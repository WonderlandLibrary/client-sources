...
public class Fonts {
    ...
    @FontDetails(fontName = "GangofThree40", fontSize = 40)
    public static GameFontRenderer GangofThree;

    @FontDetails(fontName = "GangofThree180", fontSize = 180)
    public static GameFontRenderer GangofThree180;

    @FontDetails(fontName = "PIX40", fontSize = 40)
    public static GameFontRenderer PIX40;

    @FontDetails(fontName = "PeradabanRegular40", fontSize = 40)
    public static GameFontRenderer PeradabanRegular40;

    @FontDetails(fontName = "PeradabanItalic40", fontSize = 180)
    public static GameFontRenderer PeradabanItalic40;
    ...
    public static void loadFonts() {
        ...
        GangofThree = new GameFontRenderer(getFont("GangofThree.ttf", 40));
        GangofThree180 = new GameFontRenderer(getFont("GangofThree.ttf", 180));
        PIX40 = new GameFontRenderer(getFont("PIXSPACE-DEMO.ttf", 40));
        PeradabanItalic40 = new GameFontRenderer(getFont("Peradaban-Italic.otf", 40));
        PeradabanRegular40 = new GameFontRenderer(getFont("Peradaban-Regular.otf", 40));
        try {
    ...
    private static void initFonts() {
        try {
            ...
            initSingleFont("GangofThree.ttf");
            initSingleFont("PIXSPACE-DEMO.ttf");
            initSingleFont("Peradaban-Italic.otf");
            initSingleFont("Peradaban-Regular.otf");
        }catch(IOException e) {
            e.printStackTrace();
        }
    }
