...
public class ValueButton {
    ...
    public void render(int mouseX, int mouseY, Window parent) {
        ...
        RenderUtils.drawRect2(x - 10, y - 7, x + 80 + parent.allX, y + 11, new Color(40, 40, 40).getRGB());
        if (value instanceof BoolValue) {
            ...
            RenderUtils.drawRect2(x + 1, y - 6, (x + 87.0f + parent.allX), y + font.FONT_HEIGHT + 6, new Color(29, 29, 29).getRGB());
            RenderUtils.drawRect2(x + 1, y - 6, (x + number + 1.0 + parent.allX), y + font.FONT_HEIGHT + 6, valuebackcolor);
            GlStateManager.popMatrix();
        }
        if (value instanceof BoolValue) {
            final int size = 2;
            if (change) {
                RenderUtils.drawRect2(x + 62 + size + parent.allX + 4, y - 4 + size - 1, x + 76 - size + parent.allX + 4, y + 9 - size, new Color(29, 29, 29).getRGB());
                RenderUtils.drawRect2(x + 62 + size + parent.allX + 5, y - 4 + size, x + 76 - size + parent.allX + 3, y + 8 - size, new Color(255, 255, 255, 218).getRGB());
            } else {
                RenderUtils.drawRect2(x + 62 + size + parent.allX + 4, y - 4 + size - 1, x + 76 - size + parent.allX + 4, y + 9 - size, new Color(29, 29, 29).getRGB());
            }
        }
