...
public class FileManager extends MinecraftInstance {
    ...
    public final File dir = new File(mc.mcDataDir, LiquidBounce.CLIENT_NN + "-1.8");
    ...
    public void loadBackground() {
        if(backgroundFile.exists()) {
            try {
                ...
                LiquidBounce.INSTANCE.setBackground(new ResourceLocation(LiquidBounce.CLIENT_NN.toLowerCase() + "/background.png"));
