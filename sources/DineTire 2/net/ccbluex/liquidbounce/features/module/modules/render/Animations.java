...
public class Animations extends Module {
    ...
    public static final ListValue Sword = new ListValue("Style", new String[]{
            ...
            "Avatar", "Swang", "Tap1", "Tap2", "Poke", "Push1", "Push2" , "Up" , "Shield", "Akrien", "VisionFX", "Swong",
            "SigmaOld", "ETB",
            //"Rotate360",
            "SmoothFloat", "Strange" , "Reverse", "Zoom", "Move", "Stab", "Jello", "1.7", "Flux", "Stella", "Tifality","OldExhibition"
        }, "Minecraft");
