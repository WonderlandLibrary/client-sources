...
public final class RenderUtilsKyinoSense extends MinecraftInstance {
    ...
    public static void drawCircleRect(float x, float y, float x1, float y1, float radius, int color, boolean b){
    ...
    public static int RedRainbow() {
        counts++;
        int RainbowColor = RenderUtilsKyinoSense.rainbow(System.nanoTime(), counts, 0.5f).getRGB();
        int c = RainbowColor;
    ...
    public static void drawBorderedRect22(final double x, final double y, final double x2, final double y2, final double width, final int color1, final int color2) {
        drawBorderedRect22((float)x,(float)y,(float)x2,(float)y2,(float)width,color1,color2);
    }
    public static void drawBorderedRect22(final float x, final float y, final float x2, final float y2, final float width, final int color1, final int color2) {
        drawRect(x, y, x2, y2, color2);
        glEnable(GL_BLEND);
        glDisable(GL_TEXTURE_2D);
        glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
    ...
    public static void drawTexturedRect(float x, float y, float width, float height, String image) {
        ...
        RenderUtilsKyinoSense.drawModalRectWithCustomSizedTexture(x, y, 0, 0, width, height, width, height);
    ...
    public static void drawOutlinedRect(float x, float y, float width, float height, float lineSize, int lineColor) {
        RenderUtilsKyinoSense.drawRect(x, y, width, y + lineSize, lineColor);
        RenderUtilsKyinoSense.drawRect(x, height - lineSize, width, height, lineColor);
        RenderUtilsKyinoSense.drawRect(x, y + lineSize, x + lineSize, height - lineSize, lineColor);
        RenderUtilsKyinoSense.drawRect(width - lineSize, y + lineSize, width, height - lineSize, lineColor);
    }
    ...
    public static void resetCaps() {
        glCapMap.forEach(RenderUtilsKyinoSense::setGlState);
    }
    ...
    public static void entityESPBox(Entity e, Color color, Render3DEvent event) {
        ...
        RenderUtilsKyinoSense.drawBoundingBox(box);
    }
    ...
    public static void drawRect(float toFloat, float toFloat1, float fl, double d, int rgb) {
