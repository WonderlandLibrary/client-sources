...
object LiquidBounce {
    ...
    const val CLIENT_NN = "DineTire"
    const val CLIENT_VERSION = 2
    const val IN_DEV = false
    const val CLIENT_CREATOR = "Report."
     ...
     */
    fun startClient() {
        HwidCheckKyinoSense.Title()
        //HwidCheckKyinoSense.sendWindowsMessageLogin()
        isStarting = true

        ClientUtils.getLogger().info("Starting $CLIENT_NN b$CLIENT_VERSION, by $CLIENT_CREATOR")
