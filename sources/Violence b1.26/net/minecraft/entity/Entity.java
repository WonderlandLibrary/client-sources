...
public abstract class Entity implements ICommandSender {
   ...
   public void moveEntity(double x, double y, double z) {
      if(this.noClip) {
         ...
         if(flag || (Module.getByName("SafeWalk").isToggled() || Module.getByName("Scaffold").isToggled() || Module.getByName("ProjectileESP").isToggled() && ProjectileESP.shouldAction) && !Minecraft.getMinecraft().gameSettings.keyBindJump.pressed) {
            double list1;
            for(list1 = 0.05D; x != 0.0D && this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().offset(x, -1.0D, 0.0D)).isEmpty(); d3 = x) {
               if(x < list1 && x >= -list1) {
                  x = 0.0D;
               } else if(x > 0.0D) {
                  x -= list1;
         ...
         List var54 = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().addCoord(x, y, z));
         AxisAlignedBB axisalignedbb = this.getEntityBoundingBox();

         AxisAlignedBB flag1;
         for(Iterator i = var54.iterator(); i.hasNext(); y = flag1.calculateYOffset(this.getEntityBoundingBox(), y)) {
            flag1 = (AxisAlignedBB)i.next();
         }

         this.setEntityBoundingBox(this.getEntityBoundingBox().offset(0.0D, y, 0.0D));
         boolean var55 = this.onGround || d4 != y && d4 < 0.0D;

         Iterator j;
         AxisAlignedBB var56;
         for(j = var54.iterator(); j.hasNext(); x = var56.calculateXOffset(this.getEntityBoundingBox(), x)) {
            var56 = (AxisAlignedBB)j.next();
         }

         this.setEntityBoundingBox(this.getEntityBoundingBox().offset(x, 0.0D, 0.0D));

         for(j = var54.iterator(); j.hasNext(); z = var56.calculateZOffset(this.getEntityBoundingBox(), z)) {
            var56 = (AxisAlignedBB)j.next();
         }

         this.setEntityBoundingBox(this.getEntityBoundingBox().offset(0.0D, 0.0D, z));
         if(this.stepHeight > 0.0F && var55 && (d3 != x || d5 != z)) {
            double var57 = x;
            double k = y;
            double block1 = z;
            ...
            List crashreportcategory = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().addCoord(d3, y, d5));
            AxisAlignedBB axisalignedbb4 = this.getEntityBoundingBox();
            AxisAlignedBB d14 = axisalignedbb4.addCoord(d3, 0.0D, d5);
            double d9 = y;

            AxisAlignedBB d15;
            for(Iterator var36 = crashreportcategory.iterator(); var36.hasNext(); d9 = d15.calculateYOffset(d14, d9)) {
               d15 = (AxisAlignedBB)var36.next();
            }
            ...
            AxisAlignedBB d16;
            for(Iterator var38 = crashreportcategory.iterator(); var38.hasNext(); var68 = d16.calculateXOffset(axisalignedbb4, var68)) {
               d16 = (AxisAlignedBB)var38.next();
            }

            axisalignedbb4 = axisalignedbb4.offset(var68, 0.0D, 0.0D);
            double var69 = d5;

            AxisAlignedBB axisalignedbb14;
            for(Iterator d17 = crashreportcategory.iterator(); d17.hasNext(); var69 = axisalignedbb14.calculateZOffset(axisalignedbb4, var69)) {
               axisalignedbb14 = (AxisAlignedBB)d17.next();
            }

            axisalignedbb4 = axisalignedbb4.offset(0.0D, 0.0D, var69);
            axisalignedbb14 = this.getEntityBoundingBox();
            double var70 = y;

            AxisAlignedBB d18;
            for(Iterator var43 = crashreportcategory.iterator(); var43.hasNext(); var70 = d18.calculateYOffset(axisalignedbb14, var70)) {
               d18 = (AxisAlignedBB)var43.next();
            }

            axisalignedbb14 = axisalignedbb14.offset(0.0D, var70, 0.0D);
            double var71 = d3;

            AxisAlignedBB d19;
            for(Iterator var45 = crashreportcategory.iterator(); var45.hasNext(); var71 = d19.calculateXOffset(axisalignedbb14, var71)) {
               d19 = (AxisAlignedBB)var45.next();
            }

            axisalignedbb14 = axisalignedbb14.offset(var71, 0.0D, 0.0D);
            double var72 = d5;

            AxisAlignedBB d20;
            for(Iterator var47 = crashreportcategory.iterator(); var47.hasNext(); var72 = d20.calculateZOffset(axisalignedbb14, var72)) {
               d20 = (AxisAlignedBB)var47.next();
            }

            axisalignedbb14 = axisalignedbb14.offset(0.0D, 0.0D, var72);
            double var73 = var68 * var68 + var69 * var69;
            double d10 = var71 * var71 + var72 * var72;
            if(var73 > d10) {
               x = var68;
               z = var69;
               y = -d9;
            ...
            for(Iterator var51 = crashreportcategory.iterator(); var51.hasNext(); y = axisalignedbb12.calculateYOffset(this.getEntityBoundingBox(), y)) {
               axisalignedbb12 = (AxisAlignedBB)var51.next();
            }

            this.setEntityBoundingBox(this.getEntityBoundingBox().offset(0.0D, y, 0.0D));
            if(var57 * var57 + block1 * block1 >= x * x + z * z) {
               x = var57;
               y = k;
               z = block1;
         ...
         int var59 = MathHelper.floor_double(this.posY - 0.20000000298023224D);
         int var60 = MathHelper.floor_double(this.posZ);
         BlockPos blockpos = new BlockPos(var58, var59, var60);
         Block var61 = this.worldObj.getBlockState(blockpos).getBlock();
         if(var61.getMaterial() == Material.air) {
            Block flag2 = this.worldObj.getBlockState(blockpos.down()).getBlock();
            if(flag2 instanceof BlockFence || flag2 instanceof BlockWall || flag2 instanceof BlockFenceGate) {
               var61 = flag2;
               blockpos = blockpos.down();
            }
         }

         this.updateFallState(y, this.onGround, var61, blockpos);
         if(d3 != x) {
            this.motionX = 0.0D;
         }
         ...
         if(d4 != y) {
            var61.onLanded(this.worldObj, this);
         }

         if(this.canTriggerWalking() && !flag && this.ridingEntity == null) {
            double var62 = this.posX - mods;
            double var65 = this.posY - d1;
            double var67 = this.posZ - d2;
            if(var61 != Blocks.ladder) {
               var65 = 0.0D;
            }

            if(var61 != null && this.onGround) {
               var61.onEntityCollidedWithBlock(this.worldObj, blockpos, this);
            }

            this.distanceWalkedModified = (float)((double)this.distanceWalkedModified + (double)MathHelper.sqrt_double(var62 * var62 + var67 * var67) * 0.6D);
            this.distanceWalkedOnStepModified = (float)((double)this.distanceWalkedOnStepModified + (double)MathHelper.sqrt_double(var62 * var62 + var65 * var65 + var67 * var67) * 0.6D);
            if(this.distanceWalkedOnStepModified > (float)this.nextStepDistance && var61.getMaterial() != Material.air) {
               ...
               this.playStepSound(blockpos, var61);
            }
         }
         ...
         try {
            ...
            CrashReport var64 = CrashReport.makeCrashReport(var52, "Checking entity block collision");
            CrashReportCategory var66 = var64.makeCategory("Entity being checked for collision");
            this.addEntityCrashInfo(var66);
            throw new ReportedException(var64);
         }

         boolean var63 = this.isWet();
      ...
      if(this == Minecraft.getMinecraft().thePlayer) {
         Iterator var8 = Module.getModuleList().iterator();

         while(var8.hasNext()) {
            Module var53 = (Module)var8.next();
            if(var53.isToggled()) {
               var53.onWalkUpdate();
            }
         }
   ...
   protected void resetHeight() {
      ...
      for(j = 0; (float)j < 1.0F + this.width * 20.0F; ++j) {
         ...
         this.worldObj.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX + (double)f4, (double)(f1 + 1.0F), this.posZ + (double)f5, this.motionX, this.motionY - (double)(this.rand.nextFloat() * 0.2F), this.motionZ, new int[0]);
      }
   ...
   public void writeToNBT(NBTTagCompound tagCompund) {
      try {
         ...
         if(this.ridingEntity != null) {
            ...
            if(this.ridingEntity.writeMountToNBT(throwable)) {
               tagCompund.setTag("Riding", throwable);
            }
         }
   ...
   public void readFromNBT(NBTTagCompound tagCompund) {
      try {
         NBTTagList throwable = tagCompund.getTagList("Pos", 6);
         NBTTagList crashreport1 = tagCompund.getTagList("Motion", 6);
         NBTTagList crashreportcategory1 = tagCompund.getTagList("Rotation", 5);
         this.motionX = crashreport1.getDoubleAt(0);
         this.motionY = crashreport1.getDoubleAt(1);
         this.motionZ = crashreport1.getDoubleAt(2);
         ...
         this.prevPosX = this.lastTickPosX = this.posX = throwable.getDoubleAt(0);
         this.prevPosY = this.lastTickPosY = this.posY = throwable.getDoubleAt(1);
         this.prevPosZ = this.lastTickPosZ = this.posZ = throwable.getDoubleAt(2);
         this.prevRotationYaw = this.rotationYaw = crashreportcategory1.getFloatAt(0);
         this.prevRotationPitch = this.rotationPitch = crashreportcategory1.getFloatAt(1);
   ...
   public void setPositionAndRotation2(double x, double y, double z, float yaw, float pitch, int posRotationIncrements, boolean p_180426_10_) {
      ...
      if(!list.isEmpty()) {
         ...
         while(var15.hasNext()) {
            AxisAlignedBB axisalignedbb = (AxisAlignedBB)var15.next();
   ...
   public float getCollisionBorderSize() {
      return Module.getByName("Hitbox").isToggled()?(float)VSetting.getByName("Expand", Module.getByName("Hitbox")).getCurrent():0.1F;
   }
