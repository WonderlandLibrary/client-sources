...
public class Minecraft implements IThreadListener, IPlayerUsage {
	...
	private void createDisplay() throws LWJGLException {
		...
		Display.setTitle(Violence.NAME + " " + Violence.VERSION);
				...
				if (Keyboard.getEventKeyState()) {
					...
					if (this.currentScreen != null) {
						...
						if (VSetting.getByName("Enabled", Module.getByName("TabGui")).isToggled()) {
							IngameRenderer.getTabGui().onSelect(k);
						}

						Iterator var13 = Module.getModuleList().iterator();
						while (var13.hasNext()) {
							Module var11 = (Module) var13.next();
							if (k == var11.getKeybind()) {
								var11.onToggle();
							}
						}
