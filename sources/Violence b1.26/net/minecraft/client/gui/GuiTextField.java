...
public class GuiTextField extends Gui {
   ...
   public void drawTextBox() {
      if(this.getVisible()) {
         ...
         boolean var13 = j >= 0 && j <= s.length();
         boolean var14 = this.isFocused && this.cursorCounter / 6 % 2 == 0 && var13;
         ...
         if(s.length() > 0) {
            String flag2 = var13?s.substring(0, j):s;
         ...
         if(s.length() > 0 && var13 && j < s.length()) {
