...
import dev.vertic.event.impl.motion.PostMotionEvent;
import dev.vertic.event.impl.motion.PreMotionEvent;
import dev.vertic.event.impl.other.MoveEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer() {
        ...
        Client.instance.getEventBus().call(new PostMotionEvent());
    }
    ...
    public void sendChatMessage(String message) {
        final ChatSendEvent event = new ChatSendEvent(message);
        event.call();
