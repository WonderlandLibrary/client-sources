...
public class CustomFont extends CFont {
    ...
    public CustomFont(String NameFontTTF, int size, int fonttype, boolean antiAlias, boolean fractionalMetrics) {
        super(getFontFromTTF(new ResourceLocation("vertic/fonts/" + NameFontTTF+".ttf"), size,fonttype), antiAlias, fractionalMetrics);
        setupMinecraftColorcodes();
        setupBoldItalicIDs();
    }

    public CustomFont(final String fontName, final int size) {
        super(getFontFromTTF(new ResourceLocation("vertic/fonts/" + fontName + ".ttf"), size, Font.PLAIN), true, true);
        setupMinecraftColorcodes();
        setupBoldItalicIDs();
    }
    public CustomFont(final String fontName, final int size, final int fontType) {
        super(getFontFromTTF(new ResourceLocation("vertic/fonts/" + fontName + ".ttf"), size, fontType), true, true);
        setupMinecraftColorcodes();
        setupBoldItalicIDs();
    }
