...
public class ClickGUI extends GuiScreen {
	 ...
	 */
	public ClickGUI() {
		setmgr = AuroraMod.getInstance().settingsManager;
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		for(Panel p : panels){
			for(ModuleButton b : p.Elements){
				if(b.isHovered(mouseX, mouseY) && AuroraMod.getInstance().settingsManager.getSettingByID("ClickGuiTooltips").getValBoolean()){
