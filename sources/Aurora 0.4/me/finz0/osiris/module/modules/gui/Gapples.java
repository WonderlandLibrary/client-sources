...
public class Gapples extends Module {
    ...
    public void setup(){
        ...
        AuroraMod.getInstance().settingsManager.rSetting(rainbow = new Setting("Rainbow", this, false, "GapplesRainbow"));
        AuroraMod.getInstance().settingsManager.rSetting(customFont = new Setting("CFont", this, false, "GapplesCustomFont"));
        AuroraMod.getInstance().settingsManager.rSetting(mode = new Setting("Mode", this, "Item", modes, "GapplesMode"));
    }
