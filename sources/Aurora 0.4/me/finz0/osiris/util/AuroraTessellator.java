...
//Credit 086
public class AuroraTessellator extends Tessellator {

    public static AuroraTessellator INSTANCE = new AuroraTessellator();

    public AuroraTessellator() {
        super(0x200000);
    }
...
//        GlStateManager.blendFunc(GlStateManager.SourceFactor.ONE, GlStateManager.DestFactor.ZERO);
    ...
    public static void drawFullBox(AxisAlignedBB bb, BlockPos blockPos, float width, int argb, int alpha2) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        AuroraTessellator.drawFullBox(bb, blockPos, width, r, g, b, a, alpha2);
    }
    ...
    public static void drawFullBox(AxisAlignedBB bb, BlockPos blockPos, float width, int red, int green, int blue, int alpha, int alpha2) {
        ...
        AuroraTessellator.drawBox(blockPos, red, green, blue, alpha, 63);
        AuroraTessellator.release();
        AuroraTessellator.drawBoundingBox(bb, width, red, green, blue, alpha2);
    }
    ...
    public static void drawBoxBottom(BlockPos blockPos, int argb) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        AuroraTessellator.drawBoxBottom(blockPos, r, g, b, a);
    }
    ...
    public static void drawBoxBottom(float x, float y, float z, int argb) {
        ...
        int g = argb >>> 8 & 255;
        int b = argb & 255;
        AuroraTessellator.drawBoxBottom(INSTANCE.getBuffer(), x, y, z, 1.0f, 1.0f, 1.0f, r, g, b, a);
    }


    public static void drawBoxBottom(BlockPos blockPos, int r, int g, int b, int a) {
        AuroraTessellator.drawBoxBottom(INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a);
    }
}