...
public class HudComponentOptions extends HudComponent {
    ...
    public void mouseClick(int mouseX, int mouseY, int button) {
        ...
        if (inside && button == 0) {
            AuroraMod.getInstance().hudManager.moveToTop(this);
        }
    }
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        OsirisTessellator.drawRect(this.getX(), this.getY(), this.getX() + parentNameWidth, this.getY() + Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT, 0x75505050);
        ...
        OsirisTessellator.drawRect(this.getX(), this.getY() + yOffset, this.getX() + visibleStringWidth, this.getY() + yOffset + Minecraft.getMinecraft().fontRenderer.FONT_HEIGHT, parent.isVisible() ? 0x7550FF50 : 0x75FF5050);
