...
public class HttpClient {
    ...
    {
        return readResponse(post(url, contentType, "*/*", buildParamsStr(params)));
    }
    ...
    {
        return readJson(post(url, contentType, accept, buildParamsStr(params)));
    }

    public String readPost(String url, JSONObject params, String contentType) throws MicrosoftAuthenticationException
    {
        HttpURLConnection connection = post(url, contentType, "*/*", params.toString());
    ...
    {
        HttpURLConnection connection = post(url, contentType, accept, params.toString());
        return readJson(connection);
    }
