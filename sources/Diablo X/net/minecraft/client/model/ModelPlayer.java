...
import wtf.diablo.client.module.impl.render.SkeletonESPModule;
...
public class ModelPlayer extends ModelBiped
{
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn)
    {
        ...
        if (entityIn instanceof EntityPlayer) {
            final SkeletonESPModule skeletonESPModule = Diablo.getInstance().getModuleRepository().getModuleInstance(SkeletonESPModule.class);

            if (skeletonESPModule.isEnabled()) {
                skeletonESPModule.getEntities().put((EntityPlayer) entityIn, this);
            }
        }
    }
