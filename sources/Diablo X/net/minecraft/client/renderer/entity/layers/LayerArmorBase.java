...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase>
{
    ...
    private static final class LayerArmorBase$1 {
        static final int[] field_178747_a = initializeArmorMaterialArray();
        private static final String __OBFID = "CL_00002427";

        private static int[] initializeArmorMaterialArray() {
            int[] array = new int[ItemArmor.ArmorMaterial.values().length];
            array[ItemArmor.ArmorMaterial.LEATHER.ordinal()] = 1;
            array[ItemArmor.ArmorMaterial.CHAIN.ordinal()] = 2;
            array[ItemArmor.ArmorMaterial.IRON.ordinal()] = 3;
            array[ItemArmor.ArmorMaterial.GOLD.ordinal()] = 4;
            array[ItemArmor.ArmorMaterial.DIAMOND.ordinal()] = 5;
            return array;
        }
    }
