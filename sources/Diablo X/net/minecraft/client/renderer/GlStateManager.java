...
public class GlStateManager
{
    ...
    private static final class GlStateManager$1 {
        static final int[] field_179175_a = initializeTexGenArray();
        private static final String __OBFID = "CL_00002557";

        private static int[] initializeTexGenArray() {
            int[] array = new int[GlStateManager.TexGen.values().length];
            array[GlStateManager.TexGen.S.ordinal()] = 1;
            array[GlStateManager.TexGen.T.ordinal()] = 2;
            array[GlStateManager.TexGen.R.ordinal()] = 3;
            array[GlStateManager.TexGen.Q.ordinal()] = 4;
            return array;
        }
    }
