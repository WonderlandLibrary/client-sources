...
public class WorldRenderer
{
    ...
    static final class WorldRenderer$2 {
        static final int[] field_181661_a = initializeTypeArray();
        private static final String __OBFID = "CL_00002569";

        private static int[] initializeTypeArray() {
            int[] array = new int[VertexFormatElement.EnumType.values().length];
            array[VertexFormatElement.EnumType.FLOAT.ordinal()] = 1;
            array[VertexFormatElement.EnumType.UINT.ordinal()] = 2;
            array[VertexFormatElement.EnumType.INT.ordinal()] = 3;
            array[VertexFormatElement.EnumType.USHORT.ordinal()] = 4;
            array[VertexFormatElement.EnumType.SHORT.ordinal()] = 5;
            array[VertexFormatElement.EnumType.UBYTE.ordinal()] = 6;
            array[VertexFormatElement.EnumType.BYTE.ordinal()] = 7;
            return array;
        }
    }
