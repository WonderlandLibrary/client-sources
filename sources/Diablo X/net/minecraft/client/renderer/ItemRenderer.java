...
import wtf.diablo.client.module.impl.render.AnimationsModule;
import wtf.diablo.client.module.impl.render.ItemOffsetModule;

import static wtf.diablo.client.module.impl.render.AnimationsModule.EnumAnimationMode.SWING;
...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        final AnimationsModule animations = Diablo.getInstance().getModuleRepository().getModuleInstance(AnimationsModule.class);
        final KillAuraModule killAura = Diablo.getInstance().getModuleRepository().getModuleInstance(KillAuraModule.class);
        final ItemOffsetModule itemOffset = Diablo.getInstance().getModuleRepository().getModuleInstance(ItemOffsetModule.class);
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0 || killAura.isBlocking())
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                        if (animations.isEnabled()) {
                            GlStateManager.translate(animations.getX(), animations.getY(), animations.getZ());
                            switch (animations.getMode()) {
                                case SWING:
                                ...
                                case SLIDE:
                                    ...
                                    GlStateManager.rotate(-var11 * (float) 60.0 / 2.0f, -15.0f, var12, 10);
                                    GlStateManager.rotate(-var11 * (float) 70.0, 5.0f, -var12, -0);
                                    break;
                                case SLIDE_2:
                                    GL11.glTranslated(-0.1D, 0.15D, 0.0D);
                                    this.transformFirstPersonItem(0, 0);
                                    float var13 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3f);
                                    float var14 = MathHelper.sin(MathHelper.sqrt_float(f1) * 5.9415927f);
                                    GlStateManager.rotate(-var13 * (float) 60.0 / 2.0f, -25, f1, 10);
                                    GlStateManager.rotate(-var13 * (float) 70.0, 5.0f, -var14, -0);
                                    break;
                                case SLIDE_3:
                                    GL11.glTranslated(-0.1D, 0.15D, 0.0D);
                                    this.transformFirstPersonItem(f / 2.0F, f1);
                                    float var15 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.3415927F);
                                    GlStateManager.rotate(var15 * 25.0F / 2, var15, -0.0F, 9.0F);
                                    GlStateManager.rotate(var15 * 40.0F, 15F, -var15, 0.0F);
                                    break;
                                case PUNCH:
                                    transformFirstPersonItem(f, 0.0f);
                                    func_178105_d(0.2f);
                                    GlStateManager.translate(0.1f, 0.2f, 0.3f);
                                    GlStateManager.rotate(-sine * 30.0f, -5.0f, 0.0f, 9.0f);
                                    GlStateManager.rotate(-sine * 10.0f, 1.0f, -0.4f, -0.5f);
                                    break;
                                case SPINNING:
                                ...
                                case SWANK:
                                    this.transformFirstPersonItem(f / 2.0F, f1);
                                    GlStateManager.rotate(sine * 30.0F, -sine, -0.0F, 9.0F);
                                    GlStateManager.rotate(sine * 40.0F, 1.0F, -sine, -0.0F);
                                    func_178105_d(0.4F);
                                    break;
                                case SWANG:
                                    this.transformFirstPersonItem(f / 2.0F, f1);
                                    GlStateManager.rotate(sine * 30.0F / 2.0F, -sine, -0.0F, 9.0F);
                                    GlStateManager.rotate(sine * 40.0F, 1.0F, -sine / 2.0F, -0.0F);
                                    func_178105_d(0.4F);
                                    break;
                                case SWONG:
                                    this.transformFirstPersonItem(f / 2.0F, 0.0F);
                                    GlStateManager.rotate(-sine * 40.0F / 2.0F, sine / 2.0F, -0.0F, 9.0F);
                                    GlStateManager.rotate(-sine * 30.0F, 1.0F, sine / 2.0F, -0.0F);
                                    func_178105_d(0.4F);
                                    break;
                                case SWAING:
                                    this.transformFirstPersonItem(f / 2.0F, -0.2F);
                                    GlStateManager.rotate(-sine / 19.0F, sine / 20.0F, -0.0F, 9.0F);
                                    GlStateManager.rotate(-sine * 30.0F, 10.0F, sine / 50.0F, 0.0F);
                                    func_178105_d(0.4F);
                                    break;
                                case STYLES:
                                    this.transformFirstPersonItem(f, 0.0F);
                                    ...
                                    GlStateManager.rotate(-sine * 70.0f / 2.0f, -8.0f, -0.0f, 9.0f);
                                    GlStateManager.rotate(-sine * 70.0f, 1.0f, -0.4f, -0.0f);
                                    break;
                                case STELLA:
                                ...
                                case NUDGE:
                                    ...
                                    GlStateManager.rotate(0, -320, 320, 0);
                                    ...
                                    GlStateManager.rotate(-var18 * (float) 120 / 2.0f, -90, -var16, 10);
                                    GlStateManager.rotate(-var18 * (float) 110, 15, var16, -0);
                                    break;
                            }
                        } else
                            this.transformFirstPersonItem(f, f1);
            ...
            if (itemOffset.isEnabled())
                GL11.glScaled(itemOffset.getScale(), itemOffset.getScale(), itemOffset.getScale());

            if (!(entityplayersp.getItemInUseCount() > 0 || killAura.isBlocking()) && itemOffset.isEnabled())
                GL11.glTranslated(itemOffset.getXOffset(), itemOffset.getYOffset(), itemOffset.getZOffset());
    ...
    private static final class ItemRenderer$1 {
        static final int[] field_178094_a = initializeActionArray();
        private static final String __OBFID = "CL_00002537";

        private static int[] initializeActionArray() {
            int[] array = new int[EnumAction.values().length];
            array[EnumAction.NONE.ordinal()] = 1;
            array[EnumAction.EAT.ordinal()] = 2;
            array[EnumAction.DRINK.ordinal()] = 3;
            array[EnumAction.BLOCK.ordinal()] = 4;
            array[EnumAction.BOW.ordinal()] = 5;
            return array;
        }
    }
}
