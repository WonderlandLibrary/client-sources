...
public enum EnumFacing implements IStringSerializable
{
    ...
    private static final class EnumFacing$1 {
        private static final int[] field_179515_a = initializeAxisArray();
        private static final int[] field_179513_b = initializeFacingArray();
        private static final int[] field_179514_c = initializePlaneArray();
        private static final String __OBFID = "CL_00002322";

        private static int[] initializeAxisArray() {
            int[] array = new int[EnumFacing.Axis.values().length];
            array[EnumFacing.Axis.X.ordinal()] = 1;
            array[EnumFacing.Axis.Y.ordinal()] = 2;
            array[EnumFacing.Axis.Z.ordinal()] = 3;
            return array;
        }

        private static int[] initializeFacingArray() {
            int[] array = new int[EnumFacing.values().length];
            array[EnumFacing.NORTH.ordinal()] = 1;
            array[EnumFacing.EAST.ordinal()] = 2;
            array[EnumFacing.SOUTH.ordinal()] = 3;
            array[EnumFacing.WEST.ordinal()] = 4;
            array[EnumFacing.UP.ordinal()] = 5;
            array[EnumFacing.DOWN.ordinal()] = 6;
            return array;
        }

        private static int[] initializePlaneArray() {
            int[] array = new int[EnumFacing.Plane.values().length];
            array[EnumFacing.Plane.HORIZONTAL.ordinal()] = 1;
            array[EnumFacing.Plane.VERTICAL.ordinal()] = 2;
            return array;
        }
    }
