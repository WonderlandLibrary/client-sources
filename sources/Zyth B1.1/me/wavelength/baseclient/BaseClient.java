...
import me.wavelength.baseclient.utils.HypixelStatus;
...
public class BaseClient {
	...
	private final String clientName = "Zyth";
	private final String clientVersion = "B1.1";
	private final String author = "Chazed, Aiden_JK, LRXH, Nyoxy";

	public static BaseClient instance;

	private final String defaultUsername = "ZythUser";
	...
	public void initialize() {
		Display.setTitle(String.format("%1$s - %2$s | Launching...", clientName, clientVersion));

		this.englishLocale = new Locale();

		this.ircClient = new IRCClient("https://webchat.freenode.net/", 6667, DiscordRP.name, "#freenode");
		...
		genericConfig.addDefault("tabguicolor", "1476455");
	...
	public void reset() {
		BaseClient.hypixelStatus.getSessionKills();
		BaseClient.hypixelStatus.getSessionLengthString();
	}
