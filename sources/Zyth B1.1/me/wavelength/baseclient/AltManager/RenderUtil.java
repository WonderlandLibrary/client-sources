...
public class RenderUtil {
    public static void drawOutlinedString(String str, float x, float y2, int color) {
        ...
        mc.fontRendererObj.drawStringWithShadow(str, x - 0.3f, y2, Colors.getColor(0));
        mc.fontRendererObj.drawStringWithShadow(str, x + 0.3f, y2, Colors.getColor(0));
        mc.fontRendererObj.drawStringWithShadow(str, x, y2 + 0.3f, Colors.getColor(0));
        mc.fontRendererObj.drawStringWithShadow(str, x, y2 - 0.3f, Colors.getColor(0));
        mc.fontRendererObj.drawStringWithShadow(str, x, y2, color);
    }
