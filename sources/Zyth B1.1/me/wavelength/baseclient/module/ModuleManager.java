...
import me.wavelength.baseclient.module.modules.exploit.ACfinder;
import me.wavelength.baseclient.module.modules.exploit.Crasher;
...
import me.wavelength.baseclient.module.modules.exploit.ResetVl;
import me.wavelength.baseclient.module.modules.movement.*;
import me.wavelength.baseclient.module.modules.render.Animations;
import me.wavelength.baseclient.module.modules.render.AntiCobweb;
import me.wavelength.baseclient.module.modules.render.Capes;
import me.wavelength.baseclient.module.modules.player.AntiAim;
import me.wavelength.baseclient.module.modules.player.AutoRespawn;
import me.wavelength.baseclient.module.modules.player.FastPlace;
import me.wavelength.baseclient.module.modules.player.Insults;
import me.wavelength.baseclient.module.modules.player.InvMove;
import me.wavelength.baseclient.module.modules.player.Legitscaffold;
import me.wavelength.baseclient.module.modules.player.LunarSpoofer;
import me.wavelength.baseclient.module.modules.player.Nofall;
import me.wavelength.baseclient.module.modules.player.Phase;
import me.wavelength.baseclient.module.modules.player.Stealer;
import me.wavelength.baseclient.module.modules.player.Step;
import me.wavelength.baseclient.module.modules.render.ESP;
...
import me.wavelength.baseclient.module.modules.world.Scaffold;
...
public class ModuleManager extends EventListener {
	...
	public void registerModules() {
		...
		registerModule(new Insults());
		registerModule(new ResetVl());
		...
		registerModule(new LunarSpoofer());
		registerModule(new ClickGui());
		registerModule(new Killaura());
		registerModule(new Sprint());
		registerModule(new FullBright());
		registerModule(new Velocity());
		registerModule(new HypixelHelper());
		...
		registerModule(new AntiCobweb());
		registerModule(new AutoRespawn());
		registerModule(new SpeedWalk());
