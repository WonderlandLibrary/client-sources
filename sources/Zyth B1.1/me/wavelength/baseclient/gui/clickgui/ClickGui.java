...
public class ClickGui extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		this.mc.getTextureManager().bindTexture(new ResourceLocation("Bpl/Neko1.png"));
		Gui.drawScaledCustomSizeModalRect(0, 0, 0, 0, width, height, width, height, width, height);
		int contentColor = new Color(0, 0, 0, 26).getRGB();
		int headerColor = new Color(0, 0, 0, 63).getRGB();
