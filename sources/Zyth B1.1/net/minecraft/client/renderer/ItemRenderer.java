...
public class ItemRenderer {
	...
	private void transformFirstPersonItem(float equipProgress, float swingProgress) {
		GlStateManager.translate(0.49F, -0.37F, -0.8F);
		...
		if(mc.thePlayer.ticksExisted >= 20) {
			GlStateManager.scale(Animations.factor, Animations.factor, Animations.factor);
		}else {
	...
	private void func_178098_a(float p_178098_1_, AbstractClientPlayer clientPlayer) {
		...
		GlStateManager.scale(1.0F, 1.5F, 1.0F + f1 * 0.2F);
	}
		...
		if (this.itemToRender != null) {
			if (this.itemToRender.getItem() == Items.filled_map) {
				...
				case BLOCK:
					...
					this.func_178103_d();
					GlStateManager.translate(0.5, -0.1, 0.3);
					}
					
					if(Animations.mode == 3) {
					this.transformFirstPersonItem(0F, f1);
					this.func_178103_d();
					GlStateManager.rotate(0f, 5, 5, f1);
					GlStateManager.translate(3, 1.5, -.25);
					GlStateManager.translate(-2, 0.5, 1);
					}
					
					if(Animations.mode == 4) {
						this.transformFirstPersonItem(-0.2F, f1);
						this.func_178103_d();
				...
				if(BaseClient.instance.getModuleManager().getModule("Killaura").isToggled()) {
					if(Killaura.fake)
					    this.func_178103_d();
				}
			}
