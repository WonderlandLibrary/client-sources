...
public abstract class Entity implements ICommandSender
{
	...
	public static boolean validEntity = true;
	public static boolean validEntityID = true;
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double var15 = y;
            double var17 = z;
            EventSafewalk eventSafewalk = (EventSafewalk) EventManager.call(new EventSafewalk());
            ...
            EntityStep event = new EntityStep(this, this.stepHeight, (byte)0);
