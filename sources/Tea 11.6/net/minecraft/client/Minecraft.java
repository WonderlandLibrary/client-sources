...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public final List defaultResourcePacks = Lists.newArrayList();
    ...
    public final Queue scheduledTasks = Queues.newArrayDeque();
    public long field_175615_aJ = 0L;
    public final Thread mcThread = Thread.currentThread();
    public ModelManager modelManager;
    public BlockRendererDispatcher field_175618_aM;
    ...
    public static final String __OBFID = "CL_00000631";
    ...
    public void startGame() throws LWJGLException
    {
        ...
        {
            public static final String __OBFID = "CL_00000632";
        ...
        this.ingameGUI = new ClientOverlay(this);
        
        Manager.getManager().getModuleManager().registerModules();
        ...
        Tea.getInstance().startClient();
        this.renderGlobal.func_174966_b();
    }

    public void func_175608_ak()
    {
    ...
    public void func_175609_am() throws LWJGLException
    {
    ...
    public void func_175605_an() throws LWJGLException
    {
        if (this.fullscreen)
        {
    ...
    public void startTimerHackThread()
    {
        ...
        {
            public static final String __OBFID = "CL_00000639";
            public void run()
            {
    ...
    public void func_180510_a(TextureManager p_180510_1_)
    {
    ...
    public void runTick() throws IOException
    {
         ...
         if(SelfDestruct.shouldDestruct) {
        ...
        if (this.currentScreen != null)
        {
            ...
            catch (Throwable var7)
            {
                ...
                {
                    public static final String __OBFID = "CL_00000640";
                    public String call()
                    {
            ...
            if (this.currentScreen != null)
            {
                ...
                catch (Throwable var6)
                {
                    ...
                    var3.addCrashSectionCallable("Screen name", new Callable()
                    {
                        public static final String __OBFID = "CL_00000642";
                        public String call()
                        {
                            return Minecraft.this.currentScreen.getClass().getCanonicalName();
                        }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                    	EventManager.call(new EventKeyPress(var1));
                    	
                    	ModuleUtils.onKey(var1);
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash)
    {
        ...
        {
            public static final String __OBFID = "CL_00000643";
            public String call()
            {
        ...
        {
            public static final String __OBFID = "CL_00000644";
            public String call()
            {
        ...
        {
            public static final String __OBFID = "CL_00000645";
            public String call()
            {
        ...
        {
            public static final String __OBFID = "CL_00000646";
            public String call()
            {
        ...
        {
            public static final String __OBFID = "CL_00000647";
            public String call()
            {
        ...
        {
            public static final String __OBFID = "CL_00000633";
            public String call()
            {
        ...
        {
            public static final String __OBFID = "CL_00000634";
            public String call()
            {
        ...
        {
            public static final String __OBFID = "CL_00000635";
            public String call()
            {
        ...
        {
            public static final String __OBFID = "CL_00000636";
            public String call()
            {
        ...
        {
            public static final String __OBFID = "CL_00000637";
            public String call()
            {
    ...
    public ListenableFuture func_175603_A()
    {
        ...
        {
            public static final String __OBFID = "CL_00001853";
            public void run()
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    if (var1 == this.gameSettings.keyBindStreamStartStop.getKeyCode())
                    {
                        ...
                        else if (this.getTwitchStream().func_152924_m())
                        {
                            ...
                            {
                                public static final String __OBFID = "CL_00001852";
    ...
    static final class SwitchEnumMinecartType
    {
        ...
        public static final String __OBFID = "CL_00001959";
