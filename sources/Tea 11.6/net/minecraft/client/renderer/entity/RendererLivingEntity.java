...
public abstract class RendererLivingEntity extends Render {
	...
	public void doRender(final EntityLivingBase p_76986_1_, final double p_76986_2_, final double p_76986_4_,
		...
		if (!Reflector.RenderLivingEvent_Pre_Constructor.exists()
				|| !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, p_76986_1_, this,
						p_76986_2_, p_76986_4_, p_76986_6_)) {
			...
			if (Reflector.ForgeEntity_shouldRiderSit.exists()) {
				this.mainModel.isRiding = (p_76986_1_.isRiding() && p_76986_1_.ridingEntity != null && Reflector
			...
			try {
				float var19 = this.interpolateRotation(p_76986_1_.prevRenderYawOffset, p_76986_1_.renderYawOffset,
						p_76986_9_);
				final float var20 = this.interpolateRotation(p_76986_1_.prevRotationYawHead, p_76986_1_.rotationYawHead,
						p_76986_9_);
				...
				final float var24 = p_76986_1_.prevRotationPitch
				...
				float var26 = p_76986_1_.prevLimbSwingAmount
			...
			if (!Reflector.RenderLivingEvent_Post_Constructor.exists()
					|| !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Post_Constructor, p_76986_1_, this,
							p_76986_2_, p_76986_4_, p_76986_6_)) {
			}
		}
	}
					...
					GL11.glPushMatrix();
					{
						GL11.glPushAttrib(GL11.GL_ALL_ATTRIB_BITS);
						{
							...
							if (Minecraft.getMinecraft().thePlayer.hurtTime != 0) {
								GL11.glColor3f(6F, 0F, 0F);
							} else {
								GL11.glColor3f(6F, 1F, 0F);
							}
							
							if(Manager.getManager().getFriendManager().isFriend(p_77036_1_.getName())) {
								GL11.glColor3f(0F, 1F, 1F);
							}
							
							this.mainModel.render(p_77036_1_, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_,
	...
	protected void rotateCorpse(final EntityLivingBase p_77043_1_, final float p_77043_2_, final float p_77043_3_,
		...
		if (p_77043_1_.deathTime > 0) {
			...
			if (var7 != null && (var7.equals("Dinnerbone") || var7.equals("Grumm"))
	...
	protected void func_177093_a(EntityLivingBase p_177093_1_, float p_177093_2_, float p_177093_3_, float p_177093_4_,
	...
	public void passSpecialRender(final EntityLivingBase p_77033_1_, final double p_77033_2_, final double p_77033_4_,
		...
		if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists()
				|| !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, p_77033_1_, this,
						p_77033_2_, p_77033_4_, p_77033_6_)) {
			if (this.canRenderName(p_77033_1_)) {
				final double var8 = p_77033_1_.getDistanceSqToEntity(this.renderManager.livingPlayer);
				final float var9 = p_77033_1_.isSneaking() ? RendererLivingEntity.NAME_TAG_RANGE_SNEAK
				...
				if (var8 < var9 * var9) {
					...
					if (p_77033_1_.isSneaking()) {
						...
						this.func_177069_a(p_77033_1_, p_77033_2_,
								p_77033_4_ - (p_77033_1_.isChild() ? (p_77033_1_.height / 2.0f) : 0.0), p_77033_6_,
								var10, 0.02666667f, var8);
					}
				}
			}
			if (!Reflector.RenderLivingEvent_Specials_Post_Constructor.exists()
					|| !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Post_Constructor, p_77033_1_,
							this, p_77033_2_, p_77033_4_, p_77033_6_)) {
			}
		}
	}
