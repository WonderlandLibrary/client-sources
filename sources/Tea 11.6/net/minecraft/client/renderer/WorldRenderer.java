...
public class WorldRenderer
{
    ...
    public void setColorRGBA_I(final int rgb, final int alpha) {
        final int var3 = rgb >> 16 & 0xFF;
        final int var4 = rgb >> 8 & 0xFF;
        final int var5 = rgb & 0xFF;
        this.setColorRGBA(var3, var4, var5, alpha);
    }
    
    public void setColorRGBA_F(final float red, final float green, final float blue, final float alpha) {
