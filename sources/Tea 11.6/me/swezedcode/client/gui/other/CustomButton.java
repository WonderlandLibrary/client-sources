...
public class CustomButton extends GuiButton {
	...
	public CustomButton(int i, int j, int k, String stringParams) {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY) {
		...
		RenderUtils.drawBorderedRect(this.x - this.size, this.y, this.x + this.x1 + this.size, this.y + this.y1, 2,
