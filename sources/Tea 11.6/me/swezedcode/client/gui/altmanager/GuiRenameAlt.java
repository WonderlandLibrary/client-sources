...
public class GuiRenameAlt extends GuiScreen {
	...
	public void actionPerformed(final GuiButton button) {
		...
		case 1: {
			...
			this.status = "Alt was successfully edited!";
			break;
		}
		}
	}
	...
	public void drawScreen(final int par1, final int par2, final float par3) {
		...
		this.drawCenteredString(this.fontRendererObj, this.status, this.width / 2, 25, -1);
		this.drawCenteredString(this.fontRendererObj, "Current email: " + this.manager.selectedAlt.getUsername(), this.width / 2, 47, -1);
		if(this.showPassword == true) {
			this.drawCenteredString(this.fontRendererObj, "Current password: " + this.manager.selectedAlt.getPassword(), this.width / 2, 87, -1);
		}else{
			this.drawCenteredString(this.fontRendererObj, "Current password: " + this.manager.selectedAlt.getPassword().replace(this.manager.selectedAlt.getPassword(), "********"), this.width / 2, 87, -1);
		}
	...
	@Override
	public void initGui() {
		this.buttonList.add(new GuiButton(3, this.width / 2 - 100, this.height / 4 + 68 + 12, "Show password"));
		this.buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 92 + 12, "Edit"));
		this.buttonList.add(new GuiButton(2, this.width / 2 - 100, this.height / 4 + 116 + 12, "Cancel"));
