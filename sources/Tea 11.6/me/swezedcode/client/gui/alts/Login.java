...
public class Login extends GuiScreen {
	...
	private static final ResourceLocation NiGHT = new ResourceLocation("textures/gui/title/background/Constance Halaveli Maldives UHD.png");
	public Login(GuiScreen paramScreen) {
