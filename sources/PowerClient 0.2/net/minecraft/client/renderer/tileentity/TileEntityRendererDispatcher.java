...
import me.AveReborn.events.EventRenderTileEntity;
...
public class TileEntityRendererDispatcher {
	...
	public void renderTileEntity(TileEntity tileentityIn, float partialTicks, int destroyStage) {
		if (tileentityIn.getDistanceSq(this.entityX, this.entityY, this.entityZ) < tileentityIn
			...
			EventRenderTileEntity event = new EventRenderTileEntity(this, tileentityIn, partialTicks, destroyStage,
					staticPlayerX, staticPlayerY, staticPlayerZ);
