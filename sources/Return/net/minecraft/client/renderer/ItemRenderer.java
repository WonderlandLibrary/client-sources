...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            EventRenderItemUse renderItemUseEvent = new EventRenderItemUse();
            Return.BUS.post(renderItemUseEvent);
            ...
            if (this.itemToRender != null)
            {
                if (this.itemToRender.getItem() instanceof ItemMap)
                {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0 || renderItemUseEvent.spoof) {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                            EventRenderSwordUse eventRenderSwordUse = new EventRenderSwordUse(this, equippedProgress, 0.0F, swingProgress);
                            Return.BUS.post(eventRenderSwordUse);
                            if (!eventRenderSwordUse.isCancelled()) {
                                this.transformFirstPersonItem(eventRenderSwordUse.equippedProgress, eventRenderSwordUse.renderSwingProgress);
                ...
                {
                    EventRenderSmoothSwing eventSmoothSwingAnimation = new EventRenderSmoothSwing(swingProgress);
                    Return.BUS.post(eventSmoothSwingAnimation);
                    this.doItemUsedTransformations(eventSmoothSwingAnimation.renderSwingProgress);
