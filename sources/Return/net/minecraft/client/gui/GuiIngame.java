...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        Theme theme = Return.INSTANCE.moduleManager.getByClass(Theme.class);

        if (theme != null) {
            ShaderUtil.renderGlow(this::renderGlow, theme.iterations.value.intValue(), theme.offset.value.intValue(), theme.multiplier.value.floatValue());
        }

        //CLIENT EVENT
        Return.BUS.post(new EventRender2D(scaledresolution, partialTicks));
        //CLIENT EVENT
    ...
    private void renderGlow(){
        Return.BUS.post(new EventGlow());
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
    }

    private void drawBlur(){
        Return.BUS.post(new EventBlur());
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
    }
    ...
    private void renderPumpkinOverlay(ScaledResolution p_180476_1_)
    {
        ...
        worldrenderer.pos(0.0D, (double)p_180476_1_.getScaledHeight(), -90.0D).func_181673_a(0.0D, 1.0D).endVertex();
        worldrenderer.pos((double)p_180476_1_.getScaledWidth(), (double)p_180476_1_.getScaledHeight(), -90.0D).func_181673_a(1.0D, 1.0D).endVertex();
        worldrenderer.pos((double)p_180476_1_.getScaledWidth(), 0.0D, -90.0D).func_181673_a(1.0D, 0.0D).endVertex();
    ...
    private void renderVignette(float p_180480_1_, ScaledResolution p_180480_2_)
    {
        ...
        else
        {
            ...
            WorldRenderer worldrenderer = tessellator.getWorldRenderer();
            worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
            worldrenderer.pos(0.0D, (double)p_180480_2_.getScaledHeight(), -90.0D).func_181673_a(0.0D, 1.0D).endVertex();
            worldrenderer.pos((double)p_180480_2_.getScaledWidth(), (double)p_180480_2_.getScaledHeight(), -90.0D).func_181673_a(1.0D, 1.0D).endVertex();
            worldrenderer.pos((double)p_180480_2_.getScaledWidth(), 0.0D, -90.0D).func_181673_a(1.0D, 0.0D).endVertex();
            worldrenderer.pos(0.0D, 0.0D, -90.0D).func_181673_a(0.0D, 0.0D).endVertex();
            tessellator.draw();
            GlStateManager.depthMask(true);
            GlStateManager.enableDepth();
    ...
    private void func_180474_b(float p_180474_1_, ScaledResolution p_180474_2_)
    {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.field_181707_g);
        worldrenderer.pos(0.0D, (double)p_180474_2_.getScaledHeight(), -90.0D).func_181673_a((double)f, (double)f3).endVertex();
        worldrenderer.pos((double)p_180474_2_.getScaledWidth(), (double)p_180474_2_.getScaledHeight(), -90.0D).func_181673_a((double)f2, (double)f3).endVertex();
        worldrenderer.pos((double)p_180474_2_.getScaledWidth(), 0.0D, -90.0D).func_181673_a((double)f2, (double)f1).endVertex();
        worldrenderer.pos(0.0D, 0.0D, -90.0D).func_181673_a((double)f, (double)f1).endVertex();
        tessellator.draw();
        GlStateManager.depthMask(true);
        GlStateManager.enableDepth();
        GlStateManager.enableAlpha();
