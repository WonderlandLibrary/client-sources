...
public class LanServerDetector
{
    ...
    public static class ThreadLanServerFind extends Thread
    {
        ...
        public ThreadLanServerFind(LanServerDetector.LanServerList p_i1320_1_) throws IOException
        {
            ...
            this.broadcastAddress = new InetSocketAddress(InetAddress.getByName("224.0.2.60"), 4445);
            this.networkInterface = NetworkInterface.getByInetAddress(InetAddress.getLocalHost());
            this.socket.setSoTimeout(5000);
            this.socket.joinGroup(this.broadcastAddress, this.networkInterface);
        }
        ...
        public void run()
        {
            ...
            try
            {
                this.socket.leaveGroup(this.broadcastAddress, this.networkInterface);
            }
