...
public class PlayerControllerMP
{
    ...
    {
        EventAttack attackEvent = new EventAttack(playerIn, targetEntity);
        attackEvent.setEventPhase(EventPhase.PRE);
        Return.BUS.post(attackEvent);
        ...
        attackEvent.setEventPhase(EventPhase.POST);
        Return.BUS.post(attackEvent);
    }
