...
import lol.point.returnclient.ui.MainMenu;
...
import lol.point.returnclient.managers.FontManager;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        Return.INSTANCE.fontManager = new FontManager();
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        //CLIENT TITLE
        Display.setTitle("Loading Return client...");
        //CLIENT TITLE
    ...
    private void setWindowIcon()
    {
        ...
        {
            InputStream smallIcon = null;
            InputStream bigIcon = null;

            try
            {
                //CLIENT ASSETS
                smallIcon = Minecraft.class.getResourceAsStream("/assets/minecraft/return/logo/logo_32.png");
                bigIcon = Minecraft.class.getResourceAsStream("/assets/minecraft/return/logo/logo_64.png");
                //CLIENT ASSETS
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        //CLIENT EVENT
                        Return.BUS.post(new EventKey(k));
                        //CLIENT EVENT
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage)
    {
        ...
        {
            //CLIENT EVENT
            Return.BUS.post(new EventLeaveServer());
            //CLIENT EVENT
