...
public class TexturedQuad
{
    ...
    public void draw(WorldRenderer renderer, float scale)
    {
        ...
        for (int i = 0; i < 4; ++i)
        {
            ...
            renderer.pos(positiontexturevertex.vector3D.xCoord * (double)scale, positiontexturevertex.vector3D.yCoord * (double)scale, positiontexturevertex.vector3D.zCoord * (double)scale).func_181673_a((double)positiontexturevertex.texturePositionX, (double)positiontexturevertex.texturePositionY).func_181663_c(f, f1, f2).endVertex();
        }
