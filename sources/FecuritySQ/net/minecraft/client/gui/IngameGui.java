...
public class IngameGui extends AbstractGui
{
    ...
    public void renderIngameGui(MatrixStack matrixStack, float partialTicks)
    {
        ...
        if (!this.mc.gameSettings.hideGUI)
        {
            ...
            if (scoreobjective1 != null)
            {
                ...
                boolean flag = noRender.isEnabled() && noRender.objects.setting("Скорбоард").get();
                if(!flag){
    ...
    public void func_238450_a_(ChatType p_238450_1_, ITextComponent p_238450_2_, UUID p_238450_3_)
    {
        ...
        {
            if (p_238450_1_ != ChatType.CHAT)
            {
                this.mc.ingameGUI.getChatGUI().printChatMessage(p_238450_2_);
            }
            else
            {
                this.mc.ingameGUI.getChatGUI().func_238495_b_(p_238450_2_);
            }
