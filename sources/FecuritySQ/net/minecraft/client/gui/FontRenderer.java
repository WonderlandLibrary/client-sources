...
public class FontRenderer
{
    ...
    public int func_243246_a(MatrixStack p_243246_1_, ITextComponent p_243246_2_, float p_243246_3_, float p_243246_4_, int p_243246_5_)
    {
        try {
            ...
            if (protect.isEnabled() && protect != null) {
                if (p_243246_2_.getString().contains(Minecraft.getInstance().session.getUsername())) {

                    p_243246_2_ = new StringTextComponent(p_243246_2_.getString().replaceAll(Minecraft.getInstance().session.getUsername(), "FecuritySQ.xyz"));
                }
            }
        }catch (Exception ex){}
        RenderSystem.enableAlphaTest();
    ...
    public int func_243248_b(MatrixStack p_243248_1_, ITextComponent p_243248_2_, float p_243248_3_, float p_243248_4_, int p_243248_5_)
    {
        ...
        try {
            NameProtect protect = (NameProtect) FecuritySQ.get().getModule(NameProtect.class);
            if (protect.isEnabled() && protect != null) {
                if (p_243248_2_.getString().contains(Minecraft.getInstance().session.getUsername())) {

                    p_243248_2_ = new StringTextComponent(p_243248_2_.getString().replaceAll(Minecraft.getInstance().session.getUsername(), "FecuritySQ.xyz"));
                }
            }
        }catch (Exception ex){}
