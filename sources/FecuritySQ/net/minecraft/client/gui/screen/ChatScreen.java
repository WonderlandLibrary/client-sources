...
import ru.FecuritySQ.module.дисплей.ChatHider;
...
public class ChatScreen extends Screen
{
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (FecuritySQ.get().getModule(ChatHider.class).isEnabled()) {
            if ((inputField.getText().startsWith("/l") && inputField.getText().split(" ")[0].length() <= 6) || (inputField.getText().startsWith("/reg") && inputField.getText().split(" ")[0].length() <= 9) || (inputField.getText().startsWith("/warp") && inputField.getText().split(" ")[0].length() <= 9)) {
                RenderUtil.drawRect(mc.fontRenderer.getStringWidth(inputField.getText().split(" ")[0]) + 6, this.height - 14, mc.fontRenderer.getStringWidth(inputField.getText().split(" ")[0]) + 6 + mc.fontRenderer.getStringWidth(inputField.getText().substring(inputField.getText().split(" ")[0].length())), 12, new Color(0,0,0).getRGB());
            }
        }
