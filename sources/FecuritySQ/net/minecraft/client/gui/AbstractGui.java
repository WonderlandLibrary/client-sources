...
public abstract class AbstractGui
{
    ...
    public static void outlineRect(Matrix4f matrix, float x, float y, float x2, float y2, int color)
    {
        if (x < x2)
        {
            float i = x;
        ...
        bufferbuilder.pos(matrix, (float)x, (float)y2, 0.0F).color(f, f1, f2, f3).endVertex();
        bufferbuilder.pos(matrix, (float)x2, (float)y2, 0.0F).color(f, f1, f2, f3).endVertex();
        bufferbuilder.pos(matrix, (float)x2, (float)y, 0.0F).color(f, f1, f2, f3).endVertex();
