    ...
    private void func_238493_a_(ITextComponent p_238493_1_, int p_238493_2_, int p_238493_3_, boolean p_238493_4_)
    {
        try {
            ...
            if (protect.isEnabled() && protect != null) {
                if (p_238493_1_.getString().contains(Minecraft.getInstance().session.getUsername())) {

                    p_238493_1_ = new StringTextComponent(p_238493_1_.getString().replaceAll(Minecraft.getInstance().session.getUsername(), "FecuritySQ.xyz"));
                }
            }
        }catch (Exception ex){}
