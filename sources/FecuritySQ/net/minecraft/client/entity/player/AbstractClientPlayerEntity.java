...
import ru.FecuritySQ.module.визуальные.Capes;
...
public abstract class AbstractClientPlayerEntity extends PlayerEntity
{
    ...
    public ResourceLocation getLocationCape()
    {
        ...
        Capes capes = (Capes) FecuritySQ.get().getModule(Capes.class);

        ResourceLocation cape = FecuritySQ.get().getCustomCapeLocation();
        if(capes.isEnabled()){

            if(FecuritySQ.get().getFriendManager().isFriend(getName().getString())){
                return cape;
            }
