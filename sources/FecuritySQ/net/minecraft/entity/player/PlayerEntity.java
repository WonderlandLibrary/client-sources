...
import ru.FecuritySQ.capes.CapeHolder;
import ru.FecuritySQ.capes.StickSimulation;
...
import ru.FecuritySQ.module.игрок.AutoTool;

public abstract class PlayerEntity extends LivingEntity implements CapeHolder
{
    ...
    private void updateCape()
    {
        if((Object)this instanceof AbstractClientPlayerEntity) {
            simulate((AbstractClientPlayerEntity)(Object)this);
        }
    ...
    public float getDigSpeed(BlockState state)
{
    ...
    public void attackTargetEntityWithCurrentItem(Entity targetEntity) {
        EventAttack event = new EventAttack(targetEntity, this);
