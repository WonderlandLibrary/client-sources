...
public abstract class LivingEntity extends Entity
{
    ...
    {
        if ((potionIn == Effects.NAUSEA || potionIn == Effects.BLINDNESS) && FecuritySQ.get().getModule(NoRender.class).isEnabled() &&((NoRender) FecuritySQ.get().getModule(NoRender.class)).objects.setting("Плохие эффекты").get())
            return false;
