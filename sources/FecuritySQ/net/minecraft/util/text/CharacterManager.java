        ...
        else
        {
            ...
            try {
                ...
                if (protect.isEnabled() && protect != null) {
                    if (p_238350_1_.contains(Minecraft.getInstance().session.getUsername())) {
                        p_238350_1_ = p_238350_1_.replaceAll(Minecraft.getInstance().session.getUsername(), "FecuritySQ.xyz");
                    }
                }
            }catch (Exception ex){}
