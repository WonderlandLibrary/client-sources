...
public class Potion {
    ...
    public static final Potion absorption = new PotionAbsoption(22, new ResourceLocation("absorption"), false, 0x2552A5).setPotionName("potion.absorption").setIconIndex(2, 2);
