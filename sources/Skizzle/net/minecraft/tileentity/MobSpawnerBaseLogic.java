...
public abstract class MobSpawnerBaseLogic {
    ...
    private boolean isActivated() {
        ...
        return this.getSpawnerWorld().func_175636_b((double)var1.getX() + 0.5, (double)var1.getY() + 0.5, (double)var1.getZ() + 0.5, this.activatingRangeFromPlayer);
    }
    ...
    public void updateSpawner() {
        if (this.isActivated()) {
            ...
            if (this.getSpawnerWorld().isRemote) {
                double var2 = (float)var1.getX() + this.getSpawnerWorld().rand.nextFloat();
                double var4 = (float)var1.getY() + this.getSpawnerWorld().rand.nextFloat();
                double var6 = (float)var1.getZ() + this.getSpawnerWorld().rand.nextFloat();
                this.getSpawnerWorld().spawnParticle(EnumParticleTypes.SMOKE_NORMAL, var2, var4, var6, 0.0, 0.0, 0.0, new int[0]);
                this.getSpawnerWorld().spawnParticle(EnumParticleTypes.FLAME, var2, var4, var6, 0.0, 0.0, 0.0, new int[0]);
                ...
                for (int var3 = 0; var3 < this.spawnCount; ++var3) {
                    ...
                    double var6 = (double)var1.getX() + (this.getSpawnerWorld().rand.nextDouble() - this.getSpawnerWorld().rand.nextDouble()) * (double)this.spawnRange + 0.5;
                    double var8 = var1.getY() + this.getSpawnerWorld().rand.nextInt(3) - 1;
                    double var10 = (double)var1.getZ() + (this.getSpawnerWorld().rand.nextDouble() - this.getSpawnerWorld().rand.nextDouble()) * (double)this.spawnRange + 0.5;
                    ...
                    if (var12 != null && (!var12.getCanSpawnHere() || !var12.handleLavaMovement())) continue;
    ...
    private Entity func_180613_a(Entity p_180613_1_, boolean p_180613_2_) {
        if (this.getRandomEntity() != null) {
            ...
            for (String var5 : this.getRandomEntity().field_98222_b.getKeySet()) {
    ...
    public Entity func_180612_a(World worldIn) {
        Entity var2;
        if (this.cachedEntity == null && (var2 = EntityList.createEntityByName(this.getEntityNameToSpawn(), worldIn)) != null) {
            this.cachedEntity = var2 = this.func_180613_a(var2, false);
        }
    ...
    extends WeightedRandom.Item {
        ...
        private WeightedRandomMinecart(NBTTagCompound p_i45757_2_, String p_i45757_3_, int p_i45757_4_) {
            ...
            if (p_i45757_3_.equals("Minecart")) {
                p_i45757_3_ = p_i45757_2_ != null ? EntityMinecart.EnumMinecartType.func_180038_a(p_i45757_2_.getInteger("Type")).func_180040_b() : "MinecartRideable";
            }
