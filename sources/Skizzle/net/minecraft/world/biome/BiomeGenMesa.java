...
extends BiomeGenBase {
    ...
    public void genTerrainBlocks(World worldIn, Random p_180622_2_, ChunkPrimer p_180622_3_, int p_180622_4_, int p_180622_5_, double p_180622_6_) {
        ...
        if (this.field_150626_aH) {
            var10 = (p_180622_4_ & 0xFFFFFFF0) + (p_180622_5_ & 0xF);
            var11 = (p_180622_5_ & 0xFFFFFFF0) + (p_180622_4_ & 0xF);
        ...
        var10 = p_180622_4_ & 0xF;
        var11 = p_180622_5_ & 0xF;
        boolean var23 = true;
        ...
        boolean var25 = Math.cos(p_180622_6_ / 3.0 * Math.PI) > 0.0;
        int var17 = -1;
        boolean var26 = false;
