...
IPlayerFileData {
    ...
    public void writePlayerData(EntityPlayer p_75753_1_) {
        try {
            ...
            File var3 = new File(this.playersDirectory, String.valueOf(p_75753_1_.getUniqueID().toString()) + ".dat.tmp");
            File var4 = new File(this.playersDirectory, String.valueOf(p_75753_1_.getUniqueID().toString()) + ".dat");
    ...
    public NBTTagCompound readPlayerData(EntityPlayer p_75752_1_) {
        ...
        try {
            File var3 = new File(this.playersDirectory, String.valueOf(p_75752_1_.getUniqueID().toString()) + ".dat");
    ...
    public String[] getAvailablePlayerDat() {
        ...
        for (int var2 = 0; var2 < var1.length; ++var2) {
            if (!var1[var2].endsWith(".dat")) continue;
    ...
    public File getMapFileFromName(String p_75758_1_) {
        return new File(this.mapDataDir, String.valueOf(p_75758_1_) + ".dat");
    }
