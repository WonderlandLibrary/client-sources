...
implements IThreadListener {
    ...
    private ServerBlockEventList[] field_147490_S = new ServerBlockEventList[]{new ServerBlockEventList((Object)null), new ServerBlockEventList((Object)null)};
        ...
        if (this.worldInfo.getTerrainType() == WorldType.DEBUG_WORLD) {
            ...
            for (ChunkCoordIntPair var4 : this.activeChunkSet) {
                ...
                if (this.rand.nextInt(100000) == 0 && this.isRaining() && this.isThundering()) {
                    ...
                    var9 = this.func_175736_a(new BlockPos(var5 + (var8 & 0xF), 0, var6 + (var8 >> 8 & 0xF)));
                ...
                if (this.rand.nextInt(16) == 0) {
                    this.updateLCG = this.updateLCG * 3 + 1013904223;
                    var8 = this.updateLCG >> 2;
                    var9 = this.func_175725_q(new BlockPos(var5 + (var8 & 0xF), 0, var6 + (var8 >> 8 & 0xF)));
                ...
                if (var8 > 0) {
                    for (ExtendedBlockStorage var12 : var7.getBlockStorageArray()) {
                        if (var12 == null || !var12.getNeedsRandomTick()) continue;
                        for (int var13 = 0; var13 < var8; ++var13) {
                            ...
                            if (!var20.getTickRandomly()) continue;
    ...
    public List func_147486_a(int p_147486_1_, int p_147486_2_, int p_147486_3_, int p_147486_4_, int p_147486_5_, int p_147486_6_) {
        ...
        for (int var8 = 0; var8 < this.loadedTileEntityList.size(); ++var8) {
            ...
            if (var10.getX() < p_147486_1_ || var10.getY() < p_147486_2_ || var10.getZ() < p_147486_3_ || var10.getX() >= p_147486_4_ || var10.getY() >= p_147486_5_ || var10.getZ() >= p_147486_6_) continue;
            var7.add(var9);
        }
        return var7;
    }
    ...
    public void func_180505_a(EnumParticleTypes p_180505_1_, boolean p_180505_2_, double p_180505_3_, double p_180505_5_, double p_180505_7_, int p_180505_9_, double p_180505_10_, double p_180505_12_, double p_180505_14_, double p_180505_16_, int ... p_180505_18_) {
        ...
        for (int var20 = 0; var20 < this.playerEntities.size(); ++var20) {
            ...
            if (!(var23 <= 256.0) && (!p_180505_2_ || !(var23 <= 65536.0))) continue;
