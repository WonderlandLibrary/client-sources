...
public class ChunkProviderSettings {
    ...
    public static class Factory {
        static final Gson field_177901_a = new GsonBuilder().registerTypeAdapter(Factory.class, (Object)new Serializer()).create();
    ...
    JsonSerializer {
        ...
        public Factory func_177861_a(JsonElement p_177861_1_, Type p_177861_2_, JsonDeserializationContext p_177861_3_) {
            JsonObject var4 = p_177861_1_.getAsJsonObject();
            Factory var5 = new Factory();
            try {
        ...
        public JsonElement func_177862_a(Factory p_177862_1_, Type p_177862_2_, JsonSerializationContext p_177862_3_) {
            JsonObject var4 = new JsonObject();
            var4.addProperty("coordinateScale", (Number)Float.valueOf(p_177862_1_.field_177899_b));
            var4.addProperty("heightScale", (Number)Float.valueOf(p_177862_1_.field_177900_c));
            var4.addProperty("lowerLimitScale", (Number)Float.valueOf(p_177862_1_.field_177898_e));
            var4.addProperty("upperLimitScale", (Number)Float.valueOf(p_177862_1_.field_177896_d));
            var4.addProperty("depthNoiseScaleX", (Number)Float.valueOf(p_177862_1_.field_177893_f));
            var4.addProperty("depthNoiseScaleZ", (Number)Float.valueOf(p_177862_1_.field_177894_g));
            var4.addProperty("depthNoiseScaleExponent", (Number)Float.valueOf(p_177862_1_.field_177915_h));
            var4.addProperty("mainNoiseScaleX", (Number)Float.valueOf(p_177862_1_.field_177917_i));
            var4.addProperty("mainNoiseScaleY", (Number)Float.valueOf(p_177862_1_.field_177911_j));
            var4.addProperty("mainNoiseScaleZ", (Number)Float.valueOf(p_177862_1_.field_177913_k));
            var4.addProperty("baseSize", (Number)Float.valueOf(p_177862_1_.field_177907_l));
            var4.addProperty("stretchY", (Number)Float.valueOf(p_177862_1_.field_177909_m));
            var4.addProperty("biomeDepthWeight", (Number)Float.valueOf(p_177862_1_.field_177903_n));
            var4.addProperty("biomeDepthOffset", (Number)Float.valueOf(p_177862_1_.field_177905_o));
            var4.addProperty("biomeScaleWeight", (Number)Float.valueOf(p_177862_1_.field_177933_p));
            var4.addProperty("biomeScaleOffset", (Number)Float.valueOf(p_177862_1_.field_177931_q));
