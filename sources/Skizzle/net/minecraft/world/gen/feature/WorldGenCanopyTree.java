            ...
            if ((var18 == Blocks.grass || var18 == Blocks.dirt) && p_180709_3_.getY() < 256 - var4 - 1) {
                ...
                for (var13 = -2; var13 <= 0; ++var13) {
                    for (var14 = -2; var14 <= 0; ++var14) {
                        ...
                        if (var13 <= -2 && var14 <= -1 || var13 == -1 && var14 == -2) continue;
                        int var21 = 1;
                ...
                for (var13 = -3; var13 <= 4; ++var13) {
                    for (var14 = -3; var14 <= 4; ++var14) {
                        if (var13 == -3 && var14 == -3 || var13 == -3 && var14 == 4 || var13 == 4 && var14 == -3 || var13 == 4 && var14 == 4 || Math.abs(var13) >= 3 && Math.abs(var14) >= 3) continue;
                ...
                for (var13 = -1; var13 <= 2; ++var13) {
                    for (var14 = -1; var14 <= 2; ++var14) {
                        int var17;
                        int var23;
                        if (var13 >= 0 && var13 <= 1 && var14 >= 0 && var14 <= 1 || p_180709_2_.nextInt(3) > 0) continue;
                        ...
                        for (var23 = -1; var23 <= 1; ++var23) {
                            for (var17 = -1; var17 <= 1; ++var17) {
                                this.func_150526_a(worldIn, var10 + var13 + var23, var12, var11 + var14 + var17);
                            }
                        }
                        for (var23 = -2; var23 <= 2; ++var23) {
                            for (var17 = -2; var17 <= 2; ++var17) {
                                if (Math.abs(var23) == 2 && Math.abs(var17) == 2) continue;
