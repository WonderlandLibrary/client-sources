...
extends MapGenStructure {
    ...
    public StructureOceanMonument(Map p_i45608_1_) {
        this();
        for (Map.Entry var3 : p_i45608_1_.entrySet()) {
            ...
            if (!((String)var3.getKey()).equals("separation")) continue;
    ...
    protected boolean canSpawnStructureAtCoords(int p_75047_1_, int p_75047_2_) {
        ...
        if (var3 == (var5 += (var7.nextInt(this.field_175800_f - this.field_175801_g) + var7.nextInt(this.field_175800_f - this.field_175801_g)) / 2) && var4 == (var6 += (var7.nextInt(this.field_175800_f - this.field_175801_g) + var7.nextInt(this.field_175800_f - this.field_175801_g)) / 2)) {
