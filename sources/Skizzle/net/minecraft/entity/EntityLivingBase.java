...
extends Entity {
    ...
    protected void updateFallState(double y, boolean onGroundIn, Block blockIn, BlockPos pos) {
        ...
        if (!this.worldObj.isRemote && this.fallDistance > 3.0f && onGroundIn) {
            ...
            if (var7.getMaterial() != Material.air) {
                ...
                ((WorldServer)this.worldObj).func_175739_a(EnumParticleTypes.BLOCK_DUST, this.posX, this.posY, this.posZ, var11, 0.0, 0.0, 0.0, 0.15f, Block.getStateId(var6));
            }
        }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        ...
        if (var3) {
            ...
            if (var4 != null) {
                ...
                this.attackedAtYaw = (float)(Math.atan2(var7, var9) * 180.0 / Math.PI - (double)this.rotationYaw);
    ...
    public void fall(float distance, float damageMultiplier) {
        ...
        if (var5 > 0) {
            ...
            int var7 = MathHelper.floor_double(this.posY - (double)0.2f);
    ...
    protected void jump() {
        if (this.getEntityId() == Minecraft.getMinecraft().thePlayer.getEntityId()) {
            EventJump event = new EventJump();
            Client.onEvent(event);
        }
        Minecraft mc = Minecraft.getMinecraft();
        if (ModuleManager.speed.mode.getMode().equals("Low-Hop") && ModuleManager.speed.isEnabled() && this == Minecraft.getMinecraft().thePlayer) {
            if (Minecraft.theWorld.getBlockState(mc.thePlayer.getPosition().offset(EnumFacing.fromAngle(mc.thePlayer.rotationYaw), 2)).getBlock().isFullBlock() && ModuleManager.speed.step.isEnabled()) {
        ...
        if (this.isSprinting()) {
            float var1 = this.rotationYaw * ((float)Math.PI / 180);
    ...
    public void moveEntityWithHeading(float p_70612_1_, float p_70612_2_) {
        ...
        if (this.isServerWorld()) {
            ...
            if (!(!this.isInWater() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)) {
                ...
                this.motionY -= 0.02;
                if (this.isCollidedHorizontally && this.isOffsetPositionInLiquid(this.motionX, this.motionY + (double)0.6f - this.posY + var8, this.motionZ)) {
                    this.motionY = 0.3f;
                }
    ...
    protected void collideWithNearbyEntities() {
        List var1 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox().expand(0.2f, 0.0, 0.2f));
