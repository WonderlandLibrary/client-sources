...
extends EntityLivingBase {
    ...
    protected void collideWithNearbyEntities() {
        ...
        if (var1 != null && !var1.isEmpty()) {
            for (int var2 = 0; var2 < var1.size(); ++var2) {
                ...
                if (!(var3 instanceof EntityMinecart) || ((EntityMinecart)var3).func_180456_s() != EntityMinecart.EnumMinecartType.RIDEABLE || !(this.getDistanceSqToEntity(var3) <= 0.2)) continue;
        ...
        block18: {
            block19: {
                block17: {
                    ...
                    if (p_174825_1_.func_175149_v() != false) return true;
                    var3 = 0;
                    var4 = p_174825_1_.getCurrentEquippedItem();
                    v0 = var5 = var4 != null;
                    if (var5 && var4.getItem() instanceof ItemArmor) {
                        var6 = (ItemArmor)var4.getItem();
                        if (var6.armorType == 3) {
                            var3 = 1;
                    ...
                    var14 = 0;
                    var15 = this.isSmall();
                    v1 = var16 = var15 != false ? p_174825_2_.yCoord * 2.0 : p_174825_2_.yCoord;
                    if (!(var16 >= 0.1)) break block17;
                    v2 = var15 != false ? 0.8 : 0.45;
                    if (!(var16 < 0.1 + v2) || this.contents[1] == null) break block17;
                    var14 = 1;
                    break block18;
                }
                v3 = var15 != false ? 0.3 : 0.0;
                if (!(var16 >= 0.9 + v3)) break block19;
                v4 = var15 != false ? 1.0 : 0.7;
                if (!(var16 < 0.9 + v4) || this.contents[3] == null) break block19;
                var14 = 3;
                break block18;
            }
            if (!(var16 >= 0.4)) ** GOTO lbl-1000
            v5 = var15 != false ? 1.0 : 0.8;
            if (var16 < 0.4 + v5 && this.contents[2] != null) {
                var14 = 2;
            } else if (var16 >= 1.6 && this.contents[4] != null) {
                var14 = 4;
            }
        }
        v6 = var18 = this.contents[var14] != null;
    ...
    private void dropContents() {
        for (int var1 = 0; var1 < this.contents.length; ++var1) {
            if (this.contents[var1] == null || this.contents[var1].stackSize <= 0) continue;
    ...
    private void setSmall(boolean p_175420_1_) {
        ...
        var2 = p_175420_1_ ? (byte)(var2 | 1) : (byte)(var2 & 0xFFFFFFFE);
    ...
    private void setNoGravity(boolean p_175425_1_) {
        byte var2 = this.dataWatcher.getWatchableObjectByte(10);
        var2 = p_175425_1_ ? (byte)(var2 | 2) : (byte)(var2 & 0xFFFFFFFD);
        this.dataWatcher.updateObject(10, var2);
    }
    ...
    private void setShowArms(boolean p_175413_1_) {
        byte var2 = this.dataWatcher.getWatchableObjectByte(10);
        var2 = p_175413_1_ ? (byte)(var2 | 4) : (byte)(var2 & 0xFFFFFFFB);
        this.dataWatcher.updateObject(10, var2);
    }
    ...
    private void setNoBasePlate(boolean p_175426_1_) {
        byte var2 = this.dataWatcher.getWatchableObjectByte(10);
        var2 = p_175426_1_ ? (byte)(var2 | 8) : (byte)(var2 & 0xFFFFFFF7);
        this.dataWatcher.updateObject(10, var2);
    }
