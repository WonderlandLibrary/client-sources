...
extends EntityAmbientCreature {
    ...
    protected void updateAITasks() {
        ...
        if (this.getIsBatHanging()) {
            ...
            this.motionX += (Math.signum(var3) * 0.5 - this.motionX) * (double)0.1f;
            this.motionY += (Math.signum(var5) * (double)0.7f - this.motionY) * (double)0.1f;
            this.motionZ += (Math.signum(var7) * 0.5 - this.motionZ) * (double)0.1f;
            float var9 = (float)(Math.atan2(this.motionZ, this.motionX) * 180.0 / Math.PI) - 90.0f;
