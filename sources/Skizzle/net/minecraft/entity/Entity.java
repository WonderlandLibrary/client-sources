...
implements ICommandSender {
    ...
    public boolean noTag = false;
    public float prevMoveModified;
    public float moveModified;
    ...
    public AxisAlignedBB boundingBox = field_174836_a;
    ...
    protected UUID entityUniqueID = MathHelper.func_180182_a(this.rand);
    private final CommandResultStats field_174837_as = new CommandResultStats();
    ...
    public void onEntityUpdate() {
        ...
        this.prevMoveModified = this.moveModified;
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            double var15 = y;
            double var17 = z;
            boolean bl = var19 = this.onGround && this.isSneaking() && this instanceof EntityPlayer;
            if (var19 || (ModuleManager.safeWalk.shouldStop() || ModuleManager.scaffold.shouldStop()) && Minecraft.getMinecraft().thePlayer.getEntityId() == this.entityId) {
                double var20 = 0.05;
            ...
            boolean var54 = this.onGround || var15 != y && var15 < 0.0;
            ...
            for (AxisAlignedBB var24 : var53) {
                z = var24.calculateZOffset(this.getEntityBoundingBox(), z);
            }
            ...
            int var58 = MathHelper.floor_double(this.posY - (double)0.2f);
            ...
            double var611 = this.posX - var7;
            double var661 = this.posZ - var11;
            this.moveModified = (float)((double)this.moveModified + (double)MathHelper.sqrt_double(var611 * var611 + var661 * var661) * 0.6);
            if (this.canTriggerWalking() && !var19 && this.ridingEntity == null) {
                ...
                if (this.distanceWalkedOnStepModified > (float)this.nextStepDistance && var60.getMaterial() != Material.air) {
                    ...
                    if (this.isInWater()) {
                        float var34 = MathHelper.sqrt_double(this.motionX * this.motionX * (double)0.2f + this.motionY * this.motionY + this.motionZ * this.motionZ * (double)0.2f) * 0.35f;
                        if (var34 > 1.0f) {
                            var34 = 1.0f;
                        }
    ...
    protected void func_174808_Z() {
        ...
        BlockPos var4 = new BlockPos(var1, var2 = MathHelper.floor_double(this.posY - (double)0.2f), var3 = MathHelper.floor_double(this.posZ));
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        ...
        EventStrafing eventStrafe = new EventStrafing(this.rotationYaw, friction, strafe, forward);
        if (this == Minecraft.getMinecraft().thePlayer) {
            Client.onEvent(eventStrafe);
            var5 = (float)eventStrafe.getX();
            var6 = (float)eventStrafe.getZ();
            strafe = (float)eventStrafe.strafe;
            forward = (float)eventStrafe.forward;
        }
        if (var4 >= 1.0E-4f) {
            ...
            strafe *= var4;
            forward *= var4;
            if (Minecraft.getMinecraft().thePlayer != null && this.entityId == Minecraft.getMinecraft().thePlayer.getEntityId()) {
                EventMoveFlying event = new EventMoveFlying(forward, strafe, var4);
                Client.onEvent(event);
                strafe = event.getStrafe();
                forward = event.getForward();
                var4 = event.getFriciton();
            }
    ...
    public void applyEntityCollision(Entity entityIn) {
        ...
        double var2;
        double var6;
        if (entityIn.riddenByEntity != this && entityIn.ridingEntity != this && !entityIn.noClip && !this.noClip && (var6 = MathHelper.abs_max(var2 = entityIn.posX - this.posX, var4 = entityIn.posZ - this.posZ)) >= (double)0.01f) {
    ...
    protected final Vec3 func_174806_f(float p_174806_1_, float p_174806_2_) {
        float var3 = MathHelper.cos(-p_174806_2_ * ((float)Math.PI / 180) - (float)Math.PI);
        float var4 = MathHelper.sin(-p_174806_2_ * ((float)Math.PI / 180) - (float)Math.PI);
        float var5 = -MathHelper.cos(-p_174806_1_ * ((float)Math.PI / 180));
        float var6 = MathHelper.sin(-p_174806_1_ * ((float)Math.PI / 180));
    ...
    public boolean isInRangeToRenderDist(double distance) {
        ...
        return distance < (var3 *= 64.0 * this.renderDistanceWeight) * var3;
    }
