...
public class BlockPistonStructureHelper {
    ...
    public boolean func_177253_a() {
        ...
        for (int var2 = 0; var2 < this.field_177258_e.size(); ++var2) {
            ...
            if (this.field_177261_a.getBlockState(var3).getBlock() != Blocks.slime_block || this.func_177250_b(var3)) continue;
            return false;
        }
        return true;
    }
    ...
    private boolean func_177251_a(BlockPos p_177251_1_) {
        var2 = this.field_177261_a.getBlockState(p_177251_1_).getBlock();
        ...
        var3 = 1;
        if (var3 + this.field_177258_e.size() <= 12) ** GOTO lbl16
        return false;
        while ((var2 = this.field_177261_a.getBlockState(var4 = p_177251_1_.offset(this.field_177257_d.getOpposite(), var3)).getBlock()).getMaterial() != Material.air && BlockPistonBase.func_180696_a(var2, this.field_177261_a, var4, this.field_177257_d, false) && !var4.equals(this.field_177259_b)) {
...
lbl16:
            ...
            if (var2 == Blocks.slime_block) continue;
        }
        var10 = 0;
        for (var5 = var3 - 1; var5 >= 0; ++var10, --var5) {
            this.field_177258_e.add(p_177251_1_.offset(this.field_177257_d.getOpposite(), var5));
        }
        var5 = 1;
        while (true) {
            block14: {
                if ((var7 = this.field_177258_e.indexOf(var6 = p_177251_1_.offset(this.field_177257_d, var5))) <= -1) break block14;
            ...
            if (BlockPistonBase.func_180696_a(var2, this.field_177261_a, var6, this.field_177257_d, true) == false) return false;
            if (var6.equals(this.field_177259_b)) {
                return false;
            }
...
lbl-1000:
        ...
        {
            var9 = (BlockPos)this.field_177258_e.get(var8);
...
lbl51:
    ...
    private boolean func_177250_b(BlockPos p_177250_1_) {
        for (EnumFacing var5 : EnumFacing.values()) {
            if (var5.getAxis() == this.field_177257_d.getAxis() || this.func_177251_a(p_177250_1_.offset(var5))) continue;
            return false;
        }
        return true;
    }
