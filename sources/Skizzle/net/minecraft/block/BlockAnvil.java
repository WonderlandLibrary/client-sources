...
extends BlockFalling {
    ...
    protected BlockAnvil() {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, (Comparable)((Object)EnumFacing.NORTH)).withProperty(DAMAGE, Integer.valueOf(0)));
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        ...
        return super.onBlockPlaced(worldIn, pos, facing, hitX, hitY, hitZ, meta, placer).withProperty(FACING, (Comparable)((Object)var9)).withProperty(DAMAGE, Integer.valueOf(meta >> 2));
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess access, BlockPos pos) {
        EnumFacing var3 = (EnumFacing)((Object)access.getBlockState(pos).getValue(FACING));
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(FACING, (Comparable)((Object)EnumFacing.getHorizontal(meta & 3))).withProperty(DAMAGE, Integer.valueOf((meta & 0xF) >> 2));
    }

    @Override
    public int getMetaFromState(IBlockState state) {
        int var2 = 0;
        int var3 = var2 | ((EnumFacing)((Object)state.getValue(FACING))).getHorizontalIndex();
        return var3 |= (Integer)state.getValue(DAMAGE) << 2;
    }
