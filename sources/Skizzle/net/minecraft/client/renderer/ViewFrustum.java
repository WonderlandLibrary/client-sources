...
public class ViewFrustum {
    ...
    public void func_178160_a() {
        for (RenderChunk var4 : this.field_178164_f) {
            var4.func_178566_a();
        }
    }
        ...
        for (int var8 = 0; var8 < this.field_178165_d; ++var8) {
            ...
            for (int var10 = 0; var10 < this.field_178166_e; ++var10) {
                ...
                for (int var12 = 0; var12 < this.field_178168_c; ++var12) {
                    ...
                    if (posChunk.getX() == var9 && posChunk.getY() == var13 && posChunk.getZ() == var11 || (var15 = new BlockPos(var9, var13, var11)).equals(var14.func_178568_j())) continue;
