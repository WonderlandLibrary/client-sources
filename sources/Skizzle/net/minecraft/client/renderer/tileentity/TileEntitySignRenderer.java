...
extends TileEntitySpecialRenderer {
    ...
    public void func_180541_a(TileEntitySign p_180541_1_, double p_180541_2_, double p_180541_4_, double p_180541_6_, float p_180541_8_, int p_180541_9_) {
        ...
        GL11.glNormal3f((float)0.0f, (float)0.0f, (float)(-1.0f * var13));
        ...
        if (p_180541_9_ < 0) {
            for (int var15 = 0; var15 < p_180541_1_.signText.length; ++var15) {
                String var18;
                if (p_180541_1_.signText[var15] == null) continue;
                ...
                String string = var18 = var17 != null && var17.size() > 0 ? ((IChatComponent)var17.get(0)).getFormattedText() : "";
                if (var15 == p_180541_1_.lineBeingEdited) {
                    var18 = "> " + var18 + " <";
                    var201.drawStringNormal(var18, -var201.getStringWidth(var18) / 2, var15 * 10 - p_180541_1_.signText.length * 5, var14);
                    continue;
                }
                var201.drawStringNormal(var18, -var201.getStringWidth(var18) / 2, var15 * 10 - p_180541_1_.signText.length * 5, var14);
            }
