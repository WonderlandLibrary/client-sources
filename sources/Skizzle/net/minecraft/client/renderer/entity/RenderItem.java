...
implements IResourceManagerReloadListener {
    ...
    public void renderItem(ItemStack p_175042_1_, int p_175042_2_, int p_175042_3_) {
    ...
    public void renderItemOnScreen(final ItemStack p_180450_1_, int p_180450_2_, int p_180450_3_) {
        if (p_180450_1_ != null) {
            this.zLevel += 50.0f;
            try {
                this.renderItem(p_180450_1_, p_180450_2_, p_180450_3_);
            }
    ...
    public void func_180453_a(FontRenderer p_180453_1_, ItemStack p_180453_2_, int p_180453_3_, int p_180453_4_, String p_180453_5_) {
        if (p_180453_2_ != null) {
            if (p_180453_2_.stackSize != 1 || p_180453_5_ != null) {
                ...
                GlStateManager.disableBlend();
                p_180453_1_.drawStringWithShadow(itemDamaged, p_180453_3_ + 19 - 2 - p_180453_1_.getStringWidth(itemDamaged), p_180453_4_ + 6 + 3, 0xFFFFFF);
                GlStateManager.enableLighting();
