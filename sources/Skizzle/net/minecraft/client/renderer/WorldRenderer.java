...
public class WorldRenderer {
    ...
    public void func_178978_a(float p_178978_1_, float p_178978_2_, float p_178978_3_, int p_178978_4_) {
        ...
        if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
            int var7 = (int)((float)(var6 & 0xFF) * p_178978_1_);
            int var8 = (int)((float)(var6 >> 8 & 0xFF) * p_178978_2_);
            int var9 = (int)((float)(var6 >> 16 & 0xFF) * p_178978_3_);
            var6 &= 0xFF000000;
            var6 |= var9 << 16 | var8 << 8 | var7;
        } else {
            int var7 = (int)((float)(this.field_179007_h >> 24 & 0xFF) * p_178978_1_);
            int var8 = (int)((float)(this.field_179007_h >> 16 & 0xFF) * p_178978_2_);
            int var9 = (int)((float)(this.field_179007_h >> 8 & 0xFF) * p_178978_3_);
            var6 &= 0xFF;
    ...
    public void addVertex(double p_178984_1_, double p_178984_3_, double p_178984_5_) {
        ...
        block6: for (int i = 0; i < listSize; ++i) {
    ...
    public void func_178980_d(float p_178980_1_, float p_178980_2_, float p_178980_3_) {
        ...
        this.field_179003_o = var71 & 0xFF | (var5 & 0xFF) << 8 | (var6 & 0xFF) << 16;
    }
    ...
    public void drawMultiTexture() {
         ...
         * org.benf.cfr.reader.util.ConfusedCFRException: Invalid stack depths @ lbl88 : RETURN - null : trying to set 0 previously set to 1
