...
public class SpectatorMenu {
    ...
    public ISpectatorMenuObject func_178643_a(int p_178643_1_) {
        ...
        return this.field_178658_j > 0 && p_178643_1_ == 0 ? field_178656_c : (p_178643_1_ == 7 ? (var2 < this.field_178659_h.func_178669_a().size() ? field_178653_d : field_178654_e) : (p_178643_1_ == 8 ? field_178655_b : (var2 >= 0 && var2 < this.field_178659_h.func_178669_a().size() ? (ISpectatorMenuObject)Objects.firstNonNull(this.field_178659_h.func_178669_a().get(var2), (Object)field_178657_a) : field_178657_a)));
    }
    ...
    implements ISpectatorMenuObject {
        ...
        public void func_178663_a(float p_178663_1_, int p_178663_2_) {
            ...
            Gui.drawModalRectWithCustomSizedTexture(0.0, 0.0, 128.0f, 0.0f, 16.0, 16.0, 256.0, 256.0);
        }
    ...
    implements ISpectatorMenuObject {
        ...
        public void func_178663_a(float p_178663_1_, int p_178663_2_) {
            ...
            if (this.field_178666_a < 0) {
                Gui.drawModalRectWithCustomSizedTexture(0.0, 0.0, 144.0f, 0.0f, 16.0, 16.0, 256.0, 256.0);
            } else {
                Gui.drawModalRectWithCustomSizedTexture(0.0, 0.0, 160.0f, 0.0f, 16.0, 16.0, 256.0, 256.0);
            }
        }
