...
extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.fontRendererObj.drawStringNormal(this.field_175380_I.getDisplayName().getUnformattedText(), 12.0f, 5.0f, 0x404040);
        this.fontRendererObj.drawStringNormal(this.field_175379_F.getDisplayName().getUnformattedText(), 8.0f, this.ySize - 96 + 2, 0x404040);
    }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        for (int var6 = 0; var6 < 3; ++var6) {
            ...
            if (var7 < 0 || var8 < 0 || var7 >= 108 || var8 >= 19 || !this.field_147075_G.enchantItem(this.mc.thePlayer, var6)) continue;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (int var6 = 0; var6 < 3; ++var6) {
            ...
            int var9 = var6 + 1;
            if (!this.isPointInRegion(60, 14 + 19 * var6, 108, 17, mouseX, mouseY) || var7 <= 0 || var8 < 0) continue;
            ArrayList var10 = Lists.newArrayList();
            if (var8 >= 0 && Enchantment.func_180306_c(var8 & 0xFF) != null) {
                var11 = Enchantment.func_180306_c(var8 & 0xFF).getTranslatedName((var8 & 0xFF00) >> 8);
    ...
    public void func_147068_g() {
        ...
        for (int var3 = 0; var3 < 3; ++var3) {
            if (this.field_147075_G.enchantLevels[var3] == 0) continue;
            var2 = true;
        }
