...
implements GuiYesNoCallback {
    ...
    @Override
    public void initGui() {
        DiscordClient.getInstance().getDiscordRP().update("Idle", "Singleplayer Menu");
        ...
        if (button.enabled) {
            if (button.id == 2) {
                ...
                if (var2 != null) {
                    ...
                    GuiYesNo var3 = GuiSelectWorld.func_152129_a(this, var2, this.field_146640_r);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_146628_f, this.width / 2, 20.0f, 0xFFFFFF);
    ...
    extends GuiSlot {
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
            ...
            ((GuiSelectWorld)GuiSelectWorld.this).field_146641_z.enabled = var5 = GuiSelectWorld.this.field_146640_r >= 0 && GuiSelectWorld.this.field_146640_r < this.getSize();
            ((GuiSelectWorld)GuiSelectWorld.this).field_146642_y.enabled = var5;
            ((GuiSelectWorld)GuiSelectWorld.this).field_146630_A.enabled = var5;
            ((GuiSelectWorld)GuiSelectWorld.this).field_146631_B.enabled = var5;
        ...
        protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
            ...
            if (StringUtils.isEmpty((CharSequence)var8)) {
                var8 = String.valueOf(GuiSelectWorld.this.field_146637_u) + " " + (p_180791_1_ + 1);
            }
            String var9 = var7.getFileName();
            var9 = String.valueOf(var9) + " (" + GuiSelectWorld.this.field_146633_h.format(new Date(var7.getLastTimePlayed()));
            var9 = String.valueOf(var9) + ")";
            String var10 = "";
            if (var7.requiresConversion()) {
                var10 = String.valueOf(GuiSelectWorld.this.field_146636_v) + " " + var10;
            } else {
                var10 = GuiSelectWorld.this.field_146635_w[var7.getEnumGameType().getID()];
                if (var7.isHardcoreModeEnabled()) {
                    var10 = (Object)((Object)EnumChatFormatting.DARK_RED) + I18n.format("gameMode.hardcore", new Object[0]) + (Object)((Object)EnumChatFormatting.RESET);
                }
                if (var7.getCheatsEnabled()) {
                    var10 = String.valueOf(var10) + ", " + I18n.format("selectWorld.cheats", new Object[0]);
                }
            }
            GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, var8, p_180791_2_ + 2, p_180791_3_ + 1, 0xFFFFFF);
            GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, var9, p_180791_2_ + 2, p_180791_3_ + 12, 0x808080);
            GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, var10, p_180791_2_ + 2, p_180791_3_ + 12 + 10, 0x808080);
        }
    }
}
