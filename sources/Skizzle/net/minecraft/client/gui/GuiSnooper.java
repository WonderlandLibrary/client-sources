...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_146610_i, this.width / 2, 8.0f, 0xFFFFFF);
        int var4 = 22;
        for (String var8 : this.field_146607_r) {
            this.drawCenteredString(this.fontRendererObj, var8, this.width / 2, var4, 0x808080);
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
            GuiSnooper.this.fontRendererObj.drawStringNormal((String)GuiSnooper.this.field_146604_g.get(p_180791_1_), 10.0f, p_180791_3_, 0xFFFFFF);
            GuiSnooper.this.fontRendererObj.drawStringNormal((String)GuiSnooper.this.field_146609_h.get(p_180791_1_), 230.0f, p_180791_3_, 0xFFFFFF);
        }
