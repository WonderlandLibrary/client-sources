...
implements GuiYesNoCallback {
    ...
    @Override
    public void initGui() {
        DiscordClient.getInstance().getDiscordRP().update("Idle", "Multiplayer Menu");
    ...
    public void createButtons() {
        ...
        if (!Client.ghostMode) {
            ...
            this.sButtonList.add(new Button("Random Account", 1004, this.width / 2 + 4 + sr.getScaledWidth() / 2 - 150, 5, 130, 20));
        }
        ...
        block1: {
            block8: {
                block7: {
                    block6: {
                        ...
                        block5: {
                            block4: {
                                block3: {
                                    block2: {
                                        if (!button.enabled) break block1;
                                        GuiListExtended.IGuiListEntry iGuiListEntry = var2 = this.serverListSelector.getSelectedSlot() < 0 ? null : this.serverListSelector.getListEntry(this.serverListSelector.getSelectedSlot());
                                        if (button.id == 69) {
                                            this.mc.displayGuiScreen(new GuiProtocolSelector(this));
                                        }
                                        if (button.id != 2 || !(var2 instanceof ServerListEntryNormal)) break block2;
                                        String var9 = ((ServerListEntryNormal)var2).getServerData().serverName;
                                        if (var9 == null) break block1;
                                        ...
                                        GuiYesNo var8 = new GuiYesNo(this, var4, var5, var6, var7, this.serverListSelector.getSelectedSlot());
                                        this.mc.displayGuiScreen(var8);
                                        break block1;
                                    }
                                    if (button.id != 1) break block3;
                                    this.connectToSelected();
                                    break block1;
                                }
                                if (button.id != 4) break block4;
                            ...
                            if (button.id != 3) break block5;
                            this.addingServer = true;
                            this.selectedServer = new ServerData(I18n.format("", new Object[0]), "");
                            this.mc.displayGuiScreen(new GuiScreenAddServer(this, this.selectedServer));
                            break block1;
                        }
                        if (button.id != 7 || !(var2 instanceof ServerListEntryNormal)) break block6;
                    ...
                    if (button.id != 0) break block7;
                    this.mc.displayGuiScreen(this.parentScreen);
                    break block1;
                }
                if (button.id != 8) break block8;
                this.refreshServerList();
                break block1;
            }
            if (button.id != 10) break block1;
            ModuleManager.chestStealer.toggle();
            button.displayString = String.valueOf(ModuleManager.chestStealer.isEnabled() ? "Disable" : "Enable") + " Thief";
        }
    }
    ...
    public void confirmClicked(boolean result, int id) {
        ...
        GuiListExtended.IGuiListEntry iGuiListEntry = var3 = this.serverListSelector.getSelectedSlot() < 0 ? null : this.serverListSelector.getListEntry(this.serverListSelector.getSelectedSlot());
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        int var3 = this.serverListSelector.getSelectedSlot();
        GuiListExtended.IGuiListEntry iGuiListEntry = var4 = var3 < 0 ? null : this.serverListSelector.getListEntry(var3);
        if (keyCode == 63) {
            this.refreshServerList();
        } else if (var3 >= 0) {
            if (keyCode == 200) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.title", new Object[0]), this.width / 2, 20.0f, 0xFFFFFF);
        ...
        if (!Client.ghostMode && this.mc.getSession() != null) {
            Client.fontNormal.drawString("Logged into " + (Object)((Object)EnumChatFormatting.GREEN) + this.mc.getSession().getUsername(), 5.0, 10.0, -1);
        }
    }

    public void connectToSelected() {
        GuiListExtended.IGuiListEntry var1;
        GuiListExtended.IGuiListEntry iGuiListEntry = var1 = this.serverListSelector.getSelectedSlot() < 0 ? null : this.serverListSelector.getListEntry(this.serverListSelector.getSelectedSlot());
        if (var1 instanceof ServerListEntryNormal) {
            Client.currentIP = ((ServerListEntryNormal)var1).getServerData().serverIP;
    ...
    public void func_175391_a(ServerListEntryNormal p_175391_1_, int p_175391_2_, boolean p_175391_3_) {
        ...
        if (this.serverListSelector.getSelectedSlot() == p_175391_2_) {
    ...
    public void func_175393_b(ServerListEntryNormal p_175393_1_, int p_175393_2_, boolean p_175393_3_) {
        ...
        if (this.serverListSelector.getSelectedSlot() == p_175393_2_) {
            this.selectServer(var4);
        }
        this.serverListSelector.func_148195_a(this.savedServerList);
    }
