...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_146393_h, this.width / 2, 8.0f, 0xFFFFFF);
        int var4 = this.width / 2 - 92 - 16;
        this.drawString(this.fontRendererObj, this.field_146394_i, var4, 32, 0xFFFFFF);
        this.drawString(this.fontRendererObj, this.field_146391_r, var4 + 2 + 213 - this.fontRendererObj.getStringWidth(this.field_146391_r), 32, 0xFFFFFF);
    ...
    extends GuiSlot {
        ...
        private void func_148225_a(int p_148225_1_, int p_148225_2_, ItemStack p_148225_3_) {
            ...
            if (p_148225_3_ != null && p_148225_3_.getItem() != null) {
                ...
                GuiCreateFlatWorld.this.itemRender.renderItem(p_148225_3_, p_148225_1_ + 2, p_148225_2_ + 2);
        ...
        private void func_148224_c(int p_148224_1_, int p_148224_2_, int p_148224_3_, int p_148224_4_) {
            ...
            var10.addVertexWithUV(p_148224_1_ + 0, p_148224_2_ + 18, GuiCreateFlatWorld.this.zLevel, (float)(p_148224_3_ + 0) * 0.0078125f, (float)(p_148224_4_ + 18) * 0.0078125f);
            var10.addVertexWithUV(p_148224_1_ + 18, p_148224_2_ + 18, GuiCreateFlatWorld.this.zLevel, (float)(p_148224_3_ + 18) * 0.0078125f, (float)(p_148224_4_ + 18) * 0.0078125f);
            var10.addVertexWithUV(p_148224_1_ + 18, p_148224_2_ + 0, GuiCreateFlatWorld.this.zLevel, (float)(p_148224_3_ + 18) * 0.0078125f, (float)(p_148224_4_ + 0) * 0.0078125f);
            var10.addVertexWithUV(p_148224_1_ + 0, p_148224_2_ + 0, GuiCreateFlatWorld.this.zLevel, (float)(p_148224_3_ + 0) * 0.0078125f, (float)(p_148224_4_ + 0) * 0.0078125f);
            var9.draw();
        }
        ...
        protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
            ...
            GuiCreateFlatWorld.this.fontRendererObj.drawStringNormal(var12, p_180791_2_ + 18 + 5, p_180791_3_ + 3, 0xFFFFFF);
            ...
            GuiCreateFlatWorld.this.fontRendererObj.drawStringNormal(var13, p_180791_2_ + 2 + 213 - GuiCreateFlatWorld.this.fontRendererObj.getStringWidth(var13), p_180791_3_ + 3, 0xFFFFFF);
        }
