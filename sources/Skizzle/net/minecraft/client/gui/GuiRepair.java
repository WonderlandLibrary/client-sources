...
implements ICrafting {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        this.fontRendererObj.drawStringNormal(I18n.format("container.repair", new Object[0]), 60.0f, 6.0f, 0x404040);
        if (this.anvil.maximumCost > 0) {
            ...
            if (var4) {
                ...
                if (this.fontRendererObj.getUnicodeFlag()) {
                    ...
                    this.fontRendererObj.drawStringNormal(var5, var7, var8 + 1, var6);
                    this.fontRendererObj.drawStringNormal(var5, var7 + 1, var8, var6);
                    this.fontRendererObj.drawStringNormal(var5, var7 + 1, var8 + 1, var6);
                }
                this.fontRendererObj.drawStringNormal(var5, var7, var8, var3);
            }
        }
