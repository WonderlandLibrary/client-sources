...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiOptionButton(201, var6, y += 21, Lang.get("of.options.details")));
        var6 = this.width / 2 - 155 + 160;
        this.buttonList.add(new GuiOptionButton(212, var6, y, Lang.get("of.options.performance")));
        var6 = this.width / 2 - 155 + 0;
        this.buttonList.add(new GuiOptionButton(211, var6, y += 21, Lang.get("of.options.animations")));
        var6 = this.width / 2 - 155 + 160;
    ...
    public void drawScreen(int x, int y, float z) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.screenTitle, this.width / 2, 15.0f, 0xFFFFFF);
        ...
        this.drawString(this.fontRendererObj, ver, 2, this.height - 10, 0x808080);
        String verMc = "Minecraft 1.8";
        int lenMc = this.fontRendererObj.getStringWidth(verMc);
        this.drawString(this.fontRendererObj, verMc, this.width - lenMc - 2, this.height - 10, 0x808080);
