...
implements GuiListExtended.IGuiListEntry {
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
        this.field_148293_a.fontRendererObj.drawStringNormal(I18n.format("lanServer.title", new Object[0]), x + 32 + 3, y + 1, 0xFFFFFF);
        this.field_148293_a.fontRendererObj.drawStringNormal(this.field_148291_b.getServerMotd(), x + 32 + 3, y + 12, 0x808080);
        if (this.field_148293_a.gameSettings.hideServerAddress) {
            this.field_148293_a.fontRendererObj.drawStringNormal(I18n.format("selectServer.hiddenAddress", new Object[0]), x + 32 + 3, y + 12 + 11, 0x303030);
        } else {
            this.field_148293_a.fontRendererObj.drawStringNormal(this.field_148291_b.getServerIpPort(), x + 32 + 3, y + 12 + 11, 0x303030);
        }
    }
