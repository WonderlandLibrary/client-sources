...
extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        this.fontRendererObj.drawStringNormal(var3, this.xSize / 2 - this.fontRendererObj.getStringWidth(var3) / 2, 6.0f, 0x404040);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (var4 != null && !var4.isEmpty()) {
            ...
            this.itemRender.renderItemOnScreen(var9, var5 + 36, var6 + 24);
            this.itemRender.func_175030_a(this.fontRendererObj, var9, var5 + 36, var6 + 24);
            if (var10 != null) {
                this.itemRender.renderItemOnScreen(var10, var5 + 62, var6 + 24);
                this.itemRender.func_175030_a(this.fontRendererObj, var10, var5 + 62, var6 + 24);
            }
            this.itemRender.renderItemOnScreen(var11, var5 + 120, var6 + 24);
