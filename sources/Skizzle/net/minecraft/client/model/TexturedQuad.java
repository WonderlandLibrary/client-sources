...
public class TexturedQuad {
    ...
    public void func_178765_a(WorldRenderer renderer, float scale) {
        ...
        for (int var6 = 0; var6 < 4; ++var6) {
            ...
            renderer.addVertexWithUV(var7.vector3D.xCoord * (double)scale, var7.vector3D.yCoord * (double)scale, var7.vector3D.zCoord * (double)scale, var7.texturePositionX, var7.texturePositionY);
        }
