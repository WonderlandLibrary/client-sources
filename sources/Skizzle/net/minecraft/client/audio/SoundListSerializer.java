            ...
            for (int var8 = 0; var8 < var7.size(); ++var8) {
                ...
                if (JsonUtils.jsonElementTypeIsString(var9)) {
                    ...
                    if (var11.has("volume")) {
                        ...
                        Validate.isTrue((var13 > 0.0f ? 1 : 0) != 0, (String)"Invalid volume", (Object[])new Object[0]);
                        var10.setSoundEntryVolume(var13);
                    }
                    if (var11.has("pitch")) {
                        float var13 = JsonUtils.getJsonObjectFloatFieldValue(var11, "pitch");
                        Validate.isTrue((var13 > 0.0f ? 1 : 0) != 0, (String)"Invalid pitch", (Object[])new Object[0]);
                        var10.setSoundEntryPitch(var13);
                    }
                    if (var11.has("weight")) {
                        int var14 = JsonUtils.getJsonObjectIntegerFieldValue(var11, "weight");
                        Validate.isTrue((var14 > 0 ? 1 : 0) != 0, (String)"Invalid weight", (Object[])new Object[0]);
