...
public class ModelBakery {
    ...
    static {
        ...
        field_177601_e = Joiner.on((String)" -> ");
    ...
    private void func_177577_b() {
        ...
        this.variants.put(MODEL_MISSING, new ModelBlockDefinition.Variants(MODEL_MISSING.func_177518_c(), Lists.newArrayList((Object[])new ModelBlockDefinition.Variant[]{new ModelBlockDefinition.Variant(new ResourceLocation(MODEL_MISSING.getResourcePath()), ModelRotation.X0_Y0, false, 1)})));
    ...
    private void loadVariants(Collection p_177591_1_) {
        for (ModelResourceLocation var3 : p_177591_1_) {
            try {
                ...
                LOGGER.warn("Unable to load definition " + var3, (Throwable)var7);
            }
        }
    }
    ...
    private void func_177595_c() {
        for (ModelResourceLocation var2 : this.variants.keySet()) {
            for (ModelBlockDefinition.Variant var4 : ((ModelBlockDefinition.Variants)this.variants.get(var2)).getVariants()) {
                ResourceLocation var5 = var4.getModelLocation();
                if (this.models.get(var5) != null) continue;
                try {
                    ModelBlock var6 = this.loadModel(var5);
                    this.models.put(var5, var6);
                }
                catch (Exception var7) {
                    LOGGER.warn("Unable to load block model: '" + var5 + "' for variant: '" + var2 + "'", (Throwable)var7);
                }
            }
        }
    }
    ...
    private ModelBlock loadModel(ResourceLocation p_177594_1_) throws IOException {
        ...
        try {
            ModelBlock var10 = ModelBlock.deserialize(var2);
    ...
    private void loadItemModels() {
        ...
        for (Item var2 : Item.itemRegistry) {
            ...
            for (String var5 : var3) {
                ...
                if (this.models.get(var6) != null) continue;
                try {
                    ModelBlock var7 = this.loadModel(var6);
                    this.models.put(var6, var7);
                }
                catch (Exception var8) {
                    LOGGER.warn("Unable to load item model: '" + var6 + "' for item: '" + Item.itemRegistry.getNameForObject(var2) + "'", (Throwable)var8);
                }
            }
        }
    }
    ...
    private List getVariantNames(Item p_177596_1_) {
        List<String> var2 = (List<String>)this.variantNames.get(p_177596_1_);
        if (var2 == null) {
    ...
    private void bakeBlockModels() {
        for (ModelResourceLocation modelResourceLocation : this.variants.keySet()) {
            ...
            int var4 = 0;
            for (ModelBlockDefinition.Variant var6 : ((ModelBlockDefinition.Variants)this.variants.get(modelResourceLocation)).getVariants()) {
            ...
            if (var4 == 1) {
                this.bakedRegistry.putObject(modelResourceLocation, var3.first());
                continue;
            }
            this.bakedRegistry.putObject(modelResourceLocation, var3.build());
        }
        for (Map.Entry entry : this.itemLocations.entrySet()) {
            ResourceLocation var9 = (ResourceLocation)entry.getValue();
            ModelResourceLocation var10 = new ModelResourceLocation((String)entry.getKey(), "inventory");
    ...
    private IBakedModel bakeModel(ModelBlock p_177578_1_, ModelRotation p_177578_2_, boolean p_177578_3_) {
        ...
        for (BlockPart var7 : p_177578_1_.getElements()) {
    ...
    private void func_177574_i() {
        ...
        while (!var1.isEmpty()) {
            ...
            try {
                if (this.models.get(var7) != null) continue;
                ...
                LOGGER.warn("In parent chain: " + field_177601_e.join((Iterable)this.func_177573_e(var7)) + "; unable to load model: '" + var7 + "'", (Throwable)var6);
            }
            var2.add(var7);
        }
    }
    ...
    private List func_177573_e(ResourceLocation p_177573_1_) {
        ArrayList var2 = Lists.newArrayList((Object[])new ResourceLocation[]{p_177573_1_});
    ...
    private ResourceLocation func_177576_f(ResourceLocation p_177576_1_) {
        ...
        do {
            ...
            return null;
        } while ((var4 = (ModelBlock)(var3 = var2.next()).getValue()) == null || !p_177576_1_.equals(var4.getParentLocation()));
        return (ResourceLocation)var3.getKey();
    }

    private Set func_177585_a(ModelBlock p_177585_1_) {
        HashSet var2 = Sets.newHashSet();
        for (BlockPart var4 : p_177585_1_.getElements()) {
            for (BlockPartFace var6 : var4.field_178240_c.values()) {
    ...
    private Set func_177571_k() {
        ...
        for (ResourceLocation var3 : this.itemLocations.values()) {
            ...
            if (this.isCustomRenderer(var4)) continue;
            for (BlockPart var6 : var4.getElements()) {
                for (BlockPartFace var8 : var6.field_178240_c.values()) {
    ...
    private void bakeItemModels() {
        for (ResourceLocation var2 : this.itemLocations.values()) {
            ...
            if (!this.isCustomRenderer(var3)) continue;
            this.models.put(var2, var3);
        }
        for (TextureAtlasSprite var5 : this.field_177599_g.values()) {
            if (var5.hasAnimationMetadata()) continue;
