...
implements IResourceManager {
    ...
    public IResource getResource(ResourceLocation p_110536_1_) throws IOException {
        ...
        ResourceLocation var3 = FallbackResourceManager.getLocationMcmeta(p_110536_1_);
        for (int var4 = this.resourcePacks.size() - 1; var4 >= 0; --var4) {
            ...
            if (!var5.resourceExists(p_110536_1_)) continue;
    ...
    public List getAllResources(ResourceLocation p_135056_1_) throws IOException {
        ...
        ResourceLocation var3 = FallbackResourceManager.getLocationMcmeta(p_135056_1_);
        for (IResourcePack var5 : this.resourcePacks) {
            if (!var5.resourceExists(p_135056_1_)) continue;
    ...
    static ResourceLocation getLocationMcmeta(ResourceLocation p_110537_0_) {
        return new ResourceLocation(p_110537_0_.getResourceDomain(), String.valueOf(p_110537_0_.getResourcePath()) + ".mcmeta");
    }
    ...
    extends InputStream {
        ...
        protected void finalize() throws Throwable {
            if (!this.field_177329_c) {
                field_177246_b.warn(this.field_177328_b);
            }
            super.finalize();
        }
