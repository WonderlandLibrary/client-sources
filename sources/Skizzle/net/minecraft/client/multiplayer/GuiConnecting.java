            ...
            public void run() {
                ...
                try {
                    ...
                    if (ip.contains("mineplex")) {
                        ModuleManager.killaura.mineplex = true;
                    }
                    DiscordClient.getInstance().getDiscordRP().update("Playing " + Client.currentIP + (port != 25565 ? ":" + port : ""), "In Game");
                }
                    ...
                    GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", "Unknown host"), ip, port));
                }
                    ...
                    GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", var3), ip, port));
                }
            }
        }.start();
    }
