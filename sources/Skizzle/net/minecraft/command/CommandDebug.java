...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args[0].equals("start")) {
            ...
            CommandDebug.notifyOperators(sender, (ICommand)this, "commands.debug.stop", Float.valueOf((float)var6 / 1000.0f), var8);
        } else if (args[0].equals("chunk")) {
            if (args.length != 4) {
                throw new WrongUsageException("commands.debug.usage", new Object[0]);
            }
            CommandDebug.func_175757_a(sender, args, 1, true);
        }
    }
    ...
    private void func_147202_a(int p_147202_1_, String p_147202_2_, StringBuilder p_147202_3_) {
        ...
        if (var4 != null && var4.size() >= 3) {
            for (int var5 = 1; var5 < var4.size(); ++var5) {
                ...
                if (var6.field_76331_c.equals("unspecified")) continue;
                try {
                    this.func_147202_a(p_147202_1_ + 1, String.valueOf(p_147202_2_) + "." + var6.field_76331_c, p_147202_3_);
                    continue;
                }
