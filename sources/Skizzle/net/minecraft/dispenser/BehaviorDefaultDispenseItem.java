...
implements IBehaviorDispenseItem {
    ...
    public static void doDispense(World worldIn, ItemStack stack, int speed, EnumFacing p_82486_3_, IPosition position) {
        ...
        var11.motionX += worldIn.rand.nextGaussian() * (double)0.0075f * (double)speed;
        var11.motionY += worldIn.rand.nextGaussian() * (double)0.0075f * (double)speed;
        var11.motionZ += worldIn.rand.nextGaussian() * (double)0.0075f * (double)speed;
