...
extends LegacyBlockItemRewriter<Protocol1_10To1_11> {
    ...
    protected void registerPackets() {
        ...
        ((Protocol1_10To1_11)this.protocol).registerOutgoing(ClientboundPackets1_9_3.SET_SLOT, new PacketRemapper(){
        ...
        ((Protocol1_10To1_11)this.protocol).registerOutgoing(ClientboundPackets1_9_3.WINDOW_ITEMS, new PacketRemapper(){
        ...
        ((Protocol1_10To1_11)this.protocol).registerOutgoing(ClientboundPackets1_9_3.PLUGIN_MESSAGE, new PacketRemapper(){
        ...
        ((Protocol1_10To1_11)this.protocol).registerIncoming(ServerboundPackets1_9_3.CLICK_WINDOW, new PacketRemapper(){
        ...
        ((Protocol1_10To1_11)this.protocol).registerOutgoing(ClientboundPackets1_9_3.CHUNK_DATA, new PacketRemapper(){
        ...
        ((Protocol1_10To1_11)this.protocol).registerOutgoing(ClientboundPackets1_9_3.BLOCK_CHANGE, new PacketRemapper(){
        ...
        ((Protocol1_10To1_11)this.protocol).registerOutgoing(ClientboundPackets1_9_3.MULTI_BLOCK_CHANGE, new PacketRemapper(){
        ...
        ((Protocol1_10To1_11)this.protocol).registerOutgoing(ClientboundPackets1_9_3.BLOCK_ENTITY_DATA, new PacketRemapper(){
        ...
        ((Protocol1_10To1_11)this.protocol).registerOutgoing(ClientboundPackets1_9_3.OPEN_WINDOW, new PacketRemapper(){
        ...
        ((Protocol1_10To1_11)this.protocol).registerOutgoing(ClientboundPackets1_9_3.CLOSE_WINDOW, new PacketRemapper(){
        ...
        ((Protocol1_10To1_11)this.protocol).registerIncoming(ServerboundPackets1_9_3.CLOSE_WINDOW, new PacketRemapper(){
    ...
    protected void registerRewrites() {
        MappedLegacyBlockItem data = this.replacementData.computeIfAbsent(52, s -> new MappedLegacyBlockItem(52, -1, null, false));
    ...
    private boolean isLlama(UserConnection user) {
        ...
        if (tracker.getInventory() != null && tracker.getInventory().equals("EntityHorse")) {
            EntityTracker.ProtocolEntityTracker entTracker = user.get(EntityTracker.class).get((BackwardsProtocol)this.getProtocol());
    ...
    private Optional<ChestedHorseStorage> getChestedHorse(UserConnection user) {
        EntityTracker.ProtocolEntityTracker entTracker;
        EntityTracker.StoredEntity storedEntity;
        WindowTracker tracker = user.get(WindowTracker.class);
        if (tracker.getInventory() != null && tracker.getInventory().equals("EntityHorse") && (storedEntity = (entTracker = user.get(EntityTracker.class).get((BackwardsProtocol)this.getProtocol())).getEntity(tracker.getEntityId())) != null) {
    ...
    private Item getNewItem(ChestedHorseStorage storage, int slotId, Item current) {
        ...
        if (slotId >= startNonExistingFormula && slotId < endNonExistingFormula) {
            return new Item(166, 1, 0, this.getNamedTag(ChatColor.RED + "SLOT DISABLED"));
        }
        if (slotId == 1) {
            return null;
        }
