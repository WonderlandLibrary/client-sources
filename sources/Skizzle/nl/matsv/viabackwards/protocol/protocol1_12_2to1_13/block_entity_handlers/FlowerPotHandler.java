...
implements BackwardsBlockEntityProvider.BackwardsBlockEntityHandler {
    private static final Int2ObjectMap<Pair<String, Byte>> FLOWERS = new Int2ObjectOpenHashMap<Pair<String, Byte>>(22, 1.0f);
    ...
    public CompoundTag transform(UserConnection user, int blockId, CompoundTag tag) {
        ...
        tag.put(new IntTag("Data", item.getValue().byteValue()));
        return tag;
    }
