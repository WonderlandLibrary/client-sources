...
public class BlockItemPackets1_17
extends ItemRewriter<Protocol1_16_4To1_17> {
    ...
    protected void registerPackets() {
        ...
        ((Protocol1_16_4To1_17)this.protocol).registerOutgoing(ClientboundPackets1_16_2.UPDATE_LIGHT, new PacketRemapper(){
            ...
            public void registerMap() {
                this.handler(wrapper -> {
                    ...
                    wrapper.write(Type.VAR_INT, wrapper.read(Type.VAR_LONG).intValue());
                    wrapper.write(Type.VAR_INT, wrapper.read(Type.VAR_LONG).intValue());
                    wrapper.write(Type.VAR_INT, wrapper.read(Type.VAR_LONG).intValue());
                    wrapper.write(Type.VAR_INT, wrapper.read(Type.VAR_LONG).intValue());
                });
        ...
        ((Protocol1_16_4To1_17)this.protocol).registerOutgoing(ClientboundPackets1_16_2.CHUNK_DATA, new PacketRemapper(){
        ...
        ((Protocol1_16_4To1_17)this.protocol).registerIncoming(ServerboundPackets1_16_2.EDIT_BOOK, new PacketRemapper(){
