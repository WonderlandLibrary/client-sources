...
import us.myles.viaversion.libs.javassist.tools.reflect.CompiledClass;
    ...
    private static void processClasses(CompiledClass[] entries, int n) throws Exception {
        ...
        for (i = 0; i < n; ++i) {
            ...
            if (entries[i].metaobject != null || entries[i].classobject != null) {
                String metaobj = entries[i].metaobject == null ? "us.myles.viaversion.libs.javassist.tools.reflect.Metaobject" : entries[i].metaobject;
                String classobj = entries[i].classobject == null ? "us.myles.viaversion.libs.javassist.tools.reflect.ClassMetaobject" : entries[i].classobject;
