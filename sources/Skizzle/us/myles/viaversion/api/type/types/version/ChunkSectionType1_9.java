...
extends Type<ChunkSection> {
    ...
    public ChunkSection read(ByteBuf buffer) throws Exception {
        ...
        if (blockData.length > 0) {
            ...
            CompactArrayUtil.iterateCompactArray(bitsPerBlock, 4096, blockData, bitsPerBlock == 13 ? (arg_0, arg_1) -> chunkSection.setFlatBlock(arg_0, arg_1) : (arg_0, arg_1) -> chunkSection.setPaletteIndex(arg_0, arg_1));
        }
        return chunkSection;
    }
