...
import us.myles.ViaVersion.api.protocol.VersionRange;
...
public class ProtocolVersion {
    ...
    public static final ProtocolVersion v1_16_4 = ProtocolVersion.register(754, "1.16.4");
    public static final ProtocolVersion v1_17 = ProtocolVersion.register(755, 5, "1.17");
    ...
    public ProtocolVersion(int version, int snapshotVersion, String name, @Nullable VersionRange versionRange) {
        ...
        if (versionRange != null) {
            this.includedVersions = new HashSet<String>();
