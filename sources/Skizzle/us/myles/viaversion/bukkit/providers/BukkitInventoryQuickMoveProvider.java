...
extends InventoryQuickMoveProvider {
    ...
    public boolean registerQuickMoveAction(short windowId, short slotId, short actionId, UserConnection userConnection) {
        ...
        if (windowId == 0 && slotId >= 36 && slotId <= 44 && (protocolId = ProtocolRegistry.SERVER_PROTOCOL) == ProtocolVersion.v1_8.getVersion()) {
            return false;
        }
    ...
    public Object buildWindowClickPacket(Player p, ItemTransaction storage) {
        ...
        if (tinvtype != null && (protocolId = ProtocolRegistry.SERVER_PROTOCOL) == ProtocolVersion.v1_8.getVersion() && tinvtype == InventoryType.BREWING && slotId >= 5 && slotId <= 40) {
        ...
        if (slotId <= inv.countSlots()) {
            ...
            String cause = "Too many inventory slots: slotId: " + slotId + " invSlotCount: " + inv.countSlots() + " invType: " + (Object)inv.getType() + " topInvType: " + (Object)tinvtype;
        ...
        try {
            ...
            int protocolId2 = ProtocolRegistry.SERVER_PROTOCOL;
