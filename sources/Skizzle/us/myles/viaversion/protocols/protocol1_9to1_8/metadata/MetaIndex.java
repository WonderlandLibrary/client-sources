...
public enum MetaIndex {
    ...
    private MetaIndex(Entity1_10Types.EntityType type, int index, MetaType1_8 oldType, MetaType1_9 newType) {
        this.clazz = type;
        this.index = index;
        this.newIndex = index;
    ...
    private MetaIndex(Entity1_10Types.EntityType type, int index, MetaType1_8 oldType, int newIndex, MetaType1_9 newType) {
        this.clazz = type;
        this.index = index;
        this.oldType = oldType;
