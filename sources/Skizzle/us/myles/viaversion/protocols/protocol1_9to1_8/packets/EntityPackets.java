            ...
            public void registerMap() {
                ...
                this.handler(new PacketHandler(){
                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ...
                        if (Via.getConfig().isHologramPatch() && (tracker = wrapper.user().get(EntityTracker1_9.class)).getKnownHolograms().contains(entityID)) {
            ...
            public void registerMap() {
                ...
                this.map(Type.SHORT, new ValueTransformer<Short, Integer>((Type)Type.VAR_INT){
                    ...
                    public Integer transform(PacketWrapper wrapper, Short slot) throws Exception {
                        int receiverId;
                        int entityId = wrapper.get(Type.VAR_INT, 0);
                        if (entityId == (receiverId = wrapper.user().get(EntityTracker1_9.class).getClientEntityId())) {
            ...
            public void registerMap() {
                ...
                this.handler(new PacketHandler(){
                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ...
                        if (wrapper.get(Type.VAR_INT, 0).intValue() != wrapper.user().get(EntityTracker1_9.class).getProvidedEntityId()) {
                            return;
                        }
