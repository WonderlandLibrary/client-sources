...
@Getter
@Setter
@FunctionRegister(name = "AuctionHelper", type = Category.RENDER, desc = "Показывает самые дешевые предметы")
public class AuctionHelper extends Function {

    public BooleanSetting three = new BooleanSetting("3 слота", true );
