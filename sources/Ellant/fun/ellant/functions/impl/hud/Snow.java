...
@FunctionRegister(name = "WorldParticles", type = Category.RENDER, desc = "Снег")
public class Snow extends Function {
    private final ModeSetting setting = new ModeSetting("Вид", "Доллары", "Доллары", "Снежинки", "Орбизы", "Сердечки", "Молния", "Звездочки");
