package fun.ellant.ui.mainmenu;
...
public class AltWidget implements IMinecraft {
    ...
    public void render(MatrixStack stack, int x, int y) {
        ...
        // Центрирование виджета по горизонтали
        this.x = (mc.getMainWindow().getScaledWidth() - width) / 2;
        ...
        if (open) {
            ...
            DisplayUtils.drawRoundedRect(this.x + 5, this.y + 26 + i * 17 + scroll, width - 10, 15, 3, ColorUtils.rgba(30, 30, 36, 64));
