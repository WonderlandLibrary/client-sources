...
public class AncientPotion implements ElementRenderer
{
    ...
    public void render(final EventDisplay eventDisplay) {
        ...
        DisplayUtils.drawShadow(posX - 2, posY, 3, 19.3f, 7, ColorUtils.getColor(0));
        ...
        for (EffectInstance ef : PotionRenderer.mc.player.getActivePotionEffects()) {
            ...
            DisplayUtils.drawShadow(posX - 2, posY, 3, 12.3f, 7, ColorUtils.getColor(0));
    ...
    public AncientPotion(final Dragging dragging) {
