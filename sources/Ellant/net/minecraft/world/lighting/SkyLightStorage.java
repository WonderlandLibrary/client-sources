...
public class SkyLightStorage extends SectionLightStorage<SkyLightStorage.StorageMap>
{
    ...
    {
        super(LightType.SKY, lightProvider, new StorageMap(new Long2ObjectOpenHashMap<>(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
    }
    ...
    protected int getLightOrDefault(long worldPos)
    {
        ...
        StorageMap skylightstorage$storagemap = this.uncachedLightData;
    ...
    public static final class StorageMap extends LightDataMap<StorageMap>
    {
        ...
        {
            return new StorageMap(this.arrays.clone(), this.surfaceSections.clone(), this.minY);
        }
    }
}
