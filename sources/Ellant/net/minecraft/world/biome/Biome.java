...
public final class Biome
{
    ...
    {
        return builder.group(Climate.CODEC.forGetter((biome) -> {
            return biome.climate;
        }), Category.CODEC.fieldOf("category").forGetter((biome) -> {
    ...
    {
        public static final Codec<Attributes> CODEC = RecordCodecBuilder.create((builder) ->
        {
    ...
    public static class Builder
    {
        ...
        public Biome build()
        {
            ...
            {
                return new Biome(new Climate(this.precipitation, this.temperature, this.temperatureModifier, this.downfall), this.category, this.depth, this.scale, this.effects, this.generationSettings, this.mobSpawnSettings);
            }
            else
            {
    ...
    public static enum Category implements IStringSerializable
    {
        ...
        private static final Map<String, Category> BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(Category::getName, (category) -> {
            return category;
        }));
    ...
    {
        public static final MapCodec<Climate> CODEC = RecordCodecBuilder.mapCodec((builder) ->
        {
            return builder.group(RainType.CODEC.fieldOf("precipitation").forGetter((precipitation) -> {
                return precipitation.precipitation;
            }), Codec.FLOAT.fieldOf("temperature").forGetter((climate) -> {
                return climate.temperature;
            }), TemperatureModifier.CODEC.optionalFieldOf("temperature_modifier", TemperatureModifier.NONE).forGetter((climate) -> {
    ...
    public static enum RainType implements IStringSerializable
    {
        ...
        private static final Map<String, RainType> BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(RainType::getName, (precipitation) -> {
    ...
    public static enum TemperatureModifier implements IStringSerializable
    {
        ...
        private static final Map<String, TemperatureModifier> NAME_TO_MODIFIER_MAP = Arrays.stream(values()).collect(Collectors.toMap(TemperatureModifier::getName, (temperatureModifier) -> {
