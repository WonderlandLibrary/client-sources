...
public class BiomeAmbience
{
    public static final Codec<BiomeAmbience> CODEC = RecordCodecBuilder.create((builder) ->
    {
        ...
        }), GrassColorModifier.CODEC.optionalFieldOf("grass_color_modifier", GrassColorModifier.NONE).forGetter((ambience) -> {
    ...
    public static enum GrassColorModifier implements IStringSerializable
    {
        ...
        public static final Codec<GrassColorModifier> CODEC = IStringSerializable.createEnumCodec(GrassColorModifier::values, GrassColorModifier::byName);
        private static final Map<String, GrassColorModifier> NAME_TO_MODIFIER_MAP = Arrays.stream(values()).collect(Collectors.toMap(GrassColorModifier::getName, (modifier) -> {
            return modifier;
        }));
