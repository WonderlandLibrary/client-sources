...
public class OceanMonumentPieces
{
    ...
    {
        public DoubleXRoom(Direction p_i50661_1_, RoomDefinition p_i50661_2_)
        {
        ...
        {
            RoomDefinition oceanmonumentpieces$roomdefinition = this.roomDefinition.connections[Direction.EAST.getIndex()];
            RoomDefinition oceanmonumentpieces$roomdefinition1 = this.roomDefinition;
    ...
    {
        public DoubleXYRoom(Direction p_i50659_1_, RoomDefinition p_i50659_2_)
        {
        ...
        public boolean func_230383_a_(ISeedReader p_230383_1_, StructureManager p_230383_2_, ChunkGenerator p_230383_3_, Random p_230383_4_, MutableBoundingBox p_230383_5_, ChunkPos p_230383_6_, BlockPos p_230383_7_)
        {
            RoomDefinition oceanmonumentpieces$roomdefinition = this.roomDefinition.connections[Direction.EAST.getIndex()];
            RoomDefinition oceanmonumentpieces$roomdefinition1 = this.roomDefinition;
            RoomDefinition oceanmonumentpieces$roomdefinition2 = oceanmonumentpieces$roomdefinition1.connections[Direction.UP.getIndex()];
            RoomDefinition oceanmonumentpieces$roomdefinition3 = oceanmonumentpieces$roomdefinition.connections[Direction.UP.getIndex()];
    ...
    {
        public DoubleYRoom(Direction p_i50657_1_, RoomDefinition p_i50657_2_)
        {
        ...
        public boolean func_230383_a_(ISeedReader p_230383_1_, StructureManager p_230383_2_, ChunkGenerator p_230383_3_, Random p_230383_4_, MutableBoundingBox p_230383_5_, ChunkPos p_230383_6_, BlockPos p_230383_7_)
        {
            ...
            RoomDefinition oceanmonumentpieces$roomdefinition = this.roomDefinition.connections[Direction.UP.getIndex()];
    ...
    {
        public DoubleYZRoom(Direction p_i50655_1_, RoomDefinition p_i50655_2_)
        {
        ...
        public boolean func_230383_a_(ISeedReader p_230383_1_, StructureManager p_230383_2_, ChunkGenerator p_230383_3_, Random p_230383_4_, MutableBoundingBox p_230383_5_, ChunkPos p_230383_6_, BlockPos p_230383_7_)
        {
            RoomDefinition oceanmonumentpieces$roomdefinition = this.roomDefinition.connections[Direction.NORTH.getIndex()];
            RoomDefinition oceanmonumentpieces$roomdefinition1 = this.roomDefinition;
            RoomDefinition oceanmonumentpieces$roomdefinition2 = oceanmonumentpieces$roomdefinition.connections[Direction.UP.getIndex()];
            RoomDefinition oceanmonumentpieces$roomdefinition3 = oceanmonumentpieces$roomdefinition1.connections[Direction.UP.getIndex()];
    ...
    {
        public DoubleZRoom(Direction p_i50653_1_, RoomDefinition p_i50653_2_)
        {
    ...
    {
        public EntryRoom(Direction p_i45592_1_, RoomDefinition p_i45592_2_)
        {
    ...
    static class FitSimpleRoomHelper implements IMonumentRoomFitHelper
    {
        ...
        public Piece create(Direction p_175968_1_, RoomDefinition p_175968_2_, Random p_175968_3_)
        {
    ...
    static class FitSimpleRoomTopHelper implements IMonumentRoomFitHelper
    {
    ...
    interface IMonumentRoomFitHelper
    {
        ...
        Piece create(Direction p_175968_1_, RoomDefinition p_175968_2_, Random p_175968_3_);
    }
    ...
    public static class MonumentBuilding extends Piece
    {
        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, Direction p_i45599_4_)
        {
            ...
            this.childPieces.add(new EntryRoom(direction, this.sourceRoom));
            this.childPieces.add(new MonumentCoreRoom(direction, this.coreRoom));
            List<IMonumentRoomFitHelper> list1 = Lists.newArrayList();
            ...
            for (RoomDefinition oceanmonumentpieces$roomdefinition : list)
            {
                if (!oceanmonumentpieces$roomdefinition.claimed && !oceanmonumentpieces$roomdefinition.isSpecial())
                {
                    for (IMonumentRoomFitHelper oceanmonumentpieces$imonumentroomfithelper : list1)
                    {
            ...
            for (Piece oceanmonumentpieces$piece : this.childPieces)
            {
            ...
            this.childPieces.add(new WingRoom(direction, mutableboundingbox1, i++));
            this.childPieces.add(new WingRoom(direction, mutableboundingbox2, i++));
            this.childPieces.add(new Penthouse(direction, mutableboundingbox));
        }
        ...
        private List<RoomDefinition> generateRoomGraph(Random p_175836_1_)
        {
            ...
            for (RoomDefinition oceanmonumentpieces$roomdefinition4 : aoceanmonumentpieces$roomdefinition)
            {
            ...
            for (RoomDefinition oceanmonumentpieces$roomdefinition3 : list)
            {
                int j5 = 0;
                int k5 = 0;
    ...
    {
        public MonumentCoreRoom(Direction p_i50663_1_, RoomDefinition p_i50663_2_)
        {
    ...
    public abstract static class Piece extends StructurePiece
    {
        ...
        protected Piece(IStructurePieceType p_i50649_1_, int p_i50649_2_, Direction p_i50649_3_, RoomDefinition p_i50649_4_, int p_i50649_5_, int p_i50649_6_, int p_i50649_7_)
        {
    ...
    public static class SimpleRoom extends Piece
    {
        ...
        public SimpleRoom(Direction p_i45587_1_, RoomDefinition p_i45587_2_, Random p_i45587_3_)
        {
    ...
    static class XDoubleRoomFitHelper implements IMonumentRoomFitHelper
    {
    ...
    static class XYDoubleRoomFitHelper implements IMonumentRoomFitHelper
    {
    ...
    static class YDoubleRoomFitHelper implements IMonumentRoomFitHelper
    {
    ...
    static class YZDoubleRoomFitHelper implements IMonumentRoomFitHelper
    {
    ...
    static class ZDoubleRoomFitHelper implements IMonumentRoomFitHelper
    {
