...
import fun.ellant.functions.impl.player.AutoTool;
...
public abstract class PlayerEntity extends LivingEntity {
    ...
    public void tick() {
        ...
        Ellant.getInstance().getEventBus().post(livingUpdate);
    ...
    public boolean func_234569_d_(BlockState p_234569_1_) {
        AutoTool autoTool = Ellant.getInstance().getFunctionRegistry().getAutoTool();
