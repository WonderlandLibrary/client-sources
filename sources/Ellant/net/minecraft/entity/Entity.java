...
import fun.ellant.events.EventStartRiding;
import fun.ellant.events.MovingEvent;
import fun.ellant.events.PostMoveEvent;
import fun.ellant.functions.api.FunctionRegistry;
import fun.ellant.functions.impl.combat.Hitbox;
import fun.ellant.functions.impl.render.Trails;
import fun.ellant.scripts.lua.classes.EntityClass;
...
public abstract class Entity implements INameable, ICommandSource {
    ...
    public void move(MoverType typeIn, Vector3d pos) {
        ...
        if (this.noClip) {
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Ellant.getInstance().getEventBus().post(move);
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Ellant.getInstance().getEventBus().post(post);
            }
    ...
    public boolean startRiding(Entity entityIn, boolean force) {
        Ellant.getInstance().getEventBus().post(new EventStartRiding(entityIn));
