...
import fun.ellant.functions.impl.render.NameProtect;
...
public interface ITextComponent extends Message, ITextProperties
{
     ...
     * component (IE, there is no need to call {@link #(Style)} again after modifying it).
     *  
     ...
     * example, this is the raw text in a {@link }, but it's the translated text for a {@link
     * } and it's the score value for a {@link }.
     */
