...
import fun.ellant.events.EventCalculateCooldown;
import fun.ellant.events.EventCooldown;
...
public class CooldownTracker {
    ...
    public float getCooldown(Item itemIn, float partialTicks) {
        ...
        Ellant.getInstance().getEventBus().post(cooldown);
        ...
        if (!this.cooldowns.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                if ((entry.getValue()).expireTicks <= this.ticks) {
                    ...
                    Ellant.getInstance().getEventBus().post(eventCooldown);
                    iterator.remove();
