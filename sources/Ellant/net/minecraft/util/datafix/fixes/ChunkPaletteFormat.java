...
public class ChunkPaletteFormat extends DataFix
{
    ...
    static class Section
    {
        ...
        public int upgrade(int p_199207_1_)
        {
            ...
            else
            {
                ...
                NibbleArray chunkpaletteformat$nibblearray = this.section.get("Data").asByteBufferOpt().map((p_210055_0_) ->
                {
                    return new NibbleArray(DataFixUtils.toArray(p_210055_0_));
                }).result().orElseGet(NibbleArray::new);
                NibbleArray chunkpaletteformat$nibblearray1 = this.section.get("Add").asByteBufferOpt().map((p_210052_0_) ->
                {
                    return new NibbleArray(DataFixUtils.toArray(p_210052_0_));
                }).result().orElseGet(NibbleArray::new);
    ...
    static final class UpgradeChunk
    {
        ...
        public UpgradeChunk(Dynamic<?> p_i231449_1_)
        {
            ...
            p_i231449_1_.get("Sections").asStreamOpt().result().ifPresent((p_210062_1_) ->
            {
                p_210062_1_.forEach((p_210065_1_) -> {
                    Section chunkpaletteformat$section1 = new Section(p_210065_1_);
            ...
            for (Section chunkpaletteformat$section : this.sections)
            {
                ...
                {
                    for (Map.Entry<Integer, IntList> entry : chunkpaletteformat$section.toFix.entrySet())
                    {
                        ...
                        switch (entry.getKey())
                        {
                            case 2:
                                for (int i3 : entry.getValue())
                                {
                                    ...
                                    {
                                        String s12 = ChunkPaletteFormat.getName(this.getBlock(relative(i3, Direction.UP)));
                            ...
                            case 3:
                                for (int l2 : entry.getValue())
                                {
                                    ...
                                    {
                                        String s11 = ChunkPaletteFormat.getName(this.getBlock(relative(l2, Direction.UP)));
                            ...
                            case 197:
                                for (int i2 : entry.getValue())
                                {
                                    ...
                                    if (ChunkPaletteFormat.getName(dynamic7).endsWith("_door"))
                                    {
                                        ...
                                        {
                                            int j3 = relative(i2, Direction.UP);
                            ...
                            case 86:
                                for (int l1 : entry.getValue())
                                {
                                    ...
                                    {
                                        String s9 = ChunkPaletteFormat.getName(this.getBlock(relative(l1, Direction.DOWN)));
                            ...
                            case 110:
                                for (int k1 : entry.getValue())
                                {
                                    ...
                                    {
                                        String s8 = ChunkPaletteFormat.getName(this.getBlock(relative(k1, Direction.UP)));
                            ...
                            case 175:
                                for (int l : entry.getValue())
                                {
                                    ...
                                    {
                                        Dynamic<?> dynamic12 = this.getBlock(relative(l, Direction.DOWN));
        ...
        private void setBlock(int p_210060_1_, Dynamic<?> p_210060_2_)
        {
            ...
            {
                Section chunkpaletteformat$section = this.getSection(p_210060_1_);
