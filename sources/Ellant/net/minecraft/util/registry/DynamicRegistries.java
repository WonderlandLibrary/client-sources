...
public abstract class DynamicRegistries
{
    ...
    private static final Map < RegistryKey <? extends Registry<? >> , CodecHolder<? >> registryCodecMap = Util.make(() ->
    {
        Builder < RegistryKey <? extends Registry<? >> , CodecHolder<? >> builder = ImmutableMap.builder();
    ...
    private static <E> void put(Builder < RegistryKey <? extends Registry<? >> , CodecHolder<? >> codecHolder, RegistryKey <? extends Registry<E >> registryKey, Codec<E> codec)
    {
        codecHolder.put(registryKey, new CodecHolder<>(registryKey, codec, (Codec<E>)null));
    }

    private static <E> void put(Builder < RegistryKey <? extends Registry<? >> , CodecHolder<? >> codecHolder, RegistryKey <? extends Registry<E >> registryKey, Codec<E> codec, Codec<E> codec2)
    {
        codecHolder.put(registryKey, new CodecHolder<>(registryKey, codec, codec2));
    }
    ...
    public static final class Impl extends DynamicRegistries
    {
        ...
        {
            return unboundedCodec.xmap(Impl::new, (dynamicRegistries) ->
            {
                return ((java.util.Set<Entry<K, V>>)(Object)(dynamicRegistries.keyToSimpleRegistryMap.entrySet())).stream().filter((entry) -> {
        ...
        public Impl()
        {
            this(DynamicRegistries.registryCodecMap.keySet().stream().collect(Collectors.toMap(Function.identity(), Impl::createStableRegistry)));
        }
