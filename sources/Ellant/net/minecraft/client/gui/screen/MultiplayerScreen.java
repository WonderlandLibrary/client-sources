...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = Ellant.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(Ellant.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        Ellant.getInstance().getViaMCP().viaScreen.tick();
