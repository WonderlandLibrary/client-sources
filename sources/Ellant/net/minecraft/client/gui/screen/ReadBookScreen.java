...
public class ReadBookScreen extends Screen
{
    ...
    default ITextProperties func_238806_b_(int p_238806_1_)
        ...
        static IBookInfo func_216917_a(ItemStack p_216917_0_)
        {
            ...
            {
                return (IBookInfo)(item == Items.WRITABLE_BOOK ? new UnwrittenBookInfo(p_216917_0_) : ReadBookScreen.EMPTY_BOOK);
            }
        }
    }
