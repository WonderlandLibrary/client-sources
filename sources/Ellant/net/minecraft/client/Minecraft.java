...
import fun.ellant.events.EventChangeWorld;
...
import fun.ellant.functions.impl.player.ItemCooldown;
...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
    ...
    public void setDefaultMinecraftTitle() {
        ...
        if (selfDestruct.unhooked) {
            ...
            this.mainWindow.setWindowTitle("Ellant client | dsc.gg/ellantclient");
        }
    }
    ...
    private void tick(boolean isDebug, @Nullable LongTickDetector detector) {
        Ellant.getInstance().getEventBus().post(tickEvent);
    ...
    public void runTick() {
        ...
        if (this.world != null) {
            Ellant.getInstance().getEventBus().post(player.tick);
    ...
    public void loadWorld(ClientWorld worldClientIn) {
        ...
        Ellant.getInstance().getEventBus().post(new EventChangeWorld());
    }
