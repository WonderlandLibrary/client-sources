...
import fun.ellant.functions.impl.combat.NoEntityTrace;
import fun.ellant.functions.impl.player.BetterMinecraft;
import fun.ellant.functions.impl.render.AspectRatio;
import fun.ellant.functions.impl.render.GlassHand;
import fun.ellant.ui.mainmenu.MainScreen;
...
public class GameRenderer implements IResourceManagerReloadListener, AutoCloseable {
    ...
    private void hurtCameraEffect(MatrixStack matrixStackIn, float partialTicks) {
        ...
        Ellant.getInstance().getEventBus().post(eventCancelOverlay);
    ...
    public Matrix4f getProjectionMatrix(ActiveRenderInfo activeRenderInfoIn, float partialTicks,
        ...
        FunctionRegistry moduleRepository = Ellant.getInstance().getFunctionRegistry();
