...
public class PlayerProfileCache
{
    ...
    public List<ProfileEntry> func_242116_a()
    {
        ...
        try (Reader reader = Files.newReader(this.usercacheFile, StandardCharsets.UTF_8))
        {
            ...
            {
                ProfileEntry playerprofilecache$profileentry = func_242121_a(p_242122_2_, dateformat);
    ...
    {
        return ImmutableList.copyOf(this.uuidToProfileEntryMap.values()).stream().sorted(Comparator.comparing(ProfileEntry::func_242128_c).reversed()).limit((long)p_242117_1_);
    }
