...
public class GossipManager
{
    ...
    {
        List<GossipEntry> list = this.getGossipEntries().collect(Collectors.toList());
        ...
        else
        {
            ...
            {
                GossipEntry gossipmanager$gossipentry = list.get(j);
    ...
    {
        dynamic.asStream().map(GossipEntry::read).flatMap((p_234056_0_) ->
        {
    ...
    static class Gossips
    {
        ...
        public Stream<GossipEntry> unpack(UUID identifier)
        {
            ...
            {
                return new GossipEntry(identifier, p_220897_1_.getKey(), p_220897_1_.getIntValue());
            });
        }
