...
public class ConnectedParser {
   ...
   public static Comparable parseValue(String str, Class cls) {
      return (Comparable)(cls == String.class
         ? str
         : (Comparable)(
            cls == Boolean.class
               ? Boolean.valueOf(str)
               : cls == Float.class
                  ? (double)Float.parseFloat(str)
                  : (
                     cls == Double.class
                        ? Double.parseDouble(str)
                        : (double)(cls == Integer.class ? (long)Integer.parseInt(str) : cls == Long.class ? Long.valueOf(str) : null)
                  )
         ));
   }
   ...
   public VillagerProfession[] parseProfessions(String profStr) {
      if (profStr == null) {
         ...
         return list.isEmpty() ? null : list.toArray(new VillagerProfession[0]);
      }
   }
