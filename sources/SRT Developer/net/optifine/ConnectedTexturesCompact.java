...
public class ConnectedTexturesCompact {
               ...
               : (
                  upLeft == downLeft
                     ? (
                        upRight == downRight
                           ? getQuadsCompact(
                              ConnectedTexturesCompact.Dir.LEFT, upLeft, ConnectedTexturesCompact.Dir.RIGHT, upRight, sprites, side, quad, renderEnv
                           )
                           : getQuadsCompact(
                     ...
                     : (
                        upRight == downRight
                           ...
                           : getQuadsCompact(upLeft, upRight, downLeft, downRight, sprites, side, quad, renderEnv)
                     )
               )
         );
   }
   ...
   private static BakedQuad[] getQuadsCompact(
      int index1, int index2, int index3, int index4, TextureAtlasSprite[] sprites, int side, BakedQuad quad, RenderEnv renderEnv
   ) {
      BakedQuad bakedquad = getQuadCompact(sprites[index1], ConnectedTexturesCompact.Dir.UP_LEFT, side, quad, renderEnv);
      BakedQuad bakedquad1 = getQuadCompact(sprites[index2], ConnectedTexturesCompact.Dir.UP_RIGHT, side, quad, renderEnv);
      BakedQuad bakedquad2 = getQuadCompact(sprites[index3], ConnectedTexturesCompact.Dir.DOWN_LEFT, side, quad, renderEnv);
      BakedQuad bakedquad3 = getQuadCompact(sprites[index4], ConnectedTexturesCompact.Dir.DOWN_RIGHT, side, quad, renderEnv);
