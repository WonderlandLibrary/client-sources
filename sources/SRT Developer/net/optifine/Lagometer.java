...
public class Lagometer {
   ...
   public static void showLagometer(ScaledResolution scaledResolution) {
      if (gameSettings != null && (gameSettings.ofLagometer || gameSettings.field_181657_aC)) {
         ...
         GlStateManager.ortho(0.0, (double)mc.displayWidth, (double)mc.displayHeight, 0.0, 1000.0, 3000.0);
   ...
   private static long renderTime(int frameNum, long time, int r, int g, int b, float baseHeight, WorldRenderer tessellator) {
      ...
      if (i < 3L) {
         ...
         tessellator.func_181662_b((double)((float)frameNum + 0.5F), (double)(baseHeight - (float)i + 0.5F), 0.0).func_181669_b(r, g, b, 255).func_181675_d();
         tessellator.func_181662_b((double)((float)frameNum + 0.5F), (double)(baseHeight + 0.5F), 0.0).func_181669_b(r, g, b, 255).func_181675_d();
         return i;
      }
   }
   ...
   private static void renderTimeDivider(int frameEnd, long time, float baseHeight, WorldRenderer tessellator) {
      long i = time / 200000L;
      if (i >= 3L) {
         tessellator.func_181662_b(0.5, (double)(baseHeight - (float)i + 0.5F), 0.0).func_181669_b(196, 196, 196, 255).func_181675_d();
         tessellator.func_181662_b((double)((float)frameEnd + 0.5F), (double)(baseHeight - (float)i + 0.5F), 0.0)
            .func_181669_b(196, 196, 196, 255)
            .func_181675_d();
      }
   }
