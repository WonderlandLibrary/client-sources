...
public class CustomLoadingScreen {
   ...
   public void drawBackground(int width, int height) {
      ...
      worldrenderer.func_181662_b(0.0, (double)height, 0.0).func_181673_a(d3, d4 + d2).func_181669_b(255, 255, 255, 255).func_181675_d();
      worldrenderer.func_181662_b((double)width, (double)height, 0.0).func_181673_a(d3 + d1, d4 + d2).func_181669_b(255, 255, 255, 255).func_181675_d();
      worldrenderer.func_181662_b((double)width, 0.0, 0.0).func_181673_a(d3 + d1, d4).func_181669_b(255, 255, 255, 255).func_181675_d();
