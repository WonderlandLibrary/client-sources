...
public class ShadersRender {
   ...
   public static boolean renderEndPortal(TileEntityEndPortal te, double x, double y, double z, float partialTicks, int destroyStage, float offset) {
      if (!Shaders.isShadowPass && Shaders.activeProgram.getId() == 0) {
         ...
         int i = 240;
         worldrenderer.func_181662_b(x, y + (double)offset, z + 1.0)
            .func_181666_a(f1, f2, f3, 1.0F)
            .func_181673_a((double)(f4 + f6), (double)(f4 + f6))
            .func_181671_a(i, i)
            .func_181675_d();
         worldrenderer.func_181662_b(x + 1.0, y + (double)offset, z + 1.0)
            .func_181666_a(f1, f2, f3, 1.0F)
            .func_181673_a((double)(f4 + f6), (double)(f5 + f6))
            .func_181671_a(i, i)
            .func_181675_d();
         worldrenderer.func_181662_b(x + 1.0, y + (double)offset, z)
            .func_181666_a(f1, f2, f3, 1.0F)
            .func_181673_a((double)(f5 + f6), (double)(f5 + f6))
            .func_181671_a(i, i)
            .func_181675_d();
         worldrenderer.func_181662_b(x, y + (double)offset, z)
            .func_181666_a(f1, f2, f3, 1.0F)
            .func_181673_a((double)(f5 + f6), (double)(f4 + f6))
            .func_181671_a(i, i)
            .func_181675_d();
         tessellator.draw();
