...
public class SVertexBuilder {
   ...
   public void calcNormal(WorldRenderer wrr, int baseIndex) {
      ...
      float f34 = (double)f33 != 0.0 ? (float)(1.0 / Math.sqrt((double)f33)) : 1.0F;
      f30 *= f34;
      f31 *= f34;
      f32 *= f34;
      f20 = f5 - f;
      ...
      f34 = (double)f33 != 0.0 ? (float)(1.0 / Math.sqrt((double)f33)) : 1.0F;
      f37 *= f34;
      f38 *= f34;
      f39 *= f34;
   ...
   public static void drawArrays(int drawMode, int first, int count, WorldRenderer wrr) {
      if (count != 0) {
         ...
         if (i == 56) {
            ...
            GL20.glVertexAttribPointer(11, 2, 5126, false, i, bytebuffer);
            ((Buffer)bytebuffer).position(40);
            GL20.glVertexAttribPointer(12, 4, 5122, false, i, bytebuffer);
            ((Buffer)bytebuffer).position(48);
            GL20.glVertexAttribPointer(10, 3, 5122, false, i, bytebuffer);
