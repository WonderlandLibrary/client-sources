...
public class BlockModelCustomizer {
   ...
   public static IBakedModel getRenderModel(IBakedModel modelIn, RenderEnv renderEnv) {
   ...
   private static BakedQuad[] getRenderQuads(
      BakedQuad quad, IBlockAccess worldIn, IBlockState stateIn, BlockPos posIn, EnumFacing enumfacing, long rand, RenderEnv renderEnv
   ) {
