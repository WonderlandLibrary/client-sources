...
public class RandomEntities {
   ...
   public static void worldChanged(World newWorld) {
      if (newWorld != null) {
         for(Object o : newWorld.getLoadedEntityList()) {
   ...
   public static ResourceLocation getTextureLocation(ResourceLocation loc) {
      if (!active) {
         ...
         ResourceLocation randomentityproperties;
         try {
            working = true;
   ...
   private static String getPathBase(String pathRandom) {
      return pathRandom.startsWith("optifine/random/")
         ...
         : (pathRandom.startsWith("mcpatcher/mob/") ? StrUtils.replacePrefix(pathRandom, "mcpatcher/mob/", "textures/entity/") : null);
   }
   ...
   private static void initialize() {
      ...
      for(String value : astring2) {
         String s = StrUtils.removeSuffix(value, astring1);
