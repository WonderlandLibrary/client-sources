   ...
   public void unlockAchievement(EntityPlayer playerIn, StatBase statIn, int p_150873_3_) {
      ...
      if (statIn.isAchievement() && i == 0 && p_150873_3_ > 0) {
         ...
         if (this.mcServer.isAnnouncingPlayerAchievements()) {
            this.mcServer
               ...
               .sendChatMsg(new ChatComponentTranslation("chat.type.achievement", playerIn.getDisplayName(), statIn.func_150955_j()));
         }
      }
      ...
      if (statIn.isAchievement() && i > 0 && p_150873_3_ == 0) {
         ...
         if (this.mcServer.isAnnouncingPlayerAchievements()) {
            this.mcServer
               .getConfigurationManager()
               .sendChatMsg(new ChatComponentTranslation("chat.type.achievement.taken", playerIn.getDisplayName(), statIn.func_150955_j()));
         }
      }
   }
