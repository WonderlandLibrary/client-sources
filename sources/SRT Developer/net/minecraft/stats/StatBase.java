...
public class StatBase {
   ...
   public static final IStatType simpleStatType = numberFormat::format;
   private static final DecimalFormat decimalFormat = new DecimalFormat("########0.00");
   public static final IStatType timeStatType = p_75843_1_ -> {
      ...
      double d4 = d3 / 365.0;
      return d4 > 0.5
         ? decimalFormat.format(d4) + " y"
         : (
            d3 > 0.5
               ? decimalFormat.format(d3) + " d"
               : (d2 > 0.5 ? decimalFormat.format(d2) + " h" : (d1 > 0.5 ? decimalFormat.format(d1) + " m" : d0 + " s"))
         );
   };
   public static final IStatType distanceStatType = p_75843_1_ -> {
      double d0 = (double)p_75843_1_ / 100.0;
      double d1 = d0 / 1000.0;
      return d1 > 0.5 ? decimalFormat.format(d1) + " km" : (d0 > 0.5 ? decimalFormat.format(d0) + " m" : p_75843_1_ + " cm");
   };
   public static final IStatType field_111202_k = p_75843_1_ -> decimalFormat.format((double)p_75843_1_ * 0.1);
