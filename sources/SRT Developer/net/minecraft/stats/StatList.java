...
public class StatList {
   ...
   public static final StatBase leaveGameStat = new StatBasic("stat.leaveGame", new ChatComponentTranslation("stat.leaveGame"))
      .initIndependentStat()
      .registerStat();
   public static final StatBase minutesPlayedStat = new StatBasic(
         "stat.playOneMinute", new ChatComponentTranslation("stat.playOneMinute"), StatBase.timeStatType
      )
      .initIndependentStat()
      .registerStat();
   public static final StatBase timeSinceDeathStat = new StatBasic(
         "stat.timeSinceDeath", new ChatComponentTranslation("stat.timeSinceDeath"), StatBase.timeStatType
      )
      .initIndependentStat()
      .registerStat();
   public static final StatBase distanceWalkedStat = new StatBasic("stat.walkOneCm", new ChatComponentTranslation("stat.walkOneCm"), StatBase.distanceStatType)
      .initIndependentStat()
      .registerStat();
   public static final StatBase distanceCrouchedStat = new StatBasic(
         "stat.crouchOneCm", new ChatComponentTranslation("stat.crouchOneCm"), StatBase.distanceStatType
      )
      .initIndependentStat()
      .registerStat();
   public static final StatBase distanceSprintedStat = new StatBasic(
         "stat.sprintOneCm", new ChatComponentTranslation("stat.sprintOneCm"), StatBase.distanceStatType
      )
      .initIndependentStat()
      .registerStat();
   public static final StatBase distanceSwumStat = new StatBasic("stat.swimOneCm", new ChatComponentTranslation("stat.swimOneCm"), StatBase.distanceStatType)
      .initIndependentStat()
      .registerStat();
   public static final StatBase distanceFallenStat = new StatBasic("stat.fallOneCm", new ChatComponentTranslation("stat.fallOneCm"), StatBase.distanceStatType)
      .initIndependentStat()
      .registerStat();
   public static final StatBase distanceClimbedStat = new StatBasic(
         "stat.climbOneCm", new ChatComponentTranslation("stat.climbOneCm"), StatBase.distanceStatType
      )
      .initIndependentStat()
      .registerStat();
   public static final StatBase distanceFlownStat = new StatBasic("stat.flyOneCm", new ChatComponentTranslation("stat.flyOneCm"), StatBase.distanceStatType)
      .initIndependentStat()
      .registerStat();
   public static final StatBase distanceDoveStat = new StatBasic("stat.diveOneCm", new ChatComponentTranslation("stat.diveOneCm"), StatBase.distanceStatType)
      .initIndependentStat()
      .registerStat();
   public static final StatBase distanceByMinecartStat = new StatBasic(
         "stat.minecartOneCm", new ChatComponentTranslation("stat.minecartOneCm"), StatBase.distanceStatType
      )
      .initIndependentStat()
      .registerStat();
   public static final StatBase distanceByBoatStat = new StatBasic("stat.boatOneCm", new ChatComponentTranslation("stat.boatOneCm"), StatBase.distanceStatType)
      .initIndependentStat()
      .registerStat();
   public static final StatBase distanceByPigStat = new StatBasic("stat.pigOneCm", new ChatComponentTranslation("stat.pigOneCm"), StatBase.distanceStatType)
      .initIndependentStat()
      .registerStat();
   public static final StatBase distanceByHorseStat = new StatBasic(
         "stat.horseOneCm", new ChatComponentTranslation("stat.horseOneCm"), StatBase.distanceStatType
      )
      .initIndependentStat()
      .registerStat();
   ...
   public static final StatBase damageDealtStat = new StatBasic("stat.damageDealt", new ChatComponentTranslation("stat.damageDealt"), StatBase.field_111202_k)
      .registerStat();
   public static final StatBase damageTakenStat = new StatBasic("stat.damageTaken", new ChatComponentTranslation("stat.damageTaken"), StatBase.field_111202_k)
      .registerStat();
   ...
   public static final StatBase timesTalkedToVillagerStat = new StatBasic("stat.talkedToVillager", new ChatComponentTranslation("stat.talkedToVillager"))
      .registerStat();
   public static final StatBase timesTradedWithVillagerStat = new StatBasic("stat.tradedWithVillager", new ChatComponentTranslation("stat.tradedWithVillager"))
      .registerStat();
   ...
   public static final StatBase field_181729_M = new StatBasic("stat.brewingstandInteraction", new ChatComponentTranslation("stat.brewingstandInteraction"))
      .registerStat();
   public static final StatBase field_181730_N = new StatBasic("stat.beaconInteraction", new ChatComponentTranslation("stat.beaconInteraction"))
      .registerStat();
   ...
   public static final StatBase field_181733_Q = new StatBasic("stat.dispenserInspected", new ChatComponentTranslation("stat.dispenserInspected"))
      .registerStat();
   ...
   public static final StatBase field_181737_U = new StatBasic("stat.trappedChestTriggered", new ChatComponentTranslation("stat.trappedChestTriggered"))
      .registerStat();
   ...
   public static final StatBase field_181741_Y = new StatBasic("stat.furnaceInteraction", new ChatComponentTranslation("stat.furnaceInteraction"))
      .registerStat();
   public static final StatBase field_181742_Z = new StatBasic("stat.craftingTableInteraction", new ChatComponentTranslation("stat.workbenchInteraction"))
      .registerStat();
   ...
   private static void initCraftableStats() {
      ...
      for(Item item : set) {
         if (item != null) {
            ...
            if (s != null) {
               objectCraftStats[i] = new StatCrafting(
                     "stat.craftItem.", s, new ChatComponentTranslation("stat.craftItem", new ItemStack(item).getChatComponent()), item
                  )
                  .registerStat();
            }
         }
      ...
      for(Block block : Block.blockRegistry) {
         ...
         if (item != null) {
            ...
            if (s != null && block.getEnableStats()) {
               mineBlockStatArray[i] = new StatCrafting(
                     "stat.mineBlock.", s, new ChatComponentTranslation("stat.mineBlock", new ItemStack(block).getChatComponent()), item
                  )
                  .registerStat();
   ...
   private static void initStats() {
      for(Item item : Item.itemRegistry) {
         if (item != null) {
            ...
            String s = func_180204_a(item);
            if (s != null) {
               objectUseStats[i] = new StatCrafting(
                     "stat.useItem.", s, new ChatComponentTranslation("stat.useItem", new ItemStack(item).getChatComponent()), item
                  )
                  .registerStat();
      ...
      for(Item item : Item.itemRegistry) {
         if (item != null) {
            ...
            if (s != null && item.isDamageable()) {
               objectBreakStats[i] = new StatCrafting(
                     "stat.breakItem.", s, new ChatComponentTranslation("stat.breakItem", new ItemStack(item).getChatComponent()), item
                  )
                  .registerStat();
            }
         }
   ...
   public static StatBase getStatKillEntity(EntityList.EntityEggInfo eggInfo) {
      ...
      return s == null
         ? null
         : new StatBase("stat.killEntity." + s, new ChatComponentTranslation("stat.entityKill", new ChatComponentTranslation("entity." + s + ".name")))
            .registerStat();
   }
   ...
   public static StatBase getStatEntityKilledBy(EntityList.EntityEggInfo eggInfo) {
      ...
      return s == null
         ? null
         : new StatBase("stat.entityKilledBy." + s, new ChatComponentTranslation("stat.entityKilledBy", new ChatComponentTranslation("entity." + s + ".name")))
            .registerStat();
   }
