...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable {
   ...
   public void update() {
      ...
      if (this.playerEntity.getLastActiveTime() > 0L
         && this.serverController.getMaxPlayerIdleMinutes() > 0
         && MinecraftServer.getCurrentTimeMillis() - this.playerEntity.getLastActiveTime()
            > (long)this.serverController.getMaxPlayerIdleMinutes() * 1000L * 60L) {
   ...
   public void kickPlayerFromServer(String reason) {
      ...
      this.netManager.sendPacket(new S40PacketDisconnect(chatcomponenttext), p_operationComplete_1_ -> this.netManager.closeChannel(chatcomponenttext));
   ...
   private boolean func_183006_b(C03PacketPlayer p_183006_1_) {
      return !Doubles.isFinite(p_183006_1_.getPositionX())
         || !Doubles.isFinite(p_183006_1_.getPositionY())
         || !Doubles.isFinite(p_183006_1_.getPositionZ())
         || !Floats.isFinite(p_183006_1_.getPitch())
         ...
         if (!this.playerEntity.playerConqueredTheEnd) {
            ...
            if (this.hasMoved) {
                  ...
                  if (this.playerEntity.ridingEntity != null) {
                     if (d3 > 4.0) {
                        ...
                        this.setPlayerLocation(
                           this.playerEntity.posX,
                           this.playerEntity.posY,
               ...
               if (this.playerEntity.isPlayerSleeping()) {
                  this.playerEntity.onUpdateEntity();
                  this.playerEntity
                     .setPositionAndRotation(this.lastPosX, this.lastPosY, this.lastPosZ, this.playerEntity.rotationYaw, this.playerEntity.rotationPitch);
                  worldserver.updateEntity(this.playerEntity);
                  return;
               }
               ...
               if (d15 - d14 > 100.0
                  && (!this.serverController.isSinglePlayer() || !this.serverController.getServerOwner().equals(this.playerEntity.getCommandSenderName()))) {
                  logger.warn(
               ...
               float f3 = 0.0625F;
               boolean flag = worldserver.getCollidingBoundingBoxes(
                     this.playerEntity, this.playerEntity.getEntityBoundingBox().contract((double)f3, (double)f3, (double)f3)
                  )
                  .isEmpty();
               ...
               if (!this.playerEntity.noClip) {
                  boolean flag2 = worldserver.getCollidingBoundingBoxes(
                        this.playerEntity, this.playerEntity.getEntityBoundingBox().contract((double)f3, (double)f3, (double)f3)
                     )
                     .isEmpty();
               ...
               AxisAlignedBB axisalignedbb = this.playerEntity.getEntityBoundingBox().expand((double)f3, (double)f3, (double)f3).addCoord(0.0, -0.55, 0.0);
   ...
   public void processPlayerBlockPlacement(C08PacketPlayerBlockPlacement packetIn) {
      ...
      if (packetIn.getPlacedBlockDirection() == 255) {
         ...
         if (this.hasMoved
            && this.playerEntity.getDistanceSq((double)blockpos.getX() + 0.5, (double)blockpos.getY() + 0.5, (double)blockpos.getZ() + 0.5) < 64.0
            ...
            this.playerEntity
               ...
               .activateBlockOrUseItem(
                  ...
                  blockpos,
                  enumfacing,
                  packetIn.getPlacedBlockOffsetX(),
                  packetIn.getPlacedBlockOffsetY(),
            ...
            if (this.playerEntity.playerConqueredTheEnd) {
               ...
               if (this.serverController.isSinglePlayer() && this.playerEntity.getCommandSenderName().equals(this.serverController.getServerOwner())) {
                  ...
                  UserListBansEntry userlistbansentry = new UserListBansEntry(
                     this.playerEntity.getGameProfile(), null, "(You just lost the game)", null, "Death in Hardcore"
                  );
   ...
   public void processClickWindow(C0EPacketClickWindow packetIn) {
      ...
      if (this.playerEntity.openContainer.windowId == packetIn.getWindowId() && this.playerEntity.openContainer.getCanCraft(this.playerEntity)) {
         if (this.playerEntity.isSpectator()) {
            ...
            ItemStack itemstack = this.playerEntity
               .openContainer
               .slotClick(packetIn.getSlotId(), packetIn.getUsedButton(), packetIn.getMode(), this.playerEntity);
      ...
      if ("MC|BEdit".equals(packetIn.getChannelName())) {
         ...
         if (!this.serverController.isCommandBlockEnabled()) {
            ...
            try {
               ...
               if (j == 0) {
                  TileEntity tileentity = this.playerEntity
                     .worldObj
