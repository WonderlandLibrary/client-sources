...
public class CommandWorldBorder extends CommandBase {
      ...
      if (args.length < 1) {
         ...
         switch(var4) {
            ...
            case "center":
               ...
               double d1 = parseDouble((double)blockpos.getX() + 0.5, args[1], true);
               double d3 = parseDouble((double)blockpos.getZ() + 0.5, args[2], true);
            ...
            case "damage":
               ...
               if (args[1].equals("buffer")) {
                  ...
                  notifyOperators(
                     sender, this, "commands.worldborder.damage.buffer.success", new Object[]{String.format("%.1f", d5), String.format("%.1f", d9)}
                  );
                  ...
                  notifyOperators(
                     sender, this, "commands.worldborder.damage.amount.success", new Object[]{String.format("%.2f", d6), String.format("%.2f", d10)}
                  );
               }
               break;
            case "warning":
   ...
   public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
      return args.length == 1
         ? getListOfStringsMatchingLastWord(args, new String[]{"set", "center", "damage", "warning", "add", "get"})
         : (
            args.length == 2 && args[0].equals("damage")
               ...
               : (
                  args.length >= 2 && args.length <= 3 && args[0].equals("center")
                     ...
                     : (args.length == 2 && args[0].equals("warning") ? getListOfStringsMatchingLastWord(args, new String[]{"time", "distance"}) : null)
               )
         );
   }
}
