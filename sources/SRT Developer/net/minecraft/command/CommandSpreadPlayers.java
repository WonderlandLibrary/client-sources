...
public class CommandSpreadPlayers extends CommandBase {
      ...
      if (args.length < 6) {
         ...
         if (list.isEmpty()) {
            ...
            sender.addChatMessage(
               new ChatComponentTranslation("commands.spreadplayers.spreading." + (flag ? "teams" : "players"), list.size(), d3, d0, d1, d2)
            );
   ...
   private double func_110671_a(List<Entity> p_110671_1_, World worldIn, CommandSpreadPlayers.Position[] p_110671_3_, boolean p_110671_4_) {
      ...
      for(Entity entity : p_110671_1_) {
         ...
         for(CommandSpreadPlayers.Position position : p_110671_3_) {
