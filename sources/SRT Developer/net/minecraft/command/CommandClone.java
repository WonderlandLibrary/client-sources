                        ...
                        for(NextTickListEntry nextticklistentry : list5) {
                           if (structureboundingbox.isVecInside(nextticklistentry.position)) {
                              ...
                              world.scheduleBlockUpdate(
                                 ...
                                 (int)(nextticklistentry.scheduledTime - world.getWorldInfo().getWorldTotalTime()),
      ...
      return args.length > 0 && args.length <= 3
         ...
         : (
            args.length > 3 && args.length <= 6
               ...
               : (
                  args.length > 6 && args.length <= 9
                     ? func_175771_a(args, 6, pos)
                     : (
                        args.length == 10
                           ? getListOfStringsMatchingLastWord(args, new String[]{"replace", "masked", "filtered"})
                           : (
                              args.length == 11
                                 ? getListOfStringsMatchingLastWord(args, new String[]{"normal", "force", "move"})
                                 : (
