...
public class CommandEffect extends CommandBase {
         ...
         if (args[1].equals("clear")) {
            ...
            if (l > 0) {
               ...
               notifyOperators(
                  ...
                  new Object[]{new ChatComponentTranslation(potioneffect.getEffectName()), i, k, entitylivingbase.getCommandSenderName(), l}
               );
            } else {
               if (!entitylivingbase.isPotionActive(i)) {
                  throw new CommandException(
                     "commands.effect.failure.notActive", new ChatComponentTranslation(potion1.getName()), entitylivingbase.getCommandSenderName()
                  );
               }
               ...
               notifyOperators(
                  ...
                  new Object[]{new ChatComponentTranslation(potion1.getName()), entitylivingbase.getCommandSenderName()}
               );
            }
         }
      }
   ...
   public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
      return args.length == 1
         ? getListOfStringsMatchingLastWord(args, this.getAllUsernames())
         : (
            args.length == 2
               ? getListOfStringsMatchingLastWord(args, Potion.func_181168_c())
