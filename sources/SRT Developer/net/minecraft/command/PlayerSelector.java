...
public class PlayerSelector {
   ...
   private static List<Predicate<Entity>> func_179663_a(Map<String, String> p_179663_0_, String p_179663_1_) {
      ...
      if ((s == null || !p_179663_1_.equals("e")) && !flag2) {
         if (flag1) {
            list.add((Predicate)p_apply_1_ -> p_apply_1_ instanceof EntityPlayer);
         }
      } else {
         String s_f = s;
         list.add((Predicate)p_apply_1_ -> EntityList.isStringEntityName(p_apply_1_, s_f) != flag);
      }
   ...
   private static List<Predicate<Entity>> func_179647_f(Map<String, String> p_179647_0_) {
      ...
      if (s != null) {
         String s_f = s;
         list.add((Predicate)p_apply_1_ -> p_apply_1_.getCommandSenderName().equals(s_f) != flag);
      }
   ...
   private static List<Predicate<Entity>> func_179662_g(Map<String, String> p_179662_0_) {
      ...
      if (p_179662_0_.containsKey("rym") || p_179662_0_.containsKey("ry")) {
         ...
         list.add((Predicate)p_apply_1_ -> {
            int i1 = func_179650_a((int)Math.floor((double)p_apply_1_.rotationYaw));
      ...
      if (p_179662_0_.containsKey("rxm") || p_179662_0_.containsKey("rx")) {
         ...
         list.add((Predicate)p_apply_1_ -> {
            int i1 = func_179650_a((int)Math.floor((double)p_apply_1_.rotationPitch));
   ...
   private static <T extends Entity> List<T> filterResults(
      Map<String, String> params, Class<? extends T> entityClass, List<Predicate<Entity>> inputList, String type, World worldIn, BlockPos position
   ) {
      ...
      if (position != null) {
         ...
         if (params.containsKey("dx") || params.containsKey("dy") || params.containsKey("dz")) {
            ...
            if (flag && flag2 && !flag1) {
               Predicate<Entity> predicate2 = p_apply_1_ -> p_apply_1_.posX >= axisalignedbb.minX
                     && p_apply_1_.posY >= axisalignedbb.minY
   ...
   private static <T extends Entity> List<T> func_179658_a(
      ...
      if (!p_179658_4_.equals("p") && !p_179658_4_.equals("a") && !p_179658_4_.equals("e")) {
         ...
         p_179658_0_.sort(
            (p_compare_1_, p_compare_2_) -> ComparisonChain.start()
   ...
   private static BlockPos func_179664_b(Map<String, String> p_179664_0_, BlockPos p_179664_1_) {
      return new BlockPos(
         parseIntWithDefault(p_179664_0_, "x", p_179664_1_.getX()),
