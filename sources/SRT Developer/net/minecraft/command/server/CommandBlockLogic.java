...
public abstract class CommandBlockLogic implements ICommandSender {
   ...
   public void trigger(World worldIn) {
      ...
      if (minecraftserver != null && minecraftserver.isAnvilFileSet() && minecraftserver.isCommandBlockEnabled()) {
         ...
         try {
            ...
            crashreportcategory.addCrashSectionCallable("Name", this::getCommandSenderName);
   ...
   public boolean sendCommandFeedback() {
      ...
      return minecraftserver == null
         || !minecraftserver.isAnvilFileSet()
         || minecraftserver.worldServers[0].getGameRules().getGameRuleBooleanValue("commandBlockOutput");
   }
