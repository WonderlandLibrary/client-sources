...
public class CommandScoreboard extends CommandBase {
         ...
         if (args.length == 4) {
            if (s.equalsIgnoreCase("color")) {
               throw new WrongUsageException(
                  "commands.scoreboard.teams.option.noValue", s, joinNiceStringFromCollection(EnumChatFormatting.getValidValues(true, false))
               );
            }
   ...
   protected void listTeams(ICommandSender p_147186_1_, String[] p_147186_2_) throws CommandException {
      ...
      if (p_147186_2_.length > 2) {
         ...
         ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation(
            "commands.scoreboard.teams.list.player.count", collection.size(), scoreplayerteam.getRegisteredName()
         );
   ...
   protected void joinTeam(ICommandSender p_147190_1_, String[] p_147190_2_, int p_147190_3_) throws CommandException {
      ...
      if (!set.isEmpty()) {
         ...
         notifyOperators(p_147190_1_, this, "commands.scoreboard.teams.join.success", new Object[]{set.size(), s, joinNiceString(set.toArray(new String[0]))});
      }
   ...
   protected void leaveTeam(ICommandSender p_147199_1_, String[] p_147199_2_, int p_147199_3_) throws CommandException {
      ...
      if (!set.isEmpty()) {
         ...
         notifyOperators(p_147199_1_, this, "commands.scoreboard.teams.leave.success", new Object[]{set.size(), joinNiceString(set.toArray(new String[0]))});
      }
   ...
   public boolean isUsernameIndex(String[] args, int index) {
      return !args[0].equalsIgnoreCase("players")
         ? args[0].equalsIgnoreCase("teams") && index == 2
