   ...
   public void addToCrashReport(CrashReportCategory category) {
      ...
      category.addCrashSectionCallable(
         ...
         () -> String.format(
               ...
               this.terrainType.getWorldTypeID(),
      ...
      category.addCrashSectionCallable(
         "Level spawn location", () -> CrashReportCategory.getCoordinateInfo((double)this.spawnX, (double)this.spawnY, (double)this.spawnZ)
      );
      ...
      category.addCrashSectionCallable(
         "Level game mode",
         () -> String.format(
               "Game mode: %s (ID %d). Hardcore: %b. Cheats: %b", this.theGameType.getName(), this.theGameType.getID(), this.hardcore, this.allowCommands
            )
      );
   }
}
