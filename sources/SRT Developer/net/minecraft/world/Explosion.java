...
public class Explosion {
   ...
   public Explosion(
      World worldIn, Entity p_i45752_2_, double p_i45752_3_, double p_i45752_5_, double p_i45752_7_, float p_i45752_9_, List<BlockPos> p_i45752_10_
   ) {
   ...
   public Explosion(
      World worldIn, Entity p_i45754_2_, double p_i45754_3_, double p_i45754_5_, double p_i45754_7_, float size, boolean p_i45754_10_, boolean p_i45754_11_
   ) {
      ...
      if (this.isSmoking) {
         for(BlockPos blockpos : this.affectedBlockPositions) {
            ...
            if (spawnParticles) {
               ...
               this.worldObj
                  .spawnParticle(
                     EnumParticleTypes.EXPLOSION_NORMAL, (d0 + this.explosionX) / 2.0, (d1 + this.explosionY) / 2.0, (d2 + this.explosionZ) / 2.0, d3, d4, d5
                  );
