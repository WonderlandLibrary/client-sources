...
public final class SpawnerAnimals {
         ...
         for(EnumCreatureType enumcreaturetype : EnumCreatureType.values()) {
            if ((!enumcreaturetype.getPeacefulCreature() || spawnPeacefulMobs)
               ...
               int k4 = Reflector.ForgeWorld_countEntities.exists()
                  ? Reflector.callInt(p_77192_1_, Reflector.ForgeWorld_countEntities, enumcreaturetype, Boolean.TRUE)
                  : p_77192_1_.countEntities(enumcreaturetype.getCreatureClass());
                     ...
                     if (!block.isNormalCube()) {
                        ...
                        for(int k2 = 0; k2 < 3; ++k2) {
                           ...
                           for(int l3 = 0; l3 < 4; ++l3) {
                              ...
                              if (!p_77192_1_.isAnyPlayerWithinRangeAt((double)f, (double)i3, (double)f1, 24.0)
                                 && blockpos2.distanceSq((double)f, (double)i3, (double)f1) >= 576.0) {
                                 ...
                                 if (p_77192_1_.canCreatureTypeSpawnHere(enumcreaturetype, biomegenbase$spawnlistentry, blockpos1)
                                    && canCreatureTypeSpawnAtLocation(
                                       EntitySpawnPlacementRegistry.getPlacementForEntity(biomegenbase$spawnlistentry.entityClass), p_77192_1_, blockpos1
                                    )) {
                                    ...
                                    boolean flag2 = Reflector.ForgeEventFactory_canEntitySpawn.exists()
                                       ? ReflectorForge.canEntitySpawn(entityliving, p_77192_1_, f, (float)i3, f1)
                                    ...
                                    if (flag2) {
                                       ...
                                       if (!ReflectorForge.doSpecialSpawn(entityliving, p_77192_1_, f, i3, f1)) {
                                          ientitylivingdata = entityliving.onInitialSpawn(
                                             p_77192_1_.getDifficultyForLocation(new BlockPos(entityliving)), ientitylivingdata
                                          );
                                       }
                                       ...
                                       int i4 = Reflector.ForgeEventFactory_getMaxSpawnPackSize.exists()
                                          ? Reflector.callInt(Reflector.ForgeEventFactory_getMaxSpawnPackSize, entityliving)
   ...
   private static BlockPosM getRandomChunkPosition(
      World p_getRandomChunkPosition_0_, int p_getRandomChunkPosition_1_, int p_getRandomChunkPosition_2_, BlockPosM p_getRandomChunkPosition_3_
   ) {
      ...
      if (!worldIn.getWorldBorder().contains(pos)) {
         ...
         if (p_180267_0_ == EntityLiving.SpawnPlacementType.IN_WATER) {
            ...
            boolean flag = Reflector.ForgeBlock_canCreatureSpawn.exists()
               ? Reflector.callBoolean(iblockstate.getBlock(), Reflector.ForgeBlock_canCreatureSpawn, worldIn, blockpos, p_180267_0_)
   ...
   public static void performWorldGenSpawning(
      World worldIn, BiomeGenBase p_77191_1_, int p_77191_2_, int p_77191_3_, int p_77191_4_, int p_77191_5_, Random p_77191_6_
   ) {
      ...
      if (!list.isEmpty()) {
         while(p_77191_6_.nextFloat() < p_77191_1_.getSpawningChance()) {
            ...
            int i = biomegenbase$spawnlistentry.minGroupCount
               + p_77191_6_.nextInt(1 + biomegenbase$spawnlistentry.maxGroupCount - biomegenbase$spawnlistentry.minGroupCount);
            IEntityLivingData ientitylivingdata = null;
                  ...
                  if (canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType.ON_GROUND, worldIn, blockpos)) {
                     ...
                     if (Reflector.ForgeEventFactory_canEntitySpawn.exists()) {
                        Object object = Reflector.call(
                           Reflector.ForgeEventFactory_canEntitySpawn, entityliving, worldIn, (float)j + 0.5F, blockpos.getY(), (float)k + 0.5F
                        );
                     ...
                     entityliving.setLocationAndAngles(
                        (double)((float)j + 0.5F), (double)blockpos.getY(), (double)((float)k + 0.5F), p_77191_6_.nextFloat() * 360.0F, 0.0F
                     );
