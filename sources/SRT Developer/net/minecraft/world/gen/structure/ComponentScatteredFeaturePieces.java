      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         for(EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
            if (!this.field_74940_h[enumfacing.getHorizontalIndex()]) {
               ...
               this.field_74940_h[enumfacing.getHorizontalIndex()] = this.generateChestContents(
                  worldIn,
                  structureBoundingBoxIn,
                  randomIn,
                  10 + l1,
         ...
         switch(this.coordBaseMode) {
            ...
            case SOUTH:
               this.boundingBox = new StructureBoundingBox(
                  p_i2065_2_, 64, p_i2065_4_, p_i2065_2_ + p_i2065_5_ - 1, 64 + p_i2065_6_ - 1, p_i2065_4_ + p_i2065_7_ - 1
               );
               break;
            default:
               this.boundingBox = new StructureBoundingBox(
                  p_i2065_2_, 64, p_i2065_4_, p_i2065_2_ + p_i2065_7_ - 1, 64 + p_i2065_6_ - 1, p_i2065_4_ + p_i2065_5_ - 1
               );
         }
      }
         ...
         if (this.func_74935_a(worldIn, structureBoundingBoxIn)) {
            ...
            if (!this.field_74945_j) {
               this.field_74945_j = this.generateDispenserContents(
                  worldIn, structureBoundingBoxIn, randomIn, 3, 1, EnumFacing.NORTH.getIndex(), field_175815_j
               );
            }
            ...
            if (!this.field_74947_h) {
               this.field_74947_h = this.generateChestContents(
                  worldIn,
                  structureBoundingBoxIn,
                  randomIn,
                  8,
            ...
            if (!this.field_74948_i) {
               this.field_74948_i = this.generateChestContents(
                  worldIn,
                  structureBoundingBoxIn,
                  randomIn,
                  9,
