...
public class MapGenScatteredFeature extends MapGenStructure {
      ...
      for(Entry<String, String> entry : p_i2061_1_.entrySet()) {
         if (entry.getKey().equals("distance")) {
            this.maxDistanceBetweenScatteredFeatures = MathHelper.parseIntWithDefaultAndMax(
               entry.getValue(), this.maxDistanceBetweenScatteredFeatures, this.minDistanceBetweenScatteredFeatures + 1
            );
         }
      }
   }
   ...
   public boolean func_175798_a(BlockPos p_175798_1_) {
      ...
      if (structurestart instanceof MapGenScatteredFeature.Start && !structurestart.components.isEmpty()) {
