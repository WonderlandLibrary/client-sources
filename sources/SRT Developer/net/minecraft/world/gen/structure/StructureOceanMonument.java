...
public class StructureOceanMonument extends MapGenStructure {
   ...
   public static final List<BiomeGenBase> field_175802_d = Arrays.asList(
   ...
   protected boolean canSpawnStructureAtCoords(int chunkX, int chunkZ) {
      ...
      if (i == k && j == l) {
         return this.worldObj.getWorldChunkManager().getBiomeGenerator(new BlockPos(i * 16 + 8, 64, j * 16 + 8), null) != BiomeGenBase.deepOcean
            ? false
            : this.worldObj.getWorldChunkManager().areBiomesViable(i * 16 + 8, j * 16 + 8, 29, field_175802_d);
      } else {
         return false;
      }
   }
