...
public class MapGenCaves extends MapGenBase {
                           ...
                           for(int j2 = l; j2 > l2; --j2) {
                              ...
                              if (d9 > -0.7 && d10 * d10 + d9 * d9 + d8 * d8 < 1.0) {
                                 ...
                                 IBlockState iblockstate2 = (IBlockState)Objects.firstNonNull(
                                    p_180702_5_.getBlockState(j3, j2 + 1, i2), Blocks.air.getDefaultState()
                                 );
                                    ...
                                    if (j2 - 1 < 10) {
                                       ...
                                       if (iblockstate2.getBlock() == Blocks.sand) {
                                          p_180702_5_.setBlockState(
                                             ...
                                             j2 + 1,
                                             i2,
                                             iblockstate2.getValue(BlockSand.VARIANT) == BlockSand.EnumType.RED_SAND
                                       ...
                                       if (flag1 && p_180702_5_.getBlockState(j3, j2 - 1, i2).getBlock() == Blocks.dirt) {
                                          ...
                                          p_180702_5_.setBlockState(
                                             ...
                                             j2 - 1,
                                             i2,
                                             this.worldObj.getBiomeGenForCoords(blockpos$mutableblockpos).topBlock.getBlock().getDefaultState()
                                          );
                                       }
                                    }
                                 }
   ...
   protected boolean func_175793_a(IBlockState p_175793_1_, IBlockState p_175793_2_) {
      return p_175793_1_.getBlock() == Blocks.stone
         ...
         || (p_175793_1_.getBlock() == Blocks.sand || p_175793_1_.getBlock() == Blocks.gravel) && p_175793_2_.getBlock().getMaterial() != Material.water;
   }
