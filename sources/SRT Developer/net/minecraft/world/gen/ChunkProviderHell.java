...
public class ChunkProviderHell implements IChunkProvider {
   ...
   private double[] initializeNoiseField(double[] p_73164_1_, int p_73164_2_, int p_73164_4_, int p_73164_5_, int p_73164_6_, int p_73164_7_) {
      ...
      double d0 = 684.412;
      double d1 = 2053.236;
      this.noiseData4 = this.netherNoiseGen6.generateNoiseOctaves(this.noiseData4, p_73164_2_, 0, p_73164_4_, p_73164_5_, 1, p_73164_7_, 1.0, 0.0, 1.0);
      this.noiseData5 = this.netherNoiseGen7.generateNoiseOctaves(this.noiseData5, p_73164_2_, 0, p_73164_4_, p_73164_5_, 1, p_73164_7_, 100.0, 0.0, 100.0);
      this.noiseData1 = this.netherNoiseGen3
         .generateNoiseOctaves(this.noiseData1, p_73164_2_, 0, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, d0 / 80.0, d1 / 60.0, d0 / 80.0);
