...
public class NoiseGeneratorPerlin extends NoiseGenerator {
   ...
   public double[] func_151600_a(
      ...
      for(int j = 0; j < this.field_151602_b; ++j) {
         this.field_151603_a[j]
            .func_151606_a(p_151600_1_, p_151600_2_, p_151600_4_, p_151600_6_, p_151600_7_, p_151600_8_ * d0 * d1, p_151600_10_ * d0 * d1, 0.55 / d1);
         d0 *= p_151600_12_;
         d1 *= p_151600_14_;
      }
