...
public class ChunkProviderGenerate implements IChunkProvider {
   ...
   public void replaceBlocksForBiome(int p_180517_1_, int p_180517_2_, ChunkPrimer p_180517_3_, BiomeGenBase[] p_180517_4_) {
      ...
      this.stoneNoise = this.field_147430_m
         .func_151599_a(this.stoneNoise, (double)(p_180517_1_ * 16), (double)(p_180517_2_ * 16), 16, 16, d0 * 2.0, d0 * 2.0, 1.0);
   ...
   private void func_147423_a(int p_147423_1_, int p_147423_3_) {
      ...
      this.field_147428_e = this.field_147431_j
         .generateNoiseOctaves(this.field_147428_e, p_147423_1_, 0, p_147423_3_, 5, 33, 5, (double)f, (double)f1, (double)f);
      this.field_147425_f = this.field_147432_k
         .generateNoiseOctaves(this.field_147425_f, p_147423_1_, 0, p_147423_3_, 5, 33, 5, (double)f, (double)f1, (double)f);
      int i = 0;
      int j = 0;
