...
public class ChunkProviderEnd implements IChunkProvider {
   ...
   private double[] initializeNoiseField(double[] p_73187_1_, int p_73187_2_, int p_73187_4_, int p_73187_5_, int p_73187_6_, int p_73187_7_) {
      ...
      this.noiseData1 = this.noiseGen3
         .generateNoiseOctaves(this.noiseData1, p_73187_2_, 0, p_73187_4_, p_73187_5_, p_73187_6_, p_73187_7_, d0 / 80.0, d1 / 160.0, d0 / 80.0);
      ...
      for(int j = 0; j < p_73187_5_; ++j) {
         for(int k = 0; k < p_73187_7_; ++k) {
            ...
            for(int l = 0; l < p_73187_6_; ++l) {
               ...
               int var32 = 8;
               if (l < var32) {
                  double d7 = (double)((float)(var32 - l) / ((float)var32 - 1.0F));
