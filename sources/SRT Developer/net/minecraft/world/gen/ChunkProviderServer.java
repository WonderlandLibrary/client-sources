...
public class ChunkProviderServer implements IChunkProvider {
   ...
   private void saveChunkData(Chunk p_73242_1_) {
      if (this.chunkLoader != null) {
         ...
         } catch (MinecraftException var3) {
            logger.error("Couldn't save chunk; already in use by another instance of Minecraft?", var3);
         }
      }
   }
   ...
   public void saveChunks(boolean p_73151_1_, IProgressUpdate progressCallback) {
      ...
      for(Chunk chunk : Lists.newArrayList(this.loadedChunks)) {
         if (p_73151_1_) {
