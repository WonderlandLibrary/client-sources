      ...
      public boolean equals(Object p_equals_1_) {
         if (this == p_equals_1_) {
            ...
            return this.andesiteCount == chunkprovidersettings$factory.andesiteCount
               ...
               && this.andesiteSize == chunkprovidersettings$factory.andesiteSize
               && Float.compare(chunkprovidersettings$factory.baseSize, this.baseSize) == 0
               && Float.compare(chunkprovidersettings$factory.biomeDepthOffset, this.biomeDepthOffset) == 0
               && Float.compare(chunkprovidersettings$factory.biomeDepthWeight, this.biomeDepthWeight) == 0
               && Float.compare(chunkprovidersettings$factory.biomeScaleOffset, this.biomeScaleOffset) == 0
               && Float.compare(chunkprovidersettings$factory.biomeScaleWeight, this.biomeScaleWeight) == 0
               ...
               && Float.compare(chunkprovidersettings$factory.coordinateScale, this.coordinateScale) == 0
               && Float.compare(chunkprovidersettings$factory.depthNoiseScaleExponent, this.depthNoiseScaleExponent) == 0
               && Float.compare(chunkprovidersettings$factory.depthNoiseScaleX, this.depthNoiseScaleX) == 0
               && Float.compare(chunkprovidersettings$factory.depthNoiseScaleZ, this.depthNoiseScaleZ) == 0
               ...
               && Float.compare(chunkprovidersettings$factory.heightScale, this.heightScale) == 0
               ...
               && Float.compare(chunkprovidersettings$factory.lowerLimitScale, this.lowerLimitScale) == 0
               && Float.compare(chunkprovidersettings$factory.mainNoiseScaleX, this.mainNoiseScaleX) == 0
               && Float.compare(chunkprovidersettings$factory.mainNoiseScaleY, this.mainNoiseScaleY) == 0
               && Float.compare(chunkprovidersettings$factory.mainNoiseScaleZ, this.mainNoiseScaleZ) == 0
               ...
               && Float.compare(chunkprovidersettings$factory.stretchY, this.stretchY) == 0
               && Float.compare(chunkprovidersettings$factory.upperLimitScale, this.upperLimitScale) == 0
   ...
   public static class Serializer implements JsonDeserializer<ChunkProviderSettings.Factory>, JsonSerializer<ChunkProviderSettings.Factory> {
      public ChunkProviderSettings.Factory deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
         ...
         try {
            ...
            chunkprovidersettings$factory.depthNoiseScaleExponent = JsonUtils.getFloat(
               jsonobject, "depthNoiseScaleExponent", chunkprovidersettings$factory.depthNoiseScaleExponent
            );
            ...
            } else if (chunkprovidersettings$factory.fixedBiome >= BiomeGenBase.hell.biomeID) {
            ...
            chunkprovidersettings$factory.andesiteMinHeight = JsonUtils.getInt(
               jsonobject, "andesiteMinHeight", chunkprovidersettings$factory.andesiteMinHeight
            );
            chunkprovidersettings$factory.andesiteMaxHeight = JsonUtils.getInt(
               jsonobject, "andesiteMaxHeight", chunkprovidersettings$factory.andesiteMaxHeight
            );
            ...
            chunkprovidersettings$factory.redstoneMinHeight = JsonUtils.getInt(
               jsonobject, "redstoneMinHeight", chunkprovidersettings$factory.redstoneMinHeight
            );
            chunkprovidersettings$factory.redstoneMaxHeight = JsonUtils.getInt(
               jsonobject, "redstoneMaxHeight", chunkprovidersettings$factory.redstoneMaxHeight
            );
            ...
            chunkprovidersettings$factory.lapisCenterHeight = JsonUtils.getInt(
               jsonobject, "lapisCenterHeight", chunkprovidersettings$factory.lapisCenterHeight
            );
