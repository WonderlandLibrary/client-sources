...
public class WorldGenSwamp extends WorldGenAbstractTree {
   ...
   private static final IBlockState field_181649_b = Blocks.leaves
      .getDefaultState()
   ...
   private void func_181647_a(World p_181647_1_, BlockPos p_181647_2_, PropertyBool p_181647_3_) {
      ...
      for(BlockPos var6 = p_181647_2_.down(); p_181647_1_.getBlockState(var6).getBlock().getMaterial() == Material.air && i > 0; --i) {
         this.setBlockAndNotifyAdequately(p_181647_1_, var6, iblockstate);
         var6 = var6.down();
      }
   }
}
