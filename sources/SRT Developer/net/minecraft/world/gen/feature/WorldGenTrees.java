...
public class WorldGenTrees extends WorldGenAbstractTree {
   ...
   private static final IBlockState field_181654_b = Blocks.leaves
      .getDefaultState()
         ...
         for(int j = position.getY(); j <= position.getY() + 1 + i; ++j) {
            ...
            for(int l = position.getX() - k; l <= position.getX() + k && flag; ++l) {
               for(int i1 = position.getZ() - k; i1 <= position.getZ() + k && flag; ++i1) {
                  if (j < 0 || j >= 256) {
                     flag = false;
                  } else if (!this.func_150523_a(worldIn.getBlockState(blockpos$mutableblockpos.func_181079_c(l, j, i1)).getBlock())) {
                     flag = false;
                  }
               }
            }
                     ...
                     for(int l3 = 0; l3 < 2; ++l3) {
                        for(EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
                           if (rand.nextInt(4 - l3) == 0) {
                              ...
                              this.func_181652_a(
                                 worldIn, rand.nextInt(3), position.add(enumfacing1.getFrontOffsetX(), i - 5 + l3, enumfacing1.getFrontOffsetZ()), enumfacing
                              );
                           }
                        }
                     }
   ...
   private void func_181652_a(World p_181652_1_, int p_181652_2_, BlockPos p_181652_3_, EnumFacing p_181652_4_) {
      this.setBlockAndNotifyAdequately(
         p_181652_1_, p_181652_3_, Blocks.cocoa.getDefaultState().withProperty(BlockCocoa.AGE, p_181652_2_).withProperty(BlockCocoa.FACING, p_181652_4_)
      );
   }
   ...
   private void func_181650_b(World p_181650_1_, BlockPos p_181650_2_, PropertyBool p_181650_3_) {
      ...
      for(BlockPos var5 = p_181650_2_.down(); p_181650_1_.getBlockState(var5).getBlock().getMaterial() == Material.air && i > 0; --i) {
         this.func_181651_a(p_181650_1_, var5, p_181650_3_);
         var5 = var5.down();
      }
   }
}
