...
public class NoiseGeneratorOctaves extends NoiseGenerator {
   ...
   public double[] generateNoiseOctaves(
      ...
      for(int j = 0; j < this.octaves; ++j) {
         ...
         d0 += (double)k;
         d2 += (double)l;
         this.generatorCollection[j]
            .populateNoiseArray(p_76304_1_, d0, d1, d2, p_76304_5_, p_76304_6_, p_76304_7_, p_76304_8_ * d3, p_76304_10_ * d3, p_76304_12_ * d3, d3);
         d3 /= 2.0;
      }
   ...
   public double[] generateNoiseOctaves(
      double[] p_76305_1_, int p_76305_2_, int p_76305_3_, int p_76305_4_, int p_76305_5_, double p_76305_6_, double p_76305_8_, double p_76305_10_
   ) {
