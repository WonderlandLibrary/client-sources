...
public class Teleporter {
   ...
   public boolean placeInExistingPortal(Entity entityIn, float rotationYaw) {
      ...
      if (this.destinationCoordinateCache.containsItem(l)) {
         ...
         for(int i1 = -128; i1 <= 128; ++i1) {
            ...
            for(int j1 = -128; j1 <= 128; ++j1) {
               for(BlockPos blockpos1 = blockpos3.add(i1, this.worldServerInstance.getActualHeight() - 1 - blockpos3.getY(), j1);
                  blockpos1.getY() >= 0;
                  blockpos1 = blockpos2
               ) {
      ...
      if (d0 >= 0.0) {
         ...
         double d6 = (double)(blockpattern$patternhelper.func_181117_a().getY() + 1)
         ...
         if (blockpattern$patternhelper.getFinger().getAxis() == EnumFacing.Axis.X) {
            d7 = d2
               + (1.0 - entityIn.func_181014_aG().xCoord)
                     ...
                     for(int j4 = 0; j4 < 3; ++j4) {
                        for(int k4 = 0; k4 < 4; ++k4) {
                           for(int l4 = -1; l4 < 4; ++l4) {
                              ...
                              if (l4 < 0 && !this.worldServerInstance.getBlockState(blockpos$mutableblockpos).getBlock().getMaterial().isSolid()
