...
public class BlockRailDetector extends BlockRailBase {
   ...
   public BlockRailDetector() {
      ...
      this.setDefaultState(
         this.blockState.getBaseState().withProperty(POWERED, Boolean.FALSE).withProperty(SHAPE, BlockRailBase.EnumRailDirection.NORTH_SOUTH)
      );
   ...
   protected <T extends EntityMinecart> List<T> findMinecarts(World worldIn, BlockPos pos, Class<T> clazz, Predicate<Entity>... filter) {
      AxisAlignedBB axisalignedbb = this.getDetectionBox(pos);
