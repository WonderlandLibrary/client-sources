...
public class BlockSkull extends BlockContainer {
   ...
   private static final Predicate<BlockWorldState> IS_WITHER_SKELETON = p_apply_1_ -> p_apply_1_.getBlockState() != null
      ...
      if (te.getSkullType() == 1 && pos.getY() >= 2 && worldIn.getDifficulty() != EnumDifficulty.PEACEFUL && !worldIn.isRemote) {
         ...
         if (blockpattern$patternhelper != null) {
            ...
            entitywither.setLocationAndAngles(
               ...
               blockpattern$patternhelper.getFinger().getAxis() == EnumFacing.Axis.X ? 0.0F : 90.0F,
               0.0F
            );
