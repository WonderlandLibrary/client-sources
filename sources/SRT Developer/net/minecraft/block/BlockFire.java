...
public class BlockFire extends Block {
   ...
   public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
      ...
      if (!World.doesBlockHaveSolidTopSurface(worldIn, pos.down()) && !Blocks.fire.canCatchFire(worldIn, pos.down())) {
         ...
         return state.withProperty(NORTH, this.canCatchFire(worldIn, pos.north()))
            ...
            .withProperty(UPPER, l)
            .withProperty(FLIP, flag1)
            .withProperty(ALT, flag);
      } else {
   ...
   protected BlockFire() {
      ...
      this.setDefaultState(
         this.blockState
            .getBaseState()
            .withProperty(AGE, 0)
            .withProperty(FLIP, Boolean.FALSE)
            .withProperty(ALT, Boolean.FALSE)
   ...
   protected boolean canDie(World worldIn, BlockPos pos) {
      return worldIn.canLightningStrike(pos)
         || worldIn.canLightningStrike(pos.west())
         || worldIn.canLightningStrike(pos.east())
         || worldIn.canLightningStrike(pos.north())
