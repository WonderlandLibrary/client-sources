   ...
   public boolean onBlockEventReceived(World worldIn, BlockPos pos, IBlockState state, int eventID, int eventParam) {
      ...
      if (eventID == 0) {
         ...
         worldIn.playSoundEffect(
            (double)pos.getX() + 0.5, (double)pos.getY() + 0.5, (double)pos.getZ() + 0.5, "tile.piston.out", 0.5F, worldIn.rand.nextFloat() * 0.25F + 0.6F
         );
      } else if (eventID == 1) {
         ...
         worldIn.playSoundEffect(
            (double)pos.getX() + 0.5, (double)pos.getY() + 0.5, (double)pos.getZ() + 0.5, "tile.piston.in", 0.5F, worldIn.rand.nextFloat() * 0.15F + 0.6F
         );
      }
   ...
   private boolean doMove(World worldIn, BlockPos pos, EnumFacing direction, boolean extending) {
      ...
      if (!blockpistonstructurehelper.canMove()) {
         ...
         if (extending) {
            ...
            IBlockState iblockstate2 = Blocks.piston_extension
               .getDefaultState()
