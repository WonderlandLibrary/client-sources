...
public class MerchantRecipeList extends ArrayList<MerchantRecipe> {
         ...
         return this.func_181078_a(p_77203_1_, merchantrecipe1.getItemToBuy())
               && (
                  p_77203_2_ == null && !merchantrecipe1.hasSecondItemToBuy()
                     || merchantrecipe1.hasSecondItemToBuy() && this.func_181078_a(p_77203_2_, merchantrecipe1.getSecondItemToBuy())
               )
               && p_77203_1_.stackSize >= merchantrecipe1.getItemToBuy().stackSize
               && (!merchantrecipe1.hasSecondItemToBuy() || Objects.requireNonNull(p_77203_2_).stackSize >= merchantrecipe1.getSecondItemToBuy().stackSize)
            ? merchantrecipe1
            : null;
      } else {
   ...
   private boolean func_181078_a(ItemStack p_181078_1_, ItemStack p_181078_2_) {
      return ItemStack.areItemsEqual(p_181078_1_, p_181078_2_)
         && (
            !p_181078_2_.hasTagCompound()
               || p_181078_1_.hasTagCompound() && NBTUtil.func_181123_a(p_181078_2_.getTagCompound(), p_181078_1_.getTagCompound(), false)
         );
   }
