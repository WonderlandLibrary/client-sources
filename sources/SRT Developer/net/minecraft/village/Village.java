...
public class Village {
   ...
   private void updateNumIronGolems() {
      List<EntityIronGolem> list = this.worldObj
   ...
   private void updateNumVillagers() {
      List<EntityVillager> list = this.worldObj
         .getEntitiesWithinAABB(
   ...
   public EntityLivingBase findNearestVillageAggressor(EntityLivingBase entitylivingbaseIn) {
      ...
      for(Village.VillageAggressor village$villageaggressor1 : this.villageAgressors) {
   ...
   private void removeDeadAndOldAgressors() {
      this.villageAgressors
         .removeIf(
            village$villageaggressor -> !village$villageaggressor.agressor.isEntityAlive()
