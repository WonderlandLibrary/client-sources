...
public class EntityDamageSourceIndirect extends EntityDamageSource {
   ...
   public IChatComponent getDeathMessage(EntityLivingBase p_151519_1_) {
      ...
      return itemstack != null && itemstack.hasDisplayName() && StatCollector.canTranslate(s1)
         ? new ChatComponentTranslation(s1, p_151519_1_.getDisplayName(), ichatcomponent, itemstack.getChatComponent())
         : new ChatComponentTranslation(s, p_151519_1_.getDisplayName(), ichatcomponent);
   }
}
