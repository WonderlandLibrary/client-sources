...
public class CombatTracker {
   ...
   public void func_94545_a() {
      ...
      if (this.fighter.isOnLadder()) {
         Block block = this.fighter
            .worldObj
            .getBlockState(new BlockPos(this.fighter.posX, this.fighter.getEntityBoundingBox().minY, this.fighter.posZ))
            .getBlock();
   ...
   public IChatComponent getDeathMessage() {
      if (this.combatEntries.size() == 0) {
         ...
         if (combatentry != null && combatentry1.getDamageSrc() == DamageSource.fall) {
            ...
            if (combatentry.getDamageSrc() == DamageSource.fall || combatentry.getDamageSrc() == DamageSource.outOfWorld) {
            ...
            } else if (ichatcomponent2 != null && !ichatcomponent2.equals(ichatcomponent1)) {
               ...
               if (itemstack1 != null && itemstack1.hasDisplayName()) {
                  ichatcomponent = new ChatComponentTranslation(
                     "death.fell.assist.item", this.fighter.getDisplayName(), ichatcomponent2, itemstack1.getChatComponent()
                  );
               } else {
               ...
               if (itemstack != null && itemstack.hasDisplayName()) {
                  ichatcomponent = new ChatComponentTranslation(
                     "death.fell.finish.item", this.fighter.getDisplayName(), ichatcomponent1, itemstack.getChatComponent()
                  );
               } else {
   ...
   private CombatEntry func_94544_f() {
      ...
      for(int j = 0; j < this.combatEntries.size(); ++j) {
         ...
         if ((combatentry2.getDamageSrc() == DamageSource.fall || combatentry2.getDamageSrc() == DamageSource.outOfWorld)
      ...
      return f > 5.0F && combatentry != null ? combatentry : null;
   }
