...
public class HttpUtil {
   ...
   public static ListenableFuture<Object> downloadResourcePack(
      File saveFile, String packUrl, Map<String, String> p_180192_2_, int maxSize, IProgressUpdate p_180192_4_, Proxy p_180192_5_
   ) {
      return field_180193_a.submit(() -> {
         ...
         try {
            ...
            if (saveFile.exists()) {
               ...
               logger.warn("Deleting " + saveFile + " as it does not match what we currently have (" + i + " vs our " + j + ").");
