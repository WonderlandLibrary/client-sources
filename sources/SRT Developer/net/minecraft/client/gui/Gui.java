...
public class Gui {
   ...
   public void drawTexturedModalRect(int x, int y, int textureX, int textureY, int width, int height) {
      ...
      worldrenderer.func_181662_b((double)x, (double)(y + height), (double)this.zLevel)
         .func_181673_a((double)((float)textureX * f), (double)((float)(textureY + height) * f1))
         .func_181675_d();
      worldrenderer.func_181662_b((double)(x + width), (double)(y + height), (double)this.zLevel)
         ...
         .func_181675_d();
      worldrenderer.func_181662_b((double)(x + width), (double)y, (double)this.zLevel)
         .func_181673_a((double)((float)(textureX + width) * f), (double)((float)textureY * f1))
         .func_181675_d();
      worldrenderer.func_181662_b((double)x, (double)y, (double)this.zLevel)
         .func_181673_a((double)((float)textureX * f), (double)((float)textureY * f1))
         .func_181675_d();
      tessellator.draw();
   }
   ...
   public void drawTexturedModalRect(float xCoord, float yCoord, int minU, int minV, int maxU, int maxV) {
      ...
      worldrenderer.func_181662_b((double)(xCoord + 0.0F), (double)(yCoord + (float)maxV), (double)this.zLevel)
         .func_181673_a((double)((float)minU * f), (double)((float)(minV + maxV) * f1))
         .func_181675_d();
      worldrenderer.func_181662_b((double)(xCoord + (float)maxU), (double)(yCoord + (float)maxV), (double)this.zLevel)
      ...
      worldrenderer.func_181662_b((double)(xCoord + (float)maxU), (double)(yCoord + 0.0F), (double)this.zLevel)
         .func_181673_a((double)((float)(minU + maxU) * f), (double)((float)minV * f1))
         .func_181675_d();
      worldrenderer.func_181662_b((double)(xCoord + 0.0F), (double)(yCoord + 0.0F), (double)this.zLevel)
         .func_181673_a((double)((float)minU * f), (double)((float)minV * f1))
         .func_181675_d();
      tessellator.draw();
   }
   ...
   public void drawTexturedModalRect(int xCoord, int yCoord, TextureAtlasSprite textureSprite, int widthIn, int heightIn) {
      ...
      WorldRenderer worldrenderer = tessellator.getWorldRenderer();
      worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
      worldrenderer.func_181662_b((double)xCoord, (double)(yCoord + heightIn), (double)this.zLevel)
         .func_181673_a((double)textureSprite.getMinU(), (double)textureSprite.getMaxV())
         .func_181675_d();
      worldrenderer.func_181662_b((double)(xCoord + widthIn), (double)(yCoord + heightIn), (double)this.zLevel)
         .func_181673_a((double)textureSprite.getMaxU(), (double)textureSprite.getMaxV())
         .func_181675_d();
      worldrenderer.func_181662_b((double)(xCoord + widthIn), (double)yCoord, (double)this.zLevel)
         .func_181673_a((double)textureSprite.getMaxU(), (double)textureSprite.getMinV())
         .func_181675_d();
      worldrenderer.func_181662_b((double)xCoord, (double)yCoord, (double)this.zLevel)
         .func_181673_a((double)textureSprite.getMinU(), (double)textureSprite.getMinV())
         .func_181675_d();
      tessellator.draw();
   }
   ...
   public static void drawModalRectWithCustomSizedTexture(int x, int y, float u, float v, int width, int height, float textureWidth, float textureHeight) {
      ...
      WorldRenderer worldrenderer = tessellator.getWorldRenderer();
      worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
      worldrenderer.func_181662_b((double)x, (double)(y + height), 0.0).func_181673_a((double)(u * f), (double)((v + (float)height) * f1)).func_181675_d();
      worldrenderer.func_181662_b((double)(x + width), (double)(y + height), 0.0)
         .func_181673_a((double)((u + (float)width) * f), (double)((v + (float)height) * f1))
         .func_181675_d();
      worldrenderer.func_181662_b((double)(x + width), (double)y, 0.0).func_181673_a((double)((u + (float)width) * f), (double)(v * f1)).func_181675_d();
