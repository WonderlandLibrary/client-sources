...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
   ...
   private void connectToServer(ServerData server) {
      if (server.serverIP.contains("syuu.net") && !Ries.INSTANCE.getModuleManager().getModuleByName("Safeguard").isEnabled()) {
         GuiYesNo question = new GuiYesNo("This is the only good server in Minecraft left.", "Are you sure you want to cheat on this server?", server);
         this.mc.displayGuiScreen(question);
      } else {
