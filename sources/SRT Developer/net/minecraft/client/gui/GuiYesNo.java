...
public class GuiYesNo extends GuiScreen {
   ...
   public GuiYesNo(String p_i1083_2_, String p_i1083_3_, ServerData serverData) {
      this.messageLine1 = p_i1083_2_;
      this.messageLine2 = p_i1083_3_;
      this.serverData = serverData;
      this.confirmButtonText = I18n.format("gui.yes");
      this.cancelButtonText = I18n.format("gui.no");
      this.parentButtonClickedId = 0;
   ...
   protected void actionPerformed(GuiButton button) {
      if (this.serverData != null) {
         if (button.id == 0) {
            this.mc.displayGuiScreen(new GuiConnecting(new GuiMultiplayer(new GuiMainMenu()), this.mc, this.serverData));
         } else {
