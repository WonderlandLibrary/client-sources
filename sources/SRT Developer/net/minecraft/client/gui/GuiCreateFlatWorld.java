...
public class GuiCreateFlatWorld extends GuiScreen {
   ...
   class Details extends GuiSlot {
      ...
      private void func_148224_c(int p_148224_1_, int p_148224_2_) {
         ...
         worldrenderer.func_181662_b((double)p_148224_1_, (double)(p_148224_2_ + 18), (double)GuiCreateFlatWorld.this.zLevel)
            .func_181673_a(0.0, 0.140625)
            .func_181675_d();
         worldrenderer.func_181662_b((double)(p_148224_1_ + 18), (double)(p_148224_2_ + 18), (double)GuiCreateFlatWorld.this.zLevel)
            .func_181673_a(0.140625, 0.140625)
            .func_181675_d();
         worldrenderer.func_181662_b((double)(p_148224_1_ + 18), (double)p_148224_2_, (double)GuiCreateFlatWorld.this.zLevel)
            .func_181673_a(0.140625, 0.0)
            .func_181675_d();
         worldrenderer.func_181662_b((double)p_148224_1_, (double)p_148224_2_, (double)GuiCreateFlatWorld.this.zLevel).func_181673_a(0.0, 0.0).func_181675_d();
         tessellator.draw();
      }
