...
public class GuiIngame extends Gui {
   ...
   private final Module noPumpkinOverlayMod = Ries.INSTANCE.getModuleManager().getModuleByName("NoPumpkinOverlay");
   ...
   public void renderGameOverlay(float partialTicks) {
      ...
      if (this.mc.gameSettings.thirdPersonView == 0
         ...
         && !this.noPumpkinOverlayMod.isEnabled()) {
      ...
      GlStateManager.enableAlpha();
      EventBus.processEvent(new Event2DRender(partialTicks, scaledresolution));
   }
   ...
   private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
      ...
      List<Score> list = Lists.newArrayList(
         Iterables.filter(collection, p_apply_1_ -> p_apply_1_.getPlayerName() != null && !p_apply_1_.getPlayerName().startsWith("#"))
      );
      if (list.size() > 15) {
      ...
      for(Score score1 : collection) {
         ...
         drawRect(l1 - 2, k, l, k + 9, 1342177280);
         this.getFontRenderer().drawString(s1, l1, k, 553648127);
         this.getFontRenderer().drawString(s2, l - this.getFontRenderer().getStringWidth(s2), k, 553648127);
         if (j == collection.size()) {
            String s3 = p_180475_1_.getDisplayName();
            drawRect(l1 - 2, k - 9 - 1, l, k - 1, 1610612736);
            drawRect(l1 - 2, k - 1, l, k, 1342177280);
            this.getFontRenderer().drawString(s3, l1 + i / 2 - this.getFontRenderer().getStringWidth(s3) / 2, k - 9, 553648127);
         }
      }
   }
   ...
   private void renderPumpkinOverlay(ScaledResolution p_180476_1_) {
      ...
      worldrenderer.func_181662_b(0.0, (double)p_180476_1_.getScaledHeight(), -90.0).func_181673_a(0.0, 1.0).func_181675_d();
      worldrenderer.func_181662_b((double)p_180476_1_.getScaledWidth(), (double)p_180476_1_.getScaledHeight(), -90.0).func_181673_a(1.0, 1.0).func_181675_d();
      worldrenderer.func_181662_b((double)p_180476_1_.getScaledWidth(), 0.0, -90.0).func_181673_a(1.0, 0.0).func_181675_d();
   ...
   private void renderVignette(float p_180480_1_, ScaledResolution p_180480_2_) {
      if (!Config.isVignetteEnabled()) {
         ...
         WorldRenderer worldrenderer = tessellator.getWorldRenderer();
         worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
         worldrenderer.func_181662_b(0.0, (double)p_180480_2_.getScaledHeight(), -90.0).func_181673_a(0.0, 1.0).func_181675_d();
         worldrenderer.func_181662_b((double)p_180480_2_.getScaledWidth(), (double)p_180480_2_.getScaledHeight(), -90.0)
            .func_181673_a(1.0, 1.0)
            .func_181675_d();
         worldrenderer.func_181662_b((double)p_180480_2_.getScaledWidth(), 0.0, -90.0).func_181673_a(1.0, 0.0).func_181675_d();
         worldrenderer.func_181662_b(0.0, 0.0, -90.0).func_181673_a(0.0, 0.0).func_181675_d();
         tessellator.draw();
         GlStateManager.depthMask(true);
         GlStateManager.enableDepth();
   ...
   private void func_180474_b(float p_180474_1_, ScaledResolution p_180474_2_) {
      ...
      WorldRenderer worldrenderer = tessellator.getWorldRenderer();
      worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
      worldrenderer.func_181662_b(0.0, (double)p_180474_2_.getScaledHeight(), -90.0).func_181673_a((double)f, (double)f3).func_181675_d();
      worldrenderer.func_181662_b((double)p_180474_2_.getScaledWidth(), (double)p_180474_2_.getScaledHeight(), -90.0)
         .func_181673_a((double)f2, (double)f3)
         .func_181675_d();
      worldrenderer.func_181662_b((double)p_180474_2_.getScaledWidth(), 0.0, -90.0).func_181673_a((double)f2, (double)f1).func_181675_d();
      worldrenderer.func_181662_b(0.0, 0.0, -90.0).func_181673_a((double)f, (double)f1).func_181675_d();
      tessellator.draw();
      GlStateManager.depthMask(true);
      GlStateManager.enableDepth();
      GlStateManager.enableAlpha();
