...
public class GuiCommandBlock extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      this.drawString(this.fontRendererObj, I18n.format("advMode.randomPlayer"), this.width / 2 - 150, i + j++ * 9, 10526880);
      this.drawString(this.fontRendererObj, I18n.format("advMode.allPlayers"), this.width / 2 - 150, i + j++ * 9, 10526880);
      this.drawString(this.fontRendererObj, I18n.format("advMode.allEntities"), this.width / 2 - 150, i + j++ * 9, 10526880);
      this.drawString(this.fontRendererObj, "", this.width / 2 - 150, i + j++ * 9, 10526880);
