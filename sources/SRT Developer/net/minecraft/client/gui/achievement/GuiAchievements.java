...
public class GuiAchievements extends GuiScreen implements IProgressMeter {
   ...
   public GuiAchievements(GuiScreen parentScreenIn, StatFileWriter statFileWriterIn) {
      ...
      int i = 141;
      int j = 141;
      this.field_146569_s = this.field_146567_u = this.field_146565_w = (double)(
         (float)(AchievementList.openInventory.displayColumn * 24) - (float)i / 2.0F - 12.0F
      );
      this.field_146568_t = this.field_146566_v = this.field_146573_x = (double)((float)(AchievementList.openInventory.displayRow * 24) - (float)j / 2.0F);
   }
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      if (this.loadingAchievements) {
         ...
         if (this.field_146570_r != f3) {
            float f4 = f3 * 256.0F;
            float f = f3 * 202.0F;
            float f1 = this.field_146570_r * 256.0F;
            float f2 = this.field_146570_r * 202.0F;
   ...
   protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
      ...
      for(int l3 = 0; (float)l3 * f - (float)j2 < 155.0F; ++l3) {
         ...
         for(int i4 = 0; (float)i4 * f1 - (float)i2 < 224.0F; ++i4) {
            random.setSeed((long)(this.mc.getSession().getPlayerID().hashCode() + k1 + i4) + (long)(l1 + l3) * 16L);
      ...
      GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
      this.mc.getTextureManager().bindTexture(ACHIEVEMENT_BACKGROUND);
      this.drawTexturedModalRect(k, l, 0, 0, 256, 202);
      this.zLevel = 0.0F;
      GlStateManager.depthFunc(515);
      GlStateManager.disableDepth();
      GlStateManager.enableTexture2D();
