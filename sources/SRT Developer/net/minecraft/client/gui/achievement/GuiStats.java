...
public class GuiStats extends GuiScreen implements IProgressMeter {
   ...
   private void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
      ...
      worldrenderer.func_181662_b((double)p_146527_1_, (double)(p_146527_2_ + 18), (double)this.zLevel)
         .func_181673_a((double)((float)p_146527_3_ * 0.0078125F), (double)((float)(p_146527_4_ + 18) * 0.0078125F))
         .func_181675_d();
      worldrenderer.func_181662_b((double)(p_146527_1_ + 18), (double)(p_146527_2_ + 18), (double)this.zLevel)
         .func_181673_a((double)((float)(p_146527_3_ + 18) * 0.0078125F), (double)((float)(p_146527_4_ + 18) * 0.0078125F))
         .func_181675_d();
      worldrenderer.func_181662_b((double)(p_146527_1_ + 18), (double)p_146527_2_, (double)this.zLevel)
         .func_181673_a((double)((float)(p_146527_3_ + 18) * 0.0078125F), (double)((float)p_146527_4_ * 0.0078125F))
         .func_181675_d();
      worldrenderer.func_181662_b((double)p_146527_1_, (double)p_146527_2_, (double)this.zLevel)
         .func_181673_a((double)((float)p_146527_3_ * 0.0078125F), (double)((float)p_146527_4_ * 0.0078125F))
         .func_181675_d();
      tessellator.draw();
   }
      ...
      public StatsBlock(Minecraft mcIn) {
         ...
         this.statSorter = (p_compare_1_, p_compare_2_) -> {
            ...
            if (statbase != null || statbase1 != null) {
               ...
               if (l != i1) {
                  return (l - i1) * this.field_148215_p;
               }
            }
   ...
   class StatsMobsList extends GuiSlot {
      ...
      public StatsMobsList(Minecraft mcIn) {
         super(mcIn, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, 9 * 4);
         this.setShowSelectionBox(false);
      ...
      protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
         ...
         GuiStats.this.drawString(GuiStats.this.fontRendererObj, s1, p_180791_2_ + 2, p_180791_3_ + 1 + 9, i == 0 ? 6316128 : 9474192);
         GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, p_180791_2_ + 2, p_180791_3_ + 1 + 9 * 2, j == 0 ? 6316128 : 9474192);
      }
   }
}
