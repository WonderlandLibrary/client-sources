      ...
      if (button.enabled) {
         if (button.id == 1) {
            ...
            WorldSettings worldsettings = new WorldSettings(
               i, worldsettings$gametype, this.field_146341_s, this.field_146337_w, WorldType.worldTypes[this.selectedIndex]
            );
      ...
      if (this.field_146344_y) {
         ...
         if (WorldType.worldTypes[this.selectedIndex].showWorldInfoNotice()) {
            this.fontRendererObj
               .drawSplitString(
                  I18n.format(WorldType.worldTypes[this.selectedIndex].func_151359_c()),
                  this.btnMapType.xPosition + 2,
                  this.btnMapType.yPosition + 22,
