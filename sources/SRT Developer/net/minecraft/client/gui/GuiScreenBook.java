...
public class GuiScreenBook extends GuiScreen {
   ...
   public void initGui() {
      ...
      if (this.bookIsUnsigned) {
         this.buttonList.add(this.buttonSign = new GuiButton(3, this.width / 2 - 100, 4 + 192, 98, 20, I18n.format("book.signButton")));
         this.buttonList.add(this.buttonDone = new GuiButton(0, this.width / 2 + 2, 4 + 192, 98, 20, I18n.format("gui.done")));
         this.buttonList.add(this.buttonFinalize = new GuiButton(5, this.width / 2 - 100, 4 + 192, 98, 20, I18n.format("book.finalizeButton")));
         this.buttonList.add(this.buttonCancel = new GuiButton(4, this.width / 2 + 2, 4 + 192, 98, 20, I18n.format("gui.cancel")));
      } else {
         this.buttonList.add(this.buttonDone = new GuiButton(0, this.width / 2 - 100, 4 + 192, 200, 20, I18n.format("gui.done")));
      }
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.bookGettingSigned) {
            ...
            if (ItemEditableBook.validBookTagContents(this.bookObj.getTagCompound())) {
               try {
                  ...
                  this.field_175386_A = ichatcomponent != null
                     ? GuiUtilRenderComponents.func_178908_a(ichatcomponent, 116, this.fontRendererObj, true, true)
                     : null;
         ...
         if (this.field_175386_A == null) {
            ...
            int k1 = Math.min(128 / 9, this.field_175386_A.size());

            for(int l1 = 0; l1 < k1; ++l1) {
               IChatComponent ichatcomponent2 = this.field_175386_A.get(l1);
               this.fontRendererObj.drawString(ichatcomponent2.getUnformattedText(), i + 36, j + 16 + 16 + l1 * 9, 0);
            }
   ...
   public IChatComponent func_175385_b(int p_175385_1_, int p_175385_2_) {
      if (this.field_175386_A != null) {
         ...
         if (i >= 0 && j >= 0) {
            int k = Math.min(128 / 9, this.field_175386_A.size());
            if (i <= 116 && j < 9 * k + k) {
               int l = j / 9;
