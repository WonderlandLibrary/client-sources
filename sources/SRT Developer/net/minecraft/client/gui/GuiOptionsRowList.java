...
public class GuiOptionsRowList extends GuiListExtended {
   ...
   public GuiOptionsRowList(
      Minecraft mcIn, int p_i45015_2_, int p_i45015_3_, int p_i45015_4_, int p_i45015_5_, int p_i45015_6_, GameSettings.Options... p_i45015_7_
   ) {
   ...
   private GuiButton func_148182_a(Minecraft mcIn, int p_148182_2_, GameSettings.Options p_148182_4_) {
      if (p_148182_4_ == null) {
         ...
         return (GuiButton)(p_148182_4_.getEnumFloat()
            ? new GuiOptionSlider(i, p_148182_2_, 0, p_148182_4_)
            : new GuiOptionButton(i, p_148182_2_, 0, p_148182_4_, mcIn.gameSettings.getKeyBinding(p_148182_4_)));
      }
   }
