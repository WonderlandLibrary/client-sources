...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
   ...
   private void func_175325_f() {
      ...
      GuiPageButtonList.GuiListEntry[] aguipagebuttonlist$guilistentry2 = new GuiPageButtonList.GuiListEntry[]{
         ...
         new GuiPageButtonList.GuiSlideEntry(
            109, I18n.format("createWorld.customize.custom.stretchY"), false, this, 0.01F, 50.0F, this.field_175336_F.stretchY
         ),
         new GuiPageButtonList.GuiSlideEntry(
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.field_175339_B != 0) {
         ...
         worldrenderer.func_181662_b((double)((float)this.width / 2.0F - 90.0F), 185.0, 0.0)
            .func_181673_a(0.0, 2.65625)
            .func_181669_b(64, 64, 64, 64)
            .func_181675_d();
         worldrenderer.func_181662_b((double)((float)this.width / 2.0F + 90.0F), 185.0, 0.0)
            .func_181673_a(5.625, 2.65625)
            .func_181669_b(64, 64, 64, 64)
            .func_181675_d();
         worldrenderer.func_181662_b((double)((float)this.width / 2.0F + 90.0F), 100.0, 0.0)
            .func_181673_a(5.625, 0.0)
            .func_181669_b(64, 64, 64, 64)
            .func_181675_d();
         worldrenderer.func_181662_b((double)((float)this.width / 2.0F - 90.0F), 100.0, 0.0)
