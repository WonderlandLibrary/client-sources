...
public class MapItemRenderer {
   ...
   class Instance {
      ...
      private void render(boolean noOverlayRendering) {
         ...
         worldrenderer.func_181662_b((double)((float)i + f), (double)((float)(j + 128) - f), -0.01F).func_181673_a(0.0, 1.0).func_181675_d();
         worldrenderer.func_181662_b((double)((float)(i + 128) - f), (double)((float)(j + 128) - f), -0.01F).func_181673_a(1.0, 1.0).func_181675_d();
         worldrenderer.func_181662_b((double)((float)(i + 128) - f), (double)((float)j + f), -0.01F).func_181673_a(1.0, 0.0).func_181675_d();
         worldrenderer.func_181662_b((double)((float)i + f), (double)((float)j + f), -0.01F).func_181673_a(0.0, 0.0).func_181675_d();
         tessellator.draw();
         ...
         for(Vec4b vec4b : this.mapData.playersVisibleOnMap.values()) {
            if (!noOverlayRendering || vec4b.func_176110_a() == 1) {
               ...
               worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
               float f5 = -0.001F;
               worldrenderer.func_181662_b(-1.0, 1.0, (double)((float)k * -0.001F)).func_181673_a((double)f1, (double)f2).func_181675_d();
               worldrenderer.func_181662_b(1.0, 1.0, (double)((float)k * -0.001F)).func_181673_a((double)f3, (double)f2).func_181675_d();
               worldrenderer.func_181662_b(1.0, -1.0, (double)((float)k * -0.001F)).func_181673_a((double)f3, (double)f4).func_181675_d();
               worldrenderer.func_181662_b(-1.0, -1.0, (double)((float)k * -0.001F)).func_181673_a((double)f1, (double)f4).func_181675_d();
               tessellator.draw();
