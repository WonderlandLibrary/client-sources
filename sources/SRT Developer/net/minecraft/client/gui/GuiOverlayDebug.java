...
public class GuiOverlayDebug extends Gui {
   ...
   protected List<String> call() {
      ...
      if (!this.mc.debug.equals(this.debugOF)) {
         StringBuilder builder = new StringBuilder(this.mc.debug);
         ...
         this.mc.debug = builder.toString();
         ...
         if (this.mc.theWorld != null && this.mc.theWorld.isBlockLoaded(blockpos)) {
            ...
            if (this.mc.isIntegratedServerRunning() && this.mc.getIntegratedServer() != null) {
               ...
               if (entityplayermp != null) {
                  DifficultyInstance difficultyinstance1 = this.mc
                     .getIntegratedServer()
   ...
   protected List<String> getDebugInfoRight() {
      ...
      if (Reflector.FMLCommonHandler_getBrandings.exists()) {
         ...
         list.add("");
         list.addAll(Objects.requireNonNull((Collection<? extends String>)Reflector.call(object, Reflector.FMLCommonHandler_getBrandings, Boolean.FALSE)));
      }
      ...
      if (this.isReducedDebug()) {
         ...
         if (this.mc.objectMouseOver != null
            ...
            String s1;
            for(UnmodifiableIterator var17 = iblockstate.getProperties().entrySet().iterator();
               var17.hasNext();
