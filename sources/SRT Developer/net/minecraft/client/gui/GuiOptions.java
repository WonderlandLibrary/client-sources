   ...
   public void initGui() {
      ...
      if (this.mc.theWorld != null) {
         ...
         this.field_175357_i = new GuiButton(
            108, this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), 170, 20, this.func_175355_a(enumdifficulty)
         );
               ...
               .displayGuiScreen(
                  new GuiYesNo(
                     ...
                     new ChatComponentTranslation(
                           ...
                           new ChatComponentTranslation(this.mc.theWorld.getWorldInfo().getDifficulty().getDifficultyResourceKey())
                        )
                        .getFormattedText(),
                     109
                  )
