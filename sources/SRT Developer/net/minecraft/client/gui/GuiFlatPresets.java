...
public class GuiFlatPresets extends GuiScreen {
   ...
   class ListSlot extends GuiSlot {
      ...
      private void func_148171_c(int p_148171_1_, int p_148171_2_) {
         ...
         worldrenderer.func_181662_b((double)p_148171_1_, (double)(p_148171_2_ + 18), (double)GuiFlatPresets.this.zLevel)
            .func_181673_a(0.0, 0.140625)
            .func_181675_d();
         worldrenderer.func_181662_b((double)(p_148171_1_ + 18), (double)(p_148171_2_ + 18), (double)GuiFlatPresets.this.zLevel)
            .func_181673_a(0.140625, 0.140625)
            .func_181675_d();
         worldrenderer.func_181662_b((double)(p_148171_1_ + 18), (double)p_148171_2_, (double)GuiFlatPresets.this.zLevel)
            .func_181673_a(0.140625, 0.0)
            .func_181675_d();
         worldrenderer.func_181662_b((double)p_148171_1_, (double)p_148171_2_, (double)GuiFlatPresets.this.zLevel).func_181673_a(0.0, 0.0).func_181675_d();
         tessellator.draw();
      }
