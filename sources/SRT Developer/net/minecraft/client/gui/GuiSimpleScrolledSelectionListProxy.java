...
public class GuiSimpleScrolledSelectionListProxy extends GuiSlot {
   ...
   public GuiSimpleScrolledSelectionListProxy(
      RealmsSimpleScrolledSelectionList p_i45525_1_, int widthIn, int heightIn, int topIn, int bottomIn, int slotHeightIn
   ) {
