...
public class Shader {
   ...
   public void loadShader(float p_148042_1_) {
      ...
      this.manager
         .getShaderUniformOrDefault("InSize")
         .set((float)this.framebufferIn.framebufferTextureWidth, (float)this.framebufferIn.framebufferTextureHeight);
      ...
      worldrenderer.func_181662_b(0.0, (double)f1, 500.0).func_181669_b(255, 255, 255, 255).func_181675_d();
      worldrenderer.func_181662_b((double)f, (double)f1, 500.0).func_181669_b(255, 255, 255, 255).func_181675_d();
      worldrenderer.func_181662_b((double)f, 0.0, 500.0).func_181669_b(255, 255, 255, 255).func_181675_d();
