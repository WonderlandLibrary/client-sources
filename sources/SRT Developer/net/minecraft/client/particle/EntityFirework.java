...
public class EntityFirework {
   public static class Factory implements IParticleFactory {
      ...
      public EntityFX getEntityFX(
         ...
         EntityFirework.SparkFX entityfirework$sparkfx = new EntityFirework.SparkFX(
            worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn, Minecraft.getMinecraft().effectRenderer
         );
   ...
   public static class OverlayFX extends EntityFX {
      ...
      public void renderParticle(
         ...
         worldRendererIn.func_181662_b(
               (double)(f5 - p_180434_4_ * f4 - p_180434_7_ * f4), (double)(f6 - p_180434_5_ * f4), (double)(f7 - p_180434_6_ * f4 - p_180434_8_ * f4)
            )
            .func_181673_a(0.5, 0.375)
            .func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha)
            .func_181671_a(j, k)
            .func_181675_d();
         worldRendererIn.func_181662_b(
               (double)(f5 - p_180434_4_ * f4 + p_180434_7_ * f4), (double)(f6 + p_180434_5_ * f4), (double)(f7 - p_180434_6_ * f4 + p_180434_8_ * f4)
            )
            .func_181673_a(0.5, 0.125)
            .func_181666_a(this.particleRed, this.particleGreen, this.particleBlue, this.particleAlpha)
            .func_181671_a(j, k)
            .func_181675_d();
         worldRendererIn.func_181662_b(
   ...
   public static class SparkFX extends EntityFX {
      ...
      public void setColour(int colour) {
         ...
         float f2 = (float)(colour & 0xFF) / 255.0F;
         float f3 = 1.0F;
      ...
      public void setFadeColour(int faceColour) {
         ...
         this.fadeColourBlue = (float)(faceColour & 0xFF) / 255.0F;
      ...
      public void onUpdate() {
         ...
         if (this.trail && this.particleAge < this.particleMaxAge / 2 && (this.particleAge + this.particleMaxAge) % 2 == 0) {
            EntityFirework.SparkFX entityfirework$sparkfx = new EntityFirework.SparkFX(
               this.worldObj, this.posX, this.posY, this.posZ, 0.0, 0.0, 0.0, this.field_92047_az
            );
            entityfirework$sparkfx.setAlphaF(0.99F);
   ...
   public static class StarterFX extends EntityFX {
      ...
      private boolean func_92037_i() {
         ...
         return minecraft == null
            ...
            || minecraft.getRenderViewEntity().getDistanceSq(this.posX, this.posY, this.posZ) >= 256.0;
      }
      ...
      private void createParticle(
         ...
         EntityFirework.SparkFX entityfirework$sparkfx = new EntityFirework.SparkFX(
            this.worldObj, p_92034_1_, p_92034_3_, p_92034_5_, p_92034_7_, p_92034_9_, p_92034_11_, this.theEffectRenderer
         );
         entityfirework$sparkfx.setAlphaF(0.99F);
      ...
      private void createShaped(double[][] shape, int[] colours, int[] fadeColours, boolean trail, boolean twinkleIn, boolean p_92038_8_) {
         double d0 = shape[0][0];
         double d1 = shape[0][1];
         this.createParticle(this.posX, this.posY, this.posZ, d0 * 0.5, d1 * 0.5, 0.0, colours, fadeColours, trail, twinkleIn);
