...
public class ResourcePackRepository {
   ...
   private List<File> getResourcePackFiles() {
      return this.dirResourcepacks.isDirectory()
         ? Arrays.asList(Objects.requireNonNull(this.dirResourcepacks.listFiles(resourcePackFilter)))
      ...
      try {
         ...
         if (file1.exists() && hash.length() == 40) {
            try {
               ...
               logger.warn("File " + file1 + " couldn't be hashed. Deleting it.", var13);
               FileUtils.deleteQuietly(file1);
            }
         }
   ...
   public class Entry {
      ...
      public boolean equals(Object p_equals_1_) {
         return this == p_equals_1_ || p_equals_1_ instanceof ResourcePackRepository.Entry && this.toString().equals(p_equals_1_.toString());
      }
