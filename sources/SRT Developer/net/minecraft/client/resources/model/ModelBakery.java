...
public class ModelBakery {
      ...
      this.variants
         .put(
            ...
            new ModelBlockDefinition.Variants(
               ...
               Lists.newArrayList(
                  new ModelBlockDefinition.Variant[]{
   ...
   private ModelBlockDefinition getModelBlockDefinition(ResourceLocation p_177586_1_) {
      ...
      if (modelblockdefinition == null) {
         ...
         try {
            ...
            throw new RuntimeException("Encountered an exception when loading model definition of model " + resourcelocation, var15);
         }
   ...
   public static ResourceLocation fixModelLocation(ResourceLocation p_fixModelLocation_0_, String p_fixModelLocation_1_) {
      if (p_fixModelLocation_0_ != null && p_fixModelLocation_1_ != null && p_fixModelLocation_0_.getResourceDomain().equals("minecraft")) {
