...
public class PlayerControllerMP {
   ...
   private final Module blockReachMod = Ries.INSTANCE.getModuleManager().getModuleByName("BlockReach");
   ...
   public float getBlockReachDistance() {
      return this.blockReachMod.isEnabled()
         ? (float)Ries.INSTANCE.getSettingManager().getSetting(this.blockReachMod, "INTERNAL_BLOCK_REACH_VALUE", Setting.Type.SLIDER).getCurrentValue()
