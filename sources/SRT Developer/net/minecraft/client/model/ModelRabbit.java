...
public class ModelRabbit extends ModelBase {
   ...
   public ModelRabbit() {
      ...
      this.setRotationOffset(this.rabbitLeftThigh, (float) (-Math.PI / 9), 0.0F);
      ...
      this.setRotationOffset(this.rabbitRightThigh, (float) (-Math.PI / 9), 0.0F);
      ...
      this.setRotationOffset(this.rabbitBody, (float) (-Math.PI / 9), 0.0F);
      ...
      this.setRotationOffset(this.rabbitLeftArm, (float) (-Math.PI / 18), 0.0F);
      ...
      this.setRotationOffset(this.rabbitRightArm, (float) (-Math.PI / 18), 0.0F);
      ...
      this.setRotationOffset(this.rabbitRightEar, 0.0F, (float) (-Math.PI / 12));
      ...
      this.setRotationOffset(this.rabbitLeftEar, 0.0F, (float) (Math.PI / 12));
   ...
   public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn) {
      ...
      this.rabbitNose.rotateAngleX = this.rabbitHead.rotateAngleX = this.rabbitRightEar.rotateAngleX = this.rabbitLeftEar.rotateAngleX = p_78087_5_
         * (float) (Math.PI / 180.0);
      this.rabbitNose.rotateAngleY = this.rabbitHead.rotateAngleY = p_78087_4_ * (float) (Math.PI / 180.0);
      ...
      this.rabbitLeftThigh.rotateAngleX = this.rabbitRightThigh.rotateAngleX = (this.field_178701_m * 50.0F - 21.0F) * (float) (Math.PI / 180.0);
      this.rabbitLeftFoot.rotateAngleX = this.rabbitRightFoot.rotateAngleX = this.field_178701_m * 50.0F * (float) (Math.PI / 180.0);
      this.rabbitLeftArm.rotateAngleX = this.rabbitRightArm.rotateAngleX = (this.field_178701_m * -40.0F - 11.0F) * (float) (Math.PI / 180.0);
   }
