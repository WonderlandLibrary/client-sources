...
public class ModelGuardian extends ModelBase {
   ...
   public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn) {
      ...
      this.guardianBody.rotateAngleY = p_78087_4_ / (180.0F / (float)Math.PI);
      this.guardianBody.rotateAngleX = p_78087_5_ / (180.0F / (float)Math.PI);
      ...
      if (entity != null) {
         ...
         Vec3 vec33 = new Vec3(vec31.xCoord - vec3.xCoord, 0.0, vec31.zCoord - vec3.zCoord).normalize().rotateYaw((float) (Math.PI / 2));
