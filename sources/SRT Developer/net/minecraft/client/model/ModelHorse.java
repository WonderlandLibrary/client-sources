...
public class ModelHorse extends ModelBase {
   ...
   public ModelHorse() {
      ...
      this.setBoxRotation(this.head, (float) (Math.PI / 6), 0.0F, 0.0F);
      ...
      this.setBoxRotation(this.field_178711_b, (float) (Math.PI / 6), 0.0F, 0.0F);
      ...
      this.setBoxRotation(this.field_178712_c, (float) (Math.PI / 6), 0.0F, 0.0F);
      ...
      this.setBoxRotation(this.horseLeftEar, (float) (Math.PI / 6), 0.0F, 0.0F);
      ...
      this.setBoxRotation(this.horseRightEar, (float) (Math.PI / 6), 0.0F, 0.0F);
      ...
      this.setBoxRotation(this.muleLeftEar, (float) (Math.PI / 6), 0.0F, (float) (Math.PI / 12));
      ...
      this.setBoxRotation(this.muleRightEar, (float) (Math.PI / 6), 0.0F, (float) (-Math.PI / 12));
      this.neck = new ModelRenderer(this, 0, 12);
      this.neck.addBox(-2.05F, -9.8F, -2.0F, 4, 14, 8);
      this.neck.setRotationPoint(0.0F, 4.0F, -10.0F);
      this.setBoxRotation(this.neck, (float) (Math.PI / 6), 0.0F, 0.0F);
      ...
      this.setBoxRotation(this.muleLeftChest, 0.0F, (float) (Math.PI / 2), 0.0F);
      ...
      this.setBoxRotation(this.muleRightChest, 0.0F, (float) (Math.PI / 2), 0.0F);
      ...
      this.setBoxRotation(this.horseLeftFaceMetal, (float) (Math.PI / 6), 0.0F, 0.0F);
      ...
      this.setBoxRotation(this.horseRightFaceMetal, (float) (Math.PI / 6), 0.0F, 0.0F);
      ...
      this.setBoxRotation(this.mane, (float) (Math.PI / 6), 0.0F, 0.0F);
      ...
      this.setBoxRotation(this.horseFaceRopes, (float) (Math.PI / 6), 0.0F, 0.0F);
   }
   ...
   public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
      ...
      this.head.rotateAngleX = (float) (Math.PI / 6) + f4;
      this.head.rotateAngleY = f3 / (180.0F / (float)Math.PI);
      this.head.rotateAngleX = f6 * ((float) (Math.PI / 12) + f4) + f5 * 2.18166F + (1.0F - Math.max(f6, f5)) * this.head.rotateAngleX;
      this.head.rotateAngleY = f6 * f3 / (180.0F / (float)Math.PI) + (1.0F - Math.max(f6, f5)) * this.head.rotateAngleY;
      ...
      this.field_178712_c.rotateAngleX = 0.0F + (float) (Math.PI / 20) * f8;
      ...
      this.backLeftShin.rotationPointY = this.backLeftLeg.rotationPointY + MathHelper.sin((float) (Math.PI / 2) + f15 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
      this.backLeftShin.rotationPointZ = this.backLeftLeg.rotationPointZ
         + MathHelper.cos((float) (Math.PI * 3.0 / 2.0) + f15 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
      this.backRightShin.rotationPointY = this.backRightLeg.rotationPointY + MathHelper.sin((float) (Math.PI / 2) + f15 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
      ...
      this.frontLeftShin.rotationPointY = this.frontLeftLeg.rotationPointY + MathHelper.sin((float) (Math.PI / 2) + f17) * 7.0F;
      this.frontLeftShin.rotationPointZ = this.frontLeftLeg.rotationPointZ + MathHelper.cos((float) (Math.PI * 3.0 / 2.0) + f17) * 7.0F;
      this.frontRightShin.rotationPointY = this.frontRightLeg.rotationPointY + MathHelper.sin((float) (Math.PI / 2) + f18) * 7.0F;
      this.frontRightShin.rotationPointZ = this.frontRightLeg.rotationPointZ + MathHelper.cos((float) (Math.PI * 3.0 / 2.0) + f18) * 7.0F;
      ...
      this.frontLeftShin.rotateAngleX = (this.frontLeftLeg.rotateAngleX + (float) Math.PI * Math.max(0.0F, 0.2F + f16 * 0.2F)) * f6
      ...
      this.frontRightShin.rotateAngleX = (this.frontRightLeg.rotateAngleX + (float) Math.PI * Math.max(0.0F, 0.2F - f16 * 0.2F)) * f6
         + (-f11 + Math.max(0.0F, -f10 * 0.5F * p_78086_3_)) * f7;
      ...
      float f12 = -1.3089F + p_78086_3_ * 1.5F;
      if (f12 > 0.0F) {
         f12 = 0.0F;
      }
