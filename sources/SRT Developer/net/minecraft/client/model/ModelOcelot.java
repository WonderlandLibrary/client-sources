...
public class ModelOcelot extends ModelBase {
   ...
   public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn) {
      this.ocelotHead.rotateAngleX = p_78087_5_ / (180.0F / (float)Math.PI);
      this.ocelotHead.rotateAngleY = p_78087_4_ / (180.0F / (float)Math.PI);
      if (this.field_78163_i != 3) {
         this.ocelotBody.rotateAngleX = (float) (Math.PI / 2);
         if (this.field_78163_i == 2) {
            ...
            this.ocelotTail2.rotateAngleX = 1.7278761F + (float) (Math.PI / 10) * MathHelper.cos(p_78087_1_) * p_78087_2_;
         } else {
            this.ocelotBackLeftLeg.rotateAngleX = MathHelper.cos(p_78087_1_ * 0.6662F) * 1.0F * p_78087_2_;
            ...
            if (this.field_78163_i == 1) {
               this.ocelotTail2.rotateAngleX = 1.7278761F + (float) (Math.PI / 4) * MathHelper.cos(p_78087_1_) * p_78087_2_;
            } else {
   ...
   public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
      ...
      if (entityocelot.isSneaking()) {
         ...
         this.ocelotTail.rotateAngleX = (float) (Math.PI / 2);
         this.ocelotTail2.rotateAngleX = (float) (Math.PI / 2);
         ...
         this.ocelotBody.rotateAngleX = (float) (Math.PI / 4);
         ...
         this.ocelotFrontLeftLeg.rotateAngleX = this.ocelotFrontRightLeg.rotateAngleX = (float) (-Math.PI / 20);
         ...
         this.ocelotBackLeftLeg.rotateAngleX = this.ocelotBackRightLeg.rotateAngleX = (float) (-Math.PI / 2);
