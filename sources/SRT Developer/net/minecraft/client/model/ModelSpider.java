...
public class ModelSpider extends ModelBase {
   ...
   public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity entityIn) {
      this.spiderHead.rotateAngleY = p_78087_4_ / (180.0F / (float)Math.PI);
      this.spiderHead.rotateAngleX = p_78087_5_ / (180.0F / (float)Math.PI);
      ...
      float f5 = -(MathHelper.cos(p_78087_1_ * 0.6662F * 2.0F + (float) (Math.PI / 2)) * 0.4F) * p_78087_2_;
      float f6 = -(MathHelper.cos(p_78087_1_ * 0.6662F * 2.0F + (float) (Math.PI * 3.0 / 2.0)) * 0.4F) * p_78087_2_;
      ...
      float f9 = Math.abs(MathHelper.sin(p_78087_1_ * 0.6662F + (float) (Math.PI / 2)) * 0.4F) * p_78087_2_;
      float f10 = Math.abs(MathHelper.sin(p_78087_1_ * 0.6662F + (float) (Math.PI * 3.0 / 2.0)) * 0.4F) * p_78087_2_;
