...
public class TextureUtil {
   ...
   private static int blendColorComponent(int p_147944_0_, int p_147944_1_, int p_147944_2_, int p_147944_3_, int p_147944_4_) {
      float f = (float)Math.pow((double)((float)(p_147944_0_ >> p_147944_4_ & 0xFF) / 255.0F), 2.2);
      float f1 = (float)Math.pow((double)((float)(p_147944_1_ >> p_147944_4_ & 0xFF) / 255.0F), 2.2);
      float f2 = (float)Math.pow((double)((float)(p_147944_2_ >> p_147944_4_ & 0xFF) / 255.0F), 2.2);
      float f3 = (float)Math.pow((double)((float)(p_147944_3_ >> p_147944_4_ & 0xFF) / 255.0F), 2.2);
   ...
   public static void allocateTextureImpl(int p_180600_0_, int p_180600_1_, int p_180600_2_, int p_180600_3_) {
      ...
      for(int i = 0; i <= p_180600_1_; ++i) {
         GL11.glTexImage2D(3553, i, 6408, p_180600_2_ >> i, p_180600_3_ >> i, 0, 32993, 33639, (ByteBuffer)null);
      }
   }

   public static void uploadTextureImageSub(
   ...
   private static void copyToBufferPos(int[] p_110994_0_, int p_110994_1_, int p_110994_2_) {
      ...
      ((Buffer)dataBuffer).position(0).limit(p_110994_2_);
   }
