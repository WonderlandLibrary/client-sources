...
public class Stitcher {
   ...
   public void doStitch() {
      Stitcher.Holder[] astitcher$holder = this.setStitchHolders.toArray(new Stitcher.Holder[0]);
   ...
   private boolean allocateSlot(Stitcher.Holder p_94310_1_) {
      for(Stitcher.Slot stitchSlot : this.stitchSlots) {
   ...
   public static class Holder implements Comparable<Stitcher.Holder> {
      ...
      public int getWidth() {
         return this.rotated
            ? Stitcher.getMipmapDimension((int)((float)this.height * this.scaleFactor), this.mipmapLevelHolder)
