...
public class RenderXPOrb extends Render<EntityXPOrb> {
   ...
   public void doRender(EntityXPOrb entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      int i1 = 255;
      int j1 = (int)((MathHelper.sin(f8 + (float) (Math.PI * 4.0 / 3.0)) + 1.0F) * 0.1F * 255.0F);
      ...
      worldrenderer.func_181662_b((double)(0.0F - f5), (double)(0.0F - f6), 0.0)
         .func_181673_a((double)f, (double)f3)
         .func_181669_b(k1, l1, i2, 128)
         .func_181663_c(0.0F, 1.0F, 0.0F)
         .func_181675_d();
      worldrenderer.func_181662_b((double)(f4 - f5), (double)(0.0F - f6), 0.0)
         .func_181673_a((double)f1, (double)f3)
         .func_181669_b(k1, l1, i2, 128)
         .func_181663_c(0.0F, 1.0F, 0.0F)
         .func_181675_d();
      worldrenderer.func_181662_b((double)(f4 - f5), (double)(1.0F - f6), 0.0)
         .func_181673_a((double)f1, (double)f2)
         .func_181669_b(k1, l1, i2, 128)
         .func_181663_c(0.0F, 1.0F, 0.0F)
         .func_181675_d();
      worldrenderer.func_181662_b((double)(0.0F - f5), (double)(1.0F - f6), 0.0)
