...
public class RenderDragon extends RenderLiving<EntityDragon> {
   ...
   protected final ModelDragon modelDragon = (ModelDragon)this.mainModel;
   ...
   protected void renderModel(
      EntityDragon entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_
   ) {
   ...
   protected void drawRechargeRay(EntityDragon dragon, double p_180574_2_, double p_180574_4_, double p_180574_6_, float p_180574_8_) {
      ...
      for(int j = 0; j <= 8; ++j) {
         ...
         worldrenderer.func_181662_b((double)(f9 * 0.2F), (double)(f10 * 0.2F), 0.0)
            .func_181673_a((double)f11, (double)f8)
            .func_181669_b(0, 0, 0, 255)
            .func_181675_d();
         worldrenderer.func_181662_b((double)f9, (double)f10, (double)f6)
            .func_181673_a((double)f11, (double)f7)
