...
import me.uncodable.srt.impl.events.events.render.EventNameTagRender;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
   ...
   protected void renderLayers(
      T entitylivingbaseIn, float p_177093_2_, float p_177093_3_, float partialTicks, float p_177093_5_, float p_177093_6_, float p_177093_7_
   ) {
      for(LayerRenderer<T> layerrenderer : this.layerRenderers) {
         ...
         layerrenderer.doRenderLayer(entitylivingbaseIn, p_177093_2_, p_177093_3_, partialTicks, p_177093_5_, p_177093_6_, p_177093_7_, 0.0625F);
         if (this.renderLayersPushMatrix) {
            GlStateManager.popMatrix();
         }
   ...
   public void renderName(T entity, double x, double y, double z) {
      if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists()
         ...
         EventBus.processEvent(new EventNameTagRender(entity));
