...
public class RenderItem implements IResourceManagerReloadListener {
   ...
   private final Module enchGlintMod = Ries.INSTANCE.getModuleManager().getModuleByName("EnchantmentGlint");
   ...
   private void renderEffect(IBakedModel model) {
      boolean render = !this.enchGlintMod.isEnabled()
         || !Ries.INSTANCE.getSettingManager().getSetting(this.enchGlintMod, "INTERNAL_DISABLE_GLINT", Setting.Type.CHECKBOX).isTicked();
      int color = -8372020;
      if (this.enchGlintMod.isEnabled()) {
         int red = (int)Ries.INSTANCE.getSettingManager().getSetting(this.enchGlintMod, "INTERNAL_RED_VALUE", Setting.Type.SLIDER).getCurrentValue();
         int green = (int)Ries.INSTANCE.getSettingManager().getSetting(this.enchGlintMod, "INTERNAL_GREEN_VALUE", Setting.Type.SLIDER).getCurrentValue();
         int blue = (int)Ries.INSTANCE.getSettingManager().getSetting(this.enchGlintMod, "INTERNAL_BLUE_VALUE", Setting.Type.SLIDER).getCurrentValue();
      ...
      if (stack != null && entityToRenderFor != null) {
         ...
         if (entityToRenderFor instanceof EntityPlayer) {
            ...
            if (item == Items.fishing_rod && entityplayer.fishEntity != null) {
               ...
               modelresourcelocation = (ModelResourceLocation)Reflector.call(
                  item, Reflector.ForgeItem_getModel, stack, entityplayer, entityplayer.getItemInUseCount()
               );
            }
   ...
   public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text) {
      if (stack != null) {
         ...
         if (ReflectorForge.isItemDamaged(stack)) {
            ...
            Tessellator tessellator = Tessellator.getInstance();
            WorldRenderer worldrenderer = tessellator.getWorldRenderer();
            this.func_181565_a(worldrenderer, xPosition + 2, yPosition + 13, 13, 2, 0, 0, 0);
            this.func_181565_a(worldrenderer, xPosition + 2, yPosition + 13, 12, 1, (255 - i) / 4, 64, 0);
            int j = 255 - i;
            int k = i;
            int l = 0;
            if (Config.isCustomColors()) {
            ...
            this.func_181565_a(worldrenderer, xPosition + 2, yPosition + 13, j1, 1, j, k, l);
            GlStateManager.enableBlend();
            GlStateManager.enableAlpha();
   ...
   private void func_181565_a(
      WorldRenderer p_181565_1_, int p_181565_2_, int p_181565_3_, int p_181565_4_, int p_181565_5_, int p_181565_6_, int p_181565_7_, int p_181565_8_
   ) {
      p_181565_1_.func_181668_a(7, DefaultVertexFormats.field_181706_f);
      p_181565_1_.func_181662_b((double)p_181565_2_, (double)p_181565_3_, 0.0).func_181669_b(p_181565_6_, p_181565_7_, p_181565_8_, 255).func_181675_d();
      p_181565_1_.func_181662_b((double)p_181565_2_, (double)(p_181565_3_ + p_181565_5_), 0.0)
         .func_181669_b(p_181565_6_, p_181565_7_, p_181565_8_, 255)
         .func_181675_d();
      p_181565_1_.func_181662_b((double)(p_181565_2_ + p_181565_4_), (double)(p_181565_3_ + p_181565_5_), 0.0)
         .func_181669_b(p_181565_6_, p_181565_7_, p_181565_8_, 255)
         .func_181675_d();
      p_181565_1_.func_181662_b((double)(p_181565_2_ + p_181565_4_), (double)p_181565_3_, 0.0)
         .func_181669_b(p_181565_6_, p_181565_7_, p_181565_8_, 255)
         .func_181675_d();
   ...
   private void registerItems() {
      ...
      this.itemModelMesher
         .register(
            Items.potionitem,
            stack -> ItemPotion.isSplash(stack.getMetadata())
   ...
   public static void forgeHooksClient_putQuadColor(
      WorldRenderer p_forgeHooksClient_putQuadColor_0_, BakedQuad p_forgeHooksClient_putQuadColor_1_, int p_forgeHooksClient_putQuadColor_2_
   ) {
      float f = (float)(p_forgeHooksClient_putQuadColor_2_ & 0xFF);
      float f1 = (float)(p_forgeHooksClient_putQuadColor_2_ >>> 8 & 0xFF);
      float f2 = (float)(p_forgeHooksClient_putQuadColor_2_ >>> 16 & 0xFF);
      float f3 = (float)(p_forgeHooksClient_putQuadColor_2_ >>> 24 & 0xFF);
      int[] aint = p_forgeHooksClient_putQuadColor_1_.getVertexData();
      int i = aint.length / 4;

      for(int j = 0; j < 4; ++j) {
         int k = aint[3 + i * j];
         float f4 = (float)(k & 0xFF);
         float f5 = (float)(k >>> 8 & 0xFF);
         float f6 = (float)(k >>> 16 & 0xFF);
         float f7 = (float)(k >>> 24 & 0xFF);
