   ...
   public void doRenderLayer(
      ...
      if (entitylivingbaseIn.deathTicks > 0) {
         ...
         for(int i = 0; (float)i < (f + f * f) / 2.0F * 60.0F; ++i) {
            ...
            worldrenderer.func_181662_b(-0.866 * (double)f3, (double)f2, (double)(-0.5F * f3)).func_181669_b(255, 0, 255, 0).func_181675_d();
            worldrenderer.func_181662_b(0.866 * (double)f3, (double)f2, (double)(-0.5F * f3)).func_181669_b(255, 0, 255, 0).func_181675_d();
            worldrenderer.func_181662_b(0.0, (double)f2, (double)f3).func_181669_b(255, 0, 255, 0).func_181675_d();
            worldrenderer.func_181662_b(-0.866 * (double)f3, (double)f2, (double)(-0.5F * f3)).func_181669_b(255, 0, 255, 0).func_181675_d();
            tessellator.draw();
         }
