...
import me.uncodable.srt.impl.events.events.render.EventEntityRender;
...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   private float constantUpdatePTicks;
   ...
   private final Module reachMod = Ries.INSTANCE.getModuleManager().getModuleByName("Reach");
   private final Module noEffectRenderMod = Ries.INSTANCE.getModuleManager().getModuleByName("NoEffectRender");
   private final Module noHurtDisplay = Ries.INSTANCE.getModuleManager().getModuleByName("NoHurtDisplay");
   ...
   public void getMouseOver(float partialTicks) {
      ...
      if (entity != null && this.mc.theWorld != null) {
         ...
         if (this.mc.playerController.extendedReach()) {
            d0 = 6.0;
            d1 = 6.0;
         } else if (d0 > 3.0 && !this.reachMod.isEnabled()) {
            flag = true;
         }

         if (this.mc.objectMouseOver != null) {
            d1 = this.reachMod.isEnabled()
               ? Ries.INSTANCE.getSettingManager().getSetting(this.reachMod, "INTERNAL_REACH_VALUE", Setting.Type.SLIDER).getCurrentValue()
               : this.mc.objectMouseOver.hitVec.distanceTo(vec3);
         }
   ...
   private float getFOVModifier(float partialTicks, boolean p_78481_2_) {
      ...
      return Reflector.ForgeHooksClient_getFOVModifier.exists()
         ? Reflector.callFloat(Reflector.ForgeHooksClient_getFOVModifier, this, entity, block, partialTicks, f)
         : f;
   }

   private void hurtCameraEffect(float partialTicks) {
      if (this.mc.getRenderViewEntity() instanceof EntityLivingBase && !this.noHurtDisplay.isEnabled()) {
   ...
   public void orientCamera(float partialTicks) {
      ...
      if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
         ...
         double d3 = (double)(this.thirdPersonDistanceTemp + (4.0F - this.thirdPersonDistanceTemp) * partialTicks);
         if (this.mc.gameSettings.debugCamEnable) {
   ...
   public void setupCameraTransform(float partialTicks, int pass) {
      ...
      if (this.noEffectRenderMod.isEnabled()) {
         f1 = 0.0F;
      }
         ...
         if (world != null) {
            if (Config.isCustomColors()
               && CustomColors.updateLightmap(
                  world, this.torchFlickerX, this.lightmapColors, this.mc.thePlayer.isPotionActive(Potion.nightVision), partialTicks
               )) {
   ...
   public void func_181560_a(float p_181560_1_, long p_181560_2_) {
      EventGameRender eventGameRender = new EventGameRender(p_181560_1_, p_181560_2_);
      EventBus.processEvent(eventGameRender);
      Config.renderPartialTicks = eventGameRender.getPartialTicks();
      this.frameInit();
      ...
      if (this.mc.inGameHasFocus && flag) {
         ...
         this.constantUpdatePTicks = eventGameRender.getPartialTicks();
         if (this.mc.gameSettings.smoothCamera) {
            this.smoothCamYaw += f2;
            this.smoothCamPitch += f3;
            float f4 = eventGameRender.getPartialTicks() - this.smoothCamPartialTicks;
            this.smoothCamPartialTicks = eventGameRender.getPartialTicks();
      ...
      if (!this.mc.skipRenderWorld) {
         ...
         if (this.mc.theWorld != null) {
            ...
            j = Math.max(j, 60);
            long k = System.nanoTime() - eventGameRender.getNanoTime();
            long l = Math.max((long)(1000000000 / j / 4) - k, 0L);
            this.renderWorld(eventGameRender.getPartialTicks(), System.nanoTime() + l);
            if (OpenGlHelper.shadersSupported) {
               ...
               if (this.theShaderGroup != null && this.useShader) {
                  ...
                  GlStateManager.pushMatrix();
                  GlStateManager.loadIdentity();
                  this.theShaderGroup.loadShaderGroup(eventGameRender.getPartialTicks());
                  GlStateManager.popMatrix();
               }
            ...
            if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null) {
               ...
               this.mc.ingameGUI.renderGameOverlay(eventGameRender.getPartialTicks());
         ...
         if (this.mc.currentScreen != null) {
            ...
            try {
               if (Reflector.ForgeHooksClient_drawScreen.exists()) {
                  Reflector.callVoid(Reflector.ForgeHooksClient_drawScreen, this.mc.currentScreen, k1, l1, eventGameRender.getPartialTicks());
               } else {
                  this.mc.currentScreen.drawScreen(k1, l1, eventGameRender.getPartialTicks());
               }
            } catch (Throwable var17) {
               CrashReport crashreport = CrashReport.makeCrashReport(var17, "Rendering screen");
               ...
               crashreportcategory.addCrashSectionCallable(
                  "Mouse location", () -> String.format("Scaled: (%d, %d). Absolute: (%d, %d)", k1, l1, Mouse.getX(), Mouse.getY())
               );
               crashreportcategory.addCrashSectionCallable(
                  "Screen size",
                  () -> String.format(
   ...
   private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
      ...
      EventEntityRender eventEntityRender = new EventEntityRender(entity, icamera, partialTicks);
      EventBus.processEvent(eventEntityRender);
      renderglobal.renderEntities(eventEntityRender.getRenderedEntity(), eventEntityRender.getICamera(), eventEntityRender.getPartialTicks());
      if (Reflector.ForgeHooksClient_setRenderPass.exists()) {
      ...
      EventBus.processEvent(new Event3DRender(partialTicks));
               ...
               if (biomegenbase.canSpawnLightningBolt() || biomegenbase.getEnableSnow()) {
                  ...
                  if (k2 != l2) {
                     ...
                     if (world.getWorldChunkManager().getTemperatureAtHeight(f1, j2) >= 0.15F) {
                        ...
                        int k3 = j3 >> 16 & 65535;
                        int l3 = j3 & 65535;
                        worldrenderer.func_181662_b((double)l1 - d3 + 0.5, (double)k2, (double)k1 - d4 + 0.5)
                           .func_181673_a(0.0, (double)k2 * 0.25 + d5)
                           .func_181666_a(1.0F, 1.0F, 1.0F, f3)
                           .func_181671_a(k3, l3)
                           .func_181675_d();
                        worldrenderer.func_181662_b((double)l1 + d3 + 0.5, (double)k2, (double)k1 + d4 + 0.5)
                           .func_181673_a(1.0, (double)k2 * 0.25 + d5)
                           .func_181666_a(1.0F, 1.0F, 1.0F, f3)
                           .func_181671_a(k3, l3)
                           .func_181675_d();
                        worldrenderer.func_181662_b((double)l1 + d3 + 0.5, (double)l2, (double)k1 + d4 + 0.5)
                           .func_181673_a(1.0, (double)l2 * 0.25 + d5)
                           .func_181666_a(1.0F, 1.0F, 1.0F, f3)
                           .func_181671_a(k3, l3)
                           .func_181675_d();
                        worldrenderer.func_181662_b((double)l1 - d3 + 0.5, (double)l2, (double)k1 - d4 + 0.5)
                           .func_181673_a(0.0, (double)l2 * 0.25 + d5)
                           .func_181666_a(1.0F, 1.0F, 1.0F, f3)
                           .func_181671_a(k3, l3)
                           .func_181675_d();
                     } else {
                        ...
                        int k4 = i4 & 65535;
                        worldrenderer.func_181662_b((double)l1 - d3 + 0.5, (double)k2, (double)k1 - d4 + 0.5)
                           .func_181673_a(0.0 + d9, (double)k2 * 0.25 + d8 + d10)
                           .func_181666_a(1.0F, 1.0F, 1.0F, f4)
                           .func_181671_a(j4, k4)
                           .func_181675_d();
                        worldrenderer.func_181662_b((double)l1 + d3 + 0.5, (double)k2, (double)k1 + d4 + 0.5)
                           .func_181673_a(1.0 + d9, (double)k2 * 0.25 + d8 + d10)
                           .func_181666_a(1.0F, 1.0F, 1.0F, f4)
                           .func_181671_a(j4, k4)
                           .func_181675_d();
                        worldrenderer.func_181662_b((double)l1 + d3 + 0.5, (double)l2, (double)k1 + d4 + 0.5)
                           .func_181673_a(1.0 + d9, (double)l2 * 0.25 + d8 + d10)
                           .func_181666_a(1.0F, 1.0F, 1.0F, f4)
                           .func_181671_a(j4, k4)
                           .func_181675_d();
                        worldrenderer.func_181662_b((double)l1 - d3 + 0.5, (double)l2, (double)k1 - d4 + 0.5)
                           .func_181673_a(0.0 + d9, (double)l2 * 0.25 + d8 + d10)
                           .func_181666_a(1.0F, 1.0F, 1.0F, f4)
                           .func_181671_a(j4, k4)
                           .func_181675_d();
                     }
   ...
   private void updateFogColor(float partialTicks) {
      ...
      if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPotionActive(Potion.blindness) && !this.noEffectRenderMod.isEnabled()) {
   ...
   private void setupFog(int p_78468_1_, float partialTicks) {
      ...
      } else if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPotionActive(Potion.blindness) && !this.noEffectRenderMod.isEnabled()) {
         float f4 = 5.0F;
         int i = ((EntityLivingBase)entity).getActivePotionEffect(Potion.blindness).getDuration();
         if (i < 20) {
   ...
   public float getConstantUpdatePTicks() {
      return this.constantUpdatePTicks;
   }
}
