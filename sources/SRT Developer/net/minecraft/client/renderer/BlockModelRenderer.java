...
public class BlockModelRenderer {
   ...
   public boolean renderModel(
      ...
      try {
         ...
         modelIn = BlockModelCustomizer.getRenderModel(modelIn, renderenv);
         boolean flag1 = flag
                  ...
                  for(int j = 0; j < listquadsoverlay.size(); ++j) {
                     ...
                     if (p_renderOverlayModels_10_) {
                        ...
                        this.renderQuadsFlat(
                           p_renderOverlayModels_1_, iblockstate, p_renderOverlayModels_4_, k, false, worldrenderer, list, p_renderOverlayModels_9_
                        );
                     }
                  }
               }
