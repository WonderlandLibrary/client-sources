...
public class ItemCameraTransforms {
   ...
   public ItemCameraTransforms(
      ItemTransformVec3f p_i46444_1_,
   ...
   public void func_181689_a(ItemCameraTransforms.TransformType p_181689_1_) {
      ...
      if (itemtransformvec3f != ItemTransformVec3f.DEFAULT) {
         GlStateManager.translate(itemtransformvec3f.translation.x + 0.0F, itemtransformvec3f.translation.y + 0.0F, itemtransformvec3f.translation.z + 0.0F);
         GlStateManager.rotate(itemtransformvec3f.rotation.y + 0.0F, 0.0F, 1.0F, 0.0F);
         GlStateManager.rotate(itemtransformvec3f.rotation.x + 0.0F, 1.0F, 0.0F, 0.0F);
         GlStateManager.rotate(itemtransformvec3f.rotation.z + 0.0F, 0.0F, 0.0F, 1.0F);
         GlStateManager.scale(itemtransformvec3f.scale.x + 0.0F, itemtransformvec3f.scale.y + 0.0F, itemtransformvec3f.scale.z + 0.0F);
      }
   }
   ...
   static class Deserializer implements JsonDeserializer<ItemCameraTransforms> {
      public ItemCameraTransforms deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
         ...
         return new ItemCameraTransforms(
            itemtransformvec3f, itemtransformvec3f1, itemtransformvec3f2, itemtransformvec3f3, itemtransformvec3f4, itemtransformvec3f5
         );
      }
      ...
      private ItemTransformVec3f func_181683_a(JsonDeserializationContext p_181683_1_, JsonObject p_181683_2_, String p_181683_3_) {
         return p_181683_2_.has(p_181683_3_)
            ? (ItemTransformVec3f)p_181683_1_.deserialize(p_181683_2_.get(p_181683_3_), ItemTransformVec3f.class)
            : ItemTransformVec3f.DEFAULT;
      }
   }
