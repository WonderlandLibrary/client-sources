...
public class RenderChunk {
   ...
   private final EnumMap<EnumFacing, BlockPos> field_181702_p = null;
      ...
      if (!this.isChunkRegionEmpty(blockpos)) {
         ...
         for(Object e : BlockPosM.getAllInBoxMutable(blockpos, blockpos1)) {
            ...
            for(EnumWorldBlockLayer enumWorldBlockLayer : aenumworldblocklayer) {
               ...
               EnumWorldBlockLayer enumworldblocklayer = this.fixBlockLayer(iblockstate, enumWorldBlockLayer);
   ...
   public ChunkCompileTaskGenerator makeCompileTaskTransparency() {
      ...
      return (ChunkCompileTaskGenerator)var2;
   }
   ...
   protected RegionRenderCache createRegionRenderCache(
      World p_createRegionRenderCache_1_, BlockPos p_createRegionRenderCache_2_, BlockPos p_createRegionRenderCache_3_
   ) {
   ...
   private void postRenderOverlay(
      EnumWorldBlockLayer p_postRenderOverlay_1_,
      RegionRenderCacheBuilder p_postRenderOverlay_2_,
      CompiledChunk p_postRenderOverlay_3_,
   ...
   public boolean isBoundingBoxInFrustum(ICamera p_isBoundingBoxInFrustum_1_, int p_isBoundingBoxInFrustum_2_) {
      return this.getBoundingBoxParent().isBoundingBoxInFrustumFully(p_isBoundingBoxInFrustum_1_, p_isBoundingBoxInFrustum_2_)
