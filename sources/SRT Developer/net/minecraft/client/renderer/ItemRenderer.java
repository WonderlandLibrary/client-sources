...
public class ItemRenderer {
   ...
   private void func_178109_a(AbstractClientPlayer clientPlayer) {
      int i = this.mc
         .theWorld
         .getCombinedLight(new BlockPos(clientPlayer.posX, clientPlayer.posY + (double)clientPlayer.getEyeHeight(), clientPlayer.posZ), 0);
   ...
   public void renderItemInFirstPerson(float partialTicks) {
      if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
         ...
         if (this.itemToRender == null) {
            ...
            if (this.itemToRender.getItem() instanceof ItemMap) {
            ...
            } else if (abstractclientplayer.getItemInUseCount() <= 0 && !((Aura)Ries.INSTANCE.getModuleManager().getModuleByName("Aura")).isBlocking()) {
               ...
               switch(enumaction) {
                  ...
                  case DRINK:
                     ...
                     break;
                  case BLOCK:
                     this.doBlockAnimation(partialTicks);
                     break;
                  case BOW:
                     this.transformFirstPersonItem(f, 0.0F);
   ...
   private void func_178096_b(float p_178096_2_) {
      GlStateManager.translate(0.56F, -0.52F, -0.71999997F);
      GlStateManager.translate(0.0F, 0.060000002F, 0.0F);
      GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
   ...
   public void doBlockAnimation(float partialTicks) {
      this.func_178096_b(this.mc.thePlayer.getSwingProgress(partialTicks));
      GL11.glTranslated(0.2, 0.0, 0.0);
      this.func_178103_d();
   }
   ...
   private void func_178108_a(TextureAtlasSprite p_178108_2_) {
      ...
      worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
      worldrenderer.func_181662_b(-1.0, -1.0, -0.5).func_181673_a((double)f7, (double)f9).func_181675_d();
      worldrenderer.func_181662_b(1.0, -1.0, -0.5).func_181673_a((double)f6, (double)f9).func_181675_d();
      worldrenderer.func_181662_b(1.0, 1.0, -0.5).func_181673_a((double)f6, (double)f8).func_181675_d();
      worldrenderer.func_181662_b(-1.0, 1.0, -0.5).func_181673_a((double)f7, (double)f8).func_181675_d();
      tessellator.draw();
      GlStateManager.popMatrix();
   ...
   private void renderWaterOverlayTexture(float p_78448_1_) {
      if (!Config.isShaders() || Shaders.isUnderwaterOverlay()) {
         ...
         worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
         worldrenderer.func_181662_b(-1.0, -1.0, -0.5).func_181673_a((double)(4.0F + f7), (double)(4.0F + f8)).func_181675_d();
         worldrenderer.func_181662_b(1.0, -1.0, -0.5).func_181673_a((double)(0.0F + f7), (double)(4.0F + f8)).func_181675_d();
         worldrenderer.func_181662_b(1.0, 1.0, -0.5).func_181673_a((double)(0.0F + f7), (double)(0.0F + f8)).func_181675_d();
         worldrenderer.func_181662_b(-1.0, 1.0, -0.5).func_181673_a((double)(4.0F + f7), (double)(0.0F + f8)).func_181675_d();
         tessellator.draw();
         GlStateManager.popMatrix();
         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
   ...
   private void renderFireInFirstPerson() {
      Tessellator tessellator = Tessellator.getInstance();
      WorldRenderer worldrenderer = tessellator.getWorldRenderer();
      if (Ries.INSTANCE.getModuleManager().getModuleByName("LowFire").isEnabled()) {
