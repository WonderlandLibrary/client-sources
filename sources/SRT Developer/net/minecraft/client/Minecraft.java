...
public class Minecraft implements IThreadListener, IPlayerUsage {
   ...
   private final ResourceLocation srt_icon = new ResourceLocation("srt/hellcatgradient16x16.png");
   private final ResourceLocation srt_icon2 = new ResourceLocation("srt/hellcatgradient32x32.png");
   ...
   public Minecraft(GameConfiguration gameConfig) {
      ...
      logger.info("Default user: " + this.session.getUsername());
   ...
   public void run() {
      ...
      try {
         while(this.running) {
            EventBus.processEvent(new EventMinecraftLoop());
   ...
   private void startGame() throws LWJGLException {
      ...
      Ries.INSTANCE.initialize();
      Ries.intentInitialization();
   ...
   private void createDisplay() throws LWJGLException {
      ...
      Display.setTitle(Ries.INSTANCE.getName() + " " + Ries.INSTANCE.getBuild());
   ...
   private void setWindowIcon() {
      if (Util.getOSType() != Util.EnumOS.OSX) {
         ...
         try {
            inputStream = this.mcDefaultResourcePack.getResourceStream(this.srt_icon);
            InputStream inputStream2 = this.mcDefaultResourcePack.getResourceStream(this.srt_icon2);
            if (inputStream != null && inputStream2 != null) {
               Display.setIcon(new ByteBuffer[]{this.readImageToBuffer(inputStream), this.readImageToBuffer(inputStream2)});
            }
         } catch (IOException var7) {
            logger.error("Couldn't set icon", var7);
         } finally {
   ...
   private void drawSplashScreen(TextureManager textureManagerInstance) {
      ...
      worldrenderer.func_181662_b(0.0, (double)this.displayHeight, 0.0).func_181673_a(0.0, 0.0).func_181669_b(255, 255, 255, 255).func_181675_d();
      worldrenderer.func_181662_b((double)this.displayWidth, (double)this.displayHeight, 0.0)
         .func_181673_a(0.0, 0.0)
         .func_181669_b(255, 255, 255, 255)
         .func_181675_d();
      worldrenderer.func_181662_b((double)this.displayWidth, 0.0, 0.0).func_181673_a(0.0, 0.0).func_181669_b(255, 255, 255, 255).func_181675_d();
   ...
   public void func_181536_a(
      ...
      worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
      worldrenderer.func_181662_b((double)p_181536_1_, (double)(p_181536_2_ + p_181536_6_), 0.0)
         .func_181673_a((double)((float)p_181536_3_ * f), (double)((float)(p_181536_4_ + p_181536_6_) * f1))
         .func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_)
         .func_181675_d();
      worldrenderer.func_181662_b((double)(p_181536_1_ + p_181536_5_), (double)(p_181536_2_ + p_181536_6_), 0.0)
         .func_181673_a((double)((float)(p_181536_3_ + p_181536_5_) * f), (double)((float)(p_181536_4_ + p_181536_6_) * f1))
         .func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_)
         .func_181675_d();
      worldrenderer.func_181662_b((double)(p_181536_1_ + p_181536_5_), (double)p_181536_2_, 0.0)
         .func_181673_a((double)((float)(p_181536_3_ + p_181536_5_) * f), (double)((float)p_181536_4_ * f1))
         .func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_)
         .func_181675_d();
      worldrenderer.func_181662_b((double)p_181536_1_, (double)p_181536_2_, 0.0)
         .func_181673_a((double)((float)p_181536_3_ * f), (double)((float)p_181536_4_ * f1))
         .func_181669_b(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_)
         .func_181675_d();
   ...
   public void shutdownMinecraftApplet() {
      ConfigUtils.saveConfiguration("Last Session Save");
   ...
   private void displayDebugInfo(long elapsedTicksTime) {
      if (this.mcProfiler.profilingEnabled) {
         ...
         worldrenderer.func_181662_b((double)((float)j - (float)i * 1.1F), (double)((float)k - (float)i * 0.6F - 16.0F), 0.0)
            .func_181669_b(200, 0, 0, 0)
            .func_181675_d();
         worldrenderer.func_181662_b((double)((float)j - (float)i * 1.1F), (double)(k + i * 2), 0.0).func_181669_b(200, 0, 0, 0).func_181675_d();
         worldrenderer.func_181662_b((double)((float)j + (float)i * 1.1F), (double)(k + i * 2), 0.0).func_181669_b(200, 0, 0, 0).func_181675_d();
         worldrenderer.func_181662_b((double)((float)j + (float)i * 1.1F), (double)((float)k - (float)i * 0.6F - 16.0F), 0.0)
            .func_181669_b(200, 0, 0, 0)
            .func_181675_d();
         ...
         for(Profiler.Result profiler$result1 : list) {
            ...
            int l1 = j1 >> 8 & 0xFF;
            int i2 = j1 & 0xFF;
            worldrenderer.func_181662_b((double)j, (double)k, 0.0).func_181669_b(k1, l1, i2, 255).func_181675_d();
            ...
            for(int j2 = i1; j2 >= 0; --j2) {
               ...
               worldrenderer.func_181662_b((double)((float)j + f1), (double)((float)k - f2), 0.0).func_181669_b(k1, l1, i2, 255).func_181675_d();
            }
            ...
            for(int i3 = i1; i3 >= 0; --i3) {
               ...
               worldrenderer.func_181662_b((double)((float)j + f4), (double)((float)k - f5), 0.0)
                  .func_181669_b(k1 >> 1, l1 >> 1, i2 >> 1, 255)
                  .func_181675_d();
               worldrenderer.func_181662_b((double)((float)j + f4), (double)((float)k - f5 + 10.0F), 0.0)
                  .func_181669_b(k1 >> 1, l1 >> 1, i2 >> 1, 255)
                  .func_181675_d();
            }
         ...
         while(Keyboard.next()) {
            ...
            if (Keyboard.getEventKeyState()) {
               ...
               if (this.currentScreen != null) {
                  ...
                  EventBus.processEvent(new EventKeyPress(k));
                  if (k == 1) {
   ...
   public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash) {
      ...
      theCrash.getCategory()
         .addCrashSectionCallable("OpenGL", () -> GL11.glGetString(7937) + " GL version " + GL11.glGetString(7938) + ", " + GL11.glGetString(7936));
      ...
      theCrash.getCategory()
         .addCrashSectionCallable("Profiler Position", () -> this.mcProfiler.profilingEnabled ? this.mcProfiler.getNameOfLastSection() : "N/A (disabled)");
