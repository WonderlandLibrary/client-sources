...
public class ItemMonsterPlacer extends Item {
   ...
   public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
      if (worldIn.isRemote) {
         ...
         Entity entity = spawnCreature(worldIn, stack.getMetadata(), (double)pos.getX() + 0.5, (double)pos.getY() + d0, (double)pos.getZ() + 0.5);
         if (entity != null) {
         ...
         if (movingobjectposition != null && movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (worldIn.getBlockState(blockpos).getBlock() instanceof BlockLiquid) {
               Entity entity = spawnCreature(
                  worldIn, itemStackIn.getMetadata(), (double)blockpos.getX() + 0.5, (double)blockpos.getY() + 0.5, (double)blockpos.getZ() + 0.5
               );
               if (entity != null) {
