...
public class ItemBoat extends Item {
   ...
   public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn) {
      ...
      if (movingobjectposition != null) {
         ...
         if (!flag && movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            EntityBoat entityboat = new EntityBoat(
               worldIn, (double)((float)blockpos.getX() + 0.5F), (double)((float)blockpos.getY() + 1.0F), (double)((float)blockpos.getZ() + 0.5F)
            );
            entityboat.rotationYaw = (float)(((MathHelper.floor_double((double)(playerIn.rotationYaw * 4.0F / 360.0F) + 0.5) & 3) - 1) * 90);
