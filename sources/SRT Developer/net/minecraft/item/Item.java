...
public class Item {
   ...
   public static void registerItems() {
      registerItemBlock(
         Blocks.stone,
         new ItemMultiTexture(Blocks.stone, Blocks.stone, p_apply_1_ -> BlockStone.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())
            .setUnlocalizedName("stone")
      );
      registerItemBlock(Blocks.grass, new ItemColored(Blocks.grass, false));
      registerItemBlock(
         Blocks.dirt,
         new ItemMultiTexture(Blocks.dirt, Blocks.dirt, p_apply_1_ -> BlockDirt.DirtType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())
            .setUnlocalizedName("dirt")
      );
      registerItemBlock(Blocks.cobblestone);
      registerItemBlock(
         Blocks.planks,
         new ItemMultiTexture(Blocks.planks, Blocks.planks, p_apply_1_ -> BlockPlanks.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())
            .setUnlocalizedName("wood")
      );
      registerItemBlock(
         Blocks.sapling,
         new ItemMultiTexture(Blocks.sapling, Blocks.sapling, p_apply_1_ -> BlockPlanks.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())
            .setUnlocalizedName("sapling")
      );
      registerItemBlock(Blocks.bedrock);
      registerItemBlock(
         Blocks.sand,
         new ItemMultiTexture(Blocks.sand, Blocks.sand, p_apply_1_ -> BlockSand.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())
      ...
      registerItemBlock(
         Blocks.log,
         new ItemMultiTexture(Blocks.log, Blocks.log, p_apply_1_ -> BlockPlanks.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())
            .setUnlocalizedName("log")
      );
      registerItemBlock(
         Blocks.log2,
         new ItemMultiTexture(Blocks.log2, Blocks.log2, p_apply_1_ -> BlockPlanks.EnumType.byMetadata(p_apply_1_.getMetadata() + 4).getUnlocalizedName())
            .setUnlocalizedName("log")
      );
      ...
      registerItemBlock(
         Blocks.sponge,
         new ItemMultiTexture(Blocks.sponge, Blocks.sponge, p_apply_1_ -> (p_apply_1_.getMetadata() & 1) == 1 ? "wet" : "dry").setUnlocalizedName("sponge")
      );
      ...
      registerItemBlock(
         ...
         new ItemMultiTexture(
               Blocks.sandstone, Blocks.sandstone, p_apply_1_ -> BlockSandStone.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName()
            )
      ...
      registerItemBlock(
         ...
         new ItemMultiTexture(
               Blocks.yellow_flower,
               Blocks.yellow_flower,
               p_apply_1_ -> BlockFlower.EnumFlowerType.getType(BlockFlower.EnumFlowerColor.YELLOW, p_apply_1_.getMetadata()).getUnlocalizedName()
            )
      ...
      registerItemBlock(
         ...
         new ItemMultiTexture(
               Blocks.red_flower,
               Blocks.red_flower,
               p_apply_1_ -> BlockFlower.EnumFlowerType.getType(BlockFlower.EnumFlowerColor.RED, p_apply_1_.getMetadata()).getUnlocalizedName()
            )
      ...
      registerItemBlock(
         Blocks.monster_egg,
         new ItemMultiTexture(
               Blocks.monster_egg, Blocks.monster_egg, p_apply_1_ -> BlockSilverfish.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName()
            )
      ...
      registerItemBlock(
         Blocks.stonebrick,
         new ItemMultiTexture(
               Blocks.stonebrick, Blocks.stonebrick, p_apply_1_ -> BlockStoneBrick.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName()
            )
      ...
      registerItemBlock(
         ...
         new ItemMultiTexture(
               Blocks.cobblestone_wall, Blocks.cobblestone_wall, p_apply_1_ -> BlockWall.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName()
            )
      ...
      registerItemBlock(
         ...
         new ItemDoublePlant(
               Blocks.double_plant,
               Blocks.double_plant,
               p_apply_1_ -> BlockDoublePlant.EnumPlantType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName()
            )
      ...
      registerItemBlock(
         Blocks.prismarine,
         new ItemMultiTexture(
               Blocks.prismarine, Blocks.prismarine, p_apply_1_ -> BlockPrismarine.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName()
            )
      ...
      registerItemBlock(
         ...
         new ItemMultiTexture(
               Blocks.red_sandstone, Blocks.red_sandstone, p_apply_1_ -> BlockRedSandstone.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName()
            )
      ...
      registerItem(
         377, "blaze_powder", new Item().setUnlocalizedName("blazePowder").setPotionEffect("+0-1-2+3&4-4+13").setCreativeTab(CreativeTabs.tabBrewing)
      );
      ...
      registerItem(
         ...
         new ItemMinecart(EntityMinecart.EnumMinecartType.COMMAND_BLOCK).setUnlocalizedName("minecartCommandBlock").setCreativeTab(null)
      );
