...
public class ContainerRepair extends Container {
   ...
   public void updateRepairOutput() {
      ...
      if (itemstack == null) {
         ...
         this.materialCost = 0;
         if (itemstack2 != null) {
            boolean flag = itemstack2.getItem() == Items.enchanted_book && Items.enchanted_book.getEnchantments(itemstack2).tagCount() > 0;
   ...
   public boolean canInteractWith(EntityPlayer playerIn) {
      return this.theWorld.getBlockState(this.selfPosition).getBlock() != Blocks.anvil
         || !(
            playerIn.getDistanceSq((double)this.selfPosition.getX() + 0.5, (double)this.selfPosition.getY() + 0.5, (double)this.selfPosition.getZ() + 0.5)
               <= 64.0
         );
   }
