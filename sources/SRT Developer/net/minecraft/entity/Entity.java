...
public abstract class Entity implements ICommandSender {
   ...
   private final Module antiInvisMod = Ries.INSTANCE.getModuleManager().getModuleByName("AntiInvisibles");
   ...
   public float[] getAngles(float yaw, float pitch) {
      ...
      this.rotationPitch = (float)((double)this.rotationPitch - (double)pitch * 0.15);
      this.rotationPitch = MathHelper.clamp_float(this.rotationPitch, -90.0F, 90.0F);
      return new float[]{this.prevRotationPitch + this.rotationPitch - f, this.prevRotationYaw + this.rotationYaw - f1};
   }

   public float[] getAngles(float yaw, float pitch, float comparedYaw, float comparedPitch) {
      this.rotationYaw = (float)((double)this.rotationYaw + (double)yaw * 0.15);
      this.rotationPitch = (float)((double)this.rotationPitch - (double)pitch * 0.15);
      this.rotationPitch = MathHelper.clamp_float(this.rotationPitch, -90.0F, 90.0F);
      return new float[]{this.prevRotationPitch + this.rotationPitch - comparedPitch, this.prevRotationYaw + this.rotationYaw - comparedYaw};
   }
   ...
   public boolean isInvisible() {
      return (
            !this.antiInvisMod.isEnabled()
               || !Ries.INSTANCE.getSettingManager().getSetting(this.antiInvisMod, "INTERNAL_INVISIBLES", Setting.Type.CHECKBOX).isTicked()
         )
         && this.getFlag(5);
   }
   ...
   public void addEntityCrashInfo(CrashReportCategory category) {
      ...
      category.addCrashSectionCallable("Entity Name", this::getCommandSenderName);
