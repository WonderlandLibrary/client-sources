...
public abstract class EntityPlayer extends EntityLivingBase {
   ...
   public void onLivingUpdate() {
      ...
      if (this.isSprinting()) {
         this.jumpMovementFactor = (float)((double)this.jumpMovementFactor + 0.02F * 0.3);
      }
      ...
      if (this.getHealth() > 0.0F && !this.isSpectator()) {
         ...
         for(Entity entity : this.worldObj.getEntitiesWithinAABBExcludingEntity(this, axisalignedbb)) {
            if (!entity.isDead) {
   ...
   public EntityPlayer.EnumStatus trySleep(BlockPos bedLocation) {
      ...
      if (this.worldObj.isBlockLoaded(bedLocation)) {
         ...
         this.setPosition(
            (double)((float)bedLocation.getX() + 0.5F), (double)((float)bedLocation.getY() + 0.6875F), (double)((float)bedLocation.getZ() + 0.5F)
         );
      }
   ...
   public void jump() {
      EventJump eventJump;
      EventBus.processEvent(eventJump = new EventJump());
