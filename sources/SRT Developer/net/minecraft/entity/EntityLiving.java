...
public abstract class EntityLiving extends EntityLivingBase {
   ...
   protected void despawnEntity() {
      ...
      if (this.persistenceRequired) {
         ...
         Object object;
         if ((this.entityAge & 31) != 31 || (object = Reflector.call(Reflector.ForgeEventFactory_canEntityDespawn, this)) == object1) {
            Entity entity = this.worldObj.getClosestPlayerToEntity(this, -1.0);
            if (entity != null) {
   ...
   public final boolean interactFirst(EntityPlayer playerIn) {
      if (this.getLeashed() && this.getLeashedToEntity() == playerIn) {
         ...
         return this.interact(playerIn) ? false : super.interactFirst(playerIn);
      }
   }
   ...
   private void recreateLeash() {
      if (this.isLeashed && this.leashNBTTag != null) {
         if (this.leashNBTTag.hasKey("UUIDMost", 4) && this.leashNBTTag.hasKey("UUIDLeast", 4)) {
            ...
            for(EntityLivingBase entitylivingbase : this.worldObj
               .getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().expand(10.0, 10.0, 10.0))) {
