...
public class EntityAINearestAttackableTarget<T extends EntityLivingBase> extends EntityAITarget {
   ...
   public EntityAINearestAttackableTarget(
      EntityCreature creature, Class<T> classTarget, int chance, boolean checkSight, boolean onlyNearby, Predicate<? super T> targetSelector
   ) {
      ...
      this.setMutexBits(1);
      this.targetEntitySelector = p_apply_1_ -> {
         if (targetSelector != null && !targetSelector.apply(p_apply_1_)) {
            ...
            if (p_apply_1_ instanceof EntityPlayer) {
               ...
               if ((double)p_apply_1_.getDistanceToEntity(this.taskOwner) > d0) {
                  return false;
               }
            }

            return this.isSuitableTarget(p_apply_1_);
         }
      };
   }
      ...
      if (this.targetChance > 0 && this.taskOwner.getRNG().nextInt(this.targetChance) != 0) {
         ...
         List<T> list = this.taskOwner
            ...
            .getEntitiesWithinAABB(
               this.targetClass,
               this.taskOwner.getEntityBoundingBox().expand(d0, 4.0, d0),
