   ...
   public EntityAIFindEntityNearestPlayer(EntityLiving p_i45882_1_) {
      ...
      this.field_179435_c = p_apply_1_ -> {
         if (!(p_apply_1_ instanceof EntityPlayer)) {
            ...
            return !((double)p_apply_1_.getDistanceToEntity(this.field_179434_b) > d0)
               && EntityAITarget.isSuitableTarget(this.field_179434_b, (EntityLivingBase)p_apply_1_, false, true);
         }
      };
