   ...
   protected void updateAITasks() {
      ...
      if (this.isElder()) {
         ...
         if ((this.ticksExisted + this.getEntityId()) % 1200 == 0) {
            ...
            for(EntityPlayerMP entityplayermp : this.worldObj
               .getPlayers(
                  EntityPlayerMP.class,
                  p_apply_1_ -> this.getDistanceSqToEntity(p_apply_1_) < 2500.0 && p_apply_1_.theItemInWorldManager.survivalOrAdventure()
               )) {
