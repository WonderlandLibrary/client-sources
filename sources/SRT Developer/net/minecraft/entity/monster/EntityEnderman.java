...
public class EntityEnderman extends EntityMob {
   ...
   private static final AttributeModifier attackingSpeedBoostModifier = new AttributeModifier(
         attackingSpeedBoostModifierUUID, "Attacking speed boost", 0.15F, 0
      )
      .setSaved(false);
   ...
   public void readEntityFromNBT(NBTTagCompound tagCompund) {
      ...
      if (tagCompund.hasKey("carried", 8)) {
         iblockstate = Objects.requireNonNull(Block.getBlockFromName(tagCompund.getString("carried")))
            .getStateFromMeta(tagCompund.getShort("carriedData") & '\uffff');
      } else {
         iblockstate = Block.getBlockById(tagCompund.getShort("carried")).getStateFromMeta(tagCompund.getShort("carriedData") & '\uffff');
      }
   ...
   static class AIFindPlayer extends EntityAINearestAttackableTarget {
      ...
      public boolean shouldExecute() {
         ...
         List<EntityPlayer> list = this.taskOwner
            .worldObj
            .getEntitiesWithinAABB(EntityPlayer.class, this.taskOwner.getEntityBoundingBox().expand(d0, 4.0, d0), this.targetEntitySelector);
   ...
   static class AIPlaceBlock extends EntityAIBase {
      ...
      @Override
      public boolean shouldExecute() {
         return this.enderman.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing")
      ...
      private boolean func_179474_a(World worldIn, BlockPos p_179474_2_, Block p_179474_3_, Block p_179474_4_, Block p_179474_5_) {
         return p_179474_3_.canPlaceBlockAt(worldIn, p_179474_2_)
            && p_179474_4_.getMaterial() == Material.air
            && p_179474_5_.getMaterial() != Material.air
            && p_179474_5_.isFullCube();
      }
   }
