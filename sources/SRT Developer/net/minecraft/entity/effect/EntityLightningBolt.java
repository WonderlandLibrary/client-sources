...
public class EntityLightningBolt extends EntityWeatherEffect {
   ...
   public EntityLightningBolt(World worldIn, double posX, double posY, double posZ) {
      ...
      if (!worldIn.isRemote
         && worldIn.getGameRules().getGameRuleBooleanValue("doFireTick")
         ...
         if (this.worldObj.isRemote) {
            ...
            for(Entity entity : this.worldObj
               .getEntitiesWithinAABBExcludingEntity(
                  this, new AxisAlignedBB(this.posX - d0, this.posY - d0, this.posZ - d0, this.posX + d0, this.posY + 6.0 + d0, this.posZ + d0)
               )) {
