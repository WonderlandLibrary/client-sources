...
public class DataWatcher {
   ...
   public byte getWatchableObjectByte(int id) {
      return this.getWatchedObject(id).getObject();
   }
   ...
   private static void writeWatchableObjectToPacketBuffer(PacketBuffer buffer, DataWatcher.WatchableObject object) {
      int i = (object.getObjectType() << 5 | object.getDataValueId() & 31) & 0xFF;
      buffer.writeByte(i);
      switch(object.getObjectType()) {
         case 0:
            buffer.writeByte(object.getObject());
            break;
         case 1:
            buffer.writeShort(object.getObject());
            break;
         case 2:
            buffer.writeInt(object.getObject());
            break;
         case 3:
            buffer.writeFloat(object.getObject());
            break;
         case 4:
