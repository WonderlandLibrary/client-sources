      ...
      if (this.getHealth() <= 0.0F) {
         ...
         if (this.isAIDisabled()) {
            ...
            if (this.worldObj.isRemote) {
               ...
               double d9 = Math.sqrt(this.motionX * this.motionX + this.motionZ * this.motionZ) + 1.0;
               if (d9 > 40.0) {
                  d9 = 40.0;
               }
            ...
            this.dragonPartHead
               .setLocationAndAngles(
                  ...
                  this.posY + (adouble[1] - adouble1[1]) + (double)(f15 * 5.5F),
            ...
            for(int j = 0; j < 3; ++j) {
               ...
               entitydragonpart.setLocationAndAngles(
                  ...
                  this.posY + (adouble2[1] - adouble1[1]) - (double)((f24 + f23) * f15) + 1.5,
