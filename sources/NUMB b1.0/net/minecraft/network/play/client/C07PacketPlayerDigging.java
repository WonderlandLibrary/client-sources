...
public class C07PacketPlayerDigging implements Packet {
	...
	public C07PacketPlayerDigging(C07PacketPlayerDigging.Action p_i45940_1_, BlockPos p_i45940_2_,
			EnumFacing p_i45940_3_) {
	...
	public static enum Action {
		...
		private static final C07PacketPlayerDigging.Action[] $VALUES = new C07PacketPlayerDigging.Action[] {
				START_DESTROY_BLOCK, ABORT_DESTROY_BLOCK, STOP_DESTROY_BLOCK, DROP_ALL_ITEMS, DROP_ITEM,
				RELEASE_USE_ITEM };
