...
public class S22PacketMultiBlockChange implements Packet {
	...
	public void readPacketData(PacketBuffer data) throws IOException {
		...
		for (int var2 = 0; var2 < this.field_179845_b.length; ++var2) {
			this.field_179845_b[var2] = new S22PacketMultiBlockChange.BlockUpdateData(data.readShort(),
	...
	public class BlockUpdateData {
		...
		public BlockPos func_180090_a() {
			return new BlockPos(S22PacketMultiBlockChange.this.field_148925_b.getBlock(this.field_180091_b >> 12 & 15,
					this.field_180091_b & 255, this.field_180091_b >> 8 & 15));
		}
