...
public class ServerStatusResponse {
	...
	public static class MinecraftProtocolVersionIdentifier {
		...
		public static class Serializer implements JsonDeserializer, JsonSerializer {
			...
			public ServerStatusResponse.MinecraftProtocolVersionIdentifier deserialize1(JsonElement p_deserialize_1_,
	...
	public static class PlayerCountData {
		...
		public static class Serializer implements JsonDeserializer, JsonSerializer {
			...
			public ServerStatusResponse.PlayerCountData deserialize1(JsonElement p_deserialize_1_,
					Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) {
	...
	public static class Serializer implements JsonDeserializer, JsonSerializer {
		...
		public ServerStatusResponse deserialize1(JsonElement p_deserialize_1_, Type p_deserialize_2_,
				JsonDeserializationContext p_deserialize_3_) {
