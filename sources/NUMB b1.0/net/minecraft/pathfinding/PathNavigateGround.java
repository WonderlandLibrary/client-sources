...
public class PathNavigateGround extends PathNavigate {
	...
	private int func_179687_p() {
		if (this.theEntity.isInWater() && this.func_179684_h()) {
			...
			Block var2 = this.worldObj.getBlockState(new BlockPos(MathHelper.floor_double(this.theEntity.posX), var1,
			...
			do {
				...
				++var1;
				var2 = this.worldObj.getBlockState(new BlockPos(MathHelper.floor_double(this.theEntity.posX), var1,
						MathHelper.floor_double(this.theEntity.posZ))).getBlock();
				++var3;
			} while (var3 <= 16);
	...
	protected void removeSunnyPath() {
		...
		if (this.field_179694_f) {
			if (this.worldObj.isAgainstSky(new BlockPos(MathHelper.floor_double(this.theEntity.posX),
	 ...
	 * entityZSize
	 */
	protected boolean isDirectPathBetweenPoints(Vec3 p_75493_1_, Vec3 p_75493_2_, int p_75493_3_, int p_75493_4_,
			int p_75493_5_) {
		...
		if (var12 < 1.0E-8D) {
			...
			if (!this.func_179683_a(var6, (int) p_75493_1_.yCoord, var7, p_75493_3_, p_75493_4_, p_75493_5_, p_75493_1_,
					var8, var10)) {
				return false;
			} else {
				p_75493_3_ -= 2;
				...
				} while (this.func_179683_a(var6, (int) p_75493_1_.yCoord, var7, p_75493_3_, p_75493_4_, p_75493_5_,
	...
	private boolean func_179683_a(int p_179683_1_, int p_179683_2_, int p_179683_3_, int p_179683_4_, int p_179683_5_,
			int p_179683_6_, Vec3 p_179683_7_, double p_179683_8_, double p_179683_10_) {
		int var12 = p_179683_1_ - p_179683_4_ / 2;
		int var13 = p_179683_3_ - p_179683_6_ / 2;

		if (!this.func_179692_b(var12, p_179683_2_, var13, p_179683_4_, p_179683_5_, p_179683_6_, p_179683_7_,
				p_179683_8_, p_179683_10_)) {
			return false;
		} else {
			for (int var14 = var12; var14 < var12 + p_179683_4_; ++var14) {
				for (int var15 = var13; var15 < var13 + p_179683_6_; ++var15) {
					...
					if (var16 * p_179683_8_ + var18 * p_179683_10_ >= 0.0D) {
						Block var20 = this.worldObj.getBlockState(new BlockPos(var14, p_179683_2_ - 1, var15))
								.getBlock();
	...
	private boolean func_179692_b(int p_179692_1_, int p_179692_2_, int p_179692_3_, int p_179692_4_, int p_179692_5_,
			int p_179692_6_, Vec3 p_179692_7_, double p_179692_8_, double p_179692_10_) {
		Iterator var12 = BlockPos
