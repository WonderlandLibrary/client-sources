...
public class ChunkProviderGenerate implements IChunkProvider {
	...
	public void func_180517_a(int p_180517_1_, int p_180517_2_, ChunkPrimer p_180517_3_, BiomeGenBase[] p_180517_4_) {
		...
		this.stoneNoise = this.field_147430_m.func_151599_a(this.stoneNoise, (double) (p_180517_1_ * 16),
				(double) (p_180517_2_ * 16), 16, 16, var5 * 2.0D, var5 * 2.0D, 1.0D);

		for (int var7 = 0; var7 < 16; ++var7) {
			for (int var8 = 0; var8 < 16; ++var8) {
				BiomeGenBase var9 = p_180517_4_[var8 + var7 * 16];
				var9.genTerrainBlocks(this.worldObj, this.rand, p_180517_3_, p_180517_1_ * 16 + var7,
						p_180517_2_ * 16 + var8, this.stoneNoise[var8 + var7 * 16]);
			}
		}
	}
	...
	private void func_147423_a(int p_147423_1_, int p_147423_2_, int p_147423_3_) {
		this.field_147426_g = this.noiseGen6.generateNoiseOctaves(this.field_147426_g, p_147423_1_, p_147423_3_, 5, 5,
				(double) this.field_177477_r.field_177808_e, (double) this.field_177477_r.field_177803_f,
				(double) this.field_177477_r.field_177804_g);
		...
		this.field_147427_d = this.field_147429_l.generateNoiseOctaves(this.field_147427_d, p_147423_1_, p_147423_2_,
				p_147423_3_, 5, 33, 5, (double) (var4 / this.field_177477_r.field_177825_h),
				(double) (var5 / this.field_177477_r.field_177827_i),
				(double) (var4 / this.field_177477_r.field_177821_j));
		this.field_147428_e = this.field_147431_j.generateNoiseOctaves(this.field_147428_e, p_147423_1_, p_147423_2_,
				p_147423_3_, 5, 33, 5, (double) var4, (double) var5, (double) var4);
			...
			for (int var9 = 0; var9 < 5; ++var9) {
				...
				for (int var15 = -var13; var15 <= var13; ++var15) {
					for (int var16 = -var13; var16 <= var13; ++var16) {
						...
						float var18 = this.field_177477_r.field_177813_n
								+ var17.minHeight * this.field_177477_r.field_177819_m;
						float var19 = this.field_177477_r.field_177843_p
								+ var17.maxHeight * this.field_177477_r.field_177815_o;
				...
				for (int var23 = 0; var23 < 33; ++var23) {
					double var24 = ((double) var23 - var21) * (double) this.field_177477_r.field_177817_l * 128.0D
							/ 256.0D / var40;
	...
	public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_) {
		...
		if (var7 != BiomeGenBase.desert && var7 != BiomeGenBase.desertHills && this.field_177477_r.field_177781_A
				&& !var12 && this.rand.nextInt(this.field_177477_r.field_177782_B) == 0) {
		...
		if (!var12 && this.rand.nextInt(this.field_177477_r.field_177777_D / 10) == 0
				&& this.field_177477_r.field_177783_C) {
			var14 = this.rand.nextInt(16) + 8;
	...
	public boolean func_177460_a(IChunkProvider p_177460_1_, Chunk p_177460_2_, int p_177460_3_, int p_177460_4_) {
		...
		if (this.field_177477_r.field_177852_y && this.mapFeaturesEnabled && p_177460_2_.getInhabitedTime() < 3600L) {
			var5 |= this.field_177474_A.func_175794_a(this.worldObj, this.rand,
	...
	public List func_177458_a(EnumCreatureType p_177458_1_, BlockPos p_177458_2_) {
		...
		if (this.mapFeaturesEnabled) {
			...
			if (p_177458_1_ == EnumCreatureType.MONSTER && this.field_177477_r.field_177852_y
					&& this.field_177474_A.func_175796_a(this.worldObj, p_177458_2_)) {
	...
	public BlockPos func_180513_a(World worldIn, String p_180513_2_, BlockPos p_180513_3_) {
		return "Stronghold".equals(p_180513_2_) && this.strongholdGenerator != null
				? this.strongholdGenerator.func_180706_b(worldIn, p_180513_3_)
				: null;
	}
	...
	public void func_180514_a(Chunk p_180514_1_, int p_180514_2_, int p_180514_3_) {
		...
		if (this.field_177477_r.field_177854_x && this.mapFeaturesEnabled) {
			this.scatteredFeatureGenerator.func_175792_a(this, this.worldObj, p_180514_2_, p_180514_3_,
					(ChunkPrimer) null);
		}
