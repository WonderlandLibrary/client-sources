							...
							for (int var59 = var56; var59 < var39; ++var59) {
								...
								if (var58 * var58 + var45 * var45 < 1.0D) {
									for (int var48 = var37; var48 > var55; --var48) {
										...
										if ((var58 * var58 + var45 * var45) * (double) this.field_75046_d[var48 - 1]
											...
											if (var51.getBlock() == Blocks.stone || var51.getBlock() == Blocks.dirt
												...
												if (var48 - 1 < 10) {
													...
													if (var47 && p_180707_5_.getBlockState(var41, var48 - 1, var59)
														...
														p_180707_5_
																.setBlockState(var41, var48 - 1, var59,
																		this.worldObj.getBiomeGenForCoords(new BlockPos(
																				var41 + p_180707_3_ * 16, 0,
	...
	protected void func_180701_a(World worldIn, int p_180701_2_, int p_180701_3_, int p_180701_4_, int p_180701_5_,
		...
		if (this.rand.nextInt(50) == 0) {
			...
			for (int var14 = 0; var14 < var13; ++var14) {
				...
				this.func_180707_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, p_180701_6_, var7, var9, var11,
