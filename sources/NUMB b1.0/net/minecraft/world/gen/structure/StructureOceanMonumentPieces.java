...
public class StructureOceanMonumentPieces {
	...
	public static class DoubleXRoom extends StructureOceanMonumentPieces.Piece {
		...
		public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
			StructureOceanMonumentPieces.RoomDefinition var4 = this.field_175830_k.field_175965_b[EnumFacing.EAST
					.getIndex()];
	...
	public static class DoubleYRoom extends StructureOceanMonumentPieces.Piece {
		...
		public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
			if (this.field_175830_k.field_175967_a / 25 > 0) {
				this.func_175821_a(worldIn, p_74875_3_, 0, 0,
						this.field_175830_k.field_175966_c[EnumFacing.DOWN.getIndex()]);
			}

			StructureOceanMonumentPieces.RoomDefinition var4 = this.field_175830_k.field_175965_b[EnumFacing.UP
					.getIndex()];
			...
			for (int var6 = 1; var6 <= 5; var6 += 4) {
				...
				if (var5.field_175966_c[EnumFacing.SOUTH.getIndex()]) {
					this.func_175804_a(worldIn, p_74875_3_, 2, var6, var7, 2, var6 + 2, var7, field_175826_b,
							field_175826_b, false);
					this.func_175804_a(worldIn, p_74875_3_, 5, var6, var7, 5, var6 + 2, var7, field_175826_b,
							field_175826_b, false);
					this.func_175804_a(worldIn, p_74875_3_, 3, var6 + 2, var7, 4, var6 + 2, var7, field_175826_b,
							field_175826_b, false);
				} else {
					this.func_175804_a(worldIn, p_74875_3_, 0, var6, var7, 7, var6 + 2, var7, field_175826_b,
							field_175826_b, false);
					this.func_175804_a(worldIn, p_74875_3_, 0, var6 + 1, var7, 7, var6 + 1, var7, field_175828_a,
				...
				if (var5.field_175966_c[EnumFacing.WEST.getIndex()]) {
					this.func_175804_a(worldIn, p_74875_3_, var8, var6, 2, var8, var6 + 2, 2, field_175826_b,
							field_175826_b, false);
					this.func_175804_a(worldIn, p_74875_3_, var8, var6, 5, var8, var6 + 2, 5, field_175826_b,
							field_175826_b, false);
					this.func_175804_a(worldIn, p_74875_3_, var8, var6 + 2, 3, var8, var6 + 2, 4, field_175826_b,
							field_175826_b, false);
				} else {
					this.func_175804_a(worldIn, p_74875_3_, var8, var6, 0, var8, var6 + 2, 7, field_175826_b,
							field_175826_b, false);
					this.func_175804_a(worldIn, p_74875_3_, var8, var6 + 1, 0, var8, var6 + 1, 7, field_175828_a,
							field_175828_a, false);
				}
	...
	public static class DoubleYZRoom extends StructureOceanMonumentPieces.Piece {
		...
		public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
			StructureOceanMonumentPieces.RoomDefinition var4 = this.field_175830_k.field_175965_b[EnumFacing.NORTH
					.getIndex()];
			StructureOceanMonumentPieces.RoomDefinition var5 = this.field_175830_k;
	...
	public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece {
		...
		public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
			...
			while (var7.hasNext()) {
				StructureOceanMonumentPieces.RoomDefinition var8 = (StructureOceanMonumentPieces.RoomDefinition) var7
						.next();
				...
				if (!var8.field_175963_d && !var8.func_175961_b()) {
					...
					while (var9.hasNext()) {
						StructureOceanMonumentPieces.MonumentRoomFitHelper var10 = (StructureOceanMonumentPieces.MonumentRoomFitHelper) var9
								.next();
			...
			StructureBoundingBox var18 = StructureBoundingBox.func_175899_a(this.getXWithOffset(1, 1),
					this.getYWithOffset(1), this.getZWithOffset(1, 1), this.getXWithOffset(23, 21),
					this.getYWithOffset(8), this.getZWithOffset(23, 21));
			StructureBoundingBox var19 = StructureBoundingBox.func_175899_a(this.getXWithOffset(34, 1),
					this.getYWithOffset(1), this.getZWithOffset(34, 1), this.getXWithOffset(56, 21),
					this.getYWithOffset(8), this.getZWithOffset(56, 21));
			StructureBoundingBox var12 = StructureBoundingBox.func_175899_a(this.getXWithOffset(22, 22),
		...
		private List func_175836_a(Random p_175836_1_) {
			...
			while (var22.hasNext()) {
				StructureOceanMonumentPieces.RoomDefinition var23 = (StructureOceanMonumentPieces.RoomDefinition) var22
						.next();
				int var25 = 0;
				var11 = 0;
		...
		public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
			...
			for (var4 = 0; var4 < 5; ++var4) {
				this.func_175804_a(worldIn, p_74875_3_, -1 - var4, 0 + var4 * 2, -1 - var4, -1 - var4, 23, 58 + var4,
						field_175822_f, field_175822_f, false);
				this.func_175804_a(worldIn, p_74875_3_, 58 + var4, 0 + var4 * 2, -1 - var4, 58 + var4, 23, 58 + var4,
						field_175822_f, field_175822_f, false);
				this.func_175804_a(worldIn, p_74875_3_, 0 - var4, 0 + var4 * 2, -1 - var4, 57 + var4, 23, -1 - var4,
						field_175822_f, field_175822_f, false);
				this.func_175804_a(worldIn, p_74875_3_, 0 - var4, 0 + var4 * 2, 58 + var4, 57 + var4, 23, 58 + var4,
						field_175822_f, field_175822_f, false);
			}
		...
		private void func_175840_a(boolean p_175840_1_, int p_175840_2_, World worldIn, Random p_175840_4_,
			...
			if (this.func_175818_a(p_175840_5_, p_175840_2_, 0, p_175840_2_ + 23, 20)) {
				this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + 0, 0, 0, p_175840_2_ + 24, 0, 20, field_175828_a,
						field_175828_a, false);
				this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + 0, 1, 0, p_175840_2_ + 24, 10, 20,
						field_175822_f, field_175822_f, false);
				int var7;

				for (var7 = 0; var7 < 4; ++var7) {
					this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + var7, var7 + 1, var7, p_175840_2_ + var7,
							var7 + 1, 20, field_175826_b, field_175826_b, false);
					this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + var7 + 7, var7 + 5, var7 + 7,
							p_175840_2_ + var7 + 7, var7 + 5, 20, field_175826_b, field_175826_b, false);
					this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + 17 - var7, var7 + 5, var7 + 7,
							p_175840_2_ + 17 - var7, var7 + 5, 20, field_175826_b, field_175826_b, false);
					this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + 24 - var7, var7 + 1, var7,
							p_175840_2_ + 24 - var7, var7 + 1, 20, field_175826_b, field_175826_b, false);
					this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + var7 + 1, var7 + 1, var7,
							p_175840_2_ + 23 - var7, var7 + 1, var7, field_175826_b, field_175826_b, false);
					this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + var7 + 8, var7 + 5, var7 + 7,
							p_175840_2_ + 16 - var7, var7 + 5, var7 + 7, field_175826_b, field_175826_b, false);
				}

				this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + 4, 4, 4, p_175840_2_ + 6, 4, 20, field_175828_a,
						field_175828_a, false);
				this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + 7, 4, 4, p_175840_2_ + 17, 4, 6, field_175828_a,
						field_175828_a, false);
				this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + 18, 4, 4, p_175840_2_ + 20, 4, 20,
						field_175828_a, field_175828_a, false);
				this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + 11, 8, 11, p_175840_2_ + 13, 8, 20,
						field_175828_a, field_175828_a, false);
				...
				this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + 11, 1, 12, p_175840_2_ + 13, 7, 12,
						field_175828_a, field_175828_a, false);
				this.func_175804_a(worldIn, p_175840_5_, p_175840_2_ + 12, 1, 11, p_175840_2_ + 12, 7, 13,
						field_175828_a, field_175828_a, false);
			}
		}
		...
		private void func_175839_b(World worldIn, Random p_175839_2_, StructureBoundingBox p_175839_3_) {
			if (this.func_175818_a(p_175839_3_, 22, 5, 35, 17)) {
				...
				for (int var4 = 0; var4 < 4; ++var4) {
					this.func_175804_a(worldIn, p_175839_3_, 24, 2, 5 + var4 * 4, 24, 4, 5 + var4 * 4, field_175826_b,
							field_175826_b, false);
					this.func_175804_a(worldIn, p_175839_3_, 22, 4, 5 + var4 * 4, 23, 4, 5 + var4 * 4, field_175826_b,
							field_175826_b, false);
					...
					this.func_175804_a(worldIn, p_175839_3_, 33, 2, 5 + var4 * 4, 33, 4, 5 + var4 * 4, field_175826_b,
							field_175826_b, false);
					this.func_175804_a(worldIn, p_175839_3_, 34, 4, 5 + var4 * 4, 35, 4, 5 + var4 * 4, field_175826_b,
							field_175826_b, false);
					...
					this.func_175804_a(worldIn, p_175839_3_, 27, 6, 5 + var4 * 4, 30, 6, 5 + var4 * 4, field_175828_a,
							field_175828_a, false);
				}
			}
		}
		...
		private void func_175841_d(World worldIn, Random p_175841_2_, StructureBoundingBox p_175841_3_) {
			if (this.func_175818_a(p_175841_3_, 21, 21, 36, 36)) {
				...
				for (int var4 = 0; var4 < 4; ++var4) {
					this.func_175804_a(worldIn, p_175841_3_, 21 + var4, 13 + var4, 21 + var4, 36 - var4, 13 + var4,
							21 + var4, field_175826_b, field_175826_b, false);
					this.func_175804_a(worldIn, p_175841_3_, 21 + var4, 13 + var4, 36 - var4, 36 - var4, 13 + var4,
							36 - var4, field_175826_b, field_175826_b, false);
					this.func_175804_a(worldIn, p_175841_3_, 21 + var4, 13 + var4, 22 + var4, 21 + var4, 13 + var4,
							35 - var4, field_175826_b, field_175826_b, false);
					this.func_175804_a(worldIn, p_175841_3_, 36 - var4, 13 + var4, 22 + var4, 36 - var4, 13 + var4,
							35 - var4, field_175826_b, field_175826_b, false);
				}
		...
		private void func_175835_e(World worldIn, Random p_175835_2_, StructureBoundingBox p_175835_3_) {
			...
			if (this.func_175818_a(p_175835_3_, 0, 21, 6, 58)) {
				...
				for (var4 = 0; var4 < 4; ++var4) {
					this.func_175804_a(worldIn, p_175835_3_, var4, var4 + 1, 21, var4, var4 + 1, 57 - var4,
			...
			if (this.func_175818_a(p_175835_3_, 51, 21, 58, 58)) {
				...
				for (var4 = 0; var4 < 4; ++var4) {
					this.func_175804_a(worldIn, p_175835_3_, 57 - var4, var4 + 1, 21, 57 - var4, var4 + 1, 57 - var4,
							field_175826_b, field_175826_b, false);
				}
			...
			if (this.func_175818_a(p_175835_3_, 0, 51, 57, 57)) {
				...
				for (var4 = 0; var4 < 4; ++var4) {
					this.func_175804_a(worldIn, p_175835_3_, var4 + 1, var4 + 1, 57 - var4, 56 - var4, var4 + 1,
							57 - var4, field_175826_b, field_175826_b, false);
				}
			}
		}
		...
		private void func_175842_f(World worldIn, Random p_175842_2_, StructureBoundingBox p_175842_3_) {
			...
			if (this.func_175818_a(p_175842_3_, 7, 21, 13, 50)) {
				...
				for (var4 = 0; var4 < 4; ++var4) {
					this.func_175804_a(worldIn, p_175842_3_, var4 + 7, var4 + 5, 21, var4 + 7, var4 + 5, 54,
							field_175826_b, field_175826_b, false);
				}
			...
			if (this.func_175818_a(p_175842_3_, 44, 21, 50, 54)) {
				...
				for (var4 = 0; var4 < 4; ++var4) {
					this.func_175804_a(worldIn, p_175842_3_, 50 - var4, var4 + 5, 21, 50 - var4, var4 + 5, 54,
							field_175826_b, field_175826_b, false);
				}
			...
			if (this.func_175818_a(p_175842_3_, 8, 44, 49, 54)) {
				...
				for (var4 = 0; var4 < 3; ++var4) {
					this.func_175804_a(worldIn, p_175842_3_, 8 + var4, 5 + var4, 54, 49 - var4, 5 + var4, 54,
							field_175828_a, field_175828_a, false);
				}
		...
		private void func_175838_g(World worldIn, Random p_175838_2_, StructureBoundingBox p_175838_3_) {
			...
			if (this.func_175818_a(p_175838_3_, 14, 21, 20, 43)) {
				...
				for (var4 = 0; var4 < 4; ++var4) {
					this.func_175804_a(worldIn, p_175838_3_, var4 + 14, var4 + 9, 21, var4 + 14, var4 + 9, 43 - var4,
							field_175826_b, field_175826_b, false);
				}
			...
			if (this.func_175818_a(p_175838_3_, 37, 21, 43, 43)) {
				...
				for (var4 = 0; var4 < 4; ++var4) {
					this.func_175804_a(worldIn, p_175838_3_, 43 - var4, var4 + 9, 21, 43 - var4, var4 + 9, 43 - var4,
							field_175826_b, field_175826_b, false);
				}
			...
			if (this.func_175818_a(p_175838_3_, 15, 37, 42, 43)) {
				...
				for (var4 = 0; var4 < 4; ++var4) {
					this.func_175804_a(worldIn, p_175838_3_, 15 + var4, var4 + 9, 43 - var4, 42 - var4, var4 + 9,
							43 - var4, field_175826_b, field_175826_b, false);
				}
	...
	public static class MonumentCoreRoom extends StructureOceanMonumentPieces.Piece {
		...
		public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
			...
			this.func_175804_a(worldIn, p_74875_3_, 7, 4, 7, 8, 5, 8, Blocks.gold_block.getDefaultState(),
		...
		public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
			...
			for (int var5 = 0; var5 < 2; ++var5) {
				for (int var6 = 2; var6 <= 8; var6 += 3) {
					this.func_175804_a(worldIn, p_74875_3_, var7, 0, var6, var7, 2, var6, field_175826_b,
							field_175826_b, false);
				}
	...
	public abstract static class Piece extends StructureComponent {
		...
		protected void func_175821_a(World worldIn, StructureBoundingBox p_175821_2_, int p_175821_3_, int p_175821_4_,
				boolean p_175821_5_) {
			if (p_175821_5_) {
				this.func_175804_a(worldIn, p_175821_2_, p_175821_3_ + 0, 0, p_175821_4_ + 0, p_175821_3_ + 2, 0,
						p_175821_4_ + 8 - 1, field_175828_a, field_175828_a, false);
				this.func_175804_a(worldIn, p_175821_2_, p_175821_3_ + 5, 0, p_175821_4_ + 0, p_175821_3_ + 8 - 1, 0,
						p_175821_4_ + 8 - 1, field_175828_a, field_175828_a, false);
				this.func_175804_a(worldIn, p_175821_2_, p_175821_3_ + 3, 0, p_175821_4_ + 0, p_175821_3_ + 4, 0,
						p_175821_4_ + 2, field_175828_a, field_175828_a, false);
				this.func_175804_a(worldIn, p_175821_2_, p_175821_3_ + 3, 0, p_175821_4_ + 5, p_175821_3_ + 4, 0,
						p_175821_4_ + 8 - 1, field_175828_a, field_175828_a, false);
				this.func_175804_a(worldIn, p_175821_2_, p_175821_3_ + 3, 0, p_175821_4_ + 2, p_175821_3_ + 4, 0,
						p_175821_4_ + 2, field_175826_b, field_175826_b, false);
				this.func_175804_a(worldIn, p_175821_2_, p_175821_3_ + 3, 0, p_175821_4_ + 5, p_175821_3_ + 4, 0,
						p_175821_4_ + 5, field_175826_b, field_175826_b, false);
				this.func_175804_a(worldIn, p_175821_2_, p_175821_3_ + 2, 0, p_175821_4_ + 3, p_175821_3_ + 2, 0,
						p_175821_4_ + 4, field_175826_b, field_175826_b, false);
				this.func_175804_a(worldIn, p_175821_2_, p_175821_3_ + 5, 0, p_175821_4_ + 3, p_175821_3_ + 5, 0,
						p_175821_4_ + 4, field_175826_b, field_175826_b, false);
			} else {
				this.func_175804_a(worldIn, p_175821_2_, p_175821_3_ + 0, 0, p_175821_4_ + 0, p_175821_3_ + 8 - 1, 0,
						p_175821_4_ + 8 - 1, field_175828_a, field_175828_a, false);
			}
		}
		...
		public boolean func_175959_a(int p_175959_1_) {
			if (this.field_175964_e) {
				...
				for (int var2 = 0; var2 < 6; ++var2) {
					if (this.field_175965_b[var2] != null && this.field_175966_c[var2]
							&& this.field_175965_b[var2].field_175962_f != p_175959_1_
							&& this.field_175965_b[var2].func_175959_a(p_175959_1_)) {
						return true;
					}
				}
	...
	public static class SimpleRoom extends StructureOceanMonumentPieces.Piece {
		...
		public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
			...
			boolean var4 = this.field_175833_o != 0 && p_74875_2_.nextBoolean()
					&& !this.field_175830_k.field_175966_c[EnumFacing.DOWN.getIndex()]
			...
			for (int var4 = 1; var4 <= 6; ++var4) {
				for (int var5 = 1; var5 <= 6; ++var5) {
					if (p_74875_2_.nextInt(3) != 0) {
						...
						this.func_175804_a(worldIn, p_74875_3_, var4, var6, var5, var4, 3, var5,
	...
	public static class WingRoom extends StructureOceanMonumentPieces.Piece {
		...
		public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
			if (this.field_175834_o == 0) {
				...
				for (var4 = 0; var4 < 4; ++var4) {
					this.func_175804_a(worldIn, p_74875_3_, 10 - var4, 3 - var4, 20 - var4, 12 + var4, 3 - var4, 20,
							field_175826_b, field_175826_b, false);
				}
				...
				for (var7 = 0; var7 < 2; ++var7) {
					this.func_175804_a(worldIn, p_74875_3_, var8, 0, 10, var8, 6, 10, field_175826_b, field_175826_b,
							false);
					this.func_175804_a(worldIn, p_74875_3_, var8, 0, 12, var8, 6, 12, field_175826_b, field_175826_b,
							false);
				...
				for (var7 = 0; var7 < 2; ++var7) {
					this.func_175804_a(worldIn, p_74875_3_, var8, 0, 7, var8, 2, 7, field_175826_b, field_175826_b,
							false);
					this.func_175804_a(worldIn, p_74875_3_, var8, 0, 14, var8, 2, 14, field_175826_b, field_175826_b,
							false);
					var8 = 14;
				}
	...
	static class XYDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper {
		...
		public boolean func_175969_a(StructureOceanMonumentPieces.RoomDefinition p_175969_1_) {
			if (p_175969_1_.field_175966_c[EnumFacing.EAST.getIndex()]
				...
				StructureOceanMonumentPieces.RoomDefinition var2 = p_175969_1_.field_175965_b[EnumFacing.EAST
						.getIndex()];
	...
	static class YZDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper {
		...
		public boolean func_175969_a(StructureOceanMonumentPieces.RoomDefinition p_175969_1_) {
			if (p_175969_1_.field_175966_c[EnumFacing.NORTH.getIndex()]
					...
					&& p_175969_1_.field_175966_c[EnumFacing.UP.getIndex()]
					&& !p_175969_1_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d) {
				StructureOceanMonumentPieces.RoomDefinition var2 = p_175969_1_.field_175965_b[EnumFacing.NORTH
						.getIndex()];
				return var2.field_175966_c[EnumFacing.UP.getIndex()]
						&& !var2.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d;
			} else {
