...
public abstract class MapGenStructure extends MapGenBase {
	...
	protected final void func_180701_a(World worldIn, final int p_180701_2_, final int p_180701_3_, int p_180701_4_,
		...
		if (!this.structureLongMap.containsItem(ChunkCoordIntPair.chunkXZ2Int(p_180701_2_, p_180701_3_))) {
			...
			try {
				...
				var9.addCrashSection("Chunk location", String.format("%d,%d",
						new Object[] { Integer.valueOf(p_180701_2_), Integer.valueOf(p_180701_3_) }));
	...
	private void func_143027_a(World worldIn) {
		if (this.field_143029_e == null) {
			...
			if (Reflector.ForgeWorld_getPerWorldStorage.exists()) {
				...
				this.field_143029_e = (MapGenStructureData) var2.loadData(MapGenStructureData.class,
						this.getStructureName());
			} else {
				this.field_143029_e = (MapGenStructureData) worldIn.loadItemData(MapGenStructureData.class,
						this.getStructureName());
			}
