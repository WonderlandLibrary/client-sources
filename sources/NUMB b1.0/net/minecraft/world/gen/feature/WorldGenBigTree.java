...
public class WorldGenBigTree extends WorldGenAbstractTree {
		...
		for (; var3 >= 0; --var3) {
			...
			if (var4 >= 0.0F) {
				for (int var5 = 0; var5 < var1; ++var5) {
					double var6 = this.field_175945_e * (double) var4
							* ((double) this.field_175949_k.nextFloat() + 0.328D);
					...
					if (this.func_175936_a(var14, var15) == -1) {
						...
						double var18 = (double) var14.getY()
								- Math.sqrt((double) (var16 * var16 + var17 * var17)) * this.field_175944_d;
	...
	void func_180712_a(BlockPos p_180712_1_, float p_180712_2_, Block p_180712_3_) {
		...
		for (int var5 = -var4; var5 <= var4; ++var5) {
			for (int var6 = -var4; var6 <= var4; ++var6) {
				if (Math.pow((double) Math.abs(var5) + 0.5D, 2.0D)
						+ Math.pow((double) Math.abs(var6) + 0.5D, 2.0D) <= (double) (p_180712_2_ * p_180712_2_)) {
	...
	void func_175937_a(BlockPos p_175937_1_, BlockPos p_175937_2_, Block p_175937_3_) {
		...
		for (int var9 = 0; var9 <= var5; ++var9) {
			BlockPos var10 = p_175937_1_.add((double) (0.5F + (float) var9 * var6),
					(double) (0.5F + (float) var9 * var7), (double) (0.5F + (float) var9 * var8));
			BlockLog.EnumAxis var11 = this.func_175938_b(p_175937_1_, var10);
			this.func_175903_a(this.field_175946_l, var10,
					p_175937_3_.getDefaultState().withProperty(BlockLog.AXIS_PROP, var11));
		}
	}
	...
	int func_175936_a(BlockPos p_175936_1_, BlockPos p_175936_2_) {
		...
		if (var4 == 0) {
			...
			for (int var8 = 0; var8 <= var4; ++var8) {
				BlockPos var9 = p_175936_1_.add((double) (0.5F + (float) var8 * var5),
						(double) (0.5F + (float) var8 * var6), (double) (0.5F + (float) var8 * var7));
