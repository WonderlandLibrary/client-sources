	...
	public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_) {
		...
		if (p_180709_3_.getY() < 1) {
			...
			for (int var5 = 0; var5 < 4; ++var5) {
				BlockPos var6 = p_180709_3_.add(p_180709_2_.nextInt(4) - p_180709_2_.nextInt(4),
				...
				if (worldIn.isAirBlock(var6) && World.doesBlockHaveSolidTopSurface(worldIn, var6.offsetDown())) {
					...
					if (var7 instanceof TileEntityChest) {
						WeightedRandomChestContent.generateChestContents(p_180709_2_, this.field_175909_a,
								(TileEntityChest) var7, this.itemsToGenerateInBonusChest);
					}
