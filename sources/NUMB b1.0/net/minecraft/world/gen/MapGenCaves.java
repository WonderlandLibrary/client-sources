...
public class MapGenCaves extends MapGenBase {
	...
	protected void func_180702_a(long p_180702_1_, int p_180702_3_, int p_180702_4_, ChunkPrimer p_180702_5_,
		...
		for (boolean var28 = var25.nextInt(6) == 0; p_180702_15_ < p_180702_16_; ++p_180702_15_) {
			...
			if (!var54 && p_180702_15_ == var27 && p_180702_12_ > 1.0F && p_180702_16_ > 0) {
				this.func_180702_a(var25.nextLong(), p_180702_3_, p_180702_4_, p_180702_5_, p_180702_6_, p_180702_8_,
								...
								if (var59 * var59 + var46 * var46 < 1.0D) {
									for (int var49 = var38; var49 > var56; --var49) {
										...
										if (var50 > -0.7D && var59 * var59 + var50 * var50 + var46 * var46 < 1.0D) {
											...
											IBlockState var53 = (IBlockState) Objects.firstNonNull(
											...
											if (this.func_175793_a(var52, var53)) {
												if (var49 - 1 < 10) {
													...
													if (var48 && p_180702_5_.getBlockState(var42, var49 - 1, var60)
														...
														p_180702_5_
																.setBlockState(var42, var49 - 1, var60,
																		this.worldObj.getBiomeGenForCoords(new BlockPos(
																				var42 + p_180702_3_ * 16, 0,
	...
	protected void func_180701_a(World worldIn, int p_180701_2_, int p_180701_3_, int p_180701_4_, int p_180701_5_,
			ChunkPrimer p_180701_6_) {
		...
		for (int var8 = 0; var8 < var7; ++var8) {
			...
			for (int var16 = 0; var16 < var15; ++var16) {
				...
				this.func_180702_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, p_180701_6_, var9, var11, var13,
