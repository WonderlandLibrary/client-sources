...
public final class SpawnerAnimals {
									...
									while (true) {
										if (var29 < 4) {
											label108: {
												...
												if (!p_77192_1_.func_175636_b((double) var31, (double) var24,
														(double) var32, 24.0D)
														&& var37.distanceSq((double) var31, (double) var24,
																(double) var32) >= 576.0D) {
													if (var27 == null) {
													...
													if (p_77192_1_.func_175732_a(var40, var27, var30)
														...
														var33.setLocationAndAngles((double) var31, (double) var24,
																(double) var32, p_77192_1_.rand.nextFloat() * 360.0F,
																0.0F);
	...
	public static boolean func_180267_a(EntityLiving.SpawnPlacementType p_180267_0_, World worldIn,
			BlockPos p_180267_2_) {
				...
				for (int var15 = 0; var15 < var9; ++var15) {
					...
					for (int var17 = 0; !var16 && var17 < 4; ++var17) {
						...
						if (func_180267_a(EntityLiving.SpawnPlacementType.ON_GROUND, worldIn, var18)) {
							...
							var19.setLocationAndAngles((double) ((float) var11 + 0.5F), (double) var18.getY(),
									(double) ((float) var12 + 0.5F), p_77191_6_.nextFloat() * 360.0F, 0.0F);
