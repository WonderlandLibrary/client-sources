...
public class BiomeGenMesa extends BiomeGenBase {
	...
	public void genTerrainBlocks(World worldIn, Random p_180622_2_, ChunkPrimer p_180622_3_, int p_180622_4_,
		...
		if (this.field_150626_aH) {
			...
			double var12 = Math.min(Math.abs(p_180622_6_),
					this.field_150623_aE.func_151601_a((double) var10 * 0.25D, (double) var11 * 0.25D));

			if (var12 > 0.0D) {
				double var14 = 0.001953125D;
				double var16 = Math
						.abs(this.field_150624_aF.func_151601_a((double) var10 * var14, (double) var11 * var14));
	...
	private void func_150619_a(long p_150619_1_) {
		...
		for (var4 = 0; var4 < 64; ++var4) {
			...
			if (var4 < 64) {
				this.field_150621_aC[var4] = Blocks.stained_hardened_clay.getDefaultState()
						.withProperty(BlockColored.COLOR, EnumDyeColor.ORANGE);
			}
		}
		...
		for (var5 = 0; var5 < var4; ++var5) {
			...
			for (var8 = 0; var7 + var8 < 64 && var8 < var6; ++var8) {
				this.field_150621_aC[var7 + var8] = Blocks.stained_hardened_clay.getDefaultState()
		...
		for (var6 = 0; var6 < var5; ++var6) {
			...
			for (var9 = 0; var8 + var9 < 64 && var9 < var7; ++var9) {
				this.field_150621_aC[var8 + var9] = Blocks.stained_hardened_clay.getDefaultState()
		...
		for (var7 = 0; var7 < var6; ++var7) {
			...
			for (int var10 = 0; var9 + var10 < 64 && var10 < var8; ++var10) {
				this.field_150621_aC[var9 + var10] = Blocks.stained_hardened_clay.getDefaultState()
		...
		for (var9 = 0; var9 < var7; ++var9) {
			...
			for (int var11 = 0; var8 + var11 < 64 && var11 < var12; ++var11) {
				this.field_150621_aC[var8 + var11] = Blocks.stained_hardened_clay.getDefaultState()
						.withProperty(BlockColored.COLOR, EnumDyeColor.WHITE);

				if (var8 + var11 > 1 && var3.nextBoolean()) {
					this.field_150621_aC[var8 + var11 - 1] = Blocks.stained_hardened_clay.getDefaultState()
	...
	private IBlockState func_180629_a(int p_180629_1_, int p_180629_2_, int p_180629_3_) {
		int var4 = (int) Math.round(this.field_150625_aG.func_151601_a((double) p_180629_1_ * 1.0D / 512.0D,
