...
public abstract class BiomeGenBase {
	...
	public final float func_180626_a(BlockPos p_180626_1_) {
		if (p_180626_1_.getY() > 64) {
			float var2 = (float) (temperatureNoise.func_151601_a((double) p_180626_1_.getX() * 1.0D / 8.0D,
					(double) p_180626_1_.getZ() * 1.0D / 8.0D) * 4.0D);
	...
	public final void func_180628_b(World worldIn, Random p_180628_2_, ChunkPrimer p_180628_3_, int p_180628_4_,
				...
				if (var16.getBlock().getMaterial() == Material.air) {
					...
					if (var11 == -1) {
						...
						if (var11 == 0 && var10.getBlock() == Blocks.sand) {
							...
							var10 = var10.getValue(BlockSand.VARIANT_PROP) == BlockSand.EnumType.RED_SAND
	...
	public boolean isEqualTo(BiomeGenBase p_150569_1_) {
		return p_150569_1_ == this ? true
				: (p_150569_1_ == null ? false : this.getBiomeClass() == p_150569_1_.getBiomeClass());
	}
		...
		for (int var2 = 0; var2 < var1; ++var2) {
			...
			if (var3 != null) {
				if (field_180278_o.containsKey(var3.biomeName)) {
					throw new Error("Biome \"" + var3.biomeName + "\" is defined as both ID "
							+ ((BiomeGenBase) field_180278_o.get(var3.biomeName)).biomeID + " and " + var3.biomeID);
				}
