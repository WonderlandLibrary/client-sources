...
public class SaveFormatOld implements ISaveFormat {
	 ...
	 *        world and second the new name for that world. @desc: Renames the world
	 *        by storing the new name in level.dat. It does *not* rename the
	 *        directory containing the world data.
	 */
