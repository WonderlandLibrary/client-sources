...
public class ItemDoor extends Item {
	...
	public static void func_179235_a(World worldIn, BlockPos p_179235_1_, EnumFacing p_179235_2_, Block p_179235_3_) {
		...
		int var6 = (worldIn.getBlockState(var5).getBlock().isNormalCube() ? 1 : 0)
				+ (worldIn.getBlockState(var5.offsetUp()).getBlock().isNormalCube() ? 1 : 0);
		int var7 = (worldIn.getBlockState(var4).getBlock().isNormalCube() ? 1 : 0)
				+ (worldIn.getBlockState(var4.offsetUp()).getBlock().isNormalCube() ? 1 : 0);
		boolean var8 = worldIn.getBlockState(var5).getBlock() == p_179235_3_
				|| worldIn.getBlockState(var5.offsetUp()).getBlock() == p_179235_3_;
		boolean var9 = worldIn.getBlockState(var4).getBlock() == p_179235_3_
		...
		IBlockState var12 = p_179235_3_.getDefaultState().withProperty(BlockDoor.FACING_PROP, p_179235_2_).withProperty(
				BlockDoor.HINGEPOSITION_PROP,
