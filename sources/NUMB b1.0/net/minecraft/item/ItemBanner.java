		...
		if (side == EnumFacing.DOWN) {
			...
			if (!playerIn.func_175151_a(pos, side, stack)) {
				...
				if (side == EnumFacing.UP) {
					int var9 = MathHelper
							.floor_double((double) ((playerIn.rotationYaw + 180.0F) * 16.0F / 360.0F) + 0.5D) & 15;
					worldIn.setBlockState(pos, Blocks.standing_banner.getDefaultState()
							.withProperty(BlockStandingSign.ROTATION_PROP, Integer.valueOf(var9)), 3);
				} else {
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List tooltip, boolean advanced) {
		...
		if (var5 != null && var5.hasKey("Patterns")) {
			...
			for (int var7 = 0; var7 < var6.tagCount() && var7 < 6; ++var7) {
				...
				TileEntityBanner.EnumBannerPattern var10 = TileEntityBanner.EnumBannerPattern
