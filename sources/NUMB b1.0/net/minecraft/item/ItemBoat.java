...
public class ItemBoat extends Item {
	...
	public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn) {
		...
		double var9 = playerIn.prevPosY + (playerIn.posY - playerIn.prevPosY) * (double) var4
		...
		if (var24 == null) {
			...
			boolean var26 = false;
			float var27 = 1.0F;
			List var28 = worldIn.getEntitiesWithinAABBExcludingEntity(playerIn,
			...
			for (int var29 = 0; var29 < var28.size(); ++var29) {
				...
				if (var30.canBeCollidedWith()) {
					...
					AxisAlignedBB var32 = var30.getEntityBoundingBox().expand((double) var31, (double) var31,
							(double) var31);
			...
			if (var26) {
				...
				if (var24.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
					...
					EntityBoat var34 = new EntityBoat(worldIn, (double) ((float) var33.getX() + 0.5F),
							(double) ((float) var33.getY() + 1.0F), (double) ((float) var33.getZ() + 0.5F));
					var34.rotationYaw = (float) (((MathHelper
