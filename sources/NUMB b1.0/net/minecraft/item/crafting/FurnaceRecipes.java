...
public class FurnaceRecipes {
	...
	private FurnaceRecipes() {
		...
		this.addSmeltingRecipeForBlock(Blocks.cactus,
				new ItemStack(Items.dye, 1, EnumDyeColor.GREEN.getDyeColorDamage()), 0.2F);
		...
		for (int var3 = 0; var3 < var2; ++var3) {
			...
			if (var4.getCookable()) {
				this.addSmeltingRecipe(new ItemStack(Items.fish, 1, var4.getItemDamage()),
		...
		this.addSmeltingRecipeForBlock(Blocks.lapis_ore,
				new ItemStack(Items.dye, 1, EnumDyeColor.BLUE.getDyeColorDamage()), 0.2F);
