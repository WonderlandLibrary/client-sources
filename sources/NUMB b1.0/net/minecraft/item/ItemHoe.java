...
public class ItemHoe extends Item {
		...
		if (!playerIn.func_175151_a(pos.offset(side), side, stack)) {
			...
			if (side != EnumFacing.DOWN
				...
				if (var10 == Blocks.dirt) {
					...
					case 2:
						return this.func_179232_a(stack, playerIn, worldIn, pos,
	...
	protected boolean func_179232_a(ItemStack p_179232_1_, EntityPlayer p_179232_2_, World worldIn,
			BlockPos p_179232_4_, IBlockState p_179232_5_) {
		worldIn.playSoundEffect((double) ((float) p_179232_4_.getX() + 0.5F),
				(double) ((float) p_179232_4_.getY() + 0.5F), (double) ((float) p_179232_4_.getZ() + 0.5F),
