...
public class GuiCustomizeSkin extends GuiScreen {
	...
	public void initGui() {
		...
		for (int var4 = 0; var4 < var3; ++var4) {
			...
			this.buttonList.add(new GuiCustomizeSkin.ButtonPart(var5.func_179328_b(),
					this.width / 2 - 155 + var1 % 2 * 160, this.height / 6 + 24 * (var1 >> 1), 150, 20, var5, null));
			++var1;
		}
		...
		this.buttonList.add(new GuiButton(200, this.width / 2 - 100, this.height / 6 + 24 * (var1 >> 1),
	...
	class ButtonPart extends GuiButton {
		...
		private ButtonPart(int p_i45514_2_, int p_i45514_3_, int p_i45514_4_, int p_i45514_5_, int p_i45514_6_,
				EnumPlayerModelParts p_i45514_7_) {
			super(p_i45514_2_, p_i45514_3_, p_i45514_4_, p_i45514_5_, p_i45514_6_,
					GuiCustomizeSkin.this.func_175358_a(p_i45514_7_));
			this.field_175234_p = p_i45514_7_;
		}

		ButtonPart(int p_i45515_2_, int p_i45515_3_, int p_i45515_4_, int p_i45515_5_, int p_i45515_6_,
				EnumPlayerModelParts p_i45515_7_, Object p_i45515_8_) {
