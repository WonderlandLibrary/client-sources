...
public class GuiLockIconButton extends GuiButton {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY) {
		if (this.visible) {
			...
			boolean var4 = mouseX >= this.xPosition && mouseY >= this.yPosition && mouseX < this.xPosition + this.width
			...
			this.drawTexturedModalRect(this.xPosition, this.yPosition, var5.func_178910_a(), var5.func_178912_b(),
	...
	static enum Icon {
		...
		private static final GuiLockIconButton.Icon[] $VALUES = new GuiLockIconButton.Icon[] { LOCKED, LOCKED_HOVER,
				LOCKED_DISABLED, UNLOCKED, UNLOCKED_HOVER, UNLOCKED_DISABLED };
