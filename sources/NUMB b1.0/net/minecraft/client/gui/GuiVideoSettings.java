...
public class GuiVideoSettings extends GuiScreen {
		...
		for (y = 0; y < videoOptions.length; ++y) {
			...
			if (x != null) {
				...
				if (x.getEnumFloat()) {
					...
					this.buttonList.add(new GuiOptionButtonOF(x.returnEnumOrdinal(), x1, y1, x,
							this.guiGameSettings.getKeyBinding(x)));
				}
			}
		}
	...
	public static void drawGradientRect(GuiScreen guiScreen, int left, int top, int right, int bottom, int startColor,
			int endColor) {
