	...
	public void initGui() {
		...
		for (int var4 = 0; var4 < var3; ++var4) {
			...
			if (var5.getEnumFloat()) {
				...
				GuiOptionButton var6 = new GuiOptionButton(var5.returnEnumOrdinal(),
						this.width / 2 - 155 + var1 % 2 * 160, this.height / 6 - 12 + 24 * (var1 >> 1), var5,
						this.game_settings_1.getKeyBinding(var5));
		...
		if (this.mc.theWorld != null) {
			...
			this.field_175357_i = new GuiButton(108, this.width / 2 - 155 + var1 % 2 * 160,
					this.height / 6 - 12 + 24 * (var1 >> 1), 150, 20, this.func_175355_a(var7));
		...
		this.buttonList.add(new GuiButton(8675309, this.width / 2 + 5, this.height / 6 + 48 - 6, 150, 20,
			...
			public void playPressSound(SoundHandler soundHandlerIn) {
				SoundEventAccessorComposite var2 = soundHandlerIn
