...
public class MapItemRenderer {
	...
	class Instance {
		...
		private Instance(MapData p_i45007_2_) {
			...
			this.field_148240_d = MapItemRenderer.this.textureManager
		...
		private void func_148237_a(boolean p_148237_1_) {
			...
			var5.addVertexWithUV((double) ((float) (var2 + 0) + var6), (double) ((float) (var3 + 128) - var6),
					-0.009999999776482582D, 0.0D, 1.0D);
			var5.addVertexWithUV((double) ((float) (var2 + 128) - var6), (double) ((float) (var3 + 128) - var6),
					-0.009999999776482582D, 1.0D, 1.0D);
			var5.addVertexWithUV((double) ((float) (var2 + 128) - var6), (double) ((float) (var3 + 0) + var6),
					-0.009999999776482582D, 1.0D, 0.0D);
			var5.addVertexWithUV((double) ((float) (var2 + 0) + var6), (double) ((float) (var3 + 0) + var6),
			...
			while (var8.hasNext()) {
				...
				if (!p_148237_1_ || var9.func_176110_a() == 1) {
					...
					GlStateManager.translate((float) var2 + (float) var9.func_176112_b() / 2.0F + 64.0F,
							(float) var3 + (float) var9.func_176113_c() / 2.0F + 64.0F, -0.02F);
					...
					var5.addVertexWithUV(-1.0D, -1.0D, (double) ((float) var7 * 0.001F), (double) var11,
							(double) var14);
					var4.draw();
