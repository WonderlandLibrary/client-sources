...
public class GuiScreenDemo extends GuiScreen {
	...
	public void initGui() {
		...
		byte var1 = -16;
		this.buttonList.add(new GuiButton(1, this.width / 2 - 116, this.height / 2 + 62 + var1, 114, 20,
				I18n.format("demo.help.buy", new Object[0])));
		this.buttonList.add(new GuiButton(2, this.width / 2 + 2, this.height / 2 + 62 + var1, 114, 20,
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.fontRendererObj.drawSplitString(I18n.format("demo.help.fullWrapped", new Object[0]), var4, var5 + 68, 218,
				2039583);
