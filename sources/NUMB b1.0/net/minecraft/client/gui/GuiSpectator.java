...
public class GuiSpectator extends Gui implements ISpectatorMenuReciepient {
	...
	protected void func_175258_a(ScaledResolution p_175258_1_, float p_175258_2_, int p_175258_3_, float p_175258_4_,
		...
		if (p_175258_5_.func_178681_b() >= 0) {
			this.func_175174_a((float) (p_175258_3_ - 91 - 1 + p_175258_5_.func_178681_b() * 20), p_175258_4_ - 1.0F, 0,
					22, 24, 22);
		}
		...
		for (int var6 = 0; var6 < 9; ++var6) {
			this.func_175266_a(var6, p_175258_1_.getScaledWidth() / 2 - 90 + var6 * 20 + 2, p_175258_4_ + 3.0F,
					p_175258_2_, p_175258_5_.func_178680_a(var6));
		}
	...
	private void func_175266_a(int p_175266_1_, int p_175266_2_, float p_175266_3_, float p_175266_4_,
		...
		if (p_175266_5_ != SpectatorMenu.field_178657_a) {
			...
			String var8 = String.valueOf(GameSettings
					.getKeyDisplayString(this.field_175268_g.gameSettings.keyBindsHotbar[p_175266_1_].getKeyCode()));

			if (var6 > 3 && p_175266_5_.func_178662_A_()) {
				this.field_175268_g.fontRendererObj.func_175063_a(var8,
						(float) (p_175266_2_ + 19 - 2 - this.field_175268_g.fontRendererObj.getStringWidth(var8)),
	...
	public void func_175263_a(ScaledResolution p_175263_1_) {
		...
		if (var2 > 3 && this.field_175271_i != null) {
			...
			String var4 = var3 != SpectatorMenu.field_178657_a ? var3.func_178664_z_().getFormattedText()
					: this.field_175271_i.func_178650_c().func_178670_b().getFormattedText();

			if (var4 != null) {
				int var5 = (p_175263_1_.getScaledWidth() - this.field_175268_g.fontRendererObj.getStringWidth(var4))
						/ 2;
				int var6 = p_175263_1_.getScaledHeight() - 35;
				GlStateManager.pushMatrix();
				GlStateManager.enableBlend();
				GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
				this.field_175268_g.fontRendererObj.func_175063_a(var4, (float) var5, (float) var6,
						16777215 + (var2 << 24));
				GlStateManager.disableBlend();
				GlStateManager.popMatrix();
			}
	...
	public void func_175259_b(int p_175259_1_) {
		...
		for (var2 = this.field_175271_i.func_178648_e() + p_175259_1_; var2 >= 0 && var2 <= 8
				&& (this.field_175271_i.func_178643_a(var2) == SpectatorMenu.field_178657_a
						|| !this.field_175271_i.func_178643_a(var2).func_178662_A_()); var2 += p_175259_1_) {
			;
		}
