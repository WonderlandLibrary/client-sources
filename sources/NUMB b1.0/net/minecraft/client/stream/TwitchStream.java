...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener,
	...
	public TwitchStream(Minecraft mcIn, final Property p_i46057_2_) {
		...
		if (p_i46057_2_ != null && !Strings.isNullOrEmpty(p_i46057_2_.getValue())
			...
			Thread var3 = new Thread("Twitch authenticator") {
				...
				public void run() {
					try {
						URL var1 = new URL("https://api.twitch.tv/kraken?oauth_token="
	...
	public void func_152935_j() {
		...
		boolean var3 = this.field_152952_d.func_153000_j() == ChatController.ChatState.Initialized
				&& (this.field_176029_e == null || this.field_152952_d
	...
	public void func_152922_k() {
		if (this.broadcastController.isBroadcasting() && !this.broadcastController.isBroadcastPaused()) {
			...
			if (var7) {
				...
				GlStateManager.ortho(0.0D, (double) this.field_152956_h.framebufferWidth,
						(double) this.field_152956_h.framebufferHeight, 0.0D, 1000.0D, 3000.0D);
				GlStateManager.matrixMode(5888);
				GlStateManager.pushMatrix();
				GlStateManager.loadIdentity();
				GlStateManager.translate(0.0F, 0.0F, -2000.0F);
				GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
				GlStateManager.viewport(0, 0, this.field_152956_h.framebufferWidth,
						this.field_152956_h.framebufferHeight);
	...
	public void func_152911_a(Metadata p_152911_1_, long p_152911_2_) {
		if (this.func_152934_n() && this.field_152957_i) {
			...
			if (!this.broadcastController.func_152840_a(p_152911_1_.func_152810_c(), var4 + p_152911_2_,
				...
				field_152950_b.warn(field_152949_a, "Couldn\'t send stream metadata action at {}: {}",
						new Object[] { Long.valueOf(var4 + p_152911_2_), p_152911_1_ });
			} else {
	...
	public void func_176026_a(Metadata p_176026_1_, long p_176026_2_, long p_176026_4_) {
		if (this.func_152934_n() && this.field_152957_i) {
			...
			long var10 = this.broadcastController.func_177946_b(p_176026_1_.func_152810_c(), var6 + p_176026_2_, var8,
					var9);

			if (var10 < 0L) {
				field_152950_b.warn(field_152949_a, "Could not send stream metadata sequence from {} to {}: {}",
						new Object[] { Long.valueOf(var6 + p_176026_2_), Long.valueOf(var6 + p_176026_4_),
								p_176026_1_ });
			} else if (this.broadcastController.func_177947_a(p_176026_1_.func_152810_c(), var6 + p_176026_4_, var10,
					var8, var9)) {
				field_152950_b.debug(field_152949_a, "Sent stream metadata sequence from {} to {}: {}", new Object[] {
						Long.valueOf(var6 + p_176026_2_), Long.valueOf(var6 + p_176026_4_), p_176026_1_ });
			} else {
	...
	public void func_152915_s() {
		if (this.func_152934_n()) {
			...
			this.broadcastController
					.func_152829_a(this.func_152929_G() ? 0.0F : this.field_152953_e.gameSettings.streamMicVolume);
		}
	}

	public void func_152930_t() {
		GameSettings var1 = this.field_152953_e.gameSettings;
		VideoParams var2 = this.broadcastController.func_152834_a(func_152946_b(var1.streamKbps),
				func_152948_a(var1.streamFps), func_152947_c(var1.streamBytesPerPixel),
				(float) this.field_152953_e.displayWidth / (float) this.field_152953_e.displayHeight);
		...
		field_152950_b.info(field_152949_a, "Streaming at {}/{} at {} kbps to {}",
				new Object[] { Integer.valueOf(var2.outputWidth), Integer.valueOf(var2.outputHeight),
						Integer.valueOf(var2.maxKbps), this.broadcastController.func_152833_s().serverUrl });
	...
	public void func_152893_b(ErrorCode p_152893_1_) {
		...
		this.field_152953_e.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(new ChatComponentText(
	...
	public void func_152892_c(ErrorCode p_152892_1_) {
		...
		if (p_152892_1_ == ErrorCode.TTV_EC_SOUNDFLOWER_NOT_INSTALLED) {
			...
			ChatComponentTranslation var3 = new ChatComponentTranslation("stream.unavailable.soundflower.chat",
					new Object[] { var2 });
	...
	public void func_180605_a(String p_180605_1_, ChatRawMessage[] p_180605_2_) {
		...
		for (int var5 = 0; var5 < var4; ++var5) {
			...
			if (this.func_176028_a(var6.modes, var6.subscriptions,
					this.field_152953_e.gameSettings.streamChatUserFilter)) {
				ChatComponentText var7 = new ChatComponentText(var6.userName);
				ChatComponentTranslation var8 = new ChatComponentTranslation(
						"chat.stream." + (var6.action ? "emote" : "text"), new Object[] { this.field_152954_f, var7,
				...
				Iterator var10 = GuiTwitchUserMode.func_152328_a(var6.modes, var6.subscriptions, (IStream) null)
						.iterator();
	...
	public boolean func_152929_G() {
		...
		return this.field_152962_n || this.field_152953_e.gameSettings.streamMicVolume <= 0.0F
				|| var1 != this.field_152963_o;
	}
