...
public class ModelEnderMite extends ModelBase {
	...
	public ModelEnderMite() {
		...
		for (int var2 = 0; var2 < this.field_178713_d.length; ++var2) {
			...
			this.field_178713_d[var2].addBox((float) field_178716_a[var2][0] * -0.5F, 0.0F,
					(float) field_178716_a[var2][2] * -0.5F, field_178716_a[var2][0], field_178716_a[var2][1],
					field_178716_a[var2][2]);
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_,
		...
		for (int var8 = 0; var8 < this.field_178713_d.length; ++var8) {
			this.field_178713_d[var8].rotateAngleY = MathHelper
					.cos(p_78087_3_ * 0.9F + (float) var8 * 0.15F * (float) Math.PI) * (float) Math.PI * 0.01F
					* (float) (1 + Math.abs(var8 - 2));
			this.field_178713_d[var8].rotationPointX = MathHelper
					.sin(p_78087_3_ * 0.9F + (float) var8 * 0.15F * (float) Math.PI) * (float) Math.PI * 0.1F
