...
public class SimpleBakedModel implements IBakedModel {
	...
	public SimpleBakedModel(List p_i46077_1_, List p_i46077_2_, boolean p_i46077_3_, boolean p_i46077_4_,
			TextureAtlasSprite p_i46077_5_, ItemCameraTransforms p_i46077_6_) {
	...
	public static class Builder {
		...
		public IBakedModel func_177645_b() {
			if (this.field_177652_d == null) {
				...
				return new SimpleBakedModel(this.field_177656_a, this.field_177654_b, this.field_177655_c,
						this.field_177653_e, this.field_177652_d, this.field_177651_f);
			}
		}
	}
}
