...
public class ModelBakery {
			...
			try {
				...
				while (var5.hasNext()) {
					...
					try {
						...
						ModelBlockDefinition var8 = ModelBlockDefinition
		...
		while (var1.hasNext()) {
			...
			if (var11 != null && var11.isResolved()) {
				if (this.isCustomRenderer(var11)) {
					this.bakedRegistry.putObject(var10,
	...
	private IBakedModel bakeModel(ModelBlock p_177578_1_, ModelRotation p_177578_2_, boolean p_177578_3_) {
		TextureAtlasSprite var4 = (TextureAtlasSprite) this.field_177599_g
		...
		while (var6.hasNext()) {
			...
			while (var8.hasNext()) {
				...
				TextureAtlasSprite var11 = (TextureAtlasSprite) this.field_177599_g
				...
				if (var10.field_178244_b == null) {
					...
					var5.func_177650_a(p_177578_2_.func_177523_a(var10.field_178244_b),
							this.func_177589_a(var7, var10, var11, var9, p_177578_2_, p_177578_3_));
				}
			}
		}
	...
	private BakedQuad func_177589_a(BlockPart p_177589_1_, BlockPartFace p_177589_2_, TextureAtlasSprite p_177589_3_,
			EnumFacing p_177589_4_, ModelRotation p_177589_5_, boolean p_177589_6_) {
		return this.field_177607_l.func_178414_a(p_177589_1_.field_178241_a, p_177589_1_.field_178239_b, p_177589_2_,
	...
	private void func_177574_i() {
		...
		while (!var1.isEmpty()) {
			...
			try {
				...
				LOGGER.warn("In parent chain: " + field_177601_e.join(this.func_177573_e(var7))
