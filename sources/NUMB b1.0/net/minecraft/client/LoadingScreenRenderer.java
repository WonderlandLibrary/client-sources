	...
	private void func_73722_d(String p_73722_1_) {
		...
		if (!this.mc.running) {
			...
			if (OpenGlHelper.isFramebufferEnabled()) {
				...
				GlStateManager.ortho(0.0D, (double) (this.field_146587_f.getScaledWidth() * var2),
	...
	public void setLoadingProgress(int progress) {
		if (!this.mc.running) {
			...
			if (var2 - this.field_73723_d >= 100L) {
				...
				var9.addVertexWithUV((double) var6, (double) var7, 0.0D, (double) ((float) var6 / var10),
				...
				this.mc.fontRendererObj.func_175063_a(this.currentlyDisplayedText,
						(float) ((var6 - this.mc.fontRendererObj.getStringWidth(this.currentlyDisplayedText)) / 2),
						(float) (var7 / 2 - 4 - 16), 16777215);
				this.mc.fontRendererObj.func_175063_a(this.field_73727_a,
						(float) ((var6 - this.mc.fontRendererObj.getStringWidth(this.field_73727_a)) / 2),
						(float) (var7 / 2 - 4 + 8), 16777215);
