...
public abstract class ChunkRenderContainer {
	...
	public void func_178003_a(RenderChunk p_178003_1_) {
		...
		GlStateManager.translate((float) ((double) var2.getX() - this.field_178008_c),
				(float) ((double) var2.getY() - this.field_178005_d),
				(float) ((double) var2.getZ() - this.field_178006_e));
	}
