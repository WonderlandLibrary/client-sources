...
public class ItemModelMesher {
	...
	public void register(Item p_178086_1_, int p_178086_2_, ModelResourceLocation p_178086_3_) {
		...
		this.simpleShapesCache.put(Integer.valueOf(this.getIndex(p_178086_1_, p_178086_2_)),
				this.modelManager.getModel(p_178086_3_));
	}
	...
	public void rebuildCache() {
		...
		while (var1.hasNext()) {
			...
			this.simpleShapesCache.put(var2.getKey(),
					this.modelManager.getModel((ModelResourceLocation) var2.getValue()));
		}
	}
}
