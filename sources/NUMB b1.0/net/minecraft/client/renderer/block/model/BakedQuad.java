...
public class BakedQuad implements IVertexProducer {
	...
	public String toString() {
		return "vertex: " + this.field_178215_a.length / 7 + ", tint: " + this.field_178213_b + ", facing: " + this.face
				+ ", sprite: " + this.sprite;
	}
	...
	private static TextureAtlasSprite getSpriteByUv(int[] vertexData) {
		...
		TextureAtlasSprite var12 = Minecraft.getMinecraft().getTextureMapBlocks().getIconByUV((double) var10,
				(double) var11);
		return var12;
	}
