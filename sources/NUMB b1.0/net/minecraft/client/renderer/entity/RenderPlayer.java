...
import us.loki.legit.modules.impl.Render.HitAnimation;
...
public class RenderPlayer extends RendererLivingEntity {
	...
	public void func_180596_a(AbstractClientPlayer p_180596_1_, double p_180596_2_, double p_180596_4_,
			double p_180596_6_, float p_180596_8_, float p_180596_9_) {
	...
	protected void renderOffsetLivingLabel(AbstractClientPlayer p_96449_1_, double p_96449_2_, double p_96449_4_,
			double p_96449_6_, String p_96449_8_, float p_96449_9_, double p_96449_10_) {
		ScoreObjective var13;
		Scoreboard var12;
		if (p_96449_10_ < 100.0
				&& (var13 = (var12 = p_96449_1_.getWorldScoreboard()).getObjectiveInDisplaySlot(2)) != null) {
			Score var14 = var12.getValueFromObjective(p_96449_1_.getName(), var13);
			this.renderLivingLabel(p_96449_1_, String.valueOf(var14.getScorePoints()) + " " + var13.getDisplayName(),
					p_96449_2_, p_96449_4_, p_96449_6_, 64);
	...
	protected void func_180595_a(AbstractClientPlayer p_180595_1_, float p_180595_2_, float p_180595_3_,
			float p_180595_4_) {
	...
	public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
		...
		this.func_180596_a((AbstractClientPlayer) p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_,
				p_76986_9_);
	}
	...
	protected void func_177069_a(Entity p_177069_1_, double p_177069_2_, double p_177069_4_, double p_177069_6_,
		...
		this.renderOffsetLivingLabel((AbstractClientPlayer) p_177069_1_, p_177069_2_, p_177069_4_, p_177069_6_,
				p_177069_8_, p_177069_9_, p_177069_10_);
	}
	...
	public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_,
		...
		this.func_180596_a((AbstractClientPlayer) p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_,
				p_76986_9_);
		final HitAnimation Chams = (HitAnimation) ModuleManager.getModuleByName("HitAnimation");
		if (Chams.isEnabled()) {
			GL11.glPushMatrix();
			{
				GL11.glPushAttrib(GL11.GL_ALL_ATTRIB_BITS);
				{
					...
					this.func_180596_a((AbstractClientPlayer) p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_,
