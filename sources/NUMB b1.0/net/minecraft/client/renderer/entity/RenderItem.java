...
public class RenderItem implements IResourceManagerReloadListener {
	...
	public void func_180454_a(ItemStack p_180454_1_, IBakedModel p_180454_2_) {
		...
		if (p_180454_2_.isBuiltInRenderer()) {
			...
			if (p_180454_1_.hasEffect()
					&& (!Config.isCustomItems() || !CustomItems.renderCustomEffect(this, p_180454_1_, p_180454_2_))) {
	...
	public void func_175049_a(ItemStack p_175049_1_, EntityLivingBase p_175049_2_,
			ItemCameraTransforms.TransformType p_175049_3_) {
		...
		if (p_175049_2_ instanceof EntityPlayer) {
			...
			if (var6 == Items.fishing_rod && var5.fishEntity != null) {
				...
				var7 = (ModelResourceLocation) Reflector.call(var6, Reflector.ForgeItem_getModel,
						new Object[] { p_175049_1_, var5, Integer.valueOf(var5.getItemInUseCount()) });
			}
	...
	public static void applyVanillaTransform(ItemTransformVec3f p_175034_1_) {
		if (p_175034_1_ != ItemTransformVec3f.field_178366_a) {
			GlStateManager.translate(p_175034_1_.field_178365_c.x + field_175055_b,
					p_175034_1_.field_178365_c.y + field_175056_c, p_175034_1_.field_178365_c.z + field_175053_d);
			...
			GlStateManager.scale(p_175034_1_.field_178363_d.x + field_175061_h,
					p_175034_1_.field_178363_d.y + field_175062_i, p_175034_1_.field_178363_d.z + field_175060_j);
		}
	}

	protected void func_175040_a(ItemStack p_175040_1_, IBakedModel p_175040_2_,
			ItemCameraTransforms.TransformType p_175040_3_) {
		this.field_175057_n.bindTexture(TextureMap.locationBlocksTexture);
		...
		if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
			p_175040_2_ = (IBakedModel) Reflector.call(Reflector.ForgeHooksClient_handleCameraTransforms,
					new Object[] { p_175040_2_, p_175040_3_ });
		} else {
	...
	public void func_175042_a(ItemStack p_175042_1_, int p_175042_2_, int p_175042_3_) {
		...
		if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
			var4 = (IBakedModel) Reflector.call(Reflector.ForgeHooksClient_handleCameraTransforms,
					new Object[] { var4, ItemCameraTransforms.TransformType.GUI });
		} else {
	...
	public void func_180453_a(FontRenderer p_180453_1_, ItemStack p_180453_2_, int p_180453_3_, int p_180453_4_,
			String p_180453_5_) {
		if (p_180453_2_ != null) {
			if (p_180453_2_.stackSize != 1 || p_180453_5_ != null) {
				...
				GlStateManager.disableBlend();
				p_180453_1_.func_175063_a(itemDamaged,
						(float) (p_180453_3_ + 19 - 2 - p_180453_1_.getStringWidth(itemDamaged)),
						(float) (p_180453_4_ + 6 + 3), 16777215);
				GlStateManager.enableLighting();
			...
			if (Reflector.ForgeItem_showDurabilityBar.exists()) {
				itemDamaged1 = Reflector.callBoolean(p_180453_2_.getItem(), Reflector.ForgeItem_showDurabilityBar,
						new Object[] { p_180453_2_ });
			}

			if (itemDamaged1) {
				int var12 = (int) Math.round(
						13.0D - (double) p_180453_2_.getItemDamage() * 13.0D / (double) p_180453_2_.getMaxDamage());
				int var7 = (int) Math.round(
						255.0D - (double) p_180453_2_.getItemDamage() * 255.0D / (double) p_180453_2_.getMaxDamage());

				if (Reflector.ForgeItem_getDurabilityForDisplay.exists()) {
					double var8 = Reflector.callDouble(p_180453_2_.getItem(),
							Reflector.ForgeItem_getDurabilityForDisplay, new Object[] { p_180453_2_ });
	...
	private void func_175044_a(WorldRenderer p_175044_1_, int p_175044_2_, int p_175044_3_, int p_175044_4_,
			int p_175044_5_, int p_175044_6_) {
	...
	private void registerItems() {
		...
		this.registerBlock(Blocks.monster_egg, BlockSilverfish.EnumType.CHISELED_STONEBRICK.func_176881_a(),
				"chiseled_brick_monster_egg");
		this.registerBlock(Blocks.monster_egg, BlockSilverfish.EnumType.COBBLESTONE.func_176881_a(),
				"cobblestone_monster_egg");
		this.registerBlock(Blocks.monster_egg, BlockSilverfish.EnumType.CRACKED_STONEBRICK.func_176881_a(),
				"cracked_brick_monster_egg");
		this.registerBlock(Blocks.monster_egg, BlockSilverfish.EnumType.MOSSY_STONEBRICK.func_176881_a(),
		...
		this.registerBlock(Blocks.monster_egg, BlockSilverfish.EnumType.STONEBRICK.func_176881_a(),
		...
		this.registerBlock(Blocks.quartz_block, BlockQuartz.EnumType.CHISELED.getMetaFromState(),
		...
		this.registerBlock(Blocks.red_sandstone, BlockRedSandstone.EnumType.CHISELED.getMetaFromState(),
				"chiseled_red_sandstone");
		this.registerBlock(Blocks.red_sandstone, BlockRedSandstone.EnumType.DEFAULT.getMetaFromState(),
				"red_sandstone");
		this.registerBlock(Blocks.red_sandstone, BlockRedSandstone.EnumType.SMOOTH.getMetaFromState(),
		...
		this.registerBlock(Blocks.stained_glass_pane, EnumDyeColor.LIGHT_BLUE.func_176765_a(),
				"light_blue_stained_glass_pane");
		this.registerBlock(Blocks.stained_glass_pane, EnumDyeColor.LIME.func_176765_a(), "lime_stained_glass_pane");
		this.registerBlock(Blocks.stained_glass_pane, EnumDyeColor.MAGENTA.func_176765_a(),
		...
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.BLACK.func_176765_a(),
				"black_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.BLUE.func_176765_a(),
				"blue_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.BROWN.func_176765_a(),
				"brown_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.CYAN.func_176765_a(),
				"cyan_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.GRAY.func_176765_a(),
				"gray_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.GREEN.func_176765_a(),
				"green_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.LIGHT_BLUE.func_176765_a(),
				"light_blue_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.LIME.func_176765_a(),
				"lime_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.MAGENTA.func_176765_a(),
				"magenta_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.ORANGE.func_176765_a(),
				"orange_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.PINK.func_176765_a(),
				"pink_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.PURPLE.func_176765_a(),
				"purple_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.RED.func_176765_a(), "red_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.SILVER.func_176765_a(),
				"silver_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.WHITE.func_176765_a(),
				"white_stained_hardened_clay");
		this.registerBlock(Blocks.stained_hardened_clay, EnumDyeColor.YELLOW.func_176765_a(),
		...
		this.registerBlock(Blocks.stonebrick, BlockStoneBrick.EnumType.CRACKED.getMetaFromState(),
				"cracked_stonebrick");
		this.registerBlock(Blocks.stonebrick, BlockStoneBrick.EnumType.DEFAULT.getMetaFromState(), "stonebrick");
		this.registerBlock(Blocks.stonebrick, BlockStoneBrick.EnumType.CHISELED.getMetaFromState(),
				"chiseled_stonebrick");
		...
		this.registerBlock(Blocks.stone_slab2, BlockStoneSlabNew.EnumType.RED_SANDSTONE.func_176915_a(),
				"red_sandstone_slab");
		...
		this.itemModelMesher.register(Items.potionitem, new ItemMeshDefinition() {
			...
			public ModelResourceLocation getModelLocation(ItemStack p_178113_1_) {
				return ItemPotion.isSplash(p_178113_1_.getMetadata())
		...
		this.registerBlock(Blocks.brown_mushroom_block, BlockHugeMushroom.EnumType.ALL_INSIDE.func_176896_a(),
				"brown_mushroom_block");
		this.registerBlock(Blocks.red_mushroom_block, BlockHugeMushroom.EnumType.ALL_INSIDE.func_176896_a(),
				"red_mushroom_block");
