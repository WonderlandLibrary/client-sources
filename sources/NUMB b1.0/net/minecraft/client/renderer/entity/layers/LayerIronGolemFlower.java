...
public class LayerIronGolemFlower implements LayerRenderer {
	...
	public void func_177153_a(EntityIronGolem p_177153_1_, float p_177153_2_, float p_177153_3_, float p_177153_4_,
			float p_177153_5_, float p_177153_6_, float p_177153_7_, float p_177153_8_) {
		if (p_177153_1_.getHoldRoseTick() != 0) {
			...
			GlStateManager.rotate(
					5.0F + 180.0F * ((ModelIronGolem) this.field_177154_a.getMainModel()).ironGolemRightArm.rotateAngleX
							/ (float) Math.PI,
					1.0F, 0.0F, 0.0F);
			...
			OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (float) var12 / 1.0F,
					(float) var13 / 1.0F);
	...
	public void doRenderLayer(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_,
		...
		this.func_177153_a((EntityIronGolem) p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_,
