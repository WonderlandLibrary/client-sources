...
import us.loki.legit.utils.ClientPhysic;
...
public class RenderEntityItem extends Render {
	...
	private int func_177077_a(EntityItem p_177077_1_, double p_177077_2_, double p_177077_4_, double p_177077_6_,
		...
		if (var11 == null) {
			...
			float var15 = MathHelper
					.sin(((float) p_177077_1_.func_174872_o() + p_177077_8_) / 10.0F + p_177077_1_.hoverStart) * 0.1F
					+ 0.1F;
			...
			if (var12 || this.renderManager.options != null && this.renderManager.options.fancyGraphics) {
				var16 = (((float) p_177077_1_.func_174872_o() + p_177077_8_) / 20.0F + p_177077_1_.hoverStart)
						* (180F / (float) Math.PI);
	...
	public void func_177075_a(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
		if (!(ModuleManager.getModuleByName("ItemPhysics").isToggled())) {
			ItemStack var10 = entity.getEntityItem();
			this.field_177079_e.setSeed(187);
			boolean var11 = false;
			if (this.bindEntityTexture(entity)) {
				this.renderManager.renderEngine.getTexture(this.func_177076_a(entity)).func_174936_b(false, false);
				var11 = true;
			}
			...
			if (var11) {
				this.renderManager.renderEngine.getTexture(this.func_177076_a(entity)).func_174935_a();
			}
