...
import us.loki.legit.modules.impl.GUI.GuiModule;
...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer {
	...
	public void func_180538_a(TileEntityChest p_180538_1_, double p_180538_2_, double p_180538_4_, double p_180538_6_,
			float p_180538_8_, int p_180538_9_) {
		int var10;
	...
	public void renderTileEntityAt(TileEntity p_180535_1_, double p_180535_2_, double p_180535_4_, double p_180535_6_,
		...
		this.func_180538_a((TileEntityChest) p_180535_1_, p_180535_2_, p_180535_4_, p_180535_6_, p_180535_8_,
				p_180535_9_);

		if (Client.instance.setmgr.getSettingByName("BooleanOption").getValBoolean()) {
			GL11.glPushMatrix();
			{
				GL11.glPushAttrib(GL11.GL_ALL_ATTRIB_BITS);
				{
					...
					this.func_180538_a((TileEntityChest) p_180535_1_, p_180535_2_, p_180535_4_, p_180535_6_,
							p_180535_8_, p_180535_9_);
				}
				GL11.glPopAttrib();
			}
			GL11.glPopMatrix();
