...
public class TileEntityPistonRenderer extends TileEntitySpecialRenderer {
	...
	public void func_178461_a(TileEntityPiston p_178461_1_, double p_178461_2_, double p_178461_4_, double p_178461_6_,
			float p_178461_8_, int p_178461_9_) {
		...
		if (var12.getMaterial() != Material.air && p_178461_1_.func_145860_a(p_178461_8_) < 1.0F) {
			...
			var14.setTranslation(
					(double) ((float) p_178461_2_ - (float) var10.getX() + p_178461_1_.func_174929_b(p_178461_8_)),
					(double) ((float) p_178461_4_ - (float) var10.getY() + p_178461_1_.func_174928_c(p_178461_8_)),
					(double) ((float) p_178461_6_ - (float) var10.getZ() + p_178461_1_.func_174926_d(p_178461_8_)));
			...
			if (var12 == Blocks.piston_head && p_178461_1_.func_145860_a(p_178461_8_) < 0.5F) {
				...
				this.field_178462_c.func_175019_b().renderBlockModel(var15,
						this.field_178462_c.getModelFromBlockState(var11, var15, var10), var11, var10, var14, true);
				...
				var17 = var17.withProperty(BlockPistonExtension.field_176327_M,
						Boolean.valueOf(p_178461_1_.func_145860_a(p_178461_8_) >= 0.5F));
				this.field_178462_c.func_175019_b().renderBlockModel(var15,
						this.field_178462_c.getModelFromBlockState(var17, var15, var10), var17, var10, var14, true);
				var14.setTranslation((double) ((float) p_178461_2_ - (float) var10.getX()),
						(double) ((float) p_178461_4_ - (float) var10.getY()),
						(double) ((float) p_178461_6_ - (float) var10.getZ()));
				var11.withProperty(BlockPistonBase.EXTENDED, Boolean.valueOf(true));
				this.field_178462_c.func_175019_b().renderBlockModel(var15,
						this.field_178462_c.getModelFromBlockState(var11, var15, var10), var11, var10, var14, true);
			} else {
				this.field_178462_c.func_175019_b().renderBlockModel(var15,
						this.field_178462_c.getModelFromBlockState(var11, var15, var10), var11, var10, var14, false);
			}
	...
	public void renderTileEntityAt(TileEntity p_180535_1_, double p_180535_2_, double p_180535_4_, double p_180535_6_,
		...
		this.func_178461_a((TileEntityPiston) p_180535_1_, p_180535_2_, p_180535_4_, p_180535_6_, p_180535_8_,
				p_180535_9_);
	}
}
