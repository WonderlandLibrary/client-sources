...
public class TextureAtlasSprite {
	...
	protected static TextureAtlasSprite func_176604_a(ResourceLocation p_176604_0_) {
		...
		return (TextureAtlasSprite) (field_176607_p.equals(var1) ? new TextureClock(var1)
	...
	public void updateAnimation() {
		...
		if (this.tickCounter >= this.animationMetadata.getFrameTimeSingle(this.frameCounter)) {
			...
			if (var1 != var3 && var3 >= 0 && var3 < this.framesTextureData.size()) {
				if (Config.isShaders()) {
					ShadersTex.uploadTexSub((int[][]) ((int[][]) this.framesTextureData.get(var3)), this.width,
							this.height, this.originX, this.originY, texBlur, texClamp);
				} else {
					TextureUtil.uploadTextureMipmap((int[][]) ((int[][]) this.framesTextureData.get(var3)), this.width,
							this.height, this.originX, this.originY, texBlur, texClamp);
				}
			}
	...
	private void func_180599_n() {
		...
		int var3 = this.animationMetadata.getFrameIndex(this.frameCounter);
		int var4 = this.animationMetadata.getFrameCount() == 0 ? this.framesTextureData.size()
				: this.animationMetadata.getFrameCount();
		...
		if (var3 != var5 && var5 >= 0 && var5 < this.framesTextureData.size()) {
			...
			for (int var8 = 0; var8 < var6.length; ++var8) {
				...
				if (var8 < var7.length && var7[var8].length == var6[var8].length) {
					for (int var9 = 0; var9 < var6[var8].length; ++var9) {
						...
						int var12 = (int) ((double) ((var10 & 16711680) >> 16) * var1
								+ (double) ((var11 & 16711680) >> 16) * (1.0D - var1));
						int var13 = (int) ((double) ((var10 & 65280) >> 8) * var1
								+ (double) ((var11 & 65280) >> 8) * (1.0D - var1));
			...
			TextureUtil.uploadTextureMipmap(this.field_176605_b, this.width, this.height, this.originX, this.originY,
					false, false);
		}
	}
	...
	public void func_180598_a(BufferedImage[] p_180598_1_, AnimationMetadataSection p_180598_2_) throws IOException {
				...
				if (var6 > 0 && (i.getWidth() != var3 >> var6 || i.getHeight() != var4 >> var6)) {
					throw new RuntimeException(
							String.format("Unable to load miplevel: %d, image is size: %dx%d, expected %dx%d",
									new Object[] { Integer.valueOf(var6), Integer.valueOf(i.getWidth()),
											Integer.valueOf(i.getHeight()), Integer.valueOf(var3 >> var6),
											Integer.valueOf(var4 >> var6) }));
				}
		...
		if (p_180598_2_ == null) {
			...
			if (p_180598_2_.getFrameCount() > 0) {
				...
				this.animationMetadata = new AnimationMetadataSection(var13, this.width, this.height,
						p_180598_2_.getFrameTime(), p_180598_2_.func_177219_e());
			}
		}
