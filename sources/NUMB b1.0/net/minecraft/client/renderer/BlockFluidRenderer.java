...
public class BlockFluidRenderer {
	...
	public boolean func_178270_a(IBlockAccess p_178270_1_, IBlockState p_178270_2_, BlockPos p_178270_3_,
			WorldRenderer p_178270_4_) {
		...
		if (!var11 && !var12 && !var13[0] && !var13[1] && !var13[2] && !var13[3]) {
			...
			if (var11) {
				...
				p_178270_4_.addVertexWithUV(var24 + 0.0D, var26 + (double) var20, var28 + 0.0D, (double) var33,
						(double) var37);
				p_178270_4_.addVertexWithUV(var24 + 0.0D, var26 + (double) var21, var28 + 1.0D, (double) var34,
						(double) var52);
				p_178270_4_.addVertexWithUV(var24 + 1.0D, var26 + (double) var22, var28 + 1.0D, (double) var35,
						(double) var53);
				p_178270_4_.addVertexWithUV(var24 + 1.0D, var26 + (double) var23, var28 + 0.0D, (double) var36,
						(double) var54);
