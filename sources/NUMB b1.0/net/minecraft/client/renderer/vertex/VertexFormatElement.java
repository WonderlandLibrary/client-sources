...
public class VertexFormatElement {
	...
	public VertexFormatElement(int p_i46096_1_, VertexFormatElement.EnumType p_i46096_2_,
			VertexFormatElement.EnumUseage p_i46096_3_, int p_i46096_4_) {
	...
	public String toString() {
		return this.field_177378_e + "," + this.field_177380_c.func_177384_a() + ","
				+ this.field_177379_b.func_177396_b();
	}
	...
	public boolean equals(Object p_equals_1_) {
		if (this == p_equals_1_) {
			...
			return this.field_177378_e != var2.field_177378_e ? false
					: (this.field_177377_d != var2.field_177377_d ? false
							: (this.field_177376_f != var2.field_177376_f ? false
									: (this.field_177379_b != var2.field_177379_b ? false
											: this.field_177380_c == var2.field_177380_c)));
		} else {
			return false;
		}
	}
	...
	public static enum EnumType {
		...
		private static final VertexFormatElement.EnumType[] $VALUES = new VertexFormatElement.EnumType[] { FLOAT, UBYTE,
	...
	public static enum EnumUseage {
		...
		private static final VertexFormatElement.EnumUseage[] $VALUES = new VertexFormatElement.EnumUseage[] { POSITION,
				NORMAL, COLOR, UV, MATRIX, BLEND_WEIGHT, PADDING };
