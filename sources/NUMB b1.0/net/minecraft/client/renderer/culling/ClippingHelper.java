...
public class ClippingHelper {
	...
	public boolean isBoxInFrustum(double p_78553_1_, double p_78553_3_, double p_78553_5_, double p_78553_7_,
		...
		for (int var13 = 0; var13 < 6; ++var13) {
			...
			if (this.dot(var14, minXf, minYf, minZf) <= 0.0F && this.dot(var14, maxXf, minYf, minZf) <= 0.0F
					&& this.dot(var14, minXf, maxYf, minZf) <= 0.0F && this.dot(var14, maxXf, maxYf, minZf) <= 0.0F
					&& this.dot(var14, minXf, minYf, maxZf) <= 0.0F && this.dot(var14, maxXf, minYf, maxZf) <= 0.0F
					&& this.dot(var14, minXf, maxYf, maxZf) <= 0.0F && this.dot(var14, maxXf, maxYf, maxZf) <= 0.0F) {
				return false;
			}
		}
