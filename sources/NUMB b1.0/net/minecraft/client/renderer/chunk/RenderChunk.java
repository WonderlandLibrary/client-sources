...
public class RenderChunk {
	...
	public void func_178570_a(float p_178570_1_, float p_178570_2_, float p_178570_3_,
		...
		if (var5.func_178487_c() != null && !var5.func_178491_b(EnumWorldBlockLayer.TRANSLUCENT)) {
			...
			this.func_178584_a(EnumWorldBlockLayer.TRANSLUCENT, p_178570_1_, p_178570_2_, p_178570_3_, worldRenderer,
					var5);
		}
	}

	public void func_178581_b(float p_178581_1_, float p_178581_2_, float p_178581_3_,
		...
		label237: {
			try {
				...
				if (this.field_178588_d != null) {
					var9 = this.createRegionRenderCache(this.field_178588_d, var7.add(-1, -1, -1), var8.add(1, 1, 1),
							1);

					if (Reflector.MinecraftForgeClient_onRebuildChunk.exists()) {
						Reflector.call(Reflector.MinecraftForgeClient_onRebuildChunk,
								new Object[] { this.field_178588_d, this.field_178586_f, var9 });
					}
		...
		if (!var9.extendedLevelsInChunkCache()) {
			...
			while (var11.hasNext()) {
				...
				for (int i = 0; i < var28.length; ++i) {
					...
					if (forgeBlockCanRenderInLayerExists) {
						boolean var16 = Reflector.callBoolean(var22, Reflector.ForgeBlock_canRenderInLayer,
								new Object[] { var24 });
			...
			for (int var27 = 0; var27 < var26; ++var27) {
				...
				if (var5.func_178492_d(var29)) {
					...
					this.func_178584_a(var29, p_178581_1_, p_178581_2_, p_178581_3_,
	...
	protected void func_178578_b() {
		...
		try {
			if (this.field_178599_i != null
					&& this.field_178599_i.func_178546_a() != ChunkCompileTaskGenerator.Status.DONE) {
	...
	public ChunkCompileTaskGenerator func_178582_e() {
		...
		try {
			...
			if (this.field_178599_i != null
					&& this.field_178599_i.func_178546_a() == ChunkCompileTaskGenerator.Status.PENDING) {
				var1 = null;
				return var1;
			}
			...
			this.field_178599_i = new ChunkCompileTaskGenerator(this,
	...
	private void func_178573_a(WorldRenderer p_178573_1_, BlockPos p_178573_2_) {
		...
		p_178573_1_.setTranslation((double) (-p_178573_2_.getX()), (double) (-p_178573_2_.getY()),
				(double) (-p_178573_2_.getZ()));
	}

	private void func_178584_a(EnumWorldBlockLayer p_178584_1_, float p_178584_2_, float p_178584_3_, float p_178584_4_,
			WorldRenderer p_178584_5_, CompiledChunk p_178584_6_) {
