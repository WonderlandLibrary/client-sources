...
public class ViewFrustum {
		...
		for (int var4 = 0; var4 < this.field_178165_d; ++var4) {
			for (int var5 = 0; var5 < this.field_178168_c; ++var5) {
				for (int var6 = 0; var6 < this.field_178166_e; ++var6) {
					...
					this.field_178164_f[var7] = p_178158_1_.func_178602_a(this.field_178167_b, this.field_178169_a,
							var8, var3++);
				}
			}
		}
		...
		for (int var8 = 0; var8 < this.field_178165_d; ++var8) {
			...
			for (int var10 = 0; var10 < this.field_178166_e; ++var10) {
				...
				for (int var12 = 0; var12 < this.field_178168_c; ++var12) {
					int var13 = var12 * 16;
					RenderChunk var14 = this.field_178164_f[(var10 * this.field_178168_c + var12) * this.field_178165_d
							+ var8];
	...
	public void func_178162_a(int p_178162_1_, int p_178162_2_, int p_178162_3_, int p_178162_4_, int p_178162_5_,
			int p_178162_6_) {
