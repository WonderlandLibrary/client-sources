...
public class ItemRenderer {
	...
	private void func_178105_d(float p_178105_1_) {
		...
		if (Client.modulemanager.getModuleByName("HitAnimation").isToggled() && this.mc.thePlayer.isSwingInProgress) {
	...
	private void func_178096_b(float p_178096_1_, float p_178096_2_) {
		if (this.mc != null && this.mc.thePlayer != null && this.mc.thePlayer.getItemInUse() != null
				&& this.mc.thePlayer.getItemInUse().getItem() != null
				&& Item.getIdFromItem(this.mc.thePlayer.getItemInUse().getItem()) == 261) {
			GlStateManager.translate(0.0F, 0.0F, -0.08F);
		}
		if (this.mc != null && this.mc.thePlayer != null && this.mc.thePlayer.getCurrentEquippedItem() != null
				&& this.mc.thePlayer.getCurrentEquippedItem().getItem() != null
				&& Item.getIdFromItem(this.mc.thePlayer.getCurrentEquippedItem().getItem()) == 346) {
