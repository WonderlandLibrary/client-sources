...
public class EntityLargeExplodeFX extends EntityFX {
	...
	protected EntityLargeExplodeFX(TextureManager p_i1213_1_, World worldIn, double p_i1213_3_, double p_i1213_5_,
	...
	public void func_180434_a(WorldRenderer p_180434_1_, Entity p_180434_2_, float p_180434_3_, float p_180434_4_,
		...
		if (var9 <= 15) {
			...
			p_180434_1_.addVertexWithUV((double) (var15 - p_180434_4_ * var14 - p_180434_7_ * var14),
					(double) (var16 - p_180434_5_ * var14),
					(double) (var17 - p_180434_6_ * var14 - p_180434_8_ * var14), (double) var11, (double) var13);
			p_180434_1_.addVertexWithUV((double) (var15 - p_180434_4_ * var14 + p_180434_7_ * var14),
					(double) (var16 + p_180434_5_ * var14),
					(double) (var17 - p_180434_6_ * var14 + p_180434_8_ * var14), (double) var11, (double) var12);
			p_180434_1_.addVertexWithUV((double) (var15 + p_180434_4_ * var14 + p_180434_7_ * var14),
					(double) (var16 + p_180434_5_ * var14),
					(double) (var17 + p_180434_6_ * var14 + p_180434_8_ * var14), (double) var10, (double) var12);
			p_180434_1_.addVertexWithUV((double) (var15 + p_180434_4_ * var14 - p_180434_7_ * var14),
					(double) (var16 - p_180434_5_ * var14),
					(double) (var17 + p_180434_6_ * var14 - p_180434_8_ * var14), (double) var10, (double) var13);
	...
	public static class Factory implements IParticleFactory {
		...
		public EntityFX func_178902_a(int p_178902_1_, World worldIn, double p_178902_3_, double p_178902_5_,
				double p_178902_7_, double p_178902_9_, double p_178902_11_, double p_178902_13_, int... p_178902_15_) {
			return new EntityLargeExplodeFX(Minecraft.getMinecraft().getTextureManager(), worldIn, p_178902_3_,
					p_178902_5_, p_178902_7_, p_178902_9_, p_178902_11_, p_178902_13_);
		}
	}
}
