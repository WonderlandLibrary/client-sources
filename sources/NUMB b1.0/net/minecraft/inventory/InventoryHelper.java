...
public class InventoryHelper {
	...
	public static void dropInventoryItems(World worldIn, BlockPos p_180175_1_, IInventory p_180175_2_) {
		func_180174_a(worldIn, (double) p_180175_1_.getX(), (double) p_180175_1_.getY(), (double) p_180175_1_.getZ(),
				p_180175_2_);
	}
	...
	private static void func_180174_a(World worldIn, double p_180174_1_, double p_180174_3_, double p_180174_5_,
	...
	private static void func_180173_a(World worldIn, double p_180173_1_, double p_180173_3_, double p_180173_5_,
		...
		while (p_180173_7_.stackSize > 0) {
			...
			EntityItem var12 = new EntityItem(worldIn, p_180173_1_ + (double) var8, p_180173_3_ + (double) var9,
					p_180173_5_ + (double) var10,
					new ItemStack(p_180173_7_.getItem(), var11, p_180173_7_.getMetadata()));
