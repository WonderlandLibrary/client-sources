...
public class ContainerRepair extends Container {
	...
	public ContainerRepair(InventoryPlayer p_i45807_1_, final World worldIn, final BlockPos p_i45807_3_,
			EntityPlayer p_i45807_4_) {
		...
		this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47) {
			...
			public void onPickupFromSlot(EntityPlayer playerIn, ItemStack stack) {
				...
				if (!playerIn.capabilities.isCreativeMode && !worldIn.isRemote && var5.getBlock() == Blocks.anvil
					...
					if (var4 > 2) {
						...
						worldIn.setBlockState(p_i45807_3_, var5.withProperty(BlockAnvil.DAMAGE, Integer.valueOf(var4)),
								2);
	...
	public void updateRepairOutput() {
		...
		if (var8 == null) {
			...
			if (var13 != null) {
				var15 = var13.getItem() == Items.enchanted_book
						&& Items.enchanted_book.func_92110_g(var13).tagCount() > 0;
				int var17;
				int var18;
				...
				if (var12.isItemStackDamageable() && var12.getItem().getIsRepairable(var8, var13)) {
					...
					while (var27.hasNext()) {
						...
						if (var28 != null) {
							var20 = var14.containsKey(Integer.valueOf(var18))
									? ((Integer) var14.get(Integer.valueOf(var18))).intValue()
									: 0;
	...
	public boolean canInteractWith(EntityPlayer playerIn) {
		return this.theWorld.getBlockState(this.field_178156_j).getBlock() != Blocks.anvil ? false
				: playerIn.getDistanceSq((double) this.field_178156_j.getX() + 0.5D,
						(double) this.field_178156_j.getY() + 0.5D,
						(double) this.field_178156_j.getZ() + 0.5D) <= 64.0D;
	}
