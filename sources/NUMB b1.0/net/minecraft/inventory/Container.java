...
public abstract class Container {
	...
	/**
	 * Handles slot click. Args : slotId, clickedButton, mode (0 = basic click, 1 =
	 * shift click, 2 = Hotbar, 3 = pickBlock, 4 = Drop, 5 = ?, 6 = Double click),
	 * player
	 */
	public ItemStack slotClick(int slotId, int clickedButton, int mode, EntityPlayer playerIn) {
		...
		if (mode == 5) {
			...
			if ((var7 != 1 || this.dragEvent != 2) && var7 != this.dragEvent) {
				...
				if (var8 != null && canAddItemToSlot(var8, var6.getItemStack(), true)
						&& var8.isItemValid(var6.getItemStack())
						&& var6.getItemStack().stackSize > this.dragSlots.size() && this.canDragIntoSlot(var8)) {
				...
				if (!this.dragSlots.isEmpty()) {
					...
					while (var10.hasNext()) {
						...
						if (var11 != null && canAddItemToSlot(var11, var6.getItemStack(), true)
					...
					if (var16 != null) {
						...
						if (var17 == null) {
							...
							if (var20 == null) {
								...
								if (var17.getItem() == var20.getItem() && var17.getMetadata() == var20.getMetadata()
									...
									&& (!var17.getHasSubtypes() || var17.getMetadata() == var20.getMetadata())
									&& ItemStack.areItemStackTagsEqual(var17, var20)) {
			...
			} else if (mode == 3 && playerIn.capabilities.isCreativeMode && var6.getItemStack() == null
					&& slotId >= 0) {
				var16 = (Slot) this.inventorySlots.get(slotId);
				...
				if (var17 != null && (var16 == null || !var16.getHasStack() || !var16.canTakeStack(playerIn))) {
					...
					for (int var22 = 0; var22 < 2; ++var22) {
						for (int var24 = var9; var24 >= 0 && var24 < this.inventorySlots.size()
							...
							if (var25.getHasStack() && canAddItemToSlot(var25, var17, true)
									&& var25.canTakeStack(playerIn) && this.func_94530_a(var17, var25) && (var22 != 0
	...
	protected boolean mergeItemStack(ItemStack stack, int startIndex, int endIndex, boolean useEndIndex) {
		...
		if (stack.isStackable()) {
			while (stack.stackSize > 0 && (!useEndIndex && var6 < endIndex || useEndIndex && var6 >= startIndex)) {
				...
				if (var8 != null && var8.getItem() == stack.getItem()
						&& (!stack.getHasSubtypes() || stack.getMetadata() == var8.getMetadata())
						&& ItemStack.areItemStackTagsEqual(stack, var8)) {
	...
	public static boolean func_180610_a(int p_180610_0_, EntityPlayer p_180610_1_) {
		return p_180610_0_ == 0 ? true
				: (p_180610_0_ == 1 ? true : p_180610_0_ == 2 && p_180610_1_.capabilities.isCreativeMode);
	}
			...
			for (int var3 = 0; var3 < inv.getSizeInventory(); ++var3) {
				...
				if (var4 != null) {
					var2 += (float) var4.stackSize
							/ (float) Math.min(inv.getInventoryStackLimit(), var4.getMaxStackSize());
					++var1;
				}
			}
