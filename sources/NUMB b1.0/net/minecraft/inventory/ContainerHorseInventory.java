...
public class ContainerHorseInventory extends Container {
	...
	public ContainerHorseInventory(IInventory p_i45791_1_, final IInventory p_i45791_2_, final EntityHorse p_i45791_3_,
			EntityPlayer p_i45791_4_) {
		...
		this.addSlotToContainer(new Slot(p_i45791_2_, 1, 8, 36) {
			...
			public boolean isItemValid(ItemStack stack) {
				return super.isItemValid(stack) && p_i45791_3_.canWearArmor()
						&& EntityHorse.func_146085_a(stack.getItem());
			}
		...
		for (var7 = 0; var7 < 3; ++var7) {
			for (var8 = 0; var8 < 9; ++var8) {
				this.addSlotToContainer(
						new Slot(p_i45791_1_, var8 + var7 * 9 + 9, 8 + var8 * 18, 102 + var7 * 18 + var6));
			}
		}
	...
	public boolean canInteractWith(EntityPlayer playerIn) {
		return this.field_111243_a.isUseableByPlayer(playerIn) && this.theHorse.isEntityAlive()
