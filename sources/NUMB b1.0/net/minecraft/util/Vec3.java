...
public class Vec3 {
	...
	public Vec3 normalize() {
		...
		return var1 < 1.0E-4D ? new Vec3(0.0D, 0.0D, 0.0D)
				: new Vec3(this.xCoord / var1, this.yCoord / var1, this.zCoord / var1);
	}
	...
	public Vec3 getIntermediateWithXValue(Vec3 vec, double x) {
		...
		if (var4 * var4 < 1.0000000116860974E-7D) {
			...
			return var10 >= 0.0D && var10 <= 1.0D
					? new Vec3(this.xCoord + var4 * var10, this.yCoord + var6 * var10, this.zCoord + var8 * var10)
					: null;
		}
	}
