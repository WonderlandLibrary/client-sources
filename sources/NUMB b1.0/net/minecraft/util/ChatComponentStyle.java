...
public abstract class ChatComponentStyle implements IChatComponent {
	 ...
	 * that will apply to all the siblings until a later sibling turns the text
	 * something else.
	 */
	 ...
	 * copies of each component in turn so that the properties of the returned
	 * objects will remain externally consistent after being returned.
	 */
