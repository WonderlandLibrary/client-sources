...
public class BlockVine extends Block {
	...
	public BlockVine() {
		super(Material.vine);
		this.setDefaultState(this.blockState.getBaseState().withProperty(field_176277_a, Boolean.valueOf(false))
				.withProperty(field_176273_b, Boolean.valueOf(false))
				.withProperty(field_176278_M, Boolean.valueOf(false))
				.withProperty(field_176279_N, Boolean.valueOf(false))
				.withProperty(field_176280_O, Boolean.valueOf(false)));
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		return state.withProperty(field_176277_a,
				Boolean.valueOf(worldIn.getBlockState(pos.offsetUp()).getBlock().isSolidFullCube()));
	}
	...
	private boolean func_176269_e(World worldIn, BlockPos p_176269_2_, IBlockState p_176269_3_) {
		...
		while (var5.hasNext()) {
			...
			if (((Boolean) p_176269_3_.getValue(var7)).booleanValue()
					&& !this.func_150093_a(worldIn.getBlockState(p_176269_2_.offset(var6)).getBlock())) {
			...
			if (worldIn.rand.nextInt(4) == 0) {
				...
				if (var17 == EnumFacing.UP && pos.getY() < 255 && worldIn.isAirBlock(pos.offsetUp())) {
					if (!var7) {
						...
						if (((Boolean) var19.getValue(field_176273_b)).booleanValue()
								|| ((Boolean) var19.getValue(field_176278_M)).booleanValue()
								|| ((Boolean) var19.getValue(field_176279_N)).booleanValue()
								|| ((Boolean) var19.getValue(field_176280_O)).booleanValue()) {
					...
					if (var17.getAxis().isHorizontal()
							&& !((Boolean) state.getValue(func_176267_a(var17))).booleanValue()) {
						if (!var7) {
							...
							if (var21.blockMaterial == Material.air) {
								...
								if (var25 && this.func_150093_a(worldIn.getBlockState(var27).getBlock())) {
									worldIn.setBlockState(var18, this.getDefaultState()
											.withProperty(func_176267_a(var23), Boolean.valueOf(true)), 2);
								} else if (var26 && this.func_150093_a(worldIn.getBlockState(var16).getBlock())) {
									worldIn.setBlockState(var18, this.getDefaultState()
											.withProperty(func_176267_a(var24), Boolean.valueOf(true)), 2);
								} else if (var25 && worldIn.isAirBlock(var27)
										&& this.func_150093_a(worldIn.getBlockState(pos.offset(var23)).getBlock())) {
									worldIn.setBlockState(var27, this.getDefaultState().withProperty(
											func_176267_a(var17.getOpposite()), Boolean.valueOf(true)), 2);
								} else if (var26 && worldIn.isAirBlock(var16)
										&& this.func_150093_a(worldIn.getBlockState(pos.offset(var24)).getBlock())) {
									worldIn.setBlockState(var16, this.getDefaultState().withProperty(
											func_176267_a(var17.getOpposite()), Boolean.valueOf(true)), 2);
								...
								worldIn.setBlockState(pos,
										state.withProperty(func_176267_a(var17), Boolean.valueOf(true)), 2);
							}
						}
					} else {
						if (pos.getY() > 1) {
							...
							if (var11.blockMaterial == Material.air) {
								...
								if (((Boolean) var12.getValue(field_176273_b)).booleanValue()
										|| ((Boolean) var12.getValue(field_176278_M)).booleanValue()
										|| ((Boolean) var12.getValue(field_176279_N)).booleanValue()
										|| ((Boolean) var12.getValue(field_176280_O)).booleanValue()) {
	...
	public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ,
		...
		IBlockState var9 = this.getDefaultState().withProperty(field_176277_a, Boolean.valueOf(false))
				.withProperty(field_176273_b, Boolean.valueOf(false))
				.withProperty(field_176278_M, Boolean.valueOf(false))
				.withProperty(field_176279_N, Boolean.valueOf(false))
				.withProperty(field_176280_O, Boolean.valueOf(false));
		return facing.getAxis().isHorizontal()
				? var9.withProperty(func_176267_a(facing.getOpposite()), Boolean.valueOf(true))
				: var9;
	}
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(field_176273_b, Boolean.valueOf((meta & field_176276_R) > 0))
				.withProperty(field_176278_M, Boolean.valueOf((meta & field_176275_S) > 0))
				.withProperty(field_176279_N, Boolean.valueOf((meta & field_176272_Q) > 0))
				.withProperty(field_176280_O, Boolean.valueOf((meta & field_176271_T) > 0));
	}
