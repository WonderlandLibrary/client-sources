...
public class BlockSapling extends BlockBush implements IGrowable {
	...
	protected BlockSapling() {
		this.setDefaultState(this.blockState.getBaseState().withProperty(TYPE_PROP, BlockPlanks.EnumType.OAK)
				.withProperty(STAGE_PROP, Integer.valueOf(0)));
		float var1 = 0.4F;
	...
	public void func_176476_e(World worldIn, BlockPos p_176476_2_, IBlockState p_176476_3_, Random p_176476_4_) {
		...
		case 1:
			label78: for (var6 = 0; var6 >= -1; --var6) {
				for (var7 = 0; var7 >= -1; --var7) {
					if (this.func_176477_a(worldIn, p_176476_2_.add(var6, 0, var7), BlockPlanks.EnumType.SPRUCE)
							&& this.func_176477_a(worldIn, p_176476_2_.add(var6 + 1, 0, var7),
									BlockPlanks.EnumType.SPRUCE)
							&& this.func_176477_a(worldIn, p_176476_2_.add(var6, 0, var7 + 1),
									BlockPlanks.EnumType.SPRUCE)
							&& this.func_176477_a(worldIn, p_176476_2_.add(var6 + 1, 0, var7 + 1),
									BlockPlanks.EnumType.SPRUCE)) {
		...
		case 3:
			label93: for (var6 = 0; var6 >= -1; --var6) {
				for (var7 = 0; var7 >= -1; --var7) {
					if (this.func_176477_a(worldIn, p_176476_2_.add(var6, 0, var7), BlockPlanks.EnumType.JUNGLE)
							&& this.func_176477_a(worldIn, p_176476_2_.add(var6 + 1, 0, var7),
			...
			if (!var8) {
				var7 = 0;
				var6 = 0;
				var5 = new WorldGenTrees(true, 4 + p_176476_4_.nextInt(7), BlockPlanks.EnumType.JUNGLE.func_176839_a(),
						BlockPlanks.EnumType.JUNGLE.func_176839_a(), false);
			}
		...
		case 5:
			label108: for (var6 = 0; var6 >= -1; --var6) {
				for (var7 = 0; var7 >= -1; --var7) {
					if (this.func_176477_a(worldIn, p_176476_2_.add(var6, 0, var7), BlockPlanks.EnumType.DARK_OAK)
							&& this.func_176477_a(worldIn, p_176476_2_.add(var6 + 1, 0, var7),
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(TYPE_PROP, BlockPlanks.EnumType.func_176837_a(meta & 7))
				.withProperty(STAGE_PROP, Integer.valueOf((meta & 8) >> 3));
	}
