...
public class BlockDoublePlant extends BlockBush implements IGrowable {
	...
	public BlockDoublePlant() {
		...
		this.setDefaultState(
				this.blockState.getBaseState().withProperty(VARIANT_PROP, BlockDoublePlant.EnumPlantType.SUNFLOWER)
	...
	public boolean isReplaceable(World worldIn, BlockPos pos) {
		...
		if (var3.getBlock() != this) {
			...
			BlockDoublePlant.EnumPlantType var4 = (BlockDoublePlant.EnumPlantType) this
					.getActualState(var3, worldIn, pos).getValue(VARIANT_PROP);
	...
	public void func_176491_a(World worldIn, BlockPos p_176491_2_, BlockDoublePlant.EnumPlantType p_176491_3_,
			int p_176491_4_) {
		worldIn.setBlockState(p_176491_2_, this.getDefaultState()
		...
		worldIn.setBlockState(p_176491_2_.offsetUp(),
				this.getDefaultState().withProperty(HALF_PROP, BlockDoublePlant.EnumBlockHalf.UPPER), p_176491_4_);
	}

	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
			ItemStack stack) {
		worldIn.setBlockState(pos.offsetUp(),
				this.getDefaultState().withProperty(HALF_PROP, BlockDoublePlant.EnumBlockHalf.UPPER), 2);
	}
	...
	public void harvestBlock(World worldIn, EntityPlayer playerIn, BlockPos pos, IBlockState state, TileEntity te) {
		if (worldIn.isRemote || playerIn.getCurrentEquippedItem() == null
				...
				|| !this.func_176489_b(worldIn, pos, state, playerIn)) {
	...
	private boolean func_176489_b(World worldIn, BlockPos p_176489_2_, IBlockState p_176489_3_,
			EntityPlayer p_176489_4_) {
		...
		if (var5 != BlockDoublePlant.EnumPlantType.FERN && var5 != BlockDoublePlant.EnumPlantType.GRASS) {
			...
			int var6 = (var5 == BlockDoublePlant.EnumPlantType.GRASS ? BlockTallGrass.EnumType.GRASS
	...
	public void grow(World worldIn, Random p_176474_2_, BlockPos p_176474_3_, IBlockState p_176474_4_) {
		spawnAsEntity(worldIn, p_176474_3_,
				new ItemStack(this, 1, this.func_176490_e(worldIn, p_176474_3_).func_176936_a()));
	}
	...
	public IBlockState getStateFromMeta(int meta) {
		return (meta & 8) > 0 ? this.getDefaultState().withProperty(HALF_PROP, BlockDoublePlant.EnumBlockHalf.UPPER)
				: this.getDefaultState().withProperty(HALF_PROP, BlockDoublePlant.EnumBlockHalf.LOWER)
	...
	static enum EnumBlockHalf implements IStringSerializable {
		...
		private static final BlockDoublePlant.EnumBlockHalf[] $VALUES = new BlockDoublePlant.EnumBlockHalf[] { UPPER,
				LOWER };
	...
	public static enum EnumPlantType implements IStringSerializable {
		...
		private static final BlockDoublePlant.EnumPlantType[] $VALUES = new BlockDoublePlant.EnumPlantType[] {
		...
		private EnumPlantType(String p_i45723_1_, int p_i45723_2_, int p_i45723_3_, String p_i45723_4_,
				String p_i45723_5_) {
