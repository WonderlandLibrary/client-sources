...
public class BlockBed extends BlockDirectional {
	...
	public BlockBed() {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(PART_PROP, BlockBed.EnumPartType.FOOT)
				.withProperty(OCCUPIED_PROP, Boolean.valueOf(false)));
		this.setBedBounds();
	}
	...
	public IBlockState getStateFromMeta(int meta) {
		...
		return (meta & 8) > 0
				? this.getDefaultState().withProperty(PART_PROP, BlockBed.EnumPartType.HEAD).withProperty(AGE, var2)
						.withProperty(OCCUPIED_PROP, Boolean.valueOf((meta & 4) > 0))
				: this.getDefaultState().withProperty(PART_PROP, BlockBed.EnumPartType.FOOT).withProperty(AGE, var2);
	}
