...
public class BlockPistonExtension extends Block {
	...
	public BlockPistonExtension() {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(field_176326_a, EnumFacing.NORTH)
				.withProperty(field_176325_b, BlockPistonExtension.EnumPistonType.DEFAULT)
				.withProperty(field_176327_M, Boolean.valueOf(false)));
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(field_176326_a, func_176322_b(meta)).withProperty(field_176325_b,
	...
	public static enum EnumPistonType implements IStringSerializable {
		...
		private static final BlockPistonExtension.EnumPistonType[] $VALUES = new BlockPistonExtension.EnumPistonType[] {
				DEFAULT, STICKY };
