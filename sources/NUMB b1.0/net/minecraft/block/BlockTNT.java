...
public class BlockTNT extends Block {
	...
	public void onBlockDestroyedByExplosion(World worldIn, BlockPos pos, Explosion explosionIn) {
		if (!worldIn.isRemote) {
			EntityTNTPrimed var4 = new EntityTNTPrimed(worldIn, (double) ((float) pos.getX() + 0.5F),
	...
	public void func_180692_a(World worldIn, BlockPos p_180692_2_, IBlockState p_180692_3_,
			EntityLivingBase p_180692_4_) {
		if (!worldIn.isRemote) {
			if (((Boolean) p_180692_3_.getValue(field_176246_a)).booleanValue()) {
				EntityTNTPrimed var5 = new EntityTNTPrimed(worldIn, (double) ((float) p_180692_2_.getX() + 0.5F),
						(double) ((float) p_180692_2_.getY() + 0.5F), (double) ((float) p_180692_2_.getZ() + 0.5F),
						p_180692_4_);
	...
	public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
		if (!worldIn.isRemote && entityIn instanceof EntityArrow) {
			...
			if (var5.isBurning()) {
				this.func_180692_a(worldIn, pos,
						worldIn.getBlockState(pos).withProperty(field_176246_a, Boolean.valueOf(true)),
