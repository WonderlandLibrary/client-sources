...
public class BlockSilverfish extends Block {
	...
	public void dropBlockAsItemWithChance(World worldIn, BlockPos pos, IBlockState state, float chance, int fortune) {
		if (!worldIn.isRemote && worldIn.getGameRules().getGameRuleBooleanValue("doTileDrops")) {
			...
			var6.setLocationAndAngles((double) pos.getX() + 0.5D, (double) pos.getY(), (double) pos.getZ() + 0.5D, 0.0F,
					0.0F);
	...
	public static enum EnumType implements IStringSerializable {
		...
		private static final BlockSilverfish.EnumType[] $VALUES = new BlockSilverfish.EnumType[] { STONE, COBBLESTONE,
		...
		EnumType(String p_i45706_1_, int p_i45706_2_, int p_i45706_3_, String p_i45706_4_,
				BlockSilverfish.SwitchEnumType p_i45706_5_) {
			this(p_i45706_1_, p_i45706_2_, p_i45706_3_, p_i45706_4_);
		}

		EnumType(String p_i45707_1_, int p_i45707_2_, int p_i45707_3_, String p_i45707_4_, String p_i45707_5_,
				BlockSilverfish.SwitchEnumType p_i45707_6_) {
