...
public class BlockFlowerPot extends BlockContainer {
	...
	public BlockFlowerPot() {
		...
		this.setDefaultState(
				this.blockState.getBaseState().withProperty(field_176443_b, BlockFlowerPot.EnumFlowerType.EMPTY)
						.withProperty(field_176444_a, Integer.valueOf(0)));
	...
	public static enum EnumFlowerType implements IStringSerializable {
		...
		private static final BlockFlowerPot.EnumFlowerType[] $VALUES = new BlockFlowerPot.EnumFlowerType[] { EMPTY,
				POPPY, BLUE_ORCHID, ALLIUM, HOUSTONIA, RED_TULIP, ORANGE_TULIP, WHITE_TULIP, PINK_TULIP, OXEYE_DAISY,
				DANDELION, OAK_SAPLING, SPRUCE_SAPLING, BIRCH_SAPLING, JUNGLE_SAPLING, ACACIA_SAPLING, DARK_OAK_SAPLING,
