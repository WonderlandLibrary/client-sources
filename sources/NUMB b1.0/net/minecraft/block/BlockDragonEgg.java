	...
	private void func_180683_d(World worldIn, BlockPos p_180683_2_) {
		if (BlockFalling.canFallInto(worldIn, p_180683_2_.offsetDown()) && p_180683_2_.getY() >= 0) {
			...
			if (!BlockFalling.fallInstantly
				...
				worldIn.spawnEntityInWorld(new EntityFallingBlock(worldIn, (double) ((float) p_180683_2_.getX() + 0.5F),
						(double) p_180683_2_.getY(), (double) ((float) p_180683_2_.getZ() + 0.5F),
	...
	private void func_180684_e(World worldIn, BlockPos p_180684_2_) {
		...
		if (var3.getBlock() == this) {
			for (int var4 = 0; var4 < 1000; ++var4) {
				BlockPos var5 = p_180684_2_.add(worldIn.rand.nextInt(16) - worldIn.rand.nextInt(16),
				...
				if (worldIn.getBlockState(var5).getBlock().blockMaterial == Material.air) {
					if (worldIn.isRemote) {
						for (int var6 = 0; var6 < 128; ++var6) {
							...
							double var12 = (double) var5.getX() + (double) (p_180684_2_.getX() - var5.getX()) * var7
									+ (worldIn.rand.nextDouble() - 0.5D) * 1.0D + 0.5D;
							double var14 = (double) var5.getY() + (double) (p_180684_2_.getY() - var5.getY()) * var7
									+ worldIn.rand.nextDouble() * 1.0D - 0.5D;
							double var16 = (double) var5.getZ() + (double) (p_180684_2_.getZ() - var5.getZ()) * var7
									+ (worldIn.rand.nextDouble() - 0.5D) * 1.0D + 0.5D;
							worldIn.spawnParticle(EnumParticleTypes.PORTAL, var12, var14, var16, (double) var9,
									(double) var10, (double) var11, new int[0]);
						}
					} else {
