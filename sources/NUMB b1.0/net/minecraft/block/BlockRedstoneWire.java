...
public class BlockRedstoneWire extends Block {
	...
	private BlockRedstoneWire.EnumAttachPosition getAttachPosition(IBlockAccess p_176341_1_, BlockPos p_176341_2_,
			EnumFacing p_176341_3_) {
	...
	public int colorMultiplier(IBlockAccess worldIn, BlockPos pos, int renderPass) {
		...
		return var4.getBlock() != this ? super.colorMultiplier(worldIn, pos, renderPass)
				: this.func_176337_b(((Integer) var4.getValue(POWER)).intValue());
	}
	...
	private IBlockState func_176345_a(World worldIn, BlockPos p_176345_2_, BlockPos p_176345_3_,
	...
	private boolean func_176339_d(IBlockAccess p_176339_1_, BlockPos p_176339_2_, EnumFacing p_176339_3_) {
		...
		return !var8 && var7 && func_176340_e(p_176339_1_, var4.offsetUp()) ? true
				: (func_176343_a(var5, p_176339_3_) ? true
						: (var6 == Blocks.powered_repeater && var5.getValue(BlockRedstoneDiode.AGE) == p_176339_3_
								? true
	...
	public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		if (var5 != 0) {
			...
			worldIn.spawnParticle(EnumParticleTypes.REDSTONE, var6, var8, var10, (double) var13, (double) var14,
					(double) var15, new int[0]);
		}
	}
	...
	static enum EnumAttachPosition implements IStringSerializable {
		...
		private static final BlockRedstoneWire.EnumAttachPosition[] $VALUES = new BlockRedstoneWire.EnumAttachPosition[] {
				UP, SIDE, NONE };
