...
public class BlockSandStone extends Block {
	...
	public BlockSandStone() {
		...
		this.setDefaultState(
				this.blockState.getBaseState().withProperty(field_176297_a, BlockSandStone.EnumType.DEFAULT));
	...
	public static enum EnumType implements IStringSerializable {
		...
		private static final BlockSandStone.EnumType[] $VALUES = new BlockSandStone.EnumType[] { DEFAULT, CHISELED,
				SMOOTH };
