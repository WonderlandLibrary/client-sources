...
public class BlockStem extends BlockBush implements IGrowable {
	...
	protected BlockStem(Block p_i45430_1_) {
		this.setDefaultState(this.blockState.getBaseState().withProperty(AGE_PROP, Integer.valueOf(0))
				.withProperty(FACING_PROP, EnumFacing.UP));
	...
	public void growStem(World worldIn, BlockPos p_176482_2_, IBlockState p_176482_3_) {
		int var4 = ((Integer) p_176482_3_.getValue(AGE_PROP)).intValue()
	...
	public void setBlockBoundsBasedOnState(IBlockAccess access, BlockPos pos) {
		this.maxY = (double) ((float) (((Integer) access.getBlockState(pos).getValue(AGE_PROP)).intValue() * 2 + 2)
				/ 16.0F);
		float var3 = 0.125F;
	...
	protected Item getSeedItem() {
		return this.cropBlock == Blocks.pumpkin ? Items.pumpkin_seeds
				: (this.cropBlock == Blocks.melon_block ? Items.melon_seeds : null);
	}
