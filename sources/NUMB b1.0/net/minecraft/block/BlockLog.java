		...
		if (worldIn.isAreaLoaded(pos.add(-var5, -var5, -var5), pos.add(var5, var5, var5))) {
			...
			while (var6.hasNext()) {
				...
				if (var8.getBlock().getMaterial() == Material.leaves
						&& !((Boolean) var8.getValue(BlockLeaves.field_176236_b)).booleanValue()) {
					worldIn.setBlockState(var7, var8.withProperty(BlockLeaves.field_176236_b, Boolean.valueOf(true)),
							4);
				}
			}
		}
