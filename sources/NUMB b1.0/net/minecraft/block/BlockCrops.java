...
public class BlockCrops extends BlockBush implements IGrowable {
	...
	public void growCrops(World worldIn, BlockPos p_176487_2_, IBlockState p_176487_3_) {
		int var4 = ((Integer) p_176487_3_.getValue(AGE)).intValue()
	...
	protected static float getGrowthChance(Block p_180672_0_, World worldIn, BlockPos p_180672_2_) {
		...
		boolean var9 = p_180672_0_ == worldIn.getBlockState(var14).getBlock()
				|| p_180672_0_ == worldIn.getBlockState(var15).getBlock();
		boolean var10 = p_180672_0_ == worldIn.getBlockState(var12).getBlock()
				|| p_180672_0_ == worldIn.getBlockState(var13).getBlock();

		if (var9 && var10) {
			var3 /= 2.0F;
		} else {
			boolean var11 = p_180672_0_ == worldIn.getBlockState(var14.offsetNorth()).getBlock()
	...
	public boolean canBlockStay(World worldIn, BlockPos p_180671_2_, IBlockState p_180671_3_) {
		return (worldIn.getLight(p_180671_2_) >= 8 || worldIn.isAgainstSky(p_180671_2_))
				&& this.canPlaceBlockOn(worldIn.getBlockState(p_180671_2_.offsetDown()).getBlock());
	}
