...
public class BlockStairs extends Block {
	...
	public void setBlockBoundsBasedOnState(IBlockAccess access, BlockPos pos) {
		if (this.field_150152_N) {
			this.setBlockBounds(0.5F * (float) (this.field_150153_O % 2), 0.5F * (float) (this.field_150153_O / 4 % 2),
					0.5F * (float) (this.field_150153_O / 2 % 2), 0.5F + 0.5F * (float) (this.field_150153_O % 2),
	...
	public IBlockState getStateFromMeta(int meta) {
		IBlockState var2 = this.getDefaultState().withProperty(HALF,
	...
	public static enum EnumShape implements IStringSerializable {
		...
		private static final BlockStairs.EnumShape[] $VALUES = new BlockStairs.EnumShape[] { STRAIGHT, INNER_LEFT,
