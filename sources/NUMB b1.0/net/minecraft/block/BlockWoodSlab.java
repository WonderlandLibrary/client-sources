...
public abstract class BlockWoodSlab extends BlockSlab {
	...
	public IBlockState getStateFromMeta(int meta) {
		IBlockState var2 = this.getDefaultState().withProperty(field_176557_b,
				BlockPlanks.EnumType.func_176837_a(meta & 7));
	...
	protected BlockState createBlockState() {
		return this.isDouble() ? new BlockState(this, new IProperty[] { field_176557_b })
