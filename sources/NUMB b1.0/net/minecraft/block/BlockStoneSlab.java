...
public abstract class BlockStoneSlab extends BlockSlab {
	...
	public IBlockState getStateFromMeta(int meta) {
		IBlockState var2 = this.getDefaultState().withProperty(field_176556_M,
	...
	protected BlockState createBlockState() {
		return this.isDouble() ? new BlockState(this, new IProperty[] { field_176555_b, field_176556_M })
	...
	public static enum EnumType implements IStringSerializable {
		...
		private static final BlockStoneSlab.EnumType[] $VALUES = new BlockStoneSlab.EnumType[] { STONE, SAND, WOOD,
				COBBLESTONE, BRICK, SMOOTHBRICK, NETHERBRICK, QUARTZ };
