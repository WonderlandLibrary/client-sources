		...
		if (args.length < 9) {
			...
			if (var8 > 32768) {
				throw new CommandException("commands.clone.tooManyBlocks",
						new Object[] { Integer.valueOf(var8), Integer.valueOf(32768) });
			} else {
				boolean var9 = false;
				Block var10 = null;
				int var11 = -1;
				...
				if ((args.length < 11 || !args[10].equals("force") && !args[10].equals("move"))
					...
					if (var6.minY >= 0 && var6.maxY < 256 && var7.minY >= 0 && var7.maxY < 256) {
						...
						if (var12.isAreaLoaded(var6) && var12.isAreaLoaded(var7)) {
							...
							BlockPos var18 = new BlockPos(var7.minX - var6.minX, var7.minY - var6.minY,
									var7.minZ - var6.minZ);
								...
								for (int var20 = var6.minY; var20 <= var6.maxY; ++var20) {
									for (int var21 = var6.minX; var21 <= var6.maxX; ++var21) {
										...
										if ((!var13 || var24.getBlock() != Blocks.air)
												&& (var10 == null || var24.getBlock() == var10 && (var11 < 0
														|| var24.getBlock().getMetaFromState(var24) == var11))) {
											...
											if (var25 != null) {
												...
												var17.addLast(var22);
											} else if (!var24.getBlock().isFullBlock()
													&& !var24.getBlock().isFullCube()) {
												var16.add(new CommandClone.StaticCloneData(var23, var24,
														(NBTTagCompound) null));
												var17.addFirst(var22);
											} else {
												var14.add(new CommandClone.StaticCloneData(var23, var24,
														(NBTTagCompound) null));
												var17.addLast(var22);
											}
										}
							...
							if (var9) {
								...
								for (var27 = var17.iterator(); var27.hasNext(); var12.setBlockState(var29,
							...
							for (var32 = var30.iterator(); var32.hasNext(); var12.setBlockState(var34.field_179537_a,
									Blocks.barrier.getDefaultState(), 2)) {
							...
							for (var32 = var15.iterator(); var32.hasNext(); var12.setBlockState(var34.field_179537_a,
									var34.field_179535_b, 2)) {
								var34 = (CommandClone.StaticCloneData) var32.next();
								var36 = var12.getTileEntity(var34.field_179537_a);
							...
							if (var33 != null) {
								...
								while (var35.hasNext()) {
									...
									if (var6.func_175898_b(var37.field_180282_a)) {
										...
										var12.func_180497_b(var38, var37.func_151351_a(),
												(int) (var37.scheduledTime - var12.getWorldInfo().getWorldTotalTime()),
												var37.priority);
									}
								}
							}
							...
							if (var8 <= 0) {
								...
								notifyOperators(sender, this, "commands.clone.success",
										new Object[] { Integer.valueOf(var8) });
							}
						} else {
