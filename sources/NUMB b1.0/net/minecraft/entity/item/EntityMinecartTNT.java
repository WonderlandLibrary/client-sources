...
public class EntityMinecartTNT extends EntityMinecart {
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		...
		if (var3 instanceof EntityArrow) {
			...
			if (var4.isBurning()) {
				this.explodeCart(
						var4.motionX * var4.motionX + var4.motionY * var4.motionY + var4.motionZ * var4.motionZ);
			}
		}
	...
	public float getExplosionResistance(Explosion p_180428_1_, World worldIn, BlockPos p_180428_3_,
		...
		return this.isIgnited() && (BlockRailBase.func_176563_d(p_180428_4_)
	...
	public boolean func_174816_a(Explosion p_174816_1_, World worldIn, BlockPos p_174816_3_, IBlockState p_174816_4_,
			float p_174816_5_) {
		return this.isIgnited() && (BlockRailBase.func_176563_d(p_174816_4_)
