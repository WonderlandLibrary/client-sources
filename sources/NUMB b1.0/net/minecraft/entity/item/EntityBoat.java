...
public class EntityBoat extends Entity {
	...
	public void onUpdate() {
		...
		for (int var4 = 0; var4 < var1; ++var4) {
			double var5 = this.getEntityBoundingBox().minY
					+ (this.getEntityBoundingBox().maxY - this.getEntityBoundingBox().minY) * (double) (var4 + 0)
							/ (double) var1
					- 0.125D;
			double var7 = this.getEntityBoundingBox().minY
					+ (this.getEntityBoundingBox().maxY - this.getEntityBoundingBox().minY) * (double) (var4 + 1)
							/ (double) var1
					- 0.125D;
			AxisAlignedBB var9 = new AxisAlignedBB(this.getEntityBoundingBox().minX, var5,
					this.getEntityBoundingBox().minZ, this.getEntityBoundingBox().maxX, var7,
		...
		if (var19 > 0.2975D) {
			...
			for (var10 = 0; (double) var10 < 1.0D + var19 * 60.0D; ++var10) {
				...
				if (this.rand.nextBoolean()) {
					...
					this.worldObj.spawnParticle(EnumParticleTypes.WATER_SPLASH, var15, this.posY - 0.125D, var17,
	...
	protected void func_180433_a(double p_180433_1_, boolean p_180433_3_, Block p_180433_4_, BlockPos p_180433_5_) {
		...
		} else if (this.worldObj.getBlockState((new BlockPos(this)).offsetDown()).getBlock()
				.getMaterial() != Material.water && p_180433_1_ < 0.0D) {
