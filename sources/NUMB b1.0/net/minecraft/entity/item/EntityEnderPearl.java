	...
	protected void onImpact(MovingObjectPosition p_70184_1_) {
		...
		if (!this.worldObj.isRemote) {
			if (var2 instanceof EntityPlayerMP) {
				...
				if (var5.playerNetServerHandler.getNetworkManager().isChannelOpen() && var5.worldObj == this.worldObj
						&& !var5.isPlayerSleeping()) {
					if (this.rand.nextFloat() < 0.05F
							&& this.worldObj.getGameRules().getGameRuleBooleanValue("doMobSpawning")) {
