...
public abstract class EntityLiving extends EntityLivingBase {
			...
			for (int var1 = 0; var1 < 20; ++var1) {
				...
				this.worldObj.spawnParticle(EnumParticleTypes.EXPLOSION_NORMAL,
						this.posX + (double) (this.rand.nextFloat() * this.width * 2.0F) - (double) this.width
								- var2 * var8,
						this.posY + (double) (this.rand.nextFloat() * this.height) - var4 * var8,
				...
				if (var3 == 0) {
					if (var2.getItem() instanceof ItemSword && !(var5.getItem() instanceof ItemSword)) {
						...
						if (var9.func_150931_i() == var10.func_150931_i()) {
							var4 = var2.getMetadata() > var5.getMetadata()
									|| var2.hasTagCompound() && !var5.hasTagCompound();
						} else {
	...
	protected void dropEquipment(boolean p_82160_1_, int p_82160_2_) {
		for (int var3 = 0; var3 < this.getInventory().length; ++var3) {
			...
			if (var4 != null && (p_82160_1_ || var5)
					&& this.rand.nextFloat() - (float) p_82160_2_ * 0.01F < this.equipmentDropChances[var3]) {
	...
	protected void func_180483_b(DifficultyInstance p_180483_1_) {
		...
		if (this.getHeldItem() != null && this.rand.nextFloat() < 0.25F * var2) {
			EnchantmentHelper.addRandomEnchantment(this.rand, this.getHeldItem(),
					(int) (5.0F + var2 * (float) this.rand.nextInt(18)));
		}
		...
		for (int var3 = 0; var3 < 4; ++var3) {
			...
			if (var4 != null && this.rand.nextFloat() < 0.5F * var2) {
				EnchantmentHelper.addRandomEnchantment(this.rand, var4,
						(int) (5.0F + var2 * (float) this.rand.nextInt(18)));
			}
		}
	}
	...
	private void recreateLeash() {
		if (this.isLeashed && this.leashNBTTag != null) {
			if (this.leashNBTTag.hasKey("UUIDMost", 4) && this.leashNBTTag.hasKey("UUIDLeast", 4)) {
				...
				BlockPos var1 = new BlockPos(this.leashNBTTag.getInteger("X"), this.leashNBTTag.getInteger("Y"),
	...
	public boolean func_174820_d(int p_174820_1_, ItemStack p_174820_2_) {
		...
		if (p_174820_2_ != null && getArmorPosition(p_174820_2_) != var3
	...
	public static enum SpawnPlacementType {
		ON_GROUND("ON_GROUND", 0, "ON_GROUND", 0), IN_AIR("IN_AIR", 1, "IN_AIR", 1), IN_WATER("IN_WATER", 2, "IN_WATER",
				2);
