...
public class EntityBlaze extends EntityMob {
	...
	protected void updateAITasks() {
		...
		if (var1 != null && var1.posY + (double) var1.getEyeHeight() > this.posY + (double) this.getEyeHeight()
	...
	class AIFireballAttack extends EntityAIBase {
		...
		public void updateTask() {
			...
			if (var2 < 4.0D) {
				...
				double var6 = var1.getEntityBoundingBox().minY + (double) (var1.height / 2.0F)
						- (this.field_179469_a.posY + (double) (this.field_179469_a.height / 2.0F));
				...
				if (this.field_179468_c <= 0) {
					...
					if (this.field_179467_b > 1) {
						...
						this.field_179469_a.worldObj.playAuxSFXAtEntity((EntityPlayer) null, 1009,
								new BlockPos((int) this.field_179469_a.posX, (int) this.field_179469_a.posY,
										(int) this.field_179469_a.posZ),
								0);

						for (int var11 = 0; var11 < 1; ++var11) {
							EntitySmallFireball var12 = new EntitySmallFireball(this.field_179469_a.worldObj,
									this.field_179469_a,
									var4 + this.field_179469_a.getRNG().nextGaussian() * (double) var10, var6,
									var8 + this.field_179469_a.getRNG().nextGaussian() * (double) var10);
