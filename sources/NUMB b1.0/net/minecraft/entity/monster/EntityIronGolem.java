...
public class EntityIronGolem extends EntityGolem {
	...
	public EntityIronGolem(World worldIn) {
		...
		this.targetTasks.addTask(3, new EntityIronGolem.AINearestAttackableTargetNonCreeper(this, EntityLiving.class,
				10, false, true, IMob.field_175450_e));
	}
		...
		if (this.motionX * this.motionX + this.motionZ * this.motionZ > 2.500000277905201E-7D
			...
			if (var5.getMaterial() != Material.air) {
				this.worldObj.spawnParticle(EnumParticleTypes.BLOCK_CRACK,
						...
						((double) this.rand.nextFloat() - 0.5D) * 4.0D, new int[] { Block.getStateId(var4) });
			}
		}
	}
	...
	protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
		...
		for (var4 = 0; var4 < var3; ++var4) {
			this.dropItemWithOffset(Item.getItemFromBlock(Blocks.red_flower), 1,
					(float) BlockFlower.EnumFlowerType.POPPY.func_176968_b());
		}
	...
	static class AINearestAttackableTargetNonCreeper extends EntityAINearestAttackableTarget {
		...
		public AINearestAttackableTargetNonCreeper(final EntityCreature p_i45858_1_, Class p_i45858_2_, int p_i45858_3_,
				boolean p_i45858_4_, boolean p_i45858_5_, final Predicate p_i45858_6_) {
