...
public class EntityGhast extends EntityFlying implements IMob {
	...
	class AIFireballAttack extends EntityAIBase {
		...
		public void updateTask() {
			...
			if (var1.getDistanceSqToEntity(this.field_179470_b) < var2 * var2
					&& this.field_179470_b.canEntityBeSeen(var1)) {
				...
				if (this.field_179471_a == 20) {
					...
					double var10 = var1.getEntityBoundingBox().minY + (double) (var1.height / 2.0F)
	...
	class AILookAround extends EntityAIBase {
		...
		public void updateTask() {
			if (this.field_179472_a.getAttackTarget() == null) {
				this.field_179472_a.renderYawOffset = this.field_179472_a.rotationYaw = -((float) Math
						.atan2(this.field_179472_a.motionX, this.field_179472_a.motionZ)) * 180.0F / (float) Math.PI;
			} else {
				...
				if (var1.getDistanceSqToEntity(this.field_179472_a) < var2 * var2) {
					...
					this.field_179472_a.renderYawOffset = this.field_179472_a.rotationYaw = -((float) Math.atan2(var4,
							var6)) * 180.0F / (float) Math.PI;
				}
			}
		}
	}
