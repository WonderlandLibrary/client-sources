...
public class EntitySilverfish extends EntityMob {
	...
	public float func_180484_a(BlockPos p_180484_1_) {
		return this.worldObj.getBlockState(p_180484_1_.offsetDown()).getBlock() == Blocks.stone ? 10.0F
		...
		public boolean shouldExecute() {
			if (EntitySilverfish.this.getAttackTarget() != null) {
				...
				if (var1.nextInt(10) == 0) {
					...
					BlockPos var2 = (new BlockPos(EntitySilverfish.this.posX, EntitySilverfish.this.posY + 0.5D,
							EntitySilverfish.this.posZ)).offset(this.field_179483_b);
