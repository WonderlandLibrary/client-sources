...
public class EntityEnderman extends EntityMob {
	...
	private boolean shouldAttackPlayer(EntityPlayer p_70821_1_) {
		...
		if (var2 != null && var2.getItem() == Item.getItemFromBlock(Blocks.pumpkin)) {
			...
			Vec3 var4 = new Vec3(this.posX - p_70821_1_.posX, this.getEntityBoundingBox().minY
					+ (double) (this.height / 2.0F) - (p_70821_1_.posY + (double) p_70821_1_.getEyeHeight()),
	...
	protected void updateAITasks() {
		...
		if (this.worldObj.isDaytime()) {
			...
			if (var1 > 0.5F && this.worldObj.isAgainstSky(new BlockPos(this))
	...
	protected boolean teleportToEntity(Entity p_70816_1_) {
		Vec3 var2 = new Vec3(this.posX - p_70816_1_.posX, this.getEntityBoundingBox().minY
	...
	protected boolean teleportTo(double p_70825_1_, double p_70825_3_, double p_70825_5_) {
		...
		if (!var13) {
			...
			for (int var29 = 0; var29 < var28; ++var29) {
				...
				double var22 = var7 + (this.posX - var7) * var30
				...
				double var26 = var11 + (this.posZ - var11) * var30
						+ (this.rand.nextDouble() - 0.5D) * (double) this.width * 2.0D;
				this.worldObj.spawnParticle(EnumParticleTypes.PORTAL, var22, var24, var26, (double) var19,
						(double) var20, (double) var21, new int[0]);
			}
	...
	class AIFindPlayer extends EntityAINearestAttackableTarget {
		...
		public boolean shouldExecute() {
			...
			List var3 = this.taskOwner.worldObj.func_175647_a(EntityPlayer.class,
					this.taskOwner.getEntityBoundingBox().expand(var1, 4.0D, var1), this.targetEntitySelector);
		...
		public void updateTask() {
			if (this.field_179448_g != null) {
				if (--this.field_179450_h <= 0) {
					...
					IAttributeInstance var1 = this.field_179449_j
				...
				if (this.targetEntity != null) {
					if (this.targetEntity instanceof EntityPlayer
							&& this.field_179449_j.shouldAttackPlayer((EntityPlayer) this.targetEntity)) {
						if (this.targetEntity.getDistanceSqToEntity(this.field_179449_j) < 16.0D) {
							this.field_179449_j.teleportRandomly();
						}

						this.field_179451_i = 0;
					} else if (this.targetEntity.getDistanceSqToEntity(this.field_179449_j) > 256.0D
							&& this.field_179451_i++ >= 30 && this.field_179449_j.teleportToEntity(this.targetEntity)) {
						this.field_179451_i = 0;
					}
				}
	...
	class AIPlaceBlock extends EntityAIBase {
		...
		public boolean shouldExecute() {
			return !this.field_179475_a.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing") ? false
					: (this.field_179475_a.func_175489_ck().getBlock().getMaterial() == Material.air ? false
							: this.field_179475_a.getRNG().nextInt(2000) == 0);
		}
	...
	class AITakeBlock extends EntityAIBase {
		...
		public boolean shouldExecute() {
			return !this.field_179473_a.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing") ? false
					: (this.field_179473_a.func_175489_ck().getBlock().getMaterial() != Material.air ? false
							: this.field_179473_a.getRNG().nextInt(20) == 0);
		}
