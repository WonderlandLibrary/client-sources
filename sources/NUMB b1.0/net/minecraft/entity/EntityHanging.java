...
public abstract class EntityHanging extends Entity {
	...
	private void func_174856_o() {
		if (this.field_174860_b != null) {
			...
			var16 /= 32.0D;
			var18 /= 32.0D;
			this.func_174826_a(new AxisAlignedBB(var1 - var14, var3 - var16, var5 - var18, var1 + var14, var3 + var16,
					var5 + var18));
		}
	}
	...
	public void readEntityFromNBT(NBTTagCompound tagCompund) {
		this.field_174861_a = new BlockPos(tagCompund.getInteger("TileX"), tagCompund.getInteger("TileY"),
