...
public class EntityArrow extends Entity implements IProjectile {
	...
	public EntityArrow(World worldIn, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_,
			float p_i1755_5_) {
		super(worldIn);
		this.renderDistanceWeight = 10.0D;
	...
	public void onUpdate() {
		...
		if (this.inGround) {
			...
			Entity var7 = null;
			List var8 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox()
			...
			for (var11 = 0; var11 < var8.size(); ++var11) {
				...
				if (var12.canBeCollidedWith() && (var12 != this.shootingEntity || this.ticksInAir >= 5)) {
					var13 = 0.3F;
					AxisAlignedBB var14 = var12.getEntityBoundingBox().expand((double) var13, (double) var13,
							(double) var13);
			...
			if (var6 != null && var6.entityHit != null && var6.entityHit instanceof EntityPlayer) {
				...
				if (var21.capabilities.disableDamage || this.shootingEntity instanceof EntityPlayer
						&& !((EntityPlayer) this.shootingEntity).canAttackPlayer(var21)) {
					var6 = null;
				}
			}
				...
				if (var6.entityHit != null) {
					...
					if (var6.entityHit.attackEntityFrom(var26, (float) var24)) {
						if (var6.entityHit instanceof EntityLivingBase) {
							...
							if (this.shootingEntity != null && var6.entityHit != this.shootingEntity
			...
			if (this.getIsCritical()) {
				for (var11 = 0; var11 < 4; ++var11) {
					this.worldObj.spawnParticle(EnumParticleTypes.CRIT,
							this.posX + this.motionX * (double) var11 / 4.0D,
							this.posY + this.motionY * (double) var11 / 4.0D,
							this.posZ + this.motionZ * (double) var11 / 4.0D, -this.motionX, -this.motionY + 0.2D,
			...
			for (this.rotationPitch = (float) (Math.atan2(this.motionY, (double) var22) * 180.0D
			...
			if (this.isInWater()) {
				for (int var28 = 0; var28 < 4; ++var28) {
					...
					this.worldObj.spawnParticle(EnumParticleTypes.WATER_BUBBLE,
							this.posX - this.motionX * (double) var29, this.posY - this.motionY * (double) var29,
							this.posZ - this.motionZ * (double) var29, this.motionX, this.motionY, this.motionZ,
							new int[0]);
				}
