...
public class EntityAIVillagerInteract extends EntityAIWatchClosest2 {
	...
	public void startExecuting() {
		...
		if (this.field_179477_f.func_175555_cq() && this.closestEntity instanceof EntityVillager
		...
		if (this.field_179478_e > 0) {
			...
			if (this.field_179478_e == 0) {
				...
				for (int var2 = 0; var2 < var1.getSizeInventory(); ++var2) {
					...
					if (var4 != null) {
						double var11 = this.field_179477_f.posY - 0.30000001192092896D
								+ (double) this.field_179477_f.getEyeHeight();
						EntityItem var12 = new EntityItem(this.field_179477_f.worldObj, this.field_179477_f.posX, var11,
								this.field_179477_f.posZ, var4);
						float var8 = 0.3F;
						float var9 = this.field_179477_f.rotationYawHead;
						float var10 = this.field_179477_f.rotationPitch;
						var12.motionX = (double) (-MathHelper.sin(var9 / 180.0F * (float) Math.PI)
								* MathHelper.cos(var10 / 180.0F * (float) Math.PI) * var8);
						var12.motionZ = (double) (MathHelper.cos(var9 / 180.0F * (float) Math.PI)
								* MathHelper.cos(var10 / 180.0F * (float) Math.PI) * var8);
