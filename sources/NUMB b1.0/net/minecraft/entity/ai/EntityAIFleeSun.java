...
public class EntityAIFleeSun extends EntityAIBase {
	...
	public boolean shouldExecute() {
		if (!this.theWorld.isDaytime()) {
			...
			return false;
		} else if (!this.theWorld.isAgainstSky(new BlockPos(this.theCreature.posX,
	...
	private Vec3 findPossibleShelter() {
		...
		BlockPos var2 = new BlockPos(this.theCreature.posX, this.theCreature.getEntityBoundingBox().minY,
