...
public class EntityAIMoveThroughVillage extends EntityAIBase {
	...
	public boolean shouldExecute() {
		...
		if (this.isNocturnal && this.theEntity.worldObj.isDaytime()) {
			...
			Village var1 = this.theEntity.worldObj.getVillageCollection().func_176056_a(new BlockPos(this.theEntity),
					0);
			...
			if (var1 == null) {
				...
				if (this.doorInfo == null) {
					...
					if (this.entityPathNavigate != null) {
						...
						Vec3 var4 = RandomPositionGenerator.findRandomTargetBlockTowards(this.theEntity, 10, 7,
								new Vec3((double) this.doorInfo.func_179852_d().getX(),
										(double) this.doorInfo.func_179852_d().getY(),
										(double) this.doorInfo.func_179852_d().getZ()));

						if (var4 == null) {
							return false;
						} else {
							var2.func_179688_b(false);
							this.entityPathNavigate = this.theEntity.getNavigator().getPathToXYZ(var4.xCoord,
	...
	public void resetTask() {
		if (this.theEntity.getNavigator().noPath()
				|| this.theEntity.getDistanceSq(this.doorInfo.func_179852_d()) < 16.0D) {
