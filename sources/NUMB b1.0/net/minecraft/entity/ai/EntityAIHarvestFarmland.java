...
public class EntityAIHarvestFarmland extends EntityAIMoveToBlock {
	...
	public void updateTask() {
		super.updateTask();
		this.field_179504_c.getLookHelper().setLookPosition((double) this.field_179494_b.getX() + 0.5D,
				(double) (this.field_179494_b.getY() + 1), (double) this.field_179494_b.getZ() + 0.5D, 10.0F,
				(float) this.field_179504_c.getVerticalFaceSpeed());
		...
		if (this.func_179487_f()) {
			...
			if (this.field_179501_f == 0 && var4 instanceof BlockCrops
					&& ((Integer) var3.getValue(BlockCrops.AGE)).intValue() == 7) {
	...
	protected boolean func_179488_a(World worldIn, BlockPos p_179488_2_) {
		...
		if (var3 == Blocks.farmland) {
			...
			if (var3 instanceof BlockCrops && ((Integer) var4.getValue(BlockCrops.AGE)).intValue() == 7
