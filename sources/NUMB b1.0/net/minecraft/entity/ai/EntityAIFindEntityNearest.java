...
public class EntityAIFindEntityNearest extends EntityAIBase {
		...
		this.field_179443_c = new Predicate() {
			...
			public boolean func_179876_a(EntityLivingBase p_179876_1_) {
				...
				return p_179876_1_.isInvisible() ? false
						: ((double) p_179876_1_
								.getDistanceToEntity(EntityAIFindEntityNearest.this.field_179442_b) > var2 ? false
										: EntityAITarget.func_179445_a(EntityAIFindEntityNearest.this.field_179442_b,
												p_179876_1_, false, true));
			}
	...
	public boolean shouldExecute() {
		...
		List var3 = this.field_179442_b.worldObj.func_175647_a(this.field_179439_f,
				this.field_179442_b.getEntityBoundingBox().expand(var1, 4.0D, var1), this.field_179443_c);
	...
	public boolean continueExecuting() {
		...
		if (var1 == null) {
			...
			return this.field_179442_b.getDistanceSqToEntity(var1) > var2 * var2 ? false
