...
public enum EnumCreatureType {
	...
	private static final EnumCreatureType[] $VALUES = new EnumCreatureType[] { MONSTER, CREATURE, AMBIENT,
			WATER_CREATURE };
	private static final String __OBFID = "CL_00001551";

	private EnumCreatureType(String p_i1596_1_, int p_i1596_2_, Class p_i1596_3_, int p_i1596_4_, Material p_i1596_5_,
			boolean p_i1596_6_, boolean p_i1596_7_) {
