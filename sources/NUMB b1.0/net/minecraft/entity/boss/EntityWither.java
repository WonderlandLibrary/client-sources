...
public class EntityWither extends EntityMob implements IBossDisplayData, IRangedAttackMob {
	...
	public void onLivingUpdate() {
		...
		for (var22 = 0; var22 < 3; ++var22) {
			...
			this.worldObj.spawnParticle(EnumParticleTypes.SMOKE_NORMAL,
					var23 + this.rand.nextGaussian() * 0.30000001192092896D,
					var5 + this.rand.nextGaussian() * 0.30000001192092896D,
					var7 + this.rand.nextGaussian() * 0.30000001192092896D, 0.0D, 0.0D, 0.0D, new int[0]);
			...
			for (var1 = 1; var1 < 3; ++var1) {
				if (this.ticksExisted >= this.field_82223_h[var1 - 1]) {
					...
					if (var12 > 0) {
						...
						List var13 = this.worldObj.func_175647_a(EntityLivingBase.class,
	 ...
	 */
	private void launchWitherSkullToCoords(int p_82209_1_, double p_82209_2_, double p_82209_4_, double p_82209_6_,
			boolean p_82209_8_) {
	...
	protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
		...
		if (!this.worldObj.isRemote) {
			Iterator var4 = this.worldObj
					.getEntitiesWithinAABB(EntityPlayer.class, this.getEntityBoundingBox().expand(50.0D, 100.0D, 50.0D))
					.iterator();
