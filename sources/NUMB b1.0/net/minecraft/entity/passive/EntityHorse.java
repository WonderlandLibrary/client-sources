...
public class EntityHorse extends EntityAnimal implements IInvBasic {
	...
	public void fall(float distance, float damageMultiplier) {
		...
		if (var3 > 0) {
			...
			if (var4.getMaterial() != Material.air && !this.isSlient()) {
				...
				this.worldObj.playSoundAtEntity(this, var5.getStepSound(), var5.getVolume() * 0.5F,
	...
	protected EntityHorse getClosestHorse(Entity p_110250_1_, double p_110250_2_) {
		...
		Entity var6 = null;
		List var7 = this.worldObj.func_175674_a(p_110250_1_,
	...
	public void openGUI(EntityPlayer p_110199_1_) {
		if (!this.worldObj.isRemote && (this.riddenByEntity == null || this.riddenByEntity == p_110199_1_)
				&& this.isTame()) {
			this.horseChest.func_110133_a(this.getName());
	...
	public boolean interact(EntityPlayer p_70085_1_) {
		...
		if (var2 != null && var2.getItem() == Items.spawn_egg) {
			...
			if (var2 != null) {
				...
				if (!var3 && this.canCarryChest() && !this.isChested()
	...
	public boolean func_174820_d(int p_174820_1_, ItemStack p_174820_2_) {
		if (p_174820_1_ == 499 && this.canCarryChest()) {
			...
			if (p_174820_2_ != null && p_174820_2_.getItem() == Item.getItemFromBlock(Blocks.chest)
					&& !this.isChested()) {
				this.setChested(true);
				this.func_110226_cD();
				return true;
		...
		if (var3 >= 0 && var3 < 2 && var3 < this.horseChest.getSizeInventory()) {
			if (var3 == 0 && p_174820_2_ != null && p_174820_2_.getItem() != Items.saddle) {
				return false;
					...
					&& (p_174820_2_ != null && !func_146085_a(p_174820_2_.getItem()) || !this.canWearArmor())) {
				return false;
			} else {
