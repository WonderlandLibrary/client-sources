...
public abstract class EntityAnimal extends EntityAgeable implements IAnimals {
		...
		if (this.inLove > 0) {
			...
			if (this.inLove % 10 == 0) {
				...
				this.worldObj.spawnParticle(EnumParticleTypes.HEART,
						...
						this.posZ + (double) (this.rand.nextFloat() * this.width * 2.0F) - (double) this.width, var1,
						var3, var5, new int[0]);
			}
		}
	}
	...
	public float func_180484_a(BlockPos p_180484_1_) {
		return this.worldObj.getBlockState(p_180484_1_.offsetDown()).getBlock() == Blocks.grass ? 10.0F
				: this.worldObj.getLightBrightness(p_180484_1_) - 0.5F;
	}
	...
	public boolean getCanSpawnHere() {
		...
		return this.worldObj.getBlockState(var4.offsetDown()).getBlock() == this.field_175506_bl
				&& this.worldObj.getLight(var4) > 8 && super.getCanSpawnHere();
	}
