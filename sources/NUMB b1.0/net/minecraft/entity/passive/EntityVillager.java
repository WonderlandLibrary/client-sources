...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant {
	...
	private static final EntityVillager.ITradeList[][][][] field_175561_bA = new EntityVillager.ITradeList[][][][] { { {
			...
			{ { new EntityVillager.EmeraldForItems(Item.getItemFromBlock(Blocks.wool),
					...
					{ new EntityVillager.ListItemForEmeralds(new ItemStack(Item.getItemFromBlock(Blocks.wool), 1, 0),
	...
	public void useRecipe(MerchantRecipe p_70933_1_) {
		...
		if (p_70933_1_.func_180322_j()) {
			this.worldObj
					.spawnEntityInWorld(new EntityXPOrb(this.worldObj, this.posX, this.posY + 0.5D, this.posZ, var2));
		}
	}
	...
	private void func_180489_a(EnumParticleTypes p_180489_1_) {
		for (int var2 = 0; var2 < 5; ++var2) {
			...
			this.worldObj.spawnParticle(p_180489_1_,
	...
	static class ItemAndEmeraldToItem implements EntityVillager.ITradeList {
		...
		public void func_179401_a(MerchantRecipeList p_179401_1_, Random p_179401_2_) {
			...
			p_179401_1_.add(new MerchantRecipe(
					new ItemStack(this.field_179411_a.getItem(), var3, this.field_179411_a.getMetadata()),
					new ItemStack(Items.emerald),
					new ItemStack(this.field_179410_c.getItem(), var4, this.field_179410_c.getMetadata())));
		}
	}
	...
	static class PriceInfo extends Tuple {
		...
		public int func_179412_a(Random p_179412_1_) {
			return ((Integer) this.getFirst()).intValue() >= ((Integer) this.getSecond()).intValue()
					...
					: ((Integer) this.getFirst()).intValue() + p_179412_1_.nextInt(
