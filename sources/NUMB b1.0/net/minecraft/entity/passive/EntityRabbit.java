...
public class EntityRabbit extends EntityAnimal {
	...
	protected float func_175134_bD() {
		return this.moveHelper.isUpdating() && this.moveHelper.func_179919_e() > this.posY + 0.5D ? 0.5F
				: this.field_175542_br.func_180074_b();
	}
	...
	public void func_175515_b(double p_175515_1_) {
		...
		this.moveHelper.setMoveTo(this.moveHelper.func_179917_d(), this.moveHelper.func_179919_e(),
				this.moveHelper.func_179918_f(), p_175515_1_);
	}
	...
	public void func_175519_a(boolean p_175519_1_, EntityRabbit.EnumMoveType p_175519_2_) {
		...
		if (!p_175519_1_) {
			...
			this.playSound(this.func_175516_ck(), this.getSoundVolume(),
		...
		if (this.onGround) {
			...
			if (!var4.func_180067_c()) {
				if (this.moveHelper.isUpdating() && this.field_175538_bq == 0) {
					...
					Vec3 var3 = new Vec3(this.moveHelper.func_179917_d(), this.moveHelper.func_179919_e(),
							this.moveHelper.func_179918_f());
	...
	private void func_175533_a(double p_175533_1_, double p_175533_3_) {
		this.rotationYaw = (float) (Math.atan2(p_175533_3_ - this.posZ, p_175533_1_ - this.posX) * 180.0D / Math.PI)
				- 90.0F;
	}
	...
	public EntityRabbit func_175526_b(EntityAgeable p_175526_1_) {
		...
		if (p_175526_1_ instanceof EntityRabbit) {
			var2.func_175529_r(
					this.rand.nextBoolean() ? this.func_175531_cl() : ((EntityRabbit) p_175526_1_).func_175531_cl());
		}
	...
	class AIRaidFarm extends EntityAIMoveToBlock {
		...
		public void updateTask() {
			super.updateTask();
			EntityRabbit.this.getLookHelper().setLookPosition((double) this.field_179494_b.getX() + 0.5D,
					(double) (this.field_179494_b.getY() + 1), (double) this.field_179494_b.getZ() + 0.5D, 10.0F,
			...
			if (this.func_179487_f()) {
				...
				if (this.field_179499_e && var4 instanceof BlockCarrot
						&& ((Integer) var3.getValue(BlockCarrot.AGE)).intValue() == 7) {
		...
		protected boolean func_179488_a(World worldIn, BlockPos p_179488_2_) {
			...
			if (var3 == Blocks.farmland) {
				...
				if (var3 instanceof BlockCarrot && ((Integer) var4.getValue(BlockCarrot.AGE)).intValue() == 7
	...
	static enum EnumMoveType {
		...
		private static final EntityRabbit.EnumMoveType[] $VALUES = new EntityRabbit.EnumMoveType[] { NONE, HOP, STEP,
				SPRINT, ATTACK };
		private static final String __OBFID = "CL_00002239";

		private EnumMoveType(String p_i45866_1_, int p_i45866_2_, float p_i45866_3_, float p_i45866_4_, int p_i45866_5_,
				int p_i45866_6_) {
