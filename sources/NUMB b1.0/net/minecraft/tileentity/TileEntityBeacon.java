...
public class TileEntityBeacon extends TileEntityLockable implements IUpdatePlayerListBox, IInventory {
	...
	private void func_146000_x() {
		if (this.isComplete && this.levels > 0 && !this.worldObj.isRemote && this.primaryEffect > 0) {
			...
			AxisAlignedBB var7 = (new AxisAlignedBB((double) var4, (double) var5, (double) var6, (double) (var4 + 1),
					(double) (var5 + 1), (double) (var6 + 1))).expand(var1, var1, var1).addCoord(0.0D,
	...
	private void func_146003_y() {
		...
		TileEntityBeacon.BeamSegment var5 = new TileEntityBeacon.BeamSegment(
		...
		for (var7 = var3 + 1; var7 < this.worldObj.getActualHeight(); ++var7) {
			...
			if (!var6) {
				var10 = new float[] { (var5.func_177263_b()[0] + var10[0]) / 2.0F,
						(var5.func_177263_b()[1] + var10[1]) / 2.0F, (var5.func_177263_b()[2] + var10[2]) / 2.0F };
			}
			...
			for (var7 = 1; var7 <= 4; this.levels = var7++) {
				...
				for (int var17 = var2 - var7; var17 <= var2 + var7 && var16; ++var17) {
					for (int var11 = var4 - var7; var11 <= var4 + var7; ++var11) {
						...
						if (var12 != Blocks.emerald_block && var12 != Blocks.gold_block && var12 != Blocks.diamond_block
								&& var12 != Blocks.iron_block) {
							var16 = false;
							break;
						}
					}
		...
		if (!this.worldObj.isRemote && this.levels == 4 && var1 < this.levels) {
			Iterator var13 = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class,
					(new AxisAlignedBB((double) var2, (double) var3, (double) var4, (double) var2, (double) (var3 - 4),
							(double) var4)).expand(10.0D, 5.0D, 10.0D))
					.iterator();
