...
public class RoundedRectangle extends Rectangle {
	...
	protected void createPoints() {
		...
		if (cornerRadius == 0) {
			...
			// the outer most set of points for each arc will also ac as the points that
			// start the
			...
			if ((cornerFlags & TOP_LEFT) != 0) {
				tempPoints
						.addAll(createPoints(segmentCount, cornerRadius, x + cornerRadius, y + cornerRadius, 180, 270));
			} else {
