...
public class Polygon extends Shape {
	...
	/**
	 * Construct a new polygon with 3 or more points. This constructor will take the
	 * first set of points and copy them after the last set of points to create a
	 * closed shape.
	 * 
	 * @param points
