...
public final class ShapeRenderer {
	...
	/**
	 * Draw the the given shape filled in. Only the vertices are set. The colour has
	 * to be set independently of this method.
	 * 
	 * @param shape
	 *            The shape to fill.
	 */
	...
	/**
	 * Draw the the given shape filled in with a texture. Only the vertices are set.
	 * The colour has to be set independently of this method. This method is
