...
public class GradientEffect implements ConfigurableEffect {
	...
	/**
	 * Changes the height of the gradient by a percentage. The gradient is normally
	 * the height of most glyphs in the font.
	 * 
	 * @param scale
	 *            The scale to apply
	 */
	...
	public List getValues() {
		...
		values.add(EffectUtil.floatValue("Scale", scale, 0, 1,
