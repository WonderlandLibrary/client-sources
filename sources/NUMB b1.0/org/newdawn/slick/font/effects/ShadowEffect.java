...
public class ShadowEffect implements ConfigurableEffect {
	...
	/**
	 * Sets how many neighboring pixels are used to blur the shadow. Set to 0 for no
	 * blur.
	 * 
	...
	public List getValues() {
		...
		values.add(
				EffectUtil.floatValue("Opacity", opacity, 0, 1, "This setting sets the translucency of the shadow."));
