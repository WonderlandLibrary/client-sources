...
public class UnicodeFontTest extends BasicGame {
	...
	public void init(GameContainer container) throws SlickException {
		...
		// unicodeFont = new UnicodeFont(Font.decode("Arial Unicode MS"), 25, false,
		// false);
		...
		// unicodeFont.getEffects().add(new ShadowEffect(java.awt.Color.black, 5, 5,
		// 0.5f));
