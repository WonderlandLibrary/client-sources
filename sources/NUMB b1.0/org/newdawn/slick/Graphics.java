...
public class Graphics {
	...
	/**
	 * Clear the state of the alpha map across the entire screen. This sets alpha to
	 * 0 everywhere, meaning in {@link Graphics#MODE_ALPHA_BLEND} nothing will be
	 * drawn.
	 */
	 ...
	 * clearing the context. Note that calling this method alone does not cause the
	 ...
	 * note of the transforms that have been applied to the context and is always in
	...
	/**
	 * Tile a rectangle with a pattern specifing the offset from the top corner that
	 * one tile should match
	 * 
	 * @param x
	 ...
	 * 
	 * @param x1
	 *            The x coordinate of the top left corner of a box containing the
	 *            oval
	 * @param y1
	 *            The y coordinate of the top left corner of a box containing the
	 *            oval
	 * @param width
	 ...
	 *            from this image (i.e. relative to the image)
	 * @param srcy2
	...
	/**
	 * Push the current state of the transform from this graphics contexts onto the
	 * underlying graphics stack's transform stack. An associated popTransform()
	 * must be performed to restore the state before the end of the rendering loop.
	 */
