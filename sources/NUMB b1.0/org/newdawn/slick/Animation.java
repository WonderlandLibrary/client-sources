...
public class Animation implements Renderable {
	 ...
	 *            that the current frame will be caculated based on the time between
	 *            renders
	 */
	...
	/**
	 * Create a new animation based on the sprite from a sheet. It assumed that the
	 * sprites are organised on horizontal scan lines and that every sprite in the
	 ...
	 *            The sprite sheet containing the frames
	 * @param x1
	 *            The x coordinate of the first sprite from the sheet to appear in
	 *            the animation
	 * @param y1
	 *            The y coordinate of the first sprite from the sheet to appear in
	 *            the animation
	 * @param x2
	 *            The x coordinate of the last sprite from the sheet to appear in
	 *            the animation
	 * @param y2
	 *            The y coordinate of the last sprite from the sheet to appear in
	 *            the animation
	 ...
	 *            The duration each frame should be displayed for
	 * @param autoUpdate
	 *            True if this animation should automatically update based on the
	 *            render times
	 */
	...
	/**
	 * Check if this animation has stopped (either explictly or because it's reached
	 * its target frame)
	 * 
	 * @see #stopAt
	...
	/**
	 * Update the animation, note that this will have odd effects if auto update is
	 * also turned on
	 * 
	 * @see #autoUpdate
	 * @param delta
	...
	/**
	 * Indicate the animation should stop when it reaches the specified frame index
	 * (note, not frame number but index in the animation
	 * 
	 * @param frameIndex
	...
	/**
	 * Create a copy of this animation. Note that the frames are not duplicated but
