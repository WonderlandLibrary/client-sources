...
public class ObjectTreeParser {
	...
	/**
	 * Create an object tree parser specifing the default package where classes will
	 * be search for using the XML element name
	 * 
	...
	/**
	 * Set the name of the method to use to add child objects to their parents. This
	 * is sometimes useful to not clash with the existing data model methods.
	 * 
	 * @param methodName
	...
	/**
	 * Set the default package which will be search for classes by their XML element
	 * name.
	 * 
	 * @param defaultPackage
	 *            The default package to be searched
	...
	private Object traverse(XMLElement current, Object instance) throws SlickXMLException {
		...
		try {
			...
			throw new SlickXMLException(
					"Unable to instance " + clazz + " for element " + name + ", no zero parameter constructor?", e);
	 ...
	 * @throws SlickXMLException
	 *             Indicates there is no automatic way of converting the value to
	 *             the type
	 */
	...
	/**
	 * Get a method on a given class. Only here for tidy purposes, hides the the big
	 * exceptions.
	 * 
	 * @param clazz
	 *            The class to search
