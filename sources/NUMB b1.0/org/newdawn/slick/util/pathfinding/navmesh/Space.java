...
public class Space {
	...
	/**
	 * Link this space to another by creating a link and finding the point at which
	 * the spaces link up
	 * 
	 * @param other
	...
	/**
	 * Check whether two locations are within tolerance distance. This is used when
	 * finding aligned edges to remove float rounding errors
	 * 
	 * @param a
	 *            The first value
	 * @param b
