...
public class FontUtils {
	 ...
	 *            The font to draw with
	 * @param s
	 *            The given non-null {@link String} to use to calculate the width of
	 *            a space for.
	 * @param leftWidth
	 *            The integer specifying the left width buffer to use to calculate
	 *            how much space a space should take up in justification.
	...
	/**
	 * Draws justified-space separated substrings based on the given {@link String}
	 * and the given starting x and y coordinates to the given {@link Graphics2D}
	 * instance.
	 * 
	 * @param font
	 *            The font to draw with
	 * @param s
	 *            The non-null {@link String} to draw as space-separated substrings.
	 * @param x
