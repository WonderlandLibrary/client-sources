...
/**
 * Handles holograms. <br/>
 * Right now, the definition of a hologram is an invisible ArmorStand with a
 * custom name set. This is how holograms are generated by the
 * <a href="http://dev.bukkit.org/bukkit-plugins/holographic-displays/">
 * Holographic Displays</a> plugin, which is the most popular version. However,
 * the older style of holograms created by Asdjke's method
 * <a href="https://www.youtube.com/watch?v=q1B19JvX5TE">(showcased in this
 * video)</a> do not get recognized. I don't think this is a big problem, but it
