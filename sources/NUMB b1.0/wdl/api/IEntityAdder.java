...
/**
 * Interface for WDL mods that deal with new types of entities. <br/>
...
public interface IEntityAdder extends IWDLMod {
	 ...
	 * This method will only ever be called with an entity in the list returned by
	 * {@link #getModEntities()}.
	 * 
	 * @param entity
	 *            The name of the entity.
	 * @return The default distance at which the entity is removed from the player's
	 *         view.
	 * 
	 */
	 ...
	 * It's recommended to put the mod's name here, such as "More creepers". If the
	 * mod contains a lot of entities, you can divide it into subcategories. This
	 * data used for the Entity gui.
	 * 
	 * @param entity
	 *            The name of the entity.
	 * @return The category.
