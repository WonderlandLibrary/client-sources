...
public interface IWorldInfoEditor extends IWDLMod {
	 ...
	 * @param tag
	 *            The current {@link NBTTagCompound} that is being saved. Edit or
	 *            add info to this.
	 */
	public abstract void editWorldInfo(WorldClient world, WorldInfo info, SaveHandler saveHandler, NBTTagCompound tag);
}
