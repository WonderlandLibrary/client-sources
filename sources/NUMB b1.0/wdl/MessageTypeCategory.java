...
public abstract class MessageTypeCategory {
	...
	public String toString() {
		return "MessageTypeCategory [internalName=" + internalName + ", displayName=" + getDisplayName() + "]";
	}
	...
	/**
	 * Simple {@link MessageTypeCategory} that gets the display name from an
	 ...
	 * 
	 * Put in hear instead of {@link WDLMessageTypes} because of field load orders.
	 */
	static final MessageTypeCategory CORE_RECOMMENDED = new MessageTypeCategory.I18nableMessageTypeCategory(
			"CORE_RECOMMENDED", "wdl.messages.category.core_recommended");
	/**
	 * Core recommended category.
	 * 
	 * Put in hear instead of {@link WDLMessageTypes} because of field load orders.
	 */
	static final MessageTypeCategory CORE_DEBUG = new MessageTypeCategory.I18nableMessageTypeCategory("CORE_DEBUG",
