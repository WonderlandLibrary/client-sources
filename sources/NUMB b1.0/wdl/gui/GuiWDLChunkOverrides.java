...
/**
 * A GUI that Lists... well, will list, the current chunk overrides. Currently a
 * work in progress.
 * 
...
public class GuiWDLChunkOverrides extends GuiScreen {
	...
	public void initGui() {
		...
		list.addLine("Here is a list of the current chunk overrides; in the " + "future, a map will appear here.");
		...
		this.x1Field = new GuiNumericTextField(0, fontRendererObj, this.width / 2 - 138, 18, 33, 20);
		this.z1Field = new GuiNumericTextField(1, fontRendererObj, this.width / 2 - 87, 18, 33, 20);
		this.x2Field = new GuiNumericTextField(2, fontRendererObj, this.width / 2 - 36, 18, 33, 20);
		this.z2Field = new GuiNumericTextField(3, fontRendererObj, this.width / 2 + 15, 18, 33, 20);

		this.buttonList.add(new GuiButton(5, width / 2 + 55, 18, 100, 20, "Add range request"));

		this.buttonList.add(new GuiButton(100, width / 2 - 100, height - 29, I18n.format("gui.done")));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		if (button.id == 5) {
			ChunkRange range = new ChunkRange("", x1Field.getValue(), z1Field.getValue(), x2Field.getValue(),
					z2Field.getValue());
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj, "Chunk overrides", this.width / 2, 8, 0xFFFFFF);
