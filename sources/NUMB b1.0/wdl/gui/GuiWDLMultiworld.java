...
public class GuiWDLMultiworld extends GuiScreen {
	...
	public void initGui() {
		...
		String multiworldMessage = I18n.format("wdl.gui.multiworld.descirption.requiredWhen") + "\n\n"
		...
		this.multiworldEnabledBtn = new GuiButton(1, this.width / 2 - 100, infoBoxY + infoBoxHeight - 30,
				this.getMultiworldEnabledText());
		this.buttonList.add(this.multiworldEnabledBtn);

		this.buttonList
				.add(new GuiButton(100, this.width / 2 - 155, this.height - 29, 150, 20, I18n.format("gui.cancel")));

		this.buttonList.add(new GuiButton(101, this.width / 2 + 5, this.height - 29, 150, 20, I18n.format("gui.done")));
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj, I18n.format("wdl.gui.multiworld.title"), this.width / 2, 8,
				0xFFFFFF);

		drawRect(infoBoxX, infoBoxY, infoBoxX + infoBoxWidth, infoBoxY + infoBoxHeight, 0xB0000000);
		...
		drawRect(multiworldEnabledBtn.xPosition - 2, multiworldEnabledBtn.yPosition - 2,
				multiworldEnabledBtn.xPosition + multiworldEnabledBtn.getButtonWidth() + 2,
