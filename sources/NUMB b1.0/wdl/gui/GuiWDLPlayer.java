...
public class GuiWDLPlayer extends GuiScreen {
	...
	public void initGui() {
		...
		y += 22;
		this.playerPosBtn = new GuiButton(3, this.width / 2 - 100, y, getPlayerPosText());
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.showPosFields) {
			this.drawString(this.fontRendererObj, "X:", this.width / 2 - 99, this.posTextY, 0xFFFFFF);
			this.drawString(this.fontRendererObj, "Y:", this.width / 2 - 31, this.posTextY, 0xFFFFFF);
			this.drawString(this.fontRendererObj, "Z:", this.width / 2 + 37, this.posTextY, 0xFFFFFF);
	...
	private String getHealthText() {
		String result = I18n.format("wdl.gui.player.health." + WDL.baseProps.getProperty("PlayerHealth"));
	...
	private String getHungerText() {
		String result = I18n.format("wdl.gui.player.hunger." + WDL.baseProps.getProperty("PlayerFood"));
	...
	private String getPlayerPosText() {
		return I18n.format("wdl.gui.player.position." + WDL.worldProps.getProperty("PlayerPos"));
	}
