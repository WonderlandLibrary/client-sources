...
public final class RenderHelper {
	...
	public static void enableStandardItemLighting() {
		...
		GL11.glLight((int) 16384, (int) 4611,
				(FloatBuffer) RenderHelper.setColorBuffer(RenderHelper.field_82884_b.xCoord,
						RenderHelper.field_82884_b.yCoord, RenderHelper.field_82884_b.zCoord, 0.0));
		GL11.glLight((int) 16384, (int) 4609, (FloatBuffer) RenderHelper.setColorBuffer(var1, var1, var1, 1.0));
		GL11.glLight((int) 16384, (int) 4608, (FloatBuffer) RenderHelper.setColorBuffer(0.0, 0.0, 0.0, 1.0));
		GL11.glLight((int) 16384, (int) 4610, (FloatBuffer) RenderHelper.setColorBuffer(var2, var2, var2, 1.0));
		GL11.glLight((int) 16385, (int) 4611,
				(FloatBuffer) RenderHelper.setColorBuffer(RenderHelper.field_82885_c.xCoord,
						RenderHelper.field_82885_c.yCoord, RenderHelper.field_82885_c.zCoord, 0.0));
		GL11.glLight((int) 16385, (int) 4609, (FloatBuffer) RenderHelper.setColorBuffer(var1, var1, var1, 1.0));
		GL11.glLight((int) 16385, (int) 4608, (FloatBuffer) RenderHelper.setColorBuffer(0.0, 0.0, 0.0, 1.0));
		GL11.glLight((int) 16385, (int) 4610, (FloatBuffer) RenderHelper.setColorBuffer(var2, var2, var2, 1.0));
		GlStateManager.shadeModel(7424);
		GL11.glLightModel((int) 2899, (FloatBuffer) RenderHelper.setColorBuffer(var0, var0, var0, 1.0));
	}

	private static FloatBuffer setColorBuffer(double p_74517_0_, double p_74517_2_, double p_74517_4_,
			double p_74517_6_) {
		return RenderHelper.setColorBuffer((float) p_74517_0_, (float) p_74517_2_, (float) p_74517_4_,
				(float) p_74517_6_);
	}
