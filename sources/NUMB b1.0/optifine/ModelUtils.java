...
public class ModelUtils {
	...
	public static IBakedModel duplicateModel(IBakedModel model) {
		...
		SimpleBakedModel var8 = new SimpleBakedModel(generalQuads2, faceQuads2, model.isGui3d(),
	...
	public static BakedQuad duplicateQuad(BakedQuad quad) {
		BakedQuad quad2 = new BakedQuad((int[]) quad.func_178209_a().clone(), quad.func_178211_c(), quad.getFace(),
				quad.getSprite());
		return quad2;
	}
}
