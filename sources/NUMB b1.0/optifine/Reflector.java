...
public class Reflector {
	...
	public static ReflectorClass ForgeVertexFormatElementEnumUseage = new ReflectorClass(
			VertexFormatElement.EnumUseage.class);
	...
	public static ReflectorMethod ForgeBiomeGenBase_getWaterColorMultiplier = new ReflectorMethod(ForgeBiomeGenBase,
	...
	private static void dbgCall(boolean isStatic, String callType, ReflectorMethod refMethod, Object[] params,
			Object retVal) {
	...
	private static void dbgCallVoid(boolean isStatic, String callType, ReflectorMethod refMethod, Object[] params) {
		...
		Config.dbg(
				callType + staticStr + " " + className + "." + methodName + "(" + Config.arrayToString(params) + ")");
	}
