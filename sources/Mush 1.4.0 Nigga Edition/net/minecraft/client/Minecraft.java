...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException, NoSuchAlgorithmException {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new TestGyu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new TestGyu());
        }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        if (guiScreenIn instanceof TestGyu)
        {
