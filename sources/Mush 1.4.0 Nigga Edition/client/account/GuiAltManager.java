...
public class GuiAltManager extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.backgroundShader.useShader(sr.getScaledWidth(), sr.getScaledHeight(), par1, par2, (float)(System.currentTimeMillis() - this.initTime) / 1500.0f);
        GL11.glBegin((int)7);
