...
import client.util.vector.Vector3d;
...
@UtilityClass
public final class RenderUtilGG   {

    private static final Frustum FRUSTUM = new Frustum();

    private static final RenderManager RENDER_MANAGER = Minecraft.getMinecraft().getRenderManager();
    ...
    public void image(final ResourceLocation imageLocation, final float x, final float y, final float width, final float height, final Color color) {
        ...
        Gui.Newih(x, y, 0, 0, width, height, width, height);
        GlStateManager.resetColor();
        GlStateManager.disableBlend();
    }
 ...
 */
    ...
    public void drawLine(double x, double y, double z, double x1, double y1, double z1, final Color color, final float width) {
        ...
        x1 = x1 - Minecraft.getMinecraft().getRenderManager().renderPosX;
        y = y - Minecraft.getMinecraft().getRenderManager().renderPosY;
        y1 = y1 - Minecraft.getMinecraft().getRenderManager().renderPosY;
        z = z - Minecraft.getMinecraft().getRenderManager().renderPosZ;
        z1 = z1 - Minecraft.getMinecraft().getRenderManager().renderPosZ;
    ...
    public static Framebuffer createFrameBuffer(final Framebuffer framebuffer) {
        if (framebuffer == null || framebuffer.framebufferWidth != Minecraft.getMinecraft().displayWidth || framebuffer.framebufferHeight != Minecraft.getMinecraft().displayHeight) {
            ...
            return new Framebuffer(Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight, false);
        }
        return framebuffer;
    }
