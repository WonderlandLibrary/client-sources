...
import me.nekoWare.client.module.render.Animations;
...
public class ItemRenderer {
	...
	public void renderItem(EntityLivingBase p_178099_1_, ItemStack p_178099_2_,
			ItemCameraTransforms.TransformType p_178099_3_) {
		if (p_178099_2_ != null) {
	...
	private void func_178109_a(AbstractClientPlayer p_178109_1_) {
		int var2 = this.mc.theWorld.getCombinedLight(new BlockPos(p_178109_1_.posX,
				p_178109_1_.posY + (double) p_178109_1_.getEyeHeight(), p_178109_1_.posZ), 0);
	...
	private void func_178110_a(EntityPlayerSP p_178110_1_, float p_178110_2_) {
		float var3 = p_178110_1_.prevRenderArmPitch
				+ (p_178110_1_.renderArmPitch - p_178110_1_.prevRenderArmPitch) * p_178110_2_;
		float var4 = p_178110_1_.prevRenderArmYaw
	...
	private void func_178097_a(AbstractClientPlayer p_178097_1_, float p_178097_2_, float p_178097_3_,
			float p_178097_4_) {
	...
	private void func_178098_a(float p_178098_1_, AbstractClientPlayer p_178098_2_) {
		...
		float var3 = (float) this.itemToRender.getMaxItemUseDuration()
				- ((float) p_178098_2_.getItemInUseCount() - p_178098_1_ + 1.0F);
	...
	public void renderItemInFirstPerson(float p_78440_1_) {
		float var2 = 1.0F
				- (this.prevEquippedProgress + (this.equippedProgress - this.prevEquippedProgress) * p_78440_1_);
		...
		if (this.itemToRender != null) {
			if (this.itemToRender.getItem() instanceof ItemMap) {
			...
			} else if (var3.getItemInUseCount() > 0 || Aura.isBlocking) {
				...
				case 3:
					...
					break;
				case 4:
					if (Nekoware.INSTANCE.getModuleManager().getModule("Animations").isToggled()) {
						if (Animations.anim == 1) {
							this.func_178096_b(var2, var4);
							this.func_178103_d();
						} else if (Animations.anim == 2) {
						...
						} else if (Animations.anim == 3) {
							double h = Math.sin(Math.sqrt(var4) * Math.PI);
							this.func_178096_b(var2, var4);
							this.func_178103_d();
							GL11.glRotated(-h * 33, 0, 0, 1);
							GL11.glTranslated(-0.5D, 0, 0);
						} else if (Animations.anim == 4) {
							this.func_178096_b(var2 / 2.0F, 0.0F);
							GlStateManager.rotate((-var4 * 750.0F) / 2.0F, var4, -0.0F, 10.0F);
							this.func_178103_d();
						} else if (Animations.anim == 5) { // i actually dont know where i got this blockanim from LOL
							this.func_178096_b(-0.25F, 0.0F);
							this.oldAnim(var2, var4);
							this.func_178103_d();
						} else if (Animations.anim == 6) {
		...
		if (this.mc.thePlayer.isEntityInsideOpaqueBlock()) {
			...
			if (var2.getBlock().getRenderType() != -1) {
				...
				if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderBlockOverlay,
						new Object[] { this.mc.thePlayer, Float.valueOf(p_78447_1_), var13, var2, blockPos })) {
					this.func_178108_a(p_78447_1_,
							this.mc.getBlockRendererDispatcher().func_175023_a().func_178122_a(var2));
				}
			}
		}
		...
		if (!this.mc.thePlayer.func_175149_v()) {
			if (this.mc.thePlayer.isInsideOfMaterial(Material.water)
					&& !Reflector.callBoolean(Reflector.ForgeEventFactory_renderWaterOverlay,
							new Object[] { this.mc.thePlayer, Float.valueOf(p_78447_1_) })) {
	...
	private void renderWaterOverlayTexture(float p_78448_1_) {
		...
		var3.addVertexWithUV((double) var6, (double) var8, (double) var10, (double) (var5 + var11),
				(double) (var5 + var12));
		var3.addVertexWithUV((double) var7, (double) var8, (double) var10, (double) (0.0F + var11),
				(double) (var5 + var12));
		var3.addVertexWithUV((double) var7, (double) var9, (double) var10, (double) (0.0F + var11),
				(double) (0.0F + var12));
		var3.addVertexWithUV((double) var6, (double) var9, (double) var10, (double) (var5 + var11),
				(double) (0.0F + var12));
		var2.draw();
		GlStateManager.popMatrix();
		GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
		...
		if (this.itemToRender != null && var2 != null) {
			if (!this.itemToRender.getIsItemStackEqual(var2)) {
				if (Reflector.ForgeItem_shouldCauseReequipAnimation.exists()) {
					boolean var4 = Reflector.callBoolean(this.itemToRender.getItem(),
							Reflector.ForgeItem_shouldCauseReequipAnimation, new Object[] { this.itemToRender, var2,
									Boolean.valueOf(this.equippedItemSlot != var1.inventory.currentItem) });
