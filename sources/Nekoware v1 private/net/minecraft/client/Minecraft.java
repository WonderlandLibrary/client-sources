...
public class Minecraft implements IThreadListener, IPlayerUsage {
     ...
     */
    private void startGame() throws LWJGLException, UnsupportedEncodingException, NoSuchAlgorithmException, MalformedURLException {
        ...
        //TODO hook
        this.ingameGUI = new GameHud(this);
        Nekoware.INSTANCE.init();
    ...
    private void func_175609_am() throws LWJGLException {
        ...
        Display.setTitle("Starting " + Nekoware.INSTANCE.getClientName() + " " + Nekoware.INSTANCE.getVersion());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    Nekoware.INSTANCE.handleKeyPress(var1);
