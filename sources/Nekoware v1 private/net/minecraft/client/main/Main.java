...
public class Main {
    ...
    public static String sex = "fard";

    public static void main(String[] p_main_0_) throws UnsupportedEncodingException, NoSuchAlgorithmException, MalformedURLException {
       System.setProperty("java.net.preferIPv4Stack", "true");
        ...
        ArgumentAcceptingOptionSpec var11 = var1.accepts("username").withRequiredArg().defaultsTo("A Lonely Neko");
