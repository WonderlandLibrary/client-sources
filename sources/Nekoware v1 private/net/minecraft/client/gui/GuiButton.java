...
public class GuiButton extends Gui {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY) {
		if (this.visible) {
			...
			//Gui.drawVerticalLine(this.xPosition, this.yPosition, this.yPosition + this.height,
					//new Color(175, 175, 175, 255).getRGB());
			//Gui.drawVerticalLine(this.xPosition + this.width, this.yPosition, this.yPosition + this.height,
					//new Color(175, 175, 175, 255).getRGB());
			//Gui.drawHorizontalLine(this.xPosition, this.xPosition + this.width, this.yPosition,
					//new Color(175, 175, 175, 255).getRGB());
			//Gui.drawHorizontalLine(this.xPosition, this.xPosition + this.width, this.yPosition + this.height,
					//new Color(175, 175, 175, 255).getRGB());
