...
import me.nekoWare.client.event.EventAPI;
import me.nekoWare.client.event.events.ClimbSlabEvent;
import me.nekoWare.client.module.Module;
import me.nekoWare.client.module.movement.Fly;
import me.nekoWare.client.module.player.Scaffold;
...
public abstract class Entity implements ICommandSender {
	...
	public void moveEntity(double x, double y, double z) {
		if (this.noClip) {
			...
			double var15 = y;
			double var17 = z;
			boolean var19 = Nekoware.INSTANCE.getModuleManager().get(Scaffold.class).isToggled();
			...
			ClimbSlabEvent event = new ClimbSlabEvent(true, this.stepHeight);
			...
			if (event.getStepHeight() > 0.0F && var54 && (var13 != x || var17 != z)) {
				...
				if (this instanceof EntityPlayerSP) {
					EventAPI.fire(new ClimbSlabEvent(false, this.stepHeight, y + 1));
				}
			}
			...
			boolean d = Module.getInstance(Fly.class).isToggled();
