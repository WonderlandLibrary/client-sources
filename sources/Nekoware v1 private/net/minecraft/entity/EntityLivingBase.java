...
public abstract class EntityLivingBase extends Entity {
    ...
    protected void func_180433_a(double p_180433_1_, boolean p_180433_3_, Block p_180433_4_, BlockPos p_180433_5_) {
        ...
        if (!this.worldObj.isRemote && this.fallDistance > 3.0F && p_180433_3_) {
            ...
            if (var7.getMaterial() != Material.air) {
                ...
                ((WorldServer) this.worldObj).func_175739_a(EnumParticleTypes.BLOCK_DUST, this.posX, this.posY,
                        this.posZ, var11, 0.0D, 0.0D, 0.0D, 0.15000000596046448D, new int[]{Block.getStateId(var6)});
            }
        }
    ...
    public void onEntityUpdate() {
        ...
        if (this.isEntityAlive()) {
            if (this.isEntityInsideOpaqueBlock()) {
                ...
                double var2 = this.worldObj.getWorldBorder().getClosestDistance(this)
                ...
                if (this.getAir() == -20) {
                    ...
                    for (int var3 = 0; var3 < 8; ++var3) {
                        ...
                        this.worldObj.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX + (double) var4,
                                this.posY + (double) var5, this.posZ + (double) var6, this.motionX, this.motionY,
    ...
    protected void updatePotionEffects() {
        ...
        if (var11 > 0) {
            ...
            if (var4 && var11 > 0) {
                ...
                this.worldObj.spawnParticle(var12 ? EnumParticleTypes.SPELL_MOB_AMBIENT : EnumParticleTypes.SPELL_MOB,
            ...
            if (this.getHealth() <= 0.0F) {
                ...
                if (var3) {
                    ...
                    if (var4 != null) {
                        ...
                        this.attackedAtYaw = (float) (Math.atan2(var7, var9) * 180.0D / Math.PI
    ...
    public void renderBrokenItemStack(ItemStack p_70669_1_) {
        ...
        for (int var2 = 0; var2 < 5; ++var2) {
            ...
            this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, var6.xCoord, var6.yCoord, var6.zCoord,
                    var3.xCoord, var3.yCoord + 0.05D, var3.zCoord,
                    new int[]{Item.getIdFromItem(p_70669_1_.getItem())});
        }
    }
    ...
    public boolean isOnLadder() {
        ...
        return (var4 == Blocks.ladder || var4 == Blocks.vine)
                && (!(this instanceof EntityPlayer) || !((EntityPlayer) this).func_175149_v());
    }
                ...
                if (var10 != 0 || var11 != 0) {
                    ...
                    if (this.worldObj.func_147461_a(var2).isEmpty()) {
                        if (World.doesBlockHaveSolidTopSurface(this.worldObj,
                                new BlockPos(var12, (int) this.posY, var13))) {
                        ...
                        if (World.doesBlockHaveSolidTopSurface(this.worldObj,
                                new BlockPos(var12, (int) this.posY - 1, var13))
                                || this.worldObj.getBlockState(new BlockPos(var12, (int) this.posY - 1, var13))
    ...
    public void moveEntityWithHeading(float p_70612_1_, float p_70612_2_) {
        ...
        if (this.isServerWorld()) {
            ...
            if (this.isInWater() && (!(this instanceof EntityPlayer) || !((EntityPlayer) this).capabilities.isFlying)) {
                ...
                if (this.onGround) {
                    var3 = this.worldObj.getBlockState(new BlockPos(MathHelper.floor_double(this.posX),
    ...
    public void onLivingUpdate() {
        ...
        if (!Nekoware.INSTANCE.getModuleManager().get(Disabler.class).isToggled()) {
    ...
    public void func_180426_a(double p_180426_1_, double p_180426_3_, double p_180426_5_, float p_180426_7_,
        ...
        this.rotationPitchHead = (float) p_180426_8_;
    ...
    public void onItemPickup(Entity p_71001_1_, int p_71001_2_) {
        if (!p_71001_1_.isDead && !this.worldObj.isRemote) {
            ...
            if (p_71001_1_ instanceof EntityItem) {
                var3.sendToAllTrackingEntity(p_71001_1_,
    ...
    public boolean canEntityBeSeen(Entity p_70685_1_) {
        return this.worldObj.rayTraceBlocks(new Vec3(this.posX, this.posY + (double) this.getEyeHeight(), this.posZ),
                new Vec3(p_70685_1_.posX, p_70685_1_.posY + (double) p_70685_1_.getEyeHeight(),
