...
import me.nekoWare.client.option.BooleanOption;
import me.nekoWare.client.option.NumberOption;
import me.nekoWare.client.option.Option;
import me.nekoWare.client.option.StringOption;
...
public class ModuleButton {
    ...
    public ModuleButton(Module imod, Panel pl) {
        ...
        if (Nekoware.INSTANCE.getSettingsManager().getSettingsByMod(imod) != null)
            for (Option s : Nekoware.INSTANCE.getSettingsManager().getSettingsByMod(imod)) {
