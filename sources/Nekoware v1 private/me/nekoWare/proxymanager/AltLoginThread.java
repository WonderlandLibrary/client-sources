...
public final class AltLoginThread
    ...
    public AltLoginThread(String username, String password, ProxyVersion proxyVersion) {
    ...
    public void run() {
        try {
            ...
            Nekoware.INSTANCE.proxy = this.createSession(this.username, Integer.parseInt(this.password), this.version);
        } catch (Exception e) {
