 ...
 */
package me.nekoWare.proxymanager;
...
import me.nekoWare.AltManager.Colors;
...
public class GuiAltManager
    ...
    public void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 2: {
                ...
                try {
                    Nekoware.INSTANCE.getFileMgr().getFile(ProxyFile.class).saveFile();
            ...
            case 8: {
                Nekoware.INSTANCE.proxy = Proxy.NO_PROXY;
    ...
    public void initGui() {
        ...
        this.rename.enabled = false;
        try {
            Nekoware.INSTANCE.getFileMgr().getFile(ProxyFile.class).loadFile();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
