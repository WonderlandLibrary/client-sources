...
package me.nekoWare.AltManager;
...
extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        case 0: {
            ...
            try {
                ...
                AltManager altManager = NekowareNew.altManager;
                AltManager.registry.add(new Alt(username.getText(), password.getText(), result.getProfile().getName()));
    ...
    public void drawScreen(int i2, int j2, float f2) {
		...
		this.mc.getTextureManager().bindTexture(new ResourceLocation("neko/altmanager.png"));
