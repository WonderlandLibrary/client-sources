...
import me.nekoWare.client.option.*;
...
public abstract class Module {
    ...
    public final static Module getInstance(final Class<? extends Module> clazz) {
        return Nekoware.INSTANCE.getModuleManager().get(clazz);
    }

    public final void addModes(final String... modes) {
        Nekoware.INSTANCE.getSettingsManager().addSetting(new StringOption(this, "Mode", modes));
    }

    public final void addDouble(final String name, final double dval, final double min, final double max) {
        Nekoware.INSTANCE.getSettingsManager().addSetting(new NumberOption(this, name, dval, min, max, false));
    }

    public final void addDouble(final String name, String mode, final double dval, final double min, final double max) {
        Nekoware.INSTANCE.getSettingsManager().addSetting(new NumberOption(this, name, mode, dval, min, max, false));
    }

    public final void addInt(final String name, String mode, final double dval, final double min, final double max) {
        Nekoware.INSTANCE.getSettingsManager().addSetting(new NumberOption(this, name, mode, dval, min, max, true));
    }

    public final void addBoolean(final String name, final boolean value) {
        Nekoware.INSTANCE.getSettingsManager().addSetting(new BooleanOption(this, name, value));
    }

    public final void addInt(final String name, final double dval, final double min, final double max) {
        Nekoware.INSTANCE.getSettingsManager().addSetting(new NumberOption(this, name, dval, min, max, true));
    }

    public final Double getDouble(final String string) {
        return (Double) Nekoware.INSTANCE.getSettingsManager().getSettingByMod(this.getClass(), string).getValue();
    }

    public final Double getDouble(final String mode, final String string) {
        return (Double) Nekoware.INSTANCE.getSettingsManager().getSettingByMod(this.getClass(), mode, string)
                .getValue();
    }

    public final boolean getBool(final String string) {
        return (Boolean) Nekoware.INSTANCE.getSettingsManager().getSettingByMod(this.getClass(), string).getValue();
    }

    public final String getMode(boolean format) {
        try {
            Option<?> option = Nekoware.INSTANCE.getSettingsManager().getSettingByMod(this.getClass(), "Mode");
            if (option != null) {
    ...
    public void addBlockSelection(String name, ArrayList<Block> list) {
        Nekoware.INSTANCE.getSettingsManager().addSetting(new BlockSelectionSetting(this, name, list));
    }
