...
public class Commands extends Module {
    ...
    public static String clientName = "Nekoware";
    public static String editionName = "Dev";
            ...
            if (!say) {
                if (msg.startsWith(this.prefix)) {
                    ...
                    switch (cmd) {
                        case "bind": {
                            if (args[2] != null) {
                                Module m = Nekoware.INSTANCE.getModuleManager().getModule(args[1]);
                                if (m != null) {
                        ...
                        case "t": {
                            if (args[1] != null) {
                                try {
                                    ...
                                    Nekoware.INSTANCE.getModuleManager().getModule(module).toggle();
