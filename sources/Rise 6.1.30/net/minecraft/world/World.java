...
public abstract class World implements IBlockAccess, Accessor, java.io.Serializable, ThreadAccess {
...
//        });
    ...
    public void sendBlockBreakProgressWithoutEvent(final int breakerId, final BlockPos pos, final int progress) {
        for (int i = 0; i < this.worldAccesses.size(); ++i) {
            final IWorldAccess iworldaccess = this.worldAccesses.get(i);
            iworldaccess.sendBlockBreakProgressWithoutEvent(breakerId, pos, progress);
        }
    }
    ...
    public void update(Entity entity) {
        ...
        if (!entity.isDead) {
            try {
                ...
                ChatUtil.debug("Exception when updating entity");
...
//                throw new ReportedException(crashreport1);
        ...
        if (entity.isDead) {
            final int k1 = entity.chunkCoordX;
