        ...
        if (!this.mc.running) {
            ...
            if (i - this.systemTime >= 100L) {
                ...
                if (flag) {
                    ...
                    this.mc.fontRendererObj.drawWithShadow(this.currentlyDisplayedText, (float) ((k - this.mc.fontRendererObj.width(this.currentlyDisplayedText)) / 2), (float) (l / 2 - 4 - 16), 16777215);
                    this.mc.fontRendererObj.drawWithShadow(this.message, (float) ((k - this.mc.fontRendererObj.width(this.message)) / 2), (float) (l / 2 - 4 + 8), 16777215);
                }
