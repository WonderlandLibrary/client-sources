...
public class PlayerControllerMP implements Accessor {
    /**
     ...
     */
    public int currentPlayerItem, lastPlayerItem;
        ...
        if (this.currentGameType.isCreative() && this.mc.thePlayer.getHeldItem() != null && this.mc.thePlayer.getHeldItem().getItem() instanceof ItemSword) {
            ...
            if (block1.getMaterial() == Material.air) {
                ...
                if (!this.currentGameType.isCreative()) {
                    final ItemStack itemstack1 = mc.thePlayer.inventory.alternativeSlot ? getComponent(Slot.class).getItemStack() : mc.thePlayer.getHeldItem();
    ...
    public boolean clickBlock(final BlockPos loc, final EnumFacing face) {
        if (this.currentGameType.isAdventure()) {
            ...
            if (!this.mc.thePlayer.isAllowEdit()) {
                ...
                final ItemStack itemstack = mc.thePlayer.inventory.alternativeSlot ? getComponent(Slot.class).getItemStack() : mc.thePlayer.getHeldItem();
        ...
        if (!this.mc.theWorld.getWorldBorder().contains(loc)) {
            ...
            if (this.currentGameType.isCreative()) {
                ...
                if (flag && block1.getPlayerRelativeBlockHardness(mc.thePlayer, this.mc.thePlayer.worldObj, loc) >= 1.0F) {
                    ...
                    this.currentItemHittingBlock = mc.thePlayer.inventory.alternativeSlot ? getComponent(Slot.class).getItemStack() : mc.thePlayer.getHeldItem();
    ...
    public void syncCurrentPlayItem() {
        ...
        if (i != this.currentPlayerItem) {
            this.lastPlayerItem = this.currentPlayerItem;
            ...
            if (this.currentGameType != WorldSettings.GameType.SPECTATOR) {
                ...
                if (!flag && heldStack != null && heldStack.getItem() instanceof ItemBlock) {
                    ...
                    if (!itemblock.canPlaceBlockOnSide(worldIn, hitPos, side, player, heldStack)) {
                        ...
                        heldStack.ticksSinceModified = 0;
                        heldStack.realStackSize--;
                    }
                }
            }
    ...
    public boolean isPlayerRightClickingOnEntity(final EntityPlayer p_178894_1_, final Entity p_178894_2_, final MovingObjectPosition p_178894_3_) {
        this.syncCurrentPlayItem();
