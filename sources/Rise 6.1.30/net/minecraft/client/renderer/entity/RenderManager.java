...
//        if (entity != Minecraft.getMinecraft().thePlayer && (entity.outOfViewTicks > 0 && Minecraft.getMinecraft().gameSettings.thirdPersonView == 0) && entity.threadDistance > 12 && !entity.isInvisible()) {
//            return false;
//        }
