    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                ...
                j1 = this.fontRendererInstance.drawWithShadow(s1, (float) l, (float) i1 + 1, i);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = this.fontRendererInstance.drawWithShadow(s.substring(j), (float) j1, (float) i1 + 1, i);
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    this.fontRendererInstance.drawWithShadow("_", (float) k1, (float) i1 + 1, i);
                }
            }
