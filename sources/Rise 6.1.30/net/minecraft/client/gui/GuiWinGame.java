    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        for (int i1 = 0; i1 < this.field_146582_i.size(); ++i1) {
            ...
            if ((float) l + f + 12.0F + 8.0F > 0.0F && (float) l + f < (float) this.height) {
                ...
                if (s.startsWith("[C]")) {
                    this.fontRendererObj.drawWithShadow(s.substring(3), (float) (j + (i - this.fontRendererObj.width(s.substring(3))) / 2), (float) l, 16777215);
                } else {
                    this.fontRendererObj.fontRandom.setSeed((long) i1 * 4238972211L + (long) (this.field_146581_h / 4));
                    this.fontRendererObj.drawWithShadow(s, (float) j, (float) l, 16777215);
                }
            }
