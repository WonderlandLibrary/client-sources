...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback, Accessor {
    ...
    protected void drawHoveringText(final List<String> textLines, final int x, final int y) {
        if (!textLines.isEmpty()) {
            ...
            for (final String s : textLines) {
                if (s == null) continue;
                final int j = mc.fontRendererObj.width(s);
            ...
            for (int k1 = 0; k1 < textLines.size(); ++k1) {
                ...
                this.fontRendererObj.drawWithShadow(s1, (float) l1, (float) i2, -1);
     ...
     */
    public void handleComponentHover(final IChatComponent p_175272_1_, final int mouseX, final int mouseY) {
        if (p_175272_1_ != null && p_175272_1_.getChatStyle().getChatHoverEvent() != null) {
            ...
            if (hoverevent.getAction() == HoverEvent.Action.SHOW_ITEM) {
                ...
                this.drawHoveringText(NEWLINE_SPLITTER.splitToList(hoverevent.getValue().getFormattedText()), mouseX, mouseY);
