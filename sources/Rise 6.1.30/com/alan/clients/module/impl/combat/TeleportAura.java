...
public final class TeleportAura extends Module {
    ...
    public final Listener<PreUpdateEvent> onPreUpdate = event -> {
         ...
         */
        final List<EntityLivingBase> targets = TargetComponent.getTargets(killAura.getClass(), range.getValue().doubleValue(), killAura.player.getValue(), killAura.invisibles.getValue(), killAura.animals.getValue(), killAura.mobs.getValue(), killAura.teams.getValue());
