...
public final class AimAssist extends Module {
    ...
    public final Listener<PreMotionEvent> onPreMotionEvent = event -> {
        ...
        List<EntityLivingBase> targets = TargetComponent.getTargets(this.getClass(), range, player.getValue(), invisibles.getValue(), animals.getValue(), mobs.getValue(), teams.getValue());
