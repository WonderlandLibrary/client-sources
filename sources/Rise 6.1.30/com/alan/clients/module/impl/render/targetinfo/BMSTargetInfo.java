...
public class BMSTargetInfo extends Mode<TargetInfo> {
    ...
    public final Listener<Render2DEvent> onRender2D = event -> {
        ...
        getLayer(REGULAR, 1).add(() -> {
            ...
            // Render name
            productSansMedium.drawWithShadow(name, x - 30  + faceScale + PADDING + productSansLight.width(Localization.get("ui.targethud.name")) + 3, y + EDGE_OFFSET + INDENT , Color.white.getRGB());
