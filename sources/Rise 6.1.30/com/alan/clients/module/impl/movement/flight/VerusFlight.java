...
public class VerusFlight extends Mode<Flight> { // TODO: make sneaking go down
    ...
    public final Listener<PreMotionEvent> onPreMotionEvent = event -> {
        if (mode.getValue().getName().equals("Fast")) {// When U Press Space U Go Up By 0.42F Every 2 Ticks.
    ...
    public final Listener<BlockAABBEvent> onBlockAABB = event -> {
        if (mode.getValue().getName().equals("Fast")) {// Sets The Bounding Box To The Players Y Position.
