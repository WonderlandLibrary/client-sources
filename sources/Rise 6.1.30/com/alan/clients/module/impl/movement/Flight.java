...
@ModuleInfo(aliases = {"module.movement.flight.name"}, description = "module.movement.flight.description", category = Category.MOVEMENT)
public class Flight extends Module {
    ...
    private final ModeValue mode = new ModeValue("Mode", this)
            ...
            .add(new VulcanFlight("Vulcan (Deprecated)", this))
    ...
    public final Listener<Render3DEvent> onRender3D = event -> {
        if (dragon.getValue()) {
            if (entityDragon == null) {
                ...
                Client.INSTANCE.getBotManager().add(this, entityDragon);
            }
