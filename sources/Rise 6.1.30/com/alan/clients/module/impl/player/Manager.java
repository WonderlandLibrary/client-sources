    ...
    public final Listener<PreMotionEvent> onPreMotionEvent = event -> {
        ...
        for (int i = 0; i < INVENTORY_SLOTS; i++) {
            ...
            if (item instanceof ItemBlock) {
                if (block == -1) {
                    final ItemStack blockStack = mc.thePlayer.inventory.getStackInSlot(this.blockSlot.getValue().intValue() - 1);
            ...
            if (item instanceof ItemPotion) {
                if (potion == -1) {
                    ItemStack potionStack = mc.thePlayer.inventory.getStackInSlot(this.potionSlot.getValue().intValue() - 1);
            ...
            if (item instanceof ItemFood) {
                if (food == -1) {
                    ItemStack foodStack = mc.thePlayer.inventory.getStackInSlot(this.foodSlot.getValue().intValue() - 1);
