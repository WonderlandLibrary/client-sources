...
public class AESUtil {
    ...
    public static SecretKeySpec getKeyFromPassword(String password) throws NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    public static String encrypt(String input, SecretKey key, IvParameterSpec iv) throws KeyException, NoSuchPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException {
