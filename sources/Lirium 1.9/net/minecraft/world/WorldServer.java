        ...
        else
        {
            ...
            if (this.entitiesByUuid.containsKey(uuid))
            {
                ...
                else
                {
                    ...
                    {
                        LOGGER.warn("Keeping entity {} that already exists with UUID {}", EntityList.func_191301_a(entity), FastUUID.toString(uuid));
                        return false;
                    }

                    LOGGER.warn("Force-added player with duplicate UUID {}", (Object)FastUUID.toString(uuid));
                }
