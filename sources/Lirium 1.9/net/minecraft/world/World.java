...
public abstract class World implements IBlockAccess {
    ...
    public boolean setBlockState(BlockPos pos, IBlockState newState, int flags) {
        ...
        ChunkSystem.addBlock(newState.getBlock(), pos);
    ...
    public boolean setBlockToAir(BlockPos pos) {
        ChunkSystem.addBlock(Blocks.AIR, pos);
    ...
    public boolean spawnEntityInWorld(Entity entityIn) {
        ...
        if (!flag && !this.isChunkLoaded(i, j, false)) {
            ...
            if (!FakeEntityUtil.clientSideEntities.contains(entityIn))
    ...
    public void removeEntityDangerously(Entity entityIn) {
        ...
        FakeEntityUtil.clientSideEntities.remove(entityIn);
    ...
    public void updateEntities() {
        ...
        FakeEntityUtil.clientSideEntities.removeAll(this.unloadedEntityList);
        ...
        if(!FakeEntityUtil.clientSideEntities.isEmpty()) {
            for (int i1 = 0; i1 < FakeEntityUtil.clientSideEntities.size(); ++i1) {
                Entity entity2 = FakeEntityUtil.clientSideEntities.get(i1);
                ...
                if (entity2.isDead) {
                    ...
                    FakeEntityUtil.clientSideEntities.remove(i1--);
    ...
    public void unloadEntities(Collection<Entity> entityCollection) {
        ...
        FakeEntityUtil.clientSideEntities.removeAll(entityCollection);
    }
