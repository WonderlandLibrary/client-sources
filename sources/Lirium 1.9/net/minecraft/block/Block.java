...
public class Block
{
    ...
    {
        final CollideEvent collideEvent = new CollideEvent(pos, this, blockBox);
        Client.INSTANCE.getEventBus().call(collideEvent);
        blockBox = collideEvent.boundingBox;
        if(collideEvent.isCancelled()) return;
