...
public class TileEntityShulkerBox extends TileEntityLockableLoot implements ITickable, ISidedInventory {
    ...
    public TileEntityShulkerBox(@Nullable EnumDyeColor color) {
        if (color != null)
            this.color = new Color(color.color[0], color.color[1], color.color[2]);
        else
            this.color = new Color(0xDA720D);
