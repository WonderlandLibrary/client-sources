...
import de.lirium.base.transfer.ImageSelection;
...
public class ScreenShotHelper
{
    ...
    public static boolean shotScreenshot = false;
    ...
    public static ITextComponent saveScreenshot(File gameDirectory, @Nullable String screenshotName, int width, int height, Framebuffer buffer)
    {
        try
        {
            ...
            if (flag)
            {
                ...
                minecraft.entityRenderer.updateCameraAndRender(minecraft.getRenderPartialTicks(), System.nanoTime(), minecraft.particleTimer.partialTicks);
            }
            ...
            new Thread(() -> {
                try {
                    ...
                    Toolkit.getDefaultToolkit().getSystemClipboard().setContents(new ImageSelection(ImageIO.read(finalFile)), null);
                } catch (IOException e) {
