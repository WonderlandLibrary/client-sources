...
public class RenderPlayer extends RenderLivingBase<AbstractClientPlayer>
{
    ...
    {
        final PlayerSizeEvent sizeEvent = new PlayerSizeEvent(0.9375F);
        Client.INSTANCE.getEventBus().call(sizeEvent);
        float f = sizeEvent.size;
    ...
    {
        if(FakeEntityUtil.clientSideEntities.contains(entityLiving)) partialTicks = 1F;
