...
public class RenderItemFrame extends Render<EntityItemFrame> {
    ...
    public void doRender(EntityItemFrame entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        final RenderItemFrameEvent paintingEvent = new RenderItemFrameEvent();
        Client.INSTANCE.getEventBus().call(paintingEvent);

        if (!paintingEvent.isCancelled() && entity.getDisplayedItem().getItem() instanceof ItemMap) {
