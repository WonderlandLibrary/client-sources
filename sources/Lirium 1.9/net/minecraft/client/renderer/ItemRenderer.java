...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(AbstractClientPlayer p_187457_1_, float p_187457_2_, float p_187457_3_, EnumHand p_187457_4_, float p_187457_5_, ItemStack p_187457_6_, float p_187457_7_) {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_187457_4_)) {
            ...
            if (p_187457_6_.func_190926_b()) {
                ...
                final RenderItemEvent event = new RenderItemEvent(p_187457_1_, enumhandside, itemRenderer, p_187457_5_, p_187457_7_, flag1, p_187457_6_, p_187457_4_);
    ...
    public void renderOverlays(float partialTicks) {
        ...
        final OverlayEvent overlayEvent = new OverlayEvent();
        Client.INSTANCE.getEventBus().call(overlayEvent);
        ...
        if (!this.mc.player.isSpectator()) {
            ...
            if (this.mc.player.isBurning() && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, this.mc.player, partialTicks)) {
                if (overlayEvent.renderFire)
                    this.renderFireInFirstPerson(overlayEvent.fireHeight, overlayEvent.fireSize, overlayEvent.fireRotation, overlayEvent.fireAlpha);
            }
        }
     ...
     */
    private void renderFireInFirstPerson(float height, float size, float rotation, float alpha) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            float f8 = f7 + f;
            float f9 = -0.5F;
            GlStateManager.translate((float) (-(i * 2 - 1)) * 0.24F, -0.3F * height, 0.0F);
