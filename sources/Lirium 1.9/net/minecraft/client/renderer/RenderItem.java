    ...
    public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, @Nullable String text)
    {
        ...
        if (!stack.func_190926_b())
        {
            if (stack.func_190916_E() != 1 || text != null)
            {
                ...
                GlStateManager.disableBlend();
                Client.INSTANCE.customFontLoader.panagram25.drawStringWithShadow(s, (float)(xPosition + 19 - 2 - Client.INSTANCE.customFontLoader.panagram25.getStringWidth(s)), (float)(yPosition + 6 + 3), 16777215);
                GlStateManager.enableLighting();
