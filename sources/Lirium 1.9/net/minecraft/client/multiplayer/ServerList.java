...
public class ServerList
{
    ...
    public void loadServerList()
    {
        try
        {
            ...
            if (Client.INSTANCE.getProfileManager().get() != null && Client.INSTANCE.getProfileManager().get().getName().equalsIgnoreCase("Cubecraft")) {
                this.addServerData(new ServerData("§6Cubecraft", "play.cubecraft.net", false));
                return;
            }
    ...
    {
        if (Client.INSTANCE.getProfileManager().get() != null && Client.INSTANCE.getProfileManager().get().getName().equalsIgnoreCase("Cubecraft")) return;
        try
        {
