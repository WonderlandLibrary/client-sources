...
public class PlayerControllerMP
{
    ...
    private void syncCurrentPlayItem()
    {
        ...
        final ItemSyncEvent syncEvent = new ItemSyncEvent(i);
        Client.INSTANCE.getEventBus().call(syncEvent);
        if(syncEvent.isCancelled()) return;
    ...
    {
        this.syncCurrentPlayItem();
        Client.INSTANCE.getEventBus().call(new AttackEntityEvent(AttackEntityEvent.State.BEFORE));
        ...
        Client.INSTANCE.getEventBus().call(new AttackEntityEvent(AttackEntityEvent.State.AFTER));
    }
