                    ...
                    if (chatline != null) {
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                                ...
                                int mouseX = Mouse.getX() / scaleFactor - 2;
                                int mouseY = (Mouse.getY() / scaleFactor) - 50;
                                ...
                                // Translator
                                drawRect(k + 4, j2 - 9, k + 14, j2, l1 / 2 << 24);

                                GlStateManager.enableBlend();
                                this.mc.fontRendererObj.drawStringWithShadow("\u2398", k + 6, j2 - 8, flag ? 16777215 : 16777215 + ((int) (255.0D * d0) << 24));
                                GlStateManager.disableBlend();
                                //drawRect(k + 5, j2 - 8, k + 13, j2 - 1, new Color(0, 0, 0, 100).getRGB());
                                //this.mc.fontRendererObj.drawStringWithShadow()
                                //drawRect(k + 5, j2 - 8, k + 8, j2 - 5, new Color(255, 255, 255, 255).getRGB());
                                //drawRect(k + 10, j2 - 8, k + 13, j2 - 5, new Color(255, 255, 255, 255).getRGB());

                                final ChatRenderEvent renderEvent = new ChatRenderEvent(chatline, s, -2, -j2 - 9, k + 4, -j2, mouseX, mouseY);
                                Client.INSTANCE.getEventBus().call(renderEvent);

                                s = renderEvent.text;

                                boolean clicked = Mouse.isButtonDown(0);
                                if (mouseX >= k + 4 && mouseX <= k + 14 && mouseY >= -j2 - 9 && mouseY <= -j2)
                                    if (clicked)
                                        GuiScreen.setClipboardString(ChatFormatting.stripFormatting(s));
