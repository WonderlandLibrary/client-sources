...
import de.lirium.impl.module.impl.ui.BetterHotbarFeature;
...
public class GuiIngame extends Gui {
     ...
     */
    public ItemStack highlightingItemStack = ItemStack.field_190927_a;
    ...
    public void renderGameOverlay(float partialTicks) {
        if (betterHotbar == null)
            betterHotbar = Client.INSTANCE.getModuleManager().get(BetterHotbarFeature.class);
        ...
        ShaderAccess.bloomRunnables.clear();
        ShaderAccess.bloomRunnables.add(() -> {});
        Client.INSTANCE.getEventBus().call(new Render2DEvent(partialTicks));
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        ...
        int k1;
        if (betterHotbar.isEnabled())
            k1 = (int) betterHotbar.hotbarPosition.getXPosition();
        else
            k1 = i / 2 - 91;
        ...
        if (this.recordPlayingUpFor > 0) {
            ...
            if (l1 > 8) {
                ...
                fontrenderer.drawString(this.recordPlaying, -fontrenderer.getStringWidth(this.recordPlaying) / 2F, -4, l + (l1 << 24 & -16777216));
                GlStateManager.disableBlend();
    ...
    protected void renderHotbar(ScaledResolution sr, float partialTicks) {
        final HotbarRenderEvent hotbarRenderEvent = new HotbarRenderEvent(true);
        Client.INSTANCE.getEventBus().call(hotbarRenderEvent);
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer && hotbarRenderEvent.renderDefaultHotbar) {
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    public void renderExpBar(ScaledResolution scaledRes, int x) {
        ...
        if (i > 0) {
            ...
            int l;
            if (betterHotbar.isEnabled())
                l = (int) (betterHotbar.hotbarPosition.getYPosition() - 9);
            else
                l = scaledRes.getScaledHeight() - 32 + 3;
        ...
        if (this.mc.player.experienceLevel > 0) {
            ...
            int k1;
            if (betterHotbar.isEnabled())
                k1 = (int) ((betterHotbar.hotbarPosition.getXPosition() + 91 - this.getFontRenderer().getStringWidth(s) / 2));
            else
                k1 = (scaledRes.getScaledWidth() - this.getFontRenderer().getStringWidth(s)) / 2;

            int i1;
            if (betterHotbar.isEnabled())
                i1 = (int) (betterHotbar.hotbarPosition.getYPosition() - 15);
            else
                i1 = scaledRes.getScaledHeight() - 31 - 4;
    ...
    public Draggable drag = DragHandler.setupDrag(null, "Scoreboard", 2, 300, false);
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes) {
        ...
        int j1 = (int) (drag.getYPosition() + i1) + this.getFontRenderer().FONT_HEIGHT;
        int k1 = 3;
        //int l1 = (int) (drag.getXPosition() - i - 3);
        int l1 = (int) drag.getXPosition();
        int j = 0;

        drag.setObjectHeight(i1 + this.getFontRenderer().FONT_HEIGHT);
        drag.setObjectWidth(i);
        ...
        for (Score score1 : collection) {
            ...
            //int l = (int) (drag.getXPosition() - 3 + 2);
            int l = (int) drag.getXPosition() + i;
    ...
    private static BetterHotbarFeature betterHotbar = null;
    ...
    private void renderPlayerStats(ScaledResolution scaledRes) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            if (betterHotbar.isEnabled())
                l = (int) betterHotbar.hotbarPosition.getXPosition();
            else
                l = scaledRes.getScaledWidth() / 2 - 91;
            ...
            if (betterHotbar.isEnabled())
                ...
                i1 = scaledRes.getScaledWidth() / 2 + 91;
            int j1;
            if (betterHotbar.isEnabled())
                j1 = (int) betterHotbar.hotbarPosition.getYPosition() - 20;
            else
