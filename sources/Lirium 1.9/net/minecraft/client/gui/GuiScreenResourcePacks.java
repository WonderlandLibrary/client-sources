            ...
            else if (button.id == 1)
            {
                if (this.changed)
                {
                    ...
                    for (ResourcePackListEntry resourcepacklistentry : this.selectedResourcePacks)
                    {
                        ...
                        {
                            final ResourcePackListEntryFound found = (ResourcePackListEntryFound) resourcepacklistentry;
                            final ResourcePackRepository.Entry entry = found.getResourcePackEntry();
                            final IResourcePack resourcePack = entry.getResourcePack();
                            if(entry.getPackFormat() < 3) {
                            ...
                            list.add(found.getResourcePackEntry());
                        }
                    }
