...
public class GuiLanguage extends GuiScreen
{
    ...
    public static Language selected, initLang;
    ...
    public GuiLanguage(GuiScreen screen, GameSettings gameSettingsObj, LanguageManager manager)
    {
        ...
        selected = manager.getCurrentLanguage();
        initLang = selected;
    }
    ...
    public void initGui()
    {
        ...
        if(this.list == null)
            System.out.println("Languages are null");
        ...
        if (button.enabled)
        {
            switch (button.id)
            {
                ...
                case 6:
                    ...
                    if(initLang != selected) {
                        GuiLanguage.this.languageManager.setCurrentLanguage(selected);
                        GuiLanguage.this.game_settings_3.language = selected.getLanguageCode();
    ...
    class List extends GuiSlot
    {
        ...
        {
            GuiLanguage.selected = this.languageMap.get(this.langCodeList.get(slotIndex));
        }

        protected boolean isSelected(int slotIndex)
        {
            return GuiLanguage.selected.getLanguageCode().equalsIgnoreCase(this.langCodeList.get(slotIndex));
