...
public class GuiOptions extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            if (button.id == 108) {
                ...
                if (mc.isSingleplayer() && !mc.world.getWorldInfo().isHardcoreModeEnabled() && Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) {
            ...
            if (button.id == 109) {
                this.mc.displayGuiScreen(new GuiYesNo(this, (new TextComponentTranslation("difficulty.lock.title", new Object[0])).getFormattedText(), (new TextComponentTranslation("difficulty.lock.question", new TextComponentTranslation(this.mc.world.getWorldInfo().getDifficulty().getDifficultyResourceKey()))).getFormattedText(), 109));
            }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) {
            ...
            iTextComponent.appendText("Lock Difficulty");
            iTextComponent.appendText(": ");
            iTextComponent.appendSibling(new TextComponentTranslation(mc.world.getWorldInfo().getDifficulty().getDifficultyResourceKey(), new Object[0]));
            if (difficultyButton != null)
                this.difficultyButton.displayString = iTextComponent.getFormattedText();
        } else {
            if (difficultyButton != null)
                this.difficultyButton.displayString = getDifficultyText(mc.world.getWorldInfo().getDifficulty());
        }
