...
public class GuiMultiplayer extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        drawString(fontRendererObj, "ViaForge by EnZaXD", width - fontRendererObj.getStringWidth("ViaForge by EnZaXD") - 4, 5, -1);
        drawString(fontRendererObj, "https://github.com/FlorianMichael/ViaForge", width - fontRendererObj.getStringWidth("https://github.com/FlorianMichael/ViaForge") - 4, 18, -1);
        ...
        Minecraft.getMinecraft().messages.clear();
    }
    ...
    {
        Client.INSTANCE.initTime = System.currentTimeMillis();
