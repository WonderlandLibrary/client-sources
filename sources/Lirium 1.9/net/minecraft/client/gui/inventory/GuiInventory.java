...
public class GuiInventory extends InventoryEffectRenderer implements IRecipeShownListener
{
    ...
    public static void drawEntityOnScreen(int posX, int posY, int scale, float mouseX, float mouseY, EntityLivingBase ent) {
        drawEntityOnScreen(posX, posY, scale, mouseX, mouseY, (float)Math.atan((double)(mouseX / 40.0F)) * 40.0F, (float)Math.atan((double)(mouseX / 40.0F)) * 20.0F, -((float)Math.atan((double)(mouseY / 40.0F))) * 20.0F, ent);
    }

    /**
     * Draws an entity on the screen looking toward the cursor.
     */
    public static void drawEntityOnScreen(int posX, int posY, int scale, float mouseX, float mouseY, float yaw, float yawOffset, float pitch, EntityLivingBase ent)
    {
        ...
        final float clientYaw = RotationUtil.yaw;
        final float clientPitch = RotationUtil.pitch;
        ...
        if(ent == mc.player) {
            RotationUtil.yaw = clientYaw;
            RotationUtil.pitch = clientPitch;
        }
