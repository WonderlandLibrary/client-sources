...
public class SimpleReloadableResourceManager implements IReloadableResourceManager
{
    ...
    //TODO: Recode to make it faster
    public void reloadResources(List<IResourcePack> resourcesPacksList)
    {
        this.clearResources();
        LOGGER.info("Reloading ResourceManager: {}", (Object)JOINER_RESOURCE_PACKS.join(Iterables.transform(resourcesPacksList, p_apply_1_ -> p_apply_1_ == null ? "<NULL>" : p_apply_1_.getPackName())));
