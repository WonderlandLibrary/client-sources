...
public abstract class Entity implements ICommandSender {
    ...
    @Getter
    protected int color = new Color(125, 0, 255).getRGB();
    ...
    public final int randomColor = ThreadLocalRandom.current().nextInt(0xffffff + 1);
    ...
    public Entity(World worldIn) {
        ...
        this.cachedUniqueIdString = FastUUID.toString(this.entityUniqueID);
    ...
    public void moveEntity(MoverType x, double p_70091_2_, double p_70091_4_, double p_70091_6_) {
        if (this.noClip) {
            ...
            if (this.stepHeight > 0.0F && flag && (d2 != p_70091_2_ || d4 != p_70091_6_)) {
                ...
                final StepEvent stepEvent = new StepEvent(this.stepHeight, this, StepEvent.State.PRE);
                Client.INSTANCE.getEventBus().call(stepEvent);
                p_70091_4_ = (double) stepEvent.getStepHeight();
                ...
                stepEvent.setState(StepEvent.State.ON_STEP);
                stepEvent.setStepHeight(stepEvent.getStepHeight() + p_70091_4_);
                Client.INSTANCE.getEventBus().call(stepEvent);

                this.setEntityBoundingBox(this.getEntityBoundingBox().offset(0.0D, p_70091_4_, 0.0D));

                stepEvent.setState(StepEvent.State.POST);
                Client.INSTANCE.getEventBus().call(stepEvent);
    ...
    public void func_191958_b(float p_191958_1_, float p_191958_2_, float p_191958_3_, float p_191958_4_) {
        ...
        if (f >= 1.0E-4F) {
            ...
            if (this == Minecraft.getMinecraft().player) {
                final MoveEvent moveEvent = new MoveEvent(yaw);
