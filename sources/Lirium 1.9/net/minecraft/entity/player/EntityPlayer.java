...
import de.lirium.impl.events.HitSlowEvent;
...
public abstract class EntityPlayer extends EntityLivingBase {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag5) {
                        if (i > 0) {
                            ...
                            final HitSlowEvent hitSlowEvent = new HitSlowEvent(true, 0.6);
                            Client.INSTANCE.getEventBus().call(hitSlowEvent);
                            this.motionX *= hitSlowEvent.slowdown;
                            this.motionZ *= hitSlowEvent.slowdown;
                            if (hitSlowEvent.unSprint)
    ...
    public float getCooledAttackStrength(float adjustTicks) {
        return MathHelper.clamp(((float) this.ticksSinceLastSwing / Minecraft.getMinecraft().timer.timerSpeed + adjustTicks) / this.getCooldownPeriod(), 0.0F, 1.0F);
    }
