...
{
    public static final UUID FLEEING_SPEED_MODIFIER_UUID = FastUUID.parseUUID("E199AD21-BA8A-4C53-8D13-6182D5C69D3A");
    ...
    private static int creatureColor = new Color(0, 150,0).getRGB();;
