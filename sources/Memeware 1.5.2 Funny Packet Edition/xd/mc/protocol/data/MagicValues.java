package niggerlib.mc.protocol.data;

import niggerlib.mc.protocol.data.game.*;
import niggerlib.mc.protocol.data.game.advancement.Advancement;
...
import niggerlib.mc.protocol.data.game.entity.attribute.AttributeType;
import niggerlib.mc.protocol.data.game.entity.attribute.ModifierOperation;
import niggerlib.mc.protocol.data.game.entity.attribute.ModifierType;
import niggerlib.mc.protocol.data.game.entity.metadata.MetadataType;
import niggerlib.mc.protocol.data.game.entity.player.*;
import niggerlib.mc.protocol.data.game.entity.type.GlobalEntityType;
import niggerlib.mc.protocol.data.game.entity.type.MobType;
import niggerlib.mc.protocol.data.game.entity.type.PaintingType;
import niggerlib.mc.protocol.data.game.entity.type.object.HangingDirection;
import niggerlib.mc.protocol.data.game.entity.type.object.MinecartType;
import niggerlib.mc.protocol.data.game.entity.type.object.ObjectType;
import niggerlib.mc.protocol.data.game.scoreboard.*;
import niggerlib.mc.protocol.data.game.setting.ChatVisibility;
import niggerlib.mc.protocol.data.game.setting.Difficulty;
import niggerlib.mc.protocol.data.game.statistic.GenericStatistic;
import niggerlib.mc.protocol.data.game.window.*;
import niggerlib.mc.protocol.data.game.window.property.AnvilProperty;
import niggerlib.mc.protocol.data.game.window.property.BrewingStandProperty;
import niggerlib.mc.protocol.data.game.window.property.EnchantmentTableProperty;
import niggerlib.mc.protocol.data.game.window.property.FurnaceProperty;
import niggerlib.mc.protocol.data.game.world.Particle;
import niggerlib.mc.protocol.data.game.world.WorldBorderAction;
import niggerlib.mc.protocol.data.game.world.WorldType;
...
import niggerlib.mc.protocol.data.game.world.block.value.*;
import niggerlib.mc.protocol.data.game.world.effect.ParticleEffect;
import niggerlib.mc.protocol.data.game.world.effect.SmokeEffectData;
import niggerlib.mc.protocol.data.game.world.effect.SoundEffect;
import niggerlib.mc.protocol.data.game.world.map.MapIconType;
import niggerlib.mc.protocol.data.game.world.notify.ClientNotification;
import niggerlib.mc.protocol.data.game.world.notify.DemoMessageValue;
import niggerlib.mc.protocol.data.game.world.notify.EnterCreditsValue;
import niggerlib.mc.protocol.data.game.world.sound.BuiltinSound;
import niggerlib.mc.protocol.data.game.world.sound.SoundCategory;
import niggerlib.mc.protocol.data.handshake.HandshakeIntent;
