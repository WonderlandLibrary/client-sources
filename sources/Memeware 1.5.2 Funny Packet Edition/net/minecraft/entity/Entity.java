...
import tech.dort.dortware.impl.modules.movement.CustomFly;
...
public abstract class Entity implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            if (this instanceof EntityPlayerSP) Client.INSTANCE.getEventBus().post(entityStepEvent);
                        ...
                        if (entityStepEvent.getHeight() > 0.0D && (var13 != x || var17 != z)) {
                            ...
                            if (var56 * var56 + var27 * var27 >= x * x + z * z) {
                                ...
                                if (this == Minecraft.getMinecraft().thePlayer)
                                    Client.INSTANCE.getEventBus().post(new EntityStepEvent(1.0F + (float) y, false, this));
                            }
                        }
                    }
                }
            ...
            boolean force = this instanceof EntityPlayerSP && Client.INSTANCE.getModuleManager().get(CustomFly.class).isToggled();
