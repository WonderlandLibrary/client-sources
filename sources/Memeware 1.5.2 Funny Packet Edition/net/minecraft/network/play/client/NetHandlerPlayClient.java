...
import tech.dort.dortware.impl.events.ServerPosLookEvent;
import tech.dort.dortware.impl.events.enums.PacketDirection;
import tech.dort.dortware.impl.modules.exploit.LunarClientSpoofer;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
        ...
        Client.INSTANCE.getEventBus().post(serverPosLookEvent);
...
//    }
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn) {
        if (Client.INSTANCE.getModuleManager().get(LunarClientSpoofer.class).isToggled() && packetIn.getChannelName().equals("REGISTER")) {
