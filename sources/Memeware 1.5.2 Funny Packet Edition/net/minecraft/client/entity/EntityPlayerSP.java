...
import tech.dort.dortware.impl.modules.movement.NoSlow;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void func_175161_p() {
        ...
        Client.INSTANCE.getEventBus().post(new UpdateEvent(false));
    }
    ...
    public void sendChatMessage(String p_71165_1_) {
        ChatEvent chatEvent = new ChatEvent(p_71165_1_);
        Client.INSTANCE.getEventBus().post(chatEvent);
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding() && !Client.INSTANCE.getModuleManager().get(NoSlow.class).isToggled()) {
