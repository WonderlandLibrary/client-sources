...
public class GuiContainerCreative extends InventoryEffectRenderer {
    ...
    protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType) {
        ...
        if (slotIn == null && selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && clickType != 5) {
            ...
            if (var11.getItemStack() != null) {
                if (clickedButton == 0) {
                    this.mc.thePlayer.dropPlayerItemWithRandomChoice(var11.getItemStack());
                ...
                if (clickedButton == 1) {
                    ...
                    this.mc.thePlayer.dropPlayerItemWithRandomChoice(var7);
            ...
            if (slotIn == this.field_147064_C && var5) {
                ...
                if (selectedTabIndex == CreativeTabs.tabInventory.getTabIndex()) {
                    if (slotIn == this.field_147064_C) {
                        ...
                        this.mc.thePlayer.dropPlayerItemWithRandomChoice(var6);
    ...
    private void setCurrentCreativeTab(CreativeTabs p_147050_1_) {
        ...
        var3.itemList.clear();
        p_147050_1_.displayAllRelevantItems(var3.itemList);
    ...
    protected void func_147051_a(CreativeTabs p_147051_1_) {
        ...
        if (p_147051_1_.getTabIndex() == 12) {
            var7 = this.guiLeft + this.xSize - 55;
            var5 += 56;
        }
        GlStateManager.disableLighting();
