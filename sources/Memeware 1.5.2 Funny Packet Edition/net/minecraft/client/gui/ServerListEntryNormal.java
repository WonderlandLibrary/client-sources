...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
    ...
    public boolean mousePressed(int p_148278_1_, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_) {
        if (p_148278_5_ <= 32) {
            ...
            if (p_148278_5_ < 16 && p_148278_6_ < 16 && this.field_148303_c.func_175392_a(p_148278_1_)) {
                this.field_148303_c.func_175391_a(p_148278_1_, GuiScreen.isShiftKeyDown());
                return true;
            }

            if (p_148278_5_ < 16 && p_148278_6_ > 16 && this.field_148303_c.func_175394_b(p_148278_1_)) {
                this.field_148303_c.func_175393_b(p_148278_1_, GuiScreen.isShiftKeyDown());
                return true;
            }
        }
