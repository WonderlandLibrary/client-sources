...
import tech.dort.dortware.impl.modules.render.Camera;
...
public class GuiNewChat extends Gui {
                    ...
                    if (var10 != null) {
                        ...
                        if (var11 < 200 || var3) {
                            ...
                            if (var14 > 3) {
                                byte var15 = 0;
                                int var16 = -var9 * 9;
                                final Camera camera = Client.INSTANCE.getModuleManager().get(Camera.class);
                                ...
                                final CustomFontRenderer font = Client.INSTANCE.getFontManager().getFont("Chat").getRenderer();
    ...
    public void printChatMessageWithOptionalDeletion(IChatComponent p_146234_1_, int p_146234_2_) {
        ...
        if (mc.theWorld != null && disabler.mpTest.spectatorIGN != null && disabler.mpTest.spectatorIGN != "" && p_146234_1_.getUnformattedText().contains(disabler.mpTest.spectatorIGN)) {
            return;
        }
