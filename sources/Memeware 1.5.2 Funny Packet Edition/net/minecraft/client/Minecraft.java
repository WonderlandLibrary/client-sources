...
import tech.dort.dortware.impl.modules.misc.MCF;
...
//                            System.gc();
    ...
    private void func_175609_am() throws LWJGLException {
        ...
        Display.setTitle("Starting Meme...");
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    Client.INSTANCE.getEventBus().post(keyboardEvent);
...
//        System.gc();
    ...
    private void middleClickMouse() {
        if (this.objectMouseOver != null) {
            ...
            if (this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.ENTITY && this.objectMouseOver.entityHit instanceof EntityPlayer && Client.INSTANCE.getModuleManager().get(MCF.class).isToggled()) {
                if (Client.INSTANCE.getFriendManager().getObjects().contains(this.objectMouseOver.entityHit.getName().toLowerCase())) {
                    Client.INSTANCE.getFriendManager().getObjects().remove(this.objectMouseOver.entityHit.getName().toLowerCase());
                    ChatUtil.displayChatMessage("Removed " + this.objectMouseOver.entityHit.getName() + " from the friends list.");
                } else {
                    Client.INSTANCE.getFriendManager().getObjects().add(this.objectMouseOver.entityHit.getName().toLowerCase());
