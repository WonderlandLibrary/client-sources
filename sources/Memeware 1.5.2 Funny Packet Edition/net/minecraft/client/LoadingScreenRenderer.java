    ...
    public void setLoadingProgress(int progress) {
        if (!this.mc.running) {
            ...
            if (var2 - this.field_73723_d >= 100L) {
                ...
                var9.addVertexWithUV(0.0D, var7, 0.0D, 0.0D, (float) var7 / var10);
                var9.addVertexWithUV(var6, var7, 0.0D, (float) var6 / var10, (float) var7 / var10);
                var9.addVertexWithUV(var6, 0.0D, 0.0D, (float) var6 / var10, 0.0D);
