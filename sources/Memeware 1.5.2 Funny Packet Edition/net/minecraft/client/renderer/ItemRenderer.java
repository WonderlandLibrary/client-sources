...
import tech.dort.dortware.impl.modules.render.Animations;
...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float p_78440_1_) {
        ...
        if (this.itemToRender != null) {
            if (this.itemToRender.getItem() instanceof ItemMap) {
            ...
            } else if (var3.getItemInUseCount() > 0 || mc.thePlayer.getBlocking()) {
                ...
                switch (ItemRenderer.SwitchEnumAction.field_178094_a[var7.ordinal()]) {
                    ...
                    case 4:
                        ...
                        Client.INSTANCE.getEventBus().post(renderItemEvent);
