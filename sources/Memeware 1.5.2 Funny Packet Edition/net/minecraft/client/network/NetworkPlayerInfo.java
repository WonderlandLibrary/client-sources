...
public class NetworkPlayerInfo {
    ...
    public int getResponseTime() {
        return Minecraft.getMinecraft().isSingleplayer() ? 0 : this.responseTime;
    }

    public void func_178839_a(WorldSettings.GameType p_178839_1_) {
        this.gameType = p_178839_1_;
    }

    public void func_178838_a(int p_178838_1_) {
    ...
    public String func_178851_f() {
        return this.field_178863_g == null ? DefaultPlayerSkin.getSkinType(this.field_178867_a.getId()) : this.field_178863_g;
    }
    ...
    public ResourceLocation func_178837_g() {
        ...
        return Objects.firstNonNull(this.field_178865_e, DefaultPlayerSkin.getDefaultSkin(this.field_178867_a.getId()));
    }
    ...
    protected void loadPlayerTextures() {
        synchronized (this) {
            if (!this.field_178864_d) {
                ...
                Minecraft.getMinecraft().getSkinManager().loadProfileTextures(this.field_178867_a, new SkinManager.SkinAvailableCallback() {
                    // private static final String __OBFID = "CL_00002619";
                    public void skinCallBack(Type p_180521_1_, ResourceLocation resourceLocation, MinecraftProfileTexture profileTexture) {
                        switch (NetworkPlayerInfo.SwitchType.field_178875_a[p_180521_1_.ordinal()]) {
                            case 1:
                                NetworkPlayerInfo.this.field_178865_e = resourceLocation;
                                NetworkPlayerInfo.this.field_178863_g = profileTexture.getMetadata("model");
                            ...
                            case 2:
                                NetworkPlayerInfo.this.field_178862_f = resourceLocation;
                        }
                    }
                }, true);
            }
