...
//    public static final String DEFAULT_STR = "Default";
    ...
    public String getKeyBinding(GameSettings.Options p_74297_1_) {
        ...
        if (strOF != null) {
            ...
            String var2 = I18n.format(p_74297_1_.getEnumString()) + ": ";

            if (p_74297_1_.getEnumFloat()) {
                float var32 = this.getOptionFloatValue(p_74297_1_);
                float var4 = p_74297_1_.normalizeValue(var32);
                return p_74297_1_ == GameSettings.Options.SENSITIVITY ? (var4 == 0.0F ? var2 + I18n.format("options.sensitivity.min") : (var4 == 1.0F ? var2 + I18n.format("options.sensitivity.max") : var2 + (int) (var4 * 200.0F) + "%")) : (p_74297_1_ == GameSettings.Options.FOV ? (var32 == 70.0F ? var2 + I18n.format("options.fov.min") : (var32 == 110.0F ? var2 + I18n.format("options.fov.max") : var2 + (int) var32)) : (p_74297_1_ == GameSettings.Options.FRAMERATE_LIMIT ? (var32 == p_74297_1_.valueMax ? var2 + I18n.format("options.framerateLimit.max") : var2 + (int) var32 + " fps") : (p_74297_1_ == GameSettings.Options.RENDER_CLOUDS ? (var32 == p_74297_1_.valueMin ? var2 + I18n.format("options.cloudHeight.min") : var2 + ((int) var32 + 128)) : (p_74297_1_ == GameSettings.Options.GAMMA ? (var4 == 0.0F ? var2 + I18n.format("options.gamma.min") : (var4 == 1.0F ? var2 + I18n.format("options.gamma.max") : var2 + "+" + (int) (var4 * 100.0F) + "%")) : (p_74297_1_ == GameSettings.Options.SATURATION ? var2 + (int) (var4 * 400.0F) + "%" : (p_74297_1_ == GameSettings.Options.CHAT_OPACITY ? var2 + (int) (var4 * 90.0F + 10.0F) + "%" : (p_74297_1_ == GameSettings.Options.CHAT_HEIGHT_UNFOCUSED ? var2 + GuiNewChat.calculateChatboxHeight(var4) + "px" : (p_74297_1_ == GameSettings.Options.CHAT_HEIGHT_FOCUSED ? var2 + GuiNewChat.calculateChatboxHeight(var4) + "px" : (p_74297_1_ == GameSettings.Options.CHAT_WIDTH ? var2 + GuiNewChat.calculateChatboxWidth(var4) + "px" : (p_74297_1_ == GameSettings.Options.RENDER_DISTANCE ? var2 + (int) var32 + " chunks" : (p_74297_1_ == GameSettings.Options.MIPMAP_LEVELS ? (var32 == 0.0F ? var2 + I18n.format("options.off") : var2 + (int) var32) : null)))))))))));
            } else if (p_74297_1_.getEnumBoolean()) {
                boolean var31 = this.getOptionOrdinalValue(p_74297_1_);
                return var31 ? var2 + I18n.format("options.on") : var2 + I18n.format("options.off");
    ...
    public void saveOptions() {
        if (Reflector.FMLClientHandler.exists()) {
            Object var6 = Reflector.call(Reflector.FMLClientHandler_instance);

            if (var6 != null && Reflector.callBoolean(var6, Reflector.FMLClientHandler_isLoading)) {
                return;
            }
        }
...
//    }
    ...
    private void setOptionFloatValueOF(GameSettings.Options option, float val) {
        ...
        if (option == GameSettings.Options.AA_LEVEL) {
            ...
            for (int aaLevel : aaLevels) {
                if (valInt >= aaLevel) {
                    this.ofAaLevel = aaLevel;
                }
            }
    ...
    private String getKeyBindingOF(GameSettings.Options par1EnumOptions) {
        ...
        if (par1EnumOptions == GameSettings.Options.RENDER_DISTANCE) {
            ...
            return var6 == 0.0F ? var2 + Lang.get("of.options.framerateLimit.vsync") : (var6 == par1EnumOptions.valueMax ? var2 + I18n.format("options.framerateLimit.max") : var2 + (int) var6 + " fps");
        } else {
            return null;
        }
    }
            ...
            while ((s = bufferedreader.readLine()) != null) {
                try {
                    ...
                    if (exception1[0].equals("ofRenderDistanceChunks") && exception1.length >= 2) {
                        this.renderDistanceChunks = Integer.parseInt(exception1[1]);
                    ...
                    if (exception1[0].equals("ofFogType") && exception1.length >= 2) {
                        this.ofFogType = Integer.parseInt(exception1[1]);
                        this.ofFogType = Config.limit(this.ofFogType, 1, 3);
                    }

                    if (exception1[0].equals("ofFogStart") && exception1.length >= 2) {
                        this.ofFogStart = Float.parseFloat(exception1[1]);
                    ...
                    if (exception1[0].equals("ofFastMath") && exception1.length >= 2) {
                        this.ofFastMath = Boolean.parseBoolean(exception1[1]);
                        MathHelper.fastMath = this.ofFastMath;
                    }

                    if (exception1[0].equals("ofFastRender") && exception1.length >= 2) {
                        this.ofFastRender = Boolean.parseBoolean(exception1[1]);
                    }

                    if (exception1[0].equals("ofTranslucentBlocks") && exception1.length >= 2) {
                        this.ofTranslucentBlocks = Integer.parseInt(exception1[1]);
