...
public abstract class World implements IBlockAccess {
    ...
    public BiomeGenBase getBiomeGenForCoords(final BlockPos pos) {
        if (this.isBlockLoaded(pos)) {
            ...
            try {
                ...
                var5.addCrashSectionCallable("Location", () -> CrashReportCategory.getCoordinateInfo(pos));
    ...
    public void markBlockForUpdate(BlockPos pos) {
        for (Object worldAccess : this.worldAccesses) {
            ((IWorldAccess) worldAccess).markBlockForUpdate(pos);
        }
    }
    ...
    public void markBlockRangeForRenderUpdate(int x1, int y1, int z1, int x2, int y2, int z2) {
        for (Object worldAccess : this.worldAccesses) {
            ((IWorldAccess) worldAccess).markBlockRangeForRenderUpdate(x1, y1, z1, x2, y2, z2);
        }
    }
    ...
    public void notifyBlockOfStateChange(BlockPos pos, final Block blockIn) {
        if (!this.isRemote) {
            ...
            try {
                ...
                var6.addCrashSectionCallable("Source block type", () -> {
                    try {
    ...
    public void notifyLightSet(BlockPos pos) {
        for (Object worldAccess : this.worldAccesses) {
            ((IWorldAccess) worldAccess).notifyLightSet(pos);
        }
    }
    ...
    public void playSoundAtEntity(Entity p_72956_1_, String p_72956_2_, float p_72956_3_, float p_72956_4_) {
        for (Object worldAccess : this.worldAccesses) {
            ((IWorldAccess) worldAccess).playSound(p_72956_2_, p_72956_1_.posX, p_72956_1_.posY, p_72956_1_.posZ, p_72956_3_, p_72956_4_);
        }
    }
    ...
    public void playSoundToNearExcept(EntityPlayer p_85173_1_, String p_85173_2_, float p_85173_3_, float p_85173_4_) {
        for (Object worldAccess : this.worldAccesses) {
            ((IWorldAccess) worldAccess).playSoundToNearExcept(p_85173_1_, p_85173_2_, p_85173_1_.posX, p_85173_1_.posY, p_85173_1_.posZ, p_85173_3_, p_85173_4_);
        }
    }
    ...
    public void func_175717_a(BlockPos p_175717_1_, String p_175717_2_) {
        for (Object worldAccess : this.worldAccesses) {
            ((IWorldAccess) worldAccess).func_174961_a(p_175717_2_, p_175717_1_);
        }
    }
    ...
    private void spawnParticle(int p_175720_1_, boolean p_175720_2_, double p_175720_3_, double p_175720_5_, double p_175720_7_, double p_175720_9_, double p_175720_11_, double p_175720_13_, int... p_175720_15_) {
        for (Object worldAccess : this.worldAccesses) {
            ((IWorldAccess) worldAccess).func_180442_a(p_175720_1_, p_175720_2_, p_175720_3_, p_175720_5_, p_175720_7_, p_175720_9_, p_175720_11_, p_175720_13_, p_175720_15_);
        }
    }
    ...
    protected void onEntityAdded(Entity p_72923_1_) {
        for (Object worldAccess : this.worldAccesses) {
            ((IWorldAccess) worldAccess).onEntityAdded(p_72923_1_);
        }
    }

    protected void onEntityRemoved(Entity p_72847_1_) {
        for (Object worldAccess : this.worldAccesses) {
            ((IWorldAccess) worldAccess).onEntityRemoved(p_72847_1_);
        }
    }
    ...
    public void addTileEntities(Collection tileEntityCollection) {
        if (this.processingLoadedTiles) {
            ...
            for (Object o : tileEntityCollection) {
                TileEntity var3 = (TileEntity) o;
                ...
                for (int var13 = var6; var13 < var7; ++var13) {
                    for (int var14 = var8; var14 < var9; ++var14) {
                        ...
                        if (var17.getMaterial() == p_72918_2_) {
                            double var18 = (float) (var13 + 1) - BlockLiquid.getLiquidHeightPercent((Integer) var16.getValue(BlockLiquid.LEVEL));
    ...
    public List func_175661_b(Class p_175661_1_, Predicate p_175661_2_) {
        ...
        for (EntityPlayer playerEntity : this.playerEntities) {
            if (p_175661_1_.isAssignableFrom(((Entity) playerEntity).getClass()) && p_175661_2_.apply(playerEntity)) {
                var3.add(playerEntity);
            }
        }
    ...
    public EntityPlayer getClosestPlayer(double x, double y, double z, double distance) {
        ...
        for (EntityPlayer playerEntity : this.playerEntities) {
            if (IEntitySelector.field_180132_d.apply(playerEntity)) {
                double var14 = playerEntity.getDistanceSq(x, y, z);
    ...
    public boolean func_175636_b(double p_175636_1_, double p_175636_3_, double p_175636_5_, double p_175636_7_) {
        for (EntityPlayer var10 : this.playerEntities) {
     ...
     */
    public EntityPlayer getPlayerEntityByName(String name, boolean ignoreCase) {
        for (EntityPlayer playerEntity : this.playerEntities) {
            if (ignoreCase) {
    ...
    public void func_175669_a(int p_175669_1_, BlockPos p_175669_2_, int p_175669_3_) {
        for (Object worldAccess : this.worldAccesses) {
            ((IWorldAccess) worldAccess).func_180440_a(p_175669_1_, p_175669_2_, p_175669_3_);
        }
    }
    ...
    public void playAuxSFXAtEntity(EntityPlayer p_180498_1_, int p_180498_2_, BlockPos p_180498_3_, int p_180498_4_) {
        try {
            for (Object worldAccess : this.worldAccesses) {
                ((IWorldAccess) worldAccess).func_180439_a(p_180498_1_, p_180498_2_, p_180498_3_, p_180498_4_);
            }
        } catch (Throwable var8) {
    ...
    public CrashReportCategory addWorldInfoToCrashReport(CrashReport report) {
        ...
        var2.addCrashSectionCallable("All players", () -> World.this.playerEntities.size() + " total; " + World.this.playerEntities.toString());
