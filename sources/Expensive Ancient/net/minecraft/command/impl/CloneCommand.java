...
public class CloneCommand
{
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher)
    {
        ...
        {
            return doClone(p_198276_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198276_0_, "begin"), BlockPosArgument.getLoadedBlockPos(p_198276_0_, "end"), BlockPosArgument.getLoadedBlockPos(p_198276_0_, "destination"), NOT_AIR, Mode.NORMAL);
        }).then(Commands.literal("force").executes((p_198282_0_) ->
        {
            return doClone(p_198282_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198282_0_, "begin"), BlockPosArgument.getLoadedBlockPos(p_198282_0_, "end"), BlockPosArgument.getLoadedBlockPos(p_198282_0_, "destination"), NOT_AIR, Mode.FORCE);
        })).then(Commands.literal("move").executes((p_198263_0_) ->
        {
            return doClone(p_198263_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198263_0_, "begin"), BlockPosArgument.getLoadedBlockPos(p_198263_0_, "end"), BlockPosArgument.getLoadedBlockPos(p_198263_0_, "destination"), NOT_AIR, Mode.MOVE);
        })).then(Commands.literal("normal").executes((p_198266_0_) ->
        {
            return doClone(p_198266_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198266_0_, "begin"), BlockPosArgument.getLoadedBlockPos(p_198266_0_, "end"), BlockPosArgument.getLoadedBlockPos(p_198266_0_, "destination"), NOT_AIR, Mode.NORMAL);
        }))).then(Commands.literal("filtered").then(Commands.argument("filter", BlockPredicateArgument.blockPredicate()).executes((p_198273_0_) ->
        {
            return doClone(p_198273_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198273_0_, "begin"), BlockPosArgument.getLoadedBlockPos(p_198273_0_, "end"), BlockPosArgument.getLoadedBlockPos(p_198273_0_, "destination"), BlockPredicateArgument.getBlockPredicate(p_198273_0_, "filter"), Mode.NORMAL);
        }).then(Commands.literal("force").executes((p_198267_0_) ->
        {
            return doClone(p_198267_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198267_0_, "begin"), BlockPosArgument.getLoadedBlockPos(p_198267_0_, "end"), BlockPosArgument.getLoadedBlockPos(p_198267_0_, "destination"), BlockPredicateArgument.getBlockPredicate(p_198267_0_, "filter"), Mode.FORCE);
        })).then(Commands.literal("move").executes((p_198261_0_) ->
        {
            return doClone(p_198261_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198261_0_, "begin"), BlockPosArgument.getLoadedBlockPos(p_198261_0_, "end"), BlockPosArgument.getLoadedBlockPos(p_198261_0_, "destination"), BlockPredicateArgument.getBlockPredicate(p_198261_0_, "filter"), Mode.MOVE);
        })).then(Commands.literal("normal").executes((p_198278_0_) ->
        {
            return doClone(p_198278_0_.getSource(), BlockPosArgument.getLoadedBlockPos(p_198278_0_, "begin"), BlockPosArgument.getLoadedBlockPos(p_198278_0_, "end"), BlockPosArgument.getLoadedBlockPos(p_198278_0_, "destination"), BlockPredicateArgument.getBlockPredicate(p_198278_0_, "filter"), Mode.NORMAL);
        }))))))));
    }
                        ...
                        for (int k = mutableboundingbox.minY; k <= mutableboundingbox.maxY; ++k)
                        {
                            for (int l = mutableboundingbox.minX; l <= mutableboundingbox.maxX; ++l)
                            {
                                ...
                                if (filterPredicate.test(cachedblockinfo))
                                {
                                    ...
                                    {
                                        list2.add(new BlockInfo(blockpos3, blockstate, (CompoundNBT)null));
                                        deque.addFirst(blockpos2);
                                    }
                                    else
                                    {
                                        list.add(new BlockInfo(blockpos3, blockstate, (CompoundNBT)null));
                                        deque.addLast(blockpos2);
                                    }
                                }
                            }
