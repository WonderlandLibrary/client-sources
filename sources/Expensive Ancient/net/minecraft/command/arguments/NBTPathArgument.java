...
public class NBTPathArgument implements ArgumentType<NBTPathArgument.NBTPath>
{
    ...
    public NBTPath parse(StringReader p_parse_1_) throws CommandSyntaxException
    {
        ...
        Object2IntMap<INode> object2intmap = new Object2IntOpenHashMap<>();
        boolean flag = true;

        while (p_parse_1_.canRead() && p_parse_1_.peek() != ' ')
        {
            INode nbtpathargument$inode = func_218079_a(p_parse_1_, flag);
    ...
    static class CollectionNode implements INode
    {
    ...
    static class CompoundNode implements INode
    {
    ...
    static class EmptyListNode implements INode
    {
    ...
    static class JsonNode implements INode
    {
    ...
    static class ListNode implements INode
    {
    ...
    static class StringNode implements INode
    {
