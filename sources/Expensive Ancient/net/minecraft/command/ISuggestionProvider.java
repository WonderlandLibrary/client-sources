...
default Collection<Coordinates> func_217293_r()
    ...
    static CompletableFuture<Suggestions> func_209000_a(String p_209000_0_, Collection<Coordinates> p_209000_1_, SuggestionsBuilder builder, Predicate<String> p_209000_3_)
    {
    ...
    static CompletableFuture<Suggestions> func_211269_a(String p_211269_0_, Collection<Coordinates> p_211269_1_, SuggestionsBuilder builder, Predicate<String> p_211269_3_)
    {
        List<String> list = Lists.newArrayList();
