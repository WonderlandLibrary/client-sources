...
public class TileEntityMerger
{
    public static <S extends TileEntity> ICallbackWrapper<S> func_226924_a_(TileEntityType<S> p_226924_0_, Function<BlockState, Type> p_226924_1_, Function<BlockState, Direction> p_226924_2_, DirectionProperty p_226924_3_, BlockState p_226924_4_, IWorld p_226924_5_, BlockPos p_226924_6_, BiPredicate<IWorld, BlockPos> p_226924_7_)
    {
        ...
        else
        {
            ...
            boolean flag1 = tileentitymerger$type == Type.FIRST;

            if (flag)
            {
                return new ICallbackWrapper.Single<>(s);
            }
            else
            {
                ...
                {
                    Type tileentitymerger$type1 = p_226924_1_.apply(blockstate);

                    if (tileentitymerger$type1 != Type.SINGLE && tileentitymerger$type != tileentitymerger$type1 && blockstate.get(p_226924_3_) == p_226924_4_.get(p_226924_3_))
                    {
                        ...
                        if (s1 != null)
                        {
                            S s2 = flag1 ? s : s1;
                            S s3 = flag1 ? s1 : s;
                            return new ICallbackWrapper.Double<>(s2, s3);
                        }
                    }
                }
    ...
    {
        <T> T apply(ICallback <? super S, T > p_apply_1_);
