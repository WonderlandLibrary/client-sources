...
public class PlayerInventory implements IInventory, INameable
{
    ...
    {
        return this.mainInventory.get(currentItem).getDestroySpeed(state);
    }
    public float getDestroySpeed(BlockState state, int slot)
    {
        return this.mainInventory.get(slot).getDestroySpeed(state);
    }
    /**
