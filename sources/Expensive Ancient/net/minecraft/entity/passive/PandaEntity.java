...
public class PandaEntity extends AnimalEntity
{
    ...
    {
        return Gene.byIndex(this.dataManager.get(MAIN_GENE));
    }
    ...
    {
        return Gene.byIndex(this.dataManager.get(HIDDEN_GENE));
    }
    ...
    protected void registerGoals()
    {
        ...
        this.goalSelector.addGoal(6, new AvoidGoal<>(this, PlayerEntity.class, 8.0F, 2.0D, 2.0D));
        this.goalSelector.addGoal(6, new AvoidGoal<>(this, MonsterEntity.class, 4.0F, 2.0D, 2.0D));
        ...
        this.targetSelector.addGoal(1, (new RevengeGoal(this)).setCallsForHelp(new Class[0]));
    }
    ...
    public ILivingEntityData onInitialSpawn(IServerWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag)
    {
        ...
        if (spawnDataIn == null)
        {
            spawnDataIn = new AgeableData(0.2F);
        }
    ...
    public static enum Gene
    {
        ...
        private static final Gene[] field_221109_h = Arrays.stream(values()).sorted(Comparator.comparingInt(Gene::getIndex)).toArray((p_221102_0_) -> {
            return new Gene[p_221102_0_];
        });
        ...
        {
            for (Gene pandaentity$gene : values())
            {
