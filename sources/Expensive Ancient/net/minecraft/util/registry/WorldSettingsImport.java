...
public class WorldSettingsImport<T> extends DelegatingDynamicOps<T>
{
    ...
    {
        return create(ops, IResourceAccess.create(resourceManager), dynamicRegistries);
    }
    ...
    {
        return (ResultMap<E>)this.registryToResultMap.computeIfAbsent(key, (registryKey) ->
        {
    ...
    public interface IResourceAccess
    {
        ...
        static IResourceAccess create(final IResourceManager manager)
        {
