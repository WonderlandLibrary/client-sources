...
public abstract class PropertyManager<T extends PropertyManager<T>>
{
    ...
    protected <V> Property<V> func_218981_b(String key, Function<String, V> p_218981_2_, Function<V, String> p_218981_3_, V p_218981_4_)
    {
        String s = this.getStringValue(key);
        ...
        return new Property(key, v, p_218981_3_);
    }
    ...
    protected <V> Property<V> func_218965_b(String key, Function<String, V> p_218965_2_, V p_218965_3_)
    {
    ...
    protected Property<Integer> func_218974_b(String key, int p_218974_2_)
    {
    ...
    protected Property<Boolean> func_218961_b(String key, boolean p_218961_2_)
    {
