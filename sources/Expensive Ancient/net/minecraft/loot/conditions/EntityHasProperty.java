...
public class EntityHasProperty implements ILootCondition
{
    ...
    public static IBuilder builder(LootContext.EntityTarget targetIn)
    {
        return builder(targetIn, EntityPredicate.Builder.create());
    }

    public static IBuilder builder(LootContext.EntityTarget targetIn, EntityPredicate.Builder predicateBuilderIn)
    {
        return () ->
        {
    ...
    public static IBuilder func_237477_a_(LootContext.EntityTarget p_237477_0_, EntityPredicate p_237477_1_)
    {
        return () ->
        {
