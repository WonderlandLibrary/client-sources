...
public class StrongholdPieces
{
    ...
    public static void prepareStructurePieces()
    {
        ...
        for (PieceWeight strongholdpieces$pieceweight : PIECE_WEIGHTS)
        {
    ...
    private static boolean canAddStructurePieces()
    {
        ...
        for (PieceWeight strongholdpieces$pieceweight : structurePieceList)
        {
    ...
    private static Stronghold findAndCreatePieceFactory(Class <? extends Stronghold > clazz, List<StructurePiece> p_175954_1_, Random p_175954_2_, int p_175954_3_, int p_175954_4_, int p_175954_5_, @Nullable Direction p_175954_6_, int p_175954_7_)
    {
    ...
    private static Stronghold generatePieceFromSmallDoor(Stairs2 p_175955_0_, List<StructurePiece> p_175955_1_, Random p_175955_2_, int p_175955_3_, int p_175955_4_, int p_175955_5_, Direction p_175955_6_, int p_175955_7_)
    {
        ...
        else
        {
            ...
            {
                Stronghold strongholdpieces$stronghold = findAndCreatePieceFactory(strongComponentType, p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_, p_175955_7_);
                strongComponentType = null;
    ...
    private static StructurePiece generateAndAddPiece(Stairs2 p_175953_0_, List<StructurePiece> p_175953_1_, Random p_175953_2_, int p_175953_3_, int p_175953_4_, int p_175953_5_, @Nullable Direction p_175953_6_, int p_175953_7_)
    {
        if (p_175953_7_ > 50)
        {
            return null;
    ...
    public static class ChestCorridor extends Stronghold
    {
        ...
        public boolean func_230383_a_(ISeedReader p_230383_1_, StructureManager p_230383_2_, ChunkGenerator p_230383_3_, Random p_230383_4_, MutableBoundingBox p_230383_5_, ChunkPos p_230383_6_, BlockPos p_230383_7_)
        {
            ...
            this.func_242917_a(p_230383_1_, p_230383_4_, p_230383_5_, Door.OPENING, 1, 1, 6);
    ...
    public static class PortalRoom extends Stronghold
    {
        ...
        public boolean func_230383_a_(ISeedReader p_230383_1_, StructureManager p_230383_2_, ChunkGenerator p_230383_3_, Random p_230383_4_, MutableBoundingBox p_230383_5_, ChunkPos p_230383_6_, BlockPos p_230383_7_)
        {
            ...
            this.func_242917_a(p_230383_1_, p_230383_4_, p_230383_5_, Door.GRATES, 4, 1, 0);
            int i = 6;
    ...
    public static class Stairs extends Stronghold
    {
        ...
        public boolean func_230383_a_(ISeedReader p_230383_1_, StructureManager p_230383_2_, ChunkGenerator p_230383_3_, Random p_230383_4_, MutableBoundingBox p_230383_5_, ChunkPos p_230383_6_, BlockPos p_230383_7_)
        {
            ...
            this.func_242917_a(p_230383_1_, p_230383_4_, p_230383_5_, Door.OPENING, 1, 1, 4);
    ...
    public static class StairsStraight extends Stronghold
    {
        ...
        public boolean func_230383_a_(ISeedReader p_230383_1_, StructureManager p_230383_2_, ChunkGenerator p_230383_3_, Random p_230383_4_, MutableBoundingBox p_230383_5_, ChunkPos p_230383_6_, BlockPos p_230383_7_)
        {
            ...
            this.func_242917_a(p_230383_1_, p_230383_4_, p_230383_5_, this.entryDoor, 1, 7, 0);
            this.func_242917_a(p_230383_1_, p_230383_4_, p_230383_5_, Door.OPENING, 1, 1, 7);
    ...
    abstract static class Stronghold extends StructurePiece
    {
        ...
        public Stronghold(IStructurePieceType p_i50111_1_, CompoundNBT p_i50111_2_)
        {
            ...
            this.entryDoor = Door.valueOf(p_i50111_2_.getString("EntryDoor"));
        }
        ...
        protected void func_242917_a(ISeedReader p_242917_1_, Random p_242917_2_, MutableBoundingBox p_242917_3_, Door p_242917_4_, int p_242917_5_, int p_242917_6_, int p_242917_7_)
        {
            switch (p_242917_4_)
            {
                case OPENING:
