...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
    ...
    public void tick() {
        if (this.world.isBlockLoaded(new BlockPos(this.getPosX(), 0.0D, this.getPosZ()))) {
            if (!Expensive.getInstance().playerOnServer) {
                Expensive.getInstance().playerOnServer = true;
            }

            Expensive.getInstance().getEventBus().post(eventUpdate);
            super.tick();
    ...
    private void onUpdateWalkingPlayer() {
        ...
        Expensive.getInstance().getEventBus().post(ea);
        ...
        if (this.isCurrentViewEntity()) {
            ...
            Expensive.getInstance().getEventBus().post(eventMotion);
        ...
        Expensive.getInstance().getEventBus().post(new EventPostMotion());
    ...
    public void sendChatMessage(String message) {
        ...
        CommandDispatcher commandDispatcher = Expensive.getInstance().getCommandDispatcher();
    ...
    public void setSprinting(boolean sprinting) {
        Expensive.getInstance().getEventBus().post(sprintEvent);
    ...
    public void livingTick() {
        ...
        if (this.isHandActive() && !this.isPassenger()) {
            Expensive.getInstance().getEventBus().post(noSlowEvent);
