...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = Expensive.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(Expensive.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        Expensive.getInstance().getViaMCP().viaScreen.tick();
