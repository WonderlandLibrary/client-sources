...
import im.expensive.ui.midnight.component.ColorThemeWindow;
...
public class ThemeComponent extends Component {
    ...
    public void drawComponent(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        DisplayUtils.drawRoundedRect(x + 3, y, width - 5, height, 4, Expensive.getInstance().getStyleManager().getCurrentStyle() == style ? new Color(32, 36, 42).brighter().getRGB() : new Color(32, 36, 42).getRGB());
