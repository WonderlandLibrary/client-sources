...
public class RealmsNotificationsScreen extends RealmsScreen
{
    ...
    private void func_237857_a_(MatrixStack p_237857_1_, int p_237857_2_, int p_237857_3_)
    {
        ...
        if (field_224270_f)
        {
            ...
            blit(p_237857_1_, (int)((double)(l + 2 - j1) * 2.5D), (int)((double)i1 * 2.5D), 0.0F, 0.0F, 40, 40, 40, 40);
        ...
        if (i != 0)
        {
            ...
            RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
            blit(p_237857_1_, l - j1, i1 - 6, 0.0F, 0.0F, 15, 25, 31, 25);
            j1 += 16;
        }
        ...
        if (field_224268_d)
        {
            ...
            blit(p_237857_1_, l + 4 - j1, i1 + 4, 0.0F, (float)k1, 8, 8, 8, 16);
        }
    }
