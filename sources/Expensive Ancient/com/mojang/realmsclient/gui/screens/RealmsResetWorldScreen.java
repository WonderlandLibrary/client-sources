...
public class RealmsResetWorldScreen extends NotifableRealmsScreen
{
    ...
    public void init()
    {
        ...
        this.addButton(new TexturedButton(this.func_224434_c(1), func_239562_k_(0) + 10, new TranslationTextComponent("mco.reset.world.generate"), field_237939_A_, (p_237958_1_) ->
        {
            this.minecraft.displayGuiScreen(new RealmsResetNormalWorldScreen(this, this.field_224462_h));
        }));
        this.addButton(new TexturedButton(this.func_224434_c(2), func_239562_k_(0) + 10, new TranslationTextComponent("mco.reset.world.upload"), field_237945_x_, (p_237957_1_) ->
        {
        ...
        this.addButton(new TexturedButton(this.func_224434_c(3), func_239562_k_(0) + 10, new TranslationTextComponent("mco.reset.world.template"), field_237947_z_, (p_237956_1_) ->
        {
        ...
        this.addButton(new TexturedButton(this.func_224434_c(1), func_239562_k_(6) + 20, new TranslationTextComponent("mco.reset.world.adventure"), field_237946_y_, (p_237955_1_) ->
        {
        ...
        this.addButton(new TexturedButton(this.func_224434_c(2), func_239562_k_(6) + 20, new TranslationTextComponent("mco.reset.world.experience"), field_237940_B_, (p_237954_1_) ->
        {
        ...
        this.addButton(new TexturedButton(this.func_224434_c(3), func_239562_k_(6) + 20, new TranslationTextComponent("mco.reset.world.inspiration"), field_237941_C_, (p_237951_1_) ->
        {
    ...
    private void func_237948_a_(MatrixStack p_237948_1_, int p_237948_2_, int p_237948_3_, ITextComponent p_237948_4_, ResourceLocation p_237948_5_, boolean p_237948_6_, boolean p_237948_7_)
    {
        ...
        blit(p_237948_1_, p_237948_2_ + 2, p_237948_3_ + 14, 0.0F, 0.0F, 56, 56, 56, 56);
        ...
        blit(p_237948_1_, p_237948_2_, p_237948_3_ + 12, 0.0F, 0.0F, 60, 60, 60, 60);
    ...
    class TexturedButton extends Button
    {
        ...
        public TexturedButton(int p_i232218_2_, int p_i232218_3_, ITextComponent p_i232218_4_, ResourceLocation p_i232218_5_, IPressable p_i232218_6_)
        {
