...
public class RealmsPendingInvitesScreen extends RealmsScreen
{
        ...
        (new Thread("Realms-pending-invitations-fetcher")
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    List<InvitationEntry> list1 = list.stream().map((p_225146_1_) ->
                    {
    ...
    class InvitationEntry extends ExtendedList.AbstractListEntry<InvitationEntry>
    {
        ...
        InvitationEntry(PendingInvite p_i51623_2_)
        {
            ...
            this.field_223752_c = Arrays.asList(new AcceptButton(), new RejectButton());
        }
        ...
        private void func_237893_a_(MatrixStack p_237893_1_, PendingInvite p_237893_2_, int p_237893_3_, int p_237893_4_, int p_237893_5_, int p_237893_6_)
        {
            ...
            RealmsTextureManager.func_225205_a(p_237893_2_.field_230566_d_, () ->
            {
                ...
                blit(p_237893_1_, p_237893_3_, p_237893_4_, 32, 32, 8.0F, 8.0F, 8, 8, 64, 64);
                blit(p_237893_1_, p_237893_3_, p_237893_4_, 32, 32, 40.0F, 8.0F, 8, 8, 64, 64);
            });
        }
        ...
        class AcceptButton extends ListButton
        {
            ...
            protected void func_230435_a_(MatrixStack p_230435_1_, int p_230435_2_, int p_230435_3_, boolean p_230435_4_)
            {
                ...
                blit(p_230435_1_, p_230435_2_, p_230435_3_, f, 0.0F, 18, 18, 37, 18);
    ...
    class InvitationList extends RealmsObjectSelectionList<InvitationEntry>
    {
        ...
        public void func_231400_a_(int p_231400_1_)
        {
            ...
            if (p_231400_1_ != -1)
            {
                List<InvitationEntry> list = RealmsPendingInvitesScreen.this.field_224337_e.getEventListeners();
