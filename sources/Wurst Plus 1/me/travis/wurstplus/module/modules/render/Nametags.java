...
public class Nametags extends Module {
    ...
    private void drawNametag(Entity entityIn) {
        ...
        String str = entityIn.getName() + (health.getValue() ? " " + "\u00A7a" + Math.round(((EntityLivingBase) entityIn).getHealth() + (entityIn instanceof EntityPlayer ? ((EntityPlayer) entityIn).getAbsorptionAmount() : 0)) : "");
