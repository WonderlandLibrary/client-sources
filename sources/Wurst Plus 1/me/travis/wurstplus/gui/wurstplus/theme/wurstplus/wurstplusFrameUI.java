...
public class wurstplusFrameUI<T extends Frame> extends AbstractComponentUI<Frame> {
    ...
    ColourHolder frameColour = wurstplusGUI.primaryColour.setA(100);
    ...
    public void renderComponent(Frame component, FontRenderer fontRenderer) {
        ...
        glColor4f(.9f, .49f, 0, .75f); // fill
        RenderHelper.drawFilledRectangle(0,0,component.getWidth(),component.getHeight());
        glColor3f(.98f,.85f,.69f); // outline
        glLineWidth(2.5f);
        ...
        if (component.isPinneable()){
            if (component.isPinned())
                glColor3f(1,.33f,.33f); // PIN PINNED
            else
                glColor3f(0.66f,0.66f,0.66f); // pin not pinned
    ...
    public void handleAddComponent(Frame component, Container container) {
        ...
        component.addPoof(new Frame.FrameDragPoof<Frame, Frame.FrameDragPoof.DragInfo>() {
            ...
            public void execute(Frame component, DragInfo info) {
                ...
                wurstplusGUI rootGUI = wurstplusMod.getInstance().getGuiManager();
