...
public class wurstplusGUI extends GUI {
    ...
    public void initializeGUI() {
        ...
        Frame frame = new Frame(getTheme(), new Stretcherlayout(1), "Active Goods");
        frame.setCloseable(false);
        ...
        welcomer.addTickListener(() -> {
            welcomer.setText("");
            welcomer.addLine("\u00A7k /\u00A7r good morning, \u00A7l\u00A76" + Wrapper.getPlayer().getDisplayNameString() + "\u00A7r ur looking hot today :P \u00A7k /");
        });
        ...
        information.addTickListener(() -> {
            ...
            information.addLine("\u00A7r\u00A73" + (Runtime.getRuntime().freeMemory() / 1000000000) + Command.SECTIONSIGN() + "3GB free");
        ...
        goodsLabel.addTickListener(() -> {
            goodsLabel.setText("");
            goodsLabel.addLine("\u00A76 Totems:" +manager.getTotems());
            goodsLabel.addLine("\u00A76 Hole:" +manager.getHoleType());
            goodsLabel.addLine("\u00A76 Aura:" +manager.isAura());
            goodsLabel.addLine("\u00A76 Trap:" +manager.isTrap());
            goodsLabel.addLine("\u00A76 Surround:" +manager.isSurround());
            goodsLabel.addLine("\u00A76 HoleFill:" +manager.isFill());
        });
