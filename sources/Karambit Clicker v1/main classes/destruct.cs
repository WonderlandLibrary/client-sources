    ...
    public class destruct
    {
        ...
        public void prefetch()
        {
            ...
            try
            {
                ...
                DateTime datetime = Directory.GetLastWriteTime(@"C:\Windows\Prefetch");
                foreach (FileInfo file in Files)
                {
                    File.Delete(file.FullName);
                }
                Directory.SetLastWriteTime(@"C:\Windows\Prefetch", datetime);
            }
            catch { }
        }
        ...
        public void recent()
        {
            ...
            try
            {
                ...
                FileInfo[] Files = directory.GetFiles(searchPattern: filename + "*");
                DateTime datetime = Directory.GetLastWriteTime(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + @"\AppData\Roaming\Microsoft\Windows\Recent");
                foreach (FileInfo file in Files)
                {
                    File.Delete(file.FullName);
                }
                Directory.SetLastWriteTime(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + @"\AppData\Roaming\Microsoft\Windows\Recent", datetime);
            }
            catch { }
        }
        ...
        public void antiss()
        {
            foreach (Process process in Process.GetProcesses())
            {
                ...
                if (process.ProcessName == "Process Hacker")
                {
                    process.Kill();
                }
                ...
                if (process.ProcessName == "SMT")
                {
                    process.Kill();
                }
                if (process.ProcessName == "Avenge")
                {
                    process.Kill();
                }
                if (process.ProcessName == "Paladin")
                {
                    process.Kill();
                }
        ...
        public void iwillnotsaywhatthisis2()
        {
            ...
            try
            {
                ...
                DirectoryInfo directory2 = new DirectoryInfo(path: Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\AppData\\Local\\Microsoft\\CLR_v4.0\\UsageLogs");
                DirectoryInfo directory3 = new DirectoryInfo(path: Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\AppData\\Local\\Microsoft\\CLR_v4.0_32\\UsageLogs");
                DateTime datetime = Directory.GetLastWriteTime(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\AppData\\Local\\Microsoft\\CLR_v2.0\\UsageLogs");
                DateTime datetime1 = Directory.GetLastWriteTime(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\AppData\\Local\\Microsoft\\CLR_v2.0_32\\UsageLogs");
                DateTime datetime2 = Directory.GetLastWriteTime(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\AppData\\Local\\Microsoft\\CLR_v4.0\\UsageLogs");
                DateTime datetime3 = Directory.GetLastWriteTime(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\AppData\\Local\\Microsoft\\CLR_v4.0_32\\UsageLogs");
                FileInfo[] Files = directory.GetFiles(searchPattern: filename + "*");
                foreach (FileInfo file in Files)
                {
                    File.Delete(file.FullName);
                }
                Directory.SetLastWriteTime(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\AppData\\Local\\Microsoft\\CLR_v2.0\\UsageLogs", datetime);
                FileInfo[] Files1 = directory1.GetFiles(searchPattern: filename + "*");
                foreach (FileInfo file in Files1)
                {
                    File.Delete(file.FullName);
                }
                Directory.SetLastWriteTime(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\AppData\\Local\\Microsoft\\CLR_v2.0_32\\UsageLogs", datetime1);
                FileInfo[] Files3 = directory2.GetFiles(searchPattern: filename + "*");
                foreach (FileInfo file in Files3)
                {
                    File.Delete(file.FullName);
                }
                Directory.SetLastWriteTime(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\AppData\\Local\\Microsoft\\CLR_v4.0\\UsageLogs", datetime2);
                FileInfo[] Files4 = directory3.GetFiles(searchPattern: filename + "*");
                foreach (FileInfo file in Files4)
                {
                    File.Delete(file.FullName);
                }
                Directory.SetLastWriteTime(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + "\\AppData\\Local\\Microsoft\\CLR_v4.0_32\\UsageLogs", datetime3);
            }
            catch { }
        }
        ...
        public void regedit()
        {
            ...
            pcs.StandardInput.WriteLine("reg delete \"HKEY_CURRENT_USER\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\ComDlg32\\OpenSavePidlMRU\\com\" /f");
        ...
        /*public void regedit()
        {
            ...
            using (RegistryKey key = Registry.CurrentUser.OpenSubKey("Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\ComDlg32\\OpenSavePidlMRU\\com"))
            {
                if (key != null) key.DeleteSubKey("Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\ComDlg32\\OpenSavePidlMRU\\com");
            }
