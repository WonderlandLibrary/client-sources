...
public abstract class MixinEntityPlayer extends EntityLivingBase {
    ...
    public void attackTargetEntityWithCurrentItem(Entity p_attackTargetEntityWithCurrentItem_1_) {
        Nexus.getInstance().getEventManager().post(new EventAttack(p_attackTargetEntityWithCurrentItem_1_));
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag2) {
                        if (i > 0) {
                            ...
                            KeepSprint keepSprint = Nexus.getNexus().getModuleManager().getModuleByClass(KeepSprint.class);
