...
public class GuiIngame extends Gui
{
 ...
 // Rainbow Array ###############################################################################
    private void renderArrayList(){
    	...
    	for(Module m : chaos.instance.modulemanager.getModules()){
    		if((m.isEnabled()) && (m.visible) && (!m.isCategory(Category.GUI))){
    			display.add(String.valueOf(m.getDisplayname()));
    			
    		}
    	}
    	Collections.sort(chaos.instance.modulemanager.getModules(), new Comparator <Module>(){
	...
	public void renderName() {
		...
		int index = 0;
		long x = 0;
		Minecraft.getMinecraft().fontRendererObj.drawString(chaos.instance.Client_Name + " " + chaos.instance.Client_Version, 3, 5, ColorUtils.rainbowEffekt(index  + x * 20000000L, 1.0F).getRGB());
		}
	}
    ...
    private void renderFPS() {
    	if(ModuleManager.getModuleByName("Hud").isEnabled()) {
    		int index = 0;
    		long x = 0;
    		Minecraft.getMinecraft().fontRendererObj.drawString("FPS: " + Minecraft.getMinecraft().debugFPS, 3, 25, ColorUtils.rainbowEffekt(index  + x * 20000000L, 1.0F).getRGB());
    	}
    }
    ...
    private void renderUser() {
    	if(ModuleManager.getModuleByName("Hud").isEnabled()) {
    		int index = 0;
    		long x = 0;
    		Minecraft.getMinecraft().fontRendererObj.drawString("User: " + mc.thePlayer.getName(), 3, 15, ColorUtils.rainbowEffekt(index  + x * 20000000L, 1.0F).getRGB());
    	}
    }
    // Rainbow Array ###############################################################################
    // Rainbow Array ###############################################################################
