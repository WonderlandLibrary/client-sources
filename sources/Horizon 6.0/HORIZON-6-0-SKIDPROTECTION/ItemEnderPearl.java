...
public class ItemEnderPearl extends Item_1028566121
{
    private static final String à = "CL_00000027";
    ...
    public ItemStack HorizonCode_Horizon_È(final ItemStack itemStackIn, final World worldIn, final EntityPlayer playerIn) {
        ...
        --itemStackIn.Â;
        worldIn.HorizonCode_Horizon_È((Entity)playerIn, "random.bow", 0.5f, 0.4f / (ItemEnderPearl.Ý.nextFloat() * 0.4f + 0.8f));
        if (!worldIn.ŠÄ) {
            worldIn.HorizonCode_Horizon_È(new EntityEnderPearl(worldIn, playerIn));
        }
