...
public class GuiMusicButton extends GuiButton
{
    ...
    public GuiMusicButton(final int buttonId, final int x, final int y, final String buttonText, final String musicPath) {
        this(buttonId, x, y, 200, 20, buttonText, musicPath);
    }
    
    public GuiMusicButton(final int buttonId, final int x, final int y, final int widthIn, final int heightIn, final String buttonText, final String musicPath) {
