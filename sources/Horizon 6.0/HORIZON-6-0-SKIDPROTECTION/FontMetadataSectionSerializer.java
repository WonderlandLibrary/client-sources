...
{
    private static final String HorizonCode_Horizon_È = "CL_00001109";
    
    public FontMetadataSection HorizonCode_Horizon_È(final JsonElement p_deserialize_1_, final Type p_deserialize_2_, final JsonDeserializationContext p_deserialize_3_) {
        ...
        if (var4.has("characters")) {
            ...
            for (int var13 = 0; var13 < 256; ++var13) {
                ...
                float var17 = var10;
                if (var14 != null) {
                    final JsonObject var18 = JsonUtils.Âµá€(var14, "characters[" + var13 + "]");
                    var15 = JsonUtils.HorizonCode_Horizon_È(var18, "width", var8);
                    Validate.inclusiveBetween(0.0, 3.4028234663852886E38, (double)var15, "Invalid width");
                    var16 = JsonUtils.HorizonCode_Horizon_È(var18, "spacing", var9);
                    Validate.inclusiveBetween(0.0, 3.4028234663852886E38, (double)var16, "Invalid spacing");
                    var17 = JsonUtils.HorizonCode_Horizon_È(var18, "left", var10);
