...
public final class GuiWinPasswordField extends Gui_1808253012
{
    ...
    public GuiWinPasswordField(final FontRenderer p_i1032_1_, final int p_i1032_2_, final int p_i1032_3_, final int p_i1032_4_, final int p_i1032_5_) {
        this.Ø­áŒŠá = true;
        this.à = true;
        this.Ø = "";
        this.áŒŠÆ = 32;
    ...
    public void HorizonCode_Horizon_È() {
        if (this.Â()) {
            if (this.Ý()) {
                Gui_1808253012.HorizonCode_Horizon_È(this.HorizonCode_Horizon_È - 1, this.Â + this.ÂµÈ - 1, this.HorizonCode_Horizon_È + this.áˆºÑ¢Õ + 0, this.Â + this.ÂµÈ - 18, -1);
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                this.Ý.HorizonCode_Horizon_È(var4.substring(var2).replaceAll(".", "*"), var9, (float)var8, var1);
            }
            if (var6) {
                if (var11) {
