...
public class WaveData
{
    ...
    public static WaveData HorizonCode_Horizon_È(final URL path) {
        try {
    ...
    public static WaveData HorizonCode_Horizon_È(final String path) {
        return HorizonCode_Horizon_È(WaveData.class.getClassLoader().getResource(path));
    }
    
    public static WaveData HorizonCode_Horizon_È(final InputStream is) {
        try {
    ...
    public static WaveData HorizonCode_Horizon_È(final byte[] buffer) {
        try {
    ...
    public static WaveData HorizonCode_Horizon_È(final ByteBuffer buffer) {
        try {
            byte[] bytes = null;
            if (buffer.hasArray()) {
                bytes = buffer.array();
    ...
    public static WaveData HorizonCode_Horizon_È(final AudioInputStream ais) {
        ...
        final ByteBuffer buffer = HorizonCode_Horizon_È(buf, audioformat.getSampleSizeInBits() == 16);
    ...
    private static ByteBuffer HorizonCode_Horizon_È(final byte[] audio_bytes, final boolean two_bytes_data) {
