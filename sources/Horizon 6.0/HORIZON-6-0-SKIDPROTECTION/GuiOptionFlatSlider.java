...
public class GuiOptionFlatSlider extends GuiMenuButtonNoSlide
{
    private float Â;
    ...
    public GuiOptionFlatSlider(final int p_i45016_1_, final int p_i45016_2_, final int p_i45016_3_, final GameSettings.HorizonCode_Horizon_È p_i45016_4_) {
        this(p_i45016_1_, p_i45016_2_, p_i45016_3_, p_i45016_4_, 0.0f, 1.0f);
    }
    
    public GuiOptionFlatSlider(final int p_i45017_1_, final int p_i45017_2_, final int p_i45017_3_, final GameSettings.HorizonCode_Horizon_È p_i45017_4_, final float p_i45017_5_, final float p_i45017_6_) {
    ...
    protected void HorizonCode_Horizon_È(final Minecraft mc, final int mouseX, final int mouseY) {
        if (this.ˆà) {
            ...
            mc.¥à().HorizonCode_Horizon_È(GuiOptionFlatSlider.áˆºÑ¢Õ);
            GlStateManager.Ý(1.0f, 1.0f, 1.0f, 1.0f);
            if (this.¥Æ || this.HorizonCode_Horizon_È) {
                Gui_1808253012.HorizonCode_Horizon_È(this.ˆÏ­ + (int)(this.Â * (this.ÂµÈ - 8)), this.£á, this.ˆÏ­ + (int)(this.Â * (this.ÂµÈ - 8)) + 8, this.£á + 20, 2130706431);
            }
            else {
                Gui_1808253012.HorizonCode_Horizon_È(this.ˆÏ­ + (int)(this.Â * (this.ÂµÈ - 8)), this.£á, this.ˆÏ­ + (int)(this.Â * (this.ÂµÈ - 8)) + 8, this.£á + 20, Integer.MIN_VALUE);
            }
        }
    }
