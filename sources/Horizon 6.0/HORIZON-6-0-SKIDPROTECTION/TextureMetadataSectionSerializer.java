...
{
    private static final String HorizonCode_Horizon_È = "CL_00001115";
    
    public TextureMetadataSection HorizonCode_Horizon_È(final JsonElement p_deserialize_1_, final Type p_deserialize_2_, final JsonDeserializationContext p_deserialize_3_) {
        final JsonObject var4 = p_deserialize_1_.getAsJsonObject();
        final boolean var5 = JsonUtils.HorizonCode_Horizon_È(var4, "blur", false);
        final boolean var6 = JsonUtils.HorizonCode_Horizon_È(var4, "clamp", false);
