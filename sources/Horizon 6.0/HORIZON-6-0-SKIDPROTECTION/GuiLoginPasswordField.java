...
public final class GuiLoginPasswordField extends Gui_1808253012
{
    ...
    public GuiLoginPasswordField(final FontRenderer p_i1032_1_, final int p_i1032_2_, final int p_i1032_3_, final int p_i1032_4_, final int p_i1032_5_) {
        this.Ø­áŒŠá = true;
        this.à = true;
        this.Ø = "";
        this.áŒŠÆ = 32;
    ...
    public void HorizonCode_Horizon_È() {
        if (this.Â()) {
            if (this.Ý()) {
                Gui_1808253012.HorizonCode_Horizon_È(this.HorizonCode_Horizon_È - 1, this.Â + this.ÂµÈ + 2, this.HorizonCode_Horizon_È + this.áˆºÑ¢Õ + 0, this.Â + this.ÂµÈ - 19, 1342177280);
            }
