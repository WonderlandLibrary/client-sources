...
public class GuiGameOver extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        else
        {
            ...
            this.buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 96, "Main Screen"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, "§cHow could you?!", this.width / 2 / 2, 30, 16777215);
