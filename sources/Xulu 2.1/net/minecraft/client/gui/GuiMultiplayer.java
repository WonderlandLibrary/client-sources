...
import com.darkcart.xdolf.mods.player.protocolExploit;
...
public class GuiMultiplayer extends GuiScreen
{
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            {
            	//TODO: marker
            	if (GuiScreenProtocol.proto == 316) {
            		GuiScreenProtocol.proto = 315;
            		buttonList.get(7).displayString = "1.11";
            	} else {
            		GuiScreenProtocol.proto = 316;
            		buttonList.get(7).displayString = "1.11.1/1.11.2";
            	}
            	if(Hacks.findMod(protocolExploit.class).isEnabled()){
            		GuiScreenProtocol.proto = 325;
            	}
            	this.refreshServerList();
            }
        }
