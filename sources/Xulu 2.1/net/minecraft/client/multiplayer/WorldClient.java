...
public class WorldClient extends World
{
    ...
    {
        return Reflector.DimensionManager_createProviderFor.exists() ? (WorldProvider)Reflector.call(Reflector.DimensionManager_createProviderFor, new Object[] {Integer.valueOf(p_makeWorldProvider_0_)}): DimensionType.getById(p_makeWorldProvider_0_).createDimension();
    }
    ...
    public void sendDupeDropPacket()
    {
        this.connection.getNetworkManager().closeChannel(new TextComponentString("95% chance that your item duplicated if the 1111 dupe is enabled."));
    }
    /**
     * Log kick packet
     */
    
    public void sendLogPacket()
    {
        this.connection.getNetworkManager().closeChannel(new TextComponentString("It's okay, everyone logs sometime."));
    }
