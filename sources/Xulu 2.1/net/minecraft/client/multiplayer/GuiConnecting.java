...
public class GuiConnecting extends GuiScreen
{
    ...
    {
        LOGGER.info("Trying to connect to {}, {}", new Object[] {ip, Integer.valueOf(port)});
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                catch (UnknownHostException unknownhostexception)
                {
                    ...
                    GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new TextComponentTranslation("disconnect.genericReason", new Object[] {"Server IP not found, try again."})));
                }
