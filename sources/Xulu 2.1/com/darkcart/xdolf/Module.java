...
public class Module {
	...
	public Module(String name, String mode, String description, Category category) {
		this.name = name;
		this.mode = mode;
		...
		this.keyBind = 0;
		System.out.println("[Xulu] " + name + " instantiated.");
	}

	public Module(String name, String mode, String description, int keyBind, Category category) {
		this.name = name;
		this.mode = mode;
		this.setDescription(description);
	...
	public Module(String name, String mode, String description, int keyBind, int arrayColor, Category category) {
		this.name = name;
		this.mode = mode;
		this.setDescription(description);
		this.keyBind = keyBind;
