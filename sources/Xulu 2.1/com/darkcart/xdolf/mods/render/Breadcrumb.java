...
public class Breadcrumb extends Module {
	...
	public Breadcrumb() {
		super("breadcrumb", "Old", "Draws a trail behind the player.", Keyboard.KEYBOARD_SIZE, 0xCCFFCC, Category.RENDER);
	}
	...
	public void onRender() {
		if(this.isEnabled()) {	
			...
			for(double[] pos : positionsList) {
				...
				GL11.glColor4f(0.0F, 1.0F, 9.0F, 1.0F - (float)(distance / 100D));
