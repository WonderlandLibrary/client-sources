...
/**
 * Interface for WDL mods that handle entities that have non-standard purposes.
 * <br/>
 * This is for holograms and such that are vanilla minecraft entities being
 * (ab)used for new purposes. Use {@link IEntityAdder} for new entities. <br>
...
public interface ISpecialEntityHandler extends IWDLMod {
	 ...
	 * The given entity will always have its name be one of the keys in the map from
	 * {@link #getSpecialEntities()}, and the return value should be in the list
	 * from the value of that map for said key (or <code>null</code>).
	 * 
	 * @param entity
	 *            The entity to use.
	 * @return The special entity name, or null if it is not a special entity for
	 *         this mod.
	 */
	 ...
	 * The given name will always be in the list of values for one of the keys of
	 * {@link #getSpecialEntities()}. <br/>
