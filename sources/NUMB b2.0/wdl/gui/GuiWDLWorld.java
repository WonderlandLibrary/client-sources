...
public class GuiWDLWorld extends GuiScreen {
	...
	public void initGui() {
		...
		this.gamemodeBtn = new GuiButton(1, this.width / 2 - 100, y, this.getGamemodeText());
		this.buttonList.add(this.gamemodeBtn);
		y += 22;
		this.allowCheatsBtn = new GuiButton(6, this.width / 2 - 100, y, this.getAllowCheatsText());
		this.buttonList.add(this.allowCheatsBtn);
		y += 22;
		this.timeBtn = new GuiButton(2, this.width / 2 - 100, y, this.getTimeText());
		this.buttonList.add(this.timeBtn);
		y += 22;
		this.weatherBtn = new GuiButton(3, this.width / 2 - 100, y, this.getWeatherText());
		this.buttonList.add(this.weatherBtn);
		y += 22;
		this.spawnBtn = new GuiButton(4, this.width / 2 - 100, y, this.getSpawnText());
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.showSpawnFields) {
			this.drawString(this.fontRendererObj, "X:", this.width / 2 - 99, this.spawnTextY, 0xFFFFFF);
			this.drawString(this.fontRendererObj, "Y:", this.width / 2 - 31, this.spawnTextY, 0xFFFFFF);
			this.drawString(this.fontRendererObj, "Z:", this.width / 2 + 37, this.spawnTextY, 0xFFFFFF);
	...
	private String getAllowCheatsText() {
		return I18n.format("wdl.gui.world.allowCheats." + WDL.baseProps.getProperty("AllowCheats"));
	}

	private String getGamemodeText() {
		return I18n.format("wdl.gui.world.gamemode." + WDL.baseProps.getProperty("GameType"));
	}

	private String getTimeText() {
		String result = I18n.format("wdl.gui.world.time." + WDL.baseProps.getProperty("Time"));
	...
	private String getWeatherText() {
		return I18n.format("wdl.gui.world.weather." + WDL.baseProps.getProperty("Weather"));
	}

	private String getSpawnText() {
		return I18n.format("wdl.gui.world.spawn." + WDL.worldProps.getProperty("Spawn"));
	}
