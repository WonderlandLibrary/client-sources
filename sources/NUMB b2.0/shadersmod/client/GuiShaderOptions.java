...
public class GuiShaderOptions extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(201, this.width / 2 - btnWidth - 20, this.height / 6 + 168 + 11, btnWidth,
				btnHeight, I18n.format("controls.reset", new Object[0])));
		this.buttonList.add(new GuiButton(200, this.width / 2 + 20, this.height / 6 + 168 + 11, btnWidth, btnHeight,
	...
	private String getButtonText(ShaderOption so, int btnWidth) {
		...
		if (so instanceof ShaderOptionScreen) {
			...
			for (int lenSuffix = fr.getStringWidth(": " + Lang.getOff()) + 5; fr.getStringWidth(labelName)
					+ lenSuffix >= btnWidth
