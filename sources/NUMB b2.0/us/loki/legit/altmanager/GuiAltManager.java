...
import us.loki.legit.altmanager.files.Alts;
import us.loki.legit.utils.R2DUtils;
import mcleaks.GuiRedeemToken;
...
public class GuiAltManager extends GuiScreen {
	...
	public void actionPerformed(GuiButton button) throws IOException {
		...
		case 2: {
			...
			Client.instance();
			Client.fileManager.getFile(Alts.class).saveFile();
		...
		for (Alt alt2 : AltManager.registry) {
			...
			if (alt2 == this.selectedAlt) {
				if (this.isMouseOverAlt(par1, par2, y2 - this.offset) && Mouse.isButtonDown(0)) {
					R2DUtils.drawBorderedRect(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, 1.0f,
							-16777216, -2142943931);
