...
public class PasswordField extends Gui {
	...
	public PasswordField(final FontRenderer par1FontRenderer, final int par2, final int par3, final int par4,
			final int par5) {
		this.text = "";
	...
	public void mouseClicked(final int par1, final int par2, final int par3) {
		final boolean var4 = par1 >= this.xPos && par1 < this.xPos + this.width && par2 >= this.yPos
		...
		if (this.isFocused && par3 == 0) {
			...
			final String var6 = this.fontRenderer.trimStringToWidth(this.text.substring(this.field_73816_n),
					this.getWidth());
	...
	public void drawTextBox() {
		if (this.func_73778_q()) {
			if (this.getEnableBackgroundDrawing()) {
				Gui.drawRect(this.xPos - 1, this.yPos - 1, this.xPos + this.width + 1, this.yPos + this.height + 1,
						-6250336);
			...
			final String var4 = this.fontRenderer.trimStringToWidth(this.text.substring(this.field_73816_n),
					this.getWidth());
			...
			if (var4.length() > 0) {
				...
				var9 = Minecraft.getMinecraft().fontRendererObj.func_175063_a(this.text.replaceAll("(?s).", "*"), var7,
						var8, var1);
			}
			final boolean var10 = this.cursorPosition < this.text.length()
