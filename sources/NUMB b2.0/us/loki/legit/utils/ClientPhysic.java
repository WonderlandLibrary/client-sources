	...
	public static void doRender(Entity par1Entity, double x, double y, double z, float par8, float par9) {
		...
		if (itemstack.getItem() != null) {
			...
			if (TextureMap.locationBlocksTexture != null) {
				...
				mc.getRenderManager().renderEngine.getTexture(TextureMap.locationBlocksTexture).func_174936_b(false,
						false);
			...
			if ((item != null) && (!Double.isNaN(item.func_174872_o())) && (!Double.isNaN(item.getAir()))
