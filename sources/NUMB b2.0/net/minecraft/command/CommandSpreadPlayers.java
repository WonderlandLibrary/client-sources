...
public class CommandSpreadPlayers extends CommandBase {
		...
		if (args.length < 6) {
			...
			while (var17 < args.length) {
				...
				if (PlayerSelector.hasArguments(var15)) {
					...
					EntityPlayerMP var18 = MinecraftServer.getServer().getConfigurationManager()
			...
			if (var14.isEmpty()) {
				...
				sender.addChatMessage(new ChatComponentTranslation(
						...
						new Object[] { Integer.valueOf(var14.size()), Double.valueOf(var11), Double.valueOf(var5),
								Double.valueOf(var7), Double.valueOf(var9) }));
				this.func_110669_a(sender, var14, new CommandSpreadPlayers.Position(var5, var7), var9, var11,
	...
	private void func_110669_a(ICommandSender p_110669_1_, List p_110669_2_, CommandSpreadPlayers.Position p_110669_3_,
			double p_110669_4_, double p_110669_6_, World worldIn, boolean p_110669_9_) throws CommandException {
		...
		int var20 = this.func_110668_a(p_110669_3_, p_110669_4_, worldIn, var10, var11, var13, var15, var17, var19,
				p_110669_9_);
	...
	private double func_110671_a(List p_110671_1_, World worldIn, CommandSpreadPlayers.Position[] p_110671_3_,
			boolean p_110671_4_) {
		double var5 = 0.0D;
		int var7 = 0;
		...
		for (int var9 = 0; var9 < p_110671_1_.size(); ++var9) {
			...
			var10.setPositionAndUpdate((double) ((float) MathHelper.floor_double(var11.field_111101_a) + 0.5F),
					(double) var11.func_111092_a(worldIn),
