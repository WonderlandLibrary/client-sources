		...
		if (args.length < 1) {
			...
			if (args.length != 1 && args.length != 2) {
				if (args.length < var3 + 3) {
					...
					CommandBase.CoordinateArg var9 = func_175770_a((double) ((Entity) var4).rotationYaw,
							args.length > var14 ? args[var14++] : "~", false);
					CommandBase.CoordinateArg var10 = func_175770_a((double) ((Entity) var4).rotationPitch,
							args.length > var14 ? args[var14] : "~", false);
					float var12;
					...
					if (var4 instanceof EntityPlayerMP) {
						...
						((EntityPlayerMP) var4).playerNetServerHandler.func_175089_a(var6.func_179629_b(),
								var7.func_179629_b(), var8.func_179629_b(), var12, var13, var11);
						...
						((Entity) var4).setLocationAndAngles(var6.func_179628_a(), var7.func_179628_a(),
								var8.func_179628_a(), var15, var12);
						((Entity) var4).setRotationYawHead(var15);
					}

					notifyOperators(sender, this, "commands.tp.success.coordinates",
							new Object[] { ((Entity) var4).getName(), Double.valueOf(var6.func_179628_a()),
									Double.valueOf(var7.func_179628_a()), Double.valueOf(var8.func_179628_a()) });
				}
			} else {
				...
				if (var5.worldObj != ((Entity) var4).worldObj) {
					...
					if (var4 instanceof EntityPlayerMP) {
						((EntityPlayerMP) var4).playerNetServerHandler.setPlayerLocation(var5.posX, var5.posY,
								var5.posZ, var5.rotationYaw, var5.rotationPitch);
					} else {
						((Entity) var4).setLocationAndAngles(var5.posX, var5.posY, var5.posZ, var5.rotationYaw,
								var5.rotationPitch);
					}

					notifyOperators(sender, this, "commands.tp.success",
							new Object[] { ((Entity) var4).getName(), var5.getName() });
				}
			}
		}
	}
