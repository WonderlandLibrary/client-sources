...
public class CommandSummon extends CommandBase {
			...
			if (!var12.isBlockLoaded(var4)) {
				...
				if (var21 == null) {
					...
					if (!var14 && var21 instanceof EntityLiving) {
						((EntityLiving) var21).func_180482_a(var12.getDifficultyForLocation(new BlockPos(var21)),
					...
					for (NBTTagCompound var17 = var13; var16 != null
							&& var17.hasKey("Riding", 10); var17 = var17.getCompoundTag("Riding")) {
	...
	public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
		return args.length == 1 ? func_175762_a(args, EntityList.func_180124_b())
