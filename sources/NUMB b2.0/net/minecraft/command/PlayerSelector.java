...
public class PlayerSelector {
	...
	private static final Set field_179666_d = Sets
	...
	private static boolean func_179655_b(ICommandSender p_179655_0_, Map p_179655_1_) {
		...
		if (var2 != null && !EntityList.func_180125_b(var2)) {
			ChatComponentTranslation var3 = new ChatComponentTranslation("commands.generic.entity.invalidType",
					new Object[] { var2 });
			...
			var1.add(new Predicate() {
				...
				public boolean func_179625_a(Entity p_179625_1_) {
					if (!(p_179625_1_ instanceof EntityPlayerMP)) {
						...
						return (var2 <= -1 || var2x.experienceLevel >= var2)
								&& (var3 <= -1 || var2x.experienceLevel <= var3);
					}
				}
			...
			var1.add(new Predicate() {
				...
				public boolean func_179603_a(Entity p_179603_1_) {
					...
					do {
						...
						String var8 = p_179603_1_ instanceof EntityPlayerMP ? p_179603_1_.getName()
								: p_179603_1_.getUniqueID().toString();
	...
	private static List func_179660_a(Map p_179660_0_, Class p_179660_1_, List p_179660_2_, String p_179660_3_,
			World worldIn, BlockPos p_179660_5_) {
		...
		if (p_179660_5_ != null) {
			...
			if (!p_179660_0_.containsKey("dx") && !p_179660_0_.containsKey("dy") && !p_179660_0_.containsKey("dz")) {
				if (var13 >= 0) {
					var19 = new AxisAlignedBB((double) (p_179660_5_.getX() - var13),
							(double) (p_179660_5_.getY() - var13), (double) (p_179660_5_.getZ() - var13),
							(double) (p_179660_5_.getX() + var13 + 1), (double) (p_179660_5_.getY() + var13 + 1),
							(double) (p_179660_5_.getZ() + var13 + 1));
				...
				if (var8 && var18 && !var9) {
					Predicate var20 = new Predicate() {
						...
						public boolean func_179609_a(Entity p_179609_1_) {
							return p_179609_1_.posX >= var19.minX && p_179609_1_.posY >= var19.minY
									&& p_179609_1_.posZ >= var19.minZ
											? p_179609_1_.posX < var19.maxX && p_179609_1_.posY < var19.maxY
													&& p_179609_1_.posZ < var19.maxZ
											: false;
						}
	...
	private static List func_179658_a(List p_179658_0_, Map p_179658_1_, ICommandSender p_179658_2_, Class p_179658_3_,
			String p_179658_4_, final BlockPos p_179658_5_) {
			...
			Collections.sort((List) p_179658_0_, new Comparator() {
				...
				public int func_179611_a(Entity p_179611_1_, Entity p_179611_2_) {
					return ComparisonChain.start()
							.compare(p_179611_1_.getDistanceSq(p_179658_5_), p_179611_2_.getDistanceSq(p_179658_5_))
							.result();
				}
		...
		if (var7 != null && p_179658_3_.isAssignableFrom(var7.getClass()) && var6 == 1
				&& ((List) p_179658_0_).contains(var7) && !"r".equals(p_179658_4_)) {
	...
	private static AxisAlignedBB func_179661_a(BlockPos p_179661_0_, int p_179661_1_, int p_179661_2_,
		...
		return new AxisAlignedBB((double) var7, (double) var8, (double) var9, (double) var10, (double) var11,
				(double) var12);
	}
	...
	private static BlockPos func_179664_b(Map p_179664_0_, BlockPos p_179664_1_) {
		return new BlockPos(func_179653_a(p_179664_0_, "x", p_179664_1_.getX()),
				func_179653_a(p_179664_0_, "y", p_179664_1_.getY()),
				func_179653_a(p_179664_0_, "z", p_179664_1_.getZ()));
	}
	...
	public static Map func_96560_a(Map p_96560_0_) {
		...
		while (var2.hasNext()) {
			...
			if (var3.startsWith("score_") && var3.length() > "score_".length()) {
				var1.put(var3.substring("score_".length()),
						Integer.valueOf(MathHelper.parseIntWithDefault((String) p_96560_0_.get(var3), 1)));
			}
		}
