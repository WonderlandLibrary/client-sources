...
public class Chunk {
						...
						do {
							...
							if (var4 > 0) {
								...
								if (var7 != null) {
									...
									this.worldObj.notifyLightSet(new BlockPos((this.xPosition << 4) + var2, var5,
				...
				for (int var3 = 0; var3 < 16; ++var3) {
					if (this.updateSkylightColumns[var2 + var3 * 16]) {
						...
						for (var8 = EnumFacing.Plane.HORIZONTAL.iterator(); var8
								.hasNext(); var7 = Math.min(var7, this.worldObj.getChunksLowestHorizon(
						...
						while (var8.hasNext()) {
							var9 = (EnumFacing) var8.next();
							this.checkSkylightNeighborHeight(var5 + var9.getFrontOffsetX(),
									var6 + var9.getFrontOffsetZ(), var4);
						}
		...
		if (var5 != var4) {
					...
					for (var8 = var5; var8 < var4; ++var8) {
						...
						if (var9 != null) {
							...
							this.worldObj.notifyLightSet(
									new BlockPos((this.xPosition << 4) + x, var8, (this.zPosition << 4) + z));
						}
					}
				} else {
			...
			if (!this.worldObj.provider.getHasNoSky()) {
				...
				while (var11.hasNext()) {
					...
					this.updateSkylightNeighborHeight(var6 + var12.getFrontOffsetX(), var7 + var12.getFrontOffsetZ(),
							var13, var14);
				}
	...
	public IBlockState setBlockState(BlockPos p_177436_1_, IBlockState p_177436_2_) {
		...
		if (var8 == p_177436_2_) {
			...
			if (var11 == null) {
				...
				var11 = this.storageArrays[var4 >> 4] = new ExtendedBlockStorage(var4 >> 4 << 4,
			...
			if (var11.getBlockByExtId(var3, var4 & 15, var5) != var9) {
				...
				if (var12) {
					...
					if (var13 != var14 && (var13 < var14 || this.getLightFor(EnumSkyBlock.SKY, p_177436_1_) > 0
							|| this.getLightFor(EnumSkyBlock.BLOCK, p_177436_1_) > 0)) {
				...
				if (var9 instanceof ITileEntityProvider) {
					...
					if (var15 == null) {
						var15 = ((ITileEntityProvider) var9).createNewTileEntity(this.worldObj,
	...
	public int getLightFor(EnumSkyBlock p_177413_1_, BlockPos p_177413_2_) {
		...
		return var6 == null ? (this.canSeeSky(p_177413_2_) ? p_177413_1_.defaultLightValue : 0)
				: (p_177413_1_ == EnumSkyBlock.SKY
						? (this.worldObj.provider.getHasNoSky() ? 0 : var6.getExtSkylightValue(var3, var4 & 15, var5))
	...
	public void setLightFor(EnumSkyBlock p_177431_1_, BlockPos p_177431_2_, int p_177431_3_) {
		...
		if (var7 == null) {
			var7 = this.storageArrays[var5 >> 4] = new ExtendedBlockStorage(var5 >> 4 << 4,
					!this.worldObj.provider.getHasNoSky());
			this.generateSkylightMap();
		}
	...
	public int setLight(BlockPos p_177443_1_, int p_177443_2_) {
		...
		if (var6 == null) {
			return !this.worldObj.provider.getHasNoSky() && p_177443_2_ < EnumSkyBlock.SKY.defaultLightValue
					? EnumSkyBlock.SKY.defaultLightValue - p_177443_2_
					: 0;
		} else {
	...
	public void addEntity(Entity entityIn) {
		...
		if (var2 != this.xPosition || var3 != this.zPosition) {
			logger.warn("Wrong location! (" + var2 + ", " + var3 + ") should be (" + this.xPosition + ", "
					+ this.zPosition + "), " + entityIn, new Object[] { entityIn });
			entityIn.setDead();
		}
	...
	private TileEntity createNewTileEntity(BlockPos pos) {
		...
		return !var2.hasTileEntity() ? null
				: ((ITileEntityProvider) var2).createNewTileEntity(this.worldObj, this.getBlockMetadata(pos));
	}
	...
	public void func_150804_b(boolean p_150804_1_) {
		...
		while (!this.field_177447_w.isEmpty()) {
			...
			if (this.func_177424_a(var2, Chunk.EnumCreateEntityType.CHECK) == null
					&& this.getBlock(var2).hasTileEntity()) {
	...
	public void enqueueRelightChecks() {
		...
		for (int var2 = 0; var2 < 8; ++var2) {
			...
			for (int var6 = 0; var6 < 16; ++var6) {
				...
				if (this.storageArrays[var3] == null && var8 || this.storageArrays[var3] != null
						&& this.storageArrays[var3].getBlockByExtId(var4, var6, var5).getMaterial() == Material.air) {
			...
			if (this.worldObj.isAreaLoaded(var1.add(-1, 0, -1), var1.add(16, 63, 16))) {
				...
				if (this.isLightPopulated) {
					...
					while (var5.hasNext()) {
						...
						this.worldObj.getChunkFromBlockCoords(var1.offset(var6, var4))
								.func_180700_a(var6.getOpposite());
					}
	...
	public static enum EnumCreateEntityType {
		...
		private static final Chunk.EnumCreateEntityType[] $VALUES = new Chunk.EnumCreateEntityType[] { IMMEDIATE,
				QUEUED, CHECK };
