...
public class Teleporter {
			...
			for (int var8 = -2; var8 <= 2; ++var8) {
				for (int var9 = -2; var9 <= 2; ++var9) {
					for (int var10 = -1; var10 < 3; ++var10) {
						...
						this.worldServerInstance.setBlockState(new BlockPos(var11, var12, var13),
								var14 ? Blocks.obsidian.getDefaultState() : Blocks.air.getDefaultState());
					}
				}
			}

			p_180266_1_.setLocationAndAngles((double) var3, (double) var4, (double) var5, p_180266_1_.rotationYaw,
					0.0F);
	...
	public boolean func_180620_b(Entity p_180620_1_, float p_180620_2_) {
		...
		if (this.destinationCoordinateCache.containsItem(var10)) {
			Teleporter.PortalPosition var12 = (Teleporter.PortalPosition) this.destinationCoordinateCache
					.getValueByKey(var10);
			var4 = 0.0D;
			var9 = var12;
			...
			for (int var13 = -128; var13 <= 128; ++var13) {
				...
				for (int var14 = -128; var14 <= 128; ++var14) {
					for (BlockPos var15 = var34.add(var13,
							this.worldServerInstance.getActualHeight() - 1 - var34.getY(), var14); var15
									.getY() >= 0; var15 = var16) {
						var16 = var15.offsetDown();

						if (this.worldServerInstance.getBlockState(var15).getBlock() == Blocks.portal) {
							while (this.worldServerInstance.getBlockState(var16 = var15.offsetDown())
		...
		if (var4 >= 0.0D) {
			if (var8) {
				this.destinationCoordinateCache.add(var10,
						new Teleporter.PortalPosition((BlockPos) var9, this.worldServerInstance.getTotalWorldTime()));
			...
			if (var18 != null) {
				...
				p_180620_1_.rotationYaw = p_180620_2_ - (float) (var19.getHorizontalIndex() * 90)
						+ (float) (var18.getHorizontalIndex() * 90);
			} else {
	...
	private boolean func_180265_a(BlockPos p_180265_1_) {
		return !this.worldServerInstance.isAirBlock(p_180265_1_)
				|| !this.worldServerInstance.isAirBlock(p_180265_1_.offsetUp());
	}
			...
			for (var16 = var7 - var2; var16 <= var7 + var2; ++var16) {
				...
				for (var19 = this.worldServerInstance.getActualHeight() - 1; var19 >= 0; --var19) {
					if (this.worldServerInstance.isAirBlock(new BlockPos(var13, var19, var16))) {
						while (var19 > 0
								&& this.worldServerInstance.isAirBlock(new BlockPos(var13, var19 - 1, var16))) {
							--var19;
						}
									...
									for (var25 = -1; var25 < 4; ++var25) {
										...
										if (var25 < 0
												&& !this.worldServerInstance
														.getBlockState(new BlockPos(var26, var27, var28)).getBlock()
														.getMaterial().isSolid()
												|| var25 >= 0 && !this.worldServerInstance
														.isAirBlock(new BlockPos(var26, var27, var28))) {
											continue label271;
										}
									}
								}
							...
							for (var20 = var12; var20 < var12 + 2; ++var20) {
								...
								for (var23 = 0; var23 < 4; ++var23) {
									for (var24 = -1; var24 < 4; ++var24) {
										...
										if (var24 < 0
												&& !this.worldServerInstance
														.getBlockState(new BlockPos(var25, var26, var27)).getBlock()
														.getMaterial().isSolid()
												|| var24 >= 0 && !this.worldServerInstance
														.isAirBlock(new BlockPos(var25, var26, var27))) {
											continue label219;
										}
									}
								}
			...
			for (var19 = -1; var19 <= 1; ++var19) {
				for (var20 = 1; var20 < 3; ++var20) {
					for (var21 = -1; var21 < 3; ++var21) {
						...
						this.worldServerInstance.setBlockState(new BlockPos(var22, var23, var24),
								var34 ? Blocks.obsidian.getDefaultState() : Blocks.air.getDefaultState());
					}
				}
			}
		}

		IBlockState var31 = Blocks.portal.getDefaultState().withProperty(BlockPortal.field_176550_a,
				var30 != 0 ? EnumFacing.Axis.X : EnumFacing.Axis.Z);
		...
		for (var20 = 0; var20 < 4; ++var20) {
			for (var21 = 0; var21 < 4; ++var21) {
				for (var22 = -1; var22 < 4; ++var22) {
					...
					this.worldServerInstance.setBlockState(new BlockPos(var23, var24, var25),
							var35 ? Blocks.obsidian.getDefaultState() : var31, 2);
				}
			}
			...
			for (var21 = 0; var21 < 4; ++var21) {
				for (var22 = -1; var22 < 4; ++var22) {
					...
					var24 = var15 + var22;
					var25 = var16 + (var21 - 1) * var18;
					this.worldServerInstance.notifyNeighborsOfStateChange(new BlockPos(var23, var24, var25),
							this.worldServerInstance.getBlockState(new BlockPos(var23, var24, var25)).getBlock());
				}
			}
		}
