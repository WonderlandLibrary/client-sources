...
public class Explosion {
	...
	public Explosion(World worldIn, Entity p_i45752_2_, double p_i45752_3_, double p_i45752_5_, double p_i45752_7_,
			float p_i45752_9_, List p_i45752_10_) {
	...
	public Explosion(World worldIn, Entity p_i45753_2_, double p_i45753_3_, double p_i45753_5_, double p_i45753_7_,
			float p_i45753_9_, boolean p_i45753_10_, boolean p_i45753_11_, List p_i45753_12_) {
	...
	public void doExplosionA() {
				...
				for (var5 = 0; var5 < 16; ++var5) {
					if (var3 == 0 || var3 == 15 || var4 == 0 || var4 == 15 || var5 == 0 || var5 == 15) {
						...
						for (float var21 = 0.3F; var14 > 0.0F; var14 -= 0.22500001F) {
							...
							if (var14 > 0.0F && (this.exploder == null
		...
		List var33 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this.exploder, new AxisAlignedBB((double) var4,
				(double) var31, (double) var32, (double) var5, (double) var7, (double) var9));
			...
			if (!var13.func_180427_aV()) {
				...
				if (var35 <= 1.0D) {
					...
					if (var36 != 0.0D) {
						...
						var13.attackEntityFrom(DamageSource.setExplosionSource(this),
						...
						if (var13 instanceof EntityPlayer) {
							this.field_77288_k.put((EntityPlayer) var13,
									new Vec3(var16 * var26, var18 * var26, var20 * var26));
						}
					}
				}
			}
	...
	public void doExplosionB(boolean p_77279_1_) {
			...
			while (var2.hasNext()) {
				...
				if (p_77279_1_) {
					...
					this.worldObj.spawnParticle(EnumParticleTypes.EXPLOSION_NORMAL,
							(var5 + this.explosionX * 1.0D) / 2.0D, (var7 + this.explosionY * 1.0D) / 2.0D,
							(var9 + this.explosionZ * 1.0D) / 2.0D, var11, var13, var15, new int[0]);
				...
				if (var4.getMaterial() != Material.air) {
					if (var4.canDropFromExplosion(this)) {
						var4.dropBlockAsItemWithChance(this.worldObj, var3, this.worldObj.getBlockState(var3),
		...
		if (this.isFlaming) {
			...
			while (var2.hasNext()) {
				...
				if (this.worldObj.getBlockState(var3).getBlock().getMaterial() == Material.air
						&& this.worldObj.getBlockState(var3.offsetDown()).getBlock().isFullBlock()
