...
public class WorldGenSwamp extends WorldGenAbstractTree {
	...
	public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_) {
		...
		for (var4 = p_180709_2_.nextInt(4) + 5; worldIn.getBlockState(p_180709_3_.offsetDown()).getBlock()
				.getMaterial() == Material.water; p_180709_3_ = p_180709_3_.offsetDown()) {
			;
		}
				...
				if ((var17 == Blocks.grass || var17 == Blocks.dirt) && p_180709_3_.getY() < 256 - var4 - 1) {
					...
					for (var18 = 0; var18 < var4; ++var18) {
						...
						if (var19.getMaterial() == Material.air || var19.getMaterial() == Material.leaves
								|| var19 == Blocks.flowing_water || var19 == Blocks.water) {
						...
						for (var20 = p_180709_3_.getX() - var9; var20 <= p_180709_3_.getX() + var9; ++var20) {
							for (var11 = p_180709_3_.getZ() - var9; var11 <= p_180709_3_.getZ() + var9; ++var11) {
								...
								if (worldIn.getBlockState(var21).getBlock().getMaterial() == Material.leaves) {
									...
									if (p_180709_2_.nextInt(4) == 0
											&& worldIn.getBlockState(var22).getBlock().getMaterial() == Material.air) {
										this.func_175922_a(worldIn, var22, BlockVine.field_176275_S);
									}

									if (p_180709_2_.nextInt(4) == 0
											&& worldIn.getBlockState(var14).getBlock().getMaterial() == Material.air) {
										this.func_175922_a(worldIn, var14, BlockVine.field_176271_T);
									}

									if (p_180709_2_.nextInt(4) == 0
											&& worldIn.getBlockState(var15).getBlock().getMaterial() == Material.air) {
										this.func_175922_a(worldIn, var15, BlockVine.field_176272_Q);
									}

									if (p_180709_2_.nextInt(4) == 0
											&& worldIn.getBlockState(var16).getBlock().getMaterial() == Material.air) {
	...
	private void func_175922_a(World worldIn, BlockPos p_175922_2_, int p_175922_3_) {
		...
		for (p_175922_2_ = p_175922_2_
				.offsetDown(); worldIn.getBlockState(p_175922_2_).getBlock().getMaterial() == Material.air
						&& var4 > 0; --var4) {
			this.func_175905_a(worldIn, p_175922_2_, Blocks.vine, p_175922_3_);
