				...
				if ((var18 == Blocks.grass || var18 == Blocks.dirt) && p_180709_3_.getY() < 256 - var4 - 1) {
					...
					for (var13 = 0; var13 < var4; ++var13) {
						...
						if (var16 == Material.air || var16 == Material.leaves) {
							this.func_175905_a(worldIn, var15, Blocks.log2,
									BlockPlanks.EnumType.DARK_OAK.func_176839_a() - 4);
							this.func_175905_a(worldIn, var15.offsetEast(), Blocks.log2,
									BlockPlanks.EnumType.DARK_OAK.func_176839_a() - 4);
							this.func_175905_a(worldIn, var15.offsetSouth(), Blocks.log2,
									BlockPlanks.EnumType.DARK_OAK.func_176839_a() - 4);
							this.func_175905_a(worldIn, var15.offsetEast().offsetSouth(), Blocks.log2,
									BlockPlanks.EnumType.DARK_OAK.func_176839_a() - 4);
							var12 = var14;
						}
					}
							...
							if ((var13 < 0 || var13 > 1 || var14 < 0 || var14 > 1) && p_180709_2_.nextInt(3) <= 0) {
								...
								for (var23 = -1; var23 <= 1; ++var23) {
									for (var17 = -1; var17 <= 1; ++var17) {
										this.func_150526_a(worldIn, var10 + var13 + var23, var12 - 0,
												var11 + var14 + var17);
									}
								}
								...
								for (var23 = -2; var23 <= 2; ++var23) {
									for (var17 = -2; var17 <= 2; ++var17) {
										if (Math.abs(var23) != 2 || Math.abs(var17) != 2) {
											this.func_150526_a(worldIn, var10 + var13 + var23, var12 - 1,
													var11 + var14 + var17);
										}
									}
								}
