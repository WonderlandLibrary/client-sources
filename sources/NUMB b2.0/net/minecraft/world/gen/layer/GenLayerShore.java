...
public class GenLayerShore extends GenLayer {
			...
			for (int var8 = 0; var8 < areaWidth; ++var8) {
				...
				if (var9 == BiomeGenBase.mushroomIsland.biomeID) {
					...
					if (this.func_151631_c(var11) && this.func_151631_c(var12) && this.func_151631_c(var13)
						...
						if (!isBiomeOceanic(var11) && !isBiomeOceanic(var12) && !isBiomeOceanic(var13)
								&& !isBiomeOceanic(var14)) {
							var6[var8 + var7 * areaWidth] = var9;
						} else {
				...
				} else if (var9 != BiomeGenBase.extremeHills.biomeID && var9 != BiomeGenBase.extremeHillsPlus.biomeID
					...
					if (var10 != null && var10.isSnowyBiome()) {
						...
						if (var9 != BiomeGenBase.ocean.biomeID && var9 != BiomeGenBase.deepOcean.biomeID
	...
	private boolean func_151631_c(int p_151631_1_) {
		return BiomeGenBase.getBiome(p_151631_1_) != null
				&& BiomeGenBase.getBiome(p_151631_1_).getBiomeClass() == BiomeGenJungle.class
						? true
