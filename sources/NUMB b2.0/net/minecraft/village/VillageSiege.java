...
public class VillageSiege {
					...
					while (true) {
						if (var7 < 10) {
							...
							while (var9.hasNext()) {
								...
								if (var10 != this.theVillage && var10.func_179866_a(
	...
	private boolean spawnZombie() {
		...
		if (var1 == null) {
			...
			try {
				...
				var2.func_180482_a(this.worldObj.getDifficultyForLocation(new BlockPos(var2)),
	...
	private Vec3 func_179867_a(BlockPos p_179867_1_) {
		for (int var2 = 0; var2 < 10; ++var2) {
			BlockPos var3 = p_179867_1_.add(this.worldObj.rand.nextInt(16) - 8, this.worldObj.rand.nextInt(6) - 3,
					this.worldObj.rand.nextInt(16) - 8);

			if (this.theVillage.func_179866_a(var3)
					&& SpawnerAnimals.func_180267_a(EntityLiving.SpawnPlacementType.ON_GROUND, this.worldObj, var3)) {
