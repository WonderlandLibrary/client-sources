...
public class TileEntityEnderChest extends TileEntity implements IUpdatePlayerListBox {
	...
	public void update() {
		...
		if (this.field_145973_j > 0 && this.field_145972_a == 0.0F) {
			...
			this.worldObj.playSoundEffect(var5, (double) var2 + 0.5D, var7, "random.chestopen", 0.5F,
		...
		if (this.field_145973_j == 0 && this.field_145972_a > 0.0F
			...
			if (this.field_145972_a < var6 && var11 >= var6) {
				...
				this.worldObj.playSoundEffect(var7, (double) var2 + 0.5D, var9, "random.chestclosed", 0.5F,
						this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
			}
	...
	public boolean func_145971_a(EntityPlayer p_145971_1_) {
		return this.worldObj.getTileEntity(this.pos) != this ? false
				: p_145971_1_.getDistanceSq((double) this.pos.getX() + 0.5D, (double) this.pos.getY() + 0.5D,
