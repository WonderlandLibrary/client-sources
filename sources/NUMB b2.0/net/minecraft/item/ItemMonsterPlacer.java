...
public class ItemMonsterPlacer extends Item {
	...
	public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side,
		...
		if (worldIn.isRemote) {
			...
			Entity var12 = spawnCreature(worldIn, stack.getMetadata(), (double) pos.getX() + 0.5D,
					(double) pos.getY() + var13, (double) pos.getZ() + 0.5D);
			...
			if (var4 == null) {
				...
				if (var4.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
					...
					if (worldIn.getBlockState(var5).getBlock() instanceof BlockLiquid) {
						Entity var6 = spawnCreature(worldIn, itemStackIn.getMetadata(), (double) var5.getX() + 0.5D,
								(double) var5.getY() + 0.5D, (double) var5.getZ() + 0.5D);
	 ...
	 */
	public static Entity spawnCreature(World worldIn, int p_77840_1_, double p_77840_2_, double p_77840_4_,
			double p_77840_6_) {
