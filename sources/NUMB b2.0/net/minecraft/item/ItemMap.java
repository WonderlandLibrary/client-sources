...
public class ItemMap extends ItemMapBase {
	...
	public MapData getMapData(ItemStack p_77873_1_, World worldIn) {
		...
		if (var4 == null && !worldIn.isRemote) {
			...
			var4.scale = 3;
			var4.func_176054_a((double) worldIn.getWorldInfo().getSpawnX(), (double) worldIn.getWorldInfo().getSpawnZ(),
					var4.scale);
						...
						if (var12 >= 0 && var15 >= -1 && var12 < 128 && var15 < 128) {
							...
							if (!var22.isEmpty()) {
								...
								if (worldIn.provider.getHasNoSky()) {
									...
									if ((var28 >> 20 & 1) == 0) {
										var21.add(Blocks.dirt.getMapColor(Blocks.dirt.getDefaultState()
												.withProperty(BlockDirt.VARIANT, BlockDirt.DirtType.DIRT)), 10);
									} else {
										var21.add(Blocks.stone.getMapColor(Blocks.stone.getDefaultState()
												.withProperty(BlockStone.VARIANT_PROP, BlockStone.EnumType.STONE)),
												100);
									}
									...
									for (var28 = 0; var28 < var4; ++var28) {
										for (int var29 = 0; var29 < var4; ++var29) {
											...
											if (var30 > 1) {
												do {
													--var30;
													var31 = var22.getBlockState(
															new BlockPos(var28 + var23, var30, var29 + var24));
												} while (var31.getBlock().getMapColor(var31) == MapColor.airColor
														&& var30 > 0);
								...
								var25 /= var4 * var4;
								double var34 = (var26 - var13) * 4.0D / (double) (var4 + 4)
										+ ((double) (var12 + var15 & 1) - 0.5D) * 0.4D;
								byte var35 = 1;
								...
								MapColor var36 = (MapColor) Iterables.getFirst(Multisets.copyHighestCountFirst(var21),
										MapColor.airColor);
								...
								if (var15 >= 0 && var16 * var16 + var17 * var17 < var9 * var9
										&& (!var18 || (var12 + var15 & 1) != 0)) {
