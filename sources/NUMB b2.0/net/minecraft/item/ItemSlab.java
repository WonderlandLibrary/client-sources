...
public class ItemSlab extends ItemBlock {
		...
		if (stack.stackSize == 0) {
			...
			if (var10.getBlock() == this.field_150949_c) {
				...
				if ((side == EnumFacing.UP && var13 == BlockSlab.EnumBlockHalf.BOTTOM
					...
					if (worldIn.checkNoEntityCollision(this.field_179226_c.getCollisionBoundingBox(worldIn, pos, var14))
						...
						worldIn.playSoundEffect((double) ((float) pos.getX() + 0.5F),
								...
								this.field_179226_c.stepSound.getPlaceSound(),
								(this.field_179226_c.stepSound.getVolume() + 1.0F) / 2.0F,
								this.field_179226_c.stepSound.getFrequency() * 0.8F);
						--stack.stackSize;
					}
			...
			return this.func_180615_a(stack, worldIn, pos.offset(side), var9) ? true
	...
	public boolean canPlaceBlockOnSide(World worldIn, BlockPos p_179222_2_, EnumFacing p_179222_3_,
		...
		return var11.getBlock() == this.field_150949_c && var8 == var11.getValue(var7) ? true
	...
	private boolean func_180615_a(ItemStack p_180615_1_, World worldIn, BlockPos p_180615_3_, Object p_180615_4_) {
		...
		if (var5.getBlock() == this.field_150949_c) {
			...
			if (var6 == p_180615_4_) {
				IBlockState var7 = this.field_179226_c.getDefaultState()
						.withProperty(this.field_150949_c.func_176551_l(), var6);

				if (worldIn
						.checkNoEntityCollision(this.field_179226_c.getCollisionBoundingBox(worldIn, p_180615_3_, var7))
						&& worldIn.setBlockState(p_180615_3_, var7, 3)) {
					worldIn.playSoundEffect((double) ((float) p_180615_3_.getX() + 0.5F),
							(double) ((float) p_180615_3_.getY() + 0.5F), (double) ((float) p_180615_3_.getZ() + 0.5F),
							this.field_179226_c.stepSound.getPlaceSound(),
							(this.field_179226_c.stepSound.getVolume() + 1.0F) / 2.0F,
							this.field_179226_c.stepSound.getFrequency() * 0.8F);
