			...
			if (var9 == EnumDyeColor.WHITE) {
				...
				if (var11 == Blocks.log && var10.getValue(BlockPlanks.VARIANT_PROP) == BlockPlanks.EnumType.JUNGLE) {
					...
					if (worldIn.isAirBlock(pos)) {
						IBlockState var12 = Blocks.cocoa.onBlockPlaced(worldIn, pos, side, hitX, hitY, hitZ, 0,
								playerIn);
		...
		if (var3.getMaterial() != Material.air) {
			...
			for (int var4 = 0; var4 < p_180617_2_; ++var4) {
				...
				worldIn.spawnParticle(EnumParticleTypes.VILLAGER_HAPPY,
						(double) ((float) p_180617_1_.getX() + itemRand.nextFloat()),
						(double) p_180617_1_.getY() + (double) itemRand.nextFloat() * var3.getBlockBoundsMaxY(),
						(double) ((float) p_180617_1_.getZ() + itemRand.nextFloat()), var5, var7, var9, new int[0]);
			}
		}
	}
