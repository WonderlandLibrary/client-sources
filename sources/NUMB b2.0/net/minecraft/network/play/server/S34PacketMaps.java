...
public class S34PacketMaps implements Packet {
	...
	public S34PacketMaps(int p_i45975_1_, byte p_i45975_2_, Collection p_i45975_3_, byte[] p_i45975_4_, int p_i45975_5_,
			int p_i45975_6_, int p_i45975_7_, int p_i45975_8_) {
		...
		for (int var9 = 0; var9 < p_i45975_7_; ++var9) {
			for (int var10 = 0; var10 < p_i45975_8_; ++var10) {
				this.field_179741_h[var9 + var10 * p_i45975_7_] = p_i45975_4_[p_i45975_5_ + var9
	...
	public void readPacketData(PacketBuffer data) throws IOException {
		...
		for (int var2 = 0; var2 < this.field_179740_c.length; ++var2) {
			...
			this.field_179740_c[var2] = new Vec4b((byte) (var3 >> 4 & 15), data.readByte(), data.readByte(),
					(byte) (var3 & 15));
		}
	...
	public void func_179734_a(MapData p_179734_1_) {
		...
		for (var2 = 0; var2 < this.field_179735_f; ++var2) {
			for (int var4 = 0; var4 < this.field_179736_g; ++var4) {
				p_179734_1_.colors[this.field_179737_d + var2
						+ (this.field_179738_e + var4) * 128] = this.field_179741_h[var2 + var4 * this.field_179735_f];
			}
		}
	}
