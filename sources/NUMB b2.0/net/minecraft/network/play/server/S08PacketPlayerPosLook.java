...
public class S08PacketPlayerPosLook implements Packet {
	...
	public S08PacketPlayerPosLook(double p_i45993_1_, double p_i45993_3_, double p_i45993_5_, float p_i45993_7_,
			float p_i45993_8_, Set p_i45993_9_) {
	...
	public static enum EnumFlags {
		...
		private static final S08PacketPlayerPosLook.EnumFlags[] $VALUES = new S08PacketPlayerPosLook.EnumFlags[] { X, Y,
				Z, Y_ROT, X_ROT };
