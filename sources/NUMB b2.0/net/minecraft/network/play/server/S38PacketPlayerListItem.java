...
public class S38PacketPlayerListItem implements Packet {
	...
	public S38PacketPlayerListItem(S38PacketPlayerListItem.Action p_i45967_1_, EntityPlayerMP... p_i45967_2_) {
		...
		for (int var5 = 0; var5 < var4; ++var5) {
			...
			this.field_179769_b.add(new S38PacketPlayerListItem.AddPlayerData(var6.getGameProfile(), var6.ping,
	...
	public S38PacketPlayerListItem(S38PacketPlayerListItem.Action p_i45968_1_, Iterable p_i45968_2_) {
		...
		while (var3.hasNext()) {
			...
			this.field_179769_b.add(new S38PacketPlayerListItem.AddPlayerData(var4.getGameProfile(), var4.ping,
	...
	public static enum Action {
		...
		private static final S38PacketPlayerListItem.Action[] $VALUES = new S38PacketPlayerListItem.Action[] {
	...
	public class AddPlayerData {
		...
		public AddPlayerData(GameProfile p_i45965_2_, int p_i45965_3_, WorldSettings.GameType p_i45965_4_,
				IChatComponent p_i45965_5_) {
