...
public class ModelGuardian extends ModelBase {
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_,
		...
		for (int var17 = 0; var17 < 12; ++var17) {
			...
			this.guardianSpines[var17].rotationPointX = var13[var17]
					* (1.0F + MathHelper.cos(p_78087_3_ * 1.5F + (float) var17) * 0.01F - var16);
			this.guardianSpines[var17].rotationPointY = 16.0F
					+ var14[var17] * (1.0F + MathHelper.cos(p_78087_3_ * 1.5F + (float) var17) * 0.01F - var16);
			this.guardianSpines[var17].rotationPointZ = var15[var17]
					* (1.0F + MathHelper.cos(p_78087_3_ * 1.5F + (float) var17) * 0.01F - var16);
		}
		...
		if (var26 != null) {
			...
			Vec3 var23 = (new Vec3(var19.xCoord - var18.xCoord, 0.0D, var19.zCoord - var18.zCoord)).normalize()
					.rotateYaw(((float) Math.PI / 2F));
			double var24 = var22.dotProduct(var23);
			this.guardianEye.rotationPointX = MathHelper.sqrt_float((float) Math.abs(var24)) * 2.0F
