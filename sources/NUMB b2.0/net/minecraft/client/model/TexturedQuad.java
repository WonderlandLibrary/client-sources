...
public class TexturedQuad {
	...
	public TexturedQuad(PositionTextureVertex[] vertices, int texcoordU1, int texcoordV1, int texcoordU2,
		...
		vertices[0] = vertices[0].setTexturePosition((float) texcoordU2 / textureWidth - var8,
				(float) texcoordV1 / textureHeight + var9);
		vertices[1] = vertices[1].setTexturePosition((float) texcoordU1 / textureWidth + var8,
				(float) texcoordV1 / textureHeight + var9);
		vertices[2] = vertices[2].setTexturePosition((float) texcoordU1 / textureWidth + var8,
				(float) texcoordV2 / textureHeight - var9);
		vertices[3] = vertices[3].setTexturePosition((float) texcoordU2 / textureWidth - var8,
				(float) texcoordV2 / textureHeight - var9);
	}
	...
	public void func_178765_a(WorldRenderer renderer, float scale) {
		...
		for (int var6 = 0; var6 < 4; ++var6) {
			...
			renderer.addVertexWithUV(var7.vector3D.xCoord * (double) scale, var7.vector3D.yCoord * (double) scale,
					var7.vector3D.zCoord * (double) scale, (double) var7.texturePositionX,
