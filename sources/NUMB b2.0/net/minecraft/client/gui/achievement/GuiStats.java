...
public class GuiStats extends GuiScreen implements IProgressMeter {
	...
	public void createButtons() {
		...
		GuiButton var2;
		GuiButton var3;
		this.buttonList.add(var1 = new GuiButton(2, this.width / 2 - 80, this.height - 52, 80, 20,
				I18n.format("stat.blocksButton", new Object[0])));
		this.buttonList.add(var2 = new GuiButton(3, this.width / 2, this.height - 52, 80, 20,
				I18n.format("stat.itemsButton", new Object[0])));
		this.buttonList.add(var3 = new GuiButton(4, this.width / 2 + 80, this.height - 52, 80, 20,
	...
	private void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
		...
		var10.addVertexWithUV((double) (p_146527_1_ + 0), (double) (p_146527_2_ + 18), (double) this.zLevel,
				(double) ((float) (p_146527_3_ + 0) * 0.0078125F), (double) ((float) (p_146527_4_ + 18) * 0.0078125F));
		var10.addVertexWithUV((double) (p_146527_1_ + 18), (double) (p_146527_2_ + 18), (double) this.zLevel,
				(double) ((float) (p_146527_3_ + 18) * 0.0078125F), (double) ((float) (p_146527_4_ + 18) * 0.0078125F));
		var10.addVertexWithUV((double) (p_146527_1_ + 18), (double) (p_146527_2_ + 0), (double) this.zLevel,
				(double) ((float) (p_146527_3_ + 18) * 0.0078125F), (double) ((float) (p_146527_4_ + 0) * 0.0078125F));
		var10.addVertexWithUV((double) (p_146527_1_ + 0), (double) (p_146527_2_ + 0), (double) this.zLevel,
		...
		protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_) {
			if (p_148213_1_ != null) {
				...
				if (var7.length() > 0) {
					...
					GuiStats.this.drawGradientRect(var8 - 3, var9 - 3, var8 + var10 + 3, var9 + 8 + 3, -1073741824,
							-1073741824);
			...
			while (var3.hasNext()) {
				...
				if (GuiStats.this.field_146546_t.writeStat(var4) > 0) {
					var5 = true;
						...
						&& GuiStats.this.field_146546_t.writeStat(StatList.objectUseStats[var6]) > 0) {
					var5 = true;
	...
	class StatsGeneral extends GuiSlot {
		...
		protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_,
			...
			GuiStats.this.drawString(GuiStats.this.fontRendererObj, var7.getStatName().getUnformattedText(),
					p_180791_2_ + 2, p_180791_3_ + 1, p_180791_1_ % 2 == 0 ? 16777215 : 9474192);
			String var8 = var7.func_75968_a(GuiStats.this.field_146546_t.writeStat(var7));
			GuiStats.this.drawString(GuiStats.this.fontRendererObj, var8,
	...
	class StatsMobsList extends GuiSlot {
		...
		public StatsMobsList(Minecraft mcIn) {
			...
			while (var3.hasNext()) {
				...
				if (GuiStats.this.field_146546_t.writeStat(var4.field_151512_d) > 0
						|| GuiStats.this.field_146546_t.writeStat(var4.field_151513_e) > 0) {
		...
		protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_,
			...
			GuiStats.this.drawString(GuiStats.this.fontRendererObj, var8, p_180791_2_ + 2 - 10, p_180791_3_ + 1,
					16777215);
			GuiStats.this.drawString(GuiStats.this.fontRendererObj, var11, p_180791_2_ + 2,
					p_180791_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT, var9 == 0 ? 6316128 : 9474192);
			GuiStats.this.drawString(GuiStats.this.fontRendererObj, var12, p_180791_2_ + 2,
