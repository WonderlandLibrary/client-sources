...
public class GuiSlider extends GuiButton {
	...
	public GuiSlider(GuiPageButtonList.GuiResponder p_i45541_1_, int p_i45541_2_, int p_i45541_3_, int p_i45541_4_,
			String p_i45541_5_, float p_i45541_6_, float p_i45541_7_, float p_i45541_8_,
			GuiSlider.FormatHelper p_i45541_9_) {
	...
	private String func_175221_e() {
		return this.field_175222_u == null
				? I18n.format(this.field_175226_q, new Object[0]) + ": " + this.func_175220_c()
				: this.field_175222_u.func_175318_a(this.id, I18n.format(this.field_175226_q, new Object[0]),
						this.func_175220_c());
	}
	...
	protected void mouseDragged(Minecraft mc, int mouseX, int mouseY) {
		if (this.visible) {
			...
			this.drawTexturedModalRect(this.xPosition + (int) (this.field_175227_p * (float) (this.width - 8)),
					this.yPosition, 0, 66, 4, 20);
			this.drawTexturedModalRect(this.xPosition + (int) (this.field_175227_p * (float) (this.width - 8)) + 4,
