...
public class GuiScreenBook extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList
				.add(this.buttonPreviousPage = new GuiScreenBook.NextPageButton(2, var1 + 38, var2 + 154, false));
		this.updateButtons();
	}
		...
		if (this.bookGettingSigned) {
			...
			if (this.bookIsUnsigned) {
				...
				if (ItemEditableBook.validBookTagContents(this.bookObj.getTagCompound())) {
					try {
						...
						this.field_175386_A = var14 != null
								? GuiUtilRenderComponents.func_178908_a(var14, 116, this.fontRendererObj, true, true)
								: null;
			...
			if (this.field_175386_A == null) {
				...
				for (int var16 = 0; var16 < var9; ++var16) {
					...
					this.fontRendererObj.drawString(var18.getUnformattedText(), var4 + 36,
							var5 + 16 + 16 + var16 * this.fontRendererObj.FONT_HEIGHT, 0);
				}
