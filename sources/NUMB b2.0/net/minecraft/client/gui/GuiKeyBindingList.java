...
public class GuiKeyBindingList extends GuiListExtended {
	...
	public class KeyEntry implements GuiListExtended.IGuiListEntry {
		...
		private KeyEntry(KeyBinding p_i45029_2_) {
			...
			this.btnChangeKeyBinding = new GuiButton(0, 0, 0, 75, 18,
		...
		public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY,
			...
			GuiKeyBindingList.this.mc.fontRendererObj.drawString(this.field_148283_c,
		...
		public boolean mousePressed(int p_148278_1_, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_,
			...
			if (this.btnChangeKeyBinding.mousePressed(GuiKeyBindingList.this.mc, p_148278_2_, p_148278_3_)) {
				...
				GuiKeyBindingList.this.mc.gameSettings.setOptionKeyBinding(this.field_148282_b,
