...
public class ResourcePackListEntryDefault extends ResourcePackListEntry {
	...
	public ResourcePackListEntryDefault(GuiScreenResourcePacks p_i45052_1_) {
		...
		this.field_148321_e = this.field_148317_a.getTextureManager().getDynamicTextureLocation("texturepackicon",
				var2);
	}
	...
	protected String func_148311_a() {
		try {
			PackMetadataSection var1 = (PackMetadataSection) this.field_148320_d
					.getPackMetadata(this.field_148317_a.getResourcePackRepository().rprMetadataSerializer, "pack");
