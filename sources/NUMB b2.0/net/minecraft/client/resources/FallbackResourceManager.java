...
public class FallbackResourceManager implements IResourceManager {
	...
	public IResource getResource(ResourceLocation p_110536_1_) throws IOException {
		...
		for (int var4 = this.resourcePacks.size() - 1; var4 >= 0; --var4) {
			...
			if (var5.resourceExists(p_110536_1_)) {
				...
				return new SimpleResource(var5.getPackName(), p_110536_1_, this.func_177245_a(p_110536_1_, var5), var6,
	...
	protected InputStream func_177245_a(ResourceLocation p_177245_1_, IResourcePack p_177245_2_) throws IOException {
		...
		return (InputStream) (field_177246_b.isDebugEnabled()
				? new FallbackResourceManager.ImputStreamLeakedResourceLogger(var3, p_177245_1_,
						p_177245_2_.getPackName())
				: var3);
	}
	...
	public List getAllResources(ResourceLocation p_135056_1_) throws IOException {
		...
		while (var4.hasNext()) {
			...
			if (var5.resourceExists(p_135056_1_)) {
				...
				var2.add(new SimpleResource(var5.getPackName(), p_135056_1_, this.func_177245_a(p_135056_1_, var5),
						var6, this.frmMetadataSerializer));
			}
		}
	...
	static class ImputStreamLeakedResourceLogger extends InputStream {
		...
		public ImputStreamLeakedResourceLogger(InputStream p_i46093_1_, ResourceLocation p_i46093_2_,
				String p_i46093_3_) {
