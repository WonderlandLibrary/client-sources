...
public enum ModelRotation implements IModelState, ITransformation {
	...
	public static ModelRotation func_177524_a(int p_177524_0_, int p_177524_1_) {
		return (ModelRotation) field_177546_q.get(Integer.valueOf(
				func_177521_b(MathHelper.func_180184_b(p_177524_0_, 360), MathHelper.func_180184_b(p_177524_1_, 360))));
	}
	...
	public Matrix4f getMatrix() {
		return Reflector.ForgeHooksClient_getMatrix.exists()
				...
				: new Matrix4f(this.func_177525_a());
	}
