...
public class BroadcastController {
		...
		this.field_177948_B = new IStreamCallbacks() {
			...
			public void requestAuthTokenCallback(ErrorCode p_requestAuthTokenCallback_1_,
				...
				try {
					if (BroadcastController.this.field_152867_c != null) {
						BroadcastController.this.field_152867_c.func_152900_a(p_requestAuthTokenCallback_1_,
			...
			public void getIngestServersCallback(ErrorCode p_getIngestServersCallback_1_,
				...
				if (ErrorCode.succeeded(p_getIngestServersCallback_1_)) {
					...
					BroadcastController.this.field_152884_t = BroadcastController.this.field_152883_s
							.getDefaultServer();
			...
			public void getGameNameListCallback(ErrorCode p_getGameNameListCallback_1_,
				...
				try {
					if (BroadcastController.this.field_152867_c != null) {
						BroadcastController.this.field_152867_c.func_152898_a(p_getGameNameListCallback_1_,
	...
	public boolean func_152817_A() {
		if (this.field_152876_l) {
			...
			ErrorCode var1 = this.field_152872_h.initialize(this.field_152868_d,
	...
	public boolean func_152836_a(VideoParams p_152836_1_) {
		if (p_152836_1_ != null && this.func_152857_n()) {
			...
			if (!this.func_152823_L()) {
				...
				ErrorCode var2 = this.field_152873_i.start(p_152836_1_, this.field_152882_r, this.field_152884_t,
	...
	public boolean func_152840_a(String p_152840_1_, long p_152840_2_, String p_152840_4_, String p_152840_5_) {
		ErrorCode var6 = this.field_152873_i.sendActionMetaData(this.field_152885_u, p_152840_1_, p_152840_2_,
	...
	public long func_177946_b(String p_177946_1_, long p_177946_2_, String p_177946_4_, String p_177946_5_) {
		long var6 = this.field_152873_i.sendStartSpanMetaData(this.field_152885_u, p_177946_1_, p_177946_2_,
	...
	public boolean func_177947_a(String p_177947_1_, long p_177947_2_, long p_177947_4_, String p_177947_6_,
		...
		if (p_177947_4_ == -1L) {
			...
			ErrorCode var8 = this.field_152873_i.sendEndSpanMetaData(this.field_152885_u, p_177947_1_, p_177947_2_,
	...
	protected boolean func_152823_L() {
		for (int var1 = 0; var1 < 3; ++var1) {
			FrameBuffer var2 = this.field_152873_i
					.allocateFrameBuffer(this.field_152881_q.outputWidth * this.field_152881_q.outputHeight * 4);
	...
	public static enum BroadcastState {
		...
		private static final BroadcastController.BroadcastState[] $VALUES = new BroadcastController.BroadcastState[] {
