...
public class ChatController {
	...
	public boolean func_175990_d(String p_175990_1_) {
		if (!this.field_175998_i.containsKey(p_175990_1_)) {
			...
			ChatController.ChatChannelListener var2 = (ChatController.ChatChannelListener) this.field_175998_i
					.get(p_175990_1_);
	...
	public boolean func_175986_a(String p_175986_1_, String p_175986_2_) {
		if (this.field_153011_i != ChatController.ChatState.Initialized) {
			...
			ChatController.ChatChannelListener var3 = (ChatController.ChatChannelListener) this.field_175998_i
					.get(p_175986_1_);
		...
		if (this.field_175995_l != ChatController.EnumEmoticonMode.None) {
			if (this.field_175996_m == null) {
				...
				if (ErrorCode.failed(var1)) {
					String var2 = ErrorCode.getString(var1);
					this.func_152995_h(
							String.format("Error trying to download emoticon data: %s", new Object[] { var2 }));
				}
			}
		}
	}
	...
	public class ChatChannelListener implements IChatChannelListener {
		...
		public boolean func_176038_a(boolean p_176038_1_) {
			...
			if (p_176038_1_) {
				...
				var2 = ChatController.this.field_153008_f.connect(this.field_176048_a,
			...
			if (ChatController.this.field_175995_l != ChatController.EnumEmoticonMode.None) {
				if (this.field_176043_g == null) {
					...
					if (ErrorCode.failed(var1)) {
						String var2 = ErrorCode.getString(var1);
						ChatController.this.func_152995_h(
								String.format("Error trying to download badge data: %s", new Object[] { var2 }));
					}
				}
			}
		}
		...
		protected void func_176039_i() {
			if (this.field_176043_g == null) {
				...
				ErrorCode var1 = ChatController.this.field_153008_f.getBadgeData(this.field_176048_a,
						this.field_176043_g);
	...
	public static enum ChatState {
		...
		private static final ChatController.ChatState[] $VALUES = new ChatController.ChatState[] { Uninitialized,
				Initializing, Initialized, ShuttingDown };
	...
	public static enum EnumChannelState {
		...
		private static final ChatController.EnumChannelState[] $VALUES = new ChatController.EnumChannelState[] {
	...
	public static enum EnumEmoticonMode {
		...
		private static final ChatController.EnumEmoticonMode[] $VALUES = new ChatController.EnumEmoticonMode[] { None,
				Url, TextureAtlas };
