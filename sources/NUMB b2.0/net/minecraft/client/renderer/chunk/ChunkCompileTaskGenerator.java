...
public class ChunkCompileTaskGenerator {
	...
	public static enum Status {
		...
		private static final ChunkCompileTaskGenerator.Status[] $VALUES = new ChunkCompileTaskGenerator.Status[] {
	...
	public static enum Type {
		...
		private static final ChunkCompileTaskGenerator.Type[] $VALUES = new ChunkCompileTaskGenerator.Type[] {
