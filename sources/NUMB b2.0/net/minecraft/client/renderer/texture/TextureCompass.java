...
public class TextureCompass extends TextureAtlasSprite {
	...
	public void updateAnimation() {
		...
		if (var1.theWorld != null && var1.thePlayer != null) {
			this.updateCompass(var1.theWorld, var1.thePlayer.posX, var1.thePlayer.posZ,
					(double) var1.thePlayer.rotationYaw, false, false);
		} else {
	...
	public void updateCompass(World worldIn, double p_94241_2_, double p_94241_4_, double p_94241_6_,
		...
		if (!this.framesTextureData.isEmpty()) {
			...
			for (var182 = (int) ((this.currentAngle / (Math.PI * 2D) + 1.0D) * (double) this.framesTextureData.size())
					% this.framesTextureData.size(); var182 < 0; var182 = (var182 + this.framesTextureData.size())
