...
public abstract class RenderLiving extends RendererLivingEntity {
	...
	protected boolean canRenderName(EntityLiving targetEntity) {
		return super.canRenderName(targetEntity) && (targetEntity.getAlwaysRenderNameTagForRender()
				|| targetEntity.hasCustomName() && targetEntity == this.renderManager.field_147941_i);
	}

	public boolean func_177104_a(EntityLiving p_177104_1_, ICamera p_177104_2_, double p_177104_3_, double p_177104_5_,
			double p_177104_7_) {
	...
	protected void func_110827_b(EntityLiving p_110827_1_, double p_110827_2_, double p_110827_4_, double p_110827_6_,
		...
		if (!Config.isShaders() || !Shaders.isShadowPass) {
			...
			if (var10 != null) {
				...
				double var13 = this.func_110828_a((double) var10.prevRotationYaw, (double) var10.rotationYaw,
						(double) (p_110827_9_ * 0.5F)) * 0.01745329238474369D;
				double var15 = this.func_110828_a((double) var10.prevRotationPitch, (double) var10.rotationPitch,
						(double) (p_110827_9_ * 0.5F)) * 0.01745329238474369D;
				...
				double var25 = this.func_110828_a(var10.prevPosX, var10.posX, (double) p_110827_9_) - var17 * 0.7D
						- var19 * 0.5D * var23;
				double var27 = this.func_110828_a(var10.prevPosY + (double) var10.getEyeHeight() * 0.7D,
						var10.posY + (double) var10.getEyeHeight() * 0.7D, (double) p_110827_9_) - var21 * 0.5D - 0.25D;
				double var29 = this.func_110828_a(var10.prevPosZ, var10.posZ, (double) p_110827_9_) - var19 * 0.7D
						+ var17 * 0.5D * var23;
				double var31 = this.func_110828_a((double) p_110827_1_.prevRenderYawOffset,
						(double) p_110827_1_.renderYawOffset, (double) p_110827_9_) * 0.01745329238474369D
						+ (Math.PI / 2D);
				...
				for (var48 = 0; var48 <= 24; ++var48) {
					...
					var12.addVertex(p_110827_2_ + var39 * (double) var49 + 0.0D,
							p_110827_4_ + var41 * (double) (var49 * var49 + var49) * 0.5D
									+ (double) ((24.0F - (float) var48) / 18.0F + 0.125F),
							p_110827_6_ + var43 * (double) var49);
					var12.addVertex(p_110827_2_ + var39 * (double) var49 + 0.025D,
							p_110827_4_ + var41 * (double) (var49 * var49 + var49) * 0.5D
									+ (double) ((24.0F - (float) var48) / 18.0F + 0.125F) + 0.025D,
							p_110827_6_ + var43 * (double) var49);
				}
				...
				for (var48 = 0; var48 <= 24; ++var48) {
					...
					var12.addVertex(p_110827_2_ + var39 * (double) var49 + 0.025D,
							p_110827_4_ + var41 * (double) (var49 * var49 + var49) * 0.5D
									+ (double) ((24.0F - (float) var48) / 18.0F + 0.125F),
							p_110827_6_ + var43 * (double) var49 + 0.025D);
				}
