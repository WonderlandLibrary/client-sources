...
public class RenderDragon extends RenderLiving {
	...
	protected void func_180575_a(EntityDragon p_180575_1_, float p_180575_2_, float p_180575_3_, float p_180575_4_) {
		...
		float var6 = (float) (p_180575_1_.getMovementOffsets(5, p_180575_4_)[1]
	...
	protected void func_180574_a(EntityDragon p_180574_1_, double p_180574_2_, double p_180574_4_, double p_180574_6_,
			float p_180574_8_) {
		...
		float var11 = (float) (p_180574_1_.healingEnderCrystal.posX - p_180574_1_.posX
				- (p_180574_1_.prevPosX - p_180574_1_.posX) * (double) (1.0F - p_180574_8_));
		float var12 = (float) ((double) var10 + p_180574_1_.healingEnderCrystal.posY - 1.0D - p_180574_1_.posY
				- (p_180574_1_.prevPosY - p_180574_1_.posY) * (double) (1.0F - p_180574_8_));
		float var13 = (float) (p_180574_1_.healingEnderCrystal.posZ - p_180574_1_.posZ
				- (p_180574_1_.prevPosZ - p_180574_1_.posZ) * (double) (1.0F - p_180574_8_));
		...
		GlStateManager.rotate((float) (-Math.atan2((double) var13, (double) var11)) * 180.0F / (float) Math.PI - 90.0F,
				0.0F, 1.0F, 0.0F);
		GlStateManager.rotate((float) (-Math.atan2((double) var14, (double) var12)) * 180.0F / (float) Math.PI - 90.0F,
				1.0F, 0.0F, 0.0F);
		...
		float var19 = MathHelper.sqrt_float(var11 * var11 + var12 * var12 + var13 * var13) / 32.0F
				- ((float) p_180574_1_.ticksExisted + p_180574_8_) * 0.01F;
