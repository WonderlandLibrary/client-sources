...
public class LayerCreeperCharge implements LayerRenderer {
	...
	public void doRenderLayer(EntityCreeper p_177169_1_, float p_177169_2_, float p_177169_3_, float p_177169_4_,
		...
		if (p_177169_1_.getPowered()) {
			...
			this.creeperModel.render(p_177169_1_, p_177169_2_, p_177169_3_, p_177169_5_, p_177169_6_, p_177169_7_,
					p_177169_8_);
			GlStateManager.matrixMode(5890);
			GlStateManager.loadIdentity();
			GlStateManager.matrixMode(5888);
