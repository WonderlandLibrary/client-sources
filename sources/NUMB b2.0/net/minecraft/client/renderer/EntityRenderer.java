...
public class EntityRenderer implements IResourceManagerReloadListener {
	...
	public boolean field_175083_ad;
	...
	private void updateFogColor(float partialTicks) {
		...
		if (Reflector.EntityViewRenderEvent_FogColors_Constructor.exists()) {
			Object event1 = Reflector.newInstance(Reflector.EntityViewRenderEvent_FogColors_Constructor,
					new Object[] { this, var3, var211, Float.valueOf(partialTicks), Float.valueOf(this.field_175080_Q),
							Float.valueOf(this.field_175082_R), Float.valueOf(this.field_175081_S) });
