...
public class RenderItemFrame extends Render {
	...
	public void doRender(EntityItemFrame p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
		...
		this.func_147914_a(p_76986_1_,
				p_76986_2_ + (double) ((float) p_76986_1_.field_174860_b.getFrontOffsetX() * 0.3F), p_76986_4_ - 0.25D,
				p_76986_6_ + (double) ((float) p_76986_1_.field_174860_b.getFrontOffsetZ() * 0.3F));
	}
			...
			if (!Reflector.postForgeBusEvent(Reflector.RenderItemInFrameEvent_Constructor,
				...
				if (var4 instanceof ItemMap) {
					...
					if (var4 == Items.compass) {
						var121 = this.field_147917_g.getTextureMapBlocks()
								.getAtlasSprite(TextureCompass.field_176608_l);

						if (Config.isShaders()) {
							ShadersTex.bindTextureMapForUpdateAndRender(this.field_147917_g.getTextureManager(),
						...
						if (var121 instanceof TextureCompass) {
							...
							var131.updateCompass(p_82402_1_.worldObj, p_82402_1_.posX, p_82402_1_.posZ,
									(double) MathHelper.wrapAngleTo180_float(
											(float) (180 + p_82402_1_.field_174860_b.getHorizontalIndex() * 90)),
									false, true);
