...
public class TileEntityBannerRenderer extends TileEntitySpecialRenderer {
	...
	public void func_180545_a(TileEntityBanner p_180545_1_, double p_180545_2_, double p_180545_4_, double p_180545_6_,
		...
		this.field_178465_e.bannerSlate.rotateAngleX = (-0.0125F
				+ 0.01F * MathHelper.cos(var17 * (float) Math.PI * 0.02F)) * (float) Math.PI;
			...
			if (var3 == null) {
				if (field_178466_c.size() >= 256) {
					...
					while (var6.hasNext()) {
						...
						TileEntityBannerRenderer.TimedBannerTexture var8 = (TileEntityBannerRenderer.TimedBannerTexture) field_178466_c
								.get(var7);
				...
				Minecraft.getMinecraft().getTextureManager().loadTexture(var3.field_178471_b,
	...
	public void renderTileEntityAt(TileEntity p_180535_1_, double p_180535_2_, double p_180535_4_, double p_180535_6_,
		...
		this.func_180545_a((TileEntityBanner) p_180535_1_, p_180535_2_, p_180535_4_, p_180535_6_, p_180535_8_,
				p_180535_9_);
	}
