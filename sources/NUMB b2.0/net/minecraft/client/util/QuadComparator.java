...
public class QuadComparator implements Comparator {
	...
	public QuadComparator(FloatBuffer p_i46247_1_, float p_i46247_2_, float p_i46247_3_, float p_i46247_4_,
			int p_i46247_5_) {
	...
	public int compare(Integer p_compare_1_, Integer p_compare_2_) {
		...
		float var9 = this.field_147627_d.get(p_compare_1_.intValue() + this.field_178079_e * 2 + 0)
				- this.field_147630_a;
		float var10 = this.field_147627_d.get(p_compare_1_.intValue() + this.field_178079_e * 2 + 1)
				- this.field_147628_b;
		float var11 = this.field_147627_d.get(p_compare_1_.intValue() + this.field_178079_e * 2 + 2)
				- this.field_147629_c;
		float var12 = this.field_147627_d.get(p_compare_1_.intValue() + this.field_178079_e * 3 + 0)
				- this.field_147630_a;
		float var13 = this.field_147627_d.get(p_compare_1_.intValue() + this.field_178079_e * 3 + 1)
				- this.field_147628_b;
		float var14 = this.field_147627_d.get(p_compare_1_.intValue() + this.field_178079_e * 3 + 2)
				- this.field_147629_c;
		...
		float var21 = this.field_147627_d.get(p_compare_2_.intValue() + this.field_178079_e * 2 + 0)
				- this.field_147630_a;
		float var22 = this.field_147627_d.get(p_compare_2_.intValue() + this.field_178079_e * 2 + 1)
				- this.field_147628_b;
		float var23 = this.field_147627_d.get(p_compare_2_.intValue() + this.field_178079_e * 2 + 2)
				- this.field_147629_c;
		float var24 = this.field_147627_d.get(p_compare_2_.intValue() + this.field_178079_e * 3 + 0)
				- this.field_147630_a;
		float var25 = this.field_147627_d.get(p_compare_2_.intValue() + this.field_178079_e * 3 + 1)
				- this.field_147628_b;
		float var26 = this.field_147627_d.get(p_compare_2_.intValue() + this.field_178079_e * 3 + 2)
				- this.field_147629_c;
