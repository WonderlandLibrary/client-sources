...
public class EntityHugeExplodeFX extends EntityFX {
	...
	protected EntityHugeExplodeFX(World worldIn, double p_i1214_2_, double p_i1214_4_, double p_i1214_6_,
	...
	public void onUpdate() {
		for (int var1 = 0; var1 < 6; ++var1) {
			...
			this.worldObj.spawnParticle(EnumParticleTypes.EXPLOSION_LARGE, var2, var4, var6,
