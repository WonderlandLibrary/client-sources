...
public class EntityBlockDustFX extends EntityDiggingFX {
	...
	protected EntityBlockDustFX(World worldIn, double p_i46281_2_, double p_i46281_4_, double p_i46281_6_,
			double p_i46281_8_, double p_i46281_10_, double p_i46281_12_, IBlockState p_i46281_14_) {
	...
	public static class Factory implements IParticleFactory {
		...
		public EntityFX func_178902_a(int p_178902_1_, World worldIn, double p_178902_3_, double p_178902_5_,
			...
			return var16.getBlock().getRenderType() == -1 ? null
					: (new EntityBlockDustFX(worldIn, p_178902_3_, p_178902_5_, p_178902_7_, p_178902_9_, p_178902_11_,
							p_178902_13_, var16)).func_174845_l();
		}
	}
}
