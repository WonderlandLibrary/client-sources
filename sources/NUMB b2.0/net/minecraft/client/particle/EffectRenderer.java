...
public class EffectRenderer {
	...
	private void func_178930_c() {
		...
		this.func_178929_a(EnumParticleTypes.SPELL_MOB_AMBIENT.func_179348_c(),
		...
		this.func_178929_a(EnumParticleTypes.ENCHANTMENT_TABLE.func_179348_c(),
	...
	public EntityFX func_178927_a(int p_178927_1_, double p_178927_2_, double p_178927_4_, double p_178927_6_,
		...
		if (var15 != null) {
			EntityFX var16 = var15.func_178902_a(p_178927_1_, this.worldObj, p_178927_2_, p_178927_4_, p_178927_6_,
	...
	public void addEffect(EntityFX p_78873_1_) {
		if (p_78873_1_ != null) {
			if (!(p_78873_1_ instanceof EntityFireworkSparkFX) || Config.isFireworkParticles()) {
				...
				if (!(p_78873_1_ instanceof Barrier)
						|| !this.reuseBarrierParticle(p_78873_1_, this.fxLayers[var2][var3])) {
	...
	public void renderParticles(Entity p_78874_1_, float partialTicks) {
		...
		EntityFX.interpPosX = p_78874_1_.lastTickPosX
				+ (p_78874_1_.posX - p_78874_1_.lastTickPosX) * (double) partialTicks;
		EntityFX.interpPosY = p_78874_1_.lastTickPosY
				+ (p_78874_1_.posY - p_78874_1_.lastTickPosY) * (double) partialTicks;
		EntityFX.interpPosZ = p_78874_1_.lastTickPosZ
				+ (p_78874_1_.posZ - p_78874_1_.lastTickPosZ) * (double) partialTicks;
	...
	public void func_180533_a(BlockPos p_180533_1_, IBlockState p_180533_2_) {
		...
		if (Reflector.ForgeBlock_addDestroyEffects.exists() && Reflector.ForgeBlock_isAir.exists()) {
			...
			notAir = !Reflector.callBoolean(var3, Reflector.ForgeBlock_isAir,
					new Object[] { this.worldObj, p_180533_1_ })
					&& !Reflector.callBoolean(var3, Reflector.ForgeBlock_addDestroyEffects,
							new Object[] { this.worldObj, p_180533_1_, this });
		} else {
			...
			for (int var4 = 0; var4 < var14; ++var4) {
				for (int var5 = 0; var5 < var14; ++var5) {
					for (int var6 = 0; var6 < var14; ++var6) {
						...
						this.addEffect((new EntityDiggingFX(this.worldObj, var7, var9, var11,
								var7 - (double) p_180533_1_.getX() - 0.5D, var9 - (double) p_180533_1_.getY() - 0.5D,
								var11 - (double) p_180533_1_.getZ() - 0.5D, p_180533_2_)).func_174846_a(p_180533_1_));
					}
				}
			}
		}
		...
		if (var4.getRenderType() != -1) {
			...
			double var9 = (double) var5
					+ this.rand.nextDouble()
							* (var4.getBlockBoundsMaxX() - var4.getBlockBoundsMinX() - (double) (var8 * 2.0F))
					+ (double) var8 + var4.getBlockBoundsMinX();
			double var11 = (double) var6
					+ this.rand.nextDouble()
							* (var4.getBlockBoundsMaxY() - var4.getBlockBoundsMinY() - (double) (var8 * 2.0F))
					+ (double) var8 + var4.getBlockBoundsMinY();
			double var13 = (double) var7
					+ this.rand.nextDouble()
							* (var4.getBlockBoundsMaxZ() - var4.getBlockBoundsMinZ() - (double) (var8 * 2.0F))
					+ (double) var8 + var4.getBlockBoundsMinZ();
			...
			this.addEffect((new EntityDiggingFX(this.worldObj, var9, var11, var13, 0.0D, 0.0D, 0.0D, var3))
	...
	public void addBlockHitEffects(BlockPos pos, MovingObjectPosition target) {
		...
		boolean blockAddHitEffects = Reflector.callBoolean(block, Reflector.ForgeBlock_addHitEffects,
				new Object[] { this.worldObj, target, this });
