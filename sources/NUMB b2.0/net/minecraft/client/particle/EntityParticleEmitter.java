...
public class EntityParticleEmitter extends EntityFX {
	...
	public EntityParticleEmitter(World worldIn, Entity p_i46279_2_, EnumParticleTypes p_i46279_3_) {
		super(worldIn, p_i46279_2_.posX, p_i46279_2_.getEntityBoundingBox().minY + (double) (p_i46279_2_.height / 2.0F),
	...
	public void onUpdate() {
		for (int var1 = 0; var1 < 16; ++var1) {
			...
			if (var2 * var2 + var4 * var4 + var6 * var6 <= 1.0D) {
				...
				double var10 = this.field_174851_a.getEntityBoundingBox().minY
						+ (double) (this.field_174851_a.height / 2.0F)
						+ var4 * (double) this.field_174851_a.height / 4.0D;
