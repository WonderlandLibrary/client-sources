				...
				while (var5.hasNext()) {
					...
					try {
						...
						while (var8.hasNext()) {
							...
							this.loadSoundResource(new ResourceLocation(var3, (String) var9.getKey()),
	...
	private void loadSoundResource(ResourceLocation p_147693_1_, SoundList p_147693_2_) {
		...
		while (var5.hasNext()) {
			...
			case 1:
				...
				var10 = new SoundEventAccessor(new SoundPoolEntry(var11, (double) var6.getSoundEntryPitch(),
						(double) var6.getSoundEntryVolume(), var6.isStreaming()), var6.getSoundEntryWeight());
				break;
			...
			case 2:
				var10 = new ISoundEventAccessor() {
					...
					public int getWeight() {
						SoundEventAccessorComposite var1 = (SoundEventAccessorComposite) SoundHandler.this.sndRegistry
