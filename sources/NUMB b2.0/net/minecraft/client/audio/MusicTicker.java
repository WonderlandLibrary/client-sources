...
public class MusicTicker implements IUpdatePlayerListBox {
		...
		if (this.currentMusic != null) {
			...
			if (!this.mc.getSoundHandler().isSoundPlaying(this.currentMusic)) {
				...
				this.timeUntilNextMusic = Math.min(
						MathHelper.getRandomIntegerInRange(this.rand, var1.getMinDelay(), var1.getMaxDelay()),
	...
	public static enum MusicType {
		...
		private MusicType(String p_i45111_1_, int p_i45111_2_, ResourceLocation location, int p_i45111_4_,
				int p_i45111_5_) {
