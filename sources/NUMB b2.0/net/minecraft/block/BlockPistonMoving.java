...
public class BlockPistonMoving extends BlockContainer {
	...
	public BlockPistonMoving() {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(field_176426_a, EnumFacing.NORTH)
	...
	public static TileEntity func_176423_a(IBlockState p_176423_0_, EnumFacing p_176423_1_, boolean p_176423_2_,
			boolean p_176423_3_) {
	...
	public void onBlockDestroyedByPlayer(World worldIn, BlockPos pos, IBlockState state) {
		...
		if (var5.getBlock() instanceof BlockPistonBase
				&& ((Boolean) var5.getValue(BlockPistonBase.EXTENDED)).booleanValue()) {
	...
	public AxisAlignedBB func_176424_a(World worldIn, BlockPos p_176424_2_, IBlockState p_176424_3_, float p_176424_4_,
			EnumFacing p_176424_5_) {
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(field_176426_a, BlockPistonExtension.func_176322_b(meta))
