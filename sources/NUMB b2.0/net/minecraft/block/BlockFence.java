...
public class BlockFence extends Block {
	...
	public boolean func_176524_e(IBlockAccess p_176524_1_, BlockPos p_176524_2_) {
		...
		return var3 == Blocks.barrier ? false
				: ((!(var3 instanceof BlockFence) || var3.blockMaterial != this.blockMaterial)
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		return state.withProperty(NORTH, Boolean.valueOf(this.func_176524_e(worldIn, pos.offsetNorth())))
				.withProperty(EAST, Boolean.valueOf(this.func_176524_e(worldIn, pos.offsetEast())))
				.withProperty(SOUTH, Boolean.valueOf(this.func_176524_e(worldIn, pos.offsetSouth())))
				.withProperty(WEST, Boolean.valueOf(this.func_176524_e(worldIn, pos.offsetWest())));
	}
