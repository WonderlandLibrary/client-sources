...
public class BlockWall extends Block {
	...
	public BlockWall(Block p_i45435_1_) {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(field_176256_a, Boolean.valueOf(false))
	...
	public boolean func_176253_e(IBlockAccess p_176253_1_, BlockPos p_176253_2_) {
		...
		return var3 == Blocks.barrier ? false
				: (var3 != this && !(var3 instanceof BlockFenceGate)
						? (var3.blockMaterial.isOpaque() && var3.isFullCube() ? var3.blockMaterial != Material.gourd
								: false)
						: true);
	}
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		return state.withProperty(field_176256_a, Boolean.valueOf(!worldIn.isAirBlock(pos.offsetUp())))
				.withProperty(field_176254_b, Boolean.valueOf(this.func_176253_e(worldIn, pos.offsetNorth())))
				.withProperty(field_176257_M, Boolean.valueOf(this.func_176253_e(worldIn, pos.offsetEast())))
				.withProperty(field_176258_N, Boolean.valueOf(this.func_176253_e(worldIn, pos.offsetSouth())))
				.withProperty(field_176259_O, Boolean.valueOf(this.func_176253_e(worldIn, pos.offsetWest())));
	}
