...
public abstract class BlockRedstoneDiode extends BlockDirectional {
	...
	public int isProvidingWeakPower(IBlockAccess worldIn, BlockPos pos, IBlockState state, EnumFacing side) {
		return !this.func_176406_l(state) ? 0
				: (state.getValue(AGE) == side ? this.func_176408_a(worldIn, pos, state) : 0);
	}
	...
	protected void func_176398_g(World worldIn, BlockPos p_176398_2_, IBlockState p_176398_3_) {
		if (!this.func_176405_b(worldIn, p_176398_2_, p_176398_3_)) {
			...
			if ((this.isRepeaterPowered && !var4 || !this.isRepeaterPowered && var4)
	...
	protected int func_176397_f(World worldIn, BlockPos p_176397_2_, IBlockState p_176397_3_) {
		...
		if (var6 >= 15) {
			...
			return Math.max(var6,
					var7.getBlock() == Blocks.redstone_wire
							? ((Integer) var7.getValue(BlockRedstoneWire.POWER)).intValue()
							: 0);
		}
	}
	...
	protected int func_176407_c(IBlockAccess p_176407_1_, BlockPos p_176407_2_, IBlockState p_176407_3_) {
		...
		return Math.max(this.func_176401_c(p_176407_1_, p_176407_2_.offset(var5), var5),
				this.func_176401_c(p_176407_1_, p_176407_2_.offset(var6), var6));
	}
	...
	protected int func_176401_c(IBlockAccess p_176401_1_, BlockPos p_176401_2_, EnumFacing p_176401_3_) {
		...
		return this.func_149908_a(var5)
				? (var5 == Blocks.redstone_wire ? ((Integer) var4.getValue(BlockRedstoneWire.POWER)).intValue()
	...
	public boolean func_149907_e(Block p_149907_1_) {
		return p_149907_1_ == this.func_180674_e(this.getDefaultState()).getBlock()
				|| p_149907_1_ == this.func_180675_k(this.getDefaultState()).getBlock();
	}
	...
	public boolean func_176402_i(World worldIn, BlockPos p_176402_2_, IBlockState p_176402_3_) {
		...
		return isRedstoneRepeaterBlockID(worldIn.getBlockState(var5).getBlock())
				? worldIn.getBlockState(var5).getValue(AGE) != var4
				: false;
	}
