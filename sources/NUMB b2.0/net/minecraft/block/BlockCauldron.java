...
public class BlockCauldron extends Block {
	...
	public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
		...
		if (!worldIn.isRemote && entityIn.isBurning() && var5 > 0
				&& entityIn.getEntityBoundingBox().minY <= (double) var6) {
			entityIn.extinguish();
							...
							if (!playerIn.capabilities.isCreativeMode) {
								...
								if (!playerIn.inventory.addItemStackToInventory(var13)) {
									worldIn.spawnEntityInWorld(new EntityItem(worldIn, (double) pos.getX() + 0.5D,
											(double) pos.getY() + 1.5D, (double) pos.getZ() + 0.5D, var13));
	...
	public void func_176590_a(World worldIn, BlockPos p_176590_2_, IBlockState p_176590_3_, int p_176590_4_) {
		worldIn.setBlockState(p_176590_2_,
				p_176590_3_.withProperty(field_176591_a, Integer.valueOf(MathHelper.clamp_int(p_176590_4_, 0, 3))), 2);
