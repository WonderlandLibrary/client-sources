...
public class BlockDynamicLiquid extends BlockLiquid {
	...
	private void func_180690_f(World worldIn, BlockPos p_180690_2_, IBlockState p_180690_3_) {
		worldIn.setBlockState(p_180690_2_, getStaticLiquidForMaterial(this.blockMaterial).getDefaultState()
	...
	public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		if (var5 > 0) {
			...
			for (Iterator var9 = EnumFacing.Plane.HORIZONTAL.iterator(); var9
					.hasNext(); var8 = this.func_176371_a(worldIn, pos.offset(var10), var8)) {
			...
			if (this.field_149815_a >= 2 && this.blockMaterial == Material.water) {
				...
				if (var17.getBlock().getMaterial().isSolid()) {
					var14 = 0;
				} else if (var17.getBlock().getMaterial() == this.blockMaterial
						&& ((Integer) var17.getValue(LEVEL)).intValue() == 0) {
					var14 = 0;
				}
			}
	...
	private void func_176375_a(World worldIn, BlockPos p_176375_2_, IBlockState p_176375_3_, int p_176375_4_) {
		if (this.func_176373_h(worldIn, p_176375_2_, p_176375_3_)) {
			...
			worldIn.setBlockState(p_176375_2_, this.getDefaultState().withProperty(LEVEL, Integer.valueOf(p_176375_4_)),
					3);
		}
	}
	...
	private int func_176374_a(World worldIn, BlockPos p_176374_2_, int p_176374_3_, EnumFacing p_176374_4_) {
		...
		while (var6.hasNext()) {
			...
			if (var7 != p_176374_4_) {
				...
				if (!this.func_176372_g(worldIn, var8, var9) && (var9.getBlock().getMaterial() != this.blockMaterial
						|| ((Integer) var9.getValue(LEVEL)).intValue() > 0)) {
	...
	private Set func_176376_e(World worldIn, BlockPos p_176376_2_) {
		...
		while (var5.hasNext()) {
			...
			if (!this.func_176372_g(worldIn, var7, var8) && (var8.getBlock().getMaterial() != this.blockMaterial
					|| ((Integer) var8.getValue(LEVEL)).intValue() > 0)) {
				int var9;
	...
	private boolean func_176372_g(World worldIn, BlockPos p_176372_2_, IBlockState p_176372_3_) {
		...
		return !(var4 instanceof BlockDoor) && var4 != Blocks.standing_sign && var4 != Blocks.ladder
				&& var4 != Blocks.reeds
						? (var4.blockMaterial == Material.portal ? true : var4.blockMaterial.blocksMovement())
						: true;
	}
	...
	private boolean func_176373_h(World worldIn, BlockPos p_176373_2_, IBlockState p_176373_3_) {
		...
		return var4 != this.blockMaterial && var4 != Material.lava
				&& !this.func_176372_g(worldIn, p_176373_2_, p_176373_3_);
	}
