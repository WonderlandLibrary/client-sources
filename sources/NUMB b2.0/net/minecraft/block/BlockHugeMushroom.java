...
public class BlockHugeMushroom extends Block {
	...
	public BlockHugeMushroom(Material p_i45711_1_, Block p_i45711_2_) {
		...
		this.setDefaultState(
				this.blockState.getBaseState().withProperty(field_176380_a, BlockHugeMushroom.EnumType.ALL_OUTSIDE));
	...
	public static enum EnumType implements IStringSerializable {
		...
		private static final BlockHugeMushroom.EnumType[] $VALUES = new BlockHugeMushroom.EnumType[] { NORTH_WEST,
				NORTH, NORTH_EAST, WEST, CENTER, EAST, SOUTH_WEST, SOUTH, SOUTH_EAST, STEM, ALL_INSIDE, ALL_OUTSIDE,
				ALL_STEM };
