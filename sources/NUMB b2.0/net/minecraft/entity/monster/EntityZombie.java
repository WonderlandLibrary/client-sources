...
public class EntityZombie extends EntityMob {
	...
	public void onLivingUpdate() {
		if (this.worldObj.isDaytime() && !this.worldObj.isRemote && !this.isChild()) {
			...
			if (var1 > 0.5F && this.rand.nextFloat() * 30.0F < (var1 - 0.4F) * 2.0F
					&& this.worldObj.isAgainstSky(var2)) {
				boolean var3 = true;
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		if (super.attackEntityFrom(source, amount)) {
			...
			if (var3 != null && this.worldObj.getDifficulty() == EnumDifficulty.HARD
				...
				for (int var8 = 0; var8 < 50; ++var8) {
					...
					if (World.doesBlockHaveSolidTopSurface(this.worldObj, new BlockPos(var9, var10 - 1, var11))
							&& this.worldObj.getLightFromNeighbors(new BlockPos(var9, var10, var11)) < 10) {
						var7.setPosition((double) var9, (double) var10, (double) var11);

						if (!this.worldObj.func_175636_b((double) var9, (double) var10, (double) var11, 7.0D)
								&& this.worldObj.checkNoEntityCollision(var7.getEntityBoundingBox(), var7)
								&& this.worldObj.getCollidingBoundingBoxes(var7, var7.getEntityBoundingBox()).isEmpty()
								&& !this.worldObj.isAnyLiquid(var7.getEntityBoundingBox())) {
							this.worldObj.spawnEntityInWorld(var7);
							var7.setAttackTarget(var3);
							var7.func_180482_a(this.worldObj.getDifficultyForLocation(new BlockPos(var7)),
	...
	protected boolean func_175448_a(ItemStack p_175448_1_) {
		return p_175448_1_.getItem() == Items.egg && this.isChild() && this.isRiding() ? false
				: super.func_175448_a(p_175448_1_);
	}
	...
	public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_) {
		...
		if (p_180482_2_1 == null) {
			p_180482_2_1 = new EntityZombie.GroupData(this.worldObj.rand.nextFloat() < 0.05F,
		...
		if (p_180482_2_1 instanceof EntityZombie.GroupData) {
			...
			if (var4.field_142048_a) {
				...
				if ((double) this.worldObj.rand.nextFloat() < 0.05D) {
					List var5 = this.worldObj.func_175647_a(EntityChicken.class,
							this.getEntityBoundingBox().expand(5.0D, 3.0D, 5.0D), IEntitySelector.field_152785_b);
	...
	public boolean interact(EntityPlayer p_70085_1_) {
		...
		if (var2 != null && var2.getItem() == Items.golden_apple && var2.getMetadata() == 0 && this.isVillager()
