...
public class EntitySlime extends EntityLiving implements IMob {
	...
	protected void setSlimeSize(int p_70799_1_) {
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed)
				.setBaseValue((double) (0.2F + 0.1F * (float) p_70799_1_));
	...
	public void onUpdate() {
		...
		if (this.onGround && !this.field_175452_bi) {
			...
			for (int var2 = 0; var2 < var1 * 8; ++var2) {
				...
				var10000.spawnParticle(var10001, var10002, this.getEntityBoundingBox().minY, var10004, 0.0D, 0.0D, 0.0D,
						new int[0]);
			}
	...
	protected void func_175451_e(EntityLivingBase p_175451_1_) {
		...
		if (this.canEntityBeSeen(p_175451_1_)
				&& this.getDistanceSqToEntity(p_175451_1_) < 0.6D * (double) var2 * 0.6D * (double) var2
	...
	class AISlimeAttack extends EntityAIBase {
		...
		public void updateTask() {
			...
			((EntitySlime.SlimeMoveHelper) this.field_179466_a.getMoveHelper())
					.func_179920_a(this.field_179466_a.rotationYaw, this.field_179466_a.canDamagePlayer());
		}
	}
	...
	class AISlimeFaceRandom extends EntityAIBase {
		...
		public boolean shouldExecute() {
			return this.field_179461_a.getAttackTarget() == null && (this.field_179461_a.onGround
					|| this.field_179461_a.isInWater() || this.field_179461_a.func_180799_ab());
		}
		...
		public void updateTask() {
			...
			((EntitySlime.SlimeMoveHelper) this.field_179461_a.getMoveHelper()).func_179920_a(this.field_179459_b,
					false);
		}
	}
				...
				if (this.entity.onGround) {
					...
					if (this.field_179924_h-- <= 0) {
						...
						if (this.field_179925_i.makesSoundOnJump()) {
							this.field_179925_i.playSound(this.field_179925_i.getJumpSound(),
									this.field_179925_i.getSoundVolume(), ((this.field_179925_i.getRNG().nextFloat()
											- this.field_179925_i.getRNG().nextFloat()) * 0.2F + 1.0F) * 0.8F);
						}
					} else {
