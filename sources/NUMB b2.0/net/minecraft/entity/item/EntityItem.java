...
public class EntityItem extends Entity {
	...
	public void onUpdate() {
		if (this.getEntityItem() == null) {
			...
			if (this.onGround) {
				var2 = this.worldObj.getBlockState(new BlockPos(MathHelper.floor_double(this.posX),
	...
	private void searchForOtherItemsNearby() {
		Iterator var1 = this.worldObj
				.getEntitiesWithinAABB(EntityItem.class, this.getEntityBoundingBox().expand(0.5D, 0.0D, 0.5D))
				.iterator();
	...
	public void onCollideWithPlayer(EntityPlayer entityIn) {
		if (!this.worldObj.isRemote) {
			...
			if (this.delayBeforeCanPickup == 0
				...
				if (!this.isSlient()) {
					this.worldObj.playSoundAtEntity(entityIn, "random.pop", 0.2F,
