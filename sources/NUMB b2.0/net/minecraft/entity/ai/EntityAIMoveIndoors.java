...
public class EntityAIMoveIndoors extends EntityAIBase {
	...
	public boolean shouldExecute() {
		...
		if ((!this.entityObj.worldObj.isDaytime() || this.entityObj.worldObj.isRaining()
				&& !this.entityObj.worldObj.getBiomeGenForCoords(var1).canSpawnLightningBolt())
	...
	public void startExecuting() {
		...
		if (this.entityObj.getDistanceSq(var1) > 256.0D) {
			Vec3 var5 = RandomPositionGenerator.findRandomTargetBlockTowards(this.entityObj, 14, 3,
					new Vec3((double) var2 + 0.5D, (double) var3, (double) var4 + 0.5D));
