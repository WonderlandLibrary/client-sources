  ...
  extends GuiScreen
{
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    mc.fontRendererObj.drawCenteredString(ChatColor.WHITE + "- " + ChatColor.AQUA + "MCLeaks" + ChatColor.WHITE + 
      "." + ChatColor.AQUA + "net " + ChatColor.WHITE + "-", this.width / 2, (int) 17.0F, 16777215);
    mc.fontRendererObj.drawCenteredString("Free minecraft accounts", this.width / 2, (int) 32.0F, 16777215);
    
    mc.fontRendererObj.drawCenteredString("Status:", this.width / 2, (int) 68.0F, 16777215);
    mc.fontRendererObj.drawCenteredString(MCLeaks.getStatus(), this.width / 2, (int) 90.0F, 16777215);
    
    mc.fontRendererObj.drawString("Token", this.width / 2 - 100, 115.0F, 10526880);
    if (this.message != null) {
    	mc.fontRendererObj.drawCenteredString(this.message, this.width / 2, (int) 158.0F, 16777215);
    }
