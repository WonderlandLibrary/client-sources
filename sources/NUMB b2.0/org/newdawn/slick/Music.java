...
public class Music {
	 ...
	 * and checks listeners. Note that if you're using a game container this will be
	 * auto-magically called for you.
	 * 
	 * @param delta
	...
	/**
	 * True if the music is being repositioned and it is therefore normal that it's
	 * not playing
	 */
	 ...
	 * 
	 * @return The volume of this music, still effected by global SoundStore volume.
	 *         0 - 1, 1 is Max
	 */
