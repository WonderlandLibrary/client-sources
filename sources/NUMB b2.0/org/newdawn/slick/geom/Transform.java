...
public class Transform {
	 ...
	 * destination array. All operations will be done before storing the results in
	 * the destination. This way the source and destination array can be the same
	 ...
	 *             if sourceOffset + numberOfPoints * 2 > source.length or the same
	 *             operation on the destination array
	 */
	public void transform(float source[], int sourceOffset, float destination[], int destOffset, int numberOfPoints) {
		// TODO performance can be improved by removing the safety to the destination
		// array
		...
		if (source == destination) {
			// for safety of the destination, the results are copied after the entire
			// operation.
			for (int i = 0; i < numberOfPoints * 2; i += 2) {
	...
	public Transform concatenate(Transform tx) {
		...
		mp[5] = n12;
		//
		// mp[0] = matrixPosition[0] * transform.matrixPosition[0] + matrixPosition[0] *
		// transform.matrixPosition[3] + matrixPosition[0] *
		// transform.matrixPosition[6];
		// mp[1] = matrixPosition[1] * transform.matrixPosition[1] + matrixPosition[1] *
		// transform.matrixPosition[4] + matrixPosition[1] *
		// transform.matrixPosition[7];
		// mp[2] = matrixPosition[2] * transform.matrixPosition[2] + matrixPosition[2] *
		// transform.matrixPosition[5] + matrixPosition[2] *
		// transform.matrixPosition[8];
		// mp[3] = matrixPosition[3] * transform.matrixPosition[0] + matrixPosition[3] *
		// transform.matrixPosition[3] + matrixPosition[3] *
		// transform.matrixPosition[6];
		// mp[4] = matrixPosition[4] * transform.matrixPosition[1] + matrixPosition[4] *
		// transform.matrixPosition[4] + matrixPosition[4] *
		// transform.matrixPosition[7];
		// mp[5] = matrixPosition[5] * transform.matrixPosition[2] + matrixPosition[5] *
		// transform.matrixPosition[5] + matrixPosition[5] *
		// transform.matrixPosition[8];
		//
		matrixPosition = mp;
		return this;
	...
	public String toString() {
		String result = "Transform[[" + matrixPosition[0] + "," + matrixPosition[1] + "," + matrixPosition[2] + "]["
				+ matrixPosition[3] + "," + matrixPosition[4] + "," + matrixPosition[5] + "][" + matrixPosition[6] + ","
	...
	public static Transform createRotateTransform(float angle) {
		return new Transform((float) FastTrig.cos(angle), -(float) FastTrig.sin(angle), 0, (float) FastTrig.sin(angle),
