...
public class Image implements Renderable {
	...
	/**
	 * Set the image filtering to be used. Note that this will also affect any image
	 * that was derived from this one (i.e. sub-images etc)
	 * 
	 * @param f
	...
	/**
	 * Set the color of the given corner when this image is rendered. This is useful
	 * lots of visual effect but especially light maps
	 * 
	 * @param corner
	 ...
	 * 
	 * @param x
	 *            The x coordinate of center of rotation relative to the top left
	 *            corner of the image
	 * @param y
	 *            The y coordinate of center of rotation relative to the top left
	 *            corner of the image
	 */
	...
	/**
	 * Add the angle provided to the current rotation. The angle will be normalized
	 * to be 0 <= angle < 360. The image will be rotated around its center.
	 * 
	 * @param angle
	 *            The angle to add.
	 */
	...
	/**
	 * Get a sub-part of this image. Note that the create image retains a reference
	 * to the image data so should anything change it will affect sub-images too.
	 * 
	 * @param x
	 ...
	 *            relative to this image)
	 * @param srcx2
	 *            The x position of the bottom right cornder of rectangle to draw
	 *            from this image (i.e. relative to this image)
	 * @param srcy2
	 *            The t position of the bottom right cornder of rectangle to draw
	 *            from this image (i.e. relative to this image)
	 */
	...
	/**
	 * Draw the image in a warper rectangle. The effects this can have are many and
	 * varied, might be interesting though.
	 * 
	 * @param x1
	...
	/**
	 * Get a copy of this image. This is a shallow copy and does not duplicate image
	 * adata.
	 * 
	 ...
	 * render each sprite by calling renderInUse(). Finally, endUse(). Between start
	 * and end there can be no rendering of other sprites since the rendering is
	 * locked for this sprite sheet.
	 */
