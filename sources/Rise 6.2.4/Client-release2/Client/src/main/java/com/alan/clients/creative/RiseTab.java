...
public final class RiseTab extends CreativeTabs implements Accessor {
    ...
    public void displayAllReleventItems(final List<ItemStack> items) {
        ...
        // Suspicious's Head
        items.add(ItemUtil.getCustomSkull("Suspicious", "https://education.minecraft.net/wp-content/uploads/server.jpg"));

        // Hentai's Head
        items.add(ItemUtil.getCustomSkull("Hentai", "https://education.minecraft.net/wp-content/uploads/cock.png"));
