...
public enum Themes {
    ...
    CREIDA("Creida", new Color(0xff4e5270).brighter().brighter(), new Color(0xff4e5270).darker(), NONE, KeyColors.GRAY),
    CREIDA_TWO("Creida Two", new Color(0xff9ACAEB), new Color(0xff7FBBE6).darker(), NONE, KeyColors.GRAY),
    GOTHIC("Gothic", new Color(31, 30, 30), new Color(196, 190, 190), NONE, KeyColors.GRAY),
