...
public class GuiAchievements extends GuiScreen implements IProgressMeter {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        if (this.loadingAchievements) {
            ...
            if (this.field_146570_r != f3) {
                final float f5 = f3 - this.field_146570_r;
                final float f4 = f3 * (float) this.field_146555_f;
                final float f = f3 * (float) this.field_146557_g;
                final float f1 = this.field_146570_r * (float) this.field_146555_f;
                final float f2 = this.field_146570_r * (float) this.field_146557_g;
    ...
    public void updateScreen() {
        if (!this.loadingAchievements) {
            ...
            final double d1 = this.field_146573_x - this.field_146566_v;
    ...
    protected void drawTitle() {
        final int i = (this.width - this.field_146555_f) / 2;
        final int j = (this.height - this.field_146557_g) / 2;
        this.fontRendererObj.draw(I18n.format("gui.achievements"), i + 15, j + 5, 4210752);
    }
    ...
    protected void drawAchievementScreen(final int p_146552_1_, final int p_146552_2_, final float p_146552_3_) {
        ...
        final int k1 = i + 288 >> 4;
        final int l1 = j + 288 >> 4;
        final int i2 = (i + 288) % 16;
        final int j2 = (j + 288) % 16;
        final int k2 = 4;
        final int l2 = 8;
        final int i3 = 10;
        final int j3 = 22;
        ...
        final float f1 = 16.0F / this.field_146570_r;

        for (int l3 = 0; (float) l3 * f - (float) j2 < 155.0F; ++l3) {
            final float f2 = 0.6F - (float) (l1 + l3) / 25.0F * 0.3F;
            ...
            for (int i4 = 0; (float) i4 * f1 - (float) i2 < 224.0F; ++i4) {
                ...
                final int j4 = random.nextInt(1 + l1 + l3) + (l1 + l3) / 2;
        ...
        for (int j5 = 0; j5 < AchievementList.achievementList.size(); ++j5) {
            final Achievement achievement1 = AchievementList.achievementList.get(j5);
            ...
            if (achievement1.parentAchievement != null) {
                ...
                final int j6 = achievement1.parentAchievement.displayColumn * 24 - i + 11;
                ...
                final boolean flag1 = this.statFileWriter.canUnlockAchievement(achievement1);
                final int k4 = this.statFileWriter.func_150874_c(achievement1);
        ...
        final float f3 = (float) (p_146552_1_ - i1) * this.field_146570_r;
        final float f4 = (float) (p_146552_2_ - j1) * this.field_146570_r;
        ...
        for (int i6 = 0; i6 < AchievementList.achievementList.size(); ++i6) {
            final Achievement achievement2 = AchievementList.achievementList.get(i6);
            final int l6 = achievement2.displayColumn * 24 - i;
            final int j7 = achievement2.displayRow * 24 - j;

            if (l6 >= -24 && j7 >= -24 && (float) l6 <= 224.0F * this.field_146570_r && (float) j7 <= 155.0F * this.field_146570_r) {
                final int l7 = this.statFileWriter.func_150874_c(achievement2);
        ...
        if (achievement != null) {
            ...
            final String s1 = achievement.getDescription();
            final int i7 = p_146552_1_ + 12;
            final int k7 = p_146552_2_ - 4;
            final int i8 = this.statFileWriter.func_150874_c(achievement);

            if (this.statFileWriter.canUnlockAchievement(achievement)) {
                final int j8 = Math.max(this.fontRendererObj.width(s), 120);
                ...
                if (this.statFileWriter.hasAchievementUnlocked(achievement)) {
                    this.fontRendererObj.drawWithShadow(I18n.format("achievement.taken"), (float) i7, (float) (k7 + i9 + 4), -7302913);
                }
            } else if (i8 == 3) {
                s = I18n.format("achievement.unknown");
                final int k8 = Math.max(this.fontRendererObj.width(s), 120);
                final String s2 = (new ChatComponentTranslation("achievement.requires", achievement.parentAchievement.getStatName())).getUnformattedText();
                final int i5 = this.fontRendererObj.splitStringWidth(s2, k8);
                ...
                final int l8 = Math.max(this.fontRendererObj.width(s), 120);
                final String s3 = (new ChatComponentTranslation("achievement.requires", achievement.parentAchievement.getStatName())).getUnformattedText();
                final int j9 = this.fontRendererObj.splitStringWidth(s3, l8);
            ...
            if (s != null) {
                this.fontRendererObj.drawWithShadow(s, (float) i7, (float) k7, this.statFileWriter.canUnlockAchievement(achievement) ? (achievement.getSpecial() ? -128 : -1) : (achievement.getSpecial() ? -8355776 : -8355712));
            }
        }
