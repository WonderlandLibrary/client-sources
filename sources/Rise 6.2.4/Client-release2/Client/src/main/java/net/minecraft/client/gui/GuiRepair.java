...
public class GuiRepair extends GuiContainer implements ICrafting {
    ...
    protected void drawGuiContainerForegroundLayer(final int mouseX, final int mouseY) {
        ...
        this.fontRendererObj.draw(I18n.format("container.repair"), 60, 6, 4210752);
        ...
        if (this.anvil.maximumCost > 0) {
            ...
            if (flag) {
                final int j = -16777216 | (i & 16579836) >> 2 | i & -16777216;
                final int k = this.xSize - 8 - this.fontRendererObj.width(s);
                final int l = 67;
                ...
                if (this.fontRendererObj.getUnicodeFlag()) {
                    ...
                    this.fontRendererObj.draw(s, k, l + 1, j);
                    this.fontRendererObj.draw(s, k + 1, l, j);
                    this.fontRendererObj.draw(s, k + 1, l + 1, j);
                }

                this.fontRendererObj.draw(s, k, l, i);
            }
        }
