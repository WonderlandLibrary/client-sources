...
public class GuiScreenRealmsProxy extends GuiScreen {
    ...
    public void func_154322_b(final String p_154322_1_, final int p_154322_2_, final int p_154322_3_, final int p_154322_4_, final boolean p_154322_5_) {
        if (p_154322_5_) {
            ...
            this.fontRendererObj.draw(p_154322_1_, p_154322_2_, p_154322_3_, p_154322_4_);
        }
    }
    ...
    public int func_154326_c(final String p_154326_1_) {
        return this.fontRendererObj.width(p_154326_1_);
    }

    public void func_154319_c(final String p_154319_1_, final int p_154319_2_, final int p_154319_3_, final int p_154319_4_) {
        this.fontRendererObj.drawWithShadow(p_154319_1_, (float) p_154319_2_, (float) p_154319_3_, p_154319_4_);
    }
    ...
    public List<RealmsButton> func_154320_j() {
        final List<RealmsButton> list = Lists.newArrayListWithExpectedSize(super.buttonList.size());
