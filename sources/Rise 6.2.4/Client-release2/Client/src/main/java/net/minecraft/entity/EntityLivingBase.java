...
public abstract class EntityLivingBase extends Entity implements java.io.Serializable {
    ...
    public void swingItemWithoutAnimation() {
        if (this.worldObj instanceof WorldServer) {
            ((WorldServer) this.worldObj).getEntityTracker().sendToAllTrackingEntity(this, new S0BPacketAnimation(this, 0));
        }
    }
...
//                    ChatUtil.display(f4);
    ...
    public void onUpdate() {
        ...
        if (this == Minecraft.getMinecraft().thePlayer && RotationComponent.rotations != null) {
            yaw = RotationComponent.rotations.x;
        }
    ...
    protected float func_110146_f(final float p_110146_1_, float p_110146_2_) {
        float yaw = this.rotationYaw;
        if (this == Minecraft.getMinecraft().thePlayer && RotationComponent.rotations != null) yaw = RotationComponent.rotations.x;
