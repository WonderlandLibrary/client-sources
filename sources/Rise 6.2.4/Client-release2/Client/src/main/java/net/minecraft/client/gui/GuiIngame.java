...
//                }
//
//                this.getFontRenderer().drawString(this.recordPlaying, -this.getFontRenderer().width(this.recordPlaying) / 2, -4, l + (l1 << 24 & -16777216));
//                GlStateManager.disableBlend();
...
//        }
        ...
        if (this.field_175195_w > 0) {
            ...
            if (i2 > 8) {
                ...
                this.getFontRenderer().draw(this.title, (float) (-this.getFontRenderer().width(this.title) / 2), -10.0F, 16777215 | j2, true);
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                GlStateManager.scale(2.0F, 2.0F, 2.0F);
                this.getFontRenderer().draw(this.field_175200_y, (float) (-this.getFontRenderer().width(this.field_175200_y) / 2), 5.0F, 16777215 | j2, true);
                GlStateManager.popMatrix();
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
...
//        Client.INSTANCE.getEventBus().handle(new LimitedRender2DEvent(scaledResolution, partialTicks));
    ...
    public void renderExpBar(final ScaledResolution p_175176_1_, final int p_175176_2_) {
        ...
        if (this.mc.thePlayer.experienceLevel > 0) {
            ...
            this.getFontRenderer().draw(s, l1 + 1, i1 - 7, 0);
            this.getFontRenderer().draw(s, l1 - 1, i1 - 7, 0);
            this.getFontRenderer().draw(s, l1, i1 + 1 - 7, 0);
            this.getFontRenderer().draw(s, l1, i1 - 1 - 7, 0);
            this.getFontRenderer().draw(s, l1, i1 - 7, k1);
            this.mc.mcProfiler.endSection();
        }
    }
    ...
    public void renderDemo(final ScaledResolution p_175185_1_) {
        ...
        this.getFontRenderer().drawWithShadow(s, (float) (p_175185_1_.getScaledWidth() - i - 10), 5.0F, 16777215);
        this.mc.mcProfiler.endSection();
    }
    ...
    private void renderPlayerStats(final ScaledResolution p_180477_1_) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            if (this.lastSystemTime == -50L) {
                this.mc.playerController.onPlayerDestroyBlock(null, null);
            }
    ...
    private void renderBossHealth() {
        if (BossStatus.bossName != null && BossStatus.statusBarTime > 0) {
            ...
            this.getFontRenderer().drawWithShadow(s, (float) (i / 2 - this.getFontRenderer().width(s) / 2), (float) (i1 - 10), 16777215);
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
