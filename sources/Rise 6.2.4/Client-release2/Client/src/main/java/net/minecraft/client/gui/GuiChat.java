...
//        this.inputField.mouseClicked(mouseX, mouseY, mouseButton);
    ...
    private void sendAutocompleteRequest(final String p_146405_1_, final String p_146405_2_) {
        if (!p_146405_1_.startsWith(".") && p_146405_1_.length() >= 1) { // !p_146405_1_.startsWith(".") added to prevent autocomplete of commands
...
//        final int i = 320;
//        final int j = 40;
//        final int k = MathHelper.floor_float(mc.gameSettings.chatWidth * (float) (i - j) + (float) j);
//
//        drawRect(2, this.height - 14, k + 6, this.height - 2, Integer.MIN_VALUE);
