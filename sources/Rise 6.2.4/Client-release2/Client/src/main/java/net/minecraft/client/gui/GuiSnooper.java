...
public class GuiSnooper extends GuiScreen {
    ...
    public void initGui() {
        ...
        final String s = I18n.format("options.snooper.desc");
        ...
        for (final Entry<String, String> entry : (new TreeMap<String, String>(this.mc.getPlayerUsageSnooper().getCurrentStats())).entrySet()) {
        ...
        if (flag) {
            for (final Entry<String, String> entry1 : (new TreeMap<String, String>(this.mc.getIntegratedServer().getPlayerUsageSnooper().getCurrentStats())).entrySet()) {
    ...
    class List extends GuiSlot {
        ...
        protected void drawSlot(final int entryID, final int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int mouseXIn, final int mouseYIn) {
            GuiSnooper.this.fontRendererObj.draw(GuiSnooper.this.field_146604_g.get(entryID), 10, p_180791_3_, 16777215);
            GuiSnooper.this.fontRendererObj.draw(GuiSnooper.this.field_146609_h.get(entryID), 230, p_180791_3_, 16777215);
        }
