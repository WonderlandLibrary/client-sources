...
import sudo.core.altmanager.exceptions.APIDownException;
import sudo.core.altmanager.exceptions.APIErrorException;
import sudo.core.altmanager.exceptions.InvalidResponseException;
import sudo.core.altmanager.exceptions.InvalidTokenException;
import sudo.utils.mixins.IMinecraftClient;
...
public class AltManager {
	...
	public void readAlts() {
		try {
			...
			File altFile = new File(mc.runDirectory, "sudo_alts.txt");
			if (!altFile.exists())
	...
	public void saveAlts() {
		...
		try {
			...
			System.out.println("Failed to save alts");
		}
		printwriter.close();
	}
