...
public class Snake extends Mod {
	public Snake() {
		super("Snake", "Snake game", Category.CLIENT, 0);
	}
	
	@Override
	public void onEnable() {
		mc.setScreen(new SnakeGameScreen());
		this.toggle();
		super.onEnable();
	}
...
class SnakeGameScreen extends Screen {
    ...
    private static final Identifier GRID_TEXTURE = new Identifier("sudo:images/snake_grid.png");
    ...
    public void renderBackground(MatrixStack matrices) {
        ...
        for (Vec2i vec : this.snake) {
            DrawableHelper.fill(matrices, startX + vec.x() * scaleX, startY + vec.z() * scaleZ, startX + vec.x() * scaleX + scaleX, startY + vec.z() * scaleZ + scaleZ, -1);
        }
    }
