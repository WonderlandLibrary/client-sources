...
public class GuiConnecting extends GuiScreen
{
    ...
    private void connect(String ip, final int port)
    {
        if (ip.equals("Hypixel"))
        {
            ip = "mc.hypixel.net";
        }
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    inetaddress = InetAddress.getByName(temp);
                    ...
                    GuiConnecting.this.networkManager.sendPacket(new C00Handshake(47, temp, port, EnumConnectionState.LOGIN));
