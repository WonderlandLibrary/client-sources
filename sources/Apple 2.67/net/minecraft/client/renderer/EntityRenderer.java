...
import appu26j.mods.visuals.FakeHacks;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                GlStateManager.rotate(Perspective.getPrevRotationYaw() + (Perspective.getRotationYaw() - Perspective.getPrevRotationYaw()) * partialTicks + 180.0F, 0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(Perspective.getPrevRotationPitch() + (Perspective.getRotationPitch() - Perspective.getPrevRotationPitch()) * partialTicks, -1.0F, 0.0F, 0.0F);
            }
        }
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            {
                float f1 = Perspective.getRotationYaw();
                float f2 = Perspective.getRotationPitch();
                ...
                GlStateManager.rotate(Perspective.getRotationPitch() - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(Perspective.getRotationYaw() - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float)(-d3));
                GlStateManager.rotate(f1 - Perspective.getRotationYaw(), 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - Perspective.getRotationPitch(), 1.0F, 0.0F, 0.0F);
            }
        }
        else
        {
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists())
        {
            if (!this.mc.gameSettings.debugCamEnable)
            {
                float f6 = Perspective.getPrevRotationYaw() + (Perspective.getRotationYaw() - Perspective.getPrevRotationYaw()) * partialTicks + 180.0F;
                float f7 = Perspective.getPrevRotationPitch() + (Perspective.getRotationPitch() - Perspective.getPrevRotationPitch()) * partialTicks;
                float f8 = 0.0F;
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            final ScaledResolution scaledresolution = Cache.getSR();
        ...
        FakeHacks fakeHacks = (FakeHacks) Apple.CLIENT.getModsManager().getMod("Fake Hacks");
        
        if (fakeHacks.isEnabled())
        {
            fakeHacks.onRender();
        }
    }
    ...
    {
        this.setupOverlayRendering();
        this.mc.ingameGUI.renderStreamIndicator(Cache.getSR());
    }
