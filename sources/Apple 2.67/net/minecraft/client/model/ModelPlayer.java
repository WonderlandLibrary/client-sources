...
import appu26j.mods.visuals.DabMod;
...
public class ModelPlayer extends ModelBiped
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        boolean isOurPlayer = entityIn.getEntityId() == Minecraft.getMinecraft().thePlayer.getEntityId();
        
        if (isOurPlayer)
        {
            DabMod dabMod = (DabMod) Apple.CLIENT.getModsManager().getMod("Dab Mod");
            
            if (dabMod.isEnabled() && Minecraft.getMinecraft().gameSettings.dab.isKeyDown())
            {
                this.bipedRightArm.rotateAngleX = (float) Math.toRadians((double) (-90.0F));
                this.bipedRightArm.rotateAngleY = (float) Math.toRadians((double) (-35.0F));
                this.bipedRightArmwear.rotateAngleX = (float) Math.toRadians((double) (-90.0F));
                this.bipedRightArmwear.rotateAngleY = (float) Math.toRadians((double) (-35.0F));
                this.bipedLeftArm.rotateAngleX = (float) Math.toRadians((double) (15.0F));
                this.bipedLeftArm.rotateAngleY = (float) Math.toRadians((double) (15.0F));
                this.bipedLeftArm.rotateAngleZ = (float) Math.toRadians((double) (-110.0F));
                this.bipedLeftArmwear.rotateAngleX = (float) Math.toRadians((double) (15.0F));
                this.bipedLeftArmwear.rotateAngleY = (float) Math.toRadians((double) (15.0F));
                this.bipedLeftArmwear.rotateAngleZ = (float) Math.toRadians((double) (-110.0F));
                float rotationX = entityIn.rotationPitch;
                this.bipedHead.rotateAngleX = (float) Math.toRadians((double) (-rotationX)) + (float) Math.toRadians((double) (45.0F + rotationX));
                float rotationY = ((EntityPlayer) entityIn).renderYawOffset - entityIn.rotationYaw;
                this.bipedHead.rotateAngleY = (float) Math.toRadians((double) (rotationY)) + (float) Math.toRadians((double) (35.0F - rotationY));
                this.bipedHeadwear.rotateAngleX = (float) Math.toRadians((double) (45.0F));
                this.bipedHeadwear.rotateAngleY = (float) Math.toRadians((double) (35.0F));
            }
        }
    }
