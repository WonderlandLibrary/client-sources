...
public class GameSettings
{
    ...
    public KeyBinding dab = new KeyBinding("Dab Mod Key", Keyboard.KEY_F, "Apple Client Mods");
    public KeyBinding freelookKey = new KeyBinding("Perspective Mod Key", Keyboard.KEY_LMENU, "Apple Client Mods");
    ...
    {
        this.keyBindings = (KeyBinding[])((KeyBinding[])ArrayUtils.addAll(new KeyBinding[] {this.keyBindAttack, this.keyBindUseItem, this.keyBindForward, this.keyBindLeft, this.keyBindBack, this.keyBindRight, this.keyBindJump, this.keyBindSneak, this.keyBindSprint, this.keyBindDrop, this.keyBindInventory, this.keyBindChat, this.keyBindPlayerList, this.keyBindPickBlock, this.keyBindCommand, this.keyBindScreenshot, this.keyBindTogglePerspective, this.keyBindSmoothCamera, this.keyBindStreamStartStop, this.keyBindStreamPauseUnpause, this.keyBindStreamCommercials, this.keyBindStreamToggleMic, this.keyBindFullscreen, this.keyBindSpectatorOutlines, this.dab, this.freelookKey}, this.keyBindsHotbar));
    ...
    public void setOptionValue(GameSettings.Options settingsOption, int value)
    {
        ...
        if (settingsOption == GameSettings.Options.GUI_SCALE)
        {
            ...
            Cache.setSR(new ScaledResolution(this.mc));
        }
