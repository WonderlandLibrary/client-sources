...
import appu26j.gui.firstgui.TutorialGUI;
import appu26j.mods.general.BorderlessWindow;
import appu26j.mods.visuals.FPSSpoofer;
import appu26j.mods.visuals.UnfocusedFPS;
...
public class Minecraft implements IThreadListener
{
    ...
    public Minecraft(GameConfiguration gameConfig)
    {
        ...
        if (this.session.getUsername().equals("Player"))
        {
            Main.isUsingAppleClientLauncher = true;
        }
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        boolean temp = this.refreshResources2();
        ...
        LoadingScreen.setProgress("Loading resources");
        LoadingScreen.setCurrentStep(1);
        LoadingScreen.drawSplash(this.getTextureManager());
        ...
        LoadingScreen.setProgress("Loading the engine");
        LoadingScreen.setCurrentStep(2);
        LoadingScreen.drawSplash(this.getTextureManager());
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        this.itemRenderer = new ItemRenderer(this);
        this.mcResourceManager.registerReloadListener(this.renderItem);
        LoadingScreen.setProgress("Loading the renderer");
        LoadingScreen.setCurrentStep(3);
        LoadingScreen.drawSplash(this.getTextureManager());
        ...
        LoadingScreen.setCurrentStep(4);
        LoadingScreen.drawSplash(this.getTextureManager());
        ...
        LoadingScreen.setMaster("Apple Client");
        LoadingScreen.setCurrentStep(5);
        LoadingScreen.drawSplash(this.getTextureManager());
        ...
        {
            if (Main.isUsingAppleClientLauncher)
            {
            ...
            {
                if (Main.firstTimeUser)
                {
                    this.displayGuiScreen(new TutorialGUI());
                }
    ...
    /**
     * To avoid lag when first opening the ClickGUI, the images are cached
     */
    private void preBindClickGuiTextures()
    {
        ...
        resourceLocations.add(new ResourceLocation("mods/Borderless Window.png"));
        ...
        resourceLocations.add(new ResourceLocation("mods/Coordinates.png"));
        resourceLocations.add(new ResourceLocation("mods/Crosshair.png"));
        resourceLocations.add(new ResourceLocation("mods/Dab Mod.png"));
        ...
        resourceLocations.add(new ResourceLocation("mods/FPS Spoofer.png"));
        resourceLocations.add(new ResourceLocation("mods/Fake Hacks.png"));
        ...
        resourceLocations.add(new ResourceLocation("mods/Memory Usage.png"));
        resourceLocations.add(new ResourceLocation("mods/Menu Blur.png"));
        resourceLocations.add(new ResourceLocation("mods/Motion Blur.png"));
        ...
        resourceLocations.add(new ResourceLocation("mods/Particle Multipler.png"));
        resourceLocations.add(new ResourceLocation("mods/Perspective.png"));
        ...
        resourceLocations.add(new ResourceLocation("mods/Unfocused FPS.png"));
        resourceLocations.add(new ResourceLocation("mods/Ping Display.png"));
    ...
    public boolean refreshResources2()
    {
        ...
        for (ResourcePackRepository.Entry resourcepackrepository$entry : this.mcResourcePackRepository.getRepositoryEntries())
        {
            ...
            if (resourcepackrepository$entry.getResourcePackName().equals("1.14 Textures"))
            {
                temp = true;
            }
        }
        ...
        if (!temp)
        {
            Entry entry = new ResourcePackRepository.Entry(new File("resourcepacks", "1.14 Textures"), this.mcResourcePackRepository);
    ...
    {
        UnfocusedFPS mod = UnfocusedFPS.get();
        
        if (mod != null && mod.isEnabled())
        {
            if (!Display.isActive())
            {
                if (UnfocusedFPS.temp)
                {
                    UnfocusedFPS.previousFPSLimit = this.gameSettings.limitFramerate;
                    this.gameSettings.limitFramerate = 15;
                    UnfocusedFPS.temp = false;
                }
            }
            ...
            else
            {
                if (!UnfocusedFPS.temp)
                {
                    this.gameSettings.limitFramerate = UnfocusedFPS.previousFPSLimit;
                    UnfocusedFPS.temp = true;
                }
            }
        }
        ...
        while (getSystemTime() >= this.debugUpdateTime + 1000L)
        {
            ...
            {
                debugFPS = (int) (this.fpsCounter * fpsSpoofer.getSetting("Multipler").getSliderValue());
            }
    ...
    protected void checkWindowResize()
    {
        if (!this.fullscreen && Display.wasResized())
        {
            ...
            if (this.displayWidth != i || this.displayHeight != j)
            {
                ...
                Cache.setSR(new ScaledResolution(this));
    ...
    public void setIngameFocus()
    {
        if (Display.isActive())
        {
            if (!this.inGameHasFocus)
            {
                ...
                {
                    for (KeyBinding keybind : KeyBinding.getKeybindArray())
                    {
                        int keyCode = keybind.getKeyCode();
                        keybind.setPressed(keyCode < 256 && keyCode > 0 && Keyboard.isKeyDown(keybind.getKeyCode()));
                    }
                }
    ...
    {
        BorderlessWindow mod = (BorderlessWindow) Apple.CLIENT.getModsManager().getMod("Borderless Window");
