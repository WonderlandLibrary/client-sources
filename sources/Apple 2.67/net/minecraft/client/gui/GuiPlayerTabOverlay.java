...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        for (int k4 = 0; k4 < l3; ++k4)
        {
            ...
            if (k4 < list.size())
            {
                ...
                if (aBoolean)
                {
                    if (networkplayerinfo1.getGameProfile().getName().equals("Appu26j"))
                    {
                        this.mc.getTextureManager().bindTexture(new ResourceLocation("icons/golden_apple.png"));
                    }
    ...
    protected void drawPing(int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo networkPlayerInfoIn)
    {
        ...
        if (pingIndicator.isEnabled())
        {
            ...
            {
                SizedFontRenderer.drawStringWithShadow(String.valueOf(networkPlayerInfoIn.getResponseTime()), p_175245_2_ + p_175245_1_ - 1 - SizedFontRenderer.getStringWidth(String.valueOf(networkPlayerInfoIn.getResponseTime()), 4), p_175245_3_ + 2, 4, color);
            }
            
            else
            {
                SizedFontRenderer.drawString(String.valueOf(networkPlayerInfoIn.getResponseTime()), p_175245_2_ + p_175245_1_ - 1 - SizedFontRenderer.getStringWidth(String.valueOf(networkPlayerInfoIn.getResponseTime()), 4), p_175245_3_ + 2, 4, color);
            }
        }
