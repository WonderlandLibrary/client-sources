...
public class GuiTextField extends Gui implements MinecraftInterface
{
        ...
        if (this.getVisible())
        {
            ...
            if (this.index != 0)
            {
                ...
                else
                {
                    Color temp = new Color(i, true);
                    int finalColor = new Color(temp.getRed(), temp.getGreen(), temp.getBlue(), (int) (this.index * 255)).getRGB();
                    SizedFontRenderer.drawStringWithShadow("_", (float)k1, (float)i1, 8, finalColor);
                }
            }
        ...
        if (this.getVisible())
        {
            ...
            if (this.index != 0)
            {
                ...
                else
                {
                    ...
                    {
                        SizedFontRenderer.drawString("_", (float)k1, (float)i1, 8, finalColor);
                    }
                }
            }
