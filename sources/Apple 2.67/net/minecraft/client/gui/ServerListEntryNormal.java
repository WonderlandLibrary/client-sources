...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    protected ServerListEntryNormal(GuiMultiplayer p_i45048_1_, ServerData serverIn, ServerList serverListIn)
    {
        this.owner = p_i45048_1_;
        this.server = serverIn;
        this.serverList = serverListIn;
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
        ...
        if (this.server.equals(this.serverList.getServerData(0)))
        {
