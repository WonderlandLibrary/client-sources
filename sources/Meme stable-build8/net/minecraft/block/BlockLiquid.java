...
public abstract class BlockLiquid extends Block
{
    ...
    public boolean isFullCube()
    {
        ...
        return Ruby.getRuby.getModuleManager().getModule(Jesus.class).isEnabled();
    }
    ...
    public boolean isBlockSolid(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
    {
    	...
    	if (Ruby.getRuby.getModuleManager().getModule(Jesus.class).isEnabled()) {
    		if (Minecraft.getMinecraft().thePlayer.fallDistance > 3) {
    			return false;
    		}
            return true;
    	}
