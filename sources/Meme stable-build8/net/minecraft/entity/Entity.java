...
public abstract class Entity implements ICommandSender {
	...
	public void moveEntity(double x, double y, double z) {
		if (this.noClip) {
			...
			Module xd = Ruby.getRuby.getModuleManager().getModule(Fly.class);
			boolean XDD = this instanceof EntityPlayerSP && Ruby.getRuby.setmgr.getSettingByName("Mode", xd).getValString().equalsIgnoreCase("Hypixel") && xd.isEnabled();
			this.onGround = XDD || (this.isCollidedVertically && var15 < 0.0D);
	...
	protected boolean pushOutOfBlocks(double x, double y, double z) {
		if (Ruby.getRuby.getModuleManager().getModule(Phase.class).isEnabled())
			return true;
	...
	public boolean swingCheck() {
		if (this.swing == false) {
			return this.swing = this instanceof EntityPlayer && (((EntityLivingBase) this).isSprinting());
		} else
			return true;
	}
