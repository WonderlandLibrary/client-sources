        ...
        if (this.itemToRender != null)
        {
            ...
            else if (var3.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.SwitchEnumAction.field_178094_a[var7.ordinal()])
                {
                    ...
                    case 4:
                        this.func_178096_b(var2 - 0.1F, 0.0F);
                        this.func_178103_d();
                        float var14 = (float) Math.sin(Math.sqrt(var4) * Math.PI);
                        final float var15 = MathHelper.sin(var4 * var4 * 3.1415927f);
                        GlStateManager.rotate(-var14 * 45, 32, 8, 32);
//                        GlStateManager.translate(var4 * 0.3, var4 * 0.3, (var4 - 1) * 0.3);
                        break;
