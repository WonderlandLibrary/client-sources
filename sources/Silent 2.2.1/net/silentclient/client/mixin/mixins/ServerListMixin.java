...
public abstract class ServerListMixin implements ServerListExt {
    ...
    public ServerData getServerData(int index) {
        try {
            ...
            silent$logger.error("Failed to get server data.", e);
            return null;
        }
    }
    ...
    public void removeServerData(int index) {
        try {
            ...
            silent$logger.error("Failed to remove server data.", e);
        }
    }
    ...
    public void addServerData(ServerData server) {
        try {
            ...
            silent$logger.error("Failed to add server data.", e);
        }
    }
    ...
    public void swapServers(int p_78857_1_, int p_78857_2_) {
        try {
            ...
            silent$logger.error("Failed to swap servers.", e);
        }
    }
