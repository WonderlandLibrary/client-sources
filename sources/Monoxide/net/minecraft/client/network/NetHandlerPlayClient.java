...
import io.github.liticane.monoxide.listener.event.minecraft.render.player.HeadLookEvent;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    /**
     * Seems to be either null (integrated server) or an instance of either AtaniMultiPlayerMenu (when connecting to a server)
    ...
    public void onDisconnect(IChatComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.gameController.displayGuiScreen(new GuiDisconnected(new AtaniMultiPlayerMenu(new AtaniMainMenu()), "disconnect.lost", reason));
        }
    }

    public void addToSendQueue(Packet packetIn) {
        PacketEvent packetEvent = new PacketEvent(packetIn, this, PacketEvent.Type.OUTGOING).publishItself();
    ...
    public void addToReceiveQueueWithoutEvent(Packet <?> packet) {
        this.netManager.receivePacketWithoutEvent(packet);
    }
