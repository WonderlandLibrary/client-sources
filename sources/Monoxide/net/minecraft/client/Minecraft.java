...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    public static List<DisplayMode> macDisplayModes = Lists.newArrayList(new DisplayMode[]{new DisplayMode(2560, 1600), new DisplayMode(2880, 1800)});
    ...
    public FrameTimer field_181542_y = new FrameTimer();
    ...
    public List<IResourcePack> defaultResourcePacks = Lists.newArrayList();
    ...
    public void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Loading Monoxide...");
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn == null && this.theWorld == null) {
            guiScreenIn = new AtaniMainMenu();
        } else if (guiScreenIn == null && this.thePlayer.getHealth() <= 0.0F) {
            guiScreenIn = new GuiGameOver();
        }

        if (guiScreenIn instanceof AtaniMainMenu) {
    ...
    public void runGameLoop() throws IOException {
        ...
        while (getSystemTime() >= this.debugUpdateTime + 1000L) {
            ...
            this.debug = String.format("%d fps (%d chunk update%s) T: %s%s%s%s%s", new Object[]{debugFPS, RenderChunk.renderChunksUpdated, RenderChunk.renderChunksUpdated != 1 ? "s" : "", (float) this.gameSettings.limitFramerate == GameSettings.Options.FRAMERATE_LIMIT.getValueMax() ? "inf" : Integer.valueOf(this.gameSettings.limitFramerate), this.gameSettings.enableVsync ? " vsync" : "", this.gameSettings.fancyGraphics ? "" : " fast", this.gameSettings.clouds == 0 ? "" : (this.gameSettings.clouds == 1 ? " fast-clouds" : " fancy-clouds"), OpenGlHelper.useVbo() ? " vbo" : ""});
    ...
    public void displayDebugInfo(long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            this.fontRendererObj.drawStringWithShadow(s = decimalformat.format(profiler$result.field_76330_b) + "%", (float) (j + i - this.fontRendererObj.getStringWidthInt(s)), (float) (k - i / 2 - 16), l2);
            ...
            for (int k2 = 0; k2 < list.size(); ++k2) {
                ...
                this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profiler$result2.field_76332_a) + "%", (float) (j + i - 50 - this.fontRendererObj.getStringWidthInt(s1)), (float) (k + i / 2 + k2 * 8 + 20), profiler$result2.func_76329_a());
                this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profiler$result2.field_76330_b) + "%", (float) (j + i - this.fontRendererObj.getStringWidthInt(s1)), (float) (k + i / 2 + k2 * 8 + 20), profiler$result2.func_76329_a());
            }
        }
    }
    ...
    public void runTick() throws IOException {
        EventHandling.getInstance().publishEvent(new RunTickEvent());
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        EventHandling.getInstance().publishEvent(new KeyInputEvent(k));
