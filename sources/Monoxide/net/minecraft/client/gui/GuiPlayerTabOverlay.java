...
import io.github.liticane.monoxide.module.impl.hud.CustomTabListModule;
...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    {
        RenderableShaders.renderAndRun(ModuleManager.getInstance().getModule(CustomTabListModule.class).isEnabled() && ModuleManager.getInstance().getModule(CustomTabListModule.class).bloom.isEnabled(), ModuleManager.getInstance().getModule(CustomTabListModule.class).isEnabled() && ModuleManager.getInstance().getModule(CustomTabListModule.class).blur.isEnabled(), () -> {
            ...
            if (list1 != null)
            {
                if(ModuleManager.getInstance().getModule(CustomTabListModule.class).isEnabled()) {
                    switch (ModuleManager.getInstance().getModule(CustomTabListModule.class).background.getValue()) {
                        case "Normal":
                ...
                for (String s3 : list1) {
                    ...
                    if (ModuleManager.getInstance().getModule(CustomTabListModule.class).isEnabled() && ModuleManager.getInstance().getModule(CustomTabListModule.class).customFont.isEnabled()) {
