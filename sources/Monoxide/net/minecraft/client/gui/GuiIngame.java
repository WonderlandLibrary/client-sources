...
import io.github.liticane.monoxide.module.impl.hud.CustomScoreboardModule;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        new Render2DEvent(scaledresolution, partialTicks).publishItself();
    ...
    {
        RenderableShaders.renderAndRun(ModuleManager.getInstance().getModule(CustomScoreboardModule.class).isEnabled() && ModuleManager.getInstance().getModule(CustomScoreboardModule.class).bloom.isEnabled(), ModuleManager.getInstance().getModule(CustomScoreboardModule.class).isEnabled() && ModuleManager.getInstance().getModule(CustomScoreboardModule.class).blur.isEnabled(), () -> {
            ...
            for (Score score1 : collection)
            {
                ...
                if(ModuleManager.getInstance().getModule(CustomScoreboardModule.class).isEnabled()) {
                    switch (ModuleManager.getInstance().getModule(CustomScoreboardModule.class).background.getValue()) {
                        case "Normal":
    ...
    {
        FontRenderer customFontRenderer = FontStorage.getInstance().findFont("SF UI", 17);
        if(ModuleManager.getInstance().getModule(CustomScoreboardModule.class).isEnabled() && ModuleManager.getInstance().getModule(CustomScoreboardModule.class).customFont.isEnabled()) {
