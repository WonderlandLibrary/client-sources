...
public class GuiOverlayDebug extends Gui
{
    ...
    protected void renderDebugInfoLeft()
    {
        ...
        for (int i = 0; i < list.size(); ++i)
        {
            ...
            if (!Strings.isNullOrEmpty(s))
            {
                ...
                int k = this.fontRenderer.getStringWidthInt(s);
                int l = 2;
                int i1 = 2 + j * i;
    ...
    protected List<String> call()
    {
        ...
        {
            return Lists.newArrayList("Atani " + ClientInformationAccess.CLIENT_VERSION + " (" + this.mc.getVersion() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.theWorld.getDebugLoadedEntities() + s1, this.mc.theWorld.getProviderName(), "", String.format("Chunk-relative: %d %d %d", new Object[]{blockpos.getX() & 15, blockpos.getY() & 15, blockpos.getZ() & 15}));
        }
        else
        {
            ...
            List<String> list = Lists.newArrayList("Atani " + ClientInformationAccess.CLIENT_VERSION + " (" + this.mc.getVersion() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.theWorld.getDebugLoadedEntities() + s1, this.mc.theWorld.getProviderName(), "", String.format("XYZ: %.3f / %.5f / %.3f", new Object[]{this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().getEntityBoundingBox().minY, this.mc.getRenderViewEntity().posZ}), String.format("Block: %d %d %d", new Object[]{blockpos.getX(), blockpos.getY(), blockpos.getZ()}), String.format("Chunk: %d %d %d in %d %d %d", new Object[]{blockpos.getX() & 15, blockpos.getY() & 15, blockpos.getZ() & 15, blockpos.getX() >> 4, blockpos.getY() >> 4, blockpos.getZ() >> 4}), String.format("Facing: %s (%s) (%.1f / %.1f)", new Object[]{enumfacing, s, MathHelper.wrapAngleTo180_float(entity.rotationYaw), MathHelper.wrapAngleTo180_float(entity.rotationPitch)}));
