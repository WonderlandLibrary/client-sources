...
public abstract class EntityThrowable extends Entity implements IProjectile
{
    ...
    public EntityThrowable(World worldIn, EntityLivingBase throwerIn)
    {
        ...
        this.posX -= MathHelper.cos(yaw / 180.0F * (float)Math.PI) * 0.16F;
        this.posY -= 0.10000000149011612D;
        this.posZ -= MathHelper.sin(yaw / 180.0F * (float)Math.PI) * 0.16F;
        ...
        this.motionY = -MathHelper.sin((pitch + this.getInaccuracy()) / 180.0F * (float)Math.PI) * f;
