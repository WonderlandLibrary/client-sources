...
public class CommandDebug extends CommandBase
{
    ...
    private String func_147204_b(long p_147204_1_, int p_147204_3_)
    {
        ...
        stringbuilder.append("// This is approximately ").append(String.format("%.2f", new Object[] {(float) p_147204_3_ / ((float) p_147204_1_ / 1000.0F)})).append(" ticks per second. It should be ").append(20).append(" ticks per second\n\n");
    ...
    private void func_147202_a(int p_147202_1_, String p_147202_2_, StringBuilder p_147202_3_)
    {
        ...
        if (list != null && list.size() >= 3)
        {
            for (int i = 1; i < list.size(); ++i)
            {
                ...
                p_147202_3_.append(profiler$result.field_76331_c).append(" - ").append(String.format("%.2f", new Object[] {profiler$result.field_76332_a})).append("%/").append(String.format("%.2f", new Object[] {profiler$result.field_76330_b})).append("%\n");
