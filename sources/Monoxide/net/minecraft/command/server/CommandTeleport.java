        ...
        else
        {
            ...
            if (args.length != 1 && args.length != 2)
            {
                ...
                else if (entity.worldObj != null)
                {
                    ...
                    notifyOperators(sender, this, "commands.tp.success.coordinates", new Object[] {entity.getCommandSenderName(), commandbase$coordinatearg.func_179628_a(), commandbase$coordinatearg1.func_179628_a(), commandbase$coordinatearg2.func_179628_a()});
                }
            }
            else
            {
