    ...
    public int findChunksForSpawning(WorldServer p_77192_1_, boolean spawnHostileMobs, boolean spawnPeacefulMobs, boolean p_77192_4_)
    {
        ...
        else
        {
            ...
            for (EnumCreatureType enumcreaturetype : EnumCreatureType.values())
            {
                ...
                {
                    int k4 = Reflector.ForgeWorld_countEntities.exists() ? Reflector.callInt(p_77192_1_, Reflector.ForgeWorld_countEntities, new Object[] {enumcreaturetype, Boolean.TRUE}): p_77192_1_.countEntities(enumcreaturetype.getCreatureClass());
    ...
    public static boolean canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType p_180267_0_, World worldIn, BlockPos pos)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                boolean flag = Reflector.ForgeBlock_canCreatureSpawn.exists() ? Reflector.callBoolean(iblockstate.getBlock(), Reflector.ForgeBlock_canCreatureSpawn, new Object[] {worldIn, blockpos, p_180267_0_}): World.doesBlockHaveSolidTopSurface(worldIn, blockpos);
                ...
                for (int j1 = 0; j1 < i; ++j1)
                {
                    ...
                    for (int k1 = 0; !flag && k1 < 4; ++k1)
                    {
                        ...
                        if (canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType.ON_GROUND, worldIn, blockpos))
                        {
                            ...
                            {
                                Object object = Reflector.call(Reflector.ForgeEventFactory_canEntitySpawn, new Object[] {entityliving, worldIn, (float) j + 0.5F, blockpos.getY(), (float) k + 0.5F});
