package io.github.liticane.monoxide.ui.screens.clickgui.oldaugustus;
...
import io.github.liticane.monoxide.ui.screens.clickgui.oldaugustus.frame.Frame;
...
public class OldAugustusClickGuiScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if(frames.isEmpty()) {
            float y = 50, width = 100, height = 18, x = (this.width - (ModuleCategory.values().length * (width + 5))) / 2; /* The X is made like that so categories will be in the middle*/
