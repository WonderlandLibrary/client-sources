...
public class AtaniMultiPlayerMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private AtaniServerSelectionList serverListSelector;
    ...
    public AtaniMultiPlayerMenu(GuiScreen parentScreen)
    {
    ...
    public void initGui()
    {
        DiscordRP.update("Sewrwer L-list", "S-sewecting a sewrwer...~ o//w//o");
    ...
    {
        this.buttonList.add(this.btnEditServer = new AtaniButton(7, this.width / 2 - 154, this.height - 28 - 20, 70, 20, I18n.format("selectServer.edit", new Object[0])));
        this.buttonList.add(this.btnDeleteServer = new AtaniButton(2, this.width / 2 - 74, this.height - 28 - 20, 70, 20, I18n.format("selectServer.delete", new Object[0])));
        this.buttonList.add(this.btnSelectServer = new AtaniButton(1, this.width / 2 - 154, this.height - 52 - 20, 100, 20, I18n.format("selectServer.select", new Object[0])));
        this.buttonList.add(new AtaniButton(4, this.width / 2 - 50, this.height - 52 - 20, 100, 20, I18n.format("selectServer.direct", new Object[0])));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            AtaniGuiListExtended.IGuiListEntry guilistextended$iguilistentry = this.serverListSelector.func_148193_k() < 0 ? null : this.serverListSelector.getListEntry(this.serverListSelector.func_148193_k());

            if (button.id == 2 && guilistextended$iguilistentry instanceof AtaniServerListEntryNormal)
            {
                String s4 = ((AtaniServerListEntryNormal)guilistextended$iguilistentry).getServerData().serverName;
            ...
            else if (button.id == 7 && guilistextended$iguilistentry instanceof AtaniServerListEntryNormal)
            {
                this.editingServer = true;
                ServerData serverdata = ((AtaniServerListEntryNormal)guilistextended$iguilistentry).getServerData();
    ...
    {
        this.mc.displayGuiScreen(new AtaniMultiPlayerMenu(this.parentScreen));
    }
    ...
    public void confirmClicked(boolean result, int id)
    {
        ...
        if (this.deletingServer)
        {
            ...
            if (result && guilistextended$iguilistentry instanceof AtaniServerListEntryNormal)
            {
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        AtaniGuiListExtended.IGuiListEntry guilistextended$iguilistentry = i < 0 ? null : this.serverListSelector.getListEntry(i);
        ...
        else
        {
            if (i >= 0)
            {
                if (keyCode == 200)
                {
                    if (isShiftKeyDown())
                    {
                        if (i > 0 && guilistextended$iguilistentry instanceof AtaniServerListEntryNormal)
                        {
                    ...
                    else if (i > 0)
                    {
                        ...
                        if (this.serverListSelector.getListEntry(this.serverListSelector.func_148193_k()) instanceof AtaniServerListEntryLanScan)
                        {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(FontStorage.getInstance().findFont("SF UI", 19), I18n.format("multiplayer.title", new Object[0]), this.width / 2, 20 + 20, 16777215);
    ...
    public void connectToSelected()
    {
        ...
        if (guilistextended$iguilistentry instanceof AtaniServerListEntryNormal)
        {
            this.connectToServer(((AtaniServerListEntryNormal)guilistextended$iguilistentry).getServerData());
        }
        else if (guilistextended$iguilistentry instanceof AtaniServerListEntryLanDetected)
        {
            LanServerDetector.LanServer lanserverdetector$lanserver = ((AtaniServerListEntryLanDetected)guilistextended$iguilistentry).getLanServer();
    ...
    public void selectServer(int index)
    {
        ...
        AtaniGuiListExtended.IGuiListEntry guilistextended$iguilistentry = index < 0 ? null : this.serverListSelector.getListEntry(index);
        this.btnSelectServer.enabled = false;
        this.btnEditServer.enabled = false;
        this.btnDeleteServer.enabled = false;

        if (guilistextended$iguilistentry != null && !(guilistextended$iguilistentry instanceof AtaniServerListEntryLanScan))
        {
    ...
    public boolean func_175392_a(AtaniServerListEntryNormal p_175392_1_, int p_175392_2_)
    {
        return p_175392_2_ > 0;
    }

    public boolean func_175394_b(AtaniServerListEntryNormal p_175394_1_, int p_175394_2_)
    {
        return p_175394_2_ < this.savedServerList.countServers() - 1;
    }

    public void func_175391_a(AtaniServerListEntryNormal p_175391_1_, int p_175391_2_, boolean p_175391_3_)
    {
    ...
    public void func_175393_b(AtaniServerListEntryNormal p_175393_1_, int p_175393_2_, boolean p_175393_3_)
    {
