...
public class AtaniServerListEntryLanDetected implements AtaniGuiListExtended.IGuiListEntry
{
    ...
    {
        FontStorage.getInstance().findFont("SF UI", 19).drawString(I18n.format("lanServer.title", new Object[0]), x + 32 + 3, y + 1, 16777215);
        FontStorage.getInstance().findFont("SF UI", 19).drawString(this.field_148291_b.getServerMotd(), x + 32 + 3, y + 12, 8421504);

        if (this.mc.gameSettings.hideServerAddress)
        {
            FontStorage.getInstance().findFont("SF UI", 19).drawString(I18n.format("selectServer.hiddenAddress", new Object[0]), x + 32 + 3, y + 12 + 11, 3158064);
        }
        else
        {
            FontStorage.getInstance().findFont("SF UI", 19).drawString(this.field_148291_b.getServerIpPort(), x + 32 + 3, y + 12 + 11, 3158064);
        }
    }
