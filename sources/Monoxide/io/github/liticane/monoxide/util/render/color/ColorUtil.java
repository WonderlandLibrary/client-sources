package io.github.liticane.monoxide.util.render.color;
...
public class ColorUtil {
    ...
    public static int getAstolfoColor(ModuleCategory category) {
        return switch (category) {
            case COMBAT -> new Color(230, 77, 62).getRGB();
            case MOVEMENT -> new Color(48, 203, 116).getRGB();
            case PLAYER -> new Color(141, 67, 169).getRGB();
            case MISCELLANEOUS -> new Color(75, 145, 190).getRGB();
            case RENDER -> new Color(245, 155, 27).getRGB();
            case HUD -> new Color(56, 0, 196).getRGB();
        };
    }
