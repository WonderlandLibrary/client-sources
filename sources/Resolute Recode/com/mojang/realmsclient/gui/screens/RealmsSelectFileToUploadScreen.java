...
public class RealmsSelectFileToUploadScreen extends RealmsScreen
{
    ...
    class WorldSelectionEntry extends ExtendedList.AbstractListEntry<WorldSelectionEntry>
    {
    ...
    class WorldSelectionList extends RealmsObjectSelectionList<WorldSelectionEntry>
    {
        public WorldSelectionList()
        {
            super(RealmsSelectFileToUploadScreen.this.width, RealmsSelectFileToUploadScreen.this.height, func_239562_k_(0), RealmsSelectFileToUploadScreen.this.height - 40, 36);
        }
