...
public class CustomGuiProperties
{
    ...
    private static EnumVariant[] getContainerVariants(EnumContainer cont)
    {
        ...
        {
            return cont == EnumContainer.DISPENSER ? VARIANTS_DISPENSER : new EnumVariant[0];
        }
    }
    ...
    private boolean matchesDispenser(BlockPos pos, IBlockDisplayReader blockAccess)
    {
        ...
        else
        {
            ...
            {
                EnumVariant customguiproperties$enumvariant = this.getDispenserVariant(dispensertileentity);
    ...
    private boolean matchesHorse(Entity entity, IBlockDisplayReader blockAccess)
    {
        ...
        else
        {
            ...
            if (this.variants != null)
            {
                EnumVariant customguiproperties$enumvariant = this.getHorseVariant(abstracthorseentity);
