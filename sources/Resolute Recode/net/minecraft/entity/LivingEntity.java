...
import wtf.resolute.evented.EventDamageReceive;
...
import wtf.resolute.moduled.impl.render.SwingAnimation;
...
public abstract class LivingEntity extends Entity {
    ...
    public boolean onLivingFall(float distance, float damageMultiplier) {
        ...
        if (i > 0) {
            ...
            if (this instanceof ClientPlayerEntity) {
                ResoluteInfo.getInstance().getEventBus()
    ...
    protected void jump() {
        ...
        if (this instanceof ClientPlayerEntity entity) {
            ResoluteInfo.getInstance().getEventBus().post(jumpEvent);
        }
