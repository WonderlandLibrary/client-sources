...
import wtf.resolute.evented.EventStartRiding;
import wtf.resolute.evented.MovingEvent;
import wtf.resolute.evented.PostMoveEvent;
import wtf.resolute.moduled.ModuleRegister;
import wtf.resolute.moduled.impl.combat.Hitbox;
import wtf.resolute.moduled.impl.render.Trails;
...
public abstract class Entity implements INameable, ICommandSource {
    ...
    public void move(MoverType typeIn, Vector3d pos) {
        ...
        if (this.noClip) {
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                ResoluteInfo.getInstance().getEventBus().post(move);
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                ResoluteInfo.getInstance().getEventBus().post(post);
            }
    ...
    public boolean startRiding(Entity entityIn, boolean force) {
        ResoluteInfo.getInstance().getEventBus().post(new EventStartRiding(entityIn));
