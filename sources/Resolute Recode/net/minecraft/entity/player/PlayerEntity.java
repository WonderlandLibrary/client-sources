...
import wtf.resolute.evented.EventLivingUpdate;
...
import wtf.resolute.moduled.impl.player.AutoTool;
...
public abstract class PlayerEntity extends LivingEntity {
    ...
    public void tick() {
        ...
        ResoluteInfo.getInstance().getEventBus().post(livingUpdate);
    ...
    public boolean func_234569_d_(BlockState p_234569_1_) {
        AutoTool autoTool = ResoluteInfo.getInstance().getFunctionRegistry().getAutoTool();
