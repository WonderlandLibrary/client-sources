...
public class EditGamerulesScreen extends Screen
{
    ...
    public class GamerulesList extends AbstractOptionList<Gamerule>
    {
        public GamerulesList(final GameRules p_i232316_2_)
        {
            ...
            final Map < GameRules.Category, Map < GameRules.RuleKey<?>, Gamerule >> map = Maps.newHashMap();
        ...
        public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
        {
            ...
            {
                Gamerule editgamerulesscreen$gamerule = this.getEntryAtPosition((double)mouseX, (double)mouseY);
    ...
    {
        Gamerule create(ITextComponent p_create_1_, List<IReorderingProcessor> p_create_2_, String p_create_3_, T p_create_4_);
    }
