...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = ResoluteInfo.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(ResoluteInfo.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        ResoluteInfo.getInstance().getViaMCP().viaScreen.tick();
