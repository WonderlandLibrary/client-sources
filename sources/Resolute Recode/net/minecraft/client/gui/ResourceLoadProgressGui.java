...
import wtf.resolute.utiled.animations.Alternatetext;
...
public class ResourceLoadProgressGui extends LoadingGui {
    ...
    private Alternatetext text = new Alternatetext(Arrays.asList("...", "...", "...", "...", "...", "...", "...", "...", "..."), 1500);
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (f >= 1.0F) {
            ...
            int l = MathHelper.ceil((1.0F - MathHelper.clamp(f - 1.0F, 0.0F, 1.0F)) * 255.0F);
            DisplayUtils.drawRect(0, 0, width, height, new Color(255, 255, 255, l).getRGB());
            f2 = 1.0F - MathHelper.clamp(f - 1.0F, 0.0F, 1.0F);
        ...
        DisplayUtils.drawRect(0, 0, width, height, ColorUtils.rgba(255, 255, 255, (int) (255 * f2)));
        ...
        float finalF = f2;
        {
            ...
            GlStateManager.translated(-(width / 2f), -(height / 2f), 0);
            GlStateManager.popMatrix();
            Fonted.nunito[16].drawCenteredString(matrixStack, "Загрузка" + text.output, width / 2f, height / 2f + 42, ColorUtils.rgba(0, 0, 0, (int) (255 * finalF)));
            int imageWidth = 16;
            int imageHeight = 16;
            ...
            final ResourceLocation resourceLocation = new ResourceLocation("resolute/images/loadscreen/" + currentImageIndex + ".png");
            DisplayUtils.drawImage(resourceLocation,width / 2f - 8, height / 2f + 12, imageWidth, imageHeight,-1);
        };
