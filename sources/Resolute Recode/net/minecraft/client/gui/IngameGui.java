...
import wtf.resolute.moduled.impl.render.Crosshair;
...
public class IngameGui extends AbstractGui {
    ...
    public void renderIngameGui(MatrixStack matrixStack, float partialTicks) {
        ...
        if (eventDisplay.getType() == EventDisplay.Type.PRE) {
            ResoluteInfo.getInstance().getEventBus().post(eventDisplay);
        }
        ...
        if (!this.mc.gameSettings.hideGUI) {
            ...
            ResoluteInfo.getInstance().getEventBus().post(eventCancelOverlay);
        ...
        mc.gameRenderer.setupOverlayRendering(2);
        Managed.NOTIFICATION_MANAGER.draw(matrixStack);
    ...
    protected void renderHotbar(float partialTicks, MatrixStack matrixStack) {
        ...
        if (playerentity != null) {
            ...
            boolean CustomHotbar = ResoluteInfo.getInstance().getFunctionRegistry().getHotbar().isState();
            ...
            if (CustomHotbar) {
                {
                    ...
                    int x2 = 182;
                    int y2 = 22;
                    DisplayUtils.drawShadow(x, y, x2, y2 - 2, 4, firstColor, secondColor);
                    DisplayUtils.drawRoundedRect(x, y, x2, y2 - 2, 1, DisplayUtils.reAlphaInt(new java.awt.Color(33, 32, 34).getRGB(), 250));
                    DisplayUtils.drawRoundedRect(x, y, x2, 2, 1, ColorUtils.getColor(0));
                }
                {
                    ...
                    int x2 = 24;
                    int y2 = 22;
                    DisplayUtils.drawRoundedRect(x + 2, y + 3, x2 - 4, y2 - 5, 1, new java.awt.Color(30, 33, 44).getRGB());
                }
            } else {
