...
import wtf.resolute.evented.EventChangeWorld;
import wtf.resolute.evented.TickEvent;
...
import wtf.resolute.moduled.impl.player.ItemCooldown;
...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
    ...
    private void tick(boolean isDebug, @Nullable LongTickDetector detector) {
        ResoluteInfo.getInstance().getEventBus().post(tickEvent);
    ...
    public void runTick() {
        ...
        if (this.world != null) {
            ResoluteInfo.getInstance().getEventBus().post(player.tick);
    ...
    public void loadWorld(ClientWorld worldClientIn) {
        ...
        ResoluteInfo.getInstance().getEventBus().post(new EventChangeWorld());
    }
