...
public class JigsawTileEntity extends TileEntity
{
    ...
    public void read(BlockState state, CompoundNBT nbt)
    {
        ...
        this.field_235661_g_ = OrientationType.func_235673_a_(nbt.getString("joint")).orElseGet(() ->
        {
            return JigsawBlock.getConnectingDirection(state).getAxis().isHorizontal() ? OrientationType.ALIGNED : OrientationType.ROLLABLE;
        });
    }
