...
public class FunctionObject
{
    ...
    {
        List<IEntry> list = Lists.newArrayListWithCapacity(p_237140_3_.size());
    ...
    public static class CommandEntry implements IEntry
    {
    ...
    public static class FunctionEntry implements IEntry
    {
