...
public class ServerWorldLightManager extends WorldLightManager implements AutoCloseable
{
    ...
    public void checkBlock(BlockPos blockPosIn)
    {
        ...
        this.func_215586_a(blockPosIn.getX() >> 4, blockPosIn.getZ() >> 4, Phase.POST_UPDATE, Util.namedRunnable(() ->
        {
    ...
    {
        this.func_215586_a(p_215571_1_.x, p_215571_1_.z, Phase.PRE_UPDATE, Util.namedRunnable(() ->
        {
    ...
    public CompletableFuture<IChunk> lightChunk(IChunk p_215593_1_, boolean p_215593_2_)
    {
        ...
        {
            this.func_215586_a(chunkpos.x, chunkpos.z, Phase.POST_UPDATE, p_215597_2_);
        });
    }
