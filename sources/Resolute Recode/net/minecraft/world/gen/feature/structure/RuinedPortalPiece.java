...
public class RuinedPortalPiece extends TemplateStructurePiece
{
    ...
    public RuinedPortalPiece(TemplateManager p_i232110_1_, CompoundNBT p_i232110_2_)
    {
        ...
        this.field_237008_i_ = Serializer.field_237024_a_.parse(new Dynamic<>(NBTDynamicOps.INSTANCE, p_i232110_2_.get("Properties"))).getOrThrow(true, field_237003_d_::error);
    ...
    protected void readAdditional(CompoundNBT tagCompound)
    {
        ...
        Serializer.field_237024_a_.encodeStart(NBTDynamicOps.INSTANCE, this.field_237008_i_).resultOrPartial(field_237003_d_::error).ifPresent((p_237018_1_) ->
        {
    ...
    public static enum Location
    {
        ...
        private static final Map<String, Location> field_237038_g_ = Arrays.stream(values()).collect(Collectors.toMap(Location::func_237040_a_, (p_237041_0_) -> {
            return p_237041_0_;
        }));
    ...
    {
        public static final Codec<Serializer> field_237024_a_ = RecordCodecBuilder.create((p_237031_0_) ->
        {
            ...
            })).apply(p_237031_0_, Serializer::new);
        });
