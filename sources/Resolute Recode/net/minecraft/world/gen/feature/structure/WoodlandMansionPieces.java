...
public class WoodlandMansionPieces
{
    ...
    static class Grid
    {
        ...
        @Nullable
        public Direction get1x2RoomDirection(SimpleGrid p_191113_1_, int p_191113_2_, int p_191113_3_, int p_191113_4_, int p_191113_5_)
        {
        ...
        private void recursiveCorridor(SimpleGrid p_191110_1_, int p_191110_2_, int p_191110_3_, Direction p_191110_4_, int p_191110_5_)
        {
            if (p_191110_5_ > 0)
            {
    ...
    static class Placer
    {
        ...
        public void createMansion(BlockPos p_191125_1_, Rotation p_191125_2_, List<MansionTemplate> p_191125_3_, Grid p_191125_4_)
        {
            ...
            this.createRoof(p_191125_3_, p_191125_1_.up(27), p_191125_2_, woodlandmansionpieces$simplegrid1, (SimpleGrid)null);
                ...
                for (int i1 = 0; i1 < woodlandmansionpieces$simplegrid3.height; ++i1)
                {
                    for (int j1 = 0; j1 < woodlandmansionpieces$simplegrid3.width; ++j1)
                    {
                        if (woodlandmansionpieces$simplegrid3.get(j1, i1) == 1)
                        {
                            ...
                            {
                                p_191125_3_.add(new MansionTemplate(this.templateManager, "carpet_north", blockpos1.offset(p_191125_2_.rotate(Direction.EAST), 1).up(), p_191125_2_));
                            }

                            if (woodlandmansionpieces$simplegrid3.get(j1 + 1, i1) == 1 || (woodlandmansionpieces$simplegrid2.get(j1 + 1, i1) & 8388608) == 8388608)
                            {
                                p_191125_3_.add(new MansionTemplate(this.templateManager, "carpet_east", blockpos1.offset(p_191125_2_.rotate(Direction.SOUTH), 1).offset(p_191125_2_.rotate(Direction.EAST), 5).up(), p_191125_2_));
                            }

                            if (woodlandmansionpieces$simplegrid3.get(j1, i1 + 1) == 1 || (woodlandmansionpieces$simplegrid2.get(j1, i1 + 1) & 8388608) == 8388608)
                            {
                                p_191125_3_.add(new MansionTemplate(this.templateManager, s, blockpos1.offset(p_191125_2_.rotate(Direction.SOUTH), 5).offset(p_191125_2_.rotate(Direction.WEST), 1), p_191125_2_));
                            }

                            if (woodlandmansionpieces$simplegrid3.get(j1 - 1, i1) == 1 || (woodlandmansionpieces$simplegrid2.get(j1 - 1, i1) & 8388608) == 8388608)
                            {
                                p_191125_3_.add(new MansionTemplate(this.templateManager, s1, blockpos1.offset(p_191125_2_.rotate(Direction.WEST), 1).offset(p_191125_2_.rotate(Direction.NORTH), 1), p_191125_2_));
                            }
                        }
                    }
                }
                ...
                for (int k1 = 0; k1 < woodlandmansionpieces$simplegrid3.height; ++k1)
                {
                    for (int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.width; ++l1)
                    {
                        ...
                        if (woodlandmansionpieces$simplegrid3.get(l1, k1) == 2 || flag1)
                        {
                            ...
                            {
                                p_191125_3_.add(new MansionTemplate(this.templateManager, direction1 == Direction.WEST ? s3 : s2, blockpos3, p_191125_2_));
                            }
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(l1 + 1, k1) == 1 && !flag1)
                            {
                                ...
                                p_191125_3_.add(new MansionTemplate(this.templateManager, direction1 == Direction.EAST ? s3 : s2, blockpos2, p_191125_2_));
                            }
                            ...
                            if (Grid.isHouse(woodlandmansionpieces$simplegrid3, l1, k1 + 1) && !p_191125_4_.isRoomId(woodlandmansionpieces$simplegrid3, l1, k1 + 1, l2, k2))
                            {
                                ...
                                p_191125_3_.add(new MansionTemplate(this.templateManager, direction1 == Direction.SOUTH ? s3 : s2, blockpos4, p_191125_2_.add(Rotation.CLOCKWISE_90)));
                            }
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(l1, k1 - 1) == 1 && !flag1)
                            {
                                ...
                                p_191125_3_.add(new MansionTemplate(this.templateManager, direction1 == Direction.NORTH ? s3 : s2, blockpos5, p_191125_2_.add(Rotation.CLOCKWISE_90)));
                            }
        ...
        private void traverseOuterWalls(List<MansionTemplate> p_191130_1_, PlacementData p_191130_2_, SimpleGrid p_191130_3_, Direction p_191130_4_, int p_191130_5_, int p_191130_6_, int p_191130_7_, int p_191130_8_)
        {
            int i = p_191130_5_;
            int j = p_191130_6_;
        ...
        private void entrance(List<MansionTemplate> p_191133_1_, PlacementData p_191133_2_)
        {
            ...
            p_191133_1_.add(new MansionTemplate(this.templateManager, "entrance", p_191133_2_.position.offset(direction, 9), p_191133_2_.rotation));
        ...
        {
            p_191131_1_.add(new MansionTemplate(this.templateManager, p_191131_2_.wallType, p_191131_2_.position.offset(p_191131_2_.rotation.rotate(Direction.EAST), 7), p_191131_2_.rotation));
        ...
        private void addRoom1x1(List<MansionTemplate> p_191129_1_, BlockPos p_191129_2_, Rotation p_191129_3_, Direction p_191129_4_, RoomCollection p_191129_5_)
        {
        ...
        private void addRoom1x2(List<MansionTemplate> p_191132_1_, BlockPos p_191132_2_, Rotation p_191132_3_, Direction p_191132_4_, Direction p_191132_5_, RoomCollection p_191132_6_, boolean p_191132_7_)
        {
        ...
        private void addRoom2x2(List<MansionTemplate> p_191127_1_, BlockPos p_191127_2_, Rotation p_191127_3_, Direction p_191127_4_, Direction p_191127_5_, RoomCollection p_191127_6_)
        {
            int i = 0;
            int j = 0;
