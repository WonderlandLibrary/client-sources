package wtf.resolute.ui.ab.render.impl.item;

import com.mojang.blaze3d.matrix.MatrixStack;
import wtf.resolute.ResoluteInfo;
import wtf.resolute.ui.ab.render.impl.AddedItemComponent;
import wtf.resolute.ui.ab.render.impl.AllItemComponent;
import wtf.resolute.ui.ab.render.impl.Component;
import wtf.resolute.utiled.client.IMinecraft;
import wtf.resolute.utiled.components.ButtonComponent;
import wtf.resolute.utiled.components.FieldComponent;
import wtf.resolute.utiled.components.SliderComponent;
...
public class EditComponent extends Component implements IMinecraft {
    ...
    private final ButtonComponent add = new ButtonComponent(0, 0, 0, 0, "Добавить", () -> {
        if (!price.get().isEmpty()) {
            ...
            ResoluteInfo.getInstance().getItemStorage().addItem(stack.getItem(), Integer.parseInt(price.get()), Integer.parseInt(count.fieldComponent.get()), Integer.parseInt(damage.fieldComponent.get()), enchantmentWidget.get());
