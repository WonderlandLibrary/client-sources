...
@ModuleAnontion(name = "TargetStrafe", type = Categories.Movement,server = "")
public class TargetStrafe extends Module {
    ...
    public TargetStrafe(KillAura killAura) {
        ...
        addSettings(distanceSetting, damageBoostSetting,boostValueSetting, timeSetting, saveTarget);
    }
