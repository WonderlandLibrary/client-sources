...
@ModuleAnontion(name = "Trails", type = Categories.Render,server = "")
    ...
    public void onRender(WorldEvent event) {
        ...
        if (babyboy) {
            for (PlayerEntity entity : mc.world.getPlayers()) {
                entity.points.removeIf(p -> p.time.isReached(200));
            ...
            for (Entity entity : mc.world.getAllEntities()) {
                ...
                for (Point point : points) {
                    ...
                    GL11.glVertex3d(point.getPosition().x, point.getPosition().y + 1,
                            point.getPosition().z);
                }
