...
@ModuleAnontion(name = "HitSound", type = Categories.Misc,server = "")
public class HitSound extends Module {

    private final ModeSetting sound = new ModeSetting("Звук",
            "bell",
            "bell", "metallic", "rust", "bubble", "bonk", "crime","UwU"
    );
    ...
    public void playSound(Entity e) {
        try {
            ...
            InputStream is = mc.getResourceManager().getResource(new ResourceLocation("resolute/sounds/" + sound.get() + ".wav")).getInputStream();
