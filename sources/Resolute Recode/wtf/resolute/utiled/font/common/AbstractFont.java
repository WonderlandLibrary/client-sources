package wtf.resolute.utiled.font.common;

import com.mojang.blaze3d.platform.GlStateManager;
import net.minecraft.client.renderer.vertex.DefaultVertexFormats;
import net.minecraft.util.math.vector.Matrix4f;
import wtf.resolute.utiled.font.Fonted;
import wtf.resolute.utiled.font.TextureHelper;
import wtf.resolute.utiled.font.Wrapper;
...
public abstract class AbstractFont implements Wrapper {
    ...
    public static final Font getFont(String fileName, int style, int size) {
        String path = Fonted.FONT_DIR.concat(fileName);
        Font font = null;

        try {
            font = Font.createFont(Font.TRUETYPE_FONT, Objects.requireNonNull(Fonted.class.getResourceAsStream(path)))
