package wtf.resolute.utiled.font;

import lombok.SneakyThrows;
import wtf.resolute.utiled.font.common.Lang;
import wtf.resolute.utiled.font.styled.StyledFont;


public class Fonted {
    public static final String FONT_DIR = "/assets/minecraft/resolute/font/";
    ...
    public static volatile StyledFont[] sfbold = new StyledFont[30];
    public static volatile StyledFont[] rubik = new StyledFont[30];
    public static volatile StyledFont[] nunito = new StyledFont[30];
    public static volatile StyledFont[] iconhud = new StyledFont[36];
    public static volatile StyledFont[] sfpro_italic_heavy = new StyledFont[30];
    @SneakyThrows
    public static void init() {
        ...
        for (int i = 8; i < 36;i++) {
            iconhud[i] = new StyledFont("hudicon.ttf", i, 0.0f, 0.0f, 0.0f, true, Lang.ENG_RU);
        }
        for (int i = 8; i < 16;i++) {
        ...
        for (int i = 8; i < 30;i++) {
            sfbold[i] = new StyledFont("sf_bold.ttf", i, 0.0f, 0.0f, 0.0f, true, Lang.ENG_RU);
        }
        for (int i = 8; i < 30;i++) {
            rubik[i] = new StyledFont("rub.ttf", i, 0.0f, 0.0f, 0.0f, true, Lang.ENG_RU);
        }
        for (int i = 8; i < 30;i++) {
            nunito[i] = new StyledFont("nunito.ttf", i, 0.0f, 0.0f, 0.0f, true, Lang.ENG_RU);
        }
        for (int i = 8; i < 30;i++) {
            sfpro_italic_heavy[i] = new StyledFont("sfpro_italic_heavy.ttf", i, 0.0f, 0.0f, 0.0f, true, Lang.ENG_RU);
        }
