...
public class KawaseBlur {
    ...
    public void updateBlur(float offset, int steps) {
        ...
        wtf.resolute.utiled.shader.ShaderUtil.kawaseDown.attach();
        wtf.resolute.utiled.shader.ShaderUtil.kawaseDown.setUniform("offset", offset);
        wtf.resolute.utiled.shader.ShaderUtil.kawaseDown.setUniformf("resolution", 1f / mc.getMainWindow().getWidth(),
        ...
        wtf.resolute.utiled.shader.ShaderUtil.kawaseUp.attach();
        wtf.resolute.utiled.shader.ShaderUtil.kawaseUp.setUniform("offset", offset);
        wtf.resolute.utiled.shader.ShaderUtil.kawaseUp.setUniformf("resolution", 1f / mc.getMainWindow().getWidth(),
                1f / mc.getMainWindow().getHeight());
