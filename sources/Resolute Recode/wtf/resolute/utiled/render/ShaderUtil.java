...
public class ShaderUtil implements IMinecraft {
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        ...
        int fragmentShaderID = switch (fragmentShaderLoc) {
          ...
          //  default ->
              //      createShader(Minecraft.getResourceManager().getResource(new ResourceLocation("resolute/shader/" + fragmentShaderLoc)).getInputStream(), GL_FRAGMENT_SHADER);
    ...
    static MainWindow sr = mc.getMainWindow();
