...
public class GuiConnecting extends GuiScreen {
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet()) {
            public void run() {
                ...
                try {
                    ...
                    Celestial.playTimeStart = System.currentTimeMillis();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.networkManager == null) {
        	Minecraft.getMinecraft().mntsb_18.drawCenteredString(I18n.format("connect.connecting"), this.width / 2, this.height / 2 - 50, 16777215);
        } else {
            Minecraft.getMinecraft().mntsb_18.drawCenteredString(I18n.format("connect.authorizing"), this.width / 2, this.height / 2 - 50, 16777215);
        }
