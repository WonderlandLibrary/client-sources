...
import ru.smertnix.celestial.feature.impl.misc.ChatHistory;
import ru.smertnix.celestial.feature.impl.misc.FastWorldLoad;
import ru.smertnix.celestial.ui.SplashProgress;
...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    public MCFontRenderer mntsb_18;
    public MCFontRenderer mntsb_25;
    public MCFontRenderer mntsb_30;
    public MCFontRenderer mntsb_17;
    public MCFontRenderer mntsb_16;
    public MCFontRenderer mntsb_15;
    public MCFontRenderer mntsb_14;
    public MCFontRenderer mntsb_13;
    public MCFontRenderer mntsb_20;
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        this.mntsb_18 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("celestial/fonts/montserrat.ttf"), 18.0f, 0), true, true);
        this.mntsb_17 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("celestial/fonts/montserrat.ttf"), 17.0f, 0), true, true);
        this.mntsb_16 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("celestial/fonts/montserrat.ttf"), 16.0f, 0), true, true);
        this.mntsb_15 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("celestial/fonts/montserrat.ttf"), 15.0f, 0), true, true);
        this.mntsb_14 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("celestial/fonts/montserrat.ttf"), 14.0f, 0), true, true);
        this.mntsb_13 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("celestial/fonts/montserrat.ttf"), 13.0f, 0), true, true);
        this.mntsb_25 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("celestial/fonts/montserrat.ttf"), 25.0f, 0), true, true);
        this.mntsb_30 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("celestial/fonts/montserrat.ttf"), 30.0f, 0), true, true);
        this.mntsb_20 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("celestial/fonts/montserrat.ttf"), 20.0f, 0), true, true);
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Celestial.instance.name + " " + Celestial.instance.type);
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("celestial/icon64.jpg"));
                inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("celestial/icon32.jpg"));
    ...
    public void displayGuiScreen(@Nullable GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn instanceof MainMenu || guiScreenIn instanceof GuiMultiplayer) {
            ...
            this.ingameGUI.getChatGUI().clearChatMessages(!Celestial.instance.featureManager.getFeature(ChatHistory.class).isEnabled());
        }
    ...
    public void freeMemory() {
        ...
        try {
            if (!Celestial.instance.featureManager.getFeature(FastWorldLoad.class).isEnabled()) {
                System.gc();
                this.loadWorld(null);
            }
