...
import ru.smertnix.celestial.event.events.impl.player.*;
import ru.smertnix.celestial.feature.impl.hud.ClickGUI;
import ru.smertnix.celestial.feature.impl.movement.NoSlowDown;
    ...
    public void onUpdate() {
        ...
        if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                if (!Celestial.instance.featureManager.getFeature(FreeCamera.class).isEnabled()) {
...
/*
    ...
    public void onLivingUpdate() {
        ...
        if (this.isHandActive() && !this.isRiding()) {
            this.movementInput.moveStrafe *= Celestial.instance.featureManager.getFeature(NoSlowDown.class).isEnabled() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;
            this.movementInput.moveForward *= Celestial.instance.featureManager.getFeature(NoSlowDown.class).isEnabled() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;
