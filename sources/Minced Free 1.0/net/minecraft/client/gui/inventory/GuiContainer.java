...
import ru.smertnix.celestial.feature.impl.player.ItemScroller;
...
public abstract class GuiContainer
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1) {
            ...
            if (Celestial.instance.featureManager.getFeature(ItemScroller.class).isEnabled() && Mouse.isButtonDown(0) && Keyboard.isKeyDown(this.mc.gameSettings.keyBindSneak.getKeyCode()) && this.mc.currentScreen != null && this.timerHelper.hasReached(80)) {
