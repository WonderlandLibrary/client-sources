...
public class GuiChat extends GuiScreen implements ITabCompleter
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, 3, (int) (this.height - 29), 120, 14, "2"));
    }
    ...
    {
        Celestial.instance.draggableHUD.getScreen().click(mouseX, mouseY);
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state) {
        Celestial.instance.draggableHUD.getScreen().release();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        Celestial.instance.draggableHUD.getScreen().draw(mouseX, mouseY);

        drawRect(2, this.height - 13.5f, this.width - 2, this.height - 2, Integer.MIN_VALUE);
        ...
        if (hide && (this.inputField.getText().contains("/warp") || this.inputField.getText().contains("/reg") || this.inputField.getText().contains("/l") || this.inputField.getText().contains("/cp") || this.inputField.getText().contains("/changepassword") || this.inputField.getText().contains("/tpa"))) {
        	 RenderUtils.drawBlur(15, () -> {
                 RenderUtils.drawRect(2, height - 14, mc.fontRendererObj.getStringWidth(this.inputField.getText()) + 6, height - 2, -1);
             });
        }
