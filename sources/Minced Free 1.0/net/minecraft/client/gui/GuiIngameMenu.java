...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(4, this.width / 2 - 100, this.height / 4 + 24 + -16 + 48, I18n.format("menu.returnToGame")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        Minecraft.getMinecraft().mntsb_18.drawCenteredString(I18n.format("menu.game"), this.width / 2, 40, 16777215);
