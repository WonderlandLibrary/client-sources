...
import ru.smertnix.celestial.feature.impl.player.NoInteract;
import ru.smertnix.celestial.feature.impl.visual.CustomFog;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.world != null) {
            ...
            for (int j = 0; j < list.size(); ++j) {
                ...
                if (entity1 instanceof EntityArmorStand && Celestial.instance.featureManager.getFeature(NoInteract.class).isEnabled() && NoInteract.sel.getSetting("Other").getBoolValue()) {
                    return;
                }
    ...
    public void orientCamera(float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPlayerSleeping()) {
            ...
            double d3 = (double) (this.thirdPersonDistancePrev - 0.5) * a;
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        EventRender eventRender = new EventRender(partialTicks);
    ...
    private void updateFogColor(float partialTicks)
    {
        World world = this.mc.world;
        Entity entity = this.mc.getRenderViewEntity();
        float f = Celestial.instance.featureManager.getFeature(CustomFog.class).isEnabled() ? CustomFog.distance.getNumberValue() * 10 : 0.25F + 0.75F * (float)this.mc.gameSettings.renderDistanceChunks / 32.0F;
    ...
    private void setupFog(int startCoords, float partialTicks)
    {
        ...
        else
        {
            ...
            {
                float dist = Celestial.instance.featureManager.getFeature(CustomFog.class).isEnabled() ? -CustomFog.distance.getNumberValue() : Config.getFogStart();
    ...
    public void func_190565_a(ItemStack p_190565_1_) {
        if (Celestial.instance.featureManager.getFeature(NoRender.class).isEnabled() && NoRender.sel.getSetting("Totem").getBoolValue()) {
            return;
        }
