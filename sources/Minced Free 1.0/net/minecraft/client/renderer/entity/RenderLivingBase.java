...
public abstract class RenderLivingBase<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, partialTicks, x, y, z))
        {
            ...
            if (entity instanceof EntityPlayerSP) {
                ...
                EventCustomModel m = new EventCustomModel((EntityPlayerSP) entity);
                EventManager.call(m);
            }
    ...
    protected void renderModel(T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        ...
        if (flag || flag1) {
            ...
            if (entitylivingbaseIn.getEntityId() == -10) {
                GL11.glPushMatrix();
                ...
                GL11.glBlendFunc(770, 771);
                    GlStateManager.color((float)ClientHelper.getClientColor().darker().getRed() / 255.0f, (float)ClientHelper.getClientColor().darker().getGreen() / 255.0f, (float)ClientHelper.getClientColor().darker().getBlue() / 255.0f, 0.15f);
                GL11.glDisable(2929);
            ...
            GL11.glDepthMask(true);
                GlStateManager.color((float)ClientHelper.getClientColor().getRed() / 255.0f, (float)ClientHelper.getClientColor().getGreen() / 255.0f, (float)ClientHelper.getClientColor().getBlue() / 255.0f, 0.15f);
            this.mainModel.render(entitylivingbaseIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scaleFactor);
            GL11.glEnable(3553);
        ...
        else
        {
            ...
            if (flag1)
            {
            	if (entitylivingbaseIn != Minecraft.getMinecraft().player) {
            		int color = new Color(255,0,0,(int) (255 / 10 * entitylivingbaseIn.hurtTime)).getRGB();
                    ...
                    if (Config.isShaders()) {
            		 ...
            		 i = new Color(255,0,0,(int) (155)).getRGB();
                     ...
                     this.brightnessBuffer.put(1 - f1);

                     if (Config.isShaders())
                     {
                         Shaders.setEntityColor(f2, f3, f4, 1 - f1);
                     }
            	}
            }
            else
            {
                ...
                this.brightnessBuffer.put(f3);
                this.brightnessBuffer.put(f4);
                this.brightnessBuffer.put(0);

                if (Config.isShaders())
                {
                    Shaders.setEntityColor(f2, f3, f4, 0);
                }
            }
