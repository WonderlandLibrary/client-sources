...
import ru.smertnix.celestial.feature.impl.visual.SwingAnimations;
...
public class ItemRenderer {
    ...
    private void transformEatFirstPerson(float p_187454_1_, EnumHandSide p_187454_2_, ItemStack p_187454_3_) {
        ...
        if (Celestial.instance.featureManager.getFeature(SwingAnimations.class).isEnabled()) {
    ...
    private void transformFirstPerson(EnumHandSide p_187453_1_, float p_187453_2_) {
        ...
        if (Celestial.instance.featureManager.getFeature(SwingAnimations.class).isEnabled() && SwingAnimations.item360.getBoolValue() && (!SwingAnimations.auraOnly.getBoolValue() || (SwingAnimations.auraOnly.getBoolValue() && Celestial.instance.featureManager.getFeature(SwingAnimations.class).isEnabled() && Celestial.instance.featureManager.getFeature(AttackAura.class).isEnabled() && AttackAura.target != null))) {
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_187457_4_)) {
            ...
            if (p_187457_6_.func_190926_b()) {
                ...
                if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0 && p_187457_1_.getActiveHand() == p_187457_4_) {
                    ...
                    if (Celestial.instance.featureManager.getFeature(SwingAnimations.class).isEnabled() && (!SwingAnimations.auraOnly.getBoolValue() || Celestial.instance.featureManager.getFeature(AttackAura.class).isEnabled() && AttackAura.target != null)) {
                        if (Celestial.instance.featureManager.getFeature(SwingAnimations.class).isEnabled() && !SwingAnimations.auraOnly.getBoolValue() || Celestial.instance.featureManager.getFeature(AttackAura.class).isEnabled() && AttackAura.target != null) {
                            if (enumhandside != (this.mc.gameSettings.mainHand.equals(EnumHandSide.LEFT) ? EnumHandSide.RIGHT : EnumHandSide.LEFT)) {
                                if (mode.equalsIgnoreCase("Smooth")) {
                                    ...
                                    GlStateManager.rotate(var4 * -SwingAnimations.swingStrength.getNumberValue(), 1.0f, 0.0f, 0.0f);
                                    ...
                                    GlStateManager.rotate(var3 * -20.0f, 0.0f, 1.0f, 0.0f);
                                    GlStateManager.rotate(var4 * -20.0f, 0.0f, 0.0f, 2.0f);
                                    GlStateManager.rotate(var4 * -25.0f, 1.0f, 0.0f, 0.0f);
                                } else if (mode.equalsIgnoreCase("Smooth Translate")) {
                                    this.transformFirstPersonItem(0, 0);
                                    translate4();
                                    ...
                                    GlStateManager.rotate(var3 * -20.0f, 0.0f, 1.0f, 0.0f);
                                    GlStateManager.rotate(var4 * -20.0f, 0.0f, 0.0f, 2.0f);
                                    GlStateManager.rotate(var4 * -SwingAnimations.swingStrength.getNumberValue() * 1, 1.0f, 0.0f, 0.0f);
                                     ...
                                     GlStateManager.rotate(sin1 * -SwingAnimations.swingStrength.getNumberValue()/2, 0.0f, 1.0f, 0.0f);
                                     GlStateManager.rotate(sin2 * -SwingAnimations.swingStrength.getNumberValue()/ 2, 0.0f, 0.0f, 1.0f);
                                     GlStateManager.rotate(sin2 * -SwingAnimations.swingStrength.getNumberValue(), 1.0f, 0.0f, 0.0f);
                                     GlStateManager.rotate(30.0f, 0.0f, 1.0f, 0.0f);
                                     GlStateManager.rotate(-80.0f, 1.0f, 0.0f, 0.0f);
                                     GlStateManager.rotate(60.0f, 0.0f, 1.0f, 0.0f);
                                } else if (mode.equalsIgnoreCase("Jump Translate")) {
    ...
    public void renderOverlays(float partialTicks) {
        ...
        if (!this.mc.player.isSpectator()) {
            ...
            if (!Celestial.instance.featureManager.getFeature(NoRender.class).isEnabled()) {
