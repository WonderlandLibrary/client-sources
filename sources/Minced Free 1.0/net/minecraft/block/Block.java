...
import ru.smertnix.celestial.feature.impl.player.AutoTool;
...
public class Block
{
    ...
    public boolean canCollideCheck(IBlockState state, boolean hitIfLiquid) {
        for (Block block : Objects.requireNonNull(NoInteract.getRightClickableBlocks())) {
            if (state.getBlock() != block || !Celestial.instance.featureManager.getFeature(NoInteract.class).isEnabled()) continue;
            return false;
        }
    ...
    public float getPlayerRelativeBlockHardness(IBlockState state, EntityPlayer player, World worldIn, BlockPos pos)
    {
        ...
        {
            AutoTool autoTool = ((AutoTool) Celestial.instance.featureManager.getFeature(AutoTool.class));
