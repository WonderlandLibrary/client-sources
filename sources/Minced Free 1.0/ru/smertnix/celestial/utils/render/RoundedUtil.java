...
public class RoundedUtil {
    ...
    public static ShaderUtil roundedOutlineShader = new ShaderUtil("celestial/shaders/roundrectoutline.frag");
    private static final ShaderUtil roundedTexturedShader = new ShaderUtil("celestial/shaders/roundrecttextured.frag");
