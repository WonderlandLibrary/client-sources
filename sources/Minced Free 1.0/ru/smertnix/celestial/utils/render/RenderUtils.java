...
import ru.smertnix.celestial.feature.impl.visual.Trails;
...
public class RenderUtils implements Helper {
    ...
    public static int colorAnim(float animation) {
    	int clor = 0;
        	clor = animation > 10 ? animation > 50 ? animation > 100 ? animation > 150 ? animation > 200 ? animation > 250 ? animation > 255 ? 255 : 250 : 200 : 150 : 100 : 50 : 10 : 0;
        return clor;
    }
    ...
    public static void drawGradientOutlinedRoundedRectWithGlow(double x, double y, double width, double height, float radius, float glowRadius, Color color, Color color2, Color outlineColor, Color outlineColor2, Color glowColor) {
        ...
        RenderUtils.drawBlurredShadow((float) (x2 - radius / 2 - 0.5F - 3.5), y2 + radius / 2 - 10, width2 + 15, height2 - radius / 2 + 17, (int) glowRadius, new Color(glowColor.getRGB()));

        drawRoundedRect1(x2 - radius / 2 - 0.5F - 2, y2 + radius / 2 - 10.5, width2 + 8.5, height2 - radius / 2 + 12.5, radius, new Color(outlineColor.getRGB()), new Color(outlineColor2.getRGB()));
    ...
    public static void drawGradientOutlinedRoundedRect(double x, double y, double width, double height, float radius, Color color, Color color2, Color outlineColor, Color outlineColor2) {
    ...
    public static void drawTestRoundedRect(float x, float y, float x2, float y2, float radius, int color) {
    ...
    public static void drawGradientOutlinedRoundedRectWithGlow2(float x, float y, float width, float height, float radius, float expand, int glowIntencivity, Color color, Color color2) {
        drawBlurredShadow(x,y,width + 2,height + 2, glowIntencivity,color2);

        drawRoundedRect1(x,y,width,height,radius,color,color2);

        float e = expand;

        drawRoundedRect1(x + e,y + e,width - e - e /1.5f,height - e - e /1.5f,radius - 1, color.darker(),color2.darker());
    	}
