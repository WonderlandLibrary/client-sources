    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            if (this.getEnableBackgroundDrawing()) {
                if (MainMenu.s) {
                	  RenderUtils.drawShadow(10,1, () -> {
                      	RoundedUtil.drawRound(this.xPos, this.yPos, this.width, this.height, 3, new Color(-1));
                        });
                        RenderUtils.drawBlur(10, () -> {
                      	  RoundedUtil.drawRound(this.xPos, this.yPos, this.width, this.height, 3, new Color(-1));
                        }); 
                } else {
                	 RoundedUtil.drawRound(this.xPos, this.yPos, this.width, this.height, 0, new Color(0,0,0,100));
                }
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
            	Minecraft.getMinecraft().mntsb_18.drawStringWithShadow(var4.substring(var2), (float) var9, (float) var8, var1);
            }
            ...
            if (var6) {
                if (var10) {
                	...
                	Minecraft.getMinecraft().mntsb_18.drawStringWithShadow("_", (float) var11, (float) var8, var1);
                }
            }
