...
public class NameField extends Gui
{
    ...
    public NameField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            {
                if (MainMenu.s) {
              	  RenderUtils.drawShadow(10,1, () -> {
                    	RoundedUtil.drawRound(this.xPosition, this.yPosition, this.width, this.height, 3, new Color(-1));
                      });
                      RenderUtils.drawBlur(10, () -> {
                    	  RoundedUtil.drawRound(this.xPosition, this.yPosition, this.width, this.height, 3, new Color(-1));
                      }); 
              } else {
              	 RoundedUtil.drawRound(this.xPosition, this.yPosition, this.width, this.height, 0, new Color(0,0,0,100));
              }
            }
            ...
            if (flag1)
            {
                ...
                {
                    Minecraft.getMinecraft().mntsb_18.drawStringWithShadow("_", (float)k1, (float)i1, i);
                }
            }
