...
public final class ConfigManager extends Manager<Config> {
    ...
    public static final File configDirectory = new File("C:\\Minced", "configs");
    ...
    private static ArrayList<Config> loadConfigs() {
        ...
        if (files != null) {
            for (File file : files) {
                if (FilenameUtils.getExtension(file.getName()).equals("celka"))
    ...
    public Config findConfig(String configName) {
        ...
        if (new File(configDirectory, configName + ".celka").exists())
