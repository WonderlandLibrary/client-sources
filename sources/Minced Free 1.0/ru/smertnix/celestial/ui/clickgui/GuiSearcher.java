    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtils.drawShadow(20, 1, () -> {
                	RenderUtils.drawGradientOutlinedRoundedRect(this.xPosition, this.yPosition - 1, this.width - 20, this.height - 5, 8, new Color(20, 20, 20), new Color(20, 20, 20), new Color(100, 100, 100), new Color(100, 100, 100));
                });
