...
public class ConnectedTextures {
    ...
    private static BakedQuad makeSpriteQuad(BakedQuad p_makeSpriteQuad_0_, TextureAtlasSprite p_makeSpriteQuad_1_) {
        int[] aint = (int[])((int[])p_makeSpriteQuad_0_.getVertexData().clone());
    ...
    private static boolean detectMultipass() {
        ...
        ConnectedProperties[] aconnectedproperties1 = (ConnectedProperties[])((ConnectedProperties[])((ConnectedProperties[])list.toArray(new ConnectedProperties[list.size()])));
    ...
    private static String[] getDefaultCtmPaths() {
        ...
        String[] astring1 = (String[])((String[])((String[])list.toArray(new String[list.size()])));
        return astring1;
    }
