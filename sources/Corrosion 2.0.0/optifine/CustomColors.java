...
public class CustomColors {
    ...
    public static void update() {
        ...
        if (Config.isCustomColors()) {
            ...
            lightMapsColorsRgb = (CustomColormap[])((CustomColormap[])pair.getLeft());
    ...
    private static Pair<CustomColormap[], Integer> parseLightmapsRgb() {
        ...
        for(int i = 0; i < astring.length; ++i) {
            ...
            k1 = Config.parseInt(s3, Integer.MIN_VALUE);
    ...
    private static CustomColormap[] readCustomColormaps(Properties p_readCustomColormaps_0_, String p_readCustomColormaps_1_) {
        ...
        Map map = new HashMap();
        Iterator var5 = p_readCustomColormaps_0_.keySet().iterator();

        String s6;
        while(var5.hasNext()) {
            Object s1 = var5.next();
            s6 = p_readCustomColormaps_0_.getProperty((String)s1);
            if (((String)s1).startsWith(s)) {
                map.put(s1, s6);
            }
        }

        String[] astring = (String[])((String[])((String[])map.keySet().toArray(new String[map.size()])));
        ...
        if (list.size() <= 0) {
            ...
            CustomColormap[] acustomcolormap = (CustomColormap[])((CustomColormap[])((CustomColormap[])list.toArray(new CustomColormap[list.size()])));
    ...
    private static CustomColormap[][] readBlockColormaps(String[] p_readBlockColormaps_0_, CustomColormap[] p_readBlockColormaps_1_, int p_readBlockColormaps_2_, int p_readBlockColormaps_3_) {
        ...
        if (p_readBlockColormaps_1_ != null) {
            for(j = 0; j < p_readBlockColormaps_1_.length; ++j) {
    ...
    private static CustomColormap[][] blockListToArray(List p_blockListToArray_0_) {
        ...
        for(int i = 0; i < p_blockListToArray_0_.size(); ++i) {
            ...
            if (list != null) {
                CustomColormap[] acustomcolormap1 = (CustomColormap[])((CustomColormap[])((CustomColormap[])list.toArray(new CustomColormap[list.size()])));
    ...
    private static int getSmoothColorMultiplier(IBlockAccess p_getSmoothColorMultiplier_0_, BlockPos p_getSmoothColorMultiplier_1_, CustomColors.IColorizer p_getSmoothColorMultiplier_2_, BlockPosM p_getSmoothColorMultiplier_3_) {
        ...
        for(k1 = l - 1; k1 <= l + 1; ++k1) {
            for(l1 = j1 - 1; l1 <= j1 + 1; ++l1) {
                ...
                i2 = p_getSmoothColorMultiplier_2_.getColor(p_getSmoothColorMultiplier_0_, blockposm);
                i += i2 >> 16 & 255;
                j += i2 >> 8 & 255;
                k += i2 & 255;
            }
    ...
    public static int getFluidColor(IBlockAccess p_getFluidColor_0_, IBlockState p_getFluidColor_1_, BlockPos p_getFluidColor_2_, RenderEnv p_getFluidColor_3_) {
        ...
        return customcolors$icolorizer == null ? block.colorMultiplier(p_getFluidColor_0_, p_getFluidColor_2_) : (Config.isSmoothBiomes() && !((CustomColors.IColorizer)customcolors$icolorizer).isColorConstant() ? getSmoothColorMultiplier(p_getFluidColor_0_, p_getFluidColor_2_, (CustomColors.IColorizer)customcolors$icolorizer, p_getFluidColor_3_.getColorizerBlockPosM()) : ((CustomColors.IColorizer)customcolors$icolorizer).getColor(p_getFluidColor_0_, p_getFluidColor_2_));
    }
                        ...
                        if (l < 16) {
                            ...
                            for(int j1 = 0; j1 < 16; ++j1) {
                                for(int k1 = 0; k1 < 16; ++k1) {
                                    ...
                                    l1 = (int)(afloat1[0] * 255.0F);
                                    int j2 = (int)(afloat1[1] * 255.0F);
                                    int k2 = (int)(afloat1[2] * 255.0F);
                                    p_updateLightmap_2_[j1 * 16 + k1] = -16777216 | l1 << 16 | j2 << 8 | k2;
                                }
                            }
    ...
    private static int[] readSpawnEggColors(Properties p_readSpawnEggColors_0_, String p_readSpawnEggColors_1_, String p_readSpawnEggColors_2_, String p_readSpawnEggColors_3_) {
        ...
        while(true) {
            while(true) {
                ...
                } while(!((String)s).startsWith(p_readSpawnEggColors_2_));
    ...
    private static float[][] readDyeColors(Properties p_readDyeColors_0_, String p_readDyeColors_1_, String p_readDyeColors_2_, String p_readDyeColors_3_) {
        ...
        int k = 0;
        Iterator var8 = p_readDyeColors_0_.keySet().iterator();
        ...
        while(true) {
            while(true) {
                ...
                do {
                    ...
                    s = var8.next();
                    s1 = p_readDyeColors_0_.getProperty((String)s);
                } while(!((String)s).startsWith(p_readDyeColors_2_));
    ...
    private static int[] readTextColors(Properties p_readTextColors_0_, String p_readTextColors_1_, String p_readTextColors_2_, String p_readTextColors_3_) {
        int[] aint = new int[32];
        Arrays.fill((int[])aint, -1);
        int i = 0;
        Iterator var6 = p_readTextColors_0_.keySet().iterator();
        ...
        while(true) {
            while(true) {
                ...
                do {
                    ...
                    s = var6.next();
                    s1 = p_readTextColors_0_.getProperty((String)s);
                } while(!((String)s).startsWith(p_readTextColors_2_));
    ...
    private static int[] readMapColors(Properties p_readMapColors_0_, String p_readMapColors_1_, String p_readMapColors_2_, String p_readMapColors_3_) {
        ...
        Arrays.fill((int[])aint, -1);
        int i = 0;
        Iterator var6 = p_readMapColors_0_.keySet().iterator();
        ...
        while(true) {
            while(true) {
                ...
                do {
                    ...
                    s = var6.next();
                    s1 = p_readMapColors_0_.getProperty((String)s);
                } while(!((String)s).startsWith(p_readMapColors_2_));
    ...
    private static int[] readPotionColors(Properties p_readPotionColors_0_, String p_readPotionColors_1_, String p_readPotionColors_2_, String p_readPotionColors_3_) {
        ...
        Arrays.fill((int[])aint, -1);
        int i = 0;
        Iterator var6 = p_readPotionColors_0_.keySet().iterator();
        ...
        while(true) {
            while(true) {
                ...
                do {
                    ...
                    s = var6.next();
                    s1 = p_readPotionColors_0_.getProperty((String)s);
                } while(!((String)s).startsWith(p_readPotionColors_2_));
