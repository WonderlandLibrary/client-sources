...
public class ConnectedParser {
    ...
    public MatchBlock[] parseMatchBlocks(String p_parseMatchBlocks_1_) {
        if (p_parseMatchBlocks_1_ == null) {
            ...
            MatchBlock[] amatchblock1 = (MatchBlock[])((MatchBlock[])((MatchBlock[])list.toArray(new MatchBlock[list.size()])));
            return amatchblock1;
        }
    }
            ...
            if (this.startsWithDigit(s)) {
                ...
                if (map.isEmpty()) {
                    ...
                    for(int k = 0; k < 16; ++k) {
                        ...
                        try {
                            IBlockState iblockstate1 = this.getStateFromMeta(p_parseBlockMetadatas_1_, i1);
    ...
    public static Comparable getPropertyValue(String p_getPropertyValue_0_, Collection p_getPropertyValue_1_) {
        Iterator var2 = p_getPropertyValue_1_.iterator();
        ...
        do {
            ...
            comparable = var2.next();
        } while(!String.valueOf(comparable).equals(p_getPropertyValue_0_));

        return (Comparable)comparable;
    }

    public static Comparable<?> parseValue(String p_parseValue_0_, Class<?> p_parseValue_1_) {
        return (Comparable)(p_parseValue_1_ == String.class ? p_parseValue_0_ : (p_parseValue_1_ == Boolean.class ? Boolean.valueOf(p_parseValue_0_) : (p_parseValue_1_ == Float.class ? Float.parseFloat(p_parseValue_0_) : (p_parseValue_1_ == Double.class ? Double.parseDouble(p_parseValue_0_) : (p_parseValue_1_ == Integer.class ? Integer.parseInt(p_parseValue_0_) : (p_parseValue_1_ == Long.class ? Long.parseLong(p_parseValue_0_) : (Comparable)null))))));
    }

    public boolean matchState(IBlockState p_matchState_1_, Map<IProperty, List<Comparable>> p_matchState_2_) {
        Iterator var3 = p_matchState_2_.keySet().iterator();
    ...
    public BiomeGenBase[] parseBiomes(String p_parseBiomes_1_) {
        if (p_parseBiomes_1_ == null) {
            ...
            BiomeGenBase[] abiomegenbase = (BiomeGenBase[])((BiomeGenBase[])((BiomeGenBase[])list.toArray(new BiomeGenBase[list.size()])));
