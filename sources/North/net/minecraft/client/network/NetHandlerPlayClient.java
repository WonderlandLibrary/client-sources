...
import xyz.northclient.features.events.TeleportEvent;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void onDisconnect(IChatComponent reason)
    {
        ...
        {
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new GuiMainMenuNew()), "disconnect.lost", reason));
        }
    }
