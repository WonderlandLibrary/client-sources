        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    NorthSingleton.INSTANCE.getAuth().joinServer(ip);
                    NorthSingleton.INSTANCE.getDiscordRP().update("Playing as " + NorthSingleton.INSTANCE.getAuth().username + " | " + NorthSingleton.INSTANCE.getAuth().uid,"Playing on " + ip);
