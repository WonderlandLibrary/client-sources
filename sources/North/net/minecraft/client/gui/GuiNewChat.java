...
public class GuiNewChat extends Gui
{
    ...
    public HashMap<Integer, Animation> animationHashMap = new HashMap<Integer, Animation>();
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                ...
                                int indentifier = (int) (((float)i2) * ((float)(j2 - 8)));
                                if(!animationHashMap.containsKey(indentifier)) {
                                    animationHashMap.put(indentifier, new Animation());
                                    animationHashMap.get(indentifier).setStart(-50);
                                }
                                Animation animation = animationHashMap.get(indentifier);
                                animation.update();
                                animation.animate(i2,0.2);

                                this.mc.fontRendererObj.drawStringWithShadow(s, (float) animation.getValue(), (float)(j2 - 8), 16777215 + (l1 << 24));
