...
public class Gui
{
    ...
    public static void pizda(double x, double y, double width, double height, int color) {
        ...
        worldrenderer.pos(x, y, 0.0D).color(c.getRed(),c.getGreen(),c.getBlue(),1).endVertex();
        worldrenderer.pos(x, y + height, 0.0D).color(c.getRed(),c.getGreen(),c.getBlue(),1).endVertex();
        worldrenderer.pos(x + width, y + height, 0.0D).color(c.getRed(),c.getGreen(),c.getBlue(),1).endVertex();
        worldrenderer.pos(x + width, y, 0.0D).color(c.getRed(),c.getGreen(),c.getBlue(),1).endVertex();
        tessellator.draw();
