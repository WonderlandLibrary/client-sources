...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        {
            if(NorthSingleton.INSTANCE.getModules().isEnabled("Scoreboard")) {
                DraggableManager.scoreboard.p_180475_1_ = scoreobjective1;
                DraggableManager.scoreboard.p_180475_2_ = scaledresolution;
                DraggableManager.scoreboard.useVanilla = false;
            } else {
                DraggableManager.scoreboard.useVanilla = true;
        ...
        NorthSingleton.INSTANCE.getUiHook().render(partialTicks);
    ...
    public Animation hogrider = new Animation();
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            hogrider.update();
            hogrider.animate(i - 91 - 1 + entityplayer.inventory.currentItem * 20,0.2);
            this.drawTexturedModalRect((int) hogrider.getValue(), sr.getScaledHeight() - 22 - 1, 0, 22, 24, 22);
            this.zLevel = f;
