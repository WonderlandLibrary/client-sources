...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            NorthSingleton.INSTANCE.getEventBus().post(new UpdateEvent());
            super.onUpdate();
            ...
            if (this.isRiding()) {
                ...
                NorthSingleton.INSTANCE.getEventBus().post(new PostMotionEvent());
            }
        }
    }
    ...
    public void onUpdateWalkingPlayer() {
        ...
        MotionEvent e = new MotionEvent(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch, this.lastReportedYaw, this.lastReportedPitch);
        NorthSingleton.INSTANCE.getEventBus().post(e);
        ...
        if (this.isCurrentViewEntity()) {
            double d0 = e.x - this.lastReportedPosX;
            double d1 = this.getEntityBoundingBox().minY - this.lastReportedPosY;
            double d2 = e.z - this.lastReportedPosZ;
            double d3 = (double) (e.yaw - this.lastReportedYaw);
            double d4 = (double) (e.pitch - this.lastReportedPitch);
            boolean flag2 = d0 * d0 + d1 * d1 + d2 * d2 > 9.0E-4D || this.positionUpdateTicks >= 20;
            boolean flag3 = d3 != 0.0D || d4 != 0.0D;

            if (this.ridingEntity == null) {
                if (flag2 && flag3) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(e.x, this.getEntityBoundingBox().minY, e.z, e.yaw, e.pitch, this.onGround));
                } else if (flag2) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(e.x, this.getEntityBoundingBox().minY, e.z, this.onGround));
                } else if (flag3) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C05PacketPlayerLook(e.yaw, e.pitch, this.onGround));
                } else {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer(this.onGround));
                }
            } else {
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0D, this.motionZ, e.yaw, e.pitch, this.onGround));
                flag2 = false;
            }
            ...
            if (flag2) {
                this.lastReportedPosX = e.x;
                this.lastReportedPosY = this.getEntityBoundingBox().minY;
                this.lastReportedPosZ = e.z;
    ...
    public void sendChatMessage(String message) {
        ...
        if (message.startsWith(".")) {
            NorthSingleton.INSTANCE.getCommandManager().onSendMessage(message);
        } else if (message.startsWith("#")) {
            NorthSingleton.INSTANCE.auth.sendIRCMessage(message.replace("#", ""));
        } else {
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            //dripware noslow
            /*if(Wrapper.getModuleManager().<NoSlowDown>getModule(NoSlowDown.class).isEnabled()) {
    ...
    public float getYaw() {
        return this.lastEvent != null ? this.lastEvent.getYaw() : this.rotationYaw;
    }

    public float getPreviousYaw() {
        return this.lastEvent != null ? this.lastEvent.previousYaw : this.prevRotationYaw;
    }

    public float getPitch() {
        return this.lastEvent != null ? this.lastEvent.getPitch() : this.rotationPitch;
    }

    public float getPreviousPitch() {
        return this.lastEvent != null ? this.lastEvent.previousPitch : this.prevRotationPitch;
    }
