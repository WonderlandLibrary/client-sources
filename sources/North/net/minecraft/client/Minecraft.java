...
import xyz.northclient.features.events.LegitPlaceEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.exhiFontRendererObj = new FontRenderer(this.gameSettings, new ResourceLocation("textures/font/asciiExhi.png"), this.renderEngine, false);
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new GuiMainMenuNew(), this, this.serverName, this.serverPort));
        }
        else
        {
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new GuiMainMenuNew();
        }
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            NorthSingleton.INSTANCE.getEventBus().post(new TickEvent());
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        NorthSingleton.INSTANCE.getEventBus().onKey(k);
            ...
            NorthSingleton.INSTANCE.getEventBus().post(new LegitPlaceEvent());
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        NorthSingleton.INSTANCE.getDiscordRP().update("Playing as " + NorthSingleton.INSTANCE.getAuth().username + " | " + NorthSingleton.INSTANCE.getAuth().uid,"Playing on single player");
