...
import xyz.northclient.features.events.AxisAlignedBBEvent;
...
public class Block
{
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity)
    {
        ...
        if(collidingEntity == Minecraft.getMinecraft().thePlayer) {
            AxisAlignedBBEvent nigga = new AxisAlignedBBEvent(this,pos,axisalignedbb);
            NorthSingleton.INSTANCE.getEventBus().post(nigga);
            axisalignedbb = nigga.getAxisAlignedBB();
        }
