...
import xyz.northclient.features.events.JumpEvent;
import xyz.northclient.features.events.StrafeEvent;
import xyz.northclient.util.animations.Animation;

public abstract class EntityLivingBase extends Entity {
    public Animation pies50 = new Animation();
        ...
        if (this.isServerWorld()) {
            if (!this.isInWater() || this instanceof EntityPlayer && ((EntityPlayer) this).capabilities.isFlying) {
                if (!this.isInLava() || this instanceof EntityPlayer && ((EntityPlayer) this).capabilities.isFlying) {
                    ...
                    if (this == Minecraft.getMinecraft().thePlayer) NorthSingleton.INSTANCE.getEventBus().post(event);
