...
public class CustomFont implements AbstractFontRenderer {
    ...
    @Override
    public void drawStringWithShadowGradient(String name, float x, float y, Color color, Color secondColor) {

    }

    @Override
    public void drawStringGradient(String name, float x, float y, Color firstColor, Color secondColor) {
    ...
    public float drawString(String text, double x, double y, int color, boolean shadow, float kerning, boolean smooth) {
        ...
        GlStateManager.color(r, g, b, (float) (color >> 24 & 255) / 255.0F);
        ...
        for (int index = 0; index < text.length(); index++) {
            ...
            if (character == '§') {
                ...
                if (colorIndex < 16) {
                    ...
                    float r = (float) (colorCode[colorIndex] >> 16 & 255) / 255.0F;
                    float g = (float) (colorCode[colorIndex] >> 8 & 255) / 255.0F;
                    float b = (float) (colorCode[colorIndex] & 255) / 255.0F;
