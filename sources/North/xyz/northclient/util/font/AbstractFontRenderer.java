...
public interface AbstractFontRenderer {
    ...
    void drawStringWithShadowGradient(String name, float x, float y, Color color, Color secondColor);
    void drawStringGradient(String name, float x, float y, Color color, Color secondColor);
