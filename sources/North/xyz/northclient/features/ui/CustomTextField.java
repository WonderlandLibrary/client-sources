    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            {
                ...
                RectUtil.drawRoundedRect(xPosition,yPosition,width,height,5,new Color(255,255,255,50));
            }
            ...
            if (s.length() > 0)
            {
                ...
                j1 = FontUtil.DefaultSmall.drawStringWithShadow(s1, (float)l, (float)i1, i);
            }

            FontUtil.DefaultSmall.drawString(s,l,i1+1,-1);


            animation.update();
            animation.animate((k*4)+l+1,0.1);
            if(isFocused) {
                Gui.drawRect((int) animation.getValue(),i1-1,(int) animation.getValue()+1,i1+10,-1);
            }
