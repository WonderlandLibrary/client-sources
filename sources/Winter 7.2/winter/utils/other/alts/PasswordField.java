  ...
  extends Gui
{
  ...
  public void drawTextBox()
  {
    if (func_73778_q())
    {
      ...
      if (var3 != var2)
      {
        ...
        drawCursorVertical(var11, var8 - 1, var12 - 1, var8 + 1 + this.fontRenderer.FONT_HEIGHT);
      }
    }
  }
  ...
  private void drawCursorVertical(int par1, int par2, int par3, int par4)
  {
    ...
    var7.addVertex(par1, par4, 0.0D);
    var7.addVertex(par3, par4, 0.0D);
    var7.addVertex(par3, par2, 0.0D);
    var7.addVertex(par1, par2, 0.0D);
    var7.draw();
    GL11.glDisable(3058);
    GL11.glEnable(3553);
  }
