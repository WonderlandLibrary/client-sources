...
extends Module {
    ...
    public Zoom() {
        super("Zoom", Module.Category.Movement, -16731798);
    }

    @Override
    public void onDisable() {
        this.mc.timer.timerSpeed = 1.0f;
        moveSpeed = Zoom.getBaseMoveSpeed();
        lastDist = 0.0;
        stage = 4;
    ...
    public void onMove(MoveEvent event) {
        ...
        moveSpeed = Math.max(moveSpeed, Zoom.getBaseMoveSpeed());
        Zoom.setMoveSpeed(event, moveSpeed);
        ++stage;
    }
