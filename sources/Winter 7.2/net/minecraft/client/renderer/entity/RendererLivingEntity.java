        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_)}))
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if ((Client.getManager().getMod("ESP").isEnabled()) && ((p_76986_1_ instanceof EntityPlayer)) && (p_76986_1_ != Minecraft.getMinecraft().thePlayer))
                    {
                      ...
                      winter.utils.Render.renderOne();
                      renderModel(p_76986_1_, var17, var16, var14, var12, var201, 0.0625F);
                      winter.utils.Render.renderTwo();
                      renderModel(p_76986_1_, var17, var16, var14, var12, var201, 0.0625F);
                      winter.utils.Render.renderThree();
                      winter.utils.Render.renderFour(Minecraft.getMinecraft(), p_76986_1_);
                      renderModel(p_76986_1_, var17, var16, var14, var12, var201, 0.0625F);
                      winter.utils.Render.renderFive();
                    }
                    else
                    {
                      renderModel(p_76986_1_, var17, var16, var14, var12, var201, 0.0625F);
