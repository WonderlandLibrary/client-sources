...
public class GuiTextField extends Gui
{
    ...
    private int outline = -6250336;
    private int inside = -16777216;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
              drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, this.outline);
              drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, this.inside);
            }
