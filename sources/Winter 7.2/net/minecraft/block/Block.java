...
public class Block
{
    ...
    {
      if (Client.isEnabled("Fullbright")) {
        return 15;
      }
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
    {
        if (Client.isEnabled("XRay")) {
            return XRay.shouldRender(this, pos);
        }
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List list, Entity collidingEntity)
    {
      ...
      BBEvent event = (BBEvent)EventSystem.call(new BBEvent(collidingEntity, this, pos, var7));
      var7 = event.getBounds();
      if ((!event.isCancelled()) && (var7 != null) && (mask.intersectsWith(var7))) {
        list.add(var7);
      }
    }
