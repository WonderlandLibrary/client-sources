...
import xyz.cucumber.base.events.ext.EventEntityRenderer;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    {
        EventEntityRenderer eventRenderEntity = new EventEntityRenderer(entity);
        Client.INSTANCE.getEventBus().call(eventRenderEntity);
        ...
        eventRenderEntity.setType(EventType.POST);
        Client.INSTANCE.getEventBus().call(eventRenderEntity);
    }
