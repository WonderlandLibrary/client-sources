...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    {
    	/*for(String[] user : Client.INSTANCE.getDatabase().names) {
			if(networkPlayerInfoIn.getGameProfile().getName().equals(user[2])) {
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        for (int k4 = 0; k4 < l3; ++k4)
        {
            ...
            if (k4 < list.size())
            {
                ...
                if(mod.isEnabled())
                	s1 = s1.replace(mc.thePlayer.getName(), mod.getFormatedName());
