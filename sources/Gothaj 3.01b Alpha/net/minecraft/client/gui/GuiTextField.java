...
public class GuiTextField extends Gui
{
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, 0x70000000);
              	drawRect(this.xPosition, this.yPosition + this.height, this.xPosition + this.width, this.yPosition + this.height+1, 0xffffffff);
            }
