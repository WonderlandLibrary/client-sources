                    ...
                    if (i > 0) {
                        if(!eventAttackSlowdown.isCancelled()) {
                        	for(int power = 0; power < eventAttackSlowdown.getPower(); power++) {
                        		targetEntity.addVelocity(-MathHelper.sin(this.rotationYaw * 3.1415927f / 180.0f) * i * 0.5f, eventAttackSlowdown.isReduceY() ? 0 : 0.1, MathHelper.cos(this.rotationYaw * 3.1415927f / 180.0f) * i * 0.5f);
                        	}
