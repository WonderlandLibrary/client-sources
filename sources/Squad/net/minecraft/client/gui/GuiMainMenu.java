...
import Squad.Accounts.GuiAltManager;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private static final ResourceLocation[] titlePanoramaPaths = new ResourceLocation[] {new ResourceLocation("squad/giphy.gif"), new ResourceLocation("squad/giphy.gif"), new ResourceLocation("squad/giphy.gif"), new ResourceLocation("squad/giphy.gif"), new ResourceLocation("squad/giphy.gif"), new ResourceLocation("squad/giphy.gif")};
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        this.buttonList.add(this.realmsButton = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("AltLogin", new Object[0])));
    }
    ...
    public static void renderSkyBox2() {

     /*   String skybox = null; 

    try {

        // URL Where the Text file containing T/F.

        URL url = new URL("http://flaw.bplaced.net/skybox.html");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        String var11 = "§4Coder:§b Zenz & NameHacks";
