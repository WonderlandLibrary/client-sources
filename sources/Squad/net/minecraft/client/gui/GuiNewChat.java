                    ...
                    if (var10 != null)
                    {
                        ...
                        if (var11 < 200 || var3)
                        {
                            ...
                            if (var14 > 3)
                            {
                                ...
                                String var17 = var10.getChatComponent().getUnformattedText();
                                GlStateManager.enableBlend();
                          ttfman.getInstance().getChatFont().drawString(var17, (float)var15, (float)(var16 - 10), 16777215 + (var14 << 24));
