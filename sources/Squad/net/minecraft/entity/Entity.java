...
public abstract class Entity implements ICommandSender
{
    ...
    {
    	if(Squad.moduleManager.getModule(NoPitchLimit.class).toggled){
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            if(Squad.instance.moduleManager.getModuleByName("ScaffoldWalk").toggled) {
            	var19 = true;
            }
    ...
    public void setVelocity(double x, double y, double z)
    {
        ...
        for(Module m : Squad.moduleManager.getModules())
        {
         if(m.isEnabled() && this instanceof EntityPlayerSP && x != 0 && z != 0 && y != 0)
         {
          m.onVelocity();
         }
        }
