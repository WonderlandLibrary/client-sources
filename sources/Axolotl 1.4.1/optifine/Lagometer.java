    ...
    public static void showLagometer(ScaledResolution scaledResolution)
    {
        if (gameSettings != null)
        {
            if (gameSettings.ofLagometer)
            {
                ...
                mc.customFont.drawString("30", 2, y30 + 1, -8947849);
                mc.customFont.drawString("30", 1, y30, -3881788);
                mc.customFont.drawString("60", 2, y60 + 1, -8947849);
                mc.customFont.drawString("60", 1, y60, -3881788);
                GlStateManager.matrixMode(5889);
                ...
                mc.customFont.drawString(" " + memMbSec + " MB/s", posX, posY, colMem);
