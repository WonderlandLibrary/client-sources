...
public class GuiMessage extends GuiScreen
{
    ...
    private CFontRenderer fontRendererObj;
    ...
    public void initGui()
    {
        this.fontRendererObj = mc.customFont;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredStringCF(this.fontRendererObj, this.messageLine1, this.width / 2, 70, 16777215);
        int var4 = 90;

        for (Iterator var5 = this.listLines2.iterator(); var5.hasNext(); var4 += this.fontRendererObj.getHeight())
        {
            String var6 = (String)var5.next();
            this.drawCenteredStringCF(this.fontRendererObj, var6, this.width / 2, var4, 16777215);
        }
