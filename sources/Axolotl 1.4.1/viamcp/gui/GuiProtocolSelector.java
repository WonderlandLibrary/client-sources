...
public class GuiProtocolSelector extends GuiScreen
{
    ...
    public void drawScreen(int p_drawScreen_1_, int p_drawScreen_2_, float p_drawScreen_3_)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, EnumChatFormatting.BOLD + "Version List", this.width / 4, 5, 16777215);
    ...
    class SlotList extends GuiSlot
    {
        ...
        protected void elementClicked(int i, boolean b, int i1, int i2)
        {
            ...
            Display.setTitle(Axolotl.INSTANCE.clientOn ? Axolotl.INSTANCE.full_name + " - " + mc.session.getUsername() + " - " + ProtocolCollection.getProtocolById(ViaMCP.getInstance().getVersion()).getName() + " - " + Axolotl.INSTANCE.userInfo.client_uid: "Minecraft 1.8");
        }
