    ...
    protected void mouseDragged(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
            if (this.dragging)
            {
                ...
                Display.setTitle(Axolotl.INSTANCE.full_name + " - " + Minecraft.getMinecraft().session.getUsername() + " - " + ProtocolCollection.getProtocolById(ViaMCP.getInstance().getVersion()).getName());
            }
