...
public class ItemBoat extends Item
{
    ...
    public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn)
    {
        ...
        else
        {
            ...
            boolean var26 = false;
            float var27 = 1.0F;
            List var28 = worldIn.getEntitiesWithinAABBExcludingEntity(playerIn, playerIn.getEntityBoundingBox().addCoord(var25.x * var21, var25.y * var21, var25.z * var21).expand((double)var27, (double)var27, (double)var27));
