...
import axolotl.cheats.modules.impl.player.Jesus;
...
public abstract class BlockLiquid extends Block
{
    ...
    {
        Module jesus = Axolotl.INSTANCE.moduleManager.getModule("Jesus");
        if(Minecraft.getMinecraft() != null && Minecraft.getMinecraft().thePlayer != null && !Minecraft.getMinecraft().thePlayer.isInWater && jesus.toggled && !((Jesus)jesus).mode.getMode().equalsIgnoreCase("NCP")) {
    ...
    public static double func_180689_a(IBlockAccess p_180689_0_, BlockPos p_180689_1_, Material p_180689_2_)
    {
        ...
        return var3.x == 0.0D && var3.z == 0.0D ? -1000.0D : Math.atan2(var3.z, var3.x) - (Math.PI / 2D);
    }
