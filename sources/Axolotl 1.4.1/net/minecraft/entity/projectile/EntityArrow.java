...
public class EntityArrow extends Entity implements IProjectile
{
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (var6 != null)
            {
                var5 = new Vec3(var6.hitVec.x, var6.hitVec.y, var6.hitVec.z);
            }
            ...
            if (var6 != null)
            {
                ...
                else
                {
                    ...
                    this.motionX = (double)((float)(var6.hitVec.x - this.posX));
                    this.motionY = (double)((float)(var6.hitVec.y - this.posY));
                    this.motionZ = (double)((float)(var6.hitVec.z - this.posZ));
