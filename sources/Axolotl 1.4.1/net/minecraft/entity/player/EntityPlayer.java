    ...
    protected void updateItemUse(ItemStack itemStackIn, int p_71010_2_)
    {
        ...
        if (itemStackIn.getItemUseAction() == EnumAction.EAT)
        {
            for (int var3 = 0; var3 < p_71010_2_; ++var3)
            {
                ...
                {
                    this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, var7.x, var7.y, var7.z, var4.x, var4.y + 0.05D, var4.z, new int[] {Item.getIdFromItem(itemStackIn.getItem()), itemStackIn.getMetadata()});
                }
                else
                {
                    this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, var7.x, var7.y, var7.z, var4.x, var4.y + 0.05D, var4.z, new int[] {Item.getIdFromItem(itemStackIn.getItem())});
                }
            }
