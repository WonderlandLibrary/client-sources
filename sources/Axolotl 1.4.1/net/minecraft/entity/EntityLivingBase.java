...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void renderBrokenItemStack(ItemStack p_70669_1_)
    {
        ...
        for (int var2 = 0; var2 < 5; ++var2)
        {
            ...
            this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, var6.x, var6.y, var6.z, var3.x, var3.y + 0.05D, var3.z, new int[] {Item.getIdFromItem(p_70669_1_.getItem())});
        }
    }
    ...
    {
        try {
            return (int) this.dataWatcher.getWatchableObjectStuff(9);
        } catch(Exception e) {
            return 0; // Minecraft code is so shit (or java) so it's impossible for my skill to fix it, so this will do.
        }
    }
    ...
    public void moveEntityWithHeading(float p_70612_1_, float p_70612_2_)
    {
        ...
        boolean groundState = this.onGround;
     ...
     * Moves the entity based on the specified heading.  Args: strafe, forward
     */
    public void moveEntityWithHeading(float p_70612_1_, float p_70612_2_, boolean groundState)
    {
        double var8;
        float var10;
