        ...
        public void updateTask()
        {
            ...
            if (var1.getDistanceSqToEntity(this.field_179470_b) < var2 * var2 && this.field_179470_b.canEntityBeSeen(var1))
            {
                ...
                if (this.field_179471_a == 20)
                {
                    ...
                    double var8 = var1.posX - (this.field_179470_b.posX + var7.x * var5);
                    ...
                    double var12 = var1.posZ - (this.field_179470_b.posZ + var7.z * var5);
                    ...
                    var14.posX = this.field_179470_b.posX + var7.x * var5;
                    var14.posY = this.field_179470_b.posY + (double)(this.field_179470_b.height / 2.0F) + 0.5D;
                    var14.posZ = this.field_179470_b.posZ + var7.z * var5;
