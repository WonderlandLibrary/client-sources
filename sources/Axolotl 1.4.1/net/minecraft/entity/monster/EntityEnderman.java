...
public class EntityEnderman extends EntityMob
{
    ...
    protected boolean teleportToEntity(Entity p_70816_1_)
    {
        ...
        var2 = var2.normalize();
        double var3 = 16.0D;
        double var5 = this.posX + (this.rand.nextDouble() - 0.5D) * 8.0D - var2.x * var3;
        double var7 = this.posY + (double)(this.rand.nextInt(16) - 8) - var2.y * var3;
        double var9 = this.posZ + (this.rand.nextDouble() - 0.5D) * 8.0D - var2.z * var3;
