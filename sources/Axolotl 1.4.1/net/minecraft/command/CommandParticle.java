    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                double var32 = (double)((float)func_175761_b(var31.x, args[1], true));
                double var9 = (double)((float)func_175761_b(var31.y, args[2], true));
                double var11 = (double)((float)func_175761_b(var31.z, args[3], true));
