...
import axolotl.cheats.modules.impl.world.AntiCrash;
...
public abstract class World implements IBlockAccess
{
    ...
    public MovingObjectPosition rayTraceBlocks(Vec3 p_147447_1_, Vec3 p_147447_2_, boolean p_147447_3_, boolean p_147447_4_, boolean p_147447_5_)
    {
        if (!Double.isNaN(p_147447_1_.x) && !Double.isNaN(p_147447_1_.y) && !Double.isNaN(p_147447_1_.z))
        {
            ...
            {
                int var6 = MathHelper.floor_double(p_147447_2_.x);
                int var7 = MathHelper.floor_double(p_147447_2_.y);
                int var8 = MathHelper.floor_double(p_147447_2_.z);
                int var9 = MathHelper.floor_double(p_147447_1_.x);
                int var10 = MathHelper.floor_double(p_147447_1_.y);
                int var11 = MathHelper.floor_double(p_147447_1_.z);
                ...
                while (var42-- >= 0)
                {
                    ...
                    double var27 = 999.0D;
                    double var29 = 999.0D;
                    double var31 = p_147447_2_.x - p_147447_1_.x;
                    double var33 = p_147447_2_.y - p_147447_1_.y;
                    double var35 = p_147447_2_.z - p_147447_1_.z;

                    if (var43)
                    {
                        var25 = (var19 - p_147447_1_.x) / var31;
                    }

                    if (var17)
                    {
                        var27 = (var21 - p_147447_1_.y) / var33;
                    }

                    if (var18)
                    {
                        var29 = (var23 - p_147447_1_.z) / var35;
                    }
                    ...
                    if (var25 < var27 && var25 < var29)
                    {
                        ...
                        p_147447_1_ = new Vec3(var19, p_147447_1_.y + var33 * var25, p_147447_1_.z + var35 * var25);
                    }
                    else if (var27 < var29)
                    {
                        var37 = var7 > var10 ? EnumFacing.DOWN : EnumFacing.UP;
                        p_147447_1_ = new Vec3(p_147447_1_.x + var31 * var27, var21, p_147447_1_.z + var35 * var27);
                    }
                    else
                    {
                        var37 = var8 > var11 ? EnumFacing.NORTH : EnumFacing.SOUTH;
                        p_147447_1_ = new Vec3(p_147447_1_.x + var31 * var29, p_147447_1_.y + var33 * var29, var23);
                    }

                    var9 = MathHelper.floor_double(p_147447_1_.x) - (var37 == EnumFacing.EAST ? 1 : 0);
                    var10 = MathHelper.floor_double(p_147447_1_.y) - (var37 == EnumFacing.UP ? 1 : 0);
                    var11 = MathHelper.floor_double(p_147447_1_.z) - (var37 == EnumFacing.SOUTH ? 1 : 0);
    ...
    private axolotl.util.Timer timer = new axolotl.util.Timer();
    private AntiCrash ac;
    private int maxParticles;

    private void spawnParticle(int a1, boolean a2, double a3, double a5, double a7, double a9, double a11, double a13, int ... a15)
    {
        try {
            if (ac == null) {
                ac = (AntiCrash) Axolotl.INSTANCE.moduleManager.getModule("AntiCrash");
                maxParticles = (int) ac.secMax.getNumberValue();
            }
            if (ac.toggled) {
                particles++;
                if (timer.hasTimeElapsed(1000, true)) particles = 0;
        ...
        {
            ((IWorldAccess)this.worldAccesses.get(var16)).func_180442_a(a1, a2, a3, a5, a7, a9, a11, a13, a15);
        }
    }
    ...
    public boolean handleMaterialAcceleration(AxisAlignedBB p_72918_1_, Material p_72918_2_, Entity p_72918_3_)
    {
        ...
        else
        {
            ...
            if (var11.lengthVector() > 0.0D && p_72918_3_.isPushedByWater())
            {
                ...
                double var20 = 0.014D;
                p_72918_3_.motionX += var11.x * var20;
                p_72918_3_.motionY += var11.y * var20;
                p_72918_3_.motionZ += var11.z * var20;
            }
