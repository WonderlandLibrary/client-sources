...
public class PathNavigateGround extends PathNavigate
{
    ...
    {
        int var6 = MathHelper.floor_double(p_75493_1_.x);
        int var7 = MathHelper.floor_double(p_75493_1_.z);
        double var8 = p_75493_2_.x - p_75493_1_.x;
        double var10 = p_75493_2_.z - p_75493_1_.z;
        ...
        else
        {
            ...
            if (!this.func_179683_a(var6, (int)p_75493_1_.y, var7, p_75493_3_, p_75493_4_, p_75493_5_, p_75493_1_, var8, var10))
            {
                return false;
            }
            else
            {
                ...
                double var20 = (double)(var6 * 1) - p_75493_1_.x;
                double var22 = (double)(var7 * 1) - p_75493_1_.z;
                ...
                int var26 = MathHelper.floor_double(p_75493_2_.x);
                int var27 = MathHelper.floor_double(p_75493_2_.z);
                ...
                while (this.func_179683_a(var6, (int)p_75493_1_.y, var7, p_75493_3_, p_75493_4_, p_75493_5_, p_75493_1_, var8, var10));
    ...
    private boolean func_179683_a(int p_179683_1_, int p_179683_2_, int p_179683_3_, int p_179683_4_, int p_179683_5_, int p_179683_6_, Vec3 p_179683_7_, double p_179683_8_, double p_179683_10_)
    {
        ...
        else
        {
            for (int var14 = var12; var14 < var12 + p_179683_4_; ++var14)
            {
                ...
                {
                    double var16 = (double)var14 + 0.5D - p_179683_7_.x;
                    double var18 = (double)var15 + 0.5D - p_179683_7_.z;
    ...
    private boolean func_179692_b(int p_179692_1_, int p_179692_2_, int p_179692_3_, int p_179692_4_, int p_179692_5_, int p_179692_6_, Vec3 p_179692_7_, double p_179692_8_, double p_179692_10_)
    {
        ...
        while (var12.hasNext())
        {
            ...
            double var14 = (double)var13.getX() + 0.5D - p_179692_7_.x;
            double var16 = (double)var13.getZ() + 0.5D - p_179692_7_.z;
