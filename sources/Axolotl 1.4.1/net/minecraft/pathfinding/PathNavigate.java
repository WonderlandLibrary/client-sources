...
public abstract class PathNavigate
{
    ...
    public void onUpdateNavigation()
    {
        ...
        if (!this.noPath())
        {
            ...
            else if (this.currentPath != null && this.currentPath.getCurrentPathIndex() < this.currentPath.getCurrentPathLength())
            {
                ...
                if (var1.y > var2.y && !this.theEntity.onGround && MathHelper.floor_double(var1.x) == MathHelper.floor_double(var2.x) && MathHelper.floor_double(var1.z) == MathHelper.floor_double(var2.z))
                {
            ...
            if (!this.noPath())
            {
                ...
                if (var1 != null)
                {
                    this.theEntity.getMoveHelper().setMoveTo(var1.x, var1.y, var1.z, this.speed);
                }
            }
        }
    }
    ...
    protected void pathFollow()
    {
        ...
        {
            if (this.currentPath.getPathPointFromIndex(var3).yCoord != (int)var1.y)
            {
                var2 = var3;
                break;
            }
