    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (var4.length() > 0)
            {
                ...
                var9 = (int) Minecraft.getMinecraft().customFont.drawStringWithShadow(var10, (float)var7, (float)var8 - 1, var1) + 2;
            }
            ...
            {
                var9 = (int) Minecraft.getMinecraft().customFont.drawStringWithShadow(var4.substring(var2), (float)var9, (float)var8, var1);
            }
            ...
            if (var6)
            {
                ...
                {
                	Minecraft.getMinecraft().customFont.drawStringWithShadow("_", (float)var11, (float)var8 - 1, var1);
                }
            }
