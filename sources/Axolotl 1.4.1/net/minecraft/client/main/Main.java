...
public class Main
{
	...
	public static void main(String[] p_main_0_)
    {
        ...
        OptionSpec<String> intentApiKey = var1.accepts("intentApiKey").withOptionalArg().ofType(String.class).defaultsTo("", new String[0]);
        if(var21.valueOf(intentApiKey) != null && !var21.valueOf(intentApiKey).isEmpty())
            api_key = var21.valueOf(intentApiKey);
