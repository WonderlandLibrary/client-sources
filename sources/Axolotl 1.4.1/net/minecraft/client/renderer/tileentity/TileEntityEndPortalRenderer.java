...
public class TileEntityEndPortalRenderer extends TileEntitySpecialRenderer
{
    ...
    public void func_180544_a(TileEntityEndPortal p_180544_1_, double p_180544_2_, double p_180544_4_, double p_180544_6_, float p_180544_8_, int p_180544_9_)
    {
        ...
        for (int var14 = 0; var14 < 16; ++var14)
        {
            ...
            float var19 = var18 + (float)ActiveRenderInfo.func_178804_a().y;
            float var20 = var18 + var15 + (float)ActiveRenderInfo.func_178804_a().y;
            ...
            var19 = var18 + (float)ActiveRenderInfo.func_178804_a().y;
            GlStateManager.translate((float)ActiveRenderInfo.func_178804_a().x * var15 / var19, (float)ActiveRenderInfo.func_178804_a().z * var15 / var19, -var11);
