...
public class RenderMinecart extends Render
{
    ...
    public void doRender(EntityMinecart p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        if (var23 != null)
        {
            ...
            p_76986_2_ += var23.x - var15;
            p_76986_4_ += (var25.y + var26.y) / 2.0D - var17;
            p_76986_6_ += var23.z - var19;
            Vec3 var27 = var26.addVector(-var25.x, -var25.y, -var25.z);

            if (var27.lengthVector() != 0.0D)
            {
                var27 = var27.normalize();
                p_76986_8_ = (float)(Math.atan2(var27.z, var27.x) * 180.0D / Math.PI);
