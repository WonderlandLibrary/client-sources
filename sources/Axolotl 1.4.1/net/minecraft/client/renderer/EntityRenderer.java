...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float p_78473_1_, boolean reach) {
        ...
        if (var2 != null && this.mc.theWorld != null)
        {
            ...
            this.mc.objectMouseOver = var2.func_174822_a(var3 + (reach ? 99999999 : 0), p_78473_1_);
            double var5 = var3;
            ...
            Vec3 var9 = var7.addVector(var8.x * var3, var8.y * var3, var8.z * var3);
            this.pointedEntity = null;
            Vec3 var10 = null;
            float var11 = 1.0F;
            List var12 = this.mc.theWorld.getEntitiesWithinAABBExcludingEntity(var2, var2.getEntityBoundingBox().addCoord(var8.x * var3, var8.y * var3, var8.z * var3).expand((double)var11, (double)var11, (double)var11));
            double var13 = var5;
    ...
    private void func_175068_a(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        RenderEvent event = new RenderEvent(EventType.PRE);
        ...
        RenderEvent event1 = new RenderEvent(EventType.POST);
    ...
    private void updateFogColor(float partialTicks)
    {
        ...
        this.field_175080_Q = (float)var9.x;
        this.field_175082_R = (float)var9.y;
        this.field_175081_S = (float)var9.z;
        float var13;
        ...
        if (this.cloudFog)
        {
            ...
            this.field_175080_Q = (float)fogYFactor.x;
            this.field_175082_R = (float)fogYFactor.y;
            this.field_175081_S = (float)fogYFactor.z;
        }
