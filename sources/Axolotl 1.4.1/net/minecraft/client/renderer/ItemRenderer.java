...
import axolotl.cheats.modules.impl.render.Animations;
...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float p_78440_1_)
    {
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (var3.getItemInUseCount() > 0 || aura != null && Aura.target != null && aura.toggled && aura.autoblock.isEnabled() && mc.thePlayer.getHeldItem() != null && mc.thePlayer.getHeldItem().getItem() instanceof ItemSword)
            {
                EnumAction var7 = this.itemToRender.getItemUseAction();

                if(Axolotl.INSTANCE.moduleManager.getModule("Animations").toggled) {
                    switch (ItemRenderer.SwitchEnumAction.field_178094_a[var7.ordinal()])
                    {
                        ...
                        case 4:
                            if(Animations.mode.getMode().equalsIgnoreCase("Down")) {
