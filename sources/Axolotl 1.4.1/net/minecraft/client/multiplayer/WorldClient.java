...
public class WorldClient extends World
{
    ...
    private final Set<Object> entityList = Sets.newHashSet();
     ...
     */
    private final Set<Object> entitySpawnQueue = Sets.newHashSet();
    private final Minecraft mc = Minecraft.getMinecraft();
    private final Set<Object> previousActiveChunkSet = Sets.newHashSet();
    ...
    protected void func_147456_g()
    {
        ...
        for (Object o : this.activeChunkSet) {
            ChunkCoordIntPair var3 = (ChunkCoordIntPair) o;
    ...
    public void doVoidFogParticles(int p_73029_1_, int p_73029_2_, int p_73029_3_)
    {
        ...
        for (int var8 = 0; var8 < 1000; ++var8)
        {
            ...
            {
                this.spawnParticle(EnumParticleTypes.BARRIER, (float)var9 + 0.5F, (float)var10 + 0.5F, (float)var11 + 0.5F, 0.0D, 0.0D, 0.0D);
            }
        }
    }
    ...
    public void removeAllEntities()
    {
        ...
        this.unloadedEntityList.removeAll(this.loadedEntityList);
        int var1;
        Entity var2;
        int var3;
        int var4;
    ...
    public CrashReportCategory addWorldInfoToCrashReport(CrashReport report)
    {
        ...
        var2.addCrashSectionCallable("Forced entities", () -> WorldClient.this.entityList.size() + " total; " + WorldClient.this.entityList);
        var2.addCrashSectionCallable("Retry entities", () -> WorldClient.this.entitySpawnQueue.size() + " total; " + WorldClient.this.entitySpawnQueue);
        var2.addCrashSectionCallable("Server brand", () -> WorldClient.this.mc.thePlayer.getClientBrand());
