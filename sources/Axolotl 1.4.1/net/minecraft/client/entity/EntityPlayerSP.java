...
import axolotl.cheats.modules.impl.player.NoSlow;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            {
                this.func_175161_p();
                MoveEvent event1 = new MoveEvent(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround, EventType.POST);
                Axolotl.INSTANCE.moduleManager.onEvent(event1);
            }
        }
    }
    ...
    public void func_175161_p()
    {
    	...
    	MoveEvent event = new MoveEvent(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround, EventType.PRE);
    ...
    public void sendChatMessage(String message)
    {
        ...
        boolean cancel = Axolotl.INSTANCE.cmdManager.onChat(message);
    ...
    public void onLivingUpdate()
    {
    	...
    	EventUpdate event = new EventUpdate(EventType.PRE);
    	Axolotl.INSTANCE.moduleManager.onEvent(event);
    	if(event.getCancelled())return;

        isInWater = mc.theWorld.getBlockState(new BlockPos(mc.thePlayer.posX, mc.thePlayer.posY, mc.thePlayer.posZ)).getBlock().getMaterial() == Material.water;
        ...
        {
            NoSlow noslow = (NoSlow)Axolotl.INSTANCE.moduleManager.getModule("NoSlow");
            if(!noslow.toggled) {
                if(!(noslow.mode.getMode().equalsIgnoreCase("Watchdog") && this.getHeldItem().getItem() instanceof ItemSword)) {
        ...
        EventUpdate event1 = new EventUpdate(EventType.POST);
        Axolotl.INSTANCE.moduleManager.onEvent(event1);
    }

	public void setSpeed(float speed) {
        double playerYaw = Math.toRadians(rotationYaw);
