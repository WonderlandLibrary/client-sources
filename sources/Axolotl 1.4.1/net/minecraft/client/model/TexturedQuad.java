...
public class TexturedQuad
{
    ...
    public void func_178765_a(WorldRenderer renderer, float scale)
    {
        ...
        {
            renderer.func_178980_d(-((float)var5.x), -((float)var5.y), -((float)var5.z));
        }
        else
        {
            renderer.func_178980_d((float)var5.x, (float)var5.y, (float)var5.z);
        ...
        for (int var6 = 0; var6 < 4; ++var6)
        {
            ...
            renderer.addVertexWithUV(var7.vector3D.x * (double)scale, var7.vector3D.y * (double)scale, var7.vector3D.z * (double)scale, (double)var7.texturePositionX, (double)var7.texturePositionY);
        }
