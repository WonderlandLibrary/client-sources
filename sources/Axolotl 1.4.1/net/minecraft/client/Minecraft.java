...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, InterruptedException {
        ...
        try {
			this.customFont = new CFontRenderer(Font.createFont(Font.TRUETYPE_FONT, CFont.class.getResourceAsStream("fonts/font.otf")).deriveFont(Font.PLAIN, 22), true, true);
		} catch (Exception e) {
			e.printStackTrace();
        	shutdown();
		}
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Starting Axolotl");
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                    	...
                    	Axolotl.INSTANCE.moduleManager.keyPress(var1);
