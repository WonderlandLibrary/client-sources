...
import vestige.VestigeInit;
import vestige.api.event.impl.KeyPressedEvent;
import vestige.impl.module.ghost.DelayRemover;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
		...
		LogUtil.logToConsole("HWID : " + encryptedHWID);
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = Vestige.getInstance().getMainMenu();
        }
        ...
        if (this.leftClickCounter <= 0)
        {
            ...
            else
            {
                switch (this.objectMouseOver.typeOfHit)
                {
                    ...
                    case MISS:
                    default:
                        if (this.playerController.isNotCreative() && !Vestige.getInstance().getModuleManager().getModule(DelayRemover.class).isEnabled())
                        {
                            this.leftClickCounter = 10;
                        }
                }
