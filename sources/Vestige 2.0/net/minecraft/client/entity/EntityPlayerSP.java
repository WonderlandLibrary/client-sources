...
import vestige.impl.module.exploit.SelfDestruct;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            if(((SelfDestruct) Vestige.getInstance().getModuleManager().getModule(SelfDestruct.class)).keepSprintEnabled.isEnabled() && Vestige.getInstance().isDestructed()) {
            	if(mc.thePlayer.moveForward > 0 && !mc.thePlayer.isUsingItem() && !mc.thePlayer.isCollidedHorizontally && mc.thePlayer.getFoodStats().getFoodLevel() > 6) {
    ...
    {
        MotionEvent event = new MotionEvent(mc.thePlayer.posX, mc.thePlayer.getEntityBoundingBox().minY, mc.thePlayer.posZ, mc.thePlayer.rotationYaw, mc.thePlayer.rotationPitch, mc.thePlayer.onGround);
        event.call();
