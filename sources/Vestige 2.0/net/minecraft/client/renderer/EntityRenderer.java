...
import vestige.impl.module.ghost.Hitbox;
import vestige.impl.module.ghost.Reach;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            if(isPlayer) {
            	Reach reachModule = (Reach) Vestige.getInstance().getModuleManager().getModule(Reach.class);
            	Hitbox hitboxModule = (Hitbox) Vestige.getInstance().getModuleManager().getModule(Hitbox.class);
            	
            	if(reachModule.isEnabled()) {
            		maxReach = reachModule.reach.getCurrentValue();
            	}
            	if(hitboxModule.isEnabled()) {
            		expand = (float) (hitboxModule.expand.getCurrentValue() * hitboxModule.multiplier.getCurrentValue());
            	}
            }
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > maxReach)
            {
                this.pointedEntity = null;
