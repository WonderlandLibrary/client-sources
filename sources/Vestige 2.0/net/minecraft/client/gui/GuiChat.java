...
public class GuiChat extends GuiScreen
{
    ...
    {
    	Vestige.getInstance().getModuleDragProcessor().mouseClicked(mouseX, mouseY, mouseButton);
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state) {
    	Vestige.getInstance().getModuleDragProcessor().mouseReleased(mouseX, mouseY, state);
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        Vestige.getInstance().getModuleDragProcessor().drawScreen(mouseX, mouseY, partialTicks);
    }
