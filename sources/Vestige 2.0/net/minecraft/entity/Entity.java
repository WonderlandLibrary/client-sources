...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            if(this.equals(Minecraft.getMinecraft().thePlayer)) {
            	Scaffold scaffold = (Scaffold) Vestige.getInstance().getModuleManager().getModule(Scaffold.class);
            	
            	if(scaffold.isEnabled()) {
            		flag = scaffold.shouldSafewalk() && this.onGround;
            	}
            }
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z))
            {
                ...
                if(this == Minecraft.getMinecraft().thePlayer) {
                	StepEvent event = new StepEvent((float) (this.getEntityBoundingBox().minY - this.posY));
                	event.call();
                }
            }
    ...
    public void moveFlying(float strafe, float forward, float friction)
    {
        ...
        StrafeEvent event = new StrafeEvent(this.rotationYaw);
