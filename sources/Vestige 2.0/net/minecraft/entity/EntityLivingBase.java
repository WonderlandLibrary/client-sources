...
import vestige.impl.module.render.Animations;
...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        Animations animations = (Animations) Vestige.getInstance().getModuleManager().getModule(Animations.class);

        if(animations.isEnabled()) {
            return this.isPotionActive(Potion.digSpeed) ? 6 - (1 + this.getActivePotionEffect(Potion.digSpeed).getAmplifier()) * 1 : (int) ((this.isPotionActive(Potion.digSlowdown) ? 6 + (1 + this.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2 : 6) * animations.swingDuration.getCurrentValue() * Minecraft.getMinecraft().timer.timerSpeed);
        }
    ...
    protected void jump()
    {
        ...
        JumpEvent event = new JumpEvent(this.motionY, this.rotationYaw);
        ...
        this.motionY = event.getJumpHeight();
