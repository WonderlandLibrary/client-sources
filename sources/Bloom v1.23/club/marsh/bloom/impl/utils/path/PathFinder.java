package club.marsh.bloom.impl.utils.path;
...
public class PathFinder {
    ...
    private static boolean isBlockSolid(BlockPos block) {
        return mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()).isBlockNormalCube()||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockSlab) ||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockStairs)||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockCactus)||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockChest)||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockEnderChest)||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockSkull)||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockPane)||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockFence)||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockWall)||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockGlass)||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockPistonBase)||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockPistonExtension)||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockPistonMoving)||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockStainedGlass)||
                (mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockTrapDoor);
    }

    private static boolean isSafeToWalkOn(BlockPos block) {
        return !(mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockFence) &&
                !(mc.theWorld.getBlockAt(block.getX(), block.getY(), block.getZ()) instanceof BlockWall);
    }
