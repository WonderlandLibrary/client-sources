...
public class ScreenShotHelper
{
     ...
     */
    public static IChatComponent saveScreenshot(File gameDirectory, String screenshotName, final int widthA, final int heightA, Framebuffer buffer)
    {
        try
        {
            ...
            new Thread(() -> {
                ...
                fileName.set(file2.getName());
                filePath.set(file2.getPath());
            }).run();
            IChatComponent ichatcomponent = new ChatComponentText(fileName.get());
            ichatcomponent.getChatStyle().setChatClickEvent(new ClickEvent(ClickEvent.Action.OPEN_FILE, filePath.get()));
