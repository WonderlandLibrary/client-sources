...
public class IntegratedServer extends MinecraftServer
{
    ...
    protected void loadAllWorlds(String saveName, String worldNameIn, long seed, WorldType type, String worldNameIn2)
    {
        ...
        if (flag)
        {
            WorldServer worldserver = this.isDemo() ? (WorldServer)((WorldServer)(new DemoWorldServer(this, isavehandler, worldinfo, 0)).init()) : (WorldServer)(new WorldServer(this, isavehandler, worldinfo, 0)).init();
