...
import club.marsh.bloom.impl.events.PreDuringUpdateEvent;
import club.marsh.bloom.impl.mods.combat.KeepSprint;
...
public class PlayerControllerMP
{
    ...
    {
    	Bloom.INSTANCE.eventBus.post(new AttackEvent());
        this.syncCurrentPlayItem();
