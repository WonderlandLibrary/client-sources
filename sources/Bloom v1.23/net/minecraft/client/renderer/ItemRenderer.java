...
import club.marsh.bloom.impl.mods.render.Animations;
...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            GlStateManager.pushMatrix();
            boolean aboolean = KillAura.toggled && KillAura.autoblock.isOn() && KillAura.autoblockmode.mode == "Fake" && KillAura.target != null;
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0 || aboolean)
                {
                    EnumAction enumaction = aboolean ? EnumAction.BLOCK : this.itemToRender.getItemUseAction();
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                        	...
                        	{
                        		f = 0; // just looks better
                        	}
                        	
                            if (!Animations.animate(partialTicks,abstractclientplayer.getItemInUseCount(),enumaction,abstractclientplayer.getSwingProgress(partialTicks),f)) {
                                this.transformFirstPersonItem(f, 0.0F);
