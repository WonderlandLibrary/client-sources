...
import club.marsh.bloom.impl.mods.render.FullBright;
import com.google.common.base.Predicate;
import com.google.common.base.Predicates;
import com.google.gson.JsonSyntaxException;

import club.marsh.bloom.impl.mods.render.NoHurtCam;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase && !NoHurtCam.on)
        {
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                GlStateManager.rotate(entity.prevRotationYawHead + (entity.rotationYawHead - entity.prevRotationYawHead) * partialTicks + 180.0F, 0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(entity.prevRotationPitchHead + (entity.rotationPitchHead - entity.prevRotationPitchHead) * partialTicks, -1.0F, 0.0F, 0.0F);
            }
        }
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists())
        {
            if (!this.mc.gameSettings.debugCamEnable)
            {
                float f6 = entity.prevRotationYawHead + (entity.rotationYawHead - entity.prevRotationYawHead) * partialTicks + 180.0F;
                float f7 = entity.prevRotationPitchHead + (entity.rotationPitchHead - entity.prevRotationPitchHead) * partialTicks;
                float f8 = 0.0F;
        ...
        if (this.lightmapUpdateNeeded)
        {
            ...
            if (world != null)
            {
                ...
                for (int i = 0; i < 256; ++i)
                {
                    ...
                    if (FullBright.on) {
                        switch (FullBright.mode.getMode()) {
                            case "Inverse":
                                f16 = -900;
                                f8 = 0;
                                f9 = 0;
