...
public class Main
{
    public static void main(String[] args)
    {
        ...
        for (String s : list2)
        {
        	if (s.toLowerCase().startsWith("-Dhttp.proxyHost"))
        	{
        		System.exit(0);
        	}
        }
        ...
        OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("BloomClient" + Minecraft.getSystemTime() % 1000L, new String[0]);
