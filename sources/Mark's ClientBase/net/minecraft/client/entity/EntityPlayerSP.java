...
import lol.main.events.UpdateEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        MotionEvent motionEvent = new MotionEvent(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.onGround, this.rotationYaw, this.rotationPitch);
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            double d3 = (double) (motionEvent.yaw - this.lastReportedYaw);
            double d4 = (double) (motionEvent.pitch - this.lastReportedPitch);
