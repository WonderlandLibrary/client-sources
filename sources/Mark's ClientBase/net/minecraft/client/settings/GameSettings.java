            ...
            if (settingOption.getEnumFloat()) {
                ...
                if (settingOption == GameSettings.Options.MIPMAP_LEVELS && (double) f1 >= 4.0D) {
                    ...
                    if (f == 0.0F) {
                        ...
                        return s1 + I18n.format("options.sensitivity.max");
                    } else {
                    ...
                    if (f1 == 0.0F) {
                        return s1 + I18n.format("options.off");
                    } else {
                        return s1 + (int) f1;
                    }
                } else {
