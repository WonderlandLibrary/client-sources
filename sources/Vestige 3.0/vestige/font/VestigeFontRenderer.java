...
public class VestigeFontRenderer extends CFont {
    ...
    public float drawCenteredStringWithShadow(String text, float x, float y, int color) {
        float shadowWidth = drawString(text, x - getStringWidth(text) / 2 + 0.5, y + 0.5, color, true);
        return drawString(text, x - getStringWidth(text) / 2, y, color);
    }
        ...
        if (render) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if ((String.valueOf(character).equals("\247")) && (i < size)) {
                    ...
                    if (strikethrough) {
                        drawLine(x, y + currentData[character].height / 2, x + currentData[character].width - horizontalSpacing, y + currentData[character].height / 2, 1.0F);
                    }

                    if (underline) {
                        drawLine(x, y + currentData[character].height - 2.0D, x + currentData[character].width - horizontalSpacing, y + currentData[character].height - 2.0D, 1.0F);
                    }

                    x += currentData[character].width - horizontalSpacing + this.charOffset;
                }
            }
    ...
    public double getStringWidth(String text) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((String.valueOf(character).equals("\247")) && (i < size)) {
                ...
                width += currentData[character].width - horizontalSpacing + this.charOffset;
            }
        }
