...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        Tickbase tickbase = Vestige.instance.getModuleManager().getModule(Tickbase.class);

        if(tickbase.freezing) {
            return 0;
        }

        Animations animationsModule = Vestige.instance.getModuleManager().getModule(Animations.class);
