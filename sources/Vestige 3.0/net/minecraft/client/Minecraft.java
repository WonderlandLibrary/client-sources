    ...
    public void clickMouse()
    {
        if (this.leftClickCounter <= 0)
        {
            ...
            if (this.objectMouseOver == null)
            {
                ...
                if (this.playerController.isNotCreative() && !Vestige.instance.getModuleManager().getModule(DelayRemover.class).isEnabled())
                {
            ...
            else
            {
                switch (this.objectMouseOver.typeOfHit)
                {
                    ...
                    case BLOCK:
                        ...
                        Killaura killauraModule = Vestige.instance.getModuleManager().getModule(Killaura.class);
