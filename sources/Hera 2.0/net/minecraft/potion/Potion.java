...
/* 125 */     return field_180150_I.get(new ResourceLocation(location));
/*     */   }
/*     */ 
/*     */   
...
/* 240 */       return (j > 0) ? ((p_76397_1_ % j == 0)) : true;
/*     */     } 
/* 242 */     if (this.id == wither.id) {
/*     */       
/* 244 */       int i = 40 >> p_76397_2_;
/* 245 */       return (i > 0) ? ((p_76397_1_ % i == 0)) : true;
/*     */     } 
/*     */ 
/*     */     
...
/* 336 */     AttributeModifier attributemodifier = new AttributeModifier(UUID.fromString(p_111184_2_), getName(), p_111184_3_, p_111184_5_);
...
/*     */       
/* 350 */       IAttributeInstance iattributeinstance = p_111187_2_.getAttributeInstance(entry.getKey());
/*     */       
/* 352 */       if (iattributeinstance != null)
/*     */       {
/* 354 */         iattributeinstance.removeModifier(entry.getValue());
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/*     */       
/* 363 */       IAttributeInstance iattributeinstance = p_111185_2_.getAttributeInstance(entry.getKey());
/*     */       
/* 365 */       if (iattributeinstance != null) {
/*     */         
/* 367 */         AttributeModifier attributemodifier = entry.getValue();
/* 368 */         iattributeinstance.removeModifier(attributemodifier);
/* 369 */         iattributeinstance.applyModifier(new AttributeModifier(attributemodifier.getID(), String.valueOf(getName()) + " " + amplifier, getAttributeModifierAmount(amplifier, attributemodifier), attributemodifier.getOperation()));
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
