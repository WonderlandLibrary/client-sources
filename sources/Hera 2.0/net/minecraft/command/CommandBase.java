...
/*     */     }
/*  58 */     catch (NumberFormatException var2) {
/*     */       
...
/*  66 */     return parseInt(input, min, 2147483647);
/*     */   }
/*     */ 
/*     */   
...
/*     */     }
/*  93 */     catch (NumberFormatException var2) {
/*     */       
...
/*     */     
/*     */     }
/* 138 */     catch (NumberFormatException var3) {
/*     */       
...
/* 242 */     if (entity == null)
/*     */     {
/* 244 */       entityPlayerMP = minecraftserver.getConfigurationManager().getPlayerByUsername(p_175759_1_);
/*     */     }
/*     */     
/* 247 */     if (entityPlayerMP == null) {
/*     */       
/*     */       try {
/*     */         
/* 251 */         UUID uuid = UUID.fromString(p_175759_1_);
/* 252 */         Entity entity1 = minecraftserver.getEntityFromUuid(uuid);
/*     */         
/* 254 */         if (entity1 == null)
/*     */         {
/* 256 */           entityPlayerMP = minecraftserver.getConfigurationManager().getPlayerByUUID(uuid);
/*     */         }
/*     */       }
/* 259 */       catch (IllegalArgumentException var6) {
/*     */         
/* 261 */         throw new EntityNotFoundException("commands.generic.entity.invalidUuid", new Object[0]);
/*     */       } 
/*     */     }
/*     */     
/* 265 */     if (entityPlayerMP != null && p_175759_2_.isAssignableFrom(entityPlayerMP.getClass()))
/*     */     {
/* 267 */       return (T)entityPlayerMP;
/*     */     }
/*     */ 
/*     */     
...
/* 277 */     return PlayerSelector.hasArguments(p_175763_1_) ? PlayerSelector.<Entity>matchEntities(p_175763_0_, p_175763_1_, Entity.class) : Lists.newArrayList((Object[])new Entity[] { func_175768_b(p_175763_0_, p_175763_1_) });
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */     }
/* 286 */     catch (PlayerNotFoundException playernotfoundexception) {
/*     */       
...
/*     */     }
/* 309 */     catch (PlayerNotFoundException var5) {
/*     */ 
/*     */       
/*     */       try {
/* 313 */         return func_175768_b(p_175758_0_, p_175758_1_).getUniqueID().toString();
/*     */       }
/* 315 */       catch (EntityNotFoundException entitynotfoundexception) {
/*     */         
...
/* 336 */     ChatComponentText chatComponentText = new ChatComponentText("");
/*     */     
/* 338 */     for (int i = index; i < args.length; i++) {
/*     */       IChatComponent iChatComponent;
/* 340 */       if (i > index)
/*     */       {
/* 342 */         chatComponentText.appendText(" ");
/*     */       }
/*     */       
/* 345 */       ChatComponentText chatComponentText1 = new ChatComponentText(args[i]);
/*     */       
/* 347 */       if (p_147176_3_) {
/*     */         
...
/*     */         else {
/*     */           
/* 360 */           iChatComponent = ichatcomponent2;
/*     */         } 
/*     */       } 
/*     */       
/* 364 */       chatComponentText.appendSibling(iChatComponent);
/*     */     } 
/*     */     
/* 367 */     return (IChatComponent)chatComponentText;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 573 */     ChatComponentText chatComponentText = new ChatComponentText("");
/*     */     
...
/*     */           
/* 581 */           chatComponentText.appendText(" and ");
/*     */         }
/* 583 */         else if (i > 0) {
/*     */           
/* 585 */           chatComponentText.appendText(", ");
/*     */         } 
/*     */       }
/*     */       
/* 589 */       chatComponentText.appendSibling(components.get(i));
/*     */     } 
/*     */     
...
/* 602 */     return joinNiceString(strings.toArray((Object[])new String[strings.size()]));
/*     */   }
/*     */   
...
/*     */     } 
/*     */     
/* 634 */     return Lists.newArrayList((Object[])new String[] { s });
/*     */   }
/*     */ 
/*     */   
...
/*     */     } 
/*     */     
/* 663 */     return Lists.newArrayList((Object[])new String[] { s });
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 677 */     return getListOfStringsMatchingLastWord(args, Arrays.asList((Object[])possibilities));
/*     */   }
/*     */ 
/*     */   
