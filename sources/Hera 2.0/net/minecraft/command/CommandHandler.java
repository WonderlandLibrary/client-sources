...
/*     */       
/* 126 */       ICommand icommand = this.commandMap.get(s);
/*     */       
...
/*     */         
/* 158 */         if (CommandBase.doesStringStartWith(s, entry.getKey()) && ((ICommand)entry.getValue()).canCommandSenderUseCommand(sender))
/*     */         {
...
/*     */       
/* 170 */       ICommand icommand = this.commandMap.get(s);
/*     */       
