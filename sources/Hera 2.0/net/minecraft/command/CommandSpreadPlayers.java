...
/*     */         continue;
/*     */       } 
/*  83 */       EntityPlayerMP entityPlayerMP = MinecraftServer.getServer().getConfigurationManager().getPlayerByUsername(s);
/*     */       
/*  85 */       if (entityPlayerMP == null)
/*     */       {
/*  87 */         throw new PlayerNotFoundException();
/*     */       }
/*     */       
/*  90 */       list.add(entityPlayerMP);
/*     */     } 
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 102 */     sender.addChatMessage((IChatComponent)new ChatComponentTranslation("commands.spreadplayers.spreading." + (flag ? "teams" : "players"), new Object[] { Integer.valueOf(list.size()), Double.valueOf(d3), Double.valueOf(d0), Double.valueOf(d1), Double.valueOf(d2) }));
...
/*     */     {
/* 122 */       p_110669_1_.addChatMessage((IChatComponent)new ChatComponentTranslation("commands.spreadplayers.info." + (p_110669_9_ ? "teams" : "players"), new Object[] { String.format("%.2f", new Object[] { Double.valueOf(d4) }), Integer.valueOf(i) }));
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/*     */     int i;
/* 151 */     for (i = 0; i < 10000 && flag; i++) {
/*     */       
/* 153 */       flag = false;
/* 154 */       d0 = 3.4028234663852886E38D;
/*     */       
/* 156 */       for (int j = 0; j < p_110668_14_.length; j++) {
/*     */         
/* 158 */         Position commandspreadplayers$position = p_110668_14_[j];
/* 159 */         int k = 0;
/* 160 */         Position commandspreadplayers$position1 = new Position();
/*     */         
...
/* 206 */         for (k = (arrayOfPosition = p_110668_14_).length, b = 0; b < k; ) { Position commandspreadplayers$position3 = arrayOfPosition[b];
/*     */           
...
/* 235 */       Entity entity = p_110671_1_.get(j);
/*     */ 
/*     */       
/* 238 */       if (p_110671_4_) {
/*     */         
...
/*     */         }
/*     */         
/* 247 */         commandspreadplayers$position = map.get(team);
/*     */       }
/*     */       else {
/*     */         
