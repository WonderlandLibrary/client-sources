...
/*     */     } 
/*     */     
/* 118 */     entityplayermp.playerNetServerHandler.sendPacket((Packet)new S29PacketSoundEffect(s, d0, d1, d2, (float)d3, (float)d4));
...
/* 125 */     return (args.length == 2) ? getListOfStringsMatchingLastWord(args, MinecraftServer.getServer().getAllUsernames()) : ((args.length > 2 && args.length <= 5) ? func_175771_a(args, 2, pos) : null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
