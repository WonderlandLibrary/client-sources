...
/*     */         
/* 119 */         for (int k = structureboundingbox.minZ; k <= structureboundingbox.maxZ; k++) {
/*     */           
/* 121 */           for (int l = structureboundingbox.minY; l <= structureboundingbox.maxY; l++) {
/*     */             
/* 123 */             for (int i1 = structureboundingbox.minX; i1 <= structureboundingbox.maxX; i1++) {
/*     */               
/* 125 */               BlockPos blockpos4 = new BlockPos(i1, l, k);
/* 126 */               BlockPos blockpos5 = blockpos4.add((Vec3i)blockpos3);
...
/*     */           
/* 205 */           TileEntity tileentity3 = world.getTileEntity(commandclone$staticclonedata2.field_179537_a);
/*     */           
...
/*     */             
/* 230 */             if (structureboundingbox.isVecInside((Vec3i)nextticklistentry.position)) {
/*     */               
/* 232 */               BlockPos blockpos8 = nextticklistentry.position.add((Vec3i)blockpos3);
