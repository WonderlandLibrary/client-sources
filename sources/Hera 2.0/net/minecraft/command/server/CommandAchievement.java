...
/*     */           {
/*  76 */             entityplayermp.triggerAchievement((StatBase)achievement4);
/*     */           }
/*     */           
/*  79 */           notifyOperators(sender, (ICommand)this, "commands.achievement.give.success.all", new Object[] { entityplayermp.getName() });
/*     */         }
/*  81 */         else if (flag1)
/*     */         {
/*  83 */           for (Achievement achievement5 : Lists.reverse(AchievementList.achievementList))
/*     */           {
/*  85 */             entityplayermp.func_175145_a((StatBase)achievement5);
/*     */           }
/*     */           
/*  88 */           notifyOperators(sender, (ICommand)this, "commands.achievement.take.success.all", new Object[] { entityplayermp.getName() });
/*     */         }
/*     */       
/*     */       } else {
/*     */         
...
/*     */             
/* 106 */             for (list = Lists.newArrayList(); achievement.parentAchievement != null && !entityplayermp.getStatFile().hasAchievementUnlocked(achievement.parentAchievement); achievement = achievement.parentAchievement)
/*     */             {
/* 108 */               list.add(achievement.parentAchievement);
/*     */             }
/*     */             
/* 111 */             for (Achievement achievement1 : Lists.reverse(list))
/*     */             {
/* 113 */               entityplayermp.triggerAchievement((StatBase)achievement1);
/*     */             }
/*     */           }
/* 116 */           else if (flag1) {
/*     */             
...
/*     */             }
/*     */             
/* 123 */             List<Achievement> list1 = Lists.newArrayList((Iterator)Iterators.filter(AchievementList.achievementList.iterator(), new Predicate<Achievement>()
/*     */                   {
...
/*     */                     }
/*     */                   }));
/* 130 */             List<Achievement> list2 = Lists.newArrayList(list1);
/*     */             
/* 132 */             for (Achievement achievement2 : list1) {
/*     */               
/* 134 */               Achievement achievement3 = achievement2;
/*     */               
/*     */               boolean flag2;
/* 137 */               for (flag2 = false; achievement3 != null; achievement3 = achievement3.parentAchievement) {
/*     */                 
...
/*     */             {
/* 156 */               entityplayermp.func_175145_a((StatBase)achievement6);
/*     */             }
/*     */           } 
/*     */         } 
/*     */         
...
/* 164 */           notifyOperators(sender, (ICommand)this, "commands.achievement.give.success.one", new Object[] { entityplayermp.getName(), statbase.func_150955_j() });
/*     */         }
/* 166 */         else if (flag1) {
/*     */           
/* 168 */           entityplayermp.func_175145_a(statbase);
/* 169 */           notifyOperators(sender, (ICommand)this, "commands.achievement.take.success.one", new Object[] { statbase.func_150955_j(), entityplayermp.getName() });
/*     */         } 
/*     */       } 
/*     */     }
/*     */   }
