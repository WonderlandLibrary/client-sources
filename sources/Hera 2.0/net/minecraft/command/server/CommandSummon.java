...
/*     */       
/*  81 */       world.addWeatherEffect((Entity)new EntityLightningBolt(world, d0, d1, d2));
/*  82 */       notifyOperators(sender, (ICommand)this, "commands.summon.success", new Object[0]);
/*     */     } else {
/*     */       Entity entity2;
/*     */       
...
/*  96 */           flag = true;
/*     */         }
/*  98 */         catch (NBTException nbtexception) {
/*     */           
...
/*     */       }
/* 111 */       catch (RuntimeException var19) {
/*     */         
...
/*     */       } 
/*     */       
/* 146 */       notifyOperators(sender, (ICommand)this, "commands.summon.success", new Object[0]);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 154 */     return (args.length == 1) ? getListOfStringsMatchingLastWord(args, EntityList.getEntityNameList()) : ((args.length > 1 && args.length <= 4) ? func_175771_a(args, 1, pos) : null);
/*     */   }
/*     */ }
