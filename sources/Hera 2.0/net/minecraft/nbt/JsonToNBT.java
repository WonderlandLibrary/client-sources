...
/*  38 */     Stack<Character> stack = new Stack<Character>();
/*     */     
...
/*     */         
/* 120 */         String s1 = func_150314_a(p_150316_1_, true);
/*     */         
/* 122 */         if (s1.length() > 0) {
/*     */           
...
/*     */         
/* 151 */         String s = func_150314_a(p_150316_1_, false);
/*     */         
/* 153 */         if (s.length() > 0) {
/*     */           
...
/* 214 */     Stack<Character> stack = new Stack<Character>();
...
/*     */     extends Any {
/* 395 */     protected java.util.List<JsonToNBT.Any> field_150491_b = Lists.newArrayList();
/*     */ 
/*     */     
...
/*     */   static class List
/*     */     extends Any {
/* 417 */     protected java.util.List<JsonToNBT.Any> field_150492_b = Lists.newArrayList();
/*     */ 
/*     */     
...
/* 508 */         String[] astring = (String[])Iterables.toArray(SPLITTER.split(s), String.class);
/*     */ 
/*     */         
/*     */         try {
...
/*     */         }
/* 521 */         catch (NumberFormatException var5) {
/*     */           
