...
/* 161 */     return this.tagList.remove(i);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 179 */       NBTBase nbtbase = this.tagList.get(i);
...
/*     */       
/* 192 */       NBTBase nbtbase = this.tagList.get(i);
...
/*     */       
/* 205 */       NBTBase nbtbase = this.tagList.get(i);
...
/*     */       
/* 218 */       NBTBase nbtbase = this.tagList.get(i);
...
/*     */       
/* 234 */       NBTBase nbtbase = this.tagList.get(i);
...
/* 248 */     return (idx >= 0 && idx < this.tagList.size()) ? this.tagList.get(idx) : new NBTTagEnd();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
