...
/* 249 */           double d4 = 180.0D - MathHelper.func_181159_b(d11, d13) * 180.0D / Math.PI;
...
/*     */           
/* 330 */           collideWithEntities(this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.dragonPartWing1.getEntityBoundingBox().expand(4.0D, 2.0D, 4.0D).offset(0.0D, -2.0D, 0.0D)));
/* 331 */           collideWithEntities(this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.dragonPartWing2.getEntityBoundingBox().expand(4.0D, 2.0D, 4.0D).offset(0.0D, -2.0D, 0.0D)));
/* 332 */           attackEntitiesInList(this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, this.dragonPartHead.getEntityBoundingBox().expand(1.0D, 1.0D, 1.0D)));
/*     */         } 
/*     */         
...
/*     */         
/* 410 */         double d1 = entityendercrystal1.getDistanceSqToEntity((Entity)this);
/*     */         
/* 412 */         if (d1 < d0) {
/*     */           
/* 414 */           d0 = d1;
...
/*     */       
/* 450 */       Entity entity = p_70971_1_.get(i);
/*     */       
/* 452 */       if (entity instanceof EntityLivingBase) {
/*     */         
/* 454 */         entity.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), 10.0F);
/* 455 */         applyEnchantments((EntityLivingBase)this, entity);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/* 640 */           i -= k;
/* 641 */           this.worldObj.spawnEntityInWorld((Entity)new EntityXPOrb(this.worldObj, this.posX, this.posY, this.posZ, k));
/*     */         } 
/*     */       } 
/*     */       
/* 645 */       if (this.deathTicks == 1)
/*     */       {
/* 647 */         this.worldObj.playBroadcastSound(1018, new BlockPos((Entity)this), 0);
/*     */       }
/*     */     } 
/*     */     
...
/* 663 */           j -= l;
/* 664 */           this.worldObj.spawnEntityInWorld((Entity)new EntityXPOrb(this.worldObj, this.posX, this.posY, this.posZ, l));
/*     */         } 
/*     */       } 
/*     */       
...
/* 722 */     this.worldObj.setBlockState(blockpos1.west(), Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.EAST));
/* 723 */     this.worldObj.setBlockState(blockpos1.east(), Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.WEST));
/* 724 */     this.worldObj.setBlockState(blockpos1.north(), Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.SOUTH));
/* 725 */     this.worldObj.setBlockState(blockpos1.south(), Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)EnumFacing.NORTH));
...
/* 742 */     return (Entity[])this.dragonPartArray;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
