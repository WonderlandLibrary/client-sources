...
/*     */   
/*  51 */   private static final Predicate<Entity> attackEntitySelector = new Predicate<Entity>()
/*     */     {
...
/* 196 */         float f = (float)(MathHelper.func_181159_b(d8, d6) * 180.0D / Math.PI) - 90.0F;
/* 197 */         float f1 = (float)-(MathHelper.func_181159_b(d7, d9) * 180.0D / Math.PI);
...
/* 237 */       if (j1 <= 0) {
/*     */         
/* 239 */         this.worldObj.newExplosion((Entity)this, this.posX, this.posY + getEyeHeight(), this.posZ, 7.0F, false, this.worldObj.getGameRules().getBoolean("mobGriefing"));
/* 240 */         this.worldObj.playBroadcastSound(1013, new BlockPos((Entity)this), 0);
/*     */       } 
/*     */       
/* 243 */       setInvulTime(j1);
/*     */       
...
/*     */           } else {
/*     */             
/* 304 */             List<EntityLivingBase> list = this.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, getEntityBoundingBox().expand(20.0D, 8.0D, 20.0D), Predicates.and(attackEntitySelector, EntitySelectors.NOT_SPECTATING));
/*     */             
/* 306 */             for (int j2 = 0; j2 < 10 && !list.isEmpty(); j2++) {
/*     */               
/* 308 */               EntityLivingBase entitylivingbase = list.get(this.rand.nextInt(list.size()));
/*     */               
/* 310 */               if (entitylivingbase != this && entitylivingbase.isEntityAlive() && canEntityBeSeen((Entity)entitylivingbase)) {
/*     */                 
...
/* 373 */           if (flag)
/*     */           {
/* 375 */             this.worldObj.playAuxSFXAtEntity(null, 1012, new BlockPos((Entity)this), 0);
/*     */           }
/*     */         } 
/*     */       } 
/*     */       
...
/* 473 */     this.worldObj.playAuxSFXAtEntity(null, 1014, new BlockPos((Entity)this), 0);
...
/* 478 */     double d4 = y - d1;
/* 479 */     double d5 = z - d2;
/* 480 */     EntityWitherSkull entitywitherskull = new EntityWitherSkull(this.worldObj, (EntityLivingBase)this, d3, d4, d5);
/*     */     
/* 482 */     if (invulnerable)
/*     */     {
...
/* 490 */     this.worldObj.spawnEntityInWorld((Entity)entitywitherskull);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/* 522 */         if (entity instanceof net.minecraft.entity.projectile.EntityArrow)
/*     */         {
/* 524 */           return false;
/*     */         }
/*     */       } 
...
/*     */       {
/* 543 */         this.field_82224_i[i] = this.field_82224_i[i] + 3;
/*     */       }
/*     */       
...
/* 561 */     EntityItem entityitem = dropItem(Items.nether_star, 1);
/*     */     
...
/*     */       {
/* 572 */         entityplayer.triggerAchievement((StatBase)AchievementList.killWither);
/*     */       }
/*     */     }
/*     */   }
/*     */ 
