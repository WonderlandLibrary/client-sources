...
/*     */           {
/* 383 */             playerMP.playerNetServerHandler.sendPacket((Packet)new S1CPacketEntityMetadata(this.trackedEntity.getEntityId(), this.trackedEntity.getDataWatcher(), true));
/*     */           }
/*     */           
/* 386 */           NBTTagCompound nbttagcompound = this.trackedEntity.getNBTTagCompound();
/*     */           
/* 388 */           if (nbttagcompound != null)
/*     */           {
/* 390 */             playerMP.playerNetServerHandler.sendPacket((Packet)new S49PacketUpdateEntityNBT(this.trackedEntity.getEntityId(), nbttagcompound));
/*     */           }
/*     */           
...
/*     */             {
/* 400 */               playerMP.playerNetServerHandler.sendPacket((Packet)new S20PacketEntityProperties(this.trackedEntity.getEntityId(), collection));
/*     */             }
/*     */           } 
/*     */           
...
/*     */           {
/* 410 */             playerMP.playerNetServerHandler.sendPacket((Packet)new S12PacketEntityVelocity(this.trackedEntity.getEntityId(), this.trackedEntity.motionX, this.trackedEntity.motionY, this.trackedEntity.motionZ));
/*     */           }
/*     */           
/* 413 */           if (this.trackedEntity.ridingEntity != null)
/*     */           {
/* 415 */             playerMP.playerNetServerHandler.sendPacket((Packet)new S1BPacketEntityAttach(0, this.trackedEntity, this.trackedEntity.ridingEntity));
/*     */           }
/*     */           
/* 418 */           if (this.trackedEntity instanceof EntityLiving && ((EntityLiving)this.trackedEntity).getLeashedToEntity() != null)
/*     */           {
/* 420 */             playerMP.playerNetServerHandler.sendPacket((Packet)new S1BPacketEntityAttach(1, this.trackedEntity, ((EntityLiving)this.trackedEntity).getLeashedToEntity()));
/*     */           }
/*     */           
...
/*     */               {
/* 431 */                 playerMP.playerNetServerHandler.sendPacket((Packet)new S04PacketEntityEquipment(this.trackedEntity.getEntityId(), i, itemstack));
/*     */               }
/*     */             } 
/*     */           }
/*     */           
...
/*     */             {
/* 442 */               playerMP.playerNetServerHandler.sendPacket((Packet)new S0APacketUseBed(entityplayer, new BlockPos(this.trackedEntity)));
/*     */             }
/*     */           } 
/*     */           
...
/*     */             {
/* 452 */               playerMP.playerNetServerHandler.sendPacket((Packet)new S1DPacketEntityEffect(this.trackedEntity.getEntityId(), potioneffect));
/*     */             }
/*     */           }
/*     */         
/*     */         } 
...
/*     */     }
/*     */     
/* 492 */     if (this.trackedEntity instanceof net.minecraft.entity.item.EntityItem)
/*     */     {
/* 494 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 2, 1);
/*     */     }
/* 496 */     if (this.trackedEntity instanceof EntityPlayerMP)
/*     */     {
/* 498 */       return (Packet)new S0CPacketSpawnPlayer((EntityPlayer)this.trackedEntity);
/*     */     }
/* 500 */     if (this.trackedEntity instanceof EntityMinecart) {
/*     */       
/* 502 */       EntityMinecart entityminecart = (EntityMinecart)this.trackedEntity;
/* 503 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 10, entityminecart.getMinecartType().getNetworkID());
/*     */     } 
/* 505 */     if (this.trackedEntity instanceof net.minecraft.entity.item.EntityBoat)
/*     */     {
/* 507 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 1);
/*     */     }
/* 509 */     if (this.trackedEntity instanceof net.minecraft.entity.passive.IAnimals) {
/*     */       
/* 511 */       this.lastHeadMotion = MathHelper.floor_float(this.trackedEntity.getRotationYawHead() * 256.0F / 360.0F);
/* 512 */       return (Packet)new S0FPacketSpawnMob((EntityLivingBase)this.trackedEntity);
/*     */     } 
/* 514 */     if (this.trackedEntity instanceof EntityFishHook) {
/*     */       
/* 516 */       EntityPlayer entityPlayer = ((EntityFishHook)this.trackedEntity).angler;
/* 517 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 90, (entityPlayer != null) ? entityPlayer.getEntityId() : this.trackedEntity.getEntityId());
/*     */     } 
/* 519 */     if (this.trackedEntity instanceof EntityArrow) {
/*     */       
/* 521 */       Entity entity = ((EntityArrow)this.trackedEntity).shootingEntity;
/* 522 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 60, (entity != null) ? entity.getEntityId() : this.trackedEntity.getEntityId());
/*     */     } 
/* 524 */     if (this.trackedEntity instanceof net.minecraft.entity.projectile.EntitySnowball)
/*     */     {
/* 526 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 61);
/*     */     }
/* 528 */     if (this.trackedEntity instanceof EntityPotion)
/*     */     {
/* 530 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 73, ((EntityPotion)this.trackedEntity).getPotionDamage());
/*     */     }
/* 532 */     if (this.trackedEntity instanceof net.minecraft.entity.item.EntityExpBottle)
/*     */     {
/* 534 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 75);
/*     */     }
/* 536 */     if (this.trackedEntity instanceof net.minecraft.entity.item.EntityEnderPearl)
/*     */     {
/* 538 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 65);
/*     */     }
/* 540 */     if (this.trackedEntity instanceof net.minecraft.entity.item.EntityEnderEye)
/*     */     {
/* 542 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 72);
/*     */     }
/* 544 */     if (this.trackedEntity instanceof net.minecraft.entity.item.EntityFireworkRocket)
/*     */     {
/* 546 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 76);
/*     */     }
...
/* 552 */       int i = 63;
/*     */       
/* 554 */       if (this.trackedEntity instanceof net.minecraft.entity.projectile.EntitySmallFireball) {
/*     */         
/* 556 */         i = 64;
/*     */       }
/* 558 */       else if (this.trackedEntity instanceof net.minecraft.entity.projectile.EntityWitherSkull) {
/*     */         
/* 560 */         i = 66;
/*     */       } 
/*     */       
...
/* 575 */       return (Packet)s0epacketspawnobject2;
/*     */     } 
/* 577 */     if (this.trackedEntity instanceof net.minecraft.entity.projectile.EntityEgg)
/*     */     {
/* 579 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 62);
/*     */     }
/* 581 */     if (this.trackedEntity instanceof net.minecraft.entity.item.EntityTNTPrimed)
/*     */     {
/* 583 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 50);
/*     */     }
/* 585 */     if (this.trackedEntity instanceof net.minecraft.entity.item.EntityEnderCrystal)
/*     */     {
/* 587 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 51);
/*     */     }
...
/* 592 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 70, Block.getStateId(entityfallingblock.getBlock()));
/*     */     } 
/* 594 */     if (this.trackedEntity instanceof net.minecraft.entity.item.EntityArmorStand)
/*     */     {
/* 596 */       return (Packet)new S0EPacketSpawnObject(this.trackedEntity, 78);
/*     */     }
/* 598 */     if (this.trackedEntity instanceof EntityPainting)
/*     */     {
/* 600 */       return (Packet)new S10PacketSpawnPainting((EntityPainting)this.trackedEntity);
/*     */     }
...
/* 610 */       return (Packet)s0epacketspawnobject1;
/*     */     } 
...
/* 620 */       return (Packet)s0epacketspawnobject;
/*     */     } 
/* 622 */     if (this.trackedEntity instanceof EntityXPOrb)
/*     */     {
/* 624 */       return (Packet)new S11PacketSpawnExperienceOrb((EntityXPOrb)this.trackedEntity);
/*     */     }
/*     */ 
/*     */     
