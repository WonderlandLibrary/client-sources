...
/*  40 */     super(worldIn);
/*  41 */     this.health = 5;
/*  42 */     this.hoverStart = (float)(Math.random() * Math.PI * 2.0D);
...
/*  68 */     super(worldIn);
/*  69 */     this.health = 5;
/*  70 */     this.hoverStart = (float)(Math.random() * Math.PI * 2.0D);
...
/*     */         
/* 108 */         if (this.worldObj.getBlockState(new BlockPos(this)).getBlock().getMaterial() == Material.lava) {
/*     */           
...
/*     */       {
/* 126 */         f = (this.worldObj.getBlockState(new BlockPos(MathHelper.floor_double(this.posX), MathHelper.floor_double((getEntityBoundingBox()).minY) - 1, MathHelper.floor_double(this.posZ))).getBlock()).slipperiness * 0.98F;
/*     */       }
/*     */       
/* 129 */       this.motionX *= f;
...
/* 184 */             return false;
/*     */           }
/* 186 */           if ((itemstack1.hasTagCompound() ^ itemstack.hasTagCompound()) != 0)
/*     */           {
/* 188 */             return false;
/*     */           }
...
/* 250 */     if (this.worldObj.handleMaterialAcceleration(getEntityBoundingBox(), Material.water, this)) {
/*     */       
...
/*     */     {
/* 324 */       tagCompound.setTag("Item", (NBTBase)getEntityItem().writeToNBT(new NBTTagCompound()));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */         {
/* 374 */           entityIn.triggerAchievement((StatBase)AchievementList.mineWood);
/*     */         }
/*     */         
...
/*     */         {
/* 384 */           entityIn.triggerAchievement((StatBase)AchievementList.killCow);
/*     */         }
/*     */         
/* 387 */         if (itemstack.getItem() == Items.diamond)
/*     */         {
/* 389 */           entityIn.triggerAchievement((StatBase)AchievementList.diamonds);
/*     */         }
/*     */         
/* 392 */         if (itemstack.getItem() == Items.blaze_rod)
/*     */         {
/* 394 */           entityIn.triggerAchievement((StatBase)AchievementList.blazeRod);
/*     */         }
/*     */         
...
/*     */           {
/* 403 */             entityplayer.triggerAchievement((StatBase)AchievementList.diamondsToYou);
/*     */           }
/*     */         } 
/*     */         
/* 407 */         if (!isSilent())
/*     */         {
/* 409 */           this.worldObj.playSoundAtEntity((Entity)entityIn, "random.pop", 0.2F, ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.7F + 1.0F) * 2.0F);
/*     */         }
/*     */         
...
/* 427 */     return hasCustomName() ? getCustomNameTag() : StatCollector.translateToLocal("item." + getEntityItem().getUnlocalizedName());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
