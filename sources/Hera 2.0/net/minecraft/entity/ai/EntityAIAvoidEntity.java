...
/*  39 */     this.canBeSeenSelector = new Predicate<Entity>()
/*     */       {
...
/*     */ 
/*     */     
/*  69 */     this.closestLivingEntity = list.get(0);
/*  70 */     Vec3 vec3 = RandomPositionGenerator.findRandomTargetBlockAwayFrom(this.theEntity, 16, 7, new Vec3(((Entity)this.closestLivingEntity).posX, ((Entity)this.closestLivingEntity).posY, ((Entity)this.closestLivingEntity).posZ));
/*     */     
/*  72 */     if (vec3 == null)
/*     */     {
/*  74 */       return false;
/*     */     }
/*  76 */     if (this.closestLivingEntity.getDistanceSq(vec3.xCoord, vec3.yCoord, vec3.zCoord) < this.closestLivingEntity.getDistanceSqToEntity((Entity)this.theEntity))
/*     */     {
/*  78 */       return false;
/*     */     }
/*     */ 
...
/* 117 */     if (this.theEntity.getDistanceSqToEntity((Entity)this.closestLivingEntity) < 49.0D) {
/*     */       
