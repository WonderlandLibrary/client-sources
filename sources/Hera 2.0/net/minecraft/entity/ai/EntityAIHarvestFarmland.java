...
/*     */       
/*  87 */       if (this.field_179501_f == 0 && block instanceof BlockCrops && ((Integer)iblockstate.getValue((IProperty)BlockCrops.AGE)).intValue() == 7) {
/*     */         
...
/*     */       
/* 151 */       if (block instanceof BlockCrops && ((Integer)iblockstate.getValue((IProperty)BlockCrops.AGE)).intValue() == 7 && this.field_179503_e && (this.field_179501_f == 0 || this.field_179501_f < 0)) {
/*     */         
