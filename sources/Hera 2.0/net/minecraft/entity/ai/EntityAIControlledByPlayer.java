...
/*     */         
/* 180 */         itemstack.damageItem(1, (EntityLivingBase)entityplayer);
/*     */         
/* 182 */         if (itemstack.stackSize == 0) {
/*     */           
/* 184 */           ItemStack itemstack1 = new ItemStack((Item)Items.fishing_rod);
...
/* 199 */     return !(!(blockIn instanceof net.minecraft.block.BlockStairs) && !(blockIn instanceof net.minecraft.block.BlockSlab));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
