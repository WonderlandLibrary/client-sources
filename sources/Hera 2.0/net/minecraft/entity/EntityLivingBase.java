...
/*  411 */           i -= j;
/*  412 */           this.worldObj.spawnEntityInWorld((Entity)new EntityXPOrb(this.worldObj, this.posX, this.posY, this.posZ, j));
/*      */         } 
/*      */       } 
/*      */       
/*  416 */       setDead();
...
/*  521 */     tagCompound.setFloat("AbsorptionAmount", getAbsorptionAmount()); byte b; int i;
/*      */     ItemStack[] arrayOfItemStack;
/*  523 */     for (i = (arrayOfItemStack = getInventory()).length, b = 0; b < i; ) { ItemStack itemstack = arrayOfItemStack[b];
/*      */       
...
/*      */       b++; }
/*      */     
/*  531 */     tagCompound.setTag("Attributes", (NBTBase)SharedMonsterAttributes.writeBaseAttributeMapToNBT(getAttributeMap()));
/*      */     
/*  533 */     for (i = (arrayOfItemStack = getInventory()).length, b = 0; b < i; ) { ItemStack itemstack1 = arrayOfItemStack[b];
/*      */       
...
/*      */       {
/*  547 */         nbttaglist.appendTag((NBTBase)potioneffect.writeCustomPotionEffectToNBT(new NBTTagCompound()));
/*      */       }
/*      */       
/*  550 */       tagCompound.setTag("ActiveEffects", (NBTBase)nbttaglist);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*      */       
/*  615 */       Integer integer = iterator.next();
/*  616 */       PotionEffect potioneffect = this.activePotionsMap.get(integer);
/*      */       
...
/*      */         }  continue;
/*      */       } 
/*  626 */       if (potioneffect.getDuration() % 600 == 0)
/*      */       {
...
/*  658 */       if (flag1)
/*      */       {
/*  660 */         j = flag & ((this.rand.nextInt(5) == 0) ? 1 : 0);
/*      */       }
/*      */       
/*  663 */       if (j != 0 && i > 0) {
/*      */         
...
/*      */       
/*  708 */       Integer integer = iterator.next();
/*  709 */       PotionEffect potioneffect = this.activePotionsMap.get(integer);
/*      */       
...
/*  739 */     return this.activePotionsMap.get(Integer.valueOf(potionIn.id));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  752 */         onChangedPotionEffect(this.activePotionsMap.get(Integer.valueOf(potioneffectIn.getPotionID())), true);
/*      */       }
/*      */       else {
/*      */         
...
/*  798 */     PotionEffect potioneffect = this.activePotionsMap.remove(Integer.valueOf(potionId));
/*      */     
...
/*      */         
/*      */         double d0;
/*  956 */         for (d0 = entity.posZ - this.posZ; d1 * d1 + d0 * d0 < 1.0E-4D; d0 = (Math.random() - Math.random()) * 0.01D)
/*      */         {
/*  958 */           d1 = (Math.random() - Math.random()) * 0.01D;
/*      */         }
/*      */         
/*  961 */         this.attackedAtYaw = (float)(MathHelper.func_181159_b(d0, d1) * 180.0D / Math.PI - this.rotationYaw);
...
/* 1186 */     int i = 0; byte b; int j;
/*      */     ItemStack[] arrayOfItemStack;
/* 1188 */     for (j = (arrayOfItemStack = getInventory()).length, b = 0; b < j; ) { ItemStack itemstack = arrayOfItemStack[b];
/*      */       
/* 1190 */       if (itemstack != null && itemstack.getItem() instanceof ItemArmor) {
/*      */         
/* 1192 */         int k = ((ItemArmor)itemstack.getItem()).damageReduceAmount;
/* 1193 */         i += k;
/*      */       } 
/*      */       b++; }
/*      */     
...
/* 1295 */     return (this._combatTracker.func_94550_c() != null) ? this._combatTracker.func_94550_c() : ((this.attackingPlayer != null) ? (EntityLivingBase)this.attackingPlayer : ((this.entityLivingToAttack != null) ? this.entityLivingToAttack : null));
/*      */   }
/*      */ 
/*      */   
...
/* 1325 */     return isPotionActive(Potion.digSpeed) ? (6 - (1 + getActivePotionEffect(Potion.digSpeed).getAmplifier()) * 1) : (isPotionActive(Potion.digSlowdown) ? (6 + (1 + getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2) : 6);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       {
/* 1340 */         ((WorldServer)this.worldObj).getEntityTracker().sendToAllTrackingEntity(this, (Packet)new S0BPacketAnimation(this, 0));
/*      */       }
/*      */     } 
/*      */   }
/*      */ 
...
/*      */     {
/* 1422 */       this.attributeMap = (BaseAttributeMap)new ServersideAttributeMap();
/*      */     }
/*      */     
...
/*      */             
/* 1523 */             if (World.doesBlockHaveSolidTopSurface((IBlockAccess)this.worldObj, new BlockPos(l, (int)this.posY, i1))) {
/*      */               
/* 1525 */               setPositionAndUpdate(this.posX + j, this.posY + 1.0D, this.posZ + k);
/*      */               
/*      */               return;
/*      */             } 
/* 1529 */             if (World.doesBlockHaveSolidTopSurface((IBlockAccess)this.worldObj, new BlockPos(l, (int)this.posY - 1, i1)) || this.worldObj.getBlockState(new BlockPos(l, (int)this.posY - 1, i1)).getBlock().getMaterial() == Material.water) {
/*      */               
/* 1531 */               d0 = this.posX + j;
...
/*      */           
/* 1803 */           ((WorldServer)this.worldObj).getEntityTracker().sendToAllTrackingEntity(this, (Packet)new S04PacketEntityEquipment(getEntityId(), j, itemstack1));
/*      */           
...
/* 1952 */       this.newPosRotationIncrements--;
...
/* 2041 */     List<Entity> list = this.worldObj.getEntitiesInAABBexcluding(this, getEntityBoundingBox().expand(0.20000000298023224D, 0.0D, 0.20000000298023224D), Predicates.and(EntitySelectors.NOT_SPECTATING, new Predicate<Entity>()
/*      */           {
...
/*      */       
/* 2124 */       if (p_71001_1_ instanceof net.minecraft.entity.item.EntityItem)
/*      */       {
/* 2126 */         entitytracker.sendToAllTrackingEntity(p_71001_1_, (Packet)new S0DPacketCollectItem(p_71001_1_.getEntityId(), getEntityId()));
/*      */       }
/*      */       
/* 2129 */       if (p_71001_1_ instanceof net.minecraft.entity.projectile.EntityArrow)
/*      */       {
/* 2131 */         entitytracker.sendToAllTrackingEntity(p_71001_1_, (Packet)new S0DPacketCollectItem(p_71001_1_.getEntityId(), getEntityId()));
/*      */       }
/*      */       
/* 2134 */       if (p_71001_1_ instanceof EntityXPOrb)
/*      */       {
/* 2136 */         entitytracker.sendToAllTrackingEntity(p_71001_1_, (Packet)new S0DPacketCollectItem(p_71001_1_.getEntityId(), getEntityId()));
/*      */       }
/*      */     } 
/*      */   }
/*      */ 
...
/*      */   
/*      */   public Team getTeam() {
/* 2256 */     return (Team)this.worldObj.getScoreboard().getPlayersTeam(getUniqueID().toString());
/*      */   }
/*      */ 
/*      */   
