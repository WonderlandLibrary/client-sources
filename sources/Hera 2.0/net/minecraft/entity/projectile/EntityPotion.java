...
/*  29 */     this(worldIn, throwerIn, new ItemStack((Item)Items.potionitem, 1, meta));
/*     */   }
/*     */ 
/*     */   
...
/*  40 */     this(worldIn, x, y, z, new ItemStack((Item)Items.potionitem, 1, p_i1791_8_));
/*     */   }
/*     */ 
/*     */   
...
/*     */     {
/*  74 */       this.potionDamage = new ItemStack((Item)Items.potionitem, 1, 0);
/*     */     }
/*     */     
...
/*     */     {
/*  87 */       this.potionDamage = new ItemStack((Item)Items.potionitem, 1, 0);
/*     */     }
/*     */     
...
/*     */             
/* 111 */             double d0 = getDistanceSqToEntity((Entity)entitylivingbase);
/*     */             
/* 113 */             if (d0 < 16.0D) {
/*     */               
...
/*     */                   
/* 128 */                   Potion.potionTypes[i].affectEntity(this, (Entity)getThrower(), entitylivingbase, potioneffect.getAmplifier(), d1);
/*     */                   
/*     */                   continue;
/*     */                 } 
...
/*     */     {
/* 181 */       tagCompound.setTag("Potion", (NBTBase)this.potionDamage.writeToNBT(new NBTTagCompound()));
/*     */     }
/*     */   }
/*     */ }
