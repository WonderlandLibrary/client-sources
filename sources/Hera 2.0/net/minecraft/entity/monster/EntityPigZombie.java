...
/* 111 */     return (this.worldObj.getDifficulty() != EnumDifficulty.PEACEFUL);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 119 */     return (this.worldObj.checkNoEntityCollision(getEntityBoundingBox(), (Entity)this) && this.worldObj.getCollidingBoundingBoxes((Entity)this, getEntityBoundingBox()).isEmpty() && !this.worldObj.isAnyLiquid(getEntityBoundingBox()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 153 */       setRevengeTarget((EntityLivingBase)entityplayer);
/*     */       
...
/* 269 */     setCurrentItemOrArmor(0, new ItemStack(Items.golden_sword));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 287 */       super(p_i45828_1_, true, new Class[0]);
/*     */     }
/*     */ 
/*     */     
...
/*     */       {
/* 296 */         ((EntityPigZombie)creatureIn).becomeAngryAt((Entity)entityLivingBaseIn);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/* 305 */       super(p_i45829_1_, EntityPlayer.class, true);
/*     */     }
/*     */ 
/*     */     
