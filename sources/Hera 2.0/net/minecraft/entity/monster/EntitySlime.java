...
/* 224 */         this.worldObj.spawnEntityInWorld((Entity)entityslime);
/*     */       } 
/*     */     } 
/*     */     
/* 228 */     super.setDead();
...
/*     */     {
/* 251 */       func_175451_e((EntityLivingBase)entityIn);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 259 */     if (canEntityBeSeen((Entity)p_175451_1_) && getDistanceSqToEntity((Entity)p_175451_1_) < 0.6D * i * 0.6D * i && p_175451_1_.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), getAttackStrength())) {
/*     */       
/* 261 */       playSound("mob.attack", 1.0F, (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F);
/* 262 */       applyEnchantments((EntityLivingBase)this, (Entity)p_175451_1_);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 305 */     return (getSlimeSize() == 1) ? Items.slime_ball : null;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/* 326 */       if (biomegenbase == BiomeGenBase.swampland && this.posY > 50.0D && this.posY < 70.0D && this.rand.nextFloat() < 0.5F && this.rand.nextFloat() < this.worldObj.getCurrentMoonPhaseFactor() && this.worldObj.getLightFromNeighbors(new BlockPos((Entity)this)) <= this.rand.nextInt(8))
/*     */       {
...
/* 415 */       return (entitylivingbase == null) ? false : (!entitylivingbase.isEntityAlive() ? false : (!(entitylivingbase instanceof EntityPlayer && ((EntityPlayer)entitylivingbase).capabilities.disableDamage)));
/*     */     }
/*     */ 
/*     */     
...
/* 427 */       return (entitylivingbase == null) ? false : (!entitylivingbase.isEntityAlive() ? false : ((entitylivingbase instanceof EntityPlayer && ((EntityPlayer)entitylivingbase).capabilities.disableDamage) ? false : ((--this.field_179465_b > 0))));
/*     */     }
/*     */ 
/*     */     
/*     */     public void updateTask() {
/* 432 */       this.slime.faceEntity((Entity)this.slime.getAttackTarget(), 10.0F, 10.0F);
