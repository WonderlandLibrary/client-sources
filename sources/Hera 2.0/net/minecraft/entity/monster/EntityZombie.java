...
/*  73 */     this.tasks.addTask(2, (EntityAIBase)new EntityAIAttackOnCollide(this, EntityPlayer.class, 1.0D, false));
/*  74 */     this.tasks.addTask(5, (EntityAIBase)new EntityAIMoveTowardsRestriction(this, 1.0D));
/*  75 */     this.tasks.addTask(7, (EntityAIBase)new EntityAIWander(this, 1.0D));
/*  76 */     this.tasks.addTask(8, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityPlayer.class, 8.0F));
/*  77 */     this.tasks.addTask(8, (EntityAIBase)new EntityAILookIdle((EntityLiving)this));
/*  78 */     applyEntityAI();
...
/*  84 */     this.tasks.addTask(4, (EntityAIBase)new EntityAIAttackOnCollide(this, EntityVillager.class, 1.0D, true));
/*  85 */     this.tasks.addTask(4, (EntityAIBase)new EntityAIAttackOnCollide(this, EntityIronGolem.class, 1.0D, true));
/*  86 */     this.tasks.addTask(6, (EntityAIBase)new EntityAIMoveThroughVillage(this, 1.0D, false));
/*  87 */     this.targetTasks.addTask(1, (EntityAIBase)new EntityAIHurtByTarget(this, true, new Class[] { EntityPigZombie.class }));
/*  88 */     this.targetTasks.addTask(2, (EntityAIBase)new EntityAINearestAttackableTarget(this, EntityPlayer.class, true));
/*  89 */     this.targetTasks.addTask(2, (EntityAIBase)new EntityAINearestAttackableTarget(this, EntityVillager.class, false));
/*  90 */     this.targetTasks.addTask(2, (EntityAIBase)new EntityAINearestAttackableTarget(this, EntityIronGolem.class, true));
/*     */   }
/*     */ 
/*     */   
...
/* 139 */       if (par1) {
/*     */         
/* 141 */         this.tasks.addTask(1, (EntityAIBase)this.breakDoor);
/*     */       }
/*     */       else {
/*     */         
/* 145 */         this.tasks.removeTask((EntityAIBase)this.breakDoor);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/*     */           
/* 282 */           if (World.doesBlockHaveSolidTopSurface((IBlockAccess)this.worldObj, new BlockPos(i1, j1 - 1, k1)) && this.worldObj.getLightFromNeighbors(new BlockPos(i1, j1, k1)) < 10) {
/*     */             
/* 284 */             entityzombie.setPosition(i1, j1, k1);
/*     */             
/* 286 */             if (!this.worldObj.isAnyPlayerWithinRangeAt(i1, j1, k1, 7.0D) && this.worldObj.checkNoEntityCollision(entityzombie.getEntityBoundingBox(), (Entity)entityzombie) && this.worldObj.getCollidingBoundingBoxes((Entity)entityzombie, entityzombie.getEntityBoundingBox()).isEmpty() && !this.worldObj.isAnyLiquid(entityzombie.getEntityBoundingBox())) {
/*     */               
/* 288 */               this.worldObj.spawnEntityInWorld((Entity)entityzombie);
/* 289 */               entityzombie.setAttackTarget(entitylivingbase);
/* 290 */               entityzombie.onInitialSpawn(this.worldObj.getDifficultyForLocation(new BlockPos((Entity)entityzombie)), (IEntityLivingData)null);
...
/* 489 */       entityzombie.copyLocationAndAnglesFrom((Entity)entityLivingIn);
/* 490 */       this.worldObj.removeEntity((Entity)entityLivingIn);
/* 491 */       entityzombie.onInitialSpawn(this.worldObj.getDifficultyForLocation(new BlockPos((Entity)entityzombie)), (IEntityLivingData)null);
...
/*     */       } 
/*     */       
/* 507 */       this.worldObj.spawnEntityInWorld((Entity)entityzombie);
...
/*     */           
/* 559 */           List<EntityChicken> list = this.worldObj.getEntitiesWithinAABB(EntityChicken.class, getEntityBoundingBox().expand(5.0D, 3.0D, 5.0D), EntitySelectors.IS_STANDALONE);
/*     */           
/* 561 */           if (!list.isEmpty())
/*     */           {
/* 563 */             EntityChicken entitychicken = list.get(0);
/* 564 */             entitychicken.setChickenJockey(true);
/* 565 */             mountEntity((Entity)entitychicken);
/*     */           }
/*     */         
...
/* 574 */           this.worldObj.spawnEntityInWorld((Entity)entitychicken1);
/* 575 */           mountEntity((Entity)entitychicken1);
/*     */         } 
/*     */       } 
/*     */     } 
/*     */     
...
/* 655 */     this.worldObj.setEntityState((Entity)this, (byte)16);
/*     */   }
/*     */ 
/*     */   
...
/* 695 */     entityvillager.copyLocationAndAnglesFrom((Entity)this);
/* 696 */     entityvillager.onInitialSpawn(this.worldObj.getDifficultyForLocation(new BlockPos((Entity)entityvillager)), null);
/* 697 */     entityvillager.setLookingForHome();
/*     */     
/* 699 */     if (isChild())
/*     */     {
/* 701 */       entityvillager.setGrowingAge(-24000);
/*     */     }
/*     */     
/* 704 */     this.worldObj.removeEntity((Entity)this);
...
/*     */     } 
/*     */     
/* 713 */     this.worldObj.spawnEntityInWorld((Entity)entityvillager);
...
/*     */             
/* 736 */             Block block = this.worldObj.getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(k, l, i1)).getBlock();
/*     */             
