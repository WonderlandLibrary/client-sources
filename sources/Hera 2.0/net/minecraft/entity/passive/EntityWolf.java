...
/*  64 */     this.tasks.addTask(1, (EntityAIBase)new EntityAISwimming((EntityLiving)this));
/*  65 */     this.tasks.addTask(2, (EntityAIBase)this.aiSit);
/*  66 */     this.tasks.addTask(3, (EntityAIBase)new EntityAILeapAtTarget((EntityLiving)this, 0.4F));
/*  67 */     this.tasks.addTask(4, (EntityAIBase)new EntityAIAttackOnCollide((EntityCreature)this, 1.0D, true));
/*  68 */     this.tasks.addTask(5, (EntityAIBase)new EntityAIFollowOwner(this, 1.0D, 10.0F, 2.0F));
/*  69 */     this.tasks.addTask(6, (EntityAIBase)new EntityAIMate(this, 1.0D));
/*  70 */     this.tasks.addTask(7, (EntityAIBase)new EntityAIWander((EntityCreature)this, 1.0D));
/*  71 */     this.tasks.addTask(8, (EntityAIBase)new EntityAIBeg(this, 8.0F));
/*  72 */     this.tasks.addTask(9, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityPlayer.class, 8.0F));
/*  73 */     this.tasks.addTask(9, (EntityAIBase)new EntityAILookIdle((EntityLiving)this));
/*  74 */     this.targetTasks.addTask(1, (EntityAIBase)new EntityAIOwnerHurtByTarget(this));
/*  75 */     this.targetTasks.addTask(2, (EntityAIBase)new EntityAIOwnerHurtTarget(this));
/*  76 */     this.targetTasks.addTask(3, (EntityAIBase)new EntityAIHurtByTarget((EntityCreature)this, true, new Class[0]));
/*  77 */     this.targetTasks.addTask(4, (EntityAIBase)new EntityAITargetNonTamed(this, EntityAnimal.class, false, new Predicate<Entity>()
/*     */           {
...
/*     */             }
/*     */           }));
/*  84 */     this.targetTasks.addTask(5, (EntityAIBase)new EntityAINearestAttackableTarget((EntityCreature)this, EntitySkeleton.class, false));
/*  85 */     setTamed(false);
/*     */   }
/*     */ 
/*     */   
...
/* 170 */     return isAngry() ? "mob.wolf.growl" : ((this.rand.nextInt(3) == 0) ? ((isTamed() && this.dataWatcher.getWatchableObjectFloat(18) < 10.0F) ? "mob.wolf.whine" : "mob.wolf.panting") : "mob.wolf.bark");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 215 */       this.worldObj.setEntityState((Entity)this, (byte)8);
/*     */     } 
/*     */     
...
/*     */     
/* 346 */     if (entity != null && !(entity instanceof EntityPlayer) && !(entity instanceof net.minecraft.entity.projectile.EntityArrow))
/*     */     {
...
/* 357 */     boolean flag = entityIn.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), (int)getEntityAttribute(SharedMonsterAttributes.attackDamage).getAttributeValue());
/*     */     
/* 359 */     if (flag)
/*     */     {
/* 361 */       applyEnchantments((EntityLivingBase)this, entityIn);
/*     */     }
/*     */     
/* 364 */     return flag;
/*     */   }
...
/*     */             
/* 423 */             if (!player.capabilities.isCreativeMode && --itemstack.stackSize <= 0)
/*     */             {
...
/*     */       }
/*     */       
/* 433 */       if (isOwner((EntityLivingBase)player) && !this.worldObj.isRemote && !isBreedingItem(itemstack))
/*     */       {
/* 435 */         this.aiSit.setSitting(!isSitting());
/* 436 */         this.isJumping = false;
/* 437 */         this.navigator.clearPathEntity();
/* 438 */         setAttackTarget((EntityLivingBase)null);
/*     */       }
/*     */     
...
/* 459 */           setAttackTarget((EntityLivingBase)null);
/* 460 */           this.aiSit.setSitting(true);
/* 461 */           setHealth(20.0F);
/* 462 */           setOwnerId(player.getUniqueID().toString());
/* 463 */           playTameEffect(true);
/* 464 */           this.worldObj.setEntityState((Entity)this, (byte)7);
/*     */         }
/*     */         else {
/*     */           
/* 468 */           playTameEffect(false);
/* 469 */           this.worldObj.setEntityState((Entity)this, (byte)6);
/*     */         } 
/*     */       }
/*     */       
/* 473 */       return true;
...
/* 495 */     return isAngry() ? 1.5393804F : (isTamed() ? ((0.55F - (20.0F - this.dataWatcher.getWatchableObjectFloat(18)) * 0.02F) * 3.1415927F) : 0.62831855F);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 504 */     return (stack == null) ? false : (!(stack.getItem() instanceof ItemFood) ? false : ((ItemFood)stack.getItem()).isWolfsFavoriteMeat());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 596 */     return !entitywolf.isTamed() ? false : (entitywolf.isSitting() ? false : ((isInLove() && entitywolf.isInLove())));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 615 */     if (!(p_142018_1_ instanceof net.minecraft.entity.monster.EntityCreeper) && !(p_142018_1_ instanceof net.minecraft.entity.monster.EntityGhast)) {
/*     */       
...
/*     */       } 
/*     */       
/* 627 */       return (p_142018_1_ instanceof EntityPlayer && p_142018_2_ instanceof EntityPlayer && !((EntityPlayer)p_142018_2_).canAttackPlayer((EntityPlayer)p_142018_1_)) ? false : (!(p_142018_1_ instanceof EntityHorse && ((EntityHorse)p_142018_1_).isTame()));
/*     */     } 
/*     */ 
/*     */     
/* 631 */     return false;
