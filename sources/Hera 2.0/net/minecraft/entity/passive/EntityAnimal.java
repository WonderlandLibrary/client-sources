...
/*  82 */     return (this.worldObj.getBlockState(pos.down()).getBlock() == Blocks.grass) ? 10.0F : (this.worldObj.getLightBrightness(pos) - 0.5F);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 145 */     return (stack == null) ? false : ((stack.getItem() == Items.wheat));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 195 */     this.worldObj.setEntityState((Entity)this, (byte)18);
/*     */   }
/*     */ 
/*     */   
...
/* 221 */     return (otherAnimal == this) ? false : ((otherAnimal.getClass() != getClass()) ? false : ((isInLove() && otherAnimal.isInLove())));
/*     */   }
/*     */ 
/*     */   
