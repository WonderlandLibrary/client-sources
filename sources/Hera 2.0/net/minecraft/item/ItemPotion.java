...
/*     */     {
/* 223 */       s = String.valueOf(StatCollector.translateToLocal("potion.prefix.grenade").trim()) + " ";
/*     */     }
/*     */     
...
/* 231 */       s2 = String.valueOf(s2) + ".postfix";
/* 232 */       return String.valueOf(s) + StatCollector.translateToLocal(s2).trim();
/*     */     } 
/*     */ 
/*     */     
/* 236 */     String s1 = PotionHelper.getPotionPrefix(stack.getMetadata());
/* 237 */     return String.valueOf(StatCollector.translateToLocal(s1).trim()) + " " + super.getItemStackDisplayName(stack);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 250 */       HashMultimap hashMultimap = HashMultimap.create();
/*     */       
...
/*     */               
/* 264 */               AttributeModifier attributemodifier = entry.getValue();
...
/* 266 */               hashMultimap.put(((IAttribute)entry.getKey()).getAttributeUnlocalizedName(), attributemodifier1);
/*     */             } 
/*     */           }
/*     */           
/* 270 */           if (potioneffect.getAmplifier() > 0)
/*     */           {
/* 272 */             s1 = String.valueOf(s1) + " " + StatCollector.translateToLocal("potion.potency." + potioneffect.getAmplifier()).trim();
/*     */           }
/*     */           
/* 275 */           if (potioneffect.getDuration() > 20)
/*     */           {
/* 277 */             s1 = String.valueOf(s1) + " (" + Potion.getDurationString(potioneffect) + ")";
/*     */           }
/*     */           
...
/*     */       } 
/*     */       
/* 296 */       if (!hashMultimap.isEmpty()) {
/*     */         
/* 298 */         tooltip.add("");
/* 299 */         tooltip.add(EnumChatFormatting.DARK_PURPLE + StatCollector.translateToLocal("potion.effects.whenDrank"));
/*     */         
/* 301 */         for (Map.Entry<String, AttributeModifier> entry1 : (Iterable<Map.Entry<String, AttributeModifier>>)hashMultimap.entries()) {
/*     */           double d1;
/* 303 */           AttributeModifier attributemodifier2 = entry1.getValue();
...
/* 316 */           if (d0 > 0.0D) {
/*     */             
/* 318 */             tooltip.add(EnumChatFormatting.BLUE + StatCollector.translateToLocalFormatted("attribute.modifier.plus." + attributemodifier2.getOperation(), new Object[] { ItemStack.DECIMALFORMAT.format(d1), StatCollector.translateToLocal("attribute.name." + (String)entry1.getKey()) })); continue;
/*     */           } 
/* 320 */           if (d0 < 0.0D) {
/*     */             
/* 322 */             d1 *= -1.0D;
/* 323 */             tooltip.add(EnumChatFormatting.RED + StatCollector.translateToLocalFormatted("attribute.modifier.take." + attributemodifier2.getOperation(), new Object[] { ItemStack.DECIMALFORMAT.format(d1), StatCollector.translateToLocal("attribute.name." + (String)entry1.getKey()) }));
/*     */           } 
/*     */         } 
/*     */       } 
/*     */     } 
...
/*     */     }
/*     */     
/* 387 */     Iterator<Integer> iterator = SUB_ITEMS_CACHE.values().iterator();
/*     */     
