...
/*  20 */     for (i = (arrayOfEnumDyeColor = EnumDyeColor.values()).length, b = 0; b < i; ) { EnumDyeColor enumdyecolor = arrayOfEnumDyeColor[b];
/*     */       
...
/* 112 */           nbttagcompound1.setTag("Patterns", (NBTBase)nbttaglist);
/*     */         } 
/*     */         
...
/* 118 */         nbttaglist.appendTag((NBTBase)nbttagcompound);
/*     */       } 
/*     */       
...
/* 153 */       for (i = (arrayOfEnumBannerPattern = TileEntityBanner.EnumBannerPattern.values()).length, b = 0; b < i; ) { TileEntityBanner.EnumBannerPattern tileentitybanner$enumbannerpattern = arrayOfEnumBannerPattern[b];
/*     */         
...
/*     */             
/* 164 */             for (int j = 0; j < p_179533_1_.getSizeInventory() && flag; j++) {
/*     */               
/* 166 */               ItemStack itemstack = p_179533_1_.getStackInSlot(j);
/*     */               
...
/* 200 */             int j = -1;
/*     */             
/* 202 */             for (int k = 0; k < p_179533_1_.getSizeInventory() && flag; k++) {
/*     */               
/* 204 */               int l = k / 3;
/* 205 */               int i1 = k % 3;
