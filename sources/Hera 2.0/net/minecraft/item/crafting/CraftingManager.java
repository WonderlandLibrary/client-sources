...
/*  83 */     addRecipe(new ItemStack((Block)Blocks.stone_slab, 6, BlockStoneSlab.EnumType.COBBLESTONE.getMetadata()), new Object[] { "###", Character.valueOf('#'), Blocks.cobblestone });
/*  84 */     addRecipe(new ItemStack((Block)Blocks.stone_slab, 6, BlockStoneSlab.EnumType.STONE.getMetadata()), new Object[] { "###", Character.valueOf('#'), new ItemStack(Blocks.stone, BlockStone.EnumType.STONE.getMetadata()) });
/*  85 */     addRecipe(new ItemStack((Block)Blocks.stone_slab, 6, BlockStoneSlab.EnumType.SAND.getMetadata()), new Object[] { "###", Character.valueOf('#'), Blocks.sandstone });
/*  86 */     addRecipe(new ItemStack((Block)Blocks.stone_slab, 6, BlockStoneSlab.EnumType.BRICK.getMetadata()), new Object[] { "###", Character.valueOf('#'), Blocks.brick_block });
/*  87 */     addRecipe(new ItemStack((Block)Blocks.stone_slab, 6, BlockStoneSlab.EnumType.SMOOTHBRICK.getMetadata()), new Object[] { "###", Character.valueOf('#'), Blocks.stonebrick });
/*  88 */     addRecipe(new ItemStack((Block)Blocks.stone_slab, 6, BlockStoneSlab.EnumType.NETHERBRICK.getMetadata()), new Object[] { "###", Character.valueOf('#'), Blocks.nether_brick });
/*  89 */     addRecipe(new ItemStack((Block)Blocks.stone_slab, 6, BlockStoneSlab.EnumType.QUARTZ.getMetadata()), new Object[] { "###", Character.valueOf('#'), Blocks.quartz_block });
/*  90 */     addRecipe(new ItemStack((Block)Blocks.stone_slab2, 6, BlockStoneSlabNew.EnumType.RED_SANDSTONE.getMetadata()), new Object[] { "###", Character.valueOf('#'), Blocks.red_sandstone });
/*  91 */     addRecipe(new ItemStack((Block)Blocks.wooden_slab, 6, 0), new Object[] { "###", Character.valueOf('#'), new ItemStack(Blocks.planks, 1, BlockPlanks.EnumType.OAK.getMetadata()) });
/*  92 */     addRecipe(new ItemStack((Block)Blocks.wooden_slab, 6, BlockPlanks.EnumType.BIRCH.getMetadata()), new Object[] { "###", Character.valueOf('#'), new ItemStack(Blocks.planks, 1, BlockPlanks.EnumType.BIRCH.getMetadata()) });
/*  93 */     addRecipe(new ItemStack((Block)Blocks.wooden_slab, 6, BlockPlanks.EnumType.SPRUCE.getMetadata()), new Object[] { "###", Character.valueOf('#'), new ItemStack(Blocks.planks, 1, BlockPlanks.EnumType.SPRUCE.getMetadata()) });
/*  94 */     addRecipe(new ItemStack((Block)Blocks.wooden_slab, 6, BlockPlanks.EnumType.JUNGLE.getMetadata()), new Object[] { "###", Character.valueOf('#'), new ItemStack(Blocks.planks, 1, BlockPlanks.EnumType.JUNGLE.getMetadata()) });
/*  95 */     addRecipe(new ItemStack((Block)Blocks.wooden_slab, 6, 4 + BlockPlanks.EnumType.ACACIA.getMetadata() - 4), new Object[] { "###", Character.valueOf('#'), new ItemStack(Blocks.planks, 1, 4 + BlockPlanks.EnumType.ACACIA.getMetadata() - 4) });
/*  96 */     addRecipe(new ItemStack((Block)Blocks.wooden_slab, 6, 4 + BlockPlanks.EnumType.DARK_OAK.getMetadata() - 4), new Object[] { "###", Character.valueOf('#'), new ItemStack(Blocks.planks, 1, 4 + BlockPlanks.EnumType.DARK_OAK.getMetadata() - 4) });
...
/* 144 */     addRecipe(new ItemStack((Item)Items.fishing_rod, 1), new Object[] { "  #", " #X", "# X", Character.valueOf('#'), Items.stick, Character.valueOf('X'), Items.string });
...
/* 160 */     addRecipe(new ItemStack((Block)Blocks.tripwire_hook, 2), new Object[] { "I", "S", "#", Character.valueOf('#'), Blocks.planks, Character.valueOf('S'), Items.stick, Character.valueOf('I'), Items.iron_ingot });
...
/* 166 */     addRecipe(new ItemStack((Item)Items.map, 1), new Object[] { "###", "#X#", "###", Character.valueOf('#'), Items.paper, Character.valueOf('X'), Items.compass });
...
/* 175 */     addRecipe(new ItemStack((Block)Blocks.piston, 1), new Object[] { "TTT", "#X#", "#R#", Character.valueOf('#'), Blocks.cobblestone, Character.valueOf('X'), Items.iron_ingot, Character.valueOf('R'), Items.redstone, Character.valueOf('T'), Blocks.planks });
/* 176 */     addRecipe(new ItemStack((Block)Blocks.sticky_piston, 1), new Object[] { "S", "P", Character.valueOf('S'), Items.slime_ball, Character.valueOf('P'), Blocks.piston });
...
/* 184 */     addRecipe(new ItemStack((Block)Blocks.daylight_detector), new Object[] { "GGG", "QQQ", "WWW", Character.valueOf('G'), Blocks.glass, Character.valueOf('Q'), Items.quartz, Character.valueOf('W'), Blocks.wooden_slab });
/* 185 */     addRecipe(new ItemStack((Block)Blocks.hopper), new Object[] { "I I", "ICI", " I ", Character.valueOf('I'), Items.iron_ingot, Character.valueOf('C'), Blocks.chest });
/* 186 */     addRecipe(new ItemStack((Item)Items.armor_stand, 1), new Object[] { "///", " / ", "/_/", Character.valueOf('/'), Items.stick, Character.valueOf('_'), new ItemStack((Block)Blocks.stone_slab, 1, BlockStoneSlab.EnumType.STONE.getMetadata()) });
/* 187 */     Collections.sort(this.recipes, new Comparator<IRecipe>()
/*     */         {
/*     */           public int compare(IRecipe p_compare_1_, IRecipe p_compare_2_)
/*     */           {
/* 191 */             return (p_compare_1_ instanceof ShapelessRecipes && p_compare_2_ instanceof ShapedRecipes) ? 1 : ((p_compare_2_ instanceof ShapelessRecipes && p_compare_1_ instanceof ShapedRecipes) ? -1 : ((p_compare_2_.getRecipeSize() < p_compare_1_.getRecipeSize()) ? -1 : ((p_compare_2_.getRecipeSize() > p_compare_1_.getRecipeSize()) ? 1 : 0)));
/*     */           }
/*     */         });
/*     */   }
/*     */ 
...
/*     */       
/* 208 */       String[] astring = (String[])recipeComponents[i++];
/*     */       
/* 210 */       for (int l = 0; l < astring.length; l++)
/*     */       {
/* 212 */         String s2 = astring[l];
/* 213 */         k++;
/* 214 */         j = s2.length();
/* 215 */         s = String.valueOf(s) + s2;
/*     */       }
/*     */     
/*     */     } else {
/*     */       
/* 220 */       while (recipeComponents[i] instanceof String) {
/*     */         
/* 222 */         String s1 = (String)recipeComponents[i++];
/* 223 */         k++;
/* 224 */         j = s1.length();
/* 225 */         s = String.valueOf(s) + s1;
/*     */       } 
/*     */     } 
/*     */     
/*     */     Map<Character, ItemStack> map;
/*     */     
/* 231 */     for (map = Maps.newHashMap(); i < recipeComponents.length; i += 2) {
/*     */       
...
/* 278 */     List<ItemStack> list = Lists.newArrayList(); byte b; int i;
/*     */     Object[] arrayOfObject;
/* 280 */     for (i = (arrayOfObject = recipeComponents).length, b = 0; b < i; ) { Object object = arrayOfObject[b];
/*     */       
