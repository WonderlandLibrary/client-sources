...
/* 18 */     for (int i = 0; i < this.recipeItems.length; i++) {
/*    */       
/* 20 */       Block block = (Block)this.recipeItems[i][0];
/* 21 */       ItemStack itemstack = (ItemStack)this.recipeItems[i][1];
/* 22 */       p_77590_1_.addRecipe(new ItemStack(block), new Object[] { "###", "###", "###", Character.valueOf('#'), itemstack });
/* 23 */       p_77590_1_.addRecipe(itemstack, new Object[] { "#", Character.valueOf('#'), block });
/*    */     } 
/*    */     
/* 26 */     p_77590_1_.addRecipe(new ItemStack(Items.gold_ingot), new Object[] { "###", "###", "###", Character.valueOf('#'), Items.gold_nugget });
/* 27 */     p_77590_1_.addRecipe(new ItemStack(Items.gold_nugget, 9), new Object[] { "#", Character.valueOf('#'), Items.gold_ingot });
/*    */   }
/*    */ }
