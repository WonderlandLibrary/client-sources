...
/*     */       
/*  70 */       worldIn.setBlockState(pos, Blocks.skull.getDefaultState().withProperty((IProperty)BlockSkull.FACING, (Comparable)side), 3);
/*  71 */       int i = 0;
/*     */       
...
/*     */     }
/*     */     
/* 154 */     return String.valueOf(getUnlocalizedName()) + "." + skullTypes[i];
/*     */   }
/*     */ 
/*     */   
...
/* 191 */       nbt.setTag("SkullOwner", (NBTBase)NBTUtil.writeGameProfile(new NBTTagCompound(), gameprofile));
/* 192 */       return true;
/*     */     } 
/*     */ 
/*     */     
