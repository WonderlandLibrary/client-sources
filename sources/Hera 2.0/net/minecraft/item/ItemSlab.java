...
/*     */       
/*  64 */       IProperty iproperty = this.singleSlab.getVariantProperty();
/*  65 */       Comparable comparable = iblockstate.getValue(iproperty);
/*  66 */       BlockSlab.EnumBlockHalf blockslab$enumblockhalf = (BlockSlab.EnumBlockHalf)iblockstate.getValue((IProperty)BlockSlab.HALF);
/*     */       
...
/*  89 */     IProperty iproperty = this.singleSlab.getVariantProperty();
...
/*     */       
/*  95 */       boolean flag = (iblockstate.getValue((IProperty)BlockSlab.HALF) == BlockSlab.EnumBlockHalf.TOP);
/*     */       
