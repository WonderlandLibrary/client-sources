...
/*    */     
/* 30 */     if (block == Blocks.snow_layer && ((Integer)iblockstate.getValue((IProperty)BlockSnow.LAYERS)).intValue() < 1) {
/*    */       
...
/*    */       
/* 51 */       IBlockState iblockstate1 = this.block.onBlockPlaced(worldIn, pos, side, hitX, hitY, hitZ, 0, (EntityLivingBase)playerIn);
/*    */       
...
/* 60 */           iblockstate1.getBlock().onBlockPlacedBy(worldIn, pos, iblockstate1, (EntityLivingBase)playerIn, stack);
/*    */         } 
/*    */         
