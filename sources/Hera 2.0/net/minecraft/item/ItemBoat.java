...
/*  55 */     float f9 = 1.0F;
/*  56 */     List<Entity> list = worldIn.getEntitiesWithinAABBExcludingEntity((Entity)playerIn, playerIn.getEntityBoundingBox().addCoord(vec32.xCoord * d3, vec32.yCoord * d3, vec32.zCoord * d3).expand(f9, f9, f9));
/*     */     
...
/*     */       
/*  92 */       if (!worldIn.getCollidingBoundingBoxes((Entity)entityboat, entityboat.getEntityBoundingBox().expand(-0.1D, -0.1D, -0.1D)).isEmpty())
/*     */       {
...
/*     */       {
/*  99 */         worldIn.spawnEntityInWorld((Entity)entityboat);
/*     */       }
/*     */       
/* 102 */       if (!playerIn.capabilities.isCreativeMode)
/*     */       {
/* 104 */         itemStackIn.stackSize--;
/*     */       }
/*     */       
/* 107 */       playerIn.triggerAchievement(StatList.objectUseStats[Item.getIdFromItem(this)]);
/*     */     } 
/*     */     
