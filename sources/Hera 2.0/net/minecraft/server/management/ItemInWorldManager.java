...
/*     */         
/* 193 */         block.onBlockClicked(this.theWorld, pos, (EntityPlayer)this.thisPlayerMP);
/* 194 */         f = block.getPlayerRelativeBlockHardness((EntityPlayer)this.thisPlayerMP, this.thisPlayerMP.worldObj, pos);
/*     */       } 
/*     */       
...
/*     */         
/* 221 */         float f = block.getPlayerRelativeBlockHardness((EntityPlayer)this.thisPlayerMP, this.thisPlayerMP.worldObj, pos) * (i + 1);
/*     */         
/* 223 */         if (f >= 0.7F) {
/*     */           
...
/* 255 */     iblockstate.getBlock().onBlockHarvested(this.theWorld, pos, iblockstate, (EntityPlayer)this.thisPlayerMP);
...
/* 271 */     if (this.gameType.isCreative() && this.thisPlayerMP.getHeldItem() != null && this.thisPlayerMP.getHeldItem().getItem() instanceof net.minecraft.item.ItemSword)
/*     */     {
/* 273 */       return false;
/*     */     }
/*     */ 
...
/*     */     } 
/*     */     
/* 303 */     this.theWorld.playAuxSFXAtEntity((EntityPlayer)this.thisPlayerMP, 2001, pos, Block.getStateId(iblockstate));
/* 304 */     boolean flag1 = removeBlock(pos);
/*     */     
/* 306 */     if (isCreative()) {
/*     */       
/* 308 */       this.thisPlayerMP.playerNetServerHandler.sendPacket((Packet)new S23PacketBlockChange(this.theWorld, pos));
/*     */     }
/*     */     else {
/*     */       
...
/*     */         
/* 317 */         itemstack1.onBlockDestroyed(this.theWorld, iblockstate.getBlock(), pos, (EntityPlayer)this.thisPlayerMP);
/*     */         
...
/* 325 */       if (flag1 && flag)
/*     */       {
/* 327 */         iblockstate.getBlock().harvestBlock(this.theWorld, (EntityPlayer)this.thisPlayerMP, pos, iblockstate, tileentity);
/*     */       }
/*     */     } 
/*     */     
/* 331 */     return flag1;
...
/*     */         
/* 397 */         if (ilockablecontainer instanceof net.minecraft.tileentity.TileEntityChest && block instanceof BlockChest)
/*     */         {
...
/*     */         {
/* 404 */           player.displayGUIChest((IInventory)ilockablecontainer);
/* 405 */           return true;
/*     */         }
/*     */       
...
/* 453 */     this.theWorld = (World)serverWorld;
/*     */   }
/*     */ }
