...
/*  23 */   private static final Logger pmLogger = LogManager.getLogger();
...
/*     */ 
/*     */   
/*  39 */   private final int[][] xzDirectionsConst = new int[][] { { 1 }, { 0, 1 }, { -1 }, { 0, -1 } };
/*     */ 
/*     */   
...
/*     */       {
/*  68 */         PlayerInstance playermanager$playerinstance = this.playerInstanceList.get(j);
...
/*     */         
/*  77 */         PlayerInstance playermanager$playerinstance1 = this.playerInstancesToUpdate.get(k);
...
/*  97 */     long i = chunkX + 2147483647L | chunkZ + 2147483647L << 32L;
...
/* 106 */     long i = chunkX + 2147483647L | chunkZ + 2147483647L << 32L;
...
/* 238 */     int i = x1 - x2;
/* 239 */     int j = z1 - z2;
/* 240 */     return (i >= -radius && i <= radius) ? ((j >= -radius && j <= radius)) : false;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 300 */     radius = MathHelper.clamp_int(radius, 3, 32);
/*     */     
...
/*     */         {
/* 394 */           player.playerNetServerHandler.sendPacket((Packet)new S21PacketChunkData(chunk, true, 0));
/*     */         }
/*     */         
...
/*     */           
/* 402 */           long i = this.chunkCoords.chunkXPos + 2147483647L | this.chunkCoords.chunkZPos + 2147483647L << 32L;
...
/*     */         
/* 457 */         EntityPlayerMP entityplayermp = this.playersWatchingChunk.get(i);
/*     */         
...
/* 476 */           sendToAllPlayersWatchingChunk((Packet)new S23PacketBlockChange((World)PlayerManager.this.theWorldServer, blockpos));
/*     */           
...
/* 487 */           sendToAllPlayersWatchingChunk((Packet)new S21PacketChunkData(PlayerManager.this.theWorldServer.getChunkFromChunkCoords(this.chunkCoords.chunkXPos, this.chunkCoords.chunkZPos), false, this.flagsYAreasToUpdate));
/*     */           
...
/*     */               {
/* 498 */                 sendTileToAllPlayersWatchingChunk(list.get(l));
/*     */               }
/*     */             }
/*     */           
/*     */           } 
/*     */         } else {
/*     */           
/* 505 */           sendToAllPlayersWatchingChunk((Packet)new S22PacketMultiBlockChange(this.numBlocksToUpdate, this.locationOfBlockChange, PlayerManager.this.theWorldServer.getChunkFromChunkCoords(this.chunkCoords.chunkXPos, this.chunkCoords.chunkZPos)));
/*     */           
