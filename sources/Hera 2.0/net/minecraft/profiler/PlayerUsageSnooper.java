...
/*     */     try {
/*  39 */       this.serverUrl = new URL("http://snoop.minecraft.net/" + p_i1563_1_ + "?version=" + '\002');
/*     */     }
/*  41 */     catch (MalformedURLException var6) {
/*     */       
...
/*     */                   
/*  69 */                   map = Maps.newHashMap(PlayerUsageSnooper.this.field_152774_b);
/*     */                   
...
/*     */                   }
/*     */                   
/*  76 */                   PlayerUsageSnooper.this.selfCounter = PlayerUsageSnooper.this.selfCounter + 1; map.put("snooper_count", Integer.valueOf(PlayerUsageSnooper.this.selfCounter));
...
/*     */       {
/* 152 */         map.put(entry.getKey(), entry.getValue().toString());
/*     */       }
/*     */       
/* 155 */       for (Map.Entry<String, Object> entry1 : this.field_152774_b.entrySet())
/*     */       {
/* 157 */         map.put(entry1.getKey(), entry1.getValue().toString());
/*     */       }
/*     */       
/* 160 */       return map;
/*     */     } 
