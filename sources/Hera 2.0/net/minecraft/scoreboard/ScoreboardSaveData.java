...
/* 153 */       IScoreObjectiveCriteria iscoreobjectivecriteria = IScoreObjectiveCriteria.INSTANCES.get(nbttagcompound.getString("CriteriaName"));
/*     */       
...
/*     */     else {
/*     */       
/* 205 */       nbt.setTag("Objectives", (NBTBase)objectivesToNbt());
/* 206 */       nbt.setTag("PlayerScores", (NBTBase)scoresToNbt());
/* 207 */       nbt.setTag("Teams", (NBTBase)func_96496_a());
...
/*     */       {
/* 237 */         nbttaglist1.appendTag((NBTBase)new NBTTagString(s));
/*     */       }
/*     */       
/* 240 */       nbttagcompound.setTag("Players", (NBTBase)nbttaglist1);
/* 241 */       nbttaglist.appendTag((NBTBase)nbttagcompound);
/*     */     } 
/*     */     
...
/* 263 */     if (flag)
/*     */     {
/* 265 */       p_96497_1_.setTag("DisplaySlots", (NBTBase)nbttagcompound);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 282 */         nbttaglist.appendTag((NBTBase)nbttagcompound);
/*     */       } 
/*     */     } 
/*     */     
...
/* 302 */         nbttaglist.appendTag((NBTBase)nbttagcompound);
/*     */       } 
/*     */     } 
/*     */     
