...
/* 167 */     nbttagcompound.setTag("buy", (NBTBase)this.itemToBuy.writeToNBT(new NBTTagCompound()));
/* 168 */     nbttagcompound.setTag("sell", (NBTBase)this.itemToSell.writeToNBT(new NBTTagCompound()));
/*     */     
/* 170 */     if (this.secondItemToBuy != null)
/*     */     {
/* 172 */       nbttagcompound.setTag("buyB", (NBTBase)this.secondItemToBuy.writeToNBT(new NBTTagCompound()));
/*     */     }
/*     */     
