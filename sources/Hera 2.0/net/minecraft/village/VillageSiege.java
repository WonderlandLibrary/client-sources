...
/* 100 */     Iterator<EntityPlayer> iterator = list.iterator();
/*     */ 
/*     */     
/*     */     while (true) {
...
/*     */       
/* 111 */       if (!entityplayer.isSpectator()) {
/*     */         
/* 113 */         this.theVillage = this.worldObj.getVillageCollection().getNearestVillage(new BlockPos((Entity)entityplayer), 1);
/*     */         
/* 115 */         if (this.theVillage != null && this.theVillage.getNumVillageDoors() >= 10 && this.theVillage.getTicksSinceLastDoorAdding() >= 20 && this.theVillage.getNumVillagers() >= 20) {
/*     */           
...
/*     */           }
/*     */           
/* 149 */           Vec3 vec3 = func_179867_a(new BlockPos(this.field_75532_g, this.field_75538_h, this.field_75539_i));
/*     */           
/* 151 */           if (vec3 != null) {
/*     */             break;
/*     */           }
...
/*     */     
/*     */     try {
/* 178 */       entityzombie = new EntityZombie(this.worldObj);
/* 179 */       entityzombie.onInitialSpawn(this.worldObj.getDifficultyForLocation(new BlockPos((Entity)entityzombie)), null);
