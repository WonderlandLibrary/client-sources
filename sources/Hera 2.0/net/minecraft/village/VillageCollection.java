...
/*     */       
/*  86 */       Village village = iterator.next();
/*     */       
...
/*     */       
/* 108 */       double d1 = village1.getCenter().distanceSq((Vec3i)doorBlock);
/*     */       
/* 110 */       if (d1 < d0) {
/*     */         
...
/*     */     {
/* 129 */       addDoorsAround(this.villagerPositionsList.remove(0));
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 137 */       VillageDoorInfo villagedoorinfo = this.newDoors.get(i);
...
/* 213 */     EnumFacing enumfacing = BlockDoor.getFacing((IBlockAccess)this.worldObj, doorBlock);
...
/* 263 */     return (block instanceof BlockDoor) ? ((block.getMaterial() == Material.wood)) : false;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     } 
/*     */     
/* 298 */     nbt.setTag("Villages", (NBTBase)nbttaglist);
/*     */   }
/*     */ 
/*     */   
