...
/* 232 */     for (i = (arrayOfEnumEnchantmentType = this.enchantmentTypes).length, b = 0; b < i; ) { EnumEnchantmentType enumenchantmenttype = arrayOfEnumEnchantmentType[b];
/*     */       
...
/* 268 */     for (i = (arrayOfEnchantment = Enchantment.enchantmentsBookList).length, b = 0; b < i; ) { Enchantment enchantment = arrayOfEnchantment[b];
/*     */       
/* 270 */       if (enchantment != null && enchantment.type != null) {
/*     */         
/* 272 */         boolean flag = false;
/*     */         
/* 274 */         for (int j = 0; j < enchantmentType.length && !flag; j++) {
/*     */           
/* 276 */           if (enchantment.type == enchantmentType[j])
/*     */           {
/* 278 */             flag = true;
/*     */           }
/*     */         } 
...
/* 282 */         if (flag)
/*     */         {
/* 284 */           itemList.add(Items.enchanted_book.getEnchantedItemStack(new EnchantmentData(enchantment, enchantment.getMaxLevel())));
/*     */         }
/*     */       } 
/*     */       b++; }
/*     */   
