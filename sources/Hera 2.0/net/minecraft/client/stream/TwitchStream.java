...
/*  55 */   public static final Marker STREAM_MARKER = MarkerManager.getMarker("STREAM");
/*     */   
...
/*  62 */   private final IChatComponent twitchComponent = (IChatComponent)new ChatComponentText("Twitch");
...
/* 217 */       if (flag) {
/*     */         
/* 219 */         FrameBuffer framebuffer = this.broadcastController.func_152822_N();
...
/*     */       byte b; int i; IngestServer[] arrayOfIngestServer;
/* 397 */       for (i = (arrayOfIngestServer = func_152925_v()).length, b = 0; b < i; ) { IngestServer ingestserver = arrayOfIngestServer[b];
/*     */         
...
/* 475 */     this.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion((IChatComponent)new ChatComponentText("Issue streaming frame: " + p_152893_1_ + " (" + ErrorCode.getString(p_152893_1_) + ")"), 2);
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 493 */       ChatComponentTranslation chatComponentTranslation1 = new ChatComponentTranslation("stream.unavailable.soundflower.chat.link", new Object[0]);
/* 494 */       chatComponentTranslation1.getChatStyle().setChatClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://help.mojang.com/customer/portal/articles/1374877-configuring-soundflower-for-streaming-on-apple-computers"));
/* 495 */       chatComponentTranslation1.getChatStyle().setUnderlined(Boolean.valueOf(true));
/* 496 */       ChatComponentTranslation chatComponentTranslation2 = new ChatComponentTranslation("stream.unavailable.soundflower.chat", new Object[] { chatComponentTranslation1 });
/* 497 */       chatComponentTranslation2.getChatStyle().setColor(EnumChatFormatting.DARK_RED);
/* 498 */       this.mc.ingameGUI.getChatGUI().printChatMessage((IChatComponent)chatComponentTranslation2);
/*     */     }
/*     */     else {
/*     */       
/* 502 */       ChatComponentTranslation chatComponentTranslation = new ChatComponentTranslation("stream.unavailable.unknown.chat", new Object[] { ErrorCode.getString(p_152892_1_) });
/* 503 */       chatComponentTranslation.getChatStyle().setColor(EnumChatFormatting.DARK_RED);
/* 504 */       this.mc.ingameGUI.getChatGUI().printChatMessage((IChatComponent)chatComponentTranslation);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 585 */     for (i = (arrayOfChatRawMessage = p_180605_2_).length, b = 0; b < i; ) { ChatRawMessage chatrawmessage = arrayOfChatRawMessage[b];
/*     */       
...
/*     */         
/* 591 */         ChatComponentText chatComponentText1 = new ChatComponentText(chatrawmessage.userName);
/* 592 */         ChatComponentTranslation chatComponentTranslation = new ChatComponentTranslation("chat.stream." + (chatrawmessage.action ? "emote" : "text"), new Object[] { this.twitchComponent, chatComponentText1, EnumChatFormatting.getTextWithoutFormattingCodes(chatrawmessage.message) });
/*     */         
/* 594 */         if (chatrawmessage.action)
/*     */         {
/* 596 */           chatComponentTranslation.getChatStyle().setItalic(Boolean.valueOf(true));
/*     */         }
/*     */         
/* 599 */         ChatComponentText chatComponentText2 = new ChatComponentText("");
/* 600 */         chatComponentText2.appendSibling((IChatComponent)new ChatComponentTranslation("stream.userinfo.chatTooltip", new Object[0]));
/*     */         
/* 602 */         for (IChatComponent ichatcomponent3 : GuiTwitchUserMode.func_152328_a(chatrawmessage.modes, chatrawmessage.subscriptions, null)) {
/*     */           
/* 604 */           chatComponentText2.appendText("\n");
/* 605 */           chatComponentText2.appendSibling(ichatcomponent3);
/*     */         } 
/*     */         
/* 608 */         chatComponentText1.getChatStyle().setChatHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, (IChatComponent)chatComponentText2));
/* 609 */         chatComponentText1.getChatStyle().setChatClickEvent(new ClickEvent(ClickEvent.Action.TWITCH_USER_INFO, chatrawmessage.userName));
/* 610 */         this.mc.ingameGUI.getChatGUI().printChatMessage((IChatComponent)chatComponentTranslation);
/*     */       } 
/*     */       b++; }
/*     */   
/*     */   }
...
/* 621 */     ChatUserInfo chatuserinfo = this.field_152955_g.get(p_176027_1_);
/*     */     
...
/* 642 */     for (i = (arrayOfChatUserInfo = p_176018_3_).length, b = 0; b < i; ) { ChatUserInfo chatuserinfo = arrayOfChatUserInfo[b];
/*     */       
/* 644 */       this.field_152955_g.remove(chatuserinfo.displayName);
/*     */       b++; }
/*     */     
/* 647 */     for (i = (arrayOfChatUserInfo = p_176018_4_).length, b = 0; b < i; ) { ChatUserInfo chatuserinfo1 = arrayOfChatUserInfo[b];
/*     */       
/* 649 */       this.field_152955_g.put(chatuserinfo1.displayName, chatuserinfo1);
/*     */       b++; }
/*     */     
/* 652 */     for (i = (arrayOfChatUserInfo = p_176018_2_).length, b = 0; b < i; ) { ChatUserInfo chatuserinfo2 = arrayOfChatUserInfo[b];
/*     */       
...
/* 701 */     return this.field_152955_g.get(p_152926_1_);
/*     */   }
/*     */ 
/*     */   
...
/*     */   static {
/*     */     try {
/* 748 */       if (Util.getOSType() == Util.EnumOS.WINDOWS) {
/*     */         
