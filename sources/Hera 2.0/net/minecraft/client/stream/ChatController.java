...
/*  39 */   protected HashMap<String, ChatChannelListener> field_175998_i = new HashMap<String, ChatChannelListener>();
...
/*     */ 
/*     */     
/* 148 */     ChatChannelListener chatcontroller$chatchannellistener = this.field_175998_i.get(p_175990_1_);
...
/*     */ 
/*     */     
/* 161 */     ChatChannelListener chatcontroller$chatchannellistener = this.field_175998_i.get(p_175989_1_);
...
/*     */     {
/* 172 */       this.field_175992_e = new Core((CoreAPI)new StandardCoreAPI());
/*     */     }
/*     */     
/* 175 */     this.field_153008_f = new Chat((ChatAPI)new StandardChatAPI());
/*     */   }
/*     */ 
/*     */   
...
/* 199 */     HashSet<ChatTokenizationOption> hashset = new HashSet<ChatTokenizationOption>();
/*     */     
...
/*     */ 
/*     */     
/* 282 */     ChatChannelListener chatcontroller$chatchannellistener = this.field_175998_i.get(p_175991_1_);
...
/*     */ 
/*     */     
/* 363 */     ChatChannelListener chatcontroller$chatchannellistener = this.field_175998_i.get(p_175986_1_);
...
/* 473 */     protected LinkedList<ChatRawMessage> field_176045_e = new LinkedList<ChatRawMessage>();
/* 474 */     protected LinkedList<ChatTokenizedMessage> field_176042_f = new LinkedList<ChatTokenizedMessage>();
...
/*     */         case Connecting:
/*     */         case null:
/* 522 */           errorcode = ChatController.this.field_153008_f.disconnect(this.field_176048_a);
/*     */           
...
/*     */             
/* 565 */             ChatRawMessage chatrawmessage = listiterator.next();
/*     */             
...
/*     */             
/* 580 */             ChatTokenizedMessage chattokenizedmessage = listiterator1.next();
/*     */             
