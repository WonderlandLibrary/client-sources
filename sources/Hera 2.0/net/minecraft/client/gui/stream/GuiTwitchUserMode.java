...
/*     */         
/*  50 */         ChatComponentText chatComponentText = new ChatComponentText("- ");
/*  51 */         chatComponentText.appendSibling(ichatcomponent);
/*  52 */         list.add(chatComponentText);
/*     */       } 
/*     */     } 
/*     */     
...
/*     */         
/*  62 */         ChatComponentText chatComponentText = new ChatComponentText("- ");
/*  63 */         chatComponentText.appendSibling(ichatcomponent2);
/*  64 */         list.add(chatComponentText);
/*     */       } 
/*     */     } 
/*     */     
/*  68 */     return list;
...
/*     */         
/*  83 */         chatComponentTranslation = new ChatComponentTranslation("stream.user.subscription.subscriber.self", new Object[0]);
/*     */       }
/*     */       else {
/*     */         
/*  87 */         chatComponentTranslation = new ChatComponentTranslation("stream.user.subscription.subscriber.other", new Object[] { p_152330_1_ });
/*     */       } 
/*     */       
/*  90 */       chatComponentTranslation.getChatStyle().setColor(field_152331_a);
/*     */     }
/*  92 */     else if (p_152330_0_ == ChatUserSubscription.TTV_CHAT_USERSUB_TURBO) {
/*     */       
/*  94 */       chatComponentTranslation = new ChatComponentTranslation("stream.user.subscription.turbo", new Object[0]);
/*  95 */       chatComponentTranslation.getChatStyle().setColor(field_152336_g);
/*     */     } 
/*     */     
/*  98 */     return (IChatComponent)chatComponentTranslation;
/*     */   }
/*     */   
...
/*     */       
/* 107 */       chatComponentTranslation = new ChatComponentTranslation("stream.user.mode.administrator", new Object[0]);
/* 108 */       chatComponentTranslation.getChatStyle().setColor(field_152336_g);
/*     */     }
/* 110 */     else if (p_152329_0_ == ChatUserMode.TTV_CHAT_USERMODE_BANNED) {
/*     */       
/* 112 */       if (p_152329_1_ == null) {
/*     */         
/* 114 */         chatComponentTranslation = new ChatComponentTranslation("stream.user.mode.banned", new Object[0]);
/*     */       }
/* 116 */       else if (p_152329_2_) {
/*     */         
/* 118 */         chatComponentTranslation = new ChatComponentTranslation("stream.user.mode.banned.self", new Object[0]);
/*     */       }
/*     */       else {
/*     */         
/* 122 */         chatComponentTranslation = new ChatComponentTranslation("stream.user.mode.banned.other", new Object[] { p_152329_1_ });
/*     */       } 
/*     */       
/* 125 */       chatComponentTranslation.getChatStyle().setColor(field_152335_f);
/*     */     }
/* 127 */     else if (p_152329_0_ == ChatUserMode.TTV_CHAT_USERMODE_BROADCASTER) {
/*     */       
/* 129 */       if (p_152329_1_ == null) {
/*     */         
/* 131 */         chatComponentTranslation = new ChatComponentTranslation("stream.user.mode.broadcaster", new Object[0]);
/*     */       }
/* 133 */       else if (p_152329_2_) {
/*     */         
/* 135 */         chatComponentTranslation = new ChatComponentTranslation("stream.user.mode.broadcaster.self", new Object[0]);
/*     */       }
/*     */       else {
/*     */         
/* 139 */         chatComponentTranslation = new ChatComponentTranslation("stream.user.mode.broadcaster.other", new Object[0]);
/*     */       } 
/*     */       
/* 142 */       chatComponentTranslation.getChatStyle().setColor(field_152331_a);
/*     */     }
/* 144 */     else if (p_152329_0_ == ChatUserMode.TTV_CHAT_USERMODE_MODERATOR) {
/*     */       
/* 146 */       if (p_152329_1_ == null) {
/*     */         
/* 148 */         chatComponentTranslation = new ChatComponentTranslation("stream.user.mode.moderator", new Object[0]);
/*     */       }
/* 150 */       else if (p_152329_2_) {
/*     */         
/* 152 */         chatComponentTranslation = new ChatComponentTranslation("stream.user.mode.moderator.self", new Object[0]);
/*     */       }
/*     */       else {
/*     */         
/* 156 */         chatComponentTranslation = new ChatComponentTranslation("stream.user.mode.moderator.other", new Object[] { p_152329_1_ });
/*     */       } 
/*     */       
/* 159 */       chatComponentTranslation.getChatStyle().setColor(field_152331_a);
/*     */     }
/* 161 */     else if (p_152329_0_ == ChatUserMode.TTV_CHAT_USERMODE_STAFF) {
/*     */       
/* 163 */       chatComponentTranslation = new ChatComponentTranslation("stream.user.mode.staff", new Object[0]);
/* 164 */       chatComponentTranslation.getChatStyle().setColor(field_152336_g);
/*     */     } 
/*     */     
/* 167 */     return (IChatComponent)chatComponentTranslation;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   public void initGui() {
/* 176 */     int i = this.width / 3;
/* 177 */     int j = i - 130;
/* 178 */     this.buttonList.add(new GuiButton(1, i * 0 + j / 2, this.height - 70, 130, 20, I18n.format("stream.userinfo.timeout", new Object[0])));
/* 179 */     this.buttonList.add(new GuiButton(0, i * 1 + j / 2, this.height - 70, 130, 20, I18n.format("stream.userinfo.ban", new Object[0])));
/* 180 */     this.buttonList.add(new GuiButton(2, i * 2 + j / 2, this.height - 70, 130, 20, I18n.format("stream.userinfo.mod", new Object[0])));
/* 181 */     this.buttonList.add(new GuiButton(5, i * 0 + j / 2, this.height - 45, 130, 20, I18n.format("gui.cancel", new Object[0])));
/* 182 */     this.buttonList.add(new GuiButton(3, i * 1 + j / 2, this.height - 45, 130, 20, I18n.format("stream.userinfo.unban", new Object[0])));
/* 183 */     this.buttonList.add(new GuiButton(4, i * 2 + j / 2, this.height - 45, 130, 20, I18n.format("stream.userinfo.unmod", new Object[0])));
/* 184 */     int k = 0;
/*     */     
...
/*     */     }
/*     */     
/* 191 */     this.field_152334_t = this.width / 2 - k / 2;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 232 */     drawCenteredString(this.fontRendererObj, this.field_152338_i.getUnformattedText(), this.width / 2, 70, 16777215);
/* 233 */     int i = 80;
/*     */     
