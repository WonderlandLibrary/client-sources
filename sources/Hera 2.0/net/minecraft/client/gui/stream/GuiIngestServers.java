...
/*     */     }
/*     */     
/*  38 */     this.buttonList.add(new GuiButton(1, this.width / 2 - 155, this.height - 24 - 6, 150, 20, I18n.format("gui.done", new Object[0])));
/*  39 */     this.buttonList.add(new GuiButton(2, this.width / 2 + 5, this.height - 24 - 6, 150, 20, I18n.format("options.stream.ingest.reset", new Object[0])));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  88 */     drawCenteredString(this.fontRendererObj, this.field_152310_f, this.width / 2, 20, 16777215);
...
/*  96 */       super(mcIn, GuiIngestServers.this.width, GuiIngestServers.this.height, 32, GuiIngestServers.this.height - 35, (int)(mcIn.fontRendererObj.FONT_HEIGHT * 3.5D));
...
/* 124 */       String s1 = String.valueOf((int)ingestserver.bitrateKbps) + " kbps";
/* 125 */       String s2 = null;
...
/* 133 */           s1 = String.valueOf((int)(ingestservertester.func_153030_h() * 100.0F)) + "%";
/*     */         }
