...
/*  86 */     MerchantRecipeList merchantrecipelist = this.merchant.getRecipes((EntityPlayer)this.mc.thePlayer);
/*     */     
...
/* 105 */       MerchantRecipeList merchantrecipelist = this.merchant.getRecipes((EntityPlayer)this.mc.thePlayer);
/*     */       
...
/* 131 */       this.mc.getNetHandler().addToSendQueue((Packet)new C17PacketCustomPayload("MC|TrSel", packetbuffer));
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 145 */     MerchantRecipeList merchantrecipelist = this.merchant.getRecipes((EntityPlayer)this.mc.thePlayer);
/*     */     
...
/* 175 */     MerchantRecipeList merchantrecipelist = this.merchant.getRecipes((EntityPlayer)this.mc.thePlayer);
/*     */     
