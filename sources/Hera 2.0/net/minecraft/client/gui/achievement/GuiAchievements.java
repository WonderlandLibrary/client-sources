...
/*  67 */     this.buttonList.add(new GuiOptionButton(1, this.width / 2 + 24, this.height / 2 + 74, 80, 20, I18n.format("gui.done", new Object[0])));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 109 */       drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), this.width / 2, this.height / 2, 16777215);
/* 110 */       drawCenteredString(this.fontRendererObj, lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % lanSearchStates.length)], this.width / 2, this.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
/*     */     }
/*     */     else {
/*     */       
/* 114 */       if (Mouse.isButtonDown(0)) {
/*     */         
/* 116 */         int i = (this.width - this.field_146555_f) / 2;
/* 117 */         int j = (this.height - this.field_146557_g) / 2;
/* 118 */         int k = i + 8;
/* 119 */         int l = j + 17;
/*     */         
...
/* 236 */     int i = (this.width - this.field_146555_f) / 2;
/* 237 */     int j = (this.height - this.field_146557_g) / 2;
...
/*     */     }
/*     */     
/* 266 */     int k = (this.width - this.field_146555_f) / 2;
/* 267 */     int l = (this.height - this.field_146557_g) / 2;
/* 268 */     int i1 = k + 16;
/* 269 */     int j1 = l + 17;
...
/* 301 */         TextureAtlasSprite textureatlassprite = func_175371_a((Block)Blocks.sand);
/*     */         
...
/*     */         } 
/*     */         
/* 339 */         this.mc.getTextureManager().bindTexture(TextureMap.locationBlocksTexture);
...
/*     */       
/* 350 */       Achievement achievement1 = AchievementList.achievementList.get(j5);
/*     */       
...
/*     */       
/* 408 */       Achievement achievement2 = AchievementList.achievementList.get(i6);
...
/* 545 */       if (s != null)
/*     */       {
/* 547 */         this.fontRendererObj.drawStringWithShadow(s, i7, k7, this.statFileWriter.canUnlockAchievement(achievement) ? (achievement.getSpecial() ? -128 : -1) : (achievement.getSpecial() ? -8355776 : -8355712));
/*     */       }
/*     */     } 
/*     */     
