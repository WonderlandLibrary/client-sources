...
/*     */     
/*     */     int j4;
/*  94 */     for (j4 = 1; i4 > 20; i4 = (l3 + j4 - 1) / j4)
/*     */     {
/*  96 */       j4++;
/*     */     }
/*     */     
...
/* 145 */     if (list1 != null) {
/*     */       
/* 147 */       drawRect(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + list1.size() * this.mc.fontRendererObj.FONT_HEIGHT, -2147483648);
/*     */       
...
/*     */     } 
/*     */     
/* 159 */     drawRect(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + i4 * 9, -2147483648);
/*     */     
...
/* 173 */       if (k4 < list.size()) {
/*     */         
/* 175 */         NetworkPlayerInfo networkplayerinfo1 = list.get(k4);
...
/* 182 */           boolean flag1 = (entityplayer != null && entityplayer.isWearing(EnumPlayerModelParts.CAPE) && (gameprofile.getName().equals("Dinnerbone") || gameprofile.getName().equals("Grumm")));
...
/*     */           
/* 188 */           if (entityplayer != null && entityplayer.isWearing(EnumPlayerModelParts.HAT)) {
/*     */             
...
/*     */       
/* 225 */       k1 = k1 + i4 * 9 + 1;
/* 226 */       drawRect(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + list2.size() * this.mc.fontRendererObj.FONT_HEIGHT, -2147483648);
/*     */       
...
/* 352 */           float f2 = i / 2.0F;
/*     */           
/* 354 */           if (p_175247_5_ - this.mc.fontRendererObj.getStringWidth(String.valueOf(f2) + "hp") >= p_175247_4_)
/*     */           {
/* 356 */             str = String.valueOf(f2) + "hp";
/*     */           }
/*     */           
/* 359 */           this.mc.fontRendererObj.drawStringWithShadow(str, ((p_175247_5_ + p_175247_4_) / 2 - this.mc.fontRendererObj.getStringWidth(str) / 2), p_175247_2_, i1);
/*     */         }
/*     */       
/*     */       } 
/*     */     } else {
