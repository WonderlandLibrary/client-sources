...
/*  69 */     this.fontRendererObj.drawString(this.field_175380_I.getDisplayName().getUnformattedText(), 12, 5, 4210752);
...
/*     */       
/*  96 */       if (l >= 0 && i1 >= 0 && l < 108 && i1 < 19 && this.container.enchantItem((EntityPlayer)this.mc.thePlayer, k))
/*     */       {
...
/*     */         
/* 246 */         List<String> list = Lists.newArrayList();
/*     */         
...
/* 251 */           list.add(String.valueOf(EnumChatFormatting.WHITE.toString()) + EnumChatFormatting.ITALIC.toString() + I18n.format("container.enchant.clue", new Object[] { s }));
/*     */         } 
/*     */         
/* 254 */         if (!flag) {
/*     */           
...
/*     */             
/* 263 */             list.add(String.valueOf(EnumChatFormatting.RED.toString()) + "Level Requirement: " + this.container.enchantLevels[j]);
/*     */           }
/*     */           else {
/*     */             
/* 267 */             String s1 = "";
...
/* 278 */             if (i >= i1) {
/*     */               
/* 280 */               list.add(String.valueOf(EnumChatFormatting.GRAY.toString()) + s1);
/*     */             }
/*     */             else {
/*     */               
/* 284 */               list.add(String.valueOf(EnumChatFormatting.RED.toString()) + s1);
/*     */             } 
/*     */             
/* 287 */             if (i1 == 1) {
/*     */               
...
/*     */             } 
/*     */             
/* 296 */             list.add(String.valueOf(EnumChatFormatting.GRAY.toString()) + s1);
/*     */           } 
/*     */         } 
/*     */         
