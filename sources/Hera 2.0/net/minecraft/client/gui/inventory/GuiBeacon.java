...
/*     */         
/*  69 */         int i1 = (TileEntityBeacon.effectsList[l]).length;
/*  70 */         int j1 = i1 * 22 + (i1 - 1) * 2;
/*     */         
/*  72 */         for (int k1 = 0; k1 < i1; k1++) {
/*     */           
/*  74 */           int l1 = (TileEntityBeacon.effectsList[l][k1]).id;
...
/*     */       
/*  89 */       int i2 = 3;
/*  90 */       int j2 = (TileEntityBeacon.effectsList[i2]).length + 1;
/*  91 */       int k2 = j2 * 22 + (j2 - 1) * 2;
/*     */       
/*  93 */       for (int l2 = 0; l2 < j2 - 1; l2++) {
/*     */         
/*  95 */         int i3 = (TileEntityBeacon.effectsList[i2][l2]).id;
...
/* 143 */       this.mc.getNetHandler().addToSendQueue((Packet)new C17PacketCustomPayload(s, packetbuffer));
...
/* 200 */     int i = (this.width - this.xSize) / 2;
/* 201 */     int j = (this.height - this.ySize) / 2;
...
/* 220 */       super(p_i1077_1_, p_i1077_2_, p_i1077_3_, 22, 22, "");
...
/* 275 */       super(p_i1074_2_, p_i1074_3_, p_i1074_4_, GuiBeacon.beaconGuiTextures, 112, 220);
/*     */     }
/*     */ 
/*     */     
...
/* 288 */       super(p_i1075_2_, p_i1075_3_, p_i1075_4_, GuiBeacon.beaconGuiTextures, 90, 220);
/*     */     }
/*     */ 
/*     */     
/*     */     public void drawButtonForegroundLayer(int mouseX, int mouseY) {
...
/* 304 */       super(p_i1076_2_, p_i1076_3_, p_i1076_4_, GuiContainer.inventoryBackground, 0 + Potion.potionTypes[p_i1076_5_].getStatusIconIndex() % 8 * 18, 198 + Potion.potionTypes[p_i1076_5_].getStatusIconIndex() / 8 * 18);
