...
/*      */     {
/*   76 */       this.mc.displayGuiScreen((GuiScreen)new GuiInventory((EntityPlayer)this.mc.thePlayer));
/*      */     }
/*      */     
...
/*   89 */     clickType = (slotId == -999 && clickType == 0) ? 4 : clickType;
/*      */     
...
/*      */       else
/*      */       {
/*  144 */         this.mc.thePlayer.inventoryContainer.slotClick((slotIn == null) ? slotId : ((CreativeSlot)slotIn).slot.slotNumber, clickedButton, clickType, (EntityPlayer)this.mc.thePlayer);
...
/*      */     } else {
/*      */       
/*  231 */       this.inventorySlots.slotClick((slotIn == null) ? slotId : slotIn.slotNumber, clickedButton, clickType, (EntityPlayer)this.mc.thePlayer);
/*      */       
...
/*      */     else {
/*      */       
/*  283 */       this.mc.displayGuiScreen((GuiScreen)new GuiInventory((EntityPlayer)this.mc.thePlayer));
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*  354 */     for (i = (arrayOfEnchantment = Enchantment.enchantmentsBookList).length, b = 0; b < i; ) { Enchantment enchantment = arrayOfEnchantment[b];
/*      */       
...
/*      */       
/*  367 */       ItemStack itemstack = iterator.next();
/*  368 */       boolean flag = false;
/*      */       
/*  370 */       for (String s : itemstack.getTooltip((EntityPlayer)this.mc.thePlayer, this.mc.gameSettings.advancedItemTooltips)) {
/*      */         
...
/*  399 */       this.fontRendererObj.drawString(I18n.format(creativetabs.getTranslatedTabLabel(), new Object[0]), 8, 6, 4210752);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*  411 */       int j = mouseY - this.guiTop; byte b; int k;
/*      */       CreativeTabs[] arrayOfCreativeTabs;
/*  413 */       for (k = (arrayOfCreativeTabs = CreativeTabs.creativeTabArray).length, b = 0; b < k; ) { CreativeTabs creativetabs = arrayOfCreativeTabs[b];
/*      */         
...
/*  433 */       int j = mouseY - this.guiTop; byte b; int k;
/*      */       CreativeTabs[] arrayOfCreativeTabs;
/*  435 */       for (k = (arrayOfCreativeTabs = CreativeTabs.creativeTabArray).length, b = 0; b < k; ) { CreativeTabs creativetabs = arrayOfCreativeTabs[b];
/*      */         
...
/*      */       }
/*      */       
/*  474 */       guicontainercreative$containercreative.inventorySlots = Lists.newArrayList();
/*      */       
/*  476 */       for (int j = 0; j < container.inventorySlots.size(); j++) {
/*      */         
/*  478 */         Slot slot = new CreativeSlot(container.inventorySlots.get(j), j);
...
/*  489 */         else if (j >= 0 && j < 5) {
/*      */           
/*  491 */           slot.yDisplayPosition = -2000;
/*  492 */           slot.xDisplayPosition = -2000;
/*      */         }
...
/*      */       } 
/*      */       
/*  512 */       this.field_147064_C = new Slot((IInventory)field_147060_v, 0, 173, 112);
...
/*  549 */     int i = Mouse.getEventDWheel();
/*      */     
...
/*  576 */     boolean flag = Mouse.isButtonDown(0);
...
/*      */     } 
/*      */     
/*  603 */     super.drawScreen(mouseX, mouseY, partialTicks); byte b; int m;
/*      */     CreativeTabs[] arrayOfCreativeTabs;
/*  605 */     for (m = (arrayOfCreativeTabs = CreativeTabs.creativeTabArray).length, b = 0; b < m; ) { CreativeTabs creativetabs = arrayOfCreativeTabs[b];
/*      */       
...
/*      */       
/*  626 */       List<String> list = stack.getTooltip((EntityPlayer)this.mc.thePlayer, this.mc.gameSettings.advancedItemTooltips);
/*  627 */       CreativeTabs creativetabs = stack.getItem().getCreativeTab();
/*      */       
/*  629 */       if (creativetabs == null && stack.getItem() == Items.enchanted_book) {
/*      */         
/*  631 */         Map<Integer, Integer> map = EnchantmentHelper.getEnchantments(stack);
/*      */         
/*  633 */         if (map.size() == 1) {
/*      */           
/*  635 */           Enchantment enchantment = Enchantment.getEnchantmentById(((Integer)map.keySet().iterator().next()).intValue()); byte b; int j;
/*      */           CreativeTabs[] arrayOfCreativeTabs;
/*  637 */           for (j = (arrayOfCreativeTabs = CreativeTabs.creativeTabArray).length, b = 0; b < j; ) { CreativeTabs creativetabs1 = arrayOfCreativeTabs[b];
/*      */             
...
/*  680 */     CreativeTabs creativetabs = CreativeTabs.creativeTabArray[selectedTabIndex]; byte b; int m;
/*      */     CreativeTabs[] arrayOfCreativeTabs;
/*  682 */     for (m = (arrayOfCreativeTabs = CreativeTabs.creativeTabArray).length, b = 0; b < m; ) { CreativeTabs creativetabs1 = arrayOfCreativeTabs[b];
/*      */       
...
/*      */     {
/*  703 */       drawTexturedModalRect(i, j + (int)((k - j - 17) * this.currentScroll), 232 + (needsScrollBars() ? 0 : 12), 0, 12, 15);
/*      */     }
/*      */     
...
/*      */     {
/*  710 */       GuiInventory.drawEntityOnScreen(this.guiLeft + 43, this.guiTop + 45, 20, (this.guiLeft + 43 - mouseX), (this.guiTop + 45 - 30 - mouseY), (EntityLivingBase)this.mc.thePlayer);
/*      */     }
/*      */   }
/*      */ 
/*      */   
