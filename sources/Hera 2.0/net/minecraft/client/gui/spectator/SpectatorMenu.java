...
/*  50 */     return (this.field_178658_j > 0 && p_178643_1_ == 0) ? field_178656_c : ((p_178643_1_ == 7) ? ((i < this.field_178659_h.func_178669_a().size()) ? field_178653_d : field_178654_e) : ((p_178643_1_ == 8) ? field_178655_b : ((i >= 0 && i < this.field_178659_h.func_178669_a().size()) ? (ISpectatorMenuObject)Objects.firstNonNull(this.field_178659_h.func_178669_a().get(i), field_178657_a) : field_178657_a)));
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/*     */     public IChatComponent getSpectatorName() {
/* 128 */       return (IChatComponent)new ChatComponentText("Close menu");
/*     */     }
/*     */ 
/*     */     
/*     */     public void func_178663_a(float p_178663_1_, int alpha) {
...
/*     */     
/*     */     public IChatComponent getSpectatorName() {
/* 161 */       return (this.field_178666_a < 0) ? (IChatComponent)new ChatComponentText("Previous Page") : (IChatComponent)new ChatComponentText("Next Page");
/*     */     }
/*     */ 
/*     */     
/*     */     public void func_178663_a(float p_178663_1_, int alpha) {
