...
/*  41 */     int i = CustomColorizer.getFluidColor((Block)blockliquid, blockAccess, blockPosIn);
...
/*     */     
/*  54 */     if (!flag && !flag1 && !aboolean[0] && !aboolean[1] && !aboolean[2] && !aboolean[3])
/*     */     {
/*  56 */       return false;
/*     */     }
/*     */ 
...
/* 100 */       if (f12 < -999.0F) {
/*     */         
/* 102 */         f13 = textureatlassprite.getInterpolatedU(0.0D);
/* 103 */         f17 = textureatlassprite.getInterpolatedV(0.0D);
/* 104 */         f14 = f13;
/* 105 */         f19 = textureatlassprite.getInterpolatedV(16.0D);
/* 106 */         f15 = textureatlassprite.getInterpolatedU(16.0D);
/* 107 */         f20 = f19;
/* 108 */         f16 = f15;
/* 109 */         f21 = f17;
/*     */       }
...
/*     */       } else {
/*     */         
/* 293 */         int k = ((Integer)iblockstate.getValue((IProperty)BlockLiquid.LEVEL)).intValue();
/*     */         
/* 295 */         if (k >= 8 || k == 0) {
/*     */           
