...
/*     */     }
/*     */     
/*  44 */     Object object = this.mapTextureObjects.get(resource);
/*     */     
/*  46 */     if (object == null) {
/*     */       
...
/* 150 */     Iterator<ResourceLocation> iterator = this.mapTextureObjects.keySet().iterator();
/*     */     
/* 152 */     while (iterator.hasNext()) {
/*     */       
/* 154 */       ResourceLocation resourcelocation = iterator.next();
/*     */       
/* 156 */       if (resourcelocation.getResourcePath().startsWith("mcpatcher/")) {
/*     */         
/* 158 */         ITextureObject itextureobject = (ITextureObject)this.mapTextureObjects.get(resourcelocation);
/*     */         
