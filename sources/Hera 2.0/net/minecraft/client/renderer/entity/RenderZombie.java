...
/*    */         {
/* 36 */           this.field_177189_c = (ModelBase)new ModelZombie(0.5F, true);
/* 37 */           this.field_177186_d = (ModelBase)new ModelZombie(1.0F, true);
/*    */         }
/*    */       };
...
/*    */       
/* 78 */       this.mainModel = (ModelBase)this.zombieVillagerModel;
/* 79 */       this.layerRenderers = this.field_177121_n;
/*    */     }
/*    */     else {
/*    */       
/* 83 */       this.mainModel = (ModelBase)this.field_82434_o;
...
/*    */     {
/* 94 */       p_77043_3_ += (float)(Math.cos(bat.ticksExisted * 3.25D) * Math.PI * 0.25D);
/*    */     }
/*    */     
