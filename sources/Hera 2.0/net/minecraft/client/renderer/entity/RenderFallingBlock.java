...
/* 39 */       BlockPos blockpos = new BlockPos((Entity)entity);
...
/* 57 */           IBakedModel ibakedmodel = blockrendererdispatcher.getModelFromBlockState(iblockstate, (IBlockAccess)world, null);
/* 58 */           blockrendererdispatcher.getBlockModelRenderer().renderModel((IBlockAccess)world, ibakedmodel, iblockstate, blockpos, worldrenderer, false);
