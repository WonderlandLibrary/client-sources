...
/*  44 */     float f5 = 0.5F;
/*  45 */     float f6 = 0.5F;
/*  46 */     GlStateManager.rotate(180.0F - this.renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
/*  47 */     GlStateManager.rotate(-this.renderManager.playerViewX, 1.0F, 0.0F, 0.0F);
...
/*     */       
/*  71 */       if ((this.renderManager.options != null && this.renderManager.options.thirdPersonView > 0) || entity.angler != (Minecraft.getMinecraft()).thePlayer) {
/*     */         
