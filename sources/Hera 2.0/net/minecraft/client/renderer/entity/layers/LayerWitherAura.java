...
/* 39 */       this.witherModel.setLivingAnimations((EntityLivingBase)entitylivingbaseIn, p_177141_2_, p_177141_3_, partialTicks);
/* 40 */       this.witherModel.setModelAttributes(this.witherRenderer.getMainModel());
/* 41 */       this.witherModel.render((Entity)entitylivingbaseIn, p_177141_2_, p_177141_3_, p_177141_5_, p_177141_6_, p_177141_7_, scale);
