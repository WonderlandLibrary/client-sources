...
/*     */       }
/*     */       
/*  47 */       boolean flag = !(!(entitylivingbaseIn instanceof net.minecraft.entity.passive.EntityVillager) && (!(entitylivingbaseIn instanceof EntityZombie) || !((EntityZombie)entitylivingbaseIn).isVillager()));
/*     */       
...
/*     */       
/*  60 */       if (item instanceof net.minecraft.item.ItemBlock) {
/*     */         
/*  62 */         float f2 = 0.625F;
...
/* 101 */               nbttagcompound.setTag("SkullOwner", (NBTBase)NBTUtil.writeGameProfile(new NBTTagCompound(), gameprofile));
/*     */             } 
/*     */           } 
/*     */         } 
/*     */         
