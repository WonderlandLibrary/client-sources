...
/*     */       
/*  76 */       this.mainModel = (ModelBase)new ModelGuardian();
...
/* 104 */       Vec3 vec31 = func_177110_a((EntityLivingBase)entity, f4, partialTicks);
...
/* 129 */       double d12 = 0.0D + Math.cos(d1 + Math.PI) * d2;
/* 130 */       double d13 = 0.0D + Math.sin(d1 + Math.PI) * d2;
