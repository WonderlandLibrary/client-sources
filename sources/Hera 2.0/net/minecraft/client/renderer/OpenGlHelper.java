...
/*     */       
/* 110 */       logText = String.valueOf(logText) + "Using ARB_multitexture.\n";
...
/*     */     else {
/*     */       
/* 117 */       logText = String.valueOf(logText) + "Using GL 1.3 multitexturing.\n";
...
/*     */       
/* 125 */       logText = String.valueOf(logText) + "Using ARB_texture_env_combine.\n";
...
/*     */     else {
/*     */       
/* 148 */       logText = String.valueOf(logText) + "Using GL 1.3 texture combiners.\n";
...
/*     */       
/* 176 */       logText = String.valueOf(logText) + "Using framebuffer objects because ";
/*     */       
/* 178 */       if (contextcapabilities.OpenGL30)
/*     */       {
/* 180 */         logText = String.valueOf(logText) + "OpenGL 3.0 is supported and separate blending is supported.\n";
...
/*     */       {
/* 194 */         logText = String.valueOf(logText) + "ARB_framebuffer_object is supported and separate blending is supported.\n";
...
/*     */       {
/* 208 */         logText = String.valueOf(logText) + "EXT_framebuffer_object is supported.\n";
...
/*     */     } else {
/*     */       
/* 223 */       logText = String.valueOf(logText) + "Not using framebuffer objects because ";
/* 224 */       logText = String.valueOf(logText) + "OpenGL 1.4 is " + (contextcapabilities.OpenGL14 ? "" : "not ") + "supported, ";
/* 225 */       logText = String.valueOf(logText) + "EXT_blend_func_separate is " + (contextcapabilities.GL_EXT_blend_func_separate ? "" : "not ") + "supported, ";
/* 226 */       logText = String.valueOf(logText) + "OpenGL 3.0 is " + (contextcapabilities.OpenGL30 ? "" : "not ") + "supported, ";
/* 227 */       logText = String.valueOf(logText) + "ARB_framebuffer_object is " + (contextcapabilities.GL_ARB_framebuffer_object ? "" : "not ") + "supported, and ";
/* 228 */       logText = String.valueOf(logText) + "EXT_framebuffer_object is " + (contextcapabilities.GL_EXT_framebuffer_object ? "" : "not ") + "supported.\n";
/*     */     } 
/*     */     
...
/* 233 */     logText = String.valueOf(logText) + "Shaders are " + (shadersAvailable ? "" : "not ") + "available because ";
/*     */     
/* 235 */     if (shadersAvailable) {
/*     */       
/* 237 */       if (contextcapabilities.OpenGL21)
/*     */       {
/* 239 */         logText = String.valueOf(logText) + "OpenGL 2.1 is supported.\n";
...
/*     */       else
/*     */       {
/* 248 */         logText = String.valueOf(logText) + "ARB_shader_objects, ARB_vertex_shader, and ARB_fragment_shader are supported.\n";
/* 249 */         arbShaders = true;
...
/*     */     } else {
/*     */       
/* 258 */       logText = String.valueOf(logText) + "OpenGL 2.1 is " + (contextcapabilities.OpenGL21 ? "" : "not ") + "supported, ";
/* 259 */       logText = String.valueOf(logText) + "ARB_shader_objects is " + (contextcapabilities.GL_ARB_shader_objects ? "" : "not ") + "supported, ";
/* 260 */       logText = String.valueOf(logText) + "ARB_vertex_shader is " + (contextcapabilities.GL_ARB_vertex_shader ? "" : "not ") + "supported, and ";
/* 261 */       logText = String.valueOf(logText) + "ARB_fragment_shader is " + (contextcapabilities.GL_ARB_fragment_shader ? "" : "not ") + "supported.\n";
/*     */     } 
/*     */     
...
/* 269 */     logText = String.valueOf(logText) + "VBOs are " + (vboSupported ? "" : "not ") + "available because ";
/*     */     
/* 271 */     if (vboSupported)
/*     */     {
/* 273 */       if (arbVbo) {
/*     */         
/* 275 */         logText = String.valueOf(logText) + "ARB_vertex_buffer_object is supported.\n";
/* 276 */         GL_STATIC_DRAW = 35044;
/* 277 */         GL_ARRAY_BUFFER = 34962;
/*     */       }
/*     */       else {
/*     */         
/* 281 */         logText = String.valueOf(logText) + "OpenGL 1.5 is supported.\n";
...
/* 636 */     return Config.isMultiTexture() ? false : ((vboSupported && (Minecraft.getMinecraft()).gameSettings.useVbo));
/*     */   }
/*     */ 
/*     */   
...
/* 929 */     return Config.isFastRender() ? false : ((Config.getAntialiasingLevel() > 0) ? false : ((framebufferSupported && (Minecraft.getMinecraft()).gameSettings.fboEnable)));
/*     */   }
/*     */ 
/*     */   
