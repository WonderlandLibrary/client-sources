...
/*     */ {
/*  15 */   public static final List<String> LAYERS = Lists.newArrayList((Object[])new String[] { "layer0", "layer1", "layer2", "layer3", "layer4" });
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/*  43 */     map.put("particle", blockModel.isTexturePresent("particle") ? blockModel.resolveTextureName("particle") : map.get("layer0"));
...
/* 238 */     return (p_178391_2_ >= 0 && p_178391_3_ >= 0 && p_178391_2_ < p_178391_4_ && p_178391_3_ < p_178391_5_) ? (((p_178391_1_[p_178391_3_ * p_178391_4_ + p_178391_2_] >> 24 & 0xFF) == 0)) : true;
/*     */   }
/*     */ 
/*     */   
/*     */   static class Span
...
/*     */   enum SpanFacing
/*     */   {
/* 291 */     UP((String)EnumFacing.UP, 0, -1),
/* 292 */     DOWN((String)EnumFacing.DOWN, 0, 1),
/* 293 */     LEFT((String)EnumFacing.EAST, -1, 0),
/* 294 */     RIGHT((String)EnumFacing.WEST, 1, 0);
/*     */     
