...
/*     */     {
/*  98 */       this.parent = p_178299_1_.get(this.parentLocation);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*     */     {
/* 111 */       textureName = String.valueOf('#') + textureName;
/*     */     }
/*     */     
...
/*     */ 
/*     */       
/* 128 */       String s = this.textures.get(textureName.substring(1));
/*     */       
...
/*     */       }
/* 197 */       catch (NullPointerException nullPointerException) {}
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 242 */         itemcameratransforms = (ItemCameraTransforms)p_deserialize_3_.deserialize((JsonElement)jsonobject1, ItemCameraTransforms.class);
/*     */       } 
/*     */       
...
/*     */         
/* 257 */         for (Map.Entry<String, JsonElement> entry : (Iterable<Map.Entry<String, JsonElement>>)jsonobject.entrySet())
/*     */         {
/* 259 */           map.put(entry.getKey(), ((JsonElement)entry.getValue()).getAsString());
/*     */         }
/*     */       } 
/*     */       
/* 263 */       return map;
