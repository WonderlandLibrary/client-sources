...
/*     */       
/*  40 */       float[] afloat = getFaceUvs(entry.getKey());
...
/*     */ 
/*     */         
/*  67 */         return afloat;case NORTH: case SOUTH: afloat = new float[] { this.positionFrom.x, 16.0F - this.positionTo.y, this.positionTo.x, 16.0F - this.positionFrom.y }; return afloat;case WEST: case EAST: afloat = new float[] { this.positionFrom.z, 16.0F - this.positionTo.y, this.positionTo.z, 16.0F - this.positionFrom.y }; return afloat;
/*     */     } 
...
/*     */       
/* 157 */       for (Map.Entry<String, JsonElement> entry : (Iterable<Map.Entry<String, JsonElement>>)jsonobject.entrySet()) {
/*     */         
/* 159 */         EnumFacing enumfacing = parseEnumFacing(entry.getKey());
/* 160 */         map.put(enumfacing, (BlockPartFace)p_178253_1_.deserialize(entry.getValue(), BlockPartFace.class));
/*     */       } 
/*     */       
/* 163 */       return map;
/*     */     }
...
/*     */       {
/* 222 */         afloat[i] = JsonUtils.getFloat(jsonarray.get(i), String.valueOf(p_178251_2_) + "[" + i + "]");
/*     */       }
/*     */       
