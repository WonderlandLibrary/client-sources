...
/*    */   extends ChunkCache {
/* 15 */   private static final IBlockState DEFAULT_STATE = Blocks.air.getDefaultState();
/*    */   
...
/* 23 */     this.position = posFromIn.subtract(new Vec3i(subIn, subIn, subIn));
/* 24 */     int i = 8000;
/* 25 */     this.combinedLights = new int[8000];
/* 26 */     Arrays.fill(this.combinedLights, -1);
/* 27 */     this.blockStates = new IBlockState[8000];
/*    */   }
/*    */ 
/*    */   
