...
/* 122 */         MapData mapdata = Items.filled_map.getMapData(entityitem.getEntityItem(), itemFrame.worldObj);
...
/* 165 */         this.itemRenderer.func_181564_a(entityitem.getEntityItem(), ItemCameraTransforms.TransformType.FIXED);
...
/* 199 */           GlStateManager.rotate(-this.renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
/* 200 */           GlStateManager.rotate(this.renderManager.playerViewX, 1.0F, 0.0F, 0.0F);
...
/* 219 */           fontrenderer.drawString(s, -fontrenderer.getStringWidth(s) / 2, 0, 553648127);
...
/*     */         else {
/*     */           
/* 227 */           renderLivingLabel((Entity)entity, s, x, y, z, 64);
/*     */         } 
/*     */       } 
/*     */     } 
/*     */   }
