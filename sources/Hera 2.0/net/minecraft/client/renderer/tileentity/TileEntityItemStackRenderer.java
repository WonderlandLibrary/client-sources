...
/* 32 */       TileEntityRendererDispatcher.instance.renderTileEntityAt((TileEntity)this.banner, 0.0D, 0.0D, 0.0D, 0.0F);
/*    */     }
...
/* 51 */           nbttagcompound.setTag("SkullOwner", (NBTBase)NBTUtil.writeGameProfile(new NBTTagCompound(), gameprofile));
/*    */         } 
/*    */       } 
/*    */       
...
/*    */         
/* 72 */         TileEntityRendererDispatcher.instance.renderTileEntityAt((TileEntity)this.enderChest, 0.0D, 0.0D, 0.0D, 0.0F);
/*    */       }
/* 74 */       else if (block == Blocks.trapped_chest) {
/*    */         
/* 76 */         TileEntityRendererDispatcher.instance.renderTileEntityAt((TileEntity)this.field_147718_c, 0.0D, 0.0D, 0.0D, 0.0F);
/*    */       }
/*    */       else {
/*    */         
/* 80 */         TileEntityRendererDispatcher.instance.renderTileEntityAt((TileEntity)this.field_147717_b, 0.0D, 0.0D, 0.0D, 0.0F);
/*    */       } 
/*    */     } 
/*    */   }
/*    */ }
