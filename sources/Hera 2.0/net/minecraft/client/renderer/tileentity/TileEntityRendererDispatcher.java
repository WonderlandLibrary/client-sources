...
/*  71 */     TileEntitySpecialRenderer<? extends TileEntity> tileentityspecialrenderer = this.mapSpecialRenderers.get(teClass);
/*     */     
/*  73 */     if (tileentityspecialrenderer == null && teClass != TileEntity.class) {
/*     */       
/*  75 */       tileentityspecialrenderer = getSpecialRendererByClass((Class)teClass.getSuperclass());
/*  76 */       this.mapSpecialRenderers.put(teClass, tileentityspecialrenderer);
/*     */     } 
/*     */     
/*  79 */     return (TileEntitySpecialRenderer)tileentityspecialrenderer;
/*     */   }
/*     */ 
/*     */   
/*     */   public <T extends TileEntity> TileEntitySpecialRenderer<T> getSpecialRenderer(TileEntity tileEntityIn) {
/*  84 */     return (tileEntityIn == null) ? null : getSpecialRendererByClass((Class)tileEntityIn.getClass());
/*     */   }
/*     */ 
/*     */   
