...
/*  21 */   private static final Map<String, TimedBannerTexture> DESIGNS = Maps.newHashMap();
...
/*     */ 
/*     */     
/*  95 */     TimedBannerTexture tileentitybannerrenderer$timedbannertexture = DESIGNS.get(s);
/*     */     
...
/*     */           
/* 106 */           String s1 = iterator.next();
/* 107 */           TimedBannerTexture tileentitybannerrenderer$timedbannertexture1 = DESIGNS.get(s1);
/*     */           
...
/* 124 */       List<String> list2 = Lists.newArrayList();
/*     */       
...
/* 133 */       Minecraft.getMinecraft().getTextureManager().loadTexture(tileentitybannerrenderer$timedbannertexture.bannerTexture, (ITextureObject)new LayeredColorMaskTexture(BANNERTEXTURES, list2, list));
