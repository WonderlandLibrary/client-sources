...
/*  80 */       return (this.elementCount != vertexformatelement.elementCount) ? false : ((this.index != vertexformatelement.index) ? false : ((this.type != vertexformatelement.type) ? false : ((this.usage == vertexformatelement.usage))));
/*     */     } 
/*     */ 
/*     */     
/*  84 */     return false;
