...
/* 85 */       return (this.field_151376_a != null) ? (!this.field_151375_b.isEmpty() ? (String.valueOf(this.field_151376_a) + " " + func_151372_b()) : this.field_151376_a) : (!this.field_151375_b.isEmpty() ? ("(Unknown file) " + func_151372_b()) : "(Unknown file)");
/*    */     }
/*    */     
/*    */     private Entry() {}
/*    */   }
