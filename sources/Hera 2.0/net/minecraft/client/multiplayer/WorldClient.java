...
/*  62 */     super((ISaveHandler)new SaveHandlerMP(), new WorldInfo(p_i45063_2_, "MpServer"), WorldProvider.getProviderForDimension(p_i45063_3_), p_i45063_5_, true);
...
/*     */       
/*  90 */       Entity entity = this.entitySpawnQueue.iterator().next();
...
/*     */       
/* 187 */       this.mc.getSoundHandler().playSound((ISound)new MovingSoundMinecart((EntityMinecart)entityIn));
/*     */     } 
/*     */     
/* 190 */     return flag;
/*     */   }
...
/* 259 */     return (id == this.mc.thePlayer.getEntityId()) ? (Entity)this.mc.thePlayer : super.getEntityByID(id);
/*     */   }
/*     */ 
/*     */   
...
/* 281 */     return setBlockState(p_180503_1_, p_180503_2_, 3);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 289 */     this.sendQueue.getNetworkManager().closeChannel((IChatComponent)new ChatComponentText("Quitting"));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 318 */       IBlockState iblockstate = getBlockState((BlockPos)blockposm);
/* 319 */       iblockstate.getBlock().randomDisplayTick(this, (BlockPos)blockposm, iblockstate, random);
/*     */       
...
/*     */       
/* 337 */       Entity entity = this.unloadedEntityList.get(i);
...
/*     */     {
/* 349 */       onEntityRemoved(this.unloadedEntityList.get(l));
/*     */     }
/*     */     
...
/*     */       
/* 356 */       Entity entity1 = this.loadedEntityList.get(i1);
/*     */       
...
/*     */           
/*     */           public String call() {
/* 396 */             return String.valueOf(WorldClient.this.entityList.size()) + " total; " + WorldClient.this.entityList.toString();
/*     */           }
/*     */         });
...
/*     */           
/*     */           public String call() {
/* 404 */             return String.valueOf(WorldClient.this.entitySpawnQueue.size()) + " total; " + WorldClient.this.entitySpawnQueue.toString();
/*     */           }
/*     */         });
...
/* 445 */       this.mc.getSoundHandler().playDelayedSound((ISound)positionedsoundrecord, (int)(d1 * 20.0D));
/*     */     }
/*     */     else {
/*     */       
/* 449 */       this.mc.getSoundHandler().playSound((ISound)positionedsoundrecord);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
/*     */   public void makeFireworks(double x, double y, double z, double motionX, double motionY, double motionZ, NBTTagCompound compund) {
/* 455 */     this.mc.effectRenderer.addEffect((EntityFX)new EntityFirework.StarterFX(this, x, y, z, motionX, motionY, motionZ, this.mc.effectRenderer, compund));
/*     */   }
/*     */ 
/*     */   
