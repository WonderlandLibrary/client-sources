...
/*     */     float f;
/* 336 */     for (f = p_110683_2_ - p_110683_1_; f < -180.0F; f += 360.0F);
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/* 449 */     this.backLeftLeg.rotationPointY += MathHelper.sin(1.5707964F + f15 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
/* 450 */     this.backLeftLeg.rotationPointZ += MathHelper.cos(4.712389F + f15 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
/* 451 */     this.backRightLeg.rotationPointY += MathHelper.sin(1.5707964F + f15 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
/* 452 */     this.backRightLeg.rotationPointZ += MathHelper.cos(4.712389F + f15 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
/* 453 */     float f17 = (-1.0471976F + f16) * f6 + f11 * f7;
/* 454 */     float f18 = (-1.0471976F + -f16) * f6 + -f11 * f7;
/* 455 */     this.frontLeftLeg.rotationPointY += MathHelper.sin(1.5707964F + f17) * 7.0F;
/* 456 */     this.frontLeftLeg.rotationPointZ += MathHelper.cos(4.712389F + f17) * 7.0F;
/* 457 */     this.frontRightLeg.rotationPointY += MathHelper.sin(1.5707964F + f18) * 7.0F;
/* 458 */     this.frontRightLeg.rotationPointZ += MathHelper.cos(4.712389F + f18) * 7.0F;
