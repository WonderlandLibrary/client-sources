...
/*     */                       }
/*     */                     },  );
/* 131 */                 SoundManager.this.getClass(); SoundManager.this.sndSystem = new SoundManager.SoundSystemStarterThread(null);
...
/* 381 */               String s = MathHelper.getRandomUuid((Random)ThreadLocalRandom.current()).toString();
/*     */               
...
/*     */         {
/* 471 */           return new URLConnection(p_openConnection_1_)
/*     */             {
...
/* 478 */                 return Minecraft.getMinecraft().getResourceManager().getResource(p_148612_0_).getInputStream();
/*     */               }
/*     */             };
/*     */         }
/*     */       };
...
/*     */     }
/* 488 */     catch (MalformedURLException var4) {
/*     */       
...
/* 538 */         return (source == null) ? false : (!(!source.playing() && !source.paused() && !source.preLoad));
/*     */       } 
/*     */     }
/*     */   }
/*     */ }
