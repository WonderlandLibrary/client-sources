...
/*  82 */     List<ExtendedBlockStorage> list = Lists.newArrayList();
/*     */     
...
/*  96 */     int j = 0;
/*     */     
/*  98 */     for (ExtendedBlockStorage extendedblockstorage1 : list) {
/*     */       
/* 100 */       char[] achar = extendedblockstorage1.getData(); byte b; int k;
/*     */       char[] arrayOfChar1;
/* 102 */       for (k = (arrayOfChar1 = achar).length, b = 0; b < k; ) { char c0 = arrayOfChar1[b];
/*     */         
/* 104 */         s21packetchunkdata$extracted.data[j++] = (byte)(c0 & 0xFF);
/* 105 */         s21packetchunkdata$extracted.data[j++] = (byte)(c0 >> 8 & 0xFF);
/*     */         b++; }
/*     */     
/*     */     } 
