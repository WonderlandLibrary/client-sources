...
/*   89 */     return (T)((Enum[])enumClass.getEnumConstants())[readVarIntFromBuffer()];
/*      */   }
/*      */ 
/*      */   
...
/*  179 */     while ((value & 0xFFFFFFFFFFFFFF80L) != 0L) {
/*      */       
/*  181 */       writeByte((int)(value & 0x7FL) | 0x80);
/*  182 */       value >>>= 7L;
/*      */     } 
/*      */     
...
/*      */       try {
/*      */         
/*  201 */         CompressedStreamTools.write(nbt, (DataOutput)new ByteBufOutputStream(this));
/*      */       }
...
/*      */     
/*  224 */     readerIndex(i);
/*  225 */     return CompressedStreamTools.read((DataInput)new ByteBufInputStream(this), new NBTSizeTracker(2097152L));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     {
/*  310 */       throw new EncoderException("String too big (was " + string.length() + " bytes encoded, max " + '翿' + ")");
/*      */     }
/*      */ 
/*      */     
