...
/* 224 */     return (this.worldObj.getTileEntity(this.pos) != this) ? false : ((player.getDistanceSq(this.pos.getX() + 0.5D, this.pos.getY() + 0.5D, this.pos.getZ() + 0.5D) <= 64.0D));
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/* 319 */     Block block = this.worldObj.getBlockState(posIn).getBlock();
...
/* 338 */       float f = 5.0F;
/*     */       
/* 340 */       for (EntityPlayer entityplayer : this.worldObj.getEntitiesWithinAABB(EntityPlayer.class, new AxisAlignedBB((i - f), (j - f), (k - f), ((i + 1) + f), ((j + 1) + f), ((k + 1) + f)))) {
/*     */         
...
/* 500 */     return (Container)new ContainerChest((IInventory)playerInventory, this, playerIn);
/*     */   }
/*     */ 
/*     */   
