...
/* 215 */     return (this.worldObj.getTileEntity(this.pos) != this) ? false : ((player.getDistanceSq(this.pos.getX() + 0.5D, this.pos.getY() + 0.5D, this.pos.getZ() + 0.5D) <= 64.0D));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 241 */     return (Container)new ContainerDispenser((IInventory)playerInventory, this);
/*     */   }
/*     */ 
/*     */   
