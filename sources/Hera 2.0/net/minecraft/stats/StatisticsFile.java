...
/*     */       {
/*  88 */         this.mcServer.getConfigurationManager().sendChatMsg((IChatComponent)new ChatComponentTranslation("chat.type.achievement", new Object[] { playerIn.getDisplayName(), statIn.func_150955_j() }));
/*     */       }
/*     */     } 
/*     */     
...
/*     */       {
/*  98 */         this.mcServer.getConfigurationManager().sendChatMsg((IChatComponent)new ChatComponentTranslation("chat.type.achievement.taken", new Object[] { playerIn.getDisplayName(), statIn.func_150955_j() }));
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/*     */     
/* 124 */     for (Map.Entry<String, JsonElement> entry : (Iterable<Map.Entry<String, JsonElement>>)jsonobject.entrySet()) {
/*     */       
/* 126 */       StatBase statbase = StatList.getOneShotStat(entry.getKey());
/*     */       
...
/* 150 */               IJsonSerializable ijsonserializable = constructor.newInstance(new Object[0]);
...
/*     */         } 
/*     */         
/* 193 */         jsonobject.add(((StatBase)entry.getKey()).statId, (JsonElement)jsonobject1);
/*     */         
/*     */         continue;
/*     */       } 
...
/*     */     } 
/*     */     
/* 227 */     p_150876_1_.playerNetServerHandler.sendPacket((Packet)new S37PacketStatistics(map));
/*     */   }
/*     */ 
/*     */   
...
/*     */     } 
/*     */     
/* 243 */     player.playerNetServerHandler.sendPacket((Packet)new S37PacketStatistics(map));
/*     */   }
/*     */ 
/*     */   
