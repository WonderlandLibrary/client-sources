...
/*  51 */         return (d1 > 0.5D) ? (String.valueOf(StatBase.decimalFormat.format(d1)) + " km") : ((d0 > 0.5D) ? (String.valueOf(StatBase.decimalFormat.format(d0)) + " m") : (String.valueOf(p_75843_1_) + " cm"));
/*     */       }
/*     */     };
...
/*  66 */     this.type = typeIn;
/*  67 */     this.field_150957_c = (IScoreObjectiveCriteria)new ObjectiveStat(this);
...
/* 120 */     ichatcomponent.getChatStyle().setChatHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_ACHIEVEMENT, (IChatComponent)new ChatComponentText(this.statId)));
