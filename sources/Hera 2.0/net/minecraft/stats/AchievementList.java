...
/*  23 */   public static List<Achievement> achievementList = Lists.newArrayList();
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*  74 */   public static Achievement snipeSkeleton = (new Achievement("achievement.snipeSkeleton", "snipeSkeleton", 7, 0, (Item)Items.bow, killEnemy)).setSpecial().registerStat();
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*  90 */   public static Achievement potion = (new Achievement("achievement.potion", "potion", 2, 8, (Item)Items.potionitem, blazeRod)).registerStat();
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 115 */   public static Achievement fullBeacon = (new Achievement("achievement.fullBeacon", "fullBeacon", 7, 8, (Block)Blocks.beacon, killWither)).setSpecial().registerStat();
/*     */ 
/*     */   
/* 118 */   public static Achievement exploreAllBiomes = (new Achievement("achievement.exploreAllBiomes", "exploreAllBiomes", 4, 8, (Item)Items.diamond_boots, theEnd)).func_150953_b((Class)JsonSerializableSet.class).setSpecial().registerStat();
