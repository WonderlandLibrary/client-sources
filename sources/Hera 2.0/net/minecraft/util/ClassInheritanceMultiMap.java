...
/*  15 */   private static final Set<Class<?>> field_181158_a = Sets.newHashSet();
...
/*  80 */     List<T> list = this.map.get(p_181743_2_);
/*     */     
/*  82 */     if (list == null) {
/*     */       
...
/*     */         
/* 101 */         List<T> list = this.map.get(oclass);
/*     */         
...
/* 120 */     return new Iterable<S>()
/*     */       {
/*     */         public Iterator<S> iterator()
/*     */         {
/* 124 */           List<T> list = (List<T>)ClassInheritanceMultiMap.this.map.get(ClassInheritanceMultiMap.this.func_181157_b(clazz));
/*     */           
/* 126 */           if (list == null)
/*     */           {
/* 128 */             return (Iterator<S>)Iterators.emptyIterator();
/*     */           }
/*     */ 
/*     */           
/* 132 */           Iterator<T> iterator = list.iterator();
/* 133 */           return (Iterator<S>)Iterators.filter(iterator, clazz);
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 141 */     return this.field_181745_e.isEmpty() ? (Iterator<T>)Iterators.emptyIterator() : (Iterator<T>)Iterators.unmodifiableIterator(this.field_181745_e.iterator());
/*     */   }
/*     */ 
/*     */   
/*     */   public int size() {
