...
/*     */ {
/*  14 */   private final List<CombatEntry> combatEntries = Lists.newArrayList();
/*     */   
...
/*  83 */     CombatEntry combatentry1 = this.combatEntries.get(this.combatEntries.size() - 1);
...
/*     */           }
/*     */         
/* 108 */         } else if (ichatcomponent1 != null) {
/*     */           
...
/*     */     {
/* 164 */       return (EntityLivingBase)entityplayer;
/*     */     }
/*     */ 
/*     */     
...
/*     */       
/* 181 */       CombatEntry combatentry2 = this.combatEntries.get(j);
/* 182 */       CombatEntry combatentry3 = (j > 0) ? this.combatEntries.get(j - 1) : null;
/*     */       
