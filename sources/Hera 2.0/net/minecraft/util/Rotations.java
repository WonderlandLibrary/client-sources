...
/* 34 */     nbttaglist.appendTag((NBTBase)new NBTTagFloat(this.x));
/* 35 */     nbttaglist.appendTag((NBTBase)new NBTTagFloat(this.y));
/* 36 */     nbttaglist.appendTag((NBTBase)new NBTTagFloat(this.z));
