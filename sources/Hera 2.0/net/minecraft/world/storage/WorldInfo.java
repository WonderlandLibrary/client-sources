...
/* 337 */     nbt.setLong("LastPlayed", MinecraftServer.getCurrentTimeMillis());
...
/* 364 */     nbt.setTag("GameRules", (NBTBase)this.theGameRules.writeToNBT());
/*     */     
/* 366 */     if (playerNbt != null)
/*     */     {
/* 368 */       nbt.setTag("Player", (NBTBase)playerNbt);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 845 */     category.addCrashSectionCallable("Level seed", new Callable<String>()
/*     */         {
...
/*     */           }
/*     */         });
/* 852 */     category.addCrashSectionCallable("Level generator", new Callable<String>()
/*     */         {
/*     */           public String call() throws Exception
/*     */           {
...
/*     */           }
/*     */         });
/* 859 */     category.addCrashSectionCallable("Level generator options", new Callable<String>()
/*     */         {
/*     */           public String call() throws Exception
/*     */           {
...
/*     */           }
/*     */         });
/* 866 */     category.addCrashSectionCallable("Level spawn location", new Callable<String>()
/*     */         {
/*     */           public String call() throws Exception
/*     */           {
...
/*     */           }
/*     */         });
/* 873 */     category.addCrashSectionCallable("Level time", new Callable<String>()
/*     */         {
/*     */           public String call() throws Exception
/*     */           {
/* 877 */             return String.format("%d game time, %d day time", new Object[] { Long.valueOf(WorldInfo.access$6(this.this$0)), Long.valueOf(WorldInfo.access$7(this.this$0)) });
/*     */           }
/*     */         });
/* 880 */     category.addCrashSectionCallable("Level dimension", new Callable<String>()
/*     */         {
/*     */           public String call() throws Exception
/*     */           {
...
/*     */ 
/*     */             
/* 910 */             return String.format("0x%05X - %s", new Object[] { Integer.valueOf(WorldInfo.access$9(this.this$0)), s });
/*     */           }
/*     */         });
/* 913 */     category.addCrashSectionCallable("Level weather", new Callable<String>()
/*     */         {
/*     */           public String call() throws Exception
/*     */           {
/* 917 */             return String.format("Rain time: %d (now: %b), thunder time: %d (now: %b)", new Object[] { Integer.valueOf(WorldInfo.access$10(this.this$0)), Boolean.valueOf(WorldInfo.access$11(this.this$0)), Integer.valueOf(WorldInfo.access$12(this.this$0)), Boolean.valueOf(WorldInfo.access$13(this.this$0)) });
/*     */           }
/*     */         });
/* 920 */     category.addCrashSectionCallable("Level game mode", new Callable<String>()
/*     */         {
/*     */           public String call() throws Exception
/*     */           {
/* 924 */             return String.format("Game mode: %s (ID %d). Hardcore: %b. Cheats: %b", new Object[] { WorldInfo.access$14(this.this$0).getName(), Integer.valueOf(WorldInfo.access$14(this.this$0).getID()), Boolean.valueOf(WorldInfo.access$15(this.this$0)), Boolean.valueOf(WorldInfo.access$16(this.this$0)) });
/*     */           }
/*     */         });
/*     */   }
/*     */   
