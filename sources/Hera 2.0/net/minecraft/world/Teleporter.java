...
/*  24 */   private final List<Long> destinationCoordinateKeys = Lists.newArrayList();
/*     */ 
/*     */   
...
/*     */             
/* 100 */             BlockPos blockpos2 = blockpos1.down();
/*     */             
...
/*     */               }
/*     */               
/* 109 */               double d1 = blockpos1.distanceSq((Vec3i)blockpos3);
/*     */               
...
/*     */           
/* 217 */           if (this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.func_181079_c(j2, j3, l2))) {
/*     */             
/* 219 */             while (j3 > 0 && this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.func_181079_c(j2, j3 - 1, l2)))
/*     */             {
/* 221 */               j3--;
/*     */             }
/*     */             int k3;
/* 224 */             label168: for (k3 = i2; k3 < i2 + 4; k3++) {
/*     */               
/* 226 */               int l3 = k3 % 2;
/* 227 */               int i4 = 1 - l3;
/*     */               
...
/*     */                     
/* 246 */                     if (l4 >= 0 || this.worldServerInstance.getBlockState((BlockPos)blockpos$mutableblockpos).getBlock().getMaterial().isSolid()) { if (l4 >= 0 && !this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos))
/*     */                         break label168; 
/*     */                       l4++; }
/*     */                     
/*     */                     break label168;
...
/*     */             
/* 284 */             if (this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.func_181079_c(l5, i7, j6))) {
/*     */               
/* 286 */               while (i7 > 0 && this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos.func_181079_c(l5, i7 - 1, j6)))
/*     */               {
/* 288 */                 i7--;
/*     */               }
/*     */               int k7;
/* 291 */               label167: for (k7 = i2; k7 < i2 + 2; k7++) {
/*     */                 
/* 293 */                 int j8 = k7 % 2;
/* 294 */                 int j9 = 1 - j8;
/*     */                 
...
/*     */                     
/* 305 */                     if (j11 >= 0 || this.worldServerInstance.getBlockState((BlockPos)blockpos$mutableblockpos).getBlock().getMaterial().isSolid()) { if (j11 >= 0 && !this.worldServerInstance.isAirBlock((BlockPos)blockpos$mutableblockpos))
/*     */                         break label167; 
/*     */                       j11++; }
/*     */                     
/*     */                     break label167;
...
/*     */     } 
/*     */     
/* 363 */     IBlockState iblockstate = Blocks.portal.getDefaultState().withProperty((IProperty)BlockPortal.AXIS, (l6 != 0) ? (Comparable)EnumFacing.Axis.X : (Comparable)EnumFacing.Axis.Z);
/*     */     
...
/* 426 */       super(pos.getX(), pos.getY(), pos.getZ());
