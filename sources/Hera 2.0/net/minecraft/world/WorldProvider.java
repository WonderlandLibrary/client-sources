...
/*  84 */       this.worldChunkMgr = (WorldChunkManager)new WorldChunkManagerHell(BiomeGenBase.getBiomeFromBiomeList(flatgeneratorinfo.getBiome(), BiomeGenBase.field_180279_ad), 0.5F);
/*     */     }
/*  86 */     else if (worldtype == WorldType.DEBUG_WORLD) {
/*     */       
/*  88 */       this.worldChunkMgr = (WorldChunkManager)new WorldChunkManagerHell(BiomeGenBase.plains, 0.0F);
/*     */     }
/*     */     else {
/*     */       
...
/* 101 */     return (this.terrainType == WorldType.FLAT) ? (IChunkProvider)new ChunkProviderFlat(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled(), this.generatorSettings) : ((this.terrainType == WorldType.DEBUG_WORLD) ? (IChunkProvider)new ChunkProviderDebug(this.worldObj) : ((this.terrainType == WorldType.CUSTOMIZED) ? (IChunkProvider)new ChunkProviderGenerate(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled(), this.generatorSettings) : (IChunkProvider)new ChunkProviderGenerate(this.worldObj, this.worldObj.getSeed(), this.worldObj.getWorldInfo().isMapFeaturesEnabled(), this.generatorSettings)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 109 */     return (this.worldObj.getGroundAboveSeaLevel(new BlockPos(x, 0, z)) == Blocks.grass);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 130 */     f = 1.0F - (float)((Math.cos(f * Math.PI) + 1.0D) / 2.0D);
/* 131 */     f += (f - f) / 3.0F;
/* 132 */     return f;
/*     */   }
/*     */ 
...
/* 200 */     return (dimension == -1) ? new WorldProviderHell() : ((dimension == 0) ? new WorldProviderSurface() : ((dimension == 1) ? new WorldProviderEnd() : null));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
