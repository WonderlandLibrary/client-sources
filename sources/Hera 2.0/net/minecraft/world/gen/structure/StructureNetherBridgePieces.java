...
/*   20 */   private static final PieceWeight[] primaryComponents = new PieceWeight[] { new PieceWeight((Class)Straight.class, 30, 0, true), new PieceWeight((Class)Crossing3.class, 10, 4), new PieceWeight((Class)Crossing.class, 10, 4), new PieceWeight((Class)Stairs.class, 10, 3), new PieceWeight((Class)Throne.class, 5, 2), new PieceWeight((Class)Entrance.class, 5, 1) };
/*   21 */   private static final PieceWeight[] secondaryComponents = new PieceWeight[] { new PieceWeight((Class)Corridor5.class, 25, 0, true), new PieceWeight((Class)Crossing2.class, 15, 5), new PieceWeight((Class)Corridor2.class, 5, 10), new PieceWeight((Class)Corridor.class, 5, 10), new PieceWeight((Class)Corridor3.class, 10, 3, true), new PieceWeight((Class)Corridor4.class, 7, 2), new PieceWeight((Class)NetherStalkRoom.class, 5, 2) };
/*      */ 
/*      */   
...
/*      */       
/*  154 */       if (this.field_111021_b && structureBoundingBoxIn.isVecInside((Vec3i)new BlockPos(getXWithOffset(3, 3), getYWithOffset(2), getZWithOffset(3, 3)))) {
/*      */         
...
/*      */       
/*  225 */       if (this.field_111020_b && structureBoundingBoxIn.isVecInside((Vec3i)new BlockPos(getXWithOffset(1, 3), getYWithOffset(2), getZWithOffset(1, 3)))) {
/*      */         
...
/*      */       
/*  786 */       if (structureBoundingBoxIn.isVecInside((Vec3i)blockpos))
/*      */       {
/*  788 */         worldIn.forceBlockUpdateTick((Block)Blocks.flowing_lava, blockpos, randomIn);
/*      */       }
/*      */       
/*  791 */       return true;
/*      */     }
...
/*      */         
/*  994 */         for (StructureNetherBridgePieces.PieceWeight structurenetherbridgepieces$pieceweight : p_175871_2_) {
/*      */           
...
/*      */               
/* 1009 */               structurenetherbridgepieces$pieceweight.field_78827_c++;
...
/* 1231 */       super(p_i2059_1_, p_i2059_2_, p_i2059_3_);
/* 1232 */       this.primaryWeights = Lists.newArrayList(); byte b; int i;
/*      */       StructureNetherBridgePieces.PieceWeight[] arrayOfPieceWeight;
/* 1234 */       for (i = (arrayOfPieceWeight = StructureNetherBridgePieces.primaryComponents).length, b = 0; b < i; ) { StructureNetherBridgePieces.PieceWeight structurenetherbridgepieces$pieceweight = arrayOfPieceWeight[b];
/*      */         
...
/*      */       
/* 1242 */       for (i = (arrayOfPieceWeight = StructureNetherBridgePieces.secondaryComponents).length, b = 0; b < i; ) { StructureNetherBridgePieces.PieceWeight structurenetherbridgepieces$pieceweight1 = arrayOfPieceWeight[b];
/*      */         
...
/*      */         
/* 1374 */         if (structureBoundingBoxIn.isVecInside((Vec3i)blockpos)) {
/*      */           
/* 1376 */           this.hasSpawner = true;
/* 1377 */           worldIn.setBlockState(blockpos, Blocks.mob_spawner.getDefaultState(), 2);
/* 1378 */           TileEntity tileentity = worldIn.getTileEntity(blockpos);
/*      */           
