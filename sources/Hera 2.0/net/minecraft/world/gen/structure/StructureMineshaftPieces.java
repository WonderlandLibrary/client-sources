...
/*     */       
/*     */       int i;
/* 144 */       for (i = rand.nextInt(3) + 2; i > 0; i--) {
/*     */         
/* 146 */         int j = i * 5;
/*     */         
/* 148 */         switch (facing) {
...
/* 189 */             if (j <= 1) {
/*     */               
/* 191 */               StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ - 1, this.coordBaseMode, i); break;
/*     */             } 
/* 193 */             if (j == 2) {
/*     */               
...
/* 205 */             if (j <= 1) {
/*     */               
/* 207 */               StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.maxZ + 1, this.coordBaseMode, i); break;
/*     */             } 
/* 209 */             if (j == 2) {
/*     */               
...
/* 221 */             if (j <= 1) {
/*     */               
/* 223 */               StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, this.coordBaseMode, i); break;
/*     */             } 
/* 225 */             if (j == 2) {
/*     */               
...
/* 237 */             if (j <= 1) {
/*     */               
/* 239 */               StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY - 1 + rand.nextInt(3), this.boundingBox.minZ, this.coordBaseMode, i); break;
/*     */             } 
/* 241 */             if (j == 2) {
/*     */               
...
/*     */       
/* 293 */       if (boundingBoxIn.isVecInside((Vec3i)blockpos) && worldIn.getBlockState(blockpos).getBlock().getMaterial() == Material.air) {
/*     */         
...
/* 298 */         WeightedRandomChestContent.generateChestContents(rand, listIn, (IInventory)entityminecartchest, max);
/* 299 */         worldIn.spawnEntityInWorld((Entity)entityminecartchest);
/* 300 */         return true;
/*     */       } 
/*     */ 
/*     */       
...
/*     */           
/* 374 */           if (structureBoundingBoxIn.isVecInside((Vec3i)blockpos)) {
/*     */             
/* 376 */             this.spawnerPlaced = true;
/* 377 */             worldIn.setBlockState(blockpos, Blocks.mob_spawner.getDefaultState(), 2);
/* 378 */             TileEntity tileentity = worldIn.getTileEntity(blockpos);
/*     */             
...
/*     */       }
/*     */       int k;
/* 609 */       for (k = 0; k < this.boundingBox.getXSize(); k += 4) {
/*     */         
...
/*     */       } 
/*     */       
/* 627 */       for (k = 0; k < this.boundingBox.getXSize(); k += 4) {
/*     */         
...
/*     */       } 
/*     */       
/* 645 */       for (k = 0; k < this.boundingBox.getZSize(); k += 4) {
/*     */         
...
/*     */       } 
/*     */       
/* 663 */       for (k = 0; k < this.boundingBox.getZSize(); k += 4) {
/*     */         
...
/*     */       {
/* 719 */         nbttaglist.appendTag((NBTBase)structureboundingbox.toNBTTagIntArray());
/*     */       }
/*     */       
/* 722 */       tagCompound.setTag("Entrances", (NBTBase)nbttaglist);
/*     */     }
/*     */ 
/*     */     
/*     */     protected void readStructureFromNBT(NBTTagCompound tagCompound) {
