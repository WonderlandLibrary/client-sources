...
/*  53 */   private Block field_177476_s = (Block)Blocks.water;
/*  54 */   private double[] stoneNoise = new double[256];
...
/*  91 */     this.field_147434_q = new double[825];
...
/* 106 */       this.field_177476_s = this.settings.useLavaOceans ? (Block)Blocks.lava : (Block)Blocks.water;
...
/* 386 */     BlockFalling.fallInstantly = true;
...
/* 428 */       (new WorldGenLakes((Block)Blocks.water)).generate(this.worldObj, this.rand, blockpos.add(i1, j1, k1));
/*     */     } 
/*     */     
...
/*     */       {
/* 439 */         (new WorldGenLakes((Block)Blocks.lava)).generate(this.worldObj, this.rand, blockpos.add(i2, l2, k3));
/*     */       }
/*     */     } 
/*     */     
...
/*     */     } 
/*     */     
/* 477 */     BlockFalling.fallInstantly = false;
/*     */   }
/*     */ 
/*     */   
