...
/*  88 */         Map<String, String> map = entry.getValue();
/*     */         
/*  90 */         if (!map.isEmpty())
/*     */         {
...
/*     */             }
/*     */             
/* 102 */             stringbuilder.append(entry1.getKey());
/* 103 */             stringbuilder.append("=");
/* 104 */             stringbuilder.append(entry1.getValue());
/*     */           } 
/*     */           
...
/* 167 */         block = (astring.length > 1) ? Block.getBlockFromName(String.valueOf(astring[0]) + ":" + astring[1]) : null;
/*     */         
/* 169 */         if (block != null) {
/*     */           
...
/* 215 */       int i = 0; byte b; int j;
/*     */       String[] arrayOfString1;
/* 217 */       for (j = (arrayOfString1 = astring).length, b = 0; b < j; ) { String s = arrayOfString1[b];
/*     */         
...
/*     */           
/* 270 */           String[] astring1 = astring[j++].toLowerCase().split(","); byte b; int m;
/*     */           String[] arrayOfString1;
/* 272 */           for (m = (arrayOfString1 = astring1).length, b = 0; b < m; ) { String s = arrayOfString1[b];
/*     */             
...
/* 323 */     flatgeneratorinfo.getFlatLayers().add(new FlatLayerInfo(1, (Block)Blocks.grass));
