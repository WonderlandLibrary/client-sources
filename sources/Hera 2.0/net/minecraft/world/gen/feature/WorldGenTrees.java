...
/*  77 */             if (j >= 0 && j < 256) {
/*     */               
/*  79 */               if (!func_150523_a(worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(l, j, i1)).getBlock()))
/*     */               {
/*  81 */                 flag = false;
/*     */               }
/*     */             }
...
/*     */                 
/* 180 */                 if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos1).getBlock().getMaterial() == Material.leaves) {
/*     */                   
...
/* 245 */     setBlockAndNotifyAdequately(p_181652_1_, p_181652_3_, Blocks.cocoa.getDefaultState().withProperty((IProperty)BlockCocoa.AGE, Integer.valueOf(p_181652_2_)).withProperty((IProperty)BlockCocoa.FACING, (Comparable)p_181652_4_));
/*     */   }
/*     */ 
/*     */   
/*     */   private void func_181651_a(World p_181651_1_, BlockPos p_181651_2_, PropertyBool p_181651_3_) {
/* 250 */     setBlockAndNotifyAdequately(p_181651_1_, p_181651_2_, Blocks.vine.getDefaultState().withProperty((IProperty)p_181651_3_, Boolean.valueOf(true)));
/*     */   }
/*     */ 
/*     */   
