...
/*  62 */     this.field_175948_j = Lists.newArrayList();
...
/* 150 */     return (p_76495_1_ >= 0 && p_76495_1_ < this.leafDistanceLimit) ? ((p_76495_1_ != 0 && p_76495_1_ != this.leafDistanceLimit - 1) ? 3.0F : 2.0F) : -1.0F;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     {
/* 160 */       func_181631_a(pos.up(i), leafSize(i), Blocks.leaves.getDefaultState().withProperty((IProperty)BlockLeaves.CHECK_DECAY, Boolean.valueOf(false)));
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 176 */       setBlockAndNotifyAdequately(this.world, blockpos1, p_175937_3_.getDefaultState().withProperty((IProperty)BlockLog.LOG_AXIS, (Comparable)blocklog$enumaxis));
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 368 */       super(p_i45635_1_.getX(), p_i45635_1_.getY(), p_i45635_1_.getZ());
