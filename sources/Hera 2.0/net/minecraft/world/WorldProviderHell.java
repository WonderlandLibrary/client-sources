...
/*  17 */     this.worldChunkMgr = (WorldChunkManager)new WorldChunkManagerHell(BiomeGenBase.hell, 0.0F);
...
/*  50 */     return (IChunkProvider)new ChunkProviderHell(this.worldObj, this.worldObj.getWorldInfo().isMapFeaturesEnabled(), this.worldObj.getSeed());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
