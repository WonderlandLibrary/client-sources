...
/* 116 */     boolean flag = (Math.cos(p_180622_6_ / 3.0D * Math.PI) > 0.0D);
/* 117 */     int l = -1;
...
/* 325 */       biomegenmesa.setBiomeName(String.valueOf(this.biomeName) + " M");
/*     */     }
/*     */     else {
/*     */       
/* 329 */       biomegenmesa.setBiomeName(String.valueOf(this.biomeName) + " (Bryce)");
/*     */     } 
/*     */     
