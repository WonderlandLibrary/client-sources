...
/*      */ 
/*      */   
/*  132 */   protected Set<ChunkCoordIntPair> activeChunkSet = Sets.newHashSet();
/*      */ 
/*      */   
...
/*  186 */         crashreportcategory.addCrashSectionCallable("Location", new Callable<String>()
/*      */             {
...
/*      */     BlockPos blockpos;
/*  229 */     for (blockpos = new BlockPos(pos.getX(), func_181545_F(), pos.getZ()); !isAirBlock(blockpos.up()); blockpos = blockpos.up());
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*  543 */         crashreportcategory.addCrashSectionCallable("Source block type", new Callable<String>()
/*      */             {
/*      */               
/*      */               public String call() throws Exception
/*      */               {
/*      */                 try {
/*  549 */                   return String.format("ID #%d (%s // %s)", new Object[] { Integer.valueOf(Block.getIdFromBlock(this.val$blockIn)), this.val$blockIn.getUnlocalizedName(), this.val$blockIn.getClass().getCanonicalName() });
/*      */                 }
/*  551 */                 catch (Throwable var2) {
/*      */                   
...
/* 1014 */           if (d3 < d4 && d3 < d5) {
/*      */             
/* 1016 */             enumfacing = (i > l) ? EnumFacing.WEST : EnumFacing.EAST;
/* 1017 */             vec31 = new Vec3(d0, vec31.yCoord + d7 * d3, vec31.zCoord + d8 * d3);
/*      */           }
/* 1019 */           else if (d4 < d5) {
/*      */             
/* 1021 */             enumfacing = (j > i1) ? EnumFacing.DOWN : EnumFacing.UP;
...
/*      */         
/* 1281 */         if (isBlockLoaded((BlockPos)blockpos$mutableblockpos.func_181079_c(k1, 64, l1)))
/*      */         {
...
/*      */             
/* 1298 */             if (worldborder.contains((BlockPos)blockpos$mutableblockpos) || !flag1)
/*      */             {
/* 1300 */               iblockstate1 = getBlockState((BlockPos)blockpos$mutableblockpos);
/*      */             }
/*      */             
/* 1303 */             iblockstate1.getBlock().addCollisionBoxesToList(this, (BlockPos)blockpos$mutableblockpos, iblockstate1, bb, list, entityIn);
/*      */           } 
/*      */         }
/*      */       } 
/*      */     } 
...
/*      */         }
/*      */         
/* 1323 */         axisalignedbb = entityIn.getCollisionBox(list1.get(j2));
/*      */         
...
/*      */         
/* 1375 */         if (isBlockLoaded((BlockPos)blockpos$mutableblockpos.func_181079_c(k1, 64, l1)))
/*      */         {
...
/*      */               
/* 1384 */               iblockstate = getBlockState((BlockPos)blockpos$mutableblockpos);
/*      */             }
/*      */             else {
/*      */               
...
/*      */             } 
/*      */             
/* 1391 */             iblockstate.getBlock().addCollisionBoxesToList(this, (BlockPos)blockpos$mutableblockpos, iblockstate, bb, list, null);
/*      */           } 
/*      */         }
/*      */       } 
/*      */     } 
...
/* 1525 */     float f2 = (float)(this.cloudColour >> 16L & 0xFFL) / 255.0F;
/* 1526 */     float f3 = (float)(this.cloudColour >> 8L & 0xFFL) / 255.0F;
/* 1527 */     float f4 = (float)(this.cloudColour & 0xFFL) / 255.0F;
...
/*      */       
/* 1581 */       BlockPos blockpos1 = blockpos.down();
...
/*      */       
/* 1626 */       Entity entity = this.weatherEffects.get(i);
/*      */ 
/*      */       
/*      */       try {
/* 1630 */         entity.ticksExisted++;
/* 1631 */         entity.onUpdate();
/*      */       }
/* 1633 */       catch (Throwable throwable2) {
/*      */         
...
/*      */       
/* 1661 */       Entity entity1 = this.unloadedEntityList.get(k);
...
/*      */     {
/* 1673 */       onEntityRemoved(this.unloadedEntityList.get(l));
/*      */     }
/*      */     
...
/*      */       
/* 1681 */       Entity entity2 = this.loadedEntityList.get(i1);
/*      */       
...
/*      */         }
/* 1702 */         catch (Throwable throwable1) {
/*      */           
...
/*      */       
/* 1737 */       TileEntity tileentity = iterator.next();
/*      */       
...
/*      */           }
/* 1749 */           catch (Throwable throwable) {
/*      */             
...
/*      */         
/* 1786 */         TileEntity tileentity1 = this.addedTileEntityList.get(j1);
/*      */         
...
/*      */           
/* 1996 */           Block block = getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(k1, l1, i2)).getBlock();
/*      */           
...
/*      */           
/* 2028 */           Block block = getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(k1, l1, i2)).getBlock();
/*      */           
...
/*      */             
/* 2060 */             Block block = getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(k1, l1, i2)).getBlock();
/*      */             
...
/* 2103 */           IBlockState iblockstate = getBlockState((BlockPos)blockpos$mutableblockpos);
/* 2104 */           Block block = iblockstate.getBlock();
/*      */           
/* 2106 */           if (block.getMaterial() == materialIn) {
/*      */             
/* 2108 */             double d0 = ((l1 + 1) - BlockLiquid.getLiquidHeightPercent(((Integer)iblockstate.getValue((IProperty)BlockLiquid.LEVEL)).intValue()));
/*      */             
/* 2110 */             if (l >= d0) {
/*      */               
/* 2112 */               flag = true;
/* 2113 */               vec3 = block.modifyAcceleration(this, (BlockPos)blockpos$mutableblockpos, entityIn, vec3);
/*      */             } 
/*      */           } 
/*      */         } 
/*      */       } 
...
/*      */           
/* 2152 */           if (getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(k1, l1, i2)).getBlock().getMaterial() == materialIn)
/*      */           {
/* 2154 */             return true;
/*      */           }
/*      */         } 
...
/*      */           
/* 2182 */           IBlockState iblockstate = getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(k1, l1, i2));
/* 2183 */           Block block = iblockstate.getBlock();
/*      */           
/* 2185 */           if (block.getMaterial() == materialIn) {
/*      */             
/* 2187 */             int j2 = ((Integer)iblockstate.getValue((IProperty)BlockLiquid.LEVEL)).intValue();
/* 2188 */             double d0 = (l1 + 1);
/*      */             
/* 2190 */             if (j2 < 8)
/*      */             {
...
/*      */         
/* 2319 */         TileEntity tileentity1 = this.addedTileEntityList.get(i);
/*      */         
...
/*      */         
/* 2338 */         TileEntity tileentity2 = this.addedTileEntityList.get(j);
/*      */         
...
/*      */       
/* 2599 */       EntityPlayer entityplayer = this.playerEntities.get(i);
...
/*      */     {
/* 2617 */       this.ambientTickCountdown--;
/*      */     }
/*      */     
...
/* 2625 */       EntityPlayer entityplayer1 = this.playerEntities.get(k1);
...
/*      */       
/* 2710 */       if ((block == Blocks.water || block == Blocks.flowing_water) && ((Integer)iblockstate.getValue((IProperty)BlockLiquid.LEVEL)).intValue() == 0) {
/*      */         
/* 2712 */         if (!noWaterAdj)
/*      */         {
/* 2714 */           return true;
...
/* 2815 */     for (k = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < k; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*      */       
/* 2817 */       BlockPos blockpos = pos.offset(enumfacing);
/* 2818 */       int m = getLightFor(lightType, blockpos) - j;
/*      */       
/* 2820 */       if (m > i)
/*      */       {
/* 2822 */         i = m;
...
/* 2881 */             if (j3 + k3 + l3 < 17) {
/*      */               
/* 2883 */               BlockPos.MutableBlockPos blockpos$mutableblockpos = new BlockPos.MutableBlockPos(); byte b; int m;
/*      */               EnumFacing[] arrayOfEnumFacing;
/* 2885 */               for (m = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < m; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*      */                 
...
/* 2891 */                 int l4 = Math.max(1, getBlockState((BlockPos)blockpos$mutableblockpos).getBlock().getLightOpacity());
/* 2892 */                 i3 = getLightFor(lightType, (BlockPos)blockpos$mutableblockpos);
/*      */                 
...
/*      */       
/* 3082 */       Entity entity1 = (Entity)list.get(i);
/*      */       
/* 3084 */       if (entity1 != closestTo && EntitySelectors.NOT_SPECTATING.apply(entity1)) {
/*      */         
/* 3086 */         double d1 = closestTo.getDistanceSqToEntity(entity1);
/*      */         
/* 3088 */         if (d1 <= d0) {
/*      */           
/* 3090 */           entity = entity1;
...
/* 3157 */     return (axisalignedbb != null && !checkNoEntityCollision(axisalignedbb, entityIn)) ? false : ((block.getMaterial() == Material.circuits && blockIn == Blocks.anvil) ? true : ((block.getMaterial().isReplaceable() && blockIn.canReplace(this, pos, side, itemStackIn))));
/*      */   }
/*      */ 
/*      */   
...
/* 3250 */     return (getRedstonePower(pos.down(), EnumFacing.DOWN) > 0) ? true : ((getRedstonePower(pos.up(), EnumFacing.UP) > 0) ? true : ((getRedstonePower(pos.north(), EnumFacing.NORTH) > 0) ? true : ((getRedstonePower(pos.south(), EnumFacing.SOUTH) > 0) ? true : ((getRedstonePower(pos.west(), EnumFacing.WEST) > 0) ? true : ((getRedstonePower(pos.east(), EnumFacing.EAST) > 0))))));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3259 */     int i = 0; byte b; int j;
/*      */     EnumFacing[] arrayOfEnumFacing;
/* 3261 */     for (j = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < j; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*      */       
/* 3263 */       int k = getRedstonePower(pos.offset(enumfacing), enumfacing);
/*      */       
/* 3265 */       if (k >= 15)
/*      */       {
/* 3267 */         return 15;
...
/*      */       
/* 3299 */       EntityPlayer entityplayer1 = this.playerEntities.get(i);
/*      */       
...
/*      */       
/* 3320 */       EntityPlayer entityplayer = this.playerEntities.get(i);
/*      */       
...
/*      */       
/* 3343 */       EntityPlayer entityplayer = this.playerEntities.get(i);
/*      */       
...
/*      */       
/* 3358 */       EntityPlayer entityplayer = this.playerEntities.get(i);
/*      */       
...
/* 3578 */     return biomegenbase.getEnableSnow() ? false : (canSnowAt(strikePosition, false) ? false : biomegenbase.canSpawnLightningBolt());
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*      */       }
/*      */     }
/* 3642 */     catch (Throwable throwable) {
/*      */       
...
/* 3708 */     crashreportcategory.addCrashSectionCallable("All players", new Callable<String>()
/*      */         {
/*      */           public String call()
/*      */           {
/* 3712 */             return String.valueOf(World.this.playerEntities.size()) + " total; " + World.this.playerEntities.toString();
/*      */           }
/*      */         });
/* 3715 */     crashreportcategory.addCrashSectionCallable("Chunk stats", new Callable<String>()
/*      */         {
/*      */           public String call()
/*      */           {
...
/*      */     }
/* 3727 */     catch (Throwable throwable) {
/*      */       
...
/*      */       
/* 3739 */       IWorldAccess iworldaccess = this.worldAccesses.get(i);
...
/*      */           
/* 3778 */           iblockstate.getBlock().onNeighborBlockChange(this, blockpos, iblockstate, blockIn); continue;
/*      */         } 
/* 3780 */         if (iblockstate.getBlock().isNormalCube()) {
/*      */           
