...
/*     */       
/*  71 */       this.blockRefCount++;
/*     */       
/*  73 */       if (block1.getTickRandomly())
/*     */       {
/*  75 */         this.tickRefCount++;
/*     */       }
/*     */     } 
/*     */     
...
/* 159 */     List<IBlockState> list = Block.BLOCK_STATE_IDS.getObjectList();
/* 160 */     int i = list.size();
/* 161 */     int j = 0;
/* 162 */     int k = 0;
/*     */     
...
/* 180 */             if (i2 < i) {
/*     */               
/* 182 */               IBlockState iblockstate = list.get(i2);
/*     */               
