...
/* 205 */       for (i = (arrayOfGameType = values()).length, b = 0; b < i; ) { GameType worldsettings$gametype = arrayOfGameType[b];
/*     */         
...
/*     */       int i;
/*     */       GameType[] arrayOfGameType;
/* 218 */       for (i = (arrayOfGameType = values()).length, b = 0; b < i; ) { GameType worldsettings$gametype = arrayOfGameType[b];
/*     */         
