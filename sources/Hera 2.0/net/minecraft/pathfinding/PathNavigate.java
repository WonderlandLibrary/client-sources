...
/*  91 */     BlockPos blockpos = new BlockPos((Entity)this.theEntity);
/*  92 */     int i = (int)(f + 8.0F);
/*  93 */     ChunkCache chunkcache = new ChunkCache(this.worldObj, blockpos.add(-i, -i, -i), blockpos.add(i, i, i), 0);
/*  94 */     PathEntity pathentity = this.pathFinder.createEntityPathTo((IBlockAccess)chunkcache, (Entity)this.theEntity, pos, f);
...
/* 130 */     BlockPos blockpos = (new BlockPos((Entity)this.theEntity)).up();
/* 131 */     int i = (int)(f + 16.0F);
/* 132 */     ChunkCache chunkcache = new ChunkCache(this.worldObj, blockpos.add(-i, -i, -i), blockpos.add(i, i, i), 0);
/* 133 */     PathEntity pathentity = this.pathFinder.createEntityPathTo((IBlockAccess)chunkcache, (Entity)this.theEntity, entityIn, f);
...
/* 204 */         Vec3 vec31 = this.currentPath.getVectorFromIndex((Entity)this.theEntity, this.currentPath.getCurrentPathIndex());
/*     */         
...
/* 212 */       if (!noPath()) {
/*     */         
/* 214 */         Vec3 vec32 = this.currentPath.getPosition((Entity)this.theEntity);
/*     */         
/* 216 */         if (vec32 != null) {
/*     */           
...
/* 219 */           List<AxisAlignedBB> list = this.worldObj.getCollidingBoundingBoxes((Entity)this.theEntity, axisalignedbb1.addCoord(0.0D, -1.0D, 0.0D));
/* 220 */           double d0 = -1.0D;
...
/*     */       
/* 252 */       Vec3 vec31 = this.currentPath.getVectorFromIndex((Entity)this.theEntity, k);
/*     */       
...
/*     */       
/* 266 */       if (isDirectPathBetweenPoints(vec3, this.currentPath.getVectorFromIndex((Entity)this.theEntity, i1), j1, k1, l)) {
/*     */         
