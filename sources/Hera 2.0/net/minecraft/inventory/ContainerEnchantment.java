...
/*     */       {
/*  80 */         addSlotToContainer(new Slot((IInventory)playerInv, j + i * 9 + 9, 8 + j * 18, 84 + i * 18));
/*     */       }
/*     */     } 
/*     */     
/*  84 */     for (int k = 0; k < 9; k++)
/*     */     {
/*  86 */       addSlotToContainer(new Slot((IInventory)playerInv, k, 8 + k * 18, 142));
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 111 */       ICrafting icrafting = this.crafters.get(i);
...
/*     */                 
/* 220 */                 EnchantmentData enchantmentdata = list.get(this.rand.nextInt(list.size()));
...
/* 264 */           if (flag)
/*     */           {
/* 266 */             itemstack.setItem((Item)Items.enchanted_book);
/*     */           }
/*     */           
/* 269 */           for (int j = 0; j < list.size(); j++) {
/*     */             
/* 271 */             EnchantmentData enchantmentdata = list.get(j);
/*     */             
/* 273 */             if (flag) {
/*     */               
...
/* 350 */     return (this.worldPointer.getBlockState(this.position).getBlock() != Blocks.enchanting_table) ? false : ((playerIn.getDistanceSq(this.position.getX() + 0.5D, this.position.getY() + 0.5D, this.position.getZ() + 0.5D) <= 64.0D));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 359 */     Slot slot = this.inventorySlots.get(index);
/*     */     
