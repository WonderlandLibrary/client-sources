...
/*     */         
/* 174 */         Slot slot = this.inventorySlots.get(slotId);
/*     */         
...
/*     */         }
/*     */         
/* 262 */         Slot slot6 = this.inventorySlots.get(slotId);
/*     */         
...
/*     */         }
/*     */         
/* 287 */         Slot slot7 = this.inventorySlots.get(slotId);
/*     */         
/* 289 */         if (slot7 != null)
/*     */         {
...
/*     */       
/* 392 */       Slot slot5 = this.inventorySlots.get(slotId);
/*     */       
...
/*     */       
/* 437 */       Slot slot4 = this.inventorySlots.get(slotId);
/*     */       
...
/*     */       
/* 448 */       Slot slot3 = this.inventorySlots.get(slotId);
/*     */       
...
/*     */       
/* 459 */       Slot slot2 = this.inventorySlots.get(slotId);
...
/*     */             
/* 471 */             Slot slot8 = this.inventorySlots.get(i3);
/*     */             
...
/*     */         
/* 611 */         Slot slot = this.inventorySlots.get(i);
...
/*     */         
/* 658 */         Slot slot1 = this.inventorySlots.get(i);
...
/* 707 */     return (dragModeIn == 0) ? true : ((dragModeIn == 1) ? true : ((dragModeIn == 2 && player.capabilities.isCreativeMode)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     {
/* 728 */       i = flag | (((slotIn.getStack()).stackSize + (stackSizeMatters ? 0 : stack.stackSize) <= stack.getMaxStackSize()) ? 1 : 0);
/*     */     }
/*     */     
/* 731 */     return i;
/*     */   }
...
/*     */       
/*     */       case 2:
/* 751 */         p_94525_2_.stackSize = p_94525_2_.getItem().getItemStackLimit(); break;
/* 752 */     }  p_94525_2_.stackSize += 
/*     */       
/* 754 */       p_94525_3_;
/*     */   }
/*     */ 
