...
/*     */     {
/*  80 */       this.thePlayer.triggerAchievement((StatBase)AchievementList.buildWorkBench);
/*     */     }
/*     */     
/*  83 */     if (stack.getItem() instanceof ItemPickaxe)
/*     */     {
/*  85 */       this.thePlayer.triggerAchievement((StatBase)AchievementList.buildPickaxe);
/*     */     }
/*     */     
/*  88 */     if (stack.getItem() == Item.getItemFromBlock(Blocks.furnace))
/*     */     {
/*  90 */       this.thePlayer.triggerAchievement((StatBase)AchievementList.buildFurnace);
/*     */     }
/*     */     
/*  93 */     if (stack.getItem() instanceof net.minecraft.item.ItemHoe)
/*     */     {
/*  95 */       this.thePlayer.triggerAchievement((StatBase)AchievementList.buildHoe);
/*     */     }
/*     */     
/*  98 */     if (stack.getItem() == Items.bread)
/*     */     {
/* 100 */       this.thePlayer.triggerAchievement((StatBase)AchievementList.makeBread);
/*     */     }
/*     */     
/* 103 */     if (stack.getItem() == Items.cake)
/*     */     {
/* 105 */       this.thePlayer.triggerAchievement((StatBase)AchievementList.bakeCake);
/*     */     }
/*     */     
/* 108 */     if (stack.getItem() instanceof ItemPickaxe && ((ItemPickaxe)stack.getItem()).getToolMaterial() != Item.ToolMaterial.WOOD)
/*     */     {
/* 110 */       this.thePlayer.triggerAchievement((StatBase)AchievementList.buildBetterPickaxe);
/*     */     }
/*     */     
/* 113 */     if (stack.getItem() instanceof net.minecraft.item.ItemSword)
/*     */     {
/* 115 */       this.thePlayer.triggerAchievement((StatBase)AchievementList.buildSword);
/*     */     }
/*     */     
/* 118 */     if (stack.getItem() == Item.getItemFromBlock(Blocks.enchanting_table))
/*     */     {
/* 120 */       this.thePlayer.triggerAchievement((StatBase)AchievementList.enchantments);
/*     */     }
/*     */     
/* 123 */     if (stack.getItem() == Item.getItemFromBlock(Blocks.bookshelf))
/*     */     {
/* 125 */       this.thePlayer.triggerAchievement((StatBase)AchievementList.bookcase);
/*     */     }
/*     */     
/* 128 */     if (stack.getItem() == Items.golden_apple && stack.getMetadata() == 1)
/*     */     {
/* 130 */       this.thePlayer.triggerAchievement((StatBase)AchievementList.overpowered);
/*     */     }
/*     */   }
/*     */ 
/*     */   
