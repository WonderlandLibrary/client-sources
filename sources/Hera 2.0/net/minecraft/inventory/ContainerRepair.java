...
/*     */       {
/* 133 */         addSlotToContainer(new Slot((IInventory)playerInventory, j + i * 9 + 9, 8 + j * 18, 84 + i * 18));
/*     */       }
/*     */     } 
/*     */     
/* 137 */     for (int k = 0; k < 9; k++)
/*     */     {
/* 139 */       addSlotToContainer(new Slot((IInventory)playerInventory, k, 8 + k * 18, 142));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */           
/*     */           int l4;
/* 205 */           for (l4 = 0; j4 > 0 && l4 < itemstack2.stackSize; l4++) {
/*     */             
...
/* 245 */           Iterator<Integer> iterator1 = map1.keySet().iterator();
/*     */           
...
/*     */               
/* 254 */               int i6, k5 = map.containsKey(Integer.valueOf(i5)) ? ((Integer)map.get(Integer.valueOf(i5))).intValue() : 0;
...
/*     */               }
/*     */               
/* 276 */               Iterator<Integer> iterator = map.keySet().iterator();
/*     */               
...
/* 426 */     return (this.theWorld.getBlockState(this.selfPosition).getBlock() != Blocks.anvil) ? false : ((playerIn.getDistanceSq(this.selfPosition.getX() + 0.5D, this.selfPosition.getY() + 0.5D, this.selfPosition.getZ() + 0.5D) <= 64.0D));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 435 */     Slot slot = this.inventorySlots.get(index);
/*     */     
