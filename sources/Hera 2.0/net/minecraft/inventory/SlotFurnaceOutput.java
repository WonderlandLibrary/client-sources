...
/*  92 */         i -= k;
/*  93 */         this.thePlayer.worldObj.spawnEntityInWorld((Entity)new EntityXPOrb(this.thePlayer.worldObj, this.thePlayer.posX, this.thePlayer.posY + 0.5D, this.thePlayer.posZ + 0.5D, k));
/*     */       } 
/*     */     } 
/*     */     
...
/*     */     {
/* 101 */       this.thePlayer.triggerAchievement((StatBase)AchievementList.acquireIron);
/*     */     }
/*     */     
/* 104 */     if (stack.getItem() == Items.cooked_fish)
/*     */     {
/* 106 */       this.thePlayer.triggerAchievement((StatBase)AchievementList.cookFish);
/*     */     }
/*     */   }
/*     */ }
