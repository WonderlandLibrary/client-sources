...
/*  97 */     Iterator<Integer> iterator = enchMap.keySet().iterator();
/*     */     
...
/* 109 */         nbttaglist.appendTag((NBTBase)nbttagcompound);
/*     */         
...
/*     */       {
/* 122 */         stack.setTagInfo("ench", (NBTBase)nbttaglist);
/*     */       }
/*     */     }
...
/*     */ 
/*     */     
/* 142 */     int i = 0; byte b; int j;
/*     */     ItemStack[] arrayOfItemStack;
/* 144 */     for (j = (arrayOfItemStack = stacks).length, b = 0; b < j; ) { ItemStack itemstack = arrayOfItemStack[b];
/*     */       
/* 146 */       int k = getEnchantmentLevel(enchID, itemstack);
/*     */       
/* 148 */       if (k > i)
/*     */       {
/* 150 */         i = k;
...
/*     */     int i;
/*     */     ItemStack[] arrayOfItemStack;
/* 188 */     for (i = (arrayOfItemStack = stacks).length, b = 0; b < i; ) { ItemStack itemstack = arrayOfItemStack[b];
/*     */       
...
/*     */     }
/*     */     
/* 233 */     if (p_151384_1_ instanceof net.minecraft.entity.player.EntityPlayer)
/*     */     {
...
/*     */     }
/*     */     
/* 249 */     if (p_151385_0_ instanceof net.minecraft.entity.player.EntityPlayer)
/*     */     {
...
/*     */     int i;
/*     */     ItemStack[] arrayOfItemStack;
/* 345 */     for (i = (arrayOfItemStack = p_92099_1_.getInventory()).length, b = 0; b < i; ) { ItemStack itemstack = arrayOfItemStack[b];
/*     */       
...
/* 377 */     return (p_77514_1_ == 0) ? Math.max(j / 3, 1) : ((p_77514_1_ == 1) ? (j * 2 / 3 + 1) : Math.max(j, p_77514_2_ * 2));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */             
/* 452 */             Integer integer = iterator.next();
...
/* 487 */     boolean flag = (p_77505_1_.getItem() == Items.book); byte b; int i;
/*     */     Enchantment[] arrayOfEnchantment;
/* 489 */     for (i = (arrayOfEnchantment = Enchantment.enchantmentsBookList).length, b = 0; b < i; ) { Enchantment enchantment = arrayOfEnchantment[b];
/*     */       
/* 491 */       if (enchantment != null && (enchantment.type.canEnchantItem(item) || flag))
/*     */       {
/* 493 */         for (int j = enchantment.getMinLevel(); j <= enchantment.getMaxLevel(); j++) {
/*     */           
/* 495 */           if (p_77505_0_ >= enchantment.getMinEnchantability(j) && p_77505_0_ <= enchantment.getMaxEnchantability(j)) {
/*     */             
/* 497 */             if (map == null)
/*     */             {
...
/*     */             }
/*     */             
/* 502 */             map.put(Integer.valueOf(enchantment.effectId), new EnchantmentData(enchantment, j));
/*     */           } 
/*     */         } 
/*     */       }
/*     */       b++; }
