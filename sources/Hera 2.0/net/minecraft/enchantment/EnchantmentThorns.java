...
/* 48 */     return (stack.getItem() instanceof net.minecraft.item.ItemArmor) ? true : super.canApply(stack);
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 62 */       if (attacker != null) {
/*    */         
/* 64 */         attacker.attackEntityFrom(DamageSource.causeThornsDamage((Entity)user), func_92095_b(level, random));
...
/* 81 */     return (p_92094_0_ <= 0) ? false : ((p_92094_1_.nextFloat() < 0.15F * p_92094_0_));
/*    */   }
/*    */ 
/*    */   
