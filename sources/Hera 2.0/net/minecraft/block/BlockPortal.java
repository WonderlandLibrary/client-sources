...
/* 247 */     return getDefaultState().withProperty((IProperty)AXIS, ((meta & 0x3) == 2) ? (Comparable)EnumFacing.Axis.Z : (Comparable)EnumFacing.Axis.X);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 255 */     return getMetaForAxis((EnumFacing.Axis)state.getValue((IProperty)AXIS));
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 260 */     return new BlockState(this, new IProperty[] { (IProperty)AXIS });
/*     */   }
/*     */ 
/*     */   
...
/* 267 */     LoadingCache<BlockPos, BlockWorldState> loadingcache = BlockPattern.func_181627_a(p_181089_1_, true);
/*     */     
...
/* 283 */     BlockPos blockpos = blockportal$size.field_150861_f.up(blockportal$size.func_181100_a() - 1); byte b; int i;
/*     */     EnumFacing.AxisDirection[] arrayOfAxisDirection1;
/* 285 */     for (i = (arrayOfAxisDirection1 = EnumFacing.AxisDirection.values()).length, b = 0; b < i; ) { EnumFacing.AxisDirection enumfacing$axisdirection = arrayOfAxisDirection1[b];
/*     */       
...
/*     */       
/* 289 */       for (int k = 0; k < blockportal$size.func_181101_b(); k++) {
/*     */         
/* 291 */         for (int m = 0; m < blockportal$size.func_181100_a(); m++) {
/*     */           
/* 293 */           BlockWorldState blockworldstate = blockpattern$patternhelper.translateOffset(k, m, 1);
/*     */           
/* 295 */           if (blockworldstate.getBlockState() != null && blockworldstate.getBlockState().getBlock().getMaterial() != Material.air)
/*     */           {
/* 297 */             aint[enumfacing$axisdirection.ordinal()] = aint[enumfacing$axisdirection.ordinal()] + 1;
/*     */           }
/*     */         } 
/*     */       } 
/*     */       b++; }
...
/* 305 */     for (int j = (arrayOfAxisDirection2 = EnumFacing.AxisDirection.values()).length; i < j; ) { EnumFacing.AxisDirection enumfacing$axisdirection2 = arrayOfAxisDirection2[i];
/*     */       
...
/* 401 */       label38: for (this.field_150862_g = 0; this.field_150862_g < 21; this.field_150862_g++) {
/*     */         
...
/*     */         {
/* 479 */           this.world.setBlockState(blockpos.up(j), Blocks.portal.getDefaultState().withProperty((IProperty)BlockPortal.AXIS, (Comparable)this.axis), 2);
/*     */         }
/*     */       } 
/*     */     }
/*     */   }
