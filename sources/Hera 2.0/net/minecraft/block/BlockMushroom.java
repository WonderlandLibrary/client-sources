...
/*  77 */       return (iblockstate.getBlock() == Blocks.mycelium) ? true : ((iblockstate.getBlock() == Blocks.dirt && iblockstate.getValue((IProperty)BlockDirt.VARIANT) == BlockDirt.DirtType.PODZOL) ? true : ((worldIn.getLight(pos) < 13 && canPlaceBlockOn(iblockstate.getBlock()))));
/*     */     } 
/*     */ 
/*     */     
/*  81 */     return false;
...
/*     */       
/*  92 */       worldGenBigMushroom = new WorldGenBigMushroom(Blocks.brown_mushroom_block);
/*     */     }
/*  94 */     else if (this == Blocks.red_mushroom) {
/*     */       
/*  96 */       worldGenBigMushroom = new WorldGenBigMushroom(Blocks.red_mushroom_block);
/*     */     } 
/*     */     
/*  99 */     if (worldGenBigMushroom != null && worldGenBigMushroom.generate(worldIn, rand, pos))
/*     */     {
/* 101 */       return true;
/*     */     }
/*     */ 
