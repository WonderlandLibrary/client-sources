...
/*  43 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)NORTH, Boolean.valueOf(false)).withProperty((IProperty)EAST, Boolean.valueOf(false)).withProperty((IProperty)SOUTH, Boolean.valueOf(false)).withProperty((IProperty)WEST, Boolean.valueOf(false)));
...
/*  52 */     boolean flag = canConnectTo((IBlockAccess)worldIn, pos.north());
/*  53 */     boolean flag1 = canConnectTo((IBlockAccess)worldIn, pos.south());
/*  54 */     boolean flag2 = canConnectTo((IBlockAccess)worldIn, pos.west());
/*  55 */     boolean flag3 = canConnectTo((IBlockAccess)worldIn, pos.east());
/*  56 */     float f = 0.375F;
/*  57 */     float f1 = 0.625F;
/*  58 */     float f2 = 0.375F;
/*  59 */     float f3 = 0.625F;
...
/* 164 */     return (block == Blocks.barrier) ? false : (((!(block instanceof BlockFence) || block.blockMaterial != this.blockMaterial) && !(block instanceof BlockFenceGate)) ? ((block.blockMaterial.isOpaque() && block.isFullCube()) ? ((block.blockMaterial != Material.gourd)) : false) : true);
/*     */   }
/*     */ 
/*     */   
...
/* 196 */     return new BlockState(this, new IProperty[] { (IProperty)NORTH, (IProperty)EAST, (IProperty)WEST, (IProperty)SOUTH });
/*     */   }
/*     */ }
