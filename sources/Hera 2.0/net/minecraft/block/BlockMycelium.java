...
/*    */           
/* 58 */           if (iblockstate.getBlock() == Blocks.dirt && iblockstate.getValue((IProperty)BlockDirt.VARIANT) == BlockDirt.DirtType.DIRT && worldIn.getLightFromNeighbors(blockpos.up()) >= 4 && block.getLightOpacity() <= 2)
/*    */           {
...
/* 96 */     return new BlockState(this, new IProperty[] { (IProperty)SNOWY });
/*    */   }
/*    */ }
