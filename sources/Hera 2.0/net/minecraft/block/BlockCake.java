...
/*  51 */     float f = 0.0625F;
/*  52 */     float f1 = (1 + ((Integer)state.getValue((IProperty)BITES)).intValue() * 2) / 16.0F;
/*  53 */     float f2 = 0.5F;
...
/*  92 */       int i = ((Integer)state.getValue((IProperty)BITES)).intValue();
/*     */       
/*  94 */       if (i < 6) {
/*     */         
/*  96 */         worldIn.setBlockState(pos, state.withProperty((IProperty)BITES, Integer.valueOf(i + 1)), 3);
/*     */       }
/*     */       else {
/*     */         
...
/* 157 */     return getDefaultState().withProperty((IProperty)BITES, Integer.valueOf(meta));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 165 */     return ((Integer)state.getValue((IProperty)BITES)).intValue();
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 170 */     return new BlockState(this, new IProperty[] { (IProperty)BITES });
/*     */   }
/*     */ 
/*     */   
/*     */   public int getComparatorInputOverride(World worldIn, BlockPos pos) {
/* 175 */     return (7 - ((Integer)worldIn.getBlockState(pos).getValue((IProperty)BITES)).intValue()) * 2;
/*     */   }
/*     */ 
/*     */   
