...
/*     */       
/* 130 */       TileEntityPiston tileentitypiston = getTileEntity((IBlockAccess)worldIn, pos);
/*     */       
...
/* 161 */     TileEntityPiston tileentitypiston = getTileEntity((IBlockAccess)worldIn, pos);
/*     */     
...
/* 289 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)BlockPistonExtension.getFacing(meta)).withProperty((IProperty)TYPE, ((meta & 0x8) > 0) ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 297 */     int i = 0;
/* 298 */     i |= ((EnumFacing)state.getValue((IProperty)FACING)).getIndex();
/*     */     
/* 300 */     if (state.getValue((IProperty)TYPE) == BlockPistonExtension.EnumPistonType.STICKY)
/*     */     {
/* 302 */       i |= 0x8;
/*     */     }
/*     */     
...
/* 310 */     return new BlockState(this, new IProperty[] { (IProperty)FACING, (IProperty)TYPE });
/*     */   }
/*     */ }
