...
/* 132 */     int l = 0;
/*     */     
/* 134 */     for (Object enumfacing0 : EnumFacing.Plane.HORIZONTAL) {
/*     */       
/* 136 */       EnumFacing enumfacing = (EnumFacing)enumfacing0;
/* 137 */       BlockPos blockpos = pos1.offset(enumfacing);
...
/*     */         continue;
/*     */       } 
/* 152 */       if (!worldIn.getBlockState(blockpos).getBlock().isNormalCube() && flag && pos1.getY() <= pos2.getY())
/*     */       {
...
/* 176 */     if (i != j) {
/*     */       
/* 178 */       state = state.withProperty((IProperty)POWER, Integer.valueOf(j));
/*     */       
...
/*     */       }
/*     */       
/* 185 */       this.blocksNeedingUpdate.add(pos1); byte b; int m;
/*     */       EnumFacing[] arrayOfEnumFacing;
/* 187 */       for (m = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < m; ) { EnumFacing enumfacing1 = arrayOfEnumFacing[b];
/*     */         
...
/*     */       
/* 204 */       worldIn.notifyNeighborsOfStateChange(pos, this); byte b; int i;
/*     */       EnumFacing[] arrayOfEnumFacing;
/* 206 */       for (i = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < i; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*     */         
...
/* 253 */       for (i = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < i; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*     */         
...
/*     */ 
/*     */     
/* 289 */     int i = ((Integer)worldIn.getBlockState(pos).getValue((IProperty)POWER)).intValue();
...
/*     */ 
/*     */     
/* 334 */     int i = ((Integer)state.getValue((IProperty)POWER)).intValue();
/*     */     
/* 336 */     if (i == 0)
/*     */     {
/* 338 */       return 0;
...
/* 381 */     return (!flag1 && flag && canConnectUpwardsTo(worldIn, blockpos.up())) ? true : (canConnectTo(iblockstate, side) ? true : ((block == Blocks.powered_repeater && iblockstate.getValue((IProperty)BlockRedstoneDiode.FACING) == side) ? true : ((!flag && canConnectUpwardsTo(worldIn, blockpos.down())))));
/*     */   }
/*     */ 
/*     */   
...
/* 391 */     return canConnectTo(state, (EnumFacing)null);
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 404 */       EnumFacing enumfacing = (EnumFacing)blockState.getValue((IProperty)BlockRedstoneRepeater.FACING);
...
/* 452 */     int i = ((Integer)state.getValue((IProperty)POWER)).intValue();
/*     */     
/* 454 */     if (i != 0) {
/*     */       
