...
/*     */             
/*  71 */             if (iblockstate.getBlock().getMaterial() == Material.leaves && !((Boolean)iblockstate.getValue((IProperty)CHECK_DECAY)).booleanValue())
/*     */             {
/*  73 */               worldIn.setBlockState(blockpos, iblockstate.withProperty((IProperty)CHECK_DECAY, Boolean.valueOf(true)), 4);
/*     */             }
/*     */           } 
/*     */         } 
/*     */       } 
...
/*     */     {
/*  85 */       if (((Boolean)state.getValue((IProperty)CHECK_DECAY)).booleanValue() && ((Boolean)state.getValue((IProperty)DECAYABLE)).booleanValue()) {
/*     */         
/*  87 */         int i = 4;
/*  88 */         int j = i + 1;
/*  89 */         int k = pos.getX();
...
/*     */                 
/* 111 */                 Block block = worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(k + i2, l + j2, i1 + k2)).getBlock();
/*     */                 
...
/* 180 */         if (l2 >= 0) {
/*     */           
/* 182 */           worldIn.setBlockState(pos, state.withProperty((IProperty)CHECK_DECAY, Boolean.valueOf(false)), 4);
/*     */         }
/*     */         else {
/*     */           
...
/* 194 */     if (worldIn.canLightningStrike(pos.up()) && !World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.down()) && rand.nextInt(15) == 1) {
/*     */       
...
/* 247 */         spawnAsEntity(worldIn, pos, new ItemStack(item, 1, damageDropped(state)));
/*     */       } 
/*     */       
/* 250 */       i = 200;
/*     */       
