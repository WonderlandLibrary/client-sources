...
/*     */       
/* 152 */       int i = ((Integer)state.getValue((IProperty)AGE)).intValue();
/*     */       
/* 154 */       if (i >= 7) {
/*     */         
/* 156 */         int j = 3 + fortune;
...
/* 174 */     return (((Integer)state.getValue((IProperty)AGE)).intValue() == 7) ? getCrop() : getSeed();
/*     */   }
/*     */ 
/*     */   
...
/* 187 */     return (((Integer)state.getValue((IProperty)AGE)).intValue() < 7);
/*     */   }
/*     */ 
/*     */   
...
/* 205 */     return getDefaultState().withProperty((IProperty)AGE, Integer.valueOf(meta));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 213 */     return ((Integer)state.getValue((IProperty)AGE)).intValue();
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 218 */     return new BlockState(this, new IProperty[] { (IProperty)AGE });
/*     */   }
/*     */ }
