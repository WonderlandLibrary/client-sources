...
/* 113 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)placer.getHorizontalFacing());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 122 */     state = state.withProperty((IProperty)FACING, (Comparable)enumfacing);
...
/* 189 */     EnumFacing enumfacing = (EnumFacing)state.getValue((IProperty)FACING);
...
/* 208 */         if (block2 == this) {
/*     */           
/* 210 */           enumfacing2 = (EnumFacing)iblockstate2.getValue((IProperty)FACING);
/*     */         }
/*     */         else {
/*     */           
/* 214 */           enumfacing2 = (EnumFacing)iblockstate3.getValue((IProperty)FACING);
/*     */         } 
/*     */         
...
/* 244 */       if (block == this) {
/*     */         
/* 246 */         enumfacing1 = (EnumFacing)iblockstate.getValue((IProperty)FACING);
/*     */       }
/*     */       else {
/*     */         
/* 250 */         enumfacing1 = (EnumFacing)iblockstate1.getValue((IProperty)FACING);
/*     */       } 
/*     */       
...
/*     */     } 
/*     */     
/* 272 */     state = state.withProperty((IProperty)FACING, (Comparable)enumfacing);
...
/*     */     {
/* 306 */       return state.withProperty((IProperty)FACING, (Comparable)enumfacing.getOpposite());
/*     */     }
/*     */ 
/*     */     
/* 310 */     EnumFacing enumfacing2 = (EnumFacing)state.getValue((IProperty)FACING);
/*     */     
...
/*     */     }
/*     */     
/* 327 */     return state.withProperty((IProperty)FACING, (Comparable)enumfacing2);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       
/* 424 */       InventoryHelper.dropInventoryItems(worldIn, pos, (IInventory)tileentity);
...
/*     */       
/* 443 */       playerIn.displayGUIChest((IInventory)ilockablecontainer);
/*     */       
...
/*     */ 
/*     */     
/* 469 */     TileEntityChest tileEntityChest = (TileEntityChest)tileentity;
/*     */     
...
/*     */             
/* 496 */             inventoryLargeChest = new InventoryLargeChest("container.chestDouble", (ILockableContainer)tileEntityChest, (ILockableContainer)tileentity1);
/*     */             
/*     */             continue;
/*     */           } 
/* 500 */           inventoryLargeChest = new InventoryLargeChest("container.chestDouble", (ILockableContainer)tileentity1, (ILockableContainer)inventoryLargeChest);
/*     */         } 
/*     */       } 
/*     */     } 
/*     */ 
/*     */     
/* 506 */     return (ILockableContainer)inventoryLargeChest;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 516 */     return (TileEntity)new TileEntityChest();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 584 */     return Container.calcRedstoneFromInventory((IInventory)getLockableContainer(worldIn, pos));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 599 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)enumfacing);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 607 */     return ((EnumFacing)state.getValue((IProperty)FACING)).getIndex();
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 612 */     return new BlockState(this, new IProperty[] { (IProperty)FACING });
/*     */   }
/*     */ }
