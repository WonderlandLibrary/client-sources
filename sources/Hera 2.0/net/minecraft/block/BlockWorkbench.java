...
/* 64 */       return (IChatComponent)new ChatComponentTranslation(String.valueOf(Blocks.crafting_table.getUnlocalizedName()) + ".name", new Object[0]);
/*    */     }
/*    */ 
/*    */     
/*    */     public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
/* 69 */       return (Container)new ContainerWorkbench(playerInventory, this.world, this.position);
/*    */     }
/*    */ 
/*    */     
