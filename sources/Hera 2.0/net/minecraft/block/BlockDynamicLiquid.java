...
/*     */         
/* 191 */         if (!isBlocked(worldIn, blockpos, iblockstate) && (iblockstate.getBlock().getMaterial() != this.blockMaterial || ((Integer)iblockstate.getValue((IProperty)LEVEL)).intValue() > 0)) {
/*     */           
...
/* 216 */     int i = 1000;
/* 217 */     Set<EnumFacing> set = EnumSet.noneOf(EnumFacing.class);
/*     */     
...
/*     */       
/* 225 */       if (!isBlocked(worldIn, blockpos, iblockstate) && (iblockstate.getBlock().getMaterial() != this.blockMaterial || ((Integer)iblockstate.getValue((IProperty)LEVEL)).intValue() > 0)) {
/*     */         int j;
/*     */ 
/*     */         
...
/* 257 */     return (!(block instanceof BlockDoor) && block != Blocks.standing_sign && block != Blocks.ladder && block != Blocks.reeds) ? ((block.blockMaterial == Material.portal) ? true : block.blockMaterial.blocksMovement()) : true;
/*     */   }
/*     */ 
/*     */   
/*     */   protected int checkAdjacentBlock(World worldIn, BlockPos pos, int currentMinLevel) {
/* 262 */     int i = getLevel((IBlockAccess)worldIn, pos);
/*     */     
/* 264 */     if (i < 0)
/*     */     {
