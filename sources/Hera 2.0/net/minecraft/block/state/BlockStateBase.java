...
/*  16 */   private static final Function MAP_ENTRY_TO_STRING = new Function()
/*     */     {
...
/*  28 */         return String.valueOf(iproperty.getName()) + "=" + iproperty.getName((Comparable)p_apply_1_.getValue());
/*     */       }
/*     */ 
/*     */       
...
/*  96 */     Iterator<E> iterator = values.iterator();
/*     */     
...
/* 122 */       COMMA_JOINER.appendTo(stringbuilder, Iterables.transform((Iterable)getProperties().entrySet(), MAP_ENTRY_TO_STRING));
