...
/*     */     } 
/*     */     
/* 181 */     if (((Integer)worldIn.getBlockState(pos).getValue((IProperty)LEVEL)).intValue() >= 8)
/*     */     {
...
/*     */       
/* 313 */       boolean flag = false; byte b; int i;
/*     */       EnumFacing[] arrayOfEnumFacing;
/* 315 */       for (i = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < i; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*     */         
