...
/*  61 */     setBlockBoundsBasedOnState((IBlockAccess)worldIn, pos);
...
/*  87 */     return World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.down());
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 113 */       if (!World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.down()))
/*     */       {
/* 115 */         flag = true;
/*     */       }
/*     */       
/* 118 */       if (blockrailbase$enumraildirection == EnumRailDirection.ASCENDING_EAST && !World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.east())) {
/*     */         
/* 120 */         flag = true;
/*     */       }
/* 122 */       else if (blockrailbase$enumraildirection == EnumRailDirection.ASCENDING_WEST && !World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.west())) {
/*     */         
/* 124 */         flag = true;
/*     */       }
/* 126 */       else if (blockrailbase$enumraildirection == EnumRailDirection.ASCENDING_NORTH && !World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.north())) {
/*     */         
/* 128 */         flag = true;
/*     */       }
/* 130 */       else if (blockrailbase$enumraildirection == EnumRailDirection.ASCENDING_SOUTH && !World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.south())) {
/*     */         
/* 132 */         flag = true;
/*     */       } 
/*     */       
...
/*     */     
/* 197 */     private static final EnumRailDirection[] META_LOOKUP = new EnumRailDirection[(values()).length];
/*     */ 
/*     */     
...
/* 238 */       for (i = (arrayOfEnumRailDirection = values()).length, b = 0; b < i; ) { EnumRailDirection blockrailbase$enumraildirection = arrayOfEnumRailDirection[b];
/*     */         
...
/*     */         
/* 326 */         Rail blockrailbase$rail = findRailAt(this.field_150657_g.get(i));
/*     */         
...
/*     */         
/* 350 */         BlockRailBase.this.getClass(); return new Rail(this.world, pos, iblockstate);
/*     */       } 
/*     */ 
/*     */       
...
/*     */         
/* 359 */         BlockRailBase.this.getClass(); return new Rail(this.world, lvt_2_1_, iblockstate);
/*     */       } 
/*     */ 
/*     */       
/* 363 */       lvt_2_1_ = pos.down();
/* 364 */       iblockstate = this.world.getBlockState(lvt_2_1_);
/* 365 */       BlockRailBase.this.getClass(); return BlockRailBase.isRailBlock(iblockstate) ? new Rail(this.world, lvt_2_1_, iblockstate) : null;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/* 379 */         BlockPos blockpos = this.field_150657_g.get(i);
/*     */         
...
/*     */           
/* 654 */           Rail blockrailbase$rail = findRailAt(this.field_150657_g.get(i));
/*     */           
