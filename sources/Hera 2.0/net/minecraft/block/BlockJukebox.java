...
/* 150 */     return getDefaultState().withProperty((IProperty)HAS_RECORD, Boolean.valueOf((meta > 0)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 158 */     return ((Boolean)state.getValue((IProperty)HAS_RECORD)).booleanValue() ? 1 : 0;
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 163 */     return new BlockState(this, new IProperty[] { (IProperty)HAS_RECORD });
/*     */   }
/*     */   
...
/*     */       {
/* 190 */         compound.setTag("RecordItem", (NBTBase)getRecord().writeToNBT(new NBTTagCompound()));
/*     */       }
/*     */     }
/*     */ 
/*     */     
