...
/*      */ 
/*      */       
/*  155 */       BufferedImage bufferedimage = ImageIO.read(inputstream);
...
/*  219 */     blockPalettes = new int[256][1];
/*      */     
...
/*      */     } 
/*      */     
/*  239 */     String[] astring2 = (String[])map.keySet().toArray((Object[])new String[map.size()]);
...
/*  275 */         if (i1 >= 0 && i1 <= 255) {
/*      */           
/*  277 */           if (i1 != Block.getIdFromBlock((Block)Blocks.grass) && i1 != Block.getIdFromBlock((Block)Blocks.tallgrass) && i1 != Block.getIdFromBlock((Block)Blocks.leaves) && i1 != Block.getIdFromBlock(Blocks.vine))
/*      */           {
/*  279 */             if (k == -1)
/*      */             {
...
/*  333 */       return i;
/*      */     }
/*  335 */     catch (NumberFormatException var4) {
/*      */       
...
/*  368 */       s = String.valueOf(p_getCustomColors_0_) + s;
...
/*      */ 
/*      */       
/*  393 */       int[] aint = TextureUtil.readImageData(Config.getResourceManager(), resourcelocation);
/*      */       
/*  395 */       if (aint == null)
/*      */       {
/*  397 */         return null;
...
/*      */     
/*      */     }
/*  411 */     catch (FileNotFoundException var5) {
/*      */       
/*  413 */       return null;
/*      */     }
...
/*      */                 
/*  607 */                 i2 = ColorizerFoliage.getFoliageColorPine(); break;
/*      */               } 
/*  609 */               if ((p_getSmoothColorMultiplier_6_ & 0x3) == 2) {
/*      */                 
...
/*  643 */     return (p_getFluidColor_0_.getMaterial() != Material.water) ? p_getFluidColor_0_.colorMultiplier(p_getFluidColor_1_, p_getFluidColor_2_) : ((waterColors != null) ? (Config.isSmoothBiomes() ? getSmoothColor(waterColors, p_getFluidColor_1_, p_getFluidColor_2_.getX(), p_getFluidColor_2_.getY(), p_getFluidColor_2_.getZ(), 3, 1) : getCustomColor(waterColors, p_getFluidColor_1_, p_getFluidColor_2_)) : (!Config.isSwampColors() ? 16777215 : p_getFluidColor_0_.colorMultiplier(p_getFluidColor_1_, p_getFluidColor_2_)));
/*      */   }
/*      */ 
/*      */   
...
/*      */ 
/*      */     
/*  718 */     Object object = p_getRedstoneLevel_0_.getValue((IProperty)BlockRedstoneWire.POWER);
/*      */     
...
/*  734 */     return (redstoneColors == null) ? -1 : ((p_getRedstoneColor_0_ >= 0 && p_getRedstoneColor_0_ <= 15) ? (redstoneColors[p_getRedstoneColor_0_] & 0xFFFFFF) : -1);
/*      */   }
/*      */ 
/*      */   
...
/*      */       
/*  741 */       int i = getFluidColor((Block)Blocks.water, p_updateWaterFX_1_, new BlockPos(p_updateWaterFX_2_, p_updateWaterFX_4_, p_updateWaterFX_6_));
/*  742 */       int j = i >> 16 & 0xFF;
/*  743 */       int k = i >> 8 & 0xFF;
/*  744 */       int l = i & 0xFF;
...
/*      */       
/*      */       case 0:
/* 1109 */         minecraft = Minecraft.getMinecraft();
/* 1110 */         p_getWorldFogColor_0_ = getFogColor(p_getWorldFogColor_0_, (IBlockAccess)minecraft.theWorld, p_getWorldFogColor_2_.posX, p_getWorldFogColor_2_.posY + 1.0D, p_getWorldFogColor_2_.posZ);
/*      */         break;
/*      */       
/*      */       case 1:
...
/*      */       
/*      */       case 0:
/* 1127 */         minecraft = Minecraft.getMinecraft();
/* 1128 */         p_getWorldSkyColor_0_ = getSkyColor(p_getWorldSkyColor_0_, (IBlockAccess)minecraft.theWorld, p_getWorldSkyColor_2_.posX, p_getWorldSkyColor_2_.posY + 1.0D, p_getWorldSkyColor_2_.posZ);
/*      */         break;
/*      */       
/*      */       case 1:
...
/* Location:              C:\Users\mymon\AppData\Roaming\.minecraft\versions\Hera\Hera.jar!\optfine\CustomColorizer.class
