...
/* 140 */     final BlockPos blockpos = new BlockPos(Math.min(p_getAllInBoxMutable_0_.getX(), p_getAllInBoxMutable_1_.getX()), Math.min(p_getAllInBoxMutable_0_.getY(), p_getAllInBoxMutable_1_.getY()), Math.min(p_getAllInBoxMutable_0_.getZ(), p_getAllInBoxMutable_1_.getZ()));
...
/*     */                   
/* 153 */                   this.theBlockPosM = new BlockPosM(blockpos.getX(), blockpos.getY(), blockpos.getZ(), 3);
/* 154 */                   return this.theBlockPosM;
/*     */                 } 
/* 156 */                 if (this.theBlockPosM.equals(blockpos1))
/*     */                 {
...
/*     */                 
/* 166 */                 if (i < blockpos1.getX()) {
/*     */                   
/* 168 */                   i++;
/*     */                 }
/* 170 */                 else if (j < blockpos1.getY()) {
/*     */                   
/* 172 */                   i = blockpos.getX();
/* 173 */                   j++;
/*     */                 }
/* 175 */                 else if (k < blockpos1.getZ()) {
/*     */                   
/* 177 */                   i = blockpos.getX();
/* 178 */                   j = blockpos.getY();
/* 179 */                   k++;
...
/* Location:              C:\Users\mymon\AppData\Roaming\.minecraft\versions\Hera\Hera.jar!\optfine\BlockPosM.class
