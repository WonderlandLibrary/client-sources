...
/*  84 */   public static ReflectorMethod ForgeWorld_countEntities = new ReflectorMethod(ForgeWorld, "countEntities", new Class[] { EnumCreatureType.class, boolean.class });
...
/*  93 */   public static ReflectorConstructor DrawScreenEvent_Pre_Constructor = new ReflectorConstructor(DrawScreenEvent_Pre, new Class[] { GuiScreen.class, int.class, int.class, float.class });
...
/*  95 */   public static ReflectorConstructor DrawScreenEvent_Post_Constructor = new ReflectorConstructor(DrawScreenEvent_Post, new Class[] { GuiScreen.class, int.class, int.class, float.class });
...
/*  97 */   public static ReflectorConstructor EntityViewRenderEvent_FogColors_Constructor = new ReflectorConstructor(EntityViewRenderEvent_FogColors, new Class[] { EntityRenderer.class, Entity.class, Block.class, double.class, float.class, float.class, float.class });
...
/* 102 */   public static ReflectorConstructor EntityViewRenderEvent_FogDensity_Constructor = new ReflectorConstructor(EntityViewRenderEvent_FogDensity, new Class[] { EntityRenderer.class, Entity.class, Block.class, double.class, float.class });
...
/* 105 */   public static ReflectorConstructor EntityViewRenderEvent_RenderFogEvent_Constructor = new ReflectorConstructor(EntityViewRenderEvent_RenderFogEvent, new Class[] { EntityRenderer.class, Entity.class, Block.class, double.class, int.class, float.class });
...
/*     */ 
/*     */       
/* 245 */       String s = (String)method.invoke(null, p_callString_1_);
/* 246 */       return s;
/*     */     
/*     */     }
...
/*     */ 
/*     */       
/* 268 */       Object object = method.invoke(null, p_call_1_);
/* 269 */       return object;
/*     */     
/*     */     }
...
/*     */ 
/*     */       
/* 384 */       String s = (String)method.invoke(p_callString_0_, p_callString_2_);
/* 385 */       return s;
/*     */     
/*     */     }
...
/*     */ 
/*     */       
/* 407 */       Object object = method.invoke(p_call_0_, p_call_2_);
/* 408 */       return object;
/*     */     
/*     */     }
...
/*     */ 
/*     */       
/* 435 */       Object object = field.get(p_getFieldValue_0_);
/* 436 */       return object;
/*     */     
/*     */     }
...
/*     */     
/*     */     try {
/* 534 */       Object object = constructor.newInstance(p_newInstance_1_);
/* 535 */       return object;
/*     */     }
...
/*     */     }
/*     */     
/* 579 */     Config.dbg(String.valueOf(p_dbgCall_1_) + s2 + " " + s + "." + s1 + "(" + Config.arrayToString(p_dbgCall_3_) + ") => " + p_dbgCall_4_);
/*     */   }
/*     */ 
/*     */   
...
/*     */     }
/*     */     
/* 593 */     Config.dbg(String.valueOf(p_dbgCallVoid_1_) + s2 + " " + s + "." + s1 + "(" + Config.arrayToString(p_dbgCallVoid_3_) + ")");
/*     */   }
/*     */ 
/*     */   
...
/*     */     }
/*     */     
/* 607 */     Config.dbg(String.valueOf(p_dbgFieldValue_1_) + s2 + " " + s + "." + s1 + " => " + p_dbgFieldValue_3_);
/*     */   }
/*     */ 
/*     */   
...
/* 612 */     if (p_handleException_0_ instanceof java.lang.reflect.InvocationTargetException) {
/*     */       
...
/* 636 */     if (p_handleException_0_ instanceof java.lang.reflect.InvocationTargetException) {
/*     */       
...
/* 708 */     List<Field> list = new ArrayList();
/*     */ 
/*     */     
/*     */     try {
...
/*     */       } 
/*     */       
/* 725 */       Field[] afield1 = list.<Field>toArray(new Field[list.size()]);
/* 726 */       return afield1;
/*     */     }
/* 728 */     catch (Exception var6) {
/*     */       
/* 730 */       return null;
/*     */     } 
/*     */   }
...
/* Location:              C:\Users\mymon\AppData\Roaming\.minecraft\versions\Hera\Hera.jar!\optfine\Reflector.class
