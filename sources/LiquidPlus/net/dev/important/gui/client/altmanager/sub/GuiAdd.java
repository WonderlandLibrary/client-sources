...
extends GuiScreen {
    ...
    protected void func_146284_a(GuiButton button) throws IOException {
        ...
        switch (button.field_146127_k) {
            ...
            case 1: {
                if (Client.fileManager.accountsConfig.accountExists(this.username.func_146179_b())) {
    ...
    private void addAccount(String name, String password) {
        if (Client.fileManager.accountsConfig.accountExists(name)) {
            this.status = "\u00a7cThe account has already been added.";
            return;
        }
        ...
        new Thread(() -> {
            ...
            Client.fileManager.accountsConfig.getAccounts().add(account);
