...
extends Style {
    ...
    public static float drawSlider(float value, float min, float max, int x, int y, int width, int mouseX, int mouseY, Color color) {
        ...
        RenderUtils.drawRect((float)x, (float)y, (float)(x + width), (float)(y + 2), new Color(120, 120, 120).getRGB());
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        RenderUtils.drawBorderedRect(panel.getX(), (float)panel.getY() - 3.0f, (float)panel.getX() + (float)panel.getWidth(), (float)panel.getY() + 17.0f, 3.0f, new Color(217, 217, 217).getRGB(), new Color(217, 217, 217).getRGB());
        if (panel.getFade() > 0) {
            RenderUtils.drawBorderedRect(panel.getX(), (float)panel.getY() + 17.0f, (float)panel.getX() + (float)panel.getWidth(), panel.getY() + 19 + panel.getFade(), 3.0f, new Color(217, 217, 217).getRGB(), new Color(217, 217, 217).getRGB());
            RenderUtils.drawBorderedRect(panel.getX(), panel.getY() + 17 + panel.getFade(), (float)panel.getX() + (float)panel.getWidth(), panel.getY() + 19 + panel.getFade() + 5, 3.0f, new Color(217, 217, 217).getRGB(), new Color(217, 217, 217).getRGB());
        }
        GlStateManager.func_179117_G();
        float textWidth = Fonts.Poppins.func_78256_a("\u00a7f" + StringUtils.func_76338_a((String)panel.getName()));
        Fonts.Poppins.func_78276_b(panel.getName(), (int)((float)panel.getX() - (textWidth - 100.0f) / 2.0f), panel.getY() + 7 - 3, Color.BLACK.getRGB());
    }

    @Override
    public void drawDescription(int mouseX, int mouseY, String text) {
        int textWidth = Fonts.Poppins.func_78256_a(text);
        RenderUtils.drawBorderedRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.Poppins.field_78288_b + 3, 3.0f, new Color(217, 217, 217).getRGB(), new Color(217, 217, 217).getRGB());
        GlStateManager.func_179117_G();
        Fonts.Poppins.func_78276_b(text, mouseX + 12, mouseY + Fonts.Poppins.field_78288_b / 2, Color.BLACK.getRGB());
    }

    @Override
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
        Gui.func_73734_a((int)(buttonElement.getX() - 1), (int)(buttonElement.getY() - 1), (int)(buttonElement.getX() + buttonElement.getWidth() + 1), (int)(buttonElement.getY() + buttonElement.getHeight() + 1), (int)this.hoverColor(buttonElement.getColor() != Integer.MAX_VALUE ? new Color(14, 159, 255) : new Color(255, 255, 255), buttonElement.hoverTime).getRGB());
        GlStateManager.func_179117_G();
        Fonts.Poppins.func_78276_b(buttonElement.getDisplayName(), buttonElement.getX() + 5, buttonElement.getY() + 5, Color.BLACK.getRGB());
    }

    @Override
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        Gui.func_73734_a((int)(moduleElement.getX() - 1), (int)(moduleElement.getY() - 1), (int)(moduleElement.getX() + moduleElement.getWidth() + 1), (int)(moduleElement.getY() + moduleElement.getHeight() + 1), (int)this.hoverColor(new Color(255, 255, 255), moduleElement.hoverTime).getRGB());
        Gui.func_73734_a((int)(moduleElement.getX() - 1), (int)(moduleElement.getY() - 1), (int)(moduleElement.getX() + moduleElement.getWidth() + 1), (int)(moduleElement.getY() + moduleElement.getHeight() + 1), (int)this.hoverColor(new Color(14, 159, 255, moduleElement.slowlyFade), moduleElement.hoverTime).getRGB());
        GlStateManager.func_179117_G();
        Fonts.Poppins.func_78276_b(moduleElement.getDisplayName(), moduleElement.getX() + 5, moduleElement.getY() + 5, Color.BLACK.getRGB());
        List<Value<?>> moduleValues = moduleElement.getModule().getValues();
        if (!moduleValues.isEmpty()) {
            Fonts.Poppins.func_78276_b("-", moduleElement.getX() + moduleElement.getWidth() - 8, moduleElement.getY() + 5, Color.BLACK.getRGB());
            if (moduleElement.isShowSettings()) {
                if (moduleElement.getSettingsWidth() > 0.0f && moduleElement.slowlySettingsYPos > moduleElement.getY() + 6) {
                    RenderUtils.drawBorderedRect(moduleElement.getX() + moduleElement.getWidth() + 4, moduleElement.getY() + 6, (float)(moduleElement.getX() + moduleElement.getWidth()) + moduleElement.getSettingsWidth(), moduleElement.slowlySettingsYPos + 2, 3.0f, Color.white.getRGB(), Color.white.getRGB());
                }
                ...
                for (Value<?> value : moduleValues) {
                    ...
                    if (value instanceof BoolValue) {
                        ...
                        Fonts.Poppins.func_78276_b(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, (Boolean)((BoolValue)value).get() != false ? Color.BLACK.getRGB() : new Color(120, 120, 120).getRGB());
                    ...
                    if (value instanceof ListValue) {
                        ...
                        Fonts.Poppins.func_78276_b(text2, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, -16777216);
                        Fonts.Poppins.func_78276_b(listValue.openList ? "-" : "+", (int)((float)(moduleElement.getX() + moduleElement.getWidth()) + moduleElement.getSettingsWidth() - (float)(listValue.openList ? 5 : 6)), moduleElement.slowlySettingsYPos + 2, -16777216);
                        ...
                        for (String valueOfList : listValue.getValues()) {
                            ...
                            GlStateManager.func_179117_G();
                            Fonts.Poppins.func_78276_b("- " + valueOfList, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, listValue.get() != null && ((String)listValue.get()).equalsIgnoreCase(valueOfList) ? Color.BLACK.getRGB() : new Color(120, 120, 120).getRGB());
                            moduleElement.slowlySettingsYPos += Fonts.Poppins.field_78288_b + 1;
                        }
                        if (listValue.openList) continue;
                    ...
                    if (value instanceof FloatValue) {
                        ...
                        String text3 = value.getName() + ": " + this.round(((Float)floatValue.get()).floatValue()) + floatValue.getSuffix();
                        ...
                        if ((valueOfSlide = WhiteStyle.drawSlider(((Float)floatValue.get()).floatValue(), floatValue.getMinimum(), floatValue.getMaximum(), moduleElement.getX() + moduleElement.getWidth() + 8, moduleElement.slowlySettingsYPos + 14, (int)moduleElement.getSettingsWidth() - 12, mouseX, mouseY, new Color(7, 152, 252))) != ((Float)floatValue.get()).floatValue()) {
                            floatValue.set(Float.valueOf(valueOfSlide));
                        }
                        Fonts.Poppins.func_78276_b(text3, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 3, -16777216);
                    ...
                    if (value instanceof IntegerValue) {
                        ...
                        String text4 = value.getName() + ": " + (value instanceof BlockValue ? BlockUtils.getBlockName((Integer)integerValue.get()) + " (" + integerValue.get() + ")" : integerValue.get() + integerValue.getSuffix());
                    ...
                    if (value instanceof FontValue) {
                        ...
                        Fonts.Poppins.func_78276_b(displayString, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, Color.BLACK.getRGB());
                    ...
                    GlStateManager.func_179117_G();
                    Fonts.Poppins.func_78276_b(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 4, -16777216);
