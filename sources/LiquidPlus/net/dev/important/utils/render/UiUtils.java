...
public class UiUtils {
    ...
    public static void drawRoundRect(double d, double e, double g, double h, int color) {
        UiUtils.drawRect(d + 1.0, e, g - 1.0, h, color);
        UiUtils.drawRect(d, e + 1.0, d + 1.0, h - 1.0, color);
        UiUtils.drawRect(d + 1.0, e + 1.0, d + 0.5, e + 0.5, color);
        UiUtils.drawRect(d + 1.0, e + 1.0, d + 0.5, e + 0.5, color);
        UiUtils.drawRect(g - 1.0, e + 1.0, g - 0.5, e + 0.5, color);
        UiUtils.drawRect(g - 1.0, e + 1.0, g, h - 1.0, color);
        UiUtils.drawRect(d + 1.0, h - 1.0, d + 0.5, h - 0.5, color);
        UiUtils.drawRect(g - 1.0, h - 1.0, g - 0.5, h - 0.5, color);
    }
    ...
    public static void fastShadowRoundedRect(float x, float y, float x2, float y2, float rad, float width, Color color) {
        UiUtils.fastShadowRoundedRect(x, y, x2, y2, rad, width, (float)color.getRed() / 255.0f, (float)color.getGreen() / 255.0f, (float)color.getBlue() / 255.0f, (float)color.getAlpha() / 255.0f);
    }
    ...
    public static void drawBorder(float x, float y, float x2, float y2, float strength, int color) {
        ...
        RenderUtils.glColor(new Color(color));
        GL11.glBegin((int)7);
        GL11.glVertex2f((float)(x - strength), (float)(y - strength));
        GL11.glVertex2f((float)(x2 + strength), (float)(y - strength));
        GL11.glVertex2f((float)(x2 + strength), (float)(y + strength));
        GL11.glVertex2f((float)(x - strength), (float)(y + strength));
        GL11.glVertex2f((float)(x - strength), (float)(y2 - strength));
        GL11.glVertex2f((float)(x2 + strength), (float)(y2 - strength));
        GL11.glVertex2f((float)(x2 + strength), (float)(y2 + strength));
        GL11.glVertex2f((float)(x - strength), (float)(y2 + strength));
        GL11.glVertex2f((float)(x - strength), (float)(y + strength));
        GL11.glVertex2f((float)(x + strength), (float)(y + strength));
