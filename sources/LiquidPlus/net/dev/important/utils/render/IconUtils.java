...
public final class IconUtils {
    public static ByteBuffer[] getFavicon() {
        try {
            return new ByteBuffer[]{IconUtils.readImageToBuffer(IconUtils.class.getResourceAsStream("/assets/minecraft/" + "LiquidPlus".toLowerCase() + "/icon1.png")), IconUtils.readImageToBuffer(IconUtils.class.getResourceAsStream("/assets/minecraft/" + "LiquidPlus".toLowerCase() + "/icon2.png"))};
        }
        catch (IOException e) {
            e.printStackTrace();
            return null;
