...
extends FramebufferShader {
    ...
    public void updateUniforms() {
        ...
        GL20.glUniform2f((int)this.getUniform("texelSize"), (float)(1.0f / (float)GlowShader.mc.field_71443_c * (this.radius * this.quality)), (float)(1.0f / (float)GlowShader.mc.field_71440_d * (this.radius * this.quality)));
