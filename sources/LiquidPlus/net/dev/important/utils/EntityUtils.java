...
extends MinecraftInstance {
        ...
        if (entity instanceof EntityLivingBase && (targetDead || entity.func_70089_S()) && entity != EntityUtils.mc.field_71439_g && (targetInvisible || !entity.func_82150_aj())) {
            if (targetPlayer && entity instanceof EntityPlayer) {
                ...
                if (canAttackCheck) {
                    ...
                    if (EntityUtils.isFriend((Entity)entityPlayer) && !Client.moduleManager.getModule(NoFriends.class).getState()) {
                        return false;
                    }
                    if (entityPlayer.func_175149_v()) {
                        return false;
                    }
                    Teams teams = (Teams)Client.moduleManager.getModule(Teams.class);
    ...
    public static boolean isFriend(Entity entity) {
        return entity instanceof EntityPlayer && entity.func_70005_c_() != null && Client.fileManager.friendsConfig.isFriend(ColorUtils.stripColor(entity.func_70005_c_()));
    }
