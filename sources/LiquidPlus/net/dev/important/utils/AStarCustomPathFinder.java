...
public class AStarCustomPathFinder {
    ...
    public AStarCustomPathFinder(Vec3 startVec3, Vec3 endVec3) {
        this.startVec3 = BlockUtils.floorVec3(startVec3.func_72441_c(0.0, 0.0, 0.0));
        this.endVec3 = BlockUtils.floorVec3(endVec3.func_72441_c(0.0, 0.0, 0.0));
    }
        ...
        block0: for (int i = 0; i < loops; ++i) {
            ...
            for (Hub hub : new ArrayList<Hub>(this.hubsToWork)) {
                ...
                for (Vec3 direction : flatCardinalDirections) {
                    Vec3 loc = BlockUtils.floorVec3(hub.getLoc().func_178787_e(direction));
                    if (AStarCustomPathFinder.checkPositionValidity(loc, false) && this.addHub(hub, loc, 0.0)) break block0;
                }
                Vec3 loc1 = BlockUtils.floorVec3(hub.getLoc().func_72441_c(0.0, 1.0, 0.0));
                if ((!AStarCustomPathFinder.checkPositionValidity(loc1, false) || !this.addHub(hub, loc1, 0.0)) && (!AStarCustomPathFinder.checkPositionValidity(loc2 = BlockUtils.floorVec3(hub.getLoc().func_72441_c(0.0, -1.0, 0.0)), false) || !this.addHub(hub, loc2, 0.0))) continue;
                break block0;
            }
        }
        if (this.nearest) {
