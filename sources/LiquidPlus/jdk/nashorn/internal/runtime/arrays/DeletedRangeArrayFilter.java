...
extends ArrayFilter {
    ...
    public ArrayData set(int index, Object value, boolean strict2) {
        ...
        if (longIndex < this.lo || longIndex > this.hi) {
            return super.set(index, value, strict2);
        }
        if (longIndex > this.lo && longIndex < this.hi) {
            return this.getDeletedArrayFilter().set(index, value, strict2);
        }
        ...
        return this.isEmpty() ? this.getUnderlying().set(index, value, strict2) : super.set(index, value, strict2);
    }
