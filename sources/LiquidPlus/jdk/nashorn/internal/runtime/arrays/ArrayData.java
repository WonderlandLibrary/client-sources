...
public abstract class ArrayData {
    ...
    public boolean canDelete(int index, boolean strict2) {
        return true;
    }

    public boolean canDelete(long longIndex, boolean strict2) {
        return true;
    }

    public final ArrayData safeDelete(long fromIndex, long toIndex, boolean strict2) {
        if (fromIndex <= toIndex && this.canDelete(fromIndex, strict2)) {
    ...
    public ArrayData push(boolean strict2, Object ... items) {
        if (items.length == 0) {
            return this;
        }
        ...
        for (Object item : items) {
            ...
            newData.set((int)pos++, item, strict2);
        }
        return newData;
    }

    public ArrayData push(boolean strict2, Object item) {
        return this.push(strict2, new Object[]{item});
    }
    ...
    extends ContinuousArrayData {
        ...
        public ArrayData set(int index, Object value, boolean strict2) {
            return this.toRealArrayData(index).set(index, value, strict2);
        }
        ...
        @Override
        public ArrayData push(boolean strict2, Object item) {
            return this.toRealArrayData().push(strict2, item);
        }
