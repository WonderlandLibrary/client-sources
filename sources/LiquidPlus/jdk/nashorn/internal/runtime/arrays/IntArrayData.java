...
implements IntElements {
    ...
    public ArrayData set(int index, Object value, boolean strict2) {
        if (JSType.isRepresentableAsInt(value)) {
            return this.set(index, JSType.toInt32(value), strict2);
        }
        if (value == ScriptRuntime.UNDEFINED) {
            return new UndefinedArrayFilter(this).set(index, value, strict2);
        }
        ArrayData newData = this.convert(value == null ? Object.class : value.getClass());
        return newData.set(index, value, strict2);
    }
    ...
    public ArrayData set(int index, double value, boolean strict2) {
        ...
        return this.convert(Double.class).set(index, value, strict2);
    }
