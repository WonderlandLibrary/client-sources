...
extends ScriptObject {
    ...
    private static PropertyMap getMap(boolean strict2) {
        return strict2 ? strictmodemap$ : map$;
    }
    ...
    private static MethodHandle bindToNameIfNeeded(MethodHandle methodHandle, String bindName) {
        ...
        boolean bl = isVarArg = parameterCount > 0 && methodType.parameterType(parameterCount - 1).isArray();
        if (isVarArg) {
