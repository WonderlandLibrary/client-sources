...
implements Loggable {
    ...
    public void accumulateTime(String module2, long durationNano) {
        if (this.isEnabled()) {
            this.ensureInitialized(Context.getContextTrusted());
            this.timeSupplier.accumulateTime(module2, durationNano);
        }
    }
    ...
    implements Supplier<String> {
        ...
        private void accumulateTime(String module2, long duration) {
            this.timings.computeIfAbsent(module2, this.newTimingCreator).add(duration);
        }
    }
}
