...
public final class ScriptRuntime {
    ...
    public static boolean DELETE(Object obj, Object property, Object strict2) {
        if (obj instanceof ScriptObject) {
            return ((ScriptObject)obj).delete(property, Boolean.TRUE.equals(strict2));
        }
        ...
        if (JSType.isPrimitive(obj)) {
            return ((ScriptObject)JSType.toScriptObject(obj)).delete(property, Boolean.TRUE.equals(strict2));
        }
        if (obj instanceof JSObject) {
    ...
    public static boolean SLOW_DELETE(Object obj, Object property, Object strict2) {
        if (obj instanceof ScriptObject) {
            ...
            for (ScriptObject sobj = (ScriptObject)obj; sobj != null && sobj.isScope(); sobj = sobj.getProto()) {
                ...
                return sobj.delete(key, Boolean.TRUE.equals(strict2));
            }
        }
        return ScriptRuntime.DELETE(obj, property, strict2);
    }

    public static boolean FAIL_DELETE(Object property, Object strict2) {
        if (Boolean.TRUE.equals(strict2)) {
