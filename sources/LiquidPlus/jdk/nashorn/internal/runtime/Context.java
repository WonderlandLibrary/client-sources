...
public final class Context {
    ...
    public Object eval(ScriptObject initialScope, String string, Object callThis, Object location, boolean strict2, boolean evalCall) {
        ...
        boolean strictFlag = strict2 || this._strict;
        Class<?> clazz = null;
        try {
    ...
    private synchronized Class<?> compile(Source source, ErrorManager errMan, boolean strict2) {
        String cacheKey;
        errMan.reset();
        ...
        if (storedScript == null) {
            ...
            functionNode = new Parser(this.env, source, errMan, strict2, this.getLogger(Parser.class)).parse();
            if (errMan.hasErrors()) {
                return null;
            }
        ...
        if (storedScript == null) {
            ...
            Compiler compiler = Compiler.forInitialCompilation(installer, source, errMan, strict2 | functionNode.isStrict());
