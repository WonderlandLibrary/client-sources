...
extends SpillProperty {
    ...
    @Override
    public void setValue(ScriptObject self, ScriptObject owner, int value, boolean strict2) {
        this.setValue(self, owner, (Object)value, strict2);
    }

    @Override
    public void setValue(ScriptObject self, ScriptObject owner, double value, boolean strict2) {
        this.setValue(self, owner, (Object)value, strict2);
    }

    @Override
    public void setValue(ScriptObject self, ScriptObject owner, Object value, boolean strict2) {
        try {
            UserAccessorProperty.invokeObjectSetter(this.getAccessors(owner != null ? owner : self), UserAccessorProperty.getObjectSetterInvoker(), strict2 ? this.getKey() : null, self, value);
        }
        catch (Error | RuntimeException t) {
            throw t;
        }
