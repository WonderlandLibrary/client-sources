...
extends ScriptObject {
    ...
    public boolean delete(int key, boolean strict2) {
        ...
        return this.isMapped(index) ? this.deleteMapped(index, strict2) : super.delete(key, strict2);
    }
    ...
    public boolean delete(Object key, boolean strict2) {
        ...
        return this.isMapped(index) ? this.deleteMapped(index, strict2) : super.delete(primitiveKey, strict2);
    }
    ...
    private boolean deleteMapped(int index, boolean strict2) {
        Object value = this.getArray().getObject(index);
        boolean success = super.delete(index, strict2);
        if (success) {
