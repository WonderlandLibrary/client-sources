...
implements Loggable {
    ...
    public Parser(ScriptEnvironment env, Source source, ErrorManager errors, boolean strict2, DebugLogger log) {
        this(env, source, errors, strict2, 0, log);
    }

    public Parser(ScriptEnvironment env, Source source, ErrorManager errors, boolean strict2, int lineOffset, DebugLogger log) {
        super(source, errors, strict2, lineOffset);
        this.env = env;
    ...
    private Expression functionExpression(boolean isStatement, boolean topLevel) {
        ...
        boolean strict2 = functionNode.isStrict();
        if (arity > 1) {
