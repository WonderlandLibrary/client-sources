...
public class GuardedInvocation {
    ...
    public MethodHandle compose(MethodHandle guardFallback, MethodHandle switchpointFallback, MethodHandle catchFallback) {
        ...
        MethodHandle methodHandle = catchGuarded = this.exception == null ? guarded : Lookup.MH.catchException(guarded, this.exception, MethodHandles.dropArguments(catchFallback, 0, this.exception));
        if (this.switchPoints == null) {
            return catchGuarded;
        }
