...
public class TypeConverterFactory {
    ...
    public MethodHandle asType(MethodHandle handle, MethodType fromType) {
        ...
        for (int i = 0; i < l; ++i) {
            ...
            MethodHandle converter2 = this.getTypeConverterNull(fromParamType, toParamType);
            if (converter2 != null) {
        ...
        if (fromRetType != Void.TYPE && toRetType != Void.TYPE && !TypeConverterFactory.canAutoConvert(toRetType, fromRetType) && (converter = this.getTypeConverterNull(toRetType, fromRetType)) != null) {
