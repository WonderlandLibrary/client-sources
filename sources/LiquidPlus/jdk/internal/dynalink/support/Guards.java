...
public class Guards {
    ...
    public static MethodHandle isArray(int pos, MethodType type) {
        Class<Object[]> declaredType = type.parameterType(pos);
    ...
    private static MethodHandle asType(MethodHandle test, int pos, MethodType type) {
        ...
        return MethodHandles.permuteArguments(test.asType(test.type().changeParameterType(0, type.parameterType(pos))), type.changeReturnType(Boolean.TYPE), pos);
    }
