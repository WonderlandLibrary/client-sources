...
public final class IntIterators {
    ...
    public static boolean any(IntIterator iterator2, IntPredicate predicate) {
        return IntIterators.indexOf(iterator2, predicate) != -1;
    }

    public static boolean all(IntIterator iterator2, IntPredicate predicate) {
        Objects.requireNonNull(predicate);
        do {
            if (iterator2.hasNext()) continue;
            return true;
        } while (predicate.test(iterator2.nextInt()));
        return false;
    }

    public static int indexOf(IntIterator iterator2, IntPredicate predicate) {
        Objects.requireNonNull(predicate);
        int i = 0;
        while (iterator2.hasNext()) {
            if (predicate.test(iterator2.nextInt())) {
                return i;
            }
            ++i;
        }
    ...
    public static IntIterator wrap(ByteIterator iterator2) {
        return new ByteIteratorWrapper(iterator2);
    }

    public static IntIterator wrap(ShortIterator iterator2) {
        return new ShortIteratorWrapper(iterator2);
    }

    public static IntIterator wrap(CharIterator iterator2) {
