        ...
        while (iterator2.hasNext()) {
            try {
                ...
                if (c == 50 || c == 51 || c == 52 || c == 49 || c == 48 || c == 46 || c == 47 || c == 53) {
                    pos = this.replace(cp, iterator2, pos, c, this.getLoadReplacementSignature(c));
                    continue;
                }
                if (c != 83 && c != 84 && c != 85 && c != 82 && c != 81 && c != 79 && c != 80 && c != 86) continue;
                pos = this.replace(cp, iterator2, pos, c, this.getStoreReplacementSignature(c));
            }
            catch (Exception e) {
    ...
    private int replace(ConstPool cp, CodeIterator iterator2, int pos, int opcode, String signature) throws BadBytecode {
        ...
        if (methodName != null) {
            ...
            if (castType != null) {
                ...
                iterator2.write16bit(index, pos + 4);
            }
