...
public class Javac {
    ...
    public void recordProceed(String target, String method) throws CompileError {
        ...
        ProceedHandler h = new ProceedHandler(){
            ...
            @Override
            public void doit(JvstCodeGen gen, Bytecode b, ASTList args2) throws CompileError {
            ...
            @Override
            public void setReturnType(JvstTypeChecker check, ASTList args2) throws CompileError {
                ASTree expr = new Member(m);
                if (texpr != null) {
                    expr = Expr.make(46, texpr, expr);
                }
    ...
    public void recordSpecialProceed(String target, final String classname, final String methodname, final String descriptor, final int methodIndex) throws CompileError {
        ...
        ProceedHandler h = new ProceedHandler(){
            ...
            @Override
            public void doit(JvstCodeGen gen, Bytecode b, ASTList args2) throws CompileError {
                gen.compileInvokeSpecial(texpr, methodIndex, descriptor, args2);
            }

            @Override
            public void setReturnType(JvstTypeChecker c, ASTList args2) throws CompileError {
                c.compileInvokeSpecial(texpr, classname, methodname, descriptor, args2);
            }
        };
        this.gen.setProceedHandler(h, proceedName);
    }
