...
public class Descriptor {
    ...
    public static CtClass[] getParameterTypes(String desc, ClassPool cp) throws NotFoundException {
        ...
        CtClass[] args2 = new CtClass[num];
        int n = 0;
        int i = 1;
        while ((i = Descriptor.toCtClass(cp, desc, i, args2, n++)) > 0) {
        }
        return args2;
    }
    ...
    private static int toCtClass(ClassPool cp, String desc, int i, CtClass[] args2, int n) throws NotFoundException {
        String name;
        int i2;
        int arrayDim = 0;
