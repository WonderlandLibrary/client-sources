...
public class Compiler {
    public static void main(String[] args2) throws Exception {
        ...
        CompiledClass[] entries = new CompiledClass[args2.length];
        int n = Compiler.parse(args2, entries);
        if (n < 1) {
    ...
    private static int parse(String[] args2, CompiledClass[] result) {
        int n = -1;
