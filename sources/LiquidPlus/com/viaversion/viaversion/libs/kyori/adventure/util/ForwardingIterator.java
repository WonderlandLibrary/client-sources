...
implements Iterable<T> {
    ...
    public ForwardingIterator(@NotNull Supplier<Iterator<T>> iterator2, @NotNull Supplier<Spliterator<T>> spliterator) {
        this.iterator = Objects.requireNonNull(iterator2, "iterator");
