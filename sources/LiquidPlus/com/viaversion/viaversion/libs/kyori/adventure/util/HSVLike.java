...
extends Examinable {
    ...
    @NotNull
    public static HSVLike fromRGB(@Range(from=0L, to=255L) int red2, @Range(from=0L, to=255L) int green2, @Range(from=0L, to=255L) int blue2) {
        float r = (float)red2 / 255.0f;
        float g = (float)green2 / 255.0f;
        float b = (float)blue2 / 255.0f;
