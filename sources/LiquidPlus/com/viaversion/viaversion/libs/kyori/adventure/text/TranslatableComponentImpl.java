...
implements TranslatableComponent {
    ...
    TranslatableComponentImpl(@NotNull List<Component> children, @NotNull Style style, @NotNull String key, @NotNull @NotNull ComponentLike @NotNull [] args2) {
        this(children, style, key, Arrays.asList(args2));
    }

    TranslatableComponentImpl(@NotNull List<? extends ComponentLike> children, @NotNull Style style, @NotNull String key, @NotNull List<? extends ComponentLike> args2) {
        super(children, style);
        this.key = Objects.requireNonNull(key, "key");
        this.args = ComponentLike.asComponents(args2);
    }
