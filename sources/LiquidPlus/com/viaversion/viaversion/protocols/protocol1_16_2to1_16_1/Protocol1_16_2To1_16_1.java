        ...
        this.registerServerbound(ServerboundPackets1_16_2.RECIPE_BOOK_DATA, new PacketRemapper(){
            ...
            public void registerMap() {
                this.handler(wrapper -> {
                    ...
                    boolean open2 = wrapper.read(Type.BOOLEAN);
                    boolean filter = wrapper.read(Type.BOOLEAN);
                    wrapper.write(Type.VAR_INT, 1);
                    wrapper.write(Type.BOOLEAN, recipeType == 0 && open2);
                    wrapper.write(Type.BOOLEAN, filter);
                    wrapper.write(Type.BOOLEAN, recipeType == 1 && open2);
                    wrapper.write(Type.BOOLEAN, filter);
                    wrapper.write(Type.BOOLEAN, recipeType == 2 && open2);
                    wrapper.write(Type.BOOLEAN, filter);
                    wrapper.write(Type.BOOLEAN, recipeType == 3 && open2);
                    wrapper.write(Type.BOOLEAN, filter);
                });
            }
        });
