...
extends BackwardsProtocol<ClientboundPackets1_18, ClientboundPackets1_17_1, ServerboundPackets1_17, ServerboundPackets1_17> {
    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(ClientboundPackets1_18.SCOREBOARD_OBJECTIVE, new PacketRemapper(){
        ...
        this.registerClientbound(ClientboundPackets1_18.DISPLAY_SCOREBOARD, new PacketRemapper(){
        ...
        this.registerClientbound(ClientboundPackets1_18.TEAMS, new PacketRemapper(){
        ...
        this.registerClientbound(ClientboundPackets1_18.UPDATE_SCORE, new PacketRemapper(){
