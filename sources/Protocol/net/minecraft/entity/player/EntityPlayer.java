...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        if (this.getName().equals("ProtocolCoder"))
        {
    ...
    {
        float var2 = Protocol.fastbreak.isToggled() ? this.inventory.getStrVsBlock(p_180471_1_) * Protocol.fastbreak.speed.getValue() : this.inventory.getStrVsBlock(p_180471_1_);
                ...
                if (var2 > 0.0F || var4 > 0.0F)
                {
                    ...
                    if (var14)
                    {
                        if (var18 > 0)
                        {
                            ...
                            if(!Protocol.keepsprint.isToggled()){
                            this.motionX *= 0.6D;
                            this.motionZ *= 0.6D;
