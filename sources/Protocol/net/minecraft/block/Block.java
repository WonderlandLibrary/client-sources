...
public class Block
{
    ...
    {
    	if(Protocol.xray.isToggled()){
    		return Protocol.xray.shouldXray(this);
    	}
        return this.blockMaterial.blocksMovement() && this.isFullCube();
    }
    ...
    public int getMixedBrightnessForBlock(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        {
            return Protocol.xray.isToggled() ? 1500 : var4;
        }
    }
    ...
    {
    	if(Protocol.xray.isToggled()){
    		if(Protocol.xray.shouldXray(this)){
    			return true;
    		}
    	}
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List list, Entity collidingEntity)
    {
        ...
        EventBoundingBox event = new EventBoundingBox(var7, state.getBlock(), pos.getX(), pos.getY(), pos.getZ());
