...
public abstract class BlockLiquid extends Block
{
    ...
    public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state)
    {
    	...
    	if(Protocol.jesus.isToggled() && Protocol.jesus.solid.getValue() && (Wrapper.getPlayer().fallDistance < 4.0F)){
    		if(Wrapper.mc().gameSettings.keyBindSneak.pressed || Protocol.jesus.isInLiquid()){
    			return null;
    		}
