...
public class LayerHeldItem implements LayerRenderer
{
    ...
    public void doRenderLayer(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_, float p_177141_5_, float p_177141_6_, float p_177141_7_, float p_177141_8_)
    {
        ...
        if (var9 != null)
        {
            ...
            if (var13 instanceof ItemSword && p_177141_1_ instanceof EntityPlayer && ((EntityPlayer)p_177141_1_).isBlocking())
            {
            	GlStateManager.translate(-0.0625F, 0.0375F, 0.0625F);
            	GlStateManager.rotate(-10.0F, -0.0F, 5.0F, 5.0F);
            	GlStateManager.rotate(-10.0F, -0.0F, 5.0F, 5.0F);
            	GlStateManager.rotate(-10.0F, -0.0F, 5.0F, 5.0F);
            	GlStateManager.rotate(-10.0F, -0.0F, 5.0F, 5.0F);
            }
