...
public class Gui
{
     ...
     */
    public static void drawRect(float f, float g, float h, float i, int color)
    {
        float var5;
        ...
        var10.addVertex((double)f, (double)i, 0.0D);
        var10.addVertex((double)h, (double)i, 0.0D);
        var10.addVertex((double)h, (double)g, 0.0D);
