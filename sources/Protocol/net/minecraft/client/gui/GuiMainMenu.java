...
import me.protocol_client.alts.Login;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
		...
		this.buttonList.add(new GuiButton(911, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "\247aAlt Login"));
	}
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		if (button.id == 911) {
			this.mc.displayGuiScreen(new Login(this));
		}
		if (button.id == 1) {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		Gui.drawString(Wrapper.fr(), "Protocol", width / 10 - (Wrapper.fr().getStringWidth("Protocol") / 2), 15, Protocol.getMainColor());
		GlStateManager.popMatrix();
		GlStateManager.pushMatrix();
		GlStateManager.scale(5, 5, 5);
		Gui.drawString(Wrapper.fr(), "FUCKING MEMES", width / 10 - (Wrapper.fr().getStringWidth("FUCKING MEMES") / 2), 60, Protocol.getMainColor());
		GlStateManager.popMatrix();

		String var10 = "Thanks to Hexeption for outline ESP";
		String var11 = "Welcome To Protocol, " + Wrapper.mc().getSession().getUsername();
		this.drawString(this.fontRendererObj, var10, 2, this.height - 10, Protocol.getMainColor());
		this.drawString(this.fontRendererObj, var11, this.width - this.fontRendererObj.getStringWidth(var11) - 2, this.height - 10, Protocol.getMainColor());
