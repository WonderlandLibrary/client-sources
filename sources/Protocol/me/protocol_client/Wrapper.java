...
import me.protocol_client.ui.hud.NahrFont;
...
public final class Wrapper {
	...
	public static void tellPlayer(String message) {
		Minecraft.getMinecraft().ingameGUI.getChatGUI().printChatMessage(new ChatComponentText("\2478[§9Protocol\2478]\247r: " + message));
	}
	...
	public static void invalidCommand(String s) {
		Wrapper.tellPlayer("\2477Invalid command for " + Protocol.primColor+ s);
	}
