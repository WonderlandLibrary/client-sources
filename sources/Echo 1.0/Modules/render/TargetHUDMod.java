...
public class TargetHUDMod extends Module {
    ...
    private final ModeSetting targetHud = new ModeSetting("Mode", "Exire", "Echo", "Raven", "Exire", "Moon", "Rise", "Exhibition", "Auto-Dox", "Akrien", "Astolfo", "Novoline");
    ...
    public TargetHUDMod() {
        ...
        addSettings(targetHud, trackTarget,animation, trackingMode, colorWheel.createModeSetting("Color Mode", "Dark"), colorWheel.getColorSetting());
        TargetHUD.init();
    }
    ...
    public Listener<PreRenderEvent> onPreRenderEvent = event -> {
        ...
        if (!(mc.currentScreen instanceof GuiChat)) {
            if (!killAura.isEnabled()) {
                openAnimation.setDirectionTarget(Direction.BACKWARDS);
            ...
            if (target == null && KillAura.target != null) {
                ...
                openAnimation.setDirectionTarget(Direction.FORWARDS);
