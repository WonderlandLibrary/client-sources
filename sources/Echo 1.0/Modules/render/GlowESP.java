...
import dev.echo.listener.event.impl.render.RenderChestEvent;
...
public class GlowESP extends Module {
    ...
    private final ColorSetting playerColor = new ColorSetting("Player Color", Echo.INSTANCE.getClientColor());
    private final ColorSetting animalColor = new ColorSetting("Animal Color", Echo.INSTANCE.getAlternateClientColor());
    ...
    private final ShaderUtil outlineShader = new ShaderUtil("Echo/Shaders/outline.frag");
    ...
    @Link
    public Listener<WorldEvent> worldEventListener = e -> {
    ...
    @Link
    public Listener<RenderChestEvent> renderChestEventListener = e -> {
    ...
    @Link
    public Listener<RenderModelEvent> renderModelEventListener = e -> {
