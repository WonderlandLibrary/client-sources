...
public class Snake extends Module {
    ...
    public Listener<Render2DEvent> onRender2DEvent = event -> {
       ...
       // }
        ...
        RoundedUtil.drawRound(270, 50, 20, 20,2,false,new Color(255,0,1));
        mc.fontRendererObj.drawStringWithShadow("Score " + score,450,50,Color.white.getRGB());
    };
