...
import dev.echo.utils.player.BlockUtils;
...
public class InvManager extends Module {
    ...
    public InvManager() {
        super("Inv Manager", Category.PLAYER, "cleans up your inventory");
    ...
    @Link
    public Listener<PacketSendEvent> packetSendEventListener = e -> {
        if (isInvOpen) {
