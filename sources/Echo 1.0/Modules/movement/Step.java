...
public final class Step extends Module {
    ...
    private final ModeSetting mode = new ModeSetting("Mode", "Vanilla", "Vanilla", "NCP", "Full Jump Packets", "Vulcan");
    ...
    public Listener<StrafeEvent> moveUpdateEventListener = e -> {
        ...
        if (mc.thePlayer.onGround) {
            ...
            if (mc.thePlayer.stepHeight != 0.625f) {
    ...
    @Link
    public Listener<StepConfirmEvent> onStepConfirmEvent = e -> {
        ...
        if (diffY > 0.625f && diffY <= 1.5f && mc.thePlayer.onGround) {
            ...
            switch (mode.getMode()) {
                ...
                case "Full Jump Packets":
                    ...
                    break;
                case "Vulcan": {
                    if (mc.thePlayer.stepHeight > 0.6) {
                        mc.timer.timerSpeed = 0.5f;
                        PacketUtils.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(mc.thePlayer.posX, mc.thePlayer.posY + 0.5F, mc.thePlayer.posZ, true));
                    }
                }
                break;
            }
