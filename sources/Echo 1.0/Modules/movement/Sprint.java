...
import dev.echo.module.impl.player.NoSlowDown;
    ...
    public Listener<StrafeEvent> moveUpdateEventListener = e -> {
        ...
        if (omniSprint.isEnabled()) {
            ...
            if (mc.thePlayer.isUsingItem()) {
                if (mc.thePlayer.moveForward > 0 && (Echo.INSTANCE.isEnabled(NoSlowDown.class) || !mc.thePlayer.isUsingItem()) && !mc.thePlayer.isSneaking() && !mc.thePlayer.isCollidedHorizontally && mc.thePlayer.getFoodStats().getFoodLevel() > 6) {
                    mc.thePlayer.setSprinting(true);
                }
            } else {
