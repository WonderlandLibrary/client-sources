package dev.echo.utils.spotify;
...
public class SpotifyAPI implements Utils {
    ...
    public final static File CLIENT_ID_DIR = new File(Echo.DIRECTORY, "SpotifyID.json");
    ...
    public void startConnection() {
        if (!authenticated) {
            try {
                ...
                Echo.INSTANCE.getExecutorService().submit(() -> {
                    try {
                        ...
                        callbackServer.createContext("/", context -> {
                            ...
                            final String messageSuccess = context.getRequestURI().getQuery().contains("code")
                                    ? "Successfully authorized.\nYou can now close this window, have fun on Echo!"
