package dev.echo.utils.render;

import dev.echo.Echo;
import dev.echo.listener.Link;
import dev.echo.listener.Listener;
import dev.echo.listener.event.impl.game.RenderTickEvent;
...
public class EntityCulling extends Module {
    ...
    public static boolean renderItem(Entity stack) {
        if (!Echo.INSTANCE.isEnabled(EntityCulling.class)) return false;
    ...
    @Link
    public Listener<RendererLivingEntityEvent> onRendererLivingEntityEvent = e -> {
...
//        EntityLivingBase entity = e.getEntity();
    ...
    @Link
    public Listener<RenderTickEvent> onRenderTickEvent = e -> {
        if (e.isPre()) {
