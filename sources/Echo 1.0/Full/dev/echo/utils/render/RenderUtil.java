...
import static dev.echo.utils.misc.MathUtils.interpolate;
...
public class RenderUtil implements Utils {
    ...
    public static void renderBoundingBox(EntityLivingBase entityLivingBase, Color color, float alpha,boolean outline) {
        ...
        RenderGlobal.renderCustomBoundingBox(bb, outline, true);
        glDepthMask(true);
        glEnable(GL_DEPTH_TEST);
