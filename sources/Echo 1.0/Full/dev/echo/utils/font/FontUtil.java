...
public class FontUtil implements Utils {
    ...
    public enum FontType {
        ECHO("echo", "echo-bold", 12, 14, 16, 18, 20, 22, 24, 26, 28, 32, 40, 80),
        TAHOMA("tahoma", "tahoma-bold", 10, 12, 14, 16, 18, 27),
            RUBIK("rubik", "rubik-bold", 13, 18),
        SANS("sans","sans-bold",28),
        ...
        FontType(String fontName, String boldName, int... sizes) {
            this.location = new ResourceLocation("Echo/Fonts/" + fontName + ".ttf");
            this.boldLocation = new ResourceLocation("Echo/Fonts/" + boldName + ".ttf");
            this.sizes = sizes;
        }
