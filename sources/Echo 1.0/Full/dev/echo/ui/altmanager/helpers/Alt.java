package dev.echo.ui.altmanager.helpers;

import dev.echo.other.auth.SSLController;
import dev.echo.other.auth.TheAlteningAuthentication;
...
import dev.echo.microsoft.MicrosoftLogin;
...
public class Alt {
    ...
    private void login(boolean microsoft) {
        ...
        if ((!microsoft && this.password.isEmpty()) || a) {
            ...
            stage = 2;
            Echo.INSTANCE.getAltManager().currentSessionAlt = this;
            return;
        }
