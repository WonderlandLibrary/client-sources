...
import dev.echo.ui.altmanager.panels.AltPanel;
import dev.echo.ui.altmanager.panels.InfoPanel;
import dev.echo.ui.altmanager.panels.LoginPanel;
import dev.echo.ui.altmanager.panels.MicrosoftInfoPanel;
...
public class GuiAltManager extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (currentSessionAlt != null) {
            ...
            echoBoldFont14.drawCenteredString("Current Account", altRect.getX() + altRect.getWidth() / 2f,
                    altRect.getY() - (echoBoldFont14.getHeight() + 5), -1);
        }
        ...
        Echo.INSTANCE.getModuleCollection().getModule(NotificationsMod.class).render();
        if (Alt.stage != 0) {
