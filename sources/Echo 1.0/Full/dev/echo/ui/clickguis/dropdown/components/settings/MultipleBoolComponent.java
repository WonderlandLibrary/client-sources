...
public class MultipleBoolComponent extends SettingComponent<MultipleBoolSetting> {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        echoFont14.drawString(getSetting().name, x + 6, y + 4, textColor);
        ...
        for (BooleanSetting setting : sortedSettings) {
            ...
            float enabledHeight = echoFont14.getHeight() + 4;
            ...
            echoFont14.drawString(setting.name, enabledX + 2, enabledY + 2,
    ...
    private float getEnabledWidth(BooleanSetting setting) {
        return (echoFont14.getStringWidth(setting.name) + 4);
    }
