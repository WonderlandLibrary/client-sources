...
public class ColorComponent extends SettingComponent<ColorSetting> {
    ...
    private final TextField hexField = new TextField(FontUtil.echoFont16);
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        echoFont16.drawString(colorSetting.name, x + 5, y + echoFont16.getMiddleOfBox(realHeight), textColor);
        ...
        echoFont14.drawCenteredStringWithShadow(text, colorX + colorWidth / 2f,
                colorY + echoFont14.getMiddleOfBox(colorHeight),
        ...
        if (opened || !openAnimation.isDone()) {
            ...
            GLUtil.startBlend();
            RenderUtil.drawImage(new ResourceLocation("Echo/colorpicker2.png"), pickerX, pickerY, 4, 4);
            GLUtil.endBlend();
            ...
            if (!rainbowAnimation.finished(Direction.FORWARDS)) {
                ...
                echoFont16.drawString("Hex", gradientX, newYVal + echoFont16.getMiddleOfBox(heightLeft), whiteColor);
                ...
                if (!hexField.isFocused()) {
                    ...
                    try {
                        ...
                        echoFont14.drawString("Invalid Hex Code", hexField.getXPosition() - .5f, newYVal - (echoFont14.getHeight() - .5f),
