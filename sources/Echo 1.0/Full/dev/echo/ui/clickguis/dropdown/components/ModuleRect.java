package dev.echo.ui.clickguis.dropdown.components;
...
import dev.echo.ui.clickguis.dropdown.components.settings.*;
...
import dev.echo.utils.animations.impl.EaseOutSine;
...
public class ModuleRect implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        boolean hoveringText = HoveringUtil.isHovering(x + 5, y + echoFont18.getMiddleOfBox(height), echoFont18.getStringWidth(module.getName()), echoFont18.getHeight(), mouseX, mouseY);
        ...
        echoFont18.drawString((module.isEnabled() ? "§l" : "") + module.getName(), x + 5, y + echoFont18.getMiddleOfBox(height), moduleTextColor);
