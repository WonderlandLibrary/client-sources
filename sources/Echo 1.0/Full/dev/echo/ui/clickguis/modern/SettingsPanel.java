    ...
    public SettingsPanel(Module module) {
        ...
        for (Setting setting : module.getSettingsList()) {
            ...
            if (setting instanceof StringSetting) {
                ...
                TextField textField = new TextField(echoFont18);
    ...
    public void handle(int mouseX, int mouseY, int button, GuiEvents type) {
        ...
        for (Setting setting : module.getSettingsList()) {
            ...
            if (setting instanceof BooleanSetting) {
                ...
                echoFont16.drawString(setting.name, x + 13, settingY + echoFont16.getMiddleOfBox(8), -1);
            ...
            if (setting instanceof ModeSetting) {
                ...
                float stringWidth = (float) echoFont16.getStringWidth(StringUtils.getLongestModeName(modeSetting.modes));
                ...
                float nameWidth = echoFont16.getStringWidth(modeSetting.name);
                float stringX = x + 13;
                if (nameWidth > (boxX - stringX)) {
                    echoFont16.drawWrappedText(modeSetting.name, stringX, settingY - (echoFont16.getMiddleOfBox(12) / 2), -1, boxX - stringX, 2);
                    //    echoFont16.drawString(modeSetting.name, stringX + (boxX - stringX) / 2f, settingY + echoFont16.getMiddleOfBox(8), -1);
                } else {
                    echoFont16.drawString(modeSetting.name, x + 13, settingY + 2, -1);
                }
                ...
                echoFont16.drawCenteredString(modeSetting.getMode(), modeX, settingY + echoFont16.getMiddleOfBox(10), -1);
                ...
                for (String mode : modeSetting.modes) {
                    if (!mode.equalsIgnoreCase(modeSetting.getMode())) {
                        ...
                        echoFont16.drawCenteredString(mode, modeX, (float) (settingY + 2 + ((modeCount * 15) * animation.getOutput().floatValue())),
            ...
            if (setting instanceof ColorSetting) {
                ...
                echoFont16.drawCenteredString(colorSetting.name, (x + 13) + 115 / 2f, settingY + 3, -1);
                ...
                GL11.glEnable(GL11.GL_BLEND);
                mc.getTextureManager().bindTexture(new ResourceLocation("Echo/booleanslider1.png"));
                ...
                // Hue bar
                RenderUtil.color(-1);
                mc.getTextureManager().bindTexture(new ResourceLocation("Echo/hue.png"));
                ...
                echoFont14.drawString("Rainbow: ", gradientX, gradientY + gradientHeight + 14, -1);

                String text = colorSetting.isRainbow() ? "Enabled" : "Disabled";
                float textX = gradientX + echoFont14.getStringWidth("Rainbow: ") + 4;
                float textY = gradientY + gradientHeight + 13;

                boolean hoveringRound = HoveringUtil.isHovering(textX, textY, echoFont14.getStringWidth(text) + 4, echoFont14.getHeight() + 2, mouseX, mouseY);
                ...
                RoundedUtil.drawRound(textX, textY, echoFont14.getStringWidth(text) + 4, echoFont14.getHeight() + 2, 3,
                        hoveringRound ? roundColor.brighter() : roundColor);

                echoFont14.drawCenteredString(text, textX + (echoFont14.getStringWidth(text) + 4) / 2f,
                        textY + echoFont14.getMiddleOfBox(echoFont14.getHeight() + 2), -1);
            ...
            if (setting instanceof NumberSetting) {
                ...
                echoFont16.drawString(setting.name, x + 13, settingY + 2, -1);
                ...
                echoFont16.drawString(value, x + 120 - echoFont16.getStringWidth(value), settingY + 2, -1);
            ...
            if (setting instanceof StringSetting) {
                ...
                echoFont16.drawString(setting.name, x + 16, settingY + 1, -1);
            ...
            if (setting instanceof MultipleBoolSetting) {
                ...
                echoFont16.drawCenteredString(multiBoolSetting.name, x + 70.5f, settingY - 3 + 16 / 2f - echoFont16.getHeight() / 2f, -1);
                ...
                for (BooleanSetting booleanSetting : multiBoolSetting.getBoolSettings()) {
                    ...
                    boolean isHoveringBool = animation.getDirection().equals(Direction.FORWARDS) &&
                            HoveringUtil.isHovering(x + 17, settingY + (boolCount * 15),
                                    (float) echoFont16.getStringWidth(booleanSetting.name) + 13, 11, mouseX, mouseY);
                    ...
                    GlStateManager.color(1, 1, 1, 1);
                    echoFont16.drawString(booleanSetting.name, x + 28, (float) (settingY + 2 + ((boolCount * 15) * animation.getOutput().floatValue())),
                            ColorUtil.interpolateColor(new Color(40, 40, 40, 10), new Color(colorInterpolate), (float) animation.getOutput().floatValue()));
                    boolCount++;
