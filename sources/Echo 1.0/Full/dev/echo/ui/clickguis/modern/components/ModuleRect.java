package dev.echo.ui.clickguis.modern.components;
...
import dev.echo.utils.animations.impl.ElasticAnimation;
...
public class ModuleRect extends Component {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        HUDMod hudMod = Echo.INSTANCE.getModuleCollection().getModule(HUDMod.class);
        ...
        //  mc.getTextureManager().bindTexture(new ResourceLocation("Echo/gradient.png"));
        ...
        float xStart = (float) (x + 55 + echoFont24.getStringWidth(module.getName()));
        float yVal = y + 35 / 2f - echoFont18.getHeight() / 2f;
        ...
        if (binding != module && (!hoverDescriptionAnimation.isDone() || hoverDescriptionAnimation.finished(Direction.FORWARDS))) {
            ...
            float descWidth = 305 - ((55 + echoFont24.getStringWidth(module.getName())) + 15);

            echoFont18.drawWrappedText(module.getDescription(), xStart, yVal,
                    new Color(128, 134, 141, (int) (255 * hover)).getRGB(), descWidth, 3);
        } else if (binding == module){
            echoFont18.drawString(
        ...
        if (module.getCategory().equals(Category.SCRIPTS)) {
            echoFont24.drawString(module.getName(), x + 42, y + (35 / 2f - echoFont24.getHeight() / 2f) - 6, -1);
            echoFont18.drawString(module.getAuthor(), x + 42, y + (35 / 2f - echoFont24.getHeight() / 2f) + 9,
                    new Color(255, 65, 65).getRGB());
        } else {
            echoFont24.drawString(module.getName(), x + 42, y + 35 / 2f - echoFont24.getHeight() / 2f, -1);
        }
