...
import dev.echo.utils.objects.PasswordField;
...
public class SearchPanel extends Panel {
    ...
    public void initGui() {
        ...
        modules = Echo.INSTANCE.getModuleCollection().getModules();
    ...
    public void drawScreen(int mouseX, int mouseY) {
        if (ModernClickGui.searching) {
            ...
            List<Module> possibleMods = Echo.INSTANCE.getModuleCollection().getModulesThatContainText(text);
            ...
            if (currentlySelected != null) {
                ...
                echoFont24.drawCenteredString(currentlySelected.module.getName(), newX + 125 / 2f, y - 10, -1);
