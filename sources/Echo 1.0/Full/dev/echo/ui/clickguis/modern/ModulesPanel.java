...
public class ModulesPanel extends Panel {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (!(HoveringUtil.isHovering(x + (250 + (55 * expandAnim.getOutput().floatValue())), y, 135, 250, mouseX, mouseY) && currentlySelected != null) &&
                !Echo.INSTANCE.getSideGui().isFocused()) {
            scroll.onScroll(25);
        }
        double scrollVal = MathUtils.roundToHalf(scroll.getScroll());

        echoFont18.drawCenteredString("Click your scroll wheel while hovering a module to change a keybind", x + 305 / 2f, (float) (y - 15 + scrollVal),
        ...
        if (currentlySelected != null) {
            ...
            echoBoldFont22.drawCenteredString(currentlySelected.module.getName(), newX + 125 / 2f, y - 15, -1);
