...
import dev.echo.ui.sidegui.forms.impl.SaveForm;
import dev.echo.ui.sidegui.forms.impl.UploadForm;
import dev.echo.ui.sidegui.panels.Panel;
import dev.echo.ui.sidegui.panels.configpanel.ConfigPanel;
import dev.echo.ui.sidegui.panels.infopanel.InfoPanel;
import dev.echo.ui.sidegui.panels.searchpanel.SearchPanel;
...
public class SideGUI implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ScaledResolution sr = new ScaledResolution(mc);
        HUDMod hudMod = (HUDMod) Echo.INSTANCE.getModuleCollection().get(HUDMod.class);
