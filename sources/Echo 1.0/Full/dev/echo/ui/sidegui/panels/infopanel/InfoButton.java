package dev.echo.ui.sidegui.panels.infopanel;
...
public class InfoButton implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (!openAnimation.isDone() || openAnimation.finished(Direction.FORWARDS)) {
            ...
            List<String> lines = echoFont16.getWrappedLines(answer, x + 5, (width - 5), heightIncrement);
            int spacing = 3;
            float totalAnswerHeight = (lines.size() * (echoFont16.getHeight() + heightIncrement)) + 4;
            ...
            for (String line : lines) {
                echoFont16.drawString(line, x + 3, answerY + 3.5f, textColor);
                answerY += echoFont16.getHeight() + heightIncrement;
            }
        ...
        //Question Text
        echoBoldFont18.drawString(question, x + 5, y + echoBoldFont18.getMiddleOfBox(height), textColor);
