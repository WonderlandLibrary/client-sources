...
public class InfoPanel extends Panel {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        echoBoldFont40.drawString("Info", getX() + 8, getY() + 8, getTextColor());
        echoFont18.drawString("developed by liticane, Nyghtfull and stephen", getX() + 8, getY() + 30, ColorUtil.applyOpacity(getTextColor(), .3f));
