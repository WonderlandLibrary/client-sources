    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (!openAnimation.isDone() || opened) {
            ...
            for (String option : options) {
                ...
                echoFont18.drawString(option, getX() + 5, dropdownY + seperation + echoFont18.getMiddleOfBox(getHeight()),
        ...
        echoFont18.drawString("§l" + name + ":§r " + selection, getX() + 4, getY() + echoFont18.getMiddleOfBox(getHeight()), textColor);
