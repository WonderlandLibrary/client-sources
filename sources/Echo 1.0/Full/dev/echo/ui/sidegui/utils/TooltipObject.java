...
public class TooltipObject implements Screen {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (tooltip.contains("\n")) {
            ...
            MutablePair<Float, Float> whPair = echoFont14.drawNewLineText(tooltip, x + 2, y + 2, ColorUtil.applyOpacity(-1, fadeAnim), 3);

            float additionalHeight = 0;
            if (additionalInformation != null) {
                additionalHeight = echoFont14.drawWrappedText(additionalInformation, x + 2,
            ...
            width = echoFont14.getStringWidth(tooltip) + 4;
            height = echoFont14.getHeight() + 2;
            ...
            echoFont14.drawCenteredString(tooltip, x + width / 2f, y + echoFont14.getMiddleOfBox(height), ColorUtil.applyOpacity(-1, fadeAnim));
