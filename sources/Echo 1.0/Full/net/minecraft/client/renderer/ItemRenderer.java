...
import dev.echo.listener.event.impl.render.CustomBlockRenderEvent;
import dev.echo.module.impl.combat.KillAura;
import dev.echo.module.impl.render.Animations;
...
public class ItemRenderer {
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress) {
        boolean animations = Echo.INSTANCE.isEnabled(Animations.class);
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
            ...
            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof ItemMap) {
                ...
                } else if (abstractclientplayer.getItemInUseCount() > 0 || (!KillAura.fake && InventoryUtils.getHeldItem() instanceof ItemSword) && KillAura.target != null) {
                    ...
                    switch (enumaction) {
                        ...
                        case BLOCK:
                            if (Echo.INSTANCE.isEnabled(Animations.class)) {
                                switch (Animations.mode.getMode()) {
                                    ...
                                    case "Custom":
                                        ...
                                        Echo.INSTANCE.getEventProtocol().handleEvent(blockRenderEvent);
                                        break;
                                }
                            } else {
                                this.transformFirstPersonItem(f, 0.0F);
