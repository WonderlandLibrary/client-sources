...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        Echo.INSTANCE.getEventProtocol().handleEvent(new UpdateEvent());
        ...
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            Echo.INSTANCE.getEventProtocol().handleEvent(motionEvent);
    ...
    public void onUpdateWalkingPlayer(MotionEvent motionEvent) {
        ...
        motionEvent.setState(Event.State.MID);
        Echo.INSTANCE.getEventProtocol().handleEvent(motionEvent);
        ...
        boolean looked = yawDiff != 0.0D || pitchDiff != 0.0D;
    ...
    public void sendChatMessage(String message) {
        if (Echo.INSTANCE.getCommandHandler().execute(message) || message.startsWith(CommandHandler.CHAT_PREFIX)) {
            return;
        }

        PlayerSendMessageEvent playerSendMessageEvent = new PlayerSendMessageEvent(message);
        Echo.INSTANCE.getEventProtocol().handleEvent(playerSendMessageEvent);
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        Echo.INSTANCE.getEventProtocol().handleEvent(pushOutOfBlockEvent);
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            ...
            Echo.INSTANCE.getEventProtocol().handleEvent(slowDownEvent);
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        Echo.INSTANCE.getEventProtocol().handleEvent(event);
