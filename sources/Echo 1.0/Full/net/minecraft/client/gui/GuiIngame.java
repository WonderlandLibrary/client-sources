...
public class GuiIngame extends Gui implements Utils {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        Echo.INSTANCE.getEventProtocol().handleEvent(new PreRenderEvent());


        PostProcessing postProcessing = (PostProcessing) Echo.INSTANCE.getModuleCollection().get(PostProcessing.class);
        postProcessing.blurScreen();


        Echo.INSTANCE.getEventProtocol().handleEvent(new Render2DEvent(scaledresolution.getScaledWidth(), scaledresolution.getScaledHeight()));
        NotificationsMod notif = Echo.INSTANCE.getModuleCollection().getModule(NotificationsMod.class);
        if (notif.isEnabled()) {
            notif.render();
        }
        ...
        if (scoreobjective1 != null && Echo.INSTANCE.isEnabled(ScoreboardMod.class)) {
    ...
    public void renderScoreboardBlur(ScaledResolution scaledRes) {
        ...
        if (objective != null && Echo.INSTANCE.isEnabled(ScoreboardMod.class)) {
    ...
    public AbstractFontRenderer getScoreboardFontRenderer() {
        return ScoreboardMod.customFont.isEnabled() ? echoFont20 : this.mc.fontRendererObj;
    }
