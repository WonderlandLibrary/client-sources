...
import dev.echo.listener.event.impl.game.*;
import dev.echo.listener.event.impl.input.ClickEvent;
import dev.echo.listener.event.impl.player.BlockEvent;
import dev.echo.listener.event.impl.player.BlockPlaceableEvent;
import dev.echo.module.impl.render.ClickGUIMod;
import dev.echo.protection.ProtectedLaunch;
import dev.echo.ui.SplashScreen;
import dev.echo.ui.clickguis.dropdown.DropdownClickGUI;
import dev.echo.ui.mainmenu.CustomMainMenu;
import dev.echo.utils.font.FontUtil;
import dev.echo.utils.misc.SoundUtils;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException {
        ...
        this.gameSettings.guiScale = 2;
        SoundUtils.playSound(new ResourceLocation("Echo/Sounds/opening.wav"), .8f);
    ...
    private void runGameLoop() throws IOException {
        ...
        if (!this.skipRenderWorld) {
            ...
            Echo.INSTANCE.getEventProtocol().handleEvent(renderTickEvent);
            this.mcProfiler.endStartSection("gameRenderer");
            this.entityRenderer.updateCameraAndRender(this.timer.renderPartialTicks, i);
            this.mcProfiler.endSection();
            renderTickEvent.setState(dev.echo.listener.event.Event.State.POST);
            Echo.INSTANCE.getEventProtocol().handleEvent(renderTickEvent);
        }
    ...
    public void shutdown() {
        Echo.INSTANCE.getEventProtocol().handleEvent(new GameCloseEvent());
        this.running = false;
    }
    ...
    public void runTick() throws IOException {
        ...
        Echo.INSTANCE.getEventProtocol().handleEvent(tickEvent);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        Echo.INSTANCE.getEventProtocol().handleEvent(new KeyPressEvent(k));
            ...
            Echo.INSTANCE.getEventProtocol().handleEvent(clickEvent);

            if (this.thePlayer.isUsingItem()) {
                BlockEvent blockEvent = new BlockEvent();
                Echo.INSTANCE.getEventProtocol().handleEvent(blockEvent);
            ...
            Echo.INSTANCE.getEventProtocol().handleEvent(new BlockPlaceableEvent());
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (theWorld != null) {
            ...
            Echo.INSTANCE.getEventProtocol().handleEvent(e);
        }
