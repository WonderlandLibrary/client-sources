...
public abstract class EntityLivingBase extends Entity {
    ...
    public void onDeath(DamageSource cause) {
        ...
        if (entity != null) {
            if (entity instanceof EntityLivingBase) {
                Echo.INSTANCE.getEventProtocol().handleEvent(new LivingDeathEvent(this, cause));
            }
    ...
    private int getArmSwingAnimationEnd() {
        return (Echo.INSTANCE.getModuleCollection().get(Animations.class).isEnabled() ? Animations.slowdown.getValue().intValue() : 1)
    ...
    protected void jump() {
        ...
        if (this.isSprinting()) {
            ...
            if (this instanceof EntityPlayerSP) {
                Echo.INSTANCE.getEventProtocol().handleEvent(jumpEvent);
            }

            float value = jumpEvent.getYaw() * 0.017453292F;
            this.motionX -= MathHelper.sin(value) * 0.2F;
            this.motionZ += MathHelper.cos(value) * 0.2F;
        }
