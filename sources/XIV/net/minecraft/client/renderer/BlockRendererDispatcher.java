...
public class BlockRendererDispatcher implements IResourceManagerReloadListener
{
    ...
    public boolean func_175018_a(IBlockState p_175018_1_, BlockPos p_175018_2_, IBlockAccess p_175018_3_, WorldRenderer p_175018_4_)
    {
        try
        {
            ...
            else
            {
                switch (var8)
                {
                    ...
                    case 3:
                        IBakedModel var61 = this.getModelFromBlockState(p_175018_1_, p_175018_3_, p_175018_2_);
                        return this.blockModelRenderer.func_178259_a(p_175018_3_, var61, p_175018_1_, p_175018_2_, p_175018_4_);
        ...
        {
            CrashReport var6 = CrashReport.makeCrashReport(var81, "Tesselating block in world");
