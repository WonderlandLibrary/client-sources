...
public class PotionHelper
{
    ...
    static
    {
        ...
        field_179539_o.put(Integer.valueOf(Potion.SPEED.getId()), "!0 & 1 & !2 & !3 & 1+6");
        magmaCreamEffect = "+0+1-2-3&4-4+13";
        field_179539_o.put(Integer.valueOf(Potion.FIRE_RESISTANCE.getId()), "0 & 1 & !2 & !3 & 0+6");
        speckledMelonEffect = "+0-1+2-3&4-4+13";
        field_179539_o.put(Integer.valueOf(Potion.INSTANT_HEALTH.getId()), "0 & !1 & 2 & !3");
        ...
        field_179539_o.put(Integer.valueOf(Potion.INSTANT_DAMAGE.getId()), "!0 & !1 & 2 & 3");
        field_179539_o.put(Integer.valueOf(Potion.SLOWNESS.getId()), "!0 & 1 & !2 & 3 & 3+6");
        blazePowderEffect = "+0-1-2+3&4-4+13";
        field_179539_o.put(Integer.valueOf(Potion.STRENGTH.getId()), "0 & !1 & !2 & 3 & 3+6");
        goldenCarrotEffect = "-0+1+2-3+13&4-4";
        field_179539_o.put(Integer.valueOf(Potion.NIGHT_VISION.getId()), "!0 & 1 & 2 & !3 & 2+6");
        field_179539_o.put(Integer.valueOf(Potion.INVISIBILITY.getId()), "!0 & 1 & 2 & 3 & 2+6");
        field_151423_m = "+0-1+2+3+13&4-4";
        field_179539_o.put(Integer.valueOf(Potion.WATER_BREATHING.getId()), "0 & !1 & 2 & 3 & 2+6");
        field_179538_n = "+0+1-2+3&4-4+13";
        field_179539_o.put(Integer.valueOf(Potion.JUMP_BOOST.getId()), "0 & 1 & !2 & 3");
        glowstoneEffect = "+5-6-7";
        field_179540_p.put(Integer.valueOf(Potion.SPEED.getId()), "5");
        field_179540_p.put(Integer.valueOf(Potion.HASTE.getId()), "5");
        field_179540_p.put(Integer.valueOf(Potion.STRENGTH.getId()), "5");
        field_179540_p.put(Integer.valueOf(Potion.REGENERATION.getId()), "5");
        field_179540_p.put(Integer.valueOf(Potion.INSTANT_DAMAGE.getId()), "5");
        field_179540_p.put(Integer.valueOf(Potion.INSTANT_HEALTH.getId()), "5");
        field_179540_p.put(Integer.valueOf(Potion.RESISTANCE.getId()), "5");
        field_179540_p.put(Integer.valueOf(Potion.POISON.getId()), "5");
        field_179540_p.put(Integer.valueOf(Potion.JUMP_BOOST.getId()), "5");
