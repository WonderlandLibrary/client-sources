...
public final class PathUtils extends MinecraftInstance {
    ...
    public static List<Vec3> findBlinkPath2(double curX, double curY, double curZ, final double tpX, final double tpY, final double tpZ, final double dashDistance) {
