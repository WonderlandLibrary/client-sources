...
public class GraphicsFactory {
	...
	private static void init() throws SlickException {
		...
		Minecraft.logger.info("[slick] Offscreen Buffers FBO="+fbo+" PBUFFER="+pbuffer+" PBUFFERRT="+pbufferRT);
	}
	...
	private static Graphics createGraphics(Image image) throws SlickException {
		...
		if (fbo) {
			try {
				...
				fbo = false;
				Minecraft.logger.warn("[slick] FBO failed in use, falling back to PBuffer");
			}
		}
