...
extends Type<ChunkSection> {
    ...
    public ChunkSection read(ByteBuf buffer) throws Exception {
        ...
        if ((blockData = new long[Type.VAR_INT.readPrimitive(buffer)]).length > 0) {
            ...
            CompactArrayUtil.iterateCompactArrayWithPadding(bitsPerBlock, 4096, blockData, bitsPerBlock == 15 ? (arg_0, arg_1) -> chunkSection.setFlatBlock(arg_0, arg_1) : (arg_0, arg_1) -> chunkSection.setPaletteIndex(arg_0, arg_1));
        }
        return chunkSection;
    }
