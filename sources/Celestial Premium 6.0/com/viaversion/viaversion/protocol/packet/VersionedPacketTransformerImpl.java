...
implements VersionedPacketTransformer<C, S> {
    ...
    private void validatePacket(PacketWrapper packet) {
        ...
        Class<Object> class_ = expectedPacketClass = packet.getPacketType().direction() == Direction.CLIENTBOUND ? this.clientboundPacketsClass : this.serverboundPacketsClass;
