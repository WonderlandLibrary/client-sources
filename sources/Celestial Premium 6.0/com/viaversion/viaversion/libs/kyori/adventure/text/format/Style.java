...
Examinable {
    ...
    extends Enum<Merge> {
        public static final /* enum */ Merge COLOR = new Merge();
        public static final /* enum */ Merge DECORATIONS = new Merge();
        public static final /* enum */ Merge EVENTS = new Merge();
        public static final /* enum */ Merge INSERTION = new Merge();
        public static final /* enum */ Merge FONT = new Merge();
        static final Set<Merge> ALL;
        static final Set<Merge> COLOR_AND_DECORATIONS;
        private static final /* synthetic */ Merge[] $VALUES;

        public static Merge[] values() {
            return (Merge[])$VALUES.clone();
        }

        public static Merge valueOf(String name) {
            return Enum.valueOf(Merge.class, name);
        }
        ...
        private static /* synthetic */ Merge[] $values() {
            return new Merge[]{COLOR, DECORATIONS, EVENTS, INSERTION, FONT};
        }
        ...
        extends Enum<Strategy> {
            public static final /* enum */ Strategy ALWAYS = new Strategy();
            public static final /* enum */ Strategy NEVER = new Strategy();
            public static final /* enum */ Strategy IF_ABSENT_ON_TARGET = new Strategy();
            ...
            public static Strategy valueOf(String name) {
                return Enum.valueOf(Strategy.class, name);
            }

            private static /* synthetic */ Strategy[] $values() {
                return new Strategy[]{ALWAYS, NEVER, IF_ABSENT_ON_TARGET};
            }
