...
Serializable {
    ...
    private final K[] a;
    private static final Collector<Object, ?, ObjectImmutableList<Object>> TO_LIST_COLLECTOR = Collector.of(ObjectArrayList::new, ObjectArrayList::add, (BinaryOperator)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;, combine(com.viaversion.viaversion.libs.fastutil.objects.ObjectArrayList ), (Lcom/viaversion/viaversion/libs/fastutil/objects/ObjectArrayList;Lcom/viaversion/viaversion/libs/fastutil/objects/ObjectArrayList;)Lcom/viaversion/viaversion/libs/fastutil/objects/ObjectArrayList;)(), ObjectImmutableList::convertTrustedToImmutableList, new Collector.Characteristics[0]);
    ...
    public static <K> Collector<K, ?, ObjectImmutableList<K>> toListWithExpectedSize(int expectedSize) {
        ...
        return Collector.of(new ObjectCollections.SizeDecreasingSupplier(expectedSize, size -> size <= 10 ? new ObjectArrayList() : new ObjectArrayList(size)), ObjectArrayList::add, (BinaryOperator)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;, combine(com.viaversion.viaversion.libs.fastutil.objects.ObjectArrayList ), (Lcom/viaversion/viaversion/libs/fastutil/objects/ObjectArrayList;Lcom/viaversion/viaversion/libs/fastutil/objects/ObjectArrayList;)Lcom/viaversion/viaversion/libs/fastutil/objects/ObjectArrayList;)(), ObjectImmutableList::convertTrustedToImmutableList, new Collector.Characteristics[0]);
    }
