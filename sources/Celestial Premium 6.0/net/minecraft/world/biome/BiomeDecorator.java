...
public class BiomeDecorator {
    ...
    protected void genDecorations(Biome biomeIn, World worldIn, Random random) {
        ...
        for (int l2 = 0; l2 < this.flowersPerChunk; ++l2) {
            ...
            if (j14 <= 0 || (blockflower = (blockflower$enumflowertype = biomeIn.pickRandomFlower(random, blockpos1 = this.chunkPos.add(i7, k17 = random.nextInt(j14), l10))).getBlockType().getBlock()).getDefaultState().getMaterial() == Material.AIR) continue;
        ...
        for (int k3 = 0; k3 < this.waterlilyPerChunk; ++k3) {
            ...
            while (blockpos4.getY() > 0 && worldIn.isAirBlock(blockpos7 = blockpos4.down())) {
                blockpos4 = blockpos7;
            }
        ...
        for (int l3 = 0; l3 < this.mushroomsPerChunk; ++l3) {
            ...
            if (random.nextInt(8) != 0 || (j15 = worldIn.getHeight(this.chunkPos.add(j8 = random.nextInt(16) + 8, 0, i12 = random.nextInt(16) + 8)).getY() * 2) <= 0) continue;
