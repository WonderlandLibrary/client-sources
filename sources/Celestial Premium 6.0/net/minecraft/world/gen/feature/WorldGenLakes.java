            ...
            for (int j2 = 0; j2 < 16; ++j2) {
                for (int k3 = 0; k3 < 16; ++k3) {
                    for (int k4 = 0; k4 < 8; ++k4) {
                        ...
                        if (!flag1 || k4 >= 4 && rand.nextInt(2) == 0 || !worldIn.getBlockState(position.add(j2, k4, k3)).getMaterial().isSolid()) continue;
        ...
        if (this.block.getDefaultState().getMaterial() == Material.WATER) {
            for (int k2 = 0; k2 < 16; ++k2) {
                for (int l3 = 0; l3 < 16; ++l3) {
                    int l4 = 4;
                    if (!worldIn.canBlockFreezeWater(position.add(k2, 4, l3))) continue;
