        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
            ...
            block0: for (RoomDefinition structureoceanmonumentpieces$roomdefinition : list) {
                ...
                for (MonumentRoomFitHelper monumentRoomFitHelper : list1) {
                    if (!monumentRoomFitHelper.fits(structureoceanmonumentpieces$roomdefinition)) continue;
                    this.childPieces.add(monumentRoomFitHelper.create(enumfacing, structureoceanmonumentpieces$roomdefinition, p_i45599_1_));
                    continue block0;
                }
            }
