...
public class WoodlandMansionPieces {
    ...
    static class Placer {
                    ...
                    for (int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.field_191149_b; ++l1) {
                        ...
                        if ((i2 & 0x200000) == 0x200000) {
                            for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings()) {
                                if (woodlandmansionpieces$simplegrid3.func_191145_a(l1 + enumfacing.getXOffset(), k1 + enumfacing.getZOffset()) != 1) continue;
                                list.add(enumfacing);
                            }
                        }
                        ...
                        if (j2 == 262144 && enumfacing1 != null && enumfacing1 != EnumFacing.UP) {
                            ...
                            if (!p_191125_4_.func_191114_a(woodlandmansionpieces$simplegrid3, l1 + enumfacing2.getXOffset(), k1 + enumfacing2.getZOffset(), l2, k2)) {
        ...
        private void func_191130_a(List<MansionTemplate> p_191130_1_, PlacementData p_191130_2_, SimpleGrid p_191130_3_, EnumFacing p_191130_4_, int p_191130_5_, int p_191130_6_, int p_191130_7_, int p_191130_8_) {
            ...
            do {
                if (!Grid.func_191109_a(p_191130_3_, i + p_191130_4_.getXOffset(), j + p_191130_4_.getZOffset())) {
                ...
                if (Grid.func_191109_a(p_191130_3_, i + p_191130_4_.getXOffset(), j + p_191130_4_.getZOffset()) && Grid.func_191109_a(p_191130_3_, i + p_191130_4_.getXOffset() + p_191130_4_.rotateYCCW().getXOffset(), j + p_191130_4_.getZOffset() + p_191130_4_.rotateYCCW().getZOffset())) {
                ...
                if ((i += p_191130_4_.getXOffset()) == p_191130_7_ && (j += p_191130_4_.getZOffset()) == p_191130_8_ && enumfacing == p_191130_4_) continue;
                this.func_191131_b(p_191130_1_, p_191130_2_);
    ...
    static class Grid {
        ...
        public EnumFacing func_191113_b(SimpleGrid p_191113_1_, int p_191113_2_, int p_191113_3_, int p_191113_4_, int p_191113_5_) {
            for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings()) {
                if (!this.func_191114_a(p_191113_1_, p_191113_2_ + enumfacing.getXOffset(), p_191113_3_ + enumfacing.getZOffset(), p_191113_4_, p_191113_5_)) continue;
                return enumfacing;
            }
            return null;
        }
        ...
        private void func_191110_a(SimpleGrid p_191110_1_, int p_191110_2_, int p_191110_3_, EnumFacing p_191110_4_, int p_191110_5_) {
            if (p_191110_5_ > 0) {
                ...
                for (int i = 0; i < 8; ++i) {
                    EnumFacing enumfacing = EnumFacing.byHorizontalIndex(this.field_191117_a.nextInt(4));
                    ...
                    if (p_191110_1_.func_191145_a(j + enumfacing.getXOffset(), k + enumfacing.getZOffset()) != 0 || p_191110_1_.func_191145_a(j + enumfacing.getXOffset() * 2, k + enumfacing.getZOffset() * 2) != 0) continue;
                    this.func_191110_a(p_191110_1_, p_191110_2_ + p_191110_4_.getXOffset() + enumfacing.getXOffset(), p_191110_3_ + p_191110_4_.getZOffset() + enumfacing.getZOffset(), enumfacing, p_191110_5_ - 1);
                    break;
                }
        ...
        private void func_191115_b() {
            ...
            if (list.isEmpty()) {
                ...
                int i2 = (Integer)tuple.getFirst() + enumfacing1.getXOffset();
                ...
                for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings()) {
                    if (this.field_191119_c.func_191145_a(i2 + enumfacing.getXOffset(), i1 + enumfacing.getZOffset()) != 0) continue;
                ...
                if (list1.isEmpty()) {
                    ...
                    this.func_191110_a(this.field_191119_c, i2 + enumfacing2.getXOffset(), i1 + enumfacing2.getZOffset(), enumfacing2, 4);
