...
public class RenderChunk {
    ...
    public void setPosition(int p_189562_1_, int p_189562_2_, int p_189562_3_) {
        if (p_189562_1_ != this.position.getX() || p_189562_2_ != this.position.getY() || p_189562_3_ != this.position.getZ()) {
            ...
            EventManager.call(new EventRenderChunk(this, new BlockPos(p_189562_1_, p_189562_2_, p_189562_2_)));
        ...
        if (((Boolean)Baritone.settings().renderCachedChunks.value).booleanValue() && !Minecraft.getMinecraft().isSingleplayer() && (ctx = (baritone = (Baritone)BaritoneAPI.getProvider().getPrimaryBaritone()).getPlayerContext()).player() != null && ctx.world() != null && baritone.bsi != null) {
            ...
            for (int dx = -1; dx <= 1; ++dx) {
                for (int dz = -1; dz <= 1; ++dz) {
                    if (!baritone.bsi.isLoaded(16 * dx + position.getX(), 16 * dz + position.getZ())) continue;
                    return false;
                }
            }
        }
    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
        ...
        if (this.world != null) {
            ...
            if (!this.baritoneIsEmpty(chunkcacheof)) {
                ++renderChunksUpdated;
                ...
                for (Object blockposm0 : BlockPosM.getAllInBoxMutable(blockpos, blockpos1)) {
                    ...
                    IBlockState iblockstate = this.baritoneGetBlockState(chunkcacheof, blockposm);
            ...
            try {
                HashSet<TileEntity> set = Sets.newHashSet(lvt_10_1_);
