            ...
            if (!Config.isShaders() || !Shaders.isShadowPass) {
                ...
                if (Celestial.instance.featureManager.getFeatureByClass(EnchantmentColor.class).getState()) {
                    if (EnchantmentColor.colorMode.currentMode.equals("Rainbow")) {
                        this.func_191965_a(p_191966_1_, PaletteHelper.rainbow((int)f, 1.0f, 1.0f).getRGB());
                    } else if (EnchantmentColor.colorMode.currentMode.equals("Custom")) {
                        this.func_191965_a(p_191966_1_, new Color(EnchantmentColor.customColor.getColor()).getRGB());
