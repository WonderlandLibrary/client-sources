...
extends ModelBase {
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            this.spine.rotateAngleY = this.updateRotations(adouble1[0] - adouble[0]) * ((float)Math.PI / 180) * 1.5f;
            this.spine.rotateAngleX = f9 + entitydragon.getHeadPartYOffset(i, adouble, adouble1) * ((float)Math.PI / 180) * 1.5f * 5.0f;
            this.spine.rotateAngleZ = -this.updateRotations(adouble1[0] - (double)f7) * ((float)Math.PI / 180) * 1.5f;
        ...
        this.head.rotateAngleY = this.updateRotations(adouble2[0] - adouble[0]) * ((float)Math.PI / 180);
        this.head.rotateAngleX = this.updateRotations(entitydragon.getHeadPartYOffset(6, adouble, adouble2)) * ((float)Math.PI / 180) * 1.5f * 5.0f;
        this.head.rotateAngleZ = -this.updateRotations(adouble2[0] - (double)f7) * ((float)Math.PI / 180);
        ...
        float f10 = -((float)Math.sin(f * ((float)Math.PI * 2))) * 0.0f;
        ...
        for (int k = 0; k < 12; ++k) {
            ...
            this.spine.rotateAngleY = (this.updateRotations(adouble2[0] - adouble[0]) * 1.5f + 180.0f) * ((float)Math.PI / 180);
            this.spine.rotateAngleX = f10 + (float)(adouble2[1] - adouble[1]) * ((float)Math.PI / 180) * 1.5f * 5.0f;
            this.spine.rotateAngleZ = this.updateRotations(adouble2[0] - (double)f7) * ((float)Math.PI / 180) * 1.5f;
            this.spine.rotationPointY = f2;
            this.spine.rotationPointZ = f3;
            this.spine.rotationPointX = f4;
            f2 = (float)((double)f2 + Math.sin(this.spine.rotateAngleX) * 10.0);
