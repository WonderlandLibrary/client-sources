...
public class RecipeItemHelper {
    ...
    class RecipePicker {
        ...
        public boolean func_194092_a(int p_194092_1_, @Nullable IntList p_194092_2_) {
            ...
            for (int k1 = 0; k1 < list.size(); ++k1) {
                ...
                for (int l1 = 0; l1 < this.field_194109_f; ++l1) {
                    if (!this.func_194100_b(false, j1, l1)) continue;
        ...
        private boolean func_194098_a(int p_194098_1_) {
            ...
            for (int l = 0; l < k; ++l) {
                if (RecipeItemHelper.this.field_194124_a.get(this.field_194108_e[l]) < p_194098_1_) continue;
                ...
                while (!this.field_194111_h.isEmpty()) {
                    ...
                    for (int l1 = 0; l1 < k1; ++l1) {
                        if (this.func_194101_b(flag, l1) || !this.func_194093_a(flag, j1, l1) || !this.func_194100_b(flag, j1, l1)) continue;
                        this.func_194088_a(flag, l1);
                        break;
                    }
                    if ((i2 = this.field_194111_h.size()) != i1) continue;
