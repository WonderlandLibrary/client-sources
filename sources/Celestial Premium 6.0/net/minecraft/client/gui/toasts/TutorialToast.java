...
implements IToast {
    ...
    public IToast.Visibility draw(GuiToast p_193653_1_, long p_193653_2_) {
        ...
        if (this.field_193673_e == null) {
            p_193653_1_.getMinecraft().fontRendererObj.drawString(this.field_193672_d, 30.0f, 12.0f, -11534256);
        } else {
            p_193653_1_.getMinecraft().fontRendererObj.drawString(this.field_193672_d, 30.0f, 7.0f, -11534256);
            p_193653_1_.getMinecraft().fontRendererObj.drawString(this.field_193673_e, 30.0f, 18.0f, -16777216);
        }
