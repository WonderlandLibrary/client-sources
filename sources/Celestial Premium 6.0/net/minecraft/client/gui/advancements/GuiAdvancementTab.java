...
extends Gui {
    ...
    public void func_191799_a() {
        ...
        GuiAdvancementTab.drawRect(0, 0, 234, 113, -16777216);
        ...
        for (int k = -1; k <= 15; ++k) {
            for (int l = -1; l <= 8; ++l) {
                GuiAdvancementTab.drawModalRectWithCustomSizedTexture(i + 16 * k, j + 16 * l, 0.0f, 0.0f, 16.0f, 16.0f, 16.0f, 16.0f);
            }
        }
    ...
    public void func_192991_a(int p_192991_1_, int p_192991_2_, int p_192991_3_, int p_192991_4_) {
        ...
        GuiAdvancementTab.drawRect(0, 0, 234, 113, MathHelper.floor(this.field_191815_r * 255.0f) << 24);
        boolean flag = false;
