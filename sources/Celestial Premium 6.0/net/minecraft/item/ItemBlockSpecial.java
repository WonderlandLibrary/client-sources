...
extends Item {
    ...
    public EnumActionResult onItemUse(EntityPlayer stack, World playerIn, BlockPos worldIn, EnumHand pos, EnumFacing hand, float facing, float hitX, float hitY) {
        ...
        if (!itemstack.isEmpty() && stack.canPlayerEdit(worldIn, hand, itemstack) && playerIn.mayPlace(this.block, worldIn, false, hand, null)) {
            IBlockState iblockstate1 = this.block.getStateForPlacement(playerIn, worldIn, hand, facing, hitX, hitY, 0, stack);
