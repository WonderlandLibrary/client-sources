...
{
    WHITE(0, 15, "white", "white", 0xF9FFFE, TextFormatting.WHITE),
    ...
    SILVER(8, 7, "silver", "silver", 0x9D9D97, TextFormatting.GRAY),
    ...
    BLACK(15, 0, "black", "black", 0x1D1D21, TextFormatting.BLACK);
    ...
    static {
        ...
        EnumDyeColor[] arrenumDyeColor = EnumDyeColor.values();
        int n = arrenumDyeColor.length;
        for (int i = 0; i < n; ++i) {
            EnumDyeColor enumdyecolor;
            EnumDyeColor.META_LOOKUP[enumdyecolor.getMetadata()] = enumdyecolor = arrenumDyeColor[i];
