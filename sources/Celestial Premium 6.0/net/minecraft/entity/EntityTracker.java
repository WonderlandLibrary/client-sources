...
public class EntityTracker {
    ...
    public EntityTracker(WorldServer theWorldIn) {
        ...
        this.maxTrackingDistanceThreshold = theWorldIn.getInstanceServer().getPlayerList().getEntityViewDistance();
    }
    ...
    public void sendLeashedEntitiesInChunk(EntityPlayerMP player, Chunk chunkIn) {
        ...
        for (EntityTrackerEntry entitytrackerentry : this.trackedEntities) {
            ...
            if (entity == player || entity.chunkCoordX != chunkIn.x || entity.chunkCoordZ != chunkIn.z) continue;
            entitytrackerentry.updatePlayerEntity(player);
