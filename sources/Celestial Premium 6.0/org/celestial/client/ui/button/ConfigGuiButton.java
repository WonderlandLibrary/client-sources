...
extends GuiButton {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float mouseButton) {
        if (this.visible) {
            ...
            RectHelper.drawSkeetButton(this.xPosition + 125, this.yPosition + 2, this.width + this.xPosition - 75, height + this.yPosition);
            mc.robotoRegularFontRender.drawCenteredString(this.displayString, (float)this.xPosition + (float)this.width / 2.0f + 25.0f, (float)this.yPosition + ((float)this.height - 72.5f), text.getRGB());
    ...
    public boolean mousePressed(Minecraft mc, int mouseX, int mouseY) {
        int height = this.height - 31;
        return this.enabled && this.visible && mouseX >= this.xPosition + 93 && mouseY >= this.yPosition - 41 && mouseX < this.xPosition + this.width - 43 && mouseY < height + this.yPosition - 30;
    }
