    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (!s.isEmpty()) {
                ...
                j1 = (int)Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(s1, l, i1, i);
            }
            ...
            if (!s.isEmpty() && flag && j < s.length()) {
                j1 = (int)Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(s.substring(j), j1, i1, i);
            }
            if (flag1) {
                if (flag2) {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + Minecraft.getMinecraft().fontRenderer.getFontHeight(), -3092272);
                } else {
            ...
            if (k != j) {
                ...
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + Minecraft.getMinecraft().fontRenderer.getFontHeight());
            }
        }
    }
