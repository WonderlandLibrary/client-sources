 ...
 */
package org.celestial.client.helpers.world;
...
implements Helper {
    ...
    public static EntityLivingBase rayCast(Entity e, double range) {
        ...
        AxisAlignedBB axis = EntityHelper.mc.player.getEntityBoundingBox().addCoord(vec.x - vec1.x, vec.y - vec1.y, vec.z - vec1.z).expand(1.0, 1.0, 1.0);
        Entity nearst = null;
