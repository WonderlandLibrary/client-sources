        ...
        if (classProvider.isEntityLivingBase(entity) && (targetDead || entity.isEntityAlive()) && entity != null && !entity.equals(mc.getThePlayer()) && (targetInvisible || !entity.isInvisible())) {
            if (targetPlayer && classProvider.isEntityPlayer(entity)) {
                ...
                if (canAttackCheck) {
                    ...
                    if (EntityUtils2.isFriend(entityPlayer) && !LiquidBounce.moduleManager.getModule(NoFriends.class).getState()) {
                        return false;
                    }
            ...
            return targetMobs && EntityUtils2.isMob(entity) || targetAnimals && EntityUtils2.isAnimal(entity);
        }
        return false;
    }
