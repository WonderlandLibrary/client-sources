    ...
    public final void onRender3D(@NotNull Render3DEvent event) {
        ...
        switch (string3) {
            ...
            case "bowpower": {
                ...
                RenderUtils.glColor(this.interpolateHSB(color, color2, motionFactor / (float)30 * (float)10));
                break;
            }
            case "rainbow": {
        ...
        while (!hasLanded && posY > 0.0) {
            ...
            for (IEntity possibleEntity : collidedEntities) {
                ...
                if (!possibleEntity.canBeCollidedWith() || !(Intrinsics.areEqual(possibleEntity, thePlayer) ^ true)) continue;
