...
extends Module {
    ...
    static void sendCriticalPacket$default(Criticals2 criticals2, double d, double d2, double d3, boolean bl, int n, Object object) {
        if ((n & 1) != 0) {
            d = 0.0;
        }
        if ((n & 2) != 0) {
