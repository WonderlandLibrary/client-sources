...
extends Module {
    private final IntegerValue maxCPS = new IntegerValue(this, "MaxCPS", 8, 1, 20){
        ...
        protected void onChanged(int oldValue, int newValue) {
            int i = ((Number)KillAura3.access$getMinCPS$p(this.this$0).get()).intValue();
            if (i > newValue) {
                this.set(i);
            }
    ...
    private final IntegerValue minCPS = new IntegerValue(this, "MinCPS", 5, 1, 20){
        ...
        protected void onChanged(int oldValue, int newValue) {
            int i = ((Number)KillAura3.access$getMaxCPS$p(this.this$0).get()).intValue();
            if (i < newValue) {
                this.set(i);
            }
    ...
    private final FloatValue maxTurnSpeed = new FloatValue(this, "MaxTurnSpeed", 180.0f, 0.0f, 180.0f){
        ...
        protected void onChanged(float oldValue, float newValue) {
            float v = ((Number)KillAura3.access$getMinTurnSpeed$p(this.this$0).get()).floatValue();
            if (v > newValue) {
    ...
    private final FloatValue minTurnSpeed = new FloatValue(this, "MinTurnSpeed", 180.0f, 0.0f, 180.0f){
        ...
        protected void onChanged(float oldValue, float newValue) {
            float v = ((Number)KillAura3.access$getMaxTurnSpeed$p(this.this$0).get()).floatValue();
            if (v < newValue) {
                this.set(Float.valueOf(v));
            }
        }
    ...
    private final FloatValue maxPredictSize = new FloatValue(this, "MaxPredictSize", 1.0f, 0.1f, 5.0f){
        ...
        protected void onChanged(float oldValue, float newValue) {
            float v = ((Number)KillAura3.access$getMinPredictSize$p(this.this$0).get()).floatValue();
            if (v > newValue) {
                this.set(Float.valueOf(v));
            }
        }
    ...
    private final FloatValue minPredictSize = new FloatValue(this, "MinPredictSize", 1.0f, 0.1f, 5.0f){
        ...
        protected void onChanged(float oldValue, float newValue) {
            float v = ((Number)KillAura3.access$getMaxPredictSize$p(this.this$0).get()).floatValue();
            if (v < newValue) {
                this.set(Float.valueOf(v));
            }
        }
...
lbl84:
        ...
        if (!KillAura3.access$isAlive(this_$iv, v28) || LiquidBounce.INSTANCE.getModuleManager().get(Blink.class).getState() || LiquidBounce.INSTANCE.getModuleManager().get(FreeCam.class).getState()) lbl-1000:
        // 2 sources
    ...
    public final void onRender3D(@NotNull Render3DEvent event) {
        ...
        if (!KillAura3.access$isAlive(this_$iv, v23) || LiquidBounce.INSTANCE.getModuleManager().get(Blink.class).getState() || LiquidBounce.INSTANCE.getModuleManager().get(FreeCam.class).getState()) lbl-1000:
        // 2 sources
        ...
        if (((Boolean)this.raycastValue.get()).booleanValue()) {
            IEntity raycastedEntity2 = RaycastUtils.raycastEntity(reach, new RaycastUtils.EntityFilter(this){
                ...
                public boolean canRaycast(@Nullable IEntity entity) {
                    ...
                    if (KillAura3.access$isEnemy(this.this$0, entity)) return true;
    ...
    public static final boolean access$isEnemy(KillAura3 $this, IEntity entity) {
        return $this.isEnemy(entity);
    }

    public static final BoolValue access$getLivingRaycastValue$p(KillAura3 $this) {
        return $this.livingRaycastValue;
    }

    public static final BoolValue access$getRaycastIgnoredValue$p(KillAura3 $this) {
        return $this.raycastIgnoredValue;
    }

    public static final BoolValue access$getAacValue$p(KillAura3 $this) {
        return $this.aacValue;
    }

    public static final IntegerValue access$getMinCPS$p(KillAura3 $this) {
        return $this.minCPS;
    }

    public static final long access$getAttackDelay$p(KillAura3 $this) {
        return $this.attackDelay;
    }

    public static final void access$setAttackDelay$p(KillAura3 $this, long l) {
        $this.attackDelay = l;
    }

    public static final IntegerValue access$getMaxCPS$p(KillAura3 $this) {
        return $this.maxCPS;
    }

    public static final FloatValue access$getMinTurnSpeed$p(KillAura3 $this) {
        return $this.minTurnSpeed;
    }

    public static final FloatValue access$getMaxTurnSpeed$p(KillAura3 $this) {
        return $this.maxTurnSpeed;
    }

    public static final FloatValue access$getMinPredictSize$p(KillAura3 $this) {
        return $this.minPredictSize;
    }

    public static final FloatValue access$getMaxPredictSize$p(KillAura3 $this) {
    ...
    @Metadata(mv={1, 1, 16}, bv={1, 0, 3}, k=1, d1={"\u0000\n\n\u0000\n\b\n\b\n\b\b\u000020B\b¢R$08@X¢\n\u0000\b\b\"\b\b\t¨\n"}, d2={"Lnet/ccbluex/liquidbounce/features/module/modules/combat/KillAura3$Companion;", "", "()V", "killCounts", "", "killCounts$annotations", "getKillCounts", "()I", "setKillCounts", "(I)V", "Pride"})
