...
extends MinecraftInstance {
    public final File dir = new File(mc.getDataDir(), "RedStar-1.12");
    ...
    public void loadBackground() {
        if (this.backgroundFile.exists()) {
            try {
                ...
                LiquidBounce.INSTANCE.setBackground(classProvider.createResourceLocation("RedStar".toLowerCase() + "/background.png"));
