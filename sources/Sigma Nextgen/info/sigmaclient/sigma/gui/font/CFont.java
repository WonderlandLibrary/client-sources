...
extends JelloFontRenderer {
    ...
    public void drawChar(CharData[] chars, char c2, double x2, double y2) throws ArrayIndexOutOfBoundsException {
        try {
    ...
    protected void drawQuad(double x2, double y2, float width, float height, float srcX, float srcY, float srcWidth, float srcHeight) {
        ...
        GL11.glTexCoord2f(renderSRCX + renderSRCWidth, renderSRCY);
        GL11.glVertex2d(x2 + width, y2);
//        final float n9 = (float) (width - x2);
//        final float n10 = (float) (height - y2);
//        final float n11 = srcX / this.imgSize;
//        final float n12 = srcY / this.imgSize;
//        final float n13 = srcWidth - srcX;
//        final float n14 = srcHeight - srcY;
//        final float n15 = n13 / this.imgSize;
//        final float n16 = n14 / this.imgSize;
//        GL11.glTexCoord2f(n11, n12);
//        GL11.glVertex2d(x2, y2);
//        GL11.glTexCoord2f(n11, n12 + n16);
//        GL11.glVertex2d(x2, y2 + n10);
//        GL11.glTexCoord2f(n11 + n15, n12 + n16);
//        GL11.glVertex2d(x2 + n9, y2 + n10);
//        GL11.glTexCoord2f(n11 + n15, n12);
//        GL11.glVertex2d(x2 + n9, y2);
    }
