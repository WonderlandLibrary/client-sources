...
public abstract class Interface
{
    ...
    public Interface(final String name, final int w, final int h, final ModOptions option) {
        this(name, w, h, w, h, option);
    }
    
    public Interface(final String name, final int w, final int h, final int wc, final int hc, final ModOptions option) {
        this.iname = name;
        this.w = w;
        this.w0 = w;
        this.h = h;
