package info.sigmaclient.sigma.utils.render.outline;
...
//        glEnable(GL_LIGHTING);
    ...
    public static void checkSetupFBO() {
        ...
        final Framebuffer fbo = Minecraft.getInstance().getFramebuffer();
    ...
    private static void setupFBO(final Framebuffer fbo) {
        ...
        // Width, Height
        EXTFramebufferObject.glRenderbufferStorageEXT(EXTFramebufferObject.GL_RENDERBUFFER_EXT, EXTPackedDepthStencil.GL_DEPTH_STENCIL_EXT, Minecraft.getInstance().getMainWindow().getWidth(), Minecraft.getInstance().getMainWindow().getHeight());
