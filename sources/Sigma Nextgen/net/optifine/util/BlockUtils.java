...
import info.sigmaclient.sigma.modules.render.XRay;
...
public class BlockUtils
{
    ...
    public static boolean shouldSideBeRendered(BlockState blockStateIn, IBlockReader blockReaderIn, BlockPos blockPosIn, Direction facingIn, RenderEnv renderEnv)
    {
        ...
        if(SigmaNG.getSigmaNG().moduleManager.getModule(XRay.class).enabled){
            if(!(blockStateIn.getBlock() instanceof OreBlock)){
                return false;
            }else{
                return true;
            }
