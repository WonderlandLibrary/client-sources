...
public class ReflectorForge
{
    ...
    public static boolean canDisableShield(ItemStack itemstack, ItemStack itemstack1, PlayerEntity PlayerEntity, MobEntity entityLiving)
    {
        return Reflector.IForgeItemStack_canDisableShield.exists() ? Reflector.callBoolean(itemstack, Reflector.IForgeItemStack_canDisableShield, itemstack1, PlayerEntity, entityLiving) : itemstack.getItem() instanceof AxeItem;
    }
