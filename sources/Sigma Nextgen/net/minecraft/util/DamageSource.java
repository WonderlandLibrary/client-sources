...
public class DamageSource
{
    ...
    public static DamageSource causeExplosionDamage(@Nullable LivingEntity LivingEntityIn)
    {
        return LivingEntityIn != null ? (new EntityDamageSource("explosion.player", LivingEntityIn)).setDifficultyScaled().setExplosion() : (new DamageSource("explosion")).setDifficultyScaled().setExplosion();
    }
    ...
    {
        LivingEntity livingentity = LivingEntityIn.getAttackingEntity();
        String s = "death.attack." + this.damageType;
        String s1 = s + ".player";
        return livingentity != null ? new TranslationTextComponent(s1, LivingEntityIn.getDisplayName(), livingentity.getDisplayName()) : new TranslationTextComponent(s, LivingEntityIn.getDisplayName());
    }
