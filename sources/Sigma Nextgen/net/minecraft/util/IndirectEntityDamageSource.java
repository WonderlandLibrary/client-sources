...
public class IndirectEntityDamageSource extends EntityDamageSource
{
    ...
    public ITextComponent getDeathMessage(LivingEntity LivingEntityIn)
    {
        ...
        String s1 = s + ".item";
        return !itemstack.isEmpty() && itemstack.hasDisplayName() ? new TranslationTextComponent(s1, LivingEntityIn.getDisplayName(), itextcomponent, itemstack.getTextComponent()) : new TranslationTextComponent(s, LivingEntityIn.getDisplayName(), itextcomponent);
    }
}
