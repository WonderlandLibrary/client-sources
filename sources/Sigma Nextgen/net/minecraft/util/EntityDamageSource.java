...
public class EntityDamageSource extends DamageSource
{
    ...
    public ITextComponent getDeathMessage(LivingEntity LivingEntityIn)
    {
        ...
        return !itemstack.isEmpty() && itemstack.hasDisplayName() ? new TranslationTextComponent(s + ".item", LivingEntityIn.getDisplayName(), this.damageSourceEntity.getDisplayName(), itemstack.getTextComponent()) : new TranslationTextComponent(s, LivingEntityIn.getDisplayName(), this.damageSourceEntity.getDisplayName());
    }
