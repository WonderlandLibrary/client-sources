...
public class ShaderGroup implements AutoCloseable
{
    ...
    public ShaderGroup(TextureManager p_i1050_1_, IResourceManager resourceManagerIn, Framebuffer mainFramebufferIn, String p_i1050_4_, String groupName) throws IOException, JsonSyntaxException
    {
        this.resourceManager = resourceManagerIn;
        this.mainFramebuffer = mainFramebufferIn;
        this.time = 0.0F;
        ...
        this.mainFramebufferWidth = mainFramebufferIn.framebufferWidth;
        this.mainFramebufferHeight = mainFramebufferIn.framebufferHeight;
        this.shaderGroupName = groupName;
        this.resetProjectionMatrix();
        this.parseGroup(p_i1050_1_, p_i1050_4_);
    }
    private void parseGroup(TextureManager p_152765_1_, String p_152765_2_) throws IOException, JsonSyntaxException
    {
        try
        {
            JsonObject jsonobject = JSONUtils.fromJson(p_152765_2_);
        ...
        catch (Exception exception2)
        {
            ...
            jsonexception.setFilenameAndFlush(p_152765_2_ + s);
            throw jsonexception;
        }
        finally
        {
    ...
    public void renderInject(float partialTicks, int area)
    {
        ...
        for (Shader shader : this.listShaders)
        {
            shader.renderInject(this.time / 20.0F, area);
        }
    }
