...
{
    public static final ResourceLocation sigmaLoadingTexture = new ResourceLocation("sigma/splash.png");
    public static final ResourceLocation sigmaLoadingTTexture = new ResourceLocation("sigma/splashload.png");
    public static final ResourceLocation MOJANG_LOGO_TEXTURE = new ResourceLocation("textures/gui/title/mojangstudios.png");
    public static final int field_238627_b_ = ColorHelper.PackedColor.packColor(255, 239, 50, 61);
    public static final int field_238628_c_ = field_238627_b_ & 16777215;
    public final Minecraft mc;
    public final IAsyncReloader asyncReloader;
    public final Consumer<Optional<Throwable>> completedCallback;
    public final boolean reloading;
    public float progress;
    public long fadeOutStart = -1L;
    public long fadeInStart = -1L;
    public int colorBackground = field_238628_c_;
    public int colorBar = field_238628_c_;
    public int colorOutline = 16777215;
    public int colorProgress = 16777215;
    public GlBlendState blendState = null;
...
//        SigmaNG.staticInit();
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (f < 1.0F)
        {
            this.mc.getTextureManager().bindTexture(sigmaLoadingTexture);
            RenderSystem.enableBlend();
            RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1);
            RenderUtils.drawTexture(0, 0, i, j, i, j,i, j);
            RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1);
            this.func_238629_a_(matrixStack, i / 2f - k1 + 9f, l1- 23, i / 2f + k1 - 0.5f, l1- 23 + 1, 1F);
//            this.func_238629_a_(matrixStack, i / 2 - k1, l1 - 5, i / 2 + k1, l1 + 5, 1.0F - MathHelper.clamp(f, 0.0F, 1.0F));
    ...
    private void func_238629_a_(MatrixStack p_238629_1_, float p_238629_2_, float p_238629_3_, float p_238629_4_, float p_238629_5_, float p_238629_6_)
    {
        ...
        RenderUtils.drawRoundedRect(
                p_238629_2_ - 3.5F, p_238629_3_ - 3.5F, p_238629_2_ + i, p_238629_5_ + 3.5F,
                4F
                , k
        );
