...
//        this.addButton(new Button(this.width / 2 + 2, j + 72 + 12 + 20, 98, 20, new StringTextComponent("Alt Manager"), (p_lambda$init$2_1_) ->
//        {
//            this.minecraft.displayGuiScreen(new AltManager(this));
//        }));
