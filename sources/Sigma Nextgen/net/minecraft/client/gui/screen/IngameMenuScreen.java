...
public class IngameMenuScreen extends Screen
{
    ...
    private void addButtons()
    {
        ...
        if(!SelfDestructManager.destruct)
            this.addButton(new Button(this.width / 2 - 102, this.height - 50, 204, 20, new TranslationTextComponent("Jello for Sigma Options"), (button2) -> {
            this.minecraft.displayGuiScreen(new GuiConfigScreen());
        }));
    }
