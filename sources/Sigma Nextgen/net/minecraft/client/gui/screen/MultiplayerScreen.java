...
public class MultiplayerScreen extends Screen
{
    ...
    protected void init()
    {
        ...
        if(!SelfDestructManager.destruct) {
            ViaMCP.INSTANCE.initAsyncSlider(width / 2 + 105 - 60 + 2, 8, 110, 20);
//        AsyncVersionSlider.getInstance = new AsyncVersionSlider(width / 2 + 105 - 60, 10 ,110,20);
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if(!SelfDestructManager.destruct)
            drawCenteredString(matrixStack, this.font, this.title, this.width / 2 - 120, 20 - 5, 16777215);
        else
        ...
        if(!SelfDestructManager.destruct)
            Minecraft.getInstance().fontRenderer.drawString(matrixStack,"\u00a77Jello Portal:",sr.getScaledWidth() / 2 + 40 - 60 - 5 + 2 , 15 ,-1);
