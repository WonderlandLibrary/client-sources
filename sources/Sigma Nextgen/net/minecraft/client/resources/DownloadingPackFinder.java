    ...
    public CompletableFuture<?> downloadResourcePack(String url, String hash)
    {
        ...
        try
        {
            ...
            this.currentDownload = completablefuture.thenCompose((p_217812_3_) ->
                    !this.checkHash(s1, file1) ? Util.completedExceptionallyFuture(new RuntimeException("Hash check failure for file " + file1 + ", see log")) : this.setServerPack(file1, IPackNameDecorator.SERVER)).whenComplete((p_217815_1_, p_217815_2_) ->
            {
                if (p_217815_2_ != null)
                {
