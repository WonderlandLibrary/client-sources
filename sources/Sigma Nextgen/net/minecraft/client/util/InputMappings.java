...
public class InputMappings
{
    ...
    public static String getInputByCode(int keyCode)
    {
        return InputMappings.Type.KEYSYM.getOrMakeInput(keyCode).func_237520_d_().getString();
    }
    ...
    {
        if(p_216506_2_ == 0) return false;
        return GLFW.glfwGetKey(p_216506_0_, p_216506_2_) == 1;
    }

    public static boolean isKeyDown(KeyBinding p_216506_2_)
    {
        return isKeyDown(p_216506_2_.keyCode.getKeyCode());
    }
    public static boolean isKeyDown(int p_216506_2_)
    {
        if(p_216506_2_ == 0) return false;
        return GLFW.glfwGetKey(Minecraft.getInstance().getMainWindow().getHandle(), p_216506_2_) == 1;
    }
