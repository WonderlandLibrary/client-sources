...
public class ClientPlayNetHandler implements IClientPlayNetHandler
{
    ...
    public CommandDispatcher<ISuggestionProvider> commandDispatcher = new CommandDispatcher<>();
...
//        System.out.println("Handle player " + this.client.player);
    ...
    public void handleEntityMovement(SEntityPacket packetIn)
    {
        ...
        if (entity != null)
        {
            if (!entity.canPassengerSteer())
            {
                ...
                {
                    Vector3d vector3d = packetIn.func_244300_a(entity.getServerPos());
    ...
    public void handleBlockChange(SChangeBlockPacket packetIn)
    {
        ...
        try {
            ...
            this.onDisconnect(new StringTextComponent("Viaversion Exception: " + e));
        }
    }
