...
public class MinecraftGame implements RunningGame
{
    ...
    public GameSession getCurrentSession()
    {
        ...
        return clientworld == null ? null : new ClientGameSession(clientworld, this.gameInstance.player, this.gameInstance.player == null ? null : this.gameInstance.player.connection);
    }
