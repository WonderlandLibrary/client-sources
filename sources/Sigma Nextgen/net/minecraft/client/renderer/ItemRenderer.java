...
public class ItemRenderer implements IResourceManagerReloadListener
{
    ...
    public IBakedModel getItemModelWithOverrides(ItemStack stack, @Nullable World worldIn, @Nullable LivingEntity LivingEntityIn)
    {
        ...
        ItemOverrideList.lastModelLocation = null;
        IBakedModel ibakedmodel1 = ibakedmodel.getOverrides().getOverrideModel(ibakedmodel, stack, clientworld, LivingEntityIn);
    ...
    public void
    renderItemOverlays(FontRenderer fr, ItemStack stack, int xPosition, int yPosition)
    {
