...
import info.sigmaclient.sigma.modules.render.NoHurtCam;
...
import static info.sigmaclient.sigma.modules.gui.Shader.onRender;
...
public class GameRenderer implements IResourceManagerReloadListener, AutoCloseable
{
    ...
    {
        if(SigmaNG.getSigmaNG().moduleManager.getModule(NoHurtCam.class).enabled){
            return;
        }
