...
public class MagmaCubeRenderer extends MobRenderer<MagmaCubeEntity, MagmaCubeModel<MagmaCubeEntity>>
{
    ...
    protected void preRenderCallback(MagmaCubeEntity LivingEntityIn, MatrixStack matrixStackIn, float partialTickTime)
    {
        int i = LivingEntityIn.getSlimeSize();
        float f = MathHelper.lerp(partialTickTime, LivingEntityIn.prevSquishFactor, LivingEntityIn.squishFactor) / ((float)i * 0.5F + 1.0F);
