...
public class PolarBearRenderer extends MobRenderer<PolarBearEntity, PolarBearModel<PolarBearEntity>>
{
    ...
    protected void preRenderCallback(PolarBearEntity LivingEntityIn, MatrixStack matrixStackIn, float partialTickTime)
    {
        matrixStackIn.scale(1.2F, 1.2F, 1.2F);
        super.preRenderCallback(LivingEntityIn, matrixStackIn, partialTickTime);
    }
}
