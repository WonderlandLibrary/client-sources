...
public class GuardianRenderer extends MobRenderer<GuardianEntity, GuardianModel>
{
    ...
    {
        double d0 = MathHelper.lerp((double)p_177110_4_, LivingEntityIn.lastTickPosX, LivingEntityIn.getPosX());
        double d1 = MathHelper.lerp((double)p_177110_4_, LivingEntityIn.lastTickPosY, LivingEntityIn.getPosY()) + p_177110_2_;
        double d2 = MathHelper.lerp((double)p_177110_4_, LivingEntityIn.lastTickPosZ, LivingEntityIn.getPosZ());
