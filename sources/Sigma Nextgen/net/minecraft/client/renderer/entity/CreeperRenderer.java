...
public class CreeperRenderer extends MobRenderer<CreeperEntity, CreeperModel<CreeperEntity>>
{
    ...
    protected void preRenderCallback(CreeperEntity LivingEntityIn, MatrixStack matrixStackIn, float partialTickTime)
    {
        float f = LivingEntityIn.getCreeperFlashIntensity(partialTickTime);
