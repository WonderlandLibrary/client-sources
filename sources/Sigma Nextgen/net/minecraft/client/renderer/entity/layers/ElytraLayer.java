...
public class ElytraLayer<T extends LivingEntity, M extends EntityModel<T>> extends LayerRenderer<T, M>
{
    ...
    public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T LivingEntityIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch)
    {
        ...
        if (this.shouldRender(itemstack, LivingEntityIn))
        {
            ...
            if (LivingEntityIn instanceof AbstractClientPlayerEntity)
            {
                ...
                {
                    resourcelocation = this.getElytraTexture(itemstack, LivingEntityIn);
            ...
            this.modelElytra.setRotationAngles(LivingEntityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
