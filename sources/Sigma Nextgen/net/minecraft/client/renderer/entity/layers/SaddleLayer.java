...
public class SaddleLayer<T extends Entity & IEquipable, M extends EntityModel<T>> extends LayerRenderer<T, M>
{
    ...
    {
        if (LivingEntityIn.isHorseSaddled())
        {
            this.getEntityModel().copyModelAttributesTo(this.field_239409_b_);
            this.field_239409_b_.setLivingAnimations(LivingEntityIn, limbSwing, limbSwingAmount, partialTicks);
            this.field_239409_b_.setRotationAngles(LivingEntityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
