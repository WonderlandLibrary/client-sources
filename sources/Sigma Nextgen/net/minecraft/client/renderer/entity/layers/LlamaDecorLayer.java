...
public class LlamaDecorLayer extends LayerRenderer<LlamaEntity, LlamaModel<LlamaEntity>>
{
    ...
    public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, LlamaEntity LivingEntityIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch)
    {
        ...
        {
            if (!LivingEntityIn.isTraderLlama())
            {
                return;
            }
        ...
        this.model.setRotationAngles(LivingEntityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch);
