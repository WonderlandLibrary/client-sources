...
public class DrownedOuterLayer<T extends DrownedEntity> extends LayerRenderer<T, DrownedModel<T>>
{
    ...
    {
        renderCopyCutoutModel(this.getEntityModel(), this.modelOuterLayer, LOCATION_OUTER_LAYER, matrixStackIn, bufferIn, packedLightIn, LivingEntityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, partialTicks, 1.0F, 1.0F, 1.0F);
    }
}
