...
public class IllusionerRenderer extends IllagerRenderer<IllusionerEntity>
{
    ...
    public IllusionerRenderer(EntityRendererManager renderManagerIn)
    {
        ...
        {
            public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, IllusionerEntity LivingEntityIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch)
            {
                if (LivingEntityIn.isSpellcasting() || LivingEntityIn.isAggressive())
                {
