...
import info.sigmaclient.sigma.modules.gui.ShulkerInfo;
...
public class ShulkerBoxBlock extends ContainerBlock
{
    ...
    public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
    {
        ...
        if(SigmaNG.getSigmaNG() != null && SigmaNG.getSigmaNG().moduleManager.getModule(ShulkerInfo.class).enabled){
            ShulkerInfo.addInformation(stack, worldIn, tooltip, flagIn);
            return;
        }
