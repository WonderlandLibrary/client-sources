...
import dev.star.utils.addons.viamcp.viamcp.MCPVLBPipeline;
...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    public void sendPacketNoEvent1(Packet packetIn)
    {
    ...
    public void sendPacket1(Packet packetIn)
    {
        if (this.isChannelOpen())
        {
            PacketSendEvent event = new PacketSendEvent(packetIn);

            if(!PacketUtils.shouldIgnorePacket(packetIn)) {
