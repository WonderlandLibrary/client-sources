...
public class GuiEnchantment extends GuiContainer {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        for (int k = 0; k < 3; ++k) {
            ...
            if (l >= 0 && i1 >= 0 && l < 108 && i1 < 19 && this.container.enchantItem(this.mc2.thePlayer, k)) {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.mc2.getTextureManager().bindTexture(ENCHANTMENT_TABLE_GUI_TEXTURE);
        int i = (this.width - this.xSize) / 2;
        int j = (this.height - this.ySize) / 2;
        ...
        ScaledResolution scaledresolution = new ScaledResolution(this.mc2);
        ...
        this.mc2.getTextureManager().bindTexture(ENCHANTMENT_TABLE_BOOK_TEXTURE);
        ...
        for (int l = 0; l < 3; ++l) {
            ...
            if (l1 == 0) {
                ...
                if ((k < l + 1 || this.mc2.thePlayer.experienceLevel < l1) && !this.mc2.thePlayer.capabilities.isCreativeMode) {
                    this.drawTexturedModalRect(i1, j + 14 + 19 * l, 0, 185, 108, 19);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        boolean flag = this.mc2.thePlayer.capabilities.isCreativeMode;
