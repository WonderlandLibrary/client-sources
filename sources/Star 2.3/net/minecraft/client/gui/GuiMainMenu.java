...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        this.buttonList.add(new GuiButton(3, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("Alt Manager", new Object[0])));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.id == 3)
        {
            this.mc.displayGuiScreen(new GuiAltManagerScreen());
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawString(this.fontRendererObj, s1, (int) (this.width - this.fontRendererObj.getStringWidth(s1) - 2), this.height - 10, -1);
