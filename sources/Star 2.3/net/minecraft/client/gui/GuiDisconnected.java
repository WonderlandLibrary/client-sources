...
import dev.star.utils.server.ban.BanUtils;
...
public class GuiDisconnected extends GuiScreen {
    ...
    public GuiDisconnected(GuiScreen screen, String reasonLocalizationKey, IChatComponent chatComp) {
        ...
        Alt activeAlt = Client.INSTANCE.currentSessionAlt;
        if (activeAlt != null) {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 0) {
            ...
            if (ServerUtils.lastServer != null) {
                mc2.displayGuiScreen(new GuiConnecting(new GuiMultiplayer(new GuiMainMenu()), mc2, ServerUtils.lastServer));
            }
        }
    }
