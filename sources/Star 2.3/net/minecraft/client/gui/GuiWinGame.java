...
public class GuiWinGame extends GuiScreen {
    ...
    public void updateScreen() {
        MusicTicker musicticker = this.mc2.getMusicTicker();
        SoundHandler soundhandler = this.mc2.getSoundHandler();
        ...
        if (this.field_146582_i == null) {
            ...
            try {
                ...
                while ((s = bufferedreader.readLine()) != null) {
                    ...
                    for (s = s.replaceAll("PLAYERNAME", this.mc2.getSession().getUsername()); s.contains(s1); s = s2 + EnumChatFormatting.WHITE + EnumChatFormatting.OBFUSCATED + "XXXXXXXX".substring(0, random.nextInt(4) + 3) + s3) {
                        int j = s.indexOf(s1);
                        s2 = s.substring(0, j);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.mc2.getTextureManager().bindTexture(MINECRAFT_LOGO);
        ...
        this.mc2.getTextureManager().bindTexture(VIGNETTE_TEXTURE);
