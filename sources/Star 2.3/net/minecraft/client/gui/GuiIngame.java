...
import dev.star.module.impl.display.PostProcessing;
import dev.star.module.impl.display.ScoreboardMod;
...
//            RoundedUtil.drawRound(l1 - 2, k, l, k + this.getScoreboardFontRenderer().getHeight(),8.0f, new Color(color.getRGB()));
...
//                RoundedUtil.drawRound(l1 - 2, k - this.getScoreboardFontRenderer().getHeight() - 1, l, k - 1,8.0f, new Color(color.getRGB()));
                GLUtil.startBlend();
                drawRect(l1 - 2, k - 1, l, k, color.getRGB());
//                RoundedUtil.drawRound(l1 - 2, k - 1, l, k,8.0f,new Color( color.getRGB()));
