...
public class GuiScreenBook extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.mc2.getTextureManager().bindTexture(bookGuiTextures);
        int i = (this.width - this.bookImageWidth) / 2;
        int j = 2;
        ...
        if (this.field_175386_A == null) {
            ...
            if (i >= 0 && j >= 0) {
                ...
                if (i <= 116 && j < this.mc2.fontRendererObj.FONT_HEIGHT * k + k) {
                    int l = j / this.mc2.fontRendererObj.FONT_HEIGHT;
                    ...
                    if (l >= 0 && l < this.field_175386_A.size()) {
                        ...
                        for (IChatComponent ichatcomponent1 : ichatcomponent) {
                            if (ichatcomponent1 instanceof ChatComponentText) {
                                i1 += this.mc2.fontRendererObj.getStringWidth(((ChatComponentText) ichatcomponent1).getChatComponentText_TextValue());
