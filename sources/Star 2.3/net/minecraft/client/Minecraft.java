...
import dev.star.event.impl.game.*;
import dev.star.event.impl.player.BlockEvent;
import dev.star.event.impl.player.BlockPlaceableEvent;
import dev.star.event.impl.player.ClickEvent;
import dev.star.event.impl.player.ClickEventRight;
import dev.star.module.impl.render.Camera;
import dev.star.module.impl.render.ClickGUIMod;
import dev.star.module.ProtectedLaunch;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException {
        ...
        logger.info("Start-up time: " + (System.currentTimeMillis() - Main.bootTime) + "ms");
    }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Star Client B2");
