...
import dev.star.module.impl.render.Chams;
import dev.star.module.impl.render.ESP2D;
import dev.star.module.impl.display.TargetHUDMod;
import dev.star.event.impl.render.NametagRenderEvent;
import dev.star.event.impl.render.RenderModelEvent;
import dev.star.event.impl.render.RendererLivingEntityEvent;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        boolean chamsEnabled = entity instanceof EntityPlayer && Client.INSTANCE.getModuleCollection().getModule(Chams.class).isEnabled();
