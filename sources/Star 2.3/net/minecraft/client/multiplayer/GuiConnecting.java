            ...
            public void run() {
                ...
                try {
                    ...
                    if (mc2.getSession() != null && mc2.getSession().getProfile() != null && mc2.getSession().getProfile().getId() != null) {
                        ...
                        GuiConnecting.this.mc2.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", "Star: Null session (Not logged in?)")));
                    }
