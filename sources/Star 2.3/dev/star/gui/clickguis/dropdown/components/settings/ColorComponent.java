...
public class ColorComponent extends SettingComponent<ColorSetting> {
    ...
    private final TextField hexField = new TextField(FontUtil.Font16);
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        Font16.drawString(colorSetting.name, x + 5, y + Font16.getMiddleOfBox(realHeight), textColor);
        ...
        Font14.drawCenteredStringWithShadow(text, colorX + colorWidth / 2f,
                colorY + Font14.getMiddleOfBox(colorHeight),
        ...
        if (opened || !openAnimation.isDone()) {
            ...
            GLUtil.startBlend();
            RenderUtil.drawImage(new ResourceLocation("Star/Images/colorpicker2.png"), pickerX, pickerY, 4, 4);
            GLUtil.endBlend();

            float hueY = gradientY + gradientHeight + 5;
            float hueHeight = 4;
            RenderUtil.resetColor();
            mc.getTextureManager().bindTexture(new ResourceLocation("Star/Images/hue.png"));
            ...
            if (!rainbowAnimation.finished(Direction.FORWARDS)) {
                ...
                Font16.drawString("Hex", gradientX, newYVal + Font16.getMiddleOfBox(heightLeft), whiteColor);
                ...
                if (!hexField.isFocused()) {
                    ...
                    try {
                        ...
                        Font14.drawString("Invalid Hex Code", hexField.getXPosition() - .5f, newYVal - (Font14.getHeight() - .5f),
