package dev.star.utils.spotify;
...
public class SpotifyAPI implements Utils {
    ...
    public final static File CLIENT_ID_DIR = new File(Client.DIRECTORY, "SpotifyID.json");
                    ...
                    try {
                        ...
                        callbackServer.createContext("/", context -> {
                            ...
                            final String messageSuccess = context.getRequestURI().getQuery().contains("code")
                                    ? "Successfully authorized.\nYou can now close this window, have fun on Star!"
