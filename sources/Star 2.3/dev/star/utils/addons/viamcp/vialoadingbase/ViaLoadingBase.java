 ...
 */
package dev.star.utils.addons.viamcp.vialoadingbase;
...
import dev.star.utils.addons.viamcp.vialoadingbase.model.ComparableProtocolVersion;
import dev.star.utils.addons.viamcp.vialoadingbase.model.Platform;
import dev.star.utils.addons.viamcp.vialoadingbase.platform.ViaBackwardsPlatformImpl;
import dev.star.utils.addons.viamcp.vialoadingbase.platform.ViaRewindPlatformImpl;
import dev.star.utils.addons.viamcp.vialoadingbase.platform.ViaVersionPlatformImpl;
import dev.star.utils.addons.viamcp.vialoadingbase.platform.viaversion.VLBViaCommandHandler;
import dev.star.utils.addons.viamcp.vialoadingbase.platform.viaversion.VLBViaInjector;
import dev.star.utils.addons.viamcp.vialoadingbase.platform.viaversion.VLBViaProviders;
import dev.star.utils.addons.viamcp.vialoadingbase.util.JLoggerToLog4j;
...
public class ViaLoadingBase {
    ...
    public void reload(final ProtocolVersion protocolVersion) {
        final ComparableProtocolVersion comparableProtocolVersion = fromProtocolVersion(protocolVersion);
        reload(comparableProtocolVersion);
    }
