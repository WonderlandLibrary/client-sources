...
public class OldStarTargetHUD extends TargetHUD {

    private final ContinualAnimation animation = new ContinualAnimation();

    public OldStarTargetHUD() {
        super("Opal");
    }

    @Override
    public void render(float x, float y, float alpha, EntityLivingBase target) {
        setWidth(Math.max(145, FontUtil.BoldFont26.getStringWidth(target.getName()) + 40));
        setHeight(37);
        ...
        if (target instanceof AbstractClientPlayer) {
            ...
            FontUtil.BoldFont32.drawCenteredStringWithShadow("?", x + 20, y + 17 - FontUtil.BoldFont32.getHeight() / 2f, textColor);
        }

        FontUtil.BoldFont26.drawStringWithShadow(target.getName(), x + 39, y + 5, textColor);
        ...
        FontUtil.Font16.drawStringWithShadow(healthText, x + 34 + Math.min(Math.max(1, healthWidth), realHealthWidth - 11), y + getHeight() - (14 + FontUtil.Font16.getHeight()), textColor);
    }
