...
public class l
{
    ...
    public l(final InputStream a) throws IOException {
        this(a, 9729);
    }
    
    public l(final InputStream a, final int a) throws IOException {
        this(a, a, 33071);
    }
    
    public l(final InputStream a, final int a, final int a) throws IOException {
        this.a = 3553;
        ...
        try {
            ...
            a3.a(a5, this.c * 4, com.sun.jna.z.a.f.a.RGBA);
            a5.flip();
    ...
    public static void a(final l a, final float a, final float a, final float a, final float a) {
        a.a();
        final float a2 = 0.0f;
        final float a3 = 0.0f;
        final float a4 = 1.0f;
