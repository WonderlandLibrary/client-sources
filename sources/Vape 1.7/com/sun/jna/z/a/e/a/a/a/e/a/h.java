...
public class h extends b<t>
{
    ...
    protected void a(final t a) {
        ...
        final int a5 = (int)n;
        a.a(com.sun.jna.z.a.e.a.a.a.h.e);
        GL11.glBegin(7);
        ...
        String a7 = null;
        String[] a8 = h.g;
        final DecimalFormat a9 = new DecimalFormat(a8[1]);
        final DecimalFormat a10 = new DecimalFormat(a8[0]);
        switch (l.a[a.f().ordinal()]) {
            ...
            case 3: {
                a8 = h.g;
                a7 = String.format(a8[2], Math.round(a.a()));
                break;
            }
            case 4: {
    ...
    protected void d(final t a) {
        ...
        final Point a3 = a.b();
        final com.sun.jna.z.a.e.a.a.a.a.l a4 = a.k();
        if (a4 != null) {
