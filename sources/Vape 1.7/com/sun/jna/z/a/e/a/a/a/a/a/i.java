...
public class i extends d implements t
{
    ...
    public i(final String a, final double a, final double a, final double a, final int a) {
        this(a, a, a, a, a, com.sun.jna.z.a.e.a.a.a.a.b.DECIMAL);
    }
    
    public i(final String a, double a, final double a, final double a, final double a, final b a) {
        final int q = com.sun.jna.z.a.e.a.a.a.a.a.c.q ? 1 : 0;
        final int a2 = q;
        this.s = false;
        String l = a;
        if (a2 == 0) {
        ...
        if (a2 == 0) {
            if (a != null) {
                ...
                decimal = com.sun.jna.z.a.e.a.a.a.a.b.DECIMAL;
            }
        }
        this.r = decimal;
        if (a2 != 0) {
    ...
    public void b(final String a) {
        final int a2 = com.sun.jna.z.a.e.a.a.a.a.a.c.q ? 1 : 0;
        String l = a;
        if (a2 == 0) {
            if (a != null) {
                l = a;
    ...
    public void a(final double a) {
        ...
        // 
        //     3: aload_0         /* a */
        //     4: getfield        com/sun/jna/z/a/e/a/a/a/a/a/i.n:D
        //     7: dstore          4
        //     9: istore_3        /* a */
        //    10: aload_0         /* a */
        //    11: getfield        com/sun/jna/z/a/e/a/a/a/a/a/i.o:D
        //    14: aload_0         /* a */
        //    15: getfield        com/sun/jna/z/a/e/a/a/a/a/a/i.p:D
        //    18: dload_1         /* a */
        ...
        //    32: dload_1         /* a */
        //    33: aload_0         /* a */
        //    34: getfield        com/sun/jna/z/a/e/a/a/a/a/a/i.q:D
        //    37: drem           
        //    38: aload_0         /* a */
        //    39: getfield        com/sun/jna/z/a/e/a/a/a/a/a/i.q:D
        //    42: ddiv           
        //    43: invokestatic    java/lang/Math.round:(D)J
        //    46: l2d            
        //    47: aload_0         /* a */
        //    48: getfield        com/sun/jna/z/a/e/a/a/a/a/a/i.q:D
        //    51: dmul           
        //    52: dsub           
        //    53: putfield        com/sun/jna/z/a/e/a/a/a/a/a/i.n:D
        //    56: dload           a
        //    58: aload_0         /* a */
        //    59: getfield        com/sun/jna/z/a/e/a/a/a/a/a/i.n:D
        //    62: dcmpl          
        //    63: ifeq            70
        //    66: aload_0         /* a */
        //    67: invokespecial   com/sun/jna/z/a/e/a/a/a/a/a/i.a:()V
        //    70: return         
        // 
    ...
    private void a() {
        final int q = com.sun.jna.z.a.e.a.a.a.a.a.c.q ? 1 : 0;
        final com.sun.jna.z.a.e.a.a.a.d.c[] a = this.b();
        final int a2 = q;
        final int a3 = a.length;
        int a4 = 0;
        while (a4 < a3) {
            final com.sun.jna.z.a.e.a.a.a.d.c a5 = a[a4];
            if (a2 == 0) {
                if (a5 instanceof e) {
                    ((e)a5).a(this);
                }
