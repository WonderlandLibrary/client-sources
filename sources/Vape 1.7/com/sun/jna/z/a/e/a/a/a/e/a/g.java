...
public class g extends b<q>
{
    ...
    protected void a(final q a) {
        ...
        final com.sun.jna.z.a.e.a.a.a.b.a a4 = this.e.a();
        this.a(a, false);
        GL11.glEnable(3042);
        GL11.glDisable(2884);
        GL11.glDisable(3553);
        ...
        GL11.glEnable(3553);
        String a6 = null;
        switch (com.sun.jna.z.a.e.a.a.a.e.a.k.a[a.f().ordinal()]) {
            case 1: {
                final String[] a7 = g.f;
                a6 = String.format(a7[2], a.a());
                break;
            }
            case 2: {
                final String[] a7 = g.f;
                a6 = String.format(a7[1], Math.round(a.a()));
                break;
            }
            case 3: {
                final int a8 = (int)Math.round((a.a() - a.c()) / (a.d() - a.c()) * 100.0);
                a6 = String.format(g.f[0], a8);
                break;
            }
        }
        if (a6 != null) {
    ...
    static {
        ...
        int n = 0;
        final String s;
        final int length = (s = "\u00f4\u00e2\u00f5¬\u0003\u00f4ª´\u0005\u00f4ª\u00feº\u0089").length();
        int char1 = 4;
        int n2 = -1;
        Label_0021: {
            break Label_0021;
