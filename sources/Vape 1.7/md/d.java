...
public class d extends c
{
    ...
    public d() {
        final String[] a = d.R;
        super(a[0], com.sun.jna.z.a.d.b.Utility, 0);
        this.n = new com.sun.jna.z.a.e.a.a.a.a.a.i(a[2], 100.0, 0.0, 200.0, 1);
        final int q = d.Q ? 1 : 0;
        this.o = new com.sun.jna.z.a.e.a.a.a.a.a.d(a[3], true);
        this.p = new com.sun.jna.z.a.e.a.a.a.a.a.d(a[4]);
        this.q = new m();
    ...
    public void h() {
        ...
        //    54: athrow         
        //    55: aload_0         /* a */
        //    56: getfield        md/d.n:Lcom/sun/jna/z/a/e/a/a/a/a/t;
        ...
        //   199: athrow         
        //   200: aload_0         /* a */
        //   201: getfield        md/d.q:Lcom/sun/jna/z/a/f/m;
        //   204: iload_1         /* a */
        //   205: ifne            286
        //   208: aload_0         /* a */
        //   209: getfield        md/d.n:Lcom/sun/jna/z/a/e/a/a/a/a/t;
        //   212: invokeinterface com/sun/jna/z/a/e/a/a/a/a/t.a:()D
        //   217: d2l            
        //   218: invokevirtual   com/sun/jna/z/a/f/m.a:(J)Z
        //   221: ifeq            4
        //   224: goto            228
        //   227: athrow         
        //   228: aload_0         /* a */
        ...
        //   281: pop            
        //   282: aload_0         /* a */
        //   283: getfield        md/d.q:Lcom/sun/jna/z/a/f/m;
        //   286: invokevirtual   com/sun/jna/z/a/f/m.c:()V
        //   289: iload_1         /* a */
        //   290: ifeq            4
        //   293: aload_0         /* a */
        //   294: iload_1         /* a */
        ...
        //   453: athrow         
        //   454: aload_0         /* a */
        //   455: getfield        md/d.o:Lcom/sun/jna/z/a/e/a/a/a/a/i;
        //   458: invokeinterface com/sun/jna/z/a/e/a/a/a/a/i.a:()Z
        //   463: ifeq            570
        //   466: goto            470
        //   469: athrow         
        //   470: aload           a
        ...
        //   487: getstatic       md/d.R:[Ljava/lang/String;
        //   490: astore          a
        //   492: aload           a
        //   494: iconst_5       
        //   495: aaload         
        ...
        //   524: getstatic       md/d.R:[Ljava/lang/String;
        //   527: iconst_1       
        //   528: aaload         
        ...
        //   596: ifne            649
        //   599: aload_0         /* a */
        //   600: getfield        md/d.p:Lcom/sun/jna/z/a/e/a/a/a/a/i;
    ...
    int n() {
        ...
        //     5: istore_1        /* a */
        //     6: aload_0         /* a */
        //     7: invokevirtual   md/d.c:()Lnet/minecraft/client/entity/EntityPlayerSP;
        //    10: getfield        net/minecraft/client/entity/EntityPlayerSP.field_71071_by:Lnet/minecraft/entity/player/InventoryPlayer;
        //    13: astore_3        /* a */
        //    14: iconst_0       
        //    15: istore          a
        //    17: iload           a
                        ...
                        if (item != null) {
                            ...
                            if (a == 0) {
                                if (item3 instanceof ItemPotion && this.o.a()) {
                                    ...
                                    final String[] a7 = md.d.R;
                                    boolean contains;
                                    final boolean b = contains = string.contains(a7[5]);
                                    Label_0199: {
                                        if (a == 0) {
                                            if (!b) {
                                                break Label_0199;
                                            ...
                                            contains = (contains2 = a6.func_77832_l(a4).toString().contains(a7[1]));
                                        }
                                        if (a == 0) {
                                            if (!b) {
                                                break Label_0199;
    ...
    static {
        final String[] r = new String[6];
        int n = 0;
        String s;
        int n2 = (s = "J\u0007¶\u0017D\u00eb\u0004p\u0007±\u0012\u0005\\\u0007¼\u001fQ\u0004H\r¤\r").length();
        int n3 = 6;
        int n4 = -1;
    Label_0023:
        while (true) {
