...
public class CrackManager {
	...
	public void initLists() {
		String path = "/me/xatzdevelopments/xatz/assets/cracker/passlist.txt";
		...
		path = "/me/xatzdevelopments/xatz/assets/cracker/proxies3.txt";
	...
	public void onGui() {
		if (mc.currentScreen == null) {
			Xatz.getUIRenderer().addToQueue("§6Crack §rattempts: " + tries, ScreenPos.LEFTUP);
			Xatz.getUIRenderer().addToQueue("§6Crack §rbad proxies: " + badProxies, ScreenPos.LEFTUP);
			Xatz.getUIRenderer().addToQueue("§6Crack §rfinished: " + stop, ScreenPos.LEFTUP);
			Xatz.getUIRenderer().addToQueue("§6Crack §rsuccess: " + hacked, ScreenPos.LEFTUP);
		}
	}
}
