...
public class GuiXatzCredits extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(fontRendererObj, "GreatZardasht (Owner/The creator/Lead-Dev)", 30, 65, 0xffff0000);
		this.drawString(fontRendererObj, "Masterjunior24/Tsoxas (Ex-Owner)", 30, 75, 0xffff00);
		this.drawString(fontRendererObj, "NaakteM0lrat (Owner/Dev)", 30, 85, 0xffff0000);
		this.drawString(fontRendererObj, "HeyaGlitz (Owner/Artist/Designer/Website Developer)", 30, 95, 0xffff0000);
