...
import net.minecraft.client.gui.GuiXatzMainMenuSettings;
...
public class GuiXatz extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(6, this.width / 2 + 2, this.height / 2, 98, 20, "Main Menu Settings"));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		if(id == 6) {
			mc.displayGuiScreen(new GuiXatzMainMenuSettings(this));
