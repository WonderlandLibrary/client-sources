...
//		}
	...
	public void draw() {
		...
		GL11.glColor4f(0.2f, 0.2f, 0.2f, 1f - Xatz.getClickGuiManager().getAlpha());//untoggled settings box -masterjunior
		if(isToggled()) {
			GL11.glColor4f((float)ClientSettings.hudcolorred, (float)ClientSettings.hudcolorgreen, (float)ClientSettings.hudcolorblue, 0.8f);//toggled settings box -masterjunior
		}
		...
		glEnd();
		GL11.glColor4f(0.3f, 0.3f, 0.3f, 0.8f - Xatz.getClickGuiManager().getAlpha());
		...
		glEnd();
		GL11.glColor4f(0.1f, 0.1f, 0.1f, 0.8f - Xatz.getClickGuiManager().getAlpha());
		glBegin(GL11.GL_LINES);
		{
			glVertex2d(0, 1);
			glVertex2d(10, 1);
		...
		if(Xatz.getClickGuiManager().getAlpha() <= 0.5f) {
