...
public class GuiXatzFAQ extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(fontRendererObj, "More help at Discord", 25 / 2, 25 / 2, 0xffffffff);
		...
		this.drawString(fontRendererObj, "Q: Whats the link to Xatz Discord?", 30, 140, 0xffffffff);
		this.drawString(fontRendererObj, "A: https://discord.gg/45ypdBMHZR", 30, 150, 0xffffffff);
