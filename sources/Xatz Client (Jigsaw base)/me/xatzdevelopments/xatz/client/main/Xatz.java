...
import me.xatzdevelopments.xatz.client.ExtraCommands.ExCommandManager;
import me.xatzdevelopments.xatz.client.Music.MusicManager;
import me.xatzdevelopments.xatz.client.Music.utils.PlayMusic;
import me.xatzdevelopments.xatz.client.Unused.bypasses.BypassManager;
...
import me.xatzdevelopments.xatz.client.Unused.superherofx.FXManager;
import me.xatzdevelopments.xatz.client.bungeehack.GuiBungeeCord;
...
import me.xatzdevelopments.xatz.client.friends.FriendsMananger;
...
import me.xatzdevelopments.xatz.client.modules.Alec;
...
import me.xatzdevelopments.xatz.client.modules.futureprotNOTIMPLEMENTEDMRPRINCESKID.HWID;
...
public class Xatz {
	...
	private static String clientmultiVersion = "1.8x1.21";
	public static String clientVersion = "v1.21";
    ...
    public static PlayMusic soundHandler;
    public static MusicManager musicManager;
    public static ExCommandManager ExcommandManager;
    
	public static ResourceLocation xatzTextureMainMenu = new ResourceLocation("xatz/xatzmainmenu.png");
	...
	public static final ResourceLocation newWallpaper = new ResourceLocation("xatz/testwallpaper.jpg");
	...
	public static void Register() {
		if(!oldGui) {
			xatzTextureMainMenu = new ResourceLocation("xatz/logo.png");
		}
		...
		images = new ResourceLocation[] { xatzImage5, xatzImage2, xatzImage4 , xatzImage6};
        	...
        	images = new ResourceLocation[] {xatzImage6/*, xatzImage2*/};
        }}catch(Exception e) {
		...
		//Alec.start(); // Disable if you want
...
//		}
    ...
    public static Xatz instance = new Xatz();
    ...
    public static void oninEvent(final inEvent e) {
