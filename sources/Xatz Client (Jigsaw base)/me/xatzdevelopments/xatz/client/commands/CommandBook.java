...
public class CommandBook extends Command {
	  ...
	  public static Xatz instance = null;
	...
	public void run(String[] args) {
		  if (args[0].equalsIgnoreCase(".")) {
			  Xatz.chatMessage(" Usage: .book <command|message>");
		    }
		    if (args[0].equalsIgnoreCase(".book")) {
		      try
		      {
		        ...
		        Xatz.chatMessage(" Check your inventory!");
		      }
		      catch (Exception e)
		      {
		    	  Xatz.chatMessage(" Usage: .book <command|message>");
	...
	public String getDesc() {
		return "Gives you a CommandBook. (you may need to be in creative)";
	}
}
