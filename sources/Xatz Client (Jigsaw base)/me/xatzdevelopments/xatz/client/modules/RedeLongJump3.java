...
public class RedeLongJump3 extends Module {
	...
	public RedeLongJump3() {
		super("RedeskyJump2", Keyboard.KEY_NONE, Category.MOVEMENT, "Makes your jumps longer.");
	}
	@Override
	...
	public void onUpdate(UpdateEvent e){
        ...
        if (this.mc.thePlayer.onGround && MoveUtils2.isMoving()) {
            ...
            this.mc.thePlayer.motionY = 0.679;
        }
	}
}
