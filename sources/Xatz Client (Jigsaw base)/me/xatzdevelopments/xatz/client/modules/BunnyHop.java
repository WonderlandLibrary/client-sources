...
public class BunnyHop extends Module {
	...
	public void onPreMotion(PreMotionEvent event) {
		// Xatz.chatMessage(round(mc.thePlayer.posY - (int) mc.thePlayer.posY,
		// 3));
		...
		if (mc.thePlayer.isInWater() || mc.thePlayer.isInLava() || mc.thePlayer.isInWeb
				|| Xatz.getModuleByName("Flight").isToggled()) {
			jumps = -1;
			this.stage = 2;
			return;
		}
		...
		// JXatz.chatMessage(round(mc.thePlayer.posY - (int) mc.thePlayer.posY,
