...
//		});
		...
		CheckBtnSetting box7 = new CheckBtnSetting("Items", "itemsESP");
		CheckBtnSetting box8 = new CheckBtnSetting("Arrows", "arrowESP");
		return new ModSetting[] { box1, box2, box3, box4, box5, box6, box7, box8 };
	}
	...
	public void drawESP(float red, float green, float blue, float alpha, Entity e) {
		if (e instanceof EntityPlayer && !Xatz.getFriendsMananger().isFriend((EntityPlayer) e)) {
