...
//		box3.addButtonListener(listener5);
	...
	public void onUpdate(UpdateEvent event) {
		...
		if(currentMode.equals("Redesky2")) {
	        mc.thePlayer.motionY = 0;
		...
		if(currentMode.equals("Redesky3")) {
        //if (this.mode.getValue().equals((java.lang.Object)"Motion")) {
            this.mc.thePlayer.fallDistance = 0.0f;
            this.mc.thePlayer.motionY = 0.0;
            //tk.Xatz.Utils.MovementUtil.strafe((java.lang.Double)0.85);
		...
		if(currentMode.equals("Redesky4")) {
            if(mc.thePlayer.ticksExisted %3 == 0) {
                ...
                mc.thePlayer.onGround = true;
                mc.myNetworkManager.sendPacket(new S12PacketEntityVelocity(mc.thePlayer));
	...
	public String[] getModes() {
		return new String[] { "Default", "Creative", "Glide", "AirWalk", "AAC", "AAC2", "AAC3", "Motion", "FastJetpack", "Redesky", "Redesky2", "Redesky3", "Redesky4" };
	}
