...
import me.xatzdevelopments.xatz.pathfinding.Node;
import me.xatzdevelopments.xatz.pathfinding.NodeProcessor;
...
public class ReachAura extends Module {
	...
	public ReachAura() {
		super("ReachAura", Keyboard.KEY_NONE, Category.HIDDEN, "Experimental stuff");
	} // Combat
