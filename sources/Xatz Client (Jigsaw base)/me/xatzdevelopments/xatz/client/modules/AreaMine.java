...
public class AreaMine extends Module {
	...
	public AreaMine() {
		super("AreaMine", 0, Category.WORLD, "Select two blocks and it will mine it for you! - You:Mom can we have Baritone? - Mom:No we have baritone at home - Baritone at home:");
	}
...
//		});
	...
	public void onUpdate(UpdateEvent event) {
		...
		if(blockPoses.isEmpty()) {
			...
			Xatz.getNotificationManager().addNotification(new Notification(Level.INFO, "Loaded " + blockPoses.size() + " blocks!"));
		}
		int valid = 0;
	...
	public void onRightClick() {
		if(pos1 == null) {
			Xatz.getNotificationManager().addNotification(new Notification(Level.INFO, "Set first position!"));
			pos1 = mc.objectMouseOver.getBlockPos();
		}
		else if(pos2 == null) {
			Xatz.getNotificationManager().addNotification(new Notification(Level.INFO, "Set second position!"));
