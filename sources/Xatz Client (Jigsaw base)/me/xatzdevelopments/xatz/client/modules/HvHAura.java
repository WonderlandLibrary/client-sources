...
import me.xatzdevelopments.xatz.client.modules.NoSlowdown;
...
public class HvHAura extends Module {
	...
	public HvHAura() {
		super("HvHAura", Keyboard.KEY_NONE, Category.COMBAT2, "Automatically attacks entities in range.");
	}
	 ...
	 public boolean canAttack() {
	        if (!attackList.isEmpty() && !Xatz.getModuleByName("Freecam").isToggled())
	            return true;
	        return false;
	    }
	    @Override
	    public void onEnable(){
	        ...
	        if(ClientSettings.teamn)
	            Xatz.chatMessage("Teaming enabled, warning its buggy! It might make aura not attack some players");
