...
import me.xatzdevelopments.xatz.client.Unused.AutoBuild.AutoBuildBlock;
import me.xatzdevelopments.xatz.client.Unused.AutoBuild.AutoBuildConf;
import me.xatzdevelopments.xatz.client.Unused.AutoBuild.AutoBuildTools;
...
public class AutoBuild extends Module {
	...
	public AutoBuild() {
		super("AutoBuild", Keyboard.KEY_NONE, Category.HIDDEN, "Builds stuff automatically! :D");
	} // Automation
