...
public class AntiBot extends Module {
   ...
   WaitTimer timer = new WaitTimer();
	...
	public AntiBot() {
		super("AntiBot", Keyboard.KEY_NONE, Category.COMBAT, "Removes bots for Killaura2 and HvHaura.");
	}
			...
			for (final Object entity : mc.theWorld.loadedEntityList) {
				if (((Entity) entity).isInvisible()) {
					...
					if (entity instanceof EntityPlayer) {
						Xatz.chatMessage("Removed "+((EntityPlayer) entity).getName());
					}
	...
	public String[] getModes() {
		...
		return new String[] { "AAC", "Invisible", "Check TabList" , "Hypixel"};
	}
