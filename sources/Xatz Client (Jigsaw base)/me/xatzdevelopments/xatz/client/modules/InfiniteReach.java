...
import me.xatzdevelopments.xatz.client.target.AuraUtils;
...
CheckBtnSetting players = new CheckBtnSetting("Team", "TEAMMM");
	...
	public InfiniteReach() {
		super("InfiniteReach", Keyboard.KEY_NONE, Category.HIDDEN,
				"InfiniteReach");
	} // Combat
	...
	private void attackInf(EntityLivingBase en) {
		...
		if ((Xatz.getModuleByName("Criticals2").isToggled()) || (vanillaCrit)) {
