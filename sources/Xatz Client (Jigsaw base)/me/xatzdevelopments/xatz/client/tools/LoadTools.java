...
import me.xatzdevelopments.xatz.client.modules.target.HurtResistant;
...
import me.xatzdevelopments.xatz.gui.GuiXatzUpdate;
...
//		new me.xatzdevelopments.xatz.client.Unused.epicctabs.TabExploits();
//		new me.xatzdevelopments.xatz.client.Unused.epicctabs.TabArmor();
//		new me.xatzdevelopments.xatz.client.Unused.epicctabs.TabSword();		new me.xatzdevelopments.xatz.client.Unused.epicctabs.TabExploits();
//		new me.xatzdevelopments.xatz.client.Unused.epicctabs.TabArmor();
//		new me.xatzdevelopments.xatz.client.Unused.epicctabs.TabSword(); Failled shit, rip
		// appendModule(new Admins());
		// Some of these may have gotten hidden and i got so bored i didnt put //hidden
		appendModule(new AreaMine());
		appendModule(new ClickGUISettings());
		appendModule(new Animations());
		appendModule(new AutoArmor());
		appendModule(new AutoBlock());
		appendModule(new AutoClicker());
		appendModule(new AutoBuild()); // hmm
		...
		appendModule(new RedeLongJump2());		
		...
		appendModule(new AutoParkour()); // Hidden
		...
		appendModule(new BETAFly());
		appendModule(new ConsoleSpammer());
		appendModule(new ServerCrasher2());
		...
		appendModule(new RFly69());
		//appendModule(new RedeLongJump());
		appendModule(new NBTViewer());
		appendModule(new MunchyMCDisabler());
		appendModule(new NoRotationSet());
		appendModule(new PenisESP());
		//appendModule(new Ambiance());
		//appendModule(new ItemESP());
		appendModule(new Australia());
		appendModule(new Hackerdetect2());
		appendModule(new SuperHeroFX()); // Hidden
		appendModule(new LSD()); // Hidden
	    appendModule(new Test()); // Hidden
		appendModule(new AntiBot());
		appendModule(new Criticals2());
		appendModule(new TpBedBreaker()); 
		appendModule(new ChestStealer());
		appendModule(new ChestStealer2());
		appendModule(new ClickGUI());
		appendModule(new ClickTeleport());
		appendModule(new ClickTeleport2());
		...
		appendModule(new MaxRotations());
		appendModule(new NoRender());
		//appendModule(new BlockHighlight());
		//appendModule(new AutoClutch()); // Fun fact, making or ski-d-d-ing Render modules is hard..
		//appendModule(new BlockOverlay());
		appendModule(new Keystrokes());
		appendModule(new SigmaDeleter());
		appendModule(new Xatzv69420ontop());
	//	appendModule(new RedeLongJump3());
//		appendModule(new AdvancedNameTags());
		appendModule(new AutoDisconnect());
		//appendModule(new Placeholder());
		//appendModule(new Placeholder());
		//appendModule(new Placeholder());
		//appendModule(new Placeholder());
		//appendModule(new Placeholder());
		...
		//appendModule(new DialUpPing()); // useless module, makes you get kicked
		...
		appendModule(new InventoryManager2());
		...
		appendModule(new Killaura69420());
		...
		appendModule(new KillSults()); // we need to fix this shit
		...
		appendModule(new TargetHUD()); // Hideen 
		...
		appendModule(new Shaky()); // Silly module but idc still going to add
		...
		appendModule(new TypeWars()); // Hidden
		...
		appendModule(new WatchdogDetect()); // Hidden
		appendModule(new WaterFart());	
		appendModule(new ItemSize());
		appendModule(new WtfAura()); // Hidden
		appendModule(new Zoom()); // Hidden
		return modules;
	}
