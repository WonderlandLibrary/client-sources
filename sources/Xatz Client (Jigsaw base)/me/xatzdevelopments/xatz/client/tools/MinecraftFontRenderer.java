  ...
  extends CFont
{
  ...
  public MinecraftFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics)
  {
    ...
    this.boldChars = new CFont.CharData['?'];
    this.italicChars = new CFont.CharData['?'];
    this.boldItalicChars = new CFont.CharData['?'];
  ...
  public List<String> wrapWords(String text, double width)
  {
    ...
    if (getStringWidth(text) > width)
    {
      ...
      for (int j = 0; j < length; j++)
      {
        ...
        if (getStringWidth(String.valueOf(String.valueOf(currentWord)) + word + " ") < width)
        {
  ...
  public List<String> formatString(String string, double width)
  {
    ...
    for (int i = 0; i < chars.length; i++)
    {
      ...
      if (getStringWidth(String.valueOf(String.valueOf(currentWord)) + c) < width)
      {
