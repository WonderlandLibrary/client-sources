...
public class BlockUtils
{
  public static int getBestTool(BlockPos pos)
  {
    ...
    {
      ItemStack itemStack = Minecraft.getMinecraft().thePlayer.inventoryContainer.getSlot(index).getStack();
  ...
  public static boolean isInLiquid(Entity entity)
  {
    ...
    for (int x = MathHelper.floor_double(entity.getEntityBoundingBox().minX); x < MathHelper.floor_double(Minecraft.getMinecraft().thePlayer.getEntityBoundingBox().maxX) + 1; x++) {
  ...
  public static boolean isOnLadder(Entity entity)
  {
    ...
    return (onLadder) || (Minecraft.getMinecraft().thePlayer.isOnLadder());
  }
  ...
  {
    Minecraft.getMinecraft();return getBlock(Minecraft.getMinecraft().thePlayer.getEntityBoundingBox().offset(x, y, z));
  }
