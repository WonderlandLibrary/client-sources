package me.xatzdevelopments.xatz.client.Unused.bypasses;
...
public class AntiGwen extends Bypass {
	...
	public void onEnable() {
		...
		Xatz.getModuleByName("Flight").setMode("Glide");
	...
	public void setBypassableMods() {
		...
		this.allowedMods.add(Xatz.getModuleByName("Regen"));
		...
		this.allowedMods.add(Xatz.getModuleByName("TpAura"));
