...
import me.xatzdevelopments.xatz.client.modules.Animations;
...
public class ItemRenderer {
		...
		if (this.itemToRender != null) {
			if (this.itemToRender.getItem() instanceof ItemMap) {
				...
				case 4:
					...
					if(Xatz.getModuleByName("AutoBlock").isToggled()) {
						if((Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("Vanilla"))) {
							this.transformFirstPersonItem(0, f1);
                    		this.func_178103_d();
						}
						if((Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("Slide"))) {
							this.sigma2(f*0.3f, f1);
                    		this.func_178103_d();
						}
						if((Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("Tap"))) {
							this.tap(f, f1);
                    		this.func_178103_d();
						}
						if((Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("Tap2"))) {
							this.tap2(f, f1);
                    		this.func_178103_d();
						}
						if((Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("Avatar"))) {
							this.avatar(f, f1);
                            this.func_178103_d();
						}
						if((Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("Sigma"))) {
						...
						if((Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("Helium"))) {
							 this.transformFirstPersonItem(f, 1.0f);
	                            this.func_178103_d();
	                            GL11.glTranslatef(0.4f, 0.1f, -0.01f);
	                            final float var16 = MathHelper.sin(f1 * f1 * 5.1415925f);
	                            GlStateManager.translate(-0.1f, 0.3f, 0.2f);
	                            GlStateManager.rotate(var16 * 13.0f, -10.0f, -1.4f, -10.0f);
						}
						if((Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("Xatz"))) {
							this.transformFirstPersonItem(f, 1.0f);
                            this.func_178103_d();
                            GL11.glTranslatef(0.4f, 0.3f, 0.3f);
                            final float var17 = MathHelper.sin(f1 * f1 * 5.1415925f);
                            GlStateManager.translate(-0.4f, -0.1f, -0.2f);
                            GlStateManager.rotate(var17 * 17.0f, -65.0f, -0.4f, -5.0f);
						}
						if((Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("Derp"))) {
							 this.transformFirstPersonItem(f, f1);
	                            this.func_178103_d();
	                            final float var18 = MathHelper.sin(f1 * f1 * 5.1415925f);
	                            GL11.glTranslatef(0.1f, -0.1f, 0.3f);
	                            GlStateManager.translate(0.1f, -0.1f, 0.4f);
	                            GlStateManager.rotate(var18 * 523.0f, 215.0f, 1.4f, 525.0f);
						}
						if((Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("Derp2"))) {
							if(!(f1 >= 20)) {
							 this.transformFirstPersonItem(f, f1);
	                            this.func_178103_d();
						...
						if((Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("HaxxerClient"))) {
							float var9 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
							this.transformFirstPersonItem(f / 2.0F, 1.5F);
							GL11.glRotatef(-var9 * 40.0F / 2.0F, var9 / 2.0F, -0.0F, 9.0F);
							GL11.glRotatef(-var9 * 30.0F, 1.0F, var9 / 2.0F, -0.0F);
							this.func_178103_d();
							
						}
						if(Xatz.getModuleByName("AutoBlock").getCurrentMode().equals("Exhi")) {
							float var9 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
			...
			if(Xatz.getModuleByName("Animations").isToggled()) {
				if((Xatz.getModuleByName("Animations").getCurrentMode().equals("Smooth"))) {
				 this.transformFirstPersonItem(f*0.5F, f1);
				}
			
			else if((Xatz.getModuleByName("Animations").getCurrentMode().equals("Vanilla"))) {
	...
	public void renderOverlays(float partialTicks) {
		...
		if (this.mc.thePlayer.isEntityInsideOpaqueBlock()) {
			...
			Entity entityplayersp = this.mc.thePlayer;
