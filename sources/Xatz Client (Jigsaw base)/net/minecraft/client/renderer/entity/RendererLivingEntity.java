...
import me.xatzdevelopments.xatz.client.events.NameTagEvent;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
	...
	public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
		new EventRenderEntity();
		new EventPreEntityRender(entity);
		EventRenderEntity event = new EventRenderEntity();
		Xatz.OnUpdate(event);
		...
		if (!Reflector.RenderLivingEvent_Pre_Constructor.exists()
			...
			new EventPostEntityRender(entity);
	...
	protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_,
		...
		if (flag || flag1) {
			...
			// TODO Xatz ESP Outline
			if (Xatz.getModuleByName("ESP").isToggled()
					&& Xatz.getModuleByName("ESP").getCurrentMode().equals("Outline")) {
