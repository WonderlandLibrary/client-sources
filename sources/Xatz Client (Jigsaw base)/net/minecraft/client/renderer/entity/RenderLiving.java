...
public abstract class RenderLiving<T extends EntityLiving> extends RendererLivingEntity<T> {
	...
	protected boolean canRenderName(T entity) {
		if (!Xatz.getModuleByName("NoRender").isToggled()) {
	 ...
	 * super.doRender((EntityLivingBase)entity, x, y, z, entityYaw,
	 * partialTicks); this.renderLeash(entity, x, y, z, entityYaw,
	 * partialTicks); }
	 */
	 ...
	 * float f, float f1). But JAD is pre 1.5 so doe
	 *
	 * public void doRender(EntityLivingBase entity, double x, double y, double
