...
public abstract class EntityPlayer extends EntityLivingBase {
	// TODO Xatz didswingitem
	public boolean didSwingItem = false;
	...
	public void onUpdate() {
		if (apsTimer.hasTimeElapsed(1000, true)) {
			preAps = aps;
			aps = tempAps;
			tempAps = 0;
		}
	...
	public void attackTargetEntityWithCurrentItem(Entity targetEntity) {
        final inEventAttack e = new inEventAttack(targetEntity);
						...
						if (i > 0) {
							...
							targetEntity.addVelocity(
									...
									(0.1D), ((double) (MathHelper.cos(this.rotationYaw * (float) Math.PI / 180.0F)
											* (float) i * 0.5F)));
							// TODO Xatz keepsprint!
							if (!Xatz.getModuleByName("KeepSprint").isToggled()) {
								this.motionX *= 0.6D;
								this.motionZ *= 0.6D;
