...
public final class ItemStack
{
    ...
    public static boolean areItemStacksEqualIgnoreDurability(ItemStack stackA, ItemStack stackB)
    {
        return stackA == null && stackB == null ? true : (stackA != null && stackB != null ? stackA.isItemStackEqualIgnoreDurability(stackB) : false);
    }
    ...
    private boolean isItemStackEqualIgnoreDurability(ItemStack other)
    {
        return this.stackSize != other.stackSize ? false : (this.item != other.item ? false : (this.stackTagCompound == null && other.stackTagCompound != null ? false : this.stackTagCompound == null || this.stackTagCompound.equals(other.stackTagCompound)));
    }
