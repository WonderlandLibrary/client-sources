...
import club.pulsive.impl.event.player.PlayerCollideBoiEvent;
...
public class Block
{
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        PlayerCollideBoiEvent eventCollide = new PlayerCollideBoiEvent(axisalignedbb, this, collidingEntity, pos);

        if(collidingEntity instanceof EntityPlayerSP)
            Pulsive.INSTANCE.getEventBus().call(eventCollide);
