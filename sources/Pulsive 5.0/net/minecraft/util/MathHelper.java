...
public class MathHelper
{
    ...
    public static final float PI = MathUtils.roundToFloat(ApacheMath.PI);
    public static final float PI2 = MathUtils.roundToFloat((ApacheMath.PI * 2D));
    public static final float PId2 = MathUtils.roundToFloat((ApacheMath.PI / 2D));
    ...
    {
        return (float) ApacheMath.sqrt((double)value);
    }

    public static float sqrt_double(double value)
    {
        return (float)ApacheMath.sqrt(value);
    }
    ...
    {
        return ApacheMath.max(p_82714_2_, parseIntWithDefault(p_82714_0_, p_82714_1_));
    }
    ...
    {
        return ApacheMath.max(p_82713_3_, parseDoubleWithDefault(p_82713_0_, p_82713_1_));
    }
    ...
    {
        return p_181162_0_ - ApacheMath.floor(p_181162_0_);
    }
    ...
    static
    {
        ...
        {
            SIN_TABLE[i] = (float)ApacheMath.sin((double)i * ApacheMath.PI * 2.0D / 65536.0D);
        }

        for (int j = 0; j < SIN_TABLE_FAST.length; ++j)
        {
            SIN_TABLE_FAST[j] = MathUtils.roundToFloat(ApacheMath.sin((double)j * ApacheMath.PI * 2.0D / 4096.0D));
        }
        ...
        for (int k = 0; k < 257; ++k)
        {
            ...
            double d1 = ApacheMath.asin(d0);
            field_181165_f[k] = ApacheMath.cos(d1);
            field_181164_e[k] = d1;
        }
    }
}
