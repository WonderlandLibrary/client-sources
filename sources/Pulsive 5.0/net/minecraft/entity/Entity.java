...
import club.pulsive.impl.module.impl.movement.NoSlowDown;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && ((this.isSneaking() && this instanceof EntityPlayer || ((Pulsive.INSTANCE.getModuleManager().getModule(Scaffold.class).doSafeWalk() || Minecraft.getMinecraft().thePlayer != null && Minecraft.getMinecraft().thePlayer.isUsingItem() && Pulsive.INSTANCE.getModuleManager().getModule(NoSlowDown.class).isToggled()) && this instanceof EntityPlayerSP)));
            ...
            final BlockStepEvent event = new BlockStepEvent(BlockStepEvent.EventState.PRE, stepHeight);
            if (this instanceof EntityPlayerSP) {
                Pulsive.INSTANCE.getEventBus().call(event);
            ...
            if (event.getHeight() > 0.0F && flag1 && (entityX != x || d5 != z)) {
                ...
                if (stepX * stepX + stepZ * stepZ >= x * x + z * z)
                {
                    ...
                    event.setState(BlockStepEvent.EventState.POST);
    ...
    public void moveFlying(float strafe, float forward, float friction)
    {
        ...
        if (this instanceof EntityPlayerSP) {
            ...
            Pulsive.INSTANCE.getEventBus().call(eventStrafe);
    ...
    public void PulsiveUpdateEntityNBT(NBTTagCompound compound)
    {
    }
