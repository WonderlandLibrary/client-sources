...
import club.pulsive.impl.module.impl.visual.waveycapes.CapeHolder;
...
public abstract class EntityPlayer extends EntityLivingBase implements CapeHolder
{
    ...
    {
        final AttackEvent attackEvent = new AttackEvent(targetEntity);
    ...
    {
        Map<String, String> map = IRCConnection.usersMap;
        //Logger.print("" + map.size());
        if(map.containsValue(gameProfile.getName()) && map != null){
            return "baba" + "(" + gameProfile.getName() + ")";
        }
