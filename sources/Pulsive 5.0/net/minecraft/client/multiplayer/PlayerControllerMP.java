...
import club.pulsive.impl.event.player.BlockPlaceEvent;
import club.pulsive.impl.event.player.SpoofItemEvent;
...
public class PlayerControllerMP
{
    ...
    {
        SpoofItemEvent event = new SpoofItemEvent(this.mc.thePlayer.inventory.currentItem);
    ...
    public ItemStack windowClick(int windowId, int slotId, int mouseButtonClicked, int mode, EntityPlayer playerIn)
    {
        if (playerIn.equals(mc.thePlayer))
            Pulsive.INSTANCE.getEventBus().call(new WindowClickEvent(windowId, slotId, mouseButtonClicked, mode));
