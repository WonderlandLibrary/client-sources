...
public class Main
{
    ...
    {
        String yata = JOptionPane.showInputDialog(null, "Make sure you copied it right dumbass", "Enter Your API Key!", 2);
        if(yata == null) Minecraft.getMinecraft().shutdownMinecraftApplet();
        apiKey = yata;
        ...
        OptionSpec<File> optionspec2 = optionspec2 = optionparser.accepts("gameDir").withRequiredArg().ofType(File.class).defaultsTo(new File("."), (File[])new File[0]);
        ...
        OptionSpec<Integer> optionspec13 = optionparser.accepts("width").withRequiredArg().ofType(Integer.class).defaultsTo(Integer.valueOf(1860), new Integer[0]);
        OptionSpec<Integer> optionspec14 = optionparser.accepts("height").withRequiredArg().ofType(Integer.class).defaultsTo(Integer.valueOf(1000), new Integer[0]);
        ...
        OptionSpec<String> intentApiKey = optionparser.accepts("intentApiKey").withOptionalArg().ofType(String.class).defaultsTo(yata);
