...
public class OpenGlHelper
{
    ...
    public static void initializeTextures()
    {
        ...
        try
        {
            CentralProcessor.PhysicalProcessor[] aprocessor = new SystemInfo().getHardware().getProcessor().getPhysicalProcessors().toArray(new CentralProcessor.PhysicalProcessor[0]);
            cpu = String.format("%dx %s", new Object[] {Integer.valueOf(aprocessor.length), new SystemInfo().getHardware().getProcessor()}).replaceAll("\\s+", " ");
        }
