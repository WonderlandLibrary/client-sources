...
public class RenderManager {
    ...
    public void renderEntityStaticNoShadow(Entity entity, float partialTicks, boolean p_147936_3_) {
        ...
        float f = (float) RenderUtil.interpolate(entity.rotationYaw, entity.prevRotationYaw, partialTicks);
        int i = entity.getBrightnessForRender(partialTicks);
        ...
        OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (float) j / 1.0F, (float) k / 1.0F);
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        this.doRenderEntityNoShadow(entity, d0, d1, d2, f, partialTicks, p_147936_3_);
    }
