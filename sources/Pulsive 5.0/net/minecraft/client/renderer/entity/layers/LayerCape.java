...
//                entitylivingbaseIn.setLocationOfCape(new ResourceLocation("pulsabo/images/nopandaware.png"));
            if(WaveyCapes.getInstance().isToggled() && entitylivingbaseIn instanceof EntityPlayerSP)
                return;
