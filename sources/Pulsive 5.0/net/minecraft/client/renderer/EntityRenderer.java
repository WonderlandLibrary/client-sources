...
import club.pulsive.impl.event.player.UpdateLookEvent;
import club.pulsive.impl.event.render.Render3DEvent;
import club.pulsive.impl.event.render.Render3DEvent2;
import club.pulsive.impl.module.impl.visual.Camera;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void hurtCameraEffect(float partialTicks) {
        Camera camera = Pulsive.INSTANCE.getModuleManager().getModule(Camera.class);
        if (camera.isToggled() && camera.prop_elements.isSelected(Camera.ELEMENTS.NO_HURT_CAM)) {
            return;
        }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Pulsive.INSTANCE.getEventBus().call(new Render3DEvent2(partialTicks));
        ...
        Pulsive.INSTANCE.getEventBus().call(new Render3DEvent(partialTicks));
