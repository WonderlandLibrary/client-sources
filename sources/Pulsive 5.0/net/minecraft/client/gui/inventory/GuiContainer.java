...
//        PlayerUtil.sendMessage(serverTransactionId + " " + inventorySlots.getTransactionID());
        String text = synchronizedTransactions ? "Good to go!" : "You may be unsynced!";
        RoundedUtil.drawRoundedOutline(width / 2f - fontRendererObj.getStringWidth(text) / 2f - 2, guiTop - fontRendererObj.FONT_HEIGHT * 2 - 2, width / 2f - width / 2f - fontRendererObj.getStringWidth(text) / 2f + width / 2f + fontRendererObj.getStringWidth(text) + 2, guiTop - fontRendererObj.FONT_HEIGHT + 2, 8, 3, HUD.getColor());
