...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn) {
        ...
        if(entityotherplayermp == null) return;
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn)
    {
        ...
        Pulsive.INSTANCE.getEventBus().call(playerTeleportEvent);
        ...
        if(Pulsive.INSTANCE.getModuleManager().getModule(Disabler.class).isHyp()) {
            this.netManager.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(entityplayer.posX, entityplayer.getEntityBoundingBox().minY + MovementUtil.getRandomHypixelValuesFloat(), entityplayer.posZ, false));
        } else
    ...
    {
        this.netManager.sendPacketWithoutEvent(packet);
    }
...
//            }
    ...
    public void handleChangeGameState(S2BPacketChangeGameState packetIn)
    {
        ...
        {
            this.clientWorldController.playSound(entityplayer.posX, entityplayer.posY + (double)1.62, entityplayer.posZ, "random.successful_hit", 0.18F, 0.45F, false);
        }
        else if (i == 7)
        {
