...
public class CapeUtils
{
    ...
    public static void bindTexture(AbstractClientPlayer abstractClientPlayer, RenderPlayer renderPlayer){
        if(abstractClientPlayer instanceof EntityPlayerSP){
            if(abstractClientPlayer.getLocationCape() != null)
                ...
                renderPlayer.bindTexture(new ResourceLocation("pulsabo/images/2016.png"));
        }
    }
