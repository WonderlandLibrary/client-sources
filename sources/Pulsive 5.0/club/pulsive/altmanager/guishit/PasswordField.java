package club.pulsive.altmanager.guishit;
...
public class PasswordField extends Gui {
    ...
    private com.google.common.base.Predicate<Object> field_175209_y = Predicates.alwaysTrue();
    ...
    public void setText(String p_146180_1_) {
        if (((com.google.common.base.Predicate<Object>) field_175209_y).apply(p_146180_1_)) {
    ...
    public void func_175205_a(Predicate<String> p_175205_1_) {
        field_175209_y = (com.google.common.base.Predicate<Object>) p_175205_1_;
    }
    ...
    public void writeText(String p_146191_1_) {
        ...
        if (((com.google.common.base.Predicate<Object>) field_175209_y).apply(s)) {
            text = s;
    ...
    public void drawTextBox() {
        ...
        if (s.length() > 0) {
            ...
            j1 = (int)Fonts.moon.drawStringWithShadow(s1.replaceAll("(?s).", "*"), (float) l, (float) i1, i);
        }
        ...
        if (s.length() > 0 && flag && j < s.length()) {
            j1 = fontRendererInstance.drawStringWithShadow(s.substring(j).replaceAll("(?s).", "*"), (float) j1, (float) i1, i);
        }
