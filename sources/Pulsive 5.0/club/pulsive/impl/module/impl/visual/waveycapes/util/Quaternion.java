package club.pulsive.impl.module.impl.visual.waveycapes.util;
...
public final class Quaternion {
    ...
    public static Quaternion fromYXZ(float f, float g, float h) {
        ...
        quaternion.mul(new Quaternion(0.0F, (float) ApacheMath.sin((f / 2.0F)), 0.0F, (float)ApacheMath.cos((f / 2.0F))));
        quaternion.mul(new Quaternion((float)ApacheMath.sin((g / 2.0F)), 0.0F, 0.0F, (float)ApacheMath.cos((g / 2.0F))));
        quaternion.mul(new Quaternion(0.0F, 0.0F, (float)ApacheMath.sin((h / 2.0F)), (float)ApacheMath.cos((h / 2.0F))));
        return quaternion;
    }

    public static Quaternion fromXYZDegrees(Vector3f vector3f) {
        return fromXYZ((float)ApacheMath.toRadians(vector3f.x()), (float)ApacheMath.toRadians(vector3f.y()),
                (float)ApacheMath.toRadians(vector3f.z()));
    }
    ...
    public static Quaternion fromXYZ(float f, float g, float h) {
        Quaternion quaternion = ONE.copy();
        quaternion.mul(new Quaternion((float)ApacheMath.sin((f / 2.0F)), 0.0F, 0.0F, (float)ApacheMath.cos((f / 2.0F))));
        quaternion.mul(new Quaternion(0.0F, (float)ApacheMath.sin((g / 2.0F)), 0.0F, (float)ApacheMath.cos((g / 2.0F))));
        quaternion.mul(new Quaternion(0.0F, 0.0F, (float)ApacheMath.sin((h / 2.0F)), (float)ApacheMath.cos((h / 2.0F))));
        return quaternion;
    }
    ...
    public Vector3f toXYZ() {
        ...
        float l = (float)ApacheMath.asin((k / j));
        if (ApacheMath.abs(k) > 0.999F * j)
            return new Vector3f(2.0F * (float)ApacheMath.atan2(i(), r()), l, 0.0F);
        return new Vector3f((float)ApacheMath.atan2((2.0F * j() * k() + 2.0F * i() * r()), (f - g - h + i)), l,

                (float)ApacheMath.atan2((2.0F * i() * j() + 2.0F * r() * k()), (f + g - h - i)));
    }

    public Vector3f toXYZDegrees() {
        Vector3f vector3f = toXYZ();
        return new Vector3f((float)ApacheMath.toDegrees(vector3f.x()), (float)ApacheMath.toDegrees(vector3f.y()),
                (float)ApacheMath.toDegrees(vector3f.z()));
    }
    ...
    public Vector3f toYXZ() {
        ...
        if (ApacheMath.abs(k) > 0.999F * j)
            return new Vector3f(l, 2.0F *
                    ...
                    (float)ApacheMath.atan2(j(), r()), 0.0F);
        return new Vector3f(l,

                (float)ApacheMath.atan2((2.0F * i() * k() + 2.0F * j() * r()), (f - g - h + i)),
                (float)ApacheMath.atan2((2.0F * i() * j() + 2.0F * r() * k()), (f - g + h - i)));
    }
    ...
    private static float cos(float f) {
        return (float)ApacheMath.cos(f);
    }

    private static float sin(float f) {
        return (float)ApacheMath.sin(f);
    }
