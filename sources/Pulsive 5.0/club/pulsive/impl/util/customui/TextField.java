    ...
    public void drawTextBox() {
        if (getVisible()) {
            if (getEnableBackgroundDrawing()) {
                drawRect(xPosition -1, yPosition -1, xPosition + width + 1, yPosition + height + 1, 0xFF121212);
                drawRect(xPosition, yPosition, xPosition + width, yPosition + height, 0xFF171717);
                //   drawRect(xPosition, yPosition + (height - 1), width + xPosition, height + yPosition, -1);
            }
            ...
            if (flag1) {
                if (flag2) {
                    Fonts.tahoma.drawStringWithShadow("|", (float) k1 - 2, (float) i1, -3092272);
                } else {
                    Fonts.tahoma.drawStringWithShadow("|", (float) k1 - 1, (float) i1, i);
                }
            }
