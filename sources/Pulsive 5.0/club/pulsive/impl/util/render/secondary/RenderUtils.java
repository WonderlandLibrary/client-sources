...
public class RenderUtils
{
    ...
    public static void colorAlpha(final int color, final float alpha) {
    ...
    public static void drawRoundedRect(double x, double y, final double width, final double height, final double radius, final int color) {
        ...
        for (int i = 90; i <= 180; i += 3) {
            GL11.glVertex2d(x + radius + ApacheMath.sin(i * 3.141592653589793 / 180.0) * (radius * -1.0), y2 - radius + ApacheMath.cos(i * 3.141592653589793 / 180.0) * (radius * -1.0));
        }
        for (int i = 0; i <= 90; i += 3) {
            GL11.glVertex2d(x2 - radius + ApacheMath.sin(i * 3.141592653589793 / 180.0) * radius, y2 - radius + ApacheMath.cos(i * 3.141592653589793 / 180.0) * radius);
        }
        for (int i = 90; i <= 180; i += 3) {
    ...
    public static void drawSolidEntityESP(double x, double y, double z, double width, double height, float r, float g, float b, float alpha)
    {
        GL11.glPushMatrix();
        GL11.glEnable(3042);
        GL11.glBlendFunc(770, 771);
