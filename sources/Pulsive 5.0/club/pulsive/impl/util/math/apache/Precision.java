...
public class Precision {
    ...
    public static boolean equals(float x, float y, float eps) {
        return equals(x, y, 1) || ApacheMath.abs(y - x) <= eps;
    }
    ...
    public static boolean equalsIncludingNaN(float x, float y, float eps) {
        return equalsIncludingNaN(x, y, 1) || (ApacheMath.abs(y - x) <= eps);
    }
    ...
    public static boolean equals(final float x, final float y, final int maxUlps) {
        ...
        if (((xInt ^ yInt) & SGN_MASK_FLOAT) == 0) {
            ...
            isEqual = ApacheMath.abs(xInt - yInt) <= maxUlps;
        } else {
    ...
    public static boolean equalsWithRelativeTolerance(double x, double y, double eps) {
        ...
        final double absoluteMax = ApacheMath.max(ApacheMath.abs(x), ApacheMath.abs(y));
        final double relativeDifference = ApacheMath.abs((x - y) / absoluteMax);
    ...
    public static boolean equalsIncludingNaN(double x, double y, double eps) {
        return equalsIncludingNaN(x, y) || (ApacheMath.abs(y - x) <= eps);
    }
    ...
    public interface DoubleEquivalence {
        ...
        default double signum(double a) {
            return a == 0d ||
                    ...
                    a :
                    eqZero(a) ?
                            ApacheMath.copySign(0d, a) :
                            ApacheMath.copySign(1d, a);
        }
