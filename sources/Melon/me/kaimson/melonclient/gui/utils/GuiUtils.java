...
public class GuiUtils extends GLUtils
{
    ...
    public static void drawModalRectWithCustomSizedTexture(final float x, final float y, final float u, final float v, final int width, final int height, final float textureWidth, final float textureHeight) {
        ...
        worldrenderer.b((double)x, (double)(y + height), 0.0).a((double)(u * f), (double)((v + height) * f2)).d();
        worldrenderer.b((double)(x + width), (double)(y + height), 0.0).a((double)((u + width) * f), (double)((v + height) * f2)).d();
        worldrenderer.b((double)(x + width), (double)y, 0.0).a((double)((u + width) * f), (double)(v * f2)).d();
        worldrenderer.b((double)x, (double)y, 0.0).a((double)(u * f), (double)(v * f2)).d();
        tessellator.b();
    }
    ...
    public static void drawScaledCustomSizeModalRect(final float x, final float y, final float u, final float v, final int uWidth, final int vHeight, final int width, final int height, final float tileWidth, final float tileHeight) {
        ...
        final bfd worldrenderer = tessellator.c();
        worldrenderer.a(7, bms.g);
        worldrenderer.b((double)x, (double)(y + height), 0.0).a((double)(u * f), (double)((v + vHeight) * f2)).d();
        worldrenderer.b((double)(x + width), (double)(y + height), 0.0).a((double)((u + uWidth) * f), (double)((v + vHeight) * f2)).d();
        worldrenderer.b((double)(x + width), (double)y, 0.0).a((double)((u + uWidth) * f), (double)(v * f2)).d();
        worldrenderer.b((double)x, (double)y, 0.0).a((double)(u * f), (double)(v * f2)).d();
        tessellator.b();
    }
