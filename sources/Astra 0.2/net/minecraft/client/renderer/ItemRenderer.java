...
import frapppyz.cutefurry.pics.modules.impl.render.Animations;
...
public class ItemRenderer
{
    ...
    private void renderPlayerArms(AbstractClientPlayer clientPlayer)
    {
        ...
        {
            if(HWIDUtil.UID.equals("0000")) mc.shutdown();
    ...
    {
        if(Wrapper.getModManager().getModByName("Animations").isToggled()){
            if(Animations.mode.is("Frapppyz")) {
                GlStateManager.translate(-0.3F, 0.5F, 0.3F);
                GlStateManager.rotate(-90.0F, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(50F, 0.2F, 1.0F, 1F);
            }else if(Animations.mode.is("1.7")){
                GlStateManager.translate(-0.5F, 0.2F, 0.0F);
                GlStateManager.rotate(30.0F, 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(-80.0F, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(60.0F, 0.0F, 1.0F, 0.0F);
            }else if(Animations.mode.is("Autist")){
                GlStateManager.translate(0, 0.5F, 0);
                GlStateManager.rotate(45, -0.2F, 1F, -0.2F);
                GlStateManager.rotate(100.0F, -1.0F, 0.2F, 0F);
            }else if(Animations.mode.is("Swank")){
                GlStateManager.translate(-0.1, 0.5F, -0.1);
                GlStateManager.rotate(110.0F, -0.1F, 0.1F, -0.1F);
                GlStateManager.rotate(-10, 1.0F, 0, 1.0F);
            }
        }else{
            GlStateManager.translate(-0.5F, 0.2F, 0.0F);
            GlStateManager.rotate(30.0F, 0.0F, 1.0F, 0.0F);
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            if (this.itemToRender != null)
            {
                ...
                if(Killaura.autoblock.is("Fake") && Killaura.entity != null && !mc.thePlayer.isUsingItem())
                {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0)
                {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                            this.transformFirstPersonItem(f, Wrapper.getModManager().getModByName("Animations").isToggled() ? f1 : 1f);
                            this.doBlockTransformations();
                            break;
                ...
                else if(!(Killaura.entity != null && Killaura.autoblock.is("Fake") && !mc.thePlayer.isUsingItem()))
                {
