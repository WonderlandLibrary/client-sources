...
import net.minecraft.client.triton.impl.modules.render.ESP;
...
import net.minecraft.client.triton.utils.MCStencil;
...
public abstract class RendererLivingEntity extends Render
{
    ...
    public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
	{
		...
		try
		{
			...
			final ESP espInstance = (ESP)new ESP().getInstance();
			if(espInstance.isEnabled() && ((espInstance.players && p_76986_1_ instanceof EntityPlayer) || (espInstance.monsters && p_76986_1_ instanceof EntityMob) || (espInstance.animals && p_76986_1_ instanceof EntityAnimal)) && p_76986_1_.getName() != Minecraft.getMinecraft().thePlayer.getName() && p_76986_1_ != Minecraft.getMinecraft().thePlayer) {
				MCStencil.checkSetupFBO();
				renderModel(p_76986_1_, var17, var16, var14, var12, var20, var15);
				GL11.glBlendFunc(770, 771);
				espInstance.renderOne();
				...
				float health = ((EntityLivingBase) p_76986_1_).getHealth();
				GL11.glEnable(GL11.GL_DITHER);
					GL11.glColor4f(255, 255, 255, 200); 
				if (FriendManager.isFriend(p_76986_1_.getName())) {
					GL11.glColor4f(0.0F, 255.0F, 10.0F, 255);
				}
				renderModel(p_76986_1_, var17, var16, var14, var12, var20, var15);
				espInstance.renderTwo();
				renderModel(p_76986_1_, var17, var16, var14, var12, var20, var15);
				espInstance.renderThree();
				renderModel(p_76986_1_, var17, var16, var14, var12, var20, var15);
				espInstance.renderFour();
				renderModel(p_76986_1_, var17, var16, var14, var12, var20, var15);
				espInstance.renderFive();	
