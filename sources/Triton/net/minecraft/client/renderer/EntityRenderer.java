...
import net.minecraft.client.triton.impl.modules.render.Brightness;
import net.minecraft.client.triton.impl.modules.render.SwordTransitions;
import net.minecraft.client.triton.impl.modules.render.ViewClip;
            ...
            else
            {
                ...
                for (int var20 = 0; var20 < 8; ++var20)
                {
                    ...
                    if (var24 != null)
                    {
                        ...
                        ViewClip mod = (ViewClip)new ViewClip().getInstance();
                        if (var25 < var28 && !mod.isEnabled())
                        {
                            var28 = var25;
                        }
                    }
