...
package net.minecraft.client.triton.ui.account;
...
import net.minecraft.client.triton.ui.account.component.AltButton;
import net.minecraft.client.triton.ui.account.component.Button;
import net.minecraft.client.triton.ui.account.screen.Screen;
import net.minecraft.client.triton.ui.account.screen.ScreenAddAccount;
import net.minecraft.client.triton.ui.account.screen.ScreenEditAccount;
...
extends GuiScreen {
    ...
    public static String info = "§bWaiting...";
    ...
    public void drawAltButtons(int mouseX, int mouseY) {
        ...
        if (this.toRemove != null && AccountManager.accountList.contains(this.toRemove)) {
            ...
            AccountManager.saveAccounts();
            Triton.accountScreen.addAltButtons();
            this.toRemove = null;
        }
    ...
    extends Button {
        ...
        public void onClick(int button) {
            if (AccountScreen.this.selectedButton != null) {
                ...
                Triton.accountScreen.info = "§cRemoved Account";
            }
        }
    }
