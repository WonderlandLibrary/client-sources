...
import net.minecraft.client.triton.ui.click.component.slot.option.types.BooleanOptionSlot;
import net.minecraft.client.triton.ui.click.component.slot.option.types.KeybindOptionSlot;
import net.minecraft.client.triton.ui.click.component.slot.option.types.NumberOptionSlot;
import net.minecraft.client.triton.ui.click.component.slot.option.types.VisibilityOptionSlot;
...
public class OptionWindow extends Window<Module>
{
    ...
    public OptionWindow(final Module module, final double x, final double y, double width, final ModuleWindow parentWindow) {
        ...
        for (final Option option : module.getOptions()) {
            ...
            if (option instanceof BooleanOption) {
                optionSlot = new BooleanOptionSlot((BooleanOption)option, x + 1.5 + 1.5, y + height - 0.5 + 3, width + 16.0 - 3.0 - 3.0, 17.0);
            }
            else if (option instanceof NumberOption) {
                optionSlot = new NumberOptionSlot((NumberOption)option, x + 1.5 + 1.5, y + height - 0.5 + 3, width + 16.0 - 3.0 - 3.0, 17.0);
            }
            if (optionSlot != null) {
        ...
        this.getSlotList().add(new KeybindOptionSlot(module, x + 1.5 + 1.5, y + height - 0.5 + 3, width + 16.0 - 3.0 - 3.0, 17.0));
        height += 18.0;
        this.getSlotList().add(new VisibilityOptionSlot(module, x + 1.5 + 1.5, y + height - 0.5 + 3, width + 16.0 - 3.0 - 3.0, 17.0));
        height += 18.0;
        width += 16.0;
        height += 1.5;
        this.setWidth(width);
    ...
    public void draw(final int mouseX, final int mouseY) {
        ...
        RenderUtils.rectangle(this.getX(), this.getY() + 3, this.getX() + this.getWidth(), this.getY() + this.getHeight() + 3, 0xb3000000);
