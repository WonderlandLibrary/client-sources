...
public final class ModuleManager
{
	...
	public ModuleManager() {
		...
		moduleList.add(new AutoPot());
		moduleList.add(new Velocity());
		moduleList.add(new Regen());
		moduleList.add(new AutoArmor());
		moduleList.add(new Soup());
		moduleList.add(new AntiCactus());
		moduleList.add(new AntiVanish());
		moduleList.add(new AutoEnemy());
		moduleList.add(new Commands());
		moduleList.add(new FilterBypass());
		moduleList.add(new MiddleClickFriend());
		moduleList.add(new NoRotate());
		moduleList.add(new NoteBot());
		moduleList.add(new NoteTuner());
		moduleList.add(new Respawn());
		moduleList.add(new ScreenWalk());
		moduleList.add(new AntiEffects());
		...
		moduleList.add(new SwordTransitions());
		moduleList.add(new Tags());
		moduleList.add(new ViewClip());
...
*/
    ...
    public static void start() {
        final Reflections reflections = new Reflections("net.minecraft.client.triton.impl.modules", new Scanner[0]);
