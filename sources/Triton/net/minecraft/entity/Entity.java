...
import net.minecraft.client.triton.impl.modules.movement.Step;
              ...
              if (var56 * var56 + var27 * var27 >= x * x + z * z)
              {
                ...
                if (stepEvent.isActive()) {
                  if ((stepEvent.getStepHeight() > 0.0D) && (var54) && ((var13 != x) || (var17 != z)))
                  {
                    ...
                    func_174826_a(getEntityBoundingBox().offset(0.0D, y + (((Step)new Step().getInstance()).packet ? 0.0D : 0.063D), 0.0D));
