...
public class GuiPasswordFlatField extends GuiTextField
{
    public int HorizonCode_Horizon_È;
    
    public GuiPasswordFlatField(final int p_i45542_1_, final FontRenderer p_i45542_2_, final int p_i45542_3_, final int p_i45542_4_, final int p_i45542_5_, final int p_i45542_6_) {
    ...
    public void HorizonCode_Horizon_È() {
        if (this.£á()) {
            if (this.ˆÏ­) {
                Gui_1808253012.HorizonCode_Horizon_È(this.Ø­áŒŠá - 1, this.Âµá€ + this.à - 4, this.Ø­áŒŠá + this.Ó + 1, this.Âµá€ + this.à + 1 - 4, -13330213);
            }
            else {
                Gui_1808253012.HorizonCode_Horizon_È(this.Ø­áŒŠá - 1, this.Âµá€ + this.à - 4, this.Ø­áŒŠá + this.Ó + 1, this.Âµá€ + this.à + 1 - 4, -6250336);
            }
            ...
            if (var4.length() > 0) {
                ...
                var9 = this.Ý.HorizonCode_Horizon_È(var10.replaceAll(".", "*"), var7, (float)var8, var1);
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                var9 = this.Ý.HorizonCode_Horizon_È(var4.substring(var2).replaceAll(".", "*"), var9, (float)var8, var1);
            }
            if (var6) {
                if (var11) {
