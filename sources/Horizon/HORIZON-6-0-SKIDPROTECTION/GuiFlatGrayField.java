...
public class GuiFlatGrayField extends GuiTextField
{
    public GuiFlatGrayField(final int p_i45542_1_, final FontRenderer p_i45542_2_, final int p_i45542_3_, final int p_i45542_4_, final int p_i45542_5_, final int p_i45542_6_) {
    ...
    public void HorizonCode_Horizon_È() {
        if (this.£á()) {
            if (this.áˆºÑ¢Õ()) {
                if (!this.ˆÏ­) {
                    Gui_1808253012.HorizonCode_Horizon_È(this.Ø­áŒŠá + 0, this.Âµá€ + this.à + 1, this.Ø­áŒŠá + this.Ó - 2, this.Âµá€ + this.à - 20, -8418163);
                    Gui_1808253012.HorizonCode_Horizon_È(this.Ø­áŒŠá + 2, this.Âµá€ + this.à - 1, this.Ø­áŒŠá + this.Ó - 4, this.Âµá€ + this.à - 18, -13350562);
                }
                else {
                    Gui_1808253012.HorizonCode_Horizon_È(this.Ø­áŒŠá + 0, this.Âµá€ + this.à + 1, this.Ø­áŒŠá + this.Ó - 2, this.Âµá€ + this.à - 20, -8418163);
                    Gui_1808253012.HorizonCode_Horizon_È(this.Ø­áŒŠá + 2, this.Âµá€ + this.à - 1, this.Ø­áŒŠá + this.Ó - 4, this.Âµá€ + this.à - 18, -13350562);
