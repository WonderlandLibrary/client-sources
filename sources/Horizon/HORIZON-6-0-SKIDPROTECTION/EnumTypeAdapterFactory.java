...
{
    private static final String HorizonCode_Horizon_È = "CL_00001494";
    ...
    public TypeAdapter create(final Gson p_create_1_, final TypeToken p_create_2_) {
        ...
        for (final Object var8 : var3.getEnumConstants()) {
            var4.put(this.HorizonCode_Horizon_È(var8), var8);
        }
        return new TypeAdapter() {
            private static final String Â = "CL_00001495";
            ...
            public void write(final JsonWriter p_write_1_, final Object p_write_2_) throws IOException {
                if (p_write_2_ == null) {
                    ...
                    p_write_1_.value(EnumTypeAdapterFactory.this.HorizonCode_Horizon_È(p_write_2_));
                }
            }
    ...
    private String HorizonCode_Horizon_È(final Object p_151232_1_) {
