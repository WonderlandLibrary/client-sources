...
public class GuiWinButton extends GuiButton
{
    public int HorizonCode_Horizon_È;
    
    public GuiWinButton(final int buttonId, final int x, final int y, final String buttonText) {
        this(buttonId, x, y, 200, 20, buttonText);
    }
    
    public GuiWinButton(final int buttonId, final int x, final int y, final int widthIn, final int heightIn, final String buttonText) {
    ...
    public void Ý(final Minecraft mc, final int mouseX, final int mouseY) {
        if (this.ˆà) {
            ...
            GuiUtils.HorizonCode_Horizon_È().HorizonCode_Horizon_È(this.ˆÏ­ + this.HorizonCode_Horizon_È, this.£á, this.ˆÏ­ + this.ÂµÈ - this.HorizonCode_Horizon_È, (float)(this.£á + this.á), -7453523);
