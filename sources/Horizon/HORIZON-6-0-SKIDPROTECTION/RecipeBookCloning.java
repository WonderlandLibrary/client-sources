...
{
    private static final String HorizonCode_Horizon_È = "CL_00000081";
    ...
    public boolean HorizonCode_Horizon_È(final InventoryCrafting p_77569_1_, final World worldIn) {
        ...
        for (int var5 = 0; var5 < p_77569_1_.áŒŠÆ(); ++var5) {
            ...
            if (var6 != null) {
                if (var6.HorizonCode_Horizon_È() == Items.ÇŽÊ) {
                    if (var4 != null) {
                        return false;
                    }
                    var4 = var6;
                    ...
                    if (var6.HorizonCode_Horizon_È() != Items.ŒÓ) {
                        return false;
                    }
                    ++var3;
                }
    ...
    public ItemStack HorizonCode_Horizon_È(final InventoryCrafting p_77572_1_) {
        ...
        for (int var4 = 0; var4 < p_77572_1_.áŒŠÆ(); ++var4) {
            ...
            if (var5 != null) {
                if (var5.HorizonCode_Horizon_È() == Items.ÇŽÊ) {
                    if (var3 != null) {
                        return null;
                    }
                    var3 = var5;
                    ...
                    if (var5.HorizonCode_Horizon_È() != Items.ŒÓ) {
                        return null;
                    }
                    ++var2;
                }
        ...
        if (var3 != null && var2 >= 1 && ItemEditableBook.ÂµÈ(var3) < 2) {
            final ItemStack var6 = new ItemStack(Items.ÇŽÊ, var2);
            var6.Ø­áŒŠá((NBTTagCompound)var3.Å().Â());
            var6.Å().HorizonCode_Horizon_È("generation", ItemEditableBook.ÂµÈ(var3) + 1);
            if (var3.¥Æ()) {
    ...
    public ItemStack[] Â(final InventoryCrafting p_179532_1_) {
        ...
        for (int var3 = 0; var3 < var2.length; ++var3) {
            ...
            if (var4 != null && var4.HorizonCode_Horizon_È() instanceof ItemEditableBook) {
                var2[var3] = var4;
                break;
            }
        }
