...
public class GuiWinFlatField extends GuiTextField
{
    public GuiWinFlatField(final int p_i45542_1_, final FontRenderer p_i45542_2_, final int p_i45542_3_, final int p_i45542_4_, final int p_i45542_5_, final int p_i45542_6_) {
    ...
    public void HorizonCode_Horizon_È() {
        if (this.£á()) {
            if (this.áˆºÑ¢Õ()) {
                Gui_1808253012.HorizonCode_Horizon_È(this.Ø­áŒŠá - 1, this.Âµá€ + this.à - 1, this.Ø­áŒŠá + this.Ó + 0, this.Âµá€ + this.à - 18, -1);
            }
