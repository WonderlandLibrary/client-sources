...
public class ModelBoat extends ModelBase
{
    ...
    private static final String Â = "CL_00000832";
    
    public ModelBoat() {
        (this.HorizonCode_Horizon_È = new ModelRenderer[5])[0] = new ModelRenderer(this, 0, 8);
        ...
        final byte var3 = 20;
        final byte var4 = 4;
        this.HorizonCode_Horizon_È[0].HorizonCode_Horizon_È(-var1 / 2, -var3 / 2 + 2, -3.0f, var1, var3 - 4, 4, 0.0f);
