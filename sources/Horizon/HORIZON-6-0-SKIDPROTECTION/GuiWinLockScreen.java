...
public class GuiWinLockScreen extends GuiScreen
{
    ...
    public void HorizonCode_Horizon_È() {
        this.ÇŽÉ.add(new GuiWinButton(0, GuiWinLockScreen.Çªà¢ / 2 + 85, GuiWinLockScreen.Ê / 2 + 4, 13, 13, "»"));
        this.HorizonCode_Horizon_È = new GuiWinFlatField(88, this.É, GuiWinLockScreen.Çªà¢ / 2 - 30, GuiWinLockScreen.Ê / 2 - 20, 130, 20);
        this.Â = new GuiWinPasswordField(this.É, GuiWinLockScreen.Çªà¢ / 2 - 30, GuiWinLockScreen.Ê / 2 + 0, 130, 20);
    }
    ...
    protected void HorizonCode_Horizon_È(final GuiButton button) throws IOException {
        switch (button.£à) {
            case 0: {
                GuiWinLockScreen.Ñ¢á.HorizonCode_Horizon_È((GuiScreen)null);
                break;
            }
        }
    }
    ...
    public void HorizonCode_Horizon_È(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.Ý <= -GuiWinLockScreen.Çªà¢ - 85) {
            this.Âµá€ = false;
            this.Ó = true;
            this.Ý = -GuiWinLockScreen.Çªà¢ - 85;
        }
        ...
        final ScaledResolution scaledRes = new ScaledResolution(GuiWinLockScreen.Ñ¢á, GuiWinLockScreen.Ñ¢á.Ó, GuiWinLockScreen.Ñ¢á.à);
        this.Ý(-1);
        GuiWinLockScreen.Ñ¢á.¥à().HorizonCode_Horizon_È(GuiWinLockScreen.áˆºÑ¢Õ);
        Gui_1808253012.HorizonCode_Horizon_È(GuiWinLockScreen.Çªà¢ / 2 - 130, GuiWinLockScreen.Ê / 2 - 60, 0.0f, 0.0f, 90, 90, 90, 90, 90.0f, 90.0f);
        Gui_1808253012.Â(UIFonts.Å, Horizon.É, GuiWinLockScreen.Çªà¢ / 2 - 32, GuiWinLockScreen.Ê / 2 - 60, -1);
        this.HorizonCode_Horizon_È.HorizonCode_Horizon_È(Horizon.É);
        this.HorizonCode_Horizon_È.Ý(false);
        ...
        GuiWinLockScreen.Ñ¢á.¥à().HorizonCode_Horizon_È(GuiWinLockScreen.áŒŠÆ);
        ...
        Gui_1808253012.Â(UIFonts.¥Æ, Utils.Â(), 9, GuiWinLockScreen.Ê - 90 + this.Ý, -1);
        Gui_1808253012.Â(UIFonts.µà, Utils.Ý(), 12, GuiWinLockScreen.Ê - 40 + this.Ý, -1);
    }
