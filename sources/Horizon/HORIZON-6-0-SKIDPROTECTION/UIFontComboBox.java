...
public class UIFontComboBox extends Item
{
    private List<String> HorizonCode_Horizon_È;
    private boolean à;
    
    public UIFontComboBox(final List<String> modes) {
        ...
        if (this.à) {
            ...
            for (final String x : this.HorizonCode_Horizon_È) {
                ...
                if (Horizon.à.equalsIgnoreCase("Arial")) {
                    ...
                    UIFonts.µà.HorizonCode_Horizon_È(tt3, this.Â(), this.Ý() + 3 - 3 + top, -1249039);
                }
                else if (Horizon.à.equalsIgnoreCase("Helvetica")) {
