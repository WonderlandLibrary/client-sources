package me.teus.eclipse.alt.microsoft;

import me.teus.eclipse.alt.SessionChanger;
...
public class GuiLoginMicrosoft extends GuiScreen {
    ...
    public void drawScreen(final int x2, final int y2, final float z2) {
        ...
        FontLoaders.tenacityBold21.drawString("Email & Password", (int)(this.width / 2), (int)(sr.getScaledHeight() / 2 - 65), -1);
