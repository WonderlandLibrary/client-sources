...
import me.teus.eclipse.events.player.*;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        {
            Client.getInstance().eventProtocol.call(new EventPreUpdate());
            ...
            Client.getInstance().eventProtocol.call(new EventPostUpdate());
        }
    }
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        Client.getInstance().eventProtocol.call(event);
    ...
    {
        EventChat chatEvent = new EventChat(message);
        Client.getInstance().eventProtocol.call(chatEvent);
