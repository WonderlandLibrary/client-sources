...
public class Gui
{
     ...
     */
    public static void drawRect(int left, double offset, int right, double d, int color)
    {
        if (left < right)
        {
            int i = left;
     ...
     */
    public void drawCenteredString(FontRenderer fontRendererIn, String text, float f, int y, int color)
    {
        fontRendererIn.drawStringWithShadow(text, (float)(f - fontRendererIn.getStringWidth(text) / 2), (float)y, color);
    }
