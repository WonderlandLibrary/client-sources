...
public class Value<T> {
    ...
    public Value(String classname, String modeTitle, int current) {
        ...
        this.name = String.valueOf(String.valueOf(classname)) + "_" + "Mode";
    ...
    public String getModeAt(String modeName) {
        int i2 = 0;
        while (i2 < this.mode.size()) {
            if (this.mode.get(i2).equalsIgnoreCase(modeName)) {
                return this.mode.get(i2);
            }
            ++i2;
        }
        return "NULL";
    ...
    public String getAllModes() {
        ...
        int i2 = 0;
        while (i2 < this.mode.size()) {
            all2 = String.valueOf(String.valueOf(all2)) + this.mode.get(i2).toString();
            ++i2;
        }
        return all2;
    }
