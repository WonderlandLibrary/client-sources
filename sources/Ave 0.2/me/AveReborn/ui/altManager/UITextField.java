   ...
   public void drawTextBox() {
      if(this.getVisible()) {
         if(this.getEnableBackgroundDrawing()) {
            drawBorderedRect((float)this.xPosition, (float)this.yPosition, (float)(this.xPosition + this.width), (float)(this.yPosition + this.height), 0.7F, this.isFocused?Colors.DARKBLUE.c:Colors.GREY.c, 0);
         }
         ...
         if(s.length() > 0) {
            ...
            j1 = (int)this.fontRendererInstance.drawString(flag2, (float)l, (float)i1, -1);
         }
         ...
         if(s.length() > 0 && flag && j < s.length()) {
            var10000 = (int)this.fontRendererInstance.drawString(s.substring(j), (float)j1, (float)i1, -1);
         }
         ...
         if(flag1) {
            if(var13) {
               ...
               this.fontRendererInstance.drawString("_", (float)k1, (float)i1, -1);
            }
         }

         if(k != j) {
            int l1 = l + this.fontRendererInstance.getStringWidth(s.substring(0, k));
            drawRect(k1, i1 - 1, l1 - 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, ClientUtil.reAlpha(Colors.DARKBLUE.c, 0.3F));
         }
      }
...
public void setValidator(Predicate<String> field_181032_r) {
	// TODO 自动生成的方法存根
