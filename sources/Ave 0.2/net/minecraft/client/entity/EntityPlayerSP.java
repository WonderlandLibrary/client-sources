...
import me.AveReborn.events.UpdateEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer {
   ...
   public void onUpdateWalkingPlayer() {
      ...
      if(pre.cancel) {
         EventPostMotion var16 = new EventPostMotion();
         EventManager.call(var16);
      } else {
         ...
         if(this.isCurrentViewEntity()) {
            double post = this.posX - this.lastReportedPosX;
            ...
            boolean flag2 = post * post + d1 * d1 + d2 * d2 > 9.0E-4D || this.positionUpdateTicks >= 20;
         ...
         EventPostMotion var17 = new EventPostMotion();
         EventManager.call(var17);
      }
   }
   ...
   public void onLivingUpdate() {
      ...
      if(this.isUsingItem() && !this.isRiding()) {
         double flag3 = ModManager.getModByName("NoSlowdown").isEnabled()?NoSlow.getSlowness():0.2D;
         this.movementInput.moveStrafe = (float)((double)this.movementInput.moveStrafe * flag3);
         this.movementInput.moveForward = (float)((double)this.movementInput.moveForward * flag3);
      ...
      if(this.onGround && !flag1 && !flag2 && this.movementInput.moveForward >= f && !this.isSprinting() && var7 && !this.isUsingItem() && !this.isPotionActive(Potion.blindness)) {
      ...
      if(!this.isSprinting() && this.movementInput.moveForward >= f && var7 && !this.isUsingItem() && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindSprint.isKeyDown()) {
         this.setSprinting(true);
      }

      if(this.isSprinting() && (this.movementInput.moveForward < f || this.isCollidedHorizontally || !var7)) {
         this.setSprinting(false);
      }
