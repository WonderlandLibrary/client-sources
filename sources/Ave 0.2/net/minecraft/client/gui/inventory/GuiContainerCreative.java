...
public class GuiContainerCreative extends InventoryEffectRenderer {
   ...
   protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType) {
      ...
      if(slotIn == null && selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && clickType != 5) {
         ...
         if(var11.getItemStack() != null) {
            ...
            if(clickedButton == 1) {
               itemstack1 = var11.getItemStack().splitStack(1);
   ...
   private void updateCreativeSearch() {
      ...
      Iterator s1 = Item.itemRegistry.iterator();

      while(s1.hasNext()) {
         Item iterator = (Item)s1.next();
         if(iterator != null && iterator.getCreativeTab() != null) {
            iterator.getSubItems(iterator, (CreativeTabs)null, guicontainercreative$containercreative.itemList);
         }
      }

      Enchantment[] flag = Enchantment.enchantmentsBookList;
      int itemstack = Enchantment.enchantmentsBookList.length;

      for(int var10 = 0; var10 < itemstack; ++var10) {
         Enchantment var8 = flag[var10];
         if(var8 != null && var8.type != null) {
            Items.enchanted_book.getAll(var8, guicontainercreative$containercreative.itemList);
         }
      }

      Iterator var9 = guicontainercreative$containercreative.itemList.iterator();
      ...
      while(var9.hasNext()) {
         ...
         while(var7.hasNext()) {
            ...
            if(EnumChatFormatting.getTextWithoutFormattingCodes(s).toLowerCase().contains(var11)) {
               var13 = true;
               break;
            }
         }
   ...
   protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
      if(mouseButton == 0) {
         ...
         CreativeTabs[] var9 = CreativeTabs.creativeTabArray;
         int var8 = CreativeTabs.creativeTabArray.length;
   ...
   private void setCurrentCreativeTab(CreativeTabs p_147050_1_) {
      ...
      if(p_147050_1_ == CreativeTabs.tabInventory) {
         ...
         for(int j = 0; j < container.inventorySlots.size(); ++j) {
            GuiContainerCreative.CreativeSlot slot = new GuiContainerCreative.CreativeSlot((Slot)container.inventorySlots.get(j), j);
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      CreativeTabs[] var14 = CreativeTabs.creativeTabArray;
      int var13 = CreativeTabs.creativeTabArray.length;

      for(int var12 = 0; var12 < var13; ++var12) {
         CreativeTabs creativetabs = var14[var12];
   ...
   protected void renderToolTip(ItemStack stack, int x, int y) {
      if(selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex()) {
         ...
         if(creativetabs == null && stack.getItem() == Items.enchanted_book) {
            Map i = EnchantmentHelper.getEnchantments(stack);
            if(i.size() == 1) {
               Enchantment enchantment = Enchantment.getEnchantmentById(((Integer)i.keySet().iterator().next()).intValue());
               CreativeTabs[] var11 = CreativeTabs.creativeTabArray;
               int var10 = CreativeTabs.creativeTabArray.length;
         ...
         for(int var12 = 0; var12 < list.size(); ++var12) {
            if(var12 == 0) {
               list.set(var12, stack.getRarity().rarityColor + (String)list.get(var12));
            } else {
               list.set(var12, EnumChatFormatting.GRAY + (String)list.get(var12));
            }
         }
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      int k = CreativeTabs.creativeTabArray.length;

      int j;
      for(j = 0; j < k; ++j) {
         CreativeTabs i = var8[j];
         this.mc.getTextureManager().bindTexture(creativeInventoryTabs);
         if(i.getTabIndex() != selectedTabIndex) {
            this.func_147051_a(i);
         }
      }
      ...
      if(creativetabs.shouldHidePlayerInventory()) {
         this.drawTexturedModalRect(var9, j + (int)((float)(k - j - 17) * this.currentScroll), 232 + (this.needsScrollBars()?0:12), 0, 12, 15);
      }
   ...
   protected boolean func_147049_a(CreativeTabs p_147049_1_, int p_147049_2_, int p_147049_3_) {
      ...
      return p_147049_2_ >= j && p_147049_2_ <= j + 28 && p_147049_3_ >= k1 && p_147049_3_ <= k1 + 32;
   }
   ...
   protected boolean renderCreativeInventoryHoveringText(CreativeTabs p_147052_1_, int p_147052_2_, int p_147052_3_) {
      ...
      if(this.isPointInRegion(j + 3, k1 + 3, 23, 27, p_147052_2_, p_147052_3_)) {
