...
import me.AveReborn.ui.Particle;
import me.AveReborn.ui.altManager.GuiAltManager;
import me.AveReborn.ui.menu.UIMenu;
import me.AveReborn.ui.menu.UIMenuSlot;
import me.AveReborn.ui.partcles.ParticleManager;
import me.AveReborn.ui.partcles.ParticleSnow;
import me.AveReborn.ui.shader.ParticleShader;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
   ...
   public void initGui() {
      ...
      var9.add(new UIMenuSlot("Singleplayer", new GuiSelectWorld(this)));
      var9.add(new UIMenuSlot("Multiplayer", new GuiMultiplayer(this)));
      var9.add(new UIMenuSlot("AltManager", new GuiAltManager(this)));
      var9.add(new UIMenuSlot("Options", new GuiOptions(this, this.mc.gameSettings)));
      var9.add(new UIMenuSlot("Language", new GuiLanguage(this, this.mc.gameSettings, this.mc.getLanguageManager())));
      var9.add(new UIMenuSlot("Quit", (GuiScreen)null));
      particleShader = new ParticleShader();
      this.menu = new UIMenu(var9);
   }
   ...
   private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
      ...
      this.buttonList.add(new GuiButton(23333, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "AltManager"));
   }
      ...
      if(result && id == 12) {
         ...
         if(result) {
            try {
               ...
               throwable.getMethod("browse", new Class[]{URI.class}).invoke(object, new Object[]{new URI(this.openGLWarningLink)});
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      RenderUtil.drawImage(new ResourceLocation("Ave/bg2.png"), (int)this.animationX, 0, res.getScaledWidth(), res.getScaledHeight());
      Iterator xStart = this.particles.iterator();

      while(xStart.hasNext()) {
         Particle font = (Particle)xStart.next();
         font.drawScreen(mouseX, mouseY, res.getScaledHeight());
      }

      UnicodeFontRenderer font1 = Client.fontManager.tahoma60;
      int xStart1 = (int)this.animationX + (this.width - font1.getStringWidth(Client.CLIENT_NAME)) / 2 + 5;
      int yMid = this.height / 2 - 40;
      font1 = Client.fontManager.tahoma70;
      String s = Client.CLIENT_NAME + " v" + Client.CLIENT_VER;
      font1.drawString(s, (float)xStart1 + 20.0F, (float)yMid - (float)font1.FONT_HEIGHT / 1.2F, Colors.BLUE.c);
      Gui.drawRect((float)xStart1, (float)(yMid + 20), (float)xStart1, (float)(yMid + 20) + 0.5F, Colors.GREY.c);
      this.menu.draw(mouseX, mouseY);
      RenderUtil var10001;
      if(this.menu.x == 0.0F) {
         var10001 = RenderUtil.INSTANCE;
         this.animationX = RenderUtil.getAnimationState(this.animationX, 100.0D, (100.0D - this.animationX + 1.0D) * 30.0D);
      } else {
         var10001 = RenderUtil.INSTANCE;
         this.animationX = RenderUtil.getAnimationState(this.animationX, 0.0D, (Math.abs(this.animationX) + 1.0D) * 30.0D);
      }
   ...
   private void do3dEffects(int mouseX, int mouseY, float partialTicks) {
      ...
      int randBig = this.mc.displayWidth * 2;
      int divider = randBig / 2;
      GL11.glBegin(1);
      GL11.glVertex2d((double)(RANDOM.nextInt(randBig) - divider), (double)(RANDOM.nextInt(randBig) - divider));
      GL11.glVertex2d((double)(RANDOM.nextInt(randBig) - divider), (double)(RANDOM.nextInt(randBig) - divider));
      GL11.glEnd();
      float f1 = 0.1F;
      float f2 = 0.5F;
