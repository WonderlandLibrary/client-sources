...
public class EntityRenderer implements IResourceManagerReloadListener {
	...
	public void getMouseOver(float partialTicks)
	   {
	     Entity entity = this.mc.getRenderViewEntity();
	/*      */     
	/*  444 */     if ((entity != null) && (this.mc.theWorld != null))
	/*      */     {
	/*  446 */       this.mc.mcProfiler.startSection("pick");
	/*  447 */       this.mc.pointedEntity = null;
	/*  448 */       double d0 = this.mc.playerController.getBlockReachDistance();
	/*  449 */       this.mc.objectMouseOver = entity.rayTrace(d0, partialTicks);
	/*  450 */       double d1 = d0;
	/*  451 */       Vec3 vec3 = entity.getPositionEyes(partialTicks);
	/*  452 */       boolean flag = false;
	/*  453 */       boolean flag1 = true;
	/*      */       
	/*  455 */       if (this.mc.playerController.extendedReach())
	/*      */       {
	/*  457 */         d0 = 6.0D;
	/*  458 */         d1 = 6.0D;
	/*      */       }
	...
	/*      */       }
	/*      */       
	/*  470 */       if (this.mc.objectMouseOver != null)
	/*      */       {
	/*  472 */         d1 = this.mc.objectMouseOver.hitVec.distanceTo(vec3);
	/*      */       }
	/*      */       
	/*  475 */       Vec3 vec31 = entity.getLook(partialTicks);
	/*  476 */       Vec3 vec32 = vec3.addVector(vec31.xCoord * d0, vec31.yCoord * d0, vec31.zCoord * d0);
	/*  477 */       this.pointedEntity = null;
	/*  478 */       Vec3 vec33 = null;
	/*  479 */       float f = 1.0F;
	/*  480 */       List list = this.mc.theWorld.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().addCoord(vec31.xCoord * d0, vec31.yCoord * d0, vec31.zCoord * d0).expand(f, f, f), Predicates.and(net.minecraft.util.EntitySelectors.NOT_SPECTATING, new EntityRenderer1(this)));
	/*  481 */       double d2 = d1;
	/*      */       
	/*  483 */       for (int i = 0; i < list.size(); i++)
	/*      */       {
	/*  485 */         Entity entity1 = (Entity)list.get(i);
	/*  486 */         float f1 = entity1.getCollisionBorderSize();
	/*  487 */         AxisAlignedBB axisalignedbb = entity1.getEntityBoundingBox().expand(f1, f1, f1);
	/*  488 */         MovingObjectPosition movingobjectposition = axisalignedbb.calculateIntercept(vec3, vec32);
	/*      */         
	/*  490 */         if (axisalignedbb.isVecInside(vec3))
	/*      */         {
	/*  492 */           if (d2 >= 0.0D)
	/*      */           {
	/*  494 */             this.pointedEntity = entity1;
	/*  495 */             vec33 = movingobjectposition == null ? vec3 : movingobjectposition.hitVec;
	/*  496 */             d2 = 0.0D;
	/*      */           }
	/*      */         }
	/*  499 */         else if (movingobjectposition != null)
	/*      */         {
	/*  501 */           double d3 = vec3.distanceTo(movingobjectposition.hitVec);
	/*      */           
	/*  503 */           if ((d3 < d2) || (d2 == 0.0D))
	/*      */           {
	/*  505 */             boolean flag2 = false;
	/*      */             
	/*  507 */             if (Reflector.ForgeEntity_canRiderInteract.exists())
	/*      */             {
	/*  509 */               flag2 = Reflector.callBoolean(entity1, Reflector.ForgeEntity_canRiderInteract, new Object[0]);
	/*      */             }
	/*      */             
	/*  512 */             if ((entity1 == entity.ridingEntity) && (!flag2))
	/*      */             {
	/*  514 */               if (d2 == 0.0D)
	/*      */               {
	/*  516 */                 this.pointedEntity = entity1;
	/*  517 */                 vec33 = movingobjectposition.hitVec;
	/*      */               }
	/*      */             }
	/*      */             else
	/*      */             {
	/*  522 */               this.pointedEntity = entity1;
	/*  523 */               vec33 = movingobjectposition.hitVec;
	/*  524 */               d2 = d3;
	/*      */             }
	/*      */           }
	/*      */         }
	/*      */       }
	/*      */       
	/*  530 */       if ((this.pointedEntity != null) && (flag) && (vec3.distanceTo(vec33) > 3.0D))
	/*      */       {
	/*  532 */         this.pointedEntity = null;
	...
	private void hurtCameraEffect(float partialTicks) {
		  if(this.mc.getRenderViewEntity() instanceof EntityLivingBase && !ModManager.getModByName("NoHurtcam").isEnabled()) {
	...
	private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
		...
		EventRender eventRender1 = new EventRender(partialTicks);
		EventManager.call(eventRender1);
