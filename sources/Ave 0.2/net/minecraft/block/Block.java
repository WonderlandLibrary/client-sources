...
import me.AveReborn.events.EventBlockBB;
...
public class Block
{
    ...
    {
        EventBlockBB event = new EventBlockBB();
        event.setBlock(state.getBlock(), this.getCollisionBoundingBox(worldIn, pos, state), pos.getX(), pos.getY(), pos.getZ());
