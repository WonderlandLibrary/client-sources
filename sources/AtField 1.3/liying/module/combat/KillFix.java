...
extends Module {
    private int ticks;
    private final FloatValue AirRange;
    ...
    private final FloatValue GroundRange;
    private final BoolValue Debug;

    public KillFix() {
        this.AirRange = new FloatValue("AirRange", 3.0f, 0.0f, 5.0f);
        this.GroundRange = new FloatValue("GroundRange", 3.5f, 0.0f, 5.0f);
    ...
    public final void onUpdate(UpdateEvent updateEvent) {
        ...
        if (this.ticks == 1) {
            ...
            KillAura killAura2 = (KillAura)module;
            killAura2.getHurtTimeValue().set(this.hurttime.get());
            if (((Boolean)this.Debug.get()).booleanValue()) {
        ...
        if (this.ticks == 2) {
            ...
            killAura3.getHurtTimeValue().set(this.hurttime2.get());
            if (((Boolean)this.Debug.get()).booleanValue()) {
