...
extends Style {
    ...
    public void drawDescription(int n, int n2, String string) {
        int n3 = Fonts.font35.getStringWidth(string);
        RenderUtils.drawBorderedRect(n + 9, n2, n + n3 + 14, n2 + Fonts.font35.getFontHeight() + 3, 1.0f, new Color(255, 255, 255, 89).getRGB(), Integer.MIN_VALUE);
        GlStateManager.func_179117_G();
        Fonts.font35.drawString(string, n + 12, n2 + Fonts.font35.getFontHeight() / 2, Integer.MAX_VALUE);
    }
    ...
    public void drawModuleElement(int n, int n2, ModuleElement moduleElement) {
        ...
        GlStateManager.func_179117_G();
        Fonts.font35.drawString(moduleElement.getDisplayName(), (int)((float)moduleElement.getX() - ((float)Fonts.font35.getStringWidth(moduleElement.getDisplayName()) - 100.0f) / 2.0f), moduleElement.getY() + 6, moduleElement.getModule().getState() ? n3 : Integer.MAX_VALUE);
            ...
            if (moduleElement.isShowSettings()) {
                ...
                for (Value value : list) {
                    ...
                    if (value instanceof BoolValue) {
                        ...
                        f = Fonts.font35.getStringWidth((String)object4);
                        ...
                        GlStateManager.func_179117_G();
                        Fonts.font35.drawString((String)object4, moduleElement.getX() + moduleElement.getWidth() + 6, n4 + 4, (Boolean)((BoolValue)value).get() != false ? n3 : Integer.MAX_VALUE);
                        n4 += 12;
                    } else if (value instanceof ListValue) {
                        object4 = (ListValue)value;
                        String string = value.getName();
                        float f2 = Fonts.font35.getStringWidth(string);
                        if (moduleElement.getSettingsWidth() < f2 + 16.0f) {
                            moduleElement.setSettingsWidth(f2 + 16.0f);
                        }
                        RenderUtils.drawRect((float)(moduleElement.getX() + moduleElement.getWidth() + 4), (float)(n4 + 2), (float)(moduleElement.getX() + moduleElement.getWidth()) + moduleElement.getSettingsWidth(), (float)(n4 + 14), Integer.MIN_VALUE);
                        GlStateManager.func_179117_G();
                        Fonts.font35.drawString("\u00a7c" + string, moduleElement.getX() + moduleElement.getWidth() + 6, n4 + 4, 0xFFFFFF);
                        Fonts.font35.drawString(((ListValue)object4).openList ? "-" : "+", (int)((float)(moduleElement.getX() + moduleElement.getWidth()) + moduleElement.getSettingsWidth() - (float)(((ListValue)object4).openList ? 5 : 6)), n4 + 4, 0xFFFFFF);
                        if (n >= moduleElement.getX() + moduleElement.getWidth() + 4 && (float)n <= (float)(moduleElement.getX() + moduleElement.getWidth()) + moduleElement.getSettingsWidth() && n2 >= n4 + 2 && n2 <= n4 + 14 && Mouse.isButtonDown((int)0) && moduleElement.isntPressed()) {
                        ...
                        for (n5 = 0; n5 < n6; ++n5) {
                            object = object2[n5];
                            float f3 = Fonts.font35.getStringWidth(">" + (String)object);
                            if (moduleElement.getSettingsWidth() < f3 + 8.0f) {
                                moduleElement.setSettingsWidth(f3 + 8.0f);
                            }
                            ...
                            GlStateManager.func_179117_G();
                            Fonts.font35.drawString(">", moduleElement.getX() + moduleElement.getWidth() + 6, n4 + 4, Integer.MAX_VALUE);
                            Fonts.font35.drawString((String)object, moduleElement.getX() + moduleElement.getWidth() + 14, n4 + 4, ((Value)object4).get() != null && ((String)((Value)object4).get()).equalsIgnoreCase((String)object) ? n3 : Integer.MAX_VALUE);
                            n4 += 12;
                        }
                    } else if (value instanceof FloatValue) {
                        object4 = (FloatValue)value;
                        String string = value.getName() + "\u00a7f: \u00a7c" + this.round(((Float)((Value)object4).get()).floatValue());
                        float f4 = Fonts.font35.getStringWidth(string);
                        ...
                        GlStateManager.func_179117_G();
                        Fonts.font35.drawString(string, moduleElement.getX() + moduleElement.getWidth() + 6, n4 + 4, 0xFFFFFF);
                        n4 += 22;
                        ...
                        float f6 = Fonts.font35.getStringWidth(string);
                        ...
                        Fonts.font35.drawString((String)object3, moduleElement.getX() + moduleElement.getWidth() + 6, n4 + 4, Color.WHITE.getRGB());
                        int n7 = Fonts.font35.getStringWidth((String)object3);
                        ...
                        RenderUtils.drawRect((float)(moduleElement.getX() + moduleElement.getWidth() + 4), (float)(n4 + 2), (float)(moduleElement.getX() + moduleElement.getWidth()) + moduleElement.getSettingsWidth(), (float)(n4 + 14), Integer.MIN_VALUE);
                        GlStateManager.func_179117_G();
                        Fonts.font35.drawString((String)object4, moduleElement.getX() + moduleElement.getWidth() + 6, n4 + 4, 0xFFFFFF);
                        n4 += 12;
                    }
                    if (!bl) continue;
    ...
    public void drawPanel(int n, int n2, Panel panel) {
        RenderUtils.drawBorderedRect(panel.getX(), (float)panel.getY() - 3.0f, (float)panel.getX() + (float)panel.getWidth(), (float)panel.getY() + 17.0f, 3.0f, new Color(97, 95, 95, 34).getRGB(), new Color(20, 20, 20, 174).getRGB());
        float f = Fonts.font35.getStringWidth("\u00a7f" + StringUtils.func_76338_a((String)panel.getName()));
        Fonts.font35.drawString("\u00a7f" + panel.getName(), (int)((float)panel.getX() - (f - 100.0f) / 2.0f), panel.getY() + 7, -16777216);
        if (panel.getScrollbar() && panel.getFade() > 0) {
            ...
            RenderUtils.drawRect((float)(panel.getX() - 2), (float)(panel.getY() + 30) + ((float)panel.getFade() - 24.0f) / (float)(panel.getElements().size() - (Integer)((ClickGUI)Objects.requireNonNull(LiquidBounce.moduleManager.getModule(ClickGUI.class))).maxElementsValue.get()) * (float)panel.getDragged() - 10.0f, (float)panel.getX(), (float)(panel.getY() + 40) + ((float)panel.getFade() - 24.0f) / (float)(panel.getElements().size() - (Integer)((ClickGUI)Objects.requireNonNull(LiquidBounce.moduleManager.getModule(ClickGUI.class))).maxElementsValue.get()) * (float)panel.getDragged(), Integer.MIN_VALUE);
            RenderUtils.drawBorderedRect(panel.getX(), (float)panel.getY() + 17.0f, (float)panel.getX() + (float)panel.getWidth(), panel.getY() + 19 + panel.getFade(), 3.0f, new Color(33, 33, 33, 65).getRGB(), new Color(29, 29, 29, 86).getRGB());
            RenderUtils.drawBorderedRect(panel.getX(), panel.getY() + 17 + panel.getFade(), (float)panel.getX() + (float)panel.getWidth(), panel.getY() + 19 + panel.getFade() + 5, 3.0f, new Color(47, 46, 46, 0).getRGB(), new Color(20, 20, 20, 0).getRGB());
        }
    }
