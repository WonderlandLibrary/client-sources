...
public interface IWorld {
    ...
    @NotNull
    public Collection getCollisionBoxes(@NotNull IAxisAlignedBB var1);
    ...
    @NotNull
    public Collection getEntitiesWithinAABBExcludingEntity(@Nullable IEntity var1, @NotNull IAxisAlignedBB var2);
    ...
    @NotNull
    public Collection getEntitiesInAABBexcluding(@Nullable IEntity var1, @NotNull IAxisAlignedBB var2, @NotNull Function1 var3);

    @NotNull
    public IIBlockState getBlockState(@NotNull WBlockPos var1);

    @NotNull
    public Collection getCollidingBoundingBoxes(@NotNull IEntity var1, @NotNull IAxisAlignedBB var2);
}
