...
extends Module {
    ...
    public final void onUpdate(UpdateEvent updateEvent) {
        ...
        iKeyBinding.setPressed(iWorldClient.getBlockState(new WBlockPos(iEntityPlayerSP2.getPosX(), iEntityPlayerSP2.getPosY() - 1.0, iEntityPlayerSP2.getPosZ())).getBlock().equals(MinecraftInstance.classProvider.getBlockEnum(BlockType.AIR)));
    }
}
