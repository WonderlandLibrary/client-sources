...
extends Module {
    ...
    public final void onUpdate(UpdateEvent updateEvent) {
        ...
        block6: {
            block5: {
                IEntityPlayerSP iEntityPlayerSP2 = iEntityPlayerSP = MinecraftInstance.mc.getThePlayer();
                if ((iEntityPlayerSP2 != null ? iEntityPlayerSP2.getHeldItem() : null) == null) break block5;
        ...
        IEntity iEntity = iEntityPlayerSP.getFishEntity();
        if (this.rodOutTimer.hasTimePassed(500L) && iEntity == null || iEntity != null && iEntity.getMotionX() == 0.0 && iEntity.getMotionZ() == 0.0 && iEntity.getMotionY() != 0.0) {
