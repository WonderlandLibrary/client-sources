...
extends MinecraftInstance {
    private static final ShaderUtil gradientMaskShader = new ShaderUtil("More/shader/fragment/gradientmask.frag");
    private static final ShaderUtil gradientShader = new ShaderUtil("More/shader/fragment/gradient.frag");
    ...
    public static void applyGradientCornerRL(float f, float f2, float f3, float f4, float f5, Color color, Color color2, Runnable runnable) {
        Color color3 = ColorUtil.interpolateColorC(color2, color, 0.5f);
