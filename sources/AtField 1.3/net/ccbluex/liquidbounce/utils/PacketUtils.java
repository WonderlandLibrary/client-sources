...
extends MinecraftInstance {
    ...
    public final boolean handleSendPacket(Packet packet) {
    ...
    public final PacketType getPacketType(Packet packet) {
    ...
    public final void sendPacketNoEvent(Packet packet) {
        packets.add(packet);
