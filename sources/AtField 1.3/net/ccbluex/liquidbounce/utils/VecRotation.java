...
public final class VecRotation {
    ...
    public VecRotation(WVec3 wVec3, Rotation rotation) {
        this.vec = wVec3;
        this.rotation = rotation;
    }

    public static VecRotation copy$default(VecRotation vecRotation, WVec3 wVec3, Rotation rotation, int n, Object object) {
        if ((n & 1) != 0) {
    ...
    public final VecRotation copy(WVec3 wVec3, Rotation rotation) {
        return new VecRotation(wVec3, rotation);
    }
