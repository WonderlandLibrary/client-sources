...
implements ITeam {
    ...
    public boolean equals(@Nullable Object object) {
        return object instanceof TeamImpl && ((TeamImpl)object).wrapped.equals(this.wrapped);
    }
    ...
    public String formatString(String string) {
        return this.wrapped.func_142053_d(string);
    }

    @Override
    public boolean isSameTeam(ITeam iTeam) {
        ITeam iTeam2 = iTeam;
        Team team = this.wrapped;
        boolean bl = false;
        Team team2 = ((TeamImpl)iTeam2).getWrapped();
        return team.func_142054_a(team2);
    }
}
