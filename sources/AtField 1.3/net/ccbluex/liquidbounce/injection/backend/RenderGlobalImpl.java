...
implements IRenderGlobal {
    ...
    public RenderGlobalImpl(RenderGlobal renderGlobal) {
        this.wrapped = renderGlobal;
    }

    public boolean equals(@Nullable Object object) {
        return object instanceof RenderGlobalImpl && ((RenderGlobalImpl)object).wrapped.equals(this.wrapped);
    }
