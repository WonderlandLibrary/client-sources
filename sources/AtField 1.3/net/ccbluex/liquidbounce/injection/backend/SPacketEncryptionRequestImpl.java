...
public final class SPacketEncryptionRequestImpl
extends PacketImpl
implements ISPacketEncryptionRequest {
    ...
    public SPacketEncryptionRequestImpl(SPacketEncryptionRequest sPacketEncryptionRequest) {
        super((Packet)sPacketEncryptionRequest);
    }
}
