...
public class Main {
	...
	public static void main(String[] p_main_0_) {
		...
		ArgumentAcceptingOptionSpec var11 = var1.accepts("username").withRequiredArg().defaultsTo("LunaUser",
				new String[0]);
		...
		PropertyMap var33 = (PropertyMap) (new GsonBuilder()).registerTypeAdapter(PropertyMap.class, new Serializer())
				.create().fromJson((String) var21.valueOf(var17), PropertyMap.class);
		...
		GameConfiguration var42 = new GameConfiguration(new GameConfiguration.UserInformation(var41, var33, var24),
