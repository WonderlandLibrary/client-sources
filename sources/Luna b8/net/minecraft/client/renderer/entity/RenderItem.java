...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void renderItemIntoGUIWithoutGlint(ItemStack p_175042_1_, int p_175042_2_, int p_175042_3_)
    {
      ...
      renderItemWithoutGlint(p_175042_1_, var4);
    ...
    public void renderItemAboveHead(ItemStack stack, int xPosition, int yPosition)
    {
      if (stack != null) {
        try
        {
          renderItemIntoGUIWithoutGlint(stack, xPosition, yPosition);
        }
    ...
    public void renderItemOverlayIntoGUI(FontRenderer p_180453_1_, ItemStack p_180453_2_, int p_180453_3_, int p_180453_4_, String p_180453_5_)
    {
      if (p_180453_2_ != null)
      {
        if ((p_180453_2_.stackSize != 1) || (p_180453_5_ != null))
        {
          ...
          p_180453_1_.drawString(var6, p_180453_3_ + 19 - 2 - p_180453_1_.getStringWidth(var6), p_180453_4_ + 6 + 3, 16777215);
	...
	public void renderItemIntoGUI(ItemStack stack, int x, int i, boolean b) {
		
	}

	public void renderItemOverlays(FontRenderer fontRendererObj, ItemStack stack, int x, int i) {
