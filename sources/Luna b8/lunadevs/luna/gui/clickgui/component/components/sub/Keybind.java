...
public class Keybind extends Component {
	...
	public void renderComponent() {
		...
		Minecraft.getMinecraft().fontRendererObj.drawString(binding ? "Press a key..." : ("Key: " + Keyboard.getKeyName(this.parent.mod.getBind())), (parent.parent.getX() + 7) * 2, (parent.parent.getY() + offset + 2) * 2 + 5, -1);
		GL11.glPopMatrix();
	}
