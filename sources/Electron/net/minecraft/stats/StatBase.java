...
public class StatBase {
    ...
    public static IStatType simpleStatType = p_75843_1_ -> StatBase.numberFormat.format(p_75843_1_);
    private static final DecimalFormat decimalFormat = new DecimalFormat("########0.00");
    public static IStatType timeStatType = p_75843_1_ -> {
    ...
    public static IStatType distanceStatType = p_75843_1_ -> {
    ...
    public static IStatType field_111202_k = p_75843_1_ -> StatBase.decimalFormat.format((double) p_75843_1_ * 0.1D);
