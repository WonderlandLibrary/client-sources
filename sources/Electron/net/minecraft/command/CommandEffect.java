            ...
            if (args[1].equals("clear")) {
                ...
                if (i >= 0 && i < Potion.potionTypes.length && Potion.potionTypes[i] != null) {
                    ...
                    if (l > 0) {
                        ...
                        notifyOperators(sender, this, "commands.effect.success", new ChatComponentTranslation(potioneffect.getEffectName()), Integer.valueOf(i), Integer.valueOf(k), entitylivingbase.getName(), l);
