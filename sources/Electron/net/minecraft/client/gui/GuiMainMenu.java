...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if ((double) this.updateCounter < 1.0E-4D) {
            this.drawTexturedModalRect(i, b0, 0, 0, 99, 44);
            this.drawTexturedModalRect(i + 99, b0, 129, 0, 27, 44);
            this.drawTexturedModalRect(i + 99 + 26, b0, 126, 0, 3, 44);
            this.drawTexturedModalRect(i + 99 + 26 + 3, b0, 99, 0, 26, 44);
            this.drawTexturedModalRect(i + 155, b0, 0, 45, 155, 44);
        } else {
            this.drawTexturedModalRect(i, b0, 0, 0, 155, 44);
            this.drawTexturedModalRect(i + 155, b0, 0, 45, 155, 44);
        }
