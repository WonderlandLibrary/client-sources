...
public enum ModelRotation implements IModelState, ITransformation {
    ...
    ModelRotation(String p_i14_3_, int p_i14_4_, int p_i14_5_, int p_i14_6_) {
        this.combinedXY = combineXY(p_i14_5_, p_i14_6_);
        this.matrix4d = new Matrix4f();
        Matrix4f matrix4f = new Matrix4f();
        matrix4f.setIdentity();
        Matrix4f.rotate((float) (-p_i14_5_) * 0.017453292F, new Vector3f(1.0F, 0.0F, 0.0F), matrix4f, matrix4f);
        this.quartersX = MathHelper.abs_int(p_i14_5_ / 90);
        Matrix4f matrix4f1 = new Matrix4f();
        matrix4f1.setIdentity();
        Matrix4f.rotate((float) (-p_i14_6_) * 0.017453292F, new Vector3f(0.0F, 1.0F, 0.0F), matrix4f1, matrix4f1);
        this.quartersY = MathHelper.abs_int(p_i14_6_ / 90);
    ...
    public net.optifine.util.Matrix4f getMatrix() {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (net.optifine.util.Matrix4f) Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[]{this}) : new net.optifine.util.Matrix4f(this.getMatrix4d());
    }
