...
public class BlockModelRenderer {
    ...
    private void renderModelStandardQuads(IBlockAccess p_renderModelStandardQuads_1_, Block p_renderModelStandardQuads_2_, BlockPos p_renderModelStandardQuads_3_, EnumFacing p_renderModelStandardQuads_4_, int p_renderModelStandardQuads_5_, boolean p_renderModelStandardQuads_6_, WorldRenderer p_renderModelStandardQuads_7_, List<BakedQuad> p_renderModelStandardQuads_8_, RenderEnv p_renderModelStandardQuads_9_) {
    ...
    public enum EnumNeighborInfo {
        ...
        EnumNeighborInfo(String p_i7_3_, int p_i7_4_, EnumFacing[] p_i7_5_, float p_i7_6_, boolean p_i7_7_, BlockModelRenderer.Orientation[] p_i7_8_, BlockModelRenderer.Orientation[] p_i7_9_, BlockModelRenderer.Orientation[] p_i7_10_, BlockModelRenderer.Orientation[] p_i7_11_) {
    ...
    public enum Orientation {
        ...
        Orientation(String p_i9_3_, int p_i9_4_, EnumFacing p_i9_5_, boolean p_i9_6_) {
    ...
    enum VertexTranslations {
        ...
        VertexTranslations(String p_i8_3_, int p_i8_4_, int p_i8_5_, int p_i8_6_, int p_i8_7_, int p_i8_8_) {
