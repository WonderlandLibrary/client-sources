...
public class GlStateManager {
    ...
    public static void getBlendState(GlBlendState p_getBlendState_0_) {
        p_getBlendState_0_.enabled = blendState.field_179213_a.currentState;
    ...
    public static void setBlendState(GlBlendState p_setBlendState_0_) {
        blendState.field_179213_a.setState(p_setBlendState_0_.enabled);
    ...
    public enum TexGen {
        ...
        TexGen(String p_i4_3_, int p_i4_4_) {
        }
    }
