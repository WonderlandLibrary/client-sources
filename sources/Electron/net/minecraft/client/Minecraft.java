...
import io.github.liticane.electron.event.impl.minecraft.game.TickEvent;
import io.github.liticane.electron.event.impl.minecraft.player.ClickEvent;
import io.github.liticane.electron.event.impl.minecraft.game.KeyboardEvent;
...
public class Minecraft implements IThreadListener {
    ...
    private void runGameLoop() throws IOException {
        ...
        for (int j = 0; j < this.timer.elapsedTicks; ++j) {
            ...
            Electron.getInstance().getEventBus().publish(new TickEvent());
        }
        ...
        if (this.currentScreen != null) {
            ...
            if (this.currentScreen != null) {
                try {
                    ...
                    reportCategory.addCrashSectionCallable("Screen name", () -> Minecraft.this.currentScreen.getClass().getCanonicalName());
                    throw new ReportedException(crashReport);
                }
            }
        }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            while (Mouse.next()) {
                ...
                if (Mouse.getEventButtonState()) {
                    if (this.thePlayer.isSpectator() && button == 2) {
                ...
                long elapsed = getSystemTime() - this.systemTime;
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        // FINE ME :: KEYBOARD EVENT
                        KeyboardEvent keyboardEvent = new KeyboardEvent(key);
                        Electron.getInstance().getEventBus().publish(keyboardEvent);
            ...
            Electron.getInstance().getEventBus().publish(new ClickEvent());
