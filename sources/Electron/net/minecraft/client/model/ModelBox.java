...
public class ModelBox {
    ...
    public ModelBox(ModelRenderer p_i2_1_, int[][] p_i2_2_, float p_i2_3_, float p_i2_4_, float p_i2_5_, float p_i2_6_, float p_i2_7_, float p_i2_8_, float p_i2_9_, boolean p_i2_10_) {
        this.posX1 = p_i2_3_;
        this.posY1 = p_i2_4_;
        this.posZ1 = p_i2_5_;
        this.posX2 = p_i2_3_ + p_i2_6_;
        this.posY2 = p_i2_4_ + p_i2_7_;
        this.posZ2 = p_i2_5_ + p_i2_8_;
        this.vertexPositions = new PositionTextureVertex[8];
        this.quadList = new TexturedQuad[6];
        float f = p_i2_3_ + p_i2_6_;
        float f1 = p_i2_4_ + p_i2_7_;
        float f2 = p_i2_5_ + p_i2_8_;
        p_i2_3_ = p_i2_3_ - p_i2_9_;
        p_i2_4_ = p_i2_4_ - p_i2_9_;
        p_i2_5_ = p_i2_5_ - p_i2_9_;
        f = f + p_i2_9_;
        f1 = f1 + p_i2_9_;
        f2 = f2 + p_i2_9_;
        ...
        PositionTextureVertex positiontexturevertex7 = new PositionTextureVertex(p_i2_3_, p_i2_4_, p_i2_5_, 0.0F, 0.0F);
        PositionTextureVertex positiontexturevertex = new PositionTextureVertex(f, p_i2_4_, p_i2_5_, 0.0F, 8.0F);
        PositionTextureVertex positiontexturevertex1 = new PositionTextureVertex(f, f1, p_i2_5_, 8.0F, 8.0F);
        PositionTextureVertex positiontexturevertex2 = new PositionTextureVertex(p_i2_3_, f1, p_i2_5_, 8.0F, 0.0F);
        PositionTextureVertex positiontexturevertex3 = new PositionTextureVertex(p_i2_3_, p_i2_4_, f2, 0.0F, 0.0F);
        PositionTextureVertex positiontexturevertex4 = new PositionTextureVertex(f, p_i2_4_, f2, 0.0F, 8.0F);
        PositionTextureVertex positiontexturevertex5 = new PositionTextureVertex(f, f1, f2, 8.0F, 8.0F);
        PositionTextureVertex positiontexturevertex6 = new PositionTextureVertex(p_i2_3_, f1, f2, 8.0F, 0.0F);
        ...
        this.quadList[0] = this.makeTexturedQuad(new PositionTextureVertex[]{positiontexturevertex4, positiontexturevertex, positiontexturevertex1, positiontexturevertex5}, p_i2_2_[4], false, p_i2_1_.textureWidth, p_i2_1_.textureHeight);
        this.quadList[1] = this.makeTexturedQuad(new PositionTextureVertex[]{positiontexturevertex7, positiontexturevertex3, positiontexturevertex6, positiontexturevertex2}, p_i2_2_[5], false, p_i2_1_.textureWidth, p_i2_1_.textureHeight);
        this.quadList[2] = this.makeTexturedQuad(new PositionTextureVertex[]{positiontexturevertex4, positiontexturevertex3, positiontexturevertex7, positiontexturevertex}, p_i2_2_[1], true, p_i2_1_.textureWidth, p_i2_1_.textureHeight);
        this.quadList[3] = this.makeTexturedQuad(new PositionTextureVertex[]{positiontexturevertex1, positiontexturevertex2, positiontexturevertex6, positiontexturevertex5}, p_i2_2_[0], true, p_i2_1_.textureWidth, p_i2_1_.textureHeight);
        this.quadList[4] = this.makeTexturedQuad(new PositionTextureVertex[]{positiontexturevertex, positiontexturevertex7, positiontexturevertex2, positiontexturevertex1}, p_i2_2_[2], false, p_i2_1_.textureWidth, p_i2_1_.textureHeight);
        this.quadList[5] = this.makeTexturedQuad(new PositionTextureVertex[]{positiontexturevertex3, positiontexturevertex4, positiontexturevertex5, positiontexturevertex6}, p_i2_2_[3], false, p_i2_1_.textureWidth, p_i2_1_.textureHeight);
