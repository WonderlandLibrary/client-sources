...
public class SmartLeaves {
    ...
    public static boolean isSameLeaves(IBlockState p_isSameLeaves_0_, IBlockState p_isSameLeaves_1_) {
        if (p_isSameLeaves_0_ == p_isSameLeaves_1_) {
            ...
            return block == block1 && (block instanceof BlockOldLeaf ? p_isSameLeaves_0_.getValue(BlockOldLeaf.VARIANT).equals(p_isSameLeaves_1_.getValue(BlockOldLeaf.VARIANT)) : (block instanceof BlockNewLeaf && p_isSameLeaves_0_.getValue(BlockNewLeaf.VARIANT).equals(p_isSameLeaves_1_.getValue(BlockNewLeaf.VARIANT))));
        }
    }
