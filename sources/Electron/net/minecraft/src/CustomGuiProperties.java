...
public class CustomGuiProperties {
    ...
    public CustomGuiProperties(Properties p_i38_1_, String p_i38_2_) {
        ...
        this.container = (CustomGuiProperties.EnumContainer) connectedparser.parseEnum(p_i38_1_.getProperty("container"), CustomGuiProperties.EnumContainer.values(), "container");
        ...
        this.variants = (CustomGuiProperties.EnumVariant[]) connectedparser.parseEnums(p_i38_1_.getProperty("variants"), acustomguiproperties$enumvariant, "variants", VARIANTS_INVALID);
    ...
    private boolean matchesChest(boolean p_matchesChest_1_, boolean p_matchesChest_2_, boolean p_matchesChest_3_, boolean p_matchesChest_4_) {
        return (this.large == null || this.large.booleanValue() == p_matchesChest_1_) && ((this.trapped == null || this.trapped.booleanValue() == p_matchesChest_2_) && ((this.christmas == null || this.christmas.booleanValue() == p_matchesChest_3_) && (this.ender == null || this.ender.booleanValue() == p_matchesChest_4_)));
    }
    ...
    private boolean matchesVillager(Entity p_matchesVillager_1_, IBlockAccess p_matchesVillager_2_) {
        if (!(p_matchesVillager_1_ instanceof EntityVillager entityvillager)) {
            return false;
        } else {
    ...
    private boolean matchesHorse(Entity p_matchesHorse_1_, IBlockAccess p_matchesHorse_2_) {
        if (!(p_matchesHorse_1_ instanceof EntityHorse entityhorse)) {
            return false;
        } else {
