...
public class Mipmaps {
    ...
    public Mipmaps(String p_i75_1_, int p_i75_2_, int p_i75_3_, int[] p_i75_4_, boolean p_i75_5_) {
        this.iconName = p_i75_1_;
        this.width = p_i75_2_;
        this.height = p_i75_3_;
        this.data = p_i75_4_;
        this.direct = p_i75_5_;
        this.mipmapDimensions = makeMipmapDimensions(p_i75_2_, p_i75_3_, p_i75_1_);
        this.mipmapDatas = generateMipMapData(p_i75_4_, p_i75_2_, p_i75_3_, this.mipmapDimensions);
