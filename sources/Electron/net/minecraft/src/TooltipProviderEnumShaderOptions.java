...
import net.optifine.shaders.client.EnumShaderOption;
import net.optifine.shaders.client.GuiButtonEnumShaderOption;
...
public class TooltipProviderEnumShaderOptions implements TooltipProvider {
    ...
    public String[] getTooltipLines(GuiButton p_getTooltipLines_1_, int p_getTooltipLines_2_) {
        if (!(p_getTooltipLines_1_ instanceof GuiButtonEnumShaderOption guibuttonenumshaderoption)) {
            return null;
        } else {
