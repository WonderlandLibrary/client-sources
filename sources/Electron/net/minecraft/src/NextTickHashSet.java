...
public class NextTickHashSet extends TreeSet {
    ...
    public NextTickHashSet(Set p_i79_1_) {
        for (Object object : p_i79_1_) {
            this.add(object);
        }
    }

    public boolean contains(Object p_contains_1_) {
        if (!(p_contains_1_ instanceof NextTickListEntry nextticklistentry)) {
            return false;
        } else {
    ...
    public boolean add(Object p_add_1_) {
        if (!(p_add_1_ instanceof NextTickListEntry nextticklistentry)) {
            return false;
        } else {
    ...
    public boolean remove(Object p_remove_1_) {
        if (!(p_remove_1_ instanceof NextTickListEntry nextticklistentry)) {
            return false;
        } else {
            Set set = this.getSubSet(nextticklistentry, false);
