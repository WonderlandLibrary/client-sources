...
public class ReflectorFields {
    ...
    public ReflectorFields(ReflectorClass p_i103_1_, Class p_i103_2_, int p_i103_3_) {
        this.reflectorClass = p_i103_1_;
        this.fieldType = p_i103_2_;

        if (p_i103_1_.exists()) {
            if (p_i103_2_ != null) {
                this.reflectorFields = new ReflectorField[p_i103_3_];

                for (int i = 0; i < this.reflectorFields.length; ++i) {
                    this.reflectorFields[i] = new ReflectorField(p_i103_1_, p_i103_2_, i);
                }
            }
        }
    }
