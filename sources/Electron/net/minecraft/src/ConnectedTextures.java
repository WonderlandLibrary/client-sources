...
public class ConnectedTextures {
    ...
    public static TextureAtlasSprite getConnectedTextureSingle(IBlockAccess p_getConnectedTextureSingle_0_, IBlockState p_getConnectedTextureSingle_1_, BlockPos p_getConnectedTextureSingle_2_, EnumFacing p_getConnectedTextureSingle_3_, TextureAtlasSprite p_getConnectedTextureSingle_4_, boolean p_getConnectedTextureSingle_5_, RenderEnv p_getConnectedTextureSingle_6_) {
        ...
        if (!(p_getConnectedTextureSingle_1_ instanceof BlockStateBase blockstatebase)) {
    ...
    private static TextureAtlasSprite getConnectedTexture(ConnectedProperties p_getConnectedTexture_0_, IBlockAccess p_getConnectedTexture_1_, BlockStateBase p_getConnectedTexture_2_, BlockPos p_getConnectedTexture_3_, int p_getConnectedTexture_4_, TextureAtlasSprite p_getConnectedTexture_5_, RenderEnv p_getConnectedTexture_6_) {
        ...
        if (!p_getConnectedTexture_0_.matchesBlock(p_getConnectedTexture_2_.getBlockId(), k)) {
            ...
            if (p_getConnectedTexture_0_.heights != null && !p_getConnectedTexture_0_.heights.isInRange(i1)) {
                return null;
            } else {
                ...
                switch (p_getConnectedTexture_0_.method) {
                    ...
                    case 4:
                        return getConnectedTextureRandom(p_getConnectedTexture_0_, p_getConnectedTexture_1_, p_getConnectedTexture_2_, p_getConnectedTexture_3_, p_getConnectedTexture_4_);
    ...
    private static TextureAtlasSprite getConnectedTextureRandom(ConnectedProperties p_getConnectedTextureRandom_0_, IBlockAccess p_getConnectedTextureRandom_1_, BlockStateBase p_getConnectedTextureRandom_2_, BlockPos p_getConnectedTextureRandom_3_, int p_getConnectedTextureRandom_4_) {
        if (p_getConnectedTextureRandom_0_.tileIcons.length == 1) {
            return p_getConnectedTextureRandom_0_.tileIcons[0];
        } else {
            int i = p_getConnectedTextureRandom_4_ / p_getConnectedTextureRandom_0_.symmetry * p_getConnectedTextureRandom_0_.symmetry;

            if (p_getConnectedTextureRandom_0_.linked) {
                BlockPos blockpos = p_getConnectedTextureRandom_3_.down();

                for (IBlockState iblockstate = p_getConnectedTextureRandom_1_.getBlockState(blockpos); iblockstate.getBlock() == p_getConnectedTextureRandom_2_.getBlock(); iblockstate = p_getConnectedTextureRandom_1_.getBlockState(blockpos)) {
                    p_getConnectedTextureRandom_3_ = blockpos;
            ...
            int l = Config.getRandom(p_getConnectedTextureRandom_3_, i) & Integer.MAX_VALUE;
            int i1 = 0;

            if (p_getConnectedTextureRandom_0_.weights == null) {
                i1 = l % p_getConnectedTextureRandom_0_.tileIcons.length;
            } else {
                int j = l % p_getConnectedTextureRandom_0_.sumAllWeights;
            ...
            return p_getConnectedTextureRandom_0_.tileIcons[i1];
        }
    }
    ...
    private static TextureAtlasSprite getNeighbourIcon(IBlockAccess p_getNeighbourIcon_0_, BlockPos p_getNeighbourIcon_1_, IBlockState p_getNeighbourIcon_2_, int p_getNeighbourIcon_3_) {
        ...
        if (ibakedmodel == null) {
            ...
            if (Reflector.ForgeBlock_getExtendedState.exists()) {
                p_getNeighbourIcon_2_ = (IBlockState) Reflector.call(p_getNeighbourIcon_2_.getBlock(), Reflector.ForgeBlock_getExtendedState, new Object[]{p_getNeighbourIcon_2_, p_getNeighbourIcon_0_, p_getNeighbourIcon_1_});
            }
            ...
            if (list == null) {
                ...
                if (Config.isBetterGrass()) {
                    list = BetterGrass.getFaceQuads(p_getNeighbourIcon_0_, p_getNeighbourIcon_2_, p_getNeighbourIcon_1_, enumfacing, list);
                }
        ...
        if (p_addToTileList_0_.matchTileIcons != null) {
            for (int i = 0; i < p_addToTileList_0_.matchTileIcons.length; ++i) {
                ...
                if (!(textureatlassprite instanceof TextureAtlasSprite)) {
                    Config.warn("TextureAtlasSprite is not TextureAtlasSprite: " + null + ", name: " + textureatlassprite.getIconName());
                } else {
    ...
    public static int getPaneTextureIndex(boolean p_getPaneTextureIndex_0_, boolean p_getPaneTextureIndex_1_, boolean p_getPaneTextureIndex_2_, boolean p_getPaneTextureIndex_3_) {
        return p_getPaneTextureIndex_1_ && p_getPaneTextureIndex_0_ ? p_getPaneTextureIndex_2_ ? p_getPaneTextureIndex_3_ ? 34 : 50 : p_getPaneTextureIndex_3_ ? 18 : 2 : p_getPaneTextureIndex_1_ && !p_getPaneTextureIndex_0_ ? p_getPaneTextureIndex_2_ ? p_getPaneTextureIndex_3_ ? 35 : 51 : p_getPaneTextureIndex_3_ ? 19 : 3 : p_getPaneTextureIndex_0_ ? p_getPaneTextureIndex_2_ ? p_getPaneTextureIndex_3_ ? 33 : 49 : p_getPaneTextureIndex_3_ ? 17 : 1 : p_getPaneTextureIndex_2_ ? p_getPaneTextureIndex_3_ ? 32 : 48 : p_getPaneTextureIndex_3_ ? 16 : 0;
    }
    ...
    public static TextureAtlasSprite getCtmTexture(ConnectedProperties p_getCtmTexture_0_, int p_getCtmTexture_1_, TextureAtlasSprite p_getCtmTexture_2_) {
        if (p_getCtmTexture_0_.method != 1) {
            ...
            return i < atextureatlassprite.length ? atextureatlassprite[i] : p_getCtmTexture_2_;
        } else {
            return p_getCtmTexture_2_;
        }
    }
