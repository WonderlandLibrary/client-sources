...
public class BlockPosM extends BlockPos {
    ...
    public BlockPosM(int p_i23_1_, int p_i23_2_, int p_i23_3_) {
        this(p_i23_1_, p_i23_2_, p_i23_3_, 0);
    }

    public BlockPosM(double p_i24_1_, double p_i24_3_, double p_i24_5_) {
        this(MathHelper.floor_double(p_i24_1_), MathHelper.floor_double(p_i24_3_), MathHelper.floor_double(p_i24_5_));
    }

    public BlockPosM(int p_i25_1_, int p_i25_2_, int p_i25_3_, int p_i25_4_) {
        super(0, 0, 0);
        this.mx = p_i25_1_;
        this.my = p_i25_2_;
        this.mz = p_i25_3_;
