...
public class LightMapPack {
    ...
    public LightMapPack(LightMap p_i71_1_, LightMap p_i71_2_, LightMap p_i71_3_) {
        if (p_i71_2_ != null || p_i71_3_ != null) {
            if (p_i71_2_ == null) {
                p_i71_2_ = p_i71_1_;
            }
        ...
        this.lightMap = p_i71_1_;
        this.lightMapRain = p_i71_2_;
        this.lightMapThunder = p_i71_3_;
    }
