...
public class PlayerItemModel {
    ...
    public PlayerItemModel(Dimension p_i83_1_, boolean p_i83_2_, PlayerItemRenderer[] p_i83_3_) {
        this.textureSize = p_i83_1_;
        this.usePlayerTexture = p_i83_2_;
        this.modelRenderers = p_i83_3_;
    }
