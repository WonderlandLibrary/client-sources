...
public class ModelSprite {
    ...
    public ModelSprite(ModelRenderer p_i76_1_, int p_i76_2_, int p_i76_3_, float p_i76_4_, float p_i76_5_, float p_i76_6_, int p_i76_7_, int p_i76_8_, int p_i76_9_, float p_i76_10_) {
        this.modelRenderer = p_i76_1_;
        this.textureOffsetX = p_i76_2_;
        this.textureOffsetY = p_i76_3_;
        this.posX = p_i76_4_;
        this.posY = p_i76_5_;
        this.posZ = p_i76_6_;
        this.sizeX = p_i76_7_;
        this.sizeY = p_i76_8_;
        this.sizeZ = p_i76_9_;
        this.sizeAdd = p_i76_10_;
        this.minU = (float) p_i76_2_ / p_i76_1_.textureWidth;
        this.minV = (float) p_i76_3_ / p_i76_1_.textureHeight;
        this.maxU = (float) (p_i76_2_ + p_i76_7_) / p_i76_1_.textureWidth;
        this.maxV = (float) (p_i76_3_ + p_i76_8_) / p_i76_1_.textureHeight;
    }
