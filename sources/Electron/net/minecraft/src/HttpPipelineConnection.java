...
public class HttpPipelineConnection {
    ...
    public HttpPipelineConnection(String p_i62_1_, int p_i62_2_) {
        this(p_i62_1_, p_i62_2_, Proxy.NO_PROXY);
    }

    public HttpPipelineConnection(String p_i63_1_, int p_i63_2_, Proxy p_i63_3_) {
        this.host = null;
        this.port = 0;
