...
public class Reflector {
    ...
    public static boolean getFieldValueBoolean(Object p_getFieldValueBoolean_0_, ReflectorField p_getFieldValueBoolean_1_, boolean p_getFieldValueBoolean_2_) {
        try {
            Field field = p_getFieldValueBoolean_1_.getTargetField();

            if (field == null) {
                return p_getFieldValueBoolean_2_;
            } else {
                boolean flag = field.getBoolean(p_getFieldValueBoolean_0_);
                return flag;
            }
        } catch (Throwable throwable) {
            throwable.printStackTrace();
    ...
    public static float getFieldValueFloat(Object p_getFieldValueFloat_0_, ReflectorField p_getFieldValueFloat_1_, float p_getFieldValueFloat_2_) {
        try {
            Field field = p_getFieldValueFloat_1_.getTargetField();

            if (field == null) {
                return p_getFieldValueFloat_2_;
            } else {
                float f = field.getFloat(p_getFieldValueFloat_0_);
                return f;
            }
        } catch (Throwable throwable) {
            throwable.printStackTrace();
    ...
    public static int getFieldValueInt(Object p_getFieldValueInt_0_, ReflectorField p_getFieldValueInt_1_, int p_getFieldValueInt_2_) {
        try {
            Field field = p_getFieldValueInt_1_.getTargetField();

            if (field == null) {
                return p_getFieldValueInt_2_;
            } else {
                int i = field.getInt(p_getFieldValueInt_0_);
                return i;
            }
        } catch (Throwable throwable) {
            throwable.printStackTrace();
    ...
    public static boolean setFieldValueInt(ReflectorField p_setFieldValueInt_0_, int p_setFieldValueInt_1_) {
        return setFieldValueInt(null, p_setFieldValueInt_0_, p_setFieldValueInt_1_);
    }

    public static boolean setFieldValueInt(Object p_setFieldValueInt_0_, ReflectorField p_setFieldValueInt_1_, int p_setFieldValueInt_2_) {
        try {
            Field field = p_setFieldValueInt_1_.getTargetField();

            if (field == null) {
                return false;
            } else {
                field.setInt(p_setFieldValueInt_0_, p_setFieldValueInt_2_);
                return true;
            }
        } catch (Throwable throwable) {
            throwable.printStackTrace();
