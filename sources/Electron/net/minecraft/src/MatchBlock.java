...
public class MatchBlock {
    ...
    public MatchBlock(int p_i72_1_) {
        this.blockId = p_i72_1_;
    }

    public MatchBlock(int p_i73_1_, int p_i73_2_) {
        this.blockId = p_i73_1_;

        if (p_i73_2_ >= 0 && p_i73_2_ <= 15) {
            this.metadatas = new int[]{p_i73_2_};
        }
    }

    public MatchBlock(int p_i74_1_, int[] p_i74_2_) {
        this.blockId = p_i74_1_;
        this.metadatas = p_i74_2_;
    }
