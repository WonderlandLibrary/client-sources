...
import io.github.liticane.electron.event.impl.minecraft.player.MoveStrafeEvent;
...
public abstract class Entity implements ICommandSender {
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        ...
        MoveStrafeEvent moveStrafeEvent = new MoveStrafeEvent(strafe, forward, friction, yaw);
        moveStrafeEvent.setType(EventType.PRE);

        if (isPlayer) {
            Electron.getInstance().getEventBus().publish(moveStrafeEvent);

            if (!moveStrafeEvent.isCancelled()) {
                strafe = moveStrafeEvent.getStrafe();
                forward = moveStrafeEvent.getForward();
                friction = moveStrafeEvent.getFriction();
                yaw = moveStrafeEvent.getYaw();
            }
        }
        ...
        moveStrafeEvent.setType(EventType.POST);
        Electron.getInstance().getEventBus().publish(moveStrafeEvent);
    }
