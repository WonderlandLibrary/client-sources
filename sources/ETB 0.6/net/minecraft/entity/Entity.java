...
public abstract class Entity implements ICommandSender
{
    ...
    private Vec3f pos, prevPos, lastTickPos, headPos, motion;
    private Vec2f rotation, prevRotation;
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double var15 = y;
            double var17 = z;
            boolean var19 = this.onGround && this.isSneaking() || Client.instance.getModuleManager().getModuleByClass(SafeWalk.class).isEnabled() || Client.instance.getModuleManager().getModuleByClass(Scaffold.class).isEnabled() && this instanceof EntityPlayer;
