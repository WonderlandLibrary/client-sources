...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
	...
	public void handleJoinGame(S01PacketJoinGame packetIn) {
		...
		if (Helper.onServer("enjoytheban")) {
			// Helper.sendMessage("You are now in ETB Battle Royal, you will only be able to
			// use whitelisted modules. See https://pastebin.com/raw/AR8g1Fb0 for a list of
			// allowed modules.");
		}
	}
	...
	public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
		...
		if (packetIn.func_148993_l() == 10) {
			...
			var8 = new EntityLargeFireball(this.clientWorldController, var2, var4, var6,
					(double) packetIn.func_149010_g() / 8000.0D, (double) packetIn.func_149004_h() / 8000.0D,
		...
		if (var8 != null) {
			...
			if (packetIn.func_149009_m() > 0) {
				...
				((Entity) var8).setVelocity((double) packetIn.func_149010_g() / 8000.0D,
						(double) packetIn.func_149004_h() / 8000.0D, (double) packetIn.func_148999_i() / 8000.0D);
			}
		}
	}
	...
	public void handleSpawnExperienceOrb(S11PacketSpawnExperienceOrb packetIn) {
		...
		EntityXPOrb var2 = new EntityXPOrb(this.clientWorldController, (double) packetIn.func_148984_d(),
				(double) packetIn.func_148983_e(), (double) packetIn.func_148982_f(), packetIn.func_148986_g());
	...
	public void handleEntityMovement(S14PacketEntity packetIn) {
		...
		if (var2 != null) {
			...
			double var7 = (double) var2.serverPosZ / 32.0D;
			float var9 = packetIn.func_149060_h() ? (float) (packetIn.func_149066_f() * 360) / 256.0F
					: var2.rotationYaw;
			float var10 = packetIn.func_149060_h() ? (float) (packetIn.func_149063_g() * 360) / 256.0F
					: var2.rotationPitch;
