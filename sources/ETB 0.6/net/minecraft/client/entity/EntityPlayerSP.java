...
public class EntityPlayerSP extends AbstractClientPlayer {
	...
	public void onUpdate() {
		...
		if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
			if (mc.breakTheGame) {
				this.rotationPitch = Math.max(-89, this.rotationPitch - 50f);
	...
	public void func_175161_p() {
		// TODO: Client Event - PreMotionUpdates & Post
		...
		if (this.func_175160_A()) {
			...
			double var5 = e.getY() - this.field_175166_bJ;
	...
	public void sendChatMessage(String p_71165_1_) {
		// Call EventChat
		EventChat e = new EventChat(EventChat.ChatType.Send, p_71165_1_);
		EventBus.getInstance().call(e);
		if (!e.isCancelled()) {
	...
	protected boolean pushOutOfBlocks(double x, double y, double z) {
		// freecam
		if (Client.instance.getModuleManager().getModuleByClass(Freecam.class).isEnabled()
				|| Client.instance.getModuleManager().getModuleByClass(Phase.class).isEnabled()) {
			return false;
		}
	...
	// A method for getting Entity Direction
	...
	// A method for setting Entity MoveSpeed
