...
public class ModelBiped extends ModelBase {
	...
	public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_,
		...
		if (Client.instance.getModuleManager().getModuleByClass(Dab.class).isEnabled()
				&& Minecraft.getMinecraft().gameSettings.thirdPersonView > 0) {
			boolean pressed = Keyboard.isKeyDown(Keyboard.KEY_LCONTROL);
			boolean pressed2 = Keyboard.isKeyDown(Keyboard.KEY_RCONTROL);
			if (pressed) {
				this.bipedHead.rotateAngleX = 0.5F;
				this.bipedHead.rotateAngleY = 0.75F;
				this.bipedRightArm.rotateAngleX = 4.75F;
				this.bipedRightArm.rotateAngleY = -1;
