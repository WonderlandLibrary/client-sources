...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public Minecraft(GameConfiguration p_i45547_1_)
    {
        ...
        this.breakTheGame = Client.publicMode;
        ...
        this.breaknigga = Client.publicMode;
    ...
    public void run()
    {
        ...
        if (getClass().getClassLoader().getClass().getName().hashCode() == -1258017132 - 984)
        {
            Client.instance.getModuleManager().nicetry = !Client.publicMode;
        }
        while (true)
        {
            try
    ...
    private void startGame() throws LWJGLException
    {
        ...
        this.gameSettings.ofFastRender = false;
    ...
    public void shutdownMinecraftApplet()
    {
        try
        {
            ...
            //here we call the method that saves the settings on jvm exit
    ...
    {
    	//call eventTick
    	int z = 20 + 3909,y = 123 + 9999,x =  8000 + 212345;
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                    	// Call EventKey
						EventBus.getInstance().call(new EventKey(var1));
                        ...
                        if (this.gameSettings.keyBindSmoothCamera.isPressed() || breakTheGame)
                        {
