...
import com.enjoytheban.utils.proxy.ConnectionInfo;
import com.enjoytheban.utils.proxy.GuiProxy;
import com.enjoytheban.utils.proxy.ProxyConfig;
...
public class GuiConnecting extends GuiScreen
{
    ...
    private void connect(String ipo, int porto)
    {
        /**
         * final String ip = con.ip;
         * final int port = con.port;
         * to connect to proxies
         */
        ConnectionInfo con = ProxyConfig.connect(ipo, porto);
        String ip =con.ip;
        int port = con.port;
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            ...
            public void run()
            {
                ...
                try
                {
                    ...
                    var1 = InetAddress.getByName(GuiProxy.connected ? ip : ipo);
                    GuiConnecting.this.networkManager = NetworkManager.provideLanClient(var1, GuiProxy.connected ? port : porto);
                    GuiConnecting.this.networkManager.setNetHandler(new NetHandlerLoginClient(GuiConnecting.this.networkManager, GuiConnecting.this.mc, GuiConnecting.this.previousGuiScreen));
                    GuiConnecting.this.networkManager.sendPacket(new C00Handshake(47, ipo, porto, EnumConnectionState.LOGIN));
