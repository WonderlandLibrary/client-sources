...
import com.enjoytheban.module.modules.render.Chams.ChamsMode;
import com.enjoytheban.module.modules.render.ESP;
import com.enjoytheban.module.modules.render.ESP.ESPMode;
import com.enjoytheban.module.modules.render.Nametags;
import com.enjoytheban.utils.Helper;
import com.enjoytheban.utils.render.OutlineUtils;
...
public abstract class RendererLivingEntity extends Render {
	...
	public static boolean renderLayer;
	...
	public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
		...
		if (!Reflector.RenderLivingEvent_Pre_Constructor.exists()
			...
			try {
				...
				if (esp.mode.getValue() == ESPMode.Outline && esp.isEnabled()) {
					GlStateManager.depthMask(true);
					if (!(p_76986_1_ instanceof EntityPlayer) || !((EntityPlayer) p_76986_1_).func_175149_v()) {
						this.func_177093_a(p_76986_1_, var17, var16, p_76986_9_, var14, var12, var201, var15);
					}

					if (p_76986_1_ instanceof EntityPlayer) {
						if (Minecraft.getMinecraft().theWorld != null) {
							this.renderModel(p_76986_1_, var17, var16, var14, var12, var201, var15);
				...
				if (this.field_177098_i) {
					...
					GL11.glPushMatrix();
					// ESP esp = (ESP) Client.instance.getModuleManager().getModuleByClass(ESP.class);
					// if(esp.isEnabled() && esp.mode.getValue() == ESPMode.Outline && p_76986_1_
					// instanceof EntityPlayer)
					// GLColor.color(new Color(12,255,12).getRGB());
					GL11.glPopMatrix();
	...
	protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_,
		...
		if (var8 || var9) {
			...
			if (chams.isEnabled() && chams.mode.getValue() == ChamsMode.Textured
					&& p_77036_1_ instanceof EntityPlayer) {
				GL11.glPushMatrix();
				...
				GL11.glColor3d(!Helper.mc.thePlayer.canEntityBeSeen(p_77036_1_) ? 1.0 : 0.0,
						!Helper.mc.thePlayer.canEntityBeSeen(p_77036_1_) ? 0.5 : 1.0,
						!Helper.mc.thePlayer.canEntityBeSeen(p_77036_1_) ? 0.0 : 0.0);
				this.mainModel.render(p_77036_1_, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_,
						p_77036_7_);
	...
	protected void func_177093_a(EntityLivingBase p_177093_1_, float p_177093_2_, float p_177093_3_, float p_177093_4_,
		...
		while (var9.hasNext()) {
			...
			if (RendererLivingEntity.renderLayer) {
	 ...
	 */
	public void passSpecialRender(EntityLivingBase p_77033_1_, double p_77033_2_, double p_77033_4_,
			double p_77033_6_) {
		// nametags
			...
			if (this.canRenderName(p_77033_1_)) {
				...
				if (var8 < (double) (var10 * var10)) {
					...
					if (p_77033_1_.isSneaking()) {
						...
						GlStateManager.pushMatrix();
						GlStateManager.translate((float) p_77033_2_, (float) p_77033_4_ + p_77033_1_.height + 0.5F
								- (p_77033_1_.isChild() ? p_77033_1_.height / 2.0F : 0.0F), (float) p_77033_6_);
