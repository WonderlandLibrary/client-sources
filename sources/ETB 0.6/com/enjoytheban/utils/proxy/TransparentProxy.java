        ...
        try {
            ...
            new Thread(() -> {
                try {
                    ...
                    this.server = ProxySocket.connectOverProxy((String)proxy, (int)proxyPort, (String)ip, (int)port);
                    ...
                    if (Helper.mc.currentScreen != null && Helper.mc.currentScreen instanceof GuiConnecting && ((GuiConnecting)Helper.mc.currentScreen).networkManager != null) {
                        ((GuiConnecting)Helper.mc.currentScreen).networkManager.closeChannel((IChatComponent)new ChatComponentText("Proxy failure"));
                    }
                    try {
                        this.client.close();
                    }
