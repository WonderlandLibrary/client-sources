...
public class FlightWatchdogImpl implements ModeImpl<Flight> {
        ...
        if (event instanceof EventMove) {
            ...
            switch (stage) {
                ...
                case 1:
                    ...
                    e.setY(mc.thePlayer.motionY = (float) 0.2D);
                    stage++;
                    break;
                case 2:
                  //  mc.timer.timerSpeed = 1.0f;

                        mc.timer.timerSpeed = (float) Math.min(5F, 2F * 0.992);
                    if (mc.thePlayer.fallDistance > 0)
                        e.setY(mc.thePlayer.motionY = 4.3E-8 + MovementUtil.getWatchdogUnpatchValues());
