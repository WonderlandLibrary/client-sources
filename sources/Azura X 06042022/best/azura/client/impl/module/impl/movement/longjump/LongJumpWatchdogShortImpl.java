...
public class LongJumpWatchdogShortImpl implements ModeImpl<LongJump> {
    ...
    private static final float[] LONG_JUMP_Y_MOTIONS = {
            0.36f, 0.34f, 0.32f, 0.3f, 0.28f
    };
