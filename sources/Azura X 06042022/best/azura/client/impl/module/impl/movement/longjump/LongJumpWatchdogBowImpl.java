...
public class LongJumpWatchdogBowImpl implements ModeImpl<LongJump> {
        ...
        if (event instanceof EventMove) {
            ...
            switch (stage) {
                case 0:
                    ...
                    break;
                case 1:
                    speed = MovementUtil.getBaseSpeed() * 1.9;
                    e.setY(mc.thePlayer.motionY = 0.76f);
                ...
                case 2:
                    ...
                    if (mc.thePlayer.isMoving()) MovementUtil.setSpeed(Math.max(MovementUtil.getBaseSpeed() - 0.08,
                            speed -= speed / (mc.thePlayer.isPotionActive(Potion.moveSpeed) ? 70 : 60)), e);
