...
public class SpartanB453ClickTPImpl implements ModeImpl<Teleport> {
        ...
        if (event instanceof EventMotion) {
            ...
            if (e.isPre()) {
                ...
                if (mc.gameSettings.keyBindAttack.pressed && position.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && !mc.theWorld.isAirBlock(position.getBlockPos())) {
                    ...
                    mc.thePlayer.sendQueue.addToSendQueueNoEvent(new C03PacketPlayer.C04PacketPlayerPosition(e.x, e.y + 5000, e.z, true));
                    mc.thePlayer.sendQueue.addToSendQueueNoEvent(new C03PacketPlayer.C04PacketPlayerPosition(e.x, e.y, e.z, true));
                }
            }
        }
    }
