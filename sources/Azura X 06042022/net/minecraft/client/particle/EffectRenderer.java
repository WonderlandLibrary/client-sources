...
public class EffectRenderer
{
    ...
    {
        final EventEmitParticle eventEmitParticle = new EventEmitParticle(1, particleTypes);
        Client.INSTANCE.getEventBus().call(eventEmitParticle);
        for (int i = 0; i < eventEmitParticle.multiplier; i++)
