...
public class WorldClient extends World
{
    ...
    public void sendQuittingDisconnectingPacket()
    {
        ...
        final long totalSecs = (System.currentTimeMillis() - ServerUtil.joinedTime) / 1000, minutes = (totalSecs / 60) % 60;
        if (minutes > 4 &&
    ...
    public void setWorldTime(long time)
    {
        ...
        if (ambience.isEnabled()) time = ambience.worldTime.getObject();
