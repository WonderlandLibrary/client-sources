...
public class ResourcePackRepository
{
    ...
    public void updateRepositoryEntriesAll()
    {
        ...
        for (ResourcePackRepository.Entry entry : getRepositoryEntriesAll()) {
            all.put(entry.hashCode(), entry);
        }

        final Set<Entry> newSet = new LinkedHashSet<>();
        for (File file : getResourcePackFiles()) {
            final ResourcePackRepository.Entry entry = new Entry(file);
        ...
        repositoryEntriesAll = new ArrayList<>(newSet);
    }
