...
public class Main {
    public static void main(String[] p_main_0_) {
        ...
        PropertyMap property1 = gson.fromJson(optionset.valueOf(optionspec16), PropertyMap.class);
