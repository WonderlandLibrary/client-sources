...
import best.azura.client.impl.module.impl.render.WorldColor;
...
public class BlockModelRenderer
{
    ...
    private static boolean separateAoLightValue = false;private static final EnumWorldBlockLayer[] OVERLAY_LAYERS = new EnumWorldBlockLayer[] {EnumWorldBlockLayer.CUTOUT, EnumWorldBlockLayer.CUTOUT_MIPPED, EnumWorldBlockLayer.TRANSLUCENT};
    ...
    public boolean renderModel(IBlockAccess blockAccessIn, IBakedModel modelIn, IBlockState blockStateIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, boolean checkSides)
    {
        ...
        try {
            if (Client.INSTANCE.getModuleManager().getModule(WorldColor.class).isEnabled())
                flag = blockStateIn.getBlock().getLightValue() == 0 && modelIn.isAmbientOcclusion();
