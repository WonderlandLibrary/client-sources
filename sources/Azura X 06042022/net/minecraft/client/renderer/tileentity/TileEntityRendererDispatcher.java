...
public class TileEntityRendererDispatcher
{
    ...
    public boolean skipDistanceChecks;
    ...
    {
        if (tileentityIn.getDistanceSq(this.entityX, this.entityY, this.entityZ) < tileentityIn.getMaxRenderDistanceSquared() || skipDistanceChecks)
        {
            boolean flag = true;
