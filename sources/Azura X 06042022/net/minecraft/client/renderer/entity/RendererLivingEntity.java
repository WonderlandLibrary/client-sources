...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z))) {
            ...
            try {
                ...
                if (entity == Minecraft.getMinecraft().thePlayer) {
                    ...
                    f7 = player.prevRotationPitchHead + (player.rotationPitchHead - player.prevRotationPitchHead) * partialTicks;
                }
                ...
                try {
                    if (entity instanceof EntityPlayerSP) {
                        EventRenderPlayer eventRenderPlayer = new EventRenderPlayer("sp", entity.getName(), "Pre Model", mainModel.boxList, f6, f5, f8, f2, f7);
                        Client.INSTANCE.getEventBus().call(eventRenderPlayer);
                        f6 = eventRenderPlayer.bodyRotationX;
                        f5 = eventRenderPlayer.bodyRotationY;
                        f8 = eventRenderPlayer.bodyRotationZ;
                        f2 = eventRenderPlayer.bodyRotationYaw;
                        f7 = eventRenderPlayer.bodyRotationPitch;
                    } else if (entity instanceof EntityOtherPlayerMP) {
                        EventRenderPlayer eventRenderPlayer = new EventRenderPlayer("mp", entity.getName(), "Pre Model", mainModel.boxList, f6, f5, f8, f2, f7);
                        Client.INSTANCE.getEventBus().call(eventRenderPlayer);
                        f6 = eventRenderPlayer.bodyRotationX;
                        f5 = eventRenderPlayer.bodyRotationY;
                        f8 = eventRenderPlayer.bodyRotationZ;
                ...
                try {
                    if (entity instanceof EntityPlayerSP) {
                        EventRenderPlayer eventRenderPlayer = new EventRenderPlayer("sp", entity.getName(), "Post Model", mainModel.boxList, f6, f5, f7, f2, f8);
                        Client.INSTANCE.getEventBus().call(eventRenderPlayer);
                    } else if (entity instanceof EntityOtherPlayerMP) {
                        EventRenderPlayer eventRenderPlayer = new EventRenderPlayer("mp", entity.getName(), "Post Model", mainModel.boxList, f6, f5, f7, f2, f8);
                        Client.INSTANCE.getEventBus().call(eventRenderPlayer);
                    }
                } catch (Exception ignored) {
                }
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor) {
        ...
        if (flag || flag1) {
	        ...
	        if (entitylivingbaseIn instanceof EntityPlayer
	            && !entitylivingbaseIn.isInvisible () && ESP.espCombo.isSelected ("Chams")
	            && Client.INSTANCE.getModuleManager ().getModule (ESP.class).isEnabled ()
	            && !(entitylivingbaseIn instanceof EntityPlayerSP)) {
                Color color = new Color(ESP.hiddenChams.getObject().getColor().getRGB());
                float hiddenRed = color.getRed() / 255f;
                float hiddenGreen = color.getGreen() / 255f;
                float hiddenBlue = color.getBlue() / 255f;
                Color shownColor = new Color(ESP.colorValue.getObject().getColor().getRGB());
                float shownRed = shownColor.getRed() / 255f;
                float shownGreen = shownColor.getGreen() / 255f;
                float shownBlue = shownColor.getBlue() / 255f;
                glDisable(GL_DEPTH_TEST);
                glEnable(GL_BLEND);
                glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
                glDisable(GL_TEXTURE_2D);
                glDisable(GL_LIGHTING);
                glColor4f(hiddenRed, hiddenGreen, hiddenBlue, ESP.hiddenAlpha.getObject() / 255);
                this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, scaleFactor);
                glEnable(GL_DEPTH_TEST);
                glColor4f(shownRed, shownGreen, shownBlue, ESP.shownAlpha.getObject() / 255);
                this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, scaleFactor);
                glDisable(GL_BLEND);
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
        ...
        if (!flag && !flag1) {
            ...
            GL11.glTexEnvi(GL11.GL_TEXTURE_ENV, OpenGlHelper.GL_OPERAND0_ALPHA, GL_SRC_ALPHA);
            GlStateManager.setActiveTexture(OpenGlHelper.lightmapTexUnit);
            GlStateManager.enableTexture2D();
            GL11.glTexEnvi(GL11.GL_TEXTURE_ENV, GL11.GL_TEXTURE_ENV_MODE, OpenGlHelper.GL_COMBINE);
            ...
            GL11.glTexEnvi(GL11.GL_TEXTURE_ENV, OpenGlHelper.GL_OPERAND0_RGB, GL11.GL_SRC_COLOR);
            GL11.glTexEnvi(GL11.GL_TEXTURE_ENV, OpenGlHelper.GL_OPERAND1_RGB, GL11.GL_SRC_COLOR);
            GL11.glTexEnvi(GL11.GL_TEXTURE_ENV, OpenGlHelper.GL_OPERAND2_RGB, GL_SRC_ALPHA);
            GL11.glTexEnvi(GL11.GL_TEXTURE_ENV, OpenGlHelper.GL_COMBINE_ALPHA, GL11.GL_REPLACE);
    ...
    protected void unsetBrightness() {
        ...
        GL11.glTexEnvi(GL11.GL_TEXTURE_ENV, OpenGlHelper.GL_OPERAND0_ALPHA, GL_SRC_ALPHA);
        GL11.glTexEnvi(GL11.GL_TEXTURE_ENV, OpenGlHelper.GL_OPERAND1_ALPHA, GL_SRC_ALPHA);
        GlStateManager.setActiveTexture(OpenGlHelper.lightmapTexUnit);
        GL11.glTexEnvi(GL11.GL_TEXTURE_ENV, GL11.GL_TEXTURE_ENV_MODE, OpenGlHelper.GL_COMBINE);
        GL11.glTexEnvi(GL11.GL_TEXTURE_ENV, OpenGlHelper.GL_COMBINE_RGB, GL11.GL_MODULATE);
        GL11.glTexEnvi(GL11.GL_TEXTURE_ENV, OpenGlHelper.GL_OPERAND0_RGB, GL11.GL_SRC_COLOR);
        ...
        for (LayerRenderer<T> layerrenderer : this.layerRenderers) {
            try {
                if (entitylivingbaseIn instanceof EntityPlayerSP) {
                    EventRenderLayer eventRenderLayer = new EventRenderLayer("Pre", "sp", (EntityPlayerSP)entitylivingbaseIn, layerrenderer);
                    Client.INSTANCE.getEventBus().call(eventRenderLayer);
                    //noinspection unchecked
                    layerrenderer = (LayerRenderer<T>) eventRenderLayer.layerRenderer;
                } else if (entitylivingbaseIn instanceof EntityOtherPlayerMP) {
                    EventRenderLayer eventRenderLayer = new EventRenderLayer("Pre", "mp", (EntityOtherPlayerMP)entitylivingbaseIn, layerrenderer);
                    Client.INSTANCE.getEventBus().call(eventRenderLayer);
                    //noinspection unchecked
                    layerrenderer = (LayerRenderer<T>) eventRenderLayer.layerRenderer;
                }
            ...
            try {
                if (entitylivingbaseIn instanceof EntityPlayerSP) {
                    EventRenderLayer eventRenderLayer = new EventRenderLayer("Post", "sp", (EntityPlayerSP)entitylivingbaseIn, layerrenderer);
                    Client.INSTANCE.getEventBus().call(eventRenderLayer);
                } else if (entitylivingbaseIn instanceof EntityOtherPlayerMP) {
                    EventRenderLayer eventRenderLayer = new EventRenderLayer("Post", "mp", (EntityOtherPlayerMP)entitylivingbaseIn, layerrenderer);
                    Client.INSTANCE.getEventBus().call(eventRenderLayer);
                }
            } catch (Exception ignored) {
            }
    ...
    public void renderName(T entity, double x, double y, double z) {
        ...
        if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z))) {
            final ESP esp = (ESP) Client.INSTANCE.getModuleManager().getModule(ESP.class);
            if (this.canRenderName(entity)) {
                if (esp.esp2DCombo.isSelected("Name tags") && esp.isEnabled() && entity instanceof EntityOtherPlayerMP) return;
