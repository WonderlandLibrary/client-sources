...
public class RenderManager
{
    ...
    {
        return this.renderEntityStaticNoShadow(entityIn, partialTicks, false);
    }
    ...
    public boolean renderEntityStaticNoShadow(Entity entity, float partialTicks, boolean hideDebugBox)
    {
        ...
        OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (float)j / 1.0F, (float)k / 1.0F);
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        return this.doRenderEntityNoShadow(entity, d0 - renderPosX, d1 - renderPosY, d2 - renderPosZ, f, partialTicks, hideDebugBox);
    }
