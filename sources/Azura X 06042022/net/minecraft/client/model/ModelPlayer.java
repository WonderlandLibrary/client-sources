    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        try {
            if (entityIn instanceof EntityPlayerSP) {
                EventRenderPlayer eventRenderPlayer = new EventRenderPlayer("sp", entityIn.getName(),"Set Rotation Angles", boxList);
                Client.INSTANCE.getEventBus().call(eventRenderPlayer);
            } else if (entityIn instanceof EntityOtherPlayerMP) {
                EventRenderPlayer eventRenderPlayer = new EventRenderPlayer("mp", entityIn.getName(), "Set Rotation Angles", boxList);
                Client.INSTANCE.getEventBus().call(eventRenderPlayer);
            }
        ...
        try {
            if (entityIn instanceof EntityPlayerSP) {
                EventRenderPlayer eventRenderPlayer = new EventRenderPlayer("sp", entityIn.getName(),"Set Rotation Angles Post", boxList);
                Client.INSTANCE.getEventBus().call(eventRenderPlayer);
            } else if (entityIn instanceof EntityOtherPlayerMP) {
                EventRenderPlayer eventRenderPlayer = new EventRenderPlayer("mp", entityIn.getName(), "Set Rotation Angles Post", boxList);
                Client.INSTANCE.getEventBus().call(eventRenderPlayer);
            }
        } catch (Exception ignored) {}
    }
