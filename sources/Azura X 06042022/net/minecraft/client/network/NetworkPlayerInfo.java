...
public class NetworkPlayerInfo
{
    ...
    public String getSkinType()
    {
        try {
            ...
            if (gameProfile.getName().equals(Minecraft.getMinecraft().getSession().getUsername())
                    && streamerMode != null && streamerMode.isEnabled() && streamerMode.skinChanger.getObject())
                return streamerMode.slimModel.getObject() ? "slim" : "default";
            if (Client.INSTANCE.getModuleManager().getModule(FPSBooster.class).isEnabled() && FPSBooster.noSkins.getObject())
    ...
    public ResourceLocation getLocationSkin()
    {
        try {
            ...
            if (gameProfile.getName().equals(Minecraft.getMinecraft().getSession().getUsername())
                    && streamerMode != null && streamerMode.isEnabled() && streamerMode.skinChanger.getObject())
                return streamerMode.getSkinLocation() == null ? DefaultPlayerSkin.getDefaultSkinLegacy() : streamerMode.getSkinLocation();
            if (Client.INSTANCE.getModuleManager().getModule(FPSBooster.class).isEnabled() && FPSBooster.noSkins.getObject())
    ...
    {
        try {
            if (Client.INSTANCE.getModuleManager().getModule(FPSBooster.class).isEnabled() && FPSBooster.noCapes.getObject())
                return null;
        } catch (Exception ignored) {}
