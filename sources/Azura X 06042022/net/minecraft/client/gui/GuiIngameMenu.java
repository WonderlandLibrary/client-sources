...
public class GuiIngameMenu extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(10, this.width / 2 + 2, this.height / 4 + 48 + i, 98, 20, "Edit HUD"));
		...
		switch (button.id) {
			...
			case 1:
				...
				if (flag) {
					...
					this.mc.displayGuiScreen(new MainMultiplayer(new GuiMainMenu()));
				}
			...
			case 7:
				...
				break;
			case 10:
				this.mc.displayGuiScreen(new GuiEditHUD(this));
		}
	}
