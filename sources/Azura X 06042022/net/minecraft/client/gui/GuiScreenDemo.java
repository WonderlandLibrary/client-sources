...
public class GuiScreenDemo extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 + 2, this.height / 2 + 62 + i, 114, 20, "No, I am retarded."));
    }
        ...
        switch (button.id)
        {
            case 1:
                ...
                try
                {
                    ...
                    oclass.getMethod("browse", new Class[] {URI.class}).invoke(object, new URI("https://azura.best"));
                }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.fontRendererObj.drawString("Azura Client Demo", i, j, 2039583);
        j = j + 12;
        ...
        this.fontRendererObj.drawSplitString("This demo lasts about 1 second before it start to use your PC as Miner, to prevent this you have to buy the full Version of Azura.", i, j + 68, 218, 2039583);
