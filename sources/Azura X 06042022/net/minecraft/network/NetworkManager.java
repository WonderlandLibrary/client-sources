...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    public static final Marker logMarkerPackets = MarkerManager.getMarker("NETWORK_PACKETS");
    ...
    protected void channelRead0(ChannelHandlerContext p_channelRead0_1_, Packet p_channelRead0_2_) throws Exception {
        EventReceivedPacket eventSendPacket = new EventReceivedPacket(p_channelRead0_2_);
        Client.INSTANCE.getEventBus().call(eventSendPacket);
        p_channelRead0_2_ = eventSendPacket.getPacket();
    ...
    public void sendPacket(Packet packetIn) {
        EventSentPacket eventSentPacket = new EventSentPacket(packetIn);
        Client.INSTANCE.getEventBus().call(eventSentPacket);
        packetIn = eventSentPacket.getPacket();
        if (eventSentPacket.isCancelled()) return;
    ...
    public static NetworkManager createNetworkManagerAndConnect(InetAddress address, int serverPort, boolean useNativeTransport) {
        ...
        if (ProxyManager.getProxy() == null) {
            ...
            bootstrap.channelFactory(ProxyManager.createProxyChannel());
        }
