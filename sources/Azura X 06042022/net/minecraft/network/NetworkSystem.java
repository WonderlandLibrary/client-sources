        ...
        synchronized (this.endpoints) {
            ...
            this.endpoints.add((((new ServerBootstrap()).channel(oclass)).childHandler(new ChannelInitializer<Channel>() {
                protected void initChannel(Channel p_initChannel_1_) {
                    ...
                    p_initChannel_1_.pipeline().addLast("timeout", (new ReadTimeoutHandler(30))).addLast("legacy_query",
                            (new PingResponseHandler(NetworkSystem.this))).addLast("splitter",
                            (new MessageDeserializer2())).addLast("decoder",
                            (new MessageDeserializer(EnumPacketDirection.SERVERBOUND))).addLast("prepender",
                            (new MessageSerializer2())).addLast("encoder",
