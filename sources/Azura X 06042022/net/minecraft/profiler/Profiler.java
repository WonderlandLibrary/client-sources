...
public class Profiler
{
    ...
    public void startSection(String name)
    {
        ...
        final FPSBooster fpsBooster;
        final boolean fpsBoost = Client.INSTANCE.getModuleManager() != null && (fpsBooster = (FPSBooster) Client.INSTANCE.getModuleManager().getModule(FPSBooster.class)) != null && fpsBooster.isEnabled();
        if (Config.isFastRender() || fpsBoost)
        {
            int j = name.hashCode();
