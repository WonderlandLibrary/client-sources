...
public class BooleanValue extends Value<Boolean> {
    ...
    public void setValue(final Boolean value) {
        ...
        if (mode != null && getParent() != null && getParent().isEnabled()) {
            if (getValue()) mode.register(); else mode.unregister();
        }
    }
    ...
    public void setValueAsObject(final Object value) {
        ...
        if (mode != null && getParent() != null && getParent().isEnabled() && getValue()) mode.onEnable();
    }
}