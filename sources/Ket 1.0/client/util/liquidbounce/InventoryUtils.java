...
import client.event.impl.other.WindowClickEvent;
...
public class InventoryUtils implements MinecraftInstance {
    ...
    @EventLink
    public final Listener<WindowClickEvent> onWindowClick = event -> CLICK_TIMER.reset();

    @EventLink
    public final Listener<PacketSendEvent> onPacketSend = event -> {
        if (event.getPacket() instanceof C08PacketPlayerBlockPlacement) CLICK_TIMER.reset();
    };
}
