...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        final MotionEvent event = new MotionEvent(posX, getEntityBoundingBox().minY, posZ, rotationYaw, rotationPitch, onGround);
    ...
    public void onLivingUpdate()
    {
        ...
        {
            final SlowDownEvent event = new SlowDownEvent(0.2F, 0.2F);
            Client.INSTANCE.getEventBus().handle(event);
