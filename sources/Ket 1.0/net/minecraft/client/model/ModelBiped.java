...
public class ModelBiped extends ModelBase
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if (entityIn instanceof EntityPlayerSP && RotationUtil.getRotation() != null && RotationUtil.getPreviousRotation() != null) bipedHead.rotateAngleX = (float) Math.toRadians(RotationUtil.getPreviousRotation().x + (RotationUtil.getRotation().x - RotationUtil.getPreviousRotation().x) * Minecraft.getMinecraft().timer.renderPartialTicks);
