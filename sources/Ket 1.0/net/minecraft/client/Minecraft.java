...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void sendClickBlockToController(boolean leftClick)
    {
        ...
        if (this.leftClickCounter <= 0 && !this.thePlayer.isUsingItem())
        {
            if (leftClick && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
            {
                ...
                {
                    Client.INSTANCE.getEventBus().handle(new BlockClickEvent(blockpos));
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    Client.INSTANCE.getEventBus().handle(new KeyboardInputEvent(currentScreen, k));
    ...
    {
        Client.INSTANCE.getEventBus().handle(new WorldLoadEvent());
    ...
    public void setServerData(ServerData serverDataIn)
    {
        ...
        if (serverDataIn != null) ServerUtil.setLastServerData(serverDataIn);
