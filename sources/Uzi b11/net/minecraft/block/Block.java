...
import host.kix.uzi.module.modules.exploits.Phase;
import host.kix.uzi.module.modules.misc.Freecam;
...
public class Block {
    ...
    public boolean isVisuallyOpaque() {
        if (Uzi.getInstance().getModuleManager().find(Xray.class).isEnabled()) {
            if (this == getBlockById(16)) {
                return true;
            }
            return false;
        }
        if (Uzi.getInstance().getModuleManager().find(Freecam.class).isEnabled() && Phase.isInsideBlock() || Uzi.getInstance().getModuleManager().find(Phase.class).isEnabled() && Phase.isInsideBlock()) {
            return false;
        }
    ...
    public int getMixedBrightnessForBlock(IBlockAccess worldIn, BlockPos pos) {
        ...
        int var4 = worldIn.getCombinedLight(pos, Uzi.getInstance().getModuleManager().find(Xray.class).isEnabled() ? 1500 : var3.getLightValue());
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List list, Entity collidingEntity) {
        ...
        BoundingBoxEvent event = new BoundingBoxEvent(collidingEntity, new Location(pos.getX(), pos.getY(), pos.getZ()), this, pos, var7);
