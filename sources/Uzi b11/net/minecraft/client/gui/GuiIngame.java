...
public class GuiIngame extends Gui {
    ...
    public void func_175180_a(float p_175180_1_) {
        ...
        EventManager.call(new RenderGameOverlayEvent());
    ...
    private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
        ...
        while (var12.hasNext()) {
            ...
            RenderStringEvent scoreboard = new RenderStringEvent(var15);
            RenderStringEvent scoreboard2 = new RenderStringEvent(var16);
            EventManager.call(scoreboard);
            EventManager.call(scoreboard2);
            this.func_175179_f().drawString(scoreboard.getString().replaceAll("\247g", "\2473"), var25, var18, 553648127);
            this.func_175179_f().drawString(scoreboard.getString().replaceAll("\247g", "\2473"), var19 - this.func_175179_f().getStringWidth(var16), var18, 553648127);

            if (var11 == var21.size()) {
                String var20 = p_180475_1_.getDisplayName();

                RenderStringEvent scoreboard3 = new RenderStringEvent(var20);
                ...
                this.func_175179_f().drawString(scoreboard3.getString().replaceAll("\247g", "\2473"), var25 + var6 / 2 - this.func_175179_f().getStringWidth(var20) / 2, var18 - this.func_175179_f().FONT_HEIGHT, 553648127);
            }
        }
    }
