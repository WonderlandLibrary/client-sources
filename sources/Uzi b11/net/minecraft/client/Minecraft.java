...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    public void check() {
        try {
            ...
            String hwid = getMD5((System.getenv("PROCESSOR_IDENTIFIER") + System.getenv("COMPUTERNAME") + System.getProperty("user.name")).trim());
            URL url = new URL("http://uziclient.pro/UziProtectionInfo.txt");
    ...
    private void startGame() throws LWJGLException {
        ...
        try {
            Uzi.getInstance().init(System.getProperty("user.home"));
        } catch (IOException e) {
            e.printStackTrace();
        }
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        for (Module module : Uzi.getInstance().getModuleManager().getContents()) {
                            if (var1 == module.getBind()) {
                                module.toggle();
                            }
                        }
