...
public class MathHelper
{
    ...
    /**
     * Shorten {@code in} to only have a decimal place of {@code places}
     *
     * @param in
     * @param places
     * @return
    ...
    public static double round(double in, int places) {
        places = (int) clamp(places, 0, Integer.MAX_VALUE);
        return Double.parseDouble(String.format("%." + places + "f", in));
    }

    /**
     * Clamp a value ({@code in}) to {@code min} or {@code max}
     *
     * @param in
     * @param min
     * @param max
    ...
    public static double randomDouble(double min, double max) {
        return clamp(min + random.nextDouble() * max, min, max);
    }

    /**
     * Returns a squared value of {@code in}
     *
     * @param in
     * @return
     */
    ...
    /**
     * Get the decimal percent of {@code current} to {@code max}
     *
     * @param current
     * @param max
     * @return
