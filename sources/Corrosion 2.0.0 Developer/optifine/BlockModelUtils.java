...
public class BlockModelUtils {
    ...
    private static BakedQuad makeBakedQuad(EnumFacing p_makeBakedQuad_0_, TextureAtlasSprite p_makeBakedQuad_1_, int p_makeBakedQuad_2_) {
        ...
        BakedQuad bakedquad = facebakery.makeBakedQuad(vector3f, vector3f1, blockpartface, p_makeBakedQuad_1_, p_makeBakedQuad_0_, (ModelRotation)modelrotation, (BlockPartRotation)blockpartrotation, flag, flag1);
        return bakedquad;
    }
}
