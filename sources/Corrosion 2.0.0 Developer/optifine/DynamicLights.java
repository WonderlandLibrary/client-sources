        ...
        if (i >= timeUpdateMs + 50L) {
            ...
            synchronized(mapDynamicLights) {
                ...
                if (mapDynamicLights.size() > 0) {
                    Iterator var4 = mapDynamicLights.values().iterator();

                    while(var4.hasNext()) {
                        DynamicLight dynamiclight = (DynamicLight)var4.next();
    ...
    private static void updateMapDynamicLights(RenderGlobal p_updateMapDynamicLights_0_) {
        ...
        if (world != null) {
            ...
            while(var2.hasNext()) {
                ...
                if (i > 0) {
                    integer = IntegerCache.valueOf(entity.getEntityId());
                    ...
                    integer = IntegerCache.valueOf(entity.getEntityId());
                    dynamiclight = (DynamicLight)mapDynamicLights.remove(integer);
                    if (dynamiclight != null) {
        ...
        if (p_getLightLevel_0_ == Config.getMinecraft().getRenderViewEntity() && !Config.isDynamicHandLight()) {
            ...
            if (p_getLightLevel_0_.isBurning()) {
                ...
                if (p_getLightLevel_0_ instanceof EntityLivingBase) {
                    ...
                    itemstack = entitylivingbase.getHeldItem();
