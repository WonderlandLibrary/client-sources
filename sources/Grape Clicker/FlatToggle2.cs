...
namespace Xh0kO1ZCmA
{
	...
	internal class FlatToggle2 : Control
	{
		private int W;

		private int H;

		private FlatToggle2._Options O;
		...
		[Category("Options")]
		public FlatToggle2._Options Options
		{
			get
			{
				return this.O;
		...
		protected override void OnClick(EventArgs e)
		{
			...
			FlatToggle2.CheckedChangedEventHandler checkedChangedEventHandler = this.CheckedChanged;
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			switch (this.O)
			{
				case FlatToggle2._Options.Style1:
				{
				...
				case FlatToggle2._Options.Style2:
				{
				...
				case FlatToggle2._Options.Style3:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
				...
				case FlatToggle2._Options.Style4:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
				...
				case FlatToggle2._Options.Style5:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
				...
				case FlatToggle2._Options.Style6:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
				...
				case FlatToggle2._Options.Style7:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
				...
				case FlatToggle2._Options.Style8:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
				...
				case FlatToggle2._Options.Style9:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
				...
				case FlatToggle2._Options.Style10:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
				...
				case FlatToggle2._Options.Style11:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
				...
				case FlatToggle2._Options.Style12:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
				...
				case FlatToggle2._Options.Style13:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
				...
				case FlatToggle2._Options.Style14:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
				...
				case FlatToggle2._Options.Style15:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Simulate Humanized Clicks", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 65)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
						}
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Simulate Humanized Clicks", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 64)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Simulate Humanized Clicks", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 65)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
		...
		public event FlatToggle2.CheckedChangedEventHandler CheckedChanged;
