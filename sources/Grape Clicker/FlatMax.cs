...
namespace Xh0kO1ZCmA
{
	internal class FlatMax : Control
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			{
				graphic1.DrawString("1", this.Font, new SolidBrush(this.TextColor), new Rectangle(1, 1, base.Width, base.Height), Helpers.CenterSF);
			}
			else if (base.FindForm().WindowState == FormWindowState.Normal)
			{
				graphic1.DrawString("2", this.Font, new SolidBrush(this.TextColor), new Rectangle(1, 1, base.Width, base.Height), Helpers.CenterSF);
			}
