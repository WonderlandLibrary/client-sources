...
namespace Xh0kO1ZCmA
{
	...
	internal class FlatToggle : Control
	{
		...
		public bool Checked
		{
			...
			{
				this._Checked = value;
				FlatToggle.CheckedChangedEventHandler checkedChangedEventHandler = this.CheckedChanged;
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			switch (this.O)
			{
				...
				case FlatToggle._Options.Style6:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
				...
				case FlatToggle._Options.Style7:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
				...
				case FlatToggle._Options.Style8:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
				...
				case FlatToggle._Options.Style9:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
				...
				case FlatToggle._Options.Style10:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
				...
				case FlatToggle._Options.Style11:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
				...
				case FlatToggle._Options.Style12:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
				...
				case FlatToggle._Options.Style13:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
				...
				case FlatToggle._Options.Style14:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
				...
				case FlatToggle._Options.Style15:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
				...
				case FlatToggle._Options.Style16:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
				...
				case FlatToggle._Options.Style17:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
