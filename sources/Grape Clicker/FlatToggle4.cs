...
namespace Xh0kO1ZCmA
{
	...
	internal class FlatToggle4 : Control
	{
		private int W;

		private int H;

		private FlatToggle4._Options O;
		...
		public bool Checked
		{
			...
			{
				this._Checked = value;
				FlatToggle4.CheckedChangedEventHandler checkedChangedEventHandler = this.CheckedChanged;
		...
		[Category("Options")]
		public FlatToggle4._Options Options
		{
			get
			{
				return this.O;
		...
		public FlatToggle4()
		{
			...
			this.BaseColor2 = Color.FromArgb(255, 63, 63, 63);
		...
		private void DrawFadeEffect(Graphics G)
		{
			...
			solidBrush = (MyProject.Forms.Form1.LightTheme ? new SolidBrush(Color.FromArgb(255, Color.FromArgb(255, 200, 200, 200))) : new SolidBrush(Color.FromArgb(255, Color.FromArgb(255, 83, 83, 83))));
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			switch (this.O)
			{
				case FlatToggle4._Options.Style1:
				{
				...
				case FlatToggle4._Options.Style2:
				{
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Click", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Click", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
				...
				case FlatToggle4._Options.Style3:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Jitter", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Jitter", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
				...
				case FlatToggle4._Options.Style4:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("MC Only", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("MC Only", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
				...
				case FlatToggle4._Options.Style5:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Randomize", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Randomize", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
				...
				case FlatToggle4._Options.Style6:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Break Blocks", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Break Blocks", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
				...
				case FlatToggle4._Options.Style7:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Click Sounds", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Click Sounds", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
				...
				case FlatToggle4._Options.Style8:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("CPS Drops", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("CPS Drops", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
				...
				case FlatToggle4._Options.Style9:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Smart CPS Drops", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Smart CPS Drops", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
				...
				case FlatToggle4._Options.Style10:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Block Hit", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Block Hit", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
				...
				case FlatToggle4._Options.Style11:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("W-Tap", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("W-Tap", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
				...
				case FlatToggle4._Options.Style12:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Throw Potion", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
						}
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Throw Potion", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Throw Potion", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
				...
				case FlatToggle4._Options.Style13:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Rod Trick", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Rod Trick", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
				...
				case FlatToggle4._Options.Style14:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
					...
					g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
					g.DrawString("Ignore Binds In Chat", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
					if (!this.Checked)
					{
						break;
					}
				...
				case FlatToggle4._Options.Style15:
				{
					graphicsPath = Helpers.RoundRec(rectangle, 1);
					if (MyProject.Forms.Form1.LightTheme)
					{
					...
					g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
					g.DrawString("Ignore Binds In Inv", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
					if (!this.Checked)
					{
						break;
					}
				...
				case FlatToggle4._Options.Style16:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Drop Bowls", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
						}
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Drop Bowls", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Drop Bowls", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
				...
				case FlatToggle4._Options.Style17:
				{
					if (MyProject.Forms.Form1.LightTheme)
					{
						graphicsPath = Helpers.RoundRec(rectangle, 1);
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Delete Files", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
						}
					...
					else
					{
						...
						g.DrawString("r", new System.Drawing.Font("Marlett", 8f), new SolidBrush(this.TextColor), new Rectangle(7, 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Delete Files", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(Color.Black), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 51)), 6, base.Width, base.Height), Helpers.NearSF);
						g.DrawString("Delete Files", new System.Drawing.Font("Myriad Pro", 10f), new SolidBrush(this.TextColor), new Rectangle(checked((int)Math.Round((double)this.W / 2 - 50)), 5, base.Width, base.Height), Helpers.NearSF);
						if (!this.Checked)
						{
							break;
		...
		public event FlatToggle4.CheckedChangedEventHandler CheckedChanged;
