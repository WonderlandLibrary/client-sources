...
extends WorldGenAbstractTree {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        int k2 = 3;
        int l2 = 0;
        int i3 = position.getY() - k2 + i;
        while (true) {
            int j1;
            int i4;
            if (i3 <= position.getY() + i) {
        ...
        if (!this.vinesGrow) return true;
        int k3 = position.getY() - 3 + i;
        while (true) {
            if (k3 > position.getY() + i) break;
        ...
        if (rand.nextInt(5) != 0) return true;
        if (i <= 5) return true;
        int l3 = 0;
        while (l3 < 2) {
    ...
    private void func_181650_b(World p_181650_1_, BlockPos p_181650_2_, PropertyBool p_181650_3_) {
        ...
        while (p_181650_1_.getBlockState(p_181650_2_).getBlock().getMaterial() == Material.air) {
            if (i <= 0) return;
            this.func_181651_a(p_181650_1_, p_181650_2_, p_181650_3_);
            p_181650_2_ = p_181650_2_.down();
            --i;
