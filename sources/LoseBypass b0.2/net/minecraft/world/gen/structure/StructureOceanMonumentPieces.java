...
public class StructureOceanMonumentPieces {
    ...
    implements MonumentRoomFitHelper {
        ...
        public boolean func_175969_a(RoomDefinition p_175969_1_) {
            if (!p_175969_1_.field_175966_c[EnumFacing.NORTH.getIndex()]) return false;
            if (p_175969_1_.field_175965_b[EnumFacing.NORTH.getIndex()].field_175963_d) return false;
            return true;
        }
    ...
    implements MonumentRoomFitHelper {
        ...
        public boolean func_175969_a(RoomDefinition p_175969_1_) {
            if (!p_175969_1_.field_175966_c[EnumFacing.NORTH.getIndex()]) return false;
            if (p_175969_1_.field_175965_b[EnumFacing.NORTH.getIndex()].field_175963_d) return false;
            if (!p_175969_1_.field_175966_c[EnumFacing.UP.getIndex()]) return false;
            if (p_175969_1_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d) return false;
            RoomDefinition structureoceanmonumentpieces$roomdefinition = p_175969_1_.field_175965_b[EnumFacing.NORTH.getIndex()];
            if (!structureoceanmonumentpieces$roomdefinition.field_175966_c[EnumFacing.UP.getIndex()]) return false;
            if (structureoceanmonumentpieces$roomdefinition.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d) return false;
            return true;
        }
    ...
    implements MonumentRoomFitHelper {
        ...
        @Override
        public boolean func_175969_a(RoomDefinition p_175969_1_) {
            if (!p_175969_1_.field_175966_c[EnumFacing.EAST.getIndex()]) return false;
            if (p_175969_1_.field_175965_b[EnumFacing.EAST.getIndex()].field_175963_d) return false;
            if (!p_175969_1_.field_175966_c[EnumFacing.UP.getIndex()]) return false;
            if (p_175969_1_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d) return false;
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            if (this.field_175834_o != 1) return true;
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            while (true) {
                if (i > 6) {
                    ...
                    if (!this.field_175830_k.field_175966_c[EnumFacing.SOUTH.getIndex()]) return true;
    ...
    static class RoomDefinition {
        ...
        public boolean func_175961_b() {
            if (this.field_175967_a < 75) return false;
            return true;
        }
    ...
    extends StructureComponent {
        ...
        protected Piece(int p_i45590_1_, EnumFacing p_i45590_2_, RoomDefinition p_i45590_3_, int p_i45590_4_, int p_i45590_5_, int p_i45590_6_) {
            ...
            switch (1.$SwitchMap$net$minecraft$util$EnumFacing[p_i45590_2_.ordinal()]) {
                case 1: {
        ...
        protected boolean func_175817_a(World worldIn, StructureBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_) {
            ...
            if (!p_175817_2_.isVecInside(new BlockPos(i, j = this.getYWithOffset(p_175817_4_), k = this.getZWithOffset(p_175817_3_, p_175817_5_)))) return false;
    ...
    extends Piece {
        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
            ...
            Iterator<Piece> iterator = this.field_175843_q.iterator();
            while (true) {
                if (!iterator.hasNext()) {
                ...
                Piece structureoceanmonumentpieces$piece = iterator.next();
        ...
        private List<RoomDefinition> func_175836_a(Random p_175836_1_) {
             ...
             * 
             * org.benf.cfr.reader.util.ConfusedCFRException: Tried to end blocks [6[UNCONDITIONALDOLOOP]], but top level block is 9[UNCONDITIONALDOLOOP]
        ...
        private void func_175840_a(boolean p_175840_1_, int p_175840_2_, World worldIn, Random p_175840_4_, StructureBoundingBox p_175840_5_) {
            int i = 24;
            if (!this.func_175818_a(p_175840_5_, p_175840_2_, 0, p_175840_2_ + 23, 20)) return;
        ...
        private void func_175839_b(World worldIn, Random p_175839_2_, StructureBoundingBox p_175839_3_) {
            if (!this.func_175818_a(p_175839_3_, 22, 5, 35, 17)) return;
        ...
        private void func_175837_c(World worldIn, Random p_175837_2_, StructureBoundingBox p_175837_3_) {
            if (!this.func_175818_a(p_175837_3_, 15, 20, 42, 21)) return;
        ...
        private void func_175841_d(World worldIn, Random p_175841_2_, StructureBoundingBox p_175841_3_) {
            if (!this.func_175818_a(p_175841_3_, 21, 21, 36, 36)) return;
        ...
        private void func_175835_e(World worldIn, Random p_175835_2_, StructureBoundingBox p_175835_3_) {
            ...
            if (!this.func_175818_a(p_175835_3_, 0, 51, 57, 57)) return;
        ...
        private void func_175842_f(World worldIn, Random p_175842_2_, StructureBoundingBox p_175842_3_) {
            ...
            if (!this.func_175818_a(p_175842_3_, 8, 44, 49, 54)) return;
        ...
        private void func_175838_g(World worldIn, Random p_175838_2_, StructureBoundingBox p_175838_3_) {
            ...
            if (!this.func_175818_a(p_175838_3_, 15, 37, 42, 43)) return;
    ...
    implements MonumentRoomFitHelper {
        ...
        @Override
        public boolean func_175969_a(RoomDefinition p_175969_1_) {
            if (p_175969_1_.field_175966_c[EnumFacing.WEST.getIndex()]) return false;
            if (p_175969_1_.field_175966_c[EnumFacing.EAST.getIndex()]) return false;
            if (p_175969_1_.field_175966_c[EnumFacing.NORTH.getIndex()]) return false;
            if (p_175969_1_.field_175966_c[EnumFacing.SOUTH.getIndex()]) return false;
            if (p_175969_1_.field_175966_c[EnumFacing.UP.getIndex()]) return false;
            return true;
        }
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            if (!this.field_175830_k.field_175966_c[EnumFacing.EAST.getIndex()]) return true;
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            if (!structureoceanmonumentpieces$roomdefinition.field_175966_c[EnumFacing.EAST.getIndex()]) return true;
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            if (!structureoceanmonumentpieces$roomdefinition2.field_175966_c[EnumFacing.EAST.getIndex()]) return true;
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            if (!structureoceanmonumentpieces$roomdefinition3.field_175966_c[EnumFacing.EAST.getIndex()]) return true;
