...
public class ComponentScatteredFeaturePieces {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            while (true) {
                if (i1 > 7) {
                    int k1;
                    int i2;
                    if (this.hasWitch) return true;
                    int l1 = this.getXWithOffset(2, 5);
                    if (!structureBoundingBoxIn.isVecInside(new BlockPos(l1, i2 = this.getYWithOffset(2), k1 = this.getZWithOffset(2, 5)))) return true;
                    this.hasWitch = true;
    ...
    extends Feature {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            if (this.field_74948_i) return true;
