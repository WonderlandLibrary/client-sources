...
public class Vec3 {
    ...
    public Vec3 normalize() {
        ...
        vec3 = new Vec3(this.xCoord / d0, this.yCoord / d0, this.zCoord / d0);
        return vec3;
    }
    ...
    public Vec3 getIntermediateWithXValue(Vec3 vec, double x) {
        ...
        if (!(d3 <= 1.0)) return null;
        Vec3 vec3 = new Vec3(this.xCoord + d0 * d3, this.yCoord + d1 * d3, this.zCoord + d2 * d3);
        return vec3;
    }
