...
public class MathHelper {
    ...
    public static int getRandomIntegerInRange(Random p_76136_0_, int p_76136_1_, int p_76136_2_) {
        ...
        n = p_76136_0_.nextInt(p_76136_2_ - p_76136_1_ + 1) + p_76136_1_;
        return n;
    }
    ...
    public static boolean epsilonEquals(float p_180185_0_, float p_180185_1_) {
        if (!(MathHelper.abs(p_180185_1_ - p_180185_0_) < 1.0E-5f)) return false;
        return true;
    }
    ...
    public static int calculateLogBaseTwo(int value) {
        int n;
        int n2 = MathHelper.calculateLogBaseTwoDeBruijn(value);
        if (MathHelper.isPowerOfTwo(value)) {
            n = 0;
            return n2 - n;
        }
        n = 1;
    ...
    public static int func_154354_b(int p_154354_0_, int p_154354_1_) {
        ...
        if ((i = p_154354_0_ % p_154354_1_) == 0) {
            n = p_154354_0_;
            return n;
        }
        n = p_154354_0_ + p_154354_1_ - i;
        return n;
    }
