...
extends Vec3i {
    ...
    public BlockPos add(double x, double y, double z) {
        ...
        blockPos = new BlockPos((double)this.getX() + x, (double)this.getY() + y, (double)this.getZ() + z);
        return blockPos;
    }
    ...
    public BlockPos add(int x, int y, int z) {
        ...
        blockPos = new BlockPos(this.getX() + x, this.getY() + y, this.getZ() + z);
        return blockPos;
    }
    ...
    public BlockPos add(Vec3i vec) {
        ...
        blockPos = new BlockPos(this.getX() + vec.getX(), this.getY() + vec.getY(), this.getZ() + vec.getZ());
        return blockPos;
    }
    ...
    public BlockPos offset(EnumFacing facing, int n) {
        ...
        blockPos = new BlockPos(this.getX() + facing.getFrontOffsetX() * n, this.getY() + facing.getFrontOffsetY() * n, this.getZ() + facing.getFrontOffsetZ() * n);
        return blockPos;
    }
