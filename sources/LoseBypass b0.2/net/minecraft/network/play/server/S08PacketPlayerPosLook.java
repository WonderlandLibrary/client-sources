...
implements Packet<INetHandlerPlayClient> {
    ...
    public static enum EnumFlags {
        ...
        private boolean func_180054_b(int p_180054_1_) {
            if ((p_180054_1_ & this.func_180055_a()) != this.func_180055_a()) return false;
            return true;
        }
        ...
        public static Set<EnumFlags> func_180053_a(int p_180053_0_) {
            ...
            int n2 = 0;
            while (n2 < n) {
                EnumFlags s08packetplayerposlook$enumflags = enumFlagsArray[n2];
        ...
        public static int func_180056_a(Set<EnumFlags> p_180056_0_) {
            int i = 0;
            Iterator<EnumFlags> iterator = p_180056_0_.iterator();
