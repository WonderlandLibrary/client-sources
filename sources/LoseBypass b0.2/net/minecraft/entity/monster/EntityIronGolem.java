...
extends EntityGolem {
    ...
    public void onLivingUpdate() {
        ...
        if (!(this.motionX * this.motionX + this.motionZ * this.motionZ > 2.500000277905201E-7)) return;
        if (this.rand.nextInt(5) != 0) return;
        int i = MathHelper.floor_double(this.posX);
        IBlockState iblockstate = this.worldObj.getBlockState(new BlockPos(i, j = MathHelper.floor_double(this.posY - (double)0.2f), k = MathHelper.floor_double(this.posZ)));
    ...
    public boolean canAttackClass(Class<? extends EntityLivingBase> cls) {
        ...
        boolean bl = super.canAttackClass(cls);
        return bl;
    }
        ...
        public AINearestAttackableTargetNonCreeper(final EntityCreature creature, Class<T> classTarget, int chance, boolean p_i45858_4_, boolean p_i45858_5_, final Predicate<? super T> p_i45858_6_) {
            ...
            this.targetEntitySelector = new Predicate<T>(){
                ...
                public boolean apply(T p_apply_1_) {
                    ...
                    if (!(p_apply_1_ instanceof EntityPlayer)) return this.isSuitableTarget(p_apply_1_, false);
                    ...
                    if (!((double)((Entity)p_apply_1_).getDistanceToEntity(creature) > d0)) return this.isSuitableTarget(p_apply_1_, false);
                    return false;
                }
            };
        }
