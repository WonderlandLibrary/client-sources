...
extends Block {
    ...
    public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
        ...
        if (worldIn.getBlockState(pos.east()).getBlock().isNormalCube()) {
            return true;
        }
        if (worldIn.getBlockState(pos.north()).getBlock().isNormalCube()) {
            return true;
        }
        boolean bl = worldIn.getBlockState(pos.south()).getBlock().isNormalCube();
        return bl;
    }
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        ...
        } while (!this.canBlockStay(worldIn, pos, enumfacing = iterator.next()));
