...
implements INetHandlerPlayClient {
    ...
    public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
        ...
        if (packetIn.func_149009_m() <= 0) return;
    ...
    public void handleEntityMetadata(S1CPacketEntityMetadata packetIn) {
        ...
        Entity entity = this.clientWorldController.getEntityByID(packetIn.getEntityId());
        if (entity == null) return;
        if (packetIn.func_149376_c() == null) return;
    ...
    public void handleHeldItemChange(S09PacketHeldItemChange packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        if (packetIn.getHeldItemHotbarIndex() < 0) return;
        if (packetIn.getHeldItemHotbarIndex() >= InventoryPlayer.getHotbarSize()) return;
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
        ...
        if (this.doneLoadingTerrain) return;
    ...
    public void handleChunkData(S21PacketChunkData packetIn) {
        ...
        if (packetIn.func_149274_i()) {
            if (this.clientWorldController.provider instanceof WorldProviderSurface) return;
        }
    ...
    public void handleSetSlot(S2FPacketSetSlot packetIn) {
        ...
        if (packetIn.func_149175_c() != entityplayer.openContainer.windowId) return;
    ...
    public void handleConfirmTransaction(S32PacketConfirmTransaction packetIn) {
        ...
        if (packetIn.func_148888_e()) return;
    ...
    public void handleWindowItems(S30PacketWindowItems packetIn) {
        ...
        if (packetIn.func_148911_c() != entityplayer.openContainer.windowId) return;
    ...
    public void handleUpdateTileEntity(S35PacketUpdateTileEntity packetIn) {
        ...
        if (!(i == 1 && tileentity instanceof TileEntityMobSpawner || i == 2 && tileentity instanceof TileEntityCommandBlock || i == 3 && tileentity instanceof TileEntityBeacon || i == 4 && tileentity instanceof TileEntitySkull || i == 5 && tileentity instanceof TileEntityFlowerPot)) {
            if (i != 6) return;
            if (!(tileentity instanceof TileEntityBanner)) return;
        }
    ...
    public void handleWindowProperty(S31PacketWindowProperty packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        EntityPlayerSP entityplayer = this.gameController.thePlayer;
        if (entityplayer.openContainer == null) return;
        if (entityplayer.openContainer.windowId != packetIn.getWindowId()) return;
    ...
    public void handleStatistics(S37PacketStatistics packetIn) {
        ...
        if (!(this.gameController.currentScreen instanceof IProgressMeter)) return;
    ...
    public void handleCombatEvent(S42PacketCombatEvent packetIn) {
        ...
        if (packetIn.eventType != S42PacketCombatEvent.Event.ENTITY_DIED) return;
        Entity entity1 = this.clientWorldController.getEntityByID(packetIn.field_179774_b);
        if (!(entity1 instanceof EntityPlayer)) return;
    ...
    public void handleSetCompressionLevel(S46PacketSetCompressionLevel packetIn) {
        if (this.netManager.isLocalChannel()) return;
    ...
    public void handlePlayerListItem(S38PacketPlayerListItem packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Iterator<S38PacketPlayerListItem.AddPlayerData> iterator = packetIn.func_179767_a().iterator();
        block6: while (iterator.hasNext()) {
            S38PacketPlayerListItem.AddPlayerData s38packetplayerlistitem$addplayerdata = iterator.next();
    ...
    public void handleTabComplete(S3APacketTabComplete packetIn) {
        ...
        if (!(this.gameController.currentScreen instanceof GuiChat)) return;
    ...
    public void handleResourcePack(S48PacketResourcePackSend packetIn) {
        ...
        if (this.gameController.getCurrentServerData() != null && this.gameController.getCurrentServerData().getResourceMode() != ServerData.ServerResourceMode.PROMPT) {
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn) {
        ...
        if ("MC|TrList".equals(packetIn.getChannelName())) {
            ...
            try {
                ...
                if (!(guiscreen instanceof GuiMerchant)) return;
                if (i != this.gameController.thePlayer.openContainer.windowId) return;
    ...
    public void handleScoreboardObjective(S3BPacketScoreboardObjective packetIn) {
        ...
        if (packetIn.func_149338_e() != 2) return;
    ...
    public void handleUpdateScore(S3CPacketUpdateScore packetIn) {
        ...
        if (packetIn.getScoreAction() != S3CPacketUpdateScore.Action.REMOVE) return;
    ...
    public void handleTeams(S3EPacketTeams packetIn) {
        ...
        if (packetIn.func_149307_h() != 1) return;
    ...
    public void handleEntityProperties(S20PacketEntityProperties packetIn) {
        ...
        Iterator<S20PacketEntityProperties.Snapshot> iterator = packetIn.func_149441_d().iterator();
        block0: while (iterator.hasNext()) {
            S20PacketEntityProperties.Snapshot s20packetentityproperties$snapshot = iterator.next();
    ...
    public NetworkPlayerInfo getPlayerInfo(String p_175104_1_) {
        ...
        Iterator<NetworkPlayerInfo> iterator = this.playerInfoMap.values().iterator();
        do {
            if (!iterator.hasNext()) return null;
        } while (!(networkplayerinfo = iterator.next()).getGameProfile().getName().equals(p_175104_1_));
