...
implements GuiListExtended.IGuiListEntry {
    ...
    protected boolean func_148309_e() {
        if (this.resourcePacksGUI.hasResourcePackEntry(this)) return false;
        return true;
    }
    ...
    protected boolean func_148314_g() {
        ...
        if (i <= 0) return false;
        if (!list.get(i - 1).func_148310_d()) return false;
        return true;
    }
    ...
    public boolean mousePressed(int slotIndex, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_) {
        if (!this.func_148310_d()) return false;
        if (p_148278_5_ > 32) return false;
        if (this.func_148309_e()) {
        ...
        if (p_148278_5_ <= 16) return false;
        if (p_148278_6_ <= 16) return false;
        if (!this.func_148307_h()) return false;
        List<ResourcePackListEntry> list = this.resourcePacksGUI.getListContaining(this);
        int i = list.indexOf(this);
        list.remove(this);
        list.add(i + 1, this);
