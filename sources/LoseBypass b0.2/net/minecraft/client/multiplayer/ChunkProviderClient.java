...
implements IChunkProvider {
    ...
    public Chunk provideChunk(int x, int z) {
        Chunk chunk;
        Chunk chunk2 = this.chunkMapping.getValueByKey(ChunkCoordIntPair.chunkXZ2Int(x, z));
        if (chunk2 == null) {
    ...
    public boolean unloadQueuedChunks() {
        ...
        Iterator<Chunk> iterator = this.chunkListing.iterator();
        while (true) {
            if (!iterator.hasNext()) {
                if (System.currentTimeMillis() - i <= 100L) return false;
