...
public class GlStateManager {
    ...
    public static void alphaFunc(int func, float ref) {
        if (func == GlStateManager.alphaState.func) {
            if (ref == GlStateManager.alphaState.ref) return;
        }
    ...
    public static void colorMaterial(int face, int mode) {
        if (face == GlStateManager.colorMaterialState.field_179189_b) {
            if (mode == GlStateManager.colorMaterialState.field_179190_c) return;
        }
    ...
    public static void depthFunc(int depthFunc) {
        if (depthFunc == GlStateManager.depthState.depthFunc) return;
        GlStateManager.depthState.depthFunc = depthFunc;
        GL11.glDepthFunc((int)depthFunc);
    }

    public static void depthMask(boolean flagIn) {
        if (flagIn == GlStateManager.depthState.maskEnabled) return;
    ...
    public static void blendFunc(int srcFactor, int dstFactor) {
        if (srcFactor == GlStateManager.blendState.srcFactor) {
            if (dstFactor == GlStateManager.blendState.dstFactor) return;
        }
    ...
    public static void tryBlendFuncSeparate(int srcFactor, int dstFactor, int srcFactorAlpha, int dstFactorAlpha) {
        if (srcFactor == GlStateManager.blendState.srcFactor && dstFactor == GlStateManager.blendState.dstFactor && srcFactorAlpha == GlStateManager.blendState.srcFactorAlpha) {
            if (dstFactorAlpha == GlStateManager.blendState.dstFactorAlpha) return;
        }
        GlStateManager.blendState.srcFactor = srcFactor;
        GlStateManager.blendState.dstFactor = dstFactor;
    ...
    public static void cullFace(int mode) {
        if (mode == GlStateManager.cullState.field_179053_b) return;
    ...
    public static void doPolygonOffset(float factor, float units) {
        if (factor == GlStateManager.polygonOffsetState.field_179043_c) {
            if (units == GlStateManager.polygonOffsetState.field_179041_d) return;
        }
    ...
    public static void colorLogicOp(int opcode) {
        if (opcode == GlStateManager.colorLogicState.field_179196_b) return;
    ...
    public static void texGen(TexGen p_179149_0_, int p_179149_1_) {
        ...
        if (p_179149_1_ == glstatemanager$texgencoord.field_179066_c) return;
    ...
    public static void setActiveTexture(int texture) {
        if (activeTextureUnit == texture - OpenGlHelper.defaultTexUnit) return;
    ...
    public static void deleteTexture(int texture) {
        ...
        int n = textureStateArray.length;
        int n2 = 0;
        while (n2 < n) {
    ...
    public static void bindTexture(int texture) {
        if (texture == GlStateManager.textureState[GlStateManager.activeTextureUnit].textureName) return;
    ...
    public static void shadeModel(int mode) {
        if (mode == activeShadeModel) return;
    ...
    public static void colorMask(boolean red, boolean green, boolean blue, boolean alpha) {
        if (red == GlStateManager.colorMaskState.red && green == GlStateManager.colorMaskState.green && blue == GlStateManager.colorMaskState.blue) {
            if (alpha == GlStateManager.colorMaskState.alpha) return;
        }
    ...
    public static void clearDepth(double depth) {
        if (depth == GlStateManager.clearState.field_179205_a) return;
        GlStateManager.clearState.field_179205_a = depth;
        GL11.glClearDepth((double)depth);
    }

    public static void clearColor(float red, float green, float blue, float alpha) {
        if (red == GlStateManager.clearState.field_179203_b.red && green == GlStateManager.clearState.field_179203_b.green && blue == GlStateManager.clearState.field_179203_b.blue) {
            if (alpha == GlStateManager.clearState.field_179203_b.alpha) return;
        }
    ...
    public static void color(float colorRed, float colorGreen, float colorBlue, float colorAlpha) {
        if (colorRed == GlStateManager.colorState.red && colorGreen == GlStateManager.colorState.green && colorBlue == GlStateManager.colorState.blue) {
            if (colorAlpha == GlStateManager.colorState.alpha) return;
        }
