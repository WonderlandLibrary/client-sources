...
implements ITickableTextureObject {
    ...
    public void loadTextureAtlas(IResourceManager resourceManager) {
            ...
            try {
                ...
                if (texturemetadatasection != null) {
                    ...
                    if (!list.isEmpty()) {
                        ...
                        if (MathHelper.roundUpToPowerOfTwo(l) != l) throw new RuntimeException("Unable to load extra miplevels, source-texture is not power of two");
                        if (MathHelper.roundUpToPowerOfTwo(i1) != i1) {
                    ...
                    for (int i2 : list) {
                        ...
                        try {
                            ...
                            logger.error("Unable to load miplevel {} from: {}", new Object[]{i2, resourcelocation2, ioexception});
                        }
                    }
                }
        ...
        Iterator<TextureAtlasSprite> iterator = map.values().iterator();
        while (iterator.hasNext()) {
            TextureAtlasSprite textureatlassprite3 = iterator.next();
    ...
    public void updateAnimations() {
        ...
        Iterator<TextureAtlasSprite> iterator = this.listAnimatedSprites.iterator();
        while (iterator.hasNext()) {
            TextureAtlasSprite textureatlassprite = iterator.next();
