...
public class RenderManager {
    ...
    public <T extends Entity> Render<T> getEntityClassRenderObject(Class<? extends Entity> p_78715_1_) {
        ...
        if (p_78715_1_ == Entity.class) return render;
    ...
    public <T extends Entity> Render<T> getEntityRenderObject(Entity entityIn) {
        ...
        if (!(entityIn instanceof AbstractClientPlayer)) return this.getEntityClassRenderObject(entityIn.getClass());
        ...
        renderPlayer = this.playerRenderer;
        return renderPlayer;
    }
    ...
    public boolean shouldRender(Entity entityIn, ICamera camera, double camX, double camY, double camZ) {
        ...
        if (!render.shouldRender(entityIn, camera, camX, camY, camZ)) return false;
        return true;
    }
    ...
    public boolean doRenderEntity(Entity entity, double x, double y, double z, float entityYaw, float partialTicks, boolean p_147939_10_) {
        ...
        try {
            ...
            if (this.renderEngine == null) return true;
            return false;
        }
