...
import com.wallhacks.losebypass.utils.skinlayers.renderLayers.BodyLayerFeatureRenderer;
import com.wallhacks.losebypass.utils.skinlayers.renderLayers.HeadLayerFeatureRenderer;
...
extends RendererLivingEntity<AbstractClientPlayer> {
    ...
    public HeadLayerFeatureRenderer headLayer;
    public BodyLayerFeatureRenderer bodyLayer;
    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if (entity.isUser() && this.renderManager.livingPlayer != entity) {
            if (Freecam.fakePlayer == null) return;
        }
        double d0 = y;
    ...
    private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
        ...
        if (clientPlayer.getItemInUseCount() <= 0) return;
        EnumAction enumaction = itemstack.getItemUseAction();
        if (enumaction == EnumAction.BLOCK) {
            modelplayer.heldItemRight = 3;
            return;
        }
        if (enumaction != EnumAction.BOW) return;
    ...
    private void renderFirstPersonArm(AbstractClientPlayer player, int layerId) {
        ...
        if (!ThreeDSkins.enabled()) return;
        if (!ThreeDSkins.hands()) return;
        ModelPlayer modelplayer = this.getMainModel();
        ...
        player.getSkinLayers()[layerId].x = !this.smallArms ? -15.968f : -7.984f;
    ...
    private boolean setupModel(AbstractClientPlayer abstractClientPlayerEntity) {
        ...
        SkinUtil.setup3dLayers(abstractClientPlayerEntity, this.smallArms, null);
        return true;
    }
    ...
    public void renderRightArm(AbstractClientPlayer clientPlayer) {
        ...
        this.renderFirstPersonArm(clientPlayer, 3);
    }
    ...
    public void renderLeftArm(AbstractClientPlayer clientPlayer) {
        ...
        this.renderFirstPersonArm(clientPlayer, 2);
    }
