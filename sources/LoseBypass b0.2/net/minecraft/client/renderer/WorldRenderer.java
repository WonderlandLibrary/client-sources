...
public class WorldRenderer {
    ...
    private void func_181670_b(int p_181670_1_) {
        if (p_181670_1_ <= this.rawIntBuffer.remaining()) return;
    ...
    public WorldRenderer tex(double p_181673_1_, double p_181673_3_) {
        ...
        switch (2.$SwitchMap$net$minecraft$client$renderer$vertex$VertexFormatElement$EnumType[this.field_181677_f.getType().ordinal()]) {
            case 1: {
    ...
    private void func_181667_k() {
        ...
        if (this.field_181677_f.getUsage() != VertexFormatElement.EnumUsage.PADDING) return;
        this.func_181667_k();
    }
