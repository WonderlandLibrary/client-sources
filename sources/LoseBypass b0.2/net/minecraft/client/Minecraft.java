...
import com.wallhacks.losebypass.gui.GuiLogin;
import com.wallhacks.losebypass.systems.module.modules.combat.NoHitDelay;
...
IPlayerUsage {
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle((String)"LoseBypass | b0.2");
        try {
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException {
        ...
        IOUtils.closeQuietly(inputstream);
        GuiUtil.drawRect(0.0f, 0.0f, this.displayWidth, this.displayHeight, ClickGui.background2());
        GuiUtil.drawCompleteImage((float)scaledresolution.getScaledWidth() / 2.0f - 90.0f, (float)scaledresolution.getScaledHeight() / 2.0f - 100.0f, 200.0, 200.0, new ResourceLocation("textures/icons/logosimple.png"), new Color(44, 92, 118, 255));
        GlStateManager.disableLighting();
        GlStateManager.disableFog();
    ...
    private void updateDebugProfilerName(int keyCount) {
        ...
        if (list.get((int)keyCount).field_76331_c.equals("unspecified")) return;
    ...
    private void rightClickMouse() {
        ...
        if (!this.playerController.sendUseItem(this.thePlayer, this.theWorld, itemstack1)) return;
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState() && LoseBypass.mc.currentScreen == null) {
                    InputEvent event = new InputEvent(Keyboard.getEventKey() == 0 ? Keyboard.getEventCharacter() + 256 : Keyboard.getEventKey());
                    LoseBypass.eventBus.post(event);
                }
    ...
    public NetHandlerPlayClient getNetHandler() {
        ...
        NetHandlerPlayClient netHandlerPlayClient = this.thePlayer.sendQueue;
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash) {
        ...
        theCrash.getCategory().addCrashSectionCallable("Resource Packs", new Callable<String>(){
            ...
            public String call() throws Exception {
                ...
                Iterator<String> iterator = Minecraft.this.gameSettings.resourcePacks.iterator();
    ...
    public MusicTicker.MusicType getAmbientMusicType() {
        ...
        if (this.thePlayer.worldObj.provider instanceof WorldProviderEnd) {
        ...
        if (this.thePlayer.capabilities.isCreativeMode && this.thePlayer.capabilities.allowFlying) {
