...
extends Gui {
    ...
    public String getPlayerName(NetworkPlayerInfo networkPlayerInfoIn) {
        ...
        string = ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(), networkPlayerInfoIn.getGameProfile().getName());
        return string;
    }
    ...
    implements Comparator<NetworkPlayerInfo> {
        ...
        public int compare(NetworkPlayerInfo p_compare_1_, NetworkPlayerInfo p_compare_2_) {
            ...
            ComparisonChain comparisonChain = ComparisonChain.start().compareTrueFirst(p_compare_1_.getGameType() != WorldSettings.GameType.SPECTATOR, p_compare_2_.getGameType() != WorldSettings.GameType.SPECTATOR);
            String string2 = scoreplayerteam != null ? scoreplayerteam.getRegisteredName() : "";
            if (scoreplayerteam1 != null) {
                string = scoreplayerteam1.getRegisteredName();
                return comparisonChain.compare((Comparable<?>)((Object)string2), (Comparable<?>)((Object)string)).compare((Comparable<?>)((Object)p_compare_1_.getGameProfile().getName()), (Comparable<?>)((Object)p_compare_2_.getGameProfile().getName())).result();
            }
            string = "";
            return comparisonChain.compare((Comparable<?>)((Object)string2), (Comparable<?>)((Object)string)).compare((Comparable<?>)((Object)p_compare_1_.getGameProfile().getName()), (Comparable<?>)((Object)p_compare_2_.getGameProfile().getName())).result();
        }
