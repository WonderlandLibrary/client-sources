...
GuiPageButtonList.GuiResponder {
    ...
    private Predicate<String> field_175332_D = new Predicate<String>(){
        ...
        public boolean apply(String p_apply_1_) {
            ...
            if (p_apply_1_.length() == 0) return true;
            if (f == null) return false;
            if (!Floats.isFinite(f.floatValue())) return false;
            if (!(f.floatValue() >= 0.0f)) return false;
            return true;
        }
    };
    ...
    public void func_175319_a(int p_175319_1_, String p_175319_2_) {
        ...
        if (this.field_175336_F.equals(this.field_175334_E)) return;
    ...
    private String func_175330_b(int p_175330_1_, float p_175330_2_) {
        ...
        if ((int)p_175330_2_ >= BiomeGenBase.hell.biomeID) {
            ...
            if (biomegenbase1 == null) return "?";
            String string = biomegenbase1.biomeName;
            return string;
        }
        BiomeGenBase biomegenbase = BiomeGenBase.getBiomeGenArray()[(int)p_175330_2_];
        if (biomegenbase == null) return "?";
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        if (this.field_175339_B != 0) return;
        switch (keyCode) {
            case 200: {
    ...
    private void func_175327_a(float p_175327_1_) {
        ...
        if (!(gui instanceof GuiTextField)) return;
        float f = p_175327_1_;
        ...
        if ((f1 = Floats.tryParse((guitextfield = (GuiTextField)gui).getText())) == null) return;
