...
extends GuiScreen {
    ...
    private void func_146314_g() {
        ...
        int n = cArray.length;
        for (int n2 = 0; n2 < n; this.field_146336_i = this.field_146336_i.replace(c0, '_'), ++n2) {
            c0 = cArray[n2];
        }
    ...
    private boolean func_175299_g() {
        ...
        if (!worldtype.getCanBeCreated()) return false;
        if (worldtype != WorldType.DEBUG_WORLD) return true;
        boolean bl = GuiCreateWorld.isShiftKeyDown();
        return bl;
    }
    ...
    public void func_146318_a(WorldInfo p_146318_1_) {
        ...
        if (p_146318_1_.getGameType().isSurvivalOrAdventure()) {
            this.gameMode = "survival";
            return;
        }
        if (!p_146318_1_.getGameType().isCreative()) return;
        this.gameMode = "creative";
    }
}
