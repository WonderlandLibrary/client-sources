...
extends GuiListExtended {
    ...
    public void func_181156_c(int p_181156_1_) {
        if (p_181156_1_ == this.field_178077_y) return;
    ...
    public void func_178071_h() {
        if (this.field_178077_y <= 0) return;
        this.func_181156_c(this.field_178077_y - 1);
    }

    public void func_178064_i() {
        if (this.field_178077_y >= this.field_178078_x.length - 1) return;
        this.func_181156_c(this.field_178077_y + 1);
    }
    ...
    private void func_178060_e(int p_178060_1_, int p_178060_2_) {
        ...
        GuiListEntry[] guiListEntryArray = this.field_178078_x[p_178060_2_];
        int n = guiListEntryArray.length;
        int n2 = 0;
        while (n2 < n) {
    ...
    private void func_178066_a(Gui p_178066_1_, boolean p_178066_2_) {
        ...
        if (p_178066_1_ instanceof GuiTextField) {
            ((GuiTextField)p_178066_1_).setVisible(p_178066_2_);
            return;
        }
        if (!(p_178066_1_ instanceof GuiLabel)) return;
    ...
    private Gui func_178058_a(GuiListEntry p_178058_1_, int p_178058_2_, boolean p_178058_3_) {
        ...
        if (p_178058_1_ instanceof GuiSlideEntry) {
            gui = this.func_178067_a(this.width / 2 - 155 + p_178058_2_, 0, (GuiSlideEntry)p_178058_1_);
            return gui;
        }
        if (p_178058_1_ instanceof GuiButtonEntry) {
            gui = this.func_178065_a(this.width / 2 - 155 + p_178058_2_, 0, (GuiButtonEntry)p_178058_1_);
            return gui;
        }
        if (p_178058_1_ instanceof EditBoxEntry) {
            gui = this.func_178068_a(this.width / 2 - 155 + p_178058_2_, 0, (EditBoxEntry)p_178058_1_);
            return gui;
        }
        if (!(p_178058_1_ instanceof GuiLabelEntry)) return null;
        gui = this.func_178063_a(this.width / 2 - 155 + p_178058_2_, 0, (GuiLabelEntry)p_178058_1_, p_178058_3_);
        return gui;
    }

    public void func_181155_a(boolean p_181155_1_) {
        Iterator<GuiEntry> iterator = this.field_178074_u.iterator();
        while (iterator.hasNext()) {
            GuiEntry guipagebuttonlist$guientry = iterator.next();
    ...
    public void func_178062_a(char p_178062_1_, int p_178062_2_) {
        int i;
        if (!(this.field_178075_A instanceof GuiTextField)) return;
    ...
    implements GuiListExtended.IGuiListEntry {
        ...
        private void func_178017_a(Gui p_178017_1_, int p_178017_2_, int p_178017_3_, int p_178017_4_, boolean p_178017_5_) {
            ...
            if (p_178017_1_ instanceof GuiTextField) {
                this.func_178027_a((GuiTextField)p_178017_1_, p_178017_2_, p_178017_5_);
                return;
            }
            if (!(p_178017_1_ instanceof GuiLabel)) return;
        ...
        private boolean func_178026_a(Gui p_178026_1_, int p_178026_2_, int p_178026_3_, int p_178026_4_) {
            ...
            if (!(p_178026_1_ instanceof GuiTextField)) return false;
        ...
        private void func_178018_a(GuiTextField p_178018_1_, int p_178018_2_, int p_178018_3_, int p_178018_4_) {
            ...
            if (!p_178018_1_.isFocused()) return;
        ...
        private void func_178016_b(Gui p_178016_1_, int p_178016_2_, int p_178016_3_, int p_178016_4_) {
            if (p_178016_1_ == null) return;
            if (!(p_178016_1_ instanceof GuiButton)) return;
