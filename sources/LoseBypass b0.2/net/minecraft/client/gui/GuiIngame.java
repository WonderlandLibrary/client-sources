...
extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (FreeLook.getPerspective() == 0 && itemstack != null && itemstack.getItem() == Item.getItemFromBlock(Blocks.pumpkin)) {
        ...
        LoseBypass.eventBus.post(new Render2DEvent(partialTicks));
    ...
    public void renderExpBar(ScaledResolution p_175176_1_, int p_175176_2_) {
        ...
        this.mc.mcProfiler.endSection();
        if (this.mc.thePlayer.experienceLevel <= 0) return;
    ...
    protected boolean showCrosshair() {
        ...
        if (!this.mc.playerController.isSpectator()) return true;
        if (this.mc.pointedEntity != null) {
            return true;
        }
        if (this.mc.objectMouseOver == null) return false;
        if (this.mc.objectMouseOver.typeOfHit != MovingObjectPosition.MovingObjectType.BLOCK) return false;
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
        ...
        ArrayList<Score> list = Lists.newArrayList(Iterables.filter(collection, new Predicate<Score>(){
            ...
            public boolean apply(Score p_apply_1_) {
                if (p_apply_1_.getPlayerName() == null) return false;
                if (p_apply_1_.getPlayerName().startsWith("#")) return false;
                return true;
            }
        }));
    ...
    private void renderBossHealth() {
        if (BossStatus.bossName == null) return;
        if (BossStatus.statusBarTime <= 0) return;
    ...
    public void displayTitle(String p_175178_1_, String p_175178_2_, int p_175178_3_, int p_175178_4_, int p_175178_5_) {
        ...
        if (this.field_175195_w <= 0) return;
        this.field_175195_w = this.field_175199_z + this.field_175192_A + this.field_175193_B;
    }
