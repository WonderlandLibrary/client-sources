...
implements GuiYesNoCallback {
    ...
    private boolean func_183501_a() {
        if (!Minecraft.getMinecraft().gameSettings.getOptionOrdinalValue(GameSettings.Options.REALMS_NOTIFICATIONS)) return false;
        if (this.field_183503_M == null) return false;
        return true;
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        LoseBypass.altManager.render(mouseX, mouseY, deltaTime);
    }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        LoseBypass.altManager.mouseClick();
    }

    @Override
    public void onGuiClosed() {
        if (this.field_183503_M == null) return;
