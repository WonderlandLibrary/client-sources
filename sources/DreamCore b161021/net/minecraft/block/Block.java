...
import org.dreamcore.client.feature.impl.player.ClipHelper;
...
public class Block
{
    ...
    {
        if (dreamcore.instance.featureManager.getFeatureByClass(ClipHelper.class).getState() && ClipHelper.disableBlockLight.getBoolValue()) {
            return false;
        }
    ...
    {
        Block block = state.getBlock();
        if (((NoInteract.craftTable.getBoolValue() && Block.getIdFromBlock(block) == 58) || (NoInteract.standing.getBoolValue() && Block.getIdFromBlock(block) == 63) || (NoInteract.door.getBoolValue() && Block.getIdFromBlock(block) == 193) || (NoInteract.door.getBoolValue() &Block.getIdFromBlock(block) == 194) || (NoInteract.door.getBoolValue() &Block.getIdFromBlock(block) == 195) || (NoInteract.door.getBoolValue() &&Block.getIdFromBlock(block) == 196) || (NoInteract.door.getBoolValue() &&Block.getIdFromBlock(block) == 197) || (NoInteract.hopper.getBoolValue() && Block.getIdFromBlock(block) == 154) || (NoInteract.furnace.getBoolValue() && Block.getIdFromBlock(block) == 61) || (NoInteract.dispenser.getBoolValue() && Block.getIdFromBlock(block) == 23) || (NoInteract.anvil.getBoolValue() && Block.getIdFromBlock(block) == 145) || (NoInteract.woodenslab.getBoolValue() && Block.getIdFromBlock(block) == 158) || (NoInteract.lever.getBoolValue() && Block.getIdFromBlock(block) == 69)) && (dreamcore.instance.featureManager.getFeatureByClass(NoInteract.class).getState())) {
            return false;
        }
