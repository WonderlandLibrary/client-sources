...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        if (dreamcore.instance.featureManager.getFeatureByClass(NoRender.class).getState() && NoRender.swing.getBoolValue()) {
            return;
        }
    ...
    protected void jump()
    {
        ...
        if (EntityPlayerSP.class.isInstance(this)) {
            ...
            if (baritone != null) {
                RotationMoveEvent jumpRotationEvent = new RotationMoveEvent(RotationMoveEvent.Type.JUMP, this.rotationYaw);
    ...
    public int getItemInUseDuration() {
        return isUsingItem() ? (this.activeItemStack.getMaxItemUseDuration() - this.getItemInUseCount()) : 0;
    }
