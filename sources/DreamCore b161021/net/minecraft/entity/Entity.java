...
import org.dreamcore.client.event.events.impl.motion.EventStep;
...
import org.dreamcore.client.feature.impl.movement.Scaffold;
...
public abstract class Entity implements ICommandSender {
    ...
    public float getDistanceToTileEntity(TileEntity entityIn) {
        float f = (float) (this.posX - entityIn.getPos().getX());
        float f1 = (float) (this.posY - entityIn.getPos().getY());
        float f2 = (float) (this.posZ - entityIn.getPos().getZ());
        return MathHelper.sqrt(f * f + f1 * f1 + f2 * f2);
    }
    ...
    public void applyEntityCollision(Entity entityIn) {
        if (dreamcore.instance.featureManager.getFeatureByClass(AntiPush.class).getState() && AntiPush.players.getBoolValue())
            return;
