...
import org.dreamcore.client.feature.impl.combat.KeepSprint;
...
public abstract class EntityPlayer extends EntityLivingBase
{
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag5)
                    {
                        if (i > 0)
                        {
                            ...
                            if(dreamcore.instance.featureManager.getFeatureByClass(KeepSprint.class).getState()) {
    ...
    {
        if (dreamcore.instance.featureManager.getFeatureByClass(AntiPush.class).getState() && AntiPush.water.getBoolValue())
            return false;
        return !this.capabilities.isFlying;
    }
