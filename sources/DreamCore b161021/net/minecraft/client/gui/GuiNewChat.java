...
public class GuiNewChat extends Gui
{
    ...
    public void drawChat(int updateCounter)
    {
        ...
        offset += deltaY;
        deltaY /= Math.pow(.99, -Minecraft.frameTime);
        if((int)offset != 0 && (int)offset % 8 == 0) {
            offset = 8;
        }
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                int i2 = 0;
                                int j2 = -i1 * 9;
                                RectHelper.drawRect(-2, j2 - 1 - offset - HUD.globalOffset / 5, k + 4, j2 + 8 - offset - HUD.globalOffset / 5, l1 / 2 << 24);
                                String s = chatline.getChatComponent().getFormattedText();
                                GlStateManager.enableBlend();
                                mc.fontRendererObj.drawStringWithShadow(s, 0.0F, (float)(j2 - offset - HUD.globalOffset / 5), 16777215 + (l1 << 24));
