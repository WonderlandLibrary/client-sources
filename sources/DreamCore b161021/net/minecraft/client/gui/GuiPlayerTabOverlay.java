...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, @Nullable ScoreObjective scoreObjectiveIn) {
        ...
        GlStateManager.translate(-width / 2F, -k1 / 2F, 1);
        ...
        for (int k4 = 0; k4 < l3; ++k4)
        {
            ...
            if (k4 < list.size())
            {
                ...
                if (dreamcore.instance.featureManager.getFeatureByClass(StreamerMode.class).getState()) {
                    if (StreamerMode.tabSpoof.getBoolValue() && !s4.contains(mc.player.getName())) {
                        s4 = "\247aProtected";
                    }
    ...
    protected void drawPing(int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo networkPlayerInfoIn)
    {
        ...
        if(dreamcore.instance.featureManager.getFeatureByClass(Disabler.class).getState()) {
            if(networkPlayerInfoIn.getGameProfile() == Minecraft.getInstance().player.getGameProfile()) {
                j = 5;
            }
        }
