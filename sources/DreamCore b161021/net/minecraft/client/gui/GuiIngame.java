...
import org.dreamcore.client.event.types.EventType;
import org.dreamcore.client.feature.impl.hud.HUD;
import org.dreamcore.client.feature.impl.misc.StreamerMode;
import org.dreamcore.client.feature.impl.visual.Crosshair;
import org.dreamcore.client.feature.impl.visual.NoRender;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (scoreobjective1 != null) {
            ...
            EventManager.call(e);
            if(!(dreamcore.instance.featureManager.getFeatureByClass(org.dreamcore.client.feature.impl.visual.Scoreboard.class).getState() && org.dreamcore.client.feature.impl.visual.Scoreboard.noScore.getBoolValue())) {
    ...
    private void renderAttackIndicator(float p_184045_1_, ScaledResolution p_184045_2_)
    {
        ...
        if (gamesettings.thirdPersonView == 0)
        {
            ...
            else
            {
                ...
                GlStateManager.enableAlpha();
                if (!dreamcore.instance.featureManager.getFeatureByClass(Crosshair.class).getState()) {
    ...
    protected void renderHotbar(ScaledResolution sr, float partialTicks)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            if (dreamcore.instance.featureManager.getFeatureByClass(HUD.class).getState() && HUD.rustHUD.getBoolValue()) {
            ...
            if (!itemstack.isEmpty() && !(HUD.rustHUD.getBoolValue() && dreamcore.instance.featureManager.getFeatureByClass(HUD.class).getState())) {
            ...
            for (int l = 0; l < 9; ++l)
            {
                int i1 = i - (dreamcore.instance.featureManager.getFeatureByClass(HUD.class).getState() && HUD.rustHUD.getBoolValue() ? 92 : 90) + l * 20 + 2;
                int j1 = sr.getScaledHeight() - 16 - (dreamcore.instance.featureManager.getFeatureByClass(HUD.class).getState() && HUD.rustHUD.getBoolValue() ? 10 : 3);
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes)
    {
        ...
        for (Score score1 : collection)
        {
            ...
            if (dreamcore.instance.featureManager.getFeatureByClass(StreamerMode.class).getState() && StreamerMode.scoreBoardSpoof.getBoolValue()) {
                this.getFontRenderer().drawString(s1.replace(Minecraft.getInstance().player.getName().substring(0, 2),
                        "                                                                                                                                                                                                                                                                                                                                                                        "),
                        l1, k, 553648127);
            } else {
            ...
            if (org.dreamcore.client.feature.impl.visual.Scoreboard.scoreboardPoints.getBoolValue()) {
    ...
    private void renderPlayerStats(ScaledResolution scaledRes)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            float width = sr.getScaledWidth() - 155 - (mc.helvetica.getStringWidth("zalupa"));
            float height = sr.getScaledHeight() - mc.helvetica.getFontHeight() - 110;
            ...
            if (dreamcore.instance.featureManager.getFeatureByClass(HUD.class).getState() && HUD.rustHUD.getBoolValue()) {
                ...
                /* HEALTH */
                float healthPercentage = mc.player.getHealth() / mc.player.getMaxHealth() * 100;
                ...
                org.dreamcore.client.helpers.render.RenderHelper.drawImage(new ResourceLocation("dreamcore/rusthud/health_tag_icon.png"), width + 3.5F, height + 3.5F, 13, 13, new Color(150, 150, 150, 255));
                RectHelper.drawRectBetter(width + 20, height + 2, healthPercentage, 16, new Color(135, 185, 75, 215).getRGB());
                mc.helvetica.drawString(healthPercentageStr, width + 24, height + 9, -1);

                /* ARMOR */
                float armorPercentage = (mc.player.getTotalArmorValue() * 5);
                ...
                org.dreamcore.client.helpers.render.RenderHelper.drawImage(new ResourceLocation("dreamcore/rusthud/armor_icon.png"), width + 3.5F, height + 24.5F, 13, 13, new Color(150, 150, 150, 255));
                for (ItemStack armorList : mc.player.getArmorInventoryList()) {
                    if (!armorList.isEmpty()) {
                        RectHelper.drawRectBetter(width + 20, height + 23, armorPercentage, 16, new Color(55, 155, 215, 215).getRGB());
                    }
                }
                mc.helvetica.drawString(armorPercentageStr, width + 24, height + 30, -1);

                /* FOOD */
                float foodPercentage = (mc.player.getFoodStats().getFoodLevel() * 5);
                ...
                org.dreamcore.client.helpers.render.RenderHelper.drawImage(new ResourceLocation("dreamcore/rusthud/food_icon.png"), width + 3.5F, height + 45.5F, 13, 13, new Color(150, 150, 150, 255));
                RectHelper.drawRectBetter(width + 20, height + 44, foodPercentage, 16, new Color(215, 118, 7, 215).getRGB());
                mc.helvetica.drawString(foodPercentageStr, width + 24, height + 51, -1);
    ...
    {
        if (dreamcore.instance.featureManager.getFeatureByClass(NoRender.class).getState() && NoRender.pumpkin.getBoolValue()) {
            return;
        }
        GlStateManager.disableDepth();
