...
import org.dreamcore.client.feature.impl.combat.Velocity;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityVelocity(SPacketEntityVelocity packetIn)
    {
        ...
        if (entity != null)
        {
            if (Velocity.velocityMode.currentMode.equals("Matrix") && dreamcore.instance.featureManager.getFeatureByClass(Velocity.class).getState()) {
                if (packetIn.getEntityID() == Minecraft.getInstance().player.getEntityId()) {
    ...
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        this.gameController.ingameGUI.func_191742_a(packetIn.getChatType(), packetIn.getChatComponent());
    }
