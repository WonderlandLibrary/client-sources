...
import org.dreamcore.client.feature.impl.visual.ChestESP;
...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer<TileEntityChest>
{
    ...
    public void func_192841_a(TileEntityChest p_192841_1_, double p_192841_2_, double p_192841_4_, double p_192841_6_, float p_192841_8_, int p_192841_9_, float p_192841_10_)
    {
        ...
        if (p_192841_1_.adjacentChestZNeg == null && p_192841_1_.adjacentChestXNeg == null)
        {
            ...
            if (dreamcore.instance.featureManager.getFeatureByClass(ChestESP.class).getState() && ChestESP.chestEspMode.currentMode.equals("Chams")) {
                int occludedColor = ChestESP.chamsColor.getColorValue();
                GL11.glDisable(GL11.GL_TEXTURE_2D);
                GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
                GL11.glEnable(GL11.GL_BLEND);
                GL11.glDisable(GL11.GL_LIGHTING);
                GL11.glEnable(GL11.GL_POLYGON_OFFSET_FILL);
                GL11.glPolygonOffset(0, -1000000);
                OpenGlHelper.setLightmapTextureCoords(1, 240, 240);
                GL11.glDepthMask(false);
                RenderHelper.setColor(occludedColor);
