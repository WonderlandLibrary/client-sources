...
import org.dreamcore.client.feature.impl.visual.HitColor;
...
public abstract class RenderLivingBase<T extends EntityLivingBase> extends Render<T> implements Helper {
    ...
    protected void renderModel(T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        ...
        boolean chamsCheck = (dreamcore.instance.featureManager.getFeatureByClass(Chams.class).getState() && entitylivingbaseIn instanceof EntityPlayer);
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
        ...
        if (!flag && !flag1) {
            ...
            if (flag1) {
                if (dreamcore.instance.featureManager.getFeatureByClass(HitColor.class).getState()) {
