...
import org.dreamcore.client.feature.impl.visual.NameTags;
...
public abstract class Render<T extends Entity> implements IEntityRenderer
{
    ...
    {
        if(dreamcore.instance.featureManager.getFeatureByClass(NameTags.class).getState()) {
            return;
        }
        ...
        if (d0 <= (double)(maxDistance * maxDistance))
        {
            ...
            if (dreamcore.instance.featureManager.getFeatureByClass(StreamerMode.class).getState() && StreamerMode.otherNames.getBoolValue()) {
