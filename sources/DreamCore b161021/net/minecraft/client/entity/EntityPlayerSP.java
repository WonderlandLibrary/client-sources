...
import org.dreamcore.client.event.events.impl.motion.EventMove;
import org.dreamcore.client.event.events.impl.packet.EventMessage;
import org.dreamcore.client.event.events.impl.player.*;
import org.dreamcore.client.feature.impl.misc.FreeCam;
import org.dreamcore.client.feature.impl.misc.PortalFeatures;
import org.dreamcore.client.feature.impl.player.AntiPush;
import org.dreamcore.client.feature.impl.player.NoSlowDown;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                //  if (!dreamcore.instance.featureManager.getFeatureByClass(FreeCam.class).getState()) {
    ...
    private void onUpdateWalkingPlayer() {
        ...
        IBaritone baritone1 = BaritoneAPI.getProvider().getBaritoneForPlayer((EntityPlayerSP) (Object) this);
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        if (dreamcore.instance.featureManager.getFeatureByClass(AntiPush.class).getState() && AntiPush.blocks.getBoolValue())
            return false;
    ...
    public void onLivingUpdate() {
        ...
        if (this.inPortal) {
            ...
            if (dreamcore.instance.featureManager.getFeatureByClass(PortalFeatures.class).getState() && PortalFeatures.chat.getBoolValue()) {
        ...
        if (this.isHandActive() && !this.isRiding()) {
            this.movementInput.moveStrafe *= dreamcore.instance.featureManager.getFeatureByClass(NoSlowDown.class).getState() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;
            this.movementInput.moveForward *= dreamcore.instance.featureManager.getFeatureByClass(NoSlowDown.class).getState() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;
