...
import org.dreamcore.client.event.events.impl.packet.EventAttackClient;
import org.dreamcore.client.ui.font.FontUtil;
import org.dreamcore.client.ui.font.MCFontRenderer;
import org.dreamcore.security.impl.HwidCheck;
import org.dreamcore.security.impl.VersionCheck;
import org.dreamcore.security.utils.HashUtil;
import org.dreamcore.security.utils.HttpUtils;
...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    public MCFontRenderer icons;
    public MCFontRenderer jetbrains;
    public MCFontRenderer jetbrainsSmall;
    public MCFontRenderer smallwtf;
    ...
    public MCFontRenderer sfuiFontRender;
    ...
    public MCFontRenderer aldotheapache;
    public MCFontRenderer museosans;
    public MCFontRenderer circleregular;
    public MCFontRenderer circleregularSmall;
    public MCFontRenderer circleregularSmall1;
    public MCFontRenderer montserratLight;
    public MCFontRenderer montserratRegular;
    public MCFontRenderer menlo;
    @Nullable
    ...
    public Minecraft(GameConfiguration gameConfig) {
        ...
        Bootstrap.register();
        TextComponentKeybind.supplierFunction = KeyBinding::func_193626_b;
    ...
    private void startGame() throws LWJGLException {
        ...
        this.sfuiFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/comfortaa.ttf"), 19.0F, 0), true, true);
        this.bigFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/sf-ui.ttf"), 48.0F, 0), true, true);
        this.clickguismall = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/sf-ui.ttf"), 16.5F, 0), true, true);
        this.notification = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/notification.ttf"), 45, 0), true, true);
        this.smallfontRenderer = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/sf-ui.ttf"), 14.0F, 0), true, true);
        this.fontRenderer = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/sf-ui.ttf"), 18, 0), true, true);
        this.buttonFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/quicksand.ttf"), 28, 0), true, true);
        this.bigButtonFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/quicksand.ttf"), 35, 0), true, true);
        this.arrayListQuick = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/quicksand.ttf"), 20, 0), true, true);
        this.verdanaFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/verdana.ttf"), 19, 0), true, true);
        this.robotoRegularFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/robotoregular.ttf"), 19, 0), true, true);
        this.latoFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/lato.ttf"), 19, 0), true, true);
        this.latoBig = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/lato.ttf"), 25, 0), true, true);
        this.openSansFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/opensans.ttf"), 19, 0), true, true);
        this.ubuntuFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/ubuntu.ttf"), 19, 0), true, true);
        this.lucidaConsoleFontRenderer = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/lucidaconsole.ttf"), 19, 0), true, true);
        this.helvetica = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/helvetica.ttf"), 19, 0), true, true);
        this.calibri = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/calibri.ttf"), 20, 0), true, true);
        this.productsans = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/productsans.ttf"), 20, 0), true, true);
        this.raleway = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/raleway.ttf"), 20, 0), true, true);
        this.kollektif = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/kollektif.ttf"), 20, 0), true, true);
        this.aldotheapache = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/apache.ttf"), 20, 0), true, true);
        this.museosans = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/museo.ttf"), 20, 0), true, true);
        this.smallwtf = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/sf-ui.ttf"), 11, 0), true, true);
        this.icons = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/icons.ttf"), 40, 0), true, true);
        this.circleregular = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/circle-regular.ttf"), 19, 0), true, true);
        this.circleregularSmall = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/sf-ui.ttf"), 16, 0), true, true);
        this.jetbrains = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/jetbrainsmono.ttf"), 19, 0), true, true);
        this.jetbrainsSmall = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/jetbrainsmono.ttf"), 15, 0), true, true);
        this.menlo = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/menlo.ttf"), 19, 0), true, true);
        this.montserratLight = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/montserrat-light.ttf"), 15, 0), true, true);
        this.montserratRegular = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/montserrat-regular.ttf"), 19, 0), true, true);
        this.circleregularSmall1 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("dreamcore/font/sf-ui.ttf"), 12, 0), true, true);
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("dreamcore Premium");
...
//        }
    ...
    private void runGameLoop() throws IOException {
        ...
        if (!this.skipRenderWorld) {
            ...
            this.guiToast.func_191783_a(new ScaledResolution(this));
            this.mcProfiler.endSection();
        }
        ...
        while (getSystemTime() >= this.debugUpdateTime + 1000L) {
            debugFPS = (int) (this.fpsCounter * 1.4f);
    ...
    public void runTick() throws IOException {
        ...
        this.tutorial.func_193297_a(this.world, this.objectMouseOver);
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn) {
        ...
        new DiscordRPC().update("Playing Singeplayer", "In Game");
    }
...
//            }
    ...
    public void addServerStatsToSnooper(Snooper playerSnooper) {
        ...
        playerSnooper.addClientStat("run_time", Long.valueOf((MinecraftServer.getCurrentTimeMillis() - playerSnooper.getInstanceStartTimeMillis()) / 60L * 1000L));
