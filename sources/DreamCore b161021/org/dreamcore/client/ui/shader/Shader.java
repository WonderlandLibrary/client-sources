package org.dreamcore.client.ui.shader;
...
public abstract class Shader implements Helper {
    ...
    public Shader(final String fragmentShader) {
        ...
        try {
            InputStream vertexStream = getClass().getResourceAsStream("/assets/minecraft/dreamcore/shaders/vertex.vert");
            vertexShaderID = createShader(IOUtils.toString(vertexStream), ARBVertexShader.GL_VERTEX_SHADER_ARB);
            IOUtils.closeQuietly(vertexStream);

            InputStream fragmentStream = getClass().getResourceAsStream("/assets/minecraft/dreamcore/shaders/fragment/" + fragmentShader);
