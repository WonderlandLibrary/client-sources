...
public class PasswordField extends Gui {
    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            ...
            if (var4.length() > 0) {
                ...
                var9 = Minecraft.getInstance().fontRendererObj.drawStringWithShadow(this.text.replaceAll("(?s).", "*"), (float) var7, (float) var8, var1);
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                Minecraft.getInstance().fontRendererObj.drawStringWithShadow(var4.substring(var2), (float) var9, (float) var8, var1);
            }
            ...
            if (var6) {
                if (var10) {
                    ...
                    Minecraft.getInstance().fontRendererObj.drawStringWithShadow("_", (float) var11, (float) var8, var1);
                }
            }
    ...
    private void drawCursorVertical(int par1, int par2, int par3, int par4) {
        ...
        var7.pos(par1, par4, 0.0D).endVertex();
        var7.pos(par3, par4, 0.0D).endVertex();
        var7.pos(par3, par2, 0.0D).endVertex();
        var7.pos(par1, par2, 0.0D).endVertex();
        var6.draw();
        GL11.glDisable(3058);
        GL11.glEnable(3553);
    }
