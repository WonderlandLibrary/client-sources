    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RectHelper.drawSmoothRect(this.xPosition - 0.5F, this.yPosition - 0.5F, this.xPosition + this.width + 0.5F, this.yPosition + this.height + 1F, PaletteHelper.astolfo(false, width).getRGB());
                RectHelper.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, new Color(23, 22, 22).getRGB());
            }
            int i = -1;
            ...
            if (!s.isEmpty()) {
                ...
                if (dreamcore.instance.featureManager.getFeatureByClass(StreamerMode.class).getState() && StreamerMode.warpSpoof.getBoolValue()) {
                    if (s1.startsWith("/warp")) {
                        s1 = "/warp ";
                    }
                }
                if (dreamcore.instance.featureManager.getFeatureByClass(StreamerMode.class).getState() && StreamerMode.loginSpoof.getBoolValue()) {
                    if (s1.startsWith("/l")) {
                        s1 = "/l ";
                    }
                }
