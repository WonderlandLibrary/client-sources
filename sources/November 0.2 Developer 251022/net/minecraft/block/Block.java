...
public class Block {
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        EventCollideBlock blockCollideEvent = new EventCollideBlock(this.getCollisionBoundingBox(worldIn, pos, state), state.getBlock(), pos.getX(), pos.getY(), pos.getZ());
        November.INSTANCE.getBus().post((Object)blockCollideEvent);
        if (blockCollideEvent.isCancelled()) {
            return;
        }
        AxisAlignedBB axisalignedbb = blockCollideEvent.getCollisionBoundingBox();
