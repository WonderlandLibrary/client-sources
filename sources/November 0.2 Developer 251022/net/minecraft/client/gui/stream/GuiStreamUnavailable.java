...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i = Math.max((int)((double)height * 0.85 / 2.0 - (double)((float)(this.field_152323_r.size() * this.fontRendererObj.FONT_HEIGHT) / 2.0f)), 50);
        GuiStreamUnavailable.drawCenteredString(this.fontRendererObj, this.field_152324_f.getFormattedText(), width / 2, i - this.fontRendererObj.FONT_HEIGHT * 2, 0xFFFFFF);
        for (String s : this.field_152323_r) {
            GuiStreamUnavailable.drawCenteredString(this.fontRendererObj, s, width / 2, i, 0xA0A0A0);
