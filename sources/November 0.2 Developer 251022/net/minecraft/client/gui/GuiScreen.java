...
implements GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        for (int i = 0; i < this.buttonList.size(); ++i) {
            ...
            if (this.buttonList.get(i) == null) continue;
    ...
    public void drawWorldBackground(int tint) {
        if (this.mc.theWorld != null) {
            ...
            this.shader.useShader(width * 2, height * 2, this.mc.mouseHelper.deltaX, this.mc.mouseHelper.deltaY, (float)(System.currentTimeMillis() - this.initTime) / 1000.0f);
            GL11.glBegin((int)7);
