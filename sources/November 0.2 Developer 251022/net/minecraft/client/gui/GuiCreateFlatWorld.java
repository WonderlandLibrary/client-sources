...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.field_146389_t = new GuiButton(2, width / 2 - 154, height - 52, 100, 20, I18n.format("createWorld.customize.flat.addLayer", new Object[0]) + " (NYI)");
        this.buttonList.add(this.field_146389_t);
        this.field_146388_u = new GuiButton(3, width / 2 - 50, height - 52, 100, 20, I18n.format("createWorld.customize.flat.editLayer", new Object[0]) + " (NYI)");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiCreateFlatWorld.drawCenteredString(this.fontRendererObj, this.flatWorldTitle, width / 2, 8, 0xFFFFFF);
        int i = width / 2 - 92 - 16;
        this.drawString(this.fontRendererObj, this.field_146394_i, i, 32.0f, 0xFFFFFF);
        this.drawString(this.fontRendererObj, this.field_146391_r, i + 2 + 213 - this.fontRendererObj.getStringWidth(this.field_146391_r), 32.0f, 0xFFFFFF);
