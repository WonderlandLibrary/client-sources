...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiFlatPresets.drawCenteredString(this.fontRendererObj, this.presetsTitle, width / 2, 8, 0xFFFFFF);
        this.drawString(this.fontRendererObj, this.presetsShare, 50.0f, 30.0f, 0xA0A0A0);
        this.drawString(this.fontRendererObj, this.field_146436_r, 50.0f, 70.0f, 0xA0A0A0);
