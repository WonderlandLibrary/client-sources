...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiScreenCustomizePresets.drawCenteredString(this.fontRendererObj, this.field_175315_a, width / 2, 8, 0xFFFFFF);
        this.drawString(this.fontRendererObj, this.field_175313_s, 50.0f, 30.0f, 0xA0A0A0);
        this.drawString(this.fontRendererObj, this.field_175312_t, 50.0f, 70.0f, 0xA0A0A0);
