...
implements IProgressMeter {
    ...
    public void createButtons() {
        ...
        GuiButton guibutton1 = new GuiButton(3, width / 2, height - 52, 80, 20, I18n.format("stat.itemsButton", new Object[0]));
        this.buttonList.add(guibutton1);
        GuiButton guibutton2 = new GuiButton(4, width / 2 + 80, height - 52, 80, 20, I18n.format("stat.mobsButton", new Object[0]));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            GuiStats.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), width / 2, height / 2, 0xFFFFFF);
            GuiStats.drawCenteredString(this.fontRendererObj, lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % (long)lanSearchStates.length)], width / 2, height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 0xFFFFFF);
        } else {
            this.displaySlot.drawScreen(mouseX, mouseY, partialTicks);
            GuiStats.drawCenteredString(this.fontRendererObj, this.screenTitle, width / 2, 20, 0xFFFFFF);
    ...
    extends GuiSlot {
        ...
        public StatsMobsList(Minecraft mcIn) {
            super(mcIn, width, height, 32, height - 64, ((GuiStats)GuiStats.this).fontRendererObj.FONT_HEIGHT * 4);
    ...
    extends GuiSlot {
        public StatsGeneral(Minecraft mcIn) {
            super(mcIn, width, height, 32, height - 64, 10);
            this.setShowSelectionBox(false);
        }
    ...
    extends GuiSlot {
        ...
        protected Stats(Minecraft mcIn) {
            super(mcIn, width, height, 32, height - 64, 20);
