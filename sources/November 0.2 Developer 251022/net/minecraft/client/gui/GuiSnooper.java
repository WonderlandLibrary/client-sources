...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        for (Object s1 : this.fontRendererObj.listFormattedStringToWidth(s, width - 30)) {
            list.add((String)s1);
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiSnooper.drawCenteredString(this.fontRendererObj, this.field_146610_i, width / 2, 8, 0xFFFFFF);
        int i = 22;
        for (String s : this.field_146607_r) {
            GuiSnooper.drawCenteredString(this.fontRendererObj, s, width / 2, i, 0x808080);
