...
extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        GuiRenameAlt.drawCenteredString(this.fontRendererObj, "Edit Alt", width / 2, 10, -1);
        GuiRenameAlt.drawCenteredString(this.fontRendererObj, this.status, width / 2, 20, -1);
        this.nameField.drawTextBox();
        this.pwField.drawTextBox();
        if (this.nameField.getText().isEmpty()) {
            this.drawString(this.mc.fontRendererObj, "New name", width / 2 - 96, 66.0f, -7829368);
        }
        if (this.pwField.getText().isEmpty()) {
            this.drawString(this.mc.fontRendererObj, "New password", width / 2 - 96, 106.0f, -7829368);
        }
