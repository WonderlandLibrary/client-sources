...
public class SwimNodeProcessor extends NodeProcessor
{
  ...
  {
    return func_176159_a(MathHelper.floor_double(getEntityBoundingBoxminX), MathHelper.floor_double(getEntityBoundingBoxminY + 0.5D), MathHelper.floor_double(getEntityBoundingBoxminZ));
  }
  
  public PathPoint func_176160_a(Entity p_176160_1_, double p_176160_2_, double p_176160_4_, double p_176160_6_)
  {
    return func_176159_a(MathHelper.floor_double(p_176160_2_ - width / 2.0F), MathHelper.floor_double(p_176160_4_ + 0.5D), MathHelper.floor_double(p_176160_6_ - width / 2.0F));
  }
  ...
  public int func_176164_a(PathPoint[] p_176164_1_, Entity p_176164_2_, PathPoint p_176164_3_, PathPoint p_176164_4_, float p_176164_5_)
  {
    ...
    for (int var9 = 0; var9 < var8; var9++)
    {
      ...
      PathPoint var11 = func_176185_a(p_176164_2_, xCoord + var10.getFrontOffsetX(), yCoord + var10.getFrontOffsetY(), zCoord + var10.getFrontOffsetZ());
  ...
  {
    int var5 = func_176186_b(p_176185_1_, p_176185_2_, p_176185_3_, p_176185_4_);
  ...
  private int func_176186_b(Entity p_176186_1_, int p_176186_2_, int p_176186_3_, int p_176186_4_)
  {
    for (int var5 = p_176186_2_; var5 < p_176186_2_ + field_176168_c; var5++)
    {
      for (int var6 = p_176186_3_; var6 < p_176186_3_ + field_176165_d; var6++)
      {
        ...
        {
          net.minecraft.util.BlockPos var8 = new net.minecraft.util.BlockPos(var5, var6, var7);
          net.minecraft.block.Block var9 = field_176169_a.getBlockState(var8).getBlock();
          
          if (var9.getMaterial() != net.minecraft.block.material.Material.water)
          {
            return 0;
          }
        }
