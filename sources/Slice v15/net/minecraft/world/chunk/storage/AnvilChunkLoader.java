...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO
{
  ...
  private List chunksToRemove = com.google.common.collect.Lists.newArrayList();
  private Set pendingAnvilChunksCoordinates = com.google.common.collect.Sets.newHashSet();
    ...
    throws IOException
  {
    ...
    synchronized (syncLockObject)
    {
      if (pendingAnvilChunksCoordinates.contains(var5))
      {
        ...
        {
          if (chunksToRemove.get(var7)).chunkCoordinate.equals(var5))
          {
            var4 = chunksToRemove.get(var7)).nbtTags;
            break;
          }
        }
      }
    ...
    if (var4 == null)
    {
      DataInputStream var10 = RegionFileCache.getChunkInputStream(chunkSaveLocation, x, z);
  ...
  protected Chunk checkedReadChunkFromNBT(World worldIn, int p_75822_2_, int p_75822_3_, NBTTagCompound p_75822_4_)
  {
    ...
    {
      logger.error("Chunk file at " + p_75822_2_ + "," + p_75822_3_ + " is in the wrong location; relocating. (Expected " + p_75822_2_ + ", " + p_75822_3_ + ", got " + xPosition + ", " + zPosition + ")");
  ...
  protected void addChunkToPending(ChunkCoordIntPair p_75824_1_, NBTTagCompound p_75824_2_)
  {
    ...
    synchronized (syncLockObject)
    {
      if (pendingAnvilChunksCoordinates.contains(p_75824_1_))
      {
        ...
        {
          if (chunksToRemove.get(var4)).chunkCoordinate.equals(p_75824_1_))
          {
            chunksToRemove.set(var4, new PendingChunk(p_75824_1_, p_75824_2_));
            return;
          }
        }
      }
      
      chunksToRemove.add(new PendingChunk(p_75824_1_, p_75824_2_));
  ...
  public boolean writeNextIO()
  {
    ...
    synchronized (syncLockObject)
    {
      ...
      var1 = (PendingChunk)chunksToRemove.remove(0);
      pendingAnvilChunksCoordinates.remove(chunkCoordinate);
    }
  ...
  {
    DataOutputStream var2 = RegionFileCache.getChunkOutputStream(chunkSaveLocation, chunkCoordinate.chunkXPos, chunkCoordinate.chunkZPos);
    CompressedStreamTools.write(nbtTags, var2);
    var2.close();
  }
  ...
  private void writeChunkToNBT(Chunk p_75820_1_, World worldIn, NBTTagCompound p_75820_3_)
  {
    ...
    p_75820_3_.setInteger("xPos", xPosition);
    p_75820_3_.setInteger("zPos", zPosition);
    ...
    for (int var9 = 0; var9 < var8; var9++)
    {
      ...
      if (var10 != null)
      {
        ...
        for (int var15 = 0; var15 < var10.getData().length; var15++)
        {
          ...
          var12[var15] = ((byte)(var16 >> '\004' & 0xFF));
    ...
    {
      Iterator var22 = p_75820_1_.getEntityLists()[var8].iterator();
    ...
    Iterator var22 = p_75820_1_.getTileEntityMap().values().iterator();
    ...
    if (var23 != null)
    {
      ...
      while (var28.hasNext())
      {
        ...
        var30.setInteger("x", field_180282_a.getX());
        var30.setInteger("y", field_180282_a.getY());
        var30.setInteger("z", field_180282_a.getZ());
        var30.setInteger("t", (int)(scheduledTime - var26));
        var30.setInteger("p", priority);
  ...
  private Chunk readChunkFromNBT(World worldIn, NBTTagCompound p_75823_2_)
  {
    ...
    boolean var9 = !provider.getHasNoSky();
