...
public class DemoWorldServer extends WorldServer
{
  ...
  public static final WorldSettings demoWorldSettings = new WorldSettings(demoWorldSeed, net.minecraft.world.WorldSettings.GameType.SURVIVAL, true, false, WorldType.DEFAULT).enableBonusChest();
