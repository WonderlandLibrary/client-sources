...
public class MapGenCaves extends MapGenBase
{
  ...
  protected void func_180702_a(long p_180702_1_, int p_180702_3_, int p_180702_4_, ChunkPrimer p_180702_5_, double p_180702_6_, double p_180702_8_, double p_180702_10_, float p_180702_12_, float p_180702_13_, float p_180702_14_, int p_180702_15_, int p_180702_16_, double p_180702_17_)
  {
    ...
    {
      double var29 = 1.5D + MathHelper.sin(p_180702_15_ * 3.1415927F / p_180702_16_) * p_180702_12_ * 1.0F;
      ...
      {
        func_180702_a(var25.nextLong(), p_180702_3_, p_180702_4_, p_180702_5_, p_180702_6_, p_180702_8_, p_180702_10_, var25.nextFloat() * 0.5F + 0.5F, p_180702_13_ - 1.5707964F, p_180702_14_ / 3.0F, p_180702_15_, p_180702_16_, 1.0D);
        func_180702_a(var25.nextLong(), p_180702_3_, p_180702_4_, p_180702_5_, p_180702_6_, p_180702_8_, p_180702_10_, var25.nextFloat() * 0.5F + 0.5F, p_180702_13_ + 1.5707964F, p_180702_14_ / 3.0F, p_180702_15_, p_180702_16_, 1.0D);
        return;
      }
                ...
                if (var59 * var59 + var46 * var46 < 1.0D)
                {
                  for (int var49 = var38; var49 > var56; var49--)
                  {
                    ...
                    if ((var50 > -0.7D) && (var59 * var59 + var50 * var50 + var46 * var46 < 1.0D))
                    {
                      ...
                      IBlockState var53 = (IBlockState)com.google.common.base.Objects.firstNonNull(p_180702_5_.getBlockState(var42, var49 + 1, var60), Blocks.air.getDefaultState());
                      ...
                      if (func_175793_a(var52, var53))
                      {
                        ...
                        else
                        {
                          ...
                          {
                            p_180702_5_.setBlockState(var42, var49 + 1, var60, var53.getValue(net.minecraft.block.BlockSand.VARIANT_PROP) == BlockSand.EnumType.RED_SAND ? Blocks.red_sandstone.getDefaultState() : Blocks.sandstone.getDefaultState());
                          }
                          
                          if ((var48) && (p_180702_5_.getBlockState(var42, var49 - 1, var60).getBlock() == Blocks.dirt))
                          {
                            p_180702_5_.setBlockState(var42, var49 - 1, var60, worldObj.getBiomeGenForCoords(new net.minecraft.util.BlockPos(var42 + p_180702_3_ * 16, 0, var60 + p_180702_4_ * 16)).topBlock.getBlock().getDefaultState());
                          }
                        }
                      }
                    }
  ...
  {
    return p_175793_1_.getBlock() == Blocks.stone;
  }
  ...
  protected void func_180701_a(World worldIn, int p_180701_2_, int p_180701_3_, int p_180701_4_, int p_180701_5_, ChunkPrimer p_180701_6_)
  {
    ...
    {
      double var9 = p_180701_2_ * 16 + rand.nextInt(16);
      double var11 = rand.nextInt(rand.nextInt(120) + 8);
      double var13 = p_180701_3_ * 16 + rand.nextInt(16);
      int var15 = 1;
      ...
      for (int var16 = 0; var16 < var15; var16++)
      {
        ...
        func_180702_a(rand.nextLong(), p_180701_4_, p_180701_5_, p_180701_6_, var9, var11, var13, var19, var17, var18, 0, 0, 1.0D);
      }
    }
  }
}
