  ...
  public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_)
  {
    ...
    if ((p_180709_3_.getY() >= 1) && (p_180709_3_.getY() + var4 + 1 <= 256))
    {
      ...
      if (((var16 == Blocks.grass) || (var16 == Blocks.dirt) || (var16 == Blocks.farmland)) && (p_180709_3_.getY() < 256 - var4 - 1))
      {
        ...
        for (int var17 = p_180709_3_.getY() - 3 + var4; var17 <= p_180709_3_.getY() + var4; var17++)
        {
          int var8 = var17 - (p_180709_3_.getY() + var4);
          int var9 = 1 - var8 / 2;
          ...
          for (int var10 = p_180709_3_.getX() - var9; var10 <= p_180709_3_.getX() + var9; var10++)
          {
            ...
            for (int var12 = p_180709_3_.getZ() - var9; var12 <= p_180709_3_.getZ() + var9; var12++)
            {
              ...
              if ((Math.abs(var11) != var9) || (Math.abs(var13) != var9) || ((p_180709_2_.nextInt(2) != 0) && (var8 != 0)))
              {
                ...
                if ((var15.getMaterial() == net.minecraft.block.material.Material.air) || (var15.getMaterial() == net.minecraft.block.material.Material.leaves))
                {
                  func_175905_a(worldIn, var14, Blocks.leaves, BlockPlanks.EnumType.BIRCH.func_176839_a());
                }
              }
            }
          }
        ...
        for (var17 = 0; var17 < var4; var17++)
        {
          ...
          if ((var18.getMaterial() == net.minecraft.block.material.Material.air) || (var18.getMaterial() == net.minecraft.block.material.Material.leaves))
          {
            func_175905_a(worldIn, p_180709_3_.offsetUp(var17), Blocks.log, BlockPlanks.EnumType.BIRCH.func_176839_a());
          }
        }
