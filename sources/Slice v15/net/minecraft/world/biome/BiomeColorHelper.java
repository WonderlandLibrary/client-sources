...
public class BiomeColorHelper
{
  ...
  private static final ColorResolver field_180290_c = new ColorResolver()
  {
    ...
    public int func_180283_a(BiomeGenBase p_180283_1_, BlockPos p_180283_2_) { return waterColorMultiplier; }
  };
  ...
  private static int func_180285_a(IBlockAccess p_180285_0_, BlockPos p_180285_1_, ColorResolver p_180285_2_) {
    ...
    int var8;
    for (Iterator var6 = BlockPos.getAllInBoxMutable(p_180285_1_.add(-1, 0, -1), p_180285_1_.add(1, 0, 1)).iterator(); var6.hasNext(); var5 += (var8 & 0xFF))
    {
      net.minecraft.util.BlockPos.MutableBlockPos var7 = (net.minecraft.util.BlockPos.MutableBlockPos)var6.next();
  ...
  {
    public abstract int func_180283_a(BiomeGenBase paramBiomeGenBase, BlockPos paramBlockPos);
  }
}
