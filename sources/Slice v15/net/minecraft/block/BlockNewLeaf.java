...
public class BlockNewLeaf extends BlockLeaves
{
  ...
  public BlockNewLeaf()
  {
    setDefaultState(blockState.getBaseState().withProperty(field_176240_P, BlockPlanks.EnumType.ACACIA).withProperty(field_176236_b, Boolean.valueOf(true)).withProperty(field_176237_a, Boolean.valueOf(true)));
  }
  
  protected void func_176234_a(World worldIn, BlockPos p_176234_2_, IBlockState p_176234_3_, int p_176234_4_)
  {
    if ((p_176234_3_.getValue(field_176240_P) == BlockPlanks.EnumType.DARK_OAK) && (rand.nextInt(p_176234_4_) == 0))
    {
  ...
  {
    return getDefaultState().withProperty(field_176240_P, func_176233_b(meta)).withProperty(field_176237_a, Boolean.valueOf((meta & 0x4) == 0)).withProperty(field_176236_b, Boolean.valueOf((meta & 0x8) > 0));
  }
