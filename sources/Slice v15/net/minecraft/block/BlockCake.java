...
public class BlockCake extends Block
{
  ...
  {
    float var3 = 0.0625F;
    float var4 = (1 + ((Integer)access.getBlockState(pos).getValue(BITES)).intValue() * 2) / 16.0F;
    float var5 = 0.5F;
  ...
  {
    return new BlockState(this, new net.minecraft.block.properties.IProperty[] { BITES });
  }
