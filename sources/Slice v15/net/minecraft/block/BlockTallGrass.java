...
public class BlockTallGrass extends BlockBush implements IGrowable
{
  ...
  {
    super(Material.vine);
    setDefaultState(blockState.getBaseState().withProperty(field_176497_a, EnumType.DEAD_BUSH));
    float var1 = 0.4F;
  ...
  public int getRenderColor(IBlockState state)
  {
    ...
    EnumType var2 = (EnumType)state.getValue(field_176497_a);
    return var2 == EnumType.DEAD_BUSH ? 16777215 : ColorizerGrass.getGrassColor(0.5D, 1.0D);
  }
  ...
  public void harvestBlock(World worldIn, EntityPlayer playerIn, BlockPos pos, IBlockState state, TileEntity te)
  {
    if ((!isRemote) && (playerIn.getCurrentEquippedItem() != null) && (playerIn.getCurrentEquippedItem().getItem() == Items.shears))
    {
      ...
      spawnAsEntity(worldIn, pos, new ItemStack(Blocks.tallgrass, 1, ((EnumType)state.getValue(field_176497_a)).func_177044_a()));
    }
    else
    {
  ...
  {
    return getDefaultState().withProperty(field_176497_a, EnumType.func_177045_a(meta));
  }
  ...
  {
    return ((EnumType)state.getValue(field_176497_a)).func_177044_a();
  }
