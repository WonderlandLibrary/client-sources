...
public class S27PacketExplosion implements Packet
{
  ...
  public S27PacketExplosion(double p_i45193_1_, double p_i45193_3_, double p_i45193_5_, float p_i45193_7_, List p_i45193_8_, Vec3 p_i45193_9_)
  {
    ...
    if (p_i45193_9_ != null)
    {
      field_149152_f = ((float)xCoord);
      field_149153_g = ((float)yCoord);
      field_149159_h = ((float)zCoord);
    }
  }
    ...
    throws IOException
  {
    ...
    field_149152_f = data.readFloat();
    field_149153_g = data.readFloat();
    field_149159_h = data.readFloat();
  }
    ...
    throws IOException
  {
    ...
    data.writeFloat(field_149152_f);
    data.writeFloat(field_149153_g);
    data.writeFloat(field_149159_h);
  }
