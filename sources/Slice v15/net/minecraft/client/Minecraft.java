...
import net.SliceClient.ui.GuiIngameHook;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    throws LWJGLException
  {
    ...
    if ((gameSettingsoverrideHeight > 0) && (gameSettingsoverrideWidth > 0)) {
      displayWidth = gameSettingsoverrideWidth;
      displayHeight = gameSettingsoverrideHeight;
    }
    ...
    mcLanguageManager = new LanguageManager(metadataSerializer_, gameSettingslanguage);
    ...
    mcResourceManager.registerReloadListener(new net.minecraft.client.resources.GrassColorReloadListener());
    ...
    net.minecraft.stats.AchievementList.openInventory.setStatStringFormatter(new IStatStringFormat() {
      ...
      public String formatString(String p_74535_1_) {
        try {
          return String.format(p_74535_1_, new Object[] { GameSettings.getKeyDisplayString(gameSettingskeyBindInventory.getKeyCode()) });
    ...
    textureMapBlocks.setMipmapLevels(gameSettingsmipmapLevels);
    renderEngine.loadTickableTexture(TextureMap.locationBlocksTexture, textureMapBlocks);
    renderEngine.bindTexture(TextureMap.locationBlocksTexture);
    textureMapBlocks.func_174937_a(false, gameSettingsmipmapLevels > 0);
    ...
    ingameGUI = new GuiIngameHook(this);
    ...
    if ((gameSettingsfullScreen) && (!fullscreen)) {
      toggleFullscreen();
    }
    try
    {
      Display.setVSyncEnabled(gameSettingsenableVsync);
    } catch (OpenGLException var2) {
      gameSettingsenableVsync = false;
  ...
  private void func_175609_am() throws LWJGLException {
    ...
    Display.setTitle(Slice.Start_Name);
    try
    {
  ...
  public boolean isUnicode() {
    return (mcLanguageManager.isCurrentLocaleUnicode()) || (gameSettingsforceUnicodeFont);
  }
  ...
  public void refreshResources() {
    ...
    try
    {
      ...
      mcResourceManager.reloadResources(var1);
      gameSettingsresourcePacks.clear();
      gameSettings.saveOptions();
    }
  ...
  public void displayGuiScreen(GuiScreen guiScreenIn)
  {
    ...
    if ((guiScreenIn instanceof GuiMainMenu)) {
      gameSettingsshowDebugInfo = false;
  ...
  public void shutdownMinecraftApplet()
  {
    try
    {
      ...
      Slice.bindmanager.saveKeybinds();
    ...
    throws IOException
  {
    ...
    if ((gameSettingsshowDebugInfo) && (gameSettingsshowDebugProfilerChart) && (!gameSettingshideGUI)) {
    ...
    while (getSystemTime() >= debugUpdateTime + 1000L) {
      debugFPS = fpsCounter;
      debug = String.format("%d fps (%d chunk update%s) T: %s%s%s%s%s", new Object[] { Integer.valueOf(debugFPS), Integer.valueOf(RenderChunk.field_178592_a), RenderChunk.field_178592_a != 1 ? "s" : "", gameSettingslimitFramerate == GameSettings.Options.FRAMERATE_LIMIT.getValueMax() ? "inf" : Integer.valueOf(gameSettingslimitFramerate), gameSettingsenableVsync ? " vsync" : "", gameSettingsfancyGraphics ? "" : " fast", gameSettingsclouds ? " clouds" : "", OpenGlHelper.func_176075_f() ? " vbo" : "" });
  ...
  public int getLimitFramerate() {
    return (theWorld == null) && (currentScreen != null) ? 30 : gameSettingslimitFramerate;
  }
  ...
  private void displayDebugInfo(long elapsedTicksTime)
  {
    if (mcProfiler.profilingEnabled) {
      ...
      fontRendererObj.func_175063_a(var20 = var19.format(field_76330_b) + "%", var8 + var7 - fontRendererObj.getStringWidth(var20), var9 - var7 / 2 - 16, var14);
      ...
      for (int var21 = 0; var21 < var3.size(); var21++) {
        ...
        fontRendererObj.func_175063_a(var23 = var19.format(field_76332_a) + "%", var8 + var7 - 50 - fontRendererObj.getStringWidth(var23), var9 + var7 / 2 + var21 * 8 + 20, var22.func_76329_a());
        fontRendererObj.func_175063_a(var23 = var19.format(field_76330_b) + "%", var8 + var7 - fontRendererObj.getStringWidth(var23), var9 + var7 / 2 + var21 * 8 + 20, var22.func_76329_a());
      }
    }
  }
  ...
  public void rightClickMouse()
  {
    ...
    boolean var1 = true;
    ItemStack var2 = thePlayerinventory.getCurrentItem();
    ...
    if (objectMouseOver == null) {
      ...
      case 2: 
        ...
        if (theWorld.getBlockState(var3).getBlock().getMaterial() != Material.air) {
          ...
          if (stackSize == 0) {
            thePlayerinventory.mainInventory[thePlayerinventory.currentItem] = null;
    ...
    if (var1) {
      ItemStack var5 = thePlayerinventory.getCurrentItem();
  ...
  public void toggleFullscreen()
  {
    try
    {
      ...
      gameSettingsfullScreen = fullscreen;
    ...
    throws IOException
  {
    ...
    for (Module m : ModuleManager.getModules()) {
      ModuleManager.getModuleByName(m.getName()).onTick();
    }
    ...
    if ((currentScreen == null) || (currentScreenallowUserInput)) {
          ...
          if (var4 != 0) {
            if (thePlayer.func_175149_v()) {
              ...
              if (ingameGUI.func_175187_g().func_175262_a()) {
                ...
                float var5 = MathHelper.clamp_float(thePlayercapabilities.getFlySpeed() + var4 * 0.005F, 0.0F, 0.2F);
                thePlayercapabilities.setFlySpeed(var5);
              }
            } else {
              thePlayerinventory.changeCurrentItem(var4);
            }
          }
        ...
        if (Keyboard.getEventKeyState()) {
          ...
          if (currentScreen != null) {
            ...
            if ((var1 == 35) && (Keyboard.isKeyDown(61))) {
              gameSettingsadvancedItemTooltips = (!gameSettingsadvancedItemTooltips);
              gameSettings.saveOptions();
            }
            ...
            if ((var1 == 25) && (Keyboard.isKeyDown(61))) {
              gameSettingspauseOnLostFocus = (!gameSettingspauseOnLostFocus);
              gameSettings.saveOptions();
            }
            
            if (var1 == 59) {
              gameSettingshideGUI = (!gameSettingshideGUI);
            }
            
            if (var1 == 61) {
              gameSettingsshowDebugInfo = (!gameSettingsshowDebugInfo);
              gameSettingsshowDebugProfilerChart = GuiScreen.isShiftKeyDown();
            }
            
            if (gameSettingskeyBindTogglePerspective.isPressed()) {
              gameSettingsthirdPersonView += 1;
              
              if (gameSettingsthirdPersonView > 2) {
                gameSettingsthirdPersonView = 0;
              }
              
              if (gameSettingsthirdPersonView == 0) {
                entityRenderer.func_175066_a(func_175606_aa());
              } else if (gameSettingsthirdPersonView == 1) {
                entityRenderer.func_175066_a(null);
              }
            }
            
            if (gameSettingskeyBindSmoothCamera.isPressed()) {
              gameSettingssmoothCamera = (!gameSettingssmoothCamera);
            }
          }
          
          if ((gameSettingsshowDebugInfo) && (gameSettingsshowDebugProfilerChart)) {
            if (var1 == 11) {
      ...
      for (int var1 = 0; var1 < 9; var1++) {
        if (gameSettingskeyBindsHotbar[var1].isPressed()) {
          if (thePlayer.func_175149_v()) {
            ingameGUI.func_175187_g().func_175260_a(var1);
          } else {
            thePlayerinventory.currentItem = var1;
          }
        }
      }
      
      boolean var9 = gameSettingschatVisibility != net.minecraft.entity.player.EntityPlayer.EnumChatVisibility.HIDDEN;
      
      while (gameSettingskeyBindInventory.isPressed()) {
      ...
      while (gameSettingskeyBindDrop.isPressed()) {
        if (!thePlayer.func_175149_v()) {
          thePlayer.dropOneItem(GuiScreen.isCtrlKeyDown());
        }
      }
      
      while ((gameSettingskeyBindChat.isPressed()) && (var9)) {
        displayGuiScreen(new GuiChat());
      }
      
      if ((currentScreen == null) && (gameSettingskeyBindCommand.isPressed()) && (var9)) {
        displayGuiScreen(new GuiChat("/"));
      }
      
      if (thePlayer.isUsingItem()) {
        if (!gameSettingskeyBindUseItem.getIsKeyPressed()) {
        ...
        while (gameSettingskeyBindAttack.isPressed()) {}
        while (gameSettingskeyBindUseItem.isPressed()) {}
        



        while (gameSettingskeyBindPickBlock.isPressed()) {}
      }
      ...
      if ((gameSettingskeyBindUseItem.getIsKeyPressed()) && (rightClickDelayTimer == 0) && (!thePlayer.isUsingItem())) {
        rightClickMouse();
      }
      
      sendClickBlockToController((currentScreen == null) && (gameSettingskeyBindAttack.getIsKeyPressed()) && (inGameHasFocus));
    }
    ...
    if (theWorld != null) {
      if (!isGamePaused) {
        theWorld.setAllowedSpawnTypes(theWorld.getDifficulty() != net.minecraft.world.EnumDifficulty.PEACEFUL, true);
        try
        {
          theWorld.tick();
      ...
      if ((!isGamePaused) && (theWorld != null)) {
        Slice.getTrap(); if (!Slice.getState("Freecam")) {
          theWorld.doVoidFogParticles(MathHelper.floor_double(thePlayerposX), MathHelper.floor_double(thePlayerposY), MathHelper.floor_double(thePlayerposZ));
        }
      }
  ...
  public void loadWorld(WorldClient worldClientIn, String loadingMessage)
  {
    ...
    if (worldClientIn != null) {
      ...
      thePlayermovementInput = new MovementInputFromOptions(gameSettings);
  ...
  public static NetHandlerPlayClient getNetHandler() {
    return thePlayer != null ? thePlayersendQueue : null;
  }
  
  public static boolean isGuiEnabled() {
    return (theMinecraft == null) || (!gameSettingshideGUI);
  }
  
  public static boolean isFancyGraphicsEnabled() {
    return (theMinecraft != null) && (gameSettingsfancyGraphics);
  }
  ...
  {
    return (theMinecraft != null) && (gameSettingsambientOcclusion != 0);
  }
  ...
  {
    if (objectMouseOver != null) {
      boolean var1 = thePlayercapabilities.isCreativeMode;
      int var3 = 0;
      boolean var4 = false;
      ...
      if (objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
        ...
        if ((objectMouseOver.entityHit instanceof EntityPainting)) {
          var2 = Items.painting; } else { Object var2;
          if ((objectMouseOver.entityHit instanceof net.minecraft.entity.EntityLeashKnot)) {
            ...
            default: 
              ...
              break; } } else { Object var2; if ((objectMouseOver.entityHit instanceof net.minecraft.entity.item.EntityBoat)) {
              var2 = Items.boat; } else { Object var2;
      ...
      InventoryPlayer var13 = thePlayerinventory;
      ...
      if (var1) {
        int var16 = thePlayerinventoryContainer.inventorySlots.size() - 9 + currentItem;
  ...
  public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash)
  {
    ...
    theCrash.getCategory().addCrashSectionCallable("Using VBOs", new Callable() {
      ...
      public String call() {
        return gameSettingsfield_178881_t ? "Yes" : "No";
      }
    });
    ...
    theCrash.getCategory().addCrashSectionCallable("Resource Packs", new Callable() {
      ...
      public String call() {
        return gameSettingsresourcePacks.toString();
      }
    });
  ...
  public void addServerStatsToSnooper(PlayerUsageSnooper playerSnooper) {
    ...
    playerSnooper.addClientStat("vsync_enabled", Boolean.valueOf(gameSettingsenableVsync));
  ...
  {
    return gameSettingssnooperEnabled;
  }
  ...
  public MusicTicker.MusicType getAmbientMusicType() {
    return thePlayer != null ? MusicTicker.MusicType.GAME : (thePlayercapabilities.isCreativeMode) && (thePlayercapabilities.allowFlying) ? MusicTicker.MusicType.CREATIVE : (thePlayerworldObj.provider instanceof WorldProviderEnd) ? MusicTicker.MusicType.END : (BossStatus.bossName != null) && (BossStatus.statusBarTime > 0) ? MusicTicker.MusicType.END_BOSS : (thePlayerworldObj.provider instanceof net.minecraft.world.WorldProviderHell) ? MusicTicker.MusicType.NETHER : (currentScreen instanceof GuiWinGame) ? MusicTicker.MusicType.CREDITS : MusicTicker.MusicType.MENU;
  }
  ...
  public void dispatchKeypresses() {
    ...
    if ((var1 != 0) && (!Keyboard.isRepeatEvent()) && (
      (!(currentScreen instanceof GuiControls)) || (currentScreentime <= getSystemTime() - 20L))) {
      if (Keyboard.getEventKeyState()) {
        if (var1 == gameSettingskeyBindStreamStartStop.getKeyCode()) {
        ...
        } else if (var1 == gameSettingskeyBindStreamPauseUnpause.getKeyCode()) {
          if (getTwitchStream().func_152934_n()) {
        ...
        } else if (var1 == gameSettingskeyBindStreamCommercials.getKeyCode()) {
          if (getTwitchStream().func_152934_n()) {
            getTwitchStream().func_152931_p();
          }
        } else if (var1 == gameSettingskeyBindStreamToggleMic.getKeyCode()) {
          stream.func_152910_a(true);
        } else if (var1 == gameSettingskeyBindFullscreen.getKeyCode()) {
          toggleFullscreen();
        } else if (var1 == gameSettingskeyBindScreenshot.getKeyCode()) {
