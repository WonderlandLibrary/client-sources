...
public class RenderFish extends Render
{
  ...
  public void func_180558_a(EntityFishHook p_180558_1_, double p_180558_2_, double p_180558_4_, double p_180558_6_, float p_180558_8_, float p_180558_9_)
  {
    ...
    if (angler != null)
    {
      ...
      if ((renderManager.options == null) || (renderManager.options.thirdPersonView <= 0)) { net.minecraft.client.Minecraft.getMinecraft(); if (angler == net.minecraft.client.Minecraft.thePlayer) {}
      } else {
