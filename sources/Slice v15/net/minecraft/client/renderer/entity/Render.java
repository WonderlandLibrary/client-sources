...
public abstract class Render
{
  ...
  private void renderShadow(Entity p_76975_1_, double p_76975_2_, double p_76975_4_, double p_76975_6_, float p_76975_8_, float p_76975_9_)
  {
    ...
    double var35 = lastTickPosX + (posX - lastTickPosX) * p_76975_9_;
  ...
  {
    if ((net.SliceClient.module.ModuleManager.getModule(Nametags.class).isEnabled()) && (
      ((p_147906_1_ instanceof EntityPlayer)) || ((p_147906_1_ instanceof EntityLiving)))) {
      return;
    }
