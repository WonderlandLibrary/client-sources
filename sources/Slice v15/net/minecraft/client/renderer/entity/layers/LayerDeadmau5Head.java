...
public class LayerDeadmau5Head implements LayerRenderer
{
  ...
  public void func_177207_a(AbstractClientPlayer p_177207_1_, float p_177207_2_, float p_177207_3_, float p_177207_4_, float p_177207_5_, float p_177207_6_, float p_177207_7_, float p_177207_8_)
  {
    if ((p_177207_1_.getName().equals("deadmau5")) && (p_177207_1_.hasSkin()) && (!p_177207_1_.isInvisible()))
    {
      ...
      {
        float var10 = prevRotationYaw + (rotationYaw - prevRotationYaw) * p_177207_4_ - (prevRenderYawOffset + (renderYawOffset - prevRenderYawOffset) * p_177207_4_);
        float var11 = prevRotationPitch + (rotationPitch - prevRotationPitch) * p_177207_4_;
  ...
  {
    func_177207_a((AbstractClientPlayer)p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_, p_177141_6_, p_177141_7_, p_177141_8_);
  }
}
