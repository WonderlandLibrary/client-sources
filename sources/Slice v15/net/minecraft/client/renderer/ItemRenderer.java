...
public class ItemRenderer
{
  ...
  public void renderItem(EntityLivingBase p_178099_1_, ItemStack p_178099_2_, ItemCameraTransforms.TransformType p_178099_3_)
  {
    if (p_178099_2_ != null)
    {
      net.minecraft.item.Item var4 = p_178099_2_.getItem();
  ...
  {
    int var2 = Minecraft.theWorld.getCombinedLight(new BlockPos(posX, posY + p_178109_1_.getEyeHeight(), posZ), 0);
  ...
  private void func_178102_b(AbstractClientPlayer p_178102_1_)
  {
    ...
    Render var2 = field_178111_g.getEntityRenderObject(Minecraft.thePlayer);
  ...
  private void func_178097_a(AbstractClientPlayer p_178097_1_, float p_178097_2_, float p_178097_3_, float p_178097_4_)
  {
    ...
    var11.draw();
    net.minecraft.world.storage.MapData var13 = Items.filled_map.getMapData(itemToRender, Minecraft.theWorld);
    if (var13 != null) {
  ...
  private void func_178095_a(AbstractClientPlayer p_178095_1_, float p_178095_2_, float p_178095_3_)
  {
    ...
    Render var9 = field_178111_g.getEntityRenderObject(Minecraft.thePlayer);
  ...
  private void func_178096_b1(float p_178096_1_, float p_178096_2_)
  {
    GlStateManager.translate(0.56F, -0.52F, -0.71999997F);
    GlStateManager.translate(0.0F, p_178096_1_ * -0.6F, 0.0F);
    GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
    float var3 = MathHelper.sin(p_178096_2_ * p_178096_2_ * 3.1415927F);
    float var4 = MathHelper.sin(MathHelper.sqrt_float(p_178096_2_) * 3.1415927F);
    GlStateManager.rotate(var3 * -10.0F, 0.0F, 1.0F, 0.0F);
    GlStateManager.rotate(var4 * -10.0F, 0.0F, 0.0F, 1.0F);
    GlStateManager.rotate(var4 * -30.0F, 1.0F, 0.0F, 0.0F);
    GlStateManager.scale(0.4F, 0.4F, 0.4F);
  }
  
  private void A_Animation(float p_178096_1_, float p_178096_2_)
  {
    GlStateManager.translate(0.56F, -0.52F, -0.71999997F);
    GlStateManager.translate(0.0F, p_178096_1_ * -0.6F, 0.0F);
    GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
    ...
    GlStateManager.rotate(var4 * -10.0F, 0.0F, 0.0F, 1.0F);
    GlStateManager.rotate(var4 * -30.0F, 1.0F, 0.0F, 0.0F);
    GlStateManager.rotate(var4 * -35.0F, 1.0F, 0.0F, 0.0F);
    GlStateManager.rotate(var4 * -38.0F, 1.0F, 0.0F, 0.0F);
    GlStateManager.scale(0.4F, 0.4F, 0.4F);
  }
  ...
  public void renderOverlays(float p_78447_1_)
  {
    if (Minecraft.thePlayer.isEntityInsideOpaqueBlock())
    {
      ...
      {
        double var5 = posX + ((var4 >> 0) % 2 - 0.5F) * width * 0.8F;
        double var7 = posY + ((var4 >> 1) % 2 - 0.5F) * 0.1F;
        double var9 = posZ + ((var4 >> 2) % 2 - 0.5F) * width * 0.8F;
        BlockPos var11 = new BlockPos(var5, var7 + var3.getEyeHeight(), var9);
        IBlockState var12 = Minecraft.theWorld.getBlockState(var11);
    ...
    {
      if (Minecraft.thePlayer.isInsideOfMaterial(net.minecraft.block.material.Material.water)) {
  ...
  private void renderWaterOverlayTexture(float p_78448_1_)
  {
    ...
    float var9 = 1.0F;
    float var10 = -0.5F;
    float var11 = -thePlayerrotationYaw / 64.0F;
    float var12 = thePlayerrotationPitch / 64.0F;
