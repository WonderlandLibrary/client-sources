...
public class OpenGlHelper
{
  ...
  public static void initializeTextures()
  {
    ...
    openGL21 = OpenGL21;
    field_153213_x = (openGL21) || ((GL_ARB_vertex_shader) && (GL_ARB_fragment_shader) && (GL_ARB_shader_objects));
  ...
  {
    if (field_176083_O) { Minecraft.getMinecraft(); if (gameSettingsfield_178881_t) return true; } return false;
  }
  ...
  {
    if (framebufferSupported) { Minecraft.getMinecraft(); if (gameSettingsfboEnable) return true; } return false;
  }
}
