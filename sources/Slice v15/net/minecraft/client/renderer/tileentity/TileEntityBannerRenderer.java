...
public class TileEntityBannerRenderer extends TileEntitySpecialRenderer
{
  ...
  public void func_180545_a(TileEntityBanner p_180545_1_, double p_180545_2_, double p_180545_4_, double p_180545_6_, float p_180545_8_, int p_180545_9_) { boolean var10 = p_180545_1_.getWorld() != null;
    boolean var11 = (!var10) || (p_180545_1_.getBlockType() == net.minecraft.init.Blocks.standing_banner);
    ...
    float var17 = var19.getX() * 7 + var19.getY() * 9 + var19.getZ() * 13 + (float)var13 + p_180545_8_;
    field_178465_e.bannerSlate.rotateAngleX = ((-0.0125F + 0.01F * MathHelper.cos(var17 * 3.1415927F * 0.02F)) * 3.1415927F);
    GlStateManager.enableRescaleNormal();
    ResourceLocation var18 = func_178463_a(p_180545_1_);
    ...
    if (var3 == null)
    {
      if (field_178466_c.size() >= 256)
      {
        ...
        while (var6.hasNext())
        {
          ...
          if (var4 - field_178472_a > 60000L)
          {
            Minecraft.getMinecraft().getTextureManager().deleteTexture(field_178471_b);
            var6.remove();
          }
        }
      ...
      field_178471_b = new ResourceLocation(var2);
      Minecraft.getMinecraft().getTextureManager().loadTexture(field_178471_b, new LayeredColorMaskTexture(field_178464_d, var10, var5));
      field_178466_c.put(var2, var3);
    }
    
    field_178472_a = System.currentTimeMillis();
    return field_178471_b;
  }
