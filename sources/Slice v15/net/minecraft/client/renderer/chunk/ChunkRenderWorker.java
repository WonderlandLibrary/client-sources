...
public class ChunkRenderWorker implements Runnable
{
  ...
  protected void func_178474_a(final ChunkCompileTaskGenerator p_178474_1_) throws InterruptedException
  {
    ...
    {
      p_178474_1_.func_178540_f().unlock(); } p_178474_1_.func_178540_f().unlock();
    ...
    else
    {
      ...
      float var4 = (float)posY + var2.getEyeHeight();
      ...
      if (var6 == ChunkCompileTaskGenerator.Type.REBUILD_CHUNK)
      {
        ...
        for (int var11 = 0; var11 < var10; var11++)
        {
          ...
          {
            var8.add(field_178477_b.func_178503_a(var12, p_178474_1_.func_178545_d().func_179038_a(var12), p_178474_1_.func_178536_b(), var7));
          }
        }
      }
      else if (var6 == ChunkCompileTaskGenerator.Type.RESORT_TRANSPARENCY)
      {
        var8.add(field_178477_b.func_178503_a(EnumWorldBlockLayer.TRANSLUCENT, p_178474_1_.func_178545_d().func_179038_a(EnumWorldBlockLayer.TRANSLUCENT), p_178474_1_.func_178536_b(), var7));
      }
      ...
      Futures.addCallback(var19, new com.google.common.util.concurrent.FutureCallback()
      {
