...
public class RenderChunk
{
  ...
  public void func_178581_b(float p_178581_1_, float p_178581_2_, float p_178581_3_, ChunkCompileTaskGenerator p_178581_4_)
  {
    ...
    try
    {
      ...
      RegionRenderCache var9 = new RegionRenderCache(field_178588_d, var7.add(-1, -1, -1), var8.add(1, 1, 1), 1);
      p_178581_4_.func_178543_a(var5);
    }
    finally
    {
      p_178581_4_.func_178540_f().unlock(); } RegionRenderCache var9; p_178581_4_.func_178540_f().unlock();
    ...
    if (!var9.extendedLevelsInChunkCache())
    {
      ...
      {
        EnumWorldBlockLayer var231 = var201[var221];
        
        if (var5.func_178492_d(var231))
        {
          func_178584_a(var231, p_178581_1_, p_178581_2_, p_178581_3_, p_178581_4_.func_178545_d().func_179038_a(var231), var5);
        }
      }
    }
  ...
  public ChunkCompileTaskGenerator func_178582_e()
  {
    ...
    try
    {
      ...
      ChunkCompileTaskGenerator var1;
      field_178587_g.unlock(); } ChunkCompileTaskGenerator var1; field_178587_g.unlock();
