...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester.IngestTestListener, IStream
{
  ...
  {
    int var1 = gameSettingsstreamChatEnabled;
  ...
  public void func_152915_s()
  {
    if (func_152934_n())
    {
      float var1 = gameSettingsstreamGameVolume;
      boolean var2 = (field_152962_n) || (var1 <= 0.0F);
      broadcastController.func_152837_b(var2 ? 0.0F : var1);
      broadcastController.func_152829_a(func_152929_G() ? 0.0F : gameSettingsstreamMicVolume);
    }
  }
  ...
  public void func_152930_t()
  {
    ...
    VideoParams var2 = broadcastController.func_152834_a(func_152946_b(streamKbps), func_152948_a(streamFps), func_152947_c(streamBytesPerPixel), Minecraft.displayWidth / Minecraft.displayHeight);
  ...
  public void func_180605_a(String p_180605_1_, ChatRawMessage[] p_180605_2_)
  {
    ...
    for (int var5 = 0; var5 < var4; var5++)
    {
      ...
      if (func_176028_a(modes, subscriptions, gameSettingsstreamChatUserFilter))
      {
  ...
  {
    boolean var1 = gameSettingsstreamMicToggleBehavior == 1;
    return (field_152962_n) || (gameSettingsstreamMicVolume <= 0.0F) || (var1 != field_152963_o);
  }
