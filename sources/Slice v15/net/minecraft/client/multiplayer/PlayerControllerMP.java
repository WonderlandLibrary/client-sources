...
import net.SliceClient.event.EventPreAttack;
...
public class PlayerControllerMP
{
  ...
  public void setGameType(WorldSettings.GameType p_78746_1_)
  {
    ...
    currentGameType.configurePlayerCapabilities(thePlayercapabilities);
  }
  ...
  public boolean func_178888_a(BlockPos p_178888_1_, EnumFacing p_178888_2_)
  {
    ...
    if ((currentGameType.isCreative()) && (Minecraft.thePlayer.getHeldItem() != null) && ((Minecraft.thePlayer.getHeldItem().getItem() instanceof net.minecraft.item.ItemSword)))
    {
      return false;
    }
  ...
  public boolean func_180511_b(BlockPos p_180511_1_, EnumFacing p_180511_2_)
  {
    if (currentGameType.isAdventure())
    {
      ...
      if (!Minecraft.thePlayer.func_175142_cm())
      {
        Block var3 = Minecraft.theWorld.getBlockState(p_180511_1_).getBlock();
        ItemStack var4 = Minecraft.thePlayer.getCurrentEquippedItem();
    ...
    else if ((!isHittingBlock) || (!func_178893_a(p_180511_1_)))
    {
      ...
      {
        var3.onBlockClicked(Minecraft.theWorld, p_180511_1_, Minecraft.thePlayer);
      }
      
      if ((var5) && (var3.getPlayerRelativeBlockHardness(Minecraft.thePlayer, thePlayerworldObj, p_180511_1_) >= 1.0F))
      {
      ...
      else
      {
        ...
        Minecraft.theWorld.sendBlockBreakProgress(Minecraft.thePlayer.getEntityId(), field_178895_c, (int)(curBlockDamageMP * 10.0F) - 1);
      }
    }
  ...
  public boolean func_180512_c(BlockPos p_180512_1_, EnumFacing p_180512_2_)
  {
    ...
    if ((currentGameType.isCreative()) && (Minecraft.theWorld.getWorldBorder().contains(p_180512_1_)))
    {
      blockHitDelay = 5;
    ...
    if (func_178893_a(p_180512_1_))
    {
      ...
      curBlockDamageMP += var3.getPlayerRelativeBlockHardness(Minecraft.thePlayer, thePlayerworldObj, p_180512_1_);
  ...
  {
    int var1 = thePlayerinventory.currentItem;
  ...
  {
    EventPreAttack eventPre = new EventPreAttack(targetEntity);
    com.darkmagician6.eventapi.EventManager.call(eventPre);
    syncCurrentPlayItem();
  ...
  {
    return (Minecraft.thePlayer.isRiding()) && ((thePlayerridingEntity instanceof EntityHorse));
  }
  ...
  {
    syncCurrentPlayItem();
    float var7 = (float)(xCoord - hitPos.getX());
    float var8 = (float)(yCoord - hitPos.getY());
    float var9 = (float)(zCoord - hitPos.getZ());
    boolean var10 = false;
    ...
    netClientHandler.addToSendQueue(new C08PacketPlayerBlockPlacement(hitPos, side.getIndex(), inventory.getCurrentItem(), var7, var8, var9));
    if ((!var10) && (currentGameType != WorldSettings.GameType.SPECTATOR))
    {
      if (heldStack == null) {
        return false;
