...
public class LoadingScreenRenderer implements net.minecraft.util.IProgressUpdate
{
  ...
  public void setLoadingProgress(int progress)
  {
    ...
    else
    {
      ...
      {
        field_73723_d = var2;
        ScaledResolution var4 = new ScaledResolution(mc, Minecraft.displayWidth, Minecraft.displayHeight);
        ...
        Minecraft.fontRendererObj.func_175063_a(currentlyDisplayedText, (var6 - Minecraft.fontRendererObj.getStringWidth(currentlyDisplayedText)) / 2, var7 / 2 - 4 - 16, 16777215);
        Minecraft.fontRendererObj.func_175063_a(field_73727_a, (var6 - Minecraft.fontRendererObj.getStringWidth(field_73727_a)) / 2, var7 / 2 - 4 + 8, 16777215);
