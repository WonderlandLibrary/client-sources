...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
  ...
  public void handleJoinGame(S01PacketJoinGame packetIn)
  {
    ...
    clientWorldController = new WorldClient(this, new WorldSettings(0L, packetIn.func_149198_e(), false, packetIn.func_149195_d(), packetIn.func_149196_i()), packetIn.func_149194_f(), packetIn.func_149192_g(), gameController.mcProfiler);
    gameSettingsdifficulty = packetIn.func_149192_g();
    gameController.loadWorld(clientWorldController);
    thePlayerdimension = packetIn.func_149194_f();
    gameController.displayGuiScreen(new GuiDownloadTerrain(this));
    Minecraft.thePlayer.setEntityId(packetIn.func_149197_c());
    currentServerMaxPlayers = packetIn.func_149193_h();
    Minecraft.thePlayer.func_175150_k(packetIn.func_179744_h());
    Minecraft.playerController.setGameType(packetIn.func_149198_e());
  ...
  public void handleSpawnObject(S0EPacketSpawnObject packetIn)
  {
    ...
    {
      var8 = net.minecraft.entity.item.EntityMinecart.func_180458_a(clientWorldController, var2, var4, var6, EntityMinecart.EnumMinecartType.func_180038_a(packetIn.func_149009_m()));
    }
    ...
    {
      var8 = new net.minecraft.entity.item.EntityItemFrame(clientWorldController, new BlockPos(MathHelper.floor_double(var2), MathHelper.floor_double(var4), MathHelper.floor_double(var6)), net.minecraft.util.EnumFacing.getHorizontal(packetIn.func_149009_m()));
      packetIn.func_149002_g(0);
    }
    else if (packetIn.func_148993_l() == 77)
    {
      var8 = new net.minecraft.entity.EntityLeashKnot(clientWorldController, new BlockPos(MathHelper.floor_double(var2), MathHelper.floor_double(var4), MathHelper.floor_double(var6)));
      packetIn.func_149002_g(0);
    }
    ...
    {
      var8 = new EntityLargeFireball(clientWorldController, var2, var4, var6, packetIn.func_149010_g() / 8000.0D, packetIn.func_149004_h() / 8000.0D, packetIn.func_148999_i() / 8000.0D);
      packetIn.func_149002_g(0);
    }
    else if (packetIn.func_148993_l() == 64)
    {
      var8 = new EntitySmallFireball(clientWorldController, var2, var4, var6, packetIn.func_149010_g() / 8000.0D, packetIn.func_149004_h() / 8000.0D, packetIn.func_148999_i() / 8000.0D);
      packetIn.func_149002_g(0);
    }
    else if (packetIn.func_148993_l() == 66)
    {
      var8 = new net.minecraft.entity.projectile.EntityWitherSkull(clientWorldController, var2, var4, var6, packetIn.func_149010_g() / 8000.0D, packetIn.func_149004_h() / 8000.0D, packetIn.func_148999_i() / 8000.0D);
      packetIn.func_149002_g(0);
    }
    ...
    {
      var8 = new EntityFallingBlock(clientWorldController, var2, var4, var6, Block.getStateById(packetIn.func_149009_m() & 0xFFFF));
      packetIn.func_149002_g(0);
    }
  ...
  {
    PacketThreadUtil.func_180031_a(packetIn, this, gameController);
    EntityXPOrb var2 = new EntityXPOrb(clientWorldController, packetIn.func_148984_d(), packetIn.func_148983_e(), packetIn.func_148982_f(), packetIn.func_148986_g());
  ...
  {
    PacketThreadUtil.func_180031_a(packetIn, this, gameController);
    EntityPainting var2 = new EntityPainting(clientWorldController, packetIn.func_179837_b(), packetIn.func_179836_c(), packetIn.func_148961_h());
  ...
  public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn)
  {
    ...
    EntityOtherPlayerMP var10 = new EntityOtherPlayerMP(Minecraft.theWorld, func_175102_a(packetIn.func_179819_c()).func_178845_a());
  ...
  public void handleEntityTeleport(S18PacketEntityTeleport packetIn)
  {
    ...
    if (var2 != null)
    {
      ...
      if ((Math.abs(posX - var3) < 0.03125D) && (Math.abs(posY - var5) < 0.015625D) && (Math.abs(posZ - var7) < 0.03125D))
      {
  ...
  public void handleHeldItemChange(S09PacketHeldItemChange packetIn)
  {
    ...
    {
      thePlayerinventory.currentItem = packetIn.func_149385_c();
    }
  }
  ...
  public void handleEntityMovement(S14PacketEntity packetIn)
  {
    ...
    if (var2 != null)
    {
      ...
      double var7 = serverPosZ / 32.0D;
      float var9 = packetIn.func_149060_h() ? packetIn.func_149066_f() * 360 / 256.0F : rotationYaw;
      float var10 = packetIn.func_149060_h() ? packetIn.func_149063_g() * 360 / 256.0F : rotationPitch;
  ...
  public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn)
  {
    ...
    netManager.sendPacket(new net.minecraft.network.play.client.C03PacketPlayer.C06PacketPlayerPosLook(posX, getEntityBoundingBoxminY, posZ, rotationYaw, rotationPitch, false));
    
    if (!doneLoadingTerrain)
    {
      thePlayerprevPosX = thePlayerposX;
      thePlayerprevPosY = thePlayerposY;
      thePlayerprevPosZ = thePlayerposZ;
  ...
  public void handleChunkData(S21PacketChunkData packetIn)
  {
    ...
    clientWorldController.invalidateBlockReceiveRegion(packetIn.func_149273_e() << 4, 0, packetIn.func_149271_f() << 4, (packetIn.func_149273_e() << 4) + 15, 256, (packetIn.func_149271_f() << 4) + 15);
    Chunk var2 = clientWorldController.getChunkFromChunkCoords(packetIn.func_149273_e(), packetIn.func_149271_f());
    var2.func_177439_a(packetIn.func_149272_d(), packetIn.func_149276_g(), packetIn.func_149274_i());
    clientWorldController.markBlockRangeForRenderUpdate(packetIn.func_149273_e() << 4, 0, packetIn.func_149271_f() << 4, (packetIn.func_149273_e() << 4) + 15, 256, (packetIn.func_149271_f() << 4) + 15);
  ...
  public void addToSendQueue(Packet p_147297_1_)
  {
    ...
    com.darkmagician6.eventapi.EventManager.call(event);
    if (event.isCancelled()) {
      return;
    }
    Slice.getTrap(); if (!Slice.getState("Freecam")) {
  ...
  public void handleCollectItem(S0DPacketCollectItem packetIn)
  {
    ...
    if (var2 != null)
    {
      ...
      {
        clientWorldController.playSoundAtEntity(var2, "random.orb", 0.2F, ((avRandomizer.nextFloat() - avRandomizer.nextFloat()) * 0.7F + 1.0F) * 2.0F);
      }
      else
      {
        clientWorldController.playSoundAtEntity(var2, "random.pop", 0.2F, ((avRandomizer.nextFloat() - avRandomizer.nextFloat()) * 0.7F + 1.0F) * 2.0F);
      }
  ...
  public void handleSpawnMob(S0FPacketSpawnMob packetIn)
  {
    ...
    EntityLivingBase var10 = (EntityLivingBase)net.minecraft.entity.EntityList.createEntityByID(packetIn.func_149025_e(), Minecraft.theWorld);
  ...
  {
    PacketThreadUtil.func_180031_a(packetIn, this, gameController);
    Minecraft.thePlayer.func_180473_a(packetIn.func_179800_a(), true);
  ...
  public void handleEntityAttach(S1BPacketEntityAttach packetIn)
  {
    ...
    if (packetIn.func_149404_c() == 0)
    {
      ...
      if (packetIn.func_149403_d() == Minecraft.thePlayer.getEntityId())
      {
      ...
      if (var4)
      {
        GameSettings var5 = Minecraft.gameSettings;
        gameController.ingameGUI.setRecordPlaying(I18n.format("mount.onboard", new Object[] { GameSettings.getKeyDisplayString(keyBindSneak.getKeyCode()) }), false);
      }
    }
  ...
  {
    PacketThreadUtil.func_180031_a(packetIn, this, gameController);
    Minecraft.thePlayer.setXPStats(packetIn.func_149397_c(), packetIn.func_149396_d(), packetIn.func_149395_e());
  }
  ...
  public void handleRespawn(S07PacketRespawn packetIn)
  {
    ...
    if (packetIn.func_149082_c() != thePlayerdimension)
    {
      doneLoadingTerrain = false;
      Scoreboard var2 = clientWorldController.getScoreboard();
      clientWorldController = new WorldClient(this, new WorldSettings(0L, packetIn.func_149083_e(), false, Minecraft.theWorld.getWorldInfo().isHardcoreModeEnabled(), packetIn.func_149080_f()), packetIn.func_149082_c(), packetIn.func_149081_d(), gameController.mcProfiler);
      clientWorldController.setWorldScoreboard(var2);
      gameController.loadWorld(clientWorldController);
      thePlayerdimension = packetIn.func_149082_c();
      gameController.displayGuiScreen(new GuiDownloadTerrain(this));
    }
    
    gameController.setDimensionAndSpawnPlayer(packetIn.func_149082_c());
    Minecraft.playerController.setGameType(packetIn.func_149083_e());
  }
  ...
  public void handleExplosion(S27PacketExplosion packetIn)
  {
    ...
    thePlayermotionX += packetIn.func_149149_c();
    thePlayermotionY += packetIn.func_149144_d();
    thePlayermotionZ += packetIn.func_149147_e();
  }
  ...
  public void handleSetSlot(S2FPacketSetSlot packetIn)
  {
    ...
    else
    {
      ...
      {
        GuiContainerCreative var4 = (GuiContainerCreative)Minecraft.currentScreen;
      ...
      if ((packetIn.func_149175_c() == 0) && (packetIn.func_149173_d() >= 36) && (packetIn.func_149173_d() < 45))
      {
        ...
        if ((packetIn.func_149174_e() != null) && ((var5 == null) || (stackSize < func_149174_estackSize)))
        {
      ...
      else if ((packetIn.func_149175_c() == openContainer.windowId) && ((packetIn.func_149175_c() != 0) || (!var3)))
      {
  ...
  public void handleConfirmTransaction(S32PacketConfirmTransaction packetIn)
  {
    ...
    {
      addToSendQueue(new C0FPacketConfirmTransaction(packetIn.func_148889_c(), packetIn.func_148890_d(), true));
    }
  }
  ...
  public void handleSignEditorOpen(S36PacketSignEditorOpen packetIn)
  {
    ...
    Minecraft.thePlayer.func_175141_a((TileEntitySign)var2);
  }
  ...
  public void handleUpdateSign(S33PacketUpdateSign packetIn)
  {
    ...
    if (Minecraft.theWorld.isBlockLoaded(packetIn.func_179704_a()))
    {
      TileEntity var3 = Minecraft.theWorld.getTileEntity(packetIn.func_179704_a());
    ...
    {
      Minecraft.thePlayer.addChatMessage(new ChatComponentText("Unable to locate sign at " + packetIn.func_179704_a().getX() + ", " + packetIn.func_179704_a().getY() + ", " + packetIn.func_179704_a().getZ()));
    }
  }
  ...
  public void handleUpdateTileEntity(S35PacketUpdateTileEntity packetIn)
  {
    ...
    if (Minecraft.theWorld.isBlockLoaded(packetIn.func_179823_a()))
    {
      ...
      if (((var3 == 1) && ((var2 instanceof TileEntityMobSpawner))) || ((var3 == 2) && ((var2 instanceof TileEntityCommandBlock))) || ((var3 == 3) && ((var2 instanceof TileEntityBeacon))) || ((var3 == 4) && ((var2 instanceof TileEntitySkull))) || ((var3 == 5) && ((var2 instanceof TileEntityFlowerPot))) || ((var3 == 6) && ((var2 instanceof net.minecraft.tileentity.TileEntityBanner))))
      {
  ...
  public void handleMapChunkBulk(S26PacketMapChunkBulk packetIn)
  {
    ...
    for (int var2 = 0; var2 < packetIn.func_149254_d(); var2++)
    {
      ...
      clientWorldController.invalidateBlockReceiveRegion(var3 << 4, 0, var4 << 4, (var3 << 4) + 15, 256, (var4 << 4) + 15);
      ...
      clientWorldController.markBlockRangeForRenderUpdate(var3 << 4, 0, var4 << 4, (var3 << 4) + 15, 256, (var4 << 4) + 15);
  ...
  public void handleChangeGameState(S2BPacketChangeGameState packetIn)
  {
    ...
    {
      GameSettings var6 = Minecraft.gameSettings;
      ...
      {
        gameController.ingameGUI.getChatGUI().printChatMessage(new ChatComponentTranslation("demo.help.movement", new Object[] { GameSettings.getKeyDisplayString(keyBindForward.getKeyCode()), GameSettings.getKeyDisplayString(keyBindLeft.getKeyCode()), GameSettings.getKeyDisplayString(keyBindBack.getKeyCode()), GameSettings.getKeyDisplayString(keyBindRight.getKeyCode()) }));
      }
      else if (var4 == 102.0F)
      {
        gameController.ingameGUI.getChatGUI().printChatMessage(new ChatComponentTranslation("demo.help.jump", new Object[] { GameSettings.getKeyDisplayString(keyBindJump.getKeyCode()) }));
      }
      else if (var4 == 103.0F)
      {
        gameController.ingameGUI.getChatGUI().printChatMessage(new ChatComponentTranslation("demo.help.inventory", new Object[] { GameSettings.getKeyDisplayString(keyBindInventory.getKeyCode()) }));
      }
    }
    else if (var3 == 6)
    {
      clientWorldController.playSound(posX, posY + var2.getEyeHeight(), posZ, "random.successful_hit", 0.18F, 0.45F, false);
    }
    else if (var3 == 7)
    {
    ...
    {
      clientWorldController.spawnParticle(EnumParticleTypes.MOB_APPEARANCE, posX, posY, posZ, 0.0D, 0.0D, 0.0D, new int[0]);
      clientWorldController.playSound(posX, posY, posZ, "mob.guardian.curse", 1.0F, 1.0F, false);
    }
  }
  ...
  {
    PacketThreadUtil.func_180031_a(packetIn, this, gameController);
    MapData var2 = net.minecraft.item.ItemMap.loadMapData(packetIn.getMapId(), Minecraft.theWorld);
  ...
  public void handleStatistics(S37PacketStatistics packetIn)
  {
    ...
    StatBase var5;
    int var6;
    for (Iterator var3 = packetIn.func_148974_c().entrySet().iterator(); var3.hasNext(); Minecraft.thePlayer.getStatFileWriter().func_150873_a(Minecraft.thePlayer, var5, var6))
    {
      ...
      {
        if ((field_147308_k) && (Minecraft.thePlayer.getStatFileWriter().writeStat(var5) == 0))
        {
          ...
          {
            gameSettingsshowInventoryAchievementHint = false;
    ...
    if ((!field_147308_k) && (!var2) && (gameSettingsshowInventoryAchievementHint))
    {
    ...
    {
      ((IProgressMeter)Minecraft.currentScreen).doneLoading();
    }
  }
  ...
  public void func_175099_a(S45PacketTitle p_175099_1_)
  {
    ...
    gameController.ingameGUI.func_175178_a(var3, var4, p_175099_1_.func_179806_c(), p_175099_1_.func_179804_d(), p_175099_1_.func_179803_e());
  }
  ...
  {
    gameController.ingameGUI.getTabList().setHeader(p_175096_1_.func_179700_a().getFormattedText().length() == 0 ? null : p_175096_1_.func_179700_a());
    gameController.ingameGUI.getTabList().setFooter(p_175096_1_.func_179701_b().getFormattedText().length() == 0 ? null : p_175096_1_.func_179701_b());
  }
  ...
  public void handleTabComplete(S3APacketTabComplete packetIn)
  {
    ...
    {
      GuiChat var3 = (GuiChat)Minecraft.currentScreen;
  ...
  public void func_175095_a(S48PacketResourcePackSend p_175095_1_)
  {
    ...
    if (var2.startsWith("level://"))
    {
      ...
      if (var6.isFile())
      {
        ...
        Futures.addCallback(gameController.getResourcePackRepository().func_177319_a(var6), new FutureCallback()
        {
          private static final String __OBFID = "CL_00000879";
          
          public void onSuccess(Object p_onSuccess_1_) {
            netManager.sendPacket(new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.SUCCESSFULLY_LOADED));
          }
          
          public void onFailure(Throwable p_onFailure_1_) {
            netManager.sendPacket(new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.FAILED_DOWNLOAD));
          }
        });
      }
      else
    ...
    else if ((gameController.getCurrentServerData() != null) && (gameController.getCurrentServerData().getResourceMode() == ServerData.ServerResourceMode.ENABLED))
    {
      netManager.sendPacket(new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.ACCEPTED));
      Futures.addCallback(gameController.getResourcePackRepository().func_180601_a(var2, var3), new FutureCallback()
      {
          ...
          gameController.displayGuiScreen(new GuiYesNo(new net.minecraft.client.gui.GuiYesNoCallback()
          {
            ...
            public void confirmClicked(boolean result, int id) {
              ...
              if (result)
              {
                ...
                netManager.sendPacket(new C19PacketResourcePackStatus(val$var3, C19PacketResourcePackStatus.Action.ACCEPTED));
                Futures.addCallback(gameController.getResourcePackRepository().func_180601_a(val$var2, val$var3), new FutureCallback()
                {
                  private static final String __OBFID = "CL_00002621";
                  
                  public void onSuccess(Object p_onSuccess_1_) {
                    netManager.sendPacket(new C19PacketResourcePackStatus(val$var3, C19PacketResourcePackStatus.Action.SUCCESSFULLY_LOADED));
                  }
                  
                  public void onFailure(Throwable p_onFailure_1_) {
                    netManager.sendPacket(new C19PacketResourcePackStatus(val$var3, C19PacketResourcePackStatus.Action.FAILED_DOWNLOAD));
                  }
                });
              }
              else
              {
                ...
                netManager.sendPacket(new C19PacketResourcePackStatus(val$var3, C19PacketResourcePackStatus.Action.DECLINED));
              }
  ...
  public void handleCustomPayload(S3FPacketCustomPayload packetIn)
  {
    ...
    if ("MC|TrList".equals(packetIn.getChannelName()))
    {
      ...
      try
      {
        ...
        GuiScreen var4 = Minecraft.currentScreen;
        
        if ((var4 != null) && ((var4 instanceof GuiMerchant))) { if (var3 != thePlayeropenContainer.windowId)
            break label122;
    ...
    {
      Minecraft.thePlayer.func_175158_f(packetIn.getBufferData().readStringFromBuffer(32767));
    }
    else if ("MC|BOpen".equals(packetIn.getChannelName()))
    {
      ItemStack var12 = Minecraft.thePlayer.getCurrentEquippedItem();
      
      if ((var12 != null) && (var12.getItem() == net.minecraft.init.Items.written_book))
      {
        gameController.displayGuiScreen(new net.minecraft.client.gui.GuiScreenBook(Minecraft.thePlayer, var12, false));
      }
    }
  }
  ...
  public void handleParticles(S2APacketParticles packetIn)
  {
    ...
    if (packetIn.func_149222_k() == 0)
    {
      ...
      try
      {
        clientWorldController.spawnParticle(packetIn.func_179749_a(), packetIn.func_179750_b(), packetIn.func_149220_d(), packetIn.func_149226_e(), packetIn.func_149225_f(), var2, var4, var6, packetIn.func_179748_k());
      }
    ...
    else
    {
      for (int var18 = 0; var18 < packetIn.func_149222_k(); var18++)
      {
        ...
        try
        {
          clientWorldController.spawnParticle(packetIn.func_179749_a(), packetIn.func_179750_b(), packetIn.func_149220_d() + var3, packetIn.func_149226_e() + var5, packetIn.func_149225_f() + var7, var9, var11, var13, packetIn.func_179748_k());
        }
  ...
  public void handleEntityProperties(S20PacketEntityProperties packetIn)
  {
    ...
    if (var2 != null)
    {
          ...
          var7.hasNext())
      {
        ...
        if (var6 == null)
        {
          var6 = var3.registerAttribute(new net.minecraft.entity.ai.attributes.RangedAttribute(null, var5.func_151409_a(), 0.0D, 2.2250738585072014E-308D, Double.MAX_VALUE));
        }
