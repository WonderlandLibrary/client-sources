...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
  ...
  protected void actionPerformed(GuiButton button) throws java.io.IOException
  {
    if (enabled)
    {
      ...
      if (id == 109)
      {
        mc.displayGuiScreen(new GuiYesNo(this, new ChatComponentTranslation("difficulty.lock.title", new Object[0]).getFormattedText(), new ChatComponentTranslation("difficulty.lock.question", new Object[] { new ChatComponentTranslation(Minecraft.theWorld.getWorldInfo().getDifficulty().getDifficultyResourceKey(), new Object[0]) }).getFormattedText(), 109));
      }
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    TTFManager.getInstance().getLemonMilk().drawCenteredString(field_146442_a, width / 2, 15.0F, 16777215);
