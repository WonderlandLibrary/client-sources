...
public class GuiSleepMP extends GuiChat
{
  ...
  {
    NetHandlerPlayClient var1 = thePlayersendQueue;
    var1.addToSendQueue(new net.minecraft.network.play.client.C0BPacketEntityAction(Minecraft.thePlayer, net.minecraft.network.play.client.C0BPacketEntityAction.Action.STOP_SLEEPING));
  }
}
