...
public abstract class GuiResourcePackList extends GuiListExtended
{
  ...
  public GuiResourcePackList(Minecraft mcIn, int p_i45055_2_, int p_i45055_3_, List p_i45055_4_)
  {
    ...
    setHasListHeader(true, (int)(fontRendererObjFONT_HEIGHT * 1.5F));
  }
  ...
  protected void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_)
  {
    ...
    Minecraft.fontRendererObj.drawString(var4, p_148129_1_ + width / 2 - Minecraft.fontRendererObj.getStringWidth(var4) / 2, Math.min(top + 3, p_148129_2_), 16777215);
  }
