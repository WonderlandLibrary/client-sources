...
public class GuiSpectator extends Gui implements net.minecraft.client.gui.spectator.ISpectatorMenuReciepient
{
  ...
  private void func_175266_a(int p_175266_1_, int p_175266_2_, float p_175266_3_, float p_175266_4_, ISpectatorMenuObject p_175266_5_)
  {
    ...
    if (p_175266_5_ != SpectatorMenu.field_178657_a)
    {
      ...
      String var8 = String.valueOf(GameSettings.getKeyDisplayString(gameSettingskeyBindsHotbar[p_175266_1_].getKeyCode()));
      
      if ((var6 > 3) && (p_175266_5_.func_178662_A_()))
      {
        Minecraft.fontRendererObj.func_175063_a(var8, p_175266_2_ + 19 - 2 - Minecraft.fontRendererObj.getStringWidth(var8), p_175266_3_ + 6.0F + 3.0F, 16777215 + (var6 << 24));
      }
    }
  }
  ...
  public void func_175263_a(ScaledResolution p_175263_1_)
  {
    ...
    if ((var2 > 3) && (field_175271_i != null))
    {
      ...
      if (var4 != null)
      {
        int var5 = (p_175263_1_.getScaledWidth() - Minecraft.fontRendererObj.getStringWidth(var4)) / 2;
        int var6 = p_175263_1_.getScaledHeight() - 35;
        GlStateManager.pushMatrix();
        GlStateManager.enableBlend();
        GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
        Minecraft.fontRendererObj.func_175063_a(var4, var5, var6, 16777215 + (var2 << 24));
        GlStateManager.disableBlend();
        GlStateManager.popMatrix();
      }
    }
