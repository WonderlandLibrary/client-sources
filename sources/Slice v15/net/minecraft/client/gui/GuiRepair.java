...
public class GuiRepair extends GuiContainer implements net.minecraft.inventory.ICrafting
{
  ...
  protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
  {
    ...
    if (anvil.maximumCost > 0)
    {
      ...
      if ((anvil.maximumCost >= 40) && (!thePlayercapabilities.isCreativeMode))
      {
  ...
  private void renameItem()
  {
    ...
    thePlayersendQueue.addToSendQueue(new C17PacketCustomPayload("MC|ItemName", new PacketBuffer(io.netty.buffer.Unpooled.buffer()).writeString(var1)));
  }
