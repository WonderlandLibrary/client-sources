...
public class GuiOverlayDebug extends Gui
{
  ...
  public void func_175237_a(ScaledResolution scaledResolutionIn)
  {
    ...
    net.minecraft.src.Lagometer.showLagometer(scaledResolutionIn);
    mc.mcProfiler.endSection();
  }
  
  private boolean func_175236_d()
  {
    return (Minecraft.thePlayer.func_175140_cp()) || (gameSettingsfield_178879_v);
  }
  ...
  protected List call()
  {
    ...
    if (func_175236_d())
    {
      return Lists.newArrayList(new String[] { "Minecraft 1.8 (" + mc.func_175600_c() + "/" + net.minecraft.client.ClientBrandRetriever.getClientModName() + ")", mc.debug, mc.renderGlobal.getDebugInfoRenders(), mc.renderGlobal.getDebugInfoEntities(), "P: " + mc.effectRenderer.getStatistics() + ". T: " + Minecraft.theWorld.getDebugLoadedEntities(), Minecraft.theWorld.getProviderName(), "", String.format("Chunk-relative: %d %d %d", new Object[] { Integer.valueOf(var1.getX() & 0xF), Integer.valueOf(var1.getY() & 0xF), Integer.valueOf(var1.getZ() & 0xF) }) });
    }
    

    Entity var2 = mc.func_175606_aa();
    net.minecraft.util.EnumFacing var3 = var2.func_174811_aO();
    String var4 = "Invalid";
    ...
    ArrayList var5 = Lists.newArrayList(new String[] { "Minecraft 1.8 (" + mc.func_175600_c() + "/" + net.minecraft.client.ClientBrandRetriever.getClientModName() + ")", mc.debug, mc.renderGlobal.getDebugInfoRenders(), mc.renderGlobal.getDebugInfoEntities(), "P: " + mc.effectRenderer.getStatistics() + ". T: " + Minecraft.theWorld.getDebugLoadedEntities(), Minecraft.theWorld.getProviderName(), "", String.format("XYZ: %.3f / %.5f / %.3f", new Object[] { Double.valueOf(mc.func_175606_aa().posX), Double.valueOf(mc.func_175606_aa().getEntityBoundingBox().minY), Double.valueOf(mc.func_175606_aa().posZ) }), String.format("Block: %d %d %d", new Object[] { Integer.valueOf(var1.getX()), Integer.valueOf(var1.getY()), Integer.valueOf(var1.getZ()) }), String.format("Chunk: %d %d %d in %d %d %d", new Object[] { Integer.valueOf(var1.getX() & 0xF), Integer.valueOf(var1.getY() & 0xF), Integer.valueOf(var1.getZ() & 0xF), Integer.valueOf(var1.getX() >> 4), Integer.valueOf(var1.getY() >> 4), Integer.valueOf(var1.getZ() >> 4) }), String.format("Facing: %s (%s) (%.1f / %.1f)", new Object[] { var3, var4, Float.valueOf(MathHelper.wrapAngleTo180_float(rotationYaw)), Float.valueOf(MathHelper.wrapAngleTo180_float(rotationPitch)) }) });
    ...
    if ((Minecraft.theWorld != null) && (Minecraft.theWorld.isBlockLoaded(var1)))
    {
      ...
      var5.add("Biome: " + getBiometheWorldgetWorldChunkManagerbiomeName);
      ...
      {
        net.minecraft.entity.player.EntityPlayerMP var8 = mc.getIntegratedServer().getConfigurationManager().func_177451_a(Minecraft.thePlayer.getUniqueID());
      ...
      var5.add(String.format("Local Difficulty: %.2f (Day %d)", new Object[] { Float.valueOf(var7.func_180168_b()), Long.valueOf(Minecraft.theWorld.getWorldTime() / 24000L) }));
    }
  ...
  protected List func_175238_c()
  {
    ...
    if ((mc.objectMouseOver != null) && (mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) && (mc.objectMouseOver.func_178782_a() != null))
    {
      BlockPos var10 = mc.objectMouseOver.func_178782_a();
      IBlockState var11 = Minecraft.theWorld.getBlockState(var10);
      
      if (Minecraft.theWorld.getWorldType() != net.minecraft.world.WorldType.DEBUG_WORLD)
      {
        var11 = var11.getBlock().getActualState(var11, Minecraft.theWorld, var10);
      }
  ...
  {
    static final int[] field_178907_a = new int[net.minecraft.util.EnumFacing.values().length];
    ...
    static
    {
      try
      {
        field_178907_a[net.minecraft.util.EnumFacing.NORTH.ordinal()] = 1;
      }
      ...
      try
      {
        field_178907_a[net.minecraft.util.EnumFacing.SOUTH.ordinal()] = 2;
      }
      ...
      try
      {
        field_178907_a[net.minecraft.util.EnumFacing.WEST.ordinal()] = 3;
      }
      ...
      try
      {
        field_178907_a[net.minecraft.util.EnumFacing.EAST.ordinal()] = 4;
      }
