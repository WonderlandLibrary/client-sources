...
public class GuiEnchantment extends GuiContainer
{
    ...
    throws java.io.IOException
  {
    ...
    for (int var6 = 0; var6 < 3; var6++)
    {
      ...
      if ((var7 >= 0) && (var8 >= 0) && (var7 < 108) && (var8 < 19) && (field_147075_G.enchantItem(Minecraft.thePlayer, var6)))
      {
  ...
  protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
  {
    ...
    ScaledResolution var6 = new ScaledResolution(mc, Minecraft.displayWidth, Minecraft.displayHeight);
    ...
    for (int var13 = 0; var13 < 3; var13++)
    {
      ...
      else
      {
        ...
        if (((var12 < var13 + 1) || (thePlayerexperienceLevel < var18)) && (!thePlayercapabilities.isCreativeMode))
        {
          drawTexturedModalRect(var14, var5 + 14 + 19 * var13, 0, 185, 108, 19);
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    boolean var4 = thePlayercapabilities.isCreativeMode;
    ...
    for (int var6 = 0; var6 < 3; var6++)
    {
      ...
      if ((isPointInRegion(60, 14 + 19 * var6, 108, 17, mouseX, mouseY)) && (var7 > 0) && (var8 >= 0))
      {
        ...
        if (!var4)
        {
          ...
          if (thePlayerexperienceLevel < var7)
          {
