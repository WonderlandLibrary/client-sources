...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    Minecraft.getMinecraft();TTFManager.getInstance().getLemonMilk().drawStringWithShadow("§7Last Server: §f" + gameSettingslastServer, 1.0F, 1.0F, 0);
    TTFManager.getInstance().getLemonMilk().drawStringWithShadow("§7Name: §f" + getMinecraftsession.getUsername(), 1.0F, 9.0F, 0);
    Minecraft.getMinecraft();TTFManager.getInstance().getLemonMilk().drawStringWithShadow("§7FPS: §f" + Minecraft.debugFPS, 1.0F, 18.0F, 0);
