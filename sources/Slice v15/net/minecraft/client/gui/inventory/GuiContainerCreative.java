...
public class GuiContainerCreative extends InventoryEffectRenderer
{
  ...
  protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType)
  {
    ...
    {
      InventoryPlayer var11 = thePlayerinventory;
    ...
    {
      for (int var10 = 0; var10 < thePlayerinventoryContainer.getInventory().size(); var10++)
      {
        Minecraft.playerController.sendSlotPacket(null, var10);
    ...
    else if (selectedTabIndex == CreativeTabs.tabInventory.getTabIndex())
    {
      ...
      {
        thePlayerinventory.setItemStack(null);
      }
      ...
      else if ((clickType == 4) && (thePlayerinventory.getItemStack() != null))
      {
        Minecraft.thePlayer.dropPlayerItemWithRandomChoice(thePlayerinventory.getItemStack(), true);
        Minecraft.playerController.sendPacketDropItem(thePlayerinventory.getItemStack());
        thePlayerinventory.setItemStack(null);
      }
      else
      {
        thePlayerinventoryContainer.slotClick(slotIn == null ? slotId : field_148332_b.slotNumber, clickedButton, clickType, Minecraft.thePlayer);
        thePlayerinventoryContainer.detectAndSendChanges();
      }
    }
    else if ((clickType != 5) && (inventory == field_147060_v))
    {
      ...
      if (clickType == 2)
      {
        if ((var8 != null) && (clickedButton >= 0) && (clickedButton < 9))
        {
          ...
          thePlayerinventory.setInventorySlotContents(clickedButton, var9);
          thePlayerinventoryContainer.detectAndSendChanges();
        }
    ...
    {
      inventorySlots.slotClick(slotIn == null ? slotId : slotNumber, clickedButton, clickType, Minecraft.thePlayer);
      
      if (Container.getDragEvent(clickedButton) == 2)
      {
        for (int var10 = 0; var10 < 9; var10++)
        {
          Minecraft.playerController.sendSlotPacket(inventorySlots.getSlot(45 + var10).getStack(), 36 + var10);
        }
      }
      else if (slotIn != null)
      {
        ItemStack var6 = inventorySlots.getSlot(slotNumber).getStack();
        Minecraft.playerController.sendSlotPacket(var6, slotNumber - inventorySlots.inventorySlots.size() + 9 + 36);
      }
    }
  }
  ...
  public void initGui()
  {
    if (Minecraft.playerController.isInCreativeMode())
    {
      ...
      thePlayerinventoryContainer.onCraftGuiOpened(field_147059_E);
    }
    else
    {
      mc.displayGuiScreen(new GuiInventory(Minecraft.thePlayer));
  ...
  public void onGuiClosed()
  {
    ...
    if ((Minecraft.thePlayer != null) && (thePlayerinventory != null))
    {
      thePlayerinventoryContainer.removeCraftingFromCrafters(field_147059_E);
    }
    ...
    throws IOException
  {
    ...
    {
      if (GameSettings.isKeyDown(gameSettingskeyBindChat))
      {
  ...
  private void updateCreativeSearch()
  {
    ...
    while (var2.hasNext())
    {
      ...
      boolean var12 = false;
      Iterator var6 = var11.getTooltip(Minecraft.thePlayer, gameSettingsadvancedItemTooltips).iterator();
  ...
  private void setCurrentCreativeTab(CreativeTabs p_147050_1_)
  {
    ...
    {
      Container var4 = thePlayerinventoryContainer;
  ...
  protected void renderToolTip(ItemStack itemIn, int x, int y)
  {
    if (selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex())
    {
      List var4 = itemIn.getTooltip(Minecraft.thePlayer, gameSettingsadvancedItemTooltips);
  ...
  protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
  {
    ...
    {
      GuiInventory.drawEntityOnScreen(guiLeft + 43, guiTop + 45, 20, guiLeft + 43 - mouseX, guiTop + 45 - 30 - mouseY, Minecraft.thePlayer);
    }
  }
  ...
  protected void actionPerformed(GuiButton button) throws IOException
  {
    if (id == 0)
    {
      mc.displayGuiScreen(new net.minecraft.client.gui.achievement.GuiAchievements(this, Minecraft.thePlayer.getStatFileWriter()));
    }
    
    if (id == 1)
    {
      mc.displayGuiScreen(new net.minecraft.client.gui.achievement.GuiStats(this, Minecraft.thePlayer.getStatFileWriter()));
    }
  }
