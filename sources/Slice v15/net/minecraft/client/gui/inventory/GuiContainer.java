...
public abstract class GuiContainer extends GuiScreen
{
  ...
  {
    super.initGui();
    thePlayeropenContainer = inventorySlots;
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    RenderHelper.enableGUIStandardItemLighting();
    InventoryPlayer var15 = thePlayerinventory;
  ...
  private void drawSlot(Slot slotIn)
  {
    ...
    ItemStack var7 = thePlayerinventory.getItemStack();
    String var8 = null;
  ...
  {
    ItemStack var1 = thePlayerinventory.getItemStack();
    ...
    throws java.io.IOException
  {
    ...
    boolean var4 = mouseButton == gameSettingskeyBindPickBlock.getKeyCode() + 100;
    ...
    if ((mouseButton == 0) || (mouseButton == 1) || (var4))
    {
      ...
      if ((gameSettingstouchscreen) && (var10) && (thePlayerinventory.getItemStack() == null))
      {
      ...
      if (var11 != -1)
      {
        ...
        {
          if (thePlayerinventory.getItemStack() == null)
          {
            if (mouseButton == gameSettingskeyBindPickBlock.getKeyCode() + 100)
            {
          ...
          else
          {
            ...
            else if (mouseButton == gameSettingskeyBindPickBlock.getKeyCode() + 100)
            {
  ...
  protected void mouseClickMove(int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick)
  {
    ...
    if ((clickedSlot != null) && (gameSettingstouchscreen))
    {
  ...
  protected void mouseReleased(int mouseX, int mouseY, int state)
  {
      ...
      if (isShiftKeyDown())
      {
        if ((var4 != null) && (inventory != null) && (shiftClickedSlot != null))
        {
          ...
          while (var11.hasNext())
          {
            ...
            if ((var10 != null) && (var10.canTakeStack(Minecraft.thePlayer)) && (var10.getHasStack()) && (inventory == inventory) && (Container.canAddItemToSlot(var10, shiftClickedSlot, true)))
            {
    ...
    else
    {
      ...
      else if (thePlayerinventory.getItemStack() != null)
      {
        if (state == gameSettingskeyBindPickBlock.getKeyCode() + 100)
        {
  ...
  protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType)
  {
    ...
    Minecraft.playerController.windowClick(inventorySlots.windowId, slotId, clickedButton, clickType, Minecraft.thePlayer);
  }
  ...
  protected void keyTyped(char typedChar, int keyCode)
    throws java.io.IOException
  {
    if ((keyCode == 1) || (keyCode == gameSettingskeyBindInventory.getKeyCode()))
    {
    ...
    {
      if (keyCode == gameSettingskeyBindPickBlock.getKeyCode())
      {
        handleMouseClick(theSlot, theSlot.slotNumber, 0, 3);
      }
      else if (keyCode == gameSettingskeyBindDrop.getKeyCode())
      {
  ...
  {
    if ((thePlayerinventory.getItemStack() == null) && (theSlot != null))
    {
      for (int var2 = 0; var2 < 9; var2++)
      {
        if (keyCode == gameSettingskeyBindsHotbar[var2].getKeyCode())
        {
