...
public class GuiIngame extends Gui
{
  ...
  {
    ScaledResolution var2 = new ScaledResolution(mc, Minecraft.displayWidth, Minecraft.displayHeight);
    ...
    ItemStack var5 = thePlayerinventory.armorItemInSlot(3);
    
    if ((gameSettingsthirdPersonView == 0) && (var5 != null) && (var5.getItem() == Item.getItemFromBlock(Blocks.pumpkin)))
    {
      func_180476_e(var2);
    }
    ...
    {
      float var6 = thePlayerprevTimeInPortal + (thePlayertimeInPortal - thePlayerprevTimeInPortal) * p_175180_1_;
      
      if (var6 > 0.0F)
      {
        func_180474_b(var6, var2);
      }
    }
    ...
    if ((gameSettingsheldItemTooltips) && (!Minecraft.playerController.enableEverythingIsScrewedUpMode()))
    {
      func_175182_a(var2);
    }
    ...
    if (field_175195_w > 0)
    {
      ...
      {
        float var14 = field_175199_z + field_175192_A + field_175193_B - var7;
        var8 = (int)(var14 * 255.0F / field_175199_z);
      }
    ...
    if ((gameSettingskeyBindPlayerList.getIsKeyPressed()) && ((!mc.isIntegratedServerRunning()) || (thePlayersendQueue.func_175106_d().size() > 1) || (var16 != null)))
    {
      overlayPlayerList.func_175246_a(true);
      overlayPlayerList.func_175249_a(var3, var12, var16);
    }
    else
    {
  ...
  protected void func_180479_a(ScaledResolution p_180479_1_, float p_180479_2_) {
    if ((mc.func_175606_aa() instanceof EntityPlayer)) {
      ...
      float var5 = zLevel;
      zLevel = -90.0F;
      GuiScreen.drawRect(0, GuiScreen.height - 22, GuiScreen.width, GuiScreen.height, -1728053248);
      drawRect(var4 - 91 - 1 + inventory.currentItem * 20, p_180479_1_.getScaledHeight() - 22, 
        var4 - 91 - 1 + inventory.currentItem * 20 + 23, GuiScreen.height, -1996488705);
  ...
  public void func_175176_b(ScaledResolution p_175176_1_, int p_175176_2_)
  {
    ...
    {
      short var4 = 182;
      int var5 = (int)(thePlayerexperience * (var4 + 1));
      int var6 = p_175176_1_.getScaledHeight() - 32 + 3;
      drawTexturedModalRect(p_175176_2_, var6, 0, 64, var4, 5);
      
      if (var5 > 0)
      {
        drawTexturedModalRect(p_175176_2_, var6, 0, 69, var5, 5);
      }
    }
    
    mc.mcProfiler.endSection();
    
    if (thePlayerexperienceLevel > 0)
    {
      mc.mcProfiler.startSection("expLevel");
      int var9 = 8453920;
      String var10 = thePlayerexperienceLevel;
      int var6 = (p_175176_1_.getScaledWidth() - func_175179_f().getStringWidth(var10)) / 2;
      int var7 = p_175176_1_.getScaledHeight() - 31 - 4;
      boolean var8 = false;
      func_175179_f().drawString(var10, var6 + 1, var7, 0);
      func_175179_f().drawString(var10, var6 - 1, var7, 0);
      func_175179_f().drawString(var10, var6, var7 + 1, 0);
      func_175179_f().drawString(var10, var6, var7 - 1, 0);
      func_175179_f().drawString(var10, var6, var7, var9);
      mc.mcProfiler.endSection();
    }
  }
  ...
  public void func_175185_b(ScaledResolution p_175185_1_)
  {
    ...
    {
      var2 = I18n.format("demo.remainingTime", new Object[] { net.minecraft.util.StringUtils.ticksToElapsedTime((int)(120500L - Minecraft.theWorld.getTotalWorldTime())) });
    }
  ...
  {
    if ((gameSettingsshowDebugInfo) && (!Minecraft.thePlayer.func_175140_cp()) && (!gameSettingsfield_178879_v))
    {
      return false;
    }
    if (Minecraft.playerController.enableEverythingIsScrewedUpMode())
    {
      ...
      if ((mc.objectMouseOver != null) && (mc.objectMouseOver.typeOfHit == net.minecraft.util.MovingObjectPosition.MovingObjectType.BLOCK))
      {
        ...
        if ((Minecraft.theWorld.getTileEntity(var1) instanceof net.minecraft.inventory.IInventory))
        {
          return true;
        }
      }
  ...
  private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
  {
    ...
    String var10;
    for (Iterator var7 = var21.iterator(); var7.hasNext(); var6 = Math.max(var6, func_175179_f().getStringWidth(var10)))
    {
    ...
    int var22 = var21.size() * func_175179_fFONT_HEIGHT;
    ...
    while (var12.hasNext())
    {
      ...
      int var18 = var23 - var11 * func_175179_fFONT_HEIGHT;
  ...
  private void func_180477_d(ScaledResolution p_180477_1_)
  {
    if ((mc.func_175606_aa() instanceof EntityPlayer))
    {
      ...
      net.minecraft.entity.Entity var34 = ridingEntity;
      ...
      else if ((var34 instanceof EntityLivingBase))
      {
        ...
        int var36 = (int)Math.ceil(var35.getHealth());
      ...
      if (var2.isInsideOfMaterial(net.minecraft.block.material.Material.water))
      {
        ...
        for (int var26 = 0; var26 < var36 + var25; var26++)
        {
          if (var26 < var36)
          {
  ...
  private void renderBossHealth()
  {
    if ((BossStatus.bossName != null) && (BossStatus.statusBarTime > 0))
    {
      ...
      func_175179_f().func_175063_a(var8, var3 / 2 - func_175179_f().getStringWidth(var8) / 2, var7 - 10, 16777215);
      GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
      mc.getTextureManager().bindTexture(icons);
    }
  }
  ...
  private void func_175184_a(int p_175184_1_, int p_175184_2_, int p_175184_3_, float p_175184_4_, EntityPlayer p_175184_5_)
  {
    ...
    if (var6 != null)
    {
      ...
      itemRenderer.func_175030_a(Minecraft.fontRendererObj, var6, p_175184_2_, p_175184_3_);
    }
  }
  ...
  public void updateTick()
  {
    ...
    {
      ItemStack var1 = thePlayerinventory.getCurrentItem();
