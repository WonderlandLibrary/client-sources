...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback
{
  ...
  class List extends GuiSlot
  {
    ...
    {
      super(GuiSelectWorld.width, GuiSelectWorld.height, 32, GuiSelectWorld.height - 64, 36);
    }
    ...
    protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_)
    {
      ...
      GuiSelectWorld.drawString(fontRendererObj, var8, p_180791_2_ + 2, p_180791_3_ + 1, 16777215);
      GuiSelectWorld.drawString(fontRendererObj, var9, p_180791_2_ + 2, p_180791_3_ + 12, 8421504);
      GuiSelectWorld.drawString(fontRendererObj, var10, p_180791_2_ + 2, p_180791_3_ + 12 + 10, 8421504);
    }
  }
}
