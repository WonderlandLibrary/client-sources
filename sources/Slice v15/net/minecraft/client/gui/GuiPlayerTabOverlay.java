...
public class GuiPlayerTabOverlay extends Gui
{
  ...
  {
    NetHandlerPlayClient var4 = thePlayersendQueue;
    ...
    boolean var11 = (field_175250_f.isIntegratedServerRunning()) || (Minecraft.getNetHandler().getNetworkManager().func_179292_f());
    int var12;
    int var12;
    if (p_175249_3_ != null) {
      int var12;
    ...
    if (header != null)
    {
      var17 = Minecraft.fontRendererObj.listFormattedStringToWidth(header.getFormattedText(), p_175249_1_ - 50);
      String var20;
    ...
    if (footer != null)
    {
      var18 = Minecraft.fontRendererObj.listFormattedStringToWidth(footer.getFormattedText(), p_175249_1_ - 50);
      String var20;
    ...
    if (var17 != null)
    {
      drawRect(p_175249_1_ / 2 - var16 / 2 - 1, var15 - 1, p_175249_1_ / 2 + var16 / 2 + 1, var15 + var17.size() * fontRendererObjFONT_HEIGHT, Integer.MIN_VALUE);
      
      for (Iterator var19 = var17.iterator(); var19.hasNext(); var15 += fontRendererObjFONT_HEIGHT)
      {
    ...
    for (int var30 = 0; var30 < var28; var30++)
    {
      ...
      if (var30 < var5.size())
      {
        ...
        if (var11)
        {
          ...
          net.minecraft.entity.player.EntityPlayer var26 = Minecraft.theWorld.getPlayerEntityByUUID(var24.func_178845_a().getId());
    ...
    {
      var15 += var29 * 9 + 1;
      drawRect(p_175249_1_ / 2 - var16 / 2 - 1, var15 - 1, p_175249_1_ / 2 + var16 / 2 + 1, var15 + var18.size() * fontRendererObjFONT_HEIGHT, Integer.MIN_VALUE);
      
      for (Iterator var19 = var18.iterator(); var19.hasNext(); var15 += fontRendererObjFONT_HEIGHT)
      {
        String var20 = (String)var19.next();
        int var21 = Minecraft.fontRendererObj.getStringWidth(var20);
        Minecraft.fontRendererObj.func_175063_a(var20, p_175249_1_ / 2 - var21 / 2, var15, -1);
