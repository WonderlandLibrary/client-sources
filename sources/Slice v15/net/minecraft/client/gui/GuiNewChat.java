...
public class GuiNewChat extends Gui
{
  ...
  {
    if (gameSettingschatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN)
    {
      int var2 = getLineCount();
      boolean var3 = false;
      int var4 = 0;
      int var5 = field_146253_i.size();
      float var6 = gameSettingschatOpacity * 0.9F + 0.1F;
      ...
      if (var5 > 0)
      {
        ...
        if (var3)
        {
          var9 = fontRendererObjFONT_HEIGHT;
  ...
  public IChatComponent getChatComponent(int p_146236_1_, int p_146236_2_)
  {
    ...
    ScaledResolution var3 = new ScaledResolution(mc, Minecraft.displayWidth, Minecraft.displayHeight);
    ...
    if ((var6 >= 0) && (var7 >= 0))
    {
      ...
      if ((var6 <= MathHelper.floor_float(getChatWidth() / getChatScale())) && (var7 < fontRendererObjFONT_HEIGHT * var8 + var8))
      {
        int var9 = var7 / fontRendererObjFONT_HEIGHT + scrollPos;
  ...
  {
    return calculateChatboxWidth(gameSettingschatWidth);
  }
  
  public int getChatHeight()
  {
    return calculateChatboxHeight(getChatOpen() ? gameSettingschatHeightFocused : gameSettingschatHeightUnfocused);
  }
