...
public class GuiAchievements extends GuiScreen implements net.minecraft.client.gui.IProgressMeter
{
  ...
  public void initGui()
  {
    Minecraft.getNetHandler().addToSendQueue(new net.minecraft.network.play.client.C16PacketClientStatus(net.minecraft.network.play.client.C16PacketClientStatus.EnumState.REQUEST_STATS));
    buttonList.clear();
  ...
  protected void keyTyped(char typedChar, int keyCode)
    throws IOException
  {
    if (keyCode == gameSettingskeyBindInventory.getKeyCode())
    {
  ...
  protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_)
  {
    ...
    if (var33 != null)
    {
      ...
      if (statFileWriter.canUnlockAchievement(var33))
      {
        ...
        if (statFileWriter.hasAchievementUnlocked(var33))
        {
          fontRendererObj.func_175063_a(I18n.format("achievement.taken", new Object[0]), var40, var41 + var31 + 4, -7302913);
      ...
      if (var36 != null)
      {
        fontRendererObj.func_175063_a(var36, var40, var41, var33.getSpecial() ? -8355776 : statFileWriter.canUnlockAchievement(var33) ? -1 : var33.getSpecial() ? -128 : -8355712);
      }
    }
