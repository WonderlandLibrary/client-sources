...
public class GuiStats extends GuiScreen implements IProgressMeter
{
  ...
  public void initGui()
  {
    ...
    Minecraft.getNetHandler().addToSendQueue(new net.minecraft.network.play.client.C16PacketClientStatus(C16PacketClientStatus.EnumState.REQUEST_STATS));
  }
  ...
  abstract class Stats extends GuiSlot
  {
    ...
    {
      super(GuiStats.width, GuiStats.height, 32, GuiStats.height - 64, 20);
    ...
    protected void func_148209_a(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_)
    {
      if (p_148209_1_ != null)
      {
        ...
        GuiStats.drawString(fontRendererObj, var5, p_148209_2_ - fontRendererObj.getStringWidth(var5), p_148209_3_ + 5, p_148209_4_ ? 16777215 : 9474192);
      }
      else
      {
        String var5 = "-";
      ...
      if ((p_148142_2_ >= top) && (p_148142_2_ <= bottom))
      {
        ...
        else
        {
          ...
          if (var9.length() > 0)
          {
            ...
            fontRendererObj.func_175063_a(var9, var6, var7, -1);
          }
        }
      }
    }
    ...
    protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_)
    {
      if (p_148213_1_ != null)
      {
        ...
        if (var7.length() > 0)
        {
          ...
          fontRendererObj.func_175063_a(var7, var8, var9, -1);
        }
      }
    }
  ...
  class StatsGeneral extends GuiSlot
  {
    ...
    {
      super(GuiStats.width, GuiStats.height, 32, GuiStats.height - 64, 10);
      setShowSelectionBox(false);
    }
    ...
    protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_)
    {
      ...
      GuiStats.drawString(fontRendererObj, var7.getStatName().getUnformattedText(), p_180791_2_ + 2, p_180791_3_ + 1, p_180791_1_ % 2 == 0 ? 16777215 : 9474192);
      String var8 = var7.func_75968_a(field_146546_t.writeStat(var7));
      GuiStats.drawString(fontRendererObj, var8, p_180791_2_ + 2 + 213 - fontRendererObj.getStringWidth(var8), p_180791_3_ + 1, p_180791_1_ % 2 == 0 ? 16777215 : 9474192);
    }
  }
  ...
  class StatsMobsList extends GuiSlot
  {
    ...
    {
      super(GuiStats.width, GuiStats.height, 32, GuiStats.height - 64, fontRendererObj.FONT_HEIGHT * 4);
      setShowSelectionBox(false);
    ...
    protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_)
    {
      ...
      GuiStats.drawString(fontRendererObj, var8, p_180791_2_ + 2 - 10, p_180791_3_ + 1, 16777215);
      GuiStats.drawString(fontRendererObj, var11, p_180791_2_ + 2, p_180791_3_ + 1 + fontRendererObj.FONT_HEIGHT, var9 == 0 ? 6316128 : 9474192);
      GuiStats.drawString(fontRendererObj, var12, p_180791_2_ + 2, p_180791_3_ + 1 + fontRendererObj.FONT_HEIGHT * 2, var10 == 0 ? 6316128 : 9474192);
    }
  }
}
