...
public class GuiAchievement extends net.minecraft.client.gui.Gui
{
  ...
  {
    if ((theAchievement != null) && (notificationTime != 0L)) { Minecraft.getMinecraft(); if (Minecraft.thePlayer != null)
      {
        ...
        if (permanentNotification)
        {
          Minecraft.fontRendererObj.drawSplitString(achievementDescription, var5 + 30, var6 + 7, 120, -1);
        }
        else
        {
          Minecraft.fontRendererObj.drawString(achievementTitle, var5 + 30, var6 + 7, 65280);
          Minecraft.fontRendererObj.drawString(achievementDescription, var5 + 30, var6 + 18, -1);
        }
