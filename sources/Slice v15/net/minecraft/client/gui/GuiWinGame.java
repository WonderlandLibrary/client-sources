...
public class GuiWinGame extends GuiScreen
{
  ...
  {
    thePlayersendQueue.addToSendQueue(new net.minecraft.network.play.client.C16PacketClientStatus(net.minecraft.network.play.client.C16PacketClientStatus.EnumState.PERFORM_RESPAWN));
    ...
    if (field_146582_i == null)
    {
      ...
      try
      {
        ...
        while ((var1 = var4.readLine()) != null)
        {
          ...
          field_146582_i.addAll(Minecraft.fontRendererObj.listFormattedStringToWidth(var1, var3));
          field_146582_i.add("");
        }
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    for (int var11 = 0; var11 < field_146582_i.size(); var11++)
    {
      ...
      if ((var10 + var9 + 12.0F + 8.0F > 0.0F) && (var10 + var9 < height))
      {
        ...
        {
          fontRendererObj.func_175063_a(var13.substring(3), var7 + (var6 - fontRendererObj.getStringWidth(var13.substring(3))) / 2, var10, 16777215);
        }
        else
        {
          fontRendererObj.fontRandom.setSeed(var11 * 4238972211L + field_146581_h / 4);
          fontRendererObj.func_175063_a(var13, var7, var10, 16777215);
        }
      }
