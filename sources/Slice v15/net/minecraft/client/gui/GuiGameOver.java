...
public class GuiGameOver extends GuiScreen implements GuiYesNoCallback
{
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    drawCenteredString(fontRendererObj, I18n.format("deathScreen.score", new Object[0]) + ": " + net.minecraft.util.EnumChatFormatting.YELLOW + Minecraft.thePlayer.getScore(), width / 2, 100, 16777215);
