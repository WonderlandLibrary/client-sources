...
public class GuiIngestServers extends GuiScreen
{
  ...
  protected void actionPerformed(GuiButton button) throws java.io.IOException
  {
    if (enabled)
    {
      ...
      {
        gameSettingsstreamPreferredServer = "";
  ...
  class ServerList extends net.minecraft.client.gui.GuiSlot
  {
    ...
    {
      super(GuiIngestServers.width, GuiIngestServers.height, 32, GuiIngestServers.height - 35, (int)(fontRendererObjFONT_HEIGHT * 3.5D));
    ...
    {
      gameSettingsstreamPreferredServer = mc.getTwitchStream().func_152925_v()[slotIndex].serverUrl;
      Minecraft.gameSettings.saveOptions();
    }
    
    protected boolean isSelected(int slotIndex)
    {
      return mc.getTwitchStream().func_152925_v()[slotIndex].serverUrl.equals(gameSettingsstreamPreferredServer);
    }
    ...
    protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_)
    {
      ...
      GuiIngestServers.drawString(fontRendererObj, serverName, p_180791_2_ + 2, p_180791_3_ + 5, 16777215);
      GuiIngestServers.drawString(fontRendererObj, var8, p_180791_2_ + 2, p_180791_3_ + fontRendererObj.FONT_HEIGHT + 5 + 3, 3158064);
      GuiIngestServers.drawString(fontRendererObj, var9, getScrollBarX() - 5 - fontRendererObj.getStringWidth(var9), p_180791_3_ + 5, 8421504);
      
      if (var10 != null)
      {
        GuiIngestServers.drawString(fontRendererObj, var10, getScrollBarX() - 5 - fontRendererObj.getStringWidth(var10), p_180791_3_ + 5 + 3 + fontRendererObj.FONT_HEIGHT, 8421504);
      }
    }
