...
public class ServerListEntryLanScan implements GuiListExtended.IGuiListEntry
{
  ...
  public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) { int var9 = y + slotHeight / 2 - fontRendererObjFONT_HEIGHT / 2;
    ...
    Minecraft.fontRendererObj.drawString(var10, GuiScreen.width / 2 - Minecraft.fontRendererObj.getStringWidth(var10) / 2, var9 + fontRendererObjFONT_HEIGHT, 8421504);
  }
