...
public class GuiVideoSettings extends GuiScreen
{
  ...
  protected void actionPerformed(GuiButton par1GuiButton) throws java.io.IOException
  {
    if (enabled)
    {
      ...
      {
        ScaledResolution scr = new ScaledResolution(mc, Minecraft.displayWidth, Minecraft.displayHeight);
  ...
  public void drawScreen(int x, int y, float z)
  {
    ...
    TTFManager.getInstance().getLemonMilk().drawCenteredString(screenTitle, width / 2, is64bit ? 20 : 5, 16777215);
