...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
  ...
  public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
  {
    ...
    Minecraft.fontRendererObj.drawString(field_148301_e.serverName, x + 32 + 3, y + 1, 16777215);
    List var12 = Minecraft.fontRendererObj.listFormattedStringToWidth(field_148301_e.serverMOTD, listWidth - 32 - 2);
    
    for (int var13 = 0; var13 < Math.min(var12.size(), 2); var13++)
    {
      Minecraft.fontRendererObj.drawString((String)var12.get(var13), x + 32 + 3, y + 12 + fontRendererObjFONT_HEIGHT * var13, 8421504);
    }
    ...
    if ((gameSettingstouchscreen) || (isSelected))
    {
