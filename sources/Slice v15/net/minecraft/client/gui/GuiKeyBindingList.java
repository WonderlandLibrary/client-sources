...
public class GuiKeyBindingList extends GuiListExtended
{
  ...
  public GuiKeyBindingList(GuiControls p_i45031_1_, Minecraft mcIn)
  {
    ...
    mc = mcIn;
    KeyBinding[] var3 = (KeyBinding[])org.apache.commons.lang3.ArrayUtils.clone(gameSettingskeyBindings);
    ...
    for (int var8 = 0; var8 < var7; var8++)
    {
      ...
      int var11 = Minecraft.fontRendererObj.getStringWidth(I18n.format(var9.getKeyDescription(), new Object[0]));
  ...
  public class CategoryEntry implements GuiListExtended.IGuiListEntry
  {
    ...
    {
      Minecraft.fontRendererObj.drawString(labelText, GuiScreen.width / 2 - labelWidth / 2, y + slotHeight - fontRendererObjFONT_HEIGHT - 1, 16777215);
    }
  ...
  public class KeyEntry implements GuiListExtended.IGuiListEntry
  {
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
      ...
      Minecraft.fontRendererObj.drawString(field_148283_c, x + 90 - maxListLabelWidth, y + slotHeight / 2 - fontRendererObjFONT_HEIGHT / 2, 16777215);
      ...
      {
        KeyBinding[] var11 = gameSettingskeyBindings;
