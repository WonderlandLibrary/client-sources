  ...
  class TeamSelectionObject implements ISpectatorMenuObject
  {
    ...
    public TeamSelectionObject(ScorePlayerTeam p_i45492_2_)
    {
      ...
      while (var3.hasNext())
      {
        ...
        Minecraft.getMinecraft();NetworkPlayerInfo var5 = Minecraft.getNetHandler().func_175104_a(var4);
    ...
    public void func_178663_a(float p_178663_1_, int p_178663_2_)
    {
      ...
      if (var4.length() >= 2)
      {
        Minecraft.getMinecraft();var3 = Minecraft.fontRendererObj.func_175064_b(var4.charAt(1));
      }
