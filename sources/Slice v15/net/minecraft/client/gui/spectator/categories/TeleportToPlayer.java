...
public class TeleportToPlayer implements net.minecraft.client.gui.spectator.ISpectatorMenuView, ISpectatorMenuObject
{
  ...
  {
    this(field_178674_a.sortedCopy(Minecraft.getNetHandler().func_175106_d()));
  }
  
  public TeleportToPlayer(Collection p_i45493_1_)
  {
    field_178673_b = com.google.common.collect.Lists.newArrayList();
