...
public class PlayerMenuObject implements ISpectatorMenuObject
{
  ...
  {
    Minecraft.getMinecraft();Minecraft.getNetHandler().addToSendQueue(new C18PacketSpectate(field_178668_a.getId()));
  }
  ...
  {
    Minecraft.getMinecraft().getTextureManager().bindTexture(field_178667_b);
    net.minecraft.client.renderer.GlStateManager.color(1.0F, 1.0F, 1.0F, p_178663_2_ / 255.0F);
