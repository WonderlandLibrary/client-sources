...
public class GuiCreateWorld extends GuiScreen
{
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    if (field_146344_y)
    {
      drawString(fontRendererObj, I18n.format("selectWorld.enterSeed", new Object[0]), width / 2 - 100, 47.0F, -6250336);
      drawString(fontRendererObj, I18n.format("selectWorld.seedInfo", new Object[0]), width / 2 - 100, 85.0F, -6250336);
      
      if (field_146325_B.visible)
      {
        drawString(fontRendererObj, I18n.format("selectWorld.mapFeatures.info", new Object[0]), width / 2 - 150, 122.0F, -6250336);
      }
      
      if (field_146321_E.visible)
      {
        drawString(fontRendererObj, I18n.format("selectWorld.allowCommands.info", new Object[0]), width / 2 - 150, 172.0F, -6250336);
      }
    ...
    {
      drawString(fontRendererObj, I18n.format("selectWorld.enterName", new Object[0]), width / 2 - 100, 47.0F, -6250336);
      drawString(fontRendererObj, I18n.format("selectWorld.resultFolder", new Object[0]) + " " + field_146336_i, width / 2 - 100, 85.0F, -6250336);
      field_146333_g.drawTextBox();
      drawString(fontRendererObj, field_146323_G, width / 2 - 100, 137.0F, -6250336);
      drawString(fontRendererObj, field_146328_H, width / 2 - 100, 149.0F, -6250336);
    }
