...
public class GuiScreenCustomizePresets extends GuiScreen
{
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    drawString(fontRendererObj, field_175313_s, 50.0F, 30.0F, 10526880);
    drawString(fontRendererObj, field_175312_t, 50.0F, 70.0F, 10526880);
  ...
  class ListPreset extends GuiSlot
  {
    ...
    public ListPreset()
    {
      super(GuiScreenCustomizePresets.width, GuiScreenCustomizePresets.height, 80, GuiScreenCustomizePresets.height - 32, 38);
    }
