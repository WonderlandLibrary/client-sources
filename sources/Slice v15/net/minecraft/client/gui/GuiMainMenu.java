...
import net.SliceClient.Utils.ParticleGenerator;
import net.SliceClient.altamanager.GuiAltManager;
import net.SliceClient.ui.UIChangelog;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
  ...
  private static final ResourceLocation minecraftTitleTextures = new ResourceLocation("textures/rf.png");
  ...
  public void initGui()
  {
    particles = new ParticleGenerator(25, width, height);
    ...
    buttonList.add(new GuiButton(0, width / 2 - 100, var3 + 68 + 2, 98, 20, I18n.format("menu.options", new Object[0])));
    buttonList.add(new GuiButton(4, width / 2 + 2, var3 + 68 + 2, 98, 20, I18n.format("menu.quit", new Object[0])));
  ...
  {
    buttonList.add(new GuiButton(1, width / 2 - 100, p_73969_1_ + 4, I18n.format("menu.singleplayer", new Object[0])));
    buttonList.add(new GuiButton(2, width / 2 - 100, p_73969_1_ + 26, I18n.format("menu.multiplayer", new Object[0])));
    buttonList.add(new GuiButton(14, width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "AltLogin"));
    buttonList.add(new GuiButton(88, width / 2 - 100, p_73969_1_ + 92, 200, 20, "Session Stealer"));
    buttonList.add(new GuiButton(25, width / 2 - 100, p_73969_1_ + 114, 200, 20, "About"));
  }
    ...
    throws IOException
  {
    ...
    if (id == 5) {
      mc.displayGuiScreen(new GuiLanguage(this, Minecraft.gameSettings, mc.getLanguageManager()));
    }
    
    if (id == 25) {
      mc.displayGuiScreen(new UIChangelog());
    }
    
    if (id == 88)
    {
      mc.displayGuiScreen(new net.SliceClient.Gui.GuiSessionManager(this));
    }
    ...
    if ((id == 16) && (field_175372_K.visible))
    {
      switchToRealms();
    }
    ...
    if ((result) && (id == 12)) {
      ...
      if (result) {
        try {
          ...
          net.SliceClient.Utils.Wrapper.fr.drawString("§9Welcome: §7" + Minecraft.thePlayer.getName(), 1, 42, 65408);
        }
      }
  ...
  {
    ScaledResolution scaledRes = new ScaledResolution(mc, width, height);
    ...
    drawCenteredString(Minecraft.fontRendererObj, "Slice", width / 12, 3, 16777215);
    GL11.glScalef(8.0F, 8.0F, 1.0F);
    
    GL11.glPopMatrix();
    String var10 = "Slice";
    var10 = var10 + " Version " + Slice.v;
    drawString(fontRendererObj, var10, 2.0F, height - 10, -1);
    
    String var11 = "Cracked by Mckc4HMaste7";
    drawString(fontRendererObj, "Welcome §c" + mc.session.username, width / 2 - fontRendererObj.getStringWidth("Welcome " + mc.session.username) / 2, height - 10, -1);
    drawString(fontRendererObj, var11, width - fontRendererObj.getStringWidth(var11) - 2, height - 10, 
      -1);
    ...
    throws IOException
  {
    ...
    synchronized (field_104025_t) {
      if ((field_92025_p.length() <= 0) || (mouseX < field_92022_t) || (mouseX > field_92020_v) || (mouseY < field_92021_u)) {}
    }
  }
}
