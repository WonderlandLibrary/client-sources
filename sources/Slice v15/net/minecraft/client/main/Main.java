...
public class Main
{
  ...
  public static void main(String[] p_main_0_)
  {
    ...
    joptsimple.NonOptionArgumentSpec var20 = var1.nonOptions();
    ...
    if (var23 != null)
    {
      try
      {
        var24 = new Proxy(java.net.Proxy.Type.SOCKS, new java.net.InetSocketAddress(var23, ((Integer)var21.valueOf(var8)).intValue()));
      }
    ...
    if ((!var24.equals(Proxy.NO_PROXY)) && (func_110121_a(var25)) && (func_110121_a(var26)))
    {
      Authenticator.setDefault(new Authenticator()
      {
        ...
        protected PasswordAuthentication getPasswordAuthentication() {
          return new PasswordAuthentication(Main.this, var26.toCharArray());
        }
      });
    }
    ...
    PropertyMap var33 = (PropertyMap)new GsonBuilder().registerTypeAdapter(PropertyMap.class, new com.mojang.authlib.properties.PropertyMap.Serializer()).create().fromJson((String)var21.valueOf(var17), PropertyMap.class);
