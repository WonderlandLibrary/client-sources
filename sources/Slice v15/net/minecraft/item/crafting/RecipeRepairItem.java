  ...
  implements IRecipe
{
    ...
    for (int var4 = 0; var4 < p_77569_1_.getSizeInventory(); var4++)
    {
      ...
      if (var5 != null)
      {
        ...
        if (var3.size() > 1)
        {
          ...
          if ((var5.getItem() != var6.getItem()) || (stackSize != 1) || (stackSize != 1) || (!var6.getItem().isDamageable()))
          {
            return false;
          }
        }
  ...
  public ItemStack getCraftingResult(InventoryCrafting p_77572_1_)
  {
    ...
    for (int var3 = 0; var3 < p_77572_1_.getSizeInventory(); var3++)
    {
      ...
      if (var4 != null)
      {
        ...
        if (var2.size() > 1)
        {
          ...
          if ((var4.getItem() != var5.getItem()) || (stackSize != 1) || (stackSize != 1) || (!var5.getItem().isDamageable()))
          {
            return null;
          }
        }
    ...
    if (var2.size() == 2)
    {
      ...
      if ((var10.getItem() == var4.getItem()) && (stackSize == 1) && (stackSize == 1) && (var10.getItem().isDamageable()))
      {
