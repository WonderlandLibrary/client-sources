...
public class ItemBlock extends Item
{
  ...
  public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
  {
    ...
    if ((pos.getY() == 255) && (block.getMaterial().isSolid()))
    {
      return false;
    }
    if (worldIn.canBlockBePlaced(block, pos, false, side, null, stack))
    {
  ...
  public boolean canPlaceBlockOnSide(World worldIn, BlockPos p_179222_2_, EnumFacing p_179222_3_, EntityPlayer p_179222_4_, ItemStack p_179222_5_)
  {
    ...
    return worldIn.canBlockBePlaced(block, p_179222_2_, false, p_179222_3_, null, p_179222_5_);
  }
