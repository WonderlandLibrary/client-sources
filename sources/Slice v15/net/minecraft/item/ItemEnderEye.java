...
public class ItemEnderEye extends Item
{
  ...
  public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
  {
    ...
    if ((playerIn.func_175151_a(pos.offset(side), side, stack)) && (var9.getBlock() == Blocks.end_portal_frame) && (!((Boolean)var9.getValue(BlockEndPortalFrame.field_176507_b)).booleanValue()))
    {
      ...
      {
        double var11 = pos.getX() + (5.0F + itemRand.nextFloat() * 6.0F) / 16.0F;
        double var13 = pos.getY() + 0.8125F;
        double var15 = pos.getZ() + (5.0F + itemRand.nextFloat() * 6.0F) / 16.0F;
        double var17 = 0.0D;
        double var19 = 0.0D;
        double var21 = 0.0D;
        worldIn.spawnParticle(net.minecraft.util.EnumParticleTypes.SMOKE_NORMAL, var11, var13, var15, var17, var19, var21, new int[0]);
      }
      ...
      if ((var14) && (var12 == var24 + 2))
      {
        ...
        for (int var29 = var24; var29 <= var12; var29++)
        {
        ...
        for (var29 = var24 - 1; var29 <= var12 + 1; var29 += 4)
        {
          ...
          {
            BlockPos var33 = var27.offset(var23, var31);
  ...
  {
    MovingObjectPosition var4 = getMovingObjectPositionFromPlayer(worldIn, playerIn, false);
    
    if ((var4 != null) && (typeOfHit == net.minecraft.util.MovingObjectPosition.MovingObjectType.BLOCK) && (worldIn.getBlockState(var4.func_178782_a()).getBlock() == Blocks.end_portal_frame))
    {
      return itemStackIn;
    }
    ...
    if (!isRemote)
    {
      ...
      if (var5 != null)
      {
        EntityEnderEye var6 = new EntityEnderEye(worldIn, posX, posY, posZ);
