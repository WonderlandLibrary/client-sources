...
public class ItemDoor extends Item
{
  ...
  public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
  {
    ...
    if (!field_179236_a.canPlaceBlockAt(worldIn, pos))
    {
      return false;
    }
    

    func_179235_a(worldIn, pos, EnumFacing.fromAngle(rotationYaw), field_179236_a);
    stackSize -= 1;
    return true;
  }
  ...
  public static void func_179235_a(World worldIn, BlockPos p_179235_1_, EnumFacing p_179235_2_, Block p_179235_3_)
  {
    ...
    worldIn.setBlockState(p_179235_1_, var12.withProperty(BlockDoor.HALF_PROP, net.minecraft.block.BlockDoor.EnumDoorHalf.LOWER), 2);
    worldIn.setBlockState(var11, var12.withProperty(BlockDoor.HALF_PROP, net.minecraft.block.BlockDoor.EnumDoorHalf.UPPER), 2);
