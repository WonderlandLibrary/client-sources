...
public class GuiAnimationSettingsOF extends GuiScreen
{
  ...
  protected void actionPerformed(GuiButton guibutton)
  {
    if (enabled)
    {
      ...
      {
        net.minecraft.client.gui.ScaledResolution scaledresolution = new net.minecraft.client.gui.ScaledResolution(mc, Minecraft.displayWidth, Minecraft.displayHeight);
