...
public class TileEntityBanner extends TileEntity
{
  ...
  public void setItemValues(ItemStack p_175112_1_)
  {
    ...
    if ((p_175112_1_.hasTagCompound()) && (p_175112_1_.getTagCompound().hasKey("BlockEntityTag", 10)))
    {
      ...
      {
        baseColor = (p_175112_1_.getMetadata() & 0xF);
      }
    }
    else
    {
  ...
  public net.minecraft.network.Packet getDescriptionPacket()
  {
    ...
    writeToNBT(var1);
    return new net.minecraft.network.play.server.S35PacketUpdateTileEntity(pos, 6, var1);
  }
  ...
  private void func_175109_g()
  {
    if ((field_175122_h == null) || (field_175123_i == null) || (field_175121_j == null))
    {
      ...
      else
      {
        ...
        field_175122_h.add(EnumBannerPattern.BASE);
  ...
  public static enum EnumBannerPattern
  {
    ...
    public static EnumBannerPattern func_177268_a(String p_177268_0_)
    {
      ...
      for (int var3 = 0; var3 < var2; var3++)
      {
        ...
        if (field_177285_O.equals(p_177268_0_))
        {
          return var4;
        }
      }
