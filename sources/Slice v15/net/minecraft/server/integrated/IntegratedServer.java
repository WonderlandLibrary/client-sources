...
public class IntegratedServer extends MinecraftServer
{
  ...
  protected void loadAllWorlds(String p_71247_1_, String p_71247_2_, long seed, WorldType type, String p_71247_6_)
  {
    ...
    for (int var9 = 0; var9 < worldServers.length; var9++)
    {
      byte var10 = 0;
      ...
      if (var9 == 0)
      {
        if (isDemo())
        {
          worldServers[var9] = ((WorldServer)new DemoWorldServer(this, var7, var8, var10, theProfiler).init());
        }
        else
        {
          worldServers[var9] = ((WorldServer)new WorldServerOF(this, var7, var8, var10, theProfiler).init());
        }
        
        worldServers[var9].initialize(theWorldSettings);
      }
      else
      {
        worldServers[var9] = ((WorldServer)new WorldServerMulti(this, var7, var10, worldServers[0], theProfiler).init());
      }
      
      worldServers[var9].addWorldAccess(new net.minecraft.world.WorldManager(this, worldServers[var9]));
    }
    ...
    {
      setDifficultyForAllWorlds(gameSettingsdifficulty);
    }
  ...
  public void tick()
  {
    ...
    Minecraft.getMinecraft();isGamePaused = ((Minecraft.getNetHandler() != null) && (Minecraft.getMinecraft().isGamePaused()));
    ...
    if (gameSettingsrenderDistanceChunks != getConfigurationManager().getViewDistance())
    {
      logger.info("Changing view distance to {}, from {}", new Object[] { Integer.valueOf(gameSettingsrenderDistanceChunks), Integer.valueOf(getConfigurationManager().getViewDistance()) });
      getConfigurationManager().setViewDistance(gameSettingsrenderDistanceChunks);
    }
