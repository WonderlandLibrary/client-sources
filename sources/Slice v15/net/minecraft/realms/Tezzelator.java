...
public class Tezzelator
{
  ...
  public net.minecraft.client.renderer.WorldRenderer.State sortQuads(float p_sortQuads_1_, float p_sortQuads_2_, float p_sortQuads_3_)
  {
    return t.getWorldRenderer().getVertexState(p_sortQuads_1_, p_sortQuads_2_, p_sortQuads_3_);
  }
  
  public void restoreState(net.minecraft.client.renderer.WorldRenderer.State p_restoreState_1_)
  {
