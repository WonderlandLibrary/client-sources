...
public class CommandSpreadPlayers extends CommandBase
{
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    ...
    double var7 = func_175761_b(var4.getZ(), args[(var17++)], true);
    ...
    ArrayList var14 = com.google.common.collect.Lists.newArrayList();
    ...
    while (var17 < args.length)
    {
      ...
      {
        net.minecraft.entity.player.EntityPlayerMP var18 = MinecraftServer.getServer().getConfigurationManager().getPlayerByUsername(var15);
    ...
    func_110669_a(sender, var14, new Position(var5, var7), var9, var11, get0worldObj, var13);
  }
  

  private void func_110669_a(ICommandSender p_110669_1_, List p_110669_2_, Position p_110669_3_, double p_110669_4_, double p_110669_6_, World worldIn, boolean p_110669_9_)
    throws CommandException
  {
    Random var10 = new Random();
    double var11 = field_111101_a - p_110669_6_;
    double var13 = field_111100_b - p_110669_6_;
    double var15 = field_111101_a + p_110669_6_;
    double var17 = field_111100_b + p_110669_6_;
    Position[] var19 = func_110670_a(var10, p_110669_9_ ? func_110667_a(p_110669_2_) : p_110669_2_.size(), var11, var13, var15, var17);
    ...
    notifyOperators(p_110669_1_, this, "commands.spreadplayers.success." + (p_110669_9_ ? "teams" : "players"), new Object[] { Integer.valueOf(var19.length), Double.valueOf(field_111101_a), Double.valueOf(field_111100_b) });
  ...
  {
    HashSet var2 = com.google.common.collect.Sets.newHashSet();
  ...
  private int func_110668_a(Position p_110668_1_, double p_110668_2_, World worldIn, Random p_110668_5_, double p_110668_6_, double p_110668_8_, double p_110668_10_, double p_110668_12_, Position[] p_110668_14_, boolean p_110668_15_) throws CommandException
  {
    ...
    for (int var17 = 0; (var17 < 10000) && (var16); var17++)
    {
      var16 = false;
      ...
      for (int var20 = 0; var20 < p_110668_14_.length; var20++)
      {
        ...
        for (int var24 = 0; var24 < p_110668_14_.length; var24++)
        {
          if (var20 != var24)
          {
            ...
            {
              var22++;
              field_111101_a += field_111101_a - field_111101_a;
              field_111100_b += field_111100_b - field_111100_b;
            }
          }
        }
        ...
        if (var22 > 0)
        {
          field_111101_a /= var22;
          field_111100_b /= var22;
      ...
      if (!var16)
      {
        ...
        for (int var22 = 0; var22 < var29; var22++)
        {
          Position var23 = var28[var22];
    ...
    if (var17 >= 10000)
    {
      throw new CommandException("commands.spreadplayers.failure." + (p_110668_15_ ? "teams" : "players"), new Object[] { Integer.valueOf(p_110668_14_.length), Double.valueOf(field_111101_a), Double.valueOf(field_111100_b), String.format("%.2f", new Object[] { Double.valueOf(var18) }) });
    }
  ...
  private double func_110671_a(List p_110671_1_, World worldIn, Position[] p_110671_3_, boolean p_110671_4_)
  {
    ...
    for (int var9 = 0; var9 < p_110671_1_.size(); var9++)
    {
      ...
      if (p_110671_4_)
      {
        net.minecraft.scoreboard.Team var12 = (var10 instanceof EntityPlayer) ? ((EntityPlayer)var10).getTeam() : null;
      ...
      var10.setPositionAndUpdate(MathHelper.floor_double(field_111101_a) + 0.5F, var11.func_111092_a(worldIn), MathHelper.floor_double(field_111100_b) + 0.5D);
  ...
  static class Position
  {
    ...
    {
      double var2 = field_111101_a - field_111101_a;
      double var4 = field_111100_b - field_111100_b;
    ...
    {
      field_111101_a -= field_111101_a;
      field_111100_b -= field_111100_b;
    }
