...
public class CommandDeOp extends net.minecraft.command.CommandBase
{
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    ...
    {
      throw new net.minecraft.command.WrongUsageException("commands.deop.usage", new Object[0]);
    }
  }
