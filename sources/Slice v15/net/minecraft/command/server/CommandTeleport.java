...
public class CommandTeleport extends net.minecraft.command.CommandBase
{
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    if (args.length < 1)
    {
      throw new net.minecraft.command.WrongUsageException("commands.tp.usage", new Object[0]);
    }
    ...
    if ((args.length != 1) && (args.length != 2))
    {
      ...
      {
        int var14 = var3 + 1;
        CommandBase.CoordinateArg var6 = func_175770_a(posX, args[var3], true);
        CommandBase.CoordinateArg var7 = func_175767_a(posY, args[(var14++)], 0, 0, false);
        CommandBase.CoordinateArg var8 = func_175770_a(posZ, args[(var14++)], true);
        CommandBase.CoordinateArg var9 = func_175770_a(rotationYaw, args.length > var14 ? args[(var14++)] : "~", false);
        CommandBase.CoordinateArg var10 = func_175770_a(rotationPitch, args.length > var14 ? args[var14] : "~", false);
        ...
        if ((var4 instanceof EntityPlayerMP))
        {
          ...
          playerNetServerHandler.func_175089_a(var6.func_179629_b(), var7.func_179629_b(), var8.func_179629_b(), var12, var13, var11);
    ...
    else
    {
      ...
      {
        ((Entity)var4).setLocationAndAngles(posX, posY, posZ, rotationYaw, rotationPitch);
      }
