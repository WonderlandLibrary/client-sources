...
public class CommandTestForBlock extends net.minecraft.command.CommandBase
{
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    if (args.length < 4)
    {
      throw new net.minecraft.command.WrongUsageException("commands.testforblock.usage", new Object[0]);
    }
    ...
    if (var4 == null)
    {
      throw new net.minecraft.command.NumberInvalidException("commands.setblock.notFound", new Object[] { args[3] });
    }
