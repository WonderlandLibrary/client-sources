...
public class CommandMessage extends CommandBase
{
  ...
  {
    return java.util.Arrays.asList(new String[] { "w", "msg" });
  }
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    if (args.length < 2)
    {
      throw new net.minecraft.command.WrongUsageException("commands.message.usage", new Object[0]);
    }
    ...
    IChatComponent var4 = getChatComponentFromNthArg(sender, args, 1, !(sender instanceof net.minecraft.entity.player.EntityPlayer));
