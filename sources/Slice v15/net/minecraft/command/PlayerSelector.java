...
public class PlayerSelector
{
  ...
  private static List func_179654_a(ICommandSender p_179654_0_, Map p_179654_1_)
  {
    ...
    {
      Collections.addAll(var2, getServerworldServers);
    }
    ...
    else
    {
      ...
      var2.add(new Predicate()
      {
        ...
        public boolean func_179613_a(Entity p_179613_1_) {
          return EntityList.func_180123_a(p_179613_1_, PlayerSelector.this) ^ var4;
        }
  ...
  private static List func_179648_b(Map p_179648_0_)
  {
    ...
    int var2 = func_179653_a(p_179648_0_, "lm", -1);
    ...
    if ((var2 > -1) || (var3 > -1))
    {
      var1.add(new Predicate()
      {
        ...
        public boolean func_179625_a(Entity p_179625_1_) {
          ...
          return ((val$var2 <= -1) || (experienceLevel >= val$var2)) && ((var3 <= -1) || (experienceLevel <= var3));
        }
  ...
  {
    ArrayList var1 = Lists.newArrayList();
    int var2 = func_179653_a(p_179649_0_, "m", WorldSettings.GameType.NOT_SET.getID());
    ...
    if (var2 != WorldSettings.GameType.NOT_SET.getID())
    {
      var1.add(new Predicate()
      {
        ...
        public boolean func_179619_a(Entity p_179619_1_) {
          ...
          return theItemInWorldManager.getGameType().getID() == val$var2;
        }
    ...
    if (var2 != null)
    {
      ...
      var1.add(new Predicate()
      {
        ...
        public boolean func_179621_a(Entity p_179621_1_) {
          ...
          return var4.equals(PlayerSelector.this) ^ var3;
        }
  ...
  {
    ArrayList var1 = Lists.newArrayList();
    Map var2 = func_96560_a(p_179657_0_);
      ...
      var1.add(new Predicate()
      {
        ...
        public boolean func_179603_a(Entity p_179603_1_) {
          ...
          do
          {
            ...
            net.minecraft.scoreboard.ScoreObjective var7 = var2x.getObjective(var5);
    ...
    if (var2 != null)
    {
      ...
      var1.add(new Predicate()
      {
        ...
        public boolean func_179600_a(Entity p_179600_1_) {
          return p_179600_1_.getName().equals(PlayerSelector.this) ^ var3;
        }
    ...
    if ((p_180698_1_ != null) && ((var3 >= 0) || (var4 >= 0)))
    {
      ...
      var2.add(new Predicate()
      {
        ...
        public boolean func_179594_a(Entity p_179594_1_) {
          int var2 = (int)p_179594_1_.func_174831_c(PlayerSelector.this);
  ...
  private static List func_179662_g(Map p_179662_0_)
  {
    ...
    {
      int var2 = func_179650_a(func_179653_a(p_179662_0_, "rym", 0));
      ...
      var1.add(new Predicate()
      {
        ...
        public boolean func_179591_a(Entity p_179591_1_) {
          int var2x = PlayerSelector.func_179650_a((int)Math.floor(rotationYaw));
          return (var2x >= val$var2) || (var2x <= var3);
        }
    ...
    {
      int var2 = func_179650_a(func_179653_a(p_179662_0_, "rxm", 0));
      ...
      var1.add(new Predicate()
      {
        ...
        public boolean func_179616_a(Entity p_179616_1_) {
          int var2x = PlayerSelector.func_179650_a((int)Math.floor(rotationPitch));
          return (var2x >= val$var2) || (var2x <= var3);
        }
  ...
  private static List func_179660_a(Map p_179660_0_, Class p_179660_1_, List p_179660_2_, String p_179660_3_, World worldIn, BlockPos p_179660_5_)
  {
    ...
    if (p_179660_5_ != null)
    {
      int var16 = playerEntities.size();
      int var17 = loadedEntityList.size();
      ...
      {
        AxisAlignedBB var19 = func_179661_a(p_179660_5_, var10, var11, var12);
        ...
        if ((var8) && (var18) && (!var9))
        {
          Predicate var20 = new Predicate()
          {
            ...
            public boolean func_179609_a(Entity p_179609_1_) {
              return (posX < maxX) && (posY < maxY) && (posZ < maxZ);
            }
    ...
    else if (p_179658_5_ != null)
    {
      Collections.sort(p_179658_0_, new Comparator()
      {
        ...
        public int func_179611_a(Entity p_179611_1_, Entity p_179611_2_) {
          return ComparisonChain.start().compare(p_179611_1_.getDistanceSq(PlayerSelector.this), p_179611_2_.getDistanceSq(PlayerSelector.this)).result();
        }
