...
{
  public static final RenderItem RENDER_ITEM = new RenderItem(getMinecraftrenderEngine, 
    getMinecraftmodelManager);
  ...
  public static int applyTexture(int texId, BufferedImage image, boolean linear, boolean repeat) { int[] pixels = new int[image.getWidth() * image.getHeight()];
  ...
  public static void enableGL3D(float lineWidth)
  {
    ...
    GL11.glEnable(2884);
    getMinecraftentityRenderer.func_175072_h();
    GL11.glEnable(2848);
    GL11.glHint(3154, 4354);
    GL11.glHint(3155, 4354);
    GL11.glLineWidth(lineWidth);
  ...
  {
    Minecraft.getMinecraft();Minecraft.getMinecraft();scaledResolution = new ScaledResolution(Minecraft.getMinecraft(), Minecraft.displayWidth, Minecraft.displayHeight);
  }
}
