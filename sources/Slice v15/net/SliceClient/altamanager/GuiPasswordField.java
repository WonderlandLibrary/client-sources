  ...
  extends Gui
{
  ...
  public GuiPasswordField(FontRenderer p_i1032_1_, int p_i1032_2_, int p_i1032_3_, int p_i1032_4_, int p_i1032_5_)
  {
    ...
    field_146209_f = p_i1032_2_;
    field_146210_g = p_i1032_3_;
    field_146218_h = p_i1032_4_;
    field_146219_i = p_i1032_5_;
  }
    ...
    if (func_146176_q())
    {
      if (func_146181_i())
      {
        drawRect(field_146209_f - 1, field_146210_g - 1, field_146209_f + 
          field_146218_h + 1, field_146210_g + field_146219_i + 
          1, -6250336);
      ...
      boolean var6 = (field_146213_o) && (field_146214_l / 6 % 2 == 0) && 
        (var5);
      int var7 = field_146215_m ? field_146209_f + 4 : 
        field_146209_f;
      int var8 = field_146215_m ? field_146210_g + 
        (field_146219_i - 8) / 2 : field_146210_g;
      int var9 = var7;
      if (var3 > var4.length()) {
        var3 = var4.length();
      }
      if (var4.length() > 0)
      {
        ...
        var9 = field_146211_a.drawString(
      ...
      if ((var4.length() > 0) && (var5) && (var2 < var4.length())) {
        field_146211_a.drawString(var4.substring(var2)
      ...
      if (var6) {
        if (var13) {
          ...
          field_146211_a.drawString("_", var11, var8, var1);
        }
      }
      if (var3 != var2)
      {
        int var12 = var7 + 
          field_146211_a.getStringWidth(var4.substring(0, var3)
          .replaceAll(".", "*"));
  ...
  public void func_146175_b(int p_146175_1_)
  {
    if (field_146216_j.length() != 0) {
      ...
      else
      {
        ...
        int var3 = var2 ? field_146224_r + p_146175_1_ : 
          field_146224_r;
        int var4 = var2 ? field_146224_r : field_146224_r + 
          p_146175_1_;
        String var5 = "";
        if (var3 >= 0) {
  ...
  public void func_146191_b(String p_146191_1_)
  {
    ...
    int var4 = field_146224_r < field_146223_s ? field_146224_r : 
      field_146223_s;
    int var5 = field_146224_r < field_146223_s ? field_146223_s : 
      field_146224_r;
    int var6 = field_146217_k - field_146216_j.length() - (
      var4 - field_146223_s);
    if (field_146216_j.length() > 0)
  ...
  public int func_146197_a(int p_146197_1_, int p_146197_2_, boolean p_146197_3_)
  {
    ...
    for (int var7 = 0; var7 < var6; var7++) {
      if (var5)
      {
        ...
        } while (field_146216_j.charAt(var4 - 1) != ' ');
      }
      else
      {
        int var8 = field_146216_j.length();
        var4 = field_146216_j.indexOf(' ', var4);
        if (var4 == -1) {
          var4 = var8;
        } else {
          while ((p_146197_3_) && (var4 < var8) && 
            (field_146216_j.charAt(var4) == ' ')) {
            var4++;
          }
        }
      }
  ...
  {
    int var1 = field_146224_r < field_146223_s ? field_146224_r : 
      field_146223_s;
    int var2 = field_146224_r < field_146223_s ? field_146223_s : 
      field_146224_r;
