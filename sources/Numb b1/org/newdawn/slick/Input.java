...
public class Input {
	...
	/**
	 * Set the pixel distance the mouse can move to accept a mouse click. Default is
	 * 5.
	 * 
	...
	/**
	 * Add a listener to be notified of input events. This listener will get events
	 * before others that are currently registered
	 * 
	 * @param listener
	 *            The listener to be notified
	 */
	...
	/**
	 * Check if a particular key has been pressed since this method was last called
	...
	/**
	 * Clear the state for isControlPressed method. This will reset all controls to
	 * not pressed
	 */
	...
	/**
	 * Clear the state for the <code>isKeyPressed</code> method. This will resort in
	 * all keys returning that they haven't been pressed, until they are pressed
	 * again
	 */
	...
	/**
	 * Clear the state for the <code>isMousePressed</code> method. This will resort
	 * in all mouse buttons returning that they haven't been pressed, until they are
	 * pressed again
	 */
