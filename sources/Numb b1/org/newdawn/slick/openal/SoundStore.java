...
public class SoundStore {
	...
	/**
	 * True if we should only record the request to load in the intention of loading
	 * the sound later
	 * 
	 * @param deferred
	...
	/**
	 * Set the music volume of the current playing music. Does NOT affect the global
	 * volume
	 * 
	 * @param volume
	...
	/**
	 * Initialise the sound effects stored. This must be called before anything else
	 * will work
	 */
	public void init() {
		if (inited) {
	...
	/**
	 * Stop a playing sound identified by the ID returned from playing. This utility
	 * method should only be used when needing to stop sound effects that may have
	 * been played more than once and need to be explicitly stopped.
	 * 
	 * @param id
