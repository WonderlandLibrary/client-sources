...
public class GeomTest extends BasicGame {
	...
	/** The rectangle tested */
	private Shape rect2 = new Rectangle(310, 210, 50, 100)
			.transform(Transform.createRotateTransform((float) Math.toRadians(45), 335, 260));
	/** The circle tested */
	...
	/** The circle tested */
	private Shape circle4 = new Ellipse(510, 350, 30, 30).transform(Transform.createTranslateTransform(-510, -350))
			.transform(Transform.createScaleTransform(2, 2)).transform(Transform.createTranslateTransform(510, 350));
