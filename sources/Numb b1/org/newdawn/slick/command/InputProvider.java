...
public class InputProvider {
	...
	/**
	 * Remove a listener from this provider. The listener will no longer be provided
	 * with notification of commands performe.
	 * 
	 * @param listener
	...
	/**
	 * Fire notification to any interested listeners that a control has been pressed
	 * indication an particular command
	 * 
	 * @param command
	...
	private class InputListenerImpl extends InputAdapter {
		...
		public void controllerLeftPressed(int controller) {
			Command command = (Command) commands
					.get(new ControllerDirectionControl(controller, ControllerDirectionControl.LEFT));
			if (command != null) {
				firePressed(command);
			}
		}
		...
		public void controllerRightPressed(int controller) {
			Command command = (Command) commands
					.get(new ControllerDirectionControl(controller, ControllerDirectionControl.RIGHT));
			if (command != null) {
				firePressed(command);
			}
		}
		...
		public void controllerUpPressed(int controller) {
			Command command = (Command) commands
					.get(new ControllerDirectionControl(controller, ControllerDirectionControl.UP));
			if (command != null)
				firePressed(command);
		}
		...
		public void controllerDownPressed(int controller) {
			Command command = (Command) commands
					.get(new ControllerDirectionControl(controller, ControllerDirectionControl.DOWN));
			if (command != null) {
				firePressed(command);
			}
		}
