...
public abstract class SlickCallable {
	...
	/**
	 * Enter a safe block ensuring that all the OpenGL state that slick uses is safe
	 * before touching the GL state directly.
	 */
	...
	/**
	 * Perform the GL operations that this callable is intended to. This operations
	 * should not effect the slick OpenGL state.
	 * 
	 * @throws SlickException
