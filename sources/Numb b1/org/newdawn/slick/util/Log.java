...
public final class Log {
	...
	/**
	 * Indicate that we want verbose logging. The call is ignored if verbose logging
	 * is forced by the system property "org.newdawn.slick.forceVerboseLog"
	 * 
	 * @param v
	...
	/**
	 * Check if the system property org.newdawn.slick.verboseLog is set to true. If
	 * this is the case we activate the verbose logging mode
	 */
