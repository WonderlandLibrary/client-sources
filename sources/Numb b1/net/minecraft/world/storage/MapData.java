...
public class MapData extends WorldSavedData {
	...
	public void updateVisiblePlayers(EntityPlayer p_76191_1_, ItemStack p_76191_2_) {
		...
		for (int var6 = 0; var6 < this.playersArrayList.size(); ++var6) {
			...
			if (!var4.entityplayerObj.isDead
				...
				if (!p_76191_2_.isOnItemFrame() && var4.entityplayerObj.dimension == this.dimension) {
					this.func_82567_a(0, var4.entityplayerObj.worldObj, var4.entityplayerObj.getName(),
		...
		if (p_76191_2_.isOnItemFrame()) {
			...
			this.func_82567_a(1, p_76191_1_.worldObj, "frame-" + var7.getEntityId(), (double) var9.getX(),
					(double) var9.getZ(), (double) (var7.field_174860_b.getHorizontalIndex() * 90));
		}
		...
		if (p_76191_2_.hasTagCompound() && p_76191_2_.getTagCompound().hasKey("Decorations", 9)) {
			...
			for (int var10 = 0; var10 < var8.tagCount(); ++var10) {
				...
				if (!this.playersVisibleOnMap.containsKey(var5.getString("id"))) {
					this.func_82567_a(var5.getByte("type"), p_76191_1_.worldObj, var5.getString("id"),
							var5.getDouble("x"), var5.getDouble("z"), var5.getDouble("rot"));
				}
			}
		}
	}

	private void func_82567_a(int p_82567_1_, World worldIn, String p_82567_3_, double p_82567_4_, double p_82567_6_,
			double p_82567_8_) {
	...
	public class MapInfo {
		...
		public Packet func_176101_a(ItemStack p_176101_1_) {
			if (this.field_176105_d) {
				...
				return new S34PacketMaps(p_176101_1_.getMetadata(), MapData.this.scale,
						MapData.this.playersVisibleOnMap.values(), MapData.this.colors, this.field_176106_e,
						this.field_176103_f, this.field_176104_g + 1 - this.field_176106_e,
						this.field_176108_h + 1 - this.field_176103_f);
			} else {
				return this.field_176109_i++ % 5 == 0 ? new S34PacketMaps(p_176101_1_.getMetadata(), MapData.this.scale,
						MapData.this.playersVisibleOnMap.values(), MapData.this.colors, 0, 0, 0, 0) : null;
			}
		}
