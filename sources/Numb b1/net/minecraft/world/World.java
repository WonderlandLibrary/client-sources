...
public abstract class World implements IBlockAccess {
	...
	public Block getGroundAboveSeaLevel(BlockPos pos) {
		...
		for (var2 = new BlockPos(pos.getX(), 63, pos.getZ()); !this.isAirBlock(var2.offsetUp()); var2 = var2
				.offsetUp()) {
			;
		}
	...
	private boolean isAreaLoaded(int p_175663_1_, int p_175663_2_, int p_175663_3_, int p_175663_4_, int p_175663_5_,
			int p_175663_6_, boolean p_175663_7_) {
	...
	public BlockPos getHorizon(BlockPos pos) {
		...
		if (pos.getX() >= -30000000 && pos.getZ() >= -30000000 && pos.getX() < 30000000 && pos.getZ() < 30000000) {
			if (this.isChunkLoaded(pos.getX() >> 4, pos.getZ() >> 4, true)) {
				var2 = this.getChunkFromChunkCoords(pos.getX() >> 4, pos.getZ() >> 4).getHeight(pos.getX() & 15,
						pos.getZ() & 15);
			} else {
				var2 = 0;
			}
	 ...
	 */
	public MovingObjectPosition rayTraceBlocks(Vec3 p_147447_1_, Vec3 p_147447_2_, boolean p_147447_3_,
	...
	public void playSoundAtEntity(Entity p_72956_1_, String p_72956_2_, float p_72956_3_, float p_72956_4_) {
		for (int var5 = 0; var5 < this.worldAccesses.size(); ++var5) {
			((IWorldAccess) this.worldAccesses.get(var5)).playSound(p_72956_2_, p_72956_1_.posX, p_72956_1_.posY,
	...
	public void spawnParticle(EnumParticleTypes p_175688_1_, double p_175688_2_, double p_175688_4_, double p_175688_6_,
			double p_175688_8_, double p_175688_10_, double p_175688_12_, int... p_175688_14_) {
	...
	public void spawnParticle(EnumParticleTypes p_175682_1_, boolean p_175682_2_, double p_175682_3_,
			double p_175682_5_, double p_175682_7_, double p_175682_9_, double p_175682_11_, double p_175682_13_,
			int... p_175682_15_) {
	...
	private void spawnParticle(int p_175720_1_, boolean p_175720_2_, double p_175720_3_, double p_175720_5_,
			double p_175720_7_, double p_175720_9_, double p_175720_11_, double p_175720_13_, int... p_175720_15_) {
		for (int var16 = 0; var16 < this.worldAccesses.size(); ++var16) {
			((IWorldAccess) this.worldAccesses.get(var16)).func_180442_a(p_175720_1_, p_175720_2_, p_175720_3_,
					p_175720_5_, p_175720_7_, p_175720_9_, p_175720_11_, p_175720_13_, p_175720_15_);
		}
	}
	...
	public void updateEntityWithOptionalForce(Entity p_72866_1_, boolean p_72866_2_) {
		...
		if (!p_72866_2_ || this.isAreaLoaded(var3 - var5, 0, var4 - var5, var3 + var5, 0, var4 + var5, true)) {
			...
			if (!p_72866_1_.addedToChunk || p_72866_1_.chunkCoordX != var6 || p_72866_1_.chunkCoordY != var7
				...
				if (p_72866_1_.addedToChunk
						&& this.isChunkLoaded(p_72866_1_.chunkCoordX, p_72866_1_.chunkCoordZ, true)) {
				...
				for (int var13 = var6; var13 < var7; ++var13) {
					for (int var14 = var8; var14 < var9; ++var14) {
						...
						if (var17.getMaterial() == p_72918_2_) {
							double var18 = (double) ((float) (var13 + 1) - BlockLiquid
									.getLiquidHeightPercent(((Integer) var16.getValue(BlockLiquid.LEVEL)).intValue()));
	...
	public Explosion newExplosion(Entity p_72885_1_, double p_72885_2_, double p_72885_4_, double p_72885_6_,
		...
		Explosion var11 = new Explosion(this, p_72885_1_, p_72885_2_, p_72885_4_, p_72885_6_, p_72885_8_, p_72885_9_,
				p_72885_10_);
		var11.doExplosionA();
						...
						: (var3 instanceof BlockSlab ? var2.getValue(BlockSlab.HALF_PROP) == BlockSlab.EnumBlockHalf.TOP
								: (var3 instanceof BlockHopper ? true
										: (var3 instanceof BlockSnow
												? ((Integer) var2.getValue(BlockSnow.LAYERS_PROP)).intValue() == 7
												: false))));
	}
	...
	protected void func_147467_a(int p_147467_1_, int p_147467_2_, Chunk p_147467_3_) {
		...
		if (this.ambientTickCountdown == 0 && !this.isRemote) {
			...
			if (var9.getMaterial() == Material.air && this.getLight(var8) <= this.rand.nextInt(8)
					&& this.getLightFor(EnumSkyBlock.SKY, var8) <= 0) {
				EntityPlayer var10 = this.getClosestPlayer((double) var5 + 0.5D, (double) var7 + 0.5D,
						(double) var6 + 0.5D, 8.0D);

				if (var10 != null && var10.getDistanceSq((double) var5 + 0.5D, (double) var7 + 0.5D,
	...
	public boolean func_175670_e(BlockPos p_175670_1_, boolean p_175670_2_) {
		...
		if (var4 > 0.15F) {
			...
			if (p_175670_1_.getY() >= 0 && p_175670_1_.getY() < 256
					&& this.getLightFor(EnumSkyBlock.BLOCK, p_175670_1_) < 10) {
				IBlockState var5 = this.getBlockState(p_175670_1_);
				Block var6 = var5.getBlock();

				if ((var6 == Blocks.water || var6 == Blocks.flowing_water)
						&& ((Integer) var5.getValue(BlockLiquid.LEVEL)).intValue() == 0) {
					if (!p_175670_2_) {
						return true;
					}

					boolean var7 = this.func_175696_F(p_175670_1_.offsetWest())
							&& this.func_175696_F(p_175670_1_.offsetEast())
							&& this.func_175696_F(p_175670_1_.offsetNorth())
							&& this.func_175696_F(p_175670_1_.offsetSouth());
	...
	public boolean func_175708_f(BlockPos p_175708_1_, boolean p_175708_2_) {
		...
		if (var4 > 0.15F) {
			...
			if (p_175708_1_.getY() >= 0 && p_175708_1_.getY() < 256
					&& this.getLightFor(EnumSkyBlock.BLOCK, p_175708_1_) < 10) {
							...
							if (var17 + var18 + var19 < 17) {
								...
								for (int var22 = 0; var22 < var21; ++var22) {
									...
									if (var16 == var14 - var28 && var4 < this.lightUpdateBlockList.length) {
										this.lightUpdateBlockList[var4++] = var24 - var7 + 32 | var25 - var8 + 32 << 6
					...
					if (var16 > var30) {
						...
						if (var17 + var18 + var19 < 17 && var31) {
							if (this.getLightFor(p_180500_1_, var29.offsetWest()) < var16) {
								this.lightUpdateBlockList[var4++] = var11 - 1 - var7 + 32 + (var12 - var8 + 32 << 6)
										+ (var13 - var9 + 32 << 12);
							}
							...
							if (this.getLightFor(p_180500_1_, var29.offsetDown()) < var16) {
								this.lightUpdateBlockList[var4++] = var11 - var7 + 32 + (var12 - 1 - var8 + 32 << 6)
										+ (var13 - var9 + 32 << 12);
							}
							...
							if (this.getLightFor(p_180500_1_, var29.offsetNorth()) < var16) {
								this.lightUpdateBlockList[var4++] = var11 - var7 + 32 + (var12 - var8 + 32 << 6)
										+ (var13 - 1 - var9 + 32 << 12);
							}
		...
		for (int var9 = var5; var9 <= var6; ++var9) {
			for (int var10 = var7; var10 <= var8; ++var10) {
				if (this.isChunkLoaded(var9, var10, true)) {
					this.getChunkFromChunkCoords(var9, var10).func_177414_a(p_175674_1_, p_175674_2_, var4,
							p_175674_3_);
				}
			}
		}
	...
	public List func_175647_a(Class p_175647_1_, AxisAlignedBB p_175647_2_, Predicate p_175647_3_) {
		...
		for (int var9 = var4; var9 <= var5; ++var9) {
			for (int var10 = var6; var10 <= var7; ++var10) {
				if (this.isChunkLoaded(var9, var10, true)) {
					this.getChunkFromChunkCoords(var9, var10).func_177430_a(p_175647_1_, p_175647_2_, var8,
							p_175647_3_);
				}
			}
		}
	...
	public boolean canBlockBePlaced(Block p_175716_1_, BlockPos p_175716_2_, boolean p_175716_3_,
			EnumFacing p_175716_4_, Entity p_175716_5_, ItemStack p_175716_6_) {
		Block var7 = this.getBlockState(p_175716_2_).getBlock();
		AxisAlignedBB var8 = p_175716_3_ ? null
	...
	public boolean isBlockPowered(BlockPos pos) {
		return this.getRedstonePower(pos.offsetDown(), EnumFacing.DOWN) > 0 ? true
				: (this.getRedstonePower(pos.offsetUp(), EnumFacing.UP) > 0 ? true
						: (this.getRedstonePower(pos.offsetNorth(), EnumFacing.NORTH) > 0 ? true
								: (this.getRedstonePower(pos.offsetSouth(), EnumFacing.SOUTH) > 0 ? true
										: (this.getRedstonePower(pos.offsetWest(), EnumFacing.WEST) > 0 ? true
												: this.getRedstonePower(pos.offsetEast(), EnumFacing.EAST) > 0))));
	}
	...
	public BlockPos getSpawnPoint() {
		BlockPos var1 = new BlockPos(this.worldInfo.getSpawnX(), this.worldInfo.getSpawnY(),
				this.worldInfo.getSpawnZ());

		if (!this.getWorldBorder().contains(var1)) {
			var1 = this.getHorizon(
	...
	public boolean func_175727_C(BlockPos p_175727_1_) {
		if (!this.isRaining()) {
			...
			return var2.getEnableSnow() ? false
					: (this.func_175708_f(p_175727_1_, false) ? false : var2.canSpawnLightningBolt());
		}
	}
	...
	public void playAuxSFXAtEntity(EntityPlayer p_180498_1_, int p_180498_2_, BlockPos p_180498_3_, int p_180498_4_) {
		try {
			for (int var5 = 0; var5 < this.worldAccesses.size(); ++var5) {
				((IWorldAccess) this.worldAccesses.get(var5)).func_180439_a(p_180498_1_, p_180498_2_, p_180498_3_,
						p_180498_4_);
			}
		} catch (Throwable var8) {
