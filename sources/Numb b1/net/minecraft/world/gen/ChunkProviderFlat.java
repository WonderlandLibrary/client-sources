...
public class ChunkProviderFlat implements IChunkProvider {
	...
	public Chunk provideChunk(int p_73154_1_, int p_73154_2_) {
		...
		BiomeGenBase[] var11 = this.worldObj.getWorldChunkManager().loadBlockGeneratorData((BiomeGenBase[]) null,
	...
	public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_) {
		...
		if (this.waterLakeGenerator != null && !var8 && this.random.nextInt(4) == 0) {
			this.waterLakeGenerator.generate(this.worldObj, this.random,
					var6.add(this.random.nextInt(16) + 8, this.random.nextInt(256), this.random.nextInt(16) + 8));
		}

		if (this.lavaLakeGenerator != null && !var8 && this.random.nextInt(8) == 0) {
			BlockPos var17 = var6.add(this.random.nextInt(16) + 8, this.random.nextInt(this.random.nextInt(248) + 8),
		...
		if (this.hasDungeons) {
			for (int var18 = 0; var18 < 8; ++var18) {
				(new WorldGenDungeons()).generate(this.worldObj, this.random,
						var6.add(this.random.nextInt(16) + 8, this.random.nextInt(256), this.random.nextInt(16) + 8));
			}
		}
