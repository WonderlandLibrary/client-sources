			...
			for (var6 = 0; var6 < 16; ++var6) {
				for (var30 = 0; var30 < 16; ++var30) {
					for (var8 = 0; var8 < 8; ++var8) {
						...
						if (var32) {
							Material var10 = worldIn.getBlockState(p_180709_3_.add(var6, var8, var30)).getBlock()
									.getMaterial();
							...
							if (var8 < 4 && !var10.isSolid()
									&& worldIn.getBlockState(p_180709_3_.add(var6, var8, var30))
											.getBlock() != this.field_150556_a) {
								return false;
							}
						}
					}
					...
					for (var8 = 0; var8 < 8; ++var8) {
						if (var4[(var6 * 16 + var30) * 8 + var8]) {
							worldIn.setBlockState(p_180709_3_.add(var6, var8, var30),
									var8 >= 4 ? Blocks.air.getDefaultState() : this.field_150556_a.getDefaultState(),
									2);
						}
					}
				}
