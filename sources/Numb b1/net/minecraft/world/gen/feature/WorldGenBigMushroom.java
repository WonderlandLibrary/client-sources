				...
				if (var15 != Blocks.dirt && var15 != Blocks.grass && var15 != Blocks.mycelium) {
						...
						for (int var18 = p_180709_3_.getX() - var10; var18 <= p_180709_3_.getX() + var10; ++var18) {
							for (int var12 = p_180709_3_.getZ() - var10; var12 <= p_180709_3_.getZ() + var10; ++var12) {
								...
								if (var4 == 0 || var9 < p_180709_3_.getY() + var5) {
									if ((var18 == p_180709_3_.getX() - var10 || var18 == p_180709_3_.getX() + var10)
											&& (var12 == p_180709_3_.getZ() - var10
													|| var12 == p_180709_3_.getZ() + var10)) {
										continue;
									}

									if (var18 == p_180709_3_.getX() - (var10 - 1)
											&& var12 == p_180709_3_.getZ() - var10) {
										var13 = 1;
									}

									if (var18 == p_180709_3_.getX() - var10
											&& var12 == p_180709_3_.getZ() - (var10 - 1)) {
										var13 = 1;
									}
								...
								if (var13 != 0 || p_180709_3_.getY() >= p_180709_3_.getY() + var5 - 1) {
									...
									if (!worldIn.getBlockState(var14).getBlock().isFullBlock()) {
										this.func_175905_a(worldIn, var14,
												Block.getBlockById(
														Block.getIdFromBlock(Blocks.brown_mushroom_block) + var4),
												var13);
									}
								}
							}
					...
					for (var9 = 0; var9 < var5; ++var9) {
						...
						if (!var17.isFullBlock()) {
							this.func_175905_a(worldIn, p_180709_3_.offsetUp(var9),
									Block.getBlockById(Block.getIdFromBlock(Blocks.brown_mushroom_block) + var4), 10);
						}
					}
