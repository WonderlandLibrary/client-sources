...
public class WorldGenDungeons extends WorldGenerator {
	...
	private static final List CHESTCONTENT = Lists
	...
	public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_) {
		...
		for (var14 = var6; var14 <= var7; ++var14) {
			for (var15 = -1; var15 <= 4; ++var15) {
				for (var16 = var11; var16 <= var12; ++var16) {
					...
					if ((var14 == var6 || var14 == var7 || var16 == var11 || var16 == var12) && var15 == 0
							&& worldIn.isAirBlock(var17) && worldIn.isAirBlock(var17.offsetUp())) {
						++var13;
					}
				}
			}
		...
		if (var13 >= 1 && var13 <= 5) {
			for (var14 = var6; var14 <= var7; ++var14) {
				for (var15 = 3; var15 >= -1; --var15) {
					for (var16 = var11; var16 <= var12; ++var16) {
						...
						if (var14 != var6 && var15 != -1 && var16 != var11 && var14 != var7 && var15 != 4
								&& var16 != var12) {
							if (worldIn.getBlockState(var17).getBlock() != Blocks.chest) {
								worldIn.setBlockToAir(var17);
							}
						} else if (var17.getY() >= 0
								&& !worldIn.getBlockState(var17.offsetDown()).getBlock().getMaterial().isSolid()) {
							worldIn.setBlockToAir(var17);
						} else if (worldIn.getBlockState(var17).getBlock().getMaterial().isSolid()
								&& worldIn.getBlockState(var17).getBlock() != Blocks.chest) {
					...
					if (var15 < 3) {
						label197: {
							...
							if (worldIn.isAirBlock(var26)) {
								...
								if (var20 == 1) {
									worldIn.setBlockState(var26,
											Blocks.chest.func_176458_f(worldIn, var26, Blocks.chest.getDefaultState()),
											2);
									List var27 = WeightedRandomChestContent.func_177629_a(CHESTCONTENT,
											new WeightedRandomChestContent[] {
													Items.enchanted_book.getRandomEnchantedBook(p_180709_2_) });
									TileEntity var28 = worldIn.getTileEntity(var26);

									if (var28 instanceof TileEntityChest) {
										WeightedRandomChestContent.generateChestContents(p_180709_2_, var27,
												(TileEntityChest) var28, 8);
									}
			...
			if (var23 instanceof TileEntityMobSpawner) {
				...
				field_175918_a.error("Failed to fetch mob spawner entity at (" + p_180709_3_.getX() + ", "
						+ p_180709_3_.getY() + ", " + p_180709_3_.getZ() + ")");
			}
