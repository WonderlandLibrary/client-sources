			...
			for (int var8 = 0; var8 < areaWidth; ++var8) {
				...
				if (this.field_175973_g != null && this.field_175973_g.field_177779_F >= 0) {
					...
					if (var10 > 0) {
						...
						var6[var8 + var7 * areaWidth] = this.field_151623_c[this
					...
					if (var10 > 0) {
						...
						var6[var8 + var7 * areaWidth] = this.field_151621_d[this
					...
					if (var10 > 0) {
						...
						var6[var8 + var7 * areaWidth] = this.field_151622_e[this
								.nextInt(this.field_151622_e.length)].biomeID;
					}
				} else if (var9 == 4) {
					var6[var8
							+ var7 * areaWidth] = this.field_151620_f[this.nextInt(this.field_151620_f.length)].biomeID;
				} else {
