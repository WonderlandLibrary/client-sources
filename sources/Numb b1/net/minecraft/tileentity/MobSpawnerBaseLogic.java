...
public abstract class MobSpawnerBaseLogic {
	...
	private boolean isActivated() {
		...
		return this.getSpawnerWorld().func_175636_b((double) var1.getX() + 0.5D, (double) var1.getY() + 0.5D,
				(double) var1.getZ() + 0.5D, (double) this.activatingRangeFromPlayer);
	}
		...
		if (this.isActivated()) {
			...
			if (this.getSpawnerWorld().isRemote) {
				...
				for (int var3 = 0; var3 < this.spawnCount; ++var3) {
					...
					int var5 = this.getSpawnerWorld().getEntitiesWithinAABB(var14.getClass(),
							(new AxisAlignedBB((double) var1.getX(), (double) var1.getY(), (double) var1.getZ(),
									(double) (var1.getX() + 1), (double) (var1.getY() + 1), (double) (var1.getZ() + 1)))
											.expand((double) this.spawnRange, (double) this.spawnRange,
					...
					var14.setLocationAndAngles(var6, var8, var10, this.getSpawnerWorld().rand.nextFloat() * 360.0F,
							0.0F);
		...
		if (this.getRandomEntity() != null) {
			...
			for (Entity var11 = p_180613_1_; var3.hasKey("Riding", 10); var3 = var12) {
				...
				if (var13 != null) {
					...
					var13.setLocationAndAngles(var11.posX, var11.posY, var11.posZ, var11.rotationYaw,
							var11.rotationPitch);
			...
			((EntityLiving) p_180613_1_).func_180482_a(
					p_180613_1_.worldObj.getDifficultyForLocation(new BlockPos(p_180613_1_)), (IEntityLivingData) null);
			p_180613_1_.worldObj.spawnEntityInWorld(p_180613_1_);
		}
	...
	public class WeightedRandomMinecart extends WeightedRandom.Item {
		...
		public WeightedRandomMinecart(NBTTagCompound p_i1945_2_) {
			this(p_i1945_2_.getCompoundTag("Properties"), p_i1945_2_.getString("Type"),
					p_i1945_2_.getInteger("Weight"));
		}
		...
		private WeightedRandomMinecart(NBTTagCompound p_i45757_2_, String p_i45757_3_, int p_i45757_4_) {
			...
			if (p_i45757_3_.equals("Minecart")) {
				if (p_i45757_2_ != null) {
					p_i45757_3_ = EntityMinecart.EnumMinecartType.func_180038_a(p_i45757_2_.getInteger("Type"))
							.func_180040_b();
				} else {
