...
public class TileEntityPiston extends TileEntity implements IUpdatePlayerListBox {
	...
	public float func_174929_b(float p_174929_1_) {
		return this.extending ? (this.func_145860_a(p_174929_1_) - 1.0F) * (float) this.field_174931_f.getFrontOffsetX()
				: (1.0F - this.func_145860_a(p_174929_1_)) * (float) this.field_174931_f.getFrontOffsetX();
	}

	public float func_174928_c(float p_174928_1_) {
		return this.extending ? (this.func_145860_a(p_174928_1_) - 1.0F) * (float) this.field_174931_f.getFrontOffsetY()
				: (1.0F - this.func_145860_a(p_174928_1_)) * (float) this.field_174931_f.getFrontOffsetY();
	}

	public float func_174926_d(float p_174926_1_) {
		return this.extending ? (this.func_145860_a(p_174926_1_) - 1.0F) * (float) this.field_174931_f.getFrontOffsetZ()
				: (1.0F - this.func_145860_a(p_174926_1_)) * (float) this.field_174931_f.getFrontOffsetZ();
	}
	...
	private void func_145863_a(float p_145863_1_, float p_145863_2_) {
		...
		AxisAlignedBB var3 = Blocks.piston_extension.func_176424_a(this.worldObj, this.pos, this.field_174932_a,
				p_145863_1_, this.field_174931_f);
			...
			if (!var4.isEmpty()) {
				...
				while (var5.hasNext()) {
					...
					if (this.field_174932_a.getBlock() == Blocks.slime_block && this.extending) {
						...
						var6.moveEntity((double) (p_145863_2_ * (float) this.field_174931_f.getFrontOffsetX()),
	...
	public void readFromNBT(NBTTagCompound compound) {
		...
		this.field_174932_a = Block.getBlockById(compound.getInteger("blockId"))
