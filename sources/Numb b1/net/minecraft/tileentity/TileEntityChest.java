	...
	public void update() {
		...
		if (!this.worldObj.isRemote && this.numPlayersUsing != 0
			...
			List var5 = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class,
					new AxisAlignedBB((double) ((float) var1 - var4), (double) ((float) var2 - var4),
							(double) ((float) var3 - var4), (double) ((float) (var1 + 1) + var4),
							(double) ((float) (var2 + 1) + var4), (double) ((float) (var3 + 1) + var4)));
		...
		if (this.numPlayersUsing > 0 && this.lidAngle == 0.0F && this.adjacentChestZNeg == null
			...
			this.worldObj.playSoundEffect(var11, (double) var2 + 0.5D, var14, "random.chestopen", 0.5F,
		...
		if (this.numPlayersUsing == 0 && this.lidAngle > 0.0F || this.numPlayersUsing > 0 && this.lidAngle < 1.0F) {
			...
			if (this.lidAngle < var13 && var12 >= var13 && this.adjacentChestZNeg == null
					&& this.adjacentChestXNeg == null) {
				...
				this.worldObj.playSoundEffect(var14, (double) var2 + 0.5D, var9, "random.chestclosed", 0.5F,
						this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
			}
