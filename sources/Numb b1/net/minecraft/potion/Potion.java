...
public class Potion {
	...
	public static final Potion field_180152_w = (new PotionHealthBoost(21, new ResourceLocation("health_boost"), false,
	...
	public static final Potion absorption = (new PotionAbsoption(22, new ResourceLocation("absorption"), false,
	...
	public void func_180793_a(Entity p_180793_1_, Entity p_180793_2_, EntityLivingBase p_180793_3_, int p_180793_4_,
			double p_180793_5_) {
		int var7;

		if ((this.id != heal.id || p_180793_3_.isEntityUndead())
				&& (this.id != harm.id || !p_180793_3_.isEntityUndead())) {
			if (this.id == harm.id && !p_180793_3_.isEntityUndead()
					|| this.id == heal.id && p_180793_3_.isEntityUndead()) {
				var7 = (int) (p_180793_5_ * (double) (6 << p_180793_4_) + 0.5D);

				if (p_180793_1_ == null) {
					p_180793_3_.attackEntityFrom(DamageSource.magic, (float) var7);
				} else {
					p_180793_3_.attackEntityFrom(DamageSource.causeIndirectMagicDamage(p_180793_1_, p_180793_2_),
							(float) var7);
				}
			}
		} else {
