...
public class WeightedBakedModel implements IBakedModel {
	...
	public IBakedModel func_177564_a(long p_177564_1_) {
		return ((WeightedBakedModel.MyWeighedRandomItem) WeightedRandom.func_180166_a(this.models,
	...
	static class MyWeighedRandomItem extends WeightedRandom.Item implements Comparable {
		...
		public int func_177634_a(WeightedBakedModel.MyWeighedRandomItem p_177634_1_) {
			return ComparisonChain.start().compare(p_177634_1_.itemWeight, this.itemWeight)
					.compare(this.func_177635_a(), p_177634_1_.func_177635_a()).result();
		}
