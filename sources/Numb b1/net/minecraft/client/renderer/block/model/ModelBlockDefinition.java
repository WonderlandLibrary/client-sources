...
public class ModelBlockDefinition {
	...
	public static class Deserializer implements JsonDeserializer {
		...
		public ModelBlockDefinition func_178336_a(JsonElement p_178336_1_, Type p_178336_2_,
				JsonDeserializationContext p_178336_3_) {
		...
		protected ModelBlockDefinition.Variants func_178335_a(JsonDeserializationContext p_178335_1_,
				Entry p_178335_2_) {
			...
			if (var5.isJsonArray()) {
				...
				while (var6.hasNext()) {
					...
					var4.add((ModelBlockDefinition.Variant) p_178335_1_.deserialize(var7,
							ModelBlockDefinition.Variant.class));
				}
			} else {
				var4.add((ModelBlockDefinition.Variant) p_178335_1_.deserialize(var5,
						ModelBlockDefinition.Variant.class));
			}
	...
	public static class Variant {
		...
		public boolean equals(Object p_equals_1_) {
			if (this == p_equals_1_) {
				...
				return this.field_178437_a.equals(var2.field_178437_a) && this.field_178435_b == var2.field_178435_b
						&& this.field_178436_c == var2.field_178436_c;
			}
		}
		...
		public static class Deserializer implements JsonDeserializer {
			...
			public ModelBlockDefinition.Variant func_178425_a(JsonElement p_178425_1_, Type p_178425_2_,
					JsonDeserializationContext p_178425_3_) {
	...
	public static class Variants {
		...
		public boolean equals(Object p_equals_1_) {
			if (this == p_equals_1_) {
				...
				return !this.field_178423_a.equals(var2.field_178423_a) ? false
						: this.field_178422_b.equals(var2.field_178422_b);
			}
		}
