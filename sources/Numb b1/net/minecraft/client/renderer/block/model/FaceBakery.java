...
public class FaceBakery {
	...
	public BakedQuad func_178414_a(Vector3f posFrom, Vector3f posTo, BlockPartFace face, TextureAtlasSprite sprite,
	...
	public BakedQuad makeBakedQuad(Vector3f posFrom, Vector3f posTo, BlockPartFace face, TextureAtlasSprite sprite,
			EnumFacing facing, ITransformation modelRotationIn, BlockPartRotation partRotation, boolean uvLocked,
			boolean shade) {
		int[] var10 = this.makeQuadVertexData(face, sprite, facing, this.func_178403_a(posFrom, posTo), modelRotationIn,
	...
	private int[] makeQuadVertexData(BlockPartFace p_178405_1_, TextureAtlasSprite p_178405_2_, EnumFacing p_178405_3_,
			float[] p_178405_4_, ITransformation p_178405_5_, BlockPartRotation p_178405_6_, boolean p_178405_7_,
			boolean shade) {
		byte vertexSize = 28;
		...
		for (int var10 = 0; var10 < 4; ++var10) {
			this.fillVertexData(var9, var10, p_178405_3_, p_178405_1_, p_178405_4_, p_178405_2_, p_178405_5_,
					p_178405_6_, p_178405_7_, shade);
		}
	...
	private void fillVertexData(int[] faceData, int vertexIndex, EnumFacing facing, BlockPartFace partFace,
			float[] p_178402_5_, TextureAtlasSprite sprite, ITransformation modelRotationIn,
		...
		Vector3d var14 = new Vector3d((double) p_178402_5_[var13.field_179184_a],
				(double) p_178402_5_[var13.field_179182_b], (double) p_178402_5_[var13.field_179183_c]);
	...
	private void func_178404_a(int[] faceData, int storeIndex, int vertexIndex, Vector3d position, int shadeColor,
		...
		faceData[var8 + 4] = Float
				.floatToRawIntBits(sprite.getInterpolatedU((double) faceUV.func_178348_a(vertexIndex)));
		faceData[var8 + 4 + 1] = Float
	...
	private void func_178407_a(Vector3d p_178407_1_, BlockPartRotation p_178407_2_) {
		if (p_178407_2_ != null) {
			...
			case 1:
				var3.mul(this.func_178416_a(new AxisAngle4d(1.0D, 0.0D, 0.0D,
						(double) p_178407_2_.field_178343_c * 0.017453292519943295D)));
				var4.set(0.0D, 1.0D, 1.0D);
				break;

			case 2:
				var3.mul(this.func_178416_a(new AxisAngle4d(0.0D, 1.0D, 0.0D,
						(double) p_178407_2_.field_178343_c * 0.017453292519943295D)));
				var4.set(1.0D, 0.0D, 1.0D);
				break;

			case 3:
				var3.mul(this.func_178416_a(new AxisAngle4d(0.0D, 0.0D, 1.0D,
						(double) p_178407_2_.field_178343_c * 0.017453292519943295D)));
	...
	public int func_178415_a(Vector3d position, EnumFacing facing, int vertexIndex, ModelRotation modelRotationIn,
			boolean uvLocked) {
		return this.rotateVertex(position, facing, vertexIndex, modelRotationIn, uvLocked);
	}

	public int rotateVertex(Vector3d position, EnumFacing facing, int vertexIndex, ITransformation modelRotationIn,
			boolean uvLocked) {
		if (modelRotationIn == ModelRotation.X0_Y0) {
			...
			if (Reflector.ForgeHooksClient_transform.exists()) {
				...
				this.func_178406_a(position, new Vector3d(0.5D, 0.5D, 0.5D), new Matrix4d(modelRotationIn.getMatrix()),
	...
	public static EnumFacing func_178410_a(int[] p_178410_0_) {
		...
		int step2 = step * 2;
		int step3 = step * 3;
		Vector3f var1 = new Vector3f(Float.intBitsToFloat(p_178410_0_[0]), Float.intBitsToFloat(p_178410_0_[1]),
				Float.intBitsToFloat(p_178410_0_[2]));
		Vector3f var2 = new Vector3f(Float.intBitsToFloat(p_178410_0_[step]),
				Float.intBitsToFloat(p_178410_0_[step + 1]), Float.intBitsToFloat(p_178410_0_[step + 2]));
		Vector3f var3 = new Vector3f(Float.intBitsToFloat(p_178410_0_[step2]),
	...
	public void func_178409_a(int[] p_178409_1_, EnumFacing p_178409_2_, BlockFaceUV p_178409_3_,
	...
	private void func_178401_a(int p_178401_1_, int[] p_178401_2_, EnumFacing p_178401_3_, BlockFaceUV p_178401_4_,
