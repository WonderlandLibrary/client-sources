...
public class BlockPart {
	...
	public BlockPart(Vector3f p_i46231_1_, Vector3f p_i46231_2_, Map p_i46231_3_, BlockPartRotation p_i46231_4_,
			boolean p_i46231_5_) {
	...
	private float[] func_178236_a(EnumFacing p_178236_1_) {
		...
		case 1:
		case 2:
			var2 = new float[] { this.field_178241_a.x, this.field_178241_a.z, this.field_178239_b.x,
					this.field_178239_b.z };
			break;
		case 3:
		case 4:
			var2 = new float[] { this.field_178241_a.x, 16.0F - this.field_178239_b.y, this.field_178239_b.x,
					16.0F - this.field_178241_a.y };
			break;
		case 5:
		case 6:
			var2 = new float[] { this.field_178241_a.z, 16.0F - this.field_178239_b.y, this.field_178239_b.z,
					16.0F - this.field_178241_a.y };
			break;
		default:
	...
	static class Deserializer implements JsonDeserializer {
		...
		public BlockPart func_178254_a(JsonElement p_178254_1_, Type p_178254_2_,
				JsonDeserializationContext p_178254_3_) {
		...
		private Map func_178253_b(JsonDeserializationContext p_178253_1_, JsonObject p_178253_2_) {
			...
			while (var5.hasNext()) {
				...
				var3.put(var7,
						(BlockPartFace) p_178253_1_.deserialize((JsonElement) var6.getValue(), BlockPartFace.class));
			}
