...
public class RenderFallingBlock extends Render {
	...
	public void doRender(EntityFallingBlock p_180557_1_, double p_180557_2_, double p_180557_4_, double p_180557_6_,
			float p_180557_8_, float p_180557_9_) {
		if (p_180557_1_.getBlock() != null) {
			...
			if (var10 != var13.getBlockState(var12) && var11.getRenderType() != -1) {
				if (var11.getRenderType() == 3) {
					...
					var15.setTranslation((double) ((float) (-var16) - 0.5F), (double) (-var17),
							(double) ((float) (-var18) - 0.5F));
