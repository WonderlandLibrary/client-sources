...
public class RenderMinecart extends Render {
	...
	public void doRender(EntityMinecart p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
		...
		if (var30 > 0.0F) {
			GlStateManager.rotate(
					MathHelper.sin(var30) * var30 * var31 / 10.0F * (float) p_76986_1_.getRollingDirection(), 1.0F,
					0.0F, 0.0F);
		}
	...
	protected void func_180560_a(EntityMinecart p_180560_1_, float p_180560_2_, IBlockState p_180560_3_) {
		GlStateManager.pushMatrix();
		Minecraft.getMinecraft().getBlockRendererDispatcher().func_175016_a(p_180560_3_,
				p_180560_1_.getBrightness(p_180560_2_));
		GlStateManager.popMatrix();
	}
