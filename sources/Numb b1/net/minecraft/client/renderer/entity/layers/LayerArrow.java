...
public class LayerArrow implements LayerRenderer {
	...
	public void doRenderLayer(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_,
		...
		if (var9 > 0) {
			EntityArrow var10 = new EntityArrow(p_177141_1_.worldObj, p_177141_1_.posX, p_177141_1_.posY,
					p_177141_1_.posZ);
			...
			for (int var12 = 0; var12 < var9; ++var12) {
				...
				var10.prevRotationYaw = var10.rotationYaw = (float) (Math.atan2((double) var15, (double) var17) * 180.0D
						/ Math.PI);
				var10.prevRotationPitch = var10.rotationPitch = (float) (Math.atan2((double) var16, (double) var21)
						* 180.0D / Math.PI);
				double var22 = 0.0D;
				double var24 = 0.0D;
				double var26 = 0.0D;
				this.field_177168_a.func_177068_d().renderEntityWithPosYaw(var10, var22, var24, var26, 0.0F,
						p_177141_4_);
