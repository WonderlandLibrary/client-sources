...
public class LayerDeadmau5Head implements LayerRenderer {
	...
	public void func_177207_a(AbstractClientPlayer p_177207_1_, float p_177207_2_, float p_177207_3_, float p_177207_4_,
			float p_177207_5_, float p_177207_6_, float p_177207_7_, float p_177207_8_) {
		String username = p_177207_1_.getNameClear();
		...
		if (p_177207_1_.getName().equals("deadmau5") && p_177207_1_.hasSkin() && !p_177207_1_.isInvisible()) {
			...
			for (int var9 = 0; var9 < 2; ++var9) {
				float var10 = p_177207_1_.prevRotationYaw
				...
				float var11 = p_177207_1_.prevRotationPitch
		...
		if (username != null && !username.isEmpty()) {
			if (Client.instance.setmgr.getSettingByName("Ears").getValBoolean()
					&& username.equalsIgnoreCase(Minecraft.getMinecraft().session.getUsername())) {
				{
					...
					for (int var9 = 0; var9 < 2; ++var9) {
						float var10 = p_177207_1_.prevRotationYaw
								+ (p_177207_1_.rotationYaw - p_177207_1_.prevRotationYaw) * p_177207_4_
								- (p_177207_1_.prevRenderYawOffset
										+ (p_177207_1_.renderYawOffset - p_177207_1_.prevRenderYawOffset)
												* p_177207_4_);
						float var11 = p_177207_1_.prevRotationPitch
								+ (p_177207_1_.rotationPitch - p_177207_1_.prevRotationPitch) * p_177207_4_;
						GlStateManager.pushMatrix();
	...
	public void doRenderLayer(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_,
		...
		this.func_177207_a((AbstractClientPlayer) p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_,
