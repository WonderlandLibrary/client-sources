...
public class LayerHeldBlock implements LayerRenderer {
	...
	public void func_177173_a(EntityEnderman p_177173_1_, float p_177173_2_, float p_177173_3_, float p_177173_4_,
			float p_177173_5_, float p_177173_6_, float p_177173_7_, float p_177173_8_) {
		...
		if (var9.getBlock().getMaterial() != Material.air) {
			...
			OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (float) var13 / 1.0F,
					(float) var14 / 1.0F);
	...
	public void doRenderLayer(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_,
		...
		this.func_177173_a((EntityEnderman) p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_,
