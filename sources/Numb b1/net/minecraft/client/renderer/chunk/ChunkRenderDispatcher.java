...
public class ChunkRenderDispatcher {
	...
	public String func_178504_a() {
		return String.format("pC: %03d, pU: %1d, aB: %1d", new Object[] { Integer.valueOf(this.field_178519_d.size()),
				Integer.valueOf(this.field_178524_h.size()), Integer.valueOf(this.field_178520_e.size()) });
	}
	...
	public ListenableFuture func_178503_a(final EnumWorldBlockLayer p_178503_1_, final WorldRenderer p_178503_2_,
		...
		if (Minecraft.getMinecraft().isCallingFromMinecraftThread()) {
			if (OpenGlHelper.func_176075_f()) {
				...
				this.func_178510_a(p_178503_2_,
						((ListedRenderChunk) p_178503_3_).func_178600_a(p_178503_1_, p_178503_4_), p_178503_3_);
			}
