...
public class EntityDropParticleFX extends EntityFX {
	...
	protected EntityDropParticleFX(World worldIn, double p_i1203_2_, double p_i1203_4_, double p_i1203_6_,
			Material p_i1203_8_) {
	...
	public void onUpdate() {
		...
		if (var3.isLiquid() || var3.isSolid()) {
			...
			if (var2.getBlock() instanceof BlockLiquid) {
				var4 = (double) BlockLiquid
						.getLiquidHeightPercent(((Integer) var2.getValue(BlockLiquid.LEVEL)).intValue());
			}
