...
public class EntityFireworkStarterFX extends EntityFX {
	...
	public EntityFireworkStarterFX(World worldIn, double p_i46355_2_, double p_i46355_4_, double p_i46355_6_,
			double p_i46355_8_, double p_i46355_10_, double p_i46355_12_, EffectRenderer p_i46355_14_,
			NBTTagCompound p_i46355_15_) {
	...
	private boolean func_92037_i() {
		...
		return var1 == null || var1.func_175606_aa() == null
				|| var1.func_175606_aa().getDistanceSq(this.posX, this.posY, this.posZ) >= 256.0D;
	}

	/**
	 * Creates a single particle. Args: x, y, z, x velocity, y velocity, z velocity,
	 * colours, fade colours, whether to trail, whether to twinkle
	 */
	 ...
	 * shape, colours, fade colours, whether to trail, whether to flicker, unknown
	 */
