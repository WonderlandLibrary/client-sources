...
public class EntityPickupFX extends EntityFX {
	...
	public void func_180434_a(WorldRenderer p_180434_1_, Entity p_180434_2_, float p_180434_3_, float p_180434_4_,
		...
		double var16 = this.field_174843_ax.lastTickPosX
				+ (this.field_174843_ax.posX - this.field_174843_ax.lastTickPosX) * (double) p_180434_3_;
		double var18 = this.field_174843_ax.lastTickPosY
				+ (this.field_174843_ax.posY - this.field_174843_ax.lastTickPosY) * (double) p_180434_3_
				+ (double) this.field_174841_aA;
		double var20 = this.field_174843_ax.lastTickPosZ
				+ (this.field_174843_ax.posZ - this.field_174843_ax.lastTickPosZ) * (double) p_180434_3_;
		...
		var24 -= interpPosY;
		var26 -= interpPosZ;
		this.field_174842_aB.renderEntityWithPosYaw(this.field_174840_a, (double) ((float) var22),
				(double) ((float) var24), (double) ((float) var26), this.field_174840_a.rotationYaw, p_180434_3_);
	}
