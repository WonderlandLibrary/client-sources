...
public class GuiAchievements extends GuiScreen implements IProgressMeter {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		if (this.loadingAchievements) {
			...
			if (Mouse.isButtonDown(0)) {
				...
				if ((this.field_146554_D == 0 || this.field_146554_D == 1) && mouseX >= var6 && mouseX < var6 + 224
	...
	protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
		...
		for (var25 = 0; var25 < AchievementList.achievementList.size(); ++var25) {
			...
			if (var40 >= -24 && var41 >= -24 && (float) var40 <= 224.0F * this.field_146570_r
					&& (float) var41 <= 155.0F * this.field_146570_r) {
				...
				if (var23 >= (float) var40 && var23 <= (float) (var40 + 22) && var35 >= (float) var41
						&& var35 <= (float) (var41 + 22)) {
					var33 = var38;
				}
			}
		}
		...
		if (var33 != null) {
			...
			if (this.statFileWriter.canUnlockAchievement(var33)) {
				...
				this.drawGradientRect(var40 - 3, var41 - 3, var40 + var30 + 3, var41 + var31 + 3 + 12, -1073741824,
						-1073741824);
				this.fontRendererObj.drawSplitString(var39, var40, var41 + 12, var30, -6250336);

				if (this.statFileWriter.hasAchievementUnlocked(var33)) {
					this.fontRendererObj.func_175063_a(I18n.format("achievement.taken", new Object[0]), (float) var40,
							(float) (var41 + var31 + 4), -7302913);
				}
			} else {
				int var32;
				String var44;
				...
				if (var42 == 3) {
					...
					this.drawGradientRect(var40 - 3, var41 - 3, var40 + var30 + 3, var41 + var32 + 12 + 3, -1073741824,
							-1073741824);
			...
			if (var36 != null) {
				this.fontRendererObj.func_175063_a(var36, (float) var40, (float) var41,
						this.statFileWriter.canUnlockAchievement(var33) ? (var33.getSpecial() ? -128 : -1)
								: (var33.getSpecial() ? -8355776 : -8355712));
			}
		}
