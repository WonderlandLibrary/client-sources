...
import us.loki.legit.events.*;
import us.loki.legit.gui.Fonts;
...
public class GuiIngame extends Gui {
	...
	public void renderEverything() {
		if (ModuleManager.getModuleByName("HUD").isEnabled()) {
			...
			mc.fontRendererObj.drawString("User: " + mc.thePlayer.getName(), sr.getScaledWidth() - 120,
					sr.getScaledHeight() - 20, ColorUtils.rainbowEffekt(index + x * 20000000L, 1.0F).getRGB());
			mc.fontRendererObj.drawStringWithShadow("XYZ:", 4, sr.getScaledHeight() - 10,
					ColorUtils.rainbowEffekt(index, 1.0F).getRGB());
			mc.fontRendererObj.drawString(
					"" + String.valueOf(Math.round(Client.mc.thePlayer.posX)) + ", "
							+ ("" + String.valueOf(Math.round(Client.mc.thePlayer.posY) + ", "))
							+ ("" + String.valueOf(Math.round(Client.mc.thePlayer.posZ) + " ")),
					28, sr.getScaledHeight() - 10, 0xFFFAFA);
			String var1 = "IP: ";
			mc.fontRendererObj.drawStringWithShadow(var1, right - 120, sr.getScaledHeight() - 10,
			...
			if (ModuleManager.getModuleByName("Sprint").isEnabled()
				...
				mc.fontRendererObj.drawStringWithShadow("Sprint [TOGGLED]", 25, sr.getScaledHeight() - 100, 0xFF00FF);
			}
			if (ModuleManager.getModuleByName("Sneak").isEnabled()
					&& !ModuleManager.getModuleByName("Sprint").isEnabled()) {
				mc.fontRendererObj.drawStringWithShadow("Sneak [TOGGLED]", 25, sr.getScaledHeight() - 100, 0x00FF00);
			}
	...
	public void renderPotionStatus(ScaledResolution sr) {
		if (ModuleManager.getModuleByName("StatusHUD").isEnabled()) {
			int pY = 0;
			pY = -23;
	...
	public void renderKeystrokes() {
			if (ModuleManager.getModuleByName("Keystrokes").isEnabled()) {
				if (mc.currentScreen != null && !(mc.currentScreen instanceof GuiChat)) {
					us.loki.legit.utils.RenderHelper.drawBorderRect(0.0f, 500.0f, 1000.0f, 0.0f, -1442840576,
							-1442840576, 0.0f);
				}
				us.loki.legit.utils.RenderHelper.drawBorderRect(108.0f, 1.0f, 90.0f, 16.0f,
						Keyboard.isKeyDown((int) 17) ? Integer.MAX_VALUE : -1442840576,
						Keyboard.isKeyDown((int) 17) ? Integer.MAX_VALUE : -1442840576, 0.0f);
				mc.fontRendererObj.func_175063_a(Keyboard.isKeyDown((int) 17) ? "\u00a7eW" : "W", 96.0f, 5.0f,
						Keyboard.isKeyDown((int) 17) ? -1 : Integer.MAX_VALUE);
				us.loki.legit.utils.RenderHelper.drawBorderRect(108.0f, 17.0f, 90.0f, 33.0f,
						Keyboard.isKeyDown((int) 31) ? Integer.MAX_VALUE : -1442840576,
						Keyboard.isKeyDown((int) 31) ? Integer.MAX_VALUE : -1442840576, 0.0f);
				mc.fontRendererObj.func_175063_a(Keyboard.isKeyDown((int) 31) ? "\u00a7eS" : "S", 96.0f, 22.0f,
						Keyboard.isKeyDown((int) 31) ? -1 : Integer.MAX_VALUE);
				us.loki.legit.utils.RenderHelper.drawBorderRect(88.0f, 17.0f, 70.0f, 33.0f,
						Keyboard.isKeyDown((int) 30) ? Integer.MAX_VALUE : -1442840576,
						Keyboard.isKeyDown((int) 30) ? Integer.MAX_VALUE : -1442840576, 0.0f);
				mc.fontRendererObj.func_175063_a(Keyboard.isKeyDown((int) 30) ? "\u00a7eA" : "A", 77.0f, 22.0f,
						Keyboard.isKeyDown((int) 30) ? -1 : Integer.MAX_VALUE);
				us.loki.legit.utils.RenderHelper.drawBorderRect(128.0f, 17.0f, 110.0f, 33.0f,
						Keyboard.isKeyDown((int) 32) ? Integer.MAX_VALUE : -1442840576,
						Keyboard.isKeyDown((int) 32) ? Integer.MAX_VALUE : -1442840576, 0.0f);
				mc.fontRendererObj.func_175063_a(Keyboard.isKeyDown((int) 32) ? "\u00a7eD" : "D", 116.0f, 22.0f,
						Keyboard.isKeyDown((int) 32) ? -1 : Integer.MAX_VALUE);
				us.loki.legit.utils.RenderHelper.drawBorderRect(128.0f, 35.0f, 70.0f, 50.0f,
						Keyboard.isKeyDown((int) 57) ? Integer.MAX_VALUE : -1442840576,
						Keyboard.isKeyDown((int) 57) ? Integer.MAX_VALUE : -1442840576, 0.0f);
				mc.fontRendererObj.func_175063_a(Keyboard.isKeyDown((int) 57) ? "\u00a7ESPACE" : "SPACE", 85.0f, 39.0f,
						Keyboard.isKeyDown((int) 57) ? -1 : Integer.MAX_VALUE);
				us.loki.legit.utils.RenderHelper.drawBorderRect(98.0f, 65.0f, 70.0f, 52.0f,
						mc.gameSettings.keyBindAttack.pressed ? Integer.MAX_VALUE : -1442840576,
						mc.gameSettings.keyBindAttack.pressed ? Integer.MAX_VALUE : -1442840576, 0.0f);
				mc.fontRendererObj.func_175063_a(mc.gameSettings.keyBindAttack.pressed ? "\u00a7eLMB" : "LMB", 75.0f,
						55.0f, mc.gameSettings.keyBindAttack.pressed ? -1 : Integer.MAX_VALUE);
				us.loki.legit.utils.RenderHelper.drawBorderRect(101.0f, 65.0f, 128.0f, 52.0f,
						mc.gameSettings.keyBindUseItem.pressed ? Integer.MAX_VALUE : -1442840576,
						mc.gameSettings.keyBindUseItem.pressed ? Integer.MAX_VALUE : -1442840576, 0.0f);
				mc.fontRendererObj.func_175063_a(mc.gameSettings.keyBindUseItem.pressed ? "\u00a7eRMB" : "RMB", 107.0f,
						55.0f, mc.gameSettings.keyBindUseItem.pressed ? -1 : Integer.MAX_VALUE);
			}
		}
	...
	protected void func_180479_a(ScaledResolution p_180479_1_, float p_180479_2_) {
		if (this.mc.func_175606_aa() instanceof EntityPlayer) {
			...
			this.drawTexturedModalRect(var4 - 91 - 1 + var3.inventory.currentItem * 20,
