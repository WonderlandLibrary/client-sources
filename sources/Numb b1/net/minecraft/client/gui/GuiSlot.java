...
public abstract class GuiSlot {
	...
	public int getSlotIndexFromScreenCoords(int p_148124_1_, int p_148124_2_) {
		...
		return p_148124_1_ < this.getScrollBarX() && p_148124_1_ >= var3 && p_148124_1_ <= var4 && var6 >= 0
	...
	public void drawScreen(int p_148128_1_, int p_148128_2_, float p_148128_3_) {
		if (this.field_178041_q) {
			...
			var7.addVertexWithUV((double) this.left, (double) this.bottom, 0.0D, (double) ((float) this.left / var8),
					(double) ((float) (this.bottom + (int) this.amountScrolled) / var8));
			var7.addVertexWithUV((double) this.right, (double) this.bottom, 0.0D, (double) ((float) this.right / var8),
					(double) ((float) (this.bottom + (int) this.amountScrolled) / var8));
			var7.addVertexWithUV((double) this.right, (double) this.top, 0.0D, (double) ((float) this.right / var8),
					(double) ((float) (this.top + (int) this.amountScrolled) / var8));
			var7.addVertexWithUV((double) this.left, (double) this.top, 0.0D, (double) ((float) this.left / var8),
					(double) ((float) (this.top + (int) this.amountScrolled) / var8));
			var6.draw();
			...
			if (Mouse.isButtonDown(0) && this.getEnabled()) {
				if (this.initialClickY == -1.0F) {
					...
					if (this.mouseY >= this.top && this.mouseY <= this.bottom) {
						...
						if (this.mouseX >= var2 && this.mouseX <= var3 && var5 >= 0 && var4 >= 0
								&& var5 < this.getSize()) {
							...
							this.func_148132_a(this.mouseX - var2,
						...
						if (this.mouseX >= var11 && this.mouseX <= var7) {
							...
							int var9 = (int) ((float) ((this.bottom - this.top) * (this.bottom - this.top))
	...
	protected void overlayBackground(int p_148136_1_, int p_148136_2_, int p_148136_3_, int p_148136_4_) {
		...
		var6.addVertexWithUV((double) this.left, (double) p_148136_2_, 0.0D, 0.0D,
				(double) ((float) p_148136_2_ / var7));
		var6.addVertexWithUV((double) (this.left + this.width), (double) p_148136_2_, 0.0D,
				(double) ((float) this.width / var7), (double) ((float) p_148136_2_ / var7));
		var6.func_178974_a(4210752, p_148136_3_);
		var6.addVertexWithUV((double) (this.left + this.width), (double) p_148136_1_, 0.0D,
				(double) ((float) this.width / var7), (double) ((float) p_148136_1_ / var7));
		var6.addVertexWithUV((double) this.left, (double) p_148136_1_, 0.0D, 0.0D,
				(double) ((float) p_148136_1_ / var7));
		var5.draw();
	}
