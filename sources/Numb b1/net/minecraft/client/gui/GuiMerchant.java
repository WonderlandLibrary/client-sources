...
public class GuiMerchant extends GuiContainer {
	...
	public void initGui() {
		...
		this.buttonList
				.add(this.field_147043_x = new GuiMerchant.MerchantButton(1, var1 + 120 + 27, var2 + 24 - 1, true));
		this.buttonList
				.add(this.field_147042_y = new GuiMerchant.MerchantButton(2, var1 + 36 - 19, var2 + 24 - 1, false));
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		this.fontRendererObj.drawString(var3, this.xSize / 2 - this.fontRendererObj.getStringWidth(var3) / 2, 6,
				4210752);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (var4 != null && !var4.isEmpty()) {
			...
			} else if (var8.isRecipeDisabled() && (this.isPointInRegion(83, 21, 28, 21, mouseX, mouseY)
