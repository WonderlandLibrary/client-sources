		...
		if (this.buttonsNotDrawn && var1 >= 0) {
			...
			for (int var4 = 0; var4 <= 2; ++var4) {
				...
				for (var7 = 0; var7 < var5; ++var7) {
					...
					var9 = new GuiBeacon.PowerButton(var4 << 8 | var8, this.guiLeft + 76 + var7 * 24 - var6 / 2,
							this.guiTop + 22 + var4 * 25, var8, var4);
			...
			for (var7 = 0; var7 < var5 - 1; ++var7) {
				...
				var9 = new GuiBeacon.PowerButton(var10 << 8 | var8, this.guiLeft + 167 + var7 * 24 - var6 / 2,
						this.guiTop + 47, var8, var10);
				this.buttonList.add(var9);
			...
			if (var2 > 0) {
				GuiBeacon.PowerButton var11 = new GuiBeacon.PowerButton(var10 << 8 | var2,
						this.guiLeft + 167 + (var5 - 1) * 24 - var6 / 2, this.guiTop + 47, var2, var10);
