...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
	...
	public void handleJoinGame(S01PacketJoinGame packetIn) {
		...
		this.clientWorldController = new WorldClient(this,
				...
				packetIn.func_149194_f(), packetIn.func_149192_g(), this.gameController.mcProfiler);
	...
	public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
		...
		if (packetIn.func_148993_l() == 10) {
			...
			var8 = new EntityItemFrame(
					this.clientWorldController, new BlockPos(MathHelper.floor_double(var2),
		...
		if (var8 != null) {
			...
			if (packetIn.func_149009_m() > 0) {
				...
				((Entity) var8).setVelocity(packetIn.func_149010_g() / 8000.0D, packetIn.func_149004_h() / 8000.0D,
						packetIn.func_148999_i() / 8000.0D);
			}
		}
	}
	...
	public void handleSpawnExperienceOrb(S11PacketSpawnExperienceOrb packetIn) {
		PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
		EntityXPOrb var2 = new EntityXPOrb(this.clientWorldController, packetIn.func_148984_d(),
	...
	public void handleSpawnPainting(S10PacketSpawnPainting packetIn) {
		PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
		EntityPainting var2 = new EntityPainting(this.clientWorldController, packetIn.func_179837_b(),
	...
	public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn) {
		...
		EntityOtherPlayerMP var10 = new EntityOtherPlayerMP(this.gameController.theWorld,
				this.func_175102_a(packetIn.func_179819_c()).func_178845_a());
	...
	public void handleEntityTeleport(S18PacketEntityTeleport packetIn) {
		...
		if (var2 != null) {
			...
			if (Math.abs(var2.posX - var3) < 0.03125D && Math.abs(var2.posY - var5) < 0.015625D
	...
	public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
		...
		this.netManager.sendPacket(new C03PacketPlayer.C06PacketPlayerPosLook(var2.posX,
				var2.getEntityBoundingBox().minY, var2.posZ, var2.rotationYaw, var2.rotationPitch, false));
	...
	public void handleChunkData(S21PacketChunkData packetIn) {
		...
		this.clientWorldController.invalidateBlockReceiveRegion(packetIn.func_149273_e() << 4, 0,
				packetIn.func_149271_f() << 4, (packetIn.func_149273_e() << 4) + 15, 256,
				(packetIn.func_149271_f() << 4) + 15);
		Chunk var2 = this.clientWorldController.getChunkFromChunkCoords(packetIn.func_149273_e(),
				packetIn.func_149271_f());
		var2.func_177439_a(packetIn.func_149272_d(), packetIn.func_149276_g(), packetIn.func_149274_i());
		this.clientWorldController.markBlockRangeForRenderUpdate(packetIn.func_149273_e() << 4, 0,
				packetIn.func_149271_f() << 4, (packetIn.func_149273_e() << 4) + 15, 256,
				(packetIn.func_149271_f() << 4) + 15);
	...
	public void handleCollectItem(S0DPacketCollectItem packetIn) {
		...
		if (var2 != null) {
			...
			this.gameController.effectRenderer
					.addEffect(new EntityPickupFX(this.clientWorldController, var2, (Entity) var3, 0.5F));
	...
	public void handleSpawnMob(S0FPacketSpawnMob packetIn) {
		...
		EntityLivingBase var10 = (EntityLivingBase) EntityList.createEntityByID(packetIn.func_149025_e(),
				...
				this.gameController.ingameGUI
						.setRecordPlaying(
								I18n.format("mount.onboard",
										new Object[] {
												GameSettings.getKeyDisplayString(var5.keyBindSneak.getKeyCode()) }),
								false);
			}
	...
	public void handleSetExperience(S1FPacketSetExperience packetIn) {
		PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
		this.gameController.thePlayer.setXPStats(packetIn.func_149397_c(), packetIn.func_149396_d(),
	...
	public void handleExplosion(S27PacketExplosion packetIn) {
		PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
		Explosion var2 = new Explosion(this.gameController.theWorld, (Entity) null, packetIn.func_149148_f(),
		...
		if (packetIn.func_149175_c() == -1) {
			...
			if (packetIn.func_149175_c() == 0 && packetIn.func_149173_d() >= 36 && packetIn.func_149173_d() < 45) {
				...
				if (packetIn.func_149174_e() != null
						&& (var5 == null || var5.stackSize < packetIn.func_149174_e().stackSize)) {
	...
	public void handleUpdateSign(S33PacketUpdateSign packetIn) {
		...
		if (!var2 && this.gameController.thePlayer != null) {
			this.gameController.thePlayer
					.addChatMessage(new ChatComponentText("Unable to locate sign at " + packetIn.func_179704_a().getX()
	...
	public void handleBlockAction(S24PacketBlockAction packetIn) {
		...
		PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
		this.gameController.theWorld.addBlockEvent(packetIn.func_179825_a(), packetIn.getBlockType(),
	...
	public void handleBlockBreakAnim(S25PacketBlockBreakAnim packetIn) {
		PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
		this.gameController.theWorld.sendBlockBreakProgress(packetIn.func_148845_c(), packetIn.func_179821_b(),
	...
	public void handleChangeGameState(S2BPacketChangeGameState packetIn) {
		...
		if (var3 == 1) {
			...
			if (var4 == 0.0F) {
				...
				this.gameController.ingameGUI.getChatGUI()
						.printChatMessage(new ChatComponentTranslation("demo.help.jump",
			...
			this.clientWorldController.playSound(var2.posX, var2.posY + var2.getEyeHeight(), var2.posZ,
			...
			this.clientWorldController.spawnParticle(EnumParticleTypes.MOB_APPEARANCE, var2.posX, var2.posY, var2.posZ,
					0.0D, 0.0D, 0.0D, new int[0]);
			this.clientWorldController.playSound(var2.posX, var2.posY, var2.posZ, "mob.guardian.curse", 1.0F, 1.0F,
					false);
		}
	}
	...
	public void handleEffect(S28PacketEffect packetIn) {
		...
		if (packetIn.isSoundServerwide()) {
			this.gameController.theWorld.func_175669_a(packetIn.getSoundType(), packetIn.func_179746_d(),
					packetIn.getSoundData());
		} else {
			this.gameController.theWorld.playAuxSFX(packetIn.getSoundType(), packetIn.func_179746_d(),
					packetIn.getSoundData());
		}
	}
	...
	public void func_175099_a(S45PacketTitle p_175099_1_) {
		...
		this.gameController.ingameGUI.func_175178_a(var3, var4, p_175099_1_.func_179806_c(),
	...
	public void handleSoundEffect(S29PacketSoundEffect packetIn) {
		PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
		this.gameController.theWorld.playSound(packetIn.func_149207_d(), packetIn.func_149211_e(),
	...
	public void func_175095_a(S48PacketResourcePackSend p_175095_1_) {
		...
		if (var2.startsWith("level://")) {
			...
			if (var6.isFile()) {
				...
				Futures.addCallback(this.gameController.getResourcePackRepository().func_177319_a(var6),
						new FutureCallback() {
			...
			if (this.gameController.getCurrentServerData() != null && this.gameController.getCurrentServerData()
				...
				this.netManager
						.sendPacket(new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.ACCEPTED));
				Futures.addCallback(this.gameController.getResourcePackRepository().func_180601_a(var2, var3),
						new FutureCallback() {
											...
											new FutureCallback() {
												...
												public void onSuccess(Object p_onSuccess_1_) {
													NetHandlerPlayClient.this.netManager
															.sendPacket(new C19PacketResourcePackStatus(var3,
																	C19PacketResourcePackStatus.Action.SUCCESSFULLY_LOADED));
												}
	...
	public void handleParticles(S2APacketParticles packetIn) {
		...
		if (packetIn.func_149222_k() == 0) {
			...
			try {
				this.clientWorldController.spawnParticle(packetIn.func_179749_a(), packetIn.func_179750_b(),
			...
			for (int var18 = 0; var18 < packetIn.func_149222_k(); ++var18) {
				double var3 = this.avRandomizer.nextGaussian() * packetIn.func_149221_g();
				double var5 = this.avRandomizer.nextGaussian() * packetIn.func_149224_h();
				double var7 = this.avRandomizer.nextGaussian() * packetIn.func_149223_i();
				double var9 = this.avRandomizer.nextGaussian() * packetIn.func_149227_j();
				double var11 = this.avRandomizer.nextGaussian() * packetIn.func_149227_j();
				double var13 = this.avRandomizer.nextGaussian() * packetIn.func_149227_j();
