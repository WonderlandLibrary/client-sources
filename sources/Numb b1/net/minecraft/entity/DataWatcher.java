...
public class DataWatcher {
	 ...
	 * float, string, ItemStack, ChunkCoordinates}) from the supplied PacketBuffer
	 */
	...
	public void updateWatchedObjectsFromList(List p_75687_1_) {
		...
		while (var2.hasNext()) {
			DataWatcher.WatchableObject var3 = (DataWatcher.WatchableObject) var2.next();
			DataWatcher.WatchableObject var4 = (DataWatcher.WatchableObject) this.watchedObjects
					.get(Integer.valueOf(var3.getDataValueId()));
