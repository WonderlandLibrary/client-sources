...
public class EntityLeashKnot extends EntityHanging {
	...
	public EntityLeashKnot(World worldIn, BlockPos p_i45851_2_) {
		...
		this.setPosition((double) p_i45851_2_.getX() + 0.5D, (double) p_i45851_2_.getY() + 0.5D,
				(double) p_i45851_2_.getZ() + 0.5D);
		float var3 = 0.125F;
		float var4 = 0.1875F;
		float var5 = 0.25F;
		this.func_174826_a(new AxisAlignedBB(this.posX - 0.1875D, this.posY - 0.25D + 0.125D, this.posZ - 0.1875D,
				this.posX + 0.1875D, this.posY + 0.25D + 0.125D, this.posZ + 0.1875D));
	}
	...
	public boolean interactFirst(EntityPlayer playerIn) {
		...
		if (var2 != null && var2.getItem() == Items.lead && !this.worldObj.isRemote) {
			var4 = 7.0D;
			var6 = this.worldObj.getEntitiesWithinAABB(EntityLiving.class, new AxisAlignedBB(this.posX - var4,
					this.posY - var4, this.posZ - var4, this.posX + var4, this.posY + var4, this.posZ + var4));
			var7 = var6.iterator();
	...
	public static EntityLeashKnot func_174863_b(World worldIn, BlockPos p_174863_1_) {
		...
		List var5 = worldIn.getEntitiesWithinAABB(EntityLeashKnot.class,
				new AxisAlignedBB((double) var2 - 1.0D, (double) var3 - 1.0D, (double) var4 - 1.0D,
						(double) var2 + 1.0D, (double) var3 + 1.0D, (double) var4 + 1.0D));
