...
public class EntityFishHook extends Entity {
	...
	public EntityFishHook(World worldIn, double p_i1765_2_, double p_i1765_4_, double p_i1765_6_,
	...
	public EntityFishHook(World worldIn, EntityPlayer p_i1766_2_) {
		...
		this.setSize(0.25F, 0.25F);
		this.setLocationAndAngles(p_i1766_2_.posX, p_i1766_2_.posY + (double) p_i1766_2_.getEyeHeight(),
		...
		if (this.fishPosRotationIncrements > 0) {
			...
			if (!this.worldObj.isRemote) {
				...
				if (this.angler.isDead || !this.angler.isEntityAlive() || var1 == null
						|| var1.getItem() != Items.fishing_rod || this.getDistanceSqToEntity(this.angler) > 1024.0D) {
					this.setDead();
			...
			Entity var4 = null;
			List var5 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox()
			...
			for (int var8 = 0; var8 < var5.size(); ++var8) {
				...
				if (var9.canBeCollidedWith() && (var9 != this.angler || this.ticksInAir >= 5)) {
					float var10 = 0.3F;
					AxisAlignedBB var11 = var9.getEntityBoundingBox().expand((double) var10, (double) var10,
							(double) var10);
			...
			if (!this.inGround) {
				...
				for (this.rotationPitch = (float) (Math.atan2(this.motionY, (double) var31) * 180.0D
				...
				for (int var35 = 0; var35 < var33; ++var35) {
					...
					AxisAlignedBB var21 = new AxisAlignedBB(var14.minX, var17, var14.minZ, var14.maxX, var19,
							var14.maxZ);
					...
					if (this.ticksCatchable > 0) {
						...
						if (this.ticksCatchableDelay > 0) {
							...
							if (this.ticksCatchableDelay <= 0) {
								...
								var36.func_175739_a(EnumParticleTypes.WATER_BUBBLE, this.posX, (double) (var16 + 1.0F),
										this.posZ, (int) (1.0F + this.width * 20.0F), (double) this.width, 0.0D,
										(double) this.width, 0.20000000298023224D, new int[0]);
								var36.func_175739_a(EnumParticleTypes.WATER_WAKE, this.posX, (double) (var16 + 1.0F),
										this.posZ, (int) (1.0F + this.width * 20.0F), (double) this.width, 0.0D,
										(double) this.width, 0.20000000298023224D, new int[0]);
								...
								var40 = (double) ((float) MathHelper.floor_double(this.getEntityBoundingBox().minY)
										+ 1.0F);
								...
								if (this.rand.nextFloat() < 0.15F) {
									var36.func_175739_a(EnumParticleTypes.WATER_BUBBLE, var19,
											var40 - 0.10000000149011612D, var23, 1, (double) var39, 0.1D,
											(double) var18, 0.0D, new int[0]);
								}

								float var25 = var39 * 0.04F;
								float var26 = var18 * 0.04F;
								var36.func_175739_a(EnumParticleTypes.WATER_WAKE, var19, var40, var23, 0,
										(double) var26, 0.01D, (double) (-var25), 1.0D, new int[0]);
								var36.func_175739_a(EnumParticleTypes.WATER_WAKE, var19, var40, var23, 0,
										(double) (-var26), 0.01D, (double) var25, 1.0D, new int[0]);
							}
	...
	private ItemStack func_146033_f() {
		...
		if (var1 < var4) {
			...
			if (var1 < var5) {
				...
				return ((WeightedRandomFishable) WeightedRandom.getRandomItem(this.rand, VALUABLES))
