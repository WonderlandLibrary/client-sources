...
public class EntityAIFindEntityNearestPlayer extends EntityAIBase {
		...
		this.field_179435_c = new Predicate() {
			...
			public boolean func_179880_a(Entity p_179880_1_) {
				if (!(p_179880_1_ instanceof EntityPlayer)) {
					...
					return (double) p_179880_1_
							.getDistanceToEntity(EntityAIFindEntityNearestPlayer.this.field_179434_b) > var2 ? false
									: EntityAITarget.func_179445_a(EntityAIFindEntityNearestPlayer.this.field_179434_b,
											(EntityLivingBase) p_179880_1_, false, true);
				}
			}
	...
	public boolean shouldExecute() {
		...
		List var3 = this.field_179434_b.worldObj.func_175647_a(EntityPlayer.class,
				this.field_179434_b.getEntityBoundingBox().expand(var1, 4.0D, var1), this.field_179435_c);
	...
	public boolean continueExecuting() {
		...
		if (var1 == null) {
			...
			if (var2 != null && var3 == var2) {
				...
				return this.field_179434_b.getDistanceSqToEntity(var1) > var4 * var4 ? false
