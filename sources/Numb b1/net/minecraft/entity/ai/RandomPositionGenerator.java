...
public class RandomPositionGenerator {
	...
	private static Vec3 findRandomTargetBlock(EntityCreature p_75462_0_, int p_75462_1_, int p_75462_2_,
		...
		if (p_75462_0_.hasHome()) {
			double var11 = p_75462_0_.func_180486_cf().distanceSq((double) MathHelper.floor_double(p_75462_0_.posX),
					(double) MathHelper.floor_double(p_75462_0_.posY),
					(double) MathHelper.floor_double(p_75462_0_.posZ)) + 4.0D;
