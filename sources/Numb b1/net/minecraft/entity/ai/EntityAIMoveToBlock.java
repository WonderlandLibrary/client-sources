...
public abstract class EntityAIMoveToBlock extends EntityAIBase {
	...
	public boolean continueExecuting() {
		return this.field_179493_e >= -this.field_179490_f && this.field_179493_e <= 1200
				&& this.func_179488_a(this.field_179495_c.worldObj, this.field_179494_b);
	}
	...
	public void startExecuting() {
		this.field_179495_c.getNavigator().tryMoveToXYZ((double) ((float) this.field_179494_b.getX()) + 0.5D,
				(double) (this.field_179494_b.getY() + 1), (double) ((float) this.field_179494_b.getZ()) + 0.5D,
				this.field_179492_d);
		this.field_179493_e = 0;
		this.field_179490_f = this.field_179495_c.getRNG().nextInt(this.field_179495_c.getRNG().nextInt(1200) + 1200)
				+ 1200;
	}
			...
			for (int var5 = 0; var5 < var1; ++var5) {
				for (int var6 = 0; var6 <= var5; var6 = var6 > 0 ? -var6 : 1 - var6) {
					for (int var7 = var6 < var5 && var6 > -var5 ? var5 : 0; var7 <= var5; var7 = var7 > 0 ? -var7
						...
						if (this.field_179495_c.func_180485_d(var8)
								&& this.func_179488_a(this.field_179495_c.worldObj, var8)) {
