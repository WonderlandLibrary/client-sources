...
public class ItemEnderEye extends Item {
	...
	public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side,
		...
		if (playerIn.func_175151_a(pos.offset(side), side, stack) && var9.getBlock() == Blocks.end_portal_frame
				&& !((Boolean) var9.getValue(BlockEndPortalFrame.field_176507_b)).booleanValue()) {
			if (worldIn.isRemote) {
				return true;
			} else {
				worldIn.setBlockState(pos, var9.withProperty(BlockEndPortalFrame.field_176507_b, Boolean.valueOf(true)),
						2);
				...
				if (var14 && var12 == var24 + 2) {
					...
					for (var29 = var24; var29 <= var12; ++var29) {
						...
						if (var32.getBlock() != Blocks.end_portal_frame
								|| !((Boolean) var32.getValue(BlockEndPortalFrame.field_176507_b)).booleanValue()) {
							var14 = false;
							break;
						}
					}
					...
					for (var29 = var24 - 1; var29 <= var12 + 1; var29 += 4) {
						...
						for (var31 = 1; var31 <= 3; ++var31) {
							...
							if (var20.getBlock() != Blocks.end_portal_frame
									|| !((Boolean) var20.getValue(BlockEndPortalFrame.field_176507_b)).booleanValue()) {
								var14 = false;
								break;
							}
						}
