	...
	public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side,
		...
		if (!playerIn.func_175151_a(pos, side, stack)) {
			...
			if (worldIn.canBlockBePlaced(this.field_150935_a, pos, false, side, (Entity) null, stack)) {
				IBlockState var11 = this.field_150935_a.onBlockPlaced(worldIn, pos, side, hitX, hitY, hitZ, 0,
						playerIn);
				...
				if (worldIn.setBlockState(pos, var11, 3)) {
					...
					worldIn.playSoundEffect((double) ((float) pos.getX() + 0.5F), (double) ((float) pos.getY() + 0.5F),
							(double) ((float) pos.getZ() + 0.5F), this.field_150935_a.stepSound.getPlaceSound(),
							(this.field_150935_a.stepSound.getVolume() + 1.0F) / 2.0F,
							this.field_150935_a.stepSound.getFrequency() * 0.8F);
					--stack.stackSize;
					return true;
				}
			}
