...
public class ItemFishFood extends ItemFood {
	...
	public float getSaturationModifier(ItemStack itemStackIn) {
		ItemFishFood.FishType var2 = ItemFishFood.FishType.getFishTypeForItemStack(itemStackIn);
		return this.cooked && var2.getCookable() ? var2.getCookedSaturationModifier()
				: var2.getUncookedSaturationModifier();
	}
	...
	public String getUnlocalizedName(ItemStack stack) {
		...
		return this.getUnlocalizedName() + "." + var2.getUnlocalizedNamePart() + "."
				+ (this.cooked && var2.getCookable() ? "cooked" : "raw");
	}
	...
	public static enum FishType {
		...
		public static ItemFishFood.FishType getFishTypeForItemDamage(int p_150974_0_) {
			ItemFishFood.FishType var1 = (ItemFishFood.FishType) itemDamageToFishTypeMap
					.get(Integer.valueOf(p_150974_0_));
