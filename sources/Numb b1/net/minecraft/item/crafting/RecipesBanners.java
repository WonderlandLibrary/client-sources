...
public class RecipesBanners {
	...
	void func_179534_a(CraftingManager p_179534_1_) {
		...
		for (int var4 = 0; var4 < var3; ++var4) {
			...
			p_179534_1_.addRecipe(new ItemStack(Items.banner, 1, var5.getDyeColorDamage()), new Object[] { "###", "###",
					" | ", '#', new ItemStack(Blocks.wool, 1, var5.func_176765_a()), '|', Items.stick });
		}
		...
		private TileEntityBanner.EnumBannerPattern func_179533_c(InventoryCrafting p_179533_1_) {
			...
			for (int var4 = 0; var4 < var3; ++var4) {
				...
				if (var5.func_177270_d()) {
					...
					} else if (p_179533_1_.getSizeInventory() != var5.func_177267_c().length
							* var5.func_177267_c()[0].length()) {
						var6 = false;
					} else {
						int var7 = -1;
