...
public class S26PacketMapChunkBulk implements Packet {
	...
	public void readPacketData(PacketBuffer data) throws IOException {
		...
		for (var3 = 0; var3 < var2; ++var3) {
			...
			this.field_179755_c[var3].field_150282_a = new byte[S21PacketChunkData.func_180737_a(
					Integer.bitCount(this.field_179755_c[var3].field_150280_b), this.field_149267_h, true)];
		}
