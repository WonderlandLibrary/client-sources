...
public class IntegratedServer extends MinecraftServer {
	...
	protected void loadAllWorlds(String p_71247_1_, String p_71247_2_, long seed, WorldType type, String p_71247_6_) {
		...
		if (Reflector.DimensionManager.exists()) {
			WorldServer var9 = this.isDemo()
					? (WorldServer) ((WorldServer) (new DemoWorldServer(this, var7, var8, 0, this.theProfiler)).init())
					: (WorldServer) (new WorldServerOF(this, var7, var8, 0, this.theProfiler)).init();
			var9.initialize(this.theWorldSettings);
			Integer[] var10 = (Integer[]) ((Integer[]) Reflector.call(Reflector.DimensionManager_getStaticDimensionIDs,
					new Object[0]));
			Integer[] arr$ = var10;
			...
			for (int i$ = 0; i$ < len$; ++i$) {
				...
				WorldServer world = dim == 0 ? var9
						: (WorldServer) ((WorldServer) (new WorldServerMulti(this, var7, dim, var9, this.theProfiler))
								.init());
			...
			for (int var16 = 0; var16 < this.worldServers.length; ++var16) {
				...
				if (var16 == 0) {
					if (this.isDemo()) {
						this.worldServers[var16] = (WorldServer) (new DemoWorldServer(this, var7, var8, var17,
								this.theProfiler)).init();
					} else {
						this.worldServers[var16] = (WorldServer) (new WorldServerOF(this, var7, var8, var17,
								this.theProfiler)).init();
					}

					this.worldServers[var16].initialize(this.theWorldSettings);
				} else {
					this.worldServers[var16] = (WorldServer) (new WorldServerMulti(this, var7, var17,
					...
					try {
						if (Reflector.FMLCommonHandler_callFuture.exists()) {
							Reflector.callVoid(Reflector.FMLCommonHandler_callFuture,
									new Object[] { (FutureTask) this.futureTaskQueue.poll() });
						} else {
