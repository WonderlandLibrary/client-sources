...
public class ItemInWorldManager {
	...
	public void updateBlockRemoving() {
		...
		if (this.receivedFinishDiggingPacket) {
			...
			if (var2.getMaterial() == Material.air) {
				...
				var3 = var2.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.worldObj,
						this.field_180241_i) * (float) (var1 + 1);
				var4 = (int) (var3 * 10.0F);
			...
			if (var5.getMaterial() == Material.air) {
				...
				var3 = var5.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.worldObj,
						this.field_180241_i) * (float) (var6 + 1);
				var4 = (int) (var3 * 10.0F);
	...
	public void func_180785_a(BlockPos p_180785_1_) {
		if (p_180785_1_.equals(this.field_180240_f)) {
			...
			if (var3.getMaterial() != Material.air) {
				float var4 = var3.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.worldObj,
						p_180785_1_) * (float) (var2 + 1);
		...
		if (this.gameType.isCreative() && this.thisPlayerMP.getHeldItem() != null
			...
			if (this.isCreative()) {
				this.thisPlayerMP.playerNetServerHandler
						.sendPacket(new S23PacketBlockChange(this.theWorld, p_180237_1_));
			} else {
	...
	public boolean func_180236_a(EntityPlayer p_180236_1_, World worldIn, ItemStack p_180236_3_, BlockPos p_180236_4_,
			EnumFacing p_180236_5_, float p_180236_6_, float p_180236_7_, float p_180236_8_) {
		if (this.gameType == WorldSettings.GameType.SPECTATOR) {
			...
			if (p_180236_3_ == null) {
				...
				boolean var11 = p_180236_3_.onItemUse(p_180236_1_, worldIn, p_180236_4_, p_180236_5_, p_180236_6_,
						p_180236_7_, p_180236_8_);
