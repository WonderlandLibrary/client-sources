...
public abstract class BlockRailBase extends Block {
	...
	public static boolean func_176563_d(IBlockState p_176563_0_) {
		...
		return var1 == Blocks.rail || var1 == Blocks.golden_rail || var1 == Blocks.detector_rail
				|| var1 == Blocks.activator_rail;
	}
	...
	public void setBlockBoundsBasedOnState(IBlockAccess access, BlockPos pos) {
		...
		BlockRailBase.EnumRailDirection var4 = var3.getBlock() == this
				? (BlockRailBase.EnumRailDirection) var3.getValue(this.func_176560_l())
				: null;
	...
	public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock) {
		if (!worldIn.isRemote) {
			BlockRailBase.EnumRailDirection var5 = (BlockRailBase.EnumRailDirection) state
					.getValue(this.func_176560_l());
			boolean var6 = false;
			...
			if (var5 == BlockRailBase.EnumRailDirection.ASCENDING_EAST
					&& !World.doesBlockHaveSolidTopSurface(worldIn, pos.offsetEast())) {
				var6 = true;
			} else if (var5 == BlockRailBase.EnumRailDirection.ASCENDING_WEST
					&& !World.doesBlockHaveSolidTopSurface(worldIn, pos.offsetWest())) {
				var6 = true;
			} else if (var5 == BlockRailBase.EnumRailDirection.ASCENDING_NORTH
					&& !World.doesBlockHaveSolidTopSurface(worldIn, pos.offsetNorth())) {
				var6 = true;
			} else if (var5 == BlockRailBase.EnumRailDirection.ASCENDING_SOUTH
					&& !World.doesBlockHaveSolidTopSurface(worldIn, pos.offsetSouth())) {
				var6 = true;
			}
	...
	protected IBlockState func_176564_a(World worldIn, BlockPos p_176564_2_, IBlockState p_176564_3_,
		...
		return worldIn.isRemote ? p_176564_3_
				: (new BlockRailBase.Rail(worldIn, p_176564_2_, p_176564_3_))
						.func_180364_a(worldIn.isBlockPowered(p_176564_2_), p_176564_4_).func_180362_b();
	}
	...
	public static enum EnumRailDirection implements IStringSerializable {
		NORTH_SOUTH("NORTH_SOUTH", 0, 0, "north_south"), EAST_WEST("EAST_WEST", 1, 1, "east_west"), ASCENDING_EAST(
				"ASCENDING_EAST", 2, 2, "ascending_east"), ASCENDING_WEST("ASCENDING_WEST", 3, 3,
						"ascending_west"), ASCENDING_NORTH("ASCENDING_NORTH", 4, 4, "ascending_north"), ASCENDING_SOUTH(
								"ASCENDING_SOUTH", 5, 5, "ascending_south"), SOUTH_EAST("SOUTH_EAST", 6, 6,
										"south_east"), SOUTH_WEST("SOUTH_WEST", 7, 7, "south_west"), NORTH_WEST(
												"NORTH_WEST", 8, 8,
												"north_west"), NORTH_EAST("NORTH_EAST", 9, 9, "north_east");
		...
		private static final BlockRailBase.EnumRailDirection[] $VALUES = new BlockRailBase.EnumRailDirection[] {
	...
	public class Rail {
		...
		public Rail(World worldIn, BlockPos p_i45739_3_, IBlockState p_i45739_4_) {
			...
			BlockRailBase.EnumRailDirection var5 = (BlockRailBase.EnumRailDirection) p_i45739_4_
					.getValue(BlockRailBase.this.func_176560_l());
		...
		private boolean func_180359_a(BlockPos p_180359_1_) {
			return BlockRailBase.func_176562_d(this.field_150660_b, p_180359_1_)
					|| BlockRailBase.func_176562_d(this.field_150660_b, p_180359_1_.offsetUp())
					|| BlockRailBase.func_176562_d(this.field_150660_b, p_180359_1_.offsetDown());
		}
		...
		private BlockRailBase.Rail func_180697_b(BlockPos p_180697_1_) {
			...
			if (BlockRailBase.func_176563_d(var3)) {
				...
				if (BlockRailBase.func_176563_d(var3)) {
					...
					var3 = this.field_150660_b.getBlockState(var2);
					return BlockRailBase.func_176563_d(var3)
							? BlockRailBase.this.new Rail(this.field_150660_b, var2, var3)
							: null;
				}
			}
		}
