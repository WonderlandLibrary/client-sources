...
public class BlockSkull extends BlockContainer {
	...
	protected BlockSkull() {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(field_176418_a, EnumFacing.NORTH)
				.withProperty(field_176417_b, Boolean.valueOf(false)));
	...
	public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ,
		...
		return this.getDefaultState().withProperty(field_176418_a, placer.func_174811_aO()).withProperty(field_176417_b,
	 ...
	 * 
	 * @param chance
	 *            The chance that each Item is actually spawned (1.0 = always, 0.0 =
	 *            never)
	 * @param fortune
	...
	public boolean func_176415_b(World worldIn, BlockPos p_176415_2_, ItemStack p_176415_3_) {
		return p_176415_3_.getMetadata() == 1 && p_176415_2_.getY() >= 2
				&& worldIn.getDifficulty() != EnumDifficulty.PEACEFUL && !worldIn.isRemote
						? this.func_176414_j().func_177681_a(worldIn, p_176415_2_) != null
						: false;
	}
			...
			if (var5 != null) {
				...
				for (var6 = 0; var6 < 3; ++var6) {
					...
					worldIn.setBlockState(var7.getPos(),
							var7.func_177509_a().withProperty(field_176417_b, Boolean.valueOf(true)), 2);
				}
				...
				var14.setLocationAndAngles((double) var15.getX() + 0.5D, (double) var15.getY() + 0.55D,
						(double) var15.getZ() + 0.5D,
				...
				var14.func_82206_m();
				Iterator var9 = worldIn.getEntitiesWithinAABB(EntityPlayer.class,
				...
				for (var16 = 0; var16 < 120; ++var16) {
					worldIn.spawnParticle(EnumParticleTypes.SNOWBALL, (double) var12.getX() + worldIn.rand.nextDouble(),
							(double) (var12.getY() - 2) + worldIn.rand.nextDouble() * 3.9D,
							(double) var12.getZ() + worldIn.rand.nextDouble(), 0.0D, 0.0D, 0.0D, new int[0]);
				}
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(field_176418_a, EnumFacing.getFront(meta & 7))
				.withProperty(field_176417_b, Boolean.valueOf((meta & 8) > 0));
	}
	...
	protected BlockPattern func_176414_j() {
		if (this.field_176420_N == null) {
			this.field_176420_N = FactoryBlockPattern.start().aisle(new String[] { "   ", "###", "~#~" })
	...
	protected BlockPattern func_176416_l() {
		if (this.field_176421_O == null) {
			this.field_176421_O = FactoryBlockPattern.start().aisle(new String[] { "^^^", "###", "~#~" })
					.where('#', BlockWorldState.hasState(BlockStateHelper.forBlock(Blocks.soul_sand)))
