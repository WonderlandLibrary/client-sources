...
public class BlockRedstoneComparator extends BlockRedstoneDiode implements ITileEntityProvider {
	...
	public BlockRedstoneComparator(boolean p_i45399_1_) {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(AGE, EnumFacing.NORTH)
				.withProperty(field_176464_a, Boolean.valueOf(false))
	...
	private int func_176460_j(World worldIn, BlockPos p_176460_2_, IBlockState p_176460_3_) {
		return p_176460_3_.getValue(field_176463_b) == BlockRedstoneComparator.Mode.SUBTRACT
				? Math.max(this.func_176397_f(worldIn, p_176460_2_, p_176460_3_)
						- this.func_176407_c(worldIn, p_176460_2_, p_176460_3_), 0)
				: this.func_176397_f(worldIn, p_176460_2_, p_176460_3_);
	}
	...
	private EntityItemFrame func_176461_a(World worldIn, final EnumFacing p_176461_2_, BlockPos p_176461_3_) {
		List var4 = worldIn.func_175647_a(EntityItemFrame.class,
				new AxisAlignedBB((double) p_176461_3_.getX(), (double) p_176461_3_.getY(), (double) p_176461_3_.getZ(),
						(double) (p_176461_3_.getX() + 1), (double) (p_176461_3_.getY() + 1),
						(double) (p_176461_3_.getZ() + 1)),
				new Predicate() {
	...
	protected void func_176398_g(World worldIn, BlockPos p_176398_2_, IBlockState p_176398_3_) {
		if (!worldIn.isBlockTickPending(p_176398_2_, this)) {
			...
			if (var4 != var6
					|| this.func_176406_l(p_176398_3_) != this.func_176404_e(worldIn, p_176398_2_, p_176398_3_)) {
	...
	public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		if (this.isRepeaterPowered) {
			worldIn.setBlockState(pos, this.func_180675_k(state).withProperty(field_176464_a, Boolean.valueOf(true)),
					4);
		}
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(AGE, EnumFacing.getHorizontal(meta))
				.withProperty(field_176464_a, Boolean.valueOf((meta & 8) > 0)).withProperty(field_176463_b,
	...
	public static enum Mode implements IStringSerializable {
		...
		private static final BlockRedstoneComparator.Mode[] $VALUES = new BlockRedstoneComparator.Mode[] { COMPARE,
				SUBTRACT };
