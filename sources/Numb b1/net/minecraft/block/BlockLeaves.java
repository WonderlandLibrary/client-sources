				...
				for (int var10 = -var4; var10 <= var4; ++var10) {
					for (int var11 = -var4; var11 <= var4; ++var11) {
						...
						if (var13.getBlock().getMaterial() == Material.leaves
								&& !((Boolean) var13.getValue(field_176236_b)).booleanValue()) {
	...
	public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		if (!worldIn.isRemote) {
			if (((Boolean) state.getValue(field_176236_b)).booleanValue()
					&& ((Boolean) state.getValue(field_176237_a)).booleanValue()) {
				byte var5 = 4;
				int var6 = var5 + 1;
				int var7 = pos.getX();
				int var8 = pos.getY();
							...
							for (var15 = -var5; var15 <= var5; ++var15) {
								...
								if (var16 != Blocks.log && var16 != Blocks.log2) {
									if (var16.getMaterial() == Material.leaves) {
										this.field_150128_a[(var13 + var12) * var11 + (var14 + var12) * var10 + var15
												+ var12] = -2;
									} else {
										this.field_150128_a[(var13 + var12) * var11 + (var14 + var12) * var10 + var15
												+ var12] = -1;
						...
						for (var14 = -var5; var14 <= var5; ++var14) {
							for (var15 = -var5; var15 <= var5; ++var15) {
								for (int var17 = -var5; var17 <= var5; ++var17) {
									if (this.field_150128_a[(var14 + var12) * var11 + (var15 + var12) * var10 + var17
											+ var12] == var13 - 1) {
										if (this.field_150128_a[(var14 + var12 - 1) * var11 + (var15 + var12) * var10
												+ var17 + var12] == -2) {
											this.field_150128_a[(var14 + var12 - 1) * var11 + (var15 + var12) * var10
													+ var17 + var12] = var13;
										}
										...
										if (this.field_150128_a[(var14 + var12) * var11 + (var15 + var12 - 1) * var10
												+ var17 + var12] == -2) {
											this.field_150128_a[(var14 + var12) * var11 + (var15 + var12 - 1) * var10
													+ var17 + var12] = var13;
										}
										...
										if (this.field_150128_a[(var14 + var12) * var11 + (var15 + var12) * var10
												+ (var17 + var12 - 1)] == -2) {
											this.field_150128_a[(var14 + var12) * var11 + (var15 + var12) * var10
													+ (var17 + var12 - 1)] = var13;
										}
