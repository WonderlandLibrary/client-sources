...
public class BlockRedstoneOre extends Block {
	...
	private void spawnRedstoneParticles(World worldIn, BlockPos p_180691_2_) {
		...
		for (int var6 = 0; var6 < 6; ++var6) {
			...
			if (var7 < (double) p_180691_2_.getX() || var7 > (double) (p_180691_2_.getX() + 1) || var9 < 0.0D
					|| var9 > (double) (p_180691_2_.getY() + 1) || var11 < (double) p_180691_2_.getZ()
					|| var11 > (double) (p_180691_2_.getZ() + 1)) {
