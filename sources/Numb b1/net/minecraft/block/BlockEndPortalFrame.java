...
public class BlockEndPortalFrame extends Block {
	...
	public BlockEndPortalFrame() {
		super(Material.rock);
		this.setDefaultState(this.blockState.getBaseState().withProperty(field_176508_a, EnumFacing.NORTH)
				.withProperty(field_176507_b, Boolean.valueOf(false)));
	}
	...
	public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ,
		...
		return this.getDefaultState().withProperty(field_176508_a, placer.func_174811_aO().getOpposite())
				.withProperty(field_176507_b, Boolean.valueOf(false));
	}
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(field_176507_b, Boolean.valueOf((meta & 4) != 0))
