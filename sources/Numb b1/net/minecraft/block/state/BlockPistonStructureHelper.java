...
public class BlockPistonStructureHelper {
	...
	public BlockPistonStructureHelper(World worldIn, BlockPos p_i45664_2_, EnumFacing p_i45664_3_,
			boolean p_i45664_4_) {
	...
	public boolean func_177253_a() {
		...
		if (!BlockPistonBase.func_180696_a(var1, this.field_177261_a, this.field_177260_c, this.field_177257_d,
				false)) {
			...
			for (int var2 = 0; var2 < this.field_177258_e.size(); ++var2) {
				...
				if (this.field_177261_a.getBlockState(var3).getBlock() == Blocks.slime_block
						&& !this.func_177250_b(var3)) {
					return false;
				}
			}
		...
		if (var2.getMaterial() == Material.air) {
			...
			if (var3 + this.field_177258_e.size() > 12) {
				...
				while (var2 == Blocks.slime_block) {
					...
					if (var2.getMaterial() == Material.air || !BlockPistonBase.func_180696_a(var2, this.field_177261_a,
							var4, this.field_177257_d, false) || var4.equals(this.field_177259_b)) {
						break;
					}
				...
				while (true) {
					...
					if (var7 > -1) {
						...
						for (int var8 = 0; var8 <= var7 + var10; ++var8) {
							...
							if (this.field_177261_a.getBlockState(var9).getBlock() == Blocks.slime_block
									&& !this.func_177250_b(var9)) {
								return false;
							}
						}
					...
					if (!BlockPistonBase.func_180696_a(var2, this.field_177261_a, var6, this.field_177257_d, true)
							|| var6.equals(this.field_177259_b)) {
						return false;
					}
