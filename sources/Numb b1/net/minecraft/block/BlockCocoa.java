...
public class BlockCocoa extends BlockDirectional implements IGrowable {
	...
	public BlockCocoa() {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(AGE, EnumFacing.NORTH)
				.withProperty(field_176501_a, Integer.valueOf(0)));
	...
	public void setBlockBoundsBasedOnState(IBlockAccess access, BlockPos pos) {
		...
		case 1:
			this.setBlockBounds((8.0F - var8) / 16.0F, (12.0F - (float) var7) / 16.0F, (15.0F - (float) var6) / 16.0F,
					(8.0F + var8) / 16.0F, 0.75F, 0.9375F);
			break;

		case 2:
			this.setBlockBounds((8.0F - var8) / 16.0F, (12.0F - (float) var7) / 16.0F, 0.0625F, (8.0F + var8) / 16.0F,
					0.75F, (1.0F + (float) var6) / 16.0F);
			break;

		case 3:
			this.setBlockBounds(0.0625F, (12.0F - (float) var7) / 16.0F, (8.0F - var8) / 16.0F,
					(1.0F + (float) var6) / 16.0F, 0.75F, (8.0F + var8) / 16.0F);
			break;

		case 4:
			this.setBlockBounds((15.0F - (float) var6) / 16.0F, (12.0F - (float) var7) / 16.0F, (8.0F - var8) / 16.0F,
					0.9375F, 0.75F, (8.0F + var8) / 16.0F);
		}
	}
	...
	public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ,
		...
		return this.getDefaultState().withProperty(AGE, facing.getOpposite()).withProperty(field_176501_a,
				Integer.valueOf(0));
	}
	...
	public void grow(World worldIn, Random p_176474_2_, BlockPos p_176474_3_, IBlockState p_176474_4_) {
		worldIn.setBlockState(p_176474_3_, p_176474_4_.withProperty(field_176501_a,
				Integer.valueOf(((Integer) p_176474_4_.getValue(field_176501_a)).intValue() + 1)), 2);
	}
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(AGE, EnumFacing.getHorizontal(meta)).withProperty(field_176501_a,
