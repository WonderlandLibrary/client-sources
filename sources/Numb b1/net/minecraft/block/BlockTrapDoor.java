...
public class BlockTrapDoor extends Block {
	...
	protected BlockTrapDoor(Material p_i45434_1_) {
		super(p_i45434_1_);
		this.setDefaultState(this.blockState.getBaseState().withProperty(field_176284_a, EnumFacing.NORTH)
				.withProperty(field_176283_b, Boolean.valueOf(false))
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (this.blockMaterial == Material.iron) {
			...
			worldIn.playAuxSFXAtEntity(playerIn,
					((Boolean) state.getValue(field_176283_b)).booleanValue() ? 1003 : 1006, pos, 0);
			return true;
		}
	}
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(field_176284_a, func_176281_b(meta))
				.withProperty(field_176283_b, Boolean.valueOf((meta & 4) != 0)).withProperty(field_176285_M,
