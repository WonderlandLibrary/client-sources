...
public class ReflectionUtils {
		...
		for (Field f : fields) {
			if (f.getType().equals(typeOfField)) {
				try {
					...
					throw new RuntimeException("WorldDownloader: Couldn't steal Field of type \"" + typeOfField
							+ "\" from class \"" + typeOfClass + "\" !", e);
				}
			}
		}

		throw new RuntimeException("WorldDownloader: Couldn't steal Field of type \"" + typeOfField + "\" from class \""
				+ typeOfClass + "\" !");
	}
	...
	public static <T> T stealAndGetField(Object object, Class<T> typeOfField) {
		...
		try {
			...
			throw new RuntimeException("WorldDownloader: Couldn't get Field of type \"" + typeOfField
	...
	public static void stealAndSetField(Object object, Class<?> typeOfField, Object value) {
		...
		try {
			...
			throw new RuntimeException("WorldDownloader: Couldn't set Field of type \"" + typeOfField
					+ "\" from object \"" + object + "\" to " + value + "!", e);
		}
	}
