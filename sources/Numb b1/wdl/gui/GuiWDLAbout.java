...
public class GuiWDLAbout extends GuiScreen {
	...
	@Override
	public void initGui() {
		buttonList.add(new GuiButton(0, (this.width / 2) - 155, 18, 150, 20, I18n.format("wdl.gui.about.extensions")));
		buttonList.add(new GuiButton(1, (this.width / 2) + 5, 18, 150, 20, I18n.format("wdl.gui.about.debugInfo")));
		buttonList.add(new GuiButton(2, (this.width / 2) - 100, this.height - 29, I18n.format("gui.done")));
		...
		list.addBlankLine();
		list.addLine(I18n.format("wdl.gui.about.version", wdlVersion, mcVersion));
		list.addBlankLine();
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		if (button.id == 0) {
			...
			button.displayString = I18n.format("wdl.gui.about.debugInfo.copied");
		} else if (button.id == 2) {
			// Done
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		drawCenteredString(fontRendererObj, I18n.format("wdl.gui.about.title"), width / 2, 2, 0xFFFFFF);
	}
}
