...
public class GuiShaders extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButtonEnumShaderOption(EnumShaderOption.ANTIALIASING, btnX, 0 * stepY + baseY,
				btnWidth, btnHeight));
		this.buttonList.add(new GuiButtonEnumShaderOption(EnumShaderOption.NORMAL_MAP, btnX, 1 * stepY + baseY,
				btnWidth, btnHeight));
		this.buttonList.add(new GuiButtonEnumShaderOption(EnumShaderOption.SPECULAR_MAP, btnX, 2 * stepY + baseY,
				btnWidth, btnHeight));
		this.buttonList.add(new GuiButtonEnumShaderOption(EnumShaderOption.RENDER_RES_MUL, btnX, 3 * stepY + baseY,
				btnWidth, btnHeight));
		this.buttonList.add(new GuiButtonEnumShaderOption(EnumShaderOption.SHADOW_RES_MUL, btnX, 4 * stepY + baseY,
				btnWidth, btnHeight));
		this.buttonList.add(new GuiButtonEnumShaderOption(EnumShaderOption.HAND_DEPTH_MUL, btnX, 5 * stepY + baseY,
				btnWidth, btnHeight));
		this.buttonList.add(new GuiButtonEnumShaderOption(EnumShaderOption.OLD_LIGHTING, btnX, 6 * stepY + baseY,
				btnWidth, btnHeight));
		int btnFolderWidth = Math.min(150, shaderListWidth / 2 - 10);
		this.buttonList.add(new GuiButton(201, shaderListWidth / 4 - btnFolderWidth / 2, this.height - 25,
				btnFolderWidth, btnHeight, Lang.get("of.options.shaders.shadersFolder")));
		this.buttonList.add(new GuiButton(202, shaderListWidth / 4 * 3 - btnFolderWidth / 2, this.height - 25,
				btnFolderWidth, btnHeight, I18n.format("gui.done", new Object[0])));
		this.buttonList.add(new GuiButton(203, btnX, this.height - 25, btnWidth, btnHeight,
		...
		if (button.enabled) {
			if (button instanceof GuiButtonEnumShaderOption) {
				...
				case 201:
					switch (getOSType()) {
					case 1:
						String gbeso = String.format("cmd.exe /C start \"Open file\" \"%s\"",
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		String info = "OpenGL: " + Shaders.glVersionString + ", " + Shaders.glVendorString + ", "
