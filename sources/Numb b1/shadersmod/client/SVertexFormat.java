...
public class SVertexFormat {
	...
	public static VertexFormat makeDefVertexFormatBlock() {
		...
		vf.func_177349_a(new VertexFormatElement(0, VertexFormatElement.EnumType.FLOAT,
				VertexFormatElement.EnumUseage.POSITION, 3));
		vf.func_177349_a(new VertexFormatElement(0, VertexFormatElement.EnumType.UBYTE,
		...
		vf.func_177349_a(new VertexFormatElement(0, VertexFormatElement.EnumType.BYTE,
				VertexFormatElement.EnumUseage.NORMAL, 3));
		vf.func_177349_a(new VertexFormatElement(0, VertexFormatElement.EnumType.BYTE,
				VertexFormatElement.EnumUseage.PADDING, 1));
		vf.func_177349_a(new VertexFormatElement(0, VertexFormatElement.EnumType.FLOAT,
				VertexFormatElement.EnumUseage.PADDING, 2));
		vf.func_177349_a(new VertexFormatElement(0, VertexFormatElement.EnumType.SHORT,
				VertexFormatElement.EnumUseage.PADDING, 4));
		vf.func_177349_a(new VertexFormatElement(0, VertexFormatElement.EnumType.SHORT,
				VertexFormatElement.EnumUseage.PADDING, 4));
		return vf;
	}
