...
public class RandomMobsRule {
	...
	public RandomMobsRule(ResourceLocation baseResLoc, int[] skins, int[] weights, BiomeGenBase[] biomes,
	...
	public boolean matches(EntityLiving el) {
		return !Matches.biome(el.spawnBiome, this.biomes) ? false
				: (this.heights != null && el.spawnPosition != null ? this.heights.isInRange(el.spawnPosition.getY())
						: true);
	}
