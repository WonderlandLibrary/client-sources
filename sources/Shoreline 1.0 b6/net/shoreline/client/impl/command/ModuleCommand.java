...
public class ModuleCommand extends Command {
    //
    @OptionalArgument
    Argument<Config<?>> configArgument = new ConfigArgument("Config", "The setting to configure");
    @OptionalArgument
    Argument<String> valueArgument = new StringArgument("Value", "The new value to set the config");
    //
