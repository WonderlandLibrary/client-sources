...
public class Main
{
    public static void main(String[] p_main_0_)
    {
        ...
        OptionSpec<String> optionspec11 = optionparser.accepts("accessToken").withRequiredArg().defaultsTo("none");
        OptionSpec<String> optionspec12 = optionparser.accepts("version").withRequiredArg().defaultsTo("1.8");
