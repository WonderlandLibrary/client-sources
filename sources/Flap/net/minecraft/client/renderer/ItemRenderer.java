...
public class ItemRenderer
{
    ...
    public void updateEquippedItem()
    {
        ...
        EntityPlayer entityplayer = this.mc.thePlayer;
        ItemStack itemstack = Flap.instance.getSlotSpoofHandler().getSpoofedStack();
        boolean flag = false;
        ...
        if (this.itemToRender != null && itemstack != null)
        {
            if (!this.itemToRender.getIsItemStackEqual(itemstack))
            {
                ...
                {
                    boolean flag1 = Reflector.callBoolean(this.itemToRender.getItem(), Reflector.ForgeItem_shouldCauseReequipAnimation, new Object[] {this.itemToRender, itemstack, Boolean.valueOf(this.equippedItemSlot != Flap.instance.getSlotSpoofHandler().getSpoofedSlot())});

                    if (!flag1)
                    {
                        this.itemToRender = itemstack;
                        this.equippedItemSlot = Flap.instance.getSlotSpoofHandler().getSpoofedSlot();
                        return;
                    }
                }
