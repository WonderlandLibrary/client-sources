...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        {
            Flap.instance.getEventManager().post(new UpdateEvent());
            super.onUpdate();
            ...
            else
            {
                ...
                Flap.instance.getEventManager().post(new PostMotionEvent());
            }
        }
    }
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        Flap.instance.getEventManager().post(event);
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        Flap.instance.getEventManager().post(actionEvent);
        ...
        Flap.instance.getEventManager().post(motionEvent);
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            double d3 = (double)(motionEvent.getYaw() - this.lastReportedYaw);
            double d4 = (double)(motionEvent.getPitch() - this.lastReportedPitch);
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isSprinting() && (((this.movementInput.moveForward < f || mc.thePlayer.isUsingItem()) && (!noslowAllowSprint || mc.thePlayer.moveForward <= 0.1F)) || this.isCollidedHorizontally || !flag3))
        {
            this.setSprinting(false);
        }
