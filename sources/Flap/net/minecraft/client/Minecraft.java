...
import vestige.module.impl.combat.DelayRemover;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws Exception {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(Flap.instance.getMainMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(Flap.instance.getMainMenu());
        }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = Flap.instance.getMainMenu();
        }
    ...
    private void runGameLoop() throws IOException
    {
        ...
        for (int j = 0; j < this.timer.elapsedTicks; ++j)
        {
            if(Minecraft.getMinecraft().thePlayer != null) {
                ...
                if(j == 0) {
                    Tickbase tickBase = Flap.instance.getModuleManager().getModule(Tickbase.class);
    ...
    public void clickMouse()
    {
        if (this.leftClickCounter <= 0)
        {
            ...
            if (this.objectMouseOver == null)
            {
                ...
                if (this.playerController.isNotCreative() && !Flap.instance.getModuleManager().getModule(DelayRemover.class).isEnabled())
                {
            ...
            else
            {
                switch (this.objectMouseOver.typeOfHit)
                {
                    ...
                    case BLOCK:
                        ...
                        Killaura killauraModule = Flap.instance.getModuleManager().getModule(Killaura.class);
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            Flap.instance.getEventManager().post(new TickEvent());
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                        Flap.instance.getEventManager().post(new KeyPressEvent(k));
