...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityMovement(S14PacketEntity packetIn)
    {
        ...
        if (entity != null) {
            ...
            Flap.instance.getEventManager().post(new EntityMoveEvent(entity));
        }
    }
    ...
    public void onDisconnect(IChatComponent reason)
    {
        ...
        {
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(Flap.instance.getMainMenu()), "disconnect.lost", reason));
        }
    }
    ...
    public void handleEntityProperties(S20PacketEntityProperties packetIn)
    {
        ...
        if(entity == Minecraft.getMinecraft().thePlayer) {
            //LogUtil.addChatMessage("Received S20 : " + Minecraft.getMinecraft().thePlayer.ticksExisted);

            for(S20PacketEntityProperties.Snapshot attribute : packetIn.func_149441_d()) {
                //LogUtil.addChatMessage("Attribute : " + attribute.func_151409_a() + " " + attribute.func_151410_b());

                for(AttributeModifier modifier : attribute.func_151408_c()) {
                    LogUtil.addChatMessage("Modifier : " + modifier.getOperation() + " " + modifier.getAmount());
                }
            }
