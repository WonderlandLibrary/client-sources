    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            if(this == Minecraft.getMinecraft().thePlayer) {
                Safewalk safewalkModule = Flap.instance.getModuleManager().getModule(Safewalk.class);

                if(safewalkModule.isEnabled()) {
                    if(safewalkModule.offGround.isEnabled()) {
                        flag = true;
                    } else {
                        flag = this.onGround;
                    }
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z))
            {
                ...
                if(isPlayer) {
                    Flap.instance.getEventManager().post(new PostStepEvent((float) (this.getEntityBoundingBox().minY - this.posY)));
                }
            }
