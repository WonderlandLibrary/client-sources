...
public class TextFielde extends Gui {
   ...
   public TextFielde(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
      this.id = componentId;
   ...
   public void drawTextBox() {
      if (this.getVisible()) {
         Color rectColor = new Color(100, 100, 100, 50);
         rectColor = flap$interpolateColorC(rectColor, ColorUtil2.brighter(rectColor, 0.4F), -1.0F);
         this.ravenXD$hoverValue = (int)Math.max((double)this.ravenXD$hoverValue - 600.0D / (double)Minecraft.getDebugFPS(), 102.0D);
         if (this.getEnableBackgroundDrawing()) {
            RenderUtils2.drawRoundOutline((double)(this.xPosition - 1), (double)(this.yPosition - 1), (double)(this.width + 1), (double)(this.height + 1), 6.5D, 0.0D, new Color(0, 0, 0, 0), new Color(100, 100, 100, 100));
            RenderUtils2.drawRoundOutline((double)(this.xPosition - 1), (double)(this.yPosition - 1), (double)(this.width + 1), (double)(this.height + 1), 6.5D, 1.5D, rectColor, new Color(30, 30, 30, 0));
         }
         ...
         if (s.length() > 0) {
            ...
            j1 = (int)this.productSans.drawStringWithShadow(s1, (float)l, (float)i1, i);
         }
         ...
         if (s.length() > 0 && flag && j < s.length()) {
            int var10000 = (int)this.productSans.drawStringWithShadow(s.substring(j), (float)j1, (float)i1, i);
         }
         ...
         if (flag1) {
            if (flag2) {
               ...
               this.productSans.drawStringWithShadow("_", (float)k1, (float)i1, i);
            }
         }
   ...
   private static void $$$reportNull$$$0(int var0) {
      ...
      var10001[1] = "vestige/ui/menu/components/TextFielde";
