...
public class ShaderUtil {
   ...
   public ShaderUtil(String fragmentShaderLocation) throws IOException {
      int program = GL20.glCreateProgram();
      GL20.glAttachShader(program, this.createShader(ShaderUtil.class.getResourceAsStream("/assets/minecraft/flap/shader/passthrough.vsh"), 35633));
      GL20.glAttachShader(program, this.createShader(ShaderUtil.class.getResourceAsStream(fragmentShaderLocation), 35632));
