...
final class LayerIIIDecoder implements FrameDecoder
{
    ...
    public LayerIIIDecoder(final SoundStream stream0, final Frame header0, final SynthesisFilter filtera, final SynthesisFilter filterb, final Obuffer buffer0, final int which_ch0) {
        this.CheckSumHuff = 0;
