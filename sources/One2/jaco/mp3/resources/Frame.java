...
public final class Frame
{
    ...
    void read_header(final SoundStream stream, final Crc16[] crcp) throws BitstreamException {
        boolean sync = false;
        int headerstring;
        do {
    ...
    public int frequency() {
        return Frame.frequencies[this.h_version][this.h_sample_frequency];
    }
    ...
    public int calculate_framesize() {
        if (this.h_layer == 1) {
            this.framesize = 12 * Frame.bitrates[this.h_version][0][this.h_bitrate_index] / Frame.frequencies[this.h_version][this.h_sample_frequency];
            ...
            this.framesize = 144 * Frame.bitrates[this.h_version][this.h_layer - 1][this.h_bitrate_index] / Frame.frequencies[this.h_version][this.h_sample_frequency];
    ...
    public String bitrate_string() {
        ...
        return Frame.bitrate_str[this.h_version][this.h_layer - 1][this.h_bitrate_index];
    }
    ...
    public int bitrate() {
        ...
        return Frame.bitrates[this.h_version][this.h_layer - 1][this.h_bitrate_index];
    }
