...
public class PasswordTextField extends Gui
{
    ...
    public PasswordTextField(final FontRenderer par1FontRenderer, final int par2, final int par3, final int par4, final int par5) {
        this.field_146216_j = "";
    ...
    private void func_146188_c(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
        ...
        var7.addVertex((double)p_146188_1_, (double)p_146188_4_, 0.0);
        var7.addVertex((double)p_146188_3_, (double)p_146188_4_, 0.0);
        var7.addVertex((double)p_146188_3_, (double)p_146188_2_, 0.0);
        var7.addVertex((double)p_146188_1_, (double)p_146188_2_, 0.0);
        var6.draw();
        GL11.glDisable(3058);
        GL11.glEnable(3553);
    }
