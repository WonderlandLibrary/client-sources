...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public static final Random field_175374_h = new Random();
    ...
    public void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        this.buttonList.add(this.field_175372_K = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("Login", new Object[0])));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        if (Twelve.getInstance().ghost) {
            ...
            this.drawString(this.fontRendererObj, var10, 2.0f, this.height - 10, -1);
