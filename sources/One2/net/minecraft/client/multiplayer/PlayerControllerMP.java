...
public class PlayerControllerMP
{
    ...
    {
        Block var3;
        EventClickBlock event = new EventClickBlock(p_180511_1_, p_180511_2_);
    ...
    {
        EventReach event = new EventReach(this.currentGameType.isCreative() ? 5.0f : 4.5f);
        EventManager.call(event);
    ...
    public void attackEntity(EntityPlayer playerIn, Entity targetEntity) {
        ...
        EventPostAttack postEvent = new EventPostAttack(playerIn, targetEntity);
