...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void func_175068_a(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        this.renderEvent(partialTicks, pass);
    ...
    private void renderEvent(float par1, int par2) {
        this.enableGL3D();
        GL11.glPushMatrix();
        boolean saveBobbing = this.mc.gameSettings.viewBobbing;
        this.mc.gameSettings.viewBobbing = false;
        this.setupCameraTransform(par1, par2);
        EventRender event = new EventRender(par2);
        EventManager.call(event);
        this.mc.gameSettings.viewBobbing = saveBobbing;
        GL11.glPopMatrix();
        this.disableGL3D();
    }
    
    public void enableGL3D() {
