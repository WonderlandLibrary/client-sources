...
ITransformation
{
    ...
    static {
        ...
        for (ModelRotation var3 : ModelRotation.values()) {
    ...
    private ModelRotation(String p_i46087_1_, int p_i46087_2_, int p_i46087_3_, int p_i46087_4_) {
        this.field_177545_r = ModelRotation.func_177521_b(p_i46087_3_, p_i46087_4_);
        this.field_177544_s = new Matrix4d();
        Matrix4d var5 = new Matrix4d();
        var5.setIdentity();
        var5.setRotation(new AxisAngle4d(1.0, 0.0, 0.0, (double)((float)(-p_i46087_3_) * ((float)Math.PI / 180))));
        this.field_177543_t = MathHelper.abs_int(p_i46087_3_ / 90);
        Matrix4d var6 = new Matrix4d();
        var6.setIdentity();
        var6.setRotation(new AxisAngle4d(0.0, 1.0, 0.0, (double)((float)(-p_i46087_4_) * ((float)Math.PI / 180))));
