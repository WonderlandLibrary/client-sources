...
implements IBakedModel {
    ...
    public static class Builder {
        private final List field_177656_a = Lists.newArrayList();
        private final List field_177654_b = Lists.newArrayListWithCapacity((int)6);
        ...
        private void func_177649_a(IBakedModel p_177649_1_, TextureAtlasSprite p_177649_2_, EnumFacing p_177649_3_) {
            for (BakedQuad var5 : p_177649_1_.func_177551_a(p_177649_3_)) {
        ...
        private void func_177647_a(IBakedModel p_177647_1_, TextureAtlasSprite p_177647_2_) {
            for (BakedQuad var4 : p_177647_1_.func_177550_a()) {
