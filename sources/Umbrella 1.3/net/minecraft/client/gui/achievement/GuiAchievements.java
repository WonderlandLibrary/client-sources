...
implements IProgressMeter {
    ...
    protected void drawTitle() {
        ...
        this.fontRendererObj.drawString(I18n.format("gui.achievements", new Object[0]), var1 + 15, var2 + 5, 0x404040);
    }
    ...
    protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
        ...
        for (var22 = 0; var22 < AchievementList.achievementList.size(); ++var22) {
            ...
            GuiAchievements.drawHorizontalLine(var24, var37, var25, var31);
            GuiAchievements.drawVerticalLine(var37, var25, var40, var31);
            if (var24 > var37) {
