...
implements GuiYesNoCallback {
    ...
    @Override
    public void initGui() {
        Client.getDiscordRP().update("Multiplayer Menu", "");
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            GuiListExtended.IGuiListEntry iGuiListEntry = var2 = this.serverListSelector.func_148193_k() < 0 ? null : this.serverListSelector.getListEntry(this.serverListSelector.func_148193_k());
    ...
    public void confirmClicked(boolean result, int id) {
        ...
        GuiListExtended.IGuiListEntry iGuiListEntry = var3 = this.serverListSelector.func_148193_k() < 0 ? null : this.serverListSelector.getListEntry(this.serverListSelector.func_148193_k());
    ...
    public void connectToSelected() {
        ...
        GuiListExtended.IGuiListEntry iGuiListEntry = var1 = this.serverListSelector.func_148193_k() < 0 ? null : this.serverListSelector.getListEntry(this.serverListSelector.func_148193_k());
