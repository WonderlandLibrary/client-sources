...
extends Gui {
    ...
    protected void drawLabelBackground(Minecraft mcIn, int p_146160_2_, int p_146160_3_) {
        if (this.labelBgEnabled) {
            ...
            GuiLabel.drawRect(var6, var7, var6 + var4, var7 + var5, this.field_146169_o);
            GuiLabel.drawHorizontalLine(var6, var6 + var4, var7, this.field_146166_p);
            GuiLabel.drawHorizontalLine(var6, var6 + var4, var7 + var5, this.field_146165_q);
            GuiLabel.drawVerticalLine(var6, var7, var7 + var5, this.field_146166_p);
            GuiLabel.drawVerticalLine(var6 + var4, var7, var7 + var5, this.field_146165_q);
        }
    }
}
