...
public class JsonBlendingMode {
    ...
    public static JsonBlendingMode func_148110_a(JsonObject p_148110_0_) {
        ...
        boolean var6 = true;
        boolean var7 = false;
        if (JsonUtils.jsonObjectFieldTypeIsString(p_148110_0_, "func") && (var1 = JsonBlendingMode.func_148108_a(p_148110_0_.get("func").getAsString())) != 32774) {
            var6 = false;
        }
        if (JsonUtils.jsonObjectFieldTypeIsString(p_148110_0_, "srcrgb") && (var2 = JsonBlendingMode.func_148107_b(p_148110_0_.get("srcrgb").getAsString())) != 1) {
            var6 = false;
        }
        if (JsonUtils.jsonObjectFieldTypeIsString(p_148110_0_, "dstrgb") && (var3 = JsonBlendingMode.func_148107_b(p_148110_0_.get("dstrgb").getAsString())) != 0) {
            var6 = false;
        }
        if (JsonUtils.jsonObjectFieldTypeIsString(p_148110_0_, "srcalpha")) {
            var4 = JsonBlendingMode.func_148107_b(p_148110_0_.get("srcalpha").getAsString());
            if (var4 != 1) {
                var6 = false;
            }
            var7 = true;
        ...
        if (JsonUtils.jsonObjectFieldTypeIsString(p_148110_0_, "dstalpha")) {
            var5 = JsonBlendingMode.func_148107_b(p_148110_0_.get("dstalpha").getAsString());
            if (var5 != 0) {
                var6 = false;
            }
            var7 = true;
    ...
    private static int func_148107_b(String p_148107_0_) {
        ...
        return (var1 = var1.replaceAll("minus", "-")).equals("0") ? 0 : (var1.equals("1") ? 1 : (var1.equals("srccolor") ? 768 : (var1.equals("1-srccolor") ? 769 : (var1.equals("dstcolor") ? 774 : (var1.equals("1-dstcolor") ? 775 : (var1.equals("srcalpha") ? 770 : (var1.equals("1-srcalpha") ? 771 : (var1.equals("dstalpha") ? 772 : (var1.equals("1-dstalpha") ? 773 : -1)))))))));
    }
}
