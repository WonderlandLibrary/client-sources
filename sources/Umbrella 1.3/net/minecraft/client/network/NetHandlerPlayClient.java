...
implements INetHandlerPlayClient {
    ...
    public void handleEntityVelocity(S12PacketEntityVelocity packetIn) {
        ...
        if (var2 != null) {
            var2.setVelocity((double)packetIn.getMotionX() / 8000.0, (double)packetIn.getMotionY() / 8000.0, (double)packetIn.getMotionZ() / 8000.0);
        }
    }
                    ...
                    NetHandlerPlayClient.this.gameController.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback(){
                        ...
                        public void confirmClicked(boolean result, int id) {
                            ...
                            if (result) {
                                ...
                                Futures.addCallback((ListenableFuture)NetHandlerPlayClient.this.gameController.getResourcePackRepository().func_180601_a(var2, var3), (FutureCallback)new FutureCallback(){
