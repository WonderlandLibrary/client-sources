...
implements IResourceManagerReloadListener {
    ...
    public void func_175020_a(IBlockState p_175020_1_, BlockPos p_175020_2_, TextureAtlasSprite p_175020_3_, IBlockAccess p_175020_4_) {
        ...
        if (var6 == 3) {
            IBakedModel var7 = this.field_175028_a.func_178125_b(p_175020_1_ = var5.getActualState(p_175020_1_, p_175020_4_, p_175020_2_));
            if (Reflector.ISmartBlockModel.isInstance(var7)) {
                IBlockState var15 = (IBlockState)Reflector.call(var5, Reflector.ForgeBlock_getExtendedState, p_175020_1_, p_175020_4_, p_175020_2_);
                for (EnumWorldBlockLayer layer : EnumWorldBlockLayer.values()) {
                    if (!Reflector.callBoolean(var5, Reflector.ForgeBlock_canRenderInLayer, new Object[]{layer})) continue;
                    Reflector.callVoid(Reflector.ForgeHooksClient_setRenderLayer, new Object[]{layer});
                    IBakedModel targetLayer = (IBakedModel)Reflector.call(var7, Reflector.ISmartBlockModel_handleBlockState, var15);
    ...
    public IBakedModel getModelFromBlockState(IBlockState p_175022_1_, IBlockAccess p_175022_2_, BlockPos p_175022_3_) {
        ...
        if (Reflector.ISmartBlockModel.isInstance(var5)) {
            IBlockState extendedState = (IBlockState)Reflector.call(var4, Reflector.ForgeBlock_getExtendedState, p_175022_1_, p_175022_2_, p_175022_3_);
    ...
    public void func_175016_a(IBlockState p_175016_1_, float p_175016_2_) {
        ...
        if (var3 != -1) {
            switch (var3) {
                ...
                case 3: {
                    IBakedModel var4 = this.func_175017_a(p_175016_1_, null);
