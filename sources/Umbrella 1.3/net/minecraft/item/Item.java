...
public class Item {
    ...
    protected MovingObjectPosition getMovingObjectPositionFromPlayer(World worldIn, EntityPlayer playerIn, boolean useLiquids) {
        ...
        float var13 = MathHelper.cos(-var5 * ((float)Math.PI / 180) - (float)Math.PI);
        float var14 = MathHelper.sin(-var5 * ((float)Math.PI / 180) - (float)Math.PI);
        float var15 = -MathHelper.cos(-var4 * ((float)Math.PI / 180));
        float var16 = MathHelper.sin(-var4 * ((float)Math.PI / 180));
    ...
    public static void registerItems() {
        ...
        Item.registerItemBlock(Blocks.sand, new ItemMultiTexture((Block)Blocks.sand, (Block)Blocks.sand, new Function(){
        ...
        Item.registerItemBlock(Blocks.yellow_flower, new ItemMultiTexture((Block)Blocks.yellow_flower, (Block)Blocks.yellow_flower, new Function(){
        ...
        Item.registerItemBlock(Blocks.red_flower, new ItemMultiTexture((Block)Blocks.red_flower, (Block)Blocks.red_flower, new Function(){
        ...
        Item.registerItemBlock(Blocks.double_plant, new ItemDoublePlant((Block)Blocks.double_plant, (Block)Blocks.double_plant, new Function(){
