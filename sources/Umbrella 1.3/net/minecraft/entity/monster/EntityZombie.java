...
extends EntityMob {
    protected static final IAttribute field_110186_bp = new RangedAttribute(null, "zombie.spawnReinforcements", 0.0, 0.0, 1.0).setDescription("Spawn Reinforcements Chance");
    ...
    protected void func_175456_n() {
        ...
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget((EntityCreature)this, EntityVillager.class, false));
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget((EntityCreature)this, EntityIronGolem.class, true));
    }
    ...
    protected void applyEntityAttributes() {
        ...
        this.getAttributeMap().registerAttribute(field_110186_bp).setBaseValue(this.rand.nextDouble() * (double)0.1f);
    }
    ...
    public void setVillager(boolean p_82229_1_) {
        this.getDataWatcher().updateObject(13, (byte)(p_82229_1_ ? 1 : 0));
    }
        ...
        if (super.attackEntityFrom(source, amount)) {
            ...
            if (var3 != null && this.worldObj.getDifficulty() == EnumDifficulty.HARD && (double)this.rand.nextFloat() < this.getEntityAttribute(field_110186_bp).getAttributeValue()) {
                ...
                for (int var8 = 0; var8 < 50; ++var8) {
                    ...
                    if (!World.doesBlockHaveSolidTopSurface(this.worldObj, new BlockPos(var9, (var10 = var5 + MathHelper.getRandomIntegerInRange(this.rand, 7, 40) * MathHelper.getRandomIntegerInRange(this.rand, -1, 1)) - 1, var11 = var6 + MathHelper.getRandomIntegerInRange(this.rand, 7, 40) * MathHelper.getRandomIntegerInRange(this.rand, -1, 1))) || this.worldObj.getLightFromNeighbors(new BlockPos(var9, var10, var11)) >= 10) continue;
                    var7.setPosition(var9, var10, var11);
                    if (this.worldObj.func_175636_b(var9, var10, var11, 7.0) || !this.worldObj.checkNoEntityCollision(var7.getEntityBoundingBox(), var7) || !this.worldObj.getCollidingBoundingBoxes(var7, var7.getEntityBoundingBox()).isEmpty() || this.worldObj.isAnyLiquid(var7.getEntityBoundingBox())) continue;
                    this.worldObj.spawnEntityInWorld(var7);
                    var7.setAttackTarget(var3);
                    var7.func_180482_a(this.worldObj.getDifficultyForLocation(new BlockPos(var7)), null);
                    this.getEntityAttribute(field_110186_bp).applyModifier(new AttributeModifier("Zombie reinforcement caller charge", -0.05f, 0));
                    var7.getEntityAttribute(field_110186_bp).applyModifier(new AttributeModifier("Zombie reinforcement callee charge", -0.05f, 0));
                    break;
                }
            }
            return true;
    ...
    public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_) {
        ...
        if (p_180482_2_1 instanceof GroupData) {
            ...
            if (var4.field_142048_a) {
                ...
                if ((double)this.worldObj.rand.nextFloat() < 0.05) {
                    List var5 = this.worldObj.func_175647_a(EntityChicken.class, this.getEntityBoundingBox().expand(5.0, 3.0, 5.0), IEntitySelector.field_152785_b);
                    if (!var5.isEmpty()) {
        ...
        if (this.getEquipmentInSlot(4) == null && (var8 = this.worldObj.getCurrentDate()).get(2) + 1 == 10 && var8.get(5) == 31 && this.rand.nextFloat() < 0.25f) {
        ...
        double var9 = this.rand.nextDouble() * 1.5 * (double)var3;
        if (var9 > 1.0) {
            ...
            for (int var3 = (int)this.posX - 4; var3 < (int)this.posX + 4 && var2 < 14; ++var3) {
                for (int var4 = (int)this.posY - 4; var4 < (int)this.posY + 4 && var2 < 14; ++var4) {
                    for (int var5 = (int)this.posZ - 4; var5 < (int)this.posZ + 4 && var2 < 14; ++var5) {
                        ...
                        if (var6 != Blocks.iron_bars && var6 != Blocks.bed) continue;
