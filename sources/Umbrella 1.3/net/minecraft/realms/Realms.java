...
public class Realms {
    ...
    public static String uuidToName(String p_uuidToName_0_) {
        return Minecraft.getMinecraft().getSessionService().fillProfileProperties(new GameProfile(UUIDTypeAdapter.fromString((String)p_uuidToName_0_), null), false).getName();
    }
