...
extends MapGenBase {
    ...
    protected void func_180702_a(long p_180702_1_, int p_180702_3_, int p_180702_4_, ChunkPrimer p_180702_5_, double p_180702_6_, double p_180702_8_, double p_180702_10_, float p_180702_12_, float p_180702_13_, float p_180702_14_, int p_180702_15_, int p_180702_16_, double p_180702_17_) {
        ...
        while (p_180702_15_ < p_180702_16_) {
            double var29 = 1.5 + (double)(MathHelper.sin((float)p_180702_15_ * (float)Math.PI / (float)p_180702_16_) * p_180702_12_ * 1.0f);
            ...
            p_180702_14_ = var28 ? (p_180702_14_ *= 0.92f) : (p_180702_14_ *= 0.7f);
            ...
            if (!var54 && p_180702_15_ == var27 && p_180702_12_ > 1.0f && p_180702_16_ > 0) {
                this.func_180702_a(var25.nextLong(), p_180702_3_, p_180702_4_, p_180702_5_, p_180702_6_, p_180702_8_, p_180702_10_, var25.nextFloat() * 0.5f + 0.5f, p_180702_13_ - 1.5707964f, p_180702_14_ / 3.0f, p_180702_15_, p_180702_16_, 1.0);
                this.func_180702_a(var25.nextLong(), p_180702_3_, p_180702_4_, p_180702_5_, p_180702_6_, p_180702_8_, p_180702_10_, var25.nextFloat() * 0.5f + 0.5f, p_180702_13_ + 1.5707964f, p_180702_14_ / 3.0f, p_180702_15_, p_180702_16_, 1.0);
                return;
            }
            if (var54 || var25.nextInt(4) != 0) {
                ...
                if (p_180702_6_ >= var19 - 16.0 - var29 * 2.0 && p_180702_10_ >= var21 - 16.0 - var29 * 2.0 && p_180702_6_ <= var19 + 16.0 + var29 * 2.0 && p_180702_10_ <= var21 + 16.0 + var29 * 2.0) {
                    int var42;
                    ...
                    for (var42 = var55; !var58 && var42 < var36; ++var42) {
                        for (int var43 = var57; !var58 && var43 < var40; ++var43) {
                            for (int var44 = var38 + 1; !var58 && var44 >= var56 - 1; --var44) {
                                ...
                                if (var44 == var56 - 1 || var42 == var55 || var42 == var36 - 1 || var43 == var57 || var43 == var40 - 1) continue;
                                var44 = var56;
                            }
                        }
                    }
                    if (!var58) {
                        for (var42 = var55; var42 < var36; ++var42) {
                            double var59 = ((double)(var42 + p_180702_3_ * 16) + 0.5 - p_180702_6_) / var29;
                            for (int var60 = var57; var60 < var40; ++var60) {
                                double var46 = ((double)(var60 + p_180702_4_ * 16) + 0.5 - p_180702_10_) / var29;
                                boolean var48 = false;
                                if (!(var59 * var59 + var46 * var46 < 1.0)) continue;
                                for (int var49 = var38; var49 > var56; --var49) {
                                    double var50 = ((double)(var49 - 1) + 0.5 - p_180702_8_) / var31;
                                    if (!(var50 > -0.7) || !(var59 * var59 + var50 * var50 + var46 * var46 < 1.0)) continue;
                                    IBlockState var52 = p_180702_5_.getBlockState(var42, var49, var60);
                                    IBlockState var53 = (IBlockState)Objects.firstNonNull((Object)p_180702_5_.getBlockState(var42, var49 + 1, var60), (Object)Blocks.air.getDefaultState());
                                    if (var52.getBlock() == Blocks.grass || var52.getBlock() == Blocks.mycelium) {
                                        var48 = true;
                                    }
                                    if (!this.func_175793_a(var52, var53)) continue;
                                    if (var49 - 1 < 10) {
                                    ...
                                    if (!var48 || p_180702_5_.getBlockState(var42, var49 - 1, var60).getBlock() != Blocks.dirt) continue;
                                    p_180702_5_.setBlockState(var42, var49 - 1, var60, this.worldObj.getBiomeGenForCoords((BlockPos)new BlockPos((int)(var42 + p_180702_3_ * 16), (int)0, (int)(var60 + p_180702_4_ * 16))).topBlock.getBlock().getDefaultState());
                                }
                            }
                        }
                        if (var54) break;
    ...
    protected void func_180701_a(World worldIn, int p_180701_2_, int p_180701_3_, int p_180701_4_, int p_180701_5_, ChunkPrimer p_180701_6_) {
        ...
        for (int var8 = 0; var8 < var7; ++var8) {
            ...
            for (int var16 = 0; var16 < var15; ++var16) {
                ...
                this.func_180702_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, p_180701_6_, var9, var11, var13, var19, var17, var18, 0, 0, 1.0);
            }
        }
    }
}
