...
extends MapGenBase {
    ...
    protected void func_180704_a(long p_180704_1_, int p_180704_3_, int p_180704_4_, ChunkPrimer p_180704_5_, double p_180704_6_, double p_180704_8_, double p_180704_10_, float p_180704_12_, float p_180704_13_, float p_180704_14_, int p_180704_15_, int p_180704_16_, double p_180704_17_) {
        ...
        while (p_180704_15_ < p_180704_16_) {
            double var29 = 1.5 + (double)(MathHelper.sin((float)p_180704_15_ * (float)Math.PI / (float)p_180704_16_) * p_180704_12_ * 1.0f);
            ...
            p_180704_14_ = var28 ? (p_180704_14_ *= 0.92f) : (p_180704_14_ *= 0.7f);
            ...
            if (!var52 && p_180704_15_ == var27 && p_180704_12_ > 1.0f) {
                this.func_180704_a(var25.nextLong(), p_180704_3_, p_180704_4_, p_180704_5_, p_180704_6_, p_180704_8_, p_180704_10_, var25.nextFloat() * 0.5f + 0.5f, p_180704_13_ - 1.5707964f, p_180704_14_ / 3.0f, p_180704_15_, p_180704_16_, 1.0);
                this.func_180704_a(var25.nextLong(), p_180704_3_, p_180704_4_, p_180704_5_, p_180704_6_, p_180704_8_, p_180704_10_, var25.nextFloat() * 0.5f + 0.5f, p_180704_13_ + 1.5707964f, p_180704_14_ / 3.0f, p_180704_15_, p_180704_16_, 1.0);
                return;
            }
            if (var52 || var25.nextInt(4) != 0) {
                ...
                if (p_180704_6_ >= var19 - 16.0 - var29 * 2.0 && p_180704_10_ >= var21 - 16.0 - var29 * 2.0 && p_180704_6_ <= var19 + 16.0 + var29 * 2.0 && p_180704_10_ <= var21 + 16.0 + var29 * 2.0) {
                    int var42;
                    ...
                    for (var42 = var53; !var56 && var42 < var36; ++var42) {
                        for (int var43 = var55; !var56 && var43 < var40; ++var43) {
                            for (int var44 = var38 + 1; !var56 && var44 >= var54 - 1; --var44) {
                                ...
                                if (var44 == var54 - 1 || var42 == var53 || var42 == var36 - 1 || var43 == var55 || var43 == var40 - 1) continue;
                                var44 = var54;
                            }
                        }
                    }
                    if (!var56) {
                        for (var42 = var53; var42 < var36; ++var42) {
                            double var57 = ((double)(var42 + p_180704_3_ * 16) + 0.5 - p_180704_6_) / var29;
                            for (int var58 = var55; var58 < var40; ++var58) {
                                double var46 = ((double)(var58 + p_180704_4_ * 16) + 0.5 - p_180704_10_) / var29;
                                for (int var48 = var38; var48 > var54; --var48) {
                                    IBlockState var51;
                                    double var49 = ((double)(var48 - 1) + 0.5 - p_180704_8_) / var31;
                                    if (!(var49 > -0.7) || !(var57 * var57 + var49 * var49 + var46 * var46 < 1.0) || (var51 = p_180704_5_.getBlockState(var42, var48, var58)).getBlock() != Blocks.netherrack && var51.getBlock() != Blocks.dirt && var51.getBlock() != Blocks.grass) continue;
    ...
    protected void func_180701_a(World worldIn, int p_180701_2_, int p_180701_3_, int p_180701_4_, int p_180701_5_, ChunkPrimer p_180701_6_) {
        ...
        for (int var8 = 0; var8 < var7; ++var8) {
            ...
            for (int var16 = 0; var16 < var15; ++var16) {
                ...
                this.func_180704_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, p_180701_6_, var9, var11, var13, var19 * 2.0f, var17, var18, 0, 0, 0.5);
            }
        }
    }
}
