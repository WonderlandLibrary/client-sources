...
extends WorldGenerator {
    ...
    public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_) {
        ...
        for (var14 = var6; var14 <= var7; ++var14) {
            for (var15 = -1; var15 <= 4; ++var15) {
                for (var16 = var11; var16 <= var12; ++var16) {
                    ...
                    if (var14 != var6 && var14 != var7 && var16 != var11 && var16 != var12 || var15 != 0 || !worldIn.isAirBlock(var17) || !worldIn.isAirBlock(var17.offsetUp())) continue;
                    ++var13;
                }
            }
        }
        if (var13 >= 1 && var13 <= 5) {
                ...
                for (var15 = 3; var15 >= -1; --var15) {
                    for (var16 = var11; var16 <= var12; ++var16) {
                        ...
                        if (var14 != var6 && var15 != -1 && var16 != var11 && var14 != var7 && var15 != 4 && var16 != var12) {
                            if (worldIn.getBlockState(var17).getBlock() == Blocks.chest) continue;
                            worldIn.setBlockToAir(var17);
                            continue;
                        }
                        if (var17.getY() >= 0 && !worldIn.getBlockState(var17.offsetDown()).getBlock().getMaterial().isSolid()) {
                            worldIn.setBlockToAir(var17);
                            continue;
                        }
                        if (!worldIn.getBlockState(var17).getBlock().getMaterial().isSolid() || worldIn.getBlockState(var17).getBlock() == Blocks.chest) continue;
            ...
            block6: for (var14 = 0; var14 < 2; ++var14) {
                for (var15 = 0; var15 < 3; ++var15) {
                    int var25;
                    int var24;
                    var16 = p_180709_3_.getX() + p_180709_2_.nextInt(var5 * 2 + 1) - var5;
                    BlockPos var26 = new BlockPos(var16, var24 = p_180709_3_.getY(), var25 = p_180709_3_.getZ() + p_180709_2_.nextInt(var10 * 2 + 1) - var10);
                    if (!worldIn.isAirBlock(var26)) continue;
                    int var20 = 0;
                    for (EnumFacing var22 : EnumFacing.Plane.HORIZONTAL) {
                        if (!worldIn.getBlockState(var26.offset(var22)).getBlock().getMaterial().isSolid()) continue;
                        ++var20;
                    }
                    if (var20 != true) continue;
                    worldIn.setBlockState(var26, Blocks.chest.func_176458_f(worldIn, var26, Blocks.chest.getDefaultState()), 2);
                    List var27 = WeightedRandomChestContent.func_177629_a(CHESTCONTENT, Items.enchanted_book.getRandomEnchantedBook(p_180709_2_));
                    TileEntity var28 = worldIn.getTileEntity(var26);
                    if (!(var28 instanceof TileEntityChest)) continue block6;
