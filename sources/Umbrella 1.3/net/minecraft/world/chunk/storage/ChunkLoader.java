    ...
    public static void convertToAnvilFormat(AnvilConverterData p_76690_0_, NBTTagCompound p_76690_1_, WorldChunkManager p_76690_2_) {
        ...
        for (int var5 = 0; var5 < 8; ++var5) {
            ...
            for (var7 = 0; var7 < 16 && var6; ++var7) {
                block3: for (int var8 = 0; var8 < 16 && var6; ++var8) {
        ...
        for (int var18 = 0; var18 < 16; ++var18) {
            for (var7 = 0; var7 < 16; ++var7) {
                var17[var7 << 4 | var18] = (byte)(p_76690_2_.func_180300_a((BlockPos)new BlockPos((int)(p_76690_0_.x << 4 | var18), (int)0, (int)(p_76690_0_.z << 4 | var7)), (BiomeGenBase)BiomeGenBase.field_180279_ad).biomeID & 0xFF);
            }
        }
