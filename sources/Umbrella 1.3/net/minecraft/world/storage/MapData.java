...
extends WorldSavedData {
    ...
    public void func_176054_a(double p_176054_1_, double p_176054_3_, int p_176054_5_) {
        ...
        int var7 = MathHelper.floor_double((p_176054_1_ + 64.0) / (double)var6);
        int var8 = MathHelper.floor_double((p_176054_3_ + 64.0) / (double)var6);
    ...
    public void readFromNBT(NBTTagCompound nbt) {
        ...
        int var2 = nbt.getShort("width");
        int var3 = nbt.getShort("height");
        if (var2 == 128 && var3 == 128) {
            ...
            for (int var7 = 0; var7 < var3; ++var7) {
                int var8 = var7 + var6;
                if (var8 < 0 && var8 >= 128) continue;
                for (int var9 = 0; var9 < var2; ++var9) {
                    int var10 = var9 + var5;
                    if (var10 < 0 && var10 >= 128) continue;
    ...
    public void updateVisiblePlayers(EntityPlayer p_76191_1_, ItemStack p_76191_2_) {
        ...
        for (int var6 = 0; var6 < this.playersArrayList.size(); ++var6) {
            MapInfo var4 = (MapInfo)this.playersArrayList.get(var6);
            if (!var4.entityplayerObj.isDead && (var4.entityplayerObj.inventory.hasItemStack(p_76191_2_) || p_76191_2_.isOnItemFrame())) {
                if (p_76191_2_.isOnItemFrame() || var4.entityplayerObj.dimension != this.dimension) continue;
                this.func_82567_a(0, var4.entityplayerObj.worldObj, var4.entityplayerObj.getName(), var4.entityplayerObj.posX, var4.entityplayerObj.posZ, var4.entityplayerObj.rotationYaw);
                continue;
            }
        ...
        if (p_76191_2_.isOnItemFrame()) {
            ...
            this.func_82567_a(1, p_76191_1_.worldObj, "frame-" + var7.getEntityId(), var9.getX(), var9.getZ(), var7.field_174860_b.getHorizontalIndex() * 90);
        }
        if (p_76191_2_.hasTagCompound() && p_76191_2_.getTagCompound().hasKey("Decorations", 9)) {
            ...
            for (int var10 = 0; var10 < var8.tagCount(); ++var10) {
                ...
                if (this.playersVisibleOnMap.containsKey(var5.getString("id"))) continue;
    ...
    private void func_82567_a(int p_82567_1_, World worldIn, String p_82567_3_, double p_82567_4_, double p_82567_6_, double p_82567_8_) {
        ...
        if (var11 >= (float)(-var16) && var12 >= (float)(-var16) && var11 <= (float)var16 && var12 <= (float)var16) {
            var15 = (byte)((p_82567_8_ += p_82567_8_ < 0.0 ? -8.0 : 8.0) * 16.0 / 360.0);
            if (this.dimension < 0) {
