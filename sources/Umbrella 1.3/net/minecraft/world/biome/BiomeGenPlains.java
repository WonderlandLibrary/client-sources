...
extends BiomeGenBase {
    ...
    public BlockFlower.EnumFlowerType pickRandomFlower(Random p_180623_1_, BlockPos p_180623_2_) {
        double var3 = field_180281_af.func_151601_a((double)p_180623_2_.getX() / 200.0, (double)p_180623_2_.getZ() / 200.0);
        if (var3 < -0.8) {
    ...
    public void func_180624_a(World worldIn, Random p_180624_2_, BlockPos p_180624_3_) {
        ...
        int var7;
        int var6;
        double var4 = field_180281_af.func_151601_a((double)(p_180624_3_.getX() + 8) / 200.0, (double)(p_180624_3_.getZ() + 8) / 200.0);
        if (var4 < -0.8) {
