...
extends ArrayList {
    ...
    public MerchantRecipe canRecipeBeUsed(ItemStack p_77203_1_, ItemStack p_77203_2_, int p_77203_3_) {
        ...
        for (int var4 = 0; var4 < this.size(); ++var4) {
            ...
            if (!ItemStack.areItemsEqual(p_77203_1_, var5.getItemToBuy()) || p_77203_1_.stackSize < var5.getItemToBuy().stackSize || (var5.hasSecondItemToBuy() || p_77203_2_ != null) && (!var5.hasSecondItemToBuy() || !ItemStack.areItemsEqual(p_77203_2_, var5.getSecondItemToBuy()) || p_77203_2_.stackSize < var5.getSecondItemToBuy().stackSize)) continue;
            return var5;
        }
        return null;
    }
