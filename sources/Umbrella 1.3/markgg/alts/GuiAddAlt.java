...
extends GuiScreen {
    ...
    public void drawScreen(int i2, int j2, float f2) {
        ...
        this.drawCenteredString(this.fontRendererObj, "Add Alt", this.width / 2, 20.0f, -1);
        ...
        this.drawCenteredString(this.fontRendererObj, this.status, this.width / 2, 30.0f, -1);
