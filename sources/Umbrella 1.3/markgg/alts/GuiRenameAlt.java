...
import markgg.alts.PasswordField;
...
extends GuiScreen {
    ...
    public void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 0: {
                ...
                this.status = (Object)((Object)EnumChatFormatting.GREEN) + "Alt edited. (" + this.nameField.getText() + " - new name)";
            }
        }
    }
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawCenteredString(this.fontRendererObj, "Edit Alt", this.width / 2, 10.0f, -1);
        this.drawCenteredString(this.fontRendererObj, this.status, this.width / 2, 20.0f, -1);
