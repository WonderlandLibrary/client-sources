...
extends GuiScreen {
    ...
    public void drawScreen(int x2, int y2, float z2) {
        ...
        this.drawCenteredString(this.mc.fontRendererObj, "Alt Login", this.width / 2, 20.0f, -1);
        this.drawCenteredString(this.mc.fontRendererObj, this.thread == null ? (Object)((Object)EnumChatFormatting.GRAY) + "Idle..." : this.thread.getStatus(), this.width / 2, 29.0f, -1);
