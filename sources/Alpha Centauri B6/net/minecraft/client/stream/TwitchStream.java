...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController$ChatListener, IngestServerTester$IngestTestListener, IStream {
            ...
            public void run() {
               try {
                  ...
                  if(JsonUtils.getBoolean(jsonobject1, "valid")) {
                     ...
                     Runtime.getRuntime().addShutdownHook(new 1(this, "Twitch shutdown hook"));
   ...
   public void func_152935_j() {
      ...
      boolean flag1 = this.chatController.func_153000_j() == ChatState.Initialized && (this.field_176029_e == null || this.chatController.func_175989_e(this.field_176029_e) == EnumChannelState.Disconnected);
      if(i == 2) {
         if(flag) {
   ...
   protected void func_152942_I() {
      ChatState chatcontroller$chatstate = this.chatController.func_153000_j();
      String s = this.broadcastController.getChannelInfo().name;
      this.field_176029_e = s;
      if(chatcontroller$chatstate != ChatState.Initialized) {
         LOGGER.warn("Invalid twitch chat state {}", new Object[]{chatcontroller$chatstate});
      } else if(this.chatController.func_175989_e(this.field_176029_e) == EnumChannelState.Disconnected) {
   ...
   public void func_176017_a(ChatState p_176017_1_) {
   }
   ...
   public void func_152892_c(ErrorCode p_152892_1_) {
      if(p_152892_1_ == ErrorCode.TTV_EC_SOUNDFLOWER_NOT_INSTALLED) {
         ...
         ichatcomponent.getChatStyle().setChatClickEvent(new ClickEvent(Action.OPEN_URL, "https://help.mojang.com/customer/portal/articles/1374877-configuring-soundflower-for-streaming-on-apple-computers"));
   ...
   public void func_180605_a(String p_180605_1_, ChatRawMessage[] p_180605_2_) {
      for(ChatRawMessage chatrawmessage : p_180605_2_) {
         ...
         if(this.func_176028_a(chatrawmessage.modes, chatrawmessage.subscriptions, this.mc.gameSettings.streamChatUserFilter)) {
            ...
            ichatcomponent.getChatStyle().setChatClickEvent(new ClickEvent(Action.TWITCH_USER_INFO, chatrawmessage.userName));
            this.mc.ingameGUI.getChatGUI().printChatMessage(ichatcomponent1);
         }
      }
   ...
   public void func_152907_a(IngestServerTester p_152907_1_, IngestTestState p_152907_2_) {
      LOGGER.debug(STREAM_MARKER, "Ingest test state changed to {}", new Object[]{p_152907_2_});
      if(p_152907_2_ == IngestTestState.Finished) {
