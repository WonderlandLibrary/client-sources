...
public class EffectRenderer {
   ...
   private void tickParticle(EntityFX p_178923_1_) {
      try {
         ...
         crashreportcategory.addCrashSectionCallable("Particle", new 1(this, p_178923_1_));
         crashreportcategory.addCrashSectionCallable("Particle Type", new 2(this, i));
   ...
   private boolean reuseBarrierParticle(EntityFX p_reuseBarrierParticle_1_, List p_reuseBarrierParticle_2_) {
         ...
         for(int k = 0; k < 2; ++k) {
            if(!this.fxLayers[j][k].isEmpty()) {
               ...
               for(int l = 0; l < this.fxLayers[j][k].size(); ++l) {
                  EntityFX entityfx = (EntityFX)this.fxLayers[j][k].get(l);
                  ...
                  try {
                     ...
                     crashreportcategory.addCrashSectionCallable("Particle", new 3(this, entityfx));
                     crashreportcategory.addCrashSectionCallable("Particle Type", new 4(this, j));
                     throw new ReportedException(crashreport);
                  }
               }
