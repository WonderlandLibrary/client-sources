   ...
   public void renderItemAndEffectIntoGUI(ItemStack stack, int xPosition, int yPosition) {
      if(stack != null && stack.getItem() != null) {
         ...
         try {
            ...
            crashreportcategory.addCrashSectionCallable("Item Type", new 1(this, stack));
            crashreportcategory.addCrashSectionCallable("Item Aux", new 2(this, stack));
            crashreportcategory.addCrashSectionCallable("Item NBT", new 3(this, stack));
            crashreportcategory.addCrashSectionCallable("Item Foil", new 4(this, stack));
