...
import net.minecraft.client.renderer.EntityRendererCanCollideWith;
import net.minecraft.client.renderer.EntityRendererGetCurrentScreenName;
...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   // $FF: synthetic method
   static Minecraft access$000(EntityRenderer x0) {
      return x0.mc;
   }
   ...
   public void func_181560_a(float p_181560_1_, long p_181560_2_) {
      ...
      if(!this.mc.skipRenderWorld) {
         ...
         if(this.mc.currentScreen != null) {
            ...
            try {
               ...
               crashreportcategory.addCrashSectionCallable("Screen name", new EntityRendererGetCurrentScreenName(this));
               crashreportcategory.addCrashSectionCallable("Mouse location", new 1(this, j1, k1));
               crashreportcategory.addCrashSectionCallable("Screen size", new 2(this, scaledresolution));
      ...
      if(this.mc.gameSettings.ofProfiler) {
         this.mc.gameSettings.field_181657_aC = true;
      }
   ...
   public void getMouseOver(float partialTicks) {
      ...
      if(entity != null && this.mc.theWorld != null) {
         ...
         Vec3 vec33 = null;
         float f = 1.0F;
         List<Entity> list = this.mc.theWorld.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().addCoord(vec31.xCoord * d0, vec31.yCoord * d0, vec31.zCoord * d0).expand((double)f, (double)f, (double)f), Predicates.and(EntitySelectors.NOT_SPECTATING, new EntityRendererCanCollideWith(this)));
         double d2 = d1;
   ...
   public void setupCameraTransform(float partialTicks, int pass) {
      ...
      if(this.mc.gameSettings.viewBobbing && !AC.getModuleManager().get(ModuleTracers.class).isEnabled() && !AC.getModuleManager().get(ModuleNoBob.class).isEnabled()) {
   ...
   private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
      ...
      if(!this.debugView) {
         ...
         if(this.mc.objectMouseOver != null && entity.isInsideOfMaterial(Material.water) && flag1) {
            ...
            if((!Reflector.ForgeHooksClient_onDrawBlockHighlight.exists() || !Reflector.callBoolean(Reflector.ForgeHooksClient_onDrawBlockHighlight, new Object[]{renderglobal, entityplayer, this.mc.objectMouseOver, Integer.valueOf(0), entityplayer.getHeldItem(), Float.valueOf(partialTicks)})) && !this.mc.gameSettings.thirdPersonView) {
      ...
      (new EventRender3D(partialTicks)).fire();
