...
public abstract class GuiContainer extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      int i = this.guiLeft;
      int j = this.guiTop;
      if(AC.isGhost() || !AC.getConfig().isInventoryTransparent() || this instanceof GuiInventory || this instanceof GuiContainerCreative) {
      ...
      for(int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1) {
         ...
         if(this.isMouseOverSlot(slot, mouseX, mouseY) && slot.canBeHovered()) {
            ...
            GlStateManager.enableLighting();
            GlStateManager.enableDepth();
         } else if(!(this instanceof GuiContainerCreative) && !AC.isGhost() && AC.getConfig().isInventoryTransparent()) {
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            int j1 = slot.xDisplayPosition;
            int k1 = slot.yDisplayPosition;
            GlStateManager.colorMask(true, true, true, false);
            this.drawGradientRect(j1, k1, j1 + 16, k1 + 16, 1073741824, 1073741824);
            GlStateManager.colorMask(true, true, true, true);
         }
      }
