...
public class ModelDragon extends ModelBase {
   ...
   public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
      ...
      this.jaw.rotateAngleX = (float)(Math.sin((double)(f * 3.1415927F * 2.0F)) + 1.0D) * 0.2F;
      ...
      for(int i = 0; i < 5; ++i) {
         ...
         this.spine.rotateAngleY = this.updateRotations(adouble1[0] - adouble[0]) * 3.1415927F / 180.0F * f5;
         this.spine.rotateAngleX = f9 + (float)(adouble1[1] - adouble[1]) * 3.1415927F / 180.0F * f5 * 5.0F;
         this.spine.rotateAngleZ = -this.updateRotations(adouble1[0] - (double)f7) * 3.1415927F / 180.0F * f5;
      ...
      this.head.rotateAngleZ = -this.updateRotations(adouble2[0] - (double)f7) * 3.1415927F / 180.0F * 1.0F;
      ...
      for(int k = 0; k < 12; ++k) {
         ...
         this.spine.rotateAngleY = (this.updateRotations(adouble2[0] - adouble[0]) * f5 + 180.0F) * 3.1415927F / 180.0F;
         this.spine.rotateAngleX = f10 + (float)(adouble2[1] - adouble[1]) * 3.1415927F / 180.0F * f5 * 5.0F;
         this.spine.rotateAngleZ = this.updateRotations(adouble2[0] - (double)f7) * 3.1415927F / 180.0F * f5;
         this.spine.rotationPointY = f2;
         this.spine.rotationPointZ = f3;
         this.spine.rotationPointX = f4;
         f2 = (float)((double)f2 + Math.sin((double)this.spine.rotateAngleX) * 10.0D);
