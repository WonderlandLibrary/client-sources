   ...
   private static ResourceLocation[] getTextureVariants(ResourceLocation p_getTextureVariants_0_) {
      ...
      if(resourcelocation == null) {
         ...
         if(list.size() <= 1) {
            ...
            ResourceLocation[] aresourcelocation = (ResourceLocation[])((ResourceLocation[])((ResourceLocation[])list.toArray(new ResourceLocation[list.size()])));
   ...
   public static ResourceLocation getTextureLocation(ResourceLocation p_getTextureLocation_0_) {
      if(working) {
         ...
         try {
            ...
            if(renderGlobal == null) {
               ResourceLocation texture = p_getTextureLocation_0_;
               return texture;
            }
