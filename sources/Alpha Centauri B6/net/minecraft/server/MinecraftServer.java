...
public abstract class MinecraftServer implements Runnable, ICommandSender, IThreadListener, IPlayerUsage {
   ...
   public void run() {
      try {
         if(this.startServer()) {
            ...
            this.statusResponse.setProtocolVersionInfo(new MinecraftProtocolVersionIdentifier("1.8.9", 47));
   ...
   public void tick() {
      ...
      if(i - this.nanoTimeSinceStatusRefresh >= 5000000000L) {
         ...
         this.statusResponse.setPlayerCountData(new PlayerCountData(this.getMaxPlayers(), this.getCurrentPlayerCount()));
   ...
   protected void convertMapIfNeeded(String worldNameIn) {
      if(this.getActiveAnvilConverter().isOldMapFormat(worldNameIn)) {
         ...
         this.getActiveAnvilConverter().convertMapFormat(worldNameIn, new 1(this));
      }
      ...
      for(int j = 0; j < this.worldServers.length; ++j) {
         ...
         if(j == 0 || this.getAllowNether()) {
            ...
            try {
               ...
               CrashReport crashreport = CrashReport.makeCrashReport(var8, "Exception ticking world");
            ...
            try {
               ...
               CrashReport crashreport1 = CrashReport.makeCrashReport(var7, "Exception ticking world entities");
   ...
   public CrashReport addServerInfoToCrashReport(CrashReport report) {
      report.getCategory().addCrashSectionCallable("Profiler Position", new 2(this));
      if(this.serverConfigManager != null) {
         report.getCategory().addCrashSectionCallable("Player Count", new 3(this));
      }
