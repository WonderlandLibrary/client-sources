...
public abstract class EntityPlayer extends EntityLivingBase {
   ...
   public boolean isInvisibleToPlayer(EntityPlayer player) {
      if(!this.isInvisible()) {
         ...
         return (team == null || player == null || player.getTeam() != team || !team.getSeeFriendlyInvisiblesEnabled()) && (AC.isGhost() || !AC.getModuleManager().get(ModuleTrueSight.class).isEnabled() || !((Boolean)((ModuleTrueSight)AC.getModuleManager().get(ModuleTrueSight.class)).SemiInvisible.value).booleanValue());
      }
   }
   ...
   public void onUpdate() {
      if(!(this instanceof EntityPlayerSP) || !AC.getModuleManager().get(ModuleFreecam.class).isEnabled()) {
