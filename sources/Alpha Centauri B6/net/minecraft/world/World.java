...
public abstract class World implements IBlockAccess {
   ...
   public BiomeGenBase getBiomeGenForCoords(BlockPos pos) {
      if(this.isBlockLoaded(pos)) {
         ...
         try {
            ...
            crashreportcategory.addCrashSectionCallable("Location", new 1(this, pos));
   ...
   public void notifyBlockOfStateChange(BlockPos pos, Block blockIn) {
      if(!this.isRemote) {
         ...
         try {
            ...
            crashreportcategory.addCrashSectionCallable("Source block type", new 2(this, blockIn));
   ...
   public TileEntity getTileEntity(BlockPos pos) {
      if(!this.isValid(pos)) {
         ...
         if(tileentity == null) {
            tileentity = this.getChunkFromBlockCoords(pos).getTileEntity(pos, EnumCreateEntityType.IMMEDIATE);
         }
