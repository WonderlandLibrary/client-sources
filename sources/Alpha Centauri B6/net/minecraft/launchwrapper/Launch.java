...
public class Launch {
   ...
   private void launch(String[] args) {
      ...
      try {
         ...
         while(true) {
            ...
            while(it.hasNext()) {
               ...
               if(allTweakerNames.contains(tweakName)) {
                  LogWrapper.log(Level.WARNING, "Tweak class name %s has already been visited -- skipping", new Object[]{tweakName});
               } else {
         ...
         LogWrapper.log(Level.SEVERE, var19, "Unable to launch", new Object[0]);
      }
