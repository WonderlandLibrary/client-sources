...
public class NBTTagCompound extends NBTBase {
   ...
   private CrashReport createCrashReport(String key, int expectedType, ClassCastException ex) {
      ...
      crashreportcategory.addCrashSectionCallable("Tag type found", new 1(this, key));
      crashreportcategory.addCrashSectionCallable("Tag type expected", new 2(this, expectedType));
      crashreportcategory.addCrashSection("Tag name", key);
      return crashreport;
   }
}
