...
public abstract class BiomeGenBase
{
    ...
    public final float getFloatTemperature(BlockPos pos)
    {
        if (pos.getY() > 64)
        {
            float var2 = (float)(temperatureNoise.func_151601_a(pos.getX() * 1.0D / 8.0D, pos.getZ() * 1.0D / 8.0D) * 4.0D);
            return this.temperature - (var2 + pos.getY() - 64.0F) * 0.05F / 30.0F;
        }
        else
        {
    ...
    {
        double var2 = MathHelper.clamp_float(this.getFloatTemperature(p_180627_1_), 0.0F, 1.0F);
    ...
    {
        double var2 = MathHelper.clamp_float(this.getFloatTemperature(p_180625_1_), 0.0F, 1.0F);
        double var4 = MathHelper.clamp_float(this.getFloatRainfall(), 0.0F, 1.0F);
