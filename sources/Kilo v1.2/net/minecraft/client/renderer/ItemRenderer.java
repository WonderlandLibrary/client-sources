...
public class ItemRenderer
{
    ...
    public void renderOverlays(float partialTicks)
    {
        ...
        if (this.mc.thePlayer.isEntityInsideOpaqueBlock() && !ModuleManager.get("cameranoclip").active)
        {
    ...
    {
    	if (ModuleManager.get("nooverlay").active || ModuleManager.get("liquidvision").active) {
    		return;
    	}
