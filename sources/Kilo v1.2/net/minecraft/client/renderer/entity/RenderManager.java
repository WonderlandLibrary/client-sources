...
public class RenderManager
{
    ...
    public void cacheActiveRenderInfo(World worldIn, FontRenderer textRendererIn, Entity livingPlayerIn, Entity pointedEntityIn, GameSettings optionsIn, float partialTicks)
    {
        ...
        if (livingPlayerIn instanceof EntityLivingBase && ((EntityLivingBase)livingPlayerIn).isPlayerSleeping())
        {
            ...
            if (var8 == Blocks.bed)
            {
                int var9 = ((EnumFacing)var7.getValue(BlockDirectional.FACING)).getHorizontalIndex();
    ...
    public boolean renderEntityStatic(Entity entity, float partialTicks, boolean p_147936_3_)
    {
        ...
        double var4 = entity.lastTickPosX + (entity.posX - entity.lastTickPosX) * partialTicks;
        double var6 = entity.lastTickPosY + (entity.posY - entity.lastTickPosY) * partialTicks;
        double var8 = entity.lastTickPosZ + (entity.posZ - entity.lastTickPosZ) * partialTicks;
    ...
    {
        double var3 = entityIn.lastTickPosX + (entityIn.posX - entityIn.lastTickPosX) * partialTicks;
        double var5 = entityIn.lastTickPosY + (entityIn.posY - entityIn.lastTickPosY) * partialTicks;
        double var7 = entityIn.lastTickPosZ + (entityIn.posZ - entityIn.lastTickPosZ) * partialTicks;
        Render var9 = this.getEntityRenderObject(entityIn);
    ...
    private void renderDebugBoundingBox(Entity entityIn, double p_85094_2_, double p_85094_4_, double p_85094_6_, float p_85094_8_, float p_85094_9_)
    {
        ...
        {
            RenderGlobal.drawOutlinedBoundingBox(new AxisAlignedBB(p_85094_2_ - var10, p_85094_4_ + entityIn.getEyeHeight() - 0.009999999776482582D, p_85094_6_ - var10, p_85094_2_ + var10, p_85094_4_ + entityIn.getEyeHeight() + 0.009999999776482582D, p_85094_6_ + var10), 16711680);
        }
        ...
        var14.addVertex(p_85094_2_, p_85094_4_ + entityIn.getEyeHeight(), p_85094_6_);
        var14.addVertex(p_85094_2_ + var15.xCoord * 2.0D, p_85094_4_ + entityIn.getEyeHeight() + var15.yCoord * 2.0D, p_85094_6_ + var15.zCoord * 2.0D);
        var16.draw();
