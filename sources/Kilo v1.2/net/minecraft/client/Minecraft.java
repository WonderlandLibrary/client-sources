...
import com.kilo.input.IngameInput;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private static final ResourceLocation locationMojangPng = new ResourceLocation("textures/gui/title/kilo.png");
     ...
     */
    public void scaledTessellator(int scale)
    {
        float var7 = 0.00390625F;
        float var8 = 0.00390625F;
        WorldRenderer var9 = Tessellator.getInstance().getWorldRenderer();
        var9.startDrawingQuads();
        var9.addVertexWithUV(0, 0, 0, 0, 0);
        var9.addVertexWithUV(0, Display.getHeight(), 0, 0, scale);
        var9.addVertexWithUV(Display.getWidth(), Display.getHeight(), 0, scale, scale);
        var9.addVertexWithUV(Display.getWidth(), 0, 0, scale, 0);
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
        	if (ModuleManager.get("autorespawn").active) {
        ...
        if (UIHandler.currentUI != null) {
        	UIHandler.changeUI();
        } else {
        	UIHandler.currentUI = UIUtil.newUI(this.currentScreen);
        }
    ...
    private void runGameLoop() throws IOException
    {
        ...
        {
        	if (!ModuleManager.get("cameranoclip").active) {
    ...
    private void displayDebugInfo(long elapsedTicksTime)
    {
        if (this.mcProfiler.profilingEnabled)
        {
            ...
            this.fontRendererObj.drawStringWithShadow(var20 = var19.format(var4.field_76330_b) + "%", var8 + var7 - this.fontRendererObj.getStringWidth(var20), var9 - var7 / 2 - 16, var14);
            ...
            for (int var21 = 0; var21 < var3.size(); ++var21)
            {
                ...
                this.fontRendererObj.drawStringWithShadow(var23 = var19.format(var22.field_76332_a) + "%", var8 + var7 - 50 - this.fontRendererObj.getStringWidth(var23), var9 + var7 / 2 + var21 * 8 + 20, var22.func_76329_a());
                this.fontRendererObj.drawStringWithShadow(var23 = var19.format(var22.field_76330_b) + "%", var8 + var7 - this.fontRendererObj.getStringWidth(var23), var9 + var7 / 2 + var21 * 8 + 20, var22.func_76329_a());
            }
        }
    }
            ...
            switch (Minecraft.SwitchEnumMinecartType.field_152390_a[this.objectMouseOver.typeOfHit.ordinal()])
            {
                ...
                case 2:
                    ...
                    if (this.theWorld.getBlockState(var3).getBlock().getMaterial() != Material.air)
                    {
                        ...
                        {
                        	for(Module m : ModuleManager.enabledList()) {
                        		m.onPlayerBlockPlace(var2, var3, this.objectMouseOver.sideHit, this.objectMouseOver.hitVec);
                        	}
                            var1 = false;
                            this.thePlayer.swingItem();
                        }
    ...
    public void runTick() throws IOException
    {
        if (this.rightClickDelayTimer > 0)
        {
        	...
        	if (ModuleManager.get("fastplace").active) {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
                ...
                if (var10 <= 200L)
                {
                    ...
                    if (var4 != 0)
                    {
                        if (this.thePlayer.isSpectator())
                        {
                            ...
                            {
                                float var5 = MathHelper.clamp_float(this.thePlayer.capabilities.getFlySpeed() + var4 * 0.005F, 0.0F, 0.2F);
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState()) {
                	IngameInput.keyboardPress(Keyboard.getEventKey());
                    KeyBinding.onTick(var1);
                } else {
                	IngameInput.keyboardRelease(Keyboard.getEventKey());
                }
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        if (this.gameSettings.keyBindTogglePerspective.isPressed())
                        {
                            ...
                            if (ModuleManager.get("lsd").active) {
                            	((LSD)ModuleManager.get("lsd")).refresh();
                            }
                        }
