...
import com.kilo.ui.UIPopupAcceptFriend;
...
public class ActivitySlotFriendRequest extends ActivitySlot {
	...
	public void doubleClick(int mx, int my) {
		((UIInGameMenu)UIHandler.currentUI).changePopup(new UIPopupAcceptFriend(UIHandler.currentUI, index, ActivityManager.getActivity(index).minecraftName, ActivityManager.getActivity(index).message));
	}
