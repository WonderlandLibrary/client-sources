...
import librarys.org.newdawn.slick.util.BufferedImageUtil;
import librarys.org.newdawn.slick.opengl.GLUtils;
...
public class TrueTypeFont implements Font {
	...
	public void drawString(float x, float y, String whatchars,
			librarys.org.newdawn.slick.Color color) {
		drawString(x,y,whatchars,color,0,whatchars.length()-1);
	}
	
	/**
	 * @see Font#drawString(float, float, String, librarys.org.newdawn.slick.Color, int, int)
	 */
	public void drawString(float x, float y, String whatchars,
                           librarys.org.newdawn.slick.Color color, int startIndex, int endIndex) {
		color.bind();
		fontTexture.bind();
	 ...
	 */
	public void drawString(float x, float y, String whatchars) {
		drawString(x, y, whatchars, librarys.org.newdawn.slick.Color.white);
	}
