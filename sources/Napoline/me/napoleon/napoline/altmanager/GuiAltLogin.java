 ...
 */
package me.napoleon.napoline.altmanager;
...
import me.napoleon.napoline.guis.utils.InputBox;
import me.napoleon.napoline.guis.utils.NapolineButton;
import me.napoleon.napoline.guis.utils.PasswordInputBox;
...
public class GuiAltLogin
    ...
    private NapolineButton login;
    private NapolineButton back;

    /**
     * 如果该参数为true 那么用于登录Napoline的账号
     */
     ...
     * @param test 如果该参数为true 那么用于登录Napoline的账号
     */
    ...
    public void initGui() {
        ...
        login = new NapolineButton(0, this.width / 2 - 100, var3 + 75, "Login");
        back = new NapolineButton(1, this.width / 2 - 100, var3 + 75 + 24, "Back");
