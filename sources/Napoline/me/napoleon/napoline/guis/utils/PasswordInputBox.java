package me.napoleon.napoline.guis.utils;
    ...
    public void drawTextBox() {
        if (this.func_146176_q()) {
            if (this.func_146181_i()) {
                ...
                Gui.drawRect(this.field_146209_f, this.field_146210_g, this.field_146209_f + this.field_146218_h, this.field_146210_g + this.field_146219_i, new Color(240, 240, 240));
            }
            ...
            if (var4.length() > 0) {
                ...
                var9 = (int) FontLoaders.F22.drawString(var10.replaceAll(".", "*"), var7, var8, var1);
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                FontLoaders.F22.drawString(var4.substring(var2).replaceAll(".", "*"), var9, var8, var1);
            }
            if (var6) {
                if (var11) {
                    Gui.drawRect(var12, var8 - 1, var12 + 1, var8 + 1 + this.field_146211_a.FONT_HEIGHT, -3092272);
                } else {
                    FontLoaders.F18.drawString("_", var12, var8, var1);
                }
            }
            if (var3 != var2) {
