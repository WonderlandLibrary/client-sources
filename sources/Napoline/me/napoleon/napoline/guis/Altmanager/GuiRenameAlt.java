...
extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        if (this.nameField.getText().isEmpty()) {
            mc.fontRendererObj.drawStringWithShadow("New E-Mail", this.width / 2 - 96, 66.0f, -7829368);
        }
        if (this.pwField.getText().isEmpty()) {
            mc.fontRendererObj.drawStringWithShadow("New Password", this.width / 2 - 96, 106.0f, -7829368);
        }
