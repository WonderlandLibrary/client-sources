...
//        }
        ...
        if (selectMod == null) {
            FontLoaders.F20.drawString(Napoline.CLIENT_NAME.toUpperCase(Locale.ROOT), windowX + 20, windowY + height - 20, new Color(77, 78, 84).getRGB());
        }
        //绘制顶部图标
        ...
        if (selectType == ClickType.Config) {
            ...
            for (Config c : configs) {
                ...
                if (c.equals(Napoline.configInUsing)) {
