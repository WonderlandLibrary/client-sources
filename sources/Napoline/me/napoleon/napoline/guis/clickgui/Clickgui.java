...
import me.napoleon.napoline.modules.render.ClickGui;
import me.napoleon.napoline.utils.render.RenderUtils;
import me.napoleon.napoline.utils.render.TranslateUtil;
...
public class Clickgui extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontLoaders.F30.drawString("Napoline", windowX + 15, windowY + 6, new Color(255, 255, 255).getRGB());
        FontLoaders.F16.drawString(Napoline.CLIENT_Ver, windowX + 50, windowY + 16, new Color(255, 255, 255, 150).getRGB());
    ...
    protected void keyTyped(char character, int key) {
        ...
        if (IRCgui.inputbox.isFocused() && (character == '\t' || key == Keyboard.KEY_RETURN)) {
            ...
            IRC.sendMessage(("MSG@" + Minecraft.getMinecraft().thePlayer.getName() + "@" + ChatFormatting.BLUE
                    + Napoline.CLIENT_NAME + ChatFormatting.WHITE + "@" + IRCgui.inputbox.getText()).replaceAll("&", "§"));
