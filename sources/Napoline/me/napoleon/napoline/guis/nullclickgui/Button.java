package me.napoleon.napoline.guis.nullclickgui;
...
public class Button {
    ...
    public Button(Mod cheat, int x, int y) {
        ...
        this.y = y;
        int y2 = y + 14;
        if (cheat == Napoline.INSTANCE.moduleManager.getModByClass(HUD.class)) {
    ...
    public void render(int mouseX, int mouseY) {
        if (this.cheat.getValues().size() + (this.cheat == Napoline.INSTANCE.moduleManager.getModByClass(HUD.class) ? 2 : 1) != this.buttons.size()) {
            this.buttons.clear();
            int y2 = this.y + 14;
            if (this.cheat == Napoline.INSTANCE.moduleManager.getModByClass(HUD.class)) {
