...
import me.napoleon.napoline.guis.Altmanager.Alt;
import me.napoleon.napoline.guis.Altmanager.AltManager;
...
public class FileUtil {
    ...
    public static File dir = new File(mcDir, "Napoline");
    ...
    public static void saveFile(String fileName, String context) {
        File dir = new File(mcDir, "Napoline");
        File file = new File(dir, fileName);
        try {
            if (!file.exists()) {
                file.createNewFile();
