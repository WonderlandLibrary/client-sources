package me.napoleon.napoline.utils.player;
...
import me.napoleon.napoline.utils.timer.Timer;


public class PlayerUtil {
	private static Minecraft mc = Minecraft.getMinecraft();
	Timer timer = new me.napoleon.napoline.utils.timer.Timer();
	me.napoleon.napoline.utils.timer.Timer lastCheck = new Timer();
	...
	public static void sendMessage(String msg) {
		if(mc.theWorld != null) {
			...
			mc.ingameGUI.getChatGUI().printChatMessage(new ChatComponentText(EnumChatFormatting.LIGHT_PURPLE + "[" + Napoline.CLIENT_NAME + "]" + EnumChatFormatting.GRAY + msg));
		} else {
