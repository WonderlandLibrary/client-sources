    ...
    public static void renderHud() {
        ...
        if (!mc.gameSettings.showDebugInfo) {
            ...
            if (useFont) {
                ...
                final StringBuilder append5 = new StringBuilder(String.valueOf(Napoline.CLIENT_NAME)).append(" ").append(EnumChatFormatting.GRAY);
                ...
                final StringBuilder append6 = new StringBuilder(String.valueOf(Napoline.CLIENT_NAME)).append(" ").append(EnumChatFormatting.GRAY);
