...
public class FluxHUD extends HUD {
    ...
    public static void renderHud() {
        ...
        FontLoaders.C22.drawStringWithShadow(Napoline.CLIENT_NAME, 2, 5, rainbow2.getRGB());
            ...
            for (Mod m : sorted) {
                ...
                if (m.getState()) {
                    ...
                    if ((Boolean) BackGround.getValue()) {
                        RenderUtil.drawRect(x2 - 8, m.getYAnim(), Napoline.sr.getScaledWidth(), m.getYAnim() + 10, new Color(0, 0, 0, 150).getRGB());
