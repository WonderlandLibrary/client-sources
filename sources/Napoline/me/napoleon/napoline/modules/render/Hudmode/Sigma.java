...
public class Sigma extends HUD {
    ...
    public static void renderHud() {
        ...
        FontLoaders.F30.drawStringWithShadow(Napoline.CLIENT_NAME, 7, 2, -1);
        FontLoaders.C18.drawStringWithShadow(Napoline.CLIENT_Ver, FontLoaders.F30.getStringWidth(Napoline.CLIENT_NAME), FontLoaders.F30.getStringHeight(Napoline.CLIENT_NAME) + 2, -1);
