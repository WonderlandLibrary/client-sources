...
public class KillAura
    ...
    public void onRender(EventRender2D e) {
        if (AntiPatch.patched || Napoline.crack || Napoline.username.equals("cracker!")) {
...
//                mc.thePlayer.rotationPitch = rotpitch;
    ...
    public static float[] getRotation(EntityLivingBase entity) {
        ...
        float yaw = (float) ((float) (Math.atan2(diffZ, diffX) * 180.0 / 3.1415926) + Napoline.flag - 90.0f + rotyawdist.getValue());
        float pitch = (float) ((float) (-(Math.atan2(diffY, dist) * 180.0 / 3.1415926)) + Napoline.flag + rotpitchdist.getValue());
