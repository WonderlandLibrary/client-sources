...
import me.napoleon.napoline.guis.notification.TimeHelper;
...
public class Fucker extends Mod {
    ...
    private void onPreUpdate(EventPreUpdate e) {
        if (noHit.getValue() && Napoline.moduleManager.getModByClass(KillAura.class).getState() && KillAura.target != null) {
            return;
        }
