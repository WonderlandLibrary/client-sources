...
import me.napoleon.napoline.events.EventRender3D;
...
import me.napoleon.napoline.utils.entity.EntityValidator;
import me.napoleon.napoline.utils.entity.impl.VoidCheck;
import me.napoleon.napoline.utils.entity.impl.WallCheck;
import me.napoleon.napoline.utils.gl.GLUtils;
...
public final class TargetStrafe
    ...
    public void onEnabled() {
        if (this.aura == null) {
            this.aura = (KillAura) Napoline.INSTANCE.moduleManager.getModByClass(KillAura.class);
        }
    }
    ...
    public void onRender(EventRender3D event) 
    {
    	Method method;
		try {
			method = Napoline.moduleManager.getModByClass(KillAura.class).getClass().getMethod("getTargets",Double.class);
	        for (Entity target : (List<Entity>)method.invoke(Napoline.moduleManager.getModByClass(KillAura.class), 10.0d)) {
