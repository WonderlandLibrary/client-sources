...
import me.napoleon.napoline.junk.openapi.script.api.Values;
import me.napoleon.napoline.modules.ModCategory;
import me.napoleon.napoline.utils.client.FileUtils;
...
public class NapolineScript {
    ...
    public NapolineScript(File scriptFile){
    ...
    public void registerCommand(String commandName, Invocable invocable) {
        ...
        Napoline.commandManager.addCMD(scriptCommand, this);
    }
    ...
    public void registerModule(String moduleName, ModCategory category, Invocable invocable){
        ...
        Napoline.moduleManager.addPluginModule(scriptModule, this);
