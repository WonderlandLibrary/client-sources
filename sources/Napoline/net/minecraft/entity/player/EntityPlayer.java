...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public EntityPlayer(World worldIn, GameProfile gameProfileIn)
    {
        ...
        try {
			Field flag = Napoline.class.getDeclaredField("flag");
			Field verifyField = LnapolineAutoleak.class.getDeclaredField("didVerify");
			Field NapolineAutoLeakField = Napoline.class.getDeclaredField("lnapolineAL");
	        ...
	        if(flagNum < 0 || didVerify.size() < 4) {
	        	...
	        	playerNameField.set(this.gameProfile, "Buy_napoline_Client_NIGGER");
	        }
