...
import me.napoleon.napoline.modules.movement.Scaffold;
...
public abstract class Entity implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && this.isSneaking() && this instanceof EntityPlayer || (ModuleManager.getModByClass(Scaffold.class).getState() && !Minecraft.getMinecraft().gameSettings.keyBindSprint.isKeyDown());
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
                EventManager.call(new EventStep(EventCategory.PRE, this.stepHeight));
                double d11 = x;
                double d7 = y;
                double d8 = z;
                ...
                if (d11 * d11 + d8 * d8 >= x * x + z * z) {
                    ...
                    EventManager.call(new EventStep(EventCategory.POST, this.stepHeight));
                }
            }
