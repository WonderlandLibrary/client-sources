...
import me.napoleon.napoline.modules.player.ChestStealer;
...
public abstract class GuiContainer extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (mc.thePlayer.openContainer instanceof ContainerChest && Napoline.moduleManager.getModByClass(ChestStealer.class).getState() && ChestStealer.nogui.getValue()) {
            mc.setIngameFocus();
            return;
        }
        ...
        if(!ModuleManager.getModByClass(FastGuis.class).getState()){
