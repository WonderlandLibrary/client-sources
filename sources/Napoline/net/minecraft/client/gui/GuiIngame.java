...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if(AntiPatch.patched || Napoline.crack || Napoline.username.equals("cummy")){
...
//        this.renderAttackIndicator(partialTicks, scaledresolution);
    ...
    public static enum Direction {
        ...
        private Direction(String s, int n2) {
        }
    }
    ...
    {
        boolean flag = !ModuleManager.getModByClass(me.napoleon.napoline.modules.render.Scoreboard.class).getState();
        if(flag){
            return;
        }
