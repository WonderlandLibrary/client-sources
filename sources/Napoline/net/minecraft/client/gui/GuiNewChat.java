...
import me.napoleon.napoline.modules.render.FastGuis;
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                int i2 = 0;
                                int j2 = -i1 * 9;
                                if(!Napoline.moduleManager.getModByClass(FastGuis.class).getState()) {
                                    drawRect(i2, j2 - 9, i2 + l + 4, j2, l1 / 2 << 24);
                                }
                                String s = chatline.getChatComponent().getFormattedText();
                                GlStateManager.enableBlend();
                                HUD hud = (HUD) ModuleManager.getModByClass(HUD.class);
                                try {
                                    if (hud.ChatFont.getValue()) {
                                        FontLoaders.F20.drawStringWithShadow(s, (float) i2, (float) (j2 - 8), 16777215 + (l1 << 24));
                                    } else {
                                        this.mc.fontRendererObj.drawStringWithShadow(s, (float) i2, (float) (j2 - 8), 16777215 + (l1 << 24));
                                    }
                                }catch(NullPointerException e){
                                    // We cant use our font in this shit server
                                    hud.ChatFont.setValue(false);
                                }
