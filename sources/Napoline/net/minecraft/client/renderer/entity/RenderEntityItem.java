...
import me.napoleon.napoline.junk.ClientPhysic;
import me.napoleon.napoline.modules.render.ItemPhysic;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if(Napoline.moduleManager.getModByClass(ItemPhysic.class).getState()) {
