...
import me.napoleon.napoline.modules.render.AntiInvisible;
import me.napoleon.napoline.modules.render.Chams;
import me.napoleon.napoline.modules.render.Nametag;
import me.napoleon.napoline.utils.player.RotationUtils;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
            ...
            try {
                ...
                if (this.renderOutlines) {
                    ...
                    if (!(entity instanceof EntityPlayer) || !((EntityPlayer) entity).isSpectator()) {
                        if (KillAura.target != entity || !Napoline.moduleManager.getModByClass(Chams.class).getState()) {
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor) {
        boolean flag = Napoline.moduleManager.getModByClass(AntiInvisible.class).getState() ? false : !entitylivingbaseIn.isInvisible();
        ...
        if (flag || flag1) {
            ...
            if (Napoline.moduleManager.getModByClass(Chams.class).getState()) {
                GL11.glPushMatrix();
                GL11.glPushAttrib((int) 1048575);
                RenderUtil.pre();
                GL11.glDisable((int) 2896);
                GL11.glPolygonMode((int) 1032, (int) 6914);
                if (RotationUtils.canEntityBeSeen(entitylivingbaseIn)) {
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
        ...
        boolean flag1 = entitylivingbaseIn.hurtTime > 0 || entitylivingbaseIn.deathTime > 0 || entitylivingbaseIn == KillAura.target;
    ...
    public void renderName(T entity, double x, double y, double z) {
        if (entity instanceof EntityPlayer && Napoline.moduleManager.getModByClass(Nametag.class).getState())
            return;
