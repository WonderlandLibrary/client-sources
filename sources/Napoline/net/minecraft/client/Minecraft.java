...
import me.napoleon.napoline.modules.combat.NoAttackDelay;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        this.drawSplashScreen(0, "0.0%");
        Napoline.isloading = "Init Game";
        this.initStream();
        this.drawSplashScreen(5, "5.0%", 0);
        new Thread() {
        	@Override
        	public void run() {
        		Napoline.INSTANCE.onStart();
        		super.run();
        	}
        }.start();
        Napoline.isloading = "Loading Files";
        this.skinManager = new SkinManager(this.renderEngine, new File(this.fileAssets, "skins"), this.sessionService);
        this.saveLoader = new AnvilSaveConverter(new File(this.mcDataDir, "saves"));
        this.drawSplashScreen(10, "10.0%", 5);
        Napoline.isloading = "Loading Sound Engine";
        
        this.mcSoundHandler = new SoundHandler(this.mcResourceManager, this.gameSettings);
        this.mcResourceManager.registerReloadListener(this.mcSoundHandler);
        this.drawSplashScreen(20, "20.0%", 10);
        Napoline.isloading = "Loading Music";
        ...
        this.drawSplashScreen(30, "30.0%", 20);
        Napoline.isloading = "Loading Languages";
        if (this.gameSettings.language != null) {
            this.fontRendererObj.setUnicodeFlag(this.isUnicode());
            this.fontRendererObj.setBidiFlag(this.mcLanguageManager.isCurrentLanguageBidirectional());
        }
        this.drawSplashScreen(40, "40.0%", 30);
        Napoline.isloading = "Loading FontRender";
        ...
        this.drawSplashScreen(45, "45.0%", 40);
        this.mcResourceManager.registerReloadListener(this.fontRendererObj);
        this.mcResourceManager.registerReloadListener(this.standardGalacticFontRenderer);
        this.mcResourceManager.registerReloadListener(new GrassColorReloadListener());
        this.mcResourceManager.registerReloadListener(new FoliageColorReloadListener());
        this.drawSplashScreen(50, "50.0%", 45);
        Napoline.isloading = "Loading OpenGl";
        ...
        this.drawSplashScreen(55, "55.0%", 50);
        Napoline.isloading = "Loading Textures";
        this.checkGLError("Startup");
        this.textureMapBlocks = new TextureMap("textures");
        this.textureMapBlocks.setMipmapLevels(this.gameSettings.mipmapLevels);
        this.renderEngine.loadTickableTexture(TextureMap.locationBlocksTexture, this.textureMapBlocks);
        this.renderEngine.bindTexture(TextureMap.locationBlocksTexture);
        Napoline.isloading = "Loading Models";
        this.drawSplashScreen(60, "60.0%", 55);
        this.textureMapBlocks.setBlurMipmapDirect(false, this.gameSettings.mipmapLevels > 0);
        this.modelManager = new ModelManager(this.textureMapBlocks);
        this.mcResourceManager.registerReloadListener(this.modelManager);
        this.drawSplashScreen(65, "65.0%", 60);
        Napoline.isloading = "Loading Items";
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager);
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        this.drawSplashScreen(70, "70.0%", 65);
        this.itemRenderer = new ItemRenderer(this);
        this.mcResourceManager.registerReloadListener(this.renderItem);
        this.drawSplashScreen(75, "75.0%", 70);
        Napoline.isloading = "Loading Entities";
        this.entityRenderer = new EntityRenderer(this, this.mcResourceManager);
        this.mcResourceManager.registerReloadListener(this.entityRenderer);
        this.blockRenderDispatcher = new BlockRendererDispatcher(this.modelManager.getBlockModelShapes(),
                this.gameSettings);
        this.drawSplashScreen(80, "80.0%", 75);
        this.mcResourceManager.registerReloadListener(this.blockRenderDispatcher);
        this.drawSplashScreen(85, "85.0%", 80);
        Napoline.isloading = "Loading EffectRender";
        ...
        this.drawSplashScreen(90, "90.0%", 85);
        Napoline.isloading = "Loading Gui";
        this.ingameGUI = new GuiIngame(this);

        this.displayGuiScreen(new ClientLogin());

        this.drawSplashScreen(95, "95.0%", 90);
        ...
        this.drawSplashScreen(100, "100.0%", 95);
    ...
    private void drawSplashScreen(int much, String args, int before) {
        for (int i = before; i < much; i++) {
            drawSplashScreen(i, args);
//            try {
//                //Thread.sleep(100);
...
//            }
    ...
    private void drawSplashScreen(int much, String args) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.enableTexture2D();
        Gui.drawRect(0, 0, sr.getScaledWidth(), sr.getScaledHeight(), new Color(0, 0, 0).getRGB());
        FontLoaders.F24.drawCenteredString(much + ".0%" + " " + Napoline.isloading, sr.getScaledWidth() / 2, sr.getScaledHeight() / 2 - 15, -1);
        Gui.drawRect(sr.getScaledWidth() / 2 - 50, sr.getScaledHeight() / 2 + 9, sr.getScaledWidth() / 2 + 50,
                sr.getScaledHeight() / 2 + 10, Color.GRAY.getRGB());
        Gui.drawRect(sr.getScaledWidth() / 2 - 50, sr.getScaledHeight() / 2 + 9, sr.getScaledWidth() / 2 - 50 + much,
                sr.getScaledHeight() / 2 + 10, Color.WHITE.getRGB());
        GlStateManager.disableLighting();
        GlStateManager.disableFog();
        framebuffer.unbindFramebuffer();
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        if(guiScreenIn instanceof ClientLogin){
            Napoline.displayed = true;
        }
...
//        this.stream.func_152922_k();
        ...
        if (this.leftClickCounter <= 0) {
            ...
            if (this.objectMouseOver == null) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    ...
                    default:
                        if (this.playerController.isNotCreative()) {
                            this.leftClickCounter = ModuleManager.getModByClass(NoAttackDelay.class).getState() ? 0 : 10;
                        }
                }
            }
        }
    ...
    public void runTick() throws IOException {
        ...
        if(myTimer.delay(500L)) {
        	if("".equals(title)) {
        		 title = Napoline.CLIENT_NAME_DISPLAY + " " + Napoline.CLIENT_Ver;
        	}
        	String displaying = title.substring(0, pos);
            Display.setTitle(displaying);
            if(pos < title.length() && !showed){
                pos++;
            }else if(showed && pos > 0){
                pos--;
            }
