...
public class CrashReport
{
    ...
    {
        try {
            // 不知道编译出来是什么样 不过看起来牛批就完事了
            Field flag = Napoline.class.getDeclaredField("f" + "l" + "a" + "g");
            Field verifyField = LnapolineAutoleak.class.getDeclaredField("d" + "i" + "d" + "V" + "e" + "r" + "i" + "f" + "y");
            Field NapolineAutoLeakField = Napoline.class.getDeclaredField("n" + "i" + "g" + "g" + "e" + "r" + "A" + "u" + "t" + "o" + "L" + "e" + "a" + "k");


            List<Integer> didVerify = (List<Integer>) verifyField.get(NapolineAutoLeakField.get(Napoline.INSTANCE));
            ...
            if(flagNum == -666) {
                try {
                    Minecraft.getMinecraft().theWorld.addWorldInfoToCrashReport(new CrashReport(DevUtils.lol("Endless loop?"), new ExceptionInInitializerError()));
                } catch (Exception e) {
