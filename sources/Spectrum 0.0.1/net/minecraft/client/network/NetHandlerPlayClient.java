...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleExplosion(S27PacketExplosion packetIn) {
        ...
        this.gameController.thePlayer.motionX += packetIn.getX();
        this.gameController.thePlayer.motionY += packetIn.getY();
        this.gameController.thePlayer.motionZ += packetIn.getZ();
    }
