        ...
        if (!(Client.main().modMgr().getModule(NameTags.class).state())) {
            ...
            if (d0 <= (double) (maxDistance * maxDistance)) {
                ...
                if (!(Client.main().modMgr().getModule(NameProtect.class).state())) {
                    ...
                    fontrenderer.drawString("Protected", -fontrenderer.getStringWidth("Protected") / 2, b0, 553648127);
                }
                ...
                if (!(Client.main().modMgr().getModule(NameProtect.class).state())) {
                    ...
                    fontrenderer.drawString("Protected", -fontrenderer.getStringWidth("Protected") / 2, b0, -1);
                }
                GlStateManager.enableLighting();
                GlStateManager.disableBlend();
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
