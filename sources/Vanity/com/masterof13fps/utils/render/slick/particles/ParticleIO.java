package com.masterof13fps.utils.render.slick.particles;
...
import com.masterof13fps.utils.render.slick.particles.ConfigurableEmitter.ColorRecord;
import com.masterof13fps.utils.render.slick.particles.ConfigurableEmitter.LinearInterpolator;
import com.masterof13fps.utils.render.slick.particles.ConfigurableEmitter.RandomValue;
import com.masterof13fps.utils.render.slick.particles.ConfigurableEmitter.SimpleValue;
...
public class ParticleIO {
   ...
   public static ParticleSystem loadConfiguredSystem(InputStream ref,
		...
		try {
         ...
         if (system == null) {
         system = new ParticleSystem("com/masterof13fps/utils/render/slick/data/particle.tga",
					2000, mask);
         }
