...
import com.masterof13fps.utils.render.slick.util.pathfinding.PathFindingContext;
import com.masterof13fps.utils.render.slick.util.pathfinding.TileBasedMap;
import com.masterof13fps.utils.render.slick.util.pathfinding.navmesh.Link;
import com.masterof13fps.utils.render.slick.util.pathfinding.navmesh.NavMesh;
import com.masterof13fps.utils.render.slick.util.pathfinding.navmesh.NavMeshBuilder;
import com.masterof13fps.utils.render.slick.util.pathfinding.navmesh.NavPath;
import com.masterof13fps.utils.render.slick.util.pathfinding.navmesh.Space;
...
public class NavMeshTest extends BasicGame implements PathFindingContext {
	...
	/*
	 * (non-Javadoc)
	 * @see de.crazymemecoke.utils.render.slick.util.pathfinding.PathFindingContext#getMover()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.crazymemecoke.utils.render.slick.util.pathfinding.PathFindingContext#getSearchDistance()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.crazymemecoke.utils.render.slick.util.pathfinding.PathFindingContext#getSourceX()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.crazymemecoke.utils.render.slick.util.pathfinding.PathFindingContext#getSourceY()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.crazymemecoke.utils.render.slick.BasicGame#mousePressed(int, int, int)
	 */
	...
	private class DataMap implements TileBasedMap {
		...
		/*
		 * (non-Javadoc)
		 * @see de.crazymemecoke.utils.render.slick.util.pathfinding.TileBasedMap#blocked(de.crazymemecoke.utils.render.slick.util.pathfinding.PathFindingContext, int, int)
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see de.crazymemecoke.utils.render.slick.util.pathfinding.TileBasedMap#getCost(de.crazymemecoke.utils.render.slick.util.pathfinding.PathFindingContext, int, int)
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see de.crazymemecoke.utils.render.slick.util.pathfinding.TileBasedMap#getHeightInTiles()
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see de.crazymemecoke.utils.render.slick.util.pathfinding.TileBasedMap#getWidthInTiles()
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see de.crazymemecoke.utils.render.slick.util.pathfinding.TileBasedMap#pathFinderVisited(int, int)
		 */
