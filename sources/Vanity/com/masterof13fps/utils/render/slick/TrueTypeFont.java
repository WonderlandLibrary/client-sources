...
import com.masterof13fps.utils.render.slick.opengl.GLUtils;
...
import com.masterof13fps.utils.render.slick.util.BufferedImageUtil;
...
public class TrueTypeFont implements Font {
	...
	public void drawString(float x, float y, String whatchars,
			com.masterof13fps.utils.render.slick.Color color) {
		drawString(x,y,whatchars,color,0,whatchars.length()-1);
	}
	
	/**
	 * @see Font#drawString(float, float, String, com.masterof13fps.utils.render.slick.Color, int, int)
	 */
	public void drawString(float x, float y, String whatchars,
                           com.masterof13fps.utils.render.slick.Color color, int startIndex, int endIndex) {
		color.bind();
		fontTexture.bind();
	 ...
	 */
	public void drawString(float x, float y, String whatchars) {
		drawString(x, y, whatchars, com.masterof13fps.utils.render.slick.Color.white);
	}
