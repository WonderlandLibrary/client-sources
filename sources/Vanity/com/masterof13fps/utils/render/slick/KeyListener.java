...
public interface KeyListener extends ControlledInputReciever {
	 ...
	 * 
	 * @param key The key code that was pressed (@see de.crazymemecoke.utils.render.slick.Input)
	 ...
	 * 
	 * @param key The key code that was released (@see de.crazymemecoke.utils.render.slick.Input)
