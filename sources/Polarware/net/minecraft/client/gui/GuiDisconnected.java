...
import com.polarware.component.impl.player.LastConnectionComponent;
...
public class GuiDisconnected extends GuiScreen {
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        ...
        if (button.id == 1) {
            this.mc.displayGuiScreen(new GuiConnecting(new GuiMultiplayer(new GuiMainMenu()), this.mc, new ServerData("", LastConnectionComponent.ip, false)));
        }
    }
