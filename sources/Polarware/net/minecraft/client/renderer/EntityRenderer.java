...
import com.polarware.module.impl.render.*;
...
import com.polarware.util.render.StencilUtil;
import com.polarware.util.shader.ShaderUtil;
...
public class EntityRenderer implements IResourceManagerReloadListener, InstanceAccess {
    ...
    private void hurtCameraEffect(final float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase) {
            ...
            final HurtCameraModule hurtCamera = Client.INSTANCE.getModuleManager().get(HurtCameraModule.class);
    ...
    public void orientCamera(final float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPlayerSleeping()) {
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                Module noCameraClip = Client.INSTANCE.getModuleManager().get(NoCameraClipModule.class);
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists()) {
            ...
            FreeLookModule freeLook = getModule(FreeLookModule.class);
...
//                    this.mc.ingameGUI.renderGameOverlay(partialTicks);
                    ...
                    InterfaceModule interfaceModule = getModule(InterfaceModule.class);
...
//            effectrenderer.renderLitParticles(entity, partialTicks);
    ...
    private void addRainParticles() {
        ...
        AmbienceModule ambience = Client.INSTANCE.getModuleManager().get(AmbienceModule.class);
                ...
                for (int l1 = i - i1; l1 <= i + i1; ++l1) {
                    ...
                    if (biomegenbase.canSpawnLightningBolt() || biomegenbase.getEnableSnow()) {
                        ...
                        if (k2 != l2) {
                            ...
                            final AmbienceModule ambience = Client.INSTANCE.getModuleManager().get(AmbienceModule.class);
    ...
    private void setupFog(final int p_78468_1_, final float partialTicks) {
        ...
        } else if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPotionActive(Potion.blindness) && !Client.INSTANCE.getModuleManager().get(NoBlindnes.class).isEnabled()) {
            float f4 = 5.0F;
            final int i = ((EntityLivingBase) entity).getActivePotionEffect(Potion.blindness).getDuration();
