...
import com.polarware.module.impl.render.FreeLookModule;
...
import com.polarware.event.impl.other.GameEvent;
import com.polarware.event.impl.other.LegitClickEvent;
import com.polarware.event.impl.other.TickEvent;
import com.polarware.ui.menu.impl.intro.IntroSequence;
import com.polarware.util.backend.BackendUtil;
...
//                        }
    ...
    public void runTick() throws IOException {
        ...
        if (this.theWorld != null && this.thePlayer != null) {
            RealyPlayerTick realyPlayerTick = new RealyPlayerTick();
            Client.INSTANCE.getEventBus().handle(realyPlayerTick);
        }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        if (this.gameSettings.keyBindTogglePerspective.isPressed()) {
                            ...
                            if (!Client.INSTANCE.getModuleManager().get(FreeLookModule.class).isEnabled()) {
            ...
            Client.INSTANCE.getEventBus().handle(new LegitClickEvent());
