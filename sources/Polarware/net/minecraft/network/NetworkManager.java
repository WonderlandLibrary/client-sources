...
import net.minecraft.viamcp.vialoadingbase.netty.event.CompressionReorderEvent;
import net.minecraft.viamcp.viamcp.MCPVLBPipeline;
...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    protected void channelRead0(final ChannelHandlerContext p_channelRead0_1_, final Packet p_channelRead0_2_) throws Exception {
        if (this.channel.isOpen()) {
            try {
                final PacketReceiveEvent event = new PacketReceiveEvent(p_channelRead0_2_,this.direction,getNetHandler());
    ...
    public void receivePacket(final Packet packet) {
        if (this.channel.isOpen()) {
            try {
                ...
                final PacketReceiveEvent event = new PacketReceiveEvent(packet, this.direction,getNetHandler());
                Client.INSTANCE.getEventBus().handle(event);
