package com.polarware.ui.click;

import com.polarware.Client;
import com.polarware.module.Module;
import com.polarware.module.api.Category;
import com.polarware.module.impl.render.ClickGUIModule;
import com.polarware.event.bus.Listener;
import com.polarware.event.Priority;
import com.polarware.event.annotations.EventLink;
import com.polarware.event.impl.render.AlphaEvent;
import com.polarware.ui.click.components.category.SidebarCategory;
import com.polarware.ui.click.components.value.ValueComponent;
import com.polarware.ui.click.components.value.impl.StringValueComponent;
import com.polarware.ui.click.screen.Screen;
import com.polarware.ui.click.screen.impl.ThemeScreen;
...
public final class RiseClickGUI extends GuiScreen implements InstanceAccess {
    ...
    public Vector2f moduleDefaultScale = new Vector2f(356, 38);
    ...
    public void onGuiClosed() {
        ...
        Client.INSTANCE.getModuleManager().get(ClickGUIModule.class).setEnabled(false);
    }
    ...
    public void renderGUI() {
        ...
        if (animationTime == 0) {
            ...
            Client.INSTANCE.getModuleManager().get(ClickGUIModule.class).toggle();
            return;
        }
