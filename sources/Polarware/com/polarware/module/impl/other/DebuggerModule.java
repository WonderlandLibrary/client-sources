...
public final class DebuggerModule extends Module implements InstanceAccess {
    ...
    public final Listener<Render2DEvent> onRender2D = event -> {
        ...
        if (devPanel.getValue()) {
            ...
            NORMAL_POST_RENDER_RUNNABLES.add(() -> {
                ...
                mc.fontRendererObj.drawString("Bot Amount: " + Client.INSTANCE.getBotComponent().size(), position.position.x + padding, position.position.y + padding * 7, Color.WHITE.hashCode());
