...
public class ManagerModule extends Module {
    ...
    private final BoundsNumberValue startdelay = new BoundsNumberValue("Start Delay", this, 100, 150, 0, 500, 50);
    ...
    public final Listener<PreMotionEvent> onPreMotionEvent = event -> {
        ...
        if (!this.getModule(InventoryMoveModule.class).isEnabled() && !(mc.currentScreen instanceof GuiInventory)) {
            return;
        }
        ...
        if (block != -1 && block != this.blockSlot.getValue().intValue() - 1 && !this.getModule(ScaffoldModule.class).isEnabled()) {
    ...
    private boolean canOpenInventory() {
        return this.getModule(InventoryMoveModule.class).isEnabled() && !(mc.currentScreen instanceof GuiInventory);
    }
