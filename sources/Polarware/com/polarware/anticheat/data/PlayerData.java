package com.polarware.anticheat.data;
...
import com.polarware.anticheat.util.PacketUtil;
...
public final class PlayerData {
    ...
    public void handle(final Packet<?> packet) {
        ...
        if (Client.INSTANCE.getBotComponent().contains(this.player) || !this.player.moved || this.player.isInvisibleToPlayer(Minecraft.getMinecraft().thePlayer)) {
            return;
        }
