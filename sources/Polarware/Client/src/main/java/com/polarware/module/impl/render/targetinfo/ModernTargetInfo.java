package com.polarware.module.impl.render.targetinfo;

import com.polarware.component.impl.render.ParticleComponent;
import com.polarware.module.impl.render.TargetInfoModule;
...
import static com.polarware.util.animation.Easing.*;

public class ModernTargetInfo extends Mode<TargetInfoModule> {
...
//        add(new SubMode("Solid")); looks ass
    ...
    private TargetInfoModule targetInfoModule;
    ...
    public ModernTargetInfo(String name, TargetInfoModule parent) {
        super(name, parent);
    }
    ...
    public final Listener<Render2DEvent> onRender2D = event -> {
        ...
        if (this.targetInfoModule == null) {
            this.targetInfoModule = this.getModule(TargetInfoModule.class);
        }
        ...
        double health = Math.min(!this.targetInfoModule.inWorld ? 0 : Math.round(((AbstractClientPlayer) target).getHealth()), ((AbstractClientPlayer) target).getMaxHealth());
