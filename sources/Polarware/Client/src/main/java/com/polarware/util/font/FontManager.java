package com.polarware.util.font;

import com.polarware.util.font.impl.rise.FontRenderer;
import com.polarware.util.font.impl.rise.FontUtil;
...
public class FontManager {
    ...
    public static Font getIconsTwo(final int size) {
        return get(ICONS_3, size, "Icon-2", true, true);
    }
