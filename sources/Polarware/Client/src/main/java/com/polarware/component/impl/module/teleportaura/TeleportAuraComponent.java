package com.polarware.component.impl.module.teleportaura;
...
import com.polarware.util.pathfinding.unlegit.MainPathFinder;
...
public class TeleportAuraComponent extends Component {
    ...
    private TeleportAuraModule tpa;
    public static boolean enabled;

    public TeleportAuraComponent() {
        this.tpa = getModule(TeleportAuraModule.class);
    }
    ...
    public EntityLivingBase getTarget() {
        ...
        if (!mc.theWorld.loadedEntityList.contains(tpa.target == null ? mc.thePlayer : tpa.target) || tpa.attacked) {
            List<EntityLivingBase> targets = Client.INSTANCE.getTargetComponent().getTargets(tpa.range.getValue().doubleValue());
