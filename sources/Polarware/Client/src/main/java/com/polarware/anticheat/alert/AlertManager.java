package com.polarware.anticheat.alert;

import com.polarware.anticheat.check.Check;
import com.polarware.module.impl.other.CheatDetectorModule;
...
public final class AlertManager implements InstanceAccess {
    ...
    public void sendAlert(final Check check) {
        ...
        switch (getModule(CheatDetectorModule.class).alertType.getValue().getName()) {
            case "ClientSide":
