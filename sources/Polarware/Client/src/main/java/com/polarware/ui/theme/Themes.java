package com.polarware.ui.theme;
...
public enum Themes implements ColorUtil {
    ...
    BLUE_WHITE(":fire:", new Color(66, 134, 244), Color.white, BLUE, KeyColors.RED),
    ...
    LOYINA("Loyina", new Color(74, 0, 224), Color.BLACK, BLUE, KeyColors.DARK_BLUE, KeyColors.PURPLE),
    ...
    public double getBlendFactor(Vector2d screenCoordinates) {
        return Math.sin(System.currentTimeMillis() / 200.0D
