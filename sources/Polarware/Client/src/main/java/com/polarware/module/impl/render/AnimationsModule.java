...
import com.polarware.event.impl.render.SwingAnimationEvent;
        ...
        if (event.isUseItem() && itemAction == EnumAction.BLOCK) {
            ...
            switch (blockAnimation.getValue().getName()) {
                ...
                case "Xiv": {
                    ...
                    itemRenderer.blockTransformation();
                    final float var16 = MathHelper.sin((float) (swingProgress * swingProgress * Math.PI));
                ...
                case "Remake": {
                    ...
                    //       GlStateManager.rotate(-var16 * 20.0f, 0.0f, 1.0f, 0.0f);
                    GlStateManager.rotate(-var * 20.0f, 0.0f, 0.0f, 1.0f);
                    GlStateManager.rotate(-var * 10, 1.0f, 0.0f, 0.0f);
                    break;
                }
                ...
                case "Leaked": {
                    ...
                    //GlStateManager.rotate(convertedProgress * 40.0F / 2.0F, 0.0F, 1.0F, 1.5F);
