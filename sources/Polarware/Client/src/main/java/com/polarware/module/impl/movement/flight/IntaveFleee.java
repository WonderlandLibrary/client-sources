...
public class IntaveFleee extends Mode<FlightModule> {

    private int ticks;

    public IntaveFleee(String name, FlightModule parent) {
        super(name, parent);
    }
    ...
    public void onEnable() {
        ticks = 0;
        NotificationComponent.post("Insane flee made by nyghtfull","Use boat fo fleeeeeee!??!");
