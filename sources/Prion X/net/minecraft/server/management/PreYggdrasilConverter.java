...
public class PreYggdrasilConverter
{
  ...
  private static void lookupNames(MinecraftServer server, Collection names, ProfileLookupCallback callback) { String[] var3 = (String[])Iterators.toArray(Iterators.filter(names.iterator(), new Predicate()
    {
    ...
    {
      server.getGameProfileRepository().findProfilesByNames(var3, com.mojang.authlib.Agent.MINECRAFT, callback);
    }
    else
    {
      String[] var4 = var3;
      ...
      for (int var6 = 0; var6 < var5; var6++)
      {
        ...
        UUID var8 = EntityPlayer.getUUID(new GameProfile(null, var7));
      ...
      if ((!var1.isSinglePlayer()) && (var1.isServerInOnlineMode()))
      {
        ...
        ProfileLookupCallback var4 = new ProfileLookupCallback()
        {
          ...
          public void onProfileLookupSucceeded(GameProfile p_onProfileLookupSucceeded_1_) {
            getPlayerProfileCache().func_152649_a(p_onProfileLookupSucceeded_1_);
