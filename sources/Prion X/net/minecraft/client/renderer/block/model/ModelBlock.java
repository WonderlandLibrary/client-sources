...
public class ModelBlock
{
  ...
  {
    this(p_i46226_1_, java.util.Collections.emptyList(), p_i46226_2_, p_i46226_3_, p_i46226_4_, p_i46226_5_);
  }
  ...
  {
    return !"missingno".equals(resolveTextureName(p_178300_1_));
  }
  ...
  public String resolveTextureName(String p_178308_1_)
  {
    ...
    return resolveTextureName(p_178308_1_, new Bookkeep(null));
  }
  ...
  private String resolveTextureName(String p_178302_1_, Bookkeep p_178302_2_)
  {
    if (isTextureName(p_178302_1_))
    {
      ...
      {
        LOGGER.warn("Unable to resolve texture due to upward reference: " + p_178302_1_ + " in " + field_178317_b);
        return "missingno";
      }
      ...
      {
        var3 = model.resolveTextureName(var3, p_178302_2_);
      }
  ...
  {
    return (parent != null) && (itemCameraTransforms.field_178355_b == ItemTransformVec3f.field_178366_a) ? parent.getThirdPersonTransform() : itemCameraTransforms.field_178355_b;
  }
  
  public ItemTransformVec3f getFirstPersonTransform()
  {
    return (parent != null) && (itemCameraTransforms.field_178356_c == ItemTransformVec3f.field_178366_a) ? parent.getFirstPersonTransform() : itemCameraTransforms.field_178356_c;
  }
  
  public ItemTransformVec3f getHeadTransform()
  {
    return (parent != null) && (itemCameraTransforms.field_178353_d == ItemTransformVec3f.field_178366_a) ? parent.getHeadTransform() : itemCameraTransforms.field_178353_d;
  }
  
  public ItemTransformVec3f getInGuiTransform()
  {
    return (parent != null) && (itemCameraTransforms.field_178354_e == ItemTransformVec3f.field_178366_a) ? parent.getInGuiTransform() : itemCameraTransforms.field_178354_e;
  }
  ...
  public static void func_178312_b(Map p_178312_0_)
  {
    ...
    while (var1.hasNext())
    {
      ...
      try
      {
        ModelBlock var3 = parent;
        
        for (ModelBlock var4 = parent; var3 != var4; var4 = parent.parent)
        {
          var3 = parent;
        }
  ...
  public static class Deserializer implements JsonDeserializer {
    ...
    public ModelBlock func_178327_a(JsonElement p_178327_1_, Type p_178327_2_, JsonDeserializationContext p_178327_3_) {
      ...
      List var5 = getModelElements(p_178327_3_, var4);
      String var6 = getParent(var4);
      boolean var7 = org.apache.commons.lang3.StringUtils.isEmpty(var6);
      ...
      Map var9 = getTextures(var4);
      boolean var10 = getAmbientOcclusionEnabled(var4);
