...
public class ItemTransformVec3f
{
  ...
  static class Deserializer implements JsonDeserializer
  {
    ...
    public ItemTransformVec3f func_178359_a(JsonElement p_178359_1_, Type p_178359_2_, JsonDeserializationContext p_178359_3_) { JsonObject var4 = p_178359_1_.getAsJsonObject();
      Vector3f var5 = func_178358_a(var4, "rotation", field_178362_a);
      Vector3f var6 = func_178358_a(var4, "translation", field_178360_b);
      var6.scale(0.0625F);
      MathHelper.clamp_double(x, -1.5D, 1.5D);
      MathHelper.clamp_double(y, -1.5D, 1.5D);
      MathHelper.clamp_double(z, -1.5D, 1.5D);
      Vector3f var7 = func_178358_a(var4, "scale", field_178361_c);
      MathHelper.clamp_double(x, -1.5D, 1.5D);
      MathHelper.clamp_double(y, -1.5D, 1.5D);
      MathHelper.clamp_double(z, -1.5D, 1.5D);
