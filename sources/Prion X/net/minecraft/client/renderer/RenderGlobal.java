...
public class RenderGlobal implements net.minecraft.world.IWorldAccess, net.minecraft.client.resources.IResourceManagerReloadListener
{
  ...
  {
    return (field_175015_z != null) && (field_174991_A != null) && (mc.thePlayer != null) && (mc.thePlayer.func_175149_v()) && (mc.gameSettings.field_178883_an.getIsKeyPressed());
  }
    ...
    else
    {
      ...
      if (func_174985_d())
      {
        ...
        for (var18 = 0; var18 < var17.size(); var18++)
        {
          ...
          boolean var26 = (var19.isInRangeToRender3d(var4, var6, var8)) && ((ignoreFrustumCheck) || (p_180446_2_.isBoundingBoxInFrustum(var19.getEntityBoundingBox())) || (riddenByEntity == mc.thePlayer)) && ((var19 instanceof EntityPlayer));
          
          if (((var19 != mc.func_175606_aa()) || (mc.gameSettings.thirdPersonView != 0) || (var25)) && (var26))
          {
            field_175010_j.renderEntitySimple(var19, partialTicks);
          }
        }
          ...
          ((Iterator)var27).hasNext())
      {
        ...
        if (var32.size() > 0)
        {
          ...
          boolean var34 = (field_175010_j.func_178635_a(var30, p_180446_2_, var4, var6, var8)) || (riddenByEntity == mc.thePlayer);
          
          if (var34)
          {
            boolean teClass = (mc.func_175606_aa() instanceof EntityLivingBase) ? ((EntityLivingBase)mc.func_175606_aa()).isPlayerSleeping() : false;
            
            if (((var30 != mc.func_175606_aa()) || (mc.gameSettings.thirdPersonView != 0) || (teClass)) && ((posY < 0.0D) || (posY >= 256.0D) || (theWorld.isBlockLoaded(new BlockPos(var30)))))
            {
  ...
  public void func_174976_a(float partialTicks, int pass)
  {
    ...
    {
      WorldProvider var3 = mc.theWorld.provider;
    ...
    else if (mc.theWorld.provider.isSurfaceWorld())
    {
      ...
      var221 = CustomColorizer.getSkyColor(var221, mc.theWorld, mc.func_175606_aa().posX, mc.func_175606_aa().posY + 1.0D, mc.func_175606_aa().posZ);
      ...
      double var29 = mc.thePlayer.func_174824_e(partialTicks).yCoord - theWorld.getHorizon();
