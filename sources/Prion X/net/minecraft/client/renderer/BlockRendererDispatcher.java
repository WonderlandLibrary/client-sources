...
public class BlockRendererDispatcher implements IResourceManagerReloadListener
{
  ...
  public boolean func_175018_a(IBlockState p_175018_1_, BlockPos p_175018_2_, IBlockAccess p_175018_3_, WorldRenderer p_175018_4_)
  {
    try
    {
      ...
      {
      case 1: 
        return fluidRenderer.func_178270_a(p_175018_3_, p_175018_1_, p_175018_2_, p_175018_4_);
      
      case 2: 
        return false;
      
      case 3: 
        IBakedModel var9 = getModelFromBlockState(p_175018_1_, p_175018_3_, p_175018_2_);
        return blockModelRenderer.func_178259_a(p_175018_3_, var9, p_175018_1_, p_175018_2_, p_175018_4_);
      }
