...
public class LayerSnowmanHead implements LayerRenderer
{
  ...
  public void func_177151_a(EntitySnowman p_177151_1_, float p_177151_2_, float p_177151_3_, float p_177151_4_, float p_177151_5_, float p_177151_6_, float p_177151_7_, float p_177151_8_)
  {
    if (!p_177151_1_.isInvisible())
    {
      ...
      Minecraft.getMinecraft().getItemRenderer().renderItem(p_177151_1_, new ItemStack(net.minecraft.init.Blocks.pumpkin, 1), net.minecraft.client.renderer.block.model.ItemCameraTransforms.TransformType.HEAD);
  ...
  {
    func_177151_a((EntitySnowman)p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_, p_177141_6_, p_177141_7_, p_177141_8_);
  }
}
