...
public class LayerHeldItem implements LayerRenderer
{
  ...
  public void doRenderLayer(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_, float p_177141_5_, float p_177141_6_, float p_177141_7_, float p_177141_8_)
  {
    ...
    if (var9 != null)
    {
      ...
      if (((p_177141_1_ instanceof EntityPlayer)) && (fishEntity != null))
      {
      ...
      if (((var13 instanceof net.minecraft.item.ItemBlock)) && (Block.getBlockFromItem(var13).getRenderType() == 2))
      {
      ...
      var11.getItemRenderer().renderItem(p_177141_1_, var9, net.minecraft.client.renderer.block.model.ItemCameraTransforms.TransformType.THIRD_PERSON);
