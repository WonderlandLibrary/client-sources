...
public class LayerHeldItemWitch implements LayerRenderer
{
  ...
  public void func_177143_a(EntityWitch p_177143_1_, float p_177143_2_, float p_177143_3_, float p_177143_4_, float p_177143_5_, float p_177143_6_, float p_177143_7_, float p_177143_8_)
  {
    ...
    if (var9 != null)
    {
      ...
      field_177144_a.getMainModel()).villagerNose.postRender(0.0625F);
      GlStateManager.translate(-0.0625F, 0.53125F, 0.21875F);
      Item var13 = var9.getItem();
      Minecraft var11 = Minecraft.getMinecraft();
      

      if (((var13 instanceof net.minecraft.item.ItemBlock)) && (var11.getBlockRendererDispatcher().func_175021_a(net.minecraft.block.Block.getBlockFromItem(var13), var9.getMetadata())))
      {
      ...
      else if (var13 == net.minecraft.init.Items.bow)
      {
      ...
      var11.getItemRenderer().renderItem(p_177143_1_, var9, net.minecraft.client.renderer.block.model.ItemCameraTransforms.TransformType.THIRD_PERSON);
