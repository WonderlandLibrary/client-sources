...
public class RenderTNTPrimed extends Render
{
  ...
  public void doRender(EntityTNTPrimed p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
  {
    ...
    if (fuse - p_76986_9_ + 1.0F < 10.0F)
    {
      float var11 = 1.0F - (fuse - p_76986_9_ + 1.0F) / 10.0F;
    ...
    float var11 = (1.0F - (fuse - p_76986_9_ + 1.0F) / 100.0F) * 0.8F;
  ...
  {
    doRender((EntityTNTPrimed)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
  }
}
