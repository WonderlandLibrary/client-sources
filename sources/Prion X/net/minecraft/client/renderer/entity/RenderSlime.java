...
public class RenderSlime extends RenderLiving
{
  ...
  {
    shadowSize = (0.25F * p_177124_1_.getSlimeSize());
  ...
  protected void preRenderCallback(EntitySlime p_77041_1_, float p_77041_2_)
  {
    ...
    float var4 = (prevSquishFactor + (squishFactor - prevSquishFactor) * p_77041_2_) / (var3 * 0.5F + 1.0F);
  ...
  {
    doRender((EntitySlime)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
  }
  ...
  {
    preRenderCallback((EntitySlime)p_77041_1_, p_77041_2_);
  }
  ...
  {
    return getEntityTexture((EntitySlime)p_110775_1_);
  }
