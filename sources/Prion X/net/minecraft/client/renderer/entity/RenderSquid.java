...
public class RenderSquid extends RenderLiving
{
  ...
  {
    float var5 = prevSquidPitch + (squidPitch - prevSquidPitch) * p_77043_4_;
    float var6 = prevSquidYaw + (squidYaw - prevSquidYaw) * p_77043_4_;
  ...
  {
    return lastTentacleAngle + (tentacleAngle - lastTentacleAngle) * p_77044_2_;
  }
