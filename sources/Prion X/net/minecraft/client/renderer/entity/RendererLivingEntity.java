  ...
  extends Render
{
  ...
  public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
  {
    ...
    try
    {
      float var10 = interpolateRotation(prevRenderYawOffset, renderYawOffset, p_76986_9_);
      float var11 = interpolateRotation(prevRotationYawHead, rotationYawHead, p_76986_9_);
      float var12 = var11 - var10;
      

      if ((p_76986_1_.isRiding()) && ((ridingEntity instanceof EntityLivingBase)))
      {
        EntityLivingBase var13 = (EntityLivingBase)ridingEntity;
        var10 = interpolateRotation(prevRenderYawOffset, renderYawOffset, p_76986_9_);
        var12 = var11 - var10;
      ...
      float var20 = prevRotationPitch + (rotationPitch - prevRotationPitch) * p_76986_9_;
      renderLivingAt(p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_);
      float var14 = handleRotationFloat(p_76986_1_, p_76986_9_);
      rotateCorpse(p_76986_1_, var14, var10, p_76986_9_);
      ...
      mainModel.setRotationAngles(var17, var16, var14, var12, var20, 0.0625F, p_76986_1_);
      

      if (field_177098_i)
      {
        boolean var18 = func_177088_c(p_76986_1_);
        renderModel(p_76986_1_, var17, var16, var14, var12, var20, 0.0625F);
      ...
      else
      {
        ...
        {
          func_177093_a(p_76986_1_, var17, var16, p_76986_9_, var14, var12, var20, 0.0625F);
        }
      }
  ...
  protected boolean func_177088_c(EntityLivingBase p_177088_1_)
  {
    ...
    if ((p_177088_1_ instanceof EntityPlayer))
    {
      ...
      if (var3 != null)
      {
        ...
        if (var4.length() >= 2)
        {
          var2 = getFontRendererFromRenderManager().func_175064_b(var4.charAt(1));
        }
      }
    }
  ...
  protected void rotateCorpse(EntityLivingBase p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_)
  {
    ...
    if (deathTime > 0)
    {
      float var5 = (deathTime + p_77043_4_ - 1.0F) / 20.0F * 1.6F;
      ...
      GlStateManager.rotate(var5 * getDeathMaxRotation(p_77043_1_), 0.0F, 0.0F, 1.0F);
    }
    else
    {
  ...
  public void passSpecialRender(EntityLivingBase p_77033_1_, double p_77033_2_, double p_77033_4_, double p_77033_6_)
  {
    if (canRenderName(p_77033_1_))
    {
      ...
      if (var8 < var10 * var10)
      {
        ...
        if (((ModuleManager.getModByName("Nametags").isEnabled()) || ((ModuleManager.getModByName("Stream").isEnabled()) && (!Friends.isFriend(ChatColor.stripColor(var11))))) && ((p_77033_1_ instanceof EntityPlayer))) {
          return;
        }
        if (Friends.isFriend(ChatColor.stripColor(var11))) {
          String alias = Friends.getAlias(ChatColor.stripColor(var11));
          var11 = alias;
        }
