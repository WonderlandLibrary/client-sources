...
public class ItemRenderer
{
  ...
  private void func_178097_a(AbstractClientPlayer p_178097_1_, float p_178097_2_, float p_178097_3_, float p_178097_4_)
  {
    ...
    var11.draw();
    net.minecraft.world.storage.MapData var13 = Items.filled_map.getMapData(itemToRender, mc.theWorld);
  ...
  {
    if (me.hexxed.mercury.modulebase.ModuleManager.getModByName("Freecam").isEnabled()) {
      return;
    }
    ...
    if (itemToRender != null)
    {
      ...
      else if (var3.getItemInUseCount() > 0)
      {
        ...
        case 4: 
          ...
          func_178103_d();
          if (var7 != EnumAction.BLOCK) break;
  ...
  public void renderOverlays(float p_78447_1_)
  {
    ...
    {
      IBlockState var2 = mc.theWorld.getBlockState(new BlockPos(mc.thePlayer));
      EntityPlayerSP var3 = mc.thePlayer;
