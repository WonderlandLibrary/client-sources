...
public class ActiveRenderInfo
{
  ...
  public static void updateRenderInfo(EntityPlayer p_74583_0_, boolean p_74583_1_)
  {
    ...
    float var5 = rotationPitch;
    float var6 = rotationYaw;
    rotationX = MathHelper.cos(var6 * 3.1415927F / 180.0F) * (1 - var4 * 2);
    rotationZ = MathHelper.sin(var6 * 3.1415927F / 180.0F) * (1 - var4 * 2);
    rotationYZ = -rotationZ * MathHelper.sin(var5 * 3.1415927F / 180.0F) * (1 - var4 * 2);
    rotationXY = rotationX * MathHelper.sin(var5 * 3.1415927F / 180.0F) * (1 - var4 * 2);
    rotationXZ = MathHelper.cos(var5 * 3.1415927F / 180.0F);
  }
  
  public static Vec3 func_178806_a(Entity p_178806_0_, double p_178806_1_)
  {
    double var3 = prevPosX + (posX - prevPosX) * p_178806_1_;
    double var5 = prevPosY + (posY - prevPosY) * p_178806_1_;
    double var7 = prevPosZ + (posZ - prevPosZ) * p_178806_1_;
    double var9 = var3 + field_178811_exCoord;
    double var11 = var5 + field_178811_eyCoord;
    double var13 = var7 + field_178811_ezCoord;
    return new Vec3(var9, var11, var13);
  }
  
  public static Block func_180786_a(World worldIn, Entity p_180786_1_, float p_180786_2_)
  {
    Vec3 var3 = func_178806_a(p_180786_1_, p_180786_2_);
