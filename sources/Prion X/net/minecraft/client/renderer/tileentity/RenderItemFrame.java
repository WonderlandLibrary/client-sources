  ...
  private void func_82402_b(EntityItemFrame p_82402_1_)
  {
    ...
    if (var2 != null)
    {
      ...
      if (var4 == Items.filled_map)
      {
        ...
        net.minecraft.world.storage.MapData var7 = Items.filled_map.getMapData(var3.getEntityItem(), worldObj);
        GlStateManager.translate(0.0F, 0.0F, -1.0F);
        
        if (var7 != null)
        {
          field_147917_g.entityRenderer.getMapItemRenderer().func_148250_a(var7, true);
        }
      }
      else
      {
        ...
        {
          var12 = field_147917_g.getTextureMapBlocks().getAtlasSprite(TextureCompass.field_176608_l);
          ...
          if ((var12 instanceof TextureCompass))
          {
            ...
            currentAngle = 0.0D;
            angleDelta = 0.0D;
            var13.updateCompass(worldObj, posX, posZ, MathHelper.wrapAngleTo180_float(180 + field_174860_b.getHorizontalIndex() * 90), false, true);
            currentAngle = var8;
            angleDelta = var10;
          }
          else
