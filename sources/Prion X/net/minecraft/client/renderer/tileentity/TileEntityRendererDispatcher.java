...
public class TileEntityRendererDispatcher
{
  ...
  private TileEntityRendererDispatcher()
  {
    ...
    Iterator var1 = mapSpecialRenderers.values().iterator();
  ...
  public void func_178470_a(World worldIn, TextureManager p_178470_2_, FontRenderer p_178470_3_, Entity p_178470_4_, float p_178470_5_)
  {
    ...
    field_147562_h = (prevRotationYaw + (rotationYaw - prevRotationYaw) * p_178470_5_);
    field_147563_i = (prevRotationPitch + (rotationPitch - prevRotationPitch) * p_178470_5_);
    field_147560_j = (lastTickPosX + (posX - lastTickPosX) * p_178470_5_);
    field_147561_k = (lastTickPosY + (posY - lastTickPosY) * p_178470_5_);
    field_147558_l = (lastTickPosZ + (posZ - lastTickPosZ) * p_178470_5_);
  }
  
  public void func_180546_a(TileEntity p_180546_1_, float p_180546_2_, int p_180546_3_)
  {
    if (p_180546_1_.getDistanceSq(field_147560_j, field_147561_k, field_147558_l) < p_180546_1_.getMaxRenderDistanceSquared())
    {
      int var4 = worldObj.getCombinedLight(p_180546_1_.getPos(), 0);
      int var5 = var4 % 65536;
      int var6 = var4 / 65536;
      ...
      func_178469_a(p_180546_1_, var7.getX() - staticPlayerX, var7.getY() - staticPlayerY, var7.getZ() - staticPlayerZ, p_180546_2_, p_180546_3_);
    }
  }
  ...
  {
    TileEntitySpecialRenderer var10 = getSpecialRenderer(p_178469_1_);
    ...
    if (var10 != null)
    {
      ...
      catch (Throwable var14)
      {
        ...
        throw new net.minecraft.util.ReportedException(var12);
      }
    }
  }
