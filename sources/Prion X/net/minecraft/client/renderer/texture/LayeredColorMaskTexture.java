...
public class LayeredColorMaskTexture extends AbstractTexture
{
  ...
  public void loadTexture(IResourceManager p_110551_1_) throws IOException
  {
    ...
    try
    {
      BufferedImage var3 = TextureUtil.func_177053_a(p_110551_1_.getResource(field_174948_g).getInputStream());
      ...
      BufferedImage var2 = new BufferedImage(var3.getWidth(), var3.getHeight(), var4);
      Graphics var5 = var2.getGraphics();
      var5.drawImage(var3, 0, 0, null);
      
      int var6 = 0;
      do {
        String var7 = (String)field_174949_h.get(var6);
        MapColor var8 = ((EnumDyeColor)field_174950_i.get(var6)).func_176768_e();
          ...
          if ((var10.getWidth() == var2.getWidth()) && (var10.getHeight() == var2.getHeight()) && (var10.getType() == 6))
          {
            for (int var11 = 0; var11 < var10.getHeight(); var11++)
            {
              for (int var12 = 0; var12 < var10.getWidth(); var12++)
              {
                ...
                if ((var13 & 0xFF000000) != 0)
                {
                  int var14 = (var13 & 0xFF0000) << 8 & 0xFF000000;
                  int var15 = var3.getRGB(var12, var11);
                  int var16 = MathHelper.func_180188_d(var15, colorValue) & 0xFFFFFF;
        ...
        var6++; if (var6 >= field_174949_h.size()) break; } while (var6 < field_174950_i.size());
    ...
    catch (IOException var17)
    {
      ...
      field_174947_f.error("Couldn't load layered image", var17); return;
    }
