...
public class LoadingScreenRenderer implements net.minecraft.util.IProgressUpdate
{
  ...
  {
    mc = mcIn;
    field_146587_f = new ScaledResolution(mcIn, displayWidth, displayHeight);
  ...
  public void setLoadingProgress(int progress)
  {
    ...
    else
    {
      ...
      if (var2 - field_73723_d >= 100L)
      {
        ...
        mc.fontRendererObj.func_175063_a(currentlyDisplayedText, (var6 - mc.fontRendererObj.getStringWidth(currentlyDisplayedText)) / 2, var7 / 2 - 4 - 16, 16777215);
        mc.fontRendererObj.func_175063_a(field_73727_a, (var6 - mc.fontRendererObj.getStringWidth(field_73727_a)) / 2, var7 / 2 - 4 + 8, 16777215);
