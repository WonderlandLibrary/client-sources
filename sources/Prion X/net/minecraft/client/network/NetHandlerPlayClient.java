...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
  ...
  public void handleSpawnObject(S0EPacketSpawnObject packetIn)
  {
    ...
    {
      var8 = new EntityEnderCrystal(clientWorldController, var2, var4, var6);
    }
  ...
  public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn)
  {
    ...
    EntityOtherPlayerMP var10 = new EntityOtherPlayerMP(gameController.theWorld, func_175102_a(packetIn.func_179819_c()).func_178845_a());
  ...
  public void addToSendQueue(Packet p_147297_1_)
  {
    for (Module m : ModuleManager.moduleList) {
      if (m.isEnabled()) {
        m.onPacketSend(p_147297_1_);
        if ((m.isOutboundPacketCancelled()) && (!getValuesconvertpacket)) {
          m.setOutboundPacketCancelled(false);
          return;
        }
      }
    }
  ...
  {
    getValuesinboundmessage = packetIn.func_148915_c().getFormattedText();
    for (Module m : ModuleManager.moduleList) {
      if (m.isEnabled()) {
        m.onChatRecieving(packetIn.func_148915_c().getFormattedText());
        if (m.isInboundMessageCancelled()) {
          m.setInboundMessageCancelled(false);
          return;
        }
      }
    }
    String result = getValuesinboundmessage;
    PacketThreadUtil.func_180031_a(packetIn, this, gameController);
    ChatComponentText chat = new ChatComponentText(result);
    if (packetIn.func_179841_c() == 2)
    {
      gameController.ingameGUI.func_175188_a(chat, false);
    }
    else
    {
      gameController.ingameGUI.getChatGUI().printChatMessage(chat);
    }
  }
  ...
  public void handleSpawnMob(S0FPacketSpawnMob packetIn)
  {
    ...
    EntityLivingBase var10 = (EntityLivingBase)EntityList.createEntityByID(packetIn.func_149025_e(), gameController.theWorld);
  ...
  public void handleUpdateHealth(S06PacketUpdateHealth packetIn)
  {
    ...
    for (Module m : ModuleManager.moduleList) {
      if ((m.isEnabled()) && (lasthp > packetIn.getHealth())) {
        m.onDamage();
      }
    }
    lasthp = packetIn.getHealth();
  ...
  {
    PacketThreadUtil.func_180031_a(packetIn, this, gameController);
    gameController.thePlayer.setXPStats(packetIn.func_149397_c(), packetIn.func_149396_d(), packetIn.func_149395_e());
  }
  ...
  public void handleRespawn(S07PacketRespawn packetIn)
  {
    ...
    if (packetIn.func_149082_c() != gameController.thePlayer.dimension)
    {
      ...
      clientWorldController = new WorldClient(this, new WorldSettings(0L, packetIn.func_149083_e(), false, gameController.theWorld.getWorldInfo().isHardcoreModeEnabled(), packetIn.func_149080_f()), packetIn.func_149082_c(), packetIn.func_149081_d(), gameController.mcProfiler);
  ...
  {
    PacketThreadUtil.func_180031_a(packetIn, this, gameController);
    Explosion var2 = new Explosion(gameController.theWorld, null, packetIn.func_149148_f(), packetIn.func_149143_g(), packetIn.func_149145_h(), packetIn.func_149146_i(), packetIn.func_149150_j());
  ...
  public void handleUpdateSign(S33PacketUpdateSign packetIn)
  {
    ...
    {
      gameController.thePlayer.addChatMessage(new ChatComponentText("Unable to locate sign at " + packetIn.func_179704_a().getX() + ", " + packetIn.func_179704_a().getY() + ", " + packetIn.func_179704_a().getZ()));
    }
  }
  ...
  {
    PacketThreadUtil.func_180031_a(packetIn, this, gameController);
    gameController.theWorld.addBlockEvent(packetIn.func_179825_a(), packetIn.getBlockType(), packetIn.getData1(), packetIn.getData2());
  }
  ...
  {
    PacketThreadUtil.func_180031_a(packetIn, this, gameController);
    gameController.theWorld.sendBlockBreakProgress(packetIn.func_148845_c(), packetIn.func_179821_b(), packetIn.func_148846_g());
  }
  ...
  public void handleEffect(S28PacketEffect packetIn)
  {
    ...
    {
      gameController.theWorld.func_175669_a(packetIn.getSoundType(), packetIn.func_179746_d(), packetIn.getSoundData());
    }
    else
    {
      gameController.theWorld.playAuxSFX(packetIn.getSoundType(), packetIn.func_179746_d(), packetIn.getSoundData());
    }
  }
  ...
  public void handleStatistics(S37PacketStatistics packetIn)
  {
    ...
    StatBase var5;
    int var6;
    for (Iterator var3 = packetIn.func_148974_c().entrySet().iterator(); var3.hasNext(); gameController.thePlayer.getStatFileWriter().func_150873_a(gameController.thePlayer, var5, var6))
    {
  ...
  public void handlePlayerAbilities(S39PacketPlayerAbilities packetIn)
  {
    PacketThreadUtil.func_180031_a(packetIn, this, gameController);
    EntityPlayerSP var2 = gameController.thePlayer;
    if ((ModuleManager.getModByName("Fly").isEnabled()) && (getValuesshouldbypass)) {
  ...
  {
    PacketThreadUtil.func_180031_a(packetIn, this, gameController);
    gameController.theWorld.playSound(packetIn.func_149207_d(), packetIn.func_149211_e(), packetIn.func_149210_f(), packetIn.func_149212_c(), packetIn.func_149208_g(), packetIn.func_149209_h(), false);
  }
  ...
  public void handleCustomPayload(S3FPacketCustomPayload packetIn)
  {
    ...
    if ("MC|TrList".equals(packetIn.getChannelName()))
    {
      ...
      try
      {
        ...
        if ((var4 != null) && ((var4 instanceof GuiMerchant))) { if (var3 != gameController.thePlayer.openContainer.windowId)
            break label130;
