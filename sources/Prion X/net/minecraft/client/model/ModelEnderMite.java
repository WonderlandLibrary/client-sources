...
public class ModelEnderMite extends ModelBase
{
  ...
  private static final int[][] field_178714_b = { new int[2], { 0, 5 }, { 0, 14 }, { 0, 18 } };
  ...
  public ModelEnderMite()
  {
    ...
    for (int var2 = 0; var2 < field_178713_d.length; var2++)
    {
      ...
      field_178713_d[var2].addBox(field_178716_a[var2][0] * -0.5F, 0.0F, field_178716_a[var2][2] * -0.5F, field_178716_a[var2][0], field_178716_a[var2][1], field_178716_a[var2][2]);
  ...
  public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
  {
    ...
    {
      field_178713_d[var8].render(p_78088_7_);
    }
  }
  ...
  public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
  {
    for (int var8 = 0; var8 < field_178713_d.length; var8++)
    {
      field_178713_d[var8].rotateAngleY = (MathHelper.cos(p_78087_3_ * 0.9F + var8 * 0.15F * 3.1415927F) * 3.1415927F * 0.01F * (1 + Math.abs(var8 - 2)));
      field_178713_d[var8].rotationPointX = (MathHelper.sin(p_78087_3_ * 0.9F + var8 * 0.15F * 3.1415927F) * 3.1415927F * 0.1F * Math.abs(var8 - 2));
    }
  }
}
