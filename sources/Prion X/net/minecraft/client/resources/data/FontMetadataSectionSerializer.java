...
public class FontMetadataSectionSerializer extends BaseMetadataSectionSerializer
{
  ...
  public FontMetadataSection deserialize(JsonElement p_deserialize_1_, java.lang.reflect.Type p_deserialize_2_, com.google.gson.JsonDeserializationContext p_deserialize_3_)
  {
    JsonObject var4 = p_deserialize_1_.getAsJsonObject();
    float[] var5 = new float['Ā'];
    float[] var6 = new float['Ā'];
    float[] var7 = new float['Ā'];
    float var8 = 1.0F;
    float var9 = 0.0F;
    float var10 = 0.0F;
