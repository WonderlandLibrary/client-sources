...
public class FallbackResourceManager implements IResourceManager
{
  ...
  public IResource getResource(ResourceLocation p_110536_1_) throws IOException
  {
    ...
    {
      IResourcePack var5 = (IResourcePack)resourcePacks.get(var4);
      ...
      if (var5.resourceExists(p_110536_1_))
      {
        ...
        return new SimpleResource(var5.getPackName(), p_110536_1_, func_177245_a(p_110536_1_, var5), var6, frmMetadataSerializer);
      }
    }
  ...
  public List getAllResources(ResourceLocation p_135056_1_) throws IOException
  {
    ...
    Iterator var4 = resourcePacks.iterator();
    ...
    while (var4.hasNext())
    {
      ...
      if (var5.resourceExists(p_135056_1_))
      {
        ...
        var2.add(new SimpleResource(var5.getPackName(), p_135056_1_, func_177245_a(p_135056_1_, var5), var6, frmMetadataSerializer));
      }
    }
