...
public class GuiConnecting extends GuiScreen
{
  ...
  public static Integer lastPort;
    ...
    new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
    {
      ...
      public void run() {
        ...
        try
        {
          ...
          networkManager.sendPacket(new net.minecraft.network.handshake.client.C00Handshake(47, ip, port, net.minecraft.network.EnumConnectionState.LOGIN));
