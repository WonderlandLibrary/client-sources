...
public class WorldClient extends World
{
  ...
  {
    super(new net.minecraft.world.storage.SaveHandlerMP(), new WorldInfo(p_i45063_2_, "MpServer"), WorldProvider.getProviderForDimension(p_i45063_3_), p_i45063_5_, true);
