...
public class MobAppearance extends EntityFX
{
  ...
  public void onUpdate()
  {
    ...
    {
      EntityGuardian var1 = new EntityGuardian(worldObj);
      var1.func_175465_cm();
      field_174844_a = var1;
    }
  }
  ...
  public void func_180434_a(WorldRenderer p_180434_1_, Entity p_180434_2_, float p_180434_3_, float p_180434_4_, float p_180434_5_, float p_180434_6_, float p_180434_7_, float p_180434_8_)
  {
    if (field_174844_a != null)
    {
      ...
      float var11 = (particleAge + p_180434_3_) / particleMaxAge;
      ...
      GlStateManager.rotate(60.0F - 150.0F * var11 - rotationPitch, 1.0F, 0.0F, 0.0F);
