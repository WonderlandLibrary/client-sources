...
public class EffectRenderer
{
  ...
  public void renderParticles(Entity p_78874_1_, float p_78874_2_)
  {
    ...
    EntityFX.interpPosX = lastTickPosX + (posX - lastTickPosX) * p_78874_2_;
    EntityFX.interpPosY = lastTickPosY + (posY - lastTickPosY) * p_78874_2_;
    EntityFX.interpPosZ = lastTickPosZ + (posZ - lastTickPosZ) * p_78874_2_;
    ...
    if (p_180533_2_.getBlock().getMaterial() != Material.air)
    {
      ...
      for (int var4 = 0; var4 < var3; var4++)
      {
        for (int var5 = 0; var5 < var3; var5++)
        {
          ...
          {
            double var7 = p_180533_1_.getX() + (var4 + 0.5D) / var3;
            double var9 = p_180533_1_.getY() + (var5 + 0.5D) / var3;
            double var11 = p_180533_1_.getZ() + (var6 + 0.5D) / var3;
