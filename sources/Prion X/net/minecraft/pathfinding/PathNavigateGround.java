...
public class PathNavigateGround extends PathNavigate
{
  ...
  {
    return (theEntity.onGround) || ((func_179684_h()) && (isInLiquid())) || ((theEntity.isRiding()) && ((theEntity instanceof net.minecraft.entity.monster.EntityZombie)) && ((theEntity.ridingEntity instanceof net.minecraft.entity.passive.EntityChicken)));
  }
  ...
  protected void removeSunnyPath()
  {
    ...
    if (field_179694_f)
    {
      ...
      for (int var1 = 0; var1 < currentPath.getCurrentPathLength(); var1++)
      {
        ...
        if (worldObj.isAgainstSky(new BlockPos(xCoord, yCoord, zCoord)))
        {
  ...
  protected boolean isDirectPathBetweenPoints(Vec3 p_75493_1_, Vec3 p_75493_2_, int p_75493_3_, int p_75493_4_, int p_75493_5_)
  {
    ...
    int var7 = MathHelper.floor_double(zCoord);
    double var8 = xCoord - xCoord;
    double var10 = zCoord - zCoord;
    ...
    if (!func_179683_a(var6, (int)yCoord, var7, p_75493_3_, p_75493_4_, p_75493_5_, p_75493_1_, var8, var10))
    {
      return false;
    }
    ...
    double var20 = var6 * 1 - xCoord;
    double var22 = var7 * 1 - zCoord;
    ...
    int var26 = MathHelper.floor_double(xCoord);
    int var27 = MathHelper.floor_double(zCoord);
    ...
    } while (func_179683_a(var6, (int)yCoord, var7, p_75493_3_, p_75493_4_, p_75493_5_, p_75493_1_, var8, var10));
  ...
  private boolean func_179683_a(int p_179683_1_, int p_179683_2_, int p_179683_3_, int p_179683_4_, int p_179683_5_, int p_179683_6_, Vec3 p_179683_7_, double p_179683_8_, double p_179683_10_)
  {
    ...
    for (int var14 = var12; var14 < var12 + p_179683_4_; var14++)
    {
      ...
      {
        double var16 = var14 + 0.5D - xCoord;
        double var18 = var15 + 0.5D - zCoord;
  ...
  private boolean func_179692_b(int p_179692_1_, int p_179692_2_, int p_179692_3_, int p_179692_4_, int p_179692_5_, int p_179692_6_, Vec3 p_179692_7_, double p_179692_8_, double p_179692_10_)
  {
    ...
    while (var12.hasNext())
    {
      ...
      double var14 = var13.getX() + 0.5D - xCoord;
      double var16 = var13.getZ() + 0.5D - zCoord;
