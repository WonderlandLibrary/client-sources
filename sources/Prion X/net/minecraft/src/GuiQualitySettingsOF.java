      ...
      if (System.currentTimeMillis() >= mouseStillTime + activateDelay)
      {
        ...
        if (btn != null)
        {
          ...
          for (int i = 0; i < lines.length; i++)
          {
            ...
            fontRendererObj.func_175063_a(line, x1 + 5, y1 + 5 + i * 11, col);
          }
        }
      }
    }
