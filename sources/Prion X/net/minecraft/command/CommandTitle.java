  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    ...
    if ((var4 != S45PacketTitle.Type.CLEAR) && (var4 != S45PacketTitle.Type.RESET))
    {
      if (var4 == S45PacketTitle.Type.TIMES)
      {
        ...
        playerNetServerHandler.sendPacket(var14);
        ...
        try
        {
          ...
          IChatComponent var6;
          Throwable var8 = org.apache.commons.lang3.exception.ExceptionUtils.getRootCause(var9);
        ...
        playerNetServerHandler.sendPacket(var7);
        notifyOperators(sender, this, "commands.title.success", new Object[0]);
      }
    } else {
      if (args.length != 2)
