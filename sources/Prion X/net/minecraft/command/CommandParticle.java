...
public class CommandParticle extends CommandBase
{
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    ...
    double var32 = (float)func_175761_b(xCoord, args[1], true);
    double var9 = (float)func_175761_b(yCoord, args[2], true);
    double var11 = (float)func_175761_b(zCoord, args[3], true);
    ...
    net.minecraft.world.World var23 = sender.getEntityWorld();
