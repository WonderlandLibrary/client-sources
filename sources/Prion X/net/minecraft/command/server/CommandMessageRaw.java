...
public class CommandMessageRaw extends CommandBase
{
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    if (args.length < 2)
    {
      throw new net.minecraft.command.WrongUsageException("commands.tellraw.usage", new Object[0]);
    }
    ...
    catch (JsonParseException var7)
    {
      ...
      throw new net.minecraft.command.SyntaxErrorException("commands.tellraw.jsonException", new Object[] { var6 == null ? "" : var6.getMessage() });
    }
  }
