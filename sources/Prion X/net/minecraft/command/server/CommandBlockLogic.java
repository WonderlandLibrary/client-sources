...
public abstract class CommandBlockLogic implements net.minecraft.command.ICommandSender
{
  ...
  {
    if ((trackOutput) && (getEntityWorld() != null) && (!getEntityWorldisRemote))
    {
      lastOutput = new ChatComponentText("[" + timestampFormat.format(new java.util.Date()) + "] ").appendSibling(message);
      func_145756_e();
    }
  }
  ...
  public boolean sendCommandFeedback()
  {
    ...
    return (var1 == null) || (!var1.func_175578_N()) || (worldServers[0].getGameRules().getGameRuleBooleanValue("commandBlockOutput"));
  }
