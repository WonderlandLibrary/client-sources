  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    ...
    if ((minY >= 0) && (maxY < 256) && (minY >= 0) && (maxY < 256))
    {
      ...
      if ((var9.isAreaLoaded(var6)) && (var9.isAreaLoaded(var7)))
      {
        ...
        var8 = 0;
        BlockPos var11 = new BlockPos(minX - minX, minY - minY, minZ - minZ);
        
        for (int var12 = minZ; var12 <= maxZ; var12++)
        {
          for (int var13 = minY; var13 <= maxY; var13++)
          {
            for (int var14 = minX; var14 <= maxX; var14++)
            {
              ...
              if ((!var10) || (var18.getBlock() != net.minecraft.init.Blocks.air))
              {
