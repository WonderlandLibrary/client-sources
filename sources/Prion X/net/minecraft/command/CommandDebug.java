...
public class CommandDebug extends CommandBase
{
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    ...
    else if (args[0].equals("stop"))
    {
      ...
      if (!getServertheProfiler.profilingEnabled)
      {
      ...
      getServertheProfiler.profilingEnabled = false;
  ...
  {
    File var4 = new File(MinecraftServer.getServer().getFile("debug"), "profile-results-" + new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss").format(new java.util.Date()) + ".txt");
  ...
  private String func_147204_b(long p_147204_1_, int p_147204_3_)
  {
    ...
    var4.append("// This is approximately ").append(String.format("%.2f", new Object[] { Float.valueOf(p_147204_3_ / ((float)p_147204_1_ / 1000.0F)) })).append(" ticks per second. It should be ").append(20).append(" ticks per second\n\n");
  ...
  {
    List var4 = getServertheProfiler.getProfilingData(p_147202_2_);
    ...
    if ((var4 != null) && (var4.size() >= 3))
    {
      for (int var5 = 1; var5 < var4.size(); var5++)
      {
        ...
        p_147202_3_.append(field_76331_c).append(" - ").append(String.format("%.2f", new Object[] { Double.valueOf(field_76332_a) })).append("%/").append(String.format("%.2f", new Object[] { Double.valueOf(field_76330_b) })).append("%\n");
        
        if (!field_76331_c.equals("unspecified"))
        {
          try
          {
            func_147202_a(p_147202_1_ + 1, p_147202_2_ + "." + field_76331_c, p_147202_3_);
          }
  ...
  {
    String[] var0 = { "Shiny numbers!", "Am I not running fast enough? :(", "I'm working as hard as I can!", "Will I ever be good enough for you? :(", "Speedy. Zoooooom!", "Hello world", "40% better than a crash report.", "Now with extra numbers", "Now with less numbers", "Now with the same numbers", "You should add flames to things, it makes them go faster!", "Do you feel the need for... optimization?", "*cracks redstone whip*", "Maybe if you treated it better then it'll have more motivation to work faster! Poor server." };
