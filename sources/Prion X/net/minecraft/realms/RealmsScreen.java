...
public class RealmsScreen
{
  ...
  public GuiScreenRealmsProxy getProxy() { return proxy; }
  ...
  public static void bindFace(String p_bindFace_0_, String p_bindFace_1_)
  {
    ...
    if (var2 == null)
    {
      var2 = net.minecraft.client.resources.DefaultPlayerSkin.func_177334_a(UUIDTypeAdapter.fromString(p_bindFace_0_));
    }
