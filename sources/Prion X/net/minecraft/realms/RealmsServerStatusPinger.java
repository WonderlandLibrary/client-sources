...
public class RealmsServerStatusPinger
{
  ...
  public void pingServer(final String p_pingServer_1_, final RealmsServerPing p_pingServer_2_) throws UnknownHostException { if ((p_pingServer_1_ != null) && (!p_pingServer_1_.startsWith("0.0.0.0")) && (!p_pingServer_1_.isEmpty()))
    {
      ...
      var4.setNetHandler(new INetHandlerStatusClient()
      {
        ...
        public void handleServerInfo(S00PacketServerInfo packetIn) {
          ...
          {
            p_pingServer_2_nrOfPlayers = String.valueOf(var2.getPlayerCountData().getOnlinePlayerCount());
          }
      ...
      try
      {
        var4.sendPacket(new net.minecraft.network.handshake.client.C00Handshake(RealmsSharedConstants.NETWORK_PROTOCOL_VERSION, var3.getHost(), var3.getPort(), EnumConnectionState.STATUS));
