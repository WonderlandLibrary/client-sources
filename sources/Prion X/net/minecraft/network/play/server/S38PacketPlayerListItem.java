...
public class S38PacketPlayerListItem implements net.minecraft.network.Packet
{
  private Action field_179770_a;
  private final List field_179769_b = com.google.common.collect.Lists.newArrayList();
  ...
  public S38PacketPlayerListItem(Action p_i45967_1_, EntityPlayerMP... p_i45967_2_)
  {
    ...
    for (int var5 = 0; var5 < var4; var5++)
    {
      ...
      field_179769_b.add(new AddPlayerData(var6.getGameProfile(), ping, theItemInWorldManager.getGameType(), var6.func_175396_E()));
    }
  }
  ...
  public S38PacketPlayerListItem(Action p_i45968_1_, Iterable p_i45968_2_)
  {
    ...
    while (var3.hasNext())
    {
      ...
      field_179769_b.add(new AddPlayerData(var4.getGameProfile(), ping, theItemInWorldManager.getGameType(), var4.func_175396_E()));
    }
  }
  ...
  public void readPacketData(PacketBuffer data)
    throws IOException
  {
    field_179770_a = ((Action)data.readEnumValue(Action.class));
    ...
    for (int var3 = 0; var3 < var2; var3++)
    {
      ...
      switch (SwitchAction.field_179938_a[field_179770_a.ordinal()])
      {
      case 1: 
      ...
      field_179769_b.add(new AddPlayerData(var4, var5, var6, var7));
    }
  }
    ...
    throws IOException
  {
    ...
    Iterator var2 = field_179769_b.iterator();
    
    while (var2.hasNext())
    {
      AddPlayerData var3 = (AddPlayerData)var2.next();
