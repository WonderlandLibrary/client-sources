...
public class EntityPainting extends EntityHanging
{
  ...
  public EntityPainting(World worldIn, BlockPos p_i45849_2_, EnumFacing p_i45849_3_)
  {
    ...
    if (!var4.isEmpty())
    {
      art = ((EnumArt)var4.get(rand.nextInt(var4.size())));
    }
  ...
  public void onBroken(Entity p_110128_1_)
  {
    if (worldObj.getGameRules().getGameRuleBooleanValue("doTileDrops"))
    {
      ...
      entityDropItem(new net.minecraft.item.ItemStack(Items.painting), 0.0F);
    }
  }
  ...
  {
    BlockPos var9 = new BlockPos(x - posX, y - posY, z - posZ);
    BlockPos var10 = field_174861_a.add(var9);
    setPosition(var10.getX(), var10.getY(), var10.getZ());
  }
  
  public void func_180426_a(double p_180426_1_, double p_180426_3_, double p_180426_5_, float p_180426_7_, float p_180426_8_, int p_180426_9_, boolean p_180426_10_)
  {
    BlockPos var11 = new BlockPos(p_180426_1_ - posX, p_180426_3_ - posY, p_180426_5_ - posZ);
    BlockPos var12 = field_174861_a.add(var11);
