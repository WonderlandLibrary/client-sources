...
public abstract class EntityHanging extends Entity
{
  ...
  protected void func_174859_a(EnumFacing p_174859_1_)
  {
    ...
    prevRotationYaw = (this.rotationYaw = field_174860_b.getHorizontalIndex() * 90);
    func_174856_o();
  }
  ...
  private void func_174856_o()
  {
    if (field_174860_b != null)
    {
      ...
      var16 /= 32.0D;
      var18 /= 32.0D;
      func_174826_a(new net.minecraft.util.AxisAlignedBB(var1 - var14, var3 - var16, var5 - var18, var1 + var14, var3 + var16, var5 + var18));
    }
  }
  ...
  public boolean onValidSurface()
  {
    ...
    for (int var5 = 0; var5 < var1; var5++)
    {
      for (int var6 = 0; var6 < var2; var6++)
      {
        ...
        if ((!var8.getMaterial().isSolid()) && (!net.minecraft.block.BlockRedstoneDiode.isRedstoneRepeaterBlockID(var8)))
        {
          return false;
        }
      }
