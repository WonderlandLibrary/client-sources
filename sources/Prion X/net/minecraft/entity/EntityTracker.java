...
public class EntityTracker
{
  ...
  public void addEntityToTracker(Entity p_72785_1_, int p_72785_2_, final int p_72785_3_, boolean p_72785_4_)
  {
    ...
    catch (Throwable var11)
    {
      ...
      trackedEntityHashTable.lookup(p_72785_1_.getEntityId())).trackedEntity.addEntityCrashInfo(var8);
  ...
  {
    ArrayList var1 = com.google.common.collect.Lists.newArrayList();
    ...
    while (var2.hasNext())
    {
      ...
      if ((playerEntitiesUpdated) && ((trackedEntity instanceof EntityPlayerMP)))
      {
        var1.add((EntityPlayerMP)trackedEntity);
      }
    }
  ...
  public void func_85172_a(EntityPlayerMP p_85172_1_, Chunk p_85172_2_)
  {
    ...
    while (var3.hasNext())
    {
      ...
      if ((trackedEntity != p_85172_1_) && (trackedEntity.chunkCoordX == xPosition) && (trackedEntity.chunkCoordZ == zPosition))
      {
