...
public class EntityAIHarvestFarmland extends EntityAIMoveToBlock
{
  ...
  {
    super.updateTask();
    field_179504_c.getLookHelper().setLookPosition(field_179494_b.getX() + 0.5D, field_179494_b.getY() + 1, field_179494_b.getZ() + 0.5D, 10.0F, field_179504_c.getVerticalFaceSpeed());
    
    if (func_179487_f())
    {
      World var1 = field_179504_c.worldObj;
      BlockPos var2 = field_179494_b.offsetUp();
      IBlockState var3 = var1.getBlockState(var2);
      Block var4 = var3.getBlock();
      
      if ((field_179501_f == 0) && ((var4 instanceof BlockCrops)) && (((Integer)var3.getValue(BlockCrops.AGE)).intValue() == 7))
      {
        var1.destroyBlock(var2, true);
      }
      else if ((field_179501_f == 1) && (var4 == Blocks.air))
      {
        InventoryBasic var5 = field_179504_c.func_175551_co();
  ...
  protected boolean func_179488_a(World worldIn, BlockPos p_179488_2_)
  {
    ...
    if (var3 == Blocks.farmland)
    {
      ...
      if (((var3 instanceof BlockCrops)) && (((Integer)var4.getValue(BlockCrops.AGE)).intValue() == 7) && (field_179503_e) && ((field_179501_f == 0) || (field_179501_f < 0)))
      {
        field_179501_f = 0;
        return true;
      }
