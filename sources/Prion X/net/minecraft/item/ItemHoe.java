...
public class ItemHoe extends Item
{
  ...
  public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
  {
    ...
    if ((side != EnumFacing.DOWN) && (worldIn.getBlockState(pos.offsetUp()).getBlock().getMaterial() == net.minecraft.block.material.Material.air))
    {
      ...
      {
        switch (SwitchDirtType.field_179590_a[((BlockDirt.DirtType)var9.getValue(net.minecraft.block.BlockDirt.VARIANT)).ordinal()])
        {
        case 1: 
          return func_179232_a(stack, playerIn, worldIn, pos, Blocks.farmland.getDefaultState());
        
        case 2: 
          return func_179232_a(stack, playerIn, worldIn, pos, Blocks.dirt.getDefaultState().withProperty(net.minecraft.block.BlockDirt.VARIANT, BlockDirt.DirtType.DIRT));
        }
  ...
  {
    worldIn.playSoundEffect(p_179232_4_.getX() + 0.5F, p_179232_4_.getY() + 0.5F, p_179232_4_.getZ() + 0.5F, getBlockstepSound.getStepSound(), (getBlockstepSound.getVolume() + 1.0F) / 2.0F, getBlockstepSound.getFrequency() * 0.8F);
