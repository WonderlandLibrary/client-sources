...
public class ItemBanner extends ItemBlock
{
  ...
  public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
  {
    ...
    {
      int var9 = net.minecraft.util.MathHelper.floor_double((rotationYaw + 180.0F) * 16.0F / 360.0F + 0.5D) & 0xF;
      worldIn.setBlockState(pos, Blocks.standing_banner.getDefaultState().withProperty(net.minecraft.block.BlockStandingSign.ROTATION_PROP, Integer.valueOf(var9)), 3);
    }
    else
    {
      worldIn.setBlockState(pos, Blocks.wall_banner.getDefaultState().withProperty(net.minecraft.block.BlockWallSign.field_176412_a, side), 3);
    }
  ...
  public int getColorFromItemStack(ItemStack stack, int renderPass)
  {
    ...
    EnumDyeColor var3 = func_179225_h(stack);
    return func_176768_ecolorValue;
  }
