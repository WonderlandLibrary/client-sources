...
public class ItemEditableBook extends Item
{
  ...
  public void addInformation(ItemStack stack, EntityPlayer playerIn, List tooltip, boolean advanced)
  {
    if (stack.hasTagCompound())
    {
      ...
      tooltip.add(EnumChatFormatting.GRAY + StatCollector.translateToLocal(new StringBuilder("book.generation.").append(var5.getInteger("generation")).toString()));
    }
  }
        ...
        if (validBookTagContents(var3))
        {
          ...
          for (int var5 = 0; var5 < var4.tagCount(); var5++)
          {
            ...
            try
            {
              ...
              Object var7;
              var7 = new net.minecraft.util.ChatComponentText(var6);
            }
          ...
          {
            Slot var10 = openContainer.getSlotFromInventory(inventory, inventory.currentItem);
            playerNetServerHandler.sendPacket(new net.minecraft.network.play.server.S2FPacketSetSlot(0, slotNumber, p_179229_1_));
          }
        }
      }
    }
