...
public class ItemSnow extends ItemBlock
{
  ...
  public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
  {
    ...
    if (var10 == block)
    {
      int var11 = ((Integer)var9.getValue(net.minecraft.block.BlockSnow.LAYERS_PROP)).intValue();
      
      if (var11 <= 7)
      {
        IBlockState var12 = var9.withProperty(net.minecraft.block.BlockSnow.LAYERS_PROP, Integer.valueOf(var11 + 1));
