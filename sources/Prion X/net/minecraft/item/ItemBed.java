...
public class ItemBed extends Item
{
  ...
  public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
  {
    ...
    int var12 = MathHelper.floor_double(rotationYaw * 4.0F / 360.0F + 0.5D) & 0x3;
    ...
    if ((playerIn.func_175151_a(pos, side, stack)) && (playerIn.func_175151_a(var14, side, stack)))
    {
      if ((var16) && (var17) && (World.doesBlockHaveSolidTopSurface(worldIn, pos.offsetDown())) && (World.doesBlockHaveSolidTopSurface(worldIn, var14.offsetDown())))
      {
        ...
        IBlockState var19 = net.minecraft.init.Blocks.bed.getDefaultState().withProperty(BlockBed.OCCUPIED_PROP, Boolean.valueOf(false)).withProperty(BlockBed.AGE, var13).withProperty(BlockBed.PART_PROP, BlockBed.EnumPartType.FOOT);
