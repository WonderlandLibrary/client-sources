...
public class RecipesDyes
{
  ...
  public void addRecipes(CraftingManager p_77607_1_)
  {
    for (int var2 = 0; var2 < 16; var2++)
    {
      ...
      p_77607_1_.addRecipe(new ItemStack(Blocks.stained_hardened_clay, 8, 15 - var2), new Object[] { "###", "#X#", "###", Character.valueOf('#'), new ItemStack(Blocks.hardened_clay), Character.valueOf('X'), new ItemStack(Items.dye, 1, var2) });
      p_77607_1_.addRecipe(new ItemStack(Blocks.stained_glass, 8, 15 - var2), new Object[] { "###", "#X#", "###", Character.valueOf('#'), new ItemStack(Blocks.glass), Character.valueOf('X'), new ItemStack(Items.dye, 1, var2) });
      p_77607_1_.addRecipe(new ItemStack(Blocks.stained_glass_pane, 16, var2), new Object[] { "###", "###", Character.valueOf('#'), new ItemStack(Blocks.stained_glass, 1, var2) });
    }
    ...
    {
      p_77607_1_.addRecipe(new ItemStack(Blocks.carpet, 3, var2), new Object[] { "##", Character.valueOf('#'), new ItemStack(Blocks.wool, 1, var2) });
    }
  }
}
