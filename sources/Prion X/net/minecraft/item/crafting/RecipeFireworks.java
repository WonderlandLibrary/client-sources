      ...
      if ((var4 == 1) && (var3 == 0) && (var6 == 0) && (var5 > 0) && (var8 <= 1))
      {
        ...
        for (int var13 = 0; var13 < p_77569_1_.getSizeInventory(); var13++)
        {
          ...
          if (var14 != null)
          {
            ...
            {
              var12.add(Integer.valueOf(net.minecraft.item.ItemDye.dyeColors[(var14.getMetadata() & 0xF)]));
            }
      ...
      if ((var4 == 0) && (var3 == 0) && (var6 == 1) && (var5 > 0) && (var5 == var7))
      {
        ...
        for (int var17 = 0; var17 < p_77569_1_.getSizeInventory(); var17++)
        {
          ...
          if (var11 != null)
          {
            ...
            {
              var15.add(Integer.valueOf(net.minecraft.item.ItemDye.dyeColors[(var11.getMetadata() & 0xF)]));
            }
        ...
        {
          NBTTagCompound var21 = field_92102_a.getTagCompound().getCompoundTag("Explosion");
