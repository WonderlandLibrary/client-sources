...
public class RecipesIngots
{
  ...
  public void addRecipes(CraftingManager p_77590_1_)
  {
    for (int var2 = 0; var2 < recipeItems.length; var2++)
    {
      ...
      p_77590_1_.addRecipe(new ItemStack(var3), new Object[] { "###", "###", "###", Character.valueOf('#'), var4 });
      p_77590_1_.addRecipe(var4, new Object[] { "#", Character.valueOf('#'), var3 });
    }
    
    p_77590_1_.addRecipe(new ItemStack(Items.gold_ingot), new Object[] { "###", "###", "###", Character.valueOf('#'), Items.gold_nugget });
    p_77590_1_.addRecipe(new ItemStack(Items.gold_nugget, 9), new Object[] { "#", Character.valueOf('#'), Items.gold_ingot });
  }
}
