...
public class Item
{
  ...
  {
    String var2 = getUnlocalizedName(stack);
  ...
  {
    return StatCollector.translateToLocal(new StringBuilder(String.valueOf(getUnlocalizedNameInefficiently(stack))).append(".name").toString()).trim();
  }
  ...
  {
    float var4 = prevRotationPitch + (rotationPitch - prevRotationPitch);
    float var5 = prevRotationYaw + (rotationYaw - prevRotationYaw);
    double var6 = prevPosX + (posX - prevPosX);
    double var8 = prevPosY + (posY - prevPosY) + playerIn.getEyeHeight();
    double var10 = prevPosZ + (posZ - prevPosZ);
  ...
  public static void registerItems()
  {
    registerItemBlock(Blocks.stone, new ItemMultiTexture(Blocks.stone, Blocks.stone, new Function()
    {
      ...
      public Object apply(Object p_apply_1_) {
        return apply((ItemStack)p_apply_1_);
      }
    ...
    registerItemBlock(Blocks.sponge, new ItemMultiTexture(Blocks.sponge, Blocks.sponge, new Function()
    {
      ...
      public String apply(ItemStack stack) {
        return (stack.getMetadata() & 0x1) == 1 ? "wet" : "dry";
      }
    ...
    registerItem(321, "painting", new ItemHangingEntity(net.minecraft.entity.item.EntityPainting.class).setUnlocalizedName("painting"));
    registerItem(322, "golden_apple", new ItemAppleGold(4, 1.2F, false).setAlwaysEdible().setPotionEffect(regenerationid, 5, 1, 1.0F).setUnlocalizedName("appleGold"));
    ...
    registerItem(365, "chicken", new ItemFood(2, 0.3F, true).setPotionEffect(hungerid, 30, 0, 0.3F).setUnlocalizedName("chickenRaw"));
    registerItem(366, "cooked_chicken", new ItemFood(6, 0.6F, true).setUnlocalizedName("chickenCooked"));
    registerItem(367, "rotten_flesh", new ItemFood(4, 0.1F, true).setPotionEffect(hungerid, 30, 0, 0.8F).setUnlocalizedName("rottenFlesh"));
    ...
    registerItem(375, "spider_eye", new ItemFood(2, 0.8F, false).setPotionEffect(poisonid, 5, 0, 1.0F).setUnlocalizedName("spiderEye").setPotionEffect(PotionHelper.spiderEyeEffect));
    ...
    registerItem(389, "item_frame", new ItemHangingEntity(net.minecraft.entity.item.EntityItemFrame.class).setUnlocalizedName("frame"));
    ...
    registerItem(394, "poisonous_potato", new ItemFood(2, 0.3F, false).setPotionEffect(poisonid, 5, 0, 0.6F).setUnlocalizedName("potatoPoisonous"));
  ...
  public static enum ToolMaterial
  {
    ...
    {
      return this == EMERALD ? Items.diamond : this == IRON ? Items.iron_ingot : this == GOLD ? Items.gold_ingot : this == STONE ? Item.getItemFromBlock(Blocks.cobblestone) : this == WOOD ? Item.getItemFromBlock(Blocks.planks) : null;
    }
  }
}
