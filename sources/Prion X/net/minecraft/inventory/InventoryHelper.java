...
public class InventoryHelper
{
  ...
  public static void dropInventoryItems(World worldIn, BlockPos p_180175_1_, IInventory p_180175_2_) { func_180174_a(worldIn, p_180175_1_.getX(), p_180175_1_.getY(), p_180175_1_.getZ(), p_180175_2_); }
  

  public static void func_180176_a(World worldIn, Entity p_180176_1_, IInventory p_180176_2_)
  {
    func_180174_a(worldIn, posX, posY, posZ, p_180176_2_);
  }
  ...
  private static void func_180173_a(World worldIn, double p_180173_1_, double p_180173_3_, double p_180173_5_, ItemStack p_180173_7_)
  {
    ...
    while (stackSize > 0)
    {
      ...
      float var13 = 0.05F;
      motionX = (field_180177_a.nextGaussian() * var13);
      motionY = (field_180177_a.nextGaussian() * var13 + 0.20000000298023224D);
      motionZ = (field_180177_a.nextGaussian() * var13);
