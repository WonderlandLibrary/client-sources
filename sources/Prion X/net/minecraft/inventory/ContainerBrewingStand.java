...
public class ContainerBrewingStand extends Container
{
  ...
  public ContainerBrewingStand(InventoryPlayer p_i45802_1_, IInventory p_i45802_2_)
  {
    ...
    addSlotToContainer(new Potion(player, p_i45802_2_, 0, 56, 46));
    addSlotToContainer(new Potion(player, p_i45802_2_, 1, 79, 53));
    addSlotToContainer(new Potion(player, p_i45802_2_, 2, 102, 46));
    theSlot = addSlotToContainer(new Ingredient(p_i45802_2_, 3, 79, 17));
