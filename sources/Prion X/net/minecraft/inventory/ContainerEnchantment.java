  ...
  extends Container
{
  ...
  public ContainerEnchantment(InventoryPlayer p_i45798_1_, World worldIn, BlockPos p_i45798_3_)
  {
    ...
    field_178149_f = player.func_175138_ci();
  ...
  public void onCraftGuiOpened(ICrafting p_75132_1_)
  {
    ...
    p_75132_1_.sendProgressBarUpdate(this, 3, field_178149_f & 0xFFFFFFF0);
  ...
  public void detectAndSendChanges()
  {
    ...
    for (int var1 = 0; var1 < crafters.size(); var1++)
    {
      ...
      var2.sendProgressBarUpdate(this, 3, field_178149_f & 0xFFFFFFF0);
          ...
          for (var4 = 0; var4 < 3; var4++)
          {
            if (enchantLevels[var4] > 0)
            {
              ...
              if ((var7 != null) && (!var7.isEmpty()))
              {
                ...
                field_178151_h[var4] = (enchantmentobj.effectId | enchantmentLevel << 8);
              }
            }
          }
  ...
  public boolean enchantItem(EntityPlayer playerIn, int id)
  {
    ...
    if (((var4 == null) || (stackSize < var5)) && (!capabilities.isCreativeMode))
    {
      return false;
    }
    if ((enchantLevels[id] > 0) && (var3 != null) && (((experienceLevel >= var5) && (experienceLevel >= enchantLevels[id])) || (capabilities.isCreativeMode)))
    {
      if (!worldPointer.isRemote)
      {
        ...
        if (var6 != null)
        {
          ...
          for (int var8 = 0; var8 < var6.size(); var8++)
          {
            ...
            {
              var3.addEnchantment(enchantmentobj, enchantmentLevel);
            }
          }
  ...
  {
    return worldPointer.getBlockState(field_178150_j).getBlock() == Blocks.enchanting_table;
  }
  ...
  public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
  {
    ...
    if ((var4 != null) && (var4.getHasStack()))
    {
      ...
      else
      {
        ...
        if ((var5.hasTagCompound()) && (stackSize == 1))
        {
