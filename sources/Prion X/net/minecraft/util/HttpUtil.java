...
{
  public static final ListeningExecutorService field_180193_a = com.google.common.util.concurrent.MoreExecutors.listeningDecorator(Executors.newCachedThreadPool(new ThreadFactoryBuilder().setDaemon(true).setNameFormat("Downloader %d").build()));
  ...
  public static ListenableFuture func_180192_a(final File p_180192_0_, final String p_180192_1_, final Map p_180192_2_, final int p_180192_3_, IProgressUpdate p_180192_4_, final Proxy p_180192_5_)
  {
    ListenableFuture var6 = field_180193_a.submit(new Runnable()
    {
      ...
      public void run() {
        ...
        if (HttpUtil.this != null)
        {
          resetProgressAndMessage("Downloading Resource Pack");
          displayLoadingString("Making Request...");
        }
        ...
        try
        {
          ...
          while (var8.hasNext())
          {
            ...
            if (HttpUtil.this != null)
            {
              setLoadingProgress((int)(++var6 / var7 * 100.0F));
            }
          }
          ...
          if (HttpUtil.this != null)
          {
            displayLoadingString(String.format("Downloading file (%.2f MB)...", new Object[] { Float.valueOf(var7 / 1000.0F / 1000.0F) }));
          }
