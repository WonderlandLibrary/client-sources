...
public class MessageSerializer extends MessageToByteEncoder
{
  ...
  private static final org.apache.logging.log4j.Marker RECEIVED_PACKET_MARKER = MarkerManager.getMarker("PACKET_SENT", NetworkManager.logMarkerPackets);
  ...
  protected void encode(ChannelHandlerContext p_encode_1_, Object p_encode_2_, ByteBuf p_encode_3_)
    throws IOException
  {
    encode(p_encode_1_, (Packet)p_encode_2_, p_encode_3_);
  }
}
