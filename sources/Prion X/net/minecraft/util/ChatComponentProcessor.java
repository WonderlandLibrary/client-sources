...
public class ChatComponentProcessor
{
  ...
  public static IChatComponent func_179985_a(ICommandSender p_179985_0_, IChatComponent p_179985_1_, Entity p_179985_2_) throws net.minecraft.command.CommandException
  {
    Object var3 = null;
    ...
    if ((p_179985_1_ instanceof ChatComponentScore))
    {
      ...
      if (PlayerSelector.hasArguments(var5))
      {
        ...
        if (var6.size() != 1)
        {
          throw new net.minecraft.command.EntityNotFoundException();
        }
