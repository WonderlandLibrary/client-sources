...
public class BlockPumpkin extends BlockDirectional
{
  ...
  private void createGolem(World worldIn, BlockPos p_180673_2_)
  {
    ...
    {
      for (int var4 = 0; var4 < func_176391_l().func_177685_b(); var4++)
      {
      ...
      {
        worldIn.spawnParticle(EnumParticleTypes.SNOW_SHOVEL, var11.getX() + rand.nextDouble(), var11.getY() + rand.nextDouble() * 2.5D, var11.getZ() + rand.nextDouble(), 0.0D, 0.0D, 0.0D, new int[0]);
      }
    ...
    {
      for (int var4 = 0; var4 < func_176388_T().func_177684_c(); var4++)
      {
      ...
      for (int var6 = 0; var6 < 120; var6++)
      {
        worldIn.spawnParticle(EnumParticleTypes.SNOWBALL, var10.getX() + rand.nextDouble(), var10.getY() + rand.nextDouble() * 3.9D, var10.getZ() + rand.nextDouble(), 0.0D, 0.0D, 0.0D, new int[0]);
      }
  ...
  {
    return (getBlockStategetBlockblockMaterial.isReplaceable()) && (World.doesBlockHaveSolidTopSurface(worldIn, pos.offsetDown()));
  }
  ...
  {
    return new BlockState(this, new net.minecraft.block.properties.IProperty[] { AGE });
  }
