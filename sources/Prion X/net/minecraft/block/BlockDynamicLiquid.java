...
public class BlockDynamicLiquid extends BlockLiquid
{
  ...
  {
    worldIn.setBlockState(p_180690_2_, getStaticLiquidForMaterial(blockMaterial).getDefaultState().withProperty(LEVEL, p_180690_3_.getValue(LEVEL)), 2);
  }
  ...
  public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
  {
    ...
    if ((blockMaterial == Material.lava) && (!provider.func_177500_n()))
    {
      var6 = 2;
    }
    ...
    if (var5 > 0)
    {
      ...
      {
        int var16 = func_176362_e(worldIn, pos.offsetUp());
      ...
      if ((field_149815_a >= 2) && (blockMaterial == Material.water))
      {
        ...
        else if ((var17.getBlock().getMaterial() == blockMaterial) && (((Integer)var17.getValue(LEVEL)).intValue() == 0))
        {
          var14 = 0;
        }
      }
    ...
    if (func_176373_h(worldIn, pos.offsetDown(), var13))
    {
      ...
      {
        worldIn.setBlockState(pos.offsetDown(), net.minecraft.init.Blocks.stone.getDefaultState());
  ...
  private void func_176375_a(World worldIn, BlockPos p_176375_2_, IBlockState p_176375_3_, int p_176375_4_)
  {
    ...
    {
      if (p_176375_3_.getBlock() != net.minecraft.init.Blocks.air)
      {
      ...
      worldIn.setBlockState(p_176375_2_, getDefaultState().withProperty(LEVEL, Integer.valueOf(p_176375_4_)), 3);
    }
  }
  ...
  private int func_176374_a(World worldIn, BlockPos p_176374_2_, int p_176374_3_, EnumFacing p_176374_4_)
  {
    ...
    while (var6.hasNext())
    {
      ...
      if (var7 != p_176374_4_)
      {
        ...
        if ((!func_176372_g(worldIn, var8, var9)) && ((var9.getBlock().getMaterial() != blockMaterial) || (((Integer)var9.getValue(LEVEL)).intValue() > 0)))
        {
  ...
  private Set func_176376_e(World worldIn, BlockPos p_176376_2_)
  {
    ...
    while (var5.hasNext())
    {
      ...
      if ((!func_176372_g(worldIn, var7, var8)) && ((var8.getBlock().getMaterial() != blockMaterial) || (((Integer)var8.getValue(LEVEL)).intValue() > 0)))
      {
        int var9;
        int var9;
  ...
  private boolean func_176372_g(World worldIn, BlockPos p_176372_2_, IBlockState p_176372_3_)
  {
    ...
    return blockMaterial == Material.portal;
  }
