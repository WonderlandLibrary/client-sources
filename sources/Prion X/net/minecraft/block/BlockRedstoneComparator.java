...
public class BlockRedstoneComparator extends BlockRedstoneDiode implements ITileEntityProvider
{
  ...
  {
    super(p_i45399_1_);
    setDefaultState(blockState.getBaseState().withProperty(AGE, EnumFacing.NORTH).withProperty(field_176464_a, Boolean.valueOf(false)).withProperty(field_176463_b, Mode.COMPARE));
  ...
  protected IBlockState func_180674_e(IBlockState p_180674_1_)
  {
    ...
    Mode var3 = (Mode)p_180674_1_.getValue(field_176463_b);
  ...
  protected IBlockState func_180675_k(IBlockState p_180675_1_)
  {
    ...
    Mode var3 = (Mode)p_180675_1_.getValue(field_176463_b);
  ...
  {
    return (isRepeaterPowered) || (((Boolean)p_176406_1_.getValue(field_176464_a)).booleanValue());
  }
  ...
  {
    return p_176460_3_.getValue(field_176463_b) == Mode.SUBTRACT ? Math.max(func_176397_f(worldIn, p_176460_2_, p_176460_3_) - func_176407_c(worldIn, p_176460_2_, p_176460_3_), 0) : func_176397_f(worldIn, p_176460_2_, p_176460_3_);
  }
  ...
  protected int func_176397_f(World worldIn, BlockPos p_176397_2_, IBlockState p_176397_3_)
  {
    ...
    else if ((var4 < 15) && (var7.isNormalCube()))
    {
      ...
      else if (var7.getMaterial() == net.minecraft.block.material.Material.air)
      {
  ...
  public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
  {
    ...
    worldIn.playSoundEffect(pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D, "random.click", 0.3F, state.getValue(field_176463_b) == Mode.SUBTRACT ? 0.55F : 0.5F);
  ...
  public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
  {
    ...
    {
      worldIn.setBlockState(pos, func_180675_k(state).withProperty(field_176464_a, Boolean.valueOf(true)), 4);
    }
  ...
  {
    return getDefaultState().withProperty(AGE, EnumFacing.getHorizontal(meta)).withProperty(field_176464_a, Boolean.valueOf((meta & 0x8) > 0)).withProperty(field_176463_b, (meta & 0x4) > 0 ? Mode.SUBTRACT : Mode.COMPARE);
  }
  ...
  {
    return getDefaultState().withProperty(AGE, placer.func_174811_aO().getOpposite()).withProperty(field_176464_a, Boolean.valueOf(false)).withProperty(field_176463_b, Mode.COMPARE);
  }
