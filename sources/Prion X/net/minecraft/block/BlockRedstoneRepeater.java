...
public class BlockRedstoneRepeater extends BlockRedstoneDiode
{
  ...
  {
    super(p_i45424_1_);
    setDefaultState(blockState.getBaseState().withProperty(AGE, EnumFacing.NORTH).withProperty(field_176410_b, Integer.valueOf(1)).withProperty(field_176411_a, Boolean.valueOf(false)));
  }
  ...
  {
    return new BlockState(this, new net.minecraft.block.properties.IProperty[] { AGE, field_176410_b, field_176411_a });
  }
}
