...
public class BlockDaylightDetector extends BlockContainer
{
  ...
  public BlockDaylightDetector(boolean p_i45729_1_)
  {
    ...
    setDefaultState(blockState.getBaseState().withProperty(field_176436_a, Integer.valueOf(0)));
  ...
  public void func_180677_d(World worldIn, BlockPos p_180677_2_)
  {
    if (!provider.getHasNoSky())
    {
      ...
      int var4 = worldIn.getLightFor(net.minecraft.world.EnumSkyBlock.SKY, p_180677_2_) - worldIn.getSkylightSubtracted();
  ...
  {
    return getDefaultState().withProperty(field_176436_a, Integer.valueOf(meta));
  }
