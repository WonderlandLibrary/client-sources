...
public class BlockDispenser extends BlockContainer
{
    ...
    if (var4 != null)
    {
      ...
      else
      {
        ...
        if (var7 != IBehaviorDispenseItem.itemDispenseBehaviorProvider)
        {
          ...
          var4.setInventorySlotContents(var5, stackSize == 0 ? null : var8);
        }
      }
    }
  }
  ...
  {
    return getDefaultState().withProperty(FACING, BlockPistonBase.func_180695_a(worldIn, pos, placer)).withProperty(TRIGGERED, Boolean.valueOf(false));
  }
  ...
  {
    return getDefaultState().withProperty(FACING, getFacing(meta)).withProperty(TRIGGERED, Boolean.valueOf((meta & 0x8) > 0));
  }
