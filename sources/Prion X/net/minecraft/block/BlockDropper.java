...
{
  private final IBehaviorDispenseItem field_149947_P = new net.minecraft.dispenser.BehaviorDefaultDispenseItem();
  private static final String __OBFID = "CL_00000233";
  
  public BlockDropper() {}
  
  protected IBehaviorDispenseItem func_149940_a(ItemStack p_149940_1_) { return field_149947_P; }
    ...
    if (var4 != null)
    {
      ...
      else
      {
        ...
        if (var6 != null)
        {
          ...
          if (var9 == null)
          {
            ItemStack var10 = field_149947_P.dispense(var3, var6);
            
            if ((var10 != null) && (stackSize == 0))
            {
              var10 = null;
            }
          }
