...
public class BlockPistonBase extends Block
{
  ...
  public BlockPistonBase(boolean p_i45443_1_)
  {
    ...
    setDefaultState(blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH).withProperty(EXTENDED, Boolean.valueOf(false)));
  ...
  {
    if ((!isRemote) && (worldIn.getTileEntity(pos) == null))
    {
      func_176316_e(worldIn, pos, state);
    }
  }
  ...
  {
    return getDefaultState().withProperty(FACING, func_180695_a(worldIn, pos, placer)).withProperty(EXTENDED, Boolean.valueOf(false));
  }
  ...
  public boolean onBlockEventReceived(World worldIn, BlockPos pos, IBlockState state, int eventID, int eventParam)
  {
    ...
    if (eventID == 0)
    {
      ...
      worldIn.setBlockState(pos, state.withProperty(EXTENDED, Boolean.valueOf(true)), 2);
      worldIn.playSoundEffect(pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D, "tile.piston.out", 0.5F, rand.nextFloat() * 0.25F + 0.6F);
    }
    else if (eventID == 1)
    {
      ...
      worldIn.playSoundEffect(pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D, "tile.piston.in", 0.5F, rand.nextFloat() * 0.15F + 0.6F);
    }
  ...
  public void setBlockBoundsBasedOnState(IBlockAccess access, BlockPos pos)
  {
    ...
    if ((var3.getBlock() == this) && (((Boolean)var3.getValue(EXTENDED)).booleanValue()))
    {
      ...
      default: 
        break;setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
      }
  ...
  {
    if ((MathHelper.abs((float)posX - p_180695_1_.getX()) < 2.0F) && (MathHelper.abs((float)posZ - p_180695_1_.getZ()) < 2.0F))
    {
      double var3 = posY + p_180695_2_.getEyeHeight();
  ...
  private boolean func_176319_a(World worldIn, BlockPos p_176319_2_, EnumFacing p_176319_3_, boolean p_176319_4_)
  {
    ...
    {
      BlockPos var12 = (BlockPos)var6.get(var11);
      IBlockState var19 = worldIn.getBlockState(var12);
    ...
    if (p_176319_4_)
    {
      ...
      IBlockState var19 = Blocks.piston_head.getDefaultState().withProperty(BlockPistonExtension.field_176326_a, p_176319_3_).withProperty(BlockPistonExtension.field_176325_b, var17);
    ...
    for (int var18 = var7.size() - 1; var18 >= 0; var18--)
    {
  ...
  {
    return getDefaultState().withProperty(FACING, func_176317_b(meta)).withProperty(EXTENDED, Boolean.valueOf((meta & 0x8) > 0));
  }
  ...
  {
    return new BlockState(this, new net.minecraft.block.properties.IProperty[] { FACING, EXTENDED });
  }
