...
public class BlockDragonEgg extends Block
{
  ...
  private void func_180683_d(World worldIn, BlockPos p_180683_2_)
  {
    if ((BlockFalling.canFallInto(worldIn, p_180683_2_.offsetDown())) && (p_180683_2_.getY() >= 0))
    {
      ...
      else
      {
        ...
        for (BlockPos var4 = p_180683_2_; (BlockFalling.canFallInto(worldIn, var4)) && (var4.getY() > 0); var4 = var4.offsetDown()) {}
  ...
  private void func_180684_e(World worldIn, BlockPos p_180684_2_)
  {
    ...
    if (var3.getBlock() == this)
    {
      ...
      {
        BlockPos var5 = p_180684_2_.add(rand.nextInt(16) - rand.nextInt(16), rand.nextInt(8) - rand.nextInt(8), rand.nextInt(16) - rand.nextInt(16));
        
        if (getBlockStategetBlockblockMaterial == Material.air)
        {
          if (isRemote)
          {
            for (int var6 = 0; var6 < 128; var6++)
            {
              double var7 = rand.nextDouble();
              float var9 = (rand.nextFloat() - 0.5F) * 0.2F;
              float var10 = (rand.nextFloat() - 0.5F) * 0.2F;
              float var11 = (rand.nextFloat() - 0.5F) * 0.2F;
              double var12 = var5.getX() + (p_180684_2_.getX() - var5.getX()) * var7 + (rand.nextDouble() - 0.5D) * 1.0D + 0.5D;
              double var14 = var5.getY() + (p_180684_2_.getY() - var5.getY()) * var7 + rand.nextDouble() * 1.0D - 0.5D;
              double var16 = var5.getZ() + (p_180684_2_.getZ() - var5.getZ()) * var7 + (rand.nextDouble() - 0.5D) * 1.0D + 0.5D;
