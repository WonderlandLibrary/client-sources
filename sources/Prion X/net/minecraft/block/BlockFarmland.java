...
public class BlockFarmland extends Block
{
  ...
  protected BlockFarmland()
  {
    ...
    setDefaultState(blockState.getBaseState().withProperty(field_176531_a, Integer.valueOf(0)));
  ...
  public void onFallenUpon(World worldIn, BlockPos pos, Entity entityIn, float fallDistance)
  {
    ...
    {
      if ((!isRemote) && (rand.nextFloat() < fallDistance - 0.5F))
      {
  ...
  {
    return getDefaultState().withProperty(field_176531_a, Integer.valueOf(meta & 0x7));
  }
