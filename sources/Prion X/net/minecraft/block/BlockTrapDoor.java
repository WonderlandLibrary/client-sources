...
public class BlockTrapDoor extends Block
{
  ...
  {
    super(p_i45434_1_);
    setDefaultState(blockState.getBaseState().withProperty(field_176284_a, EnumFacing.NORTH).withProperty(field_176283_b, Boolean.valueOf(false)).withProperty(field_176285_M, DoorHalf.BOTTOM));
    float var2 = 0.5F;
    float var3 = 1.0F;
  ...
  {
    return ((blockMaterial.isOpaque()) && (p_150119_0_.isFullCube())) || (p_150119_0_ == net.minecraft.init.Blocks.glowstone) || ((p_150119_0_ instanceof BlockSlab)) || ((p_150119_0_ instanceof BlockStairs));
  }
