...
public class BlockSponge extends Block
{
  ...
  protected BlockSponge()
  {
    ...
    setDefaultState(blockState.getBaseState().withProperty(WET_PROP, Boolean.valueOf(false)));
  ...
  {
    if ((!((Boolean)p_176311_3_.getValue(WET_PROP)).booleanValue()) && (absorbWater(worldIn, p_176311_2_)))
    {
  ...
  private boolean absorbWater(World worldIn, BlockPos p_176312_2_)
  {
    ...
    while (var14.hasNext())
    {
      BlockPos var7 = (BlockPos)var14.next();
  ...
  {
    return getDefaultState().withProperty(WET_PROP, Boolean.valueOf((meta & 0x1) == 1));
  }
    ...
    if (((Boolean)state.getValue(WET_PROP)).booleanValue())
    {
      ...
      if ((var5 != EnumFacing.UP) && (!World.doesBlockHaveSolidTopSurface(worldIn, pos.offset(var5))))
      {
        ...
        else
        {
          ...
          if (var5.getAxis() == net.minecraft.util.EnumFacing.Axis.X)
          {
            var10 += rand.nextDouble();
