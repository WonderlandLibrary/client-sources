...
public class BiomeGenForest extends BiomeGenBase
{
  ...
  public BiomeGenForest(int p_i45377_1_, int p_i45377_2_)
  {
    ...
    {
      spawnableCreatureList.add(new BiomeGenBase.SpawnListEntry(net.minecraft.entity.passive.EntityWolf.class, 5, 4, 4));
    }
  ...
  protected BiomeGenBase func_150557_a(int p_150557_1_, boolean p_150557_2_)
  {
    if (field_150632_aF == 2)
    {
      ...
      if (p_150557_2_)
      {
        field_150609_ah = ((field_150609_ah & 0xFEFEFE) >> 1);
      }
  ...
  {
    return (field_150632_aF != 2) && (p_150567_1_.nextInt(5) != 0) ? worldGeneratorTrees : (field_150632_aF == 3) && (p_150567_1_.nextInt(3) > 0) ? field_150631_aE : field_150630_aD;
  }
  ...
  public BlockFlower.EnumFlowerType pickRandomFlower(Random p_180623_1_, BlockPos p_180623_2_)
  {
    if (field_150632_aF == 1)
    {
      double var3 = MathHelper.clamp_double((1.0D + field_180281_af.func_151601_a(p_180623_2_.getX() / 48.0D, p_180623_2_.getZ() / 48.0D)) / 2.0D, 0.0D, 0.9999D);
  ...
  public void func_180624_a(World worldIn, Random p_180624_2_, BlockPos p_180624_3_)
  {
    if (field_150632_aF == 3)
    {
      for (int var4 = 0; var4 < 4; var4++)
      {
        ...
        {
          int var6 = var4 * 4 + 1 + 8 + p_180624_2_.nextInt(3);
          int var7 = var5 * 4 + 1 + 8 + p_180624_2_.nextInt(3);
          ...
          {
            WorldGenAbstractTree var12 = genBigTreeChance(p_180624_2_);
            var12.func_175904_e();
    ...
    while (var5 < var4)
    {
      int var6 = p_180624_2_.nextInt(3);
  ...
  public int func_180627_b(BlockPos p_180627_1_)
  {
    ...
    return field_150632_aF == 3 ? (var2 & 0xFEFEFE) + 2634762 >> 1 : var2;
  }
  
  protected BiomeGenBase createMutatedBiome(int p_180277_1_)
  {
    if (biomeID == forestbiomeID)
    {
    ...
    (biomeID != birchForestbiomeID) && (biomeID != birchForestHillsbiomeID) ? new BiomeGenMutated(p_180277_1_, this)
