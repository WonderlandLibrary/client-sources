...
public class Explosion
{
  ...
  public void doExplosionA()
  {
        ...
        for (int var5 = 0; var5 < 16; var5++)
        {
          if ((var3 == 0) || (var3 == 15) || (var4 == 0) || (var4 == 15) || (var5 == 0) || (var5 == 15))
          {
            ...
            for (float var21 = 0.3F; var14 > 0.0F; var14 -= 0.22500001F)
            {
              ...
              {
                float var24 = exploder != null ? exploder.getExplosionResistance(this, worldObj, var22, var23) : var23.getBlock().getExplosionResistance(null);
    ...
    int var4 = MathHelper.floor_double(explosionX - var30 - 1.0D);
    int var5 = MathHelper.floor_double(explosionX + var30 + 1.0D);
    ...
    for (int var34 = 0; var34 < var33.size(); var34++)
    {
      ...
      if (!var13.func_180427_aV())
      {
        ...
        if (var35 <= 1.0D)
        {
          double var16 = posX - explosionX;
          double var18 = posY + var13.getEyeHeight() - explosionY;
          double var20 = posZ - explosionZ;
          ...
          if (var36 != 0.0D)
          {
            ...
            {
              field_77288_k.put((EntityPlayer)var13, new Vec3(var16 * var26, var18 * var26, var20 * var26));
            }
          }
        }
      }
  ...
  {
    return (exploder instanceof EntityLivingBase) ? (EntityLivingBase)exploder : (exploder instanceof EntityTNTPrimed) ? ((EntityTNTPrimed)exploder).getTntPlacedBy() : exploder == null ? null : null;
  }
