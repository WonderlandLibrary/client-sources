  ...
  extends MapGenBase
{
  ...
  protected final void func_180701_a(World worldIn, final int p_180701_2_, final int p_180701_3_, int p_180701_4_, int p_180701_5_, ChunkPrimer p_180701_6_) { func_143027_a(worldIn);
    ...
    if (!structureLongMap.containsItem(ChunkCoordIntPair.chunkXZ2Int(p_180701_2_, p_180701_3_)))
    {
      ...
      try
      {
        ...
        {
          StructureStart var10 = getStructureStart(p_180701_2_, p_180701_3_);
          structureMap.put(Long.valueOf(ChunkCoordIntPair.chunkXZ2Int(p_180701_2_, p_180701_3_)), var10);
      ...
      catch (Throwable var101)
      {
        ...
        var9.addCrashSectionCallable("Is feature chunk", new Callable()
        {
          ...
          public String call() {
            return canSpawnStructureAtCoords(p_180701_2_, p_180701_3_) ? "True" : "False";
          }
        });
  ...
  public boolean func_175794_a(World worldIn, Random p_175794_2_, ChunkCoordIntPair p_175794_3_)
  {
    ...
    int var4 = (chunkXPos << 4) + 8;
    int var5 = (chunkZPos << 4) + 8;
    boolean var6 = false;
    Iterator var7 = structureMap.values().iterator();
  ...
  {
    Iterator var2 = structureMap.values().iterator();
    Iterator var4;
    label94: for (; var2.hasNext(); 
        ...
        var4.hasNext())
    {
      ...
      if ((!var3.isSizeableStructure()) || (!var3.getBoundingBox().func_175898_b(p_175797_1_)))
        break label94;
      var4 = var3.getComponents().iterator();
  ...
  {
    func_143027_a(worldIn);
    Iterator var3 = structureMap.values().iterator();
  ...
  public BlockPos func_180706_b(World worldIn, BlockPos p_180706_2_)
  {
    ...
    long var3 = rand.nextLong();
    long var5 = rand.nextLong();
    long var7 = (p_180706_2_.getX() >> 4) * var3;
    long var9 = (p_180706_2_.getZ() >> 4) * var5;
    rand.setSeed(var7 ^ var9 ^ worldIn.getSeed());
    func_180701_a(worldIn, p_180706_2_.getX() >> 4, p_180706_2_.getZ() >> 4, 0, 0, null);
    double var11 = Double.MAX_VALUE;
    BlockPos var13 = null;
    Iterator var14 = structureMap.values().iterator();
    ...
    while (var14.hasNext())
    {
      ...
      if (var20.isSizeableStructure())
      {
        ...
        BlockPos var17 = var21.func_180776_a();
        double var18 = var17.distanceSq(p_180706_2_);
    ...
    if (var201 != null)
    {
      ...
      while (var22.hasNext())
      {
        BlockPos var17 = (BlockPos)var22.next();
        double var18 = var17.distanceSq(p_180706_2_);
  ...
  private void func_143027_a(World worldIn)
  {
    ...
    {
      field_143029_e = ((MapGenStructureData)worldIn.loadItemData(MapGenStructureData.class, getStructureName()));
      ...
      {
        NBTTagCompound var2 = field_143029_e.func_143041_a();
        ...
        while (var3.hasNext())
        {
          ...
          if (var5.getId() == 10)
          {
            ...
            if ((var6.hasKey("ChunkX")) && (var6.hasKey("ChunkZ")))
            {
              ...
              if (var9 != null)
              {
                structureMap.put(Long.valueOf(ChunkCoordIntPair.chunkXZ2Int(var7, var8)), var9);
