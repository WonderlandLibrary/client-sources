...
{
  private static final BlockStateHelper field_175913_a = BlockStateHelper.forBlock(Blocks.sand).func_177637_a(net.minecraft.block.BlockSand.VARIANT_PROP, Predicates.equalTo(net.minecraft.block.BlockSand.EnumType.SAND));
  ...
  {
    field_175911_b = Blocks.stone_slab.getDefaultState().withProperty(net.minecraft.block.BlockStoneSlab.field_176556_M, net.minecraft.block.BlockStoneSlab.EnumType.SAND).withProperty(BlockSlab.HALF_PROP, net.minecraft.block.BlockSlab.EnumBlockHalf.BOTTOM);
