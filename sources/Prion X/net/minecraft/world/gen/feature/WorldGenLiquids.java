...
public class WorldGenLiquids extends WorldGenerator
{
  ...
  public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_)
  {
    ...
    if ((worldIn.getBlockState(p_180709_3_).getBlock().getMaterial() != net.minecraft.block.material.Material.air) && (worldIn.getBlockState(p_180709_3_).getBlock() != Blocks.stone))
    {
      return false;
    }
