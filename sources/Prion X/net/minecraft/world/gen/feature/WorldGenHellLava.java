...
public class WorldGenHellLava extends WorldGenerator
{
  ...
  public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_)
  {
    ...
    if ((worldIn.getBlockState(p_180709_3_).getBlock().getMaterial() != net.minecraft.block.material.Material.air) && (worldIn.getBlockState(p_180709_3_).getBlock() != Blocks.netherrack))
    {
      return false;
    }
