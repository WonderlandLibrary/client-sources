...
public class WorldGenDungeons extends WorldGenerator
{
  ...
  private static final java.util.List CHESTCONTENT = com.google.common.collect.Lists.newArrayList(new WeightedRandomChestContent[] { new WeightedRandomChestContent(Items.saddle, 0, 1, 1, 10), new WeightedRandomChestContent(Items.iron_ingot, 0, 1, 4, 10), new WeightedRandomChestContent(Items.bread, 0, 1, 1, 10), new WeightedRandomChestContent(Items.wheat, 0, 1, 4, 10), new WeightedRandomChestContent(Items.gunpowder, 0, 1, 4, 10), new WeightedRandomChestContent(Items.string, 0, 1, 4, 10), new WeightedRandomChestContent(Items.bucket, 0, 1, 1, 10), new WeightedRandomChestContent(Items.golden_apple, 0, 1, 1, 1), new WeightedRandomChestContent(Items.redstone, 0, 1, 4, 10), new WeightedRandomChestContent(Items.record_13, 0, 1, 1, 4), new WeightedRandomChestContent(Items.record_cat, 0, 1, 1, 4), new WeightedRandomChestContent(Items.name_tag, 0, 1, 1, 10), new WeightedRandomChestContent(Items.golden_horse_armor, 0, 1, 1, 2), new WeightedRandomChestContent(Items.iron_horse_armor, 0, 1, 1, 5), new WeightedRandomChestContent(Items.diamond_horse_armor, 0, 1, 1, 1) });
  private static final String __OBFID = "CL_00000425";
  
  public WorldGenDungeons() {}
  
  public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_) { boolean var4 = true;
    ...
    for (int var14 = var6; var14 <= var7; var14++)
    {
      for (int var15 = -1; var15 <= 4; var15++)
      {
        ...
        {
          BlockPos var17 = p_180709_3_.add(var14, var15, var16);
    ...
    if ((var13 >= 1) && (var13 <= 5))
    {
      ...
      while (var14 < 2)
      {
        ...
        while (var15 < 3)
        {
          ...
          int var16 = p_180709_3_.getX() + p_180709_2_.nextInt(var5 * 2 + 1) - var5;
          ...
          if (worldIn.isAirBlock(var26))
          {
            ...
            if (var20 == 1)
            {
              ...
              java.util.List var27 = WeightedRandomChestContent.func_177629_a(CHESTCONTENT, new WeightedRandomChestContent[] { Items.enchanted_book.getRandomEnchantedBook(p_180709_2_) });
              TileEntity var28 = worldIn.getTileEntity(var26);
              
              if (!(var28 instanceof net.minecraft.tileentity.TileEntityChest))
                break;
              WeightedRandomChestContent.generateChestContents(p_180709_2_, var27, (net.minecraft.tileentity.TileEntityChest)var28, 8);
      ...
      {
        ((TileEntityMobSpawner)var23).getSpawnerBaseLogic().setEntityName(pickMobSpawner(p_180709_2_));
      }
      else
      {
