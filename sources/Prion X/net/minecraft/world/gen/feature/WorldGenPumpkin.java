...
public class WorldGenPumpkin extends WorldGenerator
{
  ...
  public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_)
  {
    for (int var4 = 0; var4 < 64; var4++)
    {
      ...
      {
        worldIn.setBlockState(var5, Blocks.pumpkin.getDefaultState().withProperty(net.minecraft.block.BlockPumpkin.AGE, net.minecraft.util.EnumFacing.Plane.HORIZONTAL.random(p_180709_2_)), 2);
      }
    }
