  ...
  public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_)
  {
    ...
    if ((p_180709_3_.getY() >= 1) && (p_180709_3_.getY() + var4 + 1 <= 256))
    {
      ...
      for (int var9 = p_180709_3_.getY(); (var9 <= p_180709_3_.getY() + 1 + var4) && (var8); var9++)
      {
        boolean var10 = true;
        int var18;
        int var18; if (var9 - p_180709_3_.getY() < var5)
        {
          var18 = 0;
        }
        else
        ...
        for (int var11 = p_180709_3_.getX() - var18; (var11 <= p_180709_3_.getX() + var18) && (var8); var11++)
        {
          for (int var12 = p_180709_3_.getZ() - var18; (var12 <= p_180709_3_.getZ() + var18) && (var8); var12++)
          {
            if ((var9 >= 0) && (var9 < 256))
            {
      ...
      if (((var17 == Blocks.grass) || (var17 == Blocks.dirt)) && (p_180709_3_.getY() < 256 - var4 - 1))
      {
        ...
        for (int var11 = p_180709_3_.getY() + var4; var11 >= p_180709_3_.getY() + var5; var11--)
        {
          for (int var12 = p_180709_3_.getX() - var18; var12 <= p_180709_3_.getX() + var18; var12++)
          {
            ...
            for (int var14 = p_180709_3_.getZ() - var18; var14 <= p_180709_3_.getZ() + var18; var14++)
            {
              ...
              if ((Math.abs(var13) != var18) || (Math.abs(var15) != var18) || (var18 <= 0))
              {
                ...
                {
                  func_175905_a(worldIn, var16, Blocks.leaves, BlockPlanks.EnumType.SPRUCE.func_176839_a());
                }
              }
            }
          }
        ...
        for (var11 = 0; var11 < var4 - 1; var11++)
        {
          ...
          if ((var19.getMaterial() == net.minecraft.block.material.Material.air) || (var19.getMaterial() == net.minecraft.block.material.Material.leaves))
          {
            func_175905_a(worldIn, p_180709_3_.offsetUp(var11), Blocks.log, BlockPlanks.EnumType.SPRUCE.func_176839_a());
          }
        }
