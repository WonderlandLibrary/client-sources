...
{
  private float[] field_75046_d = new float['Ѐ'];
  ...
  protected void func_180707_a(long p_180707_1_, int p_180707_3_, int p_180707_4_, ChunkPrimer p_180707_5_, double p_180707_6_, double p_180707_8_, double p_180707_10_, float p_180707_12_, float p_180707_13_, float p_180707_14_, int p_180707_15_, int p_180707_16_, double p_180707_17_) { Random var19 = new Random(p_180707_1_);
    ...
    for (; 
        p_180707_15_ < p_180707_16_; p_180707_15_++)
    {
      double var53 = 1.5D + MathHelper.sin(p_180707_15_ * 3.1415927F / p_180707_16_) * p_180707_12_ * 1.0F;
      ...
      if ((var52) || (var19.nextInt(4) != 0))
      {
        ...
        if ((p_180707_6_ >= var20 - 16.0D - var53 * 2.0D) && (p_180707_10_ >= var22 - 16.0D - var53 * 2.0D) && (p_180707_6_ <= var20 + 16.0D + var53 * 2.0D) && (p_180707_10_ <= var22 + 16.0D + var53 * 2.0D))
        {
          ...
          for (int var41 = var54; (!var57) && (var41 < var35); var41++)
          {
          ...
          if (!var57)
          {
            ...
            {
              double var58 = (var41 + p_180707_3_ * 16 + 0.5D - p_180707_6_) / var53;
              
              for (int var59 = var56; var59 < var39; var59++)
              {
                double var45 = (var59 + p_180707_4_ * 16 + 0.5D - p_180707_10_) / var53;
                boolean var47 = false;
                ...
                if (var58 * var58 + var45 * var45 < 1.0D)
                {
                  ...
                  {
                    double var49 = (var48 - 1 + 0.5D - p_180707_8_) / var30;
                    
                    if ((var58 * var58 + var45 * var45) * field_75046_d[(var48 - 1)] + var49 * var49 / 6.0D < 1.0D)
                    {
                      ...
                      if ((var51.getBlock() == Blocks.stone) || (var51.getBlock() == Blocks.dirt) || (var51.getBlock() == Blocks.grass))
                      {
                        ...
                        else
                        {
                          ...
                          {
                            p_180707_5_.setBlockState(var41, var48 - 1, var59, worldObj.getBiomeGenForCoords(new net.minecraft.util.BlockPos(var41 + p_180707_3_ * 16, 0, var59 + p_180707_4_ * 16)).topBlock);
                          }
                        }
                      }
                    }
  ...
  protected void func_180701_a(World worldIn, int p_180701_2_, int p_180701_3_, int p_180701_4_, int p_180701_5_, ChunkPrimer p_180701_6_)
  {
    ...
    {
      double var7 = p_180701_2_ * 16 + rand.nextInt(16);
      double var9 = rand.nextInt(rand.nextInt(40) + 8) + 20;
      double var11 = p_180701_3_ * 16 + rand.nextInt(16);
      byte var13 = 1;
      ...
      for (int var14 = 0; var14 < var13; var14++)
      {
        ...
        func_180707_a(rand.nextLong(), p_180701_4_, p_180701_5_, p_180701_6_, var7, var9, var11, var17, var15, var16, 0, 0, 3.0D);
      }
    }
  }
}
