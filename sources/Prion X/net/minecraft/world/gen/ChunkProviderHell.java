  ...
  implements IChunkProvider
{
  ...
  private double[] slowsandNoise = new double['Ā'];
  private double[] gravelNoise = new double['Ā'];
  



  private double[] netherrackExclusivityNoise = new double['Ā'];
  ...
  {
    field_177467_w = new WorldGenMinable(Blocks.quartz_ore.getDefaultState(), 14, BlockHelper.forBlock(Blocks.netherrack));
  ...
  public void func_180516_b(int p_180516_1_, int p_180516_2_, ChunkPrimer p_180516_3_)
  {
    ...
    slowsandNoise = slowsandGravelNoiseGen.generateNoiseOctaves(slowsandNoise, p_180516_1_ * 16, p_180516_2_ * 16, 0, 16, 16, 1, var5, var5, 1.0D);
    gravelNoise = slowsandGravelNoiseGen.generateNoiseOctaves(gravelNoise, p_180516_1_ * 16, 109, p_180516_2_ * 16, 16, 1, 16, var5, 1.0D, var5);
    netherrackExclusivityNoise = netherrackExculsivityNoiseGen.generateNoiseOctaves(netherrackExclusivityNoise, p_180516_1_ * 16, p_180516_2_ * 16, 0, 16, 16, 1, var5 * 2.0D, var5 * 2.0D, var5 * 2.0D);
    
    for (int var7 = 0; var7 < 16; var7++)
    {
      for (int var8 = 0; var8 < 16; var8++)
      {
        boolean var9 = slowsandNoise[(var7 + var8 * 16)] + hellRNG.nextDouble() * 0.2D > 0.0D;
        boolean var10 = gravelNoise[(var7 + var8 * 16)] + hellRNG.nextDouble() * 0.2D > 0.0D;
        int var11 = (int)(netherrackExclusivityNoise[(var7 + var8 * 16)] / 3.0D + 3.0D + hellRNG.nextDouble() * 0.25D);
        int var12 = -1;
  ...
  public Chunk provideChunk(int p_73154_1_, int p_73154_2_)
  {
    ...
    BiomeGenBase[] var5 = worldObj.getWorldChunkManager().loadBlockGeneratorData(null, p_73154_1_ * 16, p_73154_2_ * 16, 16, 16);
    byte[] var6 = var4.getBiomeArray();
    
    for (int var7 = 0; var7 < var6.length; var7++)
    {
      var6[var7] = ((byte)biomeID);
    }
  ...
  private double[] initializeNoiseField(double[] p_73164_1_, int p_73164_2_, int p_73164_3_, int p_73164_4_, int p_73164_5_, int p_73164_6_, int p_73164_7_)
  {
    ...
    noiseData1 = netherNoiseGen3.generateNoiseOctaves(noiseData1, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, var8 / 80.0D, var10 / 60.0D, var8 / 80.0D);
    noiseData2 = netherNoiseGen1.generateNoiseOctaves(noiseData2, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, var8, var10, var8);
    noiseData3 = netherNoiseGen2.generateNoiseOctaves(noiseData3, p_73164_2_, p_73164_3_, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, var8, var10, var8);
    int var12 = 0;
    double[] var13 = new double[p_73164_6_];
    

    for (int var14 = 0; var14 < p_73164_6_; var14++)
    {
      var13[var14] = (Math.cos(var14 * 3.141592653589793D * 6.0D / p_73164_6_) * 2.0D);
      double var15 = var14;
    ...
    for (var14 = 0; var14 < p_73164_5_; var14++)
    {
      for (int var31 = 0; var31 < p_73164_7_; var31++)
      {
        ...
        for (int var18 = 0; var18 < p_73164_6_; var18++)
        {
          ...
          double var23 = noiseData2[var12] / 512.0D;
          double var25 = noiseData3[var12] / 512.0D;
          double var27 = (noiseData1[var12] / 10.0D + 1.0D) / 2.0D;
          ...
          {
            double var29 = (var18 - (p_73164_6_ - 4)) / 3.0F;
            var19 = var19 * (1.0D - var29) + -10.0D * var29;
          }
          
          if (var18 < var16)
          {
            double var29 = (var16 - var18) / 4.0D;
  ...
  public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
  {
    ...
    {
      field_177472_y.generate(worldObj, hellRNG, var4.add(hellRNG.nextInt(16) + 8, hellRNG.nextInt(120) + 4, hellRNG.nextInt(16) + 8));
    }
    
    for (var6 = 0; var6 < hellRNG.nextInt(hellRNG.nextInt(10) + 1) + 1; var6++)
    {
      field_177470_t.generate(worldObj, hellRNG, var4.add(hellRNG.nextInt(16) + 8, hellRNG.nextInt(120) + 4, hellRNG.nextInt(16) + 8));
    }
    
    for (var6 = 0; var6 < hellRNG.nextInt(hellRNG.nextInt(10) + 1); var6++)
    {
      field_177469_u.generate(worldObj, hellRNG, var4.add(hellRNG.nextInt(16) + 8, hellRNG.nextInt(120) + 4, hellRNG.nextInt(16) + 8));
    }
    
    for (var6 = 0; var6 < 10; var6++)
    {
      field_177468_v.generate(worldObj, hellRNG, var4.add(hellRNG.nextInt(16) + 8, hellRNG.nextInt(128), hellRNG.nextInt(16) + 8));
    }
    
    if (hellRNG.nextBoolean())
    {
      field_177471_z.generate(worldObj, hellRNG, var4.add(hellRNG.nextInt(16) + 8, hellRNG.nextInt(128), hellRNG.nextInt(16) + 8));
    }
    
    if (hellRNG.nextBoolean())
    {
      field_177465_A.generate(worldObj, hellRNG, var4.add(hellRNG.nextInt(16) + 8, hellRNG.nextInt(128), hellRNG.nextInt(16) + 8));
    }
    
    for (var6 = 0; var6 < 16; var6++)
    {
      field_177467_w.generate(worldObj, hellRNG, var4.add(hellRNG.nextInt(16), hellRNG.nextInt(108) + 10, hellRNG.nextInt(16)));
    }
    
    for (var6 = 0; var6 < 16; var6++)
    {
      field_177473_x.generate(worldObj, hellRNG, var4.add(hellRNG.nextInt(16), hellRNG.nextInt(108) + 10, hellRNG.nextInt(16)));
    }
  ...
  public List func_177458_a(EnumCreatureType p_177458_1_, BlockPos p_177458_2_)
  {
    if (p_177458_1_ == EnumCreatureType.MONSTER)
    {
      ...
      if ((genNetherBridge.func_175796_a(worldObj, p_177458_2_)) && (worldObj.getBlockState(p_177458_2_.offsetDown()).getBlock() == Blocks.nether_brick))
      {
        return genNetherBridge.getSpawnList();
      }
    }
  ...
  {
    genNetherBridge.func_175792_a(this, worldObj, p_180514_2_, p_180514_3_, null);
  }
