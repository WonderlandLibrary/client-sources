...
public abstract class GenLayer
{
  ...
  protected static boolean biomesEqualOrMesaPlateau(int biomeIDA, int biomeIDB)
  {
    ...
    if ((biomeIDA != mesaPlateau_FbiomeID) && (biomeIDA != mesaPlateaubiomeID))
    {
      ...
      catch (Throwable var7)
      {
        ...
        var6.addCrashSectionCallable("Biome A", new Callable()
        {
          ...
          public String call() {
            return String.valueOf(GenLayer.this);
          }
        });
    ...
    return (biomeIDB == mesaPlateau_FbiomeID) || (biomeIDB == mesaPlateaubiomeID);
  }
  ...
  {
    return (p_151618_0_ == oceanbiomeID) || (p_151618_0_ == deepOceanbiomeID) || (p_151618_0_ == frozenOceanbiomeID);
  }
