...
public class MapGenCavesHell extends MapGenBase
{
  ...
  protected void func_180704_a(long p_180704_1_, int p_180704_3_, int p_180704_4_, ChunkPrimer p_180704_5_, double p_180704_6_, double p_180704_8_, double p_180704_10_, float p_180704_12_, float p_180704_13_, float p_180704_14_, int p_180704_15_, int p_180704_16_, double p_180704_17_)
  {
    ...
    {
      double var29 = 1.5D + MathHelper.sin(p_180704_15_ * 3.1415927F / p_180704_16_) * p_180704_12_ * 1.0F;
      ...
      {
        func_180704_a(var25.nextLong(), p_180704_3_, p_180704_4_, p_180704_5_, p_180704_6_, p_180704_8_, p_180704_10_, var25.nextFloat() * 0.5F + 0.5F, p_180704_13_ - 1.5707964F, p_180704_14_ / 3.0F, p_180704_15_, p_180704_16_, 1.0D);
        func_180704_a(var25.nextLong(), p_180704_3_, p_180704_4_, p_180704_5_, p_180704_6_, p_180704_8_, p_180704_10_, var25.nextFloat() * 0.5F + 0.5F, p_180704_13_ + 1.5707964F, p_180704_14_ / 3.0F, p_180704_15_, p_180704_16_, 1.0D);
        return;
      }
      ...
      if ((var52) || (var25.nextInt(4) != 0))
      {
        ...
        if ((p_180704_6_ >= var19 - 16.0D - var29 * 2.0D) && (p_180704_10_ >= var21 - 16.0D - var29 * 2.0D) && (p_180704_6_ <= var19 + 16.0D + var29 * 2.0D) && (p_180704_10_ <= var21 + 16.0D + var29 * 2.0D))
        {
          ...
          for (int var42 = var53; (!var56) && (var42 < var36); var42++)
          {
            for (int var43 = var55; (!var56) && (var43 < var40); var43++)
            {
              for (int var44 = var38 + 1; (!var56) && (var44 >= var54 - 1); var44--)
              {
                if ((var44 >= 0) && (var44 < 128))
                {
                  ...
                  if ((var45.getBlock() == net.minecraft.init.Blocks.flowing_lava) || (var45.getBlock() == net.minecraft.init.Blocks.lava))
                  {
                    var56 = true;
                  }
              ...
              for (int var58 = var55; var58 < var40; var58++)
              {
                ...
                for (int var48 = var38; var48 > var54; var48--)
                {
                  ...
                  if ((var49 > -0.7D) && (var57 * var57 + var49 * var49 + var46 * var46 < 1.0D))
                  {
                    ...
                    if ((var51.getBlock() == net.minecraft.init.Blocks.netherrack) || (var51.getBlock() == net.minecraft.init.Blocks.dirt) || (var51.getBlock() == net.minecraft.init.Blocks.grass))
                    {
                      p_180704_5_.setBlockState(var42, var48, var58, net.minecraft.init.Blocks.air.getDefaultState());
                    }
                  }
                }
              }
  ...
  protected void func_180701_a(net.minecraft.world.World worldIn, int p_180701_2_, int p_180701_3_, int p_180701_4_, int p_180701_5_, ChunkPrimer p_180701_6_)
  {
    ...
    for (int var8 = 0; var8 < var7; var8++)
    {
      ...
      for (int var16 = 0; var16 < var15; var16++)
      {
        ...
        func_180704_a(rand.nextLong(), p_180701_4_, p_180701_5_, p_180701_6_, var9, var11, var13, var19 * 2.0F, var17, var18, 0, 0, 0.5D);
      }
    }
  }
}
