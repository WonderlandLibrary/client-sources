...
public class TileEntityChest extends TileEntityLockable implements IUpdatePlayerListBox, IInventory
{
  ...
  public ItemStack decrStackSize(int index, int count)
  {
    if (chestContents[index] != null)
    {
      ...
      {
        ItemStack var3 = chestContents[index];
      ...
      ItemStack var3 = chestContents[index].splitStack(count);
  ...
  private boolean func_174912_b(BlockPos p_174912_1_)
  {
    ...
    net.minecraft.block.Block var2 = worldObj.getBlockState(p_174912_1_).getBlock();
    return ((var2 instanceof BlockChest)) && (chestType == getChestType());
  }
  ...
  public void update()
  {
    ...
    if ((!worldObj.isRemote) && (numPlayersUsing != 0) && ((ticksSinceSync + var1 + var2 + var3) % 200 == 0))
    {
      numPlayersUsing = 0;
      float var4 = 5.0F;
      List var5 = worldObj.getEntitiesWithinAABB(EntityPlayer.class, new net.minecraft.util.AxisAlignedBB(var1 - var4, var2 - var4, var3 - var4, var1 + 1 + var4, var2 + 1 + var4, var3 + 1 + var4));
      ...
      while (var6.hasNext())
      {
        ...
        {
          IInventory var8 = ((ContainerChest)openContainer).getLowerChestInventory();
  ...
  public int getChestType()
  {
    if (cachedChestType == -1)
    {
      ...
      cachedChestType = getBlockTypechestType;
    }
