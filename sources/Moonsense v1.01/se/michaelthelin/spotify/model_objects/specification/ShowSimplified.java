...
public class ShowSimplified extends AbstractModelObject implements ISearchModelObject
{
    ...
    public ShowSimplified(final Builder builder) {
        super(builder);
    ...
    public String toString() {
        return invokedynamic(makeConcatWithConstants:(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Boolean;Lse/michaelthelin/spotify/model_objects/specification/ExternalUrl;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lse/michaelthelin/spotify/enums/ModelObjectType;Ljava/lang/String;)Ljava/lang/String;, Arrays.toString(this.availableMarkets), Arrays.toString(this.copyrights), this.description, this.explicit, this.externalUrls, this.href, this.id, Arrays.toString(this.images), this.isExternallyHosted, Arrays.toString(this.languages), this.mediaType, this.name, this.publisher, this.type, this.uri);
    }
