...
public class EpisodeSimplified extends AbstractModelObject implements ISearchModelObject
{
    ...
    public String toString() {
        return invokedynamic(makeConcatWithConstants:(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/Boolean;Lse/michaelthelin/spotify/model_objects/specification/ExternalUrl;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/lang/String;Ljava/lang/String;Lse/michaelthelin/spotify/enums/ReleaseDatePrecision;Lse/michaelthelin/spotify/model_objects/specification/ResumePoint;Lse/michaelthelin/spotify/enums/ModelObjectType;Ljava/lang/String;)Ljava/lang/String;, this.name, this.audioPreviewUrl, this.description, this.durationMs, this.explicit, this.externalUrls, this.href, this.id, Arrays.toString(this.images), this.isExternallyHosted, this.isPlayable, Arrays.toString(this.languages), this.releaseDate, this.releaseDatePrecision, this.resumePoint, this.type, this.uri);
    }
    ...
    public static final class Builder extends AbstractModelObject.Builder
    {
        ...
        public EpisodeSimplified build() {
            return new EpisodeSimplified(this, null);
        }
    }
