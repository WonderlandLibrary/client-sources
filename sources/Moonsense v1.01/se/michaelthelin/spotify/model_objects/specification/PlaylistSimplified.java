...
public class PlaylistSimplified extends AbstractModelObject implements ISearchModelObject
{
    ...
    public String toString() {
        return invokedynamic(makeConcatWithConstants:(Ljava/lang/String;Lse/michaelthelin/spotify/model_objects/miscellaneous/PlaylistTracksInformation;Ljava/lang/Boolean;Lse/michaelthelin/spotify/model_objects/specification/ExternalUrl;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lse/michaelthelin/spotify/model_objects/specification/User;Ljava/lang/Boolean;Ljava/lang/String;Lse/michaelthelin/spotify/enums/ModelObjectType;Ljava/lang/String;)Ljava/lang/String;, this.name, this.tracks, this.collaborative, this.externalUrls, this.href, this.id, Arrays.toString(this.images), this.owner, this.publicAccess, this.snapshotId, this.type, this.uri);
    }
    ...
    public static final class Builder extends AbstractModelObject.Builder
    {
        ...
        public Builder setTracks(final PlaylistTracksInformation tracks) {
            this.tracks = tracks;
            return this;
        }
        ...
        public PlaylistSimplified build() {
            return new PlaylistSimplified(this, null);
        }
    }
