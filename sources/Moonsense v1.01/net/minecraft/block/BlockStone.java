...
public class BlockStone extends Block
{
    ...
    public enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(final String s, final int n, final String p_i45680_1_, final int p_i45680_2_, final int p_i45680_3_, final String p_i45680_4_) {
            this(s, n, p_i45680_1_, p_i45680_2_, p_i45680_3_, p_i45680_4_, p_i45680_4_);
        }
        
        private EnumType(final String name, final int ordinal, final String p_i45681_1_, final int p_i45681_2_, final int p_i45681_3_, final String p_i45681_4_, final String p_i45681_5_) {
