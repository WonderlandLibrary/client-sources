...
public abstract class BlockStoneSlab extends BlockSlab
{
    ...
    public enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(final String s, final int n, final String p_i45677_1_, final int p_i45677_2_, final int p_i45677_3_, final String p_i45677_4_) {
            this(s, n, p_i45677_1_, p_i45677_2_, p_i45677_3_, p_i45677_4_, p_i45677_4_);
        }
        
        private EnumType(final String name, final int ordinal, final String p_i45678_1_, final int p_i45678_2_, final int p_i45678_3_, final String p_i45678_4_, final String p_i45678_5_) {
