...
public class BlockSilverfish extends Block
{
    ...
    public enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(final String s, final int n, final String p_i45704_1_, final int p_i45704_2_, final int p_i45704_3_, final String p_i45704_4_) {
            this(s, n, p_i45704_1_, p_i45704_2_, p_i45704_3_, p_i45704_4_, p_i45704_4_);
        }
        
        private EnumType(final String name, final int ordinal, final String p_i45705_1_, final int p_i45705_2_, final int p_i45705_3_, final String p_i45705_4_, final String p_i45705_5_) {
        ...
        private EnumType(final String s, final int n, final String p_i45706_1_, final int p_i45706_2_, final int p_i45706_3_, final String p_i45706_4_, final SwitchEnumType p_i45706_5_) {
            this(s, n, p_i45706_1_, p_i45706_2_, p_i45706_3_, p_i45706_4_);
        }
        
        private EnumType(final String s, final int n, final String p_i45707_1_, final int p_i45707_2_, final int p_i45707_3_, final String p_i45707_4_, final String p_i45707_5_, final SwitchEnumType p_i45707_6_) {
