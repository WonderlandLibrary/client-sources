...
public abstract class BlockFlower extends BlockBush
{
    ...
    public enum EnumFlowerColor
    {
        ...
        private EnumFlowerColor(final String name, final int ordinal, final String p_i45716_1_, final int p_i45716_2_) {
        }
    ...
    public enum EnumFlowerType implements IStringSerializable
    {
        ...
        private EnumFlowerType(final String s, final int n, final String p_i45718_1_, final int p_i45718_2_, final EnumFlowerColor p_i45718_3_, final int p_i45718_4_, final String p_i45718_5_) {
            this(s, n, p_i45718_1_, p_i45718_2_, p_i45718_3_, p_i45718_4_, p_i45718_5_, p_i45718_5_);
        }
        
        private EnumFlowerType(final String name, final int ordinal, final String p_i45719_1_, final int p_i45719_2_, final EnumFlowerColor p_i45719_3_, final int p_i45719_4_, final String p_i45719_5_, final String p_i45719_6_) {
