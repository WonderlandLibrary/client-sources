...
public class BlockDoublePlant extends BlockBush implements IGrowable
{
    ...
    enum EnumBlockHalf implements IStringSerializable
    {
        ...
        private EnumBlockHalf(final String name, final int ordinal, final String p_i45724_1_, final int p_i45724_2_) {
        }
    ...
    public enum EnumPlantType implements IStringSerializable
    {
        ...
        private EnumPlantType(final String s, final int n, final String p_i45722_1_, final int p_i45722_2_, final int p_i45722_3_, final String p_i45722_4_) {
            this(s, n, p_i45722_1_, p_i45722_2_, p_i45722_3_, p_i45722_4_, p_i45722_4_);
        }
        
        private EnumPlantType(final String name, final int ordinal, final String p_i45723_1_, final int p_i45723_2_, final int p_i45723_3_, final String p_i45723_4_, final String p_i45723_5_) {
