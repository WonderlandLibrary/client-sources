...
public class BlockDirt extends Block
{
    ...
    public enum DirtType implements IStringSerializable
    {
        ...
        private DirtType(final String s, final int n, final String p_i45727_1_, final int p_i45727_2_, final int metadata, final String name) {
            this(s, n, p_i45727_1_, p_i45727_2_, metadata, name, name);
        }
        
        private DirtType(final String name2, final int ordinal, final String p_i45728_1_, final int p_i45728_2_, final int metadata, final String name, final String unlocalizedName) {
