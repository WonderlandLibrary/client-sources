...
public class BlockPlanks extends Block
{
    ...
    public enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(final String s, final int n, final String p_i45695_1_, final int p_i45695_2_, final int p_i45695_3_, final String p_i45695_4_) {
            this(s, n, p_i45695_1_, p_i45695_2_, p_i45695_3_, p_i45695_4_, p_i45695_4_);
        }
        
        private EnumType(final String name, final int ordinal, final String p_i45696_1_, final int p_i45696_2_, final int p_i45696_3_, final String p_i45696_4_, final String p_i45696_5_) {
