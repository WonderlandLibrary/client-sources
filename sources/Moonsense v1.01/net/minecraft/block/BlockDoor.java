...
public class BlockDoor extends Block
{
    ...
    public enum EnumDoorHalf implements IStringSerializable
    {
        ...
        private EnumDoorHalf(final String name, final int ordinal, final String p_i45726_1_, final int p_i45726_2_) {
        }
    ...
    public enum EnumHingePosition implements IStringSerializable
    {
        ...
        private EnumHingePosition(final String name, final int ordinal, final String p_i45725_1_, final int p_i45725_2_) {
        }
