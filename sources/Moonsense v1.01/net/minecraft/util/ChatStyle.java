...
public class ChatStyle
{
    ...
    public static class Serializer implements JsonDeserializer, JsonSerializer
    {
        ...
        public ChatStyle deserialize(final JsonElement p_deserialize_1_, final Type p_deserialize_2_, final JsonDeserializationContext p_deserialize_3_) {
            ...
            if (var5.has("color")) {
                ChatStyle.access$5(var4, p_deserialize_3_.deserialize(var5.get("color"), EnumChatFormatting.class));
            }
            ...
            if (var5.has("hoverEvent")) {
                ...
                if (var6 != null) {
                    ...
                    final IChatComponent var12 = p_deserialize_3_.deserialize(var6.get("value"), IChatComponent.class);
