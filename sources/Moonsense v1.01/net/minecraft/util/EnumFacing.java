...
public enum EnumFacing implements IStringSerializable
{
    ...
    private EnumFacing(final String name, final int ordinal, final String p_i46016_1_, final int p_i46016_2_, final int indexIn, final int oppositeIn, final int horizontalIndexIn, final String nameIn, final AxisDirection axisDirectionIn, final Axis axisIn, final Vec3i directionVecIn) {
        this.index = indexIn;
    ...
    public enum Axis implements Predicate, IStringSerializable
    {
        ...
        private Axis(final String name2, final int ordinal, final String p_i46390_1_, final int p_i46390_2_, final String p_i46015_1_, final int p_i46015_2_, final String name, final Plane plane) {
            this.name = name;
            this.plane = plane;
        }
    ...
    public enum Plane implements Predicate, Iterable
    {
        ...
        private Plane(final String name, final int ordinal, final String p_i46392_1_, final int p_i46392_2_, final String p_i46013_1_, final int p_i46013_2_) {
        }
    ...
    public enum AxisDirection
    {
        ...
        private AxisDirection(final String name, final int ordinal, final String p_i46391_1_, final int p_i46391_2_, final String p_i46014_1_, final int p_i46014_2_, final int offset, final String description) {
            this.offset = offset;
