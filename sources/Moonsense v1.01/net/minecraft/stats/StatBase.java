    ...
    static {
        ...
        StatBase.timeStatType = new IStatType() {
            ...
            public String format(final int p_75843_1_) {
                ...
                return (var6 > 0.5) ? (String.valueOf(StatBase.decimalFormat.format(var6)) + " y") : ((var5 > 0.5) ? (String.valueOf(StatBase.decimalFormat.format(var5)) + " d") : ((var4 > 0.5) ? (String.valueOf(StatBase.decimalFormat.format(var4)) + " h") : ((var3 > 0.5) ? (String.valueOf(StatBase.decimalFormat.format(var3)) + " m") : (String.valueOf(var2) + " s"))));
            }
        };
        StatBase.distanceStatType = new IStatType() {
            ...
            public String format(final int p_75843_1_) {
                ...
                return (var3 > 0.5) ? (String.valueOf(StatBase.decimalFormat.format(var3)) + " km") : ((var2 > 0.5) ? (String.valueOf(StatBase.decimalFormat.format(var2)) + " m") : (String.valueOf(p_75843_1_) + " cm"));
            }
        };
