...
public class CommandResultStats
{
    ...
    public void func_179668_a(final NBTTagCompound p_179668_1_) {
        if (p_179668_1_.hasKey("CommandStats", 10)) {
            ...
            for (final Type var6 : Type.values()) {
                final String var7 = String.valueOf(var6.func_179637_b()) + "Name";
                final String var8 = String.valueOf(var6.func_179637_b()) + "Objective";
    ...
    public enum Type
    {
        ...
        private Type(final String name, final int ordinal, final String p_i46050_1_, final int p_i46050_2_, final int p_i46050_3_, final String p_i46050_4_) {
