...
public abstract class ServerConfigurationManager
{
    ...
    public void initializeConnectionToPlayer(final NetworkManager netManager, final EntityPlayerMP playerIn) {
        ...
        ServerConfigurationManager.logger.info(String.valueOf(playerIn.getName()) + "[" + var8 + "] logged in with entity id " + playerIn.getEntityId() + " at (" + playerIn.posX + ", " + playerIn.posY + ", " + playerIn.posZ + ")");
    ...
    public String func_180602_f() {
        ...
        for (int var2 = 0; var2 < this.playerEntityList.size(); ++var2) {
            ...
            var1 = String.valueOf(var1) + this.playerEntityList.get(var2).getName();
        }
        return var1;
    }
    ...
    public StatisticsFile getPlayerStatsFile(final EntityPlayer playerIn) {
        ...
        if (var3 == null) {
            ...
            if (!var5.exists()) {
                final File var6 = new File(var4, String.valueOf(playerIn.getName()) + ".json");
