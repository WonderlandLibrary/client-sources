...
public class PlayerProfileCache
{
    ...
    public void func_152657_b() {
        ...
        Label_0055: {
            try {
                ...
                var1 = this.gson.fromJson(var2, PlayerProfileCache.field_152666_h);
                break Label_0055;
            }
    ...
    public void func_152658_c() {
        final String var1 = this.gson.toJson(this.func_152656_a(1000));
    ...
    class ProfileEntry
    {
        ...
        ProfileEntry(final PlayerProfileCache playerProfileCache, final GameProfile p_i1166_2_, final Date p_i1166_3_, final Object p_i1166_4_) {
    ...
    class Serializer implements JsonDeserializer, JsonSerializer
    {
        ...
        Serializer(final PlayerProfileCache playerProfileCache, final Object p_i46332_2_) {
