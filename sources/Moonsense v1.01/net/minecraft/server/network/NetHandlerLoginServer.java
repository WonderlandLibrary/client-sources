...
public class NetHandlerLoginServer implements INetHandlerLoginServer, IUpdatePlayerListBox
{
    ...
    public void onDisconnect(final IChatComponent reason) {
        NetHandlerLoginServer.logger.info(String.valueOf(this.func_147317_d()) + " lost connection: " + reason.getUnformattedText());
    }
        ...
        new Thread("User Authenticator #" + NetHandlerLoginServer.AUTHENTICATOR_THREAD_ID.incrementAndGet()) {
            ...
            public void run() {
                ...
                try {
                    ...
                    NetHandlerLoginServer.access$4(NetHandlerLoginServer.this, NetHandlerLoginServer.this.server.getMinecraftSessionService().hasJoinedServer(new GameProfile((UUID)null, var1.getName()), var2));
    ...
    enum LoginState
    {
        ...
        private LoginState(final String name, final int ordinal, final String p_i45297_1_, final int p_i45297_2_) {
        }
    }
}
