...
public class MusicTicker implements IUpdatePlayerListBox
{
    ...
    public enum MusicType
    {
        ...
        private MusicType(final String name, final int ordinal, final String p_i45111_1_, final int p_i45111_2_, final ResourceLocation location, final int p_i45111_4_, final int p_i45111_5_) {
