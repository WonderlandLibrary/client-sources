...
public class SoundHandler implements IResourceManagerReloadListener, IUpdatePlayerListBox
{
    ...
    protected Map getSoundMap(final InputStream p_175085_1_) {
        Map var2;
        try {
            var2 = SoundHandler.field_147699_c.fromJson(new InputStreamReader(p_175085_1_), SoundHandler.field_147696_d);
        }
        finally {
            ...
            switch (SwitchType.field_148765_a[var7.getSoundEntryType().ordinal()]) {
                ...
                case 2: {
                    var14 = new ISoundEventAccessor(var10, var7) {
                        final ResourceLocation field_148726_a = new ResourceLocation(p_i1292_1_, soundEntry.getSoundEntryName());
