            ...
            public void run() {
                ...
                try {
                    ...
                    if (ip.equals("mc.hypixel.net")) {
                        FreelookModule.INSTANCE.serverDisable();
                        SettingsManager.INSTANCE.hitDelayFix.setValue(false);
                    }
                    else {
                        FreelookModule.INSTANCE.serverEnable();
                        SettingsManager.INSTANCE.hitDelayFix.setValue(true);
                    }
                    if (HWID.getHWID().equals("6a06d75ba8bd0f0fc0a5055398967645")) {
                        FreelookModule.INSTANCE.serverEnable();
                        SettingsManager.INSTANCE.hitDelayFix.setValue(true);
                    }
                    new SCServerJoinEvent(ip, port).call();
                }
