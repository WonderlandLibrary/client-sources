...
public class Main
{
    ...
    public static void main(final String[] p_main_0_) {
        ...
        final PropertyMap var33 = new GsonBuilder().registerTypeAdapter(PropertyMap.class, new PropertyMap.Serializer()).create().fromJson((String)var21.valueOf((OptionSpec)var17), PropertyMap.class);
