...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener
{
        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            if (this.func_174985_d()) {
                ...
                for (int var12 = 0; var12 < var11.size(); ++var12) {
                    ...
                    if (!forgeEntityPass || Reflector.callBoolean(var13, Reflector.ForgeEntity_shouldRenderInPass, pass)) {
                        final boolean isShaders = this.mc.func_175606_aa() instanceof EntityLivingBase && ((EntityLivingBase)this.mc.func_175606_aa()).isPlayerSleeping();
                        ...
                        if ((var13 != this.mc.func_175606_aa() || this.mc.gameSettings.thirdPersonView != 0 || isShaders) && var14) {
                            this.field_175010_j.renderEntitySimple(var13, partialTicks);
                        }
                    }
                }
            ...
            while (var15.hasNext()) {
                ...
                for (final Entity var18 : fontRenderer.getEntityLists()[var16.field_178036_a.func_178568_j().getY() / 16]) {
                    if (!forgeEntityPass || Reflector.callBoolean(var18, Reflector.ForgeEntity_shouldRenderInPass, pass)) {
                        ...
                        if (var19) {
                            final boolean var20 = this.mc.func_175606_aa() instanceof EntityLivingBase && ((EntityLivingBase)this.mc.func_175606_aa()).isPlayerSleeping();
                            if (var18 == this.mc.func_175606_aa() && this.mc.gameSettings.thirdPersonView == 0 && !var20) {
                                continue;
                            }
    ...
    public void func_174976_a(final float partialTicks, final int pass) {
        ...
        if (this.mc.theWorld.provider.getDimensionId() == 1) {
            ...
            var5 = CustomColors.getSkyColor(var5, this.mc.theWorld, this.mc.func_175606_aa().posX, this.mc.func_175606_aa().posY + 1.0, this.mc.func_175606_aa().posZ);
            if (var4) {
            ...
            if (this.mc.theWorld.provider.isSurfaceWorld()) {
                ...
                if (Config.isCloudsFancy()) {
                    ...
                    if (this.cloudRenderer.shouldUpdateGlList()) {
                        ...
                        double var17 = this.mc.func_175606_aa().prevPosX + (this.mc.func_175606_aa().posX - this.mc.func_175606_aa().prevPosX) * p_180447_1_ + var16 * 0.029999999329447746;
                        double var18 = this.mc.func_175606_aa().prevPosZ + (this.mc.func_175606_aa().posZ - this.mc.func_175606_aa().prevPosZ) * p_180447_1_;
    ...
    public void drawSelectionBox(final EntityPlayer p_72731_1_, final MovingObjectPosition p_72731_2_, final int p_72731_3_, final float p_72731_4_) {
        if (p_72731_3_ == 0 && p_72731_2_.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            GL11.glLineWidth(ModuleConfig.INSTANCE.isEnabled(BlockOverlayModule.INSTANCE) ? BlockOverlayModule.INSTANCE.outlineWidth.getFloat() : 2.0f);
            GlStateManager.func_179090_x();
            if (Config.isShaders()) {
                Shaders.disableTexture2D();
            }
            ...
            if (var7.getMaterial() != Material.air && this.theWorld.getWorldBorder().contains(var6)) {
                if (ModuleConfig.INSTANCE.isEnabled(BlockOverlayModule.INSTANCE) && BlockOverlayModule.INSTANCE.blockOverlay.getBoolean()) {
                    GuiUtils.setGlColor(BlockOverlayModule.INSTANCE.overlayColor.getColor());
                    ...
                    BlockOverlayModule.INSTANCE.drawFilledWithGL(var7.getSelectedBoundingBox(this.theWorld, var6).expand(0.0020000000949949026, 0.0020000000949949026, 0.0020000000949949026).offset(-d0, -d2, -d3));
                }
                if (ModuleConfig.INSTANCE.isEnabled(BlockOverlayModule.INSTANCE) && BlockOverlayModule.INSTANCE.blockOutline.getBoolean()) {
                    GuiUtils.setGlColor(BlockOverlayModule.INSTANCE.outlineColor.getColor());
                    GL11.glLineWidth(ModuleConfig.INSTANCE.isEnabled(BlockOverlayModule.INSTANCE) ? BlockOverlayModule.INSTANCE.outlineWidth.getFloat() : 2.0f);
