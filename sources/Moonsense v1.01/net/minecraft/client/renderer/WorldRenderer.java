...
public class WorldRenderer
{
    ...
    private void growBuffer(int p_178983_1_) {
        ...
        if (this.quadSprites != null) {
            final TextureAtlasSprite[] sprites = this.quadSprites;
            final int quadSize = this.getBufferQuadSize();
            System.arraycopy(sprites, 0, this.quadSprites = new TextureAtlasSprite[quadSize], 0, Math.min(sprites.length, this.quadSprites.length));
            this.quadSpritesPrev = null;
        }
    }
    ...
    public State getVertexState(final float p_178971_1_, final float p_178971_2_, final float p_178971_3_) {
        ...
        final int quadStep = this.vertexFormat.func_177338_f() / 4 * 4;
        if (this.quadSprites != null) {
        ...
        return new State(var4, this.rawBufferIndex, this.vertexCount, new VertexFormat(this.vertexFormat), quadSpritesSorted);
    }
    ...
    public void func_178960_a(final float p_178960_1_, final float p_178960_2_, final float p_178960_3_, final float p_178960_4_) {
    ...
    public void func_178972_a(final int p_178972_1_, final int p_178972_2_, final int p_178972_3_, final int p_178972_4_, final int p_178972_5_) {
        if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
    ...
    public void addVertexWithUV(final double p_178985_1_, final double p_178985_3_, final double p_178985_5_, double p_178985_7_, double p_178985_9_) {
        if (this.quadSprite != null && this.quadSprites != null) {
            p_178985_7_ = this.quadSprite.toSingleU((float)p_178985_7_);
            p_178985_9_ = this.quadSprite.toSingleV((float)p_178985_9_);
        ...
        for (int listSize = var7.size(), i = 0; i < listSize; ++i) {
            ...
            switch (SwitchEnumUseage.field_178959_a[var8.func_177375_c().ordinal()]) {
                ...
                case 3: {
                    ...
                    this.rawIntBuffer.put(var10, this.field_178996_g);
                    break;
                }
                case 4: {
    ...
    public void color(final int p_178991_1_) {
        final int var2 = p_178991_1_ >> 16 & 0xFF;
        final int var3 = p_178991_1_ >> 8 & 0xFF;
        final int var4 = p_178991_1_ & 0xFF;
        this.setPosition(var2, var3, var4);
    ...
    public void color(final int red, final int green, final int blue) {
        final int var2 = red >> 16 & 0xFF;
        final int var3 = green >> 8 & 0xFF;
        final int var4 = blue & 0xFF;
        this.setPosition(var2, var3, var4);
    }
    
    public void color(final float red, final float green, final float blue) {
        final int var2 = (int)red >> 16 & 0xFF;
        final int var3 = (int)green >> 8 & 0xFF;
        final int var4 = (int)blue & 0xFF;
        this.setPosition(var2, var3, var4);
    }
    ...
    public void color(final int p_178974_1_, final int p_178974_2_) {
        final int var3 = p_178974_1_ >> 16 & 0xFF;
        final int var4 = p_178974_1_ >> 8 & 0xFF;
        final int var5 = p_178974_1_ & 0xFF;
        this.func_178961_b(var3, var4, var5, p_178974_2_);
    ...
    public void color(final int red, final int green, final int blue, final int alpha) {
        final int var3 = red >> 16 & 0xFF;
        final int var4 = green >> 8 & 0xFF;
        final int var5 = blue & 0xFF;
        this.func_178961_b(var3, var4, var5, alpha);
    }
    
    public void color(final float red, final float green, final float blue, final float alpha) {
        final int var3 = (int)red >> 16 & 0xFF;
        final int var4 = (int)green >> 8 & 0xFF;
        final int var5 = (int)blue & 0xFF;
        this.func_178961_b(var3, var4, var5, (int)alpha);
    }
    ...
    public void drawMultiTexture() {
        if (this.quadSprites != null) {
            ...
            for (int countQuads = this.vertexCount / 4, i = 0; i < countQuads; ++i) {
                final TextureAtlasSprite icon = this.quadSprites[i];
                if (icon != null) {
    ...
    private int drawForIcon(final TextureAtlasSprite sprite, final int startQuadPos) {
        ...
        for (int i = startQuadPos; i < countQuads; ++i) {
            final TextureAtlasSprite ts = this.quadSprites[i];
            if (ts == sprite) {
                if (lastPos < 0) {
                    lastPos = i;
                }
    ...
    private int getBufferQuadSize() {
        final int quadSize = this.rawIntBuffer.capacity() * 4 / (this.vertexFormat.func_177338_f() * 4);
        return quadSize;
    }
