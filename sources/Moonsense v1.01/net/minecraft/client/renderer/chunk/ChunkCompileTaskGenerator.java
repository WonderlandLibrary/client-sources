...
public class ChunkCompileTaskGenerator
{
    ...
    public enum Status
    {
        ...
        private Status(final String name, final int ordinal, final String p_i46385_1_, final int p_i46385_2_, final String p_i46207_1_, final int p_i46207_2_) {
        }
    }
    ...
    public enum Type
    {
        ...
        private Type(final String name, final int ordinal, final String p_i46386_1_, final int p_i46386_2_, final String p_i46206_1_, final int p_i46206_2_) {
        }
    }
}
