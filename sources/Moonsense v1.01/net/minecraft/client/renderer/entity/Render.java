...
import moonsense.utils.NametagRenderer;
...
public abstract class Render
{
    ...
    public void doRender(final Entity p_76986_1_, final double p_76986_2_, final double p_76986_4_, final double p_76986_6_, final float p_76986_8_, final float p_76986_9_) {
        ...
        if (SettingsManager.INSTANCE.showName.getBoolean() && p_76986_1_ instanceof EntityPlayerSP) {
    ...
    private void renderShadow(final Entity p_76975_1_, final double p_76975_2_, final double p_76975_4_, final double p_76975_6_, final float p_76975_8_, final float p_76975_9_) {
        if (!SettingsManager.INSTANCE.renderEntityShadow.getBoolean()) {
            return;
        }
    ...
    protected void renderLivingLabel(final Entity p_147906_1_, final String p_147906_2_, final double p_147906_3_, final double p_147906_5_, final double p_147906_7_, final int p_147906_9_) {
        ...
        if (var10 <= p_147906_9_ * p_147906_9_) {
            ...
            float viewX = FreelookModule.INSTANCE.isHeld() ? FreelookModule.getCameraPitch() : this.renderManager.playerViewX;
            viewX = ((SettingsManager.INSTANCE.fixNametagRot.getBoolean() && Minecraft.getMinecraft().gameSettings.thirdPersonView == 2) ? (-viewX) : viewX);
            final float viewY = FreelookModule.INSTANCE.isHeld() ? (-FreelookModule.getCameraYaw()) : (-this.renderManager.playerViewY);
            ...
            byte var16 = 0;
            final boolean flag = p_147906_1_ instanceof AbstractClientPlayer && MoonsenseClient.INSTANCE.getSocketClient().isUserOnline(((AbstractClientPlayer)p_147906_1_).getName()) && p_147906_2_.contains(((AbstractClientPlayer)p_147906_1_).getName());
            ...
            if (!SettingsManager.INSTANCE.transparentNametags.getBoolean()) {
                ...
                int var17 = var11.getStringWidth(p_147906_2_) / 2;
                if (p_147906_1_ instanceof AbstractClientPlayer && flag) {
                    var17 += 6;
                }
            ...
            var11.drawString(p_147906_2_, -var11.getStringWidth(p_147906_2_) / 2 + (flag ? 6 : 0), var16, 553648127);
            GlStateManager.enableDepth();
            GlStateManager.depthMask(true);
            var11.drawString(p_147906_2_, -var11.getStringWidth(p_147906_2_) / 2 + (flag ? 6 : 0), var16, -1);
            if (flag && p_147906_1_.ticksExisted > 10) {
                Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("streamlined/menu logo.png"));
                Gui.drawModalRectWithCustomSizedTexture(-var11.getStringWidth(p_147906_1_.getDisplayName().getFormattedText()) / 2 - 6, -2, 0.0f, 0.0f, 10, 10, 10.0f, 10.0f);
            }
            GlStateManager.enableLighting();
            GlStateManager.disableBlend();
            GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
