...
import moonsense.features.modules.type.hud.HitboxModule;
...
public class RenderManager
{
    ...
    public void setHitboxActive(final boolean p_178629_1_) {
    ...
    private void renderDebugBoundingBox(final Entity entity, final double x, final double y, final double z, final float p_85094_8_, final float look) {
        if (ModuleConfig.INSTANCE.isEnabled(HitboxModule.INSTANCE)) {
            if (entity instanceof AbstractClientPlayer) {
                HitboxModule.INSTANCE.renderPlayerHitbox(entity, x, y, z, look);
            }
            else if (entity instanceof EntityMob) {
                HitboxModule.INSTANCE.renderMobHitbox(entity, x, y, z, look);
            }
            else if (entity instanceof EntityItem) {
                HitboxModule.INSTANCE.renderItemHitbox(entity, x, y, z, look);
            }
            else if (entity instanceof EntityXPOrb) {
                HitboxModule.INSTANCE.renderXpOrbHitbox(entity, x, y, z, look);
            }
            else if (entity instanceof IProjectile) {
                HitboxModule.INSTANCE.renderProjectileHitbox(entity, x, y, z, look);
            }
        }
        else {
