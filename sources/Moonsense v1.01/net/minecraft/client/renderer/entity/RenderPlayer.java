...
import moonsense.cosmetics.impl.CosmeticDogPet;
import moonsense.cosmetics.impl.CosmeticDragonWings;
...
public class RenderPlayer extends RendererLivingEntity
{
    ...
    public void func_180596_a(final AbstractClientPlayer pl, final double x, final double y, final double z, final float p_180596_8_, final float p_180596_9_) {
        if (!pl.func_175144_cb() || this.renderManager.livingPlayer == pl) {
            double var10 = y;
            if (pl.isSneaking() && !(pl instanceof EntityPlayerSP)) {
                var10 = y - 0.125;
            }
            this.func_177137_d(pl);
            super.doRender(pl, x, var10, z, p_180596_8_, p_180596_9_);
        }
    }
