...
import moonsense.features.modules.GlintColorizerModule;
...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public static float field_175055_b;
    public static float field_175056_c;
    public static float field_175053_d;
    public static float field_175054_e;
    public static float field_175051_f;
    public static float field_175052_g;
    public static float field_175061_h;
    public static float field_175062_i;
    public static float field_175060_j;
    private static final String __OBFID = "CL_00001003";
    private ModelResourceLocation modelLocation;
    
    static {
        RES_ITEM_GLINT = new ResourceLocation("textures/misc/enchanted_item_glint.png");
        RenderItem.field_175055_b = 0.0f;
        RenderItem.field_175056_c = 0.0f;
        RenderItem.field_175053_d = 0.0f;
        RenderItem.field_175054_e = 0.0f;
        RenderItem.field_175051_f = 0.0f;
        RenderItem.field_175052_g = 0.0f;
        RenderItem.field_175061_h = 0.0f;
        RenderItem.field_175062_i = 0.0f;
        RenderItem.field_175060_j = 0.0f;
    }
    ...
    public RenderItem(final TextureManager p_i46165_1_, final ModelManager p_i46165_2_) {
        ...
        if (Reflector.ItemModelMesherForge_Constructor.exists()) {
            this.itemModelMesher = (ItemModelMesher)Reflector.newInstance(Reflector.ItemModelMesherForge_Constructor, p_i46165_2_);
        }
        else {
    ...
    protected void registerItem(final Item p_175048_1_, final int p_175048_2_, final String p_175048_3_) {
        this.itemModelMesher.register(p_175048_1_, p_175048_2_, new ModelResourceLocation(p_175048_3_, "inventory"));
    }
    
    protected void registerBlock(final Block p_175029_1_, final int p_175029_2_, final String p_175029_3_) {
        this.registerItem(Item.getItemFromBlock(p_175029_1_), p_175029_2_, p_175029_3_);
    }
    
    private void registerBlock(final Block p_175031_1_, final String p_175031_2_) {
        this.registerBlock(p_175031_1_, 0, p_175031_2_);
    }
    
    private void registerItem(final Item p_175047_1_, final String p_175047_2_) {
        this.registerItem(p_175047_1_, 0, p_175047_2_);
    }
    
    private void func_175036_a(final IBakedModel p_175036_1_, final ItemStack p_175036_2_) {
        this.func_175045_a(p_175036_1_, -1, p_175036_2_);
    }
    
    public void func_175035_a(final IBakedModel p_175035_1_, final int p_175035_2_) {
        this.func_175045_a(p_175035_1_, p_175035_2_, null);
    }
    
    private void func_175045_a(final IBakedModel p_175045_1_, final int p_175045_2_, final ItemStack p_175045_3_) {
        final Tessellator var4 = Tessellator.getInstance();
        final WorldRenderer var5 = var4.getWorldRenderer();
        final boolean renderTextureMap = Minecraft.getMinecraft().getTextureMapBlocks().isTextureBound();
        final boolean multiTexture = Config.isMultiTexture() && renderTextureMap;
        if (multiTexture) {
    ...
    public void func_180454_a(final ItemStack p_180454_1_, IBakedModel p_180454_2_) {
    ...
    private void renderEffect(final IBakedModel p_180451_1_) {
        if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
            ...
            final float var2 = Minecraft.getSystemTime() % 3000L / 3000.0f / 8.0f;
            GlStateManager.translate(var2, 0.0f, 0.0f);
            GlStateManager.rotate(-50.0f, 0.0f, 0.0f, 1.0f);
            int glintColor = -8372020;
            if (ModuleConfig.INSTANCE.isEnabled(GlintColorizerModule.INSTANCE) && GlintColorizerModule.INSTANCE.itemGlint.getBoolean()) {
                glintColor = GlintColorizerModule.INSTANCE.itemGlintColor.getColor();
            }
            this.func_175035_a(p_180451_1_, glintColor);
            GlStateManager.popMatrix();
            GlStateManager.pushMatrix();
            GlStateManager.scale(8.0f, 8.0f, 8.0f);
            final float var3 = Minecraft.getSystemTime() % 4873L / 4873.0f / 8.0f;
    ...
    private void func_175038_a(final WorldRenderer p_175038_1_, final BakedQuad p_175038_2_) {
        final Vec3i var3 = p_175038_2_.getFace().getDirectionVec();
        p_175038_1_.func_178975_e((float)var3.getX(), (float)var3.getY(), (float)var3.getZ());
    }
    
    private void func_175033_a(final WorldRenderer p_175033_1_, final BakedQuad p_175033_2_, final int p_175033_3_) {
    ...
    private void func_175032_a(final WorldRenderer p_175032_1_, final List p_175032_2_, final int p_175032_3_, final ItemStack p_175032_4_) {
        ...
        for (final BakedQuad var7 : p_175032_2_) {
            ...
            this.func_175033_a(p_175032_1_, var7, var8);
        }
    }
    
    public boolean func_175050_a(final ItemStack p_175050_1_) {
        final IBakedModel var2 = this.itemModelMesher.getItemModel(p_175050_1_);
        return var2 != null && var2.isAmbientOcclusionEnabled();
    }
    
    private void func_175046_c(final ItemStack p_175046_1_) {
        final IBakedModel var2 = this.itemModelMesher.getItemModel(p_175046_1_);
        final Item var3 = p_175046_1_.getItem();
        if (var3 != null) {
            final boolean var4 = var2.isAmbientOcclusionEnabled();
            if (!var4) {
    ...
    public void func_175043_b(final ItemStack p_175043_1_) {
        final IBakedModel var2 = this.itemModelMesher.getItemModel(p_175043_1_);
        this.func_175040_a(p_175043_1_, var2, ItemCameraTransforms.TransformType.NONE);
    }
    
    public void func_175049_a(final ItemStack p_175049_1_, final EntityLivingBase p_175049_2_, final ItemCameraTransforms.TransformType p_175049_3_) {
        ...
        if (p_175049_2_ instanceof EntityPlayer) {
            ...
            final Item var6 = p_175049_1_.getItem();
            ...
            if (var6 == Items.fishing_rod && var5.fishEntity != null) {
                ...
                final int var8 = p_175049_1_.getMaxItemUseDuration() - var5.getItemInUseCount();
                if (var8 >= 18) {
                ...
                var7 = (ModelResourceLocation)Reflector.call(var6, Reflector.ForgeItem_getModel, p_175049_1_, var5, var5.getItemInUseCount());
            }
            if ((this.modelLocation = var7) != null) {
    ...
    protected void func_175034_a(final ItemTransformVec3f p_175034_1_) {
        applyVanillaTransform(p_175034_1_);
    }
    
    public static void applyVanillaTransform(final ItemTransformVec3f p_175034_1_) {
        if (p_175034_1_ != ItemTransformVec3f.field_178366_a) {
            GlStateManager.translate(p_175034_1_.field_178365_c.x + RenderItem.field_175055_b, p_175034_1_.field_178365_c.y + RenderItem.field_175056_c, p_175034_1_.field_178365_c.z + RenderItem.field_175053_d);
            GlStateManager.rotate(p_175034_1_.field_178364_b.y + RenderItem.field_175051_f, 0.0f, 1.0f, 0.0f);
            GlStateManager.rotate(p_175034_1_.field_178364_b.x + RenderItem.field_175054_e, 1.0f, 0.0f, 0.0f);
            GlStateManager.rotate(p_175034_1_.field_178364_b.z + RenderItem.field_175052_g, 0.0f, 0.0f, 1.0f);
            GlStateManager.scale(p_175034_1_.field_178363_d.x + RenderItem.field_175061_h, p_175034_1_.field_178363_d.y + RenderItem.field_175062_i, p_175034_1_.field_178363_d.z + RenderItem.field_175060_j);
        }
    }
    
    protected void func_175040_a(final ItemStack p_175040_1_, IBakedModel p_175040_2_, final ItemCameraTransforms.TransformType p_175040_3_) {
        this.field_175057_n.bindTexture(TextureMap.locationBlocksTexture);
        ...
        if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
            ...
            switch (SwitchTransformType.field_178640_a[p_175040_3_.ordinal()]) {
                case 2: {
    ...
    public void func_175042_a(final ItemStack p_175042_1_, final int p_175042_2_, final int p_175042_3_) {
    ...
    private void func_180452_a(final int p_180452_1_, final int p_180452_2_, final boolean p_180452_3_) {
    ...
    public void func_180450_b(final ItemStack p_180450_1_, final int p_180450_2_, final int p_180450_3_) {
        if (p_180450_1_ != null) {
            this.zLevel += 50.0f;
            try {
                ...
                final CrashReport var5 = CrashReport.makeCrashReport(var6, "Rendering item");
                final CrashReportCategory var7 = var5.makeCategory("Item being rendered");
                var7.addCrashSectionCallable("Item Type", new Callable() {
                ...
                var7.addCrashSectionCallable("Item Aux", new Callable() {
                ...
                var7.addCrashSectionCallable("Item NBT", new Callable() {
                ...
                var7.addCrashSectionCallable("Item Foil", new Callable() {
                    @Override
                    public String call() {
    ...
    public void func_175030_a(final FontRenderer p_175030_1_, final ItemStack p_175030_2_, final int p_175030_3_, final int p_175030_4_) {
        this.func_180453_a(p_175030_1_, p_175030_2_, p_175030_3_, p_175030_4_, null);
    }
    
    public void func_180453_a(final FontRenderer p_180453_1_, final ItemStack p_180453_2_, final int p_180453_3_, final int p_180453_4_, final String p_180453_5_) {
        if (p_180453_2_ != null) {
            ...
            boolean itemDamaged2 = p_180453_2_.isItemDamaged();
            if (Reflector.ForgeItem_showDurabilityBar.exists()) {
                itemDamaged2 = Reflector.callBoolean(p_180453_2_.getItem(), Reflector.ForgeItem_showDurabilityBar, p_180453_2_);
            }
            if (itemDamaged2) {
                int var12 = (int)Math.round(13.0 - p_180453_2_.getItemDamage() * 13.0 / p_180453_2_.getMaxDamage());
                int var13 = (int)Math.round(255.0 - p_180453_2_.getItemDamage() * 255.0 / p_180453_2_.getMaxDamage());
                if (Reflector.ForgeItem_getDurabilityForDisplay.exists()) {
                    final double var14 = Reflector.callDouble(p_180453_2_.getItem(), Reflector.ForgeItem_getDurabilityForDisplay, p_180453_2_);
                ...
                this.func_175044_a(var16, p_180453_3_ + 2, p_180453_4_ + 13, 13, 2, 0);
                this.func_175044_a(var16, p_180453_3_ + 2, p_180453_4_ + 13, 12, 1, var18);
                this.func_175044_a(var16, p_180453_3_ + 2, p_180453_4_ + 13, var12, 1, var17);
    ...
    public void func_175044_a(final WorldRenderer p_175044_1_, final int p_175044_2_, final int p_175044_3_, final int p_175044_4_, final int p_175044_5_, final int p_175044_6_) {
        p_175044_1_.startDrawingQuads();
        p_175044_1_.func_178991_c(p_175044_6_);
        p_175044_1_.addVertex(p_175044_2_ + 0, p_175044_3_ + 0, 0.0);
        p_175044_1_.addVertex(p_175044_2_ + 0, p_175044_3_ + p_175044_5_, 0.0);
        p_175044_1_.addVertex(p_175044_2_ + p_175044_4_, p_175044_3_ + p_175044_5_, 0.0);
        p_175044_1_.addVertex(p_175044_2_ + p_175044_4_, p_175044_3_ + 0, 0.0);
    ...
    public static void forgeHooksClient_putQuadColor(final WorldRenderer renderer, final BakedQuad quad, final int color) {
        final float cr = (float)(color & 0xFF);
        final float cg = (float)(color >>> 8 & 0xFF);
        final float cb = (float)(color >>> 16 & 0xFF);
        final float ca = (float)(color >>> 24 & 0xFF);
        final int[] vd = quad.func_178209_a();
        final int step = vd.length / 4;
        for (int i = 0; i < 4; ++i) {
            final int vc = vd[3 + step * i];
            final float vcr = (float)(vc & 0xFF);
            final float vcg = (float)(vc >>> 8 & 0xFF);
            final float vcb = (float)(vc >>> 16 & 0xFF);
            final float vca = (float)(vc >>> 24 & 0xFF);
            final int ncr = Math.min(255, (int)(cr * vcr / 255.0f));
            final int ncg = Math.min(255, (int)(cg * vcg / 255.0f));
            final int ncb = Math.min(255, (int)(cb * vcb / 255.0f));
            final int nca = Math.min(255, (int)(ca * vca / 255.0f));
