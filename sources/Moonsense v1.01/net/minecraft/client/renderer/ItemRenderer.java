...
public class ItemRenderer
{
    ...
    private void func_178096_b(final float p_178096_1_, final float p_178096_2_) {
        if (ModuleConfig.INSTANCE.isEnabled(OldAnimationsModule.INSTANCE) && OldAnimationsModule.INSTANCE.bow.getBoolean() && this.mc != null && this.mc.thePlayer != null && this.mc.thePlayer.getItemInUse() != null && this.mc.thePlayer.getItemInUse().getItem() != null && Item.getIdFromItem(this.mc.thePlayer.getItemInUse().getItem()) == 261) {
            GlStateManager.translate(-0.01f, 0.05f, -0.06f);
        }
        if (ModuleConfig.INSTANCE.isEnabled(OldAnimationsModule.INSTANCE) && OldAnimationsModule.INSTANCE.rod.getBoolean() && this.mc != null && this.mc.thePlayer != null && this.mc.thePlayer.getCurrentEquippedItem() != null && this.mc.thePlayer.getCurrentEquippedItem().getItem() != null && (Item.getIdFromItem(this.mc.thePlayer.getCurrentEquippedItem().getItem()) == 346 || Item.getIdFromItem(this.mc.thePlayer.getCurrentEquippedItem().getItem()) == 398)) {
            GlStateManager.translate(0.08f, -0.027f, -0.33f);
            GlStateManager.scale(0.93f, 1.0f, 1.0f);
        }
        if (ModuleConfig.INSTANCE.isEnabled(OldAnimationsModule.INSTANCE) && OldAnimationsModule.INSTANCE.swing.getBoolean() && this.mc != null && this.mc.thePlayer != null && this.mc.thePlayer.isSwingInProgress && this.mc.thePlayer.getCurrentEquippedItem() != null && !this.mc.thePlayer.isEating() && !this.mc.thePlayer.isBlocking()) {
    ...
    public void renderItemInFirstPerson(final float p_78440_1_) {
        ...
        if (this.itemToRender != null) {
            ...
            for (int length = (mainInventory = this.mc.thePlayer.inventory.mainInventory).length, i = 0; i < length; ++i) {
                ...
                if (is != null) {
                    final boolean b = is.getItem() instanceof ItemMap;
                }
            }
            if (this.itemToRender.getItem() instanceof ItemMap) {
                ...
                switch (SwitchEnumAction.field_178094_a[var7.ordinal()]) {
                    ...
                    case 3: {
                        ...
                        this.func_178096_b(var2, (ModuleConfig.INSTANCE.isEnabled(OldAnimationsModule.INSTANCE) && OldAnimationsModule.INSTANCE.eating.getBoolean()) ? this.swingProgress : 0.0f);
                        if (ModuleConfig.INSTANCE.isEnabled(OldAnimationsModule.INSTANCE) && OldAnimationsModule.INSTANCE.eating.getBoolean()) {
                    ...
                    case 4: {
                        this.func_178096_b(var2, (ModuleConfig.INSTANCE.isEnabled(OldAnimationsModule.INSTANCE) && OldAnimationsModule.INSTANCE.blockHit.getBoolean()) ? this.swingProgress : 0.0f);
                        this.func_178103_d();
                        if (ModuleConfig.INSTANCE.isEnabled(OldAnimationsModule.INSTANCE) && OldAnimationsModule.INSTANCE.blockHit.getBoolean()) {
                    ...
                    case 5: {
                        this.func_178096_b(var2, (ModuleConfig.INSTANCE.isEnabled(OldAnimationsModule.INSTANCE) && OldAnimationsModule.INSTANCE.bow.getBoolean()) ? this.swingProgress : 0.0f);
    ...
    private void renderFireInFirstPerson(final float p_78442_1_) {
        ...
        for (int var5 = 0; var5 < 2; ++var5) {
            ...
            GlStateManager.translate(-(var5 * 2 - 1) * 0.24f, -0.3f + SettingsManager.INSTANCE.fireHeight.getFloat() / 2.0f - 0.575f, 0.0f);
