...
public class ItemCameraTransforms
{
    ...
    public enum TransformType
    {
        ...
        private TransformType(final String name, final int ordinal, final String p_i46212_1_, final int p_i46212_2_) {
        }
    }
    ...
    static class Deserializer implements JsonDeserializer
    {
        ...
        public ItemCameraTransforms func_178352_a(final JsonElement p_178352_1_, final Type p_178352_2_, final JsonDeserializationContext p_178352_3_) {
            ...
            if (var4.has("thirdperson")) {
                var5 = p_178352_3_.deserialize(var4.get("thirdperson"), ItemTransformVec3f.class);
            }
            if (var4.has("firstperson")) {
                var6 = p_178352_3_.deserialize(var4.get("firstperson"), ItemTransformVec3f.class);
            }
            if (var4.has("head")) {
                var7 = p_178352_3_.deserialize(var4.get("head"), ItemTransformVec3f.class);
            }
            if (var4.has("gui")) {
                var8 = p_178352_3_.deserialize(var4.get("gui"), ItemTransformVec3f.class);
            }
