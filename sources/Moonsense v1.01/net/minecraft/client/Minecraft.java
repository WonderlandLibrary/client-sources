...
import moonsense.features.modules.type.mechanic.ToggleSprintModule;
...
import moonsense.event.impl.SCGuiChangedEvent;
...
import moonsense.ui.splash.SplashScreen;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException {
        SplashScreen.setProgress(1, "Initializing Client");
        MoonsenseClient.INSTANCE.onPreInit();
        ...
        SplashScreen.setProgress(2, "Initializing Minecraft Renderers");
        ...
        SplashScreen.setProgress(3, "Finalizing");
        MoonsenseClient.INSTANCE.onPostInit();
    }
    ...
    private void func_175609_am() throws LWJGLException {
        ...
        Display.setTitle("Moonsense Client 1.8.9 (" + MoonsenseClient.getVersion() + ")");
        try {
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        final GuiScreen prevScreen = this.currentScreen;
        if ((this.currentScreen = guiScreenIn) != null) {
            ...
            new SCGuiChangedEvent(this.currentScreen, prevScreen).call();
        }
        else {
    ...
    private void checkGLError(final String message) {
        if (this.field_175619_R) {
            ...
            if (var2 != 0) {
                ...
                Minecraft.logger.error(String.valueOf(var2) + ": " + var3);
            }
        }
    }
    
    public void shutdownMinecraftApplet() {
        MoonsenseClient.INSTANCE.onShutdown();
        try {
    ...
    public int getLimitFramerate() {
        return (getMinecraft().theWorld == null && getMinecraft().currentScreen != null) ? 60 : getMinecraft().gameSettings.limitFramerate;
    }
    ...
    private void updateDebugProfilerName(int keyCount) {
        ...
        if (var2 != null && !var2.isEmpty()) {
            ...
            if (keyCount == 0) {
                ...
                this.debugProfilerName = String.valueOf(this.debugProfilerName) + var2.get(keyCount).field_76331_c;
            }
        }
    }
    ...
    private void displayDebugInfo(final long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            if (!var4.field_76331_c.equals("unspecified")) {
                var19 = String.valueOf(var19) + "[0] ";
            }
            if (var4.field_76331_c.length() == 0) {
                var19 = String.valueOf(var19) + "ROOT ";
            }
            else {
                var19 = String.valueOf(var19) + var4.field_76331_c + " ";
            }
            final int var13 = 16777215;
            this.fontRendererObj.func_175063_a(var19, (float)(var8 - var7), (float)(var9 - var7 / 2 - 16), var13);
            this.fontRendererObj.func_175063_a(var19 = String.valueOf(var18.format(var4.field_76330_b)) + "%", (float)(var8 + var7 - this.fontRendererObj.getStringWidth(var19)), (float)(var9 - var7 / 2 - 16), var13);
            for (int var20 = 0; var20 < var3.size(); ++var20) {
                final Profiler.Result var21 = var3.get(var20);
                String var22 = "";
                if (var21.field_76331_c.equals("unspecified")) {
                    var22 = String.valueOf(var22) + "[?] ";
                }
                else {
                    var22 = String.valueOf(var22) + "[" + (var20 + 1) + "] ";
                }
                var22 = String.valueOf(var22) + var21.field_76331_c;
                this.fontRendererObj.func_175063_a(var22, (float)(var8 - var7), (float)(var9 + var7 / 2 + var20 * 8 + 20), var21.func_76329_a());
                this.fontRendererObj.func_175063_a(var22 = String.valueOf(var18.format(var21.field_76332_a)) + "%", (float)(var8 + var7 - 50 - this.fontRendererObj.getStringWidth(var22)), (float)(var9 + var7 / 2 + var20 * 8 + 20), var21.func_76329_a());
                this.fontRendererObj.func_175063_a(var22 = String.valueOf(var18.format(var21.field_76330_b)) + "%", (float)(var8 + var7 - this.fontRendererObj.getStringWidth(var22)), (float)(var9 + var7 / 2 + var20 * 8 + 20), var21.func_76329_a());
            }
        }
    }
    ...
    private void sendClickBlockToController(final boolean leftClick) {
        ...
        if (this.leftClickCounter <= 0 && !this.thePlayer.isUsingItem()) {
            if (leftClick && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                final BlockPos var2 = this.objectMouseOver.func_178782_a();
    ...
    private void clickMouse() {
        if (SettingsManager.INSTANCE.hitDelayFix.getBoolean()) {
            this.leftClickCounter = 0;
        }
        if (this.leftClickCounter <= 0) {
            ...
            if (this.objectMouseOver == null) {
                ...
                switch (SwitchEnumMinecartType.field_152390_a[this.objectMouseOver.typeOfHit.ordinal()]) {
                    ...
                    case 2: {
                        final BlockPos var1 = this.objectMouseOver.func_178782_a();
    ...
    private void rightClickMouse() {
        ...
        if (this.objectMouseOver == null) {
            ...
            switch (SwitchEnumMinecartType.field_152390_a[this.objectMouseOver.typeOfHit.ordinal()]) {
                ...
                case 2: {
                    final BlockPos var3 = this.objectMouseOver.func_178782_a();
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                final SCMouseEvent event = new SCMouseEvent();
                event.call();
                ...
                if (var8 != 0) {
                    if (this.thePlayer.func_175149_v()) {
                        ...
                        if (this.currentScreen == null) {
                            ...
                            flag = (GameSettings.isKeyDown(this.gameSettings.ofKeyBindZoom) && ModuleConfig.INSTANCE.isEnabled(ZoomModule.INSTANCE) && ZoomModule.INSTANCE.scrollZoom.getBoolean());
                        }
                        if (!flag) {
            ...
            while (Keyboard.next()) {
                ...
                final SCKeyEvent event2 = new SCKeyEvent(var6);
                event2.call();
                ...
                if (this.currentScreen != null) {
                    ...
                    if (var6 == 48 && Keyboard.isKeyDown(61)) {
                        this.renderManager.setHitboxActive(!this.renderManager.isHitboxActive());
                    }
        ...
        new SCUpdateEvent().call();
        new SCClientTickEvent().call();
        this.mcProfiler.endSection();
        this.systemTime = getSystemTime();
    }
    ...
    public void launchIntegratedServer(final String folderName, final String worldName, WorldSettings worldSettingsIn) {
        ...
        new SCWorldLoadedEvent(folderName, worldName, worldSettingsIn).call();
    ...
    public void loadWorld(final WorldClient worldClientIn, final String loadingMessage) {
        ...
        if ((this.theWorld = worldClientIn) != null) {
            ...
            this.thePlayer.movementInput = new ToggleSprintModule.ClientMovementInput(this.gameSettings);
    ...
    private void middleClickMouse() {
        if (this.objectMouseOver != null) {
            ...
            if (this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                final BlockPos var5 = this.objectMouseOver.func_178782_a();
    ...
    public IMetadataSerializer getMetadataSerializer() {
        return this.metadataSerializer_;
    }
