    ...
    public TextureMetadataSection deserialize(final JsonElement p_deserialize_1_, final Type p_deserialize_2_, final JsonDeserializationContext p_deserialize_3_) {
        ...
        if (var4.has("mipmaps")) {
            try {
                ...
                for (int var9 = 0; var9 < var8.size(); ++var9) {
                    ...
                    if (var10.isJsonPrimitive()) {
                        try {
                            ...
                            throw new JsonParseException("Invalid texture->mipmap->" + var9 + ": expected number, was " + var10, var11);
                        }
                    }
                ...
                throw new JsonParseException("Invalid texture->mipmaps: expected array, was " + var4.get("mipmaps"), var12);
            }
        }
