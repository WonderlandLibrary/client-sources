...
public abstract class AbstractResourcePack implements IResourcePack
{
    ...
    public BufferedImage getPackImage() throws IOException {
        final BufferedImage image = TextureUtil.func_177053_a(this.getInputStreamByName("pack.png"));
        MoonsenseClient.info("Scaling resource pack icon from " + image.getWidth() + " to 64", new Object[0]);
