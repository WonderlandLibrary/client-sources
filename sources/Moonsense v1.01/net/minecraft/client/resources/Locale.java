...
public class Locale
{
    ...
    public synchronized void loadLocaleDataFiles(final IResourceManager p_135022_1_, final List p_135022_2_) {
        ...
        for (final String var4 : p_135022_2_) {
            final String vanillaLang = String.format("lang/%s.lang", var4);
            final String ofLang = String.format("optifine/lang/%s.lang", var4);
            final String clientLang = String.format("streamlined/lang/%s.lang", var4);
            for (final String var6 : p_135022_1_.getResourceDomains()) {
                try {
                    this.loadLocaleData(p_135022_1_.getAllResources(new ResourceLocation(var6, vanillaLang)));
                    this.loadLocaleData(p_135022_1_.getAllResources(new ResourceLocation(var6, ofLang)));
                    this.loadLocaleData(p_135022_1_.getAllResources(new ResourceLocation(var6, clientLang)));
                }
