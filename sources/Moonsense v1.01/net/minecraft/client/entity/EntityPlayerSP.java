...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public ToggleSprintModule.ClientMovementInput movementInput;
    ...
    public void sendChatMessage(final String p_71165_1_) {
        if (p_71165_1_.contains("/playercoords")) {
            try {
                final String[] args = p_71165_1_.split(" ");
                for (final Object e : this.mc.theWorld.playerEntities) {
                    System.out.println(((EntityPlayer)e).getName());
                    if (((EntityPlayer)e).getName().contains(args[1])) {
                        this.mc.thePlayer.addChatMessage(new ChatComponentText(String.valueOf(((EntityPlayer)e).getName()) + "'s coords:\n X: " + (int)((EntityPlayer)e).posX + "\n Y: " + (int)((EntityPlayer)e).posY + "\n Z: " + (int)((EntityPlayer)e).posZ));
                        return;
                    }
                }
                this.mc.thePlayer.addChatMessage(new ChatComponentText("Player not found"));
                return;
            }
            catch (Exception e2) {
                this.mc.thePlayer.addChatMessage(new ChatComponentText("Failed to get player coordinates"));
                return;
            }
        }
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            final ToggleSprintModule.ClientMovementInput movementInput = this.movementInput;
            movementInput.moveStrafe *= 0.2f;
            final ToggleSprintModule.ClientMovementInput movementInput2 = this.movementInput;
