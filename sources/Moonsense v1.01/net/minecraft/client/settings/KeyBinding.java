...
public class KeyBinding implements Comparable
{
    ...
    public static void onTick(final int keyCode) {
        if (keyCode != 0) {
            moonsense.utils.KeyBinding.keyBindings.forEach(moonsense.utils.KeyBinding::onTick);
        }
        if (keyCode != 0) {
    ...
    public static void setKeyBindState(final int keyCode, final boolean pressed) {
        if (keyCode != 0) {
            moonsense.utils.KeyBinding.keyBindings.stream().filter(bind -> bind.getKeyCode() == keyCode).forEach(bind -> bind.setKeyBindState(keyCode, pressed));
        }
        if (keyCode != 0) {
