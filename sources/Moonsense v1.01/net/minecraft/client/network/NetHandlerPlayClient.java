...
import moonsense.features.modules.type.world.TimeChangerModule;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleTimeUpdate(final S03PacketTimeUpdate packetIn) {
        ...
        if (ModuleConfig.INSTANCE.isEnabled(TimeChangerModule.INSTANCE)) {
            switch (TimeChangerModule.INSTANCE.time.getInt()) {
                case 1: {
                    packet = new S03PacketTimeUpdate(packet.func_149365_d(), -6000L, true);
                    break;
                }
                case 2: {
                    packet = new S03PacketTimeUpdate(packet.func_149365_d(), -22880L, true);
                    break;
                }
                case 3: {
                    packet = new S03PacketTimeUpdate(packet.func_149365_d(), -18000L, true);
                    break;
                }
            }
            PacketThreadUtil.func_180031_a(packet, this, this.gameController);
    ...
    public void handleEntityStatus(final S19PacketEntityStatus packetIn) {
        ...
        if (packetIn.func_149160_c() == 2) {
            final SCDamageEntityEvent event = new SCDamageEntityEvent(packetIn.func_149161_a(this.clientWorldController));
            event.call();
        }
    }
    ...
    static /* synthetic */ void access$2(final NetHandlerPlayClient netHandlerPlayClient, final Minecraft gameController) {
