        ...
        var3.setNetHandler(new INetHandlerStatusClient() {
            ...
            public void handleServerInfo(final S00PacketServerInfo packetIn) {
                ...
                if (var2.getPlayerCountData() != null) {
                    server.populationInfo = new StringBuilder().append(EnumChatFormatting.GRAY).append(var2.getPlayerCountData().getOnlinePlayerCount()).append(EnumChatFormatting.DARK_GRAY).append("/").append(EnumChatFormatting.GRAY).append(var2.getPlayerCountData().getMaxPlayers()).toString();
                ...
                p_initChannel_1_.pipeline().addLast(new SimpleChannelInboundHandler() {
                    ...
                    public void channelActive(final ChannelHandlerContext p_channelActive_1_) throws Exception {
                        ...
                        try {
                            ...
                            p_channelActive_1_.channel().writeAndFlush(var2x).addListener((GenericFutureListener<? extends Future<? super Void>>)ChannelFutureListener.CLOSE_ON_FAILURE);
                        }
                        finally {
                            var2x.release();
                        }
                    ...
                    protected void channelRead0(final ChannelHandlerContext p_channelRead0_1_, final ByteBuf p_channelRead0_2_) {
                        ...
                        if (var3 == 255) {
                            ...
                            if ("§1".equals(var5[0])) {
                                ...
                                server.populationInfo = new StringBuilder().append(EnumChatFormatting.GRAY).append(var9).append(EnumChatFormatting.DARK_GRAY).append("/").append(EnumChatFormatting.GRAY).append(var10).toString();
                            }
                        }
