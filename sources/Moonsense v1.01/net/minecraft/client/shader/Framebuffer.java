...
public class Framebuffer
{
    ...
    public void func_178038_a(final int p_178038_1_, final int p_178038_2_, final boolean p_178038_3_) {
        if (OpenGlHelper.isFramebufferEnabled()) {
            ...
            final float var4 = (float)p_178038_1_;
            final float var5 = (float)p_178038_2_;
            final float var6 = this.framebufferWidth / (float)this.framebufferTextureWidth;
            final float var7 = this.framebufferHeight / (float)this.framebufferTextureHeight;
