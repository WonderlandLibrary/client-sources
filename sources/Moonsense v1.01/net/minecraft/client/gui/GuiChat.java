...
public class GuiChat extends GuiScreen
{
    ...
    public void onAutocompleteResponse(String[] p_146406_1_) {
        final NickHiderModule instance = NickHiderModule.INSTANCE;
        final boolean modEnabled = ModuleConfig.INSTANCE.isEnabled(instance);
        if (instance != null && modEnabled) {
            p_146406_1_ = instance.tabComplete(p_146406_1_, this.inputField.getText());
        }
