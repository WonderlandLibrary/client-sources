...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    protected void renderToolTip(final ItemStack itemIn, final int x, final int y) {
        if (GuiContainerCreative.selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex()) {
            ...
            if (var5 != null) {
                var4.add(1, new StringBuilder().append(EnumChatFormatting.BOLD).append(EnumChatFormatting.BLUE).append(I18n.format(var5.getTranslatedTabLabel(), new Object[0])).toString());
            }
