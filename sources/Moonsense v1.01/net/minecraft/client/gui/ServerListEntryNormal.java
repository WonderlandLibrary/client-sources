...
import moonsense.featuredservers.FeaturedServer;
...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
        ...
        final boolean isFeaturedServer = this.field_148301_e instanceof FeaturedServer;
        if (isFeaturedServer) {
            this.field_148300_d.getTextureManager().bindTexture(new ResourceLocation("streamlined/menu logo.png"));
            Gui.drawModalRectWithCustomSizedTexture(x - 16, y, 0.0f, 0.0f, 16, 16, 16.0f, 16.0f);
        }
    ...
    private void prepareServerIcon() {
        if (this.field_148301_e.getBase64EncodedIconData() == null) {
            ...
            final ByteBuf var2 = Unpooled.copiedBuffer(this.field_148301_e.getBase64EncodedIconData(), Charsets.UTF_8);
    ...
    public boolean mousePressed(final int p_148278_1_, final int p_148278_2_, final int p_148278_3_, final int p_148278_4_, final int p_148278_5_, final int p_148278_6_) {
        if (p_148278_5_ <= 32) {
            ...
            if (!(this.field_148303_c.getServerList().getServerData(p_148278_1_) instanceof FeaturedServer)) {
