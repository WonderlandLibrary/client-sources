...
import moonsense.features.modules.type.hud.ScoreboardModule;
...
public class GuiIngame extends Gui
{
    ...
    public void func_175180_a(final float p_175180_1_) {
        ...
        GlStateManager.enableBlend();
        if (this.func_175183_b() && (this.mc.gameSettings.thirdPersonView < 1 || CrosshairModule.INSTANCE.showInThird.getBoolean())) {
            GlStateManager.tryBlendFuncSeparate(775, 769, 1, 0);
            GlStateManager.enableAlpha();
            if (ModuleConfig.INSTANCE.isEnabled(CrosshairModule.INSTANCE)) {
                CrosshairModule.INSTANCE.render(this, var3 / 2, var4 / 2, var3 / 2, var4 / 2);
            }
            else {
        ...
        GlStateManager.enableAlpha();
        final SCRenderEvent event = new SCRenderEvent(var2);
        event.call();
    }
    ...
    protected boolean func_175183_b() {
        ...
        if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            final BlockPos blockpos = this.mc.objectMouseOver.func_178782_a();
    ...
    private void func_180475_a(final ScoreObjective p_180475_1_, final ScaledResolution p_180475_2_) {
        ScoreboardModule.INSTANCE.setValues(p_180475_1_, p_180475_2_);
    }
    ...
    private void attemptSwing() {
        ...
        if (ModuleConfig.INSTANCE.isEnabled(OldAnimationsModule.INSTANCE) && OldAnimationsModule.INSTANCE.blockHit.getBoolean() && this.mc.thePlayer.getItemInUseCount() > 0) {
            final boolean mouseDown = this.mc.gameSettings.keyBindAttack.getIsKeyPressed() && this.mc.gameSettings.keyBindUseItem.getIsKeyPressed();
