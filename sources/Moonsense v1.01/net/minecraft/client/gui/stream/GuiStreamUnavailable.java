...
public class GuiStreamUnavailable extends GuiScreen
{
    ...
    public enum Reason
    {
        ...
        private Reason(final String name, final int ordinal, final String p_i1067_1_, final int p_i1067_2_, final IChatComponent p_i1067_3_, final IChatComponent p_i1067_4_) {
