...
public class GuiLanguage extends GuiScreen
{
    ...
    private static final String[] OPTIFINE_LANGUAGES;
    
    static {
        OPTIFINE_LANGUAGES = new String[] { "cs_CZ", "de_DE", "en_US", "es_MX", "ja_JP", "lb_LU", "pl_PL", "ru_RU", "sv_SE", "uk_UA", "zh_CN", "zh_TW" };
    }
    ...
    class List extends GuiSlot
    {
        ...
        protected void drawSlot(final int p_180791_1_, final int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int p_180791_5_, final int p_180791_6_) {
            int offset = 0;
            String[] access$4;
            for (int length = (access$4 = GuiLanguage.OPTIFINE_LANGUAGES).length, i = 0; i < length; ++i) {
                final String s = access$4[i];
                if (s.equals(this.field_148176_l.get(p_180791_1_))) {
                    offset = 18;
                }
            }
            GuiLanguage.this.fontRendererObj.setBidiFlag(true);
            if (offset != 0) {
                this.mc.getTextureManager().bindTexture(new ResourceLocation("streamlined/menu logo.png"));
                Gui.drawModalRectWithCustomSizedTexture(this.width / 2 - GuiLanguage.this.fontRendererObj.getStringWidth(this.field_148177_m.get(this.field_148176_l.get(p_180791_1_)).toString()) / 2, p_180791_3_ - 1, 0.0f, 0.0f, 12, 12, 12.0f, 12.0f);
            }
            GuiLanguage.this.drawCenteredString(GuiLanguage.this.fontRendererObj, this.field_148177_m.get(this.field_148176_l.get(p_180791_1_)).toString(), this.width / 2 + offset, p_180791_3_ + 1, 16777215);
