...
public class GuiOverlayDebug extends Gui
{
    ...
    protected List call() {
        ...
        if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.func_178782_a() != null) {
            final BlockPos var9 = this.mc.objectMouseOver.func_178782_a();
    ...
    protected List func_175238_c() {
        ...
        if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.func_178782_a() != null) {
            final BlockPos var7 = this.mc.objectMouseOver.func_178782_a();
            ...
            for (final Map.Entry var10 : var8.getProperties().entrySet()) {
                ...
                var5.add(String.valueOf(var10.getKey().getName()) + ": " + var11);
            }
        }
        return var5;
    }
