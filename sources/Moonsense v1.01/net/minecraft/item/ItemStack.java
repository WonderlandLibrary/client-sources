...
public final class ItemStack
{
    ...
    public List getTooltip(final EntityPlayer playerIn, final boolean advanced) {
        ...
        var4 = String.valueOf(var4) + EnumChatFormatting.RESET;
        if (advanced) {
            String var5 = "";
            if (var4.length() > 0) {
            ...
            if (this.getHasSubtypes()) {
                var4 = String.valueOf(var4) + String.format("#%04d/%d%s", var6, this.itemDamage, var5);
            }
            else {
                ...
                if (var12.getTagType("Lore") == 9) {
                    ...
                    if (var13.tagCount() > 0) {
                        for (int var14 = 0; var14 < var13.tagCount(); ++var14) {
                            var3.add(new StringBuilder().append(EnumChatFormatting.DARK_PURPLE).append(EnumChatFormatting.ITALIC).append(var13.getStringTagAt(var14)).toString());
                        }
                    }
                }
            }
