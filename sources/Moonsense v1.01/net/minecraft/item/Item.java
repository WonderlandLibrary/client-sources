...
public class Item
{
    ...
    public static Item getByNameOrId(final String id) {
        final Item var1 = (Item)Item.itemRegistry.getObject(new ResourceLocation(id));
        if (var1 == null) {
            try {
    ...
    public boolean hasEffect(final ItemStack stack) {
        final int i = SettingsManager.INSTANCE.showEnchantmentGlint.getInt();
        if (i == 2) {
            return false;
        }
        if (i == 1) {
            return Minecraft.getMinecraft().currentScreen instanceof GuiContainer && stack.isItemEnchanted();
        }
    ...
    protected MovingObjectPosition getMovingObjectPositionFromPlayer(final World worldIn, final EntityPlayer playerIn, final boolean useLiquids) {
        ...
        final double var7 = playerIn.prevPosY + (playerIn.posY - playerIn.prevPosY) + playerIn.getEyeHeight();
        final double var8 = playerIn.prevPosZ + (playerIn.posZ - playerIn.prevPosZ);
        final Vec3 var9 = new Vec3(var6, var7, var8);
        final float var10 = MathHelper.cos(-var5 * 0.017453292f - 3.1415927f);
        final float var11 = MathHelper.sin(-var5 * 0.017453292f - 3.1415927f);
        final float var12 = -MathHelper.cos(-var4 * 0.017453292f);
        final float var13 = MathHelper.sin(-var4 * 0.017453292f);
        ...
        return worldIn.rayTraceBlocks(var9, var17, useLiquids, !useLiquids, false);
    }
    ...
    public enum ToolMaterial
    {
        ...
        private ToolMaterial(final String name, final int ordinal, final String p_i1874_1_, final int p_i1874_2_, final int harvestLevel, final int maxUses, final float efficiency, final float damageVsEntity, final int enchantability) {
