...
public class SaveHandler implements ISaveHandler, IPlayerFileData
{
    ...
    public void writePlayerData(final EntityPlayer p_75753_1_) {
        try {
            ...
            final File var3 = new File(this.playersDirectory, String.valueOf(p_75753_1_.getUniqueID().toString()) + ".dat.tmp");
            final File var4 = new File(this.playersDirectory, String.valueOf(p_75753_1_.getUniqueID().toString()) + ".dat");
    ...
    public NBTTagCompound readPlayerData(final EntityPlayer p_75752_1_) {
        ...
        try {
            final File var3 = new File(this.playersDirectory, String.valueOf(p_75752_1_.getUniqueID().toString()) + ".dat");
