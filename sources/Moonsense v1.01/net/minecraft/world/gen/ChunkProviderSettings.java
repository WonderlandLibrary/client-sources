...
public class ChunkProviderSettings
{
    ...
    private ChunkProviderSettings(final Factory p_i45639_1_) {
    ...
    ChunkProviderSettings(final Factory p_i45640_1_, final Object p_i45640_2_) {
        this(p_i45640_1_);
    }
    ...
    public static class Factory
    {
        ...
        static {
            field_177901_a = new GsonBuilder().registerTypeAdapter(Factory.class, new Serializer()).create();
        }
        ...
        public String toString() {
            return Factory.field_177901_a.toJson(this);
        }
