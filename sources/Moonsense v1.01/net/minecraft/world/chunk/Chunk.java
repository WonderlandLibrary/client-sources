...
public class Chunk
{
    ...
    private boolean func_150811_f(final int p_150811_1_, final int p_150811_2_) {
        ...
        while (true) {
            ...
            final BlockPos var8 = var3.add(p_150811_1_, var7, p_150811_2_);
    ...
    public enum EnumCreateEntityType
    {
        ...
        private EnumCreateEntityType(final String name, final int ordinal, final String p_i45642_1_, final int p_i45642_2_) {
        }
    }
}
