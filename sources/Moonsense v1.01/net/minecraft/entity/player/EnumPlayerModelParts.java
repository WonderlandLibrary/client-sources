...
public enum EnumPlayerModelParts
{
    ...
    private EnumPlayerModelParts(final String name, final int ordinal, final String p_i45809_1_, final int p_i45809_2_, final int p_i45809_3_, final String p_i45809_4_) {
