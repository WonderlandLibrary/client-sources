...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void attackTargetEntityWithCurrentItem(final Entity targetEntity) {
        if (targetEntity.canAttackWithItem()) {
            new SCAttackEntityEvent(this, targetEntity).call();
    ...
    public enum EnumChatVisibility
    {
        ...
        private EnumChatVisibility(final String name, final int ordinal, final String p_i45323_1_, final int p_i45323_2_, final int p_i45323_3_, final String p_i45323_4_) {
    ...
    public enum EnumStatus
    {
        ...
        private EnumStatus(final String name, final int ordinal, final String p_i1751_1_, final int p_i1751_2_) {
        }
    }
