...
public class EntityHorse extends EntityAnimal implements IInvBasic
{
    ...
    private void setHorseTexturePaths() {
        ...
        if (var1 == 0) {
            ...
            this.field_110286_bQ = String.valueOf(this.field_110286_bQ) + EntityHorse.field_110269_bA[var3];
            if (var4 >= EntityHorse.horseMarkingTextures.length) {
                this.field_175508_bO = false;
                return;
            }
            this.field_110280_bR[1] = EntityHorse.horseMarkingTextures[var4];
            this.field_110286_bQ = String.valueOf(this.field_110286_bQ) + EntityHorse.field_110292_bC[var4];
        }
        else {
        ...
        if (var3 >= EntityHorse.horseArmorTextures.length) {
            ...
            this.field_110286_bQ = String.valueOf(this.field_110286_bQ) + EntityHorse.field_110273_bx[var3];
