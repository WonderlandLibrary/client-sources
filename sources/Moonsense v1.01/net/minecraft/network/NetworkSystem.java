...
public class NetworkSystem
{
    ...
    public void addLanEndpoint(final InetAddress address, final int port) throws IOException {
        ...
        synchronized (this.endpoints) {
            this.endpoints.add(((AbstractBootstrap<ServerBootstrap, C>)((AbstractBootstrap<ServerBootstrap, Channel>)new ServerBootstrap()).channel(NioServerSocketChannel.class).childHandler(new ChannelInitializer() {
    ...
    public SocketAddress addLocalEndpoint() {
        ...
        synchronized (this.endpoints) {
            var3 = ((AbstractBootstrap<ServerBootstrap, C>)((AbstractBootstrap<ServerBootstrap, Channel>)new ServerBootstrap()).channel(LocalServerChannel.class).childHandler(new ChannelInitializer() {
                ...
                if (!var3.hasNoChannel()) {
                    if (!var3.isChannelOpen()) {
                        ...
                        try {
                            ...
                            var3.sendPacket(new S40PacketDisconnect(var7), new GenericFutureListener() {
