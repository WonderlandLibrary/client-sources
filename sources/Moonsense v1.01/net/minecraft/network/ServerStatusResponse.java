    ...
    public static class Serializer implements JsonDeserializer, JsonSerializer
    {
        ...
        public ServerStatusResponse deserialize1(final JsonElement p_deserialize_1_, final Type p_deserialize_2_, final JsonDeserializationContext p_deserialize_3_) {
            ...
            if (var4.has("description")) {
                var5.setServerDescription(p_deserialize_3_.deserialize(var4.get("description"), IChatComponent.class));
            }
            if (var4.has("players")) {
                var5.setPlayerCountData(p_deserialize_3_.deserialize(var4.get("players"), PlayerCountData.class));
            }
            if (var4.has("version")) {
                var5.setProtocolVersionInfo(p_deserialize_3_.deserialize(var4.get("version"), MinecraftProtocolVersionIdentifier.class));
            }
            if (var4.has("favicon")) {
