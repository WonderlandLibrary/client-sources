...
public class CustomFontRenderer
{
    ...
    public CustomFontRenderer(final String fontName, final float fontSize) {
        ...
        catch (FontFormatException | IOException | SlickException ex2) {
            final Exception ex;
    ...
    private Font getFontByName(final String name) throws IOException, FontFormatException {
        if (name.equalsIgnoreCase("raleway hairline")) {
            return this.getFontFromInput("/assets/minecraft/streamlined/fonts/Raleway-Hairline.ttf");
        }
        if (name.equalsIgnoreCase("raleway black")) {
            return this.getFontFromInput("/assets/minecraft/streamlined/fonts/Raleway-Black.ttf");
        }
        if (name.equalsIgnoreCase("raleway bold")) {
            return this.getFontFromInput("/assets/minecraft/streamlined/fonts/Raleway-Bold.ttf");
        }
        return this.getFontFromInput("/assets/minecraft/streamlined/fonts/Raleway-Light.ttf");
    }
    ...
    public int drawString(final String text, final int x, final int y, final int color) {
        return this.drawString(text, (float)x, (float)y, color);
    }
