...
public class ElementOpenWaypointEdit extends Element
{
    ...
    public ElementOpenWaypointEdit(final int x, final int y, final int width, final int height, final String iconLocation, final int textureIndex, final boolean shouldScissor, final Waypoint module, final Consumer<Element> consumer) {
    ...
    public void renderElement(final float partialTicks) {
        ...
        GuiUtils.drawScaledCustomSizeModalRect(this.getX() + (this.width - 14) / 2.0f + 0.75f, this.getY() + (this.height - 28) / 2.0f + 7.0f + 0.75f, 0.0f, 0.0f, 14, 14, 14, 14, 14.0f, 14.0f);
        GuiUtils.setGlColor(this.hovered ? new Color(255, 255, 255, this.fadeIcon).getRGB() : new Color(120, 120, 120, this.fadeIcon).getRGB());
        Gui.drawScaledCustomSizeModalRect(this.getX() + (this.width - 14) / 2, this.getY() + (this.height - 28) / 2 + 7, 0.0f, 0.0f, 14, 14, 14, 14, 14.0f, 14.0f);
    }
