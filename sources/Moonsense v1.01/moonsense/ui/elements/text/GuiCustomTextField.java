...
public class GuiCustomTextField extends Gui
{
    ...
    public GuiCustomTextField(final int id, final int x, final int y, final int w, final int h, final boolean isPassword, final String placeholder) {
        this.text = "";
        ...
        this.fontRendererInstance = MoonsenseClient.textRenderer;
    ...
    public boolean textboxKeyTyped(final char p_146201_1_, final int p_146201_2_) {
        ...
        switch (p_146201_2_) {
            case 14: {
                if (AbstractGuiScreen.isCtrlKeyDown()) {
                    if (this.isEnabled) {
                        this.deleteWords(-1);
                    }
                }
            ...
            case 199: {
                if (AbstractGuiScreen.isShiftKeyDown()) {
                    this.setSelectionPos(0);
                }
                else {
            ...
            case 203: {
                ...
                else if (AbstractGuiScreen.isCtrlKeyDown()) {
    ...
    public void mouseClicked(final int p_146192_1_, final int p_146192_2_, final int p_146192_3_) {
        final boolean hovered = p_146192_1_ >= this.xPosition && p_146192_1_ < this.xPosition + this.width && p_146192_2_ >= this.yPosition && p_146192_2_ < this.yPosition + this.height;
        if (this.canLoseFocus) {
            this.setFocused(hovered);
        }
        if (this.isFocused && hovered && p_146192_3_ == 0) {
            ...
            this.setCursorPosition(this.fontRendererInstance.trimStringToWidth(var6, var5).length() * 2 + this.lineScrollOffset);
        }
    }
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                GuiUtils.drawRoundedRect((float)this.xPosition, (float)this.yPosition, (float)(this.xPosition + this.width), (float)(this.yPosition + this.height), 3.0f, new Color(42, 50, 55, 100).getRGB());
                GuiUtils.drawRoundedOutline(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, 3.0f, 2.0f, new Color(105, 116, 122, 100).getRGB());
            }
            String txt = "";
            if (this.isPassword) {
            ...
            final String var4 = this.fontRendererInstance.trimStringToWidth(txt.substring(this.lineScrollOffset), this.getWidth());
            ...
            if (var4.length() > 0) {
                ...
                if (this.cursorPosition == 0) {
                    var9 = this.fontRendererInstance.drawStringWithShadow(var10, var7 / 2.0f, (float)var8, var1);
                }
                else {
                    var9 = this.fontRendererInstance.drawStringWithShadow(var10, (float)var7, (float)var8, var1);
                }
            }
            final boolean var11 = this.cursorPosition < txt.length() || txt.length() >= this.getMaxStringLength();
            int var12 = var9;
            if (var4.length() > 0) {
                var12 /= 2;
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                if (this.cursorPosition == 0) {
                    ...
                    var9 = this.fontRendererInstance.drawStringWithShadow(var4.substring(var2), var9 / 2.0f, (float)var8, var1);
                }
            }
            if (var6) {
                if (var11) {
                    if (this.cursorPosition == 0) {
                        final int left = var12;
                        final int top = var8 - 1;
                        final int right = var12 + 1;
                        final int n = var8 + 1;
                        this.fontRendererInstance.getClass();
                        Gui.drawRect(left, top, right, n + 9, -3092272);
                    }
                    else {
                        final int left2 = var12 / 2;
                        final int top2 = var8 - 1;
                        final int right2 = var12 / 2 + 1;
                        final int n2 = var8 + 1;
                        this.fontRendererInstance.getClass();
                        Gui.drawRect(left2, top2, right2, n2 + 9, -3092272);
                    }
                }
                else {
                    this.fontRendererInstance.drawStringWithShadow("_", (float)var12, (float)var8, var1);
                }
            }
            if (var3 != var2) {
                final int var13 = (int)(var7 + this.fontRendererInstance.getWidth(var4.substring(0, var3)));
                final int p_146188_1_ = var12;
                final int p_146188_2_ = var8 - 1;
                final int p_146188_3_ = var13 - 1;
                final int n3 = var8 + 1;
                this.fontRendererInstance.getClass();
                this.drawCursorVertical(p_146188_1_, p_146188_2_, p_146188_3_, n3 + 9);
            }
        }
    }
    ...
    public int getWidth() {
        if (this.isPassword) {
            return this.getEnableBackgroundDrawing() ? (this.width * 3 - 30) : (this.width * 3 - 24);
        }
        return this.getEnableBackgroundDrawing() ? (this.width * 2 - 20) : (this.width * 2);
    }
