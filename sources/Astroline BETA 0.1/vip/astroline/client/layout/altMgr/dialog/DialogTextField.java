...
extends Gui {
    ...
    public boolean textboxKeyTyped(char p_146201_1_, int p_146201_2_) {
        ...
        if (!ChatAllowedCharacters.isAllowedCharacter((char)p_146201_1_)) return false;
        if (!this.isEnabled) return true;
    ...
    public void drawTextBox() {
        ...
        if (this.getEnableBackgroundDrawing()) {
            GuiRenderUtils.drawRoundedRect((float)this.xPosition, (float)this.yPosition, (float)this.width, (float)this.height, (float)2.0f, (int)-12231829, (float)1.0f, (int)Hud.hudColor1.getColorInt());
        }
