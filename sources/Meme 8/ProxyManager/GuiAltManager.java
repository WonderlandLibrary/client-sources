...
extends GuiScreen {
    ...
    public GuiAltManager() {
		this.status = (EnumChatFormatting.GRAY + (Ruby.getRuby.proxy != Proxy.NO_PROXY ? ((InetSocketAddress)Ruby.getRuby.proxy.address()).getAddress().getHostAddress() + ":" + ((InetSocketAddress)Ruby.getRuby.proxy.address()).getPort() + "" : "XDD"));
    }
    ...
    public void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 1: {
                ...
                this.loginThread = new AltLoginThread(user, pass, (ProxyVersion)(xd.equals("SOCKS4") ? ProxyVersion.SOCKSv4 : ProxyVersion.SOCKSv5));
            ...
            case 5: {
                ...
                this.loginThread = new AltLoginThread(user2, pass2, xd2);
                this.loginThread.start();
                break;
            }
            case 6: {
            ...
            case 8: {
                Ruby.getRuby.proxy = Proxy.NO_PROXY;
    ...
    public void initGui() {
        ...
        this.rename.enabled = false;
        try {
			Ruby.getRuby.getFileMgr().getFile(Proxies.class).loadFile();
		} catch (IOException e) {
			e.printStackTrace();
		}
    }
