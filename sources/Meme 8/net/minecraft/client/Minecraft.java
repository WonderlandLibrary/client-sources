...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException
    {
        ...
        (this.ruby = Ruby.getRuby).setmgr.toString();
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                	if (null != thePlayer && null != theWorld && currentScreen == null) {
                		TabGui.INSTANCE.handleKey(Keyboard.getEventKey());
                	}
                	Ruby.getRuby.getModuleManager().modules.forEach(Nigger -> {
                		if (Nigger.getKey() == Keyboard.getEventKey() && this.currentScreen == null && 0 != Nigger.getKey() && this.thePlayer != null && this.theWorld != null) {
                			Nigger.toggle();
                		}
                	});
