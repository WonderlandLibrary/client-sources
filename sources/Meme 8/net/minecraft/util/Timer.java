...
public class Timer
{
     ...
     * @param timerSpeed
     */
    public void updateTimer(double timerSpeed)
    {
        ...
        this.elapsedPartialTicks = (float)((double)this.elapsedPartialTicks + var13 * (double)timerSpeed * (double)this.ticksPerSecond);
