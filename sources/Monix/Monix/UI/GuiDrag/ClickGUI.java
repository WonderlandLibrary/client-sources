...
extends GuiScreen {
    ...
    public static ArrayList<Mod> World = new ArrayList();
    public static ArrayList<Mod> Exploits = new ArrayList();
    ...
    public ClickGUI() {
        ...
        for (Mod m : ModManager.activeMods) {
            ...
            if (m.getCategory() != Category.EXPLOITS) continue;
            Exploits.add(m);
        }
    }
