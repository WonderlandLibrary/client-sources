...
import Monix.Files.Alts;
import Monix.Files.Binds;
import Monix.Files.Friends;
import java.io.File;
...
public class FileManager {
    ...
    private static File directory = new File(String.valueOf(String.valueOf(String.valueOf(Minecraft.getMinecraft().mcDataDir.toString()))) + "\\" + "Monix");
    private static File moduleDirectory = new File(String.valueOf(String.valueOf(String.valueOf(Minecraft.getMinecraft().mcDataDir.toString()))) + "\\" + "Monix" + "\\" + "Modules");
    ...
    public static abstract class CustomFile {
        ...
        public CustomFile(String name, boolean Module, boolean loadOnStart) {
            ...
            this.file = Module ? new File(moduleDirectory, String.valueOf(String.valueOf(String.valueOf(name))) + ".txt") : new File(directory, String.valueOf(String.valueOf(String.valueOf(name))) + ".txt");
            if (!this.file.exists()) {
                try {
                    this.saveFile();
                }
