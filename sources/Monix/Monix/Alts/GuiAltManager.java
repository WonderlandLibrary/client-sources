...
import Monix.Alts.AltLoginThread;
import Monix.Alts.AltManager;
import Monix.Alts.GuiAddAlt;
import Monix.Alts.GuiAltLogin;
import Monix.Alts.GuiRenameAlt;
...
extends GuiScreen {
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 2: {
                ...
                Monix.getInstance();
                Monix.fileManager.getFile(Alts.class).saveFile();
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        int y2 = 38;
        Monix.getInstance();
        AltManager altManager2 = Monix.altManager;
