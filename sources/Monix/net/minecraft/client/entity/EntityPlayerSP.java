...
import Monix.Monix;
import Monix.Event.events.EventPostMotionUpdates;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                final EventPreMotionUpdates eventPreMotionUpdates = new EventPreMotionUpdates(this.rotationYaw, this.rotationPitch, this.posY);
                eventPreMotionUpdates.call();
                this.func_175161_p();
                final EventPostMotionUpdates eventPostMotionUpdates = new EventPostMotionUpdates(this.rotationYaw, this.rotationPitch, this.onGround, this.posY);
    ...
    public void func_175161_p()
    {
        ...
        if (this.func_175160_A()) {
            ...
            if (this.ridingEntity == null) {
                ...
                if (!sendLook && Monix.modManager.getModbyName("KillAura").isToggled()) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C05PacketPlayerLook(this.rotationYaw, this.rotationPitch, this.onGround));
                }
            }
            else {
    ...
    {
        if (Monix.onSendChatMessage(p_71165_1_)) {
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding()){
            if (Monix.modManager.getModbyName("NoSlowDown").isToggled()) {
