...
import wtf.diablo.module.impl.Render.Animations;
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0 || KillAura.blocking)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                        String mode = "Swing";
                        float var1 = MathHelper.sin((float)(MathHelper.sqrt_float(f1) * 3.1D));
                        if (ModuleManager.getModule(Animations.class).isToggled()) mode = Animations.mode.getMode();

                        switch (mode) {
                            case "Diablo":
                                GL11.glTranslated(-0.1D, 0.4, 0.0D);
                                this.transformFirstPersonItem(0, 0);
                                float var11 = MathHelper.sin(MathHelper.sqrt_float(f1) * 1.9415927f);
                                float var12 = MathHelper.sin(MathHelper.sqrt_float(f1) * 1.9415927f);
                                GlStateManager.translate(0.35f, -0.15f, 0.15f);
                                GlStateManager.rotate(-var11 * (float) 62 / 2.0f, 5, var12, 20);
                                GlStateManager.rotate(-var11 * (float) 80, 10, -var12, -0);
                                break;
                            case "Slide":
                                /*
                                ...
                                GlStateManager.rotate(-var13 * (float)130.0 / 2.0f, -25, f1, 10);
                                GlStateManager.rotate(-var13 * (float)120.0, 5.0f, -var14, -0);

                                 */
                                GL11.glTranslated(-0.1D, 0.15D, 0.0D);
                                GlStateManager.rotate(0,120,0,0);
                                this.transformFirstPersonItem(0, 1);
                                float var13 = MathHelper.sin(MathHelper.sqrt_float(f1 ) * 3f);
                                float var14 = MathHelper.sin(MathHelper.sqrt_float(f1) * 5.9415927f);
                                GlStateManager.rotate(-var13 * (float)50.0 / 2.0f, -25, var14, 10);
                                GlStateManager.rotate(-var13 * (float)40.0, 5.0f, -var14, -0);
                                break;
                            case "Swing":
                            ...
                            case "Exhi":
                                ...
                                transformFirstPersonItem(-0.45F, 0.0F);
                                GlStateManager.rotate(-var1 * 60.0F / 2.0F, var1 / 2.0F, -0.0F, 4.0F);
                                GlStateManager.rotate(-var1 * 30.0F, 1.0F, var1 / 2.0F, -0.0F);
            ...
            if(ModuleManager.getModule(Animations.class).isToggled()) GlStateManager.scale(Animations.scale.getValue(), Animations.scale.getValue(),Animations.scale.getValue());
