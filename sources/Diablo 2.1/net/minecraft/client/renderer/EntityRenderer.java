...
import wtf.diablo.module.impl.Combat.Reach;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            Vec3 vec33 = null;
            float f = 1.0F;
            List list = this.mc.theWorld.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().addCoord(vec31.xCoord * d0, vec31.yCoord * d0, vec31.zCoord * d0).expand((double)f, (double)f, (double)f), Predicates.and(EntitySelectors.NOT_SPECTATING));
            double d2 = d1;
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null)
                {
                    ...
                    Diablo.getEventBus().post(new Render2DEvent(p_181560_1_, scaledresolution));
...
//                    crashreportcategory.addCrashSectionCallable("Screen name", new EntityRenderer$2(this));
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Render3DEventAlternate event2 = new Render3DEventAlternate(partialTicks);
        Diablo.getEventBus().post(event2);
        GL11.glPopAttrib();
