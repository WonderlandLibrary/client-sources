...
public class GuiNewChat extends Gui
{
    ...
    {
        drawRect(500,500,1000,1000,new Color(255,255,255).getRGB());
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                int i2 = 0;
                                int j2 = -i1 * 9;
                                if(!wtf.diablo.module.impl.Render.Gui.clearChat.getValue() || !ModuleManager.getModule(wtf.diablo.module.impl.Render.Gui.class).isToggled()) drawRect(i2, j2 - 9, i2 + l + 4, j2, l1 / 2 << 24);
