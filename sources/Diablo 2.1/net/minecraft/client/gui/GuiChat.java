...
import wtf.diablo.gui.guiElement.GuiElementManager;
...
public class GuiChat extends GuiScreen
{
    ...
    public void mouseReleased(int mouseX, int mouseY, int button){
        for(GuiElement guiElement : GuiElementManager.getElements()){
            guiElement.onMouseRelease(mouseX, mouseY, button);
        }
    }
    /**
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        for(GuiElement guiElement : GuiElementManager.getElements()){
            guiElement.onMouseDown(mouseX, mouseY, mouseButton);
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for(GuiElement guiElement : GuiElementManager.getElements()){
            guiElement.renderOverlay(mouseX, mouseY);
        }
    }
