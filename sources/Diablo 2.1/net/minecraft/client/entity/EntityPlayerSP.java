...
import wtf.diablo.module.impl.Movement.NoSlowdown;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void sendChatMessage(String message) {
        ...
        Diablo.getInstance().getEventBus().post(event);
        if (event.isCanceled()) {
            return;
        }
    ...
    public void onLivingUpdate()
    {
        ...
        if(!ModuleManager.getModule(NoSlowdown.class).isToggled()) {
