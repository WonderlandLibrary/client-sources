...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (org.lwjgl.util.vector.Matrix4f)Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[] {this}): new org.lwjgl.util.vector.Matrix4f();
    }
