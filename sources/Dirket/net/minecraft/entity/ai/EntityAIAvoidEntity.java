...
public class EntityAIAvoidEntity<T extends Entity> extends EntityAIBase {
	...
	public boolean shouldExecute() {
		List<T> list = this.theEntity.worldObj.<T> getEntitiesWithinAABB(this.classToAvoid, this.theEntity.getEntityBoundingBox().expand(this.avoidDistance, 3.0D, this.avoidDistance),
		...
		if (list.isEmpty()) {
			...
			Vec3d vec3d = RandomPositionGenerator.findRandomTargetBlockAwayFrom(this.theEntity, 16, 7,
