...
public class EntityAIHurtByTarget extends EntityAITarget {
	...
	protected void func_190105_f() {
		...
		for (EntityCreature entitycreature : this.taskOwner.worldObj.getEntitiesWithinAABB(this.taskOwner.getClass(),
				(new AxisAlignedBB(this.taskOwner.posX, this.taskOwner.posY, this.taskOwner.posZ, this.taskOwner.posX + 1.0D, this.taskOwner.posY + 1.0D, this.taskOwner.posZ + 1.0D)).expand(d0, 10.0D,
						d0))) {
			if ((this.taskOwner != entitycreature) && (entitycreature.getAttackTarget() == null)
					&& (!(this.taskOwner instanceof EntityTameable) || (((EntityTameable) this.taskOwner).getOwner() == ((EntityTameable) entitycreature).getOwner()))
