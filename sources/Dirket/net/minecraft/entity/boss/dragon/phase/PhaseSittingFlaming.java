...
public class PhaseSittingFlaming extends PhaseSittingBase {
	...
	public void doClientRenderEffects() {
		...
		if (((this.flameTicks % 2) == 0) && (this.flameTicks < 10)) {
			...
			for (int i = 0; i < 8; ++i) {
				...
				for (int j = 0; j < 6; ++j) {
					this.dragon.worldObj.spawnParticle(EnumParticleTypes.DRAGON_BREATH, d3, d4, d5, -vec3d.xCoord * 0.07999999821186066D * j, -vec3d.yCoord * 0.6000000238418579D,
							-vec3d.zCoord * 0.07999999821186066D * j, new int[0]);
				}
	...
	public void doLocalUpdate() {
		...
		if (this.flameTicks >= 200) {
			...
			d2 = MathHelper.floor_double(d2) + 1;
