...
public enum SkeletonType {
	NORMAL("Skeleton", LootTableList.ENTITIES_SKELETON), WITHER("WitherSkeleton", LootTableList.ENTITIES_WITHER_SKELETON), STRAY("Stray", LootTableList.field_189968_an);
