...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
	protected static final AtomicInteger UNIQUE_THREAD_ID = new AtomicInteger(0);
	protected static final Logger LOGGER = LogManager.getLogger();
	protected static final Random RANDOM = new Random();

	/** Counts the number of screen updates. */
	protected final float updateCounter;
	...
	protected int panoramaTimer;

	/**
	 * Texture allocated for the current viewport of the main menu's panorama background.
	 */
	protected DynamicTexture viewportTexture;
	protected final boolean mcoEnabled = true;
	...
	protected String openGLWarningLink;
	protected static final ResourceLocation SPLASH_TEXTS = new ResourceLocation("texts/splashes.txt");
	protected static final ResourceLocation MINECRAFT_TITLE_TEXTURES = new ResourceLocation("textures/gui/title/minecraft.png");

	/** An array of all the paths to the panorama pictures. */
	protected static final ResourceLocation[] TITLE_PANORAMA_PATHS = new ResourceLocation[] { new ResourceLocation("textures/gui/title/background/panorama_0.png"),
	...
	protected int openGLWarning2Width;

	/** Width of openGLWarning1 */
	protected int openGLWarning1Width;

	/** Left x coordinate of the OpenGL warning */
	protected int openGLWarningX1;

	/** Top y coordinate of the OpenGL warning */
	protected int openGLWarningY1;

	/** Right x coordinate of the OpenGL warning */
	protected int openGLWarningX2;

	/** Bottom y coordinate of the OpenGL warning */
	protected int openGLWarningY2;
	...
	protected boolean hasCheckedForRealmsNotification;
	 ...
	 */
	protected GuiScreen realmsNotification;
	 ...
	 */
	protected boolean areRealmsNotificationsEnabled() {
	 ...
	 */
	protected void addDemoButtons(int p_73972_1_, int p_73972_2_) {
		...
		if (button.id == 12) {
			...
			if (worldinfo != null) {
				this.mc.displayGuiScreen(
						new GuiYesNo(this, I18n.format("selectWorld.deleteQuestion", new Object[0]), "\'" + worldinfo.getWorldName() + "\' " + I18n.format("selectWorld.deleteWarning", new Object[0]),
								I18n.format("selectWorld.deleteButton", new Object[0]), I18n.format("gui.cancel", new Object[0]), 12));
			}
		}
	}

	protected void switchToRealms() {
		RealmsBridge realmsbridge = new RealmsBridge();
	 ...
	 */
	protected void rotateAndBlurSkybox(float partialTicks) {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(this.fontRendererObj, "Copyright Mojang AB. Do not distribute!", this.width - this.fontRendererObj.getStringWidth("Copyright Mojang AB. Do not distribute!") - 2,
				this.height - 10, -1);
