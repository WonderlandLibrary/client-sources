...
public class GuiScreenBook extends GuiScreen {
	...
	public void initGui() {
		...
		int j = 2;
		this.buttonNextPage = this.func_189646_b(new GuiScreenBook.NextPageButton(1, i + 120, 156, true));
		this.buttonPreviousPage = this.func_189646_b(new GuiScreenBook.NextPageButton(2, i + 38, 156, false));
		this.updateButtons();
	}
	...
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		if (mouseButton == 0) {
			...
			if ((itextcomponent != null) && this.handleComponentClick(itextcomponent)) { return; }
		}
