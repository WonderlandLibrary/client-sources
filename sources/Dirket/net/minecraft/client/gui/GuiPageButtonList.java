...
public class GuiPageButtonList extends GuiListExtended {
	...
	private Gui createEntry(@Nullable GuiPageButtonList.GuiListEntry p_178058_1_, int p_178058_2_, boolean p_178058_3_) {
		return p_178058_1_ instanceof GuiPageButtonList.GuiSlideEntry ? this.createSlider(((this.width / 2) - 155) + p_178058_2_, 0, (GuiPageButtonList.GuiSlideEntry) p_178058_1_)
				: (p_178058_1_ instanceof GuiPageButtonList.GuiButtonEntry ? this.createButton(((this.width / 2) - 155) + p_178058_2_, 0, (GuiPageButtonList.GuiButtonEntry) p_178058_1_)
						: (p_178058_1_ instanceof GuiPageButtonList.EditBoxEntry ? this.createTextField(((this.width / 2) - 155) + p_178058_2_, 0, (GuiPageButtonList.EditBoxEntry) p_178058_1_)
								: (p_178058_1_ instanceof GuiPageButtonList.GuiLabelEntry
										? this.createLabel(((this.width / 2) - 155) + p_178058_2_, 0, (GuiPageButtonList.GuiLabelEntry) p_178058_1_, p_178058_3_) : null)));
	}
	...
	private GuiSlider createSlider(int p_178067_1_, int p_178067_2_, GuiPageButtonList.GuiSlideEntry p_178067_3_) {
		GuiSlider guislider = new GuiSlider(this.responder, p_178067_3_.getId(), p_178067_1_, p_178067_2_, p_178067_3_.getCaption(), p_178067_3_.getMinValue(), p_178067_3_.getMaxValue(),
				p_178067_3_.getInitalValue(), p_178067_3_.getFormatter());
