	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		case 1:
			if (this.mc.theWorld.getWorldInfo().isHardcoreModeEnabled()) {
				...
				GuiYesNo guiyesno = new GuiYesNo(this, I18n.format("deathScreen.quit.confirm", new Object[0]), "", I18n.format("deathScreen.titleScreen", new Object[0]),
		...
		if (this.causeOfDeath == null) {
			...
			if ((p_184870_1_ >= j) && (p_184870_1_ <= k)) {
				for (ITextComponent itextcomponent : this.causeOfDeath) {
					...
					if (l > p_184870_1_) { return itextcomponent; }
				}
