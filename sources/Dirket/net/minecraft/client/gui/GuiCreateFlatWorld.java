...
public class GuiCreateFlatWorld extends GuiScreen {
	...
	class Details extends GuiSlot {
		...
		private void drawItemBackground(int x, int z, int textureX, int textureY) {
			...
			vertexbuffer.pos(x + 0, z + 18, GuiCreateFlatWorld.this.zLevel).tex((textureX + 0) * 0.0078125F, (textureY + 18) * 0.0078125F).endVertex();
			vertexbuffer.pos(x + 18, z + 18, GuiCreateFlatWorld.this.zLevel).tex((textureX + 18) * 0.0078125F, (textureY + 18) * 0.0078125F).endVertex();
			vertexbuffer.pos(x + 18, z + 0, GuiCreateFlatWorld.this.zLevel).tex((textureX + 18) * 0.0078125F, (textureY + 0) * 0.0078125F).endVertex();
			vertexbuffer.pos(x + 0, z + 0, GuiCreateFlatWorld.this.zLevel).tex((textureX + 0) * 0.0078125F, (textureY + 0) * 0.0078125F).endVertex();
			tessellator.draw();
		}
