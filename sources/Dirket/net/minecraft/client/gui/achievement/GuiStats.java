...
public class GuiStats extends GuiScreen implements IProgressMeter {
	...
	private void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
		...
		vertexbuffer.pos(p_146527_1_ + 0, p_146527_2_ + 18, this.zLevel).tex((p_146527_3_ + 0) * 0.0078125F, (p_146527_4_ + 18) * 0.0078125F).endVertex();
		vertexbuffer.pos(p_146527_1_ + 18, p_146527_2_ + 18, this.zLevel).tex((p_146527_3_ + 18) * 0.0078125F, (p_146527_4_ + 18) * 0.0078125F).endVertex();
		vertexbuffer.pos(p_146527_1_ + 18, p_146527_2_ + 0, this.zLevel).tex((p_146527_3_ + 18) * 0.0078125F, (p_146527_4_ + 0) * 0.0078125F).endVertex();
		vertexbuffer.pos(p_146527_1_ + 0, p_146527_2_ + 0, this.zLevel).tex((p_146527_3_ + 0) * 0.0078125F, (p_146527_4_ + 0) * 0.0078125F).endVertex();
		tessellator.draw();
	}
	...
	abstract class Stats extends GuiSlot {
		...
		protected void renderDecorations(int mouseXIn, int mouseYIn) {
			if ((mouseYIn >= this.top) && (mouseYIn <= this.bottom)) {
				...
				if (i >= 0) {
					if ((mouseXIn < (j + 40)) || (mouseXIn > (j + 40 + 20))) { return; }
					...
					if ((mouseXIn >= ((j + 115) - 18)) && (mouseXIn <= (j + 115))) {
						...
						if ((mouseXIn < ((j + 315) - 18)) || (mouseXIn > (j + 315))) { return; }
			...
			this.statSorter = new Comparator<StatCrafting>() {
				...
				public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_) {
					...
					if ((statbase != null) || (statbase1 != null)) {
						...
						if (i != j) { return (i - j) * StatsBlock.this.sortOrder; }
					}
	...
	class StatsGeneral extends GuiSlot {
		...
		@Override
		protected void drawSlot(int entryID, int insideLeft, int yPos, int insideSlotHeight, int mouseXIn, int mouseYIn) {
			StatBase statbase = StatList.BASIC_STATS.get(entryID);
			...
			this.statSorter = new Comparator<StatCrafting>() {
				...
				public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_) {
					...
					if ((statbase != null) || (statbase1 != null)) {
						...
						if (k != l) { return (k - l) * StatsItem.this.sortOrder; }
					}
