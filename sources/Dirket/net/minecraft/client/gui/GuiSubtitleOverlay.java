...
public class GuiSubtitleOverlay extends Gui implements ISoundEventListener {
	...
	public void renderSubtitles(ScaledResolution resolution) {
		...
		if (this.enabled && !this.subtitles.isEmpty()) {
			...
			Vec3d vec3d = new Vec3d(this.client.thePlayer.posX, this.client.thePlayer.posY + this.client.thePlayer.getEyeHeight(), this.client.thePlayer.posZ);
			...
			j = j + this.client.fontRendererObj.getStringWidth("<") + this.client.fontRendererObj.getStringWidth(" ") + this.client.fontRendererObj.getStringWidth(">")
					+ this.client.fontRendererObj.getStringWidth(" ");
			...
			for (GuiSubtitleOverlay.Subtitle guisubtitleoverlay$subtitle1 : this.subtitles) {
				...
				int l1 = MathHelper.floor_double(MathHelper.denormalizeClamp(255.0D, 75.0D, (Minecraft.getSystemTime() - guisubtitleoverlay$subtitle1.getStartTime()) / 3000.0F));
