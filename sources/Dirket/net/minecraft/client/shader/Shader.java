...
public class Shader {
	...
	public void loadShader(float p_148042_1_) {
		...
		vertexbuffer.pos(0.0D, f1, 500.0D).color(255, 255, 255, 255).endVertex();
		vertexbuffer.pos(f, f1, 500.0D).color(255, 255, 255, 255).endVertex();
		vertexbuffer.pos(f, 0.0D, 500.0D).color(255, 255, 255, 255).endVertex();
