...
public class ClippingHelper {
	...
	public boolean isBoxInFrustum(double p_78553_1_, double p_78553_3_, double p_78553_5_, double p_78553_7_, double p_78553_9_, double p_78553_11_) {
		...
		for (int i = 0; i < 6; ++i) {
			...
			if ((this.dot(afloat, f, f1, f2) <= 0.0F) && (this.dot(afloat, f3, f1, f2) <= 0.0F) && (this.dot(afloat, f, f4, f2) <= 0.0F) && (this.dot(afloat, f3, f4, f2) <= 0.0F)
					&& (this.dot(afloat, f, f1, f5) <= 0.0F) && (this.dot(afloat, f3, f1, f5) <= 0.0F) && (this.dot(afloat, f, f4, f5) <= 0.0F)
					&& (this.dot(afloat, f3, f4, f5) <= 0.0F)) { return false; }
		}
