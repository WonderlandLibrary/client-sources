			...
			for (int j = 0; j < 3; ++j) {
				...
				for (int i1 = k; i1 >= l; --i1) {
					...
					for (int j1 = 0; j1 < 5; ++j1) {
						...
						vertexbuffer.pos(d10 + d2, y + i1 * 16, d11 + d3).color(0.45F, 0.45F, 0.5F, 0.3F).endVertex();
						vertexbuffer.pos(d8 + d4, y + (i1 + 1) * 16, d9 + d5).color(0.45F, 0.45F, 0.5F, 0.3F).endVertex();
					}
