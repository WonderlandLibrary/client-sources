...
public class RenderManager {
	...
	public <T extends Entity> Render<T> getEntityClassRenderObject(Class<? extends Entity> entityClass) {
		...
		if ((render == null) && (entityClass != Entity.class)) {
			render = (Render<T>) this.<Entity> getEntityClassRenderObject((Class<? extends Entity>) entityClass.getSuperclass());
	...
	public void renderEntityStatic(Entity p_188388_1_, float p_188388_2_, boolean p_188388_3_) {
		...
		double d0 = p_188388_1_.lastTickPosX + ((p_188388_1_.posX - p_188388_1_.lastTickPosX) * p_188388_2_);
		double d1 = p_188388_1_.lastTickPosY + ((p_188388_1_.posY - p_188388_1_.lastTickPosY) * p_188388_2_);
		double d2 = p_188388_1_.lastTickPosZ + ((p_188388_1_.posZ - p_188388_1_.lastTickPosZ) * p_188388_2_);
	...
	private void renderDebugBoundingBox(Entity entityIn, double x, double y, double z, float entityYaw, float partialTicks) {
		...
		RenderGlobal.func_189694_a((axisalignedbb.minX - entityIn.posX) + x, (axisalignedbb.minY - entityIn.posY) + y, (axisalignedbb.minZ - entityIn.posZ) + z,
				(axisalignedbb.maxX - entityIn.posX) + x, (axisalignedbb.maxY - entityIn.posY) + y, (axisalignedbb.maxZ - entityIn.posZ) + z, 1.0F, 1.0F, 1.0F, 1.0F);

		if (entityIn instanceof EntityLivingBase) {
			float f1 = 0.01F;
			RenderGlobal.func_189694_a(x - f, (y + entityIn.getEyeHeight()) - 0.009999999776482582D, z - f, x + f, y + entityIn.getEyeHeight() + 0.009999999776482582D, z + f, 1.0F, 0.0F, 0.0F, 1.0F);
		}
		...
		vertexbuffer.pos(x + (vec3d.xCoord * 2.0D), y + entityIn.getEyeHeight() + (vec3d.yCoord * 2.0D), z + (vec3d.zCoord * 2.0D)).color(0, 0, 255, 255).endVertex();
		tessellator.draw();
