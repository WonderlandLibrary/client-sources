...
public class OpenGlHelper {
	...
	public static void renderDirections(int p_188785_0_) {
		...
		vertexbuffer.pos(p_188785_0_, 0.0D, 0.0D).color(0, 0, 0, 255).endVertex();
		vertexbuffer.pos(0.0D, 0.0D, 0.0D).color(0, 0, 0, 255).endVertex();
		vertexbuffer.pos(0.0D, p_188785_0_, 0.0D).color(0, 0, 0, 255).endVertex();
		vertexbuffer.pos(0.0D, 0.0D, 0.0D).color(0, 0, 0, 255).endVertex();
		vertexbuffer.pos(0.0D, 0.0D, p_188785_0_).color(0, 0, 0, 255).endVertex();
		tessellator.draw();
		GL11.glLineWidth(2.0F);
		vertexbuffer.begin(1, DefaultVertexFormats.POSITION_COLOR);
		vertexbuffer.pos(0.0D, 0.0D, 0.0D).color(255, 0, 0, 255).endVertex();
		vertexbuffer.pos(p_188785_0_, 0.0D, 0.0D).color(255, 0, 0, 255).endVertex();
		vertexbuffer.pos(0.0D, 0.0D, 0.0D).color(0, 255, 0, 255).endVertex();
		vertexbuffer.pos(0.0D, p_188785_0_, 0.0D).color(0, 255, 0, 255).endVertex();
		vertexbuffer.pos(0.0D, 0.0D, 0.0D).color(127, 127, 255, 255).endVertex();
		vertexbuffer.pos(0.0D, 0.0D, p_188785_0_).color(127, 127, 255, 255).endVertex();
		tessellator.draw();
	...
	public static void openFile(File fileIn) {
		...
		if (Util.getOSType() == Util.EnumOS.OSX) {
			try {
				...
				LOGGER.error("Couldn\'t open file", ioexception11);
			}
