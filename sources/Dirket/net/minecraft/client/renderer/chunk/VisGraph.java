...
public class VisGraph {
	...
	private int getNeighborIndexAtFace(int p_178603_1_, EnumFacing p_178603_2_) {
		switch (p_178603_2_) {
		case DOWN:
			if (((p_178603_1_ >> 8) & 15) == 0) { return -1; }

			return p_178603_1_ - DY;

		case UP:
			if (((p_178603_1_ >> 8) & 15) == 15) { return -1; }

			return p_178603_1_ + DY;

		case NORTH:
			if (((p_178603_1_ >> 4) & 15) == 0) { return -1; }

			return p_178603_1_ - DZ;

		case SOUTH:
			if (((p_178603_1_ >> 4) & 15) == 15) { return -1; }

			return p_178603_1_ + DZ;

		case WEST:
			if (((p_178603_1_ >> 0) & 15) == 0) { return -1; }

			return p_178603_1_ - DX;

		case EAST:
			if (((p_178603_1_ >> 0) & 15) == 15) { return -1; }
