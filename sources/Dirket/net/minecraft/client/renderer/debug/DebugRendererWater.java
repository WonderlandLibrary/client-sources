...
public class DebugRendererWater implements DebugRenderer.IDebugRenderer {
	...
	public void func_190060_a(float p_190060_1_, long p_190060_2_) {
		...
		this.field_190063_c = this.field_190062_b.lastTickPosX + ((this.field_190062_b.posX - this.field_190062_b.lastTickPosX) * p_190060_1_);
		this.field_190064_d = this.field_190062_b.lastTickPosY + ((this.field_190062_b.posY - this.field_190062_b.lastTickPosY) * p_190060_1_);
		this.field_190065_e = this.field_190062_b.lastTickPosZ + ((this.field_190062_b.posZ - this.field_190062_b.lastTickPosZ) * p_190060_1_);
		...
		for (BlockPos blockpos1 : BlockPos.getAllInBox(blockpos.add(-10, -10, -10), blockpos.add(10, 10, 10))) {
			...
			if ((iblockstate.getBlock() == Blocks.WATER) || (iblockstate.getBlock() == Blocks.FLOWING_WATER)) {
				double d0 = EntityBoat.getLiquidHeight(iblockstate, world, blockpos1);
				RenderGlobal.func_189696_b((new AxisAlignedBB(blockpos1.getX() + 0.01F, blockpos1.getY() + 0.01F, blockpos1.getZ() + 0.01F, blockpos1.getX() + 0.99F, d0, blockpos1.getZ() + 0.99F))
						.offset(-this.field_190063_c, -this.field_190064_d, -this.field_190065_e), 1.0F, 1.0F, 1.0F, 0.2F);
			}
		}
		...
		for (BlockPos blockpos2 : BlockPos.getAllInBox(blockpos.add(-10, -10, -10), blockpos.add(10, 10, 10))) {
			...
			if ((iblockstate1.getBlock() == Blocks.WATER) || (iblockstate1.getBlock() == Blocks.FLOWING_WATER)) {
				...
				DebugRenderer.func_190076_a(s + " " + integer, blockpos2.getX() + 0.5D, blockpos2.getY() + d1, blockpos2.getZ() + 0.5D, p_190060_1_, -16777216);
			}
		}
