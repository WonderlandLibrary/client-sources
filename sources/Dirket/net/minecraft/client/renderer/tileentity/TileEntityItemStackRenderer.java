		...
		if (itemStackIn.getItem() == Items.BANNER) {
			...
			if (itemStackIn.getSubCompound("BlockEntityTag", false) != null) {
				...
				Minecraft.getMinecraft().getTextureManager()
						.bindTexture(BannerTextures.SHIELD_DESIGNS.getResourceLocation(this.banner.getPatternResourceLocation(), this.banner.getPatternList(), this.banner.getColorList()));
			} else {
