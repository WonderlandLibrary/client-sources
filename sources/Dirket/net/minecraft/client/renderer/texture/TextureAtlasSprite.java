...
public class TextureAtlasSprite {
	...
	public void updateAnimation() {
		...
		if (this.tickCounter >= this.animationMetadata.getFrameTimeSingle(this.frameCounter)) {
			...
			if ((i != k) && (k >= 0) && (k < this.framesTextureData.size())) {
				if (Config.isShaders()) {
					ShadersTex.uploadTexSub((this.framesTextureData.get(k)), this.width, this.height, this.originX, this.originY, flag, flag1);
				} else {
	...
	public void loadSprite(PngSizeInfo sizeInfo, boolean p_188538_2_) throws IOException {
		...
		} else if (sizeInfo.pngHeight != sizeInfo.pngWidth) { throw new RuntimeException("broken aspect ratio and not an animation"); }
		...
		if (animationmetadatasection == null) {
			...
			if (animationmetadatasection.getFrameCount() > 0) {
				...
				while (iterator.hasNext()) {
					...
					if (j >= i) { throw new RuntimeException("invalid frameindex " + j); }
	...
	public String toString() {
		return "TextureAtlasSprite{name=\'" + this.iconName + '\'' + ", frameCount=" + this.framesTextureData.size() + ", rotated=" + this.rotated + ", x=" + this.originX + ", y=" + this.originY
				+ ", height=" + this.height + ", width=" + this.width + ", u0=" + this.minU + ", u1=" + this.maxU + ", v0=" + this.minV + ", v1=" + this.maxV + '}';
	}
