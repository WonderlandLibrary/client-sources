...
public class Scoreboard {
	...
	public static String getObjectiveDisplaySlot(int id) {
		...
		default:
			if ((id >= 3) && (id <= 18)) {
				...
				if ((textformatting != null) && (textformatting != TextFormatting.RESET)) { return "sidebar.team." + textformatting.getFriendlyName(); }
			}
	...
	public static int getObjectiveDisplaySlotNumber(String name) {
		if ("list".equalsIgnoreCase(name)) {
			...
			if (name.startsWith("sidebar.team.")) {
				...
				if ((textformatting != null) && (textformatting.getColorIndex() >= 0)) { return textformatting.getColorIndex() + 3; }
			}
	...
	public void removeEntity(Entity entityIn) {
		if ((entityIn != null) && !(entityIn instanceof EntityPlayer) && !entityIn.isEntityAlive()) {
			String s = entityIn.func_189512_bd();
