	...
	public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight) {
		...
		for (int i = 0; i < areaHeight; ++i) {
			for (int j = 0; j < areaWidth; ++j) {
				...
				if (!this.replaceBiomeEdgeIfNecessary(aint, aint1, j, i, areaWidth, k, Biome.getIdForBiome(Biomes.EXTREME_HILLS), Biome.getIdForBiome(Biomes.EXTREME_HILLS_EDGE))
						&& !this.replaceBiomeEdge(aint, aint1, j, i, areaWidth, k, Biome.getIdForBiome(Biomes.MESA_ROCK), Biome.getIdForBiome(Biomes.MESA))
						&& !this.replaceBiomeEdge(aint, aint1, j, i, areaWidth, k, Biome.getIdForBiome(Biomes.MESA_CLEAR_ROCK), Biome.getIdForBiome(Biomes.MESA))
						&& !this.replaceBiomeEdge(aint, aint1, j, i, areaWidth, k, Biome.getIdForBiome(Biomes.REDWOOD_TAIGA), Biome.getIdForBiome(Biomes.TAIGA))) {
					if (k == Biome.getIdForBiome(Biomes.DESERT)) {
						...
						if ((l1 != Biome.getIdForBiome(Biomes.ICE_PLAINS)) && (i2 != Biome.getIdForBiome(Biomes.ICE_PLAINS)) && (j2 != Biome.getIdForBiome(Biomes.ICE_PLAINS))
								&& (k2 != Biome.getIdForBiome(Biomes.ICE_PLAINS))) {
						...
						if ((l != Biome.getIdForBiome(Biomes.DESERT)) && (i1 != Biome.getIdForBiome(Biomes.DESERT)) && (j1 != Biome.getIdForBiome(Biomes.DESERT))
								&& (k1 != Biome.getIdForBiome(Biomes.DESERT)) && (l != Biome.getIdForBiome(Biomes.COLD_TAIGA)) && (i1 != Biome.getIdForBiome(Biomes.COLD_TAIGA))
								&& (j1 != Biome.getIdForBiome(Biomes.COLD_TAIGA)) && (k1 != Biome.getIdForBiome(Biomes.COLD_TAIGA)) && (l != Biome.getIdForBiome(Biomes.ICE_PLAINS))
								&& (i1 != Biome.getIdForBiome(Biomes.ICE_PLAINS)) && (j1 != Biome.getIdForBiome(Biomes.ICE_PLAINS)) && (k1 != Biome.getIdForBiome(Biomes.ICE_PLAINS))) {
							if ((l != Biome.getIdForBiome(Biomes.JUNGLE)) && (k1 != Biome.getIdForBiome(Biomes.JUNGLE)) && (i1 != Biome.getIdForBiome(Biomes.JUNGLE))
									&& (j1 != Biome.getIdForBiome(Biomes.JUNGLE))) {
								aint1[j + (i * areaWidth)] = k;
							} else {
