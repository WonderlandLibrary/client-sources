...
public class GenLayerShore extends GenLayer {
		...
		for (int i = 0; i < areaHeight; ++i) {
			for (int j = 0; j < areaWidth; ++j) {
				...
				if (k == Biome.getIdForBiome(Biomes.MUSHROOM_ISLAND)) {
					...
					if ((j2 != Biome.getIdForBiome(Biomes.OCEAN)) && (i3 != Biome.getIdForBiome(Biomes.OCEAN)) && (l3 != Biome.getIdForBiome(Biomes.OCEAN))
					...
					if ((biome != null) && biome.isSnowyBiome()) {
						...
						if ((k != Biome.getIdForBiome(Biomes.OCEAN)) && (k != Biome.getIdForBiome(Biomes.DEEP_OCEAN)) && (k != Biome.getIdForBiome(Biomes.RIVER))
	...
	private boolean isJungleCompatible(int p_151631_1_) {
		return (Biome.getBiome(p_151631_1_) != null) && (Biome.getBiome(p_151631_1_).getBiomeClass() == BiomeJungle.class) ? true
				: (p_151631_1_ == Biome.getIdForBiome(Biomes.JUNGLE_EDGE)) || (p_151631_1_ == Biome.getIdForBiome(Biomes.JUNGLE)) || (p_151631_1_ == Biome.getIdForBiome(Biomes.JUNGLE_HILLS))
						|| (p_151631_1_ == Biome.getIdForBiome(Biomes.FOREST)) || (p_151631_1_ == Biome.getIdForBiome(Biomes.TAIGA)) || isBiomeOceanic(p_151631_1_);
	}
