...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO {
		...
		if (!compound.hasKey("Level", 10)) {
			...
			if (!nbttagcompound.hasKey("Sections", 9)) {
				...
				if (!chunk.isAtLocation(x, z)) {
					LOGGER.error("Chunk file at {},{} is in the wrong location; relocating. (Expected {}, {}, got {}, {})",
							new Object[] { Integer.valueOf(x), Integer.valueOf(z), Integer.valueOf(x), Integer.valueOf(z), Integer.valueOf(chunk.xPosition), Integer.valueOf(chunk.zPosition) });
	...
	/**
	 * Writes the Chunk passed as an argument to the NBTTagCompound also passed, using the World argument to retrieve the Chunk's last update time.
	 */
