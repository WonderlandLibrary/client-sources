...
public class MerchantRecipeList extends ArrayList<MerchantRecipe> {
	...
	public MerchantRecipe canRecipeBeUsed(ItemStack p_77203_1_, @Nullable ItemStack p_77203_2_, int p_77203_3_) {
		if ((p_77203_3_ > 0) && (p_77203_3_ < this.size())) {
			...
			return !this.areItemStacksExactlyEqual(p_77203_1_, merchantrecipe1.getItemToBuy())
					|| (((p_77203_2_ != null) || merchantrecipe1.hasSecondItemToBuy())
							&& (!merchantrecipe1.hasSecondItemToBuy() || !this.areItemStacksExactlyEqual(p_77203_2_, merchantrecipe1.getSecondItemToBuy())))
					|| (p_77203_1_.stackSize < merchantrecipe1.getItemToBuy().stackSize)
					|| (merchantrecipe1.hasSecondItemToBuy() && (p_77203_2_.stackSize < merchantrecipe1.getSecondItemToBuy().stackSize)) ? null : merchantrecipe1;
		} else {
			for (int i = 0; i < this.size(); ++i) {
				MerchantRecipe merchantrecipe = this.get(i);

				if (this.areItemStacksExactlyEqual(p_77203_1_, merchantrecipe.getItemToBuy()) && (p_77203_1_.stackSize >= merchantrecipe.getItemToBuy().stackSize)
						&& ((!merchantrecipe.hasSecondItemToBuy() && (p_77203_2_ == null))
								|| (merchantrecipe.hasSecondItemToBuy() && this.areItemStacksExactlyEqual(p_77203_2_, merchantrecipe.getSecondItemToBuy())
										&& (p_77203_2_.stackSize >= merchantrecipe.getSecondItemToBuy().stackSize)))) { return merchantrecipe; }
			}
