...
public class VillageSiege {
	...
	private Vec3d findRandomSpawnPos(BlockPos pos) {
		for (int i = 0; i < 10; ++i) {
			...
			if (this.theVillage.isBlockPosWithinSqVillageRadius(blockpos) && WorldEntitySpawner.canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType.ON_GROUND, this.worldObj,
					blockpos)) { return new Vec3d(blockpos.getX(), blockpos.getY(), blockpos.getZ()); }
		}
