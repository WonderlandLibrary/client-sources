		...
		if ((slot != null) && slot.getHasStack()) {
			...
			if (((index < 0) || (index > 2)) && (index != 3) && (index != 4)) {
				if (!this.theSlot.getHasStack() && this.theSlot.isItemValid(itemstack1)) {
					...
					if (!this.mergeItemStack(itemstack1, 32, 41, false)) { return null; }
				} else if ((index >= 32) && (index < 41)) {
					if (!this.mergeItemStack(itemstack1, 5, 32, false)) { return null; }
				} else if (!this.mergeItemStack(itemstack1, 5, 41, false)) { return null; }
			} else {
				if (!this.mergeItemStack(itemstack1, 5, 41, true)) { return null; }
