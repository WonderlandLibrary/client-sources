				...
				if (slot7 != null) {
					...
					if (itemstack9 == null) {
						...
						if (itemstack12 == null) {
							...
							if ((itemstack9.getItem() == itemstack12.getItem()) && (itemstack9.getMetadata() == itemstack12.getMetadata())
									&& ItemStack.areItemStackTagsEqual(itemstack9, itemstack12)) {
						...
						} else if ((itemstack9.getItem() == itemstack12.getItem()) && (itemstack12.getMaxStackSize() > 1)
								&& (!itemstack9.getHasSubtypes() || (itemstack9.getMetadata() == itemstack12.getMetadata())) && ItemStack.areItemStackTagsEqual(itemstack9, itemstack12)) {
			...
			if ((itemstack4 != null) && ((slot2 == null) || !slot2.getHasStack() || !slot2.canTakeStack(player))) {
				...
				for (int i3 = 0; i3 < 2; ++i3) {
					for (int j3 = i1; (j3 >= 0) && (j3 < this.inventorySlots.size()) && (itemstack4.stackSize < itemstack4.getMaxStackSize()); j3 += j1) {
						...
						if (slot8.getHasStack() && canAddItemToSlot(slot8, itemstack4, true) && slot8.canTakeStack(player) && this.canMergeSlot(itemstack4, slot8)
