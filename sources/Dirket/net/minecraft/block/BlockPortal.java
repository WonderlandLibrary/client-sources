...
public class BlockPortal extends BlockBreakable {
	...
	public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		if (worldIn.provider.isSurfaceWorld() && worldIn.getGameRules().getBoolean("doMobSpawning") && (rand.nextInt(2000) < worldIn.getDifficulty().getDifficultyId())) {
			...
			if ((i > 0) && !worldIn.getBlockState(blockpos.up()).isNormalCube()) {
				Entity entity = ItemMonsterPlacer.spawnCreature(worldIn, EntityList.getEntityStringFromClass(EntityPigZombie.class), blockpos.getX() + 0.5D, blockpos.getY() + 1.1D,
						blockpos.getZ() + 0.5D);
	...
	public void func_189540_a(IBlockState p_189540_1_, World p_189540_2_, BlockPos p_189540_3_, Block p_189540_4_) {
		EnumFacing.Axis enumfacing$axis = p_189540_1_.getValue(AXIS);
