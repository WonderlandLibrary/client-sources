...
public class BlockRailPowered extends BlockRailBase {
	...
	protected boolean findPoweredRailSignal(World worldIn, BlockPos pos, IBlockState state, boolean p_176566_4_, int p_176566_5_) {
		if (p_176566_5_ >= 8) {
			...
			return this.isSameRailWithPower(worldIn, new BlockPos(i, j, k), p_176566_4_, p_176566_5_, blockrailbase$enumraildirection) ? true
					: flag && this.isSameRailWithPower(worldIn, new BlockPos(i, j - 1, k), p_176566_4_, p_176566_5_, blockrailbase$enumraildirection);
		}
	}
	...
	protected boolean isSameRailWithPower(World worldIn, BlockPos pos, boolean p_176567_3_, int distance, BlockRailBase.EnumRailDirection p_176567_5_) {
		...
		if (iblockstate.getBlock() != this) {
			...
			return (p_176567_5_ != BlockRailBase.EnumRailDirection.EAST_WEST) || ((blockrailbase$enumraildirection != BlockRailBase.EnumRailDirection.NORTH_SOUTH)
							...
							? ((p_176567_5_ != BlockRailBase.EnumRailDirection.NORTH_SOUTH)
									|| ((blockrailbase$enumraildirection != BlockRailBase.EnumRailDirection.EAST_WEST)
											...
											&& (blockrailbase$enumraildirection != BlockRailBase.EnumRailDirection.ASCENDING_WEST))
													? (iblockstate.getValue(POWERED).booleanValue()
															? (worldIn.isBlockPowered(pos) ? true : this.findPoweredRailSignal(worldIn, pos, iblockstate, p_176567_3_, distance + 1)) : false)
													: false)
							: false;
		}
	}
	...
	protected void func_189541_b(IBlockState p_189541_1_, World p_189541_2_, BlockPos p_189541_3_, Block p_189541_4_) {
		boolean flag = p_189541_1_.getValue(POWERED).booleanValue();
		boolean flag1 = p_189541_2_.isBlockPowered(p_189541_3_) || this.findPoweredRailSignal(p_189541_2_, p_189541_3_, p_189541_1_, true, 0)
				|| this.findPoweredRailSignal(p_189541_2_, p_189541_3_, p_189541_1_, false, 0);
