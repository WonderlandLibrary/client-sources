...
public class BlockNote extends BlockContainer {
	private static final List<SoundEvent> INSTRUMENTS = Lists
			.newArrayList(new SoundEvent[] { SoundEvents.BLOCK_NOTE_HARP, SoundEvents.BLOCK_NOTE_BASEDRUM, SoundEvents.BLOCK_NOTE_SNARE, SoundEvents.BLOCK_NOTE_HAT, SoundEvents.BLOCK_NOTE_BASS });
	...
	public boolean func_189539_a(IBlockState p_189539_1_, World p_189539_2_, BlockPos p_189539_3_, int p_189539_4_, int p_189539_5_) {
		float f = (float) Math.pow(2.0D, (p_189539_5_ - 12) / 12.0D);
		p_189539_2_.playSound((EntityPlayer) null, p_189539_3_, this.getInstrument(p_189539_4_), SoundCategory.RECORDS, 3.0F, f);
		p_189539_2_.spawnParticle(EnumParticleTypes.NOTE, p_189539_3_.getX() + 0.5D, p_189539_3_.getY() + 1.2D, p_189539_3_.getZ() + 0.5D, p_189539_5_ / 24.0D, 0.0D, 0.0D, new int[0]);
		return true;
	}
