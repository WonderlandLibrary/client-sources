...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		this.addRecipe(new ItemStack(Blocks.ACACIA_FENCE, 3),
				new Object[] { "W#W", "W#W", '#', Items.STICK, 'W', new ItemStack(Blocks.PLANKS, 1, (4 + BlockPlanks.EnumType.ACACIA.getMetadata()) - 4) });
	...
	public ItemStack findMatchingRecipe(InventoryCrafting craftMatrix, World worldIn) {
		for (IRecipe irecipe : this.recipes) {
			if (irecipe.matches(craftMatrix, worldIn)) { return irecipe.getCraftingResult(craftMatrix); }
		}
