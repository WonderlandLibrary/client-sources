		...
		synchronized (this.endpoints) {
			...
			this.endpoints.add((new ServerBootstrap()).channel(oclass).childHandler(new ChannelInitializer<Channel>() {
				...
				protected void initChannel(Channel p_initChannel_1_) throws Exception {
					...
					p_initChannel_1_.pipeline().addLast("timeout", (new ReadTimeoutHandler(30))).addLast("legacy_query", (new LegacyPingHandler(NetworkSystem.this)))
							.addLast("splitter", (new NettyVarint21FrameDecoder())).addLast("decoder", (new NettyPacketDecoder(EnumPacketDirection.SERVERBOUND)))
							.addLast("prepender", (new NettyVarint21FrameEncoder())).addLast("encoder", (new NettyPacketEncoder(EnumPacketDirection.CLIENTBOUND)));
