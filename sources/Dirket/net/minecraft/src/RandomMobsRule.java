...
public class RandomMobsRule {
	...
	public RandomMobsRule(ResourceLocation p_i63_1_, int[] p_i63_2_, int[] p_i63_3_, Biome[] p_i63_4_, RangeListInt p_i63_5_) {
		this.baseResLoc = p_i63_1_;
		this.skins = p_i63_2_;
		this.weights = p_i63_3_;
		this.biomes = p_i63_4_;
		this.heights = p_i63_5_;
	}
	...
	public boolean matches(EntityLiving p_matches_1_) {
		return !Matches.biome(p_matches_1_.spawnBiome, this.biomes) ? false
				: ((this.heights != null) && (p_matches_1_.spawnPosition != null) ? this.heights.isInRange(p_matches_1_.spawnPosition.getY()) : true);
	}
