...
public class WorldServerOF extends WorldServer {
	...
	public WorldServerOF(MinecraftServer p_i77_1_, ISaveHandler p_i77_2_, WorldInfo p_i77_3_, int p_i77_4_, Profiler p_i77_5_) {
		super(p_i77_1_, p_i77_2_, p_i77_3_, p_i77_4_, p_i77_5_);
		this.mcServer = p_i77_1_;
	}
