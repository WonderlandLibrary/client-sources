...
public class ConnectedParser {
	...
	public ConnectedParser(String p_i20_1_) {
		this.context = p_i20_1_;
	}
	...
	public static Comparable getPropertyValue(String p_getPropertyValue_0_, Collection<Comparable> p_getPropertyValue_1_) {
		for (Comparable comparable : p_getPropertyValue_1_) {
			if (String.valueOf(comparable).equals(p_getPropertyValue_0_)) { return comparable; }
		}
	...
	public static Comparable parseValue(String p_parseValue_0_, Class p_parseValue_1_) {
		return p_parseValue_1_ == String.class ? p_parseValue_0_
				: (p_parseValue_1_ == Boolean.class ? Boolean.valueOf(p_parseValue_0_)
						: (p_parseValue_1_ == Float.class ? Float.valueOf(p_parseValue_0_)
								: (p_parseValue_1_ == Double.class ? Double.valueOf(p_parseValue_0_)
										: (p_parseValue_1_ == Integer.class ? Integer.valueOf(p_parseValue_0_) : (p_parseValue_1_ == Long.class ? Long.valueOf(p_parseValue_0_) : null)))));
	}
	...
	public boolean matchState(IBlockState p_matchState_1_, Map<IProperty, List<Comparable>> p_matchState_2_) {
		for (IProperty iproperty : p_matchState_2_.keySet()) {
			...
			if (!list.contains(comparable)) { return false; }
		}
		...
		if (p_findBiome_1_.equals("nether")) {
			...
			for (ResourceLocation resourcelocation : Biome.REGISTRY.getKeys()) {
				...
				if (biome != null) {
					...
					if (s.equals(p_findBiome_1_)) { return biome; }
				}
			}
