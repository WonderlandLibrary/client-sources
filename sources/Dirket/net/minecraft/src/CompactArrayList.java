...
public class CompactArrayList {
	...
	public CompactArrayList(int p_i18_1_) {
		this(p_i18_1_, 0.75F);
	}

	public CompactArrayList(int p_i19_1_, float p_i19_2_) {
		this.list = null;
		this.initialCapacity = 0;
		this.loadFactor = 1.0F;
		this.countValid = 0;
		this.list = new ArrayList(p_i19_1_);
		this.initialCapacity = p_i19_1_;
		this.loadFactor = p_i19_2_;
	}
