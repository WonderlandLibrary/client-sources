...
public class ConnectedProperties {
	...
	public ConnectedProperties(Properties p_i21_1_, String p_i21_2_) {
		ConnectedParser connectedparser = new ConnectedParser("ConnectedTextures");
		this.name = connectedparser.parseName(p_i21_2_);
		this.basePath = connectedparser.parseBasePath(p_i21_2_);
		this.matchBlocks = connectedparser.parseMatchBlocks(p_i21_1_.getProperty("matchBlocks"));
		this.metadatas = connectedparser.parseIntList(p_i21_1_.getProperty("metadata"));
		this.matchTiles = this.parseMatchTiles(p_i21_1_.getProperty("matchTiles"));
		this.method = parseMethod(p_i21_1_.getProperty("method"));
		this.tiles = this.parseTileNames(p_i21_1_.getProperty("tiles"));
		this.connect = parseConnect(p_i21_1_.getProperty("connect"));
		this.faces = parseFaces(p_i21_1_.getProperty("faces"));
		this.biomes = connectedparser.parseBiomes(p_i21_1_.getProperty("biomes"));
		this.minHeight = connectedparser.parseInt(p_i21_1_.getProperty("minHeight"), -1);
		this.maxHeight = connectedparser.parseInt(p_i21_1_.getProperty("maxHeight"), 1024);
		this.renderPass = connectedparser.parseInt(p_i21_1_.getProperty("renderPass"));
		this.innerSeams = ConnectedParser.parseBoolean(p_i21_1_.getProperty("innerSeams"));
		this.width = connectedparser.parseInt(p_i21_1_.getProperty("width"));
		this.height = connectedparser.parseInt(p_i21_1_.getProperty("height"));
		this.weights = connectedparser.parseIntList(p_i21_1_.getProperty("weights"));
		this.symmetry = parseSymmetry(p_i21_1_.getProperty("symmetry"));
	}
	...
	public static IProperty getProperty(String p_getProperty_0_, Collection<IProperty> p_getProperty_1_) {
		for (IProperty iproperty : p_getProperty_1_) {
			if (p_getProperty_0_.equals(iproperty.getName())) { return iproperty; }
		}
	...
	private static TextureAtlasSprite[] registerIcons(String[] p_registerIcons_0_, TextureMap p_registerIcons_1_) {
		if (p_registerIcons_0_ == null) {
			...
			for (String s : p_registerIcons_0_) {
