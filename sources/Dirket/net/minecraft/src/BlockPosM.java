...
public class BlockPosM extends BlockPos {
	...
	public BlockPosM(int p_i3_1_, int p_i3_2_, int p_i3_3_) {
		this(p_i3_1_, p_i3_2_, p_i3_3_, 0);
	}

	public BlockPosM(double p_i4_1_, double p_i4_3_, double p_i4_5_) {
		this(MathHelper.floor_double(p_i4_1_), MathHelper.floor_double(p_i4_3_), MathHelper.floor_double(p_i4_5_));
	}

	public BlockPosM(int p_i5_1_, int p_i5_2_, int p_i5_3_, int p_i5_4_) {
		super(0, 0, 0);
		this.mx = p_i5_1_;
		this.my = p_i5_2_;
		this.mz = p_i5_3_;
