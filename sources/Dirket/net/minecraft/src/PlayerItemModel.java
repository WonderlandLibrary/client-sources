...
public class PlayerItemModel {
	...
	public PlayerItemModel(Dimension p_i58_1_, boolean p_i58_2_, PlayerItemRenderer[] p_i58_3_) {
		this.textureSize = p_i58_1_;
		this.usePlayerTexture = p_i58_2_;
		this.modelRenderers = p_i58_3_;
	}
