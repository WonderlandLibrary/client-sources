...
public class Mipmaps {
	...
	public Mipmaps(String p_i48_1_, int p_i48_2_, int p_i48_3_, int[] p_i48_4_, boolean p_i48_5_) {
		this.iconName = p_i48_1_;
		this.width = p_i48_2_;
		this.height = p_i48_3_;
		this.data = p_i48_4_;
		this.direct = p_i48_5_;
		this.mipmapDimensions = makeMipmapDimensions(p_i48_2_, p_i48_3_, p_i48_1_);
		this.mipmapDatas = generateMipMapData(p_i48_4_, p_i48_2_, p_i48_3_, this.mipmapDimensions);
