...
public class HoverEvent {
	...
	/**
	 * Gets the value to perform the action on when this event is raised. For example, if the action is "show item", this would be the item to show.
	 */
	...
	public boolean equals(Object p_equals_1_) {
		if (this == p_equals_1_) {
			...
			if (this.action != hoverevent.action) {
				...
				if (this.value != null) {
					if (!this.value.equals(hoverevent.value)) { return false; }
				} else if (hoverevent.value != null) { return false; }
