...
public class ShadersTex {
	...
	public static int blend4Alpha(int c0, int c1, int c2, int c3) {
		...
		int l1 = (k1 + 1) / 2;
		int i2 = (j1 << 24) | ((((((c0 >>> 16) & 255) * i) + (((c1 >>> 16) & 255) * j) + (((c2 >>> 16) & 255) * k) + (((c3 >>> 16) & 255) * l) + l1) / k1) << 16)
				| ((((((c0 >>> 8) & 255) * i) + (((c1 >>> 8) & 255) * j) + (((c2 >>> 8) & 255) * k) + (((c3 >>> 8) & 255) * l) + l1) / k1) << 8)
				| ((((((c0 >>> 0) & 255) * i) + (((c1 >>> 0) & 255) * j) + (((c2 >>> 0) & 255) * k) + (((c3 >>> 0) & 255) * l) + l1) / k1) << 0);
		return i2;
	}
	...
	public static int blendColor(int color1, int color2, int factor1) {
		int i = 255 - factor1;
		return ((((((color1 >>> 24) & 255) * factor1) + (((color2 >>> 24) & 255) * i)) / 255) << 24) | ((((((color1 >>> 16) & 255) * factor1) + (((color2 >>> 16) & 255) * i)) / 255) << 16)
				| ((((((color1 >>> 8) & 255) * factor1) + (((color2 >>> 8) & 255) * i)) / 255) << 8) | ((((((color1 >>> 0) & 255) * factor1) + (((color2 >>> 0) & 255) * i)) / 255) << 0);
	}
