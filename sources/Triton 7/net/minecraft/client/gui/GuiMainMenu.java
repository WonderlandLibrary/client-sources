...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
		...
		this.buttonList.add(this.field_175372_K = new GuiButton(69, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2,
				I18n.format("Account Manager", new Object[0])));
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		GlStateManager.popMatrix();
		String var10 = "Triton by Arithmo";

		this.drawString(this.fontRendererObj, var10, 2, this.height - 10, -1);
		String var11 = "Version: " + Triton.VERSION;
