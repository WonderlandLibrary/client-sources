...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handlePlayerListItem(S38PacketPlayerListItem packetIn)
    {
        ...
        while (var2.hasNext())
        {
            ...
            {
                NetworkPlayerInfo var4 = (NetworkPlayerInfo)this.getPlayerInfoMap().get(var3.func_179962_a().getId());
    ...
    {
        return (NetworkPlayerInfo)this.getPlayerInfoMap().get(p_175102_1_);
    }

    public NetworkPlayerInfo func_175104_a(String p_175104_1_)
    {
        Iterator var2 = this.getPlayerInfoMap().values().iterator();
