...
public class CustomFontRenderer {
    ...
    private void renderString(String text, float x, float y2, final int color, final boolean shadow) {
        ...
        final float multiplier = 255 * (shadow ? 4 : 1);
        final Color c2 = new Color(color);
        GlStateManager.color(c2.getRed() / multiplier, c2.getGreen() / multiplier, c2.getBlue() / multiplier, (float) ((color >> 24 & 255) / 255.0));        for (int i = 0; i < length; ++i) {
            int previous;
