...
public class Vec3 {
    ...
    public Vec3 add(double length) {
        return this.addVector(length, length, length);
    }

    public Vec3 scaleVector(double x, double y, double z) {
        return new Vec3(this.xCoord * x, this.yCoord * y, this.zCoord * z);
    }

    public Vec3 scale(Vec3 vec) {
        return scaleVector(vec.xCoord, vec.yCoord, vec.zCoord);
    }

    public Vec3 scale(double length) {
        return scaleVector(length, length, length);
    }
