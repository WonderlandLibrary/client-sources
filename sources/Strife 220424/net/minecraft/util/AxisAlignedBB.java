...
public class AxisAlignedBB {
    ...
    public AxisAlignedBB expand(double length) {
        double d0 = this.minX - length;
        double d1 = this.minY - length;
        double d2 = this.minZ - length;
        double d3 = this.maxX + length;
        double d4 = this.maxY + length;
        double d5 = this.maxZ + length;
        return new AxisAlignedBB(d0, d1, d2, d3, d4, d5);
    }
