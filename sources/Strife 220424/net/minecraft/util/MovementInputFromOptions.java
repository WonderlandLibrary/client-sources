...
import club.strifeclient.module.implementations.player.InventoryMove;
...
public class MovementInputFromOptions extends MovementInput {
    ...
    public void updatePlayerMoveState() {
        ...
        if (Client.INSTANCE.getModuleManager().getModule(InventoryMove.class).isEnabled() && !(Minecraft.getMinecraft().currentScreen instanceof GuiChat)) {
