...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks, ScaledResolution scaledresolution) {
        ...
        this.renderBossHealth(scaledresolution);
        ...
        Client.INSTANCE.getEventBus().call(new Render2DEvent());
    ...
    private float lastHotbarPosition;
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            final float currentHotbarPosition = i - 91 - 1 + entityplayer.inventory.currentItem * 20;
            if (lastItem != entityplayer.inventory.currentItem)
                start = System.currentTimeMillis();
            final float t = Math.min(1, (System.currentTimeMillis() - start) / 400f);

            this.drawTexturedModalRect(i - 91, sr.getScaledHeight() - 22, 0, 0, 182, 22);
            this.drawTexturedModalRect(lastHotbarPosition = InterpolateUtil.interpolateFloat(lastHotbarPosition, currentHotbarPosition, t), sr.getScaledHeight() - 22 - 1, 0, 22, 24, 22);

            lastItem = entityplayer.inventory.currentItem;
    ...
    private void renderBossHealth(ScaledResolution scaledresolution) {
