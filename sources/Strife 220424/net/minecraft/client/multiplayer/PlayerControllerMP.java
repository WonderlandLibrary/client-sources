...
public class PlayerControllerMP {
    ...
    public ItemStack windowClick(int windowId, int slotId, int mouseButtonClicked, int mode, EntityPlayer playerIn) {
        WindowClickEvent windowClickEvent = new WindowClickEvent(windowId, slotId, mouseButtonClicked, mode);
        Client.INSTANCE.getEventBus().call(windowClickEvent);
        if(windowClickEvent.isCancelled()) return null;
        short short1 = playerIn.openContainer.getNextTransactionID(playerIn.inventory);
        ItemStack itemstack = playerIn.openContainer.slotClick(windowClickEvent.slot, windowClickEvent.button, windowClickEvent.mode, playerIn);
        this.netClientHandler.addToSendQueue(new C0EPacketClickWindow(windowClickEvent.window, windowClickEvent.slot, windowClickEvent.button, windowClickEvent.mode, itemstack, short1));
        return itemstack;
    }
