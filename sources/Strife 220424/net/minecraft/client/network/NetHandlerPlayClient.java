...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
        ...
        if (disabler == null)
            disabler = Client.INSTANCE.getModuleManager().getModule(Disabler.class);

//        if (disabler.isEnabled() && disabler.modeSetting.getValue() == Disabler.DisablerMode.WATCHDOG_TIMER && !Client.INSTANCE.getModuleManager().getModule(Scaffold.class).isEnabled()) {
//            this.netManager.sendPacket(new C03PacketPlayer.C04PacketPlayerPosition(entityplayer.posX, entityplayer.getEntityBoundingBox().minY,
//                    entityplayer.posZ, false));
//        } else {
//            this.netManager.sendPacket(new C03PacketPlayer.C06PacketPlayerPosLook(entityplayer.posX, entityplayer.getEntityBoundingBox().minY,
