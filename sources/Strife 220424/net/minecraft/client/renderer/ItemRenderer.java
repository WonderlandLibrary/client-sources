...
import club.strifeclient.module.implementations.visual.Animations;
import club.strifeclient.module.implementations.visual.LowFire;
...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
            ...
            float sqrtPI = MathHelper.sin(MathHelper.sqrt_float(f1) * MathHelper.PI);
            ...
            if (animations == null)
                animations = Client.INSTANCE.getModuleManager().getModule(Animations.class);

            boolean shouldBlock = killAura.getNextTarget() != null;

            if (animations.alwaysTranslate.getValue() && animations.isEnabled())
                GlStateManager.translate(animations.xSetting.getFloat(), animations.ySetting.getFloat(), animations.zSetting.getFloat());

            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof ItemMap) {
                    this.renderItemMap(abstractclientplayer, f2, f, f1);
                } else if (abstractclientplayer.getItemInUseCount() > 0 || shouldBlock) {
                    ...
                    switch (enumAction) {
                        ...
                        case BLOCK:
                            ...
                            if (!animations.isEnabled()) {
                                ...
                                if (!animations.alwaysTranslate.getValue())
                                    GlStateManager.translate(animations.xSetting.getFloat(), animations.ySetting.getFloat(), animations.zSetting.getFloat());

                                switch (animations.modeSetting.getValue()) {
                                    case VANILLA:
                                        this.transformFirstPersonItem(f, 0);
                                        this.doBlockTransformations();
                                        break;
                                    ...
                                    case SMOOTH:
                                        ...
                                        GlStateManager.rotate(-sqrtPI * 140.0F, 8.0F, 0.0F, 8.0F);
                                        GlStateManager.rotate(sqrtPI * 90.0F, 8.0F, 0.0F, 8.0F);
                                        break;
                                    case SWANK:
                                ...
                                if (!animations.alwaysScaleSetting.getValue())
                                    GlStateManager.scale(animations.scaleSetting.getFloat(), animations.scaleSetting.getFloat(), animations.scaleSetting.getFloat());
    ...
    private void renderFireInFirstPerson(float partialTicks) {
        ...
        if (lowFire == null)
            lowFire = Client.INSTANCE.getModuleManager().getModule(LowFire.class);
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            float f8 = f7 + f;
            float f9 = -0.5F;
            GlStateManager.translate((float) (-(i * 2 - 1)) * 0.24F, lowFire.isEnabled() ? -0.55F : -0.3F, 0.0F);
