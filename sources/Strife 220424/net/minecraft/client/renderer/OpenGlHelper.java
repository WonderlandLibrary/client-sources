...
import org.lwjglx.opengl.ARBShaderObjectsx;
import org.lwjglx.opengl.ContextCapabilities;
import org.lwjglx.opengl.GL20x;
...
public class OpenGlHelper {
    ...
    public static void glShaderSource(int shaderIn, ByteBuffer string) {
        if (arbShaders) {
            ARBShaderObjectsx.glShaderSourceARB(shaderIn, string);
        } else {
            GL20x.glShaderSource(shaderIn, string);
        }
    }
