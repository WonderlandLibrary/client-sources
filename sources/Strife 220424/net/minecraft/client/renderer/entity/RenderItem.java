...
import club.strifeclient.module.implementations.visual.GlintColorize;
...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    private GlintColorize glintColorize;
    ...
    private void renderEffect(IBakedModel model) {
        if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
            if (!Config.isShaders() || !Shaders.isShadowPass) {
                ...
                if (glintColorize == null)
                    glintColorize = Client.INSTANCE.getModuleManager().getModule(GlintColorize.class);
                ...
                this.renderModel(model, glintColorize.isEnabled() ? glintColorize.colorSetting.getValue().getRGB() : -8372020);
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                GlStateManager.scale(8.0F, 8.0F, 8.0F);
