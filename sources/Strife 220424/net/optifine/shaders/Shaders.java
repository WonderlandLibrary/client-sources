...
import org.lwjglx.opengl.GL11x;
...
public class Shaders {
    ...
    public static void setCamera(float partialTicks) {
        ...
        GL11x.glGetFloat(GL11.GL_PROJECTION_MATRIX, (FloatBuffer) projection.position(0));
        ...
        GL11x.glGetFloat(GL11.GL_MODELVIEW_MATRIX, (FloatBuffer) modelView.position(0));
    ...
    public static void setCameraShadow(float partialTicks) {
        ...
        GL11x.glGetFloat(GL11.GL_PROJECTION_MATRIX, (FloatBuffer) shadowProjection.position(0));
        ...
        GL11x.glGetFloat(GL11.GL_MODELVIEW_MATRIX, (FloatBuffer) shadowModelView.position(0));
    ...
    public static void postCelestialRotate() {
        ...
        floatbuffer.clear();
        GL11x.glGetFloat(GL11.GL_MODELVIEW_MATRIX, floatbuffer);
