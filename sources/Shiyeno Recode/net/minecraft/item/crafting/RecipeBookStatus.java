...
public final class RecipeBookStatus
{
    ...
    private RecipeBookStatus(Map<RecipeBookCategory, CategoryStatus> p_i241892_1_)
    {
    ...
    public RecipeBookStatus()
    {
        this(Util.make(Maps.newEnumMap(RecipeBookCategory.class), (p_242153_0_) ->
        {
            ...
            {
                p_242153_0_.put(recipebookcategory, new CategoryStatus(false, false));
            }
        }));
    }
    ...
    {
        Map<RecipeBookCategory, CategoryStatus> map = Maps.newEnumMap(RecipeBookCategory.class);

        for (RecipeBookCategory recipebookcategory : RecipeBookCategory.values())
        {
            boolean flag = p_242157_0_.readBoolean();
            boolean flag1 = p_242157_0_.readBoolean();
            map.put(recipebookcategory, new CategoryStatus(flag, flag1));
        }
    ...
    public void func_242161_b(PacketBuffer p_242161_1_)
    {
        for (RecipeBookCategory recipebookcategory : RecipeBookCategory.values())
        {
            CategoryStatus recipebookstatus$categorystatus = this.field_242148_b.get(recipebookcategory);
    ...
    public static RecipeBookStatus func_242154_a(CompoundNBT p_242154_0_)
    {
        ...
        field_242147_a.forEach((p_242156_2_, p_242156_3_) ->
        {
            ...
            map.put(p_242156_2_, new CategoryStatus(flag, flag1));
        });
        return new RecipeBookStatus(map);
    }
    ...
    public void func_242160_b(CompoundNBT p_242160_1_)
    {
        ...
        {
            CategoryStatus recipebookstatus$categorystatus = this.field_242148_b.get(p_242155_2_);
    ...
    public void func_242150_a(RecipeBookStatus p_242150_1_)
    {
        ...
        for (RecipeBookCategory recipebookcategory : RecipeBookCategory.values())
        {
            CategoryStatus recipebookstatus$categorystatus = p_242150_1_.field_242148_b.get(recipebookcategory);
    ...
    static final class CategoryStatus
    {
        ...
        public boolean equals(Object p_equals_1_)
        {
            ...
            else if (!(p_equals_1_ instanceof CategoryStatus))
            {
                return false;
            }
            else
            {
                CategoryStatus recipebookstatus$categorystatus = (CategoryStatus)p_equals_1_;
