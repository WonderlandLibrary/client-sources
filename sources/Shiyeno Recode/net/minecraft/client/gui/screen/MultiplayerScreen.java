...
import wtf.shiyeno.ui.proxy.ProxyUI;
...
public class MultiplayerScreen extends Screen
{
    ...
    private void func_214285_a(boolean p_214285_1_)
    {
        ...
        {
            if (((ServerSelectionList.NormalEntry)serverselectionlist$entry).getServerData().serverIP.equalsIgnoreCase("mc.reallyworld.ru")) {
