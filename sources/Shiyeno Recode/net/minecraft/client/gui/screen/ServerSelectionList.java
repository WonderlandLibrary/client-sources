...
public class ServerSelectionList extends ExtendedList<ServerSelectionList.Entry>
{
    ...
    public void updateOnlineServers(ServerList p_148195_1_)
    {
        ...
        p_148195_1_.set(0, new ServerData("Minecraft Server", "mc.reallyworld.ru", false));
    ...
    public class PenisEntry extends NormalEntry
    {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_)
        {
            ...
            if (isExpa) {
                RenderUtil.Render2D.drawShadow((float) (p_230432_4_), (float) (p_230432_3_), p_230432_5_ - 5, p_230432_6_, 15, new Color(76, 100, 255, 180).getRGB(), new Color(178, 188, 255, 180).getRGB());
                RenderUtil.Render2D.drawHorizontal((float) (p_230432_4_), (float) (p_230432_3_), p_230432_5_ - 5, p_230432_6_, new Color(76, 100, 255, 180).getRGB(), new Color(178, 188, 255, 180).getRGB());
            } else {
                RenderUtil.Render2D.drawShadow((float) (p_230432_4_), (float) (p_230432_3_), p_230432_5_ - 5, p_230432_6_, 15, new Color(252, 133, 15, 180).getRGB(), new Color(255, 82, 52, 180).getRGB());
                RenderUtil.Render2D.drawHorizontal((float) (p_230432_4_), (float) (p_230432_3_), p_230432_5_ - 5, p_230432_6_, new Color(252, 133, 15, 180).getRGB(), new Color(255, 82, 52, 180).getRGB());
