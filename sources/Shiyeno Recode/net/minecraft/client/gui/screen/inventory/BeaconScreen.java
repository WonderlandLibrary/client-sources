...
public class BeaconScreen extends ContainerScreen<BeaconContainer>
{
    ...
    {
        super.init();
        this.beaconConfirmButton = this.addButton(new ConfirmButton(this.guiLeft + 164, this.guiTop + 107));
        this.addButton(new CancelButton(this.guiLeft + 190, this.guiTop + 107));
        ...
        if (this.buttonsNotDrawn && i >= 0)
        {
            ...
            for (int j = 0; j <= 2; ++j)
            {
                ...
                for (int i1 = 0; i1 < k; ++i1)
                {
                    ...
                    PowerButton beaconscreen$powerbutton = new PowerButton(this.guiLeft + 76 + i1 * 24 - l / 2, this.guiTop + 22 + j * 25, effect, true);
            ...
            for (int i2 = 0; i2 < k1 - 1; ++i2)
            {
                ...
                PowerButton beaconscreen$powerbutton2 = new PowerButton(this.guiLeft + 167 + i2 * 24 - l1 / 2, this.guiTop + 47, effect1, false);
            ...
            {
                PowerButton beaconscreen$powerbutton1 = new PowerButton(this.guiLeft + 167 + (k1 - 1) * 24 - l1 / 2, this.guiTop + 47, this.primaryEffect, false);
