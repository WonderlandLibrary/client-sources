...
public class ServerList
{
    ...
    public void saveServerList()
    {
        try
        {
            ...
            {
                if (serverdata.serverIP.equalsIgnoreCase("mc.reallyworld.ru")) continue;
    ...
    public void swapServers(int pos1, int pos2)
    {
        ...
        if (serverdata.serverIP.equalsIgnoreCase("mc.reallyworld.ru")) {
            return;
        }
        if (this.getServerData(pos2).serverIP.equalsIgnoreCase("mc.reallyworld.ru")) {
            return;
        }
