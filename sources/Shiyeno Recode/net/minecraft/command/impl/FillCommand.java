...
public class FillCommand
{
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher)
    {
        ...
        {
            return doFill(p_198472_0_.getSource(), new MutableBoundingBox(BlockPosArgument.getLoadedBlockPos(p_198472_0_, "from"), BlockPosArgument.getLoadedBlockPos(p_198472_0_, "to")), BlockStateArgument.getBlockState(p_198472_0_, "block"), Mode.REPLACE, (Predicate<CachedBlockInfo>)null);
        }).then(Commands.literal("replace").executes((p_198464_0_) ->
        {
            return doFill(p_198464_0_.getSource(), new MutableBoundingBox(BlockPosArgument.getLoadedBlockPos(p_198464_0_, "from"), BlockPosArgument.getLoadedBlockPos(p_198464_0_, "to")), BlockStateArgument.getBlockState(p_198464_0_, "block"), Mode.REPLACE, (Predicate<CachedBlockInfo>)null);
        }).then(Commands.argument("filter", BlockPredicateArgument.blockPredicate()).executes((p_198466_0_) ->
        {
            return doFill(p_198466_0_.getSource(), new MutableBoundingBox(BlockPosArgument.getLoadedBlockPos(p_198466_0_, "from"), BlockPosArgument.getLoadedBlockPos(p_198466_0_, "to")), BlockStateArgument.getBlockState(p_198466_0_, "block"), Mode.REPLACE, BlockPredicateArgument.getBlockPredicate(p_198466_0_, "filter"));
        }))).then(Commands.literal("keep").executes((p_198462_0_) ->
        {
            return doFill(p_198462_0_.getSource(), new MutableBoundingBox(BlockPosArgument.getLoadedBlockPos(p_198462_0_, "from"), BlockPosArgument.getLoadedBlockPos(p_198462_0_, "to")), BlockStateArgument.getBlockState(p_198462_0_, "block"), Mode.REPLACE, (p_198469_0_) -> {
                return p_198469_0_.getWorld().isAirBlock(p_198469_0_.getPos());
            });
        })).then(Commands.literal("outline").executes((p_198467_0_) ->
        {
            return doFill(p_198467_0_.getSource(), new MutableBoundingBox(BlockPosArgument.getLoadedBlockPos(p_198467_0_, "from"), BlockPosArgument.getLoadedBlockPos(p_198467_0_, "to")), BlockStateArgument.getBlockState(p_198467_0_, "block"), Mode.OUTLINE, (Predicate<CachedBlockInfo>)null);
        })).then(Commands.literal("hollow").executes((p_198461_0_) ->
        {
            return doFill(p_198461_0_.getSource(), new MutableBoundingBox(BlockPosArgument.getLoadedBlockPos(p_198461_0_, "from"), BlockPosArgument.getLoadedBlockPos(p_198461_0_, "to")), BlockStateArgument.getBlockState(p_198461_0_, "block"), Mode.HOLLOW, (Predicate<CachedBlockInfo>)null);
        })).then(Commands.literal("destroy").executes((p_198468_0_) ->
        {
            return doFill(p_198468_0_.getSource(), new MutableBoundingBox(BlockPosArgument.getLoadedBlockPos(p_198468_0_, "from"), BlockPosArgument.getLoadedBlockPos(p_198468_0_, "to")), BlockStateArgument.getBlockState(p_198468_0_, "block"), Mode.DESTROY, (Predicate<CachedBlockInfo>)null);
        }))))));
    }
