...
public class TropicalFishEntity extends AbstractGroupFishEntity
{
    ...
    public static final int[] SPECIAL_VARIANTS = new int[] {pack(Type.STRIPEY, DyeColor.ORANGE, DyeColor.GRAY), pack(Type.FLOPPER, DyeColor.GRAY, DyeColor.GRAY), pack(Type.FLOPPER, DyeColor.GRAY, DyeColor.BLUE), pack(Type.CLAYFISH, DyeColor.WHITE, DyeColor.GRAY), pack(Type.SUNSTREAK, DyeColor.BLUE, DyeColor.GRAY), pack(Type.KOB, DyeColor.ORANGE, DyeColor.WHITE), pack(Type.SPOTTY, DyeColor.PINK, DyeColor.LIGHT_BLUE), pack(Type.BLOCKFISH, DyeColor.PURPLE, DyeColor.YELLOW), pack(Type.CLAYFISH, DyeColor.WHITE, DyeColor.RED), pack(Type.SPOTTY, DyeColor.WHITE, DyeColor.YELLOW), pack(Type.GLITTER, DyeColor.WHITE, DyeColor.GRAY), pack(Type.CLAYFISH, DyeColor.WHITE, DyeColor.ORANGE), pack(Type.DASHER, DyeColor.CYAN, DyeColor.PINK), pack(Type.BRINELY, DyeColor.LIME, DyeColor.LIGHT_BLUE), pack(Type.BETTY, DyeColor.RED, DyeColor.WHITE), pack(Type.SNOOPER, DyeColor.GRAY, DyeColor.RED), pack(Type.BLOCKFISH, DyeColor.RED, DyeColor.WHITE), pack(Type.FLOPPER, DyeColor.WHITE, DyeColor.YELLOW), pack(Type.KOB, DyeColor.RED, DyeColor.WHITE), pack(Type.SUNSTREAK, DyeColor.GRAY, DyeColor.WHITE), pack(Type.DASHER, DyeColor.CYAN, DyeColor.YELLOW), pack(Type.FLOPPER, DyeColor.YELLOW, DyeColor.YELLOW)};
    ...
    static class TropicalFishData extends GroupData
    {
