...
public class MooshroomEntity extends CowEntity implements IShearable
{
    ...
    public ActionResultType func_230254_b_(PlayerEntity p_230254_1_, Hand p_230254_2_)
    {
        ...
        else if (this.getMooshroomType() == Type.BROWN && itemstack.getItem().isIn(ItemTags.SMALL_FLOWERS))
        {
            if (this.hasStewEffect != null)
            {
                for (int i = 0; i < 2; ++i)
    ...
    private Type func_213445_a(MooshroomEntity p_213445_1_)
    {
        ...
        Type mooshroomentity$type1 = p_213445_1_.getMooshroomType();
        Type mooshroomentity$type2;

        if (mooshroomentity$type == mooshroomentity$type1 && this.rand.nextInt(1024) == 0)
        {
            mooshroomentity$type2 = mooshroomentity$type == Type.BROWN ? Type.RED : Type.BROWN;
        }
        else
        {
    ...
    public static enum Type
    {
        ...
        {
            for (Type mooshroomentity$type : values())
            {
