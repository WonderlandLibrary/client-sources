...
import wtf.shiyeno.modules.impl.movement.SprintFunction;
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag5) {
                        if (i > 0) {
                            ...
                            if (sprintFunction.state && Managment.FUNCTION_MANAGER.auraFunction != null && this instanceof ClientPlayerEntity) {
