...
public class WeightedList<U>
{
    ...
    {
        return Entry.<U>func_234008_a_(p_234002_0_).listOf().xmap(WeightedList::new, (p_234001_0_) ->
        {
    ...
    {
        this.field_220658_a.add(new Entry(p_226313_1_, p_226313_2_));
        return this;
    }
        ...
        public static <E> Codec<Entry<E>> func_234008_a_(final Codec<E> p_234008_0_)
        {
            return new Codec<Entry<E>>()
            {
                public <T> DataResult<Pair<Entry<E>, T>> decode(DynamicOps<T> p_decode_1_, T p_decode_2_)
                {
                    ...
                    {
                        return new Entry(p_234012_1_, dynamic.get("weight").asInt(1));
                    }).map((p_234013_1_) ->
                    {
