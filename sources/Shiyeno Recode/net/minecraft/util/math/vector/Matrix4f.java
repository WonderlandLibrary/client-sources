...
public final class Matrix4f
{
    ...
    public double getTransformX(double p_getTransformX_1_, double p_getTransformX_2_, double p_getTransformX_3_, double p_getTransformX_4_)
    {
        return this.m00 * p_getTransformX_1_ + this.m01 * p_getTransformX_2_ + this.m02 * p_getTransformX_3_ + this.m03 * p_getTransformX_4_;
    }
    ...
    public double getTransformY(double p_getTransformY_1_, double p_getTransformY_2_, double p_getTransformY_3_, double p_getTransformY_4_)
    {
        return this.m10 * p_getTransformY_1_ + this.m11 * p_getTransformY_2_ + this.m12 * p_getTransformY_3_ + this.m13 * p_getTransformY_4_;
    }
    ...
    public double getTransformZ(double p_getTransformZ_1_, double p_getTransformZ_2_, double p_getTransformZ_3_, double p_getTransformZ_4_)
    {
        return this.m20 * p_getTransformZ_1_ + this.m21 * p_getTransformZ_2_ + this.m22 * p_getTransformZ_3_ + this.m23 * p_getTransformZ_4_;
    }
