...
import wtf.shiyeno.modules.impl.util.ClientSounds;
import wtf.shiyeno.modules.settings.Configurable;
...
public abstract class Function extends Configurable implements IMinecraft {
    ...
    public void toggle() {
        ...
        if (!state)
            ...
            onEnable();
        Managment.NOTIFICATION_MANAGER.add(name + " was " + (state ? TextFormatting.GREEN + "enabled" : TextFormatting.RED + "disabled"), "Function Debug",2);
