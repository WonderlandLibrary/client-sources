...
import wtf.shiyeno.ui.beta.component.ColorThemeWindow;
...
public class ThemeComponent extends Component {
    ...
    public ThemeComponent(Style config) {
        ...
        if (config.name.equalsIgnoreCase("Авалон")) {
            colors[0] = new ColorThemeWindow(new Color(StyleManager.HexColor.toColor("#00C4FFFF")), new Vector4f(0, 0, 0, 0));
            colors[1] = new ColorThemeWindow(new Color(StyleManager.HexColor.toColor("#00FF96FF")), new Vector4f(0, 0, 0, 0));
        }
    }
