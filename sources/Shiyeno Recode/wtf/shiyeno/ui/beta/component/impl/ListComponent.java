    ...
    public void drawComponent(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        if (opened) {
            ...
            for (BooleanOption s : option.options) {
                ...
                Fonts.gilroy[14].drawString(matrixStack, s.getName(), x + 9 + s.anim, y + off + 23.5F + i , option.get(s.getName()) ? ColorUtil.getColorStyle(90) : new Color(163, 176, 188).getRGB());
                i += 9;
            }
            height += 3;
        }
