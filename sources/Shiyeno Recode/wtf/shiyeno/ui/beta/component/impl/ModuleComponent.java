...
import wtf.shiyeno.ui.beta.ClickGui;
...
import static wtf.shiyeno.util.render.RenderUtil.reAlphaInt;

public class ModuleComponent extends wtf.shiyeno.ui.beta.component.impl.Component {

    public Function function;

    public List<wtf.shiyeno.ui.beta.component.impl.Component> components = new ArrayList<>();
    ...
    public void drawComponent(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        float totalHeight = 2;
        for (wtf.shiyeno.ui.beta.component.impl.Component component : components) {
        ...
        int color = ColorUtil.interpolateColor(RenderUtil.IntColor.rgba(32, 35, 57, 240), ColorUtil.getColorStyle(90), animationToggle);
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        if (binding == this && mouseButton > 2) {
            ...
            Managment.NOTIFICATION_MANAGER.add("Module " + TextFormatting.GRAY + binding.function.name + TextFormatting.WHITE + " was keyed " + ClientUtil.getKey(-100 + mouseButton), "Module Info", 2);
            binding = null;
        }
