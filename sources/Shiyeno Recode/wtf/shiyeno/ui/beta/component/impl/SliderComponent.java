...
public class SliderComponent extends Component {
    ...
    public void drawComponent(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        RenderUtil.Render2D.drawShadow(x + 6, y + 14, anim, 3, 8, ColorUtil.getColorStyle(90));

        RenderUtil.Render2D.drawRoundedCorner(x + 6, y + 13, anim, 3, new Vector4f(2,2,option.getMax() == option.getValue().floatValue() ? 2 : 0,option.getMax() == option.getValue().floatValue() ? 2 : 0), ColorUtil.getColorStyle(90));

        RenderUtil.Render2D.drawRoundCircle(x + 5 + anim, y + 14.5f, 10, new Color(17, 18, 21).getRGB());
        RenderUtil.Render2D.drawRoundCircle(x + 5 + anim, y + 14.5f, 8, ColorUtil.getColorStyle(90));
