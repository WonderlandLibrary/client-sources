...
public class ClientUtil implements IMinecraft {
    ...
    private static final String discordID = "1258102407192248342";
    ...
    public static String getKey(int integer) {
        if (integer < 0) {
            ...
            return KeyMappings.reverseKeyMap.get(integer);
        }
    }

    static IPCClient client = new IPCClient(1258102407192248342L);
    ...
    public static void startRPC() {
        ...
        client.setListener(new IPCListener(){
            ...
            public void onReady(IPCClient client)
            {
                ...
                builder.setDetails("Username: " + Managment.USER_PROFILE.getName())
                        .setState("UID: " + Managment.USER_PROFILE.getUid())
                        .setStartTimestamp(OffsetDateTime.now())

                        .setLargeImage("https://i.postimg.cc/C5f3KWN8/photo-2024-05-28-13-20-13.jpg", "shiyeno.ru");
    ...
    public static void sendMesage(String message) {
        ...
        mc.player.sendMessage(gradient("Shiyeno", new java.awt.Color(90, 105, 255).getRGB(), new java.awt.Color(245, 98, 255).getRGB()).append(new StringTextComponent(TextFormatting.DARK_GRAY + " -> " + TextFormatting.RESET + message)), Util.DUMMY_UUID);
    }
