...
public class ColorUtil implements IMinecraft {
    ...
    public static int rainbow(int speed, int offset, float saturation, float brightness, float alpha) {
        int angle = (int) ((System.currentTimeMillis() / speed + offset) % 360);
    ...
    public static int getColorStyle(float index) {
        if(Managment.STYLE_MANAGER == null)
            return -1;
    ...
    public static int setAlpha(int colorStyle, int i) {
        return 0;
    }
}