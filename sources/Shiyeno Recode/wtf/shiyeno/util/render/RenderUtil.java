package wtf.shiyeno.util.render;
...
import wtf.shiyeno.modules.impl.util.Optimization;
...
import static wtf.shiyeno.util.render.RenderUtil.IntColor.*;
import static wtf.shiyeno.util.render.ShaderUtil.*;
...
public class RenderUtil implements IMinecraft {
    ...
    public static class Render2D {
        ...
        public static void drawTransparentGradient(float x, float y, float width, float height, int color, float alphaMod) {
            var alphaStep = 255 / width;
            for(var i = 0; i < width; i++) {
                drawRect(x + width - i, y, 1, height, reAlphaInt(color, (int)(alphaMod * (255 - alphaStep * i))));
            }
        }
        ...
        public static void drawFace(float d,
            ...
            try {
                ...
                mc.getTextureManager().bindTexture(skin);
                float hurtPercent = getHurtPercent(target);
                GL11.glColor4f(1, 1 - hurtPercent, 1 - hurtPercent, alpha);
                AbstractGui.drawScaledCustomSizeModalRect(d, y, u, v, uWidth, vHeight, width, height, tileWidth, tileHeight);
                GL11.glColor4f(1, 1, 1, 1);
                GL11.glPopMatrix();
            } catch (Exception e) {
