...
public class Rotation {
     ...
     */
    public float getYaw() {
        return GCDUtil.getSensitivity((float) (this.yaw + ThreadLocalRandom.current().nextFloat(-0.1f, 0.1f)));
    }
    ...
    public float getPitch() {
        return GCDUtil.getSensitivity(MathHelper.clamp((float) (this.pitch + ThreadLocalRandom.current().nextFloat(-0.1f, 0.1f)), -90,90));
    }
