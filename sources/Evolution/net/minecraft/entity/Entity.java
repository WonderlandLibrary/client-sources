    ...
    public void move(MoverType type, double x, double y, double z)
    {
        ...
        else
        {
            ...
            if (this instanceof EntityPlayerSP) {
                double bpMX = posX, bpMY = posY, bpMZ = posZ;
                double predictX = posX, predictY = posY, predictZ = posZ;
                if (y != 0.0D) {
                    int k = 0;
                    for (int l = list1.size(); k < l; ++k) {
                        y = ((AxisAlignedBB) list1.get(k)).calculateYOffset(this.getEntityBoundingBox(),
                                y);
                    }
                    predictY = predictY + y;
                }
                ...
                if (x != 0.0D) {
                    ...
                    for (int l5 = list1.size(); j5 < l5; ++j5) {
                        x = ((AxisAlignedBB) list1.get(j5)).calculateXOffset(this.getEntityBoundingBox(),
                                x);
                    }
                ...
                if (z != 0.0D) {
                    ...
                    for (int i6 = list1.size(); k5 < i6; ++k5) {
                        z = ((AxisAlignedBB) list1.get(k5)).calculateZOffset(this.getEntityBoundingBox(),
                                z);
                    }
