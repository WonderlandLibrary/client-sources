...
public abstract class EntityLivingBase extends Entity
{
    ...
    public int getMaxTotalArmorValue()
    {
        IAttributeInstance iattributeinstance = this.getEntityAttribute(SharedMonsterAttributes.ARMOR);
        return MathHelper.floor(iattributeinstance.getBaseValue());
    }
    ...
    {
        if (Main.m.getModule(SwingAnimation.class).state) {
            return (int) ((SwingAnimation) Main.m.getModule(SwingAnimation.class)).mult.get();
        }
        else {
    ...
    public int getItemInUseDuration() {
        return isActiveItemStackBlocking() ? (this.activeItemStack.getMaxItemUseDuration() - this.getItemInUseCount()) : 0;
    }
}
