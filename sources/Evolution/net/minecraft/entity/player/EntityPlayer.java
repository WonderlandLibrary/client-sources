...
import wtf.evolution.helpers.render.Simulation;
...
public abstract class EntityPlayer extends EntityLivingBase implements CapeHolder
{
    ...
    private final Simulation stickSimulation;
    ...
    public EntityPlayer(World worldIn, GameProfile gameProfileIn)
    {
        ...
        this.stickSimulation = new Simulation();
    ...
    public Animation a = new EaseInOutQuad(100, 1);
    public float getEyeHeight()
    {
        ...
        a.setDirection(isSneaking() ? Direction.FORWARDS : Direction.BACKWARDS);
        f -= a.getOutput() * 0.05;
        return f;
    }
