...
public abstract class BlockRailBase extends Block
{
    ...
    {
        EnumRailDirection blockrailbase$enumraildirection = state.getBlock() == this ? (EnumRailDirection)state.getValue(this.getShapeProperty()) : null;
    ...
    public class Rail
    {
        ...
        public Rail(World worldIn, BlockPos pos, IBlockState state)
        {
            ...
            EnumRailDirection blockrailbase$enumraildirection = (EnumRailDirection)state.getValue(this.block.getShapeProperty());
