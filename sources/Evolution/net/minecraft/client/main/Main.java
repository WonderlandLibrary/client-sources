...
import wtf.evolution.protect.Protection;
...
public class Main
{
    ...
    public static void main(String[] p_main_0_)
    {
        ...
        OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo(RandomStringUtils.randomAlphabetic(8));
