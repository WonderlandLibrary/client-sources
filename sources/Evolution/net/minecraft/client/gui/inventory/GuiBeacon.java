        ...
        if (this.buttonsNotDrawn && i >= 0)
        {
            ...
            for (int k = 0; k <= 2; ++k)
            {
                ...
                for (int j1 = 0; j1 < l; ++j1)
                {
                    ...
                    if (k >= i)
                    {
                        guibeacon$powerbutton.enabled = Main.m.getModule(BeaconExploit.class).state;
                    }
            ...
            for (int j2 = 0; j2 < l1 - 1; ++j2)
            {
                ...
                PowerButton guibeacon$powerbutton2 = new PowerButton(j++, this.guiLeft + 167 + j2 * 24 - i2 / 2, this.guiTop + 47, potion3, 4);
                this.buttonList.add(guibeacon$powerbutton2);

                if (3 >= i)
                {
                    guibeacon$powerbutton2.enabled = Main.m.getModule(BeaconExploit.class).state;
                }
            ...
            if (potion != null)
            {
                ...
                if (3 >= i)
                {
                    guibeacon$powerbutton1.enabled = Main.m.getModule(BeaconExploit.class).state;
                }
