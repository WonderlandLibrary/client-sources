...
public class GuiInventory extends InventoryEffectRenderer implements IRecipeShownListener
{
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        RenderUtil.drawRectWH(guiLeft + 5, guiTop, this.xSize - 10, this.ySize, new Color(0,0,0,128).getRGB());
        StencilUtil.readStencilBuffer(2);
        RenderUtil.drawBlurredShadow(guiLeft, guiTop, this.xSize, this.ySize, 15, new Color(0,0,0, 255));
