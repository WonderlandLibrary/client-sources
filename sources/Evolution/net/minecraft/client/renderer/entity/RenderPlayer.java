...
public class RenderPlayer extends RenderLivingBase<AbstractClientPlayer>
{
    ...
    public RenderPlayer(RenderManager renderManager, boolean useSmallArms)
    {
        ...
        this.addLayer(new LayerCape(this, getMainModel()));
    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        {
            if (RenderUtil.isInViewFrustrum(entity) && Main.m.getModule("Optimizer").state && ((Optimizer) Main.m.getModule("Optimizer")).entities.get()) {
                double d0 = y;
                ...
                if (Main.m.getModule(Chams.class).state) {
            ...
            } else if (!Main.m.getModule("Optimizer").state) {
                double d0 = y;
                ...
                if (Main.m.getModule(Chams.class).state) {
                    ...
                    super.doRender(entity, x, d0, z, entityYaw, partialTicks);
                GlStateManager.disableBlendProfile(GlStateManager.Profile.PLAYER_SKIN);
            } else if (!((Optimizer) Main.m.getModule("Optimizer")).entities.get()){
                double d0 = y;
