...
public class FaceBakery
{
    ...
    public BakedQuad makeBakedQuad(Vector3f posFrom, Vector3f posTo, BlockPartFace face, TextureAtlasSprite sprite, EnumFacing facing, ITransformation p_makeBakedQuad_6_, BlockPartRotation partRotation, boolean p_makeBakedQuad_8_, boolean p_makeBakedQuad_9_)
    {
        ...
        int[] aint = this.makeQuadVertexData(blockfaceuv, sprite, facing, this.getPositionsDiv16(posFrom, posTo), p_makeBakedQuad_6_, partRotation, flag);
