...
public class ColorUtil {
    ...
    public static Color applyColor(String mode, int index, int color, int alhpa) {
        if (mode.equalsIgnoreCase("Static")) {
            ...
            return ColorUtil.fade(10, index * 2, new Color(color), alhpa / 255f);
        }
        else if (mode.equalsIgnoreCase("Astolfo")) {
            return new Color(RenderUtil.setAlpha(FeatureList.astolfo(1, index / 2f, 0.5f, 10), alhpa));
        }
        else if (mode.equalsIgnoreCase("Rainbow")) {
            return ColorUtil.rainbow(10, index, 0.5f, 1, alhpa / 255f);
        }
        return Color.WHITE;
    }
