...
import static wtf.evolution.Main.protectedd;
...
extends CFont {
    ...
    public void drawStringWithDropShadow(String text, float x, float y,int color) {
        ...
        this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, (float) x, (float) y, color);
    }
    public float drawString(String text, float x, float y, int color) {
        return this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x, y, color, false);
    }
    ...
    public float drawStringWithShadow(String text, float x, float y, int color) {
        float shadowWidth = this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, (double)x + 0.5, (double)y + 0.5, color, true);
        return Math.max(shadowWidth, this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x, y, color, false));
    }

    public float drawStringWithShadow(String text, double x, double y, int color) {
        float shadowWidth = this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x + 0.5, y + 0.5, color, true);
        return Math.max(shadowWidth, this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x, y, color, false));
    }

    public float drawCenteredString(String text, float x, float y, int color) {
        return this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x - (float)this.getStringWidth(protectedd ? RandomStringUtils.randomAlphabetic(16) : text) / 2.0f, y, color);
    }
    public void drawCenteredBlurredString(String text, double x, double y, int blurRadius, Color blurColor, int color) {
        RenderUtil.drawBlurredShadow((int) ((int) x - (float)this.getStringWidth(protectedd ? RandomStringUtils.randomAlphabetic(16) : text) / 2.0f), (int) y -0.5f, (int) getStringWidth(protectedd ? RandomStringUtils.randomAlphabetic(16) : text), (int) getFontHeight(), blurRadius, blurColor);
        drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x - (float)this.getStringWidth(protectedd ? RandomStringUtils.randomAlphabetic(16) : text) / 2.0f, y, color);
    }
    public float drawCenteredString(String text, double x, double y, int color) {
        return this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x - (double)((float)this.getStringWidth(protectedd ? RandomStringUtils.randomAlphabetic(16) : text) / 2.0f), y, color);
    }

    public float drawCenteredStringWithShadow(String text, float x, float y, int color) {
        this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, (double)(x - (float)this.getStringWidth(protectedd ? RandomStringUtils.randomAlphabetic(16) : text) / 2.0f) + 0.45, (double)y + 0.5, color, true);
        return this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x - (float)this.getStringWidth(protectedd ? RandomStringUtils.randomAlphabetic(16) : text) / 2.0f, y, color);
    }

    public void drawStringWithOutline(String text, double x, double y, int color) {
        this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x - 0.5, y, 0);
        this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x + 0.5, y, 0);
        this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x, y - 0.5, 0);
        this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x, y + 0.5, 0);
        this.drawString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x, y, color);
    }

    public void drawCenteredStringWithOutline(String text, double x, double y, int color) {
        this.drawCenteredString(ChatFormatting.stripFormatting(protectedd ? RandomStringUtils.randomAlphabetic(16) : text), x - 0.5, y, 0);
        this.drawCenteredString(ChatFormatting.stripFormatting(protectedd ? RandomStringUtils.randomAlphabetic(16) : text), x + 0.5, y, 0);
        this.drawCenteredString(ChatFormatting.stripFormatting(protectedd ? RandomStringUtils.randomAlphabetic(16) : text), x, y - 0.5, 0);
        this.drawCenteredString(ChatFormatting.stripFormatting(protectedd ? RandomStringUtils.randomAlphabetic(16) : text), x, y + 0.5, 0);
        this.drawCenteredString(protectedd ? RandomStringUtils.randomAlphabetic(16) : text, x, y, color);
    }

    public float drawCenteredStringWithShadow(String text, double x, double y, int color) {
        this.drawString(protectedd ? "dead" : text, x - (double)((float)this.getStringWidth(protectedd ? "dead" : text) / 2.0f) + 0.45, y + 0.5, color, true);
        return this.drawString(protectedd ? "dead" : text, x - (double)((float)this.getStringWidth(protectedd ? "dead" : text) / 2.0f), y, color);
    }
    ...
    public int getStringWidth(String text1) {
        text1 = protectedd ? RandomStringUtils.randomAlphabetic(16) : text1;
            if (text1 == null) {
                return 0;
            }
