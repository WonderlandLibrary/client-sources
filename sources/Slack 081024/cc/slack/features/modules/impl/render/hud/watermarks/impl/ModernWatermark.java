...
public class ModernWatermark implements IWatermarks {
    ...
    private void drawBackgroundedText(String fontName, int themeColor, int whiteColor, int backgroundColor, boolean rounded) {
        ...
        int width1 = Fonts.sfRoundedBold20.getStringWidth(text1);
        int width2 = Fonts.sfRoundedRegular20.getStringWidth(text2);
        int width3 = Fonts.sfRoundedRegular18.getStringWidth(text3);
        int width4 = Fonts.sfRoundedRegular18.getStringWidth(text4);
        int width5 = Fonts.sfRoundedRegular18.getStringWidth(text5);
        int width6 = Fonts.sfRoundedRegular18.getStringWidth(text6);
        ...
        int textX = rectX + 4;
        int textY = rectY + 5;
        Fonts.sfRoundedBold20.drawStringWithShadow(text1, textX, textY, themeColor);
        textX += width1 + 1;
        Fonts.sfRoundedRegular20.drawStringWithShadow(text2, textX, textY, whiteColor);
        textX += width2 + 1;
        Fonts.sfRoundedRegular18.drawStringWithShadow(text3, textX, textY, whiteColor);
        textX += width3 + 1;
        Fonts.sfRoundedRegular18.drawStringWithShadow(text4, textX, textY, whiteColor);
        textX += width4 + 1;
        Fonts.sfRoundedRegular18.drawStringWithShadow(text5, textX, textY, whiteColor);
        textX += width5 + 1;
        Fonts.sfRoundedRegular18.drawStringWithShadow(text6, textX, textY, whiteColor);
