...
public class EntityFishHook extends Entity
{
    ...
    public void handleHookCasting(double p_146035_1_, double p_146035_3_, double p_146035_5_, float p_146035_7_, float p_146035_8_)
    {
        ...
        this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.func_181159_b(p_146035_3_, f1) * 180.0D / Math.PI);
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (!this.inGround)
            {
                ...
                for (this.rotationPitch = (float)(MathHelper.func_181159_b(this.motionY, f5) * 180.0D / Math.PI); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F)
                {
                    ;
                }
