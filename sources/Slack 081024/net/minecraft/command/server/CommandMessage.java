    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                chatcomponenttranslation.getChatStyle().setColor(ChatFormatting.GRAY).setItalic(Boolean.TRUE);
                chatcomponenttranslation1.getChatStyle().setColor(ChatFormatting.GRAY).setItalic(Boolean.TRUE);
