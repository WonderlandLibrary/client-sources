        ...
        else
        {
            ...
            if (i - this.systemTime >= 100L)
            {
                ...
                if (flag)
                {
                    ...
                    this.mc.MCfontRenderer.drawStringWithShadow(this.currentlyDisplayedText, (float)((k - this.mc.MCfontRenderer.getStringWidth(this.currentlyDisplayedText)) / 2), (float)(l / 2 - 4 - 16), 16777215);
                    this.mc.MCfontRenderer.drawStringWithShadow(this.message, (float)((k - this.mc.MCfontRenderer.getStringWidth(this.message)) / 2), (float)(l / 2 - 4 + 8), 16777215);
                }
