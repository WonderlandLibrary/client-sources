...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn)
    {
        ...
        this.gameController.thePlayer.ticksSinceLastTeleport = 0;
    ...
    public void handleChangeGameState(S2BPacketChangeGameState packetIn)
    {
        ...
        {
            this.clientWorldController.setRainStrength(Math.max(0, Math.min(2, f)));
        }
        else if (i == 8)
        {
            this.clientWorldController.setThunderStrength(Math.max(0, Math.min(2, f)));
        }
        else if (i == 10)
        {
    ...
    public static boolean validateResourcePackUrl(NetHandlerPlayClient client, S48PacketResourcePackSend packet) {
        try {
            ...
            if (isLevelProtocol && (url.contains("..") || !url.endsWith("/resources.zip"))) {
                ...
                if (player != null) {
                    player.addChatMessage(new ChatComponentText(ChatFormatting.RED + ChatFormatting.BOLD.toString() +
    ...
    public void handleResourcePack(S48PacketResourcePackSend packetIn)
    {
        ...
        // TODO: Validate Pack To Pervent Exploit To See Files
