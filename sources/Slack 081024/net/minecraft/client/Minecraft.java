...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void displayDebugInfo(long elapsedTicksTime)
    {
        if (this.mcProfiler.profilingEnabled)
        {
            ...
            int l2 = 16777215;
            this.MCfontRenderer.drawStringWithShadow(s, (float)(j - i), (float)(k - i / 2 - 16), l2);
            this.MCfontRenderer.drawStringWithShadow(s = decimalformat.format(profiler$result.field_76330_b) + "%", (float)(j + i - this.MCfontRenderer.getStringWidth(s)), (float)(k - i / 2 - 16), l2);
