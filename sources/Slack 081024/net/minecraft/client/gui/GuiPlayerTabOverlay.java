...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        {
            int k = this.mc.MCfontRenderer.getStringWidth(this.getPlayerName(networkplayerinfo));
            i = Math.max(i, k);

            if (scoreObjectiveIn != null && scoreObjectiveIn.getRenderType() != IScoreObjectiveCriteria.EnumRenderType.HEARTS)
            {
                k = this.mc.MCfontRenderer.getStringWidth(" " + scoreboardIn.getValueFromObjective(networkplayerinfo.getGameProfile().getName(), scoreObjectiveIn).getScorePoints());
                j = Math.max(j, k);
            }
        }
        ...
        if (this.header != null)
        {
            ...
            for (String s : list1)
            {
                l1 = Math.max(l1, this.mc.MCfontRenderer.getStringWidth(s));
            }
        }
        ...
        if (this.footer != null)
        {
            ...
            for (String s2 : list2)
            {
                l1 = Math.max(l1, this.mc.MCfontRenderer.getStringWidth(s2));
            }
        }
        ...
        if (list1 != null)
        {
            ...
            for (String s3 : list1)
            {
                int i2 = this.mc.MCfontRenderer.getStringWidth(s3);
                this.mc.MCfontRenderer.drawStringWithShadow(s3, (float)(width / 2 - i2 / 2), (float)k1, -1);
                k1 += this.mc.MCfontRenderer.FONT_HEIGHT;
            }
        ...
        if (list2 != null)
        {
            ...
            for (String s4 : list2)
            {
                int j5 = this.mc.MCfontRenderer.getStringWidth(s4);
