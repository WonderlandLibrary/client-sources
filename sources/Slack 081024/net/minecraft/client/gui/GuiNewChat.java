...
public class GuiNewChat extends Gui
{
    ...
    public void drawChat(int p_146230_1_)
    {
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN)
        {
            ...
            if (k > 0)
            {
                ...
                if (flag)
                {
                    int k2 = this.mc.MCfontRenderer.FONT_HEIGHT;
    ...
    private void setChatLine(IChatComponent p_146237_1_, int p_146237_2_, int p_146237_3_, boolean p_146237_4_)
    {
        ...
        List<IChatComponent> list = GuiUtilRenderComponents.func_178908_a(p_146237_1_, i, this.mc.MCfontRenderer, false, false);
    ...
    public IChatComponent getChatComponent(int p_146236_1_, int p_146236_2_)
    {
        if (this.getChatOpen()) {
            ...
            if (j >= 0 && k >= 0) {
                ...
                if (j <= MathHelper.floor_float((float) this.getChatWidth() / this.getChatScale()) && k < this.mc.MCfontRenderer.FONT_HEIGHT * l + l) {
                    int i1 = k / this.mc.MCfontRenderer.FONT_HEIGHT + this.scrollPos;
                    ...
                    if (i1 >= 0 && i1 < this.field_146253_i.size()) {
                        ...
                        for (IChatComponent ichatcomponent : chatline.getChatComponent()) {
                            if (ichatcomponent instanceof ChatComponentText) {
                                j1 += this.mc.MCfontRenderer.getStringWidth(GuiUtilRenderComponents.func_178909_a(((ChatComponentText) ichatcomponent).getChatComponentText_TextValue(), false));
