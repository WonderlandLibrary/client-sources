...
public class GuiWinGame extends GuiScreen
{
    ...
    public void initGui()
    {
        if (this.field_146582_i == null)
        {
            ...
            {
                String s = "";
                String s1 = "" + ChatFormatting.WHITE + ChatFormatting.OBFUSCATED + ChatFormatting.GREEN + ChatFormatting.AQUA;
                int i = 274;
                ...
                while ((s = bufferedreader.readLine()) != null)
                {
                    ...
                    for (s = s.replaceAll("PLAYERNAME", this.mc.getSession().getUsername()); s.contains(s1); s = s2 + ChatFormatting.WHITE + ChatFormatting.OBFUSCATED + "XXXXXXXX".substring(0, random.nextInt(4) + 3) + s3)
                    {
                        int j = s.indexOf(s1);
                        s2 = s.substring(0, j);
                    ...
                    this.field_146582_i.addAll(this.mc.MCfontRenderer.listFormattedStringToWidth(s, i));
    ...
    private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_)
    {
        ...
        f3 = f3 * f3;
        f3 = f3 * 96.0F / 255.0F;
        worldrenderer.pos(0.0D, this.height, this.zLevel).tex(0.0D, f * f2).func_181666_a(f3, f3, f3, 1.0F).endVertex();
        worldrenderer.pos(i, this.height, this.zLevel).tex((float)i * f2, f * f2).func_181666_a(f3, f3, f3, 1.0F).endVertex();
        worldrenderer.pos(i, 0.0D, this.zLevel).tex((float)i * f2, f1 * f2).func_181666_a(f3, f3, f3, 1.0F).endVertex();
        worldrenderer.pos(0.0D, 0.0D, this.zLevel).tex(0.0D, f1 * f2).func_181666_a(f3, f3, f3, 1.0F).endVertex();
        tessellator.draw();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        int k1 = this.height;
        worldrenderer.begin(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.pos(0.0D, k1, this.zLevel).tex(0.0D, 1.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
        worldrenderer.pos(j1, k1, this.zLevel).tex(1.0D, 1.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
        worldrenderer.pos(j1, 0.0D, this.zLevel).tex(1.0D, 0.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
        worldrenderer.pos(0.0D, 0.0D, this.zLevel).tex(0.0D, 0.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
        tessellator.draw();
