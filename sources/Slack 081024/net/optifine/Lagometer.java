...
public class Lagometer
{
    ...
    public static void updateLagometer()
    {
        ...
        if (gameSettings.showDebugProfilerChart && (gameSettings.ofLagometer || gameSettings.field_181657_aC))
        {
            active = true;
    ...
    public static void showLagometer(ScaledResolution scaledResolution)
    {
        if (gameSettings != null)
        {
            if (gameSettings.ofLagometer || gameSettings.field_181657_aC)
            {
                ...
                mc.MCfontRenderer.drawString("30", 2, k2 + 1, -8947849);
                mc.MCfontRenderer.drawString("30", 1, k2, -3881788);
                mc.MCfontRenderer.drawString("60", 2, j2 + 1, -8947849);
                mc.MCfontRenderer.drawString("60", 1, j2, -3881788);
                GlStateManager.matrixMode(5889);
                ...
                mc.MCfontRenderer.drawString(" " + MemoryMonitor.getAllocationRateMb() + " MB/s", l1, i2, k1);
