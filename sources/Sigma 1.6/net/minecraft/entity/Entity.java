...
public abstract class Entity implements ICommandSender
{
    ...
    public void onEntityUpdate()
    {
      ...
      func_174830_Y();
      if ((!((Module)Client.getModuleManager().get(NoSlowdown.class)).isEnabled()) || (!PlayerUtil.isInLiquid())) {
        handleWaterMovement();
      }
    ...
    public void moveEntity(double x, double y, double z) {
        if(this.noClip) {
           ...
           double var15 = y;
           double var17 = z;
           boolean var19 = this.onGround && this.isSneaking();
           if(var19) {
              double var53;
              for(var53 = 0.05D; x != 0.0D && this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().offset(x, -1.0D, 0.0D)).isEmpty(); var13 = x) {
                 if(x < var53 && x >= -var53) {
                    x = 0.0D;
                 } else if(x > 0.0D) {
                    x -= var53;
           ...
           List var631 = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().addCoord(x, y, z));
           AxisAlignedBB var21 = this.getEntityBoundingBox();

           AxisAlignedBB var23;
           for(Iterator var54 = var631.iterator(); var54.hasNext(); y = var23.calculateYOffset(this.getEntityBoundingBox(), y)) {
              var23 = (AxisAlignedBB)var54.next();
           }

           this.func_174826_a(this.getEntityBoundingBox().offset(0.0D, y, 0.0D));
           boolean var64 = this.onGround || var15 != y && var15 < 0.0D;

           AxisAlignedBB var24;
           Iterator var55;
           for(var55 = var631.iterator(); var55.hasNext(); x = var24.calculateXOffset(this.getEntityBoundingBox(), x)) {
              var24 = (AxisAlignedBB)var55.next();
           }

           this.func_174826_a(this.getEntityBoundingBox().offset(x, 0.0D, 0.0D));

           for(var55 = var631.iterator(); var55.hasNext(); z = var24.calculateZOffset(this.getEntityBoundingBox(), z)) {
              var24 = (AxisAlignedBB)var55.next();
           }
           ...
           if(this == Minecraft.getMinecraft().thePlayer) {
              em.fire(true, (double)this.stepHeight);
           }
           ...
           double var27 = z;
           double var731;
           if(x * x + z * z >= x * x + z * z && !em.isCancelled() && em.getStepHeight() > 0.0D && var64 && (var13 != x || var17 != z)) {
              AxisAlignedBB var57 = this.getEntityBoundingBox();
              this.func_174826_a(var21);
              y = em.getStepHeight();
              List var58 = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().addCoord(var13, y, var17));
              AxisAlignedBB var59 = this.getEntityBoundingBox();
              AxisAlignedBB var26 = var59.addCoord(var13, 0.0D, var17);
              double var60 = y;

              AxisAlignedBB var63;
              for(Iterator var65 = var58.iterator(); var65.hasNext(); var60 = var63.calculateYOffset(var26, var60)) {
                 var63 = (AxisAlignedBB)var65.next();
              }

              var59 = var59.offset(0.0D, var60, 0.0D);
              var731 = var13;

              AxisAlignedBB var66;
              for(Iterator var68 = var58.iterator(); var68.hasNext(); var731 = var66.calculateXOffset(var59, var731)) {
                 var66 = (AxisAlignedBB)var68.next();
              }

              var59 = var59.offset(var731, 0.0D, 0.0D);
              double var76 = var17;

              AxisAlignedBB var40;
              for(Iterator var69 = var58.iterator(); var69.hasNext(); var76 = var40.calculateZOffset(var59, var76)) {
                 var40 = (AxisAlignedBB)var69.next();
              }

              var59 = var59.offset(0.0D, 0.0D, var76);
              AxisAlignedBB var77 = this.getEntityBoundingBox();
              double var70 = y;

              AxisAlignedBB var43;
              for(Iterator var71 = var58.iterator(); var71.hasNext(); var70 = var43.calculateYOffset(var77, var70)) {
                 var43 = (AxisAlignedBB)var71.next();
              }

              var77 = var77.offset(0.0D, var70, 0.0D);
              double var78 = var13;

              AxisAlignedBB var45;
              for(Iterator var72 = var58.iterator(); var72.hasNext(); var78 = var45.calculateXOffset(var77, var78)) {
                 var45 = (AxisAlignedBB)var72.next();
              }

              var77 = var77.offset(var78, 0.0D, 0.0D);
              double var79 = var17;

              AxisAlignedBB var47;
              for(Iterator var73 = var58.iterator(); var73.hasNext(); var79 = var47.calculateZOffset(var77, var79)) {
                 var47 = (AxisAlignedBB)var73.next();
              }

              var77 = var77.offset(0.0D, 0.0D, var79);
              double var80 = var731 * var731 + var76 * var76;
              double var48 = var78 * var78 + var79 * var79;
              if(var80 > var48) {
                 x = var731;
                 z = var76;
                 ...
                 x = var78;
                 z = var79;
                 this.func_174826_a(var77);
              }

              y = -em.getStepHeight();

              AxisAlignedBB var51;
              for(Iterator var50 = var58.iterator(); var50.hasNext(); y = var51.calculateYOffset(this.getEntityBoundingBox(), y)) {
              ...
              if(var56 * var56 + var27 * var27 >= x * x + z * z) {
                 ...
                 em.fire(false, (double)this.stepHeight, 1.0D + y);
              }
           }
           ...
           int var651 = MathHelper.floor_double(this.posX);
           int var661 = MathHelper.floor_double(this.posY - 0.20000000298023224D);
           int var67 = MathHelper.floor_double(this.posZ);
           BlockPos var681 = new BlockPos(var651, var661, var67);
           Block var691 = this.worldObj.getBlockState(var681).getBlock();
           if(var691.getMaterial() == Material.air) {
              Block var62 = this.worldObj.getBlockState(var681.offsetDown()).getBlock();
              if(var62 instanceof BlockFence || var62 instanceof BlockWall || var62 instanceof BlockFenceGate) {
                 var691 = var62;
                 var681 = var681.offsetDown();
              }
           }

           this.func_180433_a(y, this.onGround, var691, var681);
           if(var13 != x) {
              this.motionX = 0.0D;
           }
           ...
           if(var15 != y) {
              var691.onLanded(this.worldObj, this);
           }

           if(this.canTriggerWalking() && !var19 && this.ridingEntity == null) {
              double var701 = this.posX - var7;
              var731 = this.posY - var9;
              double var75 = this.posZ - var11;
              if(var691 != Blocks.ladder) {
                 var731 = 0.0D;
              }

              if(var691 != null && this.onGround) {
                 var691.onEntityCollidedWithBlock(this.worldObj, var681, this);
              }

              this.distanceWalkedModified = (float)((double)this.distanceWalkedModified + (double)MathHelper.sqrt_double(var701 * var701 + var75 * var75) * 0.6D);
              this.distanceWalkedOnStepModified = (float)((double)this.distanceWalkedOnStepModified + (double)MathHelper.sqrt_double(var701 * var701 + var731 * var731 + var75 * var75) * 0.6D);
              if(this.distanceWalkedOnStepModified > (float)this.nextStepDistance && var691.getMaterial() != Material.air) {
                 ...
                 this.func_180429_a(var681, var691);
              }
           }
           ...
           try {
              ...
              CrashReport var721 = CrashReport.makeCrashReport(var621, "Checking entity block collision");
              CrashReportCategory var74 = var721.makeCategory("Entity being checked for collision");
              this.addEntityCrashInfo(var74);
              throw new ReportedException(var721);
           }

           boolean var711 = this.isWet();
