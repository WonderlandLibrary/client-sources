...
public class WorldBorder
{
    ...
    public static final Serializer DEFAULT_SERIALIZER = new Serializer(0.0D, 0.0D, 0.2D, 5.0D, 5, 15, 6.0E7D, 0L, 0.0D);
    ...
    {
        this.state = (IBorderInfo)(oldSize == newSize ? new StationaryBorderInfo(newSize) : new MovingBorderInfo(oldSize, newSize, time));
    ...
    class MovingBorderInfo implements IBorderInfo
    {
        ...
        {
            return (IBorderInfo)(this.getTimeUntilTarget() <= 0L ? WorldBorder.this.new StationaryBorderInfo(this.newSize) : this);
        }
