...
public class SkinManager
{
    ...
    {
        return this.loadSkin(profileTexture, textureType, (ISkinAvailableCallback)null);
    }

    /**
     * May download the skin if its not in the cache, can be passed a SkinManager#SkinAvailableCallback for handling
     */
    private ResourceLocation loadSkin(MinecraftProfileTexture profileTexture, Type textureType, @Nullable ISkinAvailableCallback skinAvailableCallback)
    {
