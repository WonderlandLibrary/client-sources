...
public class Main {
    ...
    public static void main(String[] p_main_0_) {
        ...
        try {
            ...
            Managment.USER_PROFILE = new UserProfile("dedinside",
                    1);
        }
        ...
        OptionSpec<String> optionspec10 = optionparser.accepts("username").withRequiredArg().defaultsTo("EXPRandom" + Util.milliTime() % 1000L);
