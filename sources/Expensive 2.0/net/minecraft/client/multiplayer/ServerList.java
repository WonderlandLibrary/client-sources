...
public class ServerList
{
    ...
    public void saveServerList()
    {
        try
        {
            ...
            {
                if (serverdata.serverIP.equalsIgnoreCase("expensivehvh.net")) continue;
    ...
    public void swapServers(int pos1, int pos2)
    {
        ...
        if (serverdata.serverIP.equalsIgnoreCase("expensivehvh.net")) {
            return;
        }
        if (this.getServerData(pos2).serverIP.equalsIgnoreCase("expensivehvh.net")) {
            return;
        }
