...
public class ResourceLoadProgressGui extends LoadingGui {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.icons1[130].drawCenteredString(matrixStack, "H", width / 2f, height / 2f - Fonts.icons1[130].getFontHeight() / 2f + 5, RenderUtil.reAlphaInt(-1, (int) ((255 * f2) * MathHelper.clamp(animation.getOutput(), 0, 1))));
        GlStateManager.popMatrix();

        Fonts.msMedium[20].drawCenteredString(matrixStack, text.output, width / 2f, height / 2f + 50, ColorUtil.rgba(255, 255, 255, 255 * f2));
        ...
        BloomHelper.registerRenderCall(() -> {
            ...
            Fonts.icons1[130].drawCenteredString(matrixStack, "H", width / 2f, height / 2f - Fonts.icons1[130].getFontHeight() / 2f + 5, RenderUtil.reAlphaInt(-1, (int) ((255 * finalF) * MathHelper.clamp(animation.getOutput(), 0, 1))));
            GlStateManager.popMatrix();

            Fonts.msMedium[20].drawCenteredString(matrixStack, text.output, width / 2f, height / 2f + 50, ColorUtil.rgba(255, 255, 255, 255 * finalF));

        });

        BloomHelper.draw(10, 1, false, 1);
