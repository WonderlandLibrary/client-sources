...
public class IngameGui extends AbstractGui {
    ...
    public void renderIngameGui(MatrixStack matrixStack, float partialTicks) {
        ...
        //FogBlurUtils.renderBlur(0, 50, 0f, 0.05f, mc.gameSettings.renderDistanceChunks * 16f);
        ...
        if (Managment.FUNCTION_MANAGER.hud2.elements.get(7)) {
        ...
        //HudFunction hudFunction = Managment.FUNCTION_MANAGER.hudFunction;

//        if (!(hudFunction.state && hudFunction.elements.get(3))) {
...
//        }
    ...
    private void func_238447_a_(MatrixStack p_238447_1_, ScoreObjective p_238447_2_) {
        ...
        //RenderUtil.Render2D.drawRoundedRect(l2, j2 - i2 - 12, scaledWidth-l2, 50, 2, ColorUtil.rgba(0,0,0,128));

        RenderUtil.Render2D.drawRoundedCorner(l2 - 2, j2 - i2, scaledWidth - l2, i2, new Vector4f(0, 4, 0, 4), ColorUtil.rgba(0, 0, 0, 80));
...
//                //this.getFontRenderer().drawString(p_238447_1_, s, (float) (l1 - this.getFontRenderer().getStringWidth(s)), (float) k1, -1);
            ...
            if (l == collection.size()) {
                ...
                RenderUtil.Render2D.drawRoundedCorner(l2 - 2, k1 - 10, scaledWidth - l2, 10, new Vector4f(4, 0, 4, 0), ColorUtil.rgba(0, 0, 0, 128));
