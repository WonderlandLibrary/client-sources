...
import wtf.expensive.ui.proxy.ProxyUI;
...
public class MultiplayerScreen extends Screen
{
    ...
    protected void init()
    {
        ...
        if (!ClientUtil.legitMode) {
            this.addButton(new Button(this.width / 2 + 4 + 50 + 105, this.height - 52, 100, 20, new TranslationTextComponent("Прокси"), (ppp) ->
            {
    ...
    private void func_214285_a(boolean p_214285_1_)
    {
        ...
        {
            if (((ServerSelectionList.NormalEntry)serverselectionlist$entry).getServerData().serverIP.equalsIgnoreCase("expensivehvh.net")) {
