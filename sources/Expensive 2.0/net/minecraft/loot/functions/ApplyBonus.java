...
public class ApplyBonus extends LootFunction
{
    ...
    public static Builder<?> binomialWithBonusCount(Enchantment p_215870_0_, float p_215870_1_, int p_215870_2_)
    {
        ...
        {
            return new ApplyBonus(p_215864_3_, p_215870_0_, new BinomialWithBonusCountFormula(p_215870_2_, p_215870_1_));
        });
    }
    ...
    public static Builder<?> oreDrops(Enchantment p_215869_0_)
    {
        ...
        {
            return new ApplyBonus(p_215866_1_, p_215869_0_, new OreDropsFormula());
        });
    }
    ...
    public static Builder<?> uniformBonusCount(Enchantment p_215871_0_)
    {
        ...
        {
            return new ApplyBonus(p_215872_1_, p_215871_0_, new UniformBonusCountFormula(1));
        });
    }
    ...
    public static Builder<?> uniformBonusCount(Enchantment p_215865_0_, int p_215865_1_)
    {
        ...
        {
            return new ApplyBonus(p_215868_2_, p_215865_0_, new UniformBonusCountFormula(p_215865_1_));
        });
    }
    ...
    static final class BinomialWithBonusCountFormula implements IFormula
    {
    ...
    {
        IFormula deserialize(JsonObject p_deserialize_1_, JsonDeserializationContext p_deserialize_2_);
    }

    static final class OreDropsFormula implements IFormula
    {
    ...
    public static class Serializer extends LootFunction.Serializer<ApplyBonus>
    {
        ...
        public ApplyBonus deserialize(JsonObject object, JsonDeserializationContext deserializationContext, ILootCondition[] conditionsIn)
        {
            ...
            IFormulaDeserializer applybonus$iformuladeserializer = ApplyBonus.field_215875_a.get(resourcelocation1);
    ...
    static final class UniformBonusCountFormula implements IFormula
    {
