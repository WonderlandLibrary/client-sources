        ...
        if (this.isAttachedToEntity()) {
            ...
            if (this.boostedEntity != null) {
                if (this.boostedEntity.isElytraFlying()) {
                    if (Managment.FUNCTION_MANAGER.auraFunction.state && Managment.FUNCTION_MANAGER.auraFunction.settings.get(1) && boostedEntity instanceof ClientPlayerEntity) {
                        Vector3d vector3d = this.getVectorForRotation(Managment.FUNCTION_MANAGER.auraFunction.rotate.y, Managment.FUNCTION_MANAGER.auraFunction.rotate.x);
