...
public class CustomServerBossInfo extends ServerBossInfo
{
    ...
    {
        super(nameIn, Color.WHITE, Overlay.PROGRESS);
        this.id = idIn;
    ...
    public static CustomServerBossInfo read(CompoundNBT nbt, ResourceLocation idIn)
    {
        ...
        customserverbossinfo.setColor(Color.byName(nbt.getString("Color")));
        customserverbossinfo.setOverlay(Overlay.byName(nbt.getString("Overlay")));
