...
public class AuroraRPC {
    private static final String ClientId = "695429562288308266";
    ...
    public static void init(){
        ...
        presence.details = "Version " + AuroraMod.MODVER;
        presence.state = "Main Menu";
        presence.largeImageKey = "aurora";
        presence.largeImageText = "Aurora Owns All";
        ...
        new Thread(() -> {
            while (!Thread.currentThread().isInterrupted()) {
                try {
                    ...
                    details = "Version " + AuroraMod.MODVER;
                    state = "";
