...
public class PingComponent extends Panel {
    ...
    public void drawHud(){
        doStuff();
        String ping = "\u00A78Ping " + ChatFormatting.RESET +mod.getPing() + "ms";
        if(font) AuroraMod.fontRenderer.drawStringWithShadow(ping, (float)x, (float)y, text.getRGB());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks){
        ...
        if(extended) {
            ...
            if (font) AuroraMod.fontRenderer.drawStringWithShadow(ping, (float) x, (float) startY, text.getRGB());
