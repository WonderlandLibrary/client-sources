...
public class TimeComponent extends Panel {
    ...
    public void drawHud(){
        ...
        if(font) AuroraMod.fontRenderer.drawStringWithShadow(date, (float)x, (float)y, text.getRGB());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks){
        ...
        if(extended) {
            ...
            if (font) AuroraMod.fontRenderer.drawStringWithShadow(date, (float) x, (float) startY, text.getRGB());
