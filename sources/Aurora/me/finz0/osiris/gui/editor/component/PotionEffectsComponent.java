...
public final class PotionEffectsComponent extends DraggableHudComponent {
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        final Comparator<PotionEffect> comparator = (first, second) -> {
            final String firstEffect = EnemyPotionsComponent.getFriendlyPotionName(first) + " " + ChatFormatting.GRAY + Potion.getPotionDurationString(first, 1.0F);
            final String secondEffect = EnemyPotionsComponent.getFriendlyPotionName(second) + " " + ChatFormatting.GRAY + Potion.getPotionDurationString(second, 1.0F);
        ...
        for (PotionEffect potionEffect : effects) {
            if (potionEffect != null) {
                final String effect = EnemyPotionsComponent.getFriendlyPotionName(potionEffect) + " " + ChatFormatting.GRAY + Potion.getPotionDurationString(potionEffect, 1.0F);
