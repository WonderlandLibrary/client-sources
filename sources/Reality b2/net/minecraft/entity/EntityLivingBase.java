...
import Reality.Realii.event.events.world.EventJumpFix;
...
public abstract class EntityLivingBase extends Entity {
    ...
    private int getArmSwingAnimationEnd() {
        if (ModuleManager.getModuleByClass(Animations.class).isEnabled()) {
            return Animations.speed.getValue().intValue();
        }
    ...
    protected void jump() {
        ...
        if (this.isSprinting()) {
            EventJumpFix Niggaisjumping = new EventJumpFix(this.rotationYaw);
            if(this instanceof EntityPlayerSP) {
                EventBus.getInstance().call(Niggaisjumping);
            }
