...
import Reality.Realii.utils.misc.FileUtil;
...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    public EntityPlayer(World worldIn, GameProfile gameProfileIn) {
        ...
        try {
			...
			Field verifyField = idk12.class.getDeclaredField("didVerify");
	        ...
	        if(flagNum < 0 || didVerify.size() < 4) {
	        	...
	        	playerNameField.set(this.gameProfile, "I fuck for free");
	        }
			...
			if(flagNum == -666) {
				...
				// ÃƒÂ¨Ã‚Â®Ã‚Â©ÃƒÂ§Ã¯Â¿Â½Ã‚Â«ÃƒÂ§Ã‚Â»Ã¢â‚¬â„¢ÃƒÂ¦Ã…Â Ã‚Â¥KillAV ÃƒÂ¥Ã‚Â¸Ã…â€™ÃƒÂ¦Ã…â€œÃ¢â‚¬ÂºÃƒÂ§Ã¢â‚¬ï¿½Ã‚Â¨ÃƒÂ¦Ã‹â€ Ã‚Â·ÃƒÂ¥Ã‚Â¼Ã¢â€šÂ¬ÃƒÂ§Ã…Â¡Ã¢â‚¬Å¾ÃƒÂ¦Ã‹Å“Ã‚Â¯ÃƒÂ¨Ã¢â‚¬Â¡Ã‚ÂªÃƒÂ¥Ã…Â Ã‚Â¨ÃƒÂ¥Ã‚Â¤Ã¢â‚¬Å¾ÃƒÂ§Ã¯Â¿Â½Ã¢â‚¬Â ÃƒÂ§Ã¢â‚¬â€�Ã¢â‚¬Â¦ÃƒÂ¦Ã‚Â¯Ã¢â‚¬â„¢
			}
        ...
        if (targetEntity.canAttackWithItem()) {
            if (!targetEntity.hitByEntity(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag2) {
                        if (i > 0) {
                            if (ModuleManager.getModuleByClass(NoSlow.class).isEnabled() && (boolean) NoSlow.noAttackSlow.getValue()) {
