...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    public libraries.javax.vecmath.Matrix4f getMatrix()
    {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (libraries.javax.vecmath.Matrix4f)Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[] {this}): new libraries.javax.vecmath.Matrix4f();
    }
