...
import libraries.lumien.chunkanimator.ChunkAnimator;
import libraries.optifine.BlockPosM;
...
public class RenderChunk
{
    ...
    public void setPosition(BlockPos pos)
    {
        ...
        if(Client.instance.getModuleManager().getModuleByClass(Reality.Realii.mods.modules.render.ChunkAnimator.class).isEnabled()) {
            ChunkAnimator.INSTANCE.animationHandler.setPosition(this, position);
        }
