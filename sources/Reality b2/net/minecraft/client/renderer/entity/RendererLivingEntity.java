...
import Reality.Realii.mods.modules.render.Chams;
import Reality.Realii.mods.modules.render.Esp;
import Reality.Realii.mods.modules.render.NameTag;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected static FloatBuffer brightnessBuffer = GLAllocation.createDirectFloatBuffer(4);
    ...
    public static boolean setShaderBrightness(final EntityLivingBase entitylivingbaseIn, Color color) {
        boolean isModuleEnabled = entitylivingbaseIn instanceof EntityPlayer && entitylivingbaseIn != Minecraft.getMinecraft().thePlayer;
    ...
    public static void unsetBrightness()
    {
        GlStateManager.setActiveTexture(OpenGlHelper.defaultTexUnit);
        GlStateManager.enableTexture2D();
        GL11.glTexEnvi(GL11.GL_TEXTURE_ENV, GL11.GL_TEXTURE_ENV_MODE, OpenGlHelper.GL_COMBINE);
