...
import Reality.Realii.mods.modules.render.PlayerSize;
...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    {
        EventPreRenderPlayer event = new EventPreRenderPlayer(Helper.mc.thePlayer,null,null);
        ...
        EventPostRenderPlayer event2 = new EventPostRenderPlayer(Helper.mc.thePlayer,null,null);
    ...
    {
    	if(Client.instance.getModuleManager().getModuleByClass(PlayerSize.class).isEnabled()) {
    		 float f = PlayerSize.Size.getValue().floatValue();
    		 // float f = 0.9375F;
