...
import Reality.Realii.mods.modules.render.Animations;
...
public class ItemRenderer {
   ...
   //GlStateManager.translate(0.05f, 0.2f, -0.1f);
    	 GlStateManager.translate(Animations.x.getValue().floatValue(), Animations.y.getValue().floatValue(), Animations.z.getValue().floatValue());
        float f = 1.0F - (this.prevEquippedProgress + (this.equippedProgress - this.prevEquippedProgress) * partialTicks);
        EntityPlayerSP entityplayersp = this.mc.thePlayer;
        float f1 = entityplayersp.getSwingProgress(partialTicks);
        
        final float swingProgress = ((AbstractClientPlayer) mc.thePlayer).getSwingProgress(partialTicks);
        ...
        if (this.itemToRender != null) {
            if (this.itemToRender.getItem() instanceof ItemMap) {
            ...
            } else if (entityplayersp.getItemInUseCount() > 0 || ModuleManager.getModuleByClass(Killaura.class).isEnabled() && Killaura.blockhit.getValue().equals("Fake") && Killaura.target !=null && mc.thePlayer.isSwingInProgress ) {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()]) {
                    ...
                    case 4:
                        if (ModuleManager.getModuleByClass(Animations.class).isEnabled()) {
                            switch (Animations.mode.getModeAsString()) {
                                case "1.7":
                                	this.transformFirstPersonItem(f / 2.0f, f1);
                                	
                               	 GlStateManager.rotate(0, 0.0F, 0.0F, f1 * -0.0F);
                               	 GlStateManager.translate(0.0F, 0.3F, 0.0);
                                ...
                                case"New":
                                	  this.transformFirstPersonItem(f / 0.15f, f1);
                                     //GlStateManager.translate(0, 0.0F, -1);
                                   //GlStateManager.rotate(-59, 0, 0, 0);
                                ...
                                case "Swang":
                                    ...
                                    GlStateManager.rotate(rot * 50.0f, 1.0f, -rot, -0.0f);
                                ...
                                case "DortWare":
                                    ...
                                    this.transformFirstPersonItem(f, 0.0f);
                                    float var91793 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                                    GlStateManager.rotate(-var91793 * 10, 0.0f, 15.0f, 200.0f);
                                    GlStateManager.rotate(-var91793 * 10f, 300.0f, var91793 / 2.0f, 1.0f);
                                    
                                    //this.func_178103_d();

                                   // GL11.glTranslated(2.4, 0.3, 0.5);
                                   //GL11.glTranslatef(-2.10f, -0.2f, 0.1f);
                                    GlStateManager.rotate(var91793 * 13.0f, -10.0f, -1.4f, -10.0f);
                                	break;
                                ...
                                case "Sus":
                                    ...
                                    final float ONGOd = MathHelper.sin(f1 * f1 * (float) Math.PI);
                                    final float ONGOd2 = MathHelper.sin(MathHelper.sqrt_float(f1) * (float) Math.PI);

                                    GlStateManager.rotate(ONGOd * -20.0F, 0.0F, 1.0F, 0.0F);
                                    GlStateManager.rotate(ONGOd2 * -20.0F, 0.0F, 0.0F, 1.0F);
                                    GlStateManager.rotate(ONGOd2 * -20.0F, 1.0F, 0.0F, 0.0F);
                                    GlStateManager.scale(0.4F, 0.4F, 0.4F);
                                	break;
                                	
                                	
                                case "MeltedButter":
                                	  final float funny2 = MathHelper.sin(MathHelper.sqrt_float(f1) * (float) Math.PI);
                                    GlStateManager.translate((0.9F / ((funny2 + 1.45f) / 5) / 3) + funny2 / 10, -0.75f - funny2 / 20, -0.71999997F);
                                    GlStateManager.translate(0.3F, f * -0.6F, -1.0F);
                                    GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);

                                    final float x = MathHelper.sin(f1 * f1 * (float) Math.PI);
                                    final float y = MathHelper.sin(MathHelper.sqrt_float(f1) * (float) Math.PI);
                                ...
                                case "Old":
                                	this.transformFirstPersonItem(f, 0.0f);
                                    float var9173 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                                   
                                    GlStateManager.translate(-0.36f, 0.25f, -0.06f);
                                    GlStateManager.rotate(-var9173 * 50.0f, -8.0f, -0.0f, 9.0f);
                                    GlStateManager.rotate(-var9173 * 80.0f, 1.0f, 0.4f, -0.0f);
                                ...
                                case "Edit":
                                    final float sw0ng = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927f);
                                ...
                                case "Exchibition3":
                                	  this.transformFirstPersonItem(f, 0.0f);
                                      float var91782 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                                      
                                      GlStateManager.translate(0.0f, 0.25f, 0.00f);
                                      GlStateManager.rotate(-var91782 * 35.0f, -8.0f, -0.2f, 9.0f);
                                      GlStateManager.rotate(-var91782 * 80.0f, 1.0f, 0.4f, -0.0f);
                                ...
                                case "Exchibition2":
                                	...
                                	float var91 = MathHelper.sin(MathHelper.sqrt_float(this.mc.thePlayer.getSwingProgress(partialTicks)) * 3.1415927F);
                                    GL11.glTranslated(0.0D, 0.0D, 0.0D);
                                    GlStateManager.rotate(-var91 * 40.0F / 2.0F, var91 / 2.0F, 1.0F, 4.0F);
                                    GlStateManager.rotate(-var91 * 30.0F, 1.0F, var91 / 3.0F, -0.0F);
                                ...
                                case "Cleaner":
                                    this.transformFirstPersonItem(f, 0.0f);
                                    float var913 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                                  //  GlStateManager.translate(-0.9f, 0.50f, 0.0f);
                                    GlStateManager.translate(0.3f, 0.0f, -0.9f);
                                    GlStateManager.rotate(-var913 * 35.0f, -8.0f, -0.0f, 9.0f);
                                    GlStateManager.rotate(-var913 * 70.0f, 1.0f, -0.4f, -0.0f);
                                ...
                                case "Exchibition":
                                    this.transformFirstPersonItem(f, 0.0f);
                                    float var917 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                                   
                                    GlStateManager.translate(-0.36f, 0.25f, -0.06f);
                                    GlStateManager.rotate(-var917 * 35.0f, -8.0f, -0.0f, 9.0f);
                                    GlStateManager.rotate(-var917 * 70.0f, 1.0f, 0.4f, -0.0f);
                                ...
                                case "Exchibition4":
                                    this.transformFirstPersonItem(f, 0.0f);
                                    float var9178 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                                    
                                    GlStateManager.translate(0.0f, 0.25f, 0.00f);
                                    GlStateManager.rotate(-var9178 * 35.0f, -8.0f, -0.0f, 9.0f);
                                    GlStateManager.rotate(-var9178 * 70.0f, 1.0f, 0.4f, -0.0f);
                                ...
                                case "Pula":
                                	...
                                	final float funny = MathHelper.sin(MathHelper.sqrt_float(f1) * (float) Math.PI);

                                	GlStateManager.translate(0.56F, -0.46F + funny / 10, -0.71999997F);
                                    GlStateManager.translate(0.0F, f * -0.6F, 0.0F);
                                    GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);

                                    final float cock = MathHelper.sin(f1 * f1 * (float) Math.PI);
                                    final float lolxd = MathHelper.sin(MathHelper.sqrt_float(f1) * (float) Math.PI);
                                   ...
                                   // this.func_178103_d();
                                	...
                                	case "Ketamine":
                                    	//this.transformFirstPersonItem(f / 1.0f, f1);
                                    	final float funny1 = MathHelper.sin(MathHelper.sqrt_float(f1) * (float) Math.PI);

                                    	GlStateManager.translate(0.56F, -0.46F + funny1 / 10, -0.71999997F);
                                        GlStateManager.translate(0.0F, f * -0.6F, 0.0F);
                                        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);

                                        final float cock1 = MathHelper.sin(f1 * f1 * (float) Math.PI);
                                        final float lolxd1 = MathHelper.sin(MathHelper.sqrt_float(f1) * (float) Math.PI);

                                       
                                        GlStateManager.rotate(lolxd1 * -10.0F, 0.0F, 0.0F, 1.0F);
                                        GlStateManager.rotate(lolxd1 * -40.0F, 0.5F, 0.0F, -0.1F);
                                        GlStateManager.scale(0.4F, 0.4F, 0.4F);
                                ...
                                case "Rise":
                                	this.transformFirstPersonItem(f / 1.0f, f1);
                                     ...
                                     final float funnyer = MathHelper.sin(MathHelper.sqrt_float(f) * (float) Math.PI);
                                     //f1
                                     GlStateManager.rotate(-funnyer * 140.0F, 8.0F, 0.0F, 8.0F);
                                     GlStateManager.rotate(funnyer * 90.0F, 8.0F, 0.0F, 8.0F);
                                ...
                                case "rotate":
                                	this.transformFirstPersonItem(f / 2.0f, f1);
                                	 float var1613 = MathHelper.sin((MathHelper.sqrt_float(f1) * 3.1415927f));	
                                	 GlStateManager.rotate((var1613 * 360.0f), (-var1613), -0.0f, 43.0f);
                                	 
                                	  GlStateManager.rotate(0, 90.0F, 120.0F, f1 * -1000.0F);
                                ...
                                case "Reality":
                                	this.transformFirstPersonItem(f / 2.0f, f1);
                                	 float var154 = MathHelper.sin((MathHelper.sqrt_float(f1) * 3.1415927f));
                                	 GlStateManager.rotate((var154 * 10.0f), (-var154), -0.0f, 43.0f);
                                	 GlStateManager.translate(0.0F, 0.36F, 0.71999997F);
                                ...
                                case "exchibobo":
                                	this.transformFirstPersonItem(f / 2.0f, f1);
                                	 ...
                                	 GlStateManager.rotate(0, 0.0F, 0.0F, f1 * -0.0F);
                                	 GlStateManager.translate(0.0F, 0.0F, 0.0);
                                ...
                                case "360":
                                	this.transformFirstPersonItem(f / 2.0f, f1);
                               	 float var1543 = MathHelper.sin((MathHelper.sqrt_float(f1) * 3.1415927f));
                               	 GlStateManager.rotate((var1543 * 10.0f), (-var1543), -0.0f, 43.0f);
                                ...
                                case "Drop":
                                	...
                                	this.transformFirstPersonItem(f / 2.0f, f1);
                               	 float var16134 = MathHelper.sin((MathHelper.sqrt_float(f1) * 3.1415927f));	
                               	 GlStateManager.rotate((var16134 * 50.0f), (-var16134), -0.0f, 43.0f);
                               	 GlStateManager.translate(0.5F, f1 * 0.1F, -0.3F);
                                ...
                                case "Swank":
                                	   GL11.glTranslated(-0.1, 0.08, 0.0);
                                       this.transformFirstPersonItem(f / 0.15f, f1);
                                       final float rot3 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927f);
                                       GlStateManager.rotate(rot3 * 30.0f, 1.0f, -rot3, 9.0f);
                                       GlStateManager.rotate(rot3 * 50.0f, 1.0f, -rot3, -0.0f);
            	...
            	if (Animations.Swingmode.getValue().equals("Normal")) {
