...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
    ...
    public void drawBackground(int tint) {
        if (mc.currentScreen instanceof GuiScreenResourcePacks) {
            ...
            tessellator.draw();
        } else if (mc.currentScreen instanceof GuiConnecting || mc.currentScreen instanceof GuiCreateWorld || mc.currentScreen instanceof GuiWinGame) {
            RenderUtil.drawCustomImage(0, 0, this.width, this.height, new ResourceLocation("client/background.png"));

        } else {
            GlStateManager.disableCull();
            shader.useShader(this.width * 3, this.height * 3, Mouse.getX(), Mouse.getY(), (System.currentTimeMillis() - initTime) / 1000f);
