...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
    	//Reality
    	Client.getDiscordRP().update("Idle", "choosing a server to Dominate");
    ...
    public void createButtons()
    {
        ...
        //this.buttonList.add(new GuiButton(14,10,10,70,20,"ViaVersion"));
        this.buttonList.add(new GuiButton(14,this.width - 110,10,100,20,"Proxy"));
