...
//            tessellator.draw();
                GL11.glScissor(0, (height - bottom) * 2, width * 2, (bottom - top) * 2);
                Gui.drawRect(this.width / 2 - 154, this.top, this.width / 2 + 154, this.bottom, new Color(0, 0, 0, 100).getRGB());
                ...
                int i1 = 1;
                Gui.drawRect(0, 0, this.width, this.top, new Color(0, 0, 0, 100).getRGB());
                Gui.drawRect(0, this.bottom, this.width, this.height, new Color(0, 0, 0, 100).getRGB());


                Gui.drawRect(this.left, this.top, this.right, top + i1, -1);
                Gui.drawRect(this.left, this.bottom, this.right, this.bottom - i1, -1);
