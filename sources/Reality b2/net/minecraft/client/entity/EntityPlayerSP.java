...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onLivingUpdate()
    {
        ...
        EventBus.getInstance().call(new EventSilentMove(this.mc.thePlayer.rotationYaw));
        if (eventSilentMove.isSilent()) {
            float[] floats = eventSilentMove.mySilentStrafe(this.movementInput.moveStrafe, this.movementInput.moveForward, eventSilentMove.getYaw(), eventSilentMove.isAdvanced());
        ...
        if (this.isUsingItem() && !this.isRiding() &&!Client.instance.getModuleManager().getModuleByClass(NoSlow.class).isEnabled())
            ...
            //  if (Killaura.blockhit.getValue().equals("Watchdog") && !Client.instance.getModuleManager().getModuleByClass(Killaura.class).isEnabled() && this.isUsingItem() && !this.isRiding())
               {
                   this.movementInput.moveStrafe *= 0.2F;
                   this.movementInput.moveForward *= 0.2F;
                   this.sprintToggleTimer = 0;
               } //else if (this.isUsingItem() && !this.isRiding()  && NoSlow.mode.getValue().equals("Ncp")&& !Client.instance.getModuleManager().getModuleByClass(NoSlow.class).isEnabled()) {
        	// this.movementInput.moveStrafe *= 0.2F;
            // this.movementInput.moveForward *= 0.2F;
            // this.sprintToggleTimer = 0;
          
           
      //  } else if (this.isUsingItem() && !this.isRiding() && NoSlow.mode.getValue().equals("Uncp")&& !Client.instance.getModuleManager().getModuleByClass(NoSlow.class).isEnabled()) {
       //	 this.movementInput.moveStrafe *= 0.2F;
      //   this.movementInput.moveForward *= 0.2F;
     //    this.sprintToggleTimer = 0;
 ...
 //   }else if (this.isUsingItem() && !this.isRiding() && NoSlow.mode.getValue().equals("Mmc")&& !Client.instance.getModuleManager().getModuleByClass(NoSlow.class).isEnabled()) {
    //  	 this.movementInput.moveStrafe *= 0.2F;
   //     this.movementInput.moveForward *= 0.2F;
   //     this.sprintToggleTimer = 0;
  //  } 
    ...
    public void setMoveSpeedpre(final EventPreUpdate e, final double speed) {
        double forward = (double)this.mc.thePlayer.movementInput.moveForward;
        double strafe = (double)this.mc.thePlayer.movementInput.moveStrafe;
        float yaw = this.mc.thePlayer.rotationYaw;
        if (forward == 0.0 && strafe == 0.0) {
            ...
            e.setX(forward * speed * Math.cos(Math.toRadians((double)(yaw + 90.0f))) + strafe * speed * Math.sin(Math.toRadians((double)(yaw + 90.0f))));
            e.setZ(forward * speed * Math.sin(Math.toRadians((double)(yaw + 90.0f))) - strafe * speed * Math.cos(Math.toRadians((double)(yaw + 90.0f))));
        }
    }
