...
import Reality.Realii.event.events.world.EventClick;
...
//        } else {
        this.displayGuiScreen(new login12());
//        }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Reality Recode");
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException {
        ...
        RenderUtil.drawRect(scaledresolution.getScaledWidth() / 2f - 200f / 2f, scaledresolution.getScaledHeight() / 2f, scaledresolution.getScaledWidth() / 2f + 200f / 2f, scaledresolution.getScaledHeight() / 2f + 1.5f, new Color(0, 0, 0, 90).getRGB());
...
//        }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            EventBus.getInstance().call(new EventClick());
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn) {
        ...
        //Reality
        Client.getDiscordRP().update("Playing SinglePlayer", "He is Dominating");
    }
