...
public class TrueTypeFont implements Font {
	...
	/**
	 * This is a special internal class that holds our necessary information for the
	 * font characters. This includes width, height, and where the character is
	 * stored on the font texture.
	 */
	 ...
	 * @param antiAlias       Whether or not to apply AntiAliasing to the cached
	 *                        font
