...
public class TpAura extends Module {
    Numbers<Number> range = new Numbers("Range","Range", 50, 1, 200,1);
    Numbers<Number> delay = new Numbers("Delay","Delay", 100, 10, 2000,10);
            ...
            for (Entity entity : mc.theWorld.loadedEntityList) {
                ...
                if (entity instanceof EntityPlayer && !entity.isDead && (mc.thePlayer.getDistanceToEntity(entity) < range.getValue().floatValue()) && (entity != mc.thePlayer)) {
                    ...
                    for (Vec3 pathElm : vec3s) {
                      ...
                      //  mc.thePlayer.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(mc.thePlayer.lastTickPosX, mc.thePlayer.lastTickPosY, mc.thePlayer.lastTickPosZ, true));
