    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                ...
                Client.fontLoaders.msFont18.drawString(s1, (float) l, (float) i1, i);
                j1 = Client.fontLoaders.msFont18.getStringWidth(s1) + l;
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = (int) Client.fontLoaders.msFont18.drawString(s.substring(j), (float) j1, (float) i1, i);
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    Client.fontLoaders.msFont18.drawString("_", (float) k1, (float) i1, i);
                }
            }
