    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            {
                ...
                RenderUtil.drawRoundRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, new Color(240, 240, 240).getRGB());
            }
            ...
            if (s.length() > 0)
            {
                ...
                j1 = (int) FontLoaders.arial16.drawString(s1, (float)l, (float)i1, i);
            }
            ...
            {
                j1 = (int) FontLoaders.arial16.drawString(s.substring(j), (float)j1, (float)i1, i);
            }
            ...
            if (flag1)
            {
                ...
                {
                    FontLoaders.arial16.drawString("_", (float)k1, (float)i1, i);
                }
            }
