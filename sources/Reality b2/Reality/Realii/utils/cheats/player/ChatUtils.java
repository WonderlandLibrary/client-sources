    ...
    public static class ChatMessageBuilder {
        ...
        public ChatMessageBuilder(boolean prependDefaultPrefix, boolean useDefaultMessageColor) {
            if (prependDefaultPrefix) {
                ...
                this.theMessage.appendSibling(new ChatMessageBuilder(false, false).appendText( "[" + String.valueOf((Object) ((Object) EnumChatFormatting.LIGHT_PURPLE) + Client.CLIENT_NAME + "] ")).setColor(EnumChatFormatting.LIGHT_PURPLE).build().getChatComponent());
            }
