...
public class Mode extends SetComp {
	...
	public Mode(ModeSetting s, igbt.astolfy.ui.ClickGUI.dropDown.impl.Button b) {
		super(s, b, height);
		this.set = s;
	}
	...
	public int drawScreen(int mouseX, int mouseY, double x, double y) {
		...
		font.drawString(this.set.getCurrentValue(), (this.x + 100) - font.getStringWidth(this.set.getCurrentValue()) - 3, (y + (font.getHeight() / 2) - 2), -1);
