...
public class CFontRenderer extends CFont {
    ...
    public float drawStringWithShadow(String text, double x, double y, int color) {
        float shadowWidth = drawString(text, x + 0.69d, y + 0.69d, color, true);
    ...
    public void drawDropString(String text, double x, double y, int color){
        drawString(text, x, y, color, false);
        drawString(text, x + 0.5, y + 0.5, ColorUtils.setColorOpacity(new Color(color), (50)).getRGB(), false);
    }
