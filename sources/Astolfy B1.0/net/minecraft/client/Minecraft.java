...
import igbt.astolfy.font.CFont;
import igbt.astolfy.font.CFontRenderer;
import igbt.astolfy.ui.GuiMenus.MainMenu;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public CFontRenderer customFont;
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        try {
			this.customFont = new CFontRenderer(Font.createFont(Font.TRUETYPE_FONT, CFont.class.getResourceAsStream("font.ttf")).deriveFont(Font.PLAIN, 22), true, true);
		} catch (Exception e) {
			e.printStackTrace();
        	shutdown();
		}
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("L o a d i n g . . .");
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                    	EventKey keyEvent = new EventKey(k);
                    	Astolfy.i.moduleManager.onEvent(keyEvent);
