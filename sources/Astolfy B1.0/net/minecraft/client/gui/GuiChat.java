...
import igbt.astolfy.ui.inGame.GuiElement.GuiElementManager;
...
public class GuiChat extends GuiScreen
{
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state){
        ...
        for(GuiElement gElement : GuiElementManager.getElements()){
            if(gElement.parent == null || gElement.parent.isToggled())
                gElement.onMouseRelease(mouseX, mouseY,state);
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        for(GuiElement gElement : GuiElementManager.getElements()){
            if(gElement.parent == null || gElement.parent.isToggled())
                if(gElement.onMouseDown(mouseX, mouseY, mouseButton))
                    return;
        }
        if (mouseButton == 0)
        {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for(GuiElement gElement : GuiElementManager.getElements()){
            if(gElement.parent == null || gElement.parent.isToggled())
                if(gElement.renderOverlay(mouseX, mouseY))
                    return;
        }
    }
