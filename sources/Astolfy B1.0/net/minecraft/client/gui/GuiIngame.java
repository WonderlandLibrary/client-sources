...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        Astolfy.i.moduleManager.onEvent(new EventRender2D(sr.getScaledWidth() * 2, sr.getScaledHeight() * 2));
        ...
        if (scoreobjective1 != null)
        {
            ...
            scoreBoardElement.setHidden(true);
        }
    ...
    public GuiElement scoreBoardElement = new GuiElement("Scoreboard", 0,0, 1920,1080 / 2,0,0);

    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        scoreBoardElement.setHidden(false);
        int totalHeight = 0;
        int maxWidth = 0;
        int startX = 0;
        scoreBoardElement.renderStart();
        ...
        for (Object score1 : arraylist1)
        {
            ...
            if(s1 != null && s1.contains("§ewww.hypixel.ne\uD83C\uDF82§et")){
                s1 = "§cwww.astolfy.lgbt";
            }
        ...
        scoreBoardElement.setHeight(totalHeight + mc.fontRendererObj.FONT_HEIGHT + 1);
        scoreBoardElement.setOffBasedY(k1 - j1 - mc.fontRendererObj.FONT_HEIGHT - 1);
        scoreBoardElement.renderEnd();
        scoreBoardElement.setWidth(maxWidth - startX);
        scoreBoardElement.setOffBasedX(startX);
    }
