...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        if (p_70676_1_ == 666.0F)
        {
            return this.func_174806_f((float)((Fly)ClientBase.INSTANCE.getModuleManager().getModule(Fly.class)).startY, this.rotationYawHead);
        }
        else if (p_70676_1_ == 1.0F)
        {
