...
public abstract class Entity implements ICommandSender {
	...
	public void moveEntity(double x, double y, double z) {
		if (this.noClip) {
			...
			double var15 = y;
			double var17 = z;
			boolean var19 = /*TODO safewalk: ClientBase.INSTANCE.getModuleManager().getModule(Scaffold.class).isEnabled() ||*/ (this.onGround && this.isSneaking() && this instanceof EntityPlayer);
            ...
            EventStep event = new EventStep(this, this.stepHeight, EventStep.Type.PRE);
			...
			if (event.getStepHeight() > 0.0F && var54 && (var13 != x || var17 != z)) {
				...
				if (var56 * var56 + var27 * var27 >= x * x + z * z) {
                    ...
                    EventStep event1 = new EventStep(this, event.getStepHeight(), EventStep.Type.POST);
			...
			Module xd = ClientBase.INSTANCE.getModuleManager().getModule(Fly.class);
			boolean XDD = this instanceof EntityPlayerSP && ClientBase.INSTANCE.setmgr.getSettingByName("Mode", xd).getValString().equalsIgnoreCase("Hypixel") && xd.isEnabled();
	...
	public boolean hasSwung() {
		return this instanceof EntityLivingBase && this.swing;
	}

	public boolean swingCheck() {
		if (this.swing == false) {
			return this.swing = this instanceof EntityPlayer && (((EntityLivingBase) this).isSwingInProgress);
		} else
			return true;
	}
