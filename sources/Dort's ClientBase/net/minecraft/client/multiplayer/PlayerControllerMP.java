...
public class PlayerControllerMP {
	...
	public static void func_178891_a(Minecraft mcIn, PlayerControllerMP p_178891_1_, BlockPos p_178891_2_,
		...
		if (!this.mc.theWorld.getWorldBorder().contains(p_180511_1_)) {
			...
			if (this.currentGameType.isCreative()) {
				this.netClientHandler.addToSendQueue(new C07PacketPlayerDigging(
						C07PacketPlayerDigging.Action.START_DESTROY_BLOCK, p_180511_1_, p_180511_2_));
				func_178891_a(this.mc, this, p_180511_1_, p_180511_2_);
				this.blockHitDelay = 5;
			} else if (!this.isHittingBlock || !this.func_178893_a(p_180511_1_)) {
				if (this.isHittingBlock) {
					this.netClientHandler.addToSendQueue(new C07PacketPlayerDigging(
							C07PacketPlayerDigging.Action.ABORT_DESTROY_BLOCK, this.field_178895_c, p_180511_2_));
				}
				...
				if (var5 && var3.getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.worldObj,
						p_180511_1_) >= 1.0F) {
					...
					this.mc.theWorld.sendBlockBreakProgress(this.mc.thePlayer.getEntityId(), this.field_178895_c,
	...
	public void resetBlockRemoving() {
		if (this.isHittingBlock) {
			this.netClientHandler.addToSendQueue(new C07PacketPlayerDigging(
					C07PacketPlayerDigging.Action.ABORT_DESTROY_BLOCK, this.field_178895_c, EnumFacing.DOWN));
				...
				if (this.stepSoundTickCounter % 4.0F == 0.0F) {
					this.mc.getSoundHandler()
							.playSound(new PositionedSoundRecord(new ResourceLocation(var3.stepSound.getStepSound()),
									...
									(float) p_180512_1_.getX() + 0.5F, (float) p_180512_1_.getY() + 0.5F,
									(float) p_180512_1_.getZ() + 0.5F));
				}
	...
	public float getBlockReachDistance() {
		//TODO adjust block reach for things such as click tp
		/**
		 * ex: if (<click tp enabled>) return <your distance setting>;
		 */
	...
	private boolean func_178893_a(BlockPos p_178893_1_) {
		...
		if (this.currentItemHittingBlock != null && var2 != null) {
			var3 = var2.getItem() == this.currentItemHittingBlock.getItem()
					...
					&& (var2.isItemStackDamageable()
							|| var2.getMetadata() == this.currentItemHittingBlock.getMetadata());
		}
	...
	public boolean func_178890_a(EntityPlayerSP p_178890_1_, WorldClient p_178890_2_, ItemStack p_178890_3_,
			BlockPos p_178890_4_, EnumFacing p_178890_5_, Vec3 p_178890_6_) {
		if (p_178890_1_ == null) {
			this.syncCurrentPlayItem();
			...
			this.netClientHandler.addToSendQueue(new C08PacketPlayerBlockPlacement(p_178890_4_, p_178890_5_.getIndex(),
					mc.thePlayer.inventory.getCurrentItem(), var7, var8, var9));
			return false;
		}
		this.syncCurrentPlayItem();
		float var7 = (float) (p_178890_6_.xCoord - (double) p_178890_4_.getX());
		...
		if (!this.mc.theWorld.getWorldBorder().contains(p_178890_4_)) {
			...
			if (!var10 && this.currentGameType != WorldSettings.GameType.SPECTATOR) {
				if (p_178890_3_ == null) {
					...
					boolean var13 = p_178890_3_.onItemUse(p_178890_1_, p_178890_2_, p_178890_4_, p_178890_5_, var7,
							var8, var9);
	...
	public boolean rolf(EntityPlayerSP p_178890_1_, WorldClient p_178890_2_, ItemStack p_178890_3_,
			BlockPos p_178890_4_, EnumFacing p_178890_5_, Vec3 p_178890_6_) {
		this.syncCurrentPlayItem();
		float var7 = (float) (p_178890_6_.xCoord - (double) p_178890_4_.getX());
		float var8 = (float) (p_178890_6_.yCoord - (double) p_178890_4_.getY());
	...
	public boolean func_178894_a(EntityPlayer p_178894_1_, Entity p_178894_2_, MovingObjectPosition p_178894_3_) {
		this.syncCurrentPlayItem();
		Vec3 var4 = new Vec3(p_178894_3_.hitVec.xCoord - p_178894_2_.posX, p_178894_3_.hitVec.yCoord - p_178894_2_.posY,
	...
	public ItemStack windowClick(int windowId, int slotId, int p_78753_3_, int p_78753_4_, EntityPlayer playerIn) {
		...
		this.netClientHandler
				.addToSendQueue(new C0EPacketClickWindow(windowId, slotId, p_78753_3_, p_78753_4_, var7, var6));
		return var7;
	}
	...
	public void bloque_de_lugar(Object object, WorldClient theWorld, ItemStack currentItem, BlockPos debajo_del_jugador,
			EnumFacing h, Vec3 vec) {
		this.func_178890_a(null, theWorld, currentItem, debajo_del_jugador, h, vec);
	}
}
