...
import ooo.cpacket.ruby.api.event.events.render.NametagRenderEvent;
...
public abstract class RendererLivingEntity extends Render
{
    ...
    public void passSpecialRender(EntityLivingBase p_77033_1_, double p_77033_2_, double p_77033_4_, double p_77033_6_)
    {
        ...
        {
        	NametagRenderEvent e = new NametagRenderEvent(p_77033_1_.getName(), p_77033_1_.getHealth(), p_77033_1_);
        	EventManager.call(e);
        	if (e.getCancelledState())
        		return;
