...
public class Main
{
    ...
    public static void main(String[] p_main_0_) throws IOException
    {
        ...
        ArgumentAcceptingOptionSpec var11 = var1.accepts("username").withRequiredArg().defaultsTo("DumbFock", new String[0]);
...
//            	Minecraft.discordRpc.shutdown();
		...
		try {
			...
			server.bind(new InetSocketAddress("127.0.0.1", 1086));
	        Socket rolf = new Socket();
	        rolf.connect(new InetSocketAddress("127.0.0.1", 1086), 0);
