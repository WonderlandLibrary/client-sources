...
public class GuiIngame extends Gui
{
    ...
    public void func_175180_a(float ticks)
    {
        ...
        {
            this.func_180480_a(this.mc.thePlayer.getBrightness(ticks), var2);
        }
        else
        {
        ...
        {
            var7 = this.mc.thePlayer.prevTimeInPortal + (this.mc.thePlayer.timeInPortal - this.mc.thePlayer.prevTimeInPortal) * ticks;
        ...
        {
            this.field_175197_u.func_175264_a(var2, ticks);
        }
        else
        {
            this.func_180479_a(var2, ticks);
        }
        ...
        if (this.recordPlayingUpFor > 0)
        {
            ...
            var7 = (float)this.recordPlayingUpFor - ticks;
        ...
        if (this.field_175195_w > 0)
        {
            ...
            var7 = (float)this.field_175195_w - ticks;
            var8 = 255;
        ...
        GlStateManager.enableAlpha();
        EventGameRender egr = new EventGameRender(ticks, var2);
        EventManager.call(egr);
    }

    private static boolean check(int i) {
		return i != Keyboard.KEY_W && i != Keyboard.KEY_A && i != Keyboard.KEY_S && i != Keyboard.KEY_D && i != Keyboard.KEY_SPACE && i != Keyboard.KEY_LSHIFT;
	}
