...
public class Minecraft implements IThreadListener, IPlayerUsage {
	...
	public MCTimerHook timer = new MCTimerHook(20.0F);
	...
	private void startGame() throws LWJGLException {
		...
		// TODO fix with a better method.
		(this.ruby = ClientBase.INSTANCE).setmgr.toString();
		...
		if (this.currentScreen == null || this.currentScreen.allowUserInput) {
			...
			while (Keyboard.next()) {
				...
				if (Keyboard.getEventKeyState()) {
					if (null != thePlayer && null != theWorld && currentScreen == null) {
						
					}
					ClientBase.INSTANCE.getModuleManager().modules.forEach(module -> {
						if (module.getKey() == Keyboard.getEventKey() && this.currentScreen == null
								&& 0 != module.getKey() && this.thePlayer != null && this.theWorld != null) {
							module.toggle();
						}
					});
