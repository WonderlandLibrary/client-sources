...
public  class OGLRender {
    ...
    public static void drawVerticalLine(float x, float y, float height, int color) {
        drawRect(x, y, x + 1, height, color);
    }

    public static void drawHorizontalLine(float x, float y, float width, final int color) {
     ...
     */
    public static void drawRect(float x, float y, float x1, float y1, long color) {
        enableGL2D();
        glColor(color);
        drawRect(x, y, x1, y1);
        disableGL2D();
    ...
    public static void drawBorderedRect(float x, float y, float x1, float y1, float width, int internalColor, int borderColor) {
        ...
        glColor(borderColor);
        drawVerticalLine(x, y, y1, borderColor);
        drawVerticalLine(x1, y, y1 + 1, borderColor);
        drawHorizontalLine(x, y, x1, borderColor);
        drawHorizontalLine(x, y1, x1, borderColor);
        disableGL2D();
    }
    ...
    public static void drawBorderedRect(float x, float y, float x1, float y1, int insideC, int borderC) {
        ...
        drawVerticalLine(x, y, y1, borderC);
        drawVerticalLine(x1, y, y1, borderC);
        drawHorizontalLine(x + 1, y, x1, borderC);
        drawHorizontalLine(x, y1, x1 + 1, borderC);
        glScalef(2.0F, 2.0F, 2.0F);
        disableGL2D();
    }


    public static void drawBorderedRectReliant(float x, float y, float x1, float y1, float lineWidth, long inside, long border) {
        enableGL2D();
     ...
     *
     * */
    public static void glColor(long hex) {
    ...
    public static Color getRandomColor(int saturationRandom, float luminance) {
        ...
        float saturation = ((float)Math.random() + 1000) / saturationRandom + 1000F;
    ...
    public static void drawTexturedModalRect(int par1, int par2, int par3, int par4, int par5, int par6) {
        ...
        VertexBuffer var9 = Tessellator.getInstance().getBuffer();
    ...
    public static double interpolate(double now, double then) {
        return then + (now - then) * Minecraft.getMinecraft().getTimer().renderPartialTicks;
    }
