...
public abstract class GenLayer {
	...
	protected static boolean biomesEqualOrMesaPlateau(int biomeIDA, int biomeIDB) {
		if (biomeIDA == biomeIDB) {
			...
			return (biome != null) && (biome1 != null) ? ((biome != Biomes.MESA_ROCK) && (biome != Biomes.MESA_CLEAR_ROCK) ? (biome == biome1) || (biome.getBiomeClass() == biome1.getBiomeClass())
					: (biome1 == Biomes.MESA_ROCK) || (biome1 == Biomes.MESA_CLEAR_ROCK)) : false;
		}
	}
								...
								: ((p_151617_1_ == p_151617_3_) && (p_151617_1_ == p_151617_4_) ? p_151617_1_
										: ((p_151617_1_ == p_151617_2_) && (p_151617_3_ != p_151617_4_) ? p_151617_1_
												: ((p_151617_1_ == p_151617_3_) && (p_151617_2_ != p_151617_4_) ? p_151617_1_
														: ((p_151617_1_ == p_151617_4_) && (p_151617_2_ != p_151617_3_) ? p_151617_1_
																: ((p_151617_2_ == p_151617_3_) && (p_151617_1_ != p_151617_4_) ? p_151617_2_
																		: ((p_151617_2_ == p_151617_4_) && (p_151617_1_ != p_151617_3_) ? p_151617_2_
																				: ((p_151617_3_ == p_151617_4_) && (p_151617_1_ != p_151617_2_) ? p_151617_3_
																						: this.selectRandom(new int[] { p_151617_1_, p_151617_2_, p_151617_3_, p_151617_4_ }))))))))));
	}
}
