...
public class ChunkProviderHell implements IChunkGenerator {
	...
	public List<Biome.SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos) {
		if (creatureType == EnumCreatureType.MONSTER) {
			if (this.genNetherBridge.isInsideStructure(pos)) { return this.genNetherBridge.getSpawnList(); }

			if (this.genNetherBridge.isPositionInStructure(this.world, pos) && (this.world.getBlockState(pos.down()).getBlock() == Blocks.NETHER_BRICK)) { return this.genNetherBridge.getSpawnList(); }
		}
