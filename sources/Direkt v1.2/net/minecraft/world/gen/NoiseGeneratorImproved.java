...
public class NoiseGeneratorImproved extends NoiseGenerator {
	/**
	 * An int[512], where the first 256 elements are the numbers 0..255, in random shuffled order, and the second half of the array is identical to the first half, apparently for convenience in wrapping lookups. Effectively a shuffled 0..255 that wraps once.
	 */
	 ...
	 */
	public void populateNoiseArray(double[] noiseArray, double xOffset, double yOffset, double zOffset, int xSize, int ySize, int zSize, double xScale, double yScale, double zScale,
			double noiseScale) {
		if (ySize == 1) {
			int i5 = 0;
			int j5 = 0;
