		...
		if ((j2 >= 1) && (j2 <= 5)) {
					...
					if (worldIn.isAirBlock(blockpos2)) {
						...
						if (j3 == 1) {
							...
							if (tileentity1 instanceof TileEntityChest) {
								((TileEntityChest) tileentity1).func_189404_a(LootTableList.CHESTS_SIMPLE_DUNGEON, rand.nextLong());
							}
			...
			if (tileentity instanceof TileEntityMobSpawner) {
				...
				LOGGER.error("Failed to fetch mob spawner entity at ({}, {}, {})",
						new Object[] { Integer.valueOf(position.getX()), Integer.valueOf(position.getY()), Integer.valueOf(position.getZ()) });
			}
