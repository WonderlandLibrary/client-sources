...
public class MapGenCavesHell extends MapGenBase {
	...
	protected void addTunnel(long p_180704_1_, int p_180704_3_, int p_180704_4_, ChunkPrimer p_180704_5_, double p_180704_6_, double p_180704_8_, double p_180704_10_, float p_180704_12_,
		...
		for (boolean flag = random.nextInt(6) == 0; p_180704_15_ < p_180704_16_; ++p_180704_15_) {
			double d2 = 1.5D + MathHelper.sin((p_180704_15_ * (float) Math.PI) / p_180704_16_) * p_180704_12_;
			...
			if (!flag1 && (p_180704_15_ == j) && (p_180704_12_ > 1.0F)) {
				this.addTunnel(random.nextLong(), p_180704_3_, p_180704_4_, p_180704_5_, p_180704_6_, p_180704_8_, p_180704_10_, (random.nextFloat() * 0.5F) + 0.5F,
				...
				if ((p_180704_6_ >= (d0 - 16.0D - (d2 * 2.0D))) && (p_180704_10_ >= (d1 - 16.0D - (d2 * 2.0D))) && (p_180704_6_ <= (d0 + 16.0D + (d2 * 2.0D)))
					...
					if (!flag2) {
						for (int i3 = j2; i3 < k; ++i3) {
							double d10 = ((i3 + (p_180704_3_ * 16) + 0.5D) - p_180704_6_) / d2;

							for (int j3 = l2; j3 < i1; ++j3) {
								double d8 = ((j3 + (p_180704_4_ * 16) + 0.5D) - p_180704_10_) / d2;

								for (int i2 = l; i2 > k2; --i2) {
									double d9 = ((i2 - 1 + 0.5D) - p_180704_8_) / d3;
