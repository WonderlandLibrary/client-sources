...
public class BiomeTaiga extends Biome {
	...
	public WorldGenAbstractTree genBigTreeChance(Random rand) {
		return ((this.type == BiomeTaiga.Type.MEGA) || (this.type == BiomeTaiga.Type.MEGA_SPRUCE)) && (rand.nextInt(3) == 0)
				? ((this.type != BiomeTaiga.Type.MEGA_SPRUCE) && (rand.nextInt(13) != 0) ? MEGA_PINE_GENERATOR : MEGA_SPRUCE_GENERATOR) : (rand.nextInt(3) == 0 ? PINE_GENERATOR : SPRUCE_GENERATOR);
	}
