...
public abstract class MinecraftServer implements Runnable, ICommandSender, IThreadListener, ISnooperInfo {
	...
	public MinecraftServer(File anvilFileIn, Proxy proxyIn, DataFixer dataFixerIn, YggdrasilAuthenticationService authServiceIn, MinecraftSessionService sessionServiceIn,
			...
			if (this.startServer()) {
				...
				while (this.serverRunning) {
					...
					if ((j > 2000L) && ((this.currentTime - this.timeOfLastWarning) >= 15000L)) {
						LOG.warn("Can\'t keep up! Did the system time change, or is the server overloaded? Running {}ms behind, skipping {} tick(s)",
