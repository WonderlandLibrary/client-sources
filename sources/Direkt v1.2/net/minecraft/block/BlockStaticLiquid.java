...
public class BlockStaticLiquid extends BlockLiquid {
	...
	public void func_189540_a(IBlockState p_189540_1_, World p_189540_2_, BlockPos p_189540_3_, Block p_189540_4_) {
		if (!this.checkForMixing(p_189540_2_, p_189540_3_, p_189540_1_)) {
			this.updateLiquid(p_189540_2_, p_189540_3_, p_189540_1_);
		}
	}
			...
			if (worldIn.getGameRules().getBoolean("doFireTick")) {
				...
				if (i > 0) {
					...
					for (int k = 0; k < 3; ++k) {
						...
						if ((blockpos1.getY() >= 0) && (blockpos1.getY() < 256) && !worldIn.isBlockLoaded(blockpos1)) { return; }
