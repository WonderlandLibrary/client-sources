	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
		...
		if ((slot != null) && slot.getHasStack()) {
			...
			if (index < this.horseInventory.getSizeInventory()) {
				if (!this.mergeItemStack(itemstack1, this.horseInventory.getSizeInventory(), this.inventorySlots.size(), true)) { return null; }
			...
			} else if ((this.horseInventory.getSizeInventory() <= 2) || !this.mergeItemStack(itemstack1, 2, this.horseInventory.getSizeInventory(), false)) { return null; }
