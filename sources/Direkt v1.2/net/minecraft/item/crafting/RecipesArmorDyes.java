		...
		for (int i = 0; i < inv.getSizeInventory(); ++i) {
			...
			if (itemstack1 != null) {
				if (itemstack1.getItem() instanceof ItemArmor) {
					...
					if ((itemarmor.getArmorMaterial() != ItemArmor.ArmorMaterial.LEATHER) || (itemstack != null)) { return false; }
		...
		for (int k = 0; k < inv.getSizeInventory(); ++k) {
			...
			if (itemstack1 != null) {
				if (itemstack1.getItem() instanceof ItemArmor) {
					...
					if ((itemarmor.getArmorMaterial() != ItemArmor.ArmorMaterial.LEATHER) || (itemstack != null)) { return null; }
