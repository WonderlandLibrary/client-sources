		...
		for (int i = 0; i < inv.getSizeInventory(); ++i) {
			...
			if (itemstack != null) {
				...
				if (list.size() > 1) {
					...
					if ((itemstack.getItem() != itemstack1.getItem()) || (itemstack1.stackSize != 1) || (itemstack.stackSize != 1) || !itemstack1.getItem().isDamageable()) { return false; }
				}
			}
		}
		...
		for (int i = 0; i < inv.getSizeInventory(); ++i) {
			...
			if (itemstack != null) {
				...
				if (list.size() > 1) {
					...
					if ((itemstack.getItem() != itemstack1.getItem()) || (itemstack1.stackSize != 1) || (itemstack.stackSize != 1) || !itemstack1.getItem().isDamageable()) { return null; }
				}
			}
		}
