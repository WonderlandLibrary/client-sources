...
public class Style {
	...
	@Override
	public String toString() {
		return "Style{hasParent=" + (this.parentStyle != null) + ", color=" + this.color + ", bold=" + this.bold + ", italic=" + this.italic + ", underlined=" + this.underlined + ", obfuscated="
				+ this.obfuscated + ", clickEvent=" + this.getClickEvent() + ", hoverEvent=" + this.getHoverEvent() + ", insertion=" + this.getInsertion() + '}';
	}
	...
	public boolean equals(Object p_equals_1_) {
		if (this == p_equals_1_) {
			...
			label0: {
				...
				if ((this.getBold() == style.getBold()) && (this.getColor() == style.getColor()) && (this.getItalic() == style.getItalic()) && (this.getObfuscated() == style.getObfuscated())
						&& (this.getStrikethrough() == style.getStrikethrough()) && (this.getUnderlined() == style.getUnderlined())) {
					label85: {
