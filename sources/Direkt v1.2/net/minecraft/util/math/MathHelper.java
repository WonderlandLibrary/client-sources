...
public class MathHelper {
	...
	/**
	 * Rounds the first parameter up to the next interval of the second parameter. For instance, {@code roundUp(1, 4)} returns 4; {@code roundUp(0, 4)} returns 0; and {@code roundUp(4, 4)} returns 4.
	 */
	...
	static {
		...
		for (int k = 0; k < 360; k += 90) {
			SIN_TABLE_FAST[(int) (k * 11.377778F) & 4095] = (float) Math.sin(k * 0.017453292F);
		}
