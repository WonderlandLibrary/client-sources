...
public abstract class TabCompleter {
	...
	/**
	 * Called when tab key pressed. If it's the first time we tried to complete this string, we ask the server for completions. When the server responds, this method gets called again (via setCompletions).
	 */
