...
public class ReflectorClass {
	...
	public ReflectorClass(String p_i65_1_) {
		this(p_i65_1_, false);
	}

	public ReflectorClass(String p_i66_1_, boolean p_i66_2_) {
		this.targetClassName = null;
		this.checked = false;
		this.targetClass = null;
		this.targetClassName = p_i66_1_;
	...
	public ReflectorClass(Class p_i67_1_) {
		this.targetClassName = null;
		this.checked = false;
		this.targetClass = null;
		this.targetClass = p_i67_1_;
		this.targetClassName = p_i67_1_.getName();
		this.checked = true;
	}
