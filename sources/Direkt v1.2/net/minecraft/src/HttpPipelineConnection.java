...
public class HttpPipelineConnection {
	...
	public HttpPipelineConnection(String p_i37_1_, int p_i37_2_) {
		this(p_i37_1_, p_i37_2_, Proxy.NO_PROXY);
	}

	public HttpPipelineConnection(String p_i38_1_, int p_i38_2_, Proxy p_i38_3_) {
		this.host = null;
		this.port = 0;
