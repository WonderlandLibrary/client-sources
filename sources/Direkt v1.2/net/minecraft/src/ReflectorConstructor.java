...
public class ReflectorConstructor {
	...
	public ReflectorConstructor(ReflectorClass p_i68_1_, Class[] p_i68_2_) {
		this.reflectorClass = p_i68_1_;
		this.parameterTypes = p_i68_2_;
	...
	private static Constructor findConstructor(Class p_findConstructor_0_, Class[] p_findConstructor_1_) {
		...
		for (Constructor constructor : aconstructor) {
			...
			if (Reflector.matchesTypes(p_findConstructor_1_, aclass)) { return constructor; }
		}
