...
//              TODO: Direkt: EventPreMotionUpdate
              Direkt.getInstance().getEventManager().call(new EventPreMotionUpdate());
                this.onUpdateWalkingPlayer();
//              TODO: Direkt: EventPostMotionUpdate
              Direkt.getInstance().getEventManager().call(new EventPostMotionUpdate());
			}
		}
	}
									...
									if (axisalignedbb2.func_189973_a(vec3d7, vec3d8) || axisalignedbb2.func_189973_a(vec3d9, vec3d10)) {
										...
										while (true) {
											...
											if ((axisalignedbb1 = iblockstate2.getCollisionBoundingBox(this.worldObj, blockpos2)) != null) {
												...
												if ((f11 - this.getEntityBoundingBox().minY) > f7) { return; }
											}
											...
											if (i > 1) {
												...
												if (iblockstate3.getCollisionBoundingBox(this.worldObj, blockpos) != null) { return; }
											}
