        ...
        protected void mouseDragged(Minecraft mc, int mouseX, int mouseY) {
            if (this.visible) {
                if (this.pressed) {
                    ...
                    OGLRender.drawBorderedRectReliant(this.xPosition + (int)(this.volume * (float)(this.width - 8)) + 2, this.yPosition, this.xPosition + (int)(this.volume * (float)(this.width - 8)) + 6, this.yPosition + 20, 0.5f, 0x406FF358, -1);
                } else {
                    OGLRender.drawGradientBorderedRectReliant(this.xPosition + (int)(this.volume * (float)(this.width - 8)) + 2, this.yPosition, this.xPosition + (int)(this.volume * (float)(this.width - 8)) + 6, this.yPosition + 20, 0.5f, -1, 0x40000000, 0x50000000);
                }
