...
public class GuiScreenAddServer extends GuiScreen {
	...
	public void initGui() {
		...
		this.serverResourcePacks = this.func_189646_b(new GuiButton(2, (this.width / 2) - 100, (this.height / 4) + 72,
				I18n.format("addServer.resourcePack", new Object[0]) + ": " + this.serverData.getResourceMode().getMotd().getFormattedText()));
