...
public class GuiCustomizeSkin extends GuiScreen {
	...
	public void initGui() {
		...
		for (EnumPlayerModelParts enumplayermodelparts : EnumPlayerModelParts.values()) {
			this.buttonList.add(
					new GuiCustomizeSkin.ButtonPart(enumplayermodelparts.getPartId(), ((this.width / 2) - 155) + ((i % 2) * 160), (this.height / 6) + (24 * (i >> 1)), 150, 20, enumplayermodelparts));
			++i;
		}

		this.buttonList.add(new GuiOptionButton(199, ((this.width / 2) - 155) + ((i % 2) * 160), (this.height / 6) + (24 * (i >> 1)), GameSettings.Options.MAIN_HAND,
