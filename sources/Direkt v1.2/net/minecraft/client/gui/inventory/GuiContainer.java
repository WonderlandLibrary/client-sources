...
public abstract class GuiContainer extends GuiScreen {
	...
	protected void mouseClickMove(int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick) {
		...
		} else if (this.dragSplitting && (slot != null) && (itemstack != null) && (itemstack.stackSize > this.dragSplittingSlots.size()) && Container.canAddItemToSlot(slot, itemstack, true)
				&& slot.isItemValid(itemstack) && this.inventorySlots.canDragIntoSlot(slot)) {
			...
			if (isShiftKeyDown()) {
				if ((slot != null) && (slot.inventory != null) && (this.shiftClickedSlot != null)) {
					for (Slot slot2 : this.inventorySlots.inventorySlots) {
						if ((slot2 != null) && slot2.canTakeStack(this.mc.thePlayer) && slot2.getHasStack() && (slot2.inventory == slot.inventory)
    ...
    {
    	//TODO Render MoreInventory Items
        if (this.mc.thePlayer != null && !Direkt.getInstance().getModuleManager().getModule(MoreInventory.class).isRunning())
        {
