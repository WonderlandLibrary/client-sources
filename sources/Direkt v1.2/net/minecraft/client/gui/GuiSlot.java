...
public abstract class GuiSlot {
	...
	public void drawScreen(int mouseXIn, int mouseYIn, float partialTicks) {
		if (this.visible) {
			...
			vertexbuffer.pos(this.left, this.bottom, 0.0D).tex(this.left / 32.0F, (this.bottom + (int) this.amountScrolled) / 32.0F).color(32, 32, 32, 255).endVertex();
			vertexbuffer.pos(this.right, this.bottom, 0.0D).tex(this.right / 32.0F, (this.bottom + (int) this.amountScrolled) / 32.0F).color(32, 32, 32, 255).endVertex();
			vertexbuffer.pos(this.right, this.top, 0.0D).tex(this.right / 32.0F, (this.top + (int) this.amountScrolled) / 32.0F).color(32, 32, 32, 255).endVertex();
			vertexbuffer.pos(this.left, this.top, 0.0D).tex(this.left / 32.0F, (this.top + (int) this.amountScrolled) / 32.0F).color(32, 32, 32, 255).endVertex();
			tessellator.draw();
			...
			vertexbuffer.pos(this.right, this.top, 0.0D).tex(1.0D, 0.0D).color(0, 0, 0, 255).endVertex();
			vertexbuffer.pos(this.left, this.top, 0.0D).tex(0.0D, 0.0D).color(0, 0, 0, 255).endVertex();
			tessellator.draw();
			vertexbuffer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
			vertexbuffer.pos(this.left, this.bottom, 0.0D).tex(0.0D, 1.0D).color(0, 0, 0, 255).endVertex();
			vertexbuffer.pos(this.right, this.bottom, 0.0D).tex(1.0D, 1.0D).color(0, 0, 0, 255).endVertex();
	...
	protected void overlayBackground(int startY, int endY, int startAlpha, int endAlpha) {
		...
		float f = 32.0F;
		vertexbuffer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
		vertexbuffer.pos(this.left, endY, 0.0D).tex(0.0D, endY / 32.0F).color(64, 64, 64, endAlpha).endVertex();
		vertexbuffer.pos(this.left + this.width, endY, 0.0D).tex(this.width / 32.0F, endY / 32.0F).color(64, 64, 64, endAlpha).endVertex();
		vertexbuffer.pos(this.left + this.width, startY, 0.0D).tex(this.width / 32.0F, startY / 32.0F).color(64, 64, 64, startAlpha).endVertex();
		vertexbuffer.pos(this.left, startY, 0.0D).tex(0.0D, startY / 32.0F).color(64, 64, 64, startAlpha).endVertex();
		tessellator.draw();
	}
