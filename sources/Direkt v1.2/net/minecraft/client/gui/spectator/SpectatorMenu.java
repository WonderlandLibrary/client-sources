...
public class SpectatorMenu {
	...
	public ISpectatorMenuObject getItem(int p_178643_1_) {
		...
		return (this.page > 0) && (p_178643_1_ == 0) ? SCROLL_LEFT
				: (p_178643_1_ == 7 ? (i < this.category.getItems().size() ? SCROLL_RIGHT_ENABLED : SCROLL_RIGHT_DISABLED)
						: (p_178643_1_ == 8 ? CLOSE_ITEM
								: ((i >= 0) && (i < this.category.getItems().size()) ? (ISpectatorMenuObject) Objects.firstNonNull(this.category.getItems().get(i), EMPTY_SLOT) : EMPTY_SLOT)));
	}
