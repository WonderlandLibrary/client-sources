...
public class RenderDragon extends RenderLiving<EntityDragon> {
	...
	public void doRender(EntityDragon entity, double x, double y, double z, float entityYaw, float partialTicks) {
		...
		if (entity.healingEnderCrystal != null) {
			...
			f = ((f * f) + f) * 0.2F;
			renderCrystalBeams(x, y, z, partialTicks, entity.posX + ((entity.prevPosX - entity.posX) * (1.0F - partialTicks)), entity.posY + ((entity.prevPosY - entity.posY) * (1.0F - partialTicks)),
					entity.posZ + ((entity.prevPosZ - entity.posZ) * (1.0F - partialTicks)), entity.ticksExisted, entity.healingEnderCrystal.posX, f + entity.healingEnderCrystal.posY,
					entity.healingEnderCrystal.posZ);
		}
	}

	public static void renderCrystalBeams(double p_188325_0_, double p_188325_2_, double p_188325_4_, float p_188325_6_, double p_188325_7_, double p_188325_9_, double p_188325_11_, int p_188325_13_,
			double p_188325_14_, double p_188325_16_, double p_188325_18_) {
		...
		float f6 = (MathHelper.sqrt_float((f * f) + (f1 * f1) + (f2 * f2)) / 32.0F) - ((p_188325_13_ + p_188325_6_) * 0.01F);
