		...
		(new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet()) {
			...
			public void run() {
				...
				try {
					...
					GuiConnecting.this.networkManager.sendPacket(new C00Handshake(210, ip, port, EnumConnectionState.LOGIN));
					...
					GuiConnecting.this.mc.displayGuiScreen(
							new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new TextComponentTranslation("disconnect.genericReason", new Object[] { "Unknown host" })));
					...
					GuiConnecting.this.mc.displayGuiScreen(
							new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new TextComponentTranslation("disconnect.genericReason", new Object[] { s })));
				}
			}
		}).start();
	}
