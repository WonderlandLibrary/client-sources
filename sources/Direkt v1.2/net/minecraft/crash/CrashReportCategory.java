...
public class CrashReportCategory {
	...
	public static String getCoordinateInfo(int x, int y, int z) {
		...
		try {
			...
			int l1 = ((i + 1) << 4) - 1;
			int i2 = ((j + 1) << 4) - 1;
			stringbuilder.append(String.format("Chunk: (at %d,%d,%d in %d,%d; contains blocks %d,0,%d to %d,255,%d)", new Object[] { Integer.valueOf(k), Integer.valueOf(l), Integer.valueOf(i1),
					Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(j1), Integer.valueOf(k1), Integer.valueOf(l1), Integer.valueOf(i2) }));
		...
		try {
			...
			int k4 = ((k2 + 1) << 9) - 1;
			int j2 = ((l2 + 1) << 9) - 1;
			stringbuilder.append(String.format("Region: (%d,%d; contains chunks %d,%d to %d,%d, blocks %d,0,%d to %d,255,%d)", new Object[] { Integer.valueOf(k2), Integer.valueOf(l2),
					Integer.valueOf(i3), Integer.valueOf(j3), Integer.valueOf(k3), Integer.valueOf(l3), Integer.valueOf(i4), Integer.valueOf(j4), Integer.valueOf(k4), Integer.valueOf(j2) }));
	...
	public boolean firstTwoElementsOfStackTraceMatch(StackTraceElement s1, StackTraceElement s2) {
		if ((this.stackTrace.length != 0) && (s1 != null)) {
			...
			if ((stacktraceelement.isNativeMethod() == s1.isNativeMethod()) && stacktraceelement.getClassName().equals(s1.getClassName()) && stacktraceelement.getFileName().equals(s1.getFileName())
