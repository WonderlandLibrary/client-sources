...
public class EntityHorse extends EntityAnimal implements IInventoryChangedListener, IJumpingMount {
	...
	private static final String[] HORSE_TEXTURES = new String[] { "textures/entity/horse/horse_white.png", "textures/entity/horse/horse_creamy.png", "textures/entity/horse/horse_chestnut.png",
	...
	private static final String[] HORSE_MARKING_TEXTURES = new String[] { null, "textures/entity/horse/horse_markings_white.png", "textures/entity/horse/horse_markings_whitefield.png",
	...
	private void eatingHorse() {
		...
		if (!this.isSilent()) {
			this.worldObj.playSound((EntityPlayer) null, this.posX, this.posY, this.posZ, SoundEvents.ENTITY_HORSE_EAT, this.getSoundCategory(), 1.0F,
	...
	public void fall(float distance, float damageMultiplier) {
		...
		if (i > 0) {
			...
			if ((iblockstate.getMaterial() != Material.AIR) && !this.isSilent()) {
				...
				this.worldObj.playSound((EntityPlayer) null, this.posX, this.posY, this.posZ, soundtype.getStepSound(), this.getSoundCategory(), soundtype.getVolume() * 0.5F,
	...
	public void onLivingUpdate() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (!this.isEatingHaystack() && !this.isBeingRidden() && (this.rand.nextInt(300) == 0) && (this.worldObj
					.getBlockState(new BlockPos(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY) - 1, MathHelper.floor_double(this.posZ))).getBlock() == Blocks.GRASS)) {
	...
	protected void spawnHorseParticles(boolean p_110216_1_) {
		...
		for (int i = 0; i < 7; ++i) {
			...
			this.worldObj.spawnParticle(enumparticletypes, (this.posX + this.rand.nextFloat() * this.width * 2.0F) - this.width, this.posY + 0.5D + this.rand.nextFloat() * this.height,
