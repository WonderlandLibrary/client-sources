...
public class EntityMinecartTNT extends EntityMinecart {
	...
	public float getExplosionResistance(Explosion explosionIn, World worldIn, BlockPos pos, IBlockState blockStateIn) {
		return !this.isIgnited() || (!BlockRailBase.isRailBlock(blockStateIn) && !BlockRailBase.isRailBlock(worldIn, pos.up())) ? super.getExplosionResistance(explosionIn, worldIn, pos, blockStateIn)
				: 0.0F;
	}
	...
	public boolean verifyExplosion(Explosion explosionIn, World worldIn, BlockPos pos, IBlockState blockStateIn, float p_174816_5_) {
		return !this.isIgnited() || (!BlockRailBase.isRailBlock(blockStateIn) && !BlockRailBase.isRailBlock(worldIn, pos.up()))
				? super.verifyExplosion(explosionIn, worldIn, pos, blockStateIn, p_174816_5_) : false;
	}
