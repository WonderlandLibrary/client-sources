	...
	public void onUpdateMoveHelper() {
		if (this.action == EntityMoveHelper.Action.STRAFE) {
			...
			if (pathnavigate != null) {
				...
				if ((nodeprocessor != null) && (nodeprocessor.getPathNodeType(this.entity.worldObj, MathHelper.floor_double(this.entity.posX + f7), MathHelper.floor_double(this.entity.posY),
						MathHelper.floor_double(this.entity.posZ + f8)) != PathNodeType.WALKABLE)) {
