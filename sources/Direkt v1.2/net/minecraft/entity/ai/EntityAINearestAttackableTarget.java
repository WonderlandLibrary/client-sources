...
public class EntityAINearestAttackableTarget<T extends EntityLivingBase> extends EntityAITarget {
		...
		this.targetEntitySelector = new Predicate<T>() {
			...
			public boolean apply(@Nullable T p_apply_1_) {
				return p_apply_1_ == null ? false
						: ((targetSelector != null) && !targetSelector.apply(p_apply_1_) ? false
								: (!EntitySelectors.NOT_SPECTATING.apply(p_apply_1_) ? false : EntityAINearestAttackableTarget.this.isSuitableTarget(p_apply_1_, false)));
			}
		};
	}
	...
	public boolean shouldExecute() {
		if ((this.targetChance > 0) && (this.taskOwner.getRNG().nextInt(this.targetChance) != 0)) {
			...
			this.targetEntity = (T) this.taskOwner.worldObj.getNearestAttackablePlayer(this.taskOwner.posX, this.taskOwner.posY + this.taskOwner.getEyeHeight(), this.taskOwner.posZ,
					this.getTargetDistance(), this.getTargetDistance(), new Function<EntityPlayer, Double>() {
						...
						public Double apply(@Nullable EntityPlayer p_apply_1_) {
							...
							if ((itemstack != null) && (itemstack.getItem() == Items.SKULL)) {
								...
								boolean flag = (EntityAINearestAttackableTarget.this.taskOwner instanceof EntitySkeleton)
										&& (((EntitySkeleton) EntityAINearestAttackableTarget.this.taskOwner).func_189771_df() == SkeletonType.NORMAL) && (i == 0);
								...
								if (flag || flag1 || flag2) { return Double.valueOf(0.5D); }
							}
