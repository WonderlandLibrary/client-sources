...
public abstract class EntityHanging extends Entity {
	...
	public EntityItem entityDropItem(ItemStack stack, float offsetY) {
		EntityItem entityitem = new EntityItem(this.worldObj, this.posX + this.facingDirection.getFrontOffsetX() * 0.15F, this.posY + offsetY,
				this.posZ + this.facingDirection.getFrontOffsetZ() * 0.15F, stack);
