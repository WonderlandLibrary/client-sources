...
public class EnchantmentDamage extends Enchantment {
	...
	public float calcDamageByCreature(int level, EnumCreatureAttribute creatureType) {
		return this.damageType == 0 ? 1.0F + (Math.max(0, level - 1) * 0.5F)
				: ((this.damageType == 1) && (creatureType == EnumCreatureAttribute.UNDEAD) ? level * 2.5F
						: ((this.damageType == 2) && (creatureType == EnumCreatureAttribute.ARTHROPOD) ? level * 2.5F : 0.0F));
	}
