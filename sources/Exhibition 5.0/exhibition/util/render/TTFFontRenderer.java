...
public class TTFFontRenderer
{
    ...
    public TTFFontRenderer(final Font font, final boolean disableAA) {
        this(font, 256, disableAA);
    }
    
    public TTFFontRenderer(final Font font, final int characterCount, final boolean disableAA) {
        this(font, characterCount, true, disableAA);
    }
    
    public TTFFontRenderer(final Font font, final int characterCount, final boolean fractionalMetrics, final boolean disableAA) {
