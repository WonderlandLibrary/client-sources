...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            double var12 = z;
            final boolean var13 = this.onGround && (this.isSneaking() || Client.getModuleManager().get(Scaffold.class).isEnabled()) && this instanceof EntityPlayer;
            if (var13) {
            ...
            final EventStep em = (EventStep)EventSystem.getInstance(EventStep.class);
            if (this == Minecraft.getMinecraft().thePlayer) {
                em.fire(true, this.stepHeight);
            }
            final double var22 = x;
            final double var23 = y;
            final double var24 = z;
            if ((var22 * var22 + var24 * var24 >= x * x + z * z || em.isActive()) && em.getStepHeight() > 0.0 && var19 && (var10 != x || var12 != z)) {
                ...
                if (var22 * var22 + var24 * var24 >= x * x + z * z) {
                    ...
                    em.fire(false, this.stepHeight, 1.0 + y);
                }
            }
            this.worldObj.theProfiler.endSection();
            ...
            this.onGround = ((Client.getModuleManager().get(Fly.class).isEnabled() && this == Minecraft.getMinecraft().thePlayer) || (this.isCollidedVertically && var11 < 0.0));
    ...
    protected final Vec3 func_174806_f(final float yaw, final float pitch) {
        final float p1 = MathHelper.cos(-pitch * 0.017453292f - 3.1415927f);
        final float p2 = MathHelper.sin(-pitch * 0.017453292f - 3.1415927f);
        final float y1 = -MathHelper.cos(-yaw * 0.017453292f);
        final float y2 = MathHelper.sin(-yaw * 0.017453292f);
    ...
    public Vec3 func_174824_e(final float partial) {
        ...
        final double var2 = this.prevPosX + (this.posX - this.prevPosX) * partial;
        final double var3 = this.prevPosY + (this.posY - this.prevPosY) * partial + this.getEyeHeight();
        final double var4 = this.prevPosZ + (this.posZ - this.prevPosZ) * partial;
