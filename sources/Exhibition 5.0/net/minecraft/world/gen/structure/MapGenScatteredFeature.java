...
public class MapGenScatteredFeature extends MapGenStructure
{
    ...
    protected boolean canSpawnStructureAtCoords(int p_75047_1_, int p_75047_2_) {
        ...
        if (var3 == var5 && var4 == var6) {
            final BiomeGenBase var8 = this.worldObj.getWorldChunkManager().func_180631_a(new BlockPos(var3 * 16 + 8, 0, var4 * 16 + 8));
            if (var8 == null) {
                return false;
            }
    ...
    public boolean func_175798_a(final BlockPos p_175798_1_) {
        final StructureStart var2 = this.func_175797_c(p_175798_1_);
        if (var2 != null && var2 instanceof Start && !var2.components.isEmpty()) {
            final StructureComponent var3 = var2.components.getFirst();
