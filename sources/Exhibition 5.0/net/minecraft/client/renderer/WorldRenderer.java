...
public class WorldRenderer
{
    ...
    public void setColorRGBA(final float p_178960_1_, final float p_178960_2_, final float p_178960_3_, final float p_178960_4_) {
    ...
    public void func_178978_a(final float r, final float g, final float b, final int indx) {
        final int index = this.getGLCallListForPass(indx);
        ...
        if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
            iR = (int)((color & 0xFF) * r);
            iG = (int)((color >> 8 & 0xFF) * g);
            iB = (int)((color >> 16 & 0xFF) * b);
            color &= 0xFF000000;
            color |= (iB << 16 | iG << 8 | iR);
        }
        else {
            iR = (int)((this.field_179007_h >> 24 & 0xFF) * r);
            iG = (int)((this.field_179007_h >> 16 & 0xFF) * g);
            iB = (int)((this.field_179007_h >> 8 & 0xFF) * b);
            color &= 0xFF;
        ...
        final Xray x = Client.getModuleManager().get(Xray.class);
        if (x.isEnabled()) {
    ...
    public void drawColor(final int p_178974_1_, final int p_178974_2_) {
        final int var3 = p_178974_1_ >> 16 & 0xFF;
        final int var4 = p_178974_1_ >> 8 & 0xFF;
        final int var5 = p_178974_1_ & 0xFF;
        this.func_178961_b(var3, var4, var5, p_178974_2_);
