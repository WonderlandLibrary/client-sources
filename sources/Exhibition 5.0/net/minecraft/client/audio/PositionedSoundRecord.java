...
public class PositionedSoundRecord extends PositionedSound
{
    ...
    public static PositionedSoundRecord createPositionedSoundRecord(final ResourceLocation soundResource, final float pitch) {
    ...
    public static PositionedSoundRecord createRecordSoundAtPosition(final ResourceLocation soundResource, final float xPosition, final float yPosition, final float zPosition) {
