...
public class GuiLabel extends Gui
{
    ...
    public void drawLabel(final Minecraft mc, final int mouseX, final int mouseY) {
        if (this.visible) {
            ...
            for (int var6 = 0; var6 < this.field_146173_k.size(); ++var6) {
                if (this.centered) {
                    this.drawCenteredString(this.fontRenderer, this.field_146173_k.get(var6), this.field_146162_g + this.field_146167_a / 2, var5 + var6 * 10, this.field_146168_n);
                }
                else {
    ...
    protected void drawLabelBackground(final Minecraft mcIn, final int p_146160_2_, final int p_146160_3_) {
        if (this.labelBgEnabled) {
            ...
            Gui.drawVerticalLine(var6, var7, var7 + var5, this.field_146166_p);
            Gui.drawVerticalLine(var6 + var4, var7, var7 + var5, this.field_146165_q);
        }
    }
}
