    ...
    public void initGui() {
        ...
        for (final GameSettings.Options var5 : GuiOptions.field_146440_f) {
            if (var5.getEnumFloat()) {
                ...
                final GuiOptionButton var6 = new GuiOptionButton(var5.returnEnumOrdinal(), this.width / 2 - 155 + var1 % 2 * 160, this.height / 6 - 12 + 24 * (var1 >> 1), var5, this.game_settings_1.getKeyBinding(var5));
