...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    protected String customizeWorldSettings;
    protected String pageXofY;
    protected String basicSettings;
    ...
    public GuiCustomizeWorldScreen(final GuiScreen p_i45521_1_, final String p_i45521_2_) {
        this.customizeWorldSettings = "Customize World Settings";
        this.pageXofY = "Page 1 of 3";
        this.basicSettings = "Basic Settings";
    ...
    public void func_175320_a(final int p_175320_1_, final float p_175320_2_) {
        ...
        if (p_175320_1_ >= 100 && p_175320_1_ < 116) {
            final Gui var3 = this.guiPageButtonList.func_178061_c(p_175320_1_ - 100 + 132);
            if (var3 != null) {
            ...
            switch (button.id) {
                ...
                case 301: {
                    for (int var2 = 0; var2 < this.guiPageButtonList.getSize(); ++var2) {
                        final GuiPageButtonList.GuiEntry var3 = this.guiPageButtonList.func_178070_d(var2);
    ...
    private void func_175331_h() throws IOException {
        switch (this.field_175339_B) {
            case 300: {
                this.actionPerformed((GuiButton)this.guiPageButtonList.func_178061_c(300));
                break;
            }
            case 304: {
                this.func_175326_g();
    ...
    private void func_175328_i() {
        ...
        this.pageXofY = I18n.format("book.pageIndicator", this.guiPageButtonList.func_178059_e() + 1, this.guiPageButtonList.func_178057_f());
    ...
    private void func_175327_a(final float p_175327_1_) {
        final Gui var2 = this.guiPageButtonList.func_178056_g();
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.field_175339_B != 0) {
            ...
            Gui.drawVerticalLine(this.width / 2 - 91, 99, 185, -2039584);
            Gui.drawVerticalLine(this.width / 2 + 90, 99, 185, -6250336);
