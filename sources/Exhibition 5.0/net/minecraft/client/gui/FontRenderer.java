...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    public int drawString(final String text, final float x, final float y, final int color) {
        return this.enabled ? this.renderText(text, x, y, color, false) : 0;
    }
    
    public int renderText(final String text, final float x, final float y, final int color, final boolean shadow) {
