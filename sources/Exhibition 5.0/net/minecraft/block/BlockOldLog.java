...
public class BlockOldLog extends BlockLog
{
    ...
    public BlockOldLog() {
        this.setDefaultState(this.blockState.getBaseState().withProperty(BlockOldLog.VARIANT_PROP, BlockPlanks.EnumType.OAK).withProperty(BlockLog.AXIS_PROP, EnumAxis.Y));
    }
    ...
    public int getMetaFromState(final IBlockState state) {
        ...
        switch (SwitchEnumAxis.field_180203_a[((EnumAxis)state.getValue(BlockLog.AXIS_PROP)).ordinal()]) {
            case 1: {
                var3 |= 0x4;
                break;
            }
