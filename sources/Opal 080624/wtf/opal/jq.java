...
public final class jq extends d {
  private static final long a = on.a(8328872064839083414L, 7082792411555323330L, MethodHandles.lookup().lookupClass()).a(52942636785343L);
  ...
  public jq(long paramLong) {
    // Byte code:
    //   0: getstatic wtf/opal/jq.a : J
    //   3: lload_1
    //   4: lxor
    //   5: lstore_1
    //   6: lload_1
    //   7: dup2
    //   8: ldc2_w 24945565017690
    //   11: lxor
    //   12: lstore_3
    //   13: pop2
    //   14: aload_0
    //   15: sipush #1174
    //   18: ldc2_w 8831099044999481111
    //   21: lload_1
    //   22: lxor
    //   23: <illegal opcode> n : (IJ)Ljava/lang/String;
    //   28: lload_3
    //   29: sipush #5313
    //   32: ldc2_w 2636501153738315585
    //   35: lload_1
    //   36: lxor
  ...
  static {
    ...
    boolean bool = false;
    String str;
    int i = (str = "¾ÿÑß\021y\001É\021È\r¶çÆ¶á]ê6ÛC?\007¡ekk£Æ`£W£3±ÕFÆî\025§WuJÖKrX¶3:)\031 ò\022ai\032\fÄþ$1þDçmS\037g¡4òÁ_\005:IþÈè[?º>\0064ë)SsMZ\"ö½Ef5\003eDªOA7üqy").length();
    byte b2 = 32;
    byte b = -1;
    while (true);
  }
  ...
  private static String a(int paramInt, long paramLong) {
    int i = paramInt ^ (int)(paramLong & 0x7FFFL) ^ 0x3FB2;
    if (d[i] == null) {
      ...
      try {
        ...
        throw new RuntimeException("wtf/opal/jq", exception);
      } 
...
/* Location:              C:\Users\Administrator\Downloads\Opal 080624 ez\Opal.jar!\wtf\opal\jq.class
