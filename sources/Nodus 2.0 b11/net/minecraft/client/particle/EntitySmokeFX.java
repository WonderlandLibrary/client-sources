...
/*  5:   */ 
/*  6:   */ public class EntitySmokeFX
/*  7:   */   extends EntityFX
/*  8:   */ {
/*  9:   */   float smokeParticleScale;
/* 10:   */   private static final String __OBFID = "CL_00000924";
/* 11:   */   
/* 12:   */   public EntitySmokeFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
/* 13:   */   {
/* 14:13 */     this(par1World, par2, par4, par6, par8, par10, par12, 1.0F);
/* 15:   */   }
/* 16:   */   
/* 17:   */   public EntitySmokeFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, float par14)
/* 18:   */   {
...
/* 26:25 */     this.particleRed = (this.particleGreen = this.particleBlue = (float)(Math.random() * 0.300000011920929D));
/* 27:26 */     this.particleScale *= 0.75F;
/* 28:27 */     this.particleScale *= par14;
/* 29:28 */     this.smokeParticleScale = this.particleScale;
...
/* 42:45 */       var8 = 1.0F;
/* 43:   */     }
/* 44:48 */     this.particleScale = (this.smokeParticleScale * var8);
...
/* 57:67 */     this.motionY += 0.004D;
/* 58:68 */     moveEntity(this.motionX, this.motionY, this.motionZ);
/* 59:70 */     if (this.posY == this.prevPosY)
/* 60:   */     {
/* 61:72 */       this.motionX *= 1.1D;
/* 62:73 */       this.motionZ *= 1.1D;
/* 63:   */     }
/* 64:76 */     this.motionX *= 0.9599999785423279D;
/* 65:77 */     this.motionY *= 0.9599999785423279D;
/* 66:78 */     this.motionZ *= 0.9599999785423279D;
/* 67:80 */     if (this.onGround)
/* 68:   */     {
/* 69:82 */       this.motionX *= 0.699999988079071D;
/* 70:83 */       this.motionZ *= 0.699999988079071D;
/* 71:   */     }
/* 72:   */   }
/* 73:   */ }
 ...
 * Qualified Name:     net.minecraft.client.particle.EntitySmokeFX
