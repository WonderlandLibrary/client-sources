...
import me.protocol_client.utils.OutlineUtilsThanksHex;
...
public abstract class RendererLivingEntity extends Render {
	...
	public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
		if(Protocol.esp.isToggled() && Protocol.esp.isCorrect(p_76986_1_) && Protocol.esp.wallhack.getValue()){
...
//			if(Protocol.esp.isToggled() && Protocol.esp.chams.getValue() && Protocol.esp.isCorrect(p_76986_1_)){
//				GL11.glDisable(GL11.GL_LIGHTING);
//				GL11.glDisable(GL11.GL_DEPTH_TEST);
//				GL11.glColor4f(getColors(p_76986_1_)[0], getColors(p_76986_1_)[1], getColors(p_76986_1_)[2], 1.0f); 
...
//			}
			...
			if (Protocol.esp.isToggled() && (Protocol.esp.outline.getValue())) {
				if (Protocol.esp.isCorrect(p_76986_1_) && !p_76986_1_.getName().startsWith("Body #")) {
					renderModel(p_76986_1_, var17, var16, var14, var12, var20, 0.0625F);
					OutlineUtilsThanksHex.renderOne();
					renderModel(p_76986_1_, var17, var16, var14, var12, var20, 0.0625F);
					OutlineUtilsThanksHex.renderTwo();
					renderModel(p_76986_1_, var17, var16, var14, var12, var20, 0.0625F);
					OutlineUtilsThanksHex.renderThree();
					OutlineUtilsThanksHex.renderFour(p_76986_1_);
					renderModel(p_76986_1_, var17, var16, var14, var12, var20, 0.0625F);
					OutlineUtilsThanksHex.renderFive();
				}
			}
	...
	private Float[] getColors(EntityLivingBase entity){
	...
	protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
		boolean var8 = Protocol.invis.isToggled() ? true : !p_77036_1_.isInvisible();
		...
		if (var8 || var9) {
			...
			//TODO: ALTERNATE VERSION OF FILLED ESP. LESS INTENSIVE BUT LOOKS SLIGHTLY WORSE
			if (Protocol.esp.isToggled() && Protocol.esp.chams.getValue() && Protocol.esp.isCorrect(p_77036_1_)) {
				GL11.glPushMatrix();
				...
				GL11.glLineWidth(Protocol.esp.linewidth.getValue());
				OutlineUtilsThanksHex.getColors(p_77036_1_);
	...
	protected void rotateCorpse(EntityLivingBase p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_) {
		...
		if (p_77043_1_.deathTime > 0) {
			...
			if (var6 != null && (var6.equals("memes") || var6.equals("Grumm")) && (!(p_77043_1_ instanceof EntityPlayer) || ((EntityPlayer) p_77043_1_).func_175148_a(EnumPlayerModelParts.CAPE))) {
