...
public abstract class Entity implements ICommandSender {
    ...
    public void moveFlying(float strafe, float forward, float friction) {
        var strafeEvent = new StrafeEvent(strafe, forward, friction, this.rotationYaw);
        Client.getInstance().getEventDispatcher().dispatch(strafeEvent);
        ...
        if (f >= 1.0E-4F) {
            ...
            f = strafeEvent.getFriction() / f;
            strafeEvent.setStrafe(strafeEvent.getStrafe() * f);
            strafeEvent.setForward(strafeEvent.getForward() * f);
            ...
            this.motionX += strafeEvent.getStrafe() * f2 - strafeEvent.getForward() * f1;
            this.motionZ += strafeEvent.getForward() * f2 + strafeEvent.getStrafe() * f1;
        }
    }
