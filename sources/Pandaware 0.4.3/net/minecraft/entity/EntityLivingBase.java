...
public abstract class EntityLivingBase extends Entity {
    ...
    private int getArmSwingAnimationEnd() {
        ...
        if (animationsModule.getData().isEnabled() && animationsModule.getSwingSpeedEdit().getValue()) {
            return (int) animationsModule.getSwingSpeed().getValue().floatValue();
        }
     ...
     */
    protected void jump() {
        var jumpEvent = new JumpEvent(this.rotationYaw);
        if (this == Minecraft.getMinecraft().thePlayer) {
            Client.getInstance().getEventDispatcher().dispatch(jumpEvent);
