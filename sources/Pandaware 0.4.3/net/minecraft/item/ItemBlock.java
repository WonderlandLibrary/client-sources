    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        if (stack.stackSize == 0) {
            ...
            if (ViaMCP.getInstance().getVersion() != ProtocolCollection.R1_8.getVersion().getVersion()) {
                worldIn.playSound((float) pos.getX(), (float) pos.getY(), (float) pos.getZ(), this.block.stepSound.getPlaceSound(), (this.block.stepSound.getVolume() + 1.0F) / 2.0f, this.block.stepSound.getFrequency() * 0.8F, true);
            }
