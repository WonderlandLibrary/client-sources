...
public class Block {
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        if (collidingEntity instanceof EntityPlayerSP) {
            var collisionEvent = new CollisionEvent(state.getBlock(), pos, axisalignedbb);
            Client.getInstance().getEventDispatcher().dispatch(collisionEvent);

            if (collisionEvent.isCancelled()) {
                return;
            }

            axisalignedbb = collisionEvent.getCollisionBox();
        }
