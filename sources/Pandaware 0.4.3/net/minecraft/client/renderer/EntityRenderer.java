...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_) {
        ...
        Client.getInstance().getEventDispatcher().dispatch(new RenderEvent(p_181560_1_,
                scaledResolution, mousePos, RenderEvent.Type.FRAME));
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        Client.getInstance().getEventDispatcher().dispatch(new RenderEvent(partialTicks,
                new ScaledResolution(mc), mousePos, RenderEvent.Type.RENDER_3D));
