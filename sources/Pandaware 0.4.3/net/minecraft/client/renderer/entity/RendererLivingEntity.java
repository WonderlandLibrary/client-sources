...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        ...
        if (flag || flag1) {
            ...
            if (chamsModule.getData().isEnabled() && chamsModule.getColor().getValue()) {
                if (entitylivingbaseIn instanceof EntityPlayer) {
                    GL11.glPushMatrix();
                    ...
                    ColorUtils.glColor(chamsModule.getHiddenColor().getValue());
                    GL11.glLineWidth(1);
                    this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);

                    if (chamsModule.getAlwaysColor().getValue()) {
            ...
            if (!chamsModule.getData().isEnabled() || !chamsModule.getAlwaysColor().getValue() || !chamsModule.getColor().getValue()
    ...
    public void renderName(T entity, double x, double y, double z) {
        if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, new Object[]{entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)})) {
            var nameTagsEvent = new NameTagsEvent(entity);
            Client.getInstance().getEventDispatcher().dispatch(nameTagsEvent);

            if (this.canRenderName(entity) && !nameTagsEvent.isCancelled()) {
