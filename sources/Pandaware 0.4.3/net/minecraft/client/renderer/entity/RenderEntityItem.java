...
import dev.africa.pandaware.impl.module.render.ItemPhysicsModule;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    private int func_177077_a(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_,
        ...
        if (item == null) {
            ...
            if (Client.getInstance().getModuleManager().getByClass(ItemPhysicsModule.class).getData().isEnabled()) {
