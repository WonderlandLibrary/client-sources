...
public class GuiChest extends GuiContainer
{
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        if (chestStealer.getData().isEnabled() && mc.currentScreen instanceof GuiChest && chestStealer.getSilent().getValue()) {
            Client.getInstance().getEventDispatcher().dispatch(new KeyEvent(keyCode, KeyEvent.Type.NOT_NULL_SCREEN));
        }
