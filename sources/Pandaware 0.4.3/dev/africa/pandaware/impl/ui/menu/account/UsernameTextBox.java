...
public class UsernameTextBox extends Gui {
    ...
    public UsernameTextBox(int componentId, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtils.drawBorderedRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, 0.5, new Color(21, 21, 21, 226).getRGB(),
                        ColorUtils.rainbow(1, 1, 2).getRGB());
            }
