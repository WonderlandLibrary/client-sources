...
public class VerusStep extends ModuleMode<StepModule> {
    ...
    EventCallback<MotionEvent> onMotion = event -> {
        ...
        if (this.offsets.isEmpty()) {
            this.offsets.put(1.0F, new float[]{0.5f});
            this.offsets.put(1.5F, new float[]{0.5f, 1.0f});
        }
    ...
    public VerusStep(String name, StepModule parent) {
        super(name, parent);
    }
