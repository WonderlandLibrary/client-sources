...
import club.dortware.client.module.impl.movement.Flight;
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            if (this.stepHeight > 0.0F && var54 && (var13 != x || var17 != z))
            {
                ...
                Client.INSTANCE.getEventBus().post(entityStepEvent);
                double var56 = x;
                double var25 = y;
                double var27 = z;
                ...
                Client.INSTANCE.getEventBus().post(new EntityStepEvent((float) (y + 1.0F), false, this));
            }
            ...
            boolean force = this instanceof EntityPlayerSP && Client.INSTANCE.getModuleManager().get(Flight.class).isToggled();
