...
import club.dortware.client.proxy.tor.TorClient;
...
public class Main
{
    public static TorClient torC;


    public static void main(String[] p_main_0_)
    {
        System.setProperty("java.rmi.server.hostname","10.0.0.74");
//        new Thread(torC = new TorClient()).start();
        ...
        ArgumentAcceptingOptionSpec var11 = var1.accepts("username").withRequiredArg().defaultsTo("User");
