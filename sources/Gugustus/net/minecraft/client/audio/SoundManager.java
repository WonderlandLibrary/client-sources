...
public class SoundManager {
   ...
   public SoundManager(SoundHandler p_i45119_1_, GameSettings p_i45119_2_) {
      ...
      try {
         ...
         logger.error("Error linking with the LibraryJavaSound plug-in", (Throwable)var4);
      }
   }
   ...
   private synchronized void loadSoundSystem() {
      if (!this.loaded) {
         try {
            ...
            logger.error("Error starting SoundSystem. Turning off sounds & music", (Throwable)var2);
   ...
   public boolean isSoundPlaying(ISound sound) {
      if (!this.loaded) {
         ...
         return s == null
            ? false
            : this.sndSystem.playing(s) || this.playingSoundsStopTime.containsKey(s) && this.playingSoundsStopTime.get(s) <= this.playTime;
      }
   }
                     ...
                     if (soundpoolentry.isStreamingSound()) {
                        this.sndSystem
                           .newStreamingSource(
                              ...
                              sound.getYPosF(),
                              sound.getZPosF(),
                              sound.getAttenuationType().getTypeInt(),
                              f1
                           );
                     } else {
                        this.sndSystem
