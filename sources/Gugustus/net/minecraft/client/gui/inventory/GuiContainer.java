...
public abstract class GuiContainer extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      for(int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1) {
         ...
         this.drawSlot(slot);
         if ((this.isMouseOverSlot(slot, mouseX, mouseY) && slot.canBeHovered()) || (MM.mm.chestStealer.isToggled() && MM.mm.chestStealer.slot == slot.slotNumber && MM.mm.chestStealer.display.getBoolean() && this instanceof GuiChest) || (MM.mm.inventoryCleaner.isToggled() && MM.mm.inventoryCleaner.slot == slot.slotNumber && MM.mm.inventoryCleaner.display.getBoolean() && this instanceof GuiInventory) || (MM.mm.autoArmor.isToggled() && MM.mm.autoArmor.slot == slot.slotNumber && MM.mm.autoArmor.display.getBoolean() && this instanceof GuiInventory)) {
            this.theSlot = slot;
            GlStateManager.disableLighting();
            GlStateManager.disableDepth();
         ...
         if (isShiftKeyDown()) {
            if (slot != null && slot.inventory != null && this.shiftClickedSlot != null) {
               for(Slot slot2 : this.inventorySlots.inventorySlots) {
                  if (slot2 != null
                     && slot2.canTakeStack(this.mc.thePlayer)
                     && slot2.getHasStack()
