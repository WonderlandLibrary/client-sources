...
public abstract class GuiSlot {
   ...
   protected void overlayBackground(int startY, int endY, int startAlpha, int endAlpha) {
      if (this.mc.inGameHasFocus) {
         ...
         worldrenderer.pos(this.left + this.width, endY, 0.0)
            .tex((float)this.width / 32.0F, (float)endY / 32.0F)
            .color(64, 64, 64, endAlpha)
            .endVertex();
         worldrenderer.pos(this.left + this.width, startY, 0.0)
            .tex((float)this.width / 32.0F, (float)startY / 32.0F)
