...
public class GuiPlayerTabOverlay extends Gui {
   ...
   public static String getPlayerName(NetworkPlayerInfo networkPlayerInfoIn) {
      String string = MidClick.friends.contains(networkPlayerInfoIn.getGameProfile().getName()) ? "[Friend] " : networkPlayerInfoIn.getGameProfile().getName().equals(MC.mc.getSession().getUsername()) ? "[You] " : "";
      if (Augustus.getInstance().getModuleManager().protector.isToggled()) {
         return networkPlayerInfoIn.getDisplayName() != null
            ? string + networkPlayerInfoIn.getProtectedName()
            : ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(), string + networkPlayerInfoIn.getProtectedName());
      } else {
         return networkPlayerInfoIn.getDisplayName() != null
            ? string + networkPlayerInfoIn.getDisplayName().getFormattedText()
            : ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(), string + networkPlayerInfoIn.getGameProfile().getName());
      }
   }
