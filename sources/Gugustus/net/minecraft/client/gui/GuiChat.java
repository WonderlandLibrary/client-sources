...
public class GuiChat extends GuiScreen {
   ...
   protected void keyTyped(char typedChar, int keyCode) throws IOException {
      ...
      if (keyCode == 1) {
         ...
         if (s.length() > 0) {
        	 if(s.startsWith("#") && MM.mm.irc.isToggled()) {
        		 Augustus.getInstance().getIrc().sendMessage(s.replace("#", ""));
                 this.mc.displayGuiScreen((GuiScreen)null);
        		 return;
        	 }
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if(this.inputField.getText().isEmpty() && MM.mm.irc.isToggled()) {
    	  String s = "Start messages with # to send it as an IRC messsage.";
    	  fontRendererObj.drawStringWithShadow(s, this.width / 2 - (fontRendererObj.getStringWidth(s) / 2) - 10, this.height - 12, 0xff808080);
      }
