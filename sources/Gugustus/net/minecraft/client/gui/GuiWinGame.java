...
public class GuiWinGame extends GuiScreen {
   ...
   public void initGui() {
      if (this.field_146582_i == null) {
         ...
         try {
            ...
            logger.error("Couldn't load credits", (Throwable)var10);
         }
      }
   }
   ...
   private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
      ...
      f3 *= f3;
      f3 = f3 * 96.0F / 255.0F;
      worldrenderer.pos(0.0, (double)this.height, (double)this.zLevel).tex(0.0, (double)(f * f2)).color(f3, f3, f3, 1.0F).endVertex();
      ...
      worldrenderer.pos((double)i, 0.0, (double)this.zLevel).tex((double)((float)i * f2), (double)(f1 * f2)).color(f3, f3, f3, 1.0F).endVertex();
      worldrenderer.pos(0.0, 0.0, (double)this.zLevel).tex(0.0, (double)(f1 * f2)).color(f3, f3, f3, 1.0F).endVertex();
      tessellator.draw();
   }
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      int k1 = this.height;
      worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
      worldrenderer.pos(0.0, (double)k1, (double)this.zLevel).tex(0.0, 1.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      worldrenderer.pos((double)j1, (double)k1, (double)this.zLevel).tex(1.0, 1.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      worldrenderer.pos((double)j1, 0.0, (double)this.zLevel).tex(1.0, 0.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      worldrenderer.pos(0.0, 0.0, (double)this.zLevel).tex(0.0, 0.0).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      tessellator.draw();
