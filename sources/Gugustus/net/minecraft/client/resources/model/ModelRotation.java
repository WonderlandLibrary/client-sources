...
public enum ModelRotation implements IModelState, ITransformation {
   ...
   private ModelRotation(String p_i13_3_, int p_i13_4_, int p_i13_5_, int p_i13_6_) {
      ...
      Matrix4f.rotate((float)(-p_i13_5_) * (float) (Math.PI / 180.0), new Vector3f(1.0F, 0.0F, 0.0F), matrix4f, matrix4f);
      this.quartersX = MathHelper.abs_int(p_i13_5_ / 90);
      Matrix4f matrix4f1 = new Matrix4f();
      matrix4f1.setIdentity();
      Matrix4f.rotate((float)(-p_i13_6_) * (float) (Math.PI / 180.0), new Vector3f(0.0F, 1.0F, 0.0F), matrix4f1, matrix4f1);
