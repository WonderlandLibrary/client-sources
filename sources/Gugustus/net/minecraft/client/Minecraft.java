...
public class Minecraft implements IThreadListener, IPlayerUsage, MM {
   ...
   public void func_181536_a(
      ...
      worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
      worldrenderer.pos((double)p_181536_1_, (double)(p_181536_2_ + p_181536_6_), 0.0)
         ...
         .endVertex();
      worldrenderer.pos((double)(p_181536_1_ + p_181536_5_), (double)(p_181536_2_ + p_181536_6_), 0.0)
         .tex((double)((float)(p_181536_3_ + p_181536_5_) * f), (double)((float)(p_181536_4_ + p_181536_6_) * f1))
         .color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_)
         .endVertex();
      worldrenderer.pos((double)(p_181536_1_ + p_181536_5_), (double)p_181536_2_, 0.0)
         .tex((double)((float)(p_181536_3_ + p_181536_5_) * f), (double)((float)p_181536_4_ * f1))
         .color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_)
         .endVertex();
      worldrenderer.pos((double)p_181536_1_, (double)p_181536_2_, 0.0)
   ...
   private void runGameLoop() throws IOException {
      ...
      for (int j = 0; j < this.timer.elapsedTicks; ++j)
      {
         if(Minecraft.getMinecraft().thePlayer != null && mm.timerRange. mode.getSelected().equals("Vestige")) {
            boolean skip = false;

            if(j == 0) {
               TimerRange tickBase = mm.timerRange;

               if(tickBase.isToggled()) {
