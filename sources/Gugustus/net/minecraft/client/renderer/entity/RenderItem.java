...
public class RenderItem implements IResourceManagerReloadListener {
   ...
   private void renderEffect(IBakedModel model) {
      if ((!Config.isCustomItems() || CustomItems.isUseGlint()) && (!Config.isShaders() || !Shaders.isShadowPass)) {
         EventItemGlint eventItemGlint = new EventItemGlint(-8372020, 1.0);
         EventHandler.call(eventItemGlint);
         ...
         long customSystemTime = (long)((double)Sys.getTime() * 1000.0 * eventItemGlint.getSpeed() / (double)Sys.getTimerResolution());
         float f = (float)(customSystemTime % 3000L) / 3000.0F / 8.0F;
         GlStateManager.translate(f, 0.0F, 0.0F);
         GlStateManager.rotate(-50.0F, 0.0F, 0.0F, 1.0F);
         if (!eventItemGlint.isCanceled()) {
            this.renderModel(model, eventItemGlint.getColor());
         }

         GlStateManager.popMatrix();
         GlStateManager.pushMatrix();
         GlStateManager.scale(8.0F, 8.0F, 8.0F);
         float f1 = (float)(customSystemTime % 4873L) / 4873.0F / 8.0F;
   ...
   public void renderItemIntoGUI(ItemStack stack, int x, int y, int z) {
      this.renderItemGui = true;
      IBakedModel ibakedmodel = this.itemModelMesher.getItemModel(stack);
      GlStateManager.pushMatrix();
      this.textureManager.bindTexture(TextureMap.locationBlocksTexture);
      ...
      GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
      GlStateManager.disableLighting();
      this.setupGuiTransform(x, y, z, ibakedmodel.isGui3d());
      if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
         ibakedmodel = (IBakedModel)Reflector.call(Reflector.ForgeHooksClient_handleCameraTransforms, ibakedmodel, ItemCameraTransforms.TransformType.GUI);
      } else {
         ibakedmodel.getItemCameraTransforms().applyTransform(ItemCameraTransforms.TransformType.GUI);
   ...
   private void setupGuiTransform(int xPosition, int yPosition, int zPosition, boolean isGui3d) {
      GlStateManager.translate((float)xPosition, (float)yPosition, (float)zPosition);
      GlStateManager.translate(8.0F, 8.0F, 0.0F);
      GlStateManager.scale(1.0F, 1.0F, -1.0F);
      GlStateManager.scale(0.5F, 0.5F, 0.5F);
      if (isGui3d) {
   ...
   private void func_181565_a(
      ...
      p_181565_1_.pos((double)(p_181565_2_ + 0), (double)(p_181565_3_ + p_181565_5_), 0.0)
         .color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_)
         .endVertex();
      p_181565_1_.pos((double)(p_181565_2_ + p_181565_4_), (double)(p_181565_3_ + p_181565_5_), 0.0)
         .color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_)
         .endVertex();
      p_181565_1_.pos((double)(p_181565_2_ + p_181565_4_), (double)(p_181565_3_ + 0), 0.0)
         .color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_)
         .endVertex();
