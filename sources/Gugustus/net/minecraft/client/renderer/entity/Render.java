...
public abstract class Render<T extends Entity> implements MM {
   ...
   protected void renderOffsetLivingLabel(T entityIn, double x, double y, double z, String str, float p_177069_9_, double p_177069_10_) {
      if (mm.nameTags.isToggled() && entityIn instanceof EntityPlayer) {
         String var12 = mm.nameTags.mode.getSelected();
         switch(var12) {
            case "Vanilla":
               this.renderVanillaLivingLabel(entityIn, str, x, y, z, 256);
               break;
            case "Custom":
   ...
   private void func_180549_a(
      ...
      if (blockIn.isFullCube()) {
         Tessellator tessellator = Tessellator.getInstance();
         WorldRenderer worldrenderer = tessellator.getWorldRenderer();
         double d0 = ((double)p_180549_9_ - (p_180549_4_ - ((double)pos.getY() + p_180549_13_)) / 2.0)
            * 0.5
   ...
   protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
      ...
      if (d0 <= (double)(maxDistance * maxDistance)) {
         ...
         worldrenderer.pos((double)(-i - 1), (double)(-1 + b0), 0.0).color(0.0F, 0.0F, 0.0F, 0.25F).endVertex();
         worldrenderer.pos((double)(-i - 1), (double)(8 + b0), 0.0).color(0.0F, 0.0F, 0.0F, 0.25F).endVertex();
         worldrenderer.pos((double)(i + 1), (double)(8 + b0), 0.0).color(0.0F, 0.0F, 0.0F, 0.25F).endVertex();
         worldrenderer.pos((double)(i + 1), (double)(-1 + b0), 0.0).color(0.0F, 0.0F, 0.0F, 0.25F).endVertex();
         tessellator.draw();
         GlStateManager.enableTexture2D();
   ...
   protected void renderVanillaLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
      double d0 = entityIn.getDistanceSqToEntity(this.renderManager.livingPlayer);
      if (d0 <= (double)(maxDistance * maxDistance)) {
         FontRenderer fontrenderer = this.getFontRendererFromRenderManager();
         float f = (float)mm.nameTags.scale.getValue();
         float f1 = 0.016666668F * f;
         GlStateManager.pushMatrix();
         GlStateManager.translate((double)((float)x + 0.0F), (double)((float)y + entityIn.height + 0.5F) + mm.nameTags.height.getValue(), (double)((float)z));
         GL11.glNormal3f(0.0F, 1.0F, 0.0F);
         GlStateManager.rotate(-this.renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
         GlStateManager.rotate(this.renderManager.playerViewX, 1.0F, 0.0F, 0.0F);
         GlStateManager.scale(-f1, -f1, f1);
         ...
         tessellator.draw();
         GlStateManager.enableTexture2D();
         fontrenderer.drawString(str, (float)(-fontrenderer.getStringWidth(str)) / 2.0F, (float)b0, -1, false);
         if (entityIn instanceof EntityPlayer && mm.nameTags.armor.getBoolean()) {
            Minecraft.getMinecraft().getRenderItem().zLevel = -100.0F;
            if (((EntityPlayer)entityIn).getCurrentEquippedItem() != null) {
               Minecraft.getMinecraft().getRenderItem().renderItemIntoGUI(((EntityPlayer)entityIn).getCurrentEquippedItem(), -45, -20);
            }

            if (((EntityPlayer)entityIn).getCurrentArmor(3) != null) {
               Minecraft.getMinecraft().getRenderItem().renderItemIntoGUI(((EntityPlayer)entityIn).getCurrentArmor(3), -27, -20);
            }

            if (((EntityPlayer)entityIn).getCurrentArmor(2) != null) {
               Minecraft.getMinecraft().getRenderItem().renderItemIntoGUI(((EntityPlayer)entityIn).getCurrentArmor(2), -9, -20);
            }

            if (((EntityPlayer)entityIn).getCurrentArmor(1) != null) {
               Minecraft.getMinecraft().getRenderItem().renderItemIntoGUI(((EntityPlayer)entityIn).getCurrentArmor(1), 9, -20);
            }

            if (((EntityPlayer)entityIn).getCurrentArmor(0) != null) {
               Minecraft.getMinecraft().getRenderItem().renderItemIntoGUI(((EntityPlayer)entityIn).getCurrentArmor(0), 27, -20);
            }
         }
   ...
   public void renderCustomLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
      GL11.glPushMatrix();
      GL11.glEnable(3042);
      GL11.glDisable(2929);
      ...
      GL11.glDisable(3553);
      double d0 = entityIn.getDistanceSqToEntity(this.renderManager.livingPlayer);
      boolean b = entityIn instanceof EntityPlayer && mm.nameTags.isToggled();
      if (d0 <= (double)(maxDistance * maxDistance) || b) {
         ...
         GlStateManager.translate(
            (double)((float)x + 0.0F),
            (double)((float)y + entityIn.height + 0.5F + f1 * 8.0F - 0.016666668F * f * 8.0F) + mm.nameTags.height.getValue(),
            (double)((float)z)
         );
         GL11.glNormal3f(0.0F, 1.0F, 0.0F);
         GlStateManager.rotate(-this.renderManager.playerViewY, 0.0F, 1.0F, 0.0F);
         ...
         GlStateManager.disableTexture2D();
         worldrenderer.begin(7, DefaultVertexFormats.POSITION_COLOR);
         worldrenderer.pos((double)(-i - 1), (double)(-1 + b0), 0.0).color(0.0F, 0.0F, 0.0F, 0.5F).endVertex();
         worldrenderer.pos((double)(-i - 1), 8.5 + (double)b0, 0.0).color(0.0F, 0.0F, 0.0F, 0.5F).endVertex();
         worldrenderer.pos((double)(i + 1), 8.5 + (double)b0, 0.0).color(0.0F, 0.0F, 0.0F, 0.5F).endVertex();
         worldrenderer.pos((double)(i + 1), (double)(-1 + b0), 0.0).color(0.0F, 0.0F, 0.0F, 0.5F).endVertex();
         tessellator.draw();
         GL11.glLineWidth(1.0E-4F);
         worldrenderer.begin(1, DefaultVertexFormats.POSITION_COLOR);
         worldrenderer.pos((double)(-i - 1), (double)(-1 + b0), 0.0).color(0.0F, 0.0F, 0.0F, 1.0F).endVertex();
         worldrenderer.pos((double)(i + 1), (double)(-1 + b0), 0.0).color(0.0F, 0.0F, 0.0F, 1.0F).endVertex();
         worldrenderer.pos((double)(-i - 1), 8.5 + (double)b0, 0.0).color(0.0F, 0.0F, 0.0F, 1.0F).endVertex();
         worldrenderer.pos((double)(i + 1), 8.5 + (double)b0, 0.0).color(0.0F, 0.0F, 0.0F, 1.0F).endVertex();
         worldrenderer.pos((double)(-i - 1), (double)(-1 + b0), 0.0).color(0.0F, 0.0F, 0.0F, 1.0F).endVertex();
         worldrenderer.pos((double)(-i - 1), 8.5 + (double)b0, 0.0).color(0.0F, 0.0F, 0.0F, 1.0F).endVertex();
         worldrenderer.pos((double)(i + 1), (double)(-1 + b0), 0.0).color(0.0F, 0.0F, 0.0F, 1.0F).endVertex();
