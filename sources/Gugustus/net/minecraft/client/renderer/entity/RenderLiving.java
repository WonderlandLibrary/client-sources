      ...
      if (!Config.isShaders() || !Shaders.isShadowPass) {
         ...
         if (entity != null) {
            ...
            for(int i = 0; i <= 24; ++i) {
               ...
               worldrenderer.pos(
                     x + d13 * (double)f3 + 0.0, y + d14 * (double)(f3 * f3 + f3) * 0.5 + (double)((24.0F - (float)i) / 18.0F + 0.125F), z + d15 * (double)f3
                  )
                  .color(f, f1, f2, 1.0F)
                  .endVertex();
               worldrenderer.pos(
                     x + d13 * (double)f3 + 0.025,
                     y + d14 * (double)(f3 * f3 + f3) * 0.5 + (double)((24.0F - (float)i) / 18.0F + 0.125F) + 0.025,
                     z + d15 * (double)f3
                  )
                  .color(f, f1, f2, 1.0F)
                  .endVertex();
            ...
            for(int j = 0; j <= 24; ++j) {
               ...
               worldrenderer.pos(
                     x + d13 * (double)f7 + 0.0,
                     y + d14 * (double)(f7 * f7 + f7) * 0.5 + (double)((24.0F - (float)j) / 18.0F + 0.125F) + 0.025,
                     z + d15 * (double)f7
                  )
                  .color(f4, f5, f6, 1.0F)
                  .endVertex();
               worldrenderer.pos(
                     ...
                     y + d14 * (double)(f7 * f7 + f7) * 0.5 + (double)((24.0F - (float)j) / 18.0F + 0.125F),
