   ...
   public boolean renderFluid(IBlockAccess blockAccess, IBlockState blockStateIn, BlockPos blockPosIn, WorldRenderer worldRendererIn) {
      ...
      if (!flag && !flag1 && !aboolean[0] && !aboolean[1] && !aboolean[2] && !aboolean[3]) {
         ...
         if (flag) {
            ...
            float f26 = f4 * f1;
            float f18 = f4 * f2;
            worldRendererIn.pos(d0 + 0.0, d1 + (double)f7, d2 + 0.0).color(f25, f26, f18, 1.0F).tex((double)f13, (double)f17).lightmap(l2, i3).endVertex();
            worldRendererIn.pos(d0 + 0.0, d1 + (double)f8, d2 + 1.0).color(f25, f26, f18, 1.0F).tex((double)f14, (double)f19).lightmap(l2, i3).endVertex();
            worldRendererIn.pos(d0 + 1.0, d1 + (double)f9, d2 + 1.0).color(f25, f26, f18, 1.0F).tex((double)f15, (double)f20).lightmap(l2, i3).endVertex();
            worldRendererIn.pos(d0 + 1.0, d1 + (double)f10, d2 + 0.0).color(f25, f26, f18, 1.0F).tex((double)f16, (double)f21).lightmap(l2, i3).endVertex();
         ...
         if (flag1) {
            ...
            int k1 = i1 >> 16 & 65535;
            int i2 = i1 & 65535;
            worldRendererIn.pos(d0, d1, d2 + 1.0).color(f3, f3, f3, 1.0F).tex((double)f35, (double)f38).lightmap(k1, i2).endVertex();
            worldRendererIn.pos(d0, d1, d2).color(f3, f3, f3, 1.0F).tex((double)f35, (double)f37).lightmap(k1, i2).endVertex();
            worldRendererIn.pos(d0 + 1.0, d1, d2).color(f3, f3, f3, 1.0F).tex((double)f36, (double)f37).lightmap(k1, i2).endVertex();
            worldRendererIn.pos(d0 + 1.0, d1, d2 + 1.0).color(f3, f3, f3, 1.0F).tex((double)f36, (double)f38).lightmap(k1, i2).endVertex();
            flag2 = true;
         }
         ...
         for(int j1 = 0; j1 < 4; ++j1) {
            ...
            if (aboolean[j1]) {
               ...
               worldRendererIn.pos(d3, d1 + 0.0, d4).color(f32, f33, f34, 1.0F).tex((double)f27, (double)f30).lightmap(k, l).endVertex();
               worldRendererIn.pos(d5, d1 + 0.0, d6).color(f32, f33, f34, 1.0F).tex((double)f41, (double)f30).lightmap(k, l).endVertex();
               worldRendererIn.pos(d5, d1 + 0.0, d6).color(f32, f33, f34, 1.0F).tex((double)f41, (double)f30).lightmap(k, l).endVertex();
               worldRendererIn.pos(d3, d1 + 0.0, d4).color(f32, f33, f34, 1.0F).tex((double)f27, (double)f30).lightmap(k, l).endVertex();
               worldRendererIn.pos(d3, d1 + (double)f40, d4).color(f32, f33, f34, 1.0F).tex((double)f27, (double)f29).lightmap(k, l).endVertex();
               worldRendererIn.pos(d5, d1 + (double)f39, d6).color(f32, f33, f34, 1.0F).tex((double)f41, (double)f28).lightmap(k, l).endVertex();
