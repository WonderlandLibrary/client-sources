         ...
         if (this.itemToRender.getItem() instanceof ItemMap) {
            ...
            switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()]) {
               ...
               case 4:
                  ...
                  if (mm.blockAnimation.isToggled()) {
                     switch (mm.blockAnimation.animation.getSelected()) {
                        ...
                        case "Slide3": {
                           ...
                           float f4 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.83F);
                           GlStateManager.translate(-0.5F, 0.2F, 0.2F);
                           GlStateManager.rotate(f4 * 23.0F, -30.0F, 0.0F, 45.0F);
                           break;
                        }
                        case "Slide": {
                        ...
                        case "Slide2": {
                            ...
                            float f4 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.83F);
                            GlStateManager.rotate(-f4 * 5.0F, 1.0F, 0.7F, 0.0F);
                        	break;
                        }
                        case "None": {
                            this.transformFirstPersonItem(f, 0.0F);
                  ...
                  */
                  if(!mm.blockAnimation.animation.getSelected().equalsIgnoreCase("Leaked"))
                	  this.func_178103_d();
                  break;
               case 5:
                  this.transformFirstPersonItem(f, f1);
