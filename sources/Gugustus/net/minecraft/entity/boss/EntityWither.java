...
public class EntityWither extends EntityMob implements IBossDisplayData, IRangedAttackMob {
      ...
      if (!this.worldObj.isRemote && this.getWatchedTargetId(0) > 0) {
         ...
         if (entity != null) {
            ...
            if (d3 > 9.0) {
               ...
               this.motionX += (d0 / d5 * 0.5 - this.motionX) * 0.6F;
               this.motionZ += (d1 / d5 * 0.5 - this.motionZ) * 0.6F;
            }
         }
      }

      if (this.motionX * this.motionX + this.motionZ * this.motionZ > 0.05F) {
         this.rotationYaw = (float)MathHelper.func_181159_b(this.motionZ, this.motionX) * (180.0F / (float)Math.PI) - 90.0F;
      }
   ...
   protected void updateAITasks() {
      if (this.getInvulTime() > 0) {
         ...
         if (j1 <= 0) {
            this.worldObj
               .newExplosion(
                  this, this.posX, this.posY + (double)this.getEyeHeight(), this.posZ, 7.0F, false, this.worldObj.getGameRules().getBoolean("mobGriefing")
               );
   ...
   public static boolean func_181033_a(Block p_181033_0_) {
      return p_181033_0_ != Blocks.bedrock
         && p_181033_0_ != Blocks.end_portal
         && p_181033_0_ != Blocks.end_portal_frame
         && p_181033_0_ != Blocks.command_block
