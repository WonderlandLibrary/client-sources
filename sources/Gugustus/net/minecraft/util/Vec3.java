...
public class Vec3 {
   ...
   public double distance(Vec3 vec32) {
      double dx = this.xCoord - vec32.xCoord ;
      double dy = this.yCoord - vec32.yCoord;
      double dz = this.zCoord - vec32.zCoord;
   ...
   public double distanceXZTo(Vec3 vec) {
      double d0 = vec.xCoord - this.xCoord;
      double d2 = vec.zCoord - this.zCoord;
      return (double)MathHelper.sqrt_double(d0 * d0 + d2 * d2);
   }
