...
public class Block {
                        ...
                        side == EnumFacing.SOUTH && this.maxZ < 1.0
                           ...
                           : (
                              side == EnumFacing.WEST && this.minX > 0.0
                                 ? true
                                 : (side == EnumFacing.EAST && this.maxX < 1.0 ? true : !worldIn.getBlockState(pos).getBlock().isOpaqueCube())
                           )
                     )
               )
         );
   ...
   public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
      ...
      EventBlockBoundingBox eventBlockBoundingBox = new EventBlockBoundingBox(axisalignedbb, worldIn.getBlockState(pos).getBlock(), pos);
      EventHandler.call(eventBlockBoundingBox);
      axisalignedbb = eventBlockBoundingBox.getAxisAlignedBB();
   ...
   public static void registerBlocks() {
      ...
      registerBlock(
         74,
         "lit_redstone_ore",
         new BlockRedstoneOre(true).setLightLevel(0.625F).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setUnlocalizedName("oreRedstone")
      );
      ...
      registerBlock(
         ...
         new BlockPressurePlateWeighted(Material.iron, 15, MapColor.goldColor)
            .setHardness(0.5F)
            .setStepSound(soundTypeWood)
      ...
      registerBlock(
         ...
         new BlockPressurePlateWeighted(Material.iron, 150).setHardness(0.5F).setStepSound(soundTypeWood).setUnlocalizedName("weightedPlate_heavy")
      );
      registerBlock(
         149,
