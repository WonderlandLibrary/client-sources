package net.augustus.utils.skid.ohare.font;
...
public class MCFontRenderer extends CFont
{
    ...
    public float drawString(String text, double x, double y, int color, boolean shadow)
    {
        ...
        if (render)
        {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                if ((character == FontInvokerFix.COLOR_INVOKER) && (i < size))
                {
                    int colorIndex = 21;
        ...
        if (getStringWidth(text) > width)
        {
            ...
            for (String word : words)
            {
                for (int i = 0; i < word.toCharArray().length; i++)
                {
                    ...
                    if ((c == FontInvokerFix.COLOR_INVOKER) && (i < word.toCharArray().length - 1))
                    {
    ...
    public List<String> formatString(String string, double width)
    {
        ...
        for (int i = 0; i < chars.length; i++)
        {
            ...
            if ((c == FontInvokerFix.COLOR_INVOKER) && (i < chars.length - 1))
            {
