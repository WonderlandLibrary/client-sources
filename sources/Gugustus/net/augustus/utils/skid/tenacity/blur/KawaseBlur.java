...
public class KawaseBlur implements MC {
    ...
    private static void initFramebuffers(float iterations) {
        ...
        framebufferList.add(framebuffer = RenderUtilTenacity.createFrameBuffer(null));
    ...
    public static void renderBlur(int stencilFrameBufferTexture, int iterations, int offset) {
        ...
        RenderUtilTenacity.bindTexture(stencilFrameBufferTexture);
        GL13.glActiveTexture(GL13.GL_TEXTURE0);
        RenderUtilTenacity.bindTexture(framebufferList.get(1).framebufferTexture);
        ShaderUtil.drawQuads();
        kawaseUp.unload();


        mc.getFramebuffer().bindFramebuffer(true);
        RenderUtilTenacity.bindTexture(framebufferList.get(0).framebufferTexture);
    ...
    private static void renderFBO(Framebuffer framebuffer, int framebufferTexture, ShaderUtil shader, float offset) {
        ...
        shader.init();
        RenderUtilTenacity.bindTexture(framebufferTexture);
