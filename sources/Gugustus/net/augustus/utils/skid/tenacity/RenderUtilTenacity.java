package net.augustus.utils.skid.tenacity;
...
import static net.augustus.utils.skid.tenacity.MathUtils.interpolate;
import static org.lwjgl.opengl.GL11.*;

public class RenderUtilTenacity implements MC {
    ...
    public static void renderRoundedRect(float x, float y, float width, float height, float radius, int color) {
        RenderUtilTenacity.drawGoodCircle(x + radius, y + radius, radius, color);
        RenderUtilTenacity.drawGoodCircle(x + width - radius, y + radius, radius, color);
        RenderUtilTenacity.drawGoodCircle(x + radius, y + height - radius, radius, color);
        RenderUtilTenacity.drawGoodCircle(x + width - radius, y + height - radius, radius, color);
