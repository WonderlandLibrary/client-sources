package net.augustus.utils.skid.idek;
...
public final class Esp2DUtil implements MC {
    ...
    public static void drawTexturedRect(float x, float y, float width, float height, String image) {
        ...
        Esp2DUtil.drawModalRectWithCustomSizedTexture(x, y, 0, 0, width, height, width, height);
    ...
    public static void resetCaps(final String scale) {
        ...
        map.forEach(Esp2DUtil::setGlState);
        map.clear();
    }
    ...
    public static void rectangleBordered(double x, double y, double x1, double y1, double width, int internalColor,
                                         int borderColor) {
        Esp2DUtil.rectangle(x + width, y + width, x1 - width, y1 - width, internalColor);
        GlStateManager.color( 1.0f,  1.0f, 1.0f, 1.0f);
        Esp2DUtil.rectangle(x + width, y, x1 - width, y + width, borderColor);
        GlStateManager.color(1.0f, 1.0f,  1.0f,  1.0f);
        Esp2DUtil.rectangle(x, y, x + width, y1, borderColor);
        GlStateManager.color( 1.0f,  1.0f,  1.0f,  1.0f);
        Esp2DUtil.rectangle(x1 - width, y, x1, y1, borderColor);
        GlStateManager.color( 1.0f,  1.0f,  1.0f, 1.0f);
        Esp2DUtil.rectangle(x + width, y1 - width, x1 - width, y1, borderColor);
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
    }
    ...
    public static void drawHead(ResourceLocation skin, int x, int y, int width, int height) {
        ...
        Esp2DUtil.drawScaledCustomSizeModalRect(x, y, 8F, 8F, 8, 8, width, height,
                64F, 64F);
        Esp2DUtil.drawScaledCustomSizeModalRect(x, y, 40F, 8F, 8, 8, width, height,
                64F, 64F);
    }
