...
public class CustomItemPos extends Module {
   public DoubleValue posX = new DoubleValue(1, "X", this, 0.13, -1.0, 1.0, 2);
   public DoubleValue posY = new DoubleValue(2, "Y", this, 0.13, -1.0, 1.0, 2);
   public DoubleValue posZ = new DoubleValue(3, "Z", this, 0.04, -1.0, 1.0, 2);
   public DoubleValue blockPosX = new DoubleValue(5, "BlockX", this, -0.27, -1.0, 1.0, 2);
   public DoubleValue blockPosY = new DoubleValue(6, "BlockY", this, -0.04, -1.0, 1.0, 2);
   public DoubleValue blockPosZ = new DoubleValue(7, "BlockZ", this, 0.0, -1.0, 1.0, 2);
   public DoubleValue scale = new DoubleValue(4, "Scale", this, 0.2, 0.0, 2.0, 2);
