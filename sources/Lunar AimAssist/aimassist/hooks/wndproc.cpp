...
long __stdcall aimassist::hooks::wndproc(const HWND hwnd, UINT usermsg, WPARAM wparam, LPARAM lparam)
{
	if (aimassist::instance->menuOpen && imgui_wndproc(hwnd, usermsg, wparam, lparam))
		return 1l;
