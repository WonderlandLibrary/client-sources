...
//        func_180480_a(this.mc.thePlayer.getBrightness(p_175180_1_), var2);
//      } else {
...
//      }
      ...
      {
        float var7 = this.mc.thePlayer.prevTimeInPortal + (this.mc.thePlayer.timeInPortal - this.mc.thePlayer.prevTimeInPortal) * p_175180_1_;
        if (var7 > 0.0F) {
      ...
      if ((this.mc.currentScreen == Client.getClickGUI()) && (!Client.getModuleManager().getModuleByName("hud").isEnabled()) && 
        (!Client.getEventManager().isCancelled()))
      {
        int h = me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledHeight();
        int w = me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledWidth();
        Panel panel = Client.getClickGUI().getPanelByTitle("Player");
        GL11.glPushMatrix();
        GlStateManager.enableAlpha();
        GlStateManager.enableBlend();
        if ((panel != null) && (panel.hoveringLogo)) {
          me.kaktuswasser.client.utilities.RenderHelper.drawRect(0.0F, h - 22, 24.0F, h, 1090519039);
        }
        Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("textures/logo.png"));
        Gui.drawScaledCustomSizeModalRect(0, me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledHeight() - 22, 0.0F, 0.0F, 24, 20, 24, 20, 24.0F, 20.0F);
      ...
      {
        Client.getEventManager().hook(new DrawScreen());
      ...
      if (this.mc.thePlayer.getSleepTimer() > 0)
      {
        ...
        GlStateManager.disableAlpha();
        int var11 = this.mc.thePlayer.getSleepTimer();
    ...
    {
      HUD hud = (HUD)Client.getModuleManager().getModuleByName("hud");
      if ((hud.isEnabled()) && (((Boolean)hud.bar.getValue()).booleanValue()) && 
        (!Client.getEventManager().isCancelled()))
      {
        me.kaktuswasser.client.utilities.RenderHelper.drawRectNoBlend(0.0F, me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledHeight() - 22, me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledWidth() - 4, 
          me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledHeight(), Integer.MIN_VALUE);
        me.kaktuswasser.client.utilities.RenderHelper.drawRectNoBlend(me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledWidth() - 4, me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledHeight() - 22, me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledWidth(), 
          me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledHeight(), -862348903);
        
        int item = this.mc.thePlayer.inventory.currentItem + 1;
        ...
        me.kaktuswasser.client.utilities.RenderHelper.drawRectNoBlend(me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledWidth() / 2 - 91 + xPos - 21.0F, me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledHeight() - 22, me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledWidth() / 2 - 91 + xPos, 
          me.kaktuswasser.client.utilities.RenderHelper.getScaledRes().getScaledHeight() - 2, -2130706433);
      }
