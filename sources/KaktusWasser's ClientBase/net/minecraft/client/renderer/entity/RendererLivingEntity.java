...
import me.kaktuswasser.client.event.events.EntityRender;
  ...
  extends Render
{
  ...
  {
    EntityRender event = new EntityRender(p_76986_1_);
    ...
    try
    {
      float var10 = interpolateRotation(p_76986_1_.prevRenderYawOffset, p_76986_1_.renderYawOffset, p_76986_9_);
      ...
      if ((p_76986_1_.isRiding()) && ((p_76986_1_.ridingEntity instanceof EntityLivingBase)))
      {
        ...
        var10 = interpolateRotation(var13.prevRenderYawOffset, var13.renderYawOffset, p_76986_9_);
        var12 = var11 - var10;
      ...
      renderModel(p_76986_1_, var17, var16, var14, var12, var20, var15);
  ...
  protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
  {
    ...
    //ESP
//      final PlayerESP ESP = (PlayerESP) Icarus.getModuleManager().getModuleByName("PlayerESP");
//      if (ESP.isEnabled() && ESP != null) {
//    	  Minecraft mc = Minecraft.getMinecraft();
//            if(p_77036_1_ != mc.thePlayer) {
//          	  new ScaledResolution(mc, GuiScreen.width, GuiScreen.height);
//                this.mainModel.render(p_77036_1_, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
//                OutlineUtils.renderOne(2);
//                this.mainModel.render(p_77036_1_, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
//                OutlineUtils.renderTwo();
//                this.mainModel.render(p_77036_1_, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
//                OutlineUtils.renderThree();
//                OutlineUtils.renderFour(((Integer)PlayerESP.red.getValue()).intValue(), ((Integer)PlayerESP.green.getValue()).intValue(), ((Integer)PlayerESP.blue.getValue()).intValue());
//                this.mainModel.render(p_77036_1_, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
...
//         }
  ...
  {
    if ((canRenderName(p_77033_1_)) && (!Client.getModuleManager().getModuleByName("nametags").isEnabled()))
    {
      ...
      if (var8 < var10 * var10)
      {
        ...
        {
          func_177069_a(p_77033_1_, p_77033_2_, p_77033_4_ - (p_77033_1_.isChild() ? p_77033_1_.height / 2.0F : 0.0D), p_77033_6_, var11, 0.02666667F, var8);
        }
      }
    }
  }
