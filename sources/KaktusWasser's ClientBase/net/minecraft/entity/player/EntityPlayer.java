...
import me.kaktuswasser.client.event.events.InsideBlock;
...
public abstract class EntityPlayer extends EntityLivingBase
{
                ...
                if (var2 > 0.0F || var4 > 0.0F)
                {
                    ...
                    if (var14)
                    {
                        if (var18 > 0)
                        {
                            ...
                            if (!Client.getModuleManager().getModuleByName("noslowdown").isEnabled())
                            {
                              this.motionX *= 0.6D;
                              this.motionZ *= 0.6D;
                            }
    ...
    {
      InsideBlock event = new InsideBlock();
