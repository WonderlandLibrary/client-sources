...
import me.kaktuswasser.client.utilities.GuiPasswordField;
...
public class GuiAltLogin extends GuiScreen
{
    ...
    public void drawScreen(final int x, final int y, final float z) {
        ...
        this.drawCenteredString(this.mc.fontRendererObj, (this.thread == null) ? "§7Waiting..." : this.thread.getStatus(), this.width / 2, 29, -1);
