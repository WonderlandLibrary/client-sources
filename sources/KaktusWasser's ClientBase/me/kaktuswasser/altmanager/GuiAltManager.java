...
public class GuiAltManager extends GuiScreen
{
    ...
    public GuiAltManager() {
        ...
        Client.getAltManager().getAlts().clear();
        Client.getFileManager().getFileByName("alts").loadFile();
    }
    ...
    public void actionPerformed(final GuiButton button) {
        switch (button.id) {
            ...
            case 2: {
                ...
                Client.getAltManager().getAlts().remove(this.selectedAlt);
            ...
            case 5: {
                final Alt randomAlt = Client.getAltManager().getAlts().get(new Random().nextInt(Client.getAltManager().getAlts().size()));
            ...
            case 7: {
                final Alt lastAlt = Client.getAltManager().getLastAlt();
                if (lastAlt != null) {
    ...
    public void drawScreen(final int par1, final int par2, final float par3) {
        ...
        this.drawCenteredString(this.fontRendererObj, "Account Manager - " + Client.getAltManager().getAlts().size() + " alts", this.width / 2, 10, -1);
