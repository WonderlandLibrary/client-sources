...
import me.kaktuswasser.client.clickgui.element.elements.ElementActionButton;
import me.kaktuswasser.client.clickgui.element.elements.ElementStartMenuButton;
...
//            GL11.glPopMatrix();
        ...
        RenderHelper.drawRect(this.getX() - (textWidth - 100.0f) / 2.0f - 4.0f, this.getY() - 1, this.getX() - (textWidth - 100.0f) / 2.0f + textWidth + 4.0f, this.getY() + 15, 0x99242626);
