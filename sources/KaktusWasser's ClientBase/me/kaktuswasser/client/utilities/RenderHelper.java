...
{
    private static final NahrFont font;
    private static final NahrFont nahr;
    private static final ScaledResolution sr;
    
    static {
        font = new NahrFont("Verdana", 18.0f);
    ...
    public static void renderFour(final Minecraft mc, final Entity renderEntity) {
        ...
        if (renderEntity instanceof EntityLivingBase) {
            ...
            if (distance instanceof EntityPlayer && Client.getFriendManager().isFriend(distance.getName())) {
    ...
    public static final NahrFont getArialNahr() {
        return RenderHelper.nahr;
    }
}
