...
import me.kaktuswasser.client.event.events.SetBack;
...
public class Speed extends Module
{
    ...
    public void onEvent(final Event e) {
        ...
        if (e instanceof PlayerMovement) {
            ...
            if ((this.speedMode.getStringValue().equals("bhop") || this.speedMode.getStringValue().equals("bhop_latest")) && !Client.getModuleManager().getModuleByName("freecam").isEnabled() && this.flagTime.hasReached(750L) && !BlockHelper.isInLiquid() && !BlockHelper.isOnLiquid()) {
