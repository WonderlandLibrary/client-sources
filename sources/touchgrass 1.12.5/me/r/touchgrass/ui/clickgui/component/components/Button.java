package me.r.touchgrass.ui.clickgui.component.components;

import java.awt.*;
import java.util.ArrayList;

import me.r.touchgrass.module.Module;
import me.r.touchgrass.ui.clickgui.component.components.sub.*;
import me.r.touchgrass.ui.clickgui.component.components.sub.*;
...
public class Button extends me.r.touchgrass.ui.clickgui.component.Component {

	public final Module mod;
	public final me.r.touchgrass.ui.clickgui.component.Frame parent;
	public int offset;
	private boolean isHovered;
	public final ArrayList<me.r.touchgrass.ui.clickgui.component.Component> subcomponents;
	public boolean open;
	...
	public Button(Module mod, me.r.touchgrass.ui.clickgui.component.Frame parent, int offset) {
		this.mod = mod;
		this.parent = parent;
		this.offset = offset;
		this.subcomponents = new ArrayList<me.r.touchgrass.ui.clickgui.component.Component>();
		this.open = false;
		height = 12;
		int opY = offset + 12;
		if(touchgrass.getClient().settingsManager.getSettingsByMod(mod) != null) {
			for(Setting s : touchgrass.getClient().settingsManager.getSettingsByMod(mod)){
				if(s.isModeMode()){
	...
	public void renderTooltip(String name) {
		boolean ttf = touchgrass.getClient().settingsManager.getSettingByName("Font Type").getMode().equalsIgnoreCase("TTF");
		if(ttf) {
	...
	public void setOff(int newOff) {
		offset = newOff;
		int opY = offset + 12;
		for(me.r.touchgrass.ui.clickgui.component.Component comp : this.subcomponents) {
			comp.setOff(opY);
			opY += 12;
		}
	}
	...
	public void renderComponent() {
		...
		if(this.isHovered && touchgrass.getClient().settingsManager.getSettingByName("Tooltip").isEnabled()) {
	...
	public void updateComponent(int mouseX, int mouseY) {
		...
		if(touchgrass.getClient().settingsManager.getSettingByName("Tooltip").isEnabled()) {
