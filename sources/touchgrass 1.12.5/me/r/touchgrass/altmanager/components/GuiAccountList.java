package me.r.touchgrass.altmanager.components;
...
public class GuiAccountList extends GuiSlot {
	...
	public int getSize() {
		return touchgrass.getClient().accountManager.getAccounts().size();
	}
	...
	public Account getAccount(int i) {
		return touchgrass.getClient().accountManager.getAccounts().get(i);
	}
	...
	public void removeSelected() {
		if (this.selected == -1)
			return;
		touchgrass.getClient().accountManager.getAccounts().remove(getAccount(this.selected));
