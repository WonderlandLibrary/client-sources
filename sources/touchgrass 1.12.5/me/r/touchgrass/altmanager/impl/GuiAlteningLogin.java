package me.r.touchgrass.altmanager.impl;
...
public class GuiAlteningLogin extends GuiScreen {
	...
	protected void actionPerformed(GuiButton button) {
		...
		case -1:
			if (key.getText().isEmpty() || token.getText().isEmpty())
				return;
			touchgrass.getClient().accountManager.setAlteningKey(key.getText());
			touchgrass.getClient().accountManager.setLastAlteningAlt(token.getText());
		...
		case 2:
			...
			break;
		case 3:
			if (key.getText().isEmpty() || touchgrass.getClient().accountManager.getLastAlteningAlt() == null)
				return;
			touchgrass.getClient().accountManager.setAlteningKey(key.getText());
			thread = new AccountLoginThread(touchgrass.getClient().accountManager.getLastAlteningAlt().replaceAll(" ", ""), "gaymer");
			thread.run();
			touchgrass.getClient().accountManager.save();
			break;
		}
	...
	public void initGui() {
		...
		if (touchgrass.getClient().accountManager.getAlteningKey() != null)
			key.setText(touchgrass.getClient().accountManager.getAlteningKey());
