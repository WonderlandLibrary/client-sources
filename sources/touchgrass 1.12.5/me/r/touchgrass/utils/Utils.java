...
public class Utils {
    ...
    public static void sendChatMessage(final String message) {
        ChatComponentText chatcomponenttext = new ChatComponentText(String.format("%s %s", touchgrass.prefix, message));
    ...
    public static synchronized void playSound(final String url) {
        new Thread(() -> {
            try {
                ...
                AudioInputStream inputStream = AudioSystem.getAudioInputStream(Utils.class.getResourceAsStream("/assets/touchgrass/" + url));
    ...
    public static void errorLog(String message) {
        System.err.println("[touchgrass] " + message);
    }

    public static void log(String message) {
        System.out.println("[touchgrass] " + message);
    }
}
