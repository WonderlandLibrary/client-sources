package me.r.touchgrass.font;

import java.awt.*;
import java.io.InputStream;

/**
 * Created by r on 15/02/2021
 */
public class FontHelper {
    ...
    public static void loadFonts() {
        try {
            ...
            InputStream stream4 = FontHelper.class.getResourceAsStream("/assets/touchgrass/Comfortaa-Regular.ttf");
            Font font4 = Font.createFont(Font.TRUETYPE_FONT, stream4).deriveFont(36f);
            comfortaa_r = new H2FontRenderer(font4, true, 8);

            InputStream stream5 = FontHelper.class.getResourceAsStream("/assets/touchgrass/Comfortaa-Regular.ttf");
            ...
            InputStream stream = FontHelper.class.getResourceAsStream("/assets/touchgrass/SF-UI-Display-Light.ttf");
            Font font = Font.createFont(Font.TRUETYPE_FONT, stream).deriveFont(36f);
            sf_l = new H2FontRenderer(font, true, 8);

            InputStream stream33 = FontHelper.class.getResourceAsStream("/assets/touchgrass/SF-UI-Display-Light.ttf");
            Font font33 = Font.createFont(Font.TRUETYPE_FONT, stream33).deriveFont(72f);
            sf_l2 = new H2FontRenderer(font33, true, 8);

            InputStream stream34 = FontHelper.class.getResourceAsStream("/assets/touchgrass/SF-UI-Display-Light.ttf");
            Font font34 = Font.createFont(Font.TRUETYPE_FONT, stream34).deriveFont(200f);
            sf_l_mm = new H2FontRenderer(font34, true, 8);

            InputStream stream2 = FontHelper.class.getResourceAsStream("/assets/touchgrass/SF-UI-Display-Regular.otf");
            Font font2 = Font.createFont(Font.TRUETYPE_FONT, stream2).deriveFont(36f);
            sf_r = new H2FontRenderer(font2, true, 8);

            InputStream stream3 = FontHelper.class.getResourceAsStream("/assets/touchgrass/Comfortaa-Light.ttf");
