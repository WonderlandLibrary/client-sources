...
import me.r.touchgrass.utils.PlayerUtil;
            ...
            if (this.canRenderName(entity) && entity.getEntityId() != -3)
            {
                if (touchgrass.getClient().moduleManager.getModule(NameTags.class).isEnabled()) {
                    ...
                    if ((entity instanceof EntityPlayer)) {
                        ...
                        if (touchgrass.getClient().settingsManager.getSettingByName("Health").isEnabled()) {
                        ...
                        if (touchgrass.getClient().settingsManager.getSettingByName("State").isEnabled()) {
                        ...
                        if (touchgrass.getClient().settingsManager.getSettingByName("MurderMystery").isEnabled() && touchgrass.getClient().moduleManager.getModulebyName("MurderMystery").isEnabled() && MurderMystery.isMurderer) {
