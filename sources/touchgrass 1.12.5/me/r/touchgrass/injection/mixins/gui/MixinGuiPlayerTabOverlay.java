...
public abstract class MixinGuiPlayerTabOverlay extends MixinGui {
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
        boolean tabList = touchgrass.getClient().settingsManager.getSettingByName("Tab List").isEnabled() && touchgrass.getClient().moduleManager.getModule(Animations.class).isEnabled();
