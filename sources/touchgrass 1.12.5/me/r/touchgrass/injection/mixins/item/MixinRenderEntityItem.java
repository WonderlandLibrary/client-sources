...
import me.r.touchgrass.injection.mixins.render.MixinRender;
...
public abstract class MixinRenderEntityItem extends MixinRender<EntityItem> {
    ...
    public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if(touchgrass.getClient().settingsManager.getSettingByName("Dropped Items").isEnabled() && touchgrass.getClient().moduleManager.getModule(Animations.class).isEnabled()) {
    ...
    private int func_177077_a(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_) {
        ...
        if (item == null) {
            ...
            float f6;
            if (flag || Minecraft.getMinecraft().getRenderManager().options != null && !(touchgrass.getClient().settingsManager.getSettingByName("Dropped Items").isEnabled() && touchgrass.getClient().moduleManager.getModule(Animations.class).isEnabled())) {
