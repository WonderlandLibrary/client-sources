...
public class Enabled extends Module {
   ...
   public Enabled(ModuleData data) {
      ...
      this.settings.put(this.TIME, new Setting(this.TIME, true, "For those moments it's just too much to tab out."));
   ...
   public void onEvent(Event event) {
      if (!mc.gameSettings.showDebugInfo) {
         ...
         if (clientName.equals("ETB")) {
            ...
            mc.fontRendererObj.drawString("\2477Render", 6.0F, 26.0F, -1);
            mc.fontRendererObj.drawString("\2477Movement", 6.0F, 38.0F, -1);
            mc.fontRendererObj.drawString("\2477Player", 6.0F, 50.0F, -1);
            mc.fontRendererObj.drawString("\2477World", 6.0F, 62.0F, -1);
            long currentMS = System.currentTimeMillis();
            mc.fontRendererObj.drawStringWithShadow("\2477FPS: \247f" + Minecraft.debugFPS, 2.0F, 76.0F, -1);
            this.lastMS = currentMS;
         } else {
            boolean drawTime = ((Boolean)((Setting)this.settings.get(this.TIME)).getValue()).booleanValue();
            ...
            String extra = username.equalsIgnoreCase("Neohack") ? " - Brain Dead Edition" : (username.equalsIgnoreCase("Aki") ? " - \247bG\247aa\247cy \2471E\2473d\2472i\2474t\2477i\2476o\247dn" : (username.equals("Kaxon") ? " - Arithmo's Slave Edition >w<" : (username.equals("Phase") ? " - Noob Edition" : (username.equals("Koala") ? " - Arithmo's Bitch Edition" : ""))));
            font.drawStringWithShadow(ok + (drawTime ? " \2477[\247r" + strDate + "\2477]\247f" : "") + extra, 1.5F + font.getWidth(name), 3.0F, Colors.getColor(255, 220));
