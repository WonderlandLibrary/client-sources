...
public class PasswordField extends Gui {
   ...
   private void drawCursorVertical(int par1, int par2, int par3, int par4) {
      ...
      var7.addVertex((double)par1, (double)par4, 0.0D);
      var7.addVertex((double)par3, (double)par4, 0.0D);
      var7.addVertex((double)par3, (double)par2, 0.0D);
      var7.addVertex((double)par1, (double)par2, 0.0D);
      var7.draw();
      GL11.glDisable(3058);
      GL11.glEnable(3553);
   }
