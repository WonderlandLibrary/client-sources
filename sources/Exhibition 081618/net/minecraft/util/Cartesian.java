...
public class Cartesian {
   public static Iterable cartesianProduct(Class clazz, Iterable sets) {
      return new Cartesian.Product(clazz, (Iterable[])((Iterable[])toArray(Iterable.class, sets)), (Object)null);
   }
   ...
   private static Iterable arraysAsLists(Iterable arrays) {
      return Iterables.transform(arrays, new Cartesian.GetList((Object)null));
   }
   ...
   static class Product implements Iterable {
      ...
      public Iterator iterator() {
         return (Iterator)(this.iterables.length <= 0 ? Collections.singletonList(Cartesian.createArray(this.clazz, 0)).iterator() : new Cartesian.Product.ProductIterator(this.clazz, this.iterables, (Object)null));
      }
   ...
   static class GetList implements Function {
      ...
      public Object apply(Object p_apply_1_) {
         return this.apply((Object[])((Object[])p_apply_1_));
      }
