      ...
      ListenableFuture var6 = field_180193_a.submit(new Runnable() {
         public void run() {
            ...
            try {
               ...
               int var16x = var1.getContentLength();
               if (p_180192_4_ != null) {
                  p_180192_4_.displayLoadingString(String.format("Downloading file (%.2f MB)...", var7 / 1000.0F / 1000.0F));
               }

               if (p_180192_0_.exists()) {
                  long var17 = p_180192_0_.length();
                  if (var17 == (long)var16x) {
                     if (p_180192_4_ != null) {
                  ...
                  HttpUtil.logger.warn("Deleting " + p_180192_0_ + " as it does not match what we currently have (" + var16x + " vs our " + var17 + ").");
