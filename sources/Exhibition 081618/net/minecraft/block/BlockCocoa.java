...
public class BlockCocoa extends BlockDirectional implements IGrowable {
   ...
   public BlockCocoa() {
      ...
      this.setDefaultState(this.blockState.getBaseState().withProperty(BlockDirectional.AGE, EnumFacing.NORTH).withProperty(field_176501_a, Integer.valueOf(0)));
   ...
   public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
      ...
      return this.getDefaultState().withProperty(BlockDirectional.AGE, facing.getOpposite()).withProperty(field_176501_a, Integer.valueOf(0));
   }
   ...
   public void grow(World worldIn, Random p_176474_2_, BlockPos p_176474_3_, IBlockState p_176474_4_) {
      worldIn.setBlockState(p_176474_3_, p_176474_4_.withProperty(field_176501_a, ((Integer)p_176474_4_.getValue(field_176501_a)).intValue() + 1), 2);
   }
   ...
   public IBlockState getStateFromMeta(int meta) {
      return this.getDefaultState().withProperty(BlockDirectional.AGE, EnumFacing.getHorizontal(meta)).withProperty(field_176501_a, (meta & 15) >> 2);
   }
   ...
   protected BlockState createBlockState() {
      return new BlockState(this, new IProperty[]{BlockDirectional.AGE, field_176501_a});
   }
