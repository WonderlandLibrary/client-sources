...
public class BlockChest extends BlockContainer {
   ...
   public IBlockState func_176458_f(World worldIn, BlockPos p_176458_2_, IBlockState p_176458_3_) {
      ...
      EnumFacing var8;
      while(var5.hasNext()) {
         var8 = (EnumFacing)var5.next();
         IBlockState var7 = worldIn.getBlockState(p_176458_2_.offset(var8));
         if (var7.getBlock() == this) {
            return p_176458_3_;
         }
      ...
      if (var4 != null) {
         ...
         var8 = (EnumFacing)p_176458_3_.getValue(FACING_PROP);
               ...
               while(true) {
                  ...
                  do {
                     ...
                     do {
                        ...
                        var7 = p_180676_2_.offset(var6);
                        var8 = worldIn.getBlockState(var7).getBlock();
                     } while(var8 != this);
                     ...
                     var9 = worldIn.getTileEntity(var7);
   ...
   public int getComparatorInputOverride(World worldIn, BlockPos pos) {
      return Container.calcRedstoneFromInventory((IInventory)this.getLockableContainer(worldIn, pos));
   }
