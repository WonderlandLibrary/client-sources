...
public class BlockFire extends Block {
   ...
   public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
      ...
      if (!World.doesBlockHaveSolidTopSurface(worldIn, pos.offsetDown()) && !Blocks.fire.func_176535_e(worldIn, pos.offsetDown())) {
         ...
         return state.withProperty(field_176545_N, this.func_176535_e(worldIn, pos.offsetNorth())).withProperty(field_176546_O, this.func_176535_e(worldIn, pos.offsetEast())).withProperty(field_176541_P, this.func_176535_e(worldIn, pos.offsetSouth())).withProperty(field_176539_Q, this.func_176535_e(worldIn, pos.offsetWest())).withProperty(field_176542_R, var9).withProperty(field_176540_b, var8).withProperty(field_176544_M, var7);
      } else {
   ...
   protected BlockFire() {
      super(Material.fire);
      this.setDefaultState(this.blockState.getBaseState().withProperty(field_176543_a, Integer.valueOf(0)).withProperty(field_176540_b, false).withProperty(field_176544_M, false).withProperty(field_176545_N, false).withProperty(field_176546_O, false).withProperty(field_176541_P, false).withProperty(field_176539_Q, false).withProperty(field_176542_R, Integer.valueOf(0)));
                     ...
                     if (var10 != 0 || var12 != 0 || var11 != 0) {
                        ...
                        if (var15 > 0) {
                           ...
                           if (var16 > 0 && rand.nextInt(var13) <= var16 && (!worldIn.isRaining() || !this.func_176537_d(worldIn, var14))) {
                              ...
                              worldIn.setBlockState(var14, state.withProperty(field_176543_a, var17), 3);
                           }
                        }
                     }
                  }
   ...
   private void func_176536_a(World worldIn, BlockPos p_176536_2_, int p_176536_3_, Random p_176536_4_, int p_176536_5_) {
      ...
      if (p_176536_4_.nextInt(p_176536_3_) < var6) {
         ...
         if (p_176536_4_.nextInt(p_176536_5_ + 10) < 5 && !worldIn.func_175727_C(p_176536_2_)) {
            ...
            worldIn.setBlockState(p_176536_2_, this.getDefaultState().withProperty(field_176543_a, var8), 3);
         } else {
   ...
   public IBlockState getStateFromMeta(int meta) {
      return this.getDefaultState().withProperty(field_176543_a, meta);
   }
