...
public abstract class BlockLiquid extends Block {
   ...
   public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state) {
      ...
      eb.fire(this, pos, new AxisAlignedBB((double)pos.getX() + this.minX, (double)pos.getY() + this.minY, (double)pos.getZ() + this.minZ, (double)pos.getX() + this.maxX, (double)pos.getY() + this.maxY, (double)pos.getZ() + this.maxZ));
      return eb.isCancelled() ? eb.getBounds() : null;
   }
   ...
   protected Vec3 func_180687_h(IBlockAccess p_180687_1_, BlockPos p_180687_2_) {
      ...
      if (((Integer)p_180687_1_.getBlockState(p_180687_2_).getValue(LEVEL)).intValue() >= 8) {
         ...
         do {
            ...
            var6 = (EnumFacing)var5.next();
            var7 = p_180687_2_.offset(var6);
         } while(!this.isBlockSolid(p_180687_1_, var7, var6) && !this.isBlockSolid(p_180687_1_, var7.offsetUp(), var6));
