...
public class BlockTripWire extends Block {
   ...
   public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
      return state.withProperty(field_176296_O, func_176287_c(worldIn, pos, state, EnumFacing.NORTH)).withProperty(field_176291_P, func_176287_c(worldIn, pos, state, EnumFacing.EAST)).withProperty(field_176289_Q, func_176287_c(worldIn, pos, state, EnumFacing.SOUTH)).withProperty(field_176292_R, func_176287_c(worldIn, pos, state, EnumFacing.WEST));
   }
   ...
   public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
      this.func_176286_e(worldIn, pos, state.withProperty(field_176293_a, true));
   }
   ...
   public IBlockState getStateFromMeta(int meta) {
      return this.getDefaultState().withProperty(field_176293_a, (meta & 1) > 0).withProperty(field_176290_b, (meta & 2) > 0).withProperty(field_176294_M, (meta & 4) > 0).withProperty(field_176295_N, (meta & 8) > 0);
   }
