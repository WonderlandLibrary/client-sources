...
public class BlockDynamicLiquid extends BlockLiquid {
   ...
   private void func_180690_f(World worldIn, BlockPos p_180690_2_, IBlockState p_180690_3_) {
      worldIn.setBlockState(p_180690_2_, BlockLiquid.getStaticLiquidForMaterial(this.blockMaterial).getDefaultState().withProperty(BlockLiquid.LEVEL, p_180690_3_.getValue(BlockLiquid.LEVEL)), 2);
   }
   ...
   public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
      ...
      if (var5 > 0) {
         ...
         EnumFacing var10;
         for(var11 = EnumFacing.Plane.HORIZONTAL.iterator(); var11.hasNext(); var8 = this.func_176371_a(worldIn, pos.offset(var10), var8)) {
         ...
         if (this.field_149815_a >= 2 && this.blockMaterial == Material.water) {
            ...
            if (var17.getBlock().getMaterial().isSolid()) {
               var14 = 0;
            } else if (var17.getBlock().getMaterial() == this.blockMaterial && ((Integer)var17.getValue(BlockLiquid.LEVEL)).intValue() == 0) {
               var14 = 0;
            }
         }
         ...
         if (var14 == var5) {
            ...
            if (var14 < 0) {
               ...
               state = state.withProperty(BlockLiquid.LEVEL, var14);
   ...
   private void func_176375_a(World worldIn, BlockPos p_176375_2_, IBlockState p_176375_3_, int p_176375_4_) {
      if (this.func_176373_h(worldIn, p_176375_2_, p_176375_3_)) {
         ...
         worldIn.setBlockState(p_176375_2_, this.getDefaultState().withProperty(BlockLiquid.LEVEL, p_176375_4_), 3);
      }
      ...
      while(true) {
         ...
         do {
            do {
               ...
               } while(var7 == p_176374_4_);

               var8 = p_176374_2_.offset(var7);
               var9 = worldIn.getBlockState(var8);
            } while(this.func_176372_g(worldIn, var8, var9));
         } while(var9.getBlock().getMaterial() == this.blockMaterial && ((Integer)var9.getValue(BlockLiquid.LEVEL)).intValue() <= 0);
      ...
      while(true) {
         ...
         do {
            do {
               ...
               var7 = p_176376_2_.offset(var6);
               var8 = worldIn.getBlockState(var7);
            } while(this.func_176372_g(worldIn, var7, var8));
         } while(var8.getBlock().getMaterial() == this.blockMaterial && ((Integer)var8.getValue(BlockLiquid.LEVEL)).intValue() <= 0);
