...
public class BlockTNT extends Block {
   ...
   public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) {
      ...
      if (worldIn.isBlockPowered(pos)) {
         this.onBlockDestroyedByPlayer(worldIn, pos, state.withProperty(field_176246_a, true));
   ...
   public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
      if (playerIn.getCurrentEquippedItem() != null) {
         ...
         if (var9 == Items.flint_and_steel || var9 == Items.fire_charge) {
            this.func_180692_a(worldIn, pos, state.withProperty(field_176246_a, true), playerIn);
            worldIn.setBlockToAir(pos);
   ...
   public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
      if (!worldIn.isRemote && entityIn instanceof EntityArrow) {
         ...
         if (var5.isBurning()) {
            this.func_180692_a(worldIn, pos, worldIn.getBlockState(pos).withProperty(field_176246_a, true), var5.shootingEntity instanceof EntityLivingBase ? (EntityLivingBase)var5.shootingEntity : null);
            worldIn.setBlockToAir(pos);
         }
      }
   ...
   public IBlockState getStateFromMeta(int meta) {
      return this.getDefaultState().withProperty(field_176246_a, (meta & 1) > 0);
   }
