...
public class BlockRedstoneWire extends Block {
   ...
   public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
      ...
      if (!worldIn.isRemote) {
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            var9 = var4[var6];
            worldIn.notifyNeighborsOfStateChange(pos.offset(var9), this);
         }
   ...
   private boolean func_176339_d(IBlockAccess p_176339_1_, BlockPos p_176339_2_, EnumFacing p_176339_3_) {
      ...
      return !var8 && var7 && func_176340_e(p_176339_1_, var4.offsetUp()) ? true : (func_176343_a(var5, p_176339_3_) ? true : (var6 == Blocks.powered_repeater && var5.getValue(BlockDirectional.AGE) == p_176339_3_ ? true : !var7 && func_176340_e(p_176339_1_, var4.offsetDown())));
   }
   ...
   public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
      ...
      if (var5 != 0) {
         ...
         worldIn.spawnParticle(EnumParticleTypes.REDSTONE, var6, var8, var10, (double)var13, (double)var14, (double)var15);
      }
