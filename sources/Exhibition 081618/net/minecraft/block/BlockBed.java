...
public class BlockBed extends BlockDirectional {
   ...
   public IBlockState getStateFromMeta(int meta) {
      ...
      return (meta & 8) > 0 ? this.getDefaultState().withProperty(PART_PROP, BlockBed.EnumPartType.HEAD).withProperty(BlockDirectional.AGE, var2).withProperty(OCCUPIED_PROP, (meta & 4) > 0) : this.getDefaultState().withProperty(PART_PROP, BlockBed.EnumPartType.FOOT).withProperty(BlockDirectional.AGE, var2);
   }
   ...
   protected BlockState createBlockState() {
      return new BlockState(this, new IProperty[]{BlockDirectional.AGE, PART_PROP, OCCUPIED_PROP});
   }
