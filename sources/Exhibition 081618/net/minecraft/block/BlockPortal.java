...
extends BlockBreakable {
    ...
    public static class Size {
        ...
        protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
            BlockPos var4;
            int var3;
            for (var3 = 0; var3 < 22 && this.func_150857_a(this.field_150867_a.getBlockState(var4 = p_180120_1_.offset(p_180120_2_, var3)).getBlock()) && this.field_150867_a.getBlockState(var4.offsetDown()).getBlock() == Blocks.obsidian; ++var3) {
            }
        ...
        public void func_150859_c() {
            for (int var1 = 0; var1 < this.field_150868_h; ++var1) {
                ...
                for (int var3 = 0; var3 < this.field_150862_g; ++var3) {
                    this.field_150867_a.setBlockState(var2.offsetUp(var3), Blocks.portal.getDefaultState().withProperty(BlockPortal.field_176550_a, (Comparable)((Object)this.field_150865_b)), 2);
                }
            }
        }
    }
