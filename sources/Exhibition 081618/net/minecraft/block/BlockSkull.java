...
public class BlockSkull extends BlockContainer {
   ...
   public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
      return this.getDefaultState().withProperty(field_176418_a, placer.func_174811_aO()).withProperty(field_176417_b, false);
   }
      ...
      if (p_180679_3_.getSkullType() == 1 && p_180679_2_.getY() >= 2 && worldIn.getDifficulty() != EnumDifficulty.PEACEFUL && !worldIn.isRemote) {
         ...
         if (var5 != null) {
            ...
            for(var6 = 0; var6 < 3; ++var6) {
               ...
               worldIn.setBlockState(var7.getPos(), var7.func_177509_a().withProperty(field_176417_b, true), 2);
            }
            ...
            for(var16 = 0; var16 < 120; ++var16) {
               worldIn.spawnParticle(EnumParticleTypes.SNOWBALL, (double)var12.getX() + worldIn.rand.nextDouble(), (double)(var12.getY() - 2) + worldIn.rand.nextDouble() * 3.9D, (double)var12.getZ() + worldIn.rand.nextDouble(), 0.0D, 0.0D, 0.0D);
            }
   ...
   public IBlockState getStateFromMeta(int meta) {
      return this.getDefaultState().withProperty(field_176418_a, EnumFacing.getFront(meta & 7)).withProperty(field_176417_b, (meta & 8) > 0);
   }
