...
public class BlockNewLeaf extends BlockLeaves {
   ...
   public BlockNewLeaf() {
      this.setDefaultState(this.blockState.getBaseState().withProperty(field_176240_P, BlockPlanks.EnumType.ACACIA).withProperty(BlockLeaves.field_176236_b, true).withProperty(BlockLeaves.field_176237_a, true));
   }
   ...
   public IBlockState getStateFromMeta(int meta) {
      return this.getDefaultState().withProperty(field_176240_P, this.func_176233_b(meta)).withProperty(BlockLeaves.field_176237_a, (meta & 4) == 0).withProperty(BlockLeaves.field_176236_b, (meta & 8) > 0);
   }
   ...
   protected BlockState createBlockState() {
      return new BlockState(this, new IProperty[]{field_176240_P, BlockLeaves.field_176236_b, BlockLeaves.field_176237_a});
   }
   ...
   public void harvestBlock(World worldIn, EntityPlayer playerIn, BlockPos pos, IBlockState state, TileEntity te) {
      if (!worldIn.isRemote && playerIn.getCurrentEquippedItem() != null && playerIn.getCurrentEquippedItem().getItem() == Items.shears) {
         ...
         Block.spawnAsEntity(worldIn, pos, new ItemStack(Item.getItemFromBlock(this), 1, ((BlockPlanks.EnumType)state.getValue(field_176240_P)).func_176839_a() - 4));
      } else {
