...
public abstract class BlockRailBase extends Block {
   ...
   public class Rail {
      ...
      private BlockRailBase.Rail func_180697_b(BlockPos p_180697_1_) {
         ...
         BlockRailBase var10002;
         if (BlockRailBase.func_176563_d(var3)) {
            var10002 = BlockRailBase.this;
            BlockRailBase.this.getClass();
            return var10002.new Rail(this.field_150660_b, p_180697_1_, var3);
         } else {
            ...
            if (BlockRailBase.func_176563_d(var3)) {
               var10002 = BlockRailBase.this;
               BlockRailBase.this.getClass();
               return var10002.new Rail(this.field_150660_b, var2, var3);
            } else {
               ...
               if (BlockRailBase.func_176563_d(var3)) {
                  var10002 = BlockRailBase.this;
                  BlockRailBase.this.getClass();
                  var10000 = var10002.new Rail(this.field_150660_b, var2, var3);
               } else {
                  var10000 = null;
               }
