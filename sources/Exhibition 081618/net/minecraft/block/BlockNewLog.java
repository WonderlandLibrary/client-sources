...
public class BlockNewLog extends BlockLog {
   ...
   public BlockNewLog() {
      this.setDefaultState(this.blockState.getBaseState().withProperty(field_176300_b, BlockPlanks.EnumType.ACACIA).withProperty(BlockLog.AXIS_PROP, BlockLog.EnumAxis.Y));
   }
   ...
   protected BlockState createBlockState() {
      return new BlockState(this, new IProperty[]{field_176300_b, BlockLog.AXIS_PROP});
   }
