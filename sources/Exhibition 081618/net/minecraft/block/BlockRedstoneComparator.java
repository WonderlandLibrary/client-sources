...
public class BlockRedstoneComparator extends BlockRedstoneDiode implements ITileEntityProvider {
   ...
   public BlockRedstoneComparator(boolean p_i45399_1_) {
      super(p_i45399_1_);
      this.setDefaultState(this.blockState.getBaseState().withProperty(BlockDirectional.AGE, EnumFacing.NORTH).withProperty(field_176464_a, false).withProperty(field_176463_b, BlockRedstoneComparator.Mode.COMPARE));
   ...
   protected IBlockState func_180674_e(IBlockState p_180674_1_) {
      ...
      return Blocks.powered_comparator.getDefaultState().withProperty(BlockDirectional.AGE, var4).withProperty(field_176464_a, var2).withProperty(field_176463_b, var3);
   }
   ...
   protected IBlockState func_180675_k(IBlockState p_180675_1_) {
      ...
      return Blocks.unpowered_comparator.getDefaultState().withProperty(BlockDirectional.AGE, var4).withProperty(field_176464_a, var2).withProperty(field_176463_b, var3);
   }
   ...
   public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
      if (this.isRepeaterPowered) {
         worldIn.setBlockState(pos, this.func_180675_k(state).withProperty(field_176464_a, true), 4);
      }
   ...
   public IBlockState getStateFromMeta(int meta) {
      return this.getDefaultState().withProperty(BlockDirectional.AGE, EnumFacing.getHorizontal(meta)).withProperty(field_176464_a, (meta & 8) > 0).withProperty(field_176463_b, (meta & 4) > 0 ? BlockRedstoneComparator.Mode.SUBTRACT : BlockRedstoneComparator.Mode.COMPARE);
   }
   ...
   protected BlockState createBlockState() {
      return new BlockState(this, new IProperty[]{BlockDirectional.AGE, field_176463_b, field_176464_a});
   }

   public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
      return this.getDefaultState().withProperty(BlockDirectional.AGE, placer.func_174811_aO().getOpposite()).withProperty(field_176464_a, false).withProperty(field_176463_b, BlockRedstoneComparator.Mode.COMPARE);
   }
