...
public class BlockSilverfish extends Block {
   ...
   public static enum EnumType implements IStringSerializable {
      ...
      // $FF: synthetic method
      EnumType(String x2, int x3, int x4, String x5, BlockSilverfish.SwitchEnumType x6, Object x7) {
         this(x2, x3, x4, x5, x6);
      }

      // $FF: synthetic method
      EnumType(String x2, int x3, int x4, String x5, String x6, BlockSilverfish.SwitchEnumType x7, Object x8) {
         this(x2, x3, x4, x5, x6, x7);
      }
