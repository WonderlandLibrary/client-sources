...
public class BlockRedstoneRepeater extends BlockRedstoneDiode {
   ...
   protected BlockRedstoneRepeater(boolean p_i45424_1_) {
      super(p_i45424_1_);
      this.setDefaultState(this.blockState.getBaseState().withProperty(BlockDirectional.AGE, EnumFacing.NORTH).withProperty(field_176410_b, Integer.valueOf(1)).withProperty(field_176411_a, false));
   }

   public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
      return state.withProperty(field_176411_a, this.func_176405_b(worldIn, pos, state));
   }
   ...
   protected IBlockState func_180674_e(IBlockState p_180674_1_) {
      ...
      return Blocks.powered_repeater.getDefaultState().withProperty(BlockDirectional.AGE, var4).withProperty(field_176410_b, var2).withProperty(field_176411_a, var3);
   }
   ...
   protected IBlockState func_180675_k(IBlockState p_180675_1_) {
      ...
      return Blocks.unpowered_repeater.getDefaultState().withProperty(BlockDirectional.AGE, var4).withProperty(field_176410_b, var2).withProperty(field_176411_a, var3);
   }
   ...
   public IBlockState getStateFromMeta(int meta) {
      return this.getDefaultState().withProperty(BlockDirectional.AGE, EnumFacing.getHorizontal(meta)).withProperty(field_176411_a, false).withProperty(field_176410_b, 1 + (meta >> 2));
   }
   ...
   protected BlockState createBlockState() {
      return new BlockState(this, new IProperty[]{BlockDirectional.AGE, field_176410_b, field_176411_a});
   }
}
