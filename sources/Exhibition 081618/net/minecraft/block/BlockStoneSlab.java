...
public abstract class BlockStoneSlab extends BlockSlab {
   ...
   protected BlockState createBlockState() {
      return this.isDouble() ? new BlockState(this, new IProperty[]{field_176555_b, field_176556_M}) : new BlockState(this, new IProperty[]{BlockSlab.HALF_PROP, field_176556_M});
   }
