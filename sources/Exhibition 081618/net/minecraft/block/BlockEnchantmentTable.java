            ...
            if (rand.nextInt(16) == 0) {
               for(int var7 = 0; var7 <= 1; ++var7) {
                  ...
                  if (worldIn.getBlockState(var8).getBlock() == Blocks.bookshelf) {
                     ...
                     worldIn.spawnParticle(EnumParticleTypes.ENCHANTMENT_TABLE, (double)pos.getX() + 0.5D, (double)pos.getY() + 2.0D, (double)pos.getZ() + 0.5D, (double)((float)var5 + rand.nextFloat()) - 0.5D, (double)((float)var7 - rand.nextFloat() - 1.0F), (double)((float)var6 + rand.nextFloat()) - 0.5D);
                  }
               }
            }
         }
