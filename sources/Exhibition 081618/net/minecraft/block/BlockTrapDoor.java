...
public class BlockTrapDoor extends Block {
   ...
   public IBlockState getStateFromMeta(int meta) {
      return this.getDefaultState().withProperty(field_176284_a, func_176281_b(meta)).withProperty(field_176283_b, (meta & 4) != 0).withProperty(field_176285_M, (meta & 8) == 0 ? BlockTrapDoor.DoorHalf.BOTTOM : BlockTrapDoor.DoorHalf.TOP);
   }
