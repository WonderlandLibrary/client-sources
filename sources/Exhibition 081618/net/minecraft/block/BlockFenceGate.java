...
public class BlockFenceGate extends BlockDirectional {
   ...
   public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
      return this.getDefaultState().withProperty(BlockDirectional.AGE, placer.func_174811_aO()).withProperty(field_176466_a, false).withProperty(field_176465_b, false).withProperty(field_176467_M, false);
   }
   ...
   public IBlockState getStateFromMeta(int meta) {
      return this.getDefaultState().withProperty(BlockDirectional.AGE, EnumFacing.getHorizontal(meta)).withProperty(field_176466_a, (meta & 4) != 0).withProperty(field_176465_b, (meta & 8) != 0);
   }
   ...
   protected BlockState createBlockState() {
      return new BlockState(this, new IProperty[]{BlockDirectional.AGE, field_176466_a, field_176465_b, field_176467_M});
   }
}
