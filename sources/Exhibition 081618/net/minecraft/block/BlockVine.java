...
public class BlockVine extends Block {
   ...
   public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
      return state.withProperty(field_176277_a, worldIn.getBlockState(pos.offsetUp()).getBlock().isSolidFullCube());
   }
      ...
      while(true) {
         ...
         do {
            ...
            do {
               ...
               } while(!((Boolean)p_176269_3_.getValue(var7)).booleanValue());
            } while(this.func_150093_a(worldIn.getBlockState(p_176269_2_.offset(var6)).getBlock()));

            var8 = worldIn.getBlockState(p_176269_2_.offsetUp());
         } while(var8.getBlock() == this && ((Boolean)var8.getValue(var7)).booleanValue());
         ...
         if (var17 == EnumFacing.UP && pos.getY() < 255 && worldIn.isAirBlock(pos.offsetUp())) {
            if (!var7) {
               ...
               while(true) {
                  ...
                  } while(!rand.nextBoolean() && this.func_150093_a(worldIn.getBlockState(pos.offset(var23).offsetUp()).getBlock()));
               ...
               if (!var7) {
                  ...
                  if (var21.blockMaterial == Material.air) {
                     ...
                     if (var25 && this.func_150093_a(worldIn.getBlockState(var27).getBlock())) {
                        worldIn.setBlockState(var18, this.getDefaultState().withProperty(func_176267_a(var23), true), 2);
                     } else if (var26 && this.func_150093_a(worldIn.getBlockState(var16).getBlock())) {
                        worldIn.setBlockState(var18, this.getDefaultState().withProperty(func_176267_a(var24), true), 2);
                     } else if (var25 && worldIn.isAirBlock(var27) && this.func_150093_a(worldIn.getBlockState(pos.offset(var23)).getBlock())) {
                        worldIn.setBlockState(var27, this.getDefaultState().withProperty(func_176267_a(var17.getOpposite()), true), 2);
                     } else if (var26 && worldIn.isAirBlock(var16) && this.func_150093_a(worldIn.getBlockState(pos.offset(var24)).getBlock())) {
                        worldIn.setBlockState(var16, this.getDefaultState().withProperty(func_176267_a(var17.getOpposite()), true), 2);
                     ...
                     worldIn.setBlockState(pos, state.withProperty(func_176267_a(var17), true), 2);
                  }
               }
            } else if (pos.getY() > 1) {
               ...
               if (var11.blockMaterial == Material.air) {
                  ...
                  while(true) {
                     ...
                     do {
                        ...
                        var14 = (EnumFacing)var13.next();
                        var15 = func_176267_a(var14);
                     } while(!rand.nextBoolean() && ((Boolean)state.getValue(var15)).booleanValue());
   ...
   public IBlockState getStateFromMeta(int meta) {
      return this.getDefaultState().withProperty(field_176273_b, (meta & field_176276_R) > 0).withProperty(field_176278_M, (meta & field_176275_S) > 0).withProperty(field_176279_N, (meta & field_176272_Q) > 0).withProperty(field_176280_O, (meta & field_176271_T) > 0);
   }
