...
public class BlockOldLog extends BlockLog {
   ...
   public BlockOldLog() {
      this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT_PROP, BlockPlanks.EnumType.OAK).withProperty(BlockLog.AXIS_PROP, BlockLog.EnumAxis.Y));
   }
   ...
   protected BlockState createBlockState() {
      return new BlockState(this, new IProperty[]{VARIANT_PROP, BlockLog.AXIS_PROP});
   }
