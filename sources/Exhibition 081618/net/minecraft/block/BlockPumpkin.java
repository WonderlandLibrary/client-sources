   ...
   private void createGolem(World worldIn, BlockPos p_180673_2_) {
      ...
      if ((var3 = this.func_176391_l().func_177681_a(worldIn, p_180673_2_)) != null) {
         ...
         for(var6 = 0; var6 < 120; ++var6) {
            worldIn.spawnParticle(EnumParticleTypes.SNOW_SHOVEL, (double)var11.getX() + worldIn.rand.nextDouble(), (double)var11.getY() + worldIn.rand.nextDouble() * 2.5D, (double)var11.getZ() + worldIn.rand.nextDouble(), 0.0D, 0.0D, 0.0D);
         }
         ...
         for(var6 = 0; var6 < 120; ++var6) {
            worldIn.spawnParticle(EnumParticleTypes.SNOWBALL, (double)var10.getX() + worldIn.rand.nextDouble(), (double)var10.getY() + worldIn.rand.nextDouble() * 3.9D, (double)var10.getZ() + worldIn.rand.nextDouble(), 0.0D, 0.0D, 0.0D);
         }
