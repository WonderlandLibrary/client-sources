...
public class BlockFence extends Block {
   ...
   public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
      return state.withProperty(NORTH, this.func_176524_e(worldIn, pos.offsetNorth())).withProperty(EAST, this.func_176524_e(worldIn, pos.offsetEast())).withProperty(SOUTH, this.func_176524_e(worldIn, pos.offsetSouth())).withProperty(WEST, this.func_176524_e(worldIn, pos.offsetWest()));
   }
