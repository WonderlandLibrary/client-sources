...
public class BlockStainedGlassPane extends BlockPane {
   ...
   public BlockStainedGlassPane() {
      ...
      this.setDefaultState(this.blockState.getBaseState().withProperty(BlockPane.NORTH, false).withProperty(BlockPane.EAST, false).withProperty(BlockPane.SOUTH, false).withProperty(BlockPane.WEST, false).withProperty(field_176245_a, EnumDyeColor.WHITE));
   ...
   protected BlockState createBlockState() {
      return new BlockState(this, new IProperty[]{BlockPane.NORTH, BlockPane.EAST, BlockPane.WEST, BlockPane.SOUTH, field_176245_a});
   }
