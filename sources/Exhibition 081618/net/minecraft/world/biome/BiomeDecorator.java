...
public class BiomeDecorator {
   ...
   protected void genDecorations(BiomeGenBase p_150513_1_) {
      ...
      for(var3 = 0; var3 < this.waterlilyPerChunk; ++var3) {
         ...
         for(var7 = this.field_180294_c.add(var4, var11, var5); var7.getY() > 0; var7 = var10) {
            var10 = var7.offsetDown();
            if (!this.currentWorld.isAirBlock(var10)) {
               break;
            }
         }
      ...
      for(var3 = 0; var3 < this.mushroomsPerChunk; ++var3) {
         if (this.randomGenerator.nextInt(4) == 0) {
            var4 = this.randomGenerator.nextInt(16) + 8;
            var5 = this.randomGenerator.nextInt(16) + 8;
            var10 = this.currentWorld.getHorizon(this.field_180294_c.add(var4, 0, var5));
            this.mushroomBrownGen.generate(this.currentWorld, this.randomGenerator, var10);
         }
