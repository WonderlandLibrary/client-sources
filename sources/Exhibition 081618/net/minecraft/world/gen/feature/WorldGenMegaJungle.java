...
public class WorldGenMegaJungle extends WorldGenHugeTrees {
   ...
   public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_) {
      ...
      if (!this.func_175929_a(worldIn, p_180709_2_, p_180709_3_, var4)) {
         ...
         int var13;
         for(var13 = p_180709_3_.getY() + var4 - 2 - p_180709_2_.nextInt(4); var13 > p_180709_3_.getY() + var4 / 2; var13 -= 2 + p_180709_2_.nextInt(4)) {
            ...
            for(var9 = 0; var9 < 5; ++var9) {
               ...
               this.func_175905_a(worldIn, new BlockPos(var7, var13 - 3 + var9 / 2, var8), Blocks.log, this.woodMetadata);
            }

            var9 = 1 + p_180709_2_.nextInt(2);
            int var10 = var13;

            for(int var11 = var13 - var9; var11 <= var10; ++var11) {
