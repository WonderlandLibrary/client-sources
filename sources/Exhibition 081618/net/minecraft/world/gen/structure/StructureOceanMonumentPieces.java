   ...
   public static class MonumentCoreRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         for(var7 = 1; var7 <= 6; ++var7) {
            ...
            for(var8 = 0; var8 <= 15; var8 += 15) {
               this.func_175804_a(worldIn, p_74875_3_, var8, var7, 0, var8, var7, 1, var5, var5, false);
               this.func_175804_a(worldIn, p_74875_3_, var8, var7, 6, var8, var7, 9, var5, var5, false);
               this.func_175804_a(worldIn, p_74875_3_, var8, var7, 14, var8, var7, 15, var5, var5, false);
            }
         ...
         while(var22.hasNext()) {
            ...
            while(true) {
               while(true) {
                  ...
                  } while(!var23.field_175966_c[var12]);
