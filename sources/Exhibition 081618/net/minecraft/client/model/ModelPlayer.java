...
public class ModelPlayer extends ModelBiped {
   ...
   public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
      ...
      if (this.isChild) {
         ...
         if ((!((Module)Client.getModuleManager().get(Chams.class)).isEnabled() || !((Boolean)((Module)Client.getModuleManager().get(Chams.class)).getSetting("COLORED").getValue()).booleanValue()) && RendererLivingEntity.renderLayers) {
            this.field_178733_c.render(p_78088_7_);
            this.field_178731_d.render(p_78088_7_);
            this.field_178734_a.render(p_78088_7_);
            this.field_178732_b.render(p_78088_7_);
   ...
   public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
      ...
      if (p_78087_7_ instanceof EntityPlayer) {
         SpookySkeltal.updateModel((EntityPlayer)p_78087_7_, (ModelPlayer)this);
      }
