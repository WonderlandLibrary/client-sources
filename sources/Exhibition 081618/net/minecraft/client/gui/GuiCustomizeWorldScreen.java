...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
   ...
   public void initGui() {
      this.customizeWorldSettings = I18n.format("options.customizeTitle");
      this.buttonList.clear();
      this.buttonList.add(this.btnPrevious = new GuiButton(302, 20, 5, 80, 20, I18n.format("createWorld.customize.custom.prev")));
      this.buttonList.add(this.btnNext = new GuiButton(303, this.width - 100, 5, 80, 20, I18n.format("createWorld.customize.custom.next")));
      this.buttonList.add(this.btnDefaults = new GuiButton(304, this.width / 2 - 187, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.defaults")));
      this.buttonList.add(this.btnRandom = new GuiButton(301, this.width / 2 - 92, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.randomize")));
      this.buttonList.add(this.btnPresets = new GuiButton(305, this.width / 2 + 3, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.presets")));
      this.buttonList.add(this.btnDone = new GuiButton(300, this.width / 2 + 98, this.height - 27, 90, 20, I18n.format("gui.done")));
      this.btnYes = new GuiButton(306, this.width / 2 - 55, 160, 50, 20, I18n.format("gui.yes"));
      this.btnYes.visible = false;
      this.buttonList.add(this.btnYes);
      this.btnNo = new GuiButton(307, this.width / 2 + 5, 160, 50, 20, I18n.format("gui.no"));
   ...
   private void func_175325_f() {
      ...
      for(int var5 = 0; var5 < 4; ++var5) {
         this.strArray[var5] = I18n.format("createWorld.customize.custom.page" + var5);
      }
