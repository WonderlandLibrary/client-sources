...
public class GuiEnchantment extends GuiContainer {
   ...
   protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
      ...
      this.fontRendererObj.drawString(this.field_175379_F.getDisplayName().getUnformattedText(), 8.0F, (float)(this.ySize - 96 + 2), 4210752);
   }
      ...
      for(int var6 = 0; var6 < 3; ++var6) {
         ...
         if (this.isPointInRegion(60, 14 + 19 * var6, 108, 17, mouseX, mouseY) && var7 > 0 && var8 >= 0) {
            ...
            if (var8 >= 0 && Enchantment.func_180306_c(var8 & 255) != null) {
               var11 = Enchantment.func_180306_c(var8 & 255).getTranslatedName((var8 & '\uff00') >> 8);
