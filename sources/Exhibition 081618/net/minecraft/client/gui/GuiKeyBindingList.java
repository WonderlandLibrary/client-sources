...
public class GuiKeyBindingList extends GuiListExtended {
   ...
   public GuiKeyBindingList(GuiControls p_i45031_1_, Minecraft mcIn) {
      ...
      this.mc = mcIn;
      KeyBinding[] var3 = (KeyBinding[])((KeyBinding[])ArrayUtils.clone(mcIn.gameSettings.keyBindings));
      ...
      for(int var8 = 0; var8 < var7; ++var8) {
         ...
         int var11 = mcIn.fontRendererObj.getStringWidth(I18n.format(var9.getKeyDescription()));
         if (var11 > this.maxListLabelWidth) {
            this.maxListLabelWidth = var11;
         }

         this.listEntries[var4++] = new GuiKeyBindingList.KeyEntry(var9, (Object)null);
      }
   ...
   public class KeyEntry implements GuiListExtended.IGuiListEntry {
      ...
      public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
         ...
         GuiKeyBindingList.this.mc.fontRendererObj.drawString(this.field_148283_c, (float)(x + 90 - GuiKeyBindingList.this.maxListLabelWidth), (float)(y + slotHeight / 2 - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT / 2), 16777215);
