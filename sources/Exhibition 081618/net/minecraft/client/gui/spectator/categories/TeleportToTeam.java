   ...
   class TeamSelectionObject implements ISpectatorMenuObject {
      ...
      public TeamSelectionObject(ScorePlayerTeam p_i45492_2_) {
         ...
         while(var3.hasNext()) {
            ...
            NetworkPlayerInfo var5 = Minecraft.getMinecraft().getNetHandler().func_175104_a(var6);
            if (var5 != null) {
         ...
         if (!this.field_178675_d.isEmpty()) {
            var6 = ((NetworkPlayerInfo)this.field_178675_d.get((new Random()).nextInt(this.field_178675_d.size()))).getGameProfile().getName();
