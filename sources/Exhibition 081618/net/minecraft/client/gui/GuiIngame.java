...
public class GuiIngame extends Gui {
   ...
   public void func_175180_a(float p_175180_1_) {
      ...
      try {
         username = Crypto.decryptPublicNew(Client.authUser.getEncryptedUsername());
      } catch (Exception var17) {
    	  
      }

      if (username.equals((Object)null) || username.equals("")) {
    	  
      }

      String xd = "§7" + (Client.developerMode ? "Developer Build" : (username.equalsIgnoreCase("Neohack") ? "Special ED Build" : (username.equalsIgnoreCase("Aki") ? "Beta Cutie Build" : (username.equals("Kaxon") ? "Fake Trap Build" : (username.equals("Phase") ? "Fightbot Build" : (username.equals("Koala") ? "Dumb Fag Build" : "Release Build")))))) + " - §f§l" + Client.version + " §7- §l" + username;
      font.drawStringWithShadow(xd, (float)var2.getScaledWidth() - font.getWidth(xd) - 1.0F, (float)(var2.getScaledHeight() - (this.mc.currentScreen instanceof GuiChat ? 24 : 12)), Colors.getColor(255, 220));
      int var8;
      int var11;
      ...
      if (this.recordPlayingUpFor > 0) {
         ...
         if (var8 > 8) {
            ...
            this.func_175179_f().drawString(this.recordPlaying, (float)(-this.func_175179_f().getStringWidth(this.recordPlaying) / 2), -4.0F, var9 + (var8 << 24 & -16777216));
            GlStateManager.disableBlend();
   ...
   public void func_175176_b(ScaledResolution p_175176_1_, int p_175176_2_) {
      ...
      if (this.mc.thePlayer.experienceLevel > 0) {
         ...
         boolean var8 = false;
         this.func_175179_f().drawString(var10, (float)(var6 + 1), (float)var7, 0);
         this.func_175179_f().drawString(var10, (float)(var6 - 1), (float)var7, 0);
         this.func_175179_f().drawString(var10, (float)var6, (float)(var7 + 1), 0);
         this.func_175179_f().drawString(var10, (float)var6, (float)(var7 - 1), 0);
         this.func_175179_f().drawString(var10, (float)var6, (float)var7, var9);
         this.mc.mcProfiler.endSection();
      }
   ...
   private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
      if (!Client.getModuleManager().isEnabled(StreamerMode.class) || !StreamerMode.hideScore) {
         ...
         int var23 = p_180475_2_.getScaledHeight() - var22 / 3;
         byte var24 = 3;
         ...
         while(var12.hasNext()) {
            ...
            this.func_175179_f().drawString(var15, (float)var25, (float)var18, 553648127);
            this.func_175179_f().drawString(var16, (float)(var19 - this.func_175179_f().getStringWidth(var16)), (float)var18, 553648127);
            if (var11 == var21.size()) {
               ...
               this.func_175179_f().drawString(var20, (float)(var25 + var6 / 2 - this.func_175179_f().getStringWidth(var20) / 2), (float)(var18 - this.func_175179_f().FONT_HEIGHT), 553648127);
            }
         }
