...
public class GuiCreateFlatWorld extends GuiScreen {
   ...
   class Details extends GuiSlot {
      ...
      protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         ...
         GuiCreateFlatWorld.this.fontRendererObj.drawString(var12, (float)(p_180791_2_ + 18 + 5), (float)(p_180791_3_ + 3), 16777215);
         String var13;
         if (p_180791_1_ == 0) {
         ...
         GuiCreateFlatWorld.this.fontRendererObj.drawString(var13, (float)(p_180791_2_ + 2 + 213 - GuiCreateFlatWorld.this.fontRendererObj.getStringWidth(var13)), (float)(p_180791_3_ + 3), 16777215);
      }
