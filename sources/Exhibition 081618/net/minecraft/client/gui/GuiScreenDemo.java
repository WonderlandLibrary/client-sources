...
public class GuiScreenDemo extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      this.fontRendererObj.drawString(I18n.format("demo.help.title"), (float)var4, (float)var5, 2039583);
      var5 += 12;
      ...
      this.fontRendererObj.drawString(I18n.format("demo.help.movementMouse"), (float)var4, (float)(var5 + 12), 5197647);
      this.fontRendererObj.drawString(I18n.format("demo.help.jump", GameSettings.getKeyDisplayString(var6.keyBindJump.getKeyCode())), (float)var4, (float)(var5 + 24), 5197647);
      this.fontRendererObj.drawString(I18n.format("demo.help.inventory", GameSettings.getKeyDisplayString(var6.keyBindInventory.getKeyCode())), (float)var4, (float)(var5 + 36), 5197647);
