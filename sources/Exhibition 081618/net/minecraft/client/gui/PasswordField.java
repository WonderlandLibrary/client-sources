   ...
   public void drawTextBox() {
      if (this.func_73778_q()) {
         ...
         if (var4.length() > 0) {
            ...
            var9 = this.fontRenderer.drawStringWithShadow(this.text.replaceAll("(?s).", "*"), (float)var7, (float)var8, var1);
         }
         ...
         if (var6) {
            if (var13) {
               ...
               this.fontRenderer.drawStringWithShadow("_", (float)var11, (float)var8, var1);
            }
         }
