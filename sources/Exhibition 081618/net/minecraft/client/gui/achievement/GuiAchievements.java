...
public class GuiAchievements extends GuiScreen implements IProgressMeter {
   ...
   protected void drawTitle() {
      ...
      this.fontRendererObj.drawString(I18n.format("gui.achievements"), (float)(var1 + 15), (float)(var2 + 5), 4210752);
   }
   ...
   protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
      ...
      for(var22 = 0; var22 < AchievementList.achievementList.size(); ++var22) {
         var33 = (Achievement)AchievementList.achievementList.get(var22);
         if (var33.parentAchievement != null) {
            var24 = var33.displayColumn * 24 - var4 + 11;
            var25 = var33.displayRow * 24 - var5 + 11;
            int var37 = var33.parentAchievement.displayColumn * 24 - var4 + 11;
            var40 = var33.parentAchievement.displayRow * 24 - var5 + 11;
            ...
            var30 = this.statFileWriter.func_150874_c(var33);
            if (var30 <= 4) {
               var31 = -16777216;
               if (var28) {
                  var31 = -6250336;
      ...
      if (var33 != null) {
         ...
         if (this.statFileWriter.canUnlockAchievement(var33)) {
            ...
            if (this.statFileWriter.hasAchievementUnlocked(var33)) {
               this.fontRendererObj.drawStringWithShadow(I18n.format("achievement.taken"), (float)var40, (float)(var41 + var31 + 4), -7302913);
            }
         } else {
            int var32;
            String var44;
