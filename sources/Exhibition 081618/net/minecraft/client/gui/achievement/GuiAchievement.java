   ...
   public void updateAchievementWindow() {
      if (this.theAchievement != null && this.notificationTime != 0L && Minecraft.getMinecraft().thePlayer != null) {
         ...
         if (this.permanentNotification) {
            ...
            this.mc.fontRendererObj.drawString(this.achievementTitle, (float)(var5 + 30), (float)(var6 + 7), -256);
            this.mc.fontRendererObj.drawString(this.achievementDescription, (float)(var5 + 30), (float)(var6 + 18), -1);
         }
