...
public class GuiScreenBook extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.bookGettingSigned) {
         ...
         this.fontRendererObj.drawString(var7, (float)(var4 + 36 + (116 - var8) / 2), (float)(var5 + 16 + 16), 0);
         var9 = this.fontRendererObj.getStringWidth(var6);
         this.fontRendererObj.drawString(var6, (float)(var4 + 36 + (116 - var9) / 2), (float)(var5 + 48), 0);
         String var10 = I18n.format("book.byAuthor", this.editingPlayer.getName());
         int var11 = this.fontRendererObj.getStringWidth(var10);
         this.fontRendererObj.drawString(EnumChatFormatting.DARK_GRAY + var10, (float)(var4 + 36 + (116 - var11) / 2), (float)(var5 + 48 + 10), 0);
         ...
         if (this.bookIsUnsigned) {
            ...
            if (ItemEditableBook.validBookTagContents(this.bookObj.getTagCompound())) {
               try {
                  var17 = IChatComponent.Serializer.jsonToComponent(var7);
                  this.field_175386_A = var17 != null ? GuiUtilRenderComponents.func_178908_a(var17, 116, this.fontRendererObj, true, true) : null;
         ...
         this.fontRendererObj.drawString(var6, (float)(var4 - var8 + this.bookImageWidth - 44), (float)(var5 + 16), 0);
         if (this.field_175386_A == null) {
            ...
            for(int var16 = 0; var16 < var9; ++var16) {
               ...
               this.fontRendererObj.drawString(var18.getUnformattedText(), (float)(var4 + 36), (float)(var5 + 16 + 16 + var16 * this.fontRendererObj.FONT_HEIGHT), 0);
            }

            var17 = this.func_175385_b(mouseX, mouseY);
            if (var17 != null) {
