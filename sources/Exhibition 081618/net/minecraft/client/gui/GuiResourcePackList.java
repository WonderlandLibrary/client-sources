...
public abstract class GuiResourcePackList extends GuiListExtended {
   ...
   protected void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_) {
      ...
      this.mc.fontRendererObj.drawString(var4, (float)(p_148129_1_ + this.width / 2 - this.mc.fontRendererObj.getStringWidth(var4) / 2), (float)Math.min(this.top + 3, p_148129_2_), 16777215);
   }
