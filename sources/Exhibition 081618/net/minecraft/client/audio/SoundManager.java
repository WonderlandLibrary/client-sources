         ...
         try {
            (new Thread(new Runnable() {
               public void run() {
                  ...
                  var10000.sndSystem = var10003.new SoundSystemStarterThread((Object)null);
      ...
      public boolean playing(String p_playing_1_) {
         ...
         synchronized(SoundSystemConfig.THREAD_SYNC) {
            if (this.soundLibrary == null) {
               ...
               Source var3x = (Source)this.soundLibrary.getSources().get(p_playing_1_);
               return var3x == null ? false : var3x.playing() || var3x.paused() || var3x.preLoad;
            }
         }
      }
