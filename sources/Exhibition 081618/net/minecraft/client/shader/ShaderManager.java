   ...
   public ShaderManager(IResourceManager resourceManager, String programName) throws JsonException {
      ...
      try {
         ...
         if (var9 != null) {
            ...
            for(var32 = var9.iterator(); var32.hasNext(); ++var10) {
               JsonElement var12 = (JsonElement)var32.next();

               try {
                  this.parseSampler(var12);
               } catch (Exception var26) {
                  JsonException var14 = JsonException.func_151379_a(var26);
         ...
         if (var31 != null) {
            ...
            for(Iterator var34 = var31.iterator(); var34.hasNext(); ++var33) {
               ...
               try {
                  ...
                  JsonException var16 = JsonException.func_151379_a(var24);
         ...
         JsonException var8 = JsonException.func_151379_a(var27);
