...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
   ...
   public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
      ...
      if (packetIn.func_148993_l() == 10) {
         ...
         var8 = new EntityFallingBlock(this.clientWorldController, var2, var4, var6, Block.getStateById(packetIn.func_149009_m() & '\uffff'));
         packetIn.func_149002_g(0);
      }
   ...
   public void handleExplosion(S27PacketExplosion packetIn) {
      ...
      this.gameController.thePlayer.motionX += (double)packetIn.getX();
      this.gameController.thePlayer.motionY += (double)packetIn.getY();
      this.gameController.thePlayer.motionZ += (double)packetIn.getZ();
   }
   ...
   public void handleSetSlot(S2FPacketSetSlot packetIn) {
      ...
      if (packetIn.func_149175_c() == -1) {
         ...
         if (packetIn.func_149175_c() == 0 && packetIn.getSlotID() >= 36 && packetIn.getSlotID() < 45) {
            ItemStack var5 = var2.inventoryContainer.getSlot(packetIn.getSlotID()).getStack();
            ...
            var2.inventoryContainer.putStackInSlot(packetIn.getSlotID(), packetIn.func_149174_e());
         } else if (packetIn.func_149175_c() == var2.openContainer.windowId && (packetIn.func_149175_c() != 0 || !var3)) {
            var2.openContainer.putStackInSlot(packetIn.getSlotID(), packetIn.func_149174_e());
         }
      }
   ...
   public void func_175099_a(S45PacketTitle p_175099_1_) {
      ...
      S45PacketTitle.Type var2 = p_175099_1_.getType();
      String var3 = null;
      String var4 = null;
      String var5 = p_175099_1_.getMessage() != null ? p_175099_1_.getMessage().getFormattedText() : "";
      ...
      this.gameController.ingameGUI.func_175178_a(var3, var4, p_175099_1_.getFadeInTime(), p_175099_1_.getDisplayTime(), p_175099_1_.getFadeOutTime());
   }
   ...
   public NetworkPlayerInfo func_175104_a(String p_175104_1_) {
      ...
      while(var2.hasNext()) {
         ...
         if (var3.getGameProfile().getName().equals(p_175104_1_)) {
            return var3;
         }
      }
