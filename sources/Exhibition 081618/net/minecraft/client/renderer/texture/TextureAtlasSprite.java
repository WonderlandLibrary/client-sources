...
public class TextureAtlasSprite {
   ...
   public void updateAnimation() {
      ...
      if (this.tickCounter >= this.animationMetadata.getFrameTimeSingle(this.frameCounter)) {
         ...
         if (var1 != var3 && var3 >= 0 && var3 < this.framesTextureData.size()) {
            TextureUtil.uploadTextureMipmap((int[][])((int[][])((int[][])this.framesTextureData.get(var3))), this.width, this.height, this.originX, this.originY, false, false);
         }
   ...
   private void func_180599_n() {
      ...
      if (var3 != var5 && var5 >= 0 && var5 < this.framesTextureData.size()) {
         int[][] var6 = (int[][])((int[][])((int[][])this.framesTextureData.get(var3)));
         int[][] var7 = (int[][])((int[][])((int[][])this.framesTextureData.get(var5)));
   ...
   public void func_180598_a(BufferedImage[] p_180598_1_, AnimationMetadataSection p_180598_2_) {
      ...
      for(var11 = 0; var11 < this.framesTextureData.size(); ++var11) {
         int[][] var12 = (int[][])((int[][])((int[][])this.framesTextureData.get(var11)));
         if (var12 != null) {
