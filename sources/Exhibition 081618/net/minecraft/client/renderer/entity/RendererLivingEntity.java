...
public abstract class RendererLivingEntity extends Render {
   ...
   public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
      ...
      try {
         ...
         float var20 = Minecraft.getMinecraft().gameSettings.thirdPersonView != 0 && ((Module)Client.getModuleManager().get(AntiAim.class)).isEnabled() && p_76986_1_ == Minecraft.getMinecraft().thePlayer ? p_76986_1_.prevRotationPitch + ((AntiAim.rotationPitch != 0.0F ? AntiAim.rotationPitch : p_76986_1_.rotationPitch) - p_76986_1_.prevRotationPitch) : p_76986_1_.prevRotationPitch + (p_76986_1_.rotationPitch - p_76986_1_.prevRotationPitch) * p_76986_9_;
