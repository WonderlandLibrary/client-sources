...
public abstract class Render {
   ...
   protected void renderLivingLabel(Entity p_147906_1_, String p_147906_2_, double p_147906_3_, double p_147906_5_, double p_147906_7_, int p_147906_9_) {
      ...
      if (var10 <= (double)(p_147906_9_ * p_147906_9_)) {
         ...
         var15.draw();
         GlStateManager.enableTextures();
         var12.drawString(p_147906_2_, (float)(-var12.getStringWidth(p_147906_2_) / 2), (float)var17, 553648127);
         GlStateManager.enableDepth();
         GlStateManager.depthMask(true);
         var12.drawString(p_147906_2_, (float)(-var12.getStringWidth(p_147906_2_) / 2), (float)var17, -1);
         GlStateManager.enableLighting();
         GlStateManager.disableBlend();
         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
         GlStateManager.popMatrix();
