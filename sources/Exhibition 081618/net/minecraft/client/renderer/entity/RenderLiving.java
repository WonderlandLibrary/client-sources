...
public abstract class RenderLiving extends RendererLivingEntity {
   ...
   protected void func_110827_b(EntityLiving p_110827_1_, double p_110827_2_, double p_110827_4_, double p_110827_6_, float p_110827_8_, float p_110827_9_) {
      ...
      if (var10 != null) {
         ...
         double var31 = this.func_110828_a((double)p_110827_1_.prevRenderYawOffset, (double)p_110827_1_.renderYawOffset, (double)p_110827_9_) * 0.01745329238474369D + 1.5707963267948966D;
         ...
         for(var48 = 0; var48 <= 24; ++var48) {
            if (var48 % 2 == 0) {
               var12.setColorRGBA(0.5F, 0.4F, 0.3F, 1.0F);
            } else {
               var12.setColorRGBA(0.35F, 0.28F, 0.21000001F, 1.0F);
            }
