...
public class EntityRenderer implements IResourceManagerReloadListener {
               ...
               if (bounds.isVecInside(vec1)) {
                  ...
                  if (var20 < var13 || var13 == 0.0D) {
                     ...
                     if (Reflector.ForgeEntity_canRiderInteract.exists()) {
                        canRiderInteract = Reflector.callBoolean(index, Reflector.ForgeEntity_canRiderInteract);
                     }
         ...
         if (this.mc.gameSettings.debugCamEnable) {
            ...
            for(int var20 = 0; var20 < 8; ++var20) {
               ...
               if (var24 != null) {
                  ...
                  if (var25 < var28 && !((Module)Client.getModuleManager().get(ViewClip.class)).isEnabled()) {
                     var28 = var25;
                  }
               }
            }
      ...
      if (this.lightmapUpdateNeeded) {
         ...
         if (var2 != null) {
            ...
            for(int var3 = 0; var3 < 256; ++var3) {
               ...
               var16 = Client.getModuleManager().isEnabled(Xray.class) ? 10000.0F : this.mc.gameSettings.gammaSetting;
               var17 = 1.0F - var13;
   ...
   public void updateCameraAndRender(float partialTicks) {
      ...
      if (!this.mc.skipRenderWorld) {
         ...
         if (this.mc.currentScreen != null) {
            ...
            try {
               ...
               if (Reflector.EventBus_post.exists()) {
                  var122 = Reflector.postForgeBusEvent(Reflector.DrawScreenEvent_Pre_Constructor, this.mc.currentScreen, var161, var171, partialTicks);
               }
               ...
               Reflector.postForgeBusEvent(Reflector.DrawScreenEvent_Post_Constructor, this.mc.currentScreen, var161, var171, partialTicks);
               ...
               var11.addCrashSectionCallable("Screen size", new Callable() {
                  public String call() {
                     return String.format("Scaled: (%d, %d). Absolute: (%d, %d). Scale factor of %d", var131.getScaledWidth(), var131.getScaledHeight(), EntityRenderer.this.mc.displayWidth, EntityRenderer.this.mc.displayHeight, var131.getScaleFactor());
                  }
               });
         ...
         Client.getClickGui().drawMenu(var161, var171, partialTicks);
   ...
   private void func_175068_a(int pass, float partialTicks, long finishTimeNano) {
      ...
      boolean renderFirstPersonHand = Reflector.callBoolean(Reflector.ForgeHooksClient_renderFirstPersonHand, this.mc.renderGlobal, partialTicks, pass);
   ...
   private void setupFog(int p_78468_1_, float partialTicks) {
      ...
      Object event = Reflector.newInstance(Reflector.EntityViewRenderEvent_FogDensity_Constructor, this, var3, var5, partialTicks, 0.1F);
      float var6;
      if (Reflector.postForgeBusEvent(event)) {
         ...
         Reflector.postForgeBusEvent(Reflector.newInstance(Reflector.EntityViewRenderEvent_RenderFogEvent_Constructor, this, var3, var5, partialTicks, p_78468_1_, var6));
      }
