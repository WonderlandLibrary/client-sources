      ...
      if (this.renderEntitiesStartupCounter > 0) {
         ...
         if (this.func_174985_d()) {
            ...
            while(true) {
               ...
               var26 = entity.isInRangeToRender3d(var4, var6, var8) && (entity.ignoreFrustumCheck || p_180446_2_.isBoundingBoxInFrustum(entity.getEntityBoundingBox()) || entity.riddenByEntity == this.mc.thePlayer);
         ...
         while(var321.hasNext()) {
            ...
            while(true) {
               ...
               boolean var34;
               while(true) {
                  if (!((Iterator)var27).hasNext()) {
                     continue label168;
                  }

                  var30 = (Entity)((Iterator)var27).next();
                  var34 = this.field_175010_j.func_178635_a(var30, p_180446_2_, var4, var6, var8) || var30.riddenByEntity == this.mc.thePlayer;
                  if (!var34) {
                     break;
                  }
         ...
         while(true) {
            ...
            do {
               do {
                  ...
                  var37 = (DestroyBlockProgress)var321.next();
                  ...
                  var41 = this.theWorld.getBlockState(var39).getBlock();
               } while(var35 == null);
   ...
   public void func_174970_a(Entity viewEntity, double partialTicks, ICamera camera, int frameCount, boolean playerSpectator) {
      ...
      while(true) {
         do {
            ...
            var41 = var39.field_178036_a;
         } while(!var41.func_178569_m() && !var361.contains(var41));
            ...
            if (Config.isCloudsFancy()) {
               ...
               if (this.isFancyGlListClouds || this.cloudTickCounter >= this.cloudTickCounterGlList + 20) {
                  ...
                  if (p_180447_2_ != 2) {
                     ...
                     exactPlayerZ = (exactPlayerX * 30.0F + var10 * 70.0F) / 100.0F;
                     var14 = (exactPlayerX * 30.0F + exactPlayerY * 70.0F) / 100.0F;
                     exactPlayerX = var12;
                     var10 = exactPlayerZ;
                     exactPlayerY = var14;
                  }
               ...
               exactPlayerZ = (float)(exactPlayerX1 - this.cloudPlayerX + dc * 0.03D);
               var14 = (float)(exactPlayerY1 - this.cloudPlayerY);
               float cdz1 = (float)(exactPlayerZ1 - this.cloudPlayerZ);
               GlStateManager.translate(-exactPlayerZ, -var14, -cdz1);
   ...
   public void func_180439_a(EntityPlayer p_180439_1_, int p_180439_2_, BlockPos p_180439_3_, int p_180439_4_) {
      ...
      case 2002:
         ...
         for(var13 = 0; var13 < 8; ++var13) {
            this.func_174972_a(EnumParticleTypes.ITEM_CRACK, var7, var9, var11, var5.nextGaussian() * 0.15D, var5.nextDouble() * 0.2D, var5.nextGaussian() * 0.15D, Item.getIdFromItem(Items.potionitem), p_180439_4_);
         }
      ...
      case 2003:
         ...
         for(var13 = 0; var13 < 8; ++var13) {
            this.func_174972_a(EnumParticleTypes.ITEM_CRACK, var7, var9, var11, var5.nextGaussian() * 0.15D, var5.nextDouble() * 0.2D, var5.nextGaussian() * 0.15D, Item.getIdFromItem(Items.ender_eye));
         }
