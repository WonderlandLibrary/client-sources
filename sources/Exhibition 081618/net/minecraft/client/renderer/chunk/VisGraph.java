...
public class VisGraph {
   ...
   public void func_178606_a(BlockPos p_178606_1_) {
      if (!Client.getModuleManager().isEnabled(Xray.class) && !((Module)Client.getModuleManager().get(Phase.class)).isEnabled() && !((Module)Client.getModuleManager().get(Freecam.class)).isEnabled()) {
