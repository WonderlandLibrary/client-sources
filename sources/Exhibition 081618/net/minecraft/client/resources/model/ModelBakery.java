...
public class ModelBakery {
   ...
   private void func_177574_i() {
      ...
      while(var3.hasNext()) {
         var7 = (ResourceLocation)var3.next();
         var2.add(var7);
         var5 = ((ModelBlock)this.models.get(var7)).getParentLocation();
         if (var5 != null) {
            var1.add(var5);
         }
      }
      ...
      while(!var1.isEmpty()) {
         var7 = (ResourceLocation)var1.pop();
         ...
         try {
            ...
            LOGGER.warn("In parent chain: " + field_177601_e.join(this.func_177573_e(var7)) + "; unable to load model: '" + var7 + "'", var7);
         }
