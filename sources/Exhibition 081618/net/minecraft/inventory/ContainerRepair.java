         ...
         public void onPickupFromSlot(EntityPlayer playerIn, ItemStack stack) {
            ...
            if (!playerIn.capabilities.isCreativeMode && !worldIn.isRemote && var5.getBlock() == Blocks.anvil && playerIn.getRNG().nextFloat() < 0.12F) {
               ...
               if (var4 > 2) {
                  ...
                  worldIn.setBlockState(p_i45807_3_, var5.withProperty(BlockAnvil.DAMAGE, var4), 2);
         ...
         if (var13 != null) {
            ...
            if (var12.isItemStackDamageable() && var12.getItem().getIsRepairable(var8, var13)) {
               ...
               while(true) {
                  ...
                  var20 = var14.containsKey(var18) ? ((Integer)var14.get(var18)).intValue() : 0;
                  int var21 = ((Integer)var26.get(var18)).intValue();
                  int var10000;
                  if (var20 == var21) {
                     ++var21;
                     var10000 = var21;
                  ...
                  int var29;
                  while(var23.hasNext()) {
                     var29 = ((Integer)var23.next()).intValue();
                     if (var29 != var18 && !var28.canApplyTogether(Enchantment.func_180306_c(var29))) {
                        var22 = false;
                        ++var9;
                     }
                  }
