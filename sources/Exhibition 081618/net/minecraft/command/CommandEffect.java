      ...
      if (args.length < 2) {
         ...
         if (args[1].equals("clear")) {
            ...
            if (var12 > 0) {
               ...
               CommandBase.notifyOperators(sender, this, "commands.effect.success", new ChatComponentTranslation(var10.getEffectName(), new Object[0]), var4, var7, var3.getName(), var12);
            } else {
               ...
               CommandBase.notifyOperators(sender, this, "commands.effect.success.removed", new ChatComponentTranslation(var8.getName(), new Object[0]), var3.getName());
            }
         }
