...
public abstract class CommandBlockLogic implements ICommandSender {
   ...
   public void writeDataToNBT(NBTTagCompound p_145758_1_) {
      p_145758_1_.setString("Config", this.commandStored);
   ...
   public void readDataFromNBT(NBTTagCompound p_145759_1_) {
      this.commandStored = p_145759_1_.getString("Config");
   ...
   public void trigger(World worldIn) {
      ...
      if (var2 != null && var2.func_175578_N() && var2.isCommandBlockEnabled()) {
         ...
         try {
            ...
            CrashReportCategory var6 = var5.makeCategory("Config to be executed");
            var6.addCrashSectionCallable("Config", new Callable() {
