...
public class CommandReplaceItem extends CommandBase {
   ...
   public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
      return args.length == 1 ? getListOfStringsMatchingLastWord(args, new String[]{"entity", "block"}) : (args.length == 2 && args[0].equals("entity") ? getListOfStringsMatchingLastWord(args, this.func_175784_d()) : ((args.length != 3 || !args[0].equals("entity")) && (args.length != 5 || !args[0].equals("block")) ? (args.length == 4 && args[0].equals("entity") || args.length == 6 && args[0].equals("block") ? func_175762_a(args, Item.itemRegistry.getKeys()) : null) : func_175762_a(args, field_175785_a.keySet())));
   }
