      ...
      if (args.length < 1) {
         ...
         if (args[0].equals("set")) {
            ...
            if (var8 > 0L) {
               ...
               if (var4 > var6) {
                  CommandBase.notifyOperators(sender, this, "commands.worldborder.setSlowly.shrink.success", String.format("%.1f", var6), String.format("%.1f", var4), Long.toString(var8 / 1000L));
               } else {
                  CommandBase.notifyOperators(sender, this, "commands.worldborder.setSlowly.grow.success", String.format("%.1f", var6), String.format("%.1f", var4), Long.toString(var8 / 1000L));
               }
            } else {
               var3.setTransition(var6);
               CommandBase.notifyOperators(sender, this, "commands.worldborder.set.success", String.format("%.1f", var6), String.format("%.1f", var4));
            }
            ...
            double var5 = CommandBase.func_175761_b((double)var10.getX() + 0.5D, args[1], true);
            double var7 = CommandBase.func_175761_b((double)var10.getZ() + 0.5D, args[2], true);
            var3.setCenter(var5, var7);
            CommandBase.notifyOperators(sender, this, "commands.worldborder.center.success", var5, var7);
            ...
            if (args[1].equals("buffer")) {
               ...
               CommandBase.notifyOperators(sender, this, "commands.worldborder.damage.buffer.success", String.format("%.1f", var4), String.format("%.1f", var6));
               ...
               CommandBase.notifyOperators(sender, this, "commands.worldborder.damage.amount.success", String.format("%.2f", var4), String.format("%.2f", var6));
            }
            ...
            if (args[1].equals("time")) {
               ...
               CommandBase.notifyOperators(sender, this, "commands.worldborder.warning.time.success", var11, var12);
               ...
               CommandBase.notifyOperators(sender, this, "commands.worldborder.warning.distance.success", var11, var12);
            }
