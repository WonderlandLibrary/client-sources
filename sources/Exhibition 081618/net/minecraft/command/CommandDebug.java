...
public class CommandDebug extends CommandBase {
   ...
   public void processCommand(ICommandSender sender, String[] args) throws CommandException {
      if (args.length < 1) {
         ...
         if (args[0].equals("start")) {
            ...
            CommandBase.notifyOperators(sender, this, "commands.debug.start");
            ...
            CommandBase.notifyOperators(sender, this, "commands.debug.stop", (float)var6 / 1000.0F, var8);
   ...
   private String func_147204_b(long p_147204_1_, int p_147204_3_) {
      ...
      var4.append("// This is approximately ").append(String.format("%.2f", (float)p_147204_3_ / ((float)p_147204_1_ / 1000.0F))).append(" ticks per second. It should be ").append(20).append(" ticks per second\n\n");
