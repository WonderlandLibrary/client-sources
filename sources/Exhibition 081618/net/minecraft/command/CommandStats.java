...
public class CommandStats extends CommandBase {
      ...
      if (args.length < 1) {
         ...
         if (var6 == null) {
            ...
            if ("set".equals(var5)) {
               ...
               CommandBase.notifyOperators(sender, this, "commands.stats.success", var6.func_179637_b(), var14, var13);
            } else if ("clear".equals(var5)) {
               CommandResultStats.func_179667_a(var8, var6, (String)null, (String)null);
               CommandBase.notifyOperators(sender, this, "commands.stats.cleared", var6.func_179637_b());
            }
   ...
   public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
      return args.length == 1 ? CommandBase.getListOfStringsMatchingLastWord(args, "entity", "block") : (args.length == 2 && args[0].equals("entity") ? CommandBase.getListOfStringsMatchingLastWord(args, this.func_175776_d()) : ((args.length != 3 || !args[0].equals("entity")) && (args.length != 5 || !args[0].equals("block")) ? (args.length == 4 && args[0].equals("entity") || args.length == 6 && args[0].equals("block") ? CommandBase.getListOfStringsMatchingLastWord(args, CommandResultStats.Type.func_179634_c()) : (args.length == 6 && args[0].equals("entity") || args.length == 8 && args[0].equals("block") ? CommandBase.func_175762_a(args, this.func_175777_e()) : null)) : CommandBase.getListOfStringsMatchingLastWord(args, "set", "clear")));
   }
