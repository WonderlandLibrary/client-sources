...
public class S27PacketExplosion implements Packet {
   ...
   public void setX(float xMotion) {
      this.xMotion = xMotion;
   }

   public void setY(float yMotion) {
      this.yMotion = yMotion;
   }

   public void setZ(float zMotion) {
   ...
   public void readPacketData(PacketBuffer data) throws IOException {
      ...
      this.xMotion = data.readFloat();
      this.yMotion = data.readFloat();
      this.zMotion = data.readFloat();
   }
   ...
   public void writePacketData(PacketBuffer data) throws IOException {
      ...
      data.writeFloat(this.xMotion);
      data.writeFloat(this.yMotion);
      data.writeFloat(this.zMotion);
   }
