      ...
      try {
         if (var3.readUnsignedByte() == 254) {
            ...
            case 1:
               ...
               var8 = String.format("§1\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", Integer.valueOf(127), var6.getMinecraftVersion(), var6.getMOTD(), var6.getCurrentPlayerCount(), var6.getMaxPlayers());
               this.writeAndFlush(p_channelRead_1_, this.getStringBuffer(var8));
               break;
            default:
               ...
               String var10 = String.format("§1\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", Integer.valueOf(127), var6.getMinecraftVersion(), var6.getMOTD(), var6.getCurrentPlayerCount(), var6.getMaxPlayers());
