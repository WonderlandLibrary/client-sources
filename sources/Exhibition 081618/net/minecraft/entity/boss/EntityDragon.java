   ...
   public void onLivingUpdate() {
      ...
      if (this.getHealth() <= 0.0F) {
         ...
         if (this.worldObj.isRemote) {
            ...
            this.rotationYaw = MathHelper.wrapAngleTo180_float(this.rotationYaw);
            var11 = 180.0D - Math.atan2(var28, var6) * 180.0D / 3.141592653589793D;
         ...
         for(int var32 = 0; var32 < 3; ++var32) {
            ...
            var23 = MathHelper.cos(var37);
            var24 = 1.5F;
            float var41 = (float)(var32 + 1) * 2.0F;
            var34.onUpdate();
            var34.setLocationAndAngles(this.posX - (double)((var30 * var24 + var38 * var41) * var3), this.posY + (var36[1] - var31[1]) * 1.0D - (double)((var41 + var24) * var29) + 1.5D, this.posZ + (double)((var7 * var24 + var23 * var41) * var3), 0.0F, 0.0F);
         }
