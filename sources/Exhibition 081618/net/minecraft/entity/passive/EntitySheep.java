...
public class EntitySheep extends EntityAnimal {
   ...
   public static float[] func_175513_a(EnumDyeColor p_175513_0_) {
      return (float[])((float[])field_175514_bm.get(p_175513_0_));
   }
   ...
   public void writeEntityToNBT(NBTTagCompound tagCompound) {
      ...
      tagCompound.setByte("ColorCommand", (byte)this.func_175509_cj().func_176765_a());
   }

   public void readEntityFromNBT(NBTTagCompound tagCompund) {
      super.readEntityFromNBT(tagCompund);
      this.setSheared(tagCompund.getBoolean("Sheared"));
      this.func_175512_b(EnumDyeColor.func_176764_b(tagCompund.getByte("ColorCommand")));
   }
   ...
   public void func_175512_b(EnumDyeColor p_175512_1_) {
      ...
      this.dataWatcher.updateObject(16, (byte)(var2 & 240 | p_175512_1_.func_176765_a() & 15));
   }
