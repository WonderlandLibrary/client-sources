...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant {
   ...
   private void func_180489_a(EnumParticleTypes p_180489_1_) {
      for(int var2 = 0; var2 < 5; ++var2) {
         ...
         this.worldObj.spawnParticle(p_180489_1_, this.posX + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, this.posY + 1.0D + (double)(this.rand.nextFloat() * this.height), this.posZ + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, var3, var5, var7);
      }
