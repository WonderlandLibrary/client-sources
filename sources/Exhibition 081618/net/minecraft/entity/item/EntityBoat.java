   ...
   public void onUpdate() {
      ...
      if (var19 > 0.2975D) {
         ...
         for(var10 = 0; (double)var10 < 1.0D + var19 * 60.0D; ++var10) {
            var24 = (double)(this.rand.nextFloat() * 2.0F - 1.0F);
            var26 = (double)(this.rand.nextInt(2) * 2 - 1) * 0.7D;
            double var15;
            double var17;
            if (this.rand.nextBoolean()) {
               var15 = this.posX - var6 * var24 * 0.8D + var8 * var26;
               var17 = this.posZ - var8 * var24 * 0.8D - var6 * var26;
               ...
               var15 = this.posX + var6 + var8 * var24 * 0.7D;
               var17 = this.posZ + var8 - var6 * var24 * 0.7D;
               this.worldObj.spawnParticle(EnumParticleTypes.WATER_SPLASH, var15, this.posY - 0.125D, var17, this.motionX, this.motionY, this.motionZ);
            }
         }
      }
