...
public class EntityFishHook extends Entity {
   ...
   public void handleHookCasting(double p_146035_1_, double p_146035_3_, double p_146035_5_, float p_146035_7_, float p_146035_8_) {
      ...
      this.prevRotationPitch = this.rotationPitch = (float)(Math.atan2(p_146035_3_, (double)var10) * 180.0D / 3.141592653589793D);
   ...
   public void onUpdate() {
      ...
      if (this.fishPosRotationIncrements > 0) {
         ...
         if (!this.inGround) {
            ...
            for(this.rotationPitch = (float)(Math.atan2(this.motionY, (double)var31) * 180.0D / 3.141592653589793D); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
               ;
            }
               ...
               if (this.ticksCatchable > 0) {
                  ...
                  if (this.ticksCatchableDelay > 0) {
                     ...
                     if (this.ticksCatchableDelay <= 0) {
                        ...
                        var36.func_175739_a(EnumParticleTypes.WATER_BUBBLE, this.posX, (double)(var16 + 1.0F), this.posZ, (int)(1.0F + this.width * 20.0F), (double)this.width, 0.0D, (double)this.width, 0.20000000298023224D);
                        var36.func_175739_a(EnumParticleTypes.WATER_WAKE, this.posX, (double)(var16 + 1.0F), this.posZ, (int)(1.0F + this.width * 20.0F), (double)this.width, 0.0D, (double)this.width, 0.20000000298023224D);
                        ...
                        if (this.rand.nextFloat() < 0.15F) {
                           var36.func_175739_a(EnumParticleTypes.WATER_BUBBLE, var19, var40 - 0.10000000149011612D, var23, 1, (double)var39, 0.1D, (double)var18, 0.0D);
                        }

                        float var25 = var39 * 0.04F;
                        float var26 = var18 * 0.04F;
                        var36.func_175739_a(EnumParticleTypes.WATER_WAKE, var19, var40, var23, 0, (double)var26, 0.01D, (double)(-var25), 1.0D);
                        var36.func_175739_a(EnumParticleTypes.WATER_WAKE, var19, var40, var23, 0, (double)(-var26), 0.01D, (double)var25, 1.0D);
                     }
                     ...
                     if (this.rand.nextFloat() < var16) {
                        ...
                        var36.func_175739_a(EnumParticleTypes.WATER_SPLASH, var19, var40, var23, 2 + this.rand.nextInt(2), 0.10000000149011612D, 0.0D, 0.10000000149011612D, 0.0D);
                     }
