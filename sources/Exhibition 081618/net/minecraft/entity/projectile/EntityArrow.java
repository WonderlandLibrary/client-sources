...
public class EntityArrow extends Entity implements IProjectile {
   ...
   public void setThrowableHeading(double p_70186_1_, double p_70186_3_, double p_70186_5_, float p_70186_7_, float p_70186_8_) {
      ...
      this.prevRotationPitch = this.rotationPitch = (float)(Math.atan2(p_70186_3_, (double)var10) * 180.0D / 3.141592653589793D);
      ...
      if (this.inGround) {
         ...
         if (var6 != null) {
            if (var6.entityHit != null) {
               ...
               var28 = MathHelper.ceiling_double_int((double)var22 * this.damage);
               if (this.getIsCritical()) {
                  var28 += this.rand.nextInt(var28 / 2 + 2);
               }
               ...
               if (var6.entityHit.attackEntityFrom(var26, (float)var28)) {
         ...
         for(this.rotationPitch = (float)(Math.atan2(this.motionY, (double)var22) * 180.0D / 3.141592653589793D); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
            ;
         }
         ...
         if (this.isInWater()) {
            for(var28 = 0; var28 < 4; ++var28) {
               var29 = 0.25F;
               this.worldObj.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX - this.motionX * (double)var29, this.posY - this.motionY * (double)var29, this.posZ - this.motionZ * (double)var29, this.motionX, this.motionY, this.motionZ);
            }
