...
import exhibition.module.impl.player.Nigger;
...
public abstract class Entity implements ICommandSender {
   ...
   public void setAngles(float yaw, float pitch) {
      ...
      this.rotationPitch = MathHelper.clamp_float((float)((double)this.rotationPitch - (double)pitch * 0.15D), -90.0F, 90.0F);
   ...
   public void moveEntity(double x, double y, double z) {
      if (this.noClip) {
         ...
         double var15 = y;
         double var17 = z;
         boolean var19 = this.onGround && (this.isSneaking() || Client.getModuleManager().isEnabled(Scaffold.class) || Client.getModuleManager().isEnabled(Nigger.class)) && this instanceof EntityPlayer;
         if (var19) {
            double var20;
         ...
         double var27 = z;
         double var68;
         if ((x * x + z * z >= x * x + z * z || em.isActive()) && em.getStepHeight() > 0.0D && var54 && (var13 != x || var17 != z)) {
         ...
         Module f = (Module)Client.getModuleManager().get(Fly.class);
         this.onGround = f.isEnabled() || this.isCollidedVertically && var15 < 0.0D;
         ...
         if (this.canTriggerWalking() && (!var19 || Client.getModuleManager().isEnabled(Scaffold.class)) && this.ridingEntity == null) {
            double var61 = this.posX - var7;
            double var64 = this.posY - var9;
            var68 = this.posZ - var11;
            ...
            this.distanceWalkedModified = (float)((double)this.distanceWalkedModified + (double)MathHelper.sqrt_double(var61 * var61 + var68 * var68) * 0.6D);
            this.distanceWalkedOnStepModified = (float)((double)this.distanceWalkedOnStepModified + (double)MathHelper.sqrt_double(var61 * var61 + var64 * var64 + var68 * var68) * 0.6D);
         ...
         try {
            ...
            CrashReport var63 = CrashReport.makeCrashReport(var62, "Checking entity block collision");
   ...
   public void func_174830_Y() {
      if (this.isSprinting() && !this.isInWater() && this == Minecraft.getMinecraft().thePlayer) {
         this.func_174808_Z();
      }
   ...
   public float getGroundDistance(Entity entityIn) {
      float var2 = (float)(this.posX - entityIn.posX);
      float var4 = (float)(this.posZ - entityIn.posZ);
   ...
   protected final Vec3 func_174806_f(float yaw, float pitch) {
      float p1 = MathHelper.cos(-pitch * 0.017453292F - 3.1415927F);
      float p2 = MathHelper.sin(-pitch * 0.017453292F - 3.1415927F);
      float y1 = -MathHelper.cos(-yaw * 0.017453292F);
      float y2 = MathHelper.sin(-yaw * 0.017453292F);
      return new Vec3((double)(p2 * y1), (double)y2, (double)(p1 * y1));
   }
   ...
   public Vec3 func_174824_e(float partial) {
      if (partial == 1.0F) {
         ...
         double var2 = this.prevPosX + (this.posX - this.prevPosX) * (double)partial;
         double var4 = this.prevPosY + (this.posY - this.prevPosY) * (double)partial + (double)this.getEyeHeight();
         double var6 = this.prevPosZ + (this.posZ - this.prevPosZ) * (double)partial;
   ...
   public boolean isEntityInsideOpaqueBlock() {
      if (!this.noClip && !((Module)Client.getModuleManager().get(Freecam.class)).isEnabled()) {
