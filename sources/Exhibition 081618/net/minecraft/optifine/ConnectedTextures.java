...
public class ConnectedTextures {
   ...
   private static TextureAtlasSprite getConnectedTexture(ConnectedProperties cp, IBlockAccess blockAccess, IBlockState blockState, BlockPos blockPos, int side, TextureAtlasSprite icon, int metadata, RenderEnv renderEnv) {
      ...
      if (y >= cp.minHeight && y <= cp.maxHeight) {
         ...
         if (cp.biomes != null) {
            ...
            BiomeGenBase[] var11 = cp.biomes;
            var18 = var11.length;

            for(int var13 = 0; var13 < var18; ++var13) {
               BiomeGenBase mds = var11[var13];
               if (vertAxis == mds) {
                  metadataCheck = true;
                  break;
               }
   ...
   private static List makePropertyList(ConnectedProperties[][] propsArr) {
      ...
      if (propsArr != null) {
         ConnectedProperties[][] var2 = propsArr;
         int var3 = propsArr.length;

         for(int var4 = 0; var4 < var3; ++var4) {
            ConnectedProperties[] props = var2[var4];
   ...
   private static void addToTileList(ConnectedProperties cp, List tileList) {
      if (cp.matchTileIcons != null) {
         TextureAtlasSprite[] var2 = cp.matchTileIcons;
         int var3 = var2.length;

         for(int var4 = 0; var4 < var3; ++var4) {
            TextureAtlasSprite matchTileIcon = var2[var4];
            if (!(matchTileIcon instanceof TextureAtlasSprite)) {
               ...
               int tileId = matchTileIcon.getIndexInMap();
               if (tileId < 0) {
                  Config.warn("Invalid tile ID: " + tileId + ", icon: " + matchTileIcon.getIconName());
               } else {
   ...
   private static void addToBlockList(ConnectedProperties cp, List blockList) {
      if (cp.matchBlocks != null) {
         int[] var2 = cp.matchBlocks;
         int var3 = var2.length;

         for(int var4 = 0; var4 < var3; ++var4) {
            int blockId = var2[var4];
            if (blockId < 0) {
   ...
   private static String[] collectFilesDefault(IResourcePack rp) {
      ...
      var6 = (String[])((String[])list.toArray(new String[list.size()]));
      return var6;
   }
      ...
      if (files == null) {
         ...
         for(int var9 = 0; var9 < var8; ++var9) {
            ...
            if (file.isFile()) {
               ...
               String[] var13 = names1;
               int var14 = names1.length;

               for(int var15 = 0; var15 < var14; ++var15) {
                  String name = var13[var15];
                  list.add(name);
               }
            }
         }
