...
public class ConnectedProperties {
   ...
   private static BiomeGenBase[] parseBiomes(String str) {
      if (str == null) {
         ...
         String[] var3 = biomeNames;
         int var4 = biomeNames.length;

         for(int var5 = 0; var5 < var4; ++var5) {
            String biomeName = var3[var5];
   ...
   private static BiomeGenBase findBiome(String biomeName) {
      ...
      BiomeGenBase[] var2 = biomeList;
      int var3 = biomeList.length;

      for(int var4 = 0; var4 < var3; ++var4) {
         BiomeGenBase biome = var2[var4];
         if (biome != null) {
   ...
   private static int parseFaces(String str) {
      if (str == null) {
         ...
         int facesMask = 0;
         String[] var3 = faceStrs;
         int var4 = faceStrs.length;

         for(int var5 = 0; var5 < var4; ++var5) {
            String faceStr = var3[var5];
   ...
   private static TextureAtlasSprite[] registerIcons(String[] tileNames, TextureMap textureMap) {
      if (tileNames == null) {
         ...
         String[] var3 = tileNames;
         int var4 = tileNames.length;

         for(int var5 = 0; var5 < var4; ++var5) {
            String iconName = var3[var5];
   ...
   public boolean matchesBlock(int blockId) {
      if (this.matchBlocks != null && this.matchBlocks.length > 0) {
         int[] var2 = this.matchBlocks;
         int var3 = var2.length;

         for(int var4 = 0; var4 < var3; ++var4) {
            int matchId = var2[var4];
            if (matchId == blockId) {
               return true;
            }
         }
   ...
   public boolean matchesIcon(TextureAtlasSprite icon) {
      if (this.matchTileIcons != null && this.matchTileIcons.length > 0) {
         TextureAtlasSprite[] var2 = this.matchTileIcons;
         int var3 = var2.length;
