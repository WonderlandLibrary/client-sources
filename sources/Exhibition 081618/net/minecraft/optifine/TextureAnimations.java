...
public class TextureAnimations {
   ...
   public static void updateAnimations() {
      if (textureAnimations != null) {
         TextureAnimation[] var0 = textureAnimations;
         int var1 = var0.length;

         for(int var2 = 0; var2 < var1; ++var2) {
            TextureAnimation anim = var0[var2];
            anim.updateTexture();
         }
      }
   ...
   public static TextureAnimation[] getTextureAnimations(IResourcePack[] rps) {
      ...
      IResourcePack[] var2 = rps;
      int var3 = rps.length;

      for(int var4 = 0; var4 < var3; ++var4) {
         IResourcePack rp = var2[var4];
      ...
      if (!(rp instanceof AbstractResourcePack)) {
         ...
         if (tpFile == null) {
            ...
            if (animPropNames == null) {
               ...
               ArrayList list = new ArrayList();
               String[] var5 = animPropNames;
               int var6 = animPropNames.length;
               ...
               for(int var7 = 0; var7 < var6; ++var7) {
                  ...
                  try {
                     ...
                     Config.warn("File not found: " + var14.getMessage());
