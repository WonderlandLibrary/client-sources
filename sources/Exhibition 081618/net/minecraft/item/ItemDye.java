   ...
   public static void func_180617_a(World worldIn, BlockPos p_180617_1_, int p_180617_2_) {
      ...
      if (var3.getMaterial() != Material.air) {
         ...
         for(int var4 = 0; var4 < p_180617_2_; ++var4) {
            ...
            worldIn.spawnParticle(EnumParticleTypes.VILLAGER_HAPPY, (double)((float)p_180617_1_.getX() + Item.itemRand.nextFloat()), (double)p_180617_1_.getY() + (double)Item.itemRand.nextFloat() * var3.getBlockBoundsMaxY(), (double)((float)p_180617_1_.getZ() + Item.itemRand.nextFloat()), var5, var7, var9);
         }
      }
