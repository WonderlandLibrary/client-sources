...
public class RecipesBanners {
   void func_179534_a(CraftingManager p_179534_1_) {
      ...
      p_179534_1_.func_180302_a(new RecipesBanners.RecipeDuplicatePattern((Object)null));
      p_179534_1_.func_180302_a(new RecipesBanners.RecipeAddPattern((Object)null));
   }
   ...
   static class RecipeAddPattern implements IRecipe {
      ...
      public ItemStack getCraftingResult(InventoryCrafting p_77572_1_) {
         ...
         if (var8 != null) {
            ...
            var7.setInteger("ColorCommand", var9);
