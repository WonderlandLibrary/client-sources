      ...
      if (var4 <= 3 && var3 <= 1) {
         ...
         if (var4 >= 1 && var3 == 1 && var7 == 0) {
            ...
            if (var6 > 0) {
               ...
               for(var17 = 0; var17 < p_77569_1_.getSizeInventory(); ++var17) {
                  var11 = p_77569_1_.getStackInSlot(var17);
                  if (var11 != null && var11.getItem() == Items.firework_charge && var11.hasTagCompound() && var11.getTagCompound().hasKey("Explosion", 10)) {
                     var23.appendTag(var11.getTagCompound().getCompoundTag("Explosion"));
                  }
               }
            ...
            if (var4 == 1 && var3 == 0 && var6 == 0 && var5 > 0 && var8 <= 1) {
               ...
               for(var20 = 0; var20 < p_77569_1_.getSizeInventory(); ++var20) {
                  ItemStack var14 = p_77569_1_.getStackInSlot(var20);
                  if (var14 != null) {
