...
public class RecipesDyes {
   public void addRecipes(CraftingManager p_77607_1_) {
      ...
      for(var2 = 0; var2 < 16; ++var2) {
         ...
         p_77607_1_.addRecipe(new ItemStack(Blocks.stained_hardened_clay, 8, 15 - var2), "###", "#X#", "###", '#', new ItemStack(Blocks.hardened_clay), 'X', new ItemStack(Items.dye, 1, var2));
         p_77607_1_.addRecipe(new ItemStack(Blocks.stained_glass, 8, 15 - var2), "###", "#X#", "###", '#', new ItemStack(Blocks.glass), 'X', new ItemStack(Items.dye, 1, var2));
