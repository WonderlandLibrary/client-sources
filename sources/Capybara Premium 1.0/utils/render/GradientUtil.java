package fun.expensive.client.utils.render;
...
public class GradientUtil implements Helper {
    ...
    private static final ShaderUtil gradientMaskShader = new ShaderUtil("expensive/shaders/gradientMask.frag");
    private static final ShaderUtil gradientShader = new ShaderUtil("expensive/shaders/gradient.frag");
