...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (renderViewEntity != null && this.mc.theWorld != null) {
            ...
            Vec3 vec3 = null;
            final float n4 = 1.0f;
            final List<Entity> entitiesInAABBexcluding = this.mc.theWorld.getEntitiesInAABBexcluding(renderViewEntity, renderViewEntity.getEntityBoundingBox().addCoord(look.xCoord * n3, look.yCoord * n3, look.zCoord * n3).expand((double)n4, (double)n4, (double)n4), Predicates.and(EntitySelectors.NOT_SPECTATING, new Predicate<Entity>()
            {
            ...
            for (Object pointedEntityObj : entitiesInAABBexcluding) {
                ...
                final AxisAlignedBB expand = pointedEntity.getEntityBoundingBox().expand((double)collisionBorderSize, (double)collisionBorderSize, (double)collisionBorderSize);
                ...
                if (expand.isVecInside(positionEyes)) {
                    ...
                    if (Reflector.ForgeEntity_canRiderInteract.exists()) {
                        callBoolean = Reflector.callBoolean((Object)pointedEntity, Reflector.ForgeEntity_canRiderInteract, new Object[0]);
                    }
            ...
            if (this.pointedEntity != null && b && positionEyes.distanceTo(vec3) > rayTraceRangeEvent.getRange()) {
                this.pointedEntity = null;
                this.mc.objectMouseOver = new MovingObjectPosition(MovingObjectPosition.MovingObjectType.MISS, vec3, (EnumFacing)null, new BlockPos(vec3));
            }
