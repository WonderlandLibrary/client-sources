...
public class S18PacketEntityTeleport implements Packet<INetHandlerPlayClient>
{
    ...
    public S18PacketEntityTeleport(Entity entityIn)
    {
        ...
        this.yaw = (byte)((int)((entityIn == Minecraft.getMinecraft().thePlayer ? PlayerHandler.yaw : entityIn.rotationYaw) * 256.0F / 360.0F));
        this.pitch = (byte)((int)((entityIn == Minecraft.getMinecraft().thePlayer ? PlayerHandler.pitch : entityIn.rotationPitch) * 256.0F / 360.0F));
