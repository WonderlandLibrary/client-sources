package tech.atani.client.feature.guis.screens.clickgui.simple.window;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for(Value value : ValueStorage.getInstance().getValues(module)) {
            ...
            if(value instanceof CheckBoxValue) {
                ...
                RenderUtil.drawBorderedRect(valueX + width - 40 - 10, valueY - 1, valueX + width - 40 - 10 + 10, valueY - 1 + 10, 1, checkBoxValue.getValue() ? new Color(200, 200, 200).getRGB() : new Color(0, 0, 0, 50).getRGB(), new Color(200, 200, 200).getRGB(), true);
                ...
                if(this.expanded.contains(multiStringBoxValue)) {
                    ...
                    for(String string : multiStringBoxValue.getValues()) {
                        fontRenderer.drawStringWithShadow(string, valueX + width - 50 - length + 5.5f, stringsY + 3, multiStringBoxValue.getValue().contains(string) ? -1 : new Color(200, 200, 200).getRGB());
                        stringsY += 15;
                    }
                ...
                if(this.expanded.contains(stringBoxValue)) {
                    ...
                    RenderUtil.drawRect(valueX + width - 50 - longestLength, valueY - 1, longestLength + 10, 15 + stringBoxValue.getValues().length * 15, new Color(0, 0, 0, 50).getRGB());
                    float stringsY = valueY - 1 + 15;
                    for(String string : stringBoxValue.getValues()) {
