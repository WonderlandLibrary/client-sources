package tech.atani.client.feature.guis.screens.clickgui.koks;

import net.minecraft.client.gui.GuiButton;
import net.minecraft.client.gui.GuiScreen;
import net.minecraft.client.gui.ScaledResolution;
import org.lwjgl.input.Mouse;
import tech.atani.client.feature.guis.screens.clickgui.koks.frame.Frame;
...
public class KoksClickGuiScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if(frames.isEmpty()) {
            float y = 20, width = 125, height = 25, x = 20;
            int counter = 0;
            for(Category category : Category.values()) {
                ...
                Frame frame = new Frame(category, x, y, width, height, 20, this);
