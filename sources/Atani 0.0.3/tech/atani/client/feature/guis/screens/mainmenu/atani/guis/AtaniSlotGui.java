...
public abstract class AtaniSlotGui
{
    ...
    public AtaniSlotGui(Minecraft mcIn, int width, int height, int topIn, int bottomIn, int slotHeightIn)
    {
        this.mc = mcIn;
        this.width = width;
        this.height = height;
    ...
    public void drawScreen(int mouseXIn, int mouseYIn, float p_148128_3_)
    {
        if (this.field_178041_q)
        {
...

            {
                ...
                RenderUtil.drawScissorBox(k1 - 60, y1 - 5, 220 + 60 * 2, height - 140 + 15);
    ...
    protected void drawSelectionBox(int p_148120_1_, int p_148120_2_, int mouseXIn, int mouseYIn)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            if (this.showSelectionBox && this.isSelected(j))
            {
                ...
                RoundedShader.drawRound(i1, k - 2, j1 - i1, (k + l + 2) - (k - 2), 5, new Color(0, 0, 0, 100));
            }

            if (true || k >= this.top - this.slotHeight && k <= this.bottom)
            {
