package tech.atani.client.feature.guis.screens.clickgui.xave.window;

import tech.atani.client.feature.guis.screens.clickgui.xave.window.component.impl.*;
...
public class Window {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        if(this.components.isEmpty()) {
            for(Value value : ValueStorage.getInstance().getValues(module)) {
                if(value instanceof CheckBoxValue) {
                    CheckboxComponent component = new CheckboxComponent((CheckBoxValue) value, posX, yPos1, 14);
                    this.components.add(component);
