...
public class AtaniSinglePlayerMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.fontRendererObj = FontStorage.getInstance().findFont("Roboto", 19);
    ...
    class List extends AtaniSlotGui
    {
        ...
        {
            AtaniSinglePlayerMenu.this.fontRendererObj = FontStorage.getInstance().findFont("Roboto", 19);

            SaveFormatComparator saveformatcomparator = (SaveFormatComparator) AtaniSinglePlayerMenu.this.field_146639_s.get(entryID);
