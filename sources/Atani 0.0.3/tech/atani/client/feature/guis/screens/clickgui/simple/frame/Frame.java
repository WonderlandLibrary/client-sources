...
import tech.atani.client.feature.guis.screens.clickgui.simple.component.impl.ModuleComponent;
...
public class Frame extends tech.atani.client.feature.guis.screens.clickgui.simple.component.Component {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        if(RenderUtil.isHovered(mouseX, mouseY, getPosX(), getPosY(), getBaseWidth(), moduleHeight * 11) && ModuleStorage.getInstance().getModules(category).size() > 11) {
            if(dWheel < 0) {
                scroll -= 1;
            } else if(dWheel > 0) {
                scroll += 1;
