...
public class AtaniServerSelectionList extends AtaniGuiListExtended
{
    ...
    private final List<AtaniServerListEntryNormal> field_148198_l = Lists.<AtaniServerListEntryNormal>newArrayList();
    private final List<AtaniServerListEntryLanDetected> field_148199_m = Lists.<AtaniServerListEntryLanDetected>newArrayList();
    ...
    public AtaniGuiListExtended.IGuiListEntry getListEntry(int index)
    {
        ...
        {
            return (AtaniGuiListExtended.IGuiListEntry)this.field_148198_l.get(index);
        }
        else
        {
            ...
            {
                --index;
                return (AtaniGuiListExtended.IGuiListEntry)this.field_148199_m.get(index);
            }
        }
    }
