...
public class AtaniRenameAlt extends GuiScreen
{
    ...
    public AtaniRenameAlt(final AtaniAltManager manager) {
    ...
    public void actionPerformed(final GuiButton button) {
        switch (button.id) {
            ...
            case 0: {
                this.manager.selectedAlt.setName(this.nameField.getText());
