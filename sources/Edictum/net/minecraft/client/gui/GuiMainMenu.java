...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private static final ResourceLocation EDICTUM = new ResourceLocation("textures/gui/title/edictum.jpg");
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new DarkButtons(0, this.width / 2 - 100, j + 72 + 12, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new DarkButtons(4, this.width / 2 + 2, j + 72 + 12, 98, 20, I18n.format("menu.quit", new Object[0])));
        }
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        if(Meanings.AccountGui){
        	this.buttonList.add(new DarkButtons(9999, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * -1, I18n.format("Join", new Object[0]))); 
        }
        
        if(!Meanings.AccountGui){
            this.buttonList.add(new DarkButtons(1, this.width / 2 - 100, p_73969_1_, I18n.format("menu.singleplayer", new Object[0])));
            this.buttonList.add(new DarkButtons(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("menu.multiplayer", new Object[0])));
            this.buttonList.add(new DarkButtons(999, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("Gish Reloaded", new Object[0]))); 
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
    	...
    	if (button.id == 999) {
            try {
                Desktop.getDesktop().browse(new URI("https://www.youtube.com/c/MrTennit"));
            }
            catch (Exception ex) {}
        }
    ...
    public void drawPanorama(int mouseX, int mouseY, float partialTicks){
    	...
    	this.mc.getTextureManager().bindTexture(EDICTUM);
    	ScaledResolution scaledRes = new ScaledResolution(mc);
    	Tessellator tessellator = Tessellator.getInstance();
    	VertexBuffer vertexbuffer = tessellator.getBuffer();
    	vertexbuffer.begin(7, DefaultVertexFormats.POSITION_TEX);
    	vertexbuffer.pos(0.0D,(double) scaledRes.getScaledHeight(), -90.0).tex(0.0D, 1.0D).endVertex();
    	vertexbuffer.pos((double) scaledRes.getScaledWidth(),(double) scaledRes.getScaledHeight(), -90.0);
...
*/
        ...
        GlStateManager.popMatrix();
        String s = "Minecraft 1.10 | \u00a7fEdictumClient v1.0(release)";
        ...
        String s1 = "";
        this.drawString(this.fontRendererObj, "", this.width - this.fontRendererObj.getStringWidth("") - 2, this.height - 10, -1);
