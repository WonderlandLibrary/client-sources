...
public class GuiDisconnected extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new DarkButtons(0, this.width / 2 - 100, this.height / 2 + this.textHeight / 2 + this.fontRendererObj.FONT_HEIGHT, I18n.format("gui.toMenu", new Object[0])));
    }
