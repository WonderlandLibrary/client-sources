...
import me.gishreload.yukon.gui.AccountChange;
import me.gishreload.yukon.gui.DarkButtons;
import me.gishreload.yukon.gui.GuiFakeParams;
import me.gishreload.yukon.gui.account.Account;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
    	this.buttonList.add(new DarkButtons(190, this.width / 2 + 160, this.height - 28, 50, 20, "Nick"));
    	this.buttonList.add(new DarkButtons(999, this.width / 2 + 160, this.height - 52, 50, 20, "UUIDHack"));
        this.btnEditServer = this.func_189646_b(new DarkButtons(7, this.width / 2 - 154, this.height - 28, 70, 20, I18n.format("selectServer.edit", new Object[0])));
        this.btnDeleteServer = this.func_189646_b(new DarkButtons(2, this.width / 2 - 74, this.height - 28, 70, 20, I18n.format("selectServer.delete", new Object[0])));
        this.btnSelectServer = this.func_189646_b(new DarkButtons(1, this.width / 2 - 154, this.height - 52, 100, 20, I18n.format("selectServer.select", new Object[0])));
        this.buttonList.add(new DarkButtons(4, this.width / 2 - 50, this.height - 52, 100, 20, I18n.format("selectServer.direct", new Object[0])));
        this.buttonList.add(new DarkButtons(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, I18n.format("selectServer.add", new Object[0])));
        this.buttonList.add(new DarkButtons(8, this.width / 2 + 4, this.height - 28, 70, 20, I18n.format("selectServer.refresh", new Object[0])));
        this.buttonList.add(new DarkButtons(0, this.width / 2 + 4 + 76, this.height - 28, 75, 20, I18n.format("gui.cancel", new Object[0])));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
    	...
    	if (button.id == 190)
        {
            this.mc.displayGuiScreen(new AccountChange(this));
        }
