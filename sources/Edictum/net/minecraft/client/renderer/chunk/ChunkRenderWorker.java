    ...
    protected void processTask(final ChunkCompileTaskGenerator generator) throws InterruptedException
    {
        ...
        try
        {
            ...
            if (blockpos1.add(8, 8, 8).distanceSq(blockpos) > 576.0D)
            {
                ...
                if (!this.isChunkExisting(blockpos$mutableblockpos.func_189533_g(blockpos1).func_189534_c(EnumFacing.WEST, 16), world) || !this.isChunkExisting(blockpos$mutableblockpos.func_189533_g(blockpos1).func_189534_c(EnumFacing.NORTH, 16), world) || !this.isChunkExisting(blockpos$mutableblockpos.func_189533_g(blockpos1).func_189534_c(EnumFacing.EAST, 16), world) || !this.isChunkExisting(blockpos$mutableblockpos.func_189533_g(blockpos1).func_189534_c(EnumFacing.SOUTH, 16), world))
                {
                    return;
                }
            }
