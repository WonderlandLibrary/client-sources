...
public class BlockLever extends Block
{
    ...
    {
        if (this.checkCanSurvive(p_189540_2_, p_189540_3_, p_189540_1_) && !canAttachTo(p_189540_2_, p_189540_3_, ((BlockLever.EnumOrientation)p_189540_1_.getValue(FACING)).getFacing().getOpposite()))
        {
