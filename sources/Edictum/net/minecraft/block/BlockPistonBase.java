...
public class BlockPistonBase extends BlockDirectional
{
    ...
    {
        EnumFacing enumfacing = (EnumFacing)p_189539_1_.getValue(FACING);
        ...
        else if (p_189539_4_ == 1)
        {
            ...
            p_189539_2_.setBlockState(p_189539_3_, Blocks.PISTON_EXTENSION.getDefaultState().withProperty(BlockPistonMoving.FACING, enumfacing).withProperty(BlockPistonMoving.TYPE, this.isSticky ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT), 3);
            ...
            if (this.isSticky)
            {
                ...
                if (!flag1 && iblockstate.getMaterial() != Material.AIR && canPush(iblockstate, p_189539_2_, blockpos, enumfacing.getOpposite(), false) && (iblockstate.getMobilityFlag() == EnumPushReaction.NORMAL || block == Blocks.PISTON || block == Blocks.STICKY_PISTON))
                {
