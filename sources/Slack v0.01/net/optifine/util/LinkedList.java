...
public class LinkedList<T> {
   ...
   public LinkedList.Node<T> remove(LinkedList.Node<T> tNode) {
      ...
      tNode.setPrev((LinkedList.Node)null);
      tNode.setNext((LinkedList.Node)null);
      tNode.setParent((LinkedList)null);
      --this.size;
      return tNode;
   }
   ...
   public String toString() {
      ...
      LinkedList.Node node;
      for(Iterator it = this.iterator(); it.hasNext(); stringbuffer.append(node.getItem())) {
