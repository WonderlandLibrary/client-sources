...
public class BlockModelUtils {
   ...
   public static BakedQuad makeBakedQuad(EnumFacing facing, TextureAtlasSprite sprite, int tintIndex) {
      ...
      BakedQuad bakedquad = facebakery.makeBakedQuad(vector3f, vector3f1, blockpartface, sprite, facing, (ModelRotation)modelrotation, (BlockPartRotation)blockpartrotation, flag, flag1);
      return bakedquad;
   }
   ...
   private static void replaceTexture(List<BakedQuad> quads, TextureAtlasSprite spriteOld, TextureAtlasSprite spriteNew) {
      ...
      for(Iterator var4 = quads.iterator(); var4.hasNext(); list.add(bakedquad)) {
         bakedquad = (BakedQuad)var4.next();
         if (((BakedQuad)bakedquad).getSprite() == spriteOld) {
            bakedquad = new BreakingFour((BakedQuad)bakedquad, spriteNew);
         }
      }
