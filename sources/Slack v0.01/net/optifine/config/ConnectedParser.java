...
public class ConnectedParser {
         ...
         if (this.startsWithDigit(s)) {
            ...
            if (map.isEmpty()) {
               ...
               for(int k = 0; k < 16; ++k) {
                  ...
                  try {
                     IBlockState iblockstate1 = this.getStateFromMeta(block, i1);
   ...
   public static Comparable parseValue(String str, Class cls) {
      return (Comparable)(cls == String.class ? str : (Comparable)(cls == Boolean.class ? Boolean.valueOf(str) : cls == Float.class ? (double)Float.parseFloat(str) : (cls == Double.class ? Double.parseDouble(str) : (double)(cls == Integer.class ? (long)Integer.parseInt(str) : cls == Long.class ? Long.valueOf(str) : null))));
   }
