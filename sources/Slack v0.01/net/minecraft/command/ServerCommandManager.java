...
public class ServerCommandManager extends CommandHandler implements IAdminCommand {
   ...
   public void notifyOperators(ICommandSender sender, ICommand command, int flags, String msgFormat, Object... msgParams) {
      ...
      IChatComponent ichatcomponent = new ChatComponentTranslation("chat.type.admin", new Object[]{sender.getCommandSenderName(), new ChatComponentTranslation(msgFormat, msgParams)});
      ichatcomponent.getChatStyle().setColor(ChatFormatting.GRAY);
      ichatcomponent.getChatStyle().setItalic(Boolean.TRUE);
      if (flag) {
         Iterator var9 = minecraftserver.getConfigurationManager().func_181057_v().iterator();
         ...
         while(true) {
            ...
            do {
               do {
                  ...
                  } while(!minecraftserver.getConfigurationManager().canSendCommands(entityplayer.getGameProfile()));
               } while(!command.canCommandSenderUseCommand(sender));

               flag1 = sender instanceof MinecraftServer && MinecraftServer.getServer().func_183002_r();
               flag2 = sender instanceof RConConsoleSource && MinecraftServer.getServer().func_181034_q();
