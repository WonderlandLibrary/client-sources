...
public class CommandScoreboard extends CommandBase {
      ...
      if (i < 0) {
         ...
         while(var7.hasNext()) {
            ...
            try {
               ...
               ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation(var11.getMessage(), var11.getErrorObjects());
               chatcomponenttranslation.getChatStyle().setColor(ChatFormatting.RED);
      ...
      if (scoreplayerteam != null) {
         ...
         if (args.length == 4) {
            if (s.equalsIgnoreCase("color")) {
               throw new WrongUsageException("commands.scoreboard.teams.option.noValue", new Object[]{s, joinNiceStringFromCollection(ChatFormatting.getValidValues(true, false))});
            }
         ...
         String s1 = args[index];
         if (s.equalsIgnoreCase("color")) {
            ChatFormatting enumchatformatting = ChatFormatting.getValueByName(s1);
            ...
            scoreplayerteam.setNameSuffix(ChatFormatting.RESET.toString());
            ...
            if (s.equalsIgnoreCase("nametagVisibility")) {
               team$enumvisible1 = Team.EnumVisible.func_178824_a(s1);
   ...
   protected void listTeams(ICommandSender p_147186_1_, String[] p_147186_2_, int p_147186_3_) throws CommandException {
      ...
      if (p_147186_2_.length > p_147186_3_) {
         ...
         chatcomponenttranslation.getChatStyle().setColor(ChatFormatting.DARK_GREEN);
         ...
         Iterator var11 = collection1.iterator();

         while(var11.hasNext()) {
            ScorePlayerTeam scoreplayerteam1 = (ScorePlayerTeam)var11.next();
      ...
      if (p_147190_1_ instanceof EntityPlayer && p_147190_3_ == p_147190_2_.length) {
         ...
         while(true) {
            while(true) {
               ...
               if (s1.startsWith("@")) {
                  Iterator var12 = func_175763_c(p_147190_1_, s1).iterator();
      ...
      if (p_147199_1_ instanceof EntityPlayer && p_147199_3_ == p_147199_2_.length) {
         ...
         while(true) {
            while(true) {
               ...
               if (s.startsWith("@")) {
                  Iterator var11 = func_175763_c(p_147199_1_, s).iterator();
                  ...
                  if (args[1].equalsIgnoreCase("option")) {
                     ...
                     if (args.length == 5) {
                        if (args[3].equalsIgnoreCase("color")) {
                           return getListOfStringsMatchingLastWord(args, ChatFormatting.getValidValues(true, false));
                        }
   ...
   protected List<String> func_147184_a(boolean p_147184_1_) {
      ...
      while(true) {
         ...
         do {
            ...
            scoreobjective = (ScoreObjective)var4.next();
         } while(p_147184_1_ && scoreobjective.getCriteria().isReadOnly());
