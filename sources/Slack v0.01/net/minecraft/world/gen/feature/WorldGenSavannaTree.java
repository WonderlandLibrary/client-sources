...
public class WorldGenSavannaTree extends WorldGenAbstractTree {
   ...
   static {
      ...
      field_181644_b = Blocks.leaves2.getDefaultState().withProperty(BlockNewLeaf.VARIANT, BlockPlanks.EnumType.ACACIA).withProperty(BlockLeaves.CHECK_DECAY, Boolean.FALSE);
   }
}
