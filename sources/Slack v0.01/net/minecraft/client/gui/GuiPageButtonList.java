...
public class GuiPageButtonList extends GuiListExtended {
   ...
   private void func_178060_e(int p_178060_1_, int p_178060_2_) {
      ...
      for(var5 = 0; var5 < var4; ++var5) {
         ...
         if (guipagebuttonlist$guilistentry1 != null) {
            this.func_178066_a((Gui)this.field_178073_v.lookup(guipagebuttonlist$guilistentry1.func_178935_b()), false);
         }
      }
   ...
   private GuiTextField func_178068_a(int p_178068_1_, int p_178068_2_, GuiPageButtonList.EditBoxEntry p_178068_3_) {
      GuiTextField guitextfield = new GuiTextField(p_178068_3_.func_178935_b(), this.mc.MCfontRenderer, p_178068_1_, p_178068_2_, 150, 20);
   ...
   private GuiLabel func_178063_a(int p_178063_1_, int p_178063_2_, GuiPageButtonList.GuiLabelEntry p_178063_3_, boolean p_178063_4_) {
      GuiLabel guilabel;
      if (p_178063_4_) {
         guilabel = new GuiLabel(this.mc.MCfontRenderer, p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, this.width - p_178063_1_ * 2, 20, -1);
      } else {
         guilabel = new GuiLabel(this.mc.MCfontRenderer, p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, 150, 20, -1);
      }
