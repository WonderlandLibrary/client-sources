...
public class GuiWinGame extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      int i1;
      for(i1 = 0; i1 < this.field_146582_i.size(); ++i1) {
      ...
      worldrenderer.pos((double)i1, (double)k1, (double)this.zLevel).tex(1.0D, 1.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      worldrenderer.pos((double)i1, 0.0D, (double)this.zLevel).tex(1.0D, 0.0D).func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
