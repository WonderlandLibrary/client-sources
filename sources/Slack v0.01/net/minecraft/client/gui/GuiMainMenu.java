...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (Reflector.FMLCommonHandler_getBrandings.exists()) {
         ...
         List<String> list = Lists.reverse((List)Reflector.call(object, Reflector.FMLCommonHandler_getBrandings, Boolean.TRUE));
      ...
      Slack.getInstance().getClass();
      String s2 = "Release v0.01:\r\n-Added all modules (56)\r\n-Added SexModule";
   ...
   static {
      field_96138_a = "Please click " + ChatFormatting.UNDERLINE + "here" + ChatFormatting.RESET + " for more information.";
   }
}
