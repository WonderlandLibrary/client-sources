...
import cc.slack.events.impl.render.RenderEvent.State;
...
public class GuiIngame extends Gui {
   ...
   public void renderGameOverlay(float partialTicks) {
      ...
      if (this.mc.gameSettings.thirdPersonView == 0 && itemstack != null && itemstack.getItem() == Item.getItemFromBlock(Blocks.pumpkin) && (!((Tweaks)Slack.getInstance().getModuleManager().getInstance(Tweaks.class)).isToggle() || !(Boolean)((Tweaks)Slack.getInstance().getModuleManager().getInstance(Tweaks.class)).noPumpkin.getValue())) {
      ...
      (new RenderEvent(State.RENDER_2D, partialTicks, (float)scaledresolution.getScaledWidth(), (float)scaledresolution.getScaledHeight())).call();
      ...
      if (this.recordPlayingUpFor > 0) {
         ...
         if (i2 > 8) {
            ...
            if (this.recordIsPlaying) {
               l = MathHelper.func_181758_c(f3 / 50.0F, 0.7F, 0.6F) & 16777215;
            }

            this.getFontRenderer().drawString(this.recordPlaying, -this.getFontRenderer().getStringWidth(this.recordPlaying) / 2, -4, l + (i2 << 24 & -16777216));
            GlStateManager.disableBlend();
      ...
      if (this.field_175195_w > 0) {
         ...
         if (i2 > 8) {
            boolean customTitle = ((Tweaks)Slack.getInstance().getModuleManager().getInstance(Tweaks.class)).isToggle() && (Boolean)((Tweaks)Slack.getInstance().getModuleManager().getInstance(Tweaks.class)).customTitle.getValue();
            GlStateManager.pushMatrix();
            if (customTitle) {
            ...
            if (customTitle) {
               ...
               Fonts.apple18.drawStringWithShadow(this.titleText, (float)(-Fonts.apple18.getStringWidth(this.titleText)) / 2.0F, -10.0F, 16777215 | j2);
            } else {
            ...
            if (customTitle) {
               ...
               Fonts.apple18.drawStringWithShadow(this.subtitleText, (float)(-Fonts.apple18.getStringWidth(this.subtitleText)) / 2.0F, 5.0F, 16777215 | j2);
            } else {
      ...
      if (scoreplayerteam != null) {
         j2 = scoreplayerteam.getChatFormat().getColorIndex();
         if (j2 >= 0) {
      ...
      if (scoreobjective1 != null && !(Boolean)((ScoreboardModule)Slack.getInstance().getModuleManager().getInstance(ScoreboardModule.class)).noscoreboard.getValue()) {
         RenderScoreboard event = new RenderScoreboard(cc.slack.events.State.PRE);
         event.call();
         this.renderScoreboard(scoreobjective1, scaledresolution);
         RenderScoreboard event2 = new RenderScoreboard(cc.slack.events.State.POST);
         event2.call();
         if (event.isCanceled()) {
            return;
         }
   ...
   protected void renderTooltip(ScaledResolution sr, float partialTicks) {
      if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
         ...
         if (ItemSpoofUtil.isEnabled) {
            currentItem = ItemSpoofUtil.renderSlot;
         }
   ...
   public void renderExpBar(ScaledResolution p_175176_1_, int p_175176_2_) {
      ...
      if (i > 0) {
         ...
         this.drawTexturedModalRect(p_175176_2_, l1, 0, 64, j, 5);
         if (k > 0) {
            this.drawTexturedModalRect(p_175176_2_, l1, 0, 69, k, 5);
         }
      }
   ...
   private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
      ...
      for(Iterator var7 = collection.iterator(); var7.hasNext(); i = Math.max(i, this.getFontRenderer().getStringWidth(s))) {
         ...
         s = ScorePlayerTeam.formatPlayerName(scoreplayerteam, score.getPlayerName()) + ": " + ChatFormatting.RED + score.getScorePoints();
      }
      ...
      if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
         ...
         if (entity == null) {
            ...
            for(j6 = 0; j6 < 10; ++j6) {
               ...
               if (flag1) {
                  if (j6 * 2 + 1 < l) {
                     this.drawTexturedModalRect(j4, i7, l7 + 54, 27, 9, 9);
                  }

                  if (j6 * 2 + 1 == l) {
                     this.drawTexturedModalRect(j4, i7, l7 + 63, 27, 9, 9);
                  }
               }
            ...
            i7 = (int)Math.ceil((double)entitylivingbase.getHealth());
            ...
            for(int k9 = 0; i4 > 0; k9 += 20) {
               ...
               for(int i5 = 0; i5 < l4; ++i5) {
                  ...
                  int l5 = j1 - i5 * 8 - 9;
                  this.drawTexturedModalRect(l5, j4, j5 + k5 * 9, 9, 9, 9);
                  if (i5 * 2 + 1 + k9 < i7) {
   ...
   private void renderBossHealth() {
      if (BossStatus.bossName != null && BossStatus.statusBarTime > 0 && !(Boolean)((Tweaks)Slack.getInstance().getModuleManager().getInstance(Tweaks.class)).nobosshealth.getValue()) {
   ...
   private void renderHotbarItem(int index, int xPos, int yPos, float partialTicks, EntityPlayer p_175184_5_) {
      ...
      if (itemstack != null) {
         ...
         this.itemRenderer.renderItemOverlays(this.mc.MCfontRenderer, itemstack, xPos, yPos);
      }
