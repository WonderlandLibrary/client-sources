...
public class WorldRenderer {
   ...
   public void func_181674_a(float p_181674_1_, float p_181674_2_, float p_181674_3_) {
      ...
      for(int l1 = 0; (l1 = bitset.nextClearBit(l1)) < ainteger.length; ++l1) {
         ...
         if (i1 != l1) {
            ...
            for(k1 = ainteger[i1]; j2 != l1; k1 = ainteger[k1]) {
      ...
      if (this.quadSprites != null) {
         ...
         i1 = this.vertexFormat.getNextOffset() / 4 * 4;

         for(j2 = 0; j2 < ainteger.length; ++j2) {
            k1 = ainteger[j2];
            atextureatlassprite[j2] = this.quadSprites[k1];
         }
   ...
   public WorldRenderer func_181663_c(float p_181663_1_, float p_181663_2_, float p_181663_3_) {
      ...
      case USHORT:
      case SHORT:
         this.byteBuffer.putShort(i, (short)((int)(p_181663_1_ * 32767.0F) & '\uffff'));
         this.byteBuffer.putShort(i + 2, (short)((int)(p_181663_2_ * 32767.0F) & '\uffff'));
         this.byteBuffer.putShort(i + 4, (short)((int)(p_181663_3_ * 32767.0F) & '\uffff'));
         break;
      case UBYTE:
      case BYTE:
   ...
   public void putColorMultiplierRgba(float p_putColorMultiplierRgba_1_, float p_putColorMultiplierRgba_2_, float p_putColorMultiplierRgba_3_, float p_putColorMultiplierRgba_4_, int p_putColorMultiplierRgba_5_) {
      ...
      if (!this.needsUpdate) {
         ...
         int j1;
         if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
            k = (int)((float)(j & 255) * p_putColorMultiplierRgba_1_);
            l = (int)((float)(j >> 8 & 255) * p_putColorMultiplierRgba_2_);
            i1 = (int)((float)(j >> 16 & 255) * p_putColorMultiplierRgba_3_);
            j1 = (int)((float)(j >> 24 & 255) * p_putColorMultiplierRgba_4_);
            j = j1 << 24 | i1 << 16 | l << 8 | k;
         } else {
            k = (int)((float)(j >> 24 & 255) * p_putColorMultiplierRgba_1_);
            l = (int)((float)(j >> 16 & 255) * p_putColorMultiplierRgba_2_);
            i1 = (int)((float)(j >> 8 & 255) * p_putColorMultiplierRgba_3_);
            j1 = (int)((float)(j & 255) * p_putColorMultiplierRgba_4_);
            j = k << 24 | l << 16 | i1 << 8 | j1;
         }
      }
