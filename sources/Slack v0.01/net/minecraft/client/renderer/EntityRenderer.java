...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   public void getMouseOver(float partialTicks) {
      ...
      if (entity != null && this.mc.theWorld != null) {
         ...
         if (this.pointedEntity != null && flag) {
            ...
            if (((Reach)Slack.getInstance().getModuleManager().getInstance(Reach.class)).isToggle()) {
               combatReach = ((Reach)Slack.getInstance().getModuleManager().getInstance(Reach.class)).combatReach;
            }
   ...
   private void hurtCameraEffect(float partialTicks) {
      if (this.mc.getRenderViewEntity() instanceof EntityLivingBase && !(Boolean)((Tweaks)Slack.getInstance().getModuleManager().getInstance(Tweaks.class)).nohurtcam.getValue()) {
   ...
   public void func_181560_a(float p_181560_1_, long p_181560_2_) {
      ...
      if (this.mc.inGameHasFocus && flag) {
         ...
         float f = ((AimAssist)Slack.getInstance().getModuleManager().getInstance(AimAssist.class)).getSens() * 0.6F + 0.2F;
         float f1 = f * f * f * 8.0F;
      ...
      if (!this.mc.skipRenderWorld) {
         ...
         if (this.mc.theWorld != null) {
            ...
            TileEntityRendererDispatcher.instance.fontRenderer = this.mc.MCfontRenderer;
         }
   ...
   private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
      ...
      (new RenderEvent(State.RENDER_3D, partialTicks)).call();
               ...
               if (biomegenbase.canSpawnLightningBolt() || biomegenbase.getEnableSnow()) {
                  ...
                  if (k2 != l2) {
                     ...
                     if (world.getWorldChunkManager().getTemperatureAtHeight(f1, j2) >= 0.15F) {
                        ...
                        int j4 = i4 >> 16 & '\uffff';
                        int k4 = i4 & '\uffff';
                        worldrenderer.pos((double)l1 - d3 + 0.5D, (double)k2, (double)k1 - d4 + 0.5D).tex(0.0D + d6, (double)k2 * 0.25D + d5 + d7).func_181666_a(1.0F, 1.0F, 1.0F, f4).func_181671_a(j4, k4).endVertex();
                        worldrenderer.pos((double)l1 + d3 + 0.5D, (double)k2, (double)k1 + d4 + 0.5D).tex(1.0D + d6, (double)k2 * 0.25D + d5 + d7).func_181666_a(1.0F, 1.0F, 1.0F, f4).func_181671_a(j4, k4).endVertex();
                        worldrenderer.pos((double)l1 + d3 + 0.5D, (double)l2, (double)k1 + d4 + 0.5D).tex(1.0D + d6, (double)l2 * 0.25D + d5 + d7).func_181666_a(1.0F, 1.0F, 1.0F, f4).func_181671_a(j4, k4).endVertex();
                        worldrenderer.pos((double)l1 - d3 + 0.5D, (double)l2, (double)k1 - d4 + 0.5D).tex(0.0D + d6, (double)l2 * 0.25D + d5 + d7).func_181666_a(1.0F, 1.0F, 1.0F, f4).func_181671_a(j4, k4).endVertex();
                     }
                  }
               }
            }
   ...
   private void updateFogColor(float partialTicks) {
      ...
      Vec3 vec34;
      if (this.cloudFog) {
         vec34 = world.getCloudColour(partialTicks);
         ...
         vec34 = CustomColors.getUnderlavaColor(this.mc.theWorld, this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().posY + 1.0D, this.mc.getRenderViewEntity().posZ);
         if (vec34 != null) {
            this.fogColorRed = (float)vec34.xCoord;
            this.fogColorGreen = (float)vec34.yCoord;
            this.fogColorBlue = (float)vec34.zCoord;
   ...
   private void setupFog(int p_78468_1_, float partialTicks) {
      ...
      if (f >= 0.0F) {
         ...
         if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPotionActive(Potion.blindness)) {
            ...
            GlStateManager.setFog(2048);
            f3 = Config.isClearWater() ? 0.02F : 0.1F;
            if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPotionActive(Potion.waterBreathing)) {
               GlStateManager.setFogDensity(0.01F);
            } else {
               float f2 = 0.1F - (float)EnchantmentHelper.getRespiration(entity) * 0.03F;
               GlStateManager.setFogDensity(Config.limit(f2, 0.0F, f3));
            }
         } else if (block.getMaterial() == Material.lava) {
            GlStateManager.setFog(2048);
