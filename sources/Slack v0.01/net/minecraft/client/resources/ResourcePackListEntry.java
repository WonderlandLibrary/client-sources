...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry {
   ...
   public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
      ...
      j = this.mc.MCfontRenderer.getStringWidth(s);
      if (j > 157) {
         s = this.mc.MCfontRenderer.trimStringToWidth(s, 157 - this.mc.MCfontRenderer.getStringWidth("...")) + "...";
      }

      this.mc.MCfontRenderer.drawStringWithShadow(s, (float)(x + 32 + 2), (float)(y + 1), 16777215);
      List<String> list = this.mc.MCfontRenderer.listFormattedStringToWidth(s1, 157);

      for(int l = 0; l < 2 && l < list.size(); ++l) {
         this.mc.MCfontRenderer.drawStringWithShadow((String)list.get(l), (float)(x + 32 + 2), (float)(y + 12 + 10 * l), 8421504);
      }
