...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
   ...
   public void handleMultiBlockChange(S22PacketMultiBlockChange packetIn) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         S22PacketMultiBlockChange.BlockUpdateData s22packetmultiblockchange$blockupdatedata = var2[var4];
   ...
   public void handleExplosion(S27PacketExplosion packetIn) {
      ...
      var10000.motionX += (double)packetIn.func_149149_c();
      var10000 = this.gameController.thePlayer;
      var10000.motionY += (double)packetIn.func_149144_d();
      var10000 = this.gameController.thePlayer;
      var10000.motionZ += (double)packetIn.func_149147_e();
   }
   ...
   public void handleChangeGameState(S2BPacketChangeGameState packetIn) {
      ...
      if (i == 1) {
         ...
         this.clientWorldController.setRainStrength(Math.max(0.0F, Math.min(2.0F, f)));
      } else if (i == 8) {
         this.clientWorldController.setThunderStrength(Math.max(0.0F, Math.min(2.0F, f)));
      } else if (i == 10) {
   ...
   public void handleStatistics(S37PacketStatistics packetIn) {
      ...
      for(Iterator var3 = packetIn.func_148974_c().entrySet().iterator(); var3.hasNext(); this.gameController.thePlayer.getStatFileWriter().unlockAchievement(this.gameController.thePlayer, statbase, i)) {
         Entry<StatBase, Integer> entry = (Entry)var3.next();
   ...
   public void handlePlayerListItem(S38PacketPlayerListItem packetIn) {
      ...
      while(var2.hasNext()) {
         S38PacketPlayerListItem.AddPlayerData s38packetplayerlistitem$addplayerdata = (S38PacketPlayerListItem.AddPlayerData)var2.next();
      ...
      try {
         ...
         if (!"http".equals(scheme) && !"https".equals(scheme) && !isLevelProtocol) {
            ...
            if (!isLevelProtocol || !url.contains("..") && url.endsWith("/resources.zip")) {
               ...
               if (player != null) {
                  player.addChatMessage(new ChatComponentText(ChatFormatting.RED + ChatFormatting.BOLD.toString() + "[WARNING] The current server has attempted to be malicious but we have stopped them."));
               }
   ...
   public void handleResourcePack(S48PacketResourcePackSend packetIn) {
      validateResourcePackUrl(this, packetIn);
      String url = packetIn.getURL();
      ...
      if (url.startsWith("level://")) {
         ...
         this.gameController.addScheduledTask(() -> {
            this.gameController.displayGuiScreen(new GuiYesNo((result, id) -> {
   ...
   public void handleTeams(S3EPacketTeams packetIn) {
      ...
      if (packetIn.func_149307_h() == 0 || packetIn.func_149307_h() == 2) {
         ...
         scoreplayerteam.setChatFormat(ChatFormatting.func_175744_a(packetIn.func_179813_h()));
