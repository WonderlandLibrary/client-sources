...
public class Scoreboard {
	...
	public static String getObjectiveDisplaySlot(int p_96517_0_) {
		...
		if (p_96517_0_ >= 3 && p_96517_0_ <= 18
				&& (enumchatformatting = EnumChatFormatting.func_175744_a(p_96517_0_ - 3)) != null
	...
	public static int getObjectiveDisplaySlotNumber(String p_96537_0_) {
		...
		if (p_96537_0_.startsWith("sidebar.team.")
				&& (enumchatformatting = EnumChatFormatting
						.getValueByName(s = p_96537_0_.substring("sidebar.team.".length()))) != null
				&& enumchatformatting.getColorIndex() >= 0) {
