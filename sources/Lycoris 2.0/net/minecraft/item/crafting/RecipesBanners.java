...
public class RecipesBanners {
    ...
    implements IRecipe {
        ...
        private TileEntityBanner.EnumBannerPattern func_179533_c(InventoryCrafting p_179533_1_) {
            TileEntityBanner.EnumBannerPattern[] arrenumBannerPattern = TileEntityBanner.EnumBannerPattern.values();
            int n = arrenumBannerPattern.length;
            int n2 = 0;
            while (true) {
                block12: {
                    boolean flag;
                            ...
                            block14: {
                                block15: {
                                    block13: {
                                        ...
                                        tileentitybanner$enumbannerpattern = arrenumBannerPattern[n2];
