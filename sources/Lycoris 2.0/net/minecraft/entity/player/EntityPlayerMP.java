...
public class EntityPlayerMP extends EntityPlayer implements ICrafting {
	...
	public void onUpdateEntity() {
		try {
			...
			for (int i = 0; i < this.inventory.getSizeInventory(); ++i) {
				...
				if (itemstack == null || !itemstack.getItem().isMap() || (packet = ((ItemMapBase) itemstack.getItem())
						.createMapDataPacket(itemstack, this.worldObj, this)) == null)
					continue;
	...
	public boolean attackEntityFrom(DamageSource source, float amount) {
		...
		boolean bl = flag = this.mcServer.isDedicatedServer() && this.canPlayersAttack()
	...
	public void handleFalling(double p_71122_1_, boolean p_71122_3_) {
		...
		BlockPos blockpos = new BlockPos(i, j = MathHelper.floor_double(this.posY - (double) 0.2f),
				k = MathHelper.floor_double(this.posZ));
		Block block = this.worldObj.getBlockState(blockpos).getBlock();
		if (block.getMaterial() == Material.air
				&& ((block1 = this.worldObj.getBlockState(blockpos.down()).getBlock()) instanceof BlockFence
						|| block1 instanceof BlockWall || block1 instanceof BlockFenceGate)) {
	...
	public boolean canCommandSenderUseCommand(int permLevel, String commandName) {
		...
		if (!("tell".equals(commandName) || "help".equals(commandName) || "me".equals(commandName)
