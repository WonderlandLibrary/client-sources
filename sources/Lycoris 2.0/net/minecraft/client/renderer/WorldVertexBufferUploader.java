    ...
    public void func_181679_a(WorldRenderer p_181679_1_) {
        if (p_181679_1_.getVertexCount() > 0) {
            ...
            block12: for (int j = 0; j < list.size(); ++j) {
                ...
                if (flag) {
                    Reflector.callVoid((Object)vertexformatelement$enumusage, Reflector.ForgeVertexFormatElementEnumUseage_preDraw, vertexformatelement, i, bytebuffer);
                    continue;
                }
            ...
            block13: for (int i1 = 0; i1 < k1; ++i1) {
                ...
                if (flag1) {
                    Reflector.callVoid((Object)vertexformatelement$enumusage1, Reflector.ForgeVertexFormatElementEnumUseage_postDraw, vertexformatelement1, i, bytebuffer);
                    continue;
                }
