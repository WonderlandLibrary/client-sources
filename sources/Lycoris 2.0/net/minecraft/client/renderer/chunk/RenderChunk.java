    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
        ...
        if (!regionrendercache.extendedLevelsInChunkCache()) {
            ...
            while (iterator.hasNext()) {
                ...
                boolean flag4 = flag1 ? Reflector.callBoolean(iterator, Reflector.ForgeBlock_hasTileEntity, blockrendererdispatcher) : block.hasTileEntity();
                if (flag4) {
                ...
                for (int i = 0; i < aenumworldblocklayer.length; ++i) {
                    ...
                    int n = j;
                    aboolean[n] = aboolean[n] | blockrendererdispatcher.renderBlock(iblockstate, blockposm, regionrendercache, worldrenderer);
                }
            }
        ...
        try {
            HashSet hashset1 = Sets.newHashSet((Iterable)var11);
            HashSet hashset2 = Sets.newHashSet((Iterable)this.field_181056_j);
