...
public class RenderManager {
	private Map<Class<? extends Entity>, Render<? extends Entity>> entityRenderMap = new HashMap<Class<? extends Entity>, Render<? extends Entity>>();
	private final Map<String, RenderPlayer> skinMap = new HashMap<String, RenderPlayer>();
	...
	private void renderDebugBoundingBox(Entity entityIn, double p_85094_2_, double p_85094_4_, double p_85094_6_,
		...
		if (entityIn instanceof EntityLivingBase) {
			...
			RenderGlobal.func_181563_a(new AxisAlignedBB(p_85094_2_ - (double) f,
					p_85094_4_ + (double) entityIn.getEyeHeight() - (double) 0.01f, p_85094_6_ - (double) f,
					p_85094_2_ + (double) f, p_85094_4_ + (double) entityIn.getEyeHeight() + (double) 0.01f,
		...
		worldrenderer.pos(p_85094_2_, p_85094_4_ + (double) entityIn.getEyeHeight(), p_85094_6_).color(0, 0, 255, 255)
				.endVertex();
		worldrenderer.pos(p_85094_2_ + vec3.xCoord * 2.0,
				p_85094_4_ + (double) entityIn.getEyeHeight() + vec3.yCoord * 2.0, p_85094_6_ + vec3.zCoord * 2.0)
