...
extends Render<EntityXPOrb> {
    ...
    public void doRender(EntityXPOrb entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        worldrenderer.pos(-0.5, -0.25, 0.0).tex(f, f3).color(l, 255, j1, 128).normal(0.0f, 1.0f, 0.0f).endVertex();
        worldrenderer.pos(0.5, -0.25, 0.0).tex(f1, f3).color(l, 255, j1, 128).normal(0.0f, 1.0f, 0.0f).endVertex();
        worldrenderer.pos(0.5, 0.75, 0.0).tex(f1, f2).color(l, 255, j1, 128).normal(0.0f, 1.0f, 0.0f).endVertex();
        worldrenderer.pos(-0.5, 0.75, 0.0).tex(f, f2).color(l, 255, j1, 128).normal(0.0f, 1.0f, 0.0f).endVertex();
        tessellator.draw();
