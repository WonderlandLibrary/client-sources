...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int j = 0;
        int n = j++;
        this.drawString(this.fontRendererObj, I18n.format("advMode.nearestPlayer", new Object[0]), this.width / 2 - 150, i + n * 9, 0xA0A0A0);
        int n2 = j++;
        this.drawString(this.fontRendererObj, I18n.format("advMode.randomPlayer", new Object[0]), this.width / 2 - 150, i + n2 * 9, 0xA0A0A0);
        int n3 = j++;
        this.drawString(this.fontRendererObj, I18n.format("advMode.allPlayers", new Object[0]), this.width / 2 - 150, i + n3 * 9, 0xA0A0A0);
        int n4 = j++;
        this.drawString(this.fontRendererObj, I18n.format("advMode.allEntities", new Object[0]), this.width / 2 - 150, i + n4 * 9, 0xA0A0A0);
        int n5 = j++;
        this.drawString(this.fontRendererObj, "", this.width / 2 - 150, i + n5 * 9, 0xA0A0A0);
