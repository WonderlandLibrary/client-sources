...
public class GuiStats extends GuiScreen implements IProgressMeter {
	...
	public void createButtons() {
		...
		GuiButton guibutton = new GuiButton(2, this.width / 2 - 80, this.height - 52, 80, 20,
				I18n.format("stat.blocksButton", new Object[0]));
		this.buttonList.add(guibutton);
		GuiButton guibutton1 = new GuiButton(3, this.width / 2, this.height - 52, 80, 20,
				I18n.format("stat.itemsButton", new Object[0]));
		this.buttonList.add(guibutton1);
		GuiButton guibutton2 = new GuiButton(4, this.width / 2 + 80, this.height - 52, 80, 20,
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		if (this.doesGuiPauseGame) {
			...
			this.drawCenteredString(this.fontRendererObj,
					...
					this.width / 2, this.height / 2 + 9 * 2, 0xFFFFFF);
		} else {
	...
	private void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
		...
		worldrenderer.pos(p_146527_1_ + 0, p_146527_2_ + 18, this.zLevel)
				.tex((float) (p_146527_3_ + 0) * 0.0078125f, (float) (p_146527_4_ + 18) * 0.0078125f).endVertex();
		...
		worldrenderer.pos(p_146527_1_ + 18, p_146527_2_ + 0, this.zLevel)
				.tex((float) (p_146527_3_ + 18) * 0.0078125f, (float) (p_146527_4_ + 0) * 0.0078125f).endVertex();
		worldrenderer.pos(p_146527_1_ + 0, p_146527_2_ + 0, this.zLevel)
				.tex((float) (p_146527_3_ + 0) * 0.0078125f, (float) (p_146527_4_ + 0) * 0.0078125f).endVertex();
		tessellator.draw();
	}
	...
	class StatsGeneral extends GuiSlot {
		...
		protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn,
			...
			GuiStats.this.drawString(GuiStats.this.fontRendererObj, statbase.getStatName().getUnformattedText(),
					p_180791_2_ + 2, p_180791_3_ + 1, entryID % 2 == 0 ? 0xFFFFFF : 0x909090);
