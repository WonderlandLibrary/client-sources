...
public class GuiSnooper extends GuiScreen {
	...
	public void initGui() {
		...
		this.field_146605_t = new GuiButton(1, this.width / 2 - 152, this.height - 30, 150, 20,
		...
		if (flag) {
			for (Map.Entry<String, String> entry1 : new TreeMap<String, String>(
