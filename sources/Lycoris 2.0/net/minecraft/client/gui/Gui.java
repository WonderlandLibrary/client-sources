...
public class Gui {
    ...
    public static void drawBorder(double left, double top, double width, double height, float lineWidth, int color) {
        Gui.drawRect(left - (double)lineWidth, top - (double)lineWidth, left, top + height + (double)lineWidth, color);
        Gui.drawRect(left, top - (double)lineWidth, left + width, top, color);
        Gui.drawRect(left, top + height, left + width, top + height + (double)lineWidth, color);
        Gui.drawRect(left + width, top - (double)lineWidth, left + width + (double)lineWidth, top + height + (double)lineWidth, color);
    }
