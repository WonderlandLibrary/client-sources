...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i = Math.max((int)((double)this.height * 0.85 / 2.0 - (double)((float)(this.field_152323_r.size() * 9) / 2.0f)), 50);
        this.drawCenteredString(this.fontRendererObj, this.field_152324_f.getFormattedText(), this.width / 2, i - 9 * 2, 0xFFFFFF);
