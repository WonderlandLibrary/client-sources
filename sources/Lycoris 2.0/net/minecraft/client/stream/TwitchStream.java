...
IStream {
    ...
    public void func_152893_b(ErrorCode p_152893_1_) {
        ...
        this.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(new ChatComponentText("Issue streaming frame: " + (Object)p_152893_1_ + " (" + ErrorCode.getString((ErrorCode)p_152893_1_) + ")"), 2);
    }
