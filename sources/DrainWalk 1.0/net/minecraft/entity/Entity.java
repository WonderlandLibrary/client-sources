...
import tech.drainwalk.client.module.modules.combat.HitBoxModule;
...
public abstract class Entity implements ICommandSender
{
    ...
    {
        if(this instanceof EntityPlayer && DrainWalk.moduleManager.hitBoxModule.isEnabled()) {
            return DrainWalk.moduleManager.hitBoxModule.size.getValue() * 0.05f;
        }
        return 0.0f;
