...
public class EntityRenderer implements IResourceManagerReloadListener {
        ...
        if (!this.mc.skipRenderWorld) {
            ...
            if (this.mc.world == null) {
                ...
                if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null) {
                    ...
                    ScaledResolution r = new ScaledResolution(mc, 2);
                    EventManager.call(new EventRender2D(r));
    ...
    private void frameInit() {
        ...
        if (this.mc.currentScreen instanceof tech.drainwalk.gui.minecraft.mainmenu.GuiMainMenu) {
            this.updateMainMenu((tech.drainwalk.gui.minecraft.mainmenu.GuiMainMenu) this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(tech.drainwalk.gui.minecraft.mainmenu.GuiMainMenu p_updateMainMenu_1_) {
        try {
            String s = null;
