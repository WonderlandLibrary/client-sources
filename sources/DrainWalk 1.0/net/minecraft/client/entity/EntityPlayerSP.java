...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public float isHandActiveSlownessValue = 0.2f;
    ...
    private void onUpdateWalkingPlayer()
    {
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            {
                this.connection.sendPacket(new CPacketPlayer());
            }
    ...
    public void onLivingUpdate()
    {
        ...
        {
            this.movementInput.moveStrafe *= isHandActiveSlownessValue;
            this.movementInput.moveForward *= isHandActiveSlownessValue;
