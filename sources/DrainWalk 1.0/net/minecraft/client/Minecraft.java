...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private void init() throws LWJGLException, IOException
    {
        ...
        this.ingameGUI = new GuiIngame(this);
            ...
            this.displayGuiScreen(new tech.drainwalk.gui.minecraft.mainmenu.GuiMainMenu());
    ...
    public void displayGuiScreen(@Nullable GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new tech.drainwalk.gui.minecraft.mainmenu.GuiMainMenu();
        }
        ...
        if (guiScreenIn instanceof tech.drainwalk.gui.minecraft.mainmenu.GuiMainMenu || guiScreenIn instanceof GuiMultiplayer)
        {
    ...
    public int getLimitFramerate() {
        return Display.isActive() ? this.world == null && this.currentScreen != null ? 60 : gameSettings.limitFramerate : 15;
    }
    ...
    private void runTickKeyboard() throws IOException
    {
        while (Keyboard.next())
        {
            ...
            {
                KeyBinding.setKeyBindState(i, false);
                for (Module m : DrainWalk.moduleManager.getModuleList()) {
                    if (m.getKey() == i) {
                        m.toggle();
                    }
                }
