...
import tech.drainwalk.font.WFontRenderer;
import tech.drainwalk.utility.color.ColorUtility;

public class TextField extends Gui {
    private final int id;
    private final WFontRenderer fontRendererInstance;
    ...
    public TextField(int componentId, WFontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
...
//ИСПРАВИТЬ РУ-ТЕКСТ
            ...
            int l = this.enableBackgroundDrawing ? this.xPosition + 4 + 8 : this.xPosition + 8;
            int i1 = this.enableBackgroundDrawing ? this.yPosition + (this.height - 8) / 2 + 10 : this.yPosition + 8;
            int j1 = l;//ИСПРАВИТЬ РУ-ТЕКСТ
//ИСПРАВИТЬ РУ-ТЕКСТ
            if (k > s.length()) {
                k = s.length();
            }//ИСПРАВИТЬ РУ-ТЕКСТ
//ИСПРАВИТЬ РУ-ТЕКСТ
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    this.fontRendererInstance.drawStringWithShadow("_", (float) k1, (float) i1, ColorUtility.rgba(100,100,100,60));
                }
            }
