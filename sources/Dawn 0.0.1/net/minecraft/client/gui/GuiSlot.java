...
public abstract class GuiSlot
{
    ...
    private static GLSLShaders glslShaders;
    ...
    protected void drawBackground() {
        if(glslShaders == null) {
            try {
                glslShaders = new GLSLShaders("/assets/minecraft/dawn/shader/main.fsh");
            } catch (IOException e) {
                throw new IllegalStateException("Failed to load shaders", e);
            }
        } else {
            this.glslShaders.useShader(width * 2, height * 2, 0, 0, (System.currentTimeMillis() - initTime) / 1000f);
