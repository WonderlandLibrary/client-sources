...
import wtf.dawn.utils.RandomUtil;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(100, this.width / 2 + 2, j + 72 + 12 + 20, 98, 20, I18n.format("random alt", new Object[0])));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if(button.id == 100) {
            mc.session = new Session("Dawn" + RandomUtil.randomString(5), "", "", "legacy");
        }
    }
