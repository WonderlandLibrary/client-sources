package wtf.dawn.utils.shaders;
...
public class GLSLShaders {
    ...
    public GLSLShaders(String fragmentShaderLocation) throws IOException {
        int program = glCreateProgram();

        glAttachShader(program, createShader(GLSLShaders.class.getResourceAsStream("/assets/minecraft/dawn/shader/passthrough.vsh"), GL_VERTEX_SHADER));
        glAttachShader(program, createShader(GLSLShaders.class.getResourceAsStream(fragmentShaderLocation), GL_FRAGMENT_SHADER));
