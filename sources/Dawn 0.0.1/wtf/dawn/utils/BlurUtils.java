...
public class BlurUtils {
    ...
    public static class RounededShader {
        ...
        public RounededShader(){
            this.fragLocation = new ResourceLocation("dawn/shader/rounded_texture_frag.fsh");
            this.vertexLocation = new ResourceLocation("dawn/shader/rounded_texture_vert.vsh");
