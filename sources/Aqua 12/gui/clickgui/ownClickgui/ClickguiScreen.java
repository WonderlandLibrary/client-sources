...
public class ClickguiScreen extends GuiScreen
{
    ...
    public void initGui() {
        ...
        for (final Category category : Category.values()) {
            final CategoryPaneOwn categoryPane = new CategoryPaneOwn(x, 10, 100, 20, category, this);
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (Aqua.moduleManager.getModuleByName("Shadow").isToggled()) {
            Shadow.drawGlow(() -> RenderUtil.drawRoundedRect(5.0, sr.getScaledHeight() - 55, 35.0, 35.0, 3.0, new Color(0, 0, 0, 100).getRGB()), false);
        }
        RenderUtil.drawRoundedRect2Alpha(5.0, sr.getScaledHeight() - 55, 35.0, 35.0, 3.0, new Color(0, 0, 0, 100));
