...
package intent.AquaDev.aqua.gui.tenacity;
...
import intent.AquaDev.aqua.gui.tenacity.components.CategoryPaneNovoline;
...
public class ClickguiScreenNovoline extends GuiScreen
{
    ...
    public void initGui() {
        ...
        for (final Category category : Category.values()) {
            ...
            if (!Aqua.setmgr.getSetting("GUIAutoPosReset").isState()) {
                Aqua.INSTANCE.fileUtil.loadClickGuiTenacity(categoryPane);
            }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (Aqua.moduleManager.getModuleByName("GuiElements").isToggled()) {
            ...
            if (Aqua.moduleManager.getModuleByName("Blur").isToggled()) {
                ...
                if (Aqua.setmgr.getSetting("GuiElementsBlur").isState()) {
    ...
    public void onGuiClosed() {
        Aqua.INSTANCE.fileUtil.saveClickGuiTenacity(this);
        super.onGuiClosed();
    }
