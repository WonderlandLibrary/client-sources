...
package intent.AquaDev.aqua.gui.novolineOld;
...
import intent.AquaDev.aqua.gui.novolineOld.components.CategoryPaneNovoline;
...
public class ClickguiScreenNovoline extends GuiScreen
{
    ...
    public void initGui() {
        ...
        for (final Category category : Category.values()) {
            final CategoryPaneNovoline categoryPane = new CategoryPaneNovoline(x, 10, 105, 20, category, this);
