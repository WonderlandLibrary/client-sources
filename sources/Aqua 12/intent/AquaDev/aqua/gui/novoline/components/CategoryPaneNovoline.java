        ...
        for (final Module module3 : moduleList) {
            if (module3.getCategory() == this.category) {
                ...
                if (Aqua.moduleManager.getModuleByName("Blur").isToggled()) {
                    final int n;
                    Blur.drawBlurred(() -> Gui.drawRect(this.x + 2, this.y + n, this.x + this.width - 2, this.y + n + 15, Color.black.getRGB()), false);
                }
                if (Aqua.moduleManager.getModuleByName("Shadow").isToggled()) {
                    final int n2;
                    Shadow.drawGlow(() -> Gui.drawRect(this.x + 2, this.y + n2, this.x + this.width - 2, this.y + n2 + 15, Color.black.getRGB()), false);
                }
                Gui.drawRect(this.x + 2, this.y + add, this.x + this.width - 2, this.y + add + 15, this.CATEGORY_MODULE_COLOR);
                final int finalAdd3 = add;
                Aqua.INSTANCE.comfortaa4.drawCenteredString(module3.getName(), this.x + this.width / 2.0f, (float)(this.y + add + 2), module3.isToggled() ? this.ACTIVATED_TEXT_COLOR : this.INACTIVATED_TEXT_COLOR);
