...
package intent.AquaDev.aqua.gui.hero;
...
import intent.AquaDev.aqua.gui.hero.components.CategoryPaneHero;
import java.util.List;
import net.minecraft.util.ResourceLocation;
import intent.AquaDev.aqua.utils.Translate;
import net.minecraft.client.gui.GuiScreen;

public class ClickguiScreenHero extends GuiScreen
{
    Translate translate;
    private ResourceLocation resourceLocation;
    public static boolean awaitingClose;
    private final List<CategoryPaneHero> categoryPanes;
    private final GuiScreen parentScreen;
    public CategoryPaneHero current;
    private final Animate animate;
    
    public ClickguiScreenHero(final GuiScreen parentScreen) {
        this.categoryPanes = new ArrayList<CategoryPaneHero>();
        this.current = null;
    ...
    public void initGui() {
        ...
        this.translate = new Translate(this.mc.displayWidth / 2.0f, this.mc.displayHeight / 2.0f - 250.0f);
        int x = 10;
        ...
        for (final Category category : Category.values()) {
            final CategoryPaneHero categoryPane = new CategoryPaneHero(x, 10, 105, 20, category, this);
            this.categoryPanes.add(categoryPane);
            x += 110;
        }
        ClickguiScreenHero.awaitingClose = false;
        super.initGui();
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.translate.interpolate((float)ClickguiScreenHero.width, (float)ClickguiScreenHero.height, 6.0);
        final double xmod = ClickguiScreenHero.width / 2.0f - this.translate.getX() / 2.0f;
        final double ymod = ClickguiScreenHero.height / 2.0f - this.translate.getY() / 2.0f;
        GlStateManager.translate(xmod, ymod, 0.0);
        GlStateManager.scale(this.translate.getX() / ClickguiScreenHero.width, this.translate.getY() / ClickguiScreenHero.height, 1.0f);
        if (ClickguiScreenHero.awaitingClose) {
        ...
        for (final CategoryPaneHero categoryPane : this.categoryPanes) {
    ...
    protected void keyTyped(final char typedChar, final int keyCode) throws IOException {
        if (keyCode == 1 || keyCode == Aqua.moduleManager.getModuleByName("GUI").getKeyBind()) {
            ClickguiScreenHero.awaitingClose = true;
            return;
        }
    ...
    public List<CategoryPaneHero> getCategoryPanes() {
