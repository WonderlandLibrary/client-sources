...
public class CategoryPaneNovoline extends Gui
{
    ...
    public void draw(final int posX, final int posY, final int mouseX, final int mouseY) {
        ...
        RenderUtil.drawRoundedRect3(this.x + 2, this.y + 19, this.width - 3, 1.0, 0.0, true, true, false, false, Color.white);
        GL11.glEnable(3089);
        ...
        for (final Module module3 : moduleList) {
            if (module3.getCategory() == this.category) {
                ...
                if (Aqua.setmgr.getSetting("GUIDarkMode").isState()) {
                    ...
                    RenderUtil.drawRoundedRect3(this.x + 2, this.y + add, this.width - 3, CategoryPaneNovoline.last ? 15.0 : 15.0, 3.0, false, false, CategoryPaneNovoline.last, CategoryPaneNovoline.last, new Color(20, 20, 20, 60));
                }
                else if (Aqua.moduleManager.getModuleByName("Shadow").isToggled() && !ClickguiScreenNovoline.isDragging) {
                    final int finalAdd5 = add;
                    Shadow.drawGlow(() -> RenderUtil.drawRoundedRect3(this.x + 2, this.y + finalAdd5, this.width - 3, CategoryPaneNovoline.last ? 15.0 : 15.0, 3.0, false, false, CategoryPaneNovoline.last, CategoryPaneNovoline.last, new Color(255, 255, 255, 180)), false);
                }
