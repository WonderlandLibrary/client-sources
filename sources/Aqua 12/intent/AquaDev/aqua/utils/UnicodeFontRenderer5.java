...
public class UnicodeFontRenderer5
{
    public static UnicodeFontRenderer5 instance;
    ...
    private UnicodeFontRenderer5(final String fontName, final int fontType, final float fontSize, final float kerning, final float antiAliasingFactor) {
    ...
    private UnicodeFontRenderer5(final Font font, final float kerning, final float antiAliasingFactor) {
        this.colorCodes = new int[32];
        this.cachedStringWidth = new HashMap<String, Float>();
        this.antiAliasingFactor = antiAliasingFactor;
    ...
    public static UnicodeFontRenderer5 getFontOnPC(final String name, final int size) {
        return getFontOnPC(name, size, 0);
    }
    
    public static UnicodeFontRenderer5 getFontOnPC(final String name, final int size, final int fontType) {
        return getFontOnPC(name, size, fontType, 0.0f);
    }
    
    public static UnicodeFontRenderer5 getFontOnPC(final String name, final int size, final int fontType, final float kerning) {
        return getFontOnPC(name, size, fontType, kerning, 3.0f);
    }
    
    public static UnicodeFontRenderer5 getFontOnPC(final String name, final int size, final int fontType, final float kerning, final float antiAliasingFactor) {
        return new UnicodeFontRenderer5(new Font(name, fontType, size), kerning, antiAliasingFactor);
    }
    
    public static UnicodeFontRenderer5 getFontFromAssets(final String name, final int size) {
        return getFontOnPC(name, size, 0);
    }
    
    public static UnicodeFontRenderer5 getFontFromAssets(final String name, final int size, final int fontType) {
        return getFontOnPC(name, fontType, size, 0.0f);
    }
    
    public static UnicodeFontRenderer5 getFontFromAssets(final String name, final int size, final float kerning, final int fontType) {
        return getFontFromAssets(name, size, fontType, kerning, 3.0f);
    }
    
    public static UnicodeFontRenderer5 getFontFromAssets(final String name, final int size, final int fontType, final float kerning, final float antiAliasingFactor) {
        return new UnicodeFontRenderer5(name, fontType, (float)size, kerning, antiAliasingFactor);
    }
    ...
    public static UnicodeFontRenderer5 getInstance() {
        return UnicodeFontRenderer5.instance;
    }
}
