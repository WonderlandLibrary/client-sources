...
public class UnicodeFontRenderer3
{
    public static UnicodeFontRenderer3 instance;
    ...
    private UnicodeFontRenderer3(final String fontName, final int fontType, final float fontSize, final float kerning, final float antiAliasingFactor) {
    ...
    private UnicodeFontRenderer3(final Font font, final float kerning, final float antiAliasingFactor) {
        this.colorCodes = new int[32];
        this.cachedStringWidth = new HashMap<String, Float>();
        this.antiAliasingFactor = antiAliasingFactor;
    ...
    public static UnicodeFontRenderer3 getFontOnPC(final String name, final int size) {
        return getFontOnPC(name, size, 0);
    }
    
    public static UnicodeFontRenderer3 getFontOnPC(final String name, final int size, final int fontType) {
        return getFontOnPC(name, size, fontType, 0.0f);
    }
    
    public static UnicodeFontRenderer3 getFontOnPC(final String name, final int size, final int fontType, final float kerning) {
        return getFontOnPC(name, size, fontType, kerning, 3.0f);
    }
    
    public static UnicodeFontRenderer3 getFontOnPC(final String name, final int size, final int fontType, final float kerning, final float antiAliasingFactor) {
        return new UnicodeFontRenderer3(new Font(name, fontType, size), kerning, antiAliasingFactor);
    }
    
    public static UnicodeFontRenderer3 getFontFromAssets(final String name, final int size) {
        return getFontOnPC(name, size, 0);
    }
    
    public static UnicodeFontRenderer3 getFontFromAssets(final String name, final int size, final int fontType) {
        return getFontOnPC(name, fontType, size, 0.0f);
    }
    
    public static UnicodeFontRenderer3 getFontFromAssets(final String name, final int size, final float kerning, final int fontType) {
        return getFontFromAssets(name, size, fontType, kerning, 3.0f);
    }
    
    public static UnicodeFontRenderer3 getFontFromAssets(final String name, final int size, final int fontType, final float kerning, final float antiAliasingFactor) {
        return new UnicodeFontRenderer3(name, fontType, (float)size, kerning, antiAliasingFactor);
    }
    ...
    public void drawStringScaledShadow(final String text, final int givenX, final int givenY, final int color, final double givenScale, final float x, final float y) {
        GL11.glPushMatrix();
        GL11.glTranslated(givenX, givenY, 0.0);
        GL11.glScaled(givenScale, givenScale, givenScale);
    ...
    public int drawStringWithShadow(final String text, final float x, final float y, final int color) {
        this.drawString(StringUtils.stripControlCodes(text), x + 0.5f, y + 0.5f, new Color(0, 0, 0, 120).getRGB());
    ...
    public void drawReversedCenteredString(final String text, final float x, final float y, final int color) {
        this.drawString(text, x - (int)this.getWidth(text), y, color);
    }
    ...
    public static UnicodeFontRenderer3 getInstance() {
        return UnicodeFontRenderer3.instance;
    }
}
