...
{
    public static UnicodeFontRenderer instance;
    ...
    private Font getFontFromInput(final String path) throws IOException, FontFormatException {
        return Font.createFont(0, Objects.requireNonNull(UnicodeFontRenderer.class.getResourceAsStream(path)));
    }
    ...
    public static UnicodeFontRenderer getInstance() {
        return UnicodeFontRenderer.instance;
    }
}
