...
public class CustomColors
{
    ...
    public static void update() {
        ...
        if (Config.isCustomColors()) {
            ...
            CustomColors.lightMapPacks = pair.getLeft();
    ...
    private static Pair<LightMapPack[], Integer> parseLightMapPacks() {
        ...
        return new ImmutablePair<LightMapPack[], Integer>(alightmappack, j2);
    }
    ...
    private static CustomColormap[] readCustomColormaps(final Properties props, final String fileName) {
        ...
        for (final String s2 : props.keySet()) {
    ...
    private static CustomColormap[][] blockListToArray(final List list) {
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            if (subList != null) {
                final CustomColormap[] acustomcolormap2 = subList.toArray(new CustomColormap[subList.size()]);
