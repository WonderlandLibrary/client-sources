...
public class GuiShaders extends GuiScreenOF
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.screenTitle + " ", GuiShaders.width / 2, 15, 16777215);
        ...
        if (i < GuiShaders.width - 5) {
            this.drawCenteredString(this.fontRendererObj, s, GuiShaders.width / 2, GuiShaders.height - 40, 8421504);
        }
        else {
