...
public class GuiShaderOptions extends GuiScreenOF
{
    ...
    public void initGui() {
        ...
        if (ashaderoption != null) {
            ...
            for (int i3 = 0; i3 < ashaderoption.length; ++i3) {
                ...
                if (shaderoption != null && shaderoption.isVisible()) {
                    final int j3 = i3 % k2;
                    final int k3 = i3 / k2;
                    final int l3 = Math.min(GuiShaderOptions.width / k2, 200);
                    j = (GuiShaderOptions.width - l3 * k2) / 2;
        ...
        this.buttonList.add(new GuiButton(201, GuiShaderOptions.width / 2 - i2 - 20, GuiShaderOptions.height / 6 + 168 + 11, i2, j2, I18n.format("controls.reset", new Object[0])));
        this.buttonList.add(new GuiButton(200, GuiShaderOptions.width / 2 + 20, GuiShaderOptions.height / 6 + 168 + 11, i2, j2, I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(final int x, final int y, final float f) {
        ...
        if (this.screenText != null) {
            this.drawCenteredString(this.fontRendererObj, this.screenText, GuiShaderOptions.width / 2, 15, 16777215);
        }
        else {
            this.drawCenteredString(this.fontRendererObj, this.title, GuiShaderOptions.width / 2, 15, 16777215);
        }
