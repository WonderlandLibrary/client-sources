...
public class GuiScreenCapeOF extends GuiScreenOF
{
    ...
    public void initGui() {
        ...
        i += 2;
        this.buttonList.add(new GuiButtonOF(210, GuiScreenCapeOF.width / 2 - 155, GuiScreenCapeOF.height / 6 + 24 * (i >> 1), 150, 20, I18n.format("of.options.capeOF.openEditor", new Object[0])));
        this.buttonList.add(new GuiButtonOF(220, GuiScreenCapeOF.width / 2 - 155 + 160, GuiScreenCapeOF.height / 6 + 24 * (i >> 1), 150, 20, I18n.format("of.options.capeOF.reloadCape", new Object[0])));
        i += 6;
        this.buttonCopyLink = new GuiButtonOF(230, GuiScreenCapeOF.width / 2 - 100, GuiScreenCapeOF.height / 6 + 24 * (i >> 1), 200, 20, I18n.format("of.options.capeOF.copyEditorLink", new Object[0]));
        this.buttonCopyLink.visible = (this.linkUrl != null);
        this.buttonList.add(this.buttonCopyLink);
        i += 4;
        this.buttonList.add(new GuiButtonOF(200, GuiScreenCapeOF.width / 2 - 100, GuiScreenCapeOF.height / 6 + 24 * (i >> 1), I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRenderer, this.title, GuiScreenCapeOF.width / 2, 20, 16777215);
        if (this.message != null) {
            this.drawCenteredString(this.fontRenderer, this.message, GuiScreenCapeOF.width / 2, GuiScreenCapeOF.height / 6 + 60, 16777215);
