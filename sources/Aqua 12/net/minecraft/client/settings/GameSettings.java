...
public class GameSettings
{
    ...
    public String getKeyBinding(final Options settingOption) {
        ...
        if (settingOption.getEnumFloat()) {
            ...
            return (settingOption == Options.MIPMAP_LEVELS && f1 >= 4.0) ? (s2 + Lang.get("of.general.max")) : ((settingOption == Options.SENSITIVITY) ? ((f2 == 0.0f) ? (s2 + I18n.format("options.sensitivity.min", new Object[0])) : ((f2 == 1.0f) ? (s2 + I18n.format("options.sensitivity.max", new Object[0])) : (s2 + (int)(f2 * 200.0f) + "%"))) : ((settingOption == Options.FOV) ? ((f1 == 70.0f) ? (s2 + I18n.format("options.fov.min", new Object[0])) : ((f1 == 110.0f) ? (s2 + I18n.format("options.fov.max", new Object[0])) : (s2 + (int)f1))) : ((settingOption == Options.FRAMERATE_LIMIT) ? ((f1 == settingOption.valueMax) ? (s2 + I18n.format("options.framerateLimit.max", new Object[0])) : (s2 + (int)f1 + " fps")) : ((settingOption == Options.RENDER_CLOUDS) ? ((f1 == settingOption.valueMin) ? (s2 + I18n.format("options.cloudHeight.min", new Object[0])) : (s2 + ((int)f1 + 128))) : ((settingOption == Options.GAMMA) ? ((f2 == 0.0f) ? (s2 + I18n.format("options.gamma.min", new Object[0])) : ((f2 == 1.0f) ? (s2 + I18n.format("options.gamma.max", new Object[0])) : (s2 + "+" + (int)(f2 * 100.0f) + "%"))) : ((settingOption == Options.SATURATION) ? (s2 + (int)(f2 * 400.0f) + "%") : ((settingOption == Options.CHAT_OPACITY) ? (s2 + (int)(f2 * 90.0f + 10.0f) + "%") : ((settingOption == Options.CHAT_HEIGHT_UNFOCUSED) ? (s2 + GuiNewChat.calculateChatboxHeight(f2) + "px") : ((settingOption == Options.CHAT_HEIGHT_FOCUSED) ? (s2 + GuiNewChat.calculateChatboxHeight(f2) + "px") : ((settingOption == Options.CHAT_WIDTH) ? (s2 + GuiNewChat.calculateChatboxWidth(f2) + "px") : ((settingOption == Options.RENDER_DISTANCE) ? (s2 + (int)f1 + " chunks") : ((settingOption == Options.MIPMAP_LEVELS) ? ((f1 == 0.0f) ? (s2 + I18n.format("options.off", new Object[0])) : (s2 + (int)f1)) : ((settingOption == Options.STREAM_FPS) ? s2 : ((settingOption == Options.STREAM_KBPS) ? (s2 + " Kbps") : ((settingOption == Options.STREAM_BYTES_PER_PIXEL) ? (s2 + String.format("%.3f bpp", 0.0f)) : ((f2 == 0.0f) ? (s2 + I18n.format("options.off", new Object[0])) : (s2 + (int)(f2 * 100.0f) + "%")))))))))))))))));
        }
