...
public class ModelPlayer extends ModelBiped
{
    ...
    public ModelPlayer(final float p_i46304_1_, final boolean p_i46304_2_) {
        ...
        this.customcape = new ModelRenderer(this, 0, 0);
        if (p_i46304_2_) {
    ...
    public void renderCustomCape(final float p_178728_1_, final int textureWidth, final int textureHeight) {
        this.customcape.setTextureSize(textureWidth, textureHeight);
        this.customcape.addBox(-5.0f, 0.0f, -1.0f, 10, 16, 1, 0.0f);
        if (Aqua.moduleManager.getModuleByName("ShaderMultiplier").isToggled()) {}
        if (Aqua.moduleManager.getModuleByName("Shadow").isToggled()) {}
        this.customcape.render(p_178728_1_);
    }
