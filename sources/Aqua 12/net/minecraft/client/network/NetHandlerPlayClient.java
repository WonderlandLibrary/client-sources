...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void addToSendQueue(final Packet packet) {
        try {
            final EventPacketNofall eventPacket1 = new EventPacketNofall(EventPacketNofall.Action.SEND, packet, null, null);
            ...
            final EventBacktrack eventBacktrack = new EventBacktrack(EventBacktrack.Action.SEND, packet, null, null);
            eventBacktrack.setType(EventType.PRE);
            final EventPacket eventPacket2 = new EventPacket(EventPacket.Action.SEND, packet, null, null);
            eventPacket2.setType(EventType.PRE);
            if (Aqua.moduleManager.getModuleByName("Backtrack").isToggled()) {
                Aqua.INSTANCE.onEvent(eventPacket2);
            }
    ...
    public void handleCombatEvent(final S42PacketCombatEvent packetIn) {
        ...
        if (packetIn.eventType == S42PacketCombatEvent.Event.END_COMBAT) {
            final long n = 1000 * packetIn.field_179772_d / 20;
        }
