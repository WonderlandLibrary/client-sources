...
public class PlayerControllerMP
{
    ...
    public boolean clickBlock(final BlockPos loc, final EnumFacing face) {
        ...
        if (this.currentGameType.isCreative()) {
            ...
            if (flag && PlayerControllerMP.curBlockDamageMP == 0.0f) {
            ...
            if (flag && block2.getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.worldObj, loc) >= 1.0f) {
                ...
                PlayerControllerMP.curBlockDamageMP = 0.0f;
                this.stepSoundTickCounter = 0.0f;
                this.mc.theWorld.sendBlockBreakProgress(this.mc.thePlayer.getEntityId(), this.currentBlock, (int)(PlayerControllerMP.curBlockDamageMP * 10.0f) - 1);
            }
        }
        return true;
    }
    ...
    public boolean onPlayerDamageBlock(final BlockPos posBlock, final EnumFacing directionFacing) {
        ...
        PlayerControllerMP.curBlockDamageMP += block.getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.worldObj, posBlock);
        ...
        if (PlayerControllerMP.curBlockDamageMP >= 1.0f) {
            this.isHittingBlock = false;
    ...
    public void syncCurrentPlayItem() {
        ...
        final EventSycItem eventSyncItem = new EventSycItem(i);
        Aqua.INSTANCE.onEvent(eventSyncItem);
