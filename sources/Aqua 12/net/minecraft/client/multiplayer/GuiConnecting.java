...
public class GuiConnecting extends GuiScreen
{
    ...
    private void connect(final String ip, final int port) {
        ...
        if (this.mc.getCurrentServerData().serverIP.equalsIgnoreCase("cubecraft.net")) {
            GuiConnecting.sentinelChecker = true;
            ViaMCP.getInstance().setVersion(340);
        }
        else {
            GuiConnecting.sentinelChecker = false;
        }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.networkManager == null) {
            Aqua.INSTANCE.comfortaa3.drawCenteredString(I18n.format("connect.connecting", new Object[0]), (float)(GuiConnecting.width / 2), (float)(GuiConnecting.height / 2 - 50), 16777215);
        }
        else {
            Aqua.INSTANCE.comfortaa3.drawCenteredString(I18n.format("connect.authorizing", new Object[0]), (float)(GuiConnecting.width / 2), (float)(GuiConnecting.height / 2 - 50), 16777215);
        }
