...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate() {
        Aqua.INSTANCE.onEvent(new EventKillaura());
        Aqua.INSTANCE.onEvent(new EventUpdate());
    ...
    public void onUpdateWalkingPlayer() {
        final EventPreMotion event = new EventPreMotion(this.rotationYaw, this.rotationPitch);
        Aqua.INSTANCE.onEvent(event);
        final EventFakePreMotion event2 = new EventFakePreMotion(this.rotationYaw, this.rotationPitch);
        Aqua.INSTANCE.onEvent(event2);
        ...
        if (this.isCurrentViewEntity()) {
            ...
            if (this.ridingEntity == null) {
                if (flag3 && flag4) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.posX, this.getEntityBoundingBox().minY, this.posZ, EventPreMotion.getYaw(), EventPreMotion.getPitch(), this.onGround));
                }
                else if (flag3) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.onGround));
                }
                else if (flag4) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C05PacketPlayerLook(EventPreMotion.getYaw(), EventPreMotion.getPitch(), this.onGround));
                }
                else {
                ...
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0, this.motionZ, EventPreMotion.getYaw(), EventPreMotion.getPitch(), this.onGround));
                flag3 = false;
            }
    ...
    public void sendChatMessage(final String message) {
        if (!Aqua.commandSystem.execute(message)) {
    ...
    public void onLivingUpdate() {
        ...
        final EventSilentMove eventSilentMove = new EventSilentMove(this.mc.thePlayer.rotationYaw);
        Aqua.INSTANCE.onEvent(eventSilentMove);
        if (eventSilentMove.isSilent()) {
            final float[] floats = eventSilentMove.moveSilent(this.movementInput.moveStrafe, this.movementInput.moveForward);
        ...
        if (this.onGround && !flag2 && !flag3 && this.movementInput.moveForward >= 0.8f && !this.isSprinting() && flag4 && !this.isUsingItem() && !this.isPotionActive(Potion.blindness)) {
        ...
        if (!this.isSprinting() && this.movementInput.moveForward >= 0.8f && flag4 && !this.isUsingItem() && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindSprint.isKeyDown()) {
            this.setSprinting(true);
        }
    ...
    public void moveEntity(double motionX, double motionY, double motionZ) {
        final EventPlayerMove movement = new EventPlayerMove(motionX, motionY, motionZ);
        Aqua.INSTANCE.onEvent(movement);
