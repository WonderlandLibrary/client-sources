...
public class TextureMap extends AbstractTexture implements ITickableTextureObject
{
        ...
        for (final TextureAtlasSprite textureatlassprite3 : this.mapRegisteredSprites.values()) {
            ...
            try {
                ...
                crashreportcategory.addCrashSectionCallable("Sprite size", new Callable<String>() {
                    @Override
                    public String call() throws Exception {
                        return textureatlassprite3.getIconWidth() + " x " + textureatlassprite3.getIconHeight();
                    }
                });
                crashreportcategory.addCrashSectionCallable("Sprite frames", new Callable<String>() {
                    @Override
                    public String call() throws Exception {
                        return textureatlassprite3.getFrameCount() + " frames";
                    }
                });
    ...
    private int detectMinimumSpriteSize(final Map<Object, Object> p_detectMinimumSpriteSize_1_, final IResourceManager p_detectMinimumSpriteSize_2_, final int p_detectMinimumSpriteSize_3_) {
