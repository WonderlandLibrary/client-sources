...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener
{
    ...
    private final Deque visibilityDeque;
    private List<ContainerLocalRenderInformation> renderInfosEntities;
    private List renderInfosTileEntities;
    private final List renderInfosNormal;
    private final List renderInfosEntitiesNormal;
    private final List renderInfosTileEntitiesNormal;
    private final List renderInfosShadow;
    private final List renderInfosEntitiesShadow;
    private final List renderInfosTileEntitiesShadow;
    ...
    private final RenderEnv renderEnv;
    ...
    public void renderEntities(final Entity renderViewEntity, final ICamera camera, final float partialTicks) {
        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            if (this.isRenderEntityOutlines()) {
                ...
                for (int k = 0; k < list.size(); ++k) {
                    ...
                    if ((entity3 != this.mc.getRenderViewEntity() || this.mc.gameSettings.thirdPersonView != 0 || flag3) && flag4) {
                        if (Aqua.moduleManager.getModuleByName("ESP").isToggled() && Aqua.setmgr.getSetting("ESPMode").getCurrentMode().equalsIgnoreCase("Vanilla") && Aqua.setmgr.getSetting("ESPGlow").isState()) {
            ...
            final boolean flag7 = Shaders.isShadowPass && !this.mc.thePlayer.isSpectator();
                ...
                if (!classinheritancemultimap.isEmpty()) {
                    for (final Entity entity4 : classinheritancemultimap) {
                        if (!flag || Reflector.callBoolean(entity4, Reflector.ForgeEntity_shouldRenderInPass, i)) {
                            final boolean flag8 = this.renderManager.shouldRender(entity4, camera, d0, d2, d3) || entity4.riddenByEntity == this.mc.thePlayer;
                            if (flag8) {
                                final boolean flag9 = this.mc.getRenderViewEntity() instanceof EntityLivingBase && ((EntityLivingBase)this.mc.getRenderViewEntity()).isPlayerSleeping();
                                if ((entity4 == this.mc.getRenderViewEntity() && !flag7 && this.mc.gameSettings.thirdPersonView == 0 && !flag9) || (entity4.posY >= 0.0 && entity4.posY < 256.0 && !this.theWorld.isBlockLoaded(new BlockPos(entity4)))) {
                                    continue;
                                }
                                ++this.countEntitiesRendered;
                            ...
                            if (flag8 || !(entity4 instanceof EntityWitherSkull) || (flag && !Reflector.callBoolean(entity4, Reflector.ForgeEntity_shouldRenderInPass, i))) {
                                continue;
                            }
                            this.renderedEntity = entity4;
                            if (flag5) {
                ...
                if (flag2) {
                    ...
                    if (tileentity3 != null && Reflector.callBoolean(tileentity3, Reflector.ForgeTileEntity_shouldRenderInPass, i) && Reflector.callBoolean(tileentity3, Reflector.ForgeTileEntity_canRenderBreaking, new Object[0])) {
                        ...
                        if (axisalignedbb2 != null) {
                            flag10 = camera.isBoundingBoxInFrustum(axisalignedbb2);
                        }
                    }
                }
                else {
                    flag10 = (tileentity3 != null && (block instanceof BlockChest || block instanceof BlockEnderChest || block instanceof BlockSign || block instanceof BlockSkull));
                }
                if (flag10) {
                    if (flag5) {
