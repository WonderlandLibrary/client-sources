...
public class EntityHeartFX extends EntityFX
{
    ...
    protected EntityHeartFX(final World worldIn, final double xCoordIn, final double yCoordIn, final double zCoordIn, final double p_i46354_8_, final double p_i46354_10_, final double p_i46354_12_, final float scale) {
    ...
    public static class AngryVillagerFactory implements IParticleFactory
    {
        ...
        public EntityFX getEntityFX(final int particleID, final World worldIn, final double xCoordIn, final double yCoordIn, final double zCoordIn, final double xSpeedIn, final double ySpeedIn, final double zSpeedIn, final int... p_178902_15_) {
            final EntityFX entityfx = new EntityHeartFX(worldIn, xCoordIn, yCoordIn + 0.5, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
