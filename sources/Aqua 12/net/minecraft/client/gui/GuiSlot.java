...
public abstract class GuiSlot
{
    ...
    public void scissor(final int x, final int y, final int x2, final int y2) {
        final ScaledResolution resolution = new ScaledResolution(this.mc);
        final double factor = resolution.getScaleFactor();
        GL11.glScissor((int)(x * factor), (int)((resolution.getScaledHeight() - y2) * factor), (int)((x2 - x) * factor), (int)((y2 - y) * factor));
    }
