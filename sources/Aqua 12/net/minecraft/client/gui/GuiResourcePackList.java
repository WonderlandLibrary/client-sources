...
public abstract class GuiResourcePackList extends GuiListExtended
{
    ...
    public GuiResourcePackList(final Minecraft mcIn, final int p_i45055_2_, final int p_i45055_3_, final List<ResourcePackListEntry> p_i45055_4_) {
        ...
        final boolean hasListHeaderIn = true;
        final FontRenderer fontRendererObj = mcIn.fontRendererObj;
        this.setHasListHeader(hasListHeaderIn, (int)(FontRenderer.FONT_HEIGHT * 1.5f));
    }
