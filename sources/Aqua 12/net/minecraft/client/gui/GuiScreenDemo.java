...
public class GuiScreenDemo extends GuiScreen
{
    ...
    public void initGui() {
        ...
        final int i = -16;
        this.buttonList.add(new GuiButton(1, GuiScreenDemo.width / 2 - 116, GuiScreenDemo.height / 2 + 62 + i, 114, 20, I18n.format("demo.help.buy", new Object[0])));
        this.buttonList.add(new GuiButton(2, GuiScreenDemo.width / 2 + 2, GuiScreenDemo.height / 2 + 62 + i, 114, 20, I18n.format("demo.help.later", new Object[0])));
    }
