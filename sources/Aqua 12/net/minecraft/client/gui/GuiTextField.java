    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtil.drawRoundedRect2Alpha(this.xPosition - 1, this.yPosition - 1, this.width + 1, this.height + 1, 3.0, new Color(20, 20, 20, 120));
            }
            ...
            if (k != j) {
                ...
                final int p_146188_1_ = k2;
                final int p_146188_2_ = i2 - 1;
                final int p_146188_3_ = l2 - 1;
                final int n = i2 + 1;
                final FontRenderer fontRendererInstance = this.fontRendererInstance;
                this.drawCursorVertical(p_146188_1_, p_146188_2_, p_146188_3_, n + FontRenderer.FONT_HEIGHT);
            }
        }
    }
