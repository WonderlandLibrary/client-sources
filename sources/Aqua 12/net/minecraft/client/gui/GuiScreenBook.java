...
public class GuiScreenBook extends GuiScreen
{
    ...
    public void initGui() {
        ...
        final int i = (GuiScreenBook.width - this.bookImageWidth) / 2;
        final int j = 2;
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            ...
            if (this.field_175386_A == null) {
                ...
                for (int k2 = Math.min(n / FontRenderer.FONT_HEIGHT, this.field_175386_A.size()), l2 = 0; l2 < k2; ++l2) {
                    final IChatComponent ichatcomponent2 = this.field_175386_A.get(l2);
                    final FontRenderer fontRendererObj2 = this.fontRendererObj;
                    final String unformattedText = ichatcomponent2.getUnformattedText();
                    final int x = i + 36;
                    final int n2 = j + 16 + 16;
                    final int n3 = l2;
                    final FontRenderer fontRendererObj3 = this.fontRendererObj;
                    fontRendererObj2.drawString(unformattedText, x, n2 + n3 * FontRenderer.FONT_HEIGHT, 0);
                }
    ...
    public IChatComponent func_175385_b(final int p_175385_1_, final int p_175385_2_) {
        ...
        final int i = p_175385_1_ - (GuiScreenBook.width - this.bookImageWidth) / 2 - 36;
        final int j = p_175385_2_ - 2 - 16 - 16;
        if (i >= 0 && j >= 0) {
            final int n = 128;
            final FontRenderer fontRendererObj = this.fontRendererObj;
            final int k = Math.min(n / FontRenderer.FONT_HEIGHT, this.field_175386_A.size());
            if (i <= 116) {
                final int n2 = j;
                final FontRenderer fontRendererObj2 = this.mc.fontRendererObj;
                if (n2 < FontRenderer.FONT_HEIGHT * k + k) {
                    final int n3 = j;
                    final FontRenderer fontRendererObj3 = this.mc.fontRendererObj;
                    final int l = n3 / FontRenderer.FONT_HEIGHT;
