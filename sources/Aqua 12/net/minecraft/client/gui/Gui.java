...
public class Gui
{
    ...
    public static void drawHollowRect(final double x, final double y, final double width, final double height, final double lineWidth, final int color) {
    ...
    public static void drawRect2(double x1, double y1, double x2, double y2, final int argbColor) {
