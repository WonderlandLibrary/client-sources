...
public class GuiSnooper extends GuiScreen
{
    ...
    {
        public List() {
            final Minecraft mc = GuiSnooper.this.mc;
            final int width = GuiSnooper.width;
            final int height = GuiSnooper.height;
            final int topIn = 80;
            final int bottomIn = GuiSnooper.height - 40;
            final FontRenderer fontRendererObj = GuiSnooper.this.fontRendererObj;
            super(mc, width, height, topIn, bottomIn, FontRenderer.FONT_HEIGHT + 1);
        }
