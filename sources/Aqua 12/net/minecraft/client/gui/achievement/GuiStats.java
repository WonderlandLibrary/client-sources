...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            final String text = GuiStats.lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % GuiStats.lanSearchStates.length)];
            final int x = GuiStats.width / 2;
            final int n = GuiStats.height / 2;
            final FontRenderer fontRendererObj2 = this.fontRendererObj;
            this.drawCenteredString(fontRendererObj, text, x, n + FontRenderer.FONT_HEIGHT * 2, 16777215);
        }
        else {
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        public StatsMobsList(final Minecraft mcIn) {
            final int width = GuiStats.width;
            final int height = GuiStats.height;
            final int topIn = 32;
            final int bottomIn = GuiStats.height - 64;
            GuiStats.this.fontRendererObj;
            super(mcIn, width, height, topIn, bottomIn, FontRenderer.FONT_HEIGHT * 4);
        ...
        protected int getContentHeight() {
            ...
            GuiStats.this.fontRendererObj;
            return size * FontRenderer.FONT_HEIGHT * 4;
        }
        ...
        protected void drawSlot(final int entryID, final int p_180791_2_, final int p_180791_3_, final int p_180791_4_, final int mouseXIn, final int mouseYIn) {
            ...
            final FontRenderer access$1900 = GuiStats.this.fontRendererObj;
            final String text = s2;
            final int x = p_180791_2_ + 2;
            final int n = p_180791_3_ + 1;
            GuiStats.this.fontRendererObj;
            this$0.drawString(access$1900, text, x, n + FontRenderer.FONT_HEIGHT, (i == 0) ? 6316128 : 9474192);
            final GuiStats this$2 = GuiStats.this;
            final FontRenderer access$1901 = GuiStats.this.fontRendererObj;
            final String text2 = s3;
            final int x2 = p_180791_2_ + 2;
            final int n2 = p_180791_3_ + 1;
            GuiStats.this.fontRendererObj;
            this$2.drawString(access$1901, text2, x2, n2 + FontRenderer.FONT_HEIGHT * 2, (j == 0) ? 6316128 : 9474192);
        }
    }
}
