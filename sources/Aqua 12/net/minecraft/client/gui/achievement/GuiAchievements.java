...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        if (this.loadingAchievements) {
            ...
            final String text = GuiAchievements.lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % GuiAchievements.lanSearchStates.length)];
            final int x = GuiAchievements.width / 2;
            final int n = GuiAchievements.height / 2;
            ...
            if (Mouse.isButtonDown(0)) {
                ...
                final int j = (GuiAchievements.height - this.field_146557_g) / 2;
                final int k = i + 8;
                final int l = j + 17;
    ...
    protected void drawAchievementScreen(final int p_146552_1_, final int p_146552_2_, final float p_146552_3_) {
        ...
        final int l = (GuiAchievements.height - this.field_146557_g) / 2;
        final int i2 = k + 16;
        final int j2 = l + 17;
