...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui() {
        ...
        if (this.mc.theWorld != null) {
            ...
            final GuiOptionButton guioptionbutton2 = new GuiOptionButton(GameSettings.Options.REALMS_NOTIFICATIONS.returnEnumOrdinal(), GuiOptions.width / 2 - 155 + i % 2 * 160, GuiOptions.height / 6 - 12 + 24 * (i >> 1), GameSettings.Options.REALMS_NOTIFICATIONS, this.game_settings_1.getKeyBinding(GameSettings.Options.REALMS_NOTIFICATIONS));
