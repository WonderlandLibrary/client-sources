...
public class GuiWinGame extends GuiScreen
{
    ...
    public void updateScreen() {
        final MusicTicker musicticker = this.mc.getMusicTicker();
        ...
        soundhandler.update();
        ++this.field_146581_h;
        final float f = (this.field_146579_r + GuiWinGame.height + GuiWinGame.height + 24) / this.field_146578_s;
    ...
    private void drawWinGameScreen(final int p_146575_1_, final int p_146575_2_, final float p_146575_3_) {
        ...
        final float f2 = GuiWinGame.height - (this.field_146581_h + p_146575_3_) * 0.5f * this.field_146578_s;
        final float f3 = 0.015625f;
        float f4 = (this.field_146581_h + p_146575_3_ - 0.0f) * 0.02f;
        final float f5 = (this.field_146579_r + GuiWinGame.height + GuiWinGame.height + 24) / this.field_146578_s;
        ...
        f4 *= f4;
        f4 = f4 * 96.0f / 255.0f;
        worldrenderer.pos(0.0, GuiWinGame.height, GuiWinGame.zLevel).tex(0.0, f * f3).color(f4, f4, f4, 1.0f).endVertex();
        worldrenderer.pos(i, GuiWinGame.height, GuiWinGame.zLevel).tex(i * f3, f * f3).color(f4, f4, f4, 1.0f).endVertex();
