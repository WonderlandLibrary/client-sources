...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    private void func_175325_f() {
        ...
        this.field_175349_r = new GuiPageButtonList(this.mc, GuiCustomizeWorldScreen.width, GuiCustomizeWorldScreen.height, 32, GuiCustomizeWorldScreen.height - 32, 25, this, new GuiPageButtonList.GuiListEntry[][] { aguipagebuttonlist$guilistentry, aguipagebuttonlist$guilistentry2, aguipagebuttonlist$guilistentry3, aguipagebuttonlist$guilistentry4 });
        for (int i = 0; i < 4; ++i) {
