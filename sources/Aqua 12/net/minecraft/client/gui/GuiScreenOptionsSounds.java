...
public class GuiScreenOptionsSounds extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new Button(SoundCategory.MASTER.getCategoryId(), GuiScreenOptionsSounds.width / 2 - 155 + i % 2 * 160, GuiScreenOptionsSounds.height / 6 - 12 + 24 * (i >> 1), SoundCategory.MASTER, true));
        i += 2;
        for (final SoundCategory soundcategory : SoundCategory.values()) {
            if (soundcategory != SoundCategory.MASTER) {
                this.buttonList.add(new Button(soundcategory.getCategoryId(), GuiScreenOptionsSounds.width / 2 - 155 + i % 2 * 160, GuiScreenOptionsSounds.height / 6 - 12 + 24 * (i >> 1), soundcategory, false));
                ++i;
            }
        }
