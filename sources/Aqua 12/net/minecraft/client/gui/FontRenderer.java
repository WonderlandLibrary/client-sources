...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    protected void doDraw(final float p_doDraw_1_) {
        if (this.strikethroughStyle) {
            ...
            worldrenderer.pos(this.posX, this.posY + FontRenderer.FONT_HEIGHT / 2, 0.0).endVertex();
            worldrenderer.pos(this.posX + p_doDraw_1_, this.posY + FontRenderer.FONT_HEIGHT / 2, 0.0).endVertex();
            worldrenderer.pos(this.posX + p_doDraw_1_, this.posY + FontRenderer.FONT_HEIGHT / 2 - 1.0f, 0.0).endVertex();
            worldrenderer.pos(this.posX, this.posY + FontRenderer.FONT_HEIGHT / 2 - 1.0f, 0.0).endVertex();
            tessellator.draw();
        ...
        if (this.underlineStyle) {
            ...
            worldrenderer2.pos(this.posX + i, this.posY + FontRenderer.FONT_HEIGHT, 0.0).endVertex();
            worldrenderer2.pos(this.posX + p_doDraw_1_, this.posY + FontRenderer.FONT_HEIGHT, 0.0).endVertex();
            worldrenderer2.pos(this.posX + p_doDraw_1_, this.posY + FontRenderer.FONT_HEIGHT - 1.0f, 0.0).endVertex();
            worldrenderer2.pos(this.posX + i, this.posY + FontRenderer.FONT_HEIGHT - 1.0f, 0.0).endVertex();
            tessellator2.draw();
            GlStateManager.enableTexture2D();
        }
    ...
    public int splitStringWidth(final String str, final int maxLength) {
        return FontRenderer.FONT_HEIGHT * this.listFormattedStringToWidth(str, maxLength).size();
    }
