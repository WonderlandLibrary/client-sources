...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    @Override
    public void initGui() {
        if (Aqua.moduleManager.getModuleByName("AutoEnable").isToggled()) {
            if (Aqua.setmgr.getSetting("AutoEnableVelocity").isState()) {
                Aqua.moduleManager.getModuleByName("Velocity").setState(true);
            }
            if (Aqua.setmgr.getSetting("AutoEnableBlur").isState()) {
                Aqua.moduleManager.getModuleByName("Blur").setState(true);
            }
            if (Aqua.setmgr.getSetting("AutoEnableShadow").isState()) {
                Aqua.moduleManager.getModuleByName("Shadow").setState(true);
            }
            if (Aqua.setmgr.getSetting("AutoEnableArraylist").isState()) {
                Aqua.moduleManager.getModuleByName("Arraylist").setState(true);
            }
            if (Aqua.setmgr.getSetting("AutoEnableShaderMultiplier").isState()) {
                Aqua.moduleManager.getModuleByName("ShaderMultiplier").setState(true);
            }
            if (Aqua.setmgr.getSetting("AutoEnableShaderESP").isState()) {
                Aqua.moduleManager.getModuleByName("ShaderESP").setState(true);
            }
        }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Aqua.INSTANCE.comfortaa3.drawCenteredString(I18n.format("multiplayer.title", new Object[0]), (float)(GuiMultiplayer.width / 2), 20.0f, 16777215);
