...
public class GuiCommandBlock extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final int x = GuiCommandBlock.width / 2 - 150;
        final int n = i;
        final int n2 = j++;
        final FontRenderer fontRendererObj2 = this.fontRendererObj;
        this.drawString(fontRendererObj, format, x, n + n2 * FontRenderer.FONT_HEIGHT, 10526880);
        ...
        final int x2 = GuiCommandBlock.width / 2 - 150;
        final int n3 = i;
        final int n4 = j++;
        final FontRenderer fontRendererObj4 = this.fontRendererObj;
        this.drawString(fontRendererObj3, format2, x2, n3 + n4 * FontRenderer.FONT_HEIGHT, 10526880);
        final FontRenderer fontRendererObj5 = this.fontRendererObj;
        final String format3 = I18n.format("advMode.allPlayers", new Object[0]);
        final int x3 = GuiCommandBlock.width / 2 - 150;
        final int n5 = i;
        final int n6 = j++;
        final FontRenderer fontRendererObj6 = this.fontRendererObj;
        this.drawString(fontRendererObj5, format3, x3, n5 + n6 * FontRenderer.FONT_HEIGHT, 10526880);
        ...
        final int x4 = GuiCommandBlock.width / 2 - 150;
        final int n7 = i;
        final int n8 = j++;
        final FontRenderer fontRendererObj8 = this.fontRendererObj;
        this.drawString(fontRendererObj7, format4, x4, n7 + n8 * FontRenderer.FONT_HEIGHT, 10526880);
        final FontRenderer fontRendererObj9 = this.fontRendererObj;
        final String text = "";
        final int x5 = GuiCommandBlock.width / 2 - 150;
        final int n9 = i;
        final int n10 = j++;
        final FontRenderer fontRendererObj10 = this.fontRendererObj;
        this.drawString(fontRendererObj9, text, x5, n9 + n10 * FontRenderer.FONT_HEIGHT, 10526880);
        if (this.previousOutputTextField.getText().length() > 0) {
            final int n11 = i;
            final int n12 = j;
            final FontRenderer fontRendererObj11 = this.fontRendererObj;
            i = n11 + n12 * FontRenderer.FONT_HEIGHT + 16;
