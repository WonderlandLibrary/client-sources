...
public class ServerListEntryLanScan implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
        ...
        final int i = n - FontRenderer.FONT_HEIGHT / 2;
        ...
        fontRendererObj2.drawString(format, GuiScreen.width / 2 - this.mc.fontRendererObj.getStringWidth(I18n.format("lanServer.scanning", new Object[0])) / 2, i, 16777215);
        String s = null;
        ...
        final int x2 = GuiScreen.width / 2 - this.mc.fontRendererObj.getStringWidth(s) / 2;
        final int n2 = i;
        final FontRenderer fontRendererObj4 = this.mc.fontRendererObj;
        fontRendererObj3.drawString(text, x2, n2 + FontRenderer.FONT_HEIGHT, 8421504);
    }
