...
public class GuiVideoSettings extends GuiScreenOF
{
    ...
    public void initGui() {
        ...
        for (int i = 0; i < GuiVideoSettings.videoOptions.length; ++i) {
            ...
            if (gamesettings$options != null) {
                final int j = GuiVideoSettings.width / 2 - 155 + i % 2 * 160;
                final int k = GuiVideoSettings.height / 6 + 21 * (i / 2) - 12;
        ...
        int l = GuiVideoSettings.height / 6 + 21 * (GuiVideoSettings.videoOptions.length / 2) - 12;
        int i2 = 0;
        i2 = GuiVideoSettings.width / 2 - 155 + 0;
        this.buttonList.add(new GuiOptionButton(231, i2, l, Lang.get("of.options.shaders")));
        i2 = GuiVideoSettings.width / 2 - 155 + 160;
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.screenTitle, GuiVideoSettings.width / 2, 15, 16777215);
        ...
        this.drawString(this.fontRendererObj, s, 2, GuiVideoSettings.height - 10, 8421504);
        final String s3 = "Minecraft 1.8.9";
        final int i = this.fontRendererObj.getStringWidth(s3);
        this.drawString(this.fontRendererObj, s3, GuiVideoSettings.width - i - 2, GuiVideoSettings.height - 10, 8421504);
