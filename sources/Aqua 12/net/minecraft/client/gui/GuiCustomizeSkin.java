...
public class GuiCustomizeSkin extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButtonOF(210, GuiCustomizeSkin.width / 2 - 100, GuiCustomizeSkin.height / 6 + 24 * (i >> 1), I18n.format("of.options.skinCustomisation.ofCape", new Object[0])));
        i += 2;
