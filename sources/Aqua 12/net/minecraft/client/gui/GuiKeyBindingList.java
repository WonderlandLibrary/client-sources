...
public class GuiKeyBindingList extends GuiListExtended
{
    ...
    public class CategoryEntry implements IGuiListEntry
    {
        ...
        public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
            ...
            final int x2 = GuiScreen.width / 2 - this.labelWidth / 2;
            final int n = y + slotHeight;
            final FontRenderer fontRendererObj2 = GuiKeyBindingList.this.mc.fontRendererObj;
            fontRendererObj.drawString(labelText, x2, n - FontRenderer.FONT_HEIGHT - 1, 16777215);
        }
    ...
    public class KeyEntry implements IGuiListEntry
    {
        ...
        public void drawEntry(final int slotIndex, final int x, final int y, final int listWidth, final int slotHeight, final int mouseX, final int mouseY, final boolean isSelected) {
            ...
            final FontRenderer fontRendererObj = GuiKeyBindingList.this.mc.fontRendererObj;
            final String keyDesc = this.keyDesc;
            final int x2 = x + 90 - GuiKeyBindingList.this.maxListLabelWidth;
            final int n = y + slotHeight / 2;
            final FontRenderer fontRendererObj2 = GuiKeyBindingList.this.mc.fontRendererObj;
            fontRendererObj.drawString(keyDesc, x2, n - FontRenderer.FONT_HEIGHT / 2, 16777215);
