    ...
    public void initGui() {
        ...
        for (final GameSettings.Options gamesettings$options : ScreenChatOptions.field_146399_a) {
            if (gamesettings$options.getEnumFloat()) {
                ...
                this.buttonList.add(new GuiOptionButton(gamesettings$options.returnEnumOrdinal(), ScreenChatOptions.width / 2 - 155 + i % 2 * 160, ScreenChatOptions.height / 6 + 24 * (i >> 1), gamesettings$options, this.game_settings.getKeyBinding(gamesettings$options)));
            }
            ++i;
        }
