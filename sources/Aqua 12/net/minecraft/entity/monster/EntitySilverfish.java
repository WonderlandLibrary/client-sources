    ...
    static class AIHideInStone extends EntityAIWander
    {
        ...
        public boolean shouldExecute() {
            ...
            if (random.nextInt(10) == 0) {
                ...
                final BlockPos blockpos = new BlockPos(this.silverfish.posX, this.silverfish.posY + 0.5, this.silverfish.posZ).offset(this.facing);
                final IBlockState iblockstate = this.silverfish.worldObj.getBlockState(blockpos);
