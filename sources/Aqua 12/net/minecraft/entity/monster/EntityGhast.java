...
public class EntityGhast extends EntityFlying implements IMob
{
    ...
    protected void dropFewItems(final boolean wasRecentlyHit, final int lootingModifier) {
        ...
        for (int i = this.rand.nextInt(3) + this.rand.nextInt(1 + lootingModifier), k = 0; k < i; ++k) {
    ...
    static class AILookAround extends EntityAIBase
    {
        ...
        public void updateTask() {
            if (this.parentEntity.getAttackTarget() == null) {
                ...
                final float n = -(float)MathHelper.atan2(this.parentEntity.motionX, this.parentEntity.motionZ) * 180.0f / 3.1415927f;
                ...
                if (entitylivingbase.getDistanceSqToEntity(this.parentEntity) < d0 * d0) {
                    ...
                    final float n2 = -(float)MathHelper.atan2(d2, d3) * 180.0f / 3.1415927f;
