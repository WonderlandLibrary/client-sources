...
public class EntityAIAvoidEntity<T extends Entity> extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        final List<T> list = this.theEntity.worldObj.getEntitiesWithinAABB((Class<? extends T>)this.classToAvoid, this.theEntity.getEntityBoundingBox().expand(this.avoidDistance, 3.0, this.avoidDistance), Predicates.and(EntitySelectors.NOT_SPECTATING, this.canBeSeenSelector, this.avoidTargetSelector));
        if (list.isEmpty()) {
            return false;
        }
