...
public class EntityAIFindEntityNearestPlayer extends EntityAIBase
{
    ...
    public boolean shouldExecute() {
        ...
        final List<EntityPlayer> list = this.entityLiving.worldObj.getEntitiesWithinAABB((Class<? extends EntityPlayer>)EntityPlayer.class, this.entityLiving.getEntityBoundingBox().expand(d0, 4.0, d0), (Predicate<? super EntityPlayer>)this.predicate);
