...
public abstract class EntityLivingBase extends Entity
{
    ...
    public AxisAlignedBB realBoundingBox;
    ...
    private int getArmSwingAnimationEnd() {
        ...
        return this.isPotionActive(Potion.digSpeed) ? (6 - (1 + this.getActivePotionEffect(Potion.digSpeed).getAmplifier())) : ((int)(this.isPotionActive(Potion.digSlowdown) ? ((float)(6 + (1 + this.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2)) : HeldItem.hitSpeed));
    }
    ...
    protected void jump() {
        ...
        if (this.isSprinting()) {
            if (Aqua.setmgr.getSetting("KillauraJumpFix").isState() && Killaura.target != null) {
                final float f = EventPreMotion.getYaw() * 0.017453292f;
