...
public class EntityArrow extends Entity implements IProjectile
{
    ...
    public EntityArrow(final World worldIn, final EntityLivingBase shooter, final EntityLivingBase target, final float velocity, final float innacuracy) {
        super(worldIn);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
        ...
        final double d2 = target.getEntityBoundingBox().minY + target.height / 3.0f - this.posY;
        final double d3 = target.posZ - shooter.posZ;
        ...
        if (d4 >= 1.0E-7) {
            ...
            this.setThrowableHeading(d0, d2 + f3, d3, velocity, innacuracy);
        }
    }
    ...
    public void setVelocity(final double x, final double y, final double z) {
        ...
        if (this.prevRotationPitch == 0.0f && this.prevRotationYaw == 0.0f) {
            ...
            this.rotationYaw = n;
            this.prevRotationYaw = n;
            final float n2 = (float)(MathHelper.atan2(y, f) * 180.0 / 3.141592653589793);
            this.rotationPitch = n2;
            this.prevRotationPitch = n2;
    ...
    public void onUpdate() {
        ...
        if (this.inGround) {
            ...
            this.rotationYaw = (float)(MathHelper.atan2(this.motionX, this.motionZ) * 180.0 / 3.141592653589793);
            this.rotationPitch = (float)(MathHelper.atan2(this.motionY, f6) * 180.0 / 3.141592653589793);
