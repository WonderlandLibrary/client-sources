...
public class CommandEffect extends CommandBase
{
    ...
    public List<String> addTabCompletionOptions(final ICommandSender sender, final String[] args, final BlockPos pos) {
        return (args.length == 1) ? CommandBase.getListOfStringsMatchingLastWord(args, this.getAllUsernames()) : ((args.length == 2) ? CommandBase.getListOfStringsMatchingLastWord(args, Potion.getPotionLocations()) : ((args.length == 5) ? CommandBase.getListOfStringsMatchingLastWord(args, "true", "false") : null));
    }
