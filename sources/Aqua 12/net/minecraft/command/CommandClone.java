...
public class CommandClone extends CommandBase
{
    ...
    public void processCommand(final ICommandSender sender, final String[] args) throws CommandException {
        ...
        for (final StaticCloneData commandclone$staticclonedata3 : list2) {
            ...
            if (commandclone$staticclonedata3.compound != null && tileentity4 != null) {
                ...
                tileentity4.readFromNBT(commandclone$staticclonedata3.compound);
        ...
        for (final StaticCloneData commandclone$staticclonedata4 : list5) {
            world.notifyNeighborsRespectDebug(commandclone$staticclonedata4.pos, commandclone$staticclonedata4.blockState.getBlock());
        }
