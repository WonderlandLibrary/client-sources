...
public abstract class CommandBase implements ICommand
{
    ...
    public static Entity getEntity(final ICommandSender p_175768_0_, final String p_175768_1_) throws EntityNotFoundException {
    ...
    public static List<Entity> func_175763_c(final ICommandSender p_175763_0_, final String p_175763_1_) throws EntityNotFoundException {
        return PlayerSelector.hasArguments(p_175763_1_) ? PlayerSelector.matchEntities(p_175763_0_, p_175763_1_, (Class<? extends Entity>)Entity.class) : Lists.newArrayList(getEntity(p_175763_0_, p_175763_1_));
    }
