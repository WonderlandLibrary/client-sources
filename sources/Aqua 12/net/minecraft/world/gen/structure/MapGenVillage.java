...
public class MapGenVillage extends MapGenStructure
{
    ...
    public static class Start extends StructureStart
    {
        ...
        public Start(final World worldIn, final Random rand, final int x, final int z, final int size) {
            ...
            final StructureVillagePieces.Start structurevillagepieces$start = new StructureVillagePieces.Start(worldIn.getWorldChunkManager(), 0, rand, (x << 4) + 2, (z << 4) + 2, list, size);
