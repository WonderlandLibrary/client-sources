    ...
    protected boolean isLiquidInStructureBoundingBox(final World worldIn, final StructureBoundingBox boundingboxIn) {
        ...
        for (int k2 = i; k2 <= l; ++k2) {
            for (int l2 = k; l2 <= j2; ++l2) {
                if (worldIn.getBlockState(blockpos$mutableblockpos.set(k2, j, l2)).getBlock().getMaterial().isLiquid()) {
                    return true;
                }
                if (worldIn.getBlockState(blockpos$mutableblockpos.set(k2, i2, l2)).getBlock().getMaterial().isLiquid()) {
                    return true;
                }
            }
        }
        for (int i3 = i; i3 <= l; ++i3) {
            for (int k3 = j; k3 <= i2; ++k3) {
                if (worldIn.getBlockState(blockpos$mutableblockpos.set(i3, k3, k)).getBlock().getMaterial().isLiquid()) {
                    return true;
                }
                if (worldIn.getBlockState(blockpos$mutableblockpos.set(i3, k3, j2)).getBlock().getMaterial().isLiquid()) {
                    return true;
                }
            }
        }
        for (int j3 = k; j3 <= j2; ++j3) {
            for (int l3 = j; l3 <= i2; ++l3) {
                if (worldIn.getBlockState(blockpos$mutableblockpos.set(i, l3, j3)).getBlock().getMaterial().isLiquid()) {
                    return true;
                }
                if (worldIn.getBlockState(blockpos$mutableblockpos.set(l, l3, j3)).getBlock().getMaterial().isLiquid()) {
                    return true;
                }
            }
        }
