...
public class BiomeGenSnow extends BiomeGenBase
{
    ...
    public BiomeGenSnow(final int id, final boolean p_i45378_2_) {
        super(id);
    ...
    protected BiomeGenBase createMutatedBiome(final int p_180277_1_) {
        final BiomeGenBase biomegenbase = new BiomeGenSnow(p_180277_1_, true).func_150557_a(13828095, true).setBiomeName(this.biomeName + " Spikes").setEnableSnow().setTemperatureRainfall(0.0f, 0.5f).setHeight(new Height(this.minHeight + 0.1f, this.maxHeight + 0.1f));
