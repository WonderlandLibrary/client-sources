...
public class BiomeGenMesa extends BiomeGenBase
{
    ...
    public BiomeGenMesa(final int id, final boolean p_i45380_2_, final boolean p_i45380_3_) {
        super(id);
    ...
    public void genTerrainBlocks(final World worldIn, final Random rand, final ChunkPrimer chunkPrimerIn, final int x, final int z, final double noiseVal) {
        ...
        if (this.field_150626_aH) {
            ...
            final double d5 = Math.min(Math.abs(noiseVal), this.field_150623_aE.func_151601_a(i * 0.25, j * 0.25));
            if (d5 > 0.0) {
        ...
        final int j2 = x & 0xF;
        final int k1 = z & 0xF;
        final int l1 = worldIn.getSeaLevel();
                ...
                if (iblockstate3.getBlock().getMaterial() == Material.air) {
                    ...
                    if (l2 == -1) {
                        ...
                        if (i2 < l1 - 1) {
                            ...
                            if (i2 >= 64 && i2 <= 127) {
                                if (flag) {
                                    ...
                                    iblockstate4 = this.func_180629_a(x, i2, z);
                                }
                            }
                            else {
                        ...
                        if (flag2) {
                            ...
                            final IBlockState iblockstate5 = this.func_180629_a(x, i2, z);
