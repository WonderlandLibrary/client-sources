...
{
    public static final String unusedString;
    ...
    public static int getLiquidColor(final int dataValue, final boolean bypassCache) {
        final Integer integer = IntegerCache.getInteger(dataValue);
        if (bypassCache) {
    ...
    private static int getPotionEffect(final boolean p_77904_0_, final boolean p_77904_1_, final boolean p_77904_2_, final int p_77904_3_, final int p_77904_4_, final int p_77904_5_, final int p_77904_6_) {
        int i = 0;
        if (p_77904_0_) {
            ...
            if (k < 0 || k >= p_77912_2_) {
                ...
                for (int k2 = p_77912_1_; k2 < p_77912_2_; ++k2) {
                    ...
                    if (c0 >= '0' && c0 <= '9') {
                        ...
                        if (flag3) {
                            j3 += getPotionEffect(flag4, flag2, flag5, m, l2, i2, p_77912_3_);
                            flag4 = false;
                            flag5 = false;
                            flag = false;
                            flag2 = false;
    ...
    public static int getPotionPrefixIndexFlags(final int p_77908_0_, final int p_77908_1_, final int p_77908_2_, final int p_77908_3_, final int p_77908_4_, final int p_77908_5_) {
