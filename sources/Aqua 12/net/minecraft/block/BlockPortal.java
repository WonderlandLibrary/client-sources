...
public class BlockPortal extends BlockBreakable
{
    ...
    public BlockPattern.PatternHelper func_181089_f(final World p_181089_1_, final BlockPos p_181089_2_) {
        ...
        return new BlockPattern.PatternHelper((enumfacing.getAxisDirection() == enumfacing$axisdirection2) ? blockpos : blockpos.offset(blockportal$size.field_150866_c, blockportal$size.func_181101_b() - 1), EnumFacing.getFacingFromAxis(enumfacing$axisdirection2, enumfacing$axis), EnumFacing.UP, loadingcache, blockportal$size.func_181101_b(), blockportal$size.func_181100_a(), 1);
    }
