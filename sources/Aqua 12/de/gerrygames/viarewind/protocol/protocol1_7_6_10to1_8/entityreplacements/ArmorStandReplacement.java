...
public class ArmorStandReplacement implements EntityReplacement
{
    ...
    private void updateHologramLocation() {
        ...
        final PacketWrapper teleportSkull = PacketWrapper.create(ClientboundPackets1_7.ENTITY_TELEPORT, null, this.user);
        ...
        teleportSkull.write(Type.BYTE, (Byte)0);
        final PacketWrapper teleportHorse = PacketWrapper.create(ClientboundPackets1_7.ENTITY_TELEPORT, null, this.user);
    ...
    private void spawnHologram() {
        ...
        final PacketWrapper spawnSkull = PacketWrapper.create(ClientboundPackets1_7.SPAWN_ENTITY, null, this.user);
        ...
        final PacketWrapper spawnHorse = PacketWrapper.create(ClientboundPackets1_7.SPAWN_MOB, null, this.user);
