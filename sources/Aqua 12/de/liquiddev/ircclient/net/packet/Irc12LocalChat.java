...
public class Irc12LocalChat implements IrcPacket
{
    ...
    public void handle(final _ircIllIllIIlI connection) {
        connection._ircIllIllIIlI().getApiManager().onLocalPlayerChatMessage(this.player, this.clientType, this.message);
    }
}
