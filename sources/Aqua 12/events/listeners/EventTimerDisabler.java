...
public class EventTimerDisabler extends Event
{
    ...
    public EventTimerDisabler(final Action action, final Packet packet, final INetHandler netHandler, final EnumPacketDirection direction) {
    ...
    public static Packet getPacket() {
        return EventTimerDisabler.packet;
    }
