...
public class EventBacktrack extends Event
{
    ...
    public EventBacktrack(final Action action, final Packet packet, final INetHandler netHandler, final EnumPacketDirection direction) {
