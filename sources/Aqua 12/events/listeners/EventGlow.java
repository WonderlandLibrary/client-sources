...
public class EventGlow extends Event
{
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof EventGlow)) {
            return false;
        }
        final EventGlow other = (EventGlow)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof EventGlow;
    }
    ...
    public String toString() {
        return "EventGlow(runnable=" + this.getRunnable() + ", cancelled=" + this.isCancelled() + ")";
    }
    
    public EventGlow(final Runnable runnable) {
