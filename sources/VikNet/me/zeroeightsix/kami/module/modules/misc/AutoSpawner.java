 ...
 * Please ignore the code structure lol, its so messy but i dont care since this module wont grow in size anymore.
 */
...
public class AutoSpawner extends Module {
    ...
    protected void onEnable() {
        ...
        if (debug.getValue()) {
            ...
            Command.sendChatMessage("[AutoSpawner] Active, mode: " + entityMode.getValue().toString());
        }
    ...
    public void onUpdate() {
        ...
        if (buildStage == 1) {
            ...
            List<BlockPos> blockPosList = BlockInteractionHelper.getSphere(mc.player.getPosition().down(), placeRange.getValue(), placeRange.getValue().intValue(), false, true, 0);

            // TODO: sort blockPosList to check positions behind the player first?
