...
public class AntiSpam extends Module {
    ...
    private Setting<Boolean> discordLinks = register(Settings.b("Discord Links", false));
    private Setting<Boolean> webLinks = register(Settings.b("Web Links", false));
    private Setting<Boolean> announcers = register(Settings.b("Announcers", false));
    private Setting<Boolean> spammers = register(Settings.b("Announcers", false));
    private Setting<Boolean> insulters = register(Settings.b("Insulters", false));
    private Setting<Boolean> greeters = register(Settings.b("Greeters", false));
    private Setting<Boolean> tradeChat = register(Settings.b("Trade Chat", false));
    private Setting<Boolean> numberSuffix = register(Settings.b("Number Suffix", false));
    private Setting<Boolean> duplicates = register(Settings.b("Duplicates", false));
    ...
    private Setting<Boolean> debug = register(Settings.b("Debug Messages", false));
    ...
    public Listener<PacketEvent.Receive> listener = new Listener<>(event -> {
        ...
        // Servers do not seem to set the ChatType.CHAT enum for chat messages >:(
