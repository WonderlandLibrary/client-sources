 ...
 * Updated by Memeszz
 * autofeetplace made into autoechest by vik
 */
...
public class AutoEchest extends Module {
    ...
    private Setting<Integer> blocksPerTick = register(Settings.integerBuilder("BlocksPerTick").withMinimum(1).withValue(8).withMaximum(9).build());
    ...
    public void onUpdate() {
        ...
        while (blocksPlaced < blocksPerTick.getValue()) {
            ...
            if (mode.getValue().equals(Mode.ECHEST12)) {
    ...
    private static class Offsets {
        ...
        private static final Vec3d[] ECHEST12 = {
                new Vec3d(1, 0, 0),
                new Vec3d(0, 0, 1),
                new Vec3d(-1, 0, 0),
                new Vec3d(0, 0, -1),
