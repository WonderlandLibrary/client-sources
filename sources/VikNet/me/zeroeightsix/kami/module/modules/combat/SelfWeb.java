 ...
 * Updated by Memeszz
 * autofeetplace made into SelfWeb by Viktisen @ 18 April 2020
 */
@Module.Info(name = "SelfWeb", category = Module.Category.COMBAT)
public class SelfWeb extends Module {

    private Setting<Mode> mode = register(Settings.e("Mode", Mode.WEB1));
    ...
    private Setting<Integer> blocksPerTick = register(Settings.integerBuilder("BlocksPerTick").withMinimum(1).withValue(10).withMaximum(20).build());
    ...
    protected void onEnable() {
        ...
        if (announceUsage.getValue()) {
            Command.sendChatMessage("[SelfWeb] " + ChatFormatting.GREEN.toString() + "ON!");
        }
    ...
    protected void onDisable() {
        ...
        if (announceUsage.getValue()) {
            Command.sendChatMessage("[SelfWeb] " + ChatFormatting.RED.toString() + "OFF!");
        }
    ...
    public void onUpdate() {
        ...
        while (blocksPlaced < blocksPerTick.getValue()) {
            ...
            if (mode.getValue().equals(Mode.WEB1)) {
    ...
    private static class Offsets {
        ...
        private static final Vec3d[] WEB1 = {
                new Vec3d(0, 0, 0),
