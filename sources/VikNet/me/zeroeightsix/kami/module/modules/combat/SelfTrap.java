 ...
 * Updated by Memeszz
 * autofeetplace made into selftrap by vik11111111
 */
@Module.Info(name = "SelfTrap", category = Module.Category.COMBAT)
public class SelfTrap extends Module {

        private Setting<Mode> mode = register(Settings.e("Mode", Mode.Hook));
        private Setting<Boolean> triggerable = register(Settings.b("Triggerable", false));
        private Setting<Boolean> autoCenter = register(Settings.b("TpCenter", true));
        ...
        private Setting<Integer> blocksPerTick = register(Settings.integerBuilder("BlocksPerTick").withMinimum(1).withValue(8).withMaximum(20).build());
        ...
        protected void onEnable() {
                ...
                if (announceUsage.getValue()) {
                        Command.sendChatMessage("[SelfTrap] " + ChatFormatting.GREEN.toString() + "ON");
                }
        ...
        protected void onDisable() {
                ...
                if (announceUsage.getValue()) {
                        Command.sendChatMessage("[SelfTrap] " + ChatFormatting.RED.toString() + "OFF");
                }
        ...
        private static class Offsets {
                ...
                private static final Vec3d[] Hook = {
                        new Vec3d(0, 1, -1),
                        new Vec3d(0, 2, -1),
                        new Vec3d(0, 2, 0),
                };

                private static final Vec3d[] UP1 = {
                        new Vec3d(0, 2, 0),
                };

                private static final Vec3d[] FULLHOOK = {
                        new Vec3d(0, 1, -1),
                        new Vec3d(0, 2, -1),
                        new Vec3d(0, 2, 0),
                        new Vec3d(1, 0, 0),
