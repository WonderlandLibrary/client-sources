...
public class ElementModuleButton extends Element
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float button) {
        ...
        RenderHelper.drawBorderedCorneredRect(this.getX(), this.getY() + 4, this.getX() + this.getWidth(), this.getY() + 17, 1.0f, -16777216, this.getEnabled() ? -862535474 : Integer.MIN_VALUE);
        if (this.isHovering(mouseX, mouseY)) {
            RenderHelper.drawRect(this.getX(), this.getY() + 4, this.getX() + this.getWidth(), this.getY() + 17, -2130706433);
        }
        ...
        if (this.extra) {
            RenderHelper.drawBorderedCorneredRect(this.getX() + this.getWidth() + 6, this.getY() + 3, this.getX() + this.getWidth() + this.textWidth + 28.0f, this.boxy + 2, 1.0f, -587202560, -580294295);
            this.textWidth = 0.0f;
            this.boxy = 0;
                ...
                if (dropDown.getValue().getModule().equals(this.module)) {
                    ...
                    if (dropDown.isOpen()) {
                        for (int i = 0; i < dropDown.getValue().getStringValues().length; ++i) {
                            ...
                            RenderHelper.drawBorderedCorneredRect(this.x + this.getWidth() + 12, boxy + 24, this.x + this.getWidth() + 4 + dropDown.getWidth(), boxy + dropDown.getHeight() + 16, 1.0f, Integer.MIN_VALUE, dropDown.getValue().getStringValue().equals(dropDown.getValue().getStringValues()[i]) ? -2137603890 : -2145049307);
                            if (RenderHelper.isHovering(this.x + this.getWidth() + 12, boxy + 24, this.x + this.getWidth() + 4 + dropDown.getWidth(), boxy + dropDown.getHeight() + 16, mouseX, mouseY)) {
                                RenderHelper.drawRect(this.x + this.getWidth() + 12, boxy + 24, this.x + this.getWidth() + 4 + dropDown.getWidth(), boxy + dropDown.getHeight() + 16, 1627389951);
