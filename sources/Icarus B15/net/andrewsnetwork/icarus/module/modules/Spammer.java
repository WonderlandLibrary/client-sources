...
public class Spammer extends Module
{
    ...
    public Spammer() {
        ...
        Icarus.getCommandManager().getCommands().add(new Command("spam", "<message/file/delay>") {
            @Override
    ...
    public void onEnabled() {
        super.onEnabled();
        if (this.messages.isEmpty() && Icarus.getFileManager().getFileByName("spammermessage") != null) {
            Icarus.getFileManager().getFileByName("spammermessage").loadFile();
        }
    }
