...
import net.andrewsnetwork.icarus.utilities.MathUtils;
...
public class KillAura extends Module {
   ...
   public boolean isValidTarget(Entity entity) {
      ...
      if(entity == null) {
         ...
         return !Icarus.getFriendManager().isFriend(entity.getName()) && ((Boolean)this.players.getValue()).booleanValue();
   ...
   private void attack(Entity entity) {
      ...
      if(Icarus.getModuleManager().getModuleByName("durability").isEnabled()) {
      ...
      if(((Boolean)this.crack.getValue()).booleanValue()) {
         ...
         for(int toSwitch = 0; toSwitch < ((Integer)this.crackSize.getValue()).intValue(); ++toSwitch) {
            if(Icarus.getModuleManager().getModuleByName("criticals").isEnabled() || !mc.thePlayer.onGround) {
      ...
      if(Icarus.getModuleManager().getModuleByName("ninja").isEnabled()) {
   ...
   public void onEvent(Event event) {
      ...
      if(event instanceof PreMotion) {
         ...
         var10 = (HealingBot)Icarus.getModuleManager().getModuleByName("healingbot");
