...
public abstract class BlockLiquid extends Block
{
    ...
    protected Vec3 func_180687_h(IBlockAccess p_180687_1_, BlockPos p_180687_2_)
    {
      ...
      NoVelocity velocity = (NoVelocity)Icarus.getModuleManager().getModuleByName("novelocity");
      if ((velocity != null) && (BlockHelper.isInLiquid()) && 
        (velocity.isEnabled()) && (((Boolean)velocity.water.getValue()).booleanValue()))
      {
        double velX = var3.xCoord * 0.0D;
        double velY = var3.yCoord * 0.0D;
        double velZ = var3.zCoord * 0.0D;
        var3 = new Vec3(velX, velY, velZ);
      }
