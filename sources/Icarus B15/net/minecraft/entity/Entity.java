...
import net.andrewsnetwork.icarus.module.modules.*;
...
{
    public static boolean shouldOffset;
    ...
    public void moveEntity(double x, double y, double z)
    {
      ...
      else
      {
        ...
        double var15 = y;
        double var17 = z;
        boolean var19 = (this.onGround) && (isSneaking()) && ((this instanceof EntityPlayer));
        
        Walking walk = new Walking();
        Icarus.getEventManager().hook(walk);
        Speed speed = (Speed)Icarus.getModuleManager().getModuleByName("speed");
        
        boolean speedWalk = (speed.isEnabled()) && (speed.speedMode.getStringValue().equals("new")) ? true : this.onGround;
        if ((var19) || ((walk.isCancelled()) && (speedWalk) && ((this instanceof EntityPlayer))))
        {
          double var20 = 0.05D;
          for (;;)
          {
            ...
            var13 = x;
            if (x != 0.0D) {
              if (!this.worldObj.getCollidingBoundingBoxes(this, getEntityBoundingBox().offset(x, -1.0D, 0.0D)).isEmpty()) {
                break;
              }
            }
          }
          ...
          } while (this.worldObj.getCollidingBoundingBoxes(this, getEntityBoundingBox().offset(0.0D, -1.0D, z)).isEmpty());
        ...
        if (canStep)
        {
          PreStep var57 = new PreStep(this.stepHeight);
          Icarus.getEventManager().hook(var57);
          double previousY = getEntityBoundingBox().minY;
          double var56 = x;
          double var25 = y;
          double var27 = z;
          ...
          if (var56 * var56 + var27 * var27 >= x * x + z * z)
          {
            ...
            z = var27;
            func_174826_a(var29);
            if ((var57.bypass) && (this.stepHeight > 0.0F) && (var54) && ((var13 != var56) || (var17 != var27)))
            {
              ...
              for (Iterator var671 = var301.iterator(); var671.hasNext(); var331 = var361.calculateYOffset(var321, var331)) {
                var361 = (AxisAlignedBB)var671.next();
              }
              var311 = var311.offset(0.0D, var331, 0.0D);
              double var114 = var13;
              AxisAlignedBB var381;
              for (Iterator var681 = var301.iterator(); var681.hasNext(); var114 = var381.calculateXOffset(var311, var114)) {
                var381 = (AxisAlignedBB)var681.next();
              }
              var311 = var311.offset(var114, 0.0D, 0.0D);
              double var115 = var17;
              AxisAlignedBB var401;
              for (Iterator var691 = var301.iterator(); var691.hasNext(); var115 = var401.calculateZOffset(var311, var115)) {
                var401 = (AxisAlignedBB)var691.next();
              }
              var311 = var311.offset(0.0D, 0.0D, var115);
              AxisAlignedBB var116 = getEntityBoundingBox();
              double var701 = y;
              AxisAlignedBB var431;
              for (Iterator var711 = var301.iterator(); var711.hasNext(); var701 = var431.calculateYOffset(var116, var701)) {
                var431 = (AxisAlignedBB)var711.next();
              }
              var116 = var116.offset(0.0D, var701, 0.0D);
              double var117 = var13;
              AxisAlignedBB var451;
              for (Iterator var721 = var301.iterator(); var721.hasNext(); var117 = var451.calculateXOffset(var116, var117)) {
                var451 = (AxisAlignedBB)var721.next();
              }
              var116 = var116.offset(var117, 0.0D, 0.0D);
              double var118 = var17;
              AxisAlignedBB var471;
              for (Iterator var731 = var301.iterator(); var731.hasNext(); var118 = var471.calculateZOffset(var116, var118)) {
                var471 = (AxisAlignedBB)var731.next();
              }
              var116 = var116.offset(0.0D, 0.0D, var118);
              double var119 = var114 * var114 + var115 * var115;
              double var481 = var117 * var117 + var118 * var118;
              if (var119 > var481)
              {
                x = var114;
                z = var115;
              ...
              else
              {
                x = var117;
                z = var118;
                func_174826_a(var116);
              }
              y = -this.stepHeight;
              AxisAlignedBB var511;
              for (Iterator eventConfirm = var301.iterator(); eventConfirm.hasNext(); y = var511.calculateYOffset(getEntityBoundingBox(), y)) {
                var511 = (AxisAlignedBB)eventConfirm.next();
              }
              func_174826_a(getEntityBoundingBox().offset(0.0D, y, 0.0D));
              if (var56 * var56 + var27 * var27 >= x * x + z * z)
              {
              ...
              {
                EntityStep var120 = new EntityStep();
                Icarus.getEventManager().hook(var120);
              }
            }
          }
        }
        ...
        Icarus.getEventManager().hook(new PostStep());
      }
    }
