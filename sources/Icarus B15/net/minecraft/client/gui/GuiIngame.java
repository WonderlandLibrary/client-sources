...
public class GuiIngame extends Gui
{
    ...
    public void func_175180_a(float p_175180_1_)
    {
      ...
      if ((this.mc.currentScreen == Icarus.getClickGUI()) && (!Icarus.getModuleManager().getModuleByName("hud").isEnabled()) && 
        (!Icarus.getEventManager().isCancelled()))
      {
        int h = net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledHeight();
        int w = net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledWidth();
        Panel panel = Icarus.getClickGUI().getPanelByTitle("Player");
        GL11.glPushMatrix();
        GlStateManager.enableAlpha();
        GlStateManager.enableBlend();
        if ((panel != null) && (panel.hoveringLogo)) {
          net.andrewsnetwork.icarus.utilities.RenderHelper.drawRect(0.0F, h - 22, 24.0F, h, 1090519039);
        }
        Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("textures/logo.png"));
        Gui.drawScaledCustomSizeModalRect(0, net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledHeight() - 22, 0.0F, 0.0F, 24, 20, 24, 20, 24.0F, 20.0F);
      ...
      {
        Icarus.getEventManager().hook(new DrawScreen());
    ...
    {
      HUD hud = (HUD)Icarus.getModuleManager().getModuleByName("hud");
      if ((hud.isEnabled()) && (((Boolean)hud.bar.getValue()).booleanValue()) && 
        (!Icarus.getEventManager().isCancelled()))
      {
        net.andrewsnetwork.icarus.utilities.RenderHelper.drawRectNoBlend(0.0F, net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledHeight() - 22, net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledWidth() - 4, 
          net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledHeight(), Integer.MIN_VALUE);
        net.andrewsnetwork.icarus.utilities.RenderHelper.drawRectNoBlend(net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledWidth() - 4, net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledHeight() - 22, net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledWidth(), 
          net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledHeight(), -862348903);
        ...
        net.andrewsnetwork.icarus.utilities.RenderHelper.drawRectNoBlend(net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledWidth() / 2 - 91 + xPos - 21.0F, net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledHeight() - 22, net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledWidth() / 2 - 91 + xPos, 
          net.andrewsnetwork.icarus.utilities.RenderHelper.getScaledRes().getScaledHeight() - 2, -2130706433);
      }
