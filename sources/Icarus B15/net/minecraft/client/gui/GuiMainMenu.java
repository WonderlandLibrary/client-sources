...
import net.andrewsnetwork.altmanager.GuiAltManager;
  ...
  implements GuiYesNoCallback
{
  ...
  private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
  {
    ...
    this.buttonList.add(this.field_175372_K = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format(
      Icarus.getEventManager().isCancelled() ? "menu.online" : "Alt Manager", new Object[0])));
  }
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    else if (!Icarus.getEventManager().isCancelled())
    {
      ...
      String text = Icarus.getName() + " b" + Icarus.getBuild();
      
      this.hugeText.drawStringWithShadow(text, w / 2 - this.hugeText.getStringWidth(text) / 4, 20, -1);
      this.guiText.drawStringWithShadow("Fuck off Grax, this is my client.", 2, h - 14, 
        Icarus.isLatestVersion() ? -14614784 : -65536);
      String waterMark = "Fixed by trol";
