...
import net.andrewsnetwork.icarus.event.events.EventWorldBob;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
        if (Icarus.getModuleManager().getModuleByName("antihurtcam").isEnabled()) {
            return;
          }
    ...
    public void setupCameraTransform(float partialTicks, int pass)
    {
        ...
        EventWorldBob event = new EventWorldBob();
    ...
    private void func_175068_a(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        RenderIn3D event = new RenderIn3D(partialTicks, pass);
        Icarus.getEventManager().hook(event);
