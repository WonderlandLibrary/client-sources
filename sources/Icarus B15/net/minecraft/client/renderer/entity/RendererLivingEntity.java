...
import net.andrewsnetwork.icarus.event.events.EntityRender;
  ...
  extends Render
{
  ...
  public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
  {
    ...
    Icarus.getEventManager().hook(event);
  ...
  {
    if ((canRenderName(p_77033_1_)) && (!Icarus.getModuleManager().getModuleByName("nametags").isEnabled()))
    {
