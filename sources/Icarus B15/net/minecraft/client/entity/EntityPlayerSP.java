  ...
  extends AbstractClientPlayer
{
  ...
  public void onUpdate()
  {
    if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
    {
      ...
      Icarus.getEventManager().hook(post);
    }
  }
  ...
  public void func_175161_p()
  {
    ...
    if (func_175160_A())
    {
      ...
      HealingBot hB = (HealingBot)Icarus.getModuleManager().getModuleByName("healingbot");
  ...
  public void onLivingUpdate()
  {
    ...
    if ((isUsingItem()) && (!isRiding()) && (!Icarus.getModuleManager().getModuleByName("noslowdown").isEnabled()))
    {
  ...
  public void moveEntity(double motionX, double motionY, double motionZ)
  {
    ...
    Icarus.getEventManager().hook(movement);
    ...
    Icarus.getEventManager().hook(postmovement);
  }
}
