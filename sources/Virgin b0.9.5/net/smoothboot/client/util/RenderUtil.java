...
public enum RenderUtil
{
    ...
    public static void scissorBox(int startX, int startY, int endX, int endY)
    {
        ...
        int bottomY = Client.mc.currentScreen.height - endY;
        double factor = Client.mc.getWindow().getScaleFactor();
    ...
    {
        Camera camera = Client.mc.getBlockEntityRenderDispatcher().camera;
        if(camera == null)
            return Vec3d.ZERO;
    ...
    public static void renderBlockBox(MatrixStack mStack, BlockPos bPos, float r, float g, float b, float a) {
        renderBlockBox(mStack, BlockPos.ofFloored(new Vec3d(
                bPos.getX() + 0.5,
                bPos.getY(),
                bPos.getZ() + 0.5
        )), r, g, b, a);
                                ...
                                int y, boolean large)
    {
        ...
        if(stack.isEmpty())
        {
            ...
            TextRenderer tr = Client.mc.textRenderer;
