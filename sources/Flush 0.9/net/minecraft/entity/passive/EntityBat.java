...
public class EntityBat extends EntityAmbientCreature
{
    ...
    protected void updateAITasks()
    {
        ...
        if (this.getIsBatHanging())
        {
            if (!this.world.getBlockState(blockpos1).getBlock().isNormalCube())
            {
                this.setIsBatHanging(false);
                this.world.playAuxSFXAtEntity((EntityPlayer)null, 1015, blockpos, 0);
            }
            else
            {
        ...
        else
        {
            ...
            if (this.rand.nextInt(100) == 0 && this.world.getBlockState(blockpos1).getBlock().isNormalCube())
            {
                this.setIsBatHanging(true);
            }
        }
    ...
    public boolean getCanSpawnHere()
    {
        ...
        if (blockpos.getY() >= this.world.func_181545_F())
        {
            return false;
        }
        else
