...
public class EntityLeashKnot extends EntityHanging
{
    ...
    public boolean interactFirst(EntityPlayer playerIn)
    {
        ...
        if (itemstack != null && itemstack.getItem() == Items.lead && !this.world.isRemote)
        {
            double d0 = 7.0D;

            for (EntityLiving entityliving : this.world.getEntitiesWithinAABB(EntityLiving.class, new AxisAlignedBB(this.posX - d0, this.posY - d0, this.posZ - d0, this.posX + d0, this.posY + d0, this.posZ + d0)))
            {
        ...
        if (!this.world.isRemote && !flag)
        {
            ...
            if (playerIn.capabilities.isCreativeMode)
            {
                ...
                for (EntityLiving entityliving1 : this.world.getEntitiesWithinAABB(EntityLiving.class, new AxisAlignedBB(this.posX - d1, this.posY - d1, this.posZ - d1, this.posX + d1, this.posY + d1, this.posZ + d1)))
                {
