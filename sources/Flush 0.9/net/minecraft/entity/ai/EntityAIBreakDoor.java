...
public class EntityAIBreakDoor extends EntityAIDoorInteract
{
    ...
    public void updateTask()
    {
        ...
        {
            this.theEntity.world.playAuxSFX(1010, this.doorPosition, 0);
        }
        ...
        if (this.breakingTime == 240 && this.theEntity.world.getDifficulty() == EnumDifficulty.HARD)
        {
            ...
            this.theEntity.world.playAuxSFX(1012, this.doorPosition, 0);
            this.theEntity.world.playAuxSFX(2001, this.doorPosition, Block.getIdFromBlock(this.doorBlock));
        }
    }
}
