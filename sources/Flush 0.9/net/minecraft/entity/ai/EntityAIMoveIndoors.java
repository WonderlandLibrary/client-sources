...
public class EntityAIMoveIndoors extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        if ((!this.entityObj.world.isDaytime() || this.entityObj.world.isRaining() && !this.entityObj.world.getBiomeGenForCoords(blockpos).canSpawnLightningBolt()) && !this.entityObj.world.provider.getHasNoSky())
        {
