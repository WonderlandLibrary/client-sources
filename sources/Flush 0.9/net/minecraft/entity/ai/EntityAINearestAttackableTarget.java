...
public class EntityAINearestAttackableTarget<T extends EntityLivingBase> extends EntityAITarget
{
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            List<T> list = this.taskOwner.world.<T>getEntitiesWithinAABB(this.targetClass, this.taskOwner.getEntityBoundingBox().expand(d0, 4.0D, d0), Predicates.<T> and (this.targetEntitySelector, EntitySelectors.NOT_SPECTATING));
