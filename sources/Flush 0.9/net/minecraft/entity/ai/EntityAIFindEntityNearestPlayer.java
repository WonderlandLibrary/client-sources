...
public class EntityAIFindEntityNearestPlayer extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        List<EntityPlayer> list = this.field_179434_b.world.<EntityPlayer>getEntitiesWithinAABB(EntityPlayer.class, this.field_179434_b.getEntityBoundingBox().expand(d0, 4.0D, d0), this.field_179435_c);
