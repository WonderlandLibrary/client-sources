...
public abstract class EntityThrowable extends Entity implements IProjectile
{
    ...
    public void onUpdate()
    {
        ...
        if (movingobjectposition != null)
        {
            if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.world.getBlockState(movingobjectposition.getBlockPos()).getBlock() == Blocks.portal)
            {
