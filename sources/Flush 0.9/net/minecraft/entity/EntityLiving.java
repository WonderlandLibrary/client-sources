...
public abstract class EntityLiving extends EntityLivingBase
{
    ...
    {
        return this.world.checkNoEntityCollision(this.getEntityBoundingBox(), this) && this.world.getCollidingBoundingBoxes(this, this.getEntityBoundingBox()).isEmpty() && !this.world.isAnyLiquid(this.getEntityBoundingBox());
    }
    ...
    public void clearLeashed(boolean sendPacket, boolean dropLead)
    {
        if (this.isLeashed)
        {
            ...
            {
                ((WorldServer)this.world).getEntityTracker().sendToAllTrackingEntity(this, new S1BPacketEntityAttach(1, this, (Entity)null));
            }
        }
    }
    ...
    public void setLeashedToEntity(Entity entityIn, boolean sendAttachNotification)
    {
        ...
        {
            ((WorldServer)this.world).getEntityTracker().sendToAllTrackingEntity(this, new S1BPacketEntityAttach(1, this, this.leashedToEntity));
        }
    }
    ...
    private void recreateLeash()
    {
        if (this.isLeashed && this.leashNBTTag != null)
        {
            if (this.leashNBTTag.hasKey("UUIDMost", 4) && this.leashNBTTag.hasKey("UUIDLeast", 4))
            {
                ...
                for (EntityLivingBase entitylivingbase : this.world.getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().expand(10.0D, 10.0D, 10.0D)))
                {
    ...
    public boolean isEntityInsideOpaqueBlock()
    {
        ...
        else
        {
            ...
            for (int i = 0; i < 8; ++i)
            {
                ...
                if (this.world.getBlockState(blockposm).getBlock().isVisuallyOpaque())
                {
                    return true;
                }
            }
