    ...
    public void onUpdate()
    {
        ...
        if (this.lightningState < 0)
        {
            ...
            else if (this.lightningState < -this.rand.nextInt(10))
            {
                ...
                if (!this.world.isRemote && this.world.getGameRules().getBoolean("doFireTick") && this.world.isAreaLoaded(blockpos, 10) && this.world.getBlockState(blockpos).getBlock().getMaterial() == Material.air && Blocks.fire.canPlaceBlockAt(this.world, blockpos))
                {
