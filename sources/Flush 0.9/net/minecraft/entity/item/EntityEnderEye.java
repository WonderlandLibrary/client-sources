...
public class EntityEnderEye extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        {
            this.world.spawnParticle(EnumParticleTypes.PORTAL, this.posX - this.motionX * (double)f3 + this.rand.nextDouble() * 0.6D - 0.3D, this.posY - this.motionY * (double)f3 - 0.5D, this.posZ - this.motionZ * (double)f3 + this.rand.nextDouble() * 0.6D - 0.3D, this.motionX, this.motionY, this.motionZ, new int[0]);
        }
        ...
        if (!this.world.isRemote)
        {
            ...
            if (this.despawnTimer > 80 && !this.world.isRemote)
            {
                ...
                {
                    this.world.playAuxSFX(2003, new BlockPos(this), 0);
                }
            }
        }
    }
