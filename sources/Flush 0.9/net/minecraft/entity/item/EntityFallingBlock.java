            ...
            if (!this.world.isRemote)
            {
                ...
                if (this.onGround)
                {
                    ...
                    if (this.world.getBlockState(blockpos1).getBlock() != Blocks.piston_extension)
                    {
                        ...
                        {
                            if (this.world.canBlockBePlaced(block, blockpos1, true, EnumFacing.UP, (Entity)null, (ItemStack)null) && !BlockFalling.canFallInto(this.world, blockpos1.down()) && this.world.setBlockState(blockpos1, this.fallTile, 3))
                            {
