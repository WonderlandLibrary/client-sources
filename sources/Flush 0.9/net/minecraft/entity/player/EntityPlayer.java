...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void stopUsingItem()
    {
        if (this.itemInUse != null) {
            this.itemInUse.onPlayerStoppedUsing(this.world, this, this.itemInUseCount);
        }
    ...
    public void onUpdate()
    {
        ...
        if (this.itemInUse != null)
        {
            ...
            if (itemstack == this.itemInUse)
            {
                ...
                if (--this.itemInUseCount == 0 && !this.world.isRemote)
                {
    ...
    {
        this.world.playSoundToNearExcept(this, name, volume, pitch);
    }
    ...
    protected void updateItemUse(ItemStack itemStackIn, int p_71010_2_)
    {
        ...
        {
            this.playSound("random.drink", 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
        }
        ...
        if (itemStackIn.getItemUseAction() == EnumAction.EAT)
        {
            for (int i = 0; i < p_71010_2_; ++i)
            {
                ...
                {
                    this.world.spawnParticle(EnumParticleTypes.ITEM_CRACK, vec31.xCoord, vec31.yCoord, vec31.zCoord, vec3.xCoord, vec3.yCoord + 0.05D, vec3.zCoord, new int[] {Item.getIdFromItem(itemStackIn.getItem()), itemStackIn.getMetadata()});
                }
                else
                {
                    this.world.spawnParticle(EnumParticleTypes.ITEM_CRACK, vec31.xCoord, vec31.yCoord, vec31.zCoord, vec3.xCoord, vec3.yCoord + 0.05D, vec3.zCoord, new int[] {Item.getIdFromItem(itemStackIn.getItem())});
                }
            }
    ...
    protected void onItemUseFinish()
    {
        if (this.itemInUse != null)
        {
            ...
            ItemStack itemstack = this.itemInUse.onItemUseFinish(this.world, this);
    ...
    {
        if (!this.world.isRemote && this.isSneaking())
        {
    ...
    {
        this.world.spawnEntityInWorld(itemIn);
    }
    ...
    public EntityPlayer.EnumStatus trySleep(BlockPos bedLocation)
    {
        if (!this.world.isRemote)
        {
            ...
            double d0 = 8.0D;
            double d1 = 5.0D;
            List<EntityMob> list = this.world.<EntityMob>getEntitiesWithinAABB(EntityMob.class, new AxisAlignedBB((double)bedLocation.getX() - d0, (double)bedLocation.getY() - d1, (double)bedLocation.getZ() - d0, (double)bedLocation.getX() + d0, (double)bedLocation.getY() + d1, (double)bedLocation.getZ() + d0));
        ...
        {
            EnumFacing enumfacing = (EnumFacing)this.world.getBlockState(bedLocation).getValue(BlockDirectional.FACING);
            float f = 0.5F;
            float f1 = 0.5F;
    ...
    {
        return this.world.getBlockState(this.playerLocation).getBlock() == Blocks.bed;
    }
    ...
    public float getBedOrientationInDegrees()
    {
        ...
        {
            EnumFacing enumfacing = (EnumFacing)this.world.getBlockState(this.playerLocation).getValue(BlockDirectional.FACING);
    ...
    public void addExperienceLevel(int levels)
    {
        ...
        if (levels > 0 && this.experienceLevel % 5 == 0 && (float)this.lastXPSound < (float)this.ticksExisted - 100.0F)
        {
            ...
            this.world.playSoundAtEntity(this, "random.levelup", f * 0.75F, 1.0F);
