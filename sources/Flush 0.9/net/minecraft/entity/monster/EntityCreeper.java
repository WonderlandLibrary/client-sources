...
public class EntityCreeper extends EntityMob
{
    ...
    protected boolean interact(EntityPlayer player)
    {
        ...
        {
            this.world.playSoundEffect(this.posX + 0.5D, this.posY + 0.5D, this.posZ + 0.5D, "fire.ignite", 1.0F, this.rand.nextFloat() * 0.4F + 0.8F);
            player.swingItem();
    ...
    {
        return this.field_175494_bm < 1 && this.world.getGameRules().getBoolean("doMobLoot");
    }
