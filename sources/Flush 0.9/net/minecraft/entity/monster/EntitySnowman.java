...
public class EntitySnowman extends EntityGolem implements IRangedAttackMob
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            if (this.world.getBiomeGenForCoords(new BlockPos(i, 0, k)).getFloatTemperature(new BlockPos(i, j, k)) > 1.0F)
            {
            ...
            for (int l = 0; l < 4; ++l)
            {
                ...
                if (this.world.getBlockState(blockpos).getBlock().getMaterial() == Material.air && this.world.getBiomeGenForCoords(new BlockPos(i, 0, k)).getFloatTemperature(blockpos) < 0.8F && Blocks.snow_layer.canPlaceBlockAt(this.world, blockpos))
                {
