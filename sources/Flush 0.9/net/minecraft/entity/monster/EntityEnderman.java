...
public class EntityEnderman extends EntityMob
{
    ...
    protected boolean teleportTo(double x, double y, double z)
    {
        ...
        if (this.world.isBlockLoaded(blockpos))
        {
            ...
            if (flag1)
            {
                ...
                if (this.world.getCollidingBoundingBoxes(this, this.getEntityBoundingBox()).isEmpty() && !this.world.isAnyLiquid(this.getEntityBoundingBox()))
                {
                    flag = true;
                }
            }
        ...
        else
        {
            ...
            for (int j = 0; j < i; ++j)
            {
                ...
                this.world.spawnParticle(EnumParticleTypes.PORTAL, d3, d4, d5, (double)f, (double)f1, (double)f2, new int[0]);
            }

            this.world.playSoundEffect(d0, d1, d2, "mob.endermen.portal", 1.0F, 1.0F);
    ...
    static class AIFindPlayer extends EntityAINearestAttackableTarget
    {
        ...
        public boolean shouldExecute()
        {
            ...
            List<EntityPlayer> list = this.taskOwner.world.<EntityPlayer>getEntitiesWithinAABB(EntityPlayer.class, this.taskOwner.getEntityBoundingBox().expand(d0, 4.0D, d0), this.targetEntitySelector);
    ...
    static class AIPlaceBlock extends EntityAIBase
    {
        ...
        public boolean shouldExecute()
        {
            return !this.enderman.world.getGameRules().getBoolean("mobGriefing") ? false : (this.enderman.getHeldBlockState().getBlock().getMaterial() == Material.air ? false : this.enderman.getRNG().nextInt(2000) == 0);
        }
    ...
    static class AITakeBlock extends EntityAIBase
    {
        ...
        public boolean shouldExecute()
        {
            return !this.enderman.world.getGameRules().getBoolean("mobGriefing") ? false : (this.enderman.getHeldBlockState().getBlock().getMaterial() != Material.air ? false : this.enderman.getRNG().nextInt(20) == 0);
        }
