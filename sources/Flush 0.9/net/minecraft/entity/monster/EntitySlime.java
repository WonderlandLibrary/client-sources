    ...
    public boolean getCanSpawnHere()
    {
        ...
        else
        {
            if (this.world.getDifficulty() != EnumDifficulty.PEACEFUL)
            {
                ...
                if (biomegenbase == BiomeGenBase.swampland && this.posY > 50.0D && this.posY < 70.0D && this.rand.nextFloat() < 0.5F && this.rand.nextFloat() < this.world.getCurrentMoonPhaseFactor() && this.world.getLightFromNeighbors(new BlockPos(this)) <= this.rand.nextInt(8))
                {
