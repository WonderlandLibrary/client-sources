...
public class NetworkManager extends SimpleChannelInboundHandler<Packet> {
    ...
    public void exceptionCaught(ChannelHandlerContext context, Throwable throwable) {
        ...
        if (throwable instanceof TimeoutException)
            ...
            chatcomponenttranslation = new ChatComponentTranslation("disconnect.genericReason", "Internal Exception: " + throwable);

        this.closeChannel(chatcomponenttranslation);
    }

    protected void channelRead0(ChannelHandlerContext context, Packet packet) {
        EventPacket e = new EventPacket(packet, EventPacket.Direction.INCOMING).call();
        packet = e.getPacket();
    ...
    public void sendPacket(Packet packetIn) {
        EventPacket e = new EventPacket(packetIn, EventPacket.Direction.OUTGOING).call();
        ...
        if (this.channel != null && this.channel.isOpen()) {
            ...
            try {
                while (!this.outboundPacketsQueue.isEmpty()) {
                    NetworkManager.InboundHandlerTuplePacketListener packetListener = this.outboundPacketsQueue.poll();
                    this.dispatchPacket(packetListener.packet, packetListener.futureListeners);
                }
            } finally {
    ...
    public static NetworkManager func_181124_a(InetAddress address, int port, boolean p_181124_2_) {
