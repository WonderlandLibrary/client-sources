...
public abstract class MobSpawnerBaseLogic
{
    ...
    private Entity spawnNewEntity(Entity entityIn, boolean spawn)
    {
        if (this.getRandomEntity() != null)
        {
            ...
            if (entityIn.world != null && spawn)
            {
                entityIn.world.spawnEntityInWorld(entityIn);
            }
            ...
            for (Entity entity = entityIn; nbttagcompound.hasKey("Riding", 10); nbttagcompound = nbttagcompound2)
            {
                ...
                Entity entity1 = EntityList.createEntityByName(nbttagcompound2.getString("id"), entityIn.world);
                ...
                if (entity1 != null)
                {
                    ...
                    if (entityIn.world != null && spawn)
                    {
                        entityIn.world.spawnEntityInWorld(entity1);
                    }
        ...
        else if (entityIn instanceof EntityLivingBase && entityIn.world != null && spawn)
        {
            if (entityIn instanceof EntityLiving)
            {
                ((EntityLiving)entityIn).onInitialSpawn(entityIn.world.getDifficultyForLocation(new BlockPos(entityIn)), (IEntityLivingData)null);
            }
