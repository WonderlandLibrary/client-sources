...
public abstract class Container
{
    ...
    public ItemStack slotClick(int slotId, int clickedButton, int mode, EntityPlayer playerIn)
    {
                ...
                if (!this.dragSlots.isEmpty())
                {
                    ...
                    for (Slot slot1 : this.dragSlots)
                    {
                        if (slot1 != null && canAddItemToSlot(slot1, inventoryplayer.getItemStack(), true) && slot1.isItemValid(inventoryplayer.getItemStack()) && inventoryplayer.getItemStack().stackSize >= this.dragSlots.size() && this.canDragIntoSlot(slot1))
                        {
                            ...
                            int k = slot1.hasStack() ? slot1.getStack().stackSize : 0;
        ...
        else if (mode == 2 && clickedButton >= 0 && clickedButton < 9)
        {
            ...
            if (slot5.canTakeStack(playerIn))
            {
                ...
                else if (!slot5.hasStack() && itemstack7 != null && slot5.isItemValid(itemstack7))
                {
        ...
        else if (mode == 4 && inventoryplayer.getItemStack() == null && slotId >= 0)
        {
            ...
            if (slot3 != null && slot3.hasStack() && slot3.canTakeStack(playerIn))
            {
        ...
        else if (mode == 6 && slotId >= 0)
        {
            ...
            if (itemstack4 != null && (slot2 == null || !slot2.hasStack() || !slot2.canTakeStack(playerIn)))
            {
                ...
                for (int l2 = 0; l2 < 2; ++l2)
                {
                    for (int i3 = i1; i3 >= 0 && i3 < this.inventorySlots.size() && itemstack4.stackSize < itemstack4.getMaxStackSize(); i3 += j1)
                    {
                        ...
                        if (slot8.hasStack() && canAddItemToSlot(slot8, itemstack4, true) && slot8.canTakeStack(playerIn) && this.canMergeSlot(itemstack4, slot8) && (l2 != 0 || slot8.getStack().stackSize != slot8.getStack().getMaxStackSize()))
                        {
    ...
    {
        boolean flag = slotIn == null || !slotIn.hasStack();

        if (slotIn != null && slotIn.hasStack() && stack != null && stack.isItemEqual(slotIn.getStack()) && ItemStack.areItemStackTagsEqual(slotIn.getStack(), stack))
        {
