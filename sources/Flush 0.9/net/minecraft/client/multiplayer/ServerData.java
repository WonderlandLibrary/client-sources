...
public class ServerData {
    ...
    public ServerData(String name, String ip, boolean p_i46420_3_) {
    ...
    public enum ServerResourceMode {
        ...
        private ServerResourceMode(String packName) {
            this.motd = new ChatComponentTranslation("addServer.resourcePack." + packName);
        }
