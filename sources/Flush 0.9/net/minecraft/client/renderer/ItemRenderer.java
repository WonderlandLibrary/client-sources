...
import me.nyan.flush.module.impl.render.Animations;
...
public class ItemRenderer {
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress) {
        ...
        Animations animations = Flush.getInstance().getModuleManager().getModule(Animations.class);
        if (animations.isEnabled()) {
            GlStateManager.translate(0.0F, animations.itemsHeight.getValueFloat() / 500, 0.0F);
        }
    ...
    private void animation17(float swingProgress, float equipProgress) {
        GlStateManager.translate(0.56F, -0.52F, -0.71999997F);
        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
        GlStateManager.rotate(45.0F, 0.0F, 10.0F, 0.0F);
        float f = MathHelper.sin(swingProgress * swingProgress * (float) Math.PI);
        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float) Math.PI);
        GlStateManager.rotate(f * -20.0F, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(f1 * -20.0F, 0.0F, 0.0F, 1.0F);
    ...
    private void down(float swingProgress) {
        GlStateManager.translate(0.56F, -0.42F, -0.71999997F);
        GlStateManager.translate(0.0F, (swingProgress/2f * -0.6F) * 2, 0.0F);
        GlStateManager.rotate(45.0F, 0.0F, 10.0F, 0.0F);
    }

    private void tap(float swingProgress) {
        float owo = MathHelper.sin(swingProgress * swingProgress * (float) Math.PI) * 2.0F;
        GlStateManager.translate(0.56F, -0.4F, -0.71999997F);
        GlStateManager.translate(0.0F, 0.0F, 0.0F);
        GlStateManager.rotate(70.0F, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(owo * -20.0F, 0.0F, 1.0F, 0.0F);
    }

    private void test(float equipProgress, float swingProgress) {
        GlStateManager.translate(0.56F, -0.52F, -0.71999997F);
        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
        GlStateManager.rotate(45.0F, 0.0F, 10.0F, 0.0F);
        float f = MathHelper.sin(swingProgress * swingProgress * (float) Math.PI);
    ...
    private void swing(float swing) {
        float owo = MathHelper.sin(MathHelper.sqrt_float(swing) * (float) Math.PI) * 2.1f;
        GlStateManager.translate(0.56F, -0.4F, -0.71999997F);
        GlStateManager.translate(0.0F, 0, 0.0F);
        GlStateManager.rotate(70, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(owo * -20.0F, 22.0F, 2.0F, 0.0F);
    }

    private void flush(float swing) {
        float idkhowtonamethis = MathHelper.sin(MathHelper.sqrt_float(swing) * (float) Math.PI);
        GlStateManager.translate(0.56F, -0.4F, -0.71999997F);
        GlStateManager.translate(0.0F, 0, 0.0F);
        GlStateManager.rotate(70, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(idkhowtonamethis * -20.0F, 10.0F, 6.0F, 0.0F);
    }

    private void spin() {
        Animations animations = Flush.getInstance().getModuleManager().getModule(Animations.class);
        GlStateManager.translate(0.54F, -0.2F, -0.81999997F);
        GlStateManager.translate(0.0F, 0.0F, 0.0F);
        GlStateManager.rotate(72.0F, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(System.currentTimeMillis() % (360 * 20) * animations.spinSpeed.
                getValueFloat(), 4f, 0f, 0f);
    }
    ...
    private void blockingRotate() {
        Animations animations = Flush.getInstance().getModuleManager().getModule(Animations.class);
        float height = animations.isEnabled() ? 0.2F + animations.itemsHeight.getValueFloat() / 100F : 0.2F;
        GlStateManager.translate(-0.5F, height, 0.0F);
        GlStateManager.rotate(30.0F, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(-80.0F, 1.0F, 0.1F, 0.0F);
        GlStateManager.rotate(60.0F, 0.0F, 1.0F, 0.0F);
    }

    private void scale() {
        Animations animations = Flush.getInstance().getModuleManager().getModule(Animations.class);
        float scale = animations.isEnabled() ? animations.itemsSize.getValueFloat() / 100F : 0.4F;
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if (this.itemToRender != null) {
            if (this.itemToRender.getItem() instanceof ItemMap) {
                this.renderItemMap(entityplayersp, pitch, equippedProgress, swingProgress);
            } else if (entityplayersp.getItemInUseCount() > 0 || Flush.getInstance().getModuleManager().getModule(Aura.class).blocking) {
                switch (itemToRender.getItemUseAction()) {
                    case NONE:
                        transformFirstPersonItem(equippedProgress, 0.0F);
                        scale();
                        break;
                    ...
                    case BLOCK:
                        float f = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * MathHelper.PI);

                        if (animations.isEnabled()) {
                            switch (animations.blockAnimation.getValue().toUpperCase()) {
                                case "1.7":
                                    animation17(swingProgress, equippedProgress);
                                    break;

                                case "1.8":
                                    animation17(0, equippedProgress);
                                    break;
                                ...
                                case "SIGMA":
                                    float sigma = MathHelper.sin(swingProgress * swingProgress * MathHelper.PI);

                                    animation17(0, equippedProgress);
                                    GlStateManager.translate(0, 0.1f, 0);
                                    GlStateManager.rotate(-sigma * 70 / 2.0F, -8.0F, 0.0F, 9.0F);
                                    GlStateManager.rotate(-sigma * 70, 1.0F, sigma, 0.0F);
                                    break;

                                case "SLIDE":
                                    animation17(0, equippedProgress);
                                    GlStateManager.translate(0, 0.1F, 0);
                                    GlStateManager.rotate(-f * 70 / 2.0F, -8.0F, 0.0F, 9.0F);
                                    GlStateManager.rotate(-f * 70, 1.0F, -0.4F, -0.0F);
                                    break;

                                case "EXHIBITION":
                                    animation17(0, equippedProgress);
                                    GlStateManager.translate(0, 0.1F, 0);
                                    GlStateManager.rotate(-f * 40.0F / 2.0F, f / 2.0F, -0.0F, 9.0F);
                                    GlStateManager.rotate(-f * 30.0F, 1.0F, f / 2.0F, -0.0F);
                                    break;
                                ...
                                case "TEST":
                                    test(equippedProgress, swingProgress);
                                    break;
                            }
                        } else {
                            transformFirstPersonItem(equippedProgress, 0.0F);
                ...
                if (!animations.hitAnimation.is("Flush") || !animations.isEnabled()) {
                    func_178105_d(swingProgress);
                }

                transformFirstPersonItem(equippedProgress, swingProgress);
                scale();
            }
    ...
    private void renderFireInFirstPerson(float p_78442_1_) {
        EventRenderFire event = new EventRenderFire();
        event.call();
