...
import me.nyan.flush.module.impl.render.ItemPhysics;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    private int func_177077_a(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_) {
        ...
        boolean physics = Flush.getInstance().getModuleManager().getModule(ItemPhysics.class).isEnabled();
        ...
        if (item == null) {
            ...
            if ((flag || this.renderManager.options != null) && !physics) {
