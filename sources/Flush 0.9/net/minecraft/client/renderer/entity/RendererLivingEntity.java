...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    {
        EventRenderEntity eventRenderEntity = new EventRenderEntity(entity);
        eventRenderEntity.setState(Event.State.PRE);
        ...
        eventRenderEntity.setState(Event.State.POST);
        eventRenderEntity.call();
    }
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor)
    {
        ...
        if (flag || flag1)
        {
            ...
            EventRenderEntityModel event = new EventRenderEntityModel(mainModel, entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, scaleFactor);
            event.call();

            if(!event.isCancelled()) mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, scaleFactor);
