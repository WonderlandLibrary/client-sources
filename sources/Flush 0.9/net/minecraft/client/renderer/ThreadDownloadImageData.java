        ...
        this.imageThread = new Thread("Texture Downloader #" + threadDownloadCounter.incrementAndGet()) {
            public void run() {
                ...
                if (ThreadDownloadImageData.this.shouldPipeline()) {
                    ...
                    try {
                        connection = (HttpURLConnection) (new URL(ThreadDownloadImageData.this.imageUrl)).openConnection(Minecraft.getMinecraft().getProxy());
                        ...
                        if (ThreadDownloadImageData.this.cacheFile != null) {
                            FileUtils.copyInputStreamToFile(connection.getInputStream(), ThreadDownloadImageData.this.cacheFile);
