                ...
                else
                {
                    ...
                    if (item == Items.compass)
                    {
                        ...
                        if (textureatlassprite instanceof TextureCompass)
                        {
                            ...
                            texturecompass.updateCompass(itemFrame.world, itemFrame.posX, itemFrame.posZ, (double)MathHelper.wrapAngleTo180_float((float)(180 + itemFrame.facingDirection.getHorizontalIndex() * 90)), false, true);
