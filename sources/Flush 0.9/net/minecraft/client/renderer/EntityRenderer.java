...
import me.nyan.flush.module.impl.render.AntiBlindness;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > getAttackReach()) {
                this.pointedEntity = null;
    ...
    private double getAttackReach() {
        return ((EventReach) new EventReach(3).call()).getReach();
    }
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (new EventHurtCameraEffect().call().isCancelled())
            return;
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                for (int i = 0; i < 8; ++i) {
                    ...
                    if (movingobjectposition != null) {
                        ...
                        if (d7 < d3) {
                            EventCameraClip event = new EventCameraClip();
                            event.call();

                            if (d7 < d3 && !event.isCancelled()) {
                                d3 = d7;
                            }
                        }
                    }
        ...
        if (this.lightmapUpdateNeeded) {
            ...
            if (worldclient != null) {
                ...
                for (int i = 0; i < 256; ++i) {
                    ...
                    float f16 = Flush.getInstance().getModuleManager().getModule(FullBright.class).isEnabled() ? 10
                            : this.mc.gameSettings.gammaSetting;
                    float f17 = 1.0F - f8;
                    float f13 = 1.0F - f9;
                    float f14 = 1.0F - f10;
    ...
    private void updateFogColor(float partialTicks) {
        ...
        if (Reflector.EntityViewRenderEvent_FogColors_Constructor.exists()) {
            Object object = Reflector.newInstance(Reflector.EntityViewRenderEvent_FogColors_Constructor, this, entity, block, partialTicks, Float.valueOf(this.fogColorRed), Float.valueOf(this.fogColorGreen), Float.valueOf(this.fogColorBlue));
            Reflector.postForgeBusEvent(object);
    ...
    private void setupFog(int p_78468_1_, float partialTicks) {
        ...
        if (f1 >= 0.0F) {
            GlStateManager.setFogDensity(f1);
                ...
                !Flush.getInstance().getModuleManager().getModule(AntiBlindness.class).isEnabled()) {
            float f2 = 5.0F;
            int i = ((EntityLivingBase) entity).getActivePotionEffect(Potion.blindness).getDuration();
