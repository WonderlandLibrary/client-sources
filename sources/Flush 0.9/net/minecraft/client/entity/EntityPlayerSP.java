...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdateWalkingPlayer() {
        EventMotion event = new EventMotion(posX, getEntityBoundingBox().minY, posZ, rotationYaw, rotationPitch,
                onGround, isSprinting(), isSneaking());
        ...
        boolean ground = event.isGround(), sprint = event.isSprint(), sneak = event.isSneak();

        if (mc.gameSettings.thirdPersonView != 0 && rotationYaw != event.getYaw() || rotationPitch != event.getPitch()) {
            rotationYawHead = event.getYaw();
            renderYawOffset = event.getYaw();
            rotationPitchHead = event.getPitch();
        }
    ...
    private boolean isOpenBlockSpace(BlockPos pos) {
        return !this.world.getBlockState(pos).getBlock().isNormalCube() && !this.world.getBlockState(pos.up()).getBlock().isNormalCube();
    }
    ...
    public void onLivingUpdate() {
        ...
        EventSlowdown e = new EventSlowdown();
        e.call();
    ...
    public void moveEntity(double x, double y, double z) {
        EventMove e = new EventMove(x, y, z).call();
        x = e.getX();
        y = e.getY();
        z = e.getZ();
