...
public class SimpleReloadableResourceManager implements IReloadableResourceManager
{
    ...
    public void reloadResources(List<IResourcePack> packs)
    {
        this.clearResources();
        logger.info("Reloading ResourceManager: " + joinerResourcePacks.join(Iterables.transform(packs, IResourcePack::getPackName)));
