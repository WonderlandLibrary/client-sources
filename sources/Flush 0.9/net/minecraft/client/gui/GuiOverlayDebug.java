...
public class GuiOverlayDebug extends Gui {
    ...
    protected List<String> call() {
        ...
        if (this.isReducedDebug()) {
            ...
            ArrayList<String> arraylist = Lists.newArrayList(
                    ...
                    String.format("Chunk: %d %d %d in %d %d %d", blockpos.getX() & 15, blockpos.getY() & 15, blockpos.getZ() & 15,
    ...
    protected List<String> getDebugInfoRight() {
        ...
        if (!this.isReducedDebug()) {
            if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPos() != null) {
                ...
                for (Iterator<Entry<IProperty, Comparable>> iterator = iblockstate.getProperties().entrySet().iterator();
                     iterator.hasNext(); arraylist.add(entry.getKey().getName() + ": " + s)) {
                    entry = iterator.next();
    ...
    private void func_181554_e() {
        ...
        while (k != j) {
            ...
            int j1 = this.func_181552_c(MathHelper.clamp_int(i1, 0, 60), 30, 60);
    ...
    private int func_181552_c(int p_181552_1_, int p_181552_3_, int p_181552_4_) {
