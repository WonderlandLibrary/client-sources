...
public class GuiRepair extends GuiContainer implements ICrafting
{
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        if (this.anvil.maximumCost > 0)
        {
            ...
            else if (!this.anvil.getSlot(2).hasStack())
            {
                flag = false;
            }
    ...
    private void renameItem()
    {
        ...
        if (slot != null && slot.hasStack() && !slot.getStack().hasDisplayName() && s.equals(slot.getStack().getDisplayName()))
        {
            s = "";
        }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        this.drawTexturedModalRect(i + 59, j + 20, 0, this.ySize + (this.anvil.getSlot(0).hasStack() ? 0 : 16), 110, 16);

        if ((this.anvil.getSlot(0).hasStack() || this.anvil.getSlot(1).hasStack()) && !this.anvil.getSlot(2).hasStack())
        {
