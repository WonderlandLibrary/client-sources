...
import me.nyan.flush.login.GuiLogin;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
     ...
     */
    public void initGui() {
        if (Flush.currentUser == null) {
            mc.displayGuiScreen(new GuiLogin());
            return;
        }
        mc.displayGuiScreen(new MainMenu(Flush.currentUser));
    ...
    private void rotateAndBlurSkybox(float p_73968_1_) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            worldrenderer.pos(k, l, zLevel).tex((double) (0.0F + f1), 1.0D).color(1.0F, 1.0F, 1.0F, f).endVertex();
            worldrenderer.pos(k, 0.0D, zLevel).tex((double) (1.0F + f1), 1.0D).color(1.0F, 1.0F, 1.0F, f).endVertex();
            worldrenderer.pos(0.0D, 0.0D, zLevel).tex((double) (1.0F + f1), 0.0D).color(1.0F, 1.0F, 1.0F, f).endVertex();
            worldrenderer.pos(0.0D, l, zLevel).tex((double) (0.0F + f1), 0.0D).color(1.0F, 1.0F, 1.0F, f).endVertex();
        }
