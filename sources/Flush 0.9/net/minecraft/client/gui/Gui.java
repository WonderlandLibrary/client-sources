...
public class Gui {
    ...
    public void drawTexturedModalRect(int x, int y, int textureX, int textureY, int width, int height) {
        ...
        worldrenderer.pos((double) (x), (double) (y + height), (double) this.zLevel).tex((float) (textureX) * f, (double) ((float) (textureY + height) * f1)).endVertex();
        worldrenderer.pos((double) (x + width), y + height, (double) this.zLevel).tex((float) (textureX + width) * f, (double) ((float) (textureY + height) * f1)).endVertex();
        worldrenderer.pos((double) (x + width), y, zLevel).tex((double) ((float) (textureX + width) * f), (float) (textureY) * f1).endVertex();
        worldrenderer.pos((double) (x), (double) (y), zLevel).tex((double) ((float) (textureX) * f), (float) (textureY) * f1).endVertex();
        tessellator.draw();
    }
