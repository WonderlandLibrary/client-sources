                    ...
                    if (chatline != null) {
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                                ...
                                //if (Flush.moduleManager.getModule(HUD.class).chatFont.getValue()) {
                                    //Flush.getFont("GoogleSansDisplay", 20).drawStringWithShadow(s, (float) i2, (float) (j2 - 10) + mc.fontRenderer.FONT_HEIGHT - mc.fontRenderer.FONT_HEIGHT * l1 / 255F, 16777215 + (l1 << 24));
                                //} else {
                                    mc.fontRendererObj.drawStringWithShadow(s, (float) i2, (float) (j2 - 8) + mc.fontRendererObj.FONT_HEIGHT - mc.fontRendererObj.FONT_HEIGHT * l1 / 255F, 16777215 + (l1 << 24));
                                //}
