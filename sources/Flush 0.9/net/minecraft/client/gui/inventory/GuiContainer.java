...
import me.nyan.flush.module.impl.world.ChestStealer;
...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (inventoryplayer.getItemStack() == null && this.theSlot != null && this.theSlot.hasStack())
        {
                ...
                else if (!this.dragSplitting)
                {
                    if (this.mc.thePlayer.inventory.getItemStack() == null)
                    {
                        ...
                        else
                        {
                            ...
                            if (flag2)
                            {
                                this.shiftClickedSlot = slot != null && slot.hasStack() ? slot.getStack() : null;
                                i1 = 1;
                            }
                            else if (l == -999)
                            {
        ...
        if (this.doubleClick && slot != null && state == 0 && this.inventorySlots.canMergeSlot((ItemStack)null, slot))
        {
            if (isShiftKeyDown())
            {
                if (slot != null && slot.inventory != null && this.shiftClickedSlot != null)
                {
                    ...
                    {
                        if (slot2 != null && slot2.canTakeStack(this.mc.thePlayer) && slot2.hasStack() && slot2.inventory == slot.inventory && Container.canAddItemToSlot(slot2, this.shiftClickedSlot, true))
                        {
