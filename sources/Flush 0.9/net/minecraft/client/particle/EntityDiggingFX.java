...
public class EntityDiggingFX extends EntityFX
{
    ...
    public EntityDiggingFX func_174846_a(BlockPos pos)
    {
        ...
        {
            int i = this.field_174847_a.getBlock().colorMultiplier(this.world, pos);
    ...
    public int getBrightnessForRender(float partialTicks)
    {
        ...
        if (this.world.isBlockLoaded(this.field_181019_az))
        {
            j = this.world.getCombinedLight(this.field_181019_az, 0);
        }
