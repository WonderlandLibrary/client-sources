...
public class EntityFirework
{
    ...
    public static class SparkFX extends EntityFX
    {
        ...
        public void onUpdate()
        {
            ...
            {
                EntityFirework.SparkFX entityfirework$sparkfx = new EntityFirework.SparkFX(this.world, this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D, this.field_92047_az);
                entityfirework$sparkfx.setAlphaF(0.99F);
    ...
    public static class StarterFX extends EntityFX
    {
        ...
        public void onUpdate()
        {
            if (this.fireworkAge == 0 && this.fireworkExplosions != null)
            {
                ...
                this.world.playSound(this.posX, this.posY, this.posZ, s1, 20.0F, 0.95F + this.rand.nextFloat() * 0.1F, true);
            }
            ...
            if (this.fireworkAge % 2 == 0 && this.fireworkExplosions != null && this.fireworkAge / 2 < this.fireworkExplosions.tagCount())
            {
                ...
                EntityFirework.OverlayFX entityfirework$overlayfx = new EntityFirework.OverlayFX(this.world, this.posX, this.posY, this.posZ);
            ...
            if (this.fireworkAge > this.particleMaxAge)
            {
                if (this.twinkle)
                {
                    ...
                    this.world.playSound(this.posX, this.posY, this.posZ, s, 20.0F, 0.9F + this.rand.nextFloat() * 0.15F, true);
                }
        ...
        {
            EntityFirework.SparkFX entityfirework$sparkfx = new EntityFirework.SparkFX(this.world, p_92034_1_, p_92034_3_, p_92034_5_, p_92034_7_, p_92034_9_, p_92034_11_, this.theEffectRenderer);
            entityfirework$sparkfx.setAlphaF(0.99F);
