...
public class PotionHelper {
    ...
    public static int getLiquidColor(int dataValue, boolean bypassCache) {
        ...
        if (!bypassCache) {
            if (DATAVALUE_COLORS.containsKey(integer)) return DATAVALUE_COLORS.get(integer);
            else {
                int i = calcPotionLiquidColor(getPotionEffects(integer, false));
                DATAVALUE_COLORS.put(integer, i);
                return i;
            }
        } else return calcPotionLiquidColor(getPotionEffects(integer, true));
    }
    ...
    public static String getPotionPrefix(int dataValue) {
        return potionPrefixes[getPotionPrefixIndex(dataValue)];
    }
    ...
    private static int func_77904_a(boolean p_77904_0_, boolean p_77904_1_, boolean p_77904_2_, int p_77904_3_, int p_77904_4_, int p_77904_5_, int p_77904_6_) {
        ...
        if (p_77904_0_) i = isFlagUnset(p_77904_6_, p_77904_4_);
        else if (p_77904_3_ != -1) {
            if (p_77904_3_ == 0 && countSetFlags(p_77904_6_) == p_77904_4_) i = 1;
            else if (p_77904_3_ == 1 && countSetFlags(p_77904_6_) > p_77904_4_) i = 1;
            else if (p_77904_3_ == 2 && countSetFlags(p_77904_6_) < p_77904_4_) i = 1;
        } else i = isFlagSet(p_77904_6_, p_77904_4_);

        if (p_77904_1_) i *= p_77904_5_;
        if (p_77904_2_) i *= -1;
        ...
        if (p_77912_1_ < p_77912_0_.length() && p_77912_2_ >= 0 && p_77912_1_ < p_77912_2_) {
            ...
            if (i >= 0 && i < p_77912_2_) {
                ...
                if (j >= 0 && j < p_77912_2_) {
                    ...
                    if (flag2) j1 += func_77904_a(flag3, flag1, flag4, b0, l, i1, p_77912_3_);
                ...
                if (s != null) {
                    ...
                    if (i > 0) {
                        ...
                        if (potion.isInstant()) i = 1;
                            ...
                            if ((p_77917_0_ & 16384) != 0) i = (int) Math.round((double) i * 0.75D + 0.5D);
                        }
