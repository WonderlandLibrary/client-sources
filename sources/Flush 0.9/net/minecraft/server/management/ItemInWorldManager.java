...
public class ItemInWorldManager
{
    ...
    public void setGameType(WorldSettings.GameType type)
    {
        ...
        this.thisPlayerMP.server.getConfigurationManager().sendPacketToAllPlayers(new S38PacketPlayerListItem(S38PacketPlayerListItem.Action.UPDATE_GAME_MODE, new EntityPlayerMP[] {this.thisPlayerMP}));
    }
    ...
    public void updateBlockRemoving()
    {
        ...
        if (this.receivedFinishDiggingPacket)
        {
            ...
            {
                float f = block.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.world, this.field_180241_i) * (float)(i + 1);
                int j = (int)(f * 10.0F);
        ...
        else if (this.isDestroyingBlock)
        {
            ...
            else
            {
                ...
                float f1 = block1.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.world, this.field_180241_i) * (float)(k + 1);
                int l = (int)(f1 * 10.0F);
    ...
    public void onBlockClicked(BlockPos pos, EnumFacing side)
    {
        ...
        else
        {
            ...
            if (block.getMaterial() != Material.air)
            {
                ...
                f = block.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.world, pos);
            }
    ...
    public void blockRemoving(BlockPos pos)
    {
        if (pos.equals(this.field_180240_f))
        {
            ...
            if (block.getMaterial() != Material.air)
            {
                float f = block.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.world, pos) * (float)(i + 1);
