...
public abstract class ServerConfigurationManager
{
    ...
    public void initializeConnectionToPlayer(NetworkManager netManager, EntityPlayerMP playerIn)
    {
        ...
        playerIn.theItemInWorldManager.setWorld((WorldServer)playerIn.world);
        String s1 = "local";
    ...
    public EntityPlayerMP recreatePlayerEntity(EntityPlayerMP playerIn, int dimension, boolean conqueredEnd)
    {
        ...
        entityplayermp.playerNetServerHandler.sendPacket(new S07PacketRespawn(entityplayermp.dimension, entityplayermp.world.getDifficulty(), entityplayermp.world.getWorldInfo().getTerrainType(), entityplayermp.theItemInWorldManager.getGameType()));
    ...
    public void transferPlayerToDimension(EntityPlayerMP playerIn, int dimension)
    {
        ...
        playerIn.playerNetServerHandler.sendPacket(new S07PacketRespawn(playerIn.dimension, playerIn.world.getDifficulty(), playerIn.world.getWorldInfo().getTerrainType(), playerIn.theItemInWorldManager.getGameType()));
