...
import me.nyan.flush.event.impl.EventBoundingBox;
...
public class Block {
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        EventBoundingBox event = new EventBoundingBox(getBlockState().getBlock(), pos, axisalignedbb).call();

        if (event.isCancelled()) {
            return;
        }

        if (event.getBoundingBox() != null && mask.intersectsWith(event.getBoundingBox())) {
