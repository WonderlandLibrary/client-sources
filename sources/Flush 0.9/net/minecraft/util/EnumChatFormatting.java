...
public enum EnumChatFormatting {
    ...
    public static Collection<String> getValidValues(boolean colors, boolean styling) {
        List<String> list = Lists.newArrayList();

        for (EnumChatFormatting enumchatformatting : values()) {
            if ((!enumchatformatting.isColor() || colors) && (!enumchatformatting.isFancyStyling() || styling))
