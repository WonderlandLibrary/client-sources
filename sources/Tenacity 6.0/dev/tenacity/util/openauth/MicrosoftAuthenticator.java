 ...
 */
package dev.tenacity.util.openauth;
...
import dev.tenacity.util.openauth.model.request.MinecraftLoginRequest;
import dev.tenacity.util.openauth.model.request.XSTSAuthorizationProperties;
import dev.tenacity.util.openauth.model.request.XboxLiveLoginProperties;
import dev.tenacity.util.openauth.model.request.XboxLoginRequest;
import dev.tenacity.util.openauth.model.response.MicrosoftRefreshResponse;
import dev.tenacity.util.openauth.model.response.MinecraftLoginResponse;
import dev.tenacity.util.openauth.model.response.MinecraftProfile;
import dev.tenacity.util.openauth.model.response.MinecraftStoreResponse;
import dev.tenacity.util.openauth.model.response.XboxLoginResponse;
