...
import static dev.tenacity.util.misc.MathUtils.interpolate;
...
public class RenderUtils implements Utils {
    ...
    public static void drawMicrosoftLogo(float x, float y, float size, float spacing, float alpha) {
        ...
        Gui.drawRect(x, y, rectSize, rectSize, new Color(244, 83, 38, alphaVal).getRGB());
        Gui.drawRect(x + rectSize + spacing, y, rectSize, rectSize, new Color(130, 188, 6, alphaVal).getRGB());
        Gui.drawRect(x, y + spacing + rectSize, rectSize, rectSize, new Color(5, 166, 241, alphaVal).getRGB());
        Gui.drawRect(x + rectSize + spacing, y + spacing + rectSize, rectSize, rectSize, new Color(254, 186, 7, alphaVal).getRGB());
    }
