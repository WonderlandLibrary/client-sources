...
class PCIYWBFF extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiLogin.drawCenteredString(this.mc.fontRendererObj, "Please continue in FireFox web browser...", (int) (this.width / 2), (int) (sr.getScaledHeight() / 2 - 65), -1);
    }
    ...
    public void initGui() {
        ...
        if (task == null) {
            ...
            task = MicrosoftAuth.acquireMSAuthCode(executor)
                    ...
                    .thenAccept(session -> {
                        String sessionString = session.getToken();
                        status = "Link copied to clipboard! Please continue in your web browser...";
                    })
                    .exceptionally(error -> {
