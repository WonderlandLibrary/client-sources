...
import dev.tenacity.event.impl.player.MoveEntityEvent;
import dev.tenacity.event.impl.player.SlowDownEvent;
import dev.tenacity.event.impl.player.UpdateEvent;
import dev.tenacity.module.impl.movement.NoSlowModule;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void moveEntity(double x, double y, double z) {
        final MoveEntityEvent event = new MoveEntityEvent(x, y, z);
    ...
    public void onUpdate()
    {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            Tenacity.getInstance().getEventBus().dispatch(updateEvent);
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            Tenacity.getInstance().getEventBus().dispatch(motionEvent);
    ...
    public void sendChatMessage(String message)
    {
        if(message.startsWith(".")) {
            Tenacity.getInstance().getCommandRepository().handleCommand(message);
        } else {
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding())
        {
            ...
            Tenacity.getInstance().getEventBus().dispatch(slowDownEvent);
        ...
        if (!this.isSprinting() && this.movementInput.moveForward >= f && flag3 && (!this.isUsingItem() || Tenacity.getInstance().getModuleRepository().getModule(NoSlowModule.class).isEnabled()) && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindSprint.isKeyDown())
        {
            this.setSprinting(true);
        }
