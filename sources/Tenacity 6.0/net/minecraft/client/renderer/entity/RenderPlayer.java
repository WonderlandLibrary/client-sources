    ...
    private void setModelVisibilities(AbstractClientPlayer clientPlayer)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                final boolean flag = (Tenacity.getInstance().getModuleRepository().getModule(KillAuraModule.class).isBlocking() && clientPlayer == Minecraft.getMinecraft().thePlayer) || clientPlayer.getItemInUseCount() > 0;
                if (flag)
                {
