...
import dev.tenacity.module.impl.render.BlockAnimationModule;
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0 || Tenacity.getInstance().getModuleRepository().getModule(KillAuraModule.class).isBlocking())
                {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                            final BlockAnimationModule blockAnimationModule = Tenacity.getInstance().getModuleRepository().getModule(BlockAnimationModule.class);
                            if(blockAnimationModule.isEnabled()) {
                                switch(blockAnimationModule.getAnimationMode().getCurrentMode()) {
                                    case "1.7": {
