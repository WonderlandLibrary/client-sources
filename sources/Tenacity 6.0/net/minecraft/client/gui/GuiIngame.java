...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        Tenacity.getInstance().getModuleRepository().getModule(PostProcessing.class).process();
        Tenacity.getInstance().getEventBus().dispatch(new Render2DEvent(scaledresolution));
