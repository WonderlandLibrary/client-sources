...
import dev.tenacity.ui.auth.AltManagerGui;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    private CustomFontRenderer customFontRenderer;
    ...
    public void initGui() {
        ...
        if (calendar.get(2) + 1 == 12 && calendar.get(5) == 24) {
            this.splashText = "Merry X-mas! -Tenacity devs";
        } else if (calendar.get(2) + 1 == 1 && calendar.get(5) == 1) {
            this.splashText = "Happy new year! -Tenacity devs";
...
//        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        String s2 = "Designed by Thoq, Slqnt, River and Nat in the USA";
