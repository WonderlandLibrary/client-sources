         ...
         protocol -> "https".equals(protocol)
               ? new Handler() {
                  ...
                  protected URLConnection openConnection(URL url, Proxy proxy) throws IOException {
                     ...
                     return (URLConnection)((!"login.microsoftonline.com".equals(url.getHost()) || !url.getPath().endsWith("/oauth2/authorize"))
                        ...
                        ? connection
                        : new MicrosoftPatchedHttpURLConnection(url, connection));
                  }
               }
               : null
      );
