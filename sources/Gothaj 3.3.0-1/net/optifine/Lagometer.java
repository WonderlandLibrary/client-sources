      ...
      if (gameSettings != null && (gameSettings.ofLagometer || gameSettings.showLagometer)) {
         ...
         for (int j = 0; j < timesFrame.length; j++) {
            ...
            if (gcs[j]) {
               ...
               float j1 = f - (float)renderTime(j, timesTick[j], 0, k, k, f, worldrenderer);
            }
         }
         ...
         mc.fontRendererObj.drawString("30", 2.0, (double)(k2 + 1), -8947849);
         mc.fontRendererObj.drawString("30", 1.0, (double)k2, -3881788);
         mc.fontRendererObj.drawString("60", 2.0, (double)(j2 + 1), -8947849);
         mc.fontRendererObj.drawString("60", 1.0, (double)j2, -3881788);
         GlStateManager.matrixMode(5889);
         ...
         mc.fontRendererObj.drawString(" " + MemoryMonitor.getAllocationRateMb() + " MB/s", (double)l1, (double)i2, k1);
