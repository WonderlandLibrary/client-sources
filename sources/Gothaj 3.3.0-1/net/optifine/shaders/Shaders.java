...
public class Shaders {
   ...
   static File configFile = new File(Minecraft.getMinecraft().mcDataDir, "optionsshaders.txt");
         ...
         if (name.isEmpty() || name.equals("OFF")) {
            ...
            try {
               ...
               return (IShaderPack)(file1.isDirectory()
                  ? new ShaderPackFolder(name, file1)
   ...
   private static ICustomTexture loadCustomTextureRaw(
      ...
      try {
         ...
         if (inputstream == null) {
            ...
            TextureMetadataSection texturemetadatasection = SimpleShaderTexture.loadTextureMetadataSection(
               s, new TextureMetadataSection(true, true, new ArrayList<>())
            );
   ...
   private static void setupFrameBuffer() {
      ...
      for (int k = 0; k < usedColorBuffers; k++) {
         ...
         GL11.glTexImage2D(3553, 0, gbuffersFormat[k], renderWidth, renderHeight, 0, getPixelFormat(gbuffersFormat[k]), 33639, null);
      ...
      for (int l = 0; l < usedColorBuffers; l++) {
         ...
         GL11.glTexParameteri(3553, 10241, 9729);
         GL11.glTexParameteri(3553, 10240, 9729);
         GL11.glTexImage2D(3553, 0, gbuffersFormat[l], renderWidth, renderHeight, 0, getPixelFormat(gbuffersFormat[l]), 33639, null);
         checkGLError("FT ca");
      }
