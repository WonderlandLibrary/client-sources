...
public class PlayerProfileCache {
   ...
   private void addEntry(GameProfile gameProfile, Date expirationDate) {
      ...
      PlayerProfileCache.ProfileEntry playerprofilecache$profileentry = new PlayerProfileCache.ProfileEntry(gameProfile, expirationDate, null);
   ...
   public void load() {
      ...
      try {
         ...
         List<PlayerProfileCache.ProfileEntry> list = (List<PlayerProfileCache.ProfileEntry>)this.gson.fromJson(bufferedreader, TYPE);
