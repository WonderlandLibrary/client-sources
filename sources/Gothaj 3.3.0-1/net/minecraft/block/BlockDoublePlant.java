...
public class BlockDoublePlant extends BlockBush implements IGrowable {
   ...
   public int damageDropped(IBlockState state) {
      return state.getValue(HALF) != BlockDoublePlant.EnumBlockHalf.UPPER && state.getValue(VARIANT) != BlockDoublePlant.EnumPlantType.GRASS
   ...
   public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list) {
      ...
      for (BlockDoublePlant.EnumPlantType blockdoubleplant$enumplanttype : var7 = BlockDoublePlant.EnumPlantType.values()) {
   ...
   public static enum EnumPlantType implements IStringSerializable {
      ...
      static {
         ...
         for (BlockDoublePlant.EnumPlantType blockdoubleplant$enumplanttype : var3 = values()) {
