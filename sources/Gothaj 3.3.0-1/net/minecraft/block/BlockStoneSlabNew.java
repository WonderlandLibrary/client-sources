...
public abstract class BlockStoneSlabNew extends BlockSlab {
   ...
   public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list) {
      if (itemIn != Item.getItemFromBlock(Blocks.double_stone_slab2)) {
         ...
         for (BlockStoneSlabNew.EnumType blockstoneslabnew$enumtype : var7 = BlockStoneSlabNew.EnumType.values()) {
   ...
   public static enum EnumType implements IStringSerializable {
      ...
      static {
         ...
         for (BlockStoneSlabNew.EnumType blockstoneslabnew$enumtype : var3 = values()) {
