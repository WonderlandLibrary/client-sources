...
public class BlockPortal extends BlockBreakable {
      ...
      if (worldIn.provider.isSurfaceWorld()
         ...
         if (i > 0 && !worldIn.getBlockState(blockpos.up()).getBlock().isNormalCube()) {
            Entity entity = ItemMonsterPlacer.spawnCreature(
               worldIn, 57, (double)blockpos.getX() + 0.5, (double)blockpos.getY() + 1.1, (double)blockpos.getZ() + 0.5
            );
            if (entity != null) {
   ...
   public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
      if (rand.nextInt(100) == 0) {
         worldIn.playSound(
            (double)pos.getX() + 0.5, (double)pos.getY() + 0.5, (double)pos.getZ() + 0.5, "portal.portal", 0.5F, rand.nextFloat() * 0.4F + 0.8F, false
         );
      }
   ...
   public BlockPattern.PatternHelper func_181089_f(World p_181089_1_, BlockPos p_181089_2_) {
      ...
      if (!blockportal$size.func_150860_b()) {
         ...
         for (EnumFacing.AxisDirection enumfacing$axisdirection : var12 = EnumFacing.AxisDirection.values()) {
         ...
         EnumFacing.AxisDirection[] var21;
         for (EnumFacing.AxisDirection enumfacing$axisdirection2 : var21 = EnumFacing.AxisDirection.values()) {
