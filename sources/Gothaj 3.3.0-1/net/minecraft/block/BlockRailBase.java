...
public abstract class BlockRailBase extends Block {
   ...
   protected IBlockState func_176564_a(World worldIn, BlockPos p_176564_2_, IBlockState p_176564_3_, boolean p_176564_4_) {
      return worldIn.isRemote
         ? p_176564_3_
         : new BlockRailBase.Rail(worldIn, p_176564_2_, p_176564_3_).func_180364_a(worldIn.isBlockPowered(p_176564_2_), p_176564_4_).getBlockState();
   }
   ...
   public static enum EnumRailDirection implements IStringSerializable {
      ...
      static {
         ...
         for (BlockRailBase.EnumRailDirection blockrailbase$enumraildirection : var3 = values()) {
