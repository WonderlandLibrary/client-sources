      ...
      if (p_pingServer_1_ != null && !p_pingServer_1_.startsWith("0.0.0.0") && !p_pingServer_1_.isEmpty()) {
               ...
               public void handleServerInfo(S00PacketServerInfo packetIn) {
                  ...
                  if (serverstatusresponse.getPlayerCountData() != null) {
                     ...
                     if (ArrayUtils.isNotEmpty(serverstatusresponse.getPlayerCountData().getPlayers())) {
                        ...
                        GameProfile[] var7;
                        for (GameProfile gameprofile : var7 = serverstatusresponse.getPlayerCountData().getPlayers()) {
         ...
         try {
            networkmanager.sendPacket(
               new C00Handshake(
                  RealmsSharedConstants.NETWORK_PROTOCOL_VERSION, realmsserveraddress.getHost(), realmsserveraddress.getPort(), EnumConnectionState.STATUS
               )
            );
