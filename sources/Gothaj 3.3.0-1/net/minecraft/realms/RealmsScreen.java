...
public class RealmsScreen {
   ...
   public static void blit(int p_blit_0_, int p_blit_1_, float p_blit_2_, float p_blit_3_, int p_blit_4_, int p_blit_5_, float p_blit_6_, float p_blit_7_) {
      Gui.drawModalRectWithCustomSizedTexture(
         (float)p_blit_0_, (float)p_blit_1_, p_blit_2_, p_blit_3_, (double)p_blit_4_, (double)p_blit_5_, (double)p_blit_6_, (double)p_blit_7_
      );
   }

   public void fillGradient(
      int p_fillGradient_1_, int p_fillGradient_2_, int p_fillGradient_3_, int p_fillGradient_4_, int p_fillGradient_5_, int p_fillGradient_6_
   ) {
   ...
   public static RealmsButton newButton(
      int p_newButton_0_, int p_newButton_1_, int p_newButton_2_, int p_newButton_3_, int p_newButton_4_, String p_newButton_5_
   ) {
