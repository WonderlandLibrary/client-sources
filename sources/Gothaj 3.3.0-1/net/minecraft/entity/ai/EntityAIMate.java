...
public class EntityAIMate extends EntityAIBase {
   ...
   private EntityAnimal getNearbyMate() {
      float f = 8.0F;
      List<EntityAnimal> list = this.theWorld
         .getEntitiesWithinAABB(
            (Class<? extends EntityAnimal>)this.theAnimal.getClass(), this.theAnimal.getEntityBoundingBox().expand((double)f, (double)f, (double)f)
         );
   ...
   private void spawnBaby() {
      ...
      if (entityageable != null) {
         ...
         if (this.theWorld.getGameRules().getBoolean("doMobLoot")) {
            this.theWorld
               .spawnEntityInWorld(new EntityXPOrb(this.theWorld, this.theAnimal.posX, this.theAnimal.posY, this.theAnimal.posZ, random.nextInt(7) + 1));
         }
      }
   }
}
