...
public class EntityFishHook extends Entity {
   private static final List<WeightedRandomFishable> JUNK = Arrays.asList(
   ...
   private static final List<WeightedRandomFishable> TREASURE = Arrays.asList(
   ...
   private static final List<WeightedRandomFishable> FISH = Arrays.asList(
   ...
   public void handleHookCasting(double p_146035_1_, double p_146035_3_, double p_146035_5_, float p_146035_7_, float p_146035_8_) {
      ...
      p_146035_1_ += this.rand.nextGaussian() * 0.0075F * (double)p_146035_8_;
      p_146035_3_ += this.rand.nextGaussian() * 0.0075F * (double)p_146035_8_;
      p_146035_5_ += this.rand.nextGaussian() * 0.0075F * (double)p_146035_8_;
      ...
      this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.atan2(p_146035_3_, (double)f1) * 180.0 / Math.PI);
   ...
   public void onUpdate() {
      ...
      if (this.fishPosRotationIncrements > 0) {
         ...
         if (!this.inGround) {
            ...
            this.rotationPitch = (float)(MathHelper.atan2(this.motionY, (double)f5) * 180.0 / Math.PI);
            ...
            if (!this.worldObj.isRemote && d10 > 0.0) {
               ...
               if (this.ticksCatchable > 0) {
                  ...
                  if (this.ticksCatchableDelay <= 0) {
                     ...
                     float f7 = this.fishApproachAngle * (float) (Math.PI / 180.0);
                     ...
                     if (block1 == Blocks.water || block1 == Blocks.flowing_water) {
                        if (this.rand.nextFloat() < 0.15F) {
                           worldserver.spawnParticle(EnumParticleTypes.WATER_BUBBLE, d13, d15 - 0.1F, d16, 1, (double)f10, 0.1, (double)f11, 0.0);
                        }

                        float f3 = f10 * 0.04F;
                        float f4 = f11 * 0.04F;
                        worldserver.spawnParticle(EnumParticleTypes.WATER_WAKE, d13, d15, d16, 0, (double)f4, 0.01, (double)(-f3), 1.0);
                        worldserver.spawnParticle(EnumParticleTypes.WATER_WAKE, d13, d15, d16, 0, (double)(-f4), 0.01, (double)f3, 1.0);
                     }
                  }
                  ...
                  if (this.rand.nextFloat() < f1) {
                     float f9 = MathHelper.randomFloatClamp(this.rand, 0.0F, 360.0F) * (float) (Math.PI / 180.0);
                     ...
                     if (block == Blocks.water || block == Blocks.flowing_water) {
                        worldserver.spawnParticle(EnumParticleTypes.WATER_SPLASH, d12, d14, d6, 2 + this.rand.nextInt(2), 0.1F, 0.0, 0.1F, 0.0);
                     }
                  }
                  ...
                  this.ticksCaughtDelay = this.ticksCaughtDelay - EnchantmentHelper.getLureModifier(this.angler) * 20 * 5;
               }

               if (this.ticksCatchable > 0) {
                  this.motionY = this.motionY - (double)(this.rand.nextFloat() * this.rand.nextFloat() * this.rand.nextFloat()) * 0.2;
               }
            }

            double d11 = d10 * 2.0 - 1.0;
            this.motionY += 0.04F * d11;
            if (d10 > 0.0) {
   ...
   public int handleHookRetraction() {
      if (this.worldObj.isRemote) {
         ...
         if (this.caughtEntity != null) {
            ...
            this.caughtEntity.motionY = this.caughtEntity.motionY + d2 * d8 + (double)MathHelper.sqrt_double(d6) * 0.08;
            ...
            this.angler
               .worldObj
               .spawnEntityInWorld(
                  new EntityXPOrb(this.angler.worldObj, this.angler.posX, this.angler.posY + 0.5, this.angler.posZ + 0.5, this.rand.nextInt(6) + 1)
               );
            i = 1;
         }
