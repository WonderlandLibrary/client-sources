...
public abstract class EntityThrowable extends Entity implements IProjectile {
   ...
   public EntityThrowable(World worldIn, EntityLivingBase throwerIn) {
      ...
      this.setLocationAndAngles(
         throwerIn.posX, throwerIn.posY + (double)throwerIn.getEyeHeight(), throwerIn.posZ, throwerIn.rotationYaw, throwerIn.rotationPitch
      );
   ...
   public void onUpdate() {
      ...
      this.rotationPitch = (float)(MathHelper.atan2(this.motionY, (double)f1) * 180.0 / Math.PI);
