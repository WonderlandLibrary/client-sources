...
public abstract class Entity implements ICommandSender {
   ...
   public void moveEntity(double x, double y, double z) {
      if (this.noClip) {
         ...
         EventGround event = new EventGround(this.isCollidedVertically && d4 < 0.0);
         ...
         try {
            ...
            CrashReport crashreport = CrashReport.makeCrashReport(var53, "Checking entity block collision");
   ...
   public void moveFlying(float strafe, float forward, float friction) {
      EventMoveFlying event = new EventMoveFlying(this.rotationYaw, strafe, forward, friction);
      Client.INSTANCE.getEventBus().call(event);
   ...
   public float getDistanceToEntityRender(Entity entityIn) {
      Minecraft mc = Minecraft.getMinecraft();
      double var10000 = entityIn.lastTickPosX + (entityIn.posX - entityIn.lastTickPosX) * (double)mc.timer.renderPartialTicks;
      mc.getRenderManager();
      float x = (float)(var10000 - RenderManager.renderPosX);
      var10000 = entityIn.lastTickPosY + (entityIn.posY - entityIn.lastTickPosY) * (double)mc.timer.renderPartialTicks;
      mc.getRenderManager();
      float y = (float)(var10000 - RenderManager.renderPosY);
      var10000 = entityIn.lastTickPosZ + (entityIn.posZ - entityIn.lastTickPosZ) * (double)mc.timer.renderPartialTicks;
      mc.getRenderManager();
      float z = (float)(var10000 - RenderManager.renderPosZ);
   ...
   public void updateRidden() {
      if (this.ridingEntity.isDead) {
         ...
         if (this.ridingEntity != null) {
            ...
            this.entityRiderYawDelta = this.entityRiderYawDelta + (double)(this.ridingEntity.rotationYaw - this.ridingEntity.prevRotationYaw);
            this.entityRiderPitchDelta = this.entityRiderPitchDelta + (double)(this.ridingEntity.rotationPitch - this.ridingEntity.prevRotationPitch);
