...
public class EntityZombie extends EntityMob {
   protected static final IAttribute reinforcementChance = new RangedAttribute(null, "zombie.spawnReinforcements", 0.0, 0.0, 1.0)
   ...
   protected void applyEntityAttributes() {
      ...
      this.getAttributeMap().registerAttribute(reinforcementChance).setBaseValue(this.rand.nextDouble() * 0.1F);
   }
         ...
         if (entitylivingbase != null
            ...
            for (int l = 0; l < 50; l++) {
               ...
               if (World.doesBlockHaveSolidTopSurface(this.worldObj, new BlockPos(i1, j1 - 1, k1))
                  ...
                  if (!this.worldObj.isAnyPlayerWithinRangeAt((double)i1, (double)j1, (double)k1, 7.0)
                     && this.worldObj.checkNoEntityCollision(entityzombie.getEntityBoundingBox(), entityzombie)
                     && this.worldObj.getCollidingBoundingBoxes(entityzombie, entityzombie.getEntityBoundingBox()).isEmpty()
   ...
   public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
      ...
      if (livingdata == null) {
         livingdata = new EntityZombie.GroupData(this.worldObj.rand.nextFloat() < 0.05F, this.worldObj.rand.nextFloat() < 0.05F, null);
      }
      ...
      if (livingdata instanceof EntityZombie.GroupData) {
         ...
         if (entityzombie$groupdata.isChild) {
            ...
            if ((double)this.worldObj.rand.nextFloat() < 0.05) {
               List<EntityChicken> list = this.worldObj
                  .getEntitiesWithinAABB(EntityChicken.class, this.getEntityBoundingBox().expand(5.0, 3.0, 5.0), EntitySelectors.IS_STANDALONE);
               if (!list.isEmpty()) {
