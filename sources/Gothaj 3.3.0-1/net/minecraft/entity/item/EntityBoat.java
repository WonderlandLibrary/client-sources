      ...
      if (this.worldObj.isRemote && this.isBoatEmpty) {
         ...
         if (this.riddenByEntity instanceof EntityLivingBase) {
            ...
            this.motionX = this.motionX
               + -Math.sin((double)(f * (float) Math.PI / 180.0F)) * this.speedMultiplier * (double)entitylivingbase.moveForward * 0.05F;
            this.motionZ = this.motionZ
               + Math.cos((double)(f * (float) Math.PI / 180.0F)) * this.speedMultiplier * (double)entitylivingbase.moveForward * 0.05F;
         }
