...
public abstract class EntityLivingBase extends Entity {
   ...
   public void writeEntityToNBT(NBTTagCompound tagCompound) {
      ...
      ItemStack[] var5;
      for (ItemStack itemstack : var5 = this.getInventory()) {
         if (itemstack != null) {
      ...
      for (ItemStack itemstack1 : var5 = this.getInventory()) {
         if (itemstack1 != null) {
         ...
         if (this.getHealth() <= 0.0F) {
            ...
            if (flag) {
               ...
               if (entity != null) {
                  ...
                  this.attackedAtYaw = (float)(MathHelper.atan2(d0, d1) * 180.0 / Math.PI - (double)this.rotationYaw);
   ...
   private int getArmSwingAnimationEnd() {
      return !Client.INSTANCE.getModuleManager().getModule(AnimationsModule.class).isEnabled()
         ? (
         ...
         : (int)AnimationsModule.swingSpeed.getValue();
   }
   ...
   protected void jump() {
      EventJump event = new EventJump(this.rotationYaw, (double)this.getJumpUpwardsMotion());
      ...
      if (!event.isCancelled()) {
         ...
         if (this.isPotionActive(Potion.jump)) {
            this.motionY = this.motionY + (double)((float)(this.getActivePotionEffect(Potion.jump).getAmplifier() + 1) * 0.1F);
         }
   ...
   public void moveEntityWithHeading(float strafe, float forward) {
      ...
      this.limbSwingAmount = this.limbSwingAmount + (f7 - this.limbSwingAmount) * 0.4F;
   ...
   public void onUpdate() {
      ...
      this.onGroundSpeedFactor = this.onGroundSpeedFactor + (f3 - this.onGroundSpeedFactor) * 0.3F;
