...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob {
   ...
   public void onLivingUpdate() {
      ...
      if (this.getHealth() <= 0.0F) {
         ...
         this.worldObj
            .spawnParticle(EnumParticleTypes.EXPLOSION_LARGE, this.posX + (double)f11, this.posY + 2.0 + (double)f13, this.posZ + (double)f14, 0.0, 0.0, 0.0);
      } else {
         this.updateDragonEnderCrystal();
         float f10 = 0.2F / (MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ) * 10.0F + 1.0F);
         f10 *= (float)Math.pow(2.0, this.motionY);
         if (this.slowed) {
         ...
         if (this.isAIDisabled()) {
            ...
            if (this.worldObj.isRemote) {
               ...
               this.randomYawVelocity = (float)((double)this.randomYawVelocity + d6 * (0.7F / d9 / (double)f6));
               ...
               if (this.slowed) {
                  this.moveEntity(this.motionX * 0.8F, this.motionY * 0.8F, this.motionZ * 0.8F);
               } else {
            ...
            if (!this.worldObj.isRemote && this.hurtTime == 0) {
               this.collideWithEntities(
                  this.worldObj
                     .getEntitiesWithinAABBExcludingEntity(this, this.dragonPartWing1.getEntityBoundingBox().expand(4.0, 2.0, 4.0).offset(0.0, -2.0, 0.0))
               );
               this.collideWithEntities(
                  this.worldObj
                     .getEntitiesWithinAABBExcludingEntity(this, this.dragonPartWing2.getEntityBoundingBox().expand(4.0, 2.0, 4.0).offset(0.0, -2.0, 0.0))
               );
               this.attackEntitiesInList(
                  this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.dragonPartHead.getEntityBoundingBox().expand(1.0, 1.0, 1.0))
               );
            }
            ...
            this.dragonPartHead
               .setLocationAndAngles(
                  this.posX + (double)(f18 * 5.5F * f2),
                  this.posY + (adouble[1] - adouble1[1]) * 1.0 + (double)(f15 * 5.5F),
                  this.posZ - (double)(f19 * 5.5F * f2),
                  0.0F,
                  0.0F
               );
            ...
            for (int j = 0; j < 3; j++) {
               ...
               entitydragonpart.setLocationAndAngles(
                  this.posX - (double)((f16 * f23 + f21 * f24) * f2),
                  this.posY + (adouble2[1] - adouble1[1]) * 1.0 - (double)((f24 + f23) * f15) + 1.5,
                  this.posZ + (double)((f4 * f23 + f22 * f24) * f2),
                  0.0F,
                  0.0F
               );
            }
   ...
   private void updateDragonEnderCrystal() {
      ...
      if (this.rand.nextInt(10) == 0) {
         float f = 32.0F;
         List<EntityEnderCrystal> list = this.worldObj
            .getEntitiesWithinAABB(EntityEnderCrystal.class, this.getEntityBoundingBox().expand((double)f, (double)f, (double)f));
   ...
   private void setNewTarget() {
      ...
      if (this.rand.nextInt(2) == 0 && !list.isEmpty()) {
         ...
         do {
            ...
            this.targetZ = 0.0;
            this.targetX = this.targetX + (double)(this.rand.nextFloat() * 120.0F - 60.0F);
            this.targetZ = this.targetZ + (double)(this.rand.nextFloat() * 120.0F - 60.0F);
   ...
   private boolean destroyBlocksInAABB(AxisAlignedBB p_70972_1_) {
      ...
      if (flag1) {
         ...
         this.worldObj.spawnParticle(EnumParticleTypes.EXPLOSION_LARGE, d0, d1, d2, 0.0, 0.0, 0.0);
      }
   ...
   protected void onDeathUpdate() {
      ...
      if (this.deathTicks >= 180 && this.deathTicks <= 200) {
         ...
         this.worldObj
            .spawnParticle(EnumParticleTypes.EXPLOSION_HUGE, this.posX + (double)f, this.posY + 2.0 + (double)f1, this.posZ + (double)f2, 0.0, 0.0, 0.0);
      }
