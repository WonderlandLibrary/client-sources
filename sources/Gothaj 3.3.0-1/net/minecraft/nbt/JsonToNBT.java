...
public class JsonToNBT {
   ...
   static JsonToNBT.Any func_150316_a(String p_150316_0_, String p_150316_1_) throws NBTException {
      ...
      if (p_150316_1_.startsWith("{")) {
         ...
         JsonToNBT.Compound jsontonbt$compound = new JsonToNBT.Compound(p_150316_0_);

         while (p_150316_1_.length() > 0) {
            String s1 = func_150314_a(p_150316_1_, true);
            if (s1.length() > 0) {
               boolean flag1 = false;
         ...
         p_150316_1_ = p_150316_1_.substring(1, p_150316_1_.length() - 1);
         JsonToNBT.List jsontonbt$list = new JsonToNBT.List(p_150316_0_);

         while (p_150316_1_.length() > 0) {
            String s = func_150314_a(p_150316_1_, false);
            if (s.length() > 0) {
               boolean flag = true;
