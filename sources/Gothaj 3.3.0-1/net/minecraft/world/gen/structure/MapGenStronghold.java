...
public class MapGenStronghold extends MapGenStructure {
   ...
   public MapGenStronghold() {
      ...
      BiomeGenBase[] var4;
      for (BiomeGenBase biomegenbase : var4 = BiomeGenBase.getBiomeGenArray()) {
      ...
      if (!this.ranBiomeCheck) {
         ...
         for (int j = 0; j < this.structureCoords.length; j++) {
            ...
            if (j == this.field_82672_i) {
               ...
               this.field_82672_i = this.field_82672_i + 1 + random.nextInt(2);
            }
         }
   ...
   protected StructureStart getStructureStart(int chunkX, int chunkZ) {
      MapGenStronghold.Start mapgenstronghold$start = new MapGenStronghold.Start(this.worldObj, this.rand, chunkX, chunkZ);
