...
public class StructureOceanMonumentPieces {
   ...
   public static class DoubleYRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         for (int i = 1; i <= 5; i += 4) {
            ...
            int var9 = 7;
            if (structureoceanmonumentpieces$roomdefinition1.field_175966_c[EnumFacing.NORTH.getIndex()]) {
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, i, var9, 2, i + 2, var9, field_175826_b, field_175826_b, false);
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, i, var9, 5, i + 2, var9, field_175826_b, field_175826_b, false);
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, i + 2, var9, 4, i + 2, var9, field_175826_b, field_175826_b, false);
            } else {
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, i, var9, 7, i + 2, var9, field_175826_b, field_175826_b, false);
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, i + 1, var9, 7, i + 1, var9, field_175828_a, field_175828_a, false);
            }
            ...
            if (structureoceanmonumentpieces$roomdefinition1.field_175966_c[EnumFacing.EAST.getIndex()]) {
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, var10, i, 2, var10, i + 2, 2, field_175826_b, field_175826_b, false);
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, var10, i, 5, var10, i + 2, 5, field_175826_b, field_175826_b, false);
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, var10, i + 2, 3, var10, i + 2, 4, field_175826_b, field_175826_b, false);
            } else {
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, var10, i, 0, var10, i + 2, 7, field_175826_b, field_175826_b, false);
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, var10, i + 1, 0, var10, i + 1, 7, field_175828_a, field_175828_a, false);
            }
   ...
   static class FitSimpleRoomHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper {
      ...
      @Override
      public StructureOceanMonumentPieces.Piece func_175968_a(
         EnumFacing p_175968_1_, StructureOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_
      ) {
   ...
   public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece {
      ...
      public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
         ...
         list1.add(new StructureOceanMonumentPieces.XYDoubleRoomFitHelper(null));
         list1.add(new StructureOceanMonumentPieces.YZDoubleRoomFitHelper(null));
         list1.add(new StructureOceanMonumentPieces.ZDoubleRoomFitHelper(null));
         list1.add(new StructureOceanMonumentPieces.XDoubleRoomFitHelper(null));
         list1.add(new StructureOceanMonumentPieces.YDoubleRoomFitHelper(null));
         list1.add(new StructureOceanMonumentPieces.FitSimpleRoomTopHelper(null));
         list1.add(new StructureOceanMonumentPieces.FitSimpleRoomHelper(null));
         ...
         for (StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition : list) {
            if (!structureoceanmonumentpieces$roomdefinition.field_175963_d && !structureoceanmonumentpieces$roomdefinition.func_175961_b()) {
               for (StructureOceanMonumentPieces.MonumentRoomFitHelper structureoceanmonumentpieces$monumentroomfithelper : list1) {
                  if (structureoceanmonumentpieces$monumentroomfithelper.func_175969_a(structureoceanmonumentpieces$roomdefinition)) {
                     this.field_175843_q
                        .add(
                           structureoceanmonumentpieces$monumentroomfithelper.func_175968_a(
         ...
         StructureBoundingBox structureboundingbox1 = StructureBoundingBox.func_175899_a(
         ...
         StructureBoundingBox structureboundingbox2 = StructureBoundingBox.func_175899_a(
         ...
         StructureBoundingBox structureboundingbox = StructureBoundingBox.func_175899_a(
      ...
      private List<StructureOceanMonumentPieces.RoomDefinition> func_175836_a(Random p_175836_1_) {
            ...
            for (int j3 = 0; j3 < 5; j3++) {
               for (int i4 = 0; i4 < 3; i4++) {
                  ...
                  if (astructureoceanmonumentpieces$roomdefinition[l4] != null) {
                     EnumFacing[] j5;
                     for (EnumFacing enumfacing : j5 = EnumFacing.values()) {
                        ...
                        if (i1 >= 0 && i1 < 5 && k1 >= 0 && k1 < 5 && j1 >= 0 && j1 < 3) {
                           ...
                           if (astructureoceanmonumentpieces$roomdefinition[l1] != null) {
                              if (k1 != j3) {
                                 astructureoceanmonumentpieces$roomdefinition[l4]
                                    .func_175957_a(enumfacing.getOpposite(), astructureoceanmonumentpieces$roomdefinition[l1]);
                              } else {
         ...
         astructureoceanmonumentpieces$roomdefinition[field_175831_h]
            .func_175957_a(EnumFacing.UP, structureoceanmonumentpieces$roomdefinition = new StructureOceanMonumentPieces.RoomDefinition(1003));
         StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition1;
         astructureoceanmonumentpieces$roomdefinition[field_175832_i]
            .func_175957_a(EnumFacing.SOUTH, structureoceanmonumentpieces$roomdefinition1 = new StructureOceanMonumentPieces.RoomDefinition(1001));
         StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition2;
         astructureoceanmonumentpieces$roomdefinition[field_175829_j]
            .func_175957_a(EnumFacing.SOUTH, structureoceanmonumentpieces$roomdefinition2 = new StructureOceanMonumentPieces.RoomDefinition(1002));
            ...
            while (j5 < 2 && k5 < 5) {
               ...
               if (structureoceanmonumentpieces$roomdefinition3.field_175966_c[l5]) {
                  ...
                  if (structureoceanmonumentpieces$roomdefinition3.func_175959_a(i5++)
                     && structureoceanmonumentpieces$roomdefinition3.field_175965_b[l5].func_175959_a(i5++)) {
                     j5++;
                  } else {
      ...
      private void func_175840_a(boolean p_175840_1_, int p_175840_2_, World worldIn, Random p_175840_4_, StructureBoundingBox p_175840_5_) {
         ...
         if (this.func_175818_a(p_175840_5_, p_175840_2_, 0, p_175840_2_ + 23, 20)) {
            ...
            for (int j = 0; j < 4; j++) {
               ...
               this.fillWithBlocks(
                  worldIn, p_175840_5_, p_175840_2_ + j + 7, j + 5, j + 7, p_175840_2_ + j + 7, j + 5, 20, field_175826_b, field_175826_b, false
               );
               this.fillWithBlocks(
                  worldIn, p_175840_5_, p_175840_2_ + 17 - j, j + 5, j + 7, p_175840_2_ + 17 - j, j + 5, 20, field_175826_b, field_175826_b, false
               );
               ...
               this.fillWithBlocks(
                  worldIn, p_175840_5_, p_175840_2_ + j + 8, j + 5, j + 7, p_175840_2_ + 16 - j, j + 5, j + 7, field_175826_b, field_175826_b, false
               );
            }
   ...
   public static class MonumentCoreRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         for (int var8 = 3; var8 <= 6; var8 += 3) {
            for (int k = 6; k <= 9; k += 3) {
               this.setBlockState(worldIn, field_175825_e, k, var8, 6, structureBoundingBoxIn);
               this.setBlockState(worldIn, field_175825_e, k, var8, 9, structureBoundingBoxIn);
            }
         }
   ...
   public abstract static class Piece extends StructureComponent {
      ...
      protected Piece(
         int p_i45590_1_, EnumFacing p_i45590_2_, StructureOceanMonumentPieces.RoomDefinition p_i45590_3_, int p_i45590_4_, int p_i45590_5_, int p_i45590_6_
      ) {
         super(p_i45590_1_);
      ...
      protected void func_175821_a(World worldIn, StructureBoundingBox p_175821_2_, int p_175821_3_, int p_175821_4_, boolean p_175821_5_) {
         if (p_175821_5_) {
            this.fillWithBlocks(
               worldIn, p_175821_2_, p_175821_3_ + 0, 0, p_175821_4_ + 0, p_175821_3_ + 2, 0, p_175821_4_ + 8 - 1, field_175828_a, field_175828_a, false
            );
            this.fillWithBlocks(
               worldIn, p_175821_2_, p_175821_3_ + 5, 0, p_175821_4_ + 0, p_175821_3_ + 8 - 1, 0, p_175821_4_ + 8 - 1, field_175828_a, field_175828_a, false
            );
            this.fillWithBlocks(
               worldIn, p_175821_2_, p_175821_3_ + 3, 0, p_175821_4_ + 0, p_175821_3_ + 4, 0, p_175821_4_ + 2, field_175828_a, field_175828_a, false
            );
            this.fillWithBlocks(
               worldIn, p_175821_2_, p_175821_3_ + 3, 0, p_175821_4_ + 5, p_175821_3_ + 4, 0, p_175821_4_ + 8 - 1, field_175828_a, field_175828_a, false
            );
            this.fillWithBlocks(
               worldIn, p_175821_2_, p_175821_3_ + 3, 0, p_175821_4_ + 2, p_175821_3_ + 4, 0, p_175821_4_ + 2, field_175826_b, field_175826_b, false
            );
            this.fillWithBlocks(
               worldIn, p_175821_2_, p_175821_3_ + 3, 0, p_175821_4_ + 5, p_175821_3_ + 4, 0, p_175821_4_ + 5, field_175826_b, field_175826_b, false
            );
            this.fillWithBlocks(
               worldIn, p_175821_2_, p_175821_3_ + 2, 0, p_175821_4_ + 3, p_175821_3_ + 2, 0, p_175821_4_ + 4, field_175826_b, field_175826_b, false
            );
            this.fillWithBlocks(
               worldIn, p_175821_2_, p_175821_3_ + 5, 0, p_175821_4_ + 3, p_175821_3_ + 5, 0, p_175821_4_ + 4, field_175826_b, field_175826_b, false
            );
         } else {
            this.fillWithBlocks(
               worldIn, p_175821_2_, p_175821_3_ + 0, 0, p_175821_4_ + 0, p_175821_3_ + 8 - 1, 0, p_175821_4_ + 8 - 1, field_175828_a, field_175828_a, false
            );
         }
      }

      protected void func_175819_a(
         World worldIn,
   ...
   public static class SimpleRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         boolean flag = this.field_175833_o != 0
            && randomIn.nextBoolean()
         ...
         for (int i = 1; i <= 6; i++) {
            for (int j = 1; j <= 6; j++) {
               if (randomIn.nextInt(3) != 0) {
                  ...
                  this.fillWithBlocks(
                     worldIn, structureBoundingBoxIn, i, k, j, i, 3, j, Blocks.sponge.getStateFromMeta(1), Blocks.sponge.getStateFromMeta(1), false
                  );
               }
            }
         }
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         if (this.field_175834_o == 0) {
            ...
            for (int k1 = 0; k1 < 2; k1++) {
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, var10, 0, 10, var10, 6, 10, field_175826_b, field_175826_b, false);
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, var10, 0, 12, var10, 6, 12, field_175826_b, field_175826_b, false);
               this.setBlockState(worldIn, field_175825_e, var10, 0, 10, structureBoundingBoxIn);
               this.setBlockState(worldIn, field_175825_e, var10, 0, 12, structureBoundingBoxIn);
               this.setBlockState(worldIn, field_175825_e, var10, 4, 10, structureBoundingBoxIn);
               this.setBlockState(worldIn, field_175825_e, var10, 4, 12, structureBoundingBoxIn);
               var10 = 12;
            }
            ...
            for (int l1 = 0; l1 < 2; l1++) {
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, var10, 0, 7, var10, 2, 7, field_175826_b, field_175826_b, false);
               this.fillWithBlocks(worldIn, structureBoundingBoxIn, var10, 0, 14, var10, 2, 14, field_175826_b, field_175826_b, false);
               var10 = 14;
            }
      ...
      public boolean func_175969_a(StructureOceanMonumentPieces.RoomDefinition p_175969_1_) {
         if (p_175969_1_.field_175966_c[EnumFacing.EAST.getIndex()]
            ...
            return structureoceanmonumentpieces$roomdefinition.field_175966_c[EnumFacing.UP.getIndex()]
               && !structureoceanmonumentpieces$roomdefinition.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d;
         } else {
            return false;
         }
      }
