                  ...
                  public String call() throws Exception {
                     try {
                        return String.format(
                           "ID #%d (%s // %s)", Block.getIdFromBlock(blockIn), blockIn.getUnlocalizedName(), blockIn.getClass().getCanonicalName()
                        );
      ...
      if (!this.isAreaLoaded(i, k, i1, j, l, j1, true)) {
         ...
         if (vec3.lengthVector() > 0.0 && entityIn.isPushedByWater()) {
            ...
            if (!event.isCancelled()) {
               entityIn.motionX = entityIn.motionX + vec3.xCoord * d1;
               entityIn.motionY = entityIn.motionY + vec3.yCoord * d1;
               entityIn.motionZ = entityIn.motionZ + vec3.zCoord * d1;
            }
         }
            ...
            block instanceof BlockStairs
               ...
               : (
                  block instanceof BlockSlab
                     ...
                     : (block instanceof BlockHopper ? true : (block instanceof BlockSnow ? iblockstate.getValue(BlockSnow.LAYERS) == 7 : false))
               )
         );
   }
   ...
   private int getRawLight(BlockPos pos, EnumSkyBlock lightType) {
      if (lightType == EnumSkyBlock.SKY && this.canSeeSky(pos)) {
         ...
         if (j >= 15) {
            ...
            EnumFacing[] var9;
            for (EnumFacing enumfacing : var9 = EnumFacing.values()) {
               ...
               if (i3 == l2) {
                  ...
                  if (l2 > 0) {
                     ...
                     if (j3 + k3 + l3 < 17) {
                        ...
                        EnumFacing[] var24;
                        for (EnumFacing enumfacing : var24 = EnumFacing.values()) {
