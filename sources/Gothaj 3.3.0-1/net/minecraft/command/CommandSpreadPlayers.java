...
public class CommandSpreadPlayers extends CommandBase {
   ...
   private void func_110669_a(
      ICommandSender p_110669_1_,
      List<Entity> p_110669_2_,
      CommandSpreadPlayers.Position p_110669_3_,
      double p_110669_4_,
      double p_110669_6_,
      World worldIn,
      boolean p_110669_9_
      ...
      CommandSpreadPlayers.Position[] acommandspreadplayers$position = this.func_110670_a(
         random, p_110669_9_ ? this.func_110667_a(p_110669_2_) : p_110669_2_.size(), d0, d1, d2, d3
      );
      ...
      notifyOperators(
         p_110669_1_,
         this,
         "commands.spreadplayers.success." + (p_110669_9_ ? "teams" : "players"),
      ...
      if (acommandspreadplayers$position.length > 1) {
         p_110669_1_.addChatMessage(
            new ChatComponentTranslation("commands.spreadplayers.info." + (p_110669_9_ ? "teams" : "players"), String.format("%.2f", d4), i)
         );
      }
   }
   ...
   private int func_110668_a(
      CommandSpreadPlayers.Position p_110668_1_,
      double p_110668_2_,
      World worldIn,
      Random p_110668_5_,
      double p_110668_6_,
         ...
         for (int j = 0; j < p_110668_14_.length; j++) {
            ...
            for (int l = 0; l < p_110668_14_.length; l++) {
               if (j != l) {
                  ...
                  if (d1 < p_110668_2_) {
                     k++;
                     commandspreadplayers$position1.field_111101_a = commandspreadplayers$position1.field_111101_a
                        + (commandspreadplayers$position2.field_111101_a - commandspreadplayers$position.field_111101_a);
                     commandspreadplayers$position1.field_111100_b = commandspreadplayers$position1.field_111100_b
                        + (commandspreadplayers$position2.field_111100_b - commandspreadplayers$position.field_111100_b);
                  }
               }
            }
      ...
      if (i >= 10000) {
         throw new CommandException(
            "commands.spreadplayers.failure." + (p_110668_15_ ? "teams" : "players"),
            p_110668_14_.length,
            p_110668_1_.field_111101_a,
            p_110668_1_.field_111100_b,
            String.format("%.2f", d0)
         );
      } else {
         return i;
   ...
   private double func_110671_a(List<Entity> p_110671_1_, World worldIn, CommandSpreadPlayers.Position[] p_110671_3_, boolean p_110671_4_) {
      ...
      for (int j = 0; j < p_110671_1_.size(); j++) {
         ...
         entity.setPositionAndUpdate(
            ...
            (double)MathHelper.floor_double(commandspreadplayers$position.field_111100_b) + 0.5
         );
   ...
   private CommandSpreadPlayers.Position[] func_110670_a(
      Random p_110670_1_, int p_110670_2_, double p_110670_3_, double p_110670_5_, double p_110670_7_, double p_110670_9_
   ) {
   ...
   static class Position {
      ...
      public void func_111094_b(CommandSpreadPlayers.Position p_111094_1_) {
         this.field_111101_a = this.field_111101_a - p_111094_1_.field_111101_a;
         this.field_111100_b = this.field_111100_b - p_111094_1_.field_111100_b;
      }
