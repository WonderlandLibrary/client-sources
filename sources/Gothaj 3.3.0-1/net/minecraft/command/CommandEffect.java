...
public class CommandEffect extends CommandBase {
         ...
         if (args[1].equals("clear")) {
            ...
            if (l > 0) {
               ...
               notifyOperators(
                  ...
                  new Object[]{new ChatComponentTranslation(potioneffect.getEffectName()), i, k, entitylivingbase.getName(), l}
               );
            } else {
               ...
               notifyOperators(
                  sender, this, "commands.effect.success.removed", new Object[]{new ChatComponentTranslation(potion1.getName()), entitylivingbase.getName()}
               );
            }
         }
      }
   ...
   public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
      return args.length == 1
         ...
         : (
            args.length == 2
               ? getListOfStringsMatchingLastWord(args, Potion.getPotionLocations())
