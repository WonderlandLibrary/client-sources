   ...
   public void update() {
      ...
      if (entityplayer != null) {
         ...
         if (this.bookSpread < 0.5F || rand.nextInt(40) == 0) {
            ...
            do {
               this.field_145932_k = this.field_145932_k + (float)(rand.nextInt(4) - rand.nextInt(4));
      ...
      float f2 = this.field_145924_q - this.bookRotation;
      ...
      this.field_145929_l = this.field_145929_l + (f - this.field_145929_l) * 0.9F;
      this.pageFlip = this.pageFlip + this.field_145929_l;
   }
