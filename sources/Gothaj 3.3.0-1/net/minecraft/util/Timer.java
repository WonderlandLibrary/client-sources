   ...
   public void updateTimer() {
      ...
      if (j <= 1000L && j >= 0L) {
         ...
         if (this.counter > 1000L) {
            ...
            this.timeSyncAdjustment = this.timeSyncAdjustment + (d1 - this.timeSyncAdjustment) * 0.2F;
      ...
      this.elapsedPartialTicks = this.elapsedPartialTicks - (float)this.elapsedTicks;
