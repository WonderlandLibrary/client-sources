...
public class LongHashMap<V> {
   ...
   private void resizeTable(int p_76153_1_) {
      LongHashMap.Entry[] entry = this.hashArray;
      int i = entry.length;
      if (i == 1073741824) {
         this.capacity = Integer.MAX_VALUE;
      } else {
         LongHashMap.Entry[] entry1 = new LongHashMap.Entry[p_76153_1_];
   ...
   final LongHashMap.Entry<V> removeKey(long p_76152_1_) {
      ...
      LongHashMap.Entry<V> entry1 = entry;
   ...
   static class Entry<V> {
      ...
      public final boolean equals(Object p_equals_1_) {
         if (!(p_equals_1_ instanceof LongHashMap.Entry)) {
            ...
            LongHashMap.Entry<V> entry = (LongHashMap.Entry<V>)p_equals_1_;
