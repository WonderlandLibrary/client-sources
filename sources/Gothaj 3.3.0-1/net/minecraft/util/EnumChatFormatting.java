...
public enum EnumChatFormatting {
   ...
   static {
      ...
      for (EnumChatFormatting enumchatformatting : var3 = values()) {
   ...
   public static EnumChatFormatting func_175744_a(int p_175744_0_) {
      if (p_175744_0_ < 0) {
         ...
         for (EnumChatFormatting enumchatformatting : var4 = values()) {
   ...
   public static Collection<String> getValidValues(boolean p_96296_0_, boolean p_96296_1_) {
      ...
      for (EnumChatFormatting enumchatformatting : var6 = values()) {
