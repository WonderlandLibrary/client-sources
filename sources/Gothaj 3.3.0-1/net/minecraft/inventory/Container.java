   ...
   public ItemStack slotClick(int slotId, int clickedButton, int mode, EntityPlayer playerIn) {
      ...
      if (mode == 5) {
         ...
         if ((i != 1 || this.dragEvent != 2) && i != this.dragEvent) {
            ...
            if (slot != null
               && canAddItemToSlot(slot, inventoryplayer.getItemStack(), true)
            ...
            if (!this.dragSlots.isEmpty()) {
               ...
               for (Slot slot1 : this.dragSlots) {
                  if (slot1 != null
                     && canAddItemToSlot(slot1, inventoryplayer.getItemStack(), true)
            ...
            if (slot7 != null) {
               ...
               if (itemstack9 == null) {
                  ...
                  if (itemstack10 == null) {
                     ...
                     && itemstack10.getMaxStackSize() > 1
                     && (!itemstack9.getHasSubtypes() || itemstack9.getMetadata() == itemstack10.getMetadata())
                     && ItemStack.areItemStackTagsEqual(itemstack9, itemstack10)) {
         ...
         if (itemstack4 != null && (slot2 == null || !slot2.getHasStack() || !slot2.canTakeStack(playerIn))) {
            ...
            for (int l2 = 0; l2 < 2; l2++) {
               for (int i3 = i1; i3 >= 0 && i3 < this.inventorySlots.size() && itemstack4.stackSize < itemstack4.getMaxStackSize(); i3 += j1) {
                  ...
                  if (slot8.getHasStack()
                     && canAddItemToSlot(slot8, itemstack4, true)
                     && slot8.canTakeStack(playerIn)
         ...
         while (stack.stackSize > 0 && (!reverseDirection && i < endIndex || reverseDirection && i >= startIndex)) {
            ...
            if (itemstack != null
               ...
               if (j <= stack.getMaxStackSize()) {
                  ...
                  stack.stackSize = stack.stackSize - (stack.getMaxStackSize() - itemstack.stackSize);
