...
public class SlotFurnaceOutput extends Slot {
   ...
   public ItemStack decrStackSize(int amount) {
      if (this.getHasStack()) {
         this.field_75228_b = this.field_75228_b + Math.min(amount, this.getStack().stackSize);
      }
   ...
   protected void onCrafting(ItemStack stack) {
      ...
      if (!this.thePlayer.worldObj.isRemote) {
         ...
         while (i > 0) {
            ...
            this.thePlayer
               .worldObj
               .spawnEntityInWorld(new EntityXPOrb(this.thePlayer.worldObj, this.thePlayer.posX, this.thePlayer.posY + 0.5, this.thePlayer.posZ + 0.5, k));
         }
      }
