...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry {
   ...
   public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
      ...
      if (i != 1) {
         ...
         Gui.drawRect((double)(x - 1), (double)(y - 1), (double)(x + listWidth - 9), (double)(y + slotHeight + 1), -8978432);
      }

      this.func_148313_c();
      GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
      Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 0.0F, 0.0F, 32.0, 32.0, 32.0, 32.0);
      ...
      if ((this.mc.gameSettings.touchscreen || isSelected) && this.func_148310_d()) {
         ...
         Gui.drawRect((double)x, (double)y, (double)(x + 32), (double)(y + 32), -1601138544);
         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
         int j = mouseX - x;
         int k = mouseY - y;
         if (i < 1) {
         ...
         if (this.func_148309_e()) {
            if (j < 32) {
               Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 0.0F, 32.0F, 32.0, 32.0, 256.0, 256.0);
            } else {
               Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 0.0F, 0.0F, 32.0, 32.0, 256.0, 256.0);
            }
         } else {
            if (this.func_148308_f()) {
               if (j < 16) {
                  Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 32.0F, 32.0F, 32.0, 32.0, 256.0, 256.0);
               } else {
                  Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 32.0F, 0.0F, 32.0, 32.0, 256.0, 256.0);
               }
            }

            if (this.func_148314_g()) {
               if (j < 32 && j > 16 && k < 16) {
                  Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 96.0F, 32.0F, 32.0, 32.0, 256.0, 256.0);
               } else {
                  Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 96.0F, 0.0F, 32.0, 32.0, 256.0, 256.0);
               }
            }

            if (this.func_148307_h()) {
               if (j < 32 && j > 16 && k > 16) {
                  Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 64.0F, 32.0F, 32.0, 32.0, 256.0, 256.0);
               } else {
                  Gui.drawModalRectWithCustomSizedTexture((float)x, (float)y, 64.0F, 0.0F, 32.0, 32.0, 256.0, 256.0);
               }
            }
         }
      }
      ...
      this.mc.fontRendererObj.drawStringWithShadow(s, (double)((float)(x + 32 + 2)), (double)((float)(y + 1)), 16777215);
      List<String> list = this.mc.fontRendererObj.listFormattedStringToWidth(s1, 157);

      for (int l = 0; l < 2 && l < list.size(); l++) {
         this.mc.fontRendererObj.drawStringWithShadow(list.get(l), (double)((float)(x + 32 + 2)), (double)((float)(y + 12 + 10 * l)), 8421504);
      }
   }
