            ...
            if (flag) {
               ...
               this.mc
                  ...
                  .drawStringWithShadow(
                     ...
                     (double)((float)((k - this.mc.fontRendererObj.getStringWidth(this.currentlyDisplayedText)) / 2)),
                     (double)((float)(l / 2 - 4 - 16)),
                     16777215
                  );
               this.mc
                  .fontRendererObj
                  .drawStringWithShadow(
                     this.message,
                     (double)((float)((k - this.mc.fontRendererObj.getStringWidth(this.message)) / 2)),
                     (double)((float)(l / 2 - 4 + 8)),
                     16777215
                  );
            }
