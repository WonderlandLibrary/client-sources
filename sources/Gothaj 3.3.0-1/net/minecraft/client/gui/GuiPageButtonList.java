...
public class GuiPageButtonList extends GuiListExtended {
   ...
   private void func_178060_e(int p_178060_1_, int p_178060_2_) {
      ...
      for (GuiPageButtonList.GuiListEntry guipagebuttonlist$guilistentry : var6 = this.field_178078_x[p_178060_1_]) {
      ...
      for (GuiPageButtonList.GuiListEntry guipagebuttonlist$guilistentry1 : var6 = this.field_178078_x[p_178060_2_]) {
   ...
   private Gui func_178058_a(GuiPageButtonList.GuiListEntry p_178058_1_, int p_178058_2_, boolean p_178058_3_) {
      return (Gui)(p_178058_1_ instanceof GuiPageButtonList.GuiSlideEntry
         ? this.func_178067_a(this.width / 2 - 155 + p_178058_2_, 0, (GuiPageButtonList.GuiSlideEntry)p_178058_1_)
         : (
            p_178058_1_ instanceof GuiPageButtonList.GuiButtonEntry
               ? this.func_178065_a(this.width / 2 - 155 + p_178058_2_, 0, (GuiPageButtonList.GuiButtonEntry)p_178058_1_)
               : (
                  p_178058_1_ instanceof GuiPageButtonList.EditBoxEntry
                     ? this.func_178068_a(this.width / 2 - 155 + p_178058_2_, 0, (GuiPageButtonList.EditBoxEntry)p_178058_1_)
                     : (
                        p_178058_1_ instanceof GuiPageButtonList.GuiLabelEntry
                           ? this.func_178063_a(this.width / 2 - 155 + p_178058_2_, 0, (GuiPageButtonList.GuiLabelEntry)p_178058_1_, p_178058_3_)
                           : null
                     )
               )
         ));
   ...
   private GuiListButton func_178065_a(int p_178065_1_, int p_178065_2_, GuiPageButtonList.GuiButtonEntry p_178065_3_) {
      GuiListButton guilistbutton = new GuiListButton(
         this.field_178076_z, p_178065_3_.func_178935_b(), p_178065_1_, p_178065_2_, p_178065_3_.func_178936_c(), p_178065_3_.func_178940_a()
      );
      ...
      if (this.field_178075_A instanceof GuiTextField) {
         ...
         if (!GuiScreen.isKeyComboCtrlV(p_178062_2_)) {
            if (p_178062_2_ == 15) {
               ...
               if (l > this.bottom) {
                  this.amountScrolled = this.amountScrolled + (float)(l - this.bottom);
               } else if (i1 < this.top) {
   ...
   public static class EditBoxEntry extends GuiPageButtonList.GuiListEntry {
      ...
      public EditBoxEntry(int p_i45534_1_, String p_i45534_2_, boolean p_i45534_3_, Predicate<String> p_i45534_4_) {
         ...
         this.field_178951_a = (Predicate<String>)Objects.firstNonNull(p_i45534_4_, Predicates.alwaysTrue());
      }
