...
public class GuiMerchant extends GuiContainer {
   ...
   protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
      ...
      this.fontRendererObj.drawString(s, (double)(this.xSize / 2 - this.fontRendererObj.getStringWidth(s) / 2), 6.0, 4210752);
      this.fontRendererObj.drawString(I18n.format("container.inventory"), 8.0, (double)(this.ySize - 96 + 2), 4210752);
   }
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (merchantrecipelist != null && !merchantrecipelist.isEmpty()) {
         ...
         if (this.isPointInRegion(36, 24, 16, 16, mouseX, mouseY) && itemstack != null) {
            ...
            && (this.isPointInRegion(83, 21, 28, 21, mouseX, mouseY) || this.isPointInRegion(83, 51, 28, 21, mouseX, mouseY))) {
