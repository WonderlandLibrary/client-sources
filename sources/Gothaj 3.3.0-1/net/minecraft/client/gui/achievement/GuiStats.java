...
public class GuiStats extends GuiScreen implements IProgressMeter {
   ...
   private void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
      ...
      worldrenderer.pos((double)(p_146527_1_ + 0), (double)(p_146527_2_ + 18), (double)zLevel)
         .tex((double)((float)(p_146527_3_ + 0) * 0.0078125F), (double)((float)(p_146527_4_ + 18) * 0.0078125F))
         .endVertex();
      worldrenderer.pos((double)(p_146527_1_ + 18), (double)(p_146527_2_ + 18), (double)zLevel)
         .tex((double)((float)(p_146527_3_ + 18) * 0.0078125F), (double)((float)(p_146527_4_ + 18) * 0.0078125F))
         .endVertex();
      worldrenderer.pos((double)(p_146527_1_ + 18), (double)(p_146527_2_ + 0), (double)zLevel)
         .tex((double)((float)(p_146527_3_ + 18) * 0.0078125F), (double)((float)(p_146527_4_ + 0) * 0.0078125F))
         .endVertex();
      worldrenderer.pos((double)(p_146527_1_ + 0), (double)(p_146527_2_ + 0), (double)zLevel)
         .tex((double)((float)(p_146527_3_ + 0) * 0.0078125F), (double)((float)(p_146527_4_ + 0) * 0.0078125F))
         .endVertex();
      tessellator.draw();
   }
      ...
      protected void func_148209_a(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_) {
         if (p_148209_1_ != null) {
            ...
            GuiStats.this.drawString(
               ...
               s,
               p_148209_2_ - GuiStats.this.fontRendererObj.getStringWidth(s),
               p_148209_3_ + 5,
            ...
            GuiStats.this.drawString(
               GuiStats.this.fontRendererObj,
               s1,
               p_148209_2_ - GuiStats.this.fontRendererObj.getStringWidth(s1),
               p_148209_3_ + 5,
               p_148209_4_ ? 16777215 : 9474192
            );
         }
         ...
         if (p_148142_2_ >= this.top && p_148142_2_ <= this.bottom) {
            ...
            if (i >= 0) {
               ...
               if (s.length() > 0) {
                  ...
                  GuiStats.drawGradientRect((double)(k - 3), (double)(l - 3), (double)(k + i1 + 3), (double)(l + 8 + 3), -1073741824, -1073741824);
                  GuiStats.this.fontRendererObj.drawStringWithShadow(s, (double)((float)k), (double)((float)l), -1);
               }
            }
         }
      }
      ...
      protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_) {
         if (p_148213_1_ != null) {
            ...
            if (s1.length() > 0) {
               ...
               GuiStats.drawGradientRect((double)(i - 3), (double)(j - 3), (double)(i + k + 3), (double)(j + 8 + 3), -1073741824, -1073741824);
               GuiStats.this.fontRendererObj.drawStringWithShadow(s1, (double)((float)i), (double)((float)j), -1);
            }
         }
      }
   ...
   class StatsGeneral extends GuiSlot {
      ...
      protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
         ...
         GuiStats.this.drawString(
            GuiStats.this.fontRendererObj, statbase.getStatName().getUnformattedText(), p_180791_2_ + 2, p_180791_3_ + 1, entryID % 2 == 0 ? 16777215 : 9474192
         );
         String s = statbase.format(GuiStats.this.field_146546_t.readStat(statbase));
         GuiStats.this.drawString(
            GuiStats.this.fontRendererObj,
            s,
            p_180791_2_ + 2 + 213 - GuiStats.this.fontRendererObj.getStringWidth(s),
            p_180791_3_ + 1,
   ...
   class StatsMobsList extends GuiSlot {
      ...
      protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
         ...
         GuiStats.this.drawString(
            GuiStats.this.fontRendererObj, s1, p_180791_2_ + 2, p_180791_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT, i == 0 ? 6316128 : 9474192
         );
         GuiStats.this.drawString(
            GuiStats.this.fontRendererObj, s2, p_180791_2_ + 2, p_180791_3_ + 1 + GuiStats.this.fontRendererObj.FONT_HEIGHT * 2, j == 0 ? 6316128 : 9474192
         );
      }
   }
}
