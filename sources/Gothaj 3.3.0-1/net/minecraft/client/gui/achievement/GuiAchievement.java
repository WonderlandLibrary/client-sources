   ...
   public void updateAchievementWindow() {
      if (this.theAchievement != null && this.notificationTime != 0L && Minecraft.getMinecraft().thePlayer != null) {
         ...
         if (this.permanentNotification) {
            ...
            this.mc.fontRendererObj.drawString(this.achievementTitle, (double)(i + 30), (double)(j + 7), -256);
            this.mc.fontRendererObj.drawString(this.achievementDescription, (double)(i + 30), (double)(j + 18), -1);
         }
