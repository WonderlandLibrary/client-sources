...
public class GuiAchievements extends GuiScreen implements IProgressMeter {
         ...
         if (Mouse.isButtonDown(0)) {
            ...
            if ((this.field_146554_D == 0 || this.field_146554_D == 1) && mouseX >= k && mouseX < k + 224 && mouseY >= l && mouseY < l + 155) {
               if (this.field_146554_D == 0) {
                  ...
                  this.field_146567_u = this.field_146567_u - (double)((float)(mouseX - this.field_146563_h) * this.field_146570_r);
                  this.field_146566_v = this.field_146566_v - (double)((float)(mouseY - this.field_146564_i) * this.field_146570_r);
   ...
   protected void drawTitle() {
      int i = (this.width - this.field_146555_f) / 2;
      int j = (this.height - this.field_146557_g) / 2;
      this.fontRendererObj.drawString(I18n.format("gui.achievements"), (double)(i + 15), (double)(j + 5), 4210752);
   }
   ...
   protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
      ...
      if (achievement != null) {
         ...
         if (this.statFileWriter.canUnlockAchievement(achievement)) {
            ...
            drawGradientRect((double)(i7 - 3), (double)(k7 - 3), (double)(i7 + j8 + 3), (double)(k7 + i9 + 3 + 12), -1073741824, -1073741824);
            this.fontRendererObj.drawSplitString(s1, i7, k7 + 12, j8, -6250336);
            if (this.statFileWriter.hasAchievementUnlocked(achievement)) {
               this.fontRendererObj.drawStringWithShadow(I18n.format("achievement.taken"), (double)((float)i7), (double)((float)(k7 + i9 + 4)), -7302913);
            }
         } else if (i8 == 3) {
            ...
            drawGradientRect((double)(i7 - 3), (double)(k7 - 3), (double)(i7 + k8 + 3), (double)(k7 + i5 + 12 + 3), -1073741824, -1073741824);
            ...
            drawGradientRect((double)(i7 - 3), (double)(k7 - 3), (double)(i7 + l8 + 3), (double)(k7 + j9 + 12 + 3), -1073741824, -1073741824);
         ...
         if (s != null) {
            this.fontRendererObj
               .drawStringWithShadow(
                  ...
                  (double)((float)i7),
                  (double)((float)k7),
                  this.statFileWriter.canUnlockAchievement(achievement)
