   ...
   protected void renderDebugInfoLeft() {
      ...
      for (int i = 0; i < list.size(); i++) {
         ...
         if (!Strings.isNullOrEmpty(s)) {
            ...
            int l = 2;
            int i1 = 2 + j * i;
            drawRect(1.0, (double)(i1 - 1), (double)(2 + k + 1), (double)(i1 + j - 1), -1873784752);
            this.fontRenderer.drawString(s, 2.0, (double)i1, 14737632);
         }
      }
   }
   ...
   protected void renderDebugInfoRight(ScaledResolution scaledRes) {
      ...
      for (int i = 0; i < list.size(); i++) {
         ...
         if (!Strings.isNullOrEmpty(s)) {
            ...
            this.fontRenderer.drawString(s, (double)l, (double)i1, 14737632);
         }
      }
   }
