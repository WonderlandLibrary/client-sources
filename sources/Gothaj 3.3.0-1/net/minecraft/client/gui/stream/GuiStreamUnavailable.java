...
public class GuiStreamUnavailable extends GuiScreen {
   ...
   public void initGui() {
      if (this.field_152323_r.isEmpty()) {
         this.field_152323_r
            .addAll(this.fontRendererObj.listFormattedStringToWidth(this.field_152326_h.func_152561_a().getFormattedText(), (int)((float)this.width * 0.75F)));
      ...
      if (this.field_152326_h.func_152559_b() != null) {
         ...
         this.buttonList
            .add(new GuiButton(1, this.width / 2 - 155 + 160, this.height - 50, 150, 20, I18n.format(this.field_152326_h.func_152559_b().getFormattedText())));
      } else {
   ...
   public static void func_152321_a(GuiScreen p_152321_0_) {
      ...
      if (!OpenGlHelper.framebufferSupported) {
         ...
         List<ChatComponentTranslation> list1 = Arrays.asList(
            new ChatComponentTranslation("stream.unavailable.initialization_failure.extra", ErrorCode.getString(istream.func_152912_E()))
         );
