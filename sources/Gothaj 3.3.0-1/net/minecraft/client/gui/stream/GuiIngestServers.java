   ...
   class ServerList extends GuiSlot {
      public ServerList(Minecraft mcIn) {
         super(
            ...
            (int)((double)mcIn.fontRendererObj.FONT_HEIGHT * 3.5)
         );
      ...
      protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
         ...
         GuiIngestServers.this.drawString(
            GuiIngestServers.this.fontRendererObj, s, p_180791_2_ + 2, p_180791_3_ + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT + 5 + 3, 3158064
         );
         GuiIngestServers.this.drawString(
         ...
         if (s2 != null) {
            GuiIngestServers.this.drawString(
               ...
               p_180791_3_ + 5 + 3 + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT,
               8421504
            );
         }
      }
