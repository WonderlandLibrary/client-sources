...
public abstract class GuiSlot {
   ...
   public void drawScreen(int mouseXIn, int mouseYIn, float p_148128_3_) {
      if (this.field_178041_q) {
         ...
         worldrenderer.pos((double)this.left, (double)(this.top + i1), 0.0).tex(0.0, 1.0).color(0, 0, 0, 0).endVertex();
         worldrenderer.pos((double)this.right, (double)(this.top + i1), 0.0).tex(1.0, 1.0).color(0, 0, 0, 0).endVertex();
         ...
         worldrenderer.pos((double)this.right, (double)(this.bottom - i1), 0.0).tex(1.0, 0.0).color(0, 0, 0, 0).endVertex();
         worldrenderer.pos((double)this.left, (double)(this.bottom - i1), 0.0).tex(0.0, 0.0).color(0, 0, 0, 0).endVertex();
         tessellator.draw();
   ...
   protected void overlayBackground(int startY, int endY, int startAlpha, int endAlpha) {
      ...
      worldrenderer.pos((double)(this.left + this.width), (double)endY, 0.0)
         .tex((double)((float)this.width / 32.0F), (double)((float)endY / 32.0F))
         .color(64, 64, 64, endAlpha)
         .endVertex();
      worldrenderer.pos((double)(this.left + this.width), (double)startY, 0.0)
   ...
   protected void drawContainerBackground(Tessellator p_drawContainerBackground_1_) {
      ...
      float f = 32.0F;
      worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
      worldrenderer.pos((double)this.left, (double)this.bottom, 0.0)
         .tex((double)((float)this.left / f), (double)((float)(this.bottom + (int)this.amountScrolled) / f))
         .color(32, 32, 32, 255)
         .endVertex();
      worldrenderer.pos((double)this.right, (double)this.bottom, 0.0)
         .tex((double)((float)this.right / f), (double)((float)(this.bottom + (int)this.amountScrolled) / f))
         .color(32, 32, 32, 255)
         .endVertex();
      worldrenderer.pos((double)this.right, (double)this.top, 0.0)
         .tex((double)((float)this.right / f), (double)((float)(this.top + (int)this.amountScrolled) / f))
         .color(32, 32, 32, 255)
         .endVertex();
      worldrenderer.pos((double)this.left, (double)this.top, 0.0)
         .tex((double)((float)this.left / f), (double)((float)(this.top + (int)this.amountScrolled) / f))
         .color(32, 32, 32, 255)
         .endVertex();
