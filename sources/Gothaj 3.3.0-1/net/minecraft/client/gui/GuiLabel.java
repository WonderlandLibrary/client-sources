...
public class GuiLabel extends Gui {
         ...
         for (int k = 0; k < this.field_146173_k.size(); k++) {
            if (this.centered) {
               this.drawCenteredString(
                  this.fontRenderer, this.field_146173_k.get(k), this.field_146162_g + this.field_146167_a / 2, j + k * 10, this.field_146168_n
               );
            } else {
   ...
   protected void drawLabelBackground(Minecraft mcIn, int p_146160_2_, int p_146160_3_) {
      if (this.labelBgEnabled) {
         ...
         drawRect((double)k, (double)l, (double)(k + i), (double)(l + j), this.field_146169_o);
