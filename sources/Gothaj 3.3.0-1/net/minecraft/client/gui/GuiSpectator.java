         ...
         if (i > 3 && p_175266_5_.func_178662_A_()) {
            this.field_175268_g
               ...
               .drawStringWithShadow(
                  s,
                  (double)((float)(p_175266_2_ + 19 - 2 - this.field_175268_g.fontRendererObj.getStringWidth(s))),
                  (double)(p_175266_3_ + 6.0F + 3.0F),
                  16777215 + (i << 24)
               );
         }
      }
   ...
   public void renderSelectedItem(ScaledResolution p_175263_1_) {
      ...
      if (i > 3 && this.field_175271_i != null) {
         ...
         if (s != null) {
            ...
            GlStateManager.enableBlend();
            GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
            this.field_175268_g.fontRendererObj.drawStringWithShadow(s, (double)((float)j), (double)((float)k), 16777215 + (i << 24));
            GlStateManager.disableBlend();
            GlStateManager.popMatrix();
         }
      }
