   ...
   public void drawTextBox() {
      if (this.getVisible()) {
         if (this.getEnableBackgroundDrawing()) {
            drawRect((double)this.xPosition, (double)this.yPosition, (double)(this.xPosition + this.width), (double)(this.yPosition + this.height), 1879048192);
            drawRect(
               (double)this.xPosition,
         ...
         if (s.length() > 0) {
            ...
            j1 = this.fontRendererInstance.drawStringWithShadow(s1, (double)((float)l), (double)((float)i1), i);
         }
         ...
         if (s.length() > 0 && flag && j < s.length()) {
            j1 = this.fontRendererInstance.drawStringWithShadow(s.substring(j), (double)((float)j1), (double)((float)i1), i);
         }
         ...
         if (flag1) {
            if (flag2) {
               ...
               this.fontRendererInstance.drawStringWithShadow("_", (double)((float)k1), (double)((float)i1), i);
            }
         }
   ...
   public void setSelectionPos(int p_146199_1_) {
      ...
      if (this.fontRendererInstance != null) {
         ...
         if (p_146199_1_ > k) {
            ...
            this.lineScrollOffset = this.lineScrollOffset - (this.lineScrollOffset - p_146199_1_);
         }
