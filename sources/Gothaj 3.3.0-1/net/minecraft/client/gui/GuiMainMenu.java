...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
   ...
   private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
      ...
      if (Reflector.GuiModList_Constructor.exists()) {
         this.buttonList
            .add(
               this.realmsButton = new GuiButton(
                  14, this.width / 2 + 2, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format("menu.online").replace("Minecraft", "").trim()
               )
            );
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (l != 0 || i1 != 0) {
         drawGradientRect(0.0, 0.0, (double)this.width, (double)this.height, l, i1);
      }

      if (j1 != 0 || k1 != 0) {
         drawGradientRect(0.0, 0.0, (double)this.width, (double)this.height, j1, k1);
      }
      ...
      if (this.openGLWarning1 != null && this.openGLWarning1.length() > 0) {
         drawRect(
            (double)(this.field_92022_t - 2), (double)(this.field_92021_u - 2), (double)(this.field_92020_v + 2), (double)(this.field_92019_w - 1), 1428160512
         );
