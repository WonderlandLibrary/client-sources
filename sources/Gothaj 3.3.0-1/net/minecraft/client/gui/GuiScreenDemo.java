...
public class GuiScreenDemo extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      this.fontRendererObj.drawString(I18n.format("demo.help.title"), (double)i, (double)j, 2039583);
      j += 12;
      ...
      this.fontRendererObj.drawString(I18n.format("demo.help.movementMouse"), (double)i, (double)(j + 12), 5197647);
      this.fontRendererObj
         .drawString(
            I18n.format("demo.help.jump", GameSettings.getKeyDisplayString(gamesettings.keyBindJump.getKeyCode())), (double)i, (double)(j + 24), 5197647
         );
      this.fontRendererObj
         .drawString(
            I18n.format("demo.help.inventory", GameSettings.getKeyDisplayString(gamesettings.keyBindInventory.getKeyCode())),
            (double)i,
            (double)(j + 36),
            5197647
         );
