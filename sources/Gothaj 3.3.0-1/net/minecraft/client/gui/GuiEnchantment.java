...
public class GuiEnchantment extends GuiContainer {
   ...
   protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
      ...
      this.fontRendererObj.drawString(this.playerInventory.getDisplayName().getUnformattedText(), 8.0, (double)(this.ySize - 96 + 2), 4210752);
   }
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      for (int l = 0; l < 3; l++) {
         ...
         if (l1 == 0) {
            ...
            fontrenderer.drawStringWithShadow(s1, (double)((float)(j1 + 86 - fontrenderer.getStringWidth(s1))), (double)((float)(j + 16 + 19 * l + 7)), i2);
         }
      }
   }
   ...
   public void func_147068_g() {
      ...
      if (!ItemStack.areItemStacksEqual(itemstack, this.field_147077_B)) {
         ...
         do {
            this.field_147082_x = this.field_147082_x + (float)(this.random.nextInt(4) - this.random.nextInt(4));
