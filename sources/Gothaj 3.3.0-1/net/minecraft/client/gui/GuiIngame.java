...
public class GuiIngame extends Gui {
   ...
   public void renderGameOverlay(float partialTicks) {
      ...
      if (this.mc.thePlayer.getSleepTimer() > 0) {
         ...
         drawRect(0.0, 0.0, (double)i, (double)j, k);
         GlStateManager.enableAlpha();
      ...
      if (this.recordPlayingUpFor > 0) {
         ...
         if (l1 > 8) {
            ...
            this.getFontRenderer()
               .drawString(this.recordPlaying, (double)(-this.getFontRenderer().getStringWidth(this.recordPlaying) / 2), -4.0, l + (l1 << 24 & 0xFF000000));
            GlStateManager.disableBlend();
      ...
      if (this.titlesTimer > 0) {
         ...
         if (i2 > 8) {
            ...
            this.getFontRenderer()
               .drawString(this.displayedTitle, (double)((float)(-this.getFontRenderer().getStringWidth(this.displayedTitle) / 2)), -10.0, 16777215 | j2, true);
            GlStateManager.popMatrix();
            GlStateManager.pushMatrix();
            GlStateManager.scale(2.0F, 2.0F, 2.0F);
            this.getFontRenderer()
               .drawString(
                  this.displayedSubTitle, (double)((float)(-this.getFontRenderer().getStringWidth(this.displayedSubTitle) / 2)), 5.0, 16777215 | j2, true
               );
            GlStateManager.popMatrix();
            GlStateManager.disableBlend();
            GlStateManager.popMatrix();
   ...
   public void renderExpBar(ScaledResolution scaledRes, int x) {
      ...
      if (this.mc.thePlayer.experienceLevel > 0) {
         ...
         int j1 = 0;
         this.getFontRenderer().drawString(s, (double)(l1 + 1), (double)i1, 0);
         this.getFontRenderer().drawString(s, (double)(l1 - 1), (double)i1, 0);
         this.getFontRenderer().drawString(s, (double)l1, (double)(i1 + 1), 0);
         this.getFontRenderer().drawString(s, (double)l1, (double)(i1 - 1), 0);
         this.getFontRenderer().drawString(s, (double)l1, (double)i1, k1);
         this.mc.mcProfiler.endSection();
      }
   }
   ...
   public void renderSelectedItem(ScaledResolution scaledRes) {
      ...
      if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null) {
         ...
         if (k > 0) {
            ...
            GlStateManager.enableBlend();
            GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
            this.getFontRenderer().drawStringWithShadow(s, (double)((float)i), (double)((float)j), 16777215 + (k << 24));
            GlStateManager.disableBlend();
            GlStateManager.popMatrix();
         }
      }
   ...
   public void renderDemo(ScaledResolution scaledRes) {
      ...
      this.getFontRenderer().drawStringWithShadow(s, (double)((float)(scaledRes.getScaledWidth() - i - 10)), 5.0, 16777215);
      this.mc.mcProfiler.endSection();
   }
   ...
   private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes) {
      ...
      if (!event.isCancelled()) {
         ...
         for (Score score1 : collection) {
            ...
            this.getFontRenderer().drawString(s1, (double)l1, (double)k, 553648127);
            this.getFontRenderer().drawString(s2, (double)(l - this.getFontRenderer().getStringWidth(s2)), (double)k, 553648127);
            if (j == collection.size()) {
               ...
               this.getFontRenderer()
                  .drawString(
                     s3, (double)(l1 + i / 2 - this.getFontRenderer().getStringWidth(s3) / 2), (double)(k - this.getFontRenderer().FONT_HEIGHT), 553648127
                  );
            }
         }
      }
   ...
   private void renderBossHealth() {
      if (BossStatus.bossName != null && BossStatus.statusBarTime > 0) {
         ...
         this.getFontRenderer()
            .drawStringWithShadow(s, (double)((float)(i / 2 - this.getFontRenderer().getStringWidth(s) / 2)), (double)((float)(i1 - 10)), 16777215);
         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
         this.mc.getTextureManager().bindTexture(icons);
      }
   }
