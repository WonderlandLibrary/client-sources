...
public class GuiStreamIndicator {
   ...
   public void render(int p_152437_1_, int p_152437_2_) {
      if (this.mc.getTwitchStream().isBroadcasting()) {
         ...
         if (i > 0) {
            ...
            worldrenderer.pos((double)l, (double)j1, 0.0).endVertex();
            worldrenderer.pos((double)p_152437_1_, (double)j1, 0.0).endVertex();
            worldrenderer.pos((double)p_152437_1_, (double)i1, 0.0).endVertex();
            worldrenderer.pos((double)l, (double)i1, 0.0).endVertex();
            tessellator.draw();
            GlStateManager.enableTexture2D();
            this.mc.fontRendererObj.drawString(s, (double)(p_152437_1_ - j), (double)(p_152437_2_ + 20), 16777215);
         }
   ...
   public void updateStreamAlpha() {
      if (this.mc.getTwitchStream().isBroadcasting()) {
         this.streamAlpha = this.streamAlpha + 0.025F * (float)this.streamAlphaDelta;
