...
public class GuiVideoSettings extends GuiScreenOF {
   ...
   public static void drawGradientRect(
      ...
      GuiScreen.drawGradientRect(
         (double)p_drawGradientRect_1_,
         (double)p_drawGradientRect_2_,
         (double)p_drawGradientRect_3_,
         (double)p_drawGradientRect_4_,
         p_drawGradientRect_5_,
         p_drawGradientRect_6_
      );
   }
