...
public class MapItemRenderer {
   ...
   private MapItemRenderer.Instance getMapRendererInstance(MapData mapdataIn) {
      ...
      if (mapitemrenderer$instance == null) {
         mapitemrenderer$instance = new MapItemRenderer.Instance(mapdataIn, null);
   ...
   class Instance {
      ...
      private void render(boolean noOverlayRendering) {
         ...
         worldrenderer.pos((double)((float)(i + 0) + f), (double)((float)(j + 128) - f), -0.01F).tex(0.0, 1.0).endVertex();
         worldrenderer.pos((double)((float)(i + 128) - f), (double)((float)(j + 128) - f), -0.01F).tex(1.0, 1.0).endVertex();
         worldrenderer.pos((double)((float)(i + 128) - f), (double)((float)(j + 0) + f), -0.01F).tex(1.0, 0.0).endVertex();
         worldrenderer.pos((double)((float)(i + 0) + f), (double)((float)(j + 0) + f), -0.01F).tex(0.0, 0.0).endVertex();
         tessellator.draw();
