...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
   ...
   public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
      ...
      this.mc.fontRendererObj.drawString(this.server.serverName, (double)(x + 32 + 3), (double)(y + 1), 16777215);
      List<String> list = this.mc.fontRendererObj.listFormattedStringToWidth(this.server.serverMOTD, listWidth - 32 - 2);

      for (int i = 0; i < Math.min(list.size(), 2); i++) {
         this.mc.fontRendererObj.drawString(list.get(i), (double)(x + 32 + 3), (double)(y + 12 + this.mc.fontRendererObj.FONT_HEIGHT * i), 8421504);
      }
      ...
      this.mc.fontRendererObj.drawString(s2, (double)(x + listWidth - j - 15 - 2), (double)(y + 1), 8421504);
      int k = 0;
      String s = null;
      int l;
      String s1;
      ...
      Gui.drawModalRectWithCustomSizedTexture((float)(x + listWidth - 15), (float)y, (float)(k * 10), (float)(176 + l * 8), 10.0, 8.0, 256.0, 256.0);
   ...
   protected void drawTextureAt(int p_178012_1_, int p_178012_2_, ResourceLocation p_178012_3_) {
      ...
      Gui.drawModalRectWithCustomSizedTexture((float)p_178012_1_, (float)p_178012_2_, 0.0F, 0.0F, 32.0, 32.0, 32.0, 32.0);
