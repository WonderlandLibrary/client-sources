...
public class GuiWinGame extends GuiScreen {
   ...
   private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
      ...
      f3 *= f3;
      f3 = f3 * 96.0F / 255.0F;
      worldrenderer.pos(0.0, (double)this.height, (double)zLevel).tex(0.0, (double)(f * f2)).color(f3, f3, f3, 1.0F).endVertex();
      worldrenderer.pos((double)i, (double)this.height, (double)zLevel).tex((double)((float)i * f2), (double)(f * f2)).color(f3, f3, f3, 1.0F).endVertex();
            ...
            if (s.startsWith("[C]")) {
               this.fontRendererObj
                  .drawStringWithShadow(
                     s.substring(3), (double)((float)(j + (i - this.fontRendererObj.getStringWidth(s.substring(3))) / 2)), (double)((float)l), 16777215
                  );
            } else {
               this.fontRendererObj.fontRandom.setSeed((long)i1 * 4238972211L + (long)(this.field_146581_h / 4));
               this.fontRendererObj.drawStringWithShadow(s, (double)((float)j), (double)((float)l), 16777215);
            }
         }
