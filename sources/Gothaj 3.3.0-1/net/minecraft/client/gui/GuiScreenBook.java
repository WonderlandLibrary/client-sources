...
public class GuiScreenBook extends GuiScreen {
   ...
   public void initGui() {
      ...
      if (this.bookIsUnsigned) {
         ...
         this.buttonList
            .add(this.buttonFinalize = new GuiButton(5, this.width / 2 - 100, 4 + this.bookImageHeight, 98, 20, I18n.format("book.finalizeButton")));
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.bookGettingSigned) {
         ...
         this.fontRendererObj.drawString(s1, (double)(i + 36 + (116 - k) / 2), (double)(j + 16 + 16), 0);
         int l = this.fontRendererObj.getStringWidth(s);
         this.fontRendererObj.drawString(s, (double)(i + 36 + (116 - l) / 2), (double)(j + 48), 0);
         String s2 = I18n.format("book.byAuthor", this.editingPlayer.getName());
         int i1 = this.fontRendererObj.getStringWidth(s2);
         this.fontRendererObj.drawString(EnumChatFormatting.DARK_GRAY + s2, (double)(i + 36 + (116 - i1) / 2), (double)(j + 48 + 10), 0);
            ...
            if (ItemEditableBook.validBookTagContents(this.bookObj.getTagCompound())) {
               try {
                  ...
                  this.field_175386_A = ichatcomponent != null
                     ? GuiUtilRenderComponents.splitText(ichatcomponent, 116, this.fontRendererObj, true, true)
                     : null;
         ...
         this.fontRendererObj.drawString(s4, (double)(i - j1 + this.bookImageWidth - 44), (double)(j + 16), 0);
         if (this.field_175386_A == null) {
            ...
            for (int l1 = 0; l1 < k1; l1++) {
               ...
               this.fontRendererObj
                  .drawString(ichatcomponent2.getUnformattedText(), (double)(i + 36), (double)(j + 16 + 16 + l1 * this.fontRendererObj.FONT_HEIGHT), 0);
            }
