...
public class GuiCreateFlatWorld extends GuiScreen {
      ...
      this.buttonList
         .add(
            this.field_146389_t = new GuiButton(
               2, this.width / 2 - 154, this.height - 52, 100, 20, I18n.format("createWorld.customize.flat.addLayer") + " (NYI)"
            )
         );
      this.buttonList
         .add(
            this.field_146388_u = new GuiButton(
               3, this.width / 2 - 50, this.height - 52, 100, 20, I18n.format("createWorld.customize.flat.editLayer") + " (NYI)"
            )
         );
      this.buttonList
         .add(this.field_146386_v = new GuiButton(4, this.width / 2 - 155, this.height - 52, 150, 20, I18n.format("createWorld.customize.flat.removeLayer")));
   ...
   class Details extends GuiSlot {
      ...
      private void func_148224_c(int p_148224_1_, int p_148224_2_, int p_148224_3_, int p_148224_4_) {
         ...
         worldrenderer.pos((double)(p_148224_1_ + 0), (double)(p_148224_2_ + 18), (double)GuiCreateFlatWorld.zLevel)
            .tex((double)((float)(p_148224_3_ + 0) * 0.0078125F), (double)((float)(p_148224_4_ + 18) * 0.0078125F))
            .endVertex();
         worldrenderer.pos((double)(p_148224_1_ + 18), (double)(p_148224_2_ + 18), (double)GuiCreateFlatWorld.zLevel)
            .tex((double)((float)(p_148224_3_ + 18) * 0.0078125F), (double)((float)(p_148224_4_ + 18) * 0.0078125F))
            .endVertex();
         worldrenderer.pos((double)(p_148224_1_ + 18), (double)(p_148224_2_ + 0), (double)GuiCreateFlatWorld.zLevel)
            .tex((double)((float)(p_148224_3_ + 18) * 0.0078125F), (double)((float)(p_148224_4_ + 0) * 0.0078125F))
            .endVertex();
         worldrenderer.pos((double)(p_148224_1_ + 0), (double)(p_148224_2_ + 0), (double)GuiCreateFlatWorld.zLevel)
            .tex((double)((float)(p_148224_3_ + 0) * 0.0078125F), (double)((float)(p_148224_4_ + 0) * 0.0078125F))
            .endVertex();
         tessellator.draw();
      }
      ...
      protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
         ...
         GuiCreateFlatWorld.this.fontRendererObj.drawString(s, (double)(p_180791_2_ + 18 + 5), (double)(p_180791_3_ + 3), 16777215);
         String s1;
         if (entryID == 0) {
         ...
         GuiCreateFlatWorld.this.fontRendererObj
            .drawString(s1, (double)(p_180791_2_ + 2 + 213 - GuiCreateFlatWorld.this.fontRendererObj.getStringWidth(s1)), (double)(p_180791_3_ + 3), 16777215);
      }
