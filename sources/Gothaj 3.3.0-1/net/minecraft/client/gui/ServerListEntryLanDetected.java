...
public class ServerListEntryLanDetected implements GuiListExtended.IGuiListEntry {
   ...
   public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
      this.mc.fontRendererObj.drawString(I18n.format("lanServer.title"), (double)(x + 32 + 3), (double)(y + 1), 16777215);
      this.mc.fontRendererObj.drawString(this.field_148291_b.getServerMotd(), (double)(x + 32 + 3), (double)(y + 12), 8421504);
      if (this.mc.gameSettings.hideServerAddress) {
         this.mc.fontRendererObj.drawString(I18n.format("selectServer.hiddenAddress"), (double)(x + 32 + 3), (double)(y + 12 + 11), 3158064);
      } else {
         this.mc.fontRendererObj.drawString(this.field_148291_b.getServerIpPort(), (double)(x + 32 + 3), (double)(y + 12 + 11), 3158064);
      }
   }
