...
public class GuiPlayerTabOverlay extends Gui {
   private static final Ordering<NetworkPlayerInfo> field_175252_a = Ordering.from(new GuiPlayerTabOverlay.PlayerComparator(null));
   ...
   public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
      ...
      for (NetworkPlayerInfo networkplayerinfo : list) {
         ...
         if (scoreObjectiveIn != null && scoreObjectiveIn.getRenderType() != IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
            k = this.mc
               .fontRendererObj
               .getStringWidth(" " + scoreboardIn.getValueFromObjective(networkplayerinfo.getGameProfile().getName(), scoreObjectiveIn).getScorePoints());
            j = Math.max(j, k);
         }
      }
      ...
      if (list1 != null) {
         ...
         for (String s3 : list1) {
            ...
            this.mc.fontRendererObj.drawStringWithShadow(s3, (double)((float)(width / 2 - i2 / 2)), (double)((float)k1), -1);
      ...
      for (int k4 = 0; k4 < l3; k4++) {
         ...
         if (k4 < list.size()) {
            ...
            if (flag) {
               ...
               int l2 = 8 + (flag1 ? 8 : 0);
               int i3 = 8 * (flag1 ? -1 : 1);
               Gui.drawScaledCustomSizeModalRect((double)j2, (double)k2, 8.0F, (float)l2, 8.0, (double)i3, 8.0, 8.0, 64.0F, 64.0F);
               if (entityplayer != null && entityplayer.isWearing(EnumPlayerModelParts.HAT)) {
                  int j3 = 8 + (flag1 ? 8 : 0);
                  int k3 = 8 * (flag1 ? -1 : 1);
                  Gui.drawScaledCustomSizeModalRect((double)j2, (double)k2, 40.0F, (float)j3, 8.0, (double)k3, 8.0, 8.0, 64.0F, 64.0F);
               }

               j2 += 9;
            }

            this.mc.fontRendererObj.drawStringWithShadow(s1, (double)((float)j2), (double)((float)k2), -1);
      ...
      if (list2 != null) {
         ...
         for (String s4 : list2) {
            ...
            this.mc.fontRendererObj.drawStringWithShadow(s4, (double)((float)(width / 2 - j5 / 2)), (double)((float)k1), -1);
            k1 += this.mc.fontRendererObj.FONT_HEIGHT;
         }
      }
   }
   ...
   protected void drawPing(int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo networkPlayerInfoIn) {
      ...
      zLevel += 100.0F;
      this.drawTexturedModalRect(p_175245_2_ + p_175245_1_ - 11, p_175245_3_, 0 + i * 10, 176 + var7 * 8, 10, 8);
      zLevel -= 100.0F;
   }

   private void drawScoreboardValues(
      ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_, int p_175247_5_, NetworkPlayerInfo p_175247_6_
   ) {
      ...
      if (p_175247_1_.getRenderType() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
            ...
            if (f > 3.0F) {
               ...
               this.mc
                  ...
                  .drawStringWithShadow(
                     s, (double)((float)((p_175247_5_ + p_175247_4_) / 2 - this.mc.fontRendererObj.getStringWidth(s) / 2)), (double)((float)p_175247_2_), i1
                  );
            }
         }
      } else {
         ...
         this.mc
            .fontRendererObj
            .drawStringWithShadow(s1, (double)((float)(p_175247_5_ - this.mc.fontRendererObj.getStringWidth(s1))), (double)((float)p_175247_2_), 16777215);
      }
   }
