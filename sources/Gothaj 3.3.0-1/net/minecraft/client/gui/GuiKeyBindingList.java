   ...
   public class CategoryEntry implements GuiListExtended.IGuiListEntry {
      ...
      public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
         GuiKeyBindingList.this.mc
            ...
            .drawString(
               this.labelText,
               (double)(GuiKeyBindingList.this.mc.currentScreen.width / 2 - this.labelWidth / 2),
               (double)(y + slotHeight - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT - 1),
               16777215
            );
      }
   ...
   public class KeyEntry implements GuiListExtended.IGuiListEntry {
      ...
      public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
         ...
         GuiKeyBindingList.this.mc
            ...
            .drawString(
               this.keyDesc,
               (double)(x + 90 - GuiKeyBindingList.this.maxListLabelWidth),
               (double)(y + slotHeight / 2 - GuiKeyBindingList.this.mc.fontRendererObj.FONT_HEIGHT / 2),
               16777215
            );
         ...
         if (this.keybinding.getKeyCode() != 0) {
            KeyBinding[] var14;
            for (KeyBinding keybinding : var14 = GuiKeyBindingList.this.mc.gameSettings.keyBindings) {
