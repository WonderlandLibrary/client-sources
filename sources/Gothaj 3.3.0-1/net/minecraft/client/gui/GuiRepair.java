...
public class GuiRepair extends GuiContainer implements ICrafting {
   ...
   protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
      ...
      this.fontRendererObj.drawString(I18n.format("container.repair"), 60.0, 6.0, 4210752);
      if (this.anvil.maximumCost > 0) {
         ...
         if (flag) {
            ...
            if (this.fontRendererObj.getUnicodeFlag()) {
               ...
               this.fontRendererObj.drawString(s, (double)k, (double)(l + 1), j);
               this.fontRendererObj.drawString(s, (double)(k + 1), (double)l, j);
               this.fontRendererObj.drawString(s, (double)(k + 1), (double)(l + 1), j);
            }

            this.fontRendererObj.drawString(s, (double)k, (double)l, i);
         }
      }
