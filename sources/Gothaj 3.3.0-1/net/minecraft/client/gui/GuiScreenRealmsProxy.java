...
public class GuiScreenRealmsProxy extends GuiScreen {
   ...
   public void func_154322_b(String p_154322_1_, int p_154322_2_, int p_154322_3_, int p_154322_4_, boolean p_154322_5_) {
      if (p_154322_5_) {
         ...
         this.fontRendererObj.drawString(p_154322_1_, (double)p_154322_2_, (double)p_154322_3_, p_154322_4_);
      }
   }
   ...
   public void drawGradientRect(int left, int top, int right, int bottom, int startColor, int endColor) {
      GuiScreen.drawGradientRect((double)left, (double)top, (double)right, (double)bottom, startColor, endColor);
   }
   ...
   public void func_154319_c(String p_154319_1_, int p_154319_2_, int p_154319_3_, int p_154319_4_) {
      this.fontRendererObj.drawStringWithShadow(p_154319_1_, (double)((float)p_154319_2_), (double)((float)p_154319_3_), p_154319_4_);
   }
