   ...
   private ResourceLocation func_178463_a(TileEntityBanner bannerObj) {
      ...
      if (s.isEmpty()) {
         ...
         if (tileentitybannerrenderer$timedbannertexture == null) {
            ...
            tileentitybannerrenderer$timedbannertexture = new TileEntityBannerRenderer.TimedBannerTexture(null);
            tileentitybannerrenderer$timedbannertexture.bannerTexture = new ResourceLocation(s);
            Minecraft.getMinecraft()
               .getTextureManager()
               .loadTexture(tileentitybannerrenderer$timedbannertexture.bannerTexture, new LayeredColorMaskTexture(BANNERTEXTURES, list2, list));
