...
public class FaceBakery {
   ...
   private void fillVertexData(
      ...
      EnumFaceDirection.VertexInformation enumfacedirection$vertexinformation = EnumFaceDirection.getFacing(p_fillVertexData_3_)
         .getVertexInformation(p_fillVertexData_2_);
      Vector3f vector3f = new Vector3f(
         p_fillVertexData_5_[enumfacedirection$vertexinformation.xIndex],
   ...
   public static EnumFacing getFacingFromVertexData(int[] faceData) {
      ...
      EnumFacing[] var16;
      for (EnumFacing enumfacing1 : var16 = EnumFacing.values()) {
