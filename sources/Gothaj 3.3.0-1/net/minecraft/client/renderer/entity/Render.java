...
public abstract class Render<T extends Entity> implements IEntityRenderer {
   ...
   protected boolean canRenderName(T entity) {
      return entity.getAlwaysRenderNameTagForRender() && entity.hasCustomName() && ShaderESPModule.nametags;
   }
   ...
   protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
      ...
      if (d0 <= (double)(maxDistance * maxDistance)) {
         ...
         tessellator.draw();
         GlStateManager.enableTexture2D();
         fontrenderer.drawString(str, (double)(-fontrenderer.getStringWidth(str) / 2), (double)i, 553648127);
         GlStateManager.enableDepth();
         GlStateManager.depthMask(true);
         fontrenderer.drawString(str, (double)(-fontrenderer.getStringWidth(str) / 2), (double)i, -1);
         GlStateManager.enableLighting();
         GlStateManager.disableBlend();
         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
         GlStateManager.popMatrix();
   ...
   public void renderMultipass(
      T p_renderMultipass_1_,
      double p_renderMultipass_2_,
      double p_renderMultipass_4_,
      double p_renderMultipass_6_,
      float p_renderMultipass_8_,
      float p_renderMultipass_9_
   ) {
   }
