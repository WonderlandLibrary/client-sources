      ...
      if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
         ...
         if (this.itemToRender == null) {
            ...
            if (this.itemToRender.getItem() instanceof ItemMap) {
               ...
               || (killAura.mode.getMode().equalsIgnoreCase("Hypixel") || killAura.autoBlock.getMode().equalsIgnoreCase("Fake")) && killAura.target != null
               || Client.INSTANCE.getModuleManager().getModule(AuraModule.class).isEnabled() && AuraModule.target != null && AuraModule.autoblock.isEnabled()) {
