   ...
   public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing) {
      ...
      if (this.blockHitDelay > 0) {
         ...
         if (block.getMaterial() == Material.air) {
            ...
            EventBlockDamage event = new EventBlockDamage(
               block.getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.worldObj, posBlock), posBlock
            );
            Client.INSTANCE.getEventBus().call(event);
            curBlockDamageMP = curBlockDamageMP + event.getPlayerRelativeBlockHardness();
