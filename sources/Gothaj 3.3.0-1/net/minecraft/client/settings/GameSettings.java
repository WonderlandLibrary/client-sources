...
public class GameSettings {
   ...
   public GameSettings(Minecraft mcIn, File optionsFileIn) {
      this.keyBindings = (KeyBinding[])ArrayUtils.addAll(
         new KeyBinding[]{
            ...
            this.keyBindStreamStartStop,
            this.keyBindStreamPauseUnpause,
            this.keyBindStreamCommercials,
            this.keyBindStreamToggleMic,
   ...
   public static String getKeyDisplayString(int key) {
      return key < 0
         ? I18n.format("key.mouseButton", key + 101)
         : (key < 256 ? Keyboard.getKeyName(key) : String.format("%c", (char)(key - 256)).toUpperCase());
   }
                  ...
                  settingOption == GameSettings.Options.GAMMA
                     ...
                     : (
                        settingOption == GameSettings.Options.SATURATION
                           ? this.saturation
                           : (
                              settingOption == GameSettings.Options.SENSITIVITY
                                 ? this.mouseSensitivity
                                 : (
                                    settingOption == GameSettings.Options.CHAT_OPACITY
                                       ? this.chatOpacity
                                       : (
                                          settingOption == GameSettings.Options.CHAT_HEIGHT_FOCUSED
                                             ? this.chatHeightFocused
                                             : (
                                                settingOption == GameSettings.Options.CHAT_HEIGHT_UNFOCUSED
                                                   ? this.chatHeightUnfocused
                                                   : (
                                                      settingOption == GameSettings.Options.CHAT_SCALE
                                                         ? this.chatScale
                                                         : (
                                                            settingOption == GameSettings.Options.CHAT_WIDTH
                                                               ? this.chatWidth
                                                               : (
                                                                  settingOption == GameSettings.Options.FRAMERATE_LIMIT
                                                                     ...
                                                                     : (
                                                                        settingOption == GameSettings.Options.MIPMAP_LEVELS
                                                                           ...
                                                                           : (
                                                                              settingOption == GameSettings.Options.RENDER_DISTANCE
                                                                                 ? (float)this.renderDistanceChunks
                                                                                 : (
                                                                                    settingOption == GameSettings.Options.STREAM_BYTES_PER_PIXEL
                                                                                       ? this.streamBytesPerPixel
                                                                                       : (
                                                                                          settingOption == GameSettings.Options.STREAM_VOLUME_MIC
                                                                                             ? this.streamMicVolume
                                                                                             : (
                                                                                                settingOption == GameSettings.Options.STREAM_VOLUME_SYSTEM
                                                                                                   ? this.streamGameVolume
                                                                                                   : (
                                                                                                      settingOption == GameSettings.Options.STREAM_KBPS
                                                                                                         ? this.streamKbps
                                                                                                         : (
                                                                                                            settingOption == GameSettings.Options.STREAM_FPS
                                                                                                               ? this.streamFps
                                                                                                               : 0.0F
                                                                                                         )
                                                                                                   )
   ...
   public String getKeyBinding(GameSettings.Options settingOption) {
      ...
      if (s != null) {
         ...
         if (!settingOption.getEnumFloat()) {
            ...
            return settingOption == GameSettings.Options.MIPMAP_LEVELS && (double)f1 >= 4.0
               ? s1 + Lang.get("of.general.max")
               : (
                  settingOption == GameSettings.Options.SENSITIVITY
                     ? (
                        f == 0.0F
                           ? s1 + I18n.format("options.sensitivity.min")
                           : (f == 1.0F ? s1 + I18n.format("options.sensitivity.max") : s1 + (int)(f * 200.0F) + "%")
                     )
                     : (
                        settingOption == GameSettings.Options.FOV
                           ? (f1 == 70.0F ? s1 + I18n.format("options.fov.min") : (f1 == 110.0F ? s1 + I18n.format("options.fov.max") : s1 + (int)f1))
                           : (
                              settingOption == GameSettings.Options.FRAMERATE_LIMIT
                                 ? (f1 == settingOption.valueMax ? s1 + I18n.format("options.framerateLimit.max") : s1 + (int)f1 + " fps")
                                 : (
                                    settingOption == GameSettings.Options.RENDER_CLOUDS
                                       ? (f1 == settingOption.valueMin ? s1 + I18n.format("options.cloudHeight.min") : s1 + ((int)f1 + 128))
                                       : (
                                          settingOption == GameSettings.Options.GAMMA
                                             ? (
                                                f == 0.0F
                                                   ? s1 + I18n.format("options.gamma.min")
                                                   : (f == 1.0F ? s1 + I18n.format("options.gamma.max") : s1 + "+" + (int)(f * 100.0F) + "%")
                                             )
                                             : (
                                                settingOption == GameSettings.Options.SATURATION
                                                   ? s1 + (int)(f * 400.0F) + "%"
                                                                        ...
                                                                        settingOption == GameSettings.Options.CHAT_WIDTH
                                                                           ...
                                                                           : (
                                                                              settingOption == GameSettings.Options.RENDER_DISTANCE
                                                                                 ...
                                                                                 : (
                                                                                    settingOption == GameSettings.Options.MIPMAP_LEVELS
                                                                                       ? (f1 == 0.0F ? s1 + I18n.format("options.off") : s1 + (int)f1)
                                                                                       : (
                                                                                          settingOption == GameSettings.Options.STREAM_FPS
                                                                                             ? s1 + TwitchStream.formatStreamFps(f) + " fps"
                                                                                             : (
                                                                                                settingOption == GameSettings.Options.STREAM_KBPS
                                                                                                   ? s1 + TwitchStream.formatStreamKbps(f) + " Kbps"
                                                                                                   : (
                                                                                                      settingOption
                                                                                                            == GameSettings.Options.STREAM_BYTES_PER_PIXEL
                                                                                                         ? s1
                                                                                                            + String.format(
                                                                                                               "%.3f bpp", TwitchStream.formatStreamBps(f)
                                                                                                            )
                                                                                                         : (
                                                                                                            f == 0.0F
               ...
               while ((s = bufferedreader.readLine()) != null) {
                  try {
                     ...
                     if (astring[0].equals("resourcePacks")) {
                        this.resourcePacks = (List<String>)gson.fromJson(s.substring(s.indexOf(58) + 1), typeListString);
                     ...
                     if (astring[0].equals("incompatibleResourcePacks")) {
                        this.incompatibleResourcePacks = (List<String>)gson.fromJson(s.substring(s.indexOf(58) + 1), typeListString);
                     ...
                     SoundCategory[] var23;
                     for (SoundCategory soundcategory : var23 = SoundCategory.values()) {
                     ...
                     for (EnumPlayerModelParts enumplayermodelparts : var24 = EnumPlayerModelParts.values()) {
   ...
   public void saveOptions() {
      ...
      try {
         ...
         SoundCategory[] var14;
         for (SoundCategory soundcategory : var14 = SoundCategory.values()) {
            printwriter.println("soundCategory_" + soundcategory.getCategoryName() + ":" + this.getSoundLevel(soundcategory));
         }

         for (EnumPlayerModelParts enumplayermodelparts : var15 = EnumPlayerModelParts.values()) {
   ...
   public void sendSettingsToServer() {
      if (this.mc.thePlayer != null) {
         ...
         this.mc
            .thePlayer
            .sendQueue
            .addToSendQueue(new C15PacketClientSettings(this.language, this.renderDistanceChunks, this.chatVisibility, this.chatColours, i));
      }
   }
   ...
   private String getKeyBindingOF(GameSettings.Options p_getKeyBindingOF_1_) {
      ...
      if (p_getKeyBindingOF_1_ == GameSettings.Options.RENDER_DISTANCE) {
         ...
         int l = 900;
         return this.ofAutoSaveTicks <= l
            ? s + Lang.get("of.options.save.45s")
            : (
               this.ofAutoSaveTicks <= 2 * l
                  ? s + Lang.get("of.options.save.90s")
                  : (
                     this.ofAutoSaveTicks <= 4 * l
                        ? s + Lang.get("of.options.save.3min")
                        : (
                           this.ofAutoSaveTicks <= 8 * l
                              ? s + Lang.get("of.options.save.6min")
                              : (this.ofAutoSaveTicks <= 16 * l ? s + Lang.get("of.options.save.12min") : s + Lang.get("of.options.save.24min"))
                        )
                  )
            );
         ...
         return this.ofTime == 1
            ? s + Lang.get("of.options.time.dayOnly")
         ...
         return f == 0.0F
            ? s + Lang.get("of.options.framerateLimit.vsync")
            : (f == p_getKeyBindingOF_1_.valueMax ? s + I18n.format("options.framerateLimit.max") : s + (int)f + " fps");
      } else {
         return null;
      }
   }
