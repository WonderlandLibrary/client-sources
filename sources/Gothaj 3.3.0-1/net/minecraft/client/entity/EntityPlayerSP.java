                  ...
                  this.sendQueue
                     .addToSendQueue(
                        new C03PacketPlayer.C06PacketPlayerPosLook(
                           updateMotionEvent.getX(),
                           updateMotionEvent.getY(),
                           updateMotionEvent.getZ(),
                           updateMotionEvent.getYaw(),
                           updateMotionEvent.getPitch(),
                           updateMotionEvent.isOnGround()
                        )
                     );
               } else if (flag2) {
                  this.sendQueue
                     .addToSendQueue(
                        new C03PacketPlayer.C04PacketPlayerPosition(
                           updateMotionEvent.getX(), updateMotionEvent.getY(), updateMotionEvent.getZ(), updateMotionEvent.isOnGround()
                        )
                     );
               } else if (flag3) {
                  this.sendQueue
                     .addToSendQueue(
                        new C03PacketPlayer.C05PacketPlayerLook(updateMotionEvent.getYaw(), updateMotionEvent.getPitch(), updateMotionEvent.isOnGround())
                     );
