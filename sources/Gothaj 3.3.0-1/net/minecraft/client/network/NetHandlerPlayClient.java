...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
   ...
   public void handleEntityMovement(S14PacketEntity packetIn) {
      ...
      if (entity != null) {
         entity.serverPosX = entity.serverPosX + packetIn.func_149062_c();
         entity.serverPosY = entity.serverPosY + packetIn.func_149061_d();
         entity.serverPosZ = entity.serverPosZ + packetIn.func_149064_e();
         double d0 = (double)entity.serverPosX / 32.0;
         double d1 = (double)entity.serverPosY / 32.0;
         double d2 = (double)entity.serverPosZ / 32.0;
   ...
   public void handleMultiBlockChange(S22PacketMultiBlockChange packetIn) {
      ...
      for (S22PacketMultiBlockChange.BlockUpdateData s22packetmultiblockchange$blockupdatedata : var5 = packetIn.getChangedBlocks()) {
         this.clientWorldController
   ...
   public void onDisconnect(IChatComponent reason) {
      ...
      if (this.guiScreenServer != null) {
         if (this.guiScreenServer instanceof GuiScreenRealmsProxy) {
            this.gameController
               .displayGuiScreen(
                  new DisconnectedRealmsScreen(((GuiScreenRealmsProxy)this.guiScreenServer).func_154321_a(), "disconnect.lost", reason).getProxy()
               );
         } else {
   ...
   public void handleExplosion(S27PacketExplosion packetIn) {
      ...
      this.gameController.thePlayer.motionX = this.gameController.thePlayer.motionX + (double)packetIn.func_149149_c();
      this.gameController.thePlayer.motionY = this.gameController.thePlayer.motionY + (double)packetIn.func_149144_d();
      this.gameController.thePlayer.motionZ = this.gameController.thePlayer.motionZ + (double)packetIn.func_149147_e();
   }
      ...
      try {
         ...
         if ("MC|TrList".equals(packetIn.getChannelName())) {
            ...
            try {
               ...
               logger.error("Couldn't load trade info", var11);
            } finally {
