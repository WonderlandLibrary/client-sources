...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester.IngestTestListener, IStream {
   ...
   public void func_152922_k() {
      if (this.broadcastController.isBroadcasting() && !this.broadcastController.isBroadcastPaused()) {
         ...
         if (flag) {
            ...
            GlStateManager.ortho(0.0, (double)this.framebuffer.framebufferWidth, (double)this.framebuffer.framebufferHeight, 0.0, 1000.0, 3000.0);
            ...
            worldrenderer.pos(0.0, (double)f1, 0.0).tex(0.0, (double)f3).endVertex();
            worldrenderer.pos((double)f, (double)f1, 0.0).tex((double)f2, (double)f3).endVertex();
            worldrenderer.pos((double)f, 0.0, 0.0).tex((double)f2, 0.0).endVertex();
   ...
   public void func_152930_t() {
      ...
      VideoParams videoparams = this.broadcastController
         .func_152834_a(
            formatStreamKbps(gamesettings.streamKbps),
            formatStreamFps(gamesettings.streamFps),
            formatStreamBps(gamesettings.streamBytesPerPixel),
      ...
      if (gamesettings.streamPreferredServer != null && gamesettings.streamPreferredServer.length() > 0) {
         IngestServer[] var6;
         for (IngestServer ingestserver : var6 = this.func_152925_v()) {
      ...
      LOGGER.info(
         ...
         new Object[]{videoparams.outputWidth, videoparams.outputHeight, videoparams.maxKbps, this.broadcastController.getIngestServer().serverUrl}
      );
   ...
   public void func_152893_b(ErrorCode p_152893_1_) {
      ...
      this.mc
         ...
         .printChatMessageWithOptionalDeletion(
            new ChatComponentText("Issue streaming frame: " + p_152893_1_ + " (" + ErrorCode.getString(p_152893_1_) + ")"), 2
         );
   }
   ...
   private boolean func_176028_a(Set<ChatUserMode> p_176028_1_, Set<ChatUserSubscription> p_176028_2_, int p_176028_3_) {
      return p_176028_1_.contains(ChatUserMode.TTV_CHAT_USERMODE_BANNED)
         ? false
         : (
            p_176028_1_.contains(ChatUserMode.TTV_CHAT_USERMODE_ADMINSTRATOR)
               ? true
               : (
                  p_176028_1_.contains(ChatUserMode.TTV_CHAT_USERMODE_MODERATOR)
                     ? true
                     : (
                        p_176028_1_.contains(ChatUserMode.TTV_CHAT_USERMODE_STAFF)
                           ? true
                           : (p_176028_3_ == 0 ? true : (p_176028_3_ == 1 ? p_176028_2_.contains(ChatUserSubscription.TTV_CHAT_USERSUB_SUBSCRIBER) : false))
                     )
               )
         );
   }
