   ...
   protected IStreamCallbacks field_176005_A = new IStreamCallbacks() {
      ...
      public void stopCallback(ErrorCode p_stopCallback_1_) {
         if (ErrorCode.failed(p_stopCallback_1_)) {
            System.out
               .println("IngestTester.stopCallback failed to stop - " + IngestServerTester.this.field_153059_q.serverName + ": " + p_stopCallback_1_.toString());
         }
   ...
   protected void func_153038_n() {
      ...
      switch (this.field_153047_e) {
         ...
         default:
            ...
            this.field_153065_w = this.field_153065_w + this.field_153066_x / (float)this.field_153046_d.getServers().length;
      }
   }
