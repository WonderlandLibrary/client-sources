...
public class CompactConstructor extends org.yaml.snakeyaml.constructor.Constructor {
   ...
   protected void setProperties(Object bean, Map<String, Object> data) throws Exception {
      if (data == null) {
         ...
         for (Entry<String, Object> entry : data.entrySet()) {
            ...
            Property property = this.getPropertyUtils().getProperty((Class<? extends Object>)bean.getClass(), key);
   ...
   protected void applySequence(Object bean, List<?> value) {
      try {
         Property property = this.getPropertyUtils().getProperty((Class<? extends Object>)bean.getClass(), this.getSequencePropertyName(bean.getClass()));
   ...
   protected String getSequencePropertyName(Class<?> bean) {
      Set<Property> properties = this.getPropertyUtils().getProperties((Class<? extends Object>)bean);
   ...
   public class ConstructCompactObject extends org.yaml.snakeyaml.constructor.Constructor.ConstructMapping {
      ...
      public void construct2ndStep(Node node, Object object) {
         ...
         if (valueNode instanceof MappingNode) {
            valueNode.setType((Class<? extends Object>)object.getClass());
