...
public class VelocityPlugin implements ViaServerProxyPlatform<Player> {
   ...
   public void onProxyInit(ProxyInitializeEvent e) {
      ...
      Via.init(
         ViaManagerImpl.builder().platform(this).commandHandler(commandHandler).loader(new VelocityViaLoader()).injector(new VelocityViaInjector()).build()
      );
   }
   ...
   public ViaCommandSender[] getOnlinePlayers() {
      return PROXY.getAllPlayers().stream().map(VelocityCommandSender::new).toArray(ViaCommandSender[]::new);
   }
