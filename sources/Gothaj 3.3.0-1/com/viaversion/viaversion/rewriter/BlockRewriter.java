...
public class BlockRewriter<C extends ClientboundPacketType> {
         ...
         .registerClientbound(
            ...
            new PacketHandlers() {
               ...
               public void register() {
                  ...
                  this.map(Type.VAR_INT);
                  this.handler(
                     wrapper -> wrapper.set(Type.VAR_INT, 0, BlockRewriter.this.protocol.getMappingData().getNewBlockStateId(wrapper.get(Type.VAR_INT, 0)))
                  );
               }
            }
         );
   ...
   public PacketHandler chunkDataHandler1_19(BlockRewriter.ChunkTypeSupplier chunkTypeSupplier, @Nullable Consumer<BlockEntity> blockEntityHandler) {
      return wrapper -> {
         ...
         Type<Chunk> chunkType = chunkTypeSupplier.supply(
