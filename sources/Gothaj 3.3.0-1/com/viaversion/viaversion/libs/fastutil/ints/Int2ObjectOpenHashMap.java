   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ObjectOpenHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? (long)(Int2ObjectOpenHashMap.this.size - this.c)
            : Math.min(
               (long)(Int2ObjectOpenHashMap.this.size - this.c),
               (long)((double)Int2ObjectOpenHashMap.this.realSize() / (double)Int2ObjectOpenHashMap.this.n * (double)(this.max - this.pos))
