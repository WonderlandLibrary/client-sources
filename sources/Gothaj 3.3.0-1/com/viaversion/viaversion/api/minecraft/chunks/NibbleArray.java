...
public class NibbleArray {
   ...
   public byte get(int index) {
      ...
      return index % 2 == 0 ? (byte)(value & 15) : (byte)(value >> 4 & 15);
   }
   ...
   public void set(int index, int value) {
      if (index % 2 == 0) {
         index /= 2;
         this.handle[index] = (byte)(this.handle[index] & 240 | value & 15);
      } else {
         index /= 2;
         this.handle[index] = (byte)(this.handle[index] & 15 | (value & 15) << 4);
      }
   }
