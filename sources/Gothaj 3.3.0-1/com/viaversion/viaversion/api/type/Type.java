...
public abstract class Type<T> implements ByteBufReader<T>, ByteBufWriter<T> {
   ...
   public static final Type<CompoundTag[]> NAMED_COMPOUND_TAG_ARRAY = new ArrayType<>(NAMED_COMPOUND_TAG);
   ...
   public static final Type<BlockChangeRecord[]> BLOCK_CHANGE_RECORD_ARRAY = new ArrayType<>(BLOCK_CHANGE_RECORD);
   public static final Type<BlockChangeRecord> VAR_LONG_BLOCK_CHANGE_RECORD = new VarLongBlockChangeRecordType();
   public static final Type<BlockChangeRecord[]> VAR_LONG_BLOCK_CHANGE_RECORD_ARRAY = new ArrayType<>(VAR_LONG_BLOCK_CHANGE_RECORD);
   ...
   public Class<? extends Type> getBaseClass() {
      return (Class<? extends Type>)this.getClass();
   }
