...
public final class Protocol1_19_1To1_19
   ...
   private static final CompoundTag CHAT_REGISTRY = SNBT.deserializeCompoundTag(
         "{\n  \"minecraft:chat_type\": {\n    \"type\": \"minecraft:chat_type\",\n    \"value\": [\n         {\n            \"name\":\"minecraft:chat\",\n            \"id\":1,\n            \"element\":{\n               \"chat\":{\n                  \"translation_key\":\"chat.type.text\",\n                  \"parameters\":[\n                     \"sender\",\n                     \"content\"\n                  ]\n               },\n               \"narration\":{\n                  \"translation_key\":\"chat.type.text.narrate\",\n                  \"parameters\":[\n                     \"sender\",\n                     \"content\"\n                  ]\n               }\n            }\n         }    ]\n  }\n}"
      )
   ...
   protected void registerPackets() {
      ...
      this.registerClientbound(
         ClientboundPackets1_19.PLAYER_CHAT,
            ...
            public void register() {
               this.handler(
                  wrapper -> {
                     ...
                     ChatDecorationResult decorationResult = Protocol1_19_1To1_19.decorateChatMessage(
      ...
      this.registerClientbound(ClientboundPackets1_19.JOIN_GAME, new PacketHandlers() {
         ...
         public void register() {
            ...
            this.handler(wrapper -> {
               ...
               for (Tag chatType : (ListTag)registry.<CompoundTag>get("minecraft:chat_type").get("value")) {
   ...
   @Nullable
   public static ChatDecorationResult decorateChatMessage(
      CompoundTag chatType, int chatTypeId, JsonElement senderName, @Nullable JsonElement teamName, JsonElement message
   ) {
      if (chatType == null) {
         ...
         CompoundTag decoration = chatData.get("decoration");
         return decoration == null
            ? new ChatDecorationResult(message, overlay)
            : new ChatDecorationResult(translatabaleComponentFromTag(decoration, senderName, teamName, message), overlay);
      }
   }
   ...
   public static JsonElement translatabaleComponentFromTag(CompoundTag tag, JsonElement senderName, @Nullable JsonElement targetName, JsonElement message) {
      String translationKey = (String)tag.<Tag>get("translation_key").getValue();
      ...
      if (styleTag != null) {
         ...
         for (Entry<String, TextFormatting> entry : TextFormatting.FORMATTINGS.entrySet()) {
            Tag formattingTag = styleTag.get(entry.getKey());
            if (formattingTag instanceof ByteTag) {
               boolean value = ((NumberTag)formattingTag).asBoolean();
               TextFormatting formatting = entry.getValue();
      ...
      if (parameters != null) {
         for (Tag element : parameters) {
            ...
            String var20 = (String)element.getValue();
            switch (var20) {
               case "sender":
                  argument = senderName;
                  break;
