...
public class WorldPackets {
   ...
   public static void register(final Protocol1_14To1_13_2 protocol) {
      ...
      protocol.registerClientbound(ClientboundPackets1_13.CHUNK_DATA, wrapper -> {
         ...
         for (ChunkSection sectionx : chunk.getSections()) {
            if (sectionx != null) {
               lightPacket.write(Type.BYTE_ARRAY_PRIMITIVE, sectionx.getLight().getBlockLight());
            }
         }
         ...
         for (ChunkSection sectionxx : chunk.getSections()) {
            if (sectionxx != null) {
      ...
      protocol.registerClientbound(ClientboundPackets1_13.RESPAWN, new PacketHandlers() {
         ...
         public void register() {
            ...
            this.handler(wrapper -> {
               ...
               difficultyPacket.scheduleSend((Class<? extends Protocol>)protocol.getClass());
            });
            this.handler(wrapper -> {
