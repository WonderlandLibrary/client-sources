...
public final class Protocol1_17To1_16_4
   ...
   protected void registerPackets() {
      ...
      this.registerClientbound(ClientboundPackets1_16_2.TAGS, wrapper -> {
      ...
      this.registerClientbound(ClientboundPackets1_16_2.MAP_DATA, wrapper -> {
      ...
      this.registerClientbound(ClientboundPackets1_16_2.TITLE, null, wrapper -> {
   ...
   protected void onMappingDataLoaded() {
      ...
      this.tagRewriter
         .addEmptyTags(
            ...
            "minecraft:candles",
            "minecraft:snow_step_sound_blocks",
      ...
      this.tagRewriter
         .addEmptyTags(
            ...
            "minecraft:axolotl_tempted_hostiles",
