...
public class MovementTransmitterProvider implements Provider {
   public void sendPlayer(UserConnection userConnection) {
      if (userConnection.getProtocolInfo().getClientState() == State.PLAY
         && userConnection.<EntityTracker>getEntityTracker(Protocol1_9To1_8.class).clientEntityId() != -1) {
         ...
         try {
            ...
            Via.getPlatform().getLogger().log(Level.WARNING, "Failed to send player movement packet", var4);
         }
      }
   }
}
