...
public final class EntityPacketRewriter1_20_2 extends EntityRewriter<ClientboundPackets1_19_4, Protocol1_20_2To1_20> {
   ...
   public void registerPackets() {
      ...
      this.protocol.registerClientbound(ClientboundPackets1_19_4.SPAWN_PLAYER, ClientboundPackets1_20_2.SPAWN_ENTITY, wrapper -> {
      ...
      this.protocol.registerClientbound(ClientboundPackets1_19_4.ENTITY_EFFECT, wrapper -> {
         wrapper.passthrough(Type.VAR_INT);
      ...
      this.protocol.registerClientbound(ClientboundPackets1_19_4.REMOVE_ENTITY_EFFECT, wrapper -> {
         wrapper.passthrough(Type.VAR_INT);
         wrapper.write(Type.VAR_INT, wrapper.read(Type.VAR_INT) - 1);
      });
   }
