            ...
            if (text != null) {
               ...
               try {
                  ...
                  if (!Via.getConfig().isSuppressConversionWarnings() || Via.getManager().isDebug()) {
                     Via.getPlatform().getLogger().log(Level.WARNING, "Error reading NBT in show_item:" + text, (Throwable)var15);
                  }
               ...
               try {
                  ...
                  Via.getPlatform().getLogger().log(Level.WARNING, "Error writing NBT in show_item:" + text, (Throwable)var14);
               }
            }
         }
      }
