            ...
            if (versionProvider == null) {
               ...
               if (protocolPath != null) {
                  ...
                  for (ProtocolPathEntry entry : protocolPath) {
                     ...
                     Via.getManager().getProtocolManager().completeMappingDataLoading((Class<? extends Protocol>)entry.protocol().getClass());
                  }
               ...
               if (Via.getManager().isDebug()) {
                  Via.getPlatform()
                     .getLogger()
                     .info("User connected with protocol: " + info.getProtocolVersion() + " and serverProtocol: " + info.getServerProtocolVersion());
