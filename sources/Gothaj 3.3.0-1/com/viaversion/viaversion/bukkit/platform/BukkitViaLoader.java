         ...
         if (serverProtocolVersion < ProtocolVersion.v1_14.getVersion()) {
            ...
            if (use1_9Fix || plugin.getConf().is1_14HitboxFix()) {
               try {
                  ...
                  Via.getPlatform().getLogger().log(Level.WARNING, "Could not load hitbox fix - please report this on our GitHub", (Throwable)var9);
               }
            }
         }
               ...
               public Item getHandItem(UserConnection info) {
                  if (BukkitViaLoader.this.handItemCache != null) {
                     ...
                     try {
                        ...
                        Via.getPlatform().getLogger().log(Level.SEVERE, "Error fetching hand item", (Throwable)var3);
                        return null;
                     }
                  }
               }
