...
public interface ViaBackwardsPlatform {
   ...
   default void init(File configFile) {
      com.viaversion.viabackwards.ViaBackwardsConfig config = new com.viaversion.viabackwards.ViaBackwardsConfig(configFile);
      config.reload();
      ...
      if (this.isOutdated()) {
         ...
         protocolManager.registerProtocol(
            ...
            Arrays.asList(ProtocolVersion.v1_9_1.getVersion(), ProtocolVersion.v1_9_2.getVersion()),
            ProtocolVersion.v1_9_3.getVersion()
         );
