...
public class Protocol1_16_1To1_16_2
   ...
   protected void registerPackets() {
      ...
      this.registerClientbound(ClientboundPackets1_16_2.CHAT_MESSAGE, wrapper -> {
      ...
      this.registerServerbound(ServerboundPackets1_16.RECIPE_BOOK_DATA, wrapper -> {
   ...
   public void init(UserConnection user) {
      ...
      user.addEntityTracker((Class<? extends Protocol>)this.getClass(), new EntityTrackerBase(user, EntityTypes1_16_2.PLAYER));
   }
