...
public class Protocol1_11_1To1_12 extends BackwardsProtocol<ClientboundPackets1_12, ClientboundPackets1_9_3, ServerboundPackets1_12, ServerboundPackets1_9_3> {
   ...
   protected void registerPackets() {
      ...
      this.registerClientbound(ClientboundPackets1_12.TITLE, wrapper -> {
   ...
   public void init(UserConnection user) {
      ...
      user.addEntityTracker((Class<? extends Protocol>)this.getClass(), new EntityTrackerBase(user, EntityTypes1_12.EntityType.PLAYER));
