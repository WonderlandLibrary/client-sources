...
public final class Protocol1_16_4To1_17
   ...
   protected void registerPackets() {
      ...
      this.registerClientbound(ClientboundPackets1_17.PING, null, wrapper -> {
         wrapper.cancel();
   ...
   public void mergePacket(ClientboundPackets1_17 newPacketType, ClientboundPackets1_16_2 oldPacketType, int type) {
      this.registerClientbound(newPacketType, oldPacketType, wrapper -> wrapper.write(Type.VAR_INT, type));
   }
