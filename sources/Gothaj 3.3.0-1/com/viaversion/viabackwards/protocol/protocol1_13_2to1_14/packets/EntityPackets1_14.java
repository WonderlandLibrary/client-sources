...
public class EntityPackets1_14 extends LegacyEntityRewriter<ClientboundPackets1_14, Protocol1_13_2To1_14> {
   ...
   protected void registerPackets() {
      ...
      this.protocol.registerClientbound(ClientboundPackets1_14.ENTITY_STATUS, wrapper -> {
      ...
      this.protocol.registerClientbound(ClientboundPackets1_14.ENTITY_TELEPORT, new PacketHandlers() {
         @Override
      ...
      this.protocol.registerClientbound(ClientboundPackets1_14.SPAWN_ENTITY, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.VAR_INT);
            this.map(Type.UUID);
            ...
            this.handler(wrapper -> {
               ...
               if (objectType != null) {
                  ...
                  if (objectType == EntityTypes1_13.ObjectType.FALLING_BLOCK) {
                     ...
                     int combined = EntityPackets1_14.this.protocol.getMappingData().getNewBlockStateId(blockState);
      ...
      this.protocol.registerClientbound(ClientboundPackets1_14.SPAWN_MOB, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.VAR_INT);
            this.map(Type.UUID);
      ...
      this.protocol.registerClientbound(ClientboundPackets1_14.SPAWN_EXPERIENCE_ORB, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.VAR_INT);
            this.map(Type.DOUBLE);
      ...
      this.protocol.registerClientbound(ClientboundPackets1_14.SPAWN_GLOBAL_ENTITY, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.VAR_INT);
            this.map(Type.BYTE);
      ...
      this.protocol.registerClientbound(ClientboundPackets1_14.SPAWN_PAINTING, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.VAR_INT);
            this.map(Type.UUID);
      ...
      this.protocol.registerClientbound(ClientboundPackets1_14.SPAWN_PLAYER, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.VAR_INT);
            this.map(Type.UUID);
      ...
      this.protocol.registerClientbound(ClientboundPackets1_14.JOIN_GAME, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.INT);
            ...
            this.handler(wrapper -> {
               short difficulty = (short)wrapper.user().get(DifficultyStorage.class).getDifficulty();
      ...
      this.protocol.registerClientbound(ClientboundPackets1_14.RESPAWN, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.INT);
            this.handler(wrapper -> {
   ...
   protected void registerRewrites() {
      ...
      this.registerMetaTypeHandler(
         Types1_13_2.META_TYPES.itemType,
         Types1_13_2.META_TYPES.blockStateType,
         null,
         null,
         Types1_13_2.META_TYPES.componentType,
         Types1_13_2.META_TYPES.optionalComponentType
      );
