...
public final class Protocol1_20To1_20_2
   ...
   protected void registerPackets() {
      ...
      this.registerClientbound(ClientboundPackets1_20_2.DISPLAY_SCOREBOARD, wrapper -> {
      ...
      this.registerClientbound(
         State.CONFIGURATION,
         ClientboundConfigurationPackets1_20_2.FINISH_CONFIGURATION.getId(),
         ClientboundConfigurationPackets1_20_2.FINISH_CONFIGURATION.getId(),
         wrapper -> {
            wrapper.cancel();
      ...
      this.registerClientbound(ClientboundPackets1_20_2.START_CONFIGURATION, null, wrapper -> {
         wrapper.cancel();
      ...
      this.registerClientbound(
         ...
         -1,
         wrapper -> wrapper.setPacketType(ClientboundPackets1_19_4.DISCONNECT)
      );
      this.registerClientbound(
         State.CONFIGURATION,
         ClientboundConfigurationPackets1_20_2.KEEP_ALIVE.getId(),
         -1,
         wrapper -> wrapper.setPacketType(ClientboundPackets1_19_4.KEEP_ALIVE)
      );
      this.registerClientbound(
         State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.PING.getId(), -1, wrapper -> wrapper.setPacketType(ClientboundPackets1_19_4.PING)
      );
   ...
   public void transform(Direction direction, State state, PacketWrapper wrapper) throws Exception {
      ...
      } else if (direction == Direction.CLIENTBOUND) {
