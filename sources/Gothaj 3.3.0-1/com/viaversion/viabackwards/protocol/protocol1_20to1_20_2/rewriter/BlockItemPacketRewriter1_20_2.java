...
public final class BlockItemPacketRewriter1_20_2 extends ItemRewriter<ClientboundPackets1_20_2, ServerboundPackets1_19_4, Protocol1_20To1_20_2> {
   ...
   public void registerPackets() {
      ...
      this.protocol.cancelClientbound(ClientboundPackets1_20_2.CHUNK_BATCH_START);
      this.protocol.registerClientbound(ClientboundPackets1_20_2.CHUNK_BATCH_FINISHED, null, wrapper -> {
         wrapper.cancel();
      ...
      this.protocol.registerClientbound(ClientboundPackets1_20_2.UNLOAD_CHUNK, wrapper -> {
      ...
      this.protocol.registerClientbound(ClientboundPackets1_20_2.MAP_DATA, wrapper -> {
      ...
      this.protocol.registerClientbound(ClientboundPackets1_20_2.NBT_QUERY, wrapper -> {
         wrapper.passthrough(Type.VAR_INT);
         wrapper.write(Type.NAMED_COMPOUND_TAG, wrapper.read(Type.COMPOUND_TAG));
      });
      this.protocol.registerClientbound(ClientboundPackets1_20_2.BLOCK_ENTITY_DATA, wrapper -> {
      ...
      this.protocol
         .registerClientbound(
            ClientboundPackets1_20_2.CHUNK_DATA,
            wrapper -> {
               EntityTracker tracker = this.protocol.getEntityRewriter().tracker(wrapper.user());
               Type<Chunk> chunkType = new ChunkType1_20_2(
               ...
               Type<Chunk> newChunkType = new ChunkType1_18(
                  tracker.currentWorldSectionHeight(),
      ...
      this.protocol.registerServerbound(ServerboundPackets1_19_4.SET_BEACON_EFFECT, wrapper -> {
         if (wrapper.passthrough(Type.BOOLEAN)) {
      ...
      this.protocol.registerClientbound(ClientboundPackets1_20_2.WINDOW_ITEMS, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.UNSIGNED_BYTE);
            this.map(Type.VAR_INT);
            this.handler(wrapper -> {
               Item[] items = wrapper.read(Type.ITEM1_20_2_ARRAY);
      ...
      this.protocol.registerClientbound(ClientboundPackets1_20_2.SET_SLOT, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.UNSIGNED_BYTE);
            this.map(Type.VAR_INT);
      ...
      this.protocol.registerClientbound(ClientboundPackets1_20_2.ADVANCEMENTS, wrapper -> {
         wrapper.passthrough(Type.BOOLEAN);
      ...
      this.protocol.registerClientbound(ClientboundPackets1_20_2.ENTITY_EQUIPMENT, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.VAR_INT);
            this.handler(wrapper -> {
      ...
      this.protocol.registerServerbound(ServerboundPackets1_19_4.CLICK_WINDOW, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.UNSIGNED_BYTE);
            this.map(Type.VAR_INT);
      ...
      this.protocol.registerClientbound(ClientboundPackets1_20_2.TRADE_LIST, wrapper -> {
         wrapper.passthrough(Type.VAR_INT);
         int size = wrapper.passthrough(Type.VAR_INT);
      ...
      this.protocol.registerServerbound(ServerboundPackets1_19_4.CREATIVE_INVENTORY_ACTION, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.SHORT);
      ...
      this.protocol.registerClientbound(ClientboundPackets1_20_2.SPAWN_PARTICLE, new PacketHandlers() {
         @Override
         public void register() {
            this.map(Type.VAR_INT);
   ...
   private CompoundTag handleBlockEntity(@Nullable CompoundTag tag) {
      if (tag == null) {
         ...
         StringTag primaryEffect = tag.remove("primary_effect");
         ...
         StringTag secondaryEffect = tag.remove("secondary_effect");
