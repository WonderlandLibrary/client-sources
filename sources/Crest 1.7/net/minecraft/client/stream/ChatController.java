...
public class ChatController
{
    ...
    public enum ChatState
    {
        ...
        private ChatState(final String s, final int n, final String stateName, final int id) {
        }
    }
    ...
    public enum EnumChannelState
    {
        ...
        private EnumChannelState(final String s, final int n, final String p_i46062_1_, final int p_i46062_2_) {
        }
    }
    ...
    public enum EnumEmoticonMode
    {
        ...
        private EnumEmoticonMode(final String s, final int n, final String p_i46060_1_, final int p_i46060_2_) {
        }
    }
