...
public class GuiScreenResourcePacks extends GuiScreen
{
    ...
    @Override
    public void initGui() {
        this.buttonList.add(new GuiOptionButton(2, this.width / 2 - 154, GuiScreenResourcePacks.height - 48, I18n.format("resourcePack.openFolder", new Object[0])));
        this.buttonList.add(new GuiOptionButton(1, this.width / 2 + 4, GuiScreenResourcePacks.height - 48, I18n.format("gui.done", new Object[0])));
        ...
        (this.field_146970_i = new GuiResourcePackAvailable(this.mc, 200, GuiScreenResourcePacks.height, this.field_146966_g)).setSlotXBoundsFromLeft(this.width / 2 - 4 - 200);
        this.field_146970_i.registerScrollButtons(7, 8);
        (this.field_146967_r = new GuiResourcePackSelected(this.mc, 200, GuiScreenResourcePacks.height, this.field_146969_h)).setSlotXBoundsFromLeft(this.width / 2 + 4);
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("resourcePack.folderInfo", new Object[0]), this.width / 2 - 77, GuiScreenResourcePacks.height - 26, 8421504);
