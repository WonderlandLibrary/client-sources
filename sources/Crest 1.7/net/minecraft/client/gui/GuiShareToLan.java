...
public class GuiShareToLan extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(101, this.width / 2 - 155, GuiShareToLan.height - 28, 150, 20, I18n.format("lanServer.start", new Object[0])));
        this.buttonList.add(new GuiButton(102, this.width / 2 + 5, GuiShareToLan.height - 28, 150, 20, I18n.format("gui.cancel", new Object[0])));
