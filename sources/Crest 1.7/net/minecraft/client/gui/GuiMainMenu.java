...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private void addSingleplayerMultiplayerButtons(final int p_73969_1_, final int p_73969_2_) {
        ...
        this.buttonList.add(this.field_175372_K = new GuiButton(69, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("Account Manager", new Object[0])));
    }
    ...
    private void renderSkybox(final int p_73971_1_, final int p_73971_2_, final float p_73971_3_) {
        ...
        final WorldRenderer var5 = var4.getWorldRenderer();
        var5.startDrawingQuads();
        final float var6 = (this.width > GuiMainMenu.height) ? (120.0f / this.width) : (120.0f / GuiMainMenu.height);
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final byte var8 = 30;
        this.drawGradientRect(0, 0, this.width, GuiMainMenu.height, -2130706433, 16777215);
        this.drawGradientRect(0, 0, this.width, GuiMainMenu.height, 0, Integer.MIN_VALUE);
        ...
        GlStateManager.popMatrix();
        final String var10 = "Made by Ruggero";
        this.drawString(this.fontRendererObj, var10, 2, GuiMainMenu.height - 10, -1);
        final String var11 = "Crest 1.7 BETA";
        this.drawString(this.fontRendererObj, var11, this.width - this.fontRendererObj.getStringWidth(var11) - 2, GuiMainMenu.height - 10, -1);
