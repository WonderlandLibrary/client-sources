...
public class GuiVideoSettings extends GuiScreen
{
    ...
    public void initGui() {
        ...
        for (var12 = 0; var12 < var10; ++var12) {
            ...
            final int y2 = GuiVideoSettings.height / 6 + 21 * (var12 / 2) - 10;
            if (y.getEnumFloat()) {
        ...
        int var13 = GuiVideoSettings.height / 6 + 21 * (var12 / 2) - 10;
        ...
        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, GuiVideoSettings.height / 6 + 168 + 11, I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(final int x, final int y, final float z) {
        ...
        if (Math.abs(x - this.lastMouseX) <= 5 && Math.abs(y - this.lastMouseY) <= 5) {
            ...
            if (System.currentTimeMillis() >= this.mouseStillTime + activateDelay) {
                ...
                int y2 = GuiVideoSettings.height / 6 - 5;
                if (y <= y2 + 98) {
                    y2 += 105;
                }
