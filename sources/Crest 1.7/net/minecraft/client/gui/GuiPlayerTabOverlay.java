...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void func_175249_a(final int p_175249_1_, final Scoreboard p_175249_2_, final ScoreObjective p_175249_3_) {
        ...
        if (var19 != null) {
            ...
            for (final String var22 : var19) {
                ...
                this.field_175250_f.fontRendererObj.func_175063_a(var22, p_175249_1_ / 2 - var23 / 2, var17, -1);
        ...
        for (int var24 = 0; var24 < var11; ++var24) {
            ...
            if (var24 < var5.size()) {
                ...
                if (var28.getGameType() == WorldSettings.GameType.SPECTATOR) {
                    ...
                    this.field_175250_f.fontRendererObj.func_175063_a(var29, var26, var27, -1862270977);
                }
                else {
                    this.field_175250_f.fontRendererObj.func_175063_a(var29, var26, var27, -1);
                }
    ...
    private void func_175247_a(final ScoreObjective p_175247_1_, final int p_175247_2_, final String p_175247_3_, final int p_175247_4_, final int p_175247_5_, final NetworkPlayerInfo p_175247_6_) {
        ...
        if (p_175247_1_.func_178766_e() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
            ...
            final int var9 = Math.max(MathHelper.ceiling_float_int(var7 / 2), Math.max(MathHelper.ceiling_float_int(p_175247_6_.func_178860_m() / 2), 10));
            ...
            if (var8 > 0) {
                ...
                if (var11 > 3.0f) {
                    ...
                    this.field_175250_f.fontRendererObj.func_175063_a(var15, (p_175247_5_ + p_175247_4_) / 2 - this.field_175250_f.fontRendererObj.getStringWidth(var15) / 2, p_175247_2_, var14);
                }
            }
        }
        else {
            final String var16 = new StringBuilder().append(EnumChatFormatting.YELLOW).append(var7).toString();
            this.field_175250_f.fontRendererObj.func_175063_a(var16, p_175247_5_ - this.field_175250_f.fontRendererObj.getStringWidth(var16), p_175247_2_, 16777215);
        }
    }
