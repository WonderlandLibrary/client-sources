...
public class GuiStreamUnavailable extends GuiScreen
{
    ...
    public void initGui() {
        ...
        if (this.field_152326_h.func_152559_b() != null) {
            this.buttonList.add(new GuiButton(0, this.width / 2 - 155, GuiStreamUnavailable.height - 50, 150, 20, I18n.format("gui.cancel", new Object[0])));
            this.buttonList.add(new GuiButton(1, this.width / 2 - 155 + 160, GuiStreamUnavailable.height - 50, 150, 20, I18n.format(this.field_152326_h.func_152559_b().getFormattedText(), new Object[0])));
        }
        else {
            this.buttonList.add(new GuiButton(0, this.width / 2 - 75, GuiStreamUnavailable.height - 50, 150, 20, I18n.format("gui.cancel", new Object[0])));
        }
    }
    ...
    public enum Reason
    {
        ...
        private Reason(final String s, final int n, final String p_i1066_1_, final int p_i1066_2_, final IChatComponent p_i1066_3_) {
            this(s, n, p_i1066_1_, p_i1066_2_, p_i1066_3_, null);
        }
        
        private Reason(final String s, final int n, final String p_i1067_1_, final int p_i1067_2_, final IChatComponent p_i1067_3_, final IChatComponent p_i1067_4_) {
