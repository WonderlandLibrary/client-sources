...
public class GuiIngestServers extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(1, this.width / 2 - 155, GuiIngestServers.height - 24 - 6, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(new GuiButton(2, this.width / 2 + 5, GuiIngestServers.height - 24 - 6, 150, 20, I18n.format("options.stream.ingest.reset", new Object[0])));
    }
    ...
    class ServerList extends GuiSlot
    {
        ...
        public ServerList(final Minecraft mcIn) {
            super(mcIn, GuiIngestServers.this.width, GuiIngestServers.height, 32, GuiIngestServers.height - 35, (int)(mcIn.fontRendererObj.FONT_HEIGHT * 3.5));
