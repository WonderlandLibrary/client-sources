    ...
    public void initGui() {
        ...
        for (final GameSettings.Options var5 : GuiStreamOptions.field_152312_a) {
            if (var5.getEnumFloat()) {
                this.buttonList.add(new GuiOptionSlider(var5.returnEnumOrdinal(), this.width / 2 - 155 + var1 % 2 * 160, GuiStreamOptions.height / 6 + 24 * (var1 >> 1), var5));
            }
            else {
                this.buttonList.add(new GuiOptionButton(var5.returnEnumOrdinal(), this.width / 2 - 155 + var1 % 2 * 160, GuiStreamOptions.height / 6 + 24 * (var1 >> 1), var5, this.field_152318_h.getKeyBinding(var5)));
            }
            ++var1;
        }
        if (var1 % 2 == 1) {
        ...
        this.buttonList.add(new GuiButton(200, this.width / 2 - 155, GuiStreamOptions.height / 6 + 168, 150, 20, I18n.format("gui.done", new Object[0])));
        final GuiButton var6 = new GuiButton(201, this.width / 2 + 5, GuiStreamOptions.height / 6 + 168, 150, 20, I18n.format("options.stream.ingestSelection", new Object[0]));
