...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 155, GuiCreateWorld.height - 28, 150, 20, I18n.format("selectWorld.create", new Object[0])));
        this.buttonList.add(new GuiButton(1, this.width / 2 + 5, GuiCreateWorld.height - 28, 150, 20, I18n.format("gui.cancel", new Object[0])));
    ...
    private void func_146319_h() {
        ...
        if (this.field_146341_s) {
            this.field_146325_B.displayString = String.valueOf(this.field_146325_B.displayString) + I18n.format("options.on", new Object[0]);
        }
        else {
            this.field_146325_B.displayString = String.valueOf(this.field_146325_B.displayString) + I18n.format("options.off", new Object[0]);
        }
        ...
        if (this.field_146338_v && !this.field_146337_w) {
            this.field_146326_C.displayString = String.valueOf(this.field_146326_C.displayString) + I18n.format("options.on", new Object[0]);
        }
        else {
            this.field_146326_C.displayString = String.valueOf(this.field_146326_C.displayString) + I18n.format("options.off", new Object[0]);
        }
        ...
        if (this.field_146340_t && !this.field_146337_w) {
            this.field_146321_E.displayString = String.valueOf(this.field_146321_E.displayString) + I18n.format("options.on", new Object[0]);
        }
        else {
            this.field_146321_E.displayString = String.valueOf(this.field_146321_E.displayString) + I18n.format("options.off", new Object[0]);
        }
    }
