    ...
    public void initGui() {
        ...
        for (final GameSettings.Options var5 : ScreenChatOptions.field_146399_a) {
            if (var5.getEnumFloat()) {
                this.buttonList.add(new GuiOptionSlider(var5.returnEnumOrdinal(), this.width / 2 - 155 + var1 % 2 * 160, ScreenChatOptions.height / 6 + 24 * (var1 >> 1), var5));
            }
            else {
                this.buttonList.add(new GuiOptionButton(var5.returnEnumOrdinal(), this.width / 2 - 155 + var1 % 2 * 160, ScreenChatOptions.height / 6 + 24 * (var1 >> 1), var5, this.game_settings.getKeyBinding(var5)));
            }
            ++var1;
        }
        if (var1 % 2 == 1) {
        ...
        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, ScreenChatOptions.height / 6 + 120, I18n.format("gui.done", new Object[0])));
    }
