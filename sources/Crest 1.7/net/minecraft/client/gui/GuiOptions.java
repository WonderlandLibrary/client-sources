...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui() {
        ...
        for (final GameSettings.Options var5 : GuiOptions.field_146440_f) {
            if (var5.getEnumFloat()) {
                this.buttonList.add(new GuiOptionSlider(var5.returnEnumOrdinal(), this.width / 2 - 155 + var1 % 2 * 160, GuiOptions.height / 6 - 12 + 24 * (var1 >> 1), var5));
            }
            else {
                final GuiOptionButton var6 = new GuiOptionButton(var5.returnEnumOrdinal(), this.width / 2 - 155 + var1 % 2 * 160, GuiOptions.height / 6 - 12 + 24 * (var1 >> 1), var5, this.game_settings_1.getKeyBinding(var5));
                this.buttonList.add(var6);
            }
            ++var1;
        }
        if (this.mc.theWorld != null) {
            final EnumDifficulty var7 = this.mc.theWorld.getDifficulty();
            this.field_175357_i = new GuiButton(108, this.width / 2 - 155 + var1 % 2 * 160, GuiOptions.height / 6 - 12 + 24 * (var1 >> 1), 150, 20, this.func_175355_a(var7));
        ...
        this.buttonList.add(new GuiButton(110, this.width / 2 - 155, GuiOptions.height / 6 + 48 - 6, 150, 20, I18n.format("options.skinCustomisation", new Object[0])));
        this.buttonList.add(new GuiButton(8675309, this.width / 2 + 5, GuiOptions.height / 6 + 48 - 6, 150, 20, "Super Secret Settings...") {
        ...
        this.buttonList.add(new GuiButton(106, this.width / 2 - 155, GuiOptions.height / 6 + 72 - 6, 150, 20, I18n.format("options.sounds", new Object[0])));
        this.buttonList.add(new GuiButton(107, this.width / 2 + 5, GuiOptions.height / 6 + 72 - 6, 150, 20, I18n.format("options.stream", new Object[0])));
        this.buttonList.add(new GuiButton(101, this.width / 2 - 155, GuiOptions.height / 6 + 96 - 6, 150, 20, I18n.format("options.video", new Object[0])));
        this.buttonList.add(new GuiButton(100, this.width / 2 + 5, GuiOptions.height / 6 + 96 - 6, 150, 20, I18n.format("options.controls", new Object[0])));
        this.buttonList.add(new GuiButton(102, this.width / 2 - 155, GuiOptions.height / 6 + 120 - 6, 150, 20, I18n.format("options.language", new Object[0])));
        this.buttonList.add(new GuiButton(103, this.width / 2 + 5, GuiOptions.height / 6 + 120 - 6, 150, 20, I18n.format("options.multiplayer.title", new Object[0])));
        this.buttonList.add(new GuiButton(105, this.width / 2 - 155, GuiOptions.height / 6 + 144 - 6, 150, 20, I18n.format("options.resourcepack", new Object[0])));
        this.buttonList.add(new GuiButton(104, this.width / 2 + 5, GuiOptions.height / 6 + 144 - 6, 150, 20, I18n.format("options.snooper.view", new Object[0])));
        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, GuiOptions.height / 6 + 168, I18n.format("gui.done", new Object[0])));
    }
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            if (button.id == 107) {
                this.mc.gameSettings.saveOptions();
                final IStream var3 = this.mc.getTwitchStream();
