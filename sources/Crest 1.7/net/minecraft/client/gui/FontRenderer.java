...
import me.chrest.client.friend.Friend;
import me.chrest.client.friend.FriendManager;
import me.chrest.client.module.modules.render.NameProtect;
...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    public FontRenderer(final GameSettings p_i1035_1_, final ResourceLocation p_i1035_2_, final TextureManager p_i1035_3_, final boolean p_i1035_4_) {
        ...
        p_i1035_3_.bindTexture(this.locationFontTexture = getHdFontLocation(this.locationFontTextureBase));
    ...
    public int func_175065_a(String p_175065_1_, final float p_175065_2_, final float p_175065_3_, final int p_175065_4_, final boolean p_175065_5_) {
    ...
    private void readCustomCharWidths() {
        final String fontFileName = this.locationFontTexture.getResourcePath();
        ...
        if (fontFileName.endsWith(suffix)) {
            ...
            try {
                final ResourceLocation e = new ResourceLocation(this.locationFontTexture.getResourceDomain(), fileName);
