...
public class GuiLanguage extends GuiScreen
{
    ...
    @Override
    public void initGui() {
        this.buttonList.add(this.field_146455_i = new GuiOptionButton(100, this.width / 2 - 155, GuiLanguage.height - 38, GameSettings.Options.FORCE_UNICODE_FONT, this.game_settings_3.getKeyBinding(GameSettings.Options.FORCE_UNICODE_FONT)));
        this.buttonList.add(this.field_146452_r = new GuiOptionButton(6, this.width / 2 - 155 + 160, GuiLanguage.height - 38, I18n.format("gui.done", new Object[0])));
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, "(" + I18n.format("options.languageWarning", new Object[0]) + ")", this.width / 2, GuiLanguage.height - 56, 8421504);
    ...
    class List extends GuiSlot
    {
        ...
        public List(final Minecraft mcIn) {
            super(mcIn, GuiLanguage.this.width, GuiLanguage.height, 32, GuiLanguage.height - 65 + 4, 18);
