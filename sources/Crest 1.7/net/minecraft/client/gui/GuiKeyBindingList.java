...
public class GuiKeyBindingList extends GuiListExtended
{
    ...
    public GuiKeyBindingList(final GuiControls p_i45031_1_, final Minecraft mcIn) {
        super(mcIn, p_i45031_1_.width, GuiControls.height, 63, GuiControls.height - 32, 20);
    ...
    public class KeyEntry implements IGuiListEntry
    {
        ...
        KeyEntry(final GuiKeyBindingList list, final KeyBinding p_i45030_2_, final Object p_i45030_3_) {
