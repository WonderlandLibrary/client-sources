...
public class GuiConfirmOpenLink extends GuiYesNo
{
    ...
    @Override
    public void initGui() {
        this.buttonList.add(new GuiButton(0, this.width / 2 - 50 - 105, GuiConfirmOpenLink.height / 6 + 96, 100, 20, this.confirmButtonText));
        this.buttonList.add(new GuiButton(2, this.width / 2 - 50, GuiConfirmOpenLink.height / 6 + 96, 100, 20, this.copyLinkButtonText));
        this.buttonList.add(new GuiButton(1, this.width / 2 - 50 + 105, GuiConfirmOpenLink.height / 6 + 96, 100, 20, this.cancelButtonText));
    }
