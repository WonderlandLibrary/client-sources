...
public class GuiCustomizeSkin extends GuiScreen
{
    ...
    public void initGui() {
        ...
        for (final EnumPlayerModelParts var5 : EnumPlayerModelParts.values()) {
            this.buttonList.add(new ButtonPart(var5.func_179328_b(), this.width / 2 - 155 + var1 % 2 * 160, GuiCustomizeSkin.height / 6 + 24 * (var1 >> 1), 150, 20, var5, null));
            ++var1;
        }
        if (var1 % 2 == 1) {
            ++var1;
        }
        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, GuiCustomizeSkin.height / 6 + 24 * (var1 >> 1), I18n.format("gui.done", new Object[0])));
    }
    ...
    class ButtonPart extends GuiButton
    {
        ...
        ButtonPart(final GuiCustomizeSkin guiCustomizeSkin, final int p_i45515_2_, final int p_i45515_3_, final int p_i45515_4_, final int p_i45515_5_, final int p_i45515_6_, final EnumPlayerModelParts p_i45515_7_, final Object p_i45515_8_) {
