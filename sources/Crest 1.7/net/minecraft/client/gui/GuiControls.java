...
public class GuiControls extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(200, this.width / 2 - 155, GuiControls.height - 29, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(this.buttonReset = new GuiButton(201, this.width / 2 - 155 + 160, GuiControls.height - 29, 150, 20, I18n.format("controls.resetAll", new Object[0])));
