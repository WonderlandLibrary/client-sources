...
public class GuiFlatPresets extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.field_146434_t = new GuiButton(0, this.width / 2 - 155, GuiFlatPresets.height - 28, 150, 20, I18n.format("createWorld.customize.presets.select", new Object[0])));
        this.buttonList.add(new GuiButton(1, this.width / 2 + 5, GuiFlatPresets.height - 28, 150, 20, I18n.format("gui.cancel", new Object[0])));
        this.func_146426_g();
    }
    ...
    class ListSlot extends GuiSlot
    {
        ...
        public ListSlot() {
            super(GuiFlatPresets.this.mc, GuiFlatPresets.this.width, GuiFlatPresets.height, 80, GuiFlatPresets.height - 37, 24);
