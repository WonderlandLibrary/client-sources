...
public class GuiChat extends GuiScreen
{
    ...
    public void initGui() {
        ...
        (this.inputField = new GuiTextField(0, this.fontRendererObj, 4, GuiChat.height - 12, this.width - 4, 12)).setMaxStringLength(100);
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        Gui.drawRect(2, GuiChat.height - 14, this.width - 2, GuiChat.height - 2, Integer.MIN_VALUE);
