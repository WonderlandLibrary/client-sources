...
public class GuiWinGame extends GuiScreen
{
        ...
        if (this.field_146582_i == null) {
            ...
            try {
                ...
                while ((var1 = var4.readLine()) != null) {
                    String var7;
                    String var8;
                    for (var1 = var1.replaceAll("PLAYERNAME", this.mc.getSession().getUsername()); var1.contains(var2); var1 = String.valueOf(var7) + EnumChatFormatting.WHITE + EnumChatFormatting.OBFUSCATED + "XXXXXXXX".substring(0, var5.nextInt(4) + 3) + var8) {
    ...
    private void drawWinGameScreen(final int p_146575_1_, final int p_146575_2_, final float p_146575_3_) {
        ...
        var5.addVertexWithUV(0.0, GuiWinGame.height, this.zLevel, 0.0, var7 * var9);
        var5.addVertexWithUV(var6, GuiWinGame.height, this.zLevel, var6 * var9, var7 * var9);
