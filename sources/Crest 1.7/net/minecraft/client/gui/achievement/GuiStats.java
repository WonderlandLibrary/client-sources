...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    public void createButtons() {
        this.buttonList.add(new GuiButton(0, this.width / 2 + 4, GuiStats.height - 28, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(new GuiButton(1, this.width / 2 - 160, GuiStats.height - 52, 80, 20, I18n.format("stat.generalButton", new Object[0])));
        final GuiButton var1;
        this.buttonList.add(var1 = new GuiButton(2, this.width / 2 - 80, GuiStats.height - 52, 80, 20, I18n.format("stat.blocksButton", new Object[0])));
        final GuiButton var2;
        this.buttonList.add(var2 = new GuiButton(3, this.width / 2, GuiStats.height - 52, 80, 20, I18n.format("stat.itemsButton", new Object[0])));
        final GuiButton var3;
        this.buttonList.add(var3 = new GuiButton(4, this.width / 2 + 80, GuiStats.height - 52, 80, 20, I18n.format("stat.mobsButton", new Object[0])));
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            this.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), this.width / 2, GuiStats.height / 2, 16777215);
            this.drawCenteredString(this.fontRendererObj, GuiStats.lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % GuiStats.lanSearchStates.length)], this.width / 2, GuiStats.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
        }
        else {
    ...
    abstract class Stats extends GuiSlot
    {
        ...
        protected Stats(final Minecraft mcIn) {
            super(mcIn, GuiStats.this.width, GuiStats.height, 32, GuiStats.height - 64, 20);
        ...
        protected void func_148142_b(final int p_148142_1_, final int p_148142_2_) {
            if (p_148142_2_ >= this.top && p_148142_2_ <= this.bottom) {
                ...
                if (var3 >= 0) {
                    ...
                    var6 = new StringBuilder().append(I18n.format(var6, new Object[0])).toString().trim();
                    if (var6.length() > 0) {
                        ...
                        GuiStats.this.fontRendererObj.func_175063_a(var6, var7, var8, -1);
                    }
                }
            }
        }
        ...
        protected void func_148213_a(final StatCrafting p_148213_1_, final int p_148213_2_, final int p_148213_3_) {
            if (p_148213_1_ != null) {
                ...
                final String var7 = new StringBuilder().append(I18n.format(String.valueOf(var6) + ".name", new Object[0])).toString().trim();
                if (var7.length() > 0) {
    ...
    class StatsGeneral extends GuiSlot
    {
        ...
        public StatsGeneral(final Minecraft mcIn) {
            super(mcIn, GuiStats.this.width, GuiStats.height, 32, GuiStats.height - 64, 10);
            this.setShowSelectionBox(false);
        }
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        public StatsMobsList(final Minecraft mcIn) {
            super(mcIn, GuiStats.this.width, GuiStats.height, 32, GuiStats.height - 64, GuiStats.this.fontRendererObj.FONT_HEIGHT * 4);
