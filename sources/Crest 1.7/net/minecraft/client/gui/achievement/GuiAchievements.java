...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiOptionButton(1, this.width / 2 + 24, GuiAchievements.height / 2 + 74, 80, 20, I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        if (this.loadingAchievements) {
            ...
            this.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), this.width / 2, GuiAchievements.height / 2, 16777215);
            this.drawCenteredString(this.fontRendererObj, GuiAchievements.lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % GuiAchievements.lanSearchStates.length)], this.width / 2, GuiAchievements.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
        }
        else {
    ...
    protected void drawAchievementScreen(final int p_146552_1_, final int p_146552_2_, final float p_146552_3_) {
        ...
        if (var35 != null) {
            ...
            if (this.statFileWriter.canUnlockAchievement(var35)) {
                ...
                if (this.statFileWriter.hasAchievementUnlocked(var35)) {
                    this.fontRendererObj.func_175063_a(I18n.format("achievement.taken", new Object[0]), var30, var38 + var34 + 4, -7302913);
                }
            }
            else if (var39 == 3) {
            ...
            if (var41 != null) {
                this.fontRendererObj.func_175063_a(var41, var30, var38, this.statFileWriter.canUnlockAchievement(var35) ? (var35.getSpecial() ? -128 : -1) : (var35.getSpecial() ? -8355776 : -8355712));
            }
        }
        GlStateManager.enableDepth();
        GlStateManager.enableLighting();
