...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected void drawHoveringText(final List textLines, final int x, final int y) {
        if (!textLines.isEmpty()) {
            ...
            for (int var14 = 0; var14 < textLines.size(); ++var14) {
                ...
                this.fontRendererObj.func_175063_a(var15, var8, var9, -1);
                if (var14 == 0) {
                    var9 += 2;
                }
                var9 += 10;
    ...
    public void handleMouseInput() throws IOException {
        ...
        final int var2 = GuiScreen.height - Mouse.getEventY() * GuiScreen.height / this.mc.displayHeight - 1;
    ...
    public void drawWorldBackground(final int tint) {
        if (this.mc.theWorld != null) {
            this.drawGradientRect(0, 0, this.width, GuiScreen.height, -1072689136, -804253680);
        }
        else {
    ...
    public void drawBackground(final int tint) {
        ...
        var3.addVertexWithUV(this.width, GuiScreen.height, 0.0, this.width / var4, GuiScreen.height / var4 + tint);
