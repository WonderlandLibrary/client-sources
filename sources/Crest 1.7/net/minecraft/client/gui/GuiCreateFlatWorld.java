...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.field_146389_t = new GuiButton(2, this.width / 2 - 154, GuiCreateFlatWorld.height - 52, 100, 20, String.valueOf(I18n.format("createWorld.customize.flat.addLayer", new Object[0])) + " (NYI)"));
        this.buttonList.add(this.field_146388_u = new GuiButton(3, this.width / 2 - 50, GuiCreateFlatWorld.height - 52, 100, 20, String.valueOf(I18n.format("createWorld.customize.flat.editLayer", new Object[0])) + " (NYI)"));
        this.buttonList.add(this.field_146386_v = new GuiButton(4, this.width / 2 - 155, GuiCreateFlatWorld.height - 52, 150, 20, I18n.format("createWorld.customize.flat.removeLayer", new Object[0])));
        this.buttonList.add(new GuiButton(0, this.width / 2 - 155, GuiCreateFlatWorld.height - 28, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(new GuiButton(5, this.width / 2 + 5, GuiCreateFlatWorld.height - 52, 150, 20, I18n.format("createWorld.customize.presets", new Object[0])));
        this.buttonList.add(new GuiButton(1, this.width / 2 + 5, GuiCreateFlatWorld.height - 28, 150, 20, I18n.format("gui.cancel", new Object[0])));
    ...
    class Details extends GuiSlot
    {
        ...
        public Details() {
            super(GuiCreateFlatWorld.this.mc, GuiCreateFlatWorld.this.width, GuiCreateFlatWorld.height, 43, GuiCreateFlatWorld.height - 60, 24);
