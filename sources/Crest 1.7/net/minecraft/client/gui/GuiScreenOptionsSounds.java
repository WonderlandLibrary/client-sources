...
public class GuiScreenOptionsSounds extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new Button(SoundCategory.MASTER.getCategoryId(), this.width / 2 - 155 + var1 % 2 * 160, GuiScreenOptionsSounds.height / 6 - 12 + 24 * (var1 >> 1), SoundCategory.MASTER, true));
        int var2 = var1 + 2;
        for (final SoundCategory var6 : SoundCategory.values()) {
            if (var6 != SoundCategory.MASTER) {
                this.buttonList.add(new Button(var6.getCategoryId(), this.width / 2 - 155 + var2 % 2 * 160, GuiScreenOptionsSounds.height / 6 - 12 + 24 * (var2 >> 1), var6, false));
                ++var2;
            }
        }
        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, GuiScreenOptionsSounds.height / 6 + 168, I18n.format("gui.done", new Object[0])));
    }
    ...
    protected String getSoundVolume(final SoundCategory p_146504_1_) {
        final float var2 = this.game_settings_4.getSoundLevel(p_146504_1_);
