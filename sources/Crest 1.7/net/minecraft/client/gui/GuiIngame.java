...
public class GuiIngame extends Gui
{
    ...
    public void func_175180_a(final float p_175180_1_) {
        ...
        if (this.recordPlayingUpFor > 0) {
            ...
            if (var9 > 8) {
                ...
                this.func_175179_f().drawString(this.recordPlaying, -this.func_175179_f().getStringWidth(this.recordPlaying) / 2, -4, var10 + (var9 << 24 & 0xFF000000));
                GlStateManager.disableBlend();
        ...
        if (this.field_175195_w > 0) {
            ...
            if (var9 > 8) {
                ...
                this.func_175179_f().func_175065_a(this.field_175201_x, -this.func_175179_f().getStringWidth(this.field_175201_x) / 2, -10.0f, 0xFFFFFF | var10, true);
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                GlStateManager.scale(2.0f, 2.0f, 2.0f);
                this.func_175179_f().func_175065_a(this.field_175200_y, -this.func_175179_f().getStringWidth(this.field_175200_y) / 2, 5.0f, 0xFFFFFF | var10, true);
                GlStateManager.popMatrix();
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
    ...
    public void func_175176_b(final ScaledResolution p_175176_1_, final int p_175176_2_) {
        ...
        if (this.mc.thePlayer.experienceLevel > 0) {
            ...
            final String var8 = new StringBuilder().append(this.mc.thePlayer.experienceLevel).toString();
    ...
    protected boolean func_175183_b() {
        ...
        if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            final BlockPos var1 = this.mc.objectMouseOver.func_178782_a();
