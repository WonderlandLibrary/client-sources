...
public class GuiSnooper extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.field_146605_t = new GuiButton(1, this.width / 2 - 152, GuiSnooper.height - 30, 150, 20, this.game_settings_2.getKeyBinding(GameSettings.Options.SNOOPER_ENABLED)));
        this.buttonList.add(new GuiButton(2, this.width / 2 + 2, GuiSnooper.height - 30, 150, 20, I18n.format("gui.done", new Object[0])));
        ...
        for (final Map.Entry var7 : new TreeMap(this.mc.getPlayerUsageSnooper().getCurrentStats()).entrySet()) {
            this.field_146604_g.add(String.valueOf(var5 ? "C " : "") + var7.getKey());
    ...
    class List extends GuiSlot
    {
        ...
        public List() {
            super(GuiSnooper.this.mc, GuiSnooper.this.width, GuiSnooper.height, 80, GuiSnooper.height - 40, GuiSnooper.this.fontRendererObj.FONT_HEIGHT + 1);
        }
