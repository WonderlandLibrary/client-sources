...
public class GuiCommandBlock extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.doneBtn = new GuiButton(0, this.width / 2 - 4 - 150, GuiCommandBlock.height / 4 + 120 + 12, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(this.cancelBtn = new GuiButton(1, this.width / 2 + 4, GuiCommandBlock.height / 4 + 120 + 12, 150, 20, I18n.format("gui.cancel", new Object[0])));
