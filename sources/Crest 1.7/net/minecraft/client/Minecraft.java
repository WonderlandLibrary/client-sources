...
import me.chrest.event.events.KeyPressEvent;
...
import me.chrest.event.events.RunLoopEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void func_175609_am() throws LWJGLException {
        ...
        Display.setTitle("Crest 1.7 REL");
        try {
    ...
    private void displayDebugInfo(final long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            this.fontRendererObj.func_175063_a(var19, var8 - var7, var9 - var7 / 2 - 16, var13);
            this.fontRendererObj.func_175063_a(var19 = String.valueOf(var18.format(var4.field_76330_b)) + "%", var8 + var7 - this.fontRendererObj.getStringWidth(var19), var9 - var7 / 2 - 16, var13);
            for (int var20 = 0; var20 < var3.size(); ++var20) {
                ...
                this.fontRendererObj.func_175063_a(var22, var8 - var7, var9 + var7 / 2 + var20 * 8 + 20, var21.func_76329_a());
                this.fontRendererObj.func_175063_a(var22 = String.valueOf(var18.format(var21.field_76332_a)) + "%", var8 + var7 - 50 - this.fontRendererObj.getStringWidth(var22), var9 + var7 / 2 + var20 * 8 + 20, var21.func_76329_a());
                this.fontRendererObj.func_175063_a(var22 = String.valueOf(var18.format(var21.field_76330_b)) + "%", var8 + var7 - this.fontRendererObj.getStringWidth(var22), var9 + var7 / 2 + var20 * 8 + 20, var21.func_76329_a());
            }
        }
    }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                if (Mouse.getEventButtonState()) {
                    final MouseEvent eventMouse = new MouseEvent(var6);
                    eventMouse.call();
