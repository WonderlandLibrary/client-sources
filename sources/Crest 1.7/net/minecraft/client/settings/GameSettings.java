...
public class GameSettings
{
    ...
    public String getKeyBinding(final Options p_74297_1_) {
        ...
        final String var2 = String.valueOf(I18n.format(p_74297_1_.getEnumString(), new Object[0])) + ": ";
        if (p_74297_1_.getEnumFloat()) {
            ...
            return (p_74297_1_ == Options.SENSITIVITY) ? ((var4 == 0.0f) ? (String.valueOf(var2) + I18n.format("options.sensitivity.min", new Object[0])) : ((var4 == 1.0f) ? (String.valueOf(var2) + I18n.format("options.sensitivity.max", new Object[0])) : (String.valueOf(var2) + (int)(var4 * 200.0f) + "%"))) : ((p_74297_1_ == Options.FOV) ? ((var3 == 70.0f) ? (String.valueOf(var2) + I18n.format("options.fov.min", new Object[0])) : ((var3 == 110.0f) ? (String.valueOf(var2) + I18n.format("options.fov.max", new Object[0])) : (String.valueOf(var2) + (int)var3))) : ((p_74297_1_ == Options.FRAMERATE_LIMIT) ? ((var3 == p_74297_1_.valueMax) ? (String.valueOf(var2) + I18n.format("options.framerateLimit.max", new Object[0])) : (String.valueOf(var2) + (int)var3 + " fps")) : ((p_74297_1_ == Options.RENDER_CLOUDS) ? ((var3 == p_74297_1_.valueMin) ? (String.valueOf(var2) + I18n.format("options.cloudHeight.min", new Object[0])) : (String.valueOf(var2) + ((int)var3 + 128))) : ((p_74297_1_ == Options.GAMMA) ? ((var4 == 0.0f) ? (String.valueOf(var2) + I18n.format("options.gamma.min", new Object[0])) : ((var4 == 1.0f) ? (String.valueOf(var2) + I18n.format("options.gamma.max", new Object[0])) : (String.valueOf(var2) + "+" + (int)(var4 * 100.0f) + "%"))) : ((p_74297_1_ == Options.SATURATION) ? (String.valueOf(var2) + (int)(var4 * 400.0f) + "%") : ((p_74297_1_ == Options.CHAT_OPACITY) ? (String.valueOf(var2) + (int)(var4 * 90.0f + 10.0f) + "%") : ((p_74297_1_ == Options.CHAT_HEIGHT_UNFOCUSED) ? (String.valueOf(var2) + GuiNewChat.calculateChatboxHeight(var4) + "px") : ((p_74297_1_ == Options.CHAT_HEIGHT_FOCUSED) ? (String.valueOf(var2) + GuiNewChat.calculateChatboxHeight(var4) + "px") : ((p_74297_1_ == Options.CHAT_WIDTH) ? (String.valueOf(var2) + GuiNewChat.calculateChatboxWidth(var4) + "px") : ((p_74297_1_ == Options.RENDER_DISTANCE) ? (String.valueOf(var2) + (int)var3 + " chunks") : ((p_74297_1_ == Options.MIPMAP_LEVELS) ? ((var3 == 0.0f) ? (String.valueOf(var2) + I18n.format("options.off", new Object[0])) : (String.valueOf(var2) + (int)var3)) : ((p_74297_1_ == Options.STREAM_FPS) ? (String.valueOf(var2) + TwitchStream.func_152948_a(var4) + " fps") : ((p_74297_1_ == Options.STREAM_KBPS) ? (String.valueOf(var2) + TwitchStream.func_152946_b(var4) + " Kbps") : ((p_74297_1_ == Options.STREAM_BYTES_PER_PIXEL) ? (String.valueOf(var2) + String.format("%.3f bpp", TwitchStream.func_152947_c(var4))) : ((var4 == 0.0f) ? (String.valueOf(var2) + I18n.format("options.off", new Object[0])) : (String.valueOf(var2) + (int)(var4 * 100.0f) + "%"))))))))))))))));
        }
        ...
        if (p_74297_1_ == Options.GUI_SCALE) {
            return String.valueOf(var2) + getTranslation(GameSettings.GUISCALES, this.guiScale);
        }
        ...
        if (p_74297_1_ == Options.PARTICLES) {
            return String.valueOf(var2) + getTranslation(GameSettings.PARTICLES, this.particleSetting);
        }
        if (p_74297_1_ == Options.AMBIENT_OCCLUSION) {
            return String.valueOf(var2) + getTranslation(GameSettings.AMBIENT_OCCLUSIONS, this.ambientOcclusion);
        }
        if (p_74297_1_ == Options.STREAM_COMPRESSION) {
            return String.valueOf(var2) + getTranslation(GameSettings.STREAM_COMPRESSIONS, this.streamCompression);
        }
        if (p_74297_1_ == Options.STREAM_CHAT_ENABLED) {
            return String.valueOf(var2) + getTranslation(GameSettings.STREAM_CHAT_MODES, this.streamChatEnabled);
        }
        if (p_74297_1_ == Options.STREAM_CHAT_USER_FILTER) {
            return String.valueOf(var2) + getTranslation(GameSettings.STREAM_CHAT_FILTER_MODES, this.streamChatUserFilter);
        }
        if (p_74297_1_ == Options.STREAM_MIC_TOGGLE_BEHAVIOR) {
            return String.valueOf(var2) + getTranslation(GameSettings.STREAM_MIC_MODES, this.streamMicToggleBehavior);
        }
            ...
            if (par1EnumOptions == Options.MIPMAP_TYPE) {
                ...
                if (par1EnumOptions == Options.CLOUDS) {
                    ...
                    if (par1EnumOptions == Options.BETTER_GRASS) {
                        ...
                        if (par1EnumOptions == Options.TRANSLUCENT_BLOCKS) {
                            return (this.ofTranslucentBlocks == 1) ? (String.valueOf(var2) + "Fast") : ((this.ofTranslucentBlocks == 2) ? (String.valueOf(var2) + "Fancy") : (String.valueOf(var2) + "Default"));
                        }
                        if (par1EnumOptions == Options.LAZY_CHUNK_LOADING) {
                        ...
                        if (par1EnumOptions == Options.FRAMERATE_LIMIT) {
                            final float var4 = this.getOptionFloatValue(par1EnumOptions);
                            return (var4 == 0.0f) ? (String.valueOf(var2) + "VSync") : ((var4 == par1EnumOptions.valueMax) ? (String.valueOf(var2) + I18n.format("options.framerateLimit.max", new Object[0])) : (String.valueOf(var2) + (int)var4 + " fps"));
                        }
                        return null;
                    }
                }
            ...
            while ((s = bufferedreader.readLine()) != null) {
                try {
                    ...
                    if (exception2[0].equals("ofPreloadedChunks") && exception2.length >= 2) {
                        this.ofPreloadedChunks = Integer.valueOf(exception2[1]);
    ...
    public enum Options
    {
        ...
        FOG_FANCY("FOG_FANCY", 43, "FOG_FANCY", 43, "FOG", 999, "Fog", false, false), 
        FOG_START("FOG_START", 44, "FOG_START", 44, "", 999, "Fog Start", false, false), 
        MIPMAP_TYPE("MIPMAP_TYPE", 45, "MIPMAP_TYPE", 45, "", 999, "Mipmap Type", false, false), 
        LOAD_FAR("LOAD_FAR", 46, "LOAD_FAR", 46, "", 999, "Load Far", false, false), 
        PRELOADED_CHUNKS("PRELOADED_CHUNKS", 47, "PRELOADED_CHUNKS", 47, "", 999, "Preloaded Chunks", false, false), 
        CLOUDS("CLOUDS", 48, "CLOUDS", 48, "", 999, "Clouds", false, false), 
        CLOUD_HEIGHT("CLOUD_HEIGHT", 49, "CLOUD_HEIGHT", 49, "", 999, "Cloud Height", true, false), 
        TREES("TREES", 50, "TREES", 50, "", 999, "Trees", false, false), 
        RAIN("RAIN", 51, "RAIN", 51, "", 999, "Rain & Snow", false, false), 
        ANIMATED_WATER("ANIMATED_WATER", 52, "ANIMATED_WATER", 52, "", 999, "Water Animated", false, false), 
        ANIMATED_LAVA("ANIMATED_LAVA", 53, "ANIMATED_LAVA", 53, "", 999, "Lava Animated", false, false), 
        ANIMATED_FIRE("ANIMATED_FIRE", 54, "ANIMATED_FIRE", 54, "", 999, "Fire Animated", false, false), 
        ANIMATED_PORTAL("ANIMATED_PORTAL", 55, "ANIMATED_PORTAL", 55, "", 999, "Portal Animated", false, false), 
        AO_LEVEL("AO_LEVEL", 56, "AO_LEVEL", 56, "", 999, "Smooth Lighting Level", true, false), 
        LAGOMETER("LAGOMETER", 57, "LAGOMETER", 57, "", 999, "Lagometer", false, false), 
        AUTOSAVE_TICKS("AUTOSAVE_TICKS", 58, "AUTOSAVE_TICKS", 58, "", 999, "Autosave", false, false), 
        BETTER_GRASS("BETTER_GRASS", 59, "BETTER_GRASS", 59, "", 999, "Better Grass", false, false), 
        ANIMATED_REDSTONE("ANIMATED_REDSTONE", 60, "ANIMATED_REDSTONE", 60, "", 999, "Redstone Animated", false, false), 
        ANIMATED_EXPLOSION("ANIMATED_EXPLOSION", 61, "ANIMATED_EXPLOSION", 61, "", 999, "Explosion Animated", false, false), 
        ANIMATED_FLAME("ANIMATED_FLAME", 62, "ANIMATED_FLAME", 62, "", 999, "Flame Animated", false, false), 
        ANIMATED_SMOKE("ANIMATED_SMOKE", 63, "ANIMATED_SMOKE", 63, "", 999, "Smoke Animated", false, false), 
        WEATHER("WEATHER", 64, "WEATHER", 64, "", 999, "Weather", false, false), 
        SKY("SKY", 65, "SKY", 65, "", 999, "Sky", false, false), 
        STARS("STARS", 66, "STARS", 66, "", 999, "Stars", false, false), 
        SUN_MOON("SUN_MOON", 67, "SUN_MOON", 67, "", 999, "Sun & Moon", false, false), 
        CHUNK_UPDATES("CHUNK_UPDATES", 68, "CHUNK_UPDATES", 68, "", 999, "Chunk Updates", false, false), 
        CHUNK_UPDATES_DYNAMIC("CHUNK_UPDATES_DYNAMIC", 69, "CHUNK_UPDATES_DYNAMIC", 69, "", 999, "Dynamic Updates", false, false), 
        TIME("TIME", 70, "TIME", 70, "", 999, "Time", false, false), 
        CLEAR_WATER("CLEAR_WATER", 71, "CLEAR_WATER", 71, "", 999, "Clear Water", false, false), 
        SMOOTH_WORLD("SMOOTH_WORLD", 72, "SMOOTH_WORLD", 72, "", 999, "Smooth World", false, false), 
        VOID_PARTICLES("VOID_PARTICLES", 73, "VOID_PARTICLES", 73, "", 999, "Void Particles", false, false), 
        WATER_PARTICLES("WATER_PARTICLES", 74, "WATER_PARTICLES", 74, "", 999, "Water Particles", false, false), 
        RAIN_SPLASH("RAIN_SPLASH", 75, "RAIN_SPLASH", 75, "", 999, "Rain Splash", false, false), 
        PORTAL_PARTICLES("PORTAL_PARTICLES", 76, "PORTAL_PARTICLES", 76, "", 999, "Portal Particles", false, false), 
        POTION_PARTICLES("POTION_PARTICLES", 77, "POTION_PARTICLES", 77, "", 999, "Potion Particles", false, false), 
        PROFILER("PROFILER", 78, "PROFILER", 78, "", 999, "Debug Profiler", false, false), 
        DRIPPING_WATER_LAVA("DRIPPING_WATER_LAVA", 79, "DRIPPING_WATER_LAVA", 79, "", 999, "Dripping Water/Lava", false, false), 
        BETTER_SNOW("BETTER_SNOW", 80, "BETTER_SNOW", 80, "", 999, "Better Snow", false, false), 
        FULLSCREEN_MODE("FULLSCREEN_MODE", 81, "FULLSCREEN_MODE", 81, "", 999, "Fullscreen Mode", false, false), 
        ANIMATED_TERRAIN("ANIMATED_TERRAIN", 82, "ANIMATED_TERRAIN", 82, "", 999, "Terrain Animated", false, false), 
        SWAMP_COLORS("SWAMP_COLORS", 83, "SWAMP_COLORS", 83, "", 999, "Swamp Colors", false, false), 
        RANDOM_MOBS("RANDOM_MOBS", 84, "RANDOM_MOBS", 84, "", 999, "Random Mobs", false, false), 
        SMOOTH_BIOMES("SMOOTH_BIOMES", 85, "SMOOTH_BIOMES", 85, "", 999, "Smooth Biomes", false, false), 
        CUSTOM_FONTS("CUSTOM_FONTS", 86, "CUSTOM_FONTS", 86, "", 999, "Custom Fonts", false, false), 
        CUSTOM_COLORS("CUSTOM_COLORS", 87, "CUSTOM_COLORS", 87, "", 999, "Custom Colors", false, false), 
        SHOW_CAPES("SHOW_CAPES", 88, "SHOW_CAPES", 88, "", 999, "Show Capes", false, false), 
        CONNECTED_TEXTURES("CONNECTED_TEXTURES", 89, "CONNECTED_TEXTURES", 89, "", 999, "Connected Textures", false, false), 
        AA_LEVEL("AA_LEVEL", 90, "AA_LEVEL", 90, "", 999, "Antialiasing", false, false), 
        AF_LEVEL("AF_LEVEL", 91, "AF_LEVEL", 91, "", 999, "Anisotropic Filtering", false, false), 
        ANIMATED_TEXTURES("ANIMATED_TEXTURES", 92, "ANIMATED_TEXTURES", 92, "", 999, "Textures Animated", false, false), 
        NATURAL_TEXTURES("NATURAL_TEXTURES", 93, "NATURAL_TEXTURES", 93, "", 999, "Natural Textures", false, false), 
        CHUNK_LOADING("CHUNK_LOADING", 94, "CHUNK_LOADING", 94, "", 999, "Chunk Loading", false, false), 
        HELD_ITEM_TOOLTIPS("HELD_ITEM_TOOLTIPS", 95, "HELD_ITEM_TOOLTIPS", 95, "", 999, "Held Item Tooltips", false, false), 
        DROPPED_ITEMS("DROPPED_ITEMS", 96, "DROPPED_ITEMS", 96, "", 999, "Dropped Items", false, false), 
        LAZY_CHUNK_LOADING("LAZY_CHUNK_LOADING", 97, "LAZY_CHUNK_LOADING", 97, "", 999, "Lazy Chunk Loading", false, false), 
        CUSTOM_SKY("CUSTOM_SKY", 98, "CUSTOM_SKY", 98, "", 999, "Custom Sky", false, false), 
        FAST_MATH("FAST_MATH", 99, "FAST_MATH", 99, "", 999, "Fast Math", false, false), 
        FAST_RENDER("FAST_RENDER", 100, "FAST_RENDER", 100, "", 999, "Fast Render", false, false), 
        TRANSLUCENT_BLOCKS("TRANSLUCENT_BLOCKS", 101, "TRANSLUCENT_BLOCKS", 101, "", 999, "Translucent Blocks", false, false);
        ...
        private Options(final String s, final int n, final String p_i46381_1_, final int p_i46381_2_, final String p_i1015_1_, final int p_i1015_2_, final String p_i1015_3_, final boolean p_i1015_4_, final boolean p_i1015_5_) {
            this(s, n, p_i46381_1_, p_i46381_2_, p_i1015_1_, p_i1015_2_, p_i1015_3_, p_i1015_4_, p_i1015_5_, 0.0f, 1.0f, 0.0f);
        }
        
        private Options(final String s, final int n, final String p_i46382_1_, final int p_i46382_2_, final String p_i45004_1_, final int p_i45004_2_, final String p_i45004_3_, final boolean p_i45004_4_, final boolean p_i45004_5_, final float p_i45004_6_, final float p_i45004_7_, final float p_i45004_8_) {
