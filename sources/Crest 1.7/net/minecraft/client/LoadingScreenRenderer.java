    ...
    public void setLoadingProgress(final int progress) {
        if (!this.mc.running) {
            ...
            if (var2 - this.field_73723_d >= 100L) {
                ...
                this.mc.fontRendererObj.func_175063_a(this.currentlyDisplayedText, (var5 - this.mc.fontRendererObj.getStringWidth(this.currentlyDisplayedText)) / 2, var6 / 2 - 4 - 16, 16777215);
                this.mc.fontRendererObj.func_175063_a(this.field_73727_a, (var5 - this.mc.fontRendererObj.getStringWidth(this.field_73727_a)) / 2, var6 / 2 - 4 + 8, 16777215);
