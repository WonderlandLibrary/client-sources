...
public class BlockModelRenderer
{
    ...
    public boolean renderBlockModel(final IBlockAccess blockAccessIn, final IBakedModel modelIn, final IBlockState blockStateIn, final BlockPos blockPosIn, final WorldRenderer worldRendererIn, final boolean checkSides) {
    ...
    private void renderModelAmbientOcclusionQuads(final IBlockAccess blockAccessIn, final Block blockIn, final BlockPos blockPosIn, final WorldRenderer worldRendererIn, final List listQuadsIn, final RenderEnv renderEnv) {
        ...
        for (BakedQuad var15 : listQuadsIn) {
            if (var15.getSprite() != null && Config.isConnectedTextures()) {
            ...
            final int colorMultiplier = CustomColorizer.getColorMultiplier(var15, blockIn, blockAccessIn, blockPosIn, renderEnv);
            if (!var15.func_178212_b() && colorMultiplier < 0) {
    ...
    private void renderModelStandardQuads(final IBlockAccess blockAccessIn, final Block blockIn, final BlockPos blockPosIn, final EnumFacing faceIn, int brightnessIn, final boolean ownBrightness, final WorldRenderer worldRendererIn, final List listQuadsIn, final RenderEnv renderEnv) {
        ...
        for (BakedQuad var17 : listQuadsIn) {
            ...
            final int colorMultiplier2 = CustomColorizer.getColorMultiplier(var17, blockIn, blockAccessIn, blockPosIn, renderEnv);
            if (var17.func_178212_b() || colorMultiplier2 >= 0) {
                int var18;
    ...
    {
        DOWN("DOWN", 0, "DOWN", 0, "DOWN", 0, new EnumFacing[] { EnumFacing.WEST, EnumFacing.EAST, EnumFacing.NORTH, EnumFacing.SOUTH }, 0.5f, false, new Orientation[0], new Orientation[0], new Orientation[0], new Orientation[0]), 
        UP("UP", 1, "UP", 1, "UP", 1, new EnumFacing[] { EnumFacing.EAST, EnumFacing.WEST, EnumFacing.NORTH, EnumFacing.SOUTH }, 1.0f, false, new Orientation[0], new Orientation[0], new Orientation[0], new Orientation[0]), 
    ...
    public enum Orientation
    {
        ...
        private Orientation(final String s, final int n, final String p_i46389_1_, final int p_i46389_2_, final String p_i46233_1_, final int p_i46233_2_, final EnumFacing p_i46233_3_, final boolean p_i46233_4_) {
    ...
    enum VertexTranslations
    {
        ...
        private VertexTranslations(final String s, final int n, final String p_i46388_1_, final int p_i46388_2_, final String p_i46234_1_, final int p_i46234_2_, final int p_i46234_3_, final int p_i46234_4_, final int p_i46234_5_, final int p_i46234_6_) {
