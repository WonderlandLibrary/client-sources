...
public class BlockFluidRenderer
{
    ...
    public boolean func_178270_a(final IBlockAccess p_178270_1_, final IBlockState p_178270_2_, final BlockPos p_178270_3_, final WorldRenderer p_178270_4_) {
        ...
        final int var7 = CustomColorizer.getFluidColor(var5, p_178270_1_, p_178270_3_);
        ...
        if (var11) {
            ...
            p_178270_4_.setBrightness(var5.getMixedBrightnessForBlock(p_178270_1_, p_178270_3_));
        ...
        if (var12) {
            p_178270_4_.setBrightness(var5.getMixedBrightnessForBlock(p_178270_1_, p_178270_3_.offsetDown()));
        ...
        for (int var41 = 0; var41 < 4; ++var41) {
            ...
            if (var13[var41]) {
                ...
                p_178270_4_.setBrightness(var5.getMixedBrightnessForBlock(p_178270_1_, var44));
                float var54 = 1.0f;
                var54 *= ((var41 < 2) ? var17 : var18);
                p_178270_4_.setColorOpaque_F(var16 * var54 * var8, var16 * var54 * var9, var16 * var54 * var10);
