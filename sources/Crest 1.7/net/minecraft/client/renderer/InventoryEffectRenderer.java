        ...
        if (!var4.isEmpty()) {
            ...
            for (final PotionEffect var7 : this.mc.thePlayer.getActivePotionEffects()) {
                ...
                if (var7.getAmplifier() == 1) {
                    var10 = String.valueOf(var10) + " " + I18n.format("enchantment.level.2", new Object[0]);
                }
                else if (var7.getAmplifier() == 2) {
                    var10 = String.valueOf(var10) + " " + I18n.format("enchantment.level.3", new Object[0]);
                }
                else if (var7.getAmplifier() == 3) {
                    var10 = String.valueOf(var10) + " " + I18n.format("enchantment.level.4", new Object[0]);
                }
                this.fontRendererObj.func_175063_a(var10, var1 + 10 + 18, var2 + 6, 16777215);
                final String var11 = Potion.getDurationString(var7);
                this.fontRendererObj.func_175063_a(var11, var1 + 10 + 18, var2 + 6 + 10, 8355711);
                var2 += var5;
            }
        }
    }
