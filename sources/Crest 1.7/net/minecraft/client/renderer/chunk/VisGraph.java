...
public class VisGraph
{
            ...
            for (int var5 = 0; var5 < 16; ++var5) {
                for (int var6 = 0; var6 < 16; ++var6) {
                    if (var4 == 0 || var4 == 15 || var5 == 0 || var5 == 15 || var6 == 0 || var6 == 15) {
                        VisGraph.field_178613_e[var3++] = func_178605_a(var4, var5, var6);
                    }
                }
            }
        }
    ...
    public void func_178606_a(final BlockPos p_178606_1_) {
        final BlockCullEvent blockCullEvent = new BlockCullEvent();
        blockCullEvent.call();
        if (blockCullEvent.isCancelled()) {
            return;
        }
    ...
    public SetVisibility func_178607_a() {
        ...
        if (4096 - this.field_178611_f < 256) {
            ...
            for (final int var5 : VisGraph.field_178613_e) {
    ...
    private Set func_178604_a(final int p_178604_1_) {
        ...
        while (!var3.isEmpty()) {
            ...
            for (final EnumFacing var8 : EnumFacing.VALUES) {
                final int var9 = this.func_178603_a(var4, var8);
