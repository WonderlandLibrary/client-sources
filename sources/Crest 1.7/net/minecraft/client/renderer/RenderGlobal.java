...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener
{
    ...
    public RenderGlobal(final Minecraft mcIn) {
        ...
        (this.field_175014_r = new VertexFormat()).setElement(new VertexFormatElement(0, VertexFormatElement.EnumType.FLOAT, VertexFormatElement.EnumUseage.POSITION, 3));
        this.func_174963_q();
        this.func_174980_p();
        this.func_174964_o();
    }
        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            if (this.func_174985_d()) {
                ...
                for (int var12 = 0; var12 < var11.size(); ++var12) {
                    ...
                    final boolean var14 = this.mc.func_175606_aa() instanceof EntityLivingBase && ((EntityLivingBase)this.mc.func_175606_aa()).isPlayerSleeping();
                    final boolean var15 = var13.isInRangeToRender3d(var4, var5, var6) && (var13.ignoreFrustumCheck || p_180446_2_.isBoundingBoxInFrustum(var13.getEntityBoundingBox()) || var13.riddenByEntity == this.mc.thePlayer) && var13 instanceof EntityPlayer;
                    if ((var13 != this.mc.func_175606_aa() || this.mc.gameSettings.thirdPersonView != 0 || var14) && var15) {
                        this.field_175010_j.renderEntitySimple(var13, partialTicks);
                    }
                }
            ...
            Iterator var16 = this.glRenderLists.iterator();
            final boolean oldFancyGraphics = this.mc.gameSettings.fancyGraphics;
            this.mc.gameSettings.fancyGraphics = Config.isDroppedItemsFancy();
            while (var16.hasNext()) {
                final ContainerLocalRenderInformation var17 = var16.next();
                final Chunk fontRenderer = this.theWorld.getChunkFromBlockCoords(var17.field_178036_a.func_178568_j());
                final ClassInheratanceMultiMap var18 = fontRenderer.getEntityLists()[var17.field_178036_a.func_178568_j().getY() / 16];
                ...
                while (((Iterator)var19).hasNext()) {
                    ...
                    final boolean var21 = this.field_175010_j.func_178635_a(var20, p_180446_2_, var4, var5, var6) || var20.riddenByEntity == this.mc.thePlayer;
                    if (var21) {
                        ...
                        if (var20 == this.mc.func_175606_aa() && this.mc.gameSettings.thirdPersonView == 0 && !teClass) {
                            continue;
                        }
                        if (var20.posY >= 0.0 && var20.posY < 256.0 && !this.theWorld.isBlockLoaded(new BlockPos(var20))) {
                            continue;
                        }
                        ++this.countEntitiesRendered;
                        if (var20.getClass() == EntityItemFrame.class) {
                            var20.renderDistanceWeight = 0.06;
                        }
                        this.renderedEntity = var20;
                        this.field_175010_j.renderEntitySimple(var20, partialTicks);
                        this.renderedEntity = null;
                    }
                    if (!var21 && var20 instanceof EntityWitherSkull) {
                        this.mc.getRenderManager().func_178630_b(var20, partialTicks);
                    }
                }
            }
            this.mc.gameSettings.fancyGraphics = oldFancyGraphics;
            final FontRenderer var22 = TileEntityRendererDispatcher.instance.getFontRenderer();
            this.theWorld.theProfiler.endStartSection("blockentities");
            RenderHelper.enableStandardItemLighting();
            var16 = this.glRenderLists.iterator();
            while (var16.hasNext()) {
                final ContainerLocalRenderInformation var17 = var16.next();
                final List var23 = var17.field_178036_a.func_178571_g().func_178485_b();
                ...
                while (((Iterator)var24).hasNext()) {
                    ...
                    if (var26 == TileEntitySign.class && !Config.zoomMode) {
                        final EntityPlayerSP pl = this.mc.thePlayer;
                        final double distSq = var25.getDistanceSq(pl.posX, pl.posY, pl.posZ);
                        if (distSq > 256.0) {
                            var22.enabled = false;
                        }
                    }
                    TileEntityRendererDispatcher.instance.func_180546_a(var25, partialTicks, -1);
                    var22.enabled = true;
                }
            }
            this.func_180443_s();
            var16 = this.damagedBlocks.values().iterator();
            while (var16.hasNext()) {
                final DestroyBlockProgress var27 = var16.next();
                BlockPos var28 = var27.func_180246_b();
                TileEntity var25 = this.theWorld.getTileEntity(var28);
                if (var25 instanceof TileEntityChest) {
                    final TileEntityChest var29 = (TileEntityChest)var25;
                    if (var29.adjacentChestXNeg != null) {
                        var28 = var28.offset(EnumFacing.WEST);
                        var25 = this.theWorld.getTileEntity(var28);
                    }
                    else if (var29.adjacentChestZNeg != null) {
                        var28 = var28.offset(EnumFacing.NORTH);
                        var25 = this.theWorld.getTileEntity(var28);
                    }
                }
                final Block var30 = this.theWorld.getBlockState(var28).getBlock();
                if (var25 != null && (var30 instanceof BlockChest || var30 instanceof BlockEnderChest || var30 instanceof BlockSign || var30 instanceof BlockSkull)) {
                    TileEntityRendererDispatcher.instance.func_180546_a(var25, partialTicks, var27.getPartialBlockDamage());
                }
            }
            this.func_174969_t();
    ...
    public void func_174976_a(final float partialTicks, final int pass) {
        ...
        if (this.mc.theWorld.provider.getDimensionId() == 1) {
            ...
            if (var14 != null && Config.isSunMoonEnabled()) {
                ...
                var13.setColorRGBA_F(var15, var16, var17, var14[3]);
            ...
            if (this.mc.theWorld.provider.isSurfaceWorld()) {
                if (Config.isCloudsFancy()) {
                    ...
                    if (this.isFancyGlListClouds || this.cloudTickCounter >= this.cloudTickCounterGlList + 20) {
                        ...
                        var8.setColorRGBA_F(exactPlayerX, var9, exactPlayerY, 0.8f);
            ...
            if (!this.isFancyGlListClouds || this.cloudTickCounter >= this.cloudTickCounterGlList + 20) {
                ...
                for (int entityliving = -3; entityliving <= 4; ++entityliving) {
                    for (int exactPlayerX = -3; exactPlayerX <= 4; ++exactPlayerX) {
                        ...
                        if (var11 > -5.0f) {
                            var5.setColorRGBA_F(var15 * 0.7f, var16 * 0.7f, var17 * 0.7f, 0.8f);
                        ...
                        if (var11 <= 5.0f) {
                            var5.setColorRGBA_F(var15, var16, var17, 0.8f);
                            var5.func_178980_d(0.0f, 1.0f, 0.0f);
                        ...
                        var5.setColorRGBA_F(var15 * 0.9f, var16 * 0.9f, var17 * 0.9f, 0.8f);
                        if (entityliving > -1) {
                        ...
                        var5.setColorRGBA_F(var15 * 0.8f, var16 * 0.8f, var17 * 0.8f, 0.8f);
                        if (exactPlayerX > -1) {
    ...
    public void drawSelectionBox(final EntityPlayer p_72731_1_, final MovingObjectPosition p_72731_2_, final int p_72731_3_, final float p_72731_4_) {
        if (p_72731_3_ == 0 && p_72731_2_.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            final BlockPos var6 = p_72731_2_.func_178782_a();
    ...
    class ContainerLocalRenderInformation
    {
        ...
        ContainerLocalRenderInformation(final RenderGlobal renderGlobal, final RenderChunk p_i46249_2_, final EnumFacing p_i46249_3_, final int p_i46249_4_, final Object p_i46249_5_) {
