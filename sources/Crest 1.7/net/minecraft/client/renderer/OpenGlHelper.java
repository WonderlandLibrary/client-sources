...
public class OpenGlHelper
{
    ...
    public static void initializeTextures() {
        ...
        if (OpenGlHelper.framebufferSupported) {
            ...
            OpenGlHelper.field_153196_B = String.valueOf(OpenGlHelper.field_153196_B) + "OpenGL 1.4 is " + (var0.OpenGL14 ? "" : "not ") + "supported, ";
            OpenGlHelper.field_153196_B = String.valueOf(OpenGlHelper.field_153196_B) + "EXT_blend_func_separate is " + (var0.GL_EXT_blend_func_separate ? "" : "not ") + "supported, ";
            OpenGlHelper.field_153196_B = String.valueOf(OpenGlHelper.field_153196_B) + "OpenGL 3.0 is " + (var0.OpenGL30 ? "" : "not ") + "supported, ";
            OpenGlHelper.field_153196_B = String.valueOf(OpenGlHelper.field_153196_B) + "ARB_framebuffer_object is " + (var0.GL_ARB_framebuffer_object ? "" : "not ") + "supported, and ";
            OpenGlHelper.field_153196_B = String.valueOf(OpenGlHelper.field_153196_B) + "EXT_framebuffer_object is " + (var0.GL_EXT_framebuffer_object ? "" : "not ") + "supported.\n";
        }
        ...
        if (OpenGlHelper.field_153213_x) {
            ...
            OpenGlHelper.field_153196_B = String.valueOf(OpenGlHelper.field_153196_B) + "OpenGL 2.1 is " + (var0.OpenGL21 ? "" : "not ") + "supported, ";
            OpenGlHelper.field_153196_B = String.valueOf(OpenGlHelper.field_153196_B) + "ARB_shader_objects is " + (var0.GL_ARB_shader_objects ? "" : "not ") + "supported, ";
            OpenGlHelper.field_153196_B = String.valueOf(OpenGlHelper.field_153196_B) + "ARB_vertex_shader is " + (var0.GL_ARB_vertex_shader ? "" : "not ") + "supported, and ";
            OpenGlHelper.field_153196_B = String.valueOf(OpenGlHelper.field_153196_B) + "ARB_fragment_shader is " + (var0.GL_ARB_fragment_shader ? "" : "not ") + "supported.\n";
        }
    ...
    public static void func_176072_g(final int p_176072_0_, final int p_176072_1_) {
        if (OpenGlHelper.field_176090_Y) {
            ARBBufferObject.glBindBufferARB(p_176072_0_, p_176072_1_);
        }
        else {
    ...
    public static void func_176071_a(final int p_176071_0_, final ByteBuffer p_176071_1_, final int p_176071_2_) {
        if (OpenGlHelper.field_176090_Y) {
            ARBBufferObject.glBufferDataARB(p_176071_0_, p_176071_1_, p_176071_2_);
        }
        else {
    ...
    public static void func_176074_g(final int p_176074_0_) {
        if (OpenGlHelper.field_176090_Y) {
            ARBBufferObject.glDeleteBuffersARB(p_176074_0_);
        }
        else {
    ...
    public static boolean func_176075_f() {
        return OpenGlHelper.field_176083_O && Minecraft.getMinecraft().gameSettings.field_178881_t;
    }
