...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void func_175035_a(final IBakedModel p_175035_1_, final int p_175035_2_) {
    ...
    public void func_180454_a(final ItemStack p_180454_1_, final IBakedModel p_180454_2_) {
    ...
    public void renderItem(final ItemStack stack, final IBakedModel model, final boolean renderEffect) {
        if (renderEffect) {
            this.func_180454_a(stack, model);
        }
        else {
            GlStateManager.pushMatrix();
    ...
    private void func_175038_a(final WorldRenderer p_175038_1_, final BakedQuad p_175038_2_) {
        ...
        p_175038_1_.func_178975_e(var3.getX(), var3.getY(), var3.getZ());
    }
    ...
    protected void func_175040_a(final ItemStack p_175040_1_, final IBakedModel p_175040_2_, final ItemCameraTransforms.TransformType p_175040_3_) {
        this.field_175057_n.bindTexture(TextureMap.locationBlocksTexture);
    ...
    public void func_175042_a(final ItemStack p_175042_1_, final int p_175042_2_, final int p_175042_3_) {
        final IBakedModel var4 = this.itemModelMesher.getItemModel(p_175042_1_);
        GlStateManager.pushMatrix();
        this.field_175057_n.bindTexture(TextureMap.locationBlocksTexture);
        this.field_175057_n.getTexture(TextureMap.locationBlocksTexture).func_174936_b(false, false);
        GlStateManager.enableRescaleNormal();
    ...
    private void func_180452_a(final int p_180452_1_, final int p_180452_2_, final boolean p_180452_3_) {
        GlStateManager.translate(p_180452_1_, p_180452_2_, 100.0f + this.zLevel);
    ...
    public void func_180453_a(final FontRenderer p_180453_1_, final ItemStack p_180453_2_, final int p_180453_3_, final int p_180453_4_, final String p_180453_5_) {
        if (p_180453_2_ != null) {
            if (p_180453_2_.stackSize != 1 || p_180453_5_ != null) {
                ...
                GlStateManager.disableDepth();
                GlStateManager.disableBlend();
                p_180453_1_.func_175063_a(var6, p_180453_3_ + 19 - 2 - p_180453_1_.getStringWidth(var6), p_180453_4_ + 6 + 3, 16777215);
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
            }
            if (p_180453_2_.isItemDamaged()) {
                final int var7 = (int)Math.round(13.0 - p_180453_2_.getItemDamage() * 13.0 / p_180453_2_.getMaxDamage());
                final int var8 = (int)Math.round(255.0 - p_180453_2_.getItemDamage() * 255.0 / p_180453_2_.getMaxDamage());
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                ...
                this.func_175044_a(var10, p_180453_3_ + 2, p_180453_4_ + 13, 13, 2, 0);
                this.func_175044_a(var10, p_180453_3_ + 2, p_180453_4_ + 13, 12, 1, var12);
                this.func_175044_a(var10, p_180453_3_ + 2, p_180453_4_ + 13, var7, 1, var11);
                GlStateManager.enableBlend();
                GlStateManager.enableAlpha();
    ...
    private void func_175044_a(final WorldRenderer p_175044_1_, final int p_175044_2_, final int p_175044_3_, final int p_175044_4_, final int p_175044_5_, final int p_175044_6_) {
    ...
    public void renderItemIntoGUI(final ItemStack stack, final int x, final int y, final boolean effect) {
        final IBakedModel var4 = this.itemModelMesher.getItemModel(stack);
        GlStateManager.pushMatrix();
        this.field_175057_n.bindTexture(TextureMap.locationBlocksTexture);
        this.field_175057_n.getTexture(TextureMap.locationBlocksTexture).func_174936_b(false, false);
        GlStateManager.enableRescaleNormal();
        ...
        GlStateManager.blendFunc(770, 771);
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
        this.func_180452_a(x, y, var4.isGui3d());
        this.func_175034_a(var4.getItemCameraTransforms().field_178354_e);
    ...
    public void renderItemOverlayIntoGUI(final FontRenderer fr, final ItemStack stack, final int xPosition, final int yPosition, final String text) {
        if (stack != null) {
            if (stack.stackSize != 1 || text != null) {
                ...
                GlStateManager.disableDepth();
                GlStateManager.disableBlend();
                ClientUtils.clientFont.drawStringWithShadow(var6, xPosition + 19 - 2 - fr.getStringWidth(var6), yPosition + 6 + 3, 16777215);
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
            }
            if (stack.isItemDamaged()) {
                final int var7 = (int)Math.round(13.0 - stack.getItemDamage() * 13.0 / stack.getMaxDamage());
                final int var8 = (int)Math.round(255.0 - stack.getItemDamage() * 255.0 / stack.getMaxDamage());
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                ...
                final int var11 = 255 - var8 << 16 | var8 << 8;
                final int var12 = (255 - var8) / 4 << 16 | 0x3F00;
                this.func_175044_a(var10, xPosition + 2, yPosition + 13, 13, 2, 0);
                this.func_175044_a(var10, xPosition + 2, yPosition + 13, 12, 1, var12);
                this.func_175044_a(var10, xPosition + 2, yPosition + 13, var7, 1, var11);
                GlStateManager.enableBlend();
                GlStateManager.enableAlpha();
    ...
    public void renderItemIntoGUIHot(final ItemStack stack, final int x, final int y) {
        final IBakedModel var4 = this.itemModelMesher.getItemModel(stack);
        GlStateManager.pushMatrix();
        this.field_175057_n.bindTexture(TextureMap.locationBlocksTexture);
        this.field_175057_n.getTexture(TextureMap.locationBlocksTexture).func_174936_b(false, false);
