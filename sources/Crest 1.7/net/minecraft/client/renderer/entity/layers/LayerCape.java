...
public class LayerCape implements LayerRenderer
{
    ...
    public void doRenderLayer(final AbstractClientPlayer p_177166_1_, final float p_177166_2_, final float p_177166_3_, final float p_177166_4_, final float p_177166_5_, final float p_177166_6_, final float p_177166_7_, final float p_177166_8_) {
        final boolean b = FriendManager.isFriend(p_177166_1_.getName());
        if ((p_177166_1_.hasCape() && !p_177166_1_.isInvisible() && p_177166_1_.func_175148_a(EnumPlayerModelParts.CAPE) && p_177166_1_.getLocationCape() != null) || b) {
            GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
            this.playerRenderer.bindTexture((Client.isAtlasMember(p_177166_1_.getName()) || b) ? Client.getAtlasCape(p_177166_1_.getName()) : p_177166_1_.getLocationCape());
