...
import me.chrest.client.module.modules.render.Brightness;
import org.lwjgl.opengl.GL11;
import net.minecraft.potion.Potion;
import org.lwjgl.util.glu.Project;
import net.minecraft.block.state.IBlockState;
import net.minecraft.entity.passive.EntityAnimal;
import me.chrest.client.module.modules.render.ViewClip;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
                    ...
                    if (var15.isVecInside(var5)) {
                        ...
                        if (var17 < var11 || var11 == 0.0) {
                            ...
                            if (Reflector.ForgeEntity_canRiderInteract.exists()) {
                                canRiderInteract = Reflector.callBoolean(var12, Reflector.ForgeEntity_canRiderInteract, new Object[0]);
                            }
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                for (int var17 = 0; var17 < 8; ++var17) {
                    ...
                    if (var21 != null) {
                        ...
                        final ViewClip mod = (ViewClip)new ViewClip().getInstance();
                        if (var22 < var11 && !mod.isEnabled()) {
                            var11 = var22;
                        }
                    }
                }
    ...
    private float func_180438_a(final EntityLivingBase p_180438_1_, final float partialTicks) {
        final int var3 = new Brightness().getInstance().isEnabled() ? Integer.MAX_VALUE : p_180438_1_.getActivePotionEffect(Potion.nightVision).getDuration();
                    ...
                    if (var25.canSpawnLightningBolt() || var25.getEnableSnow()) {
                        ...
                        if (var27 != var28) {
                            ...
                            if (var6.getWorldChunkManager().getTemperatureAtHeight(var31, var26) >= 0.15f) {
                                ...
                                var11.setBrightness(var6.getCombinedLight(new BlockPos(var20, var30, var19), 0));
                                var11.setColorRGBA_F(var36, var36, var36, ((1.0f - var35 * var35) * 0.5f + 0.5f) * var4);
                                ...
                                var11.setBrightness((var6.getCombinedLight(new BlockPos(var20, var30, var19), 0) * 3 + 15728880) / 4);
                                var11.setColorRGBA_F(var41, var41, var41, ((1.0f - var40 * var40) * 0.3f + 0.5f) * var4);
                                var11.setTranslation(-var12 * 1.0, -var13 * 1.0, -var14 * 1.0);
    ...
    private void frameInit() {
        ...
        if (world != null && Config.getNewRelease() != null) {
            final String userEdition = "HD_U".replace("HD_U", "HD Ultra").replace("L", "Light");
            final String fullNewVer = String.valueOf(userEdition) + " " + Config.getNewRelease();
            final ChatComponentText msg = new ChatComponentText("A new §eOptiFine§f version is available: §e" + fullNewVer + "§f");
