...
public class VertexFormat
{
    ...
    public VertexFormat(final VertexFormat p_i46097_1_) {
        ...
        for (int var2 = 0; var2 < p_i46097_1_.func_177345_h(); ++var2) {
            this.setElement(p_i46097_1_.func_177348_c(var2));
        }
    ...
    public void setElement(final VertexFormatElement p_177349_1_) {
    ...
    public boolean hasElementOffset(final int p_177347_1_) {
    ...
    public String toString() {
        ...
        for (int var2 = 0; var2 < this.field_177355_b.size(); ++var2) {
            var1 = String.valueOf(var1) + this.field_177355_b.get(var2).toString();
    ...
    private boolean func_177341_i() {
        for (final VertexFormatElement var2 : this.field_177355_b) {
    ...
    public boolean equals(final Object p_equals_1_) {
        ...
        if (p_equals_1_ != null && this.getClass() == p_equals_1_.getClass()) {
            ...
            return this.field_177353_d == var2.field_177353_d && this.field_177355_b.equals(var2.field_177355_b) && this.field_177356_c.equals(var2.field_177356_c);
        }
        return false;
    }
