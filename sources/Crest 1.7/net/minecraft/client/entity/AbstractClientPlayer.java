...
import me.chrest.client.module.modules.render.NoFov;
...
public abstract class AbstractClientPlayer extends EntityPlayer
{
    ...
    public float func_175156_o() {
        ...
        final NoFov mod = (NoFov)new NoFov().getInstance();
        if (mod.isEnabled()) {
    ...
    public void setSprinting(boolean sprinting) {
        ...
        final IAttributeInstance var2 = this.getEntityAttribute(SharedMonsterAttributes.movementSpeed);
        if (var2.getModifier(AbstractClientPlayer.sprintingSpeedBoostModifierUUID) != null) {
            var2.removeModifier(AbstractClientPlayer.sprintingSpeedBoostModifier);
        }
        if (sprinting) {
            var2.applyModifier(AbstractClientPlayer.sprintingSpeedBoostModifier);
        }
    }
    
    static /* synthetic */ void access$1(final AbstractClientPlayer abstractClientPlayer, final ResourceLocation ofLocationCape) {
