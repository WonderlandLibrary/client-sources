...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public boolean isEntityInsideOpaqueBlock() {
        ...
        return !insideBlockRenderEvent.isCancelled() && super.isEntityInsideOpaqueBlock();
    }
    ...
    public void onUpdateWalkingPlayer() {
        final UpdateEvent eventPre = new UpdateEvent(this.posY, this.rotationYaw, this.rotationPitch, this.onGround);
        eventPre.call();
        if (eventPre.isCancelled()) {
            final UpdateEvent eventPost = new UpdateEvent();
            eventPost.call();
            return;
        }
        ...
        if (this.func_175160_A()) {
            final double var3 = this.posX - this.lastReportedPosX;
            final double var4 = eventPre.getY() - this.lastReportedPosY;
            final double var5 = this.posZ - this.lastReportedPosZ;
            final double var6 = eventPre.getYaw() - this.lastReportedYaw;
            final double var7 = eventPre.getPitch() - this.lastReportedPitch;
            boolean var8 = var3 * var3 + var4 * var4 + var5 * var5 > 9.0E-4 || this.positionUpdateTicks >= 20;
            final boolean var9 = var6 != 0.0 || var7 != 0.0;
            if (this.ridingEntity == null) {
                if ((var8 && var9) || eventPre.shouldAlwaysSend()) {
    ...
    protected boolean pushOutOfBlocks(final double x, final double y, final double z) {
        final PushOutOfBlocksEvent pushOutOfBlockEvent = new PushOutOfBlocksEvent();
    ...
    public void onLivingUpdate() {
        ...
        final ItemSlowEvent event = new ItemSlowEvent();
        event.call();
