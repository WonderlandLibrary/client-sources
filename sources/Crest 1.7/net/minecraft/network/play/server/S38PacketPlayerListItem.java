...
public class S38PacketPlayerListItem implements Packet
{
    ...
    public enum Action
    {
        ...
        private Action(final String s, final int n, final String p_i45966_1_, final int p_i45966_2_) {
        }
    }
    ...
    public class AddPlayerData
    {
        ...
        public GameProfile getField_179964_d() {
