...
public class GuiPerformanceSettingsOF extends GuiScreen
{
    ...
    public void initGui() {
        ...
        for (final GameSettings.Options enumoptions : GuiPerformanceSettingsOF.enumOptions) {
            ...
            final int y = GuiPerformanceSettingsOF.height / 6 + 21 * (i / 2) - 10;
        ...
        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, GuiPerformanceSettingsOF.height / 6 + 168 + 11, I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(final int x, final int y, final float f) {
        ...
        if (Math.abs(x - this.lastMouseX) <= 5 && Math.abs(y - this.lastMouseY) <= 5) {
            ...
            if (System.currentTimeMillis() >= this.mouseStillTime + activateDelay) {
                ...
                int y2 = GuiPerformanceSettingsOF.height / 6 - 5;
                if (y <= y2 + 98) {
                    y2 += 105;
                }
