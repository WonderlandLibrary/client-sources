...
public class GuiOtherSettingsOF extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui() {
        ...
        for (final GameSettings.Options enumoptions : GuiOtherSettingsOF.enumOptions) {
            ...
            final int y = GuiOtherSettingsOF.height / 6 + 21 * (i / 2) - 10;
        ...
        this.buttonList.add(new GuiButton(210, this.width / 2 - 100, GuiOtherSettingsOF.height / 6 + 168 + 11 - 44, "Reset Video Settings..."));
        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, GuiOtherSettingsOF.height / 6 + 168 + 11, I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(final int x, final int y, final float f) {
        ...
        if (Math.abs(x - this.lastMouseX) <= 5 && Math.abs(y - this.lastMouseY) <= 5) {
            ...
            if (System.currentTimeMillis() >= this.mouseStillTime + activateDelay) {
                ...
                int y2 = GuiOtherSettingsOF.height / 6 - 5;
                if (y <= y2 + 98) {
                    y2 += 105;
                }
                ...
                if (btn != null) {
                    ...
                    for (int i = 0; i < lines.length; ++i) {
                        ...
                        this.fontRendererObj.func_175063_a(line, x2 + 5, y2 + 5 + i * 11, 14540253);
                    }
                }
            }
        }
