...
public class GuiAnimationSettingsOF extends GuiScreen
{
    ...
    public void initGui() {
        ...
        for (final GameSettings.Options enumoptions : GuiAnimationSettingsOF.enumOptions) {
            ...
            final int y = GuiAnimationSettingsOF.height / 6 + 21 * (i / 2) - 10;
        ...
        this.buttonList.add(new GuiButton(210, this.width / 2 - 155, GuiAnimationSettingsOF.height / 6 + 168 + 11, 70, 20, "All ON"));
        this.buttonList.add(new GuiButton(211, this.width / 2 - 155 + 80, GuiAnimationSettingsOF.height / 6 + 168 + 11, 70, 20, "All OFF"));
        this.buttonList.add(new GuiOptionButton(200, this.width / 2 + 5, GuiAnimationSettingsOF.height / 6 + 168 + 11, I18n.format("gui.done", new Object[0])));
    }
