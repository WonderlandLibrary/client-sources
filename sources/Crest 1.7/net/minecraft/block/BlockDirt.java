...
public class BlockDirt extends Block
{
    ...
    public enum DirtType implements IStringSerializable
    {
        ...
        private DirtType(final String s, final int n, final String p_i45728_1_, final int p_i45728_2_, final int metadata, final String name, final String unlocalizedName) {
