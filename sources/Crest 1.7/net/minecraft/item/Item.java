...
public class Item
{
    ...
    public enum ToolMaterial
    {
        ...
        private ToolMaterial(final String s, final int n, final String p_i1874_1_, final int p_i1874_2_, final int harvestLevel, final int maxUses, final float efficiency, final float damageVsEntity, final int enchantability) {
