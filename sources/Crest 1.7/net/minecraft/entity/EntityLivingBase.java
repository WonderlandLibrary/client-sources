...
{
    public static final UUID sprintingSpeedBoostModifierUUID;
    ...
    public boolean checkTimer(final float time) {
        if (this.auraTimer.delay(time)) {
