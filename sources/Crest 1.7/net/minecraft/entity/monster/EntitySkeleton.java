...
public class EntitySkeleton extends EntityMob implements IRangedAttackMob
{
    ...
    public void onLivingUpdate() {
        if (this.worldObj.isDaytime() && !this.worldObj.isRemote) {
            ...
            final BlockPos var2 = new BlockPos(this.posX, Math.round(this.posY), this.posZ);
    ...
    public void attackEntityWithRangedAttack(final EntityLivingBase p_82196_1_, final float p_82196_2_) {
        final EntityArrow var3 = new EntityArrow(this.worldObj, this, p_82196_1_, 1.6f, 14 - this.worldObj.getDifficulty().getDifficultyId() * 4);
