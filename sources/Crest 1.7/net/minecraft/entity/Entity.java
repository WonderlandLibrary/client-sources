...
import me.chrest.client.module.modules.movement.Step;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            for (final AxisAlignedBB var23 : var15) {
                z = var23.calculateZOffset(this.getEntityBoundingBox(), z);
            }
            this.func_174826_a(this.getEntityBoundingBox().offset(0.0, 0.0, z));
            if (this.stepHeight > 0.0f && var19 && (var10 != x || var12 != z)) {
                final StepEvent stepEvent = new StepEvent(this.stepHeight, Event.State.PRE);
                if (this == ClientUtils.player()) {
                    stepEvent.call();
                }
                final double var24 = x;
                final double var25 = y;
                final double var26 = z;
                final AxisAlignedBB var27 = this.getEntityBoundingBox();
                this.func_174826_a(var16);
                y = this.stepHeight;
                final List var28 = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().addCoord(var10, y, var12));
                AxisAlignedBB var29 = this.getEntityBoundingBox();
                final AxisAlignedBB var30 = var29.addCoord(var10, 0.0, var12);
                double var31 = y;
                for (final AxisAlignedBB var33 : var28) {
                    var31 = var33.calculateYOffset(var30, var31);
                }
                var29 = var29.offset(0.0, var31, 0.0);
                double var34 = var10;
                for (final AxisAlignedBB var36 : var28) {
                    var34 = var36.calculateXOffset(var29, var34);
                }
                var29 = var29.offset(var34, 0.0, 0.0);
                double var37 = var12;
                for (final AxisAlignedBB var39 : var28) {
                    var37 = var39.calculateZOffset(var29, var37);
                }
                var29 = var29.offset(0.0, 0.0, var37);
                AxisAlignedBB var40 = this.getEntityBoundingBox();
                double var41 = y;
                for (final AxisAlignedBB var43 : var28) {
                    var41 = var43.calculateYOffset(var40, var41);
                }
                var40 = var40.offset(0.0, var41, 0.0);
                double var44 = var10;
                for (final AxisAlignedBB var46 : var28) {
                    var44 = var46.calculateXOffset(var40, var44);
                }
                var40 = var40.offset(var44, 0.0, 0.0);
                double var47 = var12;
                for (final AxisAlignedBB var49 : var28) {
                    var47 = var49.calculateZOffset(var40, var47);
                }
                var40 = var40.offset(0.0, 0.0, var47);
                final double var50 = var34 * var34 + var37 * var37;
                final double var51 = var44 * var44 + var47 * var47;
                if (var50 > var51) {
                    x = var34;
                    z = var37;
                    ...
                    x = var44;
                    z = var47;
                    this.func_174826_a(var40);
                }
                y = -this.stepHeight;
                for (final AxisAlignedBB var53 : var28) {
                    y = var53.calculateYOffset(this.getEntityBoundingBox(), y);
                }
                this.func_174826_a(this.getEntityBoundingBox().offset(0.0, y, 0.0));
                if (var24 * var24 + var26 * var26 >= x * x + z * z) {
                    x = var24;
                    y = var25;
                    z = var26;
                    this.func_174826_a(var27);
                    if (stepEvent.isActive() && stepEvent.getStepHeight() > 0.0 && var19 && (var10 != x || var12 != z)) {
                        final double var54 = x;
                        final double var55 = y;
                        final double var56 = z;
                        final AxisAlignedBB var57 = this.getEntityBoundingBox();
                        this.func_174826_a(var16);
                        y = stepEvent.getStepHeight();
                        final List var58 = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().addCoord(var10, y, var12));
                        AxisAlignedBB var59 = this.getEntityBoundingBox();
                        final AxisAlignedBB var60 = var59.addCoord(var10, 0.0, var12);
                        double var61 = y;
                        for (final AxisAlignedBB var63 : var58) {
                            var61 = var63.calculateYOffset(var60, var61);
                        }
                        var59 = var59.offset(0.0, var61, 0.0);
                        double var64 = var10;
                        for (final AxisAlignedBB var66 : var58) {
                            var64 = var66.calculateXOffset(var59, var64);
                        }
                        var59 = var59.offset(var64, 0.0, 0.0);
                        double var67 = var12;
                        for (final AxisAlignedBB var69 : var58) {
                            var67 = var69.calculateZOffset(var59, var67);
                        }
                        var59 = var59.offset(0.0, 0.0, var67);
                        AxisAlignedBB var70 = this.getEntityBoundingBox();
                        double var71 = y;
                        for (final AxisAlignedBB var73 : var58) {
                            var71 = var73.calculateYOffset(var70, var71);
                        }
                        var70 = var70.offset(0.0, var71, 0.0);
                        double var74 = var10;
                        for (final AxisAlignedBB var76 : var58) {
                            var74 = var76.calculateXOffset(var70, var74);
                        }
                        var70 = var70.offset(var74, 0.0, 0.0);
                        double var77 = var12;
                        for (final AxisAlignedBB var79 : var58) {
                            var77 = var79.calculateZOffset(var70, var77);
                        }
                        var70 = var70.offset(0.0, 0.0, var77);
                        final double var80 = var64 * var64 + var67 * var67;
                        final double var81 = var74 * var74 + var77 * var77;
                        if (var80 > var81) {
                            x = var64;
                            z = var67;
                            this.func_174826_a(var59);
                        }
                        else {
                            x = var74;
                            z = var77;
                            this.func_174826_a(var70);
                        }
                        y = -stepEvent.getStepHeight();
                        for (final AxisAlignedBB var83 : var58) {
                            y = var83.calculateYOffset(this.getEntityBoundingBox(), y);
                        }
                        this.func_174826_a(this.getEntityBoundingBox().offset(0.0, y + (((Step)new Step().getInstance()).packet ? 0.0 : 0.063), 0.0));
                        if (var54 * var54 + var56 * var56 >= x * x + z * z) {
                            x = var54;
                            y = var55;
                            z = var56;
                            this.func_174826_a(var57);
                        }
                        else {
            ...
            final int var84 = MathHelper.floor_double(this.posX);
            final int var85 = MathHelper.floor_double(this.posY - 0.20000000298023224);
            final int var86 = MathHelper.floor_double(this.posZ);
            BlockPos var87 = new BlockPos(var84, var85, var86);
            Block var88 = this.worldObj.getBlockState(var87).getBlock();
            if (var88.getMaterial() == Material.air) {
                final Block var89 = this.worldObj.getBlockState(var87.offsetDown()).getBlock();
                if (var89 instanceof BlockFence || var89 instanceof BlockWall || var89 instanceof BlockFenceGate) {
                    var88 = var89;
                    var87 = var87.offsetDown();
                }
            }
            this.func_180433_a(y, this.onGround, var88, var87);
            if (var10 != x) {
                this.motionX = 0.0;
            }
            if (var12 != z) {
            ...
            if (var11 != y) {
                var88.onLanded(this.worldObj, this);
            }
            if (this.canTriggerWalking() && !var13 && this.ridingEntity == null) {
                final double var90 = this.posX - var7;
                double var91 = this.posY - var8;
                final double var92 = this.posZ - var9;
                if (var88 != Blocks.ladder) {
                    var91 = 0.0;
                }
                if (var88 != null && this.onGround) {
                    var88.onEntityCollidedWithBlock(this.worldObj, var87, this);
                }
                this.distanceWalkedModified += (float)(MathHelper.sqrt_double(var90 * var90 + var92 * var92) * 0.6);
                this.distanceWalkedOnStepModified += (float)(MathHelper.sqrt_double(var90 * var90 + var91 * var91 + var92 * var92) * 0.6);
                if (this.distanceWalkedOnStepModified > this.nextStepDistance && var88.getMaterial() != Material.air) {
                    this.nextStepDistance = (int)this.distanceWalkedOnStepModified + 1;
                    if (this.isInWater()) {
                        float var93 = MathHelper.sqrt_double(this.motionX * this.motionX * 0.20000000298023224 + this.motionY * this.motionY + this.motionZ * this.motionZ * 0.20000000298023224) * 0.35f;
                        if (var93 > 1.0f) {
                            var93 = 1.0f;
                        }
                        this.playSound(this.getSwimSound(), var93, 1.0f + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.4f);
                    }
                    this.func_180429_a(var87, var88);
                }
            }
            try {
                ...
                final CrashReport var94 = CrashReport.makeCrashReport(var95, "Checking entity block collision");
                final CrashReportCategory var96 = var94.makeCategory("Entity being checked for collision");
                this.addEntityCrashInfo(var96);
                throw new ReportedException(var94);
            }
            final boolean var97 = this.isWet();
    ...
    protected NBTTagList newDoubleNBTList(final double... numbers) {
        ...
        for (final double var5 : numbers) {
            var2.appendTag(new NBTTagDouble(var5));
        }
        return var2;
    }
    ...
    protected NBTTagList newFloatNBTList(final float... numbers) {
        ...
        for (final float var5 : numbers) {
            var2.appendTag(new NBTTagFloat(var5));
        }
        return var2;
    }
