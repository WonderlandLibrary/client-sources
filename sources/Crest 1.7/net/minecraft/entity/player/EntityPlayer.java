...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void jump() {
        if (this == ClientUtils.player()) {
            final JumpEvent event = new JumpEvent();
            event.call();
    ...
    public enum EnumChatVisibility
    {
        ...
        private EnumChatVisibility(final String s, final int n, final String p_i45323_1_, final int p_i45323_2_, final int p_i45323_3_, final String p_i45323_4_) {
    ...
    public enum EnumStatus
    {
        ...
        private EnumStatus(final String s, final int n, final String p_i1751_1_, final int p_i1751_2_) {
        }
    }
