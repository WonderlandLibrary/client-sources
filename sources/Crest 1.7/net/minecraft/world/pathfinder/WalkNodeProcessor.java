...
public class WalkNodeProcessor extends NodeProcessor
{
    ...
    public PathPoint func_176161_a(final Entity p_176161_1_) {
        ...
        if (this.field_176184_i && p_176161_1_.isInWater()) {
            ...
            var2 = MathHelper.floor_double(p_176161_1_.getEntityBoundingBox().minY + 0.5);
        }
    ...
    public PathPoint func_176160_a(final Entity p_176160_1_, final double p_176160_2_, final double p_176160_4_, final double p_176160_6_) {
        return this.func_176159_a(MathHelper.floor_double(p_176160_2_ - p_176160_1_.width / 2.0f), MathHelper.floor_double(p_176160_4_), MathHelper.floor_double(p_176160_6_ - p_176160_1_.width / 2.0f));
    }
    ...
    public int func_176164_a(final PathPoint[] p_176164_1_, final Entity p_176164_2_, final PathPoint p_176164_3_, final PathPoint p_176164_4_, final float p_176164_5_) {
        ...
        final PathPoint var8 = this.func_176171_a(p_176164_2_, p_176164_3_.xCoord, p_176164_3_.yCoord, p_176164_3_.zCoord + 1, var7);
        final PathPoint var9 = this.func_176171_a(p_176164_2_, p_176164_3_.xCoord - 1, p_176164_3_.yCoord, p_176164_3_.zCoord, var7);
        final PathPoint var10 = this.func_176171_a(p_176164_2_, p_176164_3_.xCoord + 1, p_176164_3_.yCoord, p_176164_3_.zCoord, var7);
        final PathPoint var11 = this.func_176171_a(p_176164_2_, p_176164_3_.xCoord, p_176164_3_.yCoord, p_176164_3_.zCoord - 1, var7);
    ...
    private PathPoint func_176171_a(final Entity p_176171_1_, final int p_176171_2_, int p_176171_3_, final int p_176171_4_, final int p_176171_5_) {
        PathPoint var6 = null;
        final int var7 = this.func_176177_a(p_176171_1_, p_176171_2_, p_176171_3_, p_176171_4_);
        if (var7 == 2) {
    ...
    private int func_176177_a(final Entity p_176177_1_, final int p_176177_2_, final int p_176177_3_, final int p_176177_4_) {
    ...
    public static int func_176170_a(final IBlockAccess p_176170_0_, final Entity p_176170_1_, final int p_176170_2_, final int p_176170_3_, final int p_176170_4_, final int p_176170_5_, final int p_176170_6_, final int p_176170_7_, final boolean p_176170_8_, final boolean p_176170_9_, final boolean p_176170_10_) {
        boolean var11 = false;
