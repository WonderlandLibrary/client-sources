...
public abstract class World implements IBlockAccess
{
    ...
    public MovingObjectPosition rayTraceBlocks(Vec3 p_147447_1_, final Vec3 p_147447_2_, final boolean p_147447_3_, final boolean p_147447_4_, final boolean p_147447_5_) {
        ...
        if (!Double.isNaN(p_147447_2_.xCoord) && !Double.isNaN(p_147447_2_.yCoord) && !Double.isNaN(p_147447_2_.zCoord)) {
            ...
            if ((!p_147447_4_ || var14.getCollisionBoundingBox(this, var12, var13) != null) && var14.canCollideCheck(var13, p_147447_3_)) {
                final MovingObjectPosition var15 = var14.collisionRayTrace(this, var12, p_147447_1_, p_147447_2_);
                if (var15 != null) {
                    return var15;
                }
            }
            ...
            while (var17-- >= 0) {
                ...
                double var25 = 999.0;
                double var26 = 999.0;
                final double var27 = p_147447_2_.xCoord - p_147447_1_.xCoord;
                final double var28 = p_147447_2_.yCoord - p_147447_1_.yCoord;
                final double var29 = p_147447_2_.zCoord - p_147447_1_.zCoord;
                if (var18) {
                    var24 = (var21 - p_147447_1_.xCoord) / var27;
                }
                if (var19) {
                    var25 = (var22 - p_147447_1_.yCoord) / var28;
                }
                if (var20) {
                    var26 = (var23 - p_147447_1_.zCoord) / var29;
                }
                if (var24 == -0.0) {
                    var24 = -1.0E-4;
                }
                ...
                if (var24 < var25 && var24 < var26) {
                    ...
                    p_147447_1_ = new Vec3(var21, p_147447_1_.yCoord + var28 * var24, p_147447_1_.zCoord + var29 * var24);
                }
                else if (var25 < var26) {
                    var30 = ((var7 > var10) ? EnumFacing.DOWN : EnumFacing.UP);
                    p_147447_1_ = new Vec3(p_147447_1_.xCoord + var27 * var25, var22, p_147447_1_.zCoord + var29 * var25);
                }
                else {
                    var30 = ((var8 > var11) ? EnumFacing.NORTH : EnumFacing.SOUTH);
                    p_147447_1_ = new Vec3(p_147447_1_.xCoord + var27 * var26, p_147447_1_.yCoord + var28 * var26, var23);
                }
                var9 = MathHelper.floor_double(p_147447_1_.xCoord) - ((var30 == EnumFacing.EAST) ? 1 : 0);
                var10 = MathHelper.floor_double(p_147447_1_.yCoord) - ((var30 == EnumFacing.UP) ? 1 : 0);
                var11 = MathHelper.floor_double(p_147447_1_.zCoord) - ((var30 == EnumFacing.SOUTH) ? 1 : 0);
                var12 = new BlockPos(var9, var10, var11);
                final IBlockState var31 = this.getBlockState(var12);
                final Block var32 = var31.getBlock();
                if (p_147447_4_ && var32.getCollisionBoundingBox(this, var12, var31) == null) {
                    continue;
                }
                if (var32.canCollideCheck(var31, p_147447_3_)) {
                    final MovingObjectPosition var33 = var32.collisionRayTrace(this, var12, p_147447_1_, p_147447_2_);
                    if (var33 != null) {
                        return var33;
                    }
                    continue;
                    ...
                    var16 = new MovingObjectPosition(MovingObjectPosition.MovingObjectType.MISS, p_147447_1_, var30, var12);
                }
            }
            return p_147447_5_ ? var16 : null;
        }
    ...
    public List getCollidingBlockBoundingBoxes(final Entity p_72945_1_, final AxisAlignedBB p_72945_2_) {
        final ArrayList var3 = Lists.newArrayList();
        final int var4 = MathHelper.floor_double(p_72945_2_.minX);
        final int var5 = MathHelper.floor_double(p_72945_2_.maxX + 1.0);
        final int var6 = MathHelper.floor_double(p_72945_2_.minY);
