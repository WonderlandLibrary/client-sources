...
public class Rainbow
{
    ...
    static {
        Rainbow.colors = new HashMap<String, ChatColor>();
    }
    ...
    public static String getHexName(final Color color) {
        ...
        return String.valueOf((rHex.length() == 2) ? rHex : new StringBuilder("0").append(rHex).toString()) + ((gHex.length() == 2) ? gHex : ("0" + gHex)) + ((bHex.length() == 2) ? bHex : ("0" + bHex));
    }
