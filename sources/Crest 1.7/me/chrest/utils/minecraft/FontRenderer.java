...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    public FontRenderer(final GameSettings p_i1035_1_, final ResourceLocation p_i1035_2_, final TextureManager p_i1035_3_, final boolean p_i1035_4_) {
        FontRenderer.charWidth = new float[256];
        this.FONT_HEIGHT = 9;
        ...
        FontRenderer.locationFontTexture = p_i1035_2_;
        this.renderEngine = p_i1035_3_;
        this.unicodeFlag = p_i1035_4_;
        p_i1035_3_.bindTexture(FontRenderer.locationFontTexture);
    ...
    public void onResourceManagerReload(final IResourceManager resourceManager) {
        FontRenderer.locationFontTexture = getHdFontLocation(this.locationFontTextureBase);
    ...
    private void readFontTexture() {
        ...
        try {
            bufferedimage = TextureUtil.func_177053_a(ClientUtils.mc().getResourceManager().getResource(FontRenderer.locationFontTexture).getInputStream());
        }
        ...
        for (int k = 0; k < 256; ++k) {
            ...
            FontRenderer.charWidth[k] = (var19 + 1) / kx + 1.0f;
        }
    ...
    private float renderCharAtPos(final int p_78278_1_, final char p_78278_2_, final boolean p_78278_3_) {
        return (p_78278_2_ == ' ') ? FontRenderer.charWidth[p_78278_2_] : ((p_78278_2_ == ' ') ? 4.0f : (("\u00c0\u00c1\u00c2\u00c8\u00ca\u00cb\u00cd\u00d3\u00d4\u00d5\u00da\u00df\u00e3\u00f5\u011f\u0130\u0131\u0152\u0153\u015e\u015f\u0174\u0175\u017e\u0207\u0000\u0000\u0000\u0000\u0000\u0000\u0000 !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u0000\u00c7\u00fc\u00e9\u00e2\u00e4\u00e0\u00e5\u00e7\u00ea\u00eb\u00e8\u00ef\u00ee\u00ec\u00c4\u00c5\u00c9\u00e6\u00c6\u00f4\u00f6\u00f2\u00fb\u00f9\u00ff\u00d6\u00dc\u00f8£\u00d8\u00d7\u0192\u00e1\u00ed\u00f3\u00fa\u00f1\u00d1ªº¿®¬½¼¡«»\u2591\u2592\u2593\u2502\u2524\u2561\u2562\u2556\u2555\u2563\u2551\u2557\u255d\u255c\u255b\u2510\u2514\u2534\u252c\u251c\u2500\u253c\u255e\u255f\u255a\u2554\u2569\u2566\u2560\u2550\u256c\u2567\u2568\u2564\u2565\u2559\u2558\u2552\u2553\u256b\u256a\u2518\u250c\u2588\u2584\u258c\u2590\u2580\u03b1\u03b2\u0393\u03c0\u03a3\u03c3\u03bc\u03c4\u03a6\u0398\u03a9\u03b4\u221e\u2205\u2208\u2229\u2261±\u2265\u2264\u2320\u2321\u00f7\u2248°\u2219·\u221a\u207f²\u25a0\u0000".indexOf(p_78278_2_) != -1 && !this.unicodeFlag) ? this.renderDefaultChar(p_78278_1_, p_78278_3_) : this.renderUnicodeChar(p_78278_2_, p_78278_3_)));
    }
    ...
    private float renderDefaultChar(final int p_78266_1_, final boolean p_78266_2_) {
        ...
        this.renderEngine.bindTexture(FontRenderer.locationFontTexture);
        ...
        GL11.glVertex3d(this.posX + 7.989999771118164 - 1.0 + var5, this.posY, 0.0);
        GL11.glTexCoord2f((var3 + 7.99f - 1.0f) / 128.0f, (var4 + 7.99f) / 128.0f);
        GL11.glVertex3d(this.posX + 7.989999771118164 - 1.0 - var5, this.posY + 7.989999771118164, 0.0);
        GL11.glEnd();
        return FontRenderer.charWidth[p_78266_1_];
    }
        ...
        for (int var3 = 0; var3 < p_78255_1_.length(); ++var3) {
            ...
            if (var4 == '§' && var3 + 1 < p_78255_1_.length()) {
                ...
                if (this.randomStyle && var5 != -1) {
                    int var6;
                    do {
                        var6 = this.fontRandom.nextInt(FontRenderer.charWidth.length);
                    } while ((int)FontRenderer.charWidth[var5] != (int)FontRenderer.charWidth[var6]);
                    var5 = var6;
                }
    ...
    private float getCharWidthFloat(final char p_78263_1_) {
        ...
        if (p_78263_1_ == ' ') {
            return FontRenderer.charWidth[32];
        }
        ...
        if (p_78263_1_ > '\0' && var2 != -1 && !this.unicodeFlag) {
            return FontRenderer.charWidth[var2];
        }
    ...
    protected String wrapFormattedStringToWidth(final String str, final int wrapWidth) {
        ...
        final String var7 = String.valueOf(String.valueOf(getFormatFromString(var4))) + str.substring(var3 + (var6 ? 1 : 0));
    ...
    private static void readCustomCharWidths() {
        final String fontFileName = FontRenderer.locationFontTexture.getResourcePath();
        ...
        if (fontFileName.endsWith(suffix)) {
            ...
            try {
                final ResourceLocation e = new ResourceLocation(FontRenderer.locationFontTexture.getResourceDomain(), fileName);
    ...
    private static ResourceLocation getHdFontLocation(final ResourceLocation fontLoc) {
        ...
        final String mcpatcherStr = "packet/";
        if (!fontName.startsWith("textures/")) {
            return fontLoc;
        }
        fontName = fontName.substring("textures/".length());
        fontName = String.valueOf(String.valueOf("packet/")) + fontName;
