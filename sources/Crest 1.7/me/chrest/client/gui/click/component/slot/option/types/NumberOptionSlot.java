...
public class NumberOptionSlot extends OptionSlotComponent<NumberOption>
{
    ...
    public void draw(final int mouseX, final int mouseY) {
        ...
        RenderUtils.rectangleBordered(this.getX(), this.getY(), this.getX() + this.getWidth(), this.getY() + this.getHeight(), 0.5, RenderUtils.blend(useDarkTheme ? -14540254 : -40865, -16777216, 0.6f), -15658735);
