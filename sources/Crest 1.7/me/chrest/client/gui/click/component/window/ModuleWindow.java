...
import me.chrest.client.gui.click.component.slot.ModuleSlotComponent;
...
public class ModuleWindow extends Window<Module.Category>
{
    ...
    public ModuleWindow(final Module.Category category, final double x, final double y, double width) {
        ...
        ((Component<ModuleWindow>)this.getHandle()).setParent(this);
    }
    ...
    public void draw(final int mouseX, final int mouseY) {
        ...
        if (this.isExtended()) {
            ...
            final int[] outlineGradient = { -1710619, -1710619, -1710619, -1710619, -1710619 };
