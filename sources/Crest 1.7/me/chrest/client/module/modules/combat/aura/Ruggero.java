...
public class Ruggero extends AuraMode
{
    private boolean setupTick;
    private EntityLivingBase target;
    private Timer timer;
    
    public Ruggero(final String name, final boolean value, final Module module) {
                    ...
                    if (this.target != null) {
                        ...
                        if (this.setupTick) {
                            ...
                            if (auraModule.criticals && ClientUtils.player().isCollidedVertically && this.bhopCheck()) {
                                ...
                                ClientUtils.player().func_180799_ab();
                            }
                            if (this.timer.delay(300.0f) && ClientUtils.player().fallDistance > 0.0f && ClientUtils.player().fallDistance < 0.66) {
