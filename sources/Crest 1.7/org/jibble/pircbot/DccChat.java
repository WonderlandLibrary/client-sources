...
public class DccChat
{
    ...
    DccChat(final PircBot bot, final String nick, final String login, final String hostname, final long address, final int port) {
        this._login = null;
        this._hostname = null;
        this._address = 0L;
        this._port = 0;
    ...
    public synchronized void accept() throws IOException {
        if (this._acceptable) {
            this._acceptable = false;
            final int[] longToIp = this._bot.longToIp(this._address);
