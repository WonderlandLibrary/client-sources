                ...
                if (inputsFilter == null || inputsFilter.apply((Object)path) || inputsFilter.apply((Object)fqn)) {
                    ...
                    for (final Scanner scanner : this.configuration.getScanners()) {
                        try {
                            ...
                            Reflections.log.debug("could not scan file " + file.getRelativePath() + " in url " + url.toExternalForm() + " with scanner " + scanner.getClass().getSimpleName(), (Object)e.getMessage());
                        }
                    }
                }
            }
