...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags, bool border)
{
    ...
    if (border)
        RenderFrame(bb.Min - ImVec2(1, 1), bb.Max + ImVec2(1, 1), ImColor(15, 15, 15), true, style.FrameRounding);
...
bool ImGui::Button(const char* label, const ImVec2& size_arg, bool border)
{
    return ButtonEx(label, size_arg, ImGuiButtonFlags_None, border);
}
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    RenderFrame(check_bb.Min - ImVec2(1, 1), check_bb.Max + ImVec2(1, 1), ImColor(15, 15, 15), true, style.FrameRounding);
    ...
    if (label_size.x > 0.0f)
        RenderText(label_pos + ImVec2(0, 1), label);
