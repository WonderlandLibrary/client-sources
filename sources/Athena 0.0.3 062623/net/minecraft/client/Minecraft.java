...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public final IMetadataSerializer metadataSerializer_;
    ...
    private void drawSplashScreen(final TextureManager textureManagerInstance) throws LWJGLException {
        ...
        final int l = 256;
        final int m = 256;
        this.func_181536_a((scaledresolution.getScaledWidth() - l) / 2, (scaledresolution.getScaledHeight() - m) / 2, 0, 0, l, m, 255, 255, 255, 255);
        GlStateManager.disableLighting();
        GlStateManager.disableFog();
        framebuffer.unbindFramebuffer();
        framebuffer.framebufferRender(scaledresolution.getScaledWidth() * i, scaledresolution.getScaledHeight() * i);
    ...
    public void updateDisplay() {
        if (Athena.INSTANCE.getModuleManager().get(MotionBlur.class).isToggled() && getMinecraft().thePlayer != null) {
    ...
    public void runTick() throws IOException {
        if (getMinecraft().thePlayer != null && getMinecraft().theWorld != null && !Athena.INSTANCE.getEventBus().post(new ClientTickEvent())) {
            return;
        }
    ...
    public void dispatchKeypresses() {
        ...
        if (i != 0 && !Keyboard.isRepeatEvent() && (!(this.currentScreen instanceof GuiControls) || ((GuiControls)this.currentScreen).time <= getSystemTime() - 20L)) {
            ...
            if (!Athena.INSTANCE.getEventBus().post(event)) {
                return;
            }
            if (Keyboard.getEventKeyState()) {
                if (i == this.gameSettings.keyBindStreamStartStop.getKeyCode()) {
                    ...
                    else if (this.getTwitchStream().func_152928_D() && this.getTwitchStream().func_152936_l() && this.theWorld != null) {
