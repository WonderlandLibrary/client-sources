...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(final float partialTicks) {
        ...
        if (!Athena.INSTANCE.getEventBus().post(new RenderEvent(RenderType.INGAME_OVERLAY, partialTicks))) {
            return;
        }
        ...
        if (scoreobjective2 != null && Athena.INSTANCE.getEventBus().post(new RenderEvent(RenderType.SCOREBOARD))) {
