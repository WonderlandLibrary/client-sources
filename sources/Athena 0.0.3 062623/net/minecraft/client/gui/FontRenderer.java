...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    private void renderStringAtPos(String p_78255_1_, final boolean p_78255_2_) {
        final NickHider mod = (NickHider)Athena.INSTANCE.getModuleManager().get(NickHider.class);
        if (Athena.INSTANCE.getModuleManager().get(NickHider.class).isToggled() && Minecraft.getMinecraft().thePlayer != null && p_78255_1_.contains(Minecraft.getMinecraft().thePlayer.getName())) {
    ...
    public int getStringWidth(String text) {
        final NickHider mod = (NickHider)Athena.INSTANCE.getModuleManager().get(NickHider.class);
        if (Athena.INSTANCE.getModuleManager().get(NickHider.class).isToggled() && Minecraft.getMinecraft().thePlayer != null && text.contains(Minecraft.getMinecraft().thePlayer.getName())) {
