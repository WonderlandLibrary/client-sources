...
public class GuiStreamOptions extends GuiScreen
{
    ...
    public void initGui() {
        int i = 0;
        for (final GameSettings.Options gamesettings$options : GuiStreamOptions.field_152312_a) {
        ...
        i += 2;
        for (final GameSettings.Options gamesettings$options2 : GuiStreamOptions.field_152316_f) {
