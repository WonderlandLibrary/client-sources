...
public class GuiSlider extends GuiButton
{
    ...
    protected void mouseDragged(final Minecraft mc, final int mouseX, final int mouseY) {
        if (this.visible) {
            ...
            Gui.drawRect(this.xPosition + (int)(this.sliderPosition * (this.width - 8)), this.yPosition, this.xPosition + (int)(this.sliderPosition * (this.width - 8)) + 4, this.yPosition + 20, new Color(250, 250, 250).getRGB());
        }
    }
