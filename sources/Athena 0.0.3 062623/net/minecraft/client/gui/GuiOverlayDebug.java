...
public class GuiOverlayDebug extends Gui
{
    ...
    protected List getDebugInfoRight() {
        ...
        final long l = j - k;
        final ArrayList arraylist = Lists.newArrayList((Object[])new String[] { String.format("Java: %s %dbit", System.getProperty("java.version"), this.mc.isJava64bit() ? 64 : 32), String.format("Mem: % 2d%% %03d/%03dMB", l * 100L / i, bytesToMb(l), bytesToMb(i)), String.format("Allocated: % 2d%% %03dMB", j * 100L / i, bytesToMb(j)), "", String.format("CPU: %s", OpenGlHelper.func_183029_j()), "", String.format("Display: %dx%d (%s)", Display.getWidth(), Display.getHeight(), GL11.glGetString(7936)), GL11.glGetString(7937), GL11.glGetString(7938) });
    ...
    private void func_181554_e() {
        ...
        Gui.drawHorizontalLine(0, 239, scaledresolution.getScaledHeight() - 30, -1);
        ...
        Gui.drawHorizontalLine(0, 239, scaledresolution.getScaledHeight() - 60, -1);
        Gui.drawHorizontalLine(0, 239, scaledresolution.getScaledHeight() - 1, -1);
        ...
        if (this.mc.gameSettings.limitFramerate <= 120) {
            Gui.drawHorizontalLine(0, 239, scaledresolution.getScaledHeight() - 60 + this.mc.gameSettings.limitFramerate / 2, -16711681);
        }
