...
public class GameSettings
{
    ...
    public String getKeyBinding(final Options p_74297_1_) {
        ...
        final String s2 = I18n.format(p_74297_1_.getEnumString(), new Object[0]) + ": ";
        if (p_74297_1_.getEnumFloat()) {
            final float f1 = this.getOptionFloatValue(p_74297_1_);
            final float f2 = p_74297_1_.normalizeValue(f1);
            return (p_74297_1_ == Options.SENSITIVITY) ? ((f2 == 0.0f) ? (s2 + I18n.format("options.sensitivity.min", new Object[0])) : ((f2 == 1.0f) ? (s2 + I18n.format("options.sensitivity.max", new Object[0])) : (s2 + (int)(f2 * 200.0f) + "%"))) : ((p_74297_1_ == Options.FOV) ? ((f1 == 70.0f) ? (s2 + I18n.format("options.fov.min", new Object[0])) : ((f1 == 110.0f) ? (s2 + I18n.format("options.fov.max", new Object[0])) : (s2 + (int)f1))) : ((p_74297_1_ == Options.FRAMERATE_LIMIT) ? ((f1 == p_74297_1_.valueMax) ? (s2 + I18n.format("options.framerateLimit.max", new Object[0])) : (s2 + (int)f1 + " fps")) : ((p_74297_1_ == Options.RENDER_CLOUDS) ? ((f1 == p_74297_1_.valueMin) ? (s2 + I18n.format("options.cloudHeight.min", new Object[0])) : (s2 + ((int)f1 + 128))) : ((p_74297_1_ == Options.GAMMA) ? ((f2 == 0.0f) ? (s2 + I18n.format("options.gamma.min", new Object[0])) : ((f2 == 1.0f) ? (s2 + I18n.format("options.gamma.max", new Object[0])) : (s2 + "+" + (int)(f2 * 100.0f) + "%"))) : ((p_74297_1_ == Options.SATURATION) ? (s2 + (int)(f2 * 400.0f) + "%") : ((p_74297_1_ == Options.CHAT_OPACITY) ? (s2 + (int)(f2 * 90.0f + 10.0f) + "%") : ((p_74297_1_ == Options.CHAT_HEIGHT_UNFOCUSED) ? (s2 + GuiNewChat.calculateChatboxHeight(f2) + "px") : ((p_74297_1_ == Options.CHAT_HEIGHT_FOCUSED) ? (s2 + GuiNewChat.calculateChatboxHeight(f2) + "px") : ((p_74297_1_ == Options.CHAT_WIDTH) ? (s2 + GuiNewChat.calculateChatboxWidth(f2) + "px") : ((p_74297_1_ == Options.RENDER_DISTANCE) ? (s2 + (int)f1 + " chunks") : ((p_74297_1_ == Options.MIPMAP_LEVELS) ? ((f1 == 0.0f) ? (s2 + I18n.format("options.off", new Object[0])) : (s2 + (int)f1)) : ((p_74297_1_ == Options.STREAM_FPS) ? (s2 + TwitchStream.formatStreamFps(f2) + " fps") : ((p_74297_1_ == Options.STREAM_KBPS) ? (s2 + TwitchStream.formatStreamKbps(f2) + " Kbps") : ((p_74297_1_ == Options.STREAM_BYTES_PER_PIXEL) ? (s2 + String.format("%.3f bpp", TwitchStream.formatStreamBps(f2))) : ((f2 == 0.0f) ? (s2 + I18n.format("options.off", new Object[0])) : (s2 + (int)(f2 * 100.0f) + "%"))))))))))))))));
        }
        ...
        if (p_74297_1_ == Options.GUI_SCALE) {
            return s2 + getTranslation(GameSettings.GUISCALES, this.guiScale);
        }
            ...
            while ((s = bufferedreader.readLine()) != null) {
                try {
                    ...
                    if (astring[0].equals("resourcePacks")) {
                        this.resourcePacks = (List)GameSettings.gson.fromJson(s.substring(s.indexOf(58) + 1), (Type)GameSettings.typeListString);
                        if (this.resourcePacks == null) {
                            this.resourcePacks = Lists.newArrayList();
                        }
                    }
                    if (astring[0].equals("incompatibleResourcePacks")) {
                        this.field_183018_l = (List)GameSettings.gson.fromJson(s.substring(s.indexOf(58) + 1), (Type)GameSettings.typeListString);
                    ...
                    if (p_getKeyBindingOF_1_ == Options.BETTER_GRASS) {
                        ...
                        if (p_getKeyBindingOF_1_ == Options.VIGNETTE) {
                            ...
                            if (p_getKeyBindingOF_1_ == Options.DYNAMIC_LIGHTS) {
                                ...
                                return s + getTranslation(GameSettings.KEYS_DYNAMIC_LIGHTS, k);
                            }
    ...
    public enum Options
    {
        ...
        private Options(final String p_i0_3_, final int p_i0_4_, final String p_i0_5_, final boolean p_i0_6_, final boolean p_i0_7_) {
            this(p_i0_3_, p_i0_4_, p_i0_5_, p_i0_6_, p_i0_7_, 0.0f, 1.0f, 0.0f);
        }
        
        private Options(final String p_i1_3_, final int p_i1_4_, final String p_i1_5_, final boolean p_i1_6_, final boolean p_i1_7_, final float p_i1_8_, final float p_i1_9_, final float p_i1_10_) {
