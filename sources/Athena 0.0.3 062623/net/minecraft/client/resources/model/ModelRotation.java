...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    private ModelRotation(final String p_i13_3_, final int p_i13_4_, final int p_i13_5_, final int p_i13_6_) {
    ...
    public Matrix4f getMatrix() {
        return (Matrix4f)(Reflector.ForgeHooksClient_getMatrix.exists() ? Reflector.call(Reflector.ForgeHooksClient_getMatrix, this) : new Matrix4f());
    }
