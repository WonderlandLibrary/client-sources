...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(final float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            Vec3 vec6 = null;
            final float f = 1.0f;
            final List list = this.mc.theWorld.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().addCoord(vec4.xCoord * d0, vec4.yCoord * d0, vec4.zCoord * d0).expand(f, f, f), (Predicate<? super Entity>)Predicates.and((Predicate)EntitySelectors.NOT_SPECTATING, (Predicate)new EntityRenderer1(this)));
            double d3 = d2;
    ...
    private float getFOVModifier(final float partialTicks, final boolean p_78481_2_) {
        ...
        if (flag) {
            final Zoom zoom = (Zoom)Athena.INSTANCE.getModuleManager().get(Zoom.class);
            if (!Config.zoomMode) {
    ...
    private void orientCamera(final float partialTicks) {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                final Freelook mod = (Freelook)Athena.INSTANCE.getModuleManager().get(Freelook.class);
                if (mod.isToggled() && Freelook.perspectiveToggled) {
                    f2 = mod.getCameraYaw();
                    f3 = mod.getCameraPitch();
                }
                ...
                if (mod.isToggled() || Freelook.perspectiveToggled) {
                    GlStateManager.rotate(mod.getCameraPitch() - f3, 1.0f, 0.0f, 0.0f);
                    GlStateManager.rotate(mod.getCameraYaw() - f2, 0.0f, 1.0f, 0.0f);
                    GlStateManager.translate(0.0f, 0.0f, (float)(-d4));
                    GlStateManager.rotate(f2 - mod.getCameraYaw(), 0.0f, 1.0f, 0.0f);
                    GlStateManager.rotate(f3 - mod.getCameraPitch(), 1.0f, 0.0f, 0.0f);
                }
                else {
        ...
        final Freelook mod2 = (Freelook)Athena.INSTANCE.getModuleManager().get(Freelook.class);
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists() || (mod2.isToggled() && Freelook.perspectiveToggled)) {
            if (!this.mc.gameSettings.debugCamEnable) {
    ...
    public void setupCameraTransform(final float partialTicks, final int pass) {
        ...
        if (this.mc.gameSettings.viewBobbing) {
            final MinimalBobbing module = (MinimalBobbing)Athena.INSTANCE.getModuleManager().get(MinimalBobbing.class);
    ...
    public void func_181560_a(final float p_181560_1_, final long p_181560_2_) {
        ...
        final Freelook mod = (Athena.INSTANCE.getModuleManager() == null) ? null : ((Freelook)Athena.INSTANCE.getModuleManager().get(Freelook.class));
        if (mod != null && mod.isToggled() && Freelook.perspectiveToggled) {
            mod.overrideMouse();
        }
