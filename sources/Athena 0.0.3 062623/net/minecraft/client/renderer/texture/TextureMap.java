    ...
    public void loadTextureAtlas(final IResourceManager resourceManager) {
        ...
        for (final Object entry : this.mapRegisteredSprites.entrySet()) {
            ...
            if (!textureatlassprite2.hasCustomLoader(resourceManager, resourcelocation)) {
                ...
                if (k3 < k) {
                    TextureMap.logger.warn("Texture {} with size {}x{} limits mip level from {} to {}", new Object[] { resourcelocation2, textureatlassprite2.getIconWidth(), textureatlassprite2.getIconHeight(), MathHelper.calculateLogBaseTwo(k), MathHelper.calculateLogBaseTwo(k3) });
                    k = k3;
                }
        ...
        if (j4 < this.mipmapLevels) {
            TextureMap.logger.info("{}: dropping miplevel from {} to {}, because of minimum power of two: {}", new Object[] { this.basePath, this.mipmapLevels, j4, i3 });
