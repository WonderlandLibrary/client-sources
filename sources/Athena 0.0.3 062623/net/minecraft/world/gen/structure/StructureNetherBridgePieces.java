...
public class StructureNetherBridgePieces
{
    ...
    public static class Start extends Crossing3
    {
        ...
        public Start(final Random p_i2059_1_, final int p_i2059_2_, final int p_i2059_3_) {
            ...
            for (final PieceWeight structurenetherbridgepieces$pieceweight : StructureNetherBridgePieces.primaryComponents) {
            ...
            for (final PieceWeight structurenetherbridgepieces$pieceweight2 : StructureNetherBridgePieces.secondaryComponents) {
