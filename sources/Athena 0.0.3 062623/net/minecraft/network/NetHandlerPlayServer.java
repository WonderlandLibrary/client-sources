...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable
{
    ...
    public void processVanilla250Packet(final C17PacketCustomPayload packetIn) {
        ...
        if ("MC|BEdit".equals(packetIn.getChannelName())) {
            final PacketBuffer packetbuffer3 = new PacketBuffer(Unpooled.wrappedBuffer((ByteBuf)packetIn.getBufferData()));
            try {
        ...
        if ("MC|BSign".equals(packetIn.getChannelName())) {
            final PacketBuffer packetbuffer4 = new PacketBuffer(Unpooled.wrappedBuffer((ByteBuf)packetIn.getBufferData()));
            try {
