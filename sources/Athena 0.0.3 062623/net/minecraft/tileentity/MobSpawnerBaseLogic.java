...
public abstract class MobSpawnerBaseLogic
{
    ...
    public class WeightedRandomMinecart extends WeightedRandom.Item
    {
        ...
        public WeightedRandomMinecart(final MobSpawnerBaseLogic this$0, final NBTTagCompound tagCompound) {
            this(this$0, tagCompound.getCompoundTag("Properties"), tagCompound.getString("Type"), tagCompound.getInteger("Weight"));
        }
        
        public WeightedRandomMinecart(final MobSpawnerBaseLogic this$0, final NBTTagCompound tagCompound, final String type) {
