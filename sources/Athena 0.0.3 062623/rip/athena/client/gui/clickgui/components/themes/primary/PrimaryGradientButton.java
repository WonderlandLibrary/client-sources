...
public class PrimaryGradientButton extends MenuButton
{
    ...
    public PrimaryGradientButton(final PrimaryTheme theme, final int x, final int y, final int width, final int height, final boolean leftColorChange) {
    ...
    public void onRender() {
        ...
        RoundedUtils.drawGradientRound((float)x, (float)y, (float)width, (float)this.height, 6.0f, new Color(this.primaryTheme.getFirstColor()), new Color(this.primaryTheme.getFirstColor()), new Color(this.primaryTheme.getSecondColor()), new Color(this.primaryTheme.getSecondColor()));
        GlStateManager.color(1.0f, 1.0f, 1.0f);
