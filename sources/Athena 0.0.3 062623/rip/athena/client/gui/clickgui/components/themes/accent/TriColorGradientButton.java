...
public class TriColorGradientButton extends MenuButton
{
    ...
    public TriColorGradientButton(final AccentTheme theme, final int x, final int y, final int width, final int height, final boolean leftColorChange) {
    ...
    public void onRender() {
        ...
        RoundedUtils.drawGradientRound((float)x, (float)y, (float)width, (float)this.height, 6.0f, this.theme.getFirstColor(), this.theme.getSecondColor(), this.theme.getThirdColor(), this.theme.getFirstColor());
