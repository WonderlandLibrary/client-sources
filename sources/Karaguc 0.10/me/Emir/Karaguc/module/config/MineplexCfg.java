...
public class MineplexCfg extends Module {
    public MineplexCfg() { super("MineplexCfg", Keyboard.KEY_NONE, Category.Config); }
    ...
    public void setup() {
        ...
        Karaguc.instance.settingsManager.rSetting(new Setting("AutoBreaker Mode", this, "MineplexCfg", options));
