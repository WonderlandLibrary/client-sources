...
public class ConfigIngameAdderLocal extends Module {
    public ConfigIngameAdderLocal() { super("ConfigIngameAdderLocal", Keyboard.KEY_NONE, Category.Config); }
    ...
    public void setup() {
        ...
        Karaguc.instance.settingsManager.rSetting(new Setting("AutoBreaker Mode", this, "MySkwarsConfig", options));
