...
public class HighJump extends Module {
    public HighJump() { super("HighJump", Keyboard.KEY_NONE, Category.MOVEMENT); }

    @Override
    public void setup() {
        ArrayList<String> options = new ArrayList<>();
        //TODO: Add more HighJump modes
        options.add("LAAC");
        Karaguc.instance.settingsManager.rSetting(new Setting("HighJump Mode", this, "Normal", options));
