...
public class NameTags extends Module {
    public NameTags() {
        super("NameTags", Keyboard.KEY_NONE, Category.MOVEMENT);
    }

    public void setup() {
        Karaguc.instance.settingsManager.rSetting(new Setting("Ping", this, true));
        Karaguc.instance.settingsManager.rSetting(new Setting("Item", this, true));
        Karaguc.instance.settingsManager.rSetting(new Setting("Item", this, true));
        Karaguc.instance.settingsManager.rSetting(new Setting("RainbowNameTags", this, false));
    }
    @EventTarget
