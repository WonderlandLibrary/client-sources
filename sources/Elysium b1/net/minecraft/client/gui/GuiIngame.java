...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (this.showCrosshair() && (Elysium.getInstance().targets.isEmpty() || th.toggled && (!th.mode.is("Cross") || !th.follow.isEnabled())))
        {
        ...
        new EventRenderHUD(partialTicks).post();
        Elysium.getInstance().hud.draw(i, j, getFontRenderer());
