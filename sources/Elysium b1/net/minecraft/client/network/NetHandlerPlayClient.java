...
import dev.elysium.client.ui.gui.MainMenu;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityVelocity(S12PacketEntityVelocity packetIn)
    {
        ...
        if (entity != null)
        {
            if(entity == Minecraft.getMinecraft().thePlayer) {
                EventVelocity e = (EventVelocity) new EventVelocity(x,y,z).post();
                if(!e.isCancelled()) entity.setVelocity(e.x == 0 ? entity.motionX : e.x, e.y == 0 ? entity.motionY : e.y, e.z == 0 ? entity.motionZ : e.z);
            } else {
    ...
    {
        EventPacket e = new EventPacket(p);
        e.setDirection(Event.EventDirection.OUTGOING);

        if(!e.post().isCancelled())
