...
import dev.elysium.client.mods.impl.render.Animations;
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0)
                {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                            float eased = MathHelper.sin((float) (MathHelper.sqrt_float(f1) * Math.PI));
                            Animations animations = (Animations) Elysium.getInstance().getModManager().getModByName("Animations");
                            GL11.glTranslated(animations.x.getValue(),animations.y.getValue(),0);
                            switch(animations.mode.getMode().toUpperCase()) {
                                case "1.7":
                                ...
                                case "EXHIBITION":
                                    ...
                                    GL11.glRotated(-eased * 40.0F, eased / 2, 0.0F, 9.0F);
                                    GL11.glRotated(-eased * 50.0F, 0.8F, eased / 2, 0F);
                                    this.doBlockTransformations();
                                    break;
                                case "TEST":
                                    this.transformFirstPersonItem(f - 0.3F, f1);
                                    GL11.glRotated(eased * 30.0F - 20, -eased / 2, 0.0F, 9.0F);
                                    GL11.glRotated(eased * -10, 0.8F, eased * -1, 0F);
                                    this.doBlockTransformations();
                                    break;
                            }
                            break;
