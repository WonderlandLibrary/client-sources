...
import dev.elysium.client.mods.impl.movement.Sneak;
...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    private void setModelVisibilities(AbstractClientPlayer clientPlayer)
    {
        ...
        else
        {
            ...
            Sneak sneak = (Sneak) Elysium.getInstance().getModManager().getModByName("Sneak");
            modelplayer.isSneak = clientPlayer.isSneaking() || clientPlayer == Minecraft.getMinecraft().thePlayer && sneak.toggled && sneak.render.isEnabled();
