...
import dev.elysium.client.events.EventMoveFlying;
import dev.elysium.client.events.EventSprint;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        if(this == Minecraft.getMinecraft().thePlayer) {
            EventMove event = (EventMove) new EventMove(x,y,z, safewalk).post();
    ...
    {
        EventMoveFlying e = (EventMoveFlying) new EventMoveFlying(strafe,forward,friction,rotationYaw).post();
        strafe = e.getStrafe();
    ...
    {
        return ((EventSprint)new EventSprint(this.getFlag(3)).post()).shouldSprint();
    }
