...
@Metadata(mv={1, 1, 16}, bv={1, 0, 3}, k=1, d1={"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0006\n\u0000\n\u0002\u0010\u0007\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u00c6\u0002\u0018\u00002\u00020\u0001:\u0001\fB\u0007\b\u0002\u00a2\u0006\u0002\u0010\u0002J*\u0010\u0003\u001a\u0004\u0018\u00010\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\b2\u0006\u0010\n\u001a\u00020\u000bH\u0002J\u001a\u0010\u0003\u001a\u0004\u0018\u00010\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\n\u001a\u00020\u000bH\u0007\u00a8\u0006\r"}, d2={"Lnet/ccbluex/liquidbounce/utils/RaycastUtils;", "Lnet/ccbluex/liquidbounce/utils/MinecraftInstance;", "()V", "raycastEntity", "Lnet/ccbluex/liquidbounce/api/minecraft/client/entity/IEntity;", "range", "", "yaw", "", "pitch", "entityFilter", "Lnet/ccbluex/liquidbounce/utils/RaycastUtils$EntityFilter;", "EntityFilter", "LiKingSense"})
...
extends MinecraftInstance {
    ...
    public static final IEntity raycastEntity(double range, @NotNull EntityFilter entityFilter) {
        Intrinsics.checkParameterIsNotNull((Object)entityFilter, (String)"entityFilter");
    ...
    private final IEntity raycastEntity(double range, float yaw, float pitch, EntityFilter entityFilter) {
        ...
        if (renderViewEntity != null && MinecraftInstance.mc.getTheWorld() != null) {
            ...
            Collection<IEntity> entityList2 = MinecraftInstance.mc.getTheWorld().getEntitiesInAABBexcluding(renderViewEntity, renderViewEntity.getEntityBoundingBox().addCoord(entityLook.getXCoord() * blockReachDistance, entityLook.getYCoord() * blockReachDistance, entityLook.getZCoord() * blockReachDistance).expand(1.0, 1.0, 1.0), (Function1<? super IEntity, Boolean>)((Function1)raycastEntity.entityList.1.INSTANCE));
            ...
            for (IEntity entity : entityList2) {
                ...
                if (Intrinsics.areEqual((Object)entity, (Object)renderViewEntity.getRidingEntity()) && !renderViewEntity.canRiderInteract()) {
                    if (blockReachDistance != 0.0) continue;
                    pointedEntity = entity;
                    continue;
                }
    ...
    @Metadata(mv={1, 1, 16}, bv={1, 0, 3}, k=1, d1={"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H&\u00a8\u0006\u0006"}, d2={"Lnet/ccbluex/liquidbounce/utils/RaycastUtils$EntityFilter;", "", "canRaycast", "", "entity", "Lnet/ccbluex/liquidbounce/api/minecraft/client/entity/IEntity;", "LiKingSense"})
