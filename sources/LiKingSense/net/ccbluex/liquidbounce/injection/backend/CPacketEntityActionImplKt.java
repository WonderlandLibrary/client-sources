...
@Metadata(mv={1, 1, 16}, bv={1, 0, 3}, k=2, d1={"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\r\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u0086\b\u001a\r\u0010\u0003\u001a\u00020\u0002*\u00020\u0001H\u0086\b\u00a8\u0006\u0004"}, d2={"unwrap", "Lnet/minecraft/network/play/client/CPacketEntityAction;", "Lnet/ccbluex/liquidbounce/api/minecraft/network/play/client/ICPacketEntityAction;", "wrap", "LiKingSense"})
public final class CPacketEntityActionImplKt {
    @NotNull
    public static final CPacketEntityAction unwrap(@NotNull ICPacketEntityAction $this$unwrap) {
        int $i$f$unwrap = 0;
    ...
    @NotNull
    public static final ICPacketEntityAction wrap(@NotNull CPacketEntityAction $this$wrap) {
        int $i$f$wrap = 0;
