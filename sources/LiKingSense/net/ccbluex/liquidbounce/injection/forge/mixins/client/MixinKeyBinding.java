...
public abstract class MixinKeyBinding {
    ...
    public boolean func_151470_d() {
        ...
        boolean InvMove = inventoryMove.getState() ? this.field_74513_e : this.field_74513_e && this.getKeyConflictContext().isActive() && this.getKeyModifier().isActive(this.getKeyConflictContext());
        return InvMove;
    }
