...
public final class EventManager {
    ...
    public final void registerListener(@NotNull Listenable listener) {
        ...
        for (Method method : listener.getClass().getDeclaredMethods()) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(arrayList, (String)"registry.getOrDefault(eventClass, ArrayList())");
            List invokableEventTargets = arrayList;
            EventTarget eventTarget2 = eventTarget;
            Intrinsics.checkExpressionValueIsNotNull((Object)eventTarget2, (String)"eventTarget");
    ...
    public final void unregisterListener(@NotNull Listenable listenable) {
        Intrinsics.checkParameterIsNotNull((Object)listenable, (String)"listenable");
        ...
        while (iterator.hasNext()) {
            ...
            targets.removeIf((Predicate)new Predicate<EventHook>(listenable){
                ...
                public final boolean test(@NotNull EventHook it) {
                    ...
                    return Intrinsics.areEqual((Object)it.getEventClass(), (Object)this.$listenable);
                }
                {
    ...
    public final void callEvent(@NotNull Event event) {
        ...
        Intrinsics.checkExpressionValueIsNotNull(list, (String)"registry[event.javaClass] ?: return");
