...
extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
         ...
         * 
         * org.benf.cfr.reader.util.ConfusedCFRException: While processing lbl59 : INVOKESTATIC - null : Stack underflow
    ...
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
         ...
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
         * 
         * org.benf.cfr.reader.util.ConfusedCFRException: Invalid stack depths @ lbl34 : ALOAD_3 - null : trying to set 4 previously set to 6
