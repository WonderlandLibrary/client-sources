...
extends Module {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (!this.healthMap.containsKey(entity)) {
            this.healthMap.put(entity, Float.valueOf(entity.func_110143_aJ()));
        }
        ...
        if (floatValue != health) {
            ...
            location.setY(entity.func_174813_aQ().field_72338_b + (entity.func_174813_aQ().field_72337_e - entity.func_174813_aQ().field_72338_b) / 2.0);
    ...
    public void onRender(Render3DEvent event) {
        for (Particles p : this.particles) {
            ...
            GlStateManager.func_179114_b((float)(-mc.getRenderManager().getPlayerViewY()), (float)0.0f, (float)1.0f, (float)0.0f);
            float textY = 1.0f;
            GlStateManager.func_179114_b((float)mc.getRenderManager().getPlayerViewX(), (float)textY, (float)0.0f, (float)0.0f);
            double size = 0.025;
            GlStateManager.func_179139_a((double)-0.025, (double)-0.025, (double)0.025);
            DMGParticle.enableGL2D();
            DMGParticle.disableGL2D();
            GL11.glDepthMask((boolean)false);
            Fonts.posterama40.drawString(p.text, (float)(-(Fonts.posterama40.getStringWidth(p.text) / 2)), (float)(-(Fonts.posterama40.getFontHeight() - 1)), 0);
