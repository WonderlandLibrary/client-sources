...
@Metadata(mv={1, 1, 16}, bv={1, 0, 3}, k=1, d1={"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0005\u00a2\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016J\b\u0010\u0005\u001a\u00020\u0004H\u0016J\b\u0010\u0006\u001a\u00020\u0004H\u0016J\u0010\u0010\u0007\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\tH\u0016J\b\u0010\n\u001a\u00020\u0004H\u0016J\b\u0010\u000b\u001a\u00020\u0004H\u0016\u00a8\u0006\f"}, d2={"Lnet/ccbluex/liquidbounce/features/module/modules/movement/speeds/aac/AAC4SlowHop;", "Lnet/ccbluex/liquidbounce/features/module/modules/movement/speeds/SpeedMode;", "()V", "onDisable", "", "onEnable", "onMotion", "onMove", "event", "Lnet/ccbluex/liquidbounce/event/MoveEvent;", "onTick", "onUpdate", "LiKingSense"})
...
extends SpeedMode {
    ...
    public void onUpdate() {
        ...
        if (MovementUtils.isMoving()) {
            ...
            if (!MinecraftInstance.mc.getThePlayer().getOnGround() && (double)MinecraftInstance.mc.getThePlayer().getFallDistance() <= 0.1) {
                MinecraftInstance.mc.getThePlayer().setSpeedInAir(0.02f);
                MinecraftInstance.mc.getTimer().setTimerSpeed(1.4f);
            }
            if ((double)MinecraftInstance.mc.getThePlayer().getFallDistance() > 0.1 && (double)MinecraftInstance.mc.getThePlayer().getFallDistance() < 1.3) {
                MinecraftInstance.mc.getThePlayer().setSpeedInAir(0.0205f);
