...
@ModuleInfo(name="NewGUI", description="next generation tomo.", category=ModuleCategory.RENDER, canEnable=false)
public class NewGUI
extends Module {
    public static final BoolValue fastRenderValue;
    ...
    public static Color getAccentColor() {
         ...
         * 
         * org.benf.cfr.reader.util.ConfusedCFRException: Invalid stack depths @ lbl144 : ALOAD_0 - null : trying to set 3 previously set to 2
    ...
    static {
         ...
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
         * 
         * org.benf.cfr.reader.util.ConfusedCFRException: While processing lbl43 : INVOKESPECIAL - null : Stack underflow
