...
extends MinecraftInstance {
    ...
    protected final void chat(@NotNull String msg) {
        ...
        ClientUtils.displayChatMessage("\u00a78[\u00a79\u00a7lLiKingSense\u00a78] \u00a73" + msg);
    }

    protected final void chatSyntax(@NotNull String syntax) {
        Intrinsics.checkParameterIsNotNull((Object)syntax, (String)"syntax");
        ClientUtils.displayChatMessage("\u00a78[\u00a79\u00a7lLiKingSense\u00a78] \u00a73Syntax: \u00a77" + LiquidBounce.INSTANCE.getCommandManager().getPrefix() + syntax);
    }

    protected final void chatSyntax(@NotNull String[] syntaxes) {
        Intrinsics.checkParameterIsNotNull((Object)syntaxes, (String)"syntaxes");
        ClientUtils.displayChatMessage("\u00a78[\u00a79\u00a7lLiKingSense\u00a78] \u00a73Syntax:");
    ...
    protected final void chatSyntaxError() {
        ClientUtils.displayChatMessage("\u00a78[\u00a79\u00a7lLiKingSense\u00a78] \u00a73Syntax error");
    }
