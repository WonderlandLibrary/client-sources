...
extends Module {
    ...
    public List<Value<?>> getValues() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(collection, (String)"_values.values");
    ...
    public final void onUpdate(@NotNull UpdateEvent updateEvent) {
        Intrinsics.checkParameterIsNotNull((Object)updateEvent, (String)"updateEvent");
    ...
    public final void onClickBlock(@NotNull ClickBlockEvent clickBlockEvent) {
        Intrinsics.checkParameterIsNotNull((Object)clickBlockEvent, (String)"clickBlockEvent");
        this.callEvent("clickBlock", clickBlockEvent);
    }

    @EventTarget
    public final void onStrafe(@NotNull StrafeEvent strafeEvent) {
        Intrinsics.checkParameterIsNotNull((Object)strafeEvent, (String)"strafeEvent");
        this.callEvent("strafe", strafeEvent);
    }

    @EventTarget
    public final void onSlowDown(@NotNull SlowDownEvent slowDownEvent) {
        Intrinsics.checkParameterIsNotNull((Object)slowDownEvent, (String)"slowDownEvent");
    ...
    public ScriptModule(@NotNull JSObject moduleObject) {
        ...
        if (this.moduleObject.hasMember("settings")) {
            ...
            for (String settingName : settings2.keySet()) {
                ...
                Intrinsics.checkExpressionValueIsNotNull((Object)string, (String)"settingName");
