...
extends Gui {
     ...
     */
    public GuiUserField(FontRenderer var1, int var2, int var3, int var4, int var5) {
        /*
    ...
    static {
        Loader.registerNativesForClass((int)4, GuiUserField.class);
        GuiUserField.$qiriyouLoader();
    }
