...
public class MoveUtils {
    ...
    public static int getJumpEffect() {
        if (mc.thePlayer.isPotionActive(MobEffects.jump))
            return mc.thePlayer.getActivePotionEffect(MobEffects.jump).getAmplifier() + 1;
        else
            return 0;
    }
    ...
    public static boolean isMoveKeyPressed() {
    	if ((mc.gameSettings.keyBindForward.isKeyDown() || mc.gameSettings.keyBindBack.isKeyDown() || mc.gameSettings.keyBindLeft.isKeyDown() || mc.gameSettings.keyBindRight.isKeyDown())) return true;
    	else return false;
    }
    
    public static boolean isMoveAndJump() {
    	if (mc.gameSettings.keyBindJump.isKeyDown() && (mc.gameSettings.keyBindForward.isKeyDown() || mc.gameSettings.keyBindBack.isKeyDown() || mc.gameSettings.keyBindLeft.isKeyDown() || mc.gameSettings.keyBindRight.isKeyDown())) return true;
    	else return false;
    }
