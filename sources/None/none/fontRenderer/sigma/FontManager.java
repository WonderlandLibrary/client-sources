package none.fontRenderer.sigma;

import net.minecraft.client.renderer.GlStateManager;
import net.minecraft.util.ResourceLocation;
import none.utils.render.TTFFontRenderer;
import none.utils.render.TextureData;
...
public class FontManager {
    ...
    public FontManager() {
        ...
        try {
            ...
            for (int i : new int[]{19}) {
                InputStream istream = getClass().getResourceAsStream("/assets/minecraft/MachineC.ttf");
                Font myFont = Font.createFont(Font.PLAIN, istream);
                myFont = myFont.deriveFont(Font.PLAIN, i);
                fonts.put("MachineC " + i, new TTFFontRenderer(executorService, textureQueue, myFont));
            }
            
            for (int i : new int[]{19}) {
                InputStream istream = getClass().getResourceAsStream("/assets/minecraft/BebasNeue-Regular.otf");
                Font myFont = Font.createFont(Font.PLAIN, istream);
                myFont = myFont.deriveFont(Font.PLAIN, i);
                fonts.put("BebasNeue", new TTFFontRenderer(executorService, textureQueue, myFont));
            }
