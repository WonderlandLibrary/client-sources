...
public class CommandEffect extends CommandBase
{
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    MobEffects potion = MobEffects.getPotionFromResourceLocation(args[1]);
                ...
                if (i >= 0 && i < MobEffects.potionTypes.length && MobEffects.potionTypes[i] != null)
                {
                    MobEffects potion1 = MobEffects.potionTypes[i];
    ...
    {
        return args.length == 1 ? getListOfStringsMatchingLastWord(args, this.getAllUsernames()) : (args.length == 2 ? getListOfStringsMatchingLastWord(args, MobEffects.func_181168_c()) : (args.length == 5 ? getListOfStringsMatchingLastWord(args, new String[] {"true", "false"}): null));
    }
