...
public class TileEntityBeacon extends TileEntityLockable implements ITickable, IInventory
{
    ...
    public static final MobEffects[][] effectsList = new MobEffects[][] {{MobEffects.SPEED, MobEffects.digSpeed}, {MobEffects.resistance, MobEffects.jump}, {MobEffects.damageBoost}, {MobEffects.regeneration}};
    ...
    {
        if (p_183001_1_ >= 0 && p_183001_1_ < MobEffects.potionTypes.length && MobEffects.potionTypes[p_183001_1_] != null)
        {
            MobEffects potion = MobEffects.potionTypes[p_183001_1_];
            return potion != MobEffects.SPEED && potion != MobEffects.digSpeed && potion != MobEffects.resistance && potion != MobEffects.jump && potion != MobEffects.damageBoost && potion != MobEffects.regeneration ? 0 : p_183001_1_;
        }
        else
        {
            return 0;
