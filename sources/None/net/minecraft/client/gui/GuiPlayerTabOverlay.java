...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    {
    	if (Client.instance.moduleManager.nameProtect.isEnabled() && networkPlayerInfoIn.getGameProfile().getName().equalsIgnoreCase(mc.thePlayer.getGameProfile().getName())) {
        	return "\2479" + NameProtect.GetName() + "\247r";
        }else if (Client.instance.ISDev && networkPlayerInfoIn.getGameProfile().getName().equalsIgnoreCase(Minecraft.getMinecraft().getSession().getProfile().getName())) {
        	return networkPlayerInfoIn.getDisplayName() != null ? networkPlayerInfoIn.getDisplayName().getFormattedText() : ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(), networkPlayerInfoIn.getGameProfile().getName()) + ChatFormatting.WHITE +":" + ChatFormatting.DARK_BLUE + "Dev";
    	}else if (networkPlayerInfoIn.getGameProfile().getName().equalsIgnoreCase("NoneTK")) {
        	return networkPlayerInfoIn.getDisplayName() != null ? networkPlayerInfoIn.getDisplayName().getFormattedText() : ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(), networkPlayerInfoIn.getGameProfile().getName()) + ChatFormatting.WHITE +":" + ChatFormatting.DARK_BLUE + "Dev";
        }else if (networkPlayerInfoIn.getGameProfile().getName().equalsIgnoreCase("HaKu_V3")) {
        	return networkPlayerInfoIn.getDisplayName() != null ? networkPlayerInfoIn.getDisplayName().getFormattedText() : ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(), networkPlayerInfoIn.getGameProfile().getName()) + ChatFormatting.WHITE +":" + ChatFormatting.BLACK + "Mr.NoName";
        }else if (networkPlayerInfoIn.getGameProfile().getName().equalsIgnoreCase("Sirasora")) {
        	return networkPlayerInfoIn.getDisplayName() != null ? networkPlayerInfoIn.getDisplayName().getFormattedText() : ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(), networkPlayerInfoIn.getGameProfile().getName()) + ChatFormatting.WHITE +":" + ChatFormatting.BLUE + "TheSmokey";
        }else if (networkPlayerInfoIn.getGameProfile().getName().equalsIgnoreCase("ZeezaGamer")) {
    		return networkPlayerInfoIn.getDisplayName() != null ? networkPlayerInfoIn.getDisplayName().getFormattedText() : ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(), networkPlayerInfoIn.getGameProfile().getName()) + ChatFormatting.WHITE + ":" + ChatFormatting.RED + "l" + ChatFormatting.GOLD + "n" + ChatFormatting.YELLOW +"W" + ChatFormatting.GREEN +"T" + ChatFormatting.BLUE + "r" + ChatFormatting.DARK_BLUE + "u" + ChatFormatting.DARK_PURPLE + "e";
    	}else if (networkPlayerInfoIn.getGameProfile().getName().equalsIgnoreCase("xLinkLeto_CHx")) {
    		return networkPlayerInfoIn.getDisplayName() != null ? networkPlayerInfoIn.getDisplayName().getFormattedText() : ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(), networkPlayerInfoIn.getGameProfile().getName()) + ChatFormatting.WHITE + ":" + ChatFormatting.RED + "l" + ChatFormatting.GOLD + "n" + ChatFormatting.YELLOW +"W" + ChatFormatting.GREEN +"T" + ChatFormatting.BLUE + "r" + ChatFormatting.DARK_BLUE + "u" + ChatFormatting.DARK_PURPLE + "e";
    	}
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        boolean flag = this.mc.isIntegratedServerRunning() || this.mc.getConnection().getNetworkManager().getIsencrypted();
        int l;
        ...
        for (int k4 = 0; k4 < l3; ++k4)
        {
            ...
            if (k4 < list.size())
            {
                ...
                if (flag)
                {
                    ...
                    boolean flag1 = entityplayer != null && entityplayer.isWearing(EnumPlayerModelParts.CAPE) && (gameprofile.getName().equals("Dinnerbone") || gameprofile.getName().equals("Grumm") || Client.instance.nameList.contains(gameprofile.getName()));
                    ...
                    j2 += 9;
                }else if (Client.instance.nameList.contains(gameprofile.getName())) {
                	EntityPlayer entityplayer = this.mc.theWorld.getPlayerEntityByUUID(gameprofile.getId());
                    boolean flag1 = false;
                    this.mc.getTextureManager().bindTexture(networkplayerinfo1.getLocationSkin());
                    int l2 = 8 + (flag1 ? 8 : 0);
                ...
                this.drawPing(i1, j2 - (flag ? 9 : Client.instance.nameList.contains(gameprofile.getName()) ? 9 : 0), k2, networkplayerinfo1);
            }
        }
    ...
    private void drawScoreboardValues(ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_, int p_175247_5_, NetworkPlayerInfo p_175247_6_)
    {
        ...
        else
        {
            ...
            this.mc.fontRendererObj.drawStringWithShadow(s1, (float)(p_175247_5_ - this.mc.fontRendererObj.getStringWidth(s1)) - (Client.instance.nameList.contains(p_175247_6_.getGameProfile().getName()) ? 9 : 0), (float)p_175247_2_, 16777215);
        }
    }
