...
//        EventChat.addchatmessage("mc.playerController.windowClick(" + "this.inventorySlots.windowId" + this.inventorySlots.windowId + ", " + slotId + ", " + clickedButton + ", " + "ClickType:" + clickType + ", this.mc.thePlayer);");
    }
