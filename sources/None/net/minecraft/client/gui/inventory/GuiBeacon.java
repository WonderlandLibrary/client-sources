...
public class GuiBeacon extends GuiContainer
{
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        else if (button.id == -1)
        {
            ...
            this.mc.getConnection().sendPacket(new C17PacketCustomPayload(s, packetbuffer));
            this.mc.displayGuiScreen((GuiScreen)null);
        }
    ...
    class PowerButton extends GuiBeacon.Button
    {
        ...
        {
            super(p_i1076_2_, p_i1076_3_, p_i1076_4_, GuiContainer.inventoryBackground, 0 + MobEffects.potionTypes[p_i1076_5_].getStatusIconIndex() % 8 * 18, 198 + MobEffects.potionTypes[p_i1076_5_].getStatusIconIndex() / 8 * 18);
        ...
        public void drawButtonForegroundLayer(int mouseX, int mouseY)
        {
            String s = I18n.format(MobEffects.potionTypes[this.field_146149_p].getName(), new Object[0]);

            if (this.field_146148_q >= 3 && this.field_146149_p != MobEffects.regeneration.id)
            {
                s = s + " II";
            }
