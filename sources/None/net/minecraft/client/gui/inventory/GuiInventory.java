...
public class GuiInventory extends InventoryEffectRenderer
{
    ...
    public static void drawEntityOnScreen(int posX, int posY, int scale, float mouseX, float mouseY, EntityLivingBase ent)
    {
        ...
        float f5 = ent.prevRotationPitchHead;
        float f6 = ent.rotationPitchHead;
...
//        ent.rotationPitchHead = ent.rotationPitch;
//        ent.prevRotationPitchHead = ent.rotationPitch;
        ...
        ent.prevRotationPitchHead = f5;
        ent.rotationPitchHead = f6;
