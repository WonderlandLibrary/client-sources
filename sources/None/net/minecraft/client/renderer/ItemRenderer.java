...
import none.module.modules.render.BlockHitAM;
import none.module.modules.render.NoFire;
import none.module.modules.render.NoHurtCam;
...
//    	GlStateManager.translate(0.56F, -0.3F, -0.71999997F);
//        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
//        GlStateManager.rotate(30.0F, 0.0F, 0.0F, 1.0F);
//        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
//        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI) * 0.6F;
//        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI) * 0.6F;
//        GlStateManager.rotate(smooth * -30F, 0.0F, 0.0F, 1.0F);
//        GlStateManager.rotate(smooth * -140.0F, 1.0F, 0.0F, 0.0F);
//        GlStateManager.rotate(smooth * 30F, 0.0F, 0.0F, 1.0F);
//        GlStateManager.scale(0.4F, 0.4F, 0.4F);
    	GlStateManager.translate(0.56F, -0.52F, -0.71999997F);
        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(17.0F, 1.0F, 0.0F, 0.0F);
        GlStateManager.rotate(10.0F, 0.0F, 0.0F, 1.0F);
        GlStateManager.translate(0F, 0.37F, -0.1F);
        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
//        GlStateManager.rotate(f * -20.0F, 0.0F, 1.0F, 0.0F);
    ...
    private void spin(float equipProgress, float swingProgress)
    {
        ...
        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(spincount, 0.0F, 1.0F, 0.0F);
//        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
//        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
//        GlStateManager.rotate(f * -20.0F, 0.0F, 1.0F, 0.0F);
//        GlStateManager.rotate(f1 * -20.0F, 0.0F, 0.0F, 1.0F);
//        GlStateManager.rotate(f1 * -80.0F, 1.0F, 0.0F, 0.0F);
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        GlStateManager.pushMatrix();
//        f1 = f1*BlockHitAM.Speed.getInteger() / 100F - (f1 * f1)*BlockHitAM.Speed.getInteger() / 100F; 
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                    	...
                    	if (Client.instance.moduleManager.blockAnimtion.isEnabled()) {
                    		if (BlockHitAM.abmode.getObject() == 0) {
                            	//None
                    			this.avatar(f, f1);
                                this.func_178103_d();
                            }else if (BlockHitAM.abmode.getObject() == 1) {
                            	//Tap
                            	this.tap(f, f1);
                        		this.func_178103_d();
                            }else if (BlockHitAM.abmode.getObject() == 2) {
                            	//Tap2
                            	this.tap2(f, f1);
                        		this.func_178103_d();
                            }else if (BlockHitAM.abmode.getObject() == 3) {
                            	//Vanilla
                            	this.transformFirstPersonItem(0, f1);
                        		this.func_178103_d();
                            }else if (BlockHitAM.abmode.getObject() == 4) {
                            	//Slide
                            	this.sigma2(f * 0.2F, f1);
                        		this.func_178103_d();
                            }else if (BlockHitAM.abmode.getObject() == 5) {
                            	//Sigma
                            ...
                            }else if (BlockHitAM.abmode.getSelected().equalsIgnoreCase("Exhibition")) {
                            	//exhibition
        						...
        						func_178103_d();
                            }else if (BlockHitAM.abmode.getSelected().equalsIgnoreCase("Remix")) {
                            	//Remix
                            	GL11.glTranslated(-0.1D, 0.00D, 0.0D);
        						this.transformFirstPersonItem(-0.45F, 0F);
        						GlStateManager.rotate(-f6 * 60.0F / 2.0F, f6 / 2.0F, -0.0F, 4.0F);
        						...
        						func_178103_d();
                            }else if (BlockHitAM.abmode.getSelected().equalsIgnoreCase("Crystalware")) {
                            	//Crystalware
                            	this.transformFirstPersonItem(-0.2F, f1);
        						this.func_178103_d();
        						GlStateManager.translate(-0.5F, 0.2F, 0.0F);
                            }else if (BlockHitAM.abmode.getSelected().equalsIgnoreCase("Spin")) {
                            	//Spin
                            	this.spin(f, f1);
        						this.func_178103_d();
        						spincount += 14;
            ...
            {
            	if ((Killaura.fakeblock.getObject() && 
            			Client.instance.moduleManager.blockAnimtion.isEnabled() &&
            			Killaura.isBlocking == true) || (Client.instance.moduleManager.scaffold.isEnabled() && Scaffold.ItemBlock.getObject() && Scaffold.getBlocking() == true && (this.itemToRender.getItem() instanceof ItemSword || BlockHitAM.item.getObject()))) {
            		float f6 = MathHelper.sin((float) (MathHelper.sqrt_float(f1) * 3.1));
            		float var14 = MathHelper.sin(MathHelper.sqrt_float(f1) * (float)Math.PI);
                    float var15 =MathHelper.sin(f1 * f1 * 3.1415927F);
                    if (BlockHitAM.abmode.getObject() == 0) {
    ...
    public void renderOverlays(float partialTicks)
    {
        ...
        if (!this.mc.thePlayer.isSpectator())
        {
            ...
            if (this.mc.thePlayer.isBurning() && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, new Object[] {this.mc.thePlayer, Float.valueOf(partialTicks)}))
            {
            	...
            	Client.instance.moduleManager.noFire.setDisplayName(Client.instance.moduleManager.noFire.getName());
            }
        }
    ...
    {
        if (Client.instance.moduleManager.noFire.isEnabled()) {
        	Client.instance.moduleManager.noFire.setDisplayName(Client.instance.moduleManager.noFire.getName() + ChatFormatting.WHITE + " Burning");
        	return;
        }
    	Tessellator tessellator = Tessellator.getInstance();
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
