...
import none.module.modules.player.FastPlace;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public Minecraft(GameConfiguration gameConfig)
    {
        ...
        logger.info("(AccessToken is " + this.session.getToken() + ")");
        logger.info("(UUID is " + this.session.getProfile().getId() + ")");
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading... " + Client.instance.name + " Made by " + Client.instance.dev);
        try
        {
    ...
    public void clickMouse()
    {
    	...
    	if (this.leftClickCounter <= 0)
        {
            ...
            else
            {
                ...
                {
                    case ENTITY:
                        this.playerController.attackEntity(this.thePlayer, objectMouseOver.entityHit);
    ...
    public void rightClickMouse()
    {
        if (!this.playerController.func_181040_m())
        {
            ...
            if (Client.instance.moduleManager.fastPlace.isEnabled()) {
            	this.rightClickDelayTimer = FastPlace.speed.getInteger();
            }
            boolean flag = true;
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Mouse.next())
            {
                ...
                eventMouse.fire(i, Mouse.getEventButtonState());
                i = eventMouse.getButtonID();
            ...
            while (this.gameSettings.keyBindInventory.isPressed())
            {
                ...
                {
                    this.getConnection().sendPacket(new C16PacketClientStatus(C16PacketClientStatus.EnumState.OPEN_INVENTORY_ACHIEVEMENT));
    ...
    {
        return this.thePlayer != null ? this.thePlayer.connection : null;
    }
