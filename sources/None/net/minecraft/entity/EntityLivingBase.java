...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void onEntityUpdate()
    {
        ...
        if (this.isEntityAlive())
        {
            ...
            {
                if (!this.canBreatheUnderwater() && !this.isPotionActive(MobEffects.waterBreathing.id) && !flag1)
                {
    ...
    protected void updatePotionMetadata()
    {
        ...
        else
        {
            ...
            this.setInvisible(this.isPotionActive(MobEffects.invisibility.id));
        }
    }
    ...
    public boolean isPotionActive(MobEffects potionIn)
    {
     ...
     */
    public PotionEffect getActivePotionEffect(MobEffects potionIn)
    {
    ...
    public boolean isPotionApplicable(PotionEffect potioneffectIn)
    {
        if (this.getCreatureAttribute() == EnumCreatureAttribute.UNDEAD)
        {
            ...
            if (i == MobEffects.regeneration.id || i == MobEffects.poison.id)
            {
                return false;
            }
        }
    ...
    protected void onNewPotionEffect(PotionEffect id)
    {
        ...
        if (!this.worldObj.isRemote)
        {
            MobEffects.potionTypes[id.getPotionID()].applyAttributesModifiersToEntity(this, this.getAttributeMap(), id.getAmplifier());
        }
    }
    ...
    protected void onChangedPotionEffect(PotionEffect id, boolean p_70695_2_)
    {
        ...
        {
            MobEffects.potionTypes[id.getPotionID()].removeAttributesModifiersFromEntity(this, this.getAttributeMap(), id.getAmplifier());
            MobEffects.potionTypes[id.getPotionID()].applyAttributesModifiersToEntity(this, this.getAttributeMap(), id.getAmplifier());
        }
    }
    ...
    protected void onFinishedPotionEffect(PotionEffect p_70688_1_)
    {
        ...
        if (!this.worldObj.isRemote)
        {
            MobEffects.potionTypes[p_70688_1_.getPotionID()].removeAttributesModifiersFromEntity(this, this.getAttributeMap(), p_70688_1_.getAmplifier());
        }
    }
    ...
    public void setHealth(float health)
    {
        ...
        this.lasthealth = Float.valueOf(MathHelper.clamp_float(health, 0.0F, this.getMaxHealth()));
    }
    ...
    {
        return this.isPotionActive(MobEffects.digSpeed) ? 6 - (1 + this.getActivePotionEffect(MobEffects.digSpeed).getAmplifier()) * 1 : (this.isPotionActive(MobEffects.digSlowdown) ? 6 + (1 + this.getActivePotionEffect(MobEffects.digSlowdown).getAmplifier()) * 2 : 6);
    }
...
//    	this.motionY = this.getJumpUpwardsMotion();
    	double y = this.isPotionActive(MobEffects.jump) ? getJumpUpwardsMotion() + (getActivePotionEffect(MobEffects.jump).getAmplifier() + 1) * 0.1F : getJumpUpwardsMotion();
    	ej.fire(y, true);
    	if (ej.isCancelled())
    		return;
...
//        }
    ...
    protected float func_110146_f(float p_110146_1_, float p_110146_2_)
    {
    	...
    	if (this instanceof EntityPlayerSP) { 
	        ...
	        if (this.swingProgress > 0.0F)
	        {
	        	p_110146_1_ = e.getYaw();
	        	if (HUDEditer.rotations.getSelected().equalsIgnoreCase("NoRot")) {
	        		p_110146_1_ = this.rotationYawHead;
                }
	        }
	        
	        float f = MathHelper.wrapAngleTo180_float(p_110146_1_ - this.renderYawOffset);
	        this.renderYawOffset += f * 0.3F;
	        float f1 = MathHelper.wrapAngleTo180_float(e.getYaw() - this.renderYawOffset);
	        if (HUDEditer.rotations.getSelected().equalsIgnoreCase("NoRot")) {
	        	f1 = MathHelper.wrapAngleTo180_float(this.rotationYawHead - this.renderYawOffset);
            }
	        flag = f1 < -90.0F || f1 > 90.0F;
	        ...
	        this.renderYawOffset = e.getYaw() - f1;
	        
	        if (HUDEditer.rotations.getSelected().equalsIgnoreCase("NoRot")) {
	        	this.renderYawOffset = this.rotationYawHead - f1;
            }
	        ...
	        float f = MathHelper.wrapAngleTo180_float(p_110146_1_ - this.renderYawOffset);
	        this.renderYawOffset += f * 0.3F;
	        float f1 = MathHelper.wrapAngleTo180_float(this.rotationYawHead - this.renderYawOffset);
	        flag = f1 < -90.0F || f1 > 90.0F;
    ...
    public void onLivingUpdate()
    {
        ...
        Scaffold scaffold = (Scaffold)Client.instance.moduleManager.scaffold;
        if (scaffold != null && scaffold.isEnabled()) {
        	float f = this.moveForward;
        	float f1 = this.moveStrafing;
        	if (scaffold.swapMove.getObject()) {
        		this.moveForward = -f;
    ...
    public void setRotationPitchHead(float rotation)
    {
        this.rotationPitchHead = rotation;
    }
