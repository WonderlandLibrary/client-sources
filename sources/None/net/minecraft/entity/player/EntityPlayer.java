...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public boolean isHaveBow = false;
    ...
    public void attackTargetEntityWithCurrentItem(Entity targetEntity)
    {
        if (targetEntity.canAttackWithItem())
        {
            if (!targetEntity.hitByEntity(this))
            {
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    boolean flag = this.fallDistance > 0.0F && !this.onGround && !this.isOnLadder() && !this.isInWater() && !this.isPotionActive(MobEffects.blindness) && this.ridingEntity == null && targetEntity instanceof EntityLivingBase;
                    ...
                    double d0 = targetEntity.motionX * i;
                    double d1 = targetEntity.motionY * i;
                    double d2 = targetEntity.motionZ * i;
                    ...
                    if (flag2)
                    {
                        if (i > 0)
                        {
                        	targetEntity.addVelocity((double)(-MathHelper.sin(this.rotationYaw * (float)Math.PI / 180.0F) * (float)i), 0.1D, (double)(MathHelper.cos(this.rotationYaw * (float)Math.PI / 180.0F) * (float)i));
//                            if (this instanceof EntityPlayerSP) {
//                            }else {
...
//                            }
                        	if (Killaura.oldsprintattack.getObject()) {
                            	this.motionX *= 0.6D;
                            	this.motionZ *= 0.6D;
                        ...
                        {
//                        	((EntityPlayerMP)targetEntity).playerNetServerHandler.sendPacket(new S12PacketEntityVelocity(targetEntity.getEntityId(),targetEntity.motionX,targetEntity.motionY,targetEntity.motionZ));
