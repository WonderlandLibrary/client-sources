...
public class EntityZombie extends EntityMob
{
    ...
    protected void startConversion(int ticks)
    {
        ...
        this.removePotionEffect(MobEffects.weakness.id);
        this.addPotionEffect(new PotionEffect(MobEffects.damageBoost.id, ticks, Math.min(this.worldObj.getDifficulty().getDifficultyId() - 1, 0)));
    ...
    protected void convertToVillager()
    {
        ...
        entityvillager.addPotionEffect(new PotionEffect(MobEffects.confusion.id, 200, 0));
