...
public class EntitySpider extends EntityMob
{
    ...
    {
        return potioneffectIn.getPotionID() == MobEffects.poison.id ? false : super.isPotionApplicable(potioneffectIn);
    }
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata)
    {
        ...
        if (livingdata instanceof EntitySpider.GroupData)
        {
            ...
            if (i > 0 && MobEffects.potionTypes[i] != null)
            {
    ...
    public static class GroupData implements IEntityLivingData
    {
        ...
        public void func_111104_a(Random rand)
        {
            ...
            if (i <= 1)
            {
                this.potionEffectId = MobEffects.SPEED.id;
            }
            else if (i <= 2)
            {
                this.potionEffectId = MobEffects.damageBoost.id;
            }
            else if (i <= 3)
            {
                this.potionEffectId = MobEffects.regeneration.id;
            }
            else if (i <= 4)
            {
                this.potionEffectId = MobEffects.invisibility.id;
            }
        }
    }
}
