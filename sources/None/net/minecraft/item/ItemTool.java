    ...
    public float getStrVsBlock(ItemStack stack)
    {
    	...
    	if (stack.getItem() instanceof ItemTool) {
	    	if (stack.getItem() instanceof ItemAxe) {
	    		state = new Block(Blocks.log.getMaterial(), Blocks.log.getMaterial().getMaterialMapColor());
	    	}else if (stack.getItem() instanceof ItemPickaxe) {
	    		state = new Block(Blocks.stone.getMaterial(), Blocks.stone.getMaterial().getMaterialMapColor());
	    	}else if (stack.getItem() instanceof ItemSpade) {
	    		state = new Block(Blocks.dirt.getMaterial(), Blocks.dirt.getMaterial().getMaterialMapColor());
	    	}else {
	    		return 1.0F;
	    	}
    	}
