...
public class ItemPotion extends Item
{
    ...
    public boolean isEffectInstant(int meta)
    {
        ...
        if (list != null && !list.isEmpty())
        {
            for (PotionEffect potioneffect : list)
            {
                if (MobEffects.potionTypes[potioneffect.getPotionID()].isInstant())
                {
                    return true;
                }
            }
        ...
        if (stack.getMetadata() != 0)
        {
            ...
            if (list != null && !list.isEmpty())
            {
                for (PotionEffect potioneffect : list)
                {
                    ...
                    MobEffects potion = MobEffects.potionTypes[potioneffect.getPotionID()];
                    ...
                    {
                        s1 = s1 + " (" + MobEffects.getDurationString(potioneffect) + ")";
                    }
