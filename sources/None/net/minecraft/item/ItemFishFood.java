...
public class ItemFishFood extends ItemFood
{
    ...
    protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player)
    {
        ...
        {
            player.addPotionEffect(new PotionEffect(MobEffects.poison.id, 1200, 3));
            player.addPotionEffect(new PotionEffect(MobEffects.hunger.id, 300, 2));
            player.addPotionEffect(new PotionEffect(MobEffects.confusion.id, 300, 1));
        }
