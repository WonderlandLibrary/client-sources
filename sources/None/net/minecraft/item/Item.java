...
public class Item
{
    ...
    public static void registerItems()
    {
        ...
        registerItem(322, "golden_apple", (new ItemAppleGold(4, 1.2F, false)).setAlwaysEdible().setPotionEffect(MobEffects.regeneration.id, 5, 1, 1.0F).setUnlocalizedName("appleGold"));
        ...
        registerItem(365, "chicken", (new ItemFood(2, 0.3F, true)).setPotionEffect(MobEffects.hunger.id, 30, 0, 0.3F).setUnlocalizedName("chickenRaw"));
        registerItem(366, "cooked_chicken", (new ItemFood(6, 0.6F, true)).setUnlocalizedName("chickenCooked"));
        registerItem(367, "rotten_flesh", (new ItemFood(4, 0.1F, true)).setPotionEffect(MobEffects.hunger.id, 30, 0, 0.8F).setUnlocalizedName("rottenFlesh"));
        ...
        registerItem(375, "spider_eye", (new ItemFood(2, 0.8F, false)).setPotionEffect(MobEffects.poison.id, 5, 0, 1.0F).setUnlocalizedName("spiderEye").setPotionEffect(PotionHelper.spiderEyeEffect));
        ...
        registerItem(394, "poisonous_potato", (new ItemFood(2, 0.3F, false)).setPotionEffect(MobEffects.poison.id, 5, 0, 0.6F).setUnlocalizedName("potatoPoisonous"));
