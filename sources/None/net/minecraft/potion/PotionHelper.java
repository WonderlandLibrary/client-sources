...
public class PotionHelper
{
    ...
    public static int calcPotionLiquidColor(Collection p_77911_0_)
    {
        ...
        if (p_77911_0_ != null && !p_77911_0_.isEmpty())
        {
            ...
            for (Object potioneffect0 : p_77911_0_)
            {
                ...
                {
                    int j = MobEffects.potionTypes[potioneffect.getPotionID()].getLiquidColor();
    ...
    public static List getPotionEffects(int p_77917_0_, boolean p_77917_1_)
    {
        ...
        for (MobEffects potion : MobEffects.potionTypes)
        {
    ...
    static
    {
        potionRequirements.put(Integer.valueOf(MobEffects.regeneration.getId()), "0 & !1 & !2 & !3 & 0+6");
        potionRequirements.put(Integer.valueOf(MobEffects.SPEED.getId()), "!0 & 1 & !2 & !3 & 1+6");
        potionRequirements.put(Integer.valueOf(MobEffects.fireResistance.getId()), "0 & 1 & !2 & !3 & 0+6");
        potionRequirements.put(Integer.valueOf(MobEffects.heal.getId()), "0 & !1 & 2 & !3");
        potionRequirements.put(Integer.valueOf(MobEffects.poison.getId()), "!0 & !1 & 2 & !3 & 2+6");
        potionRequirements.put(Integer.valueOf(MobEffects.weakness.getId()), "!0 & !1 & !2 & 3 & 3+6");
        potionRequirements.put(Integer.valueOf(MobEffects.harm.getId()), "!0 & !1 & 2 & 3");
        potionRequirements.put(Integer.valueOf(MobEffects.moveSlowdown.getId()), "!0 & 1 & !2 & 3 & 3+6");
        potionRequirements.put(Integer.valueOf(MobEffects.damageBoost.getId()), "0 & !1 & !2 & 3 & 3+6");
        potionRequirements.put(Integer.valueOf(MobEffects.nightVision.getId()), "!0 & 1 & 2 & !3 & 2+6");
        potionRequirements.put(Integer.valueOf(MobEffects.invisibility.getId()), "!0 & 1 & 2 & 3 & 2+6");
        potionRequirements.put(Integer.valueOf(MobEffects.waterBreathing.getId()), "0 & !1 & 2 & 3 & 2+6");
        potionRequirements.put(Integer.valueOf(MobEffects.jump.getId()), "0 & 1 & !2 & 3 & 3+6");
        potionAmplifiers.put(Integer.valueOf(MobEffects.SPEED.getId()), "5");
        potionAmplifiers.put(Integer.valueOf(MobEffects.digSpeed.getId()), "5");
        potionAmplifiers.put(Integer.valueOf(MobEffects.damageBoost.getId()), "5");
        potionAmplifiers.put(Integer.valueOf(MobEffects.regeneration.getId()), "5");
        potionAmplifiers.put(Integer.valueOf(MobEffects.harm.getId()), "5");
        potionAmplifiers.put(Integer.valueOf(MobEffects.heal.getId()), "5");
        potionAmplifiers.put(Integer.valueOf(MobEffects.resistance.getId()), "5");
        potionAmplifiers.put(Integer.valueOf(MobEffects.poison.getId()), "5");
        potionAmplifiers.put(Integer.valueOf(MobEffects.jump.getId()), "5");
    }
}
