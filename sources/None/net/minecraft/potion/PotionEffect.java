...
public class PotionEffect
{
    ...
    public MobEffects getPotion() {
    	return MobEffects.getPotionbyId(potionID);
    }
    ...
    public boolean onUpdate(EntityLivingBase entityIn)
    {
        if (this.duration > 0)
        {
            if (MobEffects.potionTypes[this.potionID].isReady(this.duration, this.amplifier))
            {
    ...
    public void performEffect(EntityLivingBase entityIn)
    {
        if (this.duration > 0)
        {
            MobEffects.potionTypes[this.potionID].performEffect(entityIn, this.amplifier);
        }
    }

    public String getEffectName()
    {
        return MobEffects.potionTypes[this.potionID].getName();
    }
    ...
    public String toString()
    {
        ...
        return MobEffects.potionTypes[this.potionID].isUsable() ? "(" + s + ")" : s;
    }
