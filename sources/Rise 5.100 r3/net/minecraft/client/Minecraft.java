...
import dev.rise.antipiracy.KillSwitch;
...
import dev.rise.protection.ProtectedLaunch;
import dev.rise.ui.auth.AuthGUI;
import dev.rise.ui.ingame.IngameGUI;
import dev.rise.ui.mainmenu.MainMenu;
import dev.rise.ui.mainmenu.MainMenuMusic;
import dev.rise.ui.splash.SplashScreen;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    public MainMenuMusic riseMusicTicker;
    ...
    private void startGame() throws LWJGLException {
        ...
        riseMusicTicker = new MainMenuMusic();
        this.mcMusicTicker = new MusicTicker(this);
        SplashScreen.setProgress(3, "FontRenderer");
        ...
        SplashScreen.setProgress(8, "ModelManager");
        this.modelManager = new ModelManager(this.textureMapBlocks);
        this.mcResourceManager.registerReloadListener(this.modelManager);
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager);
        SplashScreen.setProgress(9, "RenderEngine");
        ...
        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(new AuthGUI(), this, this.serverName, this.serverPort));
        } else {
        ...
        SplashScreen.setProgress(13, "Rise");
        ...
        SplashScreen.setProgress(14, "Outline Shader");
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Rise.CLIENT_NAME + " " + Rise.CLIENT_VERSION);
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("rise/icon/icon16.png"));
                inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("rise/icon/icon32.png"));
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException {
        ...
        worldrenderer.pos(0.0D, (double) this.displayHeight, 0.0D).func_181673_a(0.0D, 0.0D).color(255, 255, 255, 255).endVertex();
        worldrenderer.pos((double) this.displayWidth, (double) this.displayHeight, 0.0D).func_181673_a(0.0D, 0.0D).color(255, 255, 255, 255).endVertex();
        worldrenderer.pos((double) this.displayWidth, 0.0D, 0.0D).func_181673_a(0.0D, 0.0D).color(255, 255, 255, 255).endVertex();
    ...
    public void func_181536_a(int p_181536_1_, int p_181536_2_, int p_181536_3_, int p_181536_4_, int p_181536_5_, int p_181536_6_, int p_181536_7_, int p_181536_8_, int p_181536_9_, int p_181536_10_) {
        ...
        worldrenderer.begin(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.pos((double) p_181536_1_, (double) (p_181536_2_ + p_181536_6_), 0.0D).func_181673_a((double) ((float) p_181536_3_ * f), (double) ((float) (p_181536_4_ + p_181536_6_) * f1)).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
        worldrenderer.pos((double) (p_181536_1_ + p_181536_5_), (double) (p_181536_2_ + p_181536_6_), 0.0D).func_181673_a((double) ((float) (p_181536_3_ + p_181536_5_) * f), (double) ((float) (p_181536_4_ + p_181536_6_) * f1)).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
        worldrenderer.pos((double) (p_181536_1_ + p_181536_5_), (double) p_181536_2_, 0.0D).func_181673_a((double) ((float) (p_181536_3_ + p_181536_5_) * f), (double) ((float) p_181536_4_ * f1)).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
        worldrenderer.pos((double) p_181536_1_, (double) p_181536_2_, 0.0D).func_181673_a((double) ((float) p_181536_3_ * f), (double) ((float) p_181536_4_ * f1)).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
...
//        this.guiAchievement.updateAchievementWindow();
    ...
    public void setIngameFocus() {
        if (Display.isActive()) {
            if (!this.inGameHasFocus && this.mouseHelper != null) {
    ...
    public void runTick() throws IOException {
        try {
                ...
                while (Keyboard.next()) {
                    ...
                    if (Keyboard.getEventKeyState()) {
                        ...
                        if (this.currentScreen != null) {
                            ...
                            try {
                                IngameGUI.key = IngameGUI.lastKey = Keyboard.getKeyName(k);
            ...
            this.displayGuiScreen(new GuiDisconnected(new MainMenu(), "connect.failed", new ChatComponentTranslation("disconnect.genericReason", "")));
