...
import digital.bq.utility.tweaker.ScreenShotHook;
...
public class ScreenShotHelper {
	...
	public static IChatComponent saveScreenshot(File gameDirectory, String screenshotName, int width, int height,
		...
		if (Lycoris.asyncScreenshot.getValue()) {
			return ScreenShotHook.handleScreenshot(gameDirectory, screenshotName, width, height, buffer);
		}
