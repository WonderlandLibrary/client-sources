...
public abstract class World implements IBlockAccess {
	...
	/**
	 * Warning this value may not be respected in all cases as it is still hardcoded
	 * in many places.
	 */
	...
	public boolean isRainingAt(BlockPos strikePosition) {
		if (!this.isRaining()) {
			...
			return biomegenbase.getEnableSnow() ? false
					: (this.canSnowAt(strikePosition, false) ? false : biomegenbase.canRain());
		}
	}
	...
	public double getHorizon() {
		if (Lycoris.voidFlickFix.getValueState()) {
			return 0.0d;
		} else {
