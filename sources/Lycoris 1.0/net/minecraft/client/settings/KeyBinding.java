...
public class KeyBinding implements Comparable<KeyBinding>
{
    ...
    public static void unPressAllKeys()
    {
        ...
        {
            if (ModuleManager.invMoveMod.isEnabled() && Minecraft.getMinecraft().currentScreen instanceof GuiInventory) {
                GameSettings gameSettings = Minecraft.getMinecraft().gameSettings;
                int keyCode = keybinding.getKeyCode();
                if (keyCode == gameSettings.keyBindForward.keyCode || keyCode == gameSettings.keyBindRight.keyCode || keyCode == gameSettings.keyBindLeft.keyCode || keyCode == gameSettings.keyBindBack.keyCode)
                    continue;
            }
