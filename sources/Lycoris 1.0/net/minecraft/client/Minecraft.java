...
import digital.bq.event.KeyPressEvent;
import digital.bq.event.LoopEvent;
import digital.bq.event.MiddleClickEvent;
import digital.bq.event.TickEvent;
import digital.bq.gui.hud.HudRenderer;
import digital.bq.gui.loginui.GuiLogin;
import digital.bq.irc.IRCClient;
import digital.bq.module.CommandManager;
import digital.bq.module.Module;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
	...
	public IMetadataSerializer metadataSerializer_ = new IMetadataSerializer();
				...
				while (this.running) {
					if (!this.hasCrashed || this.crashReporter == null) {
						try {
							...
							if (!Lycoris.memFix.getValueState()) System.gc();
						}
					} else {
	...
	private void startGame() throws Exception {
		...
		//Client
		Lycoris.font = new FontRenderer(this.gameSettings, new ResourceLocation("flux/bit.png"), this.renderEngine, false);
		...
		//Client
		this.mcResourceManager.registerReloadListener(Lycoris.font);
		...
		// 还是恢复正常逻辑吧
		// Lycoris.INSTANCE.start();
		this.ingameGUI = new HudRenderer(Minecraft.getMinecraft());
		Display.setTitle(Lycoris.NAME + " b" + Lycoris.VERSION + " - " + (IRCClient.isChina ? "China" : "Global"));
	...
	private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException {
		...
		Framebuffer framebuffer = new Framebuffer((int) (scaledresolution.getScaledWidth() * i),
				(int) (scaledresolution.getScaledHeight() * i), true);
	...
	public void displayGuiScreen(GuiScreen guiScreenIn) {
		if((IRCClient.reconnectFailed || IRCClient.loggedPacket == null) && !(guiScreenIn instanceof GuiLogin)) {
			return;
		}
	...
	public void runTick() throws IOException {
		...
		if (this.currentScreen == null || this.currentScreen.allowUserInput) {
				...
				if (Keyboard.getEventKeyState()) {
					...
					if (this.currentScreen != null) {
						...
						if (!Keyboard.isKeyDown(61)) {
							...
							((HudRenderer) Minecraft.getMinecraft().ingameGUI).tabGuiRenderer.keyPress(k);
						}
			...
			if (this.currentScreen == null && Keyboard.isKeyDown(52) && flag) {
				this.displayGuiScreen(new GuiChat(CommandManager.PREFIX));
			}

			if (ModuleManager.ircMod.isEnabled() && this.currentScreen == null && Keyboard.isKeyDown(40) && flag) {
				this.displayGuiScreen(new GuiChat("'"));
			}
		...
		if (i != 0 && !Keyboard.isRepeatEvent()) {
			if (!(this.currentScreen instanceof GuiControls)
				...
				if (Keyboard.getEventKeyState()) {
					...
					EventManager.call(new KeyPressEvent(i));
