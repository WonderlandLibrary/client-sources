...
import digital.bq.event.WorldInitEvent;
...
public class WorldClient extends World
{
    ...
    public WorldClient(NetHandlerPlayClient netHandler, WorldSettings settings, int dimension, EnumDifficulty difficulty, Profiler profilerIn)
    {
        ...
        EventManager.call(new WorldInitEvent());
    }
    ...
    {
        if (ModuleManager.lightningLocatorMod.isEnabled() && soundName.equals("ambient.weather.thunder")) {
            PlayerUtils.tellPlayer(String.format("Found Lightning: X:%d Y:%d Z:%d", (int)x, (int)y, (int)z));
        }
