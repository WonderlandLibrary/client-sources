...
public class PlayerControllerMP {
	...
	public static void clickBlockCreative(Minecraft mcIn, PlayerControllerMP playerController, BlockPos pos,
			EnumFacing facing) {
	...
	public float getBlockReachDistance() {
		// Client: Reach
		return ModuleManager.reachMod.isEnabled() && Reach.block.getValue() ? 5.0f
	 ...
	 */
	public boolean isPlayerRightClickingOnEntity(EntityPlayer player, Entity entityIn,
			MovingObjectPosition movingObject) {
		this.syncCurrentPlayItem();
		Vec3 vec3 = new Vec3(movingObject.hitVec.xCoord - entityIn.posX, movingObject.hitVec.yCoord - entityIn.posY,
				movingObject.hitVec.zCoord - entityIn.posZ);
