...
import digital.bq.event.RespawnEvent;
import digital.bq.event.ServerJoinEvent;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        ...
        EventManager.call(new ServerJoinEvent(Lycoris.INSTANCE.lastServer != null ? Lycoris.INSTANCE.lastServer.serverIP : null));
    }
    ...
    public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
        ...
        if (packetIn.getType() == 10) {
            entity = EntityMinecart.getMinecart(this.clientWorldController, d0, d1, d2,
    ...
    public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn) {
        ...
        entityotherplayermp = new EntityOtherPlayerMP(this.gameController.theWorld,
    ...
    public void onDisconnect(IChatComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            this.gameController.displayGuiScreen(
                    new GuiDisconnected(this.guiScreenServer, "disconnect.lost", reason));
        } else {
            this.gameController.displayGuiScreen(
