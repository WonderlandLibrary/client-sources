...
import digital.bq.module.implement.Render.ChestESP;
...
public class TileEntityEnderChestRenderer extends TileEntitySpecialRenderer<TileEntityEnderChest>
{
    ...
    public void renderTileEntityAt(TileEntityEnderChest te, double x, double y, double z, float partialTicks, int destroyStage)
    {
      ...
      //START: Outlined Storage ESP
        boolean doOutline = ModuleManager.chestESPMod.isEnabled() && ChestESP.EnderChest.getValue();
        ...
        if(doOutline && te.hasWorldObj()) {
            ...
            WorldRenderUtils.renderFour(ChestESP.chestESPColours.getColorInt());
            field_147521_c.renderAll();
