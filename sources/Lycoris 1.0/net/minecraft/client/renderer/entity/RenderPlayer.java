...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer> {
    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw,
        ...
        if (!entity.isUser() || this.renderManager.livingPlayer == entity) {
            ...
            if (!(ModuleManager.noRenderMod.isEnabled() && ModuleManager.noRenderMod.players.getValueState() && entity instanceof EntityPlayer && entity != Minecraft.getMinecraft().thePlayer)) {
