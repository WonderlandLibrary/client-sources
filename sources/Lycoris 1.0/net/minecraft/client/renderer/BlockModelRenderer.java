...
import digital.bq.event.EventRenderBlock;
...
public class BlockModelRenderer
{
    ...
    {
        boolean flag = Minecraft.isAmbientOcclusionEnabled() && blockStateIn.getBlock().getLightValue() == 0 && modelIn.isAmbientOcclusion() || ModuleManager.xRayMod.isEnabled();
        ...
        for (EnumFacing enumfacing : EnumFacing.VALUES)
        {
            ...
            if (!list.isEmpty())
            {
                ...
                if (!p_renderModelSmooth_6_ || block.shouldSideBeRendered(p_renderModelSmooth_1_, blockpos, enumfacing))
                {
                    ...
                    // Client
                    EventRenderBlock event = new EventRenderBlock(p_renderModelSmooth_3_.getBlock(), p_renderModelSmooth_4_);
        ...
        for (EnumFacing enumfacing : EnumFacing.VALUES)
        {
            ...
            if (!list.isEmpty())
            {
                ...
                if (!p_renderModelFlat_6_ || block.shouldSideBeRendered(p_renderModelFlat_1_, blockpos, enumfacing))
                {
                    ...
                    // Client
                    EventRenderBlock event = new EventRenderBlock(p_renderModelFlat_3_.getBlock(), p_renderModelFlat_4_);
                    EventManager.call(event);
