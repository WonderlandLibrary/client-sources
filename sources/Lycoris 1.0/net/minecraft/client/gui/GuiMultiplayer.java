...
import digital.bq.utility.viaversion.ViaVersion;
import digital.bq.utility.viaversion.gui.GuiProtocolSelector;
import digital.bq.utility.viaversion.protocols.ProtocolCollection;
...
import digital.bq.gui.other.GuiProxy;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        if (!this.initialized) {
            ...
            //Client
            this.serverListSelector.doCustom = true;
        } else {
    ...
    public void createButtons() {
        ...
        this.buttonList.add(this.btnDeleteServer = new GuiButton(2, this.width / 2 - 76, this.height - 28, 70, 20, I18n.format("selectServer.delete", new Object[0])));
        ...
        this.buttonList.add(new GuiButton(8, this.width / 2 + 2, this.height - 28, 70, 20, I18n.format("selectServer.refresh", new Object[0])));
        this.buttonList.add(new GuiButton(0, this.width / 2 + 4 + 76, this.height - 28, 74, 20, I18n.format("gui.cancel", new Object[0])));
        this.buttonList.add(new GuiButton(1338, 95 + 40, 6, 75, 20, "Proxy"));
        // ViaVersion
        buttonList.add(new GuiButton(6666, 10, 6, 75 + 40, 20, "Version: " +  ProtocolCollection.getProtocolById(ViaVersion.getInstance().getVersion()).getName()));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontManager.roboto15.drawString("Hypixel Unofficial IP Detection Bypass", this.width - 132, 12, ColorUtils.WHITE.c);

        RenderUtil.drawRect(this.width - 145, 11.5f, this.width - 135, 21.5f, ColorUtils.GREY.c);
        if(Lycoris.INSTANCE.directConnectToHypixel) {
            RenderUtil.drawRect(this.width - 144, 12.5f, this.width - 136, 20.5f, ColorUtils.AQUA.c);
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        if(RenderUtil.isHovering(mouseX, mouseY, this.width - 145, 11.5f, this.width - 135, 21.5f) && mouseButton == 0) {
            Lycoris.INSTANCE.directConnectToHypixel = !Lycoris.INSTANCE.directConnectToHypixel;
        }
