...
import digital.bq.Lycoris;
import digital.bq.event.DrawTextEvent;
import digital.bq.event.OldUIRenderEvent;
import digital.bq.event.UIRenderEvent;
import digital.bq.event.UIRenderPostEvent;
import digital.bq.gui.fontRenderer.FontManager;
import digital.bq.gui.fontRenderer.FontUtils;
import digital.bq.gui.clickgui.classic.RenderUtil;
import digital.bq.module.implement.Render.Hud;
import digital.bq.module.implement.Render.HudWindowMod;
import digital.bq.utility.ColorUtils;
import digital.bq.utility.ServerUtils;
...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        // Client
        OldUIRenderEvent oldevent = new OldUIRenderEvent(partialTicks);
        EventManager.call(oldevent);
        ...
        // Client
        UIRenderEvent event = new UIRenderEvent(partialTicks);
        ...
        if (this.recordPlayingUpFor > 0) {
            ...
            if (l1 > 8) {
                ...
                Minecraft.getMinecraft().fontRendererObj.drawString(this.recordPlaying,
                        -Minecraft.getMinecraft().fontRendererObj.getStringWidth(this.recordPlaying) / 2, -4, l + (l1 << 24 & -16777216));
                GlStateManager.disableBlend();
        ...
        if (this.titlesTimer > 0) {
            ...
            if (i2 > 8) {
                ...
                mc.fontRendererObj.drawStringWithShadow(this.displayedTitle, (float) (-mc.fontRendererObj.getStringWidth(this.displayedTitle) / 2), -10.0F,
                        16777215 | j2);
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                GlStateManager.scale(2.0F, 2.0F, 2.0F);
                mc.fontRendererObj.drawStringWithShadow(this.displayedSubTitle, (float) (-mc.fontRendererObj.getStringWidth(this.displayedSubTitle) / 2), 5.0F,
                        16777215 | j2);
                GlStateManager.popMatrix();
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
        ...
        if (scoreobjective1 != null) {
            if (!HudWindowMod.scoreboard.getValueState())
        ...
        if ((!this.mc.isIntegratedServerRunning() || this.mc.thePlayer.sendQueue.getPlayerInfoMap().size() > 1 || scoreobjective1 != null)) {
            ...
            } else if(!this.overlayPlayerList.isBeingRendered && !this.overlayPlayerList.animationDone) {
                this.overlayPlayerList.renderPlayerlist(i, scoreboard, scoreobjective1);
            }
        }
        ...
        // Client
        UIRenderPostEvent postEvent = new UIRenderPostEvent(partialTicks);
        EventManager.call(postEvent);
        GL11.glColor4f(1, 1, 1, 1);

        // Testing
        if (mc.currentScreen == null && !Lycoris.BETA.isEmpty()) {
            FontManager.wqy18.drawCenteredStringWithAlpha(Lycoris.BETA, scaledresolution.getScaledWidth() / 2, 18, -1, 0.5f);
        }
    }
    ...
    public void renderExpBar(ScaledResolution scaledRes, int x) {
        ...
        if (this.mc.thePlayer.experienceLevel > 0) {
            ...
            float l1 = (scaledRes.getScaledWidth() - Minecraft.getMinecraft().fontRendererObj.getStringWidth(s)) / 2;
            int i1 = scaledRes.getScaledHeight() - 31 - 4;
            int j1 = 0;
            Minecraft.getMinecraft().fontRendererObj.drawString(s, l1 + 1, i1, ColorUtils.BLACK.c);
            Minecraft.getMinecraft().fontRendererObj.drawString(s, l1 - 1, i1, ColorUtils.BLACK.c);
            Minecraft.getMinecraft().fontRendererObj.drawString(s, l1, i1 + 1, ColorUtils.BLACK.c);
            Minecraft.getMinecraft().fontRendererObj.drawString(s, l1, i1 - 1, ColorUtils.BLACK.c);
            Minecraft.getMinecraft().fontRendererObj.drawString(s, l1, i1, RenderUtil.reAlpha(k1, 1f));
            this.mc.mcProfiler.endSection();
        }
    }
    ...
    public void renderSelectedItem(ScaledResolution scaledRes) {
        ...
        if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null) {
            ...
            float i = (scaledRes.getScaledWidth() - Minecraft.getMinecraft().fontRendererObj.getStringWidth(s)) / 2;
            int j = scaledRes.getScaledHeight() - 85;
            ...
            if (k > 0) {
                ...
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s, (float) i, (float) j, 16777215 + (k << 24));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
        }
    ...
    public void renderDemo(ScaledResolution scaledRes) {
        ...
        float i = Minecraft.getMinecraft().fontRendererObj.getStringWidth(s);
        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s, (float) (scaledRes.getScaledWidth() - i - 10), 5.0F, 16777215);
        this.mc.mcProfiler.endSection();
    }
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes) {
        ...
        float i = Minecraft.getMinecraft().fontRendererObj.getStringWidth(objective.getDisplayName());
        ...
        float j1 = arraylist1.size() * Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT;
        float k1 = scaledRes.getScaledHeight() / 2 + j1 / 3;
        byte b0 = 3;
        float j = scaledRes.getScaledWidth() - i - b0;
        int k = 0;
        ...
        for (Object b : arraylist1) {
            ...
            float l = k1 - k * Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT + new ScaledResolution(mc).getScaledHeight() / 4f;
            int i1 = scaledRes.getScaledWidth() - b0 + 2;
            GuiNewChat.drawRect(j - 2, l, i1, l + Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT, new Color(0,0,0,100).getRGB());

            // Client: NameProtect
            DrawTextEvent event = new DrawTextEvent(s1);
            EventManager.call(event);
            s1 = event.text;
            ...
            Minecraft.getMinecraft().fontRendererObj.drawString(s1, j, l, ColorUtils.WHITE.c);

            // Client: NameProtect
            DrawTextEvent event1 = new DrawTextEvent(s2);
            EventManager.call(event1);
            s2 = event1.text;
            Minecraft.getMinecraft().fontRendererObj.drawString(s2, i1 - Minecraft.getMinecraft().fontRendererObj.getStringWidth(s2), l, -1);

            if (k == arraylist1.size()) {
                String s3 = objective.getDisplayName();
                GuiNewChat.drawRect(j - 2, l - Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT - 4, i1, l - 1, new Color(0,0,0,100).getRGB());
                GuiNewChat.drawRect(j - 2, l - 1, i1, l, new Color(0,0,0,100).getRGB());

                // Client: NameProtect
                DrawTextEvent event2 = new DrawTextEvent(s3);
                EventManager.call(event2);
                s3 = event2.text;

                Minecraft.getMinecraft().fontRendererObj.drawString(s3, j + (i / 2) - Minecraft.getMinecraft().fontRendererObj.getStringWidth(s3) / 2f, l - Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT - 1f, -1);
            }
        }
    }
    ...
    private void renderBossHealth() {
        if (BossStatus.bossName != null && BossStatus.statusBarTime > 0) {
            ...
            FontManager.wqy18.drawStringWithSuperShadow(s, (float) (i / 2 - FontManager.wqy18.getStringWidth(s) / 2), (float) (i1 - 11), ColorUtils.WHITE.c);
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            this.mc.getTextureManager().bindTexture(icons);
        }
    }
    ...
    public FontUtils getFontRenderer() {
        return FontManager.wqy18;
    }
