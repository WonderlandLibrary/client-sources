...
public class GuiUtilRenderComponents {
    ...
    public static List<IChatComponent> splitText(IChatComponent p_178908_0_, int p_178908_1_, FontRenderer p_178908_2_, boolean p_178908_3_, boolean p_178908_4_) {
        ...
        for (int j = 0; j < ((List) list1).size(); ++j) {
            ...
            float i1 = FontManager.wqy18.getStringWidth(s5);
            ...
            if (i + i1 > p_178908_1_) {
                String s2 = FontManager.wqy18.trimStringToWidth(s4, p_178908_1_ - i, false);
                String s3 = s2.length() < s4.length() ? s4.substring(s2.length()) : null;

                if (s3 != null && s3.length() > 0) {
                    int l = s2.lastIndexOf(" ");

                    if (l >= 0 && FontManager.wqy18.getStringWidth(s4.substring(0, l)) > 0) {
                        s2 = s4.substring(0, l);
                ...
                i1 = FontManager.wqy18.getStringWidth(s2);
