...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
    ...
    protected FontUtils unicodeFont = FontManager.wqy18;
    ...
    //Client
    public boolean disableCustomBG = false;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        // Testing
        FontManager.wqy18.drawCenteredStringWithAlpha(Lycoris.BETA, width / 2, 18, -1, 0.5f);
    }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        if (keyCode == 1 && !(this instanceof GuiLogin)) {
