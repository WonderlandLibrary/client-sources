...
public class GuiChat extends GuiScreen {
	...
	public void updateScreen() {
		Lycoris.INSTANCE.getHudWindowMgr().updateScreen();
		this.inputField.updateCursorCounter();
	}

	@Override
	protected void mouseClickMove(int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick) {
		Lycoris.INSTANCE.getHudWindowMgr().mouseClickMove(mouseX, mouseY, clickedMouseButton, timeSinceLastClick);
	...
	public void handleMouseInput() throws IOException {
		...
		Lycoris.INSTANCE.getHudWindowMgr().handleMouseInput(this.width, this.height);
	}
	...
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
		Lycoris.INSTANCE.getHudWindowMgr().mouseClick(mouseX, mouseY, mouseButton);
		if (mouseButton == 0) {
	...
	protected void mouseReleased(int mouseX, int mouseY, int state) {
		Lycoris.INSTANCE.getHudWindowMgr().mouseRelease(mouseX, mouseY, state);
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		Lycoris.INSTANCE.getHudWindowMgr().mouseCoordinateUpdate(mouseX, mouseY);
