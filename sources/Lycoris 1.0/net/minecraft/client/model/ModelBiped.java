...
public class ModelBiped extends ModelBase
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if (entityIn == Minecraft.getMinecraft().thePlayer && ((Lycoris.everythingBlock.getValueState() && Minecraft.getMinecraft().gameSettings.keyBindUseItem.pressed)
                || (KillAura.isRenderBlocked() && Minecraft.getMinecraft().thePlayer.getHeldItem() != null
