...
public class FriendManager {
	...
	public static boolean isTeam(EntityPlayer entity) {
		return WorldRenderUtils.getTeamColor(entity) == WorldRenderUtils
				...
				|| (Lycoris.INSTANCE.getFriendManager().isFriend(entity.getName()) && Lycoris.friends.getValueState());
	}
	...
	public static boolean isMobTeam(EntityMob entity) {
		...
		return (Lycoris.INSTANCE.mobfriends.getValueState() && mobpre.equals(playerpre));
	}
}
