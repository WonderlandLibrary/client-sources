...
public class EntityUtils {
    ...
    public static boolean isValid(final EntityLivingBase entity) {
        return entity != null && entity != mc.thePlayer && entity.getDistanceToEntity(mc.thePlayer) <= 10000 && entity.isEntityAlive() && (!entity.isInvisible() || entity.getTotalArmorValue() != 0) && !Lycoris.INSTANCE.getFriendManager().isFriend(entity.getName());
    }
