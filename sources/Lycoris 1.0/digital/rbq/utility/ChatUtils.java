...
public class ChatUtils {
    ...
    public static void sendMessageToPlayer(String msg) {
        mc.thePlayer.addChatMessage(new ChatComponentText(EnumChatFormatting.GRAY + "[" + EnumChatFormatting.WHITE + Lycoris.NAME + EnumChatFormatting.GRAY + "]: " + EnumChatFormatting.GRAY + msg));
    }
