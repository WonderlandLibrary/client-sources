...
public class PlayerUtils {
    ...
    public static void tellPlayer(String string) {
        if (string != null && mc.thePlayer != null)
            mc.thePlayer.addChatMessage(new ChatComponentText(EnumChatFormatting.GRAY + "[" + EnumChatFormatting.WHITE + Lycoris.NAME + EnumChatFormatting.GRAY + "]: " + EnumChatFormatting.GRAY + string));
    }
    ...
    public static void disconnectServer(String customMessage) {
        mc.thePlayer.sendQueue.getNetworkManager().closeChannel(new ChatComponentText(EnumChatFormatting.DARK_PURPLE + "[Lycoris] " + EnumChatFormatting.GRAY + customMessage));
    }
}
