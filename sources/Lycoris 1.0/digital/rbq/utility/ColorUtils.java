...
public enum ColorUtils {
    ...
    public static int fadeBetween(int startColour, int endColour, long offset) {
        return fadeBetween(startColour, endColour, ((System.currentTimeMillis() + offset) % (Hud.fadeSpeed.isCurrentMode("Fast") ? 1000L : 2000L)) / (Hud.fadeSpeed.isCurrentMode("Fast") ? 500.0 : 1000.0));
    }
