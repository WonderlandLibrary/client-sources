...
public class HypixelDisabled extends SubModule {
    ...
    public void onMove(MoveEvent e) {
        ...
        if (MoveUtils.isMoving()) {
            if ((mc.gameSettings.keyBindBack.pressed || mc.gameSettings.keyBindRight.pressed || mc.gameSettings.keyBindLeft.pressed) && Math.abs(digital.rbq.module.implement.Misc.disabler.Hypixel.yawDiff) > 15) {
                slowdown.reset();
            } else {
