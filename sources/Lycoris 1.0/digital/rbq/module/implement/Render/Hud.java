...
public class Hud extends Module {
    ...
    public static String name = "Lycoris";
    ...
    public static ModeValue waterMarkMode = new ModeValue("HUD", "Watermark Mode", "Text", "Text", "Onetap", "Icon", "Lycoris Sense", "None");
    ...
    public void onTicks(TickEvent e) {
        ...
        isLightMode = Lycoris.INSTANCE.GTheme.isCurrentMode("Light");
    }
}