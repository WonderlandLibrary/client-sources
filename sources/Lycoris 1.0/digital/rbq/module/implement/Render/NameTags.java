...
import digital.rbq.event.DrawTextEvent;
import digital.rbq.event.NameTagRenderEvent;
...
import digital.rbq.module.implement.Combat.AntiBots;
import digital.rbq.module.implement.World.HackerDetector;
import digital.rbq.utility.MathUtils;
import digital.rbq.utility.WorldRenderUtils;
import digital.rbq.utility.WorldUtil;
...
public class NameTags extends Module {
    ...
    private String getDisplayName(EntityLivingBase entity) {
        ...
        if (Lycoris.INSTANCE.getFriendManager().isFriend(entity.getName())) {
