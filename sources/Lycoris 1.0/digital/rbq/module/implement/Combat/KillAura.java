...
import digital.rbq.irc.IRCUser;
import digital.rbq.module.Category;
import digital.rbq.module.Module;
import digital.rbq.module.ModuleManager;
import digital.rbq.module.implement.Combat.killaura.AAC;
import digital.rbq.module.implement.Combat.killaura.NCP;
...
public class KillAura extends Module {
    ...
    public static ModeValue targetHUDMode = new ModeValue("KillAura", "TargetHUD Mode", "Lycoris", "Lycoris", "Lycoris (Old)", "Astolfo", "Innominate");
            ...
            for (Entity base : mc.theWorld.loadedEntityList) {
                if (base instanceof EntityPlayer) {
                    ...
                    if (targets.contains(base)) {
                        ...
                        int size = 33;
                        if (targetHUDMode.isCurrentMode("Lycoris (Old)")) {
                            size = 43;
    ...
    public static boolean isValid(EntityLivingBase entity, double maxRange) {
        ...
        // Team check
        if (entity instanceof EntityPlayer && FriendManager.isTeam((EntityPlayer) entity) && Lycoris.teams.getValue())
            return false;

        // Friend check
        if (entity instanceof EntityPlayer && Lycoris.INSTANCE.getFriendManager().isFriend(entity.getName()) && Lycoris.friends.getValueState())
            return false;
    ...
    public class TargetHUD {
        ...
        public void render(float x, float y) {
            ...
            if (targetHUDMode.isCurrentMode("Lycoris")) {
                ...
                GL11.glPopMatrix();
            } else if (targetHUDMode.isCurrentMode("Lycoris (Old)")) {
                GL11.glTranslatef(x, y, 0);
