...
import digital.rbq.module.implement.Command.*;
import digital.rbq.utility.ChatUtils;
import digital.rbq.utility.NumberUtils;
...
public class CommandManager {
    ...
    public void onChatSend(ChatSendEvent event) {
        try {
        	if (Lycoris.noCommand.getValueState()) return;
    ...
    public List<Command> getCommands() {
        ...
        commands.addAll(LycorisAPI.FLUX_API.getCommandManager().getAddonCommands());
        return commands;
    }
}
