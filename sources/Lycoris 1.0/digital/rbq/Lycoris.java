...
import digital.rbq.config.Cloud;
...
import digital.rbq.gui.clickgui.skeet.EventChangeValue;
import digital.rbq.gui.clickgui.skeet.SkeetClickGUI;
import digital.rbq.gui.hud.window.HudWindow;
import digital.rbq.gui.hud.window.HudWindowManager;
import digital.rbq.irc.IRCClient;
import digital.rbq.module.CommandManager;
...
import digital.rbq.module.implement.Render.HudWindowMod;
...
import digital.rbq.utility.shader.shaders.ShaderBlob;
...
public class Lycoris {
    ...
    public static final Lycoris INSTANCE = new Lycoris();

    public static final String NAME = "Lycoris";
    public static final float VERSION = 39.11F;
    public static final String CREDIT = "Lycoris is developed by The Flower Team";
    ...
    @Getter
    public LycorisAPI api;
    @Getter
    @Setter
    private ClickGUI clickGUI;
    @Getter
    @Setter
    private digital.rbq.gui.crink.NewClickGUI newClickGUI;
    @Getter
    @Setter
    ...
    public void start() {
        ...
        Lycoris.avatarLocation = new Base64ImageLocation(IRCClient.loggedPacket.getAvatarBase64());
