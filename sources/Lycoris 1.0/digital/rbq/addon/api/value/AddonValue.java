...
import digital.rbq.addon.api.exception.NoSuchValueException;
import digital.rbq.addon.api.exception.WrongValueTypeException;
...
public class AddonValue {
    ...
    public AddonValue(String moduleName, String valueName, Boolean defaultStage) {
        ...
        LycorisAPI.FLUX_API.getValueManager().registerValue(this);
    }
