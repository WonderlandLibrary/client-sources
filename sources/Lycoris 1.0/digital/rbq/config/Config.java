...
public class Config {
	public static final String ROOT_DIR = "Lycoris";
		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					Lycoris.INSTANCE.moduleManager = new ModuleManager();
	...
	public void saveConfig() {
		try {
			...
			friends.addAll(Lycoris.INSTANCE.getFriendManager().getFriends());
	...
	public void loadConfig() {
		try {
			...
			if (config.containsKey("Friends")) {
				...
				Lycoris.INSTANCE.getFriendManager().getFriends().addAll(friends.toJavaList(String.class));
			}
