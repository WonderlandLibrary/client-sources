...
public class CustomEmailField extends Gui {
    ...
    public void drawTextBox() {
        if (getVisible()) {
            if (getEnableBackgroundDrawing()) {
                GuiRenderUtils.drawRoundedRect(xPosition, yPosition, width, height, 2, 0xff455b6b, 1f, 0xff455b6b);
            }
    ...
    private void drawCursorVertical(int p_146188_1_, int p_146188_2_,
        ...
        var6.pos(p_146188_1_, p_146188_4_, 0.0D);
        var6.pos(p_146188_3_, p_146188_4_, 0.0D);
        var6.pos(p_146188_3_, p_146188_2_, 0.0D);
        var6.pos(p_146188_1_, p_146188_2_, 0.0D);
        var7.draw();
