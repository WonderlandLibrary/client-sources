...
public class PluginScrollableList {
    public CopyOnWriteArrayList<LycorisAddon> elements;
    ...
    public Consumer<LycorisAddon> onSelected;
    ...
    public PluginScrollableList(GuiPluginMgr parent, CopyOnWriteArrayList<LycorisAddon> elements, Consumer<LycorisAddon> onSelected) {
        this.parent = parent;
    ...
    public void draw(float x, float y, float width, float height, int mouseX, int mouseY) {
        ...
        if (parent.needToUpdateList) {
            this.elements = (CopyOnWriteArrayList<LycorisAddon>) Lycoris.INSTANCE.api.getAddonManager().getLycorisAddonList();
            this.scrollAni = 0;
            this.selectedAPI = null;
            parent.needToUpdateList = false;
        } else {
            for (LycorisAddon api : this.elements) {
                ...
                FontManager.icon18.drawString(Lycoris.INSTANCE.api.getAddonManager().getEnabledLycorisAddonList().contains(api) ? "j" : "E", x + 8, startY + 5, 0xffffffff);
