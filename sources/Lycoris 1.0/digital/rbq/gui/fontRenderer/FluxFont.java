package digital.rbq.gui.fontRenderer;
...
public class LycorisFont {
    ...
    public LycorisFont(final Font font, final boolean antiAlias, final int charOffset, final boolean allChar, int yAddon) {
        this.font = font;
    ...
    public LycorisFont(final Font font, final boolean antiAlias, final boolean allChar, int yAddon) {
        this.font = font;
        this.antiAlias = antiAlias;
        charOffset = 6;
        setupTexture(antiAlias, allChar, yAddon);
