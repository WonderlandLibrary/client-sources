...
public class FontUtils {
    ...
    private final LycorisFont unicodeFont;
    ...
    public FontUtils(String fontName, int fontType, int size, int kerning, boolean allChar, int yAddon) {
        this.unicodeFont = new LycorisFont(getFont(fontName, fontType, size), true, kerning, allChar, yAddon);
        this.kerning = 0;
    ...
    public float getHeight() {
        return unicodeFont.getHeight("LycorisClientIsThatBestClarinet.") / 2.0F;
    }

    public LycorisFont getFont() {
