    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                GuiRenderUtils.drawRoundedRect(this.xPosition - 1, this.yPosition - 1, this.width, this.height, 3, 0xffffffff, 1.5f, this.isFocused ? 0xff7d7d7d : this.getText().isEmpty() ? 0xffdbdbdb : 0xff7d7d7d);
            }
            ...
            if (s.length() > 0) {
                ...
                j1 = this.fontRendererInstance.drawString(s1.replaceAll("(?s).", "*"), (float) l, (float) i1, i);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = this.fontRendererInstance.drawString(s.substring(j).replaceAll("(?s).", "*"), (float) j1 + 1, (float) i1, i);
            }
