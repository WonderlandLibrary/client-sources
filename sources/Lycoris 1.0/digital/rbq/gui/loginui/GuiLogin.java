package digital.rbq.gui.loginui;
...
public class GuiLogin extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.usernameField = new CustomTextField(0, Lycoris.font, 0, 0, 100, 20);
        this.passwordField = new PasswordField(0, Lycoris.font, 0, 0, 100, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontManager.font1.drawString(Lycoris.NAME.toUpperCase(), wwidth - 106, 25, 0xff4286f5);
        ...
        if (!AnimationUtils.animationDone) {
            if (this.stage1) {
                ...
                if (fontLoaded) {
                    content = "Welcome to Lycoris Client!";
                    if (timer.delay(3500)) {
                        this.stage1 = false;
                        this.stage2 = true;
                    }
    ...
    public void doLogin() {
        if (checkUsername()) {
            isLogging = true;
            Lycoris.irc = new IRCClient(usernameField.getText(), passwordField.getText());
        } else {
