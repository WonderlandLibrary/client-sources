package digital.rbq.gui.hud.window.impl;
        ...
        for (Object o : mc.theWorld.getLoadedEntityList()) {
            if (o instanceof EntityPlayer) {
                ...
                if (ent.isEntityAlive() && ent != mc.thePlayer && !ent.isInvisible() && !ent.isInvisibleToPlayer(mc.thePlayer)) {
                    ...
                    int color = (FriendManager.isTeam(ent) && Lycoris.teams.getValueState()) ? HudWindowMod.radarTeamColours.getColorInt() : HudWindowMod.radarEnemyColours.getColorInt();
