...
public class Nostalgia implements Theme {
    ...
    public void render(float newWidth, float newHeight) {
        ...
        delayTimer.reset();
        GL11.glPushMatrix();
        Lycoris.rainbow = Color.getHSBColor(index, 1.0f, 1.0f);
        ...
        for (Module module : Lycoris.INSTANCE.getModuleManager().getModulesRender(mc.fontRendererObj)) {
    ...
    public void renderWatermark() {
        ...
        mc.fontRendererObj.drawStringWithShadow("b" + Lycoris.VERSION, 38, 2, Color.white.getRGB());
