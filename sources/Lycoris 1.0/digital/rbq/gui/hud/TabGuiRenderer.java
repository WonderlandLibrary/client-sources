...
public class TabGuiRenderer {
    ...
    public void render() {
        ...
        this.x = (!Hud.waterMarkMode.isCurrentMode("None") ? Hud.waterMarkMode.isCurrentMode("Lycoris Sense") ? 5 : 4 : 4);
        this.y = 3 + (!Hud.waterMarkMode.isCurrentMode("None") ? Hud.waterMarkMode.isCurrentMode("Lycoris Sense") ? 20 : 15 : 0);
 ...
 this.getCurrentCategory()) + 2f;
    ...
    private void drawModules() {
        ...
        java.util.List<Module> moduleList = Lycoris.INSTANCE.getModuleManager().getModulesByCategory(this.getCurrentCategory());
    ...
    public void keyPress(int key) {
        ...
        if (section == Section.Module) {
            if (key == Keyboard.KEY_DOWN && this.moduleIndex < Lycoris.INSTANCE.getModuleManager().getModulesByCategory(this.getCurrentCategory()).size() - 1) {
                this.moduleIndex++;
            }
    ...
    private Module getCurrentModule() {
        return Lycoris.INSTANCE.getModuleManager().getModulesByCategory(this.getCurrentCategory()).get(moduleIndex);
    }

    private float getMaxModulesWidth(Category category) {
        float result = 0;
        for (Module module : Lycoris.INSTANCE.getModuleManager().getModulesByCategory(category))
            if(!Hud.Theme.isCurrentMode("Nostalgia")) {
