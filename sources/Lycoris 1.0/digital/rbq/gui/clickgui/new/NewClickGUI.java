...
import digital.rbq.utility.SmoothAnimationTimer;
...
public class NewClickGUI extends AbstractGuiScreen {
    ...
    public void drawScr(int mouseX, int mouseY, float partialTicks) {
        ...
        FontManager.vision30.drawString(Lycoris.NAME.toUpperCase(), x + 24f, y + 10f, Hud.isLightMode ? 0xFF465CFF : new Color(255, 255, 255).getRGB());
        FontManager.baloo16.drawString("b" + Lycoris.VERSION, x + 62f, y + 13.5f, Hud.isLightMode ? 0XFFC4C4C4 : new Color(220, 221, 222).getRGB());
        ...
        RenderUtil.drawCircleWithTexture(x + 14, bottom - 12f, 0, 360, 10, Lycoris.avatarLocation.getResourceLocation(), ColorUtils.WHITE.c);
    ...
    public class CategoryButton {
        ...
        public void onClick(int mouseX, int mouseY) {
            if (isHovering(mouseX, mouseY, x - 0.5f, y, x + 99.5f, y + 25)) {
                if (Lycoris.INSTANCE.getNewClickGUI().currentCatButton != this) {
                    Lycoris.INSTANCE.getNewClickGUI().currentCatButton = this;
