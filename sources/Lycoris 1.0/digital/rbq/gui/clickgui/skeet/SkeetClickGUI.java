 ...
 */
package digital.rbq.gui.clickgui.skeet;
...
import digital.rbq.config.preset.PresetManager;
import digital.rbq.gui.AbstractGuiScreen;
import digital.rbq.gui.clickgui.classic.RenderUtil;
import digital.rbq.gui.clickgui.skeet.component.impl.sub.button.ButtonComponentImpl;
import digital.rbq.gui.clickgui.skeet.component.impl.sub.checkBox.CheckBoxTextComponent;
import digital.rbq.gui.clickgui.skeet.component.impl.sub.color.ColorPickerTextComponent;
import digital.rbq.gui.clickgui.skeet.component.impl.sub.comboBox.ComboBoxTextComponent;
import digital.rbq.gui.clickgui.skeet.component.impl.sub.key.KeyBindComponent;
import digital.rbq.gui.clickgui.skeet.component.impl.sub.slider.SliderTextComponent;
import digital.rbq.gui.fontRenderer.FontManager;
import digital.rbq.gui.fontRenderer.FontUtils;
import digital.rbq.gui.other.SavePresetScreen;
import digital.rbq.gui.clickgui.skeet.component.Component;
import digital.rbq.gui.clickgui.skeet.component.TabComponent;
import digital.rbq.gui.clickgui.skeet.component.impl.GroupBoxComponent;
import digital.rbq.gui.clickgui.skeet.component.impl.ScrollListComponent;
import digital.rbq.module.Category;
import digital.rbq.module.Module;
import digital.rbq.module.implement.Render.CGUI;
import digital.rbq.module.value.*;
            ...
            TabComponent categoryTab = new TabComponent(this.rootComponent, c.name(), 51.5f, 5.0f, 350f, 341.5f) {
                ...
                public void setupChildren() {
                    if (c == Category.Global) {
                        ...
                        configsGroupBox.addChild(new ButtonComponentImpl(configsGroupBox, "Save", button -> mc.displayGuiScreen(new SavePresetScreen(Lycoris.INSTANCE.getSkeetClickGUI())), 159f, buttonHeight));
                        ...
                        configsGroupBox.addChild(new ButtonComponentImpl(configsGroupBox, "Delete", button -> {
                            if(!selectedConfig.equals("_NONE") && !selectedConfig.startsWith("#")) {
                                Minecraft.getMinecraft().displayGuiScreen(new GuiYesNo((result, id) -> {
                                    ...
                                    Minecraft.getMinecraft().displayGuiScreen(Lycoris.INSTANCE.getSkeetClickGUI());
                        ...
                        List<Module> modulesInCategory = Lycoris.INSTANCE.getModuleManager().getModulesByCategory(c);
