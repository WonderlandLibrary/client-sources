package digital.rbq.gui.clickgui.classic;
...
import digital.rbq.gui.clickgui.classic.component.Checkbox;
import digital.rbq.gui.clickgui.classic.component.Component;
import digital.rbq.gui.clickgui.classic.component.Label;
import digital.rbq.gui.clickgui.classic.component.*;
import digital.rbq.gui.clickgui.classic.component.color.ColorPicker;
...
public class ClickGUI extends AbstractGuiScreen {
    ...
    public void drawScr(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawImage(Lycoris.avatarLocation.getResourceLocation(), 7, curHeight - 28, 22, 21, 1f);
    ...
    public void toggleBox(String group, boolean value) {
        for (Window window : this.windows) {
            for (digital.rbq.gui.clickgui.classic.component.Component child : window.children) {
