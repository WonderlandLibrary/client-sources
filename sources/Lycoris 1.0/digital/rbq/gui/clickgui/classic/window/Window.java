package digital.rbq.gui.clickgui.classic.window;
...
import digital.rbq.gui.clickgui.classic.component.Component;
import digital.rbq.gui.clickgui.classic.component.PresetList;
...
public class Window {
    ...
    public List<digital.rbq.gui.clickgui.classic.component.Component> children = new ArrayList<>();
    ...
    public void repositionComponents() {
        ...
        //caluclate height
        digital.rbq.gui.clickgui.classic.component.Component c;
        Iterator var4;
        for (var4 = this.children.iterator(); var4.hasNext(); maxWidth = Math.max(maxWidth, c.width)) {
            c = (digital.rbq.gui.clickgui.classic.component.Component) var4.next();
            c.offY = y;
    ...
    public void update(int mouseX, int mouseY) {
        ...
        for (digital.rbq.gui.clickgui.classic.component.Component component : this.children) {
    ...
    public void render(int mouseX, int mouseY) {
        ...
        //draw background
        int totalHeight = 0;
        for (digital.rbq.gui.clickgui.classic.component.Component i : this.children)
    ...
    public void handleMouseUpdates(int mouseX, int mouseY, boolean isPressed) {
        ...
        if (this.mouseOver(mouseX, mouseY)) {
            ...
            digital.rbq.gui.clickgui.classic.component.Component c;
            Iterator<digital.rbq.gui.clickgui.classic.component.Component> childIter = this.children.iterator();
            if (!overBar) {
    ...
    public void bringToFront() {
        ArrayList<Window> copy = new ArrayList<Window>(Lycoris.INSTANCE.getClickGUI().windows);
        copy.remove(this);
        copy.add(this);
        Lycoris.INSTANCE.getClickGUI().windows = copy;
    }
    ...
    public boolean mouseOver(int mouseX, int mouseY) {
        Window latest = null;
        for (Window window : Lycoris.INSTANCE.getClickGUI().windows) {
