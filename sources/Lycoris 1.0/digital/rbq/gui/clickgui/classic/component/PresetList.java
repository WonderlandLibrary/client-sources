...
import digital.rbq.gui.clickgui.classic.Rect;
...
public class PresetList extends Component {
    ...
    private void pressed(int mouseY) {
        ...
        if (this.isHoveredSave) {
            Minecraft.getMinecraft().displayGuiScreen(new SavePresetScreen(Lycoris.INSTANCE.getClickGUI()));
        }
        ...
        if (this.isHoveredDelete && canberemoved()) {
            ...
            Minecraft.getMinecraft().displayGuiScreen(new GuiYesNo((result, id) -> {
                ...
                Minecraft.getMinecraft().displayGuiScreen(Lycoris.INSTANCE.getClickGUI());
