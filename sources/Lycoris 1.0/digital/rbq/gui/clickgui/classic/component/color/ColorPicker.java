package digital.rbq.gui.clickgui.classic.component.color;
...
public class ColorPicker extends Component {
    ...
    public void render(int mouseX, int mouseY) {
        ...
        if (this == Lycoris.INSTANCE.getClickGUI().getCurrentColourPicker() && expanded) {
            ...
            if (isHoveredColour(mouseX,mouseY) && !held) {
                ...
                if (expanded) {
                    if(Keyboard.isKeyDown(Keyboard.KEY_LSHIFT))
                        ...
                        Lycoris.INSTANCE.getClickGUI().setCurrentColourPicker(this);
