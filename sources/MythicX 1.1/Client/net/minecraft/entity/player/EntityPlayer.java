...
public abstract class EntityPlayer extends EntityLivingBase
{
                        ...
                        if (i > 0) {
                            targetEntity.addVelocity(
                                    (double) (-MathHelper.sin(this.rotationYaw * (float) Math.PI / 180.0F) * (float) i
                                            * 0.5F),
                                    0.1D, (double) (MathHelper.cos(this.rotationYaw * (float) Math.PI / 180.0F) * (float) i
                                            * 0.5F));
                            if (Killaura.keepSprint) {
                            ...
                            if(MythicX.moduleManager.getModuleByName("Velocity").isToggled() && MythicX.setmgr.getSettingByName("Velocity").equals("Jump")){
                                this.motionX *= 0.6D;
                                this.motionZ *= 0.6D;
                            }
                            if(MythicX.moduleManager.getModuleByName("Velocity").isToggled() && MythicX.setmgr.getSettingByName("Velocity").equals("Gomme")){
                                this.motionX *= 0.6D;
                                this.motionZ *= 0.6D;
                            }
                        }
    ...
    public float getEyeHeight()
    {
        ...
        if (this.isSneaking())
        {
            if(MythicX.moduleManager.getModuleByName("Scaffold").isEnabled()){
                f = 1.62F;
            }else {
                f -= 0.08F;
            }
