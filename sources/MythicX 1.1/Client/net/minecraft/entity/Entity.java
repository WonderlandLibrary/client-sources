...
public abstract class Entity implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            try {
                boolean safewalk = MythicX.moduleManager.getModuleByName("Scaffold").isEnabled() && !Scaffold.legit;
    ...
    protected final Vec3 getVectorForRotation(float pitch, float yaw) {
        boolean scaffold = MythicX.moduleManager.getModuleByName("Scaffold").isEnabled();
        float f1 = 0;
        float f2 = 0;
        float f3 = 0;
        float f = 0;
