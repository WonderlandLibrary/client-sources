...
public class PlayerControllerMP {
    ...
    public void syncCurrentPlayItem() {
        ...
        EventSyncItem eventSyncItem = new EventSyncItem(i);
        EventManager.call(eventSyncItem);

        i = eventSyncItem.getSlot();
    ...
    public boolean sendUseItem(EntityPlayer playerIn, World worldIn, int slot) {
        if (this.currentGameType == WorldSettings.GameType.SPECTATOR) {
            return false;
        } else {
            ItemStack itemStackIn = playerIn.inventory.getStackInSlot(slot);
            if (itemStackIn == null)
                return false;
            this.syncCurrentPlayItem();
