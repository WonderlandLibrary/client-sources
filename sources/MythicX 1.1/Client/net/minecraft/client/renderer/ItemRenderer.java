    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            if (this.itemToRender != null)
            {
                ...
                {
                    try {
                        if(Killaura.fakeBlock && mc.thePlayer.getHeldItem().getItem() instanceof ItemSword && Killaura.target != null && mc.thePlayer != null){
                            this.transformFirstPersonItem(f, f1);
                            this.doBlockTransformations();
                        }else if (MythicX.setmgr.getSettingByName("RealBlock").getValBoolean() && mc.thePlayer.getHeldItem().getItem() instanceof ItemSword && Killaura.target != null && mc.thePlayer != null){
                            this.transformFirstPersonItem(f, f1);
                            this.doBlockTransformations();
                        }else {
