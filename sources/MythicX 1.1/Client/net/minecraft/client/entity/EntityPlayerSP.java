...
import de.theBest.MythicX.command.CommandManager;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        ...
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                EventManager.call(eventPostMotion);
            }
        }
    }
                ...
                if (flag2 && flag3) {
                    this.sendQueue.addToSendQueue(
                            new C03PacketPlayer.C06PacketPlayerPosLook(this.posX, this.getEntityBoundingBox().minY,
                                    this.posZ, event.getYaw(), event.getPitch(), this.onGround));
                } else if (flag2) {
                    ...
                    this.sendQueue.addToSendQueue(
                            new C03PacketPlayer.C05PacketPlayerLook(event.getYaw(), event.getPitch(), this.onGround));
                } else {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer(this.onGround));
                }
            } else {
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0D,
                        this.motionZ, event.getYaw(), event.getPitch(), this.onGround));
                flag2 = false;
            }
    ...
    {
        CommandManager.checkMessage(message);
    }
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            if(!MythicX.moduleManager.getModuleByName("NoSlow").isToggled()) {
