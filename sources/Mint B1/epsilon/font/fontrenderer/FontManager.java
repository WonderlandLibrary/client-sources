    ...
    public FontManager() {
        ...
        try {
            for (final int i : new int[]{60, 96}) {
                final InputStream istream = this.getClass().getResourceAsStream("/assets/minecraft/epsilon/fonts/rise.ttf");
            ...
            for (final int i : new int[]{14, 16, 18, 19, 20, 22, 24, 36, 48, 72, 96}) {
                final InputStream istream = this.getClass().getResourceAsStream("/assets/minecraft/epsilon/fonts/Product_Sans_Regular");
            ...
            for (final int i : new int[]{12, 14, 16, 18, 30, 64}) {
                final InputStream istream = this.getClass().getResourceAsStream("/assets/minecraft/epsilon/fonts/logo");
            ...
            for (final int i : new int[]{12, 18, 24,36, 48, 60, 72}) {
                final InputStream istream = this.getClass().getResourceAsStream("/assets/minecraft/epsilon/fonts/MontserratAlter.ttf");

                Font myFont = Font.createFont(0, istream);
                myFont = myFont.deriveFont(Font.PLAIN, (float) i);
                this.fonts.put("MontserratAlter " + i, new TTFFontRenderer(executorService, textureQueue, myFont));
            }

            for (final int i : new int[]{12, 18, 24,36, 48, 60, 72}) {
                final InputStream istream = this.getClass().getResourceAsStream("/assets/minecraft/epsilon/fonts/MontserratReg.ttf");

                Font myFont = Font.createFont(0, istream);
                myFont = myFont.deriveFont(Font.BOLD, (float) i);
                this.fonts.put("MontserratReg " + i, new TTFFontRenderer(executorService, textureQueue, myFont));
            }
            ...
            for (final int i : new int[]{18}) {
                final InputStream istream = this.getClass().getResourceAsStream("/assets/minecraft/epsilon/fonts/Icons");
            ...
            for (final int i : new int[]{18, 20, 24, 36, 48, 72, 96}) {
                final InputStream istream = this.getClass().getResourceAsStream("/assets/minecraft/epsilon/fonts/Mint");

                Font myFont = Font.createFont(0, istream);
                myFont = myFont.deriveFont(Font.PLAIN, (float) i);
                this.fonts.put("Mint " + i, new TTFFontRenderer(executorService, textureQueue, myFont));
            }
            ...
            for (final int i : new int[]{18, 20, 24}) {
                final InputStream istream = this.getClass().getResourceAsStream("/assets/minecraft/epsilon/fonts/icon2");
            ...
            for (final int i : new int[]{16, 18, 20, 24}) {
                final InputStream istream = this.getClass().getResourceAsStream("/assets/minecraft/epsilon/fonts/IconRiseNotPerm");
