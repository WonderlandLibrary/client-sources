...
public class TTFFontRenderer {
    ...
    public void drawString(final Category[] values, final float x, final float y, final int color) {
        GlStateManager.enableAlpha();
        GlStateManager.disableBlend();
        this.renderString(values, x, y, color, false);
    }
    ...
    private int renderString(Category[] values, float x, float y, final int color, final boolean shadow) {
    ...
    public int renderString(String text, float x, float y, final int color, final boolean shadow) {
