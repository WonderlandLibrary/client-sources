...
public abstract class BlockRedstoneDiode extends BlockDirectional
{
    ...
    {
        return !this.func_176406_l(state) ? 0 : (state.getValue(AGE) == side ? 15 : 0);
    }
     ...
     * Notch you're a dumb nigger 
     */
    /*public boolean canProvidePower() only commenting this out and not removing cuz its funny
    {
        return true;
    }*/
