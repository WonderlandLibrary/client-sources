...
import epsilon.events.EventType;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
            ...
            if (this.isRiding())
            {
                ...
                EventRiding e = new EventRiding(this.moveStrafing, this.moveForward, this.movementInput.jump, this.movementInput.sneak, this.rotationYaw, this.rotationPitch, this.onGround, this.ridingEntity);
            	Epsilon.onEvent(e);
    ...
    public void sendHorseJump(int power)
    {
        this.sendQueue.addToSendQueue(new C0BPacketEntityAction(this, C0BPacketEntityAction.Action.RIDING_JUMP, (int)(power * 100.0F)));
    }
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding())
        {
        	...
        	}else if (NoSlow.matrixfunni){
        		this.movementInput.moveStrafe *= NoSlow.matrixval * 1.1;
	            this.movementInput.moveForward *= NoSlow.matrixval * 1.1;
        	}
            else {
