...
public class Gui
{
    ...
    {
        fontRendererIn.func_175063_a(text, (float)(f - fontRendererIn.getStringWidth(text) / 2), (float)g, color);
    }
    
    public void drawCenteredString(TTFFontRenderer fontRenderer, String text, float f, float g, int color)
    {
        fontRenderer.renderString(text, (float)(f - fontRenderer.getWidth(text) / 2), (float)g, color, false);
    }
     ...
     */
    public static void drawScaledCustomSizeModalRect(float f, float g, float u, float v, int uWidth, int vHeight, int width, int height, float tileWidth, float tileHeight)
    {
        ...
        var13.addVertexWithUV((double)f, (double)(g + height), 0.0D, (double)(u * var10), (double)((v + (float)vHeight) * var11));
        var13.addVertexWithUV((double)(f + width), (double)(g + height), 0.0D, (double)((u + (float)uWidth) * var10), (double)((v + (float)vHeight) * var11));
        var13.addVertexWithUV((double)(f + width), (double)g, 0.0D, (double)((u + (float)uWidth) * var10), (double)(v * var11));
        var13.addVertexWithUV((double)f, (double)g, 0.0D, (double)(u * var10), (double)(v * var11));
        var12.draw();
    }
}
