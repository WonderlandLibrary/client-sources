...
public abstract class RendererLivingEntity extends Render
{
    ...
    public static float chamsRed, chamsGreen, chamsBlue, chamsAlpha, chamsRed2, chamsGreen2, chamsBlue2, chamsAlpha2;
    ...
    public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_)}))
        {
            ...
            try
            {
                ...
                float var201;
                if(p_76986_1_ == renderManager.livingPlayer)
                	var201 = p_76986_1_.prevRotationPitchHead + (p_76986_1_.rotationPitchHead - p_76986_1_.prevRotationPitchHead) * p_76986_9_;
                else 
    ...
    protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        if (var8 || var9)
        {
            ...
            Color color = null, color2 = null;
            color = new Color((int) chamsRed, (int) chamsGreen, (int) chamsBlue, (int) chamsAlpha);
            color2 = new Color((int) chamsRed2, (int) chamsGreen2, (int) chamsBlue2, (int) chamsAlpha2);
