...
public class ItemRenderer
{
    ...
    {
    	if (ModuleManager.smallItems.isEnabled())
    		GlStateManager.translate(0.75 * ((100 - ModuleManager.smallItems.scale.getValue()) / 100), -0.15 * ((100 - ModuleManager.smallItems.scale.getValue()) / 100), -1 * ((100 - ModuleManager.smallItems.scale.getValue()) / 100));
        ...
        float equipProgress = 1.0F - (this.prevEquippedProgress + (this.equippedProgress - this.prevEquippedProgress) * p_78440_1_);
        final float swingProgress = var3.getSwingProgress(p_78440_1_);
        ...
        for (Module m : Epsilon.modules) {
    		if(m.name== "SmallItem") {
    			...
    			if(mc.thePlayer.getHeldItem()!=null) {
	    			...
	    			if(m.toggled) {
	    	            GlStateManager.translate(SmallItem.xItem, SmallItem.yItem, SmallItem.zItem);
	    				GlStateManager.scale(SmallItem.itemScale, SmallItem.itemScale, SmallItem.itemScale);
	    			}
    			}
    		}
        }
        ...
        if (this.itemToRender != null) {
            ...
            else if (var3.getItemInUseCount() > 0)
            {
                ...
                {
                 //func_178096_b(); aka transformFirstPersonItem
                    case 1: //None
                    ...
                    case 4://Block
                    	...
                    	if(ModuleManager.isToggled("Animations")) {
                    			...
                    			case "Smooth":
                                    ...
                                    GL11.glTranslatef((float) 0, 1 / 10 + 0.1f, -1);
                                    GlStateManager.translate(0.6f, 0.3f, 0.6f);
                                    GL11.glRotatef(y * 10, 0, 1, 0);
                                    GL11.glRotatef(250, 0.2f, 1, -0.6f);
                                    GL11.glRotatef(-10, 1, 0.5f, 1);
                                    GL11.glRotatef(-angle * 20, 1, 0.5f, 1);
                                    GlStateManager.rotate(-funny * 1.0F, 16, 0, 2.0F);
                    			...
                    			case "Exhibition":
                    				...
                    				this.func_178096_b(equipProgress / 2.0F, 0.0f);
                    			...
                    			case "Mint":
                					...
                					this.func_178096_b(equipProgress / 5.0F, 0.0F);
                                    GlStateManager.translate(-0.3F*funny, 0.1F*(funny/5), -0.3F*funny);
                                    GlStateManager.rotate(-funny * 31.0F, 16, 0, 2.0F);
                                    GlStateManager.rotate(-funny * 15.0F, 1.5F, (funny / 1.1F), 0F);
                                    GlStateManager.rotate(-funny * 15.0F, 1.5F, (funny / 1.1F), 1F);
                                    this.func_178103_d();
                    			...
                    			case "Gyroscope":
                					...
                					this.func_178096_b(equipProgress / 15.0F, 0.0F);
                					GlStateManager.translate(0, 1, 0);
                                    GlStateManager.translate(-0.3F*funny, 0.4F*(funny/5), -0.3F*funny);
                                    GlStateManager.rotate(funny * 231.0F, 116, 4, (float) (2.0F*funny*Math.random()));
	                    	...
	                    	/*if(!Animations.dodafunnianimes) {
	                    		...
	                    		if(Animations.v17) {
                                    ...
                                    GL11.glRotatef(-angle * 20, 1, 0.5f, 1);
                                    GlStateManager.rotate(-funny * 1.0F, 16, 0, 2.0F);
	                    		}else if(Animations.Epsilon) {
	                    			this.func_178096_b(equipProgress / 2.0F, 0.0F);
                                    GlStateManager.translate(0.730F, 0.3F, 0.30F);
                                    GlStateManager.rotate(-funny * 31.0F, 16, 0, 2.0F);
                                    GlStateManager.rotate(-funny * 15.0F, 1.5F, (funny / 1.1F), 0F);
                                    this.func_178103_d();

	                    		}else if (Animations.Stab) {
	                    			GlStateManager.translate(0.6f, 0.3f, -0.6f + -funny * 0.7);
                                    GlStateManager.rotate(6090, 0.0f, 0.0f, 0.1f);
                                    GlStateManager.rotate(6085, 0.0f, 0.1f, 0.0f);
                                    GlStateManager.rotate(6110, 0.1f, 0.0f, 0.0f);
