...
public abstract class EntityLivingBase extends Entity {
    ...
    protected void jump() {
        ...
        if (this.isSprinting()) {
            float halal = jumpYaw * 0.017453292F;

            this.motionX -= MathHelper.sin(halal) * 0.2F;
            this.motionZ += MathHelper.cos(halal) * 0.2F;
        }
    ...
    public void onUpdate() {
        ...
        if (this.swingProgress > 0.0F) {
            f1 = (this instanceof EntityPlayerSP ? RotationComponent.rotationYaw : this.rotationYaw);
        }
    ...
    protected float updateDistance(float p_110146_1_, float p_110146_2_) {
        ...
        this.renderYawOffset = (this instanceof EntityPlayerSP ? RotationComponent.rotationYaw : this.rotationYaw) - f1;
