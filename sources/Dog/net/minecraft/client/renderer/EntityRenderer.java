...
import fr.dog.module.impl.render.Camera;
import fr.dog.module.impl.render.Freelook;
import fr.dog.module.impl.render.FullBright;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        // Absolute unit of shitcode, let me cook nigga

        SetMouseTargetEvent event = new SetMouseTargetEvent();

        Dog.getInstance().getEventBus().post(event);


        if(event.hasBeenTouchedLikeLiticaneMyFemboyFuwwyOngOrLikeMasterMeeMyFemboyBottom){
            this.mc.objectMouseOver = event.position;
            return;
        }
    ...
    private void orientCamera(float partialTicks) {
        Entity entity = this.mc.getRenderViewEntity();
        Freelook freelook = Dog.getInstance().getModuleManager().getModule(Freelook.class);
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase) entity).isPlayerSleeping()) {
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                float f1 = freelook.getRenderRotations()[0];
                float f2 = freelook.getRenderRotations()[1];
                ...
                if(!Dog.getInstance().getModuleManager().getModule(Camera.class).trw.getValue() && Dog.getInstance().getModuleManager().getModule(Camera.class).isEnabled()){
                    for (int i = 0; i < 8; ++i) {
                ...
                GlStateManager.rotate(freelook.getRenderRotations()[1] - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(freelook.getRenderRotations()[0] - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float) (-d3));
                GlStateManager.rotate(f1 - freelook.getRenderRotations()[0], 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - freelook.getRenderRotations()[1], 1.0F, 0.0F, 0.0F);
            }
        } else {
        ...
        if (!this.mc.gameSettings.debugCamEnable) {
            GlStateManager.rotate(freelook.getRenderRotations()[3] + (freelook.getRenderRotations()[1] - freelook.getRenderRotations()[3]) * partialTicks, 1.0F, 0.0F, 0.0F);
            ...
            if (entity instanceof EntityAnimal entityanimal) {
                ...
                GlStateManager.rotate(freelook.getRenderRotations()[2] + (freelook.getRenderRotations()[0] - freelook.getRenderRotations()[2]) * partialTicks + 180.0F, 0.0F, 1.0F, 0.0F);
            }
        }
        ...
        if (this.lightmapUpdateNeeded) {
            ...
            if (world != null) {
                ...
                for (int i = 0; i < 256; ++i) {
                    ...
                    float f16 = Dog.getInstance().getModuleManager().getModule(FullBright.class).isEnabled() ? 10000 : this.mc.gameSettings.gammaSetting;
                    float f17 = 1.0F - f8;
                    float f13 = 1.0F - f9;
                    float f14 = 1.0F - f10;
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        Dog.getInstance().getEventBus().post(new Render3DEvent(partialTicks));
