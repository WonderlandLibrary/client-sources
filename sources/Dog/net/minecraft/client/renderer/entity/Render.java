...
import fr.dog.Dog;
import fr.dog.module.impl.render.NameTags;
...
public abstract class Render<T extends Entity> implements IEntityRenderer {
    ...
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
        ...
        if(Dog.getInstance().getModuleManager().getModule(NameTags.class).isEnabled() &&
        Dog.getInstance().getModuleManager().getModule(NameTags.class).isValid(entityIn)){
            return;
        }
