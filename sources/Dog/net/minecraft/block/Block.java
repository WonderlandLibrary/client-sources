...
public class Block {
    ...
    public float getPlayerRelativeBlockHardnessFromTool(EntityPlayer playerIn, World worldIn, BlockPos pos, ItemStack stack) {
        float f = this.getBlockHardness(worldIn, pos);
        return f < 0.0F ? 0.0F : (!playerIn.canHarvestBlock(this) ? playerIn.getToolDigEfficiency(this, stack) / f / 100.0F : playerIn.getToolDigEfficiency(this, stack) / f / 30.0F);
    }
