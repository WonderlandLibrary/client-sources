...
public class ViewFrustum
{
    ...
    protected void createRenderChunks(IRenderChunkFactory renderChunkFactory)
    {
        ...
        for (int k = 0; k < this.countChunksX; ++k)
        {
            for (int l = 0; l < this.countChunksY; ++l)
            {
                for (int i1 = 0; i1 < this.countChunksZ; ++i1)
                {
                    ...
                    BlockPosition blockpos = new BlockPosition(k * 16, l * 16, i1 * 16);
        ...
        for (int k1 = 0; k1 < this.renderChunks.length; ++k1)
        {
            ...
            for (int l1 = 0; l1 < EnumFacing.VALUES.length; ++l1)
            {
                ...
                BlockPosition blockpos1 = renderchunk1.getBlockPosOffset16(enumfacing);
        ...
        for (int l = 0; l < this.countChunksX; ++l)
        {
            ...
            for (int j1 = 0; j1 < this.countChunksZ; ++j1)
            {
                ...
                for (int l1 = 0; l1 < this.countChunksY; ++l1)
                {
                    ...
                    {
                        BlockPosition blockpos1 = new BlockPosition(i1, i2, k1);
    ...
    public RenderChunk getRenderChunk(BlockPosition pos)
    {
        int i = pos.getX() >> 4;
        int j = pos.getY() >> 4;
        int k = pos.getZ() >> 4;
    ...
    {
        BlockPosition blockpos = p_updateVboRegion_1_.getPosition();
