...
public class BlockDynamicLiquid extends BlockLiquid
{
    ...
    private void placeStaticBlock(World worldIn, BlockPosition pos, IBlockState currentState)
    {
    ...
    private void tryFlowInto(World worldIn, BlockPosition pos, IBlockState state, int level)
    {
    ...
    private int func_176374_a(World worldIn, BlockPosition pos, int distance, EnumFacing calculateFlowCost)
    {
        int i = 1000;
    ...
    private Set<EnumFacing> getPossibleFlowDirections(World worldIn, BlockPosition pos)
    {
        int i = 1000;
    ...
    private boolean isBlocked(World worldIn, BlockPosition pos, IBlockState state)
    {
    ...
    protected int checkAdjacentBlock(World worldIn, BlockPosition pos, int currentMinLevel)
    {
    ...
    private boolean canFlowInto(World worldIn, BlockPosition pos, IBlockState state)
    {
