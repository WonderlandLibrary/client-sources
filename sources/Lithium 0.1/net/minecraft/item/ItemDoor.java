...
public class ItemDoor extends Item
{
    ...
    public static void placeDoor(World worldIn, BlockPosition pos, EnumFacing facing, Block door)
    {
        BlockPosition blockpos = pos.offset(facing.rotateY());
        BlockPosition blockpos1 = pos.offset(facing.rotateYCCW());
