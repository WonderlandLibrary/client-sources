    ...
    static class AIFireballAttack extends EntityAIBase
    {
        ...
        public void updateTask()
        {
            ...
            if (entitylivingbase.getDistanceSqToEntity(this.parentEntity) < d0 * d0 && this.parentEntity.canEntityBeSeen(entitylivingbase))
            {
                ...
                {
                    world.playAuxSFXAtEntity((EntityPlayer)null, 1007, new BlockPosition(this.parentEntity), 0);
                }
                ...
                if (this.attackTimer == 20)
                {
                    ...
                    world.playAuxSFXAtEntity((EntityPlayer)null, 1008, new BlockPosition(this.parentEntity), 0);
