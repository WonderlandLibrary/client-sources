...
public class CommandFill extends CommandBase
{
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            BlockPosition blockpos2 = new BlockPosition(Math.min(blockpos.getX(), blockpos1.getX()), Math.min(blockpos.getY(), blockpos1.getY()), Math.min(blockpos.getZ(), blockpos1.getZ()));
            BlockPosition blockpos3 = new BlockPosition(Math.max(blockpos.getX(), blockpos1.getX()), Math.max(blockpos.getY(), blockpos1.getY()), Math.max(blockpos.getZ(), blockpos1.getZ()));
            ...
            else if (blockpos2.getY() >= 0 && blockpos3.getY() < 256)
            {
                ...
                for (int k = blockpos2.getZ(); k < blockpos3.getZ() + 16; k += 16)
                {
                    ...
                    {
                        if (!world.isBlockLoaded(new BlockPosition(l, blockpos3.getY() - blockpos2.getY(), k)))
                        {
                ...
                for (int i1 = blockpos2.getZ(); i1 <= blockpos3.getZ(); ++i1)
                {
                    for (int j1 = blockpos2.getY(); j1 <= blockpos3.getY(); ++j1)
                    {
                        ...
                        {
                            BlockPosition blockpos4 = new BlockPosition(k1, j1, i1);
                ...
                for (BlockPosition blockpos5 : list)
                {
