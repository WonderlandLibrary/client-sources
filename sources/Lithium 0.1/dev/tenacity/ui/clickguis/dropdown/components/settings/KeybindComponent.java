...
public class KeybindComponent extends SettingComponent<KeybindSetting> {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        float startY = y + lithiumFont16.getMiddleOfBox(height);
        ...
        lithiumFont16.drawCenteredString("Bind: §l" + bind, x + width /2f, y + lithiumFont16.getMiddleOfBox(height), textColor);
    }
