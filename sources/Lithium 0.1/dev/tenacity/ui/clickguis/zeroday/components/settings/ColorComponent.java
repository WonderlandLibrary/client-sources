...
public class ColorComponent extends SettingComponent<ColorSetting> {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        Gui.drawRect(
                ...
                colorX + colorWidth,
                colorY + colorHeight,
                ColorUtil.interpolateColorC(actualColor, actualColor.darker(), hoverAnimation.getOutput().floatValue()).getRGB()
        );
        ...
        if (opened || !openAnimation.isDone()) {
            ...
            Gui.drawRect2(gradientX, gradientY, gradientWidth, gradientHeight,
                    ColorUtil.applyOpacity(firstColor, colorAlpha).getRGB());
            ...
            Gui.drawGradientRectSideways(
                    ...
                    ColorUtil.applyOpacity(secondColor, colorAlpha).getRGB(),
                    ColorUtil.applyOpacity(secondColor, 0).getRGB());
            ...
            Gui.drawGradientRect(
                    ...
                    gradientX + gradientWidth,
                    gradientY + gradientHeight,
                    ColorUtil.applyOpacity(thirdColor, 0).getRGB(),
                    ColorUtil.applyOpacity(thirdColor, colorAlpha).getRGB());
            ...
            if (!rainbowAnimation.finished(Direction.FORWARDS)) {
                ...
                hexField.setYPosition(newYVal + heightLeft / 2f - hexField.getHeight() / 2f - 10);
