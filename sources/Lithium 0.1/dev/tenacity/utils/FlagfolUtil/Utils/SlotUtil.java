package dev.tenacity.utils.FlagfolUtil.Utils;
...
public class SlotUtil  {
    ...
    public int findTool(final BlockPosition blockPos) {
        float bestSpeed = 1;
        int bestSlot = -1;
    ...
    public float getPlayerRelativeBlockHardness(final EntityPlayer playerIn, final World worldIn, final BlockPosition pos, final int slot) {
        final Block block = mc.theWorld.getBlockState(pos).getBlock();
        final float f = block.getBlockHardness();
