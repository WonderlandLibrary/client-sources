...
public class MovementUtils implements Utils {
    ...
    public static double getAllowedHorizontalDistance() {
        ...
        } else if (MovementUtils.isInLiquid()) {
    ...
    public static float simulationStrafeAngle(float currentMoveYaw, float maxAngle) {
        float workingYaw;
        float target = (float) Math.toDegrees(MovementUtils.getDirection());
        ...
        MovementUtils.strafe(MovementUtils.getSpeed(), workingYaw);
    ...
    public static float getSpeed() {
        return (mc.thePlayer == null || mc.theWorld == null) ? 0F : (float) Math.sqrt(mc.thePlayer.motionX * mc.thePlayer.motionX + mc.thePlayer.motionZ * mc.thePlayer.motionZ);
    }
