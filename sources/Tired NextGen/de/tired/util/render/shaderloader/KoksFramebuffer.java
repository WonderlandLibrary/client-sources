...
public class KoksFramebuffer implements IHook {
    ...
    public static void drawQuadsBufferAccel(float x, float y, float width, float height, int binding) {
        if (MC.gameSettings.ofFastRender) return;
    ...
    public void drawTexture(int texture, double scaledWidth, double scaledHeight) {
