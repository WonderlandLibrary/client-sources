...
public class GlitchShader extends Shader implements IHook {


    public GlitchShader(int pass) {
        super(new ShaderProgram("fragment/GlitchShader.glsl"));
        this.pass = pass;
    }
    ...
    public void setUniforms() {
        GL20.glUniform1f(shaderProgram.getUniform("time"), pass / 1200f);
