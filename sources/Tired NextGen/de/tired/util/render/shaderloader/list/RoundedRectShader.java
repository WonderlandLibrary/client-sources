...
@ShaderAnnoation(fragName = "roundedRect.glsl", renderType = ShaderRenderType.RENDER2D)
public class RoundedRectShader extends ShaderProgram implements IHook {
    ...
    public void drawRound(float x, float y, float width, float height, float radius, Color color) {
        ...
        handleUniform(x, y, width, height, radius);
    ...
    private void handleUniform(float x, float y, float width, float height, float radius) {
