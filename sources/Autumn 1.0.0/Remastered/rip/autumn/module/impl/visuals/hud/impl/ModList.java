...
public final class ModList extends Component {
   ...
   public void draw(ScaledResolution sr) {
      ...
      FontRenderer fr = hud.defaultFont.getValue() ? mc.fontRendererObj : mc.fontRendererObj;
   ...
   private List<Module> getSortedModules(FontRenderer fr) {
      List<Module> sortedList = new ArrayList<>((Collection<? extends Module>)Autumn.MANAGER_REGISTRY.moduleManager.getModules());
