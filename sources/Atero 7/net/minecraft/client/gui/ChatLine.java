...
public class ChatLine
{
    ...
    private ArrayList<IChatComponent> components = new ArrayList<>();
    ...
    public ChatLine(int p_i45000_1_, IChatComponent p_i45000_2_, int p_i45000_3_) {
    	...
    	//components.add(p_i45000_2_);
        this.lineString = p_i45000_2_;
        this.updateCounterCreated = p_i45000_1_;
        this.chatLineID = p_i45000_3_;
    }
    
    /*public ChatLine(int p_i45000_1_, ArrayList<IChatComponent> components, int p_i45000_3_) {
    ...
    /*public ArrayList<IChatComponent> getComponents() {
		return components;
	}*/
}
