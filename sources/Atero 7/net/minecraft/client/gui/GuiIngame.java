...
import de.verschwiegener.atero.module.modules.world.AutoEagle;
...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
      ...
      //  CustomGUIIngame.renderShader();
        ...
        if (Management.instance.modulemgr.getModuleByName("AutoEagle").isEnabled() ||Management.instance.modulemgr.getModuleByName("Scaffold").isEnabled() ) {
            drawRect(scaledresolution.getScaledWidth() / 2F + 10, scaledresolution.getScaledHeight() / 2f- 5,
                    scaledresolution.getScaledWidth() / 2f + 30, scaledresolution.getScaledHeight() / 2f + 15, new Color(23, 23 ,23).getRGB());

            drawRect(scaledresolution.getScaledWidth() / 2F + 10, scaledresolution.getScaledHeight() / 2f - 5,
                    scaledresolution.getScaledWidth() / 2f + 30, scaledresolution.getScaledHeight() / 2f - 4.7F, Management.instance.colorBlue.getRGB());

            FontManager.VistolSans_Light2.drawString(
                    "" + AutoEagle.getBlockCount(),
                    scaledresolution.getScaledWidth() / 2f - FontManager.VistolSans_Light2.getStringWidth("" + AutoEagle.getBlockCount()) / 2f + 18.5F,
                    top, Color.white.getRGB(), false);
