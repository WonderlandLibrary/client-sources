...
public class GuiMessage extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.messageLine1, (float)(this.width / 2), 70, 16777215);
        int i = 90;
        for (final Object s : this.listLines2) {
            this.drawCenteredString(this.fontRendererObj, (String)s, (float)(this.width / 2), i, 16777215);
