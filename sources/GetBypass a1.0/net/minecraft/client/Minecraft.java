...
import today.getbypass.gui.GuiIngameHook;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Loading GetBypass...");
        try {
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getInputStreamAssets(new ResourceLocation("GetBypass/icons/icon16x16.png"));
                inputstream2 = this.mcDefaultResourcePack.getInputStreamAssets(new ResourceLocation("GetBypass/icons/icon32x32.png"));
