...
public class GuiIngame extends Gui
{
    ...
    private void renderHotbar() {
        ...
        final int i = 8;
        Gui.drawRect(0, sr.getScaledHeight() - 23, sr.getScaledWidth(), sr.getScaledHeight(), Integer.MIN_VALUE);
        if (this.mc.thePlayer.inventory.currentItem == 0) {
            RoundedUtils.drawRoundedRect((float)(sr.getScaledWidth() / 2 - 91 + this.mc.thePlayer.inventory.currentItem * 20), (float)(sr.getScaledHeight() - 23), (float)(sr.getScaledWidth() / 2 + 91 - 20 * i), (float)sr.getScaledHeight(), 6.0f, Integer.MAX_VALUE);
        }
        else {
            RoundedUtils.drawRoundedRect((float)(sr.getScaledWidth() / 2 - 91 + this.mc.thePlayer.inventory.currentItem * 20), (float)(sr.getScaledHeight() - 23), (float)(sr.getScaledWidth() / 2 + 91 - 20 * (8 - this.mc.thePlayer.inventory.currentItem)), (float)sr.getScaledHeight(), 6.0f, Integer.MAX_VALUE);
        }
    }
