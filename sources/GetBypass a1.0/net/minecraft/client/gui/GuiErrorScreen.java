...
public class GuiErrorScreen extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_146313_a, (float)(this.width / 2), 90, 16777215);
        this.drawCenteredString(this.fontRendererObj, this.field_146312_f, (float)(this.width / 2), 110, 16777215);
