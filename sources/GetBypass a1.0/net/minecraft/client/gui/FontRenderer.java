...
public class FontRenderer implements IResourceManagerReloadListener
{
    ...
    public int drawString(final String text, final int x, final double d, final int color) {
        return this.enabled ? this.drawString(text, (float)x, (float)d, color, false) : 0;
    }
