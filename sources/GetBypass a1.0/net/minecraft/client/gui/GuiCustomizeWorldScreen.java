...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_175341_a, (float)(this.width / 2), 2, 16777215);
        this.drawCenteredString(this.fontRendererObj, this.field_175333_f, (float)(this.width / 2), 12, 16777215);
        this.drawCenteredString(this.fontRendererObj, this.field_175335_g, (float)(this.width / 2), 22, 16777215);
        super.drawScreen(mouseX, mouseY, partialTicks);
        if (this.field_175339_B != 0) {
            Gui.drawRect(0, 0.0, this.width, this.height, Integer.MIN_VALUE);
            ...
            tessellator.draw();
            this.drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirmTitle", new Object[0]), (float)(this.width / 2), 105, 16777215);
            this.drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirm1", new Object[0]), (float)(this.width / 2), 125, 16777215);
            this.drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirm2", new Object[0]), (float)(this.width / 2), 135, 16777215);
