...
public class GuiStreamUnavailable extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_152324_f.getFormattedText(), (float)(this.width / 2), i - this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
        for (final String s : this.field_152323_r) {
            this.drawCenteredString(this.fontRendererObj, s, (float)(this.width / 2), i, 10526880);
