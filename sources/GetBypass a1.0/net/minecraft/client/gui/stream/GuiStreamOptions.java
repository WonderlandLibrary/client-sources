...
public class GuiStreamOptions extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_152319_i, (float)(this.width / 2), 20, 16777215);
        this.drawCenteredString(this.fontRendererObj, this.field_152313_r, (float)(this.width / 2), this.field_152314_s, 16777215);
        if (this.field_152315_t) {
            this.drawCenteredString(this.fontRendererObj, EnumChatFormatting.RED + I18n.format("options.stream.changes", new Object[0]), (float)(this.width / 2), 20 + this.fontRendererObj.FONT_HEIGHT, 16777215);
        }
