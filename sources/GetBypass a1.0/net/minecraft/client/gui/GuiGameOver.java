...
import today.getbypass.ui.MainMenu;
...
public class GuiGameOver extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, s, (float)(this.width / 2 / 2), 30, 16777215);
        GlStateManager.popMatrix();
        if (flag) {
            this.drawCenteredString(this.fontRendererObj, I18n.format("deathScreen.hardcoreInfo", new Object[0]), (float)(this.width / 2), 144, 16777215);
        }
        this.drawCenteredString(this.fontRendererObj, String.valueOf(I18n.format("deathScreen.score", new Object[0])) + ": " + EnumChatFormatting.YELLOW + this.mc.thePlayer.getScore(), (float)(this.width / 2), 100, 16777215);
