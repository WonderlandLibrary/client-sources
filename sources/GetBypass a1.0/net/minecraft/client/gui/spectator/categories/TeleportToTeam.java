    ...
    class TeamSelectionObject implements ISpectatorMenuObject
    {
        ...
        public void func_178663_a(final float p_178663_1_, final int alpha) {
            ...
            if (i >= 0) {
                ...
                Gui.drawRect(1, 1.0, 15, 15.0, MathHelper.func_180183_b(f * p_178663_1_, f2 * p_178663_1_, f3 * p_178663_1_) | alpha << 24);
            }
            ...
            Gui.drawScaledCustomSizeModalRect(2.0f, 2.0f, 8.0f, 8.0f, 8.0, 8.0, 12.0, 12.0, 64.0f, 64.0f);
            Gui.drawScaledCustomSizeModalRect(2.0f, 2.0f, 40.0f, 8.0f, 8.0, 8.0, 12.0, 12.0, 64.0f, 64.0f);
        }
