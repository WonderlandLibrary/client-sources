...
public class GuiSnooper extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_146610_i, (float)(this.width / 2), 8, 16777215);
        int i = 22;
        ...
        for (int length = (field_146607_r = this.field_146607_r).length, j = 0; j < length; ++j) {
            ...
            this.drawCenteredString(this.fontRendererObj, s, (float)(this.width / 2), i, 8421504);
