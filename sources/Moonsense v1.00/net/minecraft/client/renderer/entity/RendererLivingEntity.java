...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public <V extends EntityLivingBase, U extends LayerRenderer<V>> boolean addLayer(LayerSpiderEyes layerSpiderEyes)
    {
        return this.layerRenderers.add((LayerRenderer<T>)layerSpiderEyes);
    }
    
    public <V extends EntityLivingBase, U extends LayerRenderer<V>> boolean addLayer(LayerWolfCollar layerWolfCollar)
    {
        return this.layerRenderers.add((LayerRenderer<T>)layerWolfCollar);
    }
    
    public <V extends EntityLivingBase, U extends LayerRenderer<V>> boolean addLayer(LayerSheepWool layerSheepWool)
    {
        return this.layerRenderers.add((LayerRenderer<T>)layerSheepWool);
    }
    
    public <V extends EntityLivingBase, U extends LayerRenderer<V>> boolean addLayer(LayerEndermanEyes layerEndermanEyes)
    {
        return this.layerRenderers.add((LayerRenderer<T>)layerEndermanEyes);
    }
    
    public <V extends EntityLivingBase, U extends LayerRenderer<V>> boolean addLayer(LayerCape layerCape)
    {
        return this.layerRenderers.add((LayerRenderer<T>)layerCape);
    }
    
    public <V extends EntityLivingBase, U extends LayerRenderer<V>> boolean addLayer(LayerEnderDragonEyes layerEnderDragonEyes)
    {
