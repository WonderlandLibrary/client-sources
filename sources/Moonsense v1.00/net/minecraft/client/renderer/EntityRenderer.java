...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof MoonsenseMainMenu)
        {
            this.updateMainMenu((MoonsenseMainMenu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(MoonsenseMainMenu p_updateMainMenu_1_)
    {
        try
        {
            String s = null;
            ...
            Field[] afield = MoonsenseMainMenu.class.getDeclaredFields();
