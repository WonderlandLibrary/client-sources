...
public class Gui
{
     ...
     */
    public static void drawRect(float g, float h, float right, float bottom, int color)
    {
        if (g < right)
        {
            float i = g;
        ...
        worldrenderer.pos((double)g, (double)bottom, 0.0D).endVertex();
        worldrenderer.pos((double)right, (double)bottom, 0.0D).endVertex();
        worldrenderer.pos((double)right, (double)h, 0.0D).endVertex();
