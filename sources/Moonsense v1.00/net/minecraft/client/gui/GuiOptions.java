...
import moonsense.gui.menus.CosmeticGuiScreen;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(69, this.width / 2 - 100, this.height / 6 + 165, I18n.format("Cosmetics", new Object[0])));
        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, this.height / 6 + 190, I18n.format("gui.done", new Object[0])));
    }
