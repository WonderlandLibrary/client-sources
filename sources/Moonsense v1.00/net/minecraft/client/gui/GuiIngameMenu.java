...
import moonsense.gui.GuiMultiplayerIngame;
...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        if(mc.isSingleplayer()) {
        	...
        	this.buttonList.add(new GuiButton(10348, this.width / 2 + 2, this.height / 4 + 96 + i, 98, 20, "Server List"));
        }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 1:
                ...
                if (flag)
                {
                    this.mc.displayGuiScreen(new MoonsenseMainMenu());
                }
                else if (flag1)
                {
                    RealmsBridge realmsbridge = new RealmsBridge();
                    realmsbridge.switchToRealms(new MoonsenseMainMenu());
                }
                else
                {
                    this.mc.displayGuiScreen(new GuiMultiplayer(new MoonsenseMainMenu()));
                }
