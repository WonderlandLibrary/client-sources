...
import org.neverhook.client.ui.font.FontUtil;
...
import org.neverhook.security.utils.HttpUtils;
...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    private void startGame() throws LWJGLException {
        ...
        this.sfuiFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/comfortaa.ttf"), 19.0F, 0), true, true);
        this.bigFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/sf-ui.ttf"), 48.0F, 0), true, true);
        this.clickguismall = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/sf-ui.ttf"), 16.5F, 0), true, true);
        this.notification = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/notification.ttf"), 45, 0), true, true);
        this.smallfontRenderer = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/sf-ui.ttf"), 14.0F, 0), true, true);
        this.fontRenderer = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/sf-ui.ttf"), 18, 0), true, true);
        this.buttonFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/quicksand.ttf"), 28, 0), true, true);
        this.bigButtonFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/quicksand.ttf"), 35, 0), true, true);
        this.arrayListQuick = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/quicksand.ttf"), 20, 0), true, true);
        this.verdanaFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/verdana.ttf"), 19, 0), true, true);
        this.robotoRegularFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/robotoregular.ttf"), 19, 0), true, true);
        this.latoFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/lato.ttf"), 19, 0), true, true);
        this.latoBig = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/lato.ttf"), 25, 0), true, true);
        this.openSansFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/opensans.ttf"), 19, 0), true, true);
        this.ubuntuFontRender = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/ubuntu.ttf"), 19, 0), true, true);
        this.lucidaConsoleFontRenderer = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/lucidaconsole.ttf"), 19, 0), true, true);
        this.helvetica = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/helvetica.ttf"), 19, 0), true, true);
        this.calibri = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/calibri.ttf"), 20, 0), true, true);
        this.productsans = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/productsans.ttf"), 20, 0), true, true);
        this.raleway = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/raleway.ttf"), 20, 0), true, true);
        this.kollektif = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/kollektif.ttf"), 20, 0), true, true);
        this.aldotheapache = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/apache.ttf"), 20, 0), true, true);
        this.museosans = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/museo.ttf"), 20, 0), true, true);
        this.smallwtf = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/sf-ui.ttf"), 11, 0), true, true);
        this.icons = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/icons.ttf"), 40, 0), true, true);
        this.circleregular = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/circle-regular.ttf"), 19, 0), true, true);
        this.circleregularSmall = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/sf-ui.ttf"), 16, 0), true, true);
        this.jetbrains = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/jetbrainsmono.ttf"), 19, 0), true, true);
        this.jetbrainsSmall = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/jetbrainsmono.ttf"), 15, 0), true, true);
        this.menlo = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/menlo.ttf"), 19, 0), true, true);
        this.montserratLight = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/montserrat-light.ttf"), 15, 0), true, true);
        this.montserratRegular = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/montserrat-regular.ttf"), 19, 0), true, true);
        this.circleregularSmall1 = new MCFontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("neverhook/font/sf-ui.ttf"), 12, 0), true, true);
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("NeverHook Premium");
