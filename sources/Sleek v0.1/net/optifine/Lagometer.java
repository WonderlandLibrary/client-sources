      ...
      if (gameSettings != null && (gameSettings.ofLagometer || gameSettings.field_181657_aC)) {
         ...
         for(j = 0; j < timesFrame.length; ++j) {
            ...
            if (gcs[j]) {
               ...
               float var10000 = f - (float)renderTime(j, timesTick[j], 0, k, k, f, worldrenderer);
            }
         }
         ...
         mc.MCfontRenderer.drawString("30", 2, k + 1, -8947849);
         mc.MCfontRenderer.drawString("30", 1, k, -3881788);
         mc.MCfontRenderer.drawString("60", 2, j + 1, -8947849);
         mc.MCfontRenderer.drawString("60", 1, j, -3881788);
         GlStateManager.matrixMode(5889);
         ...
         mc.MCfontRenderer.drawString(" " + memMbSec + " MB/s", l1, i2, k1);
