      ...
      if (!Config.equals(s, "PlayerItem")) {
         ...
         for(int i = 0; i < jsonarray.size(); ++i) {
            ...
            if (s1 != null) {
               ...
               while(var12.hasNext()) {
                  Entry<String, JsonElement> entry = (Entry)var12.next();
   ...
   public static ModelRenderer parseModelRenderer(JsonObject elem, ModelBase modelBase, int[] parentTextureSize, String basePath) {
      ...
      if (jsonarray != null) {
         for(int j = 0; j < jsonarray.size(); ++j) {
            ...
            afloat3 = Json.parseFloatArray(jsonobject.get("coordinates"), 6);
            if (afloat3 == null) {
            ...
            f2 = Json.getFloat(jsonobject, "sizeAdd", 0.0F);
            if (aint2 != null) {
               modelrenderer.addBox(aint2, afloat3[0], afloat3[1], afloat3[2], afloat3[3], afloat3[4], afloat3[5], f2);
            } else {
      ...
      if (jsonarray1 != null) {
         for(int k = 0; k < jsonarray1.size(); ++k) {
            ...
            afloat3 = Json.parseFloatArray(jsonobject2.get("coordinates"), 6);
            if (afloat3 == null) {
               throw new JsonParseException("Coordinates not specified");
            }
            ...
            f2 = Json.getFloat(jsonobject2, "sizeAdd", 0.0F);
      ...
      jsonobject = (JsonObject)elem.get("submodel");
      if (jsonobject != null) {
         ModelRenderer modelrenderer2 = parseModelRenderer(jsonobject, modelBase, aint, basePath);
