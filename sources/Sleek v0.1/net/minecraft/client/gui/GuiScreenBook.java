   ...
   private void sendBookToServer(boolean publish) throws IOException {
      if (this.bookIsUnsigned && this.bookIsModified && this.bookPages != null) {
         ...
         while(this.bookPages.tagCount() > 1) {
            s2 = this.bookPages.getStringTagAt(this.bookPages.tagCount() - 1);
            if (s2.length() != 0) {
               break;
            }
      ...
      if (this.bookGettingSigned) {
         ...
         if (this.bookIsUnsigned) {
            if (this.updateCount / 6 % 2 == 0) {
               s4 = s4 + "" + ChatFormatting.BLACK + "_";
            } else {
               s4 = s4 + "" + ChatFormatting.GRAY + "_";
            }
         }

         s5 = I18n.format("book.editTitle");
         j1 = this.fontRendererObj.getStringWidth(s5);
         this.fontRendererObj.drawString(s5, i + 36 + (116 - j1) / 2, j + 16 + 16, 0);
         k1 = this.fontRendererObj.getStringWidth(s4);
         this.fontRendererObj.drawString(s4, i + 36 + (116 - k1) / 2, j + 48, 0);
         String s2 = I18n.format("book.byAuthor", this.editingPlayer.getCommandSenderName());
         int i1 = this.fontRendererObj.getStringWidth(s2);
         this.fontRendererObj.drawString(ChatFormatting.DARK_GRAY + s2, i + 36 + (116 - i1) / 2, j + 48 + 10, 0);
         ...
         if (this.bookIsUnsigned) {
            ...
            if (ItemEditableBook.validBookTagContents(this.bookObj.getTagCompound())) {
               ...
               ChatComponentText chatcomponenttext = new ChatComponentText(ChatFormatting.DARK_RED.toString() + "* Invalid book tag *");
         ...
         if (this.field_175386_A == null) {
            ...
            k1 = Math.min(128 / this.fontRendererObj.FONT_HEIGHT, this.field_175386_A.size());
   ...
   public IChatComponent func_175385_b(int p_175385_1_, int p_175385_2_) {
      if (this.field_175386_A == null) {
         ...
         if (i >= 0 && j >= 0) {
            ...
            if (i <= 116 && j < this.mc.MCfontRenderer.FONT_HEIGHT * k + k) {
               int l = j / this.mc.MCfontRenderer.FONT_HEIGHT;
               if (l >= 0 && l < this.field_175386_A.size()) {
                  IChatComponent ichatcomponent = (IChatComponent)this.field_175386_A.get(l);
                  int i1 = 0;
                  Iterator var9 = ichatcomponent.iterator();

                  while(var9.hasNext()) {
                     IChatComponent ichatcomponent1 = (IChatComponent)var9.next();
                     if (ichatcomponent1 instanceof ChatComponentText) {
                        i1 += this.mc.MCfontRenderer.getStringWidth(((ChatComponentText)ichatcomponent1).getChatComponentText_TextValue());
                        if (i1 > i) {
