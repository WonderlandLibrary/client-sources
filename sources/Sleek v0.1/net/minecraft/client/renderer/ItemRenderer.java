...
public class ItemRenderer {
   ...
   public void renderItemInFirstPerson(float partialTicks) {
      if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
         ...
         if (((KillAura)Slack.getInstance().getModuleManager().getInstance(KillAura.class)).isToggle() && ((KillAura)Slack.getInstance().getModuleManager().getInstance(KillAura.class)).renderBlock) {
            killauraBlock = true;
         }
         ...
         if (this.itemToRender == null) {
            ...
            if (this.itemToRender.getItem() instanceof ItemMap) {
               ...
               case DRINK:
                  ...
                  break;
               case BLOCK:
                  if (((Animations)Slack.getInstance().getModuleManager().getInstance(Animations.class)).isToggle()) {
                     String var9 = (String)((Animations)Slack.getInstance().getModuleManager().getInstance(Animations.class)).blockStyle.getValue();
                     byte var10 = -1;
   ...
   public void updateEquippedItem() {
      ...
      if (ItemSpoofUtil.isEnabled) {
         itemstack = this.mc.thePlayer.inventory.getStackInSlot(ItemSpoofUtil.renderSlot);
      }
         ...
         if (!this.itemToRender.getIsItemStackEqual(itemstack)) {
            if (Reflector.ForgeItem_shouldCauseReequipAnimation.exists()) {
               ...
               if (!flag1) {
                  ...
                  if (ItemSpoofUtil.isEnabled) {
                     this.equippedItemSlot = ItemSpoofUtil.renderSlot;
                  }
