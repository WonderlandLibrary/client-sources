...
public class TileEntityHopper extends TileEntityLockable implements IHopper, ITickable {
   ...
   public static boolean captureDroppedItems(IHopper p_145891_0_) {
      ...
      if (iinventory != null) {
         ...
         Iterator var6 = func_181556_a(p_145891_0_.getWorld(), p_145891_0_.getXPos(), p_145891_0_.getYPos() + 1.0D, p_145891_0_.getZPos()).iterator();

         while(var6.hasNext()) {
            EntityItem entityitem = (EntityItem)var6.next();
