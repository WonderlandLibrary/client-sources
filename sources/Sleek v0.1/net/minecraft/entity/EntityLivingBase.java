...
public abstract class EntityLivingBase extends Entity {
   ...
   protected void jump() {
      ...
      if (this != mc.getPlayer() || !event.call().isCanceled()) {
   ...
   public void onLivingUpdate() {
      ...
      if (this.isJumping) {
         if (this.isInWater()) {
            ...
            this.jump();
            this.jumpTicks = 10;
            if (((Tweaks)Slack.getInstance().getModuleManager().getInstance(Tweaks.class)).isToggle() && (Boolean)((Tweaks)Slack.getInstance().getModuleManager().getInstance(Tweaks.class)).nojumpdelay.getValue()) {
               this.jumpTicks = (Integer)((Tweaks)Slack.getInstance().getModuleManager().getInstance(Tweaks.class)).noJumpDelayTicks.getValue();
            }
         }
      } else {
         this.jumpTicks = 0;
