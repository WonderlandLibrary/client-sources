...
public class ItemEditableBook extends Item {
   ...
   public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
      if (stack.hasTagCompound()) {
         ...
         if (!StringUtils.isNullOrEmpty(s)) {
            tooltip.add(ChatFormatting.GRAY + StatCollector.translateToLocalFormatted("book.byAuthor", s));
         }

         tooltip.add(ChatFormatting.GRAY + StatCollector.translateToLocal("book.generation." + nbttagcompound.getInteger("generation")));
      }
         ...
         if (!nbttagcompound.getBoolean("resolved")) {
            ...
            if (validBookTagContents(nbttagcompound)) {
               ...
               for(int i = 0; i < nbttaglist.tagCount(); ++i) {
                  ...
                  nbttaglist.set(i, new NBTTagString(IChatComponent.Serializer.componentToJson((IChatComponent)ichatcomponent)));
               }
