...
public class JsonToNBT {
   ...
   static int func_150310_b(String p_150310_0_) throws NBTException {
      ...
      for(int j = 0; j < p_150310_0_.length(); ++j) {
         ...
         if (c0 == '"') {
            ...
            if (c0 != '{' && c0 != '[') {
               if (c0 == '}' && (stack.isEmpty() || (Character)stack.pop() != '{')) {
   ...
   static JsonToNBT.Any func_150316_a(String p_150316_0_, String p_150316_1_) throws NBTException {
      ...
      if (p_150316_1_.startsWith("{")) {
         ...
         for(jsontonbt$compound = new JsonToNBT.Compound(p_150316_0_); p_150316_1_.length() > 0; p_150316_1_ = p_150316_1_.substring(s.length() + 1)) {
            s = func_150314_a(p_150316_1_, true);
            if (s.length() > 0) {
               flag = false;
               jsontonbt$compound.field_150491_b.add(func_179270_a(s, flag));
            }
            ...
            c0 = p_150316_1_.charAt(s.length());
            if (c0 != ',' && c0 != '{' && c0 != '}' && c0 != '[' && c0 != ']') {
   ...
   static class List extends JsonToNBT.Any {
      ...
      public NBTBase parse() throws NBTException {
         ...
         while(var2.hasNext()) {
            JsonToNBT.Any jsontonbt$any = (JsonToNBT.Any)var2.next();
