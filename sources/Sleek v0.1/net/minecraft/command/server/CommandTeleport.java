      ...
      if (args.length < 1) {
         ...
         if (args.length != 1 && args.length != 2) {
            ...
            if (((Entity)entity).worldObj != null) {
               ...
               notifyOperators(sender, this, "commands.tp.success.coordinates", new Object[]{((Entity)entity).getCommandSenderName(), commandbase$coordinatearg.func_179628_a(), commandbase$coordinatearg1.func_179628_a(), commandbase$coordinatearg2.func_179628_a()});
            }
         } else {
            ...
            notifyOperators(sender, this, "commands.tp.success", new Object[]{((Entity)entity).getCommandSenderName(), entity1.getCommandSenderName()});
         }
