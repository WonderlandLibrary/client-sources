      ...
      if (!Config.isShaders() || !Shaders.isShadowPass) {
         ...
         if (entity != null) {
            ...
            for(k = 0; k <= 24; ++k) {
               ...
               f7 = (float)k / 24.0F;
               worldrenderer.pos(x + d13 * (double)f7 + 0.0D, y + d14 * (double)(f7 * f7 + f7) * 0.5D + (double)((24.0F - (float)k) / 18.0F + 0.125F), z + d15 * (double)f7).func_181666_a(f4, f5, f6, 1.0F).endVertex();
               worldrenderer.pos(x + d13 * (double)f7 + 0.025D, y + d14 * (double)(f7 * f7 + f7) * 0.5D + (double)((24.0F - (float)k) / 18.0F + 0.125F) + 0.025D, z + d15 * (double)f7).func_181666_a(f4, f5, f6, 1.0F).endVertex();
            }
