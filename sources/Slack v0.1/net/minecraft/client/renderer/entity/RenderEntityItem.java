   ...
   public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      for(int j = 0; j < i; ++j) {
         ...
         if (ibakedmodel.isGui3d()) {
            ...
            this.itemRenderer.renderItem(itemstack, ibakedmodel);
            GlStateManager.popMatrix();
            f = ibakedmodel.getItemCameraTransforms().field_181699_o.scale.x;
            f1 = ibakedmodel.getItemCameraTransforms().field_181699_o.scale.y;
            f2 = ibakedmodel.getItemCameraTransforms().field_181699_o.scale.z;
