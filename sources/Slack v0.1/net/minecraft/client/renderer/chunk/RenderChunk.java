...
public class RenderChunk {
   ...
   public void setPosition(BlockPos pos) {
      ...
      int k;
      for(k = 0; k < this.positionOffsets16.length; ++k) {
         this.positionOffsets16[k] = null;
      }

      this.renderChunksOffset16Updated = false;
      this.renderChunkNeighboursUpated = false;

      for(k = 0; k < this.renderChunkNeighbours.length; ++k) {
   ...
   public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
      ...
      if (!this.isChunkRegionEmpty(blockpos)) {
         ...
         EnumWorldBlockLayer[] var36 = ENUM_WORLD_BLOCK_LAYERS;
         int var37 = var36.length;

         for(int var38 = 0; var38 < var37; ++var38) {
            EnumWorldBlockLayer enumworldblocklayer1 = var36[var38];
