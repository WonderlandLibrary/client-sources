   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      for(int l = 0; l < 3; ++l) {
         ...
         if (l1 == 0) {
            ...
            fontrenderer = this.mc.MCfontRenderer;
      ...
      for(int j = 0; j < 3; ++j) {
         ...
         if (this.isPointInRegion(60, 14 + 19 * j, 108, 17, mouseX, mouseY) && k > 0 && l >= 0) {
            ...
            if (l >= 0 && Enchantment.getEnchantmentById(l & 255) != null) {
               s1 = Enchantment.getEnchantmentById(l & 255).getTranslatedName((l & '\uff00') >> 8);
               list.add(ChatFormatting.WHITE.toString() + ChatFormatting.ITALIC.toString() + I18n.format("container.enchant.clue", s1));
            }
            ...
            if (!flag) {
               ...
               if (this.mc.thePlayer.experienceLevel < k) {
                  list.add(ChatFormatting.RED.toString() + "Level Requirement: " + this.container.enchantLevels[j]);
               } else {
                  s1 = "";
                  if (i1 == 1) {
                  ...
                  if (i >= i1) {
                     list.add(ChatFormatting.GRAY.toString() + "" + s1);
                  } else {
                     list.add(ChatFormatting.RED.toString() + "" + s1);
                  }
