      ...
      if (args.length < 2) {
         ...
         if (args[1].equals("clear")) {
            ...
            if (l > 0) {
               ...
               notifyOperators(sender, this, "commands.effect.success", new Object[]{new ChatComponentTranslation(potioneffect.getEffectName(), new Object[0]), i, k, entitylivingbase.getCommandSenderName(), l});
            } else {
