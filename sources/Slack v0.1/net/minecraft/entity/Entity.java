...
public abstract class Entity implements ICommandSender {
   ...
   public void moveEntity(double x, double y, double z, boolean safewalk) {
      if (this.noClip) {
         ...
         for(Iterator var23 = list1.iterator(); var23.hasNext(); y = axisalignedbb1.calculateYOffset(this.getEntityBoundingBox(), y)) {
         ...
         Iterator var56;
         for(var56 = list1.iterator(); var56.hasNext(); x = axisalignedbb13.calculateXOffset(this.getEntityBoundingBox(), x)) {
            axisalignedbb13 = (AxisAlignedBB)var56.next();
         }

         this.setEntityBoundingBox(this.getEntityBoundingBox().offset(x, 0.0D, 0.0D));

         for(var56 = list1.iterator(); var56.hasNext(); z = axisalignedbb13.calculateZOffset(this.getEntityBoundingBox(), z)) {
            axisalignedbb13 = (AxisAlignedBB)var56.next();
         }
         ...
         if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
            ...
            for(Iterator var36 = list.iterator(); var36.hasNext(); d9 = axisalignedbb6.calculateYOffset(axisalignedbb5, d9)) {
               axisalignedbb6 = (AxisAlignedBB)var36.next();
            }
            ...
            for(Iterator var38 = list.iterator(); var38.hasNext(); d15 = axisalignedbb7.calculateXOffset(axisalignedbb4, d15)) {
               axisalignedbb7 = (AxisAlignedBB)var38.next();
            }
            ...
            for(Iterator var40 = list.iterator(); var40.hasNext(); d16 = axisalignedbb8.calculateZOffset(axisalignedbb4, d16)) {
               axisalignedbb8 = (AxisAlignedBB)var40.next();
            }
            ...
            for(Iterator var43 = list.iterator(); var43.hasNext(); d17 = axisalignedbb9.calculateYOffset(axisalignedbb14, d17)) {
               axisalignedbb9 = (AxisAlignedBB)var43.next();
            }
            ...
            for(Iterator var45 = list.iterator(); var45.hasNext(); d18 = axisalignedbb10.calculateXOffset(axisalignedbb14, d18)) {
               axisalignedbb10 = (AxisAlignedBB)var45.next();
            }
            ...
            for(Iterator var47 = list.iterator(); var47.hasNext(); d19 = axisalignedbb11.calculateZOffset(axisalignedbb14, d19)) {
               axisalignedbb11 = (AxisAlignedBB)var47.next();
            }
            ...
            for(Iterator var51 = list.iterator(); var51.hasNext(); y = axisalignedbb12.calculateYOffset(this.getEntityBoundingBox(), y)) {
   ...
   public void moveFlying(float strafe, float forward, float friction) {
         ...
         if (RotationUtil.strafeFix) {
            ...
            if (!RotationUtil.strictStrafeFix) {
               if (MovementUtil.isBindsMoving()) {
                  int strafeYaw = Math.round((RotationUtil.clientRotation[0] - MovementUtil.getBindsDirection(mc.getPlayer().rotationYaw)) / 45.0F);
                  if (strafeYaw > 4) {
                     strafeYaw -= 8;
                  }
                  ...
                  mc.getGameSettings().keyBindForward.pressed = Math.abs(strafeYaw) <= 1;
                  mc.getGameSettings().keyBindLeft.pressed = strafeYaw >= 1 && strafeYaw <= 3;
                  mc.getGameSettings().keyBindBack.pressed = Math.abs(strafeYaw) >= 3;
      ...
      if (!event.isCanceled()) {
         ...
         if (f >= 1.0E-4F) {
            ...
            this.motionX += (double)(event.getStrafe() * f2 - event.getForward() * f1);
            this.motionZ += (double)(event.getForward() * f2 + event.getStrafe() * f1);
         }
   ...
   public float getCollisionBorderSize() {
      return ((Hitbox)Slack.getInstance().getModuleManager().getInstance(Hitbox.class)).isToggle() ? 0.1F + (Float)((Hitbox)Slack.getInstance().getModuleManager().getInstance(Hitbox.class)).hitboxSize.getValue() : 0.1F;
   }
