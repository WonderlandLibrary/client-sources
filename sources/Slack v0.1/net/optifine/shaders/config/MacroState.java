   ...
   private void processMacro(String name, String param) {
      ...
      if (name.equals("define")) {
         ...
         if (name.equals("ifdef")) {
            flag4 = this.mapMacroValues.containsKey(s);
            ...
            case 0:
               ...
               if (flag7) {
                  ...
                  flag8 = this.eval(param);
                  this.dequeState.add(flag8);
                  this.dequeResolved.add(flag8);
               }
               break;
            case 1:
               flag8 = (Boolean)this.dequeState.removeLast();
      ...
      do {
         ...
         do {
            do {
               ...
               c0 = s.charAt(0);
            } while(!Character.isLetter(c0) && c0 != '_');
         } while(!this.mapMacroValues.containsKey(s));
