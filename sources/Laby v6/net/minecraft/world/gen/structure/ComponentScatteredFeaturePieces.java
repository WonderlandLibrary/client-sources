...
public class ComponentScatteredFeaturePieces
{
    ...
    public static class DesertPyramid extends ComponentScatteredFeaturePieces.Feature
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                if (!this.field_74940_h[((EnumFacing) enumfacing).getHorizontalIndex()])
                {
                    int l1 = ((EnumFacing) enumfacing).getFrontOffsetX() * 2;
                    int i2 = ((EnumFacing) enumfacing).getFrontOffsetZ() * 2;
                    this.field_74940_h[((EnumFacing) enumfacing).getHorizontalIndex()] = this.generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 10 + l1, -11, 10 + i2, WeightedRandomChestContent.func_177629_a(itemsToGenerateInTemple, new WeightedRandomChestContent[] {Items.enchanted_book.getRandom(randomIn)}), 2 + randomIn.nextInt(5));
                }
            }
