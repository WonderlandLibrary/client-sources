...
public class ConnectedTextures
{
        ...
        else
        {
            ...
            if (tileProperties != null)
            {
                ...
                if (i >= 0 && i < tileProperties.length)
                {
                    ...
                    {
                        int j = blockstatebase.getMetadata();
                        ...
                        for (int l = 0; l < aconnectedproperties.length; ++l)
                        {
                            ...
                            if (connectedproperties != null && connectedproperties.matchesBlock(blockstatebase))
                            {
            ...
            if (blockProperties != null && p_getConnectedTextureSingle_5_)
            {
                ...
                if (i1 >= 0 && i1 < blockProperties.length)
                {
                    ConnectedProperties[] aconnectedproperties1 = blockProperties[i1];

                    if (aconnectedproperties1 != null)
                    {
                        int j1 = blockstatebase.getMetadata();
                        int k1 = getSide(p_getConnectedTextureSingle_3_);

                        for (int l1 = 0; l1 < aconnectedproperties1.length; ++l1)
                        {
                            ConnectedProperties connectedproperties1 = aconnectedproperties1[l1];

                            if (connectedproperties1 != null && connectedproperties1.matchesIcon(p_getConnectedTextureSingle_4_) && connectedproperties1.matchesBlock(blockstatebase))
                            {
                                TextureAtlasSprite textureatlassprite1 = getConnectedTexture(connectedproperties1, p_getConnectedTextureSingle_0_, p_getConnectedTextureSingle_1_, p_getConnectedTextureSingle_2_, k1, p_getConnectedTextureSingle_4_, j1, p_getConnectedTextureSingle_6_);
    ...
    private static TextureAtlasSprite getConnectedTexture(ConnectedProperties p_getConnectedTexture_0_, IBlockAccess p_getConnectedTexture_1_, IBlockState p_getConnectedTexture_2_, BlockPos p_getConnectedTexture_3_, int p_getConnectedTexture_4_, TextureAtlasSprite p_getConnectedTexture_5_, int p_getConnectedTexture_6_, RenderEnv p_getConnectedTexture_7_)
    {
        ...
        if (i >= p_getConnectedTexture_0_.minHeight && i <= p_getConnectedTexture_0_.maxHeight)
        {
            ...
            int k = 0;
            int l = p_getConnectedTexture_6_;
            Block block = p_getConnectedTexture_2_.getBlock();

            if (block instanceof BlockRotatedPillar)
            {
                k = getWoodAxis(p_getConnectedTexture_4_, p_getConnectedTexture_6_);
                l = p_getConnectedTexture_6_ & 3;
            }

            if (block instanceof BlockQuartz)
            {
                k = getQuartzAxis(p_getConnectedTexture_4_, p_getConnectedTexture_6_);
            ...
            {
                int i1 = p_getConnectedTexture_4_;

                if (k != 0)
                {
                    i1 = fixSideByAxis(p_getConnectedTexture_4_, k);
                }

                if ((1 << i1 & p_getConnectedTexture_0_.faces) == 0)
                {
                    return null;
                }
            }
            ...
            switch (p_getConnectedTexture_0_.method)
            {
                ...
                case 2:
                    return getConnectedTextureHorizontal(p_getConnectedTexture_0_, p_getConnectedTexture_1_, p_getConnectedTexture_2_, p_getConnectedTexture_3_, k, p_getConnectedTexture_4_, p_getConnectedTexture_5_, p_getConnectedTexture_6_);

                case 3:
                    return getConnectedTextureTop(p_getConnectedTexture_0_, p_getConnectedTexture_1_, p_getConnectedTexture_2_, p_getConnectedTexture_3_, k, p_getConnectedTexture_4_, p_getConnectedTexture_5_, p_getConnectedTexture_6_);
                ...
                case 6:
                    return getConnectedTextureVertical(p_getConnectedTexture_0_, p_getConnectedTexture_1_, p_getConnectedTexture_2_, p_getConnectedTexture_3_, k, p_getConnectedTexture_4_, p_getConnectedTexture_5_, p_getConnectedTexture_6_);

                case 7:
                    return getConnectedTextureFixed(p_getConnectedTexture_0_);

                case 8:
                    return getConnectedTextureHorizontalVertical(p_getConnectedTexture_0_, p_getConnectedTexture_1_, p_getConnectedTexture_2_, p_getConnectedTexture_3_, k, p_getConnectedTexture_4_, p_getConnectedTexture_5_, p_getConnectedTexture_6_);

                case 9:
                    return getConnectedTextureVerticalHorizontal(p_getConnectedTexture_0_, p_getConnectedTexture_1_, p_getConnectedTexture_2_, p_getConnectedTexture_3_, k, p_getConnectedTexture_4_, p_getConnectedTexture_5_, p_getConnectedTexture_6_);
