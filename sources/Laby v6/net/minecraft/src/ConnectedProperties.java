...
public class ConnectedProperties
{
    ...
    public ConnectedProperties(Properties p_i33_1_, String p_i33_2_)
    {
        ...
        this.matchTiles = this.parseMatchTiles(p_i33_1_.getProperty("matchTiles"));
        this.method = parseMethod(p_i33_1_.getProperty("method"));
        this.tiles = this.parseTileNames(p_i33_1_.getProperty("tiles"));
        ...
        this.minHeight = connectedparser.parseInt(p_i33_1_.getProperty("minHeight"), -1);
        this.maxHeight = connectedparser.parseInt(p_i33_1_.getProperty("maxHeight"), 1024);
    ...
    public boolean matchesBlock(BlockStateBase p_matchesBlock_1_)
    {
        ...
        {
            boolean flag1 = false;
            int k = p_matchesBlock_1_.getMetadata();

            for (int l = 0; l < this.metadatas.length; ++l)
            {
                int j = this.metadatas[l];
