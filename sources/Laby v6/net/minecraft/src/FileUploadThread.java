...
public class FileUploadThread extends Thread
{
    ...
    public FileUploadThread(String p_i43_1_, Map p_i43_2_, byte[] p_i43_3_, IFileUploadListener p_i43_4_)
    {
        this.urlString = p_i43_1_;
        this.headers = p_i43_2_;
        this.content = p_i43_3_;
        this.listener = p_i43_4_;
    }
