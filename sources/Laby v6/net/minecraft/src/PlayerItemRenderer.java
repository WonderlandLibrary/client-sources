...
public class PlayerItemRenderer
{
    ...
    public PlayerItemRenderer(int p_i69_1_, float p_i69_2_, ModelRenderer p_i69_3_)
    {
        this.attachTo = p_i69_1_;
        this.scaleFactor = p_i69_2_;
        this.modelRenderer = p_i69_3_;
    }
