...
public class ModelSprite
{
    ...
    public ModelSprite(ModelRenderer p_i62_1_, int p_i62_2_, int p_i62_3_, float p_i62_4_, float p_i62_5_, float p_i62_6_, int p_i62_7_, int p_i62_8_, int p_i62_9_, float p_i62_10_)
    {
        this.modelRenderer = p_i62_1_;
        this.textureOffsetX = p_i62_2_;
        this.textureOffsetY = p_i62_3_;
        this.posX = p_i62_4_;
        this.posY = p_i62_5_;
        this.posZ = p_i62_6_;
        this.sizeX = p_i62_7_;
        this.sizeY = p_i62_8_;
        this.sizeZ = p_i62_9_;
        this.sizeAdd = p_i62_10_;
        this.minU = (float)p_i62_2_ / p_i62_1_.textureWidth;
        this.minV = (float)p_i62_3_ / p_i62_1_.textureHeight;
        this.maxU = (float)(p_i62_2_ + p_i62_7_) / p_i62_1_.textureWidth;
        this.maxV = (float)(p_i62_3_ + p_i62_8_) / p_i62_1_.textureHeight;
    }
