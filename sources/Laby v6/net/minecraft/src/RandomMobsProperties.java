...
public class RandomMobsProperties
{
    ...
    public RandomMobsProperties(String p_i72_1_, ResourceLocation[] p_i72_2_)
    {
        ConnectedParser connectedparser = new ConnectedParser("RandomMobs");
        this.name = connectedparser.parseName(p_i72_1_);
        this.basePath = connectedparser.parseBasePath(p_i72_1_);
        this.resourceLocations = p_i72_2_;
    }

    public RandomMobsProperties(Properties p_i73_1_, String p_i73_2_, ResourceLocation p_i73_3_)
    {
        ConnectedParser connectedparser = new ConnectedParser("RandomMobs");
        this.name = connectedparser.parseName(p_i73_2_);
        this.basePath = connectedparser.parseBasePath(p_i73_2_);
        this.rules = this.parseRules(p_i73_1_, p_i73_3_, connectedparser);
    }
