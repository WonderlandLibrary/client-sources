...
public class RandomMobsRule
{
    ...
    public RandomMobsRule(ResourceLocation p_i74_1_, int[] p_i74_2_, int[] p_i74_3_, BiomeGenBase[] p_i74_4_, RangeListInt p_i74_5_)
    {
        this.baseResLoc = p_i74_1_;
        this.skins = p_i74_2_;
        this.weights = p_i74_3_;
        this.biomes = p_i74_4_;
        this.heights = p_i74_5_;
    }
