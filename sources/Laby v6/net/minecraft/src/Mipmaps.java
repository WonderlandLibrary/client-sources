...
public class Mipmaps
{
    ...
    public Mipmaps(String p_i61_1_, int p_i61_2_, int p_i61_3_, int[] p_i61_4_, boolean p_i61_5_)
    {
        this.iconName = p_i61_1_;
        this.width = p_i61_2_;
        this.height = p_i61_3_;
        this.data = p_i61_4_;
        this.direct = p_i61_5_;
        this.mipmapDimensions = makeMipmapDimensions(p_i61_2_, p_i61_3_, p_i61_1_);
        this.mipmapDatas = generateMipMapData(p_i61_4_, p_i61_2_, p_i61_3_, this.mipmapDimensions);
