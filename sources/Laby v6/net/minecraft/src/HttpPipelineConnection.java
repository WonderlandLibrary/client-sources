...
public class HttpPipelineConnection
{
    ...
    public HttpPipelineConnection(String p_i51_1_, int p_i51_2_)
    {
        this(p_i51_1_, p_i51_2_, Proxy.NO_PROXY);
    }

    public HttpPipelineConnection(String p_i52_1_, int p_i52_2_, Proxy p_i52_3_)
    {
        this.host = null;
        this.port = 0;
