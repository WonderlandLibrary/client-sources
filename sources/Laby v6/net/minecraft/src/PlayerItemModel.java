...
public class PlayerItemModel
{
    ...
    public PlayerItemModel(Dimension p_i68_1_, boolean p_i68_2_, PlayerItemRenderer[] p_i68_3_)
    {
        this.textureSize = p_i68_1_;
        this.usePlayerTexture = p_i68_2_;
        this.modelRenderers = p_i68_3_;
    }
