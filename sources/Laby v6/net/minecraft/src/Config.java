...
public class Config
{
    ...
    public static String getVersionShaders()
    {
        ...
        return s == null ? "OptiFine_1.8.8_HD_U_G7" : "OptiFine_1.8.8_HD_U_G7, " + s;
    }
    ...
    public static DefaultResourcePack getDefaultResourcePack()
    {
        if (defaultResourcePack == null)
        {
            ...
            {
                dbg("Error getting default resource pack: " + exception.getClass().getName() + ": " + exception.getMessage());
            }
    ...
    public static void checkDisplaySettings()
    {
        ...
        if (i > 0)
        {
            ...
            if (!Minecraft.isRunningOnMac && getDefaultResourcePack() != null)
            {
                ...
                {
                    dbg("Error setting window icon: " + ioexception.getClass().getName() + ": " + ioexception.getMessage());
                }
                finally
                {
