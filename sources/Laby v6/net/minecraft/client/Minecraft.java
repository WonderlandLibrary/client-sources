...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void runGameLoop() throws IOException
    {
        ...
        LabyMod.getInstance().setPartialTicks(this.timer.renderPartialTicks);
    ...
    private void displayDebugInfo(long elapsedTicksTime)
    {
        if (this.mcProfiler.profilingEnabled)
        {
            ...
            int k2 = 16777215;
            this.fontRendererObj.drawStringWithShadow(s, (float)(j - i), (float)(k - i / 2 - 16), k2);
            this.fontRendererObj.drawStringWithShadow(s = decimalformat.format(profiler$result.field_76330_b) + "%", (float)(j + i - this.fontRendererObj.getStringWidth(s)), (float)(k - i / 2 - 16), k2);
            ...
            for (int l2 = 0; l2 < list.size(); ++l2)
            {
                ...
                this.fontRendererObj.drawStringWithShadow(s1, (float)(j - i), (float)(k + i / 2 + l2 * 8 + 20), profiler$result2.func_76329_a());
                this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profiler$result2.field_76332_a) + "%", (float)(j + i - 50 - this.fontRendererObj.getStringWidth(s1)), (float)(k + i / 2 + l2 * 8 + 20), profiler$result2.func_76329_a());
                this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profiler$result2.field_76330_b) + "%", (float)(j + i - this.fontRendererObj.getStringWidth(s1)), (float)(k + i / 2 + l2 * 8 + 20), profiler$result2.func_76329_a());
            }
        }
    }
    ...
    private void sendClickBlockToController(boolean leftClick)
    {
        ...
        if (this.leftClickCounter <= 0 && (!this.thePlayer.isUsingItem() || ConfigManager.settings.oldBlockBuild && Allowed.blockBuild()))
        {
