...
public class PlayerControllerMP
{
    ...
    {
        if (ConfigManager.settings.oldBlockBuild && Allowed.blockBuild() && this.mc.thePlayer != null && this.mc.thePlayer.isUsingItem())
        {
            return true;
        }
        else
    ...
    {
      if (Jannik.getModuleManager().getModuleByClass(Range.class).isEnabled()) {
        return Values.range_range.getFloatValue();
      }
    ...
    {
        return ConfigManager.settings.oldBlockBuild && Allowed.blockBuild() ? false : this.isHittingBlock;
    }
}
