...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
      if (Jannik.getModuleManager().getModuleByClass(NoToggleSneak.class).isEnabled())
      {
      ...
      else
      {
        ...
        if (this.inPortal)
        {
          ...
          if (this.timeInPortal == 0.0F) {
            this.mc.getSoundHandler().playSound(PositionedSoundRecord.create(new ResourceLocation("portal.trigger"), getRNG().nextFloat() * 0.4F + 0.8F));
          }
          this.timeInPortal += 0.0125F;
          if (this.timeInPortal >= 1.0F) {
            this.timeInPortal = 1.0F;
        ...
        this.customMovementInput.update(this.mc, (MovementInputFromOptions)this.movementInput, this);
        if ((isUsingItem()) && (!isRiding()))
        {
          this.movementInput.moveStrafe *= 0.2F;
          this.movementInput.moveForward *= 0.2F;
        ...
        pushOutOfBlocks(this.posX + this.width * 0.35D, getEntityBoundingBox().minY + 0.5D, this.posZ - this.width * 0.35D);
        pushOutOfBlocks(this.posX + this.width * 0.35D, getEntityBoundingBox().minY + 0.5D, this.posZ + this.width * 0.35D);
        boolean flag2 = (getFoodStats().getFoodLevel() > 6.0F) || (this.capabilities.isFlying);
        boolean flag3 = !ToggleSneakMod.optionToggleSprint;
        boolean flag4 = ToggleSneakMod.optionDoubleTap;
        ...
        if (flag3)
        {
          if ((ToggleSneakMod.optionDoubleTap) && (this.onGround) && (!flag1) && (this.movementInput.moveForward >= f) && (!isSprinting()) && (flag2) && (!isUsingItem()) && (!isPotionActive(Potion.blindness))) {
            if ((this.sprintToggleTimer <= 0) && (!this.mc.gameSettings.keyBindSprint.isKeyDown()))
            {
              this.sprintToggleTimer = 7;
            }
          ...
          if ((!isSprinting()) && (this.movementInput.moveForward >= f) && (flag2) && (!isUsingItem()) && (!isPotionActive(Potion.blindness)) && (this.mc.gameSettings.keyBindSprint.isKeyDown()))
          {
            setSprinting(true);
            this.customMovementInput.UpdateSprint(true, false);
          }
        ...
        {
          boolean flag5 = this.customMovementInput.sprint;
          if ((flag2) && (!isUsingItem()) && (!isPotionActive(Potion.blindness)) && (!this.customMovementInput.sprintHeldAndReleased) && (((flag4) && (!isSprinting())) || (!flag4))) {
            setSprinting(flag5);
          }
          if ((flag4) && (!flag5) && (this.onGround) && (!flag1) && (this.movementInput.moveForward >= f) && (!isSprinting()) && (flag2) && (!isUsingItem()) && (!isPotionActive(Potion.blindness))) {
            if (this.sprintToggleTimer == 0)
            {
              this.sprintToggleTimer = 7;
            }
        ...
        if ((isSprinting()) && ((this.movementInput.moveForward < f) || (this.isCollidedHorizontally) || (!flag2)))
        {
          setSprinting(false);
          if ((this.customMovementInput.sprintHeldAndReleased) || (flag3) || (this.customMovementInput.sprintDoubleTapped) || (this.capabilities.isFlying) || (isRiding())) {
            this.customMovementInput.UpdateSprint(false, false);
          }
        }
        if ((ToggleSneakMod.optionEnableFlyBoost) && (this.capabilities.isFlying) && (this.mc.gameSettings.keyBindSprint.isKeyDown()) && (this.capabilities.isCreativeMode))
        {
          this.capabilities.setFlySpeed(0.05F * (float)ToggleSneakMod.optionFlyBoostAmount);
          if (this.movementInput.sneak) {
            this.motionY -= 0.15D * ToggleSneakMod.optionFlyBoostAmount;
          }
          if (this.movementInput.jump) {
            this.motionY += 0.15D * ToggleSneakMod.optionFlyBoostAmount;
          }
