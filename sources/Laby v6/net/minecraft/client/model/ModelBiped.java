...
public class ModelBiped extends ModelBase
{
    ...
    {
        this.bipedModelSize = modelSize;
        this.bipedF = p_i1149_2_;
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
    {
        ...
        else
        {
            ...
            RenderModelBipedEvent rendermodelbipedevent = null;

            if (ModAPI.enabled())
            {
                rendermodelbipedevent = (RenderModelBipedEvent)ModAPI.callEvent(new RenderModelBipedEvent(this.bipedHead, this.bipedHeadwear, this.bipedBody, this.bipedRightArm, this.bipedLeftArm, this.bipedRightLeg, this.bipedLeftLeg, scale, entityIn, p_78088_2_, p_78088_3_, p_78088_4_, p_78088_5_, p_78088_6_, this));
            }

            if (rendermodelbipedevent != null && rendermodelbipedevent.getModifiedBipedHead() != null)
            {
                this.bipedHead = rendermodelbipedevent.getModifiedBipedHead();
            }
            else
            {
                this.bipedHead.render(scale);
            ...
            if (rendermodelbipedevent != null && rendermodelbipedevent.getModifiedBipedHeadwear() != null)
            {
            ...
            if (rendermodelbipedevent != null && rendermodelbipedevent.getModifiedBipedBody() != null)
            {
                this.bipedBody = rendermodelbipedevent.getModifiedBipedBody();
            }
            else
            {
                this.bipedBody.render(scale);
            ...
            if (rendermodelbipedevent != null && rendermodelbipedevent.getModifiedBipedRightArm() != null)
            {
                this.bipedRightArm = rendermodelbipedevent.getModifiedBipedRightArm();
            }
            else
            {
                this.bipedRightArm.render(scale);
            ...
            if (rendermodelbipedevent != null && rendermodelbipedevent.getModifiedBipedLeftArm() != null)
            {
                this.bipedLeftArm = rendermodelbipedevent.getModifiedBipedLeftArm();
            }
            else
            {
                this.bipedLeftArm.render(scale);
            ...
            if (rendermodelbipedevent != null && rendermodelbipedevent.getModifiedBipedRightLeg() != null)
            {
                this.bipedRightLeg = rendermodelbipedevent.getModifiedBipedRightLeg();
            }
            else
            {
                this.bipedRightLeg.render(scale);
            ...
            if (rendermodelbipedevent != null && rendermodelbipedevent.getModifiedBipedLeftLeg() != null)
            {
                this.bipedLeftLeg = rendermodelbipedevent.getModifiedBipedLeftLeg();
            }
            else
            {
                this.bipedLeftLeg.render(scale);
