...
public class EffectRenderer
{
    ...
    public void updateEffects()
    {
        ...
        for (Object entityparticleemitter : this.particleEmitters)
        {
            ((EntityParticleEmitter) entityparticleemitter).onUpdate();

            if (((EntityParticleEmitter)entityparticleemitter).isDead)
            {
