...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void setUpdate()
    {
        ...
        {
            this.openGLWarning1 = LabyMod.getInstance().getServerBroadcast().getLine1();
            this.openGLWarning2 = LabyMod.getInstance().getServerBroadcast().getLine2();
            this.openGLWarningLink = LabyMod.getInstance().getServerBroadcast().getUrl();
    ...
    public void initGui()
    {
        ...
        {
            this.splashText = "Happy birthday, LabyStudio!";
        }
        ...
        {
            this.splashText = "Back to the Future!";
        }
        else if (calendar.get(2) + 1 == 4 && calendar.get(5) == 13)
        {
            this.splashText = "Happy birthday, LabyMod!";
        }
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        try
        {
            LabyMod.getInstance();
            LabyMod.overWrite();
            String s = this.mc.gameSettings.lastServer;
            String s1 = ConfigManager.settings.last_Server;
            String s2 = "Minecraft Realms";

            if (s != null && ConfigManager.settings.quickPlay)
            {
                if (this.mc.gameSettings.lastServer.isEmpty())
                {
                    if (ConfigManager.settings.last_Server != null && !ConfigManager.settings.last_Server.isEmpty())
                    {
                        this.buttonList.add(new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format(s2, new Object[0])));
                        ...
                        this.buttonList.add(new GuiButton(7, this.width / 2 + 2, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format(s1, new Object[0])));
                    }
                    else
                    {
                        this.buttonList.add(new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format(s2, new Object[0])));
                    }
                }
                else if (ConfigManager.settings.last_Server != null && !ConfigManager.settings.last_Server.isEmpty())
                {
                    ...
                    this.buttonList.add(new GuiButton(6, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format(s, new Object[0])));
                ...
                else
                {
                    ...
                    this.buttonList.add(new GuiButton(6, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format(s, new Object[0])));
                }
            }
    ...
    {
    	if (Jannik.getModuleManager().getModuleByClass(CustomBackGround.class).isEnabled()) {
    		 ...
    		 Gui.drawScaledCustomSizeModalRect(0, 0, 0.0F, 0.0F, r.getScaledWidth(), r.getScaledHeight(), r.getScaledWidth(), r.getScaledHeight(), r.getScaledWidth(), r.getScaledHeight());  
    	}
       
    	if (!this.labyModMessage && (LabyMod.getInstance().chatPacketUpdate || LabyMod.getInstance().getServerBroadcast() != null))
        {
            this.setUpdate();
            this.initGui();
        }
        ...
        this.drawString(this.fontRendererObj, "LabyMod 2.7.99 ", 2, this.height - 10, -1);
        ...
        if (this.openGLWarning1 != null && this.openGLWarning1.length() > 0)
        {
            ...
            this.drawCenteredString(this.fontRendererObj, this.openGLWarning1, this.width / 2, this.field_92021_u, -1);
