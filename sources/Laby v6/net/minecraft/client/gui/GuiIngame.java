...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (!this.mc.gameSettings.showDebugInfo) {
        	EventManager.call(new EventDrawScreen());
    ...
    private void renderPlayerStats(ScaledResolution p_180477_1_)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            float f1 = (float)iattributeinstance.getAttributeValue();
            float f2 = entityplayer.getAbsorptionAmount();
            int l1 = MathHelper.ceiling_float_int((f1 + f2) / 2.0F / 10.0F);
            ...
            {
                l2 = this.updateCounter % MathHelper.ceiling_float_int(f1 + 5.0F);
            }
            ...
            for (int i6 = MathHelper.ceiling_float_int((f1 + f2) / 2.0F) - 1; i6 >= 0; --i6)
            {
                int j6 = 16;
            ...
            if (entity == null)
            {
                ...
                for (int k6 = 0; k6 < 10; ++k6)
                {
                    ...
                    int i10 = j1 - k6 * 8 - 9;
                    this.drawTexturedModalRect(i10, j7, 16 + i9 * 9, 27, 9, 9);

                    if (flag1)
                    {
                        if (k6 * 2 + 1 < l)
                        {
                            this.drawTexturedModalRect(i10, j7, i8 + 54, 27, 9, 9);
                        }

                        if (k6 * 2 + 1 == l)
                        {
                            this.drawTexturedModalRect(i10, j7, i8 + 63, 27, 9, 9);
                        }
                    }

                    if (k6 * 2 + 1 < k)
                    {
                        this.drawTexturedModalRect(i10, j7, i8 + 36, 27, 9, 9);
                    }

                    if (k6 * 2 + 1 == k)
                    {
                        this.drawTexturedModalRect(i10, j7, i8 + 45, 27, 9, 9);
                    }
                }

                if (ConfigManager.settings.foodSaturation && Allowed.foodSaturation() && f != 0.0F)
                {
                    for (int l6 = 0; (float)l6 < f / 2.0F; ++l6)
                    {
                        int k7 = k1 - 10;
                        int j8 = 16;
                        int j9 = 0;
                        ...
                        if (f <= 0.0F && (float)this.updateCounter % (f * 3.0F + 1.0F) == 0.0F)
                        {
                            k7 = k1 + (this.rand.nextInt(3) - 1);
                        }
                        ...
                        int j10 = j1 - l6 * 8 - 9;
                        this.drawTexturedModalRect(j10, k7, 16 + j9 * 9, 27, 9, 9);

                        if (flag1)
                        {
                            if (l6 * 2 + 1 < l)
                            {
                                this.drawTexturedModalRect(j10, k7, j8 + 54, 27, 9, 9);
                            }

                            if (l6 * 2 + 1 == l)
                            {
                                this.drawTexturedModalRect(j10, k7, j8 + 63, 27, 9, 9);
                            }
                        }

                        if ((float)(l6 * 2 + 1) < f)
                        {
                            this.drawTexturedModalRect(j10, k7, j8 + 36, 27, 9, 9);
                        }

                        if ((float)(l6 * 2 + 1) == f)
                        {
                            this.drawTexturedModalRect(j10, k7, j8 + 45, 27, 9, 9);
                        }
                    }
                }
            }
            else if (entity instanceof EntityLivingBase)
            {
                ...
                for (int l10 = 0; l8 > 0; l10 += 20)
                {
                    int l4 = Math.min(l8, 10);
                    l8 -= l4;
                    ...
                    for (int i5 = 0; i5 < l4; ++i5)
                    {
                        ...
                        int l5 = j1 - i5 * 8 - 9;
                        this.drawTexturedModalRect(l5, l9, j5 + k5 * 9, 9, 9, 9);

                        if (i5 * 2 + 1 + l10 < i7)
                        {
                            this.drawTexturedModalRect(l5, l9, j5 + 36, 9, 9, 9);
                        }

                        if (i5 * 2 + 1 + l10 == i7)
                        {
                            this.drawTexturedModalRect(l5, l9, j5 + 45, 9, 9, 9);
                        }
                    }
            ...
            {
                boolean flag2 = ConfigManager.settings.foodSaturation && Allowed.foodSaturation() && f != 0.0F;
                int l7 = this.mc.thePlayer.getAir();
                int k8 = MathHelper.ceiling_double_int((double)(l7 - 2) * 10.0D / 300.0D);
                int k9 = MathHelper.ceiling_double_int((double)l7 * 10.0D / 300.0D) - k8;
                ...
                for (int k10 = 0; k10 < k8 + k9; ++k10)
                {
                    if (k10 < k8)
                    {
                        this.drawTexturedModalRect(j1 - k10 * 8 - 9, j2, 16, 18, 9, 9);
                    }
                    else
                    {
                        this.drawTexturedModalRect(j1 - k10 * 8 - 9, j2, 25, 18, 9, 9);
                    }
                }
            }
