...
public class WorldRenderer
{
    ...
    public class State
    {
        ...
        public State(int[] p_i11_2_, VertexFormat p_i11_3_, TextureAtlasSprite[] p_i11_4_)
        {
            this.stateRawBuffer = p_i11_2_;
            this.stateVertexFormat = p_i11_3_;
            this.stateQuadSprites = p_i11_4_;
        }
