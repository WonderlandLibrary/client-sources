    ...
    public void doRenderLayer(EntitySheep entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale)
    {
        if (!entitylivingbaseIn.getSheared() && !entitylivingbaseIn.isInvisible())
        {
            ...
            if (entitylivingbaseIn.hasCustomName() && "jeb_".equals(entitylivingbaseIn.getCustomNameTag()))
            {
                ...
                {
                    afloat1 = CustomColorizer.getSheepColors(EnumDyeColor.byMetadata(k), afloat1);
                    afloat2 = CustomColorizer.getSheepColors(EnumDyeColor.byMetadata(l), afloat2);
                }
            ...
            else
            {
                ...
                if (Config.isCustomColors())
                {
                    afloat = CustomColorizer.getSheepColors(entitylivingbaseIn.getFleeceColor(), afloat);
                }
