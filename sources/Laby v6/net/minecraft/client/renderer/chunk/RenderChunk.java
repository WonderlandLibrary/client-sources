...
public class RenderChunk
{
    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator)
    {
        ...
        if (!regionrendercache.extendedLevelsInChunkCache())
        {
            ...
            while (iterator.hasNext())
            {
                ...
                if (flag1)
                {
                    flag4 = Reflector.callBoolean(block, Reflector.ForgeBlock_hasTileEntity, new Object[] {iblockstate});
                }
                else
                {
    ...
    {
        return !this.fixBlockLayer ? p_fixBlockLayer_2_ : (p_fixBlockLayer_2_ == EnumWorldBlockLayer.CUTOUT ? (p_fixBlockLayer_1_ instanceof BlockRedstoneWire ? p_fixBlockLayer_2_ : (p_fixBlockLayer_1_ instanceof BlockCactus ? p_fixBlockLayer_2_ : EnumWorldBlockLayer.CUTOUT_MIPPED)) : p_fixBlockLayer_2_);
    }
}
