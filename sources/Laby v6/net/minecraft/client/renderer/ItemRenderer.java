...
public class ItemRenderer
{
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress)
    {
        ...
        if (ConfigManager.settings.oldFishing && Allowed.animations() && this.mc != null && this.mc.thePlayer != null && this.mc.thePlayer.getCurrentEquippedItem() != null && this.mc.thePlayer.getCurrentEquippedItem().getItem() != null && Item.getIdFromItem(this.mc.thePlayer.getCurrentEquippedItem().getItem()) == 346)
        {
