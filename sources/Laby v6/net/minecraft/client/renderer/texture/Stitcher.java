...
public class Stitcher
{
    ...
    public List getStichSlots()
    {
        ...
        for (Object stitcher$slot1 : arraylist)
        {
            Stitcher.Holder stitcher$holder = ((Stitcher.Slot) stitcher$slot1).getStitchHolder();
            TextureAtlasSprite textureatlassprite = stitcher$holder.getAtlasSprite();
            textureatlassprite.initSprite(this.currentWidth, this.currentHeight, ((Stitcher.Slot) stitcher$slot1).getOriginX(), ((Stitcher.Slot) stitcher$slot1).getOriginY(), stitcher$holder.isRotated());
