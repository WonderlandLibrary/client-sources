...
public class BlockModelRenderer
{
    ...
    private void renderModelAmbientOcclusionQuads(IBlockAccess p_renderModelAmbientOcclusionQuads_1_, Block p_renderModelAmbientOcclusionQuads_2_, BlockPos p_renderModelAmbientOcclusionQuads_3_, WorldRenderer p_renderModelAmbientOcclusionQuads_4_, List p_renderModelAmbientOcclusionQuads_5_, RenderEnv p_renderModelAmbientOcclusionQuads_6_)
    {
        ...
        {
            if (!p_renderModelAmbientOcclusionQuads_6_.isBreakingAnimation((BakedQuad) bakedquad))
            {
                BakedQuad bakedquad1 = (BakedQuad) bakedquad;

                if (Config.isConnectedTextures())
                {
                    bakedquad = ConnectedTextures.getConnectedTexture(p_renderModelAmbientOcclusionQuads_1_, iblockstate, p_renderModelAmbientOcclusionQuads_3_, (BakedQuad) bakedquad, p_renderModelAmbientOcclusionQuads_6_);
                }

                if (bakedquad == bakedquad1 && Config.isNaturalTextures())
                {
                    bakedquad = NaturalTextures.getNaturalTexture(p_renderModelAmbientOcclusionQuads_3_, (BakedQuad) bakedquad);
                }
            }

            this.fillQuadBounds(p_renderModelAmbientOcclusionQuads_2_, ((BakedQuad) bakedquad).getVertexData(), ((BakedQuad) bakedquad).getFace(), afloat, bitset);
            blockmodelrenderer$ambientocclusionface.updateVertexBrightness(p_renderModelAmbientOcclusionQuads_1_, p_renderModelAmbientOcclusionQuads_2_, p_renderModelAmbientOcclusionQuads_3_, ((BakedQuad) bakedquad).getFace(), afloat, bitset);

            if (p_renderModelAmbientOcclusionQuads_4_.isMultiTexture())
            {
                p_renderModelAmbientOcclusionQuads_4_.addVertexData(((BakedQuad) bakedquad).getVertexDataSingle());
                p_renderModelAmbientOcclusionQuads_4_.putSprite(((BakedQuad) bakedquad).getSprite());
            }
            else
            {
                p_renderModelAmbientOcclusionQuads_4_.addVertexData(((BakedQuad) bakedquad).getVertexData());
            }
            ...
            int k = CustomColorizer.getColorMultiplier((BakedQuad) bakedquad, p_renderModelAmbientOcclusionQuads_2_, p_renderModelAmbientOcclusionQuads_1_, p_renderModelAmbientOcclusionQuads_3_, p_renderModelAmbientOcclusionQuads_6_);

            if (!((BakedQuad) bakedquad).hasTintIndex() && k < 0)
            {
            ...
            else
            {
                ...
                {
                    j = p_renderModelAmbientOcclusionQuads_2_.colorMultiplier(p_renderModelAmbientOcclusionQuads_1_, p_renderModelAmbientOcclusionQuads_3_, ((BakedQuad) bakedquad).getTintIndex());
                }
    ...
    private void renderModelStandardQuads(IBlockAccess p_renderModelStandardQuads_1_, Block p_renderModelStandardQuads_2_, BlockPos p_renderModelStandardQuads_3_, EnumFacing p_renderModelStandardQuads_4_, int p_renderModelStandardQuads_5_, boolean p_renderModelStandardQuads_6_, WorldRenderer p_renderModelStandardQuads_7_, List p_renderModelStandardQuads_8_, RenderEnv p_renderModelStandardQuads_9_)
    {
        ...
        {
            if (!p_renderModelStandardQuads_9_.isBreakingAnimation((BakedQuad) bakedquad))
            {
                BakedQuad bakedquad1 = (BakedQuad) bakedquad;

                if (Config.isConnectedTextures())
                {
                    bakedquad = ConnectedTextures.getConnectedTexture(p_renderModelStandardQuads_1_, iblockstate, p_renderModelStandardQuads_3_, (BakedQuad) bakedquad, p_renderModelStandardQuads_9_);
                }

                if (bakedquad == bakedquad1 && Config.isNaturalTextures())
                {
                    bakedquad = NaturalTextures.getNaturalTexture(p_renderModelStandardQuads_3_, (BakedQuad) bakedquad);
                }
            }

            if (p_renderModelStandardQuads_6_)
            {
                this.fillQuadBounds(p_renderModelStandardQuads_2_, ((BakedQuad) bakedquad).getVertexData(), ((BakedQuad) bakedquad).getFace(), (float[])null, bitset);
                p_renderModelStandardQuads_5_ = bitset.get(0) ? p_renderModelStandardQuads_2_.getMixedBrightnessForBlock(p_renderModelStandardQuads_1_, p_renderModelStandardQuads_3_.offset(((BakedQuad) bakedquad).getFace())) : p_renderModelStandardQuads_2_.getMixedBrightnessForBlock(p_renderModelStandardQuads_1_, p_renderModelStandardQuads_3_);
            }

            if (p_renderModelStandardQuads_7_.isMultiTexture())
            {
                p_renderModelStandardQuads_7_.addVertexData(((BakedQuad) bakedquad).getVertexDataSingle());
                p_renderModelStandardQuads_7_.putSprite(((BakedQuad) bakedquad).getSprite());
            }
            else
            {
                p_renderModelStandardQuads_7_.addVertexData(((BakedQuad) bakedquad).getVertexData());
            }
            ...
            int i1 = CustomColorizer.getColorMultiplier((BakedQuad) bakedquad, p_renderModelStandardQuads_2_, p_renderModelStandardQuads_1_, p_renderModelStandardQuads_3_, p_renderModelStandardQuads_9_);

            if (((BakedQuad) bakedquad).hasTintIndex() || i1 >= 0)
            {
                int l;
                ...
                {
                    l = p_renderModelStandardQuads_2_.colorMultiplier(p_renderModelStandardQuads_1_, p_renderModelStandardQuads_3_, ((BakedQuad) bakedquad).getTintIndex());
                }
    ...
    private void renderModelBrightnessColorQuads(float p_178264_1_, float p_178264_2_, float p_178264_3_, float p_178264_4_, List p_178264_5_)
    {
        ...
        for (Object bakedquad : p_178264_5_)
        {
            worldrenderer.begin(7, DefaultVertexFormats.ITEM);
            worldrenderer.addVertexData(((BakedQuad) bakedquad).getVertexData());

            if (((BakedQuad) bakedquad).hasTintIndex())
            {
            ...
            Vec3i vec3i = ((BakedQuad) bakedquad).getFace().getDirectionVec();
    ...
    public static enum EnumNeighborInfo
    {
        ...
        private EnumNeighborInfo(String p_i14_3_, int p_i14_4_, EnumFacing[] p_i14_5_, float p_i14_6_, boolean p_i14_7_, BlockModelRenderer.Orientation[] p_i14_8_, BlockModelRenderer.Orientation[] p_i14_9_, BlockModelRenderer.Orientation[] p_i14_10_, BlockModelRenderer.Orientation[] p_i14_11_)
        {
            this.field_178276_g = p_i14_5_;
            this.field_178288_h = p_i14_6_;
            this.field_178289_i = p_i14_7_;
            this.field_178286_j = p_i14_8_;
            this.field_178287_k = p_i14_9_;
            this.field_178284_l = p_i14_10_;
            this.field_178285_m = p_i14_11_;
        }
    ...
    public static enum Orientation
    {
        ...
        private Orientation(String p_i16_3_, int p_i16_4_, EnumFacing p_i16_5_, boolean p_i16_6_)
        {
            this.field_178229_m = p_i16_5_.getIndex() + (p_i16_6_ ? EnumFacing.values().length : 0);
        }
    }
    ...
    static enum VertexTranslations
    {
        ...
        private VertexTranslations(String p_i15_3_, int p_i15_4_, int p_i15_5_, int p_i15_6_, int p_i15_7_, int p_i15_8_)
        {
            this.field_178191_g = p_i15_5_;
            this.field_178200_h = p_i15_6_;
            this.field_178201_i = p_i15_7_;
            this.field_178198_j = p_i15_8_;
        }
