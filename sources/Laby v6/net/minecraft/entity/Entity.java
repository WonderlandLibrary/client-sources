...
public abstract class Entity implements ICommandSender
{
    ...
    {
      if (Jannik.getModuleManager().getModuleByClass(HitBox.class).isEnabled())
      {
        float hitbox_hitbox = Values.hitbox_hitbox.getFloatValue() / 100.0F;
        return hitbox_hitbox;
      }
      return 0.1F;
    }
    ...
    {
      if (Jannik.getModuleManager().getModuleByClass(Velocity.class).isEnabled())
      {
        double velocity_xz = Values.velocity_xz.getFloatValue() / 100.0F;
        double velocity_y = Values.velocity_y.getFloatValue() / 100.0F;
        
        this.motionX = (x * velocity_xz);
        this.motionY = (y * velocity_y);
        this.motionZ = (z * velocity_xz);
      }
      else
      {
        this.motionX = x;
