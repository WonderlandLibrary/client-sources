...
public class RenderMojangService
{
    public static void renderOnMultiplayerGui()
    {
        if (ConfigManager.settings.mojangStatus)
        {
            ...
            for (Object s : new ArrayList(LabyMod.getInstance().mojangStatus.keySet()))
            {
                ...
                LabyMod.getInstance().draw.drawRect(25.0D, (double)(38 + i), (double)(LabyMod.getInstance().draw.getStringWidth((String) s) + 40) * 0.7D, (double)(45 + i), Color.toRGB(50, 50, 50, 170));
