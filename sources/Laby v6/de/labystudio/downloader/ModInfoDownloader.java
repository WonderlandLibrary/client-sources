...
public class ModInfoDownloader
{
    ...
    private boolean downloadModInfo(String page)
    {
        try
        {
            ...
            HttpURLConnection httpurlconnection = (HttpURLConnection)(new URL(page + "?ver=" + "1.8.8" + "&lmver=" + "2.7.99")).openConnection();
            ...
            LabyMod.getInstance().autoUpdaterCurrentVersionId = Integer.parseInt("2.7.99".replace(".", ""));
            ...
            System.out.println("[LabyMod] The latest LabyMod version is v" + LabyMod.getInstance().latestVersionName + ", you are currently using LabyMod version v" + "2.7.99");
