...
public class FancyTextField extends Gui
{
    private int id;
    ...
    public FancyTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
        ...
        if (this.getVisible())
        {
            ...
            if (this.getEnableBackgroundDrawing())
            {
                if (this.isFocused)
                {
                    ...
                    drawRect(this.xPosition - this.fadeGreater, this.yPosition - this.fadeGreater, this.xPosition + this.width + this.fadeGreater, this.yPosition + this.height + this.fadeGreater, (new Color(255, 255, 255, 100)).getRGB());
                }
                else
                {
                    ...
                    drawRect(this.xPosition - this.fadeGreater, this.yPosition - this.fadeGreater, this.xPosition + this.width + this.fadeGreater, this.yPosition + this.height + this.fadeGreater, (new Color(255, 255, 255, 40)).getRGB());
                }
            }
            ...
            if (s.length() > 0)
            {
                String s2 = flag ? s.substring(0, j) : s;
            ...
            if (flag1 && flag2)
            {
                Gui.drawRect(i2, i1 - 1, i2 + 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT, -3092272);
            }

            if (k != j)
            {
                int l1 = l + this.fontRendererInstance.getStringWidth(s.substring(0, k));
                this.drawCursorVertical(i2, i1 - 1, l1 - 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT);
            }
        }
    }
    ...
    private void drawCursorVertical(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_)
    {
        ...
        worldrenderer.pos((double)p_146188_1_, (double)p_146188_4_, 0.0D).color(0, 0, 255, 255).endVertex();
        worldrenderer.pos((double)p_146188_3_, (double)p_146188_4_, 0.0D).color(0, 0, 255, 255).endVertex();
        worldrenderer.pos((double)p_146188_3_, (double)p_146188_2_, 0.0D).color(0, 0, 255, 255).endVertex();
        worldrenderer.pos((double)p_146188_1_, (double)p_146188_2_, 0.0D).color(0, 0, 255, 255).endVertex();
        tessellator.draw();
