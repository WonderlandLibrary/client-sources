...
public abstract class FancyGuiListExtended extends FancyGuiSlot
{
    private static final String __OBFID = "CL_00000674";

    public FancyGuiListExtended(Minecraft mcIn, int widthIn, int heightIn, int topIn, int bottomIn, int slotHeightIn, int startBox)
    {
    ...
    {
        if (this.isMouseYWithinSlotBounds(mouseX, mouseY))
        {
    ...
    public abstract FancyGuiListExtended.IGuiListEntry getListEntry(int var1);
