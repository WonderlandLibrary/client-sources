...
import mods.togglesprint.me.imfr0zen.guiapi.KeyUtils;
import mods.togglesprint.me.imfr0zen.guiapi.RenderUtil;
import mods.togglesprint.me.imfr0zen.guiapi.listeners.TextListener;
  ...
  implements GuiComponent
{
  ...
  public void render(int posX, int posY, int width, int mouseX, int mouseY)
  {
    ...
    RenderUtil.drawRect(posX + w + 8, posY, posX + w + w1 + 11, posY + 11, 
      this.marked ? Colors.buttonColorLight : this.blinkState == -1 ? Colors.buttonColor : Colors.buttonColorDark);
  ...
  public int getWidth()
  {
    ...
    return RenderUtil.getWidth(this.desc) + (w < 50 ? 50 : w) + 15;
  }
