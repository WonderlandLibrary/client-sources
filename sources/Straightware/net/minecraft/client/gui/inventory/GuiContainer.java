...
import me.jinthium.straight.impl.modules.player.ChestStealer;
...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        boolean focus = chestStealer.isEnabled() && mc.currentScreen instanceof GuiChest && chestStealer.getSilent().isEnabled();

        if (mc.currentScreen instanceof GuiChest) {
            GuiChest chest = (GuiChest) mc.currentScreen;

            if (chestStealer.getChestCheck().isEnabled() && !chestStealer.isInvalidChest(chest)) {
                focus = false;
            }
        }
        ...
        boolean shouldDraw = !chestStealer.isEnabled() || (!chestStealer.getAim().isEnabled() ||
                chestStealer.getChestCheck().isEnabled() && (mc.currentScreen instanceof GuiChest && !chestStealer.isInvalidChest(mc.currentScreen)));
        ...
        int i = this.guiLeft;
        int j = this.guiTop;
        RenderUtil.scaleStart((float) (this.width / 2), (float) (this.height / 2), (float) animation.getOutput().floatValue());
