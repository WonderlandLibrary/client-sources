...
public class GuiNewChat extends Gui implements Util
{
    ...
    public void renderChatBox() {
        ...
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
            ...
            if (k > 0) {
                ...
                GlStateManager.pushMatrix();
                GlStateManager.translate(2.0F, (sr.getScaledHeight() - 48) + (chatPos + 3), 0.0F);
                GlStateManager.scale(f1, f1, 1.0F);
                double f3 = 0f;
                double f4 = 0f;
                double f5 = 0f;
                ...
                if (flag) {
                    int k2 = ((AbstractFontRenderer) normalFont19).getHeight();
