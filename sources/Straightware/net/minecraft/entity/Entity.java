...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        Client.INSTANCE.getPubSubEventBus().publish(safeWalkEvent);
        boolean safewalk = this.onGround && (this.isSneaking() || safeWalkEvent.isSafe()) && this instanceof EntityPlayer;
    ...
    public void moveFlying(float strafe, float forward, float friction)
    {
        ...
        if (this instanceof EntityPlayerSP) {
            Client.INSTANCE.getPubSubEventBus().publish(playerMovementEvent);
        }
