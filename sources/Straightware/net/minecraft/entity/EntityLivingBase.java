...
public abstract class EntityLivingBase extends Entity
{
    ...
    private int getArmSwingAnimationEnd() {
        return (Client.INSTANCE.getModuleManager().getModule(ItemTransformer.class).isEnabled() ? ItemTransformer.slowdown.getValue().intValue() : 1)
    ...
    protected void jump()
    {
        ...
        if (this instanceof EntityPlayerSP) {
            final JumpFixEvent event = new JumpFixEvent(this.movementYaw);
