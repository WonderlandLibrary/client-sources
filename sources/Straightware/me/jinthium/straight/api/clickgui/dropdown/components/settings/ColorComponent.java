...
public class ColorComponent extends SettingComponent<ColorSetting> {
    ...
    private final TextField hexField = new TextField(normalFont16);
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        normalFont16.drawString(colorSetting.name, x + 5, y + normalFont16.getMiddleOfBox(realHeight) + 2, textColor);
        ...
        normalFont14.drawCenteredStringWithShadow(text, colorX + colorWidth / 2f,
                colorY + normalFont14.getMiddleOfBox(colorHeight) + 2,
        ...
        if (opened || !openAnimation.isDone()) {
            ...
            GLUtil.startBlend();
            RenderUtil.drawImage(new ResourceLocation("straight/images/colorpicker2.png"), pickerX, pickerY, 4, 4);
            GLUtil.endBlend();

            float hueY = gradientY + gradientHeight + 5;
            float hueHeight = 4;
            RenderUtil.resetColor();
            mc.getTextureManager().bindTexture(new ResourceLocation("straight/images/hue.png"));
            ...
            if (!rainbowAnimation.finished(Direction.FORWARDS)) {
                ...
                normalFont16.drawString("Hex", gradientX, newYVal + normalFont16.getMiddleOfBox(heightLeft), whiteColor);
                ...
                if (!hexField.isFocused()) {
                    ...
                    try {
                        ...
                        normalFont14.drawString("Invalid Hex Code", hexField.getXPosition() - .5f, newYVal - (normalFont14.getHeight() - .5f),
