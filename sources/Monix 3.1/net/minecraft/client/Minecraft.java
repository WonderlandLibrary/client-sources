...
import Monix.Monix;
import Monix.Event.events.EventKeyboard;
import Monix.Event.events.EventMiddleClick;
import Monix.Event.events.EventTick;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void func_175609_am() throws LWJGLException
    {
        ...
        Display.setTitle(String.valueOf("Monix") + " Is Loading...");
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        final EventKeyboard eventKeyboard = new EventKeyboard(var1);
                        eventKeyboard.call();
                        for (final Mod module : ModManager.getMods()) {
	...
	public static void addChatMessageP(String string) {
