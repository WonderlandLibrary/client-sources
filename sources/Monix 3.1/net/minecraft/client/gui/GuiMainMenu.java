...
import Monix.Alts.GuiAltManager;
...
implements GuiYesNoCallback {
    ...
    private static final ResourceLocation monixTitleTextures = new ResourceLocation("textures/gui/title/monix.png");
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(69, 2, 2, 98, 20, I18n.format("Alt Manager", new Object[0])));
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        ...
        this.field_175372_K = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("menu.online", new Object[0]));
...
//        this.mc.getTextureManager().bindTexture(monixTitleTextures);
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
...
//        this.drawCenteredString(this.fontRendererObj, "Monix", 0, -8, -256);
        GlStateManager.popMatrix();
        ...
        String var11 = "Monix";
        this.drawString(this.fontRendererObj, "\u00a7eLogged in as \u00a7a" + this.mc.session.getUsername(), 2, 30, 0);
