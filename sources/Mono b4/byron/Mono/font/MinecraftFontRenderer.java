...
public class MinecraftFontRenderer extends CFont {
    ...
    public void drawStringGradientLarge(String s, int x, int y, Color color1, Color color2) {
    	int i = 0;
    	int xD = 0;
    	for(char c : s.toCharArray()) {
    		FontUtil.normal2.drawString(String.valueOf(c), x + xD, y, getColorSwitch(color1, color2, s.length() * 20, i * 10, 50, 0.2).getRGB());
    		i++;
    		xD += FontUtil.normal2.getStringWidth(String.valueOf(c));
    	}
    }
