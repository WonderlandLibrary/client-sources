...
public class ItemRenderer
{
    ...
    {
        float f = -0.4F * MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI * 0.2F);
        float f1 = 0.2F * MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI * 0.2F);
        float f2 = -0.2F * MathHelper.sin(swingProgress * (float)Math.PI * -0.1F);
        GlStateManager.translate(f, f1, f2);
    }
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress)
    {
        ...
        GlStateManager.translate(0.2F, equipProgress * -0.6F, -0.3F);
        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
        float f = MathHelper.sin(swingProgress * swingProgress * (float)Math.PI);
        float f1 = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
        GlStateManager.rotate(f * -20.0F, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(f1 * -30.0F, 0.0F, 0.0F, 1.0F);
        GlStateManager.rotate(f1 * -80.0F, 1.0F, 0.0F, 0.4F);
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            float ft = 0.9F - (this.prevEquippedProgress + (this.equippedProgress - this.prevEquippedProgress) * partialTicks);
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                        	if(Animations.exhimode == true)
                        	{
                        		 ...
                        		 if(Animations.swooshmode == true)
                        		 {
                        				  float f6 = MathHelper.sin((float) (MathHelper.sqrt_float(f1) * 3.1));
                                          GL11.glTranslated(-0.1D, 0.1D, 0.0D);
                                          this.transformFirstPersonItem((f / 3), 0.0f);
                                          GlStateManager.rotate(-f6 * 80.0F / 1.0F, f6 / 4.0F, -0.0F, 69.0F);
                                          GlStateManager.rotate(-f6 * 3.0F, 5.0F, f6 / 4.0F, -2.0F);
                                          this.doBlockTransformations();

                        	 }
                        		 
                        			if(Animations.swingmode == true)
                                	{
                        				 float f6 = MathHelper.sin((float) (MathHelper.sqrt_float(f1) * 3.1));
                                         GL11.glTranslated(-0.1D, 0.1D, 0.0D);
                                         this.transformFirstPersonItem((f / 3), 1.0f);
                                         GlStateManager.rotate(-f6 * -110.0F / 2.0F, f6 / 14.0F, -3.0F, 6.0F);
                                         GlStateManager.rotate(-f6 * -68.0F, 5.0F, f6 / 40.0F, -9.0F);
                                         this.doBlockTransformations();
                                	}
