...
import byron.Mono.module.impl.hud.MainMenu;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
    	if (!Mono.INSTANCE.getModuleManager().getModule("NoHurtCam").isToggled())
    	{	
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Event3D eventRender3D = new Event3D();
        eventRender3D.setPartialTicks(partialTicks);
        Mono.INSTANCE.getEventBus().post((eventRender3D));
