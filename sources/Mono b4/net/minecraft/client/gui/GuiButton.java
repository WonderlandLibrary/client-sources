...
public class GuiButton extends Gui
{
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY)
    {
        if (this.visible)
        {
           ...
           // this.drawRect(this.xPosition + this.width / 5, this.yPosition, 200 - this.width / 2, 46 + i * 20, this.width / 2);
            drawSmoothRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, new Color(24, 24, 24, 120).getRGB());
