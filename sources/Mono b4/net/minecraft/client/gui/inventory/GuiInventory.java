...
public class GuiInventory extends InventoryEffectRenderer
{
    ...
    {
    	FontUtil.normal.drawString(I18n.format("container.crafting", new Object[0]), 86, 16, 4210752);
    }
	...
	public static void drawEntityOnScreen(int i, int j, EntityLivingBase target) {
