    ...
    public void drawChat(int updateCounter)
    {
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN)
        {
            ...
            if (k > 0)
            {
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                int i2 = 0;
                                int j2 = -i1 * 9;
                                drawRect(i2, j2 - 9, i2 + l + 4, j2, l1 / 3 << 24);
                                String s = chatline.getChatComponent().getFormattedText();
                                GlStateManager.enableBlend();
                                Minecraft.fontRendererObj.drawString(s, (int) i2, (int) (j2 - 8), 16777215 + (l1 << 24));
                ...
                if (flag)
                {
                    int k2 = Minecraft.fontRendererObj.FONT_HEIGHT + 2;
    ...
    public IChatComponent getChatComponent(int mouseX, int mouseY)
    {
        ...
        else
        {
            ...
            if (j >= 0 && k >= 0)
            {
                ...
                if (j <= MathHelper.floor_float((float)this.getChatWidth() / this.getChatScale()) && k < Minecraft.fontRendererObj.FONT_HEIGHT * l + l)
                {
                    ...
                    if (i1 >= 0 && i1 < this.drawnChatLines.size())
                    {
                        ...
                        for (IChatComponent ichatcomponent : chatline.getChatComponent())
                        {
                            ...
                            {
                                j1 += Minecraft.fontRendererObj.getStringWidth(GuiUtilRenderComponents.func_178909_a(((ChatComponentText)ichatcomponent).getChatComponentText_TextValue(), false));
