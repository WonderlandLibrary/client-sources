...
public class Cast extends Expr {
   protected Cast(int var1, CodeIterator var2, CtClass var3, MethodInfo var4) {
   ...
   public void replace(String var1) throws CannotCompileException {
      ...
      try {
         ...
         var5.recordProceed(new Cast.ProceedForCast(var4, var9));
   ...
   static class ProceedForCast implements ProceedHandler {
      ...
      ProceedForCast(int var1, CtClass var2) {
         this.index = var1;
         this.retType = var2;
      }
