...
public class TIntArrayStack implements TIntStack, Externalizable {
   ...
   public TIntArrayStack(int var1) {
      this._list = new TIntArrayList(var1);
   }

   public TIntArrayStack(int var1, int var2) {
      this._list = new TIntArrayList(var1, var2);
   }

   public TIntArrayStack(TIntStack var1) {
      if (var1 instanceof TIntArrayStack) {
         TIntArrayStack var2 = (TIntArrayStack)var1;
         this._list = new TIntArrayList(var2._list);
      } else {
   ...
   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      var1.readByte();
      this._list = (TIntArrayList)var1.readObject();
   }
}
