...
public class TLongArrayStack implements TLongStack, Externalizable {
   ...
   public TLongArrayStack(int var1) {
      this._list = new TLongArrayList(var1);
   }

   public TLongArrayStack(int var1, long var2) {
      this._list = new TLongArrayList(var1, var2);
   }

   public TLongArrayStack(TLongStack var1) {
      if (var1 instanceof TLongArrayStack) {
         TLongArrayStack var2 = (TLongArrayStack)var1;
         this._list = new TLongArrayList(var2._list);
      } else {
   ...
   private void reverse(long[] var1, int var2, int var3) {
      if (var2 != var3) {
         if (var2 > var3) {
   ...
   private void swap(long[] var1, int var2, int var3) {
      long var4 = var1[var2];
      var1[var2] = var1[var3];
      var1[var3] = var4;
   }
   ...
   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      var1.readByte();
      this._list = (TLongArrayList)var1.readObject();
   }
}
