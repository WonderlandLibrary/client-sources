...
public abstract class TIntDoubleHash extends TPrimitiveHash {
   ...
   public TIntDoubleHash(int var1) {
      super(var1);
      this.no_entry_key = 0;
      this.no_entry_value = 0.0D;
   }

   public TIntDoubleHash(int var1, float var2) {
      super(var1, var2);
      this.no_entry_key = 0;
      this.no_entry_value = 0.0D;
   }

   public TIntDoubleHash(int var1, float var2, int var3, double var4) {
      super(var1, var2);
   ...
   protected int XinsertKey(int var1) {
      byte[] var6 = this._states;
      int[] var7 = this._set;
      int var5 = var6.length;
      int var2 = HashFunctions.hash(var1) & Integer.MAX_VALUE;
