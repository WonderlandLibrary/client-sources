...
public class TDoubleHashSet extends TDoubleHash implements TDoubleSet, Externalizable {
   ...
   public TDoubleHashSet(int var1) {
      super(var1);
   }

   public TDoubleHashSet(int var1, float var2) {
      super(var1, var2);
   }

   public TDoubleHashSet(int var1, float var2, double var3) {
   ...
   public TDoubleHashSet(Collection var1) {
      this(Math.max(var1.size(), 10));
      this.addAll(var1);
   }

   public TDoubleHashSet(TDoubleCollection var1) {
      this(Math.max(var1.size(), 10));
      if (var1 instanceof TDoubleHashSet) {
         TDoubleHashSet var2 = (TDoubleHashSet)var1;
   ...
   public TDoubleHashSet(double[] var1) {
      this(Math.max(var1.length, 10));
      this.addAll(var1);
   }

   public TDoubleIterator iterator() {
      return new TDoubleHashSet.TDoubleHashIterator(this, this);
   }
   ...
   class TDoubleHashIterator extends THashPrimitiveIterator implements TDoubleIterator {
      ...
      public TDoubleHashIterator(TDoubleHashSet var1, TDoubleHash var2) {
         super(var2);
         this.this$0 = var1;
         this._hash = var2;
      }
