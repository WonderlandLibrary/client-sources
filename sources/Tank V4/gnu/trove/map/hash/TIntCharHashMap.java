...
public class TIntCharHashMap extends TIntCharHash implements TIntCharMap, Externalizable {
   ...
   public TIntCharHashMap(int var1) {
      super(var1);
   }

   public TIntCharHashMap(int var1, float var2) {
      super(var1, var2);
   }

   public TIntCharHashMap(int var1, float var2, int var3, char var4) {
      super(var1, var2, var3, var4);
   }

   public TIntCharHashMap(int[] var1, char[] var2) {
   ...
   public TIntCharHashMap(TIntCharMap var1) {
      super(var1.size());
      if (var1 instanceof TIntCharHashMap) {
         TIntCharHashMap var2 = (TIntCharHashMap)var1;
   ...
   private char doPut(int var1, char var2, int var3) {
   ...
   public void putAll(Map var1) {
      ...
      while(var2.hasNext()) {
         ...
         this.put((Integer)var3.getKey(), (Character)var3.getValue());
      }
   ...
   public void putAll(TIntCharMap var1) {
      this.ensureCapacity(var1.size());
      TIntCharIterator var2 = var1.iterator();
   ...
   public TIntSet keySet() {
      return new TIntCharHashMap.TKeyView(this);
   }
   ...
   public TCharCollection valueCollection() {
      return new TIntCharHashMap.TValueView(this);
   }
   ...
   public TIntCharIterator iterator() {
      return new TIntCharHashMap.TIntCharHashIterator(this, this);
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TIntCharMap)) {
         return false;
      } else {
         TIntCharMap var2 = (TIntCharMap)var1;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TIntCharProcedure(this, var1) {
   ...
   static int access$000(TIntCharHashMap var0) {
      return var0.no_entry_key;
   }

   static int access$100(TIntCharHashMap var0) {
      return var0._size;
   }

   static int access$200(TIntCharHashMap var0) {
      return var0._size;
   }

   static char access$300(TIntCharHashMap var0) {
      return var0.no_entry_value;
   }

   static char access$400(TIntCharHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$500(TIntCharHashMap var0) {
      return var0._size;
   }

   static int access$600(TIntCharHashMap var0) {
      return var0._size;
   }
   ...
   class TIntCharHashIterator extends THashPrimitiveIterator implements TIntCharIterator {
      ...
      TIntCharHashIterator(TIntCharHashMap var1, TIntCharHashMap var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TIntCharValueHashIterator extends THashPrimitiveIterator implements TCharIterator {
      ...
      TIntCharValueHashIterator(TIntCharHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TIntCharKeyHashIterator extends THashPrimitiveIterator implements TIntIterator {
      ...
      TIntCharKeyHashIterator(TIntCharHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   protected class TValueView implements TCharCollection {
      ...
      protected TValueView(TIntCharHashMap var1) {
         this.this$0 = var1;
      }

      public TCharIterator iterator() {
         return this.this$0.new TIntCharValueHashIterator(this.this$0, this.this$0);
      }
   ...
   protected class TKeyView implements TIntSet {
      ...
      protected TKeyView(TIntCharHashMap var1) {
         this.this$0 = var1;
      }

      public TIntIterator iterator() {
         return this.this$0.new TIntCharKeyHashIterator(this.this$0, this.this$0);
      }
