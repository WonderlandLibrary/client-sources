...
public class TIntByteHashMap extends TIntByteHash implements TIntByteMap, Externalizable {
   ...
   public TIntByteHashMap(int var1) {
      super(var1);
   }

   public TIntByteHashMap(int var1, float var2) {
      super(var1, var2);
   }

   public TIntByteHashMap(int var1, float var2, int var3, byte var4) {
      super(var1, var2, var3, var4);
   }

   public TIntByteHashMap(int[] var1, byte[] var2) {
   ...
   public TIntByteHashMap(TIntByteMap var1) {
      super(var1.size());
      if (var1 instanceof TIntByteHashMap) {
         TIntByteHashMap var2 = (TIntByteHashMap)var1;
   ...
   private byte doPut(int var1, byte var2, int var3) {
   ...
   public void putAll(Map var1) {
      ...
      while(var2.hasNext()) {
         ...
         this.put((Integer)var3.getKey(), (Byte)var3.getValue());
      }
   ...
   public void putAll(TIntByteMap var1) {
      this.ensureCapacity(var1.size());
      TIntByteIterator var2 = var1.iterator();
   ...
   public TIntSet keySet() {
      return new TIntByteHashMap.TKeyView(this);
   }
   ...
   public TByteCollection valueCollection() {
      return new TIntByteHashMap.TValueView(this);
   }
   ...
   public TIntByteIterator iterator() {
      return new TIntByteHashMap.TIntByteHashIterator(this, this);
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TIntByteMap)) {
         return false;
      } else {
         TIntByteMap var2 = (TIntByteMap)var1;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TIntByteProcedure(this, var1) {
   ...
   static int access$000(TIntByteHashMap var0) {
      return var0.no_entry_key;
   }

   static int access$100(TIntByteHashMap var0) {
      return var0._size;
   }

   static int access$200(TIntByteHashMap var0) {
      return var0._size;
   }

   static byte access$300(TIntByteHashMap var0) {
      return var0.no_entry_value;
   }

   static byte access$400(TIntByteHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$500(TIntByteHashMap var0) {
      return var0._size;
   }

   static int access$600(TIntByteHashMap var0) {
      return var0._size;
   }
   ...
   class TIntByteHashIterator extends THashPrimitiveIterator implements TIntByteIterator {
      ...
      TIntByteHashIterator(TIntByteHashMap var1, TIntByteHashMap var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TIntByteValueHashIterator extends THashPrimitiveIterator implements TByteIterator {
      ...
      TIntByteValueHashIterator(TIntByteHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TIntByteKeyHashIterator extends THashPrimitiveIterator implements TIntIterator {
      ...
      TIntByteKeyHashIterator(TIntByteHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   protected class TValueView implements TByteCollection {
      ...
      protected TValueView(TIntByteHashMap var1) {
         this.this$0 = var1;
      }

      public TByteIterator iterator() {
         return this.this$0.new TIntByteValueHashIterator(this.this$0, this.this$0);
      }
   ...
   protected class TKeyView implements TIntSet {
      ...
      protected TKeyView(TIntByteHashMap var1) {
         this.this$0 = var1;
      }

      public TIntIterator iterator() {
         return this.this$0.new TIntByteKeyHashIterator(this.this$0, this.this$0);
      }
