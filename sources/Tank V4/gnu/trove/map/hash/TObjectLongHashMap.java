...
public class TObjectLongHashMap extends TObjectHash implements TObjectLongMap, Externalizable {
   ...
   static int access$100(TObjectLongHashMap var0) {
      return var0._size;
   }

   static int access$200(TObjectLongHashMap var0) {
      return var0._size;
   }
   ...
   class TObjectLongHashIterator extends TObjectHashIterator implements TObjectLongIterator {
      ...
      public TObjectLongHashIterator(TObjectLongHashMap var1, TObjectLongHashMap var2) {
         super(var2);
         this.this$0 = var1;
         this._map = var2;
      }
   ...
   class TLongValueCollection implements TLongCollection {
      ...
      TLongValueCollection(TObjectLongHashMap var1) {
         this.this$0 = var1;
      }
      ...
      class TObjectLongValueHashIterator implements TLongIterator {
         ...
         TObjectLongValueHashIterator(TObjectLongHashMap.TLongValueCollection var1) {
            this.this$1 = var1;
   ...
   private abstract class MapBackedView extends AbstractSet implements Set, Iterable {
      ...
      private MapBackedView(TObjectLongHashMap var1) {
         this.this$0 = var1;
      }
      ...
      MapBackedView(TObjectLongHashMap var1, Object var2) {
         this(var1);
      }
   }

   protected class KeyView extends TObjectLongHashMap.MapBackedView {
      final TObjectLongHashMap this$0;

      protected KeyView(TObjectLongHashMap var1) {
         super(var1, null);
         this.this$0 = var1;
      }
