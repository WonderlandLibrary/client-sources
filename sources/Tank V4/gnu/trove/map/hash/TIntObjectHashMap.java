...
public class TIntObjectHashMap extends TIntHash implements TIntObjectMap, Externalizable {
   ...
   public TIntObjectHashMap() {
      this.PUT_ALL_PROC = new TIntObjectProcedure(this) {
   ...
   public TIntObjectHashMap(int var1) {
      super(var1);
      this.PUT_ALL_PROC = new TIntObjectProcedure(this) {
         final TIntObjectHashMap this$0;
   ...
   public TIntObjectHashMap(int var1, float var2) {
      super(var1, var2);
      this.PUT_ALL_PROC = new TIntObjectProcedure(this) {
         final TIntObjectHashMap this$0;
   ...
   public TIntObjectHashMap(int var1, float var2, int var3) {
      super(var1, var2);
      this.PUT_ALL_PROC = new TIntObjectProcedure(this) {
         final TIntObjectHashMap this$0;
   ...
   public TIntObjectHashMap(TIntObjectMap var1) {
   ...
   public TIntSet keySet() {
      return new TIntObjectHashMap.KeyView(this);
   }
   ...
   public Collection valueCollection() {
      return new TIntObjectHashMap.ValueView(this);
   }
   ...
   public TIntObjectIterator iterator() {
      return new TIntObjectHashMap.TIntObjectHashIterator(this, this);
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TIntObjectMap)) {
         return false;
      } else {
         TIntObjectMap var2 = (TIntObjectMap)var1;
         if (var2.size() != this.size()) {
            return false;
         } else {
            try {
               TIntObjectIterator var3 = this.iterator();
   ...
   public void writeExternal(ObjectOutput var1) throws IOException {
      ...
      var1.writeInt(this.no_entry_key);
   ...
   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      ...
      this.no_entry_key = var1.readInt();
   ...
   public String toString() {
      ...
      this.forEachEntry(new TIntObjectProcedure(this, var1) {
   ...
   static int access$000(TIntObjectHashMap var0) {
      return var0._size;
   }

   static int access$100(TIntObjectHashMap var0) {
      return var0._size;
   }
   ...
   class TIntObjectHashIterator extends THashPrimitiveIterator implements TIntObjectIterator {
      ...
      public TIntObjectHashIterator(TIntObjectHashMap var1, TIntObjectHashMap var2) {
         super(var2);
         this.this$0 = var1;
         this._map = var2;
      }
   ...
   private abstract class MapBackedView extends AbstractSet implements Set, Iterable {
      ...
      private MapBackedView(TIntObjectHashMap var1) {
         this.this$0 = var1;
      }
      ...
      MapBackedView(TIntObjectHashMap var1, Object var2) {
         this(var1);
      }
   }

   protected class ValueView extends TIntObjectHashMap.MapBackedView {
      final TIntObjectHashMap this$0;

      protected ValueView(TIntObjectHashMap var1) {
         super(var1, null);
         this.this$0 = var1;
      }

      public Iterator iterator() {
         return new TIntObjectHashMap.ValueView.TIntObjectValueHashIterator(this, this.this$0) {
      ...
      class TIntObjectValueHashIterator extends THashPrimitiveIterator implements Iterator {
         ...
         public TIntObjectValueHashIterator(TIntObjectHashMap.ValueView var1, TIntObjectHashMap var2) {
            super(var2);
            this.this$1 = var1;
            this._map = var2;
         }
   ...
   class KeyView implements TIntSet {
      ...
      KeyView(TIntObjectHashMap var1) {
         this.this$0 = var1;
      }
      ...
      public boolean containsAll(Collection var1) {
         ...
         do {
            ...
            var3 = var2.next();
         } while(this.this$0.containsKey((Integer)var3));
      ...
      class TIntHashIterator extends THashPrimitiveIterator implements TIntIterator {
         ...
         public TIntHashIterator(TIntObjectHashMap.KeyView var1, TIntHash var2) {
            super(var2);
            this.this$1 = var1;
            this._hash = var2;
         }
