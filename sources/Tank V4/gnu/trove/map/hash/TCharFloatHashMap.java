...
public class TCharFloatHashMap extends TCharFloatHash implements TCharFloatMap, Externalizable {
   ...
   public TCharFloatHashMap(int var1) {
      super(var1);
   }

   public TCharFloatHashMap(int var1, float var2) {
      super(var1, var2);
   }

   public TCharFloatHashMap(int var1, float var2, char var3, float var4) {
      super(var1, var2, var3, var4);
   }

   public TCharFloatHashMap(char[] var1, float[] var2) {
   ...
   public TCharFloatHashMap(TCharFloatMap var1) {
      super(var1.size());
      if (var1 instanceof TCharFloatHashMap) {
         TCharFloatHashMap var2 = (TCharFloatHashMap)var1;
   ...
   private float doPut(char var1, float var2, int var3) {
   ...
   public void putAll(Map var1) {
      ...
      while(var2.hasNext()) {
         ...
         this.put((Character)var3.getKey(), (Float)var3.getValue());
      }
   ...
   public void putAll(TCharFloatMap var1) {
      this.ensureCapacity(var1.size());
      TCharFloatIterator var2 = var1.iterator();
   ...
   public TCharSet keySet() {
      return new TCharFloatHashMap.TKeyView(this);
   }
   ...
   public TFloatCollection valueCollection() {
      return new TCharFloatHashMap.TValueView(this);
   }
   ...
   public TCharFloatIterator iterator() {
      return new TCharFloatHashMap.TCharFloatHashIterator(this, this);
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TCharFloatMap)) {
         return false;
      } else {
         TCharFloatMap var2 = (TCharFloatMap)var1;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TCharFloatProcedure(this, var1) {
   ...
   static char access$000(TCharFloatHashMap var0) {
      return var0.no_entry_key;
   }

   static int access$100(TCharFloatHashMap var0) {
      return var0._size;
   }

   static int access$200(TCharFloatHashMap var0) {
      return var0._size;
   }

   static float access$300(TCharFloatHashMap var0) {
      return var0.no_entry_value;
   }

   static float access$400(TCharFloatHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$500(TCharFloatHashMap var0) {
      return var0._size;
   }

   static int access$600(TCharFloatHashMap var0) {
      return var0._size;
   }
   ...
   class TCharFloatHashIterator extends THashPrimitiveIterator implements TCharFloatIterator {
      ...
      TCharFloatHashIterator(TCharFloatHashMap var1, TCharFloatHashMap var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TCharFloatValueHashIterator extends THashPrimitiveIterator implements TFloatIterator {
      ...
      TCharFloatValueHashIterator(TCharFloatHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TCharFloatKeyHashIterator extends THashPrimitiveIterator implements TCharIterator {
      ...
      TCharFloatKeyHashIterator(TCharFloatHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   protected class TValueView implements TFloatCollection {
      ...
      protected TValueView(TCharFloatHashMap var1) {
         this.this$0 = var1;
      }

      public TFloatIterator iterator() {
         return this.this$0.new TCharFloatValueHashIterator(this.this$0, this.this$0);
      }
   ...
   protected class TKeyView implements TCharSet {
      ...
      protected TKeyView(TCharFloatHashMap var1) {
         this.this$0 = var1;
      }

      public TCharIterator iterator() {
         return this.this$0.new TCharFloatKeyHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachKey(new TCharProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TCharFloatHashMap.TKeyView this$1;
