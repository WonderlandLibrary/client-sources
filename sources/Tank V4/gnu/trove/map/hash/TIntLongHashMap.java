...
public class TIntLongHashMap extends TIntLongHash implements TIntLongMap, Externalizable {
   ...
   public TIntLongHashMap(int var1) {
      super(var1);
   }

   public TIntLongHashMap(int var1, float var2) {
      super(var1, var2);
   }

   public TIntLongHashMap(int var1, float var2, int var3, long var4) {
      super(var1, var2, var3, var4);
   }

   public TIntLongHashMap(int[] var1, long[] var2) {
   ...
   public TIntLongHashMap(TIntLongMap var1) {
      super(var1.size());
      if (var1 instanceof TIntLongHashMap) {
         TIntLongHashMap var2 = (TIntLongHashMap)var1;
   ...
   private long doPut(int var1, long var2, int var4) {
   ...
   public void putAll(Map var1) {
      ...
      while(var2.hasNext()) {
         ...
         this.put((Integer)var3.getKey(), (Long)var3.getValue());
      }
   ...
   public void putAll(TIntLongMap var1) {
      this.ensureCapacity(var1.size());
      TIntLongIterator var2 = var1.iterator();
   ...
   public TIntSet keySet() {
      return new TIntLongHashMap.TKeyView(this);
   }
   ...
   public TLongCollection valueCollection() {
      return new TIntLongHashMap.TValueView(this);
   }
   ...
   public TIntLongIterator iterator() {
      return new TIntLongHashMap.TIntLongHashIterator(this, this);
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TIntLongMap)) {
         return false;
      } else {
         TIntLongMap var2 = (TIntLongMap)var1;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TIntLongProcedure(this, var1) {
         private boolean first;
         final StringBuilder val$buf;
         final TIntLongHashMap this$0;
         ...
         public boolean execute(int var1, long var2) {
            if (this.first) {
               this.first = false;
            } else {
               this.val$buf.append(", ");
   ...
   static int access$000(TIntLongHashMap var0) {
      return var0.no_entry_key;
   }

   static int access$100(TIntLongHashMap var0) {
      return var0._size;
   }

   static int access$200(TIntLongHashMap var0) {
      return var0._size;
   }

   static long access$300(TIntLongHashMap var0) {
      return var0.no_entry_value;
   }

   static long access$400(TIntLongHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$500(TIntLongHashMap var0) {
      return var0._size;
   }

   static int access$600(TIntLongHashMap var0) {
      return var0._size;
   }
   ...
   class TIntLongHashIterator extends THashPrimitiveIterator implements TIntLongIterator {
      ...
      TIntLongHashIterator(TIntLongHashMap var1, TIntLongHashMap var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TIntLongValueHashIterator extends THashPrimitiveIterator implements TLongIterator {
      ...
      TIntLongValueHashIterator(TIntLongHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TIntLongKeyHashIterator extends THashPrimitiveIterator implements TIntIterator {
      ...
      TIntLongKeyHashIterator(TIntLongHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   protected class TValueView implements TLongCollection {
      ...
      protected TValueView(TIntLongHashMap var1) {
         this.this$0 = var1;
      }

      public TLongIterator iterator() {
         return this.this$0.new TIntLongValueHashIterator(this.this$0, this.this$0);
      }
   ...
   protected class TKeyView implements TIntSet {
      ...
      protected TKeyView(TIntLongHashMap var1) {
         this.this$0 = var1;
      }

      public TIntIterator iterator() {
         return this.this$0.new TIntLongKeyHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachKey(new TIntProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TIntLongHashMap.TKeyView this$1;
