...
public class TShortDoubleHashMap extends TShortDoubleHash implements TShortDoubleMap, Externalizable {
   ...
   public TShortDoubleHashMap(TShortDoubleMap var1) {
      super(var1.size());
   ...
   public void putAll(TShortDoubleMap var1) {
      this.ensureCapacity(var1.size());
      TShortDoubleIterator var2 = var1.iterator();
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TShortDoubleMap)) {
         return false;
      } else {
         TShortDoubleMap var2 = (TShortDoubleMap)var1;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TShortDoubleProcedure(this, var1) {
   ...
   static short access$000(TShortDoubleHashMap var0) {
      return var0.no_entry_key;
   }

   static int access$100(TShortDoubleHashMap var0) {
      return var0._size;
   }

   static int access$200(TShortDoubleHashMap var0) {
      return var0._size;
   }

   static double access$300(TShortDoubleHashMap var0) {
      return var0.no_entry_value;
   }

   static double access$400(TShortDoubleHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$500(TShortDoubleHashMap var0) {
      return var0._size;
   }

   static int access$600(TShortDoubleHashMap var0) {
      return var0._size;
   }
   ...
   class TShortDoubleHashIterator extends THashPrimitiveIterator implements TShortDoubleIterator {
      ...
      TShortDoubleHashIterator(TShortDoubleHashMap var1, TShortDoubleHashMap var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TShortDoubleValueHashIterator extends THashPrimitiveIterator implements TDoubleIterator {
      ...
      TShortDoubleValueHashIterator(TShortDoubleHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TShortDoubleKeyHashIterator extends THashPrimitiveIterator implements TShortIterator {
      ...
      TShortDoubleKeyHashIterator(TShortDoubleHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   protected class TValueView implements TDoubleCollection {
      ...
      protected TValueView(TShortDoubleHashMap var1) {
         this.this$0 = var1;
      }

      public TDoubleIterator iterator() {
         return this.this$0.new TShortDoubleValueHashIterator(this.this$0, this.this$0);
      }
   ...
   protected class TKeyView implements TShortSet {
      ...
      protected TKeyView(TShortDoubleHashMap var1) {
         this.this$0 = var1;
      }

      public TShortIterator iterator() {
         return this.this$0.new TShortDoubleKeyHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachKey(new TShortProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TShortDoubleHashMap.TKeyView this$1;
