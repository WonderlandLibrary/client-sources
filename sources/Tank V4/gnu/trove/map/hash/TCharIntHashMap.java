...
public class TCharIntHashMap extends TCharIntHash implements TCharIntMap, Externalizable {
   ...
   public TCharIntHashMap(TCharIntMap var1) {
      super(var1.size());
   ...
   public void putAll(TCharIntMap var1) {
      this.ensureCapacity(var1.size());
      TCharIntIterator var2 = var1.iterator();
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TCharIntMap)) {
         return false;
      } else {
         TCharIntMap var2 = (TCharIntMap)var1;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TCharIntProcedure(this, var1) {
   ...
   static char access$000(TCharIntHashMap var0) {
      return var0.no_entry_key;
   }

   static int access$100(TCharIntHashMap var0) {
      return var0._size;
   }

   static int access$200(TCharIntHashMap var0) {
      return var0._size;
   }

   static int access$300(TCharIntHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$400(TCharIntHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$500(TCharIntHashMap var0) {
      return var0._size;
   }

   static int access$600(TCharIntHashMap var0) {
      return var0._size;
   }
   ...
   class TCharIntHashIterator extends THashPrimitiveIterator implements TCharIntIterator {
      ...
      TCharIntHashIterator(TCharIntHashMap var1, TCharIntHashMap var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TCharIntValueHashIterator extends THashPrimitiveIterator implements TIntIterator {
      ...
      TCharIntValueHashIterator(TCharIntHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TCharIntKeyHashIterator extends THashPrimitiveIterator implements TCharIterator {
      ...
      TCharIntKeyHashIterator(TCharIntHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   protected class TValueView implements TIntCollection {
      ...
      protected TValueView(TCharIntHashMap var1) {
         this.this$0 = var1;
      }

      public TIntIterator iterator() {
         return this.this$0.new TCharIntValueHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachValue(new TIntProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TCharIntHashMap.TValueView this$1;
   ...
   protected class TKeyView implements TCharSet {
      ...
      protected TKeyView(TCharIntHashMap var1) {
         this.this$0 = var1;
      }

      public TCharIterator iterator() {
         return this.this$0.new TCharIntKeyHashIterator(this.this$0, this.this$0);
      }
