...
public class THashMap extends TObjectHash implements TMap, Externalizable {
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof Map)) {
         ...
         Map var2 = (Map)var1;
         return var2.size() != this.size() ? false : this.forEachEntry(new THashMap.EqProcedure(this, var2));
      }
   }

   public int hashCode() {
      THashMap.HashProcedure var1 = new THashMap.HashProcedure(this);
   ...
   protected void rehash(int var1) {
      ...
      while(var7-- > 0) {
         ...
         if (var8 != FREE && var8 != REMOVED) {
            int var9 = this.insertKey(var8);
            if (var9 < 0) {
               this.throwObjectContractViolation(this._set[-var9 - 1], var8, this.size(), var3, var4);
            }

            this._values[var9] = var5[var7];
            ++var6;
         }
      }
   ...
   static boolean access$100(THashMap var0, Object var1, Object var2) {
      return var0.equals(var1, var2);
   }

   static boolean access$300(THashMap var0, Object var1, Object var2) {
      return var0.equals(var1, var2);
   }

   static int access$400(THashMap var0, Object var1) {
      return var0.index(var1);
   }

   static boolean access$500(THashMap var0, Object var1, Object var2) {
      return var0.equals(var1, var2);
   }

   static boolean access$600(THashMap var0, Object var1, Object var2) {
      return var0.equals(var1, var2);
   }

   static boolean access$700(THashMap var0, Object var1, Object var2) {
      return var0.equals(var1, var2);
   }

   static boolean access$800(THashMap var0, Object var1, Object var2) {
      return var0.equals(var1, var2);
   }
   ...
   final class Entry implements java.util.Map.Entry {
      ...
      Entry(THashMap var1, Object var2, Object var3, int var4) {
         this.this$0 = var1;
         this.key = var2;
         this.val = var3;
         this.index = var4;
      ...
      public boolean equals(Object var1) {
         if (!(var1 instanceof java.util.Map.Entry)) {
            ...
            return THashMap.access$700(this.this$0, this.getKey(), var3.getKey()) && THashMap.access$800(this.this$0, this.getValue(), this.getValue());
         }
      }
   ...
   protected class KeyView extends THashMap.MapBackedView {
      final THashMap this$0;

      protected KeyView(THashMap var1) {
         super(var1, null);
         this.this$0 = var1;
      }
   ...
   private abstract class MapBackedView extends AbstractSet implements Set, Iterable {
      ...
      private MapBackedView(THashMap var1) {
         this.this$0 = var1;
      }
      ...
      MapBackedView(THashMap var1, Object var2) {
         this(var1);
      }
   }

   protected class EntryView extends THashMap.MapBackedView {
      final THashMap this$0;

      protected EntryView(THashMap var1) {
         super(var1, null);
         this.this$0 = var1;
      }
      ...
      public boolean removeElement(java.util.Map.Entry var1) {
         if (var1 == null) {
            ...
            int var3 = THashMap.access$400(this.this$0, var4);
            if (var3 >= 0) {
               Object var2 = this.valueForEntry(var1);
               if (var2 == this.this$0._values[var3] || null != var2 && THashMap.access$500(this.this$0, var2, this.this$0._values[var3])) {
      ...
      public boolean containsElement(java.util.Map.Entry var1) {
         ...
         return var3 == var2 || null != var2 && THashMap.access$600(this.this$0, var2, var3);
      }
      ...
      private final class EntryIterator extends TObjectHashIterator {
         ...
         EntryIterator(THashMap.EntryView var1, THashMap var2) {
            super(var2);
            this.this$1 = var1;
         }

         public THashMap.Entry objectAtIndex(int var1) {
   ...
   protected class ValueView extends THashMap.MapBackedView {
      final THashMap this$0;

      protected ValueView(THashMap var1) {
         super(var1, null);
         this.this$0 = var1;
      }
      ...
      public boolean removeElement(Object var1) {
         ...
         } while((var3[var4] == TObjectHash.FREE || var3[var4] == TObjectHash.REMOVED || var1 != var2[var4]) && (null == var2[var4] || !THashMap.access$300(this.this$0, var2[var4], var1)));
   ...
   private final class EqProcedure implements TObjectObjectProcedure {
      private final Map _otherMap;
      final THashMap this$0;

      EqProcedure(THashMap var1, Map var2) {
         this.this$0 = var1;
         this._otherMap = var2;
      }
      ...
      public final boolean execute(Object var1, Object var2) {
         if (var2 == null && !this._otherMap.containsKey(var1)) {
            ...
            return var3 == var2 || var3 != null && THashMap.access$100(this.this$0, var3, var2);
         }
      }
   }
   ...
   private final class HashProcedure implements TObjectObjectProcedure {
      ...
      private HashProcedure(THashMap var1) {
         this.this$0 = var1;
         this.h = 0;
      }
      ...
      HashProcedure(THashMap var1, Object var2) {
         this(var1);
      }
   }
}
