...
public class TDoubleDoubleHashMap extends TDoubleDoubleHash implements TDoubleDoubleMap, Externalizable {
   ...
   public TDoubleDoubleHashMap(TDoubleDoubleMap var1) {
      super(var1.size());
   ...
   public void putAll(TDoubleDoubleMap var1) {
      this.ensureCapacity(var1.size());
      TDoubleDoubleIterator var2 = var1.iterator();
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TDoubleDoubleMap)) {
         return false;
      } else {
         TDoubleDoubleMap var2 = (TDoubleDoubleMap)var1;
         if (var2.size() != this.size()) {
            ...
            while(var9-- > 0) {
               if (var4[var9] == 1) {
                  ...
                  double var12 = var2.get(var10);
                  double var14 = var3[var9];
   ...
   public String toString() {
      ...
      this.forEachEntry(new TDoubleDoubleProcedure(this, var1) {
   ...
   static double access$000(TDoubleDoubleHashMap var0) {
      return var0.no_entry_key;
   }

   static int access$100(TDoubleDoubleHashMap var0) {
      return var0._size;
   }

   static int access$200(TDoubleDoubleHashMap var0) {
      return var0._size;
   }

   static double access$300(TDoubleDoubleHashMap var0) {
      return var0.no_entry_value;
   }

   static double access$400(TDoubleDoubleHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$500(TDoubleDoubleHashMap var0) {
      return var0._size;
   }

   static int access$600(TDoubleDoubleHashMap var0) {
      return var0._size;
   }
   ...
   class TDoubleDoubleHashIterator extends THashPrimitiveIterator implements TDoubleDoubleIterator {
      ...
      TDoubleDoubleHashIterator(TDoubleDoubleHashMap var1, TDoubleDoubleHashMap var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TDoubleDoubleValueHashIterator extends THashPrimitiveIterator implements TDoubleIterator {
      ...
      TDoubleDoubleValueHashIterator(TDoubleDoubleHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TDoubleDoubleKeyHashIterator extends THashPrimitiveIterator implements TDoubleIterator {
      ...
      TDoubleDoubleKeyHashIterator(TDoubleDoubleHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   protected class TValueView implements TDoubleCollection {
      ...
      protected TValueView(TDoubleDoubleHashMap var1) {
         this.this$0 = var1;
      }

      public TDoubleIterator iterator() {
         return this.this$0.new TDoubleDoubleValueHashIterator(this.this$0, this.this$0);
      }
   ...
   protected class TKeyView implements TDoubleSet {
      ...
      protected TKeyView(TDoubleDoubleHashMap var1) {
         this.this$0 = var1;
      }

      public TDoubleIterator iterator() {
         return this.this$0.new TDoubleDoubleKeyHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachKey(new TDoubleProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TDoubleDoubleHashMap.TKeyView this$1;
