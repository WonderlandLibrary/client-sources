...
public class TIntFloatHashMap extends TIntFloatHash implements TIntFloatMap, Externalizable {
   ...
   public TIntFloatHashMap(int var1) {
      super(var1);
   }

   public TIntFloatHashMap(int var1, float var2) {
      super(var1, var2);
   }

   public TIntFloatHashMap(int var1, float var2, int var3, float var4) {
   ...
   public TIntFloatHashMap(TIntFloatMap var1) {
      super(var1.size());
      if (var1 instanceof TIntFloatHashMap) {
         TIntFloatHashMap var2 = (TIntFloatHashMap)var1;
   ...
   private float doPut(int var1, float var2, int var3) {
   ...
   public void putAll(Map var1) {
      ...
      while(var2.hasNext()) {
         ...
         this.put((Integer)var3.getKey(), (Float)var3.getValue());
      }
   ...
   public void putAll(TIntFloatMap var1) {
      this.ensureCapacity(var1.size());
      TIntFloatIterator var2 = var1.iterator();
   ...
   public TIntSet keySet() {
      return new TIntFloatHashMap.TKeyView(this);
   }
   ...
   public TFloatCollection valueCollection() {
      return new TIntFloatHashMap.TValueView(this);
   }
   ...
   public TIntFloatIterator iterator() {
      return new TIntFloatHashMap.TIntFloatHashIterator(this, this);
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TIntFloatMap)) {
         return false;
      } else {
         TIntFloatMap var2 = (TIntFloatMap)var1;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TIntFloatProcedure(this, var1) {
   ...
   static int access$000(TIntFloatHashMap var0) {
      return var0.no_entry_key;
   }

   static int access$100(TIntFloatHashMap var0) {
      return var0._size;
   }

   static int access$200(TIntFloatHashMap var0) {
      return var0._size;
   }

   static float access$300(TIntFloatHashMap var0) {
      return var0.no_entry_value;
   }

   static float access$400(TIntFloatHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$500(TIntFloatHashMap var0) {
      return var0._size;
   }

   static int access$600(TIntFloatHashMap var0) {
      return var0._size;
   }
   ...
   class TIntFloatHashIterator extends THashPrimitiveIterator implements TIntFloatIterator {
      ...
      TIntFloatHashIterator(TIntFloatHashMap var1, TIntFloatHashMap var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TIntFloatValueHashIterator extends THashPrimitiveIterator implements TFloatIterator {
      ...
      TIntFloatValueHashIterator(TIntFloatHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TIntFloatKeyHashIterator extends THashPrimitiveIterator implements TIntIterator {
      ...
      TIntFloatKeyHashIterator(TIntFloatHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   protected class TValueView implements TFloatCollection {
      ...
      protected TValueView(TIntFloatHashMap var1) {
         this.this$0 = var1;
      }

      public TFloatIterator iterator() {
         return this.this$0.new TIntFloatValueHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachValue(new TFloatProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TIntFloatHashMap.TValueView this$1;
   ...
   protected class TKeyView implements TIntSet {
      ...
      protected TKeyView(TIntFloatHashMap var1) {
         this.this$0 = var1;
      }

      public TIntIterator iterator() {
         return this.this$0.new TIntFloatKeyHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachKey(new TIntProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TIntFloatHashMap.TKeyView this$1;
