...
public class TCharByteHashMap extends TCharByteHash implements TCharByteMap, Externalizable {
   ...
   public TCharByteHashMap(int var1) {
      super(var1);
   }

   public TCharByteHashMap(int var1, float var2) {
      super(var1, var2);
   }

   public TCharByteHashMap(int var1, float var2, char var3, byte var4) {
      super(var1, var2, var3, var4);
   }

   public TCharByteHashMap(char[] var1, byte[] var2) {
   ...
   public TCharByteHashMap(TCharByteMap var1) {
      super(var1.size());
      if (var1 instanceof TCharByteHashMap) {
         TCharByteHashMap var2 = (TCharByteHashMap)var1;
   ...
   private byte doPut(char var1, byte var2, int var3) {
   ...
   public void putAll(Map var1) {
      ...
      while(var2.hasNext()) {
         ...
         this.put((Character)var3.getKey(), (Byte)var3.getValue());
      }
   ...
   public void putAll(TCharByteMap var1) {
      this.ensureCapacity(var1.size());
      TCharByteIterator var2 = var1.iterator();
   ...
   public TCharSet keySet() {
      return new TCharByteHashMap.TKeyView(this);
   }
   ...
   public TByteCollection valueCollection() {
      return new TCharByteHashMap.TValueView(this);
   }
   ...
   public TCharByteIterator iterator() {
      return new TCharByteHashMap.TCharByteHashIterator(this, this);
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TCharByteMap)) {
         return false;
      } else {
         TCharByteMap var2 = (TCharByteMap)var1;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TCharByteProcedure(this, var1) {
   ...
   static char access$000(TCharByteHashMap var0) {
      return var0.no_entry_key;
   }

   static int access$100(TCharByteHashMap var0) {
      return var0._size;
   }

   static int access$200(TCharByteHashMap var0) {
      return var0._size;
   }

   static byte access$300(TCharByteHashMap var0) {
      return var0.no_entry_value;
   }

   static byte access$400(TCharByteHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$500(TCharByteHashMap var0) {
      return var0._size;
   }

   static int access$600(TCharByteHashMap var0) {
      return var0._size;
   }
   ...
   class TCharByteHashIterator extends THashPrimitiveIterator implements TCharByteIterator {
      ...
      TCharByteHashIterator(TCharByteHashMap var1, TCharByteHashMap var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TCharByteValueHashIterator extends THashPrimitiveIterator implements TByteIterator {
      ...
      TCharByteValueHashIterator(TCharByteHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TCharByteKeyHashIterator extends THashPrimitiveIterator implements TCharIterator {
      ...
      TCharByteKeyHashIterator(TCharByteHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   protected class TValueView implements TByteCollection {
      ...
      protected TValueView(TCharByteHashMap var1) {
         this.this$0 = var1;
      }

      public TByteIterator iterator() {
         return this.this$0.new TCharByteValueHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachValue(new TByteProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TCharByteHashMap.TValueView this$1;
   ...
   protected class TKeyView implements TCharSet {
      ...
      protected TKeyView(TCharByteHashMap var1) {
         this.this$0 = var1;
      }

      public TCharIterator iterator() {
         return this.this$0.new TCharByteKeyHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachKey(new TCharProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TCharByteHashMap.TKeyView this$1;
