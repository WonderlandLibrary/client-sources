...
public class TFloatObjectHashMap extends TFloatHash implements TFloatObjectMap, Externalizable {
   ...
   public TFloatObjectHashMap() {
      this.PUT_ALL_PROC = new TFloatObjectProcedure(this) {
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TFloatObjectMap)) {
         ...
         TFloatObjectMap var2 = (TFloatObjectMap)var1;
         if (var2.size() != this.size()) {
            return false;
         } else {
            try {
               TFloatObjectIterator var3 = this.iterator();
   ...
   public String toString() {
      ...
      this.forEachEntry(new TFloatObjectProcedure(this, var1) {
   ...
   static int access$000(TFloatObjectHashMap var0) {
      return var0._size;
   }

   static int access$100(TFloatObjectHashMap var0) {
      return var0._size;
   }
   ...
   class TFloatObjectHashIterator extends THashPrimitiveIterator implements TFloatObjectIterator {
      ...
      public TFloatObjectHashIterator(TFloatObjectHashMap var1, TFloatObjectHashMap var2) {
         super(var2);
         this.this$0 = var1;
         this._map = var2;
      }
   ...
   private abstract class MapBackedView extends AbstractSet implements Set, Iterable {
      ...
      private MapBackedView(TFloatObjectHashMap var1) {
         this.this$0 = var1;
      }
      ...
      MapBackedView(TFloatObjectHashMap var1, Object var2) {
         this(var1);
      }
   }

   protected class ValueView extends TFloatObjectHashMap.MapBackedView {
      final TFloatObjectHashMap this$0;

      protected ValueView(TFloatObjectHashMap var1) {
         super(var1, null);
         this.this$0 = var1;
      }

      public Iterator iterator() {
         return new TFloatObjectHashMap.ValueView.TFloatObjectValueHashIterator(this, this.this$0) {
      ...
      class TFloatObjectValueHashIterator extends THashPrimitiveIterator implements Iterator {
         protected final TFloatObjectHashMap _map;
         final TFloatObjectHashMap.ValueView this$1;

         public TFloatObjectValueHashIterator(TFloatObjectHashMap.ValueView var1, TFloatObjectHashMap var2) {
            super(var2);
            this.this$1 = var1;
            this._map = var2;
         }
   ...
   class KeyView implements TFloatSet {
      ...
      KeyView(TFloatObjectHashMap var1) {
         this.this$0 = var1;
      }
      ...
      public boolean containsAll(Collection var1) {
         ...
         do {
            ...
            var3 = var2.next();
         } while(this.this$0.containsKey((Float)var3));
      ...
      class TFloatHashIterator extends THashPrimitiveIterator implements TFloatIterator {
         ...
         public TFloatHashIterator(TFloatObjectHashMap.KeyView var1, TFloatHash var2) {
            super(var2);
            this.this$1 = var1;
            this._hash = var2;
         }
