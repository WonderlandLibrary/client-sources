...
public class TObjectIntHashMap extends TObjectHash implements TObjectIntMap, Externalizable {
   ...
   public TObjectIntHashMap(int var1) {
      super(var1);
      this.PUT_ALL_PROC = new TObjectIntProcedure(this) {
         final TObjectIntHashMap this$0;
   ...
   public TObjectIntHashMap(int var1, float var2) {
      super(var1, var2);
      this.PUT_ALL_PROC = new TObjectIntProcedure(this) {
         final TObjectIntHashMap this$0;
   ...
   public TObjectIntHashMap(int var1, float var2, int var3) {
      super(var1, var2);
      this.PUT_ALL_PROC = new TObjectIntProcedure(this) {
         final TObjectIntHashMap this$0;
   ...
   public TObjectIntHashMap(TObjectIntMap var1) {
      this(var1.size(), 0.5F, var1.getNoEntryValue());
      if (var1 instanceof TObjectIntHashMap) {
         TObjectIntHashMap var2 = (TObjectIntHashMap)var1;
   ...
   public Set keySet() {
      return new TObjectIntHashMap.KeyView(this);
   }
   ...
   public TIntCollection valueCollection() {
      return new TObjectIntHashMap.TIntValueCollection(this);
   }
   ...
   public TObjectIntIterator iterator() {
      return new TObjectIntHashMap.TObjectIntHashIterator(this, this);
   }
   ...
   static int access$100(TObjectIntHashMap var0) {
      return var0._size;
   }

   static int access$200(TObjectIntHashMap var0) {
      return var0._size;
   }
   ...
   class TObjectIntHashIterator extends TObjectHashIterator implements TObjectIntIterator {
      ...
      public TObjectIntHashIterator(TObjectIntHashMap var1, TObjectIntHashMap var2) {
         super(var2);
         this.this$0 = var1;
         this._map = var2;
      }
   ...
   class TIntValueCollection implements TIntCollection {
      ...
      TIntValueCollection(TObjectIntHashMap var1) {
         this.this$0 = var1;
      }

      public TIntIterator iterator() {
         return new TObjectIntHashMap.TIntValueCollection.TObjectIntValueHashIterator(this);
      }
      ...
      class TObjectIntValueHashIterator implements TIntIterator {
         ...
         TObjectIntValueHashIterator(TObjectIntHashMap.TIntValueCollection var1) {
            this.this$1 = var1;
   ...
   private abstract class MapBackedView extends AbstractSet implements Set, Iterable {
      ...
      private MapBackedView(TObjectIntHashMap var1) {
         this.this$0 = var1;
      }
      ...
      MapBackedView(TObjectIntHashMap var1, Object var2) {
         this(var1);
      }
   }

   protected class KeyView extends TObjectIntHashMap.MapBackedView {
      final TObjectIntHashMap this$0;

      protected KeyView(TObjectIntHashMap var1) {
         super(var1, null);
         this.this$0 = var1;
      }
