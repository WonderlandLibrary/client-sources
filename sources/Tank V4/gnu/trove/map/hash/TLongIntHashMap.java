...
public class TLongIntHashMap extends TLongIntHash implements TLongIntMap, Externalizable {
   ...
   public TLongIntHashMap(int var1) {
      super(var1);
   }

   public TLongIntHashMap(int var1, float var2) {
      super(var1, var2);
   }

   public TLongIntHashMap(int var1, float var2, long var3, int var5) {
      super(var1, var2, var3, var5);
   }

   public TLongIntHashMap(long[] var1, int[] var2) {
   ...
   public TLongIntHashMap(TLongIntMap var1) {
      super(var1.size());
      if (var1 instanceof TLongIntHashMap) {
         TLongIntHashMap var2 = (TLongIntHashMap)var1;
   ...
   private int doPut(long var1, int var3, int var4) {
   ...
   public void putAll(Map var1) {
      ...
      while(var2.hasNext()) {
         ...
         this.put((Long)var3.getKey(), (Integer)var3.getValue());
      }
   ...
   public void putAll(TLongIntMap var1) {
      this.ensureCapacity(var1.size());
      TLongIntIterator var2 = var1.iterator();
   ...
   public TLongSet keySet() {
      return new TLongIntHashMap.TKeyView(this);
   }
   ...
   public TIntCollection valueCollection() {
      return new TLongIntHashMap.TValueView(this);
   }
   ...
   public TLongIntIterator iterator() {
      return new TLongIntHashMap.TLongIntHashIterator(this, this);
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TLongIntMap)) {
         return false;
      } else {
         TLongIntMap var2 = (TLongIntMap)var1;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TLongIntProcedure(this, var1) {
   ...
   static long access$000(TLongIntHashMap var0) {
      return var0.no_entry_key;
   }

   static int access$100(TLongIntHashMap var0) {
      return var0._size;
   }

   static int access$200(TLongIntHashMap var0) {
      return var0._size;
   }

   static int access$300(TLongIntHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$400(TLongIntHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$500(TLongIntHashMap var0) {
      return var0._size;
   }

   static int access$600(TLongIntHashMap var0) {
      return var0._size;
   }
   ...
   class TLongIntHashIterator extends THashPrimitiveIterator implements TLongIntIterator {
      ...
      TLongIntHashIterator(TLongIntHashMap var1, TLongIntHashMap var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TLongIntValueHashIterator extends THashPrimitiveIterator implements TIntIterator {
      ...
      TLongIntValueHashIterator(TLongIntHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TLongIntKeyHashIterator extends THashPrimitiveIterator implements TLongIterator {
      ...
      TLongIntKeyHashIterator(TLongIntHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   protected class TValueView implements TIntCollection {
      ...
      protected TValueView(TLongIntHashMap var1) {
         this.this$0 = var1;
      }

      public TIntIterator iterator() {
         return this.this$0.new TLongIntValueHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachValue(new TIntProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TLongIntHashMap.TValueView this$1;
   ...
   protected class TKeyView implements TLongSet {
      ...
      protected TKeyView(TLongIntHashMap var1) {
         this.this$0 = var1;
      }

      public TLongIterator iterator() {
         return this.this$0.new TLongIntKeyHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachKey(new TLongProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TLongIntHashMap.TKeyView this$1;
