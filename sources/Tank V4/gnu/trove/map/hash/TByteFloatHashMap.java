...
public class TByteFloatHashMap extends TByteFloatHash implements TByteFloatMap, Externalizable {
   ...
   public TByteFloatHashMap(TByteFloatMap var1) {
      super(var1.size());
   ...
   public void putAll(TByteFloatMap var1) {
      this.ensureCapacity(var1.size());
      TByteFloatIterator var2 = var1.iterator();
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TByteFloatMap)) {
         return false;
      } else {
         TByteFloatMap var2 = (TByteFloatMap)var1;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TByteFloatProcedure(this, var1) {
   ...
   static byte access$000(TByteFloatHashMap var0) {
      return var0.no_entry_key;
   }

   static int access$100(TByteFloatHashMap var0) {
      return var0._size;
   }

   static int access$200(TByteFloatHashMap var0) {
      return var0._size;
   }

   static float access$300(TByteFloatHashMap var0) {
      return var0.no_entry_value;
   }

   static float access$400(TByteFloatHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$500(TByteFloatHashMap var0) {
      return var0._size;
   }

   static int access$600(TByteFloatHashMap var0) {
      return var0._size;
   }
   ...
   class TByteFloatHashIterator extends THashPrimitiveIterator implements TByteFloatIterator {
      ...
      TByteFloatHashIterator(TByteFloatHashMap var1, TByteFloatHashMap var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TByteFloatValueHashIterator extends THashPrimitiveIterator implements TFloatIterator {
      ...
      TByteFloatValueHashIterator(TByteFloatHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TByteFloatKeyHashIterator extends THashPrimitiveIterator implements TByteIterator {
      ...
      TByteFloatKeyHashIterator(TByteFloatHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   protected class TValueView implements TFloatCollection {
      ...
      protected TValueView(TByteFloatHashMap var1) {
         this.this$0 = var1;
      }

      public TFloatIterator iterator() {
         return this.this$0.new TByteFloatValueHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachValue(new TFloatProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TByteFloatHashMap.TValueView this$1;
   ...
   protected class TKeyView implements TByteSet {
      ...
      protected TKeyView(TByteFloatHashMap var1) {
         this.this$0 = var1;
      }

      public TByteIterator iterator() {
         return this.this$0.new TByteFloatKeyHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachKey(new TByteProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TByteFloatHashMap.TKeyView this$1;
