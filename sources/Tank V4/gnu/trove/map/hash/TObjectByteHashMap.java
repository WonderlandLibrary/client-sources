...
public class TObjectByteHashMap extends TObjectHash implements TObjectByteMap, Externalizable {
   ...
   public TObjectByteHashMap(int var1) {
      super(var1);
      this.PUT_ALL_PROC = new TObjectByteProcedure(this) {
         final TObjectByteHashMap this$0;
   ...
   public TObjectByteHashMap(int var1, float var2) {
      super(var1, var2);
      this.PUT_ALL_PROC = new TObjectByteProcedure(this) {
         final TObjectByteHashMap this$0;
   ...
   public TObjectByteHashMap(int var1, float var2, byte var3) {
      super(var1, var2);
      this.PUT_ALL_PROC = new TObjectByteProcedure(this) {
         final TObjectByteHashMap this$0;
   ...
   public TObjectByteHashMap(TObjectByteMap var1) {
      this(var1.size(), 0.5F, var1.getNoEntryValue());
      if (var1 instanceof TObjectByteHashMap) {
         TObjectByteHashMap var2 = (TObjectByteHashMap)var1;
   ...
   public Set keySet() {
      return new TObjectByteHashMap.KeyView(this);
   }
   ...
   public TByteCollection valueCollection() {
      return new TObjectByteHashMap.TByteValueCollection(this);
   }
   ...
   public TObjectByteIterator iterator() {
      return new TObjectByteHashMap.TObjectByteHashIterator(this, this);
   }
   ...
   static int access$100(TObjectByteHashMap var0) {
      return var0._size;
   }

   static int access$200(TObjectByteHashMap var0) {
      return var0._size;
   }
   ...
   class TObjectByteHashIterator extends TObjectHashIterator implements TObjectByteIterator {
      ...
      public TObjectByteHashIterator(TObjectByteHashMap var1, TObjectByteHashMap var2) {
         super(var2);
         this.this$0 = var1;
         this._map = var2;
      }
   ...
   class TByteValueCollection implements TByteCollection {
      ...
      TByteValueCollection(TObjectByteHashMap var1) {
         this.this$0 = var1;
      }
      ...
      class TObjectByteValueHashIterator implements TByteIterator {
         ...
         TObjectByteValueHashIterator(TObjectByteHashMap.TByteValueCollection var1) {
            this.this$1 = var1;
   ...
   private abstract class MapBackedView extends AbstractSet implements Set, Iterable {
      ...
      private MapBackedView(TObjectByteHashMap var1) {
         this.this$0 = var1;
      }
      ...
      MapBackedView(TObjectByteHashMap var1, Object var2) {
         this(var1);
      }
   }

   protected class KeyView extends TObjectByteHashMap.MapBackedView {
      final TObjectByteHashMap this$0;

      protected KeyView(TObjectByteHashMap var1) {
         super(var1, null);
         this.this$0 = var1;
      }
