...
public class TByteShortHashMap extends TByteShortHash implements TByteShortMap, Externalizable {
   ...
   public TByteShortHashMap(int var1) {
      super(var1);
   }

   public TByteShortHashMap(int var1, float var2) {
      super(var1, var2);
   }

   public TByteShortHashMap(int var1, float var2, byte var3, short var4) {
      super(var1, var2, var3, var4);
   }

   public TByteShortHashMap(byte[] var1, short[] var2) {
   ...
   public TByteShortHashMap(TByteShortMap var1) {
      super(var1.size());
      if (var1 instanceof TByteShortHashMap) {
         TByteShortHashMap var2 = (TByteShortHashMap)var1;
   ...
   private short doPut(byte var1, short var2, int var3) {
   ...
   public void putAll(Map var1) {
      ...
      while(var2.hasNext()) {
         ...
         this.put((Byte)var3.getKey(), (Short)var3.getValue());
      }
   ...
   public void putAll(TByteShortMap var1) {
      this.ensureCapacity(var1.size());
      TByteShortIterator var2 = var1.iterator();
   ...
   public TByteSet keySet() {
      return new TByteShortHashMap.TKeyView(this);
   }
   ...
   public TShortCollection valueCollection() {
      return new TByteShortHashMap.TValueView(this);
   }
   ...
   public TByteShortIterator iterator() {
      return new TByteShortHashMap.TByteShortHashIterator(this, this);
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TByteShortMap)) {
         return false;
      } else {
         TByteShortMap var2 = (TByteShortMap)var1;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TByteShortProcedure(this, var1) {
   ...
   static byte access$000(TByteShortHashMap var0) {
      return var0.no_entry_key;
   }

   static int access$100(TByteShortHashMap var0) {
      return var0._size;
   }

   static int access$200(TByteShortHashMap var0) {
      return var0._size;
   }

   static short access$300(TByteShortHashMap var0) {
      return var0.no_entry_value;
   }

   static short access$400(TByteShortHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$500(TByteShortHashMap var0) {
      return var0._size;
   }

   static int access$600(TByteShortHashMap var0) {
      return var0._size;
   }
   ...
   class TByteShortHashIterator extends THashPrimitiveIterator implements TByteShortIterator {
      ...
      TByteShortHashIterator(TByteShortHashMap var1, TByteShortHashMap var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TByteShortValueHashIterator extends THashPrimitiveIterator implements TShortIterator {
      ...
      TByteShortValueHashIterator(TByteShortHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TByteShortKeyHashIterator extends THashPrimitiveIterator implements TByteIterator {
      ...
      TByteShortKeyHashIterator(TByteShortHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   protected class TValueView implements TShortCollection {
      ...
      protected TValueView(TByteShortHashMap var1) {
         this.this$0 = var1;
      }

      public TShortIterator iterator() {
         return this.this$0.new TByteShortValueHashIterator(this.this$0, this.this$0);
      }
   ...
   protected class TKeyView implements TByteSet {
      ...
      protected TKeyView(TByteShortHashMap var1) {
         this.this$0 = var1;
      }

      public TByteIterator iterator() {
         return this.this$0.new TByteShortKeyHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachKey(new TByteProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TByteShortHashMap.TKeyView this$1;
