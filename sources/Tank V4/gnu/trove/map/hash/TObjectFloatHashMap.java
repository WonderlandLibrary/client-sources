...
public class TObjectFloatHashMap extends TObjectHash implements TObjectFloatMap, Externalizable {
   ...
   public TObjectFloatHashMap(TObjectFloatMap var1) {
   ...
   static int access$100(TObjectFloatHashMap var0) {
      return var0._size;
   }

   static int access$200(TObjectFloatHashMap var0) {
      return var0._size;
   }
   ...
   class TObjectFloatHashIterator extends TObjectHashIterator implements TObjectFloatIterator {
      ...
      public TObjectFloatHashIterator(TObjectFloatHashMap var1, TObjectFloatHashMap var2) {
         super(var2);
         this.this$0 = var1;
         this._map = var2;
      }
   ...
   class TFloatValueCollection implements TFloatCollection {
      ...
      TFloatValueCollection(TObjectFloatHashMap var1) {
         this.this$0 = var1;
      }
      ...
      class TObjectFloatValueHashIterator implements TFloatIterator {
         ...
         TObjectFloatValueHashIterator(TObjectFloatHashMap.TFloatValueCollection var1) {
            this.this$1 = var1;
   ...
   private abstract class MapBackedView extends AbstractSet implements Set, Iterable {
      ...
      private MapBackedView(TObjectFloatHashMap var1) {
         this.this$0 = var1;
      }
      ...
      MapBackedView(TObjectFloatHashMap var1, Object var2) {
         this(var1);
      }
   }

   protected class KeyView extends TObjectFloatHashMap.MapBackedView {
      final TObjectFloatHashMap this$0;

      protected KeyView(TObjectFloatHashMap var1) {
         super(var1, null);
         this.this$0 = var1;
      }
