...
public class TLongDoubleHashMap extends TLongDoubleHash implements TLongDoubleMap, Externalizable {
   ...
   public TLongDoubleHashMap(TLongDoubleMap var1) {
      super(var1.size());
   ...
   public void putAll(TLongDoubleMap var1) {
      this.ensureCapacity(var1.size());
      TLongDoubleIterator var2 = var1.iterator();
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof TLongDoubleMap)) {
         return false;
      } else {
         TLongDoubleMap var2 = (TLongDoubleMap)var1;
   ...
   public String toString() {
      ...
      this.forEachEntry(new TLongDoubleProcedure(this, var1) {
   ...
   static long access$000(TLongDoubleHashMap var0) {
      return var0.no_entry_key;
   }

   static int access$100(TLongDoubleHashMap var0) {
      return var0._size;
   }

   static int access$200(TLongDoubleHashMap var0) {
      return var0._size;
   }

   static double access$300(TLongDoubleHashMap var0) {
      return var0.no_entry_value;
   }

   static double access$400(TLongDoubleHashMap var0) {
      return var0.no_entry_value;
   }

   static int access$500(TLongDoubleHashMap var0) {
      return var0._size;
   }

   static int access$600(TLongDoubleHashMap var0) {
      return var0._size;
   }
   ...
   class TLongDoubleHashIterator extends THashPrimitiveIterator implements TLongDoubleIterator {
      ...
      TLongDoubleHashIterator(TLongDoubleHashMap var1, TLongDoubleHashMap var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TLongDoubleValueHashIterator extends THashPrimitiveIterator implements TDoubleIterator {
      ...
      TLongDoubleValueHashIterator(TLongDoubleHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   class TLongDoubleKeyHashIterator extends THashPrimitiveIterator implements TLongIterator {
      ...
      TLongDoubleKeyHashIterator(TLongDoubleHashMap var1, TPrimitiveHash var2) {
         super(var2);
         this.this$0 = var1;
      }
   ...
   protected class TValueView implements TDoubleCollection {
      ...
      protected TValueView(TLongDoubleHashMap var1) {
         this.this$0 = var1;
      }

      public TDoubleIterator iterator() {
         return this.this$0.new TLongDoubleValueHashIterator(this.this$0, this.this$0);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachValue(new TDoubleProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TLongDoubleHashMap.TValueView this$1;
   ...
   protected class TKeyView implements TLongSet {
      ...
      protected TKeyView(TLongDoubleHashMap var1) {
         this.this$0 = var1;
      }

      public TLongIterator iterator() {
         return this.this$0.new TLongDoubleKeyHashIterator(this.this$0, this.this$0);
      }
