...
public class TObjectCharCustomHashMap extends TCustomObjectHash implements TObjectCharMap, Externalizable {
   ...
   public TObjectCharCustomHashMap() {
      this.PUT_ALL_PROC = new TObjectCharProcedure(this) {
         final TObjectCharCustomHashMap this$0;
   ...
   public TObjectCharCustomHashMap(HashingStrategy var1) {
      super(var1);
      this.PUT_ALL_PROC = new TObjectCharProcedure(this) {
         final TObjectCharCustomHashMap this$0;
   ...
   public TObjectCharCustomHashMap(HashingStrategy var1, int var2) {
      super(var1, var2);
      this.PUT_ALL_PROC = new TObjectCharProcedure(this) {
         final TObjectCharCustomHashMap this$0;
   ...
   public TObjectCharCustomHashMap(HashingStrategy var1, int var2, float var3) {
   ...
   public TObjectCharCustomHashMap(HashingStrategy var1, int var2, float var3, char var4) {
      super(var1, var2, var3);
      this.PUT_ALL_PROC = new TObjectCharProcedure(this) {
         final TObjectCharCustomHashMap this$0;
   ...
   public TObjectCharCustomHashMap(HashingStrategy var1, TObjectCharMap var2) {
      this(var1, var2.size(), 0.5F, var2.getNoEntryValue());
      if (var2 instanceof TObjectCharCustomHashMap) {
         TObjectCharCustomHashMap var3 = (TObjectCharCustomHashMap)var2;
   ...
   public Set keySet() {
      return new TObjectCharCustomHashMap.KeyView(this);
   }
   ...
   public TCharCollection valueCollection() {
      return new TObjectCharCustomHashMap.TCharValueCollection(this);
   }
   ...
   public TObjectCharIterator iterator() {
      return new TObjectCharCustomHashMap.TObjectCharHashIterator(this, this);
   }
   ...
   static int access$100(TObjectCharCustomHashMap var0) {
      return var0._size;
   }

   static int access$200(TObjectCharCustomHashMap var0) {
      return var0._size;
   }

   class TObjectCharHashIterator extends TObjectHashIterator implements TObjectCharIterator {
      private final TObjectCharCustomHashMap _map;
      final TObjectCharCustomHashMap this$0;

      public TObjectCharHashIterator(TObjectCharCustomHashMap var1, TObjectCharCustomHashMap var2) {
         super(var2);
         this.this$0 = var1;
         this._map = var2;
      }
   ...
   class TCharValueCollection implements TCharCollection {
      ...
      TCharValueCollection(TObjectCharCustomHashMap var1) {
         this.this$0 = var1;
      }

      public TCharIterator iterator() {
         return new TObjectCharCustomHashMap.TCharValueCollection.TObjectCharValueHashIterator(this);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachValue(new TCharProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TObjectCharCustomHashMap.TCharValueCollection this$1;
      ...
      class TObjectCharValueHashIterator implements TCharIterator {
         ...
         TObjectCharValueHashIterator(TObjectCharCustomHashMap.TCharValueCollection var1) {
            this.this$1 = var1;
   ...
   private abstract class MapBackedView extends AbstractSet implements Set, Iterable {
      ...
      private MapBackedView(TObjectCharCustomHashMap var1) {
         this.this$0 = var1;
      }
      ...
      MapBackedView(TObjectCharCustomHashMap var1, Object var2) {
         this(var1);
      }
   }

   protected class KeyView extends TObjectCharCustomHashMap.MapBackedView {
      final TObjectCharCustomHashMap this$0;

      protected KeyView(TObjectCharCustomHashMap var1) {
         super(var1, null);
         this.this$0 = var1;
      }
