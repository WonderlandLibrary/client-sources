...
public class TObjectShortCustomHashMap extends TCustomObjectHash implements TObjectShortMap, Externalizable {
   ...
   public TObjectShortCustomHashMap() {
      this.PUT_ALL_PROC = new TObjectShortProcedure(this) {
         final TObjectShortCustomHashMap this$0;
   ...
   public TObjectShortCustomHashMap(HashingStrategy var1) {
      super(var1);
      this.PUT_ALL_PROC = new TObjectShortProcedure(this) {
         final TObjectShortCustomHashMap this$0;
   ...
   public TObjectShortCustomHashMap(HashingStrategy var1, int var2) {
      super(var1, var2);
      this.PUT_ALL_PROC = new TObjectShortProcedure(this) {
         final TObjectShortCustomHashMap this$0;
   ...
   public TObjectShortCustomHashMap(HashingStrategy var1, int var2, float var3) {
   ...
   public TObjectShortCustomHashMap(HashingStrategy var1, int var2, float var3, short var4) {
      super(var1, var2, var3);
      this.PUT_ALL_PROC = new TObjectShortProcedure(this) {
         final TObjectShortCustomHashMap this$0;
   ...
   public TObjectShortCustomHashMap(HashingStrategy var1, TObjectShortMap var2) {
      this(var1, var2.size(), 0.5F, var2.getNoEntryValue());
      if (var2 instanceof TObjectShortCustomHashMap) {
         TObjectShortCustomHashMap var3 = (TObjectShortCustomHashMap)var2;
   ...
   public Set keySet() {
      return new TObjectShortCustomHashMap.KeyView(this);
   }
   ...
   public TShortCollection valueCollection() {
      return new TObjectShortCustomHashMap.TShortValueCollection(this);
   }
   ...
   public TObjectShortIterator iterator() {
      return new TObjectShortCustomHashMap.TObjectShortHashIterator(this, this);
   }
   ...
   static int access$100(TObjectShortCustomHashMap var0) {
      return var0._size;
   }

   static int access$200(TObjectShortCustomHashMap var0) {
      return var0._size;
   }

   class TObjectShortHashIterator extends TObjectHashIterator implements TObjectShortIterator {
      private final TObjectShortCustomHashMap _map;
      final TObjectShortCustomHashMap this$0;

      public TObjectShortHashIterator(TObjectShortCustomHashMap var1, TObjectShortCustomHashMap var2) {
         super(var2);
         this.this$0 = var1;
         this._map = var2;
      }
   ...
   class TShortValueCollection implements TShortCollection {
      ...
      TShortValueCollection(TObjectShortCustomHashMap var1) {
         this.this$0 = var1;
      }

      public TShortIterator iterator() {
         return new TObjectShortCustomHashMap.TShortValueCollection.TObjectShortValueHashIterator(this);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachValue(new TShortProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TObjectShortCustomHashMap.TShortValueCollection this$1;
      ...
      class TObjectShortValueHashIterator implements TShortIterator {
         ...
         TObjectShortValueHashIterator(TObjectShortCustomHashMap.TShortValueCollection var1) {
            this.this$1 = var1;
   ...
   private abstract class MapBackedView extends AbstractSet implements Set, Iterable {
      ...
      private MapBackedView(TObjectShortCustomHashMap var1) {
         this.this$0 = var1;
      }
      ...
      MapBackedView(TObjectShortCustomHashMap var1, Object var2) {
         this(var1);
      }
   }

   protected class KeyView extends TObjectShortCustomHashMap.MapBackedView {
      final TObjectShortCustomHashMap this$0;

      protected KeyView(TObjectShortCustomHashMap var1) {
         super(var1, null);
         this.this$0 = var1;
      }
