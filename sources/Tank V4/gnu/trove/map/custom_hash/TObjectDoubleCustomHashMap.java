...
public class TObjectDoubleCustomHashMap extends TCustomObjectHash implements TObjectDoubleMap, Externalizable {
   ...
   public TObjectDoubleCustomHashMap() {
      this.PUT_ALL_PROC = new TObjectDoubleProcedure(this) {
         final TObjectDoubleCustomHashMap this$0;
   ...
   public TObjectDoubleCustomHashMap(HashingStrategy var1) {
      super(var1);
      this.PUT_ALL_PROC = new TObjectDoubleProcedure(this) {
         final TObjectDoubleCustomHashMap this$0;
   ...
   public TObjectDoubleCustomHashMap(HashingStrategy var1, int var2) {
      super(var1, var2);
      this.PUT_ALL_PROC = new TObjectDoubleProcedure(this) {
         final TObjectDoubleCustomHashMap this$0;
   ...
   public TObjectDoubleCustomHashMap(HashingStrategy var1, int var2, float var3) {
   ...
   public TObjectDoubleCustomHashMap(HashingStrategy var1, int var2, float var3, double var4) {
      super(var1, var2, var3);
      this.PUT_ALL_PROC = new TObjectDoubleProcedure(this) {
         final TObjectDoubleCustomHashMap this$0;
   ...
   public TObjectDoubleCustomHashMap(HashingStrategy var1, TObjectDoubleMap var2) {
      this(var1, var2.size(), 0.5F, var2.getNoEntryValue());
      if (var2 instanceof TObjectDoubleCustomHashMap) {
         TObjectDoubleCustomHashMap var3 = (TObjectDoubleCustomHashMap)var2;
   ...
   public Set keySet() {
      return new TObjectDoubleCustomHashMap.KeyView(this);
   }
   ...
   public TDoubleCollection valueCollection() {
      return new TObjectDoubleCustomHashMap.TDoubleValueCollection(this);
   }
   ...
   public TObjectDoubleIterator iterator() {
      return new TObjectDoubleCustomHashMap.TObjectDoubleHashIterator(this, this);
   }
   ...
   static int access$100(TObjectDoubleCustomHashMap var0) {
      return var0._size;
   }

   static int access$200(TObjectDoubleCustomHashMap var0) {
      return var0._size;
   }

   class TObjectDoubleHashIterator extends TObjectHashIterator implements TObjectDoubleIterator {
      private final TObjectDoubleCustomHashMap _map;
      final TObjectDoubleCustomHashMap this$0;

      public TObjectDoubleHashIterator(TObjectDoubleCustomHashMap var1, TObjectDoubleCustomHashMap var2) {
         super(var2);
         this.this$0 = var1;
         this._map = var2;
      }
   ...
   class TDoubleValueCollection implements TDoubleCollection {
      ...
      TDoubleValueCollection(TObjectDoubleCustomHashMap var1) {
         this.this$0 = var1;
      }

      public TDoubleIterator iterator() {
         return new TObjectDoubleCustomHashMap.TDoubleValueCollection.TObjectDoubleValueHashIterator(this);
      }
      ...
      public String toString() {
         ...
         this.this$0.forEachValue(new TDoubleProcedure(this, var1) {
            private boolean first;
            final StringBuilder val$buf;
            final TObjectDoubleCustomHashMap.TDoubleValueCollection this$1;
      ...
      class TObjectDoubleValueHashIterator implements TDoubleIterator {
         ...
         TObjectDoubleValueHashIterator(TObjectDoubleCustomHashMap.TDoubleValueCollection var1) {
            this.this$1 = var1;
   ...
   private abstract class MapBackedView extends AbstractSet implements Set, Iterable {
      ...
      private MapBackedView(TObjectDoubleCustomHashMap var1) {
         this.this$0 = var1;
      }
      ...
      MapBackedView(TObjectDoubleCustomHashMap var1, Object var2) {
         this(var1);
      }
   }

   protected class KeyView extends TObjectDoubleCustomHashMap.MapBackedView {
      final TObjectDoubleCustomHashMap this$0;

      protected KeyView(TObjectDoubleCustomHashMap var1) {
         super(var1, null);
         this.this$0 = var1;
      }
