...
public class TCharCharMapDecorator extends AbstractMap implements Map, Externalizable, Cloneable {
   ...
   public TCharCharMapDecorator(TCharCharMap var1) {
      this._map = var1;
   }
   ...
   public Character put(Character var1, Character var2) {
      ...
      char var5 = this._map.put(var3, var4);
   ...
   public Character remove(Object var1) {
      ...
      char var3 = this._map.remove(var2);
      return var3 == this._map.getNoEntryValue() ? null : this.wrapValue(var3);
   }

   public Set entrySet() {
      return new AbstractSet(this) {
         final TCharCharMapDecorator this$0;
         ...
         public Iterator iterator() {
            return new Iterator(this) {
               ...
               public Entry next() {
                  this.it.advance();
                  char var1 = this.it.key();
                  Character var2 = var1 == this.this$1.this$0._map.getNoEntryKey() ? null : this.this$1.this$0.wrapKey(var1);
                  char var3 = this.it.value();
                  Character var4 = var3 == this.this$1.this$0._map.getNoEntryValue() ? null : this.this$1.this$0.wrapValue(var3);
                  return new Entry(this, var4, var2) {
                     private Character val;
                     final Character val$v;
                     final Character val$key;
                     ...
                     public Object setValue(Object var1) {
                        return this.setValue((Character)var1);
                     }
         ...
         public boolean remove(Object var1) {
            boolean var2 = false;
            if (var1 != false) {
               Character var3 = (Character)((Entry)var1).getKey();
   ...
   public boolean containsValue(Object var1) {
      return var1 instanceof Character && this._map.containsValue(this.unwrapValue(var1));
   }
   ...
   public boolean containsKey(Object var1) {
      if (var1 == null) {
         ...
         return var1 instanceof Character && this._map.containsKey(this.unwrapKey(var1));
      }
   }
   ...
   protected Character wrapKey(char var1) {
      return var1;
   }

   protected char unwrapKey(Object var1) {
      return (Character)var1;
   }

   protected Character wrapValue(char var1) {
      return var1;
   }

   protected char unwrapValue(Object var1) {
      return (Character)var1;
   }

   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      var1.readByte();
      this._map = (TCharCharMap)var1.readObject();
   }
   ...
   public Object put(Object var1, Object var2) {
      return this.put((Character)var1, (Character)var2);
   }
