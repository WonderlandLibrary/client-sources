...
public class TIntByteMapDecorator extends AbstractMap implements Map, Externalizable, Cloneable {
   ...
   public TIntByteMapDecorator(TIntByteMap var1) {
      this._map = var1;
   }
   ...
   public Set entrySet() {
      return new AbstractSet(this) {
         final TIntByteMapDecorator this$0;
   ...
   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      var1.readByte();
      this._map = (TIntByteMap)var1.readObject();
   }
   ...
   public Object put(Object var1, Object var2) {
      return this.put((Integer)var1, (Byte)var2);
   }
