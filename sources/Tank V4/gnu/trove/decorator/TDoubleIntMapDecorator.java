...
public class TDoubleIntMapDecorator extends AbstractMap implements Map, Externalizable, Cloneable {
   ...
   public TDoubleIntMapDecorator(TDoubleIntMap var1) {
      this._map = var1;
   }
   ...
   public Integer put(Double var1, Integer var2) {
      ...
      int var6 = this._map.put(var3, var5);
   ...
   public Integer remove(Object var1) {
      ...
      int var4 = this._map.remove(var2);
      return var4 == this._map.getNoEntryValue() ? null : this.wrapValue(var4);
   }

   public Set entrySet() {
      return new AbstractSet(this) {
         final TDoubleIntMapDecorator this$0;
         ...
         public Iterator iterator() {
            return new Iterator(this) {
               ...
               public Entry next() {
                  ...
                  int var4 = this.it.value();
                  Integer var5 = var4 == this.this$1.this$0._map.getNoEntryValue() ? null : this.this$1.this$0.wrapValue(var4);
   ...
   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      var1.readByte();
      this._map = (TDoubleIntMap)var1.readObject();
   }
   ...
   public Object put(Object var1, Object var2) {
      return this.put((Double)var1, (Integer)var2);
   }
