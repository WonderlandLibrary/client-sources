...
public class TObjectFloatMapDecorator extends AbstractMap implements Map, Externalizable, Cloneable {
   static final long serialVersionUID = 1L;
   protected TObjectFloatMap _map;

   public TObjectFloatMapDecorator() {
   }

   public TObjectFloatMapDecorator(TObjectFloatMap var1) {
      this._map = var1;
   }

   public TObjectFloatMap getMap() {
      return this._map;
   }
   ...
   public Float remove(Object var1) {
      float var2 = this._map.remove(var1);
      return var2 == this._map.getNoEntryValue() ? null : this.wrapValue(var2);
   }

   public Set entrySet() {
      return new AbstractSet(this) {
         final TObjectFloatMapDecorator this$0;
         ...
         public Iterator iterator() {
            return new Iterator(this) {
               private final TObjectFloatIterator it;
               ...
               public Entry next() {
                  ...
                  Float var2 = this.this$1.this$0.wrapValue(this.it.value());
   ...
   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      var1.readByte();
      this._map = (TObjectFloatMap)var1.readObject();
   }
   ...
   public Object put(Object var1, Object var2) {
      return this.put(var1, (Float)var2);
   }
