...
public class TCharShortMapDecorator extends AbstractMap implements Map, Externalizable, Cloneable {
   ...
   public TCharShortMapDecorator(TCharShortMap var1) {
      this._map = var1;
   }
   ...
   public Short put(Character var1, Short var2) {
      ...
      short var5 = this._map.put(var3, var4);
   ...
   public Short remove(Object var1) {
      ...
      short var3 = this._map.remove(var2);
      return var3 == this._map.getNoEntryValue() ? null : this.wrapValue(var3);
   }

   public Set entrySet() {
      return new AbstractSet(this) {
         final TCharShortMapDecorator this$0;
         ...
         public Iterator iterator() {
            return new Iterator(this) {
               ...
               public Entry next() {
                  ...
                  short var3 = this.it.value();
                  Short var4 = var3 == this.this$1.this$0._map.getNoEntryValue() ? null : this.this$1.this$0.wrapValue(var3);
   ...
   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      var1.readByte();
      this._map = (TCharShortMap)var1.readObject();
   }
   ...
   public Object put(Object var1, Object var2) {
      return this.put((Character)var1, (Short)var2);
   }
