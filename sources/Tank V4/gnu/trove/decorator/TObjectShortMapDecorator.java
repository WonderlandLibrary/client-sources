...
public class TObjectShortMapDecorator extends AbstractMap implements Map, Externalizable, Cloneable {
   static final long serialVersionUID = 1L;
   protected TObjectShortMap _map;

   public TObjectShortMapDecorator() {
   }

   public TObjectShortMapDecorator(TObjectShortMap var1) {
      this._map = var1;
   }

   public TObjectShortMap getMap() {
      return this._map;
   }
   ...
   public Short remove(Object var1) {
      short var2 = this._map.remove(var1);
      return var2 == this._map.getNoEntryValue() ? null : this.wrapValue(var2);
   }

   public Set entrySet() {
      return new AbstractSet(this) {
         final TObjectShortMapDecorator this$0;
         ...
         public Iterator iterator() {
            return new Iterator(this) {
               ...
               public Entry next() {
                  ...
                  Short var2 = this.this$1.this$0.wrapValue(this.it.value());
   ...
   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      var1.readByte();
      this._map = (TObjectShortMap)var1.readObject();
   }
   ...
   public Object put(Object var1, Object var2) {
      return this.put(var1, (Short)var2);
   }
