...
public class TCharObjectMapDecorator extends AbstractMap implements Map, Externalizable, Cloneable {
   static final long serialVersionUID = 1L;
   protected TCharObjectMap _map;

   public TCharObjectMapDecorator() {
   }

   public TCharObjectMapDecorator(TCharObjectMap var1) {
      this._map = var1;
   }

   public TCharObjectMap getMap() {
      return this._map;
   }
   ...
   public Object get(Object var1) {
      ...
      if (var1 != null) {
         ...
         var2 = this.unwrapKey((Character)var1);
      } else {
   ...
   public Set entrySet() {
      return new AbstractSet(this) {
         final TCharObjectMapDecorator this$0;
         ...
         public Iterator iterator() {
            return new Iterator(this) {
               private final TCharObjectIterator it;
   ...
   public boolean containsKey(Object var1) {
      if (var1 == null) {
         ...
         return var1 instanceof Character && this._map.containsKey((Character)var1);
      }
   }
   ...
   protected char unwrapKey(Character var1) {
      return var1;
   }

   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      var1.readByte();
      this._map = (TCharObjectMap)var1.readObject();
   }
   ...
   public Object put(Object var1, Object var2) {
      return this.put((Character)var1, var2);
   }
}
