...
public class TByteObjectMapDecorator extends AbstractMap implements Map, Externalizable, Cloneable {
   static final long serialVersionUID = 1L;
   protected TByteObjectMap _map;

   public TByteObjectMapDecorator() {
   }

   public TByteObjectMapDecorator(TByteObjectMap var1) {
      this._map = var1;
   }

   public TByteObjectMap getMap() {
      return this._map;
   }
   ...
   public Set entrySet() {
      return new AbstractSet(this) {
         final TByteObjectMapDecorator this$0;
         ...
         public Iterator iterator() {
            return new Iterator(this) {
               private final TByteObjectIterator it;
   ...
   public boolean containsKey(Object var1) {
      if (var1 == null) {
         ...
         return var1 instanceof Byte && this._map.containsKey((Byte)var1);
      }
   }
   ...
   protected byte unwrapKey(Byte var1) {
      return var1;
   }

   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      var1.readByte();
      this._map = (TByteObjectMap)var1.readObject();
   }
   ...
   public Object put(Object var1, Object var2) {
      return this.put((Byte)var1, var2);
   }
}
