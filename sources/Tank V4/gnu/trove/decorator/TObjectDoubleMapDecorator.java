...
public class TObjectDoubleMapDecorator extends AbstractMap implements Map, Externalizable, Cloneable {
   ...
   public TObjectDoubleMapDecorator(TObjectDoubleMap var1) {
      this._map = var1;
   }
   ...
   public Double get(Object var1) {
      double var2 = this._map.get(var1);
   ...
   public Double remove(Object var1) {
      double var2 = this._map.remove(var1);
      return var2 == this._map.getNoEntryValue() ? null : this.wrapValue(var2);
   }

   public Set entrySet() {
      return new AbstractSet(this) {
         final TObjectDoubleMapDecorator this$0;
         ...
         public Iterator iterator() {
            return new Iterator(this) {
               ...
               public Entry next() {
                  ...
                  Double var2 = this.this$1.this$0.wrapValue(this.it.value());
   ...
   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      var1.readByte();
      this._map = (TObjectDoubleMap)var1.readObject();
   }
   ...
   public Object put(Object var1, Object var2) {
      return this.put(var1, (Double)var2);
   }
