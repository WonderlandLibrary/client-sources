...
public class TDoubleLongMapDecorator extends AbstractMap implements Map, Externalizable, Cloneable {
   ...
   public TDoubleLongMapDecorator(TDoubleLongMap var1) {
      this._map = var1;
   }
   ...
   public Long put(Double var1, Long var2) {
      ...
      long var7 = this._map.put(var3, var5);
   ...
   public Long remove(Object var1) {
      ...
      long var4 = this._map.remove(var2);
      return var4 == this._map.getNoEntryValue() ? null : this.wrapValue(var4);
   }

   public Set entrySet() {
      return new AbstractSet(this) {
         final TDoubleLongMapDecorator this$0;
         ...
         public Iterator iterator() {
            return new Iterator(this) {
               ...
               public Entry next() {
                  ...
                  long var4 = this.it.value();
                  Long var6 = var4 == this.this$1.this$0._map.getNoEntryValue() ? null : this.this$1.this$0.wrapValue(var4);
   ...
   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      var1.readByte();
      this._map = (TDoubleLongMap)var1.readObject();
   }
   ...
   public Object put(Object var1, Object var2) {
      return this.put((Double)var1, (Long)var2);
   }
