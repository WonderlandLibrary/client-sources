...
public class TObjectCharMapDecorator extends AbstractMap implements Map, Externalizable, Cloneable {
   static final long serialVersionUID = 1L;
   protected TObjectCharMap _map;

   public TObjectCharMapDecorator() {
   }

   public TObjectCharMapDecorator(TObjectCharMap var1) {
      this._map = var1;
   }

   public TObjectCharMap getMap() {
      return this._map;
   }

   public Character put(Object var1, Character var2) {
   ...
   public Character remove(Object var1) {
      char var2 = this._map.remove(var1);
      return var2 == this._map.getNoEntryValue() ? null : this.wrapValue(var2);
   }

   public Set entrySet() {
      return new AbstractSet(this) {
         final TObjectCharMapDecorator this$0;
         ...
         public Iterator iterator() {
            return new Iterator(this) {
               private final TObjectCharIterator it;
               ...
               public Entry next() {
                  ...
                  Character var2 = this.this$1.this$0.wrapValue(this.it.value());
   ...
   public void readExternal(ObjectInput var1) throws IOException, ClassNotFoundException {
      var1.readByte();
      this._map = (TObjectCharMap)var1.readObject();
   }
   ...
   public Object put(Object var1, Object var2) {
      return this.put(var1, (Character)var2);
   }
