      ...
      if (this.theAchievement != null && this.notificationTime != 0L) {
         ...
         if (Minecraft.thePlayer != null) {
            ...
            if (this.permanentNotification) {
               ...
               Minecraft.fontRendererObj.drawString(this.achievementTitle, (double)(var5 + 30), (double)(var6 + 7), -256);
               Minecraft.fontRendererObj.drawString(this.achievementDescription, (double)(var5 + 30), (double)(var6 + 18), -1);
            }
