...
/* 1842 */     short[] value = this.value;
/* 1843 */     int mask = newN - 1;
/* 1844 */     double[] newKey = new double[newN + 1];
/* 1845 */     short[] newValue = new short[newN + 1];
...
/*      */     try {
/* 1899 */       c = (Double2ShortLinkedOpenHashMap)super.clone();
...
/* 1908 */     c.value = (short[])this.value.clone();
...
/* 1955 */     short[] value = this.value = new short[this.n + 1];
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\doubles\Double2ShortLinkedOpenHashMap.class
