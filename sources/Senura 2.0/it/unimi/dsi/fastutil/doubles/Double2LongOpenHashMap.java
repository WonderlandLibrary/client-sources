...
/* 1144 */     long[] value = this.value;
/* 1145 */     int mask = newN - 1;
/* 1146 */     double[] newKey = new double[newN + 1];
/* 1147 */     long[] newValue = new long[newN + 1];
/* 1148 */     int i = this.n;
...
/*      */     try {
/* 1180 */       c = (Double2LongOpenHashMap)super.clone();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\doubles\Double2LongOpenHashMap.class
