...
/*  205 */       return DoubleIterators.EMPTY_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleListIterator iterator() {
/*  210 */       return DoubleIterators.EMPTY_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public DoubleListIterator listIterator(int i) {
/*  215 */       if (i == 0)
/*  216 */         return DoubleIterators.EMPTY_ITERATOR; 
...
/*      */     
/*      */     public Object clone() {
/*  267 */       return DoubleLists.EMPTY_LIST;
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  271 */       return 1;
...
/*  283 */       return DoubleLists.EMPTY_LIST;
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  320 */       return (Double.doubleToLongBits(k) == Double.doubleToLongBits(this.element));
/*      */     }
/*      */ 
/*      */     
/*      */     public double[] toDoubleArray() {
/*  325 */       double[] a = new double[1];
/*  326 */       a[0] = this.element;
/*  327 */       return a;
/*      */     }
/*      */     
/*      */     public DoubleListIterator listIterator() {
/*  331 */       return DoubleIterators.singleton(this.element);
/*      */     }
/*      */     
/*      */     public DoubleListIterator iterator() {
...
/*  341 */       DoubleListIterator l = listIterator();
/*  342 */       if (i == 1)
/*  343 */         l.nextDouble(); 
/*  344 */       return l;
/*      */     }
...
/*      */       }
/*  354 */       if (from != 0 || to != 1)
/*  355 */         return DoubleLists.EMPTY_LIST; 
/*  356 */       return this;
/*      */     }
/*      */     
/*      */     public boolean addAll(int i, Collection<? extends Double> c) {
...
/*  475 */     return new Singleton(((Double)element).doubleValue());
/*      */   }
/*      */   
...
/*  496 */         return this.list.getDouble(i);
/*      */       } 
/*      */     }
/*      */     
...
/*  514 */         return this.list.removeDouble(i);
/*      */       } 
/*      */     }
/*      */     
/*      */     public int indexOf(double k) {
...
/*      */     
/*      */     public double getDouble(int i) {
/*  802 */       return this.list.getDouble(i);
/*      */     }
/*      */     
/*      */     public double set(int i, double k) {
...
/*      */     
/*      */     public DoubleListIterator listIterator() {
/*  862 */       return DoubleIterators.unmodifiable(this.list.listIterator());
/*      */     }
/*      */     
/*      */     public DoubleListIterator iterator() {
...
/*      */     
/*      */     public DoubleListIterator listIterator(int i) {
/*  870 */       return DoubleIterators.unmodifiable(this.list.listIterator(i));
/*      */     }
/*      */     
/*      */     public DoubleList subList(int from, int to) {
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\doubles\DoubleLists.class
