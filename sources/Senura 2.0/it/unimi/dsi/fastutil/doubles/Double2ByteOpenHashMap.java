...
/* 1143 */     byte[] value = this.value;
/* 1144 */     int mask = newN - 1;
/* 1145 */     double[] newKey = new double[newN + 1];
/* 1146 */     byte[] newValue = new byte[newN + 1];
/* 1147 */     int i = this.n;
...
/*      */     try {
/* 1179 */       c = (Double2ByteOpenHashMap)super.clone();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\doubles\Double2ByteOpenHashMap.class
