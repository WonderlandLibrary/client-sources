...
/* 222 */     if (capacity <= this.a.length || (this.a == DoubleArrays.DEFAULT_EMPTY_ARRAY && capacity <= 10))
/*     */       return; 
...
/* 327 */       this.a = DoubleArrays.forceCapacity(this.a, size, this.size); 
...
/* 439 */     DoubleArrays.ensureOffsetLength(a, offset, length);
...
/* 461 */     DoubleIterator i = c.iterator();
/* 462 */     this.size += n;
/* 463 */     while (n-- != 0)
/* 464 */       this.a[index++] = i.nextDouble(); 
...
/* 498 */       if (!c.contains(Double.valueOf(a[i])))
/* 499 */         a[j++] = a[i]; 
...
/* 507 */     return new DoubleListIterator() {
/* 508 */         int pos = index; int last = -1;
/*     */         
/*     */         public boolean hasNext() {
/* 511 */           return (this.pos < DoubleArrayList.this.size);
/*     */         }
/*     */         
...
/* 521 */           return DoubleArrayList.this.a[this.last = this.pos++];
/*     */         }
/*     */         
/*     */         public double previousDouble() {
/* 525 */           if (!hasPrevious())
/* 526 */             throw new NoSuchElementException(); 
/* 527 */           return DoubleArrayList.this.a[this.last = --this.pos];
/*     */         }
/*     */         
...
/* 539 */           DoubleArrayList.this.add(this.pos++, k);
/* 540 */           this.last = -1;
/*     */         }
/*     */         
...
/* 546 */           DoubleArrayList.this.set(this.last, k);
/*     */         }
/*     */         
/*     */         public void remove() {
/* 550 */           if (this.last == -1)
/* 551 */             throw new IllegalStateException(); 
/* 552 */           DoubleArrayList.this.removeDouble(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* 565 */     if (comp == null) {
/* 566 */       DoubleArrays.stableSort(this.a, 0, this.size);
/*     */     } else {
/* 568 */       DoubleArrays.stableSort(this.a, 0, this.size, comp);
/*     */     } 
/*     */   }
/*     */   
/*     */   public void unstableSort(DoubleComparator comp) {
/* 573 */     if (comp == null) {
/* 574 */       DoubleArrays.unstableSort(this.a, 0, this.size);
/*     */     } else {
/* 576 */       DoubleArrays.unstableSort(this.a, 0, this.size, comp);
/*     */     } 
/*     */   }
/*     */   
/*     */   public DoubleArrayList clone() {
/* 581 */     DoubleArrayList c = new DoubleArrayList(this.size);
...
/* 626 */     double[] a1 = this.a, a2 = l.a;
/*     */     
/*     */     int i;
/* 629 */     for (i = 0; i < s1 && i < s2; i++) {
/* 630 */       double e1 = a1[i];
/* 631 */       double e2 = a2[i]; int r;
/* 632 */       if ((r = Double.compare(e1, e2)) != 0)
/* 633 */         return r; 
/*     */     } 
...
/* 640 */       s.writeDouble(this.a[i]); 
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 644 */     s.defaultReadObject();
/* 645 */     this.a = new double[this.size];
/* 646 */     for (int i = 0; i < this.size; i++)
/* 647 */       this.a[i] = s.readDouble(); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\doubles\DoubleArrayList.class
