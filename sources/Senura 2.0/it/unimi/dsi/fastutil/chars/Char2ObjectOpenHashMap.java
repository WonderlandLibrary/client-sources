...
/* 1048 */     char[] key = this.key;
/* 1049 */     V[] value = this.value;
/* 1050 */     int mask = newN - 1;
/* 1051 */     char[] newKey = new char[newN + 1];
/* 1052 */     V[] newValue = (V[])new Object[newN + 1];
/* 1053 */     int i = this.n;
/* 1054 */     for (int j = realSize(); j-- != 0; ) {
/* 1055 */       while (key[--i] == '\000'); int pos;
/* 1056 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != '\000')
/* 1057 */         while (newKey[pos = pos + 1 & mask] != '\000'); 
...
/*      */     try {
/* 1083 */       c = (Char2ObjectOpenHashMap<V>)super.clone();
...
/* 1091 */     c.key = (char[])this.key.clone();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\chars\Char2ObjectOpenHashMap.class
