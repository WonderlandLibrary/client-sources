...
/* 1076 */     char[] key = this.key;
/* 1077 */     char[] value = this.value;
/* 1078 */     int mask = newN - 1;
/* 1079 */     char[] newKey = new char[newN + 1];
/* 1080 */     char[] newValue = new char[newN + 1];
/* 1081 */     int i = this.n;
/* 1082 */     for (int j = realSize(); j-- != 0; ) {
/* 1083 */       while (key[--i] == '\000'); int pos;
/* 1084 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != '\000')
/* 1085 */         while (newKey[pos = pos + 1 & mask] != '\000'); 
...
/*      */     try {
/* 1111 */       c = (Char2CharOpenHashMap)super.clone();
...
/* 1119 */     c.key = (char[])this.key.clone();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\chars\Char2CharOpenHashMap.class
