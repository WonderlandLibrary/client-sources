...
/* 1172 */     double[] value = this.value;
/* 1173 */     int mask = newN - 1;
/* 1174 */     char[] newKey = new char[newN + 1];
/* 1175 */     double[] newValue = new double[newN + 1];
/* 1176 */     int i = this.n;
...
/*      */     try {
/* 1207 */       c = (Char2DoubleOpenCustomHashMap)super.clone();
...
/* 1216 */     c.value = (double[])this.value.clone();
...
/* 1236 */       t ^= HashCommon.double2int(this.value[i]);
/* 1237 */       h += t;
/* 1238 */       i++;
/*      */     } 
/*      */     
/* 1241 */     if (this.containsNullKey)
/* 1242 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1243 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1246 */     char[] key = this.key;
/* 1247 */     double[] value = this.value;
...
/* 1263 */     double[] value = this.value = new double[this.n + 1];
/*      */ 
/*      */     
/* 1266 */     for (int i = this.size; i-- != 0; ) {
/* 1267 */       int pos; char k = s.readChar();
/* 1268 */       double v = s.readDouble();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\chars\Char2DoubleOpenCustomHashMap.class
