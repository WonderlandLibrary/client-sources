...
/*     */     
/*     */     public Object clone() {
/*  79 */       return CharIterators.EMPTY_ITERATOR;
/*     */     }
/*     */     private Object readResolve() {
/*  82 */       return CharIterators.EMPTY_ITERATOR;
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 219 */     CharArrays.ensureOffsetLength(array, offset, length);
...
/* 304 */     char[] array = new char[16];
/* 305 */     int j = 0;
/* 306 */     while (max-- != 0 && i.hasNext()) {
/* 307 */       if (j == array.length)
/* 308 */         array = CharArrays.grow(array, j + 1); 
/* 309 */       array[j++] = i.nextChar();
/*     */     } 
/* 311 */     return CharArrays.trim(array, j);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 539 */     CharArrayList l = new CharArrayList();
/* 540 */     pour(i, l, max);
/* 541 */     l.trim();
/* 542 */     return l;
/*     */   }
...
/*     */     
/*     */     public char nextChar() {
/* 575 */       return ((Character)this.i.next()).charValue();
/*     */     } }
/*     */ 
/*     */ 
/*     */ 
...
/* 598 */     if (i instanceof CharIterator)
/* 599 */       return (CharIterator)i; 
...
/* 625 */       this.i.set(Character.valueOf(k));
/*     */     }
/*     */     
/*     */     public void add(char k) {
/* 629 */       this.i.add(Character.valueOf(k));
/*     */     }
/*     */     
/*     */     public void remove() {
/* 633 */       this.i.remove();
...
/*     */     
/*     */     public char nextChar() {
/* 637 */       return ((Character)this.i.next()).charValue();
/*     */     }
/*     */     
/*     */     public char previousChar() {
/* 641 */       return ((Character)this.i.previous()).charValue();
/*     */     } }
/*     */ 
/*     */ 
/*     */ 
...
/* 664 */     if (i instanceof CharListIterator)
/* 665 */       return (CharListIterator)i; 
...
/* 675 */         return true; 
/* 676 */       if (!predicate.test(iterator.nextChar()))
/* 677 */         return false; 
/*     */     } 
...
/* 682 */       if (predicate.test(iterator.nextChar()))
/* 683 */         return i; 
/*     */     } 
/* 685 */     return -1;
/*     */   }
...
/* 706 */       this.curr = (char)(this.curr + 1); return this.curr;
/*     */     }
/*     */     
/*     */     public char previousChar() {
/* 710 */       if (!hasPrevious())
/* 711 */         throw new NoSuchElementException(); 
/* 712 */       return this.curr = (char)(this.curr - 1);
/*     */     }
/*     */     
/*     */     public int nextIndex() {
...
/* 725 */         this.curr = (char)(this.curr + n);
/* 726 */         return n;
/*     */       } 
...
/* 735 */         this.curr = (char)(this.curr - n);
/* 736 */         return n;
/*     */       } 
...
/* 786 */       char next = this.a[this.lastOffset = this.offset].nextChar();
/* 787 */       advance();
/* 788 */       return next;
/*     */     }
/*     */     
...
/*     */     
/*     */     public char nextChar() {
/* 885 */       return this.i.nextChar();
/*     */     }
/*     */     
/*     */     public char previousChar() {
/* 889 */       return this.i.previousChar();
/*     */     } }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*     */     public char nextChar() {
/* 920 */       return this.i.nextChar();
/*     */     }
/*     */     
/*     */     public char previousChar() {
/* 924 */       return this.i.previousChar();
/*     */     }
/*     */     
/*     */     public int nextIndex() {
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\chars\CharIterators.class
