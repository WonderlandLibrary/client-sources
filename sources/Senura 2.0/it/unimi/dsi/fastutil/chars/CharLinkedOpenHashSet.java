...
/* 1067 */     char[] key = this.key;
/* 1068 */     int mask = newN - 1;
/* 1069 */     char[] newKey = new char[newN + 1];
...
/* 1075 */       int pos; if (key[i] == '\000') {
/* 1076 */         pos = newN;
/*      */       } else {
/* 1078 */         pos = HashCommon.mix(key[i]) & mask;
/* 1079 */         while (newKey[pos] != '\000')
/* 1080 */           pos = pos + 1 & mask; 
/*      */       } 
...
/* 1152 */     CharIterator i = iterator();
/* 1153 */     s.defaultWriteObject();
/* 1154 */     for (int j = this.size; j-- != 0;)
/* 1155 */       s.writeChar(i.nextChar()); 
/*      */   }
/*      */   
...
/* 1163 */     char[] key = this.key = new char[this.n + 1];
/* 1164 */     long[] link = this.link = new long[this.n + 1];
/* 1165 */     int prev = -1;
/* 1166 */     this.first = this.last = -1;
/*      */     
/* 1168 */     for (int i = this.size; i-- != 0; ) {
/* 1169 */       int pos; char k = s.readChar();
/* 1170 */       if (k == '\000') {
/* 1171 */         pos = this.n;
/* 1172 */         this.containsNull = true;
/*      */       }
/* 1174 */       else if (key[pos = HashCommon.mix(k) & this.mask] != '\000') {
/* 1175 */         while (key[pos = pos + 1 & this.mask] != '\000');
/*      */       } 
/* 1177 */       key[pos] = k;
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\chars\CharLinkedOpenHashSet.class
