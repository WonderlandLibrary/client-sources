...
/* 1122 */     char[] key = this.key;
/* 1123 */     boolean[] value = this.value;
/* 1124 */     int mask = newN - 1;
/* 1125 */     char[] newKey = new char[newN + 1];
/* 1126 */     boolean[] newValue = new boolean[newN + 1];
/* 1127 */     int i = this.n;
/* 1128 */     for (int j = realSize(); j-- != 0; ) {
/* 1129 */       while (key[--i] == '\000'); int pos;
/* 1130 */       if (newKey[pos = HashCommon.mix(this.strategy.hashCode(key[i])) & mask] != '\000')
/*      */       {
...
/*      */     try {
/* 1158 */       c = (Char2BooleanOpenCustomHashMap)super.clone();
...
/* 1220 */       if (this.strategy.equals(k, false)) {
/* 1221 */         pos = this.n;
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\chars\Char2BooleanOpenCustomHashMap.class
