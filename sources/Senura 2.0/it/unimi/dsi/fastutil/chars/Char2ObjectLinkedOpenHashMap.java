...
/* 1728 */     char[] key = this.key;
/* 1729 */     V[] value = this.value;
/* 1730 */     int mask = newN - 1;
/* 1731 */     char[] newKey = new char[newN + 1];
...
/* 1738 */       int pos; if (key[i] == '\000') {
/* 1739 */         pos = newN;
/*      */       } else {
/* 1741 */         pos = HashCommon.mix(key[i]) & mask;
/* 1742 */         while (newKey[pos] != '\000')
/* 1743 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1786 */       c = (Char2ObjectLinkedOpenHashMap<V>)super.clone();
...
/* 1794 */     c.key = (char[])this.key.clone();
...
/* 1842 */     char[] key = this.key = new char[this.n + 1];
...
/* 1850 */       int pos; char k = s.readChar();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\chars\Char2ObjectLinkedOpenHashMap.class
