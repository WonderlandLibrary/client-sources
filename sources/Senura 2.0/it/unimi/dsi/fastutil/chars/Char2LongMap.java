...
/* 153 */     return (ObjectSet)char2LongEntrySet();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 492 */       return drv; 
/* 493 */     Long newValue = remappingFunction.apply(Character.valueOf(key), Long.valueOf(oldValue));
...
/* 528 */     Long newValue = remappingFunction.apply(Character.valueOf(key), 
/* 529 */         contained ? Long.valueOf(oldValue) : null);
/* 530 */     if (newValue == null) {
/* 531 */       if (contained)
/* 532 */         remove(key); 
/* 533 */       return drv;
/*     */     } 
/* 535 */     long newVal = newValue.longValue();
/* 536 */     put(key, newVal);
/* 537 */     return newVal;
/*     */   }
/*     */ 
...
/* 564 */     long oldValue = get(key), drv = defaultReturnValue();
/*     */     
/* 566 */     if (oldValue != drv || containsKey(key)) {
/* 567 */       Long mergedValue = remappingFunction.apply(Long.valueOf(oldValue), Long.valueOf(value));
/* 568 */       if (mergedValue == null) {
/* 569 */         remove(key);
/* 570 */         return drv;
/*     */       } 
/* 572 */       newValue = mergedValue.longValue();
/*     */     } else {
/* 574 */       newValue = value;
/*     */     } 
...
/* 744 */       return Long.valueOf(getLongValue());
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 754 */       return Long.valueOf(setValue(value.longValue()));
/*     */     }
/*     */     
/*     */     char getCharKey();
/*     */     
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\chars\Char2LongMap.class
