...
/* 1125 */     int[] key = this.key;
/* 1126 */     float[] value = this.value;
/* 1127 */     int mask = newN - 1;
/* 1128 */     int[] newKey = new int[newN + 1];
/* 1129 */     float[] newValue = new float[newN + 1];
/* 1130 */     int i = this.n;
...
/*      */     try {
/* 1160 */       c = (Int2FloatOpenHashMap)super.clone();
...
/* 1168 */     c.key = (int[])this.key.clone();
/* 1169 */     c.value = (float[])this.value.clone();
/* 1170 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1186 */         i++; 
/* 1187 */       t = this.key[i];
/* 1188 */       t ^= HashCommon.float2int(this.value[i]);
/* 1189 */       h += t;
/* 1190 */       i++;
/*      */     } 
/*      */     
/* 1193 */     if (this.containsNullKey)
/* 1194 */       h += HashCommon.float2int(this.value[this.n]); 
/* 1195 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1198 */     int[] key = this.key;
/* 1199 */     float[] value = this.value;
/* 1200 */     MapIterator i = new MapIterator();
/* 1201 */     s.defaultWriteObject();
/* 1202 */     for (int j = this.size; j-- != 0; ) {
/* 1203 */       int e = i.nextEntry();
/* 1204 */       s.writeInt(key[e]);
/* 1205 */       s.writeFloat(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1214 */     int[] key = this.key = new int[this.n + 1];
/* 1215 */     float[] value = this.value = new float[this.n + 1];
/*      */ 
/*      */     
/* 1218 */     for (int i = this.size; i-- != 0; ) {
/* 1219 */       int pos, k = s.readInt();
/* 1220 */       float v = s.readFloat();
/* 1221 */       if (k == 0) {
/* 1222 */         pos = this.n;
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\ints\Int2FloatOpenHashMap.class
