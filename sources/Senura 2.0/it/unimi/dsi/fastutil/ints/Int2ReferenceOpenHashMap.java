...
/* 1047 */     int[] key = this.key;
/* 1048 */     V[] value = this.value;
/* 1049 */     int mask = newN - 1;
/* 1050 */     int[] newKey = new int[newN + 1];
...
/*      */     try {
/* 1082 */       c = (Int2ReferenceOpenHashMap<V>)super.clone();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\ints\Int2ReferenceOpenHashMap.class
