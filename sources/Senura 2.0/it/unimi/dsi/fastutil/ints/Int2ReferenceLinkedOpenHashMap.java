...
/* 1727 */     int[] key = this.key;
/* 1728 */     V[] value = this.value;
/* 1729 */     int mask = newN - 1;
/* 1730 */     int[] newKey = new int[newN + 1];
...
/*      */     try {
/* 1785 */       c = (Int2ReferenceLinkedOpenHashMap<V>)super.clone();
...
/* 1841 */     int[] key = this.key = new int[this.n + 1];
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\ints\Int2ReferenceLinkedOpenHashMap.class
