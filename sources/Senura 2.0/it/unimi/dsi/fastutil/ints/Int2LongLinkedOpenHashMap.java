...
/* 1812 */     long[] value = this.value;
/* 1813 */     int mask = newN - 1;
/* 1814 */     int[] newKey = new int[newN + 1];
/* 1815 */     long[] newValue = new long[newN + 1];
...
/*      */     try {
/* 1869 */       c = (Int2LongLinkedOpenHashMap)super.clone();
...
/* 1878 */     c.value = (long[])this.value.clone();
...
/* 1896 */         i++; 
/* 1897 */       t = this.key[i];
/* 1898 */       t ^= HashCommon.long2int(this.value[i]);
/* 1899 */       h += t;
/* 1900 */       i++;
/*      */     } 
/*      */     
/* 1903 */     if (this.containsNullKey)
/* 1904 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1905 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1908 */     int[] key = this.key;
/* 1909 */     long[] value = this.value;
...
/* 1925 */     long[] value = this.value = new long[this.n + 1];
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\ints\Int2LongLinkedOpenHashMap.class
