...
/* 1126 */     int[] key = this.key;
/* 1127 */     double[] value = this.value;
/* 1128 */     int mask = newN - 1;
/* 1129 */     int[] newKey = new int[newN + 1];
/* 1130 */     double[] newValue = new double[newN + 1];
/* 1131 */     int i = this.n;
/* 1132 */     for (int j = realSize(); j-- != 0; ) {
/* 1133 */       while (key[--i] == 0); int pos;
/* 1134 */       if (newKey[pos = HashCommon.mix(key[i]) & mask] != 0)
...
/*      */     try {
/* 1161 */       c = (Int2DoubleOpenHashMap)super.clone();
...
/* 1169 */     c.key = (int[])this.key.clone();
/* 1170 */     c.value = (double[])this.value.clone();
/* 1171 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1187 */         i++; 
/* 1188 */       t = this.key[i];
/* 1189 */       t ^= HashCommon.double2int(this.value[i]);
/* 1190 */       h += t;
/* 1191 */       i++;
/*      */     } 
/*      */     
/* 1194 */     if (this.containsNullKey)
/* 1195 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1196 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1199 */     int[] key = this.key;
/* 1200 */     double[] value = this.value;
/* 1201 */     MapIterator i = new MapIterator();
/* 1202 */     s.defaultWriteObject();
/* 1203 */     for (int j = this.size; j-- != 0; ) {
/* 1204 */       int e = i.nextEntry();
/* 1205 */       s.writeInt(key[e]);
/* 1206 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1215 */     int[] key = this.key = new int[this.n + 1];
/* 1216 */     double[] value = this.value = new double[this.n + 1];
/*      */ 
/*      */     
/* 1219 */     for (int i = this.size; i-- != 0; ) {
/* 1220 */       int pos, k = s.readInt();
/* 1221 */       double v = s.readDouble();
/* 1222 */       if (k == 0) {
/* 1223 */         pos = this.n;
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\ints\Int2DoubleOpenHashMap.class
