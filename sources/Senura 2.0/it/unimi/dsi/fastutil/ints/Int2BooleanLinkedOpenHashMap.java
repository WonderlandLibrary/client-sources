...
/* 1759 */     int[] key = this.key;
/* 1760 */     boolean[] value = this.value;
/* 1761 */     int mask = newN - 1;
/* 1762 */     int[] newKey = new int[newN + 1];
...
/*      */     try {
/* 1817 */       c = (Int2BooleanLinkedOpenHashMap)super.clone();
...
/* 1872 */     int[] key = this.key = new int[this.n + 1];
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\ints\Int2BooleanLinkedOpenHashMap.class
