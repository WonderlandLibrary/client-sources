...
/* 1815 */     int[] key = this.key;
/* 1816 */     double[] value = this.value;
/* 1817 */     int mask = newN - 1;
/* 1818 */     int[] newKey = new int[newN + 1];
/* 1819 */     double[] newValue = new double[newN + 1];
...
/* 1825 */       int pos; if (key[i] == 0) {
/* 1826 */         pos = newN;
/*      */       } else {
/* 1828 */         pos = HashCommon.mix(key[i]) & mask;
/* 1829 */         while (newKey[pos] != 0)
/* 1830 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1873 */       c = (Int2DoubleLinkedOpenHashMap)super.clone();
...
/* 1881 */     c.key = (int[])this.key.clone();
/* 1882 */     c.value = (double[])this.value.clone();
...
/* 1899 */       while (this.key[i] == 0)
/* 1900 */         i++; 
/* 1901 */       t = this.key[i];
/* 1902 */       t ^= HashCommon.double2int(this.value[i]);
/* 1903 */       h += t;
/* 1904 */       i++;
/*      */     } 
/*      */     
/* 1907 */     if (this.containsNullKey)
/* 1908 */       h += HashCommon.double2int(this.value[this.n]); 
/* 1909 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1912 */     int[] key = this.key;
/* 1913 */     double[] value = this.value;
/* 1914 */     MapIterator i = new MapIterator();
/* 1915 */     s.defaultWriteObject();
/* 1916 */     for (int j = this.size; j-- != 0; ) {
/* 1917 */       int e = i.nextEntry();
/* 1918 */       s.writeInt(key[e]);
/* 1919 */       s.writeDouble(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1928 */     int[] key = this.key = new int[this.n + 1];
/* 1929 */     double[] value = this.value = new double[this.n + 1];
...
/* 1936 */       int pos, k = s.readInt();
/* 1937 */       double v = s.readDouble();
/* 1938 */       if (k == 0) {
/* 1939 */         pos = this.n;
/* 1940 */         this.containsNullKey = true;
/*      */       } else {
/* 1942 */         pos = HashCommon.mix(k) & this.mask;
/* 1943 */         while (key[pos] != 0)
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\ints\Int2DoubleLinkedOpenHashMap.class
