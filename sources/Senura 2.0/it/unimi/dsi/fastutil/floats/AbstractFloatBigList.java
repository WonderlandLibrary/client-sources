...
/* 160 */     return new FloatBigListIterator() {
/* 161 */         long pos = index; long last = -1L;
/*     */         
/*     */         public boolean hasNext() {
/* 164 */           return (this.pos < AbstractFloatBigList.this.size64());
/*     */         }
/*     */         
...
/* 174 */           return AbstractFloatBigList.this.getFloat(this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public float previousFloat() {
/* 178 */           if (!hasPrevious())
/* 179 */             throw new NoSuchElementException(); 
/* 180 */           return AbstractFloatBigList.this.getFloat(this.last = --this.pos);
/*     */         }
/*     */         
...
/* 192 */           AbstractFloatBigList.this.add(this.pos++, k);
/* 193 */           this.last = -1L;
/*     */         }
/*     */         
...
/* 199 */           AbstractFloatBigList.this.set(this.last, k);
/*     */         }
/*     */         
/*     */         public void remove() {
/* 203 */           if (this.last == -1L)
/* 204 */             throw new IllegalStateException(); 
/* 205 */           AbstractFloatBigList.this.removeFloat(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* 229 */     FloatBigListIterator i = listIterator();
/*     */     
/* 231 */     while (i.hasNext()) {
/* 232 */       float e = i.nextFloat();
/* 233 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(e))
...
/* 240 */     FloatBigListIterator i = listIterator(size64());
/*     */     
/* 242 */     while (i.hasPrevious()) {
/* 243 */       float e = i.previousFloat();
/* 244 */       if (Float.floatToIntBits(k) == Float.floatToIntBits(e))
...
/* 265 */     return new FloatSubList(this, from, to);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 276 */     ensureIndex(to);
/* 277 */     FloatBigListIterator i = listIterator(from);
/* 278 */     long n = to - from;
/* 279 */     if (n < 0L)
...
/*     */   
/*     */   public int hashCode() {
/* 361 */     FloatIterator i = iterator();
/* 362 */     int h = 1;
/* 363 */     long s = size64();
/* 364 */     while (s-- != 0L) {
/* 365 */       float k = i.nextFloat();
/* 366 */       h = 31 * h + HashCommon.float2int(k);
/*     */     } 
/* 368 */     return h;
/*     */   }
/*     */   
...
/* 378 */     if (s != l.size64())
/* 379 */       return false; 
/* 380 */     if (l instanceof FloatBigList) {
/* 381 */       FloatBigListIterator floatBigListIterator1 = listIterator(), floatBigListIterator2 = ((FloatBigList)l).listIterator();
/* 382 */       while (s-- != 0L) {
/* 383 */         if (floatBigListIterator1.nextFloat() != floatBigListIterator2.nextFloat())
/* 384 */           return false; 
/* 385 */       }  return true;
/*     */     } 
...
/* 409 */     if (l == this)
/* 410 */       return 0; 
/* 411 */     if (l instanceof FloatBigList) {
/* 412 */       FloatBigListIterator floatBigListIterator1 = listIterator(), floatBigListIterator2 = ((FloatBigList)l).listIterator();
/*     */ 
/*     */       
/* 415 */       while (floatBigListIterator1.hasNext() && floatBigListIterator2.hasNext()) {
/* 416 */         float e1 = floatBigListIterator1.nextFloat();
/* 417 */         float e2 = floatBigListIterator2.nextFloat(); int r;
/* 418 */         if ((r = Float.compare(e1, e2)) != 0)
/* 419 */           return r; 
/*     */       } 
/* 421 */       return floatBigListIterator2.hasNext() ? -1 : (floatBigListIterator1.hasNext() ? 1 : 0);
/*     */     } 
/* 423 */     BigListIterator<? extends Float> i1 = listIterator(), i2 = l.listIterator();
/*     */     
...
/* 439 */     return removeFloat(size64() - 1L);
/*     */   }
/*     */   
/*     */   public float topFloat() {
/* 443 */     if (isEmpty())
/* 444 */       throw new NoSuchElementException(); 
/* 445 */     return getFloat(size64() - 1L);
/*     */   }
/*     */   
/*     */   public float peekFloat(int i) {
/* 449 */     return getFloat(size64() - 1L - i);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 535 */     return Float.valueOf(set(index, ok.floatValue()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 548 */     return Float.valueOf(getFloat(index));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 561 */     return indexOf(((Float)ok).floatValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 574 */     return lastIndexOf(((Float)ok).floatValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 587 */     return Float.valueOf(removeFloat(index));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   @Deprecated
/*     */   public Float pop() {
/* 613 */     return Float.valueOf(popFloat());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   @Deprecated
/*     */   public Float top() {
/* 626 */     return Float.valueOf(topFloat());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 639 */     return Float.valueOf(peekFloat(i));
/*     */   }
/*     */   
/*     */   public String toString() {
/* 643 */     StringBuilder s = new StringBuilder();
/* 644 */     FloatIterator i = iterator();
/* 645 */     long n = size64();
/*     */     
...
/* 703 */       return this.l.getFloat(this.from + index);
/*     */     }
/*     */     
/*     */     public float removeFloat(long index) {
/* 707 */       ensureRestrictedIndex(index);
/* 708 */       this.to--;
/* 709 */       return this.l.removeFloat(this.from + index);
/*     */     }
/*     */     
/*     */     public float set(long index, float k) {
...
/* 746 */       return new FloatBigListIterator() {
/* 747 */           long pos = index; long last = -1L;
/*     */           
/*     */           public boolean hasNext() {
/* 750 */             return (this.pos < AbstractFloatBigList.FloatSubList.this.size64());
/*     */           }
/*     */           
/*     */           public boolean hasPrevious() {
...
/* 760 */             return AbstractFloatBigList.FloatSubList.this.l.getFloat(AbstractFloatBigList.FloatSubList.this.from + (this.last = this.pos++));
/*     */           }
/*     */           
/*     */           public float previousFloat() {
/* 764 */             if (!hasPrevious())
/* 765 */               throw new NoSuchElementException(); 
/* 766 */             return AbstractFloatBigList.FloatSubList.this.l.getFloat(AbstractFloatBigList.FloatSubList.this.from + (this.last = --this.pos));
/*     */           }
/*     */           
/*     */           public long nextIndex() {
/* 770 */             return this.pos;
...
/* 780 */             AbstractFloatBigList.FloatSubList.this.add(this.pos++, k);
/* 781 */             this.last = -1L;
/* 782 */             if (!$assertionsDisabled && !AbstractFloatBigList.FloatSubList.this.assertRange()) throw new AssertionError(); 
/*     */           }
/*     */           
/*     */           public void set(float k) {
/* 786 */             if (this.last == -1L)
/* 787 */               throw new IllegalStateException(); 
/* 788 */             AbstractFloatBigList.FloatSubList.this.set(this.last, k);
/*     */           }
/*     */           
/*     */           public void remove() {
/* 792 */             if (this.last == -1L)
/* 793 */               throw new IllegalStateException(); 
/* 794 */             AbstractFloatBigList.FloatSubList.this.removeFloat(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */             
...
/* 800 */               this.pos--; 
/* 801 */             this.last = -1L;
/* 802 */             assert AbstractFloatBigList.FloatSubList.this.assertRange();
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 812 */       return new FloatSubList(this, from, to);
/*     */     }
/*     */     
/*     */     public boolean rem(float k) {
...
/* 818 */         return false; 
/* 819 */       this.to--;
/* 820 */       this.l.removeFloat(this.from + index);
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\floats\AbstractFloatBigList.class
