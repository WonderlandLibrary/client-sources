...
/* 222 */     if (capacity <= this.a.length || (this.a == FloatArrays.DEFAULT_EMPTY_ARRAY && capacity <= 10))
/*     */       return; 
...
/* 327 */       this.a = FloatArrays.forceCapacity(this.a, size, this.size); 
...
/* 439 */     FloatArrays.ensureOffsetLength(a, offset, length);
...
/* 461 */     FloatIterator i = c.iterator();
/* 462 */     this.size += n;
/* 463 */     while (n-- != 0)
/* 464 */       this.a[index++] = i.nextFloat(); 
...
/* 498 */       if (!c.contains(Float.valueOf(a[i])))
/* 499 */         a[j++] = a[i]; 
...
/* 507 */     return new FloatListIterator() {
/* 508 */         int pos = index; int last = -1;
/*     */         
/*     */         public boolean hasNext() {
/* 511 */           return (this.pos < FloatArrayList.this.size);
/*     */         }
/*     */         
...
/* 521 */           return FloatArrayList.this.a[this.last = this.pos++];
/*     */         }
/*     */         
/*     */         public float previousFloat() {
/* 525 */           if (!hasPrevious())
/* 526 */             throw new NoSuchElementException(); 
/* 527 */           return FloatArrayList.this.a[this.last = --this.pos];
/*     */         }
/*     */         
...
/* 539 */           FloatArrayList.this.add(this.pos++, k);
/* 540 */           this.last = -1;
/*     */         }
/*     */         
...
/* 546 */           FloatArrayList.this.set(this.last, k);
/*     */         }
/*     */         
/*     */         public void remove() {
/* 550 */           if (this.last == -1)
/* 551 */             throw new IllegalStateException(); 
/* 552 */           FloatArrayList.this.removeFloat(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* 565 */     if (comp == null) {
/* 566 */       FloatArrays.stableSort(this.a, 0, this.size);
/*     */     } else {
/* 568 */       FloatArrays.stableSort(this.a, 0, this.size, comp);
/*     */     } 
/*     */   }
/*     */   
/*     */   public void unstableSort(FloatComparator comp) {
/* 573 */     if (comp == null) {
/* 574 */       FloatArrays.unstableSort(this.a, 0, this.size);
/*     */     } else {
/* 576 */       FloatArrays.unstableSort(this.a, 0, this.size, comp);
/*     */     } 
/*     */   }
/*     */   
/*     */   public FloatArrayList clone() {
/* 581 */     FloatArrayList c = new FloatArrayList(this.size);
...
/* 626 */     float[] a1 = this.a, a2 = l.a;
/*     */     
/*     */     int i;
/* 629 */     for (i = 0; i < s1 && i < s2; i++) {
/* 630 */       float e1 = a1[i];
/* 631 */       float e2 = a2[i]; int r;
/* 632 */       if ((r = Float.compare(e1, e2)) != 0)
/* 633 */         return r; 
/*     */     } 
...
/* 640 */       s.writeFloat(this.a[i]); 
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 644 */     s.defaultReadObject();
/* 645 */     this.a = new float[this.size];
/* 646 */     for (int i = 0; i < this.size; i++)
/* 647 */       this.a[i] = s.readFloat(); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\floats\FloatArrayList.class
