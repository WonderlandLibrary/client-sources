...
/*  205 */       return FloatIterators.EMPTY_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatListIterator iterator() {
/*  210 */       return FloatIterators.EMPTY_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public FloatListIterator listIterator(int i) {
/*  215 */       if (i == 0)
/*  216 */         return FloatIterators.EMPTY_ITERATOR; 
...
/*      */     
/*      */     public Object clone() {
/*  267 */       return FloatLists.EMPTY_LIST;
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  271 */       return 1;
...
/*  283 */       return FloatLists.EMPTY_LIST;
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  320 */       return (Float.floatToIntBits(k) == Float.floatToIntBits(this.element));
/*      */     }
/*      */ 
/*      */     
/*      */     public float[] toFloatArray() {
/*  325 */       float[] a = new float[1];
/*  326 */       a[0] = this.element;
/*  327 */       return a;
/*      */     }
/*      */     
/*      */     public FloatListIterator listIterator() {
/*  331 */       return FloatIterators.singleton(this.element);
/*      */     }
/*      */     
/*      */     public FloatListIterator iterator() {
...
/*  341 */       FloatListIterator l = listIterator();
/*  342 */       if (i == 1)
/*  343 */         l.nextFloat(); 
/*  344 */       return l;
/*      */     }
...
/*      */       }
/*  354 */       if (from != 0 || to != 1)
/*  355 */         return FloatLists.EMPTY_LIST; 
/*  356 */       return this;
/*      */     }
/*      */     
/*      */     public boolean addAll(int i, Collection<? extends Float> c) {
...
/*  475 */     return new Singleton(((Float)element).floatValue());
/*      */   }
/*      */   
...
/*  496 */         return this.list.getFloat(i);
/*      */       } 
/*      */     }
/*      */     
...
/*  514 */         return this.list.removeFloat(i);
/*      */       } 
/*      */     }
/*      */     
/*      */     public int indexOf(float k) {
...
/*      */     
/*      */     public float getFloat(int i) {
/*  802 */       return this.list.getFloat(i);
/*      */     }
/*      */     
/*      */     public float set(int i, float k) {
...
/*      */     
/*      */     public FloatListIterator listIterator() {
/*  862 */       return FloatIterators.unmodifiable(this.list.listIterator());
/*      */     }
/*      */     
/*      */     public FloatListIterator iterator() {
...
/*      */     
/*      */     public FloatListIterator listIterator(int i) {
/*  870 */       return FloatIterators.unmodifiable(this.list.listIterator(i));
/*      */     }
/*      */     
/*      */     public FloatList subList(int from, int to) {
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\floats\FloatLists.class
