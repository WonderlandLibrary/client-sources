...
/* 1842 */     int[] value = this.value;
/* 1843 */     int mask = newN - 1;
/* 1844 */     float[] newKey = new float[newN + 1];
/* 1845 */     int[] newValue = new int[newN + 1];
...
/*      */     try {
/* 1899 */       c = (Float2IntLinkedOpenHashMap)super.clone();
...
/* 1908 */     c.value = (int[])this.value.clone();
...
/* 1955 */     int[] value = this.value = new int[this.n + 1];
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\floats\Float2IntLinkedOpenHashMap.class
