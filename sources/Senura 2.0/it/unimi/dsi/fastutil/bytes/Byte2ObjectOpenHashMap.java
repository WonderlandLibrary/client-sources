...
/* 1048 */     byte[] key = this.key;
/* 1049 */     V[] value = this.value;
/* 1050 */     int mask = newN - 1;
/* 1051 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1083 */       c = (Byte2ObjectOpenHashMap<V>)super.clone();
...
/* 1091 */     c.key = (byte[])this.key.clone();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\bytes\Byte2ObjectOpenHashMap.class
