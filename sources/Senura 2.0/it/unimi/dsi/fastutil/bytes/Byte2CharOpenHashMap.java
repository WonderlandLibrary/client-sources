...
/* 1076 */     byte[] key = this.key;
/* 1077 */     char[] value = this.value;
/* 1078 */     int mask = newN - 1;
/* 1079 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1111 */       c = (Byte2CharOpenHashMap)super.clone();
...
/* 1119 */     c.key = (byte[])this.key.clone();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\bytes\Byte2CharOpenHashMap.class
