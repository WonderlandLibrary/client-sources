...
/* 590 */     byte[] key = this.key;
/* 591 */     int mask = newN - 1;
/* 592 */     byte[] newKey = new byte[newN + 1];
/* 593 */     int i = this.n;
...
/* 650 */     ByteIterator i = iterator();
/* 651 */     s.defaultWriteObject();
/* 652 */     for (int j = this.size; j-- != 0;)
/* 653 */       s.writeByte(i.nextByte()); 
/*     */   }
/*     */   
...
/* 661 */     byte[] key = this.key = new byte[this.n + 1];
/*     */     
/* 663 */     for (int i = this.size; i-- != 0; ) {
/* 664 */       int pos; byte k = s.readByte();
/* 665 */       if (k == 0) {
/* 666 */         pos = this.n;
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\bytes\ByteOpenHashSet.class
