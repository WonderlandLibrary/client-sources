...
/* 1123 */     byte[] key = this.key;
/* 1124 */     short[] value = this.value;
/* 1125 */     int mask = newN - 1;
/* 1126 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1158 */       c = (Byte2ShortOpenHashMap)super.clone();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\bytes\Byte2ShortOpenHashMap.class
