...
/* 1047 */     byte[] key = this.key;
/* 1048 */     V[] value = this.value;
/* 1049 */     int mask = newN - 1;
/* 1050 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1082 */       c = (Byte2ReferenceOpenHashMap<V>)super.clone();
...
/* 1090 */     c.key = (byte[])this.key.clone();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\bytes\Byte2ReferenceOpenHashMap.class
