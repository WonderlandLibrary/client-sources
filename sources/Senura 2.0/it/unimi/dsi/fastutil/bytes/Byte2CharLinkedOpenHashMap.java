...
/* 1756 */     byte[] key = this.key;
/* 1757 */     char[] value = this.value;
/* 1758 */     int mask = newN - 1;
/* 1759 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1814 */       c = (Byte2CharLinkedOpenHashMap)super.clone();
...
/* 1822 */     c.key = (byte[])this.key.clone();
...
/* 1869 */     byte[] key = this.key = new byte[this.n + 1];
...
/* 1877 */       int pos; byte k = s.readByte();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\bytes\Byte2CharLinkedOpenHashMap.class
