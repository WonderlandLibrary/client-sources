...
/*   45 */       byte t = l.getByte(i);
/*   46 */       l.set(i, l.getByte(p));
/*   47 */       l.set(p, t);
/*      */     } 
/*   49 */     return l;
/*      */   }
...
/*  187 */       return ByteBigListIterators.EMPTY_BIG_LIST_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBigListIterator iterator() {
/*  192 */       return ByteBigListIterators.EMPTY_BIG_LIST_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteBigListIterator listIterator(long i) {
/*  197 */       if (i == 0L)
/*  198 */         return ByteBigListIterators.EMPTY_BIG_LIST_ITERATOR; 
...
/*      */     
/*      */     public Object clone() {
/*  241 */       return ByteBigLists.EMPTY_BIG_LIST;
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  245 */       return 1;
...
/*  257 */       return ByteBigLists.EMPTY_BIG_LIST;
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  299 */       byte[] a = new byte[1];
/*  300 */       a[0] = this.element;
/*  301 */       return a;
/*      */     }
/*      */     
/*      */     public ByteBigListIterator listIterator() {
/*  305 */       return ByteBigListIterators.singleton(this.element);
/*      */     }
/*      */     
/*      */     public ByteBigListIterator listIterator(long i) {
/*  309 */       if (i > 1L || i < 0L)
/*  310 */         throw new IndexOutOfBoundsException(); 
/*  311 */       ByteBigListIterator l = listIterator();
/*  312 */       if (i == 1L)
/*  313 */         l.nextByte(); 
/*  314 */       return l;
/*      */     }
...
/*  325 */         return ByteBigLists.EMPTY_BIG_LIST; 
/*  326 */       return this;
/*      */     }
/*      */     
/*      */     public boolean addAll(long i, Collection<? extends Byte> c) {
...
/*  401 */     return new Singleton(((Byte)element).byteValue());
/*      */   }
/*      */   
...
/*  422 */         return this.list.getByte(i);
/*      */       } 
/*      */     }
/*      */     
...
/*  440 */         return this.list.removeByte(i);
/*      */       } 
/*      */     }
/*      */     
/*      */     public long indexOf(byte k) {
...
/*  518 */         return ByteBigLists.synchronize(this.list.subList(from, to), this.sync);
/*      */       } 
/*      */     }
/*      */     
/*      */     public boolean equals(Object o) {
...
/*      */     
/*      */     public byte getByte(long i) {
/*  673 */       return this.list.getByte(i);
/*      */     }
/*      */     
/*      */     public byte set(long i, byte k) {
...
/*      */     
/*      */     public ByteBigListIterator listIterator() {
/*  735 */       return ByteBigListIterators.unmodifiable(this.list.listIterator());
/*      */     }
/*      */     
/*      */     public ByteBigListIterator listIterator(long i) {
/*  739 */       return ByteBigListIterators.unmodifiable(this.list.listIterator(i));
/*      */     }
/*      */     
/*      */     public ByteBigList subList(long from, long to) {
/*  743 */       return ByteBigLists.unmodifiable(this.list.subList(from, to));
/*      */     }
/*      */     
/*      */     public boolean equals(Object o) {
/*  747 */       if (o == this)
...
/*      */     
/*      */     public ByteBigListIterator iterator() {
/*  866 */       return ByteBigListIterators.asBigListIterator(this.list.iterator());
/*      */     }
/*      */     
/*      */     public ByteBigListIterator listIterator() {
/*  870 */       return ByteBigListIterators.asBigListIterator(this.list.listIterator());
/*      */     }
/*      */     
/*      */     public ByteBigListIterator listIterator(long index) {
/*  874 */       return ByteBigListIterators.asBigListIterator(this.list.listIterator(intIndex(index)));
/*      */     }
/*      */     
/*      */     public boolean addAll(long index, Collection<? extends Byte> c) {
...
/*      */     
/*      */     public byte[] toByteArray() {
/*  890 */       return this.list.toByteArray();
/*      */     }
/*      */     
/*      */     public void removeElements(long from, long to) {
...
/*  945 */       return this.list.getByte(intIndex(index));
/*      */     }
/*      */     
/*      */     public long indexOf(byte k) {
...
/*  957 */       return this.list.removeByte(intIndex(index));
/*      */     }
/*      */     
/*      */     public byte set(long index, byte k) {
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\bytes\ByteBigLists.class
