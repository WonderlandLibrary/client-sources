...
/* 1122 */     byte[] key = this.key;
/* 1123 */     boolean[] value = this.value;
/* 1124 */     int mask = newN - 1;
/* 1125 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1158 */       c = (Byte2BooleanOpenCustomHashMap)super.clone();
...
/* 1166 */     c.key = (byte[])this.key.clone();
/* 1167 */     c.value = (boolean[])this.value.clone();
...
/* 1187 */       t ^= this.value[i] ? 1231 : 1237;
/* 1188 */       h += t;
/* 1189 */       i++;
/*      */     } 
/*      */     
/* 1192 */     if (this.containsNullKey)
/* 1193 */       h += this.value[this.n] ? 1231 : 1237; 
/* 1194 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1197 */     byte[] key = this.key;
/* 1198 */     boolean[] value = this.value;
/* 1199 */     MapIterator i = new MapIterator();
/* 1200 */     s.defaultWriteObject();
/* 1201 */     for (int j = this.size; j-- != 0; ) {
/* 1202 */       int e = i.nextEntry();
/* 1203 */       s.writeByte(key[e]);
/* 1204 */       s.writeBoolean(value[e]);
/*      */     } 
/*      */   }
/*      */   
...
/* 1213 */     byte[] key = this.key = new byte[this.n + 1];
/* 1214 */     boolean[] value = this.value = new boolean[this.n + 1];
/*      */ 
/*      */     
/* 1217 */     for (int i = this.size; i-- != 0; ) {
/* 1218 */       int pos; byte k = s.readByte();
/* 1219 */       boolean v = s.readBoolean();
/* 1220 */       if (this.strategy.equals(k, (byte)0)) {
/* 1221 */         pos = this.n;
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\bytes\Byte2BooleanOpenCustomHashMap.class
