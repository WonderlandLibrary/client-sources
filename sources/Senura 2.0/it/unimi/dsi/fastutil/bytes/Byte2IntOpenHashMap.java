...
/* 1124 */     byte[] key = this.key;
/* 1125 */     int[] value = this.value;
/* 1126 */     int mask = newN - 1;
/* 1127 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1159 */       c = (Byte2IntOpenHashMap)super.clone();
...
/* 1167 */     c.key = (byte[])this.key.clone();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\bytes\Byte2IntOpenHashMap.class
