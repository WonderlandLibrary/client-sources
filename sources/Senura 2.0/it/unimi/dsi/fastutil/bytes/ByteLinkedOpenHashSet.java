...
/* 1067 */     byte[] key = this.key;
/* 1068 */     int mask = newN - 1;
/* 1069 */     byte[] newKey = new byte[newN + 1];
...
/* 1152 */     ByteIterator i = iterator();
/* 1153 */     s.defaultWriteObject();
/* 1154 */     for (int j = this.size; j-- != 0;)
/* 1155 */       s.writeByte(i.nextByte()); 
/*      */   }
/*      */   
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\bytes\ByteLinkedOpenHashSet.class
