...
/* 1727 */     byte[] key = this.key;
/* 1728 */     V[] value = this.value;
/* 1729 */     int mask = newN - 1;
/* 1730 */     byte[] newKey = new byte[newN + 1];
...
/*      */     try {
/* 1785 */       c = (Byte2ReferenceLinkedOpenHashMap<V>)super.clone();
...
/* 1793 */     c.key = (byte[])this.key.clone();
...
/* 1841 */     byte[] key = this.key = new byte[this.n + 1];
...
/* 1849 */       int pos; byte k = s.readByte();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\bytes\Byte2ReferenceLinkedOpenHashMap.class
