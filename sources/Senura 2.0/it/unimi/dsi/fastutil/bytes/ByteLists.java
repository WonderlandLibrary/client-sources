...
/*  205 */       return ByteIterators.EMPTY_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteListIterator iterator() {
/*  210 */       return ByteIterators.EMPTY_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public ByteListIterator listIterator(int i) {
/*  215 */       if (i == 0)
/*  216 */         return ByteIterators.EMPTY_ITERATOR; 
...
/*      */     
/*      */     public Object clone() {
/*  267 */       return ByteLists.EMPTY_LIST;
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  271 */       return 1;
...
/*  283 */       return ByteLists.EMPTY_LIST;
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  325 */       byte[] a = new byte[1];
/*  326 */       a[0] = this.element;
/*  327 */       return a;
/*      */     }
/*      */     
/*      */     public ByteListIterator listIterator() {
/*  331 */       return ByteIterators.singleton(this.element);
/*      */     }
/*      */     
/*      */     public ByteListIterator iterator() {
...
/*  341 */       ByteListIterator l = listIterator();
/*  342 */       if (i == 1)
/*  343 */         l.nextByte(); 
/*  344 */       return l;
/*      */     }
...
/*      */       }
/*  354 */       if (from != 0 || to != 1)
/*  355 */         return ByteLists.EMPTY_LIST; 
/*  356 */       return this;
/*      */     }
/*      */     
/*      */     public boolean addAll(int i, Collection<? extends Byte> c) {
...
/*  475 */     return new Singleton(((Byte)element).byteValue());
/*      */   }
/*      */   
...
/*  496 */         return this.list.getByte(i);
/*      */       } 
/*      */     }
/*      */     
...
/*  514 */         return this.list.removeByte(i);
/*      */       } 
/*      */     }
/*      */     
/*      */     public int indexOf(byte k) {
...
/*      */     
/*      */     public byte getByte(int i) {
/*  802 */       return this.list.getByte(i);
/*      */     }
/*      */     
/*      */     public byte set(int i, byte k) {
...
/*      */     
/*      */     public ByteListIterator listIterator() {
/*  862 */       return ByteIterators.unmodifiable(this.list.listIterator());
/*      */     }
/*      */     
/*      */     public ByteListIterator iterator() {
...
/*      */     
/*      */     public ByteListIterator listIterator(int i) {
/*  870 */       return ByteIterators.unmodifiable(this.list.listIterator(i));
/*      */     }
/*      */     
/*      */     public ByteList subList(int from, int to) {
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\bytes\ByteLists.class
