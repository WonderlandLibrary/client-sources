...
/* 1103 */     K[] key = this.key;
/* 1104 */     long[] value = this.value;
/* 1105 */     int mask = newN - 1;
/* 1106 */     K[] newKey = (K[])new Object[newN + 1];
/* 1107 */     long[] newValue = new long[newN + 1];
/* 1108 */     int i = this.n;
...
/*      */     try {
/* 1139 */       c = (Reference2LongOpenHashMap<K>)super.clone();
...
/* 1148 */     c.value = (long[])this.value.clone();
/* 1149 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1168 */       t ^= HashCommon.long2int(this.value[i]);
/* 1169 */       h += t;
/* 1170 */       i++;
/*      */     } 
/*      */     
/* 1173 */     if (this.containsNullKey)
/* 1174 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1175 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1178 */     K[] key = this.key;
/* 1179 */     long[] value = this.value;
...
/* 1195 */     long[] value = this.value = new long[this.n + 1];
/*      */ 
/*      */     
/* 1198 */     for (int i = this.size; i-- != 0; ) {
/* 1199 */       int pos; K k = (K)s.readObject();
/* 1200 */       long v = s.readLong();
/* 1201 */       if (k == null) {
/* 1202 */         pos = this.n;
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\Reference2LongOpenHashMap.class
