...
/*      */     
/*      */     public K getKey() {
/*  666 */       return Object2FloatOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public float getFloatValue() {
/*  670 */       return Object2FloatOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public float setValue(float v) {
/*  674 */       float oldValue = Object2FloatOpenCustomHashMap.this.value[this.index];
/*  675 */       Object2FloatOpenCustomHashMap.this.value[this.index] = v;
/*  676 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  686 */       return Float.valueOf(Object2FloatOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  704 */       return (Object2FloatOpenCustomHashMap.this.strategy.equals(Object2FloatOpenCustomHashMap.this.key[this.index], e.getKey()) && 
/*  705 */         Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(((Float)e.getValue()).floatValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  709 */       return Object2FloatOpenCustomHashMap.this.strategy.hashCode(Object2FloatOpenCustomHashMap.this.key[this.index]) ^ HashCommon.float2int(Object2FloatOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/*  713 */       return (new StringBuilder()).append(Object2FloatOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2FloatOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  723 */     int pos = Object2FloatOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  730 */     int last = -1;
/*      */     
/*  732 */     int c = Object2FloatOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  736 */     boolean mustReturnNullKey = Object2FloatOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  751 */         return this.last = Object2FloatOpenCustomHashMap.this.n;
/*      */       } 
/*  753 */       K[] key = Object2FloatOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  755 */         if (--this.pos < 0) {
/*      */           
/*  757 */           this.last = Integer.MIN_VALUE;
/*  758 */           K k = this.wrapped.get(-this.pos - 1);
/*  759 */           int p = HashCommon.mix(Object2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Object2FloatOpenCustomHashMap.this.mask;
/*  760 */           while (!Object2FloatOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  761 */             p = p + 1 & Object2FloatOpenCustomHashMap.this.mask; 
/*  762 */           return p;
/*      */         } 
...
/*  779 */       K[] key = Object2FloatOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  781 */         pos = (last = pos) + 1 & Object2FloatOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  783 */           if ((curr = key[pos]) == null) {
/*  784 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  787 */           int slot = HashCommon.mix(Object2FloatOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2FloatOpenCustomHashMap.this.mask;
/*  788 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  790 */           pos = pos + 1 & Object2FloatOpenCustomHashMap.this.mask;
/*      */         } 
/*  792 */         if (pos < last) {
/*  793 */           if (this.wrapped == null)
/*  794 */             this.wrapped = new ObjectArrayList<>(2); 
/*  795 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  797 */         key[last] = curr;
/*  798 */         Object2FloatOpenCustomHashMap.this.value[last] = Object2FloatOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  802 */       if (this.last == -1)
/*  803 */         throw new IllegalStateException(); 
/*  804 */       if (this.last == Object2FloatOpenCustomHashMap.this.n) {
/*  805 */         Object2FloatOpenCustomHashMap.this.containsNullKey = false;
/*  806 */         Object2FloatOpenCustomHashMap.this.key[Object2FloatOpenCustomHashMap.this.n] = null;
/*  807 */       } else if (this.pos >= 0) {
/*  808 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  811 */         Object2FloatOpenCustomHashMap.this.removeFloat(this.wrapped.set(-this.pos - 1, null));
/*  812 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  815 */       Object2FloatOpenCustomHashMap.this.size--;
/*  816 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*  831 */       return this.entry = new Object2FloatOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  840 */       this.entry = new Object2FloatOpenCustomHashMap.MapEntry();
...
/*  850 */       return new Object2FloatOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Object2FloatMap.Entry<K>> fastIterator() {
/*  854 */       return new Object2FloatOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  866 */       if (Object2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  867 */         return (Object2FloatOpenCustomHashMap.this.containsNullKey && 
/*  868 */           Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[Object2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v));
/*      */       }
/*  870 */       K[] key = Object2FloatOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  873 */       if ((curr = key[pos = HashCommon.mix(Object2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Object2FloatOpenCustomHashMap.this.mask]) == null)
/*  874 */         return false; 
/*  875 */       if (Object2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  876 */         return (Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */       }
/*      */       while (true) {
/*  879 */         if ((curr = key[pos = pos + 1 & Object2FloatOpenCustomHashMap.this.mask]) == null)
/*  880 */           return false; 
/*  881 */         if (Object2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  882 */           return (Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v));
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  895 */       if (Object2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  896 */         if (Object2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[Object2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v)) {
/*  897 */           Object2FloatOpenCustomHashMap.this.removeNullEntry();
/*  898 */           return true;
/*      */         } 
/*  900 */         return false;
/*      */       } 
/*      */       
/*  903 */       K[] key = Object2FloatOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  906 */       if ((curr = key[pos = HashCommon.mix(Object2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Object2FloatOpenCustomHashMap.this.mask]) == null)
/*  907 */         return false; 
/*  908 */       if (Object2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  909 */         if (Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/*  910 */           Object2FloatOpenCustomHashMap.this.removeEntry(pos);
/*  911 */           return true;
/*      */         } 
/*  913 */         return false;
/*      */       } 
/*      */       while (true) {
/*  916 */         if ((curr = key[pos = pos + 1 & Object2FloatOpenCustomHashMap.this.mask]) == null)
/*  917 */           return false; 
/*  918 */         if (Object2FloatOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  919 */           Float.floatToIntBits(Object2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
/*  920 */           Object2FloatOpenCustomHashMap.this.removeEntry(pos);
/*  921 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  928 */       return Object2FloatOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  932 */       Object2FloatOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2FloatMap.Entry<K>> consumer) {
/*  937 */       if (Object2FloatOpenCustomHashMap.this.containsNullKey)
/*  938 */         consumer.accept(new AbstractObject2FloatMap.BasicEntry<>(Object2FloatOpenCustomHashMap.this.key[Object2FloatOpenCustomHashMap.this.n], Object2FloatOpenCustomHashMap.this.value[Object2FloatOpenCustomHashMap.this.n])); 
/*  939 */       for (int pos = Object2FloatOpenCustomHashMap.this.n; pos-- != 0;) {
/*  940 */         if (Object2FloatOpenCustomHashMap.this.key[pos] != null)
/*  941 */           consumer.accept(new AbstractObject2FloatMap.BasicEntry<>(Object2FloatOpenCustomHashMap.this.key[pos], Object2FloatOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2FloatMap.Entry<K>> consumer) {
/*  946 */       AbstractObject2FloatMap.BasicEntry<K> entry = new AbstractObject2FloatMap.BasicEntry<>();
/*  947 */       if (Object2FloatOpenCustomHashMap.this.containsNullKey) {
/*  948 */         entry.key = Object2FloatOpenCustomHashMap.this.key[Object2FloatOpenCustomHashMap.this.n];
/*  949 */         entry.value = Object2FloatOpenCustomHashMap.this.value[Object2FloatOpenCustomHashMap.this.n];
/*  950 */         consumer.accept(entry);
/*      */       } 
/*  952 */       for (int pos = Object2FloatOpenCustomHashMap.this.n; pos-- != 0;) {
/*  953 */         if (Object2FloatOpenCustomHashMap.this.key[pos] != null) {
/*  954 */           entry.key = Object2FloatOpenCustomHashMap.this.key[pos];
/*  955 */           entry.value = Object2FloatOpenCustomHashMap.this.value[pos];
...
/*      */   {
/*      */     public K next() {
/*  981 */       return Object2FloatOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractObjectSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectIterator<K> iterator() {
/*  987 */       return new Object2FloatOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/*  992 */       if (Object2FloatOpenCustomHashMap.this.containsNullKey)
/*  993 */         consumer.accept(Object2FloatOpenCustomHashMap.this.key[Object2FloatOpenCustomHashMap.this.n]); 
/*  994 */       for (int pos = Object2FloatOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  995 */         K k = Object2FloatOpenCustomHashMap.this.key[pos];
/*  996 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/* 1002 */       return Object2FloatOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1006 */       return Object2FloatOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1010 */       int oldSize = Object2FloatOpenCustomHashMap.this.size;
/* 1011 */       Object2FloatOpenCustomHashMap.this.removeFloat(k);
/* 1012 */       return (Object2FloatOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1016 */       Object2FloatOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1040 */       return Object2FloatOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1049 */             return new Object2FloatOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1053 */             return Object2FloatOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(float v) {
/* 1057 */             return Object2FloatOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1061 */             Object2FloatOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(DoubleConsumer consumer)
/*      */           {
/* 1066 */             if (Object2FloatOpenCustomHashMap.this.containsNullKey)
/* 1067 */               consumer.accept(Object2FloatOpenCustomHashMap.this.value[Object2FloatOpenCustomHashMap.this.n]); 
/* 1068 */             for (int pos = Object2FloatOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1069 */               if (Object2FloatOpenCustomHashMap.this.key[pos] != null)
/* 1070 */                 consumer.accept(Object2FloatOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */     try {
/* 1173 */       c = (Object2FloatOpenCustomHashMap<K>)super.clone();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\Object2FloatOpenCustomHashMap.class
