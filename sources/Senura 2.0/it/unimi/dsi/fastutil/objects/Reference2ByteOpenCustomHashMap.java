...
/*      */     } 
/*  319 */     byte oldValue = this.value[pos];
/*  320 */     this.value[pos] = v;
/*  321 */     return oldValue;
/*      */   }
/*      */   private byte addToValue(int pos, byte incr) {
/*  324 */     byte oldValue = this.value[pos];
/*  325 */     this.value[pos] = (byte)(oldValue + incr);
/*  326 */     return oldValue;
/*      */   }
/*      */ 
/*      */ 
...
/*  574 */     Byte newValue = remappingFunction.apply(k, Byte.valueOf(this.value[pos]));
...
/*      */     } 
/*  582 */     this.value[pos] = newValue.byteValue(); return newValue.byteValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  589 */     int pos = find(k);
/*  590 */     Byte newValue = remappingFunction.apply(k, (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  600 */     byte newVal = newValue.byteValue();
/*  601 */     if (pos < 0) {
...
/*  615 */       return v;
/*      */     } 
/*  617 */     Byte newValue = remappingFunction.apply(Byte.valueOf(this.value[pos]), Byte.valueOf(v));
...
/*      */     } 
/*  625 */     this.value[pos] = newValue.byteValue(); return newValue.byteValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  666 */       return Reference2ByteOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public byte getByteValue() {
/*  670 */       return Reference2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public byte setValue(byte v) {
/*  674 */       byte oldValue = Reference2ByteOpenCustomHashMap.this.value[this.index];
/*  675 */       Reference2ByteOpenCustomHashMap.this.value[this.index] = v;
/*  676 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  686 */       return Byte.valueOf(Reference2ByteOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  702 */         return false; 
/*  703 */       Map.Entry<K, Byte> e = (Map.Entry<K, Byte>)o;
/*  704 */       return (Reference2ByteOpenCustomHashMap.this.strategy.equals(Reference2ByteOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  708 */       return Reference2ByteOpenCustomHashMap.this.strategy.hashCode(Reference2ByteOpenCustomHashMap.this.key[this.index]) ^ Reference2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/*  712 */       return (new StringBuilder()).append(Reference2ByteOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2ByteOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  722 */     int pos = Reference2ByteOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  729 */     int last = -1;
/*      */     
/*  731 */     int c = Reference2ByteOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  735 */     boolean mustReturnNullKey = Reference2ByteOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  750 */         return this.last = Reference2ByteOpenCustomHashMap.this.n;
/*      */       } 
/*  752 */       K[] key = Reference2ByteOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  754 */         if (--this.pos < 0) {
/*      */           
/*  756 */           this.last = Integer.MIN_VALUE;
/*  757 */           K k = this.wrapped.get(-this.pos - 1);
/*  758 */           int p = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ByteOpenCustomHashMap.this.mask;
/*  759 */           while (!Reference2ByteOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  760 */             p = p + 1 & Reference2ByteOpenCustomHashMap.this.mask; 
/*  761 */           return p;
/*      */         } 
...
/*  778 */       K[] key = Reference2ByteOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  780 */         pos = (last = pos) + 1 & Reference2ByteOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  782 */           if ((curr = key[pos]) == null) {
/*  783 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  786 */           int slot = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2ByteOpenCustomHashMap.this.mask;
/*  787 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  789 */           pos = pos + 1 & Reference2ByteOpenCustomHashMap.this.mask;
/*      */         } 
/*  791 */         if (pos < last) {
...
/*      */         } 
/*  796 */         key[last] = curr;
/*  797 */         Reference2ByteOpenCustomHashMap.this.value[last] = Reference2ByteOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  801 */       if (this.last == -1)
/*  802 */         throw new IllegalStateException(); 
/*  803 */       if (this.last == Reference2ByteOpenCustomHashMap.this.n) {
/*  804 */         Reference2ByteOpenCustomHashMap.this.containsNullKey = false;
/*  805 */         Reference2ByteOpenCustomHashMap.this.key[Reference2ByteOpenCustomHashMap.this.n] = null;
/*  806 */       } else if (this.pos >= 0) {
/*  807 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  810 */         Reference2ByteOpenCustomHashMap.this.removeByte(this.wrapped.set(-this.pos - 1, null));
/*  811 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  814 */       Reference2ByteOpenCustomHashMap.this.size--;
/*  815 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*  830 */       return this.entry = new Reference2ByteOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  839 */       this.entry = new Reference2ByteOpenCustomHashMap.MapEntry();
...
/*  849 */       return new Reference2ByteOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Reference2ByteMap.Entry<K>> fastIterator() {
/*  853 */       return new Reference2ByteOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  865 */       if (Reference2ByteOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  866 */         return (Reference2ByteOpenCustomHashMap.this.containsNullKey && Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n] == v);
/*      */       }
/*  868 */       K[] key = Reference2ByteOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  871 */       if ((curr = key[pos = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ByteOpenCustomHashMap.this.mask]) == null)
/*  872 */         return false; 
/*  873 */       if (Reference2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  874 */         return (Reference2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  877 */         if ((curr = key[pos = pos + 1 & Reference2ByteOpenCustomHashMap.this.mask]) == null)
/*  878 */           return false; 
/*  879 */         if (Reference2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  880 */           return (Reference2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  889 */       if (e.getValue() == null || !(e.getValue() instanceof Byte))
/*  890 */         return false; 
/*  891 */       K k = (K)e.getKey();
/*  892 */       byte v = ((Byte)e.getValue()).byteValue();
/*  893 */       if (Reference2ByteOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  894 */         if (Reference2ByteOpenCustomHashMap.this.containsNullKey && Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n] == v) {
/*  895 */           Reference2ByteOpenCustomHashMap.this.removeNullEntry();
/*  896 */           return true;
/*      */         } 
/*  898 */         return false;
/*      */       } 
/*      */       
/*  901 */       K[] key = Reference2ByteOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  904 */       if ((curr = key[pos = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ByteOpenCustomHashMap.this.mask]) == null)
/*  905 */         return false; 
/*  906 */       if (Reference2ByteOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  907 */         if (Reference2ByteOpenCustomHashMap.this.value[pos] == v) {
/*  908 */           Reference2ByteOpenCustomHashMap.this.removeEntry(pos);
/*  909 */           return true;
/*      */         } 
/*  911 */         return false;
/*      */       } 
/*      */       while (true) {
/*  914 */         if ((curr = key[pos = pos + 1 & Reference2ByteOpenCustomHashMap.this.mask]) == null)
/*  915 */           return false; 
/*  916 */         if (Reference2ByteOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  917 */           Reference2ByteOpenCustomHashMap.this.value[pos] == v) {
/*  918 */           Reference2ByteOpenCustomHashMap.this.removeEntry(pos);
/*  919 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  926 */       return Reference2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  930 */       Reference2ByteOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
/*  935 */       if (Reference2ByteOpenCustomHashMap.this.containsNullKey)
/*  936 */         consumer.accept(new AbstractReference2ByteMap.BasicEntry<>(Reference2ByteOpenCustomHashMap.this.key[Reference2ByteOpenCustomHashMap.this.n], Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n])); 
/*  937 */       for (int pos = Reference2ByteOpenCustomHashMap.this.n; pos-- != 0;) {
/*  938 */         if (Reference2ByteOpenCustomHashMap.this.key[pos] != null)
/*  939 */           consumer.accept(new AbstractReference2ByteMap.BasicEntry<>(Reference2ByteOpenCustomHashMap.this.key[pos], Reference2ByteOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
/*  944 */       AbstractReference2ByteMap.BasicEntry<K> entry = new AbstractReference2ByteMap.BasicEntry<>();
/*  945 */       if (Reference2ByteOpenCustomHashMap.this.containsNullKey) {
/*  946 */         entry.key = Reference2ByteOpenCustomHashMap.this.key[Reference2ByteOpenCustomHashMap.this.n];
/*  947 */         entry.value = Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n];
/*  948 */         consumer.accept(entry);
/*      */       } 
/*  950 */       for (int pos = Reference2ByteOpenCustomHashMap.this.n; pos-- != 0;) {
/*  951 */         if (Reference2ByteOpenCustomHashMap.this.key[pos] != null) {
/*  952 */           entry.key = Reference2ByteOpenCustomHashMap.this.key[pos];
/*  953 */           entry.value = Reference2ByteOpenCustomHashMap.this.value[pos];
...
/*      */   {
/*      */     public K next() {
/*  979 */       return Reference2ByteOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractReferenceSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectIterator<K> iterator() {
/*  985 */       return new Reference2ByteOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/*  990 */       if (Reference2ByteOpenCustomHashMap.this.containsNullKey)
/*  991 */         consumer.accept(Reference2ByteOpenCustomHashMap.this.key[Reference2ByteOpenCustomHashMap.this.n]); 
/*  992 */       for (int pos = Reference2ByteOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  993 */         K k = Reference2ByteOpenCustomHashMap.this.key[pos];
/*  994 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/* 1000 */       return Reference2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1004 */       return Reference2ByteOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1008 */       int oldSize = Reference2ByteOpenCustomHashMap.this.size;
/* 1009 */       Reference2ByteOpenCustomHashMap.this.removeByte(k);
/* 1010 */       return (Reference2ByteOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1014 */       Reference2ByteOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1038 */       return Reference2ByteOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public ByteCollection values() {
/* 1043 */     if (this.values == null)
/* 1044 */       this.values = (ByteCollection)new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1047 */             return new Reference2ByteOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1051 */             return Reference2ByteOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(byte v) {
/* 1055 */             return Reference2ByteOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1059 */             Reference2ByteOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1064 */             if (Reference2ByteOpenCustomHashMap.this.containsNullKey)
/* 1065 */               consumer.accept(Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n]); 
/* 1066 */             for (int pos = Reference2ByteOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1067 */               if (Reference2ByteOpenCustomHashMap.this.key[pos] != null)
/* 1068 */                 consumer.accept(Reference2ByteOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1136 */     K[] key = this.key;
/* 1137 */     byte[] value = this.value;
/* 1138 */     int mask = newN - 1;
/* 1139 */     K[] newKey = (K[])new Object[newN + 1];
/* 1140 */     byte[] newValue = new byte[newN + 1];
/* 1141 */     int i = this.n;
...
/*      */     try {
/* 1171 */       c = (Reference2ByteOpenCustomHashMap<K>)super.clone();
...
/* 1180 */     c.value = (byte[])this.value.clone();
...
/* 1228 */     byte[] value = this.value = new byte[this.n + 1];
/*      */ 
/*      */     
/* 1231 */     for (int i = this.size; i-- != 0; ) {
/* 1232 */       int pos; K k = (K)s.readObject();
/* 1233 */       byte v = s.readByte();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\Reference2ByteOpenCustomHashMap.class
