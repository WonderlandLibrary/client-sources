...
/* 1794 */     K[] key = this.key;
/* 1795 */     int[] value = this.value;
/* 1796 */     int mask = newN - 1;
/* 1797 */     K[] newKey = (K[])new Object[newN + 1];
/* 1798 */     int[] newValue = new int[newN + 1];
...
/*      */     try {
/* 1852 */       c = (Reference2IntLinkedOpenHashMap<K>)super.clone();
...
/* 1861 */     c.value = (int[])this.value.clone();
...
/* 1909 */     int[] value = this.value = new int[this.n + 1];
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\Reference2IntLinkedOpenHashMap.class
