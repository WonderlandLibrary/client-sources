...
/*  320 */     int oldValue = this.value[this.n];
/*  321 */     this.size--;
...
/*      */     } 
/*  382 */     int oldValue = this.value[pos];
/*  383 */     this.value[pos] = v;
/*  384 */     return oldValue;
/*      */   }
/*      */   private int addToValue(int pos, int incr) {
/*  387 */     int oldValue = this.value[pos];
...
/*  496 */     int oldValue = this.value[pos];
...
/*  902 */     int oldValue = this.value[pos];
...
/*  913 */     int newValue = mappingFunction.applyAsInt(k);
...
/*  925 */     Integer newValue = remappingFunction.apply(k, Integer.valueOf(this.value[pos]));
...
/*  940 */     int pos = find(k);
/*  941 */     Integer newValue = remappingFunction.apply(k, (pos >= 0) ? Integer.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  951 */     int newVal = newValue.intValue();
/*  952 */     if (pos < 0) {
...
/*  966 */       return v;
/*      */     } 
/*  968 */     Integer newValue = remappingFunction.apply(Integer.valueOf(this.value[pos]), Integer.valueOf(v));
...
/*      */     } 
/*  976 */     this.value[pos] = newValue.intValue(); return newValue.intValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/* 1018 */       return Object2IntLinkedOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public int getIntValue() {
/* 1022 */       return Object2IntLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public int setValue(int v) {
/* 1026 */       int oldValue = Object2IntLinkedOpenCustomHashMap.this.value[this.index];
/* 1027 */       Object2IntLinkedOpenCustomHashMap.this.value[this.index] = v;
...
/* 1038 */       return Integer.valueOf(Object2IntLinkedOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1048 */       return Integer.valueOf(setValue(v.intValue()));
/*      */     }
/*      */ 
/*      */     
...
/* 1054 */         return false; 
/* 1055 */       Map.Entry<K, Integer> e = (Map.Entry<K, Integer>)o;
/* 1056 */       return (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(Object2IntLinkedOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2IntLinkedOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/* 1060 */       return Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(Object2IntLinkedOpenCustomHashMap.this.key[this.index]) ^ Object2IntLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1064 */       return (new StringBuilder()).append(Object2IntLinkedOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2IntLinkedOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1227 */       this.next = Object2IntLinkedOpenCustomHashMap.this.first;
/* 1228 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(K from) {
/* 1231 */       if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(from, null)) {
/* 1232 */         if (Object2IntLinkedOpenCustomHashMap.this.containsNullKey) {
/* 1233 */           this.next = (int)Object2IntLinkedOpenCustomHashMap.this.link[Object2IntLinkedOpenCustomHashMap.this.n];
/* 1234 */           this.prev = Object2IntLinkedOpenCustomHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1237 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1239 */       if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(Object2IntLinkedOpenCustomHashMap.this.key[Object2IntLinkedOpenCustomHashMap.this.last], from)) {
/* 1240 */         this.prev = Object2IntLinkedOpenCustomHashMap.this.last;
/* 1241 */         this.index = Object2IntLinkedOpenCustomHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1245 */       int pos = HashCommon.mix(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */       
/* 1247 */       while (Object2IntLinkedOpenCustomHashMap.this.key[pos] != null) {
/* 1248 */         if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(Object2IntLinkedOpenCustomHashMap.this.key[pos], from)) {
/*      */           
/* 1250 */           this.next = (int)Object2IntLinkedOpenCustomHashMap.this.link[pos];
/* 1251 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1254 */         pos = pos + 1 & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1271 */       if (this.next == -1) {
/* 1272 */         this.index = Object2IntLinkedOpenCustomHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1275 */       int pos = Object2IntLinkedOpenCustomHashMap.this.first;
/* 1276 */       this.index = 1;
/* 1277 */       while (pos != this.prev) {
/* 1278 */         pos = (int)Object2IntLinkedOpenCustomHashMap.this.link[pos];
/* 1279 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1294 */       this.next = (int)Object2IntLinkedOpenCustomHashMap.this.link[this.curr];
...
/* 1304 */       this.prev = (int)(Object2IntLinkedOpenCustomHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1319 */         this.index--;
/* 1320 */         this.prev = (int)(Object2IntLinkedOpenCustomHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1322 */         this.next = (int)Object2IntLinkedOpenCustomHashMap.this.link[this.curr];
/* 1323 */       }  Object2IntLinkedOpenCustomHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1328 */       if (this.prev == -1) {
/* 1329 */         Object2IntLinkedOpenCustomHashMap.this.first = this.next;
/*      */       } else {
/* 1331 */         Object2IntLinkedOpenCustomHashMap.this.link[this.prev] = Object2IntLinkedOpenCustomHashMap.this.link[this.prev] ^ (Object2IntLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1332 */       }  if (this.next == -1) {
/* 1333 */         Object2IntLinkedOpenCustomHashMap.this.last = this.prev;
/*      */       } else {
/* 1335 */         Object2IntLinkedOpenCustomHashMap.this.link[this.next] = Object2IntLinkedOpenCustomHashMap.this.link[this.next] ^ (Object2IntLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1336 */       }  int pos = this.curr;
/* 1337 */       this.curr = -1;
/* 1338 */       if (pos == Object2IntLinkedOpenCustomHashMap.this.n) {
/* 1339 */         Object2IntLinkedOpenCustomHashMap.this.containsNullKey = false;
/* 1340 */         Object2IntLinkedOpenCustomHashMap.this.key[Object2IntLinkedOpenCustomHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1343 */         K[] key = Object2IntLinkedOpenCustomHashMap.this.key;
/*      */         while (true) {
/*      */           K curr;
/*      */           int last;
/* 1347 */           pos = (last = pos) + 1 & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */           while (true) {
/* 1349 */             if ((curr = key[pos]) == null) {
/* 1350 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1353 */             int slot = HashCommon.mix(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2IntLinkedOpenCustomHashMap.this.mask;
/* 1354 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1356 */             pos = pos + 1 & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */           } 
/* 1358 */           key[last] = curr;
/* 1359 */           Object2IntLinkedOpenCustomHashMap.this.value[last] = Object2IntLinkedOpenCustomHashMap.this.value[pos];
/* 1360 */           if (this.next == pos)
/* 1361 */             this.next = last; 
/* 1362 */           if (this.prev == pos)
/* 1363 */             this.prev = last; 
/* 1364 */           Object2IntLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/* 1396 */       return this.entry = new Object2IntLinkedOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Object2IntLinkedOpenCustomHashMap<K>.MapEntry previous() {
/* 1400 */       return this.entry = new Object2IntLinkedOpenCustomHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1404 */       super.remove();
...
/*      */ 
/*      */   
/* 1409 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Object2IntMap.Entry<K>> { final Object2IntLinkedOpenCustomHashMap<K>.MapEntry entry = new Object2IntLinkedOpenCustomHashMap.MapEntry();
/*      */ 
/*      */     
...
/* 1431 */       return new Object2IntLinkedOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
...
/* 1452 */       if (Object2IntLinkedOpenCustomHashMap.this.size == 0)
/* 1453 */         throw new NoSuchElementException(); 
/* 1454 */       return new Object2IntLinkedOpenCustomHashMap.MapEntry(Object2IntLinkedOpenCustomHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Object2IntMap.Entry<K> last() {
/* 1458 */       if (Object2IntLinkedOpenCustomHashMap.this.size == 0)
/* 1459 */         throw new NoSuchElementException(); 
/* 1460 */       return new Object2IntLinkedOpenCustomHashMap.MapEntry(Object2IntLinkedOpenCustomHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1468 */       if (e.getValue() == null || !(e.getValue() instanceof Integer))
/* 1469 */         return false; 
/* 1470 */       K k = (K)e.getKey();
/* 1471 */       int v = ((Integer)e.getValue()).intValue();
/* 1472 */       if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
/* 1473 */         return (Object2IntLinkedOpenCustomHashMap.this.containsNullKey && Object2IntLinkedOpenCustomHashMap.this.value[Object2IntLinkedOpenCustomHashMap.this.n] == v);
/*      */       }
/* 1475 */       K[] key = Object2IntLinkedOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1478 */       if ((curr = key[pos = HashCommon.mix(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2IntLinkedOpenCustomHashMap.this.mask]) == null)
/* 1479 */         return false; 
/* 1480 */       if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(k, curr)) {
/* 1481 */         return (Object2IntLinkedOpenCustomHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/* 1484 */         if ((curr = key[pos = pos + 1 & Object2IntLinkedOpenCustomHashMap.this.mask]) == null)
/* 1485 */           return false; 
/* 1486 */         if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(k, curr)) {
/* 1487 */           return (Object2IntLinkedOpenCustomHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1496 */       if (e.getValue() == null || !(e.getValue() instanceof Integer))
/* 1497 */         return false; 
/* 1498 */       K k = (K)e.getKey();
/* 1499 */       int v = ((Integer)e.getValue()).intValue();
/* 1500 */       if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
/* 1501 */         if (Object2IntLinkedOpenCustomHashMap.this.containsNullKey && Object2IntLinkedOpenCustomHashMap.this.value[Object2IntLinkedOpenCustomHashMap.this.n] == v) {
/* 1502 */           Object2IntLinkedOpenCustomHashMap.this.removeNullEntry();
/* 1503 */           return true;
/*      */         } 
/* 1505 */         return false;
/*      */       } 
/*      */       
/* 1508 */       K[] key = Object2IntLinkedOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1511 */       if ((curr = key[pos = HashCommon.mix(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2IntLinkedOpenCustomHashMap.this.mask]) == null)
/* 1512 */         return false; 
/* 1513 */       if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1514 */         if (Object2IntLinkedOpenCustomHashMap.this.value[pos] == v) {
/* 1515 */           Object2IntLinkedOpenCustomHashMap.this.removeEntry(pos);
/* 1516 */           return true;
/*      */         } 
/* 1518 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1521 */         if ((curr = key[pos = pos + 1 & Object2IntLinkedOpenCustomHashMap.this.mask]) == null)
/* 1522 */           return false; 
...
/*      */     
/*      */     public int size() {
/* 1533 */       return Object2IntLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1537 */       Object2IntLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1578 */       return new Object2IntLinkedOpenCustomHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2IntMap.Entry<K>> consumer) {
/* 1583 */       for (int i = Object2IntLinkedOpenCustomHashMap.this.size, next = Object2IntLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1584 */         int curr = next;
/* 1585 */         next = (int)Object2IntLinkedOpenCustomHashMap.this.link[curr];
/* 1586 */         consumer.accept(new AbstractObject2IntMap.BasicEntry<>(Object2IntLinkedOpenCustomHashMap.this.key[curr], Object2IntLinkedOpenCustomHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2IntMap.Entry<K>> consumer) {
/* 1592 */       AbstractObject2IntMap.BasicEntry<K> entry = new AbstractObject2IntMap.BasicEntry<>();
/* 1593 */       for (int i = Object2IntLinkedOpenCustomHashMap.this.size, next = Object2IntLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1594 */         int curr = next;
/* 1595 */         next = (int)Object2IntLinkedOpenCustomHashMap.this.link[curr];
/* 1596 */         entry.key = Object2IntLinkedOpenCustomHashMap.this.key[curr];
/* 1597 */         entry.value = Object2IntLinkedOpenCustomHashMap.this.value[curr];
...
/*      */     
/*      */     public K previous() {
/* 1623 */       return Object2IntLinkedOpenCustomHashMap.this.key[previousEntry()];
/*      */     }
/*      */ 
/*      */     
/*      */     public KeyIterator() {}
/*      */     
/*      */     public K next() {
/* 1630 */       return Object2IntLinkedOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractObjectSortedSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectListIterator<K> iterator(K from) {
/* 1636 */       return new Object2IntLinkedOpenCustomHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1640 */       return new Object2IntLinkedOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1645 */       if (Object2IntLinkedOpenCustomHashMap.this.containsNullKey)
/* 1646 */         consumer.accept(Object2IntLinkedOpenCustomHashMap.this.key[Object2IntLinkedOpenCustomHashMap.this.n]); 
/* 1647 */       for (int pos = Object2IntLinkedOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1648 */         K k = Object2IntLinkedOpenCustomHashMap.this.key[pos];
/* 1649 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/* 1655 */       return Object2IntLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1659 */       return Object2IntLinkedOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1663 */       int oldSize = Object2IntLinkedOpenCustomHashMap.this.size;
/* 1664 */       Object2IntLinkedOpenCustomHashMap.this.removeInt(k);
/* 1665 */       return (Object2IntLinkedOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1669 */       Object2IntLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public K first() {
/* 1673 */       if (Object2IntLinkedOpenCustomHashMap.this.size == 0)
/* 1674 */         throw new NoSuchElementException(); 
/* 1675 */       return Object2IntLinkedOpenCustomHashMap.this.key[Object2IntLinkedOpenCustomHashMap.this.first];
/*      */     }
/*      */     
/*      */     public K last() {
/* 1679 */       if (Object2IntLinkedOpenCustomHashMap.this.size == 0)
/* 1680 */         throw new NoSuchElementException(); 
/* 1681 */       return Object2IntLinkedOpenCustomHashMap.this.key[Object2IntLinkedOpenCustomHashMap.this.last];
/*      */     }
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1685 */       return null;
...
/* 1718 */       return Object2IntLinkedOpenCustomHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*      */     public int nextInt() {
/* 1725 */       return Object2IntLinkedOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public IntCollection values() {
/* 1730 */     if (this.values == null)
/* 1731 */       this.values = (IntCollection)new AbstractIntCollection()
/*      */         {
/*      */           public IntIterator iterator() {
/* 1734 */             return (IntIterator)new Object2IntLinkedOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1738 */             return Object2IntLinkedOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(int v) {
/* 1742 */             return Object2IntLinkedOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1746 */             Object2IntLinkedOpenCustomHashMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1751 */             if (Object2IntLinkedOpenCustomHashMap.this.containsNullKey)
/* 1752 */               consumer.accept(Object2IntLinkedOpenCustomHashMap.this.value[Object2IntLinkedOpenCustomHashMap.this.n]); 
/* 1753 */             for (int pos = Object2IntLinkedOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1754 */               if (Object2IntLinkedOpenCustomHashMap.this.key[pos] != null)
/* 1755 */                 consumer.accept(Object2IntLinkedOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1823 */     K[] key = this.key;
/* 1824 */     int[] value = this.value;
/* 1825 */     int mask = newN - 1;
/* 1826 */     K[] newKey = (K[])new Object[newN + 1];
/* 1827 */     int[] newValue = new int[newN + 1];
...
/*      */     try {
/* 1881 */       c = (Object2IntLinkedOpenCustomHashMap<K>)super.clone();
...
/* 1890 */     c.value = (int[])this.value.clone();
...
/* 1939 */     int[] value = this.value = new int[this.n + 1];
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\Object2IntLinkedOpenCustomHashMap.class
