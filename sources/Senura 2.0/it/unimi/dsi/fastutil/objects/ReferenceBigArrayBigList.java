...
/* 314 */       if (k == BigArrays.get((Object[][])this.a, i))
/* 315 */         return i; 
/* 316 */     }  return -1L;
/*     */   }
/*     */   
...
/* 321 */       if (k == BigArrays.get((Object[][])this.a, i))
/* 322 */         return i; 
/* 323 */     }  return -1L;
/*     */   }
/*     */   
...
/* 507 */           return (K)BigArrays.get((Object[][])ReferenceBigArrayBigList.this.a, this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public K previous() {
/* 511 */           if (!hasPrevious())
/* 512 */             throw new NoSuchElementException(); 
/* 513 */           return (K)BigArrays.get((Object[][])ReferenceBigArrayBigList.this.a, this.last = --this.pos);
/*     */         }
/*     */         
...
/* 575 */     K[][] a2 = l.a;
/* 576 */     while (s-- != 0L) {
/* 577 */       if (BigArrays.get((Object[][])a1, s) != BigArrays.get((Object[][])a2, s))
/* 578 */         return false; 
/* 579 */     }  return true;
/*     */   }
...
/* 584 */       s.writeObject(BigArrays.get((Object[][])this.a, i)); 
/*     */   }
/*     */   
...
/* 591 */       BigArrays.set((Object[][])this.a, i, s.readObject()); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\ReferenceBigArrayBigList.class
