...
/*      */     
/*      */     public K getKey() {
/*  668 */       return Reference2DoubleOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public double getDoubleValue() {
/*  672 */       return Reference2DoubleOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public double setValue(double v) {
/*  676 */       double oldValue = Reference2DoubleOpenCustomHashMap.this.value[this.index];
/*  677 */       Reference2DoubleOpenCustomHashMap.this.value[this.index] = v;
/*  678 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  688 */       return Double.valueOf(Reference2DoubleOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  706 */       return (Reference2DoubleOpenCustomHashMap.this.strategy.equals(Reference2DoubleOpenCustomHashMap.this.key[this.index], e.getKey()) && 
/*  707 */         Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits(((Double)e.getValue()).doubleValue()));
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  711 */       return Reference2DoubleOpenCustomHashMap.this.strategy.hashCode(Reference2DoubleOpenCustomHashMap.this.key[this.index]) ^ HashCommon.double2int(Reference2DoubleOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */     
/*      */     public String toString() {
/*  715 */       return (new StringBuilder()).append(Reference2DoubleOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2DoubleOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  725 */     int pos = Reference2DoubleOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  732 */     int last = -1;
/*      */     
/*  734 */     int c = Reference2DoubleOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  738 */     boolean mustReturnNullKey = Reference2DoubleOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  753 */         return this.last = Reference2DoubleOpenCustomHashMap.this.n;
/*      */       } 
/*  755 */       K[] key = Reference2DoubleOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  757 */         if (--this.pos < 0) {
/*      */           
/*  759 */           this.last = Integer.MIN_VALUE;
/*  760 */           K k = this.wrapped.get(-this.pos - 1);
/*  761 */           int p = HashCommon.mix(Reference2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2DoubleOpenCustomHashMap.this.mask;
/*  762 */           while (!Reference2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  763 */             p = p + 1 & Reference2DoubleOpenCustomHashMap.this.mask; 
/*  764 */           return p;
/*      */         } 
...
/*  781 */       K[] key = Reference2DoubleOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  783 */         pos = (last = pos) + 1 & Reference2DoubleOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  785 */           if ((curr = key[pos]) == null) {
/*  786 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  789 */           int slot = HashCommon.mix(Reference2DoubleOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2DoubleOpenCustomHashMap.this.mask;
/*  790 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  792 */           pos = pos + 1 & Reference2DoubleOpenCustomHashMap.this.mask;
/*      */         } 
/*  794 */         if (pos < last) {
/*  795 */           if (this.wrapped == null)
/*  796 */             this.wrapped = new ReferenceArrayList<>(2); 
/*  797 */           this.wrapped.add(key[pos]);
/*      */         } 
/*  799 */         key[last] = curr;
/*  800 */         Reference2DoubleOpenCustomHashMap.this.value[last] = Reference2DoubleOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  804 */       if (this.last == -1)
/*  805 */         throw new IllegalStateException(); 
/*  806 */       if (this.last == Reference2DoubleOpenCustomHashMap.this.n) {
/*  807 */         Reference2DoubleOpenCustomHashMap.this.containsNullKey = false;
/*  808 */         Reference2DoubleOpenCustomHashMap.this.key[Reference2DoubleOpenCustomHashMap.this.n] = null;
/*  809 */       } else if (this.pos >= 0) {
/*  810 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  813 */         Reference2DoubleOpenCustomHashMap.this.removeDouble(this.wrapped.set(-this.pos - 1, null));
/*  814 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  817 */       Reference2DoubleOpenCustomHashMap.this.size--;
/*  818 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*  833 */       return this.entry = new Reference2DoubleOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  842 */       this.entry = new Reference2DoubleOpenCustomHashMap.MapEntry();
...
/*  852 */       return new Reference2DoubleOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Reference2DoubleMap.Entry<K>> fastIterator() {
/*  856 */       return new Reference2DoubleOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  868 */       if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  869 */         return (Reference2DoubleOpenCustomHashMap.this.containsNullKey && 
/*  870 */           Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(v));
/*      */       }
/*  872 */       K[] key = Reference2DoubleOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  875 */       if ((curr = key[pos = HashCommon.mix(Reference2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2DoubleOpenCustomHashMap.this.mask]) == null)
/*  876 */         return false; 
/*  877 */       if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  878 */         return (Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */       }
/*      */       while (true) {
/*  881 */         if ((curr = key[pos = pos + 1 & Reference2DoubleOpenCustomHashMap.this.mask]) == null)
/*  882 */           return false; 
/*  883 */         if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  884 */           return (Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v));
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  897 */       if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  898 */         if (Reference2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(v)) {
/*  899 */           Reference2DoubleOpenCustomHashMap.this.removeNullEntry();
/*  900 */           return true;
/*      */         } 
/*  902 */         return false;
/*      */       } 
/*      */       
/*  905 */       K[] key = Reference2DoubleOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  908 */       if ((curr = key[pos = HashCommon.mix(Reference2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2DoubleOpenCustomHashMap.this.mask]) == null)
/*  909 */         return false; 
/*  910 */       if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  911 */         if (Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/*  912 */           Reference2DoubleOpenCustomHashMap.this.removeEntry(pos);
/*  913 */           return true;
/*      */         } 
/*  915 */         return false;
/*      */       } 
/*      */       while (true) {
/*  918 */         if ((curr = key[pos = pos + 1 & Reference2DoubleOpenCustomHashMap.this.mask]) == null)
/*  919 */           return false; 
/*  920 */         if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  921 */           Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
/*  922 */           Reference2DoubleOpenCustomHashMap.this.removeEntry(pos);
/*  923 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  930 */       return Reference2DoubleOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  934 */       Reference2DoubleOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Reference2DoubleMap.Entry<K>> consumer) {
/*  939 */       if (Reference2DoubleOpenCustomHashMap.this.containsNullKey)
/*  940 */         consumer.accept(new AbstractReference2DoubleMap.BasicEntry<>(Reference2DoubleOpenCustomHashMap.this.key[Reference2DoubleOpenCustomHashMap.this.n], Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n])); 
/*  941 */       for (int pos = Reference2DoubleOpenCustomHashMap.this.n; pos-- != 0;) {
/*  942 */         if (Reference2DoubleOpenCustomHashMap.this.key[pos] != null)
/*  943 */           consumer.accept(new AbstractReference2DoubleMap.BasicEntry<>(Reference2DoubleOpenCustomHashMap.this.key[pos], Reference2DoubleOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Reference2DoubleMap.Entry<K>> consumer) {
/*  948 */       AbstractReference2DoubleMap.BasicEntry<K> entry = new AbstractReference2DoubleMap.BasicEntry<>();
/*  949 */       if (Reference2DoubleOpenCustomHashMap.this.containsNullKey) {
/*  950 */         entry.key = Reference2DoubleOpenCustomHashMap.this.key[Reference2DoubleOpenCustomHashMap.this.n];
/*  951 */         entry.value = Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n];
/*  952 */         consumer.accept(entry);
/*      */       } 
/*  954 */       for (int pos = Reference2DoubleOpenCustomHashMap.this.n; pos-- != 0;) {
/*  955 */         if (Reference2DoubleOpenCustomHashMap.this.key[pos] != null) {
/*  956 */           entry.key = Reference2DoubleOpenCustomHashMap.this.key[pos];
/*  957 */           entry.value = Reference2DoubleOpenCustomHashMap.this.value[pos];
...
/*      */   {
/*      */     public K next() {
/*  983 */       return Reference2DoubleOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractReferenceSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectIterator<K> iterator() {
/*  989 */       return new Reference2DoubleOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/*  994 */       if (Reference2DoubleOpenCustomHashMap.this.containsNullKey)
/*  995 */         consumer.accept(Reference2DoubleOpenCustomHashMap.this.key[Reference2DoubleOpenCustomHashMap.this.n]); 
/*  996 */       for (int pos = Reference2DoubleOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  997 */         K k = Reference2DoubleOpenCustomHashMap.this.key[pos];
/*  998 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/* 1004 */       return Reference2DoubleOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1008 */       return Reference2DoubleOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1012 */       int oldSize = Reference2DoubleOpenCustomHashMap.this.size;
/* 1013 */       Reference2DoubleOpenCustomHashMap.this.removeDouble(k);
/* 1014 */       return (Reference2DoubleOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1018 */       Reference2DoubleOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1042 */       return Reference2DoubleOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1051 */             return new Reference2DoubleOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1055 */             return Reference2DoubleOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(double v) {
/* 1059 */             return Reference2DoubleOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1063 */             Reference2DoubleOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(DoubleConsumer consumer)
/*      */           {
/* 1068 */             if (Reference2DoubleOpenCustomHashMap.this.containsNullKey)
/* 1069 */               consumer.accept(Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n]); 
/* 1070 */             for (int pos = Reference2DoubleOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1071 */               if (Reference2DoubleOpenCustomHashMap.this.key[pos] != null)
/* 1072 */                 consumer.accept(Reference2DoubleOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */     try {
/* 1175 */       c = (Reference2DoubleOpenCustomHashMap<K>)super.clone();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\Reference2DoubleOpenCustomHashMap.class
