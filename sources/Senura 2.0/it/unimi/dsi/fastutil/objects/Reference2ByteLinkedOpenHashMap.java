...
/* 1794 */     K[] key = this.key;
/* 1795 */     byte[] value = this.value;
/* 1796 */     int mask = newN - 1;
/* 1797 */     K[] newKey = (K[])new Object[newN + 1];
/* 1798 */     byte[] newValue = new byte[newN + 1];
...
/*      */     try {
/* 1852 */       c = (Reference2ByteLinkedOpenHashMap<K>)super.clone();
...
/* 1861 */     c.value = (byte[])this.value.clone();
...
/* 1909 */     byte[] value = this.value = new byte[this.n + 1];
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\Reference2ByteLinkedOpenHashMap.class
