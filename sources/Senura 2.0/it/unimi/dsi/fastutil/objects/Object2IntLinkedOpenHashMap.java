...
/* 1790 */     K[] key = this.key;
/* 1791 */     int[] value = this.value;
/* 1792 */     int mask = newN - 1;
/* 1793 */     K[] newKey = (K[])new Object[newN + 1];
/* 1794 */     int[] newValue = new int[newN + 1];
...
/*      */     try {
/* 1848 */       c = (Object2IntLinkedOpenHashMap<K>)super.clone();
...
/* 1857 */     c.value = (int[])this.value.clone();
...
/* 1905 */     int[] value = this.value = new int[this.n + 1];
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\Object2IntLinkedOpenHashMap.class
