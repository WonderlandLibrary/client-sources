...
/*  320 */     byte oldValue = this.value[this.n];
/*  321 */     this.size--;
...
/*      */     } 
/*  382 */     byte oldValue = this.value[pos];
/*  383 */     this.value[pos] = v;
/*  384 */     return oldValue;
/*      */   }
/*      */   private byte addToValue(int pos, byte incr) {
/*  387 */     byte oldValue = this.value[pos];
/*  388 */     this.value[pos] = (byte)(oldValue + incr);
/*  389 */     return oldValue;
/*      */   }
/*      */ 
/*      */ 
...
/*      */       } 
/*  426 */     }  this.key[pos] = k;
/*  427 */     this.value[pos] = (byte)(this.defRetValue + incr);
/*  428 */     if (this.size == 0) {
...
/*  902 */     byte oldValue = this.value[pos];
...
/*  913 */     byte newValue = SafeMath.safeIntToByte(mappingFunction.applyAsInt(k));
...
/*  925 */     Byte newValue = remappingFunction.apply(k, Byte.valueOf(this.value[pos]));
...
/*  940 */     int pos = find(k);
/*  941 */     Byte newValue = remappingFunction.apply(k, (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*      */     
/*      */     public K getKey() {
/* 1018 */       return Object2ByteLinkedOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public byte getByteValue() {
/* 1022 */       return Object2ByteLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public byte setValue(byte v) {
/* 1026 */       byte oldValue = Object2ByteLinkedOpenCustomHashMap.this.value[this.index];
/* 1027 */       Object2ByteLinkedOpenCustomHashMap.this.value[this.index] = v;
...
/* 1038 */       return Byte.valueOf(Object2ByteLinkedOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     @Deprecated
/*      */     public Byte setValue(Byte v) {
/* 1048 */       return Byte.valueOf(setValue(v.byteValue()));
/*      */     }
/*      */ 
/*      */     
...
/* 1054 */         return false; 
/* 1055 */       Map.Entry<K, Byte> e = (Map.Entry<K, Byte>)o;
/* 1056 */       return (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(Object2ByteLinkedOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2ByteLinkedOpenCustomHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/* 1060 */       return Object2ByteLinkedOpenCustomHashMap.this.strategy.hashCode(Object2ByteLinkedOpenCustomHashMap.this.key[this.index]) ^ Object2ByteLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/* 1064 */       return (new StringBuilder()).append(Object2ByteLinkedOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2ByteLinkedOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1227 */       this.next = Object2ByteLinkedOpenCustomHashMap.this.first;
/* 1228 */       this.index = 0;
/*      */     }
/*      */     private MapIterator(K from) {
/* 1231 */       if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(from, null)) {
/* 1232 */         if (Object2ByteLinkedOpenCustomHashMap.this.containsNullKey) {
/* 1233 */           this.next = (int)Object2ByteLinkedOpenCustomHashMap.this.link[Object2ByteLinkedOpenCustomHashMap.this.n];
/* 1234 */           this.prev = Object2ByteLinkedOpenCustomHashMap.this.n;
/*      */           return;
/*      */         } 
/* 1237 */         throw new NoSuchElementException("The key " + from + " does not belong to this map.");
/*      */       } 
/* 1239 */       if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(Object2ByteLinkedOpenCustomHashMap.this.key[Object2ByteLinkedOpenCustomHashMap.this.last], from)) {
/* 1240 */         this.prev = Object2ByteLinkedOpenCustomHashMap.this.last;
/* 1241 */         this.index = Object2ByteLinkedOpenCustomHashMap.this.size;
/*      */         
/*      */         return;
/*      */       } 
/* 1245 */       int pos = HashCommon.mix(Object2ByteLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2ByteLinkedOpenCustomHashMap.this.mask;
/*      */       
/* 1247 */       while (Object2ByteLinkedOpenCustomHashMap.this.key[pos] != null) {
/* 1248 */         if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(Object2ByteLinkedOpenCustomHashMap.this.key[pos], from)) {
/*      */           
/* 1250 */           this.next = (int)Object2ByteLinkedOpenCustomHashMap.this.link[pos];
/* 1251 */           this.prev = pos;
/*      */           return;
/*      */         } 
/* 1254 */         pos = pos + 1 & Object2ByteLinkedOpenCustomHashMap.this.mask;
/*      */       } 
...
/*      */       } 
/* 1271 */       if (this.next == -1) {
/* 1272 */         this.index = Object2ByteLinkedOpenCustomHashMap.this.size;
/*      */         return;
/*      */       } 
/* 1275 */       int pos = Object2ByteLinkedOpenCustomHashMap.this.first;
/* 1276 */       this.index = 1;
/* 1277 */       while (pos != this.prev) {
/* 1278 */         pos = (int)Object2ByteLinkedOpenCustomHashMap.this.link[pos];
/* 1279 */         this.index++;
/*      */       } 
/*      */     }
...
/* 1294 */       this.next = (int)Object2ByteLinkedOpenCustomHashMap.this.link[this.curr];
...
/* 1304 */       this.prev = (int)(Object2ByteLinkedOpenCustomHashMap.this.link[this.curr] >>> 32L);
...
/*      */         
/* 1319 */         this.index--;
/* 1320 */         this.prev = (int)(Object2ByteLinkedOpenCustomHashMap.this.link[this.curr] >>> 32L);
/*      */       } else {
/* 1322 */         this.next = (int)Object2ByteLinkedOpenCustomHashMap.this.link[this.curr];
/* 1323 */       }  Object2ByteLinkedOpenCustomHashMap.this.size--;
/*      */ 
/*      */ 
/*      */ 
/*      */       
/* 1328 */       if (this.prev == -1) {
/* 1329 */         Object2ByteLinkedOpenCustomHashMap.this.first = this.next;
/*      */       } else {
/* 1331 */         Object2ByteLinkedOpenCustomHashMap.this.link[this.prev] = Object2ByteLinkedOpenCustomHashMap.this.link[this.prev] ^ (Object2ByteLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFFL) & 0xFFFFFFFFL;
/* 1332 */       }  if (this.next == -1) {
/* 1333 */         Object2ByteLinkedOpenCustomHashMap.this.last = this.prev;
/*      */       } else {
/* 1335 */         Object2ByteLinkedOpenCustomHashMap.this.link[this.next] = Object2ByteLinkedOpenCustomHashMap.this.link[this.next] ^ (Object2ByteLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFFL) << 32L) & 0xFFFFFFFF00000000L;
/* 1336 */       }  int pos = this.curr;
/* 1337 */       this.curr = -1;
/* 1338 */       if (pos == Object2ByteLinkedOpenCustomHashMap.this.n) {
/* 1339 */         Object2ByteLinkedOpenCustomHashMap.this.containsNullKey = false;
/* 1340 */         Object2ByteLinkedOpenCustomHashMap.this.key[Object2ByteLinkedOpenCustomHashMap.this.n] = null;
/*      */       } else {
/*      */         
/* 1343 */         K[] key = Object2ByteLinkedOpenCustomHashMap.this.key;
/*      */         while (true) {
/*      */           K curr;
/*      */           int last;
/* 1347 */           pos = (last = pos) + 1 & Object2ByteLinkedOpenCustomHashMap.this.mask;
/*      */           while (true) {
/* 1349 */             if ((curr = key[pos]) == null) {
/* 1350 */               key[last] = null;
/*      */               return;
/*      */             } 
/* 1353 */             int slot = HashCommon.mix(Object2ByteLinkedOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2ByteLinkedOpenCustomHashMap.this.mask;
/* 1354 */             if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */               break; 
/* 1356 */             pos = pos + 1 & Object2ByteLinkedOpenCustomHashMap.this.mask;
/*      */           } 
/* 1358 */           key[last] = curr;
/* 1359 */           Object2ByteLinkedOpenCustomHashMap.this.value[last] = Object2ByteLinkedOpenCustomHashMap.this.value[pos];
/* 1360 */           if (this.next == pos)
/* 1361 */             this.next = last; 
/* 1362 */           if (this.prev == pos)
/* 1363 */             this.prev = last; 
/* 1364 */           Object2ByteLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*      */         } 
/*      */       } 
/*      */     }
...
/* 1396 */       return this.entry = new Object2ByteLinkedOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
/*      */     
/*      */     public Object2ByteLinkedOpenCustomHashMap<K>.MapEntry previous() {
/* 1400 */       return this.entry = new Object2ByteLinkedOpenCustomHashMap.MapEntry(previousEntry());
/*      */     }
/*      */     
/*      */     public void remove() {
/* 1404 */       super.remove();
...
/*      */ 
/*      */   
/* 1409 */   private class FastEntryIterator extends MapIterator implements ObjectListIterator<Object2ByteMap.Entry<K>> { final Object2ByteLinkedOpenCustomHashMap<K>.MapEntry entry = new Object2ByteLinkedOpenCustomHashMap.MapEntry();
/*      */ 
/*      */     
...
/* 1431 */       return new Object2ByteLinkedOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
...
/* 1452 */       if (Object2ByteLinkedOpenCustomHashMap.this.size == 0)
/* 1453 */         throw new NoSuchElementException(); 
/* 1454 */       return new Object2ByteLinkedOpenCustomHashMap.MapEntry(Object2ByteLinkedOpenCustomHashMap.this.first);
/*      */     }
/*      */     
/*      */     public Object2ByteMap.Entry<K> last() {
/* 1458 */       if (Object2ByteLinkedOpenCustomHashMap.this.size == 0)
/* 1459 */         throw new NoSuchElementException(); 
/* 1460 */       return new Object2ByteLinkedOpenCustomHashMap.MapEntry(Object2ByteLinkedOpenCustomHashMap.this.last);
/*      */     }
/*      */ 
/*      */     
...
/* 1468 */       if (e.getValue() == null || !(e.getValue() instanceof Byte))
/* 1469 */         return false; 
/* 1470 */       K k = (K)e.getKey();
/* 1471 */       byte v = ((Byte)e.getValue()).byteValue();
/* 1472 */       if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
/* 1473 */         return (Object2ByteLinkedOpenCustomHashMap.this.containsNullKey && Object2ByteLinkedOpenCustomHashMap.this.value[Object2ByteLinkedOpenCustomHashMap.this.n] == v);
/*      */       }
/* 1475 */       K[] key = Object2ByteLinkedOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1478 */       if ((curr = key[pos = HashCommon.mix(Object2ByteLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ByteLinkedOpenCustomHashMap.this.mask]) == null)
/* 1479 */         return false; 
/* 1480 */       if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(k, curr)) {
/* 1481 */         return (Object2ByteLinkedOpenCustomHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/* 1484 */         if ((curr = key[pos = pos + 1 & Object2ByteLinkedOpenCustomHashMap.this.mask]) == null)
/* 1485 */           return false; 
/* 1486 */         if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(k, curr)) {
/* 1487 */           return (Object2ByteLinkedOpenCustomHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/* 1496 */       if (e.getValue() == null || !(e.getValue() instanceof Byte))
/* 1497 */         return false; 
/* 1498 */       K k = (K)e.getKey();
/* 1499 */       byte v = ((Byte)e.getValue()).byteValue();
/* 1500 */       if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
/* 1501 */         if (Object2ByteLinkedOpenCustomHashMap.this.containsNullKey && Object2ByteLinkedOpenCustomHashMap.this.value[Object2ByteLinkedOpenCustomHashMap.this.n] == v) {
/* 1502 */           Object2ByteLinkedOpenCustomHashMap.this.removeNullEntry();
/* 1503 */           return true;
/*      */         } 
/* 1505 */         return false;
/*      */       } 
/*      */       
/* 1508 */       K[] key = Object2ByteLinkedOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/* 1511 */       if ((curr = key[pos = HashCommon.mix(Object2ByteLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ByteLinkedOpenCustomHashMap.this.mask]) == null)
/* 1512 */         return false; 
/* 1513 */       if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(curr, k)) {
/* 1514 */         if (Object2ByteLinkedOpenCustomHashMap.this.value[pos] == v) {
/* 1515 */           Object2ByteLinkedOpenCustomHashMap.this.removeEntry(pos);
/* 1516 */           return true;
/*      */         } 
/* 1518 */         return false;
/*      */       } 
/*      */       while (true) {
/* 1521 */         if ((curr = key[pos = pos + 1 & Object2ByteLinkedOpenCustomHashMap.this.mask]) == null)
/* 1522 */           return false; 
/* 1523 */         if (Object2ByteLinkedOpenCustomHashMap.this.strategy.equals(curr, k) && 
/* 1524 */           Object2ByteLinkedOpenCustomHashMap.this.value[pos] == v) {
/* 1525 */           Object2ByteLinkedOpenCustomHashMap.this.removeEntry(pos);
/* 1526 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/* 1533 */       return Object2ByteLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1537 */       Object2ByteLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1552 */       return new Object2ByteLinkedOpenCustomHashMap.EntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1563 */       return new Object2ByteLinkedOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1578 */       return new Object2ByteLinkedOpenCustomHashMap.FastEntryIterator(from.getKey());
/*      */     }
/*      */ 
/*      */     
...
/* 1586 */         consumer.accept(new AbstractObject2ByteMap.BasicEntry<>(Object2ByteLinkedOpenCustomHashMap.this.key[curr], Object2ByteLinkedOpenCustomHashMap.this.value[curr]));
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2ByteMap.Entry<K>> consumer) {
/* 1592 */       AbstractObject2ByteMap.BasicEntry<K> entry = new AbstractObject2ByteMap.BasicEntry<>();
/* 1593 */       for (int i = Object2ByteLinkedOpenCustomHashMap.this.size, next = Object2ByteLinkedOpenCustomHashMap.this.first; i-- != 0; ) {
/* 1594 */         int curr = next;
/* 1595 */         next = (int)Object2ByteLinkedOpenCustomHashMap.this.link[curr];
/* 1596 */         entry.key = Object2ByteLinkedOpenCustomHashMap.this.key[curr];
/* 1597 */         entry.value = Object2ByteLinkedOpenCustomHashMap.this.value[curr];
...
/*      */     
/*      */     public K next() {
/* 1630 */       return Object2ByteLinkedOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractObjectSortedSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectListIterator<K> iterator(K from) {
/* 1636 */       return new Object2ByteLinkedOpenCustomHashMap.KeyIterator(from);
/*      */     }
/*      */     
/*      */     public ObjectListIterator<K> iterator() {
/* 1640 */       return new Object2ByteLinkedOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/* 1645 */       if (Object2ByteLinkedOpenCustomHashMap.this.containsNullKey)
/* 1646 */         consumer.accept(Object2ByteLinkedOpenCustomHashMap.this.key[Object2ByteLinkedOpenCustomHashMap.this.n]); 
/* 1647 */       for (int pos = Object2ByteLinkedOpenCustomHashMap.this.n; pos-- != 0; ) {
/* 1648 */         K k = Object2ByteLinkedOpenCustomHashMap.this.key[pos];
/* 1649 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/* 1655 */       return Object2ByteLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1659 */       return Object2ByteLinkedOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1663 */       int oldSize = Object2ByteLinkedOpenCustomHashMap.this.size;
/* 1664 */       Object2ByteLinkedOpenCustomHashMap.this.removeByte(k);
/* 1665 */       return (Object2ByteLinkedOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1669 */       Object2ByteLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */     
/*      */     public K first() {
/* 1673 */       if (Object2ByteLinkedOpenCustomHashMap.this.size == 0)
/* 1674 */         throw new NoSuchElementException(); 
/* 1675 */       return Object2ByteLinkedOpenCustomHashMap.this.key[Object2ByteLinkedOpenCustomHashMap.this.first];
/*      */     }
/*      */     
/*      */     public K last() {
/* 1679 */       if (Object2ByteLinkedOpenCustomHashMap.this.size == 0)
/* 1680 */         throw new NoSuchElementException(); 
/* 1681 */       return Object2ByteLinkedOpenCustomHashMap.this.key[Object2ByteLinkedOpenCustomHashMap.this.last];
/*      */     }
/*      */     
/*      */     public Comparator<? super K> comparator() {
/* 1685 */       return null;
...
/* 1718 */       return Object2ByteLinkedOpenCustomHashMap.this.value[previousEntry()];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1725 */       return Object2ByteLinkedOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public ByteCollection values() {
/* 1730 */     if (this.values == null)
/* 1731 */       this.values = (ByteCollection)new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1734 */             return (ByteIterator)new Object2ByteLinkedOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1738 */             return Object2ByteLinkedOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(byte v) {
/* 1742 */             return Object2ByteLinkedOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1746 */             Object2ByteLinkedOpenCustomHashMap.this.clear();
/*      */           }
/*      */ 
/*      */           
/*      */           public void forEach(IntConsumer consumer) {
/* 1751 */             if (Object2ByteLinkedOpenCustomHashMap.this.containsNullKey)
/* 1752 */               consumer.accept(Object2ByteLinkedOpenCustomHashMap.this.value[Object2ByteLinkedOpenCustomHashMap.this.n]); 
/* 1753 */             for (int pos = Object2ByteLinkedOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1754 */               if (Object2ByteLinkedOpenCustomHashMap.this.key[pos] != null)
/* 1755 */                 consumer.accept(Object2ByteLinkedOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1823 */     K[] key = this.key;
/* 1824 */     byte[] value = this.value;
/* 1825 */     int mask = newN - 1;
/* 1826 */     K[] newKey = (K[])new Object[newN + 1];
/* 1827 */     byte[] newValue = new byte[newN + 1];
...
/*      */     try {
/* 1881 */       c = (Object2ByteLinkedOpenCustomHashMap<K>)super.clone();
...
/* 1890 */     c.value = (byte[])this.value.clone();
...
/* 1939 */     byte[] value = this.value = new byte[this.n + 1];
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\Object2ByteLinkedOpenCustomHashMap.class
