...
/* 1790 */     K[] key = this.key;
/* 1791 */     short[] value = this.value;
/* 1792 */     int mask = newN - 1;
/* 1793 */     K[] newKey = (K[])new Object[newN + 1];
/* 1794 */     short[] newValue = new short[newN + 1];
...
/*      */     try {
/* 1848 */       c = (Object2ShortLinkedOpenHashMap<K>)super.clone();
...
/* 1857 */     c.value = (short[])this.value.clone();
...
/* 1905 */     short[] value = this.value = new short[this.n + 1];
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\Object2ShortLinkedOpenHashMap.class
