...
/*      */     
/*      */     public K getKey() {
/*  666 */       return Object2ShortOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public short getShortValue() {
/*  670 */       return Object2ShortOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public short setValue(short v) {
/*  674 */       short oldValue = Object2ShortOpenCustomHashMap.this.value[this.index];
/*  675 */       Object2ShortOpenCustomHashMap.this.value[this.index] = v;
/*  676 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  686 */       return Short.valueOf(Object2ShortOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  704 */       return (Object2ShortOpenCustomHashMap.this.strategy.equals(Object2ShortOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2ShortOpenCustomHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  708 */       return Object2ShortOpenCustomHashMap.this.strategy.hashCode(Object2ShortOpenCustomHashMap.this.key[this.index]) ^ Object2ShortOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/*  712 */       return (new StringBuilder()).append(Object2ShortOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2ShortOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  722 */     int pos = Object2ShortOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  729 */     int last = -1;
/*      */     
/*  731 */     int c = Object2ShortOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  735 */     boolean mustReturnNullKey = Object2ShortOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  750 */         return this.last = Object2ShortOpenCustomHashMap.this.n;
/*      */       } 
/*  752 */       K[] key = Object2ShortOpenCustomHashMap.this.key;
/*      */       while (true) {
/*  754 */         if (--this.pos < 0) {
/*      */           
/*  756 */           this.last = Integer.MIN_VALUE;
/*  757 */           K k = this.wrapped.get(-this.pos - 1);
/*  758 */           int p = HashCommon.mix(Object2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ShortOpenCustomHashMap.this.mask;
/*  759 */           while (!Object2ShortOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  760 */             p = p + 1 & Object2ShortOpenCustomHashMap.this.mask; 
/*  761 */           return p;
/*      */         } 
...
/*  778 */       K[] key = Object2ShortOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  780 */         pos = (last = pos) + 1 & Object2ShortOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  782 */           if ((curr = key[pos]) == null) {
/*  783 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  786 */           int slot = HashCommon.mix(Object2ShortOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2ShortOpenCustomHashMap.this.mask;
/*  787 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  789 */           pos = pos + 1 & Object2ShortOpenCustomHashMap.this.mask;
/*      */         } 
/*  791 */         if (pos < last) {
...
/*      */         } 
/*  796 */         key[last] = curr;
/*  797 */         Object2ShortOpenCustomHashMap.this.value[last] = Object2ShortOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  801 */       if (this.last == -1)
/*  802 */         throw new IllegalStateException(); 
/*  803 */       if (this.last == Object2ShortOpenCustomHashMap.this.n) {
/*  804 */         Object2ShortOpenCustomHashMap.this.containsNullKey = false;
/*  805 */         Object2ShortOpenCustomHashMap.this.key[Object2ShortOpenCustomHashMap.this.n] = null;
/*  806 */       } else if (this.pos >= 0) {
/*  807 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  810 */         Object2ShortOpenCustomHashMap.this.removeShort(this.wrapped.set(-this.pos - 1, null));
/*  811 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  814 */       Object2ShortOpenCustomHashMap.this.size--;
/*  815 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*  830 */       return this.entry = new Object2ShortOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  839 */       this.entry = new Object2ShortOpenCustomHashMap.MapEntry();
...
/*  849 */       return new Object2ShortOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Object2ShortMap.Entry<K>> fastIterator() {
/*  853 */       return new Object2ShortOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  865 */       if (Object2ShortOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  866 */         return (Object2ShortOpenCustomHashMap.this.containsNullKey && Object2ShortOpenCustomHashMap.this.value[Object2ShortOpenCustomHashMap.this.n] == v);
/*      */       }
/*  868 */       K[] key = Object2ShortOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  871 */       if ((curr = key[pos = HashCommon.mix(Object2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ShortOpenCustomHashMap.this.mask]) == null)
/*  872 */         return false; 
/*  873 */       if (Object2ShortOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  874 */         return (Object2ShortOpenCustomHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  877 */         if ((curr = key[pos = pos + 1 & Object2ShortOpenCustomHashMap.this.mask]) == null)
/*  878 */           return false; 
/*  879 */         if (Object2ShortOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  880 */           return (Object2ShortOpenCustomHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  893 */       if (Object2ShortOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  894 */         if (Object2ShortOpenCustomHashMap.this.containsNullKey && Object2ShortOpenCustomHashMap.this.value[Object2ShortOpenCustomHashMap.this.n] == v) {
/*  895 */           Object2ShortOpenCustomHashMap.this.removeNullEntry();
/*  896 */           return true;
/*      */         } 
/*  898 */         return false;
/*      */       } 
/*      */       
/*  901 */       K[] key = Object2ShortOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  904 */       if ((curr = key[pos = HashCommon.mix(Object2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ShortOpenCustomHashMap.this.mask]) == null)
/*  905 */         return false; 
/*  906 */       if (Object2ShortOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  907 */         if (Object2ShortOpenCustomHashMap.this.value[pos] == v) {
/*  908 */           Object2ShortOpenCustomHashMap.this.removeEntry(pos);
/*  909 */           return true;
/*      */         } 
/*  911 */         return false;
/*      */       } 
/*      */       while (true) {
/*  914 */         if ((curr = key[pos = pos + 1 & Object2ShortOpenCustomHashMap.this.mask]) == null)
/*  915 */           return false; 
/*  916 */         if (Object2ShortOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  917 */           Object2ShortOpenCustomHashMap.this.value[pos] == v) {
/*  918 */           Object2ShortOpenCustomHashMap.this.removeEntry(pos);
/*  919 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  926 */       return Object2ShortOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  930 */       Object2ShortOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2ShortMap.Entry<K>> consumer) {
/*  935 */       if (Object2ShortOpenCustomHashMap.this.containsNullKey)
/*  936 */         consumer.accept(new AbstractObject2ShortMap.BasicEntry<>(Object2ShortOpenCustomHashMap.this.key[Object2ShortOpenCustomHashMap.this.n], Object2ShortOpenCustomHashMap.this.value[Object2ShortOpenCustomHashMap.this.n])); 
/*  937 */       for (int pos = Object2ShortOpenCustomHashMap.this.n; pos-- != 0;) {
/*  938 */         if (Object2ShortOpenCustomHashMap.this.key[pos] != null)
/*  939 */           consumer.accept(new AbstractObject2ShortMap.BasicEntry<>(Object2ShortOpenCustomHashMap.this.key[pos], Object2ShortOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2ShortMap.Entry<K>> consumer) {
/*  944 */       AbstractObject2ShortMap.BasicEntry<K> entry = new AbstractObject2ShortMap.BasicEntry<>();
/*  945 */       if (Object2ShortOpenCustomHashMap.this.containsNullKey) {
/*  946 */         entry.key = Object2ShortOpenCustomHashMap.this.key[Object2ShortOpenCustomHashMap.this.n];
/*  947 */         entry.value = Object2ShortOpenCustomHashMap.this.value[Object2ShortOpenCustomHashMap.this.n];
/*  948 */         consumer.accept(entry);
/*      */       } 
/*  950 */       for (int pos = Object2ShortOpenCustomHashMap.this.n; pos-- != 0;) {
/*  951 */         if (Object2ShortOpenCustomHashMap.this.key[pos] != null) {
/*  952 */           entry.key = Object2ShortOpenCustomHashMap.this.key[pos];
/*  953 */           entry.value = Object2ShortOpenCustomHashMap.this.value[pos];
...
/*      */   {
/*      */     public K next() {
/*  979 */       return Object2ShortOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractObjectSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectIterator<K> iterator() {
/*  985 */       return new Object2ShortOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/*  990 */       if (Object2ShortOpenCustomHashMap.this.containsNullKey)
/*  991 */         consumer.accept(Object2ShortOpenCustomHashMap.this.key[Object2ShortOpenCustomHashMap.this.n]); 
/*  992 */       for (int pos = Object2ShortOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  993 */         K k = Object2ShortOpenCustomHashMap.this.key[pos];
/*  994 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/* 1000 */       return Object2ShortOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1004 */       return Object2ShortOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1008 */       int oldSize = Object2ShortOpenCustomHashMap.this.size;
/* 1009 */       Object2ShortOpenCustomHashMap.this.removeShort(k);
/* 1010 */       return (Object2ShortOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1014 */       Object2ShortOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1038 */       return Object2ShortOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
...
/* 1047 */             return new Object2ShortOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1051 */             return Object2ShortOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(short v) {
/* 1055 */             return Object2ShortOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1059 */             Object2ShortOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1064 */             if (Object2ShortOpenCustomHashMap.this.containsNullKey)
/* 1065 */               consumer.accept(Object2ShortOpenCustomHashMap.this.value[Object2ShortOpenCustomHashMap.this.n]); 
/* 1066 */             for (int pos = Object2ShortOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1067 */               if (Object2ShortOpenCustomHashMap.this.key[pos] != null)
/* 1068 */                 consumer.accept(Object2ShortOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/*      */     try {
/* 1171 */       c = (Object2ShortOpenCustomHashMap<K>)super.clone();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\Object2ShortOpenCustomHashMap.class
