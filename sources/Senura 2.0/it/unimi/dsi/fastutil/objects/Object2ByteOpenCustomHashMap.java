...
/*  265 */     byte oldValue = this.value[this.n];
/*  266 */     this.size--;
...
/*      */     } 
/*  317 */     byte oldValue = this.value[pos];
/*  318 */     this.value[pos] = v;
/*  319 */     return oldValue;
/*      */   }
/*      */   private byte addToValue(int pos, byte incr) {
/*  322 */     byte oldValue = this.value[pos];
/*  323 */     this.value[pos] = (byte)(oldValue + incr);
/*  324 */     return oldValue;
/*      */   }
/*      */ 
/*      */ 
...
/*      */       } 
/*  361 */     }  this.key[pos] = k;
/*  362 */     this.value[pos] = (byte)(this.defRetValue + incr);
...
/*  549 */     byte oldValue = this.value[pos];
...
/*  560 */     byte newValue = SafeMath.safeIntToByte(mappingFunction.applyAsInt(k));
...
/*  572 */     Byte newValue = remappingFunction.apply(k, Byte.valueOf(this.value[pos]));
...
/*      */     } 
/*  580 */     this.value[pos] = newValue.byteValue(); return newValue.byteValue();
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  587 */     int pos = find(k);
/*  588 */     Byte newValue = remappingFunction.apply(k, (pos >= 0) ? Byte.valueOf(this.value[pos]) : null);
...
/*      */     } 
/*  598 */     byte newVal = newValue.byteValue();
/*  599 */     if (pos < 0) {
...
/*  613 */       return v;
/*      */     } 
/*  615 */     Byte newValue = remappingFunction.apply(Byte.valueOf(this.value[pos]), Byte.valueOf(v));
...
/*      */     } 
/*  623 */     this.value[pos] = newValue.byteValue(); return newValue.byteValue();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public K getKey() {
/*  664 */       return Object2ByteOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     
/*      */     public byte getByteValue() {
/*  668 */       return Object2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public byte setValue(byte v) {
/*  672 */       byte oldValue = Object2ByteOpenCustomHashMap.this.value[this.index];
/*  673 */       Object2ByteOpenCustomHashMap.this.value[this.index] = v;
/*  674 */       return oldValue;
/*      */     }
/*      */ 
/*      */ 
...
/*  684 */       return Byte.valueOf(Object2ByteOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  700 */         return false; 
/*  701 */       Map.Entry<K, Byte> e = (Map.Entry<K, Byte>)o;
/*  702 */       return (Object2ByteOpenCustomHashMap.this.strategy.equals(Object2ByteOpenCustomHashMap.this.key[this.index], e.getKey()) && Object2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  706 */       return Object2ByteOpenCustomHashMap.this.strategy.hashCode(Object2ByteOpenCustomHashMap.this.key[this.index]) ^ Object2ByteOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     
/*      */     public String toString() {
/*  710 */       return (new StringBuilder()).append(Object2ByteOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2ByteOpenCustomHashMap.this.value[this.index]).toString();
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   {
/*  720 */     int pos = Object2ByteOpenCustomHashMap.this.n;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  727 */     int last = -1;
/*      */     
/*  729 */     int c = Object2ByteOpenCustomHashMap.this.size;
/*      */ 
/*      */ 
/*      */     
/*  733 */     boolean mustReturnNullKey = Object2ByteOpenCustomHashMap.this.containsNullKey;
/*      */ 
/*      */     
...
/*  748 */         return this.last = Object2ByteOpenCustomHashMap.this.n;
/*      */       } 
...
/*  757 */           while (!Object2ByteOpenCustomHashMap.this.strategy.equals(k, key[p]))
/*  758 */             p = p + 1 & Object2ByteOpenCustomHashMap.this.mask; 
/*  759 */           return p;
/*      */         } 
...
/*  776 */       K[] key = Object2ByteOpenCustomHashMap.this.key; while (true) {
/*      */         K curr; int last;
/*  778 */         pos = (last = pos) + 1 & Object2ByteOpenCustomHashMap.this.mask;
/*      */         while (true) {
/*  780 */           if ((curr = key[pos]) == null) {
/*  781 */             key[last] = null;
/*      */             return;
/*      */           } 
/*  784 */           int slot = HashCommon.mix(Object2ByteOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2ByteOpenCustomHashMap.this.mask;
/*  785 */           if ((last <= pos) ? (last >= slot || slot > pos) : (last >= slot && slot > pos))
/*      */             break; 
/*  787 */           pos = pos + 1 & Object2ByteOpenCustomHashMap.this.mask;
/*      */         } 
/*  789 */         if (pos < last) {
...
/*      */         } 
/*  794 */         key[last] = curr;
/*  795 */         Object2ByteOpenCustomHashMap.this.value[last] = Object2ByteOpenCustomHashMap.this.value[pos];
/*      */       } 
/*      */     }
/*      */     public void remove() {
/*  799 */       if (this.last == -1)
/*  800 */         throw new IllegalStateException(); 
/*  801 */       if (this.last == Object2ByteOpenCustomHashMap.this.n) {
/*  802 */         Object2ByteOpenCustomHashMap.this.containsNullKey = false;
/*  803 */         Object2ByteOpenCustomHashMap.this.key[Object2ByteOpenCustomHashMap.this.n] = null;
/*  804 */       } else if (this.pos >= 0) {
/*  805 */         shiftKeys(this.last);
/*      */       } else {
/*      */         
/*  808 */         Object2ByteOpenCustomHashMap.this.removeByte(this.wrapped.set(-this.pos - 1, null));
/*  809 */         this.last = -1;
/*      */         return;
/*      */       } 
/*  812 */       Object2ByteOpenCustomHashMap.this.size--;
/*  813 */       this.last = -1;
/*      */     }
/*      */ 
/*      */     
...
/*  828 */       return this.entry = new Object2ByteOpenCustomHashMap.MapEntry(nextEntry());
/*      */     }
...
/*  837 */       this.entry = new Object2ByteOpenCustomHashMap.MapEntry();
...
/*  847 */       return new Object2ByteOpenCustomHashMap.EntryIterator();
/*      */     }
/*      */     
/*      */     public ObjectIterator<Object2ByteMap.Entry<K>> fastIterator() {
/*  851 */       return new Object2ByteOpenCustomHashMap.FastEntryIterator();
/*      */     }
/*      */ 
/*      */     
...
/*  859 */       if (e.getValue() == null || !(e.getValue() instanceof Byte))
/*  860 */         return false; 
/*  861 */       K k = (K)e.getKey();
/*  862 */       byte v = ((Byte)e.getValue()).byteValue();
/*  863 */       if (Object2ByteOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  864 */         return (Object2ByteOpenCustomHashMap.this.containsNullKey && Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n] == v);
/*      */       }
/*  866 */       K[] key = Object2ByteOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  869 */       if ((curr = key[pos = HashCommon.mix(Object2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ByteOpenCustomHashMap.this.mask]) == null)
/*  870 */         return false; 
/*  871 */       if (Object2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  872 */         return (Object2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */       }
/*      */       while (true) {
/*  875 */         if ((curr = key[pos = pos + 1 & Object2ByteOpenCustomHashMap.this.mask]) == null)
/*  876 */           return false; 
/*  877 */         if (Object2ByteOpenCustomHashMap.this.strategy.equals(k, curr)) {
/*  878 */           return (Object2ByteOpenCustomHashMap.this.value[pos] == v);
/*      */         }
/*      */       } 
/*      */     }
/*      */     
...
/*  891 */       if (Object2ByteOpenCustomHashMap.this.strategy.equals(k, null)) {
/*  892 */         if (Object2ByteOpenCustomHashMap.this.containsNullKey && Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n] == v) {
/*  893 */           Object2ByteOpenCustomHashMap.this.removeNullEntry();
/*  894 */           return true;
/*      */         } 
/*  896 */         return false;
/*      */       } 
/*      */       
/*  899 */       K[] key = Object2ByteOpenCustomHashMap.this.key;
/*      */       K curr;
/*      */       int pos;
/*  902 */       if ((curr = key[pos = HashCommon.mix(Object2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ByteOpenCustomHashMap.this.mask]) == null)
/*  903 */         return false; 
/*  904 */       if (Object2ByteOpenCustomHashMap.this.strategy.equals(curr, k)) {
/*  905 */         if (Object2ByteOpenCustomHashMap.this.value[pos] == v) {
/*  906 */           Object2ByteOpenCustomHashMap.this.removeEntry(pos);
/*  907 */           return true;
/*      */         } 
/*  909 */         return false;
/*      */       } 
/*      */       while (true) {
/*  912 */         if ((curr = key[pos = pos + 1 & Object2ByteOpenCustomHashMap.this.mask]) == null)
/*  913 */           return false; 
/*  914 */         if (Object2ByteOpenCustomHashMap.this.strategy.equals(curr, k) && 
/*  915 */           Object2ByteOpenCustomHashMap.this.value[pos] == v) {
/*  916 */           Object2ByteOpenCustomHashMap.this.removeEntry(pos);
/*  917 */           return true;
/*      */         } 
/*      */       } 
/*      */     }
...
/*      */     
/*      */     public int size() {
/*  924 */       return Object2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public void clear() {
/*  928 */       Object2ByteOpenCustomHashMap.this.clear();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super Object2ByteMap.Entry<K>> consumer) {
/*  933 */       if (Object2ByteOpenCustomHashMap.this.containsNullKey)
/*  934 */         consumer.accept(new AbstractObject2ByteMap.BasicEntry<>(Object2ByteOpenCustomHashMap.this.key[Object2ByteOpenCustomHashMap.this.n], Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n])); 
/*  935 */       for (int pos = Object2ByteOpenCustomHashMap.this.n; pos-- != 0;) {
/*  936 */         if (Object2ByteOpenCustomHashMap.this.key[pos] != null)
/*  937 */           consumer.accept(new AbstractObject2ByteMap.BasicEntry<>(Object2ByteOpenCustomHashMap.this.key[pos], Object2ByteOpenCustomHashMap.this.value[pos])); 
/*      */       } 
/*      */     }
/*      */     
/*      */     public void fastForEach(Consumer<? super Object2ByteMap.Entry<K>> consumer) {
/*  942 */       AbstractObject2ByteMap.BasicEntry<K> entry = new AbstractObject2ByteMap.BasicEntry<>();
/*  943 */       if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
/*  944 */         entry.key = Object2ByteOpenCustomHashMap.this.key[Object2ByteOpenCustomHashMap.this.n];
/*  945 */         entry.value = Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n];
/*  946 */         consumer.accept(entry);
/*      */       } 
/*  948 */       for (int pos = Object2ByteOpenCustomHashMap.this.n; pos-- != 0;) {
/*  949 */         if (Object2ByteOpenCustomHashMap.this.key[pos] != null) {
/*  950 */           entry.key = Object2ByteOpenCustomHashMap.this.key[pos];
/*  951 */           entry.value = Object2ByteOpenCustomHashMap.this.value[pos];
...
/*      */   {
/*      */     public K next() {
/*  977 */       return Object2ByteOpenCustomHashMap.this.key[nextEntry()];
/*      */     } }
/*      */   
/*      */   private final class KeySet extends AbstractObjectSet<K> { private KeySet() {}
/*      */     
/*      */     public ObjectIterator<K> iterator() {
/*  983 */       return new Object2ByteOpenCustomHashMap.KeyIterator();
/*      */     }
/*      */ 
/*      */     
/*      */     public void forEach(Consumer<? super K> consumer) {
/*  988 */       if (Object2ByteOpenCustomHashMap.this.containsNullKey)
/*  989 */         consumer.accept(Object2ByteOpenCustomHashMap.this.key[Object2ByteOpenCustomHashMap.this.n]); 
/*  990 */       for (int pos = Object2ByteOpenCustomHashMap.this.n; pos-- != 0; ) {
/*  991 */         K k = Object2ByteOpenCustomHashMap.this.key[pos];
/*  992 */         if (k != null)
...
/*      */     
/*      */     public int size() {
/*  998 */       return Object2ByteOpenCustomHashMap.this.size;
/*      */     }
/*      */     
/*      */     public boolean contains(Object k) {
/* 1002 */       return Object2ByteOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     
/*      */     public boolean remove(Object k) {
/* 1006 */       int oldSize = Object2ByteOpenCustomHashMap.this.size;
/* 1007 */       Object2ByteOpenCustomHashMap.this.removeByte(k);
/* 1008 */       return (Object2ByteOpenCustomHashMap.this.size != oldSize);
/*      */     }
/*      */     
/*      */     public void clear() {
/* 1012 */       Object2ByteOpenCustomHashMap.this.clear();
/*      */     } }
/*      */ 
/*      */   
...
/* 1036 */       return Object2ByteOpenCustomHashMap.this.value[nextEntry()];
/*      */     }
/*      */   }
/*      */   
/*      */   public ByteCollection values() {
/* 1041 */     if (this.values == null)
/* 1042 */       this.values = (ByteCollection)new AbstractByteCollection()
/*      */         {
/*      */           public ByteIterator iterator() {
/* 1045 */             return new Object2ByteOpenCustomHashMap.ValueIterator();
/*      */           }
/*      */           
/*      */           public int size() {
/* 1049 */             return Object2ByteOpenCustomHashMap.this.size;
/*      */           }
/*      */           
/*      */           public boolean contains(byte v) {
/* 1053 */             return Object2ByteOpenCustomHashMap.this.containsValue(v);
/*      */           }
/*      */           
/*      */           public void clear() {
/* 1057 */             Object2ByteOpenCustomHashMap.this.clear();
/*      */           }
/*      */           
/*      */           public void forEach(IntConsumer consumer)
/*      */           {
/* 1062 */             if (Object2ByteOpenCustomHashMap.this.containsNullKey)
/* 1063 */               consumer.accept(Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n]); 
/* 1064 */             for (int pos = Object2ByteOpenCustomHashMap.this.n; pos-- != 0;) {
/* 1065 */               if (Object2ByteOpenCustomHashMap.this.key[pos] != null)
/* 1066 */                 consumer.accept(Object2ByteOpenCustomHashMap.this.value[pos]); 
/*      */             }  }
/*      */         }; 
...
/* 1134 */     K[] key = this.key;
/* 1135 */     byte[] value = this.value;
/* 1136 */     int mask = newN - 1;
/* 1137 */     K[] newKey = (K[])new Object[newN + 1];
/* 1138 */     byte[] newValue = new byte[newN + 1];
/* 1139 */     int i = this.n;
...
/*      */     try {
/* 1169 */       c = (Object2ByteOpenCustomHashMap<K>)super.clone();
...
/* 1178 */     c.value = (byte[])this.value.clone();
...
/* 1226 */     byte[] value = this.value = new byte[this.n + 1];
/*      */ 
/*      */     
/* 1229 */     for (int i = this.size; i-- != 0; ) {
/* 1230 */       int pos; K k = (K)s.readObject();
/* 1231 */       byte v = s.readByte();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\Object2ByteOpenCustomHashMap.class
