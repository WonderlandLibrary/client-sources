...
/* 1103 */     K[] key = this.key;
/* 1104 */     short[] value = this.value;
/* 1105 */     int mask = newN - 1;
/* 1106 */     K[] newKey = (K[])new Object[newN + 1];
/* 1107 */     short[] newValue = new short[newN + 1];
/* 1108 */     int i = this.n;
...
/*      */     try {
/* 1139 */       c = (Reference2ShortOpenHashMap<K>)super.clone();
...
/* 1148 */     c.value = (short[])this.value.clone();
/* 1149 */     return c;
/*      */   }
/*      */ 
/*      */ 
...
/* 1195 */     short[] value = this.value = new short[this.n + 1];
/*      */ 
/*      */     
/* 1198 */     for (int i = this.size; i-- != 0; ) {
/* 1199 */       int pos; K k = (K)s.readObject();
/* 1200 */       short v = s.readShort();
/* 1201 */       if (k == null) {
/* 1202 */         pos = this.n;
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\objects\Reference2ShortOpenHashMap.class
