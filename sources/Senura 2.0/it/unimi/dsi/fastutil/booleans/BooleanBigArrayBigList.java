...
/* 280 */       if (k == BigArrays.get(this.a, i))
/* 281 */         return i; 
/* 282 */     }  return -1L;
/*     */   }
/*     */   
...
/* 287 */       if (k == BigArrays.get(this.a, i))
/* 288 */         return i; 
/* 289 */     }  return -1L;
/*     */   }
/*     */   
...
/*     */     }
/* 296 */     boolean old = BigArrays.get(this.a, index);
/* 297 */     this.size--;
...
/*     */     }
/* 317 */     boolean old = BigArrays.get(this.a, index);
...
/* 381 */       BigArrays.fill(this.a, this.size, size, false); 
/* 382 */     this.size = size;
/*     */   }
/*     */   
...
/* 490 */           return BigArrays.get(BooleanBigArrayBigList.this.a, this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public boolean previousBoolean() {
/* 494 */           if (!hasPrevious())
/* 495 */             throw new NoSuchElementException(); 
/* 496 */           return BigArrays.get(BooleanBigArrayBigList.this.a, this.last = --this.pos);
/*     */         }
/*     */         
...
/* 583 */       boolean e1 = BigArrays.get(a1, i);
/* 584 */       boolean e2 = BigArrays.get(a2, i); int r;
...
/* 593 */       s.writeBoolean(BigArrays.get(this.a, i)); 
/*     */   }
/*     */   
...
/* 600 */       BigArrays.set(this.a, i, s.readBoolean()); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\booleans\BooleanBigArrayBigList.class
