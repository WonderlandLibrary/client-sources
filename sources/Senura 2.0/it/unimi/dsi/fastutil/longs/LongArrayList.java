...
/* 222 */     if (capacity <= this.a.length || (this.a == LongArrays.DEFAULT_EMPTY_ARRAY && capacity <= 10))
/*     */       return; 
...
/* 327 */       this.a = LongArrays.forceCapacity(this.a, size, this.size); 
...
/* 461 */     LongIterator i = c.iterator();
/* 462 */     this.size += n;
/* 463 */     while (n-- != 0)
/* 464 */       this.a[index++] = i.nextLong(); 
...
/* 498 */       if (!c.contains(Long.valueOf(a[i])))
/* 499 */         a[j++] = a[i]; 
...
/* 507 */     return new LongListIterator() {
/* 508 */         int pos = index; int last = -1;
/*     */         
/*     */         public boolean hasNext() {
/* 511 */           return (this.pos < LongArrayList.this.size);
/*     */         }
/*     */         
...
/* 521 */           return LongArrayList.this.a[this.last = this.pos++];
/*     */         }
/*     */         
/*     */         public long previousLong() {
/* 525 */           if (!hasPrevious())
/* 526 */             throw new NoSuchElementException(); 
/* 527 */           return LongArrayList.this.a[this.last = --this.pos];
/*     */         }
/*     */         
...
/* 539 */           LongArrayList.this.add(this.pos++, k);
/* 540 */           this.last = -1;
/*     */         }
/*     */         
...
/* 546 */           LongArrayList.this.set(this.last, k);
/*     */         }
/*     */         
/*     */         public void remove() {
/* 550 */           if (this.last == -1)
/* 551 */             throw new IllegalStateException(); 
/* 552 */           LongArrayList.this.removeLong(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* 565 */     if (comp == null) {
/* 566 */       LongArrays.stableSort(this.a, 0, this.size);
/*     */     } else {
/* 568 */       LongArrays.stableSort(this.a, 0, this.size, comp);
/*     */     } 
/*     */   }
/*     */   
/*     */   public void unstableSort(LongComparator comp) {
/* 573 */     if (comp == null) {
/* 574 */       LongArrays.unstableSort(this.a, 0, this.size);
/*     */     } else {
/* 576 */       LongArrays.unstableSort(this.a, 0, this.size, comp);
/*     */     } 
/*     */   }
/*     */   
/*     */   public LongArrayList clone() {
/* 581 */     LongArrayList c = new LongArrayList(this.size);
...
/* 626 */     long[] a1 = this.a, a2 = l.a;
/*     */     
/*     */     int i;
/* 629 */     for (i = 0; i < s1 && i < s2; i++) {
/* 630 */       long e1 = a1[i];
/* 631 */       long e2 = a2[i]; int r;
/* 632 */       if ((r = Long.compare(e1, e2)) != 0)
/* 633 */         return r; 
/*     */     } 
...
/* 640 */       s.writeLong(this.a[i]); 
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 644 */     s.defaultReadObject();
/* 645 */     this.a = new long[this.size];
/* 646 */     for (int i = 0; i < this.size; i++)
/* 647 */       this.a[i] = s.readLong(); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\longs\LongArrayList.class
