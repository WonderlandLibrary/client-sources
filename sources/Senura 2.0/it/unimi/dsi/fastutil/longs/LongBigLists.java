...
/*   45 */       long t = l.getLong(i);
/*   46 */       l.set(i, l.getLong(p));
/*   47 */       l.set(p, t);
/*      */     } 
/*   49 */     return l;
/*      */   }
...
/*  187 */       return LongBigListIterators.EMPTY_BIG_LIST_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBigListIterator iterator() {
/*  192 */       return LongBigListIterators.EMPTY_BIG_LIST_ITERATOR;
/*      */     }
/*      */ 
/*      */     
/*      */     public LongBigListIterator listIterator(long i) {
/*  197 */       if (i == 0L)
/*  198 */         return LongBigListIterators.EMPTY_BIG_LIST_ITERATOR; 
...
/*      */     
/*      */     public Object clone() {
/*  241 */       return LongBigLists.EMPTY_BIG_LIST;
/*      */     }
/*      */     
/*      */     public int hashCode() {
/*  245 */       return 1;
...
/*  257 */       return LongBigLists.EMPTY_BIG_LIST;
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  299 */       long[] a = new long[1];
/*  300 */       a[0] = this.element;
/*  301 */       return a;
/*      */     }
/*      */     
/*      */     public LongBigListIterator listIterator() {
/*  305 */       return LongBigListIterators.singleton(this.element);
/*      */     }
/*      */     
/*      */     public LongBigListIterator listIterator(long i) {
/*  309 */       if (i > 1L || i < 0L)
/*  310 */         throw new IndexOutOfBoundsException(); 
/*  311 */       LongBigListIterator l = listIterator();
/*  312 */       if (i == 1L)
/*  313 */         l.nextLong(); 
/*  314 */       return l;
/*      */     }
...
/*  325 */         return LongBigLists.EMPTY_BIG_LIST; 
/*  326 */       return this;
/*      */     }
/*      */     
/*      */     public boolean addAll(long i, Collection<? extends Long> c) {
...
/*  401 */     return new Singleton(((Long)element).longValue());
/*      */   }
/*      */   
...
/*  422 */         return this.list.getLong(i);
/*      */       } 
/*      */     }
/*      */     
...
/*  440 */         return this.list.removeLong(i);
/*      */       } 
/*      */     }
/*      */     
/*      */     public long indexOf(long k) {
...
/*  518 */         return LongBigLists.synchronize(this.list.subList(from, to), this.sync);
/*      */       } 
/*      */     }
/*      */     
/*      */     public boolean equals(Object o) {
...
/*      */     
/*      */     public long getLong(long i) {
/*  673 */       return this.list.getLong(i);
/*      */     }
/*      */     
/*      */     public long set(long i, long k) {
...
/*      */     
/*      */     public LongBigListIterator listIterator() {
/*  735 */       return LongBigListIterators.unmodifiable(this.list.listIterator());
/*      */     }
/*      */     
/*      */     public LongBigListIterator listIterator(long i) {
/*  739 */       return LongBigListIterators.unmodifiable(this.list.listIterator(i));
/*      */     }
/*      */     
/*      */     public LongBigList subList(long from, long to) {
/*  743 */       return LongBigLists.unmodifiable(this.list.subList(from, to));
/*      */     }
/*      */     
/*      */     public boolean equals(Object o) {
/*  747 */       if (o == this)
...
/*      */     
/*      */     public LongBigListIterator iterator() {
/*  866 */       return LongBigListIterators.asBigListIterator(this.list.iterator());
/*      */     }
/*      */     
/*      */     public LongBigListIterator listIterator() {
/*  870 */       return LongBigListIterators.asBigListIterator(this.list.listIterator());
/*      */     }
/*      */     
/*      */     public LongBigListIterator listIterator(long index) {
/*  874 */       return LongBigListIterators.asBigListIterator(this.list.listIterator(intIndex(index)));
/*      */     }
/*      */     
/*      */     public boolean addAll(long index, Collection<? extends Long> c) {
...
/*      */     
/*      */     public long[] toLongArray() {
/*  890 */       return this.list.toLongArray();
/*      */     }
/*      */     
/*      */     public void removeElements(long from, long to) {
...
/*  945 */       return this.list.getLong(intIndex(index));
/*      */     }
/*      */     
/*      */     public long indexOf(long k) {
...
/*  957 */       return this.list.removeLong(intIndex(index));
/*      */     }
/*      */     
/*      */     public long set(long index, long k) {
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\longs\LongBigLists.class
