...
/*      */     try {
/* 1123 */       c = (Long2ObjectOpenCustomHashMap<V>)super.clone();
...
/* 1153 */         t ^= (this.value[i] == null) ? 0 : this.value[i].hashCode(); 
/* 1154 */       h += t;
/* 1155 */       i++;
/*      */     } 
/*      */     
/* 1158 */     if (this.containsNullKey)
/* 1159 */       h += (this.value[this.n] == null) ? 0 : this.value[this.n].hashCode(); 
/* 1160 */     return h;
/*      */   }
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\longs\Long2ObjectOpenCustomHashMap.class
