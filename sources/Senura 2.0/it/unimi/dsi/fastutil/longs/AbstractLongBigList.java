...
/* 160 */     return new LongBigListIterator() {
/* 161 */         long pos = index; long last = -1L;
/*     */         
/*     */         public boolean hasNext() {
/* 164 */           return (this.pos < AbstractLongBigList.this.size64());
/*     */         }
/*     */         
...
/* 174 */           return AbstractLongBigList.this.getLong(this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public long previousLong() {
/* 178 */           if (!hasPrevious())
/* 179 */             throw new NoSuchElementException(); 
/* 180 */           return AbstractLongBigList.this.getLong(this.last = --this.pos);
/*     */         }
/*     */         
...
/* 192 */           AbstractLongBigList.this.add(this.pos++, k);
/* 193 */           this.last = -1L;
/*     */         }
/*     */         
...
/* 199 */           AbstractLongBigList.this.set(this.last, k);
/*     */         }
/*     */         
/*     */         public void remove() {
/* 203 */           if (this.last == -1L)
/* 204 */             throw new IllegalStateException(); 
/* 205 */           AbstractLongBigList.this.removeLong(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* 229 */     LongBigListIterator i = listIterator();
/*     */     
/* 231 */     while (i.hasNext()) {
/* 232 */       long e = i.nextLong();
/* 233 */       if (k == e)
...
/* 240 */     LongBigListIterator i = listIterator(size64());
/*     */     
/* 242 */     while (i.hasPrevious()) {
/* 243 */       long e = i.previousLong();
/* 244 */       if (k == e)
...
/* 265 */     return new LongSubList(this, from, to);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 276 */     ensureIndex(to);
/* 277 */     LongBigListIterator i = listIterator(from);
/* 278 */     long n = to - from;
/* 279 */     if (n < 0L)
...
/*     */   
/*     */   public int hashCode() {
/* 361 */     LongIterator i = iterator();
/* 362 */     int h = 1;
/* 363 */     long s = size64();
/* 364 */     while (s-- != 0L) {
/* 365 */       long k = i.nextLong();
/* 366 */       h = 31 * h + HashCommon.long2int(k);
/*     */     } 
/* 368 */     return h;
/*     */   }
/*     */   
...
/* 378 */     if (s != l.size64())
/* 379 */       return false; 
/* 380 */     if (l instanceof LongBigList) {
/* 381 */       LongBigListIterator longBigListIterator1 = listIterator(), longBigListIterator2 = ((LongBigList)l).listIterator();
/* 382 */       while (s-- != 0L) {
/* 383 */         if (longBigListIterator1.nextLong() != longBigListIterator2.nextLong())
/* 384 */           return false; 
/* 385 */       }  return true;
/*     */     } 
...
/* 409 */     if (l == this)
/* 410 */       return 0; 
/* 411 */     if (l instanceof LongBigList) {
/* 412 */       LongBigListIterator longBigListIterator1 = listIterator(), longBigListIterator2 = ((LongBigList)l).listIterator();
/*     */ 
/*     */       
/* 415 */       while (longBigListIterator1.hasNext() && longBigListIterator2.hasNext()) {
/* 416 */         long e1 = longBigListIterator1.nextLong();
/* 417 */         long e2 = longBigListIterator2.nextLong(); int r;
/* 418 */         if ((r = Long.compare(e1, e2)) != 0)
/* 419 */           return r; 
/*     */       } 
/* 421 */       return longBigListIterator2.hasNext() ? -1 : (longBigListIterator1.hasNext() ? 1 : 0);
/*     */     } 
/* 423 */     BigListIterator<? extends Long> i1 = listIterator(), i2 = l.listIterator();
/*     */     
...
/* 439 */     return removeLong(size64() - 1L);
/*     */   }
/*     */   
/*     */   public long topLong() {
/* 443 */     if (isEmpty())
/* 444 */       throw new NoSuchElementException(); 
/* 445 */     return getLong(size64() - 1L);
/*     */   }
/*     */   
/*     */   public long peekLong(int i) {
/* 449 */     return getLong(size64() - 1L - i);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 535 */     return Long.valueOf(set(index, ok.longValue()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 548 */     return Long.valueOf(getLong(index));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 574 */     return lastIndexOf(((Long)ok).longValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 587 */     return Long.valueOf(removeLong(index));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   @Deprecated
/*     */   public Long pop() {
/* 613 */     return Long.valueOf(popLong());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   @Deprecated
/*     */   public Long top() {
/* 626 */     return Long.valueOf(topLong());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 639 */     return Long.valueOf(peekLong(i));
/*     */   }
/*     */   
/*     */   public String toString() {
/* 643 */     StringBuilder s = new StringBuilder();
/* 644 */     LongIterator i = iterator();
/* 645 */     long n = size64();
/*     */     
...
/* 708 */       this.to--;
/* 709 */       return this.l.removeLong(this.from + index);
/*     */     }
/*     */     
/*     */     public long set(long index, long k) {
...
/* 746 */       return new LongBigListIterator() {
/* 747 */           long pos = index; long last = -1L;
/*     */           
/*     */           public boolean hasNext() {
/* 750 */             return (this.pos < AbstractLongBigList.LongSubList.this.size64());
/*     */           }
/*     */           
/*     */           public boolean hasPrevious() {
...
/* 760 */             return AbstractLongBigList.LongSubList.this.l.getLong(AbstractLongBigList.LongSubList.this.from + (this.last = this.pos++));
/*     */           }
/*     */           
/*     */           public long previousLong() {
/* 764 */             if (!hasPrevious())
/* 765 */               throw new NoSuchElementException(); 
/* 766 */             return AbstractLongBigList.LongSubList.this.l.getLong(AbstractLongBigList.LongSubList.this.from + (this.last = --this.pos));
/*     */           }
/*     */           
/*     */           public long nextIndex() {
/* 770 */             return this.pos;
...
/* 780 */             AbstractLongBigList.LongSubList.this.add(this.pos++, k);
/* 781 */             this.last = -1L;
/* 782 */             if (!$assertionsDisabled && !AbstractLongBigList.LongSubList.this.assertRange()) throw new AssertionError(); 
/*     */           }
/*     */           
/*     */           public void set(long k) {
/* 786 */             if (this.last == -1L)
/* 787 */               throw new IllegalStateException(); 
/* 788 */             AbstractLongBigList.LongSubList.this.set(this.last, k);
/*     */           }
/*     */           
/*     */           public void remove() {
/* 792 */             if (this.last == -1L)
/* 793 */               throw new IllegalStateException(); 
/* 794 */             AbstractLongBigList.LongSubList.this.removeLong(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */             
...
/* 800 */               this.pos--; 
/* 801 */             this.last = -1L;
/* 802 */             assert AbstractLongBigList.LongSubList.this.assertRange();
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 812 */       return new LongSubList(this, from, to);
/*     */     }
/*     */     
/*     */     public boolean rem(long k) {
...
/* 818 */         return false; 
/* 819 */       this.to--;
/* 820 */       this.l.removeLong(this.from + index);
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\longs\AbstractLongBigList.class
