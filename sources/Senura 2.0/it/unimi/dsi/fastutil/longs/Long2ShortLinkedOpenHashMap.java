...
/* 1813 */     short[] value = this.value;
/* 1814 */     int mask = newN - 1;
/* 1815 */     long[] newKey = new long[newN + 1];
/* 1816 */     short[] newValue = new short[newN + 1];
...
/*      */     try {
/* 1870 */       c = (Long2ShortLinkedOpenHashMap)super.clone();
...
/* 1879 */     c.value = (short[])this.value.clone();
...
/* 1926 */     short[] value = this.value = new short[this.n + 1];
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\longs\Long2ShortLinkedOpenHashMap.class
