...
/* 1817 */     long[] key = this.key;
/* 1818 */     double[] value = this.value;
/* 1819 */     int mask = newN - 1;
/* 1820 */     long[] newKey = new long[newN + 1];
...
/* 1827 */       int pos; if (key[i] == 0L) {
/* 1828 */         pos = newN;
/*      */       } else {
/* 1830 */         pos = (int)HashCommon.mix(key[i]) & mask;
/* 1831 */         while (newKey[pos] != 0L)
/* 1832 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1875 */       c = (Long2DoubleLinkedOpenHashMap)super.clone();
...
/* 1883 */     c.key = (long[])this.key.clone();
...
/* 1901 */       while (this.key[i] == 0L)
/* 1902 */         i++; 
/* 1903 */       t = HashCommon.long2int(this.key[i]);
...
/* 1930 */     long[] key = this.key = new long[this.n + 1];
...
/* 1938 */       int pos; long k = s.readLong();
/* 1939 */       double v = s.readDouble();
/* 1940 */       if (k == 0L) {
/* 1941 */         pos = this.n;
/* 1942 */         this.containsNullKey = true;
/*      */       } else {
/* 1944 */         pos = (int)HashCommon.mix(k) & this.mask;
/* 1945 */         while (key[pos] != 0L)
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\longs\Long2DoubleLinkedOpenHashMap.class
