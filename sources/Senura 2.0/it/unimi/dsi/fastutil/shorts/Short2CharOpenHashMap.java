...
/* 1076 */     short[] key = this.key;
/* 1077 */     char[] value = this.value;
/* 1078 */     int mask = newN - 1;
/* 1079 */     short[] newKey = new short[newN + 1];
...
/*      */     try {
/* 1111 */       c = (Short2CharOpenHashMap)super.clone();
...
/* 1119 */     c.key = (short[])this.key.clone();
...
/* 1165 */     short[] key = this.key = new short[this.n + 1];
/* 1166 */     char[] value = this.value = new char[this.n + 1];
/*      */ 
/*      */     
/* 1169 */     for (int i = this.size; i-- != 0; ) {
/* 1170 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\shorts\Short2CharOpenHashMap.class
