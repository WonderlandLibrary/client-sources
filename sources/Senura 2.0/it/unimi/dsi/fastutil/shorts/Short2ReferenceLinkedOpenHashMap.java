...
/* 1727 */     short[] key = this.key;
/* 1728 */     V[] value = this.value;
/* 1729 */     int mask = newN - 1;
/* 1730 */     short[] newKey = new short[newN + 1];
...
/* 1737 */       int pos; if (key[i] == 0) {
/* 1738 */         pos = newN;
/*      */       } else {
/* 1740 */         pos = HashCommon.mix(key[i]) & mask;
/* 1741 */         while (newKey[pos] != 0)
/* 1742 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1785 */       c = (Short2ReferenceLinkedOpenHashMap<V>)super.clone();
...
/* 1793 */     c.key = (short[])this.key.clone();
...
/* 1841 */     short[] key = this.key = new short[this.n + 1];
...
/* 1849 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\shorts\Short2ReferenceLinkedOpenHashMap.class
