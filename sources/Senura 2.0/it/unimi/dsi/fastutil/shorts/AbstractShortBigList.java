...
/* 160 */     return new ShortBigListIterator() {
/* 161 */         long pos = index; long last = -1L;
/*     */         
/*     */         public boolean hasNext() {
/* 164 */           return (this.pos < AbstractShortBigList.this.size64());
/*     */         }
/*     */         
...
/* 174 */           return AbstractShortBigList.this.getShort(this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public short previousShort() {
/* 178 */           if (!hasPrevious())
/* 179 */             throw new NoSuchElementException(); 
/* 180 */           return AbstractShortBigList.this.getShort(this.last = --this.pos);
/*     */         }
/*     */         
...
/* 192 */           AbstractShortBigList.this.add(this.pos++, k);
/* 193 */           this.last = -1L;
/*     */         }
/*     */         
...
/* 199 */           AbstractShortBigList.this.set(this.last, k);
/*     */         }
/*     */         
/*     */         public void remove() {
/* 203 */           if (this.last == -1L)
/* 204 */             throw new IllegalStateException(); 
/* 205 */           AbstractShortBigList.this.removeShort(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */           
...
/* 229 */     ShortBigListIterator i = listIterator();
/*     */     
/* 231 */     while (i.hasNext()) {
/* 232 */       short e = i.nextShort();
/* 233 */       if (k == e)
...
/* 240 */     ShortBigListIterator i = listIterator(size64());
/*     */     
/* 242 */     while (i.hasPrevious()) {
/* 243 */       short e = i.previousShort();
/* 244 */       if (k == e)
...
/* 265 */     return new ShortSubList(this, from, to);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 276 */     ensureIndex(to);
/* 277 */     ShortBigListIterator i = listIterator(from);
/* 278 */     long n = to - from;
/* 279 */     if (n < 0L)
...
/*     */   
/*     */   public int hashCode() {
/* 361 */     ShortIterator i = iterator();
/* 362 */     int h = 1;
/* 363 */     long s = size64();
/* 364 */     while (s-- != 0L) {
/* 365 */       short k = i.nextShort();
/* 366 */       h = 31 * h + k;
/*     */     } 
/* 368 */     return h;
/*     */   }
...
/* 378 */     if (s != l.size64())
/* 379 */       return false; 
/* 380 */     if (l instanceof ShortBigList) {
/* 381 */       ShortBigListIterator shortBigListIterator1 = listIterator(), shortBigListIterator2 = ((ShortBigList)l).listIterator();
/* 382 */       while (s-- != 0L) {
/* 383 */         if (shortBigListIterator1.nextShort() != shortBigListIterator2.nextShort())
/* 384 */           return false; 
/* 385 */       }  return true;
/*     */     } 
...
/* 409 */     if (l == this)
/* 410 */       return 0; 
/* 411 */     if (l instanceof ShortBigList) {
/* 412 */       ShortBigListIterator shortBigListIterator1 = listIterator(), shortBigListIterator2 = ((ShortBigList)l).listIterator();
/*     */ 
/*     */       
/* 415 */       while (shortBigListIterator1.hasNext() && shortBigListIterator2.hasNext()) {
/* 416 */         short e1 = shortBigListIterator1.nextShort();
/* 417 */         short e2 = shortBigListIterator2.nextShort(); int r;
/* 418 */         if ((r = Short.compare(e1, e2)) != 0)
/* 419 */           return r; 
/*     */       } 
/* 421 */       return shortBigListIterator2.hasNext() ? -1 : (shortBigListIterator1.hasNext() ? 1 : 0);
/*     */     } 
/* 423 */     BigListIterator<? extends Short> i1 = listIterator(), i2 = l.listIterator();
/*     */     
...
/* 439 */     return removeShort(size64() - 1L);
/*     */   }
/*     */   
/*     */   public short topShort() {
/* 443 */     if (isEmpty())
/* 444 */       throw new NoSuchElementException(); 
/* 445 */     return getShort(size64() - 1L);
/*     */   }
/*     */   
/*     */   public short peekShort(int i) {
/* 449 */     return getShort(size64() - 1L - i);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 535 */     return Short.valueOf(set(index, ok.shortValue()));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 548 */     return Short.valueOf(getShort(index));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 561 */     return indexOf(((Short)ok).shortValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 574 */     return lastIndexOf(((Short)ok).shortValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 587 */     return Short.valueOf(removeShort(index));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   @Deprecated
/*     */   public Short pop() {
/* 613 */     return Short.valueOf(popShort());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   @Deprecated
/*     */   public Short top() {
/* 626 */     return Short.valueOf(topShort());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 639 */     return Short.valueOf(peekShort(i));
/*     */   }
/*     */   
/*     */   public String toString() {
/* 643 */     StringBuilder s = new StringBuilder();
/* 644 */     ShortIterator i = iterator();
/* 645 */     long n = size64();
/*     */     
...
/* 703 */       return this.l.getShort(this.from + index);
/*     */     }
/*     */     
/*     */     public short removeShort(long index) {
/* 707 */       ensureRestrictedIndex(index);
/* 708 */       this.to--;
/* 709 */       return this.l.removeShort(this.from + index);
/*     */     }
/*     */     
/*     */     public short set(long index, short k) {
...
/* 746 */       return new ShortBigListIterator() {
/* 747 */           long pos = index; long last = -1L;
/*     */           
/*     */           public boolean hasNext() {
/* 750 */             return (this.pos < AbstractShortBigList.ShortSubList.this.size64());
/*     */           }
/*     */           
/*     */           public boolean hasPrevious() {
...
/* 760 */             return AbstractShortBigList.ShortSubList.this.l.getShort(AbstractShortBigList.ShortSubList.this.from + (this.last = this.pos++));
/*     */           }
/*     */           
/*     */           public short previousShort() {
/* 764 */             if (!hasPrevious())
/* 765 */               throw new NoSuchElementException(); 
/* 766 */             return AbstractShortBigList.ShortSubList.this.l.getShort(AbstractShortBigList.ShortSubList.this.from + (this.last = --this.pos));
/*     */           }
/*     */           
/*     */           public long nextIndex() {
/* 770 */             return this.pos;
...
/* 780 */             AbstractShortBigList.ShortSubList.this.add(this.pos++, k);
/* 781 */             this.last = -1L;
/* 782 */             if (!$assertionsDisabled && !AbstractShortBigList.ShortSubList.this.assertRange()) throw new AssertionError(); 
/*     */           }
/*     */           
/*     */           public void set(short k) {
/* 786 */             if (this.last == -1L)
/* 787 */               throw new IllegalStateException(); 
/* 788 */             AbstractShortBigList.ShortSubList.this.set(this.last, k);
/*     */           }
/*     */           
/*     */           public void remove() {
/* 792 */             if (this.last == -1L)
/* 793 */               throw new IllegalStateException(); 
/* 794 */             AbstractShortBigList.ShortSubList.this.removeShort(this.last);
/*     */ 
/*     */ 
/*     */ 
/*     */             
...
/* 800 */               this.pos--; 
/* 801 */             this.last = -1L;
/* 802 */             assert AbstractShortBigList.ShortSubList.this.assertRange();
/*     */           }
/*     */         };
/*     */     }
/*     */     
...
/* 812 */       return new ShortSubList(this, from, to);
/*     */     }
/*     */     
/*     */     public boolean rem(short k) {
...
/* 818 */         return false; 
/* 819 */       this.to--;
/* 820 */       this.l.removeShort(this.from + index);
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\shorts\AbstractShortBigList.class
