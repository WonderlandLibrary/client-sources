...
/* 1067 */     short[] key = this.key;
/* 1068 */     int mask = newN - 1;
/* 1069 */     short[] newKey = new short[newN + 1];
...
/* 1152 */     ShortIterator i = iterator();
/* 1153 */     s.defaultWriteObject();
/* 1154 */     for (int j = this.size; j-- != 0;)
/* 1155 */       s.writeShort(i.nextShort()); 
/*      */   }
/*      */   
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\shorts\ShortLinkedOpenHashSet.class
