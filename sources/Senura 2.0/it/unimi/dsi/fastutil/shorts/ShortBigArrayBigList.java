...
/*     */     }
/* 296 */     short old = BigArrays.get(this.a, index);
/* 297 */     this.size--;
...
/*     */     }
/* 317 */     short old = BigArrays.get(this.a, index);
...
/* 381 */       BigArrays.fill(this.a, this.size, size, (short)0); 
/* 382 */     this.size = size;
/*     */   }
/*     */   
...
/* 490 */           return BigArrays.get(ShortBigArrayBigList.this.a, this.last = this.pos++);
/*     */         }
/*     */         
/*     */         public short previousShort() {
/* 494 */           if (!hasPrevious())
/* 495 */             throw new NoSuchElementException(); 
/* 496 */           return BigArrays.get(ShortBigArrayBigList.this.a, this.last = --this.pos);
/*     */         }
/*     */         
...
/* 583 */       short e1 = BigArrays.get(a1, i);
/* 584 */       short e2 = BigArrays.get(a2, i); int r;
...
/* 593 */       s.writeShort(BigArrays.get(this.a, i)); 
/*     */   }
/*     */   
...
/* 600 */       BigArrays.set(this.a, i, s.readShort()); 
/*     */   }
/*     */ }


/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\shorts\ShortBigArrayBigList.class
