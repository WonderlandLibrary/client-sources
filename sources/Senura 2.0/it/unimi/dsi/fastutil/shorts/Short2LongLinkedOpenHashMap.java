...
/* 1813 */     long[] value = this.value;
/* 1814 */     int mask = newN - 1;
/* 1815 */     short[] newKey = new short[newN + 1];
/* 1816 */     long[] newValue = new long[newN + 1];
...
/*      */     try {
/* 1870 */       c = (Short2LongLinkedOpenHashMap)super.clone();
...
/* 1879 */     c.value = (long[])this.value.clone();
...
/* 1897 */         i++; 
/* 1898 */       t = this.key[i];
/* 1899 */       t ^= HashCommon.long2int(this.value[i]);
/* 1900 */       h += t;
/* 1901 */       i++;
/*      */     } 
/*      */     
/* 1904 */     if (this.containsNullKey)
/* 1905 */       h += HashCommon.long2int(this.value[this.n]); 
/* 1906 */     return h;
/*      */   }
/*      */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 1909 */     short[] key = this.key;
/* 1910 */     long[] value = this.value;
...
/* 1926 */     long[] value = this.value = new long[this.n + 1];
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\shorts\Short2LongLinkedOpenHashMap.class
