...
/* 1728 */     short[] key = this.key;
/* 1729 */     V[] value = this.value;
/* 1730 */     int mask = newN - 1;
/* 1731 */     short[] newKey = new short[newN + 1];
...
/*      */     try {
/* 1786 */       c = (Short2ObjectLinkedOpenHashMap<V>)super.clone();
...
/* 1794 */     c.key = (short[])this.key.clone();
...
/* 1842 */     short[] key = this.key = new short[this.n + 1];
...
/* 1850 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\shorts\Short2ObjectLinkedOpenHashMap.class
