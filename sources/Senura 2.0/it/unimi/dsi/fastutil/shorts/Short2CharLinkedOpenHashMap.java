...
/* 1756 */     short[] key = this.key;
/* 1757 */     char[] value = this.value;
/* 1758 */     int mask = newN - 1;
/* 1759 */     short[] newKey = new short[newN + 1];
...
/* 1766 */       int pos; if (key[i] == 0) {
/* 1767 */         pos = newN;
/*      */       } else {
/* 1769 */         pos = HashCommon.mix(key[i]) & mask;
/* 1770 */         while (newKey[pos] != 0)
/* 1771 */           pos = pos + 1 & mask; 
/*      */       } 
...
/*      */     try {
/* 1814 */       c = (Short2CharLinkedOpenHashMap)super.clone();
...
/* 1822 */     c.key = (short[])this.key.clone();
...
/* 1869 */     short[] key = this.key = new short[this.n + 1];
...
/* 1877 */       int pos; short k = s.readShort();
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\shorts\Short2CharLinkedOpenHashMap.class
