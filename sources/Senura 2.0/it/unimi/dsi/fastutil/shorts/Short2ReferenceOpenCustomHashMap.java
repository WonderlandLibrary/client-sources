...
/*      */     try {
/* 1126 */       c = (Short2ReferenceOpenCustomHashMap<V>)super.clone();
...
/* 1156 */         t ^= (this.value[i] == null) ? 0 : System.identityHashCode(this.value[i]); 
/* 1157 */       h += t;
/* 1158 */       i++;
/*      */     } 
/*      */     
/* 1161 */     if (this.containsNullKey)
/* 1162 */       h += (this.value[this.n] == null) ? 0 : System.identityHashCode(this.value[this.n]); 
/* 1163 */     return h;
/*      */   }
...
/* Location:              C:\Users\Syz\Downloads\Senura (1).jar!\i\\unimi\dsi\fastutil\shorts\Short2ReferenceOpenCustomHashMap.class
