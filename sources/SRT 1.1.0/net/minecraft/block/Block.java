...
public class Block
{
    ...
    {
    	EventBoundingBox bb = new EventBoundingBox(this.getCollisionBoundingBox(worldIn, pos, state));
        SRT.moduleManager.onEvent(bb);

        AxisAlignedBB axisalignedbb = bb.getBB();
