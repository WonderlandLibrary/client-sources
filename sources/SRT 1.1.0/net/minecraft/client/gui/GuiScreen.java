...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    public void drawBackground(int tint)
    {
        ...
        //mc.getTextureManager().bindTexture(new ResourceLocation("thunderware/deepwaterhorizon.jpg"));
        this.drawRect(0, 0, width, height, new Color(31,31,31).getRGB());
        //this.drawGradientRect(0, height - 400, width, height, 0x00000000, 0xff000000);
    }
