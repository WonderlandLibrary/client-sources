...
import com.srt.SRT;
import com.thunderware.utils.api.DiscordAPI;
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    if (discordIp.contains("hypixel.net")) {
                        SRT.instance.richPresence.update("In-Game", "Playing on Hypixel", "hypixel", "");
                    } else if (discordIp.contains("blocksmc.com")) {
                        SRT.instance.richPresence.update("In-Game", "Playing on BlocksMC", "blocksmc", "");
                    } else {
                        SRT.instance.richPresence.update("In-Game", "Playing on " + discordIp + (port != 25565 ? ":" + port : ""), "", "");
                    }
                }
