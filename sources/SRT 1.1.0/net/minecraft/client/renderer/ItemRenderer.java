...
import com.srt.module.visuals.Animations;
...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0 || Killaura.currentTarget != null && SRT.instance.moduleManager.getModuleByName("Killaura").isToggled())
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                        if(Animations.mode.getCurrentValue().equalsIgnoreCase("Test")) {
                        	...
                        	this.func_178103_d();
                        }else if(Animations.mode.getCurrentValue().equalsIgnoreCase("Gangsta")) {
                        	this.transformFirstPersonItem(f / 1.5F - 0.3f, 0.0F);
                            GL11.glTranslated(0.0D, 0.0D, 0.0D);
                            this.func_178103_d();
                            float var8 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                            GlStateManager.rotate(-var8 * 80.0F, 1.0F, 0.0F, 1.0F);
                            GlStateManager.rotate(var8 * 30.0F, 1.0F, 0.0F, 1.0F);
                        }else if(Animations.mode.getCurrentValue().equalsIgnoreCase("1.7")) {
