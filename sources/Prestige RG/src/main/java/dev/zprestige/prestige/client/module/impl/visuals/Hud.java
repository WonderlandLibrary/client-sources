...
import static dev.zprestige.prestige.client.util.impl.RenderHelper.context;
...
public class Hud extends Module {
    ...
    public void event(Render2DEvent event) {;
        ...
        if (watermark.getObject()) {
            RenderUtil.renderTexturedRect(0, 0, 30, 30, watermarkTexture, RenderUtil.getThemeColor(color, 10, 10));
            context.drawTextWithShadow(mc.textRenderer, "Prestige RG", 4, (int) + 45, Color.red.getRGB());
        }
