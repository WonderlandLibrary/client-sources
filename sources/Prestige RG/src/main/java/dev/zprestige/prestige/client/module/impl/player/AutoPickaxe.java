package dev.zprestige.prestige.client.module.impl.player;
...
public class AutoPickaxe extends Module {
    ...
    public AutoPickaxe() {
        super("Auto Pickaxe", Category.Player, "Automatically switches to a pickaxe in your hotbar when mining the block below you");
