...
/*    */ 
/*    */       
/* 35 */       Map<Object, Object> map = new HashMap<Object, Object>();
...
/*    */       
/* 45 */       Config.dbg(String.valueOf(exception.getClass().getName()) + ": " + exception.getMessage());
/*    */     } 
/*    */   }
/*    */ 
/*    */   
...
/*    */     }
/*    */     
/* 82 */     String s1 = String.valueOf(throwable.getClass().getName()) + ": " + throwable.getMessage() + " (" + p_makeSummary_0_.getDescription() + ")" + " [" + s + "]";
/* 83 */     return s1;
/*    */   }
/*    */ }


/* Location:              C:\Users\mymon\AppData\Roaming\.minecraft\versions\Hera\Hera.jar!\optfine\CrashReporter.class
