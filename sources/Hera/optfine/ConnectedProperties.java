...
/*  170 */     List<BiomeGenBase> list = new ArrayList();
/*      */     
...
/*      */     } 
/*      */     
/*  187 */     BiomeGenBase[] abiomegenbase = list.<BiomeGenBase>toArray(new BiomeGenBase[list.size()]);
...
/*      */       continue;
/*      */     } 
/*  267 */     String[] astring2 = list.<String>toArray(new String[list.size()]);
/*      */     
...
/*      */       {
/*  276 */         s1 = String.valueOf(this.basePath) + "/" + s1;
/*      */       }
/*      */       
...
/*      */ 
/*      */     
/*  474 */     List<Integer> list = new ArrayList();
...
/*      */ 
/*      */     
/*  541 */     List<Integer> list = new ArrayList();
...
/*  633 */     String s2 = String.valueOf(s) + ":" + s1;
...
/*  920 */     return (this.matchBlocks != null) ? 1 : ((this.matchTiles != null) ? 2 : 128);
/*      */   }
/*      */ 
/*      */   
...
/*      */     
/*      */     int j;
/*  934 */     for (j = i; j < this.name.length(); j++) {
/*      */       
...
/*  952 */     (new int[1])[0] = k; return (k < 0) ? null : new int[1];
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  960 */     (new String[1])[0] = this.name; return (textureatlassprite == null) ? null : new String[1];
/*      */   }
/*      */ 
/*      */   
...
/*      */ 
/*      */     
/* 1216 */     List<TextureAtlasSprite> list = new ArrayList();
/*      */     
...
/*      */       }
/*      */       
/* 1230 */       String s3 = String.valueOf(s2) + ".png";
...
/*      */     } 
/*      */     
/* 1252 */     TextureAtlasSprite[] atextureatlassprite = list.<TextureAtlasSprite>toArray(new TextureAtlasSprite[list.size()]);
...
/* 1301 */     return "CTM name: " + this.name + ", basePath: " + this.basePath + ", matchBlocks: " + Config.arrayToString(this.matchBlocks) + ", matchTiles: " + Config.arrayToString((Object[])this.matchTiles);
/*      */   }
/*      */ }


/* Location:              C:\Users\mymon\AppData\Roaming\.minecraft\versions\Hera\Hera.jar!\optfine\ConnectedProperties.class
