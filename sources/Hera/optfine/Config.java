...
/*      */       
/*  245 */       dbg(String.valueOf(throwable.getClass().getName()) + ": " + throwable.getMessage());
/*      */     } 
/*      */   }
/*      */ 
/*      */   
...
/*  311 */     return !isFancyFogAvailable() ? false : ((gameSettings.ofFogType == 2));
/*      */   }
/*      */ 
/*      */   
...
/*  364 */     return (gameSettings.ofRain == 0) ? gameSettings.fancyGraphics : ((gameSettings.ofRain == 2));
/*      */   }
/*      */ 
/*      */   
...
/*  374 */     return (gameSettings.ofClouds != 0) ? ((gameSettings.ofClouds == 2)) : ((texturePackClouds != 0) ? ((texturePackClouds == 2)) : gameSettings.fancyGraphics);
/*      */   }
/*      */ 
/*      */   
...
/*  430 */     return (gameSettings.ofTrees == 0) ? gameSettings.fancyGraphics : ((gameSettings.ofTrees == 2));
/*      */   }
/*      */ 
/*      */   
/*      */   public static boolean isDroppedItemsFancy() {
/*  435 */     return (gameSettings.ofDroppedItems == 0) ? gameSettings.fancyGraphics : ((gameSettings.ofDroppedItems == 2));
/*      */   }
/*      */ 
/*      */   
/*      */   public static int limit(int p_limit_0_, int p_limit_1_, int p_limit_2_) {
/*  440 */     return (p_limit_0_ < p_limit_1_) ? p_limit_1_ : ((p_limit_0_ > p_limit_2_) ? p_limit_2_ : p_limit_0_);
/*      */   }
/*      */ 
/*      */   
/*      */   public static float limit(float p_limit_0_, float p_limit_1_, float p_limit_2_) {
/*  445 */     return (p_limit_0_ < p_limit_1_) ? p_limit_1_ : ((p_limit_0_ > p_limit_2_) ? p_limit_2_ : p_limit_0_);
/*      */   }
/*      */ 
/*      */   
/*      */   public static float limitTo1(float p_limitTo1_0_) {
/*  450 */     return (p_limitTo1_0_ < 0.0F) ? 0.0F : ((p_limitTo1_0_ > 1.0F) ? 1.0F : p_limitTo1_0_);
/*      */   }
/*      */ 
/*      */   
...
/*  669 */     List<IResourcePack> list1 = new ArrayList();
/*      */     
...
/*      */     }
/*      */     
/*  676 */     IResourcePack[] airesourcepack = list1.<IResourcePack>toArray(new IResourcePack[list1.size()]);
...
/*      */     }
/*      */     
/*  707 */     String s = arrayToString((Object[])astring);
/*  708 */     return s;
/*      */   }
/*      */ 
/*      */ 
...
/*  785 */     return (gameSettings.ofVignette == 0) ? gameSettings.fancyGraphics : ((gameSettings.ofVignette == 2));
/*      */   }
/*      */ 
/*      */   
...
/*      */     }
/*  800 */     catch (InterruptedException interruptedexception) {
/*      */       
...
/*  843 */     return (getAnisotropicFilterLevel() > 1) ? true : ((getAntialiasingLevel() > 0));
/*      */   }
/*      */ 
/*      */   
...
/*      */     }
/*  888 */     catch (NumberFormatException var3) {
/*      */       
...
/*      */     }
/*  900 */     catch (NumberFormatException var3) {
/*      */       
...
/*      */     } 
/*      */     
/*  917 */     String[] astring = list.<String>toArray(new String[list.size()]);
/*  918 */     return astring;
/*      */   }
/*      */ 
/*      */   
...
/*  931 */       List<DisplayMode> list = new ArrayList();
/*      */       
...
/*      */       } 
/*      */       
/*  943 */       DisplayMode[] adisplaymode1 = list.<DisplayMode>toArray(new DisplayMode[list.size()]);
/*  944 */       Comparator<? super DisplayMode> comparator = new Comparator()
/*      */         {
/*      */           public int compare(Object p_compare_1_, Object p_compare_2_)
/*      */           {
/*  948 */             DisplayMode displaymode1 = (DisplayMode)p_compare_1_;
/*  949 */             DisplayMode displaymode2 = (DisplayMode)p_compare_2_;
/*  950 */             return (displaymode1.getWidth() != displaymode2.getWidth()) ? (displaymode2.getWidth() - displaymode1.getWidth()) : ((displaymode1.getHeight() != displaymode2.getHeight()) ? (displaymode2.getHeight() - displaymode1.getHeight()) : 0);
/*      */           }
/*      */         };
...
/*  959 */       return new DisplayMode[] { desktopDisplayMode };
/*      */     } 
/*      */   }
/*      */ 
/*      */   
...
/* 1073 */     return (gameSettings.ofTranslucentBlocks == 0) ? gameSettings.fancyGraphics : ((gameSettings.ofTranslucentBlocks == 2));
/*      */   }
/*      */ 
/*      */   
/*      */   public static String[] readLines(File p_readLines_0_) throws IOException {
/* 1078 */     List<String> list = new ArrayList();
...
/* 1087 */       if (s == null) {
/*      */         
/* 1089 */         String[] astring = (String[])list.toArray((Object[])new String[list.size()]);
/* 1090 */         return astring;
/*      */       } 
/*      */       
/* 1093 */       list.add(s);
...
/*      */       int i;
/*      */       
/* 1186 */       for (i = 1; i < p_splitRelease_0_.length() && Character.isDigit(p_splitRelease_0_.charAt(i)); i++);
/*      */ 
/*      */ 
/*      */ 
/*      */       
...
/*      */ 
/*      */     
/* 1237 */     WorldClient worldClient = minecraft.theWorld;
/*      */     
/* 1239 */     if (worldClient == null)
/*      */     {
/* 1241 */       return null;
/*      */     }
...
/*      */ 
/*      */     
/* 1257 */     WorldProvider worldprovider = ((World)worldClient).provider;
/*      */     
...
/*      */     
/*      */     try {
/* 1269 */       WorldServer worldserver = integratedserver.worldServerForDimension(i);
/* 1270 */       return worldserver;
/*      */     }
/* 1272 */     catch (NullPointerException var5) {
/*      */       
/* 1274 */       return null;
/*      */     } 
/*      */   }
...
/* 1322 */     return (p_equals_0_ == p_equals_1_) ? true : ((p_equals_0_ == null) ? false : p_equals_0_.equals(p_equals_1_));
/*      */   }
/*      */ 
/*      */   
...
/*      */       }
/* 1341 */       catch (LWJGLException lwjglexception2) {
/*      */         
...
/*      */         }
/* 1353 */         catch (LWJGLException lwjglexception1) {
/*      */           
...
/*      */           }
/* 1364 */           catch (LWJGLException lwjglexception) {
/*      */             
...
/* 1377 */     ByteBuffer bytebuffer = ByteBuffer.allocate(4 * aint.length); byte b;
/*      */     int i, arrayOfInt1[];
/* 1379 */     for (i = (arrayOfInt1 = aint).length, b = 0; b < i; ) { int j = arrayOfInt1[b];
/*      */       
/* 1381 */       bytebuffer.putInt(j << 8 | j >> 24 & 0xFF);
/*      */       b++; }
/*      */     
...
/*      */           
/* 1437 */           ScaledResolution scaledresolution = new ScaledResolution(minecraft);
...
/* 1554 */     minecraft.fontRendererObj.drawString(s1, 2, 2, -2039584);
/*      */   }
/*      */ 
/*      */   
...
/*      */     }
/*      */     
/* 1631 */     return String.valueOf(stringbuffer.toString()) + p_fillLeft_0_;
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/* Location:              C:\Users\mymon\AppData\Roaming\.minecraft\versions\Hera\Hera.jar!\optfine\Config.class
