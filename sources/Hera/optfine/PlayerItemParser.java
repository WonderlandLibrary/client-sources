...
/*  60 */     Map<Object, Object> map = new HashMap<Object, Object>();
...
/*     */         else
/*     */         
/*  79 */         { for (Map.Entry<String, JsonElement> entry : (Iterable<Map.Entry<String, JsonElement>>)jsonobject1.entrySet()) {
/*     */             
/*  81 */             if (!jsonobject.has(entry.getKey()))
/*     */             {
/*  83 */               jsonobject.add(entry.getKey(), entry.getValue());
/*     */             }
/*     */           } 
/*     */ 
/*     */           
/*  88 */           String s2 = Json.getString(jsonobject, "id"); }  continue; }  String str1 = Json.getString(jsonobject, "id");
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 110 */     PlayerItemRenderer[] aplayeritemrenderer = (PlayerItemRenderer[])list.toArray((Object[])new PlayerItemRenderer[list.size()]);
...
/* Location:              C:\Users\mymon\AppData\Roaming\.minecraft\versions\Hera\Hera.jar!\optfine\PlayerItemParser.class
