...
/*  19 */     if (p_collectFiles_0_ instanceof net.minecraft.client.resources.DefaultResourcePack)
/*     */     {
...
/*  31 */     return (file1 == null) ? new String[0] : (file1.isDirectory() ? collectFilesFolder(file1, "", p_collectFiles_1_, p_collectFiles_2_) : (file1.isFile() ? collectFilesZIP(file1, p_collectFiles_1_, p_collectFiles_2_) : new String[0]));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */     } 
/*     */     
/*  56 */     String[] astring = list.<String>toArray(new String[list.size()]);
/*  57 */     return astring;
/*     */   }
/*     */ 
/*     */ 
...
/*  77 */       if (file1.isFile()) {
/*     */         
/*  79 */         String s3 = String.valueOf(p_collectFilesFolder_1_) + file1.getName();
/*     */         
...
/*     */         
/*  93 */         String s1 = String.valueOf(p_collectFilesFolder_1_) + file1.getName() + "/";
...
/*     */     } 
/*     */     
/* 104 */     String[] astring1 = list.<String>toArray(new String[list.size()]);
/* 105 */     return astring1;
/*     */   }
/*     */ 
/*     */ 
...
/* 117 */       Enumeration<? extends ZipEntry> enumeration = zipfile.entries();
/*     */       
...
/*     */       
/* 135 */       zipfile.close();
/* 136 */       String[] astring = list.<String>toArray(new String[list.size()]);
/* 137 */       return astring;
/*     */     }
...
/* Location:              C:\Users\mymon\AppData\Roaming\.minecraft\versions\Hera\Hera.jar!\optfine\ConnectedUtils.class
