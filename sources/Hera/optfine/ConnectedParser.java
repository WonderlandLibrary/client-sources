...
/*     */     } 
/*     */     
/*  76 */     MatchBlock[] amatchblock1 = (MatchBlock[])list.toArray((Object[])new MatchBlock[list.size()]);
...
/* 113 */     String[] astring1 = Arrays.<String>copyOfRange(astring, i + 1, astring.length);
...
/* 140 */     return (s.length() < 1) ? false : (startsWithDigit(s) ? false : (!s.contains("=")));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/* 194 */     String s = String.valueOf(p_parseBlockPart_1_) + ":" + p_parseBlockPart_2_;
...
/*     */         } 
/*     */         
/* 255 */         List<Comparable> list = (List)map.get(s2);
/*     */         
/* 257 */         if (list == null) {
/*     */           
...
/*     */ 
/*     */     
/* 287 */     List<Integer> list1 = new ArrayList();
/*     */     
...
/* 348 */     return (p_parseValue_1_ == String.class) ? p_parseValue_0_ : ((p_parseValue_1_ == Boolean.class) ? Boolean.valueOf(p_parseValue_0_) : Double.valueOf((p_parseValue_1_ == Float.class) ? Float.valueOf(p_parseValue_0_).floatValue() : ((p_parseValue_1_ == Double.class) ? Double.valueOf(p_parseValue_0_).doubleValue() : ((p_parseValue_1_ == Integer.class) ? Integer.valueOf(p_parseValue_0_).intValue() : ((p_parseValue_1_ == Long.class) ? Long.valueOf(p_parseValue_0_) : null).longValue()))));
/*     */   }
/*     */ 
/*     */   
...
/* 382 */     List<BiomeGenBase> list = new ArrayList();
/*     */     
...
/*     */     } 
/*     */     
/* 399 */     BiomeGenBase[] abiomegenbase = list.<BiomeGenBase>toArray(new BiomeGenBase[list.size()]);
...
/*     */ 
/*     */     
/* 476 */     List<Integer> list = new ArrayList();
...
/*     */ 
/*     */     
/* 543 */     EnumSet<EnumFacing> enumset = EnumSet.allOf(EnumFacing.class);
...
/* Location:              C:\Users\mymon\AppData\Roaming\.minecraft\versions\Hera\Hera.jar!\optfine\ConnectedParser.class
