...
/*     */ {
/*  22 */   private static Map locationProperties = new HashMap<Object, Object>();
...
/*     */       
/*  62 */       List<Entity> list = p_worldChanged_1_.getLoadedEntityList();
/*     */       
/*  64 */       for (int i = 0; i < list.size(); i++) {
/*     */         
/*  66 */         Entity entity = list.get(i);
...
/*     */     finally
/*     */     
/* 126 */     { working = false; }  working = false;
/*     */ 
/*     */     
/* 129 */     return entity;
/*     */   }
...
/*     */     
/*     */     }
/* 187 */     catch (FileNotFoundException var6) {
/*     */       
...
/*     */     }
/*     */     
/* 218 */     String s3 = String.valueOf(s2) + ".properties";
...
/* 276 */     String s3 = String.valueOf(s1) + p_getLocationIndexed_1_ + s2;
...
/* 301 */     List<ResourceLocation> list = new ArrayList();
...
/*     */ 
/*     */     
/* 328 */     ResourceLocation[] aresourcelocation = list.<ResourceLocation>toArray(new ResourceLocation[list.size()]);
...
/* Location:              C:\Users\mymon\AppData\Roaming\.minecraft\versions\Hera\Hera.jar!\optfine\RandomMobs.class
