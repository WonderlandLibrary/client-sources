...
/*  46 */   private TreeMap<String, Integer> playerReputation = new TreeMap<String, Integer>();
...
/*  93 */         this.worldObj.spawnEntityInWorld((Entity)entityirongolem);
/*  94 */         this.numIronGolems++;
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/* 116 */     if (!World.doesBlockHaveSolidTopSurface((IBlockAccess)this.worldObj, p_179861_2_.down()))
/*     */     {
/* 118 */       return false;
/*     */     }
/*     */ 
...
/* 191 */     return (this.center.distanceSq((Vec3i)pos) < (this.villageRadius * this.villageRadius));
/*     */   }
/*     */ 
/*     */   
...
/* 254 */     if (this.center.distanceSq((Vec3i)doorBlock) > (this.villageRadius * this.villageRadius))
/*     */     {
/* 256 */       return null;
/*     */     }
/*     */ 
...
/* 275 */     this.centerHelper = this.centerHelper.add((Vec3i)doorInfo.getDoorBlockPos());
...
/*     */       
/* 309 */       VillageAggressor village$villageaggressor1 = this.villageAgressors.get(i);
/* 310 */       double d1 = village$villageaggressor1.agressor.getDistanceSqToEntity((Entity)entitylivingbaseIn);
/*     */       
/* 312 */       if (d1 <= d0) {
/*     */         
...
/*     */           
/* 335 */           double d1 = entityplayer1.getDistanceSqToEntity((Entity)villageDefender);
/*     */           
/* 337 */           if (d1 <= d0) {
/*     */             
...
/*     */       
/* 355 */       VillageAggressor village$villageaggressor = iterator.next();
/*     */       
...
/*     */       
/* 372 */       VillageDoorInfo villagedoorinfo = iterator.next();
/*     */       
/* 374 */       if (flag1)
/*     */       {
...
/*     */         
/* 381 */         this.centerHelper = this.centerHelper.subtract((Vec3i)villagedoorinfo.getDoorBlockPos());
/* 382 */         flag = true;
...
/* 397 */     return (block instanceof net.minecraft.block.BlockDoor) ? ((block.getMaterial() == Material.wood)) : false;
/*     */   }
/*     */ 
/*     */   
...
/* 428 */     Integer integer = this.playerReputation.get(p_82684_1_);
...
/*     */       
/* 517 */       NBTTagCompound nbttagcompound = new NBTTagCompound();
...
/* 524 */       nbttaglist.appendTag((NBTBase)nbttagcompound);
/*     */     } 
/*     */     
/* 527 */     p_82689_1_.setTag("Doors", (NBTBase)nbttaglist);
...
/* 540 */         nbttaglist1.appendTag((NBTBase)nbttagcompound1);
/*     */       } 
/*     */     } 
/*     */     
/* 544 */     p_82689_1_.setTag("Players", (NBTBase)nbttaglist1);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
