...
/*  46 */     int i = flag1 | ((!worldIn.isAirBlock(blockpos1) && !worldIn.getBlockState(blockpos1).getBlock().isReplaceable(worldIn, blockpos1)) ? 1 : 0);
/*     */     
/*  48 */     if (i != 0)
/*     */     {
/*  50 */       return false;
...
/*  57 */     List<Entity> list = worldIn.getEntitiesWithinAABBExcludingEntity(null, AxisAlignedBB.fromBounds(d0, d1, d2, d0 + 1.0D, d1 + 2.0D, d2 + 1.0D));
/*     */     
/*  59 */     if (list.size() > 0)
/*     */     {
/*  61 */       return false;
...
/*     */       } 
/*     */       
/*  83 */       worldIn.spawnEntityInWorld((Entity)entityarmorstand);
/*     */     } 
/*     */     
/*  86 */     stack.stackSize--;
/*  87 */     return true;
