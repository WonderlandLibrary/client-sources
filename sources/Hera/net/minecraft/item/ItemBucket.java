...
/*     */ 
/*     */     
/*  43 */     if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
/*     */       
...
/*     */         
/*  62 */         if (material == Material.water && ((Integer)iblockstate.getValue((IProperty)BlockLiquid.LEVEL)).intValue() == 0) {
/*     */           
...
/*     */         } 
/*     */         
/*  69 */         if (material == Material.lava && ((Integer)iblockstate.getValue((IProperty)BlockLiquid.LEVEL)).intValue() == 0)
/*     */         {
...
/*     */           
/*  92 */           playerIn.triggerAchievement(StatList.objectUseStats[Item.getIdFromItem(this)]);
