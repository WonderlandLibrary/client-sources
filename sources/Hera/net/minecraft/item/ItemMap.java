...
/*  39 */       worldIn.setItemData(s, (WorldSavedData)mapdata);
/*     */     } 
/*     */     
/*  42 */     return mapdata;
/*     */   }
...
/*  59 */       worldIn.setItemData(s, (WorldSavedData)mapdata);
/*     */     } 
/*     */     
/*  62 */     return mapdata;
/*     */   }
...
/*  82 */       mapdata$mapinfo.field_82569_d++;
...
/* 101 */               HashMultiset hashMultiset = HashMultiset.create();
/* 102 */               Chunk chunk = worldIn.getChunkFromBlockCoords(new BlockPos(k2, 0, l2));
/*     */               
...
/* 116 */                   if ((l3 >> 20 & 0x1) == 0) {
/*     */                     
/* 118 */                     hashMultiset.add(Blocks.dirt.getMapColor(Blocks.dirt.getDefaultState().withProperty((IProperty)BlockDirt.VARIANT, (Comparable)BlockDirt.DirtType.DIRT)), 10);
/*     */                   }
/*     */                   else {
/*     */                     
/* 122 */                     hashMultiset.add(Blocks.stone.getMapColor(Blocks.stone.getDefaultState().withProperty((IProperty)BlockStone.VARIANT, (Comparable)BlockStone.EnumType.STONE)), 100);
/*     */                   } 
/*     */                   
/* 125 */                   d1 = 100.0D;
/*     */                 }
...
/*     */                           
/* 144 */                           k4--;
/* 145 */                           iblockstate = chunk.getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(i4 + i3, k4, j4 + j3));
/*     */                         }
...
/*     */                         
/* 171 */                         k4 / (i * i);
/* 172 */                       hashMultiset.add(iblockstate.getBlock().getMapColor(iblockstate));
/*     */                     } 
/*     */                   } 
/*     */                 } 
/*     */                 
...
/*     */                 }
/*     */                 
/* 191 */                 MapColor mapcolor = (MapColor)Iterables.getFirst((Iterable)Multisets.copyHighestCountFirst((Multiset)hashMultiset), MapColor.airColor);
/*     */                 
...
/* 279 */       worldIn.setItemData("map_" + stack.getMetadata(), (WorldSavedData)mapdata1);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 299 */         tooltip.add("(Level " + mapdata.scale + "/" + '\004' + ")");
/*     */       } 
/*     */     }
/*     */   }
/*     */ }
