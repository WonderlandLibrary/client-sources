...
/* 25 */     p_77589_1_.addRecipe(new ItemStack((Block)Blocks.chest), new Object[] { "###", "# #", "###", Character.valueOf('#'), Blocks.planks });
...
/* 30 */     p_77589_1_.addRecipe(new ItemStack(Blocks.sandstone), new Object[] { "##", "##", Character.valueOf('#'), new ItemStack((Block)Blocks.sand, 1, BlockSand.EnumType.SAND.getMetadata()) });
/* 31 */     p_77589_1_.addRecipe(new ItemStack(Blocks.red_sandstone), new Object[] { "##", "##", Character.valueOf('#'), new ItemStack((Block)Blocks.sand, 1, BlockSand.EnumType.RED_SAND.getMetadata()) });
...
/* 34 */     p_77589_1_.addRecipe(new ItemStack(Blocks.sandstone, 1, BlockSandStone.EnumType.CHISELED.getMetadata()), new Object[] { "#", "#", Character.valueOf('#'), new ItemStack((Block)Blocks.stone_slab, 1, BlockStoneSlab.EnumType.SAND.getMetadata()) });
/* 35 */     p_77589_1_.addRecipe(new ItemStack(Blocks.red_sandstone, 1, BlockRedSandstone.EnumType.CHISELED.getMetadata()), new Object[] { "#", "#", Character.valueOf('#'), new ItemStack((Block)Blocks.stone_slab2, 1, BlockStoneSlabNew.EnumType.RED_SANDSTONE.getMetadata()) });
/* 36 */     p_77589_1_.addRecipe(new ItemStack(Blocks.quartz_block, 1, BlockQuartz.EnumType.CHISELED.getMetadata()), new Object[] { "#", "#", Character.valueOf('#'), new ItemStack((Block)Blocks.stone_slab, 1, BlockStoneSlab.EnumType.QUARTZ.getMetadata()) });
...
/* 39 */     p_77589_1_.addRecipe(new ItemStack(Blocks.stonebrick, 1, BlockStoneBrick.CHISELED_META), new Object[] { "#", "#", Character.valueOf('#'), new ItemStack((Block)Blocks.stone_slab, 1, BlockStoneSlab.EnumType.SMOOTHBRICK.getMetadata()) });
...
/* 45 */     p_77589_1_.addRecipe(new ItemStack((Block)Blocks.beacon, 1), new Object[] { "GGG", "GSG", "OOO", Character.valueOf('G'), Blocks.glass, Character.valueOf('S'), Items.nether_star, Character.valueOf('O'), Blocks.obsidian });
