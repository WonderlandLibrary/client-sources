...
/*  50 */     addSmeltingRecipe(new ItemStack(Blocks.sponge, 1, 1), new ItemStack(Blocks.sponge, 1, 0), 0.15F); byte b; int i;
/*     */     ItemFishFood.FishType[] arrayOfFishType;
/*  52 */     for (i = (arrayOfFishType = ItemFishFood.FishType.values()).length, b = 0; b < i; ) { ItemFishFood.FishType itemfishfood$fishtype = arrayOfFishType[b];
/*     */       
...
/*     */       
/*  98 */       if (compareItemStacks(stack, entry.getKey()))
/*     */       {
...
/*     */       
/* 124 */       if (compareItemStacks(stack, entry.getKey()))
/*     */       {
