...
/*  37 */     return String.valueOf(getUnlocalizedName()) + "." + EnumDyeColor.byDyeDamage(i).getUnlocalizedName();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*  70 */       if (block == Blocks.log && iblockstate.getValue((IProperty)BlockPlanks.VARIANT) == BlockPlanks.EnumType.JUNGLE) {
/*     */         
...
/*     */           
/*  86 */           IBlockState iblockstate1 = Blocks.cocoa.onBlockPlaced(worldIn, pos, side, hitX, hitY, hitZ, 0, (EntityLivingBase)playerIn);
...
/*     */       
/* 141 */       block.setBlockBoundsBasedOnState((IBlockAccess)worldIn, pos);
/*     */       
