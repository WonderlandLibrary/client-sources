...
/*     */         
/*  95 */         GlStateManager.clearEnabled = false;
/*     */       }
/*  97 */       else if (j == HASH_DISPLAY && name.equals("display")) {
/*     */         
/*  99 */         GlStateManager.clearEnabled = true;
/*     */       } 
/*     */     } 
/*     */     
...
/*     */         {
/* 109 */           this.profilingSection = String.valueOf(this.profilingSection) + ".";
/*     */         }
/*     */         
/* 112 */         this.profilingSection = String.valueOf(this.profilingSection) + name;
...
/*     */         }
/*     */         
/* 147 */         this.profilingSection = !this.sectionList.isEmpty() ? this.sectionList.get(this.sectionList.size() - 1) : "";
/*     */       } 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     {
/* 161 */       return new ArrayList(Arrays.asList((Object[])new Result[] { new Result("root", 0.0D, 0.0D) }));
/*     */     }
...
/* 171 */     ArrayList<Result> arraylist = Lists.newArrayList();
/*     */     
/* 173 */     if (p_76321_1_.length() > 0)
/*     */     {
/* 175 */       p_76321_1_ = String.valueOf(p_76321_1_) + ".";
/*     */     }
/*     */     
/* 178 */     long k = 0L;
/*     */     
...
/* 244 */     return (this.sectionList.size() == 0) ? "[UNKNOWN]" : this.sectionList.get(this.sectionList.size() - 1);
/*     */   }
/*     */   
