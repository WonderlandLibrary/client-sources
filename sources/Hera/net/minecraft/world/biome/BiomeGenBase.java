...
/*  70 */   public static final Set<BiomeGenBase> explorationBiomesList = Sets.newHashSet();
...
/* 201 */     this.spawnableCreatureList.add(new SpawnListEntry((Class)EntitySheep.class, 12, 4, 4));
/* 202 */     this.spawnableCreatureList.add(new SpawnListEntry((Class)EntityRabbit.class, 10, 3, 3));
/* 203 */     this.spawnableCreatureList.add(new SpawnListEntry((Class)EntityPig.class, 10, 4, 4));
/* 204 */     this.spawnableCreatureList.add(new SpawnListEntry((Class)EntityChicken.class, 10, 4, 4));
/* 205 */     this.spawnableCreatureList.add(new SpawnListEntry((Class)EntityCow.class, 8, 4, 4));
/* 206 */     this.spawnableMonsterList.add(new SpawnListEntry((Class)EntitySpider.class, 100, 4, 4));
/* 207 */     this.spawnableMonsterList.add(new SpawnListEntry((Class)EntityZombie.class, 100, 4, 4));
/* 208 */     this.spawnableMonsterList.add(new SpawnListEntry((Class)EntitySkeleton.class, 100, 4, 4));
/* 209 */     this.spawnableMonsterList.add(new SpawnListEntry((Class)EntityCreeper.class, 100, 4, 4));
/* 210 */     this.spawnableMonsterList.add(new SpawnListEntry((Class)EntitySlime.class, 100, 4, 4));
/* 211 */     this.spawnableMonsterList.add(new SpawnListEntry((Class)EntityEnderman.class, 10, 1, 4));
/* 212 */     this.spawnableMonsterList.add(new SpawnListEntry((Class)EntityWitch.class, 5, 1, 1));
/* 213 */     this.spawnableWaterCreatureList.add(new SpawnListEntry((Class)EntitySquid.class, 10, 4, 4));
/* 214 */     this.spawnableCaveCreatureList.add(new SpawnListEntry((Class)EntityBat.class, 10, 8, 8));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     return (rand.nextInt(10) == 0) ? (WorldGenAbstractTree)this.worldGeneratorBigTree : (WorldGenAbstractTree)this.worldGeneratorTrees;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 268 */     return (WorldGenerator)new WorldGenTallGrass(BlockTallGrass.EnumType.GRASS);
/*     */   }
/*     */ 
/*     */   
...
/* 436 */     return ColorizerFoliage.getFoliageColor(d0, d1);
/*     */   }
/*     */ 
/*     */   
...
/*     */             {
/* 491 */               if (getFloatTemperature((BlockPos)blockpos$mutableblockpos.func_181079_c(p_180628_4_, j1, p_180628_5_)) < 0.15F) {
/*     */                 
...
/* 526 */               iblockstate1 = (iblockstate1.getValue((IProperty)BlockSand.VARIANT) == BlockSand.EnumType.RED_SAND) ? Blocks.red_sandstone.getDefaultState() : Blocks.sandstone.getDefaultState();
/*     */             } 
/*     */           } 
/*     */         } 
/*     */       } 
...
/* 558 */     return (biome == this) ? true : ((biome == null) ? false : ((getBiomeClass() == biome.getBiomeClass())));
/*     */   }
/*     */ 
/*     */   
/*     */   public TempCategory getTempCategory() {
/* 563 */     return (this.temperature < 0.2D) ? TempCategory.COLD : ((this.temperature < 1.0D) ? TempCategory.MEDIUM : TempCategory.WARM);
/*     */   }
/*     */ 
/*     */   
...
/* 615 */     megaTaiga.createMutatedBiome(megaTaigaHills.biomeID + 128).setBiomeName("Redwood Taiga Hills M"); byte b; int i;
/*     */     BiomeGenBase[] arrayOfBiomeGenBase;
/* 617 */     for (i = (arrayOfBiomeGenBase = biomeList).length, b = 0; b < i; ) { BiomeGenBase biomegenbase = arrayOfBiomeGenBase[b];
/*     */       
...
/* 657 */       return new Height(this.rootHeight * 0.8F, this.variation * 0.6F);
/*     */     } }
/*     */ 
/*     */   
...
/* 677 */       return String.valueOf(this.entityClass.getSimpleName()) + "*(" + this.minGroupCount + "-" + this.maxGroupCount + "):" + this.itemWeight;
/*     */     }
/*     */   }
/*     */   
