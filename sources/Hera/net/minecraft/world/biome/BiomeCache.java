...
/*  28 */     x >>= 4;
/*  29 */     z >>= 4;
/*  30 */     long i = x & 0xFFFFFFFFL | (z & 0xFFFFFFFFL) << 32L;
...
/*     */         
/*  64 */         Block biomecache$block = this.cache.get(k);
/*  65 */         long l = i - biomecache$block.lastAccessTime;
/*     */         
/*  67 */         if (l > 30000L || l < 0L) {
/*     */           
/*  69 */           this.cache.remove(k--);
/*  70 */           long i1 = biomecache$block.xPosition & 0xFFFFFFFFL | (biomecache$block.zPosition & 0xFFFFFFFFL) << 32L;
...
/*     */   public class Block
/*     */   {
/*  87 */     public float[] rainfallValues = new float[256];
/*  88 */     public BiomeGenBase[] biomes = new BiomeGenBase[256];
/*     */     
