...
/*     */ 
/*     */   
/*  40 */   protected WorldGenerator sandGen = (WorldGenerator)new WorldGenSand((Block)Blocks.sand, 7);
/*     */ 
/*     */   
/*  43 */   protected WorldGenerator gravelAsSandGen = (WorldGenerator)new WorldGenSand(Blocks.gravel, 6);
/*     */   
...
/*     */ 
/*     */   
/*  64 */   protected WorldGenerator mushroomBrownGen = (WorldGenerator)new GeneratorBushFeature(Blocks.brown_mushroom);
/*     */ 
/*     */   
/*  67 */   protected WorldGenerator mushroomRedGen = (WorldGenerator)new GeneratorBushFeature(Blocks.red_mushroom);
/*     */ 
/*     */   
/*  70 */   protected WorldGenerator bigMushroomGen = (WorldGenerator)new WorldGenBigMushroom();
/*     */ 
/*     */   
/*  73 */   protected WorldGenerator reedGen = (WorldGenerator)new WorldGenReed();
/*     */ 
/*     */   
/*  76 */   protected WorldGenerator cactusGen = (WorldGenerator)new WorldGenCactus();
/*     */ 
/*     */   
/*  79 */   protected WorldGenerator waterlilyGen = (WorldGenerator)new WorldGenWaterlily();
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/* 163 */     this.dirtGen = (WorldGenerator)new WorldGenMinable(Blocks.dirt.getDefaultState(), this.chunkProviderSettings.dirtSize);
/* 164 */     this.gravelGen = (WorldGenerator)new WorldGenMinable(Blocks.gravel.getDefaultState(), this.chunkProviderSettings.gravelSize);
/* 165 */     this.graniteGen = (WorldGenerator)new WorldGenMinable(Blocks.stone.getDefaultState().withProperty((IProperty)BlockStone.VARIANT, (Comparable)BlockStone.EnumType.GRANITE), this.chunkProviderSettings.graniteSize);
/* 166 */     this.dioriteGen = (WorldGenerator)new WorldGenMinable(Blocks.stone.getDefaultState().withProperty((IProperty)BlockStone.VARIANT, (Comparable)BlockStone.EnumType.DIORITE), this.chunkProviderSettings.dioriteSize);
/* 167 */     this.andesiteGen = (WorldGenerator)new WorldGenMinable(Blocks.stone.getDefaultState().withProperty((IProperty)BlockStone.VARIANT, (Comparable)BlockStone.EnumType.ANDESITE), this.chunkProviderSettings.andesiteSize);
/* 168 */     this.coalGen = (WorldGenerator)new WorldGenMinable(Blocks.coal_ore.getDefaultState(), this.chunkProviderSettings.coalSize);
/* 169 */     this.ironGen = (WorldGenerator)new WorldGenMinable(Blocks.iron_ore.getDefaultState(), this.chunkProviderSettings.ironSize);
/* 170 */     this.goldGen = (WorldGenerator)new WorldGenMinable(Blocks.gold_ore.getDefaultState(), this.chunkProviderSettings.goldSize);
/* 171 */     this.redstoneGen = (WorldGenerator)new WorldGenMinable(Blocks.redstone_ore.getDefaultState(), this.chunkProviderSettings.redstoneSize);
/* 172 */     this.diamondGen = (WorldGenerator)new WorldGenMinable(Blocks.diamond_ore.getDefaultState(), this.chunkProviderSettings.diamondSize);
/* 173 */     this.lapisGen = (WorldGenerator)new WorldGenMinable(Blocks.lapis_ore.getDefaultState(), this.chunkProviderSettings.lapisSize);
...
/*     */         BlockPos blockpos4;
/*     */         
/* 292 */         for (blockpos4 = this.field_180294_c.add(l7, j18, k11); blockpos4.getY() > 0; blockpos4 = blockpos7) {
/*     */           
/* 294 */           BlockPos blockpos7 = blockpos4.down();
/*     */           
...
/* 421 */           (new WorldGenLiquids((Block)Blocks.flowing_water)).generate(this.currentWorld, this.randomGenerator, blockpos6);
/*     */         } 
/*     */       } 
/*     */       
...
/* 431 */         (new WorldGenLiquids((Block)Blocks.flowing_lava)).generate(this.currentWorld, this.randomGenerator, blockpos3);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
