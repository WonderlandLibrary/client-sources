...
/*     */     {
/*  48 */       this.spawnableCreatureList.add(new BiomeGenBase.SpawnListEntry((Class)EntityWolf.class, 5, 4, 4));
/*     */     }
/*     */     
/*  51 */     if (this.field_150632_aF == 3)
/*     */     {
/*  53 */       this.theBiomeDecorator.treesPerChunk = -999;
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*  79 */     return (this.field_150632_aF == 3 && rand.nextInt(3) > 0) ? (WorldGenAbstractTree)field_150631_aE : ((this.field_150632_aF != 2 && rand.nextInt(5) != 0) ? (WorldGenAbstractTree)this.worldGeneratorTrees : (WorldGenAbstractTree)field_150630_aD);
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/* 186 */     return (this.biomeID != BiomeGenBase.birchForest.biomeID && this.biomeID != BiomeGenBase.birchForestHills.biomeID) ? new BiomeGenMutated(p_180277_1_, this)
/*     */       {
/*     */         public void decorate(World worldIn, Random rand, BlockPos pos)
/*     */         {
...
/*     */         public WorldGenAbstractTree genBigTreeChance(Random rand)
/*     */         {
/* 196 */           return rand.nextBoolean() ? (WorldGenAbstractTree)BiomeGenForest.field_150629_aC : (WorldGenAbstractTree)BiomeGenForest.field_150630_aD;
/*     */         }
/*     */       };
/*     */   }
/*     */ }
