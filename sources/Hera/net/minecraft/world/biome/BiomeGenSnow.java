...
/* 23 */     if (p_i45378_2_)
/*    */     {
/* 25 */       this.topBlock = Blocks.snow.getDefaultState();
/*    */     }
/*    */     
...
/* 55 */     return (WorldGenAbstractTree)new WorldGenTaiga2(false);
/*    */   }
/*    */ 
/*    */   
/*    */   protected BiomeGenBase createMutatedBiome(int p_180277_1_) {
/* 60 */     BiomeGenBase biomegenbase = (new BiomeGenSnow(p_180277_1_, true)).func_150557_a(13828095, true).setBiomeName(String.valueOf(this.biomeName) + " Spikes").setEnableSnow().setTemperatureRainfall(0.0F, 0.5F).setHeight(new BiomeGenBase.Height(this.minHeight + 0.1F, this.maxHeight + 0.1F));
