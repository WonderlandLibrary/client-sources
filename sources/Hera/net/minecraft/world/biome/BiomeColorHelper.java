...
/* 34 */     int k = 0;
/*    */     
/* 36 */     for (BlockPos.MutableBlockPos blockpos$mutableblockpos : BlockPos.getAllInBoxMutable(p_180285_1_.add(-1, 0, -1), p_180285_1_.add(1, 0, 1))) {
/*    */       
/* 38 */       int l = p_180285_2_.getColorAtPos(p_180285_0_.getBiomeGenForCoords((BlockPos)blockpos$mutableblockpos), (BlockPos)blockpos$mutableblockpos);
/* 39 */       i += (l & 0xFF0000) >> 16;
/* 40 */       j += (l & 0xFF00) >> 8;
/* 41 */       k += l & 0xFF;
/*    */     } 
