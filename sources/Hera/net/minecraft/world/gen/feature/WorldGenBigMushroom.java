...
/*  54 */             if (j >= 0 && j < 256) {
/*     */               
/*  56 */               Block block = worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(l, j, i1)).getBlock();
/*     */               
...
/*     */               {
/* 196 */                 setBlockAndNotifyAdequately(worldIn, blockpos, this.mushroomType.getDefaultState().withProperty((IProperty)BlockHugeMushroom.VARIANT, (Comparable)blockhugemushroom$enumtype));
/*     */               }
/*     */             } 
/*     */             continue;
/*     */           } 
...
/*     */         {
/* 209 */           setBlockAndNotifyAdequately(worldIn, position.up(i3), this.mushroomType.getDefaultState().withProperty((IProperty)BlockHugeMushroom.VARIANT, (Comparable)BlockHugeMushroom.EnumType.STEM));
/*     */         }
/*     */       } 
/*     */       
/* 213 */       return true;
