...
/*     */     int i;
/*  30 */     for (i = rand.nextInt(4) + 5; worldIn.getBlockState(position.down()).getBlock().getMaterial() == Material.water; position = position.down());
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/*  59 */             if (j >= 0 && j < 256) {
/*     */               
/*  61 */               Block block = worldIn.getBlockState((BlockPos)blockpos$mutableblockpos.func_181079_c(l, j, i1)).getBlock();
/*     */               
...
/*     */               
/* 143 */               if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos1).getBlock().getMaterial() == Material.leaves) {
/*     */                 
...
/* 190 */     IBlockState iblockstate = Blocks.vine.getDefaultState().withProperty((IProperty)p_181647_3_, Boolean.valueOf(true));
