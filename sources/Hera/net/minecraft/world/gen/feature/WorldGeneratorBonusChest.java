...
/*    */       
/* 50 */       if (worldIn.isAirBlock(blockpos) && World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, blockpos.down())) {
/*    */         
/* 52 */         worldIn.setBlockState(blockpos, Blocks.chest.getDefaultState(), 2);
/* 53 */         TileEntity tileentity = worldIn.getTileEntity(blockpos);
/*    */         
/* 55 */         if (tileentity instanceof net.minecraft.tileentity.TileEntityChest)
/*    */         {
/* 57 */           WeightedRandomChestContent.generateChestContents(rand, this.chestItems, (IInventory)tileentity, this.itemsToGenerateInBonusChest);
/*    */         }
/*    */         
...
/*    */         
/* 65 */         if (worldIn.isAirBlock(blockpos2) && World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, blockpos2.down()))
/*    */         {
/* 67 */           worldIn.setBlockState(blockpos2, Blocks.torch.getDefaultState(), 2);
/*    */         }
/*    */         
/* 70 */         if (worldIn.isAirBlock(blockpos1) && World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, blockpos1.down()))
/*    */         {
/* 72 */           worldIn.setBlockState(blockpos1, Blocks.torch.getDefaultState(), 2);
/*    */         }
/*    */         
/* 75 */         if (worldIn.isAirBlock(blockpos3) && World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, blockpos3.down()))
/*    */         {
/* 77 */           worldIn.setBlockState(blockpos3, Blocks.torch.getDefaultState(), 2);
/*    */         }
/*    */         
/* 80 */         if (worldIn.isAirBlock(blockpos4) && World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, blockpos4.down()))
/*    */         {
