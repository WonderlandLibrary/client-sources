...
/*  64 */   private final WorldGenerator field_177467_w = (WorldGenerator)new WorldGenMinable(Blocks.quartz_ore.getDefaultState(), 14, (Predicate)BlockHelper.forBlock(Blocks.netherrack));
/*  65 */   private final WorldGenHellLava field_177473_x = new WorldGenHellLava((Block)Blocks.flowing_lava, true);
/*  66 */   private final WorldGenHellLava field_177472_y = new WorldGenHellLava((Block)Blocks.flowing_lava, false);
...
/*     */       
/* 310 */       adouble[j] = Math.cos(j * Math.PI * 6.0D / p_73164_6_) * 2.0D;
/* 311 */       double d2 = j;
/*     */       
...
/*     */         
/* 320 */         d2 = 4.0D - d2;
/* 321 */         adouble[j] = adouble[j] - d2 * d2 * d2 * 10.0D;
/*     */       } 
/*     */     } 
/*     */     
...
/* 389 */     BlockFalling.fallInstantly = true;
