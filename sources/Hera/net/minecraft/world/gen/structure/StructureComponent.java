...
/*     */       }
/*     */     
/* 270 */     } else if (blockIn instanceof net.minecraft.block.BlockDoor) {
/*     */       
...
/*     */         }
/*     */       
/* 417 */       } else if (blockIn != Blocks.tripwire_hook && !(blockIn instanceof net.minecraft.block.BlockDirectional)) {
/*     */         
...
/*     */     
/* 595 */     if (boundingboxIn.isVecInside((Vec3i)blockpos))
/*     */     {
...
/* 607 */     return !boundingboxIn.isVecInside((Vec3i)blockpos) ? Blocks.air.getDefaultState() : worldIn.getBlockState(blockpos);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 750 */     if (structurebb.isVecInside((Vec3i)blockpos))
/*     */     {
...
/*     */     
/* 769 */     if (boundingboxIn.isVecInside((Vec3i)new BlockPos(i, j, k)))
/*     */     {
...
/*     */     
/* 783 */     if (boundingBoxIn.isVecInside((Vec3i)blockpos) && worldIn.getBlockState(blockpos).getBlock() != Blocks.chest) {
/*     */       
...
/*     */       
/* 789 */       if (tileentity instanceof net.minecraft.tileentity.TileEntityChest)
/*     */       {
/* 791 */         WeightedRandomChestContent.generateChestContents(rand, listIn, (IInventory)tileentity, max);
/*     */       }
/*     */       
/* 794 */       return true;
/*     */     } 
...
/*     */     
/* 806 */     if (boundingBoxIn.isVecInside((Vec3i)blockpos) && worldIn.getBlockState(blockpos).getBlock() != Blocks.dispenser) {
/*     */       
...
/*     */     
/* 831 */     if (boundingBoxIn.isVecInside((Vec3i)blockpos))
/*     */     {
