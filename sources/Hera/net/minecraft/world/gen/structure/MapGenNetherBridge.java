...
/* 41 */     return (this.rand.nextInt(3) != 0) ? false : ((chunkX != (i << 4) + 4 + this.rand.nextInt(8)) ? false : ((chunkZ == (j << 4) + 4 + this.rand.nextInt(8))));
/*    */   }
/*    */ 
/*    */   
...
/* 57 */       super(p_i2040_3_, p_i2040_4_);
...
/* 66 */         StructureComponent structurecomponent = list.remove(i);
