...
/*  26 */   private static final List<BiomeGenBase.SpawnListEntry> field_175803_h = Lists.newArrayList();
/*     */ 
/*     */ 
/*     */   
...
/*     */         
/*  42 */         this.field_175800_f = MathHelper.parseIntWithDefaultAndMax(entry.getValue(), this.field_175800_f, 1); continue;
/*     */       } 
/*  44 */       if (((String)entry.getKey()).equals("separation"))
/*     */       {
/*  46 */         this.field_175801_g = MathHelper.parseIntWithDefaultAndMax(entry.getValue(), this.field_175801_g, 1);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/*  79 */     if (i == k && j == l) {
/*     */       
/*  81 */       if (this.worldObj.getWorldChunkManager().getBiomeGenerator(new BlockPos(i * 16 + 8, 64, j * 16 + 8), null) != BiomeGenBase.deepOcean)
/*     */       {
/*  83 */         return false;
/*     */       }
/*     */       
...
/*     */   
/* 114 */   public static class StartMonument extends StructureStart { private Set<ChunkCoordIntPair> field_175791_c = Sets.newHashSet();
/*     */     
...
/* 123 */       super(p_i45607_3_, p_i45607_4_);
...
/* 137 */       EnumFacing enumfacing = EnumFacing.Plane.HORIZONTAL.random(p_175789_2_);
...
/* 175 */         nbttaglist.appendTag((NBTBase)nbttagcompound);
/*     */       } 
/*     */       
/* 178 */       tagCompound.setTag("Processed", (NBTBase)nbttaglist);
/*     */     }
/*     */ 
/*     */     
