...
/*     */         
/* 259 */         if (!this.field_74940_h[enumfacing.getHorizontalIndex()]) {
/*     */           
...
/*     */           
/* 336 */           if (p_74935_2_.isVecInside((Vec3i)blockpos$mutableblockpos)) {
/*     */             
/* 338 */             i += Math.max(worldIn.getTopSolidOrLiquidBlock((BlockPos)blockpos$mutableblockpos).getY(), worldIn.provider.getAverageGroundLevel());
/* 339 */             j++;
/*     */           } 
/*     */         } 
/*     */       } 
...
/* 364 */     private static final List<WeightedRandomChestContent> field_175816_i = Lists.newArrayList((Object[])new WeightedRandomChestContent[] { new WeightedRandomChestContent(Items.diamond, 0, 1, 3, 3), new WeightedRandomChestContent(Items.iron_ingot, 0, 1, 5, 10), new WeightedRandomChestContent(Items.gold_ingot, 0, 2, 7, 15), new WeightedRandomChestContent(Items.emerald, 0, 1, 3, 2), new WeightedRandomChestContent(Items.bone, 0, 4, 6, 20), new WeightedRandomChestContent(Items.rotten_flesh, 0, 3, 7, 16), new WeightedRandomChestContent(Items.saddle, 0, 1, 1, 3), new WeightedRandomChestContent(Items.iron_horse_armor, 0, 1, 1, 1), new WeightedRandomChestContent(Items.golden_horse_armor, 0, 1, 1, 1), new WeightedRandomChestContent(Items.diamond_horse_armor, 0, 1, 1, 1) });
/* 365 */     private static final List<WeightedRandomChestContent> field_175815_j = Lists.newArrayList((Object[])new WeightedRandomChestContent[] { new WeightedRandomChestContent(Items.arrow, 0, 2, 7, 30) });
...
/* 374 */       super(p_i2064_1_, p_i2064_2_, 64, p_i2064_3_, 12, 10, 15);
/*     */     }
/*     */ 
/*     */     
/*     */     protected void writeStructureToNBT(NBTTagCompound tagCompound) {
...
/* 510 */       setBlockState(worldIn, Blocks.tripwire_hook.getStateFromMeta(getMetadataWithOffset((Block)Blocks.tripwire_hook, EnumFacing.EAST.getHorizontalIndex())).withProperty((IProperty)BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 1, -3, 8, structureBoundingBoxIn);
/* 511 */       setBlockState(worldIn, Blocks.tripwire_hook.getStateFromMeta(getMetadataWithOffset((Block)Blocks.tripwire_hook, EnumFacing.WEST.getHorizontalIndex())).withProperty((IProperty)BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 4, -3, 8, structureBoundingBoxIn);
/* 512 */       setBlockState(worldIn, Blocks.tripwire.getDefaultState().withProperty((IProperty)BlockTripWire.ATTACHED, Boolean.valueOf(true)), 2, -3, 8, structureBoundingBoxIn);
/* 513 */       setBlockState(worldIn, Blocks.tripwire.getDefaultState().withProperty((IProperty)BlockTripWire.ATTACHED, Boolean.valueOf(true)), 3, -3, 8, structureBoundingBoxIn);
...
/* 530 */       setBlockState(worldIn, Blocks.tripwire_hook.getStateFromMeta(getMetadataWithOffset((Block)Blocks.tripwire_hook, EnumFacing.NORTH.getHorizontalIndex())).withProperty((IProperty)BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 7, -3, 1, structureBoundingBoxIn);
/* 531 */       setBlockState(worldIn, Blocks.tripwire_hook.getStateFromMeta(getMetadataWithOffset((Block)Blocks.tripwire_hook, EnumFacing.SOUTH.getHorizontalIndex())).withProperty((IProperty)BlockTripWireHook.ATTACHED, Boolean.valueOf(true)), 7, -3, 5, structureBoundingBoxIn);
/* 532 */       setBlockState(worldIn, Blocks.tripwire.getDefaultState().withProperty((IProperty)BlockTripWire.ATTACHED, Boolean.valueOf(true)), 7, -3, 2, structureBoundingBoxIn);
/* 533 */       setBlockState(worldIn, Blocks.tripwire.getDefaultState().withProperty((IProperty)BlockTripWire.ATTACHED, Boolean.valueOf(true)), 7, -3, 3, structureBoundingBoxIn);
/* 534 */       setBlockState(worldIn, Blocks.tripwire.getDefaultState().withProperty((IProperty)BlockTripWire.ATTACHED, Boolean.valueOf(true)), 7, -3, 4, structureBoundingBoxIn);
...
/* 578 */       setBlockState(worldIn, Blocks.sticky_piston.getStateFromMeta(getMetadataWithOffset((Block)Blocks.sticky_piston, EnumFacing.WEST.getIndex())), 10, -2, 8, structureBoundingBoxIn);
/* 579 */       setBlockState(worldIn, Blocks.sticky_piston.getStateFromMeta(getMetadataWithOffset((Block)Blocks.sticky_piston, EnumFacing.WEST.getIndex())), 10, -1, 8, structureBoundingBoxIn);
/* 580 */       setBlockState(worldIn, Blocks.unpowered_repeater.getStateFromMeta(getMetadataWithOffset((Block)Blocks.unpowered_repeater, EnumFacing.NORTH.getHorizontalIndex())), 10, -2, 10, structureBoundingBoxIn);
/*     */       
...
/* 621 */       super(p_i2066_1_, p_i2066_2_, 64, p_i2066_3_, 7, 7, 9);
/*     */     }
/*     */ 
/*     */     
/*     */     protected void writeStructureToNBT(NBTTagCompound tagCompound) {
...
/* 660 */       setBlockState(worldIn, Blocks.flower_pot.getDefaultState().withProperty((IProperty)BlockFlowerPot.CONTENTS, (Comparable)BlockFlowerPot.EnumFlowerType.MUSHROOM_RED), 1, 3, 5, structureBoundingBoxIn);
...
/*     */         
/* 688 */         if (structureBoundingBoxIn.isVecInside((Vec3i)new BlockPos(l1, i2, k1))) {
/*     */           
...
/* 693 */           entitywitch.onInitialSpawn(worldIn.getDifficultyForLocation(new BlockPos(l1, i2, k1)), null);
/* 694 */           worldIn.spawnEntityInWorld((Entity)entitywitch);
/*     */         } 
/*     */       } 
/*     */       
/* 698 */       return true;
