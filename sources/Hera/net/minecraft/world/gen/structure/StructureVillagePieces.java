...
/*   51 */     list.add(new PieceWeight((Class)House4Garden.class, 4, MathHelper.getRandomIntegerInRange(random, 2 + p_75084_1_, 4 + p_75084_1_ * 2)));
/*   52 */     list.add(new PieceWeight((Class)Church.class, 20, MathHelper.getRandomIntegerInRange(random, 0 + p_75084_1_, 1 + p_75084_1_)));
/*   53 */     list.add(new PieceWeight((Class)House1.class, 20, MathHelper.getRandomIntegerInRange(random, 0 + p_75084_1_, 2 + p_75084_1_)));
/*   54 */     list.add(new PieceWeight((Class)WoodHut.class, 3, MathHelper.getRandomIntegerInRange(random, 2 + p_75084_1_, 5 + p_75084_1_ * 3)));
/*   55 */     list.add(new PieceWeight((Class)Hall.class, 15, MathHelper.getRandomIntegerInRange(random, 0 + p_75084_1_, 2 + p_75084_1_)));
/*   56 */     list.add(new PieceWeight((Class)Field1.class, 3, MathHelper.getRandomIntegerInRange(random, 1 + p_75084_1_, 4 + p_75084_1_)));
/*   57 */     list.add(new PieceWeight((Class)Field2.class, 3, MathHelper.getRandomIntegerInRange(random, 2 + p_75084_1_, 4 + p_75084_1_ * 2)));
/*   58 */     list.add(new PieceWeight((Class)House2.class, 15, MathHelper.getRandomIntegerInRange(random, 0, 1 + p_75084_1_)));
/*   59 */     list.add(new PieceWeight((Class)House3.class, 8, MathHelper.getRandomIntegerInRange(random, 0 + p_75084_1_, 3 + p_75084_1_ * 2)));
...
/*      */       
/*  153 */       for (PieceWeight structurevillagepieces$pieceweight : start.structureVillageWeightedPieceList) {
/*      */         
...
/*      */             
/*  168 */             structurevillagepieces$pieceweight.villagePiecesSpawned++;
...
/*  339 */       setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)this.coordBaseMode.getOpposite()), 2, 4, 7, structureBoundingBoxIn);
/*  340 */       setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)this.coordBaseMode.rotateY()), 1, 4, 6, structureBoundingBoxIn);
/*  341 */       setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)this.coordBaseMode.rotateYCCW()), 3, 4, 6, structureBoundingBoxIn);
/*  342 */       setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)this.coordBaseMode), 2, 4, 5, structureBoundingBoxIn);
...
/*  676 */       setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)this.coordBaseMode), 2, 3, 1, structureBoundingBoxIn);
...
/*  686 */       setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)this.coordBaseMode.getOpposite()), 6, 3, 4, structureBoundingBoxIn);
...
/*      */       
/*  915 */       if (!this.hasMadeChest && structureBoundingBoxIn.isVecInside((Vec3i)new BlockPos(getXWithOffset(5, 5), getYWithOffset(1), getZWithOffset(5, 5)))) {
/*      */         
...
/* 1073 */       setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)this.coordBaseMode), 2, 3, 1, structureBoundingBoxIn);
...
/*      */       } 
/*      */       
/* 1218 */       setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)this.coordBaseMode), 2, 3, 1, structureBoundingBoxIn);
/*      */       
...
/*      */           
/* 1357 */           if (structureBoundingBoxIn.isVecInside((Vec3i)blockpos)) {
/*      */             
...
/* 1423 */       super((Start)null, 0, rand, p_i2104_4_, p_i2104_5_);
...
/* 1475 */       setBlockState(worldIn, Blocks.wool.getStateFromMeta(EnumDyeColor.WHITE.getDyeDamage()), 1, 3, 0, structureBoundingBoxIn);
/* 1476 */       boolean flag = !(this.coordBaseMode != EnumFacing.EAST && this.coordBaseMode != EnumFacing.NORTH);
/* 1477 */       setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)this.coordBaseMode.rotateY()), flag ? 2 : 0, 3, 0, structureBoundingBoxIn);
/* 1478 */       setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)this.coordBaseMode), 1, 3, 1, structureBoundingBoxIn);
/* 1479 */       setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)this.coordBaseMode.rotateYCCW()), flag ? 0 : 2, 3, 0, structureBoundingBoxIn);
/* 1480 */       setBlockState(worldIn, Blocks.torch.getDefaultState().withProperty((IProperty)BlockTorch.FACING, (Comparable)this.coordBaseMode.getOpposite()), 1, 3, -1, structureBoundingBoxIn);
/* 1481 */       return true;
/*      */     }
/*      */   }
/*      */   
...
/*      */           
/* 1577 */           if (p_74889_2_.isVecInside((Vec3i)blockpos$mutableblockpos)) {
/*      */             
/* 1579 */             i += Math.max(worldIn.getTopSolidOrLiquidBlock((BlockPos)blockpos$mutableblockpos).getY(), worldIn.provider.getAverageGroundLevel());
/* 1580 */             j++;
/*      */           } 
/*      */         } 
/*      */       } 
...
/*      */           
/* 1610 */           if (!p_74893_2_.isVecInside((Vec3i)new BlockPos(j, k, l))) {
/*      */             break;
/*      */           }
/*      */ 
/*      */           
/* 1615 */           this.villagersSpawned++;
...
/* 1618 */           entityvillager.onInitialSpawn(worldIn.getDifficultyForLocation(new BlockPos((Entity)entityvillager)), null);
/* 1619 */           entityvillager.setProfession(func_180779_c(i, entityvillager.getProfession()));
/* 1620 */           worldIn.spawnEntityInWorld((Entity)entityvillager);
/*      */         } 
/*      */       }
/*      */     }
/*      */ 
...
/*      */         {
/* 1651 */           return Blocks.sandstone_stairs.getDefaultState().withProperty((IProperty)BlockStairs.FACING, p_175847_1_.getValue((IProperty)BlockStairs.FACING));
/*      */         }
/*      */         
/* 1654 */         if (p_175847_1_.getBlock() == Blocks.stone_stairs)
/*      */         {
/* 1656 */           return Blocks.sandstone_stairs.getDefaultState().withProperty((IProperty)BlockStairs.FACING, p_175847_1_.getValue((IProperty)BlockStairs.FACING));
/*      */         }
/*      */         
...
/* 1701 */       super(start, p_i2109_2_);
/* 1702 */       this.coordBaseMode = EnumFacing.Plane.HORIZONTAL.random(rand);
/*      */       
