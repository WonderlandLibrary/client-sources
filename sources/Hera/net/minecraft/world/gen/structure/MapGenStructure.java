...
/*  33 */     this.structureMap = Maps.newHashMap();
/*     */     
/*  35 */     this.structureLongMap = new LongHashMap();
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       
/* 131 */       if (structurestart.isSizeableStructure() && structurestart.getBoundingBox().isVecInside((Vec3i)pos)) {
/*     */         
/* 133 */         Iterator<StructureComponent> iterator = structurestart.getComponents().iterator();
/*     */ 
/*     */ 
/*     */         
...
/*     */           
/* 144 */           if (structurecomponent.getBoundingBox().isVecInside((Vec3i)pos))
/*     */           {
/*     */ 
/*     */ 
/*     */ 
...
/* 184 */     recursiveGenerate(worldIn, pos.getX() >> 4, pos.getZ() >> 4, 0, 0, (ChunkPrimer)null);
...
/* 196 */         double d1 = blockpos1.distanceSq((Vec3i)pos);
/*     */         
/* 198 */         if (d1 < d0) {
/*     */           
/* 200 */           d0 = d1;
...
/*     */         
/* 220 */         double d2 = ((BlockPos)blockpos2).distanceSq((Vec3i)pos);
/*     */         
/* 222 */         if (d2 < d0) {
/*     */           
/* 224 */           d0 = d2;
