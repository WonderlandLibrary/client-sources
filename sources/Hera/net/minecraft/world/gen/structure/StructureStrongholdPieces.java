...
/*   64 */     structurePieceList = Lists.newArrayList(); byte b; int i;
/*      */     PieceWeight[] arrayOfPieceWeight;
/*   66 */     for (i = (arrayOfPieceWeight = pieceWeightArray).length, b = 0; b < i; ) { PieceWeight structurestrongholdpieces$pieceweight = arrayOfPieceWeight[b];
/*      */       
...
/*      */       
/*  171 */       for (PieceWeight structurestrongholdpieces$pieceweight : structurePieceList) {
/*      */         
...
/*      */             
/*  186 */             structurestrongholdpieces$pieceweight.instancesSpawned++;
...
/*      */       }
/*      */       
/*  299 */       if (!this.hasMadeChest && structureBoundingBoxIn.isVecInside((Vec3i)new BlockPos(getXWithOffset(3, 3), getYWithOffset(2), getZWithOffset(3, 3)))) {
/*      */         
...
/*      */         } 
/*      */       }
/*  889 */       setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i2).withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf((randomIn.nextFloat() > 0.9F))), 4, 3, 8, structureBoundingBoxIn);
/*  890 */       setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i2).withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf((randomIn.nextFloat() > 0.9F))), 5, 3, 8, structureBoundingBoxIn);
/*  891 */       setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i2).withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf((randomIn.nextFloat() > 0.9F))), 6, 3, 8, structureBoundingBoxIn);
/*  892 */       setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(l).withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf((randomIn.nextFloat() > 0.9F))), 4, 3, 12, structureBoundingBoxIn);
/*  893 */       setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(l).withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf((randomIn.nextFloat() > 0.9F))), 5, 3, 12, structureBoundingBoxIn);
/*  894 */       setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(l).withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf((randomIn.nextFloat() > 0.9F))), 6, 3, 12, structureBoundingBoxIn);
/*  895 */       setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i1).withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf((randomIn.nextFloat() > 0.9F))), 3, 3, 9, structureBoundingBoxIn);
/*  896 */       setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i1).withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf((randomIn.nextFloat() > 0.9F))), 3, 3, 10, structureBoundingBoxIn);
/*  897 */       setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(i1).withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf((randomIn.nextFloat() > 0.9F))), 3, 3, 11, structureBoundingBoxIn);
/*  898 */       setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(j1).withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf((randomIn.nextFloat() > 0.9F))), 7, 3, 9, structureBoundingBoxIn);
/*  899 */       setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(j1).withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf((randomIn.nextFloat() > 0.9F))), 7, 3, 10, structureBoundingBoxIn);
/*  900 */       setBlockState(worldIn, Blocks.end_portal_frame.getStateFromMeta(j1).withProperty((IProperty)BlockEndPortalFrame.EYE, Boolean.valueOf((randomIn.nextFloat() > 0.9F))), 7, 3, 11, structureBoundingBoxIn);
/*      */       
...
/*      */         
/*  907 */         if (structureBoundingBoxIn.isVecInside((Vec3i)blockpos)) {
/*      */           
/*  909 */           this.hasSpawner = true;
/*  910 */           worldIn.setBlockState(blockpos, Blocks.mob_spawner.getDefaultState(), 2);
/*  911 */           TileEntity tileentity = worldIn.getTileEntity(blockpos);
/*      */           
/*  913 */           if (tileentity instanceof TileEntityMobSpawner)
/*      */           {
/*  915 */             ((TileEntityMobSpawner)tileentity).getSpawnerBaseLogic().setEntityName("Silverfish");
/*      */           }
/*      */         } 
/*      */       } 
/*      */       
...
/*      */     extends Stronghold
/*      */   {
/* 1018 */     private static final List<WeightedRandomChestContent> strongholdRoomCrossingChestContents = Lists.newArrayList((Object[])new WeightedRandomChestContent[] { new WeightedRandomChestContent(Items.iron_ingot, 0, 1, 5, 10), new WeightedRandomChestContent(Items.gold_ingot, 0, 1, 3, 5), new WeightedRandomChestContent(Items.redstone, 0, 4, 9, 5), new WeightedRandomChestContent(Items.coal, 0, 3, 8, 10), new WeightedRandomChestContent(Items.bread, 0, 1, 3, 15), new WeightedRandomChestContent(Items.apple, 0, 1, 3, 15), new WeightedRandomChestContent(Items.iron_pickaxe, 0, 1, 1, 1) });
/*      */     
...
/* 1177 */       super(p_i2081_1_);
/* 1178 */       this.field_75024_a = true;
/* 1179 */       this.coordBaseMode = EnumFacing.Plane.HORIZONTAL.random(p_i2081_2_);
...
/*      */       {
/* 1219 */         StructureStrongholdPieces.strongComponentType = (Class)StructureStrongholdPieces.Crossing.class;
/*      */       }
/*      */       
...
/* 1276 */       super(0, p_i2083_2_, p_i2083_3_, p_i2083_4_);
/*      */     }
/*      */ 
/*      */     
...
/* 1354 */         if (f < 0.2F)
/*      */         {
/* 1356 */           this.blockstate = Blocks.stonebrick.getStateFromMeta(BlockStoneBrick.CRACKED_META);
/*      */         }
/* 1358 */         else if (f < 0.5F)
/*      */         {
/* 1360 */           this.blockstate = Blocks.stonebrick.getStateFromMeta(BlockStoneBrick.MOSSY_META);
/*      */         }
/* 1362 */         else if (f < 0.55F)
/*      */         {
/* 1364 */           this.blockstate = Blocks.monster_egg.getStateFromMeta(BlockSilverfish.EnumType.STONEBRICK.getMetadata());
/*      */         }
/*      */         else
/*      */         {
...
/* 1516 */           setBlockState(worldIn, Blocks.iron_bars.getDefaultState(), p_74990_5_ + 2, p_74990_6_, p_74990_7_, p_74990_3_); return;
/*      */         case IRON_DOOR:
/*      */           break;
/*      */       } 
