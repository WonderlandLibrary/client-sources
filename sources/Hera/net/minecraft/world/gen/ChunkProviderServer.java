...
/*  31 */   private Set<Long> droppedChunksSet = Collections.newSetFromMap(new ConcurrentHashMap<Long, Boolean>());
/*     */ 
/*     */ 
/*     */   
...
/* 151 */     return (chunk == null) ? ((!this.worldObj.isFindingSpawnPoint() && !this.chunkLoadOverride) ? this.dummyChunk : loadChunk(x, z)) : chunk;
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/*     */     try {
/* 164 */       Chunk chunk = this.chunkLoader.loadChunk((World)this.worldObj, x, z);
/*     */       
/* 166 */       if (chunk != null) {
/*     */         
...
/*     */       try {
/*     */         
/* 192 */         this.chunkLoader.saveExtraChunkData((World)this.worldObj, p_73243_1_);
/*     */       }
...
/* 208 */         this.chunkLoader.saveChunk((World)this.worldObj, p_73242_1_);
/*     */       }
/* 210 */       catch (IOException ioexception) {
/*     */         
/* 212 */         logger.error("Couldn't save chunk", ioexception);
/*     */       }
/* 214 */       catch (MinecraftException minecraftexception) {
/*     */         
/* 216 */         logger.error("Couldn't save chunk; already in use by another instance of Minecraft?", (Throwable)minecraftexception);
/*     */       } 
/*     */     }
/*     */   }
/*     */ 
...
/*     */           
/* 311 */           Long olong = this.droppedChunksSet.iterator().next();
