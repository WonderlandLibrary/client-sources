...
/*  50 */       File[] afile = this.savesDirectory.listFiles(); byte b; int i;
/*     */       File[] arrayOfFile1;
/*  52 */       for (i = (arrayOfFile1 = afile).length, b = 0; b < i; ) { File file1 = arrayOfFile1[b];
/*     */         
...
/*     */             
/*  69 */             long l = 0L;
/*  70 */             list.add(new SaveFormatComparator(s, s1, worldinfo.getLastTimePlayed(), l, worldinfo.getGameType(), flag, worldinfo.isHardcoreModeEnabled(), worldinfo.areCommandsAllowed()));
/*     */           } 
/*     */         } 
/*     */         b++; }
/*     */       
...
/*     */       
/* 148 */       WorldChunkManagerHell worldChunkManagerHell = new WorldChunkManagerHell(BiomeGenBase.plains, 0.5F);
/*     */     }
/*     */     else {
/*     */       
...
/* 156 */     convertFile(new File(file2, "region"), list1, (WorldChunkManager)new WorldChunkManagerHell(BiomeGenBase.hell, 0.0F), list.size(), i, progressCallback);
/* 157 */     convertFile(new File(file3, "region"), list2, (WorldChunkManager)new WorldChunkManagerHell(BiomeGenBase.sky, 0.0F), list.size() + list1.size(), i, progressCallback);
...
/* 222 */       RegionFile regionfile1 = new RegionFile(new File(p_75811_1_, String.valueOf(s.substring(0, s.length() - ".mcr".length())) + ".mca"));
/*     */       
...
/* 244 */               nbttagcompound2.setTag("Level", (NBTBase)nbttagcompound3);
