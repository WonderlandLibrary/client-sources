...
/*     */   public byte scale;
/*  28 */   public byte[] colors = new byte[16384];
...
/*     */       
/* 124 */       MapInfo mapdata$mapinfo1 = this.playersArrayList.get(i);
/*     */       
...
/* 176 */       b2 = (byte)(int)(rotation * 16.0D / 360.0D);
/*     */       
...
/* 221 */     MapInfo mapdata$mapinfo = this.playersHashMap.get(player);
...
/* 237 */     MapInfo mapdata$mapinfo = this.playersHashMap.get(player);
/*     */     
...
/* 270 */         return (Packet)new S34PacketMaps(stack.getMetadata(), MapData.this.scale, MapData.this.mapDecorations.values(), MapData.this.colors, this.minX, this.minY, this.maxX + 1 - this.minX, this.maxY + 1 - this.minY);
/*     */       } 
/*     */ 
/*     */       
/* 274 */       return (this.field_176109_i++ % 5 == 0) ? (Packet)new S34PacketMaps(stack.getMetadata(), MapData.this.scale, MapData.this.mapDecorations.values(), MapData.this.colors, 0, 0, 0, 0) : null;
/*     */     }
/*     */ 
/*     */ 
/*     */     
