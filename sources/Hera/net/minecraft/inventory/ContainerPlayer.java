...
/*     */       
/*  38 */       final int k_f = k;
/*  39 */       addSlotToContainer(new Slot((IInventory)playerInventory, playerInventory.getSizeInventory() - 1 - k, 8, 8 + k * 18)
/*     */           {
...
/*  47 */               return (stack == null) ? false : ((stack.getItem() instanceof ItemArmor) ? ((((ItemArmor)stack.getItem()).armorType == k_f)) : ((stack.getItem() != Item.getItemFromBlock(Blocks.pumpkin) && stack.getItem() != Items.skull) ? false : ((k_f == 0))));
/*     */             }
/*     */             
...
/*     */       {
/*  60 */         addSlotToContainer(new Slot((IInventory)playerInventory, j1 + (l + 1) * 9, 8 + j1 * 18, 84 + l * 18));
/*     */       }
/*     */     } 
/*     */     
/*  64 */     for (int i1 = 0; i1 < 9; i1++)
/*     */     {
/*  66 */       addSlotToContainer(new Slot((IInventory)playerInventory, i1, 8 + i1 * 18, 142));
/*     */     }
/*     */     
...
/* 111 */     Slot slot = this.inventorySlots.get(index);
/*     */     
