...
/*     */           {
/*  24 */             return (super.isItemValid(stack) && stack.getItem() == Items.saddle && !getHasStack());
/*     */           }
/*     */         });
...
/*  66 */     return (this.horseInventory.isUseableByPlayer(playerIn) && this.theHorse.isEntityAlive() && this.theHorse.getDistanceToEntity((Entity)playerIn) < 8.0F);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
