...
/*     */       {
/*  29 */         addSlotToContainer(new Slot((IInventory)playerInventory, j + i * 9 + 9, 8 + j * 18, 84 + i * 18));
/*     */       }
/*     */     } 
/*     */     
/*  33 */     for (int k = 0; k < 9; k++)
/*     */     {
/*  35 */       addSlotToContainer(new Slot((IInventory)playerInventory, k, 8 + k * 18, 142));
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/*  54 */       ICrafting icrafting = this.crafters.get(i);
/*     */       
...
/* 157 */       super(inventoryIn, index, xPosition, yPosition);
/*     */     }
/*     */ 
/*     */     
...
/* 177 */       super(inventoryIn, index, xPosition, yPosition);
...
/*     */       {
/* 195 */         this.player.triggerAchievement((StatBase)AchievementList.potion);
/*     */       }
/*     */       
