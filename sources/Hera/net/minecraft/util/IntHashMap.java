...
/*  99 */     Entry<V>[] arrayOfEntry = this.slots;
/* 100 */     int i = arrayOfEntry.length;
/*     */     
/* 102 */     if (i == 1073741824) {
/*     */       
...
/* 109 */       copyTo((Entry<V>[])entry1);
/* 110 */       this.slots = (Entry<V>[])entry1;
...
/* 120 */     Entry<V>[] arrayOfEntry = this.slots;
/* 121 */     int i = p_76048_1_.length;
/*     */     
/* 123 */     for (int j = 0; j < arrayOfEntry.length; j++) {
/*     */       
/* 125 */       Entry<V> entry1 = arrayOfEntry[j];
/*     */       
/* 127 */       if (entry1 != null) {
/*     */         Entry<V> entry2;
/* 129 */         arrayOfEntry[j] = null;
/*     */ 
/*     */         
/*     */         do {
...
/*     */     Entry<V> entry1;
/*     */     
/* 165 */     for (entry1 = entry; entry1 != null; entry1 = entry2) {
/*     */       
/* 167 */       Entry<V> entry2 = entry1.nextEntry;
/*     */       
...
/* 196 */     Entry<V>[] arrayOfEntry = this.slots;
/*     */     
/* 198 */     for (int i = 0; i < arrayOfEntry.length; i++)
/*     */     {
/* 200 */       arrayOfEntry[i] = null;
/*     */     }
/*     */     
/* 203 */     this.count = 0;
/*     */   }
...
/* 212 */     this.slots[p_76040_4_] = new Entry<V>(p_76040_1_, p_76040_2_, p_76040_3_, entry);
/*     */     
...
/*     */ 
/*     */       
/* 253 */       Entry<V> entry = (Entry<V>)p_equals_1_;
...
/* 279 */       return String.valueOf(getHash()) + "=" + getValue();
/*     */     }
/*     */   }
/*     */ }
