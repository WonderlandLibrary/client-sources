...
/*     */   
/*     */   public long toLong() {
/* 202 */     return (getX() & X_MASK) << X_SHIFT | (getY() & Y_MASK) << Y_SHIFT | (getZ() & Z_MASK) << 0L;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 218 */     final BlockPos blockpos = new BlockPos(Math.min(from.getX(), to.getX()), Math.min(from.getY(), to.getY()), Math.min(from.getZ(), to.getZ()));
...
/* 220 */     return new Iterable<BlockPos>()
/*     */       {
/*     */         public Iterator<BlockPos> iterator()
/*     */         {
/* 224 */           return (Iterator<BlockPos>)new AbstractIterator<BlockPos>()
/*     */             {
...
/*     */                   
/* 231 */                   this.lastReturned = blockpos;
/* 232 */                   return this.lastReturned;
/*     */                 } 
/* 234 */                 if (this.lastReturned.equals(blockpos1))
/*     */                 {
...
/*     */                 
/* 244 */                 if (i < blockpos1.getX()) {
/*     */                   
/* 246 */                   i++;
/*     */                 }
/* 248 */                 else if (j < blockpos1.getY()) {
/*     */                   
/* 250 */                   i = blockpos.getX();
/* 251 */                   j++;
/*     */                 }
/* 253 */                 else if (k < blockpos1.getZ()) {
/*     */                   
/* 255 */                   i = blockpos.getX();
/* 256 */                   j = blockpos.getY();
/* 257 */                   k++;
...
/* 271 */     final BlockPos blockpos = new BlockPos(Math.min(from.getX(), to.getX()), Math.min(from.getY(), to.getY()), Math.min(from.getZ(), to.getZ()));
...
/* 273 */     return new Iterable<MutableBlockPos>()
/*     */       {
/*     */         public Iterator<BlockPos.MutableBlockPos> iterator()
/*     */         {
/* 277 */           return (Iterator<BlockPos.MutableBlockPos>)new AbstractIterator<BlockPos.MutableBlockPos>()
/*     */             {
...
/*     */                   
/* 284 */                   this.theBlockPos = new BlockPos.MutableBlockPos(blockpos.getX(), blockpos.getY(), blockpos.getZ());
/* 285 */                   return this.theBlockPos;
/*     */                 } 
/* 287 */                 if (this.theBlockPos.equals(blockpos1))
/*     */                 {
...
/*     */                 
/* 297 */                 if (i < blockpos1.getX()) {
/*     */                   
/* 299 */                   i++;
/*     */                 }
/* 301 */                 else if (j < blockpos1.getY()) {
/*     */                   
/* 303 */                   i = blockpos.getX();
/* 304 */                   j++;
/*     */                 }
/* 306 */                 else if (k < blockpos1.getZ()) {
/*     */                   
/* 308 */                   i = blockpos.getX();
/* 309 */                   j = blockpos.getY();
/* 310 */                   k++;
/*     */                 } 
/*     */                 
/* 313 */                 this.theBlockPos.x = i;
/* 314 */                 this.theBlockPos.y = j;
/* 315 */                 this.theBlockPos.z = k;
