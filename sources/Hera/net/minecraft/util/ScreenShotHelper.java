...
/*     */     try {
/*  51 */       File file2, file1 = new File(gameDirectory, "screenshots");
/*  52 */       file1.mkdir();
/*     */       
...
/* 125 */       return new ChatComponentTranslation("screenshot.failure", new Object[] { exception.getMessage() });
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/*     */     while (true) {
/* 142 */       File file1 = new File(gameDirectory, String.valueOf(s) + ((i == 1) ? "" : ("_" + i)) + ".png");
/*     */       
/* 144 */       if (!file1.exists())
/*     */       {
/* 146 */         return file1;
