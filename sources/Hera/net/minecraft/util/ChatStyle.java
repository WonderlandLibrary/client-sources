...
/*     */   
/*     */   public String toString() {
/* 360 */     return "Style{hasParent=" + ((this.parentStyle != null) ? 1 : 0) + ", color=" + this.color + ", bold=" + this.bold + ", italic=" + this.italic + ", underlined=" + this.underlined + ", obfuscated=" + this.obfuscated + ", clickEvent=" + getChatClickEvent() + ", hoverEvent=" + getChatHoverEvent() + ", insertion=" + getInsertion() + '}';
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 386 */       { if (!getChatClickEvent().equals(chatstyle.getChatClickEvent()))
/*     */         
/*     */         { 
/*     */ 
/*     */ 
...
/* 423 */           return flag; }  } else if (chatstyle.getChatClickEvent() != null) { return false; }  if (getChatHoverEvent() != null) { if (!getChatHoverEvent().equals(chatstyle.getChatHoverEvent()))
/*     */           return false;  } else if (chatstyle.getChatHoverEvent() != null) { return false; }
/* 425 */        if (getInsertion() != null) { if (getInsertion().equals(chatstyle.getInsertion())) { boolean flag = true;
/* 426 */           return flag; }
/*     */          }
...
/*     */     
/*     */     } 
/* 432 */     return false; } public int hashCode() { int i = this.color.hashCode();
...
/* 628 */         jsonobject.add("clickEvent", (JsonElement)jsonobject1);
/*     */       } 
/*     */       
...
/* 636 */         jsonobject.add("hoverEvent", (JsonElement)jsonobject2);
/*     */       } 
/*     */       
