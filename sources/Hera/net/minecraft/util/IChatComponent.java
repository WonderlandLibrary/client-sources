...
/*     */       }
/* 104 */       else if (jsonobject.has("translate")) {
/*     */         
...
/*     */         }
/*     */         
/* 144 */         ichatcomponent = new ChatComponentScore(JsonUtils.getString(jsonobject1, "name"), JsonUtils.getString(jsonobject1, "objective"));
/*     */         
...
/*     */         {
/* 191 */           object.add(entry.getKey(), entry.getValue());
/*     */         }
/*     */       } 
/*     */     }
/*     */ 
...
/*     */       {
/* 200 */         return (JsonElement)new JsonPrimitive(((ChatComponentText)p_serialize_1_).getChatComponentText_TextValue());
/*     */       }
/*     */ 
/*     */       
...
/*     */         }
/*     */         
/* 220 */         jsonobject.add("extra", (JsonElement)jsonarray);
/*     */       } 
/*     */       
...
/*     */         {
/* 234 */           JsonArray jsonarray1 = new JsonArray(); byte b; int i;
/*     */           Object[] arrayOfObject;
/* 236 */           for (i = (arrayOfObject = chatcomponenttranslation.getFormatArgs()).length, b = 0; b < i; ) { Object object = arrayOfObject[b];
/*     */             
...
/*     */             else {
/*     */               
/* 244 */               jsonarray1.add((JsonElement)new JsonPrimitive(String.valueOf(object)));
/*     */             } 
/*     */             b++; }
/*     */           
/* 248 */           jsonobject.add("with", (JsonElement)jsonarray1);
/*     */         }
/*     */       
...
/* 258 */         jsonobject.add("score", (JsonElement)jsonobject1);
/*     */       }
/*     */       else {
/*     */         
...
/*     */       } 
/*     */       
/* 271 */       return (JsonElement)jsonobject;
/*     */     }
/*     */ 
/*     */ 
/*     */     
