...
/*  24 */     this.formatArgs = args; byte b; int i;
/*     */     Object[] arrayOfObject;
/*  26 */     for (i = (arrayOfObject = args).length, b = 0; b < i; ) { Object object = arrayOfObject[b];
/*     */       
...
/*     */     }
/*  57 */     catch (ChatComponentTranslationFormatException chatcomponenttranslationformatexception) {
/*     */       
...
/*     */       }
/*  65 */       catch (ChatComponentTranslationFormatException var5) {
/*     */         
...
/*     */     
/*     */     try {
/*  86 */       for (; matcher.find(j); j = l) {
/*     */         
/*  88 */         int k = matcher.start();
/*  89 */         int l = matcher.end();
/*     */         
/*  91 */         if (k > j) {
/*     */           
...
/*     */       }
/*     */     
/* 131 */     } catch (IllegalFormatException illegalformatexception) {
/*     */       
...
/* 164 */     super.setChatStyle(style); byte b; int i;
/*     */     Object[] arrayOfObject;
/* 166 */     for (i = (arrayOfObject = this.formatArgs).length, b = 0; b < i; ) { Object object = arrayOfObject[b];
/*     */       
