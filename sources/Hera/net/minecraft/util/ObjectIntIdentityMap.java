...
/* 12 */   private final IdentityHashMap identityMap = new IdentityHashMap<Object, Object>(512);
...
/* 41 */     return (Iterator)Iterators.filter(this.objectList.iterator(), Predicates.notNull());
/*    */   }
/*    */ 
/*    */   
