...
/*  66 */     return Iterators.concat((Iterator)Iterators.forArray((Object[])new ChatComponentStyle[] { this }, ), createDeepCopyIterator(this.siblings));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 103 */     Iterator<IChatComponent> iterator = Iterators.concat(Iterators.transform(components.iterator(), new Function<IChatComponent, Iterator<IChatComponent>>()
/*     */           {
...
/*     */             }
/*     */           }));
/* 110 */     iterator = Iterators.transform(iterator, new Function<IChatComponent, IChatComponent>()
/*     */         {
