...
/*  72 */     return (new EntityDamageSourceIndirect("arrow", (Entity)arrow, p_76353_1_)).setProjectile();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  80 */     return (p_76362_1_ == null) ? (new EntityDamageSourceIndirect("onFire", (Entity)fireball, (Entity)fireball)).setFireDamage().setProjectile() : (new EntityDamageSourceIndirect("fireball", (Entity)fireball, p_76362_1_)).setFireDamage().setProjectile();
/*     */   }
/*     */ 
/*     */   
...
/* 103 */     return (explosionIn != null && explosionIn.getExplosivePlacedBy() != null) ? (new EntityDamageSource("explosion.player", (Entity)explosionIn.getExplosivePlacedBy())).setDifficultyScaled().setExplosion() : (new DamageSource("explosion")).setDifficultyScaled().setExplosion();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 215 */     String s1 = String.valueOf(s) + ".player";
