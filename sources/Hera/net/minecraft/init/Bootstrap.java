...
/*  79 */             return (IProjectile)entityarrow;
/*     */           }
/*     */         });
...
/*     */           protected IProjectile getProjectileEntity(World worldIn, IPosition position)
/*     */           {
/*  86 */             return (IProjectile)new EntityEgg(worldIn, position.getX(), position.getY(), position.getZ());
/*     */           }
/*     */         });
...
/*     */           protected IProjectile getProjectileEntity(World worldIn, IPosition position)
/*     */           {
/*  93 */             return (IProjectile)new EntitySnowball(worldIn, position.getX(), position.getY(), position.getZ());
/*     */           }
/*     */         });
...
/*     */           protected IProjectile getProjectileEntity(World worldIn, IPosition position)
/*     */           {
/* 100 */             return (IProjectile)new EntityExpBottle(worldIn, position.getX(), position.getY(), position.getZ());
/*     */           }
/*     */           
...
/* 116 */             return ItemPotion.isSplash(stack.getMetadata()) ? (new BehaviorProjectileDispense()
/*     */               {
/*     */                 protected IProjectile getProjectileEntity(World worldIn, IPosition position)
/*     */                 {
/* 120 */                   return (IProjectile)new EntityPotion(worldIn, position.getX(), position.getY(), position.getZ(), stack.copy());
/*     */                 }
/*     */                 
/*     */                 protected float func_82498_a() {
...
/*     */             
/* 143 */             if (entity instanceof net.minecraft.entity.EntityLivingBase && stack.hasDisplayName())
/*     */             {
...
/* 161 */             source.getWorld().spawnEntityInWorld((Entity)entityfireworkrocket);
...
/* 184 */             world.spawnEntityInWorld((Entity)new EntitySmallFireball(world, d0, d1, d2, d3, d4, d5));
...
/* 222 */             world.spawnEntityInWorld((Entity)entityboat);
...
/*     */           }
/*     */         });
/* 231 */     BehaviorDefaultDispenseItem behaviorDefaultDispenseItem = new BehaviorDefaultDispenseItem()
/*     */       {
...
/*     */       };
/*     */     
/* 251 */     BlockDispenser.dispenseBehaviorRegistry.putObject(Items.lava_bucket, behaviorDefaultDispenseItem);
/* 252 */     BlockDispenser.dispenseBehaviorRegistry.putObject(Items.water_bucket, behaviorDefaultDispenseItem);
...
/*     */ 
/*     */             
/* 265 */             if (Material.water.equals(material) && block instanceof BlockLiquid && ((Integer)iblockstate.getValue((IProperty)BlockLiquid.LEVEL)).intValue() == 0) {
/*     */               
/* 267 */               item = Items.water_bucket;
/*     */             }
/*     */             else {
/*     */               
/* 271 */               if (!Material.lava.equals(material) || !(block instanceof BlockLiquid) || ((Integer)iblockstate.getValue((IProperty)BlockLiquid.LEVEL)).intValue() != 0)
/*     */               {
...
/*     */               
/* 313 */               Blocks.tnt.onBlockDestroyedByPlayer(world, blockpos, Blocks.tnt.getDefaultState().withProperty((IProperty)BlockTNT.EXPLODE, Boolean.valueOf(true)));
...
/* 383 */             world.spawnEntityInWorld((Entity)entitytntprimed);
/* 384 */             world.playSoundAtEntity((Entity)entitytntprimed, "game.tnt.primed", 1.0F, 1.0F);
/* 385 */             stack.stackSize--;
/* 386 */             return stack;
/*     */           }
/*     */         });
...
/*     */               {
/* 403 */                 world.setBlockState(blockpos, blockskull.getDefaultState().withProperty((IProperty)BlockSkull.FACING, (Comparable)EnumFacing.UP), 3);
...
/* 530 */     System.setErr((PrintStream)new LoggingPrintStream("STDERR", System.err));
/* 531 */     System.setOut((PrintStream)new LoggingPrintStream("STDOUT", SYSOUT));
/*     */   }
/*     */ 
/*     */   
