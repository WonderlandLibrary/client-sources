...
/*  56 */     for (i = (arrayOfBlockUpdateData = this.changedBlocks).length, b = 0; b < i; ) { BlockUpdateData s22packetmultiblockchange$blockupdatedata = arrayOfBlockUpdateData[b];
/*     */       
...
/*  95 */       return new BlockPos((Vec3i)S22PacketMultiBlockChange.this.chunkPosCoord.getBlock(this.chunkPosCrammed >> 12 & 0xF, this.chunkPosCrammed & 0xFF, this.chunkPosCrammed >> 8 & 0xF));
/*     */     }
/*     */ 
/*     */     
