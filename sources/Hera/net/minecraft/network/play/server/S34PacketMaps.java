...
/*  79 */     buf.writeVarIntToBuffer(this.mapVisiblePlayersVec4b.length); byte b; int i;
/*     */     Vec4b[] arrayOfVec4b;
/*  81 */     for (i = (arrayOfVec4b = this.mapVisiblePlayersVec4b).length, b = 0; b < i; ) { Vec4b vec4b = arrayOfVec4b[b];
/*     */       
