...
/* 124 */       Set<EnumFlags> set = EnumSet.noneOf(EnumFlags.class); byte b; int i;
/*     */       EnumFlags[] arrayOfEnumFlags;
/* 126 */       for (i = (arrayOfEnumFlags = values()).length, b = 0; b < i; ) { EnumFlags s08packetplayerposlook$enumflags = arrayOfEnumFlags[b];
/*     */         
