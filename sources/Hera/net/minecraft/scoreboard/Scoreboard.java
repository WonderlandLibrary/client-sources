...
/*  30 */     return this.scoreObjectives.get(name);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  53 */     List<ScoreObjective> list = this.scoreObjectiveCriterias.get(criteria);
/*     */     
/*  55 */     if (list == null) {
/*     */       
...
/*  71 */     Collection<ScoreObjective> collection = this.scoreObjectiveCriterias.get(criteria);
...
/*  80 */     Map<ScoreObjective, Score> map = this.entitiesScoreObjectives.get(name);
/*     */     
/*  82 */     if (map == null)
/*     */     {
/*  84 */       return false;
...
/*     */ 
/*     */     
/*  88 */     Score score = map.get(p_178819_2_);
...
/*     */ 
/*     */     
/* 104 */     Map<ScoreObjective, Score> map = this.entitiesScoreObjectives.get(name);
/*     */     
/* 106 */     if (map == null) {
/*     */       
...
/*     */     } 
/*     */     
/* 112 */     Score score = map.get(objective);
/*     */     
/* 114 */     if (score == null) {
/*     */       
...
/*     */       
/* 130 */       Score score = map.get(objective);
/*     */       
/* 132 */       if (score != null)
/*     */       {
/* 134 */         list.add(score);
...
/*     */       
/* 159 */       Map<ScoreObjective, Score> map = this.entitiesScoreObjectives.remove(name);
/*     */       
/* 161 */       if (map != null)
/*     */       {
...
/*     */     else {
/*     */       
/* 168 */       Map<ScoreObjective, Score> map2 = this.entitiesScoreObjectives.get(name);
/*     */       
/* 170 */       if (map2 != null) {
/*     */         
/* 172 */         Score score = map2.remove(objective);
/*     */         
/* 174 */         if (map2.size() < 1) {
/*     */           
/* 176 */           Map<ScoreObjective, Score> map1 = this.entitiesScoreObjectives.remove(name);
/*     */           
/* 178 */           if (map1 != null)
/*     */           {
...
/* 206 */     Map<ScoreObjective, Score> map = this.entitiesScoreObjectives.get(name);
/*     */     
/* 208 */     if (map == null)
/*     */     {
...
/*     */     } 
/*     */     
/* 228 */     List<ScoreObjective> list = this.scoreObjectiveCriterias.get(p_96519_1_.getCriteria());
/*     */     
/* 230 */     if (list != null)
/*     */     {
...
/* 264 */     return this.teams.get(p_96508_1_);
/*     */   }
/*     */ 
/*     */   
...
/* 381 */     return this.teamMemberships.get(p_96509_1_);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 511 */     if (p_181140_1_ != null && !(p_181140_1_ instanceof net.minecraft.entity.player.EntityPlayer) && !p_181140_1_.isEntityAlive()) {
/*     */       
