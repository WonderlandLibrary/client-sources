...
/*  96 */       this.scoreboardMCServer.getConfigurationManager().sendPacketToAllPlayers((Packet)new S3EPacketTeams(scoreplayerteam, Arrays.asList(new String[] { player }, ), 3));
/*  97 */       func_96551_b();
/*  98 */       return true;
/*     */     } 
/*     */ 
...
/*     */     {
/* 132 */       this.scoreboardMCServer.getConfigurationManager().sendPacketToAllPlayers((Packet)new S3BPacketScoreboardObjective(p_96532_1_, 2));
/*     */     }
/*     */     
/* 135 */     func_96551_b();
/*     */   }
...
/* 156 */     this.scoreboardMCServer.getConfigurationManager().sendPacketToAllPlayers((Packet)new S3EPacketTeams(playerTeam, 0));
/* 157 */     func_96551_b();
/*     */   }
/*     */ 
/*     */ 
...
/* 166 */     this.scoreboardMCServer.getConfigurationManager().sendPacketToAllPlayers((Packet)new S3EPacketTeams(playerTeam, 2));
/* 167 */     func_96551_b();
/*     */   }
/*     */ 
/*     */   
...
/* 173 */     this.scoreboardMCServer.getConfigurationManager().sendPacketToAllPlayers((Packet)new S3EPacketTeams(playerTeam, 1));
/* 174 */     func_96551_b();
/*     */   }
/*     */ 
/*     */   
...
/* 192 */     List<Packet> list = Lists.newArrayList();
...
/*     */     
/* 215 */     for (EntityPlayerMP entityplayermp : this.scoreboardMCServer.getConfigurationManager().func_181057_v()) {
/*     */       
/* 217 */       for (Packet packet : list)
/*     */       {
...
/* 228 */     List<Packet> list = Lists.newArrayList();
...
/*     */     
/* 246 */     for (EntityPlayerMP entityplayermp : this.scoreboardMCServer.getConfigurationManager().func_181057_v()) {
/*     */       
/* 248 */       for (Packet packet : list)
/*     */       {
