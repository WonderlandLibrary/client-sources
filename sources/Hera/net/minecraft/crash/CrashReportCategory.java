...
/*     */         
/* 150 */         if (((s2 != null) ? true : false) != ((this.stackTrace.length > 1) ? true : false))
/*     */         {
/* 152 */           return false;
/*     */         }
...
/* 202 */       for (i = (arrayOfStackTraceElement = this.stackTrace).length, b = 0; b < i; ) { StackTraceElement stacktraceelement = arrayOfStackTraceElement[b];
/*     */         
/* 204 */         builder.append("\n\tat ");
...
/* 217 */     final int i = Block.getIdFromBlock(blockIn);
/* 218 */     category.addCrashSectionCallable("Block type", new Callable<String>()
/*     */         {
/*     */           
...
/* 236 */             if (blockData < 0)
/*     */             {
/* 238 */               return "Unknown? (Got " + blockData + ")";
/*     */             }
/*     */ 
/*     */             
...
/*     */         });
/*     */     
/* 247 */     category.addCrashSectionCallable("Block location", new Callable<String>()
/*     */         {
/*     */           public String call() throws Exception
/*     */           {
/* 251 */             return CrashReportCategory.getCoordinateInfo(pos);
/*     */           }
/*     */         });
/*     */   }
/*     */ 
...
/* 258 */     category.addCrashSectionCallable("Block", new Callable<String>()
/*     */         {
/*     */           public String call() throws Exception
/*     */           {
/* 262 */             return state.toString();
/*     */           }
/*     */         });
/* 265 */     category.addCrashSectionCallable("Block location", new Callable<String>()
/*     */         {
/*     */           public String call() throws Exception
/*     */           {
/* 269 */             return CrashReportCategory.getCoordinateInfo(pos);
/*     */           }
/*     */         });
/*     */   }
/*     */ 
