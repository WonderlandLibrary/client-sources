...
/* 123 */     return locationEnchantments.get(new ResourceLocation(location));
/*     */   }
/*     */ 
/*     */   
...
/* 220 */     return String.valueOf(s) + " " + StatCollector.translateToLocal("enchantment.level." + level);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   static {
/* 248 */     List<Enchantment> list = Lists.newArrayList(); byte b; int i;
/*     */     Enchantment[] arrayOfEnchantment;
/* 250 */     for (i = (arrayOfEnchantment = enchantmentsList).length, b = 0; b < i; ) { Enchantment enchantment = arrayOfEnchantment[b];
/*     */       
...
/*     */       b++; }
/*     */     
/* 258 */     enchantmentsBookList = list.<Enchantment>toArray(new Enchantment[list.size()]);
/*     */   }
/*     */ }
