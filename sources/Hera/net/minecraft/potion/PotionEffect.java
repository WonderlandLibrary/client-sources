...
/*     */       
/* 170 */       s = String.valueOf(getEffectName()) + " x " + (getAmplifier() + 1) + ", Duration: " + getDuration();
/*     */     }
/*     */     else {
/*     */       
/* 174 */       s = String.valueOf(getEffectName()) + ", Duration: " + getDuration();
/*     */     } 
/*     */     
/* 177 */     if (this.isSplashPotion)
/*     */     {
/* 179 */       s = String.valueOf(s) + ", Splash: true";
/*     */     }
/*     */     
/* 182 */     if (!this.showParticles)
/*     */     {
/* 184 */       s = String.valueOf(s) + ", Particles: false";
/*     */     }
/*     */     
