...
/* 388 */     List<PotionEffect> list = null; byte b; int i;
/*     */     Potion[] arrayOfPotion;
/* 390 */     for (i = (arrayOfPotion = Potion.potionTypes).length, b = 0; b < i; ) { Potion potion = arrayOfPotion[b];
/*     */       
/* 392 */       if (potion != null && (!potion.isUsable() || p_77917_1_)) {
/*     */         
/* 394 */         String s = potionRequirements.get(Integer.valueOf(potion.getId()));
/*     */         
/* 396 */         if (s != null) {
/*     */           
/* 398 */           int j = parsePotionEffects(s, 0, s.length(), p_77917_0_);
/*     */           
/* 400 */           if (j > 0) {
/*     */             
/* 402 */             int k = 0;
/* 403 */             String s1 = potionAmplifiers.get(Integer.valueOf(potion.getId()));
/*     */             
/* 405 */             if (s1 != null) {
/*     */               
/* 407 */               k = parsePotionEffects(s1, 0, s1.length(), p_77917_0_);
/*     */               
/* 409 */               if (k < 0)
/*     */               {
/* 411 */                 k = 0;
...
/*     */             else {
/*     */               
/* 421 */               j = 1200 * (j * 3 + (j - 1) * 2);
/* 422 */               j >>= k;
/* 423 */               j = (int)Math.round(j * potion.getEffectiveness());
/*     */               
/* 425 */               if ((p_77917_0_ & 0x4000) != 0)
/*     */               {
/* 427 */                 j = (int)Math.round(j * 0.75D + 0.5D);
/*     */               }
/*     */             } 
/*     */             
/* 431 */             if (list == null)
...
/*     */             }
/*     */             
/* 436 */             PotionEffect potioneffect = new PotionEffect(potion.getId(), j, k);
/*     */             
