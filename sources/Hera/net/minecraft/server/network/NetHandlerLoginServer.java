...
/*  91 */       this.networkManager.sendPacket((Packet)new S00PacketDisconnect((IChatComponent)chatcomponenttext));
/*  92 */       this.networkManager.closeChannel((IChatComponent)chatcomponenttext);
/*     */     }
...
/*     */       {
/* 119 */         this.networkManager.sendPacket((Packet)new S03PacketEnableCompression(this.server.getNetworkCompressionTreshold()), (GenericFutureListener)new ChannelFutureListener()
/*     */             {
...
/*     */               }
/* 125 */             },  new GenericFutureListener[0]);
/*     */       }
/*     */       
...
/* 148 */     logger.info(String.valueOf(getConnectionInfo()) + " lost connection: " + reason.getUnformattedText());
/*     */   }
/*     */ 
/*     */   
/*     */   public String getConnectionInfo() {
/* 153 */     return (this.loginGameProfile != null) ? (String.valueOf(this.loginGameProfile.toString()) + " (" + this.networkManager.getRemoteAddress().toString() + ")") : String.valueOf(this.networkManager.getRemoteAddress());
/*     */   }
/*     */ 
/*     */   
