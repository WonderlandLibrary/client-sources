...
/*  128 */     playerIn.setWorld((World)this.mcServer.worldServerForDimension(playerIn.dimension));
...
/*      */     }
/*      */     
/*  137 */     logger.info(String.valueOf(playerIn.getName()) + "[" + s1 + "] logged in with entity id " + playerIn.getEntityId() + " at (" + playerIn.posX + ", " + playerIn.posY + ", " + playerIn.posZ + ")");
...
/*  141 */     setPlayerGameTypeBasedOnOther(playerIn, null, (World)worldserver);
/*  142 */     NetHandlerPlayServer nethandlerplayserver = new NetHandlerPlayServer(this.mcServer, netManager, playerIn);
/*  143 */     nethandlerplayserver.sendPacket((Packet)new S01PacketJoinGame(playerIn.getEntityId(), playerIn.theItemInWorldManager.getGameType(), worldinfo.isHardcoreModeEnabled(), worldserver.provider.getDimensionId(), worldserver.getDifficulty(), getMaxPlayers(), worldinfo.getTerrainType(), worldserver.getGameRules().getBoolean("reducedDebugInfo")));
/*  144 */     nethandlerplayserver.sendPacket((Packet)new S3FPacketCustomPayload("MC|Brand", (new PacketBuffer(Unpooled.buffer())).writeString(getServerInstance().getServerModName())));
/*  145 */     nethandlerplayserver.sendPacket((Packet)new S41PacketServerDifficulty(worldinfo.getDifficulty(), worldinfo.isDifficultyLocked()));
/*  146 */     nethandlerplayserver.sendPacket((Packet)new S05PacketSpawnPosition(blockpos));
/*  147 */     nethandlerplayserver.sendPacket((Packet)new S39PacketPlayerAbilities(playerIn.capabilities));
/*  148 */     nethandlerplayserver.sendPacket((Packet)new S09PacketHeldItemChange(playerIn.inventory.currentItem));
...
/*  165 */     sendChatMsg((IChatComponent)chatcomponenttranslation);
...
/*      */     {
/*  177 */       nethandlerplayserver.sendPacket((Packet)new S1DPacketEntityEffect(playerIn.getEntityId(), potioneffect));
/*      */     }
/*      */     
...
/*      */       
/*  184 */       Entity entity = EntityList.createEntityFromNBT(nbttagcompound.getCompoundTag("Riding"), (World)worldserver);
/*      */       
/*  186 */       if (entity != null) {
/*      */         
...
/*  198 */     Set<ScoreObjective> set = Sets.newHashSet();
/*      */     
/*  200 */     for (ScorePlayerTeam scoreplayerteam : scoreboardIn.getTeams())
/*      */     {
/*  202 */       playerIn.playerNetServerHandler.sendPacket((Packet)new S3EPacketTeams(scoreplayerteam, 0));
/*      */     }
/*      */     
...
/*  227 */     worldServers[0].getWorldBorder().addListener(new IBorderListener()
/*      */         {
/*      */           public void onSizeChanged(WorldBorder border, double newSize)
/*      */           {
/*  231 */             ServerConfigurationManager.this.sendPacketToAllPlayers((Packet)new S44PacketWorldBorder(border, S44PacketWorldBorder.Action.SET_SIZE));
/*      */           }
/*      */           
/*      */           public void onTransitionStarted(WorldBorder border, double oldSize, double newSize, long time) {
/*  235 */             ServerConfigurationManager.this.sendPacketToAllPlayers((Packet)new S44PacketWorldBorder(border, S44PacketWorldBorder.Action.LERP_SIZE));
/*      */           }
/*      */           
/*      */           public void onCenterChanged(WorldBorder border, double x, double z) {
/*  239 */             ServerConfigurationManager.this.sendPacketToAllPlayers((Packet)new S44PacketWorldBorder(border, S44PacketWorldBorder.Action.SET_CENTER));
/*      */           }
/*      */           
/*      */           public void onWarningTimeChanged(WorldBorder border, int newTime) {
/*  243 */             ServerConfigurationManager.this.sendPacketToAllPlayers((Packet)new S44PacketWorldBorder(border, S44PacketWorldBorder.Action.SET_WARNING_TIME));
/*      */           }
/*      */           
/*      */           public void onWarningDistanceChanged(WorldBorder border, int newDistance) {
/*  247 */             ServerConfigurationManager.this.sendPacketToAllPlayers((Packet)new S44PacketWorldBorder(border, S44PacketWorldBorder.Action.SET_WARNING_BLOCKS));
/*      */           }
/*      */ 
/*      */           
...
/*  281 */     NBTTagCompound nbttagcompound1, nbttagcompound = this.mcServer.worldServers[0].getWorldInfo().getPlayerNBTTagCompound();
/*      */ 
/*      */     
/*  284 */     if (playerIn.getName().equals(this.mcServer.getServerOwner()) && nbttagcompound != null) {
/*      */       
/*  286 */       playerIn.readFromNBT(nbttagcompound);
/*  287 */       nbttagcompound1 = nbttagcompound;
/*  288 */       logger.debug("loading single player");
/*      */     }
/*      */     else {
/*      */       
/*  292 */       nbttagcompound1 = this.playerNBTManagerObj.readPlayerData((EntityPlayer)playerIn);
/*      */     } 
/*      */     
...
/*  303 */     this.playerNBTManagerObj.writePlayerData((EntityPlayer)playerIn);
/*  304 */     StatisticsFile statisticsfile = this.playerStatFiles.get(playerIn.getUniqueID());
/*      */     
...
/*  319 */     sendPacketToAllPlayers((Packet)new S38PacketPlayerListItem(S38PacketPlayerListItem.Action.ADD_PLAYER, new EntityPlayerMP[] { playerIn }));
/*  320 */     WorldServer worldserver = this.mcServer.worldServerForDimension(playerIn.dimension);
/*  321 */     worldserver.spawnEntityInWorld((Entity)playerIn);
/*  322 */     preparePlayer(playerIn, null);
/*      */     
/*  324 */     for (int i = 0; i < this.playerEntityList.size(); i++) {
/*      */       
/*  326 */       EntityPlayerMP entityplayermp = this.playerEntityList.get(i);
/*  327 */       playerIn.playerNetServerHandler.sendPacket((Packet)new S38PacketPlayerListItem(S38PacketPlayerListItem.Action.ADD_PLAYER, new EntityPlayerMP[] { entityplayermp }));
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*  344 */     playerIn.triggerAchievement(StatList.leaveGameStat);
...
/*      */     } 
/*      */     
/*  354 */     worldserver.removeEntity((Entity)playerIn);
...
/*  358 */     EntityPlayerMP entityplayermp = this.uuidToPlayerMap.get(uuid);
/*      */     
...
/*      */     } 
/*      */     
/*  366 */     sendPacketToAllPlayers((Packet)new S38PacketPlayerListItem(S38PacketPlayerListItem.Action.REMOVE_PLAYER, new EntityPlayerMP[] { playerIn }));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/*  418 */       EntityPlayerMP entityplayermp = this.playerEntityList.get(i);
/*      */       
...
/*      */     } 
/*      */     
/*  426 */     EntityPlayerMP entityplayermp2 = this.uuidToPlayerMap.get(profile.getId());
/*      */     
...
/*      */       
/*  442 */       DemoWorldManager demoWorldManager = new DemoWorldManager((World)this.mcServer.worldServerForDimension(0));
/*      */     }
/*      */     else {
/*      */       
/*  446 */       iteminworldmanager = new ItemInWorldManager((World)this.mcServer.worldServerForDimension(0));
/*      */     } 
/*      */     
...
/*  458 */     playerIn.getServerForPlayer().getEntityTracker().untrackEntity((Entity)playerIn);
/*  459 */     playerIn.getServerForPlayer().getPlayerManager().removePlayer(playerIn);
/*  460 */     this.playerEntityList.remove(playerIn);
/*  461 */     this.mcServer.worldServerForDimension(playerIn.dimension).removePlayerEntityDangerously((Entity)playerIn);
...
/*      */       
/*  469 */       DemoWorldManager demoWorldManager = new DemoWorldManager((World)this.mcServer.worldServerForDimension(playerIn.dimension));
/*      */     }
/*      */     else {
/*      */       
/*  473 */       iteminworldmanager = new ItemInWorldManager((World)this.mcServer.worldServerForDimension(playerIn.dimension));
/*      */     } 
/*      */     
...
/*  478 */     entityplayermp.clonePlayer((EntityPlayer)playerIn, conqueredEnd);
/*  479 */     entityplayermp.setEntityId(playerIn.getEntityId());
/*  480 */     entityplayermp.func_174817_o((Entity)playerIn);
/*  481 */     WorldServer worldserver = this.mcServer.worldServerForDimension(playerIn.dimension);
/*  482 */     setPlayerGameTypeBasedOnOther(entityplayermp, playerIn, (World)worldserver);
/*      */     
/*  484 */     if (blockpos != null) {
/*      */       
/*  486 */       BlockPos blockpos1 = EntityPlayer.getBedSpawnLocation((World)this.mcServer.worldServerForDimension(playerIn.dimension), blockpos, flag);
/*      */       
...
/*      */       else {
/*      */         
/*  495 */         entityplayermp.playerNetServerHandler.sendPacket((Packet)new S2BPacketChangeGameState(0, 0.0F));
/*      */       } 
/*      */     } 
/*      */     
/*  499 */     worldserver.theChunkProviderServer.loadChunk((int)entityplayermp.posX >> 4, (int)entityplayermp.posZ >> 4);
/*      */     
/*  501 */     while (!worldserver.getCollidingBoundingBoxes((Entity)entityplayermp, entityplayermp.getEntityBoundingBox()).isEmpty() && entityplayermp.posY < 256.0D)
/*      */     {
/*  503 */       entityplayermp.setPosition(entityplayermp.posX, entityplayermp.posY + 1.0D, entityplayermp.posZ);
/*      */     }
/*      */     
/*  506 */     entityplayermp.playerNetServerHandler.sendPacket((Packet)new S07PacketRespawn(entityplayermp.dimension, entityplayermp.worldObj.getDifficulty(), entityplayermp.worldObj.getWorldInfo().getTerrainType(), entityplayermp.theItemInWorldManager.getGameType()));
...
/*  509 */     entityplayermp.playerNetServerHandler.sendPacket((Packet)new S05PacketSpawnPosition(blockpos2));
/*  510 */     entityplayermp.playerNetServerHandler.sendPacket((Packet)new S1FPacketSetExperience(entityplayermp.experience, entityplayermp.experienceTotal, entityplayermp.experienceLevel));
/*  511 */     updateTimeAndWeatherForPlayer(entityplayermp, worldserver);
/*  512 */     worldserver.getPlayerManager().addPlayer(entityplayermp);
/*  513 */     worldserver.spawnEntityInWorld((Entity)entityplayermp);
...
/*  530 */     playerIn.playerNetServerHandler.sendPacket((Packet)new S07PacketRespawn(playerIn.dimension, playerIn.worldObj.getDifficulty(), playerIn.worldObj.getWorldInfo().getTerrainType(), playerIn.theItemInWorldManager.getGameType()));
/*  531 */     worldserver.removePlayerEntityDangerously((Entity)playerIn);
/*  532 */     playerIn.isDead = false;
/*  533 */     transferEntityToWorld((Entity)playerIn, i, worldserver, worldserver1);
...
/*      */     {
/*  542 */       playerIn.playerNetServerHandler.sendPacket((Packet)new S1DPacketEntityEffect(playerIn.getEntityId(), potioneffect));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */     } 
/*      */     
/*  622 */     entityIn.setWorld((World)p_82448_4_);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/*  632 */       sendPacketToAllPlayers((Packet)new S38PacketPlayerListItem(S38PacketPlayerListItem.Action.UPDATE_LATENCY, this.playerEntityList));
...
/*      */       
/*  649 */       EntityPlayerMP entityplayermp = this.playerEntityList.get(i);
/*      */       
...
/*      */         
/*  688 */         EntityPlayerMP entityplayermp = this.playerEntityList.get(i);
/*      */         
...
/*  705 */       if (i > 0)
/*      */       {
/*  707 */         s = String.valueOf(s) + ", ";
/*      */       }
/*      */       
/*  710 */       s = String.valueOf(s) + ((EntityPlayerMP)list.get(i)).getName();
/*      */       
/*  712 */       if (p_181058_1_)
/*      */       {
/*  714 */         s = String.valueOf(s) + " (" + ((EntityPlayerMP)list.get(i)).getUniqueID().toString() + ")";
/*      */       }
/*      */     } 
/*      */     
/*  718 */     return s;
...
/*      */       
/*  807 */       EntityPlayerMP entityplayermp = this.playerEntityList.get(i);
/*      */       
...
/*      */     {
/*  830 */       writePlayerData(this.playerEntityList.get(i));
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/*  877 */     playerIn.playerNetServerHandler.sendPacket((Packet)new S44PacketWorldBorder(worldborder, S44PacketWorldBorder.Action.INITIALIZE));
/*  878 */     playerIn.playerNetServerHandler.sendPacket((Packet)new S03PacketTimeUpdate(worldIn.getTotalWorldTime(), worldIn.getWorldTime(), worldIn.getGameRules().getBoolean("doDaylightCycle")));
/*      */     
/*  880 */     if (worldIn.isRaining()) {
/*      */       
/*  882 */       playerIn.playerNetServerHandler.sendPacket((Packet)new S2BPacketChangeGameState(1, 0.0F));
/*  883 */       playerIn.playerNetServerHandler.sendPacket((Packet)new S2BPacketChangeGameState(7, worldIn.getRainStrength(1.0F)));
/*  884 */       playerIn.playerNetServerHandler.sendPacket((Packet)new S2BPacketChangeGameState(8, worldIn.getThunderStrength(1.0F)));
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*  895 */     playerIn.playerNetServerHandler.sendPacket((Packet)new S09PacketHeldItemChange(playerIn.inventory.currentItem));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1005 */     sendPacketToAllPlayers((Packet)new S02PacketChat(component, b0));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1019 */     StatisticsFile statisticsfile = (uuid == null) ? null : this.playerStatFiles.get(uuid);
/*      */     
...
/* 1024 */       File file2 = new File(file1, String.valueOf(uuid.toString()) + ".json");
/*      */       
/* 1026 */       if (!file2.exists()) {
/*      */         
/* 1028 */         File file3 = new File(file1, String.valueOf(playerIn.getName()) + ".json");
/*      */         
...
/* 1050 */       for (i = (arrayOfWorldServer = this.mcServer.worldServers).length, b = 0; b < i; ) { WorldServer worldserver = arrayOfWorldServer[b];
/*      */         
...
/* 1070 */     return this.uuidToPlayerMap.get(playerUUID);
/*      */   }
/*      */ 
/*      */   
