...
/* 153 */     return getDefaultState().withProperty((IProperty)LAYERS, Integer.valueOf((meta & 0x7) + 1));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 161 */     return (((Integer)worldIn.getBlockState(pos).getValue((IProperty)LAYERS)).intValue() == 1);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 169 */     return ((Integer)state.getValue((IProperty)LAYERS)).intValue() - 1;
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 174 */     return new BlockState(this, new IProperty[] { (IProperty)LAYERS });
/*     */   }
/*     */ }
