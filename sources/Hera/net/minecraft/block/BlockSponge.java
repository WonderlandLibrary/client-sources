...
/*  40 */     return StatCollector.translateToLocal(String.valueOf(getUnlocalizedName()) + ".dry.name");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  49 */     return ((Boolean)state.getValue((IProperty)WET)).booleanValue() ? 1 : 0;
/*     */   }
/*     */ 
/*     */   
...
/*  68 */     if (!((Boolean)state.getValue((IProperty)WET)).booleanValue() && absorb(worldIn, pos)) {
/*     */       
/*  70 */       worldIn.setBlockState(pos, state.withProperty((IProperty)WET, Boolean.valueOf(true)), 2);
...
/*     */       
/*  84 */       Tuple<BlockPos, Integer> tuple = queue.poll();
/*  85 */       BlockPos blockpos = (BlockPos)tuple.getFirst();
/*  86 */       int j = ((Integer)tuple.getSecond()).intValue(); byte b; int k;
/*     */       EnumFacing[] arrayOfEnumFacing;
/*  88 */       for (k = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < k; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*     */         
...
/* 133 */     return getDefaultState().withProperty((IProperty)WET, Boolean.valueOf(((meta & 0x1) == 1)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 141 */     return ((Boolean)state.getValue((IProperty)WET)).booleanValue() ? 1 : 0;
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 146 */     return new BlockState(this, new IProperty[] { (IProperty)WET });
/*     */   }
/*     */ 
/*     */   
/*     */   public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
/* 151 */     if (((Boolean)state.getValue((IProperty)WET)).booleanValue()) {
/*     */       
/* 153 */       EnumFacing enumfacing = EnumFacing.random(rand);
/*     */       
/* 155 */       if (enumfacing != EnumFacing.UP && !World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.offset(enumfacing))) {
/*     */         
