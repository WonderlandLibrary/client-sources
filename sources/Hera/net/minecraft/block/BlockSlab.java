...
/*     */       {
/*  57 */         if (iblockstate.getValue((IProperty)HALF) == EnumBlockHalf.TOP) {
/*     */           
...
/*  89 */     setBlockBoundsBasedOnState((IBlockAccess)worldIn, pos);
...
/* 107 */     IBlockState iblockstate = super.onBlockPlaced(worldIn, pos, facing, hitX, hitY, hitZ, meta, placer).withProperty((IProperty)HALF, EnumBlockHalf.BOTTOM);
/* 108 */     return isDouble() ? iblockstate : ((facing != EnumFacing.DOWN && (facing == EnumFacing.UP || hitY <= 0.5D)) ? iblockstate : iblockstate.withProperty((IProperty)HALF, EnumBlockHalf.TOP));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 139 */     boolean flag = (isSlab(iblockstate.getBlock()) && iblockstate.getValue((IProperty)HALF) == EnumBlockHalf.TOP);
/* 140 */     boolean flag1 = (isSlab(iblockstate1.getBlock()) && iblockstate1.getValue((IProperty)HALF) == EnumBlockHalf.TOP);
/* 141 */     return flag1 ? ((side == EnumFacing.DOWN) ? true : ((side == EnumFacing.UP && super.shouldSideBeRendered(worldIn, pos, side)) ? true : (!(isSlab(iblockstate.getBlock()) && flag)))) : ((side == EnumFacing.UP) ? true : ((side == EnumFacing.DOWN && super.shouldSideBeRendered(worldIn, pos, side)) ? true : (!(isSlab(iblockstate.getBlock()) && !flag))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
