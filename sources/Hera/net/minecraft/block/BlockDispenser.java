...
/*     */       
/*  63 */       EnumFacing enumfacing = (EnumFacing)state.getValue((IProperty)FACING);
...
/*     */       } 
/*     */       
/*  90 */       worldIn.setBlockState(pos, state.withProperty((IProperty)FACING, (Comparable)enumfacing).withProperty((IProperty)TRIGGERED, Boolean.valueOf(false)), 2);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 106 */       playerIn.displayGUIChest((IInventory)tileentity);
/*     */       
/* 108 */       if (tileentity instanceof net.minecraft.tileentity.TileEntityDropper) {
/*     */         
...
/* 125 */     TileEntityDispenser tileentitydispenser = blocksourceimpl.<TileEntityDispenser>getBlockTileEntity();
/*     */     
...
/* 160 */     boolean flag1 = ((Boolean)state.getValue((IProperty)TRIGGERED)).booleanValue();
/*     */     
/* 162 */     if (flag && !flag1) {
/*     */       
/* 164 */       worldIn.scheduleUpdate(pos, this, tickRate(worldIn));
/* 165 */       worldIn.setBlockState(pos, state.withProperty((IProperty)TRIGGERED, Boolean.valueOf(true)), 4);
/*     */     }
/* 167 */     else if (!flag && flag1) {
/*     */       
/* 169 */       worldIn.setBlockState(pos, state.withProperty((IProperty)TRIGGERED, Boolean.valueOf(false)), 4);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 186 */     return (TileEntity)new TileEntityDispenser();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 195 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)BlockPistonBase.getFacingFromEntity(worldIn, pos, placer)).withProperty((IProperty)TRIGGERED, Boolean.valueOf(false));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 203 */     worldIn.setBlockState(pos, state.withProperty((IProperty)FACING, (Comparable)BlockPistonBase.getFacingFromEntity(worldIn, pos, placer)), 2);
/*     */     
...
/*     */       
/* 222 */       InventoryHelper.dropInventoryItems(worldIn, pos, (IInventory)tileentity);
...
/* 238 */     return (IPosition)new PositionImpl(d0, d1, d2);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 272 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)EnumFacing.SOUTH);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 280 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)getFacing(meta)).withProperty((IProperty)TRIGGERED, Boolean.valueOf(((meta & 0x8) > 0)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 288 */     int i = 0;
/* 289 */     i |= ((EnumFacing)state.getValue((IProperty)FACING)).getIndex();
/*     */     
/* 291 */     if (((Boolean)state.getValue((IProperty)TRIGGERED)).booleanValue())
/*     */     {
/* 293 */       i |= 0x8;
/*     */     }
/*     */     
...
/* 301 */     return new BlockState(this, new IProperty[] { (IProperty)FACING, (IProperty)TRIGGERED });
/*     */   }
/*     */ }
