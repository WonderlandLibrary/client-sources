...
/*     */         
/*  81 */         if (!(entityIn instanceof net.minecraft.entity.player.EntityPlayer) && !worldIn.getGameRules().getBoolean("mobGriefing")) {
/*     */           return;
/*     */         }
/*     */ 
/*     */         
...
/*     */       
/* 103 */       if (worldIn.getBlockState((BlockPos)blockpos$mutableblockpos).getBlock().getMaterial() == Material.water)
/*     */       {
/* 105 */         return true;
/*     */       }
/*     */     } 
...
/*     */       case WEST:
/*     */       case EAST:
/* 136 */         block = worldIn.getBlockState(pos).getBlock();
...
/* 149 */     return Blocks.dirt.getItemDropped(Blocks.dirt.getDefaultState().withProperty((IProperty)BlockDirt.VARIANT, BlockDirt.DirtType.DIRT), rand, fortune);
/*     */   }
/*     */ 
/*     */   
...
/* 162 */     return getDefaultState().withProperty((IProperty)MOISTURE, Integer.valueOf(meta & 0x7));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 170 */     return ((Integer)state.getValue((IProperty)MOISTURE)).intValue();
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 175 */     return new BlockState(this, new IProperty[] { (IProperty)MOISTURE });
/*     */   }
/*     */ }
