...
/*     */     {
/*  64 */       if (!((Boolean)state.getValue((IProperty)POWERED)).booleanValue())
/*     */       {
...
/*  80 */     if (!worldIn.isRemote && ((Boolean)state.getValue((IProperty)POWERED)).booleanValue())
/*     */     {
...
/*  88 */     return ((Boolean)state.getValue((IProperty)POWERED)).booleanValue() ? 15 : 0;
/*     */   }
/*     */ 
/*     */   
/*     */   public int getStrongPower(IBlockAccess worldIn, BlockPos pos, IBlockState state, EnumFacing side) {
/*  93 */     return !((Boolean)state.getValue((IProperty)POWERED)).booleanValue() ? 0 : ((side == EnumFacing.UP) ? 15 : 0);
/*     */   }
/*     */ 
/*     */   
/*     */   private void updatePoweredState(World worldIn, BlockPos pos, IBlockState state) {
/*  98 */     boolean flag = ((Boolean)state.getValue((IProperty)POWERED)).booleanValue();
/*  99 */     boolean flag1 = false;
/* 100 */     List<EntityMinecart> list = findMinecarts(worldIn, pos, EntityMinecart.class, (Predicate<Entity>[])new Predicate[0]);
/*     */     
/* 102 */     if (!list.isEmpty())
/*     */     {
/* 104 */       flag1 = true;
...
/* 107 */     if (flag1 && !flag) {
/*     */       
/* 109 */       worldIn.setBlockState(pos, state.withProperty((IProperty)POWERED, Boolean.valueOf(true)), 3);
...
/* 115 */     if (!flag1 && flag) {
/*     */       
/* 117 */       worldIn.setBlockState(pos, state.withProperty((IProperty)POWERED, Boolean.valueOf(false)), 3);
...
/* 139 */     return (IProperty<BlockRailBase.EnumRailDirection>)SHAPE;
/*     */   }
/*     */ 
/*     */   
...
/* 149 */     if (((Boolean)worldIn.getBlockState(pos).getValue((IProperty)POWERED)).booleanValue()) {
/*     */       
/* 151 */       List<EntityMinecartCommandBlock> list = findMinecarts(worldIn, pos, EntityMinecartCommandBlock.class, (Predicate<Entity>[])new Predicate[0]);
/*     */       
/* 153 */       if (!list.isEmpty())
/*     */       {
...
/*     */       }
/*     */       
/* 158 */       List<EntityMinecart> list1 = findMinecarts(worldIn, pos, EntityMinecart.class, (Predicate<Entity>[])new Predicate[] { EntitySelectors.selectInventories });
/*     */       
...
/* 186 */     return getDefaultState().withProperty((IProperty)SHAPE, BlockRailBase.EnumRailDirection.byMetadata(meta & 0x7)).withProperty((IProperty)POWERED, Boolean.valueOf(((meta & 0x8) > 0)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 194 */     int i = 0;
/* 195 */     i |= ((BlockRailBase.EnumRailDirection)state.getValue((IProperty)SHAPE)).getMetadata();
/*     */     
/* 197 */     if (((Boolean)state.getValue((IProperty)POWERED)).booleanValue())
/*     */     {
/* 199 */       i |= 0x8;
/*     */     }
/*     */     
...
/* 207 */     return new BlockState(this, new IProperty[] { (IProperty)SHAPE, (IProperty)POWERED });
/*     */   }
/*     */ }
