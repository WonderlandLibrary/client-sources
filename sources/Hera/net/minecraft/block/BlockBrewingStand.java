...
/*     */     {
/* 145 */       InventoryHelper.dropInventoryItems(worldIn, pos, (IInventory)tileentity);
/*     */     }
/*     */     
...
/*     */     {
/* 188 */       iblockstate = iblockstate.withProperty((IProperty)HAS_BOTTLE[i], Boolean.valueOf(((meta & 1 << i) > 0)));
/*     */     }
/*     */     
...
/*     */       
/* 203 */       if (((Boolean)state.getValue((IProperty)HAS_BOTTLE[j])).booleanValue())
/*     */       {
/* 205 */         i |= 1 << j;
/*     */       }
/*     */     } 
...
/* 214 */     return new BlockState(this, new IProperty[] { (IProperty)HAS_BOTTLE[0], (IProperty)HAS_BOTTLE[1], (IProperty)HAS_BOTTLE[2] });
/*     */   }
/*     */ }
