...
/*  46 */       boolean flag1 = ((Boolean)state.getValue((IProperty)TRIGGERED)).booleanValue();
/*     */       
/*  48 */       if (flag && !flag1) {
/*     */         
/*  50 */         worldIn.setBlockState(pos, state.withProperty((IProperty)TRIGGERED, Boolean.valueOf(true)), 4);
/*  51 */         worldIn.scheduleUpdate(pos, this, tickRate(worldIn));
/*     */       }
/*  53 */       else if (!flag && flag1) {
/*     */         
/*  55 */         worldIn.setBlockState(pos, state.withProperty((IProperty)TRIGGERED, Boolean.valueOf(false)), 4);
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/* 140 */     return getDefaultState().withProperty((IProperty)TRIGGERED, Boolean.valueOf(((meta & 0x1) > 0)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 148 */     int i = 0;
/*     */     
/* 150 */     if (((Boolean)state.getValue((IProperty)TRIGGERED)).booleanValue())
/*     */     {
/* 152 */       i |= 0x1;
/*     */     }
/*     */     
...
/* 160 */     return new BlockState(this, new IProperty[] { (IProperty)TRIGGERED });
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 169 */     return getDefaultState().withProperty((IProperty)TRIGGERED, Boolean.valueOf(false));
/*     */   }
/*     */ }
