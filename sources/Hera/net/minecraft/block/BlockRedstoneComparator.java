...
/*  69 */     Boolean obool = (Boolean)unpoweredState.getValue((IProperty)POWERED);
/*  70 */     Mode blockredstonecomparator$mode = (Mode)unpoweredState.getValue((IProperty)MODE);
/*  71 */     EnumFacing enumfacing = (EnumFacing)unpoweredState.getValue((IProperty)FACING);
/*  72 */     return Blocks.powered_comparator.getDefaultState().withProperty((IProperty)FACING, (Comparable)enumfacing).withProperty((IProperty)POWERED, obool).withProperty((IProperty)MODE, blockredstonecomparator$mode);
/*     */   }
/*     */ 
/*     */   
/*     */   protected IBlockState getUnpoweredState(IBlockState poweredState) {
/*  77 */     Boolean obool = (Boolean)poweredState.getValue((IProperty)POWERED);
/*  78 */     Mode blockredstonecomparator$mode = (Mode)poweredState.getValue((IProperty)MODE);
/*  79 */     EnumFacing enumfacing = (EnumFacing)poweredState.getValue((IProperty)FACING);
/*  80 */     return Blocks.unpowered_comparator.getDefaultState().withProperty((IProperty)FACING, (Comparable)enumfacing).withProperty((IProperty)POWERED, obool).withProperty((IProperty)MODE, blockredstonecomparator$mode);
/*     */   }
/*     */ 
/*     */   
/*     */   protected boolean isPowered(IBlockState state) {
/*  85 */     return !(!this.isRepeaterPowered && !((Boolean)state.getValue((IProperty)POWERED)).booleanValue());
/*     */   }
/*     */ 
/*     */   
...
/*  96 */     return (state.getValue((IProperty)MODE) == Mode.SUBTRACT) ? Math.max(calculateInputStrength(worldIn, pos, state) - getPowerOnSides((IBlockAccess)worldIn, pos, state), 0) : calculateInputStrength(worldIn, pos, state);
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/* 113 */     int j = getPowerOnSides((IBlockAccess)worldIn, pos, state);
/* 114 */     return (j == 0) ? true : ((i >= j));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 154 */     List<EntityItemFrame> list = worldIn.getEntitiesWithinAABB(EntityItemFrame.class, new AxisAlignedBB(pos.getX(), pos.getY(), pos.getZ(), (pos.getX() + 1), (pos.getY() + 1), (pos.getZ() + 1)), new Predicate<Entity>()
/*     */         {
...
/*     */           }
/*     */         });
/* 161 */     return (list.size() == 1) ? list.get(0) : null;
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/* 172 */     state = state.cycleProperty((IProperty)MODE);
/* 173 */     worldIn.playSoundEffect(pos.getX() + 0.5D, pos.getY() + 0.5D, pos.getZ() + 0.5D, "random.click", 0.3F, (state.getValue((IProperty)MODE) == Mode.SUBTRACT) ? 0.55F : 0.5F);
...
/*     */     } 
/*     */     
/* 215 */     if (j != i || state.getValue((IProperty)MODE) == Mode.COMPARE) {
/*     */       
...
/* 220 */       if (flag && !flag1) {
/*     */         
/* 222 */         worldIn.setBlockState(pos, state.withProperty((IProperty)POWERED, Boolean.valueOf(false)), 2);
/*     */       }
/* 224 */       else if (!flag && flag1) {
/*     */         
/* 226 */         worldIn.setBlockState(pos, state.withProperty((IProperty)POWERED, Boolean.valueOf(true)), 2);
/*     */       } 
/*     */       
...
/*     */     {
/* 237 */       worldIn.setBlockState(pos, getUnpoweredState(state).withProperty((IProperty)POWERED, Boolean.valueOf(true)), 4);
/*     */     }
/*     */     
...
/* 271 */     return (TileEntity)new TileEntityComparator();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 279 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)EnumFacing.getHorizontal(meta)).withProperty((IProperty)POWERED, Boolean.valueOf(((meta & 0x8) > 0))).withProperty((IProperty)MODE, ((meta & 0x4) > 0) ? Mode.SUBTRACT : Mode.COMPARE);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 287 */     int i = 0;
/* 288 */     i |= ((EnumFacing)state.getValue((IProperty)FACING)).getHorizontalIndex();
/*     */     
/* 290 */     if (((Boolean)state.getValue((IProperty)POWERED)).booleanValue())
/*     */     {
/* 292 */       i |= 0x8;
/*     */     }
/*     */     
/* 295 */     if (state.getValue((IProperty)MODE) == Mode.SUBTRACT)
/*     */     {
/* 297 */       i |= 0x4;
/*     */     }
/*     */     
...
/* 305 */     return new BlockState(this, new IProperty[] { (IProperty)FACING, (IProperty)MODE, (IProperty)POWERED });
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 314 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)placer.getHorizontalFacing().getOpposite()).withProperty((IProperty)POWERED, Boolean.valueOf(false)).withProperty((IProperty)MODE, Mode.COMPARE);
/*     */   }
/*     */   
/*     */   public enum Mode
