...
/*  34 */     return World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.down()) ? super.canPlaceBlockAt(worldIn, pos) : false;
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean canBlockStay(World worldIn, BlockPos pos) {
/*  39 */     return World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.down());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  51 */     if (!isLocked((IBlockAccess)worldIn, pos, state)) {
/*     */       
...
/*  88 */     return !isPowered(state) ? 0 : ((state.getValue((IProperty)FACING) == side) ? getActiveSignal(worldIn, pos, state) : 0);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 103 */       worldIn.setBlockToAir(pos); byte b; int i;
/*     */       EnumFacing[] arrayOfEnumFacing;
/* 105 */       for (i = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < i; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*     */         
...
/* 114 */     if (!isLocked((IBlockAccess)worldIn, pos, state)) {
/*     */       
...
/* 148 */     EnumFacing enumfacing = (EnumFacing)state.getValue((IProperty)FACING);
...
/* 159 */     return Math.max(i, (iblockstate.getBlock() == Blocks.redstone_wire) ? ((Integer)iblockstate.getValue((IProperty)BlockRedstoneWire.POWER)).intValue() : 0);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 175 */     return canPowerSide(block) ? ((block == Blocks.redstone_wire) ? ((Integer)iblockstate.getValue((IProperty)BlockRedstoneWire.POWER)).intValue() : worldIn.getStrongPower(pos, side)) : 0;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 192 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)placer.getHorizontalFacing().getOpposite());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 213 */     EnumFacing enumfacing = (EnumFacing)state.getValue((IProperty)FACING);
...
/* 226 */       for (i = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < i; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*     */         
...
/* 265 */     EnumFacing enumfacing = ((EnumFacing)state.getValue((IProperty)FACING)).getOpposite();
/* 266 */     BlockPos blockpos = pos.offset(enumfacing);
/* 267 */     return isRedstoneRepeaterBlockID(worldIn.getBlockState(blockpos).getBlock()) ? ((worldIn.getBlockState(blockpos).getValue((IProperty)FACING) != enumfacing)) : false;
/*     */   }
/*     */ 
/*     */   
