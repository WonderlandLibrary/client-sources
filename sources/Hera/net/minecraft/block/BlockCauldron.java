...
/*  83 */     int i = ((Integer)state.getValue((IProperty)LEVEL)).intValue();
...
/*     */ 
/*     */     
/* 109 */     int i = ((Integer)state.getValue((IProperty)LEVEL)).intValue();
...
/*     */           
/* 133 */           ItemStack itemstack2 = new ItemStack((Item)Items.potionitem, 1, 0);
/*     */           
/* 135 */           if (!playerIn.inventory.addItemStackToInventory(itemstack2)) {
/*     */             
/* 137 */             worldIn.spawnEntityInWorld((Entity)new EntityItem(worldIn, pos.getX() + 0.5D, pos.getY() + 1.5D, pos.getZ() + 0.5D, itemstack2));
/*     */           }
...
/*     */           
/* 187 */           worldIn.spawnEntityInWorld((Entity)new EntityItem(worldIn, pos.getX() + 0.5D, pos.getY() + 1.5D, pos.getZ() + 0.5D, itemstack1));
/*     */         }
...
/* 220 */     worldIn.setBlockState(pos, state.withProperty((IProperty)LEVEL, Integer.valueOf(MathHelper.clamp_int(level, 0, 3))), 2);
...
/*     */       
/* 233 */       if (((Integer)iblockstate.getValue((IProperty)LEVEL)).intValue() < 3)
/*     */       {
/* 235 */         worldIn.setBlockState(pos, iblockstate.cycleProperty((IProperty)LEVEL), 2);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 260 */     return ((Integer)worldIn.getBlockState(pos).getValue((IProperty)LEVEL)).intValue();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 268 */     return getDefaultState().withProperty((IProperty)LEVEL, Integer.valueOf(meta));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 276 */     return ((Integer)state.getValue((IProperty)LEVEL)).intValue();
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 281 */     return new BlockState(this, new IProperty[] { (IProperty)LEVEL });
/*     */   }
/*     */ }
