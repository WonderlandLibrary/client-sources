...
/* 27 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)POWER, Integer.valueOf(0)));
...
/* 53 */     return state.withProperty((IProperty)POWER, Integer.valueOf(strength));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 69 */     return getDefaultState().withProperty((IProperty)POWER, Integer.valueOf(meta));
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 77 */     return ((Integer)state.getValue((IProperty)POWER)).intValue();
/*    */   }
/*    */ 
/*    */   
/*    */   protected BlockState createBlockState() {
/* 82 */     return new BlockState(this, new IProperty[] { (IProperty)POWER });
/*    */   }
/*    */ }
