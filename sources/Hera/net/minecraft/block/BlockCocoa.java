...
/*  72 */     setBlockBoundsBasedOnState((IBlockAccess)worldIn, pos);
/*  73 */     return super.getCollisionBoundingBox(worldIn, pos, state);
/*     */   }
/*     */ 
/*     */   
/*     */   public AxisAlignedBB getSelectedBoundingBox(World worldIn, BlockPos pos) {
/*  78 */     setBlockBoundsBasedOnState((IBlockAccess)worldIn, pos);
...
/*  86 */     EnumFacing enumfacing = (EnumFacing)iblockstate.getValue((IProperty)FACING);
/*  87 */     int i = ((Integer)iblockstate.getValue((IProperty)AGE)).intValue();
/*  88 */     int j = 4 + i * 2;
/*  89 */     int k = 5 + i * 2;
/*  90 */     float f = j / 2.0F;
/*     */     
...
/* 117 */     worldIn.setBlockState(pos, state.withProperty((IProperty)FACING, (Comparable)enumfacing), 2);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 131 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)facing.getOpposite()).withProperty((IProperty)AGE, Integer.valueOf(0));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 156 */     int i = ((Integer)state.getValue((IProperty)AGE)).intValue();
/* 157 */     int j = 1;
/*     */     
/* 159 */     if (i >= 2)
/*     */     {
...
/* 185 */     return (((Integer)state.getValue((IProperty)AGE)).intValue() < 2);
/*     */   }
/*     */ 
/*     */   
...
/* 195 */     worldIn.setBlockState(pos, state.withProperty((IProperty)AGE, Integer.valueOf(((Integer)state.getValue((IProperty)AGE)).intValue() + 1)), 2);
/*     */   }
/*     */ 
/*     */   
...
/* 208 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)EnumFacing.getHorizontal(meta)).withProperty((IProperty)AGE, Integer.valueOf((meta & 0xF) >> 2));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 216 */     int i = 0;
/* 217 */     i |= ((EnumFacing)state.getValue((IProperty)FACING)).getHorizontalIndex();
/* 218 */     i |= ((Integer)state.getValue((IProperty)AGE)).intValue() << 2;
/* 219 */     return i;
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 224 */     return new BlockState(this, new IProperty[] { (IProperty)FACING, (IProperty)AGE });
/*     */   }
/*     */ }
