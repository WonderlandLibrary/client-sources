...
/* 116 */       itemstack.setTagInfo("BlockEntityTag", (NBTBase)nbttagcompound);
...
/* 138 */       itemstack.setTagInfo("BlockEntityTag", (NBTBase)nbttagcompound);
...
/* 151 */       setDefaultState(this.blockState.getBaseState().withProperty((IProperty)FACING, (Comparable)EnumFacing.NORTH));
/*     */     }
/*     */ 
/*     */     
/*     */     public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos) {
/* 156 */       EnumFacing enumfacing = (EnumFacing)worldIn.getBlockState(pos).getValue((IProperty)FACING);
/* 157 */       float f = 0.0F;
...
/*     */         
/*     */         case WEST:
/* 176 */           setBlockBounds(1.0F - f4, f, f2, 1.0F, f1, f3); return;
/*     */         case EAST:
/*     */           break;
/*     */       } 
...
/* 186 */       EnumFacing enumfacing = (EnumFacing)state.getValue((IProperty)FACING);
/*     */       
...
/*     */       
/* 201 */       if (enumfacing.getAxis() == EnumFacing.Axis.Y)
/*     */       {
/* 203 */         enumfacing = EnumFacing.NORTH;
/*     */       }
/*     */       
/* 206 */       return getDefaultState().withProperty((IProperty)FACING, (Comparable)enumfacing);
/*     */     }
/*     */ 
/*     */     
/*     */     public int getMetaFromState(IBlockState state) {
/* 211 */       return ((EnumFacing)state.getValue((IProperty)FACING)).getIndex();
/*     */     }
/*     */ 
/*     */     
/*     */     protected BlockState createBlockState() {
/* 216 */       return new BlockState(this, new IProperty[] { (IProperty)FACING });
/*     */     }
/*     */   }
/*     */   
...
/* 224 */       setDefaultState(this.blockState.getBaseState().withProperty((IProperty)ROTATION, Integer.valueOf(0)));
/*     */     }
/*     */ 
/*     */     
/*     */     public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock) {
...
/*     */     
/*     */     public IBlockState getStateFromMeta(int meta) {
/* 240 */       return getDefaultState().withProperty((IProperty)ROTATION, Integer.valueOf(meta));
/*     */     }
/*     */ 
/*     */     
/*     */     public int getMetaFromState(IBlockState state) {
/* 245 */       return ((Integer)state.getValue((IProperty)ROTATION)).intValue();
/*     */     }
/*     */ 
/*     */     
/*     */     protected BlockState createBlockState() {
/* 250 */       return new BlockState(this, new IProperty[] { (IProperty)ROTATION });
/*     */     }
/*     */   }
/*     */ }
