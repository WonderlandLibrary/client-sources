...
/*  33 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)POWER, Integer.valueOf(0)));
...
/*  48 */     return ((Integer)state.getValue((IProperty)POWER)).intValue();
/*     */   }
/*     */ 
/*     */   
...
/*  56 */       int i = worldIn.getLightFor(EnumSkyBlock.SKY, pos) - worldIn.getSkylightSubtracted();
...
/*     */       }
/*     */       
/*  68 */       if (((Integer)iblockstate.getValue((IProperty)POWER)).intValue() != i)
/*     */       {
/*  70 */         worldIn.setBlockState(pos, iblockstate.withProperty((IProperty)POWER, Integer.valueOf(i)), 3);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/*  85 */       if (this.inverted) {
/*     */         
/*  87 */         worldIn.setBlockState(pos, Blocks.daylight_detector.getDefaultState().withProperty((IProperty)POWER, state.getValue((IProperty)POWER)), 4);
/*  88 */         Blocks.daylight_detector.updatePower(worldIn, pos);
/*     */       }
/*     */       else {
/*     */         
/*  92 */         worldIn.setBlockState(pos, Blocks.daylight_detector_inverted.getDefaultState().withProperty((IProperty)POWER, state.getValue((IProperty)POWER)), 4);
...
/* 152 */     return (TileEntity)new TileEntityDaylightDetector();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 160 */     return getDefaultState().withProperty((IProperty)POWER, Integer.valueOf(meta));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 168 */     return ((Integer)state.getValue((IProperty)POWER)).intValue();
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 173 */     return new BlockState(this, new IProperty[] { (IProperty)POWER });
/*     */   }
/*     */ 
/*     */ 
/*     */ 
