...
/*     */       {
/* 109 */         return getDefaultState().withProperty((IProperty)FACING, (Comparable)enumfacing);
/*     */       }
/*     */     } 
/*     */     
...
/* 167 */     if (state.getBlock() == this && canPlaceAt(worldIn, pos, (EnumFacing)state.getValue((IProperty)FACING)))
/*     */     {
/* 169 */       return true;
/*     */     }
/*     */ 
...
/* 188 */     EnumFacing enumfacing = (EnumFacing)worldIn.getBlockState(pos).getValue((IProperty)FACING);
/* 189 */     float f = 0.15F;
/*     */     
...
/* 218 */     EnumFacing enumfacing = (EnumFacing)state.getValue((IProperty)FACING);
...
/*     */     
/*     */     { case 1:
/* 253 */         iblockstate = iblockstate.withProperty((IProperty)FACING, (Comparable)EnumFacing.EAST);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 281 */     int i = 0;
/*     */     
/* 283 */     switch ((EnumFacing)state.getValue((IProperty)FACING))
/*     */     
/*     */     { case EAST:
/* 286 */         i |= 0x1;
/*     */ 
...
/*     */ 
/*     */         
/* 307 */         return i;case WEST: i |= 0x2; return i;case SOUTH: i |= 0x3; return i;case NORTH: i |= 0x4; return i; }  i |= 0x5; return i;
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 312 */     return new BlockState(this, new IProperty[] { (IProperty)FACING });
/*     */   }
/*     */ }
