...
/*     */     
/* 151 */     if (flag != ((Boolean)state.getValue((IProperty)ENABLED)).booleanValue())
/*     */     {
/* 153 */       worldIn.setBlockState(pos, state.withProperty((IProperty)ENABLED, Boolean.valueOf(flag)), 4);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 163 */       InventoryHelper.dropInventoryItems(worldIn, pos, (IInventory)tileentity);
...
/* 230 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)getFacing(meta)).withProperty((IProperty)ENABLED, Boolean.valueOf(isEnabled(meta)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 238 */     int i = 0;
/* 239 */     i |= ((EnumFacing)state.getValue((IProperty)FACING)).getIndex();
/*     */     
/* 241 */     if (!((Boolean)state.getValue((IProperty)ENABLED)).booleanValue())
/*     */     {
/* 243 */       i |= 0x8;
/*     */     }
/*     */     
...
/* 251 */     return new BlockState(this, new IProperty[] { (IProperty)FACING, (IProperty)ENABLED });
/*     */   }
/*     */ }
