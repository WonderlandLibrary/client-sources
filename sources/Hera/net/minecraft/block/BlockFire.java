...
/*     */       else {
/*     */         
/* 174 */         int i = ((Integer)state.getValue((IProperty)AGE)).intValue();
/*     */         
/* 176 */         if (i < 15) {
/*     */           
/* 178 */           state = state.withProperty((IProperty)AGE, Integer.valueOf(i + rand.nextInt(3) / 2));
...
/*     */             
/* 188 */             if (!World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.down()) || i > 3)
/*     */             {
...
/*     */           } 
/*     */           
/* 196 */           if (!canCatchFire((IBlockAccess)worldIn, pos.down()) && i == 15 && rand.nextInt(4) == 0) {
/*     */             
...
/*     */                     }
/*     */                     
/* 254 */                     worldIn.setBlockState(blockpos, state.withProperty((IProperty)AGE, Integer.valueOf(i2)), 3);
/*     */                   } 
/*     */                 } 
/*     */               } 
/*     */             } 
...
/* 277 */     Integer integer = this.flammabilities.get(blockIn);
/* 278 */     return (integer == null) ? 0 : integer.intValue();
/*     */   }
/*     */ 
/*     */   
/*     */   private int getEncouragement(Block blockIn) {
/* 283 */     Integer integer = this.encouragements.get(blockIn);
...
/*     */         }
/*     */         
/* 304 */         worldIn.setBlockState(pos, getDefaultState().withProperty((IProperty)AGE, Integer.valueOf(j)), 3);
/*     */       }
/*     */       else {
/*     */         
...
/*     */       {
/* 313 */         Blocks.tnt.onBlockDestroyedByPlayer(worldIn, pos, iblockstate.withProperty((IProperty)BlockTNT.EXPLODE, Boolean.valueOf(true))); } 
/*     */     } 
/*     */   }
...
/* 320 */     for (i = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < i; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*     */       
/* 322 */       if (canCatchFire((IBlockAccess)worldIn, pos.offset(enumfacing)))
/*     */       {
/* 324 */         return true;
/*     */       }
/*     */       b++; }
...
/*     */ 
/*     */     
/* 339 */     int i = 0; byte b; int j;
/*     */     EnumFacing[] arrayOfEnumFacing;
/* 341 */     for (j = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < j; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*     */       
...
/* 368 */     return !(!World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.down()) && !canNeighborCatchFire(worldIn, pos));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 376 */     if (!World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.down()) && !canNeighborCatchFire(worldIn, pos))
/*     */     {
...
/*     */     {
/* 386 */       if (!World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.down()) && !canNeighborCatchFire(worldIn, pos)) {
/*     */         
...
/*     */     }
/*     */     
/* 404 */     if (!World.doesBlockHaveSolidTopSurface((IBlockAccess)worldIn, pos.down()) && !Blocks.fire.canCatchFire((IBlockAccess)worldIn, pos.down())) {
/*     */       
/* 406 */       if (Blocks.fire.canCatchFire((IBlockAccess)worldIn, pos.west()))
/*     */       {
...
/*     */       }
/*     */       
/* 417 */       if (Blocks.fire.canCatchFire((IBlockAccess)worldIn, pos.east()))
/*     */       {
...
/*     */       }
/*     */       
/* 428 */       if (Blocks.fire.canCatchFire((IBlockAccess)worldIn, pos.north()))
/*     */       {
...
/*     */       }
/*     */       
/* 439 */       if (Blocks.fire.canCatchFire((IBlockAccess)worldIn, pos.south()))
/*     */       {
...
/*     */       }
/*     */       
/* 450 */       if (Blocks.fire.canCatchFire((IBlockAccess)worldIn, pos.up()))
/*     */       {
...
/* 491 */     return getDefaultState().withProperty((IProperty)AGE, Integer.valueOf(meta));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 499 */     return ((Integer)state.getValue((IProperty)AGE)).intValue();
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 504 */     return new BlockState(this, new IProperty[] { (IProperty)AGE, (IProperty)NORTH, (IProperty)EAST, (IProperty)SOUTH, (IProperty)WEST, (IProperty)UPPER, (IProperty)FLIP, (IProperty)ALT });
/*     */   }
/*     */ }
