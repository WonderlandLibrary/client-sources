...
/*     */         
/*  58 */         state = state.withProperty((IProperty)FACING, (Comparable)enumfacing);
/*     */         
/*     */         break;
/*     */       } 
/*     */     } 
...
/*     */         
/*  84 */         int i = ((Integer)state.getValue((IProperty)AGE)).intValue();
/*     */         
/*  86 */         if (i < 7) {
/*     */           
/*  88 */           state = state.withProperty((IProperty)AGE, Integer.valueOf(i + 1));
...
/* 117 */     int i = ((Integer)state.getValue((IProperty)AGE)).intValue() + MathHelper.getRandomIntegerInRange(worldIn.rand, 2, 5);
/* 118 */     worldIn.setBlockState(pos, state.withProperty((IProperty)AGE, Integer.valueOf(Math.min(7, i))), 2);
/*     */   }
/*     */ 
/*     */   
...
/* 153 */     this.maxY = ((((Integer)worldIn.getBlockState(pos).getValue((IProperty)AGE)).intValue() * 2 + 2) / 16.0F);
/* 154 */     float f = 0.125F;
...
/* 186 */     return (this.crop == Blocks.pumpkin) ? Items.pumpkin_seeds : ((this.crop == Blocks.melon_block) ? Items.melon_seeds : null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 208 */     return (((Integer)state.getValue((IProperty)AGE)).intValue() != 7);
/*     */   }
/*     */ 
/*     */   
...
/* 226 */     return getDefaultState().withProperty((IProperty)AGE, Integer.valueOf(meta));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 234 */     return ((Integer)state.getValue((IProperty)AGE)).intValue();
/*     */   }
/*     */ 
/*     */   
/*     */   protected BlockState createBlockState() {
/* 239 */     return new BlockState(this, new IProperty[] { (IProperty)AGE, (IProperty)FACING });
/*     */   }
/*     */ }
