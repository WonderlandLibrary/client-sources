...
/*  36 */     setDefaultState(this.blockState.getBaseState().withProperty((IProperty)FACING, (Comparable)EnumFacing.NORTH).withProperty((IProperty)EXTENDED, Boolean.valueOf(false)));
...
/*  89 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)getFacingFromEntity(worldIn, pos, placer)).withProperty((IProperty)EXTENDED, Boolean.valueOf(false));
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 106 */       worldIn.setBlockState(pos, state.withProperty((IProperty)EXTENDED, Boolean.valueOf(false)), 2);
...
/* 113 */     for (i = (arrayOfEnumFacing1 = EnumFacing.values()).length, b = 0; b < i; ) { EnumFacing enumfacing = arrayOfEnumFacing1[b];
/*     */       
...
/* 129 */     for (int j = (arrayOfEnumFacing2 = EnumFacing.values()).length; i < j; ) { EnumFacing enumfacing1 = arrayOfEnumFacing2[i];
/*     */       
...
/*     */         
/* 154 */         worldIn.setBlockState(pos, state.withProperty((IProperty)EXTENDED, Boolean.valueOf(true)), 2);
/* 155 */         return false;
/*     */       } 
/*     */       
...
/*     */       }
/*     */       
/* 171 */       worldIn.setBlockState(pos, state.withProperty((IProperty)EXTENDED, Boolean.valueOf(true)), 2);
...
/*     */           }
/*     */         
/* 358 */         } else if (((Boolean)worldIn.getBlockState(pos).getValue((IProperty)EXTENDED)).booleanValue()) {
/*     */           
/* 360 */           return false;
/*     */         } 
/*     */         
...
/*     */       
/* 399 */       BlockPos blockpos = list1.get(j);
...
/*     */       
/* 409 */       BlockPos blockpos2 = list.get(k);
...
/* 415 */       worldIn.setBlockState(blockpos2, Blocks.piston_extension.getDefaultState().withProperty((IProperty)FACING, (Comparable)direction), 4);
...
/* 426 */       IBlockState iblockstate1 = Blocks.piston_head.getDefaultState().withProperty((IProperty)BlockPistonExtension.FACING, (Comparable)direction).withProperty((IProperty)BlockPistonExtension.TYPE, blockpistonextension$enumpistontype);
/* 427 */       IBlockState iblockstate2 = Blocks.piston_extension.getDefaultState().withProperty((IProperty)BlockPistonMoving.FACING, (Comparable)direction).withProperty((IProperty)BlockPistonMoving.TYPE, this.isSticky ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT);
...
/*     */     {
/* 434 */       worldIn.notifyNeighborsOfStateChange(list1.get(l), ablock[i++]);
/*     */     }
/*     */     
/* 437 */     for (int i1 = list.size() - 1; i1 >= 0; i1--)
/*     */     {
/* 439 */       worldIn.notifyNeighborsOfStateChange(list.get(i1), ablock[i++]);
/*     */     }
/*     */     
/* 442 */     if (extending) {
/*     */       
...
/* 457 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)EnumFacing.UP);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 465 */     return getDefaultState().withProperty((IProperty)FACING, (Comparable)getFacing(meta)).withProperty((IProperty)EXTENDED, Boolean.valueOf(((meta & 0x8) > 0)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 473 */     int i = 0;
/* 474 */     i |= ((EnumFacing)state.getValue((IProperty)FACING)).getIndex();
/*     */     
/* 476 */     if (((Boolean)state.getValue((IProperty)EXTENDED)).booleanValue())
/*     */     {
/* 478 */       i |= 0x8;
/*     */     }
/*     */     
...
/* 486 */     return new BlockState(this, new IProperty[] { (IProperty)FACING, (IProperty)EXTENDED });
/*     */   }
/*     */ }
