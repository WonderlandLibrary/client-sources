...
/* 346 */     return (this.worldObj.getTileEntity(this.pos) != this) ? false : ((player.getDistanceSq(this.pos.getX() + 0.5D, this.pos.getY() + 0.5D, this.pos.getZ() + 0.5D) <= 64.0D));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 362 */     return (index == 3) ? stack.getItem().isPotionIngredient(stack) : (!(stack.getItem() != Items.potionitem && stack.getItem() != Items.glass_bottle));
/*     */   }
/*     */ 
/*     */   
...
/* 410 */     return (Container)new ContainerBrewingStand(playerInventory, (IInventory)this);
/*     */   }
/*     */ 
/*     */   
