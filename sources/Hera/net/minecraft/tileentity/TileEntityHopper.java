...
/* 202 */     return (this.worldObj.getTileEntity(this.pos) != this) ? false : ((player.getDistanceSq(this.pos.getX() + 0.5D, this.pos.getY() + 0.5D, this.pos.getZ() + 0.5D) <= 64.0D));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 274 */     for (i = (arrayOfItemStack = this.inventory).length, b = 0; b < i; ) { ItemStack itemstack = arrayOfItemStack[b];
/*     */       
...
/*     */     int i;
/*     */     ItemStack[] arrayOfItemStack;
/* 287 */     for (i = (arrayOfItemStack = this.inventory).length, b = 0; b < i; ) { ItemStack itemstack = arrayOfItemStack[b];
/*     */       
...
/*     */       } else {
/*     */         
/* 438 */         int j = iinventory.getSizeInventory();
/*     */         
...
/* 474 */       ItemStack itemstack2 = putStackInInventoryAllSlots(hopper, inventoryIn.decrStackSize(index, 1), (EnumFacing)null);
/*     */       
...
/* 503 */     ItemStack itemstack1 = putStackInInventoryAllSlots(p_145898_0_, itemstack, (EnumFacing)null);
/*     */     
...
/*     */       
/* 529 */       for (int k = 0; k < aint.length && stack != null && stack.stackSize > 0; k++)
/*     */       {
/* 531 */         stack = insertStack(inventoryIn, stack, aint[k], side);
/*     */       }
/*     */     }
/*     */     else {
/*     */       
...
/* 557 */     return !inventoryIn.isItemValidForSlot(index, stack) ? false : (!(inventoryIn instanceof ISidedInventory && !((ISidedInventory)inventoryIn).canInsertItem(index, stack, side)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 642 */     IInventory iInventory1, iinventory = null;
...
/*     */         {
/* 659 */           iLockableContainer = ((BlockChest)block).getLockableContainer(worldIn, blockpos);
/*     */         }
/*     */       } 
/*     */     } 
/*     */     
/* 664 */     if (iLockableContainer == null) {
/*     */       
/* 666 */       List<Entity> list = worldIn.getEntitiesInAABBexcluding(null, new AxisAlignedBB(x - 0.5D, y - 0.5D, z - 0.5D, x + 0.5D, y + 0.5D, z + 0.5D), EntitySelectors.selectInventories);
/*     */       
/* 668 */       if (list.size() > 0)
/*     */       {
/* 670 */         iInventory1 = (IInventory)list.get(worldIn.rand.nextInt(list.size()));
/*     */       }
/*     */     } 
/*     */     
/* 674 */     return iInventory1;
/*     */   }
/*     */ 
/*     */   
/*     */   private static boolean canCombine(ItemStack stack1, ItemStack stack2) {
/* 679 */     return (stack1.getItem() != stack2.getItem()) ? false : ((stack1.getMetadata() != stack2.getMetadata()) ? false : ((stack1.stackSize > stack1.getMaxStackSize()) ? false : ItemStack.areItemStackTagsEqual(stack1, stack2)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 728 */     return (Container)new ContainerHopper(playerInventory, this, playerIn);
/*     */   }
/*     */ 
/*     */   
