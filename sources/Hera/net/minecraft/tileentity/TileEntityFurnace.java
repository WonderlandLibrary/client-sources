...
/* 199 */         nbttaglist.appendTag((NBTBase)nbttagcompound);
/*     */       } 
/*     */     } 
/*     */     
/* 203 */     compound.setTag("Items", (NBTBase)nbttaglist);
/*     */     
...
/*     */               
/* 259 */               (this.furnaceItemStacks[1]).stackSize--;
/*     */               
...
/* 322 */     return (itemstack == null) ? false : ((this.furnaceItemStacks[2] == null) ? true : (!this.furnaceItemStacks[2].isItemEqual(itemstack) ? false : (((this.furnaceItemStacks[2]).stackSize < getInventoryStackLimit() && (this.furnaceItemStacks[2]).stackSize < this.furnaceItemStacks[2].getMaxStackSize()) ? true : (((this.furnaceItemStacks[2]).stackSize < itemstack.getMaxStackSize())))));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/* 341 */         (this.furnaceItemStacks[2]).stackSize++;
/*     */       } 
/*     */       
...
/*     */       }
/*     */       
/* 349 */       (this.furnaceItemStacks[0]).stackSize--;
/*     */       
...
/*     */     
/* 372 */     if (item instanceof net.minecraft.item.ItemBlock && Block.getBlockFromItem(item) != Blocks.air) {
/*     */       
...
/*     */     } 
/*     */     
/* 392 */     return (item instanceof ItemTool && ((ItemTool)item).getToolMaterialName().equals("WOOD")) ? 200 : ((item instanceof ItemSword && ((ItemSword)item).getToolMaterialName().equals("WOOD")) ? 200 : ((item instanceof ItemHoe && ((ItemHoe)item).getMaterialName().equals("WOOD")) ? 200 : ((item == Items.stick) ? 100 : ((item == Items.coal) ? 1600 : ((item == Items.lava_bucket) ? 20000 : ((item == Item.getItemFromBlock(Blocks.sapling)) ? 100 : ((item == Items.blaze_rod) ? 2400 : 0)))))));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 406 */     return (this.worldObj.getTileEntity(this.pos) != this) ? false : ((player.getDistanceSq(this.pos.getX() + 0.5D, this.pos.getY() + 0.5D, this.pos.getZ() + 0.5D) <= 64.0D));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 422 */     return (index == 2) ? false : ((index != 1) ? true : (!(!isItemFuel(stack) && !SlotFurnaceFuel.isBucket(stack))));
/*     */   }
/*     */ 
/*     */   
/*     */   public int[] getSlotsForFace(EnumFacing side) {
/* 427 */     return (side == EnumFacing.DOWN) ? slotsBottom : ((side == EnumFacing.UP) ? slotsTop : slotsSides);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 465 */     return (Container)new ContainerFurnace(playerInventory, (IInventory)this);
/*     */   }
/*     */ 
/*     */   
