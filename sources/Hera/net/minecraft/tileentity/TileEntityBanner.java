...
/* 176 */               this.patternResourceLocation = String.valueOf(this.patternResourceLocation) + tileentitybanner$enumbannerpattern.getPatternID() + j;
/*     */             } 
/*     */           } 
/*     */         }
/*     */       } 
...
/* 245 */     CURLY_BORDER("curly_border", "cbo", (String)new ItemStack(Blocks.vine)),
/* 246 */     CREEPER("creeper", "cre", (String)new ItemStack(Items.skull, 1, 4)),
/* 247 */     GRADIENT("gradient", "gra", "# #", " # ", " # "),
/* 248 */     GRADIENT_UP("gradient_up", "gru", " # ", " # ", "# #"),
/* 249 */     BRICKS("bricks", "bri", (String)new ItemStack(Blocks.brick_block)),
/* 250 */     SKULL("skull", "sku", (String)new ItemStack(Items.skull, 1, 1)),
/* 251 */     FLOWER("flower", "flo", (String)new ItemStack((Block)Blocks.red_flower, 1, BlockFlower.EnumFlowerType.OXEYE_DAISY.getMeta())),
/* 252 */     MOJANG("mojang", "moj", (String)new ItemStack(Items.golden_apple, 1, 1));
/*     */     
...
/* 312 */       for (i = (arrayOfEnumBannerPattern = values()).length, b = 0; b < i; ) { EnumBannerPattern tileentitybanner$enumbannerpattern = arrayOfEnumBannerPattern[b];
/*     */         
