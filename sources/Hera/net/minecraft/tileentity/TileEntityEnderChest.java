...
/* 109 */     return (this.worldObj.getTileEntity(this.pos) != this) ? false : ((p_145971_1_.getDistanceSq(this.pos.getX() + 0.5D, this.pos.getY() + 0.5D, this.pos.getZ() + 0.5D) <= 64.0D));
/*     */   }
/*     */ }
