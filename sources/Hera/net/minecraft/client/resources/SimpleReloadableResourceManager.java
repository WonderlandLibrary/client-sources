...
/*  38 */       FallbackResourceManager fallbackresourcemanager = this.domainResourceManagers.get(s);
/*     */       
...
/*  57 */     IResourceManager iresourcemanager = this.domainResourceManagers.get(location.getResourceDomain());
/*     */     
...
/*  71 */     IResourceManager iresourcemanager = this.domainResourceManagers.get(location.getResourceDomain());
/*     */     
...
/*  91 */     clearResources();
/*  92 */     logger.info("Reloading ResourceManager: " + joinerResourcePacks.join(Iterables.transform(p_110541_1_, new Function<IResourcePack, String>()
/*     */             {
