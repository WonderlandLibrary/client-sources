...
/* 105 */       int i = this.model.getGeneralQuads().size(); byte b; int j;
/*     */       EnumFacing[] arrayOfEnumFacing;
/* 107 */       for (j = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < j; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*     */         
