...
/*  34 */     this.mc = mcIn;
/*  35 */     this.scaledResolution = new ScaledResolution(mcIn);
...
/*  79 */         GlStateManager.ortho(0.0D, (this.scaledResolution.getScaledWidth() * i), (this.scaledResolution.getScaledHeight() * i), 0.0D, 100.0D, 300.0D);
/*     */       }
/*     */       else {
/*     */         
...
/* 133 */         ScaledResolution scaledresolution = new ScaledResolution(this.mc);
