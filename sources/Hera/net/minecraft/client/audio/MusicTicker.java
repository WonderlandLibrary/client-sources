...
/*    */   {
/* 68 */     MENU((String)new ResourceLocation("minecraft:music.menu"), 20, 600),
/* 69 */     GAME((String)new ResourceLocation("minecraft:music.game"), 12000, 24000),
/* 70 */     CREATIVE((String)new ResourceLocation("minecraft:music.game.creative"), 1200, 3600),
/* 71 */     CREDITS((String)new ResourceLocation("minecraft:music.game.end.credits"), 2147483647, 2147483647),
/* 72 */     NETHER((String)new ResourceLocation("minecraft:music.game.nether"), 1200, 3600),
/* 73 */     END_BOSS((String)new ResourceLocation("minecraft:music.game.end.dragon"), 0, 0),
/* 74 */     END((String)new ResourceLocation("minecraft:music.game.end"), 6000, 24000);
/*    */     
