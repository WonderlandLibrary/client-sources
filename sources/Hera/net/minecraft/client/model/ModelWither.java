...
/* 46 */     setRotationAngles(p_78088_2_, p_78088_3_, p_78088_4_, p_78088_5_, p_78088_6_, scale, entityIn); byte b; int i;
/*    */     ModelRenderer[] arrayOfModelRenderer;
/* 48 */     for (i = (arrayOfModelRenderer = this.field_82904_b).length, b = 0; b < i; ) { ModelRenderer modelrenderer = arrayOfModelRenderer[b];
/*    */       
/* 50 */       modelrenderer.render(scale);
/*    */       b++; }
/*    */     
/* 53 */     for (i = (arrayOfModelRenderer = this.field_82905_a).length, b = 0; b < i; ) { ModelRenderer modelrenderer1 = arrayOfModelRenderer[b];
/*    */       
