...
/* 145 */     if (effect != null)
/*     */     {
/* 147 */       if (!(effect instanceof EntityFirework.SparkFX) || Config.isFireworkParticles()) {
/*     */         
...
/*     */     }
/*     */     
/* 169 */     ArrayList<EntityParticleEmitter> arraylist = Lists.newArrayList();
/*     */     
...
/* 195 */     ArrayList<EntityFX> arraylist = Lists.newArrayList();
/*     */     
/* 197 */     for (int i = 0; i < p_178925_1_.size(); i++) {
/*     */       
/* 199 */       EntityFX entityfx = p_178925_1_.get(i);
...
/*     */             
/*     */             public String call() throws Exception {
/* 235 */               return (i == 0) ? "MISC_TEXTURE" : ((i == 1) ? "TERRAIN_TEXTURE" : ((i == 3) ? "ENTITY_PARTICLE_TEXTURE" : ("Unknown - " + i)));
/*     */             }
/*     */           });
...
/*     */             
/* 295 */             final EntityFX entityfx = this.fxLayers[j][k].get(l);
/*     */ 
/*     */             
/*     */             try {
...
/*     */                     
/*     */                     public String call() throws Exception {
/* 318 */                       return (j == 0) ? "MISC_TEXTURE" : ((j == 1) ? "TERRAIN_TEXTURE" : ((j == 3) ? "ENTITY_PARTICLE_TEXTURE" : ("Unknown - " + j)));
/*     */                     }
/*     */                   });
...
/*     */       
/* 346 */       List<EntityFX> list = this.fxLayers[3][i];
/*     */       
/* 348 */       if (!list.isEmpty()) {
/*     */         
...
/*     */           
/* 355 */           EntityFX entityfx = list.get(j);
...
/* 385 */       flag = (!Reflector.callBoolean(block, Reflector.ForgeBlock_isAir, new Object[] { this.worldObj, pos }) && !Reflector.callBoolean(block, Reflector.ForgeBlock_addDestroyEffects, new Object[] { this.worldObj, pos, this }));
/*     */     }
/*     */     else {
/*     */       
...
/* 392 */     if (flag) {
/*     */       
/* 394 */       state = state.getBlock().getActualState(state, (IBlockAccess)this.worldObj, pos);
/* 395 */       byte b0 = 4;
/*     */       
