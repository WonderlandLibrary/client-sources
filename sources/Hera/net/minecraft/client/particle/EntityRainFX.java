...
/* 61 */     block.setBlockBoundsBasedOnState((IBlockAccess)this.worldObj, blockpos);
...
/*    */         
/* 70 */         d0 = (1.0F - BlockLiquid.getLiquidHeightPercent(((Integer)iblockstate.getValue((IProperty)BlockLiquid.LEVEL)).intValue()));
/*    */       }
/*    */       else {
/*    */         
...
/*    */       } 
/*    */       
/* 77 */       double d1 = MathHelper.floor_double(this.posY) + d0;
/*    */       
/* 79 */       if (this.posY < d1)
/*    */       {
/* 81 */         setDead();
