...
/*    */       
/* 42 */       ItemMeshDefinition itemmeshdefinition = this.shapers.get(item);
/*    */       
...
/* 65 */     return this.simpleShapesCache.get(Integer.valueOf(getIndex(item, meta)));
/*    */   }
/*    */ 
/*    */   
...
/*    */     {
/* 95 */       this.simpleShapesCache.put(entry.getKey(), this.modelManager.getModel(entry.getValue()));
/*    */     }
/*    */   }
/*    */ }
