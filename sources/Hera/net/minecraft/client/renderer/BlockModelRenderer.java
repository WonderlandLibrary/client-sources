...
/*  60 */       throw new ReportedException(crashreport);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/*  72 */     RenderEnv renderenv = null; byte b; int i;
/*     */     EnumFacing[] arrayOfEnumFacing;
/*  74 */     for (i = (arrayOfEnumFacing = EnumFacing.VALUES).length, b = 0; b < i; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*     */       
...
/* 131 */     RenderEnv renderenv = null; byte b; int i;
/*     */     EnumFacing[] arrayOfEnumFacing;
/* 133 */     for (i = (arrayOfEnumFacing = EnumFacing.VALUES).length, b = 0; b < i; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*     */       
...
/*     */           }
/*     */           
/* 153 */           int j = p_renderModelStandard_3_.getMixedBrightnessForBlock(p_renderModelStandard_1_, blockpos);
/* 154 */           renderModelStandardQuads(p_renderModelStandard_1_, p_renderModelStandard_3_, p_renderModelStandard_5_, enumfacing, j, false, p_renderModelStandard_6_, list, renderenv);
/* 155 */           flag = true;
/*     */         } 
/*     */       } 
/*     */       b++; }
...
/*     */       
/* 196 */       long i = MathHelper.getPositionRandom((Vec3i)p_renderModelAmbientOcclusionQuads_3_);
/* 197 */       d0 += (((float)(i >> 16L & 0xFL) / 15.0F) - 0.5D) * 0.5D;
/* 198 */       d2 += (((float)(i >> 24L & 0xFL) / 15.0F) - 0.5D) * 0.5D;
/*     */       
/* 200 */       if (block$enumoffsettype == Block.EnumOffsetType.XYZ)
/*     */       {
/* 202 */         d1 += (((float)(i >> 20L & 0xFL) / 15.0F) - 1.0D) * 0.2D;
/*     */       }
/*     */     } 
/*     */     
...
/* 365 */       int j = p_renderModelStandardQuads_3_.getZ();
/* 366 */       long k = (i * 3129871) ^ j * 116129781L;
/* 367 */       k = k * k * 42317861L + k * 11L;
/* 368 */       d0 += (((float)(k >> 16L & 0xFL) / 15.0F) - 0.5D) * 0.5D;
/* 369 */       d2 += (((float)(k >> 24L & 0xFL) / 15.0F) - 0.5D) * 0.5D;
/*     */       
/* 371 */       if (block$enumoffsettype == Block.EnumOffsetType.XYZ)
/*     */       {
/* 373 */         d1 += (((float)(k >> 20L & 0xFL) / 15.0F) - 1.0D) * 0.2D;
/*     */       }
/*     */     } 
/*     */     
...
/*     */     int i;
/*     */     EnumFacing[] arrayOfEnumFacing;
/* 448 */     for (i = (arrayOfEnumFacing = EnumFacing.VALUES).length, b = 0; b < i; ) { EnumFacing enumfacing = arrayOfEnumFacing[b];
/*     */       
...
/*     */   {
/* 513 */     static final int[] field_178290_a = new int[(EnumFacing.values()).length];
/*     */     
...
/*     */     static {
/*     */       try {
/* 520 */         field_178290_a[EnumFacing.DOWN.ordinal()] = 1;
/*     */       }
/* 522 */       catch (NoSuchFieldError noSuchFieldError) {}
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */       
/*     */       try {
/* 529 */         field_178290_a[EnumFacing.UP.ordinal()] = 2;
/*     */       }
/* 531 */       catch (NoSuchFieldError noSuchFieldError) {}
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */       
/*     */       try {
/* 538 */         field_178290_a[EnumFacing.NORTH.ordinal()] = 3;
/*     */       }
/* 540 */       catch (NoSuchFieldError noSuchFieldError) {}
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */       
/*     */       try {
/* 547 */         field_178290_a[EnumFacing.SOUTH.ordinal()] = 4;
/*     */       }
/* 549 */       catch (NoSuchFieldError noSuchFieldError) {}
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */       
/*     */       try {
/* 556 */         field_178290_a[EnumFacing.WEST.ordinal()] = 5;
/*     */       }
/* 558 */       catch (NoSuchFieldError noSuchFieldError) {}
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */       
/*     */       try {
/* 565 */         field_178290_a[EnumFacing.EAST.ordinal()] = 6;
/*     */       }
/* 567 */       catch (NoSuchFieldError noSuchFieldError) {}
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 701 */         this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.field_178191_g] = f29 * f13 + f30 * f14 + f31 * f15 + f32 * f16;
/* 702 */         this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.field_178200_h] = f29 * f17 + f30 * f18 + f31 * f19 + f32 * f20;
/* 703 */         this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.field_178201_i] = f29 * f21 + f30 * f22 + f31 * f23 + f32 * f24;
/* 704 */         this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.field_178198_j] = f29 * f25 + f30 * f26 + f31 * f27 + f32 * f28;
...
/* 709 */         this.vertexBrightness[blockmodelrenderer$vertextranslations.field_178191_g] = getVertexBrightness(j2, k2, l2, i3, f13, f14, f15, f16);
/* 710 */         this.vertexBrightness[blockmodelrenderer$vertextranslations.field_178200_h] = getVertexBrightness(j2, k2, l2, i3, f17, f18, f19, f20);
/* 711 */         this.vertexBrightness[blockmodelrenderer$vertextranslations.field_178201_i] = getVertexBrightness(j2, k2, l2, i3, f21, f22, f23, f24);
/* 712 */         this.vertexBrightness[blockmodelrenderer$vertextranslations.field_178198_j] = getVertexBrightness(j2, k2, l2, i3, f25, f26, f27, f28);
/*     */       }
/*     */       else {
/*     */         
...
/* 720 */         this.vertexBrightness[blockmodelrenderer$vertextranslations.field_178191_g] = getAoBrightness(l, i, j1, i2);
/* 721 */         this.vertexBrightness[blockmodelrenderer$vertextranslations.field_178200_h] = getAoBrightness(k, i, i1, i2);
/* 722 */         this.vertexBrightness[blockmodelrenderer$vertextranslations.field_178201_i] = getAoBrightness(k, j, k1, i2);
/* 723 */         this.vertexBrightness[blockmodelrenderer$vertextranslations.field_178198_j] = getAoBrightness(l, j, l1, i2);
/* 724 */         this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.field_178191_g] = f9;
/* 725 */         this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.field_178200_h] = f10;
/* 726 */         this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.field_178201_i] = f11;
/* 727 */         this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.field_178198_j] = f12;
/*     */       } 
/*     */     }
/*     */ 
/*     */     
...
/* 775 */     private static final EnumNeighborInfo[] field_178282_n = new EnumNeighborInfo[6];
/* 776 */     private static final EnumNeighborInfo[] $VALUES = new EnumNeighborInfo[] { DOWN, UP, NORTH, SOUTH, WEST, EAST };
/*     */     
/*     */     private static final String __OBFID = "CL_00002516";
/*     */ 
/*     */     
/*     */     EnumNeighborInfo(String p_i5_3_, int p_i5_4_, EnumFacing[] p_i5_5_, float p_i5_6_, boolean p_i5_7_, BlockModelRenderer.Orientation[] p_i5_8_, BlockModelRenderer.Orientation[] p_i5_9_, BlockModelRenderer.Orientation[] p_i5_10_, BlockModelRenderer.Orientation[] p_i5_11_) {
...
/*     */   {
/* 807 */     DOWN("DOWN", 0, (String)EnumFacing.DOWN, false),
/* 808 */     UP("UP", 1, (String)EnumFacing.UP, false),
/* 809 */     NORTH("NORTH", 2, (String)EnumFacing.NORTH, false),
/* 810 */     SOUTH("SOUTH", 3, (String)EnumFacing.SOUTH, false),
/* 811 */     WEST("WEST", 4, (String)EnumFacing.WEST, false),
/* 812 */     EAST("EAST", 5, (String)EnumFacing.EAST, false),
/* 813 */     FLIP_DOWN("FLIP_DOWN", 6, (String)EnumFacing.DOWN, true),
/* 814 */     FLIP_UP("FLIP_UP", 7, (String)EnumFacing.UP, true),
/* 815 */     FLIP_NORTH("FLIP_NORTH", 8, (String)EnumFacing.NORTH, true),
/* 816 */     FLIP_SOUTH("FLIP_SOUTH", 9, (String)EnumFacing.SOUTH, true),
/* 817 */     FLIP_WEST("FLIP_WEST", 10, (String)EnumFacing.WEST, true),
/* 818 */     FLIP_EAST("FLIP_EAST", 11, (String)EnumFacing.EAST, true);
/*     */     
/*     */     protected final int field_178229_m;
/* 821 */     private static final Orientation[] $VALUES = new Orientation[] { DOWN, UP, NORTH, SOUTH, WEST, EAST, FLIP_DOWN, FLIP_UP, FLIP_NORTH, FLIP_SOUTH, FLIP_WEST, FLIP_EAST };
/*     */     
/*     */     private static final String __OBFID = "CL_00002513";
/*     */     
/*     */     Orientation(String p_i7_3_, int p_i7_4_, EnumFacing p_i7_5_, boolean p_i7_6_) {
...
/*     */     } }
/*     */   
/* 832 */   enum VertexTranslations { DOWN("DOWN", 0, 0, 1, 2, 3),
/* 833 */     UP("UP", 1, 2, 3, 0, 1),
...
/* 843 */     private static final VertexTranslations[] field_178199_k = new VertexTranslations[6];
/* 844 */     private static final VertexTranslations[] $VALUES = new VertexTranslations[] { DOWN, UP, NORTH, SOUTH, WEST, EAST };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/*     */     VertexTranslations(String p_i6_3_, int p_i6_4_, int p_i6_5_, int p_i6_6_, int p_i6_7_, int p_i6_8_) {
