...
/*     */ {
/*  24 */   static final Gson GSON = (new GsonBuilder()).registerTypeAdapter(ModelBlockDefinition.class, new Deserializer()).registerTypeAdapter(Variant.class, new Variant.Deserializer()).create();
...
/*  50 */     Variants modelblockdefinition$variants = this.mapVariants.get(p_178330_1_);
/*     */     
...
/*     */       
/*  98 */       for (Map.Entry<String, JsonElement> entry : (Iterable<Map.Entry<String, JsonElement>>)jsonobject.entrySet())
/*     */       {
...
/* 108 */       String s = p_178335_2_.getKey();
/* 109 */       List<ModelBlockDefinition.Variant> list = Lists.newArrayList();
/* 110 */       JsonElement jsonelement = p_178335_2_.getValue();
/*     */       
...
/*     */   {
/*     */     private final String name; private final List<ModelBlockDefinition.Variant> listVariants; public Variants(String nameIn, List<ModelBlockDefinition.Variant> listVariantsIn) {
