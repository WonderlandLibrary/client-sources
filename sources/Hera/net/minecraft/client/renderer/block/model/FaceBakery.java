...
/*  82 */     afloat[EnumFaceDirection.Constants.WEST_INDEX] = pos1.x / 16.0F;
/*  83 */     afloat[EnumFaceDirection.Constants.DOWN_INDEX] = pos1.y / 16.0F;
/*  84 */     afloat[EnumFaceDirection.Constants.NORTH_INDEX] = pos1.z / 16.0F;
/*  85 */     afloat[EnumFaceDirection.Constants.EAST_INDEX] = pos2.x / 16.0F;
/*  86 */     afloat[EnumFaceDirection.Constants.UP_INDEX] = pos2.y / 16.0F;
/*  87 */     afloat[EnumFaceDirection.Constants.SOUTH_INDEX] = pos2.z / 16.0F;
/*  88 */     return afloat;
/*     */   }
/*     */ 
/*     */   
...
/*  95 */     EnumFaceDirection.VertexInformation enumfacedirection$vertexinformation = EnumFaceDirection.getFacing(facing).func_179025_a(vertexIndex);
...
/* 134 */           vector3f.set(1.0F, 1.0F, 0.0F); break;
/* 135 */       }  if (partRotation
/*     */         
/* 137 */         .rescale) {
/*     */         
...
/*     */       } 
/*     */       
/* 155 */       rotateScale(p_178407_1_, new Vector3f((ReadableVector3f)partRotation.origin), matrix4f, vector3f);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/* 205 */     float f1 = 0.0F; byte b; int i;
/*     */     EnumFacing[] arrayOfEnumFacing;
/* 207 */     for (i = (arrayOfEnumFacing = EnumFacing.values()).length, b = 0; b < i; ) { EnumFacing enumfacing1 = arrayOfEnumFacing[b];
/*     */       
...
/* 248 */     afloat[EnumFaceDirection.Constants.WEST_INDEX] = 999.0F;
/* 249 */     afloat[EnumFaceDirection.Constants.DOWN_INDEX] = 999.0F;
/* 250 */     afloat[EnumFaceDirection.Constants.NORTH_INDEX] = 999.0F;
/* 251 */     afloat[EnumFaceDirection.Constants.EAST_INDEX] = -999.0F;
/* 252 */     afloat[EnumFaceDirection.Constants.UP_INDEX] = -999.0F;
/* 253 */     afloat[EnumFaceDirection.Constants.SOUTH_INDEX] = -999.0F;
/*     */     
...
/*     */       
/* 262 */       if (f1 < afloat[EnumFaceDirection.Constants.WEST_INDEX])
/*     */       {
/* 264 */         afloat[EnumFaceDirection.Constants.WEST_INDEX] = f1;
/*     */       }
/*     */       
/* 267 */       if (f2 < afloat[EnumFaceDirection.Constants.DOWN_INDEX])
/*     */       {
/* 269 */         afloat[EnumFaceDirection.Constants.DOWN_INDEX] = f2;
/*     */       }
/*     */       
/* 272 */       if (f < afloat[EnumFaceDirection.Constants.NORTH_INDEX])
/*     */       {
/* 274 */         afloat[EnumFaceDirection.Constants.NORTH_INDEX] = f;
/*     */       }
/*     */       
/* 277 */       if (f1 > afloat[EnumFaceDirection.Constants.EAST_INDEX])
/*     */       {
/* 279 */         afloat[EnumFaceDirection.Constants.EAST_INDEX] = f1;
/*     */       }
/*     */       
/* 282 */       if (f2 > afloat[EnumFaceDirection.Constants.UP_INDEX])
/*     */       {
/* 284 */         afloat[EnumFaceDirection.Constants.UP_INDEX] = f2;
/*     */       }
/*     */       
/* 287 */       if (f > afloat[EnumFaceDirection.Constants.SOUTH_INDEX])
/*     */       {
/* 289 */         afloat[EnumFaceDirection.Constants.SOUTH_INDEX] = f;
/*     */       }
/*     */     } 
/*     */     
...
/*     */       
/* 297 */       int j1 = 7 * i1;
/* 298 */       EnumFaceDirection.VertexInformation enumfacedirection$vertexinformation = enumfacedirection.func_179025_a(i1);
...
/*     */   {
/* 419 */     static final int[] field_178400_a = new int[(EnumFacing.values()).length]; static final int[] field_178399_b = new int[(EnumFacing.Axis.values()).length]; private static final String __OBFID = "CL_00002489";
/*     */     
/*     */     static {
/*     */       try {
/* 423 */         field_178400_a[EnumFacing.DOWN.ordinal()] = 1;
/*     */       }
...
/*     */       
/*     */       try {
/* 432 */         field_178400_a[EnumFacing.UP.ordinal()] = 2;
/*     */       }
/* 434 */       catch (NoSuchFieldError noSuchFieldError) {}
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */       
/*     */       try {
/* 441 */         field_178400_a[EnumFacing.NORTH.ordinal()] = 3;
/*     */       }
...
/*     */       
/*     */       try {
/* 450 */         field_178400_a[EnumFacing.SOUTH.ordinal()] = 4;
/*     */       }
...
/*     */       
/*     */       try {
/* 459 */         field_178400_a[EnumFacing.WEST.ordinal()] = 5;
/*     */       }
...
/*     */       
/*     */       try {
/* 468 */         field_178400_a[EnumFacing.EAST.ordinal()] = 6;
/*     */       }
