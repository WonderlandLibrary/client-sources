...
/*     */       
/*  34 */       this.guiLeft = 160 + (this.width - this.xSize - 200) / 2;
/*  35 */       this.hasActivePotionEffects = true;
/*     */     }
/*     */     else {
/*     */       
/*  39 */       this.guiLeft = (this.width - this.xSize) / 2;
...
/*     */           
/*  95 */           s1 = String.valueOf(s1) + " " + I18n.format("enchantment.level.2", new Object[0]);
/*     */         }
/*  97 */         else if (potioneffect.getAmplifier() == 2) {
/*     */           
/*  99 */           s1 = String.valueOf(s1) + " " + I18n.format("enchantment.level.3", new Object[0]);
/*     */         }
/* 101 */         else if (potioneffect.getAmplifier() == 3) {
/*     */           
/* 103 */           s1 = String.valueOf(s1) + " " + I18n.format("enchantment.level.4", new Object[0]);
/*     */         } 
/*     */         
