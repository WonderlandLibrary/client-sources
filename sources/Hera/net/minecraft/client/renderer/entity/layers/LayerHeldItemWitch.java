...
/*    */       
/* 46 */       if (item instanceof net.minecraft.item.ItemBlock && minecraft.getBlockRendererDispatcher().isRenderTypeChest(Block.getBlockFromItem(item), itemstack.getMetadata())) {
/*    */         
...
/* 90 */       minecraft.getItemRenderer().renderItem((EntityLivingBase)entitylivingbaseIn, itemstack, ItemCameraTransforms.TransformType.THIRD_PERSON);
