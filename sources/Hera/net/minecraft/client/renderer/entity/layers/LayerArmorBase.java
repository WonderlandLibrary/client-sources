...
/*  24 */   private static final Map<String, ResourceLocation> ARMOR_TEXTURE_RES_MAP = Maps.newHashMap();
/*     */ 
/*     */   
...
/*     */         
/*     */         case LEATHER:
/*  62 */           i = itemarmor.getColor(itemstack);
/*  63 */           f = (i >> 16 & 0xFF) / 255.0F;
/*  64 */           f1 = (i >> 8 & 0xFF) / 255.0F;
/*  65 */           f2 = (i & 0xFF) / 255.0F;
/*  66 */           GlStateManager.color(this.colorR * f, this.colorG * f1, this.colorB * f2, this.alpha);
/*  67 */           t.render((Entity)entitylivingbaseIn, p_177182_2_, p_177182_3_, p_177182_5_, p_177182_6_, p_177182_7_, p_177182_8_);
...
/*  75 */           t.render((Entity)entitylivingbaseIn, p_177182_2_, p_177182_3_, p_177182_5_, p_177182_6_, p_177182_7_, p_177182_8_);
/*     */           break;
/*     */       } 
...
/* 124 */       modelbaseIn.render((Entity)entitylivingbaseIn, p_177183_3_, p_177183_4_, p_177183_6_, p_177183_7_, p_177183_8_, p_177183_9_);
/*     */     } 
/*     */     
...
/* 144 */     ResourceLocation resourcelocation = ARMOR_TEXTURE_RES_MAP.get(s);
/*     */     
