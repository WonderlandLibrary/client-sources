...
/*  75 */     if (entity != null) {
/*     */       
/*  77 */       y -= (1.6D - ((EntityLiving)entityLivingIn).height) * 0.5D;
...
/*     */       
/*  86 */       if (entity instanceof net.minecraft.entity.EntityHanging) {
/*     */         
/*  88 */         d2 = 0.0D;
/*  89 */         d3 = 0.0D;
/*  90 */         d4 = -1.0D;
...
/*  97 */       double d9 = interpolateValue(((EntityLiving)entityLivingIn).prevRenderYawOffset, ((EntityLiving)entityLivingIn).renderYawOffset, partialTicks) * 0.01745329238474369D + 1.5707963267948966D;
/*  98 */       d2 = Math.cos(d9) * ((EntityLiving)entityLivingIn).width * 0.4D;
/*  99 */       d3 = Math.sin(d9) * ((EntityLiving)entityLivingIn).width * 0.4D;
/* 100 */       double d10 = interpolateValue(((EntityLiving)entityLivingIn).prevPosX, ((EntityLiving)entityLivingIn).posX, partialTicks) + d2;
/* 101 */       double d11 = interpolateValue(((EntityLiving)entityLivingIn).prevPosY, ((EntityLiving)entityLivingIn).posY, partialTicks);
/* 102 */       double d12 = interpolateValue(((EntityLiving)entityLivingIn).prevPosZ, ((EntityLiving)entityLivingIn).posZ, partialTicks) + d3;
/* 103 */       x += d2;
/* 104 */       z += d3;
