...
/*  122 */     worldrenderer.begin(7, DefaultVertexFormats.ITEM); byte b; int i;
...
/*      */       
/*  213 */       BakedQuad bakedquad = quads.get(i);
/*  214 */       int k = color;
/*      */       
...
/*      */         
/*  220 */         if (EntityRenderer.anaglyphEnable)
/*      */         {
/*  222 */           k = TextureUtil.anaglyphColor(k);
/*      */         }
/*      */         
/*  225 */         k |= 0xFF000000;
/*      */       } 
...
/*  338 */     return ((p_183005_1_.scale.x < 0.0F)) ^ ((p_183005_1_.scale.y < 0.0F)) ^ ((p_183005_1_.scale.z < 0.0F) ? 1 : 0);
/*      */   }
/*      */ 
/*      */   
...
/*  400 */         crashreportcategory.addCrashSectionCallable("Item Type", new Callable<String>()
/*      */             {
...
/*      */               }
/*      */             });
/*  407 */         crashreportcategory.addCrashSectionCallable("Item Aux", new Callable<String>()
/*      */             {
/*      */               public String call() throws Exception
/*      */               {
...
/*      */               }
/*      */             });
/*  414 */         crashreportcategory.addCrashSectionCallable("Item NBT", new Callable<String>()
/*      */             {
/*      */               public String call() throws Exception
/*      */               {
...
/*      */               }
/*      */             });
/*  421 */         crashreportcategory.addCrashSectionCallable("Item Foil", new Callable<String>()
/*      */             {
/*      */               public String call() throws Exception
/*      */               {
...
/*      */               }
/*      */             });
/*  428 */         throw new ReportedException(crashreport);
/*      */       } 
/*      */       
...
/*  523 */     registerBlock((Block)Blocks.double_plant, BlockDoublePlant.EnumPlantType.FERN.getMeta(), "double_fern");
/*  524 */     registerBlock((Block)Blocks.double_plant, BlockDoublePlant.EnumPlantType.GRASS.getMeta(), "double_grass");
/*  525 */     registerBlock((Block)Blocks.double_plant, BlockDoublePlant.EnumPlantType.PAEONIA.getMeta(), "paeonia");
/*  526 */     registerBlock((Block)Blocks.double_plant, BlockDoublePlant.EnumPlantType.ROSE.getMeta(), "double_rose");
/*  527 */     registerBlock((Block)Blocks.double_plant, BlockDoublePlant.EnumPlantType.SUNFLOWER.getMeta(), "sunflower");
/*  528 */     registerBlock((Block)Blocks.double_plant, BlockDoublePlant.EnumPlantType.SYRINGA.getMeta(), "syringa");
/*  529 */     registerBlock((Block)Blocks.leaves, BlockPlanks.EnumType.BIRCH.getMetadata(), "birch_leaves");
/*  530 */     registerBlock((Block)Blocks.leaves, BlockPlanks.EnumType.JUNGLE.getMetadata(), "jungle_leaves");
/*  531 */     registerBlock((Block)Blocks.leaves, BlockPlanks.EnumType.OAK.getMetadata(), "oak_leaves");
/*  532 */     registerBlock((Block)Blocks.leaves, BlockPlanks.EnumType.SPRUCE.getMetadata(), "spruce_leaves");
/*  533 */     registerBlock((Block)Blocks.leaves2, BlockPlanks.EnumType.ACACIA.getMetadata() - 4, "acacia_leaves");
/*  534 */     registerBlock((Block)Blocks.leaves2, BlockPlanks.EnumType.DARK_OAK.getMetadata() - 4, "dark_oak_leaves");
...
/*  559 */     registerBlock((Block)Blocks.red_flower, BlockFlower.EnumFlowerType.ALLIUM.getMeta(), "allium");
/*  560 */     registerBlock((Block)Blocks.red_flower, BlockFlower.EnumFlowerType.BLUE_ORCHID.getMeta(), "blue_orchid");
/*  561 */     registerBlock((Block)Blocks.red_flower, BlockFlower.EnumFlowerType.HOUSTONIA.getMeta(), "houstonia");
/*  562 */     registerBlock((Block)Blocks.red_flower, BlockFlower.EnumFlowerType.ORANGE_TULIP.getMeta(), "orange_tulip");
/*  563 */     registerBlock((Block)Blocks.red_flower, BlockFlower.EnumFlowerType.OXEYE_DAISY.getMeta(), "oxeye_daisy");
/*  564 */     registerBlock((Block)Blocks.red_flower, BlockFlower.EnumFlowerType.PINK_TULIP.getMeta(), "pink_tulip");
/*  565 */     registerBlock((Block)Blocks.red_flower, BlockFlower.EnumFlowerType.POPPY.getMeta(), "poppy");
/*  566 */     registerBlock((Block)Blocks.red_flower, BlockFlower.EnumFlowerType.RED_TULIP.getMeta(), "red_tulip");
/*  567 */     registerBlock((Block)Blocks.red_flower, BlockFlower.EnumFlowerType.WHITE_TULIP.getMeta(), "white_tulip");
/*  568 */     registerBlock((Block)Blocks.sand, BlockSand.EnumType.RED_SAND.getMetadata(), "red_sand");
/*  569 */     registerBlock((Block)Blocks.sand, BlockSand.EnumType.SAND.getMetadata(), "sand");
...
/*  584 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.BLACK.getMetadata(), "black_stained_glass");
/*  585 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.BLUE.getMetadata(), "blue_stained_glass");
/*  586 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.BROWN.getMetadata(), "brown_stained_glass");
/*  587 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.CYAN.getMetadata(), "cyan_stained_glass");
/*  588 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.GRAY.getMetadata(), "gray_stained_glass");
/*  589 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.GREEN.getMetadata(), "green_stained_glass");
/*  590 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.LIGHT_BLUE.getMetadata(), "light_blue_stained_glass");
/*  591 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.LIME.getMetadata(), "lime_stained_glass");
/*  592 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.MAGENTA.getMetadata(), "magenta_stained_glass");
/*  593 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.ORANGE.getMetadata(), "orange_stained_glass");
/*  594 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.PINK.getMetadata(), "pink_stained_glass");
/*  595 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.PURPLE.getMetadata(), "purple_stained_glass");
/*  596 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.RED.getMetadata(), "red_stained_glass");
/*  597 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.SILVER.getMetadata(), "silver_stained_glass");
/*  598 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.WHITE.getMetadata(), "white_stained_glass");
/*  599 */     registerBlock((Block)Blocks.stained_glass, EnumDyeColor.YELLOW.getMetadata(), "yellow_stained_glass");
/*  600 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.BLACK.getMetadata(), "black_stained_glass_pane");
/*  601 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.BLUE.getMetadata(), "blue_stained_glass_pane");
/*  602 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.BROWN.getMetadata(), "brown_stained_glass_pane");
/*  603 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.CYAN.getMetadata(), "cyan_stained_glass_pane");
/*  604 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.GRAY.getMetadata(), "gray_stained_glass_pane");
/*  605 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.GREEN.getMetadata(), "green_stained_glass_pane");
/*  606 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.LIGHT_BLUE.getMetadata(), "light_blue_stained_glass_pane");
/*  607 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.LIME.getMetadata(), "lime_stained_glass_pane");
/*  608 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.MAGENTA.getMetadata(), "magenta_stained_glass_pane");
/*  609 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.ORANGE.getMetadata(), "orange_stained_glass_pane");
/*  610 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.PINK.getMetadata(), "pink_stained_glass_pane");
/*  611 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.PURPLE.getMetadata(), "purple_stained_glass_pane");
/*  612 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.RED.getMetadata(), "red_stained_glass_pane");
/*  613 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.SILVER.getMetadata(), "silver_stained_glass_pane");
/*  614 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.WHITE.getMetadata(), "white_stained_glass_pane");
/*  615 */     registerBlock((Block)Blocks.stained_glass_pane, EnumDyeColor.YELLOW.getMetadata(), "yellow_stained_glass_pane");
...
/*  643 */     registerBlock((Block)Blocks.stone_slab, BlockStoneSlab.EnumType.BRICK.getMetadata(), "brick_slab");
/*  644 */     registerBlock((Block)Blocks.stone_slab, BlockStoneSlab.EnumType.COBBLESTONE.getMetadata(), "cobblestone_slab");
/*  645 */     registerBlock((Block)Blocks.stone_slab, BlockStoneSlab.EnumType.WOOD.getMetadata(), "old_wood_slab");
/*  646 */     registerBlock((Block)Blocks.stone_slab, BlockStoneSlab.EnumType.NETHERBRICK.getMetadata(), "nether_brick_slab");
/*  647 */     registerBlock((Block)Blocks.stone_slab, BlockStoneSlab.EnumType.QUARTZ.getMetadata(), "quartz_slab");
/*  648 */     registerBlock((Block)Blocks.stone_slab, BlockStoneSlab.EnumType.SAND.getMetadata(), "sandstone_slab");
/*  649 */     registerBlock((Block)Blocks.stone_slab, BlockStoneSlab.EnumType.SMOOTHBRICK.getMetadata(), "stone_brick_slab");
/*  650 */     registerBlock((Block)Blocks.stone_slab, BlockStoneSlab.EnumType.STONE.getMetadata(), "stone_slab");
/*  651 */     registerBlock((Block)Blocks.stone_slab2, BlockStoneSlabNew.EnumType.RED_SANDSTONE.getMetadata(), "red_sandstone_slab");
/*  652 */     registerBlock((Block)Blocks.tallgrass, BlockTallGrass.EnumType.DEAD_BUSH.getMeta(), "dead_bush");
/*  653 */     registerBlock((Block)Blocks.tallgrass, BlockTallGrass.EnumType.FERN.getMeta(), "fern");
/*  654 */     registerBlock((Block)Blocks.tallgrass, BlockTallGrass.EnumType.GRASS.getMeta(), "tall_grass");
/*  655 */     registerBlock((Block)Blocks.wooden_slab, BlockPlanks.EnumType.ACACIA.getMetadata(), "acacia_slab");
/*  656 */     registerBlock((Block)Blocks.wooden_slab, BlockPlanks.EnumType.BIRCH.getMetadata(), "birch_slab");
/*  657 */     registerBlock((Block)Blocks.wooden_slab, BlockPlanks.EnumType.DARK_OAK.getMetadata(), "dark_oak_slab");
/*  658 */     registerBlock((Block)Blocks.wooden_slab, BlockPlanks.EnumType.JUNGLE.getMetadata(), "jungle_slab");
/*  659 */     registerBlock((Block)Blocks.wooden_slab, BlockPlanks.EnumType.OAK.getMetadata(), "oak_slab");
/*  660 */     registerBlock((Block)Blocks.wooden_slab, BlockPlanks.EnumType.SPRUCE.getMetadata(), "spruce_slab");
...
/*  679 */     registerBlock((Block)Blocks.beacon, "beacon");
...
/*  686 */     registerBlock((Block)Blocks.brown_mushroom, "brown_mushroom");
/*  687 */     registerBlock((Block)Blocks.cactus, "cactus");
...
/*  694 */     registerBlock((Block)Blocks.daylight_detector, "daylight_detector");
/*  695 */     registerBlock((Block)Blocks.deadbush, "dead_bush");
...
/*  725 */     registerBlock((Block)Blocks.grass, "grass");
...
/*  730 */     registerBlock((Block)Blocks.hopper, "hopper");
...
/*  746 */     registerBlock((Block)Blocks.mycelium, "mycelium");
...
/*  755 */     registerBlock((Block)Blocks.piston, "piston");
...
/*  764 */     registerBlock((Block)Blocks.red_mushroom, "red_mushroom");
...
/*  773 */     registerBlock((Block)Blocks.sticky_piston, "sticky_piston");
...
/*  781 */     registerBlock((Block)Blocks.tripwire_hook, "tripwire_hook");
...
/*  787 */     registerBlock((Block)Blocks.yellow_flower, BlockFlower.EnumFlowerType.DANDELION.getMeta(), "dandelion");
/*  788 */     registerBlock((Block)Blocks.chest, "chest");
...
/*  796 */     registerItem((Item)Items.bow, 0, "bow");
/*  797 */     registerItem((Item)Items.bow, 1, "bow_pulling_0");
/*  798 */     registerItem((Item)Items.bow, 2, "bow_pulling_1");
/*  799 */     registerItem((Item)Items.bow, 3, "bow_pulling_2");
...
/*  837 */     registerItem((Item)Items.leather_helmet, "leather_helmet");
/*  838 */     registerItem((Item)Items.leather_chestplate, "leather_chestplate");
/*  839 */     registerItem((Item)Items.leather_leggings, "leather_leggings");
/*  840 */     registerItem((Item)Items.leather_boots, "leather_boots");
/*  841 */     registerItem((Item)Items.chainmail_helmet, "chainmail_helmet");
/*  842 */     registerItem((Item)Items.chainmail_chestplate, "chainmail_chestplate");
/*  843 */     registerItem((Item)Items.chainmail_leggings, "chainmail_leggings");
/*  844 */     registerItem((Item)Items.chainmail_boots, "chainmail_boots");
/*  845 */     registerItem((Item)Items.iron_helmet, "iron_helmet");
/*  846 */     registerItem((Item)Items.iron_chestplate, "iron_chestplate");
/*  847 */     registerItem((Item)Items.iron_leggings, "iron_leggings");
/*  848 */     registerItem((Item)Items.iron_boots, "iron_boots");
/*  849 */     registerItem((Item)Items.diamond_helmet, "diamond_helmet");
/*  850 */     registerItem((Item)Items.diamond_chestplate, "diamond_chestplate");
/*  851 */     registerItem((Item)Items.diamond_leggings, "diamond_leggings");
/*  852 */     registerItem((Item)Items.diamond_boots, "diamond_boots");
/*  853 */     registerItem((Item)Items.golden_helmet, "golden_helmet");
/*  854 */     registerItem((Item)Items.golden_chestplate, "golden_chestplate");
/*  855 */     registerItem((Item)Items.golden_leggings, "golden_leggings");
/*  856 */     registerItem((Item)Items.golden_boots, "golden_boots");
...
/*  891 */     registerItem((Item)Items.fishing_rod, "fishing_rod");
/*  892 */     registerItem((Item)Items.fishing_rod, 1, "fishing_rod_cast");
...
/*  923 */     registerItem((Item)Items.shears, "shears");
...
/*  944 */     this.itemModelMesher.register((Item)Items.potionitem, new ItemMeshDefinition()
/*      */         {
...
/*  977 */     registerItem((Item)Items.map, "map");
...
/*  993 */     registerItem((Item)Items.armor_stand, "armor_stand");
...
/* 1020 */     this.itemModelMesher.register((Item)Items.enchanted_book, new ItemMeshDefinition()
/*      */         {
/*      */           public ModelResourceLocation getModelLocation(ItemStack stack)
/*      */           {
...
/*      */           }
/*      */         });
/* 1027 */     this.itemModelMesher.register((Item)Items.filled_map, new ItemMeshDefinition()
/*      */         {
/*      */           public ModelResourceLocation getModelLocation(ItemStack stack)
/*      */           {
