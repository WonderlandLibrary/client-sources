...
/*     */     
/*     */     int k;
/*  29 */     for (k = 1; this.imageWidth < i || this.imageHeight < j; k *= 2) {
/*     */       
...
/*     */         {
/*  87 */           this.imageData[i + j * this.imageWidth] = this.imageData[i + j * this.imageWidth] & 0xFFFFFF;
/*     */         }
/*     */       } 
/*     */     }
/*     */   }
...
/*     */       {
/* 102 */         this.imageData[i + j * this.imageWidth] = this.imageData[i + j * this.imageWidth] | 0xFF000000;
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
