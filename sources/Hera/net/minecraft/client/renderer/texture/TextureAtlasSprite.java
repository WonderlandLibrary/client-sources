...
/*  69 */     return locationNameClock.equals(s) ? new TextureClock(s) : (locationNameCompass.equals(s) ? new TextureCompass(s) : new TextureAtlasSprite(s));
/*     */   }
/*     */ 
/*     */   
...
/*     */       {
/* 223 */         TextureUtil.uploadTextureMipmap(this.framesTextureData.get(k), this.width, this.height, this.originX, this.originY, flag, flag1);
/*     */       }
/*     */     }
...
/*     */       
/* 241 */       int[][] aint = this.framesTextureData.get(i);
/* 242 */       int[][] aint1 = this.framesTextureData.get(k);
/*     */       
...
/* 276 */     return this.framesTextureData.get(index);
/*     */   }
/*     */ 
/*     */   
...
/*     */         
/* 347 */         Iterator<Integer> iterator = meta.getFrameIndexSet().iterator();
/*     */         
...
/*     */       else {
/*     */         
/* 366 */         ArrayList<AnimationFrame> arraylist = Lists.newArrayList();
/*     */         
...
/*     */       
/* 380 */       int[][] aint1 = this.framesTextureData.get(l1);
/*     */       
...
/* 400 */     ArrayList<int[][]> arraylist = Lists.newArrayList();
/*     */     
/* 402 */     for (int i = 0; i < this.framesTextureData.size(); i++) {
/*     */       
/* 404 */       final int[][] aint = this.framesTextureData.get(i);
/*     */       
/* 406 */       if (aint != null) {
/*     */         
/*     */         try {
...
/* 422 */                   StringBuilder stringbuilder = new StringBuilder(); byte b;
/*     */                   int i, arrayOfInt[][];
/* 424 */                   for (i = (arrayOfInt = aint).length, b = 0; b < i; ) { int[] aint1 = arrayOfInt[b];
/*     */                     
