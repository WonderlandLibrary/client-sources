...
/*  60 */     Holder[] astitcher$holder = (Holder[])this.setStitchHolders.toArray((Object[])new Holder[this.setStitchHolders.size()]);
/*  61 */     Arrays.sort((Object[])astitcher$holder); byte b; int i;
/*     */     Holder[] arrayOfHolder1;
/*  63 */     for (i = (arrayOfHolder1 = astitcher$holder).length, b = 0; b < i; ) { Holder stitcher$holder = arrayOfHolder1[b];
/*     */       
...
/*     */     }
/*     */     
/*  88 */     ArrayList<TextureAtlasSprite> arraylist1 = Lists.newArrayList();
/*     */     
...
/*     */       }
/*     */       
/* 202 */       stitcher$slot = new Slot(this.currentWidth, 0, p_94311_1_.getWidth(), this.currentHeight);
