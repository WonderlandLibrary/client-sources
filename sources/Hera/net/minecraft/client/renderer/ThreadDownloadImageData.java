...
/* 117 */           ThreadDownloadImageData.logger.debug("Downloading http texture from {} to {}", new Object[] { ThreadDownloadImageData.access$1(this.this$0), ThreadDownloadImageData.access$2(this.this$0) });
/*     */ 
/*     */           
...
/*     */             }
/*     */             
/* 162 */             ThreadDownloadImageData.this.imageFound = Boolean.valueOf((ThreadDownloadImageData.this.bufferedImage != null)); }  if (httpurlconnection != null) httpurlconnection.disconnect();  ThreadDownloadImageData.this.imageFound = Boolean.valueOf((ThreadDownloadImageData.this.bufferedImage != null));
/*     */         }
/*     */       };
/*     */     
