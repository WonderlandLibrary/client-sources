...
/*  33 */     for (i = (arrayOfGuiListEntry = this.field_178078_x).length, b = 0; b < i; ) { GuiListEntry[] aguipagebuttonlist$guilistentry = arrayOfGuiListEntry[b];
/*     */       
/*  35 */       for (int j = 0; j < aguipagebuttonlist$guilistentry.length; j += 2) {
/*     */         
/*  37 */         GuiListEntry guipagebuttonlist$guilistentry = aguipagebuttonlist$guilistentry[j];
/*  38 */         GuiListEntry guipagebuttonlist$guilistentry1 = (j < aguipagebuttonlist$guilistentry.length - 1) ? aguipagebuttonlist$guilistentry[j + 1] : null;
...
/*     */     int i;
/*     */     GuiListEntry[] arrayOfGuiListEntry;
/* 132 */     for (i = (arrayOfGuiListEntry = this.field_178078_x[p_178060_1_]).length, b = 0; b < i; ) { GuiListEntry guipagebuttonlist$guilistentry = arrayOfGuiListEntry[b];
/*     */       
...
/*     */       b++; }
/*     */     
/* 140 */     for (i = (arrayOfGuiListEntry = this.field_178078_x[p_178060_2_]).length, b = 0; b < i; ) { GuiListEntry guipagebuttonlist$guilistentry1 = arrayOfGuiListEntry[b];
/*     */       
...
/*     */           } 
/*     */           
/* 282 */           this.field_178075_A = this.field_178072_w.get(k);
...
/* 307 */         int j = i; byte b; int k;
/*     */         String[] arrayOfString1;
/* 309 */         for (k = (arrayOfString1 = astring).length, b = 0; b < k; ) { String s1 = arrayOfString1[b];
/*     */           
...
/* 336 */     return this.field_178074_u.get(index);
/*     */   }
/*     */ 
/*     */   
/*     */   public int getSize() {
...
/* 363 */       super(p_i45534_1_, p_i45534_2_, p_i45534_3_);
/* 364 */       this.field_178951_a = (Predicate<String>)Objects.firstNonNull(p_i45534_4_, Predicates.alwaysTrue());
/*     */     }
/*     */ 
/*     */     
...
/* 379 */       super(p_i45535_1_, p_i45535_2_, p_i45535_3_);
...
/* 550 */       super(p_i45532_1_, p_i45532_2_, p_i45532_3_);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 601 */       super(p_i45530_1_, p_i45530_2_, p_i45530_3_);
