...
/*     */   
/*  66 */   protected final Set<Slot> dragSplittingSlots = Sets.newHashSet();
/*     */   
...
/*  92 */     this.guiLeft = (this.width - this.xSize) / 2;
/*  93 */     this.guiTop = (this.height - this.ySize) / 2;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 156 */         itemstack.stackSize = MathHelper.ceiling_float_int(itemstack.stackSize / 2.0F);
/*     */       }
...
/* 186 */       drawItemStack(this.returningStack, l1, i2, (String)null);
/*     */     } 
/*     */     
...
/* 282 */       if (s1 != null) {
/*     */         
/* 284 */         TextureAtlasSprite textureatlassprite = this.mc.getTextureMapBlocks().getAtlasSprite(s1);
...
/*     */             else {
/*     */               
/* 416 */               boolean flag2 = (l != -999 && (Keyboard.isKeyDown(42) || Keyboard.isKeyDown(54)));
/* 417 */               int i1 = 0;
/*     */               
/* 419 */               if (flag2) {
/*     */                 
...
/* 494 */               this.draggedStack.stackSize--;
/*     */             }
/*     */           
/*     */           } else {
/*     */             
...
/*     */           {
/* 541 */             if (slot2 != null && slot2.canTakeStack((EntityPlayer)this.mc.thePlayer) && slot2.getHasStack() && slot2.inventory == slot.inventory && Container.canAddItemToSlot(slot2, this.shiftClickedSlot, true))
/*     */             {
...
/*     */         
/* 617 */         handleMouseClick((Slot)null, -999, Container.func_94534_d(0, this.dragSplittingLimit), 5);
/*     */         
...
/*     */         }
/*     */         
/* 624 */         handleMouseClick((Slot)null, -999, Container.func_94534_d(2, this.dragSplittingLimit), 5);
/*     */       }
...
/*     */         else {
/*     */           
/* 634 */           boolean flag1 = (k != -999 && (Keyboard.isKeyDown(42) || Keyboard.isKeyDown(54)));
/*     */           
/* 636 */           if (flag1)
/*     */           {
...
/*     */     }
/*     */     
/* 685 */     this.mc.playerController.windowClick(this.inventorySlots.windowId, slotId, clickedButton, clickType, (EntityPlayer)this.mc.thePlayer);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     {
/* 742 */       this.inventorySlots.onContainerClosed((EntityPlayer)this.mc.thePlayer);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
