...
/* 220 */       String s1 = this.inputField.getText().substring(0, this.inputField.getCursorPosition());
...
/*     */       } 
/*     */       
/* 246 */       this.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion((IChatComponent)new ChatComponentText(stringbuilder.toString()), 1);
/*     */     } 
/*     */     
/* 249 */     this.inputField.writeText(this.foundPlayerNames.get(this.autocompleteIndex++));
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 256 */       BlockPos blockpos = null;
/*     */       
/* 258 */       if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
/*     */       {
/* 260 */         blockpos = this.mc.objectMouseOver.getBlockPos();
/*     */       }
/*     */       
/* 263 */       this.mc.thePlayer.sendQueue.addToSendQueue((Packet)new C14PacketTabComplete(p_146405_1_, blockpos));
...
/*     */         }
/*     */         
/* 292 */         this.inputField.setText(this.mc.ingameGUI.getChatGUI().getSentMessages().get(i));
...
/* 303 */     drawRect(2, this.height - 14, this.width - 2, this.height - 2, -2147483648);
...
/* 320 */       this.foundPlayerNames.clear(); byte b; int i;
/*     */       String[] arrayOfString;
/* 322 */       for (i = (arrayOfString = p_146406_1_).length, b = 0; b < i; ) { String s = arrayOfString[b];
/*     */         
/* 324 */         if (s.length() > 0)
/*     */         {
...
/* 331 */       String s2 = StringUtils.getCommonPrefix(p_146406_1_);
/*     */       
