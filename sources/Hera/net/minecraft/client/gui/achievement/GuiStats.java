...
/* 156 */       drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), this.width / 2, this.height / 2, 16777215);
/* 157 */       drawCenteredString(this.fontRendererObj, lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % lanSearchStates.length)], this.width / 2, this.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
/*     */     }
/*     */     else {
/*     */       
/* 161 */       this.displaySlot.drawScreen(mouseX, mouseY, partialTicks);
/* 162 */       drawCenteredString(this.fontRendererObj, this.screenTitle, this.width / 2, 20, 16777215);
...
/* 235 */       super(mcIn, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, 20);
...
/* 331 */         this.mc.getSoundHandler().playSound((ISound)PositionedSoundRecord.create(new ResourceLocation("gui.button.press"), 1.0F));
/*     */       } 
/*     */     }
/*     */ 
/*     */     
...
/* 342 */       return this.statsHolder.get(p_148211_1_);
/*     */     }
/*     */ 
/*     */     
...
/* 421 */         String s1 = I18n.format(String.valueOf(s) + ".name", new Object[0]).trim();
/*     */         
/* 423 */         if (s1.length() > 0) {
/*     */           
...
/*     */       } 
/*     */       
/* 451 */       Collections.sort(this.statsHolder, this.statSorter);
/*     */     }
/*     */   }
/*     */   
/*     */   class StatsBlock
...
/*     */         
/* 467 */         if (GuiStats.this.field_146546_t.readStat((StatBase)statcrafting) > 0) {
/*     */           
/* 469 */           flag = true;
/*     */         }
...
/*     */       } 
/*     */       
/* 486 */       this.statSorter = new Comparator<StatCrafting>()
/*     */         {
...
/*     */               }
/*     */               
/* 523 */               int l = (GuiStats.StatsBlock.access$0(GuiStats.StatsBlock.this)).field_146546_t.readStat(statbase);
/* 524 */               int i1 = (GuiStats.StatsBlock.access$0(GuiStats.StatsBlock.this)).field_146546_t.readStat(statbase1);
/*     */               
/* 526 */               if (l != i1)
/*     */               {
...
/* 577 */       func_148209_a((StatBase)statcrafting, p_180791_2_ + 215, p_180791_3_, (entryID % 2 == 0));
/*     */     }
/*     */ 
/*     */     
/*     */     protected String func_148210_b(int p_148210_1_) {
/* 582 */       return (p_148210_1_ == 0) ? "stat.crafted" : ((p_148210_1_ == 1) ? "stat.used" : "stat.mined");
/*     */     }
/*     */   }
/*     */   
/*     */   class StatsGeneral
...
/* 590 */       super(mcIn, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, 10);
...
/*     */     
/*     */     protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
/* 620 */       StatBase statbase = StatList.generalStats.get(entryID);
...
/*     */         
/* 639 */         if (GuiStats.this.field_146546_t.readStat((StatBase)statcrafting) > 0) {
/*     */           
/* 641 */           flag = true;
/*     */         }
...
/*     */       } 
/*     */       
/* 658 */       this.statSorter = new Comparator<StatCrafting>()
/*     */         {
/*     */           public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_)
/*     */           {
...
/*     */               }
/*     */               
/* 695 */               int l = (GuiStats.StatsItem.access$0(GuiStats.StatsItem.this)).field_146546_t.readStat(statbase);
/* 696 */               int i1 = (GuiStats.StatsItem.access$0(GuiStats.StatsItem.this)).field_146546_t.readStat(statbase1);
/*     */               
/* 698 */               if (l != i1)
/*     */               {
...
/* 749 */       func_148209_a((StatBase)statcrafting, p_180791_2_ + 215, p_180791_3_, (entryID % 2 == 0));
/*     */     }
/*     */ 
/*     */     
/*     */     protected String func_148210_b(int p_148210_1_) {
/* 754 */       return (p_148210_1_ == 1) ? "stat.crafted" : ((p_148210_1_ == 2) ? "stat.used" : "stat.depleted");
/*     */     }
/*     */   }
/*     */   
/*     */   class StatsMobsList
...
/* 764 */       super(mcIn, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, GuiStats.this.fontRendererObj.FONT_HEIGHT * 4);
...
/*     */     
/*     */     protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
/* 802 */       EntityList.EntityEggInfo entitylist$entityegginfo = this.field_148222_l.get(entryID);
