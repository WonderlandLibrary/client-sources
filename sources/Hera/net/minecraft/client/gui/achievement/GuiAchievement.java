...
/*  34 */     this.achievementTitle = I18n.format("achievement.get", new Object[0]);
...
/*  59 */     ScaledResolution scaledresolution = new ScaledResolution(this.mc);
...
/*     */       else {
/*     */         
/* 124 */         this.mc.fontRendererObj.drawString(this.achievementTitle, i + 30, j + 7, -256);
