...
/*  48 */     EnumParticleTypes enumparticletypes = null; byte b; int j;
/*     */     EnumParticleTypes[] arrayOfEnumParticleTypes;
/*  50 */     for (j = (arrayOfEnumParticleTypes = EnumParticleTypes.values()).length, b = 0; b < j; ) { EnumParticleTypes enumparticletypes1 = arrayOfEnumParticleTypes[b];
/*     */       
...
/*     */         
/* 109 */         for (int k = 1; k < astring.length; k++) {
/*     */ 
/*     */           
/*     */           try {
/* 113 */             aint[k - 1] = Integer.parseInt(astring[k]);
/*     */           }
/* 115 */           catch (NumberFormatException var29) {
/*     */             
...
/* 131 */     return (args.length == 1) ? getListOfStringsMatchingLastWord(args, EnumParticleTypes.getParticleNames()) : ((args.length > 1 && args.length <= 4) ? func_175771_a(args, 1, pos) : ((args.length == 10) ? getListOfStringsMatchingLastWord(args, new String[] { "normal", "force" }) : null));
/*     */   }
/*     */ }
