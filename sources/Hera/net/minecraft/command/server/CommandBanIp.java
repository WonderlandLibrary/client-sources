...
/*     */     } else {
/*     */       
/*  82 */       throw new WrongUsageException("commands.banip.usage", new Object[0]);
/*     */     } 
/*     */   }
/*     */ 
/*     */   
...
/*  94 */     MinecraftServer.getServer().getConfigurationManager().getBannedIPs().addEntry((UserListEntry)ipbanentry);
...
/* 105 */     if (list.isEmpty()) {
/*     */       
/* 107 */       notifyOperators(p_147210_1_, (ICommand)this, "commands.banip.success", new Object[] { p_147210_2_ });
/*     */     }
/*     */     else {
/*     */       
/* 111 */       notifyOperators(p_147210_1_, (ICommand)this, "commands.banip.success.players", new Object[] { p_147210_2_, joinNiceString((Object[])astring) });
/*     */     } 
/*     */   }
/*     */ }
