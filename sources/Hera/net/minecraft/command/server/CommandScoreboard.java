...
/*      */           
/*  252 */           if (args.length < 4 && (args.length != 3 || !(sender instanceof net.minecraft.entity.player.EntityPlayer)))
/*      */           {
...
/*      */           
/*  261 */           if (args.length < 3 && !(sender instanceof net.minecraft.entity.player.EntityPlayer))
/*      */           {
...
/*  321 */         list.add(s1);
/*      */       }
/*  323 */       catch (CommandException commandexception) {
/*      */         
...
/*  327 */         p_175780_1_.addChatMessage((IChatComponent)chatcomponenttranslation);
/*      */       } 
/*      */     } 
/*      */     
/*  331 */     p_175780_2_[i] = s;
...
/*      */     } 
/*      */     
/*  432 */     notifyOperators(sender, (ICommand)this, "commands.scoreboard.objectives.add.success", new Object[] { s });
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*      */     } 
/*      */     
/*  478 */     notifyOperators(sender, (ICommand)this, "commands.scoreboard.teams.add.success", new Object[] { s });
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*      */       } 
/*      */       
/*  574 */       notifyOperators(sender, (ICommand)this, "commands.scoreboard.teams.option.success", new Object[] { s, scoreplayerteam.getRegisteredName(), s1 });
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*  587 */       notifyOperators(p_147194_1_, (ICommand)this, "commands.scoreboard.teams.remove.success", new Object[] { scoreplayerteam.getRegisteredName() });
/*      */     } 
/*      */   }
/*      */ 
/*      */   
...
/*  614 */       p_147186_1_.addChatMessage((IChatComponent)chatcomponenttranslation);
/*  615 */       p_147186_1_.addChatMessage((IChatComponent)new ChatComponentText(joinNiceString(collection.toArray())));
/*      */     }
/*      */     else {
/*      */       
...
/*  629 */       p_147186_1_.addChatMessage((IChatComponent)chatcomponenttranslation1);
/*      */       
/*  631 */       for (ScorePlayerTeam scoreplayerteam1 : collection1) {
/*      */         
/*  633 */         p_147186_1_.addChatMessage((IChatComponent)new ChatComponentTranslation("commands.scoreboard.teams.list.entry", new Object[] { scoreplayerteam1.getRegisteredName(), scoreplayerteam1.getTeamName(), Integer.valueOf(scoreplayerteam1.getMembershipCollection().size()) }));
/*      */       } 
/*      */     } 
/*      */   }
/*      */ 
...
/*      */       
/*  647 */       String s4 = getCommandSenderAsPlayer(p_147190_1_).getName();
/*      */       
...
/*  699 */       notifyOperators(p_147190_1_, (ICommand)this, "commands.scoreboard.teams.join.success", new Object[] { Integer.valueOf(set.size()), s, joinNiceString(set.toArray((Object[])new String[set.size()])) });
/*      */     } 
/*      */     
/*  702 */     if (!set1.isEmpty())
/*      */     {
...
/*      */     
/*  714 */     if (p_147199_1_ instanceof net.minecraft.entity.player.EntityPlayer && p_147199_3_ == p_147199_2_.length) {
/*      */       
/*  716 */       String s3 = getCommandSenderAsPlayer(p_147199_1_).getName();
/*      */       
...
/*  768 */       notifyOperators(p_147199_1_, (ICommand)this, "commands.scoreboard.teams.leave.success", new Object[] { Integer.valueOf(set.size()), joinNiceString(set.toArray((Object[])new String[set.size()])) });
/*      */     } 
/*      */     
/*  771 */     if (!set1.isEmpty())
/*      */     {
...
/*      */       }
/*      */       
/*  798 */       notifyOperators(p_147188_1_, (ICommand)this, "commands.scoreboard.teams.empty.success", new Object[] { Integer.valueOf(collection.size()), scoreplayerteam.getRegisteredName() });
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*  808 */     notifyOperators(p_147191_1_, (ICommand)this, "commands.scoreboard.objectives.remove.success", new Object[] { p_147191_2_ });
/*      */   }
/*      */ 
/*      */   
...
/*  824 */     p_147196_1_.addChatMessage((IChatComponent)chatcomponenttranslation);
/*      */     
/*  826 */     for (ScoreObjective scoreobjective : collection) {
/*      */       
/*  828 */       p_147196_1_.addChatMessage((IChatComponent)new ChatComponentTranslation("commands.scoreboard.objectives.list.entry", new Object[] { scoreobjective.getName(), scoreobjective.getDisplayName(), scoreobjective.getCriteria().getName() }));
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*      */       
/*  855 */       notifyOperators(p_147198_1_, (ICommand)this, "commands.scoreboard.objectives.setdisplay.successSet", new Object[] { Scoreboard.getObjectiveDisplaySlot(i), scoreobjective.getName() });
/*      */     }
/*      */     else {
/*      */       
/*  859 */       notifyOperators(p_147198_1_, (ICommand)this, "commands.scoreboard.objectives.setdisplay.successCleared", new Object[] { Scoreboard.getObjectiveDisplaySlot(i) });
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*  881 */       p_147195_1_.addChatMessage((IChatComponent)chatcomponenttranslation);
/*      */       
/*  883 */       for (Score score : map.values())
/*      */       {
/*  885 */         p_147195_1_.addChatMessage((IChatComponent)new ChatComponentTranslation("commands.scoreboard.players.list.player.entry", new Object[] { Integer.valueOf(score.getScorePoints()), score.getObjective().getDisplayName(), score.getObjective().getName() }));
/*      */       }
/*      */     
/*      */     } else {
/*      */       
...
/*  900 */       p_147195_1_.addChatMessage((IChatComponent)chatcomponenttranslation1);
/*  901 */       p_147195_1_.addChatMessage((IChatComponent)new ChatComponentText(joinNiceString(collection.toArray())));
/*      */     } 
/*      */   }
/*      */ 
/*      */   
...
/*      */         
/*  930 */         if (!NBTUtil.func_181123_a((NBTBase)nbttagcompound, (NBTBase)nbttagcompound1, true))
/*      */         {
/*  932 */           throw new CommandException("commands.scoreboard.players.set.tagMismatch", new Object[] { s1 });
/*      */         }
/*      */       }
/*  935 */       catch (NBTException nbtexception) {
/*      */         
...
/*      */     } 
/*      */     
/*  957 */     notifyOperators(p_147197_1_, (ICommand)this, "commands.scoreboard.players.set.success", new Object[] { scoreobjective.getName(), s1, Integer.valueOf(score.getScorePoints()) });
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  970 */       notifyOperators(p_147187_1_, (ICommand)this, "commands.scoreboard.players.resetscore.success", new Object[] { scoreobjective.getName(), s });
/*      */     }
/*      */     else {
/*      */       
/*  974 */       scoreboard.removeObjectiveFromEntity(s, null);
/*  975 */       notifyOperators(p_147187_1_, (ICommand)this, "commands.scoreboard.players.reset.success", new Object[] { s });
/*      */     } 
/*      */   }
/*      */ 
/*      */   
...
/* 1000 */     notifyOperators(p_175779_1_, (ICommand)this, "commands.scoreboard.players.enable.success", new Object[] { scoreobjective.getName(), s });
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/* 1031 */       notifyOperators(p_175781_1_, (ICommand)this, "commands.scoreboard.players.test.success", new Object[] { Integer.valueOf(score.getScorePoints()), Integer.valueOf(i), Integer.valueOf(j) });
/*      */     }
/*      */     else {
/*      */       
...
/*      */     } 
/*      */     
/* 1120 */     notifyOperators(p_175778_1_, (ICommand)this, "commands.scoreboard.players.operation.success", new Object[0]);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1352 */     return !args[0].equalsIgnoreCase("players") ? (args[0].equalsIgnoreCase("teams") ? ((index == 2)) : false) : ((args.length > 1 && args[1].equalsIgnoreCase("operation")) ? (!(index != 2 && index != 5)) : ((index == 2)));
/*      */   }
/*      */ }
