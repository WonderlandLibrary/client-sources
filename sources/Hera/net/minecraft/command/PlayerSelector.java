...
/*  66 */     return (list.size() == 1) ? list.get(0) : null;
/*     */   }
/*     */ 
/*     */   
...
/*     */     else {
/*     */       
/* 145 */       Collections.addAll(list, (Object[])(MinecraftServer.getServer()).worldServers);
/*     */     } 
/*     */     
/* 148 */     return list;
/*     */   }
...
/* 160 */       commandSender.addChatMessage((IChatComponent)chatcomponenttranslation);
/* 161 */       return false;
/*     */     } 
/*     */ 
/*     */     
...
/* 185 */       if (flag1)
/*     */       {
/* 187 */         list.add(new Predicate<Entity>()
/*     */             {
/*     */               public boolean apply(Entity p_apply_1_)
/*     */               {
/* 191 */                 return p_apply_1_ instanceof net.minecraft.entity.player.EntityPlayer;
/*     */               }
/*     */             });
/*     */       }
/*     */     }
/*     */     else {
/*     */       
/* 198 */       final String s_f = s;
/* 199 */       list.add(new Predicate<Entity>()
/*     */           {
/*     */             public boolean apply(Entity p_apply_1_)
/*     */             {
/* 203 */               return EntityList.isStringEntityName(p_apply_1_, s_f) ^ flag;
/*     */             }
/*     */           });
/*     */     } 
/*     */     
...
/* 214 */     final int i = parseIntWithDefault(p_179648_0_, "lm", -1);
/* 215 */     final int j = parseIntWithDefault(p_179648_0_, "l", -1);
/*     */     
/* 217 */     if (i > -1 || j > -1)
/*     */     {
/* 219 */       list.add(new Predicate<Entity>()
/*     */           {
/*     */             public boolean apply(Entity p_apply_1_)
/*     */             {
...
/* 230 */               return ((i <= -1 || entityplayermp.experienceLevel >= i) && (j <= -1 || entityplayermp.experienceLevel <= j));
/*     */             }
/*     */           });
/*     */     }
/*     */ 
...
/* 242 */     final int i = parseIntWithDefault(p_179649_0_, "m", WorldSettings.GameType.NOT_SET.getID());
/*     */     
/* 244 */     if (i != WorldSettings.GameType.NOT_SET.getID())
/*     */     {
/* 246 */       list.add(new Predicate<Entity>()
/*     */           {
/*     */             public boolean apply(Entity p_apply_1_)
/*     */             {
...
/* 257 */               return (entityplayermp.theItemInWorldManager.getGameType().getID() == i);
/*     */             }
/*     */           });
/*     */     }
/*     */ 
...
/* 277 */     if (s != null) {
/*     */       
/* 279 */       final String s_f = s;
/* 280 */       list.add(new Predicate<Entity>()
/*     */           {
/*     */             public boolean apply(Entity p_apply_1_)
/*     */             {
...
/* 305 */     final Map<String, Integer> map = func_96560_a(p_179657_0_);
/*     */     
/* 307 */     if (map != null && map.size() > 0)
/*     */     {
/* 309 */       list.add(new Predicate<Entity>()
/*     */           {
/*     */             public boolean apply(Entity p_apply_1_)
/*     */             {
/* 313 */               Scoreboard scoreboard = MinecraftServer.getServer().worldServerForDimension(0).getScoreboard();
/*     */               
/* 315 */               for (Map.Entry<String, Integer> entry : (Iterable<Map.Entry<String, Integer>>)map.entrySet()) {
/*     */                 
/* 317 */                 String s = entry.getKey();
...
/*     */                 } 
/*     */                 
/* 326 */                 ScoreObjective scoreobjective = scoreboard.getObjective(s);
/*     */                 
...
/* 373 */     if (s != null) {
/*     */       
/* 375 */       final String s_f = s;
/* 376 */       list.add(new Predicate<Entity>()
/*     */           {
/*     */             public boolean apply(Entity p_apply_1_)
/*     */             {
/* 380 */               return p_apply_1_.getName().equals(s_f) ^ flag;
/*     */             }
/*     */           });
/*     */     } 
/*     */     
...
/* 396 */       final int k = i * i;
/* 397 */       final int l = j * j;
/* 398 */       list.add(new Predicate<Entity>()
/*     */           {
/*     */             public boolean apply(Entity p_apply_1_)
/*     */             {
/* 402 */               int i1 = (int)p_apply_1_.getDistanceSqToCenter(p_180698_1_);
...
/*     */       
/* 417 */       final int i = func_179650_a(parseIntWithDefault(p_179662_0_, "rym", 0));
...
/* 424 */               return (i > j) ? (!(i1 < i && i1 > j)) : ((i1 >= i && i1 <= j));
/*     */             }
/*     */           });
/*     */     } 
/*     */     
...
/*     */       } else {
/*     */         
/* 496 */         final AxisAlignedBB axisalignedbb = func_179661_a(position, i, j, k);
/*     */         
/* 498 */         if (flag && flag2 && !flag1)
/*     */         {
/* 500 */           Predicate<Entity> predicate2 = new Predicate<Entity>()
/*     */             {
/*     */               public boolean apply(Entity p_apply_1_)
/*     */               {
/* 504 */                 return (p_apply_1_.posX >= axisalignedbb.minX && p_apply_1_.posY >= axisalignedbb.minY && p_apply_1_.posZ >= axisalignedbb.minZ) ? ((p_apply_1_.posX < axisalignedbb.maxX && p_apply_1_.posY < axisalignedbb.maxY && p_apply_1_.posZ < axisalignedbb.maxZ)) : false;
/*     */               }
/*     */             };
...
/*     */       
/* 544 */       Collections.sort(p_179658_0_, (Comparator)new Comparator<Entity>()
/*     */           {
/*     */             public int compare(Entity p_compare_1_, Entity p_compare_2_)
/*     */             {
/* 548 */               return ComparisonChain.start().compare(p_compare_1_.getDistanceSq(p_179658_5_), p_compare_2_.getDistanceSq(p_179658_5_)).result();
/*     */             }
/*     */           });
/*     */     } 
/*     */     
...
/*     */     {
/* 557 */       p_179658_0_ = Lists.newArrayList((Object[])new Entity[] { entity });
/*     */     }
/*     */     
/* 560 */     if (i != 0) {
/*     */       
...
/* 624 */     return p_179653_0_.containsKey(p_179653_1_) ? MathHelper.parseIntWithDefault(p_179653_0_.get(p_179653_1_), p_179653_2_) : p_179653_2_;
/*     */   }
/*     */ 
/*     */   
/*     */   private static String func_179651_b(Map<String, String> p_179651_0_, String p_179651_1_) {
/* 629 */     return p_179651_0_.get(p_179651_1_);
/*     */   }
/*     */ 
/*     */   
...
/*     */       {
/* 640 */         map.put(s.substring("score_".length()), Integer.valueOf(MathHelper.parseIntWithDefault(p_96560_0_.get(s), 1)));
/*     */       }
/*     */     } 
/*     */     
/* 644 */     return map;
