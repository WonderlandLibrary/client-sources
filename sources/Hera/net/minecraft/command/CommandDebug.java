...
/*  97 */     File file1 = new File(MinecraftServer.getServer().getFile("debug"), "profile-results-" + (new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss")).format(new Date()) + ".txt");
...
/*     */         
/* 136 */         Profiler.Result profiler$result = list.get(i);
...
/*     */           try {
/*     */             
/* 150 */             func_147202_a(p_147202_1_ + 1, String.valueOf(p_147202_2_) + "." + profiler$result.field_76331_c, p_147202_3_);
/*     */           }
