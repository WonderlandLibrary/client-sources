...
/*  75 */       return (this.riddenByEntity != entity && this.ridingEntity != entity) ? true : true;
/*     */     } 
/*     */ 
/*     */     
/*  79 */     return false;
...
/* 112 */       i += EnchantmentHelper.getKnockbackModifier((EntityLivingBase)this);
/*     */     } 
/*     */     
/* 115 */     boolean flag = entityIn.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), f);
/*     */     
/* 117 */     if (flag) {
/*     */       
/* 119 */       if (i > 0) {
...
/*     */       } 
/*     */       
/* 126 */       int j = EnchantmentHelper.getFireAspectModifier((EntityLivingBase)this);
/*     */       
/* 128 */       if (j > 0)
/*     */       {
...
/*     */       }
/*     */       
/* 133 */       applyEnchantments((EntityLivingBase)this, entityIn);
/*     */     } 
/*     */     
/* 136 */     return flag;
/*     */   }
...
/*     */     
/* 151 */     if (this.worldObj.getLightFor(EnumSkyBlock.SKY, blockpos) > this.rand.nextInt(32))
/*     */     {
/* 153 */       return false;
/*     */     }
/*     */ 
