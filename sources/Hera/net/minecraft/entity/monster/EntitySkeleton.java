...
/* 158 */               setCurrentItemOrArmor(4, (ItemStack)null);
/*     */             } 
/*     */           } 
/*     */           
/* 162 */           flag = false;
...
/*     */       {
/* 209 */         entityplayer.triggerAchievement((StatBase)AchievementList.snipeSkeleton);
/*     */       }
/*     */     }
...
/* 273 */     setCurrentItemOrArmor(0, new ItemStack((Item)Items.bow));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 284 */     if (this.worldObj.provider instanceof net.minecraft.world.WorldProviderHell && getRNG().nextInt(5) > 0) {
/*     */       
/* 286 */       this.tasks.addTask(4, (EntityAIBase)this.aiAttackOnCollide);
...
/*     */     else {
/*     */       
/* 293 */       this.tasks.addTask(4, (EntityAIBase)this.aiArrowAttack);
...
/* 319 */     this.tasks.removeTask((EntityAIBase)this.aiAttackOnCollide);
/* 320 */     this.tasks.removeTask((EntityAIBase)this.aiArrowAttack);
/* 321 */     ItemStack itemstack = getHeldItem();
/*     */     
/* 323 */     if (itemstack != null && itemstack.getItem() == Items.bow) {
/*     */       
/* 325 */       this.tasks.addTask(4, (EntityAIBase)this.aiArrowAttack);
/*     */     }
/*     */     else {
/*     */       
/* 329 */       this.tasks.addTask(4, (EntityAIBase)this.aiAttackOnCollide);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* 338 */     EntityArrow entityarrow = new EntityArrow(this.worldObj, (EntityLivingBase)this, p_82196_1_, 1.6F, (14 - this.worldObj.getDifficulty().getDifficultyId() * 4));
...
/* 359 */     this.worldObj.spawnEntityInWorld((Entity)entityarrow);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
