...
/* 256 */     return !isInWater() ? "mob.guardian.land.idle" : (isElder() ? "mob.guardian.elder.idle" : "mob.guardian.idle");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 264 */     return !isInWater() ? "mob.guardian.land.hit" : (isElder() ? "mob.guardian.elder.hit" : "mob.guardian.hit");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 272 */     return !isInWater() ? "mob.guardian.land.death" : (isElder() ? "mob.guardian.elder.death" : "mob.guardian.death");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */         }
/*     */         
/* 313 */         this.field_175480_bp = (this.motionY < 0.0D && this.worldObj.isBlockNormalCube((new BlockPos((Entity)this)).down(), false));
/*     */       }
...
/*     */           
/* 368 */           getLookHelper().setLookPositionWithEntity((Entity)entitylivingbase, 90.0F, 90.0F);
...
/*     */         
/* 441 */         for (EntityPlayerMP entityplayermp : this.worldObj.getPlayers(EntityPlayerMP.class, new Predicate<EntityPlayerMP>()
/*     */             {
/*     */               public boolean apply(EntityPlayerMP p_apply_1_)
/*     */               {
/* 445 */                 return (EntityGuardian.this.getDistanceSqToEntity((Entity)p_apply_1_) < 2500.0D && p_apply_1_.theItemInWorldManager.survivalOrAdventure());
/*     */               }
/*     */             })) {
/*     */           
...
/*     */             
/* 451 */             entityplayermp.playerNetServerHandler.sendPacket((Packet)new S2BPacketChangeGameState(10, 0.0F));
...
/* 457 */       if (!hasHome())
/*     */       {
/* 459 */         setHomePosAndDistance(new BlockPos((Entity)this), 16);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 496 */     ItemStack itemstack = ((WeightedRandomFishable)WeightedRandom.getRandomItem(this.rand, EntityFishHook.func_174855_j())).getItemStack(this.rand);
...
/*     */         
/* 535 */         entitylivingbase.attackEntityFrom(DamageSource.causeThornsDamage((Entity)this), 2.0F);
...
/* 603 */       return (super.continueExecuting() && (this.theEntity.isElder() || this.theEntity.getDistanceSqToEntity((Entity)this.theEntity.getAttackTarget()) > 9.0D));
/*     */     }
/*     */ 
/*     */     
...
/* 610 */       this.theEntity.getLookHelper().setLookPositionWithEntity((Entity)this.theEntity.getAttackTarget(), 90.0F, 90.0F);
...
/* 625 */       this.theEntity.getLookHelper().setLookPositionWithEntity((Entity)entitylivingbase, 90.0F, 90.0F);
/*     */       
/* 627 */       if (!this.theEntity.canEntityBeSeen((Entity)entitylivingbase)) {
/*     */         
/* 629 */         this.theEntity.setAttackTarget(null);
/*     */       }
/*     */       else {
/*     */         
/* 633 */         this.tickCounter++;
/*     */         
/* 635 */         if (this.tickCounter == 0) {
/*     */           
/* 637 */           this.theEntity.setTargetedEntity(this.theEntity.getAttackTarget().getEntityId());
/* 638 */           this.theEntity.worldObj.setEntityState((Entity)this.theEntity, (byte)21);
/*     */         }
...
/*     */           }
/*     */           
/* 654 */           entitylivingbase.attackEntityFrom(DamageSource.causeIndirectMagicDamage((Entity)this.theEntity, (Entity)this.theEntity), f);
/* 655 */           entitylivingbase.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this.theEntity), (float)this.theEntity.getEntityAttribute(SharedMonsterAttributes.attackDamage).getAttributeValue());
...
/* 674 */       super((EntityLiving)p_i45831_1_);
...
/* 687 */         d1 /= d3;
/* 688 */         float f = (float)(MathHelper.func_181159_b(d2, d0) * 180.0D / Math.PI) - 90.0F;
...
/* 738 */       return ((p_apply_1_ instanceof EntityPlayer || p_apply_1_ instanceof net.minecraft.entity.passive.EntitySquid) && p_apply_1_.getDistanceSqToEntity((Entity)this.parentEntity) > 9.0D);
/*     */     }
/*     */   }
/*     */ }
