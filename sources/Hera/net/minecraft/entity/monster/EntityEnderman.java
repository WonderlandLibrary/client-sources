...
/* 138 */     return (d1 > 1.0D - 0.025D / d0) ? player.canEntityBeSeen((Entity)this) : false;
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/*     */       
/* 181 */       if (f > 0.5F && this.worldObj.canSeeSky(new BlockPos((Entity)this)) && this.rand.nextFloat() * 30.0F < (f - 0.4F) * 2.0F) {
/*     */         
...
/* 252 */       if (flag1) {
/*     */         
/* 254 */         setPositionAndUpdate(this.posX, this.posY, this.posZ);
/*     */         
/* 256 */         if (this.worldObj.getCollidingBoundingBoxes((Entity)this, getEntityBoundingBox()).isEmpty() && !this.worldObj.isAnyLiquid(getEntityBoundingBox()))
/*     */         {
/* 258 */           flag = true;
/*     */         }
/*     */       } 
...
/* 447 */       super(p_i45842_1_, EntityPlayer.class, true);
...
/* 455 */       Collections.sort(list, (Comparator<? super EntityPlayer>)this.theNearestAttackableTargetSorter);
/*     */       
/* 457 */       if (list.isEmpty())
/*     */       {
/* 459 */         return false;
...
/* 494 */         this.enderman.faceEntity((Entity)this.player, 10.0F, 10.0F);
/* 495 */         return true;
/*     */       } 
/*     */ 
/*     */ 
...
/*     */         {
/* 510 */           this.targetEntity = (EntityLivingBase)this.player;
...
/*     */             
/* 525 */             if (this.targetEntity.getDistanceSqToEntity((Entity)this.enderman) < 16.0D)
/*     */             {
...
/*     */           }
/* 532 */           else if (this.targetEntity.getDistanceSqToEntity((Entity)this.enderman) > 256.0D && this.field_179451_i++ >= 30 && this.enderman.teleportToEntity((Entity)this.targetEntity)) {
/*     */             
...
/*     */     
/*     */     public boolean shouldExecute() {
/* 554 */       return !this.enderman.worldObj.getGameRules().getBoolean("mobGriefing") ? false : ((this.enderman.getHeldBlockState().getBlock().getMaterial() == Material.air) ? false : ((this.enderman.getRNG().nextInt(2000) == 0)));
/*     */     }
/*     */ 
/*     */     
/*     */     public void updateTask() {
...
/* 577 */       return !p_179474_3_.canPlaceBlockAt(worldIn, p_179474_2_) ? false : ((p_179474_4_.getMaterial() != Material.air) ? false : ((p_179474_5_.getMaterial() == Material.air) ? false : p_179474_5_.isFullCube()));
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/*     */     public boolean shouldExecute() {
/* 592 */       return !this.enderman.worldObj.getGameRules().getBoolean("mobGriefing") ? false : ((this.enderman.getHeldBlockState().getBlock().getMaterial() != Material.air) ? false : ((this.enderman.getRNG().nextInt(20) == 0)));
/*     */     }
/*     */ 
/*     */     
/*     */     public void updateTask() {
