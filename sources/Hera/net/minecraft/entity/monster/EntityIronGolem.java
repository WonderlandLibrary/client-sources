...
/*  50 */     this.tasks.addTask(1, (EntityAIBase)new EntityAIAttackOnCollide(this, 1.0D, true));
/*  51 */     this.tasks.addTask(2, (EntityAIBase)new EntityAIMoveTowardsTarget(this, 0.9D, 32.0F));
/*  52 */     this.tasks.addTask(3, (EntityAIBase)new EntityAIMoveThroughVillage(this, 0.6D, true));
/*  53 */     this.tasks.addTask(4, (EntityAIBase)new EntityAIMoveTowardsRestriction(this, 1.0D));
/*  54 */     this.tasks.addTask(5, (EntityAIBase)new EntityAILookAtVillager(this));
/*  55 */     this.tasks.addTask(6, (EntityAIBase)new EntityAIWander(this, 0.6D));
/*  56 */     this.tasks.addTask(7, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityPlayer.class, 6.0F));
/*  57 */     this.tasks.addTask(8, (EntityAIBase)new EntityAILookIdle((EntityLiving)this));
/*  58 */     this.targetTasks.addTask(1, (EntityAIBase)new EntityAIDefendVillage(this));
/*  59 */     this.targetTasks.addTask(2, (EntityAIBase)new EntityAIHurtByTarget(this, false, new Class[0]));
/*  60 */     this.targetTasks.addTask(3, (EntityAIBase)new AINearestAttackableTargetNonCreeper(this, EntityLiving.class, 10, false, true, IMob.VISIBLE_MOB_SELECTOR));
/*     */   }
/*     */ 
/*     */   
...
/*  74 */       this.villageObj = this.worldObj.getVillageCollection().getNearestVillage(new BlockPos((Entity)this), 32);
/*     */       
...
/*     */     {
/* 125 */       this.attackTimer--;
/*     */     }
/*     */     
/* 128 */     if (this.holdRoseTick > 0)
/*     */     {
/* 130 */       this.holdRoseTick--;
/*     */     }
/*     */     
...
/* 177 */     this.worldObj.setEntityState((Entity)this, (byte)4);
/* 178 */     boolean flag = entityIn.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), (7 + this.rand.nextInt(15)));
/*     */     
/* 180 */     if (flag) {
/*     */       
/* 182 */       entityIn.motionY += 0.4000000059604645D;
/* 183 */       applyEnchantments((EntityLivingBase)this, entityIn);
/*     */     } 
/*     */     
...
/* 220 */     this.worldObj.setEntityState((Entity)this, (byte)11);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     {
/* 253 */       dropItemWithOffset(Item.getItemFromBlock((Block)Blocks.red_flower), 1, BlockFlower.EnumFlowerType.POPPY.getMeta());
/*     */     }
/*     */     
...
/* 305 */       super(creature, classTarget, chance, p_i45858_4_, p_i45858_5_, p_i45858_6_);
/* 306 */       this.targetEntitySelector = new Predicate<T>()
/*     */         {
...
/*     */               } 
/*     */               
/* 341 */               if (p_apply_1_.getDistanceToEntity((Entity)creature) > d0)
/*     */               {
/* 343 */                 return false;
/*     */               }
/*     */             } 
/*     */             
/* 347 */             return EntityIronGolem.AINearestAttackableTargetNonCreeper.this.isSuitableTarget((EntityLivingBase)p_apply_1_, false);
/*     */           }
/*     */         };
/*     */     }
/*     */   }
