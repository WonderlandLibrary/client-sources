...
/*  44 */     this.targetTasks.addTask(2, (EntityAIBase)new AISpiderTarget<EntityPlayer>(this, EntityPlayer.class));
/*  45 */     this.targetTasks.addTask(3, (EntityAIBase)new AISpiderTarget<EntityIronGolem>(this, EntityIronGolem.class));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  61 */     return (PathNavigate)new PathNavigateClimber((EntityLiving)this, worldIn);
/*     */   }
/*     */ 
/*     */   
...
/* 207 */       this.worldObj.spawnEntityInWorld((Entity)entityskeleton);
/* 208 */       entityskeleton.mountEntity((Entity)this);
/*     */     } 
/*     */     
...
/*     */       
/* 215 */       if (this.worldObj.getDifficulty() == EnumDifficulty.HARD && this.worldObj.rand.nextFloat() < 0.1F * difficulty.getClampedAdditionalDifficulty())
/*     */       {
...
/*     */       {
/* 227 */         addPotionEffect(new PotionEffect(i, 2147483647));
/*     */       }
/*     */     } 
/*     */     
...
/* 243 */       super(p_i45819_1_, targetClass, 1.0D, true);
/*     */     }
/*     */ 
/*     */     
...
/* 271 */       super(p_i45818_1_, classTarget, true);
/*     */     }
/*     */ 
/*     */     
