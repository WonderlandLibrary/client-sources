...
/*  39 */     this.targetTasks.addTask(1, (EntityAIBase)new EntityAIFindEntityNearestPlayer((EntityLiving)this));
/*     */   }
/*     */ 
/*     */   
...
/*  82 */       ((EntityPlayer)source.getEntity()).triggerAchievement((StatBase)AchievementList.ghast);
/*  83 */       return true;
/*     */     } 
/*     */ 
/*     */     
...
/* 232 */       double d0 = 64.0D;
/*     */       
/* 234 */       if (entitylivingbase.getDistanceSqToEntity((Entity)this.parentEntity) < d0 * d0 && this.parentEntity.canEntityBeSeen((Entity)entitylivingbase)) {
/*     */         
/* 236 */         World world = this.parentEntity.worldObj;
/* 237 */         this.attackTimer++;
/*     */         
/* 239 */         if (this.attackTimer == 10)
/*     */         {
/* 241 */           world.playAuxSFXAtEntity(null, 1007, new BlockPos((Entity)this.parentEntity), 0);
/*     */         }
/*     */         
...
/* 251 */           world.playAuxSFXAtEntity(null, 1008, new BlockPos((Entity)this.parentEntity), 0);
/* 252 */           EntityLargeFireball entitylargefireball = new EntityLargeFireball(world, (EntityLivingBase)this.parentEntity, d2, d3, d4);
...
/* 257 */           world.spawnEntityInWorld((Entity)entitylargefireball);
/* 258 */           this.attackTimer = -40;
/*     */         }
/*     */       
/* 261 */       } else if (this.attackTimer > 0) {
/*     */         
/* 263 */         this.attackTimer--;
/*     */       } 
/*     */       
...
/* 294 */         double d0 = 64.0D;
/*     */         
/* 296 */         if (entitylivingbase.getDistanceSqToEntity((Entity)this.parentEntity) < d0 * d0) {
/*     */           
...
/* 356 */       super((EntityLiving)p_i45838_1_);
...
/*     */         
/* 399 */         if (!this.parentEntity.worldObj.getCollidingBoundingBoxes((Entity)this.parentEntity, axisalignedbb).isEmpty())
/*     */         {
/* 401 */           return false;
/*     */         }
/*     */       } 
