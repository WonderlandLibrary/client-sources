...
/*  107 */     this.randomMobsId = (int)(j & 0x7FFFFFFFL);
/*      */   }
/*      */ 
/*      */   
...
/*  121 */     return (PathNavigate)new PathNavigateGround(this, worldIn);
/*      */   }
/*      */ 
/*      */   
...
/*      */ 
/*      */   
/*      */   public boolean canAttackClass(Class<EntityGhast> cls) {
...
/*      */       }
/*      */       
/*  370 */       nbttaglist.appendTag((NBTBase)nbttagcompound);
/*      */     } 
/*      */     
/*  373 */     tagCompound.setTag("Equipment", (NBTBase)nbttaglist);
/*  374 */     NBTTagList nbttaglist1 = new NBTTagList();
/*      */     
/*  376 */     for (int j = 0; j < this.equipmentDropChances.length; j++)
/*      */     {
/*  378 */       nbttaglist1.appendTag((NBTBase)new NBTTagFloat(this.equipmentDropChances[j]));
/*      */     }
/*      */     
/*  381 */     tagCompound.setTag("DropChances", (NBTBase)nbttaglist1);
...
/*      */       } 
/*      */       
/*  401 */       tagCompound.setTag("Leash", (NBTBase)nbttagcompound1);
/*      */     } 
/*      */     
/*  404 */     if (isAIDisabled())
/*      */     {
...
/*      */             }
/*      */           
/*  527 */           } else if (itemstack.getItem() instanceof net.minecraft.item.ItemBow && itemstack1.getItem() instanceof net.minecraft.item.ItemBow) {
/*      */             
...
/*      */           {
/*  573 */             entityplayer.triggerAchievement((StatBase)AchievementList.diamondsToYou);
/*      */           }
/*      */         } 
/*      */         
...
/*  580 */         onItemPickup((Entity)itemEntity, 1);
...
/*      */     }
/*  612 */     else if ((this.entityAge & 0x1F) == 31 && (object = Reflector.call(Reflector.ForgeEventFactory_canEntityDespawn, new Object[] { this })) != object1) {
/*      */       
...
/*  701 */     double d2, d0 = entityIn.posX - this.posX;
...
/*  716 */     float f = (float)(MathHelper.func_181159_b(d1, d0) * 180.0D / Math.PI) - 90.0F;
/*  717 */     float f1 = (float)-(MathHelper.func_181159_b(d2, d3) * 180.0D / Math.PI);
...
/*  954 */         if (itemTier == 0)
/*      */         {
/*  956 */           return (Item)Items.leather_helmet;
/*      */         }
/*  958 */         if (itemTier == 1)
/*      */         {
/*  960 */           return (Item)Items.golden_helmet;
/*      */         }
/*  962 */         if (itemTier == 2)
/*      */         {
/*  964 */           return (Item)Items.chainmail_helmet;
/*      */         }
/*  966 */         if (itemTier == 3)
/*      */         {
/*  968 */           return (Item)Items.iron_helmet;
/*      */         }
/*  970 */         if (itemTier == 4)
/*      */         {
/*  972 */           return (Item)Items.diamond_helmet;
/*      */         }
/*      */       
/*      */       case 3:
/*  976 */         if (itemTier == 0)
/*      */         {
/*  978 */           return (Item)Items.leather_chestplate;
/*      */         }
/*  980 */         if (itemTier == 1)
/*      */         {
/*  982 */           return (Item)Items.golden_chestplate;
/*      */         }
/*  984 */         if (itemTier == 2)
/*      */         {
/*  986 */           return (Item)Items.chainmail_chestplate;
/*      */         }
/*  988 */         if (itemTier == 3)
/*      */         {
/*  990 */           return (Item)Items.iron_chestplate;
/*      */         }
/*  992 */         if (itemTier == 4)
/*      */         {
/*  994 */           return (Item)Items.diamond_chestplate;
/*      */         }
/*      */       
/*      */       case 2:
/*  998 */         if (itemTier == 0)
/*      */         {
/* 1000 */           return (Item)Items.leather_leggings;
/*      */         }
/* 1002 */         if (itemTier == 1)
/*      */         {
/* 1004 */           return (Item)Items.golden_leggings;
/*      */         }
/* 1006 */         if (itemTier == 2)
/*      */         {
/* 1008 */           return (Item)Items.chainmail_leggings;
/*      */         }
/* 1010 */         if (itemTier == 3)
/*      */         {
/* 1012 */           return (Item)Items.iron_leggings;
/*      */         }
/* 1014 */         if (itemTier == 4)
/*      */         {
/* 1016 */           return (Item)Items.diamond_leggings;
/*      */         }
/*      */       
/*      */       case 1:
/* 1020 */         if (itemTier == 0)
/*      */         {
/* 1022 */           return (Item)Items.leather_boots;
/*      */         }
/* 1024 */         if (itemTier == 1)
/*      */         {
/* 1026 */           return (Item)Items.golden_boots;
/*      */         }
/* 1028 */         if (itemTier == 2)
/*      */         {
/* 1030 */           return (Item)Items.chainmail_boots;
/*      */         }
/* 1032 */         if (itemTier == 3)
/*      */         {
/* 1034 */           return (Item)Items.iron_boots;
/*      */         }
/* 1036 */         if (itemTier == 4)
/*      */         {
/* 1038 */           return (Item)Items.diamond_boots;
/*      */         }
/*      */         break;
/*      */     } 
/* 1042 */     return null;
...
/*      */       } 
/*      */       
/* 1139 */       if (((EntityTameable)this).isOwner((EntityLivingBase)playerIn)) {
/*      */         
/* 1141 */         setLeashedToEntity((Entity)playerIn, true);
/* 1142 */         itemstack.stackSize--;
/* 1143 */         return true;
/*      */       } 
/*      */     } 
/*      */     
...
/*      */       {
/* 1200 */         ((WorldServer)this.worldObj).getEntityTracker().sendToAllTrackingEntity(this, (Packet)new S1BPacketEntityAttach(1, this, null));
/*      */       }
/*      */     } 
/*      */   }
/*      */ 
...
/* 1207 */     return (!getLeashed() && !(this instanceof net.minecraft.entity.monster.IMob));
/*      */   }
/*      */ 
/*      */   
...
/*      */       
/* 1345 */       if (this.worldObj.getBlockState((BlockPos)blockposm).getBlock().isVisuallyOpaque())
/*      */       {
/* 1347 */         return true;
/*      */       }
/*      */     } 
...
/*      */ 
/*      */     
/* 1383 */     Entity entity = world.playerEntities.get(0);
...
/* 1394 */     this.entityAge++;
/*      */     
/* 1396 */     if (this instanceof net.minecraft.entity.monster.EntityMob) {
/*      */       
...
/*      */     
/* 1415 */     private static final SpawnPlacementType[] $VALUES = new SpawnPlacementType[] { ON_GROUND, IN_AIR, IN_WATER };
