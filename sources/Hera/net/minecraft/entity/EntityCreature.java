...
/*  20 */   private EntityAIBase aiBase = (EntityAIBase)new EntityAIMoveTowardsRestriction(this, 1.0D);
/*     */   
...
/*  56 */     return (this.maximumHomeDistance == -1.0F) ? true : ((this.homePosition.distanceSq((Vec3i)pos) < (this.maximumHomeDistance * this.maximumHomeDistance)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
