...
/*     */     
/*  33 */     if (itemstack != null && itemstack.getItem() == Items.spawn_egg) {
/*     */       
...
/*     */             
/*  45 */             entityageable.setGrowingAge(-24000);
...
/* 141 */     this.dataWatcher.updateObject(12, Byte.valueOf((byte)MathHelper.clamp_int(age, -1, 1)));
...
/*     */         {
/* 180 */           this.worldObj.spawnParticle(EnumParticleTypes.VILLAGER_HAPPY, this.posX + (this.rand.nextFloat() * this.width * 2.0F) - this.width, this.posY + 0.5D + (this.rand.nextFloat() * this.height), this.posZ + (this.rand.nextFloat() * this.width * 2.0F) - this.width, 0.0D, 0.0D, 0.0D, new int[0]);
/*     */         }
/*     */         
/* 183 */         this.field_175503_c--;
/*     */       } 
/*     */       
