...
/*  70 */     this.aiAvoidWolves = new AIAvoidEntity<EntityWolf>(this, EntityWolf.class, 16.0F, 1.33D, 1.33D);
...
/* 217 */     this.rotationYaw = (float)(MathHelper.func_181159_b(z - this.posZ, x - this.posX) * 180.0D / Math.PI) - 90.0F;
/*     */   }
/*     */ 
/*     */   
...
/*     */       {
/* 253 */         this.worldObj.setEntityState((Entity)this, (byte)1);
/*     */       }
/*     */       
/* 256 */       this.field_175540_bm++;
/*     */     }
...
/* 326 */       return entityIn.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), 8.0F);
/*     */     } 
/*     */ 
/*     */     
/* 330 */     return entityIn.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), 3.0F);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 387 */     return !(itemIn != Items.carrot && itemIn != Items.golden_carrot && itemIn != Item.getItemFromBlock((Block)Blocks.yellow_flower));
/*     */   }
/*     */ 
/*     */   
...
/*     */       
/* 420 */       this.tasks.removeTask((EntityAIBase)this.aiAvoidWolves);
/* 421 */       this.tasks.addTask(4, (EntityAIBase)new AIEvilAttack(this));
/* 422 */       this.targetTasks.addTask(1, (EntityAIBase)new EntityAIHurtByTarget((EntityCreature)this, false, new Class[0]));
/* 423 */       this.targetTasks.addTask(2, (EntityAIBase)new EntityAINearestAttackableTarget((EntityCreature)this, EntityPlayer.class, true));
/* 424 */       this.targetTasks.addTask(2, (EntityAIBase)new EntityAINearestAttackableTarget((EntityCreature)this, EntityWolf.class, true));
/*     */       
/* 426 */       if (!hasCustomName())
/*     */       {
/* 428 */         setCustomNameTag(StatCollector.translateToLocal("entity.KillerBunny.name"));
/*     */       }
/*     */     } 
/*     */     
...
/* 483 */     this.worldObj.spawnParticle(EnumParticleTypes.BLOCK_DUST, this.posX + (this.rand.nextFloat() * this.width * 2.0F) - this.width, this.posY + 0.5D + (this.rand.nextFloat() * this.height), this.posZ + (this.rand.nextFloat() * this.width * 2.0F) - this.width, 0.0D, 0.0D, 0.0D, new int[] { Block.getStateId(Blocks.carrots.getStateFromMeta(7)) });
...
/* 507 */       super((EntityCreature)p_i46403_1_, p_i46403_2_, p_i46403_3_, p_i46403_4_, p_i46403_6_);
...
/* 521 */       super((EntityCreature)p_i45867_1_, EntityLivingBase.class, 1.4D, true);
/*     */     }
/*     */ 
/*     */     
...
/* 536 */       super((EntityCreature)p_i45861_1_, speedIn);
...
/* 555 */       super((EntityCreature)p_i45860_1_, 0.699999988079071D, 16);
...
/*     */         
/* 602 */         if (this.field_179499_e && block instanceof BlockCarrot && ((Integer)iblockstate.getValue((IProperty)BlockCarrot.AGE)).intValue() == 7) {
/*     */           
...
/*     */         
/* 624 */         if (block instanceof BlockCarrot && ((Integer)iblockstate.getValue((IProperty)BlockCarrot.AGE)).intValue() == 7 && this.field_179498_d && !this.field_179499_e) {
/*     */           
...
/* 719 */       super((EntityLiving)p_i45862_1_);
