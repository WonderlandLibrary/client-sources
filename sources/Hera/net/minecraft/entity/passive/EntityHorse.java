...
/*      */       }
/*      */     };
/*   52 */   private static final IAttribute horseJumpStrength = (IAttribute)(new RangedAttribute(null, "horse.jumpStrength", 0.7D, 0.0D, 2.0D)).setDescription("Jump Strength").setShouldWatch(true);
...
/*   95 */     this.tasks.addTask(0, (EntityAIBase)new EntityAISwimming((EntityLiving)this));
/*   96 */     this.tasks.addTask(1, (EntityAIBase)new EntityAIPanic((EntityCreature)this, 1.2D));
/*   97 */     this.tasks.addTask(1, (EntityAIBase)new EntityAIRunAroundLikeCrazy(this, 1.2D));
/*   98 */     this.tasks.addTask(2, (EntityAIBase)new EntityAIMate(this, 1.0D));
/*   99 */     this.tasks.addTask(4, (EntityAIBase)new EntityAIFollowParent(this, 1.0D));
/*  100 */     this.tasks.addTask(6, (EntityAIBase)new EntityAIWander((EntityCreature)this, 0.7D));
...
/*  295 */     return (item == Items.iron_horse_armor) ? 1 : ((item == Items.golden_horse_armor) ? 2 : ((item == Items.diamond_horse_armor) ? 3 : 0));
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*      */       
/*  402 */       dropItem(Item.getItemFromBlock((Block)Blocks.chest), 1);
...
/*  411 */     if (!isSilent())
/*      */     {
/*  413 */       this.worldObj.playSoundAtEntity((Entity)this, "eating", 1.0F, 1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F);
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/*  440 */         this.worldObj.playSoundAtEntity((Entity)this, block$soundtype.getStepSound(), block$soundtype.getVolume() * 0.5F, block$soundtype.getFrequency() * 0.75F);
/*      */       } 
/*      */     } 
/*      */   }
/*      */ 
...
/*  563 */     return (i == 3) ? "mob.horse.zombie.death" : ((i == 4) ? "mob.horse.skeleton.death" : ((i != 1 && i != 2) ? "mob.horse.death" : "mob.horse.donkey.death"));
/*      */   }
/*      */ 
/*      */   
...
/*  570 */     return (i == 4) ? Items.bone : ((i == 3) ? (flag ? null : Items.rotten_flesh) : Items.leather);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  586 */     return (i == 3) ? "mob.horse.zombie.hit" : ((i == 4) ? "mob.horse.skeleton.hit" : ((i != 1 && i != 2) ? "mob.horse.hit" : "mob.horse.donkey.hit"));
/*      */   }
/*      */ 
/*      */   
...
/*  607 */     return (i == 3) ? "mob.horse.zombie.idle" : ((i == 4) ? "mob.horse.skeleton.idle" : ((i != 1 && i != 2) ? "mob.horse.idle" : "mob.horse.donkey.idle"));
/*      */   }
/*      */ 
/*      */   
...
/*  615 */     return (i != 3 && i != 4) ? ((i != 1 && i != 2) ? "mob.horse.angry" : "mob.horse.donkey.angry") : null;
/*      */   }
/*      */ 
/*      */   
...
/*  733 */       this.texturePrefix = String.valueOf(this.texturePrefix) + HORSE_TEXTURES_ABBR[k];
/*      */       
...
/*  742 */       this.texturePrefix = String.valueOf(this.texturePrefix) + HORSE_MARKING_TEXTURES_ABBR[l];
/*      */     }
/*      */     else {
/*      */       
/*  746 */       this.horseTexturesArray[0] = "";
/*  747 */       this.texturePrefix = String.valueOf(this.texturePrefix) + "_" + i + "_";
/*      */     } 
/*      */     
...
/*  759 */       this.texturePrefix = String.valueOf(this.texturePrefix) + HORSE_ARMOR_TEXTURES_ABBR[i1];
...
/*  789 */       playerEntity.displayGUIHorse(this, (IInventory)this.horseChest);
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*  931 */       if (!isTame() && !flag) {
/*      */         
/*  933 */         if (itemstack != null && itemstack.interactWithEntity(player, (EntityLivingBase)this))
/*      */         {
/*  935 */           return true;
/*      */         }
/*      */         
...
/*      */       } 
/*      */       
/*  942 */       if (!flag && canCarryChest() && !isChested() && itemstack.getItem() == Item.getItemFromBlock((Block)Blocks.chest)) {
/*      */         
/*  944 */         setChested(true);
...
/*  956 */       if (flag) {
/*      */         
/*  958 */         if (!player.capabilities.isCreativeMode && --itemstack.stackSize == 0)
/*      */         {
...
/*      */       
/*  969 */       if (itemstack != null && itemstack.interactWithEntity(player, (EntityLivingBase)this))
/*      */       {
/*  971 */         return true;
/*      */       }
/*      */ 
...
/*      */     {
/*  995 */       player.mountEntity((Entity)this);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1021 */     return (this.riddenByEntity != null && isHorseSaddled()) ? true : (!(!isEatingHaystack() && !isRearing()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */         
/* 1101 */         EntityHorse entityhorse = getClosestHorse((Entity)this, 16.0D);
/*      */         
/* 1103 */         if (entityhorse != null && getDistanceSqToEntity((Entity)entityhorse) > 4.0D)
/*      */         {
/* 1105 */           this.navigator.getPathToEntityLiving((Entity)entityhorse);
/*      */         }
/*      */       } 
/*      */     } 
/*      */   }
...
/* 1276 */     dropItemsInChest((Entity)this, this.horseChest);
/* 1277 */     dropChests();
/*      */   }
/*      */ 
/*      */   
...
/* 1418 */           nbttaglist.appendTag((NBTBase)nbttagcompound);
/*      */         } 
/*      */       } 
/*      */       
/* 1422 */       tagCompound.setTag("Items", (NBTBase)nbttaglist);
/*      */     } 
/*      */     
/* 1425 */     if (this.horseChest.getStackInSlot(1) != null)
/*      */     {
/* 1427 */       tagCompound.setTag("ArmorItem", (NBTBase)this.horseChest.getStackInSlot(1).writeToNBT(new NBTTagCompound()));
/*      */     }
/*      */     
/* 1430 */     if (this.horseChest.getStackInSlot(0) != null)
/*      */     {
/* 1432 */       tagCompound.setTag("SaddleItem", (NBTBase)this.horseChest.getStackInSlot(0).writeToNBT(new NBTTagCompound()));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1459 */       s = PreYggdrasilConverter.getStringUUIDFromName(s1);
/*      */     } 
/*      */     
/* 1462 */     if (s.length() > 0)
/*      */     {
...
/* 1565 */     if (k == 0) {
/*      */       
/* 1567 */       int l, i1 = this.rand.nextInt(9);
/*      */ 
/*      */       
/* 1570 */       if (i1 < 4) {
/*      */         
...
/*      */       } 
/*      */       
/* 1830 */       if (itemStackIn != null && itemStackIn.getItem() == Item.getItemFromBlock((Block)Blocks.chest) && !isChested()) {
/*      */         
