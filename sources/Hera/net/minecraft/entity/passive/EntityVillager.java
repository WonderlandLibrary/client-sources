...
/*  486 */         if (flag) {
/*      */           
/*  488 */           this.worldObj.setEntityState((Entity)this, (byte)18);
...
/*      */     {
/*  535 */       this.worldObj.spawnEntityInWorld((Entity)new EntityXPOrb(this.worldObj, this.posX, this.posY + 0.5D, this.posZ, i));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */       
/*  595 */       ITradeList[] aentityvillager$itradelist2 = aentityvillager$itradelist1[j]; byte b; int k;
/*      */       ITradeList[] arrayOfITradeList1;
/*  597 */       for (k = (arrayOfITradeList1 = aentityvillager$itradelist2).length, b = 0; b < k; ) { ITradeList entityvillager$itradelist = arrayOfITradeList1[b];
/*      */         
...
/*  620 */       return (IChatComponent)chatcomponenttext;
/*      */     } 
/*      */ 
/*      */     
...
/*      */           
/*  640 */           s1 = "fisherman"; break;
/*      */         } 
/*  642 */         if (this.careerId == 3) {
/*      */           
/*  644 */           s1 = "shepherd"; break;
/*      */         } 
/*  646 */         if (this.careerId == 4)
/*      */         {
/*  648 */           s1 = "fletcher";
/*      */         }
/*      */         break;
...
/*  664 */           s1 = "armor"; break;
/*      */         } 
/*  666 */         if (this.careerId == 2) {
/*      */           
/*  668 */           s1 = "weapon"; break;
/*      */         } 
/*  670 */         if (this.careerId == 3)
/*      */         {
/*  672 */           s1 = "tool";
/*      */         }
/*      */         break;
...
/*      */           
/*  680 */           s1 = "butcher"; break;
/*      */         } 
/*  682 */         if (this.careerId == 2)
/*      */         {
/*  684 */           s1 = "leather";
/*      */         }
/*      */         break;
...
/*  693 */       return (IChatComponent)chatcomponenttranslation;
/*      */     } 
/*      */ 
/*      */     
...
/*  765 */     entityvillager.onInitialSpawn(this.worldObj.getDifficultyForLocation(new BlockPos((Entity)entityvillager)), (IEntityLivingData)null);
...
/*  783 */       entitywitch.onInitialSpawn(this.worldObj.getDifficultyForLocation(new BlockPos((Entity)entitywitch)), null);
...
/*      */       } 
/*      */       
/*  792 */       this.worldObj.spawnEntityInWorld((Entity)entitywitch);
/*  793 */       setDead();
/*      */     } 
/*      */   }
/*      */ 
...
/*  848 */     return flag ? (!hasEnoughItems(5)) : (!hasEnoughItems(1));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1057 */       if (i < 0) {
/*      */         
/* 1059 */         itemstack = new ItemStack(Items.emerald, 1, 0);
...
/* 1076 */       super(Integer.valueOf(p_i45810_1_), Integer.valueOf(p_i45810_2_));
/*      */     }
/*      */ 
/*      */     
