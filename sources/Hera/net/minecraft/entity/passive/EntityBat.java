...
/*  91 */     getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(6.0D);
/*     */   }
/*     */ 
/*     */   
...
/* 134 */     BlockPos blockpos = new BlockPos((Entity)this);
...
/*     */         }
/*     */         
/* 151 */         if (this.worldObj.getClosestPlayerToEntity((Entity)this, 4.0D) != null)
/*     */         {
...
/* 176 */       float f = (float)(MathHelper.func_181159_b(this.motionZ, this.motionX) * 180.0D / Math.PI) - 90.0F;
