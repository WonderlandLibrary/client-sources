...
/* 127 */     return this.worldObj.handleMaterialAcceleration(getEntityBoundingBox().expand(0.0D, -0.6000000238418579D, 0.0D), Material.water, (Entity)this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */         }
/*     */         
/* 158 */         this.worldObj.setEntityState((Entity)this, (byte)19);
/*     */       } 
/*     */     }
/*     */     
/* 162 */     if (this.inWater) {
...
/* 196 */       this.squidYaw = (float)(this.squidYaw + Math.PI * this.field_70871_bB * 1.5D);
