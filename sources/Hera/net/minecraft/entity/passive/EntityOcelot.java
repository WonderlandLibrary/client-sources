...
/*  49 */     this.tasks.addTask(2, (EntityAIBase)this.aiSit);
/*  50 */     this.tasks.addTask(3, (EntityAIBase)(this.aiTempt = new EntityAITempt((EntityCreature)this, 0.6D, Items.fish, true)));
/*  51 */     this.tasks.addTask(5, (EntityAIBase)new EntityAIFollowOwner(this, 1.0D, 10.0F, 5.0F));
/*  52 */     this.tasks.addTask(6, (EntityAIBase)new EntityAIOcelotSit(this, 0.8D));
/*  53 */     this.tasks.addTask(7, (EntityAIBase)new EntityAILeapAtTarget((EntityLiving)this, 0.3F));
/*  54 */     this.tasks.addTask(8, (EntityAIBase)new EntityAIOcelotAttack((EntityLiving)this));
/*  55 */     this.tasks.addTask(9, (EntityAIBase)new EntityAIMate(this, 0.8D));
/*  56 */     this.tasks.addTask(10, (EntityAIBase)new EntityAIWander((EntityCreature)this, 0.8D));
/*  57 */     this.tasks.addTask(11, (EntityAIBase)new EntityAIWatchClosest((EntityLiving)this, EntityPlayer.class, 10.0F));
/*  58 */     this.targetTasks.addTask(1, (EntityAIBase)new EntityAITargetNonTamed(this, EntityChicken.class, false, null));
/*     */   }
/*     */ 
/*     */   
...
/* 138 */     return isTamed() ? (isInLove() ? "mob.cat.purr" : ((this.rand.nextInt(4) == 0) ? "mob.cat.purreow" : "mob.cat.meow")) : "";
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 172 */     return entityIn.attackEntityFrom(DamageSource.causeMobDamage((EntityLivingBase)this), 3.0F);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 205 */     if (isTamed()) {
/*     */       
/* 207 */       if (isOwner((EntityLivingBase)player) && !this.worldObj.isRemote && !isBreedingItem(itemstack))
/*     */       {
/* 209 */         this.aiSit.setSitting(!isSitting());
/*     */       }
/*     */     }
/* 212 */     else if (this.aiTempt.isRunning() && itemstack != null && itemstack.getItem() == Items.fish && player.getDistanceSqToEntity((Entity)this) < 9.0D) {
/*     */       
/* 214 */       if (!player.capabilities.isCreativeMode)
/*     */       {
/* 216 */         itemstack.stackSize--;
/*     */       }
/*     */       
...
/* 233 */           this.worldObj.setEntityState((Entity)this, (byte)7);
/*     */         }
/*     */         else {
/*     */           
/* 237 */           playTameEffect(false);
/* 238 */           this.worldObj.setEntityState((Entity)this, (byte)6);
/*     */         } 
/*     */       }
/*     */       
/* 242 */       return true;
...
/* 291 */     return !entityocelot.isTamed() ? false : ((isInLove() && entityocelot.isInLove()));
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 318 */     if (this.worldObj.checkNoEntityCollision(getEntityBoundingBox(), (Entity)this) && this.worldObj.getCollidingBoundingBoxes((Entity)this, getEntityBoundingBox()).isEmpty() && !this.worldObj.isAnyLiquid(getEntityBoundingBox())) {
/*     */       
...
/*     */       
/* 329 */       if (block == Blocks.grass || block.getMaterial() == Material.leaves)
/*     */       {
/* 331 */         return true;
/*     */       }
/*     */     } 
...
/* 343 */     return hasCustomName() ? getCustomNameTag() : (isTamed() ? StatCollector.translateToLocal("entity.Cat.name") : super.getName());
/*     */   }
/*     */ 
/*     */   
...
/*     */     {
/* 355 */       this.avoidEntity = new EntityAIAvoidEntity((EntityCreature)this, EntityPlayer.class, 16.0F, 0.8D, 1.33D);
/*     */     }
/*     */     
/* 358 */     this.tasks.removeTask((EntityAIBase)this.avoidEntity);
/*     */     
/* 360 */     if (!isTamed())
/*     */     {
/* 362 */       this.tasks.addTask(4, (EntityAIBase)this.avoidEntity);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 380 */         entityocelot.setGrowingAge(-24000);
/* 381 */         this.worldObj.spawnEntityInWorld((Entity)entityocelot);
/*     */       } 
/*     */     }
/*     */     
