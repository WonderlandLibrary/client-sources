...
/*  25 */   private static final Map<Class<?>, Integer> dataTypes = Maps.newHashMap();
...
/*  39 */     Integer integer = dataTypes.get(object.getClass());
/*     */     
/*  41 */     if (integer == null)
/*     */     {
...
/*  45 */     if (id > 31)
/*     */     {
/*  47 */       throw new IllegalArgumentException("Data value id is too big with " + id + "! (Max is " + '\037' + ")");
/*     */     }
...
/*     */     
/*     */     try {
/* 127 */       datawatcher$watchableobject = this.watchedObjects.get(Integer.valueOf(id));
/*     */     }
...
/*     */       
/*     */       case 5:
/* 284 */         itemstack = (ItemStack)object.getObject();
/* 285 */         buffer.writeItemStackToBuffer(itemstack);
/*     */         break;
/*     */       
/*     */       case 6:
/* 289 */         blockpos = (BlockPos)object.getObject();
...
/*     */       
/*     */       case 7:
/* 296 */         rotations = (Rotations)object.getObject();
...
/*     */         
/*     */         case 6:
/* 345 */           l = buffer.readInt();
/* 346 */           i1 = buffer.readInt();
/* 347 */           j1 = buffer.readInt();
/* 348 */           datawatcher$watchableobject = new WatchableObject(j, k, new BlockPos(l, i1, j1));
/*     */           break;
/*     */         
/*     */         case 7:
/* 352 */           f = buffer.readFloat();
/* 353 */           f1 = buffer.readFloat();
/* 354 */           f2 = buffer.readFloat();
...
/*     */       
/* 370 */       WatchableObject datawatcher$watchableobject1 = this.watchedObjects.get(Integer.valueOf(datawatcher$watchableobject.getDataValueId()));
/*     */       
