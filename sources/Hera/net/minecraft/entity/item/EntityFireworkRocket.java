...
/*  78 */       this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.func_181159_b(x, z) * 180.0D / Math.PI);
/*  79 */       this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.func_181159_b(y, f) * 180.0D / Math.PI);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*  97 */     this.rotationYaw = (float)(MathHelper.func_181159_b(this.motionX, this.motionZ) * 180.0D / Math.PI);
/*     */     
/*  99 */     for (this.rotationPitch = (float)(MathHelper.func_181159_b(this.motionY, f) * 180.0D / Math.PI); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F);
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/* 172 */       tagCompound.setTag("FireworksItem", (NBTBase)nbttagcompound);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
