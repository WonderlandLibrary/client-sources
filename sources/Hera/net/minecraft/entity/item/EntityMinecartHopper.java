...
/*     */     {
/*  66 */       playerIn.displayGUIChest((IInventory)this);
/*     */     }
/*     */     
/*  69 */     return true;
/*     */   }
...
/* 176 */     if (list.size() > 0)
/*     */     {
/* 178 */       TileEntityHopper.putDropInInventoryAllSlots((IInventory)this, list.get(0));
/*     */     }
/*     */     
/* 181 */     return false;
/*     */   }
...
/* 236 */     return (Container)new ContainerHopper(playerInventory, (IInventory)this, playerIn);
/*     */   }
/*     */ }
