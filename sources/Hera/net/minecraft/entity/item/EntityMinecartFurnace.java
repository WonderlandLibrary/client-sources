...
/*     */     {
/*  65 */       this.worldObj.spawnParticle(EnumParticleTypes.SMOKE_LARGE, this.posX, this.posY + 0.8D, this.posZ, 0.0D, 0.0D, 0.0D, new int[0]);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     
/* 145 */     if (itemstack != null && itemstack.getItem() == Items.coal) {
/*     */       
/* 147 */       if (!playerIn.capabilities.isCreativeMode && --itemstack.stackSize == 0)
/*     */       {
...
/* 201 */     return (isMinecartPowered() ? Blocks.lit_furnace : Blocks.furnace).getDefaultState().withProperty((IProperty)BlockFurnace.FACING, (Comparable)EnumFacing.NORTH);
/*     */   }
/*     */ }
