...
/*     */       
/* 257 */       if (this.worldObj.isAABBInMaterial(axisalignedbb, Material.water))
/*     */       {
/* 259 */         d0 += 1.0D / i;
/*     */       }
/*     */     } 
...
/* 265 */     if (d9 > 0.2975D) {
/*     */       
/* 267 */       double d2 = Math.cos(this.rotationYaw * Math.PI / 180.0D);
/* 268 */       double d4 = Math.sin(this.rotationYaw * Math.PI / 180.0D);
/*     */       
...
/* 300 */         this.boatPosRotationIncrements--;
...
/*     */             {
/* 420 */               dropItemWithOffset(Item.getItemFromBlock(Blocks.planks), 1, 0.0F);
/*     */             }
/*     */             
...
/*     */       {
/* 444 */         d15 = (float)(MathHelper.func_181159_b(d21, d18) * 180.0D / Math.PI);
/*     */       }
/*     */       
...
/*     */       
/* 491 */       double d0 = Math.cos(this.rotationYaw * Math.PI / 180.0D) * 0.4D;
/* 492 */       double d1 = Math.sin(this.rotationYaw * Math.PI / 180.0D) * 0.4D;
...
/*     */             {
/* 547 */               dropItemWithOffset(Item.getItemFromBlock(Blocks.planks), 1, 0.0F);
/*     */             }
/*     */             
...
/*     */       }
/*     */     
/* 560 */     } else if (this.worldObj.getBlockState((new BlockPos(this)).down()).getBlock().getMaterial() != Material.water && y < 0.0D) {
/*     */       
