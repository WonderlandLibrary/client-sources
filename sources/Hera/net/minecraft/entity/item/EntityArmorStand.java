...
/*     */     {
/* 307 */       nbttagcompound.setTag("Head", (NBTBase)this.headRotation.writeToNBT());
/*     */     }
/*     */     
/* 310 */     if (!DEFAULT_BODY_ROTATION.equals(this.bodyRotation))
/*     */     {
/* 312 */       nbttagcompound.setTag("Body", (NBTBase)this.bodyRotation.writeToNBT());
/*     */     }
/*     */     
/* 315 */     if (!DEFAULT_LEFTARM_ROTATION.equals(this.leftArmRotation))
/*     */     {
/* 317 */       nbttagcompound.setTag("LeftArm", (NBTBase)this.leftArmRotation.writeToNBT());
/*     */     }
/*     */     
/* 320 */     if (!DEFAULT_RIGHTARM_ROTATION.equals(this.rightArmRotation))
/*     */     {
/* 322 */       nbttagcompound.setTag("RightArm", (NBTBase)this.rightArmRotation.writeToNBT());
/*     */     }
/*     */     
/* 325 */     if (!DEFAULT_LEFTLEG_ROTATION.equals(this.leftLegRotation))
/*     */     {
/* 327 */       nbttagcompound.setTag("LeftLeg", (NBTBase)this.leftLegRotation.writeToNBT());
/*     */     }
/*     */     
/* 330 */     if (!DEFAULT_RIGHTLEG_ROTATION.equals(this.rightLegRotation))
/*     */     {
/* 332 */       nbttagcompound.setTag("RightLeg", (NBTBase)this.rightLegRotation.writeToNBT());
/*     */     }
/*     */     
...
/* 352 */     List<Entity> list = this.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this, getEntityBoundingBox());
/*     */     
/* 354 */     if (list != null && !list.isEmpty())
/*     */     {
/* 356 */       for (int i = 0; i < list.size(); i++) {
/*     */         
/* 358 */         Entity entity = list.get(i);
/*     */         
...
/*     */         {
/* 362 */           entity.applyEntityCollision((Entity)this);
/*     */         }
/*     */       } 
/*     */     }
/*     */   }
...
/*     */       
/* 418 */       if (d3 >= 0.1D && d3 < 0.1D + (flag1 ? 0.8D : 0.45D) && this.contents[1] != null) {
/*     */         
/* 420 */         j = 1;
/*     */       }
/* 422 */       else if (d3 >= 0.9D + (flag1 ? 0.3D : 0.0D) && d3 < 0.9D + (flag1 ? 1.0D : 0.7D) && this.contents[3] != null) {
/*     */         
/* 424 */         j = 3;
/*     */       }
/* 426 */       else if (d3 >= 0.4D && d3 < 0.4D + (flag1 ? 1.0D : 0.8D) && this.contents[2] != null) {
/*     */         
/* 428 */         j = 2;
/*     */       }
/* 430 */       else if (d3 >= 1.6D && this.contents[4] != null) {
/*     */         
/* 432 */         j = 4;
/*     */       } 
/*     */       
...
/*     */ 
/*     */       
/* 563 */       if (source.getSourceOfDamage() instanceof net.minecraft.entity.projectile.EntityArrow)
/*     */       {
...
/*     */     {
/* 625 */       ((WorldServer)this.worldObj).spawnParticle(EnumParticleTypes.BLOCK_DUST, this.posX, this.posY + this.height / 1.5D, this.posZ, 10, (this.width / 4.0F), (this.height / 4.0F), (this.width / 4.0F), 0.05D, new int[] { Block.getStateId(Blocks.planks.getDefaultState()) });
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/* 647 */     Block.spawnAsEntity(this.worldObj, new BlockPos((Entity)this), new ItemStack((Item)Items.armor_stand));
/* 648 */     dropContents();
/*     */   }
/*     */ 
/*     */   
...
/*     */         {
/* 659 */           Block.spawnAsEntity(this.worldObj, (new BlockPos((Entity)this)).up(), this.contents[i]);
/*     */         }
/*     */         
