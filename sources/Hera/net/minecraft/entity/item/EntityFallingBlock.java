...
/*     */             {
/* 131 */               if (this.worldObj.canBlockBePlaced(block, blockpos1, true, EnumFacing.UP, null, null) && !BlockFalling.canFallInto(this.worldObj, blockpos1.down()) && this.worldObj.setBlockState(blockpos1, this.fallTile, 3)) {
/*     */                 
...
/* 190 */       if (i > 0) {
/*     */         
/* 192 */         List<Entity> list = Lists.newArrayList(this.worldObj.getEntitiesWithinAABBExcludingEntity(this, getEntityBoundingBox()));
...
/*     */           
/* 203 */           int j = ((Integer)this.fallTile.getValue((IProperty)BlockAnvil.DAMAGE)).intValue();
/* 204 */           j++;
/*     */           
/* 206 */           if (j > 2) {
/*     */             
...
/*     */           else {
/*     */             
/* 212 */             this.fallTile = this.fallTile.withProperty((IProperty)BlockAnvil.DAMAGE, Integer.valueOf(j));
/*     */           } 
/*     */         } 
/*     */       } 
/*     */     } 
...
/*     */     {
/* 236 */       tagCompound.setTag("TileEntityData", (NBTBase)this.tileEntityData);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
