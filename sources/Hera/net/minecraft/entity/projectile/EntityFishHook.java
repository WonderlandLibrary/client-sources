...
/* 144 */     this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.func_181159_b(p_146035_1_, p_146035_5_) * 180.0D / Math.PI);
/* 145 */     this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.func_181159_b(p_146035_3_, f1) * 180.0D / Math.PI);
...
/* 187 */       this.fishPosRotationIncrements--;
...
/*     */         
/* 197 */         if (this.angler.isDead || !this.angler.isEntityAlive() || itemstack == null || itemstack.getItem() != Items.fishing_rod || getDistanceSqToEntity((Entity)this.angler) > 1024.0D) {
/*     */           
/* 199 */           setDead();
...
/*     */           
/* 297 */           if (movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, (Entity)this.angler), 0.0F))
/*     */           {
...
/* 312 */         this.rotationYaw = (float)(MathHelper.func_181159_b(this.motionX, this.motionZ) * 180.0D / Math.PI);
/*     */         
/* 314 */         for (this.rotationPitch = (float)(MathHelper.func_181159_b(this.motionY, f5) * 180.0D / Math.PI); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F);
/*     */ 
/*     */ 
/*     */ 
/*     */         
...
/*     */           
/* 354 */           if (this.worldObj.isAABBInMaterial(axisalignedbb2, Material.water))
/*     */           {
/* 356 */             d10 += 1.0D / j;
/*     */           }
/*     */         } 
...
/* 466 */             this.ticksCaughtDelay -= EnchantmentHelper.getLureModifier((EntityLivingBase)this.angler) * 20 * 5;
/*     */           } 
/*     */           
...
/* 561 */       this.worldObj.spawnEntityInWorld((Entity)entityitem);
/* 562 */       this.angler.worldObj.spawnEntityInWorld((Entity)new EntityXPOrb(this.angler.worldObj, this.angler.posX, this.angler.posY + 0.5D, this.angler.posZ + 0.5D, this.rand.nextInt(6) + 1));
/* 563 */       i = 1;
/*     */     } 
/*     */     
...
/* 580 */     int i = EnchantmentHelper.getLuckOfSeaModifier((EntityLivingBase)this.angler);
/* 581 */     int j = EnchantmentHelper.getLureModifier((EntityLivingBase)this.angler);
