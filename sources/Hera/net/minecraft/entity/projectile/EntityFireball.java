...
/*  94 */     if (this.worldObj.isRemote || ((this.shootingEntity == null || !this.shootingEntity.isDead) && this.worldObj.isBlockLoaded(new BlockPos(this)))) {
/*     */       
/*  96 */       super.onUpdate();
/*  97 */       setFire(1);
/*     */       
/*  99 */       if (this.inGround) {
/*     */         
/* 101 */         if (this.worldObj.getBlockState(new BlockPos(this.xTile, this.yTile, this.zTile)).getBlock() == this.inTile) {
/*     */           
/* 103 */           this.ticksAlive++;
/*     */           
...
/*     */         
/* 142 */         Entity entity1 = list.get(i);
/*     */         
/* 144 */         if (entity1.canBeCollidedWith() && (!entity1.isEntityEqual((Entity)this.shootingEntity) || this.ticksInAir >= 25)) {
/*     */           
/* 146 */           float f = 0.3F;
...
/* 177 */       this.rotationYaw = (float)(MathHelper.func_181159_b(this.motionZ, this.motionX) * 180.0D / Math.PI) + 90.0F;
/*     */       
/* 179 */       for (this.rotationPitch = (float)(MathHelper.func_181159_b(f1, this.motionY) * 180.0D / Math.PI) - 90.0F; this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F);
/*     */ 
/*     */ 
/*     */ 
/*     */       
...
/* 253 */     tagCompound.setTag("direction", (NBTBase)newDoubleNBTList(new double[] { this.motionX, this.motionY, this.motionZ }));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
