...
/* 118 */     this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.func_181159_b(x, z) * 180.0D / Math.PI);
/* 119 */     this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.func_181159_b(y, f1) * 180.0D / Math.PI);
...
/* 135 */       this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.func_181159_b(x, z) * 180.0D / Math.PI);
/* 136 */       this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.func_181159_b(y, f) * 180.0D / Math.PI);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/*     */     {
/* 152 */       this.throwableShake--;
/*     */     }
/*     */     
/* 155 */     if (this.inGround) {
/*     */       
/* 157 */       if (this.worldObj.getBlockState(new BlockPos(this.xTile, this.yTile, this.zTile)).getBlock() == this.inTile) {
/*     */         
/* 159 */         this.ticksInGround++;
/*     */         
...
/*     */     {
/* 230 */       if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.worldObj.getBlockState(movingobjectposition.getBlockPos()).getBlock() == Blocks.portal) {
/*     */         
...
/* 244 */     this.rotationYaw = (float)(MathHelper.func_181159_b(this.motionX, this.motionZ) * 180.0D / Math.PI);
/*     */     
/* 246 */     for (this.rotationPitch = (float)(MathHelper.func_181159_b(this.motionY, f1) * 180.0D / Math.PI); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F);
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/*     */     
/* 315 */     if ((this.throwerName == null || this.throwerName.length() == 0) && this.thrower instanceof net.minecraft.entity.player.EntityPlayer)
/*     */     {
...
/*     */       
/* 358 */       this.thrower = (EntityLivingBase)this.worldObj.getPlayerEntityByName(this.throwerName);
/*     */       
/* 360 */       if (this.thrower == null && this.worldObj instanceof WorldServer) {
/*     */         
/*     */         try {
/*     */           
/* 364 */           Entity entity = ((WorldServer)this.worldObj).getEntityFromUuid(UUID.fromString(this.throwerName));
/*     */           
