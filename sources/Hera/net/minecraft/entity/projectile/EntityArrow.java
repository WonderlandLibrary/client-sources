...
/* 131 */     y /= f;
/* 132 */     z /= f;
/* 133 */     x += this.rand.nextGaussian() * (this.rand.nextBoolean() ? -1 : true) * 0.007499999832361937D * inaccuracy;
/* 134 */     y += this.rand.nextGaussian() * (this.rand.nextBoolean() ? -1 : true) * 0.007499999832361937D * inaccuracy;
/* 135 */     z += this.rand.nextGaussian() * (this.rand.nextBoolean() ? -1 : true) * 0.007499999832361937D * inaccuracy;
/* 136 */     x *= velocity;
/* 137 */     y *= velocity;
/* 138 */     z *= velocity;
/* 139 */     this.motionX = x;
...
/* 143 */     this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.func_181159_b(x, z) * 180.0D / Math.PI);
/* 144 */     this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.func_181159_b(y, f1) * 180.0D / Math.PI);
...
/* 166 */       this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.func_181159_b(x, z) * 180.0D / Math.PI);
/* 167 */       this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.func_181159_b(y, f) * 180.0D / Math.PI);
...
/* 185 */       this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.func_181159_b(this.motionX, this.motionZ) * 180.0D / Math.PI);
/* 186 */       this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.func_181159_b(this.motionY, f) * 180.0D / Math.PI);
/*     */     } 
/*     */     
...
/*     */       
/* 195 */       block.setBlockBoundsBasedOnState((IBlockAccess)this.worldObj, blockpos);
...
/*     */           } 
/*     */           
/* 311 */           if (isBurning() && !(movingobjectposition.entityHit instanceof net.minecraft.entity.monster.EntityEnderman))
/*     */           {
...
/* 340 */                 EnchantmentHelper.applyArthropodEnchantments((EntityLivingBase)this.shootingEntity, (Entity)entitylivingbase);
/*     */               } 
/*     */               
...
/*     */               {
/* 345 */                 ((EntityPlayerMP)this.shootingEntity).playerNetServerHandler.sendPacket((Packet)new S2BPacketChangeGameState(6, 0.0F));
/*     */               }
/*     */             } 
/*     */             
/* 349 */             playSound("random.bowhit", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
/*     */             
/* 351 */             if (!(movingobjectposition.entityHit instanceof net.minecraft.entity.monster.EntityEnderman))
/*     */             {
/* 353 */               setDead();
/*     */             }
/*     */           }
...
/* 406 */       this.rotationYaw = (float)(MathHelper.func_181159_b(this.motionX, this.motionZ) * 180.0D / Math.PI);
/*     */       
/* 408 */       for (this.rotationPitch = (float)(MathHelper.func_181159_b(this.motionY, f3) * 180.0D / Math.PI); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F);
/*     */ 
/*     */ 
/*     */ 
/*     */       
...
/*     */       
/* 523 */       if (this.canBePickedUp == 1 && !entityIn.inventory.addItemStackToInventory(new ItemStack(Items.arrow, 1)))
/*     */       {
/* 525 */         flag = false;
/*     */       }
/*     */       
