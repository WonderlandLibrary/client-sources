...
/*     */       
/*  43 */       EntityAITaskEntry entityaitasks$entityaitaskentry = iterator.next();
...
/*     */       
/*  65 */       Iterator<EntityAITaskEntry> iterator = this.taskEntries.iterator();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */         
/*  79 */         EntityAITaskEntry entityaitasks$entityaitaskentry = iterator.next();
...
/*     */           } 
/*     */         }
/*  95 */         if (canUse(entityaitasks$entityaitaskentry) && entityaitasks$entityaitaskentry.action.shouldExecute())
/*     */         {
...
/*     */         
/* 108 */         EntityAITaskEntry entityaitasks$entityaitaskentry1 = iterator1.next();
/*     */         
...
/*     */           continue;
/*     */         } 
/* 155 */         if (!entityaitasks$entityaitaskentry.action.isInterruptible() && this.executingTaskEntries.contains(entityaitasks$entityaitaskentry))
/*     */         {
/* 157 */           return false;
/*     */         }
/*     */       } 
