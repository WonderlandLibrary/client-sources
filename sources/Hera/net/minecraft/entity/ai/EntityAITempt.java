...
/*     */       
/*  70 */       this.delayTemptCounter--;
/*  71 */       return false;
/*     */     } 
/*     */ 
/*     */     
/*  75 */     this.temptingPlayer = this.temptedEntity.worldObj.getClosestPlayerToEntity((Entity)this.temptedEntity, 10.0D);
/*     */     
...
/*  84 */     return (itemstack == null) ? false : ((itemstack.getItem() == this.temptItem));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*  96 */       if (this.temptedEntity.getDistanceSqToEntity((Entity)this.temptingPlayer) < 36.0D) {
/*     */         
...
/* 152 */     this.temptedEntity.getLookHelper().setLookPositionWithEntity((Entity)this.temptingPlayer, 30.0F, this.temptedEntity.getVerticalFaceSpeed());
/*     */     
/* 154 */     if (this.temptedEntity.getDistanceSqToEntity((Entity)this.temptingPlayer) < 6.25D) {
/*     */       
/* 156 */       this.temptedEntity.getNavigator().clearPathEntity();
/*     */     }
/*     */     else {
/*     */       
/* 160 */       this.temptedEntity.getNavigator().tryMoveToEntityLiving((Entity)this.temptingPlayer, this.speed);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
