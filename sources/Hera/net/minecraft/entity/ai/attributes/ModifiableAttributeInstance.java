...
/*  61 */     return this.mapByOperation.get(Integer.valueOf(operation));
/*     */   }
/*     */ 
/*     */   
...
/*  81 */     return this.mapByUUID.get(uuid);
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/*  97 */     Set<AttributeModifier> set = this.mapByName.get(modifier.getName());
/*     */     
/*  99 */     if (set == null) {
/*     */       
...
/*     */     } 
/*     */     
/* 105 */     ((Set<AttributeModifier>)this.mapByOperation.get(Integer.valueOf(modifier.getOperation()))).add(modifier);
...
/*     */       
/* 122 */       Set<AttributeModifier> set = this.mapByOperation.get(Integer.valueOf(i));
/* 123 */       set.remove(modifier);
/*     */     } 
/*     */     
/* 126 */     Set<AttributeModifier> set1 = this.mapByName.get(modifier.getName());
/*     */     
/* 128 */     if (set1 != null) {
/*     */       
