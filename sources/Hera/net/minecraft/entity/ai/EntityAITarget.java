...
/*     */     } 
/*     */     
/* 185 */     return !(checkSight && !attacker.getEntitySenses().canSee((Entity)target));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 196 */     if (!isSuitableTarget((EntityLiving)this.taskOwner, target, includeInvincibles, this.shouldCheckSight))
/*     */     {
/* 198 */       return false;
/*     */     }
/* 200 */     if (!this.taskOwner.isWithinHomeDistanceFromPosition(new BlockPos((Entity)target)))
/*     */     {
/* 202 */       return false;
/*     */     }
/*     */ 
...
/* 234 */     PathEntity pathentity = this.taskOwner.getNavigator().getPathToEntityLiving((Entity)p_75295_1_);
/*     */     
