...
/*  60 */       return false;
/*     */     }
/*  62 */     if (this.thePet.getDistanceSqToEntity((Entity)entitylivingbase) < (this.minDist * this.minDist))
/*     */     {
/*  64 */       return false;
/*     */     }
/*     */ 
...
/*  78 */     return (!this.petPathfinder.noPath() && this.thePet.getDistanceSqToEntity((Entity)this.theOwner) > (this.maxDist * this.maxDist) && !this.thePet.isSitting());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 105 */     return (block == Blocks.air) ? true : (!block.isFullCube());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 113 */     this.thePet.getLookHelper().setLookPositionWithEntity((Entity)this.theOwner, 10.0F, this.thePet.getVerticalFaceSpeed());
/*     */     
...
/*     */         
/* 121 */         if (!this.petPathfinder.tryMoveToEntityLiving((Entity)this.theOwner, this.followSpeed))
/*     */         {
/* 123 */           if (!this.thePet.getLeashed())
/*     */           {
/* 125 */             if (this.thePet.getDistanceSqToEntity((Entity)this.theOwner) >= 144.0D) {
/*     */               
...
/*     */                   
/* 135 */                   if ((l < 1 || i1 < 1 || l > 3 || i1 > 3) && World.doesBlockHaveSolidTopSurface((IBlockAccess)this.theWorld, new BlockPos(i + l, k - 1, j + i1)) && func_181065_a(new BlockPos(i + l, k, j + i1)) && func_181065_a(new BlockPos(i + l, k + 1, j + i1))) {
/*     */                     
