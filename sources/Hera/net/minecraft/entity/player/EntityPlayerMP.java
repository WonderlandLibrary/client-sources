...
/*      */       {
/*  860 */         this.playerNetServerHandler.sendPacket((Packet)new S2FPacketSetSlot(containerToSend.windowId, slotInd, stack));
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*  875 */     this.playerNetServerHandler.sendPacket((Packet)new S30PacketWindowItems(containerToSend.windowId, itemsList));
/*  876 */     this.playerNetServerHandler.sendPacket((Packet)new S2FPacketSetSlot(-1, -1, this.inventory.getItemStack()));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  886 */     this.playerNetServerHandler.sendPacket((Packet)new S31PacketWindowProperty(containerIn.windowId, varToUpdate, newValue));
/*      */   }
/*      */ 
/*      */   
...
/*      */     {
/*  893 */       this.playerNetServerHandler.sendPacket((Packet)new S31PacketWindowProperty(p_175173_1_.windowId, i, p_175173_2_.getField(i)));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  902 */     this.playerNetServerHandler.sendPacket((Packet)new S2EPacketCloseWindow(this.openContainer.windowId));
/*  903 */     closeContainer();
/*      */   }
/*      */ 
/*      */ 
...
/*      */     {
/*  913 */       this.playerNetServerHandler.sendPacket((Packet)new S2FPacketSetSlot(-1, -1, this.inventory.getItemStack()));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */     {
/*  988 */       this.riddenByEntity.mountEntity((Entity)this);
/*      */     }
/*      */     
...
/* 1008 */     this.playerNetServerHandler.sendPacket((Packet)new S02PacketChat(chatComponent));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1016 */     this.playerNetServerHandler.sendPacket((Packet)new S19PacketEntityStatus((Entity)this, (byte)9));
...
/*      */     {
/* 1029 */       getServerForPlayer().getEntityTracker().func_151248_b((Entity)this, (Packet)new S0BPacketAnimation((Entity)this, 3));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1049 */     this.playerNetServerHandler.sendPacket((Packet)new S1DPacketEntityEffect(getEntityId(), id));
/*      */   }
/*      */ 
/*      */   
/*      */   protected void onChangedPotionEffect(PotionEffect id, boolean p_70695_2_) {
/* 1054 */     super.onChangedPotionEffect(id, p_70695_2_);
/* 1055 */     this.playerNetServerHandler.sendPacket((Packet)new S1DPacketEntityEffect(getEntityId(), id));
/*      */   }
/*      */ 
/*      */   
/*      */   protected void onFinishedPotionEffect(PotionEffect p_70688_1_) {
/* 1060 */     super.onFinishedPotionEffect(p_70688_1_);
/* 1061 */     this.playerNetServerHandler.sendPacket((Packet)new S1EPacketRemoveEntityEffect(getEntityId(), p_70688_1_));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1077 */     getServerForPlayer().getEntityTracker().func_151248_b((Entity)this, (Packet)new S0BPacketAnimation(entityHit, 4));
/*      */   }
/*      */ 
/*      */   
/*      */   public void onEnchantmentCritical(Entity entityHit) {
/* 1082 */     getServerForPlayer().getEntityTracker().func_151248_b((Entity)this, (Packet)new S0BPacketAnimation(entityHit, 5));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/* 1092 */       this.playerNetServerHandler.sendPacket((Packet)new S39PacketPlayerAbilities(this.capabilities));
...
/* 1108 */     this.playerNetServerHandler.sendPacket((Packet)new S2BPacketChangeGameState(3, gameType.getID()));
/*      */     
/* 1110 */     if (gameType == WorldSettings.GameType.SPECTATOR) {
/*      */       
/* 1112 */       mountEntity((Entity)null);
/*      */     }
/*      */     else {
/*      */       
/* 1116 */       setSpectatingEntity((Entity)this);
/*      */     } 
/*      */     
...
/* 1136 */     this.playerNetServerHandler.sendPacket((Packet)new S02PacketChat(component));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1153 */         return (userlistopsentry != null) ? ((userlistopsentry.getPermissionLevel() >= permLevel)) : ((this.mcServer.getOpPermissionLevel() >= permLevel));
/*      */       } 
/*      */ 
/*      */       
/* 1157 */       return false;
...
/* 1192 */     this.playerNetServerHandler.sendPacket((Packet)new S48PacketResourcePackSend(url, hash));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/* 1224 */       this.playerNetServerHandler.sendPacket((Packet)new S13PacketDestroyEntities(new int[] { p_152339_1_.getEntityId() }));
/*      */     }
/*      */     else {
/*      */       
...
/* 1253 */     return (this.spectatingEntity == null) ? (Entity)this : this.spectatingEntity;
/*      */   }
/*      */ 
/*      */   
/*      */   public void setSpectatingEntity(Entity entityToSpectate) {
/* 1258 */     Entity entity = getSpectatingEntity();
/* 1259 */     this.spectatingEntity = (entityToSpectate == null) ? (Entity)this : entityToSpectate;
/*      */     
/* 1261 */     if (entity != this.spectatingEntity) {
/*      */       
/* 1263 */       this.playerNetServerHandler.sendPacket((Packet)new S43PacketCamera(this.spectatingEntity));
