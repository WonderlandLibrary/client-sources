...
public class FieldLocatorActionKeyF3 implements IFieldLocator
{
    public Field getField()
    {
        ...
        if (field == null)
        {
            //[REMOVED_LOG] Config.log("(Reflector) Field not present: " + oclass.getName() + ".actionKeyF3 (field renderChunksMany not found)");
            return null;
        }
        else
        {
            ...
            if (field1 == null)
            {
                //[REMOVED_LOG] Config.log("(Reflector) Field not present: " + oclass.getName() + ".actionKeyF3");
                return null;
            }
            else
            {
