...
public class Score
{
    public static final Comparator<Score> scoreComparator = (first, second) ->
            first.getScorePoints() > second.getScorePoints() ? 1
                    : (first.getScorePoints() < second.getScorePoints() ? -1
                    : second.getPlayerName().compareToIgnoreCase(first.getPlayerName())
            );
