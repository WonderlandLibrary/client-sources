    ...
    public int findChunksForSpawning(WorldServer p_77192_1_, boolean spawnHostileMobs, boolean spawnPeacefulMobs, boolean p_77192_4_)
    {
        ...
        else
        {
            ...
            for (EnumCreatureType enumcreaturetype : EnumCreatureType.values())
            {
                ...
                {
                    int k4 = Reflector.ForgeWorld_countEntities.exists() ? Reflector.callInt(p_77192_1_, Reflector.ForgeWorld_countEntities, new Object[] {enumcreaturetype, true}): p_77192_1_.countEntities(enumcreaturetype.getCreatureClass());
