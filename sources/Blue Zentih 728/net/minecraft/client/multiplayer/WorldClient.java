...
public class WorldClient extends World {
    ...
    public Entity getEntityByID(int id) {
        return mc.thePlayer == null ? null : id == this.mc.thePlayer.getEntityId() ? this.mc.thePlayer : super.getEntityByID(id);
    }
    ...
    public void sendQuittingDisconnectingPacket() {
        BlueZenith.getBlueZenith().postEvent(new DisconnectEvent(null));
