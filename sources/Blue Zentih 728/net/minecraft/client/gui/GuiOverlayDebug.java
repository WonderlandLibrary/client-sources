...
public class GuiOverlayDebug extends Gui
{
    ...
    protected List<String> call()
    {
        ...
        else
        {
            ...
            if (this.mc.theWorld != null && this.mc.theWorld.isBlockLoaded(blockpos))
            {
                ...
                list.add(String.format("Local Difficulty: %.2f (Day %d)", new Object[] {Float.valueOf(difficultyinstance.getAdditionalDifficulty()), (this.mc.theWorld.getWorldTime() / 24000L)}));
            }
    ...
    protected List<String> getDebugInfoRight()
    {
        ...
        long l = j - k;
        List<String> list = Lists.newArrayList(new String[] {String.format("Java: %s %dbit", new Object[]{System.getProperty("java.version"), Integer.valueOf(this.mc.isJava64bit() ? 64 : 32)}), String.format("Mem: % 2d%% %03d/%03dMB", new Object[]{(l * 100L / i), (bytesToMb(l)), (bytesToMb(i))}), String.format("Allocated: % 2d%% %03dMB", new Object[]{(j * 100L / i), (bytesToMb(j))}), "", String.format("CPU: %s", new Object[]{OpenGlHelper.func_183029_j()}), "", String.format("Display: %dx%d (%s)", new Object[]{Integer.valueOf(Display.getWidth()), Integer.valueOf(Display.getHeight()), GL11.glGetString(GL11.GL_VENDOR)}), GL11.glGetString(GL11.GL_RENDERER), GL11.glGetString(GL11.GL_VERSION)});
