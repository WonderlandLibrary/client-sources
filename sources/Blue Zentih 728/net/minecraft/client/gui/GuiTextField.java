...
public class GuiTextField extends Gui {
	...
	private boolean enableBackgroundDrawing = true, hideContent;
	...
	public GuiTextField setName(String name) {
		this.name = name;
		return this;
	}
	...
	public GuiTextField setHideContent(boolean hideContent) {
	...
	public void drawTextBox() {
		if (this.getVisible()) {
			if (this.getEnableBackgroundDrawing()) {
				...
				float width = 1f;
				final FontRenderer nameFont = FontUtil.rubikR30;
				final boolean useOldTop = name == null;
				final float titleStart = 4;
				...
				if(useOldTop) {
					...
					drawRect(this.xPosition, this.yPosition - width, this.xPosition + titleStart, this.yPosition, outlineColor);
					final float strwidth = nameFont.getStringWidthF(name);
					drawRect(this.xPosition + strwidth + 6, this.yPosition - width, this.xPosition + this.width, this.yPosition, outlineColor);
					nameFont.drawString(name, this.xPosition + titleStart + 0.5F, this.yPosition - 6.5F, ColorUtil.setOpacity(outlineColor, 255));
				}
			}
			...
			if (s.length() > 0) {
				...
				j1 = this.fontRendererInstance.drawStringWithShadow(this.hideContent && !this.isFocused ? censored : s1, (float) l, (float) i1, i);
			}
			...
			if (s.length() > 0 && flag && j < s.length()) {
				j1 = this.fontRendererInstance.drawStringWithShadow(this.hideContent && !this.isFocused ? censored : s.substring(j), (float) j1, (float) i1, i);
			}
