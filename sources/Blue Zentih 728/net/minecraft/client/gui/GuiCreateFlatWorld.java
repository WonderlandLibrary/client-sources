...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    class Details extends GuiSlot
    {
        ...
        private void func_148224_c(int p_148224_1_, int p_148224_2_, int p_148224_3_, int p_148224_4_)
        {
            ...
            worldrenderer.pos((double)(p_148224_1_), (double)(p_148224_2_ + 18), (double)GuiCreateFlatWorld.this.zLevel).func_181673_a((double)((float)(p_148224_3_) * 0.0078125F), (double)((float)(p_148224_4_ + 18) * 0.0078125F)).endVertex();
            worldrenderer.pos((double)(p_148224_1_ + 18), (double)(p_148224_2_ + 18), (double)GuiCreateFlatWorld.this.zLevel).func_181673_a((double)((float)(p_148224_3_ + 18) * 0.0078125F), (double)((float)(p_148224_4_ + 18) * 0.0078125F)).endVertex();
            worldrenderer.pos((double)(p_148224_1_ + 18), (double)(p_148224_2_), (double)GuiCreateFlatWorld.this.zLevel).func_181673_a((double)((float)(p_148224_3_ + 18) * 0.0078125F), (double)((float)(p_148224_4_) * 0.0078125F)).endVertex();
            worldrenderer.pos((double)(p_148224_1_), (double)(p_148224_2_), (double)GuiCreateFlatWorld.this.zLevel).func_181673_a((double)((float)(p_148224_3_) * 0.0078125F), (double)((float)(p_148224_4_) * 0.0078125F)).endVertex();
            tessellator.draw();
        }
