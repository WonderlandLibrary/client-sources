...
public class GuiAchievements extends GuiScreen implements IProgressMeter {
    ...
    public GuiAchievements(GuiScreen parentScreenIn, StatFileWriter statFileWriterIn) {
        ...
        int i = 141;
        int j = 141;
        this.field_146569_s = this.field_146567_u = this.field_146565_w = AchievementList.openInventory.displayColumn * 24 - i / 2f - 12;
        this.field_146568_t = this.field_146566_v = this.field_146573_x = AchievementList.openInventory.displayRow * 24 - j / 2f;
    }
