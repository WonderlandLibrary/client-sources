...
public class GuiFlatPresets extends GuiScreen
{
    ...
    class ListSlot extends GuiSlot
    {
        ...
        private void func_148171_c(int p_148171_1_, int p_148171_2_, int p_148171_3_, int p_148171_4_)
        {
            ...
            worldrenderer.pos((double)(p_148171_1_), (double)(p_148171_2_ + 18), (double)GuiFlatPresets.this.zLevel).func_181673_a((double)((float)(p_148171_3_) * 0.0078125F), (double)((float)(p_148171_4_ + 18) * 0.0078125F)).endVertex();
            worldrenderer.pos((double)(p_148171_1_ + 18), (double)(p_148171_2_ + 18), (double)GuiFlatPresets.this.zLevel).func_181673_a((double)((float)(p_148171_3_ + 18) * 0.0078125F), (double)((float)(p_148171_4_ + 18) * 0.0078125F)).endVertex();
            worldrenderer.pos((double)(p_148171_1_ + 18), (double)(p_148171_2_), (double)GuiFlatPresets.this.zLevel).func_181673_a((double)((float)(p_148171_3_ + 18) * 0.0078125F), (double)((float)(p_148171_4_) * 0.0078125F)).endVertex();
            worldrenderer.pos((double)(p_148171_1_), (double)(p_148171_2_), (double)GuiFlatPresets.this.zLevel).func_181673_a((double)((float)(p_148171_3_) * 0.0078125F), (double)((float)(p_148171_4_) * 0.0078125F)).endVertex();
            tessellator.draw();
        }
