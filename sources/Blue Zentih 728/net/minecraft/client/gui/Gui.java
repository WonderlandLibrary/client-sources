...
public class Gui {
    ...
    public static void drawRect(int left, int top, int right, int bottom, int color) {
        ...
        final float normalAlpha = (float) (color >> 24 & 255) / 255.0F;
        final float forcedAlpha = RenderUtil.limitAlpha ? (RenderUtil.alphaLimit255) / 255F : normalAlpha;

        float f3 = min(normalAlpha, forcedAlpha);
    ...
    public void drawGradientRect(float x, float y, float x2, float y2, int startColor, int endColor) {
        float f = (float) (startColor >> 24 & 255) / 255.0F;
        float f1 = (float) (startColor >> 16 & 255) / 255.0F;
        float f2 = (float) (startColor >> 8 & 255) / 255.0F;
        float f3 = (float) (startColor & 255) / 255.0F;
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_COLOR);
        worldrenderer.pos(x2, y, this.zLevel).func_181666_a(f1, f2, f3, f).endVertex();
        worldrenderer.pos(x, y, this.zLevel).func_181666_a(f1, f2, f3, f).endVertex();
        worldrenderer.pos(x, y2, this.zLevel).func_181666_a(f5, f6, f7, f4).endVertex();
        worldrenderer.pos(x2, y2, this.zLevel).func_181666_a(f5, f6, f7, f4).endVertex();
        tessellator.draw();
        GlStateManager.shadeModel(7424);
        GlStateManager.disableBlend();
        GlStateManager.enableAlpha();
    ...
    public void drawTexturedModalRect(int x, int y, int textureX, int textureY, int width, int height) {
        ...
        worldrenderer.pos(x, y + height, this.zLevel).func_181673_a((float) (textureX) * f, (float) (textureY + height) * f1).endVertex();
        worldrenderer.pos(x + width, y + height, this.zLevel).func_181673_a((float) (textureX + width) * f, (float) (textureY + height) * f1).endVertex();
        worldrenderer.pos(x + width, y, this.zLevel).func_181673_a((float) (textureX + width) * f, (float) (textureY) * f1).endVertex();
        worldrenderer.pos(x, y, this.zLevel).func_181673_a((float) (textureX) * f, (float) (textureY) * f1).endVertex();
        tessellator.draw();
    }
    ...
    public void drawTexturedModalRect(float xCoord, float yCoord, int minU, int minV, int maxU, int maxV) {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
        worldrenderer.pos(xCoord + 0.0F, yCoord + (float) maxV, this.zLevel).func_181673_a((float) (minU) * f, (float) (minV + maxV) * f1).endVertex();
        ...
        worldrenderer.pos(xCoord + (float) maxU, yCoord + 0.0F, this.zLevel).func_181673_a((float) (minU + maxU) * f, (float) (minV) * f1).endVertex();
        worldrenderer.pos(xCoord + 0.0F, yCoord + 0.0F, this.zLevel).func_181673_a((float) (minU) * f, (float) (minV) * f1).endVertex();
        tessellator.draw();
    }
    ...
    public static void drawModalRectWithCustomSizedTexture(int x, int y, float u, float v, int width, int height, float textureWidth, float textureHeight) {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
        worldrenderer.pos(x, y + height, 0.0D).func_181673_a(u * f, (v + (float) height) * f1).endVertex();
        worldrenderer.pos(x + width, y + height, 0.0D).func_181673_a((u + (float) width) * f, (v + (float) height) * f1).endVertex();
        worldrenderer.pos(x + width, y, 0.0D).func_181673_a((u + (float) width) * f, v * f1).endVertex();
