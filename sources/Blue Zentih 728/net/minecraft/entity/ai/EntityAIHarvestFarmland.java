...
public class EntityAIHarvestFarmland extends EntityAIMoveToBlock
{
    ...
    public void updateTask()
    {
        ...
        if (this.getIsAboveDestination())
        {
            ...
            if (this.field_179501_f == 0 && block instanceof BlockCrops && ((Integer)iblockstate.getValue(BlockCrops.AGE)) == 7)
            {
    ...
    protected boolean shouldMoveTo(World worldIn, BlockPos pos)
    {
        ...
        if (block == Blocks.farmland)
        {
            ...
            if (block instanceof BlockCrops && ((Integer)iblockstate.getValue(BlockCrops.AGE)) == 7 && this.field_179503_e && (this.field_179501_f == 0 || this.field_179501_f < 0))
            {
