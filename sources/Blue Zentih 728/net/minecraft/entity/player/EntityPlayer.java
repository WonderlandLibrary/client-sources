...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    /** the current location of the player's bed (edit: angles) */
    public BlockPos playerBedLocation;
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        if (this.sleeping)
        {
            this.playerBedLocation = new BlockPos(this);
            this.wakeUpPlayer(true, true, false);
        }
    ...
    public EntityPlayer.EnumStatus trySleep(BlockPos bedLocation)
    {
        ...
        this.sleeping = true;
        this.sleepTimer = 0;
        this.playerBedLocation = bedLocation;
    ...
    {
        this.setSize(0.6F, 1.8F);
        IBlockState iblockstate = this.worldObj.getBlockState(this.playerBedLocation);

        if (this.playerBedLocation != null && iblockstate.getBlock() == Blocks.bed)
        {
            this.worldObj.setBlockState(this.playerBedLocation, iblockstate.withProperty(BlockBed.OCCUPIED, false), 4);
            BlockPos blockpos = BlockBed.getSafeExitLocation(this.worldObj, this.playerBedLocation, 0);

            if (blockpos == null)
            {
                blockpos = this.playerBedLocation.up();
            }
        ...
        if (setSpawn)
        {
            this.setSpawnPoint(this.playerBedLocation, false);
        }
    }

    private boolean isInBed()
    {
        return this.worldObj.getBlockState(this.playerBedLocation).getBlock() == Blocks.bed;
    }
    ...
    public float getBedOrientationInDegrees()
    {
        ...
        {
            EnumFacing enumfacing = (EnumFacing)this.worldObj.getBlockState(this.playerBedLocation).getValue(BlockDirectional.FACING);
    ...
    public void jump(double motionY)
    {
        super.jump(motionY);
        this.triggerAchievement(StatList.jumpStat);
    ...
    public boolean equals(Object o) {
        ...
        return getEntityId() == (player.getEntityId());
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), getEntityId());
    }
