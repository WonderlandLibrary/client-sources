...
public class ProxyFactory {
   ...
   private void computeSignature(MethodFilter var1) {
      ...
      for(int var4 = 0; var4 < var2; ++var4) {
         ...
         if (!Modifier.isFinal(var7) && !Modifier.isStatic(var7) && isVisible(var7, this.basename, var6) && (var1 == null || var1.isHandled(var6))) {
   ...
   private boolean testBit(byte[] var1, int var2) {
      int var3 = var2 >> 3;
      if (var3 > var1.length) {
         return false;
      } else {
   ...
   private int overrideMethods(ClassFile var1, ConstPool var2, String var3, ArrayList var4) throws CannotCompileException {
      ...
      for(var7 = 0; var6.hasNext(); ++var7) {
         ...
         if ((ClassFile.MAJOR_VERSION < 49 || !isBridge(var10)) && this.testBit(this.signature, var7)) {
   ...
   private void override(String var1, Method var2, String var3, int var4, String var5, ClassFile var6, ConstPool var7, ArrayList var8) throws CannotCompileException {
      ...
      if (Modifier.isAbstract(var2.getModifiers())) {
         ...
         var11 = this.makeDelegator(var2, var5, var7, var9, var10);
   ...
   private void makeConstructors(String var1, ClassFile var2, ConstPool var3, String var4) throws CannotCompileException {
      ...
      for(int var7 = 0; var7 < var5.length; ++var7) {
         ...
         if (!Modifier.isFinal(var9) && !Modifier.isPrivate(var9) && isVisible(var9, this.basename, var8)) {
   ...
   private static String makeUniqueName(String var0, List var1) {
      if (makeUniqueName0(var0, var1.iterator())) {
         return var0;
      } else {
         for(int var2 = 100; var2 < 999; ++var2) {
            String var3 = var0 + var2;
            if (makeUniqueName0(var3, var1.iterator())) {
               return var3;
            }
         }
   ...
   private static boolean makeUniqueName0(String var0, Iterator var1) {
      while(true) {
         if (var1.hasNext()) {
   ...
   private static boolean isVisible(int var0, String var1, Member var2) {
      if ((var0 & 2) != 0) {
         return false;
      } else if ((var0 & 5) != 0) {
         return true;
      } else {
         String var3 = getPackageName(var1);
         String var4 = getPackageName(var2.getDeclaringClass().getName());
         if (var3 == null) {
            return var4 == null;
         } else {
      ...
      if (var3.add(var2)) {
         ...
         for(int var7 = 0; var7 < var6.length; ++var7) {
            if (!Modifier.isPrivate(var6[var7].getModifiers())) {
               ...
               if (null != var10 && isBridge(var8) && !Modifier.isPublic(var10.getDeclaringClass().getModifiers()) && !Modifier.isAbstract(var10.getModifiers()) && !isOverloaded(var7, var6)) {
                  var1.put(var9, var10);
               }
   ...
   private static boolean isOverloaded(int var0, Method[] var1) {
      String var2 = var1[var0].getName();

      for(int var3 = 0; var3 < var1.length; ++var3) {
         if (var3 != var0 && var2.equals(var1[var3].getName())) {
            return true;
         }
      }
   ...
   private MethodInfo makeDelegator(Method var1, String var2, ConstPool var3, Class var4, String var5) {
      MethodInfo var6 = new MethodInfo(var3, var5, var2);
      var6.setAccessFlags(17 | var1.getModifiers() & -1319);
      setThrows(var6, var3, var1);
      Bytecode var7 = new Bytecode(var3, 0, 0);
      var7.addAload(0);
      int var8 = addLoadParameters(var7, var1.getParameterTypes(), 1);
      Class var9 = this.invokespecialTarget(var4);
      var7.addInvokespecial(var9.isInterface(), var3.addClassInfo(var9.getName()), var1.getName(), var2);
      addReturn(var7, var1.getReturnType());
      ++var8;
      var7.setMaxLocals(var8);
      var6.setCodeAttribute(var7.toCodeAttribute());
      return var6;
   }

   private Class invokespecialTarget(Class var1) {
      if (var1.isInterface()) {
