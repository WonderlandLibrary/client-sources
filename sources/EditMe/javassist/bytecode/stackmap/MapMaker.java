...
public class MapMaker extends Tracer {
   ...
   private static TypeData validateTypeData(TypeData[] var0, int var1, int var2) {
      ...
      return (TypeData)(var3.is2WordType() && var2 + 1 < var1 && var0[var2 + 1] != TOP ? TOP : var3);
   }
   ...
   public StackMapTable toStackMap(TypedBlock[] var1) {
      ...
      for(int var6 = 1; var6 < var3; ++var6) {
         ...
         if (this.isTarget(var7, var1[var6 - 1])) {
            var7.resetNumLocals();
   ...
   private boolean isTarget(TypedBlock var1, TypedBlock var2) {
      int var3 = var1.incoming;
      if (var3 > 1) {
         return true;
      } else {
         return var3 < 1 ? false : var2.stop;
      }
   }
   ...
   private static boolean stackMapEq(TypeData[] var0, TypeData[] var1, int var2) {
      for(int var3 = 0; var3 < var2; ++var3) {
         if (!var0[var3].eq(var1[var3])) {
            return false;
         }
      }
