...
public final class ClassFile {
   ...
   private void testExistingMethod(MethodInfo var1) throws DuplicateMemberException {
      ...
      } while(!isDuplicated(var1, var2, var3, (MethodInfo)var4.next(), var4));

      throw new DuplicateMemberException("duplicate method: " + var2 + " in " + this.getName());
   }

   private static boolean isDuplicated(MethodInfo var0, String var1, String var2, MethodInfo var3, ListIterator var4) {
      if (!var3.getName().equals(var1)) {
         return false;
      } else {
         String var5 = var3.getDescriptor();
         if (!Descriptor.eqParamTypes(var5, var2)) {
            return false;
         } else if (var5.equals(var2)) {
            if (notBridgeMethod(var3)) {
               return true;
            } else {
               var4.remove();
               return false;
   ...
   private static boolean notBridgeMethod(MethodInfo var0) {
      return (var0.getAccessFlags() & 64) == 0;
   }
   ...
   public AttributeInfo removeAttribute(String var1) {
      return AttributeInfo.remove(this.attributes, var1);
   }
