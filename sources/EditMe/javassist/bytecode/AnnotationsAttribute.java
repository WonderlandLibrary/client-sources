...
public class AnnotationsAttribute extends AttributeInfo {
   ...
   public boolean removeAnnotation(String var1) {
      Annotation[] var2 = this.getAnnotations();

      for(int var3 = 0; var3 < var2.length; ++var3) {
         if (var2[var3].getTypeName().equals(var1)) {
            Annotation[] var4 = new Annotation[var2.length - 1];
            System.arraycopy(var2, 0, var4, 0, var3);
            if (var3 < var2.length - 1) {
               System.arraycopy(var2, var3 + 1, var4, var3, var2.length - var3 - 1);
            }

            this.setAnnotations(var4);
            return true;
         }
      }
