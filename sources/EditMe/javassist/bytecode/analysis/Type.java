...
public class Type {
   ...
   public boolean isAssignableFrom(Type var1) {
      if (this == var1) {
         return true;
      } else if (var1 == UNINIT && this.isReference() || this == UNINIT && var1.isReference()) {
         return true;
      } else if (var1 instanceof MultiType) {
   ...
   public Type merge(Type var1) {
      if (var1 == this) {
         ...
         return var1;
      } else if (var1.isReference() && this.isReference()) {
         if (var1 instanceof MultiType) {
            return var1.merge(this);
         } else if (var1.isArray() && this.isArray()) {
   ...
   private Type mergeArray(Type var1) {
      ...
      if (var4 == var5) {
         ...
         return !eq(CLONEABLE.clazz, var6.clazz) && !eq(SERIALIZABLE.clazz, var6.clazz) ? this.createArray(OBJECT, var7) : this.createArray(var6, var7);
      }
   }
   ...
   public boolean equals(Object var1) {
      if (!(var1 instanceof Type)) {
         ...
         return var1.getClass() == this.getClass() && eq(this.clazz, ((Type)var1).clazz);
      }
   }
