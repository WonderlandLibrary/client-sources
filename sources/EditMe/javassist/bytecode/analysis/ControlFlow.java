...
public class ControlFlow {
   ...
   public ControlFlow(CtClass var1, MethodInfo var2) throws BadBytecode {
      ...
      this.basicBlocks = (ControlFlow.Block[])((ControlFlow.Block[])(new BasicBlock.Maker(this) {
         ...
         protected BasicBlock makeBlock(int var1) {
            return new ControlFlow.Block(var1, this.this$0.methodInfo);
         }
      ...
      for(var5 = 0; var5 < var3; ++var5) {
         ...
         for(int var11 = 0; var11 < var10.length; ++var11) {
            ControlFlow.Block var9 = var10[var11].node;
      ...
      if (var1 == 0) {
         ...
         ControlFlow.Access var7 = new ControlFlow.Access(this, var2) {
            ...
            BasicBlock[] exits(ControlFlow.Node var1) {
               return var1.block.getExit();
            }

            BasicBlock[] entrances(ControlFlow.Node var1) {
               return var1.block.entrances;
            }
         };
         ...
         ControlFlow.Node.setChildren(var2);
         return var2;
      }
   }
   ...
   public ControlFlow.Node[] postDominatorTree() {
      ...
      if (var1 == 0) {
         ...
         do {
            ...
            for(var8 = 0; var8 < var1; ++var8) {
               if (var2[var8].block.exits() == 0 && var2[var8].makeDominatorTree(var3, var4, var9)) {
                  var10 = true;
               }
            }
         } while(var10);
   ...
   public static class Node {
      ...
      boolean makeDominatorTree(boolean[] var1, int[] var2, ControlFlow.Access var3) {
         int var4 = this.block.index;
         if (var1[var4]) {
            return false;
         } else {
            var1[var4] = true;
            boolean var5 = false;
            BasicBlock[] var6 = var3.exits(this);
            if (var6 != null) {
               for(int var7 = 0; var7 < var6.length; ++var7) {
                  ControlFlow.Node var8 = var3.node(var6[var7]);
                  if (var8.makeDominatorTree(var1, var2, var3)) {
                     var5 = true;
                  }
               }
            }

            BasicBlock[] var10 = var3.entrances(this);
            if (var10 != null) {
               for(int var11 = 0; var11 < var10.length; ++var11) {
                  if (this.parent != null) {
                     ControlFlow.Node var9 = getAncestor(this.parent, var3.node(var10[var11]), var2);
                     if (var9 != this.parent) {
                        this.parent = var9;
                        var5 = true;
                     }
