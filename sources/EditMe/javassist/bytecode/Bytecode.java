...
public class Bytecode extends ByteVector implements Cloneable, Opcode {
   ...
   public void addInvokespecial(boolean var1, int var2, String var3, String var4) {
      ...
      this.addInvokespecial(var5, var4);
   }

   public void addInvokespecial(int var1, String var2) {
      this.add(183);
      this.addIndex(var1);
      this.growStack(Descriptor.dataSize(var2) - 1);
   }
   ...
   public void addInvokestatic(CtClass var1, String var2, String var3) {
      ...
      if (var1 == THIS) {
         ...
         var4 = var1.isInterface();
      }

      this.addInvokestatic(this.constPool.addClassInfo(var1), var2, var3, var4);
   }
   ...
   public void addInvokestatic(int var1, String var2, String var3) {
      this.addInvokestatic(var1, var2, var3, false);
   }

   private void addInvokestatic(int var1, String var2, String var3, boolean var4) {
      this.add(184);
      int var5;
      if (var4) {
         var5 = this.constPool.addInterfaceMethodrefInfo(var1, var2, var3);
      } else {
         var5 = this.constPool.addMethodrefInfo(var1, var2, var3);
      }
