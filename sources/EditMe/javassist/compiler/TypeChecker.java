...
public class TypeChecker extends Visitor implements Opcode, TokenId {
   ...
   public void atBinExpr(BinExpr var1) throws CompileError {
      ...
      if (var3 >= 0) {
         if (var2 == 43) {
            ...
            int var6 = this.exprType;
            var5.accept(this);
            if (!this.isConstant(var1, var2, var8, var5)) {
   ...
   private Expr atPlusExpr(BinExpr var1) throws CompileError {
      ...
      if (var3 == null) {
         ...
         var3.accept(this);
         if (this.isConstant(var1, 43, var2, var3)) {
            return null;
   ...
   private boolean isConstant(BinExpr var1, int var2, ASTree var3, ASTree var4) throws CompileError {
      var3 = stripPlusExpr(var3);
      var4 = stripPlusExpr(var4);
      Object var5 = null;
      if (var3 instanceof StringL && var4 instanceof StringL && var2 == 43) {
         var5 = new StringL(((StringL)var3).get() + ((StringL)var4).get());
      } else if (var3 instanceof IntConst) {
         var5 = ((IntConst)var3).compute(var2, var4);
      } else if (var3 instanceof DoubleConst) {
         var5 = ((DoubleConst)var3).compute(var2, var4);
      }
      ...
      if (var5 == null) {
         ...
         var1.setOperator(43);
         var1.setOprand1((ASTree)var5);
         var1.setOprand2((ASTree)null);
         ((ASTree)var5).accept(this);
         return true;
      }
   }
   ...
   private static boolean isPlusExpr(ASTree var0) {
      if (var0 instanceof BinExpr) {
         BinExpr var1 = (BinExpr)var0;
         int var2 = var1.getOperator();
         return var2 == 43;
   ...
   public void atExpr(Expr var1) throws CompileError {
      ...
      if (var2 == 46) {
         ...
         if (var2 == 33) {
            ...
            var3.accept(this);
            if (!this.isConstant(var1, var2, var3) && (var2 == 45 || var2 == 126) && CodeGen.isP_INT(this.exprType)) {
               this.exprType = 324;
            }
         }
      } else {
   ...
   private boolean isConstant(Expr var1, int var2, ASTree var3) {
      var3 = stripPlusExpr(var3);
      if (var3 instanceof IntConst) {
         IntConst var4 = (IntConst)var3;
         long var5 = var4.get();
         if (var2 == 45) {
            var5 = -var5;
         } else {
         ...
         if (!(var3 instanceof DoubleConst)) {
            return false;
         }

         DoubleConst var7 = (DoubleConst)var3;
         if (var2 != 45) {
            return false;
         }
