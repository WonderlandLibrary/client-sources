...
public abstract class CodeGen extends Visitor implements Opcode, TokenId {
   ...
   public static boolean is2word(int var0, int var1) {
      return var1 == 0 && (var0 == 312 || var0 == 326);
   }
   ...
   public void atMethodBody(Stmnt var1, boolean var2, boolean var3) throws CompileError {
      if (var1 != null) {
         if (var2 && this.needsSuperCall(var1)) {
   ...
   private boolean needsSuperCall(Stmnt var1) throws CompileError {
      if (var1.getOperator() == 66) {
         var1 = (Stmnt)var1.head();
      }

      if (var1 != null && var1.getOperator() == 69) {
         ASTree var2 = var1.head();
         if (var2 != null && var2 instanceof Expr && ((Expr)var2).getOperator() == 67) {
            ASTree var3 = ((Expr)var2).head();
            if (var3 instanceof Keyword) {
               int var4 = ((Keyword)var3).get();
               return var4 != 339 && var4 != 336;
            }
         }
      }
   ...
   protected final void atReturnStmnt2(ASTree var1) throws CompileError {
      short var2;
      if (var1 == null) {
         var2 = 177;
      } else {
         this.compileExpr(var1);
         if (this.arrayDim > 0) {
            var2 = 176;
         } else {
      ...
      for(CodeGen.ReturnHook var4 = this.returnHooks; var4 != null; var4 = var4.next) {
         if (var4.doit(this.bytecode, var2)) {
            this.hasReturned = true;
            return;
         }
      }

      this.bytecode.addOpcode(var2);
      this.hasReturned = true;
   }
   ...
   private static boolean isPlusPlusExpr(ASTree var0) {
      if (!(var0 instanceof Expr)) {
         return false;
      } else {
         int var1 = ((Expr)var0).getOperator();
         return var1 == 362 || var1 == 363;
      }
   }
   ...
   public void atDeclarator(Declarator var1) throws CompileError {
      ...
      byte var2;
      if (is2word(var1.getType(), var1.getArrayDim())) {
         var2 = 2;
      } else {
         var2 = 1;
      }
   ...
   private void atVariableAssign(Expr var1, int var2, Variable var3, Declarator var4, ASTree var5, boolean var6) throws CompileError {
      int var7 = var4.getType();
      int var8 = var4.getArrayDim();
      String var9 = var4.getClassName();
      int var10 = this.getLocalVar(var4);
      if (var2 != 61) {
         this.atVariable(var3);
      }

      if (var1 == null && var5 instanceof ArrayInit) {
         this.atArrayVariableAssign((ArrayInit)var5, var7, var8, var9);
      } else {
         this.atAssignCore(var1, var2, var5, var7, var8, var9);
      }

      if (var6) {
         if (is2word(var7, var8)) {
      ...
      if (var8 > 0) {
         this.bytecode.addAstore(var10);
      } else if (var7 == 312) {
         this.bytecode.addDstore(var10);
      } else if (var7 == 317) {
         this.bytecode.addFstore(var10);
      } else if (var7 == 326) {
         this.bytecode.addLstore(var10);
      } else if (isRefType(var7)) {
         this.bytecode.addAstore(var10);
      } else {
         this.bytecode.addIstore(var10);
      }
   ...
   protected void atAssignCore(Expr var1, int var2, ASTree var3, int var4, int var5, String var6) throws CompileError {
      if (var2 == 354 && var5 == 0 && var4 == 307) {
         this.atStringPlusEq(var1, var4, var5, var6, var3);
      } else {
         var3.accept(this);
         if (this.invalidDim(this.exprType, this.arrayDim, this.className, var4, var5, var6, false) || var2 != 61 && var5 > 0) {
            badAssign(var1);
         }

         if (var2 != 61) {
            int var7 = assignOps[var2 - 351];
            int var8 = lookupBinOp(var7);
            if (var8 < 0) {
               fatal();
            }

            this.atArithBinExpr(var1, var7, var8, var4);
         }
      }

      if (var2 != 61 || var5 == 0 && !isRefType(var4)) {
         this.atNumCastExpr(this.exprType, var4);
      }
   ...
   private boolean invalidDim(int var1, int var2, String var3, int var4, int var5, String var6, boolean var7) {
      if (var2 != var5) {
         if (var1 == 412) {
            return false;
         } else if (var5 == 0 && var4 == 307 && "java/lang/Object".equals(var6)) {
            return false;
         } else {
            return !var7 || var2 != 0 || var1 != 307 || !"java/lang/Object".equals(var3);
         }
      } else {
         return false;
      }
   ...
   public void atCondExpr(CondExpr var1) throws CompileError {
      if (this.booleanExpr(false, var1.condExpr())) {
   ...
   private void convToString(int var1, int var2) throws CompileError {
      String var3 = "valueOf";
      if (!isRefType(var1) && var2 <= 0) {
         if (var1 == 312) {
   ...
   private boolean booleanExpr(boolean var1, ASTree var2) throws CompileError {
      int var4 = getCompOperator(var2);
      BinExpr var5;
      int var6;
      if (var4 == 358) {
         var5 = (BinExpr)var2;
         var6 = this.compileOprands(var5);
         this.compareExpr(var1, var5.getOperator(), var6, var5);
      } else {
         if (var4 == 33) {
            return this.booleanExpr(!var1, ((Expr)var2).oprand1());
         }

         boolean var3;
         if (!(var3 = var4 == 369) && var4 != 368) {
            if (isAlwaysBranch(var2, var1)) {
               this.exprType = 301;
               this.arrayDim = 0;
               return true;
            }
            ...
            this.bytecode.addOpcode(var1 ? 154 : 153);
         } else {
            var5 = (BinExpr)var2;
            if (this.booleanExpr(!var3, var5.oprand1())) {
               this.exprType = 301;
               this.arrayDim = 0;
               return true;
            }
            ...
            var6 = this.bytecode.currentPc();
            this.bytecode.addIndex(0);
            if (this.booleanExpr(var3, var5.oprand2())) {
               this.bytecode.addOpcode(167);
            }

            this.bytecode.write16bit(var6, this.bytecode.currentPc() - var6 + 3);
            if (var1 != var3) {
   ...
   private static boolean isAlwaysBranch(ASTree var0, boolean var1) {
      if (var0 instanceof Keyword) {
         int var2 = ((Keyword)var0).get();
         return var1 ? var2 == 410 : var2 == 411;
      } else {
         return false;
      }
   }
   ...
   protected static boolean isRefType(int var0) {
      return var0 == 307 || var0 == 412;
   }

   private static int typePrecedence(int var0) {
      if (var0 == 312) {
         return 0;
      } else if (var0 == 317) {
         return 1;
   ...
   private String checkCastExpr(CastExpr var1, String var2) throws CompileError {
      ...
      if (!this.invalidDim(var7, this.arrayDim, this.className, var6, var5, var2, true) && var7 != 344 && var6 != 344) {
         if (var6 == 307) {
            if (!isRefType(var7) && var8 == 0) {
   ...
   public void atExpr(Expr var1) throws CompileError {
      ...
      if (var2 == 46) {
         ...
         if (var2 == 33) {
            if (!this.booleanExpr(false, var1)) {
               this.bytecode.addIndex(7);
               this.bytecode.addIconst(1);
               this.bytecode.addOpcode(167);
               this.bytecode.addIndex(4);
   ...
   public void atArrayPlusPlus(int var1, boolean var2, Expr var3, boolean var4) throws CompileError {
      ...
      int var7 = is2word(var5, var6) ? 94 : 91;
