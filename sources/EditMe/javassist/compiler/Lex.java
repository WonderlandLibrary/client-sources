...
public class Lex implements TokenId {
   ...
   private int readStringL(Token var1) {
      StringBuffer var3 = this.textBuffer;
      var3.setLength(0);

      while(true) {
         int var2;
         while((var2 = this.getc()) == 34) {
            while(true) {
               while(true) {
                  var2 = this.getc();
                  if (var2 == 10) {
                     ++this.lineNumber;
                  } else if (!isBlank(var2) && var2 != 34) {
                     this.ungetc(var2);
                     var1.textValue = var3.toString();
                     return 406;
                  }
               }
            }
         ...
         if (var2 == 92) {
            var2 = this.readEscapeChar();
         } else if (var2 == 10 || var2 < 0) {
            ++this.lineNumber;
            return 500;
         }
   ...
   private static boolean isBlank(int var0) {
      return var0 == 32 || var0 == 9 || var0 == 12 || var0 == 13 || var0 == 10;
   }
