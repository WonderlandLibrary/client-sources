...
public class JvstCodeGen extends MemberCodeGen {
   ...
   void compileInvokeSpecial(ASTree var1, int var2, String var3, ASTList var4) throws CompileError {
      var1.accept(this);
      int var5 = this.getMethodArgsLength(var4);
      this.atMethodArgs(var4, new int[var5], new int[var5], new String[var5]);
      this.bytecode.addInvokespecial(var2, var3);
      this.setReturnType(var3, false, false);
      this.addNullIfVoid();
   }
