...
public class Javac {
   ...
   public void recordSpecialProceed(String var1, String var2, String var3, String var4, int var5) throws CompileError {
      Parser var6 = new Parser(new Lex(var1));
      ASTree var7 = var6.parseExpression(this.stable);
      ProceedHandler var8 = new ProceedHandler(this, var7, var5, var4, var2, var3) {
         final ASTree val$texpr;
         ...
         public void doit(JvstCodeGen var1, Bytecode var2, ASTList var3) throws CompileError {
            var1.compileInvokeSpecial(this.val$texpr, this.val$methodIndex, this.val$descriptor, var3);
         }

         public void setReturnType(JvstTypeChecker var1, ASTList var2) throws CompileError {
            var1.compileInvokeSpecial(this.val$texpr, this.val$classname, this.val$methodname, this.val$descriptor, var2);
         }
      };
      this.gen.setProceedHandler(var8, "$proceed");
   }
