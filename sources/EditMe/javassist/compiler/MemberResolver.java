   ...
   private MemberResolver.Method lookupMethod(CtClass var1, String var2, int[] var3, int[] var4, String[] var5, boolean var6) throws CompileError {
      ...
      if (var8 != null) {
         ...
         for(int var11 = 0; var11 < var10; ++var11) {
            ...
            if (var12.getName().equals(var2) && (var12.getAccessFlags() & 64) == 0) {
         ...
         for(int var9 = 0; var6 < var8; ++var9) {
            ...
            if (var2[var9] == 412) {
               ...
               if (var10 == 'L') {
                  ...
                  String var13 = var1.substring(var6, var12);
                  if (!var13.equals(var4[var9])) {
                     CtClass var14 = this.lookupClassByJvmName(var4[var9]);

                     try {
                        if (!var14.subtypeOf(this.lookupClassByJvmName(var13))) {
                           return -1;
                        }
                  ...
                  int var17 = var2[var9];
                  if (var12 != var17) {
                     if (var12 != 324 || var17 != 334 && var17 != 303 && var17 != 306) {
                        return -1;
                     }
