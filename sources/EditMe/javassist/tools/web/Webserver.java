...
public class Webserver {
   ...
   public void doReply(InputStream var1, OutputStream var2, String var3) throws IOException, BadHttpRequest {
      if (!var3.startsWith("GET /")) {
         ...
         if (var5 != 2 || !this.letUsersSendClassfile(var2, var6, var4)) {
   ...
   private boolean letUsersSendClassfile(OutputStream var1, String var2, int var3) throws IOException, BadHttpRequest {
      if (this.classPool == null) {
         return false;
      } else {
         String var5 = var2.substring(0, var3 - 6).replace('/', '.');

         byte[] var4;
         try {
            if (this.translator != null) {
               this.translator.onLoad(this.classPool, var5);
            }

            CtClass var6 = this.classPool.get(var5);
            var4 = var6.toBytecode();
            if (this.debugDir != null) {
               var6.writeFile(this.debugDir);
            }
         } catch (Exception var7) {
            throw new BadHttpRequest(var7);
         }

         this.sendHeader(var1, (long)var4.length, 2);
         var1.write(var4);
         return true;
      }
   }
