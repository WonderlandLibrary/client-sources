...
public class Loader extends ClassLoader {
   ...
   protected Class loadClassByDelegation(String var1) throws ClassNotFoundException {
      Class var2 = null;
      if (this.doDelegation && (var1.startsWith("java.") || var1.startsWith("javax.") || var1.startsWith("sun.") || var1.startsWith("com.sun.") || var1.startsWith("org.w3c.") || var1.startsWith("org.xml.") || this.notDelegated(var1))) {
   ...
   private boolean notDelegated(String var1) {
      if (this.notDefinedHere.get(var1) != null) {
         return true;
      } else {
         int var2 = this.notDefinedPackages.size();

         for(int var3 = 0; var3 < var2; ++var3) {
            if (var1.startsWith((String)this.notDefinedPackages.elementAt(var3))) {
               return true;
            }
         }
