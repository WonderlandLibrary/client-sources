...
class CtClassType extends CtClass {
   ...
   public ClassFile getClassFile3(boolean var1) {
      ...
      if (var2 != null) {
         ...
         if (this.rawClassfile != null) {
            try {
               ClassFile var20 = new ClassFile(new DataInputStream(new ByteArrayInputStream(this.rawClassfile)));
               this.rawClassfile = null;
               this.getCount = 2;
               return this.setClassFile(var20);
            ...
            try {
               ...
               ClassFile var4 = new ClassFile(new DataInputStream((InputStream)var3));
   ...
   public CtConstructor[] getConstructors() {
      ...
      while(var5 != var3) {
         var5 = var5.next();
         if (isPubCons((CtConstructor)var5)) {
            ++var4;
         }
      }
   ...
   private static boolean isPubCons(CtConstructor var0) {
      return !Modifier.isPrivate(var0.getModifiers()) && var0.isConstructor();
   }
   ...
   public void addMethod(CtMethod var1) throws CannotCompileException {
      ...
      if (var1.getDeclaringClass() != this) {
         ...
         if ((this.getModifiers() & 512) != 0) {
            if (Modifier.isProtected(var2) || Modifier.isPrivate(var2)) {
               throw new CannotCompileException("an interface method must be public: " + var1.toString());
            }
   ...
   private static boolean notFindInArray(String var0, String[] var1) {
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         if (var1[var3].startsWith(var0)) {
            return false;
         }
      }
