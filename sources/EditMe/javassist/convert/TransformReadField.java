...
public class TransformReadField extends Transformer {
   ...
   static String isField(ClassPool var0, ConstPool var1, CtClass var2, String var3, boolean var4, int var5) {
      if (!var1.getFieldrefName(var5).equals(var3)) {
         ...
         try {
            ...
            if (var6 == var2 || !var4 && isFieldInSuper(var6, var2, var3)) {
   ...
   static boolean isFieldInSuper(CtClass var0, CtClass var1, String var2) {
      if (!var0.subclassOf(var1)) {
         return false;
      } else {
         try {
            CtField var3 = var0.getField(var2);
            return var3.getDeclaringClass() == var1;
