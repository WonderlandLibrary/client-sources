...
public class MemberUsageScanner extends AbstractScanner {
   ...
   void scanMember(CtBehavior var1) throws CannotCompileException {
      ...
      var1.instrument(new ExprEditor(this, var2) {
         ...
         public void edit(NewExpr var1) throws CannotCompileException {
            try {
               this.this$0.put(var1.getConstructor().getDeclaringClass().getName() + ".<init>(" + this.this$0.parameterNames(var1.getConstructor().getMethodInfo()) + ")", var1.getLineNumber(), this.val$key);
         ...
         public void edit(MethodCall var1) throws CannotCompileException {
            try {
               this.this$0.put(var1.getMethod().getDeclaringClass().getName() + "." + var1.getMethodName() + "(" + this.this$0.parameterNames(var1.getMethod().getMethodInfo()) + ")", var1.getLineNumber(), this.val$key);
            } catch (NotFoundException var3) {
         ...
         public void edit(FieldAccess var1) throws CannotCompileException {
            try {
               this.this$0.put(var1.getField().getDeclaringClass().getName() + "." + var1.getFieldName(), var1.getLineNumber(), this.val$key);
            } catch (NotFoundException var3) {
   ...
   String parameterNames(MethodInfo var1) {
      return Joiner.on(", ").join(this.getMetadataAdapter().getParameterNames(var1));
   }
