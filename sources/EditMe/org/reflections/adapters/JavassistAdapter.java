...
public class JavassistAdapter implements MetadataAdapter {
   ...
   public List getParameterAnnotationNames(MethodInfo var1, int var2) {
      ...
      ArrayList var4 = Lists.newArrayList(new ParameterAnnotationsAttribute[]{(ParameterAnnotationsAttribute)var1.getAttribute("RuntimeVisibleParameterAnnotations"), (ParameterAnnotationsAttribute)var1.getAttribute("RuntimeInvisibleParameterAnnotations")});
      if (var4 != null) {
   ...
   public String getMethodKey(ClassFile var1, MethodInfo var2) {
      return this.getMethodName(var2) + "(" + Joiner.on(", ").join(this.getParameterNames(var2)) + ")";
   }
