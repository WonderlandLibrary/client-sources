...
public abstract class ClasspathHelper {
      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         ...
         try {
            ...
            while(var8.hasMoreElements()) {
               ...
               if (var10 != -1) {
                  var2.add(new URL(var9, var9.toExternalForm().substring(0, var10)));
               } else {
                  var2.add(var9);
               }
            }
   ...
   public static Collection forWebInfLib(ServletContext var0) {
      ArrayList var1 = new ArrayList();
      Set var2 = var0.getResourcePaths("/WEB-INF/lib");
      if (var2 == null) {
         return var1;
      } else {
         ...
         while(var3.hasNext()) {
            ...
            try {
               var1.add(var0.getResource((String)var4));
   ...
   private static Collection distinctUrls(Collection var0) {
      LinkedHashMap var1 = new LinkedHashMap(var0.size());
      Iterator var2 = var0.iterator();
