...
public abstract class Utils {
   ...
   public static String name(Constructor var0) {
      return var0.getName() + ".<init>(" + Joiner.on(", ").join(names(var0.getParameterTypes())) + ")";
   }

   public static String name(Method var0) {
      return var0.getDeclaringClass().getName() + "." + var0.getName() + "(" + Joiner.on(", ").join(names(var0.getParameterTypes())) + ")";
   }
