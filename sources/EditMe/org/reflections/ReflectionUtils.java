...
public abstract class ReflectionUtils {
   ...
   public static Set getAll(Set var0, Predicate... var1) {
      return (Set)(Utils.isEmpty((Object[])var1) ? var0 : Sets.newHashSet(Iterables.filter(var0, Predicates.and(var1))));
   }
   ...
   public static Predicate withAnnotations(Class... var0) {
      return new Predicate(var0) {
         ...
         public boolean apply(@Nullable AnnotatedElement var1) {
            return var1 != null && Arrays.equals(this.val$annotations, ReflectionUtils.annotationTypes(var1.getAnnotations()));
         }
   ...
   public static Predicate withAnnotation(Annotation var0) {
      return new Predicate(var0) {
         ...
         public boolean apply(@Nullable AnnotatedElement var1) {
            return var1 != null && var1.isAnnotationPresent(this.val$annotation.annotationType()) && ReflectionUtils.areAnnotationMembersMatching(var1.getAnnotation(this.val$annotation.annotationType()), this.val$annotation);
         }
            ...
            if (var1 != null) {
               ...
               if (var2.length == this.val$annotations.length) {
                  for(int var3 = 0; var3 < var2.length; ++var3) {
                     if (!ReflectionUtils.areAnnotationMembersMatching(var2[var3], this.val$annotations[var3])) {
                        return false;
                     }
                  }
               }
   ...
   public static Predicate withParameters(Class... var0) {
      return new Predicate(var0) {
         ...
         public boolean apply(@Nullable Member var1) {
            return Arrays.equals(ReflectionUtils.parameterTypes(var1), this.val$types);
         }
   ...
   public static Predicate withParametersAssignableTo(Class... var0) {
      return new Predicate(var0) {
         ...
         public boolean apply(@Nullable Member var1) {
            if (var1 != null) {
               Class[] var2 = ReflectionUtils.parameterTypes(var1);
   ...
   public static Predicate withParametersCount(int var0) {
      return new Predicate(var0) {
         ...
         public boolean apply(@Nullable Member var1) {
            return var1 != null && ReflectionUtils.parameterTypes(var1).length == this.val$count;
         }
   ...
   public static Predicate withAnyParameterAnnotation(Class var0) {
      return new Predicate(var0) {
         ...
         public boolean apply(@Nullable Member var1) {
            return var1 != null && Iterables.any(ReflectionUtils.annotationTypes((Iterable)ReflectionUtils.parameterAnnotations(var1)), new Predicate(this) {
   ...
   public static Predicate withAnyParameterAnnotation(Annotation var0) {
      return new Predicate(var0) {
         ...
         public boolean apply(@Nullable Member var1) {
            return var1 != null && Iterables.any(ReflectionUtils.parameterAnnotations(var1), new Predicate(this) {
               final <undefinedtype> this$0;
               ...
               public boolean apply(@Nullable Annotation var1) {
                  return ReflectionUtils.areAnnotationMembersMatching(this.this$0.val$annotation, var1);
               }
   ...
   static Set filter(Object[] var0, Predicate... var1) {
      return Utils.isEmpty((Object[])var1) ? Sets.newHashSet(var0) : Sets.newHashSet(Iterables.filter(Arrays.asList(var0), Predicates.and(var1)));
   }

   static Set filter(Iterable var0, Predicate... var1) {
      return Utils.isEmpty((Object[])var1) ? Sets.newHashSet(var0) : Sets.newHashSet(Iterables.filter(var0, Predicates.and(var1)));
   }
