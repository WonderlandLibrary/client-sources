...
public class SystemDir implements Vfs.Dir {
         ...
         public Iterator iterator() {
            return new AbstractIterator(this) {
...

               {
                  ...
                  this.stack.addAll(SystemDir.listFiles(this.this$1.this$0.file));
               }
               ...
               protected Vfs.File computeNext() {
                  while(true) {
                     if (!this.stack.isEmpty()) {
                        ...
                        if (var1.isDirectory()) {
                           this.stack.addAll(SystemDir.listFiles(var1));
                           continue;
                        }
   ...
   private static List listFiles(File var0) {
      ...
      return var1 != null ? Lists.newArrayList(var1) : Lists.newArrayList();
   }
