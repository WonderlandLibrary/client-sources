...
public class SettingsFrame extends Frame {
   ...
   public void initialize() {
      ...
      while(var2.hasNext()) {
         ...
         if (var3.getCategory() == this.moduleCategory && !var3.getCategory().isHidden()) {
            this.getComponents().add(new ModuleSettingsComponent(var3, this.getPosX(), this.getPosY(), 0.0F, var1, this.getWidth(), 14.0F));
            var1 += 14.0F;
         }
      }
   ...
   public void setPosY(float var1) {
      ...
      while(var2.hasNext()) {
         ...
         if (var3.getName().equals(String.valueOf((new StringBuilder()).append(this.moduleCategory.getName().toUpperCase()).append("y")))) {
            var3.setValue(var1);
         }
      }
   ...
   public SettingsFrame(Module.Category var1, float var2, float var3, float var4, float var5) {
   ...
   public void onMouseClicked(int var1, int var2, int var3) {
      ...
      if (this.isExtended() && mouseWithinBounds(var1, var2, (double)this.getPosX(), (double)(this.getPosY() + this.getHeight()), (double)this.getWidth(), (double)(this.getCurrentHeight() > 280.0F ? 280.0F : this.getCurrentHeight()))) {
         this.getComponents().forEach(SettingsFrame::lambda$onMouseClicked$1);
      }
   ...
   public void setPosX(float var1) {
      ...
      while(var2.hasNext()) {
         Setting var3 = (Setting)var2.next();
         if (var3.getName().equals(String.valueOf((new StringBuilder()).append(this.moduleCategory.getName().toUpperCase()).append("x")))) {
            var3.setValue(var1);
         }
      }
   ...
   public void drawScreen(int var1, int var2, float var3) {
      ...
      if (this.isExtended()) {
         ...
         this.getComponents().forEach(SettingsFrame::lambda$drawScreen$0);
         GL11.glDisable(3089);
         GL11.glPopMatrix();
      }
