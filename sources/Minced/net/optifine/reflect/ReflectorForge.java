...
public class ReflectorForge
{
    ...
    public static int getLightValue(final IBlockState stateIn, final IBlockAccess worldIn, final BlockPos posIn) {
    ...
    public static boolean canEntitySpawn(final EntityLiving entityliving, final World world, final float x, final float y, final float z) {
        final Object object = Reflector.call(Reflector.ForgeEventFactory_canEntitySpawn, entityliving, world, x, y, z, false);
    ...
    public static boolean isAmbientOcclusion(final IBakedModel model, final IBlockState state) {
    ...
    public static ICrashReportDetail<String> getDetailItemRegistryName(final Item item) {
        return new ICrashReportDetail<String>() {
            ...
            public String call() throws Exception {
                final Object object = Reflector.call(item, Reflector.IForgeRegistryEntry_Impl_getRegistryName, new Object[0]);
