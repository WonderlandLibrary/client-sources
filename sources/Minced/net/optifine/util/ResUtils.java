...
public class ResUtils
{
    ...
    public static String[] collectFiles(IResourcePack rp, final String[] prefixes, final String[] suffixes, final String[] defaultPaths) {
        if (rp instanceof DefaultResourcePack) {
            return collectFilesFixed(rp, defaultPaths);
        }
        if (rp instanceof LegacyV2Adapter) {
            final IResourcePack iresourcepack = (IResourcePack)Reflector.getFieldValue(rp, Reflector.LegacyV2Adapter_pack);
    ...
    private static String[] collectFilesFolder(final File tpFile, final String basePath, final String[] prefixes, final String[] suffixes) {
        ...
        for (int i = 0; i < afile.length; ++i) {
            ...
            if (file1.isFile()) {
                String s2 = basePath + file1.getName();
                if (s2.startsWith(s)) {
                ...
                final String s3 = basePath + file1.getName() + "/";
