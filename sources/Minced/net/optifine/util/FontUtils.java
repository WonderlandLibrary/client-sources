...
public class FontUtils
{
    public static Properties readFontProperties(final ResourceLocation locationFontTexture) {
        final String s = locationFontTexture.getPath();
        ...
        try {
            final ResourceLocation resourcelocation = new ResourceLocation(locationFontTexture.getNamespace(), s3);
    ...
    public static void readCustomCharWidths(final Properties props, final float[] charWidth) {
        for (final Object a : props.keySet()) {
    ...
    public static ResourceLocation getHdFontLocation(final ResourceLocation fontLoc) {
        ...
        s = s3 + s;
        final ResourceLocation resourcelocation = new ResourceLocation(fontLoc.getNamespace(), s);
