...
public class CustomColors
{
    ...
    private static CustomColormap[] readCustomColormaps(final Properties props, final String fileName) {
        ...
        for (final Object s2 : props.keySet()) {
            ...
            final String s4 = props.getProperty(s3);
            if (s3.startsWith(s)) {
                map.put(s3, s4);
            }
        }
        ...
        for (int j = 0; j < astring.length; ++j) {
            ...
            final String s6 = props.getProperty(s5);
            dbg("Block palette: " + s5 + " = " + s6);
            String s7 = s5.substring(s.length());
            final String s8 = TextureUtils.getBasePath(fileName);
    ...
    private static void addToList(final CustomColormap cm, final List list, final int id) {
        ...
        ArrayList<CustomColormap> subList = list.get(id);
        if (subList == null) {
    ...
    private static CustomColormap[][] blockListToArray(final List list) {
        ...
        for (int i2 = 0; i2 < list.size(); ++i2) {
            final List<CustomColormap> subList = list.get(i2);
            if (subList != null) {
    ...
    private static Vec3d readColorVec3(final Properties props, final String name) {
    ...
    protected static Biome getColorBiome(final IBlockAccess blockAccess, final BlockPos blockPos) {
    ...
    public static void updatePortalFX(final Particle fx) {
    ...
    public static void updateMyceliumFX(final Particle fx) {
    ...
    public static void updateReddustFX(final Particle fx, final IBlockAccess blockAccess, final double x, final double y, final double z) {
        if (CustomColors.redstoneColors != null) {
    ...
    public static int getDurabilityColor(final float dur, final int color) {
        ...
        final int i = (int)(dur * CustomColors.durabilityColors.getLength());
        final int j = CustomColors.durabilityColors.getColor(i);
        return j;
    }
    
    public static void updateWaterFX(final Particle fx, final IBlockAccess blockAccess, final double x, final double y, final double z, final RenderEnv renderEnv) {
    ...
    private static int getLilypadColorMultiplier(final IBlockAccess blockAccess, final BlockPos blockPos) {
        return (CustomColors.lilyPadColor < 0) ? getBlockColors().colorMultiplier(Blocks.WATERLILY.getDefaultState(), blockAccess, blockPos, 0) : CustomColors.lilyPadColor;
    }
    
    private static Vec3d getFogColorNether(final Vec3d col) {
        return (CustomColors.fogColorNether == null) ? col : CustomColors.fogColorNether;
    }
    
    private static Vec3d getFogColorEnd(final Vec3d col) {
        return (CustomColors.fogColorEnd == null) ? col : CustomColors.fogColorEnd;
    }
    
    private static Vec3d getSkyColorEnd(final Vec3d col) {
        return (CustomColors.skyColorEnd == null) ? col : CustomColors.skyColorEnd;
    }
    
    public static Vec3d getSkyColor(final Vec3d skyColor3d, final IBlockAccess blockAccess, final double x, final double y, final double z) {
        ...
        float f2 = k / 255.0f;
        float f3 = l / 255.0f;
        final float f4 = (float)skyColor3d.x / 0.5f;
        final float f5 = (float)skyColor3d.y / 0.66275f;
        final float f6 = (float)skyColor3d.z;
        f *= f4;
        f2 *= f5;
        f3 *= f6;
    ...
    private static Vec3d getFogColor(final Vec3d fogColor3d, final IBlockAccess blockAccess, final double x, final double y, final double z) {
        ...
        float f2 = k / 255.0f;
        float f3 = l / 255.0f;
        final float f4 = (float)fogColor3d.x / 0.753f;
        final float f5 = (float)fogColor3d.y / 0.8471f;
        final float f6 = (float)fogColor3d.z;
        f *= f4;
        f2 *= f5;
        f3 *= f6;
    ...
    public static Vec3d getUnderwaterColor(final IBlockAccess blockAccess, final double x, final double y, final double z) {
        return getUnderFluidColor(blockAccess, x, y, z, CustomColors.underwaterColors, CustomColors.underwaterColorFader);
    }
    
    public static Vec3d getUnderlavaColor(final IBlockAccess blockAccess, final double x, final double y, final double z) {
        return getUnderFluidColor(blockAccess, x, y, z, CustomColors.underlavaColors, CustomColors.underlavaColorFader);
    }
    
    public static Vec3d getUnderFluidColor(final IBlockAccess blockAccess, final double x, final double y, final double z, final CustomColormap underFluidColors, final CustomColorFader underFluidColorFader) {
        ...
        final float f2 = k / 255.0f;
        final float f3 = l / 255.0f;
        final Vec3d vec3d = underFluidColorFader.getColor(f, f2, f3);
        return vec3d;
    }
    ...
    public static Vec3d getWorldFogColor(final Vec3d fogVec, final World world, final Entity renderViewEntity, final float partialTicks) {
    ...
    public static Vec3d getWorldSkyColor(final Vec3d skyVec, final World world, final Entity renderViewEntity, final float partialTicks) {
        final DimensionType dimensiontype = world.provider.getDimensionType();
        final Minecraft minecraft = Minecraft.getMinecraft();
        if (dimensiontype == DimensionType.OVERWORLD) {
    ...
    private static int[] readSpawnEggColors(final Properties props, final String fileName, final String prefix, final String logName) {
        ...
        int i = 0;
        for (final Object ss : set) {
            final String s = (String)ss;
    ...
    private static float[][] readDyeColors(final Properties props, final String fileName, final String prefix, final String logName) {
        ...
        int k = 0;
        for (final Object ss : props.keySet()) {
            final String s = (String)ss;
            final String s2 = props.getProperty(s);
            if (s.startsWith(prefix)) {
    ...
    public static int getPotionColor(final Potion potion, final int color) {
        int i = 0;
        if (potion != null) {
    ...
    static {
        ...
        COLORIZER_GRASS = new IColorizer() {
            ...
            public int getColor(final IBlockState blockState, final IBlockAccess blockAccess, final BlockPos blockPos) {
                final Biome biome = CustomColors.getColorBiome(blockAccess, blockPos);
