...
public class CustomLoadingScreen
{
    ...
    public void drawBackground(final int width, final int height) {
        ...
        bufferbuilder.pos(0.0, height, 0.0).tex(d4, d5 + d3).color(255, 255, 255, 255).endVertex();
        bufferbuilder.pos(width, height, 0.0).tex(d4 + d2, d5 + d3).color(255, 255, 255, 255).endVertex();
        bufferbuilder.pos(width, 0.0, 0.0).tex(d4 + d2, d5).color(255, 255, 255, 255).endVertex();
        bufferbuilder.pos(0.0, 0.0, 0.0).tex(d4, d5).color(255, 255, 255, 255).endVertex();
        tessellator.draw();
    }
}
