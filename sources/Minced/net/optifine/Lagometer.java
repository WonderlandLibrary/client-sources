...
public class Lagometer
{
    ...
    public static void updateLagometer() {
        if (Lagometer.mc == null) {
            ...
            Lagometer.profiler = Lagometer.mc.profiler;
        }
    ...
    public static void showLagometer(final ScaledResolution scaledResolution) {
        if (Lagometer.gameSettings != null && (Lagometer.gameSettings.ofLagometer || Lagometer.gameSettings.showLagometer)) {
            ...
            Lagometer.mc.fontRenderer.drawString("30", 2, k2 + 1, -8947849);
            Lagometer.mc.fontRenderer.drawString("30", 1, k2, -3881788);
            Lagometer.mc.fontRenderer.drawString("60", 2, j2 + 1, -8947849);
            Lagometer.mc.fontRenderer.drawString("60", 1, j2, -3881788);
            GlStateManager.matrixMode(5889);
            ...
            Lagometer.mc.fontRenderer.drawString(" " + MemoryMonitor.getAllocationRateMb() + " MB/s", l3, i3, k3);
            Lagometer.renderTimeNano = System.nanoTime() - i;
        }
    }
    
    private static long renderTime(final int frameNum, final long time, final int r, final int g, final int b, final float baseHeight, final BufferBuilder tessellator) {
    ...
    private static long renderTimeDivider(final int frameStart, final int frameEnd, final long time, final int r, final int g, final int b, final float baseHeight, final BufferBuilder tessellator) {
        final long i = time / 200000L;
        if (i < 3L) {
            return 0L;
        }
