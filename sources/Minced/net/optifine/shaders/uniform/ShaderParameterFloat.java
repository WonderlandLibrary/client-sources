    ...
    public float eval(final int index1, final int index2) {
        ...
        switch (this) {
            case BIOME: {
                ...
                final Biome biome2 = Shaders.getCurrentWorld().getBiome(blockpos2);
                return (float)Biome.getIdForBiome(biome2);
            }
            case TEMPERATURE: {
                final BlockPos blockpos3 = Shaders.getCameraPosition();
                final Biome biome3 = Shaders.getCurrentWorld().getBiome(blockpos3);
                return (biome3 != null) ? biome3.getTemperature(blockpos3) : 0.0f;
            }
            case RAINFALL: {
                final BlockPos blockpos4 = Shaders.getCameraPosition();
                final Biome biome4 = Shaders.getCurrentWorld().getBiome(blockpos4);
                return (biome4 != null) ? biome4.getRainfall() : 0.0f;
            }
            default: {
