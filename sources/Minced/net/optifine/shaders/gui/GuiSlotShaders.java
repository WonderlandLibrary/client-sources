...
class GuiSlotShaders extends GuiSlot
{
    ...
    @Override
    protected void drawSlot(final int index, final int posX, final int posY, final int contentY, final int mouseX, final int mouseY, final float partialTicks) {
