...
public class BlockRedstoneTorch extends BlockTorch
{
    ...
    public void updateTick(final World worldIn, final BlockPos pos, final IBlockState state, final Random rand) {
        ...
        if (this.isOn) {
            if (flag) {
                worldIn.setBlockState(pos, Blocks.UNLIT_REDSTONE_TORCH.getDefaultState().withProperty((IProperty<Comparable>)BlockRedstoneTorch.FACING, (Comparable)state.getValue((IProperty<V>)BlockRedstoneTorch.FACING)), 3);
            ...
            worldIn.setBlockState(pos, Blocks.REDSTONE_TORCH.getDefaultState().withProperty((IProperty<Comparable>)BlockRedstoneTorch.FACING, (Comparable)state.getValue((IProperty<V>)BlockRedstoneTorch.FACING)), 3);
        }
    }
    ...
    public void randomDisplayTick(final IBlockState stateIn, final World worldIn, final BlockPos pos, final Random rand) {
        if (this.isOn) {
            ...
            if (enumfacing.getAxis().isHorizontal()) {
                ...
                d0 += 0.27 * enumfacing2.getXOffset();
                d2 += 0.22;
                d3 += 0.27 * enumfacing2.getZOffset();
            }
