...
public class BlockStaticLiquid extends BlockLiquid
{
    ...
    private void updateLiquid(final World worldIn, final BlockPos pos, final IBlockState state) {
        final BlockDynamicLiquid blockdynamicliquid = BlockLiquid.getFlowingBlock(this.material);
    ...
    public void updateTick(final World worldIn, final BlockPos pos, final IBlockState state, final Random rand) {
        if (this.material == Material.LAVA && worldIn.getGameRules().getBoolean("doFireTick")) {
