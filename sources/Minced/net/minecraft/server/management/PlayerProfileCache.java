...
public class PlayerProfileCache
{
    ...
    public void load() {
        ...
        try {
            ...
            final List<ProfileEntry> list = JsonUtils.fromJson(this.gson, bufferedreader, PlayerProfileCache.TYPE);
    ...
    private List<ProfileEntry> getEntriesWithLimit(final int limitSize) {
        final List<ProfileEntry> list = (List<ProfileEntry>)Lists.newArrayList();
