...
public class RealmsBufferBuilder
{
    ...
    public RealmsBufferBuilder(final BufferBuilder p_i46442_1_) {
        this.b = p_i46442_1_;
    }
    
    public RealmsBufferBuilder from(final BufferBuilder p_from_1_) {
        this.b = p_from_1_;
        return this;
    }
    ...
    public void restoreState(final BufferBuilder.State p_restoreState_1_) {
