...
public class MapGenRavine extends MapGenBase
{
    ...
    protected void addTunnel(final long p_180707_1_, final int p_180707_3_, final int p_180707_4_, final ChunkPrimer p_180707_5_, double p_180707_6_, double p_180707_8_, double p_180707_10_, final float p_180707_12_, float p_180707_13_, float p_180707_14_, int p_180707_15_, int p_180707_16_, final double p_180707_17_) {
        ...
        while (p_180707_15_ < p_180707_16_) {
            double d3 = 1.5 + MathHelper.sin(p_180707_15_ * 3.1415927f / p_180707_16_) * p_180707_12_;
            ...
            if (flag1 || random.nextInt(4) != 0) {
                ...
                if (p_180707_6_ >= d0 - 16.0 - d3 * 2.0 && p_180707_10_ >= d2 - 16.0 - d3 * 2.0 && p_180707_6_ <= d0 + 16.0 + d3 * 2.0 && p_180707_10_ <= d2 + 16.0 + d3 * 2.0) {
                    int k2 = MathHelper.floor(p_180707_6_ - d3) - p_180707_3_ * 16 - 1;
                    int l = MathHelper.floor(p_180707_6_ + d3) - p_180707_3_ * 16 + 1;
                    int l2 = MathHelper.floor(p_180707_8_ - d4) - 1;
                    int m = MathHelper.floor(p_180707_8_ + d4) + 1;
                    int i2 = MathHelper.floor(p_180707_10_ - d3) - p_180707_4_ * 16 - 1;
                    int i3 = MathHelper.floor(p_180707_10_ + d3) - p_180707_4_ * 16 + 1;
                    if (k2 < 0) {
                        k2 = 0;
                    }
                    if (l > 16) {
                                    ...
                                    for (int j4 = m; j4 > l2; --j4) {
                                        ...
                                        if ((d9 * d9 + d10 * d10) * this.rs[j4 - 1] + d11 * d11 / 6.0 < 1.0) {
                                            ...
                                            if (iblockstate2.getBlock() == Blocks.STONE || iblockstate2.getBlock() == Blocks.DIRT || iblockstate2.getBlock() == Blocks.GRASS) {
                                                if (j4 - 1 < 10) {
                                                    p_180707_5_.setBlockState(j3, j4, i4, MapGenRavine.FLOWING_LAVA);
                                                }
                                                else {
                                                    p_180707_5_.setBlockState(j3, j4, i4, MapGenRavine.AIR);
                                                    if (flag3 && p_180707_5_.getBlockState(j3, j4 - 1, i4).getBlock() == Blocks.DIRT) {
                                                        blockpos$mutableblockpos.setPos(j3 + p_180707_3_ * 16, 0, i4 + p_180707_4_ * 16);
                                                        p_180707_5_.setBlockState(j3, j4 - 1, i4, this.world.getBiome(blockpos$mutableblockpos).topBlock);
                                                    }
                                                }
                                            }
                                        }
    ...
    protected void recursiveGenerate(final World worldIn, final int chunkX, final int chunkZ, final int originalX, final int originalZ, final ChunkPrimer chunkPrimerIn) {
        if (this.rand.nextInt(50) == 0) {
            ...
            for (int j = 0; j < 1; ++j) {
                ...
                this.addTunnel(this.rand.nextLong(), originalX, originalZ, chunkPrimerIn, d0, d2, d3, f3, f, f2, 0, 0, 3.0);
            }
        }
    }
