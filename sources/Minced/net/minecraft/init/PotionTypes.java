...
public class PotionTypes
{
    ...
    private static PotionType getRegisteredPotionType(final String id) {
        final PotionType potiontype = PotionType.REGISTRY.getObject(new ResourceLocation(id));
        if (!PotionTypes.CACHE.add(potiontype)) {
