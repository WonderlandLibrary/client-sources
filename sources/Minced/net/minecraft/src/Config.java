...
public class Config
{
    ...
    public static int getMinecraftVersionInt() {
        if (Config.minecraftVersionInt < 0) {
            final String[] astring = tokenize("1.12.2", ".");
            int i = 0;
            if (astring.length > 0) {
    ...
    public static IResourcePack[] getResourcePacks() {
        ...
        if (resourcepackrepository.getServerResourcePack() != null) {
            list2.add(resourcepackrepository.getServerResourcePack());
        }
    ...
    public static IResourcePack getDefiningResourcePack(final ResourceLocation p_getDefiningResourcePack_0_) {
        final ResourcePackRepository resourcepackrepository = Config.minecraft.getResourcePackRepository();
        final IResourcePack iresourcepack = resourcepackrepository.getServerResourcePack();
    ...
    public static void checkGlError(final String p_checkGlError_0_) {
        ...
        if (i != 0 && GlErrors.isEnabled(i)) {
            ...
            if (isShowGlErrors() && TimedEvent.isActive("ShowGlError", 10000L)) {
                ...
                Config.minecraft.ingameGUI.getChatGUI().printChatMessage(new TextComponentString(s3));
            }
        }
    }
    ...
    public static void drawFps() {
        ...
        Config.minecraft.fontRenderer.drawString(s2, 2, 2, -2039584);
    }
