...
public class CompiledChunk
{
    ...
    public BitSet getAnimatedSprites(final BlockRenderLayer p_getAnimatedSprites_1_) {
        return this.animatedSprites[p_getAnimatedSprites_1_.ordinal()];
    }
    
    public void setAnimatedSprites(final BlockRenderLayer p_setAnimatedSprites_1_, final BitSet p_setAnimatedSprites_2_) {
