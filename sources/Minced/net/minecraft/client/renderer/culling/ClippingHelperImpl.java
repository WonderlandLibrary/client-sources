...
public class ClippingHelperImpl extends ClippingHelper
{
    ...
    private final FloatBuffer floatBuffer16;
    ...
    private void normalize(final float[] p_180547_1_) {
        final float f = MathHelper.sqrt(p_180547_1_[0] * p_180547_1_[0] + p_180547_1_[1] * p_180547_1_[1] + p_180547_1_[2] * p_180547_1_[2]);
        final int n = 0;
        p_180547_1_[n] /= f;
        final int n2 = 1;
        p_180547_1_[n2] /= f;
