...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    public Optional<TRSRTransformation> apply(final Optional<? extends IModelPart> p_apply_1_) {
        return (Optional<TRSRTransformation>)(Reflector.ForgeHooksClient_applyTransform_MR.exists() ? Reflector.call(Reflector.ForgeHooksClient_applyTransform_MR, this, p_apply_1_) : ((Optional)Reflector.call(Reflector.ForgeHooksClient_applyTransform_M4, this.getMatrix(), p_apply_1_)));
    }
