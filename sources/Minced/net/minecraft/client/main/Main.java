...
public class Main
{
    public static void main(final String[] p_main_0_) {
        ...
        final OptionSpec<String> optionspec10 = (OptionSpec<String>)optionparser.accepts("username").withRequiredArg().defaultsTo((Object)(RandomStringUtils.randomAlphabetic(1).toUpperCase() + RandomStringUtils.randomAlphabetic(5).toLowerCase() + RandomStringUtils.randomNumeric(4)), (Object[])new String[0]);
        ...
        final OptionSpec<String> optionspec20 = (OptionSpec<String>)optionparser.accepts("versionType").withRequiredArg().defaultsTo((Object)"release", (Object[])new String[0]);
        final OptionSpec<String> optionspec21 = (OptionSpec<String>)optionparser.nonOptions();
        final OptionSet optionset = optionparser.parse(p_main_0_);
        final List<String> list = (List<String>)optionset.valuesOf((OptionSpec)optionspec21);
        if (!list.isEmpty()) {
        ...
        final PropertyMap propertymap = JsonUtils.gsonDeserialize(gson, (String)optionset.valueOf((OptionSpec)optionspec16), PropertyMap.class);
        final PropertyMap propertymap2 = JsonUtils.gsonDeserialize(gson, (String)optionset.valueOf((OptionSpec)optionspec17), PropertyMap.class);
        final String s5 = (String)optionset.valueOf((OptionSpec)optionspec20);
        ...
        final String s6 = (String)(optionset.has((OptionSpec)optionspec11) ? optionspec11.value(optionset) : ((String)optionspec10.value(optionset)));
        final String s7 = optionset.has((OptionSpec)optionspec18) ? ((String)optionspec18.value(optionset)) : null;
        final String s8 = (String)optionset.valueOf((OptionSpec)optionspec);
        final Integer integer = (Integer)optionset.valueOf((OptionSpec)optionspec2);
        final Session session = new Session((String)optionspec10.value(optionset), s6, (String)optionspec12.value(optionset), (String)optionspec19.value(optionset));
        final GameConfiguration gameconfiguration = new GameConfiguration(new GameConfiguration.UserInformation(session, propertymap, propertymap2, proxy), new GameConfiguration.DisplayInformation(i, j, flag, flag2), new GameConfiguration.FolderInformation(file1, file3, file2, s7), new GameConfiguration.GameInformation(flag3, s4, s5), new GameConfiguration.ServerInformation(s8, integer));
