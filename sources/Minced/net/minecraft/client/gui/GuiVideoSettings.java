...
public class GuiVideoSettings extends GuiScreenOF
{
    ...
    private void actionPerformed(final GuiButton p_actionPerformed_1_, final int p_actionPerformed_2_) {
        if (p_actionPerformed_1_.enabled) {
            ...
            if (this.guiGameSettings.guiScale != i) {
                final ScaledResolution scaledresolution = new ScaledResolution(GuiVideoSettings.mc);
                final int j = scaledresolution.getScaledWidth();
                final int k = scaledresolution.getScaledHeight();
                this.setWorldAndResolution(GuiVideoSettings.mc, j, k);
            }
            if (p_actionPerformed_1_.id == 201) {
                ...
                GuiVideoSettings.mc.displayGuiScreen(guidetailsettingsof);
            }
            if (p_actionPerformed_1_.id == 202) {
                ...
                GuiVideoSettings.mc.displayGuiScreen(guiqualitysettingsof);
            }
            if (p_actionPerformed_1_.id == 211) {
                ...
                GuiVideoSettings.mc.displayGuiScreen(guianimationsettingsof);
            }
            if (p_actionPerformed_1_.id == 212) {
                ...
                GuiVideoSettings.mc.displayGuiScreen(guiperformancesettingsof);
            }
            if (p_actionPerformed_1_.id == 222) {
                ...
                GuiVideoSettings.mc.displayGuiScreen(guiothersettingsof);
            }
            if (p_actionPerformed_1_.id == 231) {
                ...
                GuiVideoSettings.mc.displayGuiScreen(guishaders);
            }
        }
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final int i = this.fontRenderer.getStringWidth(s3);
        this.drawString(this.fontRenderer, s3, this.width - i - 2, this.height - 10, 8421504);
