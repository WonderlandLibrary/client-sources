...
public class GuiCommandBlock extends GuiScreen implements ITabCompleter
{
    ...
    public void initGui() {
        ...
        (this.commandTextField = new GuiTextField(2, this.fontRenderer, this.width / 2 - 150, 50, 300, 20)).setMaxStringLength(32500);
        this.commandTextField.setFocused(true);
        (this.previousOutputTextField = new GuiTextField(3, this.fontRenderer, this.width / 2 - 150, 135, 276, 20)).setMaxStringLength(32500);
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            if (button.id == 1) {
                ...
                GuiCommandBlock.mc.getConnection().sendPacket(new CPacketCustomPayload("MC|AutoCmd", packetbuffer));
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (!this.previousOutputTextField.getText().isEmpty()) {
            ...
            this.drawString(this.fontRenderer, I18n.format("advMode.previousOutput", new Object[0]), this.width / 2 - 150, i + 4, 10526880);
