...
public class GuiMultiplayer extends GuiScreen
{
    ...
    public void initGui() {
        ...
        if (this.initialized) {
            ...
            (this.serverListSelector = new ServerSelectionList(this, GuiMultiplayer.mc, this.width, this.height, 32, this.height - 64, 36)).updateOnlineServers(this.savedServerList);
        }
        this.createButtons();
    }
        ...
        if (button.enabled) {
            ...
            if (button.id == 2 && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
                ...
                if (s4 != null) {
                    ...
                    GuiMultiplayer.mc.displayGuiScreen(guiyesno);
                }
            }
            else if (button.id == 1) {
                ...
                GuiMultiplayer.mc.displayGuiScreen(new GuiScreenServerList(this, this.selectedServer));
            }
            else if (button.id == 3) {
