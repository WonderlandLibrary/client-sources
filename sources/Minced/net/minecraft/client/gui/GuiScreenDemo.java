...
public class GuiScreenDemo extends GuiScreen
{
    ...
    public void drawDefaultBackground() {
        ...
        GuiScreenDemo.mc.getTextureManager().bindTexture(GuiScreenDemo.DEMO_BACKGROUND_LOCATION);
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.fontRenderer.drawString(I18n.format("demo.help.title", new Object[0]), i, j, 2039583);
        j += 12;
        ...
        this.fontRenderer.drawString(I18n.format("demo.help.movementMouse", new Object[0]), i, j + 12, 5197647);
        ...
        this.fontRenderer.drawSplitString(I18n.format("demo.help.fullWrapped", new Object[0]), i, j + 68, 218, 2039583);
