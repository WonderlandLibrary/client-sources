...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void initGui() {
        ...
        (this.worldNameField = new GuiTextField(9, this.fontRenderer, this.width / 2 - 100, 60, 200, 20)).setFocused(true);
        this.worldNameField.setText(this.worldName);
        (this.worldSeedField = new GuiTextField(10, this.fontRenderer, this.width / 2 - 100, 60, 200, 20)).setText(this.worldSeed);
    ...
    private void calcSaveDirName() {
        ...
        this.saveDirName = getUncollidingSaveDirName(GuiCreateWorld.mc.getSaveLoader(), this.saveDirName);
    }
    ...
    public static String getUncollidingSaveDirName(final ISaveFormat saveLoader, String name) {
        ...
        for (final String s : GuiCreateWorld.DISALLOWED_FILENAMES) {
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.enabled) {
            if (button.id == 1) {
                GuiCreateWorld.mc.displayGuiScreen(this.parentScreen);
            }
            else if (button.id == 0) {
                ...
                GuiCreateWorld.mc.launchIntegratedServer(this.saveDirName, this.worldNameField.getText().trim(), worldsettings);
            }
            else if (button.id == 3) {
                ...
                if (WorldType.WORLD_TYPES[this.selectedIndex] == WorldType.FLAT) {
                    GuiCreateWorld.mc.displayGuiScreen(new GuiCreateFlatWorld(this, this.chunkProviderSettingsJson));
                }
                else {
                    GuiCreateWorld.mc.displayGuiScreen(new GuiCustomizeWorldScreen(this, this.chunkProviderSettingsJson));
                }
            }
        }
    }
    ...
    private boolean canSelectCurWorldType() {
        ...
        return worldtype != null && worldtype.canBeCreated() && (worldtype != WorldType.DEBUG_ALL_BLOCK_STATES || GuiScreen.isShiftKeyDown());
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.inMoreWorldOptionsDisplay) {
            ...
            if (WorldType.WORLD_TYPES[this.selectedIndex].hasInfoNotice()) {
                this.fontRenderer.drawSplitString(I18n.format(WorldType.WORLD_TYPES[this.selectedIndex].getInfoTranslationKey(), new Object[0]), this.btnMapType.x + 2, this.btnMapType.y + 22, this.btnMapType.getButtonWidth(), 10526880);
            }
        }
        else {
