...
public enum BannerPattern
{
    ...
    private BannerPattern(final String p_i47245_3_, final String p_i47245_4_) {
    ...
    private BannerPattern(final String p_i47246_3_, final String p_i47246_4_, final ItemStack p_i47246_5_) {
        this(p_i47246_3_, p_i47246_4_);
        this.patternItem = p_i47246_5_;
    }
    
    private BannerPattern(final String p_i47247_3_, final String p_i47247_4_, final String p_i47247_5_, final String p_i47247_6_, final String p_i47247_7_) {
    ...
    @Nullable
    public static BannerPattern byHash(final String hash) {
        for (final BannerPattern bannerpattern : values()) {
