...
public class ContainerEnchantment extends Container
{
    ...
    public boolean canInteractWith(final EntityPlayer playerIn) {
        return this.world.getBlockState(this.position).getBlock() == Blocks.ENCHANTING_TABLE && playerIn.getDistanceSq(this.position.getX() + 0.5, this.position.getY() + 0.5, this.position.getZ() + 0.5) <= 64.0;
    }
