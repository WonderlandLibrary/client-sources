...
public class SoundEvent
{
    ...
    public SoundEvent(final ResourceLocation soundNameIn) {
    ...
    private static void registerSound(final String soundNameIn) {
        final ResourceLocation resourcelocation = new ResourceLocation(soundNameIn);
        SoundEvent.REGISTRY.register(SoundEvent.soundEventId++, resourcelocation, new SoundEvent(resourcelocation));
    }
