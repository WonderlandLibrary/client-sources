...
{
    private static final String[] ID_MAP;
    ...
    public NBTTagCompound fixTagCompound(final NBTTagCompound compound) {
        if (compound.hasKey("id", 99)) {
            final short short1 = compound.getShort("id");
            if (short1 > 0 && short1 < ItemIntIDToString.ID_MAP.length && ItemIntIDToString.ID_MAP[short1] != null) {
                compound.setString("id", ItemIntIDToString.ID_MAP[short1]);
            }
        }
        return compound;
    }
