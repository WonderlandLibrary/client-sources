    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtility.drawRectNotWH(this.xPos, this.yPos, this.xPos + this.width, this.yPos + this.height, new Color(30, 30, 30, 185).getRGB());
            }
            this.getClass();
            ...
            if (var6) {
                if (var10) {
                    Gui.drawRect((float)var11, (float)(var8 - 1), (float)(var11 + 1), (float)(var8 + 1 + this.fontRenderer.FONT_HEIGHT), -3092272);
                }
                else {
