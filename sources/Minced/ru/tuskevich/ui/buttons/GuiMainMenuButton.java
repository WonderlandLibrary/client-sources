...
package ru.tuskevich.ui.buttons;
...
public class GuiMainMenuButton extends GuiButton
{
    ...
    public void drawButton(final Minecraft mc, final int mouseX, final int mouseY, final float mouseButton) {
        if (this.visible) {
            ...
            mc.getTextureManager().bindTexture(GuiMainMenuButton.BUTTON_TEXTURES);
            ...
            RenderUtility.drawRound((float)this.x, (float)this.y, (float)this.width, (float)this.height, 3.0f, new Color(25, 25, 25, 100));
