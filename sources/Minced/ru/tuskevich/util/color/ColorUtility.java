...
public class ColorUtility implements Utility
{
    ...
    public static Color interpolateColorC(final Color color1, final Color color2, float amount) {
        ...
        return new Color(MathUtility.interpolateInt(color1.getRed(), color2.getRed(), amount), MathUtility.interpolateInt(color1.getGreen(), color2.getGreen(), amount), MathUtility.interpolateInt(color1.getBlue(), color2.getBlue(), amount), MathUtility.interpolateInt(color1.getAlpha(), color2.getAlpha(), amount));
    }
