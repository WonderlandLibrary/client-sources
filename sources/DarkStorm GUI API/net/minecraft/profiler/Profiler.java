...
public class Profiler {
	...
	public List getProfilingData(String p_76321_1_) {
		...
		if (!this.profilerLocalEnabled) {
			...
			long var5 = this.profilingMap.containsKey(p_76321_1_)
					? ((Long) this.profilingMap.get(p_76321_1_)).longValue() : -1L;
			...
			while (var21.hasNext()) {
				...
				this.profilingMap.put(var12,
						Long.valueOf(((Long) this.profilingMap.get(var12)).longValue() * 950L / 1000L));
			}
