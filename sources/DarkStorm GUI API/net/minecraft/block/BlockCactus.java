...
public class BlockCactus extends Block {
	...
	public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state) {
		float var4 = 0.0625F;
		return new AxisAlignedBB((double) ((float) pos.getX() + var4), (double) pos.getY(),
				(double) ((float) pos.getZ() + var4), (double) ((float) (pos.getX() + 1) - var4),
				(double) ((float) (pos.getY() + 1) - var4), (double) ((float) (pos.getZ() + 1) - var4));
	}

	public AxisAlignedBB getSelectedBoundingBox(World worldIn, BlockPos pos) {
		float var3 = 0.0625F;
		return new AxisAlignedBB((double) ((float) pos.getX() + var3), (double) pos.getY(),
				(double) ((float) pos.getZ() + var3), (double) ((float) (pos.getX() + 1) - var3),
				(double) (pos.getY() + 1), (double) ((float) (pos.getZ() + 1) - var3));
	}
