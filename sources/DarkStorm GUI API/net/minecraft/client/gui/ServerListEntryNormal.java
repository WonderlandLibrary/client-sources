...
public class ServerListEntryNormal implements GuiListExtended.IGuiListEntry {
	...
	public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY,
		...
		List var12 = this.field_148300_d.fontRendererObj.listFormattedStringToWidth(this.field_148301_e.serverMOTD,
				listWidth - 32 - 2);

		for (int var13 = 0; var13 < Math.min(var12.size(), 2); ++var13) {
			this.field_148300_d.fontRendererObj.drawString((String) var12.get(var13), x + 32 + 3,
					y + 12 + this.field_148300_d.fontRendererObj.FONT_HEIGHT * var13, 8421504);
		}

		String var23 = var11 ? EnumChatFormatting.DARK_RED + this.field_148301_e.gameVersion
				: EnumChatFormatting.GREEN + this.field_148301_e.gameVersion + " " + this.field_148301_e.populationInfo;
		...
		Gui.drawModalRectWithCustomSizedTexture(x + listWidth - 15, y, (float) (var15 * 10), (float) (176 + var16 * 8),
				10, 8, 256.0F, 256.0F);
