...
import net.minecraft.client.main.neptune.UI.UIRenderer;
...
public class GuiIngame extends Gui {
	...
	public void renderUI(float var1337) {
		...
		if (Minecraft.isFancyGraphicsEnabled()) {
			this.func_180480_a(this.mc.thePlayer.getBrightness(var1337), var2);
		} else {
		...
		if (!this.mc.thePlayer.isPotionActive(Potion.confusion)) {
			float var6 = this.mc.thePlayer.prevTimeInPortal
					+ (this.mc.thePlayer.timeInPortal - this.mc.thePlayer.prevTimeInPortal) * var1337;
		...
		if (this.mc.playerController.enableEverythingIsScrewedUpMode()) {
			this.field_175197_u.func_175264_a(var2, var1337);
		} else {
			this.func_180479_a(var2, var1337);
		}
		...
		if (this.recordPlayingUpFor > 0) {
			...
			var7 = (float) this.recordPlayingUpFor - var1337;
		...
		if (this.field_175195_w > 0) {
			...
			var7 = (float) this.field_175195_w - var1337;
			var8 = 255;
			...
			if (var8 > 8) {
				...
				var9 = var8 << 24 & -16777216;
				this.func_175179_f().drawString(this.field_175201_x,
						(float) (-this.func_175179_f().getStringWidth(this.field_175201_x) / 2), -10.0F,
						16777215 | var9, true);
				GlStateManager.popMatrix();
				GlStateManager.pushMatrix();
				GlStateManager.scale(2.0F, 2.0F, 2.0F);
				this.func_175179_f().drawString(this.field_175200_y,
		...
		if (this.mc.gameSettings.keyBindPlayerList.getIsKeyPressed() && (!this.mc.isIntegratedServerRunning()
				|| this.mc.thePlayer.sendQueue.func_175106_d().size() > 1 || var16 != null)) {
	...
	public void func_175185_b(ScaledResolution p_175185_1_) {
		...
		this.func_175179_f().drawStringWithShadow(var2, (float) (p_175185_1_.getScaledWidth() - var3 - 10), 5.0F,
				16777215);
		this.mc.mcProfiler.endSection();
	}
	...
	private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
		...
		for (Iterator var7 = var21.iterator(); var7
			...
			var10 = ScorePlayerTeam.formatPlayerName(var9, var8.getPlayerName()) + ": " + EnumChatFormatting.RED
					+ var8.getScorePoints();
		}
	...
	private void renderBossHealth() {
		if (BossStatus.bossName != null && BossStatus.statusBarTime > 0) {
			...
			this.func_175179_f().drawStringWithShadow(var8,
					(float) (var3 / 2 - this.func_175179_f().getStringWidth(var8) / 2), (float) (var7 - 10), 16777215);
			GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
			this.mc.getTextureManager().bindTexture(icons);
		}
	}
