...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
		...
		if (p_175272_1_ != null && p_175272_1_.getChatStyle().getChatHoverEvent() != null) {
			...
			if (var4.getAction() == HoverEvent.Action.SHOW_ITEM) {
				...
				if (var4.getAction() == HoverEvent.Action.SHOW_ENTITY) {
					if (this.mc.gameSettings.advancedItemTooltips) {
						try {
							...
							if (var12 instanceof NBTTagCompound) {
								...
								this.drawCreativeTabHoveringText(EnumChatFormatting.RED + "Invalid Entity!",
					...
					this.drawHoveringText(field_175285_g.splitToList(var4.getValue().getFormattedText()), p_175272_2_,
							p_175272_3_);
	...
	public void drawBackground(int tint) {
		...
		var3.addVertexWithUV(0.0D, (double) this.height, 0.0D, 0.0D,
				(double) ((float) this.height / var4 + (float) tint));
		var3.addVertexWithUV((double) this.width, (double) this.height, 0.0D, (double) ((float) this.width / var4),
				(double) ((float) this.height / var4 + (float) tint));
		...
		this.drawScaledCustomSizeModalRect(0, 0, 0, 0, this.width, this.height, this.width, this.height, this.width,
				this.height);
	}
