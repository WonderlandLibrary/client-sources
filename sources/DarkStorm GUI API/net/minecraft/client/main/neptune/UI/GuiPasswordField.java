...
public class GuiPasswordField extends Gui {
	...
	public GuiPasswordField(final int p_i45542_1_, final FontRenderer p_i45542_2_, final int p_i45542_3_,
	...
	public void mouseClicked(final int p_146192_1_, final int p_146192_2_, final int p_146192_3_) {
		final boolean var4 = p_146192_1_ >= this.xPosition && p_146192_1_ < this.xPosition + this.width
		...
		if (this.isFocused && var4 && p_146192_3_ == 0) {
			...
			final String var6 = this.fontRendererInstance.trimStringToWidth(this.text.substring(this.lineScrollOffset),
					this.getWidth());
	...
	public void drawTextBox() {
		if (this.getVisible()) {
			...
			final String var4 = this.fontRendererInstance.trimStringToWidth(this.text.substring(this.lineScrollOffset),
					this.getWidth());
			...
			if (var4.length() > 0) {
				...
				var9 = Minecraft.getMinecraft().fontRendererObj
						.drawStringWithShadow(var10.replaceAll(this.textVisible ? "" : "(?s).", "*"), var7, var8, var1);
			}
			final boolean var11 = this.cursorPosition < this.text.length()
			...
			if (var3 != var2) {
				final int var13 = var7 + Minecraft.getMinecraft().fontRendererObj
						.getStringWidth(var4.substring(0, var3).replaceAll(this.textVisible ? "" : "(?s).", "*"));
				this.drawCursorVertical(var12, var8 - 1, var13 - 1,
