package net.minecraft.client.main.neptune.ttf;
...
public class NahrFont
{
    ...
    private void drawTexturedModalRect(final float x, final float y, final float u, final float v, final float width, final float height) {
        ...
        worldRenderer.addVertexWithUV((double)(x + 0.0f), (double)(y + height), 0.0, (double)((u + 0.0f) * 0.0039063f), (double)((v + height) * 0.0039063f));
        worldRenderer.addVertexWithUV((double)(x + width), (double)(y + height), 0.0, (double)((u + width) * 0.0039063f), (double)((v + height) * 0.0039063f));
        worldRenderer.addVertexWithUV((double)(x + width), (double)(y + 0.0f), 0.0, (double)((u + width) * 0.0039063f), (double)((v + 0.0f) * 0.0039063f));
        worldRenderer.addVertexWithUV((double)(x + 0.0f), (double)(y + 0.0f), 0.0, (double)((u + 0.0f) * 0.0039063f), (double)((v + 0.0f) * 0.0039063f));
        tessellator.draw();
    }
    ...
    public enum FontType
    {
        ...
        private FontType(final String s2, final int n2, final String s, final int n) {
        }
    }
}
