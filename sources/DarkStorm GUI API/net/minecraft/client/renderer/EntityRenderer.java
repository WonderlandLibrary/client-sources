...
public class EntityRenderer implements IResourceManagerReloadListener {
	...
	private void setupViewBobbing(float p_78475_1_) {
		if (this.mc.func_175606_aa() instanceof EntityPlayer) {
			...
			float var6;
				...
				var6 = var2.prevCameraPitch + (var2.cameraPitch - var2.prevCameraPitch) * p_78475_1_;
	...
	public void orientCamera(float p_78467_1_) {
		...
		if (var2 instanceof EntityLivingBase && ((EntityLivingBase) var2).isPlayerSleeping()) {
			...
			if (this.mc.gameSettings.debugCamEnable) {
				...
				double var14 = (double) (-MathHelper.sin(var12 / 180.0F * (float) Math.PI)
						* MathHelper.cos(var13 / 180.0F * (float) Math.PI)) * var28;
				double var16 = (double) (MathHelper.cos(var12 / 180.0F * (float) Math.PI)
						* MathHelper.cos(var13 / 180.0F * (float) Math.PI)) * var28;
				...
				for (int var20 = 0; var20 < 8; ++var20) {
					...
					MovingObjectPosition var24 = this.mc.theWorld.rayTraceBlocks(
							...
							new Vec3(var4 - var14 + (double) var21 + (double) var23, var6 - var18 + (double) var22,
	...
	private void renderHand(float p_78476_1_, int p_78476_2_) {
		if (!this.field_175078_W) {
			...
			boolean var4 = this.mc.func_175606_aa() instanceof EntityLivingBase
		...
		if (!this.mc.skipRenderWorld) {
			...
			if (this.mc.theWorld != null) {
				...
				if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null) {
					...
					this.mc.ingameGUI.renderUI(partialTicks);
				}
			...
			if (this.mc.currentScreen != null) {
				...
				try {
					...
					if (Reflector.EventBus_post.exists()) {
						var122 = Reflector.postForgeBusEvent(Reflector.DrawScreenEvent_Pre_Constructor,
	...
	private void func_175068_a(int pass, float partialTicks, long finishTimeNano) {
		...
		if (!Config.isSkyEnabled() && !Config.isSunMoonEnabled() && !Config.isStarsEnabled()) {
			...
			Project.gluPerspective(this.getFOVModifier(partialTicks, true),
					...
					this.farPlaneDistance * MathHelper.field_180189_a);
			GlStateManager.matrixMode(5888);
		}
	...
	private void updateFogColor(float partialTicks) {
		...
		if (this.cloudFog) {
			...
			fogYFactor = CustomColorizer.getUnderwaterColor(this.mc.theWorld, this.mc.func_175606_aa().posX,
	...
	private void frameInit() {
		...
		if (world != null && Config.getNewRelease() != null) {
			...
			ChatComponentText msg = new ChatComponentText(
					"A new \u00a7eOptiFine\u00a7f version is available: \u00a7e" + fullNewVer + "\u00a7f");
