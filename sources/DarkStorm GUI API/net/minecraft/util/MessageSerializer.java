...
public class MessageSerializer extends MessageToByteEncoder {
	...
	protected void encode(ChannelHandlerContext p_encode_1_, Packet p_encode_2_, ByteBuf p_encode_3_)
			throws IOException {
		Integer var4 = ((EnumConnectionState) p_encode_1_.channel().attr(NetworkManager.attrKeyConnectionState).get())
		...
		if (var4 == null) {
			...
			try {
				// if(p_encode_2_instanceofS0CPacketSpawnPlayer){p_encode_2_=p_encode_2_;}
