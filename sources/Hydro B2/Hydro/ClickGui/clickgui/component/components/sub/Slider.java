...
public class Slider extends Component {
	...
	public void renderComponent() {
		...
		Client.instance.fontManager.getFont("regular 30").drawString(this.set.getDisplayName() + ": " + this.set.getValDouble() , (parent.parent.getX()* 2 + 15), (parent.parent.getY() + offset - 2) * 2 + 5, -1);
