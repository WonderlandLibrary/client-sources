...
public class TTFFontRenderer {
     ...
     */
    public int drawString(String text, double d, float y, int color) {
        return renderString(text, d, y, color, false);
    }
     ...
     * @param color  The color of the text.
     */
    private int renderString(String text, double d, float y, int color, boolean shadow) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (character == COLOR_INVOKER && i < length) {
                ...
                // Draws the character.
                drawChar(character, characterData, d, y);
     ...
     */
    private void drawChar(char character, CharacterData[] characterData, double d, float y) {
        ...
        GL11.glBegin(GL11.GL_QUADS);
        {
            ...
            GL11.glVertex2d(d, y + charData.height);
            GL11.glTexCoord2f(1, 1);
            GL11.glVertex2d(d + charData.width, y + charData.height);
            GL11.glTexCoord2f(1, 0);
            GL11.glVertex2d(d + charData.width, y);
        }
        // Ends the quad.
        GL11.glEnd();
    }
