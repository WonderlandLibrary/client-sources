...
import Hydro.util.font.MinecraftFontRenderer;
...
public class RenderUtils {
    ...
    public static void renderEntity(final Entity e, int color, final int type) {
        ...
        if (type == 1) {
            ...
            final Aura ka = (Aura) Client.instance.moduleManager.getModuleByName("Aura");
            MinecraftFontRenderer fr = FontUtil.arrayList;
