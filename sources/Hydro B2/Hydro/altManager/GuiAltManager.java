...
extends GuiScreen {
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 90: {
            	...
            	Minecraft.getMinecraft().session = new Session(Wrapper.generateRandomString(), "", "", "mojang");
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(90, width / 2 / 2 / 2, 0, 120, 20, "Random Cracked Account"));
