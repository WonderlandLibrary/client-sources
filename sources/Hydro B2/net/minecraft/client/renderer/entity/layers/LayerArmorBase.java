...
import Hydro.Client;
import Hydro.module.modules.render.CustomGlint;
        ...
        if (!Config.isCustomItems() || CustomItems.isUseGlint())
        {
            if (!Config.isShaders() || !Shaders.isShadowPass)
            {
                ...
                for (int i = 0; i < 2; ++i)
                {
                    ...
                    float f2 = 0.76F;
                    if (Client.instance.moduleManager.getModuleByName("CustomGlint").isEnabled()) {
                        Color c = Color.getHSBColor(CustomGlint.armorHue, 1.0F, 1.0F);
                        float red = c.getRed() / 255.0F;
                        float blue = c.getBlue() / 255.0F;
                        float green = c.getGreen() / 255.0F;
                        if (CustomGlint.rainbow) {
                            int col = CustomGlint.getRainbow(6000, -15);
                            float red2 = (col >> 16 & 255) / 255.0F;
                            float green2 = (col >> 8 & 255) / 255.0F;
                            float blue2 = (col & 255) / 255.0F;
                            GlStateManager.color(red2, green2, blue2, 1.0F);
                        } else GlStateManager.color(red, green, blue, 1.0F);
                    } else {
