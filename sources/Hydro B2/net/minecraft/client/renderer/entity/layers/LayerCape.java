...
public class LayerCape implements LayerRenderer
{
    ...
    public static ResourceLocation capeLoc = new ResourceLocation("Hydro/cosmetics/capes/default1.png");
    ...
    {
        if (entitylivingbaseIn.hasPlayerInfo() && !entitylivingbaseIn.isInvisible() && entitylivingbaseIn.getName().equalsIgnoreCase(Minecraft.getMinecraft().thePlayer.getName()))
        {
