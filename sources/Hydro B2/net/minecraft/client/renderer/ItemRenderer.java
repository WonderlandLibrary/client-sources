...
public class ItemRenderer
{
    ...
    {
        if(Client.settingsManager.getSettingByName("AnimationsMode").getValString().equalsIgnoreCase("Spin") && Client.moduleManager.getModuleByName("Animations").isEnabled()){
        ...
        if(Client.settingsManager.getSettingByName("AnimationsMode").getValString().equalsIgnoreCase("Exhibition") && Client.moduleManager.getModuleByName("Animations").isEnabled()){
        ...
        if(!Client.moduleManager.getModuleByName("Animations").isEnabled()){
            GlStateManager.translate(-0.5F, 0.2F, 0.0F);
            GlStateManager.rotate(30.0F, 0.0F, 1.0F, 0.0F);
            GlStateManager.rotate(-80.0F, 1.0F, 0.0F, 0.0F);
            GlStateManager.rotate(60.0F, 0.0F, 1.0F, 0.0F);
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                        if(Client.moduleManager.getModuleByName("Animations").isEnabled()){
                            if(Client.settingsManager.getSettingByName("AnimationsMode").getValString().equalsIgnoreCase("Exhibition")){
                                avatar(f, f1);
                                this.func_178103_d();
                                break;
                            }
                            if(Client.settingsManager.getSettingByName("AnimationsMode").getValString().equalsIgnoreCase("Spin")){
                                this.func_178103_d();
                                break;
                            }
                        }
