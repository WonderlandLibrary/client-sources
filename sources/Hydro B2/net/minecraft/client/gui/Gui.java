...
public class Gui
{
    ...
    public static void drawRect(int mouseX, int mouseY, double stringWidth, int i) {
    }
     ...
     */
    public static void drawRect(double d, double top, double g, double e, int color)
    {
        if (d < g)
        {
            float i = (float) d;
        ...
        worldrenderer.pos((double)g, (double)top, 0.0D).endVertex();
        worldrenderer.pos((double)d, (double)top, 0.0D).endVertex();
        tessellator.draw();
