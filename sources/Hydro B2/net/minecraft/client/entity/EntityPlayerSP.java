...
public class EntityPlayerSP extends AbstractClientPlayer {
	...
	public void onUpdate() {
		for (Hydro.module.Module m : Client.instance.moduleManager.getEnabledModules()) {
			m.onUpdate();
		}
	...
	public void onUpdateWalkingPlayer() {
		...
		EventMotion event = new EventMotion(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw,
			...
			if (CommandManager.isCommand(message)) {
				...
				if (cmd.getExecutor() != null){
				   cmd.getExecutor().execute(this, CommandManager.getArgs(message));
					...
					ChatUtils.sendMessageToPlayer(EnumChatFormatting.RED + "A" + EnumChatFormatting.BOLD + " FATAL" + EnumChatFormatting.RESET + "" + EnumChatFormatting.RED + "error has occurred!");
				}
			}else {
				ChatUtils.sendMessageToPlayer(EnumChatFormatting.RED + "Unknown Command!");
			}
		}else {
