...
public class CFont
{
    ...
    public CFont(final Font font, final boolean antiAlias, final boolean fractionalMetrics) {
        this.charData = new CharData[1104];
        this.fontHeight = -1;
        this.charOffset = 0;
        this.font = font;
    ...
    protected cdg setupTexture(final Font font, final boolean antiAlias, final boolean fractionalMetrics, final CharData[] chars) {
