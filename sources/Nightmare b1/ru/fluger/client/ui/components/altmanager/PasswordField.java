...
public class PasswordField extends bir
{
    ...
    public PasswordField(final bip par1FontRenderer, final int par2, final int par3, final int par4, final int par5) {
        this.text = "";
    ...
    public void mouseClicked(final int par1, final int par2, final int par3) {
        final boolean bl;
        final boolean var4 = bl = (par1 >= this.xPos && par1 < this.xPos + this.width && par2 >= this.yPos && par2 < this.yPos + this.height);
        ...
        if (this.isFocused && par3 == 0) {
            ...
            final String var6 = this.fontRenderer.a(this.text.substring(this.field_73816_n), this.getWidth());
            this.setCursorPosition(this.fontRenderer.a(var6, var5).length() + this.field_73816_n);
        }
    }
    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            if (this.getEnableBackgroundDrawing()) {
                RectHelper.drawRect(this.xPos, this.yPos, this.xPos + this.width, this.yPos + this.height, new Color(30, 30, 30, 185).getRGB());
                RectHelper.drawGradientRect(this.xPos, this.yPos, this.xPos + this.width, this.yPos + this.height, new Color(1, 1, 1, 255).getRGB(), new Color(5, 5, 5, 255).getRGB());
            }
            this.getClass();
            final int var1 = this.enabledColor;
            final int var2 = this.cursorPosition - this.field_73816_n;
            int var3 = this.selectionEnd - this.field_73816_n;
            final String var4 = this.fontRenderer.a(this.text.substring(this.field_73816_n), this.getWidth());
            ...
            if (var4.length() > 0) {
                ...
                var9 = bib.z().k.a(this.text.replaceAll("(?s).", "*"), (float)var7, (float)var8, var1);
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                bib.z().k.a(var4.substring(var2), (float)var9, (float)var8, var1);
            }
            if (var6) {
                if (var10) {
                    bir.a(var11, var8 - 1, var11 + 1, var8 + 1 + this.fontRenderer.a, -3092272);
                }
                else {
                    bib.z().k.a("_", (float)var11, (float)var8, var1);
                }
            }
            if (var3 != var2) {
                final int var12 = var7 + this.fontRenderer.a(var4.substring(0, var3));
                this.drawCursorVertical(var11, var8 - 1, var12 - 1, var8 + 1 + this.fontRenderer.a);
            }
        }
    }
    ...
    private void drawCursorVertical(int par1, int par2, int par3, int par4) {
        ...
        final buk var7 = var6.c();
        GL11.glColor4f(0.0f, 0.0f, 255.0f, 255.0f);
        GL11.glDisable(3553);
        GL11.glEnable(3058);
        GL11.glLogicOp(5387);
        var7.a(7, cdy.e);
        var7.b(par1, par4, 0.0).d();
        var7.b(par3, par4, 0.0).d();
        var7.b(par3, par2, 0.0).d();
        var7.b(par1, par2, 0.0).d();
        var6.b();
        GL11.glDisable(3058);
        GL11.glEnable(3553);
    }
    ...
    public void func_73800_i(int par1) {
        ...
        if (this.fontRenderer != null) {
            ...
            final String var4 = this.fontRenderer.a(this.text.substring(this.field_73816_n), var3);
            final int var5 = var4.length() + this.field_73816_n;
            if (par1 == this.field_73816_n) {
                this.field_73816_n -= this.fontRenderer.a(this.text, var3, true).length();
            }
            if (par1 > var5) {
