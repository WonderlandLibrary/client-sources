...
public class TileEntityBanner extends TileEntity
{
    ...
    public static void setBaseColorAndPatterns(final NBTTagCompound compound, final int baseColorIn, final NBTTagList patternsIn) {
    ...
    public enum EnumBannerPattern
    {
        ...
        private EnumBannerPattern(final String s, final int n, final String name, final String id) {
