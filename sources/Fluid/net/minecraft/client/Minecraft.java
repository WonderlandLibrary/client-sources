...
import fluid.client.EarlyClient;
...
import fluid.client.gui.CustomMainMenu;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(EarlyClient.display);
        try {
    ...
    private void displayDebugInfo(final long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            for (int k3 = 0; k3 < list.size(); ++k3) {
                ...
                this.fontRendererObj.drawStringWithShadow(s2 = String.valueOf(decimalformat.format(profiler$result3.field_76332_a)) + "%", (float)(j + i - 50 - this.fontRendererObj.getStringWidth(s2)), (float)(k + i / 2 + k3 * 8 + 20), profiler$result3.getColor());
                this.fontRendererObj.drawStringWithShadow(s2 = String.valueOf(decimalformat.format(profiler$result3.field_76330_b)) + "%", (float)(j + i - this.fontRendererObj.getStringWidth(s2)), (float)(k + i / 2 + k3 * 8 + 20), profiler$result3.getColor());
            }
        }
    }
    ...
    private void clickMouse() {
        if (this.leftClickCounter <= 0) {
            ...
            if (this.objectMouseOver == null) {
                ...
                if (this.playerController.isNotCreative() && !Client.INSTANCE.modManager.hitDelayFix.enabled) {
