...
public class VertexFormatElement
{
    ...
    public enum EnumType
    {
        ...
        private EnumType(final String s, final int n, final int sizeIn, final String displayNameIn, final int glConstantIn) {
            this.size = sizeIn;
    ...
    public enum EnumUsage
    {
        ...
        private EnumUsage(final String s, final int n, final String displayNameIn) {
            this.displayName = displayNameIn;
        }
