...
public class ChatController
{
    ...
    public boolean func_175984_n() {
        ...
        errorcode = this.field_153008_f.initialize((HashSet)hashset, this.field_175999_p);
        if (ErrorCode.failed(errorcode)) {
    ...
    public class ChatChannelListener implements IChatChannelListener
    {
        ...
        public boolean func_176038_a(final boolean p_176038_1_) {
            ...
            if (p_176038_1_) {
                errorcode = ChatController.this.field_153008_f.connectAnonymous(this.field_176048_a, (IChatChannelListener)this);
            }
            else {
                errorcode = ChatController.this.field_153008_f.connect(this.field_176048_a, ChatController.this.field_153004_b, ChatController.this.field_153012_j.data, (IChatChannelListener)this);
            }
            if (ErrorCode.failed(errorcode)) {
                final String s = ErrorCode.getString(errorcode);
