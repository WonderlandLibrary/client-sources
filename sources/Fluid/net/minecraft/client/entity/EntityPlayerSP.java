...
import com.darkmagician6.eventapi.events.impl.EventPost;
import net.minecraft.network.play.client.C0CPacketInput;
import net.minecraft.network.Packet;
import net.minecraft.network.play.client.C03PacketPlayer;
import com.darkmagician6.eventapi.events.Event;
import com.darkmagician6.eventapi.EventManager;
import com.darkmagician6.eventapi.events.impl.EventPre;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0, this.posZ))) {
            EventManager.call(new EventPre());
            super.onUpdate();
            if (this.isRiding()) {
            ...
            EventManager.call(new EventPost());
        }
    }
    
    public void onUpdateWalkingPlayer() {
        EventManager.call(new EventWalking());
