...
public class GuiStreamUnavailable extends GuiScreen
{
    ...
    public static void func_152321_a(final GuiScreen p_152321_0_) {
        ...
        if (!OpenGlHelper.framebufferSupported) {
            final List<ChatComponentTranslation> list = Lists.newArrayList();
    ...
    public enum Reason
    {
        ...
        private Reason(final String s, final int n, final IChatComponent p_i1067_3_, final IChatComponent p_i1067_4_) {
