...
public class GuiUtilRenderComponents
{
    ...
    public static List<IChatComponent> splitText(final IChatComponent p_178908_0_, final int p_178908_1_, final FontRenderer p_178908_2_, final boolean p_178908_3_, final boolean p_178908_4_) {
        int i = 0;
        IChatComponent ichatcomponent = new ChatComponentText("");
        final List<IChatComponent> list = Lists.newArrayList();
        final List<IChatComponent> list2 = Lists.newArrayList((Iterable)p_178908_0_);
