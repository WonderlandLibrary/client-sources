...
public class BiomeGenMutated extends BiomeGenBase
{
    ...
    public BiomeGenMutated(final int id, final BiomeGenBase biome) {
        ...
        this.spawnableCreatureList = Lists.newArrayList((Iterable)biome.spawnableCreatureList);
        this.spawnableMonsterList = Lists.newArrayList((Iterable)biome.spawnableMonsterList);
        this.spawnableCaveCreatureList = Lists.newArrayList((Iterable)biome.spawnableCaveCreatureList);
        this.spawnableWaterCreatureList = Lists.newArrayList((Iterable)biome.spawnableWaterCreatureList);
        this.temperature = biome.temperature;
        this.rainfall = biome.rainfall;
