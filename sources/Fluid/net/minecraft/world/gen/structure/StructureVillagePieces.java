        ...
        protected IBlockState func_175847_a(final IBlockState p_175847_1_) {
            if (this.isDesertVillage) {
                ...
                if (p_175847_1_.getBlock() == Blocks.oak_stairs) {
                    return Blocks.sandstone_stairs.getDefaultState().withProperty((IProperty<Comparable>)BlockStairs.FACING, (EnumFacing)p_175847_1_.getValue((IProperty<V>)BlockStairs.FACING));
                }
