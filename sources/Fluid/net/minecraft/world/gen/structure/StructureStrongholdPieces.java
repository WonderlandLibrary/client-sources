...
public class StructureStrongholdPieces
{
    ...
    public static void prepareStructurePieces() {
        ...
        PieceWeight[] pieceWeightArray;
        for (int length = (pieceWeightArray = StructureStrongholdPieces.pieceWeightArray).length, i = 0; i < length; ++i) {
            final PieceWeight structurestrongholdpieces$pieceweight = pieceWeightArray[i];
