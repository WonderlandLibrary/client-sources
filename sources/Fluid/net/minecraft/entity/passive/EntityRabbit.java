...
public class EntityRabbit extends EntityAnimal
{
    ...
    private void calculateRotationYaw(final double x, final double z) {
        this.rotationYaw = (float)(MathHelper.atan2(z - this.posZ, x - this.posX) * 180.0 / 3.141592653589793) - 90.0f;
    }
    ...
    protected void dropFewItems(final boolean wasRecentlyHit, final int lootingModifier) {
        for (int i = this.rand.nextInt(2) + this.rand.nextInt(1 + lootingModifier), j = 0; j < i; ++j) {
    ...
    enum EnumMoveType
    {
        ...
        private EnumMoveType(final String s, final int n, final float typeSpeed, final float p_i45866_4_, final int typeDuration, final int p_i45866_6_) {
    ...
    static class AIRaidFarm extends EntityAIMoveToBlock
    {
        ...
        public void updateTask() {
            ...
            if (this.getIsAboveDestination()) {
                final World world = this.rabbit.worldObj;
