...
public enum EnumParticleTypes
{
    ...
    private EnumParticleTypes(final String s, final int n, final String particleNameIn, final int particleIDIn, final boolean p_i46011_5_, final int argumentCountIn) {
