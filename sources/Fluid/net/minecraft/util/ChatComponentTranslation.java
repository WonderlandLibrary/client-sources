...
public class ChatComponentTranslation extends ChatComponentStyle
{
    ...
    public Iterator<IChatComponent> iterator() {
        ...
        return Iterators.concat((Iterator)ChatComponentStyle.createDeepCopyIterator(this.children), (Iterator)ChatComponentStyle.createDeepCopyIterator(this.siblings));
    }
