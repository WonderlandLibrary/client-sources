...
public enum EnumChatFormatting
{
    ...
    private EnumChatFormatting(final String s, final int n, final String formattingName, final char formattingCodeIn, final boolean fancyStylingIn, final int colorIndex) {
