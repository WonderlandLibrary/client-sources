...
public class ItemArmor extends Item
{
    ...
    static {
        ...
        dispenserBehavior = new BehaviorDefaultDispenseItem() {
            ...
            protected ItemStack dispenseStack(final IBlockSource source, final ItemStack stack) {
                ...
                final List<EntityLivingBase> list = source.getWorld().getEntitiesWithinAABB((Class<? extends EntityLivingBase>)EntityLivingBase.class, axisalignedbb, (com.google.common.base.Predicate<? super EntityLivingBase>)Predicates.and((Predicate)EntitySelectors.NOT_SPECTATING, (Predicate)new EntitySelectors.ArmoredMob(stack)));
                if (list.size() > 0) {
    ...
    public enum ArmorMaterial
    {
        ...
        private ArmorMaterial(final String s, final int n, final String name, final int maxDamage, final int[] reductionAmounts, final int enchantability) {
            this.name = name;
