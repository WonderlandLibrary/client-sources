...
public class ItemFishFood extends ItemFood
{
    ...
    public enum FishType
    {
        ...
        private FishType(final String s, final int n, final int meta, final String unlocalizedName, final int uncookedHeal, final float uncookedSaturation, final int cookedHeal, final float cookedSaturation) {
            this.cookable = false;
            this.meta = meta;
        ...
        private FishType(final String s, final int n, final int meta, final String unlocalizedName, final int uncookedHeal, final float uncookedSaturation) {
            this.cookable = false;
            this.meta = meta;
            this.unlocalizedName = unlocalizedName;
            this.uncookedHealAmount = uncookedHeal;
