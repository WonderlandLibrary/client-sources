 ...
 */
package io.github.raze.version.gui;

import com.viaversion.viaversion.api.protocol.version.ProtocolVersion;
import io.github.raze.version.base.ViaLoadingBase;
import io.github.raze.version.protocolinfo.ProtocolInfo;
...
public class GuiProtocolSelector extends GuiScreen {
    ...
    public GuiProtocolSelector(GuiScreen parent) { this.parent = parent; }
    ...
    class SlotList extends GuiSlot {
        ...
        @Override
        protected int getSize() { return ViaLoadingBase.getProtocols().size(); }
        ...
        @Override
        protected void drawBackground() { drawDefaultBackground(); }

        @Override
        protected void drawSlot(int i, int i1, int i2, int i3, int i4, int i5) {
            drawCenteredString(mc.fontRenderer,(ViaLoadingBase.getInstance().getTargetVersion().getIndex() == i ? EnumChatFormatting.GREEN.toString() + EnumChatFormatting.BOLD : EnumChatFormatting.GRAY.toString()) + ViaLoadingBase.getProtocols().get(i).getName(), width / 2, i2 + 2, -1);
            GlStateManager.pushMatrix();
            GlStateManager.scale(0.5, 0.5, 0.5);
            drawCenteredString(mc.fontRenderer, "PVN: " + ViaLoadingBase.getProtocols().get(i).getVersion(), width, (i2 + 2) * 2 + 20, -1);
            GlStateManager.popMatrix();
        }
    }
}
