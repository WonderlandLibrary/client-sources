 ...
 */
package io.github.raze.version.base;
...
import io.github.raze.version.base.model.ComparableProtocolVersion;
import io.github.raze.version.base.model.Platform;
import io.github.raze.version.base.platform.ViaBackwardsPlatformImpl;
import io.github.raze.version.base.platform.ViaRewindPlatformImpl;
import io.github.raze.version.base.platform.ViaVersionPlatformImpl;
import io.github.raze.version.base.platform.viaversion.VLBViaCommandHandler;
import io.github.raze.version.base.platform.viaversion.VLBViaInjector;
import io.github.raze.version.base.platform.viaversion.VLBViaProviders;
import io.github.raze.version.base.util.JLoggerToLog4j;
...
public class ViaLoadingBase {
    ...
    public void reload(final ProtocolVersion protocolVersion) { reload(fromProtocolVersion(protocolVersion)); }
    ...
    public static ViaLoadingBase getInstance() { return instance; }

    public List<Platform> getSubPlatforms() { return platforms; }

    public File getRunDirectory() { return runDirectory; }

    public int getNativeVersion() { return nativeVersion; }

    public Supplier<JsonObject> getDumpSupplier() { return dumpSupplier; }

    public Consumer<ViaProviders> getProviders() { return providers; }
    ...
    public static List<ProtocolVersion> getProtocols() { return new LinkedList<>(PROTOCOLS.keySet()); }
