...
public enum CFontUtil {
    ...
    Jello_Light_18 ("Jello Light 18", new CFontRenderer(new ResourceLocation("raze/fonts/Jello-Light.ttf"), 18)),
    ...
    Jello_Regular_18 ("Jello Regular 18", new CFontRenderer(new ResourceLocation("raze/fonts/Jello-Regular.ttf"), 18)),
    ...
    Jello_Regular_36 ("Jello Regular 36", new CFontRenderer(new ResourceLocation("raze/fonts/Jello-Regular.ttf"), 36)),
    ...
    Jello_Medium_18 ("Jello Medium 18", new CFontRenderer(new ResourceLocation("raze/fonts/Jello-Medium.ttf"), 18)),
