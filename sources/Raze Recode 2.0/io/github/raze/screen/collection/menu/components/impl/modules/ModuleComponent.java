...
public class ModuleComponent extends BaseComponent {
    ...
    public ModuleComponent(AbstractModule module, CategoryComponent parent, double x, double y, double width, double height, int index) {
        this.module = module;
        this.parent = parent;
        this.x = x;
        this.y = y;
        ...
        this.height = height;
        this.index = index;
        this.list = Raze.INSTANCE.managerRegistry.settingRegistry.getSettingsByModule(module);
    }
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.rectangle(
                ...
                getWidth(),
                getHeight(),
                module.isEnabled() ? Raze.INSTANCE.managerRegistry.themeRegistry.getCurrentTheme().getAccent()
                                   : Raze.INSTANCE.managerRegistry.themeRegistry.getCurrentTheme().getBackground()
        );
        ...
        CFontUtil.Jello_Light_20.getRenderer().drawString(
                ...
                module.isEnabled() ? Raze.INSTANCE.managerRegistry.themeRegistry.getCurrentTheme().getBackground()
        ...
        if (MouseUtil.isInside(mouseX, mouseY, x, y, width, height)) {
            switch (mouseButton) {
                ...
                case 1: {
                    ...
                    mc.displayGuiScreen(new UISettingManager(Raze.INSTANCE.screenRegistry.uiModuleManager, module));
                    break;
                }
                case 2: {
                    setBinding(true);
