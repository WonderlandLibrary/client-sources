...
public class S27PacketExplosion implements Packet<INetHandlerPlayClient>
{
    ...
    public S27PacketExplosion(double p_i45193_1_, double y, double z, float strengthIn, List<BlockPosition> affectedBlocksIn, Vec3 p_i45193_9_)
    {
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        int i = buf.readInt();
        this.affectedBlockPositions = Lists.<BlockPosition>newArrayListWithCapacity(i);
        int j = (int)this.posX;
        int k = (int)this.posY;
        int l = (int)this.posZ;
