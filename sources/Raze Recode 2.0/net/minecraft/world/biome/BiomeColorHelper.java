...
public class BiomeColorHelper
{
    ...
    {
        public int getColorAtPos(BiomeGenBase biome, BlockPosition blockPosition)
        {
    ...
    private static int getColorAtPos(IBlockAccess blockAccess, BlockPosition pos, BiomeColorHelper.ColorResolver colorResolver)
    {
        int i = 0;
        int j = 0;
        int k = 0;

        for (BlockPosition.MutableBlockPosition blockpos$mutableblockpos : BlockPosition.getAllInBoxMutable(pos.add(-1, 0, -1), pos.add(1, 0, 1)))
        {
    ...
    public static int getGrassColorAtPos(IBlockAccess p_180286_0_, BlockPosition p_180286_1_)
    {
        return getColorAtPos(p_180286_0_, p_180286_1_, GRASS_COLOR);
    }

    public static int getFoliageColorAtPos(IBlockAccess p_180287_0_, BlockPosition p_180287_1_)
    {
        return getColorAtPos(p_180287_0_, p_180287_1_, FOLIAGE_COLOR);
    }

    public static int getWaterColorAtPos(IBlockAccess p_180288_0_, BlockPosition p_180288_1_)
    {
    ...
    {
        int getColorAtPos(BiomeGenBase biome, BlockPosition blockPosition);
    }
}
