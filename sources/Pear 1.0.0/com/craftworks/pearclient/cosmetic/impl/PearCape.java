...
public class PearCape implements LayerRenderer<AbstractClientPlayer> {
    private final RenderPlayer playerRenderer;
    public static Animated CAPEANIMATED = new Animated("pearclient/cape/pearcape", 1, 1);

    public PearCape(RenderPlayer playerRendererIn) {
