package com.craftworks.pearclient.nofication;
...
public class Notification {
    ...
    public void render() {
        ...
        GlyphPageFontRenderer fontRenderer = GlyphPageFontRenderer.create("Roboto", 15, false, false, false);

        GLDraw.drawRoundedRect((float)(GuiScreen.width - offset - 5), (float)(GuiScreen.height - 10 - height), GuiScreen.width + 10, GuiScreen.height - 5, 4, color.getRGB());
        GLDraw.drawRoundedOutline((float)(GuiScreen.width - offset - 5), (float)(GuiScreen.height - 10 - height), (float)(GuiScreen.width + 10), (float)(GuiScreen.height - 5), 4.0f, 2.0f, color1.getRGB());

        fontRenderer.drawString(title, (int) (GuiScreen.width - offset + 4), GuiScreen.height - 2 - height, -1, false);
        fontRenderer.drawString(messsage, (int) (GuiScreen.width - offset + 4), GuiScreen.height - 18, -1, false);
    }
