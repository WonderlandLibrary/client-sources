...
public class EntityEnderman extends EntityMob {
   ...
   public EntityEnderman(World worldIn) {
      ...
      this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityEndermite.class, 10, true, false, new 1(this)));
   }
   ...
   // $FF: synthetic method
   static boolean access$100(EntityEnderman x0, EntityPlayer x1) {
   ...
   // $FF: synthetic method
   static boolean access$202(EntityEnderman x0, boolean x1) {
      return x0.isAggressive = x1;
   }
