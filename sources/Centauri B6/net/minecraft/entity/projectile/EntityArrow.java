...
public class EntityArrow extends Entity implements IProjectile {
   ...
   public void setVelocity(double x, double y, double z) {
      ...
      if(this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
         ...
         this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.func_181159_b(x, z) * 180.0D / 3.141592653589793D);
         this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.func_181159_b(y, (double)f) * 180.0D / 3.141592653589793D);
   ...
   public void onUpdate() {
      ...
      if(this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
         ...
         this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.func_181159_b(this.motionY, (double)f) * 180.0D / 3.141592653589793D);
      }
      ...
      if(this.inGround) {
         ...
         for(this.rotationPitch = (float)(MathHelper.func_181159_b(this.motionY, (double)f3) * 180.0D / 3.141592653589793D); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
            ;
         }
   ...
   public void setThrowableHeading(double x, double y, double z, float velocity, float inaccuracy) {
      ...
      this.prevRotationYaw = this.rotationYaw = (float)(MathHelper.func_181159_b(x, z) * 180.0D / 3.141592653589793D);
      this.prevRotationPitch = this.rotationPitch = (float)(MathHelper.func_181159_b(y, (double)f1) * 180.0D / 3.141592653589793D);
      this.ticksInGround = 0;
   }
