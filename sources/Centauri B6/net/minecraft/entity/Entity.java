...
public abstract class Entity implements ICommandSender {
   ...
   public void moveEntity(double x, double y, double z) {
      if(this.noClip) {
         ...
         if(this.isInWeb) {
            this.isInWeb = false;
            float noSlowDown = ((EventSlowdown)(new EventSlowdown(EventSlowdown$Cause.CobWeb)).fire()).getNoSlowDown();
            x *= 0.25D + 0.75D * (double)noSlowDown;
            y *= 0.05000000074505806D;
            z *= 0.25D + 0.75D * (double)noSlowDown;
            this.motionX = 0.0D;
            this.motionY = 0.0D;
            this.motionZ = 0.0D;
         }
         ...
         double d4 = y;
         double d5 = z;
         boolean flag = this.onGround && this instanceof EntityPlayer && (this.isSneaking() || AC.getModuleManager().get(ModuleSafeWalk.class).isEnabled() || AC.getModuleManager().get(ModuleScaffold.class).isEnabled());
         if(flag) {
            double d6;
         ...
         if(this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
            ...
            } else if(y >= -0.4D && y <= 0.0D && this.onGround) {
               (new EventStep((double)this.stepHeight + y)).fire();
            }
         }
   ...
   public void func_181015_d(BlockPos p_181015_1_) {
      if(this.timeUntilPortal > 0) {
         ...
         if(!this.worldObj.isRemote && !p_181015_1_.equals(this.field_181016_an)) {
            ...
            PatternHelper blockpattern$patternhelper = Blocks.portal.func_181089_f(this.worldObj, p_181015_1_);
   ...
   public void setVelocity(double x, double y, double z) {
      EventVelocity event = (EventVelocity)(new EventVelocity(this, x, y, z)).fire();
   ...
   public boolean isInvisible() {
      return this.getFlag(5) && (AC.isGhost() || !AC.getModuleManager().get(ModuleTrueSight.class).isEnabled() || ((Boolean)((ModuleTrueSight)AC.getModuleManager().get(ModuleTrueSight.class)).SemiInvisible.value).booleanValue());
   }
   ...
   public void addEntityCrashInfo(CrashReportCategory category) {
      category.addCrashSectionCallable("Entity Type", new 1(this));
      category.addCrashSection("Entity ID", Integer.valueOf(this.entityId));
      category.addCrashSectionCallable("Entity Name", new 2(this));
      ...
      category.addCrashSectionCallable("Entity\'s Rider", new 3(this));
      category.addCrashSectionCallable("Entity\'s Vehicle", new 4(this));
   }
