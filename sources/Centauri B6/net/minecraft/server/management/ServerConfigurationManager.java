...
public abstract class ServerConfigurationManager {
   ...
   public void onTick() {
      if(++this.playerPingIndex > 600) {
         this.sendPacketToAllPlayers(new S38PacketPlayerListItem(Action.UPDATE_LATENCY, this.playerEntityList));
   ...
   public void updateTimeAndWeatherForPlayer(EntityPlayerMP playerIn, WorldServer worldIn) {
      ...
      playerIn.playerNetServerHandler.sendPacket(new S44PacketWorldBorder(worldborder, net.minecraft.network.play.server.S44PacketWorldBorder.Action.INITIALIZE));
   ...
   public void playerLoggedIn(EntityPlayerMP playerIn) {
      ...
      this.sendPacketToAllPlayers(new S38PacketPlayerListItem(Action.ADD_PLAYER, new EntityPlayerMP[]{playerIn}));
      WorldServer worldserver = this.mcServer.worldServerForDimension(playerIn.dimension);
      ...
      for(int i = 0; i < this.playerEntityList.size(); ++i) {
         EntityPlayerMP entityplayermp = (EntityPlayerMP)this.playerEntityList.get(i);
         playerIn.playerNetServerHandler.sendPacket(new S38PacketPlayerListItem(Action.ADD_PLAYER, new EntityPlayerMP[]{entityplayermp}));
      }
   ...
   public void playerLoggedOut(EntityPlayerMP playerIn) {
      ...
      this.sendPacketToAllPlayers(new S38PacketPlayerListItem(Action.REMOVE_PLAYER, new EntityPlayerMP[]{playerIn}));
   }
   ...
   public void setPlayerManager(WorldServer[] worldServers) {
      ...
      worldServers[0].getWorldBorder().addListener(new 1(this));
   }
