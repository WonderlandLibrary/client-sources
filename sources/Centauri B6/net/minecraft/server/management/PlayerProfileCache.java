...
public class PlayerProfileCache {
   ...
   private static GameProfile getGameProfile(MinecraftServer server, String username) {
      ...
      ProfileLookupCallback profilelookupcallback = new 2(agameprofile);
         ...
         if(p_deserialize_1_.isJsonObject()) {
            ...
            if(jsonelement != null && jsonelement1 != null) {
               ...
               if(s1 != null && s != null) {
                  ...
                  PlayerProfileCache.ProfileEntry playerprofilecache$profileentry = var10002.new ProfileEntry(new GameProfile(uuid, s1), date);
                  return playerprofilecache$profileentry;
               } else {
                  return null;
               }
