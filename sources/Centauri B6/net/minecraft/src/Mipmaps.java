...
public class Mipmaps {
   ...
   public Mipmaps(String p_i59_1_, int p_i59_2_, int p_i59_3_, int[] p_i59_4_, boolean p_i59_5_) {
      this.iconName = p_i59_1_;
      this.width = p_i59_2_;
      this.height = p_i59_3_;
      this.data = p_i59_4_;
      this.direct = p_i59_5_;
      this.mipmapDimensions = makeMipmapDimensions(p_i59_2_, p_i59_3_, p_i59_1_);
      this.mipmapDatas = generateMipMapData(p_i59_4_, p_i59_2_, p_i59_3_, this.mipmapDimensions);
      if(p_i59_5_) {
   ...
   public static Dimension[] makeMipmapDimensions(int p_makeMipmapDimensions_0_, int p_makeMipmapDimensions_1_, String p_makeMipmapDimensions_2_) {
      ...
      if(i == p_makeMipmapDimensions_0_ && j == p_makeMipmapDimensions_1_) {
         ...
         while(true) {
            ...
            l /= 2;
            if(k <= 0 && l <= 0) {
               Dimension[] adimension = (Dimension[])((Dimension[])((Dimension[])list.toArray(new Dimension[list.size()])));
               return adimension;
            }
   ...
   public static void allocateMipmapTextures(int p_allocateMipmapTextures_0_, int p_allocateMipmapTextures_1_, String p_allocateMipmapTextures_2_) {
      ...
      for(int i = 0; i < adimension.length; ++i) {
         ...
         int l = i + 1;
         GL11.glTexImage2D(3553, l, 6408, j, k, 0, '胡', '荧', (IntBuffer)null);
      }
