...
public class NaturalProperties {
   ...
   public NaturalProperties(String p_i61_1_) {
      if(p_i61_1_.equals("4")) {
         this.rotation = 4;
      } else if(p_i61_1_.equals("2")) {
         this.rotation = 2;
      } else if(p_i61_1_.equals("F")) {
         this.flip = true;
      } else if(p_i61_1_.equals("4F")) {
         this.rotation = 4;
         this.flip = true;
      } else if(p_i61_1_.equals("2F")) {
         this.rotation = 2;
         this.flip = true;
      } else {
         Config.warn("NaturalTextures: Unknown type: " + p_i61_1_);
      }
   ...
   private int[] transformVertexData(int[] p_transformVertexData_1_, int p_transformVertexData_2_, boolean p_transformVertexData_3_) {
      int[] aint = (int[])((int[])p_transformVertexData_1_.clone());
