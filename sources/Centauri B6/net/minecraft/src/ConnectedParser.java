...
public class ConnectedParser {
   ...
   public static Comparable parseValue(String p_parseValue_0_, Class p_parseValue_1_) {
      return (Comparable)((Comparable)(p_parseValue_1_ == String.class?p_parseValue_0_:(p_parseValue_1_ == Boolean.class?Boolean.valueOf(p_parseValue_0_):Double.valueOf(p_parseValue_1_ == Float.class?(double)Float.valueOf(p_parseValue_0_).floatValue():(p_parseValue_1_ == Double.class?Double.valueOf(p_parseValue_0_).doubleValue():(double)(p_parseValue_1_ == Integer.class?(long)Integer.valueOf(p_parseValue_0_).intValue():(p_parseValue_1_ == Long.class?Long.valueOf(p_parseValue_0_):null).longValue()))))));
   }
