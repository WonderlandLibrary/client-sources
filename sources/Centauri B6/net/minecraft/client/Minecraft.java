...
import net.minecraft.client.Minecraft.17;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
   ...
   private static final ResourceLocation locationACSplashPng = new ResourceLocation("alphacentauri/splash.png");
   ...
   public String getVersion() {
      return AC.isGhost()?"1.8.9-OptiFine_HD_U_H6":this.launchedVersion;
   }
   ...
   public void runTick() throws IOException {
      ...
      if(this.currentScreen != null) {
         ...
         if(this.currentScreen != null) {
            try {
               ...
               crashreportcategory1.addCrashSectionCallable("Screen name", new 4(this));
      ...
      if(this.currentScreen == null || this.currentScreen.allowUserInput) {
         ...
         AC.getKeyBindManager().preMouse();

         while(Mouse.next()) {
            int i = Mouse.getEventButton();
            AC.getKeyBindManager().updateMouseButton(i - 100);
   ...
   public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
      if(worldClientIn == null) {
         ...
         (new EventWorldChanged(worldClientIn)).fire();
      }
   ...
   public void clickMouse() {
      ...
      if(this.leftClickCounter <= 0) {
         ...
         if(this.objectMouseOver == null) {
            ...
            switch(18.$SwitchMap$net$minecraft$util$MovingObjectPosition$MovingObjectType[this.objectMouseOver.typeOfHit.ordinal()]) {
            case 1:
               if(!((EventAttack)(new EventAttack(this.objectMouseOver.entityHit, true)).fire()).isCancelled()) {
   ...
   private void createDisplay() throws LWJGLException {
      ...
      Display.setTitle(AC.isGhost()?"Minecraft 1.8.9":"Alpha Centauri " + AC.getVersion());
   ...
   private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException {
      ...
      if(AC.isGhost()) {
         try {
            ...
            logger.error("Unable to load logo: " + locationMojangPng, var17);
         } finally {
            IOUtils.closeQuietly(inputstream);
         }
      } else {
         textureManagerInstance.bindTexture(locationACSplashPng);
      }
      ...
      if(AC.isGhost()) {
         ...
         worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
         worldrenderer.pos(0.0D, (double)height, 0.0D).tex(0.0D, (double)((float)height / y + (float)tint)).color(255, 255, 255, 255).endVertex();
         worldrenderer.pos((double)width, (double)height, 0.0D).tex((double)((float)width / x), (double)((float)height / y + (float)tint)).color(255, 255, 255, 255).endVertex();
         worldrenderer.pos((double)width, 0.0D, 0.0D).tex((double)((float)width / x), (double)tint).color(255, 255, 255, 255).endVertex();
         worldrenderer.pos(0.0D, 0.0D, 0.0D).tex(0.0D, (double)tint).color(255, 255, 255, 255).endVertex();
         tessellator.draw();
      }
   ...
   public void refreshResources() {
      ...
      try {
         ...
         this.gameSettings.resourcePackNames.clear();
         this.gameSettings.saveOptions();
      }
      ...
      if(this.mcProfiler.profilingEnabled) {
         ...
         for(int l = 0; l < list.size(); ++l) {
            ...
            for(int j2 = i1; j2 >= 0; --j2) {
               float f = (float)((d0 + profiler$result1.field_76332_a * (double)j2 / (double)i1) * 3.141592653589793D * 2.0D / 100.0D);
            ...
            for(int i3 = i1; i3 >= 0; --i3) {
               float f3 = (float)((d0 + profiler$result1.field_76332_a * (double)i3 / (double)i1) * 3.141592653589793D * 2.0D / 100.0D);
   ...
   private void middleClickMouse() {
      if(!((EventMiddleClick)(new EventMiddleClick()).fire()).isCancelled()) {
         if(this.objectMouseOver != null) {
            ...
            if(this.objectMouseOver.typeOfHit == MovingObjectType.BLOCK) {
               ...
               if(this.objectMouseOver.entityHit instanceof EntityPainting) {
                  ...
                  switch(18.$SwitchMap$net$minecraft$entity$item$EntityMinecart$EnumMinecartType[entityminecart.getMinecartType().ordinal()]) {
                  case 1:
   ...
   public void setServerData(ServerData serverDataIn) {
      ...
      if(serverDataIn != null) {
         this.lastServerData = serverDataIn;
      }
   ...
   public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash) {
      ...
      theCrash.getCategory().addCrashSectionCallable("Using VBOs", new 9(this));
      theCrash.getCategory().addCrashSectionCallable("Is Modded", new 10(this));
      theCrash.getCategory().addCrashSectionCallable("Type", new 11(this));
      theCrash.getCategory().addCrashSectionCallable("Resource Packs", new 12(this));
      theCrash.getCategory().addCrashSectionCallable("Current Language", new 13(this));
      theCrash.getCategory().addCrashSectionCallable("Profiler Position", new 14(this));
      theCrash.getCategory().addCrashSectionCallable("CPU", new 15(this));
      if(this.theWorld != null) {
   ...
   public ListenableFuture scheduleResourcesRefresh() {
      return this.addScheduledTask((Runnable)(new 16(this)));
   }
   ...
   public static int getGLMaximumTextureSize() {
      for(int i = 16384; i > 0; i >>= 1) {
         GL11.glTexImage2D('聤', 0, 6408, i, i, 0, 6408, 5121, (ByteBuffer)null);
         ...
         if(Keyboard.getEventKeyState()) {
            if(i == this.gameSettings.keyBindStreamStartStop.getKeyCode()) {
               if(this.getTwitchStream().isBroadcasting()) {
                  ...
                  this.displayGuiScreen(new GuiYesNo(new 17(this), I18n.format("stream.confirm_start", new Object[0]), "", 0));
            ...
            } else if(i == this.gameSettings.keyBindStreamCommercial.getKeyCode()) {
               if(this.getTwitchStream().isBroadcasting()) {
   ...
   public void addServerTypeToSnooper(PlayerUsageSnooper playerSnooper) {
      ...
      playerSnooper.addStatToSnooper("gl_caps[gl_max_vertex_uniforms]", Integer.valueOf(GL11.glGetInteger('譊')));
      GL11.glGetError();
      playerSnooper.addStatToSnooper("gl_caps[gl_max_fragment_uniforms]", Integer.valueOf(GL11.glGetInteger('證')));
      GL11.glGetError();
      playerSnooper.addStatToSnooper("gl_caps[gl_max_vertex_attribs]", Integer.valueOf(GL11.glGetInteger('衩')));
      GL11.glGetError();
      playerSnooper.addStatToSnooper("gl_caps[gl_max_vertex_texture_image_units]", Integer.valueOf(GL11.glGetInteger('譌')));
      GL11.glGetError();
