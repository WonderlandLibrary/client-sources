...
public class WorldClient extends World {
   ...
   // $FF: synthetic method
   static Set access$100(WorldClient x0) {
      return x0.entitySpawnQueue;
   }

   // $FF: synthetic method
   static Minecraft access$200(WorldClient x0) {
      return x0.mc;
   }

   // $FF: synthetic method
   static Set access$000(WorldClient x0) {
   ...
   public CrashReportCategory addWorldInfoToCrashReport(CrashReport report) {
      ...
      crashreportcategory.addCrashSectionCallable("Forced entities", new 1(this));
      crashreportcategory.addCrashSectionCallable("Retry entities", new 2(this));
      crashreportcategory.addCrashSectionCallable("Server brand", new 3(this));
      crashreportcategory.addCrashSectionCallable("Server type", new 4(this));
   ...
   public void doVoidFogParticles(int p_73029_1_, int p_73029_2_, int p_73029_3_) {
      ...
      boolean flag = this.mc.playerController.getCurrentGameType() == GameType.CREATIVE && itemstack != null && Block.getBlockFromItem(itemstack.getItem()) == Blocks.barrier || ((ModuleTrueSight)AC.getModuleManager().get(ModuleTrueSight.class)).shouldShowBarriers();
