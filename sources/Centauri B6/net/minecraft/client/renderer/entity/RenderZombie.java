...
public class RenderZombie extends RenderBiped {
   ...
   private final ArrayList field_177121_n;
   private final ArrayList field_177122_o;
   ...
   protected void rotateCorpse(EntityZombie bat, float p_77043_2_, float p_77043_3_, float partialTicks) {
      if(bat.isConverting()) {
         p_77043_3_ += (float)(Math.cos((double)bat.ticksExisted * 3.25D) * 3.141592653589793D * 0.25D);
      }
