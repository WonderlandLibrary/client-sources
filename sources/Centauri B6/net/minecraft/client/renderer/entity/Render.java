...
public abstract class Render {
   ...
   protected void renderLivingLabel(Entity entityIn, String str, double x, double y, double z, int maxDistance) {
      ...
      if(d0 <= (double)(maxDistance * maxDistance)) {
         if(AC.getModuleManager().get(ModuleNameTags.class).isEnabled() && entityIn instanceof EntityPlayer && !(entityIn instanceof EntityPlayerSP) && !AC.isGhost()) {
            ((ModuleNameTags)AC.getModuleManager().get(ModuleNameTags.class)).renderNameTag((EntityPlayer)entityIn, str, x, y, z);
         } else {
