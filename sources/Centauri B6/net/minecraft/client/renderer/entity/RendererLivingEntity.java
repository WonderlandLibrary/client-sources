...
import net.minecraft.client.renderer.entity.RendererLivingEntity.RendererLivingEntity.1;
      ...
      if(!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, new Object[]{entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)})) {
         if(this.canRenderName(entity)) {
            ...
            if(d0 < (double)(f * f)) {
               ...
               GlStateManager.alphaFunc(516, 0.1F);
               if(entity.isSneaking() && (!AC.getModuleManager().get(ModuleNameTags.class).isEnabled() || AC.isGhost())) {
   ...
   protected boolean canRenderName(EntityLivingBase entity) {
      ...
      if(entity instanceof EntityPlayer && entity != entityplayersp) {
         ...
         if(team != null) {
            ...
            switch(1.field_178679_a[team$enumvisible.ordinal()]) {
            case 1:
               return true;
            case 2:
               return false;
