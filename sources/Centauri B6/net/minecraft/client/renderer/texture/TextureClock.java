   ...
   public void updateAnimation() {
      if(!this.framesTextureData.isEmpty()) {
         ...
         if(i != this.frameCounter) {
            this.frameCounter = i;
            if(Config.isShaders()) {
               ShadersTex.uploadTexSub((int[][])((int[][])((int[][])this.framesTextureData.get(this.frameCounter))), this.width, this.height, this.originX, this.originY, false, false);
            } else {
               TextureUtil.uploadTextureMipmap((int[][])((int[][])((int[][])this.framesTextureData.get(this.frameCounter))), this.width, this.height, this.originX, this.originY, false, false);
            }
         }
      }
