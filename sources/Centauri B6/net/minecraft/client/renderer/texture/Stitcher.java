...
public class Stitcher {
   ...
   public Stitcher(int maxTextureWidth, int maxTextureHeight, boolean forcePowerOf2, int maxTileDimension, int mipmapLevel) {
   ...
   public List getStichSlots() {
      ArrayList<Stitcher.Slot> arraylist = Lists.newArrayList();
      ...
      for(Stitcher.Slot stitcher$slot1 : arraylist) {
   ...
   public void doStitch() {
      Stitcher.Holder[] astitcher$holder = (Stitcher.Holder[])((Stitcher.Holder[])((Stitcher.Holder[])this.setStitchHolders.toArray(new Stitcher.Holder[this.setStitchHolders.size()])));
