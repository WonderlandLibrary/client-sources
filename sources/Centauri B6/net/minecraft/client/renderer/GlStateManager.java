...
public class GlStateManager {
   private static GlStateManager.AlphaState alphaState = new GlStateManager.AlphaState((1)null);
   ...
   private static GlStateManager.ColorMaterialState colorMaterialState = new GlStateManager.ColorMaterialState((1)null);
   private static GlStateManager.BlendState blendState = new GlStateManager.BlendState((1)null);
   private static GlStateManager.DepthState depthState = new GlStateManager.DepthState((1)null);
   private static GlStateManager.FogState fogState = new GlStateManager.FogState((1)null);
   private static GlStateManager.CullState cullState = new GlStateManager.CullState((1)null);
   private static GlStateManager.PolygonOffsetState polygonOffsetState = new GlStateManager.PolygonOffsetState((1)null);
   private static GlStateManager.ColorLogicState colorLogicState = new GlStateManager.ColorLogicState((1)null);
   private static GlStateManager.TexGenState texGenState = new GlStateManager.TexGenState((1)null);
   private static GlStateManager.ClearState clearState = new GlStateManager.ClearState((1)null);
   private static GlStateManager.StencilState stencilState = new GlStateManager.StencilState((1)null);
   ...
   private static GlStateManager.BooleanState rescaleNormalState = new GlStateManager.BooleanState('耺');
   private static GlStateManager.ColorMask colorMaskState = new GlStateManager.ColorMask((1)null);
   ...
   static {
      ...
      for(int j = 0; j < textureState.length; ++j) {
         textureState[j] = new GlStateManager.TextureState((1)null);
      }
   ...
   public static void checkBoundTexture() {
      if(Config.isMinecraftThread()) {
         int i = GL11.glGetInteger('蓠');
         int j = GL11.glGetInteger('聩');
   ...
   private static GlStateManager.TexGenCoord texGenCoord(TexGen p_179125_0_) {
   ...
   static class ColorMaterialState {
      ...
      ColorMaterialState(1 p_i46484_1_) {
         this();
      }
   }
   ...
   static class PolygonOffsetState {
      ...
      PolygonOffsetState(1 p_i46480_1_) {
         this();
      }
   }
   ...
   static class StencilState {
      ...
      private StencilState() {
         this.field_179078_a = new GlStateManager.StencilFunc((1)null);
