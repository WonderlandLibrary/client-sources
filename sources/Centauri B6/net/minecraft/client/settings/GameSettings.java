...
public class GameSettings {
   ...
   public List resourcePackNames = Lists.newArrayList();
   ...
   private final Set mapSoundLevels = Sets.newHashSet(EnumPlayerModelParts.values());
   ...
   public KeyBinding keyBindStreamCommercial = new KeyBinding("key.streamCommercial", 0, "key.categories.stream");
   ...
   public GameSettings(Minecraft mcIn, File p_i46326_2_) {
      ...
      this.logger = false;
      this.mc = mcIn;
      this.file = new File(p_i46326_2_, "options.txt");
   ...
   public void saveOptions() {
      ...
      try {
         ...
         fileBuilder.append("invertYMouse:" + this.invertMouse).append('\n');
         fileBuilder.append("mouseSensitivity:" + this.mouseSensitivity).append('\n');
         fileBuilder.append("fov:" + (this.gammaSetting - 70.0F) / 40.0F).append('\n');
         fileBuilder.append("gamma:" + this.saturation).append('\n');
         fileBuilder.append("saturation:" + this.guiScale).append('\n');
         fileBuilder.append("renderDistance:" + this.renderDistanceChunks).append('\n');
         fileBuilder.append("guiScale:" + this.particleSetting).append('\n');
         fileBuilder.append("particles:" + this.language).append('\n');
         fileBuilder.append("bobView:" + this.viewBobbing).append('\n');
         fileBuilder.append("anaglyph3d:" + this.anaglyph).append('\n');
         fileBuilder.append("maxFps:" + this.limitFramerate).append('\n');
         fileBuilder.append("fboEnable:" + this.fboEnable).append('\n');
         fileBuilder.append("difficulty:" + this.difficulty.getDifficultyId()).append('\n');
         fileBuilder.append("fancyGraphics:" + this.fancyGraphics).append('\n');
         fileBuilder.append("ao:" + this.ambientOcclusion).append('\n');
         switch(this.clouds) {
         case 0:
            fileBuilder.append("renderClouds:false").append('\n');
            break;
         case 1:
            fileBuilder.append("renderClouds:fast").append('\n');
            break;
         case 2:
            fileBuilder.append("renderClouds:true").append('\n');
         }

         fileBuilder.append("resourcePacks:" + typeListString.toJson(this.resourcePacks)).append('\n');
         fileBuilder.append("incompatibleResourcePacks:" + typeListString.toJson(this.resourcePackNames)).append('\n');
         fileBuilder.append("lastServer:" + this.smoothCamera).append('\n');
         fileBuilder.append("lang:" + this.forceUnicodeFont).append('\n');
         fileBuilder.append("chatVisibility:" + this.chatVisibility.getChatVisibility()).append('\n');
         fileBuilder.append("chatColors:" + this.chatColours).append('\n');
         fileBuilder.append("chatLinks:" + this.chatLinks).append('\n');
         fileBuilder.append("chatLinksPrompt:" + this.chatLinksPrompt).append('\n');
         fileBuilder.append("chatOpacity:" + this.chatOpacity).append('\n');
         fileBuilder.append("snooperEnabled:" + this.snooperEnabled).append('\n');
         fileBuilder.append("fullscreen:" + this.fullScreen).append('\n');
         fileBuilder.append("enableVsync:" + this.enableVsync).append('\n');
         fileBuilder.append("useVbo:" + this.useVbo).append('\n');
         fileBuilder.append("hideServerAddress:" + this.hideServerAddress).append('\n');
         fileBuilder.append("advancedItemTooltips:" + this.advancedItemTooltips).append('\n');
         fileBuilder.append("pauseOnLostFocus:" + this.pauseOnLostFocus).append('\n');
         fileBuilder.append("touchscreen:" + this.touchscreen).append('\n');
         fileBuilder.append("overrideWidth:" + this.overrideWidth).append('\n');
         fileBuilder.append("overrideHeight:" + this.overrideHeight).append('\n');
         fileBuilder.append("heldItemTooltips:" + this.heldItemTooltips).append('\n');
         fileBuilder.append("chatHeightFocused:" + this.chatHeightFocused).append('\n');
         fileBuilder.append("chatHeightUnfocused:" + this.chatHeightUnfocused).append('\n');
         fileBuilder.append("chatScale:" + this.chatScale).append('\n');
         fileBuilder.append("chatWidth:" + this.chatWidth).append('\n');
         fileBuilder.append("showInventoryAchievementHint:" + this.showInventoryAchievementHint).append('\n');
         fileBuilder.append("mipmapLevels:" + this.mipmapLevels).append('\n');
         fileBuilder.append("streamBytesPerPixel:" + this.streamBytesPerPixel).append('\n');
         fileBuilder.append("streamMicVolume:" + this.streamMicVolume).append('\n');
         fileBuilder.append("streamSystemVolume:" + this.streamGameVolume).append('\n');
         fileBuilder.append("streamKbps:" + this.streamKbps).append('\n');
         fileBuilder.append("streamFps:" + this.streamFps).append('\n');
         fileBuilder.append("streamCompression:" + this.streamCompression).append('\n');
         fileBuilder.append("streamSendMetadata:" + this.streamSendMetadata).append('\n');
         fileBuilder.append("streamPreferredServer:" + this.streamPreferredServer).append('\n');
         fileBuilder.append("streamChatEnabled:" + this.streamChatEnabled).append('\n');
         fileBuilder.append("streamChatUserFilter:" + this.streamChatUserFilter).append('\n');
         fileBuilder.append("streamMicToggleBehavior:" + this.streamMicToggleBehavior).append('\n');
         fileBuilder.append("forceUnicodeFont:" + this.logger).append('\n');
         fileBuilder.append("allowBlockAlternatives:" + this.allowBlockAlternatives).append('\n');
         fileBuilder.append("reducedDebugInfo:" + this.reducedDebugInfo).append('\n');
         fileBuilder.append("useNativeTransport:" + this.field_181150_U).append('\n');
         fileBuilder.append("entityShadows:" + this.field_181151_V).append('\n');

         for(KeyBinding keybinding : this.keyBindings) {
            fileBuilder.append("key_" + keybinding.getKeyDescription() + ":" + keybinding.getKeyCode()).append('\n');
         }

         for(SoundCategory soundcategory : SoundCategory.values()) {
            fileBuilder.append("soundCategory_" + soundcategory.getCategoryName() + ":" + this.getSoundLevel(soundcategory)).append('\n');
         }

         for(EnumPlayerModelParts enumplayermodelparts : EnumPlayerModelParts.values()) {
            fileBuilder.append("modelPart_" + enumplayermodelparts.getPartName() + ":" + this.mapSoundLevels.contains(enumplayermodelparts)).append('\n');
         }

         API.saveFile(this.file.getName(), fileBuilder.toString().getBytes(Charset.forName("UTF-8")));
      } catch (Exception var6) {
         gson.error("Failed to save options", var6);
      }
   ...
   public static boolean isKeyDown(KeyBinding p_100015_0_) {
      ...
      label0: {
         ...
         if(i >= -100 && i <= 255 && p_100015_0_.getKeyCode() != 0) {
   ...
   public String getKeyBinding(GameSettings.Options p_74297_1_) {
      ...
      if(s != null) {
         ...
         if(p_74297_1_.getEnumFloat()) {
            ...
            return p_74297_1_ == GameSettings.Options.SENSITIVITY?(f == 0.0F?s1 + I18n.format("options.sensitivity.min", new Object[0]):(f == 1.0F?s1 + I18n.format("options.sensitivity.max", new Object[0]):s1 + (int)(f * 200.0F) + "%")):(p_74297_1_ == GameSettings.Options.FOV?(f1 == 70.0F?s1 + I18n.format("options.fov.min", new Object[0]):(f1 == 110.0F?s1 + I18n.format("options.fov.max", new Object[0]):s1 + (int)f1)):(p_74297_1_ == GameSettings.Options.FRAMERATE_LIMIT?(f1 == p_74297_1_.$VALUES?s1 + I18n.format("options.framerateLimit.max", new Object[0]):s1 + (int)f1 + " fps"):(p_74297_1_ == GameSettings.Options.RENDER_CLOUDS?(f1 == p_74297_1_.valueMax?s1 + I18n.format("options.cloudHeight.min", new Object[0]):s1 + ((int)f1 + 128)):(p_74297_1_ == GameSettings.Options.GAMMA?(f == 0.0F?s1 + I18n.format("options.gamma.min", new Object[0]):(f == 1.0F?s1 + I18n.format("options.gamma.max", new Object[0]):s1 + "+" + (int)(f * 100.0F) + "%")):(p_74297_1_ == GameSettings.Options.SATURATION?s1 + (int)(f * 400.0F) + "%":(p_74297_1_ == GameSettings.Options.CHAT_OPACITY?s1 + (int)(f * 90.0F + 10.0F) + "%":(p_74297_1_ == GameSettings.Options.CHAT_HEIGHT_UNFOCUSED?s1 + GuiNewChat.calculateChatboxHeight(f) + "px":(p_74297_1_ == GameSettings.Options.CHAT_HEIGHT_FOCUSED?s1 + GuiNewChat.calculateChatboxHeight(f) + "px":(p_74297_1_ == GameSettings.Options.CHAT_WIDTH?s1 + GuiNewChat.calculateChatboxWidth(f) + "px":(p_74297_1_ == GameSettings.Options.RENDER_DISTANCE?s1 + (int)f1 + " chunks":(p_74297_1_ == GameSettings.Options.MIPMAP_LEVELS?(f1 == 0.0F?s1 + I18n.format("options.off", new Object[0]):s1 + (int)f1):(p_74297_1_ == GameSettings.Options.STREAM_FPS?s1 + TwitchStream.formatStreamFps(f) + " fps":(p_74297_1_ == GameSettings.Options.STREAM_KBPS?s1 + TwitchStream.formatStreamKbps(f) + " Kbps":(p_74297_1_ == GameSettings.Options.STREAM_BYTES_PER_PIXEL?s1 + String.format("%.3f bpp", new Object[]{Float.valueOf(TwitchStream.formatStreamBps(f))}):(f == 0.0F?s1 + I18n.format("options.off", new Object[0]):s1 + (int)(f * 100.0F) + "%")))))))))))))));
            ...
            return s1 + getTranslation(field_181149_aW, this.streamMicToggleBehavior);
   ...
   public void saveOfOptions() {
      try {
         StringBuilder fileBuilder = new StringBuilder();
         fileBuilder.append("ofRenderDistanceChunks:" + this.renderDistanceChunks).append('\n');
         fileBuilder.append("ofFogType:" + this.ofFogType).append('\n');
         fileBuilder.append("ofFogStart:" + this.ofFogStart).append('\n');
         fileBuilder.append("ofMipmapType:" + this.ofMipmapType).append('\n');
         fileBuilder.append("ofOcclusionFancy:" + this.ofOcclusionFancy).append('\n');
         fileBuilder.append("ofSmoothFps:" + this.ofSmoothFps).append('\n');
         fileBuilder.append("ofSmoothWorld:" + this.ofSmoothWorld).append('\n');
         fileBuilder.append("ofAoLevel:" + this.ofAoLevel).append('\n');
         fileBuilder.append("ofClouds:" + this.ofClouds).append('\n');
         fileBuilder.append("ofCloudsHeight:" + this.ofCloudsHeight).append('\n');
         fileBuilder.append("ofTrees:" + this.ofTrees).append('\n');
         fileBuilder.append("ofDroppedItems:" + this.ofDroppedItems).append('\n');
         fileBuilder.append("ofRain:" + this.ofRain).append('\n');
         fileBuilder.append("ofAnimatedWater:" + this.ofAnimatedWater).append('\n');
         fileBuilder.append("ofAnimatedLava:" + this.ofAnimatedLava).append('\n');
         fileBuilder.append("ofAnimatedFire:" + this.ofAnimatedFire).append('\n');
         fileBuilder.append("ofAnimatedPortal:" + this.ofAnimatedPortal).append('\n');
         fileBuilder.append("ofAnimatedRedstone:" + this.ofAnimatedRedstone).append('\n');
         fileBuilder.append("ofAnimatedExplosion:" + this.ofAnimatedExplosion).append('\n');
         fileBuilder.append("ofAnimatedFlame:" + this.ofAnimatedFlame).append('\n');
         fileBuilder.append("ofAnimatedSmoke:" + this.ofAnimatedSmoke).append('\n');
         fileBuilder.append("ofVoidParticles:" + this.ofVoidParticles).append('\n');
         fileBuilder.append("ofWaterParticles:" + this.ofWaterParticles).append('\n');
         fileBuilder.append("ofPortalParticles:" + this.ofPortalParticles).append('\n');
         fileBuilder.append("ofPotionParticles:" + this.ofPotionParticles).append('\n');
         fileBuilder.append("ofFireworkParticles:" + this.ofFireworkParticles).append('\n');
         fileBuilder.append("ofDrippingWaterLava:" + this.ofDrippingWaterLava).append('\n');
         fileBuilder.append("ofAnimatedTerrain:" + this.ofAnimatedTerrain).append('\n');
         fileBuilder.append("ofAnimatedTextures:" + this.ofAnimatedTextures).append('\n');
         fileBuilder.append("ofRainSplash:" + this.ofRainSplash).append('\n');
         fileBuilder.append("ofLagometer:" + this.ofLagometer).append('\n');
         fileBuilder.append("ofShowFps:" + this.ofShowFps).append('\n');
         fileBuilder.append("ofAutoSaveTicks:" + this.ofAutoSaveTicks).append('\n');
         fileBuilder.append("ofBetterGrass:" + this.ofBetterGrass).append('\n');
         fileBuilder.append("ofConnectedTextures:" + this.ofConnectedTextures).append('\n');
         fileBuilder.append("ofWeather:" + this.ofWeather).append('\n');
         fileBuilder.append("ofSky:" + this.ofSky).append('\n');
         fileBuilder.append("ofStars:" + this.ofStars).append('\n');
         fileBuilder.append("ofSunMoon:" + this.ofSunMoon).append('\n');
         fileBuilder.append("ofVignette:" + this.ofVignette).append('\n');
         fileBuilder.append("ofChunkUpdates:" + this.ofChunkUpdates).append('\n');
         fileBuilder.append("ofChunkUpdatesDynamic:" + this.ofChunkUpdatesDynamic).append('\n');
         fileBuilder.append("ofTime:" + this.ofTime).append('\n');
         fileBuilder.append("ofClearWater:" + this.ofClearWater).append('\n');
         fileBuilder.append("ofAaLevel:" + this.ofAaLevel).append('\n');
         fileBuilder.append("ofAfLevel:" + this.ofAfLevel).append('\n');
         fileBuilder.append("ofProfiler:" + this.ofProfiler).append('\n');
         fileBuilder.append("ofBetterSnow:" + this.ofBetterSnow).append('\n');
         fileBuilder.append("ofSwampColors:" + this.ofSwampColors).append('\n');
         fileBuilder.append("ofRandomMobs:" + this.ofRandomMobs).append('\n');
         fileBuilder.append("ofSmoothBiomes:" + this.ofSmoothBiomes).append('\n');
         fileBuilder.append("ofCustomFonts:" + this.ofCustomFonts).append('\n');
         fileBuilder.append("ofCustomColors:" + this.ofCustomColors).append('\n');
         fileBuilder.append("ofCustomItems:" + this.ofCustomItems).append('\n');
         fileBuilder.append("ofCustomSky:" + this.ofCustomSky).append('\n');
         fileBuilder.append("ofShowCapes:" + this.ofShowCapes).append('\n');
         fileBuilder.append("ofNaturalTextures:" + this.ofNaturalTextures).append('\n');
         fileBuilder.append("ofLazyChunkLoading:" + this.ofLazyChunkLoading).append('\n');
         fileBuilder.append("ofDynamicFov:" + this.ofDynamicFov).append('\n');
         fileBuilder.append("ofDynamicLights:" + this.ofDynamicLights).append('\n');
         fileBuilder.append("ofFullscreenMode:" + this.ofFullscreenMode).append('\n');
         fileBuilder.append("ofFastMath:" + this.ofFastMath).append('\n');
         fileBuilder.append("ofFastRender:" + this.ofFastRender).append('\n');
         fileBuilder.append("ofTranslucentBlocks:" + this.ofTranslucentBlocks).append('\n');
         fileBuilder.append("key_" + this.ofKeyBindZoom.getKeyDescription() + ":" + this.ofKeyBindZoom.getKeyCode()).append('\n');
         API.saveFile(this.optionsFileOF.getName(), fileBuilder.toString().getBytes(Charset.forName("UTF-8")));
   ...
   public void loadOptions() {
      try {
         ...
         String[] lines = (new String(API.loadFile(this.file.getName()), Charset.forName("UTF-8"))).split("\n");
         ...
         for(String s : lines) {
            try {
               ...
               if(astring[0].equals("resourcePacks")) {
                  this.resourcePacks = (List)typeListString.fromJson(s.substring(s.indexOf(58) + 1), GUISCALES);
               ...
               if(astring[0].equals("incompatibleResourcePacks")) {
                  this.resourcePackNames = (List)typeListString.fromJson(s.substring(s.indexOf(58) + 1), GUISCALES);
                  if(this.resourcePackNames == null) {
                     this.resourcePackNames = Lists.newArrayList();
                  }
               }
         ...
         gson.error("Failed to load options", var12);
      }
   ...
   public void loadOfOptions() {
      try {
         String[] lines = (new String(API.loadFile(this.optionsFileOF.getName()), Charset.forName("UTF-8"))).split("\n");
   ...
   public static enum Options {
      ...
      enumFloat("REALMS_NOTIFICATIONS", 44, "options.realmsNotifications", false, true),
      ...
      private Options(String p_i1_3_, int p_i1_4_, String p_i1_5_, boolean p_i1_6_, boolean p_i1_7_, float p_i1_8_, float p_i1_9_, float p_i1_10_) {
         this.valueStep = p_i1_5_;
         this.enumBoolean = p_i1_6_;
         this.enumString = p_i1_7_;
         this.valueMax = p_i1_8_;
         this.$VALUES = p_i1_9_;
         this.valueMin = p_i1_10_;
      }
