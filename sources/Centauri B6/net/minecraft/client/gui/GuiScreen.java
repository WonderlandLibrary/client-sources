...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
   ...
   public static ResourceLocation whiteTexture = new ResourceLocation("alphacentauri/white.png");
   private BackgroundRenderer bgRenderer = new BackgroundRenderer(this);
   ...
   protected void setBgRenderer(BackgroundRenderer bgRenderer) {
   ...
   public void sendChatMessage(String msg, boolean addToChat) {
      String prefix = AC.getConfig().getPrefix();
      if(addToChat) {
      ...
      if(!AC.isGhost()) {
         if(msg.startsWith(prefix + prefix)) {
            ...
            AC.getCommandManager().execCommand(msg.replaceFirst(prefix, ""));
            return;
         }
      }
   ...
   public void drawBackground(int tint) {
      if(AC.isGhost()) {
         ...
         this.mc.getTextureManager().bindTexture(whiteTexture);
