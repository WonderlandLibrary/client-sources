...
public class GuiNewChat extends Gui {
   ...
   private List sentMessages = Lists.newArrayList();
   private List chatLines = Lists.newArrayList();
   private List field_146253_i = Lists.newArrayList();
   ...
   public void clearACMessages() {
      this.sentMessages = (List)this.sentMessages.stream().filter((string) -> {
         return !string.startsWith(".");
      }).collect(Collectors.toCollection(ArrayList::<init>));
      this.chatLines = (List)this.chatLines.stream().filter((chatline) -> {
         return !chatline.getChatComponent().getUnformattedText().startsWith("§8[§4AC§8] [§c");
      }).collect(Collectors.toCollection(ArrayList::<init>));
      this.field_146253_i = (List)this.field_146253_i.stream().filter((chatline) -> {
         return !chatline.getChatComponent().getUnformattedText().startsWith("§8[§4AC§8] [§c");
      }).collect(Collectors.toCollection(ArrayList::<init>));
   }
   ...
   private void setChatLine(IChatComponent p_146237_1_, int p_146237_2_, int p_146237_3_, boolean p_146237_4_) {
      ...
      while(this.field_146253_i.size() > (AC.isGhost()?100:10000)) {
      ...
      if(!p_146237_4_) {
         ...
         while(this.chatLines.size() > (AC.isGhost()?100:10000)) {
