...
import net.minecraft.client.gui.GuiIngame.1;
...
public class GuiIngame extends Gui {
   ...
   private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
      if(AC.isGhost() || !AC.getModuleManager().get(ModuleNoScoreboard.class).isEnabled()) {
         Scoreboard scoreboard = p_180475_1_.getScoreboard();
         Collection<Score> collection = scoreboard.getSortedScores(p_180475_1_);
         ArrayList arraylist = Lists.newArrayList(Iterables.filter(collection, new 1(this)));
   ...
   protected void renderTooltip(ScaledResolution sr, float partialTicks) {
      if(this.mc.getRenderViewEntity() instanceof EntityPlayer) {
         ...
         if(AC.isGhost()) {
            ...
            this.drawGradientRect(i - 91, sr.getScaledHeight() - 22, i + 91, sr.getScaledHeight(), -1207959552, -1207959552);
            this.drawGradientRect(i - 91 - 1 + entityplayer.inventory.currentItem * 20, sr.getScaledHeight() - 22 - 1, i - 91 - 1 + entityplayer.inventory.currentItem * 20 + 24, sr.getScaledHeight() - 22 - 1 + 22, 570425343, 570425343);
         }
   ...
   public void renderGameOverlay(float partialTicks) {
      ...
      this.mc.getTextureManager().bindTexture(icons);
      GlStateManager.enableBlend();
      if(this.showCrosshair() && this.mc.gameSettings.showDebugInfo < 1) {
      ...
      if(!this.mc.gameSettings.showDebugProfilerChart) {
         (new EventRender2D(scaledresolution)).fire();
      }
