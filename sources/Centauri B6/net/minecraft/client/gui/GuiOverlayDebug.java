...
public class GuiOverlayDebug extends Gui {
   ...
   protected List call() {
      ...
      if(this.isReducedDebug()) {
         ...
         String s = "Invalid";
         switch(1.field_178907_a[enumfacing.ordinal()]) {
         case 1:
         ...
         if(this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPos() != null) {
   ...
   protected List getDebugInfoRight() {
      ...
      if(this.isReducedDebug()) {
         ...
         if(this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPos() != null) {
            ...
            String s;
            for(Iterator<Entry<IProperty, Comparable>> iterator = iblockstate.getProperties().entrySet().iterator(); ((Iterator)iterator).hasNext(); arraylist.add(((IProperty)entry.getKey()).getName() + ": " + s)) {
