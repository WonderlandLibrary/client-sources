...
public class RecipesBanners {
   void addRecipes(CraftingManager p_179534_1_) {
      ...
      p_179534_1_.addRecipe(new RecipesBanners.RecipeDuplicatePattern((1)null));
      p_179534_1_.addRecipe(new RecipesBanners.RecipeAddPattern((1)null));
   }

   static class RecipeAddPattern implements IRecipe {
      // $FF: synthetic method
      RecipeAddPattern(1 x0) {
         this();
      }
      ...
      public ItemStack getCraftingResult(InventoryCrafting inv) {
         ...
         EnumBannerPattern tileentitybanner$enumbannerpattern = this.func_179533_c(inv);
      ...
      private EnumBannerPattern func_179533_c(InventoryCrafting p_179533_1_) {
