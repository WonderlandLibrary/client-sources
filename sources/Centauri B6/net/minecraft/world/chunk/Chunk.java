...
public class Chunk {
   ...
   public Chunk(World worldIn, int x, int z) {
      ...
      Arrays.fill((int[])this.precipitationHeightMap, -999);
   ...
   public IBlockState getBlockState(BlockPos pos) {
      if(this.worldObj.getWorldType() == WorldType.DEBUG_WORLD) {
         ...
         try {
            ...
            crashreportcategory.addCrashSectionCallable("Location", new 3(this, pos));
   ...
   public Block getBlock(BlockPos pos) {
      try {
         ...
         crashreportcategory.addCrashSectionCallable("Location", new 2(this, pos));
         throw var4;
      }
   }
   ...
   public Block getBlock(int x, int y, int z) {
      try {
         ...
         crashreportcategory.addCrashSectionCallable("Location", new 1(this, x, y, z));
         throw var6;
      }
   }
