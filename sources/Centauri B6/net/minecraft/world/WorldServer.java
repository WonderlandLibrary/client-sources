...
public class WorldServer extends World implements IThreadListener {
   ...
   private ServerBlockEventList[] field_147490_S = new ServerBlockEventList[]{new ServerBlockEventList((1)null), new ServerBlockEventList((1)null)};
   ...
   protected BlockPos adjustPosToNearbyEntity(BlockPos pos) {
      ...
      List<EntityLivingBase> list = this.getEntitiesWithinAABB(EntityLivingBase.class, axisalignedbb, new 1(this));
