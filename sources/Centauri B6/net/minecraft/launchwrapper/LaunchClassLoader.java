...
public class LaunchClassLoader extends URLClassLoader {
            ...
            try {
               ...
               if(lastDot > -1 && !untransformedName.startsWith("net.minecraft.")) {
                  if(urlConnection instanceof JarURLConnection) {
                     ...
                     Package pkg = this.getPackage(packageName);
                     if(pkg == null) {
                        pkg = this.definePackage(packageName, (String)null, (String)null, (String)null, (String)null, (String)null, (String)null, (URL)null);
               ...
               this.invalidClasses.add(name);
               if(DEBUG) {
                  LogWrapper.log(Level.FINEST, var15, "Exception encountered attempting classloading of %s", new Object[]{name});
               }
   ...
   private byte[] readFully(InputStream stream) {
      try {
         ...
         LogWrapper.log(Level.WARNING, var6, "Problem loading class", new Object[0]);
         return new byte[0];
      }
   }
   ...
   private void saveTransformedClass(byte[] data, String transformedName) {
      if(tempFolder != null) {
         ...
         try {
            ...
            LogWrapper.log(Level.WARNING, var6, "Could not save transformed class \"%s\"", new Object[]{transformedName});
         }
   ...
   public void registerTransformer(String transformerClassName) {
      try {
         ...
         LogWrapper.log(Level.SEVERE, var3, "A critical problem occurred registering the ASM transformer class %s", new Object[]{transformerClassName});
      }
   ...
   public byte[] getClassBytes(String name) throws IOException {
      ...
      try {
         ...
         if(classResource != null) {
            ...
            byte[] var14 = this.readFully(classStream);
            return var14;
         }
   ...
   private byte[] runTransformers(String name, String transformedName, byte[] basicClass) {
      if(DEBUG_FINER) {
         ...
         for(IClassTransformer transformer : this.transformers) {
            ...
            LogWrapper.finest("Before Transformer %s: %d", new Object[]{transName, Integer.valueOf(basicClass == null?0:basicClass.length)});
            basicClass = transformer.transform(name, transformedName, basicClass);
            LogWrapper.finest("After  Transformer %s: %d", new Object[]{transName, Integer.valueOf(basicClass == null?0:basicClass.length)});
         }
