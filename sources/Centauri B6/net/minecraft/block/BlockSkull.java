...
public class BlockSkull extends BlockContainer {
   ...
   public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos) {
      switch(2.$SwitchMap$net$minecraft$util$EnumFacing[((EnumFacing)worldIn.getBlockState(pos).getValue(FACING)).ordinal()]) {
      case 1:
      default:
         this.setBlockBounds(0.25F, 0.0F, 0.25F, 0.75F, 0.5F, 0.75F);
         break;
   ...
   public void checkWitherSpawn(World worldIn, BlockPos pos, TileEntitySkull te) {
      if(te.getSkullType() == 1 && pos.getY() >= 2 && worldIn.getDifficulty() != EnumDifficulty.PEACEFUL && !worldIn.isRemote) {
         ...
         PatternHelper blockpattern$patternhelper = blockpattern.match(worldIn, pos);
