...
import dev.myth.features.visual.GlowESPFeature;
...
//        GlowESPFeature.glowShader = new ShaderProgramOther("GlowShader.frag");
        GlowESPFeature.glowShader = new ShaderProgramOther("esp.glsl");
        GlowESPFeature.outlineShader = new ShaderProgramOther("OutlineShader.frag");
        /* TODO: Client */
        ClientMain.INSTANCE.init();

        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(ClientMain.INSTANCE.isLoggedIn() && !ClientMain.INSTANCE.getUsername().equals("MythClarinet1337") && ClientMain.INSTANCE.getUid() != Integer.MAX_VALUE && TempKeyUtil.getDecryptedTempKey().equals("AdolfDripler" + ClientMain.INSTANCE.getUsername() + "|" + ClientMain.INSTANCE.getUid() + "5Y9NJeVl1sKasLx*#Yje8Y0%QpknOIgy" + ClientMain.INSTANCE.getUsername()) ? new GuiMainMenu() : new GuiLogin(), this, this.serverName, this.serverPort));
        } else {
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn == null && this.theWorld == null) {
            guiScreenIn = ClientMain.INSTANCE.isLoggedIn() && !ClientMain.INSTANCE.getUsername().equals("MythClarinet1337") && ClientMain.INSTANCE.getUid() != Integer.MAX_VALUE && TempKeyUtil.getDecryptedTempKey().equals("AdolfDripler" + ClientMain.INSTANCE.getUsername() + "|" + ClientMain.INSTANCE.getUid() + "5Y9NJeVl1sKasLx*#Yje8Y0%QpknOIgy" + ClientMain.INSTANCE.getUsername()) ? new GuiMainMenu() : new GuiLogin();
    ...
    public void runTick() throws IOException {
        ...
        ClientMain.INSTANCE.eventBus.call(tickEvent);
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        ClientMain.INSTANCE.eventBus.call(new KeyEvent(k));
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (worldClientIn != null) {
            ...
            ClientMain.INSTANCE.eventBus.call(new LoadWorldEvent());
        } else {
