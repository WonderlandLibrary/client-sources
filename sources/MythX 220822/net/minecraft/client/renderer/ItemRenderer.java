...
import dev.myth.features.visual.AnimationsFeature;
...
public class ItemRenderer {
    ...
    public final Animation animation1 = new Animation();
    public final Animation animation2 = new Animation();
    public final Animation animation3 = new Animation();
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress) {
        AnimationsFeature animationsFeature = ClientMain.INSTANCE.manager.getManager(FeatureManager.class).getFeature(AnimationsFeature.class);
        ...
        float scale = 0.4F;
        if (animationsFeature.isEnabled())
            scale *= animationsFeature.itemScale.getValue().floatValue();
    ...
    private AnimationsFeature animationsFeature;
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
            ...
            if (animationsFeature == null) {
                animationsFeature = ClientMain.INSTANCE.manager.getManager(FeatureManager.class).getFeature(AnimationsFeature.class);
            } else {
                if (animationsFeature.isEnabled()) {
                    GlStateManager.scale(1, 1, animationsFeature.itemDistance.getValue());
                }
            }
            ...
            if (this.itemToRender != null) {
                ...
                } else if (abstractclientplayer.getItemInUseCount() > 0 || killAuraFeature.shouldRenderBlocking()) {
                    ...
                    switch (enumaction) {
                        ...
                        case BLOCK:
                            if (!animationsFeature.isEnabled()) {
                                ...
                                GlStateManager.translate(animationsFeature.itemX.getValue(), animationsFeature.itemY.getValue(), 0);

                                float equipProgress = f;
                                if (animationsFeature.equipProgress.getValue())
                                    equipProgress *= animationsFeature.equipProgressMultiplier.getValue().floatValue();
                                else equipProgress = 0;

                                switch (animationsFeature.mode.getValue()) {
                                    case VANILLA: {
                                    ...
                                    case OLD: {
                                        this.transformFirstPersonItem(equipProgress, f1);
                                        this.doBlockTransformations();
                                        break;
                                    }
                                    case EXHIBITION: {
                                        GL11.glTranslated(0D, f8 * 0.05D, 0.0D);
                                        this.transformFirstPersonItem(equipProgress, 0.0f);
                                        final double rotX = 0.1D, rotY = 0.1D, rotZ = 0.1D;
                                        GL11.glTranslated(rotX, rotY, rotZ);
                                        GlStateManager.rotate(-f8 * 56 / 1.85F, f8 / 4.8F, -2.0F, 145.0F);
                                        GlStateManager.rotate(-f8 * 56, 1.0F, f8 / 2.1F, 0.125F);
                                        GL11.glTranslated(-rotX, -rotY, -rotZ);
                                        this.doBlockTransformations();
                                    ...
                                    case ETB: {
                                        ...
                                        this.doBlockTransformations();
                                        GlStateManager.rotate(-f8 * 30, -12, 0, 10);
                                        GlStateManager.rotate(-f8 * 70, 1, -0.4f, 0);
                                        break;
                                    }
                                    case SWANK: {
                                        this.transformFirstPersonItem(equipProgress, f1);
                                        GlStateManager.rotate(f8 * 30, -f8, 0, 9);
                                        GlStateManager.rotate(f8 * 40, 1, -f8 / 2, 0);
                                        this.doBlockTransformations();
                                        break;
                                    }
                                    case SWANG: {
                                        this.transformFirstPersonItem(equipProgress, f1);
                                        GlStateManager.rotate(f8 * 10, -f8, 0, 9);
                                        GlStateManager.rotate(f8 * 50, 1, -f8 / 2, 0);
                                        this.doBlockTransformations();
                                        break;
                                    }
                                    case AUXY: {
                                        GL11.glTranslated(0D, f8 * 0.05D, 0.0D);
                                        this.transformFirstPersonItem(equipProgress, f1);
                                        GlStateManager.rotate((float) (-f8 * 50 / 3.0), f8 / 4.8F, (float) -0.0, 5.0F);
                                        GlStateManager.rotate((float) (-f8 * -50.0), 5.0F, (f8 / 2.1F), (float) -0.0);
                                        this.doBlockTransformations();
                                        break;
                                    }
                                }
    ...
    public void doAnimation(float equipProgress, float swingProgress) {
        GlStateManager.translate(0.0F, 0.0F, 3F);
    }
