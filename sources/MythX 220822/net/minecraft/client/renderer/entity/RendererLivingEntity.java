...
import dev.myth.features.visual.DamageColorFeature;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[]{entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)})) {
            ...
            try {
                ...
                if (entity instanceof EntityPlayerSP) {
                    ...
                    f1 = this.interpolateRotation(player.currentEvent.getLastYaw(), player.currentEvent.getYaw(), partialTicks);
                }
                float f2 = f1 - f;
                ...
                if (entity instanceof EntityPlayerSP) {
                    EntityPlayerSP player = Minecraft.getMinecraft().thePlayer;
                    f7 = player.currentEvent.getLastPitch() + (player.currentEvent.getPitch() - player.currentEvent.getLastPitch()) * partialTicks;
                }
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
        // DamageColor
        final DamageColorFeature damageColorFeature = ClientMain.INSTANCE.manager.getManager(FeatureManager.class).getFeature(DamageColorFeature.class);
        ...
        if (!flag && !flag1) {
            ...
            if (flag1) {
                if (damageColorFeature.isEnabled()) {
                    this.brightnessBuffer.put(damageColorFeature.getColor().getRed() / 255F);
                    this.brightnessBuffer.put(damageColorFeature.getColor().getGreen() / 255F);
                    this.brightnessBuffer.put(damageColorFeature.getColor().getBlue() / 255F);
                    this.brightnessBuffer.put(damageColorFeature.alpha.getValue().floatValue() / 255F);
                }else {
