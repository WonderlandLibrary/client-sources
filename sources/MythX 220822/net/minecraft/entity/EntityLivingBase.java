...
public abstract class EntityLivingBase extends Entity {
    ...
    public PotionEffect getActivePotionEffect(int potionId) {
        return (PotionEffect) this.activePotionsMap.get(potionId);
    }
    ...
    private int getArmSwingAnimationEnd() {
        ...
        int anim;
        if (animationsFeature.isEnabled() && this == Minecraft.getMinecraft().thePlayer)
            anim = (int) (6 + animationsFeature.itemSlowdown.getValue() * 2);
        else
            anim = this.isPotionActive(Potion.digSpeed) ? 6 - (1 + this.getActivePotionEffect(Potion.digSpeed).getAmplifier()) : (this.isPotionActive(Potion.digSlowdown) ? 6 + (1 + this.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2 : 6);
    ...
    protected float updateDistance(float p_110146_1_, float p_110146_2_) {
        ...
        if (this instanceof EntityPlayerSP && Minecraft.getMinecraft().thePlayer.currentEvent != null) {
            yaw = Minecraft.getMinecraft().thePlayer.currentEvent.getYaw();
        }
