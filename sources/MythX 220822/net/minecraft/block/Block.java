...
public class Block {
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        CollisonEvent eventCollide = new CollisonEvent( collidingEntity, pos.getX (), pos.getY (), pos.getZ (), axisAlignedBB, this );
        ClientMain.INSTANCE.eventBus.call(eventCollide);
