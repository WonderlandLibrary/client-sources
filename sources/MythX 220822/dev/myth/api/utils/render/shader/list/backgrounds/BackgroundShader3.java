...
@ShaderAnnoation(fragName = "background3.glsl", renderType = ShaderRenderType.NONE)
public class BackgroundShader3 extends ShaderProgram {

    public static Framebuffer framebuffer = new Framebuffer(1, 1, false);
    public final long startTime;

    public BackgroundShader3() {
