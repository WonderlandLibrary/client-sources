...
@ShaderAnnoation(fragName = "background4.glsl", renderType = ShaderRenderType.NONE)
public class BackgroundShader4 extends ShaderProgram {

    public static Framebuffer framebuffer = new Framebuffer(1, 1, false);
    public final long startTime;

    public BackgroundShader4() {
