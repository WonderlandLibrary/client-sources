...
import alos.stella.event.events.StepConfirmEvent;
import alos.stella.event.events.StepEvent;
import alos.stella.event.events.StrafeEvent;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        Stella.eventManager.callEvent(moveEvent);
        ...
        else
        {
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z))
            {
                ...
                Stella.eventManager.callEvent(stepEvent);
                double d11 = x;
                double d7 = y;
                double d8 = z;
                ...
                if (d11 * d11 + d8 * d8 >= x * x + z * z)
                {
                    ...
                    Stella.eventManager.callEvent(new StepConfirmEvent());
                }
            }
    ...
    public void moveFlying(float strafe, float forward, float friction)
    {
        ...
        if (player) {
            final StrafeEvent event = new StrafeEvent();
        ...
        Stella.eventManager.callEvent(strafeEvent);
