...
public class GuiChat extends GuiScreen
{
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        if (!inputField.getText().startsWith(String.valueOf(Stella.commandManager.getPrefix()))) return;
        Stella.commandManager.autoComplete(inputField.getText());

        if (!inputField.getText().startsWith(Stella.commandManager.getPrefix() + "lc")) {
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state) {
        Stella.draggableHUD.getScreen().release();
    ...
    {
        Stella.draggableHUD.getScreen().click(mouseX, mouseY);
        if (mouseButton == 0)
        {
    ...
    {
        Stella.draggableHUD.getScreen().draw(mouseX, mouseY);
