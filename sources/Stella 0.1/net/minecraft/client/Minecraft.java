...
import alos.stella.utils.IconUtils;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(Stella.CLIENT_NAME + " " + Stella.CLIENT_VERSION);
    ...
    private void setWindowIcon()
    {
        if(Util.getOSType() != Util.EnumOS.OSX) {
            final ByteBuffer[] stella = IconUtils.getFavicon();
            if(stella != null) {
                Display.setIcon(stella);
                return;
            }
        }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        Stella.eventManager.callEvent(new ScreenEvent(currentScreen));
    }
        ...
        if (this.leftClickCounter <= 0 && !this.thePlayer.isUsingItem())
        {
            if (leftClick && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
            {
                ...
                if (this.leftClickCounter == 0 && theWorld.getBlockState(objectMouseOver.getBlockPos()).getBlock().getMaterial() != Material.air) {
                    Stella.eventManager.callEvent(new ClickBlockEvent(objectMouseOver.getBlockPos(), this.objectMouseOver.sideHit));
                }
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState() && currentScreen == null)
                    Stella.eventManager.callEvent(new KeyEvent(Keyboard.getEventKey() == 0 ? Keyboard.getEventCharacter() + 256 : Keyboard.getEventKey()));
        ...
        if (this.theWorld != null)
        {
            ...
            {
                Stella.eventManager.callEvent(new TickEvent());
    ...
    {
        Stella.eventManager.callEvent(new WorldEvent(worldClientIn));
