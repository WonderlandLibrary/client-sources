...
import alos.stella.module.modules.visual.Animations;
...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            if (Stella.moduleManager.getModule(Animations.class).getState()) {
            ...
            if (this.itemToRender != null) {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0 || (this.itemToRender.getItem() instanceof ItemSword && Stella.INSTANCE.getModuleManager().getModule(KillAura.class).getState() && Stella.INSTANCE.getModuleManager().getModule(KillAura.class).block != false))                {
                            ...
                            if (Stella.moduleManager.getModule(Animations.class).getState()) {
                                ...
                                switch (z) {
                                    ...
                                    case "Stella2": {
                                        this.func_178096_b(f, f1);
                                        this.func_178103_d();
                                        GL11.glTranslated(0.08D, -0.8D, -0.2D);
                                        break;
                                    }
                                    case "1.7": {
