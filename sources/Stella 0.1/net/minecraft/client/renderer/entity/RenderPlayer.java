...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    {
        if (Stella.moduleManager.getModule(CustomModel.class).getState() && (!Stella.moduleManager.getModule(CustomModel.class).onlyMe.get() || entity == Minecraft.getMinecraft().thePlayer)){
            if (Stella.moduleManager.getModule(CustomModel.class).getState() && CustomModel.modelMode.get().equals("Rabbit")) {
                return new ResourceLocation("stella/models/rabbit.png");
            }
            if (Stella.moduleManager.getModule(CustomModel.class).getState() && CustomModel.modelMode.get().equals("Amogus")) {
                return new ResourceLocation("stella/models/amogus.png");
            }
        }
