...
import alos.stella.module.modules.movement.Scaffold;
import alos.stella.module.modules.visual.Camera;
import alos.stella.module.modules.visual.NameTags;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
            ...
            this.mainModel.isChild = PlayerEdit.baby.get() && (Stella.moduleManager.getModule(PlayerEdit.class).onlyMe.get() && entity == Minecraft.getMinecraft().thePlayer || Stella.moduleManager.getModule(PlayerEdit.class).onlyOther.get() && entity != Minecraft.getMinecraft().thePlayer) && Stella.moduleManager.getModule(PlayerEdit.class).getState() ? true :entity.isChild();
            ...
            try
            {
                ...
                if (entity == this.renderManager.livingPlayer && (Stella.INSTANCE.getModuleManager().getModule(Scaffold.class).getState() || Stella.INSTANCE.getModuleManager().getModule(KillAura.class).getState() && Stella.INSTANCE.getModuleManager().getModule(KillAura.class).block)) {
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures)
    {
        ...
        else
        {
            ...
            if (flag1)
            {
                if (Stella.moduleManager.getModule(Camera.class).getState() && Camera.customHitColor.get()) {
                    int color = new Color(Camera.rHit.get(), Camera.gHit.get(), Camera.bHit.get(), Camera.aHit.get()).getRGB();
    ...
    {
        if (Objects.requireNonNull(Stella.moduleManager.getModule(NameTags.class)).getState()){
            return false;
        }
