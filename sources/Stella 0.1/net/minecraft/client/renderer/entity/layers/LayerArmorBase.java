...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase>
{
    ...
    {
        if ((!CustomModel.onlyMe.get() || entitylivingbaseIn == Minecraft.getMinecraft().thePlayer) && Stella.moduleManager.getModule(CustomModel.class).getState() && (!CustomModel.modelMode.get().equals("None"))) {
            return;
        }
