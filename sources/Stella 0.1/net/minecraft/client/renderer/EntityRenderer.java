...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        {
            Stella.eventManager.callEvent(new Render3DEvent(partialTicks));
            if (flag)
            {
    ...
    private void setupFog(int startCoords, float partialTicks)
    {
        ...
        {
            float value = Stella.INSTANCE.getModuleManager().getModule(Camera.class).getState() && Camera.fogColor.get() ? Camera.distance.get() * 50.0f : 0.0f;
            float f3 = this.farPlaneDistance - value;
        ...
        Stella.INSTANCE.getEventManager().callEvent(event);
        if (Stella.moduleManager.getModule(Camera.class).getState() && Camera.fogColor.get()) {
