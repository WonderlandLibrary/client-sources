...
public class Tab {
    ...
    public Tab(ModuleCategory enumModuleType, float posX, float posY) {
        ...
        this.posX = posX;
        this.posY = posY;
        for (alos.stella.module.Module abstractModule : Stella.moduleManager.getModuleInCategory(enumModuleType)) {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        DrawUtils.drawRect(posX - 1, posY, posX + 101, posY + 15, new Color(29, 29, 29, 255).getRGB());
        ...
        if (opened) {
            DrawUtils.drawRect(posX - 1, posY + 15, posX + 101, posY + 15 + getTabHeight() + 1, new Color(29, 29, 29, 255).getRGB());
