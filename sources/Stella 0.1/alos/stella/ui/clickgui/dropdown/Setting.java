...
public class Setting {
    ...
    private final MSTimer backSpace = new MSTimer();
    private final MSTimer caretTimer = new MSTimer();
    public int height;
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        if (setting instanceof FloatValue) {
            ...
            DrawUtils.drawRect(module.tab.getPosX() + 1, y + 3, module.tab.getPosX() + 99, y + 14, new Color(0, 0, 0, 50).getRGB());
            DrawUtils.drawRect(module.tab.getPosX() + 1, y + 3, module.tab.getPosX() + 1 + 98 * percent, y + 14, ClickGUI.generateColor().getRGB());
        ...
        if (setting instanceof BoolValue) {
            ...
            DrawUtils.drawRect(module.tab.getPosX() + 89, y + 4, module.tab.getPosX() + 99, y + 14, new Color(0, 0, 0, 50).getRGB());
            if (boolValue.get()) {
                DrawUtils.drawCheck(module.tab.getPosX() + 91, y + 8.5f, 2, ClickGUI.generateColor().brighter().getRGB());
            }
       ...
       if (setting instanceof TextValue){
        ...
        DrawUtils.drawRect(module.tab.getPosX() + 6, y + 16, module.tab.getPosX() + 84, y + 16.5, new Color(195, 195, 195, 220).getRGB());
