package alos.stella.file;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import alos.stella.Stella;
import alos.stella.file.configs.ModulesConfig;
import alos.stella.file.configs.ShortcutsConfig;
import alos.stella.file.configs.ValuesConfig;
...
public class FileManager extends MinecraftInstance {
    ...
    public File dir = new File(mc.mcDataDir, Stella.CLIENT_NAME);
...
//    public final FileConfig hudConfig = new HudConfig(new File(dir, "hud.json"));
    ...
    private void saveConfig(final FileConfig config, final boolean ignoreStarting) {
        if (!ignoreStarting && Stella.INSTANCE.isStarting())
            return;
...
//                Stella.INSTANCE.setBackground(new ResourceLocation(Stella.CLIENT_NAME.toLowerCase() + "/userbackground.png"));
//                mc.getTextureManager().loadTexture(Stella.INSTANCE.getBackground(), new DynamicTexture(bufferedImage));
