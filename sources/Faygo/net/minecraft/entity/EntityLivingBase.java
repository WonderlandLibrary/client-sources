...
public abstract class EntityLivingBase extends Entity {
	...
	public void setLocation(Location location) {
		...
		this.rotationPitch = location.getPitch();
		float var7 = this.width / 2.0F;
        float var8 = this.height;
		this.func_174826_a(new AxisAlignedBB(posX - (double)var7, posY, posZ - (double)var7, posX + (double)var7, posY + (double)var8, posZ + (double)var7));
	}
