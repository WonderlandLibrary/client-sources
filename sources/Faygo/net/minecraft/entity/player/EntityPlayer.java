...
public abstract class EntityPlayer extends EntityLivingBase {
	...
	public EntityPlayer(World worldIn, GameProfile p_i45324_2_) {
		...
		this.setLocationAndAngles((double) var3.getX() + 0.5D, (double) (var3.getY() + 1), (double) var3.getZ() + 0.5D,
				0.0F, 0.0F);
		...
		if (itemStackIn.getItemUseAction() == EnumAction.EAT) {
			for (int var3 = 0; var3 < p_71010_2_; ++var3) {
				...
				if (itemStackIn.getHasSubtypes()) {
					this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, var7.xCoord, var7.yCoord, var7.zCoord,
	...
	public void onLivingUpdate() {
		...
		if (this.getHealth() > 0.0F && !this.func_175149_v()) {
			...
			if (this.ridingEntity != null && !this.ridingEntity.isDead) {
				var4 = this.getEntityBoundingBox().union(this.ridingEntity.getEntityBoundingBox()).expand(1.0D, 0.0D,
						1.0D);
			} else {
	...
	private Collection func_175137_e(Entity p_175137_1_) {
		...
		if (var2 != null) {
			...
			if (var3 >= 0 && var3 < IScoreObjectiveCriteria.field_178793_i.length) {
				Iterator var4 = this.getWorldScoreboard().func_96520_a(IScoreObjectiveCriteria.field_178793_i[var3])
						.iterator();
		...
		if (targetEntity.canAttackWithItem()) {
			if (!targetEntity.hitByEntity(this)) {
				...
				if (targetEntity instanceof EntityLivingBase) {
					var4 = EnchantmentHelper.func_152377_a(this.getHeldItem(),
	...
	public EntityPlayer.EnumStatus func_180469_a(BlockPos p_180469_1_) {
		if (!this.worldObj.isRemote) {
			...
			if (Math.abs(this.posX - (double) p_180469_1_.getX()) > 3.0D
					|| Math.abs(this.posY - (double) p_180469_1_.getY()) > 2.0D
					|| Math.abs(this.posZ - (double) p_180469_1_.getZ()) > 3.0D) {
				return EntityPlayer.EnumStatus.TOO_FAR_AWAY;
			}

			double var2 = 8.0D;
			double var4 = 5.0D;
			List var6 = this.worldObj.getEntitiesWithinAABB(EntityMob.class,
					new AxisAlignedBB((double) p_180469_1_.getX() - var2, (double) p_180469_1_.getY() - var4,
							(double) p_180469_1_.getZ() - var2, (double) p_180469_1_.getX() + var2,
							(double) p_180469_1_.getY() + var4, (double) p_180469_1_.getZ() + var2));
		...
		if (this.worldObj.isBlockLoaded(p_180469_1_)) {
			...
			this.setPosition((double) ((float) p_180469_1_.getX() + var3),
					(double) ((float) p_180469_1_.getY() + 0.6875F), (double) ((float) p_180469_1_.getZ() + var8));
		} else {
			this.setPosition((double) ((float) p_180469_1_.getX() + 0.5F),
					(double) ((float) p_180469_1_.getY() + 0.6875F), (double) ((float) p_180469_1_.getZ() + 0.5F));
		}
	...
	public void wakeUpPlayer(boolean p_70999_1_, boolean updateWorldFlag, boolean setSpawn) {
		...
		if (this.playerLocation != null && var4.getBlock() == Blocks.bed) {
			this.worldObj.setBlockState(this.playerLocation,
					var4.withProperty(BlockBed.OCCUPIED_PROP, Boolean.valueOf(false)), 4);
	...
	public float getBedOrientationInDegrees() {
		if (this.playerLocation != null) {
			EnumFacing var1 = (EnumFacing) this.worldObj.getBlockState(this.playerLocation)
					.getValue(BlockDirectional.AGE);
	...
	public void onKillEntity(EntityLivingBase entityLivingIn) {
		...
		EntityList.EntityEggInfo var2 = (EntityList.EntityEggInfo) EntityList.entityEggs
	...
	public boolean func_175148_a(EnumPlayerModelParts p_175148_1_) {
		return (this.getDataWatcher().getWatchableObjectByte(10) & p_175148_1_.func_179327_a()) == p_175148_1_
				.func_179327_a();
	}
