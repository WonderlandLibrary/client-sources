                            ...
                            else
                            {
                                ...
                                if (var19.length >= 2)
                                {
                                    ...
                                    if (value.indexOf(44) < 0)
                                    {
                                        ...
                                        IProperty prop = getProperty(key, properties);
                                        ...
                                        else
                                        {
                                            ...
                                            Comparable valueObj = ConnectedParser.parseValue(value, var20);

                                            if (valueObj == null)
                                            {
                                                Collection valueObjComp = prop.getAllowedValues();
                                                valueObj = ConnectedParser.getPropertyValue(value, valueObjComp);
                                            }
        ...
        if (this.name != null && this.name.length() > 0)
        {
            ...
            else
            {
                ...
                else if (this.tiles != null && this.tiles.length > 0)
                {
                    ...
                    {
                        Config.warn("MotionBlur pass not supported: " + this.renderPass);
                        return false;
                    }
        ...
        if (this.tiles != null && this.tiles.length > 0)
        {
            if (this.weights != null)
            {
                ...
                if (this.weights.length < this.tiles.length)
                {
                    ...
                    i = ConnectedUtils.getAverage(this.weights);
