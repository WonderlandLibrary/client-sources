...
public class Gui
{
    ...
    public static void drawRect(double left, double d, double right, double e, final int color) {
        if (left < right) {
        ...
        var11.startDrawingQuads();
        var11.addVertex(left, e, 0.0);
        var11.addVertex(right, e, 0.0);
        var11.addVertex(right, d, 0.0);
        var11.addVertex(left, d, 0.0);
        var10.draw();
        GlStateManager.func_179098_w();
        GlStateManager.disableBlend();
    }
