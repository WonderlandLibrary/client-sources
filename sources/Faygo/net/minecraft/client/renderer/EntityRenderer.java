...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private static final ResourceLocation[] shaderResourceLocations = new ResourceLocation[] {new ResourceLocation("shaders/post/phosphor.json")};
    ...
    private void func_175068_a(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        EventSystem.call(new EventRenderWorld());
