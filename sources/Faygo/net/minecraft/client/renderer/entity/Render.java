...
public abstract class Render
{
    ...
    /**
     * Returns the location of an entity's texture. Doesn't seem to be called unless you call MotionBlur.bindEntityTexture.
     */
    ...
    {
    	if(EventSystem.call(new EventRenderNametag(p_147906_1_)).isCancelled()) return;
