...
import me.valk.event.events.player.EventPlayerAttack;
...
public class PlayerControllerMP
{
    ...
    {
    	Event event = EventSystem.call(new EventPlayerAttack(EventType.PRE, targetEntity));
        ...
        EventSystem.call(new EventPlayerAttack(EventType.PRE, targetEntity));
    }
