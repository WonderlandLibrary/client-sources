...
import io.github.nevalackin.client.event.world.UpdateWorldTimeEvent;
...
public abstract class World implements IBlockAccess
{
    ...
    public void setWorldTime(long time) {
        final UpdateWorldTimeEvent event = new UpdateWorldTimeEvent(time);
        KetamineClient.getInstance().getEventBus().post(event);
        this.worldInfo.setWorldTime(event.getTime());
    }
