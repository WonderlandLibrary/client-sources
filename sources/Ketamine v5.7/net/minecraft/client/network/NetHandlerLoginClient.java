...
public class NetHandlerLoginClient implements INetHandlerLoginClient
{
    ...
    public void handleLoginSuccess(S02PacketLoginSuccess packetIn)
    {
        ...
        // FIND ME :: Discord RPC server IP update
        KetamineClient.getInstance().updateDiscordRPC(String.format("Currently playing on %s.", this.mc.getCurrentServerData().serverIP));
    }
