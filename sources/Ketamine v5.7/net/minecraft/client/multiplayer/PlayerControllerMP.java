...
import io.github.nevalackin.client.event.player.BlockPlaceEvent;
import io.github.nevalackin.client.event.player.GetClientSideCurrentSlotEvent;
import io.github.nevalackin.client.event.player.WindowClickEvent;
...
public class PlayerControllerMP {
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing) {
        ...
        if (this.blockHitDelay > 0) {
            ...
            if (block.getMaterial() == Material.air) {
                ...
                // FIND ME :: PlayerDamageBlockEvent
                final PlayerDamageBlockEvent onDamageBlock = new PlayerDamageBlockEvent();
                KetamineClient.getInstance().getEventBus().post(onDamageBlock);
    ...
    public void syncCurrentPlayItem() {
        ...
        final GetClientSideCurrentSlotEvent event = new GetClientSideCurrentSlotEvent(this.mc.thePlayer.inventory.currentItem);
...
//        System.out.println("held: " + i);
        ...
        if (i != this.currentPlayerItem) {
            this.netClientHandler.sendPacket(new C09PacketHeldItemChange(i));
    ...
    public void windowClick(int windowId, int slotId, int mouseButtonClicked, int mode, EntityPlayer playerIn) {
        // FIND ME :: WindowClickEvent

        KetamineClient.getInstance().getEventBus().post(
            new WindowClickEvent(windowId, slotId, mouseButtonClicked, mode));

        ItemStack itemstack = playerIn.openContainer.slotClick(slotId, mouseButtonClicked, mode, playerIn);
        this.netClientHandler.sendPacket(new C0EPacketClickWindow(windowId, slotId, mouseButtonClicked, mode, itemstack,
                                                                  playerIn.openContainer.getNextTransactionID(playerIn.inventory)));
    }
