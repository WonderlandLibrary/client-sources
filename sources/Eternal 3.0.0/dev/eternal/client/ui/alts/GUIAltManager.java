...
public final class GUIAltManager extends GuiScreen {
  ...
  final TrueTypeFontRenderer font = FontManager.getFontRenderer(FontType.ICIEL, 19);
  ...
  protected void actionPerformed(GuiButton button) {
    try {
      switch (button.id) {
        ...
        case 3:
          thread = null;
          crackedStatus = RandomStringUtils.randomAlphabetic(15);
          thread = new LoginThread(crackedStatus, "");
          thread.start();
          break;
  ...
  public void drawScreen(int x, int y2, float z) {
    ...
    font.drawCenteredStringWithShadow(thread == null ? (crackedStatus == null ? EnumChatFormatting.GRAY + "Idle" : EnumChatFormatting.GREEN + crackedStatus) : thread.status(), width / 2F, 29, -1);
  ...
  public void initGui() {
    ...
    password = new GuiPasswordField(var3, mc.fontRendererObj, width / 2 - 100, 100, 200, 20);
  ...
  @Override
  public void mouseClicked(int x, int y2, int button) {
    try {
