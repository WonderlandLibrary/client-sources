...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(8325, 4, 4, 100, 20, "KillAura"));
        this.buttonList.add(new GuiButton(246, 4, 29, 100, 20, "ChestStealer"));
    }

    protected void actionPerformed(GuiButton var1) throws IOException {
        if (var1.id == 8325) {
            Monsoon.killAura.toggle();
        }
        if (var1.id == 246) {
            Monsoon.cheststealer.toggle();
        }
    }
