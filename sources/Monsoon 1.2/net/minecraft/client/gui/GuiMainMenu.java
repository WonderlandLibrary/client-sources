...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        //this.buttonList.add(this.field_175372_K = new GuiButton(500, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "Alt manager"));
        this.buttonList.add(this.field_175372_K = new GuiButton(1173, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "Alt manager"));
        
        // was : this.buttonList.add(this.field_175372_K = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("menu.online", new Object[0])));
        //this.buttonList.add(new GuiButton(14, this.width / 2- 100, this.height / 4 * 48 + 24 * 2, "Login"));
