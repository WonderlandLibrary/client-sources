...
import dev.monsoon.util.render.AnimatedResourceLocation;
...
public class GuiDisconnected extends GuiScreen
{
    ...
    private AnimatedResourceLocation configgy;
    private int sex;
    ...
    {
        //configgy = new AnimatedResourceLocation("monsoon/config_issue",107, 1);
    ...
    {
        configgy = new AnimatedResourceLocation("monsoon/config_issue",107, 1);
        sex = (int) MathUtils.randomNumber(100, 1);
    	if(mc.theWorld == null)
    		NotificationManager.show(new Notification(NotificationType.ERROR, "Disconnected", "If this was a kick, report to the Devs.", 2));
    	Monsoon.cheststealer.setEnabledSilent(false);
    	Monsoon.manager.crasher.setEnabledSilent(false);
        Monsoon.manager.killAura.setEnabledSilent(false);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if(sex == 69) {
            DrawUtil.draw2DImage(configgy.getTexture(), this.width / 2 - 70, 14, 140, 213, Color.white);
        }
