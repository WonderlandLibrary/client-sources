...
public class Gui
{
     ...
     */
    public void drawString(FontRenderer fontRendererIn, String text, float f, float g, int color)
    {
        fontRendererIn.drawStringWithShadow(text, (float)f, (float)g, color);
    }
    ...
    public static void drawModalRectWithCustomSizedTexture(float f, float g, float u, float v, float imageSpace, float imageSpace2, float textureWidth, float textureHeight)
    {
        ...
        var11.addVertexWithUV((double)f, (double)(g + imageSpace2), 0.0D, (double)(u * var8), (double)((v + (float)imageSpace2) * var9));
        var11.addVertexWithUV((double)(f + imageSpace), (double)(g + imageSpace2), 0.0D, (double)((u + (float)imageSpace) * var8), (double)((v + (float)imageSpace2) * var9));
        var11.addVertexWithUV((double)(f + imageSpace), (double)g, 0.0D, (double)((u + (float)imageSpace) * var8), (double)(v * var9));
        var11.addVertexWithUV((double)f, (double)g, 0.0D, (double)(u * var8), (double)(v * var9));
        var10.draw();
    }
