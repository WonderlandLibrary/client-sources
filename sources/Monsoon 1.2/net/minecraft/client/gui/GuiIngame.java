...
import dev.monsoon.event.EventType;
...
public class GuiIngame extends Gui
{
    ...
    public void func_175180_a(float p_175180_1_)
    {
        ...
        EventRenderGUI e = new EventRenderGUI(var2, p_175180_1_, var2.getScaledWidth(), var2.getScaledHeight());
    	...
    	if(Monsoon.authorized) {
            Monsoon.hud.draw();
            //Monsoon.hudManagaer.renderMods();
    ...
    protected void func_180479_a(ScaledResolution p_180479_1_, float p_180479_2_)
    {
        if (this.mc.func_175606_aa() instanceof EntityPlayer)
        {
            ...
            int color = new Color(0, 170, 255, 255).getRGB();
            ...
            if(Monsoon.arraylist.color.is("Astolfo")) {
                color = ColorUtil.astolfoColors(10, 30);
            }
    		
            if(Monsoon.arraylist.hotbar.is("German")) {
	            drawRect(0, p_180479_1_.getScaledHeight() - 22, p_180479_1_.getScaledWidth(), p_180479_1_.getScaledHeight(), new Color(0, 0, 0, 130).getRGB());
	            drawRect(0, p_180479_1_.getScaledHeight() - 22, p_180479_1_.getScaledWidth(), p_180479_1_.getScaledHeight() - 21, color);
	            drawRect(var4 - 88 - 1 + var3.inventory.currentItem * 20, p_180479_1_.getScaledHeight() - 21, var4 - 70 + var3.inventory.currentItem * 20, p_180479_1_.getScaledHeight(), new Color(255, 255, 255, 90).getRGB()); //TODO: Custom slot
            } else if (Monsoon.arraylist.hotbar.is("Normal")){
    ...
    private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        while (var12.hasNext())
        {
            ...
            var15 = var15.replace("www.hypixel.net", "monsoon.wtf");
            ...
            if (var11 == var21.size())
            {
                ...
                var20 = var20.replace("www.hypixel.net", "monsoon.wtf");
