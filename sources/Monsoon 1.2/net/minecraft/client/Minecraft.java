...
import dev.monsoon.auth.MonsoonLoginScreen;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public String serverName; // was private
    public int serverPort; // was private
    ...
    public boolean integratedServerIsRunning; // was private
    ...
    private void startGame() throws LWJGLException
    {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new MonsoonLoginScreen(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new MonsoonLoginScreen());
        }
    ...
    private void func_175594_ao()
    {
        ...
        if (var1 != Util.EnumOS.OSX)
        {
            ...
            try
            {
                var2 = this.mcDefaultResourcePack.func_152780_c(new ResourceLocation("monsoon/icon/icon_16x16.png"));
                var3 = this.mcDefaultResourcePack.func_152780_c(new ResourceLocation("monsoon/icon/icon_32x32.png"));
    ...
    public void displayCrashReport(CrashReport crashReportIn)
    {
        ...
        File var3 = new File(var2, "crash-" + (new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss")).format(new Date()) + "-client.monsoon");
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new MonsoonMainMenu();
        }
        ...
        if (guiScreenIn instanceof MonsoonMainMenu)
        {
    ...
    private void sendClickBlockToController(boolean leftClick)
    {
        ...
        if (this.leftClickCounter <= 0 && !this.thePlayer.isUsingItem())
        {
            if (leftClick && this.objectMouseOver != null && this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
            {
                ...
                if (this.theWorld.getBlockState(var2).getBlock().getMaterial() != Material.air && this.playerController.onPlayerDamageBlock(var2, this.objectMouseOver.field_178784_b))
                {
