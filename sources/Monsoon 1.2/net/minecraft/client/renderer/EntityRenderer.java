...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void func_175068_a(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        EventRender3D render = new EventRender3D(partialTicks);
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof MonsoonMainMenu)
        {
            this.updateMainMenu((MonsoonMainMenu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(MonsoonMainMenu mainGui)
    {
        try
        {
            String e = null;
            ...
            Field[] fs = MonsoonMainMenu.class.getDeclaredFields();
