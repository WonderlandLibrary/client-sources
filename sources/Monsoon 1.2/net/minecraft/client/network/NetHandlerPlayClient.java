...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void onDisconnect(IChatComponent reason)
    {
        ...
        {
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new MonsoonMainMenu()), "disconnect.lost", reason));
        }
    }
    ...
    public void sendPacketNoEvent(Packet p_147297_1_) //Client-made method, only purpose is to bypass client Events so it doesn't trigger any events and can't be cancelled
    {
