...
import dev.monsoon.module.implementation.movement.Safewalk;
...
public abstract class Entity implements ICommandSender
{
    ...
    public AxisAlignedBB boundingBox; // was not public
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double var15 = y;
            double var17 = z;
            boolean var19 = (this.onGround && this.isSneaking() && this instanceof EntityPlayer) || ((Safewalk.isEnabled || (Monsoon.scaffold.safewalk.enabled && Monsoon.scaffold.isEnabled())) && Minecraft.getMinecraft().thePlayer.onGround);
