...
public class Session
{
    ...
    {
        this.username = p_i1098_1_; // old = this.username = p_i1098_1_;
        this.playerID = p_i1098_2_; // old = this.playerID = p_i1098_2_;
        this.token = p_i1098_3_; // old = this.token = p_i1098_3_;
        this.sessionType = Session.Type.setSessionType(p_i1098_4_); // old = this.sessionType = Session.Type.setSessionType(p_i1098_4_);
    }
