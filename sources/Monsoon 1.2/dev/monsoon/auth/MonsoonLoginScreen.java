...
import dev.monsoon.ui.alt.PasswordField;
...
public final class MonsoonLoginScreen extends GuiScreen {
    ...
    public void drawScreen(int x2, int y2, float z2) {
        ...
        Monsoon.getLargeFont().drawString("Monsoon Login",this.width / 2 - 145, this.height / 2 - 93,-1);

        GlStateManager.pushMatrix();
        GlStateManager.scale(0.9, 0.9, 0.9);
        Monsoon.getFont().drawString("Version: " + Monsoon.version, 2, 2, -1);
        Monsoon.getFont().drawString("Build Type: " + Monsoon.type, 2, 2 + Monsoon.getFont().getHeight() + 2, -1);
        Monsoon.getFont().drawString("Modules: " + Monsoon.manager.modules.size(), 2, 2 + (Monsoon.getFont().getHeight() * 2) + 2, -1);
        Monsoon.getFont().drawString("Commands: " + Monsoon.commandManager.commands.size(), 2, 2 + (Monsoon.getFont().getHeight() * 3) + 2, -1);
        Monsoon.getFont().drawString("Made with \u2764 by quick", 2, 2 + (Monsoon.getFont().getHeight() * 4) + 2, -1);
