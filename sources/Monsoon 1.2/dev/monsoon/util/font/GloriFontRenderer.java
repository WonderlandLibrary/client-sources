...
public final class GloriFontRenderer extends GloriFont {

    protected final GloriFont.CharData[] boldItalicChars = new GloriFont.CharData[256];
    protected final GloriFont.CharData[] italicChars = new GloriFont.CharData[256];
    protected final GloriFont.CharData[] boldChars = new GloriFont.CharData[256];
    ...
    public GloriFontRenderer(ResourceLocation resourceLocation, float size) {
    ...
    public float drawString(String text, double x, double y, int color, boolean shadow) {
        ...
        GloriFont.CharData[] currentData = this.charData;
