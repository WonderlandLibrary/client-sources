...
public class SaveLoad {
	...
	public void save() {
		...
		for(Module mod : Monsoon.modules) {
		...
		toSave.add("COMMANDPREFIX:" + Monsoon.commandManager.prefix);
	...
	public void load() {
		...
		for(String s : lines) {
			...
			if(s.toLowerCase().startsWith("module:")) {
				Module m = Monsoon.getModule(args[1]);
				if(m != null) {
				...
				Monsoon.commandManager.setPrefix(args[1]);
			}
		}
	}
}