...
extends Thread {
    ...
    public void run() {
        ...
        /*if (this.password.equals("") && this.username.equals("")) {
        	String newName = UsernameUtil.getNewName();
            SessionChanger.getInstance().setUserOffline(newName);
            this.status = (Object)((Object)EnumChatFormatting.GREEN) + "Logged in. (" + newName + " - offline name)";
            return;
        }*/
