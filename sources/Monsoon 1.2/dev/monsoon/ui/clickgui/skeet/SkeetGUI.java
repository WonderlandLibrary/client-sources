package dev.monsoon.ui.clickgui.skeet;
...
import dev.monsoon.ui.clickgui.dropdown1.api.CGUI;
import dev.monsoon.ui.clickgui.skeet.comp.ModuleButton;
import dev.monsoon.ui.clickgui.skeet.comp.SkeetCategoryButton;
import dev.monsoon.ui.hud.DraggableComponent;
...
public class SkeetGUI extends GuiScreen {
    ...
    public void initGui() {
        ...
        setConfiguring(Monsoon.manager.getModulesByCategory(viewing).get(0));
        super.initGui();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Monsoon.getFont().drawString(viewing.getName(), top.getxPosition() + 85, top.getyPosition() + 10, -1);
        Gui.drawRect(top.getxPosition() + 84, top.getyPosition() + 10 + Monsoon.getFont().getHeight() + 1,top.getxPosition() + 85 + Monsoon.getFont().getStringWidth(viewing.getName()) + 1, top.getyPosition() + 10 + Monsoon.getFont().getHeight() + 3, -1);
        ...
        int countModule = 2;
        for(Module m  : Monsoon.manager.getModulesByCategory(viewing)) {
        ...
        for(Setting set : configuring.settings) {
            Monsoon.getFont().drawString(set.name, top.getxPosition() + 195, top.getyPosition() + 15 * countSetting, -1);
            countSetting++;
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        for(ModuleButton b : moduleButtons) {
            if(RenderUtil.isHovered(b.x + b.w + 2, b.y + 1, b.x + b.w + 11, b.y + b.h, mouseX, mouseY) && b.m.category == viewing) {
                ...
                if (mouseButton == 1) Monsoon.getSkeetGui().setConfiguring(b.m);
            }
