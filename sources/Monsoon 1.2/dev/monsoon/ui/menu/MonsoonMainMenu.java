...
public class MonsoonMainMenu extends GuiScreen {
	...
	public void initGui() {
		...
		buttonList.add(new GuiButton(1, this.width / 2 - 100, var3 + 52, 98, 20, "Singleplayer"));
		buttonList.add(new GuiButton(2, this.width / 2 + 2, var3 + 52, 98, 20, "Multiplayer"));

		buttonList.add(new GuiButton(4, this.width / 2 - 100, var3 + 76, 98, 20, "Alts"));
		buttonList.add(new GuiButton(3, this.width / 2 + 2, var3 + 76, 98, 20, "Settings"));

		buttonList.add(new GuiButton(5, this.width / 2 - 100, var3 + 100, 98, 20, "Language"));
		buttonList.add(new GuiButton(6, this.width / 2 + 2, var3 + 100, 98, 20, "Quit"));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(fontRendererObj, "Welcome to Monsoon, " + Monsoon.monsoonUsername + "! Current build: " + Monsoon.version, 4, 4, -1);
		GlStateManager.popMatrix();
		...
		for(ImageButton i : this.imageButtons) {
			i.draw(mouseX, mouseY, Color.WHITE);
		}
