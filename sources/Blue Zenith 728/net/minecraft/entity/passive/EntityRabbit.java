    ...
    static class AIRaidFarm extends EntityAIMoveToBlock
    {
        ...
        public void updateTask()
        {
            ...
            if (this.getIsAboveDestination())
            {
                ...
                if (this.field_179499_e && block instanceof BlockCarrot && ((Integer)iblockstate.getValue(BlockCarrot.AGE)) == 7)
                {
        ...
        protected boolean shouldMoveTo(World worldIn, BlockPos pos)
        {
            ...
            if (block == Blocks.farmland)
            {
                ...
                if (block instanceof BlockCarrot && ((Integer)iblockstate.getValue(BlockCarrot.AGE)) == 7 && this.field_179498_d && !this.field_179499_e)
                {
