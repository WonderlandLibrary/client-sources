...
public class C03PacketPlayer implements Packet<INetHandlerPlayServer> {
    ...
    public boolean s08response = false;
    ...
    public static class C04PacketPlayerPosition extends C03PacketPlayer {
        ...
        public C04PacketPlayerPosition(double posX, double posY, double posZ, boolean isOnGround, boolean s08response) {
            this.x = posX;
            this.y = posY;
            this.z = posZ;
            this.onGround = isOnGround;
            this.moving = true;
            this.s08response = s08response;
        }
    ...
    public static class C05PacketPlayerLook extends C03PacketPlayer {
        ...
        public C05PacketPlayerLook(float playerYaw, float playerPitch, boolean isOnGround, boolean s08response) {
            this.yaw = playerYaw;
            this.pitch = playerPitch;
            this.onGround = isOnGround;
            this.rotating = true;
    ...
    public static class C06PacketPlayerPosLook extends C03PacketPlayer {
        ...
        public C06PacketPlayerPosLook(double playerX, double playerY, double playerZ, float playerYaw, float playerPitch, boolean playerIsOnGround, boolean s08response) {
            this.x = playerX;
            this.y = playerY;
            this.z = playerZ;
            this.yaw = playerYaw;
