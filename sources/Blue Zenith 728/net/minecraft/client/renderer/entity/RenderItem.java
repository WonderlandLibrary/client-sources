...
import static club.bluezenith.module.modules.render.Glint.glint;
...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void renderEffect(IBakedModel model)
    {
        if (!Config.isCustomItems() || CustomItems.isUseGlint())
        {
            if (!Config.isShaders() || !Shaders.isShadowPass)
            {
                ...
                this.renderModel(model, glint.getState() ? glint.color() : -8372020);
                GlStateManager.popMatrix();
    ...
    public void renderItemIntoGUI(ItemStack stack, int x, int y)
    {
        ...
        if(HUD.shouldRotateItems()) {
            stack.incrementAngle();
            GlStateManager.rotate(stack.angle, 1, 1, 1);
        }
