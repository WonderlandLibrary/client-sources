...
public abstract class Render<T extends Entity> implements IEntityRenderer
{
    ...
    private void renderEntityOnFire(Entity entity, double x, double y, double z, float partialTicks)
    {
        ...
        while (f3 > 0.0F)
        {
            ...
            worldrenderer.pos(f1 - f2, 0.0F - f4, f5).func_181673_a(f8, f9).endVertex();
            worldrenderer.pos(-f1 - f2, 0.0F - f4, f5).func_181673_a(f6, f9).endVertex();
            worldrenderer.pos(-f1 - f2, 1.4F - f4, f5).func_181673_a(f6, f7).endVertex();
            worldrenderer.pos(f1 - f2, 1.4F - f4, f5).func_181673_a(f8, f7).endVertex();
            f3 -= 0.45F;
            f4 -= 0.45F;
            f1 *= 0.9F;
            f5 += 0.03F;
    ...
    private void func_180549_a(Block blockIn, double p_180549_2_, double p_180549_4_, double p_180549_6_, BlockPos pos, float p_180549_9_, float p_180549_10_, double p_180549_11_, double p_180549_13_, double p_180549_15_)
    {
        if (blockIn.isFullCube())
        {
            ...
            if (d0 >= 0.0D)
            {
                ...
                worldrenderer.pos(d1, d3, d4).func_181673_a(f, f2).func_181666_a(1.0F, 1.0F, 1.0F, (float)d0).endVertex();
                worldrenderer.pos(d1, d3, d5).func_181673_a(f, f3).func_181666_a(1.0F, 1.0F, 1.0F, (float)d0).endVertex();
                worldrenderer.pos(d2, d3, d5).func_181673_a(f1, f3).func_181666_a(1.0F, 1.0F, 1.0F, (float)d0).endVertex();
                worldrenderer.pos(d2, d3, d4).func_181673_a(f1, f2).func_181666_a(1.0F, 1.0F, 1.0F, (float)d0).endVertex();
            }
        }
    }
    ...
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance)
    {
        ...
        if(entityIn instanceof EntityLivingBase) {
            final RenderNameTagEvent event = new RenderNameTagEvent((EntityLivingBase) entityIn);
        ...
        if (d0 <= (double)(maxDistance * maxDistance))
        {
            ...
            if(!cancelled) {
                ...
                worldrenderer.pos(-j - 1, -1 + i, 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).endVertex();
                worldrenderer.pos(-j - 1, 8 + i, 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).endVertex();
                worldrenderer.pos(j + 1, 8 + i, 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).endVertex();
                worldrenderer.pos(j + 1, -1 + i, 0.0D).func_181666_a(0.0F, 0.0F, 0.0F, 0.25F).endVertex();
                tessellator.draw();
            }
