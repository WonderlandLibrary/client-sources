...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
     ...
     */
    boolean unlockedSussy;
    public void initGui()
    {
        //RPCManager.updateRPC("Options", "");
        int i = 0;
        ...
        {
            //GuiOptionButton guioptionbutton1 = new GuiOptionButton(69 , this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), "");
            //this.buttonList.add(guioptionbutton1);
        }

        if(mc.thePlayer == null)
        this.buttonList.add(new GuiButton(69420, this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), 150, 20, "Sussy Settings..."));
    ...
    {
        if(button.id == 69420) {
            BlueZenith.getBlueZenith().getNotificationPublisher().postError(BlueZenith.getBlueZenith().getName(), "This GUI is temporaily disabled.", 2000);
        }
        if (button.enabled)
        {
            ...
            {
                this.mc.gameSettings.saveOptions();
                this.mc.displayGuiScreen(new GuiConfirmDialog(this, false, (accepted) -> {
                    if(accepted)
                        mc.displayGuiScreen(new GuiLanguage(this, this.game_settings_1, this.mc.getLanguageManager()));
                }, 3000).setTitle("Are you sure you want to change language?"));
            }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        FontUtil.SFLight42.drawCenteredString(this.field_146442_a, this.width / 2f, 15, -1);
