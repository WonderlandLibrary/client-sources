...
public abstract class GuiSlot
{
    ...
    protected float yCropUpper = 30;
    protected float yCropBottom = 30;
    ...
    public void drawScreen(int mouseXIn, int mouseYIn, float p_148128_3_)
    {
        if (this.field_178041_q)
        {
            ...
            if(this instanceof GuiResourcePackList)
...
/*
    ...
    {
        int i = this.getSize();
        final boolean flag = this instanceof GuiResourcePackList;
        if(!flag)
        GL11.glEnable(GL11.GL_SCISSOR_TEST);
        int i1 = this.left + (this.width / 2 - this.getListWidth() / 2);
        int j1 = this.left + this.width / 2 + this.getListWidth() / 2;
        if(this instanceof ServerSelectionList)
        RenderUtil.rect(i1 - 10, yCropUpper, j1 + 5,this.bottom - 5, new Color(0, 0, 0, 50));
        for (int j = 0; j < i; ++j)
        {
            if(!flag)
            RenderUtil.crop(0, yCropUpper + 2, this.width, this.bottom - 5);
            ...
            {
                RenderUtil.hollowRect(i1, k - 2, j1, k + l + 2, 2, new Color(154, 154, 154, 180).getRGB());
                RenderUtil.rect(i1, k - 2, j1, k + l + 2, new Color(0, 0, 0, 100));
            }
