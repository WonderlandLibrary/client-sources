...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public Animate anim = new Animate().setMin(0).setMax(1).setEase(Easing.CUBIC_OUT).setSpeed(1);
     ...
     */
    public static float playtimeYOffset;
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        GlStateManager.translate(((width / 2 - l1 / 2 - 1) + (width / 2 + l1 / 2 + 1)) / 2,((k1 - 1) + (k1 + list1.size() * this.mc.fontRendererObj.FONT_HEIGHT)) / 2, 0);
        GlStateManager.scale((anim.getValue() * 0.3) + 0.7, (anim.getValue() * 0.3) + 0.7, 1);
        GlStateManager.translate(-((width / 2 - l1 / 2 - 1) + (width / 2 + l1 / 2 + 1)) / 2,-((k1 - 1) + (k1 + list1.size() * this.mc.fontRendererObj.FONT_HEIGHT)) / 2, 0);
