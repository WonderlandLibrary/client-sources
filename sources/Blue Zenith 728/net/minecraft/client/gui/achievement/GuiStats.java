...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    private void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_)
    {
        ...
        worldrenderer.pos((double)(p_146527_1_), (double)(p_146527_2_ + 18), (double)this.zLevel).func_181673_a((double)((float)(p_146527_3_) * 0.0078125F), (double)((float)(p_146527_4_ + 18) * 0.0078125F)).endVertex();
        worldrenderer.pos((double)(p_146527_1_ + 18), (double)(p_146527_2_ + 18), (double)this.zLevel).func_181673_a((double)((float)(p_146527_3_ + 18) * 0.0078125F), (double)((float)(p_146527_4_ + 18) * 0.0078125F)).endVertex();
        worldrenderer.pos((double)(p_146527_1_ + 18), (double)(p_146527_2_), (double)this.zLevel).func_181673_a((double)((float)(p_146527_3_ + 18) * 0.0078125F), (double)((float)(p_146527_4_) * 0.0078125F)).endVertex();
        worldrenderer.pos((double)(p_146527_1_), (double)(p_146527_2_), (double)this.zLevel).func_181673_a((double)((float)(p_146527_3_) * 0.0078125F), (double)((float)(p_146527_4_) * 0.0078125F)).endVertex();
        tessellator.draw();
    }
