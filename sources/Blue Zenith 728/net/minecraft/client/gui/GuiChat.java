...
public class GuiChat extends GuiScreen {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        BlueZenith.getBlueZenith().getDraggableRenderer().mouseClicked(mouseX, mouseY, mouseButton);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        BlueZenith.getBlueZenith().getDraggableRenderer().doDragging(mouseX, mouseY); //find me draggable shit
       //todo remove elementmanager BlueZenith.getBlueZenith().getElementManager().render(mouseX, mouseY, new Render2DEvent(partialTicks, new ScaledResolution(mc)));
    }
