...
public class GuiStreamIndicator
{
    ...
    private void render(int p_152436_1_, int p_152436_2_, int p_152436_3_, int p_152436_4_)
    {
        ...
        worldrenderer.pos((double)(p_152436_1_ - p_152436_4_), (double)(p_152436_2_), (double)f).func_181673_a((double)f3, (double)f2).endVertex();
        worldrenderer.pos((double)(p_152436_1_ - 16 - p_152436_4_), (double)(p_152436_2_), (double)f).func_181673_a((double)f1, (double)f2).endVertex();
        tessellator.draw();
