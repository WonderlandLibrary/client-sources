...
public class RenderManager
{
     ...
     */
    private void renderDebugBoundingBox(Entity entityIn, double xPos, double yPos, double zPos, float entityYaw, float partialTicks)
    {
        ...
        AxisAlignedBB var12 = new AxisAlignedBB(var11.minX - entityIn.posX + xPos, var11.minY - entityIn.posY + yPos, var11.minZ - entityIn.posZ + zPos, var11.maxX - entityIn.posX + xPos, var11.maxY - entityIn.posY + yPos, var11.maxZ - entityIn.posZ + zPos);
        RenderGlobal.drawOutlinedBoundingBox(var12, 16777215);

        if (entityIn instanceof EntityLivingBase)
        {
            float var16 = 0.01F;
            RenderGlobal.drawOutlinedBoundingBox(new AxisAlignedBB(xPos - (double)var10, yPos + (double)entityIn.getEyeHeight() - 0.009999999776482582D, zPos - (double)var10, xPos + (double)var10, yPos + (double)entityIn.getEyeHeight() + 0.009999999776482582D, zPos + (double)var10), 16711680);
        }

        Tessellator var161 = Tessellator.getInstance();
        WorldRenderer var14 = var161.getWorldRenderer();
        Vec3 var15 = entityIn.getLook(partialTicks);
        var14.startDrawing(3);
        var14.func_178991_c(255);
        var14.addVertex(xPos, yPos + (double)entityIn.getEyeHeight(), zPos);
        var14.addVertex(xPos + var15.xCoord * 2.0D, yPos + (double)entityIn.getEyeHeight() + var15.yCoord * 2.0D, zPos + var15.zCoord * 2.0D);
        var161.draw();
