...
public class ActiveRenderInfo
{
    ...
    public static void updateRenderInfo(EntityPlayer p_74583_0_, boolean p_74583_1_)
    {
        ...
        GLU.gluUnProject(var2, var3, 0.0F, MODELVIEW, PROJECTION, field_178814_a, OBJECTCOORDS);
        field_178811_e = new Vec3((double)OBJECTCOORDS.get(0), (double)OBJECTCOORDS.get(1), (double)OBJECTCOORDS.get(2));
