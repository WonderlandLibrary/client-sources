...
public class VertexFormat
{
    ...
    public VertexFormat(VertexFormat p_i46097_1_)
    {
        ...
        this.nextOffset = p_i46097_1_.func_177338_f();
    }
    ...
    public void func_177349_a(VertexFormatElement p_177349_1_)
    {
        ...
        else
        {
            ...
            this.field_177356_c.add(Integer.valueOf(this.nextOffset));
            p_177349_1_.func_177371_a(this.nextOffset);
            this.nextOffset += p_177349_1_.func_177368_f();
    ...
    public int func_181720_d(int p_181720_1_) {
        return (int) this.field_177356_c.get(p_181720_1_);
    }
    ...
    public boolean equals(Object p_equals_1_)
    {
        ...
        else if (p_equals_1_ != null && this.getClass() == p_equals_1_.getClass())
        {
            ...
            return this.nextOffset != var2.nextOffset ? false : (!this.field_177355_b.equals(var2.field_177355_b) ? false : this.field_177356_c.equals(var2.field_177356_c));
        }
        else
        {
            return false;
