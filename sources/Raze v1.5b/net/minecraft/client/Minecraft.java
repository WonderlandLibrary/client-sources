...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void setWindowIcon() {
		...
		try {
			inputStream16x16 = mcDefaultResourcePack.getInputStream(new ResourceLocation("icons/icon_16x16.png"));
			inputStream32x32 = mcDefaultResourcePack.getInputStream(new ResourceLocation("icons/icon_32x32.png"));
	...
	/**
	 * image to base64: https://www.browserling.com/tools/image-to-base64
	 */
            ...
            switch (Minecraft.SwitchEnumMinecartType.field_152390_a[this.objectMouseOver.typeOfHit.ordinal()])
            {
                ...
                case 2:
                    ...
                    if (this.theWorld.getBlockState(var3).getBlock().getMaterial() != Material.air)
                    {
                        ...
                        if (this.playerController.onPlayerRightClick(this.thePlayer, this.theWorld, var2, var3, this.objectMouseOver.field_178784_b, this.objectMouseOver.hitVec))
                        {
                            var1 = false;
                            this.thePlayer.swingItem();
                        }
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        //Raze
        Client.getDiscordRP().update("Playing Singleplayer", "");;
    }
