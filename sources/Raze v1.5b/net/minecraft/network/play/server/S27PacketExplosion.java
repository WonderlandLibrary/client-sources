...
{
    private double field_149158_a; //posX
    private double field_149156_b; //posY
    private double field_149157_c; //posZ
    private float field_149154_d; //explosion strength
    private List field_149155_e; //affected block poss
    public float field_149152_f; //motionX
    public float field_149153_g; //motionY
    public float field_149159_h; //motionZ
    ...
    public float func_149149_c() //getMotionX
    {
        return this.field_149152_f;
    }

    public float func_149144_d() //getMotionY
    {
        return this.field_149153_g;
    }

    public float func_149147_e() //getMotionZ
    {
