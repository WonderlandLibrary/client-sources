...
{
    private int field_149018_a; //entityId
    private int field_149016_b; //x
    private int field_149017_c; //y
    private int field_149014_d; //z
    private int field_149015_e; //speedX
    private int field_149012_f; //speedY
    private int field_149013_g; //speedZ
    private int field_149021_h; //pitch
    private int field_149022_i; //yaw
    public int field_149019_j; //type
    private int field_149020_k; //data
