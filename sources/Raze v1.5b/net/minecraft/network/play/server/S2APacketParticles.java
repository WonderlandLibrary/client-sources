...
{
    private EnumParticleTypes field_179751_a; //particleType
    ...
    public EnumParticleTypes func_179749_a() //getParticleType
    {
        return this.field_179751_a;
    }

    public boolean func_179750_b() //isLongDistance
    {
        return this.field_179752_j;
    }

    public double func_149220_d() //getXCoordinate
    {
        return (double)this.field_149234_b;
    }

    public double func_149226_e() //getYCoordinate
    {
        return (double)this.field_149235_c;
    }

    public double func_149225_f() //getZCoordinate
    {
        return (double)this.field_149232_d;
    }

    public float func_149221_g() //getXOffset
    {
        return this.field_149233_e;
    }

    public float func_149224_h() //getYOffset
    {
        return this.field_149230_f;
    }

    public float func_149223_i() //getZOffset
    {
        return this.field_149231_g;
    }

    public float func_149227_j() //getParticleSpeed
    {
        return this.field_149237_h;
    }

    public int func_149222_k() //getParticleCount
    {
        return this.field_149238_i;
    }

    public int[] func_179748_k() //getParticleArgs
    {
