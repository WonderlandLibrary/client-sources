...
public class BlockFenceGate extends BlockDirectional
{
    ...
    {
        return this.getDefaultState().withProperty(AGE, placer.getHorizontalFacing()).withProperty(field_176466_a, Boolean.valueOf(false)).withProperty(field_176465_b, Boolean.valueOf(false)).withProperty(field_176467_M, Boolean.valueOf(false));
    }
