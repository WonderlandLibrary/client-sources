...
public class BlockEnderChest extends BlockContainer
{
    ...
    {
        return this.getDefaultState().withProperty(field_176437_a, placer.getHorizontalFacing().getOpposite());
    }

    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        worldIn.setBlockState(pos, state.withProperty(field_176437_a, placer.getHorizontalFacing().getOpposite()), 2);
    }
