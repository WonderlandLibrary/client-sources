...
public class BlockLever extends Block
{
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
        ...
        {
            return var9.withProperty(FACING, BlockLever.EnumOrientation.func_176856_a(facing, placer.getHorizontalFacing()));
        }
        else
        {
            ...
            do
            {
                if (!var10.hasNext())
                {
                    ...
                    {
                        return var9.withProperty(FACING, BlockLever.EnumOrientation.func_176856_a(EnumFacing.UP, placer.getHorizontalFacing()));
                    }
            ...
            return var9.withProperty(FACING, BlockLever.EnumOrientation.func_176856_a(var11, placer.getHorizontalFacing()));
        }
    }
