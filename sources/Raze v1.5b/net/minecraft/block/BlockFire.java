...
public class BlockFire extends Block
{
    ...
    {
        return worldIn.isRainingAt(p_176537_2_) || worldIn.isRainingAt(p_176537_2_.offsetWest()) || worldIn.isRainingAt(p_176537_2_.offsetEast()) || worldIn.isRainingAt(p_176537_2_.offsetNorth()) || worldIn.isRainingAt(p_176537_2_.offsetSouth());
    }
    ...
    private void func_176536_a(World worldIn, BlockPos p_176536_2_, int p_176536_3_, Random p_176536_4_, int p_176536_5_)
    {
        ...
        if (p_176536_4_.nextInt(p_176536_3_) < var6)
        {
            ...
            if (p_176536_4_.nextInt(p_176536_5_ + 10) < 5 && !worldIn.isRainingAt(p_176536_2_))
            {
