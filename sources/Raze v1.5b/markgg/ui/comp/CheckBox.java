...
public class CheckBox extends Comp {
	...
	public CheckBox(double x, double y, GUIMethod parent, Module module, Setting setting) {
		this.x = x;
		this.y = y;
		this.parent = parent;
		this.module = module;
	...
	public CheckBox(double x, double y, GUIMethodLight parent1, Module module, Setting setting) {
		this.x = x;
		this.y = y;
	...
	public void drawScreen(int mouseX, int mouseY) {
		...
		Gui.drawRect(parent.posX + x - 70, parent.posY + y, parent.posX + x + 10 - 70, parent.posY + y + 10,((BooleanSetting) setting).isEnabled()? primaryColor : new Color(30,30,30).getRGB());
		Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(setting.name, (int)(parent.posX + x - 55), (int)(parent.posY + y + 1), -1);
	}
