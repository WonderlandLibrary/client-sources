...
public class Slider extends Comp {
	...
	public Slider(double x, double y, GUIMethod parent, Module module, Setting setting) {
		this.x = x;
		this.y = y;
		this.parent = parent;
		this.module = module;
	...
	public Slider(double x, double y, GUIMethodLight parent1, Module module, Setting setting) {
		this.x = x;
		this.y = y;
	...
	public void drawScreen(int mouseX, int mouseY) {
		...
		Gui.drawRect(parent.posX + x - 70, parent.posY + y + 10,parent.posX + x - 70 + renderWidth2, parent.posY + y + 20, secondaryColor);
		Gui.drawRect(parent.posX + x - 70, parent.posY + y + 10, parent.posX + x - 70 + renderWidth, parent.posY + y + 20, primaryColor);
		Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(setting.name + ": " + ((NumberSetting)setting).getValue(),(int)(parent.posX + x - 70),(int)(parent.posY + y), -1);
	}
