...
public class ComboLight extends CompLight {
	
	public ComboLight(double x, double y, GUIMethodLight parent1, Module module, Setting setting) {
		this.x = x;
		this.y = y;
	...
	public void drawScreen(int mouseX, int mouseY) {
		...
		Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(setting.name + ": " + ((ModeSetting)setting).getMode(), (int)(parent1.posX + x - 69), (int)(parent1.posY + y + 1), -1);
	}
