...
public class ALC10 {
	...
	public static final int ALC_FREQUENCY = ALC10.ALC_FREQUENCY;
	public static final int ALC_REFRESH = ALC10.ALC_REFRESH;
	public static final int ALC_SYNC = ALC10.ALC_SYNC;
	public static final int ALC_NO_ERROR = ALC10.ALC_NO_ERROR;
	public static final int ALC_DEFAULT_DEVICE_SPECIFIER = ALC10.ALC_DEFAULT_DEVICE_SPECIFIER;
	public static final int ALC_DEVICE_SPECIFIER = ALC10.ALC_DEVICE_SPECIFIER;
