...
import best.actinium.event.impl.move.*;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            Actinium.INSTANCE.getEventManager().publish(updateEvent);
            ...
            Actinium.INSTANCE.getEventManager().publish(motionEvent);
    ...
    public void onUpdateWalkingPlayer(MotionEvent motionEvent) {
        EntityActionEvent actionEvent = new EntityActionEvent(this.isSprinting(), this.isSneaking());
        Actinium.INSTANCE.getEventManager().publish(actionEvent);
        ...
        motionEvent.setType(EventType.MID);
        Actinium.INSTANCE.getEventManager().publish(motionEvent);
        ...
        if (this.ridingEntity == null) {
            ...
            boolean isMoving = deltaX * deltaX + deltaY * deltaY + deltaZ * deltaZ > 9.0E-4D || this.positionUpdateTicks >= 20;
            boolean isRotating = deltaYaw != 0.0D || deltaPitch != 0.0D;
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        Actinium.INSTANCE.getEventManager().publish(event);
    ...
    {
        EventPushBlock push = new EventPushBlock();
        Actinium.INSTANCE.getEventManager().publish(push);
        if (this.noClip)
        {
            return false;
        }
    ...
    public void displayGUIChest(IInventory chestInventory)
    {
        ...
        {
            ChestGuiEvent chestGuiEvent = new ChestGuiEvent();
            Actinium.INSTANCE.getEventManager().publish(chestGuiEvent);

            if(!chestGuiEvent.isCancelled()) {
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding())
        {
            ...
            Actinium.INSTANCE.getEventManager().publish(slowDownEvent);
            this.movementInput.moveStrafe *= slowDownEvent.isCancelled() ? slowDownEvent.getSlowdownAmount() : 0.2F;
            this.movementInput.moveForward *= slowDownEvent.isCancelled() ? slowDownEvent.getSlowdownAmount() : 0.2F;
