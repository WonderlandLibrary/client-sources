...
import best.actinium.module.impl.combat.KillauraModule;
import best.actinium.module.impl.visual.AnimationModule;
...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            float var15 = MathHelper.sin((float)(MathHelper.sqrt_float(f1) * Math.PI));
            AnimationModule anim = Actinium.INSTANCE.getModuleManager().get(AnimationModule.class);
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0 || (PlayerUtil.isHoldingSword() && Actinium.INSTANCE.getModuleManager().get(KillauraModule.class).fakeAutoblock.isEnabled() && Actinium.INSTANCE.getModuleManager().get(KillauraModule.class).target != null))
                {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                            if(!anim.isEnabled()) {
                                ...
                                GlStateManager.translate(anim.x.getValue().floatValue(),anim.y.getValue().floatValue(),anim.z.getValue().floatValue());

                                switch (anim.mode.getMode()) {
                                    case "None":
                                        this.transformFirstPersonItem(f, 0.0F);
                                        this.doBlockTransformations();
                                        break;
                                    ...
                                    case "Slide 2":
                                        ...
                                        GlStateManager.rotate(convertedProgress * -95.0F, 1.0F, 0.0F, 0.0F);

                                        GlStateManager.scale(0.285f, 0.285f, 0.285f);
                                        this.doBlockTransformations();
                                        break;
                                    case "Exhibition":
                                        ...
                                        break;
                                    case "ZeroDay":
                                        float idk = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.0F) * 1.75F;
                                        transformFirstPersonItem(f / 2.5F, 1.0F);

                                        GL11.glTranslated(-0.06D, Math.sin(System.currentTimeMillis() / 150.0D) * .15D + 0.42, -0.0D);
                                        GlStateManager.rotate(-idk * 20.0F, 3.2F, 2.0F, 8.0F);
                                        GlStateManager.rotate(-idk * 10.0F - 10.0F, 1.0F, idk / 3.5F, 0.0F);
                                        doBlockTransformations();
                                        break;
                                    case "Tap":
                                        ...
                                        break;
                                    case "Slide":
                                        GlStateManager.translate(-0.02D, 0.05000000074505806D, 0.0D);
                ...
                else
                {
                    ...
                    if (anim.isEnabled()) {
                        switch (anim.swingMode.getMode()) {
                            case "1.8":
                                this.transformFirstPersonItem(f, f1);
                                break;
                            case "1.9+":
                                transformFirstPersonItem(f, f1);
                                swing = mc.thePlayer.swingProgressInt == 1 ? 9 : Math.max(0, swing - 1);
