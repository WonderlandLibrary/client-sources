...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
        HurtCamEvent hurtEvent = new HurtCamEvent();
        Actinium.INSTANCE.getEventManager().publish(hurtEvent);

        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase && !hurtEvent.isCancelled())
        {
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        if (flag && Minecraft.isRunningOnMac && this.mc.inGameHasFocus && !Mouse.isGrabbed())
        {
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Actinium.INSTANCE.getEventManager().publish(render3DEvent);
