...
import best.actinium.event.impl.input.PossibleClickEvent;
...
import net.minecraft.viamcpFix.viamcp.fixes.AttackOrder;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public static final TimerUtil closeTimer = new TimerUtil();
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.theWorld != null && this.thePlayer != null) {
            final EarlyTickEvent eventEarlyTick = new EarlyTickEvent();
            Actinium.INSTANCE.getEventManager().publish(eventEarlyTick);
        }
        ...
        {
            PossibleClickEvent possibleClick = new PossibleClickEvent();
            Actinium.INSTANCE.getEventManager().publish(possibleClick);
            ...
            Actinium.INSTANCE.getEventManager().publish(new TickEvent());
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        Actinium.INSTANCE.getEventManager().publish(keyboardEvent);
            ...
            //thx e-sound uwu <:
            final ClickEvent eventClick = new ClickEvent(this.thePlayer.inventory.currentItem);
            final int oldSlot = this.thePlayer.inventory.currentItem;
            eventClick.setShouldRightClick(true);
            Actinium.INSTANCE.getEventManager().publish(eventClick);
