...
public class GuiChat extends GuiScreen
{
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        boolean hoveringResetButton = RenderUtil.isHovering(width / 2f - 100, 20, 200, 20, mouseX, mouseY);
        if (hoveringResetButton && mouseButton == 0) {
            for (Draggable draggable : DragManager.draggables.values()) {
                draggable.setXPos(draggable.initialXVal);
                draggable.setYPos(draggable.initialYVal);
            }
            return;
        }


        DragManager.draggables.values().forEach(draggable -> {
