...
import best.actinium.module.impl.visual.EffectsModule;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        EffectsModule effects = Actinium.INSTANCE.getModuleManager().get(EffectsModule.class);
        ...
        Actinium.INSTANCE.getEventManager().publish(render2DEvent);
