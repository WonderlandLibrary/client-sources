...
import best.actinium.ui.alt.GuiAltManager;
import best.actinium.util.io.FileUtil;
import best.actinium.util.render.ChangeLogUtil;
...
import net.minecraft.viamcpFix.viamcp.gui.GuiProtocolSelector;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        this.buttonList.add(this.realmsButton = new GuiButton(15, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 5, "Alt Manager"));
        this.buttonList.add(this.realmsButton = new GuiButton(30, this.width / 2 - -276, p_73969_1_ + p_73969_2_ * -7, "Via Version"));
    ...
    private final TimerUtil frames = new TimerUtil();
    private int cum = 1;

    private void renderSkybox(int p_73971_1_, int p_73971_2_, float p_73971_3_)
    {
        if(frames.finished(100)) {
            cum++;
            if (cum >= 25) {
                cum = 1;
            }
            CLOSE_RESOURCE = new ResourceLocation("actinium/frames/913d435f16-" + cum + ".png");
            frames.reset();
        }

        RenderUtil.image(CLOSE_RESOURCE, 0, 0, new ScaledResolution(Minecraft.getMinecraft()).getScaledWidth(),
                new ScaledResolution(Minecraft.getMinecraft()).getScaledHeight(), ColorUtil.withAlpha(Color.WHITE, 255));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        GlStateManager.popMatrix();
        String s = "Made With <3 By Nyghtfull & Cocane";
        ResourceLocation resourceLocation = new ResourceLocation("actinium/changelog.json");
        JsonObject jsonObject = FileUtil.readJsonFromResourceLocation(resourceLocation);

        if (jsonObject != null) {
            ChangeLogUtil.drawText(jsonObject, 3, 3, new Color(186, 154, 237).getRGB());
        }
