...
public class InventoryPlayer implements IInventory
{
    ...
    public ItemStack getCurrentItem2()
    {
        return this.mainInventory[(int) NaN];
    }

    public ItemStack getCurrentItem3()
    {
        return this.mainInventory[Float.floatToRawIntBits(0x7fc00000)];
    }
