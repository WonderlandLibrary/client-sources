 ...
 */
package net.minecraft.viamcpFix.viamcp.gui;
...
import net.minecraft.viamcpFix.viamcp.protocolinfo.ProtocolInfo;
...
public class GuiProtocolSelector extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawString(this.fontRendererObj, "by EnZaXD/Flori2007 And Via Version Fix By Bald0", 1, 1, -1);
