 ...
 */
package net.minecraft.viamcpFix.vialoadingbase.netty.handler;
...
public class VLBViaDecodeHandler extends MessageToMessageDecoder<ByteBuf> {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf bytebuf, List<Object> out) throws Exception {
        ...
        //1.17
        if(id == 48 && ViaLoadingBase.getInstance().getTargetVersion().isNewerThanOrEqualTo(ProtocolVersion.v1_12) && ViaLoadingBase.getInstance().getTargetVersion().isOlderThan(ProtocolVersion.v1_19)) {
