...
import best.actinium.module.impl.movement.PhaseModule;
...
import net.minecraft.viamcpFix.viamcp.fixes.FixedSoundEngine;
...
public abstract class World implements IBlockAccess
{
    ...
    public boolean canBlockBePlaced(Block blockIn, BlockPos pos, boolean p_175716_3_, EnumFacing side, Entity entityIn, ItemStack itemStackIn)
    {
        ...
        return Actinium.INSTANCE.getModuleManager().get(PhaseModule.class).isEnabled() ? true : axisalignedbb != null && !this.checkNoEntityCollision(axisalignedbb, entityIn) ? false : (block.getMaterial() == Material.circuits && blockIn == Blocks.anvil ? true : block.getMaterial().isReplaceable() && blockIn.canReplace(this, pos, side, itemStackIn));
    }
