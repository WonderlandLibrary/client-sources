package best.actinium.util.math.pathfinder;
...
public class NodeProcessor {
	...
	public ArrayList<Node> getPathVal() {
		return path;
	}
...
//		neighbors.add(createNode(b1.south()));
	...
	public Node createNode(BlockPos pos) {
		return new Node(mc.theWorld.getBlockState(pos).getBlock().getMaterial() == Material.air &&  mc.theWorld.getBlockState(pos.up()).getBlock().getMaterial() == Material.air, pos);
	}
