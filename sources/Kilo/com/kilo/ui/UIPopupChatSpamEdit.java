...
public class UIPopupChatSpamEdit extends UI {
	...
	public UIPopupChatSpamEdit(UI parent, String message) {
		super(parent);
	...
	public void setValues() {
		((TextBox)inters.get(2)).text = message;
	}
	
	public void submit() {
		int index = ChatSpamManager.getIndex(message);
		
		ChatSpamManager.removeMessage(message);
