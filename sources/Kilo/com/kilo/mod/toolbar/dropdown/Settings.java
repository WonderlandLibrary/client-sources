...
public class Settings extends Interactable {
	...
	public String text;
	public SettingsRel rel;
	
	public Settings(Window parent, TYPE type, SettingsRel rel, String text, int id, String help, float offsetX, float offsetY, float width, float height) {
