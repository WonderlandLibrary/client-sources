...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
    	if (this == Minecraft.getMinecraft().thePlayer && ModuleManager.get("noswing").active) {
    		return;
    	}
    ...
    {
        return 0.42F * (ModuleManager.get("highjump").active?Util.makeFloat(ModuleManager.get("highjump").getOptionValue("height")):1);
    }
    ...
    public void moveEntityWithHeading(float strafe, float forward)
    {
        ...
        if (this.isServerWorld())
        {
            ...
            else
            {
                ...
                if (Minecraft.getMinecraft().thePlayer != null && this == Minecraft.getMinecraft().thePlayer && ModuleManager.get("speed").active) {
                	var5*= Util.makeFloat(ModuleManager.get("speed").getOptionValue("speed"));
                }
                ...
                if (ModuleManager.get("fastladder").active) {
                	climbSpeed = Util.makeFloat(ModuleManager.get("fastladder").getOptionValue("climb speed"));
                }
                ...
                if (this.isOnLadder())
                {
                    ...
                    if (this.motionY < -climbSpeed)
                    {
                        this.motionY = -climbSpeed;
                    }
