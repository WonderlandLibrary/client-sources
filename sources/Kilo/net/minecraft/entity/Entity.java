...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double var15 = y;
            double var17 = z;
            boolean var19 = this.onGround && (this.isSneaking() || (ModuleManager.get("safewalk")).active) && this instanceof EntityPlayer;
            ...
            if (this.stepHeight > 0.0F && var54 && (var13 != x || var17 != z))
            {
                ...
                if (this.equals(Minecraft.getMinecraft().thePlayer)) {
	                Step s = (Step)ModuleManager.get("step");
	                s.onStep((float)var33);
                }
    ...
    {
    	return ModuleManager.get("underwaterwalk").active?false:this.inWater;
    }
