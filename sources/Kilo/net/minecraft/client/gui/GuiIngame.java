...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (this.field_175195_w > 0)
        {
            ...
            {
                float var14 = this.field_175199_z + this.field_175192_A + this.field_175193_B - var7;
                var8 = (int)(var14 * 255.0F / this.field_175199_z);
            }
        ...
        if (this.mc.gameSettings.keyBindPlayerList.isKeyDown() && (!this.mc.isIntegratedServerRunning() || this.mc.thePlayer.sendQueue.func_175106_d().size() > 1 || var16 != null))
        {
    ...
    public void renderExpBar(ScaledResolution p_175176_1_, int p_175176_2_)
    {
        ...
        {
            short var4 = 182;
            int var5 = (int)(this.mc.thePlayer.experience * (var4 + 1));
    ...
    private void renderPlayerStats(ScaledResolution p_180477_1_)
    {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer)
        {
            ...
            if (var2.isInsideOfMaterial(Material.water))
            {
                ...
                var25 = MathHelper.ceiling_double_int(var23 * 10.0D / 300.0D) - var36;
    ...
    {
    	if (ModuleManager.get("nooverlay").active) {
    		return;
    	}
        GlStateManager.disableDepth();
