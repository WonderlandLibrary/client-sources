...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    public void handleInput() throws IOException
    {
        ...
        if (Keyboard.isCreated())
        {
            while (Keyboard.next())
            {
            	if (ModuleManager.get("inventorywalk").active && this instanceof GuiContainer) {
    ...
    public void drawBackground(int tint)
    {
        ...
        var3.addVertexWithUV(0.0D, this.height, 0.0D, 0.0D, this.height / var4 + tint);
        var3.addVertexWithUV(this.width, this.height, 0.0D, this.width / var4, this.height / var4 + tint);
        var3.addVertexWithUV(this.width, 0.0D, 0.0D, this.width / var4, tint);
