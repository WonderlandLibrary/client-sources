	...
	public void handleEntityVelocity(S12PacketEntityVelocity packetIn)
    {
        ...
        if (var2 != null)
        {
        	if (var2 != Minecraft.getMinecraft().thePlayer) {
        		...
        		if (ModuleManager.get("noknockback").active) {
        		} else {
	        		if (ModuleManager.get("knockbackmultiplier").active) {
	        			float kb = Util.makeFloat(ModuleManager.get("knockbackmultiplier").getOptionValue("multiplier"));
	        			var2.addVelocity((double)packetIn.func_149411_d() / 8000.0D * kb, (double)packetIn.func_149410_e() / 8000.0D * kb, (double)packetIn.func_149409_f() / 8000.0D * kb);
	        		} else {
	        			var2.setVelocity((double)packetIn.func_149411_d() / 8000.0D, (double)packetIn.func_149410_e() / 8000.0D, (double)packetIn.func_149409_f() / 8000.0D);
	        		}
        		}
	...
	public void handlePlayerListItem(S38PacketPlayerListItem packetIn)
    {
        ...
        while (var2.hasNext())
        {
            ...
            if (packetIn.func_179768_b() == S38PacketPlayerListItem.Action.REMOVE_PLAYER)
            {
                ...
                UserHandler.remove(var3.func_179962_a());
            }
            else
            {
                ...
                if (packetIn.func_179768_b() == S38PacketPlayerListItem.Action.ADD_PLAYER)
                {
                    ...
                    UserHandler.add(var3.func_179962_a(), false);
                }
