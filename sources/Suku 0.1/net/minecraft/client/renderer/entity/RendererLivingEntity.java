...
import io.github.liticane.clients.feature.module.impl.visual.PlayerModel;
...
import io.github.liticane.clients.feature.event.impl.render.RenderModelEvent;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor)
    {
        ...
        if (flag || flag1)
        {
            ...
            if(Client.INSTANCE.getModuleManager().get(PlayerModel.class).isToggled() && entitylivingbaseIn == Minecraft.getInstance().player) {
                GlStateManager.scale(Client.INSTANCE.getModuleManager().get(PlayerModel.class).sizeX.getValue(),
                        Client.INSTANCE.getModuleManager().get(PlayerModel.class).sizeY.getValue(),
                        Client.INSTANCE.getModuleManager().get(PlayerModel.class).sizeZ.getValue());
            }
            ...
            Client.INSTANCE.getEventManager().handle(renderModelEvent);
    ...
    protected void rotateCorpse(T bat, float p_77043_2_, float p_77043_3_, float partialTicks)
    {
        ...
        else
        {
            ...
            if(Client.INSTANCE.getModuleManager().get(PlayerModel.class).isToggled()&& bat == Minecraft.getInstance().player)
            {
                GlStateManager.translate(0.0F, Client.INSTANCE.getModuleManager().get(PlayerModel.class).bat.isToggled() ? bat.height + 0.1F : 0.0f, 0.0F);
                GlStateManager.rotate((float)Client.INSTANCE.getModuleManager().get(PlayerModel.class).angle.getValue(),0.0F, 0.0F, 1.0F);
            }
        }
    }
