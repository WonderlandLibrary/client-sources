...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        Animations animation = Client.INSTANCE.getModuleManager().get(Animations.class);
        if(animation.isToggled()) {
            return (int)animation.swingSpeed.getValue();
        }
    ...
    if (this.isSprinting()) {
        JumpFixEvent Niggaisjumping = new JumpFixEvent(this.rotationYaw);
        if(this instanceof EntityPlayerSP) {
            Client.INSTANCE.getEventManager().handle(Niggaisjumping);
        }
