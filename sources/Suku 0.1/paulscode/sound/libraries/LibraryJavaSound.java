...
public class LibraryJavaSound extends Library {
        ...
        if (myMixer == null) {
            ...
            if (myMixer == null) {
                ...
                if (bestRankedMixer == null)
                    throw new Exception("No useable mixers " +
    ...
    public static class MixerRanking {
        ...
        public void rank(Mixer.Info i) throws Exception {
            ...
            if (i == null)
                throw new Exception("No Mixer info " +
            ...
            try {
                ...
                throw new Exception("Unable to acquire the " +
            ...
            if (!AudioSystem.isLineSupported(lineInfo)) {
                if (MIN_SAMPLE_RATE_PRIORITY == HIGH)
                    throw new Exception("Specified minimum " +
            ...
            if (!AudioSystem.isLineSupported(lineInfo)) {
                if (MAX_SAMPLE_RATE_PRIORITY == HIGH)
                    throw new Exception("Specified maximum " +
                            "sample-rate not possible for Mixer '" +
                            mixerInfo.getName() + "'", this);
            } else {
            ...
            if (minSampleRatePossible == -1 || maxSampleRatePossible == -1)
                throw new Exception("No possible " +
            ...
            try {
                ...
                throw new Exception("Unable to attach an " +
                        "actual audio buffer " +
                        "to an actual Clip... " +
                        "Mixer '" +
                        mixerInfo.getName() +
            ...
            if (!useGainControl(GET, false)) {
                ...
                if (GAIN_CONTROL_PRIORITY == HIGH)
                    throw new Exception("Gain control " +
            ...
            if (!usePanControl(GET, false)) {
                ...
                if (PAN_CONTROL_PRIORITY == HIGH)
                    throw new Exception("Pan control " +
                            "not available for Mixer '" +
                            mixerInfo.getName() + "'", this);
            } else {
                panControlOK = true;
            ...
            if (!useSampleRateControl(GET, false)) {
                ...
                if (SAMPLE_RATE_CONTROL_PRIORITY == HIGH)
                    throw new Exception("Sample-rate " +
