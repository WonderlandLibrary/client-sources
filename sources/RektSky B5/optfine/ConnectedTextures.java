...
public class ConnectedTextures {
    ...
    private static void fixVertex(int[] p_fixVertex_0_, int p_fixVertex_1_, TextureAtlasSprite p_fixVertex_2_, TextureAtlasSprite p_fixVertex_3_) {
        int i2 = 7 * p_fixVertex_1_;
        float f2 = Float.intBitsToFloat(p_fixVertex_0_[i2 + 4]);
        float f1 = Float.intBitsToFloat(p_fixVertex_0_[i2 + 4 + 1]);
        double d0 = p_fixVertex_2_.getSpriteU16(f2);
        double d1 = p_fixVertex_2_.getSpriteV16(f1);
        p_fixVertex_0_[i2 + 4] = Float.floatToRawIntBits(p_fixVertex_3_.getInterpolatedU(d0));
        p_fixVertex_0_[i2 + 4 + 1] = Float.floatToRawIntBits(p_fixVertex_3_.getInterpolatedV(d1));
    }
    ...
    public static TextureAtlasSprite getConnectedTextureSingle(IBlockAccess p_getConnectedTextureSingle_0_, IBlockState p_getConnectedTextureSingle_1_, BlockPos p_getConnectedTextureSingle_2_, EnumFacing p_getConnectedTextureSingle_3_, TextureAtlasSprite p_getConnectedTextureSingle_4_, boolean p_getConnectedTextureSingle_5_, RenderEnv p_getConnectedTextureSingle_6_) {
        ...
        if (tileProperties != null && (i2 = p_getConnectedTextureSingle_4_.getIndexInMap()) >= 0 && i2 < tileProperties.length && (aconnectedproperties = tileProperties[i2]) != null) {
            int j2 = p_getConnectedTextureSingle_6_.getMetadata();
            int k2 = ConnectedTextures.getSide(p_getConnectedTextureSingle_3_);
            for (int l2 = 0; l2 < aconnectedproperties.length; ++l2) {
                TextureAtlasSprite textureatlassprite;
                int i1;
                ConnectedProperties connectedproperties = aconnectedproperties[l2];
                if (connectedproperties == null || !connectedproperties.matchesBlock(i1 = p_getConnectedTextureSingle_6_.getBlockId()) || (textureatlassprite = ConnectedTextures.getConnectedTexture(connectedproperties, p_getConnectedTextureSingle_0_, p_getConnectedTextureSingle_1_, p_getConnectedTextureSingle_2_, k2, p_getConnectedTextureSingle_4_, j2, p_getConnectedTextureSingle_6_)) == null) continue;
                return textureatlassprite;
            }
        }
        if (blockProperties != null && p_getConnectedTextureSingle_5_ && (j1 = p_getConnectedTextureSingle_6_.getBlockId()) >= 0 && j1 < blockProperties.length && (aconnectedproperties1 = blockProperties[j1]) != null) {
            int k1 = p_getConnectedTextureSingle_6_.getMetadata();
            int l1 = ConnectedTextures.getSide(p_getConnectedTextureSingle_3_);
            for (int i22 = 0; i22 < aconnectedproperties1.length; ++i22) {
                TextureAtlasSprite textureatlassprite1;
                ConnectedProperties connectedproperties1 = aconnectedproperties1[i22];
                if (connectedproperties1 == null || !connectedproperties1.matchesIcon(p_getConnectedTextureSingle_4_) || (textureatlassprite1 = ConnectedTextures.getConnectedTexture(connectedproperties1, p_getConnectedTextureSingle_0_, p_getConnectedTextureSingle_1_, p_getConnectedTextureSingle_2_, l1, p_getConnectedTextureSingle_4_, k1, p_getConnectedTextureSingle_6_)) == null) continue;
                return textureatlassprite1;
            }
        }
    ...
    private static TextureAtlasSprite getConnectedTexture(ConnectedProperties p_getConnectedTexture_0_, IBlockAccess p_getConnectedTexture_1_, IBlockState p_getConnectedTexture_2_, BlockPos p_getConnectedTexture_3_, int p_getConnectedTexture_4_, TextureAtlasSprite p_getConnectedTexture_5_, int p_getConnectedTexture_6_, RenderEnv p_getConnectedTexture_7_) {
        int i2 = p_getConnectedTexture_3_.getY();
        if (i2 >= p_getConnectedTexture_0_.minHeight && i2 <= p_getConnectedTexture_0_.maxHeight) {
            if (p_getConnectedTexture_0_.biomes != null) {
                ...
                boolean flag = false;
                for (int j2 = 0; j2 < p_getConnectedTexture_0_.biomes.length; ++j2) {
                    BiomeGenBase biomegenbase1 = p_getConnectedTexture_0_.biomes[j2];
            ...
            if (block instanceof BlockRotatedPillar) {
                l2 = ConnectedTextures.getWoodAxis(p_getConnectedTexture_4_, p_getConnectedTexture_6_);
                i1 = p_getConnectedTexture_6_ & 3;
            }
            if (block instanceof BlockQuartz) {
                l2 = ConnectedTextures.getQuartzAxis(p_getConnectedTexture_4_, p_getConnectedTexture_6_);
                if (i1 > 2) {
                    i1 = 2;
                }
            }
            if (p_getConnectedTexture_4_ >= 0 && p_getConnectedTexture_0_.faces != 63) {
                ...
                if (l2 != 0) {
                    j1 = ConnectedTextures.fixSideByAxis(p_getConnectedTexture_4_, l2);
                }
            ...
            switch (p_getConnectedTexture_0_.method) {
                ...
                case 2: {
                    return ConnectedTextures.getConnectedTextureHorizontal(p_getConnectedTexture_0_, p_getConnectedTexture_1_, p_getConnectedTexture_2_, p_getConnectedTexture_3_, l2, p_getConnectedTexture_4_, p_getConnectedTexture_5_, p_getConnectedTexture_6_);
                }
                case 3: {
                    return ConnectedTextures.getConnectedTextureTop(p_getConnectedTexture_0_, p_getConnectedTexture_1_, p_getConnectedTexture_2_, p_getConnectedTexture_3_, l2, p_getConnectedTexture_4_, p_getConnectedTexture_5_, p_getConnectedTexture_6_);
                }
                case 4: {
                ...
                case 6: {
                    return ConnectedTextures.getConnectedTextureVertical(p_getConnectedTexture_0_, p_getConnectedTexture_1_, p_getConnectedTexture_2_, p_getConnectedTexture_3_, l2, p_getConnectedTexture_4_, p_getConnectedTexture_5_, p_getConnectedTexture_6_);
                }
                case 7: {
                    return ConnectedTextures.getConnectedTextureFixed(p_getConnectedTexture_0_);
                }
                case 8: {
                    return ConnectedTextures.getConnectedTextureHorizontalVertical(p_getConnectedTexture_0_, p_getConnectedTexture_1_, p_getConnectedTexture_2_, p_getConnectedTexture_3_, l2, p_getConnectedTexture_4_, p_getConnectedTexture_5_, p_getConnectedTexture_6_);
                }
                case 9: {
                    return ConnectedTextures.getConnectedTextureVerticalHorizontal(p_getConnectedTexture_0_, p_getConnectedTexture_1_, p_getConnectedTexture_2_, p_getConnectedTexture_3_, l2, p_getConnectedTexture_4_, p_getConnectedTexture_5_, p_getConnectedTexture_6_);
                }
            }
            return null;
        }
    ...
    private static TextureAtlasSprite getConnectedTextureCtm(ConnectedProperties p_getConnectedTextureCtm_0_, IBlockAccess p_getConnectedTextureCtm_1_, IBlockState p_getConnectedTextureCtm_2_, BlockPos p_getConnectedTextureCtm_3_, int p_getConnectedTextureCtm_4_, TextureAtlasSprite p_getConnectedTextureCtm_5_, int p_getConnectedTextureCtm_6_, RenderEnv p_getConnectedTextureCtm_7_) {
        ...
        switch (p_getConnectedTextureCtm_4_) {
            ...
            case 5: {
                ...
                boolean bl = aboolean[3] = !ConnectedTextures.isNeighbour(p_getConnectedTextureCtm_0_, p_getConnectedTextureCtm_1_, p_getConnectedTextureCtm_2_, p_getConnectedTextureCtm_3_.up().south(), p_getConnectedTextureCtm_4_, p_getConnectedTextureCtm_5_, p_getConnectedTextureCtm_6_);
            }
        }
        if (i2 == 13 && aboolean[0]) {
            i2 = 4;
    ...
    private static void addToBlockList(ConnectedProperties p_addToBlockList_0_, List p_addToBlockList_1_) {
        if (p_addToBlockList_0_.matchBlocks != null) {
            for (int i2 = 0; i2 < p_addToBlockList_0_.matchBlocks.length; ++i2) {
                int j2 = p_addToBlockList_0_.matchBlocks[i2];
                if (j2 < 0) {
    ...
    private static String[] collectFiles(IResourcePack p_collectFiles_0_, String p_collectFiles_1_, String p_collectFiles_2_) {
        ...
        return file1 == null ? new String[]{} : (file1.isDirectory() ? ConnectedTextures.collectFilesFolder(file1, "", p_collectFiles_1_, p_collectFiles_2_) : (file1.isFile() ? ConnectedTextures.collectFilesZIP(file1, p_collectFiles_1_, p_collectFiles_2_) : new String[]{}));
    }
    ...
    private static String[] collectFilesDefault(IResourcePack p_collectFilesDefault_0_) {
        ...
        for (int i2 = 0; i2 < astring.length; ++i2) {
            String s2 = astring[i2];
            ResourceLocation resourcelocation = new ResourceLocation(s2);
            if (!p_collectFilesDefault_0_.resourceExists(resourcelocation)) continue;
            list.add(s2);
        }
