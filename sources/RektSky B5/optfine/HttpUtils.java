...
public class HttpUtils {
    ...
    public static byte[] get(String p_get_0_) throws IOException {
        ...
        try {
            ...
            int i2 = 0;
            do {
                if ((j2 = inputstream.read(abyte, i2, abyte.length - i2)) >= 0) continue;
                throw new IOException("Input stream closed: " + p_get_0_);
            } while ((i2 += j2) < abyte.length);
            abyte1 = abyte;
        }
        finally {
    ...
    public static String post(String p_post_0_, Map p_post_1_, byte[] p_post_2_) throws IOException {
        ...
        try {
            ...
            if (p_post_1_ != null) {
                for (Object s4 : p_post_1_.keySet()) {
                    String s1 = "" + p_post_1_.get(s4);
                    httpurlconnection.setRequestProperty((String)s4, s1);
                }
            }
