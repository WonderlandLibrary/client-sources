...
extends BasicGame {
    ...
    public void createPoly(float x2, float y2) {
        int size = 20;
        int change = 10;
        ...
        this.randomShape.setCenterX(x2);
        this.randomShape.setCenterY(y2);
    }
    ...
    public void render(GameContainer container, Graphics g2) {
        ...
        for (int i2 = 0; i2 < this.shapes.size(); ++i2) {
            g2.fill((Shape)this.shapes.get(i2));
        }
        g2.fill(this.randomShape);
        g2.setColor(Color.black);
        g2.setAntiAlias(true);
        g2.draw(this.randomShape);
        g2.setAntiAlias(false);
        g2.setColor(Color.white);
        g2.drawString("keys", 10.0f, 300.0f);
        g2.drawString("wasd - move rectangle", 10.0f, 315.0f);
        g2.drawString("WASD - resize rectangle", 10.0f, 330.0f);
        g2.drawString("tgfh - move rounded rectangle", 10.0f, 345.0f);
        g2.drawString("TGFH - resize rounded rectangle", 10.0f, 360.0f);
        g2.drawString("ry - resize corner radius on rounded rectangle", 10.0f, 375.0f);
        g2.drawString("ikjl - move ellipse", 10.0f, 390.0f);
        g2.drawString("IKJL - resize ellipse", 10.0f, 405.0f);
        g2.drawString("Arrows - move circle", 10.0f, 420.0f);
        g2.drawString("Page Up/Page Down - resize circle", 10.0f, 435.0f);
        g2.drawString("numpad 8546 - move polygon", 10.0f, 450.0f);
    }
