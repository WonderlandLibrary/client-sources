...
class NativeDefinitions {
    ...
    public static final int ABS_MT_FIRST = 48;
    public static final int ABS_MT_LAST = 59;
    ...
    public static final int FF_EFFECT_MIN = 80;
    public static final int FF_EFFECT_MAX = 87;
    ...
    public static final int FF_WAVEFORM_MIN = 88;
    public static final int FF_WAVEFORM_MAX = 93;
    public static final int FF_GAIN = 96;
    public static final int FF_AUTOCENTER = 97;
    public static final int FF_MAX = 127;
    public static final int FF_CNT = 128;
