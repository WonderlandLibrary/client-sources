...
final class OSXHIDDevice {
    ...
    private final void addElements(List<OSXHIDElement> elements, Map<String, ?> properties) {
        ...
        for (int i2 = 0; i2 < elements_properties.length; ++i2) {
            Map element_properties = (Map)elements_properties[i2];
    ...
    public final List<OSXHIDElement> getElements() {
        ArrayList<OSXHIDElement> elements = new ArrayList<OSXHIDElement>();
        this.addElements(elements, this.properties);
        return elements;
    }

    private static final long getLongFromProperties(Map<String, ?> properties, String key, long default_value) {
    ...
    private static final boolean getBooleanFromProperties(Map<String, ?> properties, String key, boolean default_value) {
        return OSXHIDDevice.getLongFromProperties(properties, key, default_value ? 1L : 0L) != 0L;
    }

    private static final int getIntFromProperties(Map<String, ?> properties, String key) {
        return (int)OSXHIDDevice.getLongFromProperties(properties, key);
    }

    private static final long getLongFromProperties(Map<String, ?> properties, String key) {
        Long long_obj = (Long)properties.get(key);
        return long_obj;
    }
    ...
    private static final void dumpArray(String prefix, Object[] array) {
        ...
        for (int i2 = 0; i2 < array.length; ++i2) {
            OSXHIDDevice.dumpObject(prefix + "\t", array[i2]);
            log.info(prefix + ",");
        }
        log.info(prefix + "}");
    }

    private static final void dumpMap(String prefix, Map<String, ?> map) {
    ...
    private static final void dumpObject(String prefix, Object obj) {
        if (obj instanceof Long) {
            Long l2 = (Long)obj;
            log.info(prefix + "0x" + Long.toHexString(l2));
    ...
    private static final native Map<String, ?> nGetDeviceProperties(long var0) throws IOException;
