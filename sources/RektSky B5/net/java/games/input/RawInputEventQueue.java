...
final class RawInputEventQueue {
    ...
    private final RawDevice lookupDevice(long handle) {
        for (int i2 = 0; i2 < this.devices.size(); ++i2) {
            RawDevice device = this.devices.get(i2);
    ...
    extends Thread {
        ...
        public final void run() {
            ...
            try {
                for (int i2 = 0; i2 < RawInputEventQueue.this.devices.size(); ++i2) {
                    RawDevice device = (RawDevice)RawInputEventQueue.this.devices.get(i2);
