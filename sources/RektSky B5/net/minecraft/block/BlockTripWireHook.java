...
extends Block {
    ...
    public void func_176260_a(World worldIn, BlockPos pos, IBlockState hookState, boolean p_176260_4_, boolean p_176260_5_, int p_176260_6_, IBlockState p_176260_7_) {
        ...
        for (int j2 = 1; j2 < 42; ++j2) {
            BlockPos blockpos = pos.offset(enumfacing, j2);
            ...
            if (iblockstate.getBlock() != Blocks.tripwire && j2 != p_176260_6_) {
                aiblockstate[j2] = null;
                flag3 = false;
                continue;
            }
            if (j2 == p_176260_6_) {
            ...
            flag3 &= flag7 == flag2;
            flag4 |= flag5 && flag6;
            aiblockstate[j2] = iblockstate;
            if (j2 != p_176260_6_) continue;
            worldIn.scheduleUpdate(pos, this, this.tickRate(worldIn));
            flag3 &= flag5;
        }
        IBlockState iblockstate1 = this.getDefaultState().withProperty(ATTACHED, flag3).withProperty(POWERED, flag4 &= (flag3 &= i2 > 1));
        if (i2 > 0) {
            BlockPos blockpos1 = pos.offset(enumfacing, i2);
        ...
        if (flag != flag3) {
            for (int k2 = 1; k2 < i2; ++k2) {
                BlockPos blockpos2 = pos.offset(enumfacing, k2);
                IBlockState iblockstate2 = aiblockstate[k2];
