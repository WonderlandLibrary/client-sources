...
extends Block {
    ...
    public static int combineMetadata(IBlockAccess worldIn, BlockPos pos) {
        ...
        boolean flag = BlockDoor.isTop(i2);
        IBlockState iblockstate1 = worldIn.getBlockState(pos.down());
        int j2 = iblockstate1.getBlock().getMetaFromState(iblockstate1);
        int k2 = flag ? j2 : i2;
        IBlockState iblockstate2 = worldIn.getBlockState(pos.up());
        int l2 = iblockstate2.getBlock().getMetaFromState(iblockstate2);
        int i1 = flag ? i2 : l2;
        boolean flag1 = (i1 & 1) != 0;
        boolean flag2 = (i1 & 2) != 0;
        return BlockDoor.removeHalfBit(k2) | (flag ? 8 : 0) | (flag1 ? 16 : 0) | (flag2 ? 32 : 0);
    }
    ...
    public int getMetaFromState(IBlockState state) {
        ...
        if (state.getValue(HALF) == EnumDoorHalf.UPPER) {
            ...
            i2 |= state.getValue(FACING).rotateY().getHorizontalIndex();
