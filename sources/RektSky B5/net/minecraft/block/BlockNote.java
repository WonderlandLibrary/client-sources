...
extends BlockContainer {
    ...
    public boolean onBlockEventReceived(World worldIn, BlockPos pos, IBlockState state, int eventID, int eventParam) {
        float f2 = (float)Math.pow(2.0, (double)(eventParam - 12) / 12.0);
        worldIn.playSoundEffect((double)pos.getX() + 0.5, (double)pos.getY() + 0.5, (double)pos.getZ() + 0.5, "note." + this.getInstrument(eventID), 3.0f, f2);
