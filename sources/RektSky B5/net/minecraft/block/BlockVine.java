...
extends Block {
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos) {
        ...
        this.setBlockBounds(f1, f22, f3, f4, f5, f6);
    }
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        if (!worldIn.isRemote && worldIn.rand.nextInt(4) == 0) {
            ...
            int j2 = 5;
            boolean flag = false;
            block0: for (int k2 = -i2; k2 <= i2; ++k2) {
                for (int l2 = -i2; l2 <= i2; ++l2) {
                    for (int i1 = -1; i1 <= 1; ++i1) {
                        if (worldIn.getBlockState(pos.add(k2, i1, l2)).getBlock() != this || --j2 > 0) continue;
                        flag = true;
                        break block0;
                    }
                }
