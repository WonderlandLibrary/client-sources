...
extends BlockBreakable {
    ...
    public BlockPattern.PatternHelper func_181089_f(World p_181089_1_, BlockPos p_181089_2_) {
        ...
        for (EnumFacing.AxisDirection enumfacing$axisdirection : EnumFacing.AxisDirection.values()) {
            ...
            for (int i2 = 0; i2 < blockportal$size.func_181101_b(); ++i2) {
                for (int j2 = 0; j2 < blockportal$size.func_181100_a(); ++j2) {
                    ...
                    int n2 = enumfacing$axisdirection.ordinal();
                    aint[n2] = aint[n2] + 1;
                }
            }
        }
    ...
    public static class Size {
        ...
        protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
            BlockPos blockpos;
            int i2;
            for (i2 = 0; i2 < 22 && this.func_150857_a(this.world.getBlockState(blockpos = p_180120_1_.offset(p_180120_2_, i2)).getBlock()) && this.world.getBlockState(blockpos.down()).getBlock() == Blocks.obsidian; ++i2) {
            }
            Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i2)).getBlock();
            return block == Blocks.obsidian ? i2 : 0;
        }
        ...
        protected int func_150858_a() {
            ...
            for (int j2 = 0; j2 < this.field_150868_h; ++j2) {
                if (this.world.getBlockState(this.field_150861_f.offset(this.field_150866_c, j2).up(this.field_150862_g)).getBlock() == Blocks.obsidian) continue;
                this.field_150862_g = 0;
                break;
            }
        ...
        public void func_150859_c() {
            for (int i2 = 0; i2 < this.field_150868_h; ++i2) {
                ...
                for (int j2 = 0; j2 < this.field_150862_g; ++j2) {
