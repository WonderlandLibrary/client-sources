...
implements IGrowable {
    ...
    private boolean onHarvest(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player) {
        ...
        int i2 = (blockdoubleplant$enumplanttype == EnumPlantType.GRASS ? BlockTallGrass.EnumType.GRASS : BlockTallGrass.EnumType.FERN).getMeta();
        BlockDoublePlant.spawnAsEntity(worldIn, pos, new ItemStack(Blocks.tallgrass, 2, i2));
        return true;
    }
    ...
    public static enum EnumPlantType implements IStringSerializable
    {
        ...
        static {
            ...
            int n2 = enumPlantTypeArray.length;
            for (int i2 = 0; i2 < n2; ++i2) {
                EnumPlantType blockdoubleplant$enumplanttype;
                EnumPlantType.META_LOOKUP[blockdoubleplant$enumplanttype.getMeta()] = blockdoubleplant$enumplanttype = enumPlantTypeArray[i2];
            }
        }
    }
