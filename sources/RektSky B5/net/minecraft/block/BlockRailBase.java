...
extends Block {
    ...
    public class Rail {
        ...
        private void func_150651_b() {
            for (int i2 = 0; i2 < this.field_150657_g.size(); ++i2) {
                Rail blockrailbase$rail = this.findRailAt(this.field_150657_g.get(i2));
                if (blockrailbase$rail != null && blockrailbase$rail.func_150653_a(this)) {
                    this.field_150657_g.set(i2, blockrailbase$rail.pos);
                    continue;
                }
        ...
        private boolean func_180363_c(BlockPos p_180363_1_) {
            for (int i2 = 0; i2 < this.field_150657_g.size(); ++i2) {
                BlockPos blockpos = this.field_150657_g.get(i2);
    ...
    public static enum EnumRailDirection implements IStringSerializable
    {
        ...
        static {
            ...
            int n2 = enumRailDirectionArray.length;
            for (int i2 = 0; i2 < n2; ++i2) {
                EnumRailDirection blockrailbase$enumraildirection;
                EnumRailDirection.META_LOOKUP[blockrailbase$enumraildirection.getMetadata()] = blockrailbase$enumraildirection = enumRailDirectionArray[i2];
            }
        }
    }
}
