...
extends Block {
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        int i2;
        if (!worldIn.isRemote && (i2 = this.getRedstoneStrength(state)) > 0) {
            this.updateState(worldIn, pos, state, i2);
        }
    }
    ...
    protected void updateState(World worldIn, BlockPos pos, IBlockState state, int oldRedstoneStrength) {
        boolean flag1;
        int i2 = this.computeRedstoneStrength(worldIn, pos);
        boolean flag = oldRedstoneStrength > 0;
        boolean bl = flag1 = i2 > 0;
        if (oldRedstoneStrength != i2) {
            state = this.setRedstoneStrength(state, i2);
