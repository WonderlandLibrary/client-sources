...
public class WorldInfo {
    ...
    public WorldInfo(NBTTagCompound nbt) {
        ...
        if (nbt.hasKey("generatorName", 8)) {
            String s2 = nbt.getString("generatorName");
            this.terrainType = WorldType.parseWorldType(s2);
            if (this.terrainType == null) {
                this.terrainType = WorldType.DEFAULT;
            } else if (this.terrainType.isVersioned()) {
                int i2 = 0;
                if (nbt.hasKey("generatorVersion", 99)) {
                    i2 = nbt.getInteger("generatorVersion");
                }
                this.terrainType = this.terrainType.getWorldTypeForGeneratorVersion(i2);
            }
    ...
    public void setSpawnX(int x2) {
        this.spawnX = x2;
    }

    public void setSpawnY(int y2) {
        this.spawnY = y2;
    }

    public void setSpawnZ(int z2) {
        this.spawnZ = z2;
    }
    ...
    public void addToCrashReport(CrashReportCategory category) {
        ...
        category.addCrashSectionCallable("Level storage version", new Callable<String>(){
            ...
            public String call() throws Exception {
                ...
                return String.format("0x%05X - %s", WorldInfo.this.saveVersion, s2);
            }
        });
