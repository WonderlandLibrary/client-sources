...
public class StructureOceanMonumentPieces {
    ...
    static class RoomDefinition {
        ...
        public boolean func_175959_a(int p_175959_1_) {
            ...
            for (int i2 = 0; i2 < 6; ++i2) {
                if (this.field_175965_b[i2] == null || !this.field_175966_c[i2] || this.field_175965_b[i2].field_175962_f == p_175959_1_ || !this.field_175965_b[i2].func_175959_a(p_175959_1_)) continue;
                return true;
            }
            return false;
        }
        ...
        public int func_175960_c() {
            ...
            for (int j2 = 0; j2 < 6; ++j2) {
                if (!this.field_175966_c[j2]) continue;
                ++i2;
            }
            return i2;
        }
    ...
    extends StructureComponent {
        ...
        protected void func_181655_a(World p_181655_1_, StructureBoundingBox p_181655_2_, int p_181655_3_, int p_181655_4_, int p_181655_5_, int p_181655_6_, int p_181655_7_, int p_181655_8_, boolean p_181655_9_) {
            for (int i2 = p_181655_4_; i2 <= p_181655_7_; ++i2) {
                for (int j2 = p_181655_3_; j2 <= p_181655_6_; ++j2) {
                    for (int k2 = p_181655_5_; k2 <= p_181655_8_; ++k2) {
                        if (p_181655_9_ && this.getBlockStateFromPos(p_181655_1_, j2, i2, k2, p_181655_2_).getBlock().getMaterial() == Material.air) continue;
                        if (this.getYWithOffset(i2) >= p_181655_1_.func_181545_F()) {
        ...
        protected void func_175819_a(World worldIn, StructureBoundingBox p_175819_2_, int p_175819_3_, int p_175819_4_, int p_175819_5_, int p_175819_6_, int p_175819_7_, int p_175819_8_, IBlockState p_175819_9_) {
            for (int i2 = p_175819_4_; i2 <= p_175819_7_; ++i2) {
                for (int j2 = p_175819_3_; j2 <= p_175819_6_; ++j2) {
                    for (int k2 = p_175819_5_; k2 <= p_175819_8_; ++k2) {
                        if (this.getBlockStateFromPos(worldIn, j2, i2, k2, p_175819_2_) != field_175822_f) continue;
    ...
    extends Piece {
        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
            ...
            this.field_175843_q.add(new WingRoom(this.coordBaseMode, structureBoundingBox, i2++));
        ...
        @Override
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            int i2 = Math.max(worldIn.func_181545_F(), 64) - this.boundingBox.minY;
