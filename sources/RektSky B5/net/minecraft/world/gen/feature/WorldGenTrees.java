...
extends WorldGenAbstractTree {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        int i2 = rand.nextInt(3) + this.minTreeHeight;
        boolean flag = true;
        if (position.getY() >= 1 && position.getY() + i2 + 1 <= 256) {
            ...
            if ((block1 == Blocks.grass || block1 == Blocks.dirt || block1 == Blocks.farmland) && position.getY() < 256 - i2 - 1) {
                ...
                int k2 = 3;
                int l2 = 0;
                for (int i3 = position.getY() - k2 + i2; i3 <= position.getY() + i2; ++i3) {
                    int i4 = i3 - (position.getY() + i2);
                    int j1 = l2 + 1 - i4 / 2;
                    for (int k1 = position.getX() - j1; k1 <= position.getX() + j1; ++k1) {
                        int l1 = k1 - position.getX();
                        for (int i22 = position.getZ() - j1; i22 <= position.getZ() + j1; ++i22) {
                            BlockPos blockpos;
                            Block block;
                            int j2 = i22 - position.getZ();
                            if (Math.abs(l1) == j1 && Math.abs(j2) == j1 && (rand.nextInt(2) == 0 || i4 == 0) || (block = worldIn.getBlockState(blockpos = new BlockPos(k1, i3, i22)).getBlock()).getMaterial() != Material.air && block.getMaterial() != Material.leaves && block.getMaterial() != Material.vine) continue;
                ...
                if (this.vinesGrow) {
                    for (int k3 = position.getY() - 3 + i2; k3 <= position.getY() + i2; ++k3) {
                        int j4 = k3 - (position.getY() + i2);
                        int k4 = 2 - j4 / 2;
                    ...
                    if (rand.nextInt(5) == 0 && i2 > 5) {
                        for (int l3 = 0; l3 < 2; ++l3) {
                            for (Object enumfacing0 : EnumFacing.Plane.HORIZONTAL) {
                                EnumFacing enumfacing = (EnumFacing)enumfacing0;
                                if (rand.nextInt(4 - l3) != 0) continue;
                                EnumFacing enumfacing1 = enumfacing.getOpposite();
                                this.func_181652_a(worldIn, rand.nextInt(3), position.add(enumfacing1.getFrontOffsetX(), i2 - 5 + l3, enumfacing1.getFrontOffsetZ()), enumfacing);
                            }
                        }
                    }
                }
    ...
    private void func_181650_b(World p_181650_1_, BlockPos p_181650_2_, PropertyBool p_181650_3_) {
        ...
        for (int i2 = 4; p_181650_1_.getBlockState(p_181650_2_).getBlock().getMaterial() == Material.air && i2 > 0; --i2) {
            this.func_181651_a(p_181650_1_, p_181650_2_, p_181650_3_);
            p_181650_2_ = p_181650_2_.down();
        }
    }
