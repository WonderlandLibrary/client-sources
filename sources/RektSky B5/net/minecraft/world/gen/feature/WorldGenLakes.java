        ...
        for (int k1 = 0; k1 < 16; ++k1) {
            for (int l2 = 0; l2 < 16; ++l2) {
                for (int k2 = 0; k2 < 8; ++k2) {
                    boolean flag;
                    boolean bl = flag = !aboolean[(k1 * 16 + l2) * 8 + k2] && (k1 < 15 && aboolean[((k1 + 1) * 16 + l2) * 8 + k2] || k1 > 0 && aboolean[((k1 - 1) * 16 + l2) * 8 + k2] || l2 < 15 && aboolean[(k1 * 16 + l2 + 1) * 8 + k2] || l2 > 0 && aboolean[(k1 * 16 + (l2 - 1)) * 8 + k2] || k2 < 7 && aboolean[(k1 * 16 + l2) * 8 + k2 + 1] || k2 > 0 && aboolean[(k1 * 16 + l2) * 8 + (k2 - 1)]);
                    if (!flag) continue;
