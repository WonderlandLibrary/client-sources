...
public class CommandResultStats {
    ...
    public void func_179672_a(final ICommandSender sender, Type resultTypeIn, int p_179672_3_) {
        String s2 = this.field_179675_c[resultTypeIn.getTypeID()];
        if (s2 != null) {
            ...
            String s22 = this.field_179673_d[resultTypeIn.getTypeID()];
    ...
    public void readStatsFromNBT(NBTTagCompound tagcompound) {
        if (tagcompound.hasKey("CommandStats", 10)) {
            ...
            for (Type commandresultstats$type : Type.values()) {
                String s2 = commandresultstats$type.getTypeName() + "Name";
                String s1 = commandresultstats$type.getTypeName() + "Objective";
                if (!nbttagcompound.hasKey(s2, 8) || !nbttagcompound.hasKey(s1, 8)) continue;
                String s22 = nbttagcompound.getString(s2);
                String s3 = nbttagcompound.getString(s1);
                CommandResultStats.func_179667_a(this, commandresultstats$type, s22, s3);
            }
        }
    }
    ...
    public void writeStatsToNBT(NBTTagCompound tagcompound) {
        ...
        for (Type commandresultstats$type : Type.values()) {
            String s2 = this.field_179675_c[commandresultstats$type.getTypeID()];
            String s1 = this.field_179673_d[commandresultstats$type.getTypeID()];
            if (s2 == null || s1 == null) continue;
            nbttagcompound.setString(commandresultstats$type.getTypeName() + "Name", s2);
