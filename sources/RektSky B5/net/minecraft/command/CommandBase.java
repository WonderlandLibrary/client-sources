...
implements ICommand {
    ...
    public static int parseInt(String input, int min, int max) throws NumberInvalidException {
        int i2 = CommandBase.parseInt(input);
        if (i2 < min) {
            throw new NumberInvalidException("commands.generic.num.tooSmall", i2, min);
        }
        if (i2 > max) {
            throw new NumberInvalidException("commands.generic.num.tooBig", i2, max);
        }
        return i2;
    }
    ...
    public static long parseLong(String input, long min, long max) throws NumberInvalidException {
        long i2 = CommandBase.parseLong(input);
        if (i2 < min) {
            throw new NumberInvalidException("commands.generic.num.tooSmall", i2, min);
        }
        if (i2 > max) {
    ...
    public static IChatComponent getChatComponentFromNthArg(ICommandSender sender, String[] args, int index, boolean p_147176_3_) throws PlayerNotFoundException {
        ...
        for (int i2 = index; i2 < args.length; ++i2) {
            ...
            IChatComponent ichatcomponent1 = new ChatComponentText(args[i2]);
            if (p_147176_3_) {
                IChatComponent ichatcomponent2 = PlayerSelector.matchEntitiesToChatComponent(sender, args[i2]);
                if (ichatcomponent2 == null) {
                    if (PlayerSelector.hasArguments(args[i2])) {
                        throw new PlayerNotFoundException();
                    }
                } else {
    ...
    public static String buildString(String[] args, int startPos) {
        ...
        for (int i2 = startPos; i2 < args.length; ++i2) {
            if (i2 > startPos) {
    ...
    public static String joinNiceString(Object[] elements) {
        ...
        for (int i2 = 0; i2 < elements.length; ++i2) {
            String s2 = elements[i2].toString();
            if (i2 > 0) {
    ...
    public static IChatComponent join(List<IChatComponent> components) {
        ...
        for (int i2 = 0; i2 < components.size(); ++i2) {
            ...
            ichatcomponent.appendSibling(components.get(i2));
        }
        return ichatcomponent;
    }
    ...
    public static List<String> func_175771_a(String[] p_175771_0_, int p_175771_1_, BlockPos p_175771_2_) {
        ...
        int i2 = p_175771_0_.length - 1;
        if (i2 == p_175771_1_) {
            s2 = Integer.toString(p_175771_2_.getX());
        } else if (i2 == p_175771_1_ + 1) {
            s2 = Integer.toString(p_175771_2_.getY());
        } else {
            if (i2 != p_175771_1_ + 2) {
                return null;
            }
            s2 = Integer.toString(p_175771_2_.getZ());
        }
        return Lists.newArrayList(s2);
    }
    ...
    public static List<String> func_181043_b(String[] p_181043_0_, int p_181043_1_, BlockPos p_181043_2_) {
        ...
        int i2 = p_181043_0_.length - 1;
        if (i2 == p_181043_1_) {
            s2 = Integer.toString(p_181043_2_.getX());
        } else {
            if (i2 != p_181043_1_ + 1) {
                return null;
            }
            s2 = Integer.toString(p_181043_2_.getZ());
        }
        return Lists.newArrayList(s2);
    }
    ...
    public static List<String> getListOfStringsMatchingLastWord(String[] p_175762_0_, Collection<?> p_175762_1_) {
        String s2 = p_175762_0_[p_175762_0_.length - 1];
        ...
        if (!p_175762_1_.isEmpty()) {
            ...
            if (list.isEmpty()) {
                for (String object : p_175762_1_) {
                    if (!(object instanceof ResourceLocation) || !CommandBase.doesStringStartWith(s2, ((ResourceLocation)((Object)object)).getResourcePath())) continue;
