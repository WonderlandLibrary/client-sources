...
public class Scoreboard {
    ...
    public void removeObjective(ScoreObjective p_96519_1_) {
        ...
        for (int i2 = 0; i2 < 19; ++i2) {
            if (this.getObjectiveInDisplaySlot(i2) != p_96519_1_) continue;
            this.setObjectiveInDisplaySlot(i2, null);
        }
    ...
    public void removeTeam(ScorePlayerTeam p_96511_1_) {
        ...
        for (String s2 : p_96511_1_.getMembershipCollection()) {
            this.teamMemberships.remove(s2);
        }
    ...
    public static int getObjectiveDisplaySlotNumber(String p_96537_0_) {
        ...
        if (p_96537_0_.startsWith("sidebar.team.") && (enumchatformatting = EnumChatFormatting.getValueByName(s2 = p_96537_0_.substring("sidebar.team.".length()))) != null && enumchatformatting.getColorIndex() >= 0) {
    ...
    public static String[] getDisplaySlotStrings() {
        if (field_178823_g == null) {
            ...
            for (int i2 = 0; i2 < 19; ++i2) {
                Scoreboard.field_178823_g[i2] = Scoreboard.getObjectiveDisplaySlot(i2);
            }
        }
    ...
    public void func_181140_a(Entity p_181140_1_) {
        if (p_181140_1_ != null && !(p_181140_1_ instanceof EntityPlayer) && !p_181140_1_.isEntityAlive()) {
            String s2 = p_181140_1_.getUniqueID().toString();
            this.removeObjectiveFromEntity(s2, null);
            this.removePlayerFromTeams(s2);
        }
    }
}
