...
extends TileEntitySpecialRenderer<TileEntityBanner> {
    ...
    @Override
    public void renderTileEntityAt(TileEntityBanner te, double x2, double y2, double z2, float partialTicks, int destroyStage) {
        boolean flag = te.getWorld() != null;
        boolean flag1 = !flag || te.getBlockType() == Blocks.standing_banner;
        int i2 = flag ? te.getBlockMetadata() : 0;
        long j2 = flag ? te.getWorld().getTotalWorldTime() : 0L;
    ...
    private ResourceLocation func_178463_a(TileEntityBanner bannerObj) {
        String s2 = bannerObj.func_175116_e();
        if (s2.isEmpty()) {
            return null;
        }
