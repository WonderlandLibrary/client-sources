...
extends TileEntitySpecialRenderer<TileEntitySkull> {
    ...
    @Override
    public void renderTileEntityAt(TileEntitySkull te, double x2, double y2, double z2, float partialTicks, int destroyStage) {
        EnumFacing enumfacing = EnumFacing.getFront(te.getBlockMetadata() & 7);
        this.renderSkull((float)x2, (float)y2, (float)z2, enumfacing, (float)(te.getSkullRotation() * 360) / 16.0f, te.getSkullType(), te.getPlayerProfile(), destroyStage);
    }
    ...
    public void renderSkull(float p_180543_1_, float p_180543_2_, float p_180543_3_, EnumFacing p_180543_4_, float p_180543_5_, int p_180543_6_, GameProfile p_180543_7_, int p_180543_8_) {
        ...
        ((ModelBase)modelbase).render(null, 0.0f, 0.0f, 0.0f, p_180543_5_, 0.0f, f2);
