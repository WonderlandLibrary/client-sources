...
extends TileEntitySpecialRenderer<TileEntityEnchantmentTable> {
    ...
    @Override
    public void renderTileEntityAt(TileEntityEnchantmentTable te, double x2, double y2, double z2, float partialTicks, int destroyStage) {
        float f1;
        GlStateManager.pushMatrix();
        GlStateManager.translate((float)x2 + 0.5f, (float)y2 + 0.75f, (float)z2 + 0.5f);
        float f2 = (float)te.tickCount + partialTicks;
        ...
        float f22 = te.bookRotationPrev + f1 * partialTicks;
