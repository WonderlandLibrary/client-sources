...
public class ClippingHelper {
    ...
    public boolean isBoxInFrustum(double p_78553_1_, double p_78553_3_, double p_78553_5_, double p_78553_7_, double p_78553_9_, double p_78553_11_) {
        float f2 = (float)p_78553_1_;
        float f1 = (float)p_78553_3_;
        float f22 = (float)p_78553_5_;
        float f3 = (float)p_78553_7_;
        float f4 = (float)p_78553_9_;
        float f5 = (float)p_78553_11_;
        for (int i2 = 0; i2 < 6; ++i2) {
            float[] afloat = this.frustum[i2];
            if (!(this.dot(afloat, f2, f1, f22) <= 0.0f) || !(this.dot(afloat, f3, f1, f22) <= 0.0f) || !(this.dot(afloat, f2, f4, f22) <= 0.0f) || !(this.dot(afloat, f3, f4, f22) <= 0.0f) || !(this.dot(afloat, f2, f1, f5) <= 0.0f) || !(this.dot(afloat, f3, f1, f5) <= 0.0f) || !(this.dot(afloat, f2, f4, f5) <= 0.0f) || !(this.dot(afloat, f3, f4, f5) <= 0.0f)) continue;
            return false;
        }
        return true;
    }
