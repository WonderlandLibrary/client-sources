...
public class Stitcher {
    ...
    public void doStitch() {
        ...
        for (Holder stitcher$holder : astitcher$holder) {
            ...
            throw new StitcherException(stitcher$holder, s2);
        }
    ...
    private boolean allocateSlot(Holder p_94310_1_) {
        for (int i2 = 0; i2 < this.stitchSlots.size(); ++i2) {
            if (((Slot)this.stitchSlots.get(i2)).addSlot(p_94310_1_)) {
                return true;
            }
            p_94310_1_.rotate();
            if (((Slot)this.stitchSlots.get(i2)).addSlot(p_94310_1_)) {
        ...
        public boolean addSlot(Holder holderIn) {
            ...
            if (i2 <= this.width && j2 <= this.height) {
                ...
                for (Object stitcher$slot : this.subSlots) {
                    if (!((Slot)stitcher$slot).addSlot(holderIn)) continue;
                    return true;
                }
                return false;
            }
