...
public class RenderManager {
    ...
    public <T extends Entity> Render<T> getEntityClassRenderObject(Class<? extends Entity> p_78715_1_) {
        Render<Entity> render = this.entityRenderMap.get(p_78715_1_);
    ...
    public void cacheActiveRenderInfo(World worldIn, FontRenderer textRendererIn, Entity livingPlayerIn, Entity pointedEntityIn, GameSettings optionsIn, float partialTicks) {
        ...
        if (livingPlayerIn instanceof EntityLivingBase && ((EntityLivingBase)livingPlayerIn).isPlayerSleeping()) {
            ...
            if (block == Blocks.bed) {
                int i2 = iblockstate.getValue(BlockBed.FACING).getHorizontalIndex();
    ...
    public boolean renderEntityStatic(Entity entity, float partialTicks, boolean p_147936_3_) {
        ...
        return this.doRenderEntity(entity, d0 - this.renderPosX, d1 - this.renderPosY, d2 - this.renderPosZ, f2, partialTicks, p_147936_3_);
    }
    ...
    private void renderDebugBoundingBox(Entity entityIn, double p_85094_2_, double p_85094_4_, double p_85094_6_, float p_85094_8_, float p_85094_9_) {
        ...
        RenderGlobal.drawBoundingBoxWithColor(axisalignedbb1, 255, 255, 255, 255);
        if (entityIn instanceof EntityLivingBase) {
            float f1 = 0.01f;
            RenderGlobal.drawBoundingBoxWithColor(new AxisAlignedBB(p_85094_2_ - (double)f2, p_85094_4_ + (double)entityIn.getEyeHeight() - (double)0.01f, p_85094_6_ - (double)f2, p_85094_2_ + (double)f2, p_85094_4_ + (double)entityIn.getEyeHeight() + (double)0.01f, p_85094_6_ + (double)f2), 255, 0, 0, 255);
        }
