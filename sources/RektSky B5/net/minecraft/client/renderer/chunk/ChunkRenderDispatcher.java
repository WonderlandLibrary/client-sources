...
public class ChunkRenderDispatcher {
    ...
    public String getDebugInfo() {
        return String.format("Packet Chunk Updates: %03d, Packet Chunk Uploads: %1d, Free Render Builders: %1d", this.queueChunkUpdates.size(), this.queueChunkUploads.size(), this.queueFreeRenderBuilders.size());
    }
    ...
    public boolean runChunkUploads(long p_178516_1_) {
        ...
        } while (p_178516_1_ != 0L && flag1 && (i2 = p_178516_1_ - System.nanoTime()) >= 0L);
        return flag;
    }
