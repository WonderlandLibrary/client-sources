...
import tk.rektsky.event.impl.hitentity.PostHitEntityEvent;
...
public class PlayerControllerMP {
    ...
    public boolean sendUseItem(EntityPlayer playerIn, World worldIn, ItemStack itemStackIn) {
        ...
        this.syncCurrentPlayItem();
        if (ModulesManager.getModuleByClass(NoSlow.class).doSlowDown()) {
            // empty if block
        }
    ...
    public void attackEntity(EntityPlayer playerIn, Entity targetEntity) {
        PreHitEntityEvent event = new PreHitEntityEvent();
        ...
        PostHitEntityEvent post = new PostHitEntityEvent();
        EventManager.callEvent(post);
    }
