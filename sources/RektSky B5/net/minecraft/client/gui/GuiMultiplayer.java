...
implements GuiYesNoCallback {
    ...
    private GuiButton btnProtocolSwitcher;
    ...
    public void createButtons() {
        ...
        this.btnProtocolSwitcher = new GuiButton(9, sr.getScaledWidth() - 100, 10, 70, 20, "Version switcher");
        this.buttonList.add(this.btnProtocolSwitcher);
