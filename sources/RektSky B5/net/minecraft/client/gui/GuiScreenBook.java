...
extends GuiScreen {
    ...
    private void sendBookToServer(boolean publish) throws IOException {
        if (this.bookIsUnsigned && this.bookIsModified && this.bookPages != null) {
            String s2;
            while (this.bookPages.tagCount() > 1 && (s2 = this.bookPages.getStringTagAt(this.bookPages.tagCount() - 1)).length() == 0) {
            ...
            if (publish) {
                ...
                for (int i2 = 0; i2 < this.bookPages.tagCount(); ++i2) {
            ...
            this.mc.getNetHandler().addToSendQueue(new C17PacketCustomPayload(s22, packetbuffer));
        }
    }
    ...
    private void pageInsertIntoCurrent(String p_146459_1_) {
        String s2 = this.pageGetCurrent();
        String s1 = s2 + p_146459_1_;
        int i2 = this.fontRendererObj.splitStringWidth(s1 + "" + (Object)((Object)EnumChatFormatting.BLACK) + "_", 118);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            ...
            if (this.bookIsUnsigned) {
                s2 = this.updateCount / 6 % 2 == 0 ? s2 + "" + (Object)((Object)EnumChatFormatting.BLACK) + "_" : s2 + "" + (Object)((Object)EnumChatFormatting.GRAY) + "_";
            }
