...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new Button(SoundCategory.MASTER.getCategoryId(), this.width / 2 - 155 + i2 % 2 * 160, this.height / 6 - 12 + 24 * (i2 >> 1), SoundCategory.MASTER, true));
        i2 += 2;
        for (SoundCategory soundcategory : SoundCategory.values()) {
            if (soundcategory == SoundCategory.MASTER) continue;
            this.buttonList.add(new Button(soundcategory.getCategoryId(), this.width / 2 - 155 + i2 % 2 * 160, this.height / 6 - 12 + 24 * (i2 >> 1), soundcategory, false));
            ++i2;
        }
    ...
    protected String getSoundVolume(SoundCategory p_146504_1_) {
        float f2 = this.game_settings_4.getSoundLevel(p_146504_1_);
        return f2 == 0.0f ? this.field_146508_h : (int)(f2 * 100.0f) + "%";
    }
