...
extends Gui {
    ...
    public void updateAchievementWindow() {
        if (this.theAchievement != null && this.notificationTime != 0L && Minecraft.getMinecraft().thePlayer != null) {
            ...
            if (this.permanentNotification) {
                this.mc.fontRendererObj.drawSplitString(this.achievementDescription, i2 + 30, j2 + 7, 120, -1);
            } else {
                this.mc.fontRendererObj.drawString(this.achievementTitle, i2 + 30, j2 + 7, -256);
                this.mc.fontRendererObj.drawString(this.achievementDescription, i2 + 30, j2 + 18, -1);
            }
            ...
            this.renderItem.renderItemAndEffectIntoGUI(this.theAchievement.theItemStack, i2 + 8, j2 + 8);
            GlStateManager.disableLighting();
