...
implements GuiYesNoCallback {
    ...
    protected String func_146614_d(int p_146614_1_) {
        ...
        if (StringUtils.isEmpty(s2)) {
            s2 = I18n.format("selectWorld.world", new Object[0]) + " " + (p_146614_1_ + 1);
        }
        return s2;
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            if (button.id == 2) {
                String s2 = this.func_146614_d(this.field_146640_r);
                if (s2 != null) {
                    this.field_146643_x = true;
                    GuiYesNo guiyesno = GuiSelectWorld.func_152129_a(this, s2, this.field_146640_r);
    ...
    public static GuiYesNo func_152129_a(GuiYesNoCallback p_152129_0_, String p_152129_1_, int p_152129_2_) {
        ...
        GuiYesNo guiyesno = new GuiYesNo(p_152129_0_, s2, s1, s22, s3, p_152129_2_);
        return guiyesno;
    }
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            if (StringUtils.isEmpty(s2)) {
                s2 = GuiSelectWorld.this.field_146637_u + " " + (entryID + 1);
            }
            ...
            if (saveformatcomparator.requiresConversion()) {
                s22 = GuiSelectWorld.this.field_146636_v + " " + s22;
            } else {
                ...
                if (saveformatcomparator.getCheatsEnabled()) {
                    s22 = s22 + ", " + I18n.format("selectWorld.cheats", new Object[0]);
                }
            }
