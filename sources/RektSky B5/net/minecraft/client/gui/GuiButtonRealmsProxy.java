...
extends GuiButton {
    ...
    public GuiButtonRealmsProxy(RealmsButton realmsButtonIn, int buttonId, int x2, int y2, String text) {
        super(buttonId, x2, y2, text);
        this.realmsButton = realmsButtonIn;
    }

    public GuiButtonRealmsProxy(RealmsButton realmsButtonIn, int buttonId, int x2, int y2, String text, int widthIn, int heightIn) {
