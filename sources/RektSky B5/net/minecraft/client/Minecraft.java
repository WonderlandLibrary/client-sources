...
import tk.rektsky.gui.GuiLoading;
...
IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        logger.info("I3");
        LaunchWrapper._check2();
        logger.info("I4 " + LaunchWrapper.paused2);
        logger.info("I5");
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            block5: {
                ...
                inputstream1 = null;
                try {
                    inputstream = Fly.class.getResourceAsStream("/assets/minecraft/rektsky/icons/16.png");
                    inputstream1 = Fly.class.getResourceAsStream("/assets/minecraft/rektsky/icons/32.png");
    ...
    private void runGameLoop() throws IOException {
        ...
        while (Minecraft.getSystemTime() >= this.debugUpdateTime + 1000L) {
            ...
            objectArray[3] = (float)this.gameSettings.limitFramerate == GameSettings.Options.FRAMERATE_LIMIT.getValueMax() ? "Infinty" : Integer.valueOf(this.gameSettings.limitFramerate);
            objectArray[4] = this.gameSettings.enableVsync ? " VSYNC: On" : " VSYNC: Off";
            Object object = objectArray[5] = this.gameSettings.fancyGraphics ? " Fast: Render Off" : " Fast Render: On";
            objectArray[6] = this.gameSettings.clouds == 0 ? " Cloud: None" : (this.gameSettings.clouds == 1 ? " Cloud: Fast" : " Cloud: Fancy");
            objectArray[7] = OpenGlHelper.useVbo() ? " VBO: On" : " VBO: Off";
            this.debug = String.format("%d fps (%d chunk update%s) FPS Limit: %s%s%s%s%s", objectArray);
    ...
    public void toggleFullscreen() {
        try {
            ...
            if (this.fullscreen) {
                this.oldHeight = Display.getDisplayMode().getHeight();
                this.oldWidth = Display.getDisplayMode().getWidth();
                this.updateDisplayMode();
    ...
    public void runTick() throws IOException {
        ...
        if (this.isInGame()) {
            EventManager.callEvent(new WorldTickEvent());
        }
        EventManager.callEvent(new ClientTickEvent());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                EventManager.callEvent(new KeyPressedEvent(k2));
        ...
        if (this.isInGame()) {
            EventManager.callEvent(new WorldTickPostEvent());
        }
        EventManager.callEvent(new ClientTickPostEvent());
    }
