...
implements INetHandlerPlayClient {
    ...
    public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
        ...
        if (entity != null) {
            ...
            if (aentity != null) {
                int i2 = packetIn.getEntityID() - entity.getEntityId();
                for (int j2 = 0; j2 < aentity.length; ++j2) {
                    aentity[j2].setEntityId(aentity[j2].getEntityId() + i2);
                }
            }
    ...
    public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn) {
        ...
        int i2 = packetIn.getCurrentItemID();
        entityotherplayermp.inventory.mainInventory[entityotherplayermp.inventory.currentItem] = i2 == 0 ? null : new ItemStack(Item.getItemById(i2), 1, 0);
        entityotherplayermp.setPositionAndRotation(d0, d1, d2, f2, f1);
    ...
    public void handleEntityTeleport(S18PacketEntityTeleport packetIn) {
        ...
        if (entity != null) {
            ...
            if (Math.abs(entity.posX - d0) < 0.03125 && Math.abs(entity.posY - d1) < 0.015625 && Math.abs(entity.posZ - d2) < 0.03125) {
                entity.setPositionAndRotation2(entity.posX, entity.posY, entity.posZ, f2, f1, 3, true);
            } else {
                entity.setPositionAndRotation2(d0, d1, d2, f2, f1, 3, true);
            }
    ...
    public void handleEntityMovement(S14PacketEntity packetIn) {
        ...
        if (entity != null) {
            ...
            double d1 = (double)entity.serverPosY / 32.0;
            double d2 = (double)entity.serverPosZ / 32.0;
            float f2 = packetIn.func_149060_h() ? (float)(packetIn.func_149066_f() * 360) / 256.0f : entity.rotationYaw;
            float f1 = packetIn.func_149060_h() ? (float)(packetIn.func_149063_g() * 360) / 256.0f : entity.rotationPitch;
            entity.setPositionAndRotation2(d0, d1, d2, f2, f1, 3, false);
            entity.onGround = packetIn.getOnGround();
        }
    }
    ...
    public void handleDestroyEntities(S13PacketDestroyEntities packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        for (int i2 = 0; i2 < packetIn.getEntityIDs().length; ++i2) {
            this.clientWorldController.removeEntityFromWorld(packetIn.getEntityIDs()[i2]);
        }
    }
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
        ...
        if (packetIn.func_179834_f().contains((Object)S08PacketPlayerPosLook.EnumFlags.Y_ROT)) {
            f2 += entityplayer.rotationYaw;
        }
        entityplayer.setPositionAndRotation(d0, d1, d2, f2, f1);
    ...
    public void handleSpawnMob(S0FPacketSpawnMob packetIn) {
        ...
        if (aentity != null) {
            int i2 = packetIn.getEntityID() - entitylivingbase.getEntityId();
            for (int j2 = 0; j2 < aentity.length; ++j2) {
                aentity[j2].setEntityId(aentity[j2].getEntityId() + i2);
            }
        }
        entitylivingbase.setEntityId(packetIn.getEntityID());
        entitylivingbase.setPositionAndRotation(d0, d1, d2, f2, f1);
    ...
    public void handleUpdateTileEntity(S35PacketUpdateTileEntity packetIn) {
        ...
        if (this.gameController.theWorld.isBlockLoaded(packetIn.getPos())) {
            ...
            int i2 = packetIn.getTileEntityType();
            if (i2 == 1 && tileentity instanceof TileEntityMobSpawner || i2 == 2 && tileentity instanceof TileEntityCommandBlock || i2 == 3 && tileentity instanceof TileEntityBeacon || i2 == 4 && tileentity instanceof TileEntitySkull || i2 == 5 && tileentity instanceof TileEntityFlowerPot || i2 == 6 && tileentity instanceof TileEntityBanner) {
    ...
    public void handleMapChunkBulk(S26PacketMapChunkBulk packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        for (int i2 = 0; i2 < packetIn.getChunkCount(); ++i2) {
            int j2 = packetIn.getChunkX(i2);
            int k2 = packetIn.getChunkZ(i2);
            ...
            chunk.fillChunk(packetIn.getChunkBytes(i2), packetIn.getChunkSize(i2), true);
    ...
    public void handleChangeGameState(S2BPacketChangeGameState packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        EntityPlayerSP entityplayer = this.gameController.thePlayer;
        int i2 = packetIn.getGameState();
        float f2 = packetIn.func_149137_d();
        int j2 = MathHelper.floor_float(f2 + 0.5f);
        if (i2 >= 0 && i2 < S2BPacketChangeGameState.MESSAGE_NAMES.length && S2BPacketChangeGameState.MESSAGE_NAMES[i2] != null) {
            ((EntityPlayer)entityplayer).addChatComponentMessage(new ChatComponentTranslation(S2BPacketChangeGameState.MESSAGE_NAMES[i2], new Object[0]));
        }
        if (i2 == 1) {
            ...
            this.clientWorldController.setRainStrength(f2);
        } else if (i2 == 8) {
            this.clientWorldController.setThunderStrength(f2);
        } else if (i2 == 10) {
    ...
    public void handleStatistics(S37PacketStatistics packetIn) {
        ...
        for (Map.Entry<StatBase, Integer> entry : packetIn.func_148974_c().entrySet()) {
            ...
            if (statbase.isAchievement() && i2 > 0) {
            ...
            this.gameController.thePlayer.getStatFileWriter().unlockAchievement(this.gameController.thePlayer, statbase, i2);
        }
    ...
    public void handleCombatEvent(S42PacketCombatEvent packetIn) {
        ...
        if (packetIn.eventType == S42PacketCombatEvent.Event.END_COMBAT) {
            long i2 = 1000 * packetIn.field_179772_d / 20;
            MetadataCombat metadatacombat = new MetadataCombat(this.gameController.thePlayer, entitylivingbase);
            this.gameController.getTwitchStream().func_176026_a(metadatacombat, 0L - i2, 0L);
    ...
    public void handleResourcePack(S48PacketResourcePackSend packetIn) {
        ...
        if (s2.startsWith("level://")) {
            ...
            this.netManager.sendPacket(new C19PacketResourcePackStatus(s1, C19PacketResourcePackStatus.Action.ACCEPTED));
            Futures.addCallback(this.gameController.getResourcePackRepository().downloadResourcePack(s2, s1), new FutureCallback<Object>(){
                    ...
                    NetHandlerPlayClient.this.gameController.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback(){
                        ...
                        public void confirmClicked(boolean result, int id) {
                            ...
                            if (result) {
                                ...
                                Futures.addCallback(NetHandlerPlayClient.this.gameController.getResourcePackRepository().downloadResourcePack(s2, s1), new FutureCallback<Object>(){
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn) {
        ...
        if ("MC|TrList".equals(packetIn.getChannelName())) {
            ...
            try {
                ...
                if (guiscreen == null || !(guiscreen instanceof GuiMerchant) || i2 != this.gameController.thePlayer.openContainer.windowId) return;
    ...
    public void handleTeams(S3EPacketTeams packetIn) {
        ...
        if (packetIn.func_149307_h() == 0 || packetIn.func_149307_h() == 3) {
            for (String s2 : packetIn.func_149310_g()) {
                scoreboard.addPlayerToTeam(s2, packetIn.func_149312_c());
            }
        }
    ...
    public void handleParticles(S2APacketParticles packetIn) {
        ...
        if (packetIn.getParticleCount() == 0) {
            ...
            for (int i2 = 0; i2 < packetIn.getParticleCount(); ++i2) {
