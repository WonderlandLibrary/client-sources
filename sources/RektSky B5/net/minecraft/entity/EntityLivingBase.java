...
extends Entity {
    ...
    public EntityLivingBase(World worldIn) {
        ...
        if (this != Minecraft.getMinecraft().thePlayer || RotationUtil.doReset()) {
            this.rotationYawHead = this.rotationYaw;
        }
        this.rotationYawHead = RotationUtil.getYaw();
    ...
    public boolean isPotionApplicable(PotionEffect potioneffectIn) {
        int i2;
        return this.getCreatureAttribute() != EnumCreatureAttribute.UNDEAD || (i2 = potioneffectIn.getPotionID()) != Potion.regeneration.id && i2 != Potion.poison.id;
    }
    ...
    protected float func_110146_f(float p_110146_1_, float p_110146_2_) {
        ...
        if (this == Minecraft.getMinecraft().thePlayer && !RotationUtil.doReset()) {
            f1 = MathHelper.wrapAngleTo180_float(RotationUtil.getYaw() - this.renderYawOffset);
        }
        ...
        if (this == Minecraft.getMinecraft().thePlayer && !RotationUtil.doReset()) {
            this.renderYawOffset = RotationUtil.getYaw() - f1;
        }
        if (f1 * f1 > 2500.0f) {
