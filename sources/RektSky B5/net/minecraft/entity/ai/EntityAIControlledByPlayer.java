...
extends EntityAIBase {
    ...
    public void updateTask() {
        ...
        float f2 = MathHelper.wrapAngleTo180_float(entityplayer.rotationYaw - this.thisEntity.rotationYaw) * 0.5f;
        if (f2 > 5.0f) {
            f2 = 5.0f;
        }
        if (f2 < -5.0f) {
        ...
        this.thisEntity.rotationYaw = MathHelper.wrapAngleTo180_float(this.thisEntity.rotationYaw + f2);
        ...
        int i2 = MathHelper.floor_double(this.thisEntity.posX);
        int j2 = MathHelper.floor_double(this.thisEntity.posY);
        int k2 = MathHelper.floor_double(this.thisEntity.posZ);
        ...
        if (this.thisEntity.onGround) {
            f22 = this.thisEntity.worldObj.getBlockState((BlockPos)new BlockPos((int)MathHelper.floor_float((float)((float)i2)), (int)(MathHelper.floor_float((float)((float)j2)) - 1), (int)MathHelper.floor_float((float)((float)k2)))).getBlock().slipperiness * 0.91f;
        }
        ...
        int l2 = MathHelper.floor_double(this.thisEntity.posX + (double)f9);
        ...
        if (i2 != l2 || k2 != i1) {
            boolean flag;
            Block block = this.thisEntity.worldObj.getBlockState(new BlockPos(i2, j2, k2)).getBlock();
            boolean bl = flag = !this.isStairOrSlab(block) && (block.getMaterial() != Material.air || !this.isStairOrSlab(this.thisEntity.worldObj.getBlockState(new BlockPos(i2, j2 - 1, k2)).getBlock()));
            if (flag && 0 == WalkNodeProcessor.func_176170_a(this.thisEntity.worldObj, this.thisEntity, l2, j2, i1, j1, k1, l1, false, false, true) && 1 == WalkNodeProcessor.func_176170_a(this.thisEntity.worldObj, this.thisEntity, i2, j2 + 1, k2, j1, k1, l1, false, false, true) && 1 == WalkNodeProcessor.func_176170_a(this.thisEntity.worldObj, this.thisEntity, l2, j2 + 1, i1, j1, k1, l1, false, false, true)) {
