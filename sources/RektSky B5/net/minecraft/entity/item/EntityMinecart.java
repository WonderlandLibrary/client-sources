...
implements IWorldNameable {
    ...
    public void onUpdate() {
        ...
        if (this.worldObj.isRemote) {
            ...
            int k2 = MathHelper.floor_double(this.posX);
            if (BlockRailBase.isRailBlock(this.worldObj, new BlockPos(k2, (l2 = MathHelper.floor_double(this.posY)) - 1, i1 = MathHelper.floor_double(this.posZ)))) {
                --l2;
            }
            if (BlockRailBase.isRailBlock(iblockstate = this.worldObj.getBlockState(blockpos = new BlockPos(k2, l2, i1)))) {
    ...
    protected void func_180460_a(BlockPos p_180460_1_, IBlockState p_180460_2_) {
        ...
        if (j2 != p_180460_1_.getX() || i2 != p_180460_1_.getZ()) {
            d5 = Math.sqrt(this.motionX * this.motionX + this.motionZ * this.motionZ);
            this.motionX = d5 * (double)(j2 - p_180460_1_.getX());
            this.motionZ = d5 * (double)(i2 - p_180460_1_.getZ());
        }
        if (flag) {
    ...
    public Vec3 func_70495_a(double p_70495_1_, double p_70495_3_, double p_70495_5_, double p_70495_7_) {
        ...
        int k2;
        int j2;
        int i2 = MathHelper.floor_double(p_70495_1_);
        if (BlockRailBase.isRailBlock(this.worldObj, new BlockPos(i2, (j2 = MathHelper.floor_double(p_70495_3_)) - 1, k2 = MathHelper.floor_double(p_70495_5_)))) {
            --j2;
        }
        if (BlockRailBase.isRailBlock(iblockstate = this.worldObj.getBlockState(new BlockPos(i2, j2, k2)))) {
            ...
            if (aint[0][1] != 0 && MathHelper.floor_double(p_70495_1_ += (d0 /= d2) * p_70495_7_) - i2 == aint[0][0] && MathHelper.floor_double(p_70495_5_ += (d1 /= d2) * p_70495_7_) - k2 == aint[0][2]) {
                p_70495_3_ += (double)aint[0][1];
            } else if (aint[1][1] != 0 && MathHelper.floor_double(p_70495_1_) - i2 == aint[1][0] && MathHelper.floor_double(p_70495_5_) - k2 == aint[1][2]) {
    ...
    public Vec3 func_70489_a(double p_70489_1_, double p_70489_3_, double p_70489_5_) {
        ...
        int k2;
        int j2;
        int i2 = MathHelper.floor_double(p_70489_1_);
        if (BlockRailBase.isRailBlock(this.worldObj, new BlockPos(i2, (j2 = MathHelper.floor_double(p_70489_3_)) - 1, k2 = MathHelper.floor_double(p_70489_5_)))) {
            --j2;
        }
        if (BlockRailBase.isRailBlock(iblockstate = this.worldObj.getBlockState(new BlockPos(i2, j2, k2)))) {
            BlockRailBase.EnumRailDirection blockrailbase$enumraildirection = iblockstate.getValue(((BlockRailBase)iblockstate.getBlock()).getShapeProperty());
            int[][] aint = matrix[blockrailbase$enumraildirection.getMetadata()];
            double d0 = 0.0;
            double d1 = (double)i2 + 0.5 + (double)aint[0][0] * 0.5;
            double d2 = (double)j2 + 0.0625 + (double)aint[0][1] * 0.5;
            double d3 = (double)k2 + 0.5 + (double)aint[0][2] * 0.5;
            double d4 = (double)i2 + 0.5 + (double)aint[1][0] * 0.5;
            double d5 = (double)j2 + 0.0625 + (double)aint[1][1] * 0.5;
            double d6 = (double)k2 + 0.5 + (double)aint[1][2] * 0.5;
            double d7 = d4 - d1;
            double d8 = (d5 - d2) * 2.0;
            double d9 = d6 - d3;
            if (d7 == 0.0) {
                p_70489_1_ = (double)i2 + 0.5;
                d0 = p_70489_5_ - (double)k2;
            } else if (d9 == 0.0) {
                p_70489_5_ = (double)k2 + 0.5;
                d0 = p_70489_1_ - (double)i2;
            } else {
    ...
    protected void readEntityFromNBT(NBTTagCompound tagCompund) {
        if (tagCompund.getBoolean("CustomDisplayTile")) {
            int i2 = tagCompund.getInteger("DisplayData");
            if (tagCompund.hasKey("DisplayTile", 8)) {
                ...
                if (block == null) {
                    ...
                    this.func_174899_a(block.getStateFromMeta(i2));
                }
            } else {
                ...
                if (block1 == null) {
                    ...
                    this.func_174899_a(block1.getStateFromMeta(i2));
                }
            }
    ...
    public void setVelocity(double x2, double y2, double z2) {
        this.velocityX = this.motionX = x2;
        this.velocityY = this.motionY = y2;
        this.velocityZ = this.motionZ = z2;
    }
