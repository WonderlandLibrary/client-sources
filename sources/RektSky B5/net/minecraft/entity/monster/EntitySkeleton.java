...
implements IRangedAttackMob {
    ...
    public EntitySkeleton(World worldIn) {
        ...
        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget<EntityAnimal>((EntityCreature)this, EntityAnimal.class, true));
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
        if (this.getSkeletonType() == 1) {
            ...
            int k2 = this.rand.nextInt(3 + p_70628_2_);
            for (int i1 = 0; i1 < k2; ++i1) {
                this.dropItem(Items.arrow, 1);
            }
        }
        int l2 = this.rand.nextInt(3 + p_70628_2_);
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_) {
        ...
        int i2 = EnchantmentHelper.getEnchantmentLevel(Enchantment.power.effectId, this.getHeldItem());
        int j2 = EnchantmentHelper.getEnchantmentLevel(Enchantment.punch.effectId, this.getHeldItem());
        ...
        if (i2 > 0) {
            entityarrow.setDamage(entityarrow.getDamage() + (double)i2 * 0.5 + 0.5);
        }
        if (j2 > 0) {
            entityarrow.setKnockbackStrength(j2);
        }
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        if (tagCompund.hasKey("SkeletonType", 99)) {
            byte i2 = tagCompund.getByte("SkeletonType");
            this.setSkeletonType(i2);
        }
        this.setCombatTask();
    }
