...
implements IRangedAttackMob {
    ...
    public void handleStatusUpdate(byte id) {
        if (id == 15) {
            for (int i2 = 0; i2 < this.rand.nextInt(35) + 10; ++i2) {
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
        ...
        for (int j2 = 0; j2 < i2; ++j2) {
            ...
            if (p_70628_2_ > 0) {
                k2 += this.rand.nextInt(p_70628_2_ + 1);
            }
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_) {
        if (!this.getAggressive()) {
            ...
            if (f2 >= 8.0f && !p_82196_1_.isPotionActive(Potion.moveSlowdown)) {
            ...
            } else if (f2 <= 3.0f && !p_82196_1_.isPotionActive(Potion.weakness) && this.rand.nextFloat() < 0.25f) {
