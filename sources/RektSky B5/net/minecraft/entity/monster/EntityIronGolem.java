...
extends EntityGolem {
    ...
    public void onLivingUpdate() {
        ...
        if (this.motionX * this.motionX + this.motionZ * this.motionZ > 2.500000277905201E-7 && this.rand.nextInt(5) == 0 && (block = (iblockstate = this.worldObj.getBlockState(new BlockPos(i2 = MathHelper.floor_double(this.posX), j2 = MathHelper.floor_double(this.posY - (double)0.2f), k2 = MathHelper.floor_double(this.posZ)))).getBlock()).getMaterial() != Material.air) {
                ...
                public boolean apply(T p_apply_1_) {
                    ...
                    if (p_apply_1_ instanceof EntityPlayer) {
                        ...
                        if (((Entity)p_apply_1_).isInvisible()) {
                            float f2 = ((EntityPlayer)p_apply_1_).getArmorVisibility();
                            if (f2 < 0.1f) {
                                f2 = 0.1f;
                            }
                            d0 *= (double)(0.7f * f2);
