...
extends EntityMob {
    ...
    public int getTotalArmorValue() {
        int i2 = super.getTotalArmorValue() + 2;
        if (i2 > 20) {
            i2 = 20;
        }
        return i2;
    ...
    public void onLivingUpdate() {
        if (this.worldObj.isDaytime() && !this.worldObj.isRemote && !this.isChild()) {
            ...
            if (f2 > 0.5f && this.rand.nextFloat() * 30.0f < (f2 - 0.4f) * 2.0f && this.worldObj.canSeeSky(blockpos)) {
                boolean flag = true;
        ...
        if (super.attackEntityFrom(source, amount)) {
            ...
            if (entitylivingbase != null && this.worldObj.getDifficulty() == EnumDifficulty.HARD && (double)this.rand.nextFloat() < this.getEntityAttribute(reinforcementChance).getAttributeValue()) {
                ...
                for (int l2 = 0; l2 < 50; ++l2) {
                    int k1;
                    int j1;
                    int i1 = i2 + MathHelper.getRandomIntegerInRange(this.rand, 7, 40) * MathHelper.getRandomIntegerInRange(this.rand, -1, 1);
                    if (!World.doesBlockHaveSolidTopSurface(this.worldObj, new BlockPos(i1, (j1 = j2 + MathHelper.getRandomIntegerInRange(this.rand, 7, 40) * MathHelper.getRandomIntegerInRange(this.rand, -1, 1)) - 1, k1 = k2 + MathHelper.getRandomIntegerInRange(this.rand, 7, 40) * MathHelper.getRandomIntegerInRange(this.rand, -1, 1))) || this.worldObj.getLightFromNeighbors(new BlockPos(i1, j1, k1)) >= 10) continue;
    ...
    public void onUpdate() {
        if (!this.worldObj.isRemote && this.isConverting()) {
            int i2 = this.getConversionTimeBoost();
    ...
    public boolean attackEntityAsMob(Entity entityIn) {
        ...
        if (flag) {
            int i2 = this.worldObj.getDifficulty().getDifficultyId();
            if (this.getHeldItem() == null && this.isBurning() && this.rand.nextFloat() < (float)i2 * 0.3f) {
                entityIn.setFire(2 * i2);
            }
        }
        return flag;
    }
    ...
    protected void setEquipmentBasedOnDifficulty(DifficultyInstance difficulty) {
        ...
        float f3 = this.worldObj.getDifficulty() == EnumDifficulty.HARD ? 0.05f : 0.01f;
        if (f2 < f3) {
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        this.setCanPickUpLoot(this.rand.nextFloat() < 0.55f * f2);
        if (livingdata == null) {
        ...
        this.setBreakDoorsAItask(this.rand.nextFloat() < f2 * 0.1f);
        ...
        double d0 = this.rand.nextDouble() * 1.5 * (double)f2;
        if (d0 > 1.0) {
        ...
        if (this.rand.nextFloat() < f2 * 0.05f) {
    ...
    protected int getConversionTimeBoost() {
        ...
        if (this.rand.nextFloat() < 0.01f) {
            ...
            for (int k2 = (int)this.posX - 4; k2 < (int)this.posX + 4 && j2 < 14; ++k2) {
                for (int l2 = (int)this.posY - 4; l2 < (int)this.posY + 4 && j2 < 14; ++l2) {
                    for (int i1 = (int)this.posZ - 4; i1 < (int)this.posZ + 4 && j2 < 14; ++i1) {
                        Block block = this.worldObj.getBlockState(blockpos$mutableblockpos.func_181079_c(k2, l2, i1)).getBlock();
