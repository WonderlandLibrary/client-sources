...
public class EntityList {
    ...
    public static List<String> getEntityNameList() {
        ...
        for (String s2 : set) {
            Class<? extends Entity> oclass = stringToClassMapping.get(s2);
    ...
    public static boolean isStringEntityName(Entity entityIn, String entityName) {
        String s2 = EntityList.getEntityString(entityIn);
        if (s2 == null && entityIn instanceof EntityPlayer) {
            s2 = "Player";
        } else if (s2 == null && entityIn instanceof EntityLightningBolt) {
            s2 = "LightningBolt";
        }
        return entityName.equals(s2);
    }
