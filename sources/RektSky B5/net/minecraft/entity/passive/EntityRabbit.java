...
extends EntityAnimal {
    ...
    private void calculateRotationYaw(double x2, double z2) {
        this.rotationYaw = (float)(MathHelper.func_181159_b(z2 - this.posZ, x2 - this.posX) * 180.0 / Math.PI) - 90.0f;
    }
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
        int i2 = this.rand.nextInt(2) + this.rand.nextInt(1 + p_70628_2_);
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (livingdata instanceof RabbitTypeData) {
            i2 = ((RabbitTypeData)livingdata).typeData;
            flag = true;
        } else {
            livingdata = new RabbitTypeData(i2);
        }
        this.setRabbitType(i2);
        if (flag) {
