...
extends EntityAnimal {
    ...
    protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
        ...
        int i2 = this.rand.nextInt(2) + 1 + this.rand.nextInt(1 + p_70628_2_);
    ...
    public float getHeadRotationAngleX(float p_70890_1_) {
        if (this.sheepTimer > 4 && this.sheepTimer <= 36) {
            float f2 = ((float)(this.sheepTimer - 4) - p_70890_1_) / 32.0f;
    ...
    public static EnumDyeColor getRandomSheepColor(Random random) {
        ...
        return i2 < 5 ? EnumDyeColor.BLACK : (i2 < 10 ? EnumDyeColor.GRAY : (i2 < 15 ? EnumDyeColor.SILVER : (i2 < 18 ? EnumDyeColor.BROWN : (random.nextInt(500) == 0 ? EnumDyeColor.PINK : EnumDyeColor.WHITE))));
    }
    ...
    private EnumDyeColor getDyeColorMixFromParents(EntityAnimal father, EntityAnimal mother) {
        int i2 = ((EntitySheep)father).getFleeceColor().getDyeDamage();
        int j2 = ((EntitySheep)mother).getFleeceColor().getDyeDamage();
        this.inventoryCrafting.getStackInSlot(0).setItemDamage(i2);
        this.inventoryCrafting.getStackInSlot(1).setItemDamage(j2);
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, ((EntitySheep)father).worldObj);
        int k2 = itemstack != null && itemstack.getItem() == Items.dye ? itemstack.getMetadata() : (this.worldObj.rand.nextBoolean() ? i2 : j2);
        return EnumDyeColor.byDyeDamage(k2);
    }
