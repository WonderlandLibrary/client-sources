...
INpc {
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        for (int i2 = 0; i2 < this.villagerInventory.getSizeInventory(); ++i2) {
            ItemStack itemstack = this.villagerInventory.getStackInSlot(i2);
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        for (int i2 = 0; i2 < nbttaglist.tagCount(); ++i2) {
            ItemStack itemstack = ItemStack.loadItemStackFromNBT(nbttaglist.getCompoundTagAt(i2));
            if (itemstack == null) continue;
    ...
    public void setRevengeTarget(EntityLivingBase livingBase) {
        ...
        if (this.villageObj != null && livingBase != null) {
            ...
            if (livingBase instanceof EntityPlayer) {
                ...
                this.villageObj.setReputationForPlayer(livingBase.getName(), i2);
    ...
    public void useRecipe(MerchantRecipe recipe) {
        ...
        if (recipe.getRewardsExp()) {
            this.worldObj.spawnEntityInWorld(new EntityXPOrb(this.worldObj, this.posX, this.posY + 0.5, this.posZ, i2));
        }
    }
    ...
    private void populateBuyingList() {
        ...
        int i2 = this.careerId - 1;
        int j2 = this.careerLevel - 1;
        ITradeList[][] aentityvillager$itradelist1 = aentityvillager$itradelist[i2];
        if (j2 >= 0 && j2 < aentityvillager$itradelist1.length) {
            ITradeList[] aentityvillager$itradelist2;
            for (ITradeList entityvillager$itradelist : aentityvillager$itradelist2 = aentityvillager$itradelist1[j2]) {
    ...
    public IChatComponent getDisplayName() {
        String s2 = this.getCustomNameTag();
        if (s2 != null && s2.length() > 0) {
            ChatComponentText chatcomponenttext = new ChatComponentText(s2);
    ...
    public boolean replaceItemInInventory(int inventorySlot, ItemStack itemStackIn) {
        ...
        int i2 = inventorySlot - 300;
        if (i2 >= 0 && i2 < this.villagerInventory.getSizeInventory()) {
            this.villagerInventory.setInventorySlotContents(i2, itemStackIn);
            return true;
        }
        return false;
    }
    ...
    implements ITradeList {
        ...
        public void modifyMerchantRecipeList(MerchantRecipeList recipeList, Random random) {
            ...
            if (this.field_179402_b != null) {
                i2 = this.field_179402_b.getPrice(random);
            }
            if (i2 < 0) {
                itemstack = new ItemStack(Items.emerald, 1, 0);
                itemstack1 = new ItemStack(this.field_179403_a.getItem(), -i2, this.field_179403_a.getMetadata());
            } else {
                itemstack = new ItemStack(Items.emerald, i2, 0);
    ...
    implements ITradeList {
        ...
        public void modifyMerchantRecipeList(MerchantRecipeList recipeList, Random random) {
            ...
            if (this.field_179406_b != null) {
                i2 = this.field_179406_b.getPrice(random);
            }
            ItemStack itemstack = new ItemStack(Items.emerald, i2, 0);
    ...
    implements ITradeList {
        ...
        public void modifyMerchantRecipeList(MerchantRecipeList recipeList, Random random) {
            ...
            int i2 = MathHelper.getRandomIntegerInRange(random, enchantment.getMinLevel(), enchantment.getMaxLevel());
            ItemStack itemstack = Items.enchanted_book.getEnchantedItemStack(new EnchantmentData(enchantment, i2));
            int j2 = 2 + random.nextInt(5 + i2 * 10) + 3 * i2;
            if (j2 > 64) {
                j2 = 64;
            }
            recipeList.add(new MerchantRecipe(new ItemStack(Items.book), new ItemStack(Items.emerald, j2), itemstack));
        }
    }
    ...
    implements ITradeList {
        ...
        public void modifyMerchantRecipeList(MerchantRecipeList recipeList, Random random) {
            ...
            if (this.field_179409_b != null) {
                i2 = this.field_179409_b.getPrice(random);
            }
            int j2 = 1;
            if (this.field_179408_d != null) {
                j2 = this.field_179408_d.getPrice(random);
            }
            recipeList.add(new MerchantRecipe(new ItemStack(this.field_179411_a.getItem(), i2, this.field_179411_a.getMetadata()), new ItemStack(Items.emerald), new ItemStack(this.field_179410_c.getItem(), j2, this.field_179410_c.getMetadata())));
        }
    }
    ...
    implements ITradeList {
        ...
        public void modifyMerchantRecipeList(MerchantRecipeList recipeList, Random random) {
            int i2 = 1;
            if (this.price != null) {
                i2 = this.price.getPrice(random);
            }
            recipeList.add(new MerchantRecipe(new ItemStack(this.sellItem, i2, 0), Items.emerald));
        }
    }
}
