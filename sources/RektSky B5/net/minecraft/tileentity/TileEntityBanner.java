        ...
        if (this.patternList == null || this.colorList == null || this.patternResourceLocation == null) {
            if (!this.field_175119_g) {
                ...
                if (this.patterns != null) {
                    for (int i2 = 0; i2 < this.patterns.tagCount(); ++i2) {
                        NBTTagCompound nbttagcompound = this.patterns.getCompoundTagAt(i2);
                        ...
                        int j2 = nbttagcompound.getInteger("Color");
                        this.colorList.add(EnumDyeColor.byDyeDamage(j2));
                        this.patternResourceLocation = this.patternResourceLocation + tileentitybanner$enumbannerpattern.getPatternID() + j2;
                    }
                }
            }
        }
