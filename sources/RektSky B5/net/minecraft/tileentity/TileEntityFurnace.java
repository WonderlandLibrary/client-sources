...
ISidedInventory {
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        for (int i2 = 0; i2 < nbttaglist.tagCount(); ++i2) {
            ...
            if (j2 < 0 || j2 >= this.furnaceItemStacks.length) continue;
            this.furnaceItemStacks[j2] = ItemStack.loadItemStackFromNBT(nbttagcompound);
        }
    ...
    public void writeToNBT(NBTTagCompound compound) {
        ...
        for (int i2 = 0; i2 < this.furnaceItemStacks.length; ++i2) {
            ...
            this.furnaceItemStacks[i2].writeToNBT(nbttagcompound);
