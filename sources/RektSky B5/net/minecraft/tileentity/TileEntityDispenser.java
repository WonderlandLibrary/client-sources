...
implements IInventory {
    ...
    public int getDispenseSlot() {
        int i2 = -1;
        int j2 = 1;
        for (int k2 = 0; k2 < this.stacks.length; ++k2) {
            if (this.stacks[k2] == null || RNG.nextInt(j2++) != 0) continue;
            i2 = k2;
        }
        return i2;
    }
    ...
    public int addItemStack(ItemStack stack) {
        for (int i2 = 0; i2 < this.stacks.length; ++i2) {
            if (this.stacks[i2] != null && this.stacks[i2].getItem() != null) continue;
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        for (int i2 = 0; i2 < nbttaglist.tagCount(); ++i2) {
            ...
            if (j2 < 0 || j2 >= this.stacks.length) continue;
