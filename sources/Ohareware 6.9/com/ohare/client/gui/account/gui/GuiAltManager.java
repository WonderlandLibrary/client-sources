package com.ohare.client.gui.account.gui;

import com.ohare.client.Client;
import com.ohare.client.gui.account.gui.components.GuiAccountList;
import com.ohare.client.gui.account.gui.impl.GuiAddAlt;
import com.ohare.client.gui.account.gui.impl.GuiAltLogin;
import com.ohare.client.gui.account.gui.impl.GuiAlteningLogin;
import com.ohare.client.gui.account.gui.thread.AccountLoginThread;
import com.ohare.client.gui.account.system.Account;
...
public class GuiAltManager extends GuiScreen {
    ...
    public void drawScreen(int p_drawScreen_1_, int p_drawScreen_2_, float p_drawScreen_3_){
        ...
        drawCenteredString(mc.fontRendererObj, "Accounts: " + Client.INSTANCE.getAccountManager().getAccounts().size(), width / 2, 15, 0xFFFFFFFF);
    }
            ...
            case 5:
                ...
                if(returnVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    for(String line : Files.readAllLines(Paths.get(chooser.getSelectedFile().getPath()))){
                        ...
                        Client.INSTANCE.getAccountManager().getAccounts().add(account);
                    }
                }
