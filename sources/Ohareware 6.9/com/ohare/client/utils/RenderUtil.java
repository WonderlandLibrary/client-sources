...
public class RenderUtil {
    ...
    public static void drawCustomString(final String str, final float x, final float y, final int color) {
        Minecraft.getMinecraft().fontRendererObj.drawDaNiggaString(str, x - 1.0f, y, 0);
        Minecraft.getMinecraft().fontRendererObj.drawDaNiggaString(str, x, y - 1.0f, 0);
        Minecraft.getMinecraft().fontRendererObj.drawDaNiggaString(str, x, y + 1.0f, 0);
        Minecraft.getMinecraft().fontRendererObj.drawDaNiggaString(str, x + 1.0f, y, 0);
        Minecraft.getMinecraft().fontRendererObj.drawDaNiggaString(str, x + 1.0f, y - 1.0f, 0);
        Minecraft.getMinecraft().fontRendererObj.drawDaNiggaString(str, x - 1.0f, y - 1.0f, 0);
        Minecraft.getMinecraft().fontRendererObj.drawDaNiggaString(str, x - 1.0f, y + 1.0f, 0);
        Minecraft.getMinecraft().fontRendererObj.drawDaNiggaString(str, x + 1.0f, y + 1.0f, 0);
