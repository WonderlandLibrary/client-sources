...
public class OutlineESP extends Module {
    ...
    public OutlineESP() {
        super("OutlineESP", Category.VISUALS, new Color(0xA54DFF).getRGB());
        addValues(red, green, blue, alpha, width, players, animals, mobs, invisibles, passives, rainbow);
        setRenderlabel("Outline ESP");
    }

    public boolean isValid(EntityLivingBase entity) {
        return isValidType(entity) && entity.getEntityId() != -1488 && entity.isEntityAlive() && (!entity.isInvisible() || invisibles.isEnabled());
    }
