...
import com.ohare.client.module.modules.other.TimeChanger;
...
public class WorldInfo
{
    ...
    {
        return  Client.INSTANCE.getModuleManager().getModule("timechanger").isEnabled() ? ((TimeChanger) Client.INSTANCE.getModuleManager().getModule("timechanger")).cool.isEnabled() ? ((TimeChanger) Client.INSTANCE.getModuleManager().getModule("timechanger")).cooltime:((TimeChanger) Client.INSTANCE.getModuleManager().getModule("timechanger")).time.getValue():worldTime;
    }
