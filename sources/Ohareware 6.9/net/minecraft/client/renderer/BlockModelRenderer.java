...
import com.ohare.client.event.events.render.RenderBlockModelEvent;
...
public class BlockModelRenderer
{
    ...
    {
        RenderBlockModelEvent renderBlockModelEvent = new RenderBlockModelEvent(blockStateIn.getBlock(), blockPosIn);
        renderBlockModelEvent.dispatch();
