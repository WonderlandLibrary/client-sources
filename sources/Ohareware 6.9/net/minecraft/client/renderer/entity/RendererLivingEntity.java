...
import com.ohare.client.event.events.render.RenderNametagEvent;
import com.ohare.client.module.modules.player.Freecam;
import com.ohare.client.module.modules.visuals.Chams;
import com.ohare.client.module.modules.visuals.OutlineESP;
import com.ohare.client.utils.OutlineUtils;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        ...
        OutlineESP outline = (OutlineESP) Client.INSTANCE.getModuleManager().getModule("outlineesp");
        ...
        if (flag || flag1) {
            ...
            if (outline.isEnabled()) {
                ...
                if (outline.isValid(entitylivingbaseIn)) {
                    if (Minecraft.getMinecraft().theWorld != null) {
                        GL11.glColor4f(Client.INSTANCE.getFriendManager().isFriend(entitylivingbaseIn.getName()) ? 0.12F : (outline.rainbow.isEnabled() ? rgba[0] : outline.red.getValue()), Client.INSTANCE.getFriendManager().isFriend(entitylivingbaseIn.getName()) ? 0.5F : (outline.rainbow.isEnabled() ? rgba[1] : outline.green.getValue()), Client.INSTANCE.getFriendManager().isFriend(entitylivingbaseIn.getName()) ? 1 : (outline.rainbow.isEnabled() ? rgba[2] : outline.blue.getValue()), outline.alpha.getValue());
            ...
            if (Client.INSTANCE.getModuleManager().getModuleClass(Chams.class).isEnabled() && chams.isValid(entitylivingbaseIn)) {
                if (chams.colored.isEnabled()) {
                    ...
                    GL11.glColor4f(Client.INSTANCE.getFriendManager().isFriend(entitylivingbaseIn.getName()) ? 0.12F : (chams.rainbow.isEnabled() ? rgba[0] : chams.hiddenred.getValue()), Client.INSTANCE.getFriendManager().isFriend(entitylivingbaseIn.getName()) ? 0.5F : (chams.rainbow.isEnabled() ? rgba[1] : chams.hiddengreen.getValue()), Client.INSTANCE.getFriendManager().isFriend(entitylivingbaseIn.getName()) ? 1 : (chams.rainbow.isEnabled() ? rgba[2] : chams.hiddenblue.getValue()), chams.alpha.getValue());
                    this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
                    GL11.glEnable(GL11.GL_DEPTH_TEST);
                    GL11.glDepthMask(true);
                    GL11.glColor4f(Client.INSTANCE.getFriendManager().isFriend(entitylivingbaseIn.getName()) ? 0.12f : (chams.rainbow.isEnabled() ? rgba[0] : chams.visiblered.getValue()), Client.INSTANCE.getFriendManager().isFriend(entitylivingbaseIn.getName()) ? 0.5F : (chams.rainbow.isEnabled() ? rgba[1] : chams.visiblegreen.getValue()), Client.INSTANCE.getFriendManager().isFriend(entitylivingbaseIn.getName()) ? 1 : (chams.rainbow.isEnabled() ? rgba[2] : chams.visibleblue.getValue()), chams.alpha.getValue());
                    this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
                    GL11.glEnable(3042);
                    GL11.glEnable(2896);
                    GL11.glEnable(3553);
