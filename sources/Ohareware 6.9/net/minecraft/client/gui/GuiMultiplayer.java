...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
    ...
    private boolean initialized, autoCheat;
    ...
    public void createButtons() {
        ...
        buttonList.add(new GuiOptionButton(420, new ScaledResolution(mc).getScaledWidth() - 100, new ScaledResolution(mc).getScaledHeight() / 55, 90, 20, "AutoCheat: " + Client.INSTANCE.isAutoCheat()));
    ...
    public void updateScreen() {
        super.updateScreen();
        buttonList.get(7).displayString = "AutoCheat: " + Client.INSTANCE.isAutoCheat();
        ...
        autoCheat = Client.INSTANCE.isAutoCheat();
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            if (button.id == 420) {
                Client.INSTANCE.setAutoCheat(!Client.INSTANCE.isAutoCheat());
            }
        }
    }
