...
import com.ohare.client.utils.LoginUtils;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
	...
	protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button.id == 5) {
            if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) LoginUtils.loginFromClipboard();
            else mc.displayGuiScreen(new GuiAltManager());
        }
