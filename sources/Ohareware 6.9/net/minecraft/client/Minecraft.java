...
import com.ohare.client.event.events.input.GuiOpenEvent;
...
import com.ohare.client.event.events.world.LoadWorldEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public void func_181536_a(int p_181536_1_, int p_181536_2_, int p_181536_3_, int p_181536_4_, int p_181536_5_, int p_181536_6_, int p_181536_7_, int p_181536_8_, int p_181536_9_, int p_181536_10_)
    {
        ...
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
        worldrenderer.pos(p_181536_1_, p_181536_2_ + p_181536_6_, 0.0D).tex(p_181536_3_ * f, (p_181536_4_ + p_181536_6_) * f1).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
        worldrenderer.pos(p_181536_1_ + p_181536_5_, p_181536_2_ + p_181536_6_, 0.0D).tex((p_181536_3_ + p_181536_5_) * f, (p_181536_4_ + p_181536_6_) * f1).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
        worldrenderer.pos(p_181536_1_ + p_181536_5_, p_181536_2_, 0.0D).tex((p_181536_3_ + p_181536_5_) * f, p_181536_4_ * f1).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
        worldrenderer.pos(p_181536_1_, p_181536_2_, 0.0D).tex(p_181536_3_ * f, p_181536_4_ * f1).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).endVertex();
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        new GuiOpenEvent(guiScreenIn).dispatch();
    ...
    private void displayDebugInfo(long elapsedTicksTime)
    {
        if (this.mcProfiler.profilingEnabled)
        {
            ...
            for (int k2 = 0; k2 < list.size(); ++k2)
            {
                ...
                this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profiler$result2.field_76332_a) + "%", j + i - 50 - this.fontRendererObj.getStringWidth(s1), k + i / 2 + k2 * 8 + 20, profiler$result2.func_76329_a());
                this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profiler$result2.field_76330_b) + "%", j + i - this.fontRendererObj.getStringWidth(s1), k + i / 2 + k2 * 8 + 20, profiler$result2.func_76329_a());
            }
        }
    }
    ...
    public void toggleFullscreen()
    {
        try
        {
            ...
            Display.setVSyncEnabled(this.gameSettings.enableVsync);
            this.updateDisplay();
            FullScreenEvent event = new FullScreenEvent(this.displayWidth,this.displayHeight);
            event.dispatch();
        }
        catch (Exception exception)
        {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Mouse.next())
            {
                ...
                if (Mouse.getEventButtonState()) {
                    final MouseEvent eventMouse = new MouseEvent(i);
                    eventMouse.dispatch();
