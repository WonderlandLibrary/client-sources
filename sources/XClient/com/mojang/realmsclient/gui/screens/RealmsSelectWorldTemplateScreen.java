...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen
{
    ...
    public RealmsSelectWorldTemplateScreen(NotifableRealmsScreen p_i51753_1_, RealmsServer.ServerType p_i51753_2_, @Nullable WorldTemplatePaginatedList p_i51753_3_)
    {
        ...
        {
            this.field_224517_c = new WorldTemplateSelectionList(Lists.newArrayList(p_i51753_3_.field_230657_a_));
    ...
    class WorldTemplateSelectionEntry extends ExtendedList.AbstractListEntry<WorldTemplateSelectionEntry>
    {
        ...
        private void func_238027_a_(MatrixStack p_238027_1_, int p_238027_2_, int p_238027_3_, int p_238027_4_, int p_238027_5_, WorldTemplate p_238027_6_)
        {
            ...
            blit(p_238027_1_, p_238027_2_ + 1, p_238027_3_ + 1, 0.0F, 0.0F, 38, 38, 38, 38);
            ...
            RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
            blit(p_238027_1_, p_238027_2_, p_238027_3_, 0.0F, 0.0F, 40, 40, 40, 40);
        }
        ...
        private void func_238028_a_(MatrixStack p_238028_1_, int p_238028_2_, int p_238028_3_, int p_238028_4_, int p_238028_5_, String p_238028_6_, String p_238028_7_, String p_238028_8_)
        {
            ...
            if (!flag2)
            {
                ...
                blit(p_238028_1_, p_238028_2_ + i, p_238028_3_, f, 0.0F, 15, 15, 30, 15);
            ...
            if (!"".equals(p_238028_7_))
            {
                ...
                blit(p_238028_1_, j, p_238028_3_, f1, 0.0F, 15, 15, 30, 15);
                RenderSystem.popMatrix();
            }
    ...
    class WorldTemplateSelectionList extends RealmsObjectSelectionList<WorldTemplateSelectionEntry>
    {
        ...
        {
            super(RealmsSelectWorldTemplateScreen.this.width, RealmsSelectWorldTemplateScreen.this.height, RealmsSelectWorldTemplateScreen.this.field_224529_o ? func_239562_k_(1) : 32, RealmsSelectWorldTemplateScreen.this.height - 40, 46);
