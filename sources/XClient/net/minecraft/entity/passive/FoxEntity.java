...
public class FoxEntity extends AnimalEntity
{
    ...
    public static class FoxData extends AgeableData
    {
    ...
    class JumpGoal extends Goal
    {
        ...
        public JumpGoal()
        {
            this.setMutexFlags(EnumSet.of(Flag.LOOK, Flag.JUMP, Flag.MOVE));
        }
    ...
    public static enum Type
    {
        ...
        private static final Type[] field_221088_c = Arrays.stream(values()).sorted(Comparator.comparingInt(Type::getIndex)).toArray((p_221084_0_) -> {
            return new Type[p_221084_0_];
        });
        private static final Map<String, Type> TYPES_BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(Type::getName, (p_221081_0_) -> {
            return p_221081_0_;
        }));
