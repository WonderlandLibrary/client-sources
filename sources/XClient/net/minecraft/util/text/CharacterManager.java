...
public class CharacterManager
{
    ...
    {
        StringWidthProcessor charactermanager$stringwidthprocessor = new StringWidthProcessor((float)p_238352_2_);
    ...
    {
        StringWidthProcessor charactermanager$stringwidthprocessor = new StringWidthProcessor((float)p_238357_2_);
    ...
    {
        StringWidthProcessor charactermanager$stringwidthprocessor = new StringWidthProcessor((float)p_243239_2_);
    ...
    {
        final StringWidthProcessor charactermanager$stringwidthprocessor = new StringWidthProcessor((float)p_238358_2_);
    ...
    public void func_238353_a_(String p_238353_1_, int p_238353_2_, Style p_238353_3_, boolean p_238353_4_, ISliceAcceptor p_238353_5_)
    {
        ...
        MultilineProcessor charactermanager$multilineprocessor;

        for (Style style = p_238353_3_; i < j; style = charactermanager$multilineprocessor.func_238389_b_())
        {
            charactermanager$multilineprocessor = new MultilineProcessor((float)p_238353_2_);
    ...
    {
        List<StyleOverridingTextComponent> list = Lists.newArrayList();
        ...
        {
            flag = false;
            MultilineProcessor charactermanager$multilineprocessor = new MultilineProcessor((float)p_243242_2_);
