...
public final class Ingredient implements Predicate<ItemStack>
{
    ...
    {
        return fromItemListStream(Stream.of(new TagList(tagIn)));
    }
    ...
    public static Ingredient read(PacketBuffer buffer)
    {
        ...
        {
            return new SingleItemList(buffer.readItemStack());
        }).limit((long)i));
    }
    ...
    static class SingleItemList implements IItemList
    {
    ...
    static class TagList implements IItemList
    {
