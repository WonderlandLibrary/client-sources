...
public class SystemToast implements IToast
{
    ...
    public Visibility func_230444_a_(MatrixStack p_230444_1_, ToastGui p_230444_2_, long p_230444_3_)
    {
        ...
        return p_230444_3_ - this.firstDrawTime < 5000L ? Visibility.SHOW : Visibility.HIDE;
    }
    ...
    {
        func_238536_a_(p_238535_0_.getToastGui(), Type.WORLD_ACCESS_FAILURE, new TranslationTextComponent("selectWorld.access_failure"), new StringTextComponent(p_238535_1_));
    }

    public static void func_238538_b_(Minecraft p_238538_0_, String p_238538_1_)
    {
        func_238536_a_(p_238538_0_.getToastGui(), Type.WORLD_ACCESS_FAILURE, new TranslationTextComponent("selectWorld.delete_failure"), new StringTextComponent(p_238538_1_));
    }

    public static void func_238539_c_(Minecraft p_238539_0_, String p_238539_1_)
    {
        func_238536_a_(p_238539_0_.getToastGui(), Type.PACK_COPY_FAILURE, new TranslationTextComponent("pack.copyFailure"), new StringTextComponent(p_238539_1_));
    }
