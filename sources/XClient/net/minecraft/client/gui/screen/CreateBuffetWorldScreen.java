...
public class CreateBuffetWorldScreen extends Screen
{
    ...
    class BiomeList extends ExtendedList<BiomeList.BiomeEntry>
    {
        private BiomeList()
        {
            ...
            {
                this.addEntry(new BiomeEntry(p_238597_1_.getValue()));
            });
        }
        ...
        class BiomeEntry extends AbstractListEntry<BiomeEntry>
        {
