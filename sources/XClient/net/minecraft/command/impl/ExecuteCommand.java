...
public class ExecuteCommand
{
    ...
    private static Command<CommandSource> func_218834_a(boolean p_218834_0_, INumericTest p_218834_1_)
    {
    ...
    private static ArgumentBuilder < CommandSource, ? > buildIfResult(CommandNode<CommandSource> context, ArgumentBuilder < CommandSource, ? > builder, boolean value, IBooleanTest test)
    {
