...
public class Alternative implements ILootCondition
{
    ...
    public static Builder builder(IBuilder... buildersIn)
    {
    ...
    public static class Builder implements IBuilder
    {
        ...
        public Builder(IBuilder... buildersIn)
        {
            for (IBuilder ilootcondition$ibuilder : buildersIn)
            {
                this.conditions.add(ilootcondition$ibuilder.build());
            }
        }

        public Builder alternative(IBuilder builderIn)
        {
