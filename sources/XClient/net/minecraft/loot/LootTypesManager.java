...
public class LootTypesManager
{
    ...
    {
        return new LootTypeRegistryWrapper<>(registry, id, name, typeFunction);
    }
    ...
    public static class LootTypeRegistryWrapper<E, T extends LootType<E>>
    {
        ...
        {
            return new Serializer(this.registry, this.id, this.name, this.typeFunction, this.typeSerializer);
        }
    }
