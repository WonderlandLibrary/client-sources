...
public class ChunkStatus
{
    ...
    public static final ChunkStatus EMPTY = registerSelective("empty", (ChunkStatus)null, -1, PRE_FEATURES, Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
    });
    public static final ChunkStatus STRUCTURE_STARTS = register("structure_starts", EMPTY, 0, PRE_FEATURES, Type.PROTOCHUNK, (status, world, generator, templateManager, worldLightManager, loadingFunction, chunks, loadingChunk) ->
    {
    ...
    public static final ChunkStatus STRUCTURE_REFERENCES = registerSelective("structure_references", STRUCTURE_STARTS, 8, PRE_FEATURES, Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
    ...
    public static final ChunkStatus BIOMES = registerSelective("biomes", STRUCTURE_REFERENCES, 0, PRE_FEATURES, Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
        generator.func_242706_a(world.func_241828_r().getRegistry(Registry.BIOME_KEY), loadingChunk);
    });
    public static final ChunkStatus NOISE = registerSelective("noise", BIOMES, 8, PRE_FEATURES, Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
        WorldGenRegion worldgenregion = new WorldGenRegion(world, chunks);
        generator.func_230352_b_(worldgenregion, world.func_241112_a_().func_241464_a_(worldgenregion), loadingChunk);
    });
    public static final ChunkStatus SURFACE = registerSelective("surface", NOISE, 0, PRE_FEATURES, Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
        generator.generateSurface(new WorldGenRegion(world, chunks), loadingChunk);
    });
    public static final ChunkStatus CARVERS = registerSelective("carvers", SURFACE, 0, PRE_FEATURES, Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
        generator.func_230350_a_(world.getSeed(), world.getBiomeManager(), loadingChunk, GenerationStage.Carving.AIR);
    });
    public static final ChunkStatus LIQUID_CARVERS = registerSelective("liquid_carvers", CARVERS, 0, POST_FEATURES, Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
        generator.func_230350_a_(world.getSeed(), world.getBiomeManager(), loadingChunk, GenerationStage.Carving.LIQUID);
    });
    public static final ChunkStatus FEATURES = register("features", LIQUID_CARVERS, 8, POST_FEATURES, Type.PROTOCHUNK, (status, world, generator, templateManager, worldLightManager, loadingFunction, chunks, loadingChunk) ->
    {
    ...
    public static final ChunkStatus LIGHT = register("light", FEATURES, 1, POST_FEATURES, Type.PROTOCHUNK, (status, world, generator, templateManager, worldLightManager, loadingFunction, chunks, loadingChunk) ->
    {
    ...
    public static final ChunkStatus SPAWN = registerSelective("spawn", LIGHT, 0, POST_FEATURES, Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
        generator.func_230354_a_(new WorldGenRegion(world, chunks));
    });
    public static final ChunkStatus HEIGHTMAPS = registerSelective("heightmaps", SPAWN, 0, POST_FEATURES, Type.PROTOCHUNK, (world, generator, chunks, loadingChunk) ->
    {
    });
    public static final ChunkStatus FULL = register("full", HEIGHTMAPS, 0, POST_FEATURES, Type.LEVELCHUNK, (status, world, generator, templateManager, worldLightManager, loadingFunction, chunks, loadingChunk) ->
    {
