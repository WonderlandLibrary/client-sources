...
public class MobSpawnInfo
{
    ...
    public static final MapCodec<MobSpawnInfo> CODEC = RecordCodecBuilder.mapCodec((builder) ->
    {
        ...
        }), Codec.simpleMap(EntityClassification.CODEC, Spawners.CODEC.listOf().promotePartial(Util.func_240982_a_("Spawn data: ", LOGGER::error)), IStringSerializable.createKeyable(EntityClassification.values())).fieldOf("spawners").forGetter((spawnInfo) -> {
            return spawnInfo.spawners;
        }), Codec.simpleMap(Registry.ENTITY_TYPE, SpawnCosts.CODEC, Registry.ENTITY_TYPE).fieldOf("spawn_costs").forGetter((spawnInfo) -> {
    ...
    {
        private final Map<EntityClassification, List<Spawners>> spawners = Stream.of(EntityClassification.values()).collect(ImmutableMap.toImmutableMap((classification) ->
        {
            return classification;
        }, (classification) ->
        {
    ...
    {
        public static final Codec<SpawnCosts> CODEC = RecordCodecBuilder.create((builder) ->
        {
    ...
    {
        public static final Codec<Spawners> CODEC = RecordCodecBuilder.create((builder) ->
        {
