...
public class ChunkHolder
{
    ...
    protected void processUpdates(ChunkManager chunkManagerIn)
    {
        ...
        LocationType chunkholder$locationtype = getLocationTypeFromLevel(this.prevChunkLevel);
        LocationType chunkholder$locationtype1 = getLocationTypeFromLevel(this.chunkLevel);
    ...
    {
        IChunkLoadingError UNLOADED = new IChunkLoadingError()
        {
            public String toString()
            {
                return "UNLOADED";
