...
public class SerializableTickList<T> implements ITickList<T>
{
    ...
    public SerializableTickList(Function<T, ResourceLocation> p_i231603_1_, List<NextTickListEntry<T>> p_i231603_2_, long p_i231603_3_)
    {
        ...
        {
            return new TickHolder<>(p_234854_2_.getTarget(), p_234854_2_.position, (int)(p_234854_2_.field_235017_b_ - p_i231603_3_), p_234854_2_.priority);
    ...
    {
        this.ticks.add(new TickHolder<>(itemIn, pos, scheduledTime, priority));
    }
    ...
    {
        List<TickHolder<T>> list = Lists.newArrayList();
        ...
        for (int i = 0; i < p_222984_0_.size(); ++i)
        {
            ...
            if (t != null)
            {
                ...
                list.add(new TickHolder<>(t, blockpos, compoundnbt.getInt("t"), TickPriority.getPriority(compoundnbt.getInt("p"))));
            }
        }
