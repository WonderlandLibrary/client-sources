...
public class PotionBrewing
{
    ...
    private static void addContainerRecipe(Item p_196207_0_, Item p_196207_1_, Item p_196207_2_)
    {
        ...
        {
            POTION_ITEM_CONVERSIONS.add(new MixPredicate<>(p_196207_0_, Ingredient.fromItems(p_196207_1_), p_196207_2_));
        }
    }
    ...
    {
        POTION_TYPE_CONVERSIONS.add(new MixPredicate<>(potionEntry, Ingredient.fromItems(potionIngredient), potionResult));
    }
