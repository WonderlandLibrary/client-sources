...
public class ArrayComponent extends BaseComponent {

    public ArraySetting setting;

    public ArrayComponent(ArraySetting setting, double x, double y, double width, double height) {
