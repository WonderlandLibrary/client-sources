...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        eventMotion.setState(BaseEvent.State.PRE);
        eventMotion.call();
        ...
        {
            double xDiff = eventMotion.getX() - this.lastReportedPosX;
        ...
        eventMotion.setState(BaseEvent.State.POST);
        eventMotion.call();
    }
    ...
    public void sendChatMessage(String message)
    {
        ...
        eventChatMessage.call();

        if (eventChatMessage.isCancelled()) {
            return;
        }
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.inPortal)
        {
            if (this.mc.currentScreen != null && !this.mc.currentScreen.pausegame())
            {
                this.mc.displayGuiScreen((GuiScreen)null);
            }
