...
public class BlockModelRenderer
{
    ...
    public boolean renderModel(IBlockAccess blockAccessIn, IBakedModel modelIn, IBlockState blockStateIn, BlockPosition blockPositionIn, WorldRenderer worldRendererIn, boolean checkSides)
    {
        ...
        try
        {
            ...
            boolean flag1 = flag ? this.renderModelSmooth(blockAccessIn, modelIn, blockStateIn, blockPositionIn, worldRendererIn, checkSides) : this.renderModelFlat(blockAccessIn, modelIn, blockStateIn, blockPositionIn, worldRendererIn, checkSides);

            if (flag1)
            {
                this.renderOverlayModels(blockAccessIn, modelIn, blockStateIn, blockPositionIn, worldRendererIn, checkSides, 0L, renderenv, flag);
            }
