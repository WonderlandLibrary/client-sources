...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initialize()
    {
        ...
        this.buttonList.add(new GuiButton(13, this.width / 2 + 2, j + 72 + 12 + 25, 98, 20, I18n.format("alt", new Object[0])));
        ...
        if (this.func_183501_a())
        {
            ...
            this.field_183503_M.initialize();
        }
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if(button.id == 13) {
            mc.session = new Session(RandomUtil.randomString(8), "", "", "legacy");
    ...
    public void render(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.func_183501_a())
        {
            this.field_183503_M.render(mouseX, mouseY, partialTicks);
        }

        if (this.modUpdateNotification != null)
        {
            this.modUpdateNotification.render(mouseX, mouseY, partialTicks);
        }
    }
    ...
    protected void click(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        if (this.func_183501_a())
        {
            this.field_183503_M.click(mouseX, mouseY, mouseButton);
        }
    }
