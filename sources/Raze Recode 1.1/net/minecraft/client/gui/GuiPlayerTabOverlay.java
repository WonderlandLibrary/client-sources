...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        for (NetworkPlayerInfo networkplayerinfo : list)
        {
            ...
            {
                k = this.mc.fontRenderer.getStringWidth(" " + scoreboardIn.getValueFromObjective(networkplayerinfo.getGameProfile().getName(), scoreObjectiveIn).getScorePoints());
                j = Math.max(j, k);
            }
        }
        ...
        if (this.footer != null)
        {
            ...
            for (String s2 : list2)
            {
                l1 = Math.max(l1, this.mc.fontRenderer.getStringWidth(s2));
            }
        }
        ...
        for (int k4 = 0; k4 < l3; ++k4)
        {
            ...
            if (k4 < list.size())
            {
                ...
                {
                    this.mc.fontRenderer.drawStringWithShadow(s1, (float)j2, (float)k2, -1);
                }
