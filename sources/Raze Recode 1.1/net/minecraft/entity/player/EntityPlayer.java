...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public EntityPlayer.EnumStatus trySleep(BlockPosition bedLocation)
    {
        if (!this.worldObj.isRemote)
        {
            ...
            double d0 = 8.0D;
            double d1 = 5.0D;
            List<EntityMonster> list = this.worldObj.<EntityMonster>getEntitiesWithinAABB(EntityMonster.class, new AxisAlignedBB((double)bedLocation.getX() - d0, (double)bedLocation.getY() - d1, (double)bedLocation.getZ() - d0, (double)bedLocation.getX() + d0, (double)bedLocation.getY() + d1, (double)bedLocation.getZ() + d0));
