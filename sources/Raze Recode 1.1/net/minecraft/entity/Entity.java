...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = (this.onGround && this.isSneaking() && this instanceof EntityPlayer) || ((Raze.INSTANCE.MANAGER_REGISTRY.MODULE_REGISTRY.getModule(SafeWalk.class).isEnabled() || (Raze.INSTANCE.MANAGER_REGISTRY.MODULE_REGISTRY.getModule(Scaffold.class).safeWalk.get() && Raze.INSTANCE.MANAGER_REGISTRY.MODULE_REGISTRY.getModule(Scaffold.class).isEnabled())) && Minecraft.getMinecraft().thePlayer.onGround);
