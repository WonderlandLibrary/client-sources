...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        return this.isPotionActive(Potion.digSpeed) ? 6 - (1 + this.getActivePotionEffect(Potion.digSpeed).getAmplifier()) : (int) ((this.isPotionActive(Potion.digSlowdown) ? 6 + (1 + this.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2 : 6) * (Raze.INSTANCE.MANAGER_REGISTRY.MODULE_REGISTRY.getModule(Animations.class).isEnabled() ? Raze.INSTANCE.MANAGER_REGISTRY.MODULE_REGISTRY.getModule(Animations.class).slowdown.get().doubleValue() : 1));
    }
