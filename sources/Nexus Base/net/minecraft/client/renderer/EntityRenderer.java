...
import dev.nexus.modules.impl.render.NoHurtCam;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase) {
            if (Nexus.INSTANCE.getModuleManager().getModule(NoHurtCam.class).isEnabled()) {
                return;
            }
            ...
            if (this.mc.currentScreen != null) {
                ...
                try {
                    if (Reflector.ForgeHooksClient_drawScreen.exists()) {
                        Reflector.callVoid(Reflector.ForgeHooksClient_drawScreen, new Object[]{this.mc.currentScreen, k1, l1, partialTicks});
                    } else {
    ...
    private void setupFog(int startCoords, float partialTicks) {
        ...
        if (f >= 0.0F) {
            ...
            if (Reflector.ForgeHooksClient_onFogRender.exists()) {
                Reflector.callVoid(Reflector.ForgeHooksClient_onFogRender, new Object[]{this, entity, block, partialTicks, startCoords, f3});
            }
        }
    ...
    private void frameFinish() {
        if (this.mc.theWorld != null && Config.isShowGlErrors() && TimedEvent.isActive("CheckGlErrorFrameFinish", 10000L)) {
            ...
            if (i != 0 && GlErrors.isEnabled(i)) {
                ...
                ChatComponentText chatcomponenttext = new ChatComponentText(I18n.format("of.message.openglError", new Object[]{i, s}));
