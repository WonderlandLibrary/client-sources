...
import dev.nexus.modules.impl.other.Disabler;
...
public abstract class ServerConfigurationManager {
    ...
    public EntityPlayerMP createPlayerForUser(GameProfile profile) {
        ...
        for (EntityPlayerMP entityplayermp1 : list) {
            if (!(Nexus.INSTANCE.getModuleManager().getModule(Disabler.class).isEnabled() && Nexus.INSTANCE.getModuleManager().getModule(Disabler.class).joinClaim.getValue()))
