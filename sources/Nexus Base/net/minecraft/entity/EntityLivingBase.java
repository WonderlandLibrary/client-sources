...
import dev.nexus.events.impl.EventJump;
...
public abstract class EntityLivingBase extends Entity {
    ...
    protected void jump() {
        final EventJump e = new EventJump(this.getJumpUpwardsMotion(), this.rotationYaw);
        Nexus.INSTANCE.getEventManager().post(e);

        if (e.isCancelled()) return;

        this.motionY = e.getJumpMotion();
