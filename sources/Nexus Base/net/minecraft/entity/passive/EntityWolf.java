        ...
        if (this.isWet()) {
            ...
            if (this.timeWolfIsShaking > 0.4F) {
                ...
                for (int j = 0; j < i; ++j) {
                    ...
                    this.worldObj.spawnParticle(EnumParticleTypes.WATER_SPLASH, this.posX + (double) f1, f + 0.8F, this.posZ + (double) f2, this.motionX, this.motionY, this.motionZ, new int[0]);
                }
            }
        }
    }
