...
import dev.vertic.module.impl.render.Animations;
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0)
                {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                            if (!Objects.requireNonNull(Client.instance.getModuleManager().getModule(Animations.class)).isEnabled()) {
                                this.transformFirstPersonItem(equipProgress, 0.0F);
                                this.func_178103_d();
                                break;
                            }
                            String mode = Objects.requireNonNull(Client.instance.getModuleManager().getModule(Animations.class)).mode.getMode().toLowerCase();
