...
public class NetworkPlayerInfo
{
    ...
    public String getFullName() {
        ...
        String team = String.valueOf(getPlayerTeam());
        String name = getGameProfile().getName();
        if (team != null) {
            return formatString(team, name);
        } else {
            return name;
        }
    }

    private String formatString(String team, String name) {
        // Implement the logic to format the string with the team and name
        return team + " " + name;
    }
}
