...
import dev.vertic.module.impl.combat.KeepSprint;
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag2)
                    {
                        if (i > 0)
                        {
                            ...
                            KeepSprint keepSprint = Client.instance.getModuleManager().getModule(KeepSprint.class);
                            double hitMotion = keepSprint.isEnabled() ? keepSprint.getMotion() : 0.6D;

                            this.motionX *= hitMotion;
                            this.motionZ *= hitMotion;
                            this.setSprinting(keepSprint.isEnabled());
                        }
