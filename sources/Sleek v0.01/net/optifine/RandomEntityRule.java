            ...
            if (resourcelocation == null) {
               ...
               for(k = 0; k < this.resourceLocations.length; ++k) {
                  ...
                  if (i1 <= 1) {
                     ...
                     ResourceLocation resourcelocation1 = RandomEntities.getLocationIndexed(resourcelocation, i1);
   ...
   public boolean matches(IRandomEntity randomEntity) {
      if (this.biomes != null && !Matches.biome(randomEntity.getSpawnBiome(), this.biomes)) {
         ...
         if (this.professions != null && randomEntity instanceof RandomEntity) {
            randomentity2 = (RandomEntity)randomEntity;
            entity2 = randomentity2.getEntity();
            if (entity2 instanceof EntityVillager) {
               EntityVillager entityvillager = (EntityVillager)entity2;
         ...
         if (this.moonPhases != null) {
            world2 = Config.getMinecraft().theWorld;
            if (world2 != null) {
               k1 = world2.getMoonPhase();
         ...
         if (this.dayTimes != null) {
            world2 = Config.getMinecraft().theWorld;
            if (world2 != null) {
               k1 = (int)world2.getWorldInfo().getWorldTime();
