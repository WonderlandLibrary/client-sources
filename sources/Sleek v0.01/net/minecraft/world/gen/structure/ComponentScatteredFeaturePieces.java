...
public class ComponentScatteredFeaturePieces {
   ...
   public static class SwampHut extends ComponentScatteredFeaturePieces.Feature {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         if (!this.func_74935_a(worldIn, structureBoundingBoxIn, 0)) {
            ...
            for(l1 = 2; l1 <= 7; l1 += 5) {
               for(i2 = 1; i2 <= 5; i2 += 4) {
                  this.replaceAirAndLiquidDownwards(worldIn, Blocks.log.getDefaultState(), i2, -1, l1, structureBoundingBoxIn);
               }
            }

            if (!this.hasWitch) {
               l1 = this.getXWithOffset(2, 5);
               i2 = this.getYWithOffset(2);
   ...
   public static class JunglePyramid extends ComponentScatteredFeaturePieces.Feature {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         if (!this.func_74935_a(worldIn, structureBoundingBoxIn, 0)) {
            ...
            int j2;
            for(j2 = 0; j2 <= 14; j2 += 14) {
               this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, 4, j2, 2, 5, j2, false, randomIn, junglePyramidsRandomScatteredStones);
               this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 4, j2, 4, 5, j2, false, randomIn, junglePyramidsRandomScatteredStones);
               this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 7, 4, j2, 7, 5, j2, false, randomIn, junglePyramidsRandomScatteredStones);
               this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 9, 4, j2, 9, 5, j2, false, randomIn, junglePyramidsRandomScatteredStones);
            }
            ...
            for(j2 = 0; j2 <= 11; j2 += 11) {
               for(int j1 = 2; j1 <= 12; j1 += 2) {
                  this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, j2, 4, j1, j2, 5, j1, false, randomIn, junglePyramidsRandomScatteredStones);
               }

               this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, j2, 6, 5, j2, 6, 5, false, randomIn, junglePyramidsRandomScatteredStones);
               this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, j2, 6, 9, j2, 6, 9, false, randomIn, junglePyramidsRandomScatteredStones);
            }
            ...
            for(j2 = 0; j2 < 4; ++j2) {
               this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(j), 5, 0 - j2, 6 + j2, structureBoundingBoxIn);
               this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(j), 6, 0 - j2, 6 + j2, structureBoundingBoxIn);
               this.fillWithAir(worldIn, structureBoundingBoxIn, 5, 0 - j2, 7 + j2, 6, 0 - j2, 9 + j2);
            }
            ...
            for(j2 = 1; j2 <= 13; j2 += 2) {
               this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, -3, j2, 1, -2, j2, false, randomIn, junglePyramidsRandomScatteredStones);
            }
      ...
      static {
         ...
         junglePyramidsRandomScatteredStones = new ComponentScatteredFeaturePieces.JunglePyramid.Stones();
      }
   ...
   public static class DesertPyramid extends ComponentScatteredFeaturePieces.Feature {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         ...
         int j2;
         for(j2 = 1; j2 <= 9; ++j2) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, j2, j2, j2, this.scatteredFeatureSizeX - 1 - j2, j2, this.scatteredFeatureSizeZ - 1 - j2, Blocks.sandstone.getDefaultState(), Blocks.sandstone.getDefaultState(), false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, j2 + 1, j2, j2 + 1, this.scatteredFeatureSizeX - 2 - j2, j2, this.scatteredFeatureSizeZ - 2 - j2, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
         }

         int j;
         for(j2 = 0; j2 < this.scatteredFeatureSizeX; ++j2) {
         ...
         j2 = this.getMetadataWithOffset(Blocks.sandstone_stairs, 3);
         ...
         this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(j2), 2, 10, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(j), 2, 10, 4, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(j2), this.scatteredFeatureSizeX - 3, 10, 0, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(j), this.scatteredFeatureSizeX - 3, 10, 4, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(j2), 2, 4, 5, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(j2), 2, 3, 4, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(j2), this.scatteredFeatureSizeX - 3, 4, 5, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(j2), this.scatteredFeatureSizeX - 3, 3, 4, structureBoundingBoxIn);
         ...
         for(k3 = 0; k3 <= this.scatteredFeatureSizeX - 1; k3 += this.scatteredFeatureSizeX - 1) {
            this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k3, 2, 1, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(i1), k3, 2, 2, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k3, 2, 3, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k3, 3, 1, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(i1), k3, 3, 2, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k3, 3, 3, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(i1), k3, 4, 1, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), k3, 4, 2, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(i1), k3, 4, 3, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k3, 5, 1, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(i1), k3, 5, 2, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k3, 5, 3, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(i1), k3, 6, 1, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), k3, 6, 2, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(i1), k3, 6, 3, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(i1), k3, 7, 1, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(i1), k3, 7, 2, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(i1), k3, 7, 3, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k3, 8, 1, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k3, 8, 2, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k3, 8, 3, structureBoundingBoxIn);
         }

         for(k3 = 2; k3 <= this.scatteredFeatureSizeX - 3; k3 += this.scatteredFeatureSizeX - 3 - 2) {
         ...
         while(var15.hasNext()) {
            EnumFacing enumfacing = (EnumFacing)var15.next();
