...
public class StructureMineshaftPieces {
   ...
   private static StructureComponent func_175892_a(List<StructureComponent> listIn, Random rand, int x, int y, int z, EnumFacing facing, int type) {
      ...
      if (i >= 80) {
         structureboundingbox1 = StructureMineshaftPieces.Cross.func_175813_a(listIn, rand, x, y, z, facing);
         if (structureboundingbox1 != null) {
            return new StructureMineshaftPieces.Cross(type, rand, structureboundingbox1, facing);
         }
      } else if (i >= 70) {
         structureboundingbox1 = StructureMineshaftPieces.Stairs.func_175812_a(listIn, rand, x, y, z, facing);
         if (structureboundingbox1 != null) {
            return new StructureMineshaftPieces.Stairs(type, rand, structureboundingbox1, facing);
         }
      } else {
         structureboundingbox1 = StructureMineshaftPieces.Corridor.func_175814_a(listIn, rand, x, y, z, facing);
         if (structureboundingbox1 != null) {
            return new StructureMineshaftPieces.Corridor(type, rand, structureboundingbox1, facing);
         }
      }
   ...
   public static class Room extends StructureComponent {
      ...
      public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
         ...
         for(boolean var7 = false; k < this.boundingBox.getXSize(); k += 4) {
         ...
         for(k = 0; k < this.boundingBox.getXSize(); k += 4) {
            ...
            structurecomponent3 = StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.minX + k, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i);
            if (structurecomponent3 != null) {
               structureboundingbox3 = structurecomponent3.getBoundingBox();
         ...
         for(k = 0; k < this.boundingBox.getZSize(); k += 4) {
            ...
            structurecomponent3 = StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.WEST, i);
            if (structurecomponent3 != null) {
               structureboundingbox3 = structurecomponent3.getBoundingBox();
         ...
         for(k = 0; k < this.boundingBox.getZSize(); k += 4) {
            ...
            structurecomponent3 = StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + rand.nextInt(j) + 1, this.boundingBox.minZ + k, EnumFacing.EAST, i);
            if (structurecomponent3 != null) {
               structureboundingbox3 = structurecomponent3.getBoundingBox();
         ...
         if (i < 8) {
            ...
            if (this.coordBaseMode != EnumFacing.NORTH && this.coordBaseMode != EnumFacing.SOUTH) {
               for(k = this.boundingBox.minX + 3; k + 3 <= this.boundingBox.maxX; k += 5) {
                  l = rand.nextInt(5);
                  if (l == 0) {
                     StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, k, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, i + 1);
                  } else if (l == 1) {
                     StructureMineshaftPieces.func_175890_b(componentIn, listIn, rand, k, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, i + 1);
                  }
               }
            } else {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         if (this.isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn)) {
            ...
            for(l2 = 0; l2 <= 2; ++l2) {
               for(k1 = 0; k1 <= i1; ++k1) {
                  int j3 = -1;
                  IBlockState iblockstate1 = this.getBlockStateFromPos(worldIn, l2, j3, k1, structureBoundingBoxIn);
                  if (iblockstate1.getBlock().getMaterial() == Material.air) {
                     int k3 = -1;
                     this.setBlockState(worldIn, Blocks.planks.getDefaultState(), l2, k3, k1, structureBoundingBoxIn);
                  }
               }
            }
