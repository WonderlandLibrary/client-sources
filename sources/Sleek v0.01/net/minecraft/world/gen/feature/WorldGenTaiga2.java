...
public class WorldGenTaiga2 extends WorldGenAbstractTree {
   ...
   static {
      ...
      field_181646_b = Blocks.leaves.getDefaultState().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.SPRUCE).withProperty(BlockLeaves.CHECK_DECAY, Boolean.FALSE);
   }
}
