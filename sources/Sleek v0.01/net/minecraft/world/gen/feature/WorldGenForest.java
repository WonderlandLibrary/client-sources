...
public class WorldGenForest extends WorldGenAbstractTree {
   ...
   static {
      ...
      field_181630_b = Blocks.leaves.getDefaultState().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.BIRCH).withProperty(BlockOldLeaf.CHECK_DECAY, Boolean.FALSE);
   }
}
