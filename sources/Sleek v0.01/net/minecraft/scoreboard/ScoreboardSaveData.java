   ...
   protected void readTeams(NBTTagList p_96498_1_) {
      for(int i = 0; i < p_96498_1_.tagCount(); ++i) {
         ...
         if (nbttagcompound.hasKey("TeamColor", 8)) {
            scoreplayerteam.setChatFormat(ChatFormatting.getValueByName(nbttagcompound.getString("TeamColor")));
         }
         ...
         if (nbttagcompound.hasKey("NameTagVisibility", 8)) {
            team$enumvisible1 = Team.EnumVisible.func_178824_a(nbttagcompound.getString("NameTagVisibility"));
         ...
         if (nbttagcompound.hasKey("DeathMessageVisibility", 8)) {
            team$enumvisible1 = Team.EnumVisible.func_178824_a(nbttagcompound.getString("DeathMessageVisibility"));
            if (team$enumvisible1 != null) {
