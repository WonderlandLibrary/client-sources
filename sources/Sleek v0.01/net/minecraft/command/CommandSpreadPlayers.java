         ...
         for(int j = 0; j < p_110668_14_.length; ++j) {
            ...
            for(int l = 0; l < p_110668_14_.length; ++l) {
               if (j != l) {
                  ...
                  if (d1 < p_110668_2_) {
                     ++k;
                     commandspreadplayers$position3.field_111101_a += commandspreadplayers$position2.field_111101_a - commandspreadplayers$position.field_111101_a;
                     commandspreadplayers$position3.field_111100_b += commandspreadplayers$position2.field_111100_b - commandspreadplayers$position.field_111100_b;
                  }
               }
            }

            if (k > 0) {
               commandspreadplayers$position3.field_111101_a /= (double)k;
               commandspreadplayers$position3.field_111100_b /= (double)k;
               double d2 = (double)commandspreadplayers$position3.func_111096_b();
               if (d2 > 0.0D) {
                  commandspreadplayers$position3.func_111095_a();
                  commandspreadplayers$position.func_111094_b(commandspreadplayers$position3);
               } else {
