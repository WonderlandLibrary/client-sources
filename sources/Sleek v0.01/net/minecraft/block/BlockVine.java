            ...
            if (!flag) {
               ...
               while(true) {
                  do {
                     ...
                     enumfacing2 = (EnumFacing)var23.next();
                  } while(!rand.nextBoolean() && this.canPlaceOn(worldIn.getBlockState(blockpos1.offset(enumfacing2)).getBlock()));
            ...
            if (enumfacing1.getAxis().isHorizontal() && !(Boolean)state.getValue(getPropertyFor(enumfacing1))) {
               ...
               if (block.blockMaterial == Material.air) {
                  ...
                  while(var14.hasNext()) {
                     ...
                     if (rand.nextBoolean()) {
                        iblockstate3 = iblockstate3.withProperty(getPropertyFor(enumfacing), Boolean.FALSE);
                     }
                  }
