...
public class TileEntityBeacon extends TileEntityLockable implements ITickable, IInventory {
   ...
   private void addEffectsToPlayers() {
      if (this.isComplete && this.levels > 0 && !this.worldObj.isRemote && this.primaryEffect > 0) {
         ...
         while(var9.hasNext()) {
            entityplayer1 = (EntityPlayer)var9.next();
            entityplayer1.addPotionEffect(new PotionEffect(this.primaryEffect, 180, i, true, true));
         }
   ...
   private void updateSegmentColors() {
      ...
      int l1;
      for(l1 = k + 1; l1 < 256; ++l1) {
         IBlockState iblockstate = this.worldObj.getBlockState(blockpos$mutableblockpos.func_181079_c(j, l1, l));
         float[] afloat;
      ...
      if (!this.worldObj.isRemote && this.levels == 4 && i < this.levels) {
         Iterator var14 = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class, (new AxisAlignedBB((double)j, (double)k, (double)l, (double)j, (double)(k - 4), (double)l)).expand(10.0D, 5.0D, 10.0D)).iterator();

         while(var14.hasNext()) {
            EntityPlayer entityplayer = (EntityPlayer)var14.next();
