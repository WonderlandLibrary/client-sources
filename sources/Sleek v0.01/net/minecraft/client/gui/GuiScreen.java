...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      this.labelList.forEach((guiLabel) -> {
      ...
      if (chatComponent != null && chatComponent.getChatStyle().getChatHoverEvent() != null) {
         ...
         if (hoverevent.getAction() == HoverEvent.Action.SHOW_ITEM) {
            ...
            if (itemstack != null) {
               ...
               this.drawCreativeTabHoveringText(ChatFormatting.RED + "Invalid Item!", p_175272_2_, p_175272_3_);
            }
         } else {
            String s1;
            if (hoverevent.getAction() == HoverEvent.Action.SHOW_ENTITY) {
               if (this.mc.gameSettings.advancedItemTooltips) {
                  try {
                     ...
                     if (nbtbase1 instanceof NBTTagCompound) {
                        ...
                        this.drawCreativeTabHoveringText(ChatFormatting.RED + "Invalid Entity!", p_175272_2_, p_175272_3_);
                     }
               ...
               if (statbase != null) {
                  ...
                  this.drawCreativeTabHoveringText(ChatFormatting.RED + "Invalid statistic/achievement!", p_175272_2_, p_175272_3_);
               }
            }
         }
   ...
   public void setWorldAndResolution(Minecraft mc, int width, int height) {
      ...
      this.fontRendererObj = mc.MCfontRenderer;
      this.width = width;
      this.height = height;
