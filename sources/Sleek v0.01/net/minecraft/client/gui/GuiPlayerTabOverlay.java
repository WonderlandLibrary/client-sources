...
public class GuiPlayerTabOverlay extends Gui {
   ...
   public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
      ...
      while(var8.hasNext()) {
         ...
         j4 = this.mc.MCfontRenderer.getStringWidth(this.getPlayerName(networkplayerinfo));
         i = Math.max(i, j4);
         if (scoreObjectiveIn != null && scoreObjectiveIn.getRenderType() != IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
            j4 = this.mc.MCfontRenderer.getStringWidth(" " + scoreboardIn.getValueFromObjective(networkplayerinfo.getGameProfile().getName(), scoreObjectiveIn).getScorePoints());
            j = Math.max(j, j4);
         }
      }
      ...
      String s4;
      if (this.header != null) {
         list1 = this.mc.MCfontRenderer.listFormattedStringToWidth(this.header.getFormattedText(), width - 50);

         for(var19 = list1.iterator(); var19.hasNext(); l1 = Math.max(l1, this.mc.MCfontRenderer.getStringWidth(s4))) {
            s4 = (String)var19.next();
         }
      }

      if (this.footer != null) {
         list2 = this.mc.MCfontRenderer.listFormattedStringToWidth(this.footer.getFormattedText(), width - 50);

         for(var19 = list2.iterator(); var19.hasNext(); l1 = Math.max(l1, this.mc.MCfontRenderer.getStringWidth(s4))) {
            s4 = (String)var19.next();
         }
      }
      ...
      int j5;
      if (list1 != null) {
         drawRect(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + list1.size() * this.mc.MCfontRenderer.FONT_HEIGHT, Integer.MIN_VALUE);

         for(var19 = list1.iterator(); var19.hasNext(); k1 += this.mc.MCfontRenderer.FONT_HEIGHT) {
            s4 = (String)var19.next();
            j5 = this.mc.MCfontRenderer.getStringWidth(s4);
            this.mc.MCfontRenderer.drawStringWithShadow(s4, (float)(width / 2 - j5 / 2), (float)k1, -1);
         }
      ...
      for(int k4 = 0; k4 < l3; ++k4) {
         ...
         if (k4 < list.size()) {
            ...
            if (networkplayerinfo1.getGameType() == WorldSettings.GameType.SPECTATOR) {
               s1 = ChatFormatting.ITALIC + s1;
               this.mc.MCfontRenderer.drawStringWithShadow(s1, (float)j2, (float)k2, -1862270977);
            } else {
               this.mc.MCfontRenderer.drawStringWithShadow(s1, (float)j2, (float)k2, -1);
            }
      ...
      if (list2 != null) {
         k1 = k1 + i4 * 9 + 1;
         drawRect(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + list2.size() * this.mc.MCfontRenderer.FONT_HEIGHT, Integer.MIN_VALUE);

         for(var19 = list2.iterator(); var19.hasNext(); k1 += this.mc.MCfontRenderer.FONT_HEIGHT) {
            s4 = (String)var19.next();
            j5 = this.mc.MCfontRenderer.getStringWidth(s4);
            this.mc.MCfontRenderer.drawStringWithShadow(s4, (float)(width / 2 - j5 / 2), (float)k1, -1);
         }
      ...
      if (p_175247_1_.getRenderType() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
         ...
         if (j > 0) {
            ...
            if (f > 3.0F) {
               ...
               if (p_175247_5_ - this.mc.MCfontRenderer.getStringWidth(s + "hp") >= p_175247_4_) {
                  s = s + "hp";
               }

               this.mc.MCfontRenderer.drawStringWithShadow(s, (float)((p_175247_5_ + p_175247_4_) / 2 - this.mc.MCfontRenderer.getStringWidth(s) / 2), (float)p_175247_2_, i1);
            }
         }
      } else {
         String s1 = ChatFormatting.YELLOW + "" + i;
         this.mc.MCfontRenderer.drawStringWithShadow(s1, (float)(p_175247_5_ - this.mc.MCfontRenderer.getStringWidth(s1)), (float)p_175247_2_, 16777215);
      }
