...
public class GuiAchievement extends Gui {
   ...
   public void updateAchievementWindow() {
      if (this.theAchievement != null && this.notificationTime != 0L && Minecraft.getMinecraft().thePlayer != null && !(Boolean)((Tweaks)Slack.getInstance().getModuleManager().getInstance(Tweaks.class)).noachievement.getValue()) {
         ...
         if (this.permanentNotification) {
            this.mc.MCfontRenderer.drawSplitString(this.achievementDescription, i + 30, j + 7, 120, -1);
         } else {
            this.mc.MCfontRenderer.drawString(this.achievementTitle, i + 30, j + 7, -256);
            this.mc.MCfontRenderer.drawString(this.achievementDescription, i + 30, j + 18, -1);
         }
