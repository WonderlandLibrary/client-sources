...
public class GuiIngame extends Gui {
   ...
   public void renderGameOverlay(float partialTicks) {
      ...
      (new RenderEvent(RenderEvent.State.RENDER_2D, partialTicks, (float)scaledresolution.getScaledWidth(), (float)scaledresolution.getScaledHeight())).call();
      ...
      if (scoreobjective1 != null && !(Boolean)((ScoreboardModule)Slack.getInstance().getModuleManager().getInstance(ScoreboardModule.class)).noscoreboard.getValue()) {
         ...
         RenderScoreboard event2 = new RenderScoreboard(State.POST);
         event2.call();
         if (event.isCanceled()) {
            return;
         }
