...
public class SoundHandler implements IResourceManagerReloadListener, ITickable {
         ...
         try {
            ...
            while(var4.hasNext()) {
               ...
               try {
                  ...
                  while(var7.hasNext()) {
                     Entry<String, SoundList> entry = (Entry)var7.next();
   ...
   private void loadSoundResource(ResourceLocation location, SoundList sounds) {
      ...
      while(var5.hasNext()) {
         final SoundList.SoundEntry soundlist$soundentry = (SoundList.SoundEntry)var5.next();
         ...
         case FILE:
            ...
            try {
               ...
               logger.warn("Could not load sound file " + resourcelocation1 + ", cannot add it to event " + location, var19);
               continue;
            } finally {
