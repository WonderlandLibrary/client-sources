...
public class SoundManager {
   ...
   public void updateAllSounds() {
      ...
      while(iterator.hasNext()) {
         ...
         if (itickablesound.isDonePlaying()) {
            ...
            this.sndSystem.setVolume(s1, this.getNormalizedVolume(itickablesound, (SoundPoolEntry)this.playingSoundPoolEntries.get(itickablesound), this.sndHandler.getSound(itickablesound.getSoundLocation()).getSoundCategory()));
            this.sndSystem.setPitch(s1, this.getNormalizedPitch(itickablesound, (SoundPoolEntry)this.playingSoundPoolEntries.get(itickablesound)));
   ...
   public boolean isSoundPlaying(ISound sound) {
      if (!this.loaded) {
         ...
         return s == null ? false : this.sndSystem.playing(s) || this.playingSoundsStopTime.containsKey(s) && (Integer)this.playingSoundsStopTime.get(s) <= this.playTime;
      }
   }
