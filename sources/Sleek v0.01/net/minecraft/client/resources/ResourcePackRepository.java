...
public class ResourcePackRepository {
   ...
   public ListenableFuture<Object> downloadResourcePack(String url, String hash) {
      ...
      try {
         ...
         if (file1.exists() && hash.length() == 40) {
            try {
               ...
               if (s1.equals(hash)) {
                  ...
                  ListenableFuture var19 = listenablefuture2;
                  return var19;
               }
               ...
               logger.warn("File " + file1 + " couldn't be hashed. Deleting it.", var15);
               FileUtils.deleteQuietly(file1);
            }
         }
         ...
         ListenableFuture var11 = listenablefuture;
         return var11;
      } finally {
         this.lock.unlock();
      }
   ...
   public class Entry {
      ...
      public String getTexturePackDescription() {
         return this.rePackMetadataSection == null ? ChatFormatting.RED + "Invalid pack.mcmeta (or missing 'pack' section)" : this.rePackMetadataSection.getPackDescription().getFormattedText();
      }
