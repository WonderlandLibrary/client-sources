...
public class GameSettings {
   ...
   public void setOptionValue(GameSettings.Options p_74306_1_, int p_74306_2_) {
      ...
      if (p_74306_1_ == GameSettings.Options.FORCE_UNICODE_FONT) {
         ...
         this.mc.MCfontRenderer.setUnicodeFlag(this.mc.getLanguageManager().isCurrentLocaleUnicode() || this.forceUnicodeFont);
      }
   ...
   public String getKeyBinding(GameSettings.Options p_74297_1_) {
      ...
      if (s != null) {
         ...
         if (!p_74297_1_.getEnumFloat()) {
            ...
            return p_74297_1_ == GameSettings.Options.MIPMAP_LEVELS && (double)f1 >= 4.0D ? s1 + Lang.get("of.general.max") : (p_74297_1_ == GameSettings.Options.SENSITIVITY ? (f == 0.0F ? s1 + I18n.format("options.sensitivity.min") : (f == 1.0F ? s1 + I18n.format("options.sensitivity.max") : s1 + (int)(f * 200.0F) + "%")) : (p_74297_1_ == GameSettings.Options.FOV ? (f1 == 70.0F ? s1 + I18n.format("options.fov.min") : (f1 == 110.0F ? s1 + I18n.format("options.fov.max") : s1 + (int)f1)) : (p_74297_1_ == GameSettings.Options.FRAMERATE_LIMIT ? (f1 == p_74297_1_.valueMax ? s1 + I18n.format("options.framerateLimit.max") : s1 + (int)f1 + " fps") : (p_74297_1_ == GameSettings.Options.RENDER_CLOUDS ? (f1 == p_74297_1_.valueMin ? s1 + I18n.format("options.cloudHeight.min") : s1 + ((int)f1 + 128)) : (p_74297_1_ == GameSettings.Options.GAMMA ? (f == 0.0F ? s1 + I18n.format("options.gamma.min") : (f == 1.0F ? s1 + I18n.format("options.gamma.max") : s1 + "+" + (int)(f * 100.0F) + "%")) : (p_74297_1_ == GameSettings.Options.SATURATION ? s1 + (int)(f * 400.0F) + "%" : (p_74297_1_ == GameSettings.Options.CHAT_OPACITY ? s1 + (int)(f * 90.0F + 10.0F) + "%" : (p_74297_1_ == GameSettings.Options.CHAT_HEIGHT_UNFOCUSED ? s1 + GuiNewChat.calculateChatboxHeight(f) + "px" : (p_74297_1_ == GameSettings.Options.CHAT_HEIGHT_FOCUSED ? s1 + GuiNewChat.calculateChatboxHeight(f) + "px" : (p_74297_1_ == GameSettings.Options.CHAT_WIDTH ? s1 + GuiNewChat.calculateChatboxWidth(f) + "px" : (p_74297_1_ == GameSettings.Options.RENDER_DISTANCE ? s1 + (int)f1 + " chunks" : (p_74297_1_ == GameSettings.Options.MIPMAP_LEVELS ? (f1 == 0.0F ? s1 + I18n.format("options.off") : s1 + (int)f1) : s1 + (int)(f * 100.0F) + "%"))))))))))));
         }
      }
   }
            ...
            if (this.optionsFile.exists()) {
               ...
               while((s = bufferedreader.readLine()) != null) {
                  try {
                     ...
                     KeyBinding[] var5 = this.keyBindings;
                     ...
                     for(var7 = 0; var7 < var6; ++var7) {
                        SoundCategory soundcategory = var16[var7];
                     ...
                     for(var7 = 0; var7 < var6; ++var7) {
                        EnumPlayerModelParts enumplayermodelparts = var17[var7];
   ...
   public void saveOptions() {
      ...
      try {
         ...
         EnumPlayerModelParts[] var9 = EnumPlayerModelParts.values();
         var3 = var9.length;

         for(var4 = 0; var4 < var3; ++var4) {
            EnumPlayerModelParts enumplayermodelparts = var9[var4];
   ...
   private void setOptionValueOF(GameSettings.Options p_setOptionValueOF_1_, int p_setOptionValueOF_2_) {
      ...
      if (p_setOptionValueOF_1_ == GameSettings.Options.CUSTOM_FONTS) {
         ...
         this.mc.MCfontRenderer.onResourceManagerReload(Config.getResourceManager());
