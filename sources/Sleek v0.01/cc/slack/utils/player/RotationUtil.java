...
public class RotationUtil extends mc {
   ...
   public static float[] getTargetRotations(AxisAlignedBB aabb, RotationUtil.TargetRotation mode, double random) {
      double minX = 0.0D;
      double maxX = 1.0D;
      double minY = 0.0D;
      double maxY = 1.0D;
      ...
      if (mode == RotationUtil.TargetRotation.OPTIMAL) {
   ...
   public static enum TargetRotation {
      EDGE,
      CENTER,
      OPTIMAL,
      MIDDLE,
