   ...
   public void drawTextBox() {
      if (this.func_73778_q()) {
         ...
         if (var4.length() > 0) {
            ...
            var9 = mc.getFontRenderer().drawStringWithShadow(this.text.replaceAll("(?s).", "*"), (float)var7, (float)var8, var1);
         }
         ...
         if (var4.length() > 0 && var5 && var2 < var4.length()) {
            mc.getFontRenderer().drawStringWithShadow(var4.substring(var2), (float)var9, (float)var8, var1);
         }
         ...
         if (var6) {
            if (var10) {
               ...
               mc.getFontRenderer().drawStringWithShadow("_", (float)var11, (float)var8, var1);
            }
         }
