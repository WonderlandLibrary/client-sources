...
import im.expensive.functions.impl.misc.AutoTool;
...
public abstract class PlayerEntity extends LivingEntity {
    ...
    public void tick() {
        ...
        Furious.getInstance().getEventBus().post(livingUpdate);
    ...
    public boolean func_234569_d_(BlockState p_234569_1_) {
        AutoTool autoTool = Furious.getInstance().getFunctionRegistry().getAutoTool();
