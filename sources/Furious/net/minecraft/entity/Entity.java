...
import im.expensive.scripts.lua.classes.EntityClass;
...
public abstract class Entity implements INameable, ICommandSource {
    ...
    public void move(MoverType typeIn, Vector3d pos) {
        ...
        if (this.noClip) {
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Furious.getInstance().getEventBus().post(move);
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Furious.getInstance().getEventBus().post(post);
            }
    ...
    public boolean startRiding(Entity entityIn, boolean force) {
        Furious.getInstance().getEventBus().post(new EventStartRiding(entityIn));
