...
public class ResourcePackInfo implements AutoCloseable
{
    ...
    {
        @Nullable
        ResourcePackInfo create(String p_create_1_, boolean p_create_2_, Supplier<IResourcePack> p_create_3_, IResourcePack p_create_4_, PackMetadataSection p_create_5_, Priority p_create_6_, IPackNameDecorator p_create_7_);
    }
    ...
    public static enum Priority
    {
        ...
        {
            Priority resourcepackinfo$priority = p_198993_4_ ? this.opposite() : this;
