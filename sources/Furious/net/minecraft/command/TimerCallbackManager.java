...
public class TimerCallbackManager<T>
{
    ...
    private final Queue<Entry<T>> entries = new PriorityQueue<>(sorter());
    ...
    {
        return Comparator.<Entry<T>>comparingLong((p_227578_0_) ->
        {
    ...
    public void run(T p_216331_1_, long gameTime)
    {
        while (true)
        {
            Entry<T> entry = this.entries.peek();
    ...
    public void func_227576_a_(String p_227576_1_, long p_227576_2_, ITimerCallback<T> p_227576_4_)
    {
        if (!this.byName.contains(p_227576_1_, p_227576_2_))
        {
            ...
            Entry<T> entry = new Entry<>(p_227576_2_, this.nextUniqueId, p_227576_1_, p_227576_4_);
    ...
    {
        Collection<Entry<T>> collection = this.byName.row(p_227575_1_).values();
