...
public class IOWorker implements AutoCloseable
{
    ...
    protected IOWorker(File p_i231890_1_, boolean p_i231890_2_, String p_i231890_3_)
    {
        ...
        this.field_235969_c_ = new DelegatedTaskExecutor<>(new ITaskQueue.Priority(Priority.values().length), Util.getRenderingService(), "IOWorker-" + p_i231890_3_);
    }
    ...
    public CompletableFuture<Void> func_227093_a_(ChunkPos p_227093_1_, CompoundNBT p_227093_2_)
    {
        ...
        {
            Entry ioworker$entry = this.field_227085_f_.computeIfAbsent(p_227093_1_, (p_235977_1_) -> {
                return new Entry(p_227093_2_);
            });
