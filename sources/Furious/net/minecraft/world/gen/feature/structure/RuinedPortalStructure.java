...
public class RuinedPortalStructure extends Structure<RuinedPortalFeature>
{
    ...
    public IStartFactory<RuinedPortalFeature> getStartFactory()
    {
        return Start::new;
    }
    ...
    public static enum Location implements IStringSerializable
    {
        ...
        private static final Map<String, Location> field_236343_i_ = Arrays.stream(values()).collect(Collectors.toMap(Location::func_236347_b_, (p_236345_0_) -> {
            return p_236345_0_;
        }));
