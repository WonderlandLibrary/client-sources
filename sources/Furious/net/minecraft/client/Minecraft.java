...
import im.expensive.functions.impl.misc.ItemCooldown;
...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
    ...
    public void setDefaultMinecraftTitle() {
        ...
        if (selfDestruct.unhooked) {
            ...
            this.mainWindow.setWindowTitle("Furious 0.5 - 1.16.5");
        }
    }
    ...
    private void tick(boolean isDebug, @Nullable LongTickDetector detector) {
        Furious.getInstance().getEventBus().post(tickEvent);
    ...
    public void runTick() {
        ...
        if (this.world != null) {
            Furious.getInstance().getEventBus().post(player.tick);
    ...
    public void loadWorld(ClientWorld worldClientIn) {
        ...
        Furious.getInstance().getEventBus().post(new EventChangeWorld());
    }
