...
public abstract class Particle
{
    ...
    public void move(double x, double y, double z)
    {
        if (!this.collidedY)
        {
            ...
            {
                Vector3d vector3d = Entity.collideBoundingBoxHeuristically((Entity)null, new Vector3d(x, y, z), this.getBoundingBox(), this.world, ISelectionContext.dummy(), new ReuseableStream<>(Stream.empty()), false, false);
                x = vector3d.x;
                y = vector3d.y;
                z = vector3d.z;
            }
