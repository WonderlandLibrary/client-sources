...
public class StatsScreen extends Screen implements IProgressMeter
{
    ...
    class CustomStatsList extends ExtendedList<CustomStatsList.Entry>
    {
        ...
        class Entry extends net.minecraft.client.gui.widget.list.AbstractList.AbstractListEntry<Entry>
        {
    ...
    class MobStatsList extends ExtendedList<MobStatsList.Entry>
    {
    ...
    class StatsList extends ExtendedList<StatsList.Entry>
    {
        ...
        protected final java.util.Comparator<Item> field_195117_z = new Comparator();
        @Nullable
        ...
        protected void renderDecorations(MatrixStack p_230447_1_, int p_230447_2_, int p_230447_3_)
        {
            ...
            {
                Entry statsscreen$statslist$entry = this.getEntryAtPosition((double)p_230447_2_, (double)p_230447_3_);
