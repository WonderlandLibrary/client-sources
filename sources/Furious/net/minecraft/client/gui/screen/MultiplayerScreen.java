...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = Furious.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(Furious.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        Furious.getInstance().getViaMCP().viaScreen.tick();
