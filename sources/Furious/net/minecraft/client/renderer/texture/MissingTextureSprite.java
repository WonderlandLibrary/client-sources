...
public final class MissingTextureSprite extends TextureAtlasSprite
{
    ...
    private static final Info spriteInfo = new Info(LOCATION, 16, 16, new AnimationMetadataSection(Lists.newArrayList(new AnimationFrame(0, -1)), 16, 16, 1, false));

    public MissingTextureSprite(AtlasTexture p_i242120_1_, Info p_i242120_2_, int p_i242120_3_, int p_i242120_4_, int p_i242120_5_, int p_i242120_6_, int p_i242120_7_)
    {
    ...
    public static Info getSpriteInfo()
    {
        return spriteInfo;
    }
