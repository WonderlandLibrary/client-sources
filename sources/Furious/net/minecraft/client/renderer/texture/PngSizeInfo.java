...
public class PngSizeInfo
{
    ...
    public PngSizeInfo(String p_i51172_1_, InputStream p_i51172_2_) throws IOException
    {
        synchronized (STATIC_MONITOR)
        {
            try (
                    ...
                    Reader pngsizeinfo$reader = func_195695_a(p_i51172_2_);
    ...
    {
        return (Reader)(p_195695_0_ instanceof FileInputStream ? new ReaderSeekable(((FileInputStream)p_195695_0_).getChannel()) : new ReaderBuffer(Channels.newChannel(p_195695_0_)));
    }
    ...
    static class ReaderBuffer extends Reader
    {
    ...
    static class ReaderSeekable extends Reader
    {
