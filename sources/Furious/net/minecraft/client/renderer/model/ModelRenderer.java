...
public class ModelRenderer
{
    ...
    private void doRender(MatrixStack.Entry matrixEntryIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ModelBox modelrenderer$modelbox = this.cubeList.get(j);
            ...
            for (int k = 0; k < i1; ++k)
            {
                TexturedQuad modelrenderer$texturedquad = modelrenderer$modelbox.quads[k];
                ...
                if (modelrenderer$texturedquad != null)
                {
                    ...
                    for (int l = 0; l < 4; ++l)
                    {
                        PositionTextureVertex modelrenderer$positiontexturevertex = modelrenderer$texturedquad.vertexPositions[l];
    ...
    {
        this.cubeList.add(new ModelBox(p_addBox_1_, p_addBox_2_, p_addBox_3_, p_addBox_4_, p_addBox_5_, p_addBox_6_, p_addBox_7_, p_addBox_8_, p_addBox_8_, p_addBox_8_, this.mirror, this.textureWidth, this.textureHeight));
    }
    ...
    public static class ModelBox
    {
        ...
        public ModelBox(int[][] p_i242122_1_, float p_i242122_2_, float p_i242122_3_, float p_i242122_4_, float p_i242122_5_, float p_i242122_6_, float p_i242122_7_, float p_i242122_8_, float p_i242122_9_, float p_i242122_10_, boolean p_i242122_11_, float p_i242122_12_, float p_i242122_13_)
        {
            ...
            PositionTextureVertex modelrenderer$positiontexturevertex7 = new PositionTextureVertex(p_i242122_2_, p_i242122_3_, p_i242122_4_, 0.0F, 0.0F);
            PositionTextureVertex modelrenderer$positiontexturevertex = new PositionTextureVertex(f, p_i242122_3_, p_i242122_4_, 0.0F, 8.0F);
            PositionTextureVertex modelrenderer$positiontexturevertex1 = new PositionTextureVertex(f, f1, p_i242122_4_, 8.0F, 8.0F);
            PositionTextureVertex modelrenderer$positiontexturevertex2 = new PositionTextureVertex(p_i242122_2_, f1, p_i242122_4_, 8.0F, 0.0F);
            PositionTextureVertex modelrenderer$positiontexturevertex3 = new PositionTextureVertex(p_i242122_2_, p_i242122_3_, f2, 0.0F, 0.0F);
            PositionTextureVertex modelrenderer$positiontexturevertex4 = new PositionTextureVertex(f, p_i242122_3_, f2, 0.0F, 8.0F);
            PositionTextureVertex modelrenderer$positiontexturevertex5 = new PositionTextureVertex(f, f1, f2, 8.0F, 8.0F);
            PositionTextureVertex modelrenderer$positiontexturevertex6 = new PositionTextureVertex(p_i242122_2_, f1, f2, 8.0F, 0.0F);
            this.quads[2] = this.makeTexturedQuad(new PositionTextureVertex[] {modelrenderer$positiontexturevertex4, modelrenderer$positiontexturevertex3, modelrenderer$positiontexturevertex7, modelrenderer$positiontexturevertex}, p_i242122_1_[1], true, p_i242122_12_, p_i242122_13_, p_i242122_11_, Direction.DOWN);
            this.quads[3] = this.makeTexturedQuad(new PositionTextureVertex[] {modelrenderer$positiontexturevertex1, modelrenderer$positiontexturevertex2, modelrenderer$positiontexturevertex6, modelrenderer$positiontexturevertex5}, p_i242122_1_[0], true, p_i242122_12_, p_i242122_13_, p_i242122_11_, Direction.UP);
            this.quads[1] = this.makeTexturedQuad(new PositionTextureVertex[] {modelrenderer$positiontexturevertex7, modelrenderer$positiontexturevertex3, modelrenderer$positiontexturevertex6, modelrenderer$positiontexturevertex2}, p_i242122_1_[5], false, p_i242122_12_, p_i242122_13_, p_i242122_11_, Direction.WEST);
            this.quads[4] = this.makeTexturedQuad(new PositionTextureVertex[] {modelrenderer$positiontexturevertex, modelrenderer$positiontexturevertex7, modelrenderer$positiontexturevertex2, modelrenderer$positiontexturevertex1}, p_i242122_1_[2], false, p_i242122_12_, p_i242122_13_, p_i242122_11_, Direction.NORTH);
            this.quads[0] = this.makeTexturedQuad(new PositionTextureVertex[] {modelrenderer$positiontexturevertex4, modelrenderer$positiontexturevertex, modelrenderer$positiontexturevertex1, modelrenderer$positiontexturevertex5}, p_i242122_1_[4], false, p_i242122_12_, p_i242122_13_, p_i242122_11_, Direction.EAST);
            this.quads[5] = this.makeTexturedQuad(new PositionTextureVertex[] {modelrenderer$positiontexturevertex3, modelrenderer$positiontexturevertex4, modelrenderer$positiontexturevertex5, modelrenderer$positiontexturevertex6}, p_i242122_1_[3], false, p_i242122_12_, p_i242122_13_, p_i242122_11_, Direction.SOUTH);
        }

        private TexturedQuad makeTexturedQuad(PositionTextureVertex[] p_makeTexturedQuad_1_, int[] p_makeTexturedQuad_2_, boolean p_makeTexturedQuad_3_, float p_makeTexturedQuad_4_, float p_makeTexturedQuad_5_, boolean p_makeTexturedQuad_6_, Direction p_makeTexturedQuad_7_)
        {
