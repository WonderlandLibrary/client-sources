...
public class FilledProfileResult implements IProfileResult
{
    ...
    private static final Comparator<Entry<String, Section>> field_230092_d_ = Entry.<String, Section>comparingByValue(Comparator.comparingLong((p_230096_0_) ->
    {
    ...
    {
        Map<String, Section> map = Maps.newTreeMap();
