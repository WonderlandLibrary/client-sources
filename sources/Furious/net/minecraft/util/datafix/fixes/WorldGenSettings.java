...
{
    private static final ImmutableMap<String, StructureSeparationSettingsCodec> field_233422_a_ = ImmutableMap.<String, StructureSeparationSettingsCodec>builder().put("minecraft:village", new StructureSeparationSettingsCodec(32, 8, 10387312)).put("minecraft:desert_pyramid", new StructureSeparationSettingsCodec(32, 8, 14357617)).put("minecraft:igloo", new StructureSeparationSettingsCodec(32, 8, 14357618)).put("minecraft:jungle_pyramid", new StructureSeparationSettingsCodec(32, 8, 14357619)).put("minecraft:swamp_hut", new StructureSeparationSettingsCodec(32, 8, 14357620)).put("minecraft:pillager_outpost", new StructureSeparationSettingsCodec(32, 8, 165745296)).put("minecraft:monument", new StructureSeparationSettingsCodec(32, 5, 10387313)).put("minecraft:endcity", new StructureSeparationSettingsCodec(20, 11, 10387313)).put("minecraft:mansion", new StructureSeparationSettingsCodec(80, 20, 10387319)).build();
    ...
    private static <T> Map<Dynamic<T>, Dynamic<T>> func_233430_a_(DynamicOps<T> p_233430_0_, OptionalDynamic<T> p_233430_1_)
    {
        ...
        Map<String, StructureSeparationSettingsCodec> map = Maps.newHashMap();
    ...
    static final class StructureSeparationSettingsCodec
    {
        public static final Codec<StructureSeparationSettingsCodec> field_233442_a_ = RecordCodecBuilder.create((p_233448_0_) ->
        {
            ...
            })).apply(p_233448_0_, StructureSeparationSettingsCodec::new);
        });
