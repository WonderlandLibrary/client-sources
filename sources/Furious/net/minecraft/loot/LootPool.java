...
public class LootPool
{
    ...
    public static class Builder implements ILootFunctionConsumer<Builder>, ILootConditionConsumer<Builder>
    {
        ...
        public Builder rolls(IRandomRange rollsIn)
        {
            this.rolls = rollsIn;
            return this;
        }
        ...
        public Builder addEntry(LootEntry.Builder<?> entriesBuilder)
        {
            this.entries.add(entriesBuilder.build());
            return this;
        }

        public Builder acceptCondition(ILootCondition.IBuilder conditionBuilder)
        {
