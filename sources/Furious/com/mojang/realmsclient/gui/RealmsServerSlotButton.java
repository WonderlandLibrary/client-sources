...
public class RealmsServerSlotButton extends Button implements IScreen
{
    ...
    public RealmsServerSlotButton(int p_i232195_1_, int p_i232195_2_, int p_i232195_3_, int p_i232195_4_, Supplier<RealmsServer> p_i232195_5_, Consumer<ITextComponent> p_i232195_6_, int p_i232195_7_, IPressable p_i232195_8_)
    {
    ...
    public void tick()
    {
        ...
        if (realmsserver != null)
        {
            ...
            Action realmsserverslotbutton$action = func_237720_a_(realmsserver, flag, flag2);
    ...
    private void func_237718_a_(MatrixStack p_237718_1_, int p_237718_2_, int p_237718_3_, int p_237718_4_, int p_237718_5_, boolean p_237718_6_, String p_237718_7_, int p_237718_8_, long p_237718_9_, @Nullable String p_237718_11_, boolean p_237718_12_, boolean p_237718_13_, Action p_237718_14_, @Nullable ITextComponent p_237718_15_)
    {
        ...
        boolean flag1 = flag && p_237718_14_ != Action.NOTHING;
