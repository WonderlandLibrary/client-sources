...
public class RealmsPlayerScreen extends RealmsScreen
{
    ...
    private void func_237914_c_(MatrixStack p_237914_1_, int p_237914_2_, int p_237914_3_, int p_237914_4_, int p_237914_5_)
    {
        ...
        blit(p_237914_1_, p_237914_2_, p_237914_3_, 0.0F, f, 8, 7, 8, 14);
    ...
    private void func_237921_d_(MatrixStack p_237921_1_, int p_237921_2_, int p_237921_3_, int p_237921_4_, int p_237921_5_)
    {
        ...
        blit(p_237921_1_, p_237921_2_, p_237921_3_, 0.0F, f, 8, 8, 8, 16);
    ...
    private void func_237925_e_(MatrixStack p_237925_1_, int p_237925_2_, int p_237925_3_, int p_237925_4_, int p_237925_5_)
    {
        ...
        RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
        float f = flag ? 8.0F : 0.0F;
        blit(p_237925_1_, p_237925_2_, p_237925_3_, 0.0F, f, 8, 8, 8, 16);
    ...
    class InvitedEntry extends ExtendedList.AbstractListEntry<InvitedEntry>
    {
        ...
        private void func_237932_a_(MatrixStack p_237932_1_, PlayerInfo p_237932_2_, int p_237932_3_, int p_237932_4_, int p_237932_5_, int p_237932_6_)
        {
            ...
            {
                RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
                blit(p_237932_1_, RealmsPlayerScreen.this.field_224305_f + 2 + 2, p_237932_4_ + 1, 8, 8, 8.0F, 8.0F, 8, 8, 64, 64);
                blit(p_237932_1_, RealmsPlayerScreen.this.field_224305_f + 2 + 2, p_237932_4_ + 1, 8, 8, 40.0F, 8.0F, 8, 8, 64, 64);
            });
        }
    }
    ...
    class InvitedList extends RealmsObjectSelectionList<InvitedEntry>
    {
        public InvitedList()
        {
            super(RealmsPlayerScreen.this.field_224306_g + 10, func_239562_k_(12) + 20, func_239562_k_(1), func_239562_k_(12) + 20, 13);
        }
