...
public class RealmsMainScreen extends RealmsScreen
{
    ...
    private void func_243059_h(RealmsServer p_243059_1_)
    {
        ...
        {
            return p_243041_1_ instanceof ServerEntry && ((ServerEntry)p_243041_1_).field_223734_a.field_230582_a_ == this.field_224021_j;
        });
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.field_224037_z && !this.field_223993_A && this.func_223990_b())
        {
            ...
            blit(matrixStack, this.field_224009_Q.x + this.field_224009_Q.getWidth() - 8 - 4, this.field_224009_Q.y + this.field_224009_Q.getHeightRealms() / 2 - 4, 0.0F, (float)j, 8, 8, 8, 16);
        }
    }
    ...
    private void func_237579_a_(MatrixStack p_237579_1_, int p_237579_2_, int p_237579_3_)
    {
        ...
        blit(p_237579_1_, p_237579_2_ * 2, p_237579_3_ * 2 - 5, 0.0F, 0.0F, 200, 50, 200, 50);
    ...
    private void func_237581_a_(MatrixStack p_237581_1_, int p_237581_2_, int p_237581_3_, int p_237581_4_, int p_237581_5_, boolean p_237581_6_, boolean p_237581_7_)
    {
        ...
        blit(p_237581_1_, p_237581_4_, p_237581_5_ - 6, f2, 0.0F, 15, 25, 31, 25);
        ...
        if (flag2)
        {
            ...
            blit(p_237581_1_, p_237581_4_ + 4, p_237581_5_ + 4 + l, (float)k, f1, 8, 8, 48, 16);
        }
    ...
    private void func_237614_c_(MatrixStack p_237614_1_, int p_237614_2_, int p_237614_3_, int p_237614_4_, int p_237614_5_)
    {
        ...
        RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
        blit(p_237614_1_, p_237614_2_, p_237614_3_, 0.0F, 0.0F, 10, 28, 10, 28);
    ...
    private void func_237606_b_(MatrixStack p_237606_1_, int p_237606_2_, int p_237606_3_, int p_237606_4_, int p_237606_5_, int p_237606_6_)
    {
        ...
        {
            blit(p_237606_1_, p_237606_2_, p_237606_3_, 0.0F, 0.0F, 10, 28, 20, 28);
        }
        else
        {
            blit(p_237606_1_, p_237606_2_, p_237606_3_, 10.0F, 0.0F, 10, 28, 20, 28);
        }
    ...
    private void func_237620_d_(MatrixStack p_237620_1_, int p_237620_2_, int p_237620_3_, int p_237620_4_, int p_237620_5_)
    {
        ...
        RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
        blit(p_237620_1_, p_237620_2_, p_237620_3_, 0.0F, 0.0F, 10, 28, 10, 28);
    ...
    private void func_237626_e_(MatrixStack p_237626_1_, int p_237626_2_, int p_237626_3_, int p_237626_4_, int p_237626_5_)
    {
        ...
        RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
        blit(p_237626_1_, p_237626_2_, p_237626_3_, 0.0F, 0.0F, 10, 28, 10, 28);
    ...
    private void func_237630_f_(MatrixStack p_237630_1_, int p_237630_2_, int p_237630_3_, int p_237630_4_, int p_237630_5_)
    {
        ...
        blit(p_237630_1_, p_237630_2_, p_237630_3_, f, 0.0F, 28, 28, 56, 28);
    ...
    private void func_237633_g_(MatrixStack p_237633_1_, int p_237633_2_, int p_237633_3_, int p_237633_4_, int p_237633_5_)
    {
        ...
        RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
        float f = flag ? 28.0F : 0.0F;
        blit(p_237633_1_, p_237633_2_, p_237633_3_, f, 0.0F, 28, 28, 56, 28);
    ...
    private void func_237580_a_(MatrixStack p_237580_1_, int p_237580_2_, int p_237580_3_, int p_237580_4_, int p_237580_5_, boolean p_237580_6_)
    {
        ...
        blit(p_237580_1_, p_237580_4_, p_237580_5_, f, 0.0F, 20, 20, 40, 20);
    ...
    private void func_237582_a_(MatrixStack p_237582_1_, int p_237582_2_, int p_237582_3_, boolean p_237582_4_, int p_237582_5_, int p_237582_6_, boolean p_237582_7_, boolean p_237582_8_)
    {
        ...
        blit(p_237582_1_, p_237582_5_, p_237582_6_, f, 0.0F, 20, 20, 40, 20);
        ...
        if (p_237582_4_ && p_237582_8_)
        {
            ...
            this.minecraft.getTextureManager().bindTexture(field_237545_s_);
            RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
            blit(p_237582_1_, p_237582_5_ + 10, p_237582_6_ + 2 + i, 40.0F, 0.0F, 8, 8, 48, 16);
        }
    }
    ...
    abstract class ListEntry extends ExtendedList.AbstractListEntry<ListEntry>
    {
        private ListEntry()
        {
        }
    ...
    class ServerEntry extends ListEntry
    {
        ...
        private void func_237679_b_(RealmsServer p_237679_1_, MatrixStack p_237679_2_, int p_237679_3_, int p_237679_4_, int p_237679_5_, int p_237679_6_)
        {
            if (p_237679_1_.field_230586_e_ == RealmsServer.Status.UNINITIALIZED)
            {
                ...
                blit(p_237679_2_, p_237679_3_ + 10, p_237679_4_ + 6, 0.0F, 0.0F, 40, 20, 40, 20);
                ...
                drawCenteredString(p_237679_2_, RealmsMainScreen.this.font, RealmsMainScreen.field_243003_H, p_237679_3_ + 10 + 40 + 75, p_237679_4_ + 12, k2);
            }
            else
            {
                int i = 225;
                ...
                if (RealmsMainScreen.this.func_223885_h(p_237679_1_) && p_237679_1_.field_230591_j_)
                {
                    ...
                    int l1 = flag ? 2 : 1;
                    blit(p_237679_2_, j1, k1, 0.0F, (float)(46 + l1 * 20), l / 2, 8, 256, 256);
                    blit(p_237679_2_, j1 + l / 2, k1, (float)(200 - l / 2), (float)(46 + l1 * 20), l / 2, 8, 256, 256);
                    blit(p_237679_2_, j1, k1 + 8, 0.0F, (float)(46 + l1 * 20 + 12), l / 2, 8, 256, 256);
                    blit(p_237679_2_, j1 + l / 2, k1 + 8, (float)(200 - l / 2), (float)(46 + l1 * 20 + 12), l / 2, 8, 256, 256);
                    RenderSystem.disableBlend();
                    ...
                    drawCenteredString(p_237679_2_, RealmsMainScreen.this.font, itextcomponent1, j1 + l / 2, i2 + 1, j2);
                }
                else
                {
                ...
                {
                    RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
                    blit(p_237679_2_, p_237679_3_ - 36, p_237679_4_, 32, 32, 8.0F, 8.0F, 8, 8, 64, 64);
                    blit(p_237679_2_, p_237679_3_ - 36, p_237679_4_, 32, 32, 40.0F, 8.0F, 8, 8, 64, 64);
                });
            }
        }
    }

    class ServerList extends RealmsObjectSelectionList<ListEntry>
    {
        ...
        public boolean keyPressed(int keyCode, int scanCode, int modifiers)
        {
            ...
            {
                AbstractListEntry extendedlist$abstractlistentry = this.getSelected();
    ...
    class TrialServerEntry extends ListEntry
    {
        ...
        private void func_237681_a_(MatrixStack p_237681_1_, int p_237681_2_, int p_237681_3_, int p_237681_4_, int p_237681_5_, int p_237681_6_)
        {
            ...
            {
                drawCenteredString(p_237681_1_, RealmsMainScreen.this.font, itextcomponent, RealmsMainScreen.this.width / 2, i + j, k);
                j += 10;
            }
        }
    }
