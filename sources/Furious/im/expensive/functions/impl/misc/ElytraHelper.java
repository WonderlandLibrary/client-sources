...
@FunctionRegister(name = "ElytraHelper", type = Category.Miscellaneous)
    ...
    private void changeChestPlate(ItemStack stack) {
        ...
        if (stack.getItem() != Items.ELYTRA) {
            ...
            if (elytraSlot >= 0) {
                ...
                print(TextFormatting.WHITE + "Свапнул на элитру!");
                return;
            } else {
        ...
        if (armorSlot >= 0) {
            ...
            print(TextFormatting.WHITE + "Свапнул на нагрудник!");
        } else {
