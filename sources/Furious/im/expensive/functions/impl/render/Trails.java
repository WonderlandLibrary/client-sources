...
public class Trails extends Function {
    private final SliderSetting timeLife = new SliderSetting("Время жизни", 1f, 1f, 100f, 1f);

    public Trails() {
        addSettings(timeLife);
    }
    @Subscribe
    public void onRender(WorldEvent event) {

            for (PlayerEntity entity : mc.world.getPlayers()) {
            entity.points.removeIf(p -> p.time.isReached((long) (timeLife.get() * 100)));
