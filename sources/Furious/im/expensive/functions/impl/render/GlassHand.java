...
public class GlassHand extends Function {
    ...
    public void onRender(EventDisplay e) {
        ...
        if (mc.gameSettings.getPointOfView() == PointOfView.FIRST_PERSON) {
            ...
            ColorUtils.setColor(HUD.getColor(0,1));
    ...
    public static void setSaturation(float saturation) {
        float[] saturationMatrix = {0.4086f * (0.5f - saturation) + saturation, 0.6094f * (1.0f - saturation), 0.0820f * (1.0f - saturation), 0, 0, 0.3086f * (1.0f - saturation), 0.6094f * (1.0f - saturation) + saturation, 0.0820f * (1.0f - saturation), 0, 0, 0.3086f * (1.0f - saturation), 0.6094f * (1.0f - saturation), 0.0820f * (1.0f - saturation) + saturation, 0, 0, 0, 0, 0, 1, 0};
