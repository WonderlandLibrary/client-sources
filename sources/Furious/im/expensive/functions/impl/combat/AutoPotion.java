...
public class AutoPotion extends Function {
    ...
    private boolean canThrowPotion() {
        boolean isOnGround = !MoveUtils.isBlockUnder(0.4F) || mc.player.isOnGround();
        boolean timeIsReached = stopWatch.isReached(200);
        boolean ticksExisted = mc.player.ticksExisted > 10;
    ...
    private Vector3d findNearestCollision() {
        return mc.world.getCollisionShapes(mc.player, mc.player.getBoundingBox().grow(0.0, 0.3, 0.0))
                .toList()
                .stream()
