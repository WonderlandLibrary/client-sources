...
public class DisplayUtils implements IMinecraft {
    public static void drawtargetespimage(MatrixStack stack, ResourceLocation image, double x, double y, double z, double width, double height, int color1, int color2, int color3, int color4) {
        ...
        bufferBuilder.pos(stack.getLast().getMatrix(), (float)x, (float)(y + height), (float)z).color(color1 >> 12 & 255, color1 >> 6 & 255, color1 & 255, color1 >>> 16).tex(0.0F, 0.99F).lightmap(0, 241).endVertex();
        bufferBuilder.pos(stack.getLast().getMatrix(), (float)(x + width), (float)(y + height), (float)z).color(color2 >> 12 & 255, color2 >> 8 & 255, color2 & 255, color2 >>> 16).tex(1.0F, 0.99F).lightmap(0, 241).endVertex();
        bufferBuilder.pos(stack.getLast().getMatrix(), (float)(x + width), (float)y, (float)z).color(color3 >> 12 & 255, color3 >> 6 & 255, color3 & 255, color3 >>> 16).tex(1.0F, 0.0F).lightmap(0, 241).endVertex();
        bufferBuilder.pos(stack.getLast().getMatrix(), (float)x, (float)y, (float)z).color(color4 >> 12 & 255, color4 >> 6 & 255, color4 & 255, color4 >>> 16).tex(0.0F, 0.0F).lightmap(0, 241).endVertex();
        tessellator.draw();
