...
public class Panel implements IBuilder {
    ...
    public void render(MatrixStack stack, float mouseX, float mouseY) {
        ...
        Fonts.montserrat.drawCenteredText(stack, category.name(), x + width / 2f,
                y + 1f+ header / 2f - Fonts.montserrat.getHeight(headerFont) / 2f - 1, ColorUtils.rgb(255, 255, 255),
                headerFont, 0.1f);
    ...
    private void drawStyledRect(float x,
        ...
        DisplayUtils.drawRoundedRect(x - 0.5f, y - 0.5f, width + 1, height + 1, radius + 0.5f, HUD.getColor(1)); // outline
    }
