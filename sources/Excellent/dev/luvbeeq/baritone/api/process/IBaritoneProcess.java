...
import dev.luvbeeq.baritone.api.event.events.PathEvent;

/**
 * A process that can control the PathingBehavior.
 * <p>
 * Differences between a dev.intave.baritone process and a behavior:
 * <ul>
 * <li>Only one dev.intave.baritone process can be active at a time</li>
