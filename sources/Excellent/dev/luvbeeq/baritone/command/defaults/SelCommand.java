...
import dev.luvbeeq.baritone.api.command.datatypes.ForAxis;
import dev.luvbeeq.baritone.api.command.datatypes.ForBlockOptionalMeta;
import dev.luvbeeq.baritone.api.command.datatypes.ForDirection;
...
import dev.luvbeeq.baritone.api.schematic.*;
import dev.luvbeeq.baritone.api.schematic.mask.shape.CylinderMask;
import dev.luvbeeq.baritone.api.schematic.mask.shape.SphereMask;
            ...
            for (ISelection selection : selections) {
                ...
                UnaryOperator<ISchematic> create = fill -> {
                    ...
                    return switch (action) {
                        ...
                        case CYLINDER ->
                                MaskSchematic.create(fill, new CylinderMask(w, h, l, true, alignment).compute());
                        case HCYLINDER ->
                                MaskSchematic.create(fill, new CylinderMask(w, h, l, false, alignment).compute());
                        default ->
                            // Silent fail
                                fill;
                    };
