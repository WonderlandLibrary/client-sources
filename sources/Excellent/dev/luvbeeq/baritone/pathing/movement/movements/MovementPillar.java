...
import dev.luvbeeq.baritone.api.utils.VecUtils;
    ...
    public MovementState updateState(MovementState state) {
        ...
        if (ladder) {
            ...
            if (dist > 0.17) {//why 0.17? because it seemed like a good number, that's why
                //[explanation added after dev.intave.baritone port lol] also because it needs to be less than 0.2 because of the 0.3 sneak limit
