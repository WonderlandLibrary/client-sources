...
@Getter
public class BlurShader implements IRenderAccess {
    private final ShaderLink upSample = ShaderLink.create("kawaseUp");
    private final ShaderLink downSample = ShaderLink.create("kawaseDown");
    ...
    public void draw(int iterations, float offset, RenderType type, float saturation) {
        ...
        switch (type) {
            ...
            case DISPLAY -> {
                ...
                renderFBO(framebufferList.get(1), mc.getFramebuffer().framebufferTexture, downSample, offset);
                renderFBO(framebufferList.get(1), mc.getFramebuffer().framebufferTexture, upSample, offset);
                ...
                upSample.setUniformi("textureToCheck", 20);
