...
@Getter
public class GlowShader implements IRenderAccess {
    private final ShaderLink upSample = ShaderLink.create("kawaseUpGlow");
    private final ShaderLink downSample = ShaderLink.create("kawaseDownGlow");
    ...
    private void initFramebuffers(float iterations) {
        ...
        framebufferList.add(outFramebuffer = RenderUtil.FrameBuffer.createFrameBuffer(null, true));
        ...
        for (int i = 0; i <= iterations; i++) {
            ...
            Framebuffer currentBuffer = new Framebuffer(width, height, true);
    ...
    public void draw(int iterations, float offset, RenderType type, float saturation, int color) {
        ...
        switch (type) {
            ...
            case DISPLAY -> {
                ...
                upSample.init();
                upSample.setUniformf("color", ColorUtil.redf(color), ColorUtil.greenf(color), ColorUtil.bluef(color), ColorUtil.alphaf(color));
