...
public abstract class AbstractBlock {
     ...
     * call via {@link IBlockState#onBlockEventReceived(World, BlockPos, int, int)} whenever possible.
     ...
     * call via {@link IBlockState#getRenderType()} whenever possible. Implementing/overriding is fine.
     */
    ...
    /**
     * call via {@link IBlockState#getMobilityFlag()} whenever possible. Implementing/overriding is fine.
     */
    ...
    /**
     * call via {@link IBlockState#hasComparatorInputOverride()} whenever possible. Implementing/overriding
     * is fine.
     */
     ...
     * blockstate.
     * call via {@link IBlockState#withRotation(Rotation)} whenever possible. Implementing/overriding is
     * fine.
     */
     ...
     * blockstate.
     * call via {@link IBlockState#withMirror(Mirror)} whenever possible. Implementing/overriding is fine.
     */
    ...
    /**
     * call via {@link IBlockState#getComparatorInputOverride(World, BlockPos)} whenever possible.
     * Implementing/overriding is fine.
     */
     ...
     * call via {@link IBlockState#getPlayerRelativeBlockHardness(EntityPlayer, World, BlockPos)} whenever
    ...
    /**
     * call via {@link IBlockState#getStrongPower(IBlockAccess, BlockPos, EnumFacing)} whenever possible.
     * Implementing/overriding is fine.
     */
    ...
    public abstract static class AbstractBlockState extends StateHolder<Block, BlockState> {
        ...
        public boolean isReplaceable() {
            return this.getBlock().isReplaceable();
        }
