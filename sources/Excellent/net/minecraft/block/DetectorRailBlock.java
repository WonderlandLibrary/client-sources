...
public class DetectorRailBlock extends AbstractRailBlock {
    ...
    public int getComparatorInputOverride(BlockState blockState, World worldIn, BlockPos pos) {
        if (blockState.get(POWERED)) {
            List<CommandBlockMinecartEntity> list = this.findMinecarts(worldIn, pos, CommandBlockMinecartEntity.class, null);
    ...
    private AxisAlignedBB getDectectionBox(BlockPos pos) {
        double d0 = 0.2D;
        return new AxisAlignedBB((double) pos.getX() + 0.2D, pos.getY(), (double) pos.getZ() + 0.2D, (double) (pos.getX() + 1) - 0.2D, (double) (pos.getY() + 1) - 0.2D, (double) (pos.getZ() + 1) - 0.2D);
    }
