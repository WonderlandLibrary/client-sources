...
public abstract class PlayerEntity extends LivingEntity {
     ...
     */
    public void tick() {
        this.noClip = this.isSpectator() || FreeCam.singleton.get().isEnabled();
    ...
    public ItemEntity dropItem(ItemStack droppedItem, boolean dropAround, boolean traceItem) {
        if (droppedItem.isEmpty()) {
            ...
            if (dropAround) {
                ...
                itementity.setMotion((double) (-f3 * f2 * f7) + Math.cos(f5) * (double) f6, -f8 * f7 + 0.1F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.1F, (double) (f4 * f2 * f7) + Math.sin(f5) * (double) f6);
            }
    ...
    public boolean isPushedByWater() {
        if (NoPush.singleton.get().isEnabled() && NoPush.singleton.get().elements.isEnabled("Воды"))
            return false;
        return !this.abilities.isFlying;
    }
