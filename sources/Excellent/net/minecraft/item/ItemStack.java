...
public final class ItemStack implements IItemStack {
    public static final Codec<ItemStack> CODEC = RecordCodecBuilder.create((p_234698_0_) ->
            p_234698_0_.group(Registry.ITEM.fieldOf("id").forGetter((p_234706_0_) -> p_234706_0_.item),
                    Codec.INT.fieldOf("Count").forGetter((p_234705_0_) -> p_234705_0_.count),
                    CompoundNBT.CODEC.optionalFieldOf("tag").forGetter((p_234704_0_) -> Optional.ofNullable(p_234704_0_.tag))).apply(p_234698_0_, ItemStack::new));
    ...
    public ItemStack onItemUseFinish(World worldIn, LivingEntity entityLiving) {
        ...
        CustomCooldown.ItemEnum itemEnum = CustomCooldown.ItemEnum.getItemEnum(getItem());
                ...
                if (itag != null) {
                    ...
                    if (!collection.isEmpty()) {
                        return collection.stream().map(Block::getTranslatedName).map((p_222119_0_) ->
                                p_222119_0_.mergeStyle(TextFormatting.DARK_GRAY)).collect(Collectors.toList());
                    }
                }
            }
    ...
    public ITextComponent getTextComponent() {
        ...
        if (!this.isEmpty) {
            iformattabletextcomponent1.mergeStyle(this.getRarity().color).modifyStyle((p_234702_1_) ->
                    p_234702_1_.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_ITEM, new HoverEvent.ItemHover(this))));
        }
