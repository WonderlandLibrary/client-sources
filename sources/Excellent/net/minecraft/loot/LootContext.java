        ...
        public LootContext build(LootParameterSet parameterSet) {
            ...
            if (!set.isEmpty()) {
                ...
                if (!set1.isEmpty()) {
                    ...
                    MinecraftServer minecraftserver = BaritoneUtils.getServer(this.world);
                    return new LootContext(random, this.luck, this.world, BaritoneUtils.getLootTableManager(minecraftserver)::getLootTableFromLocation, BaritoneUtils.getLootPredicateManager(minecraftserver)::func_227517_a_, this.lootParameters, this.field_216026_c);
                }
            }
        }
    }
