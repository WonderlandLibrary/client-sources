...
import dev.excellent.api.event.impl.funs.RenderSpiderFootEvent;
...
public class SpiderModel<T extends Entity> extends SegmentedModel<T> {
   ...
   public Iterable<ModelRenderer> getParts() {
      RenderSpiderFootEvent renderSpiderFootEvent = new RenderSpiderFootEvent();
      Excellent.getInst().getEventBus().handle(renderSpiderFootEvent);
      if (renderSpiderFootEvent.isCancelled())
         return ImmutableList.of(this.spiderHead, this.spiderNeck, this.spiderBody);
      else
