...
import dev.excellent.api.event.impl.funs.CreeperResizerPopEvent;
...
public class CreeperRenderer extends MobRenderer<CreeperEntity, CreeperModel<CreeperEntity>> {
   ...
   protected void preRenderCallback(CreeperEntity entitylivingbaseIn, MatrixStack matrixStackIn, float partialTickTime) {
      ...
      f = f * f;
      f = f * f;
      CreeperResizerPopEvent creeperResizerPopEvent = new CreeperResizerPopEvent(0.4F, entitylivingbaseIn, matrixStackIn);
      Excellent.getInst().getEventBus().handle(creeperResizerPopEvent);
      float f2 = (1.0F + f * creeperResizerPopEvent.getResize()) * f1;
