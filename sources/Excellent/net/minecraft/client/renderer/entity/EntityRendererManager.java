...
import dev.excellent.api.event.impl.funs.EntityRenderMatrixEvent;
...
public class EntityRendererManager implements IEntityRenderManager {
    ...
    @Native
    public void registerRenderers(net.minecraft.client.renderer.ItemRenderer itemRendererIn, IReloadableResourceManager resourceManagerIn) {
    ...
    public <E extends Entity> void renderEntityStatic(E entityIn, double xIn, double yIn, double zIn, float rotationYawIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        if (this.info != null) {
            ...
            try {
                ...
                matrixStackIn.push();
                matrixStackIn.translate(d2, d3, d0);
                Excellent.getInst().getEventBus().handle(new EntityRenderMatrixEvent(matrixStackIn, entityIn));
