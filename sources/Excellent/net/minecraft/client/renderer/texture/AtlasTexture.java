...
public class AtlasTexture extends Texture implements ITickable {
    ...
    private final Map<ResourceLocation, TextureAtlasSprite> mapRegisteredSprites = new LinkedHashMap<>();
    private final Map<ResourceLocation, TextureAtlasSprite> mapMissingSprites = new LinkedHashMap<>();
...
//        LOGGER.info("Created: {}x{}x{} {}-atlas", sheetDataIn.width, sheetDataIn.height, sheetDataIn.mipmapLevel, this.textureLocation);
            ...
            if (j1 >= 1 && k1 >= 1) {
                if (j1 < l || i > 0) {
                    ...
                    if (l1 != j1) {
                        ...
                        textureatlassprite$info.setScaleFactor((double) l1 / (double) j1);
                    }
                }
    ...
    public boolean isTextureBlend(ShadersTextureType p_isTextureBlend_1_) {
        if (p_isTextureBlend_1_ == null) {
            ...
            return this.textureFormat == null || this.textureFormat.isTextureBlend(p_isTextureBlend_1_);
        }
    }
