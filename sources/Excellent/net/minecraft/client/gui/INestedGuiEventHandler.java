...
public interface INestedGuiEventHandler extends IGuiEventListener {
    ...
    default boolean mouseClicked(double mouseX, double mouseY, int button) {
        GuiMouseClickEvent guiMouseClickEvent = new GuiMouseClickEvent(mouseX, mouseY, button);
        Excellent.getInst().getEventBus().handle(guiMouseClickEvent);
        for (IGuiEventListener iguieventlistener : this.getEventListeners()) {
    ...
    default boolean mouseReleased(double mouseX, double mouseY, int button) {
        ...
        Excellent.getInst().getEventBus().handle(guiMouseReleaseEvent);
