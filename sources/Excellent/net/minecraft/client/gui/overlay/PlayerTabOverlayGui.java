...
public class PlayerTabOverlayGui extends AbstractGui {
    ...
    public void func_238523_a_(MatrixStack p_238523_1_, int p_238523_2_, Scoreboard p_238523_3_, @Nullable ScoreObjective p_238523_4_) {
        GLUtils.scaleStart(mc.getMainWindow().getScaledWidth() / 2F, 10, (float) animation.getValue());
        ...
        for (int i5 = 0; i5 < i4; ++i5) {
            ...
            if (isPlayer) {
                fill(p_238523_1_, k2, l2, k2 + i1, l2 + 8, ColorUtil.getColor(0, 128, 200, 128));
            } else {
            ...
            if (i5 < list.size()) {
                ...
                if (NameProtect.singleton.get().isEnabled()) {
                    ITextComponent chatComponent = this.getDisplayName(networkplayerinfo1);
                    ...
                    this.mc.fontRenderer.func_243246_a(p_238523_1_, newComponent, (float) k2, (float) l2, networkplayerinfo1.getGameType() == GameType.SPECTATOR ? -1862270977 : -1);
                } else {
