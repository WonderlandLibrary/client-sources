...
public class DebugOverlayGui extends AbstractGui {
    ...
    protected void renderDebugInfoLeft(MatrixStack p_230024_1_) {
        ...
        if (list == null || System.currentTimeMillis() > this.updateInfoLeftTimeMs) {
            ...
            list.add("Server TPS: " + Mathf.round(Excellent.getInst().getServerTPS().getTPS(), 1));
    ...
    protected List<String> getInfoLeft() {
        ...
        if (this.mc.isReducedDebug()) {
            return Lists.newArrayList("Minecraft " + SharedConstants.getVersion().getName() + " (" + this.mc.getVersion() + "/" + ClientBrandRetriever.getClientModName() + ")",
                    this.mc.debug,
                    s,
