...
public class WorldOptionsScreen implements IScreen, IRenderable
{
    ...
    public void func_239048_a_(final CreateWorldScreen p_239048_1_, Minecraft p_239048_2_, FontRenderer p_239048_3_)
    {
        ...
        this.field_239036_j_ = p_239048_1_.addButton(new Button(j, 120, 150, 20, new TranslationTextComponent("selectWorld.customizeType"), (p_239044_3_) ->
        {
            ...
            {
                p_239048_2_.displayScreen(biomegeneratortypescreens$ifactory.createEditScreen(p_239048_1_, this.field_239039_m_));
            }
        }));
            ...
            if (s != null)
            {
                ...
                dataresult.resultOrPartial(field_239028_b_::error).ifPresent((p_239046_5_) ->
                {
                    BooleanConsumer booleanconsumer = (p_239045_5_) -> {
                        p_239048_2_.displayScreen(p_239048_1_);
                    ...
                    {
                        p_239048_2_.displayScreen(new ConfirmScreen(booleanconsumer, new TranslationTextComponent("selectWorld.import_worldgen_settings.experimental.title"), new TranslationTextComponent("selectWorld.import_worldgen_settings.experimental.question")));
                    }
                    else {
                        p_239048_2_.displayScreen(new ConfirmScreen(booleanconsumer, new TranslationTextComponent("selectWorld.import_worldgen_settings.deprecated.title"), new TranslationTextComponent("selectWorld.import_worldgen_settings.deprecated.question")));
                    }
                });
            }
        }));
