...
public class WorldSelectionList extends ExtendedList<WorldSelectionList.Entry>
{
    ...
    public void func_212330_a(Supplier<String> p_212330_1_, boolean p_212330_2_)
    {
        ...
        if (this.field_212331_y == null || p_212330_2_)
        {
            ...
            catch (AnvilConverterException anvilconverterexception)
            {
                ...
                this.minecraft.displayScreen(new ErrorScreen(new TranslationTextComponent("selectWorld.unable_to_load"), new StringTextComponent(anvilconverterexception.getMessage())));
                return;
            }
        ...
        {
            this.minecraft.displayScreen(CreateWorldScreen.func_243425_a((Screen)null));
        }
        else
        {
    ...
    public final class Entry extends ExtendedList.AbstractListEntry<WorldSelectionList.Entry> implements AutoCloseable
    {
        ...
        public void func_214438_a()
        {
            if (!this.field_214451_d.isLocked())
            {
                if (this.field_214451_d.askToCreateBackup())
                {
                    ...
                    this.field_214449_b.displayScreen(new ConfirmBackupScreen(this.field_214450_c, (p_214436_1_, p_214436_2_) ->
                    {
                        if (p_214436_1_)
                        {
                ...
                {
                    this.field_214449_b.displayScreen(new ConfirmScreen((p_214434_1_) ->
                    {
                        if (p_214434_1_)
                        {
                            try
                            ...
                            catch (Exception exception)
                            {
                                ...
                                this.field_214449_b.displayScreen(new AlertScreen(() ->
                                {
                                    this.field_214449_b.displayScreen(this.field_214450_c);
        ...
        {
            this.field_214449_b.displayScreen(new ConfirmScreen((p_214440_1_) ->
            {
                if (p_214440_1_)
                {
                    this.field_214449_b.displayScreen(new WorkingScreen());
        ...
        public void func_214444_c()
        {
            ...
            try
            {
                ...
                this.field_214449_b.displayScreen(new EditWorldScreen((p_239096_3_) ->
                {
                    try {
        ...
        public void func_214445_d()
        {
                ...
                )
            {
                ...
                {
                    this.field_214449_b.displayScreen(new ConfirmScreen((p_239095_6_) ->
                    {
                        this.field_214449_b.displayScreen((Screen)(p_239095_6_ ? new CreateWorldScreen(this.field_214450_c, worldsettings, dimensiongeneratorsettings, path, datapackcodec, dynamicregistries$impl) : this.field_214450_c));
                ...
                {
                    this.field_214449_b.displayScreen(new CreateWorldScreen(this.field_214450_c, worldsettings, dimensiongeneratorsettings, path, datapackcodec, dynamicregistries$impl));
                }
            }
            catch (Exception exception)
            {
