...
public class InventoryScreen extends DisplayEffectsScreen<PlayerContainer> implements IRecipeShownListener {
    ...
    protected void init() {
        if (this.minecraft.playerController.isInCreativeMode()) {
            ...
            int margin = 15;
            this.addButton(new Button(width / 2 - ((margin + font.getStringWidth(dropText) + margin) / 2), guiTop - 25, (margin + font.getStringWidth(dropText) + margin), 20, new StringTextComponent(dropText), (button) -> {
