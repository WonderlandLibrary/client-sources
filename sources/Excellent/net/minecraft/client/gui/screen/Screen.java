...
import dev.excellent.api.event.impl.other.ScreenResizeEvent;
...
public abstract class Screen extends FocusableGui implements IScreen, IRenderable, IGuiScreen {
    ...
    public void renderBackground(MatrixStack matrixStack, int vOffset) {
        if (this.minecraft.world != null) {
            this.fillGradient(matrixStack, -this.width, -this.height, this.width * 2, this.height * 2, -1072689136, -804253680);
        } else {
    ...
    public void resize(Minecraft minecraft, int width, int height) {
        if (this instanceof ClickGuiScreen || this instanceof AutoBuyScreen) return;
        this.init(minecraft, width, height);
        Excellent.getInst().getEventBus().handle(new ScreenResizeEvent());
    }
