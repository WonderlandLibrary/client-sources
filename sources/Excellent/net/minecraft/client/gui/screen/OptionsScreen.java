    ...
    protected void init()
    {
        ...
        if (this.minecraft.world != null)
        {
            ...
            if (this.minecraft.isSingleplayer() && !this.minecraft.world.getWorldInfo().isHardcore())
            {
                ...
                {
                    this.minecraft.displayScreen(new ConfirmScreen(this::accept, new TranslationTextComponent("difficulty.lock.title"), new TranslationTextComponent("difficulty.lock.question", new TranslationTextComponent("options.difficulty." + this.minecraft.world.getWorldInfo().getDifficulty().getTranslationKey()))));
                }));
        ...
        {
            this.minecraft.displayScreen(new CustomizeSkinScreen(this, this.settings));
        }));
        ...
        {
            this.minecraft.displayScreen(new OptionsSoundsScreen(this, this.settings));
        }));
        ...
        {
            this.minecraft.displayScreen(new VideoSettingsScreen(this, this.settings));
        }));
        ...
        {
            this.minecraft.displayScreen(new ControlsScreen(this, this.settings));
        }));
        ...
        {
            this.minecraft.displayScreen(new LanguageScreen(this, this.settings, this.minecraft.getLanguageManager()));
        }));
        ...
        {
            this.minecraft.displayScreen(new ChatOptionsScreen(this, this.settings));
        }));
        ...
        {
            this.minecraft.displayScreen(new PackScreen(this, this.minecraft.getResourcePackList(), this::func_241584_a_, this.minecraft.getFileResourcePacks(), new TranslationTextComponent("resourcePack.title")));
        }));
        ...
        {
            this.minecraft.displayScreen(new AccessibilityScreen(this, this.settings));
        }));
        this.addButton(new Button(this.width / 2 - 100, this.height / 6 + 168, 200, 20, DialogTexts.GUI_DONE, (p_213056_1_) ->
        {
            this.minecraft.displayScreen(this.lastScreen);
        }));
    }
