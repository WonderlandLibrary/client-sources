...
public class ServerSelectionList extends ExtendedList<ServerSelectionList.Entry> {
    ...
    public void updateOnlineServers(ServerList serverList) {
        ...
        this.serverListInternet.add(new ServerSelectionList.NormalEntry(this.owner, new ServerData("MetaHVH", Excellent.AUTODOB, false)));
        for (int i = 0; i < serverList.countServers(); ++i) {
            this.serverListInternet.add(new ServerSelectionList.NormalEntry(this.owner, serverList.getServerData(i)));
        }
    ...
    public static class LanScanEntry extends ServerSelectionList.Entry {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            ...
            String s = switch ((int) (Util.milliTime() / 300L % 4L)) {
                default -> "O o o";
                case 1, 3 -> "o O o";
                case 2 -> "o o O";
            };
    ...
    public class NormalEntry extends ServerSelectionList.Entry {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            ...
            boolean custom = this.server.serverIP.equalsIgnoreCase(Excellent.AUTODOB);
            if (custom) {
                RenderUtil.renderClientRect(p_230432_1_, p_230432_4_, p_230432_3_, 305, 32, false, 0);
            }
            this.mc.fontRenderer.drawString(p_230432_1_, this.server.serverName, (float) (p_230432_4_ + 32 + 3), (float) (p_230432_3_ + 3), 16777215);
            ...
            this.mc.fontRenderer.func_243248_b(p_230432_1_, itextcomponent1, (float) (p_230432_4_ + p_230432_5_ - j - 15 - 2), (float) (p_230432_3_ + 3), 8421504);
            int k = 0;
            int l;
            ...
            AbstractGui.blit(p_230432_1_, p_230432_4_ + p_230432_5_ - 15, p_230432_3_ + 2, (float) (k * 10), (float) (176 + l * 8), 10, 8, 256, 256);
            ...
            if (this.mc.gameSettings.touchscreen || p_230432_9_) {
                ...
                if (this.canJoin()) {
                    if (k1 < 32 && k1 > 16) {
                        AbstractGui.blit(p_230432_1_, p_230432_4_ - 4, p_230432_3_, 0.0F, 32.0F, 32, 32, 256, 256);
                    } else {
                        AbstractGui.blit(p_230432_1_, p_230432_4_ - 4, p_230432_3_, 0.0F, 0.0F, 32, 32, 256, 256);
                    }
                }
