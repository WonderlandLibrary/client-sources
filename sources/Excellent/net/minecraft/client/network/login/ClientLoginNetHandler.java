...
public class ClientLoginNetHandler implements IClientLoginNetHandler
{
    ...
    public void onDisconnect(ITextComponent reason)
    {
        ...
        {
            this.mc.displayScreen(new DisconnectedRealmsScreen(this.previousGuiScreen, DialogTexts.CONNECTION_FAILED, reason));
        }
        else
        {
            this.mc.displayScreen(new DisconnectedScreen(this.previousGuiScreen, DialogTexts.CONNECTION_FAILED, reason));
        }
    }
