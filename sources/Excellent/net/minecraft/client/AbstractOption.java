...
public abstract class AbstractOption {
    ...
    }, (p_lambda$static$14_0_, p_lambda$static$14_1_) ->
    {
        ...
        return d0 == 0.0D ? DialogTexts.getComposedOptionMessage(p_lambda$static$14_1_.getBaseMessageTranslation(), false) : p_lambda$static$14_1_.getPercentValueComponent(d0);
    });
    ...
    {
        return Math.pow(p_lambda$static$27_0_.fovScaleEffect, 2.0D);
    ...
    }, (p_lambda$static$41_0_, p_lambda$static$41_1_) ->
    {
        ...
        if (d0 >= 4.0D) {
            ...
            return d0 == 0.0D ? DialogTexts.getComposedOptionMessage(p_lambda$static$41_1_.getBaseMessageTranslation(), false) : p_lambda$static$41_1_.getMessageWithValue((int) d0);
        }
    });
    ...
    {
        p_lambda$static$67_0_.guiScale = MathHelper.normalizeAngle(p_lambda$static$67_0_.guiScale + 2, Minecraft.getInstance().getMainWindow().calcGuiScale(0, Minecraft.getInstance().getForceUnicodeFont()) + 1);
