...
public class Framebuffer {
    ...
    public Framebuffer(int width, int height, boolean depth, boolean onMac) {
    ...
    private void framebufferRenderExtRaw(int width, int height, boolean p_227588_3_) {
        if (GLX.isUsingFBOs()) {
            ...
            bufferbuilder.pos(0.0D, f1, 0.0D).tex(0.0F, 0.0F).color(255, 255, 255, 255).endVertex();
            bufferbuilder.pos(f, f1, 0.0D).tex(f2, 0.0F).color(255, 255, 255, 255).endVertex();
