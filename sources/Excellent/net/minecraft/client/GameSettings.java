...
public class GameSettings {
    ...
    private static final TypeToken<List<String>> TYPE_LIST_STRING = new TypeToken<>() {
    };
    ...
    public boolean hideMatchedNames = false;
    ...
    private final File optionsFileOF;
    ...
    public void loadOptions() {
        try {
            ...
            LOGGER.error("Failed to load options", exception11);
        }
    ...
    public String getKeyBindingOF(AbstractOption p_getKeyBindingOF_1_) {
        ...
        if (p_getKeyBindingOF_1_ == AbstractOption.RENDER_DISTANCE) {
            ...
            return FloatOptions.getText(p_getKeyBindingOF_1_, this.ofMipmapType);
            ...
            return FloatOptions.getText(p_getKeyBindingOF_1_, this.ofAaLevel);
        } else if (p_getKeyBindingOF_1_ == AbstractOption.AF_LEVEL) {
            return FloatOptions.getText(p_getKeyBindingOF_1_, this.ofAfLevel);
        ...
        } else if (p_getKeyBindingOF_1_ instanceof SliderPercentageOption sliderpercentageoption) {
            ...
            while ((s = bufferedreader.readLine()) != null) {
                try {
                    ...
                    if (astring[0].equals("ofChatBackground") && astring.length >= 2) {
                        this.ofChatBackground = Integer.parseInt(astring[1]);
                    }

                    if (astring[0].equals("ofChatShadow") && astring.length >= 2) {
                        this.ofChatShadow = Boolean.parseBoolean(astring[1]);
                    }
