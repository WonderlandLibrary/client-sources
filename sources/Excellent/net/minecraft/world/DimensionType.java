...
public class DimensionType {
    ...
    public static final Codec<DimensionType> CODEC = RecordCodecBuilder.create((builder) ->
    {
        ...
        }), Codec.BOOL.fieldOf("has_skylight").forGetter(DimensionType::hasSkyLight), Codec.BOOL.fieldOf("has_ceiling").forGetter(DimensionType::getHasCeiling), Codec.BOOL.fieldOf("ultrawarm").forGetter(DimensionType::isUltrawarm), Codec.BOOL.fieldOf("natural").forGetter(DimensionType::isNatural), Codec.doubleRange(1.0E-5F, 3.0E7D).fieldOf("coordinate_scale").forGetter(DimensionType::getCoordinateScale), Codec.BOOL.fieldOf("piglin_safe").forGetter(DimensionType::isPiglinSafe), Codec.BOOL.fieldOf("bed_works").forGetter(DimensionType::doesBedWork), Codec.BOOL.fieldOf("respawn_anchor_works").forGetter(DimensionType::doesRespawnAnchorWorks), Codec.BOOL.fieldOf("has_raids").forGetter(DimensionType::isHasRaids), Codec.intRange(0, 256).fieldOf("logical_height").forGetter(DimensionType::getLogicalHeight), ResourceLocation.CODEC.fieldOf("infiniburn").forGetter((type) -> {
