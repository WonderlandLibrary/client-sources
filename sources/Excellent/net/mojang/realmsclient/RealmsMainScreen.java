package net.mojang.realmsclient;
...
import net.mojang.realmsclient.client.Ping;
import net.mojang.realmsclient.client.RealmsClient;
import net.mojang.realmsclient.dto.*;
import net.mojang.realmsclient.exception.RealmsServiceException;
import net.mojang.realmsclient.gui.RealmsDataFetcher;
import net.mojang.realmsclient.gui.screens.*;
import net.mojang.realmsclient.util.RealmsPersistence;
import net.mojang.realmsclient.util.RealmsTextureManager;
...
public class RealmsMainScreen extends RealmsScreen
{
    ...
    public void init()
    {
        ...
        {
            this.minecraft.displayScreen(field_224000_H);
        }
        else
        {
    ...
    public void func_223901_c()
    {
        ...
        this.field_224023_l = this.addButton(new Button(this.width / 2 + 4, this.height - 32, 90, 20, DialogTexts.GUI_BACK, (p_237632_1_) ->
        {
            ...
            {
                this.minecraft.displayScreen(this.field_224019_h);
            }
        }));
                ...
                public void run()
                {
                    ...
                    try
                    {
                        ...
                        if (realmsclient$compatibleversionresponse == RealmsClient.CompatibleVersionResponse.OUTDATED)
                        {
                            ...
                            {
                                RealmsMainScreen.this.minecraft.displayScreen(RealmsMainScreen.field_224000_H);
                            });
                            return;
                        }
                    ...
                    catch (RealmsServiceException realmsserviceexception)
                    {
                        ...
                        else
                        {
                            RealmsMainScreen.this.minecraft.execute(() ->
                            {
                                RealmsMainScreen.this.minecraft.displayScreen(new RealmsGenericErrorScreen(realmsserviceexception, RealmsMainScreen.this.field_224019_h));
                            });
                        }
                    }
                }
            ...
            public void run()
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        RealmsMainScreen.this.minecraft.execute(() ->
                        {
                            RealmsMainScreen.this.minecraft.displayScreen(new RealmsParentalConsentScreen(RealmsMainScreen.this.field_224019_h));
                        });
                    }
    ...
    private void func_223966_f(RealmsServer p_223966_1_)
    {
        ...
        {
            this.func_223949_z();
            this.minecraft.displayScreen(new RealmsConfigureWorldScreen(this, p_223966_1_.field_230582_a_));
        }
    }
    ...
    private void func_223906_g(@Nullable RealmsServer p_223906_1_)
    {
        if (p_223906_1_ != null && !this.minecraft.getSession().getPlayerID().equals(p_223906_1_.field_230588_g_))
        {
            ...
            this.minecraft.displayScreen(new RealmsLongConfirmationScreen(this::func_237625_d_, RealmsLongConfirmationScreen.Type.Info, itextcomponent, itextcomponent1, true));
        }
    }
            ...
            (new Thread("Realms-leave-server")
            {
                public void run()
                {
                    ...
                    catch (RealmsServiceException realmsserviceexception)
                    {
                        ...
                        RealmsMainScreen.this.minecraft.execute(() ->
                        {
                            RealmsMainScreen.this.minecraft.displayScreen(new RealmsGenericErrorScreen(realmsserviceexception, RealmsMainScreen.this));
                        });
                    }
                }
            }).start();
    ...
    public void func_223911_a(RealmsServer p_223911_1_, Screen p_223911_2_)
    {
        if (p_223911_1_ != null)
        {
            ...
            this.minecraft.displayScreen(new RealmsLongRunningMcoTaskScreen(p_223911_2_, new ConnectingToRealmsAction(this, p_223911_2_, p_223911_1_, this.field_224004_L)));
        }
    }
    ...
    {
        this.minecraft.displayScreen(new RealmsPendingInvitesScreen(this.field_224019_h));
    }
    ...
    class ServerEntry extends RealmsMainScreen.ListEntry
    {
        ...
        public boolean mouseClicked(double mouseX, double mouseY, int button)
        {
            if (this.field_223734_a.field_230586_e_ == RealmsServer.Status.UNINITIALIZED)
            {
                ...
                RealmsMainScreen.this.minecraft.displayScreen(new RealmsCreateRealmScreen(this.field_223734_a, RealmsMainScreen.this));
            }
            else
            {
        ...
        public void func_231401_a_(int p_231401_1_, int p_231401_2_, double p_231401_3_, double p_231401_5_, int p_231401_7_)
        {
            ...
            if (p_231401_2_ < RealmsMainScreen.this.field_224028_q.size())
            {
                ...
                if (realmsserver != null)
                {
                    ...
                    {
                        RealmsMainScreen.this.field_224021_j = -1L;
                        Minecraft.getInstance().displayScreen(new RealmsCreateRealmScreen(realmsserver, RealmsMainScreen.this));
                    }
                    else
                    {
                        RealmsMainScreen.this.field_224021_j = realmsserver.field_230582_a_;
