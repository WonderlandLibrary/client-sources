package net.mojang.realmsclient.gui.screens;
...
import net.mojang.realmsclient.client.RealmsClient;
import net.mojang.realmsclient.dto.RealmsServer;
import net.mojang.realmsclient.dto.RealmsWorldOptions;
import net.mojang.realmsclient.dto.WorldTemplate;
import net.mojang.realmsclient.exception.RealmsServiceException;
import net.mojang.realmsclient.gui.RealmsServerSlotButton;
...
public class RealmsConfigureWorldScreen extends NotifableRealmsScreen
{
    ...
    public void init()
    {
        ...
        {
            this.minecraft.displayScreen(new RealmsPlayerScreen(this, this.field_224416_d));
        }));
        ...
        {
            this.minecraft.displayScreen(new RealmsSettingsScreen(this, this.field_224416_d.clone()));
        }));
        ...
        {
            this.minecraft.displayScreen(new RealmsSubscriptionInfoScreen(this, this.field_224416_d.clone(), this.field_224415_c));
        }));
        ...
        this.field_224428_p = this.addButton(new Button(this.func_224411_b(0), func_239562_k_(13) - 5, 100, 20, new TranslationTextComponent("mco.configure.world.buttons.switchminigame"), (p_237815_1_) ->
        {
            ...
            this.minecraft.displayScreen(realmsselectworldtemplatescreen);
        }));
        ...
        {
            this.minecraft.displayScreen(new RealmsSlotOptionsScreen(this, this.field_224416_d.field_230590_i_.get(this.field_224416_d.field_230595_n_).clone(), this.field_224416_d.field_230594_m_, this.field_224416_d.field_230595_n_));
        }));
        ...
        {
            this.minecraft.displayScreen(new RealmsBackupScreen(this, this.field_224416_d.clone(), this.field_224416_d.field_230595_n_));
        }));
        ...
        {
            this.minecraft.displayScreen(new RealmsResetWorldScreen(this, this.field_224416_d.clone(), () -> {
                this.minecraft.displayScreen(this.func_224407_b());
            }, () -> {
                this.minecraft.displayScreen(this.func_224407_b());
            }));
        }));
    ...
    private void func_224390_d()
    {
        ...
        this.minecraft.displayScreen(this.field_224415_c);
    }
    ...
    private void func_224387_a(long p_224387_1_)
    {
        (new Thread(() ->
        {
            ...
            catch (RealmsServiceException realmsserviceexception)
            {
                ...
                {
                    this.minecraft.displayScreen(new RealmsGenericErrorScreen(ITextComponent.getTextComponentOrEmpty(realmsserviceexception.getMessage()), this.field_224415_c));
                });
            }
        })).start();
    }
    ...
    private void func_224403_a(int p_224403_1_, RealmsServer p_224403_2_)
    {
        ...
        this.minecraft.displayScreen(new RealmsLongConfirmationScreen((p_237805_3_) ->
        {
            if (p_237805_3_)
            {
                this.minecraft.displayScreen(new RealmsLongRunningMcoTaskScreen(this.field_224415_c, new SwitchMinigameRealmsAction(p_224403_2_.field_230582_a_, p_224403_1_, () ->
                {
                    this.minecraft.displayScreen(this.func_224407_b());
                })));
            }
    ...
    private void func_224388_b(int p_224388_1_, RealmsServer p_224388_2_)
    {
        ITextComponent itextcomponent = new TranslationTextComponent("mco.configure.world.slot.switch.question.line1");
        ITextComponent itextcomponent1 = new TranslationTextComponent("mco.configure.world.slot.switch.question.line2");
        this.minecraft.displayScreen(new RealmsLongConfirmationScreen((p_237797_3_) ->
        {
            if (p_237797_3_)
            {
                ...
                this.minecraft.displayScreen(realmsresetworldscreen);
            }
            else {
                this.minecraft.displayScreen(this);
            }
    ...
    public void func_224386_a(RealmsWorldOptions p_224386_1_)
    {
        ...
        catch (RealmsServiceException realmsserviceexception)
        {
            ...
            this.minecraft.displayScreen(new RealmsGenericErrorScreen(realmsserviceexception, this));
            return;
        }
    ...
    {
        this.minecraft.displayScreen(new RealmsLongRunningMcoTaskScreen(p_237802_2_, new OpeningWorldRealmsAction(this.field_224416_d, this, this.field_224415_c, p_237802_1_)));
    }

    public void func_237800_a_(Screen p_237800_1_)
    {
        this.minecraft.displayScreen(new RealmsLongRunningMcoTaskScreen(p_237800_1_, new CloseRealmsAction(this.field_224416_d, this)));
    }
    ...
    protected void func_223627_a_(@Nullable WorldTemplate p_223627_1_)
    {
        if (p_223627_1_ != null)
        {
            ...
            {
                this.minecraft.displayScreen(new RealmsLongRunningMcoTaskScreen(this.field_224415_c, new StartMinigameRealmsAction(this.field_224416_d.field_230582_a_, p_223627_1_, this.func_224407_b())));
            }
        }
    }
