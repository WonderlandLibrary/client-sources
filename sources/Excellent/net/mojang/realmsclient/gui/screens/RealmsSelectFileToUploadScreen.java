...
public class RealmsSelectFileToUploadScreen extends RealmsScreen
{
    ...
    public void init()
    {
        ...
        catch (Exception exception)
        {
            ...
            this.minecraft.displayScreen(new RealmsGenericErrorScreen(new StringTextComponent("Unable to load worlds"), ITextComponent.getTextComponentOrEmpty(exception.getMessage()), this.field_224548_b));
            return;
        }
        ...
        {
            this.minecraft.displayScreen(this.field_224548_b);
        }));
    ...
    private void func_224544_b()
    {
        if (this.field_224554_h != -1 && !this.field_224553_g.get(this.field_224554_h).isHardcoreModeEnabled())
        {
            ...
            this.minecraft.displayScreen(new RealmsUploadScreen(this.field_224549_c, this.field_224550_d, this.field_224548_b, worldsummary, this.field_237967_A_));
        }
    }
