...
public class RealmsBackupScreen extends RealmsScreen
{
    ...
    public void init()
    {
        ...
        {
            this.minecraft.displayScreen(new RealmsBackupInfoScreen(this, this.field_224117_d.get(this.field_224120_g)));
            this.field_224120_g = -1;
        }));
        this.addButton(new Button(this.width - 100, this.height - 35, 85, 20, DialogTexts.GUI_BACK, (p_237748_1_) ->
        {
            this.minecraft.displayScreen(this.field_224116_c);
        }));
    ...
    private void func_224104_b(int p_224104_1_)
    {
        if (p_224104_1_ >= 0 && p_224104_1_ < this.field_224117_d.size() && !this.field_224126_m.field_230591_j_)
        {
            ...
            this.minecraft.displayScreen(new RealmsLongConfirmationScreen((p_237759_1_) ->
            {
                if (p_237759_1_)
                {
                    this.func_224097_i();
    ...
    private void func_224088_g()
    {
        ...
        this.minecraft.displayScreen(new RealmsLongConfirmationScreen((p_237755_1_) ->
        {
            if (p_237755_1_)
            {
                this.func_224100_h();
    ...
    private void func_224097_i()
    {
        ...
        this.field_224120_g = -1;
        this.minecraft.displayScreen(new RealmsLongRunningMcoTaskScreen(this.field_224116_c.func_224407_b(), new RestoringBackupRealmsAction(backup, this.field_224126_m.field_230582_a_, this.field_224116_c)));
    }
        ...
        public void func_231401_a_(int p_231401_1_, int p_231401_2_, double p_231401_3_, double p_231401_5_, int p_231401_7_)
        {
            ...
            if (p_231401_3_ >= (double)i && p_231401_3_ <= (double)(i + 9) && p_231401_5_ >= (double)j && p_231401_5_ <= (double)(j + 9))
            {
                if (!(RealmsBackupScreen.this.field_224117_d.get(p_231401_2_)).field_230557_e_.isEmpty())
                {
                    ...
                    this.minecraft.displayScreen(new RealmsBackupInfoScreen(RealmsBackupScreen.this, RealmsBackupScreen.this.field_224117_d.get(p_231401_2_)));
                }
            }
