...
import net.mojang.realmsclient.dto.PendingInvite;
import net.mojang.realmsclient.exception.RealmsServiceException;
import net.mojang.realmsclient.gui.ListButton;
...
public class RealmsPendingInvitesScreen extends RealmsScreen
{
    ...
    public void init()
    {
        ...
        {
            this.minecraft.displayScreen(new RealmsMainScreen(this.field_224334_b));
        }));
