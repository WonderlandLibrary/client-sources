...
public class RealmsCreateRealmScreen extends RealmsScreen
{
    ...
    public void init()
    {
        ...
        {
            this.minecraft.displayScreen(this.field_224136_b);
        }));
    ...
    private void func_224132_a()
    {
        if (this.func_224133_b())
        {
            ...
            {
                this.minecraft.displayScreen(this.field_224136_b.func_223942_f());
            }, () ->
            {
                this.minecraft.displayScreen(this.field_224136_b.func_223942_f());
            });
            realmsresetworldscreen.func_224432_a(new TranslationTextComponent("mco.create.world.reset.title"));
            this.minecraft.displayScreen(new RealmsLongRunningMcoTaskScreen(this.field_224136_b, new CreateWorldRealmsAction(this.field_224135_a.field_230582_a_, this.field_224137_c.getText(), this.field_224138_d.getText(), realmsresetworldscreen)));
        }
    }
