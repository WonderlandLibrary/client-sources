...
import net.mojang.realmsclient.dto.WorldDownload;
...
public class RealmsBrokenWorldScreen extends RealmsScreen
{
        ...
        for (Entry<Integer, RealmsWorldOptions> entry : this.field_224074_d.field_230590_i_.entrySet())
        {
            ...
            if (flag)
            {
                button = new Button(this.func_224065_a(i), func_239562_k_(8), 80, 20, new TranslationTextComponent("mco.brokenworld.play"), (p_237780_2_) ->
                {
                    if ((this.field_224074_d.field_230590_i_.get(i)).field_230627_n_)
                    {
                        ...
                        this.minecraft.displayScreen(new RealmsLongRunningMcoTaskScreen(this.field_224072_b, new SwitchMinigameRealmsAction(this.field_224074_d.field_230582_a_, i, this::func_237772_a_)));
                    }
                });
            }
            else
            {
                button = new Button(this.func_224065_a(i), func_239562_k_(8), 80, 20, new TranslationTextComponent("mco.brokenworld.download"), (p_237777_2_) ->
                {
                    ...
                    this.minecraft.displayScreen(new RealmsLongConfirmationScreen((p_237778_2_) -> {
                        if (p_237778_2_)
                        {
    ...
    {
        this.minecraft.displayScreen(this.field_224072_b);
    }
    ...
    private void func_224068_a(long p_224068_1_)
    {
        (new Thread(() ->
        {
            ...
            catch (RealmsServiceException realmsserviceexception)
            {
                ...
                this.minecraft.displayScreen(new RealmsGenericErrorScreen(ITextComponent.getTextComponentOrEmpty(realmsserviceexception.getMessage()), this.field_224072_b));
            }
        })).start();
    }
    ...
    public void func_237772_a_()
    {
        (new Thread(() ->
        {
            ...
            if (this.field_224074_d.field_230586_e_ == RealmsServer.Status.CLOSED)
            {
                ...
                {
                    this.minecraft.displayScreen(new RealmsLongRunningMcoTaskScreen(this, new OpeningWorldRealmsAction(this.field_224074_d, this, this.field_224073_c, true)));
                });
            }
            else {
                try {
    ...
    private void func_224066_b(int p_224066_1_)
    {
        ...
        try
        {
            ...
            this.minecraft.displayScreen(realmsdownloadlatestworldscreen);
        }
        catch (RealmsServiceException realmsserviceexception)
        {
