...
import net.mojang.realmsclient.client.FileDownload;
...
public class RealmsDownloadLatestWorldScreen extends RealmsScreen
{
    ...
    private void func_224162_c()
    {
        if (!this.field_224188_n)
        {
            if (!this.field_224198_x && this.func_224152_a(this.field_224177_c.field_230643_a_) >= 5368709120L)
            {
                ...
                this.minecraft.displayScreen(new RealmsLongConfirmationScreen((p_237837_1_) ->
                {
    ...
    private void func_224174_d()
    {
        ...
        this.minecraft.displayScreen(this.field_224176_b);
    }
