...
import net.mojang.realmsclient.dto.Subscription;
...
public class RealmsSubscriptionInfoScreen extends RealmsScreen
{
    ...
    public void init()
    {
        ...
        {
            this.minecraft.displayScreen(this.field_224580_b);
        }));
        ...
        if (this.field_224581_c.field_230591_j_)
        {
            this.addButton(new Button(this.width / 2 - 100, func_239562_k_(10), 200, 20, new TranslationTextComponent("mco.configure.world.delete.button"), (p_238069_1_) ->
            {
                ...
                this.minecraft.displayScreen(new RealmsLongConfirmationScreen(this::func_238074_c_, RealmsLongConfirmationScreen.Type.Warning, itextcomponent, itextcomponent1, true));
            }));
        }
    }
        ...
        if (p_238074_1_)
        {
            (new Thread("Realms-delete-realm")
            {
                public void run()
                {
                    ...
                    {
                        RealmsSubscriptionInfoScreen.this.minecraft.displayScreen(RealmsSubscriptionInfoScreen.this.field_224582_d);
                    });
                }
            }).start();
        }
    ...
    private void func_224573_a(long p_224573_1_)
    {
        ...
        catch (RealmsServiceException realmsserviceexception)
        {
            ...
            this.minecraft.displayScreen(new RealmsGenericErrorScreen(realmsserviceexception, this.field_224580_b));
        }
    }
