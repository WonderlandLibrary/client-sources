...
import net.mojang.realmsclient.dto.Ops;
import net.mojang.realmsclient.dto.PlayerInfo;
...
public class RealmsPlayerScreen extends RealmsScreen
{
    ...
    public void init()
    {
        ...
        {
            this.minecraft.displayScreen(new RealmsInviteScreen(this.field_224302_c, this, this.field_224303_d));
        }));
    ...
    private void func_224298_b()
    {
        ...
        {
            this.minecraft.displayScreen(this.field_224302_c.func_224407_b());
        }
        else
        {
            this.minecraft.displayScreen(this.field_224302_c);
        }
    }
    ...
    private void func_224274_d(int p_224274_1_)
    {
        ...
        if (p_224274_1_ >= 0 && p_224274_1_ < this.field_224303_d.field_230589_h_.size())
        {
            ...
            this.minecraft.displayScreen(realmsconfirmscreen);
        }
    }
