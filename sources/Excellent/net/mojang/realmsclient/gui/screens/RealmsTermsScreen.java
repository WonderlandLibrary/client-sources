...
public class RealmsTermsScreen extends RealmsScreen
{
     ...
     * to a server) or {@link net.mojang.realmsclient.gui.screens.RealmsTermsScreen} (when connecting to MCO server)
     */
    ...
    public void init()
    {
        ...
        {
            this.minecraft.displayScreen(this.field_224723_b);
        }));
    }
    ...
    private void func_224721_a()
    {
        ...
        try
        {
            ...
            this.minecraft.displayScreen(new RealmsLongRunningMcoTaskScreen(this.field_224723_b, new ConnectingToRealmsAction(this.field_224724_c, this.field_224723_b, this.guiScreenServer, new ReentrantLock())));
        }
