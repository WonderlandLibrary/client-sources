...
import net.mojang.realmsclient.dto.WorldTemplatePaginatedList;
...
public class RealmsResetWorldScreen extends NotifableRealmsScreen
{
    ...
    public void init()
    {
        ...
        {
            this.minecraft.displayScreen(this.field_224457_c);
        }));
        ...
        {
            this.minecraft.displayScreen(new RealmsResetNormalWorldScreen(this, this.field_224462_h));
        }));
    ...
    {
        this.minecraft.displayScreen(new RealmsLongRunningMcoTaskScreen(this.field_224457_c, new SwitchMinigameRealmsAction(this.field_224458_d.field_230582_a_, this.field_224455_a, p_237952_1_)));
    }
    ...
    {
        this.minecraft.displayScreen(new RealmsLongRunningMcoTaskScreen(this.field_224457_c, new ResetWorldRealmsAction(p_237953_1_, p_237953_2_, p_237953_3_, p_237953_4_, this.field_224458_d.field_230582_a_, this.field_224475_u, this.field_237942_L_)));
    }
