...
import net.mojang.realmsclient.client.FileUpload;
import net.mojang.realmsclient.client.RealmsClient;
import net.mojang.realmsclient.client.UploadStatus;
import net.mojang.realmsclient.dto.UploadInfo;
import net.mojang.realmsclient.exception.RealmsServiceException;
import net.mojang.realmsclient.exception.RetryCallException;
import net.mojang.realmsclient.util.UploadTokenCache;
...
public class RealmsUploadScreen extends RealmsScreen
{
    ...
    private void func_224695_d()
    {
        ...
        this.minecraft.displayScreen(this.field_224697_b);
    }
