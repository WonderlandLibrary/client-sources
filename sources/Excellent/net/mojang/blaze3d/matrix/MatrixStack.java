package net.mojang.blaze3d.matrix;
...
public class MatrixStack
{
    ...
    public void mulPose(Quaternion rotationDegrees) {
        MatrixStack.Entry matrixstack$entry = this.stack.getLast();
        matrixstack$entry.matrix.mul(rotationDegrees);
        matrixstack$entry.normal.mul(rotationDegrees);
    }
