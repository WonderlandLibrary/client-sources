...
public class Config {
    ...
    private static final boolean fullscreenModeChecked = false;
    private static final boolean desktopModeChecked = false;
    ...
    private static final boolean showFrameTime = Boolean.getBoolean("frame.time");
    ...
    public static boolean hasResource(IResourcePack rp, ResourceLocation loc) {
        return rp != null && loc != null && rp.resourceExists(ResourcePackType.CLIENT_RESOURCES, loc);
    }
    ...
    public static void showGuiMessage(String line1, String line2) {
        ...
        minecraft.displayScreen(guimessage);
    }
    ...
    public static void writeFile(File file, String str) throws IOException {
        ...
        byte[] abyte = str.getBytes(StandardCharsets.US_ASCII);
    ...
    public static boolean isReloadingResources() {
        if (minecraft.loadingGui == null) {
            ...
            if (minecraft.loadingGui instanceof ResourceLoadProgressGui resourceloadprogressgui) {

                return !resourceloadprogressgui.isFadeOut();
            }
