...
import dev.excellent.client.module.impl.render.Fullbright;
...
public class Shaders {
    ...
    private static void setProgramUniforms(ProgramStage programStage) {
        ...
        setProgramUniform1f(uniform_screenBrightness, Fullbright.singleton.get().isEnabled() ? 10 : (float) mc.gameSettings.gamma);
