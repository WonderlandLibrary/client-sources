...
import me.thekirkayt.client.module.modules.movement.Fly;
import me.thekirkayt.client.module.modules.movement.Step;
...
implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        block53 : {
            ...
            var15 = y;
            var17 = z;
            v0 = var19 = this.onGround != false && this.isSneaking() != false && this instanceof EntityPlayer != false;
            if (var19 || ModuleManager.getModule("Safewalk").isEnabled() || ModuleManager.getModule("ScaffoldWalk").isEnabled()) {
                var20 = 0.05;
                while (x != 0.0 && this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().offset(x, -1.0, 0.0)).isEmpty()) {
                    x = x < var20 && x >= -var20 ? 0.0 : (x > 0.0 ? (x -= var20) : (x += var20));
                    var13 = x;
                }
                while (z != 0.0 && this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().offset(0.0, -1.0, z)).isEmpty()) {
                    z = z < var20 && z >= -var20 ? 0.0 : (z > 0.0 ? (z -= var20) : (z += var20));
                    var17 = z;
                }
            ...
            var53 = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().addCoord(x, y, z));
            var21 = this.getEntityBoundingBox();
            for (AxisAlignedBB var23 : var53) {
                y = var23.calculateYOffset(this.getEntityBoundingBox(), y);
            }
            this.func_174826_a(this.getEntityBoundingBox().offset(0.0, y, 0.0));
            var54 = this.onGround != false || var15 != y && var15 < 0.0;
            for (AxisAlignedBB var24 : var53) {
                x = var24.calculateXOffset(this.getEntityBoundingBox(), x);
            }
            this.func_174826_a(this.getEntityBoundingBox().offset(x, 0.0, 0.0));
            for (AxisAlignedBB var241 : var53) {
                z = var241.calculateZOffset(this.getEntityBoundingBox(), z);
            }
            this.func_174826_a(this.getEntityBoundingBox().offset(0.0, 0.0, z));
            if (this.stepHeight > 0.0f && var54 && (var13 != x || var17 != z)) {
                stepEvent = new StepEvent(this.stepHeight, Event.State.PRE);
                ...
                var25 = y;
                var27 = z;
                var29 = this.getEntityBoundingBox();
                this.func_174826_a(var21);
                y = this.stepHeight;
                var30 = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().addCoord(var13, y, var17));
                var31 = this.getEntityBoundingBox();
                var32 = var31.addCoord(var13, 0.0, var17);
                var33 = y;
                for (AxisAlignedBB var36 : var30) {
                    var33 = var36.calculateYOffset(var32, var33);
                }
                var31 = var31.offset(0.0, var33, 0.0);
                var67 = var13;
                for (AxisAlignedBB var38 : var30) {
                    var67 = var38.calculateXOffset(var31, var67);
                }
                var31 = var31.offset(var67, 0.0, 0.0);
                var68 = var17;
                for (AxisAlignedBB var40 : var30) {
                    var68 = var40.calculateZOffset(var31, var68);
                }
                var31 = var31.offset(0.0, 0.0, var68);
                var69 = this.getEntityBoundingBox();
                var70 = y;
                for (AxisAlignedBB var43 : var30) {
                    var70 = var43.calculateYOffset(var69, var70);
                }
                var69 = var69.offset(0.0, var70, 0.0);
                var71 = var13;
                for (AxisAlignedBB var45 : var30) {
                    var71 = var45.calculateXOffset(var69, var71);
                }
                var69 = var69.offset(var71, 0.0, 0.0);
                var72 = var17;
                for (AxisAlignedBB var47 : var30) {
                    var72 = var47.calculateZOffset(var69, var72);
                }
                var69 = var69.offset(0.0, 0.0, var72);
                var73 = var67 * var67 + var68 * var68;
                var48 = var71 * var71 + var72 * var72;
                if (var73 > var48) {
                    x = var67;
                    z = var68;
                ...
                if (var56 * var56 + var27 * var27 >= x * x + z * z) {
                    ...
                    if (stepEvent.isActive() && stepEvent.getStepHeight() > 0.0 && var54 && (var13 != x || var17 != z)) {
                        var561 = x;
                        var251 = y;
                        var271 = z;
                        var291 = this.getEntityBoundingBox();
                        this.func_174826_a(var21);
                        y = stepEvent.getStepHeight();
                        var301 = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().addCoord(var13, y, var17));
                        var311 = this.getEntityBoundingBox();
                        var321 = var311.addCoord(var13, 0.0, var17);
                        var331 = y;
                        for (AxisAlignedBB var361 : var301) {
                            var331 = var361.calculateYOffset(var321, var331);
                        }
                        var311 = var311.offset(0.0, var331, 0.0);
                        var671 = var13;
                        for (AxisAlignedBB var381 : var301) {
                            var671 = var381.calculateXOffset(var311, var671);
                        }
                        var311 = var311.offset(var671, 0.0, 0.0);
                        var681 = var17;
                        for (AxisAlignedBB var401 : var301) {
                            var681 = var401.calculateZOffset(var311, var681);
                        }
                        var311 = var311.offset(0.0, 0.0, var681);
                        var691 = this.getEntityBoundingBox();
                        var701 = y;
                        for (AxisAlignedBB var431 : var301) {
                            var701 = var431.calculateYOffset(var691, var701);
                        }
                        var691 = var691.offset(0.0, var701, 0.0);
                        var711 = var13;
                        for (AxisAlignedBB var451 : var301) {
                            var711 = var451.calculateXOffset(var691, var711);
                        }
                        var691 = var691.offset(var711, 0.0, 0.0);
                        var721 = var17;
                        for (AxisAlignedBB var471 : var301) {
                            var721 = var471.calculateZOffset(var691, var721);
                        }
                        var691 = var691.offset(0.0, 0.0, var721);
                        var731 = var671 * var671 + var681 * var681;
                        var481 = var711 * var711 + var721 * var721;
                        if (var731 > var481) {
                            x = var671;
                            z = var681;
                            this.func_174826_a(var311);
                        } else {
                            x = var711;
                            z = var721;
                            this.func_174826_a(var691);
                        }
                        y = -stepEvent.getStepHeight();
                        for (AxisAlignedBB var511 : var301) {
                            y = var511.calculateYOffset(this.getEntityBoundingBox(), y);
                        }
                        this.func_174826_a(this.getEntityBoundingBox().offset(0.0, y + (((Step)new Step().getInstance()).packet != false ? 0.0 : 0.063), 0.0));
                        if (var561 * var561 + var271 * var271 >= x * x + z * z) {
                            x = var561;
                            y = var251;
                            z = var271;
                            this.func_174826_a(var291);
                        } else {
            ...
            v1 = this.isCollidedVertically = var15 != y;
            if (!new Fly().getInstance().isEnabled()) break block53;
            Minecraft.getMinecraft();
            if (this == Minecraft.thePlayer) ** GOTO lbl-1000
        }
        if (!(ModuleManager.getModule("Drunken").isEnabled() || this.isCollidedVertically && var15 < 0.0)) {
            v2 = false;
        ...
        this.onGround = v2;
        this.isCollided = this.isCollidedHorizontally != false || this.isCollidedVertically != false;
        var57 = MathHelper.floor_double(this.posX);
        var58 = MathHelper.floor_double(this.posY - 0.20000000298023224);
        var59 = MathHelper.floor_double(this.posZ);
        var26 = new BlockPos(var57, var58, var59);
        var60 = this.worldObj.getBlockState(var26).getBlock();
        if (var60.getMaterial() == Material.air && ((var28 = this.worldObj.getBlockState(var26.offsetDown()).getBlock()) instanceof BlockFence || var28 instanceof BlockWall || var28 instanceof BlockFenceGate)) {
            var60 = var28;
        ...
        if (this.canTriggerWalking() && !var19 && this.ridingEntity == null) {
            var61 = this.posX - var7;
            var64 = this.posY - var9;
            var66 = this.posZ - var11;
            ...
            this.distanceWalkedModified = (float)((double)this.distanceWalkedModified + (double)MathHelper.sqrt_double(var61 * var61 + var66 * var66) * 0.6);
            this.distanceWalkedOnStepModified = (float)((double)this.distanceWalkedOnStepModified + (double)MathHelper.sqrt_double(var61 * var61 + var64 * var64 + var66 * var66) * 0.6);
            if (this.distanceWalkedOnStepModified > (float)this.nextStepDistance && var60.getMaterial() != Material.air) {
                this.nextStepDistance = (int)this.distanceWalkedOnStepModified + 1;
                if (this.isInWater() && !ModuleManager.getModule("AntiWater").isEnabled()) {
                    var34 = MathHelper.sqrt_double(this.motionX * this.motionX * 0.20000000298023224 + this.motionY * this.motionY + this.motionZ * this.motionZ * 0.20000000298023224) * 0.35f;
                    if (var34 > 1.0f) {
                        var34 = 1.0f;
                    }
        ...
        try {
            ...
            var63 = CrashReport.makeCrashReport(var52, "Checking entity block collision");
            var65 = var63.makeCategory("Entity being checked for collision");
    ...
    protected void doBlockCollisions() {
        BlockPos var1 = new BlockPos(this.getEntityBoundingBox().minX + 0.001, this.getEntityBoundingBox().minY + 0.001, this.getEntityBoundingBox().minZ + 0.001);
        BlockPos var2 = new BlockPos(this.getEntityBoundingBox().maxX - 0.001, this.getEntityBoundingBox().maxY - 0.001, this.getEntityBoundingBox().maxZ - 0.001);
    ...
    public boolean handleWaterMovement() {
        if (!ModuleManager.getModule("AntiWater").isEnabled()) {
    ...
    protected void func_174808_Z() {
        ...
        BlockPos var4 = new BlockPos(var1, var2 = MathHelper.floor_double(this.posY - 0.20000000298023224), var3 = MathHelper.floor_double(this.posZ));
        IBlockState var5 = this.worldObj.getBlockState(var4);
        Block var6 = var5.getBlock();
        if (var6.getRenderType() != -1) {
            this.worldObj.spawnParticle(EnumParticleTypes.BLOCK_CRACK, this.posX + ((double)this.rand.nextFloat() - 0.5) * (double)this.width, this.getEntityBoundingBox().minY + 0.1, this.posZ + ((double)this.rand.nextFloat() - 0.5) * (double)this.width, -this.motionX * 4.0, 1.5, -this.motionZ * 4.0, Block.getStateId(var5));
        }
    }
    ...
    public int getBrightnessForRender(float p_70070_1_) {
        BlockPos var2 = new BlockPos(this.posX, 0.0, this.posZ);
        if (this.worldObj.isBlockLoaded(var2)) {
            double var3 = (this.getEntityBoundingBox().maxY - this.getEntityBoundingBox().minY) * 0.66;
    ...
    public void func_174828_a(BlockPos p_174828_1_, float p_174828_2_, float p_174828_3_) {
        this.setLocationAndAngles((double)p_174828_1_.getX() + 0.5, p_174828_1_.getY(), (double)p_174828_1_.getZ() + 0.5, p_174828_2_, p_174828_3_);
    }
    ...
    public void applyEntityCollision(Entity entityIn) {
        ...
        double var6;
        double var4;
        if (entityIn.riddenByEntity != this && entityIn.ridingEntity != this && !entityIn.noClip && !this.noClip && (var6 = MathHelper.abs_max(var2 = entityIn.posX - this.posX, var4 = entityIn.posZ - this.posZ)) >= 0.009999999776482582) {
            ...
            if (entityIn.riddenByEntity == null) {
                entityIn.addVelocity(var2, 0.0, var4);
            }
        }
    }
    ...
    public boolean isInRangeToRenderDist(double distance) {
        ...
        return distance < (var3 *= 64.0 * renderDistanceWeight) * var3;
    }
    ...
    public void readFromNBT(NBTTagCompound tagCompund) {
        try {
            ...
            this.lastTickPosX = this.posX = var2.getDouble(0);
            this.prevPosX = this.posX;
            this.lastTickPosY = this.posY = var2.getDouble(1);
            this.prevPosY = this.posY;
            this.lastTickPosZ = this.posZ = var2.getDouble(2);
            this.prevPosZ = this.posZ;
    ...
    public boolean isEntityInsideOpaqueBlock() {
        ...
        for (int var1 = 0; var1 < 8; ++var1) {
            ...
            if (!this.worldObj.getBlockState(new BlockPos(var2, var4 + (double)this.getEyeHeight(), var6)).getBlock().isVisuallyOpaque()) continue;
            return true;
        }
        return false;
    }
    ...
    public void mountEntity(Entity entityIn) {
        ...
        if (entityIn == null) {
            ...
            if (entityIn != null) {
                Entity var2 = entityIn.ridingEntity;
                while (var2 != null) {
                    if (var2 == this) {
                        return;
                    }
                    var2 = var2.ridingEntity;
                }
            }
    ...
    public void func_180426_a(double p_180426_1_, double p_180426_3_, double p_180426_5_, float p_180426_7_, float p_180426_8_, int p_180426_9_, boolean p_180426_10_) {
        ...
        List var11 = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().contract(0.03125, 0.0, 0.03125));
        if (!var11.isEmpty()) {
            double var12 = 0.0;
            for (AxisAlignedBB var15 : var11) {
                if (!(var15.maxY > var12)) continue;
                var12 = var15.maxY;
            }
            this.setPosition(p_180426_1_, p_180426_3_ += var12 - this.getEntityBoundingBox().minY, p_180426_5_);
        }
    }
    ...
    public void setInPortal() {
        if (this.timeUntilPortal > 0) {
            ...
            if (!this.worldObj.isRemote && !this.inPortal) {
                int var5 = MathHelper.abs((float)var1) > MathHelper.abs((float)var3) ? (var1 > 0.0 ? EnumFacing.WEST.getHorizontalIndex() : EnumFacing.EAST.getHorizontalIndex()) : (var3 > 0.0 ? EnumFacing.NORTH.getHorizontalIndex() : EnumFacing.SOUTH.getHorizontalIndex());
    ...
    public boolean isBurning() {
        boolean var1;
        boolean bl = var1 = this.worldObj != null && this.worldObj.isRemote;
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        if (!this.worldObj.func_175665_u(var7.offsetEast()) && 1.0 - var8 < var16) {
            var16 = 1.0 - var8;
            var15 = 1;
        }
        if (!this.worldObj.func_175665_u(var7.offsetUp()) && 1.0 - var10 < var16) {
            var16 = 1.0 - var10;
            var15 = 3;
        }
        ...
        if (!this.worldObj.func_175665_u(var7.offsetSouth()) && 1.0 - var12 < var16) {
            var16 = 1.0 - var12;
            var15 = 5;
        }
