...
implements INetHandlerPlayClient {
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        ...
        Minecraft.thePlayer.dimension = packetIn.func_149194_f();
    ...
    public void handleHeldItemChange(S09PacketHeldItemChange packetIn) {
        ...
        if (packetIn.func_149385_c() >= 0 && packetIn.func_149385_c() < InventoryPlayer.getHotbarSize()) {
            Minecraft.thePlayer.inventory.currentItem = packetIn.func_149385_c();
        }
    }
    ...
    public void handleRespawn(S07PacketRespawn packetIn) {
        PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
        if (packetIn.func_149082_c() != Minecraft.thePlayer.dimension) {
            ...
            this.gameController.loadWorld(this.clientWorldController);
            Minecraft.thePlayer.dimension = packetIn.func_149082_c();
            this.gameController.displayGuiScreen(new GuiDownloadTerrain(this));
        }
    ...
    public void handleStatistics(S37PacketStatistics packetIn) {
        ...
        for (Map.Entry var4 : packetIn.func_148974_c().entrySet()) {
            ...
            if (var5.isAchievement() && var6 > 0) {
                if (this.field_147308_k && Minecraft.thePlayer.getStatFileWriter().writeStat(var5) == 0) {
            ...
            Minecraft.thePlayer.getStatFileWriter().func_150873_a(Minecraft.thePlayer, var5, var6);
        }
        ...
        if (Minecraft.currentScreen instanceof IProgressMeter) {
            ((IProgressMeter)((Object)Minecraft.currentScreen)).doneLoading();
        }
    }
                ...
                public void run() {
                    NetHandlerPlayClient.this.gameController.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback(){
                        ...
                        public void confirmClicked(boolean result, int id) {
                            NetHandlerPlayClient.access$1(3.this.NetHandlerPlayClient.this, Minecraft.getMinecraft());
                            if (result) {
                                if (3.this.NetHandlerPlayClient.this.gameController.getCurrentServerData() != null) {
                                    3.this.NetHandlerPlayClient.this.gameController.getCurrentServerData().setResourceMode(ServerData.ServerResourceMode.ENABLED);
                                }
                                3.access$0(3.this).netManager.sendPacket(new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.ACCEPTED));
                                Futures.addCallback((ListenableFuture)3.this.NetHandlerPlayClient.this.gameController.getResourcePackRepository().func_180601_a(var2, var3), (FutureCallback)new FutureCallback(){
                                    private static final String __OBFID = "CL_00002621";

                                    public void onSuccess(Object p_onSuccess_1_) {
                                        3.access$0(1.access$0(1.this)).netManager.sendPacket(new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.SUCCESSFULLY_LOADED));
                                    }

                                    public void onFailure(Throwable p_onFailure_1_) {
                                        3.access$0(1.access$0(1.this)).netManager.sendPacket(new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.FAILED_DOWNLOAD));
                                    }
                                });
                            } else {
                                if (3.this.NetHandlerPlayClient.this.gameController.getCurrentServerData() != null) {
                                    3.this.NetHandlerPlayClient.this.gameController.getCurrentServerData().setResourceMode(ServerData.ServerResourceMode.DISABLED);
                                }
                                3.access$0(3.this).netManager.sendPacket(new C19PacketResourcePackStatus(var3, C19PacketResourcePackStatus.Action.DECLINED));
                            }
                            ServerList.func_147414_b(3.this.NetHandlerPlayClient.this.gameController.getCurrentServerData());
                            3.this.NetHandlerPlayClient.this.gameController.displayGuiScreen(null);
                        }
        ...
        if ("MC|TrList".equals(packetIn.getChannelName())) {
            ...
            try {
                try {
                    ...
                    if (var4 == null || !(var4 instanceof GuiMerchant) || var3 != Minecraft.thePlayer.openContainer.windowId) return;
            ...
            ItemStack var12;
            if (!"MC|BOpen".equals(packetIn.getChannelName()) || (var12 = Minecraft.thePlayer.getCurrentEquippedItem()) == null || var12.getItem() != Items.written_book) return;
            this.gameController.displayGuiScreen(new GuiScreenBook(Minecraft.thePlayer, var12, false));
        }
    }
    ...
    static /* synthetic */ void access$1(NetHandlerPlayClient netHandlerPlayClient, Minecraft minecraft) {
        netHandlerPlayClient.gameController = minecraft;
    }
