...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        for (GameSettings.Options var5 : field_152312_a) {
            if (var5.getEnumFloat()) {
                ...
                this.buttonList.add(new GuiOptionButton(var5.returnEnumOrdinal(), width / 2 - 155 + var1 % 2 * 160, height / 6 + 24 * (var1 >> 1), var5, this.field_152318_h.getKeyBinding(var5)));
            }
            ++var1;
        }
        if (var1 % 2 == 1) {
        ...
        var1 += 2;
        for (GameSettings.Options var5 : field_152316_f) {
            if (var5.getEnumFloat()) {
                this.buttonList.add(new GuiOptionSlider(var5.returnEnumOrdinal(), width / 2 - 155 + var1 % 2 * 160, height / 6 + 24 * (var1 >> 1), var5));
            } else {
                this.buttonList.add(new GuiOptionButton(var5.returnEnumOrdinal(), width / 2 - 155 + var1 % 2 * 160, height / 6 + 24 * (var1 >> 1), var5, this.field_152318_h.getKeyBinding(var5)));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.field_152315_t) {
            this.drawCenteredString(this.fontRendererObj, (Object)((Object)EnumChatFormatting.RED) + I18n.format("options.stream.changes", new Object[0]), width / 2, 20 + this.fontRendererObj.FONT_HEIGHT, 16777215);
        }
