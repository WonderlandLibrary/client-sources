...
public class MapItemRenderer {
    ...
    class Instance {
        ...
        private void func_148237_a(boolean p_148237_1_) {
            ...
            var5.addVertexWithUV((float)(var2 + 0) + var6, (float)(var3 + 128) - var6, -0.009999999776482582, 0.0, 1.0);
            var5.addVertexWithUV((float)(var2 + 128) - var6, (float)(var3 + 128) - var6, -0.009999999776482582, 1.0, 1.0);
            var5.addVertexWithUV((float)(var2 + 128) - var6, (float)(var3 + 0) + var6, -0.009999999776482582, 1.0, 0.0);
            var5.addVertexWithUV((float)(var2 + 0) + var6, (float)(var3 + 0) + var6, -0.009999999776482582, 0.0, 0.0);
            var4.draw();
