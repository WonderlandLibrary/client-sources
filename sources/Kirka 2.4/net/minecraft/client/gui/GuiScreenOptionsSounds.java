...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new Button(SoundCategory.MASTER.getCategoryId(), width / 2 - 155 + var1 % 2 * 160, height / 6 - 12 + 24 * (var1 >> 1), SoundCategory.MASTER, true));
        int var6 = var1 + 2;
        for (SoundCategory var5 : SoundCategory.values()) {
            if (var5 == SoundCategory.MASTER) continue;
            this.buttonList.add(new Button(var5.getCategoryId(), width / 2 - 155 + var6 % 2 * 160, height / 6 - 12 + 24 * (var6 >> 1), var5, false));
            ++var6;
        }
