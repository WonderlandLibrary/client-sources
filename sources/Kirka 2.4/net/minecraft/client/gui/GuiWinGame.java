...
extends GuiScreen {
    ...
    public void updateScreen() {
        ++this.field_146581_h;
        float var1 = (float)(this.field_146579_r + height + height + 24) / this.field_146578_s;
    ...
    private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
        ...
        float var8 = (float)height - ((float)this.field_146581_h + p_146575_3_) * 0.5f * this.field_146578_s;
        ...
        var5.addVertexWithUV(0.0, height, this.zLevel, 0.0, var7 * var9);
        var5.addVertexWithUV(var6, height, this.zLevel, (float)var6 * var9, var7 * var9);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (var11 = 0; var11 < this.field_146582_i.size(); ++var11) {
            float var12;
            if (var11 == this.field_146582_i.size() - 1 && (var12 = (float)var10 + var9 - (float)(height / 2 - 6)) < 0.0f) {
