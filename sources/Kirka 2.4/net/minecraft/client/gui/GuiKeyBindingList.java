...
extends GuiListExtended {
    ...
    implements GuiListExtended.IGuiListEntry {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
            GuiKeyBindingList.access$0((GuiKeyBindingList)GuiKeyBindingList.this).fontRendererObj.drawString(this.labelText, GuiScreen.width / 2 - this.labelWidth / 2, y + slotHeight - GuiKeyBindingList.access$0((GuiKeyBindingList)GuiKeyBindingList.this).fontRendererObj.FONT_HEIGHT - 1, 16777215);
        }
    ...
    implements GuiListExtended.IGuiListEntry {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
            ...
            if (this.field_148282_b.getKeyCode() != 0) {
                for (KeyBinding var14 : GuiKeyBindingList.access$0((GuiKeyBindingList)GuiKeyBindingList.this).gameSettings.keyBindings) {
