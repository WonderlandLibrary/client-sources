...
public class XMLElement {
    ...
    public int getIntAttribute(String name, int def) throws SlickXMLException {
        try {
            ...
            throw new SlickXMLException("Value read: '" + this.getAttribute(name, new StringBuilder().append("").append(def).toString()) + "' is not an integer", e);
        }
    }
    ...
    public double getDoubleAttribute(String name, double def) throws SlickXMLException {
        try {
            ...
            throw new SlickXMLException("Value read: '" + this.getAttribute(name, new StringBuilder().append("").append(def).toString()) + "' is not a double", e);
        }
    }
    ...
    public boolean getBooleanAttribute(String name, boolean def) throws SlickXMLException {
        ...
        throw new SlickXMLException("Value read: '" + this.getAttribute(name, new StringBuilder().append("").append(def).toString()) + "' is not a boolean");
    }
