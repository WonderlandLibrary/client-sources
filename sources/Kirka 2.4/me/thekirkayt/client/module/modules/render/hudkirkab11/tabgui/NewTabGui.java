...
extends TabGui {
    ...
    public boolean onRender(Render2DEvent event) {
        if (super.onRender(event)) {
            ...
            RenderUtils.rectangle(2.0, 14.0, 35 + baseCategoryWidth, baseCategoryHeight, -1610612736);
            ...
            if (section == Section.MODS) {
                RenderUtils.rectangle(baseCategoryWidth + 40, categoryPosition - 1, baseCategoryWidth + 55 + baseModWidth, categoryPosition + NewTabGui.getModsInCategory(Module.Category.values()[categoryTab]).size() * 14 + 1, -1610612736);
