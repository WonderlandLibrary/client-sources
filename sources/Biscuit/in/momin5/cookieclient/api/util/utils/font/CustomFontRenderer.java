...
public class CustomFontRenderer extends CustomFont{
    ...
    public CustomFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics) {
        ...
        public float drawStringWithShadow(String text, double x, double y, CustomColor color) {
    ...
    public float drawCenteredStringWithShadow(String text, float x, float y, CustomColor color) {
    ...
    public float drawString(String text, double x, double y, CustomColor gsColor, boolean shadow) {
        x -= 1;
        y -= 2;
        CustomColor color=new CustomColor(gsColor);
        if (text == null) return 0.0F;
        if (color.getRed()==255 && color.getGreen()==255 && color.getBlue()==255 && color.getAlpha()==32) color=new CustomColor(255,255,255);
        if (color.getAlpha()<4) color=new CustomColor(color,255);
        if (shadow) color=new CustomColor(color.getRed()/4,color.getGreen()/4,color.getBlue()/4,color.getAlpha());
