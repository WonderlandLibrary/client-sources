...
public class DRenderUtils {
    private static final Minecraft mc = Minecraft.getMinecraft();

    public static void drawBox(BlockPos blockPos, double height, CustomColor color, int sides) {
        drawBox(blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1, height, 1, color, sides);
    }

    public static void drawBox(AxisAlignedBB bb, boolean check, double height, CustomColor color, int sides) {
        if (check){
    ...
    public static void drawBox(double x, double y, double z, double w, double h, double d, CustomColor color, int sides) {
    ...
    public static void drawStorageBox(BlockPos blockPos, double height, CustomColor color, int sides) {
        drawStorageBox(blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1, height, 1, color, sides);
    }

    public static void drawStorageBox(AxisAlignedBB bb, boolean check,  double height, CustomColor color, int sides) {
        if (check){
    ...
    public static void drawStorageBox(double x, double y, double z, double w, double h, double d, CustomColor color, int sides) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        color.glColor();
        bufferbuilder.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION);
    ...
    public static void drawBoundingBox (BlockPos bp, double height, float width, CustomColor color) {
        drawBoundingBox(getBoundingBox(bp,1, height,1),width,color);
    }

    public static void drawBoundingBox (AxisAlignedBB bb, float width, CustomColor color) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
    ...
    public static void playerEsp (BlockPos bp, double height, float width, CustomColor color) {
        drawBoundingBox(getBoundingBox(bp,1, height,1),width,color);
    }

    public static void playerEsp (AxisAlignedBB bb, float width, CustomColor color) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        GlStateManager.glLineWidth(width);
        color.glColor();
    ...
    public static void drawPlayerBox(AxisAlignedBB bb, float width, CustomColor color, int sides) {
        drawPlayerBox(bb.minX,bb.minY,bb.minZ,bb.maxX-bb.minX, bb.maxY-bb.minY,bb.maxZ-bb.minZ,color,sides);
    }

    public static void drawPlayerBox(double x, double y, double z, double w, double h, double d, CustomColor color, int sides) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        color.glColor();
        bufferbuilder.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION);
    ...
    public static void drawBoundingBoxWithSides(BlockPos blockPos, int width, CustomColor color, int sides){
    ...
    public static void drawBoundingBoxWithSides(AxisAlignedBB axisAlignedBB, int width, CustomColor color, int sides){
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        GlStateManager.glLineWidth(width);
        color.glColor();
    ...
    public static void drawNametag (Entity entity, String[] text, CustomColor color, int type) {
    ...
    public static void drawNametag (double x, double y, double z, String[] text, CustomColor color, int type) {
        ...
        if (type == 2) {
            double width = 0;
            CustomColor bcolor = new CustomColor(0,0,0,51);
            ...
            drawBorderedRect(-width - 1, -mc.fontRenderer.FONT_HEIGHT, width + 2,1,1.8f, new CustomColor(0,4,0,85), bcolor);
        }
    ...
    private static void drawBorderedRect (double x, double y, double x1, double y1, float lineWidth, CustomColor inside, CustomColor border) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        inside.glColor();
        bufferbuilder.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION);
