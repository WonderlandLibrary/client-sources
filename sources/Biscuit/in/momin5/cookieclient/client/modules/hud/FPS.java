...
public class FPS extends HudModule {
    ...
    SettingColor color = register(new SettingColor("Color",this,new CustomColor(255,255,255,255)));
    public FPS(){
        super("FPS",new Point(10,30), Category.HUD);
    }
