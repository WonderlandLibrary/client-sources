...
public class InventoryPlayer implements IInventory
{
    ...
    public float getStrVsBlock(Block blockIn)
    {
        ...
        if (this.mainInventory[alternativeSlot ? alternativeCurrentItem : this.currentItem] != null)
        {
            f *= this.mainInventory[alternativeSlot ? alternativeCurrentItem : this.currentItem].getStrVsBlock(blockIn);
        }
