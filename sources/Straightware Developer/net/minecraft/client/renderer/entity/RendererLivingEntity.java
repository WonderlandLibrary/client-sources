...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    private LayerRenderer<?> currentLayer;
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        {
            RenderLivingEntityEvent event = new RenderLivingEntityEvent(entity, this, partialTicks, x, y, z);
    ...
    protected void renderModel(T entitylivingbaseIn, float x, float y, float z, float entityYaw, float entityPitch, float scaleFactor, float partialTicks)
    {
        ...
        if (flag || flag1)
        {
            ...
            Client.INSTANCE.getPubSubEventBus().publish(renderModelEvent);
