...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public EntityPlayerSP blurplayer;
    ...
    public void loadBlur()
    {
        ...
        {
            if(this.blurshader == null || blurplayer != mc.thePlayer) {
                try {
                    blurplayer = mc.thePlayer;
                    blurshader = new ShaderGroup(this.mc.getTextureManager(), this.resourceManager, this.mc.getFramebuffer(), shaderResourceLocations[18]);
                } catch(IOException e) {
                    e.printStackTrace();
                }
            }

            this.theShaderGroup = blurshader;
    ...
    public void getMouseOver(final float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            Client.INSTANCE.getPubSubEventBus().publish(mouseOverEvent);
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        if (this.mc.inGameHasFocus && flag)
        {
            ...
            float f = this.mc.gameSettings.mouseSensitivity * 0.6F + 0.2F;
            float f1 = f * f * f * 8.0F;
            float f2 = (float)(this.mc.mouseHelper.deltaX + mouseAddedX) * f1;
            float f3 = (float)(this.mc.mouseHelper.deltaY + mouseAddedY) * f1;
            int i = 1;
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            final ScaledResolution scaledresolution = ScaledResolution.fetchResolution(this.mc);
...
//                    this.mc.ingameGUI.renderGameOverlay(partialTicks);
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                try
                {
                    ...
                    {
                        try{
                            this.mc.currentScreen.drawScreen(k1,
                                    l1,
                                    partialTicks);
    ...
    {
        this.setupOverlayRendering();
        this.mc.ingameGUI.renderStreamIndicator(ScaledResolution.fetchResolution(this.mc));
    }
