...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityVelocity(S12PacketEntityVelocity packetIn)
    {
        ...
        double x = packetIn.getMotionX() / 8000.0D;
        double y = packetIn.getMotionY() / 8000.0D;
        double z = packetIn.getMotionZ() / 8000.0D;
...
//            return;
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn)
    {
        ...
        this.netManager.sendPacketNoEvent(new C03PacketPlayer.C06PacketPlayerPosLook(
                d0,
                d1,
                d2,
                f % 360,
    ...
    public void addToSendQueue(Packet p) {
        PacketEvent packetEvent = new PacketEvent(PacketEvent.PacketState.ADDQUEUE, p);
        if(packetEvent.isCancelled())
            return;
        this.netManager.sendPacket(packetEvent.getPacket());
    }

    public void addToSilentSendQueue(Packet p)
    {
    ...
    public void handleChat(S02PacketChat packetIn)
    {
        ...
        Client.INSTANCE.getPubSubEventBus().publish(serverChatEvent);
        ...
        {
            this.gameController.ingameGUI.setRecordPlaying(serverChatEvent.getChatComponent(), false);
        }
        else
        {
            this.gameController.ingameGUI.getChatGUI().printChatMessage(serverChatEvent.getChatComponent());
        }
    }
