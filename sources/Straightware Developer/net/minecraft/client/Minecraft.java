...
import me.jinthium.straight.impl.event.render.RenderTickEvent;
import me.jinthium.straight.impl.event.world.BlockPlaceableEvent;
import me.jinthium.straight.impl.manager.DragManager;
import me.jinthium.straight.impl.ui.MainMenu;
import me.jinthium.straight.impl.ui.ThemeSelector;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private int tempDisplayWidth, ticks;
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        {
            this.displayGuiScreen(new UserLogin());
        }
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Loading Straightware...");
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
                ...
                if (inputstream != null && inputstream1 != null)
                {
                    ...
                    //Display.setIcon(new ByteBuffer[] {this.readImageToBuffer(inputstream1), this.readImageToBuffer(inputstream)});
                }
            }
    ...
    {
        ScaledResolution scaledresolution = ScaledResolution.fetchResolution(this);
        ...
        RenderUtil.drawImage(new ResourceLocation("straight/images/Straigtware.png"), 0, 0, scaledresolution.getScaledWidth(), scaledresolution.getScaledHeight());
//        textureManagerInstance.bindTexture(new ResourceLocation("straight/images"));
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = Client.INSTANCE.getUser() == null ? new UserLogin() : new MainMenu();
        }
...
//            Client.INSTANCE.getKeyAuth().endSession();
...
//        RunGameLoopEvent runGameLoopEvent = new RunGameLoopEvent();
        Client.INSTANCE.getPubSubEventBus().publish(new RunGameLoopEvent());
        ...
        if (!this.skipRenderWorld)
        {
            ...
            Client.INSTANCE.getPubSubEventBus().publish(renderTickEvent);
    ...
    public void clickMouse()
    {
        ...
        {
            Client.INSTANCE.getPubSubEventBus().publish(new ClickEvent());

            if (this.objectMouseOver != null && this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.ENTITY) {
                final PlayerAttackEvent event = new PlayerAttackEvent(this.objectMouseOver.entityHit);
...
//                        AttackOrder.sendFixedAttack(thePlayer, this.objectMouseOver.entityHit);
    ...
    public void runTick() throws IOException
    {
        ...
        Client.INSTANCE.getPubSubEventBus().publish(tickEvent);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                {
                    KeyPressEvent keyPressEvent = new KeyPressEvent(k, false);
                    Client.INSTANCE.getPubSubEventBus().publish(keyPressEvent);
            ...
            Client.INSTANCE.getPubSubEventBus().publish(new BlockPlaceableEvent());
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash)
    {
        ...
        theCrash.getCategory().addCrashSectionCallable("OpenGL", new Callable<String>()
        {
            public String call()
            {
                return GL11.glGetString(GL11.GL_RENDERER) + " GL version " + Version.getVersion() + ", " + GL11.glGetString(GL11.GL_VENDOR);
            }
        });
