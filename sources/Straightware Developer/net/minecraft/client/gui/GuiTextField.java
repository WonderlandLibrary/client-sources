...
public class GuiTextField extends Gui
{
    ...
    public GuiTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height, boolean passwordField)
    {
        this.id = componentId;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
                ...
                if(passwordField){
                    for(char cha : s1.toCharArray()){
                        fun.append("*");
                    }
                }
                j1 = this.fontRendererInstance.drawStringWithShadow(passwordField ? fun.toString() : s1, (float)l, (float)i1, i);
            }
