...
public class GuiButton extends Gui implements Util
{
...
//            this.drawCenteredString(fontrenderer, this.displayString, this.xPosition + this.width / 2, this.yPosition + (this.height - 8) / 2, j);
            ...
            RenderUtil.scaleStart(xPosition + width / 2, yPosition + height / 2, animation.getOutput().floatValue());
...
//        RenderUtil.scaleStart(xPosition + width / 2, yPosition + height / 2, 1 + hoverAnimation.getOutput().floatValue());
            normalFont22.drawStringWithShadow(this.displayString, (xPosition + width / 2) - normalFont22.getStringWidth(this.displayString) / 2f, (yPosition + height / 2) - normalFont22.getHeight() / 2 + 2, -1);
            RenderUtil.scaleEnd();
        }
    }
