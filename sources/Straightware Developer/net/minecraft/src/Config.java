        ...
        if (i > 0)
        {
            ...
            if (!Minecraft.isRunningOnMac && getDefaultResourcePack() != null)
            {
                ...
                try
                {
                    ...
                    {
                       // Display.setIcon(new ByteBuffer[] {readIconImage(inputstream1), readIconImage(inputstream)});
                    }
                }
    ...
    public static void checkDisplayMode()
    {
        try
        {
            if (minecraft.isFullScreen())
            {
                ...
                {
                    ScaledResolution scaledresolution = ScaledResolution.fetchResolution(minecraft);
