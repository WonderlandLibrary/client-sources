    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            {
                ...
                RenderUtility.drawRoundedGradientRect(this.xPosition - 0.5f, this.yPosition - 0.5f, this.width + 1, this.height + 1, 6, 1, color, color, color2, color2);
                RenderUtility.drawRoundedRect(this.xPosition, this.yPosition, this.width, this.height, 5, new Color(0, 0, 0).getRGB());
            }
            ...
            if (!s.isEmpty())
            {
                ...
                j1 = (int) this.fontRendererInstance.drawStringWithShadow(s1.replaceAll("(?s).", "*"), (float)l, (float)i1 + 1.5f, i);
            }
            ...
            {
                j1 = (int) this.fontRendererInstance.drawStringWithShadow(s.substring(j), (float)j1, (float)i1 + 1.5f, i);
            }
            ...
            if (flag1)
            {
                ...
                {
                    Fonts.mntsb17.drawStringWithShadow("_", (float)k1 + 1, (float)i1 + 1.5f, i);
                }
            }
