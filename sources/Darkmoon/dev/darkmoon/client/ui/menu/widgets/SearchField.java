...
public class SearchField extends Gui
{
    ...
    public SearchField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                RenderUtility.drawRoundedRect(this.xPosition, this.yPosition, this.width, this.height, 6, new Color(17, 15, 15).getRGB());
            }

            int i = new Color(120, 120, 120).getRGB();
            ...
            if (!s.isEmpty())
            {
                ...
                j1 = (int) this.fontRendererInstance.drawString(s1, (float)l, (float)i1 + 2, i);
            }
            ...
            {
                j1 = (int) this.fontRendererInstance.drawString(s.substring(j), (float)j1, (float)i1 + 2, i);
            }
            ...
            if (flag1)
            {
                ...
                {
                    this.fontRendererInstance.drawString("_", (float)k1 + 1, (float)i1 + 2, i);
                }
            }
