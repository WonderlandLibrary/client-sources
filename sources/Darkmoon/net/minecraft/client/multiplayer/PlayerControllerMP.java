...
import dev.darkmoon.client.module.impl.player.AutoTool;
...
public class PlayerControllerMP
{
    ...
    public void attackEntityNoEvent(EntityPlayer playerIn, Entity targetEntity) {
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing)
    {
        ...
        if (DarkMoon.getInstance().getModuleManager().getModule(AutoTool.class).isEnabled() || DarkMoon.getInstance().getModuleManager().getModule(NoClip.class).isEnabled()) {
            EventInteractBlock event = new EventInteractBlock(posBlock, directionFacing);
