...
public class Gui
{
    ...
    public static void drawRect2(double x, double y, double width, double height, int color) {
        ...
        RenderUtility.setAlphaLimit(0);
        GLUtility.setup2DRendering(true);
    ...
    public static void drawGradientRect(float f8, float sY, double d, double e, int startColor, int endColor) {
        ...
        bufferbuilder.pos(d, sY, zLevel).color(f1, f2, f3, f).endVertex();
        bufferbuilder.pos(f8, sY, zLevel).color(f5, f6, f7, f4).endVertex();
        bufferbuilder.pos(f8, e, zLevel).color(f5, f6, f7, f4).endVertex();
