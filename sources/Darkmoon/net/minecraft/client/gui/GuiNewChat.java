                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                ...
                                Color[] clientColors = DarkMoon.getInstance().getThemeManager().getCurrentStyleTheme().getColors();
                                if (s.contains(ChatFormatting.DARK_GRAY + "\2477(" + ChatFormatting.RESET + "DarkMoon" + ChatFormatting.RESET + ChatFormatting.DARK_GRAY + "\2477)")) {
                                    StencilUtility.initStencilToWrite();
                                    this.mc.fontRenderer.drawString(s, 0, (int)(j2 - 8), 16777215 + (l1 << 24));
                                    StencilUtility.readStencilBuffer(1);
                                    RenderUtility.drawGradientHorizontal(mc.fontRenderer.getStringWidth("\2477(") + 0.5f, j2 - 10, mc.fontRenderer.getStringWidth("DarkMoon") - 0.5f, mc.fontRenderer.getStringHeight("DarkMoon") + 3, 0, ColorUtility.applyOpacity(clientColors[0], 255), ColorUtility.applyOpacity(clientColors[1], 255));
