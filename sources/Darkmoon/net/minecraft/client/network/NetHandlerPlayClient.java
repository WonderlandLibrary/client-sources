...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void onDisconnect(ITextComponent reason)
    {
        ...
        {
            this.client.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new GuiMainMenuElement()), "disconnect.lost", reason));
        }
    }
    ...
    {
        this.netManager.sendPacketSilent(packetIn);
    }
