...
import dev.darkmoon.client.module.impl.render.CustomFog;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void setupCameraTransform(float partialTicks, int pass)
    {
        ...
        if (DarkMoon.getInstance().getModuleManager().getModule(CustomFog.class).isEnabled()) {
            this.farPlaneDistance *= CustomFog.distance.get();
        }
    ...
    {
        EventOverlay eventOverlay = new EventOverlay(EventOverlay.OverlayType.WEATHER);
        EventManager.call(eventOverlay);
    ...
    private void updateFogColor(float partialTicks)
    {
        ...
        if (DarkMoon.getInstance().getModuleManager().getModule(CustomFog.class).isEnabled()) {
            Color rgb = CustomFog.color.getColor();
    ...
    {
        EventOverlay event = new EventOverlay(EventOverlay.OverlayType.TOTEM_ANIMATION);
        EventManager.call(event);
