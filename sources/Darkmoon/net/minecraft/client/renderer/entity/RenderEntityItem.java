...
import dev.darkmoon.client.module.impl.render.Physic;
...
public class RenderEntityItem
    ...
    private int transformModelCount(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_) {
        ...
        float f = 0.25f;
        float f1 = DarkMoon.getInstance().getModuleManager().getModule(Physic.class).isEnabled() ? 0.0f : MathHelper.sin(((float)itemIn.getAge() + p_177077_8_) / 10.0f + itemIn.hoverStart) * 0.1f + 0.1f;
        ...
        if (!DarkMoon.getInstance().getModuleManager().getModule(Physic.class).isEnabled() && (flag || this.renderManager.options != null)) {
            float f3 = (((float)itemIn.getAge() + p_177077_8_) / 20.0f + itemIn.hoverStart) * 57.295776f;
            GlStateManager.rotate(f3, 0.0f, 1.0f, 0.0f);
        }
        this.shadowSize = DarkMoon.getInstance().getModuleManager().getModule(Physic.class).isEnabled() ? 0.0f : 0.15f;
    ...
    public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
        if (!DarkMoon.getInstance().getModuleManager().getModule(Physic.class).isEnabled()) {
