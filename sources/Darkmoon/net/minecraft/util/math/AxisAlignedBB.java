...
public class AxisAlignedBB
{
    ...
    public Vec3d clamp(Vec3d vec3d) {
        double var2 = MathHelper.clamp(vec3d.x, this.minX, this.maxX);
        double var4 = MathHelper.clamp(vec3d.y, this.minY, this.maxY);
        double var6 = MathHelper.clamp(vec3d.z, this.minZ, this.maxZ);
