...
import me.Emir.Karaguc.utils.ItemUtils;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    {
        if(Karaguc.instance.moduleManager.getModuleByName("ItemPhysics").isToggled())
            ItemUtils.doRender(entity, x, y, z, entityYaw, partialTicks);
        else
            renderNormal(entity, x, y, z, entityYaw, partialTicks);
