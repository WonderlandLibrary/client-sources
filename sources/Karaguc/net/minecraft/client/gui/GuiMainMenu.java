...
import me.Emir.Karaguc.ui.alt.GuiAltManager;
import me.Emir.Karaguc.ui.credits.GuiCredits;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 - 100, p_73969_1_, I18n.format("menu.multiplayer", new Object[0])));
        this.buttonList.add(this.realmsButton = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_, I18n.format("menu.online", new Object[0])));
        this.buttonList.add(new GuiButton(500, this.width / 2 + 2, p_73969_1_ + p_73969_2_ * 2, 98, 20, "Alt Manager"));
        this.buttonList.add(new GuiButton(501, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, 98, 20, "Credits"));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation(Karaguc.instance.name.toLowerCase() + "/icons/logo.png"));
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);

        drawModalRectWithCustomSizedTexture(width / 2 - 32, 7, 0, 0, 63, 63, 63, 63);
        ...
        GlStateManager.popMatrix();
        String s = Karaguc.instance.name + " b" + Karaguc.instance.version;
        ...
        String s1 = "Don't forget to check";
        String s2 = "the credits!";
