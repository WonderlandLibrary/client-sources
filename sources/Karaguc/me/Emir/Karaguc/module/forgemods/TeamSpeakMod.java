...
public class TeamSpeakMod extends Module {
    public TeamSpeakMod() { super("TeamSpeakMod", Keyboard.KEY_NONE, Category.ForgeMods); }

    @Override
    public void setup() {
        ArrayList<String> options = new ArrayList<>();
        //TODO: Add more TeamSpeakMod modes
        Karaguc.instance.settingsManager.rSetting(new Setting("TeamSpeakMod Mode", this, "Normal", options));
    }
