...
public class CpsMod extends Module {
    public CpsMod() { super("CpsMod", Keyboard.KEY_NONE, Category.ForgeMods); }

    @Override
    public void setup() {
        ArrayList<String> options = new ArrayList<>();
        //TODO: Add more CpsMod modes
        Karaguc.instance.settingsManager.rSetting(new Setting("CpsMod Mode", this, "Normal", options));
    }
