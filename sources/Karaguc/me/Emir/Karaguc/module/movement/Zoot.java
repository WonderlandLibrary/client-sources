...
public class Zoot extends Module {
    public Zoot() {
        super("Zoot", Keyboard.KEY_NONE, Category.MOVEMENT);
    }

    public void setup() {
        ArrayList<String> modes = new ArrayList<String>();
        Karaguc.instance.settingsManager.rSetting(new Setting("Zoot Mode", this, "Normal", modes));
        Karaguc.instance.settingsManager.rSetting(new Setting("NotFire", this, false));
        Karaguc.instance.settingsManager.rSetting(new Setting("NotPotions", this, false));
    }
    @EventTarget
