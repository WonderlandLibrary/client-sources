...
import me.Emir.Karaguc.utils.ArmorUtils;
...
public class AutoArmor extends Module {
    ...
    public void setup() {
        ...
        modes.add("AAC");
        modes.add("Normal");
        Karaguc.instance.settingsManager.rSetting(new Setting("AutoArmor Mode", this, "Normal", modes));
        Karaguc.instance.settingsManager.rSetting(new Setting("Open-Inv", this, true));
    }
