...
public class AutoBuild extends Module {
    public AutoBuild() {
        super("AutoBuild", Keyboard.KEY_NONE, Category.PLAYER);
    }
    ...
    public void setup() {
        ...
        modes.add("SpeedBuilderAuto");
        modes.add("1 Block");
        modes.add("3 block");
        modes.add("Wall");
        modes.add("Flash");
        Karaguc.instance.settingsManager.rSetting(new Setting("AutoBuild Mode", this, "Flash", modes));
        Karaguc.instance.settingsManager.rSetting(new Setting("Normal", this, true));
