...
public class NoRender extends Module {
    public NoRender() {
        super("NoRender", Keyboard.KEY_NONE, Category.MOVEMENT);
    }

    public void setup() {
        ArrayList<String> modes = new ArrayList<String>();
        modes.add("Tab");
        modes.add("NoScoreBoard");
        modes.add("Chunk");
        modes.add("Stream");
        Karaguc.instance.settingsManager.rSetting(new Setting("NoRender Mode", this, "Normal", modes));
    }
    @EventTarget
