...
public class ClickGUI extends GuiScreen {
	 ...
	 */
	public ClickGUI() {
		setmgr = Karaguc.instance.settingsManager;
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		Gui.drawRect(0, 0, width, height, new Color(255, 133, 133, 50).getRGB());
		...
		/* copyright KaragucCode 2017									*/ GL11.glTranslated(s.getScaledWidth(), s.getScaledHeight(), 0);GL11.glScaled(0.5, 0.5, 0.5);
				...
				for (ModuleButton b : panel.Elements) {
					if (b.extended && b.menuelements != null && !b.menuelements.isEmpty()) {
						...
						for (Element e : b.menuelements) {
							e.offset = off;
							e.update();
							if(Karaguc.instance.settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("Karaguc")){
		...
		if(mb != null){
			...
			FontUtil.drawTotalCenteredStringWithShadow("KaragucCode", 0, 20, 0xffffffff);
			GL11.glPopMatrix();
		}
