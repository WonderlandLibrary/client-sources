...
public class RandomMobs {
    ...
    private static ResourceLocation getPropertyLocation(ResourceLocation loc) {
        ...
        if (Config.hasResource(locProps = new ResourceLocation(domain, pathProps = String.valueOf(pathBase) + ".properties"))) {
            return locProps;
        }
        ...
        ResourceLocation locParentProps = new ResourceLocation(domain, String.valueOf(pathParent) + ".properties");
