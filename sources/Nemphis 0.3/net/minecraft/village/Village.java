...
public class Village {
    ...
    private boolean func_179861_a(BlockPos p_179861_1_, BlockPos p_179861_2_) {
        ...
        int var5 = var3;
        while (var5 < var3 + p_179861_1_.getX()) {
            int var6 = p_179861_2_.getY();
            while (var6 < p_179861_2_.getY() + p_179861_1_.getY()) {
                int var7 = var4;
                while (var7 < var4 + p_179861_1_.getZ()) {
    ...
    public boolean func_179866_a(BlockPos p_179866_1_) {
        if (this.center.distanceSq(p_179866_1_) < (double)(this.villageRadius * this.villageRadius)) {
            return true;
        }
        return false;
    }
    ...
    public boolean isPlayerReputationTooLow(String p_82687_1_) {
        if (this.getReputationForPlayer(p_82687_1_) <= -15) {
            return true;
        }
        return false;
    }
