...
extends Vec3i {
    ...
    static {
        field_177991_c = BlockPos.field_177990_b = 1 + MathHelper.calculateLogBaseTwo(MathHelper.roundUpToPowerOfTwo(30000000));
        ...
        field_177994_h = (1 << field_177990_b) - 1;
        field_177995_i = (1 << field_177989_d) - 1;
        field_177993_j = (1 << field_177991_c) - 1;
    }
    ...
    public static Iterable getAllInBox(BlockPos from, BlockPos to) {
        ...
        return new Iterable(){
            ...
            public Iterator iterator() {
                return new AbstractIterator(BlockPos.this, var3){
                    private BlockPos lastReturned;
                    private static final String __OBFID = "CL_00002332";
                    private final /* synthetic */ BlockPos val$var2;
                    private final /* synthetic */ BlockPos val$var3;
                    ...
                    protected BlockPos computeNext0() {
                        ...
                        if (var1 < this.val$var3.getX()) {
                            ++var1;
                        } else if (var2x < this.val$var3.getY()) {
                            var1 = this.val$var2.getX();
                            ++var2x;
                        } else if (var3x < this.val$var3.getZ()) {
                            var1 = this.val$var2.getX();
                            var2x = this.val$var2.getY();
                            ++var3x;
                        }
                ...
                return new AbstractIterator(BlockPos.this, var3){
                    ...
                    protected MutableBlockPos computeNext0() {
                        if (this.theBlockPos == null) {
                            this.theBlockPos = new MutableBlockPos(this.val$var2.getX(), this.val$var2.getY(), this.val$var2.getZ(), null);
                        ...
                        if (var1 < this.val$var3.getX()) {
                            ++var1;
                        } else if (var2xx < this.val$var3.getY()) {
                            var1 = this.val$var2.getX();
                            ++var2xx;
                        } else if (var3x < this.val$var3.getZ()) {
                            var1 = this.val$var2.getX();
                            var2xx = this.val$var2.getY();
                            ++var3x;
                        }
