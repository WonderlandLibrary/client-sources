...
public enum EnumWorldBlockLayer {
    ...
    static {
        $VALUES = new EnumWorldBlockLayer[]{SOLID, CUTOUT_MIPPED, CUTOUT, TRANSLUCENT};
    }

    private EnumWorldBlockLayer(String p_i45755_1_, int p_i45755_2_, String p_i45755_3_, int n2, String string2) {
