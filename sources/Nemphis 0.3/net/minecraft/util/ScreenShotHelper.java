...
public class ScreenShotHelper {
    ...
    public static IChatComponent saveScreenshot(File p_148259_0_, String p_148259_1_, int p_148259_2_, int p_148259_3_, Framebuffer p_148259_4_) {
        try {
            ...
            if (OpenGlHelper.isFramebufferEnabled()) {
                ...
                int var9 = var8 = p_148259_4_.framebufferTextureHeight - p_148259_4_.framebufferHeight;
                while (var9 < p_148259_4_.framebufferTextureHeight) {
                    int var10 = 0;
                    while (var10 < p_148259_4_.framebufferWidth) {
    ...
    private static File getTimestampedPNGFileForDirectory(File p_74290_0_) {
        ...
        int var3 = 1;
        File var1;
        while ((var1 = new File(p_74290_0_, String.valueOf(var2) + (var3 == 1 ? "" : new StringBuilder("_").append(var3).toString()) + ".png")).exists()) {
            ++var3;
        }
        return var1;
    }
