...
implements ICommand {
    ...
    public static String func_180529_a(String[] p_180529_0_, int p_180529_1_) {
        ...
        int var3 = p_180529_1_;
        while (var3 < p_180529_0_.length) {
            if (var3 > p_180529_1_) {
                var2.append(" ");
            }
    ...
    public static /* varargs */ List getListOfStringsMatchingLastWord(String[] args, String ... possibilities) {
    ...
    public static /* varargs */ void notifyOperators(ICommandSender sender, ICommand command, String msgFormat, Object ... msgParams) {
        CommandBase.notifyOperators(sender, command, 0, msgFormat, msgParams);
    }

    public static /* varargs */ void notifyOperators(ICommandSender sender, ICommand command, int p_152374_2_, String msgFormat, Object ... msgParams) {
        if (theAdmin != null) {
