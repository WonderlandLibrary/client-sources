...
public class PlayerSelector {
        ...
        if (!(var3 != null && p_179663_1_.equals("e") || var7)) {
            ...
            var2.add(new Predicate(){
                ...
                public boolean func_179613_a(Entity p_179613_1_) {
                    return EntityList.func_180123_a(p_179613_1_, String.this) ^ var4;
                }
    ...
    private static List func_179648_b(Map p_179648_0_) {
        ...
        int var2 = PlayerSelector.func_179653_a(p_179648_0_, "lm", -1);
        ...
        if (var2 > -1 || var3 > -1) {
            var1.add(new Predicate(){
                ...
                public boolean func_179625_a(Entity p_179625_1_) {
                    ...
                    if (!(val$var2 > -1 && var2x.experienceLevel < val$var2 || var3 > -1 && var2x.experienceLevel > var3)) {
                        return true;
                    }
                    return false;
                }
    ...
    private static List func_179649_c(Map p_179649_0_) {
        ArrayList var1 = Lists.newArrayList();
        int var2 = PlayerSelector.func_179653_a(p_179649_0_, "m", WorldSettings.GameType.NOT_SET.getID());
        if (var2 != WorldSettings.GameType.NOT_SET.getID()) {
            var1.add(new Predicate(){
                ...
                public boolean func_179619_a(Entity p_179619_1_) {
                    ...
                    if (var2x.theItemInWorldManager.getGameType().getID() == val$var2) {
                        return true;
                    }
                    return false;
                }
        ...
        if (var2 != null) {
            ...
            var1.add(new Predicate(){
                ...
                public boolean func_179621_a(Entity p_179621_1_) {
                    ...
                    return var4.equals(String.this) ^ var3;
                }
    ...
    private static List func_179657_e(Map p_179657_0_) {
        ArrayList var1 = Lists.newArrayList();
        Map var2 = PlayerSelector.func_96560_a(p_179657_0_);
        if (var2 != null && var2.size() > 0) {
            var1.add(new Predicate(){
                ...
                public boolean func_179603_a(Entity p_179603_1_) {
                    ...
                    Iterator var3 = Map.this.entrySet().iterator();
                    do {
                        ScoreObjective var7;
                        String var8;
                        if (!var3.hasNext()) {
        ...
        if (var2 != null) {
            ...
            var1.add(new Predicate(){
                ...
                public boolean func_179600_a(Entity p_179600_1_) {
                    return p_179600_1_.getName().equals(String.this) ^ var3;
                }
    ...
    private static List func_180698_a(Map p_180698_0_, BlockPos p_180698_1_) {
        ArrayList var2 = Lists.newArrayList();
        ...
        if (p_180698_1_ != null && (var3 >= 0 || var4 >= 0)) {
            ...
            var2.add(new Predicate(){
                ...
                public boolean func_179594_a(Entity p_179594_1_) {
                    int var2 = (int)p_179594_1_.func_174831_c(BlockPos.this);
                    if (!(var3 >= 0 && var2 < var5 || var4 >= 0 && var2 > var6)) {
                        return true;
                    }
                    return false;
                }
        ...
        if (p_179662_0_.containsKey("rym") || p_179662_0_.containsKey("ry")) {
            ...
            var1.add(new Predicate(){
                ...
                public boolean func_179591_a(Entity p_179591_1_) {
                    ...
                    return val$var2 > var3 ? var2x >= val$var2 || var2x <= var3 : var2x >= val$var2 && var2x <= var3;
                }
    ...
    private static List func_179660_a(Map p_179660_0_, Class p_179660_1_, List p_179660_2_, String p_179660_3_, World worldIn, BlockPos p_179660_5_) {
        ...
        if (p_179660_5_ != null) {
            ...
            if (!(p_179660_0_.containsKey("dx") || p_179660_0_.containsKey("dy") || p_179660_0_.containsKey("dz"))) {
                ...
                AxisAlignedBB var19 = PlayerSelector.func_179661_a(p_179660_5_, var10, var11, var12);
                if (var8 && var18 && !var9) {
                    Predicate var20 = new Predicate(){
                        ...
                        public boolean func_179609_a(Entity p_179609_1_) {
                            return p_179609_1_.posX >= AxisAlignedBB.this.minX && p_179609_1_.posY >= AxisAlignedBB.this.minY && p_179609_1_.posZ >= AxisAlignedBB.this.minZ ? p_179609_1_.posX < AxisAlignedBB.this.maxX && p_179609_1_.posY < AxisAlignedBB.this.maxY && p_179609_1_.posZ < AxisAlignedBB.this.maxZ : false;
                        }
    ...
    private static List func_179658_a(List p_179658_0_, Map p_179658_1_, ICommandSender p_179658_2_, Class p_179658_3_, String p_179658_4_, BlockPos p_179658_5_) {
        Entity var7;
        ...
        if (!(p_179658_4_.equals("p") || p_179658_4_.equals("a") || p_179658_4_.equals("e"))) {
            ...
            Collections.sort(p_179658_0_, new Comparator(){
                ...
                public int func_179611_a(Entity p_179611_1_, Entity p_179611_2_) {
                    return ComparisonChain.start().compare(p_179611_1_.getDistanceSq(BlockPos.this), p_179611_2_.getDistanceSq(BlockPos.this)).result();
                }
    ...
    public static Map func_96560_a(Map p_96560_0_) {
        ...
        for (String var3 : p_96560_0_.keySet()) {
            ...
            var1.put(var3.substring("score_".length()), MathHelper.parseIntWithDefault((String)p_96560_0_.get(var3), 1));
        }
        return var1;
    }
    ...
    public static boolean matchesMultiplePlayers(String p_82377_0_) {
        ...
        if (PlayerSelector.func_179653_a(var2, "c", var4) != 1) {
            return true;
        }
        return false;
    }
