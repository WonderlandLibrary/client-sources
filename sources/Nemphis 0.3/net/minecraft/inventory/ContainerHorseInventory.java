...
extends Container {
    ...
    public ContainerHorseInventory(IInventory p_i45791_1_, IInventory p_i45791_2_, final EntityHorse p_i45791_3_, EntityPlayer p_i45791_4_) {
        ...
        this.addSlotToContainer(new Slot(p_i45791_2_, 0, 8, 18){
            ...
            public boolean isItemValid(ItemStack stack) {
                if (super.isItemValid(stack) && stack.getItem() == Items.saddle && !this.getHasStack()) {
                    return true;
                }
                return false;
            }
        ...
        this.addSlotToContainer(new Slot(p_i45791_2_, 1, 8, 36){
            ...
            @Override
            public boolean isItemValid(ItemStack stack) {
                if (super.isItemValid(stack) && p_i45791_3_.canWearArmor() && EntityHorse.func_146085_a(stack.getItem())) {
                    return true;
                }
                return false;
            }
    ...
    public boolean canInteractWith(EntityPlayer playerIn) {
        if (this.field_111243_a.isUseableByPlayer(playerIn) && this.theHorse.isEntityAlive() && this.theHorse.getDistanceToEntity(playerIn) < 8.0f) {
            return true;
        }
        return false;
    }
