    ...
    private void writeChunkToNBT(Chunk p_75820_1_, World worldIn, NBTTagCompound p_75820_3_) {
        ...
        while (var9 < var8) {
            ...
            if (var10 != null) {
                ...
                int var15 = 0;
                while (var15 < var10.getData().length) {
        ...
        var8 = 0;
        while (var8 < p_75820_1_.getEntityLists().length) {
