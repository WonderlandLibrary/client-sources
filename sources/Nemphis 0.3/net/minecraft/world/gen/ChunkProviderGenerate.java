...
implements IChunkProvider {
    ...
    public ChunkProviderGenerate(World worldIn, long p_i45636_2_, boolean p_i45636_4_, String p_i45636_5_) {
        ...
        while (var6 <= 2) {
            ...
            while (var7 <= 2) {
                float var8;
                this.parabolicField[var6 + 2 + (var7 + 2) * 5] = var8 = 10.0f / MathHelper.sqrt_float((float)(var6 * var6 + var7 * var7) + 0.2f);
                ++var7;
            }
            ++var6;
        }
    ...
    private void func_147423_a(int p_147423_1_, int p_147423_2_, int p_147423_3_) {
        ...
        while (var8 < 5) {
            ...
            while (var9 < 5) {
                ...
                double var38 = this.field_147426_g[var7] / 8000.0;
                if (var38 < 0.0) {
                    var38 = (- var38) * 0.3;
                }
                if ((var38 = var38 * 3.0 - 2.0) < 0.0) {
                    if ((var38 /= 2.0) < -1.0) {
                        var38 = -1.0;
                    }
                    var38 /= 1.4;
                ...
                double var40 = var10;
                var39 += var38 * 0.2;
                var39 = var39 * (double)this.field_177477_r.field_177823_k / 8.0;
                double var21 = (double)this.field_177477_r.field_177823_k + var39 * 4.0;
                int var23 = 0;
                while (var23 < 33) {
                    double var24 = ((double)var23 - var21) * (double)this.field_177477_r.field_177817_l * 128.0 / 256.0 / var40;
                    if (var24 < 0.0) {
                        var24 *= 4.0;
                    }
                    ...
                    double var30 = (this.field_147427_d[var6] / 10.0 + 1.0) / 2.0;
                    double var32 = MathHelper.denormalizeClamp(var26, var28, var30) - var24;
                    if (var23 > 29) {
                        double var34 = (float)(var23 - 29) / 3.0f;
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_) {
        ...
        long var8 = this.rand.nextLong() / 2 * 2 + 1;
        long var10 = this.rand.nextLong() / 2 * 2 + 1;
        ...
        if (this.field_177477_r.field_177837_s) {
            var14 = 0;
            while (var14 < this.field_177477_r.field_177835_t) {
    ...
    public boolean func_177460_a(IChunkProvider p_177460_1_, Chunk p_177460_2_, int p_177460_3_, int p_177460_4_) {
        boolean var5 = false;
        if (this.field_177477_r.field_177852_y && this.mapFeaturesEnabled && p_177460_2_.getInhabitedTime() < 3600) {
