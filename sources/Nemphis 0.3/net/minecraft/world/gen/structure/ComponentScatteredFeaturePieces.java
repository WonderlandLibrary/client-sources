...
public class ComponentScatteredFeaturePieces {
    ...
    extends Feature {
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            var4 = 0;
            while (var4 < this.scatteredFeatureSizeX) {
                var5 = 0;
                while (var5 < this.scatteredFeatureSizeZ) {
                    int var6 = -5;
            ...
            var10 = 0;
            while (var10 <= this.scatteredFeatureSizeX - 1) {
                ...
                var10 += this.scatteredFeatureSizeX - 1;
            }
            var10 = 2;
            while (var10 <= this.scatteredFeatureSizeX - 3) {
                ...
                this.func_175811_a(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.func_176675_a()), var10 + 1, 8, 0, p_74875_3_);
                var10 += this.scatteredFeatureSizeX - 3 - 2;
            }
            ...
            for (EnumFacing var11 : EnumFacing.Plane.HORIZONTAL) {
                if (this.field_74940_h[var11.getHorizontalIndex()]) continue;
                int var12 = var11.getFrontOffsetX() * 2;
                int var13 = var11.getFrontOffsetZ() * 2;
                this.field_74940_h[var11.getHorizontalIndex()] = this.func_180778_a(worldIn, p_74875_3_, p_74875_2_, 10 + var12, -11, 10 + var13, WeightedRandomChestContent.func_177629_a(itemsToGenerateInTemple, Items.enchanted_book.getRandomEnchantedBook(p_74875_2_)), 2 + p_74875_2_.nextInt(5));
            }
            return true;
        }
    }
    ...
    extends StructureComponent {
        ...
        protected boolean func_74935_a(World worldIn, StructureBoundingBox p_74935_2_, int p_74935_3_) {
            ...
            while (var6 <= this.boundingBox.maxZ) {
                int var7 = this.boundingBox.minX;
                while (var7 <= this.boundingBox.maxX) {
    ...
    extends Feature {
        ...
        private static final List field_175816_i = Lists.newArrayList((Object[])new WeightedRandomChestContent[]{new WeightedRandomChestContent(Items.diamond, 0, 1, 3, 3), new WeightedRandomChestContent(Items.iron_ingot, 0, 1, 5, 10), new WeightedRandomChestContent(Items.gold_ingot, 0, 2, 7, 15), new WeightedRandomChestContent(Items.emerald, 0, 1, 3, 2), new WeightedRandomChestContent(Items.bone, 0, 4, 6, 20), new WeightedRandomChestContent(Items.rotten_flesh, 0, 3, 7, 16), new WeightedRandomChestContent(Items.saddle, 0, 1, 1, 3), new WeightedRandomChestContent(Items.iron_horse_armor, 0, 1, 1, 1), new WeightedRandomChestContent(Items.golden_horse_armor, 0, 1, 1, 1), new WeightedRandomChestContent(Items.diamond_horse_armor, 0, 1, 1, 1)});
        private static final List field_175815_j = Lists.newArrayList((Object[])new WeightedRandomChestContent[]{new WeightedRandomChestContent(Items.arrow, 0, 2, 7, 30)});
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            if (!this.field_74947_h) {
                this.field_74947_h = this.func_180778_a(worldIn, p_74875_3_, p_74875_2_, 8, -3, 3, WeightedRandomChestContent.func_177629_a(field_175816_i, Items.enchanted_book.getRandomEnchantedBook(p_74875_2_)), 2 + p_74875_2_.nextInt(5));
            }
            ...
            if (!this.field_74948_i) {
                this.field_74948_i = this.func_180778_a(worldIn, p_74875_3_, p_74875_2_, 9, -3, 10, WeightedRandomChestContent.func_177629_a(field_175816_i, Items.enchanted_book.getRandomEnchantedBook(p_74875_2_)), 2 + p_74875_2_.nextInt(5));
            }
            return true;
        }
        ...
        extends StructureComponent.BlockSelector {
            ...
            public void selectBlocks(Random p_75062_1_, int p_75062_2_, int p_75062_3_, int p_75062_4_, boolean p_75062_5_) {
                this.field_151562_a = p_75062_1_.nextFloat() < 0.4f ? Blocks.cobblestone.getDefaultState() : Blocks.mossy_cobblestone.getDefaultState();
            }

            Stones(SwitchEnumFacing p_i45583_1_) {
                this();
            }
        }
    ...
    extends Feature {
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            this.func_175811_a(worldIn, Blocks.flower_pot.getDefaultState().withProperty(BlockFlowerPot.field_176443_b, (Comparable)((Object)BlockFlowerPot.EnumFlowerType.MUSHROOM_RED)), 1, 3, 5, p_74875_3_);
            ...
            if (!this.hasWitch && p_74875_3_.func_175898_b(new BlockPos(var8 = this.getXWithOffset(2, 5), var9 = this.getYWithOffset(2), var10 = this.getZWithOffset(2, 5)))) {
                this.hasWitch = true;
