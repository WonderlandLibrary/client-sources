...
public class StructureOceanMonumentPieces {
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            RoomDefinition var4 = this.field_175830_k.field_175965_b[EnumFacing.EAST.getIndex()];
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            RoomDefinition var4 = this.field_175830_k.field_175965_b[EnumFacing.EAST.getIndex()];
            RoomDefinition var5 = this.field_175830_k;
            RoomDefinition var6 = var5.field_175965_b[EnumFacing.UP.getIndex()];
            RoomDefinition var7 = var4.field_175965_b[EnumFacing.UP.getIndex()];
            if (this.field_175830_k.field_175967_a / 25 > 0) {
                this.func_175821_a(worldIn, p_74875_3_, 8, 0, var4.field_175966_c[EnumFacing.DOWN.getIndex()]);
                this.func_175821_a(worldIn, p_74875_3_, 0, 0, var5.field_175966_c[EnumFacing.DOWN.getIndex()]);
            }
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            RoomDefinition var4 = this.field_175830_k.field_175965_b[EnumFacing.UP.getIndex()];
            if (var4.field_175965_b[EnumFacing.UP.getIndex()] == null) {
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            IBlockState var9;
            RoomDefinition var4 = this.field_175830_k.field_175965_b[EnumFacing.NORTH.getIndex()];
            RoomDefinition var5 = this.field_175830_k;
            RoomDefinition var6 = var4.field_175965_b[EnumFacing.UP.getIndex()];
            RoomDefinition var7 = var5.field_175965_b[EnumFacing.UP.getIndex()];
            if (this.field_175830_k.field_175967_a / 25 > 0) {
    ...
    implements MonumentRoomFitHelper {
        ...
        FitSimpleRoomHelper(SwitchEnumFacing p_i45601_1_) {
            this();
        }
    }
    ...
    implements MonumentRoomFitHelper {
        ...
        @Override
        public boolean func_175969_a(RoomDefinition p_175969_1_) {
            if (!(p_175969_1_.field_175966_c[EnumFacing.WEST.getIndex()] || p_175969_1_.field_175966_c[EnumFacing.EAST.getIndex()] || p_175969_1_.field_175966_c[EnumFacing.NORTH.getIndex()] || p_175969_1_.field_175966_c[EnumFacing.SOUTH.getIndex()] || p_175969_1_.field_175966_c[EnumFacing.UP.getIndex()])) {
                return true;
            }
            return false;
        }
        ...
        FitSimpleRoomTopHelper(SwitchEnumFacing p_i45600_1_) {
            this();
        }
    }
    ...
    extends Piece {
        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
            ...
            block3 : for (RoomDefinition var8 : var5) {
                if (var8.field_175963_d || var8.func_175961_b()) continue;
                for (MonumentRoomFitHelper var10 : var6) {
                    if (!var10.func_175969_a(var8)) continue;
            ...
            for (Piece var11 : this.field_175843_q) {
            ...
            this.field_175843_q.add(new WingRoom(this.coordBaseMode, var18, var13++));
            this.field_175843_q.add(new WingRoom(this.coordBaseMode, var19, var13++));
            this.field_175843_q.add(new Penthouse(this.coordBaseMode, var12));
        }
        ...
        private List func_175836_a(Random p_175836_1_) {
            ...
            while (var3 < 5) {
                ...
                while (var4 < 4) {
                    var5 = 0;
                    var6 = MonumentBuilding.func_175820_a(var3, var5, var4);
            ...
            while (var3 < 5) {
                ...
                while (var4 < 5) {
                    int var17 = 0;
                    while (var17 < 3) {
                        var6 = MonumentBuilding.func_175820_a(var3, var17, var4);
                        if (var2[var6] != null) {
                            ...
                            while (var9 < var8) {
                                ...
                                if (var11 >= 0 && var11 < 5 && var13 >= 0 && var13 < 5 && var12 >= 0 && var12 < 3 && var2[var14 = MonumentBuilding.func_175820_a(var11, var12, var13)] != null) {
                                    if (var13 != var4) {
            ...
            RoomDefinition var16 = new RoomDefinition(1001);
            var2[field_175832_i].func_175957_a(EnumFacing.SOUTH, var16);
            ...
            this.field_175844_p = var2[MonumentBuilding.func_175820_a(p_175836_1_.nextInt(4), 0, 2)];
            ...
            var9 = 0;
            while (var9 < var8) {
                RoomDefinition var24 = var20[var9];
                if (var24 != null) {
                    var24.func_175958_a();
                    var19.add(var24);
                }
            ...
            int var21 = 1;
            for (RoomDefinition var23 : var19) {
                int var25 = 0;
                var11 = 0;
                while (var25 < 2 && var11 < 5) {
                    ++var11;
                    var12 = p_175836_1_.nextInt(6);
                    if (!var23.field_175966_c[var12]) continue;
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            for (Piece var11 : this.field_175843_q) {
                if (!var11.getBoundingBox().intersectsWith(p_74875_3_)) continue;
    ...
    extends StructureComponent {
        ...
        protected void func_175819_a(World worldIn, StructureBoundingBox p_175819_2_, int p_175819_3_, int p_175819_4_, int p_175819_5_, int p_175819_6_, int p_175819_7_, int p_175819_8_, IBlockState p_175819_9_) {
            int var10 = p_175819_4_;
            while (var10 <= p_175819_7_) {
                int var11 = p_175819_3_;
                while (var11 <= p_175819_6_) {
                    int var12 = p_175819_5_;
                    while (var12 <= p_175819_8_) {
        ...
        protected boolean func_175817_a(World worldIn, StructureBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_) {
            ...
            if (p_175817_2_.func_175898_b(new BlockPos(var6, var7 = this.getYWithOffset(p_175817_4_), var8 = this.getZWithOffset(p_175817_3_, p_175817_5_)))) {
                EntityGuardian var9 = new EntityGuardian(worldIn);
                var9.func_175467_a(true);
                var9.heal(var9.getMaxHealth());
                var9.setLocationAndAngles((double)var6 + 0.5, var7, (double)var8 + 0.5, 0.0f, 0.0f);
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            boolean bl = var4 = this.field_175833_o != 0 && p_74875_2_.nextBoolean() && !this.field_175830_k.field_175966_c[EnumFacing.DOWN.getIndex()] && !this.field_175830_k.field_175966_c[EnumFacing.UP.getIndex()] && this.field_175830_k.func_175960_c() > 1;
    ...
    implements MonumentRoomFitHelper {
        ...
        @Override
        public boolean func_175969_a(RoomDefinition p_175969_1_) {
            if (p_175969_1_.field_175966_c[EnumFacing.EAST.getIndex()] && !p_175969_1_.field_175965_b[EnumFacing.EAST.getIndex()].field_175963_d) {
                return true;
            }
            return false;
        }
        ...
        XDoubleRoomFitHelper(SwitchEnumFacing p_i45606_1_) {
            this();
        }
    }
    ...
    implements MonumentRoomFitHelper {
        ...
        public boolean func_175969_a(RoomDefinition p_175969_1_) {
            if (p_175969_1_.field_175966_c[EnumFacing.EAST.getIndex()] && !p_175969_1_.field_175965_b[EnumFacing.EAST.getIndex()].field_175963_d && p_175969_1_.field_175966_c[EnumFacing.UP.getIndex()] && !p_175969_1_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d) {
                RoomDefinition var2 = p_175969_1_.field_175965_b[EnumFacing.EAST.getIndex()];
                if (var2.field_175966_c[EnumFacing.UP.getIndex()] && !var2.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d) {
                    return true;
                }
                return false;
            }
        ...
        XYDoubleRoomFitHelper(SwitchEnumFacing p_i45605_1_) {
            this();
        }
    }
    ...
    implements MonumentRoomFitHelper {
        ...
        @Override
        public boolean func_175969_a(RoomDefinition p_175969_1_) {
            if (p_175969_1_.field_175966_c[EnumFacing.UP.getIndex()] && !p_175969_1_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d) {
                return true;
            }
            return false;
        }
        ...
        YDoubleRoomFitHelper(SwitchEnumFacing p_i45604_1_) {
            this();
        }
    }
    ...
    implements MonumentRoomFitHelper {
        ...
        public boolean func_175969_a(RoomDefinition p_175969_1_) {
            if (p_175969_1_.field_175966_c[EnumFacing.NORTH.getIndex()] && !p_175969_1_.field_175965_b[EnumFacing.NORTH.getIndex()].field_175963_d && p_175969_1_.field_175966_c[EnumFacing.UP.getIndex()] && !p_175969_1_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d) {
                RoomDefinition var2 = p_175969_1_.field_175965_b[EnumFacing.NORTH.getIndex()];
                if (var2.field_175966_c[EnumFacing.UP.getIndex()] && !var2.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d) {
                    return true;
                }
                return false;
        ...
        YZDoubleRoomFitHelper(SwitchEnumFacing p_i45603_1_) {
            this();
        }
    }
    ...
    implements MonumentRoomFitHelper {
        ...
        @Override
        public boolean func_175969_a(RoomDefinition p_175969_1_) {
            if (p_175969_1_.field_175966_c[EnumFacing.NORTH.getIndex()] && !p_175969_1_.field_175965_b[EnumFacing.NORTH.getIndex()].field_175963_d) {
                return true;
            }
            return false;
        }
        ...
        ZDoubleRoomFitHelper(SwitchEnumFacing p_i45602_1_) {
            this();
        }
    }
