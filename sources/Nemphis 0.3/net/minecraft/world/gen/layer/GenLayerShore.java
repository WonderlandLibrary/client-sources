        ...
        while (var7 < areaHeight) {
            ...
            while (var8 < areaWidth) {
                ...
                if (var9 == BiomeGenBase.mushroomIsland.biomeID) {
                    ...
                    var6[var8 + var7 * areaWidth] = var11 != BiomeGenBase.ocean.biomeID && var12 != BiomeGenBase.ocean.biomeID && var13 != BiomeGenBase.ocean.biomeID && var14 != BiomeGenBase.ocean.biomeID ? var9 : BiomeGenBase.mushroomIslandShore.biomeID;
                } else if (var10 != null && var10.getBiomeClass() == BiomeGenJungle.class) {
                    var11 = var5[var8 + 1 + (var7 + 1 - 1) * (areaWidth + 2)];
                    var12 = var5[var8 + 1 + 1 + (var7 + 1) * (areaWidth + 2)];
                    var13 = var5[var8 + 1 - 1 + (var7 + 1) * (areaWidth + 2)];
                    var14 = var5[var8 + 1 + (var7 + 1 + 1) * (areaWidth + 2)];
                    var6[var8 + var7 * areaWidth] = this.func_151631_c(var11) && this.func_151631_c(var12) && this.func_151631_c(var13) && this.func_151631_c(var14) ? (!(GenLayerShore.isBiomeOceanic(var11) || GenLayerShore.isBiomeOceanic(var12) || GenLayerShore.isBiomeOceanic(var13) || GenLayerShore.isBiomeOceanic(var14)) ? var9 : BiomeGenBase.beach.biomeID) : BiomeGenBase.jungleEdge.biomeID;
                    ...
                    if (var10 != null && var10.isSnowyBiome()) {
                        ...
                        if (var9 != BiomeGenBase.ocean.biomeID && var9 != BiomeGenBase.deepOcean.biomeID && var9 != BiomeGenBase.river.biomeID && var9 != BiomeGenBase.swampland.biomeID) {
                            ...
                            var13 = var5[var8 + 1 - 1 + (var7 + 1) * (areaWidth + 2)];
                            var14 = var5[var8 + 1 + (var7 + 1 + 1) * (areaWidth + 2)];
                            var6[var8 + var7 * areaWidth] = !(GenLayerShore.isBiomeOceanic(var11) || GenLayerShore.isBiomeOceanic(var12) || GenLayerShore.isBiomeOceanic(var13) || GenLayerShore.isBiomeOceanic(var14)) ? var9 : BiomeGenBase.beach.biomeID;
                        } else {
                        ...
                        var13 = var5[var8 + 1 - 1 + (var7 + 1) * (areaWidth + 2)];
                        var14 = var5[var8 + 1 + (var7 + 1 + 1) * (areaWidth + 2)];
                        var6[var8 + var7 * areaWidth] = !(GenLayerShore.isBiomeOceanic(var11) || GenLayerShore.isBiomeOceanic(var12) || GenLayerShore.isBiomeOceanic(var13) || GenLayerShore.isBiomeOceanic(var14)) ? (this.func_151633_d(var11) && this.func_151633_d(var12) && this.func_151633_d(var13) && this.func_151633_d(var14) ? var9 : BiomeGenBase.desert.biomeID) : var9;
                    }
                } else {
