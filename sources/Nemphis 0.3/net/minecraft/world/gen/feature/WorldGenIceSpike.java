            ...
            while (var9 <= var8) {
                ...
                while (var11 <= var8) {
                    ...
                    if ((var9 == 0 && var11 == 0 || var10 * var10 + var12 * var12 <= var7 * var7) && (var9 != - var8 && var9 != var8 && var11 != - var8 && var11 != var8 || p_180709_2_.nextFloat() <= 0.75f)) {
                        ...
                        if (var6 != 0 && var8 > 1 && ((var13 = worldIn.getBlockState(p_180709_3_.add(var9, - var6, var11)).getBlock()).getMaterial() == Material.air || var13 == Blocks.dirt || var13 == Blocks.snow || var13 == Blocks.ice)) {
                            this.func_175906_a(worldIn, p_180709_3_.add(var9, - var6, var11), Blocks.packed_ice);
                        }
                    }
                    ++var11;
