...
extends WorldGenAbstractTree {
        ...
        while (var3 >= 0) {
            ...
            if (var4 >= 0.0f) {
                ...
                while (var5 < var1) {
                    ...
                    double var10 = var6 * Math.sin(var8 = (double)(this.field_175949_k.nextFloat() * 2.0f) * 3.141592653589793) + 0.5;
                    BlockPos var14 = this.field_175947_m.add(var10, (double)(var3 - 1), var12 = var6 * Math.cos(var8) + 0.5);
                    if (this.func_175936_a(var14, var15 = var14.offsetUp(this.leafDistanceLimit)) == -1) {
    ...
    void func_180712_a(BlockPos p_180712_1_, float p_180712_2_, Block p_180712_3_) {
        ...
        while (var5 <= var4) {
            ...
            while (var6 <= var4) {
                Material var8;
                BlockPos var7;
                if (Math.pow((double)Math.abs(var5) + 0.5, 2.0) + Math.pow((double)Math.abs(var6) + 0.5, 2.0) <= (double)(p_180712_2_ * p_180712_2_) && ((var8 = this.field_175946_l.getBlockState(var7 = p_180712_1_.add(var5, 0, var6)).getBlock().getMaterial()) == Material.air || var8 == Material.leaves)) {
    ...
    void func_175940_a(BlockPos p_175940_1_) {
        int var2 = 0;
        while (var2 < this.leafDistanceLimit) {
    ...
    boolean leafNodeNeedsBase(int p_76493_1_) {
        if ((double)p_76493_1_ >= (double)this.heightLimit * 0.2) {
            return true;
        }
        return false;
    }
