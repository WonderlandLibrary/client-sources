...
public class WorldBorder {
    ...
    public WorldBorder() {
        this.endDiameter = this.startDiameter = 6.0E7;
    ...
    public boolean contains(BlockPos pos) {
        if ((double)(pos.getX() + 1) > this.minX() && (double)pos.getX() < this.maxX() && (double)(pos.getZ() + 1) > this.minZ() && (double)pos.getZ() < this.maxZ()) {
            return true;
        }
        return false;
    }
    ...
    public boolean contains(ChunkCoordIntPair range) {
        if ((double)range.getXEnd() > this.minX() && (double)range.getXStart() < this.maxX() && (double)range.getZEnd() > this.minZ() && (double)range.getZStart() < this.maxZ()) {
            return true;
        }
        return false;
    }
    ...
    public boolean contains(AxisAlignedBB bb) {
        if (bb.maxX > this.minX() && bb.minX < this.maxX() && bb.maxZ > this.minZ() && bb.minZ < this.maxZ()) {
            return true;
        }
        return false;
    }
    ...
    public long getTimeUntilTarget() {
        return this.getStatus() != EnumBorderStatus.STATIONARY ? this.endTime - System.currentTimeMillis() : 0;
    }
