...
public class JsonToNBT {
    ...
    static /* varargs */ Any func_179272_a(String ... p_179272_0_) throws NBTException {
    ...
    private static boolean func_179271_b(String p_179271_0_, int p_179271_1_) {
        if (p_179271_1_ > 0 && p_179271_0_.charAt(p_179271_1_ - 1) == '\\' && !JsonToNBT.func_179271_b(p_179271_0_, p_179271_1_ - 1)) {
            return true;
        }
        return false;
    }
        ...
        public NBTBase func_150489_a() {
            try {
                ...
                if (this.field_150493_b.equalsIgnoreCase("true") || this.field_150493_b.equalsIgnoreCase("false")) {
                    return new NBTTagByte(Boolean.parseBoolean(this.field_150493_b) ? 1 : 0);
                }
            }
            ...
            int var2 = 0;
            while (var2 < this.field_150493_b.length()) {
