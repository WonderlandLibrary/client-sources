...
public class StatFileWriter {
    ...
    public boolean hasAchievementUnlocked(Achievement p_77443_1_) {
        if (this.writeStat(p_77443_1_) > 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean canUnlockAchievement(Achievement p_77442_1_) {
        if (p_77442_1_.parentAchievement != null && !this.hasAchievementUnlocked(p_77442_1_.parentAchievement)) {
            return false;
        }
        return true;
    }
    ...
    public int func_150874_c(Achievement p_150874_1_) {
        ...
        int var2 = 0;
        Achievement var3 = p_150874_1_.parentAchievement;
        while (var3 != null && !this.hasAchievementUnlocked(var3)) {
