...
extends EntityLivingBase {
    ...
    public EntityItem func_146097_a(ItemStack p_146097_1_, boolean p_146097_2_, boolean p_146097_3_) {
        ...
        double var4 = this.posY - 0.30000001192092896 + (double)this.getEyeHeight();
        ...
        if (targetEntity.canAttackWithItem() && !targetEntity.hitByEntity(this)) {
            ...
            if (var2 > 0.0f || var4 > 0.0f) {
                ...
                if (var14) {
                    ...
                    if (var18 > 0) {
                        targetEntity.addVelocity((- MathHelper.sin(this.rotationYaw * 3.1415927f / 180.0f)) * (float)var18 * 0.5f, 0.1, MathHelper.cos(this.rotationYaw * 3.1415927f / 180.0f) * (float)var18 * 0.5f);
                        this.motionX *= 0.6;
                        this.motionZ *= 0.6;
    ...
    public boolean canEat(boolean p_71043_1_) {
        if ((p_71043_1_ || this.foodStats.needFood()) && !this.capabilities.disableDamage) {
            return true;
        }
        return false;
    }
    ...
    public boolean func_175151_a(BlockPos p_175151_1_, EnumFacing p_175151_2_, ItemStack p_175151_3_) {
        ...
        if (!p_175151_3_.canPlaceOn(var5) && !p_175151_3_.canEditBlocks()) {
            return false;
        }
        return true;
    }
    ...
    public boolean isInvisibleToPlayer(EntityPlayer playerIn) {
        ...
        Team var2 = this.getTeam();
        if (var2 != null && playerIn != null && playerIn.getTeam() == var2 && var2.func_98297_h()) {
            return false;
        }
        return true;
    }
    ...
    public boolean func_175148_a(EnumPlayerModelParts p_175148_1_) {
        if ((this.getDataWatcher().getWatchableObjectByte(10) & p_175148_1_.func_179327_a()) == p_175148_1_.func_179327_a()) {
            return true;
        }
        return false;
    }
    ...
    public static enum EnumStatus {
        ...
        private EnumStatus(String p_i1751_1_, int p_i1751_2_, String string2, int n2) {
        }
    }
