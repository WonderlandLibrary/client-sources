...
public enum EnumPlayerModelParts {
    ...
    static {
        $VALUES = new EnumPlayerModelParts[]{CAPE, JACKET, LEFT_SLEEVE, RIGHT_SLEEVE, LEFT_PANTS_LEG, RIGHT_PANTS_LEG, HAT};
    }

    private EnumPlayerModelParts(String p_i45809_1_, int p_i45809_2_, String p_i45809_3_, int p_i45809_4_, int n2, String string2) {
        this.field_179340_h = p_i45809_3_;
        this.field_179341_i = true << p_i45809_3_;
        this.field_179338_j = (String)p_i45809_4_;
        this.field_179339_k = new ChatComponentTranslation("options.modelPart." + (String)p_i45809_4_, new Object[0]);
    }
