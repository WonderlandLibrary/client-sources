...
implements IProjectile {
    ...
    public void setThrowableHeading(double p_70186_1_, double p_70186_3_, double p_70186_5_, float p_70186_7_, float p_70186_8_) {
        ...
        p_70186_1_ += this.rand.nextGaussian() * 0.007499999832361937 * (double)p_70186_8_;
        p_70186_3_ += this.rand.nextGaussian() * 0.007499999832361937 * (double)p_70186_8_;
        p_70186_5_ += this.rand.nextGaussian() * 0.007499999832361937 * (double)p_70186_8_;
        ...
        if (!this.worldObj.isRemote) {
            ...
            while (var9 < var5.size()) {
                ...
                if (var10.canBeCollidedWith() && (var10 != var8 || this.ticksInAir >= 5)) {
                    ...
                    if (var13 != null && ((var14 = var1.distanceTo(var13.hitVec)) < var6 || var6 == 0.0)) {
                        var4 = var10;
                        var6 = var14;
                    }
                }
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        tagCompound.setByte("inGround", this.field_174854_a ? 1 : 0);
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        this.field_174853_f = tagCompund.hasKey("inTile", 8) ? Block.getBlockFromName(tagCompund.getString("inTile")) : Block.getBlockById(tagCompund.getByte("inTile") & 255);
