...
extends Entity {
    ...
    public EntityFireball(World worldIn, EntityLivingBase p_i1761_2_, double p_i1761_3_, double p_i1761_5_, double p_i1761_7_) {
        ...
        this.motionY = 0.0;
        this.motionX = 0.0;
        double var9 = MathHelper.sqrt_double(p_i1761_3_ * (p_i1761_3_ += this.rand.nextGaussian() * 0.4) + p_i1761_5_ * (p_i1761_5_ += this.rand.nextGaussian() * 0.4) + p_i1761_7_ * (p_i1761_7_ += this.rand.nextGaussian() * 0.4));
        ...
        if (!this.worldObj.isRemote && (this.shootingEntity != null && this.shootingEntity.isDead || !this.worldObj.isBlockLoaded(new BlockPos(this)))) {
            ...
            while (var8 < var5.size()) {
                ...
                if (var9.canBeCollidedWith() && (!var9.isEntityEqual(this.shootingEntity) || this.ticksInAir >= 25)) {
                    ...
                    if (var12 != null && ((var13 = var1.distanceTo(var12.hitVec)) < var6 || var6 == 0.0)) {
                        var4 = var9;
                        var6 = var13;
                    }
                }
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        this.field_145796_h = tagCompund.hasKey("inTile", 8) ? Block.getBlockFromName(tagCompund.getString("inTile")) : Block.getBlockById(tagCompund.getByte("inTile") & 255);
