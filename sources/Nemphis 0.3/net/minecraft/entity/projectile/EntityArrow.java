...
implements IProjectile {
    ...
    public EntityArrow(World worldIn, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_) {
        ...
        this.posY = p_i1755_2_.posY + (double)p_i1755_2_.getEyeHeight() - 0.10000000149011612;
        ...
        if (var12 >= 1.0E-7) {
            ...
            float var20 = (float)(var12 * 0.20000000298023224);
    ...
    public void setThrowableHeading(double p_70186_1_, double p_70186_3_, double p_70186_5_, float p_70186_7_, float p_70186_8_) {
        ...
        p_70186_1_ += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.007499999832361937 * (double)p_70186_8_;
        p_70186_3_ += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.007499999832361937 * (double)p_70186_8_;
        p_70186_5_ += this.rand.nextGaussian() * (double)(this.rand.nextBoolean() ? -1 : 1) * 0.007499999832361937 * (double)p_70186_8_;
        ...
        this.prevRotationYaw = this.rotationYaw = (float)(Math.atan2(p_70186_1_, p_70186_5_) * 180.0 / 3.141592653589793);
        this.prevRotationPitch = this.rotationPitch = (float)(Math.atan2(p_70186_3_, var10) * 180.0 / 3.141592653589793);
    ...
    public void setVelocity(double x, double y, double z) {
        ...
        if (this.prevRotationPitch == 0.0f && this.prevRotationYaw == 0.0f) {
            ...
            this.prevRotationPitch = this.rotationPitch = (float)(Math.atan2(y, var7) * 180.0 / 3.141592653589793);
        ...
        if (this.inGround) {
            ...
            while (var11 < var8.size()) {
                ...
                if (var12.canBeCollidedWith() && (var12 != this.shootingEntity || this.ticksInAir >= 5)) {
                    ...
                    if (var15 != null && ((var16 = var19.distanceTo(var15.hitVec)) < var9 || var9 == 0.0)) {
                        var7 = var12;
                        var9 = var16;
                    }
                }
            ...
            if (var6 != null) {
                if (var6.entityHit != null) {
                    ...
                    if (var6.entityHit.attackEntityFrom(var26, var24)) {
                        if (var6.entityHit instanceof EntityLivingBase) {
                            ...
                            if (this.knockbackStrength > 0 && (var29 = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ)) > 0.0f) {
                                var6.entityHit.addVelocity(this.motionX * (double)this.knockbackStrength * 0.6000000238418579 / (double)var29, 0.1, this.motionZ * (double)this.knockbackStrength * 0.6000000238418579 / (double)var29);
                            }
                    ...
                    this.posX -= this.motionX / (double)var25 * 0.05000000074505806;
                    this.posY -= this.motionY / (double)var25 * 0.05000000074505806;
                    this.posZ -= this.motionZ / (double)var25 * 0.05000000074505806;
                    this.playSound("random.bowhit", 1.0f, 1.2f / (this.rand.nextFloat() * 0.2f + 0.9f));
                    this.inGround = true;
                    this.arrowShake = 7;
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        tagCompound.setByte("inGround", this.inGround ? 1 : 0);
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        this.field_145790_g = tagCompund.hasKey("inTile", 8) ? Block.getBlockFromName(tagCompund.getString("inTile")) : Block.getBlockById(tagCompund.getByte("inTile") & 255);
