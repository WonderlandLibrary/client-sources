...
IMerchant {
    ...
    private InventoryBasic field_175560_bz = new InventoryBasic("Items", false, 8);
            ...
            if (this.timeUntilReset <= 0) {
                if (this.needsInitilization) {
                    for (MerchantRecipe var4 : this.buyingList) {
                        if (!var4.isRecipeDisabled()) continue;
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        int var3 = 0;
        while (var3 < this.field_175560_bz.getSizeInventory()) {
    ...
    private void func_175554_cu() {
        ...
        int var2;
        ITradeList[][] var4;
        ITradeList[][][] var1 = field_175561_bA[this.getProfession()];
        ...
        if ((var3 = this.field_175562_bw - 1) < (var4 = var1[var2 = this.field_175563_bv - 1]).length) {
            ITradeList[] var5;
            ITradeList[] var6 = var5 = var4[var3];
    ...
    private void func_180489_a(EnumParticleTypes p_180489_1_) {
        ...
        while (var2 < 5) {
            ...
            this.worldObj.spawnParticle(p_180489_1_, this.posX + (double)(this.rand.nextFloat() * this.width * 2.0f) - (double)this.width, this.posY + 1.0 + (double)(this.rand.nextFloat() * this.height), this.posZ + (double)(this.rand.nextFloat() * this.width * 2.0f) - (double)this.width, var3, var5, var7, new int[0]);
            ++var2;
        }
    }
    ...
    private boolean func_175558_a(Item p_175558_1_) {
        if (p_175558_1_ != Items.bread && p_175558_1_ != Items.potato && p_175558_1_ != Items.carrot && p_175558_1_ != Items.wheat && p_175558_1_ != Items.wheat_seeds) {
            return false;
        }
        return true;
    }
    ...
    public boolean func_175557_cr() {
        boolean var1;
        boolean bl = var1 = this.getProfession() == 0;
    ...
    public boolean func_175556_cs() {
        int var1 = 0;
        while (var1 < this.field_175560_bz.getSizeInventory()) {
    ...
    implements ITradeList {
        ...
        public EmeraldForItems(Item p_i45815_1_, PriceInfo p_i45815_2_) {
    ...
    implements ITradeList {
        ...
        public ListItemForEmeralds(Item p_i45811_1_, PriceInfo p_i45811_2_) {
            this.field_179403_a = new ItemStack(p_i45811_1_);
            this.field_179402_b = p_i45811_2_;
        }

        public ListItemForEmeralds(ItemStack p_i45812_1_, PriceInfo p_i45812_2_) {
    ...
    extends Tuple {
        ...
        public int func_179412_a(Random p_179412_1_) {
            return (Integer)this.getFirst() >= (Integer)this.getSecond() ? (Integer)this.getFirst() : (Integer)this.getFirst() + p_179412_1_.nextInt((Integer)this.getSecond() - (Integer)this.getFirst() + 1);
        }
    }
