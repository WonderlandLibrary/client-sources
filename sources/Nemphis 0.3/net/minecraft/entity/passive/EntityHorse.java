...
implements IInvBasic {
    private static final Predicate horseBreedingSelector = new Predicate(){
        ...
        public boolean func_179873_a(Entity p_179873_1_) {
            if (p_179873_1_ instanceof EntityHorse && ((EntityHorse)p_179873_1_).func_110205_ce()) {
                return true;
            }
            return false;
        }
    ...
    private boolean getHorseWatchableBoolean(int p_110233_1_) {
        if ((this.dataWatcher.getWatchableObjectInt(16) & p_110233_1_) != 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean isSterile() {
        if (!this.isUndead() && this.getHorseType() != 2) {
            return false;
        }
        return true;
    }
    ...
    private void dropItemsInChest(Entity p_110240_1_, AnimalChest p_110240_2_) {
        if (p_110240_2_ != null && !this.worldObj.isRemote) {
            int var3 = 0;
            while (var3 < p_110240_2_.getSizeInventory()) {
    ...
    public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_) {
        ...
        if (p_180482_2_1 instanceof GroupData) {
            ...
            var4 = ((GroupData)p_180482_2_1).field_111106_b & 255 | this.rand.nextInt(5) << 8;
        } else {
