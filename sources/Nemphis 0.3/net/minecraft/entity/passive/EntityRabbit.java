...
extends EntityAnimal {
    ...
    public void onLivingUpdate() {
        ...
        if (this.field_175540_bm != this.field_175535_bn) {
            if (this.field_175540_bm == 0 && !this.worldObj.isRemote) {
                this.worldObj.setEntityState(this, 1);
            }
    ...
    private boolean func_175525_a(Item p_175525_1_) {
        if (p_175525_1_ != Items.carrot && p_175525_1_ != Items.golden_carrot && p_175525_1_ != Item.getItemFromBlock(Blocks.yellow_flower)) {
            return false;
        }
        return true;
    }
    ...
    public boolean isBreedingItem(ItemStack p_70877_1_) {
        if (p_70877_1_ != null && this.func_175525_a(p_70877_1_.getItem())) {
            return true;
        }
        return false;
    }
    ...
    static enum EnumMoveType {
        ...
        private EnumMoveType(String p_i45866_1_, int p_i45866_2_, String p_i45866_3_, int p_i45866_4_, float p_i45866_5_, float p_i45866_6_, int n2, int n3) {
            this.field_180076_f = p_i45866_3_;
            this.field_180077_g = p_i45866_4_;
            this.field_180084_h = (int)p_i45866_5_;
            this.field_180085_i = (int)p_i45866_6_;
        }
