...
implements ICommandSender {
    ...
    public Entity(World worldIn) {
        ...
        this.dataWatcher.addObject(3, Byte.valueOf(0));
        this.dataWatcher.addObject(2, "");
        this.dataWatcher.addObject(4, Byte.valueOf(0));
        this.entityInit();
    }
    ...
    private boolean func_174809_b(AxisAlignedBB p_174809_1_) {
        if (this.worldObj.getCollidingBoundingBoxes(this, p_174809_1_).isEmpty() && !this.worldObj.isAnyLiquid(p_174809_1_)) {
            return true;
        }
        return false;
    }
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            for (AxisAlignedBB var242 : var53) {
                x = var242.calculateXOffset(this.getEntityBoundingBox(), x);
            }
            this.func_174826_a(this.getEntityBoundingBox().offset(x, 0.0, 0.0));
            for (AxisAlignedBB var242 : var53) {
                z = var242.calculateZOffset(this.getEntityBoundingBox(), z);
            }
    ...
    public boolean isSlient() {
        if (this.dataWatcher.getWatchableObjectByte(4) == 1) {
            return true;
        }
        return false;
    }
    ...
    public void func_174810_b(boolean p_174810_1_) {
        this.dataWatcher.updateObject(4, Byte.valueOf(p_174810_1_ ? 1 : 0));
    }
    ...
    public boolean isWet() {
        if (!(this.inWater || this.worldObj.func_175727_C(new BlockPos(this.posX, this.posY, this.posZ)) || this.worldObj.func_175727_C(new BlockPos(this.posX, this.posY + (double)this.height, this.posZ)))) {
            return false;
        }
        return true;
    }
    ...
    protected /* varargs */ NBTTagList newDoubleNBTList(double ... numbers) {
    ...
    protected /* varargs */ NBTTagList newFloatNBTList(float ... numbers) {
        NBTTagList var2 = new NBTTagList();
        float[] var3 = numbers;
        int var4 = numbers.length;
        int var5 = 0;
    ...
    protected boolean getFlag(int flag) {
        if ((this.dataWatcher.getWatchableObjectByte(0) & 1 << flag) != 0) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        arrobject[1] = this.getName();
        arrobject[2] = this.entityId;
    ...
    public boolean func_180431_b(DamageSource p_180431_1_) {
        if (this.invulnerable && p_180431_1_ != DamageSource.outOfWorld && !p_180431_1_.func_180136_u()) {
            return true;
        }
        return false;
    }
    ...
    public boolean hasCustomName() {
        if (this.dataWatcher.getWatchableObjectString(2).length() > 0) {
            return true;
        }
        return false;
    }
    ...
    public void setAlwaysRenderNameTag(boolean p_174805_1_) {
        this.dataWatcher.updateObject(3, Byte.valueOf(p_174805_1_ ? 1 : 0));
    }

    public boolean getAlwaysRenderNameTag() {
        if (this.dataWatcher.getWatchableObjectByte(3) == 1) {
            return true;
        }
        return false;
    }
