...
extends EntityAIBase {
    ...
    public static boolean func_179445_a(EntityLiving p_179445_0_, EntityLivingBase p_179445_1_, boolean p_179445_2_, boolean p_179445_3_) {
        ...
        if (p_179445_0_ instanceof IEntityOwnable && StringUtils.isNotEmpty((CharSequence)((IEntityOwnable)((Object)p_179445_0_)).func_152113_b())) {
            if (p_179445_1_ instanceof IEntityOwnable && ((IEntityOwnable)((Object)p_179445_0_)).func_152113_b().equals(((IEntityOwnable)((Object)p_179445_1_)).func_152113_b())) {
                return false;
            }
            if (p_179445_1_ == ((IEntityOwnable)((Object)p_179445_0_)).getOwner()) {
                return false;
            }
        } else if (p_179445_1_ instanceof EntityPlayer && !p_179445_2_ && ((EntityPlayer)p_179445_1_).capabilities.disableDamage) {
            return false;
        }
        if (p_179445_3_ && !p_179445_0_.getEntitySenses().canSee(p_179445_1_)) {
            return false;
        }
        return true;
    }
    ...
    protected boolean isSuitableTarget(EntityLivingBase p_75296_1_, boolean p_75296_2_) {
        if (!EntityAITarget.func_179445_a(this.taskOwner, p_75296_1_, p_75296_2_, this.shouldCheckSight)) {
            return false;
        }
    ...
    private boolean canEasilyReach(EntityLivingBase p_75295_1_) {
        ...
        if ((double)(var4 * var4 + (var5 = var3.zCoord - MathHelper.floor_double(p_75295_1_.posZ)) * var5) <= 2.25) {
            return true;
        }
        return false;
    }
