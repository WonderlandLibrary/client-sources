...
extends EntityMob {
    ...
    public void setChild(boolean p_82227_1_) {
        this.getDataWatcher().updateObject(12, Byte.valueOf(p_82227_1_ ? 1 : 0));
    ...
    public void setVillager(boolean p_82229_1_) {
        this.getDataWatcher().updateObject(13, Byte.valueOf(p_82229_1_ ? 1 : 0));
    }
        ...
        if (super.attackEntityFrom(source, amount)) {
            ...
            if (var3 != null && this.worldObj.getDifficulty() == EnumDifficulty.HARD && (double)this.rand.nextFloat() < this.getEntityAttribute(field_110186_bp).getAttributeValue()) {
                ...
                while (var8 < 50) {
                    ...
                    if (World.doesBlockHaveSolidTopSurface(this.worldObj, new BlockPos(var9, (var10 = var5 + MathHelper.getRandomIntegerInRange(this.rand, 7, 40) * MathHelper.getRandomIntegerInRange(this.rand, -1, 1)) - 1, var11 = var6 + MathHelper.getRandomIntegerInRange(this.rand, 7, 40) * MathHelper.getRandomIntegerInRange(this.rand, -1, 1))) && this.worldObj.getLightFromNeighbors(new BlockPos(var9, var10, var11)) < 10) {
