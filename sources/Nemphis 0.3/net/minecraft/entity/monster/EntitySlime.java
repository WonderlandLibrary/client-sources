...
implements IMob {
    ...
    extends EntityAIBase {
        ...
        public boolean continueExecuting() {
            EntityLivingBase var1 = this.field_179466_a.getAttackTarget();
            boolean bl = var1 == null ? false : (!var1.isEntityAlive() ? false : --this.field_179465_b > 0);
            return bl;
        }
    ...
    extends EntityAIBase {
        ...
        @Override
        public boolean shouldExecute() {
            if (this.field_179461_a.getAttackTarget() == null && (this.field_179461_a.onGround || this.field_179461_a.isInWater() || this.field_179461_a.func_180799_ab())) {
                return true;
            }
            return false;
        }
    ...
    extends EntityAIBase {
        ...
        @Override
        public boolean shouldExecute() {
            if (!this.field_179457_a.isInWater() && !this.field_179457_a.func_180799_ab()) {
                return false;
            }
            return true;
        }
