...
extends EntityMob {
    ...
    private boolean func_175468_a(int p_175468_1_) {
        if ((this.dataWatcher.getWatchableObjectInt(16) & p_175468_1_) != 0) {
            return true;
        }
        return false;
    }
        ...
        if (this.worldObj.isRemote) {
            ...
            if (this.func_175474_cn()) {
                ...
                if ((var14 = this.func_175466_co()) != null) {
                    ...
                    while (var12 < var10) {
                        this.worldObj.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX + var4 * var12, this.posY + var6 * var12 + (double)this.getEyeHeight(), this.posZ + var8 * (var12 += 1.8 - var15 + this.rand.nextDouble() * (1.7 - var15)), 0.0, 0.0, 0.0, new int[0]);
                    }
                }
            }
        }
            ...
            if ((this.ticksExisted + this.getEntityId()) % 1200 == 0) {
                ...
                List var6 = this.worldObj.func_175661_b(EntityPlayerMP.class, new Predicate(){
                    ...
                    public boolean func_179913_a(EntityPlayerMP p_179913_1_) {
                        if (EntityGuardian.this.getDistanceSqToEntity(p_179913_1_) < 2500.0 && p_179913_1_.theItemInWorldManager.func_180239_c()) {
                            return true;
                        }
                        return false;
                    }
    ...
    public boolean getCanSpawnHere() {
        if ((this.rand.nextInt(20) == 0 || !this.worldObj.canBlockSeeSky(new BlockPos(this))) && super.getCanSpawnHere()) {
            return true;
        }
        return false;
    }
    ...
    extends EntityAIBase {
        ...
        public boolean continueExecuting() {
            if (super.continueExecuting() && (this.field_179456_a.func_175461_cl() || this.field_179456_a.getDistanceSqToEntity(this.field_179456_a.getAttackTarget()) > 9.0)) {
                return true;
            }
            return false;
        }
        ...
        public void updateTask() {
            ...
            if (!this.field_179456_a.canEntityBeSeen(var1)) {
                ...
                if (this.field_179455_b == 0) {
                    ...
                    this.field_179456_a.worldObj.setEntityState(this.field_179456_a, 21);
    ...
    implements Predicate {
        ...
        public boolean func_179915_a(EntityLivingBase p_179915_1_) {
            if ((p_179915_1_ instanceof EntityPlayer || p_179915_1_ instanceof EntitySquid) && p_179915_1_.getDistanceSqToEntity(this.field_179916_a) > 9.0) {
                return true;
            }
            return false;
        }
