...
extends EntityMob {
    ...
    private static final AttributeModifier attackingSpeedBoostModifier = new AttributeModifier(attackingSpeedBoostModifierUUID, "Attacking speed boost", 0.15000000596046448, 0).setSaved(false);
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        IBlockState var2 = tagCompund.hasKey("carried", 8) ? Block.getBlockFromName(tagCompund.getString("carried")).getStateFromMeta(tagCompund.getShort("carriedData") & 65535) : Block.getBlockById(tagCompund.getShort("carried")).getStateFromMeta(tagCompund.getShort("carriedData") & 65535);
    ...
    public void func_175490_a(IBlockState p_175490_1_) {
        this.dataWatcher.updateObject(16, (short)(Block.getStateId(p_175490_1_) & 65535));
    }
    ...
    public void setScreaming(boolean p_70819_1_) {
        this.dataWatcher.updateObject(18, Byte.valueOf(p_70819_1_ ? 1 : 0));
    }

    static /* synthetic */ void access$2(EntityEnderman entityEnderman, boolean bl) {
        entityEnderman.isAggressive = bl;
    }
