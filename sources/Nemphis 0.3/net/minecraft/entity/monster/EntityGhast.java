...
implements IMob {
    ...
    public void func_175454_a(boolean p_175454_1_) {
        this.dataWatcher.updateObject(16, Byte.valueOf(p_175454_1_ ? 1 : 0));
    }
    ...
    public boolean getCanSpawnHere() {
        if (this.rand.nextInt(20) == 0 && super.getCanSpawnHere() && this.worldObj.getDifficulty() != EnumDifficulty.PEACEFUL) {
            return true;
        }
        return false;
    }
    ...
    extends EntityAIBase {
        ...
        public boolean shouldExecute() {
            if (this.field_179470_b.getAttackTarget() != null) {
                return true;
            }
            return false;
        }
