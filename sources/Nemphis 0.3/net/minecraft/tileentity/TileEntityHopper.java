...
IUpdatePlayerListBox {
    ...
    public void writeToNBT(NBTTagCompound compound) {
        ...
        int var3 = 0;
        while (var3 < this.inventory.length) {
    ...
    private boolean func_145883_k() {
        ...
        int var3 = 0;
        while (var3 < this.getSizeInventory()) {
    ...
    public static boolean func_145891_a(IHopper p_145891_0_) {
        ...
        if (var1 != null) {
            ...
            if (var1 instanceof ISidedInventory) {
                ...
                int var5 = 0;
                while (var5 < var4.length) {
                    if (TileEntityHopper.func_174915_a(p_145891_0_, var1, var4[var5], var2)) {
                        return true;
                    }
                    ++var5;
                }
    ...
    public static ItemStack func_174918_a(IInventory p_174918_0_, ItemStack p_174918_1_, EnumFacing p_174918_2_) {
        if (p_174918_0_ instanceof ISidedInventory && p_174918_2_ != null) {
            ...
            int var5 = 0;
            while (var5 < var7.length && p_174918_1_ != null && p_174918_1_.stackSize > 0) {
            ...
            int var4 = 0;
            while (var4 < var3 && p_174918_1_ != null && p_174918_1_.stackSize > 0) {
    ...
    private static boolean func_174921_b(IInventory p_174921_0_, ItemStack p_174921_1_, int p_174921_2_, EnumFacing p_174921_3_) {
        if (p_174921_0_ instanceof ISidedInventory && !((ISidedInventory)p_174921_0_).canExtractItem(p_174921_2_, p_174921_1_, p_174921_3_)) {
            return false;
        }
        return true;
    }
    ...
    public void clearInventory() {
        int var1 = 0;
        while (var1 < this.inventory.length) {
