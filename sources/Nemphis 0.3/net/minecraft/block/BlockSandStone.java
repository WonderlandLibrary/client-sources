...
extends Block {
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(String p_i45686_1_, int p_i45686_2_, String p_i45686_3_, int p_i45686_4_, int p_i45686_5_, String string2, String string3) {
            this.field_176680_e = p_i45686_3_;
            this.field_176677_f = (String)p_i45686_4_;
            this.field_176678_g = (String)p_i45686_5_;
        }
