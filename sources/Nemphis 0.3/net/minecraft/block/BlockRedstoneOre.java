...
extends Block {
    ...
    private void spawnRedstoneParticles(World worldIn, BlockPos p_180691_2_) {
        ...
        while (var6 < 6) {
            ...
            if (var7 < (double)p_180691_2_.getX() || var7 > (double)(p_180691_2_.getX() + 1) || var9 < 0.0 || var9 > (double)(p_180691_2_.getY() + 1) || var11 < (double)p_180691_2_.getZ() || var11 > (double)(p_180691_2_.getZ() + 1)) {
