...
extends Block {
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(String p_i45673_1_, int p_i45673_2_, String p_i45673_3_, int p_i45673_4_, int p_i45673_5_, String string2, String string3) {
            this.field_176663_d = p_i45673_3_;
            this.field_176664_e = (String)p_i45673_4_;
            this.field_176661_f = (String)p_i45673_5_;
        }
