...
extends Block {
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(String p_i45680_1_, int p_i45680_2_, String p_i45680_3_, int p_i45680_4_, int n2, String string2) {
            this(string, n, p_i45680_1_, p_i45680_2_, (int)p_i45680_3_, (String)p_i45680_4_, (String)p_i45680_4_);
        }

        private EnumType(String p_i45681_1_, int p_i45681_2_, String p_i45681_3_, int p_i45681_4_, int p_i45681_5_, String string2, String string3) {
            this.meta = p_i45681_3_;
            this.name = (String)p_i45681_4_;
            this.field_176654_k = (String)p_i45681_5_;
        }
