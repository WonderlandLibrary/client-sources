...
implements IGrowable {
    ...
    public boolean canBlockStay(World worldIn, BlockPos p_180671_2_, IBlockState p_180671_3_) {
        if ((worldIn.getLight(p_180671_2_) >= 8 || worldIn.isAgainstSky(p_180671_2_)) && this.canPlaceBlockOn(worldIn.getBlockState(p_180671_2_.offsetDown()).getBlock())) {
            return true;
        }
        return false;
    }
    ...
    public boolean isStillGrowing(World worldIn, BlockPos p_176473_2_, IBlockState p_176473_3_, boolean p_176473_4_) {
        if ((Integer)p_176473_3_.getValue(AGE) < 7) {
            return true;
        }
        return false;
    }
