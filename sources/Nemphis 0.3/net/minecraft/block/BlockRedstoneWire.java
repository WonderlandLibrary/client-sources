...
extends Block {
    ...
    public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
        if (!World.doesBlockHaveSolidTopSurface(worldIn, pos.offsetDown()) && worldIn.getBlockState(pos.offsetDown()).getBlock() != Blocks.glowstone) {
            return false;
        }
        return true;
    }
    ...
    public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) {
        if (!worldIn.isRemote) {
            ...
            for (EnumFacing var522 : EnumFacing.Plane.VERTICAL) {
                worldIn.notifyNeighborsOfStateChange(pos.offset(var522), this);
            }
            for (EnumFacing var522 : EnumFacing.Plane.HORIZONTAL) {
                this.func_176344_d(worldIn, pos.offset(var522));
            }
            for (EnumFacing var522 : EnumFacing.Plane.HORIZONTAL) {
                BlockPos var6 = pos.offset(var522);
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        ...
        if (!worldIn.isRemote) {
            ...
            for (EnumFacing var92 : EnumFacing.Plane.HORIZONTAL) {
                this.func_176344_d(worldIn, pos.offset(var92));
            }
            for (EnumFacing var92 : EnumFacing.Plane.HORIZONTAL) {
                BlockPos var10 = pos.offset(var92);
    ...
    protected static boolean func_176343_a(IBlockState p_176343_0_, EnumFacing p_176343_1_) {
        ...
        if (Blocks.unpowered_repeater.func_149907_e(var2)) {
            ...
            if (var3 != p_176343_1_ && var3.getOpposite() != p_176343_1_) {
                return false;
            }
            return true;
        }
        if (var2.canProvidePower() && p_176343_1_ != null) {
            return true;
        }
        return false;
    }
    ...
    static enum EnumAttachPosition implements IStringSerializable
    {
        ...
        private EnumAttachPosition(String p_i45689_1_, int p_i45689_2_, String p_i45689_3_, int n2, String string2) {
