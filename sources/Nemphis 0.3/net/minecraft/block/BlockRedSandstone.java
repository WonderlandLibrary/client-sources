...
extends Block {
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(String p_i45690_1_, int p_i45690_2_, String p_i45690_3_, int p_i45690_4_, int p_i45690_5_, String string2, String string3) {
            this.field_176832_e = p_i45690_3_;
            this.field_176829_f = (String)p_i45690_4_;
            this.field_176830_g = (String)p_i45690_5_;
        }
