...
extends Block {
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(String p_i45679_1_, int p_i45679_2_, String p_i45679_3_, int p_i45679_4_, int p_i45679_5_, String string2, String string3) {
            this.field_176615_f = p_i45679_3_;
            this.field_176616_g = (String)p_i45679_4_;
            this.field_176622_h = (String)p_i45679_5_;
        }
