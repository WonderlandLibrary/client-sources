...
extends Block {
    ...
    public static enum EnumRailDirection implements IStringSerializable
    {
        ...
        private EnumRailDirection(String p_i45738_1_, int p_i45738_2_, String p_i45738_3_, int p_i45738_4_, int n2, String string2) {
            this.field_177027_l = p_i45738_3_;
            this.field_177028_m = (String)p_i45738_4_;
        }
    ...
    public class Rail {
        ...
        private void func_150651_b() {
            int var1 = 0;
            while (var1 < this.field_150657_g.size()) {
        ...
        private boolean func_180359_a(BlockPos p_180359_1_) {
            if (!(BlockRailBase.func_176562_d(this.field_150660_b, p_180359_1_) || BlockRailBase.func_176562_d(this.field_150660_b, p_180359_1_.offsetUp()) || BlockRailBase.func_176562_d(this.field_150660_b, p_180359_1_.offsetDown()))) {
                return false;
            }
            return true;
        }
        ...
        private boolean func_180363_c(BlockPos p_180363_1_) {
            int var2 = 0;
            while (var2 < this.field_150657_g.size()) {
        ...
        private boolean func_150649_b(Rail p_150649_1_) {
            if (!this.func_150653_a(p_150649_1_) && this.field_150657_g.size() == 2) {
                return false;
            }
            return true;
        }
        ...
        public Rail func_180364_a(boolean p_180364_1_, boolean p_180364_2_) {
            ...
            if (p_180364_2_ || this.field_150660_b.getBlockState(this.field_180367_c) != this.field_180366_e) {
                this.field_150660_b.setBlockState(this.field_180367_c, this.field_180366_e, 3);
                int var12 = 0;
                while (var12 < this.field_150657_g.size()) {
