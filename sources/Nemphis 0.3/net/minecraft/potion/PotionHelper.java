...
public class PotionHelper {
    ...
    private static int parsePotionEffects(String p_77912_0_, int p_77912_1_, int p_77912_2_, int p_77912_3_) {
        if (p_77912_1_ < p_77912_0_.length() && p_77912_2_ >= 0 && p_77912_1_ < p_77912_2_) {
            ...
            int var13 = 0;
            int var14 = 0;
            int var15 = p_77912_1_;
            while (var15 < p_77912_2_) {
    ...
    public static List getPotionEffects(int p_77917_0_, boolean p_77917_1_) {
        ...
        while (var5 < var4) {
            ...
            if (var6 != null && (!var6.isUsable() || p_77917_1_) && (var7 = (String)field_179539_o.get(var6.getId())) != null && (var8 = PotionHelper.parsePotionEffects(var7, 0, var7.length(), p_77917_0_)) > 0) {
                int var9 = 0;
