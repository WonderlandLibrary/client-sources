...
public class PlayerManager {
    ...
    public void updatePlayerInstances() {
        ...
        if (var1 - this.previousTotalWorldTime > 8000) {
            ...
            int var3 = 0;
            while (var3 < this.playerInstancesToUpdate.size()) {
    ...
    public boolean func_152621_a(int p_152621_1_, int p_152621_2_) {
        ...
        if (this.playerInstances.getValueByKey(var3) != null) {
            return true;
        }
        return false;
    }
            ...
            if (var13 != 0 || var14 != 0) {
                ...
                while (var15 <= var2 + var12) {
                    ...
                    while (var16 <= var3 + var12) {
                        ...
                        if (!this.overlaps(var15 - var13, var16 - var14, var2, var3, var12) && (var17 = this.getPlayerInstance(var15 - var13, var16 - var14, false)) != null) {
    ...
    public boolean isPlayerWatchingChunk(EntityPlayerMP p_72694_1_, int p_72694_2_, int p_72694_3_) {
        ...
        if (var4 != null && var4.playersWatchingChunk.contains(p_72694_1_) && !p_72694_1_.loadedChunks.contains(var4.currentChunk)) {
            return true;
        }
        return false;
    }
    ...
    public void func_152622_a(int p_152622_1_) {
        if ((p_152622_1_ = MathHelper.clamp_int(p_152622_1_, 3, 32)) != this.playerViewRadius) {
            ...
            for (EntityPlayerMP var5 : var3) {
                ...
                if (var2 > 0) {
                    var8 = var6 - p_152622_1_;
                    while (var8 <= var6 + p_152622_1_) {
                        var9 = var7 - p_152622_1_;
                        while (var9 <= var7 + p_152622_1_) {
                ...
                var8 = var6 - this.playerViewRadius;
                while (var8 <= var6 + this.playerViewRadius) {
                    var9 = var7 - this.playerViewRadius;
                    while (var9 <= var7 + this.playerViewRadius) {
    ...
    class PlayerInstance {
        ...
        public void flagChunkForUpdate(int p_151253_1_, int p_151253_2_, int p_151253_3_) {
            ...
            if (this.numBlocksToUpdate < 64) {
                ...
                int var5 = 0;
                while (var5 < this.numBlocksToUpdate) {
        ...
        public void onUpdate() {
            if (this.numBlocksToUpdate != 0) {
                if (this.numBlocksToUpdate == 1) {
                    int var1 = (this.locationOfBlockChange[0] >> 12 & 15) + this.currentChunk.chunkXPos * 16;
                    int var2 = this.locationOfBlockChange[0] & 255;
                    int var3 = (this.locationOfBlockChange[0] >> 8 & 15) + this.currentChunk.chunkZPos * 16;
                    ...
                    int var1 = 0;
                    while (var1 < this.numBlocksToUpdate) {
                        int var2 = (this.locationOfBlockChange[var1] >> 12 & 15) + this.currentChunk.chunkXPos * 16;
                        int var3 = this.locationOfBlockChange[var1] & 255;
                        int var7 = (this.locationOfBlockChange[var1] >> 8 & 15) + this.currentChunk.chunkZPos * 16;
