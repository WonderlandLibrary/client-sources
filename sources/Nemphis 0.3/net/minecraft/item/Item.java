...
public class Item {
    ...
    public boolean isPotionIngredient(ItemStack stack) {
        if (this.getPotionEffect(stack) != null) {
            return true;
        }
        return false;
    }
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        return StatCollector.translateToLocal(new StringBuilder(String.valueOf(this.getUnlocalizedNameInefficiently(stack))).append(".name").toString()).trim();
    }
    ...
    public static enum ToolMaterial {
        ...
        private ToolMaterial(String p_i1874_1_, int p_i1874_2_, String harvestLevel, int maxUses, int efficiency, int damageVsEntity, float enchantability, float f, int n2) {
