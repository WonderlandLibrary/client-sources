...
extends Item {
    ...
    public void addInformation(ItemStack stack, EntityPlayer playerIn, List tooltip, boolean advanced) {
        if (stack.hasTagCompound()) {
            ...
            tooltip.add((Object)((Object)EnumChatFormatting.GRAY) + StatCollector.translateToLocal(new StringBuilder("book.generation.").append(var5.getInteger("generation")).toString()));
        }
    }
    ...
    private void func_179229_a(ItemStack p_179229_1_, EntityPlayer p_179229_2_) {
        ...
        if (p_179229_1_ != null && p_179229_1_.getTagCompound() != null && !(var3 = p_179229_1_.getTagCompound()).getBoolean("resolved")) {
            ...
            if (ItemEditableBook.validBookTagContents(var3)) {
                ...
                int var5 = 0;
                while (var5 < var4.tagCount()) {
                    IChatComponent var72;
                    IChatComponent var72;
                    String var6 = var4.getStringTagAt(var5);
                    try {
                        IChatComponent var11 = IChatComponent.Serializer.jsonToComponent(var6);
                        var72 = ChatComponentProcessor.func_179985_a(p_179229_2_, var11, p_179229_2_);
                    }
                    catch (Exception var9) {
                        var72 = new ChatComponentText(var6);
                    }
                    var4.set(var5, new NBTTagString(IChatComponent.Serializer.componentToJson(var72)));
                    ++var5;
                }
