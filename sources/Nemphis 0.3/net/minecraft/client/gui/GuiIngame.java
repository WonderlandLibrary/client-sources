...
extends Gui {
    ...
    public void func_175185_b(ScaledResolution p_175185_1_) {
        ...
        String var2 = "";
        var2 = this.mc.theWorld.getTotalWorldTime() >= 120500 ? I18n.format("demo.demoExpired", new Object[0]) : I18n.format("demo.remainingTime", StringUtils.ticksToElapsedTime((int)(120500 - this.mc.theWorld.getTotalWorldTime())));
    ...
    protected boolean func_175183_b() {
        ...
        if (this.mc.playerController.enableEverythingIsScrewedUpMode()) {
            ...
            if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.theWorld.getTileEntity(var1 = this.mc.objectMouseOver.func_178782_a()) instanceof IInventory) {
                return true;
            }
            return false;
        }
    ...
    private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
        ...
        ArrayList var5 = Lists.newArrayList((Iterable)Iterables.filter((Iterable)var4, (Predicate)new Predicate(){
            ...
            public boolean func_178903_a(Score p_178903_1_) {
                if (p_178903_1_.getPlayerName() != null && !p_178903_1_.getPlayerName().startsWith("#")) {
                    return true;
                }
                return false;
            }
    ...
    private void func_180477_d(ScaledResolution p_180477_1_) {
        if (this.mc.func_175606_aa() instanceof EntityPlayer) {
            ...
            boolean bl = var4 = this.field_175191_F > (long)this.updateCounter && (this.field_175191_F - (long)this.updateCounter) / 3 % 2 == 1;
