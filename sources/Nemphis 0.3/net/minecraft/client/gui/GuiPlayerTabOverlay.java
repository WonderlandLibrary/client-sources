...
extends Gui {
    ...
    public void func_175249_a(int p_175249_1_, Scoreboard p_175249_2_, ScoreObjective p_175249_3_) {
        ...
        if (var17 != null) {
            ...
            for (String var20 : var17) {
                ...
                this.field_175250_f.fontRendererObj.func_175063_a(var20, p_175249_1_ / 2 - var21 / 2, var15, -1);
        ...
        while (var30 < var28) {
            ...
            GuiPlayerTabOverlay.drawRect(var22, var23, var22 + var13, var23 + 8, 553648127);
            ...
            if (var30 < var5.size()) {
                ...
                if (var24.getGameType() == WorldSettings.GameType.SPECTATOR) {
                    ...
                    this.field_175250_f.fontRendererObj.func_175063_a(var25, var22, var23, -1862270977);
                } else {
                    this.field_175250_f.fontRendererObj.func_175063_a(var25, var22, var23, -1);
                }
        ...
        if (var18 != null) {
            GuiPlayerTabOverlay.drawRect(p_175249_1_ / 2 - var16 / 2 - 1, var15 - 1, p_175249_1_ / 2 + var16 / 2 + 1, (var15 += var29 * 9 + 1) + var18.size() * this.field_175250_f.fontRendererObj.FONT_HEIGHT, Integer.MIN_VALUE);
            for (String var20 : var18) {
                var21 = this.field_175250_f.fontRendererObj.getStringWidth(var20);
                this.field_175250_f.fontRendererObj.func_175063_a(var20, p_175249_1_ / 2 - var21 / 2, var15, -1);
                var15 += this.field_175250_f.fontRendererObj.FONT_HEIGHT;
    ...
    private void func_175247_a(ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_, int p_175247_5_, NetworkPlayerInfo p_175247_6_) {
        ...
        if (p_175247_1_.func_178766_e() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
            ...
            if (Minecraft.getSystemTime() - p_175247_6_.func_178847_n() > 1000 || this.field_175253_j != p_175247_6_.func_178855_p()) {
            ...
            boolean bl = var10 = p_175247_6_.func_178858_o() > (long)this.field_175251_g.getUpdateCounter() && (p_175247_6_.func_178858_o() - (long)this.field_175251_g.getUpdateCounter()) / 3 % 2 == 1;
            if (var8 > 0) {
                ...
                if (var11 > 3.0f) {
                    ...
                    this.field_175250_f.fontRendererObj.func_175063_a(var14, (p_175247_5_ + p_175247_4_) / 2 - this.field_175250_f.fontRendererObj.getStringWidth(var14) / 2, p_175247_2_, var13);
                }
            }
        } else {
            String var15 = (Object)((Object)EnumChatFormatting.YELLOW) + var7;
            this.field_175250_f.fontRendererObj.func_175063_a(var15, p_175247_5_ - this.field_175250_f.fontRendererObj.getStringWidth(var15), p_175247_2_, 16777215);
        }
    }
