...
extends GuiListExtended {
    ...
    public GuiKeyBindingList(GuiControls p_i45031_1_, Minecraft mcIn) {
        ...
        while (var8 < var7) {
            ...
            if ((var11 = mcIn.fontRendererObj.getStringWidth(I18n.format(var9.getKeyDescription(), new Object[0]))) > this.maxListLabelWidth) {
    ...
    implements GuiListExtended.IGuiListEntry {
        ...
        public CategoryEntry(String p_i45028_2_) {
            ...
            this.labelWidth = GuiKeyBindingList.access$0((GuiKeyBindingList)GuiKeyBindingList.this).fontRendererObj.getStringWidth(this.labelText);
        }

        @Override
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
            GuiKeyBindingList.access$0((GuiKeyBindingList)GuiKeyBindingList.this).fontRendererObj.drawString(this.labelText, GuiKeyBindingList.access$0((GuiKeyBindingList)GuiKeyBindingList.this).currentScreen.width / 2 - this.labelWidth / 2, y + slotHeight - GuiKeyBindingList.access$0((GuiKeyBindingList)GuiKeyBindingList.this).fontRendererObj.FONT_HEIGHT - 1, 16777215);
        }
    ...
    implements GuiListExtended.IGuiListEntry {
        ...
        @Override
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
            boolean var9 = GuiKeyBindingList.access$1((GuiKeyBindingList)GuiKeyBindingList.this).buttonId == this.field_148282_b;
            GuiKeyBindingList.access$0((GuiKeyBindingList)GuiKeyBindingList.this).fontRendererObj.drawString(this.field_148283_c, x + 90 - GuiKeyBindingList.this.maxListLabelWidth, y + slotHeight / 2 - GuiKeyBindingList.access$0((GuiKeyBindingList)GuiKeyBindingList.this).fontRendererObj.FONT_HEIGHT / 2, 16777215);
            ...
            if (this.field_148282_b.getKeyCode() != 0) {
                KeyBinding[] var11 = GuiKeyBindingList.access$0((GuiKeyBindingList)GuiKeyBindingList.this).gameSettings.keyBindings;
        ...
        public boolean mousePressed(int p_148278_1_, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_) {
            if (this.btnChangeKeyBinding.mousePressed(GuiKeyBindingList.this.mc, p_148278_2_, p_148278_3_)) {
                GuiKeyBindingList.access$1((GuiKeyBindingList)GuiKeyBindingList.this).buttonId = this.field_148282_b;
                return true;
            }
            if (this.btnReset.mousePressed(GuiKeyBindingList.this.mc, p_148278_2_, p_148278_3_)) {
                GuiKeyBindingList.access$0((GuiKeyBindingList)GuiKeyBindingList.this).gameSettings.setOptionKeyBinding(this.field_148282_b, this.field_148282_b.getKeyCodeDefault());
