...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        for (ResourcePackRepository.Entry var42 : var2) {
            this.field_146966_g.add(new ResourcePackListEntryFound(this, var42));
        }
        for (ResourcePackRepository.Entry var42 : Lists.reverse((List)var1.getRepositoryEntries())) {
            this.field_146969_h.add(new ResourcePackListEntryFound(this, var42));
        }
