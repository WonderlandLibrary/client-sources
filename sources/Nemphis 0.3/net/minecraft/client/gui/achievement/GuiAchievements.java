...
implements IProgressMeter {
    ...
    protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
        var4 = MathHelper.floor_double(this.field_146569_s + (this.field_146567_u - this.field_146569_s) * (double)p_146552_3_);
        var5 = MathHelper.floor_double(this.field_146568_t + (this.field_146566_v - this.field_146568_t) * (double)p_146552_3_);
        ...
        var6 = (this.width - this.field_146555_f) / 2;
        var7 = (this.height - this.field_146557_g) / 2;
        var8 = var6 + 16;
        var9 = var7 + 17;
        this.zLevel = 0.0f;
        ...
        var18 = true;
        var19 = new Random();
        var20 = 16.0f / this.field_146570_r;
        var21 = 16.0f / this.field_146570_r;
        var22 = 0;
        while ((float)var22 * var20 - (float)var13 < 155.0f) {
            ...
            while ((float)var24 * var21 - (float)var12 < 224.0f) {
                ...
                var26 = this.func_175371_a(Blocks.sand);
        ...
        while (var22 < AchievementList.achievementList.size()) {
            ...
            if (var34.parentAchievement != null) {
                ...
                var37 = var34.parentAchievement.displayColumn * 24 - var4 + 11;
                var40 = var34.parentAchievement.displayRow * 24 - var5 + 11;
                var28 = this.statFileWriter.hasAchievementUnlocked(var34);
                var29 = this.statFileWriter.canUnlockAchievement(var34);
        ...
        var35 = (float)(p_146552_2_ - var9) * this.field_146570_r;
        RenderHelper.enableGUIStandardItemLighting();
        GlStateManager.disableLighting();
        GlStateManager.enableRescaleNormal();
        GlStateManager.enableColorMaterial();
        var25 = 0;
        while (var25 < AchievementList.achievementList.size()) {
            var38 = (Achievement)AchievementList.achievementList.get(var25);
            var40 = var38.displayColumn * 24 - var4;
            var41 = var38.displayRow * 24 - var5;
            if (var40 < -24 || var41 < -24 || (float)var40 > 224.0f * this.field_146570_r || (float)var41 > 155.0f * this.field_146570_r) ** GOTO lbl157
            var42 = this.statFileWriter.func_150874_c(var38);
            if (!this.statFileWriter.hasAchievementUnlocked(var38)) ** GOTO lbl123
            var43 = 0.75f;
            GlStateManager.color(var43, var43, var43, 1.0f);
            ** GOTO lbl138
lbl123: // 1 sources:
            if (!this.statFileWriter.canUnlockAchievement(var38)) ** GOTO lbl127
            var43 = 1.0f;
            GlStateManager.color(var43, var43, var43, 1.0f);
            ** GOTO lbl138
lbl127: // 1 sources:
            if (var42 >= 3) ** GOTO lbl131
            var43 = 0.3f;
            GlStateManager.color(var43, var43, var43, 1.0f);
            ** GOTO lbl138
lbl131: // 1 sources:
            if (var42 != 3) ** GOTO lbl135
            var43 = 0.2f;
            GlStateManager.color(var43, var43, var43, 1.0f);
            ** GOTO lbl138
lbl135: // 1 sources:
...
lbl157: // 6 sources:
        ...
        if (var33 != null) {
            var36 = var33.getStatName().getUnformattedText();
            var39 = var33.getDescription();
            ...
            if (var36 != null) {
                this.fontRendererObj.func_175063_a(var36, var40, var41, this.statFileWriter.canUnlockAchievement(var33) ? (var33.getSpecial() ? -128 : -1) : (var33.getSpecial() != false ? -8355776 : -8355712));
            }
        }
        GlStateManager.enableDepth();
        GlStateManager.enableLighting();
