...
extends GuiScreen {
    ...
    public static void func_152321_a(GuiScreen p_152321_0_) {
        ...
        if (!var1.func_180509_L().containsKey((Object)"twitch_access_token")) {
    ...
    public static enum Reason {
        ...
        private Reason(String p_i1066_1_, int p_i1066_2_, String p_i1066_3_, int n2, IChatComponent iChatComponent) {
            this(string, n, p_i1066_1_, p_i1066_2_, (IChatComponent)((Object)p_i1066_3_), null);
        }

        private Reason(String p_i1067_1_, int p_i1067_2_, String p_i1067_3_, int p_i1067_4_, IChatComponent iChatComponent, IChatComponent iChatComponent2) {
            this.field_152574_m = p_i1067_3_;
            this.field_152575_n = (IChatComponent)p_i1067_4_;
        }
