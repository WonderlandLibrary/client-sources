...
public class WorldRenderer {
    ...
    public State getVertexState(float p_178971_1_, float p_178971_2_, float p_178971_3_) {
        ...
        PriorityQueue<Integer> var5 = new PriorityQueue<Integer>(this.rawBufferIndex, new QuadComparator(this.rawFloatBuffer, (float)((double)p_178971_1_ + this.xOffset), (float)((double)p_178971_2_ + this.yOffset), (float)((double)p_178971_3_ + this.zOffset), this.vertexFormat.func_177338_f() / 4));
        ...
        return new State(this, var4, this.rawBufferIndex, this.vertexCount, new VertexFormat(this.vertexFormat), quadSpritesSorted);
    }
    ...
    public void func_178978_a(float p_178978_1_, float p_178978_2_, float p_178978_3_, int p_178978_4_) {
        ...
        if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
            int var7 = (int)((float)(var6 & 255) * p_178978_1_);
            int var8 = (int)((float)(var6 >> 8 & 255) * p_178978_2_);
            int var9 = (int)((float)(var6 >> 16 & 255) * p_178978_3_);
            var6 &= -16777216;
            var6 |= var9 << 16 | var8 << 8 | var7;
        } else {
            int var7 = (int)((float)(this.field_179007_h >> 24 & 255) * p_178978_1_);
            int var8 = (int)((float)(this.field_179007_h >> 16 & 255) * p_178978_2_);
            int var9 = (int)((float)(this.field_179007_h >> 8 & 255) * p_178978_3_);
            var6 &= 255;
    ...
    public void func_178961_b(int p_178961_1_, int p_178961_2_, int p_178961_3_, int p_178961_4_) {
        if (!this.needsUpdate) {
            ...
            this.field_179007_h = ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN ? p_178961_4_ << 24 | p_178961_3_ << 16 | p_178961_2_ << 8 | p_178961_1_ : p_178961_1_ << 24 | p_178961_2_ << 16 | p_178961_3_ << 8 | p_178961_4_;
        }
    }
    ...
    public void func_178980_d(float p_178980_1_, float p_178980_2_, float p_178980_3_) {
        ...
        byte var71 = (byte)(p_178980_1_ * 127.0f);
        byte var5 = (byte)(p_178980_2_ * 127.0f);
        byte var6 = (byte)(p_178980_3_ * 127.0f);
    ...
    public void func_178975_e(float p_178975_1_, float p_178975_2_, float p_178975_3_) {
        byte var4 = (byte)(p_178975_1_ * 127.0f);
        byte var5 = (byte)(p_178975_2_ * 127.0f);
        byte var6 = (byte)(p_178975_3_ * 127.0f);
    ...
    public void drawMultiTexture() {
        if (this.quadSprites != null) {
            ...
            while (i < countQuads) {
                ...
                if (icon != null && !this.drawnIcons[iconIndex = icon.getIndexInMap()]) {
    ...
    public class State {
        ...
        final /* synthetic */ WorldRenderer this$0;

        public State(WorldRenderer worldRenderer, int[] buf, int bufIndex, int vertCount, VertexFormat vertFormat, TextureAtlasSprite[] quadSprites) {
            this.this$0 = worldRenderer;
        ...
        public State(WorldRenderer worldRenderer, int[] p_i46274_2_, int p_i46274_3_, int p_i46274_4_, VertexFormat p_i46274_5_) {
            this.this$0 = worldRenderer;
