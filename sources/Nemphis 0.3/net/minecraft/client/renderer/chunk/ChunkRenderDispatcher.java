...
public class ChunkRenderDispatcher {
    ...
    private final BlockingQueue field_178519_d = Queues.newArrayBlockingQueue((int)100);
    private final BlockingQueue field_178520_e = Queues.newArrayBlockingQueue((int)5);
    ...
    public boolean func_178516_a(long p_178516_1_) {
        ...
        } while (p_178516_1_ != 0 && var4 && (var8 = p_178516_1_ - System.nanoTime()) >= 0 && var8 <= 1000000000);
        return var3;
    }
    ...
    public boolean func_178509_c(RenderChunk p_178509_1_) {
        ...
        try {
            ...
            var4 = var3 = this.field_178519_d.offer(var2);
        }
        finally {
    ...
    public ListenableFuture func_178503_a(final EnumWorldBlockLayer p_178503_1_, final WorldRenderer p_178503_2_, final RenderChunk p_178503_3_, final CompiledChunk p_178503_4_) {
        ...
        ListenableFutureTask var5 = ListenableFutureTask.create((Runnable)new Runnable(){
