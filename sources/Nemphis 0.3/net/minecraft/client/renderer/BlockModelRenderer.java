...
public class BlockModelRenderer {
    ...
    private void renderModelAmbientOcclusionQuads(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, List listQuadsIn, RenderEnv renderEnv) {
        ...
        if (var15 != Block.EnumOffsetType.NONE) {
            ...
            var9 += ((double)((float)(var22 >> 16 & 15) / 15.0f) - 0.5) * 0.5;
            var13 += ((double)((float)(var22 >> 24 & 15) / 15.0f) - 0.5) * 0.5;
            if (var15 == Block.EnumOffsetType.XYZ) {
                var11 += ((double)((float)(var22 >> 20 & 15) / 15.0f) - 1.0) * 0.2;
            }
        }
        Iterator var221 = listQuadsIn.iterator();
    ...
    private void renderModelStandardQuads(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, EnumFacing faceIn, int brightnessIn, boolean ownBrightness, WorldRenderer worldRendererIn, List listQuadsIn, RenderEnv renderEnv) {
        ...
        if (var16 != Block.EnumOffsetType.NONE) {
            ...
            long colorMultiplier = (long)(var23 * 3129871) ^ (long)var24 * 116129781;
            colorMultiplier = colorMultiplier * colorMultiplier * 42317861 + colorMultiplier * 11;
            var10 += ((double)((float)(colorMultiplier >> 16 & 15) / 15.0f) - 0.5) * 0.5;
            var14 += ((double)((float)(colorMultiplier >> 24 & 15) / 15.0f) - 0.5) * 0.5;
            if (var16 == Block.EnumOffsetType.XYZ) {
                var12 += ((double)((float)(colorMultiplier >> 20 & 15) / 15.0f) - 1.0) * 0.2;
            }
        }
        Iterator var231 = listQuadsIn.iterator();
    ...
    public static enum EnumNeighborInfo {
        ...
        private EnumNeighborInfo(String p_i46381_1_, int p_i46381_2_, String p_i46236_1_, int p_i46236_2_, String p_i46236_3_, int p_i46236_4_, EnumFacing[] p_i46236_5_, float p_i46236_6_, boolean p_i46236_7_, Orientation[] p_i46236_8_, Orientation[] p_i46236_9_, Orientation[] arrorientation, Orientation[] arrorientation2) {
    ...
    public static enum Orientation {
        ...
        private Orientation(String p_i46383_1_, int p_i46383_2_, String p_i46233_1_, int p_i46233_2_, String p_i46233_3_, int p_i46233_4_, EnumFacing enumFacing, boolean bl) {
            this.field_178229_m = p_i46233_3_.getIndex() + (p_i46233_4_ != 0 ? EnumFacing.values().length : 0);
        }
    }
    ...
    static enum VertexTranslations {
        ...
        private VertexTranslations(String p_i46382_1_, int p_i46382_2_, String p_i46234_1_, int p_i46234_2_, String p_i46234_3_, int p_i46234_4_, int p_i46234_5_, int p_i46234_6_, int n2, int n3) {
