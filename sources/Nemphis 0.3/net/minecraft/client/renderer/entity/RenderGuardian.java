...
extends RenderLiving {
    ...
    public void func_177109_a(EntityGuardian p_177109_1_, double p_177109_2_, double p_177109_4_, double p_177109_6_, float p_177109_8_, float p_177109_9_) {
        ...
        if (var10 != null) {
            ...
            boolean var25 = true;
            double var26 = (double)var15 * 0.05 * (1.0 - (double)(var25 & true) ? 1 : 0 * 2.5);
            ...
            double var29 = (double)var25 ? 1 : 0 * 0.2;
            ...
            double var49 = 0.0 + Math.cos(var26 + 3.141592653589793) * var29;
            double var51 = 0.0 + Math.sin(var26 + 3.141592653589793) * var29;
