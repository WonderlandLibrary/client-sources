...
implements IResourceManagerReloadListener {
    ...
    public static boolean field_175058_l = true;
    public float zLevel;
    ...
    private void renderEffect(IBakedModel p_180451_1_) {
        if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
            ...
            float var2 = (float)(Minecraft.getSystemTime() % 3000) / 3000.0f / 8.0f;
            ...
            GlStateManager.pushMatrix();
            GlStateManager.scale(8.0f, 8.0f, 8.0f);
            float var3 = (float)(Minecraft.getSystemTime() % 4873) / 4873.0f / 8.0f;
    ...
    public static void forgeHooksClient_putQuadColor(WorldRenderer renderer, BakedQuad quad, int color) {
        ...
        float cb = color >>> 16 & 255;
        float ca = color >>> 24 & 255;
