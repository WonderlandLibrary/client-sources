...
implements LayerRenderer {
    ...
    public static boolean field_177193_i;
    ...
    private ResourceLocation func_177178_a(ItemArmor p_177178_1_, boolean p_177178_2_, String p_177178_3_) {
        ...
        arrobject[0] = p_177178_1_.getArmorMaterial().func_179242_c();
        arrobject[1] = p_177178_2_ ? 2 : 1;
        arrobject[2] = p_177178_3_ == null ? "" : String.format("_%s", p_177178_3_);
        String var4 = String.format("textures/models/armor/%s_layer_%d%s.png", arrobject);
    ...
    public ResourceLocation getArmorResource(Entity entity, ItemStack stack, int slot, String type) {
        ...
        arrobject[0] = domain;
        arrobject[1] = texture;
        arrobject[2] = slot == 2 ? 2 : 1;
        arrobject[3] = type == null ? "" : String.format("_%s", type);
        String s1 = String.format("%s:textures/models/armor/%s_layer_%d%s.png", arrobject);
        ResourceLocation resourcelocation = (ResourceLocation)field_177191_j.get(s1 = Reflector.callString(Reflector.ForgeHooksClient_getArmorTexture, entity, stack, s1, slot, type));
