...
IStream {
    ...
    public static final Marker field_152949_a = MarkerManager.getMarker((String)"STREAM");
    ...
    public TwitchStream(Minecraft mcIn, final Property p_i46057_2_) {
        ...
        if (p_i46057_2_ != null && !Strings.isNullOrEmpty((String)p_i46057_2_.getValue()) && OpenGlHelper.framebufferSupported) {
                ...
                public void run() {
                    try {
                        ...
                        if (JsonUtils.getJsonObjectBooleanFieldValue(var4, "valid")) {
                            ...
                            field_152950_b.debug(TwitchStream.field_152949_a, "Authenticated with twitch; username is {}", new Object[]{var5});
                            ...
                            Runtime.getRuntime().addShutdownHook(new Thread("Twitch shutdown hook"){
                                ...
                                @Override
                                public void run() {
                                    1.this.TwitchStream.this.shutdownStream();
                                }
                            });
                            ...
                            field_152950_b.error(TwitchStream.field_152949_a, "Given twitch access token is invalid");
                        }
                    }
                    catch (IOException var7) {
                        TwitchStream.access$3(TwitchStream.this, IStream.AuthFailureReason.ERROR);
                        field_152950_b.error(TwitchStream.field_152949_a, "Could not authenticate with twitch", (Throwable)var7);
                    }
                }
    ...
    public void func_152935_j() {
        ...
        boolean bl = var3 = this.field_152952_d.func_153000_j() == ChatController.ChatState.Initialized && (this.field_176029_e == null || this.field_152952_d.func_175989_e(this.field_176029_e) == ChatController.EnumChannelState.Disconnected);
        if (var1 == 2) {
            if (var2) {
    ...
    public void func_152922_k() {
        if (this.broadcastController.isBroadcasting() && !this.broadcastController.isBroadcastPaused()) {
            ...
            boolean bl = var7 = var5 >= (var3 = (long)(1000000000 / this.field_152958_j));
            if (var7) {
    ...
    public void func_152911_a(Metadata p_152911_1_, long p_152911_2_) {
        if (this.func_152934_n() && this.field_152957_i) {
            ...
            if (!this.broadcastController.func_152840_a(p_152911_1_.func_152810_c(), var4 + p_152911_2_, p_152911_1_.func_152809_a(), p_152911_1_.func_152806_b())) {
                field_152950_b.warn(field_152949_a, "Couldn't send stream metadata action at {}: {}", new Object[]{var4 + p_152911_2_, p_152911_1_});
            } else {
                field_152950_b.debug(field_152949_a, "Sent stream metadata action at {}: {}", new Object[]{var4 + p_152911_2_, p_152911_1_});
            }
        }
    }
    ...
    public void func_176026_a(Metadata p_176026_1_, long p_176026_2_, long p_176026_4_) {
        if (this.func_152934_n() && this.field_152957_i) {
            ...
            if (var10 < 0) {
                field_152950_b.warn(field_152949_a, "Could not send stream metadata sequence from {} to {}: {}", new Object[]{var6 + p_176026_2_, var6 + p_176026_4_, p_176026_1_});
            } else if (this.broadcastController.func_177947_a(p_176026_1_.func_152810_c(), var6 + p_176026_4_, var10, var8, var9)) {
                field_152950_b.debug(field_152949_a, "Sent stream metadata sequence from {} to {}: {}", new Object[]{var6 + p_176026_2_, var6 + p_176026_4_, p_176026_1_});
            } else {
                field_152950_b.warn(field_152949_a, "Half-sent stream metadata sequence from {} to {}: {}", new Object[]{var6 + p_176026_2_, var6 + p_176026_4_, p_176026_1_});
            }
        }
    }
    ...
    public void func_152897_a(ErrorCode p_152897_1_) {
        if (ErrorCode.succeeded((ErrorCode)p_152897_1_)) {
            ...
            field_152950_b.warn(field_152949_a, "Login attempt unsuccessful: {} (error code {})", new Object[]{ErrorCode.getString((ErrorCode)p_152897_1_), p_152897_1_.getValue()});
    ...
    public void func_152894_a(StreamInfo p_152894_1_) {
        field_152950_b.debug(field_152949_a, "Stream info updated; {} viewers on stream ID {}", new Object[]{p_152894_1_.viewers, p_152894_1_.streamId});
    }
    ...
    public void func_152893_b(ErrorCode p_152893_1_) {
        field_152950_b.warn(field_152949_a, "Issue submitting frame: {} (Error code {})", new Object[]{ErrorCode.getString((ErrorCode)p_152893_1_), p_152893_1_.getValue()});
        this.field_152953_e.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(new ChatComponentText("Issue streaming frame: " + (Object)p_152893_1_ + " (" + ErrorCode.getString((ErrorCode)p_152893_1_) + ")"), 2);
    }
    ...
    public void func_152892_c(ErrorCode p_152892_1_) {
        if (p_152892_1_ == ErrorCode.TTV_EC_SOUNDFLOWER_NOT_INSTALLED) {
            ...
            ChatComponentTranslation var2 = new ChatComponentTranslation("stream.unavailable.unknown.chat", ErrorCode.getString((ErrorCode)p_152892_1_));
    ...
    public boolean func_152927_B() {
        if (this.field_176029_e != null && this.field_176029_e.equals(this.broadcastController.func_152843_l().name)) {
            return true;
        }
        return false;
    }
    ...
    public boolean func_152928_D() {
        if (field_152965_q && this.broadcastController.func_152858_b()) {
            return true;
        }
        return false;
    }
    ...
    public boolean func_152929_G() {
        boolean var1;
        boolean bl = var1 = this.field_152953_e.gameSettings.streamMicToggleBehavior == 1;
        if (!this.field_152962_n && this.field_152953_e.gameSettings.streamMicVolume > 0.0f && var1 == this.field_152963_o) {
            return false;
        }
        return true;
    }
