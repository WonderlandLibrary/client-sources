...
public class BroadcastController {
        ...
        this.field_177948_B = new IStreamCallbacks(){
            ...
            public void requestAuthTokenCallback(ErrorCode p_requestAuthTokenCallback_1_, AuthToken p_requestAuthTokenCallback_2_) {
                if (ErrorCode.succeeded((ErrorCode)p_requestAuthTokenCallback_1_)) {
                    ...
                    String var3 = ErrorCode.getString((ErrorCode)p_requestAuthTokenCallback_1_);
            ...
            public void loginCallback(ErrorCode p_loginCallback_1_, ChannelInfo p_loginCallback_2_) {
                if (ErrorCode.succeeded((ErrorCode)p_loginCallback_1_)) {
                    ...
                    String var3 = ErrorCode.getString((ErrorCode)p_loginCallback_1_);
            ...
            public void getIngestServersCallback(ErrorCode p_getIngestServersCallback_1_, IngestList p_getIngestServersCallback_2_) {
                if (ErrorCode.succeeded((ErrorCode)p_getIngestServersCallback_1_)) {
                    ...
                    String var3 = ErrorCode.getString((ErrorCode)p_getIngestServersCallback_1_);
            ...
            public void getUserInfoCallback(ErrorCode p_getUserInfoCallback_1_, UserInfo p_getUserInfoCallback_2_) {
                ...
                if (ErrorCode.failed((ErrorCode)p_getUserInfoCallback_1_)) {
                    String var3 = ErrorCode.getString((ErrorCode)p_getUserInfoCallback_1_);
            ...
            public void getStreamInfoCallback(ErrorCode p_getStreamInfoCallback_1_, StreamInfo p_getStreamInfoCallback_2_) {
                if (ErrorCode.succeeded((ErrorCode)p_getStreamInfoCallback_1_)) {
                    ...
                    String var3 = ErrorCode.getString((ErrorCode)p_getStreamInfoCallback_1_);
            ...
            public void runCommercialCallback(ErrorCode p_runCommercialCallback_1_) {
                if (ErrorCode.failed((ErrorCode)p_runCommercialCallback_1_)) {
                    String var2 = ErrorCode.getString((ErrorCode)p_runCommercialCallback_1_);
            ...
            public void setStreamInfoCallback(ErrorCode p_setStreamInfoCallback_1_) {
                if (ErrorCode.failed((ErrorCode)p_setStreamInfoCallback_1_)) {
                    String var2 = ErrorCode.getString((ErrorCode)p_setStreamInfoCallback_1_);
            ...
            public void getGameNameListCallback(ErrorCode p_getGameNameListCallback_1_, GameInfoList p_getGameNameListCallback_2_) {
                if (ErrorCode.failed((ErrorCode)p_getGameNameListCallback_1_)) {
                    String var3 = ErrorCode.getString((ErrorCode)p_getGameNameListCallback_1_);
                    BroadcastController.this.func_152820_d(String.format("GameNameListCallback got failure: %s", var3));
                }
                try {
                    if (BroadcastController.this.field_152867_c != null) {
                        BroadcastController.this.field_152867_c.func_152898_a(p_getGameNameListCallback_1_, p_getGameNameListCallback_2_ == null ? new GameInfo[]{} : p_getGameNameListCallback_2_.list);
                    }
                }
                catch (Exception var4) {
                    BroadcastController.this.func_152820_d(var4.toString());
            ...
            public void bufferUnlockCallback(long p_bufferUnlockCallback_1_) {
                FrameBuffer var3 = FrameBuffer.lookupBuffer((long)p_bufferUnlockCallback_1_);
            ...
            public void startCallback(ErrorCode p_startCallback_1_) {
                if (ErrorCode.succeeded((ErrorCode)p_startCallback_1_)) {
                    ...
                    String var2 = ErrorCode.getString((ErrorCode)p_startCallback_1_);
            ...
            public void stopCallback(ErrorCode p_stopCallback_1_) {
                if (ErrorCode.succeeded((ErrorCode)p_stopCallback_1_)) {
                    ...
                    BroadcastController.this.func_152827_a(BroadcastState.ReadyToBroadcast);
                    String var2 = ErrorCode.getString((ErrorCode)p_stopCallback_1_);
            ...
            public void sendActionMetaDataCallback(ErrorCode p_sendActionMetaDataCallback_1_) {
                if (ErrorCode.failed((ErrorCode)p_sendActionMetaDataCallback_1_)) {
                    String var2 = ErrorCode.getString((ErrorCode)p_sendActionMetaDataCallback_1_);
            ...
            public void sendStartSpanMetaDataCallback(ErrorCode p_sendStartSpanMetaDataCallback_1_) {
                if (ErrorCode.failed((ErrorCode)p_sendStartSpanMetaDataCallback_1_)) {
                    String var2 = ErrorCode.getString((ErrorCode)p_sendStartSpanMetaDataCallback_1_);
            ...
            public void sendEndSpanMetaDataCallback(ErrorCode p_sendEndSpanMetaDataCallback_1_) {
                if (ErrorCode.failed((ErrorCode)p_sendEndSpanMetaDataCallback_1_)) {
                    String var2 = ErrorCode.getString((ErrorCode)p_sendEndSpanMetaDataCallback_1_);
    ...
    public boolean func_152828_a(String p_152828_1_, String p_152828_2_, String p_152828_3_) {
        ...
        return ErrorCode.succeeded((ErrorCode)var5);
    }
    ...
    public boolean func_152830_D() {
        ...
        this.func_152853_a(var1);
        return ErrorCode.succeeded((ErrorCode)var1);
    }
    ...
    public boolean func_152836_a(VideoParams p_152836_1_) {
        if (p_152836_1_ != null && this.func_152857_n()) {
            ...
            this.field_152882_r.enableMicCapture = this.field_152882_r.audioEnabled = this.field_152871_g && this.func_152848_y();
    ...
    public boolean func_152840_a(String p_152840_1_, long p_152840_2_, String p_152840_4_, String p_152840_5_) {
        ...
        if (ErrorCode.failed((ErrorCode)var6)) {
            String var7 = ErrorCode.getString((ErrorCode)var6);
    ...
    public boolean func_177947_a(String p_177947_1_, long p_177947_2_, long p_177947_4_, String p_177947_6_, String p_177947_7_) {
        ...
        if (ErrorCode.failed((ErrorCode)var8)) {
            String var9 = ErrorCode.getString((ErrorCode)var8);
        ...
        if (this.field_152873_i != null && this.field_152876_l) {
            ...
            switch (SwitchBroadcastState.field_177773_a[this.broadcastState.ordinal()]) {
                case 1: {
                    ...
                    if (!ErrorCode.failed((ErrorCode)var1)) break;
                    String var2 = ErrorCode.getString((ErrorCode)var1);
    ...
    protected void func_152835_I() {
        ...
        long var3 = (var1 - this.field_152890_z) / 1000000000;
        if (var3 >= 30) {
            this.field_152890_z = var1;
            ErrorCode var5 = this.field_152873_i.getStreamInfo(this.field_152885_u, this.field_152880_p);
            if (ErrorCode.failed((ErrorCode)var5)) {
                String var6 = ErrorCode.getString((ErrorCode)var5);
    ...
    protected void func_152831_M() {
        int var1 = 0;
        while (var1 < this.field_152874_j.size()) {
    ...
    public void func_152846_a(FrameBuffer p_152846_1_) {
        try {
            ...
            var4.addCrashSection("Buffer", (Object)p_152846_1_);
    ...
    public ErrorCode func_152859_b(FrameBuffer p_152859_1_) {
        ...
        if (var2 != ErrorCode.TTV_EC_SUCCESS) {
            String var3 = ErrorCode.getString((ErrorCode)var2);
            if (ErrorCode.succeeded((ErrorCode)var2)) {
    ...
    public static enum BroadcastState {
        ...
        static {
            $VALUES = new BroadcastState[]{Uninitialized, Initialized, Authenticating, Authenticated, LoggingIn, LoggedIn, FindingIngestServer, ReceivedIngestServers, ReadyToBroadcast, Starting, Broadcasting, Stopping, Paused, IngestTesting};
        }

        private BroadcastState(String p_i1025_1_, int p_i1025_2_, String string2, int n2) {
        }
    }

    static final class SwitchBroadcastState {
        static final int[] field_177773_a = new int[BroadcastState.values().length];
