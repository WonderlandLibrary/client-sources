...
public class IngestServerTester {
    ...
    protected long field_153049_g = 2000;
        ...
        if (!this.field_153061_s && !this.field_153060_r && this.func_153037_m() < this.field_153048_f) {
            if (!this.field_176008_y && !this.field_176007_z) {
                ...
                if (this.field_153051_i == RTMPState.SendVideo) {
                    ...
                    if (var3 > 0 && this.field_153050_h > this.field_153064_v) {
                        p_153029_1_.bitrateKbps = (float)(this.field_153050_h * 8) / (float)this.func_153037_m();
                        this.field_153064_v = this.field_153050_h;
                    }
                }
                return true;
    ...
    public static enum IngestTestState {
        ...
        static {
            $VALUES = new IngestTestState[]{Uninitalized, Starting, ConnectingToServer, TestingServer, DoneTestingServer, Finished, Cancelling, Cancelled, Failed};
        }

        private IngestTestState(String p_i1016_1_, int p_i1016_2_, String string2, int n2) {
        }
    }
