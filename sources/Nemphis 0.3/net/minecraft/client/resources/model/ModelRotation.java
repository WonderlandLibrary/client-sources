...
ITransformation
{
    ...
    static {
        ...
        ModelRotation[] var0 = ModelRotation.values();
    ...
    private ModelRotation(String p_i46087_1_, int p_i46087_2_, String p_i46087_3_, int p_i46087_4_, int n2, int n3) {
        this.field_177545_r = ModelRotation.func_177521_b((int)p_i46087_3_, p_i46087_4_);
        this.field_177544_s = new Matrix4d();
        Matrix4d var5 = new Matrix4d();
        var5.setIdentity();
        var5.setRotation(new AxisAngle4d(1.0, 0.0, 0.0, (double)((Object)(- p_i46087_3_) * 0.017453292f)));
        this.field_177543_t = MathHelper.abs_int((int)(p_i46087_3_ / 90));
        Matrix4d var6 = new Matrix4d();
        var6.setIdentity();
        var6.setRotation(new AxisAngle4d(0.0, 1.0, 0.0, (double)((float)(- p_i46087_4_) * 0.017453292f)));
    ...
    public EnumFacing func_177523_a(EnumFacing p_177523_1_) {
        ...
        int var3 = 0;
        while (var3 < this.field_177543_t) {
            var2 = var2.rotateAround(EnumFacing.Axis.X);
            ++var3;
        }
        if (var2.getAxis() != EnumFacing.Axis.Y) {
            var3 = 0;
            while (var3 < this.field_177542_u) {
    ...
    public int func_177520_a(EnumFacing facing, int vertexIndex) {
        ...
        int var5 = 0;
        while (var5 < this.field_177543_t) {
    ...
    public static ModelRotation func_177524_a(int p_177524_0_, int p_177524_1_) {
        return (ModelRotation)field_177546_q.get(ModelRotation.func_177521_b(MathHelper.func_180184_b(p_177524_0_, 360), MathHelper.func_180184_b(p_177524_1_, 360)));
    }
    ...
    public IModelPart apply(Object x0) {
        return (IModelPart)((Object)this.apply((IModelPart)x0));
    }
}
