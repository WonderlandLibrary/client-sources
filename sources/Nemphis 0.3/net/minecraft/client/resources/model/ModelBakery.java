...
public class ModelBakery {
    ...
    private ModelBlock loadModel(ResourceLocation p_177594_1_) throws IOException {
        ...
        if (var3.startsWith("builtin/")) {
            ...
            var22 = new StringReader(var5);
        } else {
            IResource var9 = this.resourceManager.getResource(this.getModelLocation(p_177594_1_));
            var22 = new InputStreamReader(var9.getInputStream(), Charsets.UTF_8);
        }
        try {
            ModelBlock var10 = ModelBlock.deserialize(var22);
    ...
    private void bakeBlockModels() {
        for (ModelResourceLocation var2 : this.variants.keySet()) {
            ...
            int var4 = 0;
            for (ModelBlockDefinition.Variant var6 : ((ModelBlockDefinition.Variants)this.variants.get(var2)).getVariants()) {
        ...
        for (Map.Entry var8 : this.itemLocations.entrySet()) {
    ...
    private boolean func_177581_b(ModelBlock p_177581_1_) {
        ...
        if (var2 != MODEL_GENERATED && var2 != MODEL_COMPASS && var2 != MODEL_CLOCK) {
            return false;
        }
        return true;
    }
