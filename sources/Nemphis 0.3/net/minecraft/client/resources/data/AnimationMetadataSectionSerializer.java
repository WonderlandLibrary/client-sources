...
implements JsonSerializer {
    ...
    public AnimationMetadataSection deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) {
        ...
        if (var6 != 1) {
            Validate.inclusiveBetween((long)1, (long)Integer.MAX_VALUE, (long)var6, (String)"Invalid default frame time");
        }
        if (var5.has("frames")) {
            try {
        ...
        if (var12 != -1) {
            Validate.inclusiveBetween((long)1, (long)Integer.MAX_VALUE, (long)var12, (String)"Invalid width");
        }
        if (var8 != -1) {
            Validate.inclusiveBetween((long)1, (long)Integer.MAX_VALUE, (long)var8, (String)"Invalid height");
        }
    ...
    private AnimationFrame parseAnimationFrame(int p_110492_1_, JsonElement p_110492_2_) {
        ...
        if (p_110492_2_.isJsonObject()) {
            ...
            if (var3.has("time")) {
                Validate.inclusiveBetween((long)1, (long)Integer.MAX_VALUE, (long)var4, (String)"Invalid frame time");
            }
            int var5 = JsonUtils.getJsonObjectIntegerFieldValue(var3, "index");
            Validate.inclusiveBetween((long)0, (long)Integer.MAX_VALUE, (long)var5, (String)"Invalid frame index");
    ...
    public JsonElement serialize(AnimationMetadataSection p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_) {
        ...
        if (p_serialize_1_.getFrameCount() > 0) {
            ...
            int var6 = 0;
            while (var6 < p_serialize_1_.getFrameCount()) {
