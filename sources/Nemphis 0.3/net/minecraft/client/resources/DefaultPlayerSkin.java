...
public class DefaultPlayerSkin {
    ...
    public static ResourceLocation func_177334_a(UUID p_177334_0_) {
        return DefaultPlayerSkin.func_177333_c(p_177334_0_) ? field_177336_b : field_177337_a;
    }

    public static String func_177332_b(UUID p_177332_0_) {
        return DefaultPlayerSkin.func_177333_c(p_177332_0_) ? "slim" : "default";
    }

    private static boolean func_177333_c(UUID p_177333_0_) {
        if ((p_177333_0_.hashCode() & 1) == 1) {
            return true;
        }
        return false;
    }
