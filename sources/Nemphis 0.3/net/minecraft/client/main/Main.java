...
public class Main {
    ...
    public static void main(String[] p_main_0_) {
        ...
        if (var23 != null) {
            ...
            catch (Exception var25_25) {
                // empty catch block
            }
        }
        String var25 = (String)var21.valueOf((OptionSpec)var9);
        ...
        if (!var24.equals(Proxy.NO_PROXY) && Main.func_110121_a(var25) && Main.func_110121_a(var26)) {
            Authenticator.setDefault(new Authenticator(){
                ...
                protected PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication(String.this, var26.toCharArray());
                }
            });
        }
    ...
    private static boolean func_110121_a(String p_110121_0_) {
        if (p_110121_0_ != null && !p_110121_0_.isEmpty()) {
            return true;
        }
        return false;
    }
