...
public class GuiFlatNormalField
extends GuiTextField {
    public int tick = 0;

    public GuiFlatNormalField(int p_i45542_1_, FontRenderer p_i45542_2_, int p_i45542_3_, int p_i45542_4_, int p_i45542_5_, int p_i45542_6_) {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.isFocused) {
                LWJGLUtil.drawRect(this.xPosition - 1, this.yPosition, this.xPosition + this.width + 1, this.yPosition + this.height, -2131956500);
            } else {
                LWJGLUtil.drawRect(this.xPosition - 1, this.yPosition, this.xPosition + this.width + 1, this.yPosition + this.height, -2131956500);
            }
            ...
            if (var6) {
                if (var11) {
                    LWJGLUtil.drawRect(var12, var8 - 1, var12 + 1, var8 + 1 + this.fontRendererInstance.FONT_HEIGHT, -3092272);
                } else {
                    this.fontRendererInstance.drawStringWithShadow("_", var9, var8, var1);
                }
            }
            if (var3 != var2) {
                int var13 = var7 + this.fontRendererInstance.getStringWidth(var4.substring(0, var3));
