...
public class OutlineUtils {
    ...
    public static void renderFour(EntityPlayer p) {
        OutlineUtils.setColor(new Color(EntityHelper.getPlayerColor(p)[0].floatValue(), EntityHelper.getPlayerColor(p)[1].floatValue(), EntityHelper.getPlayerColor(p)[2].floatValue()));
    ...
    public static void renderFour2() {
        OutlineUtils.setColor(new Color(0.0f, 0.0f, 0.0f, 0.19607843f));
        GL11.glDepthMask((boolean)false);
        GL11.glDisable((int)2929);
        GL11.glEnable((int)10754);
        GL11.glPolygonOffset((float)1.0f, (float)-2000000.0f);
