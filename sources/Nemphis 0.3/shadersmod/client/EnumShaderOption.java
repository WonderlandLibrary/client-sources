...
public enum EnumShaderOption {
    ...
    static {
        $VALUES = new EnumShaderOption[]{ANTIALIASING, NORMAL_MAP, SPECULAR_MAP, RENDER_RES_MUL, SHADOW_RES_MUL, HAND_DEPTH_MUL, CLOUD_SHADOW, OLD_LIGHTING, SHADER_PACK, TWEAK_BLOCK_DAMAGE, SHADOW_CLIP_FRUSTRUM, TEX_MIN_FIL_B, TEX_MIN_FIL_N, TEX_MIN_FIL_S, TEX_MAG_FIL_B, TEX_MAG_FIL_N, TEX_MAG_FIL_S};
    }

    private EnumShaderOption(String var1, int var2, String resourceKey, int propertyKey, String valueDefault, String string2, String string3) {
        this.resourceKey = resourceKey;
        this.propertyKey = (String)propertyKey;
