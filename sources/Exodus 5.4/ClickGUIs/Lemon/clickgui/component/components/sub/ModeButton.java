...
extends Component {
    ...
    public void renderComponent() {
        ...
        Minecraft.fontRendererObj.drawStringWithShadow(String.valueOf(this.set.getName()) + ": " + this.set.getValString(), (this.parent.parent.getX() + 7) * 2, (this.parent.parent.getY() + this.offset + 2) * 2 + 5, -1);
        GL11.glPopMatrix();
    }
    ...
    public ModeButton(Setting setting, Button button, Module module, int n) {
        this.set = setting;
        this.parent = button;
        this.mod = module;
    ...
    public void mouseClicked(int n, int n2, int n3) {
        if (this.isMouseOnButton(n, n2) && n3 == 0 && this.parent.open) {
            int n4 = this.set.getOptions().size();
            this.modeIndex = this.modeIndex + 1 >= n4 ? 0 : ++this.modeIndex;
