...
public class BlockModelShapes {
    ...
    private void registerAllBlocks() {
        ...
        this.registerBlockWithStateMapper(Blocks.quartz_block, new StateMapperBase(){
            ...
            protected ModelResourceLocation getModelResourceLocation(IBlockState iBlockState) {
                BlockQuartz.EnumType enumType = iBlockState.getValue(BlockQuartz.VARIANT);
                switch (enumType) {
                    default: {
        ...
        this.registerBlockWithStateMapper(Blocks.pumpkin_stem, new StateMapperBase(){
            ...
            protected ModelResourceLocation getModelResourceLocation(IBlockState iBlockState) {
                ...
                return new ModelResourceLocation((ResourceLocation)Block.blockRegistry.getNameForObject(iBlockState.getBlock()), this.getPropertyString(linkedHashMap));
            }
        });
        ...
        this.registerBlockWithStateMapper(Blocks.dirt, new StateMapperBase(){
            ...
            protected ModelResourceLocation getModelResourceLocation(IBlockState iBlockState) {
                LinkedHashMap linkedHashMap = Maps.newLinkedHashMap(iBlockState.getProperties());
                String string = BlockDirt.VARIANT.getName((BlockDirt.DirtType)linkedHashMap.remove(BlockDirt.VARIANT));
        ...
        this.registerBlockWithStateMapper(Blocks.double_stone_slab, new StateMapperBase(){
            ...
            protected ModelResourceLocation getModelResourceLocation(IBlockState iBlockState) {
                LinkedHashMap linkedHashMap = Maps.newLinkedHashMap(iBlockState.getProperties());
                String string = BlockStoneSlab.VARIANT.getName((BlockStoneSlab.EnumType)linkedHashMap.remove(BlockStoneSlab.VARIANT));
                linkedHashMap.remove(BlockStoneSlab.SEAMLESS);
                String string2 = iBlockState.getValue(BlockStoneSlab.SEAMLESS) != false ? "all" : "normal";
                return new ModelResourceLocation(String.valueOf(string) + "_double_slab", string2);
            }
        });
        this.registerBlockWithStateMapper(Blocks.double_stone_slab2, new StateMapperBase(){
            ...
            protected ModelResourceLocation getModelResourceLocation(IBlockState iBlockState) {
                LinkedHashMap linkedHashMap = Maps.newLinkedHashMap(iBlockState.getProperties());
                String string = BlockStoneSlabNew.VARIANT.getName((BlockStoneSlabNew.EnumType)linkedHashMap.remove(BlockStoneSlabNew.VARIANT));
                linkedHashMap.remove(BlockStoneSlab.SEAMLESS);
                String string2 = iBlockState.getValue(BlockStoneSlabNew.SEAMLESS) != false ? "all" : "normal";
                return new ModelResourceLocation(String.valueOf(string) + "_double_slab", string2);
            }
        });
    }
    ...
    public TextureAtlasSprite getTexture(IBlockState iBlockState) {
        ...
        IBakedModel iBakedModel = this.getModelForState(iBlockState);
    ...
    public void registerBuiltInBlocks(Block ... blockArray) {
        this.blockStateMapper.registerBuiltInBlocks(blockArray);
    }
