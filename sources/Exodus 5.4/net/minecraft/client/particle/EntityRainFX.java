...
extends EntityFX {
    ...
    public void onUpdate() {
        ...
        if (material.isLiquid() || material.isSolid()) {
            double d = 0.0;
            d = iBlockState.getBlock() instanceof BlockLiquid ? (double)(1.0f - BlockLiquid.getLiquidHeightPercent(iBlockState.getValue(BlockLiquid.LEVEL))) : block.getBlockBoundsMaxY();
    ...
    protected EntityRainFX(World world, double d, double d2, double d3) {
