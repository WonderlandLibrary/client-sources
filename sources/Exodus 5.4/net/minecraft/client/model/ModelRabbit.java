...
extends ModelBase {
    ...
    public void setRotationAngles(float f, float f2, float f3, float f4, float f5, float f6, Entity entity) {
        ...
        this.rabbitRightEar.rotateAngleX = this.rabbitLeftEar.rotateAngleX = f5 * ((float)Math.PI / 180);
        this.rabbitHead.rotateAngleX = this.rabbitLeftEar.rotateAngleX;
        this.rabbitNose.rotateAngleX = this.rabbitLeftEar.rotateAngleX;
        this.rabbitNose.rotateAngleY = this.rabbitHead.rotateAngleY = f4 * ((float)Math.PI / 180);
        this.rabbitRightEar.rotateAngleY = this.rabbitNose.rotateAngleY - 0.2617994f;
        this.rabbitLeftEar.rotateAngleY = this.rabbitNose.rotateAngleY + 0.2617994f;
        this.field_178701_m = MathHelper.sin(entityRabbit.func_175521_o(f7) * (float)Math.PI);
