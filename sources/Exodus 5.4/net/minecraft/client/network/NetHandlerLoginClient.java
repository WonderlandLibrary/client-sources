...
implements INetHandlerLoginClient {
    ...
    public void handleEncryptionRequest(S01PacketEncryptionRequest s01PacketEncryptionRequest) {
        ...
        String string = s01PacketEncryptionRequest.getServerId();
        PublicKey publicKey = s01PacketEncryptionRequest.getPublicKey();
        String string2 = new BigInteger(CryptManager.getServerIdHash(string, publicKey, secretKey)).toString(16);
        if (this.mc.getCurrentServerData() != null && this.mc.getCurrentServerData().func_181041_d()) {
            try {
                this.getSessionService().joinServer(this.mc.getSession().getProfile(), this.mc.getSession().getToken(), string2);
            }
        ...
        this.networkManager.sendPacket(new C01PacketEncryptionResponse(secretKey, publicKey, s01PacketEncryptionRequest.getVerifyToken()), (GenericFutureListener<? extends Future<? super Void>>)new GenericFutureListener<Future<? super Void>>(){
