...
extends BiomeGenBase {
    ...
    public WorldGenAbstractTree genBigTreeChance(Random random) {
        return random.nextInt(10) == 0 ? this.worldGeneratorBigTree : (random.nextInt(2) == 0 ? new WorldGenShrub(field_181620_aE, field_181622_aG) : (!this.field_150614_aC && random.nextInt(3) == 0 ? new WorldGenMegaJungle(false, 10, 20, field_181620_aE, field_181621_aF) : new WorldGenTrees(false, 4 + random.nextInt(7), field_181620_aE, field_181621_aF, true)));
    }
    ...
    public BiomeGenJungle(int n, boolean bl) {
        super(n);
        this.field_150614_aC = bl;
        this.theBiomeDecorator.treesPerChunk = bl ? 2 : 50;
    ...
    public void decorate(World world, Random random, BlockPos blockPos) {
        ...
        int n3 = random.nextInt(world.getHeight(blockPos.add(n, 0, n2)).getY() * 2);
        new WorldGenMelon().generate(world, random, blockPos.add(n, n3, n2));
        ...
        while (n2 < 50) {
            ...
            worldGenVines.generate(world, random, blockPos.add(n3, 128, n5));
            ++n2;
        }
    }
}
