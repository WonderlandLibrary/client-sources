...
public enum EnumParticleTypes {
    ...
    private EnumParticleTypes(String string2, int n2, boolean bl, int n3) {
        this.particleName = string2;
        this.particleID = n2;
        this.shouldIgnoreRange = bl;
        this.argumentCount = n3;
    }

    private EnumParticleTypes(String string2, int n2, boolean bl) {
    ...
    static {
        ...
        int n2 = 0;
        while (n2 < n) {
            EnumParticleTypes enumParticleTypes = enumParticleTypesArray[n2];
    ...
    public static EnumParticleTypes getParticleFromId(int n) {
        return PARTICLES.get(n);
    }
}
