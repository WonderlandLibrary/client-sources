...
public class Item {
    ...
    private static void registerItem(int n, String string, Item item) {
        Item.registerItem(n, new ResourceLocation(string), item);
    }

    protected static void registerItemBlock(Block block, Item item) {
        Item.registerItem(Block.getIdFromBlock(block), (ResourceLocation)Block.blockRegistry.getNameForObject(block), item);
        BLOCK_TO_ITEM.put(block, item);
    }

    private static void registerItem(int n, ResourceLocation resourceLocation, Item item) {
        itemRegistry.register(n, resourceLocation, item);
    }
    ...
    protected Item setPotionEffect(String string) {
    ...
    protected MovingObjectPosition getMovingObjectPositionFromPlayer(World world, EntityPlayer entityPlayer, boolean bl) {
        float f = entityPlayer.rotationPitch;
        float f2 = entityPlayer.rotationYaw;
        double d = entityPlayer.posX;
        double d2 = entityPlayer.posY + (double)entityPlayer.getEyeHeight();
        ...
        return world.rayTraceBlocks(vec3, vec32, bl, !bl, false);
    }
    ...
    private static void registerItemBlock(Block block) {
        Item.registerItemBlock(block, new ItemBlock(block));
    }
    ...
    public static Item getItemById(int n) {
        return itemRegistry.getObjectById(n);
    }
    ...
    public String getUnlocalizedNameInefficiently(ItemStack itemStack) {
        ...
        return string == null ? "" : StatCollector.translateToLocal(string);
    }
    ...
    public String getItemStackDisplayName(ItemStack itemStack) {
        return StatCollector.translateToLocal(String.valueOf(this.getUnlocalizedNameInefficiently(itemStack)) + ".name").trim();
    }
    ...
    public static Item getByNameOrId(String string) {
        Item item = itemRegistry.getObject(new ResourceLocation(string));
        if (item == null) {
            try {
                return Item.getItemById(Integer.parseInt(string));
            }
    ...
    public static int getIdFromItem(Item item) {
        return item == null ? 0 : itemRegistry.getIDForObject(item);
    }
    ...
    public static enum ToolMaterial {
        ...
        private ToolMaterial(int n2, int n3, float f, float f2, int n4) {
