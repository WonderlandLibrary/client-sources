...
public class CraftingManager {
     ...
     */
    public ShapedRecipes addRecipe(ItemStack var1_1, Object ... var2_2) {
        block9: {
            var3_3 = "";
            var4_4 = 0;
            var5_5 = 0;
            var6_6 = 0;
            if (!(var2_2[var4_4] instanceof String[])) ** GOTO lbl20
            var7_7 = (String[])var2_2[var4_4++];
            var8_8 = 0;
            while (var8_8 < ((String[])var7_7).length) {
                var9_11 = var7_7[var8_8];
                ++var6_6;
                var5_5 = var9_11.length();
                var3_3 = String.valueOf(var3_3) + (String)var9_11;
                ++var8_8;
            }
            break block9;
lbl-1000:
...

            {
                var7_7 = (String)var2_2[var4_4++];
                ++var6_6;
                var5_5 = var7_7.length();
                var3_3 = String.valueOf(var3_3) + (String)var7_7;
lbl20:
                // 2 sources

                ** while (var2_2[var4_4] instanceof String)
            }
        }
        var7_7 = Maps.newHashMap();
        while (var4_4 < var2_2.length) {
            var8_9 = (Character)var2_2[var4_4];
            var9_11 = null;
            if (var2_2[var4_4 + 1] instanceof Item) {
                var9_11 = new ItemStack((Item)var2_2[var4_4 + 1]);
            } else if (var2_2[var4_4 + 1] instanceof Block) {
                var9_11 = new ItemStack((Block)var2_2[var4_4 + 1], 1, 32767);
            } else if (var2_2[var4_4 + 1] instanceof ItemStack) {
                var9_11 = (ItemStack)var2_2[var4_4 + 1];
            }
            var7_7.put(var8_9, var9_11);
            var4_4 += 2;
        }
        var8_10 = new ItemStack[var5_5 * var6_6];
        var9_12 = 0;
        while (var9_12 < var5_5 * var6_6) {
            var10_14 = var3_3.charAt(var9_12);
            var8_10[var9_12] = var7_7.containsKey(Character.valueOf(var10_14)) != false ? ((ItemStack)var7_7.get(Character.valueOf(var10_14))).copy() : null;
            ++var9_12;
        }
        var9_13 = new ShapedRecipes(var5_5, var6_6, var8_10, var1_1);
        this.recipes.add(var9_13);
        return var9_13;
    }
    ...
    public ItemStack[] func_180303_b(InventoryCrafting inventoryCrafting, World world) {
        for (IRecipe object2 : this.recipes) {
            if (!object2.matches(inventoryCrafting, world)) continue;
            return object2.getRemainingItems(inventoryCrafting);
        }
        ItemStack[] itemStackArray = new ItemStack[inventoryCrafting.getSizeInventory()];
        int n = 0;
        while (n < itemStackArray.length) {
            itemStackArray[n] = inventoryCrafting.getStackInSlot(n);
            ++n;
        }
    ...
    private CraftingManager() {
        ...
        Collections.sort(this.recipes, new Comparator<IRecipe>(){
            ...
            public int compare(IRecipe iRecipe, IRecipe iRecipe2) {
                return iRecipe instanceof ShapelessRecipes && iRecipe2 instanceof ShapedRecipes ? 1 : (iRecipe2 instanceof ShapelessRecipes && iRecipe instanceof ShapedRecipes ? -1 : (iRecipe2.getRecipeSize() < iRecipe.getRecipeSize() ? -1 : (iRecipe2.getRecipeSize() > iRecipe.getRecipeSize() ? 1 : 0)));
            }
        });
    }
}
