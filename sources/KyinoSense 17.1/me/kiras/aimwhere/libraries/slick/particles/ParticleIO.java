...
import me.kiras.aimwhere.libraries.slick.particles.ConfigurableEmitterFactory;
...
public class ParticleIO {
    ...
    public static ParticleSystem loadConfiguredSystem(InputStream ref, ConfigurableEmitterFactory factory, ParticleSystem system, Color mask) throws IOException {
        ...
        try {
            ...
            if (system == null) {
                system = new ParticleSystem("net/ccbluex/liquidbounce/libraries/slick/data/particle.tga", 2000, mask);
            }
