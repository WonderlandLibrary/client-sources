...
extends GuiButton {
    ...
    public void func_146112_a(Minecraft mc, int mouseX, int mouseY) {
        if (this.field_146125_m) {
            ...
            RenderUtils.drawCircleRectMixinGuiButtonExt(this.field_146128_h + (int)this.cut, this.field_146129_i, this.field_146128_h + this.field_146120_f - (int)this.cut, this.field_146129_i + this.field_146121_g, 2.0f, this.field_146124_l ? new Color(0.0f, 0.0f, 0.0f, this.alpha / 255.0f).getRGB() : new Color(0.5f, 0.5f, 0.5f).getRGB(), true);
