...
public class PlayerUtil {
    ...
    public static float[] getRotations(Entity ent) {
        ...
        return PlayerUtil.getRotationFromPosition(x, z, y);
    }

    public static Block getBlock(double offsetX, double offsetY, double offsetZ) {
        return PlayerUtil.mc.field_71441_e.func_180495_p(new BlockPos(offsetX, offsetY, offsetZ)).func_177230_c();
    }

    public static void damagePlayer() {
        for (int i = 0; i <= 45; ++i) {
            PlayerUtil.mc.field_71439_g.field_71174_a.func_147298_b().func_179290_a((Packet)new C03PacketPlayer.C04PacketPlayerPosition(PlayerUtil.mc.field_71439_g.field_70165_t, PlayerUtil.mc.field_71439_g.field_70163_u + 0.0624986421, PlayerUtil.mc.field_71439_g.field_70161_v, false));
            PlayerUtil.mc.field_71439_g.field_71174_a.func_147298_b().func_179290_a((Packet)new C03PacketPlayer.C04PacketPlayerPosition(PlayerUtil.mc.field_71439_g.field_70165_t, PlayerUtil.mc.field_71439_g.field_70163_u + 0.0625, PlayerUtil.mc.field_71439_g.field_70161_v, false));
            PlayerUtil.mc.field_71439_g.field_71174_a.func_147298_b().func_179290_a((Packet)new C03PacketPlayer.C04PacketPlayerPosition(PlayerUtil.mc.field_71439_g.field_70165_t, PlayerUtil.mc.field_71439_g.field_70163_u + 0.0624986421, PlayerUtil.mc.field_71439_g.field_70161_v, false));
            PlayerUtil.mc.field_71439_g.field_71174_a.func_147298_b().func_179290_a((Packet)new C03PacketPlayer.C04PacketPlayerPosition(PlayerUtil.mc.field_71439_g.field_70165_t, PlayerUtil.mc.field_71439_g.field_70163_u + 1.3579E-6, PlayerUtil.mc.field_71439_g.field_70161_v, false));
        }
        mc.func_147114_u().func_147297_a((Packet)new C03PacketPlayer.C04PacketPlayerPosition(PlayerUtil.mc.field_71439_g.field_70165_t, PlayerUtil.mc.field_71439_g.field_70163_u, PlayerUtil.mc.field_71439_g.field_70161_v, true));
    }
    ...
    private static float[] getRotationFromPosition(double x, double z, double y) {
        double xDiff = x - PlayerUtil.mc.field_71439_g.field_70165_t;
        double zDiff = z - PlayerUtil.mc.field_71439_g.field_70161_v;
        double yDiff = y - PlayerUtil.mc.field_71439_g.field_70163_u - 0.6;
    ...
    public static float getMaxFallDist() {
        ...
        return PlayerUtil.mc.field_71439_g.func_82143_as() + f2;
    }

    public static float getDirection() {
        float yaw = PlayerUtil.mc.field_71439_g.field_70759_as;
        float forward = PlayerUtil.mc.field_71439_g.field_70701_bs;
        float strafe = PlayerUtil.mc.field_71439_g.field_70702_br;
    ...
    public static Block getBlockAtPosC(EntityPlayer inPlayer, double x, double y, double z) {
        return PlayerUtil.getBlock(new BlockPos(inPlayer.field_70165_t - x, inPlayer.field_70163_u - y, inPlayer.field_70161_v - z));
    }
    ...
    public static ArrayList<Vector3f> vanillaTeleportPositions(double tpX, double tpY, double tpZ, double speed) {
        ...
        double steps = 1.0;
        for (d = speed; d < PlayerUtil.getDistance(PlayerUtil.mc.field_71439_g.field_70165_t, PlayerUtil.mc.field_71439_g.field_70163_u, PlayerUtil.mc.field_71439_g.field_70161_v, tpX, tpY, tpZ); d += speed) {
            steps += 1.0;
        }
        for (d = speed; d < PlayerUtil.getDistance(PlayerUtil.mc.field_71439_g.field_70165_t, PlayerUtil.mc.field_71439_g.field_70163_u, PlayerUtil.mc.field_71439_g.field_70161_v, tpX, tpY, tpZ); d += speed) {
            tmpX = PlayerUtil.mc.field_71439_g.field_70165_t - Math.sin(PlayerUtil.getDirection(yaw)) * d;
            tmpZ = PlayerUtil.mc.field_71439_g.field_70161_v + Math.cos(PlayerUtil.getDirection(yaw)) * d;
    ...
    public static void blockHit(Entity en, boolean value) {
        ItemStack stack = PlayerUtil.mc.field_71439_g.func_71045_bC();
        if (PlayerUtil.mc.field_71439_g.func_71045_bC() != null && en != null && value && stack.func_77973_b() instanceof ItemSword && (double)PlayerUtil.mc.field_71439_g.field_70733_aJ > 0.2) {
            PlayerUtil.mc.field_71439_g.func_71045_bC().func_77957_a((World)PlayerUtil.mc.field_71441_e, (EntityPlayer)PlayerUtil.mc.field_71439_g);
        }
    }
    ...
    public static int bestWeapon(Entity target) {
        PlayerUtil.mc.field_71439_g.field_71071_by.field_70461_c = 0;
        int firstSlot = 0;
        int bestWeapon = -1;
        int j = 1;
        for (int i = 0; i < 9; i = (int)((byte)(i + 1))) {
            ...
            ItemStack itemStack = PlayerUtil.mc.field_71439_g.func_70694_bm();
            if (itemStack == null) continue;
            j = itemAtkDamage = (int)PlayerUtil.getItemAtkDamage(itemStack);
            bestWeapon = i;
        }
        if (bestWeapon != -1) {
            return bestWeapon;
    ...
    public static void shiftClick(Item i) {
        for (int i1 = 9; i1 < 37; ++i1) {
            ItemStack itemstack = PlayerUtil.mc.field_71439_g.field_71069_bz.func_75139_a(i1).func_75211_c();
            if (itemstack == null || itemstack.func_77973_b() != i) continue;
            PlayerUtil.mc.field_71442_b.func_78753_a(0, i1, 0, 1, (EntityPlayer)PlayerUtil.mc.field_71439_g);
            break;
        }
    }
    ...
    public static boolean hotbarIsFull() {
        for (int i = 0; i <= 36; ++i) {
            ItemStack itemstack = PlayerUtil.mc.field_71439_g.field_71071_by.func_70301_a(i);
            if (itemstack != null) continue;
            return false;
        }
        return true;
    ...
    public static double getDistanceToFall() {
        double distance = 0.0;
        for (double i2 = PlayerUtil.mc.field_71439_g.field_70163_u; i2 > 0.0 && !(i2 < 0.0); i2 -= 0.1) {
            Block block = BlockUtils.getBlock(new BlockPos(PlayerUtil.mc.field_71439_g.field_70165_t, i2, PlayerUtil.mc.field_71439_g.field_70161_v));
        ...
        return PlayerUtil.mc.field_71439_g.field_70163_u - distance;
    }
}
