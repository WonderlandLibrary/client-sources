...
public class ColorUtil22 {
    ...
    public static Color blendColors(float[] fractions, Color[] colors, float progress) {
        ...
        if (fractions.length == colors.length) {
            int[] getFractionBlack = ColorUtil22.getFraction(fractions, progress);
            ...
            return ColorUtil22.blend(colorRange[0], colorRange[1], 1.0f - weight);
        }
    ...
    public static Color hslToRGB(float[] hsl) {
        ...
        if (hsl[1] == 0.0f) {
            ...
            red = ColorUtil22.hueToRGB(p, q, hsl[0] + 0.33333334f);
            green = ColorUtil22.hueToRGB(p, q, hsl[0]);
            blue = ColorUtil22.hueToRGB(p, q, hsl[0] - 0.33333334f);
        }
    ...
    public static int applyOpacity(int color, float opacity) {
        ...
        return ColorUtil22.applyOpacity(old, opacity).getRGB();
    }
    ...
    public static int interpolateColor(Color color1, Color color2, float amount) {
        ...
        return ColorUtil22.interpolateColorC(color1, color2, amount).getRGB();
    }
    ...
    public static int interpolateColor(int color1, int color2, float amount) {
        ...
        return ColorUtil22.interpolateColorC(cColor1, cColor2, amount).getRGB();
    }

    public static int interpolateInt(int oldValue, int newValue, double interpolationValue) {
        return ColorUtil22.interpolate(oldValue, newValue, (float)interpolationValue).intValue();
    }
    ...
    public static Color interpolateColorC(Color color1, Color color2, float amount) {
        amount = Math.min(1.0f, Math.max(0.0f, amount));
        return new Color(ColorUtil22.interpolateInt(color1.getRed(), color2.getRed(), amount), ColorUtil22.interpolateInt(color1.getGreen(), color2.getGreen(), amount), ColorUtil22.interpolateInt(color1.getBlue(), color2.getBlue(), amount), ColorUtil22.interpolateInt(color1.getAlpha(), color2.getAlpha(), amount));
    }

    public static float interpolateFloat(float oldValue, float newValue, double interpolationValue) {
        return ColorUtil22.interpolate(oldValue, newValue, (float)interpolationValue).floatValue();
    }
    ...
    public static Color interpolateColorHue(Color color1, Color color2, float amount) {
        ...
        Color resultColor = Color.getHSBColor(ColorUtil22.interpolateFloat(color1HSB[0], color2HSB[0], amount), ColorUtil22.interpolateFloat(color1HSB[1], color2HSB[1], amount), ColorUtil22.interpolateFloat(color1HSB[2], color2HSB[2], amount));
        return new Color(resultColor.getRed(), resultColor.getGreen(), resultColor.getBlue(), ColorUtil22.interpolateInt(color1.getAlpha(), color2.getAlpha(), amount));
    }
    ...
    public static int[] createColorArray(int color) {
        return new int[]{ColorUtil22.bitChangeColor(color, 16), ColorUtil22.bitChangeColor(color, 8), ColorUtil22.bitChangeColor(color, 0), ColorUtil22.bitChangeColor(color, 24)};
    }

    public static int getOppositeColor(int color) {
        int R = ColorUtil22.bitChangeColor(color, 0);
        int G = ColorUtil22.bitChangeColor(color, 8);
        int B = ColorUtil22.bitChangeColor(color, 16);
        int A = ColorUtil22.bitChangeColor(color, 24);
        R = 255 - R;
        G = 255 - G;
        B = 255 - B;
