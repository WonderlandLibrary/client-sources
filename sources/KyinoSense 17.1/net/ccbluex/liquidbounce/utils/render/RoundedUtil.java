...
import net.ccbluex.liquidbounce.utils.render.ColorUtil22;
...
public class RoundedUtil {
    ...
    public static void drawRound2(float x, float y, float width, float height, float radius, Color color) {
        RoundedUtil.drawRound2(x, y, width, height, radius, color);
    }

    public static void drawRoundTarget(float x, float y, float width, float height, float radius, int rgb) {
        RoundedUtil.drawRoundTarget(x, y, width, height, radius, rgb);
    }
    ...
    public static void drawGradientCornerLR(float x, float y, float width, float height, float radius, Color topLeft, Color bottomRight) {
        Color mixedColor = ColorUtil22.interpolateColorC(topLeft, bottomRight, 0.5f);
    ...
    public static void drawGradientCornerRL(float x, float y, float width, float height, float radius, Color bottomLeft, Color topRight) {
        Color mixedColor = ColorUtil22.interpolateColorC(topRight, bottomLeft, 0.5f);
    ...
    public static void drawRoundTarget(float x, float y, float width, float height, float radius, boolean blur, Color color) {
        GlStateManager.func_179117_G();
        GlStateManager.func_179147_l();
        GlStateManager.func_179112_b((int)770, (int)771);
        roundedShader.init();
