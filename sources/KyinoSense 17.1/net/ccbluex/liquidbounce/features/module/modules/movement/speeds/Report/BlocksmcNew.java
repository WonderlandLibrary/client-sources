...
@Metadata(mv={1, 1, 16}, bv={1, 0, 3}, k=1, xi=2, d1={"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0006\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\u0018\u00002\u00020\u0001B\u0005\u00a2\u0006\u0002\u0010\u0002J\b\u0010\u0003\u001a\u00020\u0004H\u0016J\u000e\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u0007J\b\u0010\b\u001a\u00020\u0004H\u0016J\u0010\u0010\t\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\nH\u0016J\b\u0010\u000b\u001a\u00020\u0004H\u0016J(\u0010\f\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\n2\u0006\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u000e2\u0006\u0010\u0010\u001a\u00020\u0011H\u0016\u00a8\u0006\u0012"}, d2={"Lnet/ccbluex/liquidbounce/features/module/modules/movement/speeds/Report/BlocksmcNew;", "Lnet/ccbluex/liquidbounce/features/module/modules/movement/speeds/SpeedMode;", "()V", "onDisable", "", "onJump", "event", "Lnet/ccbluex/liquidbounce/event/JumpEvent;", "onMotion", "onMove", "Lnet/ccbluex/liquidbounce/event/MoveEvent;", "onUpdate", "setMotion", "baseMoveSpeed", "", "d", "b", "", "KyinoClient"})
public final class BlocksmcNew
extends SpeedMode {
    public final void onJump(@NotNull JumpEvent event) {
        Intrinsics.checkParameterIsNotNull(event, "event");
        if (BlocksmcNew.access$getMc$p$s361255530().field_71439_g != null && MovementUtils.isMoving()) {
            event.cancelEvent();
        }
    }
    ...
    public void onMotion() {
        EntityPlayerSP entityPlayerSP = BlocksmcNew.access$getMc$p$s361255530().field_71439_g;
        ...
        if (MovementUtils.isMoving()) {
            if (thePlayer.field_70122_E && thePlayer.field_70124_G) {
                ...
                if (scaffoldModule.getState()) {
                    ...
                    double d = 0.4 + (double)MovementUtils.getSpeedEffect() * 0.1;
                ...
                if (!module3.getState()) {
                    BlocksmcNew.access$getMc$p$s361255530().field_71428_T.field_74278_d = 1.07f;
                }
                MovementUtils.setMotion(MovementUtils.getSpeed(), true);
            }
        }
    }
