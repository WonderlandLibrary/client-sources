...
@ModuleInfo(name="AntiBot", description="Prevents KillAura from attacking AntiCheat bots.", category=ModuleCategory.WORLD)
public final class AntiBot
extends Module {
    public static final ListValue modeValue = new ListValue("Mode", new String[]{"Normal", "AntiCheat", "Hypixel", "Mineplex", "Syuu", "TestMatrix", "Matrix"}, "Hypixel");
    ...
    public void onUpdate(UpdateEvent updateEvent) {
        if (this.sendTimer.hasReached(3000.0)) {
            if (this.removedBots.size() != 0) {
                ClientUtils.displayChatMessage("\u00a78[\u00a79\u00a7cLoveSenseAntiBots\u00a78] \u00a73\u5df2\u7ecf\u4e3a\u60a8\u6e05\u7406\u4e86 " + this.removedBots.size() + " Bots Nya!!!");
            }
            this.removedBots.clear();
    ...
    public static boolean isBot(EntityLivingBase entity) {
        if (((String)modeValue.get()).equals("normal")) {
            ...
            AntiBot antiBot = (AntiBot)LiquidBounce.moduleManager.getModule(AntiBot.class);
