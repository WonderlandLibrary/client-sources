...
@Metadata(mv={1, 1, 16}, bv={1, 0, 3}, k=1, xi=2, d1={"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0005\u00a2\u0006\u0002\u0010\u0002J\u001b\u0010\u0003\u001a\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006H\u0016\u00a2\u0006\u0002\u0010\bJ!\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00070\n2\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006H\u0016\u00a2\u0006\u0002\u0010\u000b\u00a8\u0006\f"}, d2={"Lnet/ccbluex/liquidbounce/features/command/commands/EnchantCommand;", "Lnet/ccbluex/liquidbounce/features/command/Command;", "()V", "execute", "", "args", "", "", "([Ljava/lang/String;)V", "tabComplete", "", "([Ljava/lang/String;)Ljava/util/List;", "KyinoClient"})
...
extends Command {
    ...
    public void execute(@NotNull String[] args2) {
        ...
        if (args2.length > 2) {
            ...
            int n2;
            ItemStack item;
            PlayerControllerMP playerControllerMP = EnchantCommand.access$getMc$p$s1046033730().field_71442_b;
            ...
            EntityPlayerSP entityPlayerSP = EnchantCommand.access$getMc$p$s1046033730().field_71439_g;
            ItemStack itemStack = item = entityPlayerSP != null ? entityPlayerSP.func_70694_bm() : null;
            ...
            try {
                ...
                Enchantment enchantment = Enchantment.func_180305_b((String)args2[1]);
                if (enchantment == null) {
            ...
            Minecraft minecraft = EnchantCommand.access$getMc$p$s1046033730();
            Intrinsics.checkExpressionValueIsNotNull(minecraft, "mc");
            NetHandlerPlayClient netHandlerPlayClient = minecraft.func_147114_u();
            EntityPlayerSP entityPlayerSP2 = EnchantCommand.access$getMc$p$s1046033730().field_71439_g;
    ...
    public List<String> tabComplete(@NotNull String[] args2) {
        ...
        switch (args2.length) {
            case 1: {
                ...
                Set set = Enchantment.func_181077_c();
                Intrinsics.checkExpressionValueIsNotNull(set, "Enchantment.func_181077_c()");
                ...
                for (Object item$iv$iv : $this$mapTo$iv$iv) {
                    ...
                    Intrinsics.checkExpressionValueIsNotNull(v1.func_110623_a(), "it.resourcePath");
                    boolean bl3 = false;
