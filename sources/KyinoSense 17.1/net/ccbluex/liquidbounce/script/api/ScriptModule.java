...
extends Module {
    ...
    static {
        $$delegatedProperties = new KProperty[]{Reflection.property1(new PropertyReference1Impl(Reflection.getOrCreateKotlinClass(ScriptModule.class), "settings", "getSettings()Ljava/util/LinkedHashMap;"))};
    }
