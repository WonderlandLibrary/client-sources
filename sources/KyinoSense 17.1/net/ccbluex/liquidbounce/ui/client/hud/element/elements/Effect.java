...
extends Element {
    ...
    protected Border draw() {
        ...
        int y = 0;
        for (PotionEffect potionEffect : Effect.mc.field_71439_g.func_70651_bq()) {
            int potionMaxTime;
            int potionTime;
            ...
            boolean flag = true;
            for (PotionEffect checkEffect : Effect.mc.field_71439_g.func_70651_bq()) {
            ...
            Fonts.font35.drawString(name + " " + this.intToRomanByGreedy(potionEffect.func_76458_c() + 1), 29.0f, posY - (float)Effect.mc.field_71466_p.field_78288_b, realpha.reAlpha(Colors.WHITE.c, 0.8f));
            Fonts.font35.drawString(Potion.func_76389_a((PotionEffect)potionEffect), 29.0f, posY + 4.0f, realpha.reAlpha(new Color(200, 200, 200).getRGB(), 0.5f));
            if (potion.func_76400_d()) {
                ...
                Effect.mc.field_71456_v.func_175174_a(6.0f, (float)(position + 1), statusIconIndex % 8 * 18, 198 + statusIconIndex / 8 * 18, 18, 18);
