...
extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        RenderUtils.drawGradientSideways((float)panel.getX() - 3.0f, panel.getY(), (float)panel.getX() + (float)panel.getWidth() + 3.0f, (float)panel.getY() + 19.0f, new Color(0, 0, 0, 150).getRGB(), new Color(0, 0, 0, 120).getRGB());
        if (panel.getFade() > 0) {
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        int guiColor = RenderUtils.Astolfo(0);
        GlStateManager.func_179117_G();
