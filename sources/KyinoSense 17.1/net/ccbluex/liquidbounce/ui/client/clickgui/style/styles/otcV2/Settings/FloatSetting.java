...
extends Downward<FloatValue> {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        double percentBar = ((double)((Float)((FloatValue)this.setting).get()).floatValue() - (double)((FloatValue)this.setting).getMinimum()) / (double)(((FloatValue)this.setting).getMaximum() - ((FloatValue)this.setting).getMinimum());
