...
extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        RenderUtils.drawGradientSideways((float)panel.getX() - 3.0f, panel.getY(), (float)panel.getX() + (float)panel.getWidth() + 3.0f, (float)panel.getY() + 19.0f, ClickGUI.generateColor().getRGB(), new Color(ClickGUI.generateColor().getRed(), ClickGUI.generateColor().getGreen(), ClickGUI.generateColor().getBlue(), 50).getRGB());
        if (panel.getFade() > 0) {
        ...
        float textWidth = Fonts.minecraftFont.func_78256_a("\u00a7f" + StringUtils.func_76338_a((String)panel.getName()));
        Fonts.minecraftFont.func_78276_b("\u00a7f" + panel.getName(), (int)((float)panel.getX() - (textWidth - 93.0f) / 2.0f), panel.getY() + 7, Integer.MAX_VALUE);
    }

    @Override
    public void drawDescription(int mouseX, int mouseY, String text) {
        int textWidth = Fonts.minecraftFont.func_78256_a(text);
        RenderUtils.drawRect((float)(mouseX + 9), (float)mouseY, (float)(mouseX + textWidth + 14), (float)(mouseY + Fonts.minecraftFont.field_78288_b + 3), ClickGUI.generateColor().getRGB());
        GlStateManager.func_179117_G();
        Fonts.minecraftFont.func_78276_b(text, mouseX + 12, mouseY + Fonts.minecraftFont.field_78288_b / 2, Integer.MAX_VALUE);
    }

    @Override
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
        GlStateManager.func_179117_G();
        Fonts.minecraftFont.func_78276_b(buttonElement.getDisplayName(), (int)((float)buttonElement.getX() - ((float)Fonts.minecraftFont.func_78256_a(buttonElement.getDisplayName()) - 100.0f) / 2.0f), buttonElement.getY() + 6, buttonElement.getColor());
    }
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        GlStateManager.func_179117_G();
        Fonts.minecraftFont.func_78276_b(moduleElement.getDisplayName(), moduleElement.getX() + 3, moduleElement.getY() + 7, moduleElement.getModule().getState() ? guiColor : Integer.MAX_VALUE);
