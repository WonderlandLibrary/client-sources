...
implements GuardingDynamicLinker {
    ...
    public GuardedInvocation getGuardedInvocation(LinkRequest linkRequest, LinkerServices linkerServices) throws Exception {
        ...
        if (self != null && "call".equals(desc.getNameToken(1)) && (name = NashornBeansLinker.getFunctionalInterfaceMethodName(self.getClass())) != null) {
            ...
            return gi.replaceMethods(jdk.nashorn.internal.lookup.Lookup.MH.dropArguments(linkerServices.filterInternalObjects(gi.getInvocation()), 1, new Class[]{callType.parameterType(1)}), gi.getGuard());
        }
