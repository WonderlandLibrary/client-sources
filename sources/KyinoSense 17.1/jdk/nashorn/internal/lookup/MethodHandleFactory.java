...
public final class MethodHandleFactory {
    ...
    static void traceArgs(DebugLogger logger, String tag2, int paramStart, Object ... args2) {
    ...
    public static MethodHandle addDebugPrintout(MethodHandle mh, Object tag2) {
        return MethodHandleFactory.addDebugPrintout(null, Level.OFF, mh, 0, true, tag2);
    }

    public static MethodHandle addDebugPrintout(DebugLogger logger, Level level, MethodHandle mh, Object tag2) {
        return MethodHandleFactory.addDebugPrintout(logger, level, mh, 0, true, tag2);
    }

    public static MethodHandle addDebugPrintout(MethodHandle mh, int paramStart, boolean printReturnValue, Object tag2) {
        return MethodHandleFactory.addDebugPrintout(null, Level.OFF, mh, paramStart, printReturnValue, tag2);
    }

    public static MethodHandle addDebugPrintout(DebugLogger logger, Level level, MethodHandle mh, int paramStart, boolean printReturnValue, Object tag2) {
        MethodType type = mh.type();
        if (logger == null || !logger.isLoggable(level)) {
            return mh;
        }
        assert (TRACE != null);
        MethodHandle trace = MethodHandles.insertArguments(TRACE, 0, logger, tag2, paramStart);
