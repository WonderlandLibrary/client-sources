...
extends ClassReader {
    ...
    private String parse(byte[] bytecode) {
        ...
        block14: for (int i = 1; i < cpc; ++i) {
            int tag2 = NashornClassReader.readByte(bytecode, u);
            ++u;
            switch (tag2) {
                case 7: {
                    cp.add(new IndexInfo(cp, tag2, NashornClassReader.readShort(bytecode, u)));
                    u += 2;
                    continue block14;
                }
                case 9: 
                case 10: 
                case 11: {
                    cp.add(new IndexInfo2(cp, tag2, NashornClassReader.readShort(bytecode, u), NashornClassReader.readShort(bytecode, u + 2)));
                    u += 4;
                    continue block14;
                }
                case 8: {
                ...
                case 3: {
                    cp.add(new DirectInfo<Integer>(cp, tag2, NashornClassReader.readInt(bytecode, u)));
                    u += 4;
                    continue block14;
                }
                case 4: {
                    cp.add(new DirectInfo<Float>(cp, tag2, Float.valueOf(Float.intBitsToFloat(NashornClassReader.readInt(bytecode, u)))));
                    u += 4;
                    continue block14;
                }
                case 5: {
                    cp.add(new DirectInfo<Long>(cp, tag2, NashornClassReader.readLong(bytecode, u)));
                    cp.add(null);
                    ++i;
                    u += 8;
                    continue block14;
                ...
                case 6: {
                    cp.add(new DirectInfo<Double>(cp, tag2, Double.longBitsToDouble(NashornClassReader.readLong(bytecode, u))));
                    cp.add(null);
                    ++i;
                    u += 8;
                    continue block14;
                ...
                case 1: {
                    ...
                    cp.add(new DirectInfo<String>(cp, tag2, NashornClassReader.readUTF(u += 2, len, bytecode)));
                    u += len;
                    continue block14;
                }
                case 16: {
                ...
                case 15: {
                    ...
                    cp.add(new IndexInfo2(cp, tag2, kind, NashornClassReader.readShort(bytecode, u + 1)){
    ...
    extends Constant {
        ...
        DirectInfo(ArrayList<Constant> cp, int tag2, T info) {
            super(cp, tag2);
            this.info = info;
        }
    ...
    extends IndexInfo {
        ...
        IndexInfo2(ArrayList<Constant> cp, int tag2, int index, int index2) {
            super(cp, tag2, index);
            this.index2 = index2;
        }
    ...
    extends Constant {
        ...
        IndexInfo(ArrayList<Constant> cp, int tag2, int index) {
            super(cp, tag2);
            this.index = index;
        }
    ...
    private static abstract class Constant {
        ...
        protected Constant(ArrayList<Constant> cp, int tag2) {
            this.cp = cp;
            this.tag = tag2;
        }
