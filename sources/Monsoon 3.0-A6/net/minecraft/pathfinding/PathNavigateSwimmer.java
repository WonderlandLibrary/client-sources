...
extends PathNavigate {
    ...
    protected boolean isDirectPathBetweenPoints(Vec3 posVec31, Vec3 posVec32, int sizeX, int sizeY, int sizeZ) {
        MovingObjectPosition movingobjectposition = this.worldObj.rayTraceBlocks(posVec31, new Vec3(posVec32.x, posVec32.y + (double)this.theEntity.height * 0.5, posVec32.z), false, true, false);
