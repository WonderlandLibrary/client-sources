...
implements Packet<INetHandlerPlayServer> {
    ...
    public void readPacketData(PacketBuffer buf) throws IOException {
        ...
        this.facingX = (float)buf.readUnsignedByte() / PacketUtil.fixRightClick();
        this.facingY = (float)buf.readUnsignedByte() / PacketUtil.fixRightClick();
        this.facingZ = (float)buf.readUnsignedByte() / PacketUtil.fixRightClick();
    }
    ...
    public void writePacketData(PacketBuffer buf) throws IOException {
        ...
        buf.writeByte((int)(this.facingX * PacketUtil.fixRightClick()));
        buf.writeByte((int)(this.facingY * PacketUtil.fixRightClick()));
        buf.writeByte((int)(this.facingZ * PacketUtil.fixRightClick()));
    }
