...
extends GuiListExtended {
    ...
    protected void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_) {
        ...
        this.mc.fontRendererObj.drawString(s, (float)(p_148129_1_ + this.width / 2 - this.mc.fontRendererObj.getStringWidth(s) / 2), (float)Math.min(this.top + 3, p_148129_2_), 0xFFFFFF);
    }
