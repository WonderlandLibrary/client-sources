...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttons.clear();
        this.buttons.add(new Button(8.0f, 8.0f, Wrapper.getFont(), "Disable Aura", 8.0f, click -> {
            if (click.equals((Object)Click.LEFT) && Wrapper.getModule(Aura.class).isEnabled()) {
                Wrapper.getModule(Aura.class).toggle();
            }
        }));
        this.buttons.add(new Button(8.0f, 30.0f, Wrapper.getFont(), "Disable Stealer", 8.0f, click -> {
            if (click.equals((Object)Click.LEFT) && Wrapper.getModule(ChestStealer.class).isEnabled()) {
                Wrapper.getModule(ChestStealer.class).toggle();
            }
        }));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.buttons.forEach(b -> b.draw(mouseX, mouseY, 0));
    }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        this.buttons.forEach(b -> b.mouseClicked(mouseX, mouseY, Click.getClick(mouseButton)));
    }
