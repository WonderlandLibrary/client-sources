...
extends Gui {
    ...
    protected void drawLabelBackground(Minecraft mcIn, int p_146160_2_, int p_146160_3_) {
        if (this.labelBgEnabled) {
            ...
            GuiLabel.drawHorizontalLine(k, k + i, l, this.field_146166_p);
            GuiLabel.drawHorizontalLine(k, k + i, l + j, this.field_146165_q);
            GuiLabel.drawVerticalLine(k, l, l + j, this.field_146166_p);
            GuiLabel.drawVerticalLine(k + i, l, l + j, this.field_146165_q);
        }
    }
}
