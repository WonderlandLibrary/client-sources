...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            ...
            this.fontRendererObj.drawString(s1, (float)(i + 36 + (116 - k) / 2), (float)(j + 16 + 16), 0);
            ...
            this.fontRendererObj.drawString((Object)((Object)EnumChatFormatting.DARK_GRAY) + s2, (float)(i + 36 + (116 - i1) / 2), (float)(j + 48 + 10), 0);
            ...
            this.fontRendererObj.drawString(s4, (float)(i - j1 + this.bookImageWidth - 44), (float)(j + 16), 0);
            if (this.field_175386_A == null) {
                ...
                for (int l1 = 0; l1 < k1; ++l1) {
                    ...
                    this.fontRendererObj.drawString(ichatcomponent2.getUnformattedText(), (float)(i + 36), (float)(j + 16 + 16 + l1 * this.fontRendererObj.FONT_HEIGHT), 0);
                }
