...
implements IProgressMeter {
    ...
    private void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
        ...
        worldrenderer.pos(p_146527_1_ + 0, p_146527_2_ + 18, this.zLevel).func_181673_a((float)(p_146527_3_ + 0) * 0.0078125f, (float)(p_146527_4_ + 18) * 0.0078125f).end();
        worldrenderer.pos(p_146527_1_ + 18, p_146527_2_ + 18, this.zLevel).func_181673_a((float)(p_146527_3_ + 18) * 0.0078125f, (float)(p_146527_4_ + 18) * 0.0078125f).end();
        worldrenderer.pos(p_146527_1_ + 18, p_146527_2_ + 0, this.zLevel).func_181673_a((float)(p_146527_3_ + 18) * 0.0078125f, (float)(p_146527_4_ + 0) * 0.0078125f).end();
        worldrenderer.pos(p_146527_1_ + 0, p_146527_2_ + 0, this.zLevel).func_181673_a((float)(p_146527_3_ + 0) * 0.0078125f, (float)(p_146527_4_ + 0) * 0.0078125f).end();
        tessellator.draw();
    }
