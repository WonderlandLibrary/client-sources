...
implements IProgressMeter {
    ...
    protected void drawTitle() {
        int i = (this.width - this.field_146555_f) / 2;
        int j = (this.height - this.field_146557_g) / 2;
        this.fontRendererObj.drawString(I18n.format("gui.achievements", new Object[0]), (float)(i + 15), (float)(j + 5), 0x404040);
    }
    ...
    protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
        ...
        for (int j5 = 0; j5 < AchievementList.achievementList.size(); ++j5) {
            ...
            GuiAchievements.drawHorizontalLine(k5, j6, l5, l4);
            GuiAchievements.drawVerticalLine(j6, l5, k6, l4);
            if (k5 > j6) {
