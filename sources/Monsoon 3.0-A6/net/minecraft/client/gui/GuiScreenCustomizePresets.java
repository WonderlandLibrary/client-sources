...
extends GuiScreen {
    ...
    extends GuiSlot {
        ...
        private void func_178051_a(int p_178051_1_, int p_178051_2_, ResourceLocation p_178051_3_) {
            ...
            worldrenderer.pos(i + 0, p_178051_2_ + 32, 0.0).func_181673_a(0.0, 1.0).end();
            worldrenderer.pos(i + 32, p_178051_2_ + 32, 0.0).func_181673_a(1.0, 1.0).end();
            worldrenderer.pos(i + 32, p_178051_2_ + 0, 0.0).func_181673_a(1.0, 0.0).end();
            worldrenderer.pos(i + 0, p_178051_2_ + 0, 0.0).func_181673_a(0.0, 0.0).end();
            tessellator.draw();
        }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiScreenCustomizePresets.this.fontRendererObj.drawString(guiscreencustomizepresets$info.field_178955_a, (float)(p_180791_2_ + 32 + 10), (float)(p_180791_3_ + 14), 0xFFFFFF);
        }
    }
