...
GuiPageButtonList.GuiResponder {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.field_175339_B != 0) {
            ...
            GuiCustomizeWorldScreen.drawHorizontalLine(this.width / 2 - 91, this.width / 2 + 90, 99.0, -2039584);
            GuiCustomizeWorldScreen.drawHorizontalLine(this.width / 2 - 91, this.width / 2 + 90, 185.0, -6250336);
            GuiCustomizeWorldScreen.drawVerticalLine(this.width / 2 - 91, 99.0, 185.0, -2039584);
            GuiCustomizeWorldScreen.drawVerticalLine(this.width / 2 + 90, 99.0, 185.0, -6250336);
            float f = 85.0f;
            float f1 = 180.0f;
            ...
            worldrenderer.pos(this.width / 2 - 90, 185.0, 0.0).func_181673_a(0.0, 2.65625).color(64, 64, 64, 64).end();
            worldrenderer.pos(this.width / 2 + 90, 185.0, 0.0).func_181673_a(5.625, 2.65625).color(64, 64, 64, 64).end();
            worldrenderer.pos(this.width / 2 + 90, 100.0, 0.0).func_181673_a(5.625, 0.0).color(64, 64, 64, 64).end();
            worldrenderer.pos(this.width / 2 - 90, 100.0, 0.0).func_181673_a(0.0, 0.0).color(64, 64, 64, 64).end();
            tessellator.draw();
