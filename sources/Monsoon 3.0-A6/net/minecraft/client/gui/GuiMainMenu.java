...
implements GuiYesNoCallback {
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        ...
        this.buttonList.add(new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "Alt Login"));
    }
    ...
    private void drawPanorama(int p_73970_1_, int p_73970_2_, float p_73970_3_) {
        ...
        for (int k = 0; k < j; ++k) {
            ...
            for (int l = 0; l < 6; ++l) {
                ...
                int i1 = 255 / (k + 1);
                float f3 = 0.0f;
                worldrenderer.pos(-1.0, -1.0, 1.0).func_181673_a(0.0, 0.0).color(255, 255, 255, i1).end();
                worldrenderer.pos(1.0, -1.0, 1.0).func_181673_a(1.0, 0.0).color(255, 255, 255, i1).end();
                worldrenderer.pos(1.0, 1.0, 1.0).func_181673_a(1.0, 1.0).color(255, 255, 255, i1).end();
                worldrenderer.pos(-1.0, 1.0, 1.0).func_181673_a(0.0, 1.0).color(255, 255, 255, i1).end();
                tessellator.draw();
    ...
    private void rotateAndBlurSkybox(float p_73968_1_) {
        ...
        for (int k = 0; k < j; ++k) {
            ...
            worldrenderer.pos(l, i1, this.zLevel).func_181673_a(0.0f + f1, 1.0).func_181666_a(1.0f, 1.0f, 1.0f, f).end();
            worldrenderer.pos(l, 0.0, this.zLevel).func_181673_a(1.0f + f1, 1.0).func_181666_a(1.0f, 1.0f, 1.0f, f).end();
            worldrenderer.pos(0.0, 0.0, this.zLevel).func_181673_a(1.0f + f1, 0.0).func_181666_a(1.0f, 1.0f, 1.0f, f).end();
            worldrenderer.pos(0.0, i1, this.zLevel).func_181673_a(0.0f + f1, 0.0).func_181666_a(1.0f, 1.0f, 1.0f, f).end();
        }
        tessellator.draw();
    ...
    private void renderSkybox(int p_73971_1_, int p_73971_2_, float p_73971_3_) {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.pos(0.0, l, this.zLevel).func_181673_a(0.5f - f, 0.5f + f1).func_181666_a(1.0f, 1.0f, 1.0f, 1.0f).end();
        worldrenderer.pos(k, l, this.zLevel).func_181673_a(0.5f - f, 0.5f - f1).func_181666_a(1.0f, 1.0f, 1.0f, 1.0f).end();
        worldrenderer.pos(k, 0.0, this.zLevel).func_181673_a(0.5f + f, 0.5f - f1).func_181666_a(1.0f, 1.0f, 1.0f, 1.0f).end();
        worldrenderer.pos(0.0, 0.0, this.zLevel).func_181673_a(0.5f + f, 0.5f + f1).func_181666_a(1.0f, 1.0f, 1.0f, 1.0f).end();
        tessellator.draw();
    }
