...
extends Gui {
    ...
    private void drawCursorVertical(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
        ...
        worldrenderer.pos(p_146188_1_, p_146188_4_, 0.0).end();
        worldrenderer.pos(p_146188_3_, p_146188_4_, 0.0).end();
        worldrenderer.pos(p_146188_3_, p_146188_2_, 0.0).end();
        worldrenderer.pos(p_146188_1_, p_146188_2_, 0.0).end();
        tessellator.draw();
