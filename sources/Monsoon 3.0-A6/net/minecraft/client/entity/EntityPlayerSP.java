...
extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0, this.posZ))) {
            ...
            if (this.ticksExisted < 2) {
                Wrapper.setInitTime(0L);
            }
            EventUpdate eventUpdate = new EventUpdate();
            Wrapper.getEventBus().post(eventUpdate);
            if (this.isRiding()) {
    ...
    public void onUpdateWalkingPlayer() {
        ...
        EventPostMotion event2 = new EventPostMotion();
    ...
    public void sendChatMessage(String message) {
        EventChatMessageSent event = new EventChatMessageSent(message);
        Wrapper.getEventBus().post(event);
        ...
        block43: {
            block44: {
                ...
                if (this.sprintingTicksLeft > 0) {
                    ...
                    if (this.sprintingTicksLeft == 0 && !Wrapper.getModule(NoSlow.class).isEnabled()) {
                ...
                if (this.isUsingItem() && !this.isRiding() && !Wrapper.getModule(NoSlow.class).isEnabled()) {
                ...
                if (!this.isSprinting()) break block43;
                if (!sprint.isEnabled() || sprint.omni.getValue() == false ? this.movementInput.moveForward < f : this.movementInput.moveForward == 0.0f && this.movementInput.moveStrafe == 0.0f) break block44;
                if (!this.isCollidedHorizontally && flag3) break block43;
            }
            this.setSprinting(false);
        }
