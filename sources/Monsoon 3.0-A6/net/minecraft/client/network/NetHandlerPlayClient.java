...
implements INetHandlerPlayClient {
    ...
    public void handleEntityVelocity(S12PacketEntityVelocity packetIn) {
        ...
        if (entity != null) {
            ...
            if (entity == Minecraft.getMinecraft().thePlayer && !Wrapper.getModule(Velocity.class).isEnabled()) {
                int amount = (packetIn.getMotionX() + packetIn.getMotionY() + packetIn.getMotionZ()) / 3 / 200;
    ...
    public void handleTeams(S3EPacketTeams packetIn) {
        ...
        if (packetIn.func_149307_h() == 1 && scoreplayerteam != null) {
