...
implements IEntityRenderer {
    ...
    private void renderEntityOnFire(Entity entity, double x, double y, double z, float partialTicks) {
        ...
        while (f3 > 0.0f) {
            ...
            worldrenderer.pos(f1 - f2, 0.0f - f4, f5).func_181673_a(f8, f9).end();
            worldrenderer.pos(-f1 - f2, 0.0f - f4, f5).func_181673_a(f6, f9).end();
            worldrenderer.pos(-f1 - f2, 1.4f - f4, f5).func_181673_a(f6, f7).end();
            worldrenderer.pos(f1 - f2, 1.4f - f4, f5).func_181673_a(f8, f7).end();
            f3 -= 0.45f;
            f4 -= 0.45f;
            f1 *= 0.9f;
            f5 += 0.03f;
    ...
    private void func_180549_a(Block blockIn, double p_180549_2_, double p_180549_4_, double p_180549_6_, BlockPos pos, float p_180549_9_, float p_180549_10_, double p_180549_11_, double p_180549_13_, double p_180549_15_) {
        if (blockIn.isFullCube()) {
            ...
            if (d0 >= 0.0) {
                ...
                worldrenderer.pos(d1, d3, d4).func_181673_a(f, f2).func_181666_a(1.0f, 1.0f, 1.0f, (float)d0).end();
                worldrenderer.pos(d1, d3, d5).func_181673_a(f, f3).func_181666_a(1.0f, 1.0f, 1.0f, (float)d0).end();
                worldrenderer.pos(d2, d3, d5).func_181673_a(f1, f3).func_181666_a(1.0f, 1.0f, 1.0f, (float)d0).end();
                worldrenderer.pos(d2, d3, d4).func_181673_a(f1, f2).func_181666_a(1.0f, 1.0f, 1.0f, (float)d0).end();
            }
        }
    }
    ...
    public static void renderOffsetAABB(AxisAlignedBB boundingBox, double x, double y, double z) {
        ...
        worldrenderer.pos(boundingBox.minX, boundingBox.maxY, boundingBox.minZ).func_181663_c(0.0f, 0.0f, -1.0f).end();
        worldrenderer.pos(boundingBox.maxX, boundingBox.maxY, boundingBox.minZ).func_181663_c(0.0f, 0.0f, -1.0f).end();
        worldrenderer.pos(boundingBox.maxX, boundingBox.minY, boundingBox.minZ).func_181663_c(0.0f, 0.0f, -1.0f).end();
        worldrenderer.pos(boundingBox.minX, boundingBox.minY, boundingBox.minZ).func_181663_c(0.0f, 0.0f, -1.0f).end();
        worldrenderer.pos(boundingBox.minX, boundingBox.minY, boundingBox.maxZ).func_181663_c(0.0f, 0.0f, 1.0f).end();
        worldrenderer.pos(boundingBox.maxX, boundingBox.minY, boundingBox.maxZ).func_181663_c(0.0f, 0.0f, 1.0f).end();
        worldrenderer.pos(boundingBox.maxX, boundingBox.maxY, boundingBox.maxZ).func_181663_c(0.0f, 0.0f, 1.0f).end();
        worldrenderer.pos(boundingBox.minX, boundingBox.maxY, boundingBox.maxZ).func_181663_c(0.0f, 0.0f, 1.0f).end();
        worldrenderer.pos(boundingBox.minX, boundingBox.minY, boundingBox.minZ).func_181663_c(0.0f, -1.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.maxX, boundingBox.minY, boundingBox.minZ).func_181663_c(0.0f, -1.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.maxX, boundingBox.minY, boundingBox.maxZ).func_181663_c(0.0f, -1.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.minX, boundingBox.minY, boundingBox.maxZ).func_181663_c(0.0f, -1.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.minX, boundingBox.maxY, boundingBox.maxZ).func_181663_c(0.0f, 1.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.maxX, boundingBox.maxY, boundingBox.maxZ).func_181663_c(0.0f, 1.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.maxX, boundingBox.maxY, boundingBox.minZ).func_181663_c(0.0f, 1.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.minX, boundingBox.maxY, boundingBox.minZ).func_181663_c(0.0f, 1.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.minX, boundingBox.minY, boundingBox.maxZ).func_181663_c(-1.0f, 0.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.minX, boundingBox.maxY, boundingBox.maxZ).func_181663_c(-1.0f, 0.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.minX, boundingBox.maxY, boundingBox.minZ).func_181663_c(-1.0f, 0.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.minX, boundingBox.minY, boundingBox.minZ).func_181663_c(-1.0f, 0.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.maxX, boundingBox.minY, boundingBox.minZ).func_181663_c(1.0f, 0.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.maxX, boundingBox.maxY, boundingBox.minZ).func_181663_c(1.0f, 0.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.maxX, boundingBox.maxY, boundingBox.maxZ).func_181663_c(1.0f, 0.0f, 0.0f).end();
        worldrenderer.pos(boundingBox.maxX, boundingBox.minY, boundingBox.maxZ).func_181663_c(1.0f, 0.0f, 0.0f).end();
        tessellator.draw();
    ...
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
        ...
        EventRenderVanillaNametag event = new EventRenderVanillaNametag((Entity)entityIn);
        ...
        if (d0 <= (double)(maxDistance * maxDistance)) {
            ...
            worldrenderer.pos(-j - 1, -1 + i, 0.0).func_181666_a(0.0f, 0.0f, 0.0f, 0.25f).end();
            worldrenderer.pos(-j - 1, 8 + i, 0.0).func_181666_a(0.0f, 0.0f, 0.0f, 0.25f).end();
            worldrenderer.pos(j + 1, 8 + i, 0.0).func_181666_a(0.0f, 0.0f, 0.0f, 0.25f).end();
            worldrenderer.pos(j + 1, -1 + i, 0.0).func_181666_a(0.0f, 0.0f, 0.0f, 0.25f).end();
            tessellator.draw();
            GlStateManager.enableTexture2D();
            fontrenderer.drawString(str, (float)(-fontrenderer.getStringWidth(str) / 2), (float)i, 0x20FFFFFF);
