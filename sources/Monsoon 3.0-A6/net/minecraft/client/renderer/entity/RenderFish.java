...
extends Render<EntityFishHook> {
    ...
    public void doRender(EntityFishHook entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        worldrenderer.pos(-0.5, -0.5, 0.0).func_181673_a(0.0625, 0.1875).func_181663_c(0.0f, 1.0f, 0.0f).end();
        worldrenderer.pos(0.5, -0.5, 0.0).func_181673_a(0.125, 0.1875).func_181663_c(0.0f, 1.0f, 0.0f).end();
        worldrenderer.pos(0.5, 0.5, 0.0).func_181673_a(0.125, 0.125).func_181663_c(0.0f, 1.0f, 0.0f).end();
        worldrenderer.pos(-0.5, 0.5, 0.0).func_181673_a(0.0625, 0.125).func_181663_c(0.0f, 1.0f, 0.0f).end();
        tessellator.draw();
        ...
        if (entity.angler != null) {
            ...
            for (int l = 0; l <= 16; ++l) {
                ...
                worldrenderer.pos(x + d9 * (double)f10, y + d11 * (double)(f10 * f10 + f10) * 0.5 + 0.25, z + d12 * (double)f10).color(0, 0, 0, 255).end();
            }
            tessellator.draw();
