...
implements IResourceManagerReloadListener {
    ...
    private void renderEffect(IBakedModel model) {
        if (!(Config.isCustomItems() && !CustomItems.isUseGlint() || Config.isShaders() && Shaders.isShadowPass)) {
            ...
            EventEnchantColour colour = new EventEnchantColour(new Color(-8372020));
            Wrapper.getEventBus().post(colour);
            this.renderModel(model, colour.getColour().getRGB());
            GlStateManager.popMatrix();
            GlStateManager.pushMatrix();
            GlStateManager.scale(8.0f, 8.0f, 8.0f);
    ...
    private void func_181565_a(WorldRenderer p_181565_1_, int p_181565_2_, int p_181565_3_, int p_181565_4_, int p_181565_5_, int p_181565_6_, int p_181565_7_, int p_181565_8_, int p_181565_9_) {
        p_181565_1_.begin(7, DefaultVertexFormats.ITEM);
        p_181565_1_.pos(p_181565_2_ + 0, p_181565_3_ + 0, 0.0).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).end();
        p_181565_1_.pos(p_181565_2_ + 0, p_181565_3_ + p_181565_5_, 0.0).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).end();
        p_181565_1_.pos(p_181565_2_ + p_181565_4_, p_181565_3_ + p_181565_5_, 0.0).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).end();
        p_181565_1_.pos(p_181565_2_ + p_181565_4_, p_181565_3_ + 0, 0.0).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).end();
