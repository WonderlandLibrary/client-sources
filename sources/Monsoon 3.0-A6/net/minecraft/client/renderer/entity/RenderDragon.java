...
extends RenderLiving<EntityDragon> {
    ...
    protected void drawRechargeRay(EntityDragon dragon, double p_180574_2_, double p_180574_4_, double p_180574_6_, float p_180574_8_) {
        ...
        for (int j = 0; j <= 8; ++j) {
            ...
            worldrenderer.pos(f9 * 0.2f, f10 * 0.2f, 0.0).func_181673_a(f11, f8).color(0, 0, 0, 255).end();
            worldrenderer.pos(f9, f10, f6).func_181673_a(f11, f7).color(255, 255, 255, 255).end();
        }
        tessellator.draw();
