            ...
            for (int j = 0; j < 3; ++j) {
                ...
                for (int i1 = k; i1 >= l; --i1) {
                    ...
                    for (int j1 = 0; j1 < 5; ++j1) {
                        ...
                        worldrenderer.pos(d10 + d2, y + (double)(i1 * 16), d11 + d3).func_181666_a(0.45f, 0.45f, 0.5f, 0.3f).end();
                        worldrenderer.pos(d8 + d4, y + (double)((i1 + 1) * 16), d9 + d5).func_181666_a(0.45f, 0.45f, 0.5f, 0.3f).end();
                    }
                    tessellator.draw();
                }
            }
