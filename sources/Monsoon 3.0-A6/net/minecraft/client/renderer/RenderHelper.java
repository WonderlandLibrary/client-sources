...
public class RenderHelper {
    ...
    public static void enableStandardItemLighting() {
        ...
        float f1 = 0.6f;
        float f2 = 0.0f;
        GL11.glLight((int)16384, (int)4611, (FloatBuffer)RenderHelper.setColorBuffer(RenderHelper.LIGHT0_POS.x, RenderHelper.LIGHT0_POS.y, RenderHelper.LIGHT0_POS.z, 0.0));
        ...
        GL11.glLight((int)16385, (int)4611, (FloatBuffer)RenderHelper.setColorBuffer(RenderHelper.LIGHT1_POS.x, RenderHelper.LIGHT1_POS.y, RenderHelper.LIGHT1_POS.z, 0.0));
