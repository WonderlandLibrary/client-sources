...
IPlayerUsage {
    ...
    private final Animation blurAnimation = new Animation(() -> Float.valueOf(400.0f), false, () -> Easing.LINEAR);
    private final Animation gradientAnimation = new Animation(() -> Float.valueOf(400.0f), false, () -> Easing.LINEAR);
    private boolean enableDebugMode = false;
    long lastFrame = Sys.getTime() * 1000L / Sys.getTimerResolution();

    public Minecraft(GameConfiguration gameConfig, boolean enableDebugMode) {
        theMinecraft = this;
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        Wrapper.init(this.enableDebugMode);
        Wrapper.setSessionTime(System.currentTimeMillis());
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle((String)"Monsoon (Loading)");
        try {
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException {
        ...
        worldrenderer.pos(0.0, this.displayHeight, 0.0).func_181673_a(0.0, 0.0).color(255, 255, 255, 255).end();
        worldrenderer.pos(this.displayWidth, this.displayHeight, 0.0).func_181673_a(0.0, 0.0).color(255, 255, 255, 255).end();
        worldrenderer.pos(this.displayWidth, 0.0, 0.0).func_181673_a(0.0, 0.0).color(255, 255, 255, 255).end();
        worldrenderer.pos(0.0, 0.0, 0.0).func_181673_a(0.0, 0.0).color(255, 255, 255, 255).end();
        tessellator.draw();
    ...
    public void func_181536_a(int p_181536_1_, int p_181536_2_, int p_181536_3_, int p_181536_4_, int p_181536_5_, int p_181536_6_, int p_181536_7_, int p_181536_8_, int p_181536_9_, int p_181536_10_) {
        ...
        worldrenderer.begin(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.pos(p_181536_1_, p_181536_2_ + p_181536_6_, 0.0).func_181673_a((float)p_181536_3_ * f, (float)(p_181536_4_ + p_181536_6_) * f1).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).end();
        worldrenderer.pos(p_181536_1_ + p_181536_5_, p_181536_2_ + p_181536_6_, 0.0).func_181673_a((float)(p_181536_3_ + p_181536_5_) * f, (float)(p_181536_4_ + p_181536_6_) * f1).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).end();
        worldrenderer.pos(p_181536_1_ + p_181536_5_, p_181536_2_, 0.0).func_181673_a((float)(p_181536_3_ + p_181536_5_) * f, (float)p_181536_4_ * f1).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).end();
        worldrenderer.pos(p_181536_1_, p_181536_2_, 0.0).func_181673_a((float)p_181536_3_ * f, (float)p_181536_4_ * f1).color(p_181536_7_, p_181536_8_, p_181536_9_, p_181536_10_).end();
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        this.gradientAnimation.setState(guiScreenIn instanceof WindowGUI);
        this.blurAnimation.setState(guiScreenIn != null);
        if (this.currentScreen != null) {
            this.currentScreen.onGuiClosed();
            if (Screen.class.isAssignableFrom(this.currentScreen.getClass())) {
                Wrapper.getGlgui().onClose();
            }
        }
    ...
    private void runGameLoop() throws IOException {
        long currentTime = Sys.getTime() * 1000L / Sys.getTimerResolution();
    ...
    public int getLimitFramerate() {
        if (this.theWorld != null && this.currentScreen != null) {
            return MathHelper.clamp_int(this.gameSettings.limitFramerate, 0, 240);
        }
        return this.theWorld == null && this.currentScreen != null ? MathHelper.clamp_int(this.gameSettings.limitFramerate, 0, 240) : this.gameSettings.limitFramerate;
    }
    ...
    private void displayDebugInfo(long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            worldrenderer.pos((float)j - (float)i * 1.1f, (float)k - (float)i * 0.6f - 16.0f, 0.0).color(200, 0, 0, 0).end();
            worldrenderer.pos((float)j - (float)i * 1.1f, k + i * 2, 0.0).color(200, 0, 0, 0).end();
            worldrenderer.pos((float)j + (float)i * 1.1f, k + i * 2, 0.0).color(200, 0, 0, 0).end();
            worldrenderer.pos((float)j + (float)i * 1.1f, (float)k - (float)i * 0.6f - 16.0f, 0.0).color(200, 0, 0, 0).end();
            tessellator.draw();
            ...
            for (int l = 0; l < list.size(); ++l) {
                ...
                int l1 = j1 >> 8 & 0xFF;
                int i2 = j1 & 0xFF;
                worldrenderer.pos(j, k, 0.0).color(k1, l1, i2, 255).end();
                for (int j2 = i1; j2 >= 0; --j2) {
                    ...
                    worldrenderer.pos((float)j + f1, (float)k - f2, 0.0).color(k1, l1, i2, 255).end();
                }
                tessellator.draw();
                ...
                for (int i3 = i1; i3 >= 0; --i3) {
                    ...
                    worldrenderer.pos((float)j + f4, (float)k - f5, 0.0).color(k1 >> 1, l1 >> 1, i2 >> 1, 255).end();
                    worldrenderer.pos((float)j + f4, (float)k - f5 + 10.0f, 0.0).color(k1 >> 1, l1 >> 1, i2 >> 1, 255).end();
                }
                tessellator.draw();
            ...
            this.fontRendererObj.drawStringWithShadow(s, (float)(j + i - this.fontRendererObj.getStringWidth(s)), (float)(k - i / 2 - 16), l2);
            for (int k2 = 0; k2 < list.size(); ++k2) {
                ...
                this.fontRendererObj.drawStringWithShadow(s1, (float)(j + i - 50 - this.fontRendererObj.getStringWidth(s1)), (float)(k + i / 2 + k2 * 8 + 20), profiler$result2.func_76329_a());
                s1 = decimalformat.format(profiler$result2.field_76330_b) + "%";
                this.fontRendererObj.drawStringWithShadow(s1, (float)(j + i - this.fontRendererObj.getStringWidth(s1)), (float)(k + i / 2 + k2 * 8 + 20), profiler$result2.func_76329_a());
            }
        }
    }
    ...
    public void clickMouse() {
        if (this.leftClickCounter <= 0) {
            if (this.objectMouseOver != null && !this.objectMouseOver.typeOfHit.equals((Object)MovingObjectPosition.MovingObjectType.ENTITY)) {
                this.thePlayer.swingItem();
            }
    ...
    private void resize(int width, int height) {
        ...
        this.loadingScreen = new LoadingScreenRenderer(this);
        this.updateFramebufferSize();
        Wrapper.getGlgui().resize(width, height);
    }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (this.currentScreen != null) {
                    ...
                    Wrapper.getEventBus().post(eventKey);
                    if (k == 1) {
    ...
    public Animation getBlurAnimation() {
        return this.blurAnimation;
    }

    public Animation getGradientAnimation() {
        return this.gradientAnimation;
    }
}
