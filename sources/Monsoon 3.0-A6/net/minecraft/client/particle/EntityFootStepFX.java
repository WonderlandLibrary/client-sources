...
extends EntityFX {
    ...
    public void renderParticle(WorldRenderer worldRendererIn, Entity entityIn, float partialTicks, float p_180434_4_, float p_180434_5_, float p_180434_6_, float p_180434_7_, float p_180434_8_) {
        ...
        worldRendererIn.pos(f3 - 0.125f, f4, f5 + 0.125f).func_181673_a(0.0, 1.0).func_181666_a(f6, f6, f6, f1).end();
        worldRendererIn.pos(f3 + 0.125f, f4, f5 + 0.125f).func_181673_a(1.0, 1.0).func_181666_a(f6, f6, f6, f1).end();
        worldRendererIn.pos(f3 + 0.125f, f4, f5 - 0.125f).func_181673_a(1.0, 0.0).func_181666_a(f6, f6, f6, f1).end();
        worldRendererIn.pos(f3 - 0.125f, f4, f5 - 0.125f).func_181673_a(0.0, 0.0).func_181666_a(f6, f6, f6, f1).end();
