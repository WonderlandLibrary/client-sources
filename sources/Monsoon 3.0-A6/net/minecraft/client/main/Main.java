...
public class Main {
    public static void main(String[] args) {
        boolean found = false;
        for (String s : args) {
            if (!s.equals("launchedCorrectlyYouMonkey")) continue;
            found = true;
        }
        if (!found) {
            System.out.println("Launched incorrectly! Remember to use net/minecraft/client/main/WrappedLaunchLauncher");
        }
        ...
        boolean enableDebugMode = list.contains("debugmode");
        ...
        if (enableDebugMode) {
            System.out.println("Launching Monsoon in debug mode...");
        }
        new Minecraft(gameconfiguration, enableDebugMode).run();
    }
