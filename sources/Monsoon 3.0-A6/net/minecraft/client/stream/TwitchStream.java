    ...
    public void func_152922_k() {
        if (this.broadcastController.isBroadcasting() && !this.broadcastController.isBroadcastPaused()) {
            ...
            if (flag) {
                ...
                worldrenderer.pos(0.0, f1, 0.0).func_181673_a(0.0, f3).end();
                worldrenderer.pos(f, f1, 0.0).func_181673_a(f2, f3).end();
                worldrenderer.pos(f, 0.0, 0.0).func_181673_a(f2, 0.0).end();
                worldrenderer.pos(0.0, 0.0, 0.0).func_181673_a(0.0, 0.0).end();
                tessellator.draw();
