...
public class Framebuffer {
    ...
    public static Framebuffer create(Framebuffer fb) {
    ...
    public void framebufferRenderExt(int p_178038_1_, int p_178038_2_, boolean p_178038_3_) {
        if (OpenGlHelper.isFramebufferEnabled()) {
            ...
            worldrenderer.pos(0.0, f1, 0.0).func_181673_a(0.0, 0.0).color(255, 255, 255, 255).end();
            worldrenderer.pos(f, f1, 0.0).func_181673_a(f2, 0.0).color(255, 255, 255, 255).end();
            worldrenderer.pos(f, 0.0, 0.0).func_181673_a(f2, f3).color(255, 255, 255, 255).end();
            worldrenderer.pos(0.0, 0.0, 0.0).func_181673_a(0.0, f3).color(255, 255, 255, 255).end();
            tessellator.draw();
            this.unbindFramebufferTexture();
