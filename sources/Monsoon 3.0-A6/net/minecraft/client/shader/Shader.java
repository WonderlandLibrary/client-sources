...
public class Shader {
    ...
    public void loadShader(float p_148042_1_) {
        ...
        worldrenderer.pos(0.0, f1, 500.0).color(255, 255, 255, 255).end();
        worldrenderer.pos(f, f1, 500.0).color(255, 255, 255, 255).end();
        worldrenderer.pos(f, 0.0, 500.0).color(255, 255, 255, 255).end();
        worldrenderer.pos(0.0, 0.0, 500.0).color(255, 255, 255, 255).end();
        tessellator.draw();
