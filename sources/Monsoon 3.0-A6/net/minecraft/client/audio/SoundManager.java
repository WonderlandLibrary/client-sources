...
public class SoundManager {
    ...
    public void playSound(ISound sound) {
        ...
        if (this.loaded && !(this.sndSystem.getMasterVolume() <= 0.0f) && (soundeventaccessorcomposite = this.sndHandler.getSound(sound.getSoundLocation())) != null && (soundpoolentry = soundeventaccessorcomposite.cloneEntry()) != SoundHandler.missing_sound) {
