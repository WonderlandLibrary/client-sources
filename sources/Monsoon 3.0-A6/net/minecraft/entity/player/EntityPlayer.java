        ...
        if (itemStackIn.getItemUseAction() == EnumAction.EAT) {
            for (int i = 0; i < p_71010_2_; ++i) {
                ...
                if (itemStackIn.getHasSubtypes()) {
                    this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, vec31.x, vec31.y, vec31.z, vec3.x, vec3.y + 0.05, vec3.z, Item.getIdFromItem(itemStackIn.getItem()), itemStackIn.getMetadata());
                    continue;
                }
                this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, vec31.x, vec31.y, vec31.z, vec3.x, vec3.y + 0.05, vec3.z, Item.getIdFromItem(itemStackIn.getItem()));
            }
