...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        double d6 = (float)CommandParticle.parseDouble(vec3.x, args[1], true);
        double d0 = (float)CommandParticle.parseDouble(vec3.y, args[2], true);
        double d1 = (float)CommandParticle.parseDouble(vec3.z, args[3], true);
