...
public class ShadersRender {
    ...
    public static boolean renderEndPortal(TileEntityEndPortal te, double x, double y, double z, float partialTicks, int destroyStage, float offset) {
        ...
        int i = 240;
        worldrenderer.pos(x, y + (double)offset, z + 1.0).func_181666_a(f1, f2, f3, 1.0f).func_181673_a(f4 + f6, f4 + f6).func_181671_a(i, i).end();
        worldrenderer.pos(x + 1.0, y + (double)offset, z + 1.0).func_181666_a(f1, f2, f3, 1.0f).func_181673_a(f4 + f6, f5 + f6).func_181671_a(i, i).end();
        worldrenderer.pos(x + 1.0, y + (double)offset, z).func_181666_a(f1, f2, f3, 1.0f).func_181673_a(f5 + f6, f5 + f6).func_181671_a(i, i).end();
        worldrenderer.pos(x, y + (double)offset, z).func_181666_a(f1, f2, f3, 1.0f).func_181673_a(f5 + f6, f4 + f6).func_181671_a(i, i).end();
        tessellator.draw();
