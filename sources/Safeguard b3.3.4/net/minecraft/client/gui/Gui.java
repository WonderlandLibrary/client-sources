...
public class Gui
{
     ...
     */
    public static void drawRect(double e, double offset, double f, double d, int color)
    {
        double var5;
        ...
        var10.addVertex((double)e, (double)d, 0.0D);
        var10.addVertex((double)f, (double)d, 0.0D);
        var10.addVertex((double)f, (double)offset, 0.0D);
        var10.addVertex((double)e, (double)offset, 0.0D);
        var9.draw();
