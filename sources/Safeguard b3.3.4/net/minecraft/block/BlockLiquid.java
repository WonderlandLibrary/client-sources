...
public abstract class BlockLiquid extends Block
{
    ...
    public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state)
    {
    	...
    	if(mc.thePlayer != null && mc.theWorld != null && Jesus.jesus && !mc.thePlayer.isInLiquid && !mc.thePlayer.isSneaking() && !Jesus.mode.getMode().equalsIgnoreCase("NCP")) {
