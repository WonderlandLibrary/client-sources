...
public class GuiSpamText extends GuiScreen {
  private String status;
  
  private GuiTextField loginField;
  
  public void initGui() {
    this.status = "Text: " + Spammer.spamText;
  ...
  protected void actionPerformed(GuiButton button) throws IOException {
    if (button.id == 0) {
      Spammer.spamText = this.loginField.getText();
      this.status = "Text: " + Spammer.spamText;
    } else if (button.id == 1) {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    drawCenteredString(this.fontRendererObj, "Spammer", (this.width / 2), 10.0F, -1);
    drawCenteredString(this.fontRendererObj, "Text: " + Spammer.spamText, (this.width / 2), 20.0F, -1);
