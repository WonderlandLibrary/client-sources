...
public final class EventManager {
    ...
    /**
     * Registers all the methods marked with the SubscribeEvent annotation in the class of the given Object.
     *
     * @param object
    ...
    /**
     * Registers the methods marked with the SubscribeEvent annotation and that require
    ...
    /**
     * Unregisters all the methods inside the Object that are marked with the SubscribeEvent annotation.
     *
     * @param object
     ...
     * Performed checks: Checks if the parameter length is not 1 and if the SubscribeEvent annotation is not present.
     *
     * @param method
     *         Method to check.
     *
