...
import host.kix.uzi.module.modules.combat.Hitboxes;
...
public abstract class Entity implements ICommandSender {
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            double var15 = y;
            double var17 = z;
            SafeWalkEvent eventSafewalk = (SafeWalkEvent) EventManager.call(new SafeWalkEvent());
    ...
    public float getCollisionBorderSize() {
        return Uzi.getInstance().getModuleManager().find("Hitboxes").isEnabled() ? Hitboxes.size.getValue() : 0.1F;
    }
