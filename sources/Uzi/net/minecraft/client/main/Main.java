...
public class Main {
    ...
    public static void main(String[] p_main_0_) {
        ...
        Session loginSession = authenticate((String)var21.valueOf(username), (String)var21.valueOf(password));
        Session var41 = loginSession == null ? new Session((String) var11.value(var21), var37, (String) var13.value(var21), (String) var19.value(var21)) : loginSession;
    ...
    public static Session authenticate(String username, String password){
        ...
        try {
            userAuth.logIn();
            return new Session(userAuth.getSelectedProfile().getName(), userAuth.getSelectedProfile().getId().toString(), userAuth.getAuthenticatedToken(), username.contains("@") ? "mojang" : "legacy");
