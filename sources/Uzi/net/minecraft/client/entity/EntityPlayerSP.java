...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                PreMotionEvent e = new PreMotionEvent();
    ...
    public void moveEntity(double x, double y, double z) {
        MotionEvent e = new MotionEvent(x, y, z);
        EventManager.call(e);
    ...
    public void func_175161_p() {
        ...
        UpdateEvent e = new UpdateEvent(this.posY, new float[]{this.rotationYaw, this.rotationPitch}, this.onGround, this);
        EventManager.call(e);
        if (e.isCancelled()) {
            UpdateEvent e2 = new UpdateEvent();
            EventManager.call(e2);
            return;
        }
        ...
        if (this.func_175160_A()) {
            ...
            if (this.ridingEntity == null) {
                if (var13 && var14) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.posX, e.y, this.posZ, e.yaw, e.pitch, e.onGround));
                } else if (var13) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(this.posX, e.y, this.posZ, e.onGround));
                } else if (var14) {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C05PacketPlayerLook(e.yaw, e.pitch, e.onGround));
                } else {
            ...
            if (var13) {
                ...
                this.field_175166_bJ = e.y;
                this.field_175167_bK = this.posZ;
                this.field_175168_bP = 0;
            }

            if (var14) {
                this.field_175164_bL = e.yaw;
                this.field_175165_bM = e.pitch;
            }
        }
    ...
    public void sendChatMessage(String p_71165_1_) {
        SentMessageEvent e = new SentMessageEvent(p_71165_1_);
        e.checkCommands();
        EventManager.call(e);
        if (!e.isCancelled()) {
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding() && !Uzi.getInstance().getModuleManager().find("NoSlowDown").isEnabled()) {
