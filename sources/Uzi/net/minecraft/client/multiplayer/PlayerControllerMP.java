...
public class PlayerControllerMP {
    ...
    public boolean func_180512_c(BlockPos p_180512_1_, EnumFacing p_180512_2_) {
        ...
        BlockClickedEvent blockClickedEvent = new BlockClickedEvent(p_180512_1_, p_180512_2_);
        EventManager.call(blockClickedEvent);

        BlockDamageEvent blockDamageEvent = new BlockDamageEvent(p_180512_1_, p_180512_2_);
        EventManager.call(blockDamageEvent);
