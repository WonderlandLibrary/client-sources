 ...
 */
public class StaminaTheme extends Theme {
    ...
    private class WatermarkObjectRenderer extends ObjectRenderer<Watermark> {
        ...
        private void watermark() {
            ...
            mc.fontRendererObj.drawStringWithShadow("\247eU", 2, 2, -1);
            GL11.glPopMatrix();
            mc.fontRendererObj.drawStringWithShadow("\247ezi", 12, 6.5F, -1);
            GL11.glPushMatrix();
            GL11.glScaled(.5, .5, .5);
            mc.fontRendererObj.drawStringWithShadow("\247710.0", 24, 3, -1);
            GL11.glPopMatrix();
        }
