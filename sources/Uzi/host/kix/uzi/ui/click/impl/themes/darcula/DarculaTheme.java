package host.kix.uzi.ui.click.impl.themes.darcula;
...
import host.kix.uzi.ui.click.impl.themes.darcula.components.*;
...
public class DarculaTheme extends Theme {
    ...
    public DarculaTheme() {
        super("DarculaTheme", 90, 14);
        font = new NahrFont(new Font("Tahoma", Font.BOLD, 22), 22);
        keyBinding = new NahrFont("Tahoma", 12.5F);
    }
