...
/**
 * Created by Anthony on 24/07/2015.
 */
...
public class GuiMaskedTextField extends Gui
{
    ...
    public GuiMaskedTextField(FontRenderer p_i46392_1_, int p_i46392_2_, int p_i46392_3_, int p_i46392_4_, int p_i46392_5_)
    {
    ...
    public void drawTextBox()
    {
        if (this.func_146176_q())
        {
            ...
            {
                String var10 = var4.substring(var2);
                StringBuilder builder = new StringBuilder();
                for (int i = 0; i<var10.length(); i++) {
                    builder.append("*");
                }
                var10 = builder.toString();
                this.field_146211_a.drawStringWithShadow(var10, var9, var8, var1);
            }
