...
extends Gui {
    ...
    public FlatTextField(int p_i45542_1_, FontRenderer p_i45542_2_, int p_i45542_3_, int p_i45542_4_, int p_i45542_5_, int p_i45542_6_) {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                LWJGLUtil.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, -16777216);
            }
            ...
            if (var6) {
                if (var13) {
                    ...
                    this.fontRendererInstance.func_175063_a("*", this.fontRendererInstance.getStringWidth(this.getText()), var8, var1);
                }
            }
            if (var3 != var2) {
