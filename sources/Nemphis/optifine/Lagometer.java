        ...
        if (gameSettings != null && Lagometer.gameSettings.ofLagometer) {
            ...
            while (y60 < timesFrame.length) {
                ...
                if (gcs[y60]) {
                    ...
                    float f = lumMem - (float)Lagometer.renderTime(y60, timesTick[y60], 0, y30, y30, lumMem, tessellator);
                }
                ++y60;
            }
            Lagometer.renderTimeDivider(0, timesFrame.length, 33333333, 196, 196, 196, Lagometer.mc.displayHeight, tessellator);
            Lagometer.renderTimeDivider(0, timesFrame.length, 16666666, 196, 196, 196, Lagometer.mc.displayHeight, tessellator);
            tess.draw();
            GlStateManager.func_179098_w();
            y60 = Lagometer.mc.displayHeight - 80;
            y30 = Lagometer.mc.displayHeight - 160;
            Lagometer.mc.fontRendererObj.drawString("30", 2, y30 + 1, -8947849);
            Lagometer.mc.fontRendererObj.drawString("30", 1, y30, -3881788);
