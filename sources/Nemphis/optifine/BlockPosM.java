    ...
    public static Iterable getAllInBoxMutable(BlockPos from, BlockPos to) {
        ...
        return new Iterable(){
            ...
            public Iterator iterator() {
                return new AbstractIterator(BlockPos.this, posTo){
                    private BlockPosM theBlockPosM;
                    private final /* synthetic */ BlockPos val$posFrom;
                    private final /* synthetic */ BlockPos val$posTo;
                    ...
                    protected BlockPosM computeNext0() {
                        ...
                        if (bx < this.val$posTo.getX()) {
                            ++bx;
                        } else if (by < this.val$posTo.getY()) {
                            bx = this.val$posFrom.getX();
                            ++by;
                        } else if (bz < this.val$posTo.getZ()) {
                            bx = this.val$posFrom.getX();
                            by = this.val$posFrom.getY();
                            ++bz;
                        }
