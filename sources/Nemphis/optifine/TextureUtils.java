...
public class TextureUtils {
    ...
    public static void update() {
        ...
        if (mapBlocks != null) {
            ...
            iconGrassTop = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "grass_top");
            iconGrassSide = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "grass_side");
            iconGrassSideOverlay = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "grass_side_overlay");
            iconSnow = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "snow");
            iconGrassSideSnowed = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "grass_side_snowed");
            iconMyceliumSide = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "mycelium_side");
            iconMyceliumTop = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "mycelium_top");
            iconWaterStill = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "water_still");
            iconWaterFlow = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "water_flow");
            iconLavaStill = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "lava_still");
            iconLavaFlow = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "lava_flow");
            iconFireLayer0 = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "fire_layer_0");
            iconFireLayer1 = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "fire_layer_1");
            iconPortal = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "portal");
            iconGlass = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "glass");
            iconGlassPaneTop = mapBlocks.getSpriteSafe(String.valueOf(prefix) + "glass_pane_top");
            String prefixItems = "minecraft:items/";
            iconCompass = mapBlocks.getSpriteSafe(String.valueOf(prefixItems) + "compass");
            iconClock = mapBlocks.getSpriteSafe(String.valueOf(prefixItems) + "clock");
        }
    }
