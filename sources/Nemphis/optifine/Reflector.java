...
public class Reflector {
    ...
    public static /* varargs */ double callDouble(ReflectorMethod refMethod, Object ... params) {
        Method e;
        block3 : {
            try {
                e = refMethod.getTargetMethod();
        ...
        Double retVal = (Double)e.invoke(null, params);
        return retVal;
    }
    ...
    public static /* varargs */ double callDouble(Object obj, ReflectorMethod refMethod, Object ... params) {
        Method e;
        block3 : {
            try {
                e = refMethod.getTargetMethod();
    ...
    public static /* varargs */ boolean postForgeBusEvent(ReflectorConstructor constr, Object ... params) {
    ...
    public static /* varargs */ Object newInstance(ReflectorConstructor constr, Object ... params) {
    ...
    public static Method getMethod(Class cls, String methodName, Class[] paramTypes) {
        ...
        while (i < ms.length) {
            Class[] types;
            Method m = ms[i];
            if (m.getName().equals(methodName) && Reflector.matchesTypes(paramTypes, types = m.getParameterTypes())) {
                return m;
            }
            ++i;
        }
