...
public class Config {
    ...
    public static boolean isMipmaps() {
        if (Config.gameSettings.mipmapLevels > 0) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isTreesSmart() {
        if (Config.gameSettings.ofTrees == 4) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isTimeDefault() {
        if (Config.gameSettings.ofTime == 0) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isTimeNightOnly() {
        if (Config.gameSettings.ofTime == 2) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isAntialiasingConfigured() {
        if (Config.getGameSettings().ofAaLevel > 0) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isDynamicLights() {
        if (Config.gameSettings.ofDynamicLights != 3) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isDynamicLightsFast() {
        if (Config.gameSettings.ofDynamicLights == 1) {
            return true;
        }
        return false;
    }
