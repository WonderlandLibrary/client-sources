...
public class PreYggdrasilConverter {
    ...
    private static void lookupNames(MinecraftServer server, Collection names, ProfileLookupCallback callback) {
        String[] var3 = (String[])Iterators.toArray((Iterator)Iterators.filter(names.iterator(), (Predicate)new Predicate(){
            ...
            if (!var1.isSinglePlayer() && var1.isServerInOnlineMode()) {
                ...
                ProfileLookupCallback var4 = new ProfileLookupCallback(){
                    ...
                    public void onProfileLookupSucceeded(GameProfile p_onProfileLookupSucceeded_1_) {
                        MinecraftServer.this.getPlayerProfileCache().func_152649_a(p_onProfileLookupSucceeded_1_);
                ...
                PreYggdrasilConverter.lookupNames(var1, Lists.newArrayList((Object[])new String[]{p_152719_0_}), var4);
