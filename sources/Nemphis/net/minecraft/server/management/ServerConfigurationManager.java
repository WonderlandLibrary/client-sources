...
public abstract class ServerConfigurationManager {
    ...
    public EntityPlayerMP createPlayerForUser(GameProfile profile) {
        ...
        int var4 = 0;
        while (var4 < this.playerEntityList.size()) {
    ...
    public boolean canJoin(GameProfile profile) {
        if (this.whiteListEnforced && !this.ops.hasEntry((Object)profile) && !this.whiteListedPlayers.hasEntry((Object)profile)) {
            return false;
        }
        return true;
    }
    ...
    public boolean canSendCommands(GameProfile profile) {
        if (!(this.ops.hasEntry((Object)profile) || this.mcServer.isSinglePlayer() && this.mcServer.worldServers[0].getWorldInfo().areCommandsAllowed() && this.mcServer.getServerOwner().equalsIgnoreCase(profile.getName()) || this.commandsAllowedForAll)) {
            return false;
        }
        return true;
    }
    ...
    public void sendToAllNearExcept(EntityPlayer p_148543_1_, double x, double y, double z, double radius, int dimension, Packet p_148543_11_) {
        ...
        while (var12 < this.playerEntityList.size()) {
            ...
            if (var13 != p_148543_1_ && var13.dimension == dimension && (var14 = x - var13.posX) * var14 + (var16 = y - var13.posY) * var16 + (var18 = z - var13.posZ) * var18 < radius * radius) {
    ...
    public void sendChatMsgImpl(IChatComponent component, boolean isChat) {
        ...
        byte var3 = isChat ? 1 : 0;
        this.sendPacketToAllPlayers(new S02PacketChat(component, var3));
    }
