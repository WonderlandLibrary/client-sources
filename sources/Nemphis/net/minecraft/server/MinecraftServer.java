...
IPlayerUsage {
    ...
    public MinecraftServer(Proxy p_i46053_1_, File p_i46053_2_) {
        this.usageSnooper = new PlayerUsageSnooper("server", this, MinecraftServer.getCurrentTimeMillis());
        ...
        this.nanoTimeSinceStatusRefresh = 0;
    ...
    public void run() {
        try {
            if (!this.startServer()) ** GOTO lbl10
            this.currentTime = MinecraftServer.getCurrentTimeMillis();
            var1 = 0;
...
lbl-1000: // 1 sources:
        {
            ...
            if (var5 > 2000 && this.currentTime - this.timeOfLastWarning >= 15000) {
                MinecraftServer.logger.warn("Can't keep up! Did the system time change, or is the server overloaded? Running {}ms behind, skipping {} tick(s)", new Object[]{var5, var5 / 50});
                var5 = 2000;
...
lbl69: // 2 sources:
            Thread.sleep(Math.max(1, 50 - var1));
...
lbl72: // 1 sources:
    ...
    public void updateTimeLightAndEntities() {
        ...
        int var11 = 0;
        while (var11 < this.worldServers.length) {
        ...
        var11 = 0;
        while (var11 < this.playersOnline.size()) {
        ...
        if (this.worldServers != null) {
            ...
            while (var3 < this.worldServers.length) {
                if (this.worldServers[var3] != null) {
                    ...
                    playerSnooper.addClientStat("world[" + var2 + "][mode]", (Object)((Object)var5.getGameType()));
                    playerSnooper.addClientStat("world[" + var2 + "][difficulty]", (Object)((Object)var4.getDifficulty()));
    ...
    public Entity getEntityFromUuid(UUID uuid) {
        ...
        while (var4 < var3) {
            Entity var6;
            WorldServer var5 = var2[var4];
            if (var5 != null && (var6 = var5.getEntityFromUuid(uuid)) != null) {
                return var6;
            }
            ++var4;
        }
