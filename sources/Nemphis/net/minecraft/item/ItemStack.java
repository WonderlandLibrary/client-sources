...
public final class ItemStack {
    ...
    public boolean isItemEqual(ItemStack other) {
        if (other != null && this.item == other.item && this.itemDamage == other.itemDamage) {
            return true;
        }
        return false;
    }
    ...
    public List getTooltip(EntityPlayer playerIn, boolean advanced) {
        ...
        if (this.hasTagCompound()) {
            ...
            if (this.stackTagCompound.hasKey("display", 10)) {
                ...
                if (var16.getTagType("Lore") == 9 && (var183 = var16.getTagList("Lore", 8)).tagCount() > 0) {
                    var20 = 0;
                    while (var20 < var183.tagCount()) {
                        var3.add((Object)((Object)EnumChatFormatting.DARK_PURPLE) + (Object)((Object)EnumChatFormatting.ITALIC) + var183.getStringTagAt(var20));
                        ++var20;
                    }
                }
            }
        ...
        if (!(var17 = this.getAttributeModifiers()).isEmpty() && (var14 & 2) == 0) {
            ...
            for (Map.Entry var21 : var17.entries()) {
                ...
                if (var10 > 0.0) {
                    var3.add((Object)((Object)EnumChatFormatting.BLUE) + StatCollector.translateToLocalFormatted(new StringBuilder("attribute.modifier.plus.").append(var22.getOperation()).toString(), DECIMALFORMAT.format(var12), StatCollector.translateToLocal(new StringBuilder("attribute.name.").append((String)var21.getKey()).toString())));
                    continue;
                }
                if (var10 >= 0.0) continue;
                var3.add((Object)((Object)EnumChatFormatting.RED) + StatCollector.translateToLocalFormatted(new StringBuilder("attribute.modifier.take.").append(var22.getOperation()).toString(), DECIMALFORMAT.format(var12 *= -1.0), StatCollector.translateToLocal(new StringBuilder("attribute.name.").append((String)var21.getKey()).toString())));
            }
        }
        ...
        if (this.hasTagCompound() && this.stackTagCompound.hasKey("CanPlaceOn", 9) && (var14 & 16) == 0 && (var182 = this.stackTagCompound.getTagList("CanPlaceOn", 8)).tagCount() > 0) {
            var3.add("");
            var3.add((Object)((Object)EnumChatFormatting.GRAY) + StatCollector.translateToLocal("item.canPlace"));
            var20 = 0;
            while (var20 < var182.tagCount()) {
                Block var23 = Block.getBlockFromName(var182.getStringTagAt(var20));
                if (var23 != null) {
                    var3.add((Object)((Object)EnumChatFormatting.DARK_GRAY) + var23.getLocalizedName());
                } else {
                    var3.add((Object)((Object)EnumChatFormatting.DARK_GRAY) + "missingno");
    ...
    public Multimap getAttributeModifiers() {
        ...
        if (this.hasTagCompound() && this.stackTagCompound.hasKey("AttributeModifiers", 9)) {
            ...
            while (var3 < var2.tagCount()) {
                ...
                if (var5 != null && var5.getID().getLeastSignificantBits() != 0 && var5.getID().getMostSignificantBits() != 0) {
