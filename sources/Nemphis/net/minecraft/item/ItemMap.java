...
extends ItemMapBase {
    ...
    public void updateMapData(World worldIn, Entity p_77872_2_, MapData p_77872_3_) {
        if (worldIn.provider.getDimensionId() == p_77872_3_.dimension && p_77872_2_ instanceof EntityPlayer) {
            ...
            ++var10.field_82569_d;
            boolean var11 = false;
            int var12 = var7 - var9 + 1;
            while (var12 < var7 + var9) {
                if ((var12 & 15) == (var10.field_82569_d & 15) || var11) {
                    var11 = false;
                    double var13 = 0.0;
                    int var15 = var8 - var9 - 1;
                    while (var15 < var8 + var9) {
                        if (var12 >= 0 && var15 >= -1 && var12 < 128 && var15 < 128) {
                            ...
                            if (!var22.isEmpty()) {
                                ...
                                var13 = var26;
                                if (!(var15 < 0 || var16 * var16 + var17 * var17 >= var9 * var9 || var18 && (var12 + var15 & 1) == 0 || (var37 = p_77872_3_.colors[var12 + var15 * 128]) == (var38 = (byte)(var36.colorIndex * 4 + var35)))) {
