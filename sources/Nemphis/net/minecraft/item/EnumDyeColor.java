...
public enum EnumDyeColor implements IStringSerializable
{
    ...
    static {
        field_176790_q = new EnumDyeColor[EnumDyeColor.values().length];
        field_176789_r = new EnumDyeColor[EnumDyeColor.values().length];
        ...
        while (var2 < var1) {
            EnumDyeColor var3;
            EnumDyeColor.field_176790_q[var3.func_176765_a()] = var3 = var0[var2];
            EnumDyeColor.field_176789_r[var3.getDyeColorDamage()] = var3;
            ++var2;
        }
    }

    private EnumDyeColor(String p_i45786_1_, int p_i45786_2_, String p_i45786_3_, int p_i45786_4_, int p_i45786_5_, int p_i45786_6_, String p_i45786_7_, String p_i45786_8_, MapColor mapColor, EnumChatFormatting enumChatFormatting) {
        this.field_176788_s = p_i45786_3_;
        this.field_176787_t = p_i45786_4_;
        this.field_176786_u = (String)p_i45786_5_;
        this.field_176785_v = (String)p_i45786_6_;
