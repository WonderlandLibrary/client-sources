        ...
        if (stack.getMetadata() != 0) {
            ...
            if (!var6.isEmpty()) {
                ...
                for (Map.Entry var17 : var6.entries()) {
                    ...
                    if (var19 > 0.0) {
                        tooltip.add((Object)((Object)EnumChatFormatting.BLUE) + StatCollector.translateToLocalFormatted(new StringBuilder("attribute.modifier.plus.").append(var18.getOperation()).toString(), ItemStack.DECIMALFORMAT.format(var20), StatCollector.translateToLocal(new StringBuilder("attribute.name.").append((String)var17.getKey()).toString())));
                        continue;
                    }
                    if (var19 >= 0.0) continue;
                    tooltip.add((Object)((Object)EnumChatFormatting.RED) + StatCollector.translateToLocalFormatted(new StringBuilder("attribute.modifier.take.").append(var18.getOperation()).toString(), ItemStack.DECIMALFORMAT.format(var20 *= -1.0), StatCollector.translateToLocal(new StringBuilder("attribute.name.").append((String)var17.getKey()).toString())));
                }
            }
        }
    }
