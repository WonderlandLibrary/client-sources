...
public class RealmsScreen {
    ...
    public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
        int var4 = 0;
        while (var4 < this.proxy.func_154320_j().size()) {
    ...
    public static void bindFace(String p_bindFace_0_, String p_bindFace_1_) {
        ...
        if (var2 == null) {
            var2 = DefaultPlayerSkin.func_177334_a(UUIDTypeAdapter.fromString((String)p_bindFace_0_));
        }
    ...
    public static /* varargs */ String getLocalizedString(String p_getLocalizedString_0_, Object ... p_getLocalizedString_1_) {
