...
extends EntityMob {
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        this.dataWatcher.updateObject(17, Byte.valueOf(tagCompund.getBoolean("powered") ? 1 : 0));
    ...
    public boolean isAIEnabled() {
        if (this.field_175494_bm < 1 && this.worldObj.getGameRules().getGameRuleBooleanValue("doMobLoot")) {
            return true;
        }
        return false;
    }
