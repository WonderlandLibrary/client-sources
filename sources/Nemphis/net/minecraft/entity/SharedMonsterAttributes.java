...
public class SharedMonsterAttributes {
    ...
    public static final IAttribute movementSpeed = new RangedAttribute(null, "generic.movementSpeed", 0.699999988079071, 0.0, Double.MAX_VALUE).setDescription("Movement Speed").setShouldWatch(true);
