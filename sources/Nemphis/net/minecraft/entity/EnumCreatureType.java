...
public enum EnumCreatureType {
    ...
    static {
        $VALUES = new EnumCreatureType[]{MONSTER, CREATURE, AMBIENT, WATER_CREATURE};
    }

    private EnumCreatureType(String p_i1596_1_, int p_i1596_2_, String p_i1596_3_, int p_i1596_4_, Class p_i1596_5_, int p_i1596_6_, Material p_i1596_7_, boolean bl, boolean bl2) {
