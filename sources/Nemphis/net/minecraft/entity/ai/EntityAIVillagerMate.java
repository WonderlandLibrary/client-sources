...
extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        if (this.checkSufficientDoorsPresentForNewVillager() && this.villagerObj.func_175550_n(true)) {
            Entity var1 = this.worldObj.findNearestEntityWithinAABB(EntityVillager.class, this.villagerObj.getEntityBoundingBox().expand(8.0, 3.0, 8.0), this.villagerObj);
            if (var1 == null) {
                return false;
            }
            this.mate = (EntityVillager)var1;
            if (this.mate.getGrowingAge() == 0 && this.mate.func_175550_n(true)) {
                return true;
            }
            return false;
        }
    ...
    public boolean continueExecuting() {
        if (this.matingTimeout >= 0 && this.checkSufficientDoorsPresentForNewVillager() && this.villagerObj.getGrowingAge() == 0 && this.villagerObj.func_175550_n(false)) {
            return true;
        }
        return false;
    }
