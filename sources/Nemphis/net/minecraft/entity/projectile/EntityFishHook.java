        ...
        if (this.fishPosRotationIncrements > 0) {
            ...
            while (var8 < var5.size()) {
                ...
                if (var9.canBeCollidedWith() && (var9 != this.angler || this.ticksInAir >= 5)) {
                    ...
                    if (var12 != null && ((var13 = var27.distanceTo(var12.hitVec)) < var6 || var6 == 0.0)) {
                        var4 = var9;
                        var6 = var13;
                    }
                }
            ...
            if (!this.inGround) {
                ...
                this.rotationPitch = (float)(Math.atan2(this.motionY, var31) * 180.0 / 3.141592653589793);
                ...
                if (!this.worldObj.isRemote && var34 > 0.0) {
                    ...
                    if (this.ticksCatchable > 0) {
                        ...
                        if (this.ticksCatchableDelay <= 0) {
                            ...
                            var36.func_175739_a(EnumParticleTypes.WATER_BUBBLE, this.posX, var16 + 1.0f, this.posZ, (int)(1.0f + this.width * 20.0f), this.width, 0.0, this.width, 0.20000000298023224, new int[0]);
                            var36.func_175739_a(EnumParticleTypes.WATER_WAKE, this.posX, var16 + 1.0f, this.posZ, (int)(1.0f + this.width * 20.0f), this.width, 0.0, this.width, 0.20000000298023224, new int[0]);
                            ...
                            if (this.rand.nextFloat() < 0.15f) {
                                var36.func_175739_a(EnumParticleTypes.WATER_BUBBLE, var19, var40 - 0.10000000149011612, var23, 1, var39, 0.1, var18, 0.0, new int[0]);
                            }
                        ...
                        if (this.rand.nextFloat() < var16) {
                            ...
                            var36.func_175739_a(EnumParticleTypes.WATER_SPLASH, var19, var40, var23, 2 + this.rand.nextInt(2), 0.10000000149011612, 0.0, 0.10000000149011612, 0.0, new int[0]);
                        }
