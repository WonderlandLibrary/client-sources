...
public class EntityList {
    ...
    private static void addMapping(Class p_75618_0_, String p_75618_1_, int p_75618_2_) {
        ...
        if (idToClassMapping.containsKey(p_75618_2_)) {
    ...
    private static void addMapping(Class p_75614_0_, String p_75614_1_, int p_75614_2_, int p_75614_3_, int p_75614_4_) {
        ...
        entityEggs.put(p_75614_2_, new EntityEggInfo(p_75614_2_, p_75614_3_, p_75614_4_));
    }
    ...
    public static Entity createEntityByName(String p_75620_0_, World worldIn) {
        ...
        try {
            ...
            if (var3 != null) {
                var2 = (Entity)var3.getConstructor(World.class).newInstance(worldIn);
            }
        }
    ...
    public static String getStringFromID(int p_75617_0_) {
        return (String)classToStringMapping.get(EntityList.getClassFromID(p_75617_0_));
    }
    ...
    public static List func_180124_b() {
        ...
        for (String var3 : var0) {
            ...
            if ((var4.getModifiers() & 1024) == 1024) continue;
            var1.add(var3);
        }
    ...
    public static boolean func_180125_b(String p_180125_0_) {
        if (!"Player".equals(p_180125_0_) && !EntityList.func_180124_b().contains(p_180125_0_)) {
            return false;
        }
        return true;
    }
