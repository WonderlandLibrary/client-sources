...
extends Entity {
    ...
    public boolean isPotionApplicable(PotionEffect p_70687_1_) {
        int var2;
        if (this.getCreatureAttribute() == EnumCreatureAttribute.UNDEAD && ((var2 = p_70687_1_.getPotionID()) == Potion.regeneration.id || var2 == Potion.poison.id)) {
            return false;
        }
        return true;
    }
    ...
    public boolean isOnLadder() {
        ...
        if (!(var4 != Blocks.ladder && var4 != Blocks.vine || this instanceof EntityPlayer && ((EntityPlayer)this).func_175149_v())) {
            return true;
        }
        return false;
    }
    ...
    public boolean canEntityBeSeen(Entity p_70685_1_) {
        if (this.worldObj.rayTraceBlocks(new Vec3(this.posX, this.posY + (double)this.getEyeHeight(), this.posZ), new Vec3(p_70685_1_.posX, p_70685_1_.posY + (double)p_70685_1_.getEyeHeight(), p_70685_1_.posZ)) == null) {
            return true;
        }
        return false;
    }
