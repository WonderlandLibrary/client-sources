...
extends Entity {
    ...
    public void fall(float distance, float damageMultiplier) {
        ...
        if (this.hurtEntities && (var4 = MathHelper.ceiling_float_int(distance - 1.0f)) > 0) {
            ...
            if (var6 && (double)this.rand.nextFloat() < 0.05000000074505806 + (double)var4 * 0.05) {
    ...
    protected void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        this.field_175132_d = tagCompund.hasKey("Block", 8) ? Block.getBlockFromName(tagCompund.getString("Block")).getStateFromMeta(var2) : (tagCompund.hasKey("TileID", 99) ? Block.getBlockById(tagCompund.getInteger("TileID")).getStateFromMeta(var2) : Block.getBlockById(tagCompund.getByte("Tile") & 255).getStateFromMeta(var2));
