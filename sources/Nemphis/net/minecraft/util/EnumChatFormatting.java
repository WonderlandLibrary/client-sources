...
public enum EnumChatFormatting {
    ...
    private EnumChatFormatting(String p_i46291_1_, int p_i46291_2_, String p_i46291_3_, int p_i46291_4_, String p_i46291_5_, char c, int n2) {
        this(string, n, p_i46291_1_, p_i46291_2_, p_i46291_3_, (char)p_i46291_4_, false, (int)p_i46291_5_);
    }

    private EnumChatFormatting(String p_i46292_1_, int p_i46292_2_, String p_i46292_3_, int p_i46292_4_, String p_i46292_5_, char c, boolean bl) {
        this(string, n, p_i46292_1_, p_i46292_2_, p_i46292_3_, (char)p_i46292_4_, (boolean)p_i46292_5_, -1);
    }

    private EnumChatFormatting(String p_i46293_1_, int p_i46293_2_, String p_i46293_3_, int p_i46293_4_, String p_i46293_5_, char p_i46293_6_, boolean bl, int n2) {
        ...
        this.controlString = "\u00a7" + (char)p_i46293_4_;
    }
