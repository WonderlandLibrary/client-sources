...
public class MovingObjectPosition {
    ...
    public String toString() {
        return "HitResult{type=" + (Object)((Object)this.typeOfHit) + ", blockpos=" + this.field_178783_e + ", f=" + this.field_178784_b + ", pos=" + this.hitVec + ", entity=" + this.entityHit + '}';
    }
    ...
    public static enum MovingObjectType {
        ...
        private MovingObjectType(String p_i2302_1_, int p_i2302_2_, String string2, int n2) {
        }
    }
