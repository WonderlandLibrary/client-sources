...
extends ChatComponentStyle {
    ...
    public /* varargs */ ChatComponentTranslation(String translationKey, Object ... args) {
    ...
    public boolean equals(Object p_equals_1_) {
        ...
        if (Arrays.equals(this.formatArgs, var2.formatArgs) && this.key.equals(var2.key) && super.equals(p_equals_1_)) {
            return true;
        }
        return false;
    }
