    ...
    JsonSerializer {
        ...
        public IChatComponent deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) {
            ...
            if (var4.has("text")) {
                ...
                var52 = new ChatComponentScore(JsonUtils.getJsonObjectStringFieldValue(var13, "name"), JsonUtils.getJsonObjectStringFieldValue(var13, "objective"));
                if (var13.has("value")) {
                    ((ChatComponentScore)var52).func_179997_b(JsonUtils.getJsonObjectStringFieldValue(var13, "value"));
                }
            } else {
                if (!var4.has("selector")) {
                    throw new JsonParseException("Don't know how to turn " + p_deserialize_1_.toString() + " into a Component");
                }
                var52 = new ChatComponentSelector(JsonUtils.getJsonObjectStringFieldValue(var4, "selector"));
            }
            if (var4.has("extra")) {
                ...
                int var16 = 0;
                while (var16 < var14.size()) {
                    ((IChatComponent)var52).appendSibling(this.deserialize(var14.get(var16), p_deserialize_2_, p_deserialize_3_));
                    ++var16;
                }
            }
            ((IChatComponent)var52).setChatStyle((ChatStyle)p_deserialize_3_.deserialize(p_deserialize_1_, ChatStyle.class));
            return var52;
        }
