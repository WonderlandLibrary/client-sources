...
public enum EnumFacing implements IStringSerializable
{
    ...
    private EnumFacing(String p_i46016_1_, int p_i46016_2_, String indexIn, int oppositeIn, int horizontalIndexIn, int nameIn, int axisDirectionIn, String axisIn, AxisDirection directionVecIn, Axis axis, Vec3i vec3i) {
        this.index = indexIn;
        this.horizontalIndex = horizontalIndexIn;
        this.opposite = oppositeIn;
        this.name = (String)nameIn;
        this.axis = axisIn;
        this.axisDirection = (AxisDirection)axisDirectionIn;
    ...
    IStringSerializable
    {
        ...
        private Axis(String p_i46390_1_, int p_i46390_2_, String p_i46015_1_, int p_i46015_2_, String name, int plane, String string2, Plane plane2) {
            this.name = name;
        ...
        public boolean apply(EnumFacing facing) {
            if (facing != null && facing.getAxis() == this) {
                return true;
            }
            return false;
        }
    ...
    public static enum AxisDirection {
        ...
        private AxisDirection(String p_i46391_1_, int p_i46391_2_, String p_i46014_1_, int p_i46014_2_, String offset, int description, int n2, String string2) {
            this.offset = offset;
    ...
    Iterable
    {
        ...
        private Plane(String p_i46392_1_, int p_i46392_2_, String p_i46013_1_, int p_i46013_2_, String string2, int n2) {
        }
        ...
        public boolean apply(EnumFacing facing) {
            if (facing != null && facing.getAxis().getPlane() == this) {
                return true;
            }
            return false;
        }
