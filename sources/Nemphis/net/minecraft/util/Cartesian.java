...
public class Cartesian {
    ...
    implements Iterable {
        ...
        public Iterator iterator() {
            return this.iterables.length <= 0 ? Collections.singletonList(Cartesian.createArray(this.clazz, 0)).iterator() : new Object(this.clazz, this.iterables, null);
        }
        ...
        extends UnmodifiableIterator {
            ...
            private ProductIterator(Class clazz, Iterable[] iterables) {
                ...
                int var3 = 0;
                while (var3 < this.iterables.length) {
