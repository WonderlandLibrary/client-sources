...
public class CrashReportCategory {
    ...
    public static void addBlockInfo(CrashReportCategory category, BlockPos pos, final Block blockIn, int blockData) {
        ...
        category.addCrashSectionCallable("Block type", new Callable(){
            ...
            public String call() {
                try {
                    return String.format("ID #%d (%s // %s)", val$var4, blockIn.getUnlocalizedName(), blockIn.getClass().getCanonicalName());
                }
        ...
        category.addCrashSectionCallable("Block data value", new Callable(){
            ...
            public String call() {
                ...
                String var1 = String.format("%4s", Integer.toBinaryString(val$blockData)).replace(" ", "0");
                return String.format("%1$d / 0x%1$X / 0b%2$s", val$blockData, var1);
            }
        });
        category.addCrashSectionCallable("Block location", new Callable(){
            ...
            public String call() {
                return CrashReportCategory.getCoordinateInfo(BlockPos.this);
            }
        });
    }
    ...
    public static void addBlockInfo(CrashReportCategory category, BlockPos pos, IBlockState state) {
        category.addCrashSectionCallable("Block", new Callable(){
            ...
            public String func_175753_a() {
                return IBlockState.this.toString();
            }
