...
extends TileEntity {
    ...
    public void setItemValues(ItemStack p_175112_1_) {
        ...
        if (p_175112_1_.hasTagCompound() && p_175112_1_.getTagCompound().hasKey("BlockEntityTag", 10)) {
            ...
            this.baseColor = var2.hasKey("Base", 99) ? var2.getInteger("Base") : p_175112_1_.getMetadata() & 15;
        } else {
    ...
    private void func_175109_g() {
        if (this.field_175122_h == null || this.field_175123_i == null || this.field_175121_j == null) {
            if (!this.field_175119_g) {
                ...
                if (this.field_175118_f != null) {
                    int var1 = 0;
                    while (var1 < this.field_175118_f.tagCount()) {
                        ...
                        if (var3 != null) {
                            ...
                            this.field_175121_j = String.valueOf(this.field_175121_j) + var3.func_177273_b() + var4;
                        }
                        ++var1;
                    }
                }
    ...
    public static void func_175117_e(ItemStack p_175117_0_) {
        ...
        if (var1 != null && var1.hasKey("Patterns", 9) && (var2 = var1.getTagList("Patterns", 10)).tagCount() > 0) {
    ...
    public static enum EnumBannerPattern {
        ...
        private String[] field_177291_P = new String[3];
        ...
        private EnumBannerPattern(String p_i45670_1_, int p_i45670_2_, String p_i45670_3_, int p_i45670_4_, String string2, String string3) {
            this.field_177284_N = p_i45670_3_;
            this.field_177285_O = (String)p_i45670_4_;
        }

        private EnumBannerPattern(String p_i45671_1_, int p_i45671_2_, String p_i45671_3_, int p_i45671_4_, String p_i45671_5_, String string2, ItemStack itemStack) {
            this(string, n, p_i45671_1_, p_i45671_2_, p_i45671_3_, (String)p_i45671_4_);
            this.field_177290_Q = p_i45671_5_;
        }

        private EnumBannerPattern(String p_i45672_1_, int p_i45672_2_, String p_i45672_3_, int p_i45672_4_, String p_i45672_5_, String p_i45672_6_, String p_i45672_7_, String string2, String string3) {
            this(string, n, p_i45672_1_, p_i45672_2_, p_i45672_3_, (String)p_i45672_4_);
        ...
        public boolean func_177270_d() {
            if (this.field_177290_Q == null && this.field_177291_P[0] == null) {
                return false;
            }
            return true;
        }
        ...
        public static EnumBannerPattern func_177268_a(String p_177268_0_) {
            EnumBannerPattern[] var1 = EnumBannerPattern.values();
