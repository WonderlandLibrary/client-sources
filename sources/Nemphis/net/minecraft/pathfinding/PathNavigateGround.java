...
extends PathNavigate {
    ...
    protected boolean canNavigate() {
        if (!(this.theEntity.onGround || this.func_179684_h() && this.isInLiquid() || this.theEntity.isRiding() && this.theEntity instanceof EntityZombie && this.theEntity.ridingEntity instanceof EntityChicken)) {
            return false;
        }
        return true;
    }
