...
implements IUpdatePlayerListBox {
    ...
    public static enum MusicType {
        ...
        static {
            $VALUES = new MusicType[]{MENU, GAME, CREATIVE, CREDITS, NETHER, END_BOSS, END};
        }

        private MusicType(String p_i45111_1_, int p_i45111_2_, String location, int p_i45111_4_, ResourceLocation p_i45111_5_, int n2, int n3) {
