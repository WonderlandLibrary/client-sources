...
public class SoundManager {
            ...
            try {
                new Thread(new Runnable(){
                    ...
                    public void run() {
                        ...
                        SoundManager.access$1(SoundManager.this, soundManager.new SoundSystemStarterThread(null));
                ...
                if (var2 == null) {
                    ...
                    if (var3 == SoundHandler.missing_sound) {
                        ...
                        if (var7 == 0.0f) {
                            ...
                            String var12 = MathHelper.func_180182_a((Random)ThreadLocalRandom.current()).toString();
    ...
    private static URL getURLForSoundResource(ResourceLocation p_148612_0_) {
        ...
        URLStreamHandler var2 = new URLStreamHandler(){
            ...
            protected URLConnection openConnection(URL p_openConnection_1_) {
                return new URLConnection(p_openConnection_1_, ResourceLocation.this){
    ...
    static /* synthetic */ void access$1(SoundManager soundManager, SoundSystemStarterThread soundSystemStarterThread) {
        soundManager.sndSystem = soundSystemStarterThread;
    }

    static /* synthetic */ void access$2(SoundManager soundManager, boolean bl) {
        soundManager.loaded = bl;
    }
