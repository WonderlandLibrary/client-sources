...
extends ResourceLocation {
    ...
    protected /* varargs */ ModelResourceLocation(int p_i46078_1_, String ... p_i46078_2_) {
    ...
    public ModelResourceLocation(String p_i46079_1_) {
        this(0, ModelResourceLocation.func_177517_b(p_i46079_1_));
    }
    ...
    public ModelResourceLocation(String p_i46081_1_, String p_i46081_2_) {
        this(0, ModelResourceLocation.func_177517_b(String.valueOf(p_i46081_1_) + '#' + (p_i46081_2_ == null ? "normal" : p_i46081_2_)));
    }

    protected static String[] func_177517_b(String p_177517_0_) {
        String[] arrstring = new String[3];
        arrstring[1] = p_177517_0_;
