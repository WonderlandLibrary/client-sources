...
implements INetHandlerPlayClient {
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        ...
        this.clientWorldController = new WorldClient(this, new WorldSettings(0, packetIn.func_149198_e(), false, packetIn.func_149195_d(), packetIn.func_149196_i()), packetIn.func_149194_f(), packetIn.func_149192_g(), this.gameController.mcProfiler);
    ...
    public void handleEntityVelocity(S12PacketEntityVelocity packetIn) {
        ...
        ToggleableModule m = Nemphis.instance.modulemanager.getModule(NoVelocity.class);
        if (var2 != null) {
            if (Nemphis.instance.modulemanager.getModuleIsEnabled("NoVelocity")) {
                var2.setVelocity((double)packetIn.func_149411_d() / 8000.0 / 3.0, (double)packetIn.func_149410_e() / 8000.0 / 2.0, (double)packetIn.func_149409_f() / 8000.0 / 3.0);
            } else {
    ...
    public void handleDestroyEntities(S13PacketDestroyEntities packetIn) {
        PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
        int var2 = 0;
        while (var2 < packetIn.func_149098_c().length) {
    ...
    public void handleRespawn(S07PacketRespawn packetIn) {
        ...
        if (packetIn.func_149082_c() != this.gameController.thePlayer.dimension) {
            ...
            this.clientWorldController = new WorldClient(this, new WorldSettings(0, packetIn.func_149083_e(), false, this.gameController.theWorld.getWorldInfo().isHardcoreModeEnabled(), packetIn.func_149080_f()), packetIn.func_149082_c(), packetIn.func_149081_d(), this.gameController.mcProfiler);
    ...
    public void handleUpdateSign(S33PacketUpdateSign packetIn) {
        ...
        PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
        boolean var2 = false;
        if (this.gameController.theWorld.isBlockLoaded(packetIn.func_179704_a()) && (var3 = this.gameController.theWorld.getTileEntity(packetIn.func_179704_a())) instanceof TileEntitySign) {
    ...
    public void handleMapChunkBulk(S26PacketMapChunkBulk packetIn) {
        PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
        int var2 = 0;
        while (var2 < packetIn.func_149254_d()) {
        ...
        for (Map.Entry var4 : packetIn.func_148974_c().entrySet()) {
            ...
            if (var5.isAchievement() && var6 > 0) {
                if (this.field_147308_k && this.gameController.thePlayer.getStatFileWriter().writeStat(var5) == 0) {
                    ...
                    this.gameController.getTwitchStream().func_152911_a(new MetadataAchievement(var7), 0);
    ...
    public void func_175098_a(S42PacketCombatEvent p_175098_1_) {
        ...
        if (p_175098_1_.field_179776_a == S42PacketCombatEvent.Event.END_COMBAT) {
            ...
            this.gameController.getTwitchStream().func_176026_a(var6, 0 - var4, 0);
            ...
            this.gameController.getTwitchStream().func_152911_a(var5, 0);
        }
    }
    ...
    public void func_175095_a(S48PacketResourcePackSend p_175095_1_) {
        ...
        if (var2.startsWith("level://")) {
            ...
            this.gameController.addScheduledTask(new Runnable(){
                ...
                @Override
                public void run() {
                    NetHandlerPlayClient.this.gameController.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback(var3, var2){
                        private static final String __OBFID = "CL_00002622";
                        private final /* synthetic */ String val$var3;
                        private final /* synthetic */ String val$var2;

                        @Override
                        public void confirmClicked(boolean result, int id) {
                            NetHandlerPlayClient.access$2(3.this.NetHandlerPlayClient.this, Minecraft.getMinecraft());
                            if (result) {
                                ...
                                3.this.NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(this.val$var3, C19PacketResourcePackStatus.Action.ACCEPTED));
                                Futures.addCallback((ListenableFuture)3.this.NetHandlerPlayClient.this.gameController.getResourcePackRepository().func_180601_a(this.val$var2, this.val$var3), (FutureCallback)new FutureCallback(this.val$var3){
                                    private static final String __OBFID = "CL_00002621";
                                    private final /* synthetic */ String val$var3;

                                    public void onSuccess(Object p_onSuccess_1_) {
                                        1.this.3.this.NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(this.val$var3, C19PacketResourcePackStatus.Action.SUCCESSFULLY_LOADED));
                                    }

                                    public void onFailure(Throwable p_onFailure_1_) {
                                        1.this.3.this.NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(this.val$var3, C19PacketResourcePackStatus.Action.FAILED_DOWNLOAD));
                                    }
                                });
                            } else {
                                if (3.this.NetHandlerPlayClient.this.gameController.getCurrentServerData() != null) {
                                ...
                                3.this.NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(this.val$var3, C19PacketResourcePackStatus.Action.DECLINED));
                            }
    ...
    public void handleParticles(S2APacketParticles packetIn) {
        ...
        if (packetIn.func_149222_k() == 0) {
            ...
            int var18 = 0;
            while (var18 < packetIn.func_149222_k()) {
    ...
    static /* synthetic */ void access$2(NetHandlerPlayClient netHandlerPlayClient, Minecraft minecraft) {
