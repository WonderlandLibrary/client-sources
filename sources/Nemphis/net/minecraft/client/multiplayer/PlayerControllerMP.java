...
public class PlayerControllerMP {
    ...
    public float getBlockReachDistance() {
        if (Nemphis.instance.modulemanager.getModuleIsEnabled("Teleport")) {
            return 10000.0f;
        }
        return 4.5f;
    }
    ...
    private boolean func_178893_a(BlockPos p_178893_1_) {
        ...
        if (p_178893_1_.equals(this.field_178895_c) && var3) {
            return true;
        }
        return false;
    }
    ...
    public boolean interactWithEntitySendPacket(EntityPlayer playerIn, Entity targetEntity) {
        ...
        if (this.currentGameType != WorldSettings.GameType.SPECTATOR && playerIn.interactWith(targetEntity)) {
            return true;
        }
        return false;
    }
    ...
    public boolean func_178894_a(EntityPlayer p_178894_1_, Entity p_178894_2_, MovingObjectPosition p_178894_3_) {
        ...
        if (this.currentGameType != WorldSettings.GameType.SPECTATOR && p_178894_2_.func_174825_a(p_178894_1_, var4)) {
            return true;
        }
        return false;
    }
