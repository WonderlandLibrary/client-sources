...
public class EffectRenderer {
    ...
    public /* varargs */ EntityFX func_178927_a(int p_178927_1_, double p_178927_2_, double p_178927_4_, double p_178927_6_, double p_178927_8_, double p_178927_10_, double p_178927_12_, int ... p_178927_14_) {
        EntityFX var16;
        ...
        while (var8_nf < 3) {
            ...
            while (var9 < 2) {
                if (!this.fxLayers[var8][var9].isEmpty()) {
                    ...
                    int var12 = 0;
                    while (var12 < this.fxLayers[var8][var9].size()) {
    ...
    public void func_180533_a(BlockPos p_180533_1_, IBlockState p_180533_2_) {
        ...
        if (Reflector.ForgeBlock_addDestroyEffects.exists() && Reflector.ForgeBlock_isAir.exists()) {
            ...
            boolean bl = notAir = p_180533_2_.getBlock().getMaterial() != Material.air;
        }
        if (notAir) {
