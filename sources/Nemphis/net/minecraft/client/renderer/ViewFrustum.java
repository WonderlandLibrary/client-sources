...
public class ViewFrustum {
    ...
    protected void func_178158_a(IRenderChunkFactory p_178158_1_) {
        ...
        int var3 = 0;
        int var4 = 0;
        while (var4 < this.field_178165_d) {
            int var5 = 0;
            while (var5 < this.field_178168_c) {
                int var6 = 0;
                while (var6 < this.field_178166_e) {
    ...
    protected void func_178159_a(int renderDistanceChunks) {
        int var2;
        this.field_178165_d = var2 = renderDistanceChunks * 2 + 1;
    ...
    public void func_178163_a(double viewEntityX, double viewEntityZ) {
        ...
        int var8 = 0;
        while (var8 < this.field_178165_d) {
            int var9 = this.func_178157_a(var5, var7, var8);
            int var10 = 0;
            while (var10 < this.field_178166_e) {
                int var11 = this.func_178157_a(var6, var7, var10);
                int var12 = 0;
                while (var12 < this.field_178168_c) {
                    BlockPos var15;
                    int var13 = var12 * 16;
                    ...
                    if (!(posChunk.getX() == var9 && posChunk.getY() == var13 && posChunk.getZ() == var11 || (var15 = new BlockPos(var9, var13, var11)).equals(var14.func_178568_j()))) {
    ...
    protected RenderChunk func_178161_a(BlockPos p_178161_1_) {
        ...
        if (var3 >= 0 && var3 < this.field_178168_c) {
            if ((var2 %= this.field_178165_d) < 0) {
                var2 += this.field_178165_d;
            }
            if ((var4 %= this.field_178166_e) < 0) {
