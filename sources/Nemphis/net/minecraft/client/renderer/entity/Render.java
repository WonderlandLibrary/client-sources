...
public abstract class Render {
    ...
    public boolean func_177071_a(Entity p_177071_1_, ICamera p_177071_2_, double p_177071_3_, double p_177071_5_, double p_177071_7_) {
        if (p_177071_1_.isInRangeToRender3d(p_177071_3_, p_177071_5_, p_177071_7_) && (p_177071_1_.ignoreFrustumCheck || p_177071_2_.isBoundingBoxInFrustum(p_177071_1_.getEntityBoundingBox()))) {
            return true;
        }
        return false;
    }
    ...
    protected boolean func_177070_b(Entity p_177070_1_) {
        if (p_177070_1_.getAlwaysRenderNameTagForRender() && p_177070_1_.hasCustomName()) {
            return true;
        }
        return false;
    }
