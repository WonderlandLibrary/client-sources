...
extends RendererLivingEntity {
    ...
    protected boolean canRenderName(EntityLiving targetEntity) {
        if (super.canRenderName(targetEntity) && (targetEntity.getAlwaysRenderNameTagForRender() || targetEntity.hasCustomName() && targetEntity == this.renderManager.field_147941_i)) {
            return true;
        }
        return false;
    }
