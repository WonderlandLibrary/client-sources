...
public class VertexFormat {
    ...
    public VertexFormat(VertexFormat p_i46097_1_) {
        this();
        int var2 = 0;
        while (var2 < p_i46097_1_.func_177345_h()) {
    ...
    public boolean func_177347_a(int p_177347_1_) {
        if (this.field_177351_f.size() - 1 >= p_177347_1_) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        int var2 = 0;
        while (var2 < this.field_177355_b.size()) {
