...
public class VertexFormatElement {
    ...
    private final boolean func_177372_a(int p_177372_1_, EnumUseage p_177372_2_) {
        if (p_177372_1_ != 0 && p_177372_2_ != EnumUseage.UV) {
            return false;
        }
        return true;
    }
    ...
    public final boolean func_177374_g() {
        if (this.field_177380_c == EnumUseage.POSITION) {
            return true;
        }
        return false;
    }
    ...
    public static enum EnumType {
        ...
        static {
            $VALUES = new EnumType[]{FLOAT, UBYTE, BYTE, USHORT, SHORT, UINT, INT};
        }

        private EnumType(String p_i46095_1_, int p_i46095_2_, String p_i46095_3_, int p_i46095_4_, int p_i46095_5_, String string2, int n2) {
            this.field_177407_h = p_i46095_3_;
            this.field_177408_i = (String)p_i46095_4_;
    ...
    public static enum EnumUseage {
        ...
        static {
            $VALUES = new EnumUseage[]{POSITION, NORMAL, COLOR, UV, MATRIX, BLEND_WEIGHT, PADDING};
        }

        private EnumUseage(String p_i46094_1_, int p_i46094_2_, String p_i46094_3_, int n2, String string2) {
