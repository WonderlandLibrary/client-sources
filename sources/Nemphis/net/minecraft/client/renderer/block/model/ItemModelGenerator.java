...
public class ItemModelGenerator {
    ...
    private List func_178393_a(TextureAtlasSprite p_178393_1_) {
        ...
        ArrayList var4 = Lists.newArrayList();
        int var5 = 0;
        while (var5 < p_178393_1_.getFrameCount()) {
    ...
    static enum SpanFacing {
        ...
        private SpanFacing(String p_i46215_1_, int p_i46215_2_, String p_i46215_3_, int p_i46215_4_, EnumFacing p_i46215_5_, int n2, int n3) {
