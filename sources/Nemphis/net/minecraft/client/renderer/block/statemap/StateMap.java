...
extends StateMapperBase {
    ...
    protected ModelResourceLocation func_178132_a(IBlockState p_178132_1_) {
        ...
        String var3 = this.field_178142_a == null ? ((ResourceLocation)Block.blockRegistry.getNameForObject(p_178132_1_.getBlock())).toString() : this.field_178142_a.getName((Comparable)var2.remove(this.field_178142_a));
        if (this.field_178141_c != null) {
            var3 = String.valueOf(var3) + this.field_178141_c;
        }
        for (IProperty var5 : this.field_178140_d) {
            var2.remove(var5);
        }
    ...
    public static class Builder {
        ...
        public /* varargs */ Builder func_178442_a(IProperty ... p_178442_1_) {
