...
extends ChunkRenderContainer {
    ...
    private void func_178010_a() {
        if (Config.isShaders()) {
            ...
            GL11.glVertexPointer((int)3, (int)5126, (int)28, (long)0);
            GL11.glColorPointer((int)4, (int)5121, (int)28, (long)12);
            GL11.glTexCoordPointer((int)2, (int)5126, (int)28, (long)16);
            OpenGlHelper.setClientActiveTexture(OpenGlHelper.lightmapTexUnit);
            GL11.glTexCoordPointer((int)2, (int)5122, (int)28, (long)24);
