...
extends AbstractTexture {
    ...
    public void loadTexture(IResourceManager p_110551_1_) throws IOException {
        ...
        try {
            ...
            int var6 = 0;
            while (var6 < this.field_174949_h.size() && var6 < this.field_174950_i.size()) {
                InputStream var9;
                BufferedImage var10;
                String var7 = (String)this.field_174949_h.get(var6);
                MapColor var8 = ((EnumDyeColor)this.field_174950_i.get(var6)).func_176768_e();
                if (var7 != null && (var10 = TextureUtil.func_177053_a(var9 = p_110551_1_.getResource(new ResourceLocation(var7)).getInputStream())).getWidth() == var2.getWidth() && var10.getHeight() == var2.getHeight() && var10.getType() == 6) {
                    int var11 = 0;
                    while (var11 < var10.getHeight()) {
                        int var12 = 0;
                        while (var12 < var10.getWidth()) {
