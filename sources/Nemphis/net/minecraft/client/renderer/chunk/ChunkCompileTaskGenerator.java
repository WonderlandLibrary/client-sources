...
public class ChunkCompileTaskGenerator {
    ...
    public static enum Status {
        ...
        private Status(String p_i46385_1_, int p_i46385_2_, String p_i46207_1_, int p_i46207_2_, String string2, int n2) {
        }
    }
    ...
    public static enum Type {
        ...
        private Type(String p_i46386_1_, int p_i46386_2_, String p_i46206_1_, int p_i46206_2_, String string2, int n2) {
        }
    }
