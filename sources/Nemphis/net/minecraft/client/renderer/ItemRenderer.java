...
public class ItemRenderer {
    ...
    private boolean func_178107_a(Block p_178107_1_) {
        if (p_178107_1_ != null && p_178107_1_.getBlockLayer() == EnumWorldBlockLayer.TRANSLUCENT) {
            return true;
        }
        return false;
    }
    ...
    public void renderOverlays(float p_78447_1_) {
        ...
        if (!this.mc.thePlayer.func_175149_v()) {
            if (this.mc.thePlayer.isInsideOfMaterial(Material.water) && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderWaterOverlay, this.mc.thePlayer, Float.valueOf(p_78447_1_))) {
                this.renderWaterOverlayTexture(p_78447_1_);
            }
            if (this.mc.thePlayer.isBurning() && !Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, this.mc.thePlayer, Float.valueOf(p_78447_1_))) {
        ...
        if (this.itemToRender != null && var2 != null) {
            if (!this.itemToRender.getIsItemStackEqual(var2)) {
                if (Reflector.ForgeItem_shouldCauseReequipAnimation.exists()) {
                    ...
                    arrobject[0] = this.itemToRender;
                    arrobject[1] = var2;
                    arrobject[2] = this.equippedItemSlot != var1.inventory.currentItem;
                    boolean var4 = Reflector.callBoolean(this.itemToRender.getItem(), Reflector.ForgeItem_shouldCauseReequipAnimation, arrobject);
                    if (!var4) {
