...
public class BlockModelShapes {
    ...
    public void func_178124_c() {
        ...
        for (Map.Entry var2 : this.blockStateMapper.func_178446_a().entrySet()) {
    ...
    public /* varargs */ void func_178123_a(Block ... p_178123_1_) {
    ...
    private void func_178119_d() {
        ...
        this.func_178121_a(Blocks.quartz_block, new StateMapperBase(){
            ...
            protected ModelResourceLocation func_178132_a(IBlockState p_178132_1_) {
                BlockQuartz.EnumType var2 = (BlockQuartz.EnumType)((Object)p_178132_1_.getValue(BlockQuartz.VARIANT_PROP));
                switch (var2) {
                    default: {
        ...
        this.func_178121_a(Blocks.pumpkin_stem, new StateMapperBase(){
            ...
            @Override
            protected ModelResourceLocation func_178132_a(IBlockState p_178132_1_) {
                LinkedHashMap var2 = Maps.newLinkedHashMap((Map)p_178132_1_.getProperties());
        ...
        this.func_178121_a(Blocks.double_stone_slab, new StateMapperBase(){
            ...
            protected ModelResourceLocation func_178132_a(IBlockState p_178132_1_) {
                ...
                String var4 = (Boolean)p_178132_1_.getValue(BlockStoneSlab.field_176555_b) != false ? "all" : "normal";
        ...
        this.func_178121_a(Blocks.double_stone_slab2, new StateMapperBase(){
            ...
            protected ModelResourceLocation func_178132_a(IBlockState p_178132_1_) {
                ...
                var2.remove(BlockStoneSlab.field_176555_b);
                String var4 = (Boolean)p_178132_1_.getValue(BlockStoneSlabNew.field_176558_b) != false ? "all" : "normal";
                return new ModelResourceLocation(String.valueOf(var3) + "_double_slab", var4);
            }
        });
    }
