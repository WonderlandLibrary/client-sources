...
extends Gui {
    ...
    private boolean func_175236_d() {
        if (!this.mc.thePlayer.func_175140_cp() && !this.mc.gameSettings.field_178879_v) {
            return false;
        }
        return true;
    }
    ...
    protected void func_175239_b(ScaledResolution p_175239_1_) {
        ...
        while (var3 < var2.size()) {
            ...
            if (!Strings.isNullOrEmpty((String)var4)) {
    ...
    protected List call() {
        ...
        if (this.mc.theWorld != null && this.mc.theWorld.isBlockLoaded(var1)) {
            ...
            var5.add("Biome: " + var9.getBiome((BlockPos)var1, (WorldChunkManager)this.mc.theWorld.getWorldChunkManager()).biomeName);
            ...
            var5.add(String.format("Local Difficulty: %.2f (Day %d)", Float.valueOf(var7.func_180168_b()), this.mc.theWorld.getWorldTime() / 24000));
        }
    ...
    protected List func_175238_c() {
        ...
        long var7 = var3 - var5;
        Object[] arrobject = new String[7];
        Object[] arrobject2 = new Object[2];
        arrobject2[0] = System.getProperty("java.version");
        arrobject2[1] = this.mc.isJava64bit() ? 64 : 32;
        arrobject[0] = String.format("Java: %s %dbit", arrobject2);
        arrobject[1] = String.format("Mem: % 2d%% %03d/%03dMB", var7 * 100 / var1, GuiOverlayDebug.func_175240_a(var7), GuiOverlayDebug.func_175240_a(var1));
        arrobject[2] = String.format("Allocated: % 2d%% %03dMB", var3 * 100 / var1, GuiOverlayDebug.func_175240_a(var3));
        arrobject[3] = "";
        arrobject[4] = String.format("Display: %dx%d (%s)", Display.getWidth(), Display.getHeight(), GL11.glGetString((int)7936));
        arrobject[5] = GL11.glGetString((int)7937);
        arrobject[6] = GL11.glGetString((int)7938);
        ArrayList var9 = Lists.newArrayList((Object[])arrobject);
