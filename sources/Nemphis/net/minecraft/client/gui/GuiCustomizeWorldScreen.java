    ...
    public GuiCustomizeWorldScreen(GuiScreen p_i45521_1_, String p_i45521_2_) {
        this.field_175332_D = new Predicate(){
            ...
            public boolean func_178956_a(String p_178956_1_) {
                ...
                if (!(p_178956_1_.length() == 0 || var2 != null && Floats.isFinite((float)var2.floatValue()) && var2.floatValue() >= 0.0f)) {
                    return false;
                }
                return true;
            }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            switch (button.id) {
                ...
                case 301: {
                    int var2 = 0;
                    while (var2 < this.field_175349_r.getSize()) {
                        Gui var8;
                        ...
                        if ((var8 = var3.func_178021_b()) instanceof GuiButton) {
