...
extends InventoryEffectRenderer {
    ...
    protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType) {
        ...
        if (slotIn == null && selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && clickType != 5) {
            ...
            if (slotIn == this.field_147064_C) {
                ...
                this.mc.thePlayer.inventoryContainer.slotClick(slotIn == null ? slotId : CreativeSlot.access$0((CreativeSlot)((CreativeSlot)slotIn)).slotNumber, clickedButton, clickType, this.mc.thePlayer);
    ...
    private boolean needsScrollBars() {
        if (selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && CreativeTabs.creativeTabArray[selectedTabIndex].shouldHidePlayerInventory() && ((ContainerCreative)this.inventorySlots).func_148328_e()) {
            return true;
        }
        return false;
    }
    ...
    protected void func_147051_a(CreativeTabs p_147051_1_) {
        ...
        this.itemRender.func_180450_b(var10, var7 += 6, var8 += 8 + (var3 ? 1 : -1));
    ...
    extends Container {
        ...
        public boolean func_94530_a(ItemStack p_94530_1_, Slot p_94530_2_) {
            if (p_94530_2_.yDisplayPosition > 90) {
                return true;
            }
            return false;
        }
        ...
        public boolean canDragIntoSlot(Slot p_94531_1_) {
            if (!(p_94531_1_.inventory instanceof InventoryPlayer || p_94531_1_.yDisplayPosition > 90 && p_94531_1_.xDisplayPosition <= 162)) {
                return false;
            }
            return true;
        }
