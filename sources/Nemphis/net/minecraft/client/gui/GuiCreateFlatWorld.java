...
extends GuiScreen {
    ...
    private boolean func_146382_i() {
        if (this.createFlatWorldListSlotGui.field_148228_k > -1 && this.createFlatWorldListSlotGui.field_148228_k < this.theFlatGeneratorInfo.getFlatLayers().size()) {
            return true;
        }
        return false;
    }
    ...
    extends GuiSlot {
        ...
        protected boolean isSelected(int slotIndex) {
            if (slotIndex == this.field_148228_k) {
                return true;
            }
            return false;
        }
