...
extends Gui {
    ...
    public void drawLabel(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            int var6 = 0;
            while (var6 < this.field_146173_k.size()) {
                if (this.centered) {
                    ...
                    GuiLabel.drawString(this.fontRenderer, (String)this.field_146173_k.get(var6), this.field_146162_g, var5 + var6 * 10, this.field_146168_n);
                }
                ++var6;
            }
        }
