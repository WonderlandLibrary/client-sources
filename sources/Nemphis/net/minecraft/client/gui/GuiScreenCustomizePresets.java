...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiScreenCustomizePresets.drawString(this.fontRendererObj, this.field_175313_s, 50, 30, 10526880);
        GuiScreenCustomizePresets.drawString(this.fontRendererObj, this.field_175312_t, 50, 70, 10526880);
    ...
    private boolean func_175305_g() {
        if ((this.field_175311_g.field_178053_u <= -1 || this.field_175311_g.field_178053_u >= field_175310_f.size()) && this.field_175317_i.getText().length() <= 1) {
            return false;
        }
        return true;
    }

    static /* synthetic */ ListPreset access$2(GuiScreenCustomizePresets guiScreenCustomizePresets) {
    ...
    extends GuiSlot {
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
            ...
            GuiScreenCustomizePresets.this.field_175317_i.setText(((Info)GuiScreenCustomizePresets.access$0().get((int)GuiScreenCustomizePresets.access$2((GuiScreenCustomizePresets)GuiScreenCustomizePresets.this).field_178053_u)).field_178954_c.toString());
        }

        @Override
        protected boolean isSelected(int slotIndex) {
            if (slotIndex == this.field_178053_u) {
                return true;
            }
            return false;
        }
        ...
        private void func_178051_a(int p_178051_1_, int p_178051_2_, ResourceLocation p_178051_3_) {
            ...
            var9.addVertexWithUV(var4 + 0, p_178051_2_ + 32, 0.0, 0.0, 1.0);
            var9.addVertexWithUV(var4 + 32, p_178051_2_ + 32, 0.0, 1.0, 1.0);
            var9.addVertexWithUV(var4 + 32, p_178051_2_ + 0, 0.0, 1.0, 0.0);
            var9.addVertexWithUV(var4 + 0, p_178051_2_ + 0, 0.0, 0.0, 0.0);
            var8.draw();
        }

        @Override
        protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
            Info var7 = (Info)field_175310_f.get(p_180791_1_);
