...
implements ISpectatorMenuReciepient {
    ...
    private float func_175265_c() {
        long var1 = this.field_175270_h - Minecraft.getSystemTime() + 5000;
    ...
    public void func_175259_b(int p_175259_1_) {
        int var2 = this.field_175271_i.func_178648_e() + p_175259_1_;
        while (!(var2 < 0 || var2 > 8 || this.field_175271_i.func_178643_a(var2) != SpectatorMenu.field_178657_a && this.field_175271_i.func_178643_a(var2).func_178662_A_())) {
            var2 += p_175259_1_;
        }
        if (var2 >= 0 && var2 <= 8) {
