...
extends GuiScreen {
    ...
    private static /* varargs */ void func_175354_a(String p_175354_0_, Item p_175354_1_, int p_175354_2_, BiomeGenBase p_175354_3_, List p_175354_4_, FlatLayerInfo ... p_175354_5_) {
        FlatGeneratorInfo var6 = new FlatGeneratorInfo();
        int var7 = p_175354_5_.length - 1;
        while (var7 >= 0) {
    ...
    extends GuiSlot {
        ...
        protected boolean isSelected(int slotIndex) {
            if (slotIndex == this.field_148175_k) {
                return true;
            }
            return false;
        }
