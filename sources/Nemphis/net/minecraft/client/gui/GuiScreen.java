...
implements GuiYesNoCallback {
    ...
    public static boolean func_175277_d(int p_175277_0_) {
        if (p_175277_0_ == 45 && GuiScreen.isCtrlKeyDown()) {
            return true;
        }
        return false;
    }
    ...
    public static boolean func_175279_e(int p_175279_0_) {
        if (p_175279_0_ == 47 && GuiScreen.isCtrlKeyDown()) {
            return true;
        }
        return false;
    }
    ...
    public static boolean func_175280_f(int p_175280_0_) {
        if (p_175280_0_ == 46 && GuiScreen.isCtrlKeyDown()) {
            return true;
        }
        return false;
    }
    ...
    public static boolean func_175278_g(int p_175278_0_) {
        if (p_175278_0_ == 30 && GuiScreen.isCtrlKeyDown()) {
            return true;
        }
        return false;
    }
