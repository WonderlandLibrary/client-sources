...
import pw.vertexcode.nemphis.events.EventKeyTyped;
...
IPlayerUsage {
    ...
    public Timer renderTimer = new Timer(30.0f);
    ...
    public Minecraft(GameConfiguration p_i45547_1_) {
        ...
        Bootstrap.register();
        EventManager.registerClass(new Nemphis());
    }
    ...
    private void updateDisplayMode() throws LWJGLException {
        ...
        if (!var1.contains((Object)var2) && Util.getOSType() == Util.EnumOS.OSX) {
            block0 : for (DisplayMode var4 : macDisplayModes) {
                boolean var5 = true;
                for (DisplayMode var72 : var1) {
                    if (var72.getBitsPerPixel() != 32 || var72.getWidth() != var4.getWidth() || var72.getHeight() != var4.getHeight()) continue;
                    var5 = false;
                    break;
                }
                if (var5) continue;
                for (DisplayMode var72 : var1) {
                    if (var72.getBitsPerPixel() != 32 || var72.getWidth() != var4.getWidth() / 2 || var72.getHeight() != var4.getHeight() / 2) continue;
                    var2 = var72;
                    continue block0;
                }
            }
    ...
    private void runGameLoop() throws IOException {
        ...
        while (Minecraft.getSystemTime() >= this.debugUpdateTime + 1000) {
            ...
            arrobject[1] = RenderChunk.field_178592_a;
            arrobject[2] = RenderChunk.field_178592_a != 1 ? "s" : "";
            ...
            arrobject[5] = this.gameSettings.fancyGraphics ? "" : " fast";
            arrobject[6] = this.gameSettings.clouds ? " clouds" : "";
            arrobject[7] = OpenGlHelper.func_176075_f() ? " vbo" : "";
    ...
    private void rightClickMouse() {
        ...
        if (this.objectMouseOver == null) {
            ...
            switch (this.objectMouseOver.typeOfHit) {
                ...
                case BLOCK: {
                    ...
                    if (this.theWorld.getBlockState(var3).getBlock().getMaterial() == Material.air) break;
        ...
        if (var1 && (var5 = this.thePlayer.inventory.getCurrentItem()) != null && this.playerController.sendUseItem(this.thePlayer, this.theWorld, var5)) {
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen != null && !this.currentScreen.allowUserInput) ** GOTO lbl204
        ...
        while (Mouse.next()) {
            ...
            if ((var10 = Minecraft.getSystemTime() - this.systemTime) > 200) continue;
            ...
            if (var4 != 0) {
                if (this.thePlayer.func_175149_v()) {
                    ...
                    if (this.ingameGUI.func_175187_g().func_175262_a()) {
                        ...
                        var5 = MathHelper.clamp_float(this.thePlayer.capabilities.getFlySpeed() + (float)var4 * 0.005f, 0.0f, 0.2f);
        ...
        while (Keyboard.next()) {
            ...
            if (this.debugCrashKeyPressTime > 0) {
                if (Minecraft.getSystemTime() - this.debugCrashKeyPressTime >= 6000) {
            ...
            if (this.currentScreen != null) {
                ...
                for (ToggleableModule m : Nemphis.instance.modulemanager.mod) {
                    if (var1 != m.getKeybind()) continue;
                    m.toggleModule();
                }
                EventManager.fire(new EventKeyTyped(var1));
                if (var1 == 1) {
                ...
                if (var1 == 48 && Keyboard.isKeyDown((int)61)) {
                    this.renderManager.func_178629_b(this.renderManager.func_178634_b() == false);
                }
        ...
        while (this.gameSettings.keyBindDrop.isPressed()) {
            if (this.thePlayer.func_175149_v()) continue;
        ...
        if (!this.thePlayer.isUsingItem()) ** GOTO lbl194
...
lbl201: // 2 sources:
        ...
        this.sendClickBlockToController(this.currentScreen == null && this.gameSettings.keyBindAttack.getIsKeyPressed() != false && this.inGameHasFocus != false);
lbl204: // 2 sources:
    ...
    public void addServerStatsToSnooper(PlayerUsageSnooper playerSnooper) {
        ...
        playerSnooper.addClientStat("run_time", (MinecraftServer.getCurrentTimeMillis() - playerSnooper.getMinecraftStartTimeMillis()) / 60 * 1000);
    ...
    public void dispatchKeypresses() {
        ...
        if (!(var1 == 0 || Keyboard.isRepeatEvent() || this.currentScreen instanceof GuiControls && ((GuiControls)this.currentScreen).time > Minecraft.getSystemTime() - 20)) {
            if (Keyboard.getEventKeyState()) {
