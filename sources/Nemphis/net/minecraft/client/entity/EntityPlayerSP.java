...
extends AbstractClientPlayer {
    ...
    public void func_175161_p() {
        boolean var2;
        EventManager.fire(new EventPreMotion());
    ...
    public void sendChatMessage(String msg) {
        if (msg.startsWith(".")) {
            String textCombine = msg.substring(1);
            String[] args = textCombine.split(" ");
            for (Command command : Nemphis.instance.commandManager.commands) {
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            ToggleableModule m = new ModuleManager().getModule(NoSlowDown.class);
            boolean e = m.isEnabled();
            this.movementInput.moveStrafe *= 1.0f;
            this.movementInput.moveForward *= 1.0f;
