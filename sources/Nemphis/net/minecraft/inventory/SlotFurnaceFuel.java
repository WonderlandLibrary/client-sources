...
extends Slot {
    ...
    public boolean isItemValid(ItemStack stack) {
        if (!TileEntityFurnace.isItemFuel(stack) && !SlotFurnaceFuel.func_178173_c_(stack)) {
            return false;
        }
        return true;
    }
    ...
    public static boolean func_178173_c_(ItemStack p_178173_0_) {
        if (p_178173_0_ != null && p_178173_0_.getItem() != null && p_178173_0_.getItem() == Items.bucket) {
            return true;
        }
        return false;
    }
