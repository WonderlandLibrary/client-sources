...
extends Container {
    ...
    public ContainerEnchantment(InventoryPlayer p_i45798_1_, World worldIn, BlockPos p_i45798_3_) {
        ...
        this.addSlotToContainer(new Slot(this.tableInventory, 1, 35, 47){
            ...
            @Override
            public boolean isItemValid(ItemStack stack) {
                if (stack.getItem() == Items.dye && EnumDyeColor.func_176766_a(stack.getMetadata()) == EnumDyeColor.BLUE) {
                    return true;
                }
                return false;
            }
        ...
        if (p_75130_1_ == this.tableInventory) {
            ...
            if (var2 != null && var2.isItemEnchantable()) {
                if (!this.worldPointer.isRemote) {
                    ...
                    while (var4 < 3) {
                        List var7;
                        if (this.enchantLevels[var4] > 0 && (var7 = this.func_178148_a(var2, var4, this.enchantLevels[var4])) != null && !var7.isEmpty()) {
    ...
    public void onContainerClosed(EntityPlayer p_75134_1_) {
        ...
        if (!this.worldPointer.isRemote) {
            int var2 = 0;
            while (var2 < this.tableInventory.getSizeInventory()) {
