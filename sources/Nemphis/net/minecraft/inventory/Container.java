...
public abstract class Container {
    ...
    public ItemStack slotClick(int slotId, int clickedButton, int mode, EntityPlayer playerIn) {
        ...
        if (mode == 5) {
                ...
                if (var16 != null) {
                    ...
                    if (var17 == null) {
                        if (var20 != null && var16.isItemValid(var20)) {
                            int var21;
                            int n = var21 = clickedButton == 0 ? var20.stackSize : 1;
                        ...
                        if (var20 == null) {
                            ...
                            if (var17.getItem() == var20.getItem() && var17.getMetadata() == var20.getMetadata() && ItemStack.areItemStackTagsEqual(var17, var20)) {
                                int var213;
                                int n = var213 = clickedButton == 0 ? var20.stackSize : 1;
            ...
            if (!(var17 == null || var16 != null && var16.getHasStack() && var16.canTakeStack(playerIn))) {
                ...
                while (var22 < 2) {
                    int var24 = var9;
                    while (var24 >= 0 && var24 < this.inventorySlots.size() && var17.stackSize < var17.getMaxStackSize()) {
                        Slot var25 = (Slot)this.inventorySlots.get(var24);
                        if (var25.getHasStack() && Container.canAddItemToSlot(var25, var17, true) && var25.canTakeStack(playerIn) && this.func_94530_a(var17, var25) && (var22 != 0 || var25.getStack().stackSize != var25.getStack().getMaxStackSize())) {
    ...
    public static boolean canAddItemToSlot(Slot slotIn, ItemStack stack, boolean stackSizeMatters) {
        boolean var3;
        boolean bl = var3 = slotIn == null || !slotIn.getHasStack();
    ...
    public static int calcRedstoneFromInventory(IInventory inv) {
        ...
        float var2 = 0.0f;
        int var3 = 0;
        while (var3 < inv.getSizeInventory()) {
