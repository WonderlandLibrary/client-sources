...
public class Slot {
    ...
    public void onSlotChange(ItemStack p_75220_1_, ItemStack p_75220_2_) {
        int var3;
        if (p_75220_1_ != null && p_75220_2_ != null && p_75220_1_.getItem() == p_75220_2_.getItem() && (var3 = p_75220_2_.stackSize - p_75220_1_.stackSize) > 0) {
    ...
    public boolean isHere(IInventory p_75217_1_, int p_75217_2_) {
        if (p_75217_1_ == this.inventory && p_75217_2_ == this.slotIndex) {
            return true;
        }
        return false;
    }
