...
extends WorldSavedData {
    ...
    protected void func_96498_a(NBTTagList p_96498_1_) {
        int var2 = 0;
        while (var2 < p_96498_1_.tagCount()) {
            ...
            if (var3.hasKey("NameTagVisibility", 8) && (var5 = Team.EnumVisible.func_178824_a(var3.getString("NameTagVisibility"))) != null) {
                var4.func_178772_a(var5);
            }
            if (var3.hasKey("DeathMessageVisibility", 8) && (var5 = Team.EnumVisible.func_178824_a(var3.getString("DeathMessageVisibility"))) != null) {
    ...
    protected void func_96502_a(ScorePlayerTeam p_96502_1_, NBTTagList p_96502_2_) {
        int var3 = 0;
        while (var3 < p_96502_2_.tagCount()) {
    ...
    protected void func_96501_b(NBTTagList p_96501_1_) {
        int var2 = 0;
        while (var2 < p_96501_1_.tagCount()) {
    ...
    protected void func_96500_c(NBTTagList p_96500_1_) {
        int var2 = 0;
        while (var2 < p_96500_1_.tagCount()) {
    ...
    protected NBTTagList func_96505_b() {
        ...
        for (ScoreObjective var4 : var2) {
            if (var4.getCriteria() == null) continue;
            NBTTagCompound var5 = new NBTTagCompound();
    ...
    protected NBTTagList func_96503_e() {
        ...
        for (Score var4 : var2) {
            if (var4.getObjective() == null) continue;
            NBTTagCompound var5 = new NBTTagCompound();
