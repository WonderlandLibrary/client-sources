...
public class Block {
    ...
    public void dropBlockAsItemWithChance(World worldIn, BlockPos pos, IBlockState state, float chance, int fortune) {
        if (!worldIn.isRemote) {
            ...
            while (var7 < var6) {
                Item var8;
                if (worldIn.rand.nextFloat() <= chance && (var8 = this.getItemDropped(state, worldIn.rand, fortune)) != null) {
    ...
    public static void registerBlocks() {
        ...
        for (Block var142 : blockRegistry) {
            boolean var20;
            if (var142.blockMaterial == Material.air) {
                var142.useNeighborBrightness = false;
                continue;
            }
            boolean var15 = false;
            boolean var16 = var142 instanceof BlockStairs;
            boolean var17 = var142 instanceof BlockSlab;
            boolean var18 = var142 == var6;
            boolean var19 = var142.translucent;
            boolean bl = var20 = var142.lightOpacity == 0;
            if (var16 || var17 || var18 || var19 || var20) {
                var15 = true;
            }
            var142.useNeighborBrightness = var15;
        }
        for (Block var142 : blockRegistry) {
            for (IBlockState var22 : var142.getBlockState().getValidStates()) {
                int var23 = blockRegistry.getIDForObject(var142) << 4 | var142.getMetaFromState(var22);
    ...
    public static enum EnumOffsetType {
        ...
        private EnumOffsetType(String p_i45733_1_, int p_i45733_2_, String string2, int n2) {
        }
    }
