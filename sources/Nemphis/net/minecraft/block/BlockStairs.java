...
extends Block {
    ...
    public static boolean isSameStair(IBlockAccess worldIn, BlockPos pos, IBlockState state) {
        ...
        if (BlockStairs.isBlockStairs(var4) && var3.getValue(HALF) == state.getValue(HALF) && var3.getValue(FACING) == state.getValue(FACING)) {
            return true;
        }
        return false;
    }
    ...
    public MovingObjectPosition collisionRayTrace(World worldIn, BlockPos pos, Vec3 start, Vec3 end) {
        ...
        while (var15 < var14) {
            ...
            if (var16 != null && (var17 = var16.hitVec.squareDistanceTo(end)) > var21) {
                var20 = var16;
                var21 = var17;
            }
            ++var15;
    ...
    public static enum EnumHalf implements IStringSerializable
    {
        ...
        private EnumHalf(String p_i45683_1_, int p_i45683_2_, String p_i45683_3_, int n2, String string2) {
    ...
    public static enum EnumShape implements IStringSerializable
    {
        ...
        private EnumShape(String p_i45682_1_, int p_i45682_2_, String p_i45682_3_, int n2, String string2) {
