...
extends Block {
    ...
    public static enum EnumDoorHalf implements IStringSerializable
    {
        ...
        private EnumDoorHalf(String p_i45726_1_, int p_i45726_2_, String string2, int n2) {
        }
    ...
    public static enum EnumHingePosition implements IStringSerializable
    {
        ...
        private EnumHingePosition(String p_i45725_1_, int p_i45725_2_, String string2, int n2) {
        }
