...
extends BlockTorch {
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        while (var6 != null && !var6.isEmpty() && worldIn.getTotalWorldTime() - ((Toggle)var6.get((int)0)).field_150844_d > 60) {
            var6.remove(0);
        }
        if (this.field_150113_a) {
            if (var5) {
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        if (this.field_150113_a) {
            ...
            if (var11.getAxis().isHorizontal()) {
                ...
                double var13 = 0.27000001072883606;
                var5 += 0.27000001072883606 * (double)var12.getFrontOffsetX();
                var7 += 0.2199999988079071;
                var9 += 0.27000001072883606 * (double)var12.getFrontOffsetZ();
            }
    ...
    public boolean isAssociatedBlock(Block other) {
        if (other != Blocks.unlit_redstone_torch && other != Blocks.redstone_torch) {
            return false;
        }
        return true;
    }
