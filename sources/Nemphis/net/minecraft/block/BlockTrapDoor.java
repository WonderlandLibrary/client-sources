...
extends Block {
    ...
    public boolean canPlaceBlockOnSide(World worldIn, BlockPos pos, EnumFacing side) {
        if (!side.getAxis().isVertical() && BlockTrapDoor.isValidSupportBlock(worldIn.getBlockState(pos.offset(side.getOpposite())).getBlock())) {
            return true;
        }
        return false;
    }
    ...
    private static boolean isValidSupportBlock(Block p_150119_0_) {
        if (!(p_150119_0_.blockMaterial.isOpaque() && p_150119_0_.isFullCube() || p_150119_0_ == Blocks.glowstone || p_150119_0_ instanceof BlockSlab || p_150119_0_ instanceof BlockStairs)) {
            return false;
        }
        return true;
    }
    ...
    public static enum DoorHalf implements IStringSerializable
    {
        ...
        private DoorHalf(String p_i45674_1_, int p_i45674_2_, String p_i45674_3_, int n2, String string2) {
