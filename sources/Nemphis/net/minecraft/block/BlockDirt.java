...
extends Block {
    ...
    public static enum DirtType implements IStringSerializable
    {
        ...
        private DirtType(String p_i45727_1_, int p_i45727_2_, String metadata, int name, int n2, String string2) {
            this(string, n, p_i45727_1_, p_i45727_2_, (int)metadata, (String)name, (String)name);
        }

        private DirtType(String p_i45728_1_, int p_i45728_2_, String metadata, int name, int unlocalizedName, String string2, String string3) {
            this.metadata = metadata;
            this.name = (String)name;
            this.unlocalizedName = (String)unlocalizedName;
        }
