...
implements IGrowable {
    ...
    public boolean isStillGrowing(World worldIn, BlockPos p_176473_2_, IBlockState p_176473_3_, boolean p_176473_4_) {
        if (p_176473_3_.getValue(field_176497_a) != EnumType.DEAD_BUSH) {
            return true;
        }
        return false;
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(String p_i45676_1_, int p_i45676_2_, String p_i45676_3_, int p_i45676_4_, int n2, String string2) {
            this.field_177049_e = p_i45676_3_;
            this.field_177046_f = (String)p_i45676_4_;
        }
