...
public class BlockPattern {
    ...
    private PatternHelper func_177682_a(BlockPos p_177682_1_, EnumFacing p_177682_2_, EnumFacing p_177682_3_, LoadingCache p_177682_4_) {
        int var5 = 0;
        while (var5 < this.field_177686_d) {
            int var6 = 0;
            while (var6 < this.field_177688_c) {
                int var7 = 0;
                while (var7 < this.field_177687_b) {
                    if (!this.field_177689_a[var7][var6][var5].apply(p_177682_4_.getUnchecked((Object)BlockPattern.func_177683_a(p_177682_1_, p_177682_2_, p_177682_3_, var5, var6, var7)))) {
                        return null;
                    }
                    ++var7;
                }
        ...
        for (BlockPos var6 : BlockPos.getAllInBox(p_177681_2_, p_177681_2_.add(var4 - 1, var4 - 1, var4 - 1))) {
            ...
            while (var9 < var8) {
                ...
                while (var13 < var12) {
                    ...
                    if (var14 != var10 && var14 != var10.getOpposite() && (var15 = this.func_177682_a(var6, var10, var14, var3)) != null) {
                        return var15;
                    }
                    ++var13;
                }
