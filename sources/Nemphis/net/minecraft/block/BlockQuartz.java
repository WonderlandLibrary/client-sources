...
extends Block {
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(String p_i45691_1_, int p_i45691_2_, String p_i45691_3_, int p_i45691_4_, int p_i45691_5_, String string2, String string3) {
            this.field_176798_g = p_i45691_3_;
            this.field_176805_h = (String)p_i45691_4_;
            this.field_176806_i = (String)p_i45691_5_;
        }
