...
extends Block {
    ...
    public static boolean func_176377_d(IBlockState p_176377_0_) {
        ...
        if (p_176377_0_ != Blocks.stone.getDefaultState().withProperty(BlockStone.VARIANT_PROP, (Comparable)((Object)BlockStone.EnumType.STONE)) && var1 != Blocks.cobblestone && var1 != Blocks.stonebrick) {
            return false;
        }
        return true;
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(String p_i45704_1_, int p_i45704_2_, String p_i45704_3_, int p_i45704_4_, int n2, String string2) {
            this(string, n, p_i45704_1_, p_i45704_2_, (int)p_i45704_3_, (String)p_i45704_4_, (String)p_i45704_4_);
        }

        private EnumType(String p_i45705_1_, int p_i45705_2_, String p_i45705_3_, int p_i45705_4_, int p_i45705_5_, String string2, String string3) {
            this.field_176893_h = p_i45705_3_;
            this.field_176894_i = (String)p_i45705_4_;
            this.field_176891_j = (String)p_i45705_5_;
        }
        ...
        private EnumType(String p_i45706_1_, int p_i45706_2_, String p_i45706_3_, int p_i45706_4_, int p_i45706_5_, String string2, SwitchEnumType switchEnumType) {
            this(string, n, p_i45706_1_, p_i45706_2_, (int)p_i45706_3_, (String)p_i45706_4_);
        }

        private EnumType(String p_i45707_1_, int p_i45707_2_, String p_i45707_3_, int p_i45707_4_, int p_i45707_5_, String p_i45707_6_, String string2, SwitchEnumType switchEnumType) {
            this(string, n, p_i45707_1_, p_i45707_2_, (int)p_i45707_3_, (String)p_i45707_4_, (String)p_i45707_5_);
        }

        /* synthetic */ EnumType(String string, int n, String string2, int n2, int n3, String string3, SwitchEnumType switchEnumType, EnumType enumType) {
            EnumType enumType2;
            enumType2(string, n, string2, n2, n3, string3, switchEnumType);
        }

        /* synthetic */ EnumType(String string, int n, String string2, int n2, int n3, String string3, String string4, SwitchEnumType switchEnumType, EnumType enumType) {
            EnumType enumType2;
            enumType2(string, n, string2, n2, n3, string3, string4, switchEnumType);
        }
