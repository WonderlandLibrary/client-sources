...
extends BlockRailBase {
    public static final PropertyEnum field_176568_b = PropertyEnum.create("shape", BlockRailBase.EnumRailDirection.class, new Predicate(){
        ...
        public boolean func_180133_a(BlockRailBase.EnumRailDirection p_180133_1_) {
            if (p_180133_1_ != BlockRailBase.EnumRailDirection.NORTH_EAST && p_180133_1_ != BlockRailBase.EnumRailDirection.NORTH_WEST && p_180133_1_ != BlockRailBase.EnumRailDirection.SOUTH_EAST && p_180133_1_ != BlockRailBase.EnumRailDirection.SOUTH_WEST) {
                return true;
            }
            return false;
        }
    ...
    protected BlockRailPowered() {
        super(true);
        this.setDefaultState(this.blockState.getBaseState().withProperty(field_176568_b, (Comparable)((Object)BlockRailBase.EnumRailDirection.NORTH_SOUTH)).withProperty(field_176569_M, Boolean.valueOf(false)));
    }
    ...
    protected boolean func_176566_a(World worldIn, BlockPos p_176566_2_, IBlockState p_176566_3_, boolean p_176566_4_, int p_176566_5_) {
        ...
        boolean var9 = true;
        BlockRailBase.EnumRailDirection var10 = (BlockRailBase.EnumRailDirection)((Object)p_176566_3_.getValue(field_176568_b));
    ...
    protected boolean func_176567_a(World worldIn, BlockPos p_176567_2_, boolean p_176567_3_, int p_176567_4_, BlockRailBase.EnumRailDirection p_176567_5_) {
        ...
        BlockRailBase.EnumRailDirection var7 = (BlockRailBase.EnumRailDirection)((Object)var6.getValue(field_176568_b));
    ...
    protected void func_176561_b(World worldIn, BlockPos p_176561_2_, IBlockState p_176561_3_, Block p_176561_4_) {
        boolean var6;
        boolean var5 = (Boolean)p_176561_3_.getValue(field_176569_M);
        boolean bl = var6 = worldIn.isBlockPowered(p_176561_2_) || this.func_176566_a(worldIn, p_176561_2_, p_176561_3_, true, 0) || this.func_176566_a(worldIn, p_176561_2_, p_176561_3_, false, 0);
        if (var6 != var5) {
            ...
            if (((BlockRailBase.EnumRailDirection)((Object)p_176561_3_.getValue(field_176568_b))).func_177018_c()) {
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(field_176568_b, (Comparable)((Object)BlockRailBase.EnumRailDirection.func_177016_a(meta & 7))).withProperty(field_176569_M, Boolean.valueOf((meta & 8) > 0));
    }

    @Override
    public int getMetaFromState(IBlockState state) {
        int var2 = 0;
        int var3 = var2 | ((BlockRailBase.EnumRailDirection)((Object)state.getValue(field_176568_b))).func_177015_a();
    ...
    protected BlockState createBlockState() {
        return new BlockState(this, field_176568_b, field_176569_M);
    }
