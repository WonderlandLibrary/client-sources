...
implements IGrowable {
    ...
    public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
        if (super.canPlaceBlockAt(worldIn, pos) && worldIn.isAirBlock(pos.offsetUp())) {
            return true;
        }
        return false;
    }
    ...
    public boolean isReplaceable(World worldIn, BlockPos pos) {
        ...
        if (var4 != EnumPlantType.FERN && var4 != EnumPlantType.GRASS) {
            return false;
        }
        return true;
    }
    ...
    public boolean canBlockStay(World worldIn, BlockPos p_180671_2_, IBlockState p_180671_3_) {
        if (p_180671_3_.getValue(HALF_PROP) == EnumBlockHalf.UPPER) {
            if (worldIn.getBlockState(p_180671_2_.offsetDown()).getBlock() == this) {
                return true;
            }
            return false;
        }
        IBlockState var4 = worldIn.getBlockState(p_180671_2_.offsetUp());
        if (var4.getBlock() == this && super.canBlockStay(worldIn, p_180671_2_, var4)) {
            return true;
        }
        return false;
    }
    ...
    public boolean isStillGrowing(World worldIn, BlockPos p_176473_2_, IBlockState p_176473_3_, boolean p_176473_4_) {
        ...
        if (var5 != EnumPlantType.GRASS && var5 != EnumPlantType.FERN) {
            return true;
        }
        return false;
    }
    ...
    static enum EnumBlockHalf implements IStringSerializable
    {
        ...
        private EnumBlockHalf(String p_i45724_1_, int p_i45724_2_, String string2, int n2) {
        }
    ...
    public static enum EnumPlantType implements IStringSerializable
    {
        ...
        private EnumPlantType(String p_i45722_1_, int p_i45722_2_, String p_i45722_3_, int p_i45722_4_, int n2, String string2) {
            this(string, n, p_i45722_1_, p_i45722_2_, (int)p_i45722_3_, (String)p_i45722_4_, (String)p_i45722_4_);
        }

        private EnumPlantType(String p_i45723_1_, int p_i45723_2_, String p_i45723_3_, int p_i45723_4_, int p_i45723_5_, String string2, String string3) {
            this.field_176949_h = p_i45723_3_;
            this.field_176950_i = (String)p_i45723_4_;
            this.field_176947_j = (String)p_i45723_5_;
        }
