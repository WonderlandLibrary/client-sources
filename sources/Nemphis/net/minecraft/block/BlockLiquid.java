...
extends Block {
    ...
    public boolean canCollideCheck(IBlockState state, boolean p_176209_2_) {
        if (p_176209_2_ && (Integer)state.getValue(LEVEL) == 0) {
            return true;
        }
        return false;
    }
    ...
    protected Vec3 func_180687_h(IBlockAccess p_180687_1_, BlockPos p_180687_2_) {
        ...
        for (EnumFacing var62 : EnumFacing.Plane.HORIZONTAL) {
            int var9;
            var7 = p_180687_2_.offset(var62);
        ...
        if ((Integer)p_180687_1_.getBlockState(p_180687_2_).getValue(LEVEL) >= 8) {
            for (EnumFacing var62 : EnumFacing.Plane.HORIZONTAL) {
                var7 = p_180687_2_.offset(var62);
                if (!this.isBlockSolid(p_180687_1_, var7, var62) && !this.isBlockSolid(p_180687_1_, var7.offsetUp(), var62)) continue;
