...
extends BlockSlab {
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(String p_i45677_1_, int p_i45677_2_, String p_i45677_3_, int p_i45677_4_, int n2, String string2) {
            this(string, n, p_i45677_1_, p_i45677_2_, (int)p_i45677_3_, (String)p_i45677_4_, (String)p_i45677_4_);
        }

        private EnumType(String p_i45678_1_, int p_i45678_2_, String p_i45678_3_, int p_i45678_4_, int p_i45678_5_, String string2, String string3) {
            this.field_176637_j = p_i45678_3_;
            this.field_176638_k = (String)p_i45678_4_;
            this.field_176635_l = (String)p_i45678_5_;
        }
