...
extends BlockDirectional {
    ...
    protected static boolean func_176469_d(World worldIn, BlockPos p_176469_1_) {
        if (World.doesBlockHaveSolidTopSurface(worldIn, p_176469_1_.offsetDown()) && !worldIn.getBlockState(p_176469_1_).getBlock().getMaterial().isSolid() && !worldIn.getBlockState(p_176469_1_.offsetUp()).getBlock().getMaterial().isSolid()) {
            return true;
        }
        return false;
    }
    ...
    public static enum EnumPartType implements IStringSerializable
    {
        ...
        private EnumPartType(String p_i45735_1_, int p_i45735_2_, String p_i45735_3_, int n2, String string2) {
