...
extends Block {
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        private EnumType(String p_i45695_1_, int p_i45695_2_, String p_i45695_3_, int p_i45695_4_, int n2, String string2) {
            this(string, n, p_i45695_1_, p_i45695_2_, (int)p_i45695_3_, (String)p_i45695_4_, (String)p_i45695_4_);
        }

        private EnumType(String p_i45696_1_, int p_i45696_2_, String p_i45696_3_, int p_i45696_4_, int p_i45696_5_, String string2, String string3) {
            this.field_176850_h = p_i45696_3_;
            this.field_176851_i = (String)p_i45696_4_;
            this.field_176848_j = (String)p_i45696_5_;
        }
