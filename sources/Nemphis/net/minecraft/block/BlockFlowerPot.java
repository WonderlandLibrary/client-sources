...
extends BlockContainer {
    ...
    public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
        if (super.canPlaceBlockAt(worldIn, pos) && World.doesBlockHaveSolidTopSurface(worldIn, pos.offsetDown())) {
            return true;
        }
        return false;
    }
    ...
    public static enum EnumFlowerType implements IStringSerializable
    {
        ...
        private EnumFlowerType(String p_i45715_1_, int p_i45715_2_, String p_i45715_3_, int n2, String string2) {
