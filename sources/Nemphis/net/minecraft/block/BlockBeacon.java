...
extends BlockContainer {
    ...
    public static void func_176450_d(World worldIn, final BlockPos p_176450_1_) {
        HttpUtil.field_180193_a.submit(new Runnable(){
            private static final String __OBFID = "CL_00002136";

            @Override
            public void run() {
                Chunk var1 = World.this.getChunkFromBlockCoords(p_176450_1_);
                int var2 = p_176450_1_.getY() - 1;
                while (var2 >= 0) {
                    BlockPos var3 = new BlockPos(p_176450_1_.getX(), var2, p_176450_1_.getZ());
                    if (!var1.canSeeSky(var3)) break;
                    IBlockState var4 = World.this.getBlockState(var3);
                    if (var4.getBlock() == Blocks.beacon) {
                        ((WorldServer)World.this).addScheduledTask(new Runnable(World.this, var3){
                            private static final String __OBFID = "CL_00002135";
                            private final /* synthetic */ World val$worldIn;
