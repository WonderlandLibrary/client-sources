...
extends BlockBush {
    ...
    public void getSubBlocks(Item itemIn, CreativeTabs tab, List list) {
        EnumFlowerType[] var4 = EnumFlowerType.func_176966_a(this.func_176495_j());
        ...
        if (this.field_176496_a == null) {
            this.field_176496_a = PropertyEnum.create("type", EnumFlowerType.class, new Predicate(){
                ...
                public boolean func_180354_a(EnumFlowerType p_180354_1_) {
                    if (p_180354_1_.func_176964_a() == BlockFlower.this.func_176495_j()) {
                        return true;
                    }
                    return false;
                }
    ...
    public static enum EnumFlowerColor {
        ...
        private EnumFlowerColor(String p_i45716_1_, int p_i45716_2_, String string2, int n2) {
        }
    ...
    public static enum EnumFlowerType implements IStringSerializable
    {
            ...
            while (var2 < var1) {
                ...
                Collection var4 = Collections2.filter((Collection)Lists.newArrayList((Object[])EnumFlowerType.values()), (Predicate)new Predicate(){
                    ...
                    public boolean func_180350_a(EnumFlowerType p_180350_1_) {
                        if (p_180350_1_.func_176964_a() == EnumFlowerColor.this) {
                            return true;
                        }
                        return false;
                    }
        ...
        private EnumFlowerType(String p_i45718_1_, int p_i45718_2_, String p_i45718_3_, int p_i45718_4_, EnumFlowerColor p_i45718_5_, int n2, String string2) {
            this(string, n, p_i45718_1_, p_i45718_2_, (EnumFlowerColor)((Object)p_i45718_3_), p_i45718_4_, (String)((Object)p_i45718_5_), (String)((Object)p_i45718_5_));
        }

        private EnumFlowerType(String p_i45719_1_, int p_i45719_2_, String p_i45719_3_, int p_i45719_4_, EnumFlowerColor p_i45719_5_, int p_i45719_6_, String string2, String string3) {
            this.field_176978_l = p_i45719_3_;
            this.field_176979_m = p_i45719_4_;
            this.field_176976_n = p_i45719_5_;
            this.field_176977_o = (String)p_i45719_6_;
        }
