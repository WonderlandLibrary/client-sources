        ...
        while (var6 < 128) {
            block8 : {
                ...
                for (int var8 = 0; var8 < var6 / 16; ++var8) {
                    if (worldIn.getBlockState((var7 = var7.add(p_176474_2_.nextInt(3) - 1, (p_176474_2_.nextInt(3) - 1) * p_176474_2_.nextInt(3) / 2, p_176474_2_.nextInt(3) - 1)).offsetDown()).getBlock() == Blocks.grass && !worldIn.getBlockState(var7).getBlock().isNormalCube()) {
                        continue;
                    }
                    break block8;
                }
                if (worldIn.getBlockState((BlockPos)var7).getBlock().blockMaterial == Material.air) {
                    if (p_176474_2_.nextInt(8) == 0) {
                        ...
                        if (var9.canBlockStay(worldIn, var7, var10 = var9.getDefaultState().withProperty(var9.func_176494_l(), (Comparable)((Object)var11)))) {
