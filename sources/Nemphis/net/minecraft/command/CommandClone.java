...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        int var19 = var6.minZ;
        while (var19 <= var6.maxZ) {
            int var20 = var6.minY;
            while (var20 <= var6.maxY) {
                int var21 = var6.minX;
                while (var21 <= var6.maxX) {
        ...
        if (var9) {
            ...
            for (BlockPos var292 : var17) {
                var12.setBlockState(var292, Blocks.air.getDefaultState(), 3);
            }
        }
        ...
        for (StaticCloneData var34222 : var30) {
            var36 = var12.getTileEntity(var34222.field_179537_a);
            if (var36 instanceof IInventory) {
                ((IInventory)((Object)var36)).clearInventory();
            }
            var12.setBlockState(var34222.field_179537_a, Blocks.barrier.getDefaultState(), 2);
        }
        var8 = 0;
        for (StaticCloneData var34222 : var28) {
            if (!var12.setBlockState(var34222.field_179537_a, var34222.field_179535_b, 2)) continue;
            ++var8;
        }
        for (StaticCloneData var34222 : var15) {
            var36 = var12.getTileEntity(var34222.field_179537_a);
            if (var34222.field_179536_c != null && var36 != null) {
                var34222.field_179536_c.setInteger("x", var34222.field_179537_a.getX());
                var34222.field_179536_c.setInteger("y", var34222.field_179537_a.getY());
                var34222.field_179536_c.setInteger("z", var34222.field_179537_a.getZ());
                var36.readFromNBT(var34222.field_179536_c);
                var36.markDirty();
            }
            var12.setBlockState(var34222.field_179537_a, var34222.field_179535_b, 2);
        }
        for (StaticCloneData var34222 : var30) {
            var12.func_175722_b(var34222.field_179537_a, var34222.field_179535_b.getBlock());
        }
