...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (var3) {
            ...
            if (!var18.func_174820_d(var5, var9)) {
                ...
                arrobject[0] = var5;
                arrobject[1] = var7;
                arrobject[2] = var9 == null ? "Air" : var9.getChatComponent();
                throw new CommandException("commands.replaceitem.failed", arrobject);
            }
            if (var18 instanceof EntityPlayer) {
                ((EntityPlayer)var18).inventoryContainer.detectAndSendChanges();
            }
        ...
        arrobject[1] = var7;
        arrobject[2] = var9 == null ? "Air" : var9.getChatComponent();
        CommandReplaceItem.notifyOperators(sender, (ICommand)this, "commands.replaceitem.success", arrobject);
    }
    ...
    public boolean isUsernameIndex(String[] args, int index) {
        if (args.length > 0 && args[0].equals("entity") && index == 1) {
            return true;
        }
        return false;
    }
