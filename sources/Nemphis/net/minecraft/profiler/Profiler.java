...
public class Profiler {
    ...
    public List getProfilingData(String p_76321_1_) {
        ...
        long var5 = this.profilingMap.containsKey(p_76321_1_) ? (Long)this.profilingMap.get(p_76321_1_) : -1;
        ...
        for (String var122 : this.profilingMap.keySet()) {
            if (var122.length() <= p_76321_1_.length() || !var122.startsWith(p_76321_1_) || var122.indexOf(".", p_76321_1_.length() + 1) >= 0) continue;
            long var13 = (Long)this.profilingMap.get(var122);
            double var15 = (double)var13 * 100.0 / (double)var8;
            double var17 = (double)var13 * 100.0 / (double)var3;
            String var19 = var122.substring(p_76321_1_.length());
            var7.add(new Result(var19, var15, var17));
        }
        for (String var122 : this.profilingMap.keySet()) {
            this.profilingMap.put(var122, (Long)this.profilingMap.get(var122) * 950 / 1000);
        }
