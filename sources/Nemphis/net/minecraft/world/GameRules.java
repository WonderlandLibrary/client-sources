...
public class GameRules {
    ...
    public boolean areSameType(String key, ValueType otherValue) {
        Value var3 = (Value)this.theGameRules.get(key);
        if (var3 != null && (var3.getType() == otherValue || otherValue == ValueType.ANY_VALUE)) {
            return true;
        }
        return false;
    }
    ...
    public static enum ValueType {
        ...
        private ValueType(String p_i46394_1_, int p_i46394_2_, String p_i45750_1_, int p_i45750_2_, String string2, int n2) {
        }
    }
