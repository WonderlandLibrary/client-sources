...
implements IBlockAccess {
    ...
    public boolean isAirBlock(BlockPos pos) {
        if (this.getBlockState(pos).getBlock().getMaterial() == Material.air) {
            return true;
        }
        return false;
    }
    ...
    private boolean isAreaLoaded(int p_175663_1_, int p_175663_2_, int p_175663_3_, int p_175663_4_, int p_175663_5_, int p_175663_6_, boolean p_175663_7_) {
        if (p_175663_5_ >= 0 && p_175663_2_ < 256) {
            p_175663_3_ >>= 4;
            p_175663_6_ >>= 4;
            int var8 = p_175663_1_ >>= 4;
            while (var8 <= (p_175663_4_ >>= 4)) {
                int var9 = p_175663_3_;
                while (var9 <= p_175663_6_) {
    ...
    protected boolean isChunkLoaded(int x, int z, boolean allowEmpty) {
        if (this.chunkProvider.chunkExists(x, z) && (allowEmpty || !this.chunkProvider.provideChunk(x, z).isEmpty())) {
            return true;
        }
        return false;
    }
    ...
    public BlockPos getHorizon(BlockPos pos) {
        int var2 = pos.getX() >= -30000000 && pos.getZ() >= -30000000 && pos.getX() < 30000000 && pos.getZ() < 30000000 ? (this.isChunkLoaded(pos.getX() >> 4, pos.getZ() >> 4, true) ? this.getChunkFromChunkCoords(pos.getX() >> 4, pos.getZ() >> 4).getHeight(pos.getX() & 15, pos.getZ() & 15) : 0) : 64;
    ...
    public MovingObjectPosition rayTraceBlocks(Vec3 p_147447_1_, Vec3 p_147447_2_, boolean p_147447_3_, boolean p_147447_4_, boolean p_147447_5_) {
        if (!(Double.isNaN(p_147447_1_.xCoord) || Double.isNaN(p_147447_1_.yCoord) || Double.isNaN(p_147447_1_.zCoord))) {
            if (!(Double.isNaN(p_147447_2_.xCoord) || Double.isNaN(p_147447_2_.yCoord) || Double.isNaN(p_147447_2_.zCoord))) {
                ...
                new net.minecraft.util.BlockPos(var6, var7, var8);
                IBlockState var14 = this.getBlockState(var12);
                Block var15 = var14.getBlock();
                if ((!p_147447_4_ || var15.getCollisionBoundingBox(this, var12, var14) != null) && var15.canCollideCheck(var14, p_147447_3_) && (var16 = var15.collisionRayTrace(this, var12, p_147447_1_, p_147447_2_)) != null) {
                    return var16;
                }
                ...
                while (var42-- >= 0) {
                    ...
                    if (p_147447_4_ && var39.getCollisionBoundingBox(this, var12, var38) == null) continue;
    ...
    public void func_175717_a(BlockPos p_175717_1_, String p_175717_2_) {
        int var3 = 0;
        while (var3 < this.worldAccesses.size()) {
            ((IWorldAccess)this.worldAccesses.get(var3)).func_174961_a(p_175717_2_, p_175717_1_);
            ++var3;
        }
    }

    public /* varargs */ void spawnParticle(EnumParticleTypes p_175688_1_, double p_175688_2_, double p_175688_4_, double p_175688_6_, double p_175688_8_, double p_175688_10_, double p_175688_12_, int ... p_175688_14_) {
    ...
    public /* varargs */ void spawnParticle(EnumParticleTypes p_175682_1_, boolean p_175682_2_, double p_175682_3_, double p_175682_5_, double p_175682_7_, double p_175682_9_, double p_175682_11_, double p_175682_13_, int ... p_175682_15_) {
    ...
    private /* varargs */ void spawnParticle(int p_175720_1_, boolean p_175720_2_, double p_175720_3_, double p_175720_5_, double p_175720_7_, double p_175720_9_, double p_175720_11_, double p_175720_13_, int ... p_175720_15_) {
        int var16 = 0;
        while (var16 < this.worldAccesses.size()) {
    ...
    public List getCollidingBoundingBoxes(Entity p_72945_1_, AxisAlignedBB p_72945_2_) {
        ...
        while (var19 < var18.size()) {
            if (p_72945_1_.riddenByEntity != var18 && p_72945_1_.ridingEntity != var18) {
                ...
                if ((var20 = p_72945_1_.getCollisionBox((Entity)var18.get(var19))) != null && var20.intersectsWith(p_72945_2_)) {
                    var3.add(var20);
                }
            }
            ++var19;
    ...
    public boolean isInsideBorder(WorldBorder p_175673_1_, Entity p_175673_2_) {
        ...
        if (p_175673_2_.posX > var3 && p_175673_2_.posX < var7 && p_175673_2_.posZ > var5 && p_175673_2_.posZ < var9) {
            return true;
        }
        return false;
    }
    ...
    public Vec3 getSkyColor(Entity p_72833_1_, float p_72833_2_) {
        ...
        if (this.lastLightningBolt > 0) {
            ...
            var12 = var12 * (1.0f - var17) + 0.8f * (var17 *= 0.45f);
    ...
    public void updateEntities() {
        ...
        while (var1 < this.loadedEntityList.size()) {
            ...
            if (var2.ridingEntity == null) ** GOTO lbl47
...
lbl47: // 2 sources:
        ...
        var10 = this.tickableTileEntities.iterator();
        while (var10.hasNext()) {
            var11 = (TileEntity)var10.next();
            if (!var11.isInvalid() && var11.hasWorldObj() && this.isBlockLoaded(var13 = var11.getPos()) && this.worldBorder.contains(var13)) {
                try {
                    ...
                    var16 = CrashReport.makeCrashReport(var7, "Ticking block entity");
                    var6 = var16.makeCategory("Block entity being ticked");
        ...
        if (!this.addedTileEntityList.isEmpty()) {
            var12 = 0;
            while (var12 < this.addedTileEntityList.size()) {
                var14 = (TileEntity)this.addedTileEntityList.get(var12);
                if (!var14.isInvalid()) {
        ...
        while (var12 < var5) {
            ...
            while (var13 < var7) {
                ...
                while (var14 < var9) {
                    ...
                    if (var17.getMaterial() == p_72918_2_ && (double)var7 >= (var18 = (double)((float)(var13 + 1) - BlockLiquid.getLiquidHeightPercent((Integer)var16.getValue(BlockLiquid.LEVEL))))) {
                        var10 = true;
    ...
    public TileEntity getTileEntity(BlockPos pos) {
        ...
        if (this.processingLoadedTiles) {
            var3 = 0;
            while (var3 < this.addedTileEntityList.size()) {
    ...
    public void setTileEntity(BlockPos p_175690_1_, TileEntity p_175690_2_) {
        if (p_175690_2_ != null && !p_175690_2_.isInvalid()) {
            if (this.processingLoadedTiles) {
                ...
                Iterator<E> var3 = this.addedTileEntityList.iterator();
                while (var3.hasNext()) {
    ...
    public boolean func_175665_u(BlockPos p_175665_1_) {
        ...
        if (var3 != null && var3.getAverageEdgeLength() >= 1.0) {
            return true;
        }
        return false;
    }
    ...
    public boolean func_175677_d(BlockPos p_175677_1_, boolean p_175677_2_) {
        ...
        if (var4.getMaterial().isOpaque() && var4.isFullCube()) {
            return true;
        }
        return false;
    }
    ...
    protected void func_147467_a(int p_147467_1_, int p_147467_2_, Chunk p_147467_3_) {
        ...
        if (this.ambientTickCountdown == 0 && !this.isRemote) {
            ...
            if (var9.getMaterial() == Material.air && this.getLight(var8) <= this.rand.nextInt(8) && this.getLightFor(EnumSkyBlock.SKY, var8) <= 0 && (var10 = this.getClosestPlayer((double)var5 + 0.5, (double)var7 + 0.5, (double)var6 + 0.5, 8.0)) != null && var10.getDistanceSq((double)(var5 += p_147467_1_) + 0.5, (double)var7 + 0.5, (double)(var6 += p_147467_2_) + 0.5) > 4.0) {
    ...
    private boolean func_175696_F(BlockPos p_175696_1_) {
        if (this.getBlockState(p_175696_1_).getBlock().getMaterial() == Material.water) {
            return true;
        }
        return false;
    }
    ...
    public boolean func_175708_f(BlockPos p_175708_1_, boolean p_175708_2_) {
        ...
        if (p_175708_1_.getY() >= 0 && p_175708_1_.getY() < 256 && this.getLightFor(EnumSkyBlock.BLOCK, p_175708_1_) < 10 && (var5 = this.getBlockState(p_175708_1_).getBlock()).getMaterial() == Material.air && Blocks.snow_layer.canPlaceBlockAt(this, p_175708_1_)) {
            return true;
        }
        return false;
    }
    ...
    public Entity findNearestEntityWithinAABB(Class p_72857_1_, AxisAlignedBB p_72857_2_, Entity p_72857_3_) {
        ...
        while (var8 < var4.size()) {
            ...
            if (var9 != p_72857_3_ && IEntitySelector.field_180132_d.apply((Object)var9) && (var10 = p_72857_3_.getDistanceSqToEntity(var9)) <= var6) {
                var5 = var9;
                var6 = var10;
            }
            ++var8;
    ...
    public boolean func_175709_b(BlockPos p_175709_1_, EnumFacing p_175709_2_) {
        if (this.getRedstonePower(p_175709_1_, p_175709_2_) > 0) {
            return true;
        }
        return false;
    }
    ...
    public EntityPlayer getClosestPlayer(double x, double y, double z, double distance) {
        ...
        while (var12 < this.playerEntities.size()) {
            ...
            if (IEntitySelector.field_180132_d.apply((Object)var13)) {
                double var14 = var13.getDistanceSq(x, y, z);
                if (!(distance >= 0.0 && var14 >= distance * distance || var9 != -1.0 && var14 >= var9)) {
                    var9 = var14;
                    var11 = var13;
                }
            }
    ...
    public boolean func_175636_b(double p_175636_1_, double p_175636_3_, double p_175636_5_, double p_175636_7_) {
        int var9 = 0;
        while (var9 < this.playerEntities.size()) {
