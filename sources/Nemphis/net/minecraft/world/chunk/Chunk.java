...
public class Chunk {
            ...
            while (var2 < 16) {
                ...
                while (var3 < 16) {
                    if (this.updateSkylightColumns[var2 + var3 * 16]) {
                        ...
                        for (EnumFacing var92 : EnumFacing.Plane.HORIZONTAL) {
                            var7 = Math.min(var7, this.worldObj.getChunksLowestHorizon(var5 + var92.getFrontOffsetX(), var6 + var92.getFrontOffsetZ()));
                        }
                        this.checkSkylightNeighborHeight(var5, var6, var7);
                        for (EnumFacing var92 : EnumFacing.Plane.HORIZONTAL) {
                            this.checkSkylightNeighborHeight(var5 + var92.getFrontOffsetX(), var6 + var92.getFrontOffsetZ(), var4);
                        }
                        if (p_150803_1_) {
    ...
    private void relightBlock(int x, int y, int z) {
        int var4;
        int var5 = var4 = this.heightMap[z << 4 | x] & 255;
        if (y > var4) {
            var5 = y;
        }
    ...
    public IBlockState setBlockState(BlockPos p_177436_1_, IBlockState p_177436_2_) {
        ...
        if (var9 instanceof ITileEntityProvider) {
            TileEntity var152 = this.func_177424_a(p_177436_1_, EnumCreateEntityType.CHECK);
            if (var152 == null) {
                var152 = ((ITileEntityProvider)((Object)var9)).createNewTileEntity(this.worldObj, var9.getMetaFromState(p_177436_2_));
                this.worldObj.setTileEntity(p_177436_1_, var152);
            }
            if (var152 != null) {
                var152.updateContainingBlockInfo();
            }
        }
        this.isModified = true;
        return var8;
    ...
    public boolean canSeeSky(BlockPos pos) {
        ...
        int var3 = pos.getY();
        if (var3 >= this.heightMap[(var4 = pos.getZ() & 15) << 4 | var2]) {
            return true;
        }
        return false;
    }
    ...
    public boolean needsSaving(boolean p_76601_1_) {
        if (p_76601_1_ ? this.hasEntities && this.worldObj.getTotalWorldTime() != this.lastSaveTime || this.isModified : this.hasEntities && this.worldObj.getTotalWorldTime() >= this.lastSaveTime + 600) {
            return true;
        }
    ...
    public Random getRandomWithSeed(long seed) {
        return new Random(this.worldObj.getSeed() + (long)(this.xPosition * this.xPosition * 4987142) + (long)(this.xPosition * 5947611) + (long)(this.zPosition * this.zPosition) * 4392871 + (long)(this.zPosition * 389711) ^ seed);
    }
    ...
    public void setStorageArrays(ExtendedBlockStorage[] newStorageArrays) {
        if (this.storageArrays.length != newStorageArrays.length) {
            ...
            int var2 = 0;
            while (var2 < this.storageArrays.length) {
    ...
    public void func_177439_a(byte[] p_177439_1_, int p_177439_2_, boolean p_177439_3_) {
        ...
        int var6 = 0;
        while (var6 < this.storageArrays.length) {
    ...
    public void setBiomeArray(byte[] biomeArray) {
        if (this.blockBiomeArray.length != biomeArray.length) {
            ...
            int var2 = 0;
            while (var2 < this.blockBiomeArray.length) {
    ...
    private void func_177441_y() {
        int var1 = 0;
        while (var1 < this.updateSkylightColumns.length) {
    ...
    public void setHeightMap(int[] newHeightMap) {
        if (this.heightMap.length != newHeightMap.length) {
            ...
            int var2 = 0;
            while (var2 < this.heightMap.length) {
    ...
    public static enum EnumCreateEntityType {
        ...
        private EnumCreateEntityType(String p_i45642_1_, int p_i45642_2_, String string2, int n2) {
        }
    }
