...
public class StructureVillagePieces {
    ...
    extends Road {
        ...
        public void buildComponent(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_) {
            ...
            while (var5 < this.averageGroundLevel - 8) {
                ...
                var5 += 2 + p_74861_3_.nextInt(5);
            }
            var5 = p_74861_3_.nextInt(5);
            while (var5 < this.averageGroundLevel - 8) {
        ...
        public static StructureBoundingBox func_175848_a(Start p_175848_0_, List p_175848_1_, Random p_175848_2_, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing p_175848_6_) {
            int var7 = 7 * MathHelper.getRandomIntegerInRange(p_175848_2_, 3, 5);
            while (var7 >= 7) {
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            while (var6 <= this.boundingBox.maxX) {
                int var7 = this.boundingBox.minZ;
                while (var7 <= this.boundingBox.maxZ) {
    ...
    extends StructureComponent {
        ...
        protected static boolean canVillageGoDeeper(StructureBoundingBox p_74895_0_) {
            if (p_74895_0_ != null && p_74895_0_.minY > 10) {
                return true;
            }
            return false;
        }
