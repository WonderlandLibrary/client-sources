...
public class StructureBoundingBox {
    ...
    public boolean intersectsWith(StructureBoundingBox p_78884_1_) {
        if (this.maxX >= p_78884_1_.minX && this.minX <= p_78884_1_.maxX && this.maxZ >= p_78884_1_.minZ && this.minZ <= p_78884_1_.maxZ && this.maxY >= p_78884_1_.minY && this.minY <= p_78884_1_.maxY) {
            return true;
        }
        return false;
    }
    ...
    public boolean intersectsWith(int p_78885_1_, int p_78885_2_, int p_78885_3_, int p_78885_4_) {
        if (this.maxX >= p_78885_1_ && this.minX <= p_78885_3_ && this.maxZ >= p_78885_2_ && this.minZ <= p_78885_4_) {
            return true;
        }
        return false;
    }
    ...
    public boolean func_175898_b(Vec3i p_175898_1_) {
        if (p_175898_1_.getX() >= this.minX && p_175898_1_.getX() <= this.maxX && p_175898_1_.getZ() >= this.minZ && p_175898_1_.getZ() <= this.maxZ && p_175898_1_.getY() >= this.minY && p_175898_1_.getY() <= this.maxY) {
            return true;
        }
        return false;
    }
