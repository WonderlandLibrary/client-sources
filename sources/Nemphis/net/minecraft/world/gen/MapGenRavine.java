        ...
        while (p_180707_15_ < p_180707_16_) {
            ...
            if (var52 || var19.nextInt(4) != 0) {
                ...
                if (p_180707_6_ >= var20 - 16.0 - var53 * 2.0 && p_180707_10_ >= var22 - 16.0 - var53 * 2.0 && p_180707_6_ <= var20 + 16.0 + var53 * 2.0 && p_180707_10_ <= var22 + 16.0 + var53 * 2.0) {
                    ...
                    boolean var57 = false;
                    int var41 = var54;
                    while (!var57 && var41 < var35) {
                        int var42 = var56;
                        while (!var57 && var42 < var39) {
                            int var43 = var37 + 1;
                            while (!var57 && var43 >= var55 - 1) {
                    ...
                    if (!var57) {
                        ...
                        while (var41 < var35) {
                            ...
                            while (var59 < var39) {
                                ...
                                boolean var47 = false;
                                if (var58 * var58 + var45 * var45 < 1.0) {
                                    int var48 = var37;
                                    while (var48 > var55) {
                                        double var49 = ((double)(var48 - 1) + 0.5 - p_180707_8_) / var30;
                                        if ((var58 * var58 + var45 * var45) * (double)this.field_75046_d[var48 - 1] + var49 * var49 / 6.0 < 1.0) {
