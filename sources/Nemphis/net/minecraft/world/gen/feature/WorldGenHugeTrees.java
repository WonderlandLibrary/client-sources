...
extends WorldGenAbstractTree {
    ...
    private boolean func_175926_c(World worldIn, BlockPos p_175926_2_, int p_175926_3_) {
        ...
        if (p_175926_2_.getY() >= 1 && p_175926_2_.getY() + p_175926_3_ + 1 <= 256) {
            ...
            while (var5 <= 1 + p_175926_3_) {
                ...
                int var7 = - var6;
                while (var7 <= var6 && var4) {
                    int var8 = - var6;
                    while (var8 <= var6 && var4) {
    ...
    protected boolean func_175929_a(World worldIn, Random p_175929_2_, BlockPos p_175929_3_, int p_175929_4_) {
        if (this.func_175926_c(worldIn, p_175929_3_, p_175929_4_) && this.func_175927_a(p_175929_3_, worldIn)) {
            return true;
        }
        return false;
    }
    ...
    protected void func_175925_a(World worldIn, BlockPos p_175925_2_, int p_175925_3_) {
        ...
        int var5 = - p_175925_3_;
        while (var5 <= p_175925_3_ + 1) {
            int var6 = - p_175925_3_;
            while (var6 <= p_175925_3_ + 1) {
                BlockPos var9;
                Material var10;
                int var7 = var5 - 1;
                int var8 = var6 - 1;
                if (!(var5 * var5 + var6 * var6 > var4 && var7 * var7 + var8 * var8 > var4 && var5 * var5 + var8 * var8 > var4 && var7 * var7 + var6 * var6 > var4 || (var10 = worldIn.getBlockState(var9 = p_175925_2_.add(var5, 0, var6)).getBlock().getMaterial()) != Material.air && var10 != Material.leaves)) {
    ...
    protected void func_175928_b(World worldIn, BlockPos p_175928_2_, int p_175928_3_) {
        ...
        int var5 = - p_175928_3_;
        while (var5 <= p_175928_3_) {
            int var6 = - p_175928_3_;
            while (var6 <= p_175928_3_) {
                Material var8;
                BlockPos var7;
                if (var5 * var5 + var6 * var6 <= var4 && ((var8 = worldIn.getBlockState(var7 = p_175928_2_.add(var5, 0, var6)).getBlock().getMaterial()) == Material.air || var8 == Material.leaves)) {
