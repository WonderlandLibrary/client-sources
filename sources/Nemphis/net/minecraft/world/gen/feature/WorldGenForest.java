    ...
    public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_) {
        ...
        if (p_180709_3_.getY() >= 1 && p_180709_3_.getY() + var4 + 1 <= 256) {
            ...
            if ((var16 == Blocks.grass || var16 == Blocks.dirt || var16 == Blocks.farmland) && p_180709_3_.getY() < 256 - var4 - 1) {
                ...
                int var17 = p_180709_3_.getY() - 3 + var4;
                while (var17 <= p_180709_3_.getY() + var4) {
                    var8 = var17 - (p_180709_3_.getY() + var4);
                    var9 = 1 - var8 / 2;
                    int var10 = p_180709_3_.getX() - var9;
                    while (var10 <= p_180709_3_.getX() + var9) {
                        ...
                        while (var12 <= p_180709_3_.getZ() + var9) {
                            ...
                            if ((Math.abs(var11) != var9 || Math.abs(var13) != var9 || p_180709_2_.nextInt(2) != 0 && var8 != 0) && ((var15 = worldIn.getBlockState(var14 = new BlockPos(var10, var17, var12)).getBlock()).getMaterial() == Material.air || var15.getMaterial() == Material.leaves)) {
