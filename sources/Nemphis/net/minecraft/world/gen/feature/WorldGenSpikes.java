...
extends WorldGenerator {
    ...
    public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_) {
        if (worldIn.isAirBlock(p_180709_3_) && worldIn.getBlockState(p_180709_3_.offsetDown()).getBlock() == this.field_150520_a) {
            ...
            int var6 = p_180709_3_.getX() - var5;
            while (var6 <= p_180709_3_.getX() + var5) {
                var7 = p_180709_3_.getZ() - var5;
                while (var7 <= p_180709_3_.getZ() + var5) {
                    var8 = var6 - p_180709_3_.getX();
                    if (var8 * var8 + (var9 = var7 - p_180709_3_.getZ()) * var9 <= var5 * var5 + 1 && worldIn.getBlockState(new BlockPos(var6, p_180709_3_.getY() - 1, var7)).getBlock() != this.field_150520_a) {
                        return false;
                    }
                    ++var7;
                }
            ...
            var6 = p_180709_3_.getY();
            while (var6 < p_180709_3_.getY() + var4 && var6 < 256) {
                var7 = p_180709_3_.getX() - var5;
                while (var7 <= p_180709_3_.getX() + var5) {
                    var8 = p_180709_3_.getZ() - var5;
                    while (var8 <= p_180709_3_.getZ() + var5) {
                        int var10;
                        var9 = var7 - p_180709_3_.getX();
                        if (var9 * var9 + (var10 = var8 - p_180709_3_.getZ()) * var10 <= var5 * var5 + 1) {
