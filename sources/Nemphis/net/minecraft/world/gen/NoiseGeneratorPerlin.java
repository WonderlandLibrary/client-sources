...
extends NoiseGenerator {
    ...
    public double func_151601_a(double p_151601_1_, double p_151601_3_) {
        ...
        double var7 = 1.0;
        int var9 = 0;
        while (var9 < this.field_151602_b) {
    ...
    public double[] func_151600_a(double[] p_151600_1_, double p_151600_2_, double p_151600_4_, int p_151600_6_, int p_151600_7_, double p_151600_8_, double p_151600_10_, double p_151600_12_, double p_151600_14_) {
        if (p_151600_1_ != null && p_151600_1_.length >= p_151600_6_ * p_151600_7_) {
            int var16 = 0;
            while (var16 < p_151600_1_.length) {
        ...
        double var18 = 1.0;
        int var20 = 0;
        while (var20 < this.field_151602_b) {
            this.field_151603_a[var20].func_151606_a(p_151600_1_, p_151600_2_, p_151600_4_, p_151600_6_, p_151600_7_, p_151600_8_ * var18 * var21, p_151600_10_ * var18 * var21, 0.55 / var21);
            var18 *= p_151600_12_;
            var21 *= p_151600_14_;
            ++var20;
        }
