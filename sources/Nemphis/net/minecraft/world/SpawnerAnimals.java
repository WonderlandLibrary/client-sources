...
public final class SpawnerAnimals {
    ...
    public int findChunksForSpawning(WorldServer p_77192_1_, boolean p_77192_2_, boolean p_77192_3_, boolean p_77192_4_) {
        ...
        for (EntityPlayer var7 : p_77192_1_.playerEntities) {
            ...
            var9 = MathHelper.floor_double(var7.posZ / 16.0);
            int var10 = 8;
            int var11 = - var10;
            while (var11 <= var10) {
                var12 = - var10;
        ...
        while (var39 < var9) {
            ...
            if (!(var40.getPeacefulCreature() && !p_77192_3_ || !var40.getPeacefulCreature() && !p_77192_2_ || var40.getAnimal() && !p_77192_4_ || (var12 = p_77192_1_.countEntities(var40.getCreatureClass())) > (var41 = var40.getMaxNumberOfCreature() * var5 / field_180268_a))) {
                block6 : for (ChunkCoordIntPair var15 : this.eligibleChunksForSpawning) {
                    ...
                    while (var22 < 3) {
                        ...
                        for (int var29 = 0; var29 < 4; ++var29) {
                            ...
                            if (var27 == null && (var27 = p_77192_1_.func_175734_a(var40, var30)) == null) break;
    ...
    public static boolean func_180267_a(EntityLiving.SpawnPlacementType p_180267_0_, World worldIn, BlockPos p_180267_2_) {
        ...
        if (p_180267_0_ == EntityLiving.SpawnPlacementType.IN_WATER) {
            if (var3.getMaterial().isLiquid() && worldIn.getBlockState(p_180267_2_.offsetDown()).getBlock().getMaterial().isLiquid() && !worldIn.getBlockState(p_180267_2_.offsetUp()).getBlock().isNormalCube()) {
                return true;
            }
            return false;
        }
        ...
        if (var6 && !var3.isNormalCube() && !var3.getMaterial().isLiquid() && !worldIn.getBlockState(p_180267_2_.offsetUp()).getBlock().isNormalCube()) {
            return true;
        }
        return false;
    }
                ...
                while (var15 < var9) {
                    ...
                    while (!var16 && var17 < 4) {
                        block8 : {
                            ...
                            while (var11 < p_77191_2_ || (var11 += p_77191_6_.nextInt(5) - p_77191_6_.nextInt(5)) >= p_77191_2_ + p_77191_4_ || var12 < p_77191_3_ || (var12 += p_77191_6_.nextInt(5) - p_77191_6_.nextInt(5)) >= p_77191_3_ + p_77191_4_) {
