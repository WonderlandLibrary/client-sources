...
implements IBlockAccess {
    ...
    public ChunkCache(World worldIn, BlockPos p_i45746_2_, BlockPos p_i45746_3_, int p_i45746_4_) {
        ...
        var7 = p_i45746_2_.getX() >> 4;
        while (var7 <= p_i45746_3_.getX() >> 4) {
            var8 = p_i45746_2_.getZ() >> 4;
            while (var8 <= p_i45746_3_.getZ() >> 4) {
    ...
    public IBlockState getBlockState(BlockPos pos) {
        if (pos.getY() >= 0 && pos.getY() < 256) {
            ...
            int var2 = (pos.getX() >> 4) - this.chunkX;
            int var3 = (pos.getZ() >> 4) - this.chunkZ;
            if (var2 >= 0 && var2 < this.chunkArray.length && var3 >= 0 && var3 < this.chunkArray[var2].length && (var4 = this.chunkArray[var2][var3]) != null) {
