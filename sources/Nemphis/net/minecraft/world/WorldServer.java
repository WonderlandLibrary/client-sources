...
implements IThreadListener {
    ...
    public void updateAllPlayersSleepingFlag() {
        ...
        if (!this.playerEntities.isEmpty()) {
            ...
            for (EntityPlayer var4 : this.playerEntities) {
                ...
                if (!var4.isPlayerSleeping()) continue;
                ++var2;
            }
    ...
    public boolean areAllPlayersAsleep() {
        if (this.allPlayersSleeping && !this.isRemote) {
            ...
            do {
                ...
                return true;
            } while (!(var2 = (EntityPlayer)var1.next()).func_175149_v() && var2.isPlayerFullyAsleep());
            return false;
        }
        return false;
    }
    ...
    protected void func_147456_g() {
        ...
        if (this.worldInfo.getTerrainType() == WorldType.DEBUG_WORLD) {
            for (ChunkCoordIntPair var22 : this.activeChunkSet) {
    ...
    protected BlockPos func_175736_a(BlockPos p_175736_1_) {
        ...
        List var4 = this.func_175647_a(EntityLivingBase.class, var3, new Predicate(){
            ...
            public boolean func_180242_a(EntityLivingBase p_180242_1_) {
                if (p_180242_1_ != null && p_180242_1_.isEntityAlive() && WorldServer.this.isAgainstSky(p_180242_1_.getPosition())) {
                    return true;
                }
                return false;
            }
    ...
    public void func_175654_a(BlockPos p_175654_1_, Block p_175654_2_, int p_175654_3_, int p_175654_4_) {
        ...
        if (this.scheduledUpdatesAreImmediate && p_175654_2_.getMaterial() != Material.air) {
            if (p_175654_2_.requiresUpdates()) {
                IBlockState var7;
                var6 = 8;
                if (this.isAreaLoaded(var5.field_180282_a.add(- var6, - var6, - var6), var5.field_180282_a.add(var6, var6, var6)) && (var7 = this.getBlockState(var5.field_180282_a)).getBlock().getMaterial() != Material.air && var7.getBlock() == var5.func_151351_a()) {
    ...
    public boolean tickUpdates(boolean p_72955_1_) {
        ...
        while (var3 < var2) {
            ...
            if (!p_72955_1_ && var4.scheduledTime > this.worldInfo.getWorldTotalTime()) break;
        ...
        while (var11.hasNext()) {
            ...
            if (this.isAreaLoaded(var4.field_180282_a.add(- var5, - var5, - var5), var4.field_180282_a.add(var5, var5, var5))) {
                ...
                if (var6.getBlock().getMaterial() == Material.air || !Block.isEqualTo(var6.getBlock(), var4.func_151351_a())) continue;
                try {
    ...
    public List func_175712_a(StructureBoundingBox p_175712_1_, boolean p_175712_2_) {
        ...
        while (var4 < 2) {
            ...
            while (var5.hasNext()) {
                ...
                if (var7.getX() < p_175712_1_.minX || var7.getX() >= p_175712_1_.maxX || var7.getZ() < p_175712_1_.minZ || var7.getZ() >= p_175712_1_.maxZ) continue;
                if (p_175712_2_) {
    ...
    public List func_147486_a(int p_147486_1_, int p_147486_2_, int p_147486_3_, int p_147486_4_, int p_147486_5_, int p_147486_6_) {
        ...
        int var8 = 0;
        while (var8 < this.loadedTileEntityList.size()) {
    ...
    public boolean isBlockModifiable(EntityPlayer p_175660_1_, BlockPos p_175660_2_) {
        if (!this.mcServer.isBlockProtected(this, p_175660_2_, p_175660_1_) && this.getWorldBorder().contains(p_175660_2_)) {
            return true;
        }
        return false;
    }
    ...
    private void setDebugWorldSettings() {
        ...
        this.worldInfo.setWorldTime(6000);
    ...
    protected void createBonusChest() {
        ...
        while (var2 < 10) {
            ...
            BlockPos var5 = this.func_175672_r(new BlockPos(var3, 0, var4 = this.worldInfo.getSpawnZ() + this.rand.nextInt(6) - this.rand.nextInt(6))).offsetUp();
            if (var1.generate(this, this.rand, var5)) break;
            ++var2;
        }
    }
    ...
    public void saveAllChunks(boolean p_73044_1_, IProgressUpdate p_73044_2_) throws MinecraftException {
        if (this.chunkProvider.canSave()) {
            ...
            for (Chunk var5 : var3) {
                if (this.thePlayerManager.func_152621_a(var5.xPosition, var5.zPosition)) continue;
    ...
    public Explosion newExplosion(Entity p_72885_1_, double p_72885_2_, double p_72885_4_, double p_72885_6_, float p_72885_8_, boolean p_72885_9_, boolean p_72885_10_) {
        ...
        for (EntityPlayer var13 : this.playerEntities) {
            if (var13.getDistanceSq(p_72885_2_, p_72885_4_, p_72885_6_) >= 4096.0) continue;
    ...
    public void addBlockEvent(BlockPos pos, Block blockIn, int eventID, int eventParam) {
        ...
        do {
            ...
            return;
        } while (!(var7 = (BlockEventData)var6.next()).equals(var5));
    }
    ...
    public /* varargs */ void func_175739_a(EnumParticleTypes p_175739_1_, double p_175739_2_, double p_175739_4_, double p_175739_6_, int p_175739_8_, double p_175739_9_, double p_175739_11_, double p_175739_13_, double p_175739_15_, int ... p_175739_17_) {
    ...
    public /* varargs */ void func_180505_a(EnumParticleTypes p_180505_1_, boolean p_180505_2_, double p_180505_3_, double p_180505_5_, double p_180505_7_, int p_180505_9_, double p_180505_10_, double p_180505_12_, double p_180505_14_, double p_180505_16_, int ... p_180505_18_) {
        ...
        int var20 = 0;
        while (var20 < this.playerEntities.size()) {
