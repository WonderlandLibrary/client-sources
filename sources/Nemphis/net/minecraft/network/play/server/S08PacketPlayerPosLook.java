...
implements Packet {
    ...
    public static enum EnumFlags {
        ...
        private EnumFlags(String p_i45992_1_, int p_i45992_2_, String p_i45992_3_, int n2, int n3) {
        ...
        private boolean func_180054_b(int p_180054_1_) {
            if ((p_180054_1_ & this.func_180055_a()) == this.func_180055_a()) {
                return true;
            }
            return false;
        }
        ...
        public static Set func_180053_a(int p_180053_0_) {
            ...
            EnumFlags[] var2 = EnumFlags.values();
