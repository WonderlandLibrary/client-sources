...
IUpdatePlayerListBox {
    ...
    public void update() {
        ...
        if ((long)this.networkTickCount - this.lastSentPingPacket > 40) {
        ...
        if (this.playerEntity.getLastActiveTime() > 0 && this.serverController.getMaxPlayerIdleMinutes() > 0 && MinecraftServer.getCurrentTimeMillis() - this.playerEntity.getLastActiveTime() > (long)(this.serverController.getMaxPlayerIdleMinutes() * 1000 * 60)) {
