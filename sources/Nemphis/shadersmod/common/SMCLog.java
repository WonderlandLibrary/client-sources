...
public abstract class SMCLog {
    ...
    public static /* varargs */ void log(Level level, String format, Object ... args) {
        if (logger.isLoggable(level)) {
    ...
    public static /* varargs */ void config(String format, Object ... args) {
        if (logger.isLoggable(SMCCONFIG)) {
    ...
    public static /* varargs */ void finer(String format, Object ... args) {
        if (logger.isLoggable(SMCFINER)) {
            logger.log(SMCFINER, String.format(format, args));
        }
    }

    public static /* varargs */ void finest(String format, Object ... args) {
        if (logger.isLoggable(SMCFINEST)) {
    ...
    extends Formatter {
        ...
        /* synthetic */ SMCFormatter(SMCFormatter sMCFormatter) {
            SMCFormatter sMCFormatter2;
            sMCFormatter2();
        }
    }
    ...
    extends Level {
        ...
        SMCLevel(String x0, int x1, NamelessClass763038833 x2) {
            this(x0, x1);
        }
    }
    ...
    extends Logger {
        SMCLogger(String name) {
            ...
            SMCFormatter formatter = new SMCFormatter(null);
