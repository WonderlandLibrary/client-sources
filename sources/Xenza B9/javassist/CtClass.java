...
public abstract class CtClass
{
    ...
    public static void main(final String[] args) {
        System.out.println("Javassist version 3.29.1-GA");
    ...
    public synchronized Collection<String> getRefClasses() {
        ...
        if (cf != null) {
            ...
            cf.getRefClasses(cm);
            return ((HashMap<K, String>)cm).values();
        }
        return null;
    }
    ...
    public Class<?> toClass(final Class<?> neighbor) throws CannotCompileException {
