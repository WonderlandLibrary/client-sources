...
public class Descriptor
{
    ...
    public static String toClassName(final String descriptor) {
        ...
        final StringBuilder sbuf = new StringBuilder(name);
        do {
            sbuf.append("[]");
        } while (--arrayDim > 0);
    ...
    public static String rename(final String desc, final Map<String, String> map) {
        if (map == null) {
            return desc;
        }
        final StringBuilder newdesc = new StringBuilder();
    ...
    private static void toDescriptor(final StringBuilder desc, final CtClass type) {
        if (type.isArray()) {
            desc.append('[');
            try {
    ...
    static class PrettyPrinter
    {
        ...
        static int readType(final StringBuilder sbuf, int pos, final String desc) {
