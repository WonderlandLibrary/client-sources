...
public class CodeAttribute extends AttributeInfo implements Opcode
{
    ...
    private CodeAttribute(final ConstPool cp, final CodeAttribute src, final Map<String, String> classnames) throws BadBytecode {
        super(cp, "Code");
        this.maxStack = src.getMaxStack();
        this.maxLocals = src.getMaxLocals();
        this.exceptions = src.getExceptionTable().copy(cp, classnames);
        this.attributes = new ArrayList<AttributeInfo>();
        final List<AttributeInfo> src_attr = src.getAttributes();
    ...
    @Override
    public AttributeInfo copy(final ConstPool newCp, final Map<String, String> classnames) throws RuntimeCopyException {
        try {
    ...
    private byte[] copyCode(final ConstPool destCp, final Map<String, String> classnames, final ExceptionTable etable, final CodeAttribute destCa) throws BadBytecode {
    ...
    private static LdcEntry copyCode(final byte[] code, final int beginPos, final int endPos, final ConstPool srcCp, final byte[] newcode, final ConstPool destCp, final Map<String, String> classnameMap) throws BadBytecode {
    ...
    private static void copyConstPoolInfo(final int i, final byte[] code, final ConstPool srcCp, final byte[] newcode, final ConstPool destCp, final Map<String, String> classnameMap) {
