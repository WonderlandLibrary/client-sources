...
public class AnnotationImpl implements InvocationHandler
{
    ...
    public static Object make(final ClassLoader cl, final Class<?> clazz, final ClassPool cp, final Annotation anon) throws IllegalArgumentException {
    ...
    private boolean checkEquals(final Object obj) throws Exception {
        ...
        final Class<?> otherAnnotationType = (Class<?>)AnnotationImpl.JDK_ANNOTATION_TYPE_METHOD.invoke(obj, new Object[0]);
