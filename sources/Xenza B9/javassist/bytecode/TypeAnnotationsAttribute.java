...
public class TypeAnnotationsAttribute extends AttributeInfo
{
    ...
    static class Renamer extends AnnotationsAttribute.Renamer
    {
        ...
        Renamer(final byte[] attrInfo, final ConstPool cp, final Map<String, String> map) {
    ...
    static class Copier extends AnnotationsAttribute.Copier
    {
        ...
        Copier(final byte[] attrInfo, final ConstPool src, final ConstPool dest, final Map<String, String> map) {
    ...
    static class SubCopier extends SubWalker
    {
        ...
        SubCopier(final byte[] attrInfo, final ConstPool src, final ConstPool dest, final Map<String, String> map, final TypeAnnotationsWriter w) {
            super(attrInfo);
            this.srcPool = src;
            this.destPool = dest;
            this.classnames = map;
