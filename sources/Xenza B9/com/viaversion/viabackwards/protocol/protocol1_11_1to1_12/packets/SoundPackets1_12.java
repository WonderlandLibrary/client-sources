...
{
    public SoundPackets1_12(final Protocol1_11_1To1_12 protocol) {
        super(protocol);
    }
            ...
            public void registerMap() {
                ...
                this.handler(new PacketHandler() {
                    ...
                    public void handle(final PacketWrapper wrapper) throws Exception {
                        final int oldId = wrapper.get((Type<Integer>)Type.VAR_INT, 0);
                        final int newId = SoundPackets1_12.this.handleSounds(oldId);
                        if (newId == -1) {
                            wrapper.cancel();
                            return;
                        }
