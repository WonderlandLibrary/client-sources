...
{
    private static final Map<String, String> advancements;
    
    private static void add(final String key, final String value) {
        AdvancementTranslations.advancements.put(key, value);
    }
    
    public static String get(final String key) {
        return AdvancementTranslations.advancements.get(key);
    }
