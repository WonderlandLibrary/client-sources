...
public interface ViaBackwardsPlatform
{
    ...
    public static final String IMPL_VERSION = "git-ViaBackwards-4.4.3-SNAPSHOT:c554027";
    ...
    default void init(final File dataFolder) {
        ...
        Via.getManager().getSubPlatforms().add("git-ViaBackwards-4.4.3-SNAPSHOT:c554027");
