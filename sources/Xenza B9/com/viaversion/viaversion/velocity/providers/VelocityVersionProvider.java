...
public class VelocityVersionProvider extends BaseVersionProvider
{
    ...
    private int getBackProtocol(final UserConnection user) throws Exception {
        ...
        return Via.proxyPlatform().protocolDetectorService().serverProtocolVersion(((ServerConnection)VelocityVersionProvider.getAssociation.invoke(mcHandler, new Object[0])).getServerInfo().getName());
    }
