...
public class VelocityViaConfig extends AbstractViaConfig
{
    ...
    protected void loadFields() {
        ...
        this.velocityServerProtocols = this.get("velocity-servers", (Class<HashMap>)Map.class, new HashMap());
    }
    ...
    protected void handleConfig(final Map<String, Object> config) {
        ...
        for (final Map.Entry<String, Object> entry : new HashSet(servers.entrySet())) {
