            ...
            if (section != null) {
                ...
                if (willConnect) {
                    ...
                    for (int idx = 0; idx < 4096; ++idx) {
                        ...
                        if (handler != null) {
                            id2 = handler.connect(user, new Position(xOff + ChunkSection.xFromIndex(idx), yOff + ChunkSection.yFromIndex(idx), zOff + ChunkSection.zFromIndex(idx)), id2);
                            blocks.setIdAt(idx, id2);
                        }
                    }
                }
            }
