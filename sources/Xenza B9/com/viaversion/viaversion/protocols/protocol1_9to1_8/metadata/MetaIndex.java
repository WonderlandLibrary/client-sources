...
public enum MetaIndex
{
    ...
    private MetaIndex(final Entity1_10Types.EntityType type, final int index, final MetaType1_8 oldType, final MetaType1_9 newType) {
        this.clazz = type;
        this.index = index;
        this.newIndex = index;
    ...
    private MetaIndex(final Entity1_10Types.EntityType type, final int index, final MetaType1_8 oldType, final int newIndex, final MetaType1_9 newType) {
        this.clazz = type;
        this.index = index;
        this.oldType = oldType;
    ...
    static {
        ...
        for (final MetaIndex index : values()) {
            MetaIndex.metadataRewrites.put(new Pair<Entity1_10Types.EntityType, Integer>(index.clazz, index.index), index);
        }
    }
}
