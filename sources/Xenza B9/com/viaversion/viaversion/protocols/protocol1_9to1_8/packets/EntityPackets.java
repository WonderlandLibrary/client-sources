            ...
            public void registerMap() {
                ...
                this.handler(new PacketHandler() {
                    ...
                    public void handle(final PacketWrapper wrapper) throws Exception {
                        ...
                        properties.put("generic.attackSpeed", new Pair<Double, List<Triple<UUID, Double, Byte>>>(15.9, (List<Triple<UUID, Double, Byte>>)ImmutableList.of(new Triple(UUID.fromString("FA233E1C-4180-4865-B01B-BCCE9785ACA3"), 0.0, 0), new Triple(UUID.fromString("AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF3"), 0.0, 2), new Triple(UUID.fromString("55FCED67-E92A-486E-9800-B47F202C4386"), 0.0, 2))));
                        ...
                        for (final Map.Entry<String, Pair<Double, List<Triple<UUID, Double, Byte>>>> entry : properties.entrySet()) {
                            ...
                            wrapper.write((Type<Object>)Type.DOUBLE, entry.getValue().key());
                            wrapper.write(Type.VAR_INT, ((List)entry.getValue().value()).size());
                            for (final Triple<UUID, Double, Byte> modifier : (List)entry.getValue().value()) {
