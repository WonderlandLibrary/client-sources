...
public enum SoundEffect
{
    ...
    private SoundEffect(final String name, final String newname, final SoundCategory cat) {
        this.category = cat;
    ...
    private SoundEffect(final String name, final String newname, final SoundCategory cat, final boolean shouldIgnore) {
        this.category = cat;
        this.newName = newname;
        this.name = name;
    ...
    static {
        ...
        for (final SoundEffect e : values()) {
            SoundEffect.effects.put(e.getName(), e);
        }
    }
}
