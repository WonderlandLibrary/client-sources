...
{
    private static final Int2ObjectMap<Pair<Integer, Boolean>> POTIONS;
    
    public static Pair<Integer, Boolean> getNewData(final int oldData) {
        return PotionColorMapping.POTIONS.get(oldData);
    }
    
    private static void addRewrite(final int oldData, final int newData, final boolean isInstant) {
        PotionColorMapping.POTIONS.put(oldData, new Pair<Integer, Boolean>(newData, isInstant));
    }
    
    static {
        POTIONS = new Int2ObjectOpenHashMap<Pair<Integer, Boolean>>(37, 0.99f);
