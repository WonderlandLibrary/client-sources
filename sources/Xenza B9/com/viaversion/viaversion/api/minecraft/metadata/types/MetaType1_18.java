...
public enum MetaType1_18 implements MetaType
{
    ...
    PARTICLE(15, (Type)Types1_18.PARTICLE), 
    VILLAGER_DATA(16, (Type)Type.VILLAGER_DATA), 
    OPT_VAR_INT(17, (Type)Type.OPTIONAL_VAR_INT), 
    POSE(18, (Type)Type.VAR_INT);
    
    private static final MetaType1_18[] VALUES;
    private final int typeId;
    private final Type type;
    
    private MetaType1_18(final int typeId, final Type type) {
        this.typeId = typeId;
        this.type = type;
    }
    
    public static MetaType1_18 byId(final int id) {
        return MetaType1_18.VALUES[id];
    }
