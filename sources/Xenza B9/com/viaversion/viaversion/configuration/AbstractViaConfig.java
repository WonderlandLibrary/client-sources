...
public abstract class AbstractViaConfig extends Config implements ViaVersionConfig
{
    ...
    protected void loadFields() {
        ...
        final Map<String, String> worlds = this.get("map-1_16-world-names", (Class<HashMap>)Map.class, new HashMap());
        ...
        this.chatTypeFormats = this.get("chat-types-1_19", (Class<HashMap>)Map.class, new HashMap());
    }
        ...
        if (lowerBound != -1 || upperBound != -1) {
            ...
            blockedProtocols.removeIf(version -> {
                if ((finalLowerBound != -1 && version < finalLowerBound) || (finalUpperBound != -1 && version > finalUpperBound)) {
                    final ProtocolVersion protocolVersion2 = ProtocolVersion.getProtocol(version);
