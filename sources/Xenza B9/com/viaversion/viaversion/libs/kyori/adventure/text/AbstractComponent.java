...
public abstract class AbstractComponent implements Component
{
    ...
    public Stream<? extends ExaminableProperty> examinableProperties() {
        return Stream.concat(this.examinablePropertiesWithoutChildren(), (Stream<? extends ExaminableProperty>)Stream.of(ExaminableProperty.of("children", this.children)));
    }
