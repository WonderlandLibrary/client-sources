...
public class Reflection implements Translator
{
    ...
    public void start(final ClassPool pool) throws NotFoundException {
        this.classPool = pool;
        final String msg = "com.viaversion.viaversion.libs.javassist.tools.reflect.Sample is not found or broken.";
        try {
            final CtClass c = this.classPool.get("com.viaversion.viaversion.libs.javassist.tools.reflect.Sample");
    ...
    public boolean makeReflective(final CtClass clazz, final CtClass metaobject, final CtClass metaclass) throws CannotCompileException, CannotReflectException, NotFoundException {
        ...
        if (clazz.subclassOf(this.classPool.get("com.viaversion.viaversion.libs.javassist.tools.reflect.ClassMetaobject"))) {
            throw new CannotReflectException("Cannot reflect a subclass of ClassMetaobject: " + clazz.getName());
        }
        if (clazz.subclassOf(this.classPool.get("com.viaversion.viaversion.libs.javassist.tools.reflect.Metaobject"))) {
    ...
    private boolean modifyClassfile(final CtClass clazz, final CtClass metaobject, final CtClass metaclass) throws CannotCompileException, NotFoundException {
        ...
        final CtClass mlevel = this.classPool.get("com.viaversion.viaversion.libs.javassist.tools.reflect.Metalevel");
        ...
        if (addMeta) {
            final CtField f = new CtField(this.classPool.get("com.viaversion.viaversion.libs.javassist.tools.reflect.Metaobject"), "_metaobject", clazz);
            f.setModifiers(4);
        ...
        final CtField f = new CtField(this.classPool.get("com.viaversion.viaversion.libs.javassist.tools.reflect.ClassMetaobject"), "_classobject", clazz);
        f.setModifiers(10);
