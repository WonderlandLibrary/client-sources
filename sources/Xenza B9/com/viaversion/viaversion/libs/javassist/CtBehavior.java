...
public abstract class CtBehavior extends CtMember
{
    ...
    static void setBody0(final CtClass srcClass, final MethodInfo srcInfo, final CtClass destClass, final MethodInfo destInfo, ClassMap map) throws CannotCompileException {
        ...
        catch (final CodeAttribute.RuntimeCopyException e) {
            throw new CannotCompileException(e);
        }
    ...
    public void useCflow(final String name) throws CannotCompileException {
        ...
        while (true) {
            ...
            try {
                ...
                try {
                    final CtClass type = pool.get("com.viaversion.viaversion.libs.javassist.runtime.Cflow");
    ...
    private void insertBefore(final String src, final boolean rebuild) throws CannotCompileException {
        ...
        catch (final CompileError e2) {
            throw new CannotCompileException(e2);
        }
        catch (final BadBytecode e3) {
    ...
    public void insertAfter(final String src, final boolean asFinally, final boolean redundant) throws CannotCompileException {
        final CtClass cc = this.declaringClass;
        cc.checkModify();
            ...
            while (iterator.hasNext()) {
                ...
                if (redundant) {
                    ...
                    if (noReturn) {
                        ...
                        final int nvars2 = jvc.recordParams(this.getParameterTypes(), Modifier.isStatic(this.getModifiers()));
                        jvc.recordParamNames(ca, nvars2);
                        retVarNo = jvc.recordReturnType(rtype, true);
                        jvc.recordLocalVariables(ca, 0);
                    }
                    final int adviceLen2 = this.insertAfterAdvice(bcode, jvc, src, pool, rtype, retVarNo);
                    final int offset = iterator.append(bcode.get());
                    iterator.append(bcode.getExceptionTable(), offset);
                    final int advicePos2 = iterator.getCodeLength() - adviceLen2;
