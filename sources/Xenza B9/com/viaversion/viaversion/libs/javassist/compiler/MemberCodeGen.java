...
public class MemberCodeGen extends CodeGen
{
    ...
    protected void atTryStmnt(final Stmnt st) throws CompileError {
        ...
        final List<Integer> gotoList = new ArrayList<Integer>();
    ...
    private void addFinally(final List<int[]> returnList, final Stmnt finallyBlock) throws CompileError {
        final Bytecode bc = this.bytecode;
    ...
    private boolean isFromSameDeclaringClass(CtClass outer, final CtClass inner) {
        try {
            while (outer != null) {
    ...
    protected CtField fieldAccess(final ASTree expr, final boolean acceptLength) throws CompileError {
        ...
        if (expr instanceof Expr) {
            ...
            if (op == 35) {
                final CtField f2 = this.resolver.lookupField(((Symbol)e2.oprand1()).get(), (Symbol)e2.oprand2());
            ...
            if (op == 46) {
                ...
                try {
                    ...
                    if (this.exprType == 307 && this.arrayDim == 0) {
                        f2 = this.resolver.lookupFieldByJvmName(this.className, (Symbol)e2.oprand2());
                    }
                    else {
                    ...
                    final Symbol fname = (Symbol)e2.oprand2();
