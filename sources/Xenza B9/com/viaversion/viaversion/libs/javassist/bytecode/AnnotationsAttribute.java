...
public class AnnotationsAttribute extends AttributeInfo
{
    ...
    static class Renamer extends Walker
    {
        ...
        Renamer(final byte[] info, final ConstPool cp, final Map<String, String> map) {
            super(info);
            this.cpool = cp;
            this.classnames = map;
        }
    ...
    static class Copier extends Walker
    {
        ...
        Copier(final byte[] info, final ConstPool src, final ConstPool dest, final Map<String, String> map) {
            this(info, src, dest, map, true);
        }
        
        Copier(final byte[] info, final ConstPool src, final ConstPool dest, final Map<String, String> map, final boolean makeWriter) {
            super(info);
