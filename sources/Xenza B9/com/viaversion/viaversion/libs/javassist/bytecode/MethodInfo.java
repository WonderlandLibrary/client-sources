...
public class MethodInfo
{
    ...
    public MethodInfo(final ConstPool cp, final String methodname, final MethodInfo src, final Map<String, String> classnameMap) throws BadBytecode {
        this(cp);
    ...
    private void read(final MethodInfo src, final String methodname, final Map<String, String> classnames) {
