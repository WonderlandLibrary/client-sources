...
public class NBTIO
{
    ...
    public static CompoundTag readTag(final InputStream in, final TagLimiter tagLimiter) throws IOException {
    ...
    public static CompoundTag readTag(final DataInput in, final TagLimiter tagLimiter) throws IOException {
