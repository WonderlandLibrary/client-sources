...
public abstract class AbstractInt2ObjectSortedMap<V> extends AbstractInt2ObjectMap<V> implements Int2ObjectSortedMap<V>
{
    ...
    protected class KeySet extends AbstractIntSortedSet
    {
        ...
        public IntBidirectionalIterator iterator(final int from) {
            return new KeySetIterator<Object>((ObjectBidirectionalIterator<Int2ObjectMap.Entry<?>>)AbstractInt2ObjectSortedMap.this.int2ObjectEntrySet().iterator(new BasicEntry<Object>(from, null)));
        }
