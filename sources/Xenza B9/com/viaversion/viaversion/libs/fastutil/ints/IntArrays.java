                ...
                while (true) {
                    if (queueSize.get() == 0) {
                        ...
                        while (true) {
                            ...
                            final Object o;
                            if (o != 0) {
                                queue.add(IntArrays.POISON_PILL);
                            }
                            else {
                                break;
                            }
                    ...
                    if (segment == IntArrays.POISON_PILL) {
                        ...
                        while (true) {
                            ...
                            final Object o2;
                            if (o2 != first) {
                                final int n = (a[l] >>> shift & 0xFF) ^ signMask;
                                final Object o3;
                                ++o3[n];
                            }
                            else {
                        ...
                        int c2;
                        for (int end = first + length - count[lastUsed], i2 = first, c = -1; i2 <= end; i2 += count[c2], count[c2] = 0) {
                            int t = a[i2];
                            ...
                            if (level < 3 && count[c2] > 1) {
                                if (count[c2] < 1024) {
                                    quickSort(a, i2, i2 + count[c2]);
                                }
                                else {
                                    queueSize.incrementAndGet();
                                    queue.add(new Segment(i2, count[c2], level + 1));
                                }
                            }
                        }
                ...
                while (true) {
                    ...
                    if (segment == IntArrays.POISON_PILL) {
                        ...
                        while (true) {
                            ...
                            final Object o2;
                            if (o2 != first) {
                                final int n = (a[perm[l]] >>> shift & 0xFF) ^ signMask;
                                final Object o3;
                                ++o3[n];
                            }
                            else {
                        ...
                        if (stable) {
                            ...
                            while (true) {
                                ...
                                final Object o5;
                                if (o5 != first) {
                                    final int n3 = (a[perm[i2]] >>> shift & 0xFF) ^ signMask;
                                    final Object o6;
                                    final int n4 = o6[n3] - 1;
                                    support[o6[n3] = n4] = perm[i2];
                                }
                                else {
                                    break;
                                }
                            ...
                            while (i3 <= lastUsed) {
                                if (level < 3 && count[i3] > 1) {
                                    if (count[i3] < 1024) {
                                        radixSortIndirect(perm, a, p2, p2 + count[i3], stable);
                                    }
                                    else {
                                        queueSize.incrementAndGet();
                                        queue.add(new Segment(p2, count[i3], level + 1));
                                    }
                                }
                                p2 += count[i3];
                                ++i3;
                            ...
                            int c2;
                            for (int end = first + length - count[lastUsed], i4 = first, c = -1; i4 <= end; i4 += count[c2], count[c2] = 0) {
                                int t = perm[i4];
                                ...
                                if (level < 3 && count[c2] > 1) {
                                    if (count[c2] < 1024) {
                                        radixSortIndirect(perm, a, i4, i4 + count[c2], stable);
                                    }
                                    else {
                                        queueSize.incrementAndGet();
                                        queue.add(new Segment(i4, count[c2], level + 1));
                                    }
                                }
                            }
                        }
                ...
                while (true) {
                    ...
                    if (segment == IntArrays.POISON_PILL) {
                        ...
                        while (true) {
                            ...
                            final Object o2;
                            if (o2 != first) {
                                final int n = (l[m] >>> shift & 0xFF) ^ signMask;
                                final Object o3;
                                ++o3[n];
                            }
                            else {
                        ...
                        int c2;
                        for (int end = first + length - count[lastUsed], i3 = first, c = -1; i3 <= end; i3 += count[c2], count[c2] = 0) {
                            int t = a[i3];
                            int u = b[i3];
                            c2 = ((l[i3] >>> shift & 0xFF) ^ signMask);
                            if (i3 < end) {
                                while (true) {
                                    final Object o5;
                                    final int n4;
                            ...
                            if (level < 7 && count[c2] > 1) {
                                if (count[c2] < 1024) {
                                    quickSort(a, b, i3, i3 + count[c2]);
                                }
                                else {
                                    queueSize.incrementAndGet();
                                    queue.add(new Segment(i3, count[c2], level + 1));
                                }
                            }
                        }
                        queueSize.decrementAndGet();
