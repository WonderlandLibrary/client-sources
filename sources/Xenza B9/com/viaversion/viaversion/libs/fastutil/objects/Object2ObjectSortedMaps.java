    ...
    public static class Singleton<K, V> extends Object2ObjectMaps.Singleton<K, V> implements Object2ObjectSortedMap<K, V>, Serializable, Cloneable
    {
        ...
        public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
            if (this.entries == null) {
                this.entries = (ObjectSet<Object2ObjectMap.Entry<K, V>>)ObjectSortedSets.singleton(new AbstractObject2ObjectMap.BasicEntry(this.key, this.value), (Comparator<? super AbstractObject2ObjectMap.BasicEntry>)Object2ObjectSortedMaps.entryComparator((Comparator<? super Object>)this.comparator));
            }
