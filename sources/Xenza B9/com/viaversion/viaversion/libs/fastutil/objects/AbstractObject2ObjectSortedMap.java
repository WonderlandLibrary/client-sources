...
public abstract class AbstractObject2ObjectSortedMap<K, V> extends AbstractObject2ObjectMap<K, V> implements Object2ObjectSortedMap<K, V>
{
    ...
    protected class KeySet extends AbstractObjectSortedSet<K>
    {
        ...
        public ObjectBidirectionalIterator<K> iterator(final K from) {
            return new KeySetIterator<K, Object>((ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, ?>>)AbstractObject2ObjectSortedMap.this.object2ObjectEntrySet().iterator(new BasicEntry<Object, Object>(from, null)));
        }
