...
public enum MetaIndex1_8to1_7_6_10
{
    ...
    private MetaIndex1_8to1_7_6_10(final Entity1_10Types.EntityType type, final int index, final MetaType1_7_6_10 oldType, final MetaType1_8 newType) {
        this.clazz = type;
        this.index = index;
        this.newIndex = index;
    ...
    private MetaIndex1_8to1_7_6_10(final Entity1_10Types.EntityType type, final int index, final MetaType1_7_6_10 oldType, final int newIndex, final MetaType1_8 newType) {
        this.clazz = type;
        this.index = index;
        this.oldType = oldType;
    ...
    static {
        ...
        for (final MetaIndex1_8to1_7_6_10 index : values()) {
            MetaIndex1_8to1_7_6_10.metadataRewrites.put(new Pair<Entity1_10Types.EntityType, Integer>(index.getClazz(), index.getIndex()), index);
        }
    }
}
