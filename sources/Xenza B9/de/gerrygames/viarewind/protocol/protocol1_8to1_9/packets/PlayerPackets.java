    ...
    public static void register(final Protocol<ClientboundPackets1_9, ClientboundPackets1_8, ServerboundPackets1_9, ServerboundPackets1_8> protocol) {
        protocol.registerClientbound(ClientboundPackets1_9.BOSSBAR, null, new PacketRemapper() {
            ...
            public void registerMap() {
                this.handler(packetWrapper -> {
                    ...
                    final BossBarStorage bossBarStorage = packetWrapper.user().get(BossBarStorage.class);
                    if (action == 0) {
                        ...
                        final String title = ChatUtil.jsonToLegacy(packetWrapper.read(Type.COMPONENT));
        ...
        protocol.registerClientbound(ClientboundPackets1_9.GAME_EVENT, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.map(Type.FLOAT);
                this.handler(packetWrapper -> {
                    final int reason = packetWrapper.get((Type<Short>)Type.UNSIGNED_BYTE, 0);
                    if (reason == 3) {
        ...
        protocol.registerClientbound(ClientboundPackets1_9.PLAYER_POSITION, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.map(Type.BYTE);
                this.handler(packetWrapper -> {
                    final PlayerPosition pos = packetWrapper.user().get(PlayerPosition.class);
                    final int teleportId = packetWrapper.read((Type<Integer>)Type.VAR_INT);
                    pos.setConfirmId(teleportId);
                    final byte flags = packetWrapper.get((Type<Byte>)Type.BYTE, 0);
                    double x = packetWrapper.get((Type<Double>)Type.DOUBLE, 0);
                    double y = packetWrapper.get((Type<Double>)Type.DOUBLE, 1);
                    double z = packetWrapper.get((Type<Double>)Type.DOUBLE, 2);
                    float yaw = packetWrapper.get((Type<Float>)Type.FLOAT, 0);
                    float pitch = packetWrapper.get((Type<Float>)Type.FLOAT, 1);
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (msg.toLowerCase().startsWith("/offhand")) {
                        packetWrapper.cancel();
                        final PacketWrapper swapItems = PacketWrapper.create(19, null, packetWrapper.user());
        ...
        protocol.registerServerbound(ServerboundPackets1_8.INTERACT_ENTITY, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.map(Type.VAR_INT);
                this.handler(packetWrapper -> {
                    final int type = packetWrapper.get((Type<Integer>)Type.VAR_INT, 1);
                    if (type == 2) {
        ...
        protocol.registerServerbound(ServerboundPackets1_8.PLAYER_POSITION_AND_ROTATION, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    final double y = packetWrapper.get((Type<Double>)Type.DOUBLE, 1);
                    ...
                    final boolean onGround = packetWrapper.get((Type<Boolean>)Type.BOOLEAN, 0);
                    final PlayerPosition pos = packetWrapper.user().get(PlayerPosition.class);
                    if (pos.getConfirmId() != -1) {
        ...
        protocol.registerServerbound(ServerboundPackets1_8.PLAYER_DIGGING, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    final int state = packetWrapper.get((Type<Integer>)Type.VAR_INT, 0);
                    if (state == 0) {
                        packetWrapper.user().get(BlockPlaceDestroyTracker.class).setMining(true);
                    }
                    else if (state == 2) {
                        final BlockPlaceDestroyTracker tracker = packetWrapper.user().get(BlockPlaceDestroyTracker.class);
                        ...
                        final BlockPlaceDestroyTracker tracker2 = packetWrapper.user().get(BlockPlaceDestroyTracker.class);
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    if (packetWrapper.get((Type<Integer>)Type.VAR_INT, 0) == -1) {
                        packetWrapper.cancel();
                        final PacketWrapper useItem = PacketWrapper.create(29, null, packetWrapper.user());
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (action == 6) {
                        ...
                        final PlayerPosition pos = packetWrapper.user().get(PlayerPosition.class);
                        if (!pos.isOnGround()) {
                            final PacketWrapper elytra = PacketWrapper.create(20, null, packetWrapper.user());
                            elytra.write((Type<Object>)Type.VAR_INT, packetWrapper.get((Type<T>)Type.VAR_INT, 0));
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (vehicle != -1 && tracker.getClientEntityTypes().get(vehicle) == Entity1_10Types.EntityType.BOAT) {
                        final PacketWrapper steerBoat = PacketWrapper.create(17, null, packetWrapper.user());
                        final float left = packetWrapper.get((Type<Float>)Type.FLOAT, 0);
                        final float forward = packetWrapper.get((Type<Float>)Type.FLOAT, 1);
        ...
        protocol.registerServerbound(ServerboundPackets1_8.CLIENT_SETTINGS, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    final short flags = packetWrapper.get((Type<Short>)Type.UNSIGNED_BYTE, 0);
                    final PacketWrapper updateSkin = PacketWrapper.create(28, null, packetWrapper.user());
            ...
            public void registerMap() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (channel.equalsIgnoreCase("MC|BEdit") || channel.equalsIgnoreCase("MC|BSign")) {
                        final Item book = packetWrapper.passthrough(Type.ITEM);
                            ...
                            if (pages.size() > ViaRewind.getConfig().getMaxBookPages()) {
                                ...
                                while (i < pages.size()) {
                                    ...
                                    if (value.length() > ViaRewind.getConfig().getMaxBookPageSize()) {
                                        ...
                                        final String value2 = ChatUtil.jsonToLegacy(value);
                        ...
                        final String channel2 = "MC|AdvCmd";
                        final int n;
                        final T t;
