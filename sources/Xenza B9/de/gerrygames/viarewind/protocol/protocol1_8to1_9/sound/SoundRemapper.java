...
{
    private static final HashMap<Integer, String> sounds1_9;
    private static final HashMap<String, String> sound1_9to1_8;
    private static int id;
    
    private static void register1_9Sound(final String sound1_9) {
        SoundRemapper.sounds1_9.put(SoundRemapper.id++, sound1_9);
    }
    
    private static void registerSoundRemapping(final String sound1_9, final String sound1_8) {
        SoundRemapper.sound1_9to1_8.put(sound1_9, sound1_8);
    }
    
    public static String oldNameFromId(final int id) {
        final String sound1_9 = SoundRemapper.sounds1_9.get(id);
        if (sound1_9 == null) {
            return null;
        }
    ...
    public static String getOldName(final String sound1_9) {
        return SoundRemapper.sound1_9to1_8.getOrDefault(sound1_9, sound1_9);
    }
