...
public class EndermiteReplacement extends EntityReplacement1_7to1_8
{
    ...
    public void updateMetadata() {
        final PacketWrapper metadataPacket = PacketWrapper.create(ClientboundPackets1_7.ENTITY_METADATA, this.user);
    ...
    @Override
    public void spawn() {
        this.sendSpawn(this.entityId, 60, this.locX, this.locY, this.locZ);
    }
