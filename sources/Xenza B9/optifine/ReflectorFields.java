...
public class ReflectorFields
{
    ...
    public ReflectorFields(final ReflectorClass p_i90_1_, final Class p_i90_2_, final int p_i90_3_) {
    ...
    public ReflectorField getReflectorField(final int p_getReflectorField_1_) {
