...
public class CompactArrayList
{
    ...
    public CompactArrayList(final int p_i29_1_) {
        this(p_i29_1_, 0.75f);
    }
    
    public CompactArrayList(final int p_i30_1_, final float p_i30_2_) {
        this.list = null;
    ...
    public void add(final int p_add_1_, final Object p_add_2_) {
        if (p_add_2_ != null) {
            ++this.countValid;
        }
    ...
    public Object set(final int p_set_1_, final Object p_set_2_) {
        final Object object = this.list.set(p_set_1_, p_set_2_);
        if (p_set_2_ != object) {
            if (object == null) {
                ++this.countValid;
            }
    ...
    public Object remove(final int p_remove_1_) {
        final Object object = this.list.remove(p_remove_1_);
        if (object != null) {
            --this.countValid;
        }
        return object;
    ...
    public Object get(final int p_get_1_) {
