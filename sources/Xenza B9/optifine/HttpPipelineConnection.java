...
public class HttpPipelineConnection
{
    ...
    public HttpPipelineConnection(final String p_i55_1_, final int p_i55_2_) {
        this(p_i55_1_, p_i55_2_, Proxy.NO_PROXY);
    }
    
    public HttpPipelineConnection(final String p_i56_1_, final int p_i56_2_, final Proxy p_i56_3_) {
        this.host = null;
        this.port = 0;
