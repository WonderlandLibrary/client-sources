...
public class Input
{
    ...
    public void poll(final int width, final int height) {
        ...
        this.height = height;
        final Iterator allStarts = this.allListeners.iterator();
        while (allStarts.hasNext()) {
            final ControlledInputReciever listener = allStarts.next();
        ...
        final Iterator all = this.allListeners.iterator();
        while (all.hasNext()) {
            final ControlledInputReciever listener6 = all.next();
