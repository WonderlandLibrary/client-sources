...
public class HieroSettings
{
    ...
    public HieroSettings(final String hieroFileRef) throws SlickException {
        ...
        this.effects = new ArrayList();
        try {
            final BufferedReader reader = new BufferedReader(new InputStreamReader(ResourceLoader.getResourceAsStream(hieroFileRef)));
            while (true) {
                ...
                if (name.equals("font.size")) {
                    ...
                    while (iter.hasNext()) {
                        final ConfigurableEffect.Value effectValue = iter.next();
            ...
            throw new SlickException("Unable to load Hiero font file: " + hieroFileRef, ex2);
        }
    }
    ...
    public void save(final File file) throws IOException {
        ...
        out.println();
        final Iterator iter = this.effects.iterator();
        while (iter.hasNext()) {
            final ConfigurableEffect effect = iter.next();
            out.println("effect.class=" + effect.getClass().getName());
            final Iterator iter2 = effect.getValues().iterator();
            while (iter2.hasNext()) {
                final ConfigurableEffect.Value value = iter2.next();
