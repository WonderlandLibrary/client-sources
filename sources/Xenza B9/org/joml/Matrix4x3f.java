...
public class Matrix4x3f implements Externalizable, Matrix4x3fc
{
    ...
    public Planef frustumPlane(final int which, final Planef plane) {
        switch (which) {
            case 0: {
                plane.set(this.m00, this.m10, this.m20, 1.0f + this.m30).normalize(plane);
                break;
            }
            case 1: {
                plane.set(-this.m00, -this.m10, -this.m20, 1.0f - this.m30).normalize(plane);
            ...
            case 2: {
                plane.set(this.m01, this.m11, this.m21, 1.0f + this.m31).normalize(plane);
                break;
            }
            case 3: {
                plane.set(-this.m01, -this.m11, -this.m21, 1.0f - this.m31).normalize(plane);
            ...
            case 4: {
                plane.set(this.m02, this.m12, this.m22, 1.0f + this.m32).normalize(plane);
                break;
            }
            case 5: {
                plane.set(-this.m02, -this.m12, -this.m22, 1.0f - this.m32).normalize(plane);
