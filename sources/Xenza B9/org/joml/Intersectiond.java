...
public class Intersectiond
{
    ...
    public static boolean testPlaneSphere(final Planed plane, final Spheref sphere) {
    ...
    public static boolean testAabPlane(final AABBd aabb, final Planed plane) {
    ...
    public static boolean testAabAab(final AABBd aabb1, final AABBd aabb2) {
    ...
    public static boolean intersectSphereSphere(final Spheref sphereA, final Spheref sphereB, final Vector4d centerAndRadiusOfIntersectionCircle) {
    ...
    public static double intersectRayPlane(final Rayd ray, final Planed plane, final double epsilon) {
    ...
    public static boolean testAabSphere(final AABBd aabb, final Spheref sphere) {
    ...
    public static boolean intersectRaySphere(final Rayd ray, final Spheref sphere, final Vector2d result) {
    ...
    public static boolean testRaySphere(final Rayd ray, final Spheref sphere) {
    ...
    public static boolean intersectRayAab(final Rayd ray, final AABBd aabb, final Vector2d result) {
    ...
    public static int intersectLineSegmentAab(final LineSegmentf lineSegment, final AABBd aabb, final Vector2d result) {
    ...
    public static boolean testRayAab(final Rayd ray, final AABBd aabb) {
