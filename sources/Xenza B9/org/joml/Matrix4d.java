...
public class Matrix4d implements Externalizable, Matrix4dc
{
    ...
    private Matrix4d rotateTranslationInternal(final double ang, final double x, final double y, final double z, final Matrix4d dest) {
        ...
        dest._m20(rm7)._m21(rm8)._m22(rm9)._m00(nm00)._m01(nm2)._m02(nm3)._m03(0.0)._m10(nm4)._m11(nm5)._m12(nm6)._m13(0.0)._m30(this.m30)._m31(this.m31)._m32(this.m32)._m33(this.m33)._properties(this.properties & 0xFFFFFFF2);
        return dest;
    }
    ...
    public Vector4d project(final double x, final double y, final double z, final int[] viewport, final Vector4d dest) {
        final double invW = 1.0 / (this.m03 * x + this.m13 * y + this.m23 * z + this.m33);
    ...
    public Vector3d project(final double x, final double y, final double z, final int[] viewport, final Vector3d dest) {
        final double invW = 1.0 / (this.m03 * x + this.m13 * y + this.m23 * z + this.m33);
        final double nx = (this.m00 * x + this.m10 * y + this.m20 * z + this.m30) * invW;
        final double ny = (this.m01 * x + this.m11 * y + this.m21 * z + this.m31) * invW;
        final double nz = (this.m02 * x + this.m12 * y + this.m22 * z + this.m32) * invW;
    ...
    public Vector4d frustumPlane(final int plane, final Vector4d dest) {
        switch (plane) {
            case 0: {
                dest.set(this.m03 + this.m00, this.m13 + this.m10, this.m23 + this.m20, this.m33 + this.m30).normalize3(dest);
                break;
            }
            case 1: {
                dest.set(this.m03 - this.m00, this.m13 - this.m10, this.m23 - this.m20, this.m33 - this.m30).normalize3(dest);
            ...
            case 2: {
                dest.set(this.m03 + this.m01, this.m13 + this.m11, this.m23 + this.m21, this.m33 + this.m31).normalize3(dest);
                break;
            }
            case 3: {
                dest.set(this.m03 - this.m01, this.m13 - this.m11, this.m23 - this.m21, this.m33 - this.m31).normalize3(dest);
            ...
            case 4: {
                dest.set(this.m03 + this.m02, this.m13 + this.m12, this.m23 + this.m22, this.m33 + this.m32).normalize3(dest);
                break;
            }
            case 5: {
                dest.set(this.m03 - this.m02, this.m13 - this.m12, this.m23 - this.m22, this.m33 - this.m32).normalize3(dest);
    ...
    public Planed frustumPlane(final int which, final Planed plane) {
        switch (which) {
            case 0: {
