...
public interface Matrix4dc
{
    ...
    Matrix4d perspectiveRect(final double p0, final double p1, final double p2, final double p3, final boolean p4);
    
    Matrix4d perspectiveRect(final double p0, final double p1, final double p2, final double p3);
    ...
    Matrix4d perspectiveOffCenter(final double p0, final double p1, final double p2, final double p3, final double p4, final double p5, final boolean p6);
    
    Matrix4d perspectiveOffCenter(final double p0, final double p1, final double p2, final double p3, final double p4, final double p5);
    ...
    Planed frustumPlane(final int p0, final Planed p1);
