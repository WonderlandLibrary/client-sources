...
public interface Matrix4fc
{
    ...
    Matrix4f perspectiveRect(final float p0, final float p1, final float p2, final float p3, final boolean p4);
    
    Matrix4f perspectiveRect(final float p0, final float p1, final float p2, final float p3);
    ...
    Matrix4f perspectiveOffCenter(final float p0, final float p1, final float p2, final float p3, final float p4, final float p5, final boolean p6);
    
    Matrix4f perspectiveOffCenter(final float p0, final float p1, final float p2, final float p3, final float p4, final float p5);
    ...
    Planef frustumPlane(final int p0, final Planef p1);
