...
public class Matrix4f implements Externalizable, Matrix4fc
{
    ...
    private Matrix4f rotateXInternal(final float ang, final Matrix4f dest) {
        ...
        return dest._m20(lm10 * -sin + lm14 * cos)._m21(lm11 * -sin + lm15 * cos)._m22(lm12 * -sin + lm16 * cos)._m23(lm13 * -sin + lm17 * cos)._m10(lm10 * cos + lm14 * sin)._m11(lm11 * cos + lm15 * sin)._m12(lm12 * cos + lm16 * sin)._m13(lm13 * cos + lm17 * sin)._m00(this.m00)._m01(this.m01)._m02(this.m02)._m03(this.m03)._m30(this.m30)._m31(this.m31)._m32(this.m32)._m33(this.m33)._properties(this.properties & 0xFFFFFFF2);
    }
    ...
    private Matrix4f rotateYInternal(final float ang, final Matrix4f dest) {
        final float sin = Math.sin(ang);
        final float cos = Math.cosFromSin(sin, ang);
        final float nm00 = this.m00 * cos + this.m20 * -sin;
        final float nm2 = this.m01 * cos + this.m21 * -sin;
        final float nm3 = this.m02 * cos + this.m22 * -sin;
        final float nm4 = this.m03 * cos + this.m23 * -sin;
        return dest._m20(this.m00 * sin + this.m20 * cos)._m21(this.m01 * sin + this.m21 * cos)._m22(this.m02 * sin + this.m22 * cos)._m23(this.m03 * sin + this.m23 * cos)._m00(nm00)._m01(nm2)._m02(nm3)._m03(nm4)._m10(this.m10)._m11(this.m11)._m12(this.m12)._m13(this.m13)._m30(this.m30)._m31(this.m31)._m32(this.m32)._m33(this.m33)._properties(this.properties & 0xFFFFFFF2);
    }
    ...
    public Matrix4f rotateTowardsXY(final float dirX, final float dirY, final Matrix4f dest) {
        ...
        final float nm00 = this.m00 * dirY + this.m10 * dirX;
        final float nm2 = this.m01 * dirY + this.m11 * dirX;
        final float nm3 = this.m02 * dirY + this.m12 * dirX;
        final float nm4 = this.m03 * dirY + this.m13 * dirX;
        return dest._m10(this.m00 * -dirX + this.m10 * dirY)._m11(this.m01 * -dirX + this.m11 * dirY)._m12(this.m02 * -dirX + this.m12 * dirY)._m13(this.m03 * -dirX + this.m13 * dirY)._m00(nm00)._m01(nm2)._m02(nm3)._m03(nm4)._m20(this.m20)._m21(this.m21)._m22(this.m22)._m23(this.m23)._m30(this.m30)._m31(this.m31)._m32(this.m32)._m33(this.m33)._properties(this.properties & 0xFFFFFFF2);
    }
    ...
    private Matrix4f rotateXYZInternal(final float angleX, final float angleY, final float angleZ, final Matrix4f dest) {
        ...
        final float nm13 = this.m13 * cosX + this.m23 * sinX;
        final float nm14 = this.m10 * m_sinX + this.m20 * cosX;
        final float nm15 = this.m11 * m_sinX + this.m21 * cosX;
        final float nm16 = this.m12 * m_sinX + this.m22 * cosX;
        final float nm17 = this.m13 * m_sinX + this.m23 * cosX;
        final float nm18 = this.m00 * cosY + nm14 * m_sinY;
        final float nm19 = this.m01 * cosY + nm15 * m_sinY;
        final float nm20 = this.m02 * cosY + nm16 * m_sinY;
        final float nm21 = this.m03 * cosY + nm17 * m_sinY;
        return dest._m20(this.m00 * sinY + nm14 * cosY)._m21(this.m01 * sinY + nm15 * cosY)._m22(this.m02 * sinY + nm16 * cosY)._m23(this.m03 * sinY + nm17 * cosY)._m00(nm18 * cosZ + nm10 * sinZ)._m01(nm19 * cosZ + nm11 * sinZ)._m02(nm20 * cosZ + nm12 * sinZ)._m03(nm21 * cosZ + nm13 * sinZ)._m10(nm18 * m_sinZ + nm10 * cosZ)._m11(nm19 * m_sinZ + nm11 * cosZ)._m12(nm20 * m_sinZ + nm12 * cosZ)._m13(nm21 * m_sinZ + nm13 * cosZ)._m30(this.m30)._m31(this.m31)._m32(this.m32)._m33(this.m33)._properties(this.properties & 0xFFFFFFF2);
    }
    ...
    private Matrix4f rotateAffineXYZInternal(final float angleX, final float angleY, final float angleZ, final Matrix4f dest) {
        ...
        return dest._m20(this.m00 * sinY + nm13 * cosY)._m21(this.m01 * sinY + nm14 * cosY)._m22(this.m02 * sinY + nm15 * cosY)._m23(0.0f)._m00(nm16 * cosZ + nm10 * sinZ)._m01(nm17 * cosZ + nm11 * sinZ)._m02(nm18 * cosZ + nm12 * sinZ)._m03(0.0f)._m10(nm16 * m_sinZ + nm10 * cosZ)._m11(nm17 * m_sinZ + nm11 * cosZ)._m12(nm18 * m_sinZ + nm12 * cosZ)._m13(0.0f)._m30(this.m30)._m31(this.m31)._m32(this.m32)._m33(this.m33)._properties(this.properties & 0xFFFFFFF2);
    }
    ...
    private Matrix4f rotateTranslationInternal(final float ang, final float x, final float y, final float z, final Matrix4f dest) {
        ...
        final float rm8 = yz * C - x * s;
        final float rm9 = zz * C + c;
        return dest._m20(rm7)._m21(rm8)._m22(rm9)._m00(rm00)._m01(rm2)._m02(rm3)._m03(0.0f)._m10(rm4)._m11(rm5)._m12(rm6)._m13(0.0f)._m30(this.m30)._m31(this.m31)._m32(this.m32)._m33(1.0f)._properties(this.properties & 0xFFFFFFF2);
    }
    ...
    private Matrix4f frustumGeneric(final float left, final float right, final float bottom, final float top, final float zNear, final float zFar, final boolean zZeroToOne, final Matrix4f dest) {
        ...
        dest._m00(this.m00 * rm00)._m01(this.m01 * rm00)._m02(this.m02 * rm00)._m03(this.m03 * rm00)._m10(this.m10 * rm2)._m11(this.m11 * rm2)._m12(this.m12 * rm2)._m13(this.m13 * rm2)._m30(this.m20 * rm6)._m31(this.m21 * rm6)._m32(this.m22 * rm6)._m33(this.m23 * rm6)._m20(nm20)._m21(nm21)._m22(nm22)._m23(nm23)._m30(this.m30)._m31(this.m31)._m32(this.m32)._m33(this.m33)._properties(0);
        return dest;
    }
    ...
    public Vector4f project(final float x, final float y, final float z, final int[] viewport, final Vector4f winCoordsDest) {
        ...
        return winCoordsDest.set((nx * 0.5f + 0.5f) * viewport[2] + viewport[0], (ny * 0.5f + 0.5f) * viewport[3] + viewport[1], (1.0f + nz) * 0.5f, 1.0f);
    }
    ...
    public Vector4f frustumPlane(final int plane, final Vector4f planeEquation) {
        switch (plane) {
            case 0: {
                planeEquation.set(this.m03 + this.m00, this.m13 + this.m10, this.m23 + this.m20, this.m33 + this.m30).normalize3(planeEquation);
                break;
            }
            case 1: {
                planeEquation.set(this.m03 - this.m00, this.m13 - this.m10, this.m23 - this.m20, this.m33 - this.m30).normalize3(planeEquation);
            ...
            case 2: {
                planeEquation.set(this.m03 + this.m01, this.m13 + this.m11, this.m23 + this.m21, this.m33 + this.m31).normalize3(planeEquation);
                break;
            }
            case 3: {
                planeEquation.set(this.m03 - this.m01, this.m13 - this.m11, this.m23 - this.m21, this.m33 - this.m31).normalize3(planeEquation);
            ...
            case 4: {
                planeEquation.set(this.m03 + this.m02, this.m13 + this.m12, this.m23 + this.m22, this.m33 + this.m32).normalize3(planeEquation);
                break;
            }
            case 5: {
                planeEquation.set(this.m03 - this.m02, this.m13 - this.m12, this.m23 - this.m22, this.m33 - this.m32).normalize3(planeEquation);
    ...
    public Planef frustumPlane(final int which, final Planef plane) {
        switch (which) {
            case 0: {
                plane.set(this.m03 + this.m00, this.m13 + this.m10, this.m23 + this.m20, this.m33 + this.m30).normalize(plane);
                break;
            }
            case 1: {
                plane.set(this.m03 - this.m00, this.m13 - this.m10, this.m23 - this.m20, this.m33 - this.m30).normalize(plane);
            ...
            case 2: {
                plane.set(this.m03 + this.m01, this.m13 + this.m11, this.m23 + this.m21, this.m33 + this.m31).normalize(plane);
                break;
            }
            case 3: {
                plane.set(this.m03 - this.m01, this.m13 - this.m11, this.m23 - this.m21, this.m33 - this.m31).normalize(plane);
            ...
            case 4: {
                plane.set(this.m03 + this.m02, this.m13 + this.m12, this.m23 + this.m22, this.m33 + this.m32).normalize(plane);
                break;
            }
            case 5: {
                plane.set(this.m03 - this.m02, this.m13 - this.m12, this.m23 - this.m22, this.m33 - this.m32).normalize(plane);
    ...
    public Matrix4f obliqueZ(final float a, final float b) {
        ...
        this._properties(this.properties & 0x2);
        return this;
    }
