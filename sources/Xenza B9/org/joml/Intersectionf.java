...
public class Intersectionf
{
    ...
    public static boolean testPlaneSphere(final Planef plane, final Spheref sphere) {
    ...
    public static boolean testAabPlane(final AABBf aabb, final Planef plane) {
        return testAabPlane(aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ, plane.a, plane.b, plane.c, plane.d);
    }
    
    public static boolean testAabPlane(final AABBi aabb, final Planef plane) {
        return testAabPlane((float)aabb.minX, (float)aabb.minY, (float)aabb.minZ, (float)aabb.maxX, (float)aabb.maxY, (float)aabb.maxZ, plane.a, plane.b, plane.c, plane.d);
    }
    ...
    public static boolean testAabAab(final AABBf aabb1, final AABBf aabb2) {
    ...
    public static boolean intersectSphereSphere(final Spheref sphereA, final Spheref sphereB, final Vector4f centerAndRadiusOfIntersectionCircle) {
    ...
    public static float intersectRayPlane(final Rayf ray, final Planef plane, final float epsilon) {
    ...
    public static boolean testAabSphere(final AABBf aabb, final Spheref sphere) {
    ...
    public static boolean testAabSphere(final AABBi aabb, final Spheref sphere) {
        return testAabSphere((float)aabb.minX, (float)aabb.minY, (float)aabb.minZ, (float)aabb.maxX, (float)aabb.maxY, (float)aabb.maxZ, sphere.x, sphere.y, sphere.z, sphere.r * sphere.r);
    }
    ...
    public static boolean intersectRaySphere(final Rayf ray, final Spheref sphere, final Vector2f result) {
    ...
    public static boolean testRaySphere(final Rayf ray, final Spheref sphere) {
    ...
    public static boolean intersectRayAab(final Rayf ray, final AABBf aabb, final Vector2f result) {
    ...
    public static boolean intersectRayAab(final Rayf ray, final AABBi aabb, final Vector2f result) {
        return intersectRayAab(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, (float)aabb.minX, (float)aabb.minY, (float)aabb.minZ, (float)aabb.maxX, (float)aabb.maxY, (float)aabb.maxZ, result);
    }
    ...
    public static int intersectLineSegmentAab(final LineSegmentf lineSegment, final AABBf aabb, final Vector2f result) {
    ...
    public static int intersectLineSegmentAab(final LineSegmentf lineSegment, final AABBi aabb, final Vector2f result) {
        return intersectLineSegmentAab(lineSegment.aX, lineSegment.aY, lineSegment.aZ, lineSegment.bX, lineSegment.bY, lineSegment.bZ, (float)aabb.minX, (float)aabb.minY, (float)aabb.minZ, (float)aabb.maxX, (float)aabb.maxY, (float)aabb.maxZ, result);
    }
    ...
    public static boolean testRayAab(final Rayf ray, final AABBf aabb) {
        return testRayAab(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, aabb.minX, aabb.minY, aabb.minZ, aabb.maxX, aabb.maxY, aabb.maxZ);
    }
    
    public static boolean testRayAab(final Rayf ray, final AABBi aabb) {
        return testRayAab(ray.oX, ray.oY, ray.oZ, ray.dX, ray.dY, ray.dZ, (float)aabb.minX, (float)aabb.minY, (float)aabb.minZ, (float)aabb.maxX, (float)aabb.maxY, (float)aabb.maxZ);
    }
