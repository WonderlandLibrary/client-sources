    ...
    static {
        ...
        StatBase.timeStatType = new IStatType() {
            ...
            public String format(final int p_75843_1_) {
                ...
                return (d5 > 0.5) ? (StatBase.decimalFormat.format(d5) + " y") : ((d4 > 0.5) ? (StatBase.decimalFormat.format(d4) + " d") : ((d3 > 0.5) ? (StatBase.decimalFormat.format(d3) + " h") : ((d2 > 0.5) ? (StatBase.decimalFormat.format(d2) + " m") : (d0 + " s"))));
            }
        };
        StatBase.distanceStatType = new IStatType() {
            ...
            public String format(final int p_75843_1_) {
                ...
                return (d2 > 0.5) ? (StatBase.decimalFormat.format(d2) + " km") : ((d0 > 0.5) ? (StatBase.decimalFormat.format(d0) + " m") : (p_75843_1_ + " cm"));
            }
        };
