...
public class ShaderGroup
{
    ...
    public void parseGroup(final TextureManager p_152765_1_, final ResourceLocation p_152765_2_) throws JsonException, IOException, JsonSyntaxException {
        ...
        try {
            ...
            if (JsonUtils.isJsonArray(jsonobject, "targets")) {
                ...
                for (final JsonElement jsonelement : jsonarray) {
                    try {
                        ...
                        final JsonException jsonexception1 = JsonException.func_151379_a(var19);
            ...
            if (JsonUtils.isJsonArray(jsonobject, "passes")) {
                ...
                for (final JsonElement jsonelement2 : jsonarray2) {
                    try {
                        ...
                        final JsonException jsonexception2 = JsonException.func_151379_a(var20);
            ...
            final JsonException jsonexception3 = JsonException.func_151379_a(var21);
        ...
        if (jsonarray != null) {
            ...
            for (final JsonElement jsonelement : jsonarray) {
                try {
                    ...
                    final JsonException jsonexception = JsonException.func_151379_a(var25);
        ...
        if (jsonarray2 != null) {
            ...
            for (final JsonElement jsonelement2 : jsonarray2) {
                try {
                    ...
                    final JsonException jsonexception2 = JsonException.func_151379_a(var26);
    ...
    private void initUniform(final JsonElement p_148028_1_) throws JsonException {
        ...
        for (final JsonElement jsonelement : JsonUtils.getJsonArray(jsonobject, "values")) {
            try {
                ...
                final JsonException jsonexception = JsonException.func_151379_a(var11);
