...
public class ShaderManager
{
    ...
    public ShaderManager(final IResourceManager resourceManager, final String programName) throws JsonException, IOException {
        ...
        try {
            ...
            if (jsonarray != null) {
                ...
                for (final JsonElement jsonelement : jsonarray) {
                    try {
                        ...
                        final JsonException jsonexception1 = JsonException.func_151379_a(var25);
            ...
            if (jsonarray3 != null) {
                ...
                for (final JsonElement jsonelement3 : jsonarray3) {
                    try {
                        ...
                        final JsonException jsonexception3 = JsonException.func_151379_a(var27);
            ...
            final JsonException jsonexception4 = JsonException.func_151379_a(var28);
    ...
    private void parseUniform(final JsonElement p_147987_1_) throws JsonException {
        ...
        for (final JsonElement jsonelement : jsonarray) {
            try {
                ...
                final JsonException jsonexception = JsonException.func_151379_a(var13);
