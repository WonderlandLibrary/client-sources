...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void renderEffect(final IBakedModel model) {
        if ((!Config.isCustomItems() || CustomItems.isUseGlint()) && (!Config.isShaders() || !Shaders.isShadowPass)) {
            final EventItemGlint eventItemGlint = new EventItemGlint(-8372020, 1.0);
            ...
            final long customSystemTime = (long)(Sys.getTime() * 1000.0 * eventItemGlint.getSpeed() / Sys.getTimerResolution());
            final float f = customSystemTime % 3000L / 3000.0f / 8.0f;
            ...
            GlStateManager.pushMatrix();
            GlStateManager.scale(8.0f, 8.0f, 8.0f);
            final float f2 = customSystemTime % 4873L / 4873.0f / 8.0f;
    ...
    private void renderQuads(final WorldRenderer renderer, final List quads, final int color, final ItemStack stack) {
    ...
    public void renderItemModelForEntity(final ItemStack stack, final EntityLivingBase entityToRenderFor, final ItemCameraTransforms.TransformType cameraTransformType) {
        if (stack != null && entityToRenderFor != null) {
            ...
            if (entityToRenderFor instanceof EntityPlayer) {
                ...
                if ((this.modelLocation = modelresourcelocation) != null) {
    ...
    public void renderItemIntoGUI(final ItemStack stack, final int x, final int y, final int z) {
        this.renderItemGui = true;
        IBakedModel ibakedmodel = this.itemModelMesher.getItemModel(stack);
        GlStateManager.pushMatrix();
        this.textureManager.bindTexture(TextureMap.locationBlocksTexture);
    ...
    private void setupGuiTransform(final int xPosition, final int yPosition, final int zPosition, final boolean isGui3d) {
    ...
    public void renderItemAndEffectIntoGUI(final ItemStack stack, final int xPosition, final int yPosition) {
        if (stack != null && stack.getItem() != null) {
            ...
            try {
                ...
                final CrashReport crashreport = CrashReport.makeCrashReport(var7, "Rendering item");
    ...
    public void renderItemOverlayIntoGUI(final FontRenderer fr, final ItemStack stack, final int xPosition, final int yPosition, final String text) {
        if (stack != null) {
            ...
            if (flag) {
                int i = (int)Math.round(13.0 - stack.getItemDamage() * 13.0 / stack.getMaxDamage());
                int j = (int)Math.round(255.0 - stack.getItemDamage() * 255.0 / stack.getMaxDamage());
