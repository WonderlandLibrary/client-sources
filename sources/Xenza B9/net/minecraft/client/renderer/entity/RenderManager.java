        ...
        try {
            ...
            if (render != null && this.renderEngine != null) {
                ...
                try {
                    ...
                    throw new ReportedException(CrashReport.makeCrashReport(var19, "Post-rendering entity in world"));
                }
                ...
                try {
                    ...
                    throw new ReportedException(CrashReport.makeCrashReport(var20, "Rendering entity hitbox in world"));
                }
            }
            ...
            final CrashReport crashreport = CrashReport.makeCrashReport(var21, "Rendering entity in world");
