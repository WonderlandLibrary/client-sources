...
public class BlockModelRenderer
{
    ...
    public boolean renderModel(final IBlockAccess blockAccessIn, IBakedModel modelIn, final IBlockState blockStateIn, final BlockPos blockPosIn, final WorldRenderer worldRendererIn, final boolean checkSides) {
        ...
        try {
            ...
            final CrashReport crashreport = CrashReport.makeCrashReport(var11, "Tesselating block model");
    ...
    public enum EnumNeighborInfo
    {
        ...
        private EnumNeighborInfo(final String p_i6_3_, final int p_i6_4_, final EnumFacing[] p_i6_5_, final float p_i6_6_, final boolean p_i6_7_, final Orientation[] p_i6_8_, final Orientation[] p_i6_9_, final Orientation[] p_i6_10_, final Orientation[] p_i6_11_) {
    ...
    public enum Orientation
    {
        ...
        private Orientation(final String p_i8_3_, final int p_i8_4_, final EnumFacing p_i8_5_, final boolean p_i8_6_) {
    ...
    enum VertexTranslations
    {
        ...
        private VertexTranslations(final String p_i7_3_, final int p_i7_4_, final int p_i7_5_, final int p_i7_6_, final int p_i7_7_, final int p_i7_8_) {
