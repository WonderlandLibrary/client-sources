...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener, MM
{
    ...
    public void makeEntityOutlineShader() {
        if (OpenGlHelper.shadersSupported) {
            ...
            try {
                ...
                RenderGlobal.logger.warn("Failed to load shader: " + resourcelocation, var3);
                this.entityOutlineShader = null;
                this.entityOutlineFramebuffer = null;
            }
            catch (final JsonSyntaxException var4) {
                RenderGlobal.logger.warn("Failed to load shader: " + resourcelocation, (Throwable)var4);
                this.entityOutlineShader = null;
                this.entityOutlineFramebuffer = null;
            }
        }
    ...
    protected boolean isRenderEntityOutlines() {
        if ((!RenderGlobal.mm.esp.isToggled() || !RenderGlobal.mm.esp.mode.getSelected().equals("Vanilla")) && (!RenderGlobal.mm.itemEsp.isToggled() || !RenderGlobal.mm.itemEsp.mode.getSelected().equals("Vanilla"))) {
    ...
    public void loadRenderers() {
        if (this.theWorld != null) {
            ...
            final Set entity = this.field_181024_n;
            ...
            if (this.theWorld != null) {
                ...
                if (entity2 != null) {
                    this.viewFrustum.updateChunkPositions(entity2.posX, entity2.posZ);
                }
            }
            this.renderEntitiesStartupCounter = 2;
        }
    ...
    public void renderEntities(final Entity renderViewEntity, final ICamera camera, final float partialTicks) {
        ...
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            if (this.isRenderEntityOutlines()) {
                ...
                for (int k = 0; k < list.size(); ++k) {
                    ...
                    if (!flag || Reflector.callBoolean(entity3, Reflector.ForgeEntity_shouldRenderInPass, i)) {
                        ...
                        final boolean flag4 = entity3.isInRangeToRender3d(d0, d2, d3) && (entity3.ignoreFrustumCheck || camera.isBoundingBoxInFrustum(entity3.getEntityBoundingBox()) || entity3.riddenByEntity == this.mc.thePlayer) && ((RenderGlobal.mm.esp.isToggled() && RenderGlobal.mm.esp.mode.getSelected().equals("Vanilla") && entity3 instanceof EntityLivingBase && RenderGlobal.mm.esp.canRender((EntityLivingBase)entity3)) || (RenderGlobal.mm.itemEsp.isToggled() && RenderGlobal.mm.itemEsp.mode.getSelected().equals("Vanilla") && entity3 instanceof EntityItem));
            ...
            final EventRenderEntity eventRenderEntity = new EventRenderEntity();
                    ...
                    for (final Entity entity4 : classinheritancemultimap) {
                        if (!flag || Reflector.callBoolean(entity4, Reflector.ForgeEntity_shouldRenderInPass, i)) {
                            ...
                            if (flag7) {
                                ...
                                if (entity4 == this.mc.getRenderViewEntity() && this.mc.gameSettings.thirdPersonView == 0 && !flag8) {
                                    continue;
                                }
                                if (entity4.posY >= 0.0 && entity4.posY < 256.0 && !this.theWorld.isBlockLoaded(new BlockPos(entity4))) {
                                    continue;
                                }
                                ++this.countEntitiesRendered;
            ...
            for (final Object renderglobal$containerlocalrenderinformation2 : this.renderInfosTileEntities) {
                ...
                final List<TileEntity> list2 = renderglobal$containerlocalrenderinformation3.renderChunk.getCompiledChunk().getTileEntities();
                if (!list2.isEmpty()) {
            ...
            final Set var48 = this.field_181024_n;
            synchronized (this.field_181024_n) {
                for (final Object tileentity2 : this.field_181024_n) {
                    ...
                    if (oclass2 == TileEntitySign.class && !Config.zoomMode) {
                        final EntityPlayer entityplayer2 = this.mc.thePlayer;
    ...
    public void spawnParticle(final int particleID, final boolean ignoreRange, final double xCoord, final double yCoord, final double zCoord, final double xOffset, final double yOffset, final double zOffset, final int... p_180442_15_) {
        try {
            ...
            final CrashReport crashreport = CrashReport.makeCrashReport(var19, "Exception while adding particle");
    ...
    public void func_181023_a(final Collection p_181023_1_, final Collection p_181023_2_) {
        final Set var4 = this.field_181024_n;
        synchronized (this.field_181024_n) {
