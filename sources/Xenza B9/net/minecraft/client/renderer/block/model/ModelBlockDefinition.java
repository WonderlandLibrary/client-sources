...
public class ModelBlockDefinition
{
        ...
        protected Variants parseVariants(final JsonDeserializationContext p_178335_1_, final Map.Entry<String, JsonElement> p_178335_2_) {
            ...
            if (jsonelement.isJsonArray()) {
                for (final JsonElement jsonelement2 : jsonelement.getAsJsonArray()) {
                    list.add((Variant)p_178335_1_.deserialize(jsonelement2, (Type)Variant.class));
                }
            }
            else {
                list.add((Variant)p_178335_1_.deserialize(jsonelement, (Type)Variant.class));
            }
    ...
    public static class Variant
    {
        ...
        public static class Deserializer implements JsonDeserializer<Variant>
        {
            ...
            private ResourceLocation makeModelLocation(final String p_178426_1_) {
                final ResourceLocation resourcelocation = new ResourceLocation(p_178426_1_);
    ...
    public static class Variants
    {
        ...
        @Override
        public int hashCode() {
            final int i = this.name.hashCode();
