        ...
        if (button.enabled) {
            if (button.id == 2) {
                ...
                Label_0135: {
                    if (Util.getOSType() == Util.EnumOS.OSX) {
                        try {
                            ...
                            GuiScreenResourcePacks.logger.error("Couldn't open file", var9);
                            break Label_0135;
                        }
                    }
                    if (Util.getOSType() == Util.EnumOS.WINDOWS) {
                        ...
                        try {
                            ...
                            GuiScreenResourcePacks.logger.error("Couldn't open file", var10);
                        }
                    }
                }
                boolean flag = false;
                try {
                    ...
                    GuiScreenResourcePacks.logger.error("Couldn't open link", var11);
                    flag = true;
                }
                if (flag) {
