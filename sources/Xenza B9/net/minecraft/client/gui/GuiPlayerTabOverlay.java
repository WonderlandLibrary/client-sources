...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public static String getPlayerName(final NetworkPlayerInfo networkPlayerInfoIn) {
        final String string = MidClick.friends.contains(networkPlayerInfoIn.getGameProfile().getName()) ? "§7[§2Friend§7]§9 " : "";
        if (Augustus.getInstance().getModuleManager().protector.isToggled()) {
            return (networkPlayerInfoIn.getDisplayName() != null) ? (string + networkPlayerInfoIn.getProtectedName()) : ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(), string + networkPlayerInfoIn.getProtectedName());
        }
        return (networkPlayerInfoIn.getDisplayName() != null) ? (string + networkPlayerInfoIn.getDisplayName().getFormattedText()) : ScorePlayerTeam.formatPlayerName(networkPlayerInfoIn.getPlayerTeam(), string + networkPlayerInfoIn.getGameProfile().getName());
    }
    ...
    public void renderPlayerlist(final int width, final Scoreboard scoreboardIn, final ScoreObjective scoreObjectiveIn) {
        ...
        for (int k3 = 0; k3 < l3; ++k3) {
            ...
            if (k3 < list.size()) {
                ...
                String s4 = getPlayerName(networkplayerinfo2);
