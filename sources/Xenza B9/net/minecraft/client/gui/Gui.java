...
public class Gui
{
    ...
    protected static void drawFloatRect(final float v, final float i, final float v1, final float i1, final float i2) {
        drawRect((int)v, (int)i, (int)v1, (int)i1, (int)i2);
    }
    
    public static void drawRect(final double posX, final double v, final double v1, final double v2, final int color) {
