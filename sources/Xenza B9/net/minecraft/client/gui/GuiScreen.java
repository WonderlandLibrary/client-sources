...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
        ...
        if (isShiftKeyDown()) {
            ...
            if (clickevent.getAction() == ClickEvent.Action.OPEN_URL) {
                ...
                try {
                    ...
                    GuiScreen.LOGGER.error("Can't open url for " + clickevent, var5);
                }
            }
    ...
    private void openWebLink(final URI p_175282_1_) {
        try {
            ...
            GuiScreen.LOGGER.error("Couldn't open link", var4);
        }
    }
    ...
    public void setEventButton(final int eventButton) {
