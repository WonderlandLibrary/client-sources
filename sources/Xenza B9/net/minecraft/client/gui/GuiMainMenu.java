...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback, MM
{
    ...
    private void addSingleplayerMultiplayerButtons(final int p_73969_1_, final int p_73969_2_) {
        ...
        this.buttonList.add(new CustomButton(1337, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, 200, 20, "Client Manager", Augustus.getInstance().getClientColor()));
        ...
        if (result && id == 12) {
            ...
            if (result) {
                try {
                    ...
                    GuiMainMenu.logger.error("Couldn't open link", var5);
                }
            }
            this.mc.displayGuiScreen(this);
        }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.fontRendererObj.drawString("xenza", sr.getScaledWidth() / 4.0f / 2.0f - this.fontRendererObj.getStringWidth("xenza") / 2.0f, sr.getScaledHeight() / 11 / 4.0f, Color.lightGray.getRGB());
        GlStateManager.scale(1.0f, 1.0f, 1.0f);
        GL11.glPopMatrix();
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
        final String s = "Waltuh white productions";
        this.drawString(this.fontRendererObj, s, 2, this.height - 10, -1);
        final String s2 = "Made by " + Augustus.getInstance().getDev() + "!";
