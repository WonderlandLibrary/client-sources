...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui() {
        ...
        try {
            ...
            GuiSelectWorld.logger.error("Couldn't load level list", var2);
        ...
        if (this.field_146643_x) {
            ...
            if (result) {
                ...
                try {
                    ...
                    GuiSelectWorld.logger.error("Couldn't load level list", var5);
                }
            }
    ...
    public static GuiYesNo func_152129_a(final GuiYesNoCallback p_152129_0_, final String p_152129_1_, final int p_152129_2_) {
        ...
        return new GuiYesNo(p_152129_0_, s, s2, s3, s4, p_152129_2_);
    }
