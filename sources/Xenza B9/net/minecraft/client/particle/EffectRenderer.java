...
public class EffectRenderer
{
    ...
    private void tickParticle(final EntityFX p_178923_1_) {
        try {
            ...
            final CrashReport crashreport = CrashReport.makeCrashReport(var6, "Ticking Particle");
                ...
                if (!this.fxLayers[j][k].isEmpty()) {
                    ...
                    for (int l = 0; l < this.fxLayers[j][k].size(); ++l) {
                        ...
                        try {
                            ...
                            final CrashReport crashreport = CrashReport.makeCrashReport(var18, "Rendering Particle");
