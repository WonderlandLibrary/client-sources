...
public class ModelBakery
{
    ...
    private void loadVariants(final Collection<ModelResourceLocation> p_177591_1_) {
        for (final ModelResourceLocation modelresourcelocation : p_177591_1_) {
            try {
                ...
                ModelBakery.LOGGER.warn("Unable to load definition " + modelresourcelocation, var7);
            }
        }
    }
    ...
    private ModelBlockDefinition getModelBlockDefinition(final ResourceLocation p_177586_1_) {
        ...
        if (modelblockdefinition == null) {
            ...
            try {
                ...
                throw new RuntimeException("Encountered an exception when loading model definition of model " + resourcelocation.toString(), var14);
            }
            ...
            for (final ModelBlockDefinition.Variant modelblockdefinition$variant : this.variants.get(modelresourcelocation).getVariants()) {
                ...
                if (this.models.get(resourcelocation) == null) {
                    try {
                        ...
                        ModelBakery.LOGGER.warn("Unable to load block model: '" + resourcelocation + "' for variant: '" + modelresourcelocation + "'", var7);
                    }
                }
            }
        }
            ...
            for (final String s : this.getVariantNames(item)) {
                ...
                if (this.models.get(resourcelocation) == null) {
                    try {
                        ...
                        ModelBakery.LOGGER.warn("Unable to load item model: '" + resourcelocation + "' for item: '" + Item.itemRegistry.getNameForObject(item) + "'", var7);
                    }
                }
            }
        }
    ...
    private void bakeBlockModels() {
        ...
        for (final Map.Entry<String, ResourceLocation> entry : this.itemLocations.entrySet()) {
            ...
            else if (this.isCustomRenderer(modelblock2)) {
    ...
    private void loadModels() {
        ...
        while (!deque.isEmpty()) {
            ...
            try {
                ...
                ModelBakery.LOGGER.warn("In parent chain: " + ModelBakery.JOINER.join(this.getParentPath(resourcelocation3)) + "; unable to load model: '" + resourcelocation3 + "'", var6);
            }
