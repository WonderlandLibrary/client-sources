    ...
    public TextureMetadataSection deserialize(final JsonElement p_deserialize_1_, final Type p_deserialize_2_, final JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
        ...
        if (jsonobject.has("mipmaps")) {
            try {
                ...
                for (int i = 0; i < jsonarray.size(); ++i) {
                    ...
                    if (jsonelement.isJsonPrimitive()) {
                        try {
                            ...
                            throw new JsonParseException("Invalid texture->mipmap->" + i + ": expected number, was " + jsonelement, (Throwable)var12);
                        }
                    }
                ...
                throw new JsonParseException("Invalid texture->mipmaps: expected array, was " + jsonobject.get("mipmaps"), (Throwable)var13);
            }
        }
