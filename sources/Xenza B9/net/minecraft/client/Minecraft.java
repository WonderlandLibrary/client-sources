...
import net.augustus.events.EventLateTick;
...
import net.augustus.events.EventKeyboard;
...
import net.augustus.auth.GuiAuth;
...
{
    public final NameProtectList nameProtectList;
    ...
    public Minecraft(final GameConfiguration gameConfig) {
        this.nameProtectList = new NameProtectList();
    ...
    public void run() {
        ...
        try {
            ...
            final CrashReport crashreport = CrashReport.makeCrashReport(var11, "Initializing game");
        ...
        try {
            while (this.running) {
                if (this.hasCrashed && this.crashReporter != null) {
                    ...
                    catch (final OutOfMemoryError var12) {
                        this.freeMemory();
            ...
            final CrashReport crashreport2 = this.addGraphicsAndWorldToCrashReport(new CrashReport("Unexpected error", var14));
            this.freeMemory();
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(new GuiAuth(), this, this.serverName, this.serverPort));
        }
        else {
            this.displayGuiScreen(new GuiAuth());
        }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Augustus.getInstance().getName() + " " + Augustus.getInstance().getVersion());
        try {
    ...
    public void sendClickBlockToControllerCustom(final boolean leftClick, final MovingObjectPosition movingObjectPosition, final BlockPos blockpos, final int id) {
        this.b = false;
        final int i = this.thePlayer.inventory.currentItem;
        ...
        if (this.leftClickCounter <= 0 && !this.thePlayer.isUsingItem()) {
            if (leftClick && movingObjectPosition != null && movingObjectPosition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                if (this.theWorld.getBlockState(blockpos).getBlock().getMaterial() != Material.air && this.playerController.onPlayerDamageBlockCustom(blockpos, movingObjectPosition.sideHit, id)) {
    ...
    public void runTick() throws IOException {
        ...
        if (this.theWorld != null && this.thePlayer != null) {
            final EventEarlyTick eventEarlyTick = new EventEarlyTick();
            EventHandler.call(eventEarlyTick);
        }
        this.entityRenderer.getMouseOver(1.0f);
        if (this.theWorld != null && this.thePlayer != null) {
            final EventPostMouseOver eventPostMouseOver = new EventPostMouseOver();
        ...
        if (this.currentScreen != null) {
            try {
                ...
                final CrashReport crashreport = CrashReport.makeCrashReport(var7, "Updating screen events");
            ...
            if (this.currentScreen != null) {
                try {
                    ...
                    final CrashReport crashreport2 = CrashReport.makeCrashReport(var8, "Ticking screen");
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        final EventKeyboard eventKeyboard = new EventKeyboard(k);
            ...
            final EventClick eventClick = new EventClick(this.thePlayer.inventory.currentItem);
        ...
        if (this.theWorld != null) {
            if (!this.isGamePaused) {
                ...
                try {
                    ...
                    final CrashReport crashreport3 = CrashReport.makeCrashReport(var9, "Exception in world tick");
                    if (this.theWorld == null) {
        ...
        if (this.theWorld != null && this.thePlayer != null) {
            final EventLateTick eventLateTick = new EventLateTick();
    ...
    public void launchIntegratedServer(final String folderName, final String worldName, WorldSettings worldSettingsIn) {
        ...
        try {
            ...
            final CrashReport crashreport = CrashReport.makeCrashReport(var10, "Starting integrated server");
    ...
    public void loadWorld(final WorldClient worldClientIn, final String loadingMessage) {
        final EventWorld eventWorld = new EventWorld(worldClientIn);
    ...
    public void middleClickMouse() {
        if (this.objectMouseOver != null) {
            final EventMidClick eventMidClick = new EventMidClick();
