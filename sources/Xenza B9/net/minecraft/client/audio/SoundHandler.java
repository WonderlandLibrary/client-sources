            ...
            try {
                for (final IResource iresource : resourceManager.getAllResources(new ResourceLocation(s, "sounds.json"))) {
                    try {
                        ...
                        SoundHandler.logger.warn("Invalid sounds.json", var9);
                    }
                }
            }
            ...
            switch (soundlist$soundentry.getSoundEntryType()) {
                case FILE: {
                    ...
                    try {
                        ...
                        SoundHandler.logger.warn("Could not load sound file " + resourcelocation2 + ", cannot add it to event " + location, var19);
                    }
                    finally {
