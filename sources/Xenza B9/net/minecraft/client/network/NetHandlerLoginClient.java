...
public class NetHandlerLoginClient implements INetHandlerLoginClient
{
    ...
    public void handleEncryptionRequest(final S01PacketEncryptionRequest packetIn) {
        ...
        if (this.mc.getCurrentServerData() != null && this.mc.getCurrentServerData().func_181041_d()) {
            ...
            catch (final AuthenticationException var19) {
            ...
            catch (final AuthenticationUnavailableException var20) {
            ...
            catch (final InvalidCredentialsException var21) {
            ...
            catch (final AuthenticationException var22) {
                this.networkManager.closeChannel(new ChatComponentTranslation("disconnect.loginFailedInfo", new Object[] { var22.getMessage() }));
                return;
            }
        }
