...
public class GameSettings
{
    ...
    public String getKeyBinding(final Options p_74297_1_) {
        ...
        if (p_74297_1_.getEnumFloat()) {
            ...
            return (p_74297_1_ == Options.SENSITIVITY) ? ((f2 == 0.0f) ? (s2 + I18n.format("options.sensitivity.min", new Object[0])) : ((f2 == 1.0f) ? (s2 + I18n.format("options.sensitivity.max", new Object[0])) : (s2 + (int)(f2 * 200.0f) + "%"))) : ((p_74297_1_ == Options.FOV) ? ((f1 == 70.0f) ? (s2 + I18n.format("options.fov.min", new Object[0])) : ((f1 == 110.0f) ? (s2 + I18n.format("options.fov.max", new Object[0])) : (s2 + (int)f1))) : ((p_74297_1_ == Options.FRAMERATE_LIMIT) ? ((f1 == p_74297_1_.valueMax) ? (s2 + I18n.format("options.framerateLimit.max", new Object[0])) : (s2 + (int)f1 + " fps")) : ((p_74297_1_ == Options.RENDER_CLOUDS) ? ((f1 == p_74297_1_.valueMin) ? (s2 + I18n.format("options.cloudHeight.min", new Object[0])) : (s2 + ((int)f1 + 128))) : ((p_74297_1_ == Options.GAMMA) ? ((f2 == 0.0f) ? (s2 + I18n.format("options.gamma.min", new Object[0])) : ((f2 == 1.0f) ? (s2 + I18n.format("options.gamma.max", new Object[0])) : (s2 + "+" + (int)(f2 * 100.0f) + "%"))) : ((p_74297_1_ == Options.SATURATION) ? (s2 + (int)(f2 * 400.0f) + "%") : ((p_74297_1_ == Options.CHAT_OPACITY) ? (s2 + (int)(f2 * 90.0f + 10.0f) + "%") : ((p_74297_1_ == Options.CHAT_HEIGHT_UNFOCUSED) ? (s2 + GuiNewChat.calculateChatboxHeight(f2) + "px") : ((p_74297_1_ == Options.CHAT_HEIGHT_FOCUSED) ? (s2 + GuiNewChat.calculateChatboxHeight(f2) + "px") : ((p_74297_1_ == Options.CHAT_WIDTH) ? (s2 + GuiNewChat.calculateChatboxWidth(f2) + "px") : ((p_74297_1_ == Options.RENDER_DISTANCE) ? (s2 + (int)f1 + " chunks") : ((p_74297_1_ == Options.MIPMAP_LEVELS) ? ((f1 == 0.0f) ? (s2 + I18n.format("options.off", new Object[0])) : (s2 + (int)f1)) : ((f2 == 0.0f) ? (s2 + I18n.format("options.off", new Object[0])) : (s2 + (int)(f2 * 100.0f) + "%")))))))))))));
        }
    ...
    public void loadOptions() {
        try {
            ...
            GameSettings.logger.error("Failed to load options", var9);
        }
        this.loadOfOptions();
    }
    ...
    public void saveOptions() {
        ...
        try {
            ...
            GameSettings.logger.error("Failed to save options", var6);
        }
        this.saveOfOptions();
