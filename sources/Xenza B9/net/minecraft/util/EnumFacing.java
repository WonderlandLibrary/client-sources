...
public enum EnumFacing implements IStringSerializable
{
    ...
    private EnumFacing(final String p_i17_3_, final int p_i17_4_, final int p_i17_5_, final int p_i17_6_, final int p_i17_7_, final String p_i17_8_, final AxisDirection p_i17_9_, final Axis p_i17_10_, final Vec3i p_i17_11_) {
        this.index = p_i17_5_;
    ...
    public enum Axis implements Predicate, IStringSerializable
    {
        ...
        private Axis(final String p_i14_3_, final int p_i14_4_, final String p_i14_5_, final Plane p_i14_6_) {
            this.name = p_i14_5_;
            this.plane = p_i14_6_;
        }
    ...
    public enum AxisDirection
    {
        ...
        private AxisDirection(final String p_i15_3_, final int p_i15_4_, final int p_i15_5_, final String p_i15_6_) {
    ...
    public enum Plane implements Predicate, Iterable
    {
        ...
        private Plane(final String p_i16_3_, final int p_i16_4_) {
        }
