...
public class EntityAIEatGrass extends EntityAIBase
{
    ...
    static {
        field_179505_b = BlockStateHelper.forBlock(Blocks.tallgrass).where(BlockTallGrass.TYPE, (Predicate<? extends BlockTallGrass.EnumType>)Predicates.equalTo(BlockTallGrass.EnumType.GRASS));
    }
}
