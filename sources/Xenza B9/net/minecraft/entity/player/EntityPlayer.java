...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void setProtectedName(final String protectedName) {
        this.protectedName = protectedName;
    }
    
    public EntityPlayer(final World worldIn, final GameProfile gameProfileIn) {
        super(worldIn);
        this.protectedName = Minecraft.getMinecraft().nameProtectList.getRandomName();
    ...
    public void onUpdate() {
        this.noClip = (EntityPlayer.mm.phase.isToggled() || this.isSpectator());
        if (this.isSpectator()) {
            this.onGround = false;
        }
        if (this.itemInUse != null) {
    ...
    public void onLivingUpdate() {
        ...
        if (this.isSprinting() || (EntityPlayer.mm.sprint.isToggled() && EntityPlayer.mm.sprint.allSprint)) {
    ...
    public void jump() {
        if (!EntityPlayer.mm.blockFly.isTower2() || EntityPlayer.mm.blockFly.towerMode.getSelected().equals("None") || !EntityPlayer.mm.blockFly.isToggled()) {
            super.jump();
    ...
    public IChatComponent getDisplayName() {
        if (Augustus.getInstance().getModuleManager().protector.isToggled()) {
            final IChatComponent ichatcomponent = new ChatComponentText(ScorePlayerTeam.formatPlayerName(this.getTeam(), this.getProtectedName()));
    ...
    public void setSpeedInAir(final float speedInAir) {
    ...
    public void setSpeedOnGround(final float speedOnGround) {
