...
public class EntityTracker
{
    ...
    public void addEntityToTracker(final Entity entityIn, int trackingRange, final int updateFrequency, final boolean sendVelocityUpdates) {
        ...
        try {
            ...
            final CrashReport crashreport = CrashReport.makeCrashReport(var11, "Adding entity to track");
            ...
            catch (final ReportedException var12) {
                EntityTracker.logger.error("\"Silently\" catching entity tracking error.", var12);
            }
        }
    }
