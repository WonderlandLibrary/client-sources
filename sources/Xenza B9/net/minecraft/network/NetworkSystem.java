                    ...
                    if (!networkmanager.isChannelOpen()) {
                        ...
                        try {
                            ...
                            if (networkmanager.isLocalChannel()) {
                                final CrashReport crashreport = CrashReport.makeCrashReport(var8, "Ticking memory connection");
                            ...
                            NetworkSystem.logger.warn("Failed to handle packet for " + networkmanager.getRemoteAddress(), var8);
