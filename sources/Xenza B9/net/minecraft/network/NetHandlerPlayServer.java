...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable
{
    ...
    public void sendPacket(final Packet packetIn) {
        ...
        try {
            ...
            final CrashReport crashreport = CrashReport.makeCrashReport(var5, "Sending packet");
    ...
    @Override
    public void handleHandAnimation(final CAnimateHandPacket packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue((Packet<NetHandlerPlayServer>)packetIn, this, this.playerEntity.getServerForPlayer());
        this.playerEntity.markPlayerActive();
        this.playerEntity.swingItem();
    }
    ...
    public void processVanilla250Packet(final C17PacketCustomPayload packetIn) {
        ...
        if ("MC|BEdit".equals(packetIn.getChannelName())) {
            ...
            try {
                ...
                NetHandlerPlayServer.logger.error("Couldn't handle book info", var36);
            }
            finally {
            ...
            try {
                ...
                NetHandlerPlayServer.logger.error("Couldn't sign book", var37);
            }
            finally {
            ...
            try {
                ...
                NetHandlerPlayServer.logger.error("Couldn't select trade", var38);
            }
        }
            ...
            if (!this.serverController.isCommandBlockEnabled()) {
                ...
                try {
                    ...
                    NetHandlerPlayServer.logger.error("Couldn't set command block", var39);
                }
                finally {
            ...
            if (this.playerEntity.openContainer instanceof ContainerBeacon) {
                try {
                    ...
                    NetHandlerPlayServer.logger.error("Couldn't set beacon", var40);
                }
            }
        }
