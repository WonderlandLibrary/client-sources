...
public class WorldGenDesertWells extends WorldGenerator
{
    ...
    static {
        field_175913_a = BlockStateHelper.forBlock(Blocks.sand).where(BlockSand.VARIANT, (Predicate<? extends BlockSand.EnumType>)Predicates.equalTo(BlockSand.EnumType.SAND));
    }
}
