...
public class AttackEffects extends Module
{
    ...
    private void renderEffects() {
        ...
        if (AttackEffects.mm.killAura.isToggled() && AttackEffects.mm.killAura.mode.getSelected().equals("Basic")) {
            final KillAura killAura = AttackEffects.mm.killAura;
            if (KillAura.target != null) {
                final KillAura killAura2 = AttackEffects.mm.killAura;
