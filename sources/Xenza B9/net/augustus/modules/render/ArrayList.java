...
public class ArrayList extends Module
{
    ...
    public ArrayList() {
        ...
        this.mode = new StringValue(23638, "Mode", this, "Default", new String[] { "Default", "Vega" });
    ...
    public void renderArrayList() {
        ...
        if (this.sideOption.getSelected().equalsIgnoreCase(ArrayList.mm.hud.side.getSelected())) {
            final String selected = ArrayList.mm.hud.mode.getSelected();
            switch (selected) {
                case "Ryu": {
                    y = ArrayList.mc.fontRendererObj.FONT_HEIGHT + 5.0f;
                    break;
                }
                case "Old": {
                    y = 48.0f;
                ...
                case "Other": {
                    y = (float)(int)((ArrayList.mc.fontRendererObj.FONT_HEIGHT * 1.75f + 4.0f + 1.0f) * 1.5);
                    break;
                }
                case "Basic": {
                    y = (float)(ArrayList.mc.fontRendererObj.FONT_HEIGHT + 1);
                    break;
                }
            }
        }
    ...
    public void onEventClickSetting(final EventClickSetting eventClickSetting) {
        if (!ArrayList.mm.arrayList.font.getSelected().equals("Minecraft") && !this.customFont.getFontName().equalsIgnoreCase(ArrayList.mm.arrayList.font.getSelected())) {
            ...
            final String var2 = selected = ArrayList.mm.arrayList.font.getSelected();
            switch (selected) {
                case "Verdana": {
