...
public class Module implements MC, MM, SM, Comparable<Module>
{
    ...
    public final void toggle() {
        if (this.toggled) {
            ...
            GeneralNotifyManager.addNotification("Toggled " + this.name + " off", NotificationType.ToggleOff);
            this.toggled = false;
            ...
            GeneralNotifyManager.addNotification("Toggled " + this.name + " on", NotificationType.ToggleOn);
            this.toggled = true;
