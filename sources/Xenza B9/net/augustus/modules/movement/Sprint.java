...
public class Sprint extends Module
{
    ...
    public void onEventTick(final EventTick eventTick) {
        KeyBinding.setKeyBindState(Sprint.mc.gameSettings.keyBindSprint.getKeyCode(), !Sprint.mm.blockFly.isToggled() || Sprint.mm.blockFly.sprint.getBoolean());
        ...
        else if (!Sprint.mm.blockFly.isToggled() || Sprint.mm.blockFly.sprint.getBoolean()) {
            this.allSprint = true;
        }
    }
