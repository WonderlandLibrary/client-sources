...
public class Step extends Module
{
    ...
    public Step() {
        ...
        this.mode = new StringValue(1, "Modes", this, "Vanilla", new String[] { "Vanilla", "NCPPacket", "NCPMotion", "Lowhop" });
    }
        ...
        switch (selected) {
            case "NCPMotion": {
                if (Step.mc.thePlayer.isCollidedHorizontally) {
                    if (Step.mc.thePlayer.isCollidedVertically) {
                        Step.mc.thePlayer.motionY = 0.37;
                    }
            ...
            case "Lowhop": {
                if (Step.mc.thePlayer.isCollidedHorizontally && Step.mc.thePlayer.isCollidedVertically) {
                    Step.mc.thePlayer.motionY = 0.37;
                    break;
                }
                break;
