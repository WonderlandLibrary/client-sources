...
public class FakeLag extends Module
{
    ...
    public void onEventSendPacket(final EventSendPacket eventSendPacket) {
        ...
        if (this.combat.getBoolean()) {
            ...
            else if (packet instanceof C03PacketPlayer && FakeLag.mm.killAura.isToggled()) {
                final KillAura killAura = FakeLag.mm.killAura;
                if (KillAura.target != null) {
                    final KillAura killAura2 = FakeLag.mm.killAura;
                    final EntityLivingBase entityLivingBase = KillAura.target;
