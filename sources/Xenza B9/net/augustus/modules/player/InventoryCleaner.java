...
public class InventoryCleaner extends Module
{
    ...
    public InventoryCleaner() {
        ...
        this.delay = new DoubleValue(2, "Delay", this, 100.0, 0.0, 1000.0, 0);
    ...
    public void onEventClick(final EventClick eventClick) {
        this.blockInv = false;
        if (this.mode.getSelected().equals("SpoofInv") && this.interactionCheck.getBoolean()) {
            Label_0075: {
                if (!Mouse.isButtonDown(1) && !Mouse.isButtonDown(0)) {
                    if (InventoryCleaner.mm.killAura.isToggled()) {
                        final KillAura killAura = InventoryCleaner.mm.killAura;
    ...
    public void onEventTick(final EventEarlyTick eventEarlyTick) {
        ...
        if (invCleaner && !this.blockInv) {
            ...
            final Iterator<ItemStack> iterator = blocks.iterator();
                ...
                if (itemStack.getSlotID() != blockID + 36) {
                    if (block == null) {
                        ...
                        if (newBlock != null) {
                            ...
                            if (itemStack.stackSize <= block.stackSize) {
                                continue;
                            }
                            newBlock = itemStack;
                        }
            ...
            final Iterator<ItemStack> iterator2 = swords.iterator();
            ...
            final Iterator<ItemStack> iterator3 = axes.iterator();
            ...
            final Iterator<ItemStack> iterator4 = pickAxes.iterator();
            ...
            final Iterator<ItemStack> iterator5 = shovels.iterator();
            ...
            final Iterator<ItemStack> iterator6 = bows.iterator();
            ...
            final Iterator<ItemStack> iterator7 = rods.iterator();
            ...
            final Iterator<ItemStack> iterator8 = foods.iterator();
            ...
            final Iterator<ItemStack> iterator9 = gapples.iterator();
            while (iterator9.hasNext()) {
                final ItemStack itemStack = iterator9.next();
    ...
    private double getToolDamage(final ItemStack itemStack) {
        ...
        damage += EnchantmentHelper.getEnchantmentLevel(Enchantment.fireAspect.effectId, itemStack) / 11.0;
        damage += EnchantmentHelper.getEnchantmentLevel(Enchantment.knockback.effectId, itemStack) / 11.0;
        return damage + EnchantmentHelper.getEnchantmentLevel(Enchantment.unbreaking.effectId, itemStack) / 11.0;
    }
