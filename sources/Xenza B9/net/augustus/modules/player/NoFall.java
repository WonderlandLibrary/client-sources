...
public class NoFall extends Module
{
    ...
    public void onEventSendPacket(final EventSendPacket eventSendPacket) {
        ...
        byte var4 = -1;
        if (var3.hashCode() == 370287304 && var3.equals("NoGround")) {
            var4 = 0;
        }
        if (var4 == 0 && packet instanceof C03PacketPlayer) {
    ...
    public void onEventEarlyTick(final EventEarlyTick eventEarlyTick) {
        this.setDisplayName(super.getName() + " §8" + this.mode.getSelected());
        if (this.mode.getSelected().equals("Legit") && NoFall.mc.thePlayer != null) {
    ...
    private void setRotation() {
        if (NoFall.mc.currentScreen == null && (!NoFall.mm.killAura.isToggled() || KillAura.target == null)) {
