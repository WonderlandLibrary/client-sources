...
public class ClickGui extends GuiScreen implements MM, SM
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.currentSorting == null) {
            ...
            final String height = selected = ClickGui.mm.clickGUI.sorting.getSelected();
            switch (selected) {
                case "Random": {
                ...
                case "Alphabet": {
                    final CategoryButton categoryButton;
            ...
            final String var25 = selected2 = ClickGui.mm.clickGUI.sorting.getSelected();
            switch (selected2) {
                case "Random": {
                    this.moduleButtons.clear();
                    this.moduleButtons.addAll(this.moduleButtonsRandom);
        ...
        final Iterator<CategoryButton> iterator3 = this.categoryButtons.iterator();
        while (iterator3.hasNext()) {
            final CategoryButton categoryButton = iterator3.next();
            if (categoryButton.isUnfolded()) {
                for (final ModuleButton moduleButton2 : this.moduleButtons) {
                    if (moduleButton2.getParent() == categoryButton.getCategory()) {
        ...
        for (final CategoryButton categoryButton2 : this.categoryButtons) {
            if (this.draggedCategory != null && this.draggedCategory == categoryButton2.getCategory()) {
                categoryButton2.xPosition = (int)(mouseX - (categoryButton2.getCm()[0] - categoryButton2.getCm()[2]));
                categoryButton2.yPosition = (int)(mouseY - (categoryButton2.getCm()[1] - categoryButton2.getCm()[3]));
            }
            categoryButton2.drawButton(MC.mc, mouseX, mouseY);
            if (categoryButton2.isUnfolded()) {
                int i = 0;
                final int moduleX = categoryButton2.xPosition + 3;
                final int moduleHeight = 16;
                for (final ModuleButton moduleButton3 : this.moduleButtons) {
                    if (moduleButton3.getParent() == categoryButton2.getCategory()) {
                        moduleButton3.xPosition = moduleX;
                        moduleButton3.yPosition = height2 + i * moduleHeight + categoryButton2.yPosition;
