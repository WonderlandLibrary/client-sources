...
public class SettingSorter implements MC, MM, SM
{
    ...
    private void split9() {
        ...
        SettingSorter.mm.blockFly.moonWalk.setVisible(SettingSorter.mm.blockFly.playerYaw.isVisible() && SettingSorter.mm.blockFly.playerYaw.getBoolean() && !SettingSorter.mm.blockFly.godBridge.getBoolean());
        SettingSorter.mm.blockFly.godBridge.setVisible(SettingSorter.mm.blockFly.playerYaw.isVisible() && SettingSorter.mm.blockFly.playerYaw.getBoolean() && !SettingSorter.mm.blockFly.moonWalk.getBoolean());
    ...
    private void split8() {
        ...
        SettingSorter.mm.fly.speed.setVisible(SettingSorter.mm.fly.mode.getSelected().equals("Vanilla") || SettingSorter.mm.fly.mode.getSelected().equals("SkycaveBad") || SettingSorter.mm.fly.mode.getSelected().equals("PolarTest") || SettingSorter.mm.fly.mode.getSelected().equals("Teleport") || SettingSorter.mm.fly.mode.getSelected().equals("SilentACAbuse") || SettingSorter.mm.fly.mode.getSelected().equals("FurtherTeleport") || SettingSorter.mm.fly.mode.getSelected().equals("Motion") || SettingSorter.mm.fly.mode.getSelected().equals("FoxAC"));
        ...
        SettingSorter.mm.blockFly.resetRotation.setVisible(SettingSorter.mm.blockFly.snap.getBoolean());
    ...
    private void split7() {
        ...
        SettingSorter.mm.antiBot.checkTab.setVisible(SettingSorter.mm.antiBot.mode.getSelected().equals("Custom"));
    ...
    private void split6() {
        ...
        SettingSorter.mm.speed.vanillaSpeed.setVisible(SettingSorter.mm.speed.mode.getSelected().equals("VOnGround") || SettingSorter.mm.speed.mode.getSelected().equals("VBhop") || SettingSorter.mm.speed.mode.getSelected().equals("Polar"));
    ...
    public void split5() {
        ...
        SettingSorter.mm.velocity.karhuStart.setVisible(SettingSorter.mm.velocity.mode.getSelected().equals("Karhu"));
