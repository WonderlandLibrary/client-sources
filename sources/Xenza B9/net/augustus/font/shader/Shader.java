...
public class Shader
{
    ...
    public void compile() {
        ...
        GL20.glShaderSource(vertexID, (CharSequence)this.vertexSource);
        ...
        GL20.glShaderSource(fragmentID, (CharSequence)this.fragmentSource);
        GL20.glCompileShader(fragmentID);
        success = GL20.glGetShaderi(fragmentID, 35713);
        if (success == 0) {
            final int len2 = GL20.glGetShaderi(fragmentID, 35716);
            System.out.println("ERROR: '" + this.filepath + "'\n\tFragment shader compilation failed.");
            System.out.println(GL20.glGetShaderInfoLog(fragmentID, len2));
            assert false : "";
        }
        ...
        if (success == 0) {
            final int len2 = GL20.glGetProgrami(this.shaderProgramID, 35716);
            System.out.println("ERROR: '" + this.filepath + "'\n\tLinking of shaders failed.");
            System.out.println(GL20.glGetProgramInfoLog(this.shaderProgramID, len2));
            assert false : "";
        }
    }
    ...
    public void uploadMat4f(final String varName, final Matrix4f mat4) {
        final int varLocation = GL20.glGetUniformLocation(this.shaderProgramID, (CharSequence)varName);
        this.use();
