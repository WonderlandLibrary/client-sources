...
public class AugustusOptions extends GuiScreen
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.fontRendererObj.drawStringWithShadow("Client Manager", sr.getScaledWidth() / 4.0f - this.fontRendererObj.getStringWidth("Client Manager") / 2.0f, 10.0f, Color.lightGray.getRGB());
