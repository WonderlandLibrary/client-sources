...
public class PasswordTextField extends Gui
{
    ...
    public PasswordTextField(final int componentId, final FontRenderer fontrendererObj, final int x, final int y, final int par5Width, final int par6Height) {
        this.text = "";
        this.realText = "";
    ...
    public void setText(final String p_146180_1_) {
        if (this.field_175209_y.apply(p_146180_1_)) {
            if (p_146180_1_.length() > this.maxStringLength) {
                ...
                this.realText = p_146180_1_.substring(0, this.maxStringLength);
            }
            else {
                this.text = p_146180_1_;
                this.realText = p_146180_1_;
            }
    ...
    public void setMaxStringLength(final int p_146203_1_) {
        ...
        if (this.text.length() > p_146203_1_) {
            ...
            this.realText = this.realText.substring(0, p_146203_1_);
        }
    }
