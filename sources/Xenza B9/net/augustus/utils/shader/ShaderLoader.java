...
public class ShaderLoader
{
    ...
    public ShaderLoader(final String vertexSource, final String fragmentSource) {
        ...
        GL20.glShaderSource(vertexShader, (CharSequence)vertexShaderSource);
        GL20.glCompileShader(vertexShader);
        if (GL20.glGetShaderi(vertexShader, 35713) == 0) {
            System.err.println("Vertex shader wasn't able to be compiled correctly :(");
        }
        GL20.glShaderSource(fragmentShader, (CharSequence)fragmentShaderSource);
        ...
        this.timeUniform = GL20.glGetUniformLocation(this.shaderProgram, (CharSequence)"time");
        this.mouseUniform = GL20.glGetUniformLocation(this.shaderProgram, (CharSequence)"mouse");
        this.resolutionUniform = GL20.glGetUniformLocation(this.shaderProgram, (CharSequence)"resolution");
        GL20.glUseProgram(0);
    }
