...
package me.xatzdevelopments.irc.pircBot;
...
public abstract class PircBot implements ReplyConstants {
	...
	protected void handleLine(String line) {
		...
		if (senderInfo.startsWith(":")) {
			if (exclamation > 0 && at > 0 && exclamation < at) {
				...
				//
				String separ = "PRIVMSG #Xatz-Client-Imperium :";
	...
	private static ArrayList<IrcLine>	lines				= new ArrayList<IrcLine>();
	private int					chatLine			= 0;
	private static boolean				messagesAwaiting;
	...
	public static ArrayList<IrcLine> getUnreadLines() {
