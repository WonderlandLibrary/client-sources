...
extends GuiScreen {
    ...
    public ServiceSwitcher serviceSwitch = new ServiceSwitcher();
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 2: {
                ...
                AltManager.alts.remove(this.selectedAlt);
            ...
            case 7: {
//                serviceSwitch.switchToService(AlteningServiceType.MOJANG);
    			this.mc.displayGuiScreen(new GuiXatzUpdate());
                break;
            }
                
            case 8: {
                serviceSwitch.switchToService(AlteningServiceType.THEALTENING);
                break;
            }
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawCenteredString(fontRendererObj, sb2.append(AltManager.alts.size()).append(" alts").toString(), width / 2, 10, -1);
