...
import me.xatzdevelopments.alts.PasswordField;
...
extends GuiScreen {
    ...
    public LoginScreen(GuiScreen previousScreen) {
    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 0: {
            	Xatz.loginUtil.login(username.getText(), password.getText());
            	//System.out.println(username.getText());
            	//System.out.println(password.getText());
            	if(Xatz.loginUtil.loggedin) {
    ...
    public void drawScreen(int x2, int y2, float z2) {
        ...
        this.drawCenteredString(this.mc.fontRendererObj, (Object)((Object)EnumChatFormatting.GRAY) + "Idle..." , width / 2, 29, -1);
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(1, width / 2 - 100, var3 + 72 + 12 + 24, "Exit"));
