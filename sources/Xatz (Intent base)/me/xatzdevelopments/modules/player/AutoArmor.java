...
import me.xatzdevelopments.util.BypassUtil;
...
public class AutoArmor extends Module {
    ...
    public AutoArmor() {
        super("AutoArmor", Keyboard.KEY_NONE, Category.PLAYER, "sex");
        addSettings(speed);
    }
    ...
    public void onEvent(Event event) {
        if (event instanceof EventUpdate) {
            if (mc.thePlayer != null && (mc.currentScreen == null || mc.currentScreen instanceof GuiInventory)) {
                ...
                if (slotID != -1 && Xatz.invCooldownElapsed((long) (speed.getValue() + BypassUtil.range(0, 30)))) {
