...
import me.xatzdevelopments.util.TextureData;
...
public class FontManager {
    ...
    public FontManager() {
        ...
        try {
            ...
            for (int i : new int[]{6, 7, 8, 10, 11, 12, 14}) {
                InputStream istream = getClass().getResourceAsStream("/assets/minecraft/jelloregular.ttf");
                Font myFont = Font.createFont(Font.PLAIN, istream);
                myFont = myFont.deriveFont(Font.PLAIN, i);
                fonts.put("JEL " + i, new TTFFontRenderer(executorService, textureQueue, myFont));
            }
