...
public class ElementCheckBox extends Element {
	...
	public ElementCheckBox(ModuleButton iparent, BooleanSetting iset) {
		parent = iparent;
		set = iset;
		super.setup();
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		 ...
		 */
		FontUtil.drawString(set.name, x + width - FontUtil.getStringWidth(set.name), y + FontUtil.getFontHeight() / 2 - 0.5, 0xffffffff);
		Gui.drawRect(x + 1, y + 2, x + 12, y + 13, set.isEnabled() ? color : 0xff000000);
