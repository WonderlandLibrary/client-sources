...
public class ClickGUI extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		/* https://www.youtube.com/channel/UCJum3PIbnYvIfIEu05GL_yQ	*/ //Minecraft.getMinecraft().fontRendererObj.drawStringwithShadow("b"+"y"+ "H"+"e"+"r"+"o"+"C"+"o"+"d"+"e", -Minecraft.getMinecraft().fontRendererObj.getStringWidth("b"+"y"+ "H"+"e"+"r"+"o"+"C"+"o"+"d"+"e"), -Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT, 0xff11F86B);
																	   //Minecraft.getMinecraft().fontRendererObj.drawStringwithShadow("Modified by masterjunior24", -Minecraft.getMinecraft().fontRendererObj.getStringWidth("Modified by masterjunior24"), -Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT - 10, 0xff11F86B);
		/*															*/ //GL11.glPopMatrix();
						...
						for (Element e : b.menuelements) {
							...
							if(Xatz.getModuleByName("ClickGui").getModeSetting("Design").getMode().equals("New")){
								if(e instanceof ElementComboBox) {
									ElementComboBox el = (ElementComboBox)e;
									Gui.drawRect(el.x, el.y, el.x + el.width + 2, el.y + el.privheight, outlineColor);
								}else if(!(e instanceof ElementComboBox)) {
