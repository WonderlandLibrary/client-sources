package me.xatzdevelopments.util.render;
...
//    private final static Frustum frustrum = new Frustum();
    ...
    private final static void gradientSideways(double x, double y, double width, double height, boolean filled, Color color1, Color color2) {
    	start();
...
//        tessellator.draw();
    ...
    public static void prepareScissorBox(float x, float y, float x2, float y2) {
        ScaledResolution scale = new ScaledResolution(mc, 0, 0);
