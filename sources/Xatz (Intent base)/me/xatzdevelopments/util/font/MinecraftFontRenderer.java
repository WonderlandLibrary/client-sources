package me.xatzdevelopments.util.font;
...
//import fangclient.command.commands.NameProtectCommand;
...
//        if (NameProtectCommand.name != null) {
//            text = text.replace(Minecraft.getMinecraft().session.getUsername(), NameProtectCommand.name);
 //       }
