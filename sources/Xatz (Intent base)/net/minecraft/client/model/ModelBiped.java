...
public class ModelBiped extends ModelBase
{
    ...
    Entity idk = Minecraft.getMinecraft().thePlayer;
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        ...
        if(Xatz.overridePitch && p_78087_7_ instanceof EntityPlayerSP) {
        	this.bipedHead.rotateAngleX = Minecraft.getMinecraft().thePlayer.rotationPitchHead / (180F / (float) Math.PI);
        } else {
