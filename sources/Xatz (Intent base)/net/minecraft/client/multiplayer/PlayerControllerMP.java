...
import me.xatzdevelopments.events.listeners.EventDestroyBlock;
import me.xatzdevelopments.events.listeners.EventItemUse;
...
public class PlayerControllerMP
{
    ...
    {
        EventDestroyBlock event = new EventDestroyBlock();
        ...
        else
        {
            ...
            if (!var10 && this.currentGameType != WorldSettings.GameType.SPECTATOR)
            {
                ...
                else
                {
                    ...
                    event.setType(EventType.PRE);
                    Xatz.onEvent(event);
                    return !event.isCancelled() && p_178890_3_.onItemUse(p_178890_1_, p_178890_2_, p_178890_4_, p_178890_5_, var7, var8, var9);
                }
            }
            else
            {
