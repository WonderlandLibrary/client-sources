...
import me.xatzdevelopments.ui.LoginScreen;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public void run()
    {
        ...
        try {
            ...
            final CrashReport var21 = this.addGraphicsAndWorldToCrashReport(new CrashReport("Unexpected error", var5));
            this.freeMemory();
            Minecraft.logger.fatal("Unreported exception thrown!", var5);
            this.displayCrashReport(var21);
        }
        finally {
    ...
    private void func_175609_am() throws LWJGLException
    {
        ...
        Display.setTitle("Loading " + Xatz.name + " v" + Xatz.version);
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            final EventCanInteract e = new EventCanInteract();
            Xatz.onEvent(e);
