...
import me.xatzdevelopments.ui.MainMenu;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
        return OpenGlHelper.shadersSupported && this.getTheShaderGroup() != null;
    }

    public void stopUseShader()
    {
        if (this.getTheShaderGroup() != null)
        {
            this.getTheShaderGroup().deleteShaderGroup();
        }
    ...
    public void func_175069_a(ResourceLocation p_175069_1_)
    {
        if (OpenGlHelper.isFramebufferEnabled())
        {
            try
            {
                this.setTheShaderGroup(new ShaderGroup(this.mc.getTextureManager(), this.resourceManager, this.mc.getFramebuffer(), p_175069_1_));
                this.getTheShaderGroup().createBindFramebuffers(this.mc.displayWidth, this.mc.displayHeight);
    ...
    public void updateShaderGroupSize(int p_147704_1_, int p_147704_2_)
    {
        if (OpenGlHelper.shadersSupported)
        {
            if (this.getTheShaderGroup() != null)
            {
                this.getTheShaderGroup().createBindFramebuffers(p_147704_1_, p_147704_2_);
            }
    ...
    public void setupCameraTransform(float partialTicks, int pass)
    {
		...
		if (!Xatz.getModuleByName("NoHurtcam").isEnabled()) {
			this.hurtCameraEffect(partialTicks);
		}
		
		if (Xatz.getModuleByName("Australia").isEnabled()) {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                if (OpenGlHelper.shadersSupported)
                {
                    ...
                    if (this.getTheShaderGroup() != null && this.field_175083_ad)
                    {
                        GlStateManager.matrixMode(5890);
                        GlStateManager.pushMatrix();
                        GlStateManager.loadIdentity();
                        this.getTheShaderGroup().loadShaderGroup(partialTicks);
                        GlStateManager.popMatrix();
                    }
    ...
    private void func_175068_a(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Xatz.onEvent(new EventRenderWorld());
    ...
    public boolean setFxaaShader(int fxaaLevel)
    {
        ...
        else if (this.getTheShaderGroup() != null && this.getTheShaderGroup() != this.fxaaShaders[2] && this.getTheShaderGroup() != this.fxaaShaders[4])
        {
            return true;
        }
        ...
        else if (this.getTheShaderGroup() != null && this.getTheShaderGroup() == this.fxaaShaders[fxaaLevel])
        {
            return true;
        }
        ...
        else
        {
            ...
            this.fxaaShaders[fxaaLevel] = this.getTheShaderGroup();
