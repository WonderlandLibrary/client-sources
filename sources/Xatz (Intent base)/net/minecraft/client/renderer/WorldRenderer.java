...
public class WorldRenderer
{
    ...
    public WorldRenderer pos(double p_181662_1_, double p_181662_3_, double p_181662_5_) {
		...
		int i = this.vertexCount * this.vertexFormat.func_177338_f()
				+ this.vertexFormat.func_177344_b(this.rawBufferIndex);

		switch (WorldRenderer.SwitchEnumUseage.field_178959_a[this.field_181677_f.func_177367_b().ordinal()]) {
		case 1:
    ...
    public void begin(int p_181668_1_, VertexFormat p_181668_2_) {
		if (this.isDrawing) {
			...
			this.field_181677_f = p_181668_2_.getElement(this.rawBufferIndex);
			this.needsUpdate = false;
    ...
    private void func_181667_k() {
		++this.rawBufferIndex;
		this.rawBufferIndex %= this.vertexFormat.func_177345_h();
		this.field_181677_f = this.vertexFormat.getElement(this.rawBufferIndex);

		if (this.field_181677_f.func_177375_c() == VertexFormatElement.EnumUseage.PADDING) {
			this.func_181667_k();
		}
	}
