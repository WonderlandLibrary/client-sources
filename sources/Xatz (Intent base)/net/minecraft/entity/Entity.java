...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double var15 = y;
            double var17 = z;
            EventSafeWalk safeWalk = new EventSafeWalk();
            safeWalk.setType(EventType.PRE);
            Xatz.onEvent(safeWalk);
            boolean var19 = this.onGround && (this.isSneaking() || safeWalk.isCancelled()) && this instanceof EntityPlayer;
    ...
    {
    	EventMoveFlying e = new EventMoveFlying(strafe, forward, friction);
