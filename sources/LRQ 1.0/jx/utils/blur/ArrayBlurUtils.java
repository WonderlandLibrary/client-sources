...
public final class ArrayBlurUtils {
    ...
    private final void setValues(float strength, float x, float y, float w, float h, float width, float height, boolean force) {
        ...
        while (bl <= bl2) {
            void i;
            ShaderUniform shaderUniform = ((Shader)ArrayBlurUtils.shaderGroup.field_148031_d.get((int)i)).func_148043_c().func_147991_a("Radius");
            if (shaderUniform != null) {
                shaderUniform.func_148090_a(strength);
            }
            ShaderUniform shaderUniform2 = ((Shader)ArrayBlurUtils.shaderGroup.field_148031_d.get((int)i)).func_148043_c().func_147991_a("BlurXY");
            if (shaderUniform2 != null) {
                shaderUniform2.func_148087_a(x, height - y - h);
            }
            ShaderUniform shaderUniform3 = ((Shader)ArrayBlurUtils.shaderGroup.field_148031_d.get((int)i)).func_148043_c().func_147991_a("BlurCoord");
    ...
    static /* synthetic */ void setValues$default(ArrayBlurUtils arrayBlurUtils, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean bl, int n, Object object) {
        if ((n & 0x80) != 0) {
            bl = false;
        }
    ...
    public static final void blur(float posX, float posY, float posXEnd, float posYEnd, float blurStrength, boolean displayClipMask, Function0<Unit> triggerMethod) {
        ...
        lastWidth = width;
        lastHeight = height;
        ArrayBlurUtils.setValues$default(INSTANCE, blurStrength, x, y, x2 - x, y2 - y, width, height, false, 128, null);
        ...
        double f2 = (double)ArrayBlurUtils.frbuffer.field_147621_c / (double)ArrayBlurUtils.frbuffer.field_147622_a;
        double f3 = (double)ArrayBlurUtils.frbuffer.field_147618_d / (double)ArrayBlurUtils.frbuffer.field_147620_b;
    ...
    public static final void blurArea(float x, float y, float x2, float y2, float blurStrength) {
        ArrayBlurUtils.blur(x, y, x2, y2, blurStrength, false, (Function0<Unit>)((Function0)new Function0<Unit>(x, y, x2, y2){
    ...
    public static final void blurAreaRounded(float x, float y, float x2, float y2, float rad, float blurStrength) {
        ArrayBlurUtils.blur(x, y, x2, y2, blurStrength, false, (Function0<Unit>)((Function0)new Function0<Unit>(x, y, x2, y2, rad){
            final /* synthetic */ float $x;
            final /* synthetic */ float $y;
            final /* synthetic */ float $x2;
            final /* synthetic */ float $y2;
