...
public final class EaseUtils {
     ...
     */
    @JvmStatic
    public static final ListValue getEnumEasingList(String name) {
     ...
     */
    @JvmStatic
    public static final ListValue getEnumEasingOrderList(String name) {
        void $this$toTypedArray$iv;
        Collection<String> collection;
        void $this$mapTo$iv$iv;
        Collection $this$map$iv;
    ...
    @JvmStatic
    public static final double apply(EnumEasingType type, EnumEasingOrder order, double value) {
        double d;
        Method method;
        boolean bl;
        Method[] methodArray;
        block5: {
            ...
            methodArray = INSTANCE.getClass().getDeclaredMethods();
            bl = false;
