...
extends Gui {
    ...
    public void drawTextBox2() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                String s1 = flag ? s.substring(0, j) : s;
                j1 = (int)FontLoaders.xyz18.drawString(s1, l, i1 + 1, new Color(255, 255, 255).getRGB());
            }
            boolean flag2 = this.cursorPosition < this.text.length() || this.text.length() >= this.getMaxStringLength();
            int k1 = j1;
            if (!flag) {
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                FontLoaders.xyz18.drawString(s.substring(j), j1 + 2, i1 + 1, new Color(250, 250, 250).getRGB());
            }
            if (flag1) {
                if (flag2) {
                    Gui.func_73734_a((int)j1, (int)i1, (int)(k1 + 1), (int)(i1 + 1 + this.fontRendererInstance.field_78288_b), (int)-3092272);
                } else {
                    FontLoaders.xyz20.drawString("_", k1 + 1, i1, i);
                }
            }
            if (k != j) {
                int l1 = l + this.fontRendererInstance.func_78256_a(s.substring(0, k).replaceAll(".", "*"));
