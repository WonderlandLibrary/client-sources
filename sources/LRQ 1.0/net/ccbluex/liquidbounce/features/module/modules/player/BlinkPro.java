...
@ModuleInfo(name="BlinkPro", category=ModuleCategory.PLAYER, description="Suspends all movement packets.")
public final class BlinkPro
extends Module {
    ...
    private final BoolValue hytnewvalue = new BoolValue("HytBlink", false);
    ...
    public final void onPacket(PacketEvent event) {
        ...
        if (((Boolean)this.hytnewvalue.get()).booleanValue() && packet instanceof CPacketConfirmTransaction) {
            event.cancelEvent();
        }
