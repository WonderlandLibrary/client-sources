...
extends Module {
    ...
    public void onRender2D(Render2DEvent event) {
        if (((Boolean)this.counterDisplayValue.get()).booleanValue()) {
            ...
            RenderUtils.drawRoundedRect((float)(scaledResolution.func_78326_a() / 2 - infoWidth / 2 - 4), (float)(scaledResolution.func_78328_b() - 60), (float)(scaledResolution.func_78326_a() / 2 + infoWidth / 2 + 4), (float)(scaledResolution.func_78328_b() - 74), 2, new Color(0.15f, 0.15f, 0.15f, this.progress).getRGB());
            GlStateManager.func_179117_G();
            Fonts.font35.drawCenteredString(info, (float)(scaledResolution.func_78326_a() / 2) + 0.1f, scaledResolution.func_78328_b() - 70, new Color(1.0f, 1.0f, 1.0f, 0.8f * this.progress).getRGB(), false);
            GlStateManager.func_179109_b((float)0.0f, (float)(14.0f + this.progress * 4.0f), (float)0.0f);
        }
    }
