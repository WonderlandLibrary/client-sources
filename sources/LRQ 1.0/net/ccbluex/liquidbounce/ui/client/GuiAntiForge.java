...
extends WrappedGuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.fontBold180.drawCenteredString("AntiForge", (int)((float)this.representedScreen.getWidth() / 2.0f), (int)((float)this.representedScreen.getHeight() / 8.0f + 5.0f), 4673984, true);
