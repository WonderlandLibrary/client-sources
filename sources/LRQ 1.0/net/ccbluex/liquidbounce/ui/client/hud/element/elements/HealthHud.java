...
extends Element {
    ...
    public Border drawElement() {
        float health = HealthHud.mc2.field_71439_g.func_110143_aJ();
        double hpPercentage = health / HealthHud.mc2.field_71439_g.func_110138_aP();
        hpPercentage = MathHelper.func_151237_a((double)hpPercentage, (double)0.0, (double)1.0);
        double newWidth = 51.0 * hpPercentage;
        this.animWidth = (float)AnimationHelper.animate(newWidth, this.animWidth, 0.0429999852180481);
        ...
        if (((Boolean)this.BlurValue.get()).booleanValue()) {
            ...
            GL11.glPushMatrix();
            BlurBuffer.blurArea(this.x, this.y, (float)this.x + 40.0f, (float)this.y + 43.0f);
            GL11.glPopMatrix();
            GL11.glTranslated((double)this.getRenderX(), (double)this.getRenderY(), (double)0.0);
        }
        Fonts.SFBOLD.SFBOLD_16.SFBOLD_16.drawCenteredString("HP", this.x + 20, this.y + 14 - 10, -1);
        ...
        double scoef = HealthHud.mc2.field_71439_g.func_110143_aJ() / HealthHud.mc2.field_71439_g.func_110138_aP() * 100.0f;
