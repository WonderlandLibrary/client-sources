...
extends Style {
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        RenderUtils.drawBorderedRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.font35.getFontHeight() + 3, 1.0f, new Color(255, 255, 255, 90).getRGB(), Integer.MIN_VALUE);
                ...
                for (Value<?> value : moduleValues) {
                    ...
                    if (value instanceof BoolValue) {
                        ...
                        if (fontRenderer.isGameFontRenderer()) {
                            ...
                            Fonts.FontInfo fontInfo = Fonts.getFontDetails(fontRenderer);
                            if (fontInfo != null) {
