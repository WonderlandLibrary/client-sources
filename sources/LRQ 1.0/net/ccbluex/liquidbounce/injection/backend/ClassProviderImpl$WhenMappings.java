...
public final class ClassProviderImpl$WhenMappings {
    ...
    static {
        ...
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.DIG_SPEED.ordinal()] = 1;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.HEAL.ordinal()] = 2;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.REGENERATION.ordinal()] = 3;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.BLINDNESS.ordinal()] = 4;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.MOVE_SPEED.ordinal()] = 5;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.HUNGER.ordinal()] = 6;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.DIG_SLOWDOWN.ordinal()] = 7;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.CONFUSION.ordinal()] = 8;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.WEAKNESS.ordinal()] = 9;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.MOVE_SLOWDOWN.ordinal()] = 10;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.HARM.ordinal()] = 11;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.WITHER.ordinal()] = 12;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.POISON.ordinal()] = 13;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.NIGHT_VISION.ordinal()] = 14;
        ClassProviderImpl$WhenMappings.$EnumSwitchMapping$1[PotionType.JUMP.ordinal()] = 15;
