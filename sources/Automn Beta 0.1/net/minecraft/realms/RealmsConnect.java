...
public class RealmsConnect {
        ...
        (new Thread("Realms-connect-task") {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (RealmsConnect.this.aborted) return;
                    ...
                    if (inetaddress != null) {
                        final String s1 = inetaddress.toString() + ":" + p_connect_2_;
                        s = s.replaceAll(s1, "");
                    }
    ...
    public void tick() {
        if (this.connection != null) if (this.connection.isChannelOpen()) this.connection.processReceivedPackets();
        else
