...
import wtf.automn.events.impl.player.EventJump;
...
public abstract class EntityLivingBase extends Entity implements MM
{
    ...
    {
        /**
         * adding EventJump and modificate this method
         */
        ...
        if (this.isSprinting())
        {
            ...
            if (this == Minecraft.getMinecraft().thePlayer) {
                f = eventJump.getYaw() * 0.017453292F;
            }
    ...
    public Vec3 getLook(float partialTicks)
    {
         ...
         * MouseDelayFix
         */
        if (this instanceof EntityPlayerSP && mm.fixes.enabled() && mm.fixes.mouseDelayFix.getBoolean()) {
