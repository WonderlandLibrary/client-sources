...
import wtf.automn.events.impl.visual.EventRender3D;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    /**
     * adding variables for silent aim
     */
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                if (OpenGlHelper.shadersSupported)
                {
                    ...
                    this.mc.getFramebuffer().bind(true);
                }
            ...
            /**
             * last thing for silent Aim
             */

            if (mc.getRenderViewEntity() != null) {
                mc.getRenderViewEntity().prevRotationYaw = this.lastYawBefore;
                mc.getRenderViewEntity().prevRotationPitch = this.lastPitchBefore;
                mc.getRenderViewEntity().rotationYaw = this.yawBefore;
                mc.getRenderViewEntity().rotationPitch = this.pitchBefore;
            }
    ...
    public void renderWorld(float partialTicks, long finishTimeNano)
    {
        ...
        this.lastYawBefore = mc.getRenderViewEntity().prevRotationYaw;
        this.lastPitchBefore = mc.getRenderViewEntity().prevRotationPitch;
        this.yawBefore = mc.getRenderViewEntity().rotationYaw;
        this.pitchBefore = mc.getRenderViewEntity().rotationPitch;

        mc.getRenderViewEntity().rotationYaw = Automn.instance().yawPitchHelper().realYaw;
        mc.getRenderViewEntity().rotationPitch = Automn.instance().yawPitchHelper().realPitch;
        mc.getRenderViewEntity().prevRotationYaw = Automn.instance().yawPitchHelper().realLastYaw;
        mc.getRenderViewEntity().prevRotationPitch = Automn.instance().yawPitchHelper().realLastPitch;
