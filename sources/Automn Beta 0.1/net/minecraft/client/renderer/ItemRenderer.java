...
public class ItemRenderer {
    ...
    public void renderItem(final EntityLivingBase entityIn, final ItemStack heldStack,
        ...
        if (heldStack != null) {
            ...
            GlStateManager.popMatrix();
                ...
                if(Automn.instance().moduleManager().glowedItem.enabled()){
                    ModuleShadow.drawShadow(() ->    this.itemRenderer.renderItemModelForEntity(heldStack, entityIn, transform), false);
                }else{
                    if(Automn.instance().moduleManager().bluredItem.enabled()) {
                        ModuleBlur.drawBlurred(() -> this.itemRenderer.renderItemModelForEntity(heldStack, entityIn, transform), false);
                    }
                }
    ...
    private void performDrinking(final AbstractClientPlayer clientPlayer, final float partialTicks) {
        ...
        final float f3 = 1.0F - (float) Math.pow((double) f1, 27.0D);
    ...
    private void doBowTransformations(final float partialTicks, final AbstractClientPlayer clientPlayer) {
        ...
        final float f = (float) this.itemToRender.getMaxItemUseDuration() - ((float) clientPlayer.getItemInUseCount() - partialTicks + 1.0F);
        float f1 = f / 20.0F;
    ...
    public void renderItemInFirstPerson(final float partialTicks) {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
            ...
            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof ItemMap) this.renderItemMap(abstractclientplayer, f2, f, f1);
            ...
            } else if (!abstractclientplayer.isInvisible()) this.renderPlayerArm(abstractclientplayer, f, f1);
        ...
        if (this.itemToRender != null && itemstack != null) {
            if (!this.itemToRender.getIsItemStackEqual(itemstack)) {
                if (Reflector.ForgeItem_shouldCauseReequipAnimation.exists()) {
                    final boolean flag1 = Reflector.callBoolean(this.itemToRender.getItem(), Reflector.ForgeItem_shouldCauseReequipAnimation, new Object[]{this.itemToRender, itemstack, Boolean.valueOf(this.equippedItemSlot != entityplayer.inventory.currentItem)});
