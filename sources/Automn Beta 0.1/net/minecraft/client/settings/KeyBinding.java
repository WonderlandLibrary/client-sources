...
public class KeyBinding implements Comparable<KeyBinding> {
    ...
    public static void unPressAllKeys() {
        for (final KeyBinding keybinding : keybindArray) keybinding.unpressKey();
    }

    public static void resetKeyBindingArrayAndHash() {
        hash.clearMap();

        for (final KeyBinding keybinding : keybindArray) hash.addKey(keybinding.keyCode, keybinding);
    }
