...
public class GuiConnecting extends GuiScreen {
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet()) {
            ...
            public void run() {
                ...
                try {
                    ...
                    GuiConnecting.this.networkManager = NetworkManager.func_181124_a(inetaddress, port, GuiConnecting.this.mc.gameSettings.isUsingNativeTransport());
                    ...
                    if (inetaddress != null) {
                        final String s1 = inetaddress.toString() + ":" + port;
                        s = s.replaceAll(s1, "");
                    }
    ...
    public void updateScreen() {
        if (this.networkManager != null)
            if (this.networkManager.isChannelOpen()) this.networkManager.processReceivedPackets();
            else
