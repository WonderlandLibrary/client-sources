...
import wtf.automn.gui.alt.ScreenAltManager;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    public GuiMainMenu() {
        ...
        try {
            ...
            if (!list.isEmpty()) while (true) {
                this.splashText = list.get(RANDOM.nextInt(list.size()));

                if (this.splashText.hashCode() != 125780783) break;
            }
  ...
  //      this.buttonList.add(new GuiButtonLanguage(5, this.width / 2 - 124, j + 72 + 12));
    ...
    private void addSingleplayerMultiplayerButtons(final int p_73969_1_, final int p_73969_2_) {
        ...
        if (Reflector.GuiModList_Constructor.exists()) {
            ...
            this.buttonList.add(this.realmsButton = new GuiButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "§aAltmanager"));
    }
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        ...
        if (button.id == 14) this.mc.displayGuiScreen(new ScreenAltManager(this));
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Gui.drawRect(width / 2f + 110, this.height / 4f + 160, width / 2f - 110, height / 3f -50,  Integer.MIN_VALUE);
          GlyphPageFontRenderer mainFont = ClientFont.font(50, "Arial", true);
        mainFont.drawString("Automn", width / 2f - 45,height / 3f -40, new Color(0, 141, 255).getRGB());
       // RenderUtils.drawImage(0, 0, this.mc.displayWidth / 2f, this.mc.displayHeight / 2f, new ResourceLocation("automn/mainmenu/background.png"));
       // RenderUtils.drawImage(410, 25, 160, 160, new ResourceLocation("automn/mainmenu/mainmenu.png"));
