...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        } else this.serverListSelector.setDimensions(this.width, this.height, 32, this.height - 64);
        ...
        if (button.enabled) {
            ...
            if (button.id == 2 && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
                ...
                if (s4 != null) {
                    ...
                    final String s = I18n.format("selectServer.deleteQuestion", new Object[0]);
                    final String s1 = "\'" + s4 + "\' " + I18n.format("selectServer.deleteWarning", new Object[0]);
                    final String s2 = I18n.format("selectServer.deleteButton", new Object[0]);
                    final String s3 = I18n.format("gui.cancel", new Object[0]);
                    final GuiYesNo guiyesno = new GuiYesNo(this, s, s1, s2, s3, this.serverListSelector.func_148193_k());
                    this.mc.displayGuiScreen(guiyesno);
                }
            } else if (button.id == 1) this.connectToSelected();
            else if (button.id == 88) this.mc.displayGuiScreen(new GuiProtocolSelector(this));
            else if (button.id == 4) {
            ...
            } else if (button.id == 0) this.mc.displayGuiScreen(this.parentScreen);
            else if (button.id == 8) this.refreshServerList();
        }
    }
    ...
    public void confirmClicked(final boolean result, final int id) {
        ...
        if (this.deletingServer) {
            ...
            if (result) this.connectToServer(this.selectedServer);
    ...
    protected void keyTyped(final char typedChar, final int keyCode) throws IOException {
        ...
        if (keyCode == 63) this.refreshServerList();
        else if (i >= 0) if (keyCode == 200) if (isShiftKeyDown()) {
            ...
            if (this.serverListSelector.getListEntry(this.serverListSelector.func_148193_k()) instanceof ServerListEntryLanScan)
                if (this.serverListSelector.func_148193_k() > 0) {
                    ...
                    this.serverListSelector.scrollBy(-this.serverListSelector.getSlotHeight());
                } else this.selectServer(-1);
        } else this.selectServer(-1);
        else if (keyCode == 208) if (isShiftKeyDown()) {
        ...
        else if (keyCode != 28 && keyCode != 156) super.keyTyped(typedChar, keyCode);
        else
    ...
    public void func_175391_a(final ServerListEntryNormal p_175391_1_, final int p_175391_2_, final boolean p_175391_3_) {
        ...
        if (this.serverListSelector.func_148193_k() == p_175391_2_) this.selectServer(i);
    ...
    public void func_175393_b(final ServerListEntryNormal p_175393_1_, final int p_175393_2_, final boolean p_175393_3_) {
        ...
        if (this.serverListSelector.func_148193_k() == p_175393_2_) this.selectServer(i);
