...
implements Serializable {
    ...
    public static <T> Optional<T> fromNullable(@Nullable T t) {
        return t == null ? Optional.absent() : new Present<T>(t);
    }

    @Nullable
    public static <T> Optional<T> fromJavaUtil(@Nullable java.util.Optional<T> optional) {
        return optional == null ? null : Optional.fromNullable(optional.orElse(null));
    }

    @Nullable
    public static <T> java.util.Optional<T> toJavaUtil(@Nullable Optional<T> optional) {
        return optional == null ? null : optional.toJavaUtil();
    }
