...
public final class CacheBuilder<K, V> {
    ...
    @GwtIncompatible
    public static CacheBuilder<Object, Object> from(String string) {
    ...
    public CacheBuilder<K, V> maximumSize(long l) {
        ...
        Preconditions.checkArgument(l >= 0L, "maximum size must not be negative");
        this.maximumSize = l;
        return this;
    }
    ...
    public CacheBuilder<K, V> maximumWeight(long l) {
        ...
        Preconditions.checkArgument(l >= 0L, "maximum weight must not be negative");
        return this;
    }
    ...
    public <K1 extends K, V1 extends V> CacheBuilder<K1, V1> weigher(Weigher<? super K1, ? super V1> weigher) {
        ...
        cacheBuilder.weigher = Preconditions.checkNotNull(weigher);
        return cacheBuilder;
    }
    ...
    public CacheBuilder<K, V> expireAfterWrite(long l, TimeUnit timeUnit) {
        ...
        Preconditions.checkArgument(l >= 0L, "duration cannot be negative: %s %s", l, (Object)timeUnit);
    ...
    public CacheBuilder<K, V> refreshAfterWrite(long l, TimeUnit timeUnit) {
        ...
        Preconditions.checkArgument(l > 0L, "duration must be positive: %s %s", l, (Object)timeUnit);
