...
extends ViaSubCommand {
    ...
    public boolean execute(ViaCommandSender viaCommandSender, String[] stringArray) {
        ...
        DisplayLeaksSubCmd.sendMessage(viaCommandSender, "&6Leak detector is now %s", ResourceLeakDetector.getLevel() == ResourceLeakDetector.Level.PARANOID ? "&aenabled" : "&cdisabled");
        return false;
    }
}
