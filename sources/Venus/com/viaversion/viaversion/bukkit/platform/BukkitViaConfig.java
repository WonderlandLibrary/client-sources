...
extends AbstractViaConfig {
    ...
    protected void loadFields() {
        super.loadFields();
        this.registerUserConnectionOnJoin = this.getBoolean("register-userconnections-on-join", false);
        this.quickMoveActionFix = this.getBoolean("quick-move-action-fix", true);
        this.hitboxFix1_9 = this.getBoolean("change-1_9-hitbox", true);
        this.hitboxFix1_14 = this.getBoolean("change-1_14-hitbox", true);
        this.blockConnectionMethod = this.getString("blockconnection-method", "packet");
        this.armorToggleFix = this.getBoolean("armor-toggle-fix", false);
    }
