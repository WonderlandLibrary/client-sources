...
public class AchievementTranslationMapping {
    ...
    private static void add(String string, String string2) {
        ACHIEVEMENTS.put(string, string2);
    }

    private static void addSpecial(String string, String string2) {
        AchievementTranslationMapping.add(string, string2);
        SPECIAL_ACHIEVEMENTS.add(string);
    }
    ...
    public static boolean isSpecial(String string) {
        return SPECIAL_ACHIEVEMENTS.contains(string);
    }
