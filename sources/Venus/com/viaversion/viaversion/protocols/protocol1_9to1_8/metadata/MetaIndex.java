...
public enum MetaIndex {
    ...
    private MetaIndex(Entity1_10Types.EntityType entityType, @Nullable int n2, MetaType1_8 metaType1_8, MetaType1_9 metaType1_9) {
        this.clazz = entityType;
        this.index = n2;
        this.newIndex = n2;
        this.oldType = metaType1_8;
        this.newType = metaType1_9;
    }

    private MetaIndex(Entity1_10Types.EntityType entityType, int n2, @Nullable MetaType1_8 metaType1_8, int n3, MetaType1_9 metaType1_9) {
        this.clazz = entityType;
        this.index = n2;
        this.oldType = metaType1_8;
        this.newIndex = n3;
    ...
    private static Optional<MetaIndex> getIndex(EntityType entityType, int n) {
        Pair<EntityType, Integer> pair = new Pair<EntityType, Integer>(entityType, n);
        return Optional.ofNullable(metadataRewrites.get(pair));
    }

    public static MetaIndex searchIndex(EntityType entityType, int n) {
        EntityType entityType2 = entityType;
        do {
            Optional<MetaIndex> optional;
            if (!(optional = MetaIndex.getIndex(entityType2, n)).isPresent()) continue;
            return optional.get();
    ...
    static {
        ...
        for (MetaIndex metaIndex : MetaIndex.values()) {
            metadataRewrites.put(new Pair<Entity1_10Types.EntityType, Integer>(metaIndex.clazz, metaIndex.index), metaIndex);
        }
    }
}
