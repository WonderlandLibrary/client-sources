...
public enum ArmorType {
    ...
    private ArmorType(int n2, int n3, String string2) {
        this.armorPoints = n2;
        this.id = n3;
        this.type = string2;
    }
    ...
    public static ArmorType findById(int n) {
        ArmorType armorType = armor.get(n);
        return armorType == null ? NONE : armorType;
    }

    public static ArmorType findByType(String string) {
        for (ArmorType armorType : ArmorType.values()) {
            if (!armorType.getType().equals(string)) continue;
            return armorType;
        }
        return NONE;
    }

    public static boolean isArmor(int n) {
        return armor.containsKey(n);
    }
    ...
    static {
        ...
        for (ArmorType armorType : ArmorType.values()) {
            armor.put(armorType.getId(), armorType);
        }
    }
}
