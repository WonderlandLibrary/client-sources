...
public enum SoundEffect {
    ...
    private SoundEffect(String string2, String string3, SoundCategory soundCategory) {
        this.category = soundCategory;
        this.newName = string3;
        this.name = string2;
        this.breaksound = string2.startsWith("dig.");
    }

    private SoundEffect(String string2, String string3, SoundCategory soundCategory, boolean bl) {
        this.category = soundCategory;
        this.newName = string3;
        this.name = string2;
        this.breaksound = string2.startsWith("dig.") || bl;
    }

    public static SoundEffect getByName(String string) {
        string = string.toLowerCase(Locale.ROOT);
        return effects.get(string);
    }
    ...
    static {
        ...
        for (SoundEffect soundEffect : SoundEffect.values()) {
            effects.put(soundEffect.getName(), soundEffect);
        }
    }
}
