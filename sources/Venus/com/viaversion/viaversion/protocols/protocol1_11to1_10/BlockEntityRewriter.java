...
public class BlockEntityRewriter {
    ...
    private static void rewrite(String string, String string2) {
        oldToNewNames.put(string, "minecraft:" + string2);
    }
    ...
    public static String toNewIdentifier(String string) {
        String string2 = (String)oldToNewNames.get(string);
        if (string2 != null) {
            return string2;
        }
        return string;
