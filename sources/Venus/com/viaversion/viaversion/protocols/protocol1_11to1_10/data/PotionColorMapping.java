...
public class PotionColorMapping {
    ...
    public static Pair<Integer, Boolean> getNewData(int n) {
        return (Pair)POTIONS.get(n);
    }

    private static void addRewrite(int n, int n2, boolean bl) {
        POTIONS.put(n, new Pair<Integer, Boolean>(n2, bl));
    }
