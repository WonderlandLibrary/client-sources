...
public enum Entity1_19_4Types implements EntityType
{
    ...
    private Entity1_19_4Types(EntityType entityType) {
        this.parent = entityType;
        this.identifier = "minecraft:" + this.name().toLowerCase(Locale.ROOT);
    }

    private Entity1_19_4Types(EntityType entityType, String string2) {
        this.parent = entityType;
    ...
    public static EntityType getTypeFromId(int n) {
        return EntityTypeUtil.getTypeFromId(TYPES, n, ENTITY);
    }

    public static void initialize(Protocol<?, ?, ?, ?> protocol) {
        EntityTypeUtil.initialize((EntityType[])Entity1_19_4Types.values(), (EntityType[])TYPES, protocol, Entity1_19_4Types::lambda$initialize$0);
    }

    private static void lambda$initialize$0(Entity1_19_4Types entity1_19_4Types, int n) {
        entity1_19_4Types.id = n;
    }

    static {
        TYPES = EntityTypeUtil.createSizedArray(Entity1_19_4Types.values());
    }
}
