...
public interface UserConnection {
    ...
    default public void transformOutgoing(ByteBuf byteBuf, Function<Throwable, Exception> function) throws Exception {
    ...
    default public void transformIncoming(ByteBuf byteBuf, Function<Throwable, Exception> function) throws Exception {
        if (this.isClientSide()) {
            this.transformClientbound(byteBuf, function);
        } else {
            this.transformServerbound(byteBuf, function);
