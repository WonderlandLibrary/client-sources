...
public interface PacketWrapper {
    ...
    @Deprecated
    public static PacketWrapper create(int n, @Nullable ByteBuf byteBuf, UserConnection userConnection) {
    ...
    default public void send(Class<? extends Protocol> clazz) throws Exception {
        this.send(clazz, true);
    }

    public void send(Class<? extends Protocol> var1, boolean var2) throws Exception;

    default public void scheduleSend(Class<? extends Protocol> clazz) throws Exception {
    ...
    default public PacketWrapper create(PacketType packetType, PacketHandler packetHandler) throws Exception {
    ...
    default public void sendToServer(Class<? extends Protocol> clazz) throws Exception {
        this.sendToServer(clazz, true);
    }

    public void sendToServer(Class<? extends Protocol> var1, boolean var2) throws Exception;

    default public void scheduleSendToServer(Class<? extends Protocol> clazz) throws Exception {
