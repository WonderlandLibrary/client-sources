...
public interface ProtocolManager {
    ...
    default public @Nullable Protocol getProtocol(ProtocolVersion protocolVersion, ProtocolVersion protocolVersion2) {
    ...
    @Deprecated
    default public void setOnlyCheckLoweringPathEntries(boolean bl) {
        this.setMaxPathDeltaIncrease(bl ? 0 : -1);
    }
