...
extends Rewriter<T> {
    ...
    default public EntityType objectTypeFromId(int n) {
    ...
    default public <E extends EntityTracker> E tracker(UserConnection userConnection) {
        return (E)userConnection.getEntityTracker(this.protocol().getClass());
    }
}
