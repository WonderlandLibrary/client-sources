...
ScopedComponent<TranslatableComponent> {
    ...
    @Contract(pure=true)
    @NotNull
    public TranslatableComponent args(@NotNull @NotNull ComponentLike @NotNull ... var1);
    ...
    extends ComponentBuilder<TranslatableComponent, Builder> {
        ...
        @Contract(value="_ -> this")
        @NotNull
        public Builder args(@NotNull @NotNull ComponentBuilder<?, ?> @NotNull ... var1);
        ...
        @Contract(value="_ -> this")
        @NotNull
        public Builder args(@NotNull @NotNull ComponentLike @NotNull ... var1);
