...
Buildable<LegacyComponentSerializer, Builder> {
    ...
    @NotNull
    public static LegacyComponentSerializer legacy(char c) {
        if (c == '\u00a7') {
        ...
        return LegacyComponentSerializer.builder().character(c).build();
    }

    @Nullable
    public static LegacyFormat parseChar(char c) {
    ...
    @Override
    @NotNull
    default public Object serialize(@NotNull Component component) {
        return this.serialize(component);
    }

    @Override
    @NotNull
    default public Component deserialize(@NotNull Object object) {
