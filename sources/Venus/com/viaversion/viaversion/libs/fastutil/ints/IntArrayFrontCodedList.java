...
RandomAccess {
    ...
    public IntArrayFrontCodedList(Iterator<int[]> iterator2, int n) {
        ...
        while (iterator2.hasNext()) {
            ...
            if (n2 % n == 0) {
                lArray = LongArrays.grow((long[])lArray, (int)(n2 / n + 1));
                lArray[n2 / n] = l;
                nArray = BigArrays.grow(nArray, l + (long)IntArrayFrontCodedList.count(n4) + (long)n4, l);
                l += (long)IntArrayFrontCodedList.writeInt(nArray, n4, l);
                BigArrays.copyToBig(nArrayArray[n3], 0, nArray, l, (long)n4);
                l += (long)n4;
            } else {
                int n5;
                int n6 = Math.min(nArrayArray[1 - n3].length, n4);
                for (n5 = 0; n5 < n6 && nArrayArray[0][n5] == nArrayArray[5][n5]; ++n5) {
                }
                nArray = BigArrays.grow(nArray, l + (long)IntArrayFrontCodedList.count(n4 -= n5) + (long)IntArrayFrontCodedList.count(n5) + (long)n4, l);
                l += (long)IntArrayFrontCodedList.writeInt(nArray, n4, l);
                l += (long)IntArrayFrontCodedList.writeInt(nArray, n5, l);
                BigArrays.copyToBig(nArrayArray[n3], n5, nArray, l, (long)n4);
                l += (long)n4;
            }
            n3 = 1 - n3;
            ++n2;
        ...
        this.n = n2;
        this.ratio = n;
        this.array = BigArrays.trim(nArray, l);
        this.p = LongArrays.trim((long[])lArray, (int)((n2 + n - 1) / n));
    }
    ...
    static int readInt(int[][] nArray, long l) {
        return BigArrays.get(nArray, l);
    }
    ...
    static int writeInt(int[][] nArray, int n, long l) {
        BigArrays.set(nArray, l, n);
        return 0;
    }
    ...
    private int extract(int n, int[] nArray, int n2, int n3) {
        ...
        if (n4 == 0) {
            ...
            BigArrays.copyFromBig(this.array, l2, nArray, n2, Math.min(n3, n5));
            return n5;
        }
        int n7 = 0;
        for (int i = 0; i < n4; ++i) {
            ...
            BigArrays.copyFromBig(this.array, l3, nArray, n6 + n2, n8 - n6);
            n6 = n8;
        }
        if (n6 < n3) {
            BigArrays.copyFromBig(this.array, l2 + (long)IntArrayFrontCodedList.count(n5) + (long)IntArrayFrontCodedList.count(n7), nArray, n6 + n2, Math.min(n5, n3 - n6));
        }
        return n5 + n7;
    }
        ...
        return new ObjectListIterator<int[]>(){
            ...
            public int[] next() {
                ...
                if (this.i % this.this$0.ratio == 0) {
                    ...
                    BigArrays.copyFromBig(this.this$0.array, this.pos + (long)IntArrayFrontCodedList.count(n), this.s, 0, n);
                    this.pos += (long)(n + IntArrayFrontCodedList.count(n));
                    this.inSync = true;
                } else if (this.inSync) {
                    n = IntArrayFrontCodedList.readInt(this.this$0.array, this.pos);
                    int n2 = IntArrayFrontCodedList.readInt(this.this$0.array, this.pos + (long)IntArrayFrontCodedList.count(n));
                    this.s = IntArrays.ensureCapacity(this.s, n + n2, n2);
                    BigArrays.copyFromBig(this.this$0.array, this.pos + (long)IntArrayFrontCodedList.count(n) + (long)IntArrayFrontCodedList.count(n2), this.s, n2, n);
                    this.pos += (long)(IntArrayFrontCodedList.count(n) + IntArrayFrontCodedList.count(n2) + n);
                    n += n2;
                } else {
                    n = IntArrayFrontCodedList.access$000(this.this$0, this.i);
                    this.s = IntArrays.ensureCapacity(this.s, n, 0);
    ...
    static int access$000(IntArrayFrontCodedList intArrayFrontCodedList, int n) {
        return intArrayFrontCodedList.length(n);
    }

    static int access$100(IntArrayFrontCodedList intArrayFrontCodedList, int n, int[] nArray, int n2, int n3) {
