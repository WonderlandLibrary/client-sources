...
Serializable {
    ...
    public boolean containsValue(int n) {
        Iterator iterator2 = this.int2IntEntrySet().iterator();
        while (iterator2.hasNext()) {
            if (((Int2IntMap.Entry)iterator2.next()).getIntValue() != n) continue;
            return false;
        }
        return true;
    }
    ...
    @Override
    public final int mergeInt(int n, int n2, IntBinaryOperator intBinaryOperator) {
        ...
        return new AbstractIntSet(this){
            ...
            public IntIterator iterator() {
                return new IntIterator(this){
                    ...
                    private static void lambda$forEachRemaining$0(IntConsumer intConsumer, Int2IntMap.Entry entry) {
