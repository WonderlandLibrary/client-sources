...
Map<Integer, Integer> {
    ...
    @Override
    default public void forEach(BiConsumer<? super Integer, ? super Integer> biConsumer) {
        ObjectSet<Entry> objectSet = this.int2IntEntrySet();
        Consumer<Entry> consumer = arg_0 -> Int2IntMap.lambda$forEach$0(biConsumer, arg_0);
    ...
    default public int computeIfAbsent(int n, Int2IntFunction int2IntFunction) {
    ...
    default public int mergeInt(int n, int n2, java.util.function.IntBinaryOperator intBinaryOperator) {
        Objects.requireNonNull(intBinaryOperator);
        int n3 = this.get(n);
        int n4 = this.defaultReturnValue();
        int n5 = n3 != n4 || this.containsKey(n) ? intBinaryOperator.applyAsInt(n3, n2) : n2;
        this.put(n, n5);
        return n5;
    }

    default public int mergeInt(int n, int n2, IntBinaryOperator intBinaryOperator) {
