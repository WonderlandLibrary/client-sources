...
public final class IntArrays {
    ...
    public static void parallelQuickSort(int[] nArray, int n, int n2, IntComparator intComparator) {
        ForkJoinPool forkJoinPool = IntArrays.getPool();
        if (n2 - n < 8192 || forkJoinPool.getParallelism() == 1) {
    ...
    public static void unstableSort(int[] nArray, int n, int n2) {
        if (n2 - n >= 2000) {
            IntArrays.radixSort(nArray, n, n2);
        } else {
            IntArrays.quickSort(nArray, n, n2);
        }
    }

    public static void unstableSort(int[] nArray) {
        IntArrays.unstableSort(nArray, 0, nArray.length);
    }

    public static void unstableSort(int[] nArray, int n, int n2, IntComparator intComparator) {
        IntArrays.quickSort(nArray, n, n2, intComparator);
    }

    public static void unstableSort(int[] nArray, IntComparator intComparator) {
        IntArrays.unstableSort(nArray, 0, nArray.length, intComparator);
    }
    ...
    public static void mergeSort(int[] nArray, int n, int n2, int[] nArray2) {
        ...
        if (nArray2 == null) {
            nArray2 = java.util.Arrays.copyOf(nArray, n2);
        }
        int n4 = n + n2 >>> 1;
    ...
    public static void mergeSort(int[] nArray, int n, int n2) {
        IntArrays.mergeSort(nArray, n, n2, (int[])null);
    }
    ...
    public static void mergeSort(int[] nArray, int n, int n2, IntComparator intComparator) {
        IntArrays.mergeSort(nArray, n, n2, intComparator, null);
    }
    ...
    public static void stableSort(int[] nArray, int n, int n2) {
        IntArrays.unstableSort(nArray, n, n2);
    }

    public static void stableSort(int[] nArray) {
        IntArrays.stableSort(nArray, 0, nArray.length);
    }

    public static void stableSort(int[] nArray, int n, int n2, IntComparator intComparator) {
        IntArrays.mergeSort(nArray, n, n2, intComparator);
    }

    public static void stableSort(int[] nArray, IntComparator intComparator) {
        IntArrays.stableSort(nArray, 0, nArray.length, intComparator);
    }
    ...
    public static void parallelRadixSort(int[] nArray, int n, int n2) {
        ForkJoinPool forkJoinPool = IntArrays.getPool();
        if (n2 - n < 1024 || forkJoinPool.getParallelism() == 1) {
            IntArrays.quickSort(nArray, n, n2);
            return;
        }
        int n3 = 3;
        ...
        int n4 = forkJoinPool.getParallelism();
        ExecutorCompletionService<Void> executorCompletionService = new ExecutorCompletionService<Void>(forkJoinPool);
        int n5 = n4;
        while (n5-- != 0) {
    ...
    public static void radixSortIndirect(int[] nArray, int[] nArray2, int n, int n2, boolean bl) {
        ...
        if (n2 - n < 1024) {
            IntArrays.quickSortIndirect(nArray, nArray2, n, n2);
            if (bl) {
                IntArrays.stabilize(nArray, nArray2, n, n2);
            }
            return;
        }
        int n3 = 3;
        ...
        while (n5 > 0) {
            ...
            if (bl) {
                ...
                for (n6 = 0; n6 <= n13; ++n6) {
                    if (n10 < 3 && nArray7[n6] > 1) {
                        if (nArray7[n6] < 1024) {
                            IntArrays.quickSortIndirect(nArray, nArray2, n7, n7 + nArray7[n6]);
                            if (bl) {
                                IntArrays.stabilize(nArray, nArray2, n7, n7 + nArray7[n6]);
                            }
                        } else {
                            nArray4[n5] = n7;
            ...
            for (n7 = n8; n7 <= n6; n7 += nArray7[n18]) {
                ...
                if (n10 < 3 && nArray7[n18] > 1) {
                    if (nArray7[n18] < 1024) {
                        IntArrays.quickSortIndirect(nArray, nArray2, n7, n7 + nArray7[n18]);
                        if (bl) {
                            IntArrays.stabilize(nArray, nArray2, n7, n7 + nArray7[n18]);
                        }
                    } else {
                        nArray4[n5] = n7;
        ...
        while (n6 > 0) {
            ...
            for (n15 = n8; n15 <= n7; n15 += nArray6[n16]) {
                ...
                if (n10 < 7 && nArray6[n16] > 1) {
                    if (nArray6[n16] < 1024) {
                        IntArrays.quickSort(nArray, nArray2, n15, n15 + nArray6[n16]);
                    } else {
                        nArray3[n6] = n15;
    ...
    public static void parallelRadixSort(int[] nArray, int[] nArray2, int n, int n2) {
        ...
        linkedBlockingQueue.add(new Segment(n, n2 - n, 0));
        AtomicInteger atomicInteger = new AtomicInteger(1);
        int n5 = forkJoinPool.getParallelism();
        ExecutorCompletionService<Void> executorCompletionService = new ExecutorCompletionService<Void>(forkJoinPool);
        int n6 = n5;
        while (n6-- != 0) {
