...
public final class ObjectArrays {
    ...
    public static <K> void parallelQuickSort(K[] KArray, int n, int n2, Comparator<K> comparator) {
        ForkJoinPool forkJoinPool = ObjectArrays.getPool();
    ...
    public static <K> void unstableSort(K[] KArray, int n, int n2) {
        ObjectArrays.quickSort(KArray, n, n2);
    }

    public static <K> void unstableSort(K[] KArray) {
        ObjectArrays.unstableSort(KArray, 0, KArray.length);
    }

    public static <K> void unstableSort(K[] KArray, int n, int n2, Comparator<K> comparator) {
        ObjectArrays.quickSort(KArray, n, n2, comparator);
    }

    public static <K> void unstableSort(K[] KArray, Comparator<K> comparator) {
        ObjectArrays.unstableSort(KArray, 0, KArray.length, comparator);
    }
    ...
    public static <K> void mergeSort(K[] KArray, int n, int n2, K[] KArray2) {
        ...
        if (KArray2 == null) {
            KArray2 = java.util.Arrays.copyOf(KArray, n2);
        }
        int n4 = n + n2 >>> 1;
    ...
    public static <K> void mergeSort(K[] KArray, int n, int n2) {
        ObjectArrays.mergeSort(KArray, n, n2, (Object[])null);
    }
    ...
    public static <K> void mergeSort(K[] KArray, int n, int n2, Comparator<K> comparator) {
        ObjectArrays.mergeSort(KArray, n, n2, comparator, null);
    }
    ...
    public static <K> void stableSort(K[] KArray, int n, int n2) {
        java.util.Arrays.sort(KArray, n, n2);
    }

    public static <K> void stableSort(K[] KArray) {
        ObjectArrays.stableSort(KArray, 0, KArray.length);
    }

    public static <K> void stableSort(K[] KArray, int n, int n2, Comparator<K> comparator) {
        java.util.Arrays.sort(KArray, n, n2, comparator);
    }

    public static <K> void stableSort(K[] KArray, Comparator<K> comparator) {
        ObjectArrays.stableSort(KArray, 0, KArray.length, comparator);
    }
