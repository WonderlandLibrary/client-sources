...
Hash {
    ...
    @SafeVarargs
    public static <K> ObjectLinkedOpenHashSet<K> of(K ... KArray) {
        ObjectLinkedOpenHashSet<K> objectLinkedOpenHashSet = new ObjectLinkedOpenHashSet<K>(KArray.length, 0.75f);
        for (K k : KArray) {
            if (objectLinkedOpenHashSet.add(k)) continue;
            throw new IllegalArgumentException("Duplicate element " + k);
        }
        return objectLinkedOpenHashSet;
    }

    private ObjectLinkedOpenHashSet<K> combine(ObjectLinkedOpenHashSet<? extends K> objectLinkedOpenHashSet) {
    ...
    public static <K> Collector<K, ?, ObjectLinkedOpenHashSet<K>> toSetWithExpectedSize(int n) {
        if (n <= 16) {
    ...
    private static ObjectLinkedOpenHashSet lambda$toSetWithExpectedSize$0(int n) {
    ...
    implements ObjectListIterator<K> {
        ...
        public void forEachRemaining(Consumer<? super K> consumer) {
            ...
            while (this.next != -1) {
                ...
                consumer.accept(KArray[this.curr]);
            }
        }
