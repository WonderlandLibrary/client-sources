...
extends Int2ObjectMap<V> {
    ...
    public static <V> @NonNull Int2ObjectSyncMap<V> hashmap(int n) {
        return Int2ObjectSyncMap.of(Int2ObjectOpenHashMap::new, n);
    }
    ...
    public static @NonNull IntSet hashset(int n) {
        return Int2ObjectSyncMap.setOf(Int2ObjectOpenHashMap::new, n);
    }

    public static <V> @NonNull Int2ObjectSyncMap<V> of(@NonNull IntFunction<Int2ObjectMap<ExpungingEntry<V>>> intFunction, int n) {
        return new Int2ObjectSyncMapImpl<V>(intFunction, n);
    }

    public static @NonNull IntSet setOf(@NonNull IntFunction<Int2ObjectMap<ExpungingEntry<Boolean>>> intFunction, int n) {
        return new Int2ObjectSyncMapSet(new Int2ObjectSyncMapImpl<Boolean>(intFunction, n));
    }
