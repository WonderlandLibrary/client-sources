...
public interface ViaBackwardsPlatform {
    ...
    public static final String IMPL_VERSION = "git-ViaBackwards-4.7.1-SNAPSHOT:4d4e7399";

    default public void init(File file) {
        ViaBackwardsConfig viaBackwardsConfig = new ViaBackwardsConfig(new File(file, "config.yml"));
    ...
    default public boolean isOutdated() {
        ...
        if (string != null && new Version(string).compareTo(new Version("4.7.0--")) < 0) {
            this.getLogger().severe("================================");
            this.getLogger().severe("YOUR VIAVERSION IS OUTDATED");
            this.getLogger().severe("PLEASE USE VIAVERSION 4.7.0 OR NEWER");
