...
public class EntityPackets1_13_2 {
    public static void register(Protocol1_13_1To1_13_2 protocol1_13_1To1_13_2) {
        protocol1_13_1To1_13_2.registerClientbound(ClientboundPackets1_13.SPAWN_MOB, new PacketHandlers(){
            ...
            private static void lambda$register$0(PacketWrapper packetWrapper) throws Exception {
                for (Metadata metadata : packetWrapper.get(Types1_13.METADATA_LIST, 0)) {
                    metadata.setMetaType(Types1_13.META_TYPES.byId(metadata.metaType().typeId()));
                }
            }
        });
        protocol1_13_1To1_13_2.registerClientbound(ClientboundPackets1_13.SPAWN_PLAYER, new PacketHandlers(){
        ...
        protocol1_13_1To1_13_2.registerClientbound(ClientboundPackets1_13.ENTITY_METADATA, new PacketHandlers(){
