...
extends RealmsScreen {
    ...
    public RealmsDownloadLatestWorldScreen(Screen screen, WorldDownload worldDownload, String string, BooleanConsumer booleanConsumer) {
        ...
        this.field_224182_h = new DownloadStatus(this);
    ...
    public void init() {
        ...
        this.field_224180_f = this.addButton(new Button(this.width / 2 - 100, this.height - 42, 200, 20, DialogTexts.GUI_CANCEL, this::lambda$init$0));
        this.func_224162_c();
    }
    ...
    private void func_224162_c() {
        if (!this.field_224188_n) {
            if (!this.field_224198_x && this.func_224152_a(this.field_224177_c.field_230643_a_) >= 0x140000000L) {
                ...
                TranslationTextComponent translationTextComponent2 = new TranslationTextComponent("mco.download.confirmation.line2");
                this.minecraft.displayGuiScreen(new RealmsLongConfirmationScreen(this::lambda$func_224162_c$1, RealmsLongConfirmationScreen.Type.Warning, translationTextComponent, translationTextComponent2, false));
            } else {
                this.func_224165_h();
            }
        }
    ...
    public void tick() {
        super.tick();
        ++this.field_224193_s;
        if (this.field_224184_j != null && this.field_224179_e.tryAcquire(0)) {
            ...
            String string = arrayList.stream().map(ITextComponent::getString).collect(Collectors.joining("\n"));
            RealmsNarratorHelper.func_239550_a_(string);
        }
    }
    ...
    private void func_237835_b_(MatrixStack matrixStack) {
        int n = this.font.getStringPropertyWidth(this.field_224184_j);
        if (this.field_224193_s % 10 == 0) {
            ++this.field_224195_u;
        }
        this.font.drawString(matrixStack, field_224194_t[this.field_224195_u % field_224194_t.length], this.width / 2 + n / 2 + 5, 50.0f, 0xFFFFFF);
    }
    ...
    private void func_237836_c_(MatrixStack matrixStack) {
        ...
        RealmsDownloadLatestWorldScreen.drawCenteredString(matrixStack, this.font, this.field_224185_k + " %", this.width / 2, 84, 0xFFFFFF);
    }

    private void func_237838_d_(MatrixStack matrixStack) {
        if (this.field_224193_s % 20 == 0) {
            if (this.field_224190_p != null) {
                long l = Util.milliTime() - this.field_224191_q;
                if (l == 0L) {
                    l = 1L;
                }
                this.field_224192_r = 1000L * (this.field_224182_h.field_225139_a - this.field_224190_p) / l;
                this.func_237833_a_(matrixStack, this.field_224192_r);
            }
    ...
    private void func_237833_a_(MatrixStack matrixStack, long l) {
        if (l > 0L) {
            int n = this.font.getStringWidth(this.field_224185_k);
    ...
    private void func_224165_h() {
        new Thread(this::lambda$func_224165_h$2).start();
    }
    ...
    private void lambda$func_224165_h$2() {
        try {
    ...
    private void lambda$func_224162_c$1(boolean bl) {
    ...
    public class DownloadStatus {
        ...
        public DownloadStatus(RealmsDownloadLatestWorldScreen realmsDownloadLatestWorldScreen) {
            this.this$0 = realmsDownloadLatestWorldScreen;
        }
    }
}
