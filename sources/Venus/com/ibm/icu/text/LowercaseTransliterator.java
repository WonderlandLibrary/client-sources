...
extends Transliterator {
        ...
        synchronized (lowercaseTransliterator) {
            if (this.sourceTargetUtility == null) {
                this.sourceTargetUtility = new SourceTargetUtility(new Transform<String, String>(this){
                    final LowercaseTransliterator this$0;
                    {
                        this.this$0 = lowercaseTransliterator;
                    }

                    @Override
                    public String transform(String string) {
                        return UCharacter.toLowerCase(LowercaseTransliterator.access$000(this.this$0), string);
                    }
    ...
    static ULocale access$000(LowercaseTransliterator lowercaseTransliterator) {
        return lowercaseTransliterator.locale;
    }
}
