...
public class LocaleIDs {
    ...
    public static String getISO3Country(String string) {
        int n = LocaleIDs.findIndex(_countries, string);
        if (n >= 0) {
            return _countries3[n];
        }
        n = LocaleIDs.findIndex(_obsoleteCountries, string);
        if (n >= 0) {
            return _obsoleteCountries3[n];
        }
        return "";
    }

    public static String getISO3Language(String string) {
        int n = LocaleIDs.findIndex(_languages, string);
        if (n >= 0) {
            return _languages3[n];
        }
        n = LocaleIDs.findIndex(_obsoleteLanguages, string);
        if (n >= 0) {
            return _obsoleteLanguages3[n];
        }
        return "";
    }

    public static String threeToTwoLetterLanguage(String string) {
        int n = LocaleIDs.findIndex(_languages3, string);
        if (n >= 0) {
            return _languages[n];
        }
        n = LocaleIDs.findIndex(_obsoleteLanguages3, string);
        if (n >= 0) {
            return _obsoleteLanguages[n];
        }
        return null;
    }

    public static String threeToTwoLetterRegion(String string) {
        int n = LocaleIDs.findIndex(_countries3, string);
        if (n >= 0) {
            return _countries[n];
        }
        n = LocaleIDs.findIndex(_obsoleteCountries3, string);
        if (n >= 0) {
            return _obsoleteCountries[n];
        }
        return null;
    }

    private static int findIndex(String[] stringArray, String string) {
    ...
    public static String getCurrentCountryID(String string) {
        int n = LocaleIDs.findIndex(_deprecatedCountries, string);
        if (n >= 0) {
            return _replacementCountries[n];
        }
        return string;
    }

    public static String getCurrentLanguageID(String string) {
        int n = LocaleIDs.findIndex(_obsoleteLanguages, string);
        if (n >= 0) {
            return _replacementLanguages[n];
        }
        return string;
    }
}
