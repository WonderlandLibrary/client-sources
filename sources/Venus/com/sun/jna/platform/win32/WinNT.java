...
BaseTSD {
    ...
    extends ACEStructure {
        ...
        public ACCESS_ACEStructure(Pointer pointer) {
            super(pointer);
            this.read();
            int n = this.AceSize - this.size() + 4;
            int n2 = 8;
            byte[] byArray = pointer.getByteArray(n2, n);
            this.psid = new PSID(byArray);
        }
    }
    ...
    extends Structure {
        ...
        public ACEStructure(Pointer pointer) {
            super(pointer);
        }
    ...
    extends Structure {
        ...
        public ACL(Pointer pointer) {
            ...
            for (int i = 0; i < this.AceCount; ++i) {
                Pointer pointer2 = pointer.share(n);
                byte by = pointer2.getByte(0L);
                ACCESS_ACEStructure aCCESS_ACEStructure = null;
                switch (by) {
                    case 0: {
                        aCCESS_ACEStructure = new ACCESS_ALLOWED_ACE(pointer2);
                        break;
                    }
                    case 1: {
                        aCCESS_ACEStructure = new ACCESS_DENIED_ACE(pointer2);
                        break;
                    }
                    default: {
                        throw new IllegalArgumentException("Unknwon ACE type " + by);
                    }
                }
                this.ACEs[i] = aCCESS_ACEStructure;
                n += aCCESS_ACEStructure.AceSize;
            }
        }
    ...
    extends Structure {
        ...
        public TOKEN_PRIVILEGES(int n) {
            this.PrivilegeCount = new WinDef.DWORD((long)n);
            this.Privileges = new LUID_AND_ATTRIBUTES[n];
        }
    }
    ...
    extends Structure {
        ...
        public byte[] getBytes() {
            int n = Advapi32.INSTANCE.GetLengthSid(this);
            return this.getPointer().getByteArray(0L, n);
        }
