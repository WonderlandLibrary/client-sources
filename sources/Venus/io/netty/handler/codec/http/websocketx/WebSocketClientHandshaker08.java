...
extends WebSocketClientHandshaker {
    ...
    protected FullHttpRequest newHandshakeRequest() {
        URI uRI = this.uri();
        String string = WebSocketClientHandshaker08.rawPath(uRI);
        ...
        httpHeaders.add((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_VERSION, (Object)"8");
