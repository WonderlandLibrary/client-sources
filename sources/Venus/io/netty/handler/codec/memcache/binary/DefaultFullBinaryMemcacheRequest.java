...
implements FullBinaryMemcacheRequest {
    ...
    @Override
    public FullBinaryMemcacheRequest retain(int n) {
        super.retain(n);
        return this;
    }
    ...
    @Override
    public FullBinaryMemcacheRequest touch(Object object) {
        super.touch(object);
    ...
    public FullBinaryMemcacheRequest copy() {
        ...
        return new DefaultFullBinaryMemcacheRequest(byteBuf2, byteBuf, this.content().copy());
    }
    ...
    public FullBinaryMemcacheRequest duplicate() {
        ...
        return new DefaultFullBinaryMemcacheRequest(byteBuf2, byteBuf, this.content().duplicate());
    }
    ...
    public FullBinaryMemcacheRequest replace(ByteBuf byteBuf) {
        ...
        return new DefaultFullBinaryMemcacheRequest(byteBuf3, byteBuf2, byteBuf);
    }
