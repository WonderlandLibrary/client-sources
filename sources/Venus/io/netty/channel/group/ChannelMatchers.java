...
public final class ChannelMatchers {
    ...
    public static ChannelMatcher compose(ChannelMatcher ... channelMatcherArray) {
        if (channelMatcherArray.length < 1) {
            throw new IllegalArgumentException("matchers must at least contain one element");
        }
        if (channelMatcherArray.length == 1) {
            return channelMatcherArray[0];
        }
    ...
    implements ChannelMatcher {
        ...
        CompositeMatcher(ChannelMatcher ... channelMatcherArray) {
            this.matchers = channelMatcherArray;
        }
