...
extends SimpleLeakAwareCompositeByteBuf {
    ...
    public CompositeByteBuf addComponents(ByteBuf ... byteBufArray) {
        AdvancedLeakAwareByteBuf.recordLeakNonRefCountingOperation(this.leak);
        return super.addComponents(byteBufArray);
    }
    ...
    public CompositeByteBuf addComponents(boolean bl, ByteBuf ... byteBufArray) {
        AdvancedLeakAwareByteBuf.recordLeakNonRefCountingOperation(this.leak);
        return super.addComponents(bl, byteBufArray);
    }
    ...
    public CompositeByteBuf addComponent(boolean bl, int n, ByteBuf byteBuf) {
        AdvancedLeakAwareByteBuf.recordLeakNonRefCountingOperation(this.leak);
        return super.addComponent(bl, n, byteBuf);
    }

    @Override
    public CompositeByteBuf removeComponent(int n) {
        AdvancedLeakAwareByteBuf.recordLeakNonRefCountingOperation(this.leak);
        return super.removeComponent(n);
    }

    @Override
    public CompositeByteBuf removeComponents(int n, int n2) {
        AdvancedLeakAwareByteBuf.recordLeakNonRefCountingOperation(this.leak);
        return super.removeComponents(n, n2);
    }
