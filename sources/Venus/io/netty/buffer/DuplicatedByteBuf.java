...
extends AbstractDerivedByteBuf {
    ...
    DuplicatedByteBuf(ByteBuf byteBuf, int n, int n2) {
        super(byteBuf.maxCapacity());
        this.buffer = byteBuf instanceof DuplicatedByteBuf ? ((DuplicatedByteBuf)byteBuf).buffer : (byteBuf instanceof AbstractPooledDerivedByteBuf ? byteBuf.unwrap() : byteBuf);
        this.setIndex(n, n2);
