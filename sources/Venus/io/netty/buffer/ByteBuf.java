...
Comparable<ByteBuf> {
    ...
    public float getFloatLE(int n) {
        return Float.intBitsToFloat(this.getIntLE(n));
    }

    public abstract double getDouble(int var1);

    public double getDoubleLE(int n) {
        return Double.longBitsToDouble(this.getLongLE(n));
    }
    ...
    public ByteBuf setFloatLE(int n, float f) {
        return this.setIntLE(n, Float.floatToRawIntBits(f));
    }

    public abstract ByteBuf setDouble(int var1, double var2);

    public ByteBuf setDoubleLE(int n, double d) {
        return this.setLongLE(n, Double.doubleToRawLongBits(d));
    }
    ...
    public ByteBuf writeDoubleLE(double d) {
        return this.writeLongLE(Double.doubleToRawLongBits(d));
    }
