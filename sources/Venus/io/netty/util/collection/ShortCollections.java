...
public final class ShortCollections {
    ...
    implements ShortObjectMap<V> {
        ...
        static ShortObjectMap access$100(UnmodifiableMap unmodifiableMap) {
        ...
        implements ShortObjectMap.PrimitiveEntry<V> {
            ...
            EntryImpl(UnmodifiableMap unmodifiableMap, ShortObjectMap.PrimitiveEntry<V> primitiveEntry) {
                this.this$0 = unmodifiableMap;
        ...
        implements Iterator<ShortObjectMap.PrimitiveEntry<V>> {
            ...
            IteratorImpl(UnmodifiableMap unmodifiableMap, Iterator<ShortObjectMap.PrimitiveEntry<V>> iterator2) {
                this.this$0 = unmodifiableMap;
                this.iter = iterator2;
            }
    ...
    implements ShortObjectMap<Object> {
        ...
        @Override
        public Object put(Object object, Object object2) {
            return this.put((Short)object, object2);
        }
