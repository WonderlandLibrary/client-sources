...
Serializable {
    ...
    @Override
    @Deprecated
    public StringBuilder format(Object object, StringBuilder stringBuilder, FieldPosition fieldPosition) {
        if (object instanceof Date) {
            return this.format((Date)object, stringBuilder);
        }
        if (object instanceof Calendar) {
            return this.format((Calendar)object, stringBuilder);
        }
        if (object instanceof Long) {
            return this.format((Long)object, stringBuilder);
        }
    ...
    private <B extends Appendable> B applyRules(Calendar calendar, B b) {
        try {
            ...
            Throwables.rethrow(iOException);
        }
        return b;
    }
