...
extends AbstractCaverphone {
    ...
    public String encode(String string) {
        ...
        string2 = string2.replaceAll("^trough", "trou2f");
        ...
        string2 = string2.replaceAll("^y", "A");
        string2 = string2.replaceAll("y", "3");
        ...
        string2 = string2.replaceAll("w$", "3");
