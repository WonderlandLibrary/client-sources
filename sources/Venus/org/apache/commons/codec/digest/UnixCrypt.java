...
public class UnixCrypt {
    ...
    public static String crypt(byte[] byArray) {
        return UnixCrypt.crypt(byArray, null);
    }
    ...
    public static String crypt(byte[] byArray, String string) {
        ...
        if (string == null) {
            ...
            c = SALT_CHARS.length;
            string = "" + SALT_CHARS[((Random)serializable).nextInt(c)] + SALT_CHARS[((Random)serializable).nextInt(c)];
        ...
        ((StringBuilder)serializable).setCharAt(0, c);
        ((StringBuilder)serializable).setCharAt(1, c2);
        int n2 = CON_SALT[c];
        int n3 = CON_SALT[c2] << 4;
        byte[] byArray2 = new byte[8];
        for (n = 0; n < byArray2.length; ++n) {
            byArray2[n] = 0;
        }
        for (n = 0; n < byArray2.length && n < byArray.length; ++n) {
            byte by = byArray[n];
            byArray2[n] = (byte)(by << 1);
        }
        int[] nArray = UnixCrypt.desSetKey(byArray2);
        int[] nArray2 = UnixCrypt.body(nArray, n2, n3);
        byte[] byArray3 = new byte[9];
        UnixCrypt.intToFourBytes(nArray2[0], byArray3, 0);
        UnixCrypt.intToFourBytes(nArray2[1], byArray3, 4);
        byArray3[8] = 0;
        int n4 = 0;
        int n5 = 128;
        for (int i = 2; i < 13; ++i) {
            ...
            for (int j = 0; j < 6; ++j) {
                ...
                ((StringBuilder)serializable).setCharAt(i, (char)COV2CHAR[n6]);
            }
        }
    ...
    public static String crypt(String string) {
        return UnixCrypt.crypt(string.getBytes(Charsets.UTF_8));
    }

    public static String crypt(String string, String string2) {
        return UnixCrypt.crypt(string.getBytes(Charsets.UTF_8), string2);
    }

    private static int[] body(int[] nArray, int n, int n2) {
        int n3 = 0;
        int n4 = 0;
        int n5 = 0;
        for (int i = 0; i < 25; ++i) {
            for (int j = 0; j < 32; j += 4) {
                n3 = UnixCrypt.dEncrypt(n3, n4, j, n, n2, nArray);
                n4 = UnixCrypt.dEncrypt(n4, n3, j + 2, n, n2, nArray);
            }
            n5 = n3;
            n3 = n4;
            n4 = n5;
        ...
        UnixCrypt.permOp(n4, n3, 1, 0x55555555, nArray2);
        n4 = nArray2[0];
        n3 = nArray2[1];
        UnixCrypt.permOp(n3, n4, 8, 0xFF00FF, nArray2);
        n3 = nArray2[0];
        n4 = nArray2[1];
        UnixCrypt.permOp(n4, n3, 2, 0x33333333, nArray2);
        n4 = nArray2[0];
        n3 = nArray2[1];
        UnixCrypt.permOp(n3, n4, 16, 65535, nArray2);
        n3 = nArray2[0];
        n4 = nArray2[1];
        UnixCrypt.permOp(n4, n3, 4, 0xF0F0F0F, nArray2);
        n4 = nArray2[0];
        n3 = nArray2[1];
    ...
    private static int byteToUnsigned(byte n) {
        int n2 = n;
        return n2 < 0 ? n2 + 256 : n2;
    }

    private static int dEncrypt(int n, int n2, int n3, int n4, int n5, int[] nArray) {
        int n6 = n2 ^ n2 >>> 16;
        int n7 = n6 & n4;
    ...
    private static int[] desSetKey(byte[] byArray) {
        int[] nArray = new int[32];
        int n = UnixCrypt.fourBytesToInt(byArray, 0);
        int n2 = UnixCrypt.fourBytesToInt(byArray, 4);
        int[] nArray2 = new int[2];
        UnixCrypt.permOp(n2, n, 4, 0xF0F0F0F, nArray2);
        n2 = nArray2[0];
        n = nArray2[1];
        n = UnixCrypt.hPermOp(n, -2, -859045888);
        n2 = UnixCrypt.hPermOp(n2, -2, -859045888);
        UnixCrypt.permOp(n2, n, 1, 0x55555555, nArray2);
        n2 = nArray2[0];
        n = nArray2[1];
        UnixCrypt.permOp(n, n2, 8, 0xFF00FF, nArray2);
        n = nArray2[0];
        n2 = nArray2[1];
        UnixCrypt.permOp(n2, n, 1, 0x55555555, nArray2);
        n2 = nArray2[0];
    ...
    private static int fourBytesToInt(byte[] byArray, int n) {
        int n2 = UnixCrypt.byteToUnsigned(byArray[n++]);
        n2 |= UnixCrypt.byteToUnsigned(byArray[n++]) << 8;
        n2 |= UnixCrypt.byteToUnsigned(byArray[n++]) << 16;
        return n2 |= UnixCrypt.byteToUnsigned(byArray[n++]) << 24;
    }

    private static int hPermOp(int n, int n2, int n3) {
        int n4 = (n << 16 - n2 ^ n) & n3;
        n = n ^ n4 ^ n4 >>> 16 - n2;
        return n;
    }

    private static void intToFourBytes(int n, byte[] byArray, int n2) {
    ...
    private static void permOp(int n, int n2, int n3, int n4, int[] nArray) {
        int n5 = (n >>> n3 ^ n2) & n4;
        nArray[0] = n ^= n5 << n3;
        nArray[1] = n2 ^= n5;
    }
