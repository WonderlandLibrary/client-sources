...
implements ZipExtraField {
    ...
    public void parseFromLocalFileData(byte[] byArray, int n, int n2) {
        this.localFileData = new byte[n2];
        System.arraycopy(byArray, n, this.localFileData, 0, n2);
    }

    public void parseFromCentralDirectoryData(byte[] byArray, int n, int n2) {
        this.centralDirectoryData = new byte[n2];
        System.arraycopy(byArray, n, this.centralDirectoryData, 0, n2);
