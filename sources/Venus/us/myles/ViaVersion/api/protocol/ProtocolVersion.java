...
public class ProtocolVersion {
    ...
    public static ProtocolVersion register(int n, String string) {
        return ProtocolVersion.register(n, -1, string);
    }

    public static ProtocolVersion register(int n, int n2, String string) {
        return ProtocolVersion.register(n, n2, string, null);
    }

    public static ProtocolVersion register(int n, String string, @Nullable VersionRange versionRange) {
        return ProtocolVersion.register(n, -1, string, versionRange);
    }

    public static ProtocolVersion register(int n, int n2, String string, @Nullable VersionRange versionRange) {
        ProtocolVersion protocolVersion = new ProtocolVersion(n, n2, string, versionRange);
    ...
    public static @NonNull ProtocolVersion getProtocol(int n) {
        ProtocolVersion protocolVersion = (ProtocolVersion)versions.get(n);
    ...
    public static @Nullable ProtocolVersion getClosest(String string) {
        for (ProtocolVersion protocolVersion : versions.values()) {
            String string2;
            String string3 = protocolVersion.getName();
            if (string3.equals(string)) {
                return protocolVersion;
            }
            if (!(protocolVersion.isVersionWildcard() ? (string2 = string3.substring(0, string3.length() - 2)).equals(string) || string.startsWith(string3.substring(0, string3.length() - 1)) : protocolVersion.isRange() && protocolVersion.getIncludedVersions().contains(string))) continue;
            return protocolVersion;
        }
        return null;
    }

    public ProtocolVersion(int n, String string) {
        this(n, -1, string, null);
    }

    public ProtocolVersion(int n, int n2, String string, @Nullable VersionRange versionRange) {
        this.version = n;
        this.snapshotVersion = n2;
        this.name = string;
        this.versionWildcard = string.endsWith(".x");
        ...
        if (versionRange != null) {
            ...
            this.includedVersions = Collections.singleton(string);
        }
    }
