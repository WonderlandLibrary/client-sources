...
Hash {
    ...
    public Byte2LongOpenCustomHashMap(int n, float f, ByteHash.Strategy strategy) {
    ...
    public Byte2LongOpenCustomHashMap(int n, ByteHash.Strategy strategy) {
    ...
    public Byte2LongOpenCustomHashMap(Map<? extends Byte, ? extends Long> map, float f, ByteHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Byte2LongOpenCustomHashMap(Map<? extends Byte, ? extends Long> map, ByteHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Byte2LongOpenCustomHashMap(Byte2LongMap byte2LongMap, float f, ByteHash.Strategy strategy) {
        this(byte2LongMap.size(), f, strategy);
        this.putAll(byte2LongMap);
    }

    public Byte2LongOpenCustomHashMap(Byte2LongMap byte2LongMap, ByteHash.Strategy strategy) {
        this(byte2LongMap, 0.75f, strategy);
    }

    public Byte2LongOpenCustomHashMap(byte[] byArray, long[] lArray, float f, ByteHash.Strategy strategy) {
    ...
    public Byte2LongOpenCustomHashMap(byte[] byArray, long[] lArray, ByteHash.Strategy strategy) {
        this(byArray, lArray, 0.75f, strategy);
    }
    ...
    public boolean remove(byte by, long l) {
        ...
        if (this.strategy.equals(by, by2) && l == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((by2 = byArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(by, by2) || l != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection(this){
                final Byte2LongOpenCustomHashMap this$0;
                {
                    this.this$0 = byte2LongOpenCustomHashMap;
                }
    ...
    public Byte2LongOpenCustomHashMap clone() {
        Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap;
        try {
            byte2LongOpenCustomHashMap = (Byte2LongOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2LongOpenCustomHashMap.keys = null;
        byte2LongOpenCustomHashMap.values = null;
        byte2LongOpenCustomHashMap.entries = null;
        byte2LongOpenCustomHashMap.containsNullKey = this.containsNullKey;
        byte2LongOpenCustomHashMap.key = (byte[])this.key.clone();
        byte2LongOpenCustomHashMap.value = (long[])this.value.clone();
        byte2LongOpenCustomHashMap.strategy = this.strategy;
        return byte2LongOpenCustomHashMap;
    }
    ...
    static long access$300(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap) {
        return byte2LongOpenCustomHashMap.removeNullEntry();
    }

    static long access$400(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap, int n) {
        return byte2LongOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements LongIterator {
        ...
        public ValueIterator(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap) {
            this.this$0 = byte2LongOpenCustomHashMap;
            super(byte2LongOpenCustomHashMap, null);
        }
    ...
    extends AbstractByteSet {
        ...
        private KeySet(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap) {
            this.this$0 = byte2LongOpenCustomHashMap;
        }
        ...
        KeySet(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap, 1 var2_2) {
            this(byte2LongOpenCustomHashMap);
        }
    }
    ...
    implements ByteIterator {
        ...
        public KeyIterator(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap) {
            this.this$0 = byte2LongOpenCustomHashMap;
            super(byte2LongOpenCustomHashMap, null);
        }
    ...
    implements Byte2LongMap.FastEntrySet {
        ...
        private MapEntrySet(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap) {
            this.this$0 = byte2LongOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(by, (byte)0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == l) {
                    Byte2LongOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(by2, by)) {
                if (this.this$0.value[n] == l) {
                    Byte2LongOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((by2 = byArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(by2, by) || this.this$0.value[n] != l);
            Byte2LongOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        public void forEach(Consumer<? super Byte2LongMap.Entry> consumer) {
            if (this.this$0.containsNullKey) {
                consumer.accept(new AbstractByte2LongMap.BasicEntry(this.this$0.key[this.this$0.n], this.this$0.value[this.this$0.n]));
            }
            int n = this.this$0.n;
            while (n-- != 0) {
                if (this.this$0.key[n] == 0) continue;
                consumer.accept(new AbstractByte2LongMap.BasicEntry(this.this$0.key[n], this.this$0.value[n]));
            }
        }
        ...
        MapEntrySet(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap, 1 var2_2) {
            this(byte2LongOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2LongMap.Entry> {
        ...
        private FastEntryIterator(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap) {
            this.this$0 = byte2LongOpenCustomHashMap;
            super(byte2LongOpenCustomHashMap, null);
        ...
        FastEntryIterator(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap, 1 var2_2) {
            this(byte2LongOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2LongMap.Entry> {
        ...
        private EntryIterator(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap) {
            this.this$0 = byte2LongOpenCustomHashMap;
            super(byte2LongOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap, 1 var2_2) {
            this(byte2LongOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap) {
            this.this$0 = byte2LongOpenCustomHashMap;
        ...
        MapIterator(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap, 1 var2_2) {
            this(byte2LongOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Byte, Long> {
        ...
        MapEntry(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap, int n) {
            this.this$0 = byte2LongOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Byte2LongOpenCustomHashMap byte2LongOpenCustomHashMap) {
            this.this$0 = byte2LongOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Byte)entry.getKey()) && this.this$0.value[this.index] == (Long)entry.getValue();
        }
