...
public final class Byte2CharSortedMaps {
    ...
    public static Comparator<? super Map.Entry<Byte, ?>> entryComparator(ByteComparator byteComparator) {
        return (arg_0, arg_1) -> Byte2CharSortedMaps.lambda$entryComparator$0(byteComparator, arg_0, arg_1);
    }

    public static ObjectBidirectionalIterator<Byte2CharMap.Entry> fastIterator(Byte2CharSortedMap byte2CharSortedMap) {
        ObjectSet objectSet = byte2CharSortedMap.byte2CharEntrySet();
        return objectSet instanceof Byte2CharSortedMap.FastSortedEntrySet ? ((Byte2CharSortedMap.FastSortedEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }

    public static ObjectBidirectionalIterable<Byte2CharMap.Entry> fastIterable(Byte2CharSortedMap byte2CharSortedMap) {
        ObjectSet objectSet = byte2CharSortedMap.byte2CharEntrySet();
        return objectSet instanceof Byte2CharSortedMap.FastSortedEntrySet ? ((Byte2CharSortedMap.FastSortedEntrySet)objectSet)::fastIterator : objectSet;
    }

    public static Byte2CharSortedMap singleton(Byte by, Character c) {
        return new Singleton(by, c.charValue());
    }

    public static Byte2CharSortedMap singleton(Byte by, Character c, ByteComparator byteComparator) {
        return new Singleton(by, c.charValue(), byteComparator);
    }

    public static Byte2CharSortedMap singleton(byte by, char c) {
        return new Singleton(by, c);
    }

    public static Byte2CharSortedMap singleton(byte by, char c, ByteComparator byteComparator) {
        return new Singleton(by, c, byteComparator);
    }

    public static Byte2CharSortedMap synchronize(Byte2CharSortedMap byte2CharSortedMap) {
        return new SynchronizedSortedMap(byte2CharSortedMap);
    }

    public static Byte2CharSortedMap synchronize(Byte2CharSortedMap byte2CharSortedMap, Object object) {
        return new SynchronizedSortedMap(byte2CharSortedMap, object);
    }

    public static Byte2CharSortedMap unmodifiable(Byte2CharSortedMap byte2CharSortedMap) {
        return new UnmodifiableSortedMap(byte2CharSortedMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableSortedMap(Byte2CharSortedMap byte2CharSortedMap) {
            super(byte2CharSortedMap);
            this.sortedMap = byte2CharSortedMap;
        }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Byte2CharSortedMap byte2CharSortedMap, Object object) {
            super(byte2CharSortedMap, object);
            this.sortedMap = byte2CharSortedMap;
        }

        protected SynchronizedSortedMap(Byte2CharSortedMap byte2CharSortedMap) {
            super(byte2CharSortedMap);
            this.sortedMap = byte2CharSortedMap;
        }
    ...
    Cloneable {
        ...
        protected Singleton(byte by, char c, ByteComparator byteComparator) {
            super(by, c);
