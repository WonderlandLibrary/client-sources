...
Hash {
    ...
    public Byte2ObjectOpenCustomHashMap(int n, float f, ByteHash.Strategy strategy) {
    ...
    public Byte2ObjectOpenCustomHashMap(int n, ByteHash.Strategy strategy) {
    ...
    public Byte2ObjectOpenCustomHashMap(Map<? extends Byte, ? extends V> map, float f, ByteHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Byte2ObjectOpenCustomHashMap(Map<? extends Byte, ? extends V> map, ByteHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Byte2ObjectOpenCustomHashMap(Byte2ObjectMap<V> byte2ObjectMap, float f, ByteHash.Strategy strategy) {
        this(byte2ObjectMap.size(), f, strategy);
        this.putAll(byte2ObjectMap);
    }

    public Byte2ObjectOpenCustomHashMap(Byte2ObjectMap<V> byte2ObjectMap, ByteHash.Strategy strategy) {
        this(byte2ObjectMap, 0.75f, strategy);
    }

    public Byte2ObjectOpenCustomHashMap(byte[] byArray, V[] VArray, float f, ByteHash.Strategy strategy) {
    ...
    public Byte2ObjectOpenCustomHashMap(byte[] byArray, V[] VArray, ByteHash.Strategy strategy) {
        this(byArray, VArray, 0.75f, strategy);
    }
    ...
    public boolean remove(byte by, Object object) {
        ...
        if (this.strategy.equals(by, by2) && Objects.equals(object, this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((by2 = byArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(by, by2) || !Objects.equals(object, this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public ObjectCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(this){
                final Byte2ObjectOpenCustomHashMap this$0;
                {
    ...
    public Byte2ObjectOpenCustomHashMap<V> clone() {
        Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap;
        try {
            byte2ObjectOpenCustomHashMap = (Byte2ObjectOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2ObjectOpenCustomHashMap.keys = null;
        byte2ObjectOpenCustomHashMap.values = null;
        byte2ObjectOpenCustomHashMap.entries = null;
        byte2ObjectOpenCustomHashMap.containsNullKey = this.containsNullKey;
        byte2ObjectOpenCustomHashMap.key = (byte[])this.key.clone();
        byte2ObjectOpenCustomHashMap.value = (Object[])this.value.clone();
        byte2ObjectOpenCustomHashMap.strategy = this.strategy;
        return byte2ObjectOpenCustomHashMap;
    }
    ...
    static Object access$300(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap) {
        return byte2ObjectOpenCustomHashMap.removeNullEntry();
    }

    static Object access$400(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap, int n) {
        return byte2ObjectOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap) {
            this.this$0 = byte2ObjectOpenCustomHashMap;
            super(byte2ObjectOpenCustomHashMap, null);
        }
    ...
    extends AbstractByteSet {
        ...
        private KeySet(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap) {
            this.this$0 = byte2ObjectOpenCustomHashMap;
        }
        ...
        KeySet(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap, 1 var2_2) {
            this(byte2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements ByteIterator {
        ...
        public KeyIterator(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap) {
            this.this$0 = byte2ObjectOpenCustomHashMap;
            super(byte2ObjectOpenCustomHashMap, null);
        }
    ...
    implements Byte2ObjectMap.FastEntrySet<V> {
        ...
        private MapEntrySet(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap) {
            this.this$0 = byte2ObjectOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(by, (byte)0)) {
                if (this.this$0.containsNullKey && Objects.equals(this.this$0.value[this.this$0.n], v)) {
                    Byte2ObjectOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(by2, by)) {
                if (Objects.equals(this.this$0.value[n], v)) {
                    Byte2ObjectOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((by2 = byArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(by2, by) || !Objects.equals(this.this$0.value[n], v));
            Byte2ObjectOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        public void forEach(Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
            if (this.this$0.containsNullKey) {
                consumer.accept(new AbstractByte2ObjectMap.BasicEntry(this.this$0.key[this.this$0.n], this.this$0.value[this.this$0.n]));
            }
            int n = this.this$0.n;
            while (n-- != 0) {
                if (this.this$0.key[n] == 0) continue;
                consumer.accept(new AbstractByte2ObjectMap.BasicEntry(this.this$0.key[n], this.this$0.value[n]));
            }
        }
        ...
        MapEntrySet(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap, 1 var2_2) {
            this(byte2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2ObjectMap.Entry<V>> {
        ...
        private FastEntryIterator(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap) {
            this.this$0 = byte2ObjectOpenCustomHashMap;
            super(byte2ObjectOpenCustomHashMap, null);
        ...
        FastEntryIterator(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap, 1 var2_2) {
            this(byte2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2ObjectMap.Entry<V>> {
        ...
        private EntryIterator(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap) {
            this.this$0 = byte2ObjectOpenCustomHashMap;
            super(byte2ObjectOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap, 1 var2_2) {
            this(byte2ObjectOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap) {
            this.this$0 = byte2ObjectOpenCustomHashMap;
        ...
        MapIterator(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap, 1 var2_2) {
            this(byte2ObjectOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Byte, V> {
        ...
        MapEntry(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap, int n) {
            this.this$0 = byte2ObjectOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Byte2ObjectOpenCustomHashMap byte2ObjectOpenCustomHashMap) {
            this.this$0 = byte2ObjectOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Byte)entry.getKey()) && Objects.equals(this.this$0.value[this.index], entry.getValue());
        }
