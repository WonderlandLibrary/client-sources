...
public final class Byte2ObjectMaps {
    ...
    public static <V> ObjectIterator<Byte2ObjectMap.Entry<V>> fastIterator(Byte2ObjectMap<V> byte2ObjectMap) {
        ObjectSet<Byte2ObjectMap.Entry<V>> objectSet = byte2ObjectMap.byte2ObjectEntrySet();
        return objectSet instanceof Byte2ObjectMap.FastEntrySet ? ((Byte2ObjectMap.FastEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }

    public static <V> void fastForEach(Byte2ObjectMap<V> byte2ObjectMap, Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
        ObjectSet<Byte2ObjectMap.Entry<V>> objectSet = byte2ObjectMap.byte2ObjectEntrySet();
        if (objectSet instanceof Byte2ObjectMap.FastEntrySet) {
            ((Byte2ObjectMap.FastEntrySet)objectSet).fastForEach(consumer);
        } else {
    ...
    public static <V> ObjectIterable<Byte2ObjectMap.Entry<V>> fastIterable(Byte2ObjectMap<V> byte2ObjectMap) {
        ObjectSet<Byte2ObjectMap.Entry<V>> objectSet = byte2ObjectMap.byte2ObjectEntrySet();
        return objectSet instanceof Byte2ObjectMap.FastEntrySet ? new ObjectIterable<Byte2ObjectMap.Entry<V>>(objectSet){
            ...
            public ObjectIterator<Byte2ObjectMap.Entry<V>> iterator() {
                return ((Byte2ObjectMap.FastEntrySet)this.val$entries).fastIterator();
            }

            @Override
            public void forEach(Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
                ((Byte2ObjectMap.FastEntrySet)this.val$entries).fastForEach(consumer);
            }
    ...
    public static <V> Byte2ObjectMap<V> singleton(byte by, V v) {
    ...
    public static <V> Byte2ObjectMap<V> synchronize(Byte2ObjectMap<V> byte2ObjectMap) {
        return new SynchronizedMap<V>(byte2ObjectMap);
    }

    public static <V> Byte2ObjectMap<V> synchronize(Byte2ObjectMap<V> byte2ObjectMap, Object object) {
        return new SynchronizedMap<V>(byte2ObjectMap, object);
    }

    public static <V> Byte2ObjectMap<V> unmodifiable(Byte2ObjectMap<V> byte2ObjectMap) {
        return new UnmodifiableMap<V>(byte2ObjectMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableMap(Byte2ObjectMap<V> byte2ObjectMap) {
        ...
        @Override
        public V computeIfAbsentPartial(byte by, Byte2ObjectFunction<? extends V> byte2ObjectFunction) {
            throw new UnsupportedOperationException();
        }
    ...
    Serializable {
        ...
        protected SynchronizedMap(Byte2ObjectMap<V> byte2ObjectMap, Object object) {
            super(byte2ObjectMap, object);
            this.map = byte2ObjectMap;
        }

        protected SynchronizedMap(Byte2ObjectMap<V> byte2ObjectMap) {
            super(byte2ObjectMap);
            this.map = byte2ObjectMap;
        }
        ...
        public V computeIfAbsentPartial(byte by, Byte2ObjectFunction<? extends V> byte2ObjectFunction) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.computeIfAbsentPartial(by, byte2ObjectFunction);
            }
        }
