...
Cloneable {
    ...
    public Byte2BooleanRBTreeMap(Comparator<? super Byte> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Byte2BooleanRBTreeMap(Map<? extends Byte, ? extends Boolean> map) {
        this();
        this.putAll(map);
    }

    public Byte2BooleanRBTreeMap(SortedMap<Byte, Boolean> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Byte, ? extends Boolean>)sortedMap);
    }

    public Byte2BooleanRBTreeMap(Byte2BooleanMap byte2BooleanMap) {
        this();
        this.putAll(byte2BooleanMap);
    }

    public Byte2BooleanRBTreeMap(Byte2BooleanSortedMap byte2BooleanSortedMap) {
        this(byte2BooleanSortedMap.comparator());
        this.putAll(byte2BooleanSortedMap);
    }

    public Byte2BooleanRBTreeMap(byte[] byArray, boolean[] blArray, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2BooleanRBTreeMap(byte[] byArray, boolean[] blArray) {
    ...
    public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2BooleanMap.Entry>(this){
                ...
                final Byte2BooleanRBTreeMap this$0;
                {
                    this.this$0 = byte2BooleanRBTreeMap;
    ...
    public Byte2BooleanRBTreeMap clone() {
        Byte2BooleanRBTreeMap byte2BooleanRBTreeMap;
        try {
            byte2BooleanRBTreeMap = (Byte2BooleanRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2BooleanRBTreeMap.keys = null;
        byte2BooleanRBTreeMap.values = null;
        byte2BooleanRBTreeMap.entries = null;
        byte2BooleanRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2BooleanRBTreeMap.firstEntry = byte2BooleanRBTreeMap.tree = entry2.left;
                            while (byte2BooleanRBTreeMap.firstEntry.left != null) {
                                byte2BooleanRBTreeMap.firstEntry = byte2BooleanRBTreeMap.firstEntry.left;
                            }
                            byte2BooleanRBTreeMap.lastEntry = byte2BooleanRBTreeMap.tree;
                            while (byte2BooleanRBTreeMap.lastEntry.right != null) {
                                byte2BooleanRBTreeMap.lastEntry = byte2BooleanRBTreeMap.lastEntry.right;
                            }
                            return byte2BooleanRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Byte2BooleanRBTreeMap byte2BooleanRBTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2BooleanRBTreeMap;
            if (!bl && !bl2 && byte2BooleanRBTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2BooleanRBTreeMap.defRetValue;
        }
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Byte2BooleanRBTreeMap byte2BooleanRBTreeMap) {
            this.this$0 = byte2BooleanRBTreeMap;
            super(byte2BooleanRBTreeMap);
        }
        ...
        ValueIterator(Byte2BooleanRBTreeMap byte2BooleanRBTreeMap, 1 var2_2) {
            this(byte2BooleanRBTreeMap);
        }
    }
    ...
    extends AbstractByte2BooleanSortedMap.KeySet {
        ...
        private KeySet(Byte2BooleanRBTreeMap byte2BooleanRBTreeMap) {
            this.this$0 = byte2BooleanRBTreeMap;
            super(byte2BooleanRBTreeMap);
        }
        ...
        KeySet(Byte2BooleanRBTreeMap byte2BooleanRBTreeMap, 1 var2_2) {
            this(byte2BooleanRBTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2BooleanRBTreeMap byte2BooleanRBTreeMap) {
            this.this$0 = byte2BooleanRBTreeMap;
            super(byte2BooleanRBTreeMap);
        }

        public KeyIterator(Byte2BooleanRBTreeMap byte2BooleanRBTreeMap, byte by) {
            this.this$0 = byte2BooleanRBTreeMap;
            super(byte2BooleanRBTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2BooleanMap.Entry> {
        ...
        EntryIterator(Byte2BooleanRBTreeMap byte2BooleanRBTreeMap) {
            this.this$0 = byte2BooleanRBTreeMap;
            super(byte2BooleanRBTreeMap);
        }

        EntryIterator(Byte2BooleanRBTreeMap byte2BooleanRBTreeMap, byte by) {
            this.this$0 = byte2BooleanRBTreeMap;
            super(byte2BooleanRBTreeMap, by);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2BooleanRBTreeMap byte2BooleanRBTreeMap) {
            this.this$0 = byte2BooleanRBTreeMap;
            this.index = 0;
            this.next = byte2BooleanRBTreeMap.firstEntry;
        }

        TreeIterator(Byte2BooleanRBTreeMap byte2BooleanRBTreeMap, byte by) {
            this.this$0 = byte2BooleanRBTreeMap;
            this.index = 0;
            this.next = byte2BooleanRBTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2BooleanRBTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
