...
Hash {
    ...
    public Byte2IntOpenCustomHashMap(int n, float f, ByteHash.Strategy strategy) {
    ...
    public Byte2IntOpenCustomHashMap(int n, ByteHash.Strategy strategy) {
    ...
    public Byte2IntOpenCustomHashMap(byte[] byArray, int[] nArray, float f, ByteHash.Strategy strategy) {
    ...
    public Byte2IntOpenCustomHashMap(byte[] byArray, int[] nArray, ByteHash.Strategy strategy) {
        this(byArray, nArray, 0.75f, strategy);
    }
    ...
    public int getOrDefault(byte by, int n) {
        ...
        byte[] byArray = this.key;
        int n2 = HashCommon.mix(this.strategy.hashCode(by)) & this.mask;
        byte by2 = byArray[n2];
        if (by2 == 0) {
            return n;
        }
    ...
    public boolean remove(byte by, int n) {
        ...
        if (this.strategy.equals(by, by2) && n == this.value[n2]) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if ((by2 = byArray[n2 = n2 + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(by, by2) || n != this.value[n2]);
        this.removeEntry(n2);
        return false;
    }
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection(this){
                final Byte2IntOpenCustomHashMap this$0;
                {
                    this.this$0 = byte2IntOpenCustomHashMap;
                }
    ...
    public Byte2IntOpenCustomHashMap clone() {
        Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap;
        try {
            byte2IntOpenCustomHashMap = (Byte2IntOpenCustomHashMap)super.clone();
    ...
    static int access$300(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap) {
        return byte2IntOpenCustomHashMap.removeNullEntry();
    }

    static int access$400(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap, int n) {
        return byte2IntOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements IntIterator {
        ...
        public ValueIterator(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap) {
            this.this$0 = byte2IntOpenCustomHashMap;
            super(byte2IntOpenCustomHashMap, null);
        }
    ...
    extends AbstractByteSet {
        ...
        private KeySet(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap) {
            this.this$0 = byte2IntOpenCustomHashMap;
        }
        ...
        KeySet(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap, 1 var2_2) {
            this(byte2IntOpenCustomHashMap);
        }
    }
    ...
    implements ByteIterator {
        ...
        public KeyIterator(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap) {
            this.this$0 = byte2IntOpenCustomHashMap;
            super(byte2IntOpenCustomHashMap, null);
        }
    ...
    implements Byte2IntMap.FastEntrySet {
        ...
        private MapEntrySet(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap) {
            this.this$0 = byte2IntOpenCustomHashMap;
        }
        ...
        public boolean contains(Object object) {
            ...
            int n2 = HashCommon.mix(this.this$0.strategy.hashCode(by)) & this.this$0.mask;
            byte by2 = byArray[n2];
            if (by2 == 0) {
                return true;
            }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(by, (byte)0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n) {
                    Byte2IntOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(by2, by)) {
                if (this.this$0.value[n2] == n) {
                    Byte2IntOpenCustomHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((by2 = byArray[n2 = n2 + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(by2, by) || this.this$0.value[n2] != n);
            Byte2IntOpenCustomHashMap.access$400(this.this$0, n2);
            return false;
        }
        ...
        public void forEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            if (this.this$0.containsNullKey) {
                consumer.accept(new AbstractByte2IntMap.BasicEntry(this.this$0.key[this.this$0.n], this.this$0.value[this.this$0.n]));
            }
            int n = this.this$0.n;
            while (n-- != 0) {
                if (this.this$0.key[n] == 0) continue;
                consumer.accept(new AbstractByte2IntMap.BasicEntry(this.this$0.key[n], this.this$0.value[n]));
            }
        }
        ...
        MapEntrySet(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap, 1 var2_2) {
            this(byte2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2IntMap.Entry> {
        ...
        private FastEntryIterator(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap) {
            this.this$0 = byte2IntOpenCustomHashMap;
            super(byte2IntOpenCustomHashMap, null);
        ...
        FastEntryIterator(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap, 1 var2_2) {
            this(byte2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2IntMap.Entry> {
        ...
        private EntryIterator(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap) {
            this.this$0 = byte2IntOpenCustomHashMap;
            super(byte2IntOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap, 1 var2_2) {
            this(byte2IntOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap) {
            this.this$0 = byte2IntOpenCustomHashMap;
        ...
        MapIterator(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap, 1 var2_2) {
            this(byte2IntOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Byte, Integer> {
        ...
        MapEntry(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap, int n) {
            this.this$0 = byte2IntOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Byte2IntOpenCustomHashMap byte2IntOpenCustomHashMap) {
            this.this$0 = byte2IntOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Byte)entry.getKey()) && this.this$0.value[this.index] == (Integer)entry.getValue();
        }
