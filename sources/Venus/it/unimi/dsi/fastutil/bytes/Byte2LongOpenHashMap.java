...
Hash {
    ...
    public Byte2LongOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Byte2LongOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Byte2LongOpenHashMap(byte[] byArray, long[] lArray, float f) {
    ...
    public Byte2LongOpenHashMap(byte[] byArray, long[] lArray) {
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection(this){
                final Byte2LongOpenHashMap this$0;
                {
                    this.this$0 = byte2LongOpenHashMap;
                }
    ...
    public Byte2LongOpenHashMap clone() {
        Byte2LongOpenHashMap byte2LongOpenHashMap;
        try {
            byte2LongOpenHashMap = (Byte2LongOpenHashMap)super.clone();
    ...
    static long access$300(Byte2LongOpenHashMap byte2LongOpenHashMap) {
        return byte2LongOpenHashMap.removeNullEntry();
    }

    static long access$400(Byte2LongOpenHashMap byte2LongOpenHashMap, int n) {
        return byte2LongOpenHashMap.removeEntry(n);
    }
    ...
    implements LongIterator {
        ...
        public ValueIterator(Byte2LongOpenHashMap byte2LongOpenHashMap) {
            this.this$0 = byte2LongOpenHashMap;
            super(byte2LongOpenHashMap, null);
        }
    ...
    extends AbstractByteSet {
        ...
        private KeySet(Byte2LongOpenHashMap byte2LongOpenHashMap) {
            this.this$0 = byte2LongOpenHashMap;
        }
        ...
        KeySet(Byte2LongOpenHashMap byte2LongOpenHashMap, 1 var2_2) {
            this(byte2LongOpenHashMap);
        }
    }
    ...
    implements ByteIterator {
        ...
        public KeyIterator(Byte2LongOpenHashMap byte2LongOpenHashMap) {
            this.this$0 = byte2LongOpenHashMap;
            super(byte2LongOpenHashMap, null);
        }
    ...
    implements Byte2LongMap.FastEntrySet {
        ...
        private MapEntrySet(Byte2LongOpenHashMap byte2LongOpenHashMap) {
            this.this$0 = byte2LongOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (by == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == l) {
                    Byte2LongOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (by2 == by) {
                if (this.this$0.value[n] == l) {
                    Byte2LongOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Byte2LongOpenHashMap byte2LongOpenHashMap, 1 var2_2) {
            this(byte2LongOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2LongMap.Entry> {
        ...
        private FastEntryIterator(Byte2LongOpenHashMap byte2LongOpenHashMap) {
            this.this$0 = byte2LongOpenHashMap;
            super(byte2LongOpenHashMap, null);
        ...
        FastEntryIterator(Byte2LongOpenHashMap byte2LongOpenHashMap, 1 var2_2) {
            this(byte2LongOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2LongMap.Entry> {
        ...
        private EntryIterator(Byte2LongOpenHashMap byte2LongOpenHashMap) {
            this.this$0 = byte2LongOpenHashMap;
            super(byte2LongOpenHashMap, null);
        }
        ...
        EntryIterator(Byte2LongOpenHashMap byte2LongOpenHashMap, 1 var2_2) {
            this(byte2LongOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Byte2LongOpenHashMap byte2LongOpenHashMap) {
            this.this$0 = byte2LongOpenHashMap;
        ...
        MapIterator(Byte2LongOpenHashMap byte2LongOpenHashMap, 1 var2_2) {
            this(byte2LongOpenHashMap);
        }
    }
    ...
    Map.Entry<Byte, Long> {
        ...
        MapEntry(Byte2LongOpenHashMap byte2LongOpenHashMap, int n) {
            this.this$0 = byte2LongOpenHashMap;
            this.index = n;
        }

        MapEntry(Byte2LongOpenHashMap byte2LongOpenHashMap) {
            this.this$0 = byte2LongOpenHashMap;
        }
