...
Hash {
    ...
    public Byte2ByteLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Byte2ByteLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Byte2ByteLinkedOpenHashMap(Map<? extends Byte, ? extends Byte> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Byte2ByteLinkedOpenHashMap(Map<? extends Byte, ? extends Byte> map) {
        this(map, 0.75f);
    }
    ...
    public Byte2ByteLinkedOpenHashMap(byte[] byArray, byte[] byArray2, float f) {
    ...
    public Byte2ByteLinkedOpenHashMap(byte[] byArray, byte[] byArray2) {
        this(byArray, byArray2, 0.75f);
    }
    ...
    public byte getAndMoveToFirst(byte by) {
        if (by == 0) {
            if (this.containsNullKey) {
    ...
    public byte getAndMoveToLast(byte by) {
        if (by == 0) {
            if (this.containsNullKey) {
    ...
    public byte putAndMoveToFirst(byte by, byte by2) {
        int n;
        if (by == 0) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
                return this.setValue(this.n, by2);
            }
            this.containsNullKey = true;
            n = this.n;
        } else {
    ...
    public byte putAndMoveToLast(byte by, byte by2) {
        int n;
        if (by == 0) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection(this){
                final Byte2ByteLinkedOpenHashMap this$0;
                {
    ...
    protected void rehash(int n) {
        ...
        while (n6-- != 0) {
            ...
            byArray3[n7] = byArray[n3];
            byArray4[n7] = byArray2[n3];
            if (n4 != -1) {
                int n8 = n5;
    ...
    public Byte2ByteLinkedOpenHashMap clone() {
        Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap;
        try {
            byte2ByteLinkedOpenHashMap = (Byte2ByteLinkedOpenHashMap)super.clone();
        ...
        byte2ByteLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        byte2ByteLinkedOpenHashMap.key = (byte[])this.key.clone();
        byte2ByteLinkedOpenHashMap.value = (byte[])this.value.clone();
        byte2ByteLinkedOpenHashMap.link = (long[])this.link.clone();
    ...
    @Override
    public ObjectSortedSet byte2ByteEntrySet() {
    ...
    static byte access$100(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap) {
        return byte2ByteLinkedOpenHashMap.removeNullEntry();
    }

    static byte access$200(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap, int n) {
        return byte2ByteLinkedOpenHashMap.removeEntry(n);
    }
    ...
    extends AbstractByteSortedSet {
        ...
        KeySet(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap, 1 var2_2) {
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap, byte by) {
            this.this$0 = byte2ByteLinkedOpenHashMap;
            super(byte2ByteLinkedOpenHashMap, by, null);
        }
    ...
    implements Byte2ByteSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap) {
            this.this$0 = byte2ByteLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (by == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == by2) {
                    Byte2ByteLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (by3 == by) {
                if (this.this$0.value[n] == by2) {
                    Byte2ByteLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((by3 = byArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (by3 != by || this.this$0.value[n] != by2);
            Byte2ByteLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Byte2ByteMap.Entry> iterator(Byte2ByteMap.Entry entry) {
        ...
        public ObjectListIterator<Byte2ByteMap.Entry> fastIterator(Byte2ByteMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Byte2ByteMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractByte2ByteMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Byte2ByteMap.Entry entry) {
        ...
        MapEntrySet(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap, 1 var2_2) {
            this(byte2ByteLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Byte2ByteMap.Entry> {
        ...
        public FastEntryIterator(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap) {
            this.this$0 = byte2ByteLinkedOpenHashMap;
            super(byte2ByteLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap, byte by) {
            this.this$0 = byte2ByteLinkedOpenHashMap;
            super(byte2ByteLinkedOpenHashMap, by, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Byte2ByteMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Byte2ByteMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Byte2ByteMap.Entry> {
        ...
        public EntryIterator(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap) {
            this.this$0 = byte2ByteLinkedOpenHashMap;
            super(byte2ByteLinkedOpenHashMap);
        }

        public EntryIterator(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap, byte by) {
            this.this$0 = byte2ByteLinkedOpenHashMap;
            super(byte2ByteLinkedOpenHashMap, by, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap) {
            this.this$0 = byte2ByteLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
        ...
        private MapIterator(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap, byte by) {
            this.this$0 = byte2ByteLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (by == 0) {
                if (byte2ByteLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)byte2ByteLinkedOpenHashMap.link[byte2ByteLinkedOpenHashMap.n];
                    this.prev = byte2ByteLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + by + " does not belong to this map.");
            }
            if (byte2ByteLinkedOpenHashMap.key[byte2ByteLinkedOpenHashMap.last] == by) {
                this.prev = byte2ByteLinkedOpenHashMap.last;
                this.index = byte2ByteLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(by) & byte2ByteLinkedOpenHashMap.mask;
            while (byte2ByteLinkedOpenHashMap.key[n] != 0) {
                if (byte2ByteLinkedOpenHashMap.key[n] == by) {
                    this.next = (int)byte2ByteLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & byte2ByteLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + by + " does not belong to this map.");
        }
        ...
        public void set(Byte2ByteMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Byte2ByteMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap, byte by, 1 var3_3) {
            this(byte2ByteLinkedOpenHashMap, by);
        }
    }
    ...
    Map.Entry<Byte, Byte> {
        ...
        MapEntry(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap, int n) {
            this.this$0 = byte2ByteLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Byte2ByteLinkedOpenHashMap byte2ByteLinkedOpenHashMap) {
            this.this$0 = byte2ByteLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.key[this.index] == (Byte)entry.getKey() && this.this$0.value[this.index] == (Byte)entry.getValue();
        }
