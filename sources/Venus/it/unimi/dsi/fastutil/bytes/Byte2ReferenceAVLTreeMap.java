...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Byte2ReferenceAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Byte2ReferenceAVLTreeMap(Comparator<? super Byte> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Byte2ReferenceAVLTreeMap(Map<? extends Byte, ? extends V> map) {
        this();
        this.putAll((Map<Byte, ? extends V>)map);
    }

    public Byte2ReferenceAVLTreeMap(SortedMap<Byte, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Byte, V>)sortedMap);
    }

    public Byte2ReferenceAVLTreeMap(Byte2ReferenceMap<? extends V> byte2ReferenceMap) {
        this();
        this.putAll(byte2ReferenceMap);
    }

    public Byte2ReferenceAVLTreeMap(Byte2ReferenceSortedMap<V> byte2ReferenceSortedMap) {
        this(byte2ReferenceSortedMap.comparator());
        this.putAll(byte2ReferenceSortedMap);
    }

    public Byte2ReferenceAVLTreeMap(byte[] byArray, V[] VArray, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2ReferenceAVLTreeMap(byte[] byArray, V[] VArray) {
    ...
    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>(this){
                final Comparator<? super Byte2ReferenceMap.Entry<V>> comparator;
                final Byte2ReferenceAVLTreeMap this$0;
                {
                    this.this$0 = byte2ReferenceAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> entry) {
                ...
                public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> entry, Byte2ReferenceMap.Entry<V> entry2) {
                    return this.this$0.subMap(entry.getByteKey(), entry2.getByteKey()).byte2ReferenceEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> entry) {
                    return this.this$0.headMap(entry.getByteKey()).byte2ReferenceEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> entry) {
                    return this.this$0.tailMap(entry.getByteKey()).byte2ReferenceEntrySet();
                }
                ...
                private int lambda$$0(Byte2ReferenceMap.Entry entry, Byte2ReferenceMap.Entry entry2) {
    ...
    public Byte2ReferenceAVLTreeMap<V> clone() {
        Byte2ReferenceAVLTreeMap byte2ReferenceAVLTreeMap;
        try {
            byte2ReferenceAVLTreeMap = (Byte2ReferenceAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2ReferenceAVLTreeMap.keys = null;
        byte2ReferenceAVLTreeMap.values = null;
        byte2ReferenceAVLTreeMap.entries = null;
        byte2ReferenceAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2ReferenceAVLTreeMap.tree = entry2.left;
                            byte2ReferenceAVLTreeMap.firstEntry = byte2ReferenceAVLTreeMap.tree;
                            while (byte2ReferenceAVLTreeMap.firstEntry.left != null) {
                                byte2ReferenceAVLTreeMap.firstEntry = byte2ReferenceAVLTreeMap.firstEntry.left;
                            }
                            byte2ReferenceAVLTreeMap.lastEntry = byte2ReferenceAVLTreeMap.tree;
                            while (byte2ReferenceAVLTreeMap.lastEntry.right != null) {
                                byte2ReferenceAVLTreeMap.lastEntry = byte2ReferenceAVLTreeMap.lastEntry.right;
                            }
                            return byte2ReferenceAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Byte2ReferenceAVLTreeMap byte2ReferenceAVLTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2ReferenceAVLTreeMap;
            if (!bl && !bl2 && byte2ReferenceAVLTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2ReferenceAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>(this){
                    ...
                    @Override
                    public Comparator<? super Byte2ReferenceMap.Entry<V>> comparator() {
                        return this.this$1.this$0.byte2ReferenceEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> entry, Byte2ReferenceMap.Entry<V> entry2) {
                        return this.this$1.subMap(entry.getByteKey(), entry2.getByteKey()).byte2ReferenceEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> entry) {
                        return this.this$1.headMap(entry.getByteKey()).byte2ReferenceEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> entry) {
                        return this.this$1.tailMap(entry.getByteKey()).byte2ReferenceEntrySet();
                    }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Byte2ReferenceAVLTreeMap byte2ReferenceAVLTreeMap) {
            this.this$0 = byte2ReferenceAVLTreeMap;
            super(byte2ReferenceAVLTreeMap);
        }
        ...
        ValueIterator(Byte2ReferenceAVLTreeMap byte2ReferenceAVLTreeMap, 1 var2_2) {
            this(byte2ReferenceAVLTreeMap);
        }
    }
    ...
    extends AbstractByte2ReferenceSortedMap.KeySet {
        ...
        private KeySet(Byte2ReferenceAVLTreeMap byte2ReferenceAVLTreeMap) {
            this.this$0 = byte2ReferenceAVLTreeMap;
            super(byte2ReferenceAVLTreeMap);
        }
        ...
        KeySet(Byte2ReferenceAVLTreeMap byte2ReferenceAVLTreeMap, 1 var2_2) {
            this(byte2ReferenceAVLTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2ReferenceAVLTreeMap byte2ReferenceAVLTreeMap) {
            this.this$0 = byte2ReferenceAVLTreeMap;
            super(byte2ReferenceAVLTreeMap);
        }

        public KeyIterator(Byte2ReferenceAVLTreeMap byte2ReferenceAVLTreeMap, byte by) {
            this.this$0 = byte2ReferenceAVLTreeMap;
            super(byte2ReferenceAVLTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> {
        ...
        EntryIterator(Byte2ReferenceAVLTreeMap byte2ReferenceAVLTreeMap) {
            this.this$0 = byte2ReferenceAVLTreeMap;
            super(byte2ReferenceAVLTreeMap);
        }

        EntryIterator(Byte2ReferenceAVLTreeMap byte2ReferenceAVLTreeMap, byte by) {
            this.this$0 = byte2ReferenceAVLTreeMap;
            super(byte2ReferenceAVLTreeMap, by);
        }
        ...
        public void add(Object object) {
            this.add((Byte2ReferenceMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Byte2ReferenceMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2ReferenceAVLTreeMap byte2ReferenceAVLTreeMap) {
            this.this$0 = byte2ReferenceAVLTreeMap;
            this.index = 0;
            this.next = byte2ReferenceAVLTreeMap.firstEntry;
        }

        TreeIterator(Byte2ReferenceAVLTreeMap byte2ReferenceAVLTreeMap, byte by) {
            this.this$0 = byte2ReferenceAVLTreeMap;
            this.index = 0;
            this.next = byte2ReferenceAVLTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2ReferenceAVLTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Byte)entry.getKey() && this.value == entry.getValue();
        }
