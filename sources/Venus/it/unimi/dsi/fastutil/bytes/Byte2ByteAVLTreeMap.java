...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Byte2ByteAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Byte2ByteAVLTreeMap(Comparator<? super Byte> comparator) {
        this();
    ...
    public Byte2ByteAVLTreeMap(SortedMap<Byte, Byte> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Byte, ? extends Byte>)sortedMap);
    }

    public Byte2ByteAVLTreeMap(Byte2ByteMap byte2ByteMap) {
        this();
        this.putAll(byte2ByteMap);
    }

    public Byte2ByteAVLTreeMap(Byte2ByteSortedMap byte2ByteSortedMap) {
        this(byte2ByteSortedMap.comparator());
        this.putAll(byte2ByteSortedMap);
    }

    public Byte2ByteAVLTreeMap(byte[] byArray, byte[] byArray2, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2ByteAVLTreeMap(byte[] byArray, byte[] byArray2) {
    ...
    public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ByteMap.Entry>(this){
                ...
                final Byte2ByteAVLTreeMap this$0;
                {
                    this.this$0 = byte2ByteAVLTreeMap;
    ...
    public Byte2ByteAVLTreeMap clone() {
        Byte2ByteAVLTreeMap byte2ByteAVLTreeMap;
        try {
            byte2ByteAVLTreeMap = (Byte2ByteAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2ByteAVLTreeMap.keys = null;
        byte2ByteAVLTreeMap.values = null;
        byte2ByteAVLTreeMap.entries = null;
        byte2ByteAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2ByteAVLTreeMap.firstEntry = byte2ByteAVLTreeMap.tree = entry2.left;
                            while (byte2ByteAVLTreeMap.firstEntry.left != null) {
                                byte2ByteAVLTreeMap.firstEntry = byte2ByteAVLTreeMap.firstEntry.left;
                            }
                            byte2ByteAVLTreeMap.lastEntry = byte2ByteAVLTreeMap.tree;
                            while (byte2ByteAVLTreeMap.lastEntry.right != null) {
                                byte2ByteAVLTreeMap.lastEntry = byte2ByteAVLTreeMap.lastEntry.right;
                            }
                            return byte2ByteAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Byte2ByteAVLTreeMap byte2ByteAVLTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2ByteAVLTreeMap;
            if (!bl && !bl2 && byte2ByteAVLTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2ByteAVLTreeMap.defRetValue;
        }
    ...
    implements ByteListIterator {
        ...
        private ValueIterator(Byte2ByteAVLTreeMap byte2ByteAVLTreeMap) {
            this.this$0 = byte2ByteAVLTreeMap;
            super(byte2ByteAVLTreeMap);
        }
        ...
        ValueIterator(Byte2ByteAVLTreeMap byte2ByteAVLTreeMap, 1 var2_2) {
            this(byte2ByteAVLTreeMap);
        }
    }
    ...
    extends AbstractByte2ByteSortedMap.KeySet {
        ...
        private KeySet(Byte2ByteAVLTreeMap byte2ByteAVLTreeMap) {
            this.this$0 = byte2ByteAVLTreeMap;
            super(byte2ByteAVLTreeMap);
        }
        ...
        KeySet(Byte2ByteAVLTreeMap byte2ByteAVLTreeMap, 1 var2_2) {
            this(byte2ByteAVLTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2ByteAVLTreeMap byte2ByteAVLTreeMap) {
            this.this$0 = byte2ByteAVLTreeMap;
            super(byte2ByteAVLTreeMap);
        }

        public KeyIterator(Byte2ByteAVLTreeMap byte2ByteAVLTreeMap, byte by) {
            this.this$0 = byte2ByteAVLTreeMap;
            super(byte2ByteAVLTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2ByteMap.Entry> {
        ...
        EntryIterator(Byte2ByteAVLTreeMap byte2ByteAVLTreeMap) {
            this.this$0 = byte2ByteAVLTreeMap;
            super(byte2ByteAVLTreeMap);
        }

        EntryIterator(Byte2ByteAVLTreeMap byte2ByteAVLTreeMap, byte by) {
            this.this$0 = byte2ByteAVLTreeMap;
            super(byte2ByteAVLTreeMap, by);
        }
        ...
        public void add(Object object) {
            this.add((Byte2ByteMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Byte2ByteMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2ByteAVLTreeMap byte2ByteAVLTreeMap) {
            this.this$0 = byte2ByteAVLTreeMap;
            this.index = 0;
            this.next = byte2ByteAVLTreeMap.firstEntry;
        }

        TreeIterator(Byte2ByteAVLTreeMap byte2ByteAVLTreeMap, byte by) {
            this.this$0 = byte2ByteAVLTreeMap;
            this.index = 0;
            this.next = byte2ByteAVLTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2ByteAVLTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
