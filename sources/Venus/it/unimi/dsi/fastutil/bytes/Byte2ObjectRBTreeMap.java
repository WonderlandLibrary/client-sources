...
Cloneable {
    ...
    public Byte2ObjectRBTreeMap(Comparator<? super Byte> comparator) {
        this();
    ...
    public Byte2ObjectRBTreeMap(SortedMap<Byte, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Byte, V>)sortedMap);
    }

    public Byte2ObjectRBTreeMap(Byte2ObjectMap<? extends V> byte2ObjectMap) {
        this();
        this.putAll(byte2ObjectMap);
    }

    public Byte2ObjectRBTreeMap(Byte2ObjectSortedMap<V> byte2ObjectSortedMap) {
        this(byte2ObjectSortedMap.comparator());
        this.putAll(byte2ObjectSortedMap);
    }

    public Byte2ObjectRBTreeMap(byte[] byArray, V[] VArray, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2ObjectRBTreeMap(byte[] byArray, V[] VArray) {
    ...
    public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ObjectMap.Entry<V>>(this){
                ...
                final Byte2ObjectRBTreeMap this$0;
                {
                    this.this$0 = byte2ObjectRBTreeMap;
    ...
    public Byte2ObjectRBTreeMap<V> clone() {
        Byte2ObjectRBTreeMap byte2ObjectRBTreeMap;
        try {
            byte2ObjectRBTreeMap = (Byte2ObjectRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2ObjectRBTreeMap.keys = null;
        byte2ObjectRBTreeMap.values = null;
        byte2ObjectRBTreeMap.entries = null;
        byte2ObjectRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2ObjectRBTreeMap.tree = entry2.left;
                            byte2ObjectRBTreeMap.firstEntry = byte2ObjectRBTreeMap.tree;
                            while (byte2ObjectRBTreeMap.firstEntry.left != null) {
                                byte2ObjectRBTreeMap.firstEntry = byte2ObjectRBTreeMap.firstEntry.left;
                            }
                            byte2ObjectRBTreeMap.lastEntry = byte2ObjectRBTreeMap.tree;
                            while (byte2ObjectRBTreeMap.lastEntry.right != null) {
                                byte2ObjectRBTreeMap.lastEntry = byte2ObjectRBTreeMap.lastEntry.right;
                            }
                            return byte2ObjectRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Byte2ObjectRBTreeMap byte2ObjectRBTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2ObjectRBTreeMap;
            if (!bl && !bl2 && byte2ObjectRBTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2ObjectRBTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Byte2ObjectRBTreeMap byte2ObjectRBTreeMap) {
            this.this$0 = byte2ObjectRBTreeMap;
            super(byte2ObjectRBTreeMap);
        }
        ...
        ValueIterator(Byte2ObjectRBTreeMap byte2ObjectRBTreeMap, 1 var2_2) {
            this(byte2ObjectRBTreeMap);
        }
    }
    ...
    extends AbstractByte2ObjectSortedMap.KeySet {
        ...
        private KeySet(Byte2ObjectRBTreeMap byte2ObjectRBTreeMap) {
            this.this$0 = byte2ObjectRBTreeMap;
            super(byte2ObjectRBTreeMap);
        }
        ...
        KeySet(Byte2ObjectRBTreeMap byte2ObjectRBTreeMap, 1 var2_2) {
            this(byte2ObjectRBTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2ObjectRBTreeMap byte2ObjectRBTreeMap) {
            this.this$0 = byte2ObjectRBTreeMap;
            super(byte2ObjectRBTreeMap);
        }

        public KeyIterator(Byte2ObjectRBTreeMap byte2ObjectRBTreeMap, byte by) {
            this.this$0 = byte2ObjectRBTreeMap;
            super(byte2ObjectRBTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2ObjectMap.Entry<V>> {
        ...
        EntryIterator(Byte2ObjectRBTreeMap byte2ObjectRBTreeMap) {
            this.this$0 = byte2ObjectRBTreeMap;
            super(byte2ObjectRBTreeMap);
        }

        EntryIterator(Byte2ObjectRBTreeMap byte2ObjectRBTreeMap, byte by) {
            this.this$0 = byte2ObjectRBTreeMap;
            super(byte2ObjectRBTreeMap, by);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2ObjectRBTreeMap byte2ObjectRBTreeMap) {
            this.this$0 = byte2ObjectRBTreeMap;
            this.index = 0;
            this.next = byte2ObjectRBTreeMap.firstEntry;
        }

        TreeIterator(Byte2ObjectRBTreeMap byte2ObjectRBTreeMap, byte by) {
            this.this$0 = byte2ObjectRBTreeMap;
            this.index = 0;
            this.next = byte2ObjectRBTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2ObjectRBTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
