...
Cloneable {
    ...
    public Byte2ReferenceRBTreeMap(Comparator<? super Byte> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Byte2ReferenceRBTreeMap(Map<? extends Byte, ? extends V> map) {
        this();
        this.putAll((Map<Byte, ? extends V>)map);
    }

    public Byte2ReferenceRBTreeMap(SortedMap<Byte, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Byte, V>)sortedMap);
    }

    public Byte2ReferenceRBTreeMap(Byte2ReferenceMap<? extends V> byte2ReferenceMap) {
        this();
        this.putAll(byte2ReferenceMap);
    }

    public Byte2ReferenceRBTreeMap(Byte2ReferenceSortedMap<V> byte2ReferenceSortedMap) {
        this(byte2ReferenceSortedMap.comparator());
        this.putAll(byte2ReferenceSortedMap);
    }

    public Byte2ReferenceRBTreeMap(byte[] byArray, V[] VArray, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2ReferenceRBTreeMap(byte[] byArray, V[] VArray) {
    ...
    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>(this){
                ...
                final Byte2ReferenceRBTreeMap this$0;
                {
                    this.this$0 = byte2ReferenceRBTreeMap;
    ...
    public Byte2ReferenceRBTreeMap<V> clone() {
        Byte2ReferenceRBTreeMap byte2ReferenceRBTreeMap;
        try {
            byte2ReferenceRBTreeMap = (Byte2ReferenceRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2ReferenceRBTreeMap.keys = null;
        byte2ReferenceRBTreeMap.values = null;
        byte2ReferenceRBTreeMap.entries = null;
        byte2ReferenceRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2ReferenceRBTreeMap.tree = entry2.left;
                            byte2ReferenceRBTreeMap.firstEntry = byte2ReferenceRBTreeMap.tree;
                            while (byte2ReferenceRBTreeMap.firstEntry.left != null) {
                                byte2ReferenceRBTreeMap.firstEntry = byte2ReferenceRBTreeMap.firstEntry.left;
                            }
                            byte2ReferenceRBTreeMap.lastEntry = byte2ReferenceRBTreeMap.tree;
                            while (byte2ReferenceRBTreeMap.lastEntry.right != null) {
                                byte2ReferenceRBTreeMap.lastEntry = byte2ReferenceRBTreeMap.lastEntry.right;
                            }
                            return byte2ReferenceRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Byte2ReferenceRBTreeMap byte2ReferenceRBTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2ReferenceRBTreeMap;
            if (!bl && !bl2 && byte2ReferenceRBTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2ReferenceRBTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Byte2ReferenceRBTreeMap byte2ReferenceRBTreeMap) {
            this.this$0 = byte2ReferenceRBTreeMap;
            super(byte2ReferenceRBTreeMap);
        }
        ...
        ValueIterator(Byte2ReferenceRBTreeMap byte2ReferenceRBTreeMap, 1 var2_2) {
            this(byte2ReferenceRBTreeMap);
        }
    }
    ...
    extends AbstractByte2ReferenceSortedMap.KeySet {
        ...
        private KeySet(Byte2ReferenceRBTreeMap byte2ReferenceRBTreeMap) {
            this.this$0 = byte2ReferenceRBTreeMap;
            super(byte2ReferenceRBTreeMap);
        }
        ...
        KeySet(Byte2ReferenceRBTreeMap byte2ReferenceRBTreeMap, 1 var2_2) {
            this(byte2ReferenceRBTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2ReferenceRBTreeMap byte2ReferenceRBTreeMap) {
            this.this$0 = byte2ReferenceRBTreeMap;
            super(byte2ReferenceRBTreeMap);
        }

        public KeyIterator(Byte2ReferenceRBTreeMap byte2ReferenceRBTreeMap, byte by) {
            this.this$0 = byte2ReferenceRBTreeMap;
            super(byte2ReferenceRBTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> {
        ...
        EntryIterator(Byte2ReferenceRBTreeMap byte2ReferenceRBTreeMap) {
            this.this$0 = byte2ReferenceRBTreeMap;
            super(byte2ReferenceRBTreeMap);
        }

        EntryIterator(Byte2ReferenceRBTreeMap byte2ReferenceRBTreeMap, byte by) {
            this.this$0 = byte2ReferenceRBTreeMap;
            super(byte2ReferenceRBTreeMap, by);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2ReferenceRBTreeMap byte2ReferenceRBTreeMap) {
            this.this$0 = byte2ReferenceRBTreeMap;
            this.index = 0;
            this.next = byte2ReferenceRBTreeMap.firstEntry;
        }

        TreeIterator(Byte2ReferenceRBTreeMap byte2ReferenceRBTreeMap, byte by) {
            this.this$0 = byte2ReferenceRBTreeMap;
            this.index = 0;
            this.next = byte2ReferenceRBTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2ReferenceRBTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
