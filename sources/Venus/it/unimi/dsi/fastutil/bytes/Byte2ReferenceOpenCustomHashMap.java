...
Hash {
    ...
    public Byte2ReferenceOpenCustomHashMap(int n, float f, ByteHash.Strategy strategy) {
    ...
    public Byte2ReferenceOpenCustomHashMap(int n, ByteHash.Strategy strategy) {
    ...
    public Byte2ReferenceOpenCustomHashMap(Map<? extends Byte, ? extends V> map, float f, ByteHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Byte2ReferenceOpenCustomHashMap(Map<? extends Byte, ? extends V> map, ByteHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Byte2ReferenceOpenCustomHashMap(Byte2ReferenceMap<V> byte2ReferenceMap, float f, ByteHash.Strategy strategy) {
        this(byte2ReferenceMap.size(), f, strategy);
        this.putAll(byte2ReferenceMap);
    }

    public Byte2ReferenceOpenCustomHashMap(Byte2ReferenceMap<V> byte2ReferenceMap, ByteHash.Strategy strategy) {
        this(byte2ReferenceMap, 0.75f, strategy);
    }

    public Byte2ReferenceOpenCustomHashMap(byte[] byArray, V[] VArray, float f, ByteHash.Strategy strategy) {
    ...
    public Byte2ReferenceOpenCustomHashMap(byte[] byArray, V[] VArray, ByteHash.Strategy strategy) {
    ...
    public boolean remove(byte by, Object object) {
        ...
        if (this.strategy.equals(by, by2) && object == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((by2 = byArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(by, by2) || object != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Byte2ReferenceOpenCustomHashMap this$0;
                {
                    this.this$0 = byte2ReferenceOpenCustomHashMap;
                }
    ...
    public Byte2ReferenceOpenCustomHashMap<V> clone() {
        Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap;
        try {
            byte2ReferenceOpenCustomHashMap = (Byte2ReferenceOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2ReferenceOpenCustomHashMap.keys = null;
        byte2ReferenceOpenCustomHashMap.values = null;
        byte2ReferenceOpenCustomHashMap.entries = null;
        byte2ReferenceOpenCustomHashMap.containsNullKey = this.containsNullKey;
        byte2ReferenceOpenCustomHashMap.key = (byte[])this.key.clone();
        byte2ReferenceOpenCustomHashMap.value = (Object[])this.value.clone();
        byte2ReferenceOpenCustomHashMap.strategy = this.strategy;
        return byte2ReferenceOpenCustomHashMap;
    }
    ...
    static Object access$300(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap) {
        return byte2ReferenceOpenCustomHashMap.removeNullEntry();
    }

    static Object access$400(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap, int n) {
        return byte2ReferenceOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap) {
            this.this$0 = byte2ReferenceOpenCustomHashMap;
            super(byte2ReferenceOpenCustomHashMap, null);
        }
    ...
    extends AbstractByteSet {
        ...
        private KeySet(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap) {
            this.this$0 = byte2ReferenceOpenCustomHashMap;
        }
        ...
        KeySet(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(byte2ReferenceOpenCustomHashMap);
        }
    }
    ...
    implements ByteIterator {
        ...
        public KeyIterator(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap) {
            this.this$0 = byte2ReferenceOpenCustomHashMap;
            super(byte2ReferenceOpenCustomHashMap, null);
        }
    ...
    implements Byte2ReferenceMap.FastEntrySet<V> {
        ...
        private MapEntrySet(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap) {
            this.this$0 = byte2ReferenceOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(by, (byte)0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Byte2ReferenceOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(by2, by)) {
                if (this.this$0.value[n] == v) {
                    Byte2ReferenceOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((by2 = byArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(by2, by) || this.this$0.value[n] != v);
            Byte2ReferenceOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(byte2ReferenceOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2ReferenceMap.Entry<V>> {
        ...
        private FastEntryIterator(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap) {
            this.this$0 = byte2ReferenceOpenCustomHashMap;
            super(byte2ReferenceOpenCustomHashMap, null);
        ...
        FastEntryIterator(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(byte2ReferenceOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2ReferenceMap.Entry<V>> {
        ...
        private EntryIterator(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap) {
            this.this$0 = byte2ReferenceOpenCustomHashMap;
            super(byte2ReferenceOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(byte2ReferenceOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap) {
            this.this$0 = byte2ReferenceOpenCustomHashMap;
        ...
        MapIterator(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(byte2ReferenceOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Byte, V> {
        ...
        MapEntry(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap, int n) {
            this.this$0 = byte2ReferenceOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Byte2ReferenceOpenCustomHashMap byte2ReferenceOpenCustomHashMap) {
            this.this$0 = byte2ReferenceOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Byte)entry.getKey()) && this.this$0.value[this.index] == entry.getValue();
        }
