...
Cloneable {
    ...
    public Byte2ShortRBTreeMap(Comparator<? super Byte> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Byte2ShortRBTreeMap(Map<? extends Byte, ? extends Short> map) {
        this();
        this.putAll(map);
    }

    public Byte2ShortRBTreeMap(SortedMap<Byte, Short> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Byte, ? extends Short>)sortedMap);
    }

    public Byte2ShortRBTreeMap(Byte2ShortMap byte2ShortMap) {
        this();
        this.putAll(byte2ShortMap);
    }

    public Byte2ShortRBTreeMap(Byte2ShortSortedMap byte2ShortSortedMap) {
        this(byte2ShortSortedMap.comparator());
        this.putAll(byte2ShortSortedMap);
    }

    public Byte2ShortRBTreeMap(byte[] byArray, short[] sArray, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2ShortRBTreeMap(byte[] byArray, short[] sArray) {
    ...
    public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ShortMap.Entry>(this){
                ...
                final Byte2ShortRBTreeMap this$0;
                {
                    this.this$0 = byte2ShortRBTreeMap;
    ...
    public Byte2ShortRBTreeMap clone() {
        Byte2ShortRBTreeMap byte2ShortRBTreeMap;
        try {
            byte2ShortRBTreeMap = (Byte2ShortRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2ShortRBTreeMap.keys = null;
        byte2ShortRBTreeMap.values = null;
        byte2ShortRBTreeMap.entries = null;
        byte2ShortRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2ShortRBTreeMap.firstEntry = byte2ShortRBTreeMap.tree = entry2.left;
                            while (byte2ShortRBTreeMap.firstEntry.left != null) {
                                byte2ShortRBTreeMap.firstEntry = byte2ShortRBTreeMap.firstEntry.left;
                            }
                            byte2ShortRBTreeMap.lastEntry = byte2ShortRBTreeMap.tree;
                            while (byte2ShortRBTreeMap.lastEntry.right != null) {
                                byte2ShortRBTreeMap.lastEntry = byte2ShortRBTreeMap.lastEntry.right;
                            }
                            return byte2ShortRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Byte2ShortRBTreeMap byte2ShortRBTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2ShortRBTreeMap;
            if (!bl && !bl2 && byte2ShortRBTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2ShortRBTreeMap.defRetValue;
        }
    ...
    implements ShortListIterator {
        ...
        private ValueIterator(Byte2ShortRBTreeMap byte2ShortRBTreeMap) {
            this.this$0 = byte2ShortRBTreeMap;
            super(byte2ShortRBTreeMap);
        }
        ...
        ValueIterator(Byte2ShortRBTreeMap byte2ShortRBTreeMap, 1 var2_2) {
            this(byte2ShortRBTreeMap);
        }
    }
    ...
    extends AbstractByte2ShortSortedMap.KeySet {
        ...
        private KeySet(Byte2ShortRBTreeMap byte2ShortRBTreeMap) {
            this.this$0 = byte2ShortRBTreeMap;
            super(byte2ShortRBTreeMap);
        }
        ...
        KeySet(Byte2ShortRBTreeMap byte2ShortRBTreeMap, 1 var2_2) {
            this(byte2ShortRBTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2ShortRBTreeMap byte2ShortRBTreeMap) {
            this.this$0 = byte2ShortRBTreeMap;
            super(byte2ShortRBTreeMap);
        }

        public KeyIterator(Byte2ShortRBTreeMap byte2ShortRBTreeMap, byte by) {
            this.this$0 = byte2ShortRBTreeMap;
            super(byte2ShortRBTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2ShortMap.Entry> {
        ...
        EntryIterator(Byte2ShortRBTreeMap byte2ShortRBTreeMap) {
            this.this$0 = byte2ShortRBTreeMap;
            super(byte2ShortRBTreeMap);
        }

        EntryIterator(Byte2ShortRBTreeMap byte2ShortRBTreeMap, byte by) {
            this.this$0 = byte2ShortRBTreeMap;
            super(byte2ShortRBTreeMap, by);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2ShortRBTreeMap byte2ShortRBTreeMap) {
            this.this$0 = byte2ShortRBTreeMap;
            this.index = 0;
            this.next = byte2ShortRBTreeMap.firstEntry;
        }

        TreeIterator(Byte2ShortRBTreeMap byte2ShortRBTreeMap, byte by) {
            this.this$0 = byte2ShortRBTreeMap;
            this.index = 0;
            this.next = byte2ShortRBTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2ShortRBTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
