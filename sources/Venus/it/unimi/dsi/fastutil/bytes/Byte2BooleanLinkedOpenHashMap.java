...
Hash {
    ...
    public Byte2BooleanLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Byte2BooleanLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Byte2BooleanLinkedOpenHashMap(byte[] byArray, boolean[] blArray, float f) {
    ...
    public Byte2BooleanLinkedOpenHashMap(byte[] byArray, boolean[] blArray) {
        this(byArray, blArray, 0.75f);
    }
    ...
    public boolean getAndMoveToFirst(byte by) {
        if (by == 0) {
            if (this.containsNullKey) {
    ...
    public boolean getAndMoveToLast(byte by) {
        if (by == 0) {
            if (this.containsNullKey) {
    ...
    public boolean putAndMoveToFirst(byte by, boolean bl) {
        int n;
        if (by == 0) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public boolean putAndMoveToLast(byte by, boolean bl) {
        int n;
        if (by == 0) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public BooleanCollection values() {
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(this){
                final Byte2BooleanLinkedOpenHashMap this$0;
                {
                    this.this$0 = byte2BooleanLinkedOpenHashMap;
                }
    ...
    public Byte2BooleanLinkedOpenHashMap clone() {
        Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap;
        try {
            byte2BooleanLinkedOpenHashMap = (Byte2BooleanLinkedOpenHashMap)super.clone();
        ...
        byte2BooleanLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        byte2BooleanLinkedOpenHashMap.key = (byte[])this.key.clone();
        byte2BooleanLinkedOpenHashMap.value = (boolean[])this.value.clone();
        byte2BooleanLinkedOpenHashMap.link = (long[])this.link.clone();
    ...
    @Override
    public ObjectSortedSet byte2BooleanEntrySet() {
    ...
    static boolean access$100(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap) {
        return byte2BooleanLinkedOpenHashMap.removeNullEntry();
    }

    static boolean access$200(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap, int n) {
        return byte2BooleanLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements BooleanListIterator {
        ...
        public ValueIterator(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap) {
            this.this$0 = byte2BooleanLinkedOpenHashMap;
            super(byte2BooleanLinkedOpenHashMap);
        }
    ...
    extends AbstractByteSortedSet {
        ...
        private KeySet(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap) {
            this.this$0 = byte2BooleanLinkedOpenHashMap;
        }
        ...
        KeySet(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap, 1 var2_2) {
            this(byte2BooleanLinkedOpenHashMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap, byte by) {
            this.this$0 = byte2BooleanLinkedOpenHashMap;
            super(byte2BooleanLinkedOpenHashMap, by, null);
        }
        ...
        public KeyIterator(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap) {
            this.this$0 = byte2BooleanLinkedOpenHashMap;
            super(byte2BooleanLinkedOpenHashMap);
        }
    ...
    implements Byte2BooleanSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap) {
            this.this$0 = byte2BooleanLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (by == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == bl) {
                    Byte2BooleanLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (by2 == by) {
                if (this.this$0.value[n] == bl) {
                    Byte2BooleanLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((by2 = byArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (by2 != by || this.this$0.value[n] != bl);
            Byte2BooleanLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Byte2BooleanMap.Entry> iterator(Byte2BooleanMap.Entry entry) {
        ...
        public ObjectListIterator<Byte2BooleanMap.Entry> fastIterator(Byte2BooleanMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Byte2BooleanMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractByte2BooleanMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Byte2BooleanMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Byte2BooleanMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Byte2BooleanMap.Entry)object, (Byte2BooleanMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Byte2BooleanMap.Entry)object);
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Byte2BooleanMap.Entry entry) {
        ...
        MapEntrySet(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap, 1 var2_2) {
            this(byte2BooleanLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Byte2BooleanMap.Entry> {
        ...
        public FastEntryIterator(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap) {
            this.this$0 = byte2BooleanLinkedOpenHashMap;
            super(byte2BooleanLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap, byte by) {
            this.this$0 = byte2BooleanLinkedOpenHashMap;
            super(byte2BooleanLinkedOpenHashMap, by, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Byte2BooleanMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Byte2BooleanMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Byte2BooleanMap.Entry> {
        ...
        public EntryIterator(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap) {
            this.this$0 = byte2BooleanLinkedOpenHashMap;
            super(byte2BooleanLinkedOpenHashMap);
        }

        public EntryIterator(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap, byte by) {
            this.this$0 = byte2BooleanLinkedOpenHashMap;
            super(byte2BooleanLinkedOpenHashMap, by, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap) {
            this.this$0 = byte2BooleanLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = byte2BooleanLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap, byte by) {
            this.this$0 = byte2BooleanLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (by == 0) {
                if (byte2BooleanLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)byte2BooleanLinkedOpenHashMap.link[byte2BooleanLinkedOpenHashMap.n];
                    this.prev = byte2BooleanLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + by + " does not belong to this map.");
            }
            if (byte2BooleanLinkedOpenHashMap.key[byte2BooleanLinkedOpenHashMap.last] == by) {
                this.prev = byte2BooleanLinkedOpenHashMap.last;
                this.index = byte2BooleanLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(by) & byte2BooleanLinkedOpenHashMap.mask;
            while (byte2BooleanLinkedOpenHashMap.key[n] != 0) {
                if (byte2BooleanLinkedOpenHashMap.key[n] == by) {
                    this.next = (int)byte2BooleanLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & byte2BooleanLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + by + " does not belong to this map.");
        }
        ...
        MapIterator(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap, byte by, 1 var3_3) {
            this(byte2BooleanLinkedOpenHashMap, by);
        }
    }
    ...
    Map.Entry<Byte, Boolean> {
        ...
        MapEntry(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap, int n) {
            this.this$0 = byte2BooleanLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Byte2BooleanLinkedOpenHashMap byte2BooleanLinkedOpenHashMap) {
            this.this$0 = byte2BooleanLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.key[this.index] == (Byte)entry.getKey() && this.this$0.value[this.index] == (Boolean)entry.getValue();
        }
