...
Hash {
    ...
    public Byte2ObjectLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Byte2ObjectLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Byte2ObjectLinkedOpenHashMap(Map<? extends Byte, ? extends V> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Byte2ObjectLinkedOpenHashMap(Map<? extends Byte, ? extends V> map) {
        this(map, 0.75f);
    }

    public Byte2ObjectLinkedOpenHashMap(Byte2ObjectMap<V> byte2ObjectMap, float f) {
        this(byte2ObjectMap.size(), f);
        this.putAll(byte2ObjectMap);
    }

    public Byte2ObjectLinkedOpenHashMap(Byte2ObjectMap<V> byte2ObjectMap) {
        this(byte2ObjectMap, 0.75f);
    }

    public Byte2ObjectLinkedOpenHashMap(byte[] byArray, V[] VArray, float f) {
    ...
    public Byte2ObjectLinkedOpenHashMap(byte[] byArray, V[] VArray) {
    ...
    public boolean containsValue(Object object) {
        ...
        int n = this.n;
        while (n-- != 0) {
            if (byArray[n] == 0 || !Objects.equals(VArray[n], object)) continue;
            return false;
        }
        return true;
    }
    ...
    public boolean remove(byte by, Object object) {
        ...
        if (by == by2 && Objects.equals(object, this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((by2 = byArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (by != by2 || !Objects.equals(object, this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public ObjectCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(this){
                final Byte2ObjectLinkedOpenHashMap this$0;
                {
    ...
    public Byte2ObjectLinkedOpenHashMap<V> clone() {
        Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap;
        try {
            byte2ObjectLinkedOpenHashMap = (Byte2ObjectLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2ObjectLinkedOpenHashMap.keys = null;
        byte2ObjectLinkedOpenHashMap.values = null;
        byte2ObjectLinkedOpenHashMap.entries = null;
        byte2ObjectLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        byte2ObjectLinkedOpenHashMap.key = (byte[])this.key.clone();
        byte2ObjectLinkedOpenHashMap.value = (Object[])this.value.clone();
        byte2ObjectLinkedOpenHashMap.link = (long[])this.link.clone();
        return byte2ObjectLinkedOpenHashMap;
    }
    ...
    static Object access$100(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap) {
        return byte2ObjectLinkedOpenHashMap.removeNullEntry();
    }

    static Object access$200(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap, int n) {
        return byte2ObjectLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectListIterator<V> {
        ...
        public ValueIterator(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap) {
            this.this$0 = byte2ObjectLinkedOpenHashMap;
    ...
    extends AbstractByteSortedSet {
        ...
        private KeySet(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap) {
            this.this$0 = byte2ObjectLinkedOpenHashMap;
        }
        ...
        KeySet(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap, 1 var2_2) {
            this(byte2ObjectLinkedOpenHashMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap, byte by) {
            this.this$0 = byte2ObjectLinkedOpenHashMap;
            super(byte2ObjectLinkedOpenHashMap, by, null);
        }
        ...
        public KeyIterator(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap) {
            this.this$0 = byte2ObjectLinkedOpenHashMap;
            super(byte2ObjectLinkedOpenHashMap);
        }
    ...
    implements Byte2ObjectSortedMap.FastSortedEntrySet<V> {
        ...
        private MapEntrySet(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap) {
            this.this$0 = byte2ObjectLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (by == 0) {
                if (this.this$0.containsNullKey && Objects.equals(this.this$0.value[this.this$0.n], v)) {
                    Byte2ObjectLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (by2 == by) {
                if (Objects.equals(this.this$0.value[n], v)) {
                    Byte2ObjectLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((by2 = byArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (by2 != by || !Objects.equals(this.this$0.value[n], v));
            Byte2ObjectLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> entry) {
        ...
        @Override
        public ObjectListIterator<Byte2ObjectMap.Entry<V>> fastIterator(Byte2ObjectMap.Entry<V> entry) {
        ...
        public void forEach(Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractByte2ObjectMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }

        @Override
        public void fastForEach(Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
            AbstractByte2ObjectMap.BasicEntry basicEntry = new AbstractByte2ObjectMap.BasicEntry();
            int n = this.this$0.size;
            int n2 = this.this$0.first;
            while (n-- != 0) {
                int n3 = n2;
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Byte2ObjectMap.Entry entry) {
        ...
        MapEntrySet(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap, 1 var2_2) {
            this(byte2ObjectLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Byte2ObjectMap.Entry<V>> {
        ...
        public FastEntryIterator(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap) {
            this.this$0 = byte2ObjectLinkedOpenHashMap;
            super(byte2ObjectLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap, byte by) {
            this.this$0 = byte2ObjectLinkedOpenHashMap;
            super(byte2ObjectLinkedOpenHashMap, by, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Byte2ObjectMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Byte2ObjectMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Byte2ObjectMap.Entry<V>> {
        ...
        public EntryIterator(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap) {
            this.this$0 = byte2ObjectLinkedOpenHashMap;
            super(byte2ObjectLinkedOpenHashMap);
        }

        public EntryIterator(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap, byte by) {
            this.this$0 = byte2ObjectLinkedOpenHashMap;
            super(byte2ObjectLinkedOpenHashMap, by, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap) {
            this.this$0 = byte2ObjectLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = byte2ObjectLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap, byte by) {
            this.this$0 = byte2ObjectLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (by == 0) {
                if (byte2ObjectLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)byte2ObjectLinkedOpenHashMap.link[byte2ObjectLinkedOpenHashMap.n];
                    this.prev = byte2ObjectLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + by + " does not belong to this map.");
            }
            if (byte2ObjectLinkedOpenHashMap.key[byte2ObjectLinkedOpenHashMap.last] == by) {
                this.prev = byte2ObjectLinkedOpenHashMap.last;
                this.index = byte2ObjectLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(by) & byte2ObjectLinkedOpenHashMap.mask;
            while (byte2ObjectLinkedOpenHashMap.key[n] != 0) {
                if (byte2ObjectLinkedOpenHashMap.key[n] == by) {
                    this.next = (int)byte2ObjectLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & byte2ObjectLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + by + " does not belong to this map.");
        }
        ...
        MapIterator(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap, byte by, 1 var3_3) {
            this(byte2ObjectLinkedOpenHashMap, by);
        }
    }
    ...
    Map.Entry<Byte, V> {
        ...
        MapEntry(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap, int n) {
            this.this$0 = byte2ObjectLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Byte2ObjectLinkedOpenHashMap byte2ObjectLinkedOpenHashMap) {
            this.this$0 = byte2ObjectLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.key[this.index] == (Byte)entry.getKey() && Objects.equals(this.this$0.value[this.index], entry.getValue());
        }
