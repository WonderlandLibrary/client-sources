...
Map<Byte, V> {
    ...
    default public V put(Byte by, V v) {
        return Byte2ReferenceFunction.super.put(by, v);
    }

    @Override
    @Deprecated
    default public V get(Object object) {
        return Byte2ReferenceFunction.super.get(object);
    }

    @Override
    @Deprecated
    default public V remove(Object object) {
        return Byte2ReferenceFunction.super.remove(object);
    }
    ...
    default public boolean containsKey(Object object) {
        return Byte2ReferenceFunction.super.containsKey(object);
    }
    ...
    default public boolean remove(byte by, Object object) {
        ...
        if (v != object || v == this.defaultReturnValue() && !this.containsKey(by)) {
            return true;
        }
        this.remove(by);
        return false;
    ...
    default public boolean replace(byte by, V v, V v2) {
        Object v3 = this.get(by);
        if (v3 != v || v3 == this.defaultReturnValue() && !this.containsKey(by)) {
            return true;
        }
        this.put(by, v2);
        return false;
    ...
    default public V computeIfAbsentPartial(byte by, Byte2ReferenceFunction<? extends V> byte2ReferenceFunction) {
        ...
        if (!byte2ReferenceFunction.containsKey(by)) {
            return v2;
        }
        V v3 = byte2ReferenceFunction.get(by);
        this.put(by, v3);
        return v3;
    }
