...
implements Byte2CharSortedMap {
    ...
    implements CharIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Byte2CharMap.Entry> objectBidirectionalIterator) {
    ...
    extends AbstractCharCollection {
        final AbstractByte2CharSortedMap this$0;

        protected ValuesCollection(AbstractByte2CharSortedMap abstractByte2CharSortedMap) {
            this.this$0 = abstractByte2CharSortedMap;
        }

        @Override
        public CharIterator iterator() {
            return new ValuesIterator(Byte2CharSortedMaps.fastIterator(this.this$0));
        }
    ...
    implements ByteBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Byte2CharMap.Entry> objectBidirectionalIterator) {
            this.i = objectBidirectionalIterator;
        }
    ...
    extends AbstractByteSortedSet {
        ...
        protected KeySet(AbstractByte2CharSortedMap abstractByte2CharSortedMap) {
            this.this$0 = abstractByte2CharSortedMap;
        }
        ...
        public ByteBidirectionalIterator iterator(byte by) {
            return new KeySetIterator(this.this$0.byte2CharEntrySet().iterator(new AbstractByte2CharMap.BasicEntry(by, '\u0000')));
        }

        @Override
        public ByteBidirectionalIterator iterator() {
            return new KeySetIterator(Byte2CharSortedMaps.fastIterator(this.this$0));
        }
