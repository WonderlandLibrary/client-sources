...
Cloneable {
    ...
    public Byte2FloatRBTreeMap(Comparator<? super Byte> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Byte2FloatRBTreeMap(Map<? extends Byte, ? extends Float> map) {
        this();
        this.putAll(map);
    }

    public Byte2FloatRBTreeMap(SortedMap<Byte, Float> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Byte, ? extends Float>)sortedMap);
    }

    public Byte2FloatRBTreeMap(Byte2FloatMap byte2FloatMap) {
        this();
        this.putAll(byte2FloatMap);
    }

    public Byte2FloatRBTreeMap(Byte2FloatSortedMap byte2FloatSortedMap) {
        this(byte2FloatSortedMap.comparator());
        this.putAll(byte2FloatSortedMap);
    }

    public Byte2FloatRBTreeMap(byte[] byArray, float[] fArray, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2FloatRBTreeMap(byte[] byArray, float[] fArray) {
    ...
    public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2FloatMap.Entry>(this){
                ...
                final Byte2FloatRBTreeMap this$0;
                {
                    this.this$0 = byte2FloatRBTreeMap;
    ...
    public Byte2FloatRBTreeMap clone() {
        Byte2FloatRBTreeMap byte2FloatRBTreeMap;
        try {
            byte2FloatRBTreeMap = (Byte2FloatRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2FloatRBTreeMap.keys = null;
        byte2FloatRBTreeMap.values = null;
        byte2FloatRBTreeMap.entries = null;
        byte2FloatRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2FloatRBTreeMap.firstEntry = byte2FloatRBTreeMap.tree = entry2.left;
                            while (byte2FloatRBTreeMap.firstEntry.left != null) {
                                byte2FloatRBTreeMap.firstEntry = byte2FloatRBTreeMap.firstEntry.left;
                            }
                            byte2FloatRBTreeMap.lastEntry = byte2FloatRBTreeMap.tree;
                            while (byte2FloatRBTreeMap.lastEntry.right != null) {
                                byte2FloatRBTreeMap.lastEntry = byte2FloatRBTreeMap.lastEntry.right;
                            }
                            return byte2FloatRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Byte2FloatRBTreeMap byte2FloatRBTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2FloatRBTreeMap;
            if (!bl && !bl2 && byte2FloatRBTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2FloatRBTreeMap.defRetValue;
        }
    ...
    implements FloatListIterator {
        ...
        private ValueIterator(Byte2FloatRBTreeMap byte2FloatRBTreeMap) {
            this.this$0 = byte2FloatRBTreeMap;
            super(byte2FloatRBTreeMap);
        }
        ...
        ValueIterator(Byte2FloatRBTreeMap byte2FloatRBTreeMap, 1 var2_2) {
            this(byte2FloatRBTreeMap);
        }
    }
    ...
    extends AbstractByte2FloatSortedMap.KeySet {
        ...
        private KeySet(Byte2FloatRBTreeMap byte2FloatRBTreeMap) {
            this.this$0 = byte2FloatRBTreeMap;
            super(byte2FloatRBTreeMap);
        }
        ...
        KeySet(Byte2FloatRBTreeMap byte2FloatRBTreeMap, 1 var2_2) {
            this(byte2FloatRBTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2FloatRBTreeMap byte2FloatRBTreeMap) {
            this.this$0 = byte2FloatRBTreeMap;
            super(byte2FloatRBTreeMap);
        }

        public KeyIterator(Byte2FloatRBTreeMap byte2FloatRBTreeMap, byte by) {
            this.this$0 = byte2FloatRBTreeMap;
            super(byte2FloatRBTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2FloatMap.Entry> {
        ...
        EntryIterator(Byte2FloatRBTreeMap byte2FloatRBTreeMap) {
            this.this$0 = byte2FloatRBTreeMap;
            super(byte2FloatRBTreeMap);
        }

        EntryIterator(Byte2FloatRBTreeMap byte2FloatRBTreeMap, byte by) {
            this.this$0 = byte2FloatRBTreeMap;
            super(byte2FloatRBTreeMap, by);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2FloatRBTreeMap byte2FloatRBTreeMap) {
            this.this$0 = byte2FloatRBTreeMap;
            this.index = 0;
            this.next = byte2FloatRBTreeMap.firstEntry;
        }

        TreeIterator(Byte2FloatRBTreeMap byte2FloatRBTreeMap, byte by) {
            this.this$0 = byte2FloatRBTreeMap;
            this.index = 0;
            this.next = byte2FloatRBTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2FloatRBTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
