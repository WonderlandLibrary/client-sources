...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Byte2BooleanAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Byte2BooleanAVLTreeMap(Comparator<? super Byte> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Byte2BooleanAVLTreeMap(Map<? extends Byte, ? extends Boolean> map) {
        this();
        this.putAll(map);
    }

    public Byte2BooleanAVLTreeMap(SortedMap<Byte, Boolean> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Byte, ? extends Boolean>)sortedMap);
    }

    public Byte2BooleanAVLTreeMap(Byte2BooleanMap byte2BooleanMap) {
        this();
        this.putAll(byte2BooleanMap);
    }

    public Byte2BooleanAVLTreeMap(Byte2BooleanSortedMap byte2BooleanSortedMap) {
        this(byte2BooleanSortedMap.comparator());
        this.putAll(byte2BooleanSortedMap);
    }

    public Byte2BooleanAVLTreeMap(byte[] byArray, boolean[] blArray, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2BooleanAVLTreeMap(byte[] byArray, boolean[] blArray) {
        this(byArray, blArray, null);
    }
    ...
    public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2BooleanMap.Entry>(this){
                final Comparator<? super Byte2BooleanMap.Entry> comparator;
                final Byte2BooleanAVLTreeMap this$0;
                {
                    this.this$0 = byte2BooleanAVLTreeMap;
                ...
                public ObjectSortedSet<Byte2BooleanMap.Entry> subSet(Byte2BooleanMap.Entry entry, Byte2BooleanMap.Entry entry2) {
                    return this.this$0.subMap(entry.getByteKey(), entry2.getByteKey()).byte2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(Byte2BooleanMap.Entry entry) {
                    return this.this$0.headMap(entry.getByteKey()).byte2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(Byte2BooleanMap.Entry entry) {
                    return this.this$0.tailMap(entry.getByteKey()).byte2BooleanEntrySet();
                }
                ...
                private int lambda$$0(Byte2BooleanMap.Entry entry, Byte2BooleanMap.Entry entry2) {
    ...
    public Byte2BooleanAVLTreeMap clone() {
        Byte2BooleanAVLTreeMap byte2BooleanAVLTreeMap;
        try {
            byte2BooleanAVLTreeMap = (Byte2BooleanAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2BooleanAVLTreeMap.keys = null;
        byte2BooleanAVLTreeMap.values = null;
        byte2BooleanAVLTreeMap.entries = null;
        byte2BooleanAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2BooleanAVLTreeMap.firstEntry = byte2BooleanAVLTreeMap.tree = entry2.left;
                            while (byte2BooleanAVLTreeMap.firstEntry.left != null) {
                                byte2BooleanAVLTreeMap.firstEntry = byte2BooleanAVLTreeMap.firstEntry.left;
                            }
                            byte2BooleanAVLTreeMap.lastEntry = byte2BooleanAVLTreeMap.tree;
                            while (byte2BooleanAVLTreeMap.lastEntry.right != null) {
                                byte2BooleanAVLTreeMap.lastEntry = byte2BooleanAVLTreeMap.lastEntry.right;
                            }
                            return byte2BooleanAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readByte(), objectInputStream.readBoolean());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readByte(), objectInputStream.readBoolean());
            entry4.right(new Entry(objectInputStream.readByte(), objectInputStream.readBoolean()));
    ...
    implements Serializable {
        ...
        public Submap(Byte2BooleanAVLTreeMap byte2BooleanAVLTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2BooleanAVLTreeMap;
            if (!bl && !bl2 && byte2BooleanAVLTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2BooleanAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2BooleanMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Byte2BooleanMap.Entry> comparator() {
                        return this.this$1.this$0.byte2BooleanEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Byte2BooleanMap.Entry> subSet(Byte2BooleanMap.Entry entry, Byte2BooleanMap.Entry entry2) {
                        return this.this$1.subMap(entry.getByteKey(), entry2.getByteKey()).byte2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(Byte2BooleanMap.Entry entry) {
                        return this.this$1.headMap(entry.getByteKey()).byte2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(Byte2BooleanMap.Entry entry) {
                        return this.this$1.tailMap(entry.getByteKey()).byte2BooleanEntrySet();
                    }
        ...
        public boolean put(byte by, boolean bl) {
            ...
            boolean bl2 = this.this$0.put(by, bl);
        ...
        public boolean remove(byte by) {
            ...
            boolean bl = this.this$0.remove(by);
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Byte2BooleanAVLTreeMap byte2BooleanAVLTreeMap) {
            this.this$0 = byte2BooleanAVLTreeMap;
            super(byte2BooleanAVLTreeMap);
        }
        ...
        ValueIterator(Byte2BooleanAVLTreeMap byte2BooleanAVLTreeMap, 1 var2_2) {
            this(byte2BooleanAVLTreeMap);
        }
    }
    ...
    extends AbstractByte2BooleanSortedMap.KeySet {
        ...
        private KeySet(Byte2BooleanAVLTreeMap byte2BooleanAVLTreeMap) {
            this.this$0 = byte2BooleanAVLTreeMap;
            super(byte2BooleanAVLTreeMap);
        }
        ...
        KeySet(Byte2BooleanAVLTreeMap byte2BooleanAVLTreeMap, 1 var2_2) {
            this(byte2BooleanAVLTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2BooleanAVLTreeMap byte2BooleanAVLTreeMap) {
            this.this$0 = byte2BooleanAVLTreeMap;
            super(byte2BooleanAVLTreeMap);
        }

        public KeyIterator(Byte2BooleanAVLTreeMap byte2BooleanAVLTreeMap, byte by) {
            this.this$0 = byte2BooleanAVLTreeMap;
            super(byte2BooleanAVLTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2BooleanMap.Entry> {
        ...
        EntryIterator(Byte2BooleanAVLTreeMap byte2BooleanAVLTreeMap) {
            this.this$0 = byte2BooleanAVLTreeMap;
            super(byte2BooleanAVLTreeMap);
        }

        EntryIterator(Byte2BooleanAVLTreeMap byte2BooleanAVLTreeMap, byte by) {
            this.this$0 = byte2BooleanAVLTreeMap;
            super(byte2BooleanAVLTreeMap, by);
        }
        ...
        public void add(Object object) {
            this.add((Byte2BooleanMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Byte2BooleanMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2BooleanAVLTreeMap byte2BooleanAVLTreeMap) {
            this.this$0 = byte2BooleanAVLTreeMap;
            this.index = 0;
            this.next = byte2BooleanAVLTreeMap.firstEntry;
        }

        TreeIterator(Byte2BooleanAVLTreeMap byte2BooleanAVLTreeMap, byte by) {
            this.this$0 = byte2BooleanAVLTreeMap;
            this.index = 0;
            this.next = byte2BooleanAVLTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2BooleanAVLTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Byte)entry.getKey() && this.value == (Boolean)entry.getValue();
        }
