...
Hash {
    ...
    public ByteLinkedOpenCustomHashSet(int n, float f, ByteHash.Strategy strategy) {
    ...
    public ByteLinkedOpenCustomHashSet(int n, ByteHash.Strategy strategy) {
    ...
    public ByteLinkedOpenCustomHashSet(Iterator<?> iterator2, float f, ByteHash.Strategy strategy) {
        this(ByteIterators.asByteIterator(iterator2), f, strategy);
    }

    public ByteLinkedOpenCustomHashSet(Iterator<?> iterator2, ByteHash.Strategy strategy) {
        this(ByteIterators.asByteIterator(iterator2), strategy);
    }

    public ByteLinkedOpenCustomHashSet(byte[] byArray, int n, int n2, float f, ByteHash.Strategy strategy) {
    ...
    public ByteLinkedOpenCustomHashSet(byte[] byArray, int n, int n2, ByteHash.Strategy strategy) {
        this(byArray, n, n2, 0.75f, strategy);
    }

    public ByteLinkedOpenCustomHashSet(byte[] byArray, float f, ByteHash.Strategy strategy) {
        this(byArray, 0, byArray.length, f, strategy);
    }

    public ByteLinkedOpenCustomHashSet(byte[] byArray, ByteHash.Strategy strategy) {
    ...
    public boolean addAndMoveToFirst(byte by) {
        ...
        if (this.strategy.equals(by, (byte)0)) {
            ...
            n = HashCommon.mix(this.strategy.hashCode(by)) & this.mask;
            while (byArray[n] != 0) {
                if (this.strategy.equals(by, byArray[n])) {
    ...
    protected void rehash(int n) {
        ...
        while (n6-- != 0) {
            int n7;
            if (this.strategy.equals(byArray[n3], (byte)0)) {
                n7 = n;
            } else {
                n7 = HashCommon.mix(this.strategy.hashCode(byArray[n3])) & n2;
                while (byArray2[n7] != 0) {
                    n7 = n7 + 1 & n2;
                }
            }
    ...
    public ByteLinkedOpenCustomHashSet clone() {
        ByteLinkedOpenCustomHashSet byteLinkedOpenCustomHashSet;
        try {
            byteLinkedOpenCustomHashSet = (ByteLinkedOpenCustomHashSet)super.clone();
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        while (n2-- != 0) {
            ...
            if (this.strategy.equals(by, (byte)0)) {
                ...
                n3 = HashCommon.mix(this.strategy.hashCode(by)) & this.mask;
                if (byArray[n3] != 0) {
    ...
    implements ByteListIterator {
        ...
        int curr;
        int index;
        final ByteLinkedOpenCustomHashSet this$0;

        SetIterator(ByteLinkedOpenCustomHashSet byteLinkedOpenCustomHashSet) {
            this.this$0 = byteLinkedOpenCustomHashSet;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = byteLinkedOpenCustomHashSet.first;
            this.index = 0;
        }

        SetIterator(ByteLinkedOpenCustomHashSet byteLinkedOpenCustomHashSet, byte by) {
            this.this$0 = byteLinkedOpenCustomHashSet;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (byteLinkedOpenCustomHashSet.strategy.equals(by, (byte)0)) {
                if (byteLinkedOpenCustomHashSet.containsNull) {
                    this.next = (int)byteLinkedOpenCustomHashSet.link[byteLinkedOpenCustomHashSet.n];
                    this.prev = byteLinkedOpenCustomHashSet.n;
                    return;
                }
                throw new NoSuchElementException("The key " + by + " does not belong to this set.");
            }
            if (byteLinkedOpenCustomHashSet.strategy.equals(byteLinkedOpenCustomHashSet.key[byteLinkedOpenCustomHashSet.last], by)) {
                this.prev = byteLinkedOpenCustomHashSet.last;
                this.index = byteLinkedOpenCustomHashSet.size;
                return;
            }
            byte[] byArray = byteLinkedOpenCustomHashSet.key;
            int n = HashCommon.mix(byteLinkedOpenCustomHashSet.strategy.hashCode(by)) & byteLinkedOpenCustomHashSet.mask;
            while (byArray[n] != 0) {
                if (byteLinkedOpenCustomHashSet.strategy.equals(byArray[n], by)) {
                    this.next = (int)byteLinkedOpenCustomHashSet.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & byteLinkedOpenCustomHashSet.mask;
            }
            throw new NoSuchElementException("The key " + by + " does not belong to this set.");
        }
