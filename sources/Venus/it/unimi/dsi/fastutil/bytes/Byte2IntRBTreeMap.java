...
Cloneable {
    ...
    public Byte2IntRBTreeMap(Comparator<? super Byte> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Byte2IntRBTreeMap(Map<? extends Byte, ? extends Integer> map) {
        this();
        this.putAll(map);
    }

    public Byte2IntRBTreeMap(SortedMap<Byte, Integer> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Byte, ? extends Integer>)sortedMap);
    }

    public Byte2IntRBTreeMap(Byte2IntMap byte2IntMap) {
        this();
        this.putAll(byte2IntMap);
    }

    public Byte2IntRBTreeMap(Byte2IntSortedMap byte2IntSortedMap) {
        this(byte2IntSortedMap.comparator());
        this.putAll(byte2IntSortedMap);
    }

    public Byte2IntRBTreeMap(byte[] byArray, int[] nArray, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2IntRBTreeMap(byte[] byArray, int[] nArray) {
    ...
    public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>(this){
                ...
                final Byte2IntRBTreeMap this$0;
                {
                    this.this$0 = byte2IntRBTreeMap;
    ...
    public Byte2IntRBTreeMap clone() {
        Byte2IntRBTreeMap byte2IntRBTreeMap;
        try {
            byte2IntRBTreeMap = (Byte2IntRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2IntRBTreeMap.keys = null;
        byte2IntRBTreeMap.values = null;
        byte2IntRBTreeMap.entries = null;
        byte2IntRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2IntRBTreeMap.firstEntry = byte2IntRBTreeMap.tree = entry2.left;
                            while (byte2IntRBTreeMap.firstEntry.left != null) {
                                byte2IntRBTreeMap.firstEntry = byte2IntRBTreeMap.firstEntry.left;
                            }
                            byte2IntRBTreeMap.lastEntry = byte2IntRBTreeMap.tree;
                            while (byte2IntRBTreeMap.lastEntry.right != null) {
                                byte2IntRBTreeMap.lastEntry = byte2IntRBTreeMap.lastEntry.right;
                            }
                            return byte2IntRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Byte2IntRBTreeMap byte2IntRBTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2IntRBTreeMap;
            if (!bl && !bl2 && byte2IntRBTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2IntRBTreeMap.defRetValue;
        }
    ...
    implements IntListIterator {
        ...
        private ValueIterator(Byte2IntRBTreeMap byte2IntRBTreeMap) {
            this.this$0 = byte2IntRBTreeMap;
            super(byte2IntRBTreeMap);
        }
        ...
        ValueIterator(Byte2IntRBTreeMap byte2IntRBTreeMap, 1 var2_2) {
            this(byte2IntRBTreeMap);
        }
    }
    ...
    extends AbstractByte2IntSortedMap.KeySet {
        ...
        private KeySet(Byte2IntRBTreeMap byte2IntRBTreeMap) {
            this.this$0 = byte2IntRBTreeMap;
            super(byte2IntRBTreeMap);
        }
        ...
        KeySet(Byte2IntRBTreeMap byte2IntRBTreeMap, 1 var2_2) {
            this(byte2IntRBTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2IntRBTreeMap byte2IntRBTreeMap) {
            this.this$0 = byte2IntRBTreeMap;
            super(byte2IntRBTreeMap);
        }

        public KeyIterator(Byte2IntRBTreeMap byte2IntRBTreeMap, byte by) {
            this.this$0 = byte2IntRBTreeMap;
            super(byte2IntRBTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2IntMap.Entry> {
        ...
        EntryIterator(Byte2IntRBTreeMap byte2IntRBTreeMap) {
            this.this$0 = byte2IntRBTreeMap;
            super(byte2IntRBTreeMap);
        }

        EntryIterator(Byte2IntRBTreeMap byte2IntRBTreeMap, byte by) {
            this.this$0 = byte2IntRBTreeMap;
            super(byte2IntRBTreeMap, by);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2IntRBTreeMap byte2IntRBTreeMap) {
            this.this$0 = byte2IntRBTreeMap;
            this.index = 0;
            this.next = byte2IntRBTreeMap.firstEntry;
        }

        TreeIterator(Byte2IntRBTreeMap byte2IntRBTreeMap, byte by) {
            this.this$0 = byte2IntRBTreeMap;
            this.index = 0;
            this.next = byte2IntRBTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2IntRBTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
