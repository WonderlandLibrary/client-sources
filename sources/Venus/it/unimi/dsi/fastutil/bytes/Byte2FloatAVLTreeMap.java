...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Byte2FloatAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Byte2FloatAVLTreeMap(Comparator<? super Byte> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Byte2FloatAVLTreeMap(Map<? extends Byte, ? extends Float> map) {
        this();
        this.putAll(map);
    }

    public Byte2FloatAVLTreeMap(SortedMap<Byte, Float> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Byte, ? extends Float>)sortedMap);
    }

    public Byte2FloatAVLTreeMap(Byte2FloatMap byte2FloatMap) {
        this();
        this.putAll(byte2FloatMap);
    }

    public Byte2FloatAVLTreeMap(Byte2FloatSortedMap byte2FloatSortedMap) {
        this(byte2FloatSortedMap.comparator());
        this.putAll(byte2FloatSortedMap);
    }

    public Byte2FloatAVLTreeMap(byte[] byArray, float[] fArray, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2FloatAVLTreeMap(byte[] byArray, float[] fArray) {
        this(byArray, fArray, null);
    }
    ...
    public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2FloatMap.Entry>(this){
                final Comparator<? super Byte2FloatMap.Entry> comparator;
                final Byte2FloatAVLTreeMap this$0;
                {
                    this.this$0 = byte2FloatAVLTreeMap;
                ...
                public ObjectSortedSet<Byte2FloatMap.Entry> subSet(Byte2FloatMap.Entry entry, Byte2FloatMap.Entry entry2) {
                    return this.this$0.subMap(entry.getByteKey(), entry2.getByteKey()).byte2FloatEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2FloatMap.Entry> headSet(Byte2FloatMap.Entry entry) {
                    return this.this$0.headMap(entry.getByteKey()).byte2FloatEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2FloatMap.Entry> tailSet(Byte2FloatMap.Entry entry) {
                    return this.this$0.tailMap(entry.getByteKey()).byte2FloatEntrySet();
                }
                ...
                private int lambda$$0(Byte2FloatMap.Entry entry, Byte2FloatMap.Entry entry2) {
    ...
    public Byte2FloatAVLTreeMap clone() {
        Byte2FloatAVLTreeMap byte2FloatAVLTreeMap;
        try {
            byte2FloatAVLTreeMap = (Byte2FloatAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2FloatAVLTreeMap.keys = null;
        byte2FloatAVLTreeMap.values = null;
        byte2FloatAVLTreeMap.entries = null;
        byte2FloatAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2FloatAVLTreeMap.firstEntry = byte2FloatAVLTreeMap.tree = entry2.left;
                            while (byte2FloatAVLTreeMap.firstEntry.left != null) {
                                byte2FloatAVLTreeMap.firstEntry = byte2FloatAVLTreeMap.firstEntry.left;
                            }
                            byte2FloatAVLTreeMap.lastEntry = byte2FloatAVLTreeMap.tree;
                            while (byte2FloatAVLTreeMap.lastEntry.right != null) {
                                byte2FloatAVLTreeMap.lastEntry = byte2FloatAVLTreeMap.lastEntry.right;
                            }
                            return byte2FloatAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readByte(), objectInputStream.readFloat());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readByte(), objectInputStream.readFloat());
            entry4.right(new Entry(objectInputStream.readByte(), objectInputStream.readFloat()));
    ...
    implements Serializable {
        ...
        public Submap(Byte2FloatAVLTreeMap byte2FloatAVLTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2FloatAVLTreeMap;
            if (!bl && !bl2 && byte2FloatAVLTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2FloatAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2FloatMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Byte2FloatMap.Entry> comparator() {
                        return this.this$1.this$0.byte2FloatEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Byte2FloatMap.Entry> subSet(Byte2FloatMap.Entry entry, Byte2FloatMap.Entry entry2) {
                        return this.this$1.subMap(entry.getByteKey(), entry2.getByteKey()).byte2FloatEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Byte2FloatMap.Entry> headSet(Byte2FloatMap.Entry entry) {
                        return this.this$1.headMap(entry.getByteKey()).byte2FloatEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Byte2FloatMap.Entry> tailSet(Byte2FloatMap.Entry entry) {
                        return this.this$1.tailMap(entry.getByteKey()).byte2FloatEntrySet();
                    }
    ...
    implements FloatListIterator {
        ...
        private ValueIterator(Byte2FloatAVLTreeMap byte2FloatAVLTreeMap) {
            this.this$0 = byte2FloatAVLTreeMap;
            super(byte2FloatAVLTreeMap);
        }
        ...
        ValueIterator(Byte2FloatAVLTreeMap byte2FloatAVLTreeMap, 1 var2_2) {
            this(byte2FloatAVLTreeMap);
        }
    }
    ...
    extends AbstractByte2FloatSortedMap.KeySet {
        ...
        private KeySet(Byte2FloatAVLTreeMap byte2FloatAVLTreeMap) {
            this.this$0 = byte2FloatAVLTreeMap;
            super(byte2FloatAVLTreeMap);
        }
        ...
        KeySet(Byte2FloatAVLTreeMap byte2FloatAVLTreeMap, 1 var2_2) {
            this(byte2FloatAVLTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2FloatAVLTreeMap byte2FloatAVLTreeMap) {
            this.this$0 = byte2FloatAVLTreeMap;
            super(byte2FloatAVLTreeMap);
        }

        public KeyIterator(Byte2FloatAVLTreeMap byte2FloatAVLTreeMap, byte by) {
            this.this$0 = byte2FloatAVLTreeMap;
            super(byte2FloatAVLTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2FloatMap.Entry> {
        ...
        EntryIterator(Byte2FloatAVLTreeMap byte2FloatAVLTreeMap) {
            this.this$0 = byte2FloatAVLTreeMap;
            super(byte2FloatAVLTreeMap);
        }

        EntryIterator(Byte2FloatAVLTreeMap byte2FloatAVLTreeMap, byte by) {
            this.this$0 = byte2FloatAVLTreeMap;
            super(byte2FloatAVLTreeMap, by);
        }
        ...
        public void add(Object object) {
            this.add((Byte2FloatMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Byte2FloatMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2FloatAVLTreeMap byte2FloatAVLTreeMap) {
            this.this$0 = byte2FloatAVLTreeMap;
            this.index = 0;
            this.next = byte2FloatAVLTreeMap.firstEntry;
        }

        TreeIterator(Byte2FloatAVLTreeMap byte2FloatAVLTreeMap, byte by) {
            this.this$0 = byte2FloatAVLTreeMap;
            this.index = 0;
            this.next = byte2FloatAVLTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2FloatAVLTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Byte)entry.getKey() && Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)entry.getValue()).floatValue());
        }
