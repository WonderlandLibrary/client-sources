...
Hash {
    ...
    public Byte2IntOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Byte2IntOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Byte2IntOpenHashMap(byte[] byArray, int[] nArray, float f) {
    ...
    public Byte2IntOpenHashMap(byte[] byArray, int[] nArray) {
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection(this){
                final Byte2IntOpenHashMap this$0;
                {
                    this.this$0 = byte2IntOpenHashMap;
                }
    ...
    public Byte2IntOpenHashMap clone() {
        Byte2IntOpenHashMap byte2IntOpenHashMap;
        try {
            byte2IntOpenHashMap = (Byte2IntOpenHashMap)super.clone();
    ...
    static int access$300(Byte2IntOpenHashMap byte2IntOpenHashMap) {
        return byte2IntOpenHashMap.removeNullEntry();
    }

    static int access$400(Byte2IntOpenHashMap byte2IntOpenHashMap, int n) {
        return byte2IntOpenHashMap.removeEntry(n);
    }
    ...
    implements IntIterator {
        ...
        public ValueIterator(Byte2IntOpenHashMap byte2IntOpenHashMap) {
            this.this$0 = byte2IntOpenHashMap;
            super(byte2IntOpenHashMap, null);
        }
    ...
    extends AbstractByteSet {
        ...
        private KeySet(Byte2IntOpenHashMap byte2IntOpenHashMap) {
            this.this$0 = byte2IntOpenHashMap;
        }
        ...
        KeySet(Byte2IntOpenHashMap byte2IntOpenHashMap, 1 var2_2) {
            this(byte2IntOpenHashMap);
        }
    }
    ...
    implements ByteIterator {
        ...
        public KeyIterator(Byte2IntOpenHashMap byte2IntOpenHashMap) {
            this.this$0 = byte2IntOpenHashMap;
            super(byte2IntOpenHashMap, null);
        }
    ...
    implements Byte2IntMap.FastEntrySet {
        ...
        private MapEntrySet(Byte2IntOpenHashMap byte2IntOpenHashMap) {
            this.this$0 = byte2IntOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (by == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n) {
                    Byte2IntOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (by2 == by) {
                if (this.this$0.value[n2] == n) {
                    Byte2IntOpenHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Byte2IntOpenHashMap byte2IntOpenHashMap, 1 var2_2) {
            this(byte2IntOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2IntMap.Entry> {
        ...
        private FastEntryIterator(Byte2IntOpenHashMap byte2IntOpenHashMap) {
            this.this$0 = byte2IntOpenHashMap;
            super(byte2IntOpenHashMap, null);
        ...
        FastEntryIterator(Byte2IntOpenHashMap byte2IntOpenHashMap, 1 var2_2) {
            this(byte2IntOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2IntMap.Entry> {
        ...
        private EntryIterator(Byte2IntOpenHashMap byte2IntOpenHashMap) {
            this.this$0 = byte2IntOpenHashMap;
            super(byte2IntOpenHashMap, null);
        }
        ...
        EntryIterator(Byte2IntOpenHashMap byte2IntOpenHashMap, 1 var2_2) {
            this(byte2IntOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Byte2IntOpenHashMap byte2IntOpenHashMap) {
            this.this$0 = byte2IntOpenHashMap;
        ...
        MapIterator(Byte2IntOpenHashMap byte2IntOpenHashMap, 1 var2_2) {
            this(byte2IntOpenHashMap);
        }
    }
    ...
    Map.Entry<Byte, Integer> {
        ...
        MapEntry(Byte2IntOpenHashMap byte2IntOpenHashMap, int n) {
            this.this$0 = byte2IntOpenHashMap;
            this.index = n;
        }

        MapEntry(Byte2IntOpenHashMap byte2IntOpenHashMap) {
            this.this$0 = byte2IntOpenHashMap;
        }
