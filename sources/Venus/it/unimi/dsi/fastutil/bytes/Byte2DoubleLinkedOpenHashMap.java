...
Hash {
    ...
    public Byte2DoubleLinkedOpenHashMap(byte[] byArray, double[] dArray, float f) {
    ...
    public Byte2DoubleLinkedOpenHashMap(byte[] byArray, double[] dArray) {
    ...
    public double getAndMoveToFirst(byte by) {
        if (by == 0) {
            if (this.containsNullKey) {
    ...
    public double getAndMoveToLast(byte by) {
        if (by == 0) {
            if (this.containsNullKey) {
    ...
    public double putAndMoveToFirst(byte by, double d) {
        int n;
        if (by == 0) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public double putAndMoveToLast(byte by, double d) {
        int n;
        if (by == 0) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(this){
                final Byte2DoubleLinkedOpenHashMap this$0;
                {
                    this.this$0 = byte2DoubleLinkedOpenHashMap;
                }
    ...
    public Byte2DoubleLinkedOpenHashMap clone() {
        Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap;
        try {
            byte2DoubleLinkedOpenHashMap = (Byte2DoubleLinkedOpenHashMap)super.clone();
        ...
        byte2DoubleLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        byte2DoubleLinkedOpenHashMap.key = (byte[])this.key.clone();
        byte2DoubleLinkedOpenHashMap.value = (double[])this.value.clone();
        byte2DoubleLinkedOpenHashMap.link = (long[])this.link.clone();
    ...
    @Override
    public ObjectSortedSet byte2DoubleEntrySet() {
    ...
    static double access$100(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap) {
        return byte2DoubleLinkedOpenHashMap.removeNullEntry();
    }

    static double access$200(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap, int n) {
        return byte2DoubleLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements DoubleListIterator {
        ...
        public ValueIterator(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap) {
            this.this$0 = byte2DoubleLinkedOpenHashMap;
            super(byte2DoubleLinkedOpenHashMap);
        }
    ...
    extends AbstractByteSortedSet {
        ...
        private KeySet(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap) {
            this.this$0 = byte2DoubleLinkedOpenHashMap;
        }
        ...
        KeySet(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap, 1 var2_2) {
            this(byte2DoubleLinkedOpenHashMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap, byte by) {
            this.this$0 = byte2DoubleLinkedOpenHashMap;
            super(byte2DoubleLinkedOpenHashMap, by, null);
        }
        ...
        public KeyIterator(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap) {
            this.this$0 = byte2DoubleLinkedOpenHashMap;
            super(byte2DoubleLinkedOpenHashMap);
        }
    ...
    implements Byte2DoubleSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap) {
            this.this$0 = byte2DoubleLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (by == 0) {
                if (this.this$0.containsNullKey && Double.doubleToLongBits(this.this$0.value[this.this$0.n]) == Double.doubleToLongBits(d)) {
                    Byte2DoubleLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (by2 == by) {
                if (Double.doubleToLongBits(this.this$0.value[n]) == Double.doubleToLongBits(d)) {
                    Byte2DoubleLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Byte2DoubleMap.Entry> iterator(Byte2DoubleMap.Entry entry) {
        ...
        public ObjectListIterator<Byte2DoubleMap.Entry> fastIterator(Byte2DoubleMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractByte2DoubleMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Byte2DoubleMap.Entry entry) {
        ...
        MapEntrySet(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap, 1 var2_2) {
            this(byte2DoubleLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Byte2DoubleMap.Entry> {
        ...
        public FastEntryIterator(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap) {
            this.this$0 = byte2DoubleLinkedOpenHashMap;
            super(byte2DoubleLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap, byte by) {
            this.this$0 = byte2DoubleLinkedOpenHashMap;
            super(byte2DoubleLinkedOpenHashMap, by, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Byte2DoubleMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Byte2DoubleMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Byte2DoubleMap.Entry> {
        ...
        public EntryIterator(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap) {
            this.this$0 = byte2DoubleLinkedOpenHashMap;
            super(byte2DoubleLinkedOpenHashMap);
        }

        public EntryIterator(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap, byte by) {
            this.this$0 = byte2DoubleLinkedOpenHashMap;
            super(byte2DoubleLinkedOpenHashMap, by, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap) {
            this.this$0 = byte2DoubleLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = byte2DoubleLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap, byte by) {
            this.this$0 = byte2DoubleLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (by == 0) {
                if (byte2DoubleLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)byte2DoubleLinkedOpenHashMap.link[byte2DoubleLinkedOpenHashMap.n];
                    this.prev = byte2DoubleLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + by + " does not belong to this map.");
            }
            if (byte2DoubleLinkedOpenHashMap.key[byte2DoubleLinkedOpenHashMap.last] == by) {
                this.prev = byte2DoubleLinkedOpenHashMap.last;
                this.index = byte2DoubleLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(by) & byte2DoubleLinkedOpenHashMap.mask;
            while (byte2DoubleLinkedOpenHashMap.key[n] != 0) {
                if (byte2DoubleLinkedOpenHashMap.key[n] == by) {
                    this.next = (int)byte2DoubleLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & byte2DoubleLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + by + " does not belong to this map.");
        }
        ...
        public void set(Byte2DoubleMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Byte2DoubleMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap, byte by, 1 var3_3) {
            this(byte2DoubleLinkedOpenHashMap, by);
        }
    }
    ...
    Map.Entry<Byte, Double> {
        ...
        MapEntry(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap, int n) {
            this.this$0 = byte2DoubleLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Byte2DoubleLinkedOpenHashMap byte2DoubleLinkedOpenHashMap) {
            this.this$0 = byte2DoubleLinkedOpenHashMap;
        }
