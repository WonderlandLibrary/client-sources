...
implements Byte2IntSortedMap {
    ...
    implements IntIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Byte2IntMap.Entry> objectBidirectionalIterator) {
    ...
    extends AbstractIntCollection {
        final AbstractByte2IntSortedMap this$0;

        protected ValuesCollection(AbstractByte2IntSortedMap abstractByte2IntSortedMap) {
            this.this$0 = abstractByte2IntSortedMap;
        }

        @Override
        public IntIterator iterator() {
            return new ValuesIterator(Byte2IntSortedMaps.fastIterator(this.this$0));
        }
    ...
    implements ByteBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Byte2IntMap.Entry> objectBidirectionalIterator) {
            this.i = objectBidirectionalIterator;
        }
    ...
    extends AbstractByteSortedSet {
        ...
        protected KeySet(AbstractByte2IntSortedMap abstractByte2IntSortedMap) {
            this.this$0 = abstractByte2IntSortedMap;
        }
        ...
        public ByteBidirectionalIterator iterator(byte by) {
            return new KeySetIterator(this.this$0.byte2IntEntrySet().iterator(new AbstractByte2IntMap.BasicEntry(by, 0)));
        }

        @Override
        public ByteBidirectionalIterator iterator() {
            return new KeySetIterator(Byte2IntSortedMaps.fastIterator(this.this$0));
        }
