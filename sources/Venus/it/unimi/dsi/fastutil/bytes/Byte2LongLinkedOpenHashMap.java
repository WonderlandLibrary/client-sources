...
Hash {
    ...
    public Byte2LongLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Byte2LongLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Byte2LongLinkedOpenHashMap(byte[] byArray, long[] lArray, float f) {
    ...
    public Byte2LongLinkedOpenHashMap(byte[] byArray, long[] lArray) {
        this(byArray, lArray, 0.75f);
    }
    ...
    private void insert(int n, byte by, long l) {
        if (n == this.n) {
    ...
    public long getAndMoveToFirst(byte by) {
        if (by == 0) {
            if (this.containsNullKey) {
    ...
    public long getAndMoveToLast(byte by) {
        if (by == 0) {
            if (this.containsNullKey) {
    ...
    public long putAndMoveToFirst(byte by, long l) {
        int n;
        if (by == 0) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public long putAndMoveToLast(byte by, long l) {
        int n;
        if (by == 0) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public boolean containsValue(long l) {
        ...
        int n = this.n;
        while (n-- != 0) {
            if (byArray[n] == 0 || lArray[n] != l) continue;
            return false;
        }
        return true;
    }
    ...
    public long computeIfAbsent(byte by, IntToLongFunction intToLongFunction) {
        ...
        long l = intToLongFunction.applyAsLong(by);
        this.insert(-n - 1, by, l);
        return l;
    }
    ...
    public long computeIfAbsentNullable(byte by, IntFunction<? extends Long> intFunction) {
        ...
        Long l = intFunction.apply(by);
        if (l == null) {
            return this.defRetValue;
        }
        long l2 = l;
        this.insert(-n - 1, by, l2);
        return l2;
    }
    ...
    public long computeIfPresent(byte by, BiFunction<? super Byte, ? super Long, ? extends Long> biFunction) {
        ...
        Long l = biFunction.apply((Byte)by, (Long)this.value[n]);
        if (l == null) {
            if (by == 0) {
                this.removeNullEntry();
            } else {
    ...
    public long compute(byte by, BiFunction<? super Byte, ? super Long, ? extends Long> biFunction) {
        Objects.requireNonNull(biFunction);
        int n = this.find(by);
        Long l = biFunction.apply((Byte)by, n >= 0 ? Long.valueOf(this.value[n]) : null);
        if (l == null) {
            if (n >= 0) {
                if (by == 0) {
                    this.removeNullEntry();
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection(this){
                final Byte2LongLinkedOpenHashMap this$0;
                {
                    this.this$0 = byte2LongLinkedOpenHashMap;
                }
    ...
    public Byte2LongLinkedOpenHashMap clone() {
        Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap;
        try {
            byte2LongLinkedOpenHashMap = (Byte2LongLinkedOpenHashMap)super.clone();
    ...
    @Override
    public ObjectSortedSet byte2LongEntrySet() {
    ...
    static long access$100(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap) {
        return byte2LongLinkedOpenHashMap.removeNullEntry();
    }

    static long access$200(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap, int n) {
        return byte2LongLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements LongListIterator {
        ...
        public ValueIterator(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap) {
            this.this$0 = byte2LongLinkedOpenHashMap;
            super(byte2LongLinkedOpenHashMap);
        }
    ...
    extends AbstractByteSortedSet {
        ...
        private KeySet(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap) {
            this.this$0 = byte2LongLinkedOpenHashMap;
        }
        ...
        KeySet(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap, 1 var2_2) {
            this(byte2LongLinkedOpenHashMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap, byte by) {
            this.this$0 = byte2LongLinkedOpenHashMap;
            super(byte2LongLinkedOpenHashMap, by, null);
        }
        ...
        public KeyIterator(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap) {
            this.this$0 = byte2LongLinkedOpenHashMap;
            super(byte2LongLinkedOpenHashMap);
        }
    ...
    implements Byte2LongSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap) {
            this.this$0 = byte2LongLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (by == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == l) {
                    Byte2LongLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (by2 == by) {
                if (this.this$0.value[n] == l) {
                    Byte2LongLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((by2 = byArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (by2 != by || this.this$0.value[n] != l);
            Byte2LongLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        public void forEach(Consumer<? super Byte2LongMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractByte2LongMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Byte2LongMap.Entry entry) {
        ...
        MapEntrySet(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap, 1 var2_2) {
            this(byte2LongLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Byte2LongMap.Entry> {
        ...
        public FastEntryIterator(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap) {
            this.this$0 = byte2LongLinkedOpenHashMap;
            super(byte2LongLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap, byte by) {
            this.this$0 = byte2LongLinkedOpenHashMap;
            super(byte2LongLinkedOpenHashMap, by, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Byte2LongMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Byte2LongMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Byte2LongMap.Entry> {
        ...
        public EntryIterator(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap) {
            this.this$0 = byte2LongLinkedOpenHashMap;
            super(byte2LongLinkedOpenHashMap);
        }

        public EntryIterator(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap, byte by) {
            this.this$0 = byte2LongLinkedOpenHashMap;
            super(byte2LongLinkedOpenHashMap, by, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap) {
            this.this$0 = byte2LongLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = byte2LongLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap, byte by) {
            this.this$0 = byte2LongLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (by == 0) {
                if (byte2LongLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)byte2LongLinkedOpenHashMap.link[byte2LongLinkedOpenHashMap.n];
                    this.prev = byte2LongLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + by + " does not belong to this map.");
            }
            if (byte2LongLinkedOpenHashMap.key[byte2LongLinkedOpenHashMap.last] == by) {
                this.prev = byte2LongLinkedOpenHashMap.last;
                this.index = byte2LongLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(by) & byte2LongLinkedOpenHashMap.mask;
            while (byte2LongLinkedOpenHashMap.key[n] != 0) {
                if (byte2LongLinkedOpenHashMap.key[n] == by) {
                    this.next = (int)byte2LongLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & byte2LongLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + by + " does not belong to this map.");
        }
        ...
        MapIterator(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap, byte by, 1 var3_3) {
            this(byte2LongLinkedOpenHashMap, by);
        }
    }
    ...
    Map.Entry<Byte, Long> {
        ...
        MapEntry(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap, int n) {
            this.this$0 = byte2LongLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Byte2LongLinkedOpenHashMap byte2LongLinkedOpenHashMap) {
            this.this$0 = byte2LongLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.key[this.index] == (Byte)entry.getKey() && this.this$0.value[this.index] == (Long)entry.getValue();
        }
