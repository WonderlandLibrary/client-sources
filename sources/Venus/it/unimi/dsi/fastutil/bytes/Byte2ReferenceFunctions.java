...
public final class Byte2ReferenceFunctions {
    ...
    public static <V> Byte2ReferenceFunction<V> singleton(byte by, V v) {
    ...
    public static <V> Byte2ReferenceFunction<V> synchronize(Byte2ReferenceFunction<V> byte2ReferenceFunction) {
        return new SynchronizedFunction<V>(byte2ReferenceFunction);
    }

    public static <V> Byte2ReferenceFunction<V> synchronize(Byte2ReferenceFunction<V> byte2ReferenceFunction, Object object) {
        return new SynchronizedFunction<V>(byte2ReferenceFunction, object);
    }

    public static <V> Byte2ReferenceFunction<V> unmodifiable(Byte2ReferenceFunction<V> byte2ReferenceFunction) {
        return new UnmodifiableFunction<V>(byte2ReferenceFunction);
    }

    public static <V> Byte2ReferenceFunction<V> primitive(java.util.function.Function<? super Byte, ? extends V> function) {
        Objects.requireNonNull(function);
        if (function instanceof Byte2ReferenceFunction) {
            return (Byte2ReferenceFunction)function;
        }
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Byte2ReferenceFunction<V> byte2ReferenceFunction) {
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Byte2ReferenceFunction<V> byte2ReferenceFunction, Object object) {
            if (byte2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = byte2ReferenceFunction;
        ...
        protected SynchronizedFunction(Byte2ReferenceFunction<V> byte2ReferenceFunction) {
            if (byte2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = byte2ReferenceFunction;
