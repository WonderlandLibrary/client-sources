...
Cloneable {
    ...
    public Byte2CharRBTreeMap(Comparator<? super Byte> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Byte2CharRBTreeMap(Map<? extends Byte, ? extends Character> map) {
        this();
        this.putAll(map);
    }

    public Byte2CharRBTreeMap(SortedMap<Byte, Character> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Byte, ? extends Character>)sortedMap);
    }

    public Byte2CharRBTreeMap(Byte2CharMap byte2CharMap) {
        this();
        this.putAll(byte2CharMap);
    }

    public Byte2CharRBTreeMap(Byte2CharSortedMap byte2CharSortedMap) {
        this(byte2CharSortedMap.comparator());
        this.putAll(byte2CharSortedMap);
    }

    public Byte2CharRBTreeMap(byte[] byArray, char[] cArray, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2CharRBTreeMap(byte[] byArray, char[] cArray) {
    ...
    public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2CharMap.Entry>(this){
                ...
                final Byte2CharRBTreeMap this$0;
                {
                    this.this$0 = byte2CharRBTreeMap;
    ...
    public Byte2CharRBTreeMap clone() {
        Byte2CharRBTreeMap byte2CharRBTreeMap;
        try {
            byte2CharRBTreeMap = (Byte2CharRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2CharRBTreeMap.keys = null;
        byte2CharRBTreeMap.values = null;
        byte2CharRBTreeMap.entries = null;
        byte2CharRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2CharRBTreeMap.firstEntry = byte2CharRBTreeMap.tree = entry2.left;
                            while (byte2CharRBTreeMap.firstEntry.left != null) {
                                byte2CharRBTreeMap.firstEntry = byte2CharRBTreeMap.firstEntry.left;
                            }
                            byte2CharRBTreeMap.lastEntry = byte2CharRBTreeMap.tree;
                            while (byte2CharRBTreeMap.lastEntry.right != null) {
                                byte2CharRBTreeMap.lastEntry = byte2CharRBTreeMap.lastEntry.right;
                            }
                            return byte2CharRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Byte2CharRBTreeMap byte2CharRBTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2CharRBTreeMap;
            if (!bl && !bl2 && byte2CharRBTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2CharRBTreeMap.defRetValue;
        }
    ...
    implements CharListIterator {
        ...
        private ValueIterator(Byte2CharRBTreeMap byte2CharRBTreeMap) {
            this.this$0 = byte2CharRBTreeMap;
            super(byte2CharRBTreeMap);
        }
        ...
        ValueIterator(Byte2CharRBTreeMap byte2CharRBTreeMap, 1 var2_2) {
            this(byte2CharRBTreeMap);
        }
    }
    ...
    extends AbstractByte2CharSortedMap.KeySet {
        ...
        private KeySet(Byte2CharRBTreeMap byte2CharRBTreeMap) {
            this.this$0 = byte2CharRBTreeMap;
            super(byte2CharRBTreeMap);
        }
        ...
        KeySet(Byte2CharRBTreeMap byte2CharRBTreeMap, 1 var2_2) {
            this(byte2CharRBTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2CharRBTreeMap byte2CharRBTreeMap) {
            this.this$0 = byte2CharRBTreeMap;
            super(byte2CharRBTreeMap);
        }

        public KeyIterator(Byte2CharRBTreeMap byte2CharRBTreeMap, byte by) {
            this.this$0 = byte2CharRBTreeMap;
            super(byte2CharRBTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2CharMap.Entry> {
        ...
        EntryIterator(Byte2CharRBTreeMap byte2CharRBTreeMap) {
            this.this$0 = byte2CharRBTreeMap;
            super(byte2CharRBTreeMap);
        }

        EntryIterator(Byte2CharRBTreeMap byte2CharRBTreeMap, byte by) {
            this.this$0 = byte2CharRBTreeMap;
            super(byte2CharRBTreeMap, by);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2CharRBTreeMap byte2CharRBTreeMap) {
            this.this$0 = byte2CharRBTreeMap;
            this.index = 0;
            this.next = byte2CharRBTreeMap.firstEntry;
        }

        TreeIterator(Byte2CharRBTreeMap byte2CharRBTreeMap, byte by) {
            this.this$0 = byte2CharRBTreeMap;
            this.index = 0;
            this.next = byte2CharRBTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2CharRBTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
