...
Hash {
    ...
    public Byte2ByteOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Byte2ByteOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Byte2ByteOpenHashMap(Map<? extends Byte, ? extends Byte> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }
    ...
    public Byte2ByteOpenHashMap(Byte2ByteMap byte2ByteMap, float f) {
        this(byte2ByteMap.size(), f);
        this.putAll(byte2ByteMap);
    }

    public Byte2ByteOpenHashMap(Byte2ByteMap byte2ByteMap) {
        this(byte2ByteMap, 0.75f);
    }

    public Byte2ByteOpenHashMap(byte[] byArray, byte[] byArray2, float f) {
    ...
    public Byte2ByteOpenHashMap(byte[] byArray, byte[] byArray2) {
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection(this){
                final Byte2ByteOpenHashMap this$0;
                {
                    this.this$0 = byte2ByteOpenHashMap;
                }
    ...
    public Byte2ByteOpenHashMap clone() {
        ...
        try {
            byte2ByteOpenHashMap = (Byte2ByteOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2ByteOpenHashMap.keys = null;
        byte2ByteOpenHashMap.values = null;
        byte2ByteOpenHashMap.entries = null;
        byte2ByteOpenHashMap.containsNullKey = this.containsNullKey;
        byte2ByteOpenHashMap.key = (byte[])this.key.clone();
        byte2ByteOpenHashMap.value = (byte[])this.value.clone();
        return byte2ByteOpenHashMap;
    }
    ...
    static byte access$300(Byte2ByteOpenHashMap byte2ByteOpenHashMap) {
        return byte2ByteOpenHashMap.removeNullEntry();
    }

    static byte access$400(Byte2ByteOpenHashMap byte2ByteOpenHashMap, int n) {
        return byte2ByteOpenHashMap.removeEntry(n);
    }
    ...
    implements ByteIterator {
        ...
        public ValueIterator(Byte2ByteOpenHashMap byte2ByteOpenHashMap) {
            this.this$0 = byte2ByteOpenHashMap;
            super(byte2ByteOpenHashMap, null);
        }
    ...
    extends AbstractByteSet {
        ...
        private KeySet(Byte2ByteOpenHashMap byte2ByteOpenHashMap) {
            this.this$0 = byte2ByteOpenHashMap;
        }
        ...
        KeySet(Byte2ByteOpenHashMap byte2ByteOpenHashMap, 1 var2_2) {
            this(byte2ByteOpenHashMap);
        }
    }
    ...
    implements ByteIterator {
        ...
        public KeyIterator(Byte2ByteOpenHashMap byte2ByteOpenHashMap) {
            this.this$0 = byte2ByteOpenHashMap;
            super(byte2ByteOpenHashMap, null);
        }
    ...
    implements Byte2ByteMap.FastEntrySet {
        ...
        private MapEntrySet(Byte2ByteOpenHashMap byte2ByteOpenHashMap) {
            this.this$0 = byte2ByteOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (by == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == by2) {
                    Byte2ByteOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (by3 == by) {
                if (this.this$0.value[n] == by2) {
                    Byte2ByteOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Byte2ByteOpenHashMap byte2ByteOpenHashMap, 1 var2_2) {
            this(byte2ByteOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2ByteMap.Entry> {
        ...
        private FastEntryIterator(Byte2ByteOpenHashMap byte2ByteOpenHashMap) {
            this.this$0 = byte2ByteOpenHashMap;
            super(byte2ByteOpenHashMap, null);
        ...
        FastEntryIterator(Byte2ByteOpenHashMap byte2ByteOpenHashMap, 1 var2_2) {
            this(byte2ByteOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2ByteMap.Entry> {
        ...
        private EntryIterator(Byte2ByteOpenHashMap byte2ByteOpenHashMap) {
            this.this$0 = byte2ByteOpenHashMap;
            super(byte2ByteOpenHashMap, null);
        }
        ...
        EntryIterator(Byte2ByteOpenHashMap byte2ByteOpenHashMap, 1 var2_2) {
            this(byte2ByteOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Byte2ByteOpenHashMap byte2ByteOpenHashMap) {
            this.this$0 = byte2ByteOpenHashMap;
        ...
        MapIterator(Byte2ByteOpenHashMap byte2ByteOpenHashMap, 1 var2_2) {
            this(byte2ByteOpenHashMap);
        }
    }
    ...
    Map.Entry<Byte, Byte> {
        ...
        MapEntry(Byte2ByteOpenHashMap byte2ByteOpenHashMap, int n) {
            this.this$0 = byte2ByteOpenHashMap;
            this.index = n;
        }

        MapEntry(Byte2ByteOpenHashMap byte2ByteOpenHashMap) {
            this.this$0 = byte2ByteOpenHashMap;
        }
