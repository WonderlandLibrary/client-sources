...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Byte2IntAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Byte2IntAVLTreeMap(Comparator<? super Byte> comparator) {
        this();
    ...
    public Byte2IntAVLTreeMap(SortedMap<Byte, Integer> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Byte, ? extends Integer>)sortedMap);
    }

    public Byte2IntAVLTreeMap(Byte2IntMap byte2IntMap) {
        this();
        this.putAll(byte2IntMap);
    }

    public Byte2IntAVLTreeMap(Byte2IntSortedMap byte2IntSortedMap) {
        this(byte2IntSortedMap.comparator());
        this.putAll(byte2IntSortedMap);
    }

    public Byte2IntAVLTreeMap(byte[] byArray, int[] nArray, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2IntAVLTreeMap(byte[] byArray, int[] nArray) {
        this(byArray, nArray, null);
    }
    ...
    public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>(this){
                final Comparator<? super Byte2IntMap.Entry> comparator;
                final Byte2IntAVLTreeMap this$0;
                {
                    this.this$0 = byte2IntAVLTreeMap;
                ...
                public ObjectSortedSet<Byte2IntMap.Entry> subSet(Byte2IntMap.Entry entry, Byte2IntMap.Entry entry2) {
                    return this.this$0.subMap(entry.getByteKey(), entry2.getByteKey()).byte2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry entry) {
                    return this.this$0.headMap(entry.getByteKey()).byte2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Byte2IntMap.Entry> tailSet(Byte2IntMap.Entry entry) {
                    return this.this$0.tailMap(entry.getByteKey()).byte2IntEntrySet();
                }
                ...
                private int lambda$$0(Byte2IntMap.Entry entry, Byte2IntMap.Entry entry2) {
    ...
    public Byte2IntAVLTreeMap clone() {
        Byte2IntAVLTreeMap byte2IntAVLTreeMap;
        try {
            byte2IntAVLTreeMap = (Byte2IntAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2IntAVLTreeMap.keys = null;
        byte2IntAVLTreeMap.values = null;
        byte2IntAVLTreeMap.entries = null;
        byte2IntAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2IntAVLTreeMap.firstEntry = byte2IntAVLTreeMap.tree = entry2.left;
                            while (byte2IntAVLTreeMap.firstEntry.left != null) {
                                byte2IntAVLTreeMap.firstEntry = byte2IntAVLTreeMap.firstEntry.left;
                            }
                            byte2IntAVLTreeMap.lastEntry = byte2IntAVLTreeMap.tree;
                            while (byte2IntAVLTreeMap.lastEntry.right != null) {
                                byte2IntAVLTreeMap.lastEntry = byte2IntAVLTreeMap.lastEntry.right;
                            }
                            return byte2IntAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readByte(), objectInputStream.readInt());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readByte(), objectInputStream.readInt());
            entry4.right(new Entry(objectInputStream.readByte(), objectInputStream.readInt()));
    ...
    implements Serializable {
        ...
        public Submap(Byte2IntAVLTreeMap byte2IntAVLTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2IntAVLTreeMap;
            if (!bl && !bl2 && byte2IntAVLTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2IntAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Byte2IntMap.Entry> comparator() {
                        return this.this$1.this$0.byte2IntEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Byte2IntMap.Entry> subSet(Byte2IntMap.Entry entry, Byte2IntMap.Entry entry2) {
                        return this.this$1.subMap(entry.getByteKey(), entry2.getByteKey()).byte2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry entry) {
                        return this.this$1.headMap(entry.getByteKey()).byte2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Byte2IntMap.Entry> tailSet(Byte2IntMap.Entry entry) {
                        return this.this$1.tailMap(entry.getByteKey()).byte2IntEntrySet();
                    }
    ...
    implements IntListIterator {
        ...
        private ValueIterator(Byte2IntAVLTreeMap byte2IntAVLTreeMap) {
            this.this$0 = byte2IntAVLTreeMap;
            super(byte2IntAVLTreeMap);
        }
        ...
        ValueIterator(Byte2IntAVLTreeMap byte2IntAVLTreeMap, 1 var2_2) {
            this(byte2IntAVLTreeMap);
        }
    }
    ...
    extends AbstractByte2IntSortedMap.KeySet {
        ...
        private KeySet(Byte2IntAVLTreeMap byte2IntAVLTreeMap) {
            this.this$0 = byte2IntAVLTreeMap;
            super(byte2IntAVLTreeMap);
        }
        ...
        KeySet(Byte2IntAVLTreeMap byte2IntAVLTreeMap, 1 var2_2) {
            this(byte2IntAVLTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2IntAVLTreeMap byte2IntAVLTreeMap) {
            this.this$0 = byte2IntAVLTreeMap;
            super(byte2IntAVLTreeMap);
        }

        public KeyIterator(Byte2IntAVLTreeMap byte2IntAVLTreeMap, byte by) {
            this.this$0 = byte2IntAVLTreeMap;
            super(byte2IntAVLTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2IntMap.Entry> {
        ...
        EntryIterator(Byte2IntAVLTreeMap byte2IntAVLTreeMap) {
            this.this$0 = byte2IntAVLTreeMap;
            super(byte2IntAVLTreeMap);
        }

        EntryIterator(Byte2IntAVLTreeMap byte2IntAVLTreeMap, byte by) {
            this.this$0 = byte2IntAVLTreeMap;
            super(byte2IntAVLTreeMap, by);
        }
        ...
        public void add(Object object) {
            this.add((Byte2IntMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Byte2IntMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2IntAVLTreeMap byte2IntAVLTreeMap) {
            this.this$0 = byte2IntAVLTreeMap;
            this.index = 0;
            this.next = byte2IntAVLTreeMap.firstEntry;
        }

        TreeIterator(Byte2IntAVLTreeMap byte2IntAVLTreeMap, byte by) {
            this.this$0 = byte2IntAVLTreeMap;
            this.index = 0;
            this.next = byte2IntAVLTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2IntAVLTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Byte)entry.getKey() && this.value == (Integer)entry.getValue();
        }
