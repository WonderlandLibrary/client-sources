...
Hash {
    ...
    public Byte2CharOpenCustomHashMap(int n, float f, ByteHash.Strategy strategy) {
    ...
    public Byte2CharOpenCustomHashMap(int n, ByteHash.Strategy strategy) {
    ...
    public Byte2CharOpenCustomHashMap(Map<? extends Byte, ? extends Character> map, float f, ByteHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Byte2CharOpenCustomHashMap(Map<? extends Byte, ? extends Character> map, ByteHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Byte2CharOpenCustomHashMap(Byte2CharMap byte2CharMap, float f, ByteHash.Strategy strategy) {
        this(byte2CharMap.size(), f, strategy);
        this.putAll(byte2CharMap);
    }

    public Byte2CharOpenCustomHashMap(Byte2CharMap byte2CharMap, ByteHash.Strategy strategy) {
        this(byte2CharMap, 0.75f, strategy);
    }

    public Byte2CharOpenCustomHashMap(byte[] byArray, char[] cArray, float f, ByteHash.Strategy strategy) {
    ...
    public Byte2CharOpenCustomHashMap(byte[] byArray, char[] cArray, ByteHash.Strategy strategy) {
        this(byArray, cArray, 0.75f, strategy);
    }
    ...
    public boolean remove(byte by, char c) {
        ...
        if (this.strategy.equals(by, by2) && c == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((by2 = byArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(by, by2) || c != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public CharCollection values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection(this){
                final Byte2CharOpenCustomHashMap this$0;
                {
                    this.this$0 = byte2CharOpenCustomHashMap;
                }
    ...
    public Byte2CharOpenCustomHashMap clone() {
        Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap;
        try {
            byte2CharOpenCustomHashMap = (Byte2CharOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2CharOpenCustomHashMap.keys = null;
        byte2CharOpenCustomHashMap.values = null;
        byte2CharOpenCustomHashMap.entries = null;
        byte2CharOpenCustomHashMap.containsNullKey = this.containsNullKey;
        byte2CharOpenCustomHashMap.key = (byte[])this.key.clone();
        byte2CharOpenCustomHashMap.value = (char[])this.value.clone();
        byte2CharOpenCustomHashMap.strategy = this.strategy;
        return byte2CharOpenCustomHashMap;
    }
    ...
    static char access$300(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap) {
        return byte2CharOpenCustomHashMap.removeNullEntry();
    }

    static char access$400(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap, int n) {
        return byte2CharOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements CharIterator {
        ...
        public ValueIterator(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap) {
            this.this$0 = byte2CharOpenCustomHashMap;
            super(byte2CharOpenCustomHashMap, null);
        }
    ...
    extends AbstractByteSet {
        ...
        private KeySet(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap) {
            this.this$0 = byte2CharOpenCustomHashMap;
        }
        ...
        KeySet(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap, 1 var2_2) {
            this(byte2CharOpenCustomHashMap);
        }
    }
    ...
    implements ByteIterator {
        ...
        public KeyIterator(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap) {
            this.this$0 = byte2CharOpenCustomHashMap;
            super(byte2CharOpenCustomHashMap, null);
        }
    ...
    implements Byte2CharMap.FastEntrySet {
        ...
        private MapEntrySet(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap) {
            this.this$0 = byte2CharOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(by, (byte)0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == c) {
                    Byte2CharOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(by2, by)) {
                if (this.this$0.value[n] == c) {
                    Byte2CharOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((by2 = byArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(by2, by) || this.this$0.value[n] != c);
            Byte2CharOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap, 1 var2_2) {
            this(byte2CharOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2CharMap.Entry> {
        ...
        private FastEntryIterator(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap) {
            this.this$0 = byte2CharOpenCustomHashMap;
            super(byte2CharOpenCustomHashMap, null);
        ...
        FastEntryIterator(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap, 1 var2_2) {
            this(byte2CharOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Byte2CharMap.Entry> {
        ...
        private EntryIterator(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap) {
            this.this$0 = byte2CharOpenCustomHashMap;
            super(byte2CharOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap, 1 var2_2) {
            this(byte2CharOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap) {
            this.this$0 = byte2CharOpenCustomHashMap;
        ...
        MapIterator(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap, 1 var2_2) {
            this(byte2CharOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Byte, Character> {
        ...
        MapEntry(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap, int n) {
            this.this$0 = byte2CharOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Byte2CharOpenCustomHashMap byte2CharOpenCustomHashMap) {
            this.this$0 = byte2CharOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Byte)entry.getKey()) && this.this$0.value[this.index] == ((Character)entry.getValue()).charValue();
        }
