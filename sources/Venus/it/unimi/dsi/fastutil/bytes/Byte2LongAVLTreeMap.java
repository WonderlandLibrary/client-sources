...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Byte2LongAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Byte2LongAVLTreeMap(Comparator<? super Byte> comparator) {
        this();
    ...
    public Byte2LongAVLTreeMap(SortedMap<Byte, Long> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Byte, ? extends Long>)sortedMap);
    }

    public Byte2LongAVLTreeMap(Byte2LongMap byte2LongMap) {
        this();
        this.putAll(byte2LongMap);
    }

    public Byte2LongAVLTreeMap(Byte2LongSortedMap byte2LongSortedMap) {
        this(byte2LongSortedMap.comparator());
        this.putAll(byte2LongSortedMap);
    }

    public Byte2LongAVLTreeMap(byte[] byArray, long[] lArray, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2LongAVLTreeMap(byte[] byArray, long[] lArray) {
    ...
    public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>(this){
                ...
                final Byte2LongAVLTreeMap this$0;
                {
                    this.this$0 = byte2LongAVLTreeMap;
    ...
    public Byte2LongAVLTreeMap clone() {
        Byte2LongAVLTreeMap byte2LongAVLTreeMap;
        try {
            byte2LongAVLTreeMap = (Byte2LongAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2LongAVLTreeMap.keys = null;
        byte2LongAVLTreeMap.values = null;
        byte2LongAVLTreeMap.entries = null;
        byte2LongAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2LongAVLTreeMap.firstEntry = byte2LongAVLTreeMap.tree = entry2.left;
                            while (byte2LongAVLTreeMap.firstEntry.left != null) {
                                byte2LongAVLTreeMap.firstEntry = byte2LongAVLTreeMap.firstEntry.left;
                            }
                            byte2LongAVLTreeMap.lastEntry = byte2LongAVLTreeMap.tree;
                            while (byte2LongAVLTreeMap.lastEntry.right != null) {
                                byte2LongAVLTreeMap.lastEntry = byte2LongAVLTreeMap.lastEntry.right;
                            }
                            return byte2LongAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Byte2LongAVLTreeMap byte2LongAVLTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2LongAVLTreeMap;
            if (!bl && !bl2 && byte2LongAVLTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2LongAVLTreeMap.defRetValue;
        }
    ...
    implements LongListIterator {
        ...
        private ValueIterator(Byte2LongAVLTreeMap byte2LongAVLTreeMap) {
            this.this$0 = byte2LongAVLTreeMap;
            super(byte2LongAVLTreeMap);
        }
        ...
        ValueIterator(Byte2LongAVLTreeMap byte2LongAVLTreeMap, 1 var2_2) {
            this(byte2LongAVLTreeMap);
        }
    }
    ...
    extends AbstractByte2LongSortedMap.KeySet {
        ...
        private KeySet(Byte2LongAVLTreeMap byte2LongAVLTreeMap) {
            this.this$0 = byte2LongAVLTreeMap;
            super(byte2LongAVLTreeMap);
        }
        ...
        KeySet(Byte2LongAVLTreeMap byte2LongAVLTreeMap, 1 var2_2) {
            this(byte2LongAVLTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2LongAVLTreeMap byte2LongAVLTreeMap) {
            this.this$0 = byte2LongAVLTreeMap;
            super(byte2LongAVLTreeMap);
        }

        public KeyIterator(Byte2LongAVLTreeMap byte2LongAVLTreeMap, byte by) {
            this.this$0 = byte2LongAVLTreeMap;
            super(byte2LongAVLTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2LongMap.Entry> {
        ...
        EntryIterator(Byte2LongAVLTreeMap byte2LongAVLTreeMap) {
            this.this$0 = byte2LongAVLTreeMap;
            super(byte2LongAVLTreeMap);
        }

        EntryIterator(Byte2LongAVLTreeMap byte2LongAVLTreeMap, byte by) {
            this.this$0 = byte2LongAVLTreeMap;
            super(byte2LongAVLTreeMap, by);
        }
        ...
        public void add(Object object) {
            this.add((Byte2LongMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Byte2LongMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2LongAVLTreeMap byte2LongAVLTreeMap) {
            this.this$0 = byte2LongAVLTreeMap;
            this.index = 0;
            this.next = byte2LongAVLTreeMap.firstEntry;
        }

        TreeIterator(Byte2LongAVLTreeMap byte2LongAVLTreeMap, byte by) {
            this.this$0 = byte2LongAVLTreeMap;
            this.index = 0;
            this.next = byte2LongAVLTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2LongAVLTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
