...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Byte2DoubleAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Byte2DoubleAVLTreeMap(Comparator<? super Byte> comparator) {
        this();
    ...
    public Byte2DoubleAVLTreeMap(SortedMap<Byte, Double> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Byte, ? extends Double>)sortedMap);
    }

    public Byte2DoubleAVLTreeMap(Byte2DoubleMap byte2DoubleMap) {
        this();
        this.putAll(byte2DoubleMap);
    }

    public Byte2DoubleAVLTreeMap(Byte2DoubleSortedMap byte2DoubleSortedMap) {
        this(byte2DoubleSortedMap.comparator());
        this.putAll(byte2DoubleSortedMap);
    }

    public Byte2DoubleAVLTreeMap(byte[] byArray, double[] dArray, Comparator<? super Byte> comparator) {
        this(comparator);
    ...
    public Byte2DoubleAVLTreeMap(byte[] byArray, double[] dArray) {
    ...
    public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>(this){
                ...
                final Byte2DoubleAVLTreeMap this$0;
                {
                    this.this$0 = byte2DoubleAVLTreeMap;
    ...
    public Byte2DoubleAVLTreeMap clone() {
        Byte2DoubleAVLTreeMap byte2DoubleAVLTreeMap;
        try {
            byte2DoubleAVLTreeMap = (Byte2DoubleAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2DoubleAVLTreeMap.keys = null;
        byte2DoubleAVLTreeMap.values = null;
        byte2DoubleAVLTreeMap.entries = null;
        byte2DoubleAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            byte2DoubleAVLTreeMap.firstEntry = byte2DoubleAVLTreeMap.tree = entry2.left;
                            while (byte2DoubleAVLTreeMap.firstEntry.left != null) {
                                byte2DoubleAVLTreeMap.firstEntry = byte2DoubleAVLTreeMap.firstEntry.left;
                            }
                            byte2DoubleAVLTreeMap.lastEntry = byte2DoubleAVLTreeMap.tree;
                            while (byte2DoubleAVLTreeMap.lastEntry.right != null) {
                                byte2DoubleAVLTreeMap.lastEntry = byte2DoubleAVLTreeMap.lastEntry.right;
                            }
                            return byte2DoubleAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Byte2DoubleAVLTreeMap byte2DoubleAVLTreeMap, byte by, boolean bl, byte by2, boolean bl2) {
            this.this$0 = byte2DoubleAVLTreeMap;
            if (!bl && !bl2 && byte2DoubleAVLTreeMap.compare(by, by2) > 0) {
            ...
            this.to = by2;
            this.top = bl2;
            this.defRetValue = byte2DoubleAVLTreeMap.defRetValue;
        }
    ...
    implements DoubleListIterator {
        ...
        private ValueIterator(Byte2DoubleAVLTreeMap byte2DoubleAVLTreeMap) {
            this.this$0 = byte2DoubleAVLTreeMap;
            super(byte2DoubleAVLTreeMap);
        }
        ...
        ValueIterator(Byte2DoubleAVLTreeMap byte2DoubleAVLTreeMap, 1 var2_2) {
            this(byte2DoubleAVLTreeMap);
        }
    }
    ...
    extends AbstractByte2DoubleSortedMap.KeySet {
        ...
        private KeySet(Byte2DoubleAVLTreeMap byte2DoubleAVLTreeMap) {
            this.this$0 = byte2DoubleAVLTreeMap;
            super(byte2DoubleAVLTreeMap);
        }
        ...
        KeySet(Byte2DoubleAVLTreeMap byte2DoubleAVLTreeMap, 1 var2_2) {
            this(byte2DoubleAVLTreeMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2DoubleAVLTreeMap byte2DoubleAVLTreeMap) {
            this.this$0 = byte2DoubleAVLTreeMap;
            super(byte2DoubleAVLTreeMap);
        }

        public KeyIterator(Byte2DoubleAVLTreeMap byte2DoubleAVLTreeMap, byte by) {
            this.this$0 = byte2DoubleAVLTreeMap;
            super(byte2DoubleAVLTreeMap, by);
        }
    ...
    implements ObjectListIterator<Byte2DoubleMap.Entry> {
        ...
        EntryIterator(Byte2DoubleAVLTreeMap byte2DoubleAVLTreeMap) {
            this.this$0 = byte2DoubleAVLTreeMap;
            super(byte2DoubleAVLTreeMap);
        }

        EntryIterator(Byte2DoubleAVLTreeMap byte2DoubleAVLTreeMap, byte by) {
            this.this$0 = byte2DoubleAVLTreeMap;
            super(byte2DoubleAVLTreeMap, by);
        }
        ...
        public void add(Object object) {
            this.add((Byte2DoubleMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Byte2DoubleMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Byte2DoubleAVLTreeMap byte2DoubleAVLTreeMap) {
            this.this$0 = byte2DoubleAVLTreeMap;
            this.index = 0;
            this.next = byte2DoubleAVLTreeMap.firstEntry;
        }

        TreeIterator(Byte2DoubleAVLTreeMap byte2DoubleAVLTreeMap, byte by) {
            this.this$0 = byte2DoubleAVLTreeMap;
            this.index = 0;
            this.next = byte2DoubleAVLTreeMap.locateKey(by);
            if (this.next != null) {
                if (byte2DoubleAVLTreeMap.compare(this.next.key, by) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
