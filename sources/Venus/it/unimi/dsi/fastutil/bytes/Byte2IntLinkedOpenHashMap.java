...
Hash {
    ...
    public Byte2IntLinkedOpenHashMap(Map<? extends Byte, ? extends Integer> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Byte2IntLinkedOpenHashMap(Map<? extends Byte, ? extends Integer> map) {
        this(map, 0.75f);
    }

    public Byte2IntLinkedOpenHashMap(Byte2IntMap byte2IntMap, float f) {
        this(byte2IntMap.size(), f);
        this.putAll(byte2IntMap);
    }

    public Byte2IntLinkedOpenHashMap(Byte2IntMap byte2IntMap) {
        this(byte2IntMap, 0.75f);
    }

    public Byte2IntLinkedOpenHashMap(byte[] byArray, int[] nArray, float f) {
        this(byArray.length, f);
        if (byArray.length != nArray.length) {
            throw new IllegalArgumentException("The key array and the value array have different lengths (" + byArray.length + " and " + nArray.length + ")");
        }
        for (int i = 0; i < byArray.length; ++i) {
            this.put(byArray[i], nArray[i]);
        }
    }

    public Byte2IntLinkedOpenHashMap(byte[] byArray, int[] nArray) {
        this(byArray, nArray, 0.75f);
    }
    ...
    private void insert(int n, byte by, int n2) {
        if (n == this.n) {
    ...
    public int addTo(byte by, int n) {
        int n2;
        if (by == 0) {
            ...
            if (by2 != 0) {
                ...
                while ((by2 = byArray[n2 = n2 + 1 & this.mask]) != 0) {
                    if (by2 != by) continue;
                    return this.addToValue(n2, n);
                }
            }
    ...
    public int getAndMoveToFirst(byte by) {
        if (by == 0) {
            if (this.containsNullKey) {
    ...
    public int getAndMoveToLast(byte by) {
        if (by == 0) {
            if (this.containsNullKey) {
    ...
    public int putAndMoveToFirst(byte by, int n) {
        int n2;
        if (by == 0) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public int putAndMoveToLast(byte by, int n) {
        int n2;
        if (by == 0) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public boolean containsValue(int n) {
        ...
        int n2 = this.n;
        while (n2-- != 0) {
            if (byArray[n2] == 0 || nArray[n2] != n) continue;
            return false;
        }
        return true;
    }
    ...
    public int getOrDefault(byte by, int n) {
        ...
        byte[] byArray = this.key;
        int n2 = HashCommon.mix(by) & this.mask;
        byte by2 = byArray[n2];
        if (by2 == 0) {
            return n;
        }
        ...
        do {
            if ((by2 = byArray[n2 = n2 + 1 & this.mask]) != 0) continue;
            return n;
        } while (by != by2);
        return this.value[n2];
    }
    ...
    public int computeIfAbsentNullable(byte by, IntFunction<? extends Integer> intFunction) {
        ...
        Integer n2 = intFunction.apply(by);
        if (n2 == null) {
            return this.defRetValue;
        }
        int n3 = n2;
        this.insert(-n - 1, by, n3);
        return n3;
    }
    ...
    public int computeIfPresent(byte by, BiFunction<? super Byte, ? super Integer, ? extends Integer> biFunction) {
        ...
        Integer n2 = biFunction.apply((Byte)by, (Integer)this.value[n]);
        if (n2 == null) {
            if (by == 0) {
                this.removeNullEntry();
            } else {
    ...
    public int compute(byte by, BiFunction<? super Byte, ? super Integer, ? extends Integer> biFunction) {
        Objects.requireNonNull(biFunction);
        int n = this.find(by);
        Integer n2 = biFunction.apply((Byte)by, n >= 0 ? Integer.valueOf(this.value[n]) : null);
        if (n2 == null) {
            if (n >= 0) {
                if (by == 0) {
                    this.removeNullEntry();
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection(this){
                final Byte2IntLinkedOpenHashMap this$0;
                {
                    this.this$0 = byte2IntLinkedOpenHashMap;
                }
    ...
    public Byte2IntLinkedOpenHashMap clone() {
        Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap;
        try {
            byte2IntLinkedOpenHashMap = (Byte2IntLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        byte2IntLinkedOpenHashMap.keys = null;
        byte2IntLinkedOpenHashMap.values = null;
        byte2IntLinkedOpenHashMap.entries = null;
        byte2IntLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        byte2IntLinkedOpenHashMap.key = (byte[])this.key.clone();
        byte2IntLinkedOpenHashMap.value = (int[])this.value.clone();
        byte2IntLinkedOpenHashMap.link = (long[])this.link.clone();
        return byte2IntLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet byte2IntEntrySet() {
    ...
    static int access$100(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap) {
        return byte2IntLinkedOpenHashMap.removeNullEntry();
    }

    static int access$200(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap, int n) {
        return byte2IntLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements IntListIterator {
        ...
        public ValueIterator(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap) {
            this.this$0 = byte2IntLinkedOpenHashMap;
            super(byte2IntLinkedOpenHashMap);
        }
    ...
    extends AbstractByteSortedSet {
        ...
        private KeySet(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap) {
            this.this$0 = byte2IntLinkedOpenHashMap;
        }
        ...
        KeySet(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap, 1 var2_2) {
            this(byte2IntLinkedOpenHashMap);
        }
    }
    ...
    implements ByteListIterator {
        ...
        public KeyIterator(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap, byte by) {
            this.this$0 = byte2IntLinkedOpenHashMap;
            super(byte2IntLinkedOpenHashMap, by, null);
        }
        ...
        public KeyIterator(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap) {
            this.this$0 = byte2IntLinkedOpenHashMap;
            super(byte2IntLinkedOpenHashMap);
        }
    ...
    implements Byte2IntSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap) {
            this.this$0 = byte2IntLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Byte2IntMap.Entry> subSet(Byte2IntMap.Entry entry, Byte2IntMap.Entry entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Byte2IntMap.Entry> tailSet(Byte2IntMap.Entry entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean contains(Object object) {
            ...
            int n2 = HashCommon.mix(by) & this.this$0.mask;
            byte by2 = byArray[n2];
            if (by2 == 0) {
                return true;
            }
            ...
            do {
                if ((by2 = byArray[n2 = n2 + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (by != by2);
            return this.this$0.value[n2] == n;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (by == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n) {
                    Byte2IntLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (by2 == by) {
                if (this.this$0.value[n2] == n) {
                    Byte2IntLinkedOpenHashMap.access$200(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((by2 = byArray[n2 = n2 + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (by2 != by || this.this$0.value[n2] != n);
            Byte2IntLinkedOpenHashMap.access$200(this.this$0, n2);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Byte2IntMap.Entry> iterator(Byte2IntMap.Entry entry) {
        ...
        public ObjectListIterator<Byte2IntMap.Entry> fastIterator(Byte2IntMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractByte2IntMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Byte2IntMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Byte2IntMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Byte2IntMap.Entry)object, (Byte2IntMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Byte2IntMap.Entry)object);
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Byte2IntMap.Entry entry) {
        ...
        MapEntrySet(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap, 1 var2_2) {
            this(byte2IntLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Byte2IntMap.Entry> {
        ...
        public FastEntryIterator(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap) {
            this.this$0 = byte2IntLinkedOpenHashMap;
            super(byte2IntLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap, byte by) {
            this.this$0 = byte2IntLinkedOpenHashMap;
            super(byte2IntLinkedOpenHashMap, by, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Byte2IntMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Byte2IntMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Byte2IntMap.Entry> {
        ...
        public EntryIterator(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap) {
            this.this$0 = byte2IntLinkedOpenHashMap;
            super(byte2IntLinkedOpenHashMap);
        }

        public EntryIterator(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap, byte by) {
            this.this$0 = byte2IntLinkedOpenHashMap;
            super(byte2IntLinkedOpenHashMap, by, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap) {
            this.this$0 = byte2IntLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = byte2IntLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap, byte by) {
            this.this$0 = byte2IntLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (by == 0) {
                if (byte2IntLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)byte2IntLinkedOpenHashMap.link[byte2IntLinkedOpenHashMap.n];
                    this.prev = byte2IntLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + by + " does not belong to this map.");
            }
            if (byte2IntLinkedOpenHashMap.key[byte2IntLinkedOpenHashMap.last] == by) {
                this.prev = byte2IntLinkedOpenHashMap.last;
                this.index = byte2IntLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(by) & byte2IntLinkedOpenHashMap.mask;
            while (byte2IntLinkedOpenHashMap.key[n] != 0) {
                if (byte2IntLinkedOpenHashMap.key[n] == by) {
                    this.next = (int)byte2IntLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & byte2IntLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + by + " does not belong to this map.");
        }
        ...
        MapIterator(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap, byte by, 1 var3_3) {
            this(byte2IntLinkedOpenHashMap, by);
        }
    }
    ...
    Map.Entry<Byte, Integer> {
        ...
        MapEntry(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap, int n) {
            this.this$0 = byte2IntLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Byte2IntLinkedOpenHashMap byte2IntLinkedOpenHashMap) {
            this.this$0 = byte2IntLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.key[this.index] == (Byte)entry.getKey() && this.this$0.value[this.index] == (Integer)entry.getValue();
        }
