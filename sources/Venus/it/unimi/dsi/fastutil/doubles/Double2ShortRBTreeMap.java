...
Cloneable {
    ...
    public Double2ShortRBTreeMap(Comparator<? super Double> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Double2ShortRBTreeMap(Map<? extends Double, ? extends Short> map) {
        this();
        this.putAll(map);
    }

    public Double2ShortRBTreeMap(SortedMap<Double, Short> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Double, ? extends Short>)sortedMap);
    }

    public Double2ShortRBTreeMap(Double2ShortMap double2ShortMap) {
        this();
        this.putAll(double2ShortMap);
    }

    public Double2ShortRBTreeMap(Double2ShortSortedMap double2ShortSortedMap) {
        this(double2ShortSortedMap.comparator());
        this.putAll(double2ShortSortedMap);
    }

    public Double2ShortRBTreeMap(double[] dArray, short[] sArray, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2ShortRBTreeMap(double[] dArray, short[] sArray) {
    ...
    public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>(this){
                ...
                final Double2ShortRBTreeMap this$0;
                {
                    this.this$0 = double2ShortRBTreeMap;
    ...
    public Double2ShortRBTreeMap clone() {
        Double2ShortRBTreeMap double2ShortRBTreeMap;
        try {
            double2ShortRBTreeMap = (Double2ShortRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2ShortRBTreeMap.keys = null;
        double2ShortRBTreeMap.values = null;
        double2ShortRBTreeMap.entries = null;
        double2ShortRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2ShortRBTreeMap.firstEntry = double2ShortRBTreeMap.tree = entry2.left;
                            while (double2ShortRBTreeMap.firstEntry.left != null) {
                                double2ShortRBTreeMap.firstEntry = double2ShortRBTreeMap.firstEntry.left;
                            }
                            double2ShortRBTreeMap.lastEntry = double2ShortRBTreeMap.tree;
                            while (double2ShortRBTreeMap.lastEntry.right != null) {
                                double2ShortRBTreeMap.lastEntry = double2ShortRBTreeMap.lastEntry.right;
                            }
                            return double2ShortRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Double2ShortRBTreeMap double2ShortRBTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2ShortRBTreeMap;
            if (!bl && !bl2 && double2ShortRBTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2ShortRBTreeMap.defRetValue;
        }
    ...
    implements ShortListIterator {
        ...
        private ValueIterator(Double2ShortRBTreeMap double2ShortRBTreeMap) {
            this.this$0 = double2ShortRBTreeMap;
            super(double2ShortRBTreeMap);
        }
        ...
        ValueIterator(Double2ShortRBTreeMap double2ShortRBTreeMap, 1 var2_2) {
            this(double2ShortRBTreeMap);
        }
    }
    ...
    extends AbstractDouble2ShortSortedMap.KeySet {
        ...
        private KeySet(Double2ShortRBTreeMap double2ShortRBTreeMap) {
            this.this$0 = double2ShortRBTreeMap;
            super(double2ShortRBTreeMap);
        }
        ...
        KeySet(Double2ShortRBTreeMap double2ShortRBTreeMap, 1 var2_2) {
            this(double2ShortRBTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2ShortRBTreeMap double2ShortRBTreeMap) {
            this.this$0 = double2ShortRBTreeMap;
            super(double2ShortRBTreeMap);
        }

        public KeyIterator(Double2ShortRBTreeMap double2ShortRBTreeMap, double d) {
            this.this$0 = double2ShortRBTreeMap;
            super(double2ShortRBTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2ShortMap.Entry> {
        ...
        EntryIterator(Double2ShortRBTreeMap double2ShortRBTreeMap) {
            this.this$0 = double2ShortRBTreeMap;
            super(double2ShortRBTreeMap);
        }

        EntryIterator(Double2ShortRBTreeMap double2ShortRBTreeMap, double d) {
            this.this$0 = double2ShortRBTreeMap;
            super(double2ShortRBTreeMap, d);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2ShortRBTreeMap double2ShortRBTreeMap) {
            this.this$0 = double2ShortRBTreeMap;
            this.index = 0;
            this.next = double2ShortRBTreeMap.firstEntry;
        }

        TreeIterator(Double2ShortRBTreeMap double2ShortRBTreeMap, double d) {
            this.this$0 = double2ShortRBTreeMap;
            this.index = 0;
            this.next = double2ShortRBTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2ShortRBTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
