...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Double2ObjectAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Double2ObjectAVLTreeMap(Comparator<? super Double> comparator) {
        this();
    ...
    public Double2ObjectAVLTreeMap(SortedMap<Double, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Double, V>)sortedMap);
    }

    public Double2ObjectAVLTreeMap(Double2ObjectMap<? extends V> double2ObjectMap) {
        this();
        this.putAll(double2ObjectMap);
    }

    public Double2ObjectAVLTreeMap(Double2ObjectSortedMap<V> double2ObjectSortedMap) {
        this(double2ObjectSortedMap.comparator());
        this.putAll(double2ObjectSortedMap);
    }

    public Double2ObjectAVLTreeMap(double[] dArray, V[] VArray, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2ObjectAVLTreeMap(double[] dArray, V[] VArray) {
    ...
    public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>(this){
                final Comparator<? super Double2ObjectMap.Entry<V>> comparator;
                final Double2ObjectAVLTreeMap this$0;
                {
                    this.this$0 = double2ObjectAVLTreeMap;
                ...
                public ObjectSortedSet<Double2ObjectMap.Entry<V>> subSet(Double2ObjectMap.Entry<V> entry, Double2ObjectMap.Entry<V> entry2) {
                    return this.this$0.subMap(entry.getDoubleKey(), entry2.getDoubleKey()).double2ObjectEntrySet();
                }

                @Override
                public ObjectSortedSet<Double2ObjectMap.Entry<V>> headSet(Double2ObjectMap.Entry<V> entry) {
                    return this.this$0.headMap(entry.getDoubleKey()).double2ObjectEntrySet();
                }

                @Override
                public ObjectSortedSet<Double2ObjectMap.Entry<V>> tailSet(Double2ObjectMap.Entry<V> entry) {
                    return this.this$0.tailMap(entry.getDoubleKey()).double2ObjectEntrySet();
                }
                ...
                private int lambda$$0(Double2ObjectMap.Entry entry, Double2ObjectMap.Entry entry2) {
    ...
    public Double2ObjectAVLTreeMap<V> clone() {
        Double2ObjectAVLTreeMap double2ObjectAVLTreeMap;
        try {
            double2ObjectAVLTreeMap = (Double2ObjectAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2ObjectAVLTreeMap.keys = null;
        double2ObjectAVLTreeMap.values = null;
        double2ObjectAVLTreeMap.entries = null;
        double2ObjectAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2ObjectAVLTreeMap.tree = entry2.left;
                            double2ObjectAVLTreeMap.firstEntry = double2ObjectAVLTreeMap.tree;
                            while (double2ObjectAVLTreeMap.firstEntry.left != null) {
                                double2ObjectAVLTreeMap.firstEntry = double2ObjectAVLTreeMap.firstEntry.left;
                            }
                            double2ObjectAVLTreeMap.lastEntry = double2ObjectAVLTreeMap.tree;
                            while (double2ObjectAVLTreeMap.lastEntry.right != null) {
                                double2ObjectAVLTreeMap.lastEntry = double2ObjectAVLTreeMap.lastEntry.right;
                            }
                            return double2ObjectAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Double2ObjectAVLTreeMap double2ObjectAVLTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2ObjectAVLTreeMap;
            if (!bl && !bl2 && double2ObjectAVLTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2ObjectAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>(this){
                    ...
                    @Override
                    public Comparator<? super Double2ObjectMap.Entry<V>> comparator() {
                        return this.this$1.this$0.double2ObjectEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Double2ObjectMap.Entry<V>> subSet(Double2ObjectMap.Entry<V> entry, Double2ObjectMap.Entry<V> entry2) {
                        return this.this$1.subMap(entry.getDoubleKey(), entry2.getDoubleKey()).double2ObjectEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Double2ObjectMap.Entry<V>> headSet(Double2ObjectMap.Entry<V> entry) {
                        return this.this$1.headMap(entry.getDoubleKey()).double2ObjectEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Double2ObjectMap.Entry<V>> tailSet(Double2ObjectMap.Entry<V> entry) {
                        return this.this$1.tailMap(entry.getDoubleKey()).double2ObjectEntrySet();
                    }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Double2ObjectAVLTreeMap double2ObjectAVLTreeMap) {
            this.this$0 = double2ObjectAVLTreeMap;
            super(double2ObjectAVLTreeMap);
        }
        ...
        ValueIterator(Double2ObjectAVLTreeMap double2ObjectAVLTreeMap, 1 var2_2) {
            this(double2ObjectAVLTreeMap);
        }
    }
    ...
    extends AbstractDouble2ObjectSortedMap.KeySet {
        ...
        private KeySet(Double2ObjectAVLTreeMap double2ObjectAVLTreeMap) {
            this.this$0 = double2ObjectAVLTreeMap;
            super(double2ObjectAVLTreeMap);
        }
        ...
        KeySet(Double2ObjectAVLTreeMap double2ObjectAVLTreeMap, 1 var2_2) {
            this(double2ObjectAVLTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2ObjectAVLTreeMap double2ObjectAVLTreeMap) {
            this.this$0 = double2ObjectAVLTreeMap;
            super(double2ObjectAVLTreeMap);
        }

        public KeyIterator(Double2ObjectAVLTreeMap double2ObjectAVLTreeMap, double d) {
            this.this$0 = double2ObjectAVLTreeMap;
            super(double2ObjectAVLTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2ObjectMap.Entry<V>> {
        ...
        EntryIterator(Double2ObjectAVLTreeMap double2ObjectAVLTreeMap) {
            this.this$0 = double2ObjectAVLTreeMap;
            super(double2ObjectAVLTreeMap);
        }

        EntryIterator(Double2ObjectAVLTreeMap double2ObjectAVLTreeMap, double d) {
            this.this$0 = double2ObjectAVLTreeMap;
            super(double2ObjectAVLTreeMap, d);
        }
        ...
        public void add(Object object) {
            this.add((Double2ObjectMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Double2ObjectMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2ObjectAVLTreeMap double2ObjectAVLTreeMap) {
            this.this$0 = double2ObjectAVLTreeMap;
            this.index = 0;
            this.next = double2ObjectAVLTreeMap.firstEntry;
        }

        TreeIterator(Double2ObjectAVLTreeMap double2ObjectAVLTreeMap, double d) {
            this.this$0 = double2ObjectAVLTreeMap;
            this.index = 0;
            this.next = double2ObjectAVLTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2ObjectAVLTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Double.doubleToLongBits(this.key) == Double.doubleToLongBits((Double)entry.getKey()) && Objects.equals(this.value, entry.getValue());
        }
