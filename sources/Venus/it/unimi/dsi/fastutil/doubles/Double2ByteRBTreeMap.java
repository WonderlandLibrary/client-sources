...
Cloneable {
    ...
    public Double2ByteRBTreeMap(Comparator<? super Double> comparator) {
        this();
    ...
    public Double2ByteRBTreeMap(SortedMap<Double, Byte> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Double, ? extends Byte>)sortedMap);
    }

    public Double2ByteRBTreeMap(Double2ByteMap double2ByteMap) {
        this();
        this.putAll(double2ByteMap);
    }

    public Double2ByteRBTreeMap(Double2ByteSortedMap double2ByteSortedMap) {
        this(double2ByteSortedMap.comparator());
        this.putAll(double2ByteSortedMap);
    }

    public Double2ByteRBTreeMap(double[] dArray, byte[] byArray, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2ByteRBTreeMap(double[] dArray, byte[] byArray) {
    ...
    public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>(this){
                ...
                final Double2ByteRBTreeMap this$0;
                {
                    this.this$0 = double2ByteRBTreeMap;
    ...
    public Double2ByteRBTreeMap clone() {
        Double2ByteRBTreeMap double2ByteRBTreeMap;
        try {
            double2ByteRBTreeMap = (Double2ByteRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2ByteRBTreeMap.keys = null;
        double2ByteRBTreeMap.values = null;
        double2ByteRBTreeMap.entries = null;
        double2ByteRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2ByteRBTreeMap.firstEntry = double2ByteRBTreeMap.tree = entry2.left;
                            while (double2ByteRBTreeMap.firstEntry.left != null) {
                                double2ByteRBTreeMap.firstEntry = double2ByteRBTreeMap.firstEntry.left;
                            }
                            double2ByteRBTreeMap.lastEntry = double2ByteRBTreeMap.tree;
                            while (double2ByteRBTreeMap.lastEntry.right != null) {
                                double2ByteRBTreeMap.lastEntry = double2ByteRBTreeMap.lastEntry.right;
                            }
                            return double2ByteRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Double2ByteRBTreeMap double2ByteRBTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2ByteRBTreeMap;
            if (!bl && !bl2 && double2ByteRBTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2ByteRBTreeMap.defRetValue;
        }
    ...
    implements ByteListIterator {
        ...
        private ValueIterator(Double2ByteRBTreeMap double2ByteRBTreeMap) {
            this.this$0 = double2ByteRBTreeMap;
            super(double2ByteRBTreeMap);
        }
        ...
        ValueIterator(Double2ByteRBTreeMap double2ByteRBTreeMap, 1 var2_2) {
            this(double2ByteRBTreeMap);
        }
    }
    ...
    extends AbstractDouble2ByteSortedMap.KeySet {
        ...
        private KeySet(Double2ByteRBTreeMap double2ByteRBTreeMap) {
            this.this$0 = double2ByteRBTreeMap;
            super(double2ByteRBTreeMap);
        }
        ...
        KeySet(Double2ByteRBTreeMap double2ByteRBTreeMap, 1 var2_2) {
            this(double2ByteRBTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2ByteRBTreeMap double2ByteRBTreeMap) {
            this.this$0 = double2ByteRBTreeMap;
            super(double2ByteRBTreeMap);
        }

        public KeyIterator(Double2ByteRBTreeMap double2ByteRBTreeMap, double d) {
            this.this$0 = double2ByteRBTreeMap;
            super(double2ByteRBTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2ByteMap.Entry> {
        ...
        EntryIterator(Double2ByteRBTreeMap double2ByteRBTreeMap) {
            this.this$0 = double2ByteRBTreeMap;
            super(double2ByteRBTreeMap);
        }

        EntryIterator(Double2ByteRBTreeMap double2ByteRBTreeMap, double d) {
            this.this$0 = double2ByteRBTreeMap;
            super(double2ByteRBTreeMap, d);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2ByteRBTreeMap double2ByteRBTreeMap) {
            this.this$0 = double2ByteRBTreeMap;
            this.index = 0;
            this.next = double2ByteRBTreeMap.firstEntry;
        }

        TreeIterator(Double2ByteRBTreeMap double2ByteRBTreeMap, double d) {
            this.this$0 = double2ByteRBTreeMap;
            this.index = 0;
            this.next = double2ByteRBTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2ByteRBTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
