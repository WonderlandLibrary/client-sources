...
Hash {
    ...
    public Double2ByteLinkedOpenHashMap(Map<? extends Double, ? extends Byte> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Double2ByteLinkedOpenHashMap(Map<? extends Double, ? extends Byte> map) {
        this(map, 0.75f);
    }

    public Double2ByteLinkedOpenHashMap(Double2ByteMap double2ByteMap, float f) {
        this(double2ByteMap.size(), f);
        this.putAll(double2ByteMap);
    }

    public Double2ByteLinkedOpenHashMap(Double2ByteMap double2ByteMap) {
        this(double2ByteMap, 0.75f);
    }

    public Double2ByteLinkedOpenHashMap(double[] dArray, byte[] byArray, float f) {
    ...
    public Double2ByteLinkedOpenHashMap(double[] dArray, byte[] byArray) {
    ...
    public byte getAndMoveToFirst(double d) {
        if (Double.doubleToLongBits(d) == 0L) {
            if (this.containsNullKey) {
    ...
    public byte getAndMoveToLast(double d) {
        if (Double.doubleToLongBits(d) == 0L) {
            if (this.containsNullKey) {
    ...
    public byte putAndMoveToFirst(double d, byte by) {
        int n;
        if (Double.doubleToLongBits(d) == 0L) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public byte putAndMoveToLast(double d, byte by) {
        int n;
        if (Double.doubleToLongBits(d) == 0L) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection(this){
                final Double2ByteLinkedOpenHashMap this$0;
                {
                    this.this$0 = double2ByteLinkedOpenHashMap;
                }
    ...
    public Double2ByteLinkedOpenHashMap clone() {
        Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap;
        try {
            double2ByteLinkedOpenHashMap = (Double2ByteLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2ByteLinkedOpenHashMap.keys = null;
        double2ByteLinkedOpenHashMap.values = null;
        double2ByteLinkedOpenHashMap.entries = null;
        double2ByteLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        double2ByteLinkedOpenHashMap.key = (double[])this.key.clone();
        double2ByteLinkedOpenHashMap.value = (byte[])this.value.clone();
        double2ByteLinkedOpenHashMap.link = (long[])this.link.clone();
        return double2ByteLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet double2ByteEntrySet() {
    ...
    static byte access$100(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap) {
        return double2ByteLinkedOpenHashMap.removeNullEntry();
    }

    static byte access$200(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap, int n) {
        return double2ByteLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ByteListIterator {
        ...
        public ValueIterator(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap) {
            this.this$0 = double2ByteLinkedOpenHashMap;
            super(double2ByteLinkedOpenHashMap);
        }
    ...
    extends AbstractDoubleSortedSet {
        ...
        private KeySet(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap) {
            this.this$0 = double2ByteLinkedOpenHashMap;
        }
        ...
        KeySet(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap, 1 var2_2) {
            this(double2ByteLinkedOpenHashMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap, double d) {
            this.this$0 = double2ByteLinkedOpenHashMap;
            super(double2ByteLinkedOpenHashMap, d, null);
        }
        ...
        public KeyIterator(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap) {
            this.this$0 = double2ByteLinkedOpenHashMap;
            super(double2ByteLinkedOpenHashMap);
        }
    ...
    implements Double2ByteSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap) {
            this.this$0 = double2ByteLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Double2ByteMap.Entry> subSet(Double2ByteMap.Entry entry, Double2ByteMap.Entry entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Double2ByteMap.Entry> headSet(Double2ByteMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Double2ByteMap.Entry> tailSet(Double2ByteMap.Entry entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (Double.doubleToLongBits(d) == 0L) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == by) {
                    Double2ByteLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (Double.doubleToLongBits(d2) == Double.doubleToLongBits(d)) {
                if (this.this$0.value[n] == by) {
                    Double2ByteLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Double2ByteMap.Entry> iterator(Double2ByteMap.Entry entry) {
        ...
        public ObjectListIterator<Double2ByteMap.Entry> fastIterator(Double2ByteMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Double2ByteMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractDouble2ByteMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Double2ByteMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Double2ByteMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Double2ByteMap.Entry)object, (Double2ByteMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Double2ByteMap.Entry)object);
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Double2ByteMap.Entry entry) {
        ...
        MapEntrySet(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap, 1 var2_2) {
            this(double2ByteLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Double2ByteMap.Entry> {
        ...
        public FastEntryIterator(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap) {
            this.this$0 = double2ByteLinkedOpenHashMap;
            super(double2ByteLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap, double d) {
            this.this$0 = double2ByteLinkedOpenHashMap;
            super(double2ByteLinkedOpenHashMap, d, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Double2ByteMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Double2ByteMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Double2ByteMap.Entry> {
        ...
        public EntryIterator(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap) {
            this.this$0 = double2ByteLinkedOpenHashMap;
            super(double2ByteLinkedOpenHashMap);
        }

        public EntryIterator(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap, double d) {
            this.this$0 = double2ByteLinkedOpenHashMap;
            super(double2ByteLinkedOpenHashMap, d, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap) {
            this.this$0 = double2ByteLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = double2ByteLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap, double d) {
            this.this$0 = double2ByteLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (Double.doubleToLongBits(d) == 0L) {
                if (double2ByteLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)double2ByteLinkedOpenHashMap.link[double2ByteLinkedOpenHashMap.n];
                    this.prev = double2ByteLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + d + " does not belong to this map.");
            }
            if (Double.doubleToLongBits(double2ByteLinkedOpenHashMap.key[double2ByteLinkedOpenHashMap.last]) == Double.doubleToLongBits(d)) {
                this.prev = double2ByteLinkedOpenHashMap.last;
                this.index = double2ByteLinkedOpenHashMap.size;
                return;
            }
            int n = (int)HashCommon.mix(Double.doubleToRawLongBits(d)) & double2ByteLinkedOpenHashMap.mask;
            while (Double.doubleToLongBits(double2ByteLinkedOpenHashMap.key[n]) != 0L) {
                if (Double.doubleToLongBits(double2ByteLinkedOpenHashMap.key[n]) == Double.doubleToLongBits(d)) {
                    this.next = (int)double2ByteLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & double2ByteLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + d + " does not belong to this map.");
        }
        ...
        public void set(Double2ByteMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Double2ByteMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap, double d, 1 var4_3) {
            this(double2ByteLinkedOpenHashMap, d);
        }
    }
    ...
    Map.Entry<Double, Byte> {
        ...
        MapEntry(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap, int n) {
            this.this$0 = double2ByteLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Double2ByteLinkedOpenHashMap double2ByteLinkedOpenHashMap) {
            this.this$0 = double2ByteLinkedOpenHashMap;
        }
