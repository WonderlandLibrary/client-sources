...
Cloneable {
    ...
    public Double2CharRBTreeMap(Comparator<? super Double> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Double2CharRBTreeMap(Map<? extends Double, ? extends Character> map) {
        this();
        this.putAll(map);
    }

    public Double2CharRBTreeMap(SortedMap<Double, Character> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Double, ? extends Character>)sortedMap);
    }

    public Double2CharRBTreeMap(Double2CharMap double2CharMap) {
        this();
        this.putAll(double2CharMap);
    }

    public Double2CharRBTreeMap(Double2CharSortedMap double2CharSortedMap) {
        this(double2CharSortedMap.comparator());
        this.putAll(double2CharSortedMap);
    }

    public Double2CharRBTreeMap(double[] dArray, char[] cArray, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2CharRBTreeMap(double[] dArray, char[] cArray) {
    ...
    public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2CharMap.Entry>(this){
                ...
                final Double2CharRBTreeMap this$0;
                {
                    this.this$0 = double2CharRBTreeMap;
    ...
    public Double2CharRBTreeMap clone() {
        Double2CharRBTreeMap double2CharRBTreeMap;
        try {
            double2CharRBTreeMap = (Double2CharRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2CharRBTreeMap.keys = null;
        double2CharRBTreeMap.values = null;
        double2CharRBTreeMap.entries = null;
        double2CharRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2CharRBTreeMap.firstEntry = double2CharRBTreeMap.tree = entry2.left;
                            while (double2CharRBTreeMap.firstEntry.left != null) {
                                double2CharRBTreeMap.firstEntry = double2CharRBTreeMap.firstEntry.left;
                            }
                            double2CharRBTreeMap.lastEntry = double2CharRBTreeMap.tree;
                            while (double2CharRBTreeMap.lastEntry.right != null) {
                                double2CharRBTreeMap.lastEntry = double2CharRBTreeMap.lastEntry.right;
                            }
                            return double2CharRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Double2CharRBTreeMap double2CharRBTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2CharRBTreeMap;
            if (!bl && !bl2 && double2CharRBTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2CharRBTreeMap.defRetValue;
        }
    ...
    implements CharListIterator {
        ...
        private ValueIterator(Double2CharRBTreeMap double2CharRBTreeMap) {
            this.this$0 = double2CharRBTreeMap;
            super(double2CharRBTreeMap);
        }
        ...
        ValueIterator(Double2CharRBTreeMap double2CharRBTreeMap, 1 var2_2) {
            this(double2CharRBTreeMap);
        }
    }
    ...
    extends AbstractDouble2CharSortedMap.KeySet {
        ...
        private KeySet(Double2CharRBTreeMap double2CharRBTreeMap) {
            this.this$0 = double2CharRBTreeMap;
            super(double2CharRBTreeMap);
        }
        ...
        KeySet(Double2CharRBTreeMap double2CharRBTreeMap, 1 var2_2) {
            this(double2CharRBTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2CharRBTreeMap double2CharRBTreeMap) {
            this.this$0 = double2CharRBTreeMap;
            super(double2CharRBTreeMap);
        }

        public KeyIterator(Double2CharRBTreeMap double2CharRBTreeMap, double d) {
            this.this$0 = double2CharRBTreeMap;
            super(double2CharRBTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2CharMap.Entry> {
        ...
        EntryIterator(Double2CharRBTreeMap double2CharRBTreeMap) {
            this.this$0 = double2CharRBTreeMap;
            super(double2CharRBTreeMap);
        }

        EntryIterator(Double2CharRBTreeMap double2CharRBTreeMap, double d) {
            this.this$0 = double2CharRBTreeMap;
            super(double2CharRBTreeMap, d);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2CharRBTreeMap double2CharRBTreeMap) {
            this.this$0 = double2CharRBTreeMap;
            this.index = 0;
            this.next = double2CharRBTreeMap.firstEntry;
        }

        TreeIterator(Double2CharRBTreeMap double2CharRBTreeMap, double d) {
            this.this$0 = double2CharRBTreeMap;
            this.index = 0;
            this.next = double2CharRBTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2CharRBTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
