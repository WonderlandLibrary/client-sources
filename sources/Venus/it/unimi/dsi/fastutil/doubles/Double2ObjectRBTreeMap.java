...
Cloneable {
    ...
    public Double2ObjectRBTreeMap(Comparator<? super Double> comparator) {
        this();
    ...
    public Double2ObjectRBTreeMap(SortedMap<Double, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Double, V>)sortedMap);
    }

    public Double2ObjectRBTreeMap(Double2ObjectMap<? extends V> double2ObjectMap) {
        this();
        this.putAll(double2ObjectMap);
    }

    public Double2ObjectRBTreeMap(Double2ObjectSortedMap<V> double2ObjectSortedMap) {
        this(double2ObjectSortedMap.comparator());
        this.putAll(double2ObjectSortedMap);
    }

    public Double2ObjectRBTreeMap(double[] dArray, V[] VArray, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2ObjectRBTreeMap(double[] dArray, V[] VArray) {
    ...
    public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>(this){
                ...
                final Double2ObjectRBTreeMap this$0;
                {
                    this.this$0 = double2ObjectRBTreeMap;
    ...
    public Double2ObjectRBTreeMap<V> clone() {
        Double2ObjectRBTreeMap double2ObjectRBTreeMap;
        try {
            double2ObjectRBTreeMap = (Double2ObjectRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2ObjectRBTreeMap.keys = null;
        double2ObjectRBTreeMap.values = null;
        double2ObjectRBTreeMap.entries = null;
        double2ObjectRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2ObjectRBTreeMap.tree = entry2.left;
                            double2ObjectRBTreeMap.firstEntry = double2ObjectRBTreeMap.tree;
                            while (double2ObjectRBTreeMap.firstEntry.left != null) {
                                double2ObjectRBTreeMap.firstEntry = double2ObjectRBTreeMap.firstEntry.left;
                            }
                            double2ObjectRBTreeMap.lastEntry = double2ObjectRBTreeMap.tree;
                            while (double2ObjectRBTreeMap.lastEntry.right != null) {
                                double2ObjectRBTreeMap.lastEntry = double2ObjectRBTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Double2ObjectRBTreeMap double2ObjectRBTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2ObjectRBTreeMap;
            if (!bl && !bl2 && double2ObjectRBTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2ObjectRBTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Double2ObjectRBTreeMap double2ObjectRBTreeMap) {
            this.this$0 = double2ObjectRBTreeMap;
            super(double2ObjectRBTreeMap);
        }
        ...
        ValueIterator(Double2ObjectRBTreeMap double2ObjectRBTreeMap, 1 var2_2) {
            this(double2ObjectRBTreeMap);
        }
    }
    ...
    extends AbstractDouble2ObjectSortedMap.KeySet {
        ...
        private KeySet(Double2ObjectRBTreeMap double2ObjectRBTreeMap) {
            this.this$0 = double2ObjectRBTreeMap;
            super(double2ObjectRBTreeMap);
        }
        ...
        KeySet(Double2ObjectRBTreeMap double2ObjectRBTreeMap, 1 var2_2) {
            this(double2ObjectRBTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2ObjectRBTreeMap double2ObjectRBTreeMap) {
            this.this$0 = double2ObjectRBTreeMap;
            super(double2ObjectRBTreeMap);
        }

        public KeyIterator(Double2ObjectRBTreeMap double2ObjectRBTreeMap, double d) {
            this.this$0 = double2ObjectRBTreeMap;
            super(double2ObjectRBTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2ObjectMap.Entry<V>> {
        ...
        EntryIterator(Double2ObjectRBTreeMap double2ObjectRBTreeMap) {
            this.this$0 = double2ObjectRBTreeMap;
            super(double2ObjectRBTreeMap);
        }

        EntryIterator(Double2ObjectRBTreeMap double2ObjectRBTreeMap, double d) {
            this.this$0 = double2ObjectRBTreeMap;
            super(double2ObjectRBTreeMap, d);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2ObjectRBTreeMap double2ObjectRBTreeMap) {
            this.this$0 = double2ObjectRBTreeMap;
            this.index = 0;
            this.next = double2ObjectRBTreeMap.firstEntry;
        }

        TreeIterator(Double2ObjectRBTreeMap double2ObjectRBTreeMap, double d) {
            this.this$0 = double2ObjectRBTreeMap;
            this.index = 0;
            this.next = double2ObjectRBTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2ObjectRBTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
