...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Double2ByteAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Double2ByteAVLTreeMap(Comparator<? super Double> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Double2ByteAVLTreeMap(Map<? extends Double, ? extends Byte> map) {
        this();
        this.putAll(map);
    }

    public Double2ByteAVLTreeMap(SortedMap<Double, Byte> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Double, ? extends Byte>)sortedMap);
    }

    public Double2ByteAVLTreeMap(Double2ByteMap double2ByteMap) {
        this();
        this.putAll(double2ByteMap);
    }

    public Double2ByteAVLTreeMap(Double2ByteSortedMap double2ByteSortedMap) {
        this(double2ByteSortedMap.comparator());
        this.putAll(double2ByteSortedMap);
    }

    public Double2ByteAVLTreeMap(double[] dArray, byte[] byArray, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2ByteAVLTreeMap(double[] dArray, byte[] byArray) {
        this(dArray, byArray, null);
    }
    ...
    public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>(this){
                final Comparator<? super Double2ByteMap.Entry> comparator;
                final Double2ByteAVLTreeMap this$0;
                {
                    this.this$0 = double2ByteAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator(Double2ByteMap.Entry entry) {
                ...
                public ObjectSortedSet<Double2ByteMap.Entry> subSet(Double2ByteMap.Entry entry, Double2ByteMap.Entry entry2) {
                    return this.this$0.subMap(entry.getDoubleKey(), entry2.getDoubleKey()).double2ByteEntrySet();
                }

                @Override
                public ObjectSortedSet<Double2ByteMap.Entry> headSet(Double2ByteMap.Entry entry) {
                    return this.this$0.headMap(entry.getDoubleKey()).double2ByteEntrySet();
                }

                @Override
                public ObjectSortedSet<Double2ByteMap.Entry> tailSet(Double2ByteMap.Entry entry) {
                    return this.this$0.tailMap(entry.getDoubleKey()).double2ByteEntrySet();
                }
                ...
                private int lambda$$0(Double2ByteMap.Entry entry, Double2ByteMap.Entry entry2) {
    ...
    public Double2ByteAVLTreeMap clone() {
        Double2ByteAVLTreeMap double2ByteAVLTreeMap;
        try {
            double2ByteAVLTreeMap = (Double2ByteAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2ByteAVLTreeMap.keys = null;
        double2ByteAVLTreeMap.values = null;
        double2ByteAVLTreeMap.entries = null;
        double2ByteAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2ByteAVLTreeMap.firstEntry = double2ByteAVLTreeMap.tree = entry2.left;
                            while (double2ByteAVLTreeMap.firstEntry.left != null) {
                                double2ByteAVLTreeMap.firstEntry = double2ByteAVLTreeMap.firstEntry.left;
                            }
                            double2ByteAVLTreeMap.lastEntry = double2ByteAVLTreeMap.tree;
                            while (double2ByteAVLTreeMap.lastEntry.right != null) {
                                double2ByteAVLTreeMap.lastEntry = double2ByteAVLTreeMap.lastEntry.right;
                            }
                            return double2ByteAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readDouble(), objectInputStream.readByte());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readDouble(), objectInputStream.readByte());
            entry4.right(new Entry(objectInputStream.readDouble(), objectInputStream.readByte()));
    ...
    implements Serializable {
        ...
        public Submap(Double2ByteAVLTreeMap double2ByteAVLTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2ByteAVLTreeMap;
            if (!bl && !bl2 && double2ByteAVLTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2ByteAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Double2ByteMap.Entry> comparator() {
                        return this.this$1.this$0.double2ByteEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Double2ByteMap.Entry> subSet(Double2ByteMap.Entry entry, Double2ByteMap.Entry entry2) {
                        return this.this$1.subMap(entry.getDoubleKey(), entry2.getDoubleKey()).double2ByteEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Double2ByteMap.Entry> headSet(Double2ByteMap.Entry entry) {
                        return this.this$1.headMap(entry.getDoubleKey()).double2ByteEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Double2ByteMap.Entry> tailSet(Double2ByteMap.Entry entry) {
                        return this.this$1.tailMap(entry.getDoubleKey()).double2ByteEntrySet();
                    }
    ...
    implements ByteListIterator {
        ...
        private ValueIterator(Double2ByteAVLTreeMap double2ByteAVLTreeMap) {
            this.this$0 = double2ByteAVLTreeMap;
            super(double2ByteAVLTreeMap);
        }
        ...
        ValueIterator(Double2ByteAVLTreeMap double2ByteAVLTreeMap, 1 var2_2) {
            this(double2ByteAVLTreeMap);
        }
    }
    ...
    extends AbstractDouble2ByteSortedMap.KeySet {
        ...
        private KeySet(Double2ByteAVLTreeMap double2ByteAVLTreeMap) {
            this.this$0 = double2ByteAVLTreeMap;
            super(double2ByteAVLTreeMap);
        }
        ...
        KeySet(Double2ByteAVLTreeMap double2ByteAVLTreeMap, 1 var2_2) {
            this(double2ByteAVLTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2ByteAVLTreeMap double2ByteAVLTreeMap) {
            this.this$0 = double2ByteAVLTreeMap;
            super(double2ByteAVLTreeMap);
        }

        public KeyIterator(Double2ByteAVLTreeMap double2ByteAVLTreeMap, double d) {
            this.this$0 = double2ByteAVLTreeMap;
            super(double2ByteAVLTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2ByteMap.Entry> {
        ...
        EntryIterator(Double2ByteAVLTreeMap double2ByteAVLTreeMap) {
            this.this$0 = double2ByteAVLTreeMap;
            super(double2ByteAVLTreeMap);
        }

        EntryIterator(Double2ByteAVLTreeMap double2ByteAVLTreeMap, double d) {
            this.this$0 = double2ByteAVLTreeMap;
            super(double2ByteAVLTreeMap, d);
        }
        ...
        public void add(Object object) {
            this.add((Double2ByteMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Double2ByteMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2ByteAVLTreeMap double2ByteAVLTreeMap) {
            this.this$0 = double2ByteAVLTreeMap;
            this.index = 0;
            this.next = double2ByteAVLTreeMap.firstEntry;
        }

        TreeIterator(Double2ByteAVLTreeMap double2ByteAVLTreeMap, double d) {
            this.this$0 = double2ByteAVLTreeMap;
            this.index = 0;
            this.next = double2ByteAVLTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2ByteAVLTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Double.doubleToLongBits(this.key) == Double.doubleToLongBits((Double)entry.getKey()) && this.value == (Byte)entry.getValue();
        }
