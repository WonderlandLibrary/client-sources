...
Cloneable {
    ...
    public Double2DoubleRBTreeMap(Comparator<? super Double> comparator) {
        this();
    ...
    public Double2DoubleRBTreeMap(SortedMap<Double, Double> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Double, ? extends Double>)sortedMap);
    }

    public Double2DoubleRBTreeMap(Double2DoubleMap double2DoubleMap) {
        this();
        this.putAll(double2DoubleMap);
    }

    public Double2DoubleRBTreeMap(Double2DoubleSortedMap double2DoubleSortedMap) {
        this(double2DoubleSortedMap.comparator());
        this.putAll(double2DoubleSortedMap);
    }

    public Double2DoubleRBTreeMap(double[] dArray, double[] dArray2, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2DoubleRBTreeMap(double[] dArray, double[] dArray2) {
    ...
    public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2DoubleMap.Entry>(this){
                ...
                final Double2DoubleRBTreeMap this$0;
                {
                    this.this$0 = double2DoubleRBTreeMap;
    ...
    public Double2DoubleRBTreeMap clone() {
        Double2DoubleRBTreeMap double2DoubleRBTreeMap;
        try {
            double2DoubleRBTreeMap = (Double2DoubleRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2DoubleRBTreeMap.keys = null;
        double2DoubleRBTreeMap.values = null;
        double2DoubleRBTreeMap.entries = null;
        double2DoubleRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2DoubleRBTreeMap.firstEntry = double2DoubleRBTreeMap.tree = entry2.left;
                            while (double2DoubleRBTreeMap.firstEntry.left != null) {
                                double2DoubleRBTreeMap.firstEntry = double2DoubleRBTreeMap.firstEntry.left;
                            }
                            double2DoubleRBTreeMap.lastEntry = double2DoubleRBTreeMap.tree;
                            while (double2DoubleRBTreeMap.lastEntry.right != null) {
                                double2DoubleRBTreeMap.lastEntry = double2DoubleRBTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Double2DoubleRBTreeMap double2DoubleRBTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2DoubleRBTreeMap;
            if (!bl && !bl2 && double2DoubleRBTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2DoubleRBTreeMap.defRetValue;
        }
    ...
    implements DoubleListIterator {
        ...
        private ValueIterator(Double2DoubleRBTreeMap double2DoubleRBTreeMap) {
            this.this$0 = double2DoubleRBTreeMap;
            super(double2DoubleRBTreeMap);
        }
        ...
        ValueIterator(Double2DoubleRBTreeMap double2DoubleRBTreeMap, 1 var2_2) {
            this(double2DoubleRBTreeMap);
        }
    }
    ...
    extends AbstractDouble2DoubleSortedMap.KeySet {
        ...
        private KeySet(Double2DoubleRBTreeMap double2DoubleRBTreeMap) {
            this.this$0 = double2DoubleRBTreeMap;
            super(double2DoubleRBTreeMap);
        }
        ...
        KeySet(Double2DoubleRBTreeMap double2DoubleRBTreeMap, 1 var2_2) {
            this(double2DoubleRBTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2DoubleRBTreeMap double2DoubleRBTreeMap) {
            this.this$0 = double2DoubleRBTreeMap;
            super(double2DoubleRBTreeMap);
        }

        public KeyIterator(Double2DoubleRBTreeMap double2DoubleRBTreeMap, double d) {
            this.this$0 = double2DoubleRBTreeMap;
            super(double2DoubleRBTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2DoubleMap.Entry> {
        ...
        EntryIterator(Double2DoubleRBTreeMap double2DoubleRBTreeMap) {
            this.this$0 = double2DoubleRBTreeMap;
            super(double2DoubleRBTreeMap);
        }

        EntryIterator(Double2DoubleRBTreeMap double2DoubleRBTreeMap, double d) {
            this.this$0 = double2DoubleRBTreeMap;
            super(double2DoubleRBTreeMap, d);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2DoubleRBTreeMap double2DoubleRBTreeMap) {
            this.this$0 = double2DoubleRBTreeMap;
            this.index = 0;
            this.next = double2DoubleRBTreeMap.firstEntry;
        }

        TreeIterator(Double2DoubleRBTreeMap double2DoubleRBTreeMap, double d) {
            this.this$0 = double2DoubleRBTreeMap;
            this.index = 0;
            this.next = double2DoubleRBTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2DoubleRBTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
