...
Hash {
    ...
    public Double2IntLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Double2IntLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Double2IntLinkedOpenHashMap(Map<? extends Double, ? extends Integer> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }
    ...
    public Double2IntLinkedOpenHashMap(Double2IntMap double2IntMap, float f) {
        this(double2IntMap.size(), f);
        this.putAll(double2IntMap);
    }

    public Double2IntLinkedOpenHashMap(Double2IntMap double2IntMap) {
        this(double2IntMap, 0.75f);
    }

    public Double2IntLinkedOpenHashMap(double[] dArray, int[] nArray, float f) {
    ...
    public Double2IntLinkedOpenHashMap(double[] dArray, int[] nArray) {
    ...
    public int getAndMoveToFirst(double d) {
        if (Double.doubleToLongBits(d) == 0L) {
            if (this.containsNullKey) {
    ...
    public int getAndMoveToLast(double d) {
        if (Double.doubleToLongBits(d) == 0L) {
            if (this.containsNullKey) {
    ...
    public int putAndMoveToFirst(double d, int n) {
        int n2;
        if (Double.doubleToLongBits(d) == 0L) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public int putAndMoveToLast(double d, int n) {
        int n2;
        if (Double.doubleToLongBits(d) == 0L) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection(this){
                final Double2IntLinkedOpenHashMap this$0;
                {
                    this.this$0 = double2IntLinkedOpenHashMap;
                }
    ...
    public Double2IntLinkedOpenHashMap clone() {
        ...
        try {
            double2IntLinkedOpenHashMap = (Double2IntLinkedOpenHashMap)super.clone();
    ...
    static int access$100(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap) {
        return double2IntLinkedOpenHashMap.removeNullEntry();
    }

    static int access$200(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap, int n) {
        return double2IntLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements IntListIterator {
        ...
        public ValueIterator(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap) {
            this.this$0 = double2IntLinkedOpenHashMap;
            super(double2IntLinkedOpenHashMap);
        }
    ...
    extends AbstractDoubleSortedSet {
        ...
        private KeySet(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap) {
            this.this$0 = double2IntLinkedOpenHashMap;
        }
        ...
        KeySet(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap, 1 var2_2) {
            this(double2IntLinkedOpenHashMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap, double d) {
            this.this$0 = double2IntLinkedOpenHashMap;
            super(double2IntLinkedOpenHashMap, d, null);
        }
        ...
        public KeyIterator(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap) {
            this.this$0 = double2IntLinkedOpenHashMap;
            super(double2IntLinkedOpenHashMap);
        }
    ...
    implements Double2IntSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap) {
            this.this$0 = double2IntLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (Double.doubleToLongBits(d) == 0L) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n) {
                    Double2IntLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (Double.doubleToLongBits(d2) == Double.doubleToLongBits(d)) {
                if (this.this$0.value[n2] == n) {
                    Double2IntLinkedOpenHashMap.access$200(this.this$0, n2);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Double2IntMap.Entry> iterator(Double2IntMap.Entry entry) {
        ...
        public ObjectListIterator<Double2IntMap.Entry> fastIterator(Double2IntMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Double2IntMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractDouble2IntMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Double2IntMap.Entry entry) {
        ...
        MapEntrySet(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap, 1 var2_2) {
            this(double2IntLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Double2IntMap.Entry> {
        ...
        public FastEntryIterator(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap) {
            this.this$0 = double2IntLinkedOpenHashMap;
            super(double2IntLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap, double d) {
            this.this$0 = double2IntLinkedOpenHashMap;
            super(double2IntLinkedOpenHashMap, d, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Double2IntMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Double2IntMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Double2IntMap.Entry> {
        ...
        public EntryIterator(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap) {
            this.this$0 = double2IntLinkedOpenHashMap;
            super(double2IntLinkedOpenHashMap);
        }

        public EntryIterator(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap, double d) {
            this.this$0 = double2IntLinkedOpenHashMap;
            super(double2IntLinkedOpenHashMap, d, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap) {
            this.this$0 = double2IntLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = double2IntLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap, double d) {
            this.this$0 = double2IntLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (Double.doubleToLongBits(d) == 0L) {
                if (double2IntLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)double2IntLinkedOpenHashMap.link[double2IntLinkedOpenHashMap.n];
                    this.prev = double2IntLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + d + " does not belong to this map.");
            }
            if (Double.doubleToLongBits(double2IntLinkedOpenHashMap.key[double2IntLinkedOpenHashMap.last]) == Double.doubleToLongBits(d)) {
                this.prev = double2IntLinkedOpenHashMap.last;
                this.index = double2IntLinkedOpenHashMap.size;
                return;
            }
            int n = (int)HashCommon.mix(Double.doubleToRawLongBits(d)) & double2IntLinkedOpenHashMap.mask;
            while (Double.doubleToLongBits(double2IntLinkedOpenHashMap.key[n]) != 0L) {
                if (Double.doubleToLongBits(double2IntLinkedOpenHashMap.key[n]) == Double.doubleToLongBits(d)) {
                    this.next = (int)double2IntLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & double2IntLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + d + " does not belong to this map.");
        }
        ...
        MapIterator(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap, double d, 1 var4_3) {
            this(double2IntLinkedOpenHashMap, d);
        }
    }
    ...
    Map.Entry<Double, Integer> {
        ...
        MapEntry(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap, int n) {
            this.this$0 = double2IntLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Double2IntLinkedOpenHashMap double2IntLinkedOpenHashMap) {
            this.this$0 = double2IntLinkedOpenHashMap;
        }
