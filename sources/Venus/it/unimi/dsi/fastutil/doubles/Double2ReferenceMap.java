...
Map<Double, V> {
    ...
    default public V put(Double d, V v) {
        return Double2ReferenceFunction.super.put(d, v);
    }

    @Override
    @Deprecated
    default public V get(Object object) {
        return Double2ReferenceFunction.super.get(object);
    }

    @Override
    @Deprecated
    default public V remove(Object object) {
        return Double2ReferenceFunction.super.remove(object);
    }
    ...
    default public boolean containsKey(Object object) {
        return Double2ReferenceFunction.super.containsKey(object);
    }
    ...
    default public boolean remove(double d, Object object) {
        Object v = this.get(d);
        if (v != object || v == this.defaultReturnValue() && !this.containsKey(d)) {
            return true;
        }
        this.remove(d);
        return false;
    ...
    default public boolean replace(double d, V v, V v2) {
        Object v3 = this.get(d);
        if (v3 != v || v3 == this.defaultReturnValue() && !this.containsKey(d)) {
            return true;
        }
        this.put(d, v2);
        return false;
    ...
    default public V computeIfAbsentPartial(double d, Double2ReferenceFunction<? extends V> double2ReferenceFunction) {
        ...
        V v3 = double2ReferenceFunction.get(d);
        this.put(d, v3);
        return v3;
    }
