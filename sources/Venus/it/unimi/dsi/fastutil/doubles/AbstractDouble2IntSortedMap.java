...
implements Double2IntSortedMap {
    ...
    implements IntIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Double2IntMap.Entry> objectBidirectionalIterator) {
    ...
    extends AbstractIntCollection {
        final AbstractDouble2IntSortedMap this$0;

        protected ValuesCollection(AbstractDouble2IntSortedMap abstractDouble2IntSortedMap) {
            this.this$0 = abstractDouble2IntSortedMap;
        }

        @Override
        public IntIterator iterator() {
            return new ValuesIterator(Double2IntSortedMaps.fastIterator(this.this$0));
        }
    ...
    implements DoubleBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Double2IntMap.Entry> objectBidirectionalIterator) {
            this.i = objectBidirectionalIterator;
        }
    ...
    extends AbstractDoubleSortedSet {
        ...
        protected KeySet(AbstractDouble2IntSortedMap abstractDouble2IntSortedMap) {
            this.this$0 = abstractDouble2IntSortedMap;
        }
        ...
        public DoubleBidirectionalIterator iterator(double d) {
            return new KeySetIterator(this.this$0.double2IntEntrySet().iterator(new AbstractDouble2IntMap.BasicEntry(d, 0)));
        }

        @Override
        public DoubleBidirectionalIterator iterator() {
            return new KeySetIterator(Double2IntSortedMaps.fastIterator(this.this$0));
        }
