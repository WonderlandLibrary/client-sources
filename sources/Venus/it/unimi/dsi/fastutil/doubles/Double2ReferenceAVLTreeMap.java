...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Double2ReferenceAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Double2ReferenceAVLTreeMap(Comparator<? super Double> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Double2ReferenceAVLTreeMap(Map<? extends Double, ? extends V> map) {
        this();
        this.putAll((Map<Double, ? extends V>)map);
    }

    public Double2ReferenceAVLTreeMap(SortedMap<Double, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Double, V>)sortedMap);
    }

    public Double2ReferenceAVLTreeMap(Double2ReferenceMap<? extends V> double2ReferenceMap) {
        this();
        this.putAll(double2ReferenceMap);
    }

    public Double2ReferenceAVLTreeMap(Double2ReferenceSortedMap<V> double2ReferenceSortedMap) {
        this(double2ReferenceSortedMap.comparator());
        this.putAll(double2ReferenceSortedMap);
    }

    public Double2ReferenceAVLTreeMap(double[] dArray, V[] VArray, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2ReferenceAVLTreeMap(double[] dArray, V[] VArray) {
    ...
    public ObjectSortedSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ReferenceMap.Entry<V>>(this){
                ...
                final Double2ReferenceAVLTreeMap this$0;
                {
                    this.this$0 = double2ReferenceAVLTreeMap;
    ...
    public Double2ReferenceAVLTreeMap<V> clone() {
        Double2ReferenceAVLTreeMap double2ReferenceAVLTreeMap;
        try {
            double2ReferenceAVLTreeMap = (Double2ReferenceAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2ReferenceAVLTreeMap.keys = null;
        double2ReferenceAVLTreeMap.values = null;
        double2ReferenceAVLTreeMap.entries = null;
        double2ReferenceAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2ReferenceAVLTreeMap.tree = entry2.left;
                            double2ReferenceAVLTreeMap.firstEntry = double2ReferenceAVLTreeMap.tree;
                            while (double2ReferenceAVLTreeMap.firstEntry.left != null) {
                                double2ReferenceAVLTreeMap.firstEntry = double2ReferenceAVLTreeMap.firstEntry.left;
                            }
                            double2ReferenceAVLTreeMap.lastEntry = double2ReferenceAVLTreeMap.tree;
                            while (double2ReferenceAVLTreeMap.lastEntry.right != null) {
                                double2ReferenceAVLTreeMap.lastEntry = double2ReferenceAVLTreeMap.lastEntry.right;
                            }
                            return double2ReferenceAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Double2ReferenceAVLTreeMap double2ReferenceAVLTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2ReferenceAVLTreeMap;
            if (!bl && !bl2 && double2ReferenceAVLTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2ReferenceAVLTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Double2ReferenceAVLTreeMap double2ReferenceAVLTreeMap) {
            this.this$0 = double2ReferenceAVLTreeMap;
            super(double2ReferenceAVLTreeMap);
        }
        ...
        ValueIterator(Double2ReferenceAVLTreeMap double2ReferenceAVLTreeMap, 1 var2_2) {
            this(double2ReferenceAVLTreeMap);
        }
    }
    ...
    extends AbstractDouble2ReferenceSortedMap.KeySet {
        ...
        private KeySet(Double2ReferenceAVLTreeMap double2ReferenceAVLTreeMap) {
            this.this$0 = double2ReferenceAVLTreeMap;
            super(double2ReferenceAVLTreeMap);
        }
        ...
        KeySet(Double2ReferenceAVLTreeMap double2ReferenceAVLTreeMap, 1 var2_2) {
            this(double2ReferenceAVLTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2ReferenceAVLTreeMap double2ReferenceAVLTreeMap) {
            this.this$0 = double2ReferenceAVLTreeMap;
            super(double2ReferenceAVLTreeMap);
        }

        public KeyIterator(Double2ReferenceAVLTreeMap double2ReferenceAVLTreeMap, double d) {
            this.this$0 = double2ReferenceAVLTreeMap;
            super(double2ReferenceAVLTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2ReferenceMap.Entry<V>> {
        ...
        EntryIterator(Double2ReferenceAVLTreeMap double2ReferenceAVLTreeMap) {
            this.this$0 = double2ReferenceAVLTreeMap;
            super(double2ReferenceAVLTreeMap);
        }

        EntryIterator(Double2ReferenceAVLTreeMap double2ReferenceAVLTreeMap, double d) {
            this.this$0 = double2ReferenceAVLTreeMap;
            super(double2ReferenceAVLTreeMap, d);
        }
        ...
        public void add(Object object) {
            this.add((Double2ReferenceMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Double2ReferenceMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2ReferenceAVLTreeMap double2ReferenceAVLTreeMap) {
            this.this$0 = double2ReferenceAVLTreeMap;
            this.index = 0;
            this.next = double2ReferenceAVLTreeMap.firstEntry;
        }

        TreeIterator(Double2ReferenceAVLTreeMap double2ReferenceAVLTreeMap, double d) {
            this.this$0 = double2ReferenceAVLTreeMap;
            this.index = 0;
            this.next = double2ReferenceAVLTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2ReferenceAVLTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
