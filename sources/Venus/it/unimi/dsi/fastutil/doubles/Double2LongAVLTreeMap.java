...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Double2LongAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Double2LongAVLTreeMap(Comparator<? super Double> comparator) {
        this();
    ...
    public Double2LongAVLTreeMap(SortedMap<Double, Long> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Double, ? extends Long>)sortedMap);
    }

    public Double2LongAVLTreeMap(Double2LongMap double2LongMap) {
        this();
        this.putAll(double2LongMap);
    }

    public Double2LongAVLTreeMap(Double2LongSortedMap double2LongSortedMap) {
        this(double2LongSortedMap.comparator());
        this.putAll(double2LongSortedMap);
    }

    public Double2LongAVLTreeMap(double[] dArray, long[] lArray, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2LongAVLTreeMap(double[] dArray, long[] lArray) {
    ...
    public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2LongMap.Entry>(this){
                ...
                final Double2LongAVLTreeMap this$0;
                {
                    this.this$0 = double2LongAVLTreeMap;
    ...
    public Double2LongAVLTreeMap clone() {
        Double2LongAVLTreeMap double2LongAVLTreeMap;
        try {
            double2LongAVLTreeMap = (Double2LongAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2LongAVLTreeMap.keys = null;
        double2LongAVLTreeMap.values = null;
        double2LongAVLTreeMap.entries = null;
        double2LongAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2LongAVLTreeMap.firstEntry = double2LongAVLTreeMap.tree = entry2.left;
                            while (double2LongAVLTreeMap.firstEntry.left != null) {
                                double2LongAVLTreeMap.firstEntry = double2LongAVLTreeMap.firstEntry.left;
                            }
                            double2LongAVLTreeMap.lastEntry = double2LongAVLTreeMap.tree;
                            while (double2LongAVLTreeMap.lastEntry.right != null) {
                                double2LongAVLTreeMap.lastEntry = double2LongAVLTreeMap.lastEntry.right;
                            }
                            return double2LongAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Double2LongAVLTreeMap double2LongAVLTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2LongAVLTreeMap;
            if (!bl && !bl2 && double2LongAVLTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2LongAVLTreeMap.defRetValue;
        }
    ...
    implements LongListIterator {
        ...
        private ValueIterator(Double2LongAVLTreeMap double2LongAVLTreeMap) {
            this.this$0 = double2LongAVLTreeMap;
            super(double2LongAVLTreeMap);
        }
        ...
        ValueIterator(Double2LongAVLTreeMap double2LongAVLTreeMap, 1 var2_2) {
            this(double2LongAVLTreeMap);
        }
    }
    ...
    extends AbstractDouble2LongSortedMap.KeySet {
        ...
        private KeySet(Double2LongAVLTreeMap double2LongAVLTreeMap) {
            this.this$0 = double2LongAVLTreeMap;
            super(double2LongAVLTreeMap);
        }
        ...
        KeySet(Double2LongAVLTreeMap double2LongAVLTreeMap, 1 var2_2) {
            this(double2LongAVLTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2LongAVLTreeMap double2LongAVLTreeMap) {
            this.this$0 = double2LongAVLTreeMap;
            super(double2LongAVLTreeMap);
        }

        public KeyIterator(Double2LongAVLTreeMap double2LongAVLTreeMap, double d) {
            this.this$0 = double2LongAVLTreeMap;
            super(double2LongAVLTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2LongMap.Entry> {
        ...
        EntryIterator(Double2LongAVLTreeMap double2LongAVLTreeMap) {
            this.this$0 = double2LongAVLTreeMap;
            super(double2LongAVLTreeMap);
        }

        EntryIterator(Double2LongAVLTreeMap double2LongAVLTreeMap, double d) {
            this.this$0 = double2LongAVLTreeMap;
            super(double2LongAVLTreeMap, d);
        }
        ...
        public void add(Object object) {
            this.add((Double2LongMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Double2LongMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2LongAVLTreeMap double2LongAVLTreeMap) {
            this.this$0 = double2LongAVLTreeMap;
            this.index = 0;
            this.next = double2LongAVLTreeMap.firstEntry;
        }

        TreeIterator(Double2LongAVLTreeMap double2LongAVLTreeMap, double d) {
            this.this$0 = double2LongAVLTreeMap;
            this.index = 0;
            this.next = double2LongAVLTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2LongAVLTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
