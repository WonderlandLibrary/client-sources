...
Hash {
    ...
    public Double2DoubleOpenCustomHashMap(int n, float f, DoubleHash.Strategy strategy) {
    ...
    public Double2DoubleOpenCustomHashMap(int n, DoubleHash.Strategy strategy) {
    ...
    public Double2DoubleOpenCustomHashMap(Map<? extends Double, ? extends Double> map, float f, DoubleHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Double2DoubleOpenCustomHashMap(Map<? extends Double, ? extends Double> map, DoubleHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Double2DoubleOpenCustomHashMap(Double2DoubleMap double2DoubleMap, float f, DoubleHash.Strategy strategy) {
        this(double2DoubleMap.size(), f, strategy);
        this.putAll(double2DoubleMap);
    }

    public Double2DoubleOpenCustomHashMap(Double2DoubleMap double2DoubleMap, DoubleHash.Strategy strategy) {
        this(double2DoubleMap, 0.75f, strategy);
    }

    public Double2DoubleOpenCustomHashMap(double[] dArray, double[] dArray2, float f, DoubleHash.Strategy strategy) {
    ...
    public Double2DoubleOpenCustomHashMap(double[] dArray, double[] dArray2, DoubleHash.Strategy strategy) {
        this(dArray, dArray2, 0.75f, strategy);
    }
        ...
        if (this.strategy.equals(d, 0.0)) {
            ...
            if (Double.doubleToLongBits(d3) != 0L) {
                ...
                while (Double.doubleToLongBits(d3 = dArray[n = n + 1 & this.mask]) != 0L) {
                    if (!this.strategy.equals(d3, d)) continue;
                    return this.addToValue(n, d2);
                }
            }
        }
    ...
    public boolean remove(double d, double d2) {
        ...
        if (this.strategy.equals(d, d3) && Double.doubleToLongBits(d2) == Double.doubleToLongBits(this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if (Double.doubleToLongBits(d3 = dArray[n = n + 1 & this.mask]) != 0L) continue;
            return true;
        } while (!this.strategy.equals(d, d3) || Double.doubleToLongBits(d2) != Double.doubleToLongBits(this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(this){
                final Double2DoubleOpenCustomHashMap this$0;
                {
                    this.this$0 = double2DoubleOpenCustomHashMap;
                }
    ...
    public Double2DoubleOpenCustomHashMap clone() {
        Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap;
        try {
            double2DoubleOpenCustomHashMap = (Double2DoubleOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2DoubleOpenCustomHashMap.keys = null;
        double2DoubleOpenCustomHashMap.values = null;
        double2DoubleOpenCustomHashMap.entries = null;
        double2DoubleOpenCustomHashMap.containsNullKey = this.containsNullKey;
        double2DoubleOpenCustomHashMap.key = (double[])this.key.clone();
        double2DoubleOpenCustomHashMap.value = (double[])this.value.clone();
        double2DoubleOpenCustomHashMap.strategy = this.strategy;
    ...
    static double access$300(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap) {
        return double2DoubleOpenCustomHashMap.removeNullEntry();
    }

    static double access$400(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap, int n) {
        return double2DoubleOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements DoubleIterator {
        ...
        public ValueIterator(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap) {
            this.this$0 = double2DoubleOpenCustomHashMap;
            super(double2DoubleOpenCustomHashMap, null);
        }
    ...
    extends AbstractDoubleSet {
        ...
        private KeySet(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap) {
            this.this$0 = double2DoubleOpenCustomHashMap;
        }
        ...
        KeySet(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap, 1 var2_2) {
            this(double2DoubleOpenCustomHashMap);
        }
    }
    ...
    implements DoubleIterator {
        ...
        public KeyIterator(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap) {
            this.this$0 = double2DoubleOpenCustomHashMap;
            super(double2DoubleOpenCustomHashMap, null);
        }
    ...
    implements Double2DoubleMap.FastEntrySet {
        ...
        private MapEntrySet(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap) {
            this.this$0 = double2DoubleOpenCustomHashMap;
        }
        ...
        public boolean contains(Object object) {
            ...
            if (this.this$0.strategy.equals(d, d3)) {
            ...
            do {
                ...
                return true;
            } while (!this.this$0.strategy.equals(d, d3));
            return Double.doubleToLongBits(this.this$0.value[n]) == Double.doubleToLongBits(d2);
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(d, 0.0)) {
                if (this.this$0.containsNullKey && Double.doubleToLongBits(this.this$0.value[this.this$0.n]) == Double.doubleToLongBits(d2)) {
                    Double2DoubleOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(d3, d)) {
                if (Double.doubleToLongBits(this.this$0.value[n]) == Double.doubleToLongBits(d2)) {
                    Double2DoubleOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if (Double.doubleToLongBits(d3 = dArray[n = n + 1 & this.this$0.mask]) != 0L) continue;
                return true;
            } while (!this.this$0.strategy.equals(d3, d) || Double.doubleToLongBits(this.this$0.value[n]) != Double.doubleToLongBits(d2));
            Double2DoubleOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap, 1 var2_2) {
            this(double2DoubleOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Double2DoubleMap.Entry> {
        ...
        private FastEntryIterator(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap) {
            this.this$0 = double2DoubleOpenCustomHashMap;
            super(double2DoubleOpenCustomHashMap, null);
        ...
        FastEntryIterator(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap, 1 var2_2) {
            this(double2DoubleOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Double2DoubleMap.Entry> {
        ...
        private EntryIterator(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap) {
            this.this$0 = double2DoubleOpenCustomHashMap;
            super(double2DoubleOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap, 1 var2_2) {
            this(double2DoubleOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap) {
            this.this$0 = double2DoubleOpenCustomHashMap;
        ...
        MapIterator(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap, 1 var2_2) {
            this(double2DoubleOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Double, Double> {
        ...
        MapEntry(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap, int n) {
            this.this$0 = double2DoubleOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Double2DoubleOpenCustomHashMap double2DoubleOpenCustomHashMap) {
            this.this$0 = double2DoubleOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Double)entry.getKey()) && Double.doubleToLongBits(this.this$0.value[this.index]) == Double.doubleToLongBits((Double)entry.getValue());
        }
