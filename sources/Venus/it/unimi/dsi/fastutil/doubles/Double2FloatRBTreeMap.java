...
Cloneable {
    ...
    public Double2FloatRBTreeMap(Comparator<? super Double> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Double2FloatRBTreeMap(Map<? extends Double, ? extends Float> map) {
        this();
        this.putAll(map);
    }

    public Double2FloatRBTreeMap(SortedMap<Double, Float> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Double, ? extends Float>)sortedMap);
    }

    public Double2FloatRBTreeMap(Double2FloatMap double2FloatMap) {
        this();
        this.putAll(double2FloatMap);
    }

    public Double2FloatRBTreeMap(Double2FloatSortedMap double2FloatSortedMap) {
        this(double2FloatSortedMap.comparator());
        this.putAll(double2FloatSortedMap);
    }

    public Double2FloatRBTreeMap(double[] dArray, float[] fArray, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2FloatRBTreeMap(double[] dArray, float[] fArray) {
    ...
    public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2FloatMap.Entry>(this){
                ...
                final Double2FloatRBTreeMap this$0;
                {
                    this.this$0 = double2FloatRBTreeMap;
    ...
    public Double2FloatRBTreeMap clone() {
        Double2FloatRBTreeMap double2FloatRBTreeMap;
        try {
            double2FloatRBTreeMap = (Double2FloatRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2FloatRBTreeMap.keys = null;
        double2FloatRBTreeMap.values = null;
        double2FloatRBTreeMap.entries = null;
        double2FloatRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2FloatRBTreeMap.firstEntry = double2FloatRBTreeMap.tree = entry2.left;
                            while (double2FloatRBTreeMap.firstEntry.left != null) {
                                double2FloatRBTreeMap.firstEntry = double2FloatRBTreeMap.firstEntry.left;
                            }
                            double2FloatRBTreeMap.lastEntry = double2FloatRBTreeMap.tree;
                            while (double2FloatRBTreeMap.lastEntry.right != null) {
                                double2FloatRBTreeMap.lastEntry = double2FloatRBTreeMap.lastEntry.right;
                            }
                            return double2FloatRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Double2FloatRBTreeMap double2FloatRBTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2FloatRBTreeMap;
            if (!bl && !bl2 && double2FloatRBTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2FloatRBTreeMap.defRetValue;
        }
    ...
    implements FloatListIterator {
        ...
        private ValueIterator(Double2FloatRBTreeMap double2FloatRBTreeMap) {
            this.this$0 = double2FloatRBTreeMap;
            super(double2FloatRBTreeMap);
        }
        ...
        ValueIterator(Double2FloatRBTreeMap double2FloatRBTreeMap, 1 var2_2) {
            this(double2FloatRBTreeMap);
        }
    }
    ...
    extends AbstractDouble2FloatSortedMap.KeySet {
        ...
        private KeySet(Double2FloatRBTreeMap double2FloatRBTreeMap) {
            this.this$0 = double2FloatRBTreeMap;
            super(double2FloatRBTreeMap);
        }
        ...
        KeySet(Double2FloatRBTreeMap double2FloatRBTreeMap, 1 var2_2) {
            this(double2FloatRBTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2FloatRBTreeMap double2FloatRBTreeMap) {
            this.this$0 = double2FloatRBTreeMap;
            super(double2FloatRBTreeMap);
        }

        public KeyIterator(Double2FloatRBTreeMap double2FloatRBTreeMap, double d) {
            this.this$0 = double2FloatRBTreeMap;
            super(double2FloatRBTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2FloatMap.Entry> {
        ...
        EntryIterator(Double2FloatRBTreeMap double2FloatRBTreeMap) {
            this.this$0 = double2FloatRBTreeMap;
            super(double2FloatRBTreeMap);
        }

        EntryIterator(Double2FloatRBTreeMap double2FloatRBTreeMap, double d) {
            this.this$0 = double2FloatRBTreeMap;
            super(double2FloatRBTreeMap, d);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2FloatRBTreeMap double2FloatRBTreeMap) {
            this.this$0 = double2FloatRBTreeMap;
            this.index = 0;
            this.next = double2FloatRBTreeMap.firstEntry;
        }

        TreeIterator(Double2FloatRBTreeMap double2FloatRBTreeMap, double d) {
            this.this$0 = double2FloatRBTreeMap;
            this.index = 0;
            this.next = double2FloatRBTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2FloatRBTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
