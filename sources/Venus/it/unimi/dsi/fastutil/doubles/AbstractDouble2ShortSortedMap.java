...
implements Double2ShortSortedMap {
    ...
    implements ShortIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Double2ShortMap.Entry> objectBidirectionalIterator) {
    ...
    extends AbstractShortCollection {
        final AbstractDouble2ShortSortedMap this$0;

        protected ValuesCollection(AbstractDouble2ShortSortedMap abstractDouble2ShortSortedMap) {
            this.this$0 = abstractDouble2ShortSortedMap;
        }

        @Override
        public ShortIterator iterator() {
            return new ValuesIterator(Double2ShortSortedMaps.fastIterator(this.this$0));
        }
    ...
    implements DoubleBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Double2ShortMap.Entry> objectBidirectionalIterator) {
            this.i = objectBidirectionalIterator;
        }
    ...
    extends AbstractDoubleSortedSet {
        ...
        protected KeySet(AbstractDouble2ShortSortedMap abstractDouble2ShortSortedMap) {
            this.this$0 = abstractDouble2ShortSortedMap;
        }
        ...
        public DoubleBidirectionalIterator iterator(double d) {
            return new KeySetIterator(this.this$0.double2ShortEntrySet().iterator(new AbstractDouble2ShortMap.BasicEntry(d, 0)));
        }

        @Override
        public DoubleBidirectionalIterator iterator() {
            return new KeySetIterator(Double2ShortSortedMaps.fastIterator(this.this$0));
        }
