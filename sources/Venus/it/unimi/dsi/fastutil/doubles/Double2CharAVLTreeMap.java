...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Double2CharAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Double2CharAVLTreeMap(Comparator<? super Double> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Double2CharAVLTreeMap(Map<? extends Double, ? extends Character> map) {
        this();
        this.putAll(map);
    }

    public Double2CharAVLTreeMap(SortedMap<Double, Character> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Double, ? extends Character>)sortedMap);
    }

    public Double2CharAVLTreeMap(Double2CharMap double2CharMap) {
        this();
        this.putAll(double2CharMap);
    }

    public Double2CharAVLTreeMap(Double2CharSortedMap double2CharSortedMap) {
        this(double2CharSortedMap.comparator());
        this.putAll(double2CharSortedMap);
    }

    public Double2CharAVLTreeMap(double[] dArray, char[] cArray, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2CharAVLTreeMap(double[] dArray, char[] cArray) {
        this(dArray, cArray, null);
    }
    ...
    public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2CharMap.Entry>(this){
                final Comparator<? super Double2CharMap.Entry> comparator;
                final Double2CharAVLTreeMap this$0;
                {
                    this.this$0 = double2CharAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator(Double2CharMap.Entry entry) {
                ...
                public ObjectSortedSet<Double2CharMap.Entry> subSet(Double2CharMap.Entry entry, Double2CharMap.Entry entry2) {
                    return this.this$0.subMap(entry.getDoubleKey(), entry2.getDoubleKey()).double2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Double2CharMap.Entry> headSet(Double2CharMap.Entry entry) {
                    return this.this$0.headMap(entry.getDoubleKey()).double2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Double2CharMap.Entry> tailSet(Double2CharMap.Entry entry) {
                    return this.this$0.tailMap(entry.getDoubleKey()).double2CharEntrySet();
                }
                ...
                private int lambda$$0(Double2CharMap.Entry entry, Double2CharMap.Entry entry2) {
    ...
    public Double2CharAVLTreeMap clone() {
        Double2CharAVLTreeMap double2CharAVLTreeMap;
        try {
            double2CharAVLTreeMap = (Double2CharAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2CharAVLTreeMap.keys = null;
        double2CharAVLTreeMap.values = null;
        double2CharAVLTreeMap.entries = null;
        double2CharAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2CharAVLTreeMap.firstEntry = double2CharAVLTreeMap.tree = entry2.left;
                            while (double2CharAVLTreeMap.firstEntry.left != null) {
                                double2CharAVLTreeMap.firstEntry = double2CharAVLTreeMap.firstEntry.left;
                            }
                            double2CharAVLTreeMap.lastEntry = double2CharAVLTreeMap.tree;
                            while (double2CharAVLTreeMap.lastEntry.right != null) {
                                double2CharAVLTreeMap.lastEntry = double2CharAVLTreeMap.lastEntry.right;
                            }
                            return double2CharAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readDouble(), objectInputStream.readChar());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readDouble(), objectInputStream.readChar());
            entry4.right(new Entry(objectInputStream.readDouble(), objectInputStream.readChar()));
    ...
    implements Serializable {
        ...
        public Submap(Double2CharAVLTreeMap double2CharAVLTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2CharAVLTreeMap;
            if (!bl && !bl2 && double2CharAVLTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2CharAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2CharMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Double2CharMap.Entry> comparator() {
                        return this.this$1.this$0.double2CharEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Double2CharMap.Entry> subSet(Double2CharMap.Entry entry, Double2CharMap.Entry entry2) {
                        return this.this$1.subMap(entry.getDoubleKey(), entry2.getDoubleKey()).double2CharEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Double2CharMap.Entry> headSet(Double2CharMap.Entry entry) {
                        return this.this$1.headMap(entry.getDoubleKey()).double2CharEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Double2CharMap.Entry> tailSet(Double2CharMap.Entry entry) {
                        return this.this$1.tailMap(entry.getDoubleKey()).double2CharEntrySet();
                    }
    ...
    implements CharListIterator {
        ...
        private ValueIterator(Double2CharAVLTreeMap double2CharAVLTreeMap) {
            this.this$0 = double2CharAVLTreeMap;
            super(double2CharAVLTreeMap);
        }
        ...
        ValueIterator(Double2CharAVLTreeMap double2CharAVLTreeMap, 1 var2_2) {
            this(double2CharAVLTreeMap);
        }
    }
    ...
    extends AbstractDouble2CharSortedMap.KeySet {
        ...
        private KeySet(Double2CharAVLTreeMap double2CharAVLTreeMap) {
            this.this$0 = double2CharAVLTreeMap;
            super(double2CharAVLTreeMap);
        }
        ...
        KeySet(Double2CharAVLTreeMap double2CharAVLTreeMap, 1 var2_2) {
            this(double2CharAVLTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2CharAVLTreeMap double2CharAVLTreeMap) {
            this.this$0 = double2CharAVLTreeMap;
            super(double2CharAVLTreeMap);
        }

        public KeyIterator(Double2CharAVLTreeMap double2CharAVLTreeMap, double d) {
            this.this$0 = double2CharAVLTreeMap;
            super(double2CharAVLTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2CharMap.Entry> {
        ...
        EntryIterator(Double2CharAVLTreeMap double2CharAVLTreeMap) {
            this.this$0 = double2CharAVLTreeMap;
            super(double2CharAVLTreeMap);
        }

        EntryIterator(Double2CharAVLTreeMap double2CharAVLTreeMap, double d) {
            this.this$0 = double2CharAVLTreeMap;
            super(double2CharAVLTreeMap, d);
        }
        ...
        public void add(Object object) {
            this.add((Double2CharMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Double2CharMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2CharAVLTreeMap double2CharAVLTreeMap) {
            this.this$0 = double2CharAVLTreeMap;
            this.index = 0;
            this.next = double2CharAVLTreeMap.firstEntry;
        }

        TreeIterator(Double2CharAVLTreeMap double2CharAVLTreeMap, double d) {
            this.this$0 = double2CharAVLTreeMap;
            this.index = 0;
            this.next = double2CharAVLTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2CharAVLTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Double.doubleToLongBits(this.key) == Double.doubleToLongBits((Double)entry.getKey()) && this.value == ((Character)entry.getValue()).charValue();
        }
