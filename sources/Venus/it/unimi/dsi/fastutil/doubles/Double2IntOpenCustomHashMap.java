...
Hash {
    ...
    public Double2IntOpenCustomHashMap(int n, float f, DoubleHash.Strategy strategy) {
    ...
    public Double2IntOpenCustomHashMap(int n, DoubleHash.Strategy strategy) {
    ...
    public Double2IntOpenCustomHashMap(Map<? extends Double, ? extends Integer> map, float f, DoubleHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Double2IntOpenCustomHashMap(Map<? extends Double, ? extends Integer> map, DoubleHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Double2IntOpenCustomHashMap(Double2IntMap double2IntMap, float f, DoubleHash.Strategy strategy) {
        this(double2IntMap.size(), f, strategy);
        this.putAll(double2IntMap);
    }

    public Double2IntOpenCustomHashMap(Double2IntMap double2IntMap, DoubleHash.Strategy strategy) {
        this(double2IntMap, 0.75f, strategy);
    }

    public Double2IntOpenCustomHashMap(double[] dArray, int[] nArray, float f, DoubleHash.Strategy strategy) {
    ...
    public Double2IntOpenCustomHashMap(double[] dArray, int[] nArray, DoubleHash.Strategy strategy) {
        this(dArray, nArray, 0.75f, strategy);
    }
    ...
    public int getOrDefault(double d, int n) {
        ...
        double[] dArray = this.key;
        int n2 = HashCommon.mix(this.strategy.hashCode(d)) & this.mask;
        double d2 = dArray[n2];
        if (Double.doubleToLongBits(d2) == 0L) {
            return n;
        }
    ...
    public boolean remove(double d, int n) {
        ...
        if (this.strategy.equals(d, d2) && n == this.value[n2]) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if (Double.doubleToLongBits(d2 = dArray[n2 = n2 + 1 & this.mask]) != 0L) continue;
            return true;
        } while (!this.strategy.equals(d, d2) || n != this.value[n2]);
        this.removeEntry(n2);
        return false;
    }
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection(this){
                final Double2IntOpenCustomHashMap this$0;
                {
                    this.this$0 = double2IntOpenCustomHashMap;
                }
    ...
    public Double2IntOpenCustomHashMap clone() {
        Double2IntOpenCustomHashMap double2IntOpenCustomHashMap;
        try {
            double2IntOpenCustomHashMap = (Double2IntOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2IntOpenCustomHashMap.keys = null;
        double2IntOpenCustomHashMap.values = null;
        double2IntOpenCustomHashMap.entries = null;
        double2IntOpenCustomHashMap.containsNullKey = this.containsNullKey;
        double2IntOpenCustomHashMap.key = (double[])this.key.clone();
        double2IntOpenCustomHashMap.value = (int[])this.value.clone();
        double2IntOpenCustomHashMap.strategy = this.strategy;
    ...
    static int access$300(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap) {
        return double2IntOpenCustomHashMap.removeNullEntry();
    }

    static int access$400(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap, int n) {
        return double2IntOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements IntIterator {
        ...
        public ValueIterator(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap) {
            this.this$0 = double2IntOpenCustomHashMap;
            super(double2IntOpenCustomHashMap, null);
        }
    ...
    extends AbstractDoubleSet {
        ...
        private KeySet(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap) {
            this.this$0 = double2IntOpenCustomHashMap;
        }
        ...
        KeySet(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap, 1 var2_2) {
            this(double2IntOpenCustomHashMap);
        }
    }
    ...
    implements DoubleIterator {
        ...
        public KeyIterator(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap) {
            this.this$0 = double2IntOpenCustomHashMap;
            super(double2IntOpenCustomHashMap, null);
        }
    ...
    implements Double2IntMap.FastEntrySet {
        ...
        private MapEntrySet(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap) {
            this.this$0 = double2IntOpenCustomHashMap;
        }
        ...
        public boolean contains(Object object) {
            ...
            int n2 = HashCommon.mix(this.this$0.strategy.hashCode(d)) & this.this$0.mask;
            double d2 = dArray[n2];
            if (Double.doubleToLongBits(d2) == 0L) {
                return true;
            }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(d, 0.0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n) {
                    Double2IntOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(d2, d)) {
                if (this.this$0.value[n2] == n) {
                    Double2IntOpenCustomHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if (Double.doubleToLongBits(d2 = dArray[n2 = n2 + 1 & this.this$0.mask]) != 0L) continue;
                return true;
            } while (!this.this$0.strategy.equals(d2, d) || this.this$0.value[n2] != n);
            Double2IntOpenCustomHashMap.access$400(this.this$0, n2);
            return false;
        }
        ...
        MapEntrySet(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap, 1 var2_2) {
            this(double2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Double2IntMap.Entry> {
        ...
        private FastEntryIterator(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap) {
            this.this$0 = double2IntOpenCustomHashMap;
            super(double2IntOpenCustomHashMap, null);
        ...
        FastEntryIterator(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap, 1 var2_2) {
            this(double2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Double2IntMap.Entry> {
        ...
        private EntryIterator(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap) {
            this.this$0 = double2IntOpenCustomHashMap;
            super(double2IntOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap, 1 var2_2) {
            this(double2IntOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap) {
            this.this$0 = double2IntOpenCustomHashMap;
        ...
        MapIterator(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap, 1 var2_2) {
            this(double2IntOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Double, Integer> {
        ...
        MapEntry(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap, int n) {
            this.this$0 = double2IntOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Double2IntOpenCustomHashMap double2IntOpenCustomHashMap) {
            this.this$0 = double2IntOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Double)entry.getKey()) && this.this$0.value[this.index] == (Integer)entry.getValue();
        }
