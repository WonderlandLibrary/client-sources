...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Double2ShortAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Double2ShortAVLTreeMap(Comparator<? super Double> comparator) {
        this();
    ...
    public Double2ShortAVLTreeMap(SortedMap<Double, Short> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Double, ? extends Short>)sortedMap);
    }

    public Double2ShortAVLTreeMap(Double2ShortMap double2ShortMap) {
        this();
        this.putAll(double2ShortMap);
    }

    public Double2ShortAVLTreeMap(Double2ShortSortedMap double2ShortSortedMap) {
        this(double2ShortSortedMap.comparator());
        this.putAll(double2ShortSortedMap);
    }

    public Double2ShortAVLTreeMap(double[] dArray, short[] sArray, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2ShortAVLTreeMap(double[] dArray, short[] sArray) {
        this(dArray, sArray, null);
    }
    ...
    public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>(this){
                final Comparator<? super Double2ShortMap.Entry> comparator;
                final Double2ShortAVLTreeMap this$0;
                {
                    this.this$0 = double2ShortAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Double2ShortMap.Entry> iterator(Double2ShortMap.Entry entry) {
                ...
                public ObjectSortedSet<Double2ShortMap.Entry> subSet(Double2ShortMap.Entry entry, Double2ShortMap.Entry entry2) {
                    return this.this$0.subMap(entry.getDoubleKey(), entry2.getDoubleKey()).double2ShortEntrySet();
                }

                @Override
                public ObjectSortedSet<Double2ShortMap.Entry> headSet(Double2ShortMap.Entry entry) {
                    return this.this$0.headMap(entry.getDoubleKey()).double2ShortEntrySet();
                }

                @Override
                public ObjectSortedSet<Double2ShortMap.Entry> tailSet(Double2ShortMap.Entry entry) {
                    return this.this$0.tailMap(entry.getDoubleKey()).double2ShortEntrySet();
                }
                ...
                private int lambda$$0(Double2ShortMap.Entry entry, Double2ShortMap.Entry entry2) {
    ...
    public Double2ShortAVLTreeMap clone() {
        Double2ShortAVLTreeMap double2ShortAVLTreeMap;
        try {
            double2ShortAVLTreeMap = (Double2ShortAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2ShortAVLTreeMap.keys = null;
        double2ShortAVLTreeMap.values = null;
        double2ShortAVLTreeMap.entries = null;
        double2ShortAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2ShortAVLTreeMap.firstEntry = double2ShortAVLTreeMap.tree = entry2.left;
                            while (double2ShortAVLTreeMap.firstEntry.left != null) {
                                double2ShortAVLTreeMap.firstEntry = double2ShortAVLTreeMap.firstEntry.left;
                            }
                            double2ShortAVLTreeMap.lastEntry = double2ShortAVLTreeMap.tree;
                            while (double2ShortAVLTreeMap.lastEntry.right != null) {
                                double2ShortAVLTreeMap.lastEntry = double2ShortAVLTreeMap.lastEntry.right;
                            }
                            return double2ShortAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readDouble(), objectInputStream.readShort());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readDouble(), objectInputStream.readShort());
            entry4.right(new Entry(objectInputStream.readDouble(), objectInputStream.readShort()));
    ...
    implements Serializable {
        ...
        public Submap(Double2ShortAVLTreeMap double2ShortAVLTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2ShortAVLTreeMap;
            if (!bl && !bl2 && double2ShortAVLTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2ShortAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Double2ShortMap.Entry> comparator() {
                        return this.this$1.this$0.double2ShortEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Double2ShortMap.Entry> subSet(Double2ShortMap.Entry entry, Double2ShortMap.Entry entry2) {
                        return this.this$1.subMap(entry.getDoubleKey(), entry2.getDoubleKey()).double2ShortEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Double2ShortMap.Entry> headSet(Double2ShortMap.Entry entry) {
                        return this.this$1.headMap(entry.getDoubleKey()).double2ShortEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Double2ShortMap.Entry> tailSet(Double2ShortMap.Entry entry) {
                        return this.this$1.tailMap(entry.getDoubleKey()).double2ShortEntrySet();
                    }
    ...
    implements ShortListIterator {
        ...
        private ValueIterator(Double2ShortAVLTreeMap double2ShortAVLTreeMap) {
            this.this$0 = double2ShortAVLTreeMap;
            super(double2ShortAVLTreeMap);
        }
        ...
        ValueIterator(Double2ShortAVLTreeMap double2ShortAVLTreeMap, 1 var2_2) {
            this(double2ShortAVLTreeMap);
        }
    }
    ...
    extends AbstractDouble2ShortSortedMap.KeySet {
        ...
        private KeySet(Double2ShortAVLTreeMap double2ShortAVLTreeMap) {
            this.this$0 = double2ShortAVLTreeMap;
            super(double2ShortAVLTreeMap);
        }
        ...
        KeySet(Double2ShortAVLTreeMap double2ShortAVLTreeMap, 1 var2_2) {
            this(double2ShortAVLTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2ShortAVLTreeMap double2ShortAVLTreeMap) {
            this.this$0 = double2ShortAVLTreeMap;
            super(double2ShortAVLTreeMap);
        }

        public KeyIterator(Double2ShortAVLTreeMap double2ShortAVLTreeMap, double d) {
            this.this$0 = double2ShortAVLTreeMap;
            super(double2ShortAVLTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2ShortMap.Entry> {
        ...
        EntryIterator(Double2ShortAVLTreeMap double2ShortAVLTreeMap) {
            this.this$0 = double2ShortAVLTreeMap;
            super(double2ShortAVLTreeMap);
        }

        EntryIterator(Double2ShortAVLTreeMap double2ShortAVLTreeMap, double d) {
            this.this$0 = double2ShortAVLTreeMap;
            super(double2ShortAVLTreeMap, d);
        }
        ...
        public void add(Object object) {
            this.add((Double2ShortMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Double2ShortMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2ShortAVLTreeMap double2ShortAVLTreeMap) {
            this.this$0 = double2ShortAVLTreeMap;
            this.index = 0;
            this.next = double2ShortAVLTreeMap.firstEntry;
        }

        TreeIterator(Double2ShortAVLTreeMap double2ShortAVLTreeMap, double d) {
            this.this$0 = double2ShortAVLTreeMap;
            this.index = 0;
            this.next = double2ShortAVLTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2ShortAVLTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Double.doubleToLongBits(this.key) == Double.doubleToLongBits((Double)entry.getKey()) && this.value == (Short)entry.getValue();
        }
