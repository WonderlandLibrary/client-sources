...
Hash {
    ...
    public DoubleOpenCustomHashSet(int n, float f, DoubleHash.Strategy strategy) {
    ...
    public DoubleOpenCustomHashSet(int n, DoubleHash.Strategy strategy) {
    ...
    public DoubleOpenCustomHashSet(Iterator<?> iterator2, float f, DoubleHash.Strategy strategy) {
        this(DoubleIterators.asDoubleIterator(iterator2), f, strategy);
    }

    public DoubleOpenCustomHashSet(Iterator<?> iterator2, DoubleHash.Strategy strategy) {
        this(DoubleIterators.asDoubleIterator(iterator2), strategy);
    }

    public DoubleOpenCustomHashSet(double[] dArray, int n, int n2, float f, DoubleHash.Strategy strategy) {
    ...
    public DoubleOpenCustomHashSet(double[] dArray, int n, int n2, DoubleHash.Strategy strategy) {
        this(dArray, n, n2, 0.75f, strategy);
    }

    public DoubleOpenCustomHashSet(double[] dArray, float f, DoubleHash.Strategy strategy) {
        this(dArray, 0, dArray.length, f, strategy);
    }

    public DoubleOpenCustomHashSet(double[] dArray, DoubleHash.Strategy strategy) {
    ...
    public DoubleOpenCustomHashSet clone() {
        DoubleOpenCustomHashSet doubleOpenCustomHashSet;
        try {
            doubleOpenCustomHashSet = (DoubleOpenCustomHashSet)super.clone();
    ...
    implements DoubleIterator {
        ...
        final DoubleOpenCustomHashSet this$0;

        private SetIterator(DoubleOpenCustomHashSet doubleOpenCustomHashSet) {
            this.this$0 = doubleOpenCustomHashSet;
        ...
        SetIterator(DoubleOpenCustomHashSet doubleOpenCustomHashSet, 1 var2_2) {
            this(doubleOpenCustomHashSet);
        }
    }
}
