...
Hash {
    ...
    public DoubleLinkedOpenCustomHashSet(int n, float f, DoubleHash.Strategy strategy) {
    ...
    public DoubleLinkedOpenCustomHashSet(int n, DoubleHash.Strategy strategy) {
    ...
    public DoubleLinkedOpenCustomHashSet(Collection<? extends Double> collection, float f, DoubleHash.Strategy strategy) {
        this(collection.size(), f, strategy);
        this.addAll(collection);
    }

    public DoubleLinkedOpenCustomHashSet(Collection<? extends Double> collection, DoubleHash.Strategy strategy) {
        this(collection, 0.75f, strategy);
    }

    public DoubleLinkedOpenCustomHashSet(DoubleCollection doubleCollection, float f, DoubleHash.Strategy strategy) {
        this(doubleCollection.size(), f, strategy);
        this.addAll(doubleCollection);
    }

    public DoubleLinkedOpenCustomHashSet(DoubleCollection doubleCollection, DoubleHash.Strategy strategy) {
        this(doubleCollection, 0.75f, strategy);
    }

    public DoubleLinkedOpenCustomHashSet(DoubleIterator doubleIterator, float f, DoubleHash.Strategy strategy) {
        this(16, f, strategy);
    ...
    public DoubleLinkedOpenCustomHashSet(DoubleIterator doubleIterator, DoubleHash.Strategy strategy) {
        this(doubleIterator, 0.75f, strategy);
    }

    public DoubleLinkedOpenCustomHashSet(Iterator<?> iterator2, float f, DoubleHash.Strategy strategy) {
        this(DoubleIterators.asDoubleIterator(iterator2), f, strategy);
    }

    public DoubleLinkedOpenCustomHashSet(Iterator<?> iterator2, DoubleHash.Strategy strategy) {
        this(DoubleIterators.asDoubleIterator(iterator2), strategy);
    }

    public DoubleLinkedOpenCustomHashSet(double[] dArray, int n, int n2, float f, DoubleHash.Strategy strategy) {
    ...
    public DoubleLinkedOpenCustomHashSet(double[] dArray, int n, int n2, DoubleHash.Strategy strategy) {
        this(dArray, n, n2, 0.75f, strategy);
    }

    public DoubleLinkedOpenCustomHashSet(double[] dArray, float f, DoubleHash.Strategy strategy) {
        this(dArray, 0, dArray.length, f, strategy);
    }

    public DoubleLinkedOpenCustomHashSet(double[] dArray, DoubleHash.Strategy strategy) {
        this(dArray, 0.75f, strategy);
    }
    ...
    public boolean addAndMoveToFirst(double d) {
        ...
        if (this.strategy.equals(d, 0.0)) {
            ...
            while (Double.doubleToLongBits(dArray[n]) != 0L) {
                if (this.strategy.equals(d, dArray[n])) {
    ...
    protected void rehash(int n) {
        ...
        while (n6-- != 0) {
            int n7;
            if (this.strategy.equals(dArray[n3], 0.0)) {
                n7 = n;
            } else {
                n7 = HashCommon.mix(this.strategy.hashCode(dArray[n3])) & n2;
    ...
    public DoubleLinkedOpenCustomHashSet clone() {
        DoubleLinkedOpenCustomHashSet doubleLinkedOpenCustomHashSet;
        try {
            doubleLinkedOpenCustomHashSet = (DoubleLinkedOpenCustomHashSet)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        doubleLinkedOpenCustomHashSet.key = (double[])this.key.clone();
        doubleLinkedOpenCustomHashSet.containsNull = this.containsNull;
        doubleLinkedOpenCustomHashSet.link = (long[])this.link.clone();
        doubleLinkedOpenCustomHashSet.strategy = this.strategy;
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        while (n2-- != 0) {
            ...
            if (this.strategy.equals(d, 0.0)) {
                ...
                n3 = HashCommon.mix(this.strategy.hashCode(d)) & this.mask;
    ...
    implements DoubleListIterator {
        ...
        int curr;
        int index;
        final DoubleLinkedOpenCustomHashSet this$0;

        SetIterator(DoubleLinkedOpenCustomHashSet doubleLinkedOpenCustomHashSet) {
            this.this$0 = doubleLinkedOpenCustomHashSet;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = doubleLinkedOpenCustomHashSet.first;
            this.index = 0;
        }

        SetIterator(DoubleLinkedOpenCustomHashSet doubleLinkedOpenCustomHashSet, double d) {
            this.this$0 = doubleLinkedOpenCustomHashSet;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (doubleLinkedOpenCustomHashSet.strategy.equals(d, 0.0)) {
                if (doubleLinkedOpenCustomHashSet.containsNull) {
                    this.next = (int)doubleLinkedOpenCustomHashSet.link[doubleLinkedOpenCustomHashSet.n];
                    this.prev = doubleLinkedOpenCustomHashSet.n;
                    return;
                }
                throw new NoSuchElementException("The key " + d + " does not belong to this set.");
            }
            if (doubleLinkedOpenCustomHashSet.strategy.equals(doubleLinkedOpenCustomHashSet.key[doubleLinkedOpenCustomHashSet.last], d)) {
                this.prev = doubleLinkedOpenCustomHashSet.last;
                this.index = doubleLinkedOpenCustomHashSet.size;
                return;
            }
            double[] dArray = doubleLinkedOpenCustomHashSet.key;
            int n = HashCommon.mix(doubleLinkedOpenCustomHashSet.strategy.hashCode(d)) & doubleLinkedOpenCustomHashSet.mask;
            while (Double.doubleToLongBits(dArray[n]) != 0L) {
                if (doubleLinkedOpenCustomHashSet.strategy.equals(dArray[n], d)) {
                    this.next = (int)doubleLinkedOpenCustomHashSet.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & doubleLinkedOpenCustomHashSet.mask;
            }
            throw new NoSuchElementException("The key " + d + " does not belong to this set.");
        }
