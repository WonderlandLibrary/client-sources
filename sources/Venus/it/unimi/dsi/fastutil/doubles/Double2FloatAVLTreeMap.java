...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Double2FloatAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Double2FloatAVLTreeMap(Comparator<? super Double> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Double2FloatAVLTreeMap(Map<? extends Double, ? extends Float> map) {
        this();
        this.putAll(map);
    }

    public Double2FloatAVLTreeMap(SortedMap<Double, Float> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Double, ? extends Float>)sortedMap);
    }

    public Double2FloatAVLTreeMap(Double2FloatMap double2FloatMap) {
        this();
        this.putAll(double2FloatMap);
    }

    public Double2FloatAVLTreeMap(Double2FloatSortedMap double2FloatSortedMap) {
        this(double2FloatSortedMap.comparator());
        this.putAll(double2FloatSortedMap);
    }

    public Double2FloatAVLTreeMap(double[] dArray, float[] fArray, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2FloatAVLTreeMap(double[] dArray, float[] fArray) {
        this(dArray, fArray, null);
    }
    ...
    public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2FloatMap.Entry>(this){
                final Comparator<? super Double2FloatMap.Entry> comparator;
                final Double2FloatAVLTreeMap this$0;
                {
                    this.this$0 = double2FloatAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Double2FloatMap.Entry> iterator(Double2FloatMap.Entry entry) {
                ...
                public ObjectSortedSet<Double2FloatMap.Entry> subSet(Double2FloatMap.Entry entry, Double2FloatMap.Entry entry2) {
                    return this.this$0.subMap(entry.getDoubleKey(), entry2.getDoubleKey()).double2FloatEntrySet();
                }

                @Override
                public ObjectSortedSet<Double2FloatMap.Entry> headSet(Double2FloatMap.Entry entry) {
                    return this.this$0.headMap(entry.getDoubleKey()).double2FloatEntrySet();
                }

                @Override
                public ObjectSortedSet<Double2FloatMap.Entry> tailSet(Double2FloatMap.Entry entry) {
                    return this.this$0.tailMap(entry.getDoubleKey()).double2FloatEntrySet();
                }
                ...
                private int lambda$$0(Double2FloatMap.Entry entry, Double2FloatMap.Entry entry2) {
    ...
    public Double2FloatAVLTreeMap clone() {
        Double2FloatAVLTreeMap double2FloatAVLTreeMap;
        try {
            double2FloatAVLTreeMap = (Double2FloatAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2FloatAVLTreeMap.keys = null;
        double2FloatAVLTreeMap.values = null;
        double2FloatAVLTreeMap.entries = null;
        double2FloatAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2FloatAVLTreeMap.firstEntry = double2FloatAVLTreeMap.tree = entry2.left;
                            while (double2FloatAVLTreeMap.firstEntry.left != null) {
                                double2FloatAVLTreeMap.firstEntry = double2FloatAVLTreeMap.firstEntry.left;
                            }
                            double2FloatAVLTreeMap.lastEntry = double2FloatAVLTreeMap.tree;
                            while (double2FloatAVLTreeMap.lastEntry.right != null) {
                                double2FloatAVLTreeMap.lastEntry = double2FloatAVLTreeMap.lastEntry.right;
                            }
                            return double2FloatAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readDouble(), objectInputStream.readFloat());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readDouble(), objectInputStream.readFloat());
            entry4.right(new Entry(objectInputStream.readDouble(), objectInputStream.readFloat()));
    ...
    implements Serializable {
        ...
        public Submap(Double2FloatAVLTreeMap double2FloatAVLTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2FloatAVLTreeMap;
            if (!bl && !bl2 && double2FloatAVLTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2FloatAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2FloatMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Double2FloatMap.Entry> comparator() {
                        return this.this$1.this$0.double2FloatEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Double2FloatMap.Entry> subSet(Double2FloatMap.Entry entry, Double2FloatMap.Entry entry2) {
                        return this.this$1.subMap(entry.getDoubleKey(), entry2.getDoubleKey()).double2FloatEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Double2FloatMap.Entry> headSet(Double2FloatMap.Entry entry) {
                        return this.this$1.headMap(entry.getDoubleKey()).double2FloatEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Double2FloatMap.Entry> tailSet(Double2FloatMap.Entry entry) {
                        return this.this$1.tailMap(entry.getDoubleKey()).double2FloatEntrySet();
                    }
    ...
    implements FloatListIterator {
        ...
        private ValueIterator(Double2FloatAVLTreeMap double2FloatAVLTreeMap) {
            this.this$0 = double2FloatAVLTreeMap;
            super(double2FloatAVLTreeMap);
        }
        ...
        ValueIterator(Double2FloatAVLTreeMap double2FloatAVLTreeMap, 1 var2_2) {
            this(double2FloatAVLTreeMap);
        }
    }
    ...
    extends AbstractDouble2FloatSortedMap.KeySet {
        ...
        private KeySet(Double2FloatAVLTreeMap double2FloatAVLTreeMap) {
            this.this$0 = double2FloatAVLTreeMap;
            super(double2FloatAVLTreeMap);
        }
        ...
        KeySet(Double2FloatAVLTreeMap double2FloatAVLTreeMap, 1 var2_2) {
            this(double2FloatAVLTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2FloatAVLTreeMap double2FloatAVLTreeMap) {
            this.this$0 = double2FloatAVLTreeMap;
            super(double2FloatAVLTreeMap);
        }

        public KeyIterator(Double2FloatAVLTreeMap double2FloatAVLTreeMap, double d) {
            this.this$0 = double2FloatAVLTreeMap;
            super(double2FloatAVLTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2FloatMap.Entry> {
        ...
        EntryIterator(Double2FloatAVLTreeMap double2FloatAVLTreeMap) {
            this.this$0 = double2FloatAVLTreeMap;
            super(double2FloatAVLTreeMap);
        }

        EntryIterator(Double2FloatAVLTreeMap double2FloatAVLTreeMap, double d) {
            this.this$0 = double2FloatAVLTreeMap;
            super(double2FloatAVLTreeMap, d);
        }
        ...
        public void add(Object object) {
            this.add((Double2FloatMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Double2FloatMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2FloatAVLTreeMap double2FloatAVLTreeMap) {
            this.this$0 = double2FloatAVLTreeMap;
            this.index = 0;
            this.next = double2FloatAVLTreeMap.firstEntry;
        }

        TreeIterator(Double2FloatAVLTreeMap double2FloatAVLTreeMap, double d) {
            this.this$0 = double2FloatAVLTreeMap;
            this.index = 0;
            this.next = double2FloatAVLTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2FloatAVLTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Double.doubleToLongBits(this.key) == Double.doubleToLongBits((Double)entry.getKey()) && Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)entry.getValue()).floatValue());
        }
