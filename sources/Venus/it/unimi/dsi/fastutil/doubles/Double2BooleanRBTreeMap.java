...
Cloneable {
    ...
    public Double2BooleanRBTreeMap(Comparator<? super Double> comparator) {
        this();
    ...
    public Double2BooleanRBTreeMap(SortedMap<Double, Boolean> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Double, ? extends Boolean>)sortedMap);
    }

    public Double2BooleanRBTreeMap(Double2BooleanMap double2BooleanMap) {
        this();
        this.putAll(double2BooleanMap);
    }

    public Double2BooleanRBTreeMap(Double2BooleanSortedMap double2BooleanSortedMap) {
        this(double2BooleanSortedMap.comparator());
        this.putAll(double2BooleanSortedMap);
    }

    public Double2BooleanRBTreeMap(double[] dArray, boolean[] blArray, Comparator<? super Double> comparator) {
        this(comparator);
    ...
    public Double2BooleanRBTreeMap(double[] dArray, boolean[] blArray) {
    ...
    public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2BooleanMap.Entry>(this){
                ...
                final Double2BooleanRBTreeMap this$0;
                {
                    this.this$0 = double2BooleanRBTreeMap;
    ...
    public Double2BooleanRBTreeMap clone() {
        Double2BooleanRBTreeMap double2BooleanRBTreeMap;
        try {
            double2BooleanRBTreeMap = (Double2BooleanRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2BooleanRBTreeMap.keys = null;
        double2BooleanRBTreeMap.values = null;
        double2BooleanRBTreeMap.entries = null;
        double2BooleanRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            double2BooleanRBTreeMap.firstEntry = double2BooleanRBTreeMap.tree = entry2.left;
                            while (double2BooleanRBTreeMap.firstEntry.left != null) {
                                double2BooleanRBTreeMap.firstEntry = double2BooleanRBTreeMap.firstEntry.left;
                            }
                            double2BooleanRBTreeMap.lastEntry = double2BooleanRBTreeMap.tree;
                            while (double2BooleanRBTreeMap.lastEntry.right != null) {
                                double2BooleanRBTreeMap.lastEntry = double2BooleanRBTreeMap.lastEntry.right;
                            }
                            return double2BooleanRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Double2BooleanRBTreeMap double2BooleanRBTreeMap, double d, boolean bl, double d2, boolean bl2) {
            this.this$0 = double2BooleanRBTreeMap;
            if (!bl && !bl2 && double2BooleanRBTreeMap.compare(d, d2) > 0) {
            ...
            this.to = d2;
            this.top = bl2;
            this.defRetValue = double2BooleanRBTreeMap.defRetValue;
        }
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Double2BooleanRBTreeMap double2BooleanRBTreeMap) {
            this.this$0 = double2BooleanRBTreeMap;
            super(double2BooleanRBTreeMap);
        }
        ...
        ValueIterator(Double2BooleanRBTreeMap double2BooleanRBTreeMap, 1 var2_2) {
            this(double2BooleanRBTreeMap);
        }
    }
    ...
    extends AbstractDouble2BooleanSortedMap.KeySet {
        ...
        private KeySet(Double2BooleanRBTreeMap double2BooleanRBTreeMap) {
            this.this$0 = double2BooleanRBTreeMap;
            super(double2BooleanRBTreeMap);
        }
        ...
        KeySet(Double2BooleanRBTreeMap double2BooleanRBTreeMap, 1 var2_2) {
            this(double2BooleanRBTreeMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2BooleanRBTreeMap double2BooleanRBTreeMap) {
            this.this$0 = double2BooleanRBTreeMap;
            super(double2BooleanRBTreeMap);
        }

        public KeyIterator(Double2BooleanRBTreeMap double2BooleanRBTreeMap, double d) {
            this.this$0 = double2BooleanRBTreeMap;
            super(double2BooleanRBTreeMap, d);
        }
    ...
    implements ObjectListIterator<Double2BooleanMap.Entry> {
        ...
        EntryIterator(Double2BooleanRBTreeMap double2BooleanRBTreeMap) {
            this.this$0 = double2BooleanRBTreeMap;
            super(double2BooleanRBTreeMap);
        }

        EntryIterator(Double2BooleanRBTreeMap double2BooleanRBTreeMap, double d) {
            this.this$0 = double2BooleanRBTreeMap;
            super(double2BooleanRBTreeMap, d);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Double2BooleanRBTreeMap double2BooleanRBTreeMap) {
            this.this$0 = double2BooleanRBTreeMap;
            this.index = 0;
            this.next = double2BooleanRBTreeMap.firstEntry;
        }

        TreeIterator(Double2BooleanRBTreeMap double2BooleanRBTreeMap, double d) {
            this.this$0 = double2BooleanRBTreeMap;
            this.index = 0;
            this.next = double2BooleanRBTreeMap.locateKey(d);
            if (this.next != null) {
                if (double2BooleanRBTreeMap.compare(this.next.key, d) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
