...
public final class Double2ObjectFunctions {
    ...
    public static <V> Double2ObjectFunction<V> synchronize(Double2ObjectFunction<V> double2ObjectFunction) {
        return new SynchronizedFunction<V>(double2ObjectFunction);
    }

    public static <V> Double2ObjectFunction<V> synchronize(Double2ObjectFunction<V> double2ObjectFunction, Object object) {
        return new SynchronizedFunction<V>(double2ObjectFunction, object);
    }

    public static <V> Double2ObjectFunction<V> unmodifiable(Double2ObjectFunction<V> double2ObjectFunction) {
        return new UnmodifiableFunction<V>(double2ObjectFunction);
    }
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Double2ObjectFunction<V> double2ObjectFunction) {
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Double2ObjectFunction<V> double2ObjectFunction, Object object) {
            if (double2ObjectFunction == null) {
                throw new NullPointerException();
            }
            this.function = double2ObjectFunction;
        ...
        protected SynchronizedFunction(Double2ObjectFunction<V> double2ObjectFunction) {
            if (double2ObjectFunction == null) {
                throw new NullPointerException();
            }
            this.function = double2ObjectFunction;
