...
Hash {
    ...
    public Double2FloatOpenCustomHashMap(int n, float f, DoubleHash.Strategy strategy) {
    ...
    public Double2FloatOpenCustomHashMap(int n, DoubleHash.Strategy strategy) {
    ...
    public Double2FloatOpenCustomHashMap(Map<? extends Double, ? extends Float> map, float f, DoubleHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Double2FloatOpenCustomHashMap(Map<? extends Double, ? extends Float> map, DoubleHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Double2FloatOpenCustomHashMap(Double2FloatMap double2FloatMap, float f, DoubleHash.Strategy strategy) {
        this(double2FloatMap.size(), f, strategy);
        this.putAll(double2FloatMap);
    }

    public Double2FloatOpenCustomHashMap(Double2FloatMap double2FloatMap, DoubleHash.Strategy strategy) {
        this(double2FloatMap, 0.75f, strategy);
    }

    public Double2FloatOpenCustomHashMap(double[] dArray, float[] fArray, float f, DoubleHash.Strategy strategy) {
    ...
    public Double2FloatOpenCustomHashMap(double[] dArray, float[] fArray, DoubleHash.Strategy strategy) {
        this(dArray, fArray, 0.75f, strategy);
    }
    ...
    public boolean remove(double d, float f) {
        ...
        if (this.strategy.equals(d, d2) && Float.floatToIntBits(f) == Float.floatToIntBits(this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if (Double.doubleToLongBits(d2 = dArray[n = n + 1 & this.mask]) != 0L) continue;
            return true;
        } while (!this.strategy.equals(d, d2) || Float.floatToIntBits(f) != Float.floatToIntBits(this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public FloatCollection values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection(this){
                final Double2FloatOpenCustomHashMap this$0;
                {
                    this.this$0 = double2FloatOpenCustomHashMap;
                }
    ...
    public Double2FloatOpenCustomHashMap clone() {
        Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap;
        try {
            double2FloatOpenCustomHashMap = (Double2FloatOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2FloatOpenCustomHashMap.keys = null;
        double2FloatOpenCustomHashMap.values = null;
        double2FloatOpenCustomHashMap.entries = null;
        double2FloatOpenCustomHashMap.containsNullKey = this.containsNullKey;
        double2FloatOpenCustomHashMap.key = (double[])this.key.clone();
        double2FloatOpenCustomHashMap.value = (float[])this.value.clone();
        double2FloatOpenCustomHashMap.strategy = this.strategy;
        return double2FloatOpenCustomHashMap;
    }
    ...
    static float access$300(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap) {
        return double2FloatOpenCustomHashMap.removeNullEntry();
    }

    static float access$400(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap, int n) {
        return double2FloatOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements FloatIterator {
        ...
        public ValueIterator(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap) {
            this.this$0 = double2FloatOpenCustomHashMap;
            super(double2FloatOpenCustomHashMap, null);
        }
    ...
    extends AbstractDoubleSet {
        ...
        private KeySet(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap) {
            this.this$0 = double2FloatOpenCustomHashMap;
        }
        ...
        KeySet(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap, 1 var2_2) {
            this(double2FloatOpenCustomHashMap);
        }
    }
    ...
    implements DoubleIterator {
        ...
        public KeyIterator(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap) {
            this.this$0 = double2FloatOpenCustomHashMap;
            super(double2FloatOpenCustomHashMap, null);
        }
    ...
    implements Double2FloatMap.FastEntrySet {
        ...
        private MapEntrySet(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap) {
            this.this$0 = double2FloatOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(d, 0.0)) {
                if (this.this$0.containsNullKey && Float.floatToIntBits(this.this$0.value[this.this$0.n]) == Float.floatToIntBits(f)) {
                    Double2FloatOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(d2, d)) {
                if (Float.floatToIntBits(this.this$0.value[n]) == Float.floatToIntBits(f)) {
                    Double2FloatOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if (Double.doubleToLongBits(d2 = dArray[n = n + 1 & this.this$0.mask]) != 0L) continue;
                return true;
            } while (!this.this$0.strategy.equals(d2, d) || Float.floatToIntBits(this.this$0.value[n]) != Float.floatToIntBits(f));
            Double2FloatOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap, 1 var2_2) {
            this(double2FloatOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Double2FloatMap.Entry> {
        ...
        private FastEntryIterator(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap) {
            this.this$0 = double2FloatOpenCustomHashMap;
            super(double2FloatOpenCustomHashMap, null);
        ...
        FastEntryIterator(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap, 1 var2_2) {
            this(double2FloatOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Double2FloatMap.Entry> {
        ...
        private EntryIterator(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap) {
            this.this$0 = double2FloatOpenCustomHashMap;
            super(double2FloatOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap, 1 var2_2) {
            this(double2FloatOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap) {
            this.this$0 = double2FloatOpenCustomHashMap;
        ...
        MapIterator(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap, 1 var2_2) {
            this(double2FloatOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Double, Float> {
        ...
        MapEntry(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap, int n) {
            this.this$0 = double2FloatOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Double2FloatOpenCustomHashMap double2FloatOpenCustomHashMap) {
            this.this$0 = double2FloatOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Double)entry.getKey()) && Float.floatToIntBits(this.this$0.value[this.index]) == Float.floatToIntBits(((Float)entry.getValue()).floatValue());
        }
