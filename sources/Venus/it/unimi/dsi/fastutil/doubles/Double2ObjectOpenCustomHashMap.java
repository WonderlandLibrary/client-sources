...
Hash {
    ...
    public Double2ObjectOpenCustomHashMap(int n, float f, DoubleHash.Strategy strategy) {
    ...
    public Double2ObjectOpenCustomHashMap(int n, DoubleHash.Strategy strategy) {
    ...
    public Double2ObjectOpenCustomHashMap(Map<? extends Double, ? extends V> map, float f, DoubleHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Double2ObjectOpenCustomHashMap(Map<? extends Double, ? extends V> map, DoubleHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Double2ObjectOpenCustomHashMap(Double2ObjectMap<V> double2ObjectMap, float f, DoubleHash.Strategy strategy) {
        this(double2ObjectMap.size(), f, strategy);
        this.putAll(double2ObjectMap);
    }

    public Double2ObjectOpenCustomHashMap(Double2ObjectMap<V> double2ObjectMap, DoubleHash.Strategy strategy) {
        this(double2ObjectMap, 0.75f, strategy);
    }

    public Double2ObjectOpenCustomHashMap(double[] dArray, V[] VArray, float f, DoubleHash.Strategy strategy) {
    ...
    public Double2ObjectOpenCustomHashMap(double[] dArray, V[] VArray, DoubleHash.Strategy strategy) {
    ...
    public boolean remove(double d, Object object) {
        ...
        if (this.strategy.equals(d, d2) && Objects.equals(object, this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if (Double.doubleToLongBits(d2 = dArray[n = n + 1 & this.mask]) != 0L) continue;
            return true;
        } while (!this.strategy.equals(d, d2) || !Objects.equals(object, this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public ObjectCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(this){
                final Double2ObjectOpenCustomHashMap this$0;
                {
    ...
    public Double2ObjectOpenCustomHashMap<V> clone() {
        Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap;
        try {
            double2ObjectOpenCustomHashMap = (Double2ObjectOpenCustomHashMap)super.clone();
        ...
        double2ObjectOpenCustomHashMap.value = (Object[])this.value.clone();
        double2ObjectOpenCustomHashMap.strategy = this.strategy;
    ...
    static Object access$300(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap) {
        return double2ObjectOpenCustomHashMap.removeNullEntry();
    }

    static Object access$400(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap, int n) {
        return double2ObjectOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap) {
            this.this$0 = double2ObjectOpenCustomHashMap;
            super(double2ObjectOpenCustomHashMap, null);
        }
    ...
    extends AbstractDoubleSet {
        ...
        private KeySet(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap) {
            this.this$0 = double2ObjectOpenCustomHashMap;
        }
        ...
        KeySet(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap, 1 var2_2) {
            this(double2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements DoubleIterator {
        ...
        public KeyIterator(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap) {
            this.this$0 = double2ObjectOpenCustomHashMap;
            super(double2ObjectOpenCustomHashMap, null);
        }
    ...
    implements Double2ObjectMap.FastEntrySet<V> {
        ...
        private MapEntrySet(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap) {
            this.this$0 = double2ObjectOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(d, 0.0)) {
                if (this.this$0.containsNullKey && Objects.equals(this.this$0.value[this.this$0.n], v)) {
                    Double2ObjectOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(d2, d)) {
                if (Objects.equals(this.this$0.value[n], v)) {
                    Double2ObjectOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if (Double.doubleToLongBits(d2 = dArray[n = n + 1 & this.this$0.mask]) != 0L) continue;
                return true;
            } while (!this.this$0.strategy.equals(d2, d) || !Objects.equals(this.this$0.value[n], v));
            Double2ObjectOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap, 1 var2_2) {
            this(double2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Double2ObjectMap.Entry<V>> {
        ...
        private FastEntryIterator(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap) {
            this.this$0 = double2ObjectOpenCustomHashMap;
            super(double2ObjectOpenCustomHashMap, null);
        ...
        FastEntryIterator(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap, 1 var2_2) {
            this(double2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Double2ObjectMap.Entry<V>> {
        ...
        private EntryIterator(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap) {
            this.this$0 = double2ObjectOpenCustomHashMap;
            super(double2ObjectOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap, 1 var2_2) {
            this(double2ObjectOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap) {
            this.this$0 = double2ObjectOpenCustomHashMap;
        ...
        MapIterator(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap, 1 var2_2) {
            this(double2ObjectOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Double, V> {
        ...
        MapEntry(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap, int n) {
            this.this$0 = double2ObjectOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Double2ObjectOpenCustomHashMap double2ObjectOpenCustomHashMap) {
            this.this$0 = double2ObjectOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Double)entry.getKey()) && Objects.equals(this.this$0.value[this.index], entry.getValue());
        }
