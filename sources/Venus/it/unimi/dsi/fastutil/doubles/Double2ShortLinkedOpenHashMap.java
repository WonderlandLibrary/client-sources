...
Hash {
    ...
    public Double2ShortLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Double2ShortLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Double2ShortLinkedOpenHashMap(Map<? extends Double, ? extends Short> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Double2ShortLinkedOpenHashMap(Map<? extends Double, ? extends Short> map) {
        this(map, 0.75f);
    }

    public Double2ShortLinkedOpenHashMap(Double2ShortMap double2ShortMap, float f) {
        this(double2ShortMap.size(), f);
        this.putAll(double2ShortMap);
    }

    public Double2ShortLinkedOpenHashMap(Double2ShortMap double2ShortMap) {
        this(double2ShortMap, 0.75f);
    }

    public Double2ShortLinkedOpenHashMap(double[] dArray, short[] sArray, float f) {
    ...
    public Double2ShortLinkedOpenHashMap(double[] dArray, short[] sArray) {
        this(dArray, sArray, 0.75f);
    }
    ...
    public boolean remove(double d, short s) {
        ...
        if (Double.doubleToLongBits(d) == Double.doubleToLongBits(d2) && s == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if (Double.doubleToLongBits(d2 = dArray[n = n + 1 & this.mask]) != 0L) continue;
            return true;
        } while (Double.doubleToLongBits(d) != Double.doubleToLongBits(d2) || s != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection(this){
                final Double2ShortLinkedOpenHashMap this$0;
                {
                    this.this$0 = double2ShortLinkedOpenHashMap;
                }
    ...
    public Double2ShortLinkedOpenHashMap clone() {
        Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap;
        try {
            double2ShortLinkedOpenHashMap = (Double2ShortLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        double2ShortLinkedOpenHashMap.keys = null;
        double2ShortLinkedOpenHashMap.values = null;
        double2ShortLinkedOpenHashMap.entries = null;
        double2ShortLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        double2ShortLinkedOpenHashMap.key = (double[])this.key.clone();
        double2ShortLinkedOpenHashMap.value = (short[])this.value.clone();
        double2ShortLinkedOpenHashMap.link = (long[])this.link.clone();
        return double2ShortLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet double2ShortEntrySet() {
    ...
    static short access$100(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap) {
        return double2ShortLinkedOpenHashMap.removeNullEntry();
    }

    static short access$200(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap, int n) {
        return double2ShortLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ShortListIterator {
        ...
        public ValueIterator(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap) {
            this.this$0 = double2ShortLinkedOpenHashMap;
            super(double2ShortLinkedOpenHashMap);
        }
    ...
    extends AbstractDoubleSortedSet {
        ...
        private KeySet(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap) {
            this.this$0 = double2ShortLinkedOpenHashMap;
        }
        ...
        KeySet(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap, 1 var2_2) {
            this(double2ShortLinkedOpenHashMap);
        }
    }
    ...
    implements DoubleListIterator {
        ...
        public KeyIterator(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap, double d) {
            this.this$0 = double2ShortLinkedOpenHashMap;
            super(double2ShortLinkedOpenHashMap, d, null);
        }
        ...
        public KeyIterator(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap) {
            this.this$0 = double2ShortLinkedOpenHashMap;
            super(double2ShortLinkedOpenHashMap);
        }
    ...
    implements Double2ShortSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap) {
            this.this$0 = double2ShortLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Double2ShortMap.Entry> subSet(Double2ShortMap.Entry entry, Double2ShortMap.Entry entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Double2ShortMap.Entry> headSet(Double2ShortMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Double2ShortMap.Entry> tailSet(Double2ShortMap.Entry entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (Double.doubleToLongBits(d) == 0L) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == s) {
                    Double2ShortLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (Double.doubleToLongBits(d2) == Double.doubleToLongBits(d)) {
                if (this.this$0.value[n] == s) {
                    Double2ShortLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if (Double.doubleToLongBits(d2 = dArray[n = n + 1 & this.this$0.mask]) != 0L) continue;
                return true;
            } while (Double.doubleToLongBits(d2) != Double.doubleToLongBits(d) || this.this$0.value[n] != s);
            Double2ShortLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Double2ShortMap.Entry> iterator(Double2ShortMap.Entry entry) {
        ...
        public ObjectListIterator<Double2ShortMap.Entry> fastIterator(Double2ShortMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Double2ShortMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractDouble2ShortMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Double2ShortMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Double2ShortMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Double2ShortMap.Entry)object, (Double2ShortMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Double2ShortMap.Entry)object);
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Double2ShortMap.Entry entry) {
        ...
        MapEntrySet(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap, 1 var2_2) {
            this(double2ShortLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Double2ShortMap.Entry> {
        ...
        public FastEntryIterator(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap) {
            this.this$0 = double2ShortLinkedOpenHashMap;
            super(double2ShortLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap, double d) {
            this.this$0 = double2ShortLinkedOpenHashMap;
            super(double2ShortLinkedOpenHashMap, d, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Double2ShortMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Double2ShortMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Double2ShortMap.Entry> {
        ...
        public EntryIterator(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap) {
            this.this$0 = double2ShortLinkedOpenHashMap;
            super(double2ShortLinkedOpenHashMap);
        }

        public EntryIterator(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap, double d) {
            this.this$0 = double2ShortLinkedOpenHashMap;
            super(double2ShortLinkedOpenHashMap, d, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap) {
            this.this$0 = double2ShortLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = double2ShortLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap, double d) {
            this.this$0 = double2ShortLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (Double.doubleToLongBits(d) == 0L) {
                if (double2ShortLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)double2ShortLinkedOpenHashMap.link[double2ShortLinkedOpenHashMap.n];
                    this.prev = double2ShortLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + d + " does not belong to this map.");
            }
            if (Double.doubleToLongBits(double2ShortLinkedOpenHashMap.key[double2ShortLinkedOpenHashMap.last]) == Double.doubleToLongBits(d)) {
                this.prev = double2ShortLinkedOpenHashMap.last;
                this.index = double2ShortLinkedOpenHashMap.size;
                return;
            }
            int n = (int)HashCommon.mix(Double.doubleToRawLongBits(d)) & double2ShortLinkedOpenHashMap.mask;
            while (Double.doubleToLongBits(double2ShortLinkedOpenHashMap.key[n]) != 0L) {
                if (Double.doubleToLongBits(double2ShortLinkedOpenHashMap.key[n]) == Double.doubleToLongBits(d)) {
                    this.next = (int)double2ShortLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & double2ShortLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + d + " does not belong to this map.");
        }
        ...
        public void set(Double2ShortMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Double2ShortMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap, double d, 1 var4_3) {
            this(double2ShortLinkedOpenHashMap, d);
        }
    }
    ...
    Map.Entry<Double, Short> {
        ...
        MapEntry(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap, int n) {
            this.this$0 = double2ShortLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Double2ShortLinkedOpenHashMap double2ShortLinkedOpenHashMap) {
            this.this$0 = double2ShortLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Double.doubleToLongBits(this.this$0.key[this.index]) == Double.doubleToLongBits((Double)entry.getKey()) && this.this$0.value[this.index] == (Short)entry.getValue();
        }
