...
Cloneable {
    ...
    public Int2DoubleRBTreeMap(Int2DoubleMap int2DoubleMap) {
        this();
        this.putAll(int2DoubleMap);
    }

    public Int2DoubleRBTreeMap(Int2DoubleSortedMap int2DoubleSortedMap) {
        this(int2DoubleSortedMap.comparator());
        this.putAll(int2DoubleSortedMap);
    }

    public Int2DoubleRBTreeMap(int[] nArray, double[] dArray, Comparator<? super Integer> comparator) {
        this(comparator);
    ...
    public Int2DoubleRBTreeMap(int[] nArray, double[] dArray) {
    ...
    public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>(this){
                ...
                final Int2DoubleRBTreeMap this$0;
                {
                    this.this$0 = int2DoubleRBTreeMap;
    ...
    public Int2DoubleRBTreeMap clone() {
        Int2DoubleRBTreeMap int2DoubleRBTreeMap;
        try {
            int2DoubleRBTreeMap = (Int2DoubleRBTreeMap)super.clone();
        ...
        int2DoubleRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            int2DoubleRBTreeMap.firstEntry = int2DoubleRBTreeMap.tree = entry2.left;
                            while (int2DoubleRBTreeMap.firstEntry.left != null) {
                                int2DoubleRBTreeMap.firstEntry = int2DoubleRBTreeMap.firstEntry.left;
                            }
                            int2DoubleRBTreeMap.lastEntry = int2DoubleRBTreeMap.tree;
                            while (int2DoubleRBTreeMap.lastEntry.right != null) {
                                int2DoubleRBTreeMap.lastEntry = int2DoubleRBTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Int2DoubleRBTreeMap int2DoubleRBTreeMap, int n, boolean bl, int n2, boolean bl2) {
            this.this$0 = int2DoubleRBTreeMap;
            if (!bl && !bl2 && int2DoubleRBTreeMap.compare(n, n2) > 0) {
            ...
            this.to = n2;
            this.top = bl2;
            this.defRetValue = int2DoubleRBTreeMap.defRetValue;
        }
    ...
    implements DoubleListIterator {
        ...
        private ValueIterator(Int2DoubleRBTreeMap int2DoubleRBTreeMap) {
            this.this$0 = int2DoubleRBTreeMap;
            super(int2DoubleRBTreeMap);
        }
        ...
        ValueIterator(Int2DoubleRBTreeMap int2DoubleRBTreeMap, 1 var2_2) {
            this(int2DoubleRBTreeMap);
        }
    }
    ...
    extends AbstractInt2DoubleSortedMap.KeySet {
        ...
        private KeySet(Int2DoubleRBTreeMap int2DoubleRBTreeMap) {
            this.this$0 = int2DoubleRBTreeMap;
            super(int2DoubleRBTreeMap);
        }
        ...
        KeySet(Int2DoubleRBTreeMap int2DoubleRBTreeMap, 1 var2_2) {
            this(int2DoubleRBTreeMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2DoubleRBTreeMap int2DoubleRBTreeMap) {
            this.this$0 = int2DoubleRBTreeMap;
            super(int2DoubleRBTreeMap);
        }

        public KeyIterator(Int2DoubleRBTreeMap int2DoubleRBTreeMap, int n) {
            this.this$0 = int2DoubleRBTreeMap;
            super(int2DoubleRBTreeMap, n);
        }
    ...
    implements ObjectListIterator<Int2DoubleMap.Entry> {
        ...
        EntryIterator(Int2DoubleRBTreeMap int2DoubleRBTreeMap) {
            this.this$0 = int2DoubleRBTreeMap;
            super(int2DoubleRBTreeMap);
        }

        EntryIterator(Int2DoubleRBTreeMap int2DoubleRBTreeMap, int n) {
            this.this$0 = int2DoubleRBTreeMap;
            super(int2DoubleRBTreeMap, n);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Int2DoubleRBTreeMap int2DoubleRBTreeMap) {
            this.this$0 = int2DoubleRBTreeMap;
            this.index = 0;
            this.next = int2DoubleRBTreeMap.firstEntry;
        }

        TreeIterator(Int2DoubleRBTreeMap int2DoubleRBTreeMap, int n) {
            this.this$0 = int2DoubleRBTreeMap;
            this.index = 0;
            this.next = int2DoubleRBTreeMap.locateKey(n);
            if (this.next != null) {
                if (int2DoubleRBTreeMap.compare(this.next.key, n) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
