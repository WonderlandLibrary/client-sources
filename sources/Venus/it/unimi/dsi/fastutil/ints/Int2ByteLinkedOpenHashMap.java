...
Hash {
    ...
    public Int2ByteLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Int2ByteLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Int2ByteLinkedOpenHashMap(Map<? extends Integer, ? extends Byte> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Int2ByteLinkedOpenHashMap(Map<? extends Integer, ? extends Byte> map) {
        this(map, 0.75f);
    }

    public Int2ByteLinkedOpenHashMap(Int2ByteMap int2ByteMap, float f) {
        this(int2ByteMap.size(), f);
        this.putAll(int2ByteMap);
    }

    public Int2ByteLinkedOpenHashMap(Int2ByteMap int2ByteMap) {
        this(int2ByteMap, 0.75f);
    }

    public Int2ByteLinkedOpenHashMap(int[] nArray, byte[] byArray, float f) {
    ...
    public Int2ByteLinkedOpenHashMap(int[] nArray, byte[] byArray) {
    ...
    public byte getAndMoveToFirst(int n) {
        if (n == 0) {
            if (this.containsNullKey) {
    ...
    public byte getAndMoveToLast(int n) {
        if (n == 0) {
            if (this.containsNullKey) {
    ...
    public byte putAndMoveToFirst(int n, byte by) {
        int n2;
        if (n == 0) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public byte putAndMoveToLast(int n, byte by) {
        int n2;
        if (n == 0) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection(this){
                final Int2ByteLinkedOpenHashMap this$0;
                {
                    this.this$0 = int2ByteLinkedOpenHashMap;
                }
    ...
    public Int2ByteLinkedOpenHashMap clone() {
        Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap;
        try {
            int2ByteLinkedOpenHashMap = (Int2ByteLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2ByteLinkedOpenHashMap.keys = null;
        int2ByteLinkedOpenHashMap.values = null;
        int2ByteLinkedOpenHashMap.entries = null;
        int2ByteLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        int2ByteLinkedOpenHashMap.key = (int[])this.key.clone();
        int2ByteLinkedOpenHashMap.value = (byte[])this.value.clone();
        int2ByteLinkedOpenHashMap.link = (long[])this.link.clone();
        return int2ByteLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet int2ByteEntrySet() {
    ...
    static byte access$100(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap) {
        return int2ByteLinkedOpenHashMap.removeNullEntry();
    }

    static byte access$200(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap, int n) {
        return int2ByteLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ByteListIterator {
        ...
        public ValueIterator(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap) {
            this.this$0 = int2ByteLinkedOpenHashMap;
            super(int2ByteLinkedOpenHashMap);
        }
    ...
    extends AbstractIntSortedSet {
        ...
        private KeySet(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap) {
            this.this$0 = int2ByteLinkedOpenHashMap;
        }
        ...
        KeySet(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap, 1 var2_2) {
            this(int2ByteLinkedOpenHashMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap, int n) {
            this.this$0 = int2ByteLinkedOpenHashMap;
            super(int2ByteLinkedOpenHashMap, n, null);
        }
        ...
        public KeyIterator(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap) {
            this.this$0 = int2ByteLinkedOpenHashMap;
            super(int2ByteLinkedOpenHashMap);
        }
    ...
    implements Int2ByteSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap) {
            this.this$0 = int2ByteLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (n == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == by) {
                    Int2ByteLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (n3 == n) {
                if (this.this$0.value[n2] == by) {
                    Int2ByteLinkedOpenHashMap.access$200(this.this$0, n2);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Int2ByteMap.Entry> iterator(Int2ByteMap.Entry entry) {
        ...
        public ObjectListIterator<Int2ByteMap.Entry> fastIterator(Int2ByteMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Int2ByteMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractInt2ByteMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Int2ByteMap.Entry entry) {
        ...
        MapEntrySet(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap, 1 var2_2) {
            this(int2ByteLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Int2ByteMap.Entry> {
        ...
        public FastEntryIterator(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap) {
            this.this$0 = int2ByteLinkedOpenHashMap;
            super(int2ByteLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap, int n) {
            this.this$0 = int2ByteLinkedOpenHashMap;
            super(int2ByteLinkedOpenHashMap, n, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Int2ByteMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Int2ByteMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Int2ByteMap.Entry> {
        ...
        public EntryIterator(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap) {
            this.this$0 = int2ByteLinkedOpenHashMap;
            super(int2ByteLinkedOpenHashMap);
        }

        public EntryIterator(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap, int n) {
            this.this$0 = int2ByteLinkedOpenHashMap;
            super(int2ByteLinkedOpenHashMap, n, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap) {
            this.this$0 = int2ByteLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = int2ByteLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap, int n) {
            this.this$0 = int2ByteLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (n == 0) {
                if (int2ByteLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)int2ByteLinkedOpenHashMap.link[int2ByteLinkedOpenHashMap.n];
                    this.prev = int2ByteLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + n + " does not belong to this map.");
            }
            if (int2ByteLinkedOpenHashMap.key[int2ByteLinkedOpenHashMap.last] == n) {
                this.prev = int2ByteLinkedOpenHashMap.last;
                this.index = int2ByteLinkedOpenHashMap.size;
                return;
            }
            int n2 = HashCommon.mix(n) & int2ByteLinkedOpenHashMap.mask;
            while (int2ByteLinkedOpenHashMap.key[n2] != 0) {
                if (int2ByteLinkedOpenHashMap.key[n2] == n) {
                    this.next = (int)int2ByteLinkedOpenHashMap.link[n2];
                    this.prev = n2;
                    return;
                }
                n2 = n2 + 1 & int2ByteLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + n + " does not belong to this map.");
        }
        ...
        MapIterator(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap, int n, 1 var3_3) {
            this(int2ByteLinkedOpenHashMap, n);
        }
    }
    ...
    Map.Entry<Integer, Byte> {
        ...
        MapEntry(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap, int n) {
            this.this$0 = int2ByteLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Int2ByteLinkedOpenHashMap int2ByteLinkedOpenHashMap) {
            this.this$0 = int2ByteLinkedOpenHashMap;
        }
