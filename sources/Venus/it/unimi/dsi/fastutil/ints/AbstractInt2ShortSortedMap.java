...
implements Int2ShortSortedMap {
    ...
    extends AbstractShortCollection {
        final AbstractInt2ShortSortedMap this$0;

        protected ValuesCollection(AbstractInt2ShortSortedMap abstractInt2ShortSortedMap) {
            this.this$0 = abstractInt2ShortSortedMap;
        }

        @Override
        public ShortIterator iterator() {
            return new ValuesIterator(Int2ShortSortedMaps.fastIterator(this.this$0));
        }
    ...
    extends AbstractIntSortedSet {
        ...
        protected KeySet(AbstractInt2ShortSortedMap abstractInt2ShortSortedMap) {
            this.this$0 = abstractInt2ShortSortedMap;
        }
        ...
        public IntBidirectionalIterator iterator(int n) {
            return new KeySetIterator(this.this$0.int2ShortEntrySet().iterator(new AbstractInt2ShortMap.BasicEntry(n, 0)));
        }

        @Override
        public IntBidirectionalIterator iterator() {
            return new KeySetIterator(Int2ShortSortedMaps.fastIterator(this.this$0));
        }
