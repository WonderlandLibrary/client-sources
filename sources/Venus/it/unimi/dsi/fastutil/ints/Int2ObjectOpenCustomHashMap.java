...
Hash {
    ...
    public Int2ObjectOpenCustomHashMap(int n, float f, IntHash.Strategy strategy) {
    ...
    public Int2ObjectOpenCustomHashMap(int n, IntHash.Strategy strategy) {
    ...
    public Int2ObjectOpenCustomHashMap(Map<? extends Integer, ? extends V> map, float f, IntHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Int2ObjectOpenCustomHashMap(Map<? extends Integer, ? extends V> map, IntHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Int2ObjectOpenCustomHashMap(Int2ObjectMap<V> int2ObjectMap, float f, IntHash.Strategy strategy) {
        this(int2ObjectMap.size(), f, strategy);
        this.putAll(int2ObjectMap);
    }

    public Int2ObjectOpenCustomHashMap(Int2ObjectMap<V> int2ObjectMap, IntHash.Strategy strategy) {
        this(int2ObjectMap, 0.75f, strategy);
    }

    public Int2ObjectOpenCustomHashMap(int[] nArray, V[] VArray, float f, IntHash.Strategy strategy) {
    ...
    public Int2ObjectOpenCustomHashMap(int[] nArray, V[] VArray, IntHash.Strategy strategy) {
    ...
    public boolean remove(int n, Object object) {
        ...
        if (this.strategy.equals(n, n3) && Objects.equals(object, this.value[n2])) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if ((n3 = nArray[n2 = n2 + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(n, n3) || !Objects.equals(object, this.value[n2]));
        this.removeEntry(n2);
        return false;
    }
    ...
    public ObjectCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(this){
                final Int2ObjectOpenCustomHashMap this$0;
                {
    ...
    public Int2ObjectOpenCustomHashMap<V> clone() {
        Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap;
        try {
            int2ObjectOpenCustomHashMap = (Int2ObjectOpenCustomHashMap)super.clone();
        ...
        int2ObjectOpenCustomHashMap.value = (Object[])this.value.clone();
    ...
    static Object access$300(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap) {
        return int2ObjectOpenCustomHashMap.removeNullEntry();
    }

    static Object access$400(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap, int n) {
        return int2ObjectOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap) {
            this.this$0 = int2ObjectOpenCustomHashMap;
            super(int2ObjectOpenCustomHashMap, null);
        }
    ...
    extends AbstractIntSet {
        ...
        private KeySet(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap) {
            this.this$0 = int2ObjectOpenCustomHashMap;
        }
        ...
        KeySet(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap, 1 var2_2) {
            this(int2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements IntIterator {
        ...
        public KeyIterator(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap) {
            this.this$0 = int2ObjectOpenCustomHashMap;
            super(int2ObjectOpenCustomHashMap, null);
        }
    ...
    implements Int2ObjectMap.FastEntrySet<V> {
        ...
        private MapEntrySet(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap) {
            this.this$0 = int2ObjectOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(n, 0)) {
                if (this.this$0.containsNullKey && Objects.equals(this.this$0.value[this.this$0.n], v)) {
                    Int2ObjectOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(n3, n)) {
                if (Objects.equals(this.this$0.value[n2], v)) {
                    Int2ObjectOpenCustomHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((n3 = nArray[n2 = n2 + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(n3, n) || !Objects.equals(this.this$0.value[n2], v));
            Int2ObjectOpenCustomHashMap.access$400(this.this$0, n2);
            return false;
        }
        ...
        public void forEach(Consumer<? super Int2ObjectMap.Entry<V>> consumer) {
            if (this.this$0.containsNullKey) {
                consumer.accept(new AbstractInt2ObjectMap.BasicEntry(this.this$0.key[this.this$0.n], this.this$0.value[this.this$0.n]));
            }
            int n = this.this$0.n;
            while (n-- != 0) {
                if (this.this$0.key[n] == 0) continue;
                consumer.accept(new AbstractInt2ObjectMap.BasicEntry(this.this$0.key[n], this.this$0.value[n]));
            }
        }
        ...
        MapEntrySet(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap, 1 var2_2) {
            this(int2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2ObjectMap.Entry<V>> {
        ...
        private FastEntryIterator(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap) {
            this.this$0 = int2ObjectOpenCustomHashMap;
            super(int2ObjectOpenCustomHashMap, null);
        ...
        FastEntryIterator(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap, 1 var2_2) {
            this(int2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2ObjectMap.Entry<V>> {
        ...
        private EntryIterator(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap) {
            this.this$0 = int2ObjectOpenCustomHashMap;
            super(int2ObjectOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap, 1 var2_2) {
            this(int2ObjectOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap) {
            this.this$0 = int2ObjectOpenCustomHashMap;
        ...
        MapIterator(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap, 1 var2_2) {
            this(int2ObjectOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Integer, V> {
        ...
        MapEntry(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap, int n) {
            this.this$0 = int2ObjectOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Int2ObjectOpenCustomHashMap int2ObjectOpenCustomHashMap) {
            this.this$0 = int2ObjectOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Integer)entry.getKey()) && Objects.equals(this.this$0.value[this.index], entry.getValue());
        }
