...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Int2ObjectAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Int2ObjectAVLTreeMap(Comparator<? super Integer> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Int2ObjectAVLTreeMap(Map<? extends Integer, ? extends V> map) {
        this();
        this.putAll((Map<Integer, ? extends V>)map);
    }

    public Int2ObjectAVLTreeMap(SortedMap<Integer, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Integer, V>)sortedMap);
    }

    public Int2ObjectAVLTreeMap(Int2ObjectMap<? extends V> int2ObjectMap) {
        this();
        this.putAll(int2ObjectMap);
    }

    public Int2ObjectAVLTreeMap(Int2ObjectSortedMap<V> int2ObjectSortedMap) {
        this(int2ObjectSortedMap.comparator());
        this.putAll(int2ObjectSortedMap);
    }

    public Int2ObjectAVLTreeMap(int[] nArray, V[] VArray, Comparator<? super Integer> comparator) {
        this(comparator);
    ...
    public Int2ObjectAVLTreeMap(int[] nArray, V[] VArray) {
    ...
    public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ObjectMap.Entry<V>>(this){
                final Comparator<? super Int2ObjectMap.Entry<V>> comparator;
                final Int2ObjectAVLTreeMap this$0;
                {
                    this.this$0 = int2ObjectAVLTreeMap;
                ...
                public ObjectSortedSet<Int2ObjectMap.Entry<V>> subSet(Int2ObjectMap.Entry<V> entry, Int2ObjectMap.Entry<V> entry2) {
                    return this.this$0.subMap(entry.getIntKey(), entry2.getIntKey()).int2ObjectEntrySet();
                }

                @Override
                public ObjectSortedSet<Int2ObjectMap.Entry<V>> headSet(Int2ObjectMap.Entry<V> entry) {
                    return this.this$0.headMap(entry.getIntKey()).int2ObjectEntrySet();
                }

                @Override
                public ObjectSortedSet<Int2ObjectMap.Entry<V>> tailSet(Int2ObjectMap.Entry<V> entry) {
                    return this.this$0.tailMap(entry.getIntKey()).int2ObjectEntrySet();
                }
                ...
                private int lambda$$0(Int2ObjectMap.Entry entry, Int2ObjectMap.Entry entry2) {
    ...
    public Int2ObjectAVLTreeMap<V> clone() {
        ...
        try {
            int2ObjectAVLTreeMap = (Int2ObjectAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2ObjectAVLTreeMap.keys = null;
        int2ObjectAVLTreeMap.values = null;
        int2ObjectAVLTreeMap.entries = null;
        int2ObjectAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            int2ObjectAVLTreeMap.tree = entry2.left;
                            int2ObjectAVLTreeMap.firstEntry = int2ObjectAVLTreeMap.tree;
                            while (int2ObjectAVLTreeMap.firstEntry.left != null) {
                                int2ObjectAVLTreeMap.firstEntry = int2ObjectAVLTreeMap.firstEntry.left;
                            }
                            int2ObjectAVLTreeMap.lastEntry = int2ObjectAVLTreeMap.tree;
                            while (int2ObjectAVLTreeMap.lastEntry.right != null) {
                                int2ObjectAVLTreeMap.lastEntry = int2ObjectAVLTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Int2ObjectAVLTreeMap int2ObjectAVLTreeMap, int n, boolean bl, int n2, boolean bl2) {
            this.this$0 = int2ObjectAVLTreeMap;
            if (!bl && !bl2 && int2ObjectAVLTreeMap.compare(n, n2) > 0) {
            ...
            this.to = n2;
            this.top = bl2;
            this.defRetValue = int2ObjectAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2ObjectMap.Entry<V>>(this){
                    ...
                    @Override
                    public Comparator<? super Int2ObjectMap.Entry<V>> comparator() {
                        return this.this$1.this$0.int2ObjectEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Int2ObjectMap.Entry<V>> subSet(Int2ObjectMap.Entry<V> entry, Int2ObjectMap.Entry<V> entry2) {
                        return this.this$1.subMap(entry.getIntKey(), entry2.getIntKey()).int2ObjectEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Int2ObjectMap.Entry<V>> headSet(Int2ObjectMap.Entry<V> entry) {
                        return this.this$1.headMap(entry.getIntKey()).int2ObjectEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Int2ObjectMap.Entry<V>> tailSet(Int2ObjectMap.Entry<V> entry) {
                        return this.this$1.tailMap(entry.getIntKey()).int2ObjectEntrySet();
                    }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Int2ObjectAVLTreeMap int2ObjectAVLTreeMap) {
            this.this$0 = int2ObjectAVLTreeMap;
            super(int2ObjectAVLTreeMap);
        }
        ...
        ValueIterator(Int2ObjectAVLTreeMap int2ObjectAVLTreeMap, 1 var2_2) {
            this(int2ObjectAVLTreeMap);
        }
    }
    ...
    extends AbstractInt2ObjectSortedMap.KeySet {
        ...
        private KeySet(Int2ObjectAVLTreeMap int2ObjectAVLTreeMap) {
            this.this$0 = int2ObjectAVLTreeMap;
            super(int2ObjectAVLTreeMap);
        }
        ...
        KeySet(Int2ObjectAVLTreeMap int2ObjectAVLTreeMap, 1 var2_2) {
            this(int2ObjectAVLTreeMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2ObjectAVLTreeMap int2ObjectAVLTreeMap) {
            this.this$0 = int2ObjectAVLTreeMap;
            super(int2ObjectAVLTreeMap);
        }

        public KeyIterator(Int2ObjectAVLTreeMap int2ObjectAVLTreeMap, int n) {
            this.this$0 = int2ObjectAVLTreeMap;
            super(int2ObjectAVLTreeMap, n);
        }
    ...
    implements ObjectListIterator<Int2ObjectMap.Entry<V>> {
        ...
        EntryIterator(Int2ObjectAVLTreeMap int2ObjectAVLTreeMap) {
            this.this$0 = int2ObjectAVLTreeMap;
            super(int2ObjectAVLTreeMap);
        }

        EntryIterator(Int2ObjectAVLTreeMap int2ObjectAVLTreeMap, int n) {
            this.this$0 = int2ObjectAVLTreeMap;
            super(int2ObjectAVLTreeMap, n);
        }
        ...
        public void add(Object object) {
            this.add((Int2ObjectMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Int2ObjectMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Int2ObjectAVLTreeMap int2ObjectAVLTreeMap) {
            this.this$0 = int2ObjectAVLTreeMap;
            this.index = 0;
            this.next = int2ObjectAVLTreeMap.firstEntry;
        }

        TreeIterator(Int2ObjectAVLTreeMap int2ObjectAVLTreeMap, int n) {
            this.this$0 = int2ObjectAVLTreeMap;
            this.index = 0;
            this.next = int2ObjectAVLTreeMap.locateKey(n);
            if (this.next != null) {
                if (int2ObjectAVLTreeMap.compare(this.next.key, n) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Integer)entry.getKey() && Objects.equals(this.value, entry.getValue());
        }
