...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Int2BooleanAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Int2BooleanAVLTreeMap(Comparator<? super Integer> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Int2BooleanAVLTreeMap(Map<? extends Integer, ? extends Boolean> map) {
        this();
        this.putAll(map);
    }

    public Int2BooleanAVLTreeMap(SortedMap<Integer, Boolean> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Integer, ? extends Boolean>)sortedMap);
    }

    public Int2BooleanAVLTreeMap(Int2BooleanMap int2BooleanMap) {
        this();
        this.putAll(int2BooleanMap);
    }

    public Int2BooleanAVLTreeMap(Int2BooleanSortedMap int2BooleanSortedMap) {
        this(int2BooleanSortedMap.comparator());
        this.putAll(int2BooleanSortedMap);
    }

    public Int2BooleanAVLTreeMap(int[] nArray, boolean[] blArray, Comparator<? super Integer> comparator) {
        this(comparator);
    ...
    public Int2BooleanAVLTreeMap(int[] nArray, boolean[] blArray) {
        this(nArray, blArray, null);
    }
    ...
    public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>(this){
                final Comparator<? super Int2BooleanMap.Entry> comparator;
                final Int2BooleanAVLTreeMap this$0;
                {
                    this.this$0 = int2BooleanAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator(Int2BooleanMap.Entry entry) {
                ...
                public ObjectSortedSet<Int2BooleanMap.Entry> subSet(Int2BooleanMap.Entry entry, Int2BooleanMap.Entry entry2) {
                    return this.this$0.subMap(entry.getIntKey(), entry2.getIntKey()).int2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Int2BooleanMap.Entry> headSet(Int2BooleanMap.Entry entry) {
                    return this.this$0.headMap(entry.getIntKey()).int2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Int2BooleanMap.Entry> tailSet(Int2BooleanMap.Entry entry) {
                    return this.this$0.tailMap(entry.getIntKey()).int2BooleanEntrySet();
                }
                ...
                private int lambda$$0(Int2BooleanMap.Entry entry, Int2BooleanMap.Entry entry2) {
    ...
    public Int2BooleanAVLTreeMap clone() {
        Int2BooleanAVLTreeMap int2BooleanAVLTreeMap;
        try {
            int2BooleanAVLTreeMap = (Int2BooleanAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2BooleanAVLTreeMap.keys = null;
        int2BooleanAVLTreeMap.values = null;
        int2BooleanAVLTreeMap.entries = null;
        int2BooleanAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            int2BooleanAVLTreeMap.firstEntry = int2BooleanAVLTreeMap.tree = entry2.left;
                            while (int2BooleanAVLTreeMap.firstEntry.left != null) {
                                int2BooleanAVLTreeMap.firstEntry = int2BooleanAVLTreeMap.firstEntry.left;
                            }
                            int2BooleanAVLTreeMap.lastEntry = int2BooleanAVLTreeMap.tree;
                            while (int2BooleanAVLTreeMap.lastEntry.right != null) {
                                int2BooleanAVLTreeMap.lastEntry = int2BooleanAVLTreeMap.lastEntry.right;
                            }
                            return int2BooleanAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readInt(), objectInputStream.readBoolean());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readInt(), objectInputStream.readBoolean());
            entry4.right(new Entry(objectInputStream.readInt(), objectInputStream.readBoolean()));
    ...
    implements Serializable {
        ...
        public Submap(Int2BooleanAVLTreeMap int2BooleanAVLTreeMap, int n, boolean bl, int n2, boolean bl2) {
            this.this$0 = int2BooleanAVLTreeMap;
            if (!bl && !bl2 && int2BooleanAVLTreeMap.compare(n, n2) > 0) {
            ...
            this.to = n2;
            this.top = bl2;
            this.defRetValue = int2BooleanAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Int2BooleanMap.Entry> comparator() {
                        return this.this$1.this$0.int2BooleanEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Int2BooleanMap.Entry> subSet(Int2BooleanMap.Entry entry, Int2BooleanMap.Entry entry2) {
                        return this.this$1.subMap(entry.getIntKey(), entry2.getIntKey()).int2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Int2BooleanMap.Entry> headSet(Int2BooleanMap.Entry entry) {
                        return this.this$1.headMap(entry.getIntKey()).int2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Int2BooleanMap.Entry> tailSet(Int2BooleanMap.Entry entry) {
                        return this.this$1.tailMap(entry.getIntKey()).int2BooleanEntrySet();
                    }
        ...
        public boolean put(int n, boolean bl) {
            ...
            boolean bl2 = this.this$0.put(n, bl);
        ...
        public boolean remove(int n) {
            ...
            boolean bl = this.this$0.remove(n);
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Int2BooleanAVLTreeMap int2BooleanAVLTreeMap) {
            this.this$0 = int2BooleanAVLTreeMap;
            super(int2BooleanAVLTreeMap);
        }
        ...
        ValueIterator(Int2BooleanAVLTreeMap int2BooleanAVLTreeMap, 1 var2_2) {
            this(int2BooleanAVLTreeMap);
        }
    }
    ...
    extends AbstractInt2BooleanSortedMap.KeySet {
        ...
        private KeySet(Int2BooleanAVLTreeMap int2BooleanAVLTreeMap) {
            this.this$0 = int2BooleanAVLTreeMap;
            super(int2BooleanAVLTreeMap);
        }
        ...
        KeySet(Int2BooleanAVLTreeMap int2BooleanAVLTreeMap, 1 var2_2) {
            this(int2BooleanAVLTreeMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2BooleanAVLTreeMap int2BooleanAVLTreeMap) {
            this.this$0 = int2BooleanAVLTreeMap;
            super(int2BooleanAVLTreeMap);
        }

        public KeyIterator(Int2BooleanAVLTreeMap int2BooleanAVLTreeMap, int n) {
            this.this$0 = int2BooleanAVLTreeMap;
            super(int2BooleanAVLTreeMap, n);
        }
    ...
    implements ObjectListIterator<Int2BooleanMap.Entry> {
        ...
        EntryIterator(Int2BooleanAVLTreeMap int2BooleanAVLTreeMap) {
            this.this$0 = int2BooleanAVLTreeMap;
            super(int2BooleanAVLTreeMap);
        }

        EntryIterator(Int2BooleanAVLTreeMap int2BooleanAVLTreeMap, int n) {
            this.this$0 = int2BooleanAVLTreeMap;
            super(int2BooleanAVLTreeMap, n);
        }
        ...
        public void add(Object object) {
            this.add((Int2BooleanMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Int2BooleanMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Int2BooleanAVLTreeMap int2BooleanAVLTreeMap) {
            this.this$0 = int2BooleanAVLTreeMap;
            this.index = 0;
            this.next = int2BooleanAVLTreeMap.firstEntry;
        }

        TreeIterator(Int2BooleanAVLTreeMap int2BooleanAVLTreeMap, int n) {
            this.this$0 = int2BooleanAVLTreeMap;
            this.index = 0;
            this.next = int2BooleanAVLTreeMap.locateKey(n);
            if (this.next != null) {
                if (int2BooleanAVLTreeMap.compare(this.next.key, n) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Integer)entry.getKey() && this.value == (Boolean)entry.getValue();
        }
