...
Hash {
    ...
    public Int2BooleanOpenCustomHashMap(int n, float f, IntHash.Strategy strategy) {
    ...
    public Int2BooleanOpenCustomHashMap(int n, IntHash.Strategy strategy) {
    ...
    public Int2BooleanOpenCustomHashMap(int[] nArray, boolean[] blArray, float f, IntHash.Strategy strategy) {
    ...
    public Int2BooleanOpenCustomHashMap(int[] nArray, boolean[] blArray, IntHash.Strategy strategy) {
        this(nArray, blArray, 0.75f, strategy);
    }
    ...
    public boolean remove(int n, boolean bl) {
        ...
        if (this.strategy.equals(n, n3) && bl == this.value[n2]) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if ((n3 = nArray[n2 = n2 + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(n, n3) || bl != this.value[n2]);
        this.removeEntry(n2);
        return false;
    }
    ...
    public BooleanCollection values() {
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(this){
                final Int2BooleanOpenCustomHashMap this$0;
                {
                    this.this$0 = int2BooleanOpenCustomHashMap;
                }
    ...
    public Int2BooleanOpenCustomHashMap clone() {
        Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap;
        try {
            int2BooleanOpenCustomHashMap = (Int2BooleanOpenCustomHashMap)super.clone();
    ...
    static boolean access$300(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap) {
        return int2BooleanOpenCustomHashMap.removeNullEntry();
    }

    static boolean access$400(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap, int n) {
        return int2BooleanOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements BooleanIterator {
        ...
        public ValueIterator(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap) {
            this.this$0 = int2BooleanOpenCustomHashMap;
            super(int2BooleanOpenCustomHashMap, null);
        }
    ...
    extends AbstractIntSet {
        ...
        private KeySet(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap) {
            this.this$0 = int2BooleanOpenCustomHashMap;
        }
        ...
        KeySet(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap, 1 var2_2) {
            this(int2BooleanOpenCustomHashMap);
        }
    }
    ...
    implements IntIterator {
        ...
        public KeyIterator(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap) {
            this.this$0 = int2BooleanOpenCustomHashMap;
            super(int2BooleanOpenCustomHashMap, null);
        }
    ...
    implements Int2BooleanMap.FastEntrySet {
        ...
        private MapEntrySet(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap) {
            this.this$0 = int2BooleanOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(n, 0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == bl) {
                    Int2BooleanOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(n3, n)) {
                if (this.this$0.value[n2] == bl) {
                    Int2BooleanOpenCustomHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((n3 = nArray[n2 = n2 + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(n3, n) || this.this$0.value[n2] != bl);
            Int2BooleanOpenCustomHashMap.access$400(this.this$0, n2);
            return false;
        }
        ...
        MapEntrySet(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap, 1 var2_2) {
            this(int2BooleanOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2BooleanMap.Entry> {
        ...
        private FastEntryIterator(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap) {
            this.this$0 = int2BooleanOpenCustomHashMap;
            super(int2BooleanOpenCustomHashMap, null);
        ...
        FastEntryIterator(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap, 1 var2_2) {
            this(int2BooleanOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2BooleanMap.Entry> {
        ...
        private EntryIterator(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap) {
            this.this$0 = int2BooleanOpenCustomHashMap;
            super(int2BooleanOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap, 1 var2_2) {
            this(int2BooleanOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap) {
            this.this$0 = int2BooleanOpenCustomHashMap;
        ...
        MapIterator(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap, 1 var2_2) {
            this(int2BooleanOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Integer, Boolean> {
        ...
        MapEntry(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap, int n) {
            this.this$0 = int2BooleanOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Int2BooleanOpenCustomHashMap int2BooleanOpenCustomHashMap) {
            this.this$0 = int2BooleanOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Integer)entry.getKey()) && this.this$0.value[this.index] == (Boolean)entry.getValue();
        }
