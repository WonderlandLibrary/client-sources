...
Hash {
    ...
    public Int2ShortOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Int2ShortOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Int2ShortOpenHashMap(Map<? extends Integer, ? extends Short> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }
    ...
    public Int2ShortOpenHashMap(Int2ShortMap int2ShortMap, float f) {
        this(int2ShortMap.size(), f);
        this.putAll(int2ShortMap);
    }

    public Int2ShortOpenHashMap(Int2ShortMap int2ShortMap) {
        this(int2ShortMap, 0.75f);
    }

    public Int2ShortOpenHashMap(int[] nArray, short[] sArray, float f) {
    ...
    public Int2ShortOpenHashMap(int[] nArray, short[] sArray) {
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection(this){
                final Int2ShortOpenHashMap this$0;
                {
                    this.this$0 = int2ShortOpenHashMap;
                }
    ...
    public Int2ShortOpenHashMap clone() {
        Int2ShortOpenHashMap int2ShortOpenHashMap;
        try {
            int2ShortOpenHashMap = (Int2ShortOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2ShortOpenHashMap.keys = null;
        int2ShortOpenHashMap.values = null;
        int2ShortOpenHashMap.entries = null;
        int2ShortOpenHashMap.containsNullKey = this.containsNullKey;
        int2ShortOpenHashMap.key = (int[])this.key.clone();
        int2ShortOpenHashMap.value = (short[])this.value.clone();
        return int2ShortOpenHashMap;
    }
    ...
    static short access$300(Int2ShortOpenHashMap int2ShortOpenHashMap) {
        return int2ShortOpenHashMap.removeNullEntry();
    }

    static short access$400(Int2ShortOpenHashMap int2ShortOpenHashMap, int n) {
        return int2ShortOpenHashMap.removeEntry(n);
    }
    ...
    implements ShortIterator {
        ...
        public ValueIterator(Int2ShortOpenHashMap int2ShortOpenHashMap) {
            this.this$0 = int2ShortOpenHashMap;
            super(int2ShortOpenHashMap, null);
        }
    ...
    extends AbstractIntSet {
        ...
        private KeySet(Int2ShortOpenHashMap int2ShortOpenHashMap) {
            this.this$0 = int2ShortOpenHashMap;
        }
        ...
        KeySet(Int2ShortOpenHashMap int2ShortOpenHashMap, 1 var2_2) {
            this(int2ShortOpenHashMap);
        }
    }
    ...
    implements IntIterator {
        ...
        public KeyIterator(Int2ShortOpenHashMap int2ShortOpenHashMap) {
            this.this$0 = int2ShortOpenHashMap;
            super(int2ShortOpenHashMap, null);
        }
    ...
    implements Int2ShortMap.FastEntrySet {
        ...
        private MapEntrySet(Int2ShortOpenHashMap int2ShortOpenHashMap) {
            this.this$0 = int2ShortOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (n == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == s) {
                    Int2ShortOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (n3 == n) {
                if (this.this$0.value[n2] == s) {
                    Int2ShortOpenHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Int2ShortOpenHashMap int2ShortOpenHashMap, 1 var2_2) {
            this(int2ShortOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2ShortMap.Entry> {
        ...
        private FastEntryIterator(Int2ShortOpenHashMap int2ShortOpenHashMap) {
            this.this$0 = int2ShortOpenHashMap;
            super(int2ShortOpenHashMap, null);
        ...
        FastEntryIterator(Int2ShortOpenHashMap int2ShortOpenHashMap, 1 var2_2) {
            this(int2ShortOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2ShortMap.Entry> {
        ...
        private EntryIterator(Int2ShortOpenHashMap int2ShortOpenHashMap) {
            this.this$0 = int2ShortOpenHashMap;
            super(int2ShortOpenHashMap, null);
        }
        ...
        EntryIterator(Int2ShortOpenHashMap int2ShortOpenHashMap, 1 var2_2) {
            this(int2ShortOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Int2ShortOpenHashMap int2ShortOpenHashMap) {
            this.this$0 = int2ShortOpenHashMap;
        ...
        MapIterator(Int2ShortOpenHashMap int2ShortOpenHashMap, 1 var2_2) {
            this(int2ShortOpenHashMap);
        }
    }
    ...
    Map.Entry<Integer, Short> {
        ...
        MapEntry(Int2ShortOpenHashMap int2ShortOpenHashMap, int n) {
            this.this$0 = int2ShortOpenHashMap;
            this.index = n;
        }

        MapEntry(Int2ShortOpenHashMap int2ShortOpenHashMap) {
            this.this$0 = int2ShortOpenHashMap;
        }
