...
Hash {
    ...
    public Int2ReferenceLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Int2ReferenceLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Int2ReferenceLinkedOpenHashMap(Map<? extends Integer, ? extends V> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Int2ReferenceLinkedOpenHashMap(Map<? extends Integer, ? extends V> map) {
        this(map, 0.75f);
    }

    public Int2ReferenceLinkedOpenHashMap(Int2ReferenceMap<V> int2ReferenceMap, float f) {
        this(int2ReferenceMap.size(), f);
        this.putAll(int2ReferenceMap);
    }

    public Int2ReferenceLinkedOpenHashMap(Int2ReferenceMap<V> int2ReferenceMap) {
        this(int2ReferenceMap, 0.75f);
    }

    public Int2ReferenceLinkedOpenHashMap(int[] nArray, V[] VArray, float f) {
    ...
    public Int2ReferenceLinkedOpenHashMap(int[] nArray, V[] VArray) {
    ...
    public boolean remove(int n, Object object) {
        ...
        do {
            if ((n3 = nArray[n2 = n2 + 1 & this.mask]) != 0) continue;
            return true;
        } while (n != n3 || object != this.value[n2]);
        this.removeEntry(n2);
        return false;
    }
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Int2ReferenceLinkedOpenHashMap this$0;
                {
                    this.this$0 = int2ReferenceLinkedOpenHashMap;
                }
    ...
    public Int2ReferenceLinkedOpenHashMap<V> clone() {
        Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap;
        try {
            int2ReferenceLinkedOpenHashMap = (Int2ReferenceLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2ReferenceLinkedOpenHashMap.keys = null;
        int2ReferenceLinkedOpenHashMap.values = null;
        int2ReferenceLinkedOpenHashMap.entries = null;
        int2ReferenceLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        int2ReferenceLinkedOpenHashMap.key = (int[])this.key.clone();
        int2ReferenceLinkedOpenHashMap.value = (Object[])this.value.clone();
        int2ReferenceLinkedOpenHashMap.link = (long[])this.link.clone();
    ...
    static Object access$100(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap) {
        return int2ReferenceLinkedOpenHashMap.removeNullEntry();
    }

    static Object access$200(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap, int n) {
        return int2ReferenceLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectListIterator<V> {
        ...
        public ValueIterator(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap) {
            this.this$0 = int2ReferenceLinkedOpenHashMap;
            super(int2ReferenceLinkedOpenHashMap);
        }
    ...
    extends AbstractIntSortedSet {
        ...
        private KeySet(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap) {
            this.this$0 = int2ReferenceLinkedOpenHashMap;
        }
        ...
        KeySet(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap, 1 var2_2) {
            this(int2ReferenceLinkedOpenHashMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap, int n) {
            this.this$0 = int2ReferenceLinkedOpenHashMap;
            super(int2ReferenceLinkedOpenHashMap, n, null);
        }
        ...
        public KeyIterator(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap) {
            this.this$0 = int2ReferenceLinkedOpenHashMap;
            super(int2ReferenceLinkedOpenHashMap);
        }
    ...
    implements Int2ReferenceSortedMap.FastSortedEntrySet<V> {
        ...
        private MapEntrySet(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap) {
            this.this$0 = int2ReferenceLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (n == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Int2ReferenceLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (n3 == n) {
                if (this.this$0.value[n2] == v) {
                    Int2ReferenceLinkedOpenHashMap.access$200(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((n3 = nArray[n2 = n2 + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (n3 != n || this.this$0.value[n2] != v);
            Int2ReferenceLinkedOpenHashMap.access$200(this.this$0, n2);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Int2ReferenceMap.Entry<V>> iterator(Int2ReferenceMap.Entry<V> entry) {
        ...
        @Override
        public ObjectListIterator<Int2ReferenceMap.Entry<V>> fastIterator(Int2ReferenceMap.Entry<V> entry) {
        ...
        public void forEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractInt2ReferenceMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Int2ReferenceMap.Entry entry) {
        ...
        MapEntrySet(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap, 1 var2_2) {
            this(int2ReferenceLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Int2ReferenceMap.Entry<V>> {
        ...
        public FastEntryIterator(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap) {
            this.this$0 = int2ReferenceLinkedOpenHashMap;
            super(int2ReferenceLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap, int n) {
            this.this$0 = int2ReferenceLinkedOpenHashMap;
            super(int2ReferenceLinkedOpenHashMap, n, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Int2ReferenceMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Int2ReferenceMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Int2ReferenceMap.Entry<V>> {
        ...
        public EntryIterator(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap) {
            this.this$0 = int2ReferenceLinkedOpenHashMap;
            super(int2ReferenceLinkedOpenHashMap);
        }

        public EntryIterator(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap, int n) {
            this.this$0 = int2ReferenceLinkedOpenHashMap;
            super(int2ReferenceLinkedOpenHashMap, n, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap) {
            this.this$0 = int2ReferenceLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = int2ReferenceLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap, int n) {
            this.this$0 = int2ReferenceLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (n == 0) {
                if (int2ReferenceLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)int2ReferenceLinkedOpenHashMap.link[int2ReferenceLinkedOpenHashMap.n];
                    this.prev = int2ReferenceLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + n + " does not belong to this map.");
            }
            if (int2ReferenceLinkedOpenHashMap.key[int2ReferenceLinkedOpenHashMap.last] == n) {
                this.prev = int2ReferenceLinkedOpenHashMap.last;
                this.index = int2ReferenceLinkedOpenHashMap.size;
                return;
            }
            int n2 = HashCommon.mix(n) & int2ReferenceLinkedOpenHashMap.mask;
            while (int2ReferenceLinkedOpenHashMap.key[n2] != 0) {
                if (int2ReferenceLinkedOpenHashMap.key[n2] == n) {
                    this.next = (int)int2ReferenceLinkedOpenHashMap.link[n2];
                    this.prev = n2;
                    return;
                }
                n2 = n2 + 1 & int2ReferenceLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + n + " does not belong to this map.");
        }
        ...
        public void set(Int2ReferenceMap.Entry<V> entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Int2ReferenceMap.Entry<V> entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap, int n, 1 var3_3) {
            this(int2ReferenceLinkedOpenHashMap, n);
        }
    }
    ...
    Map.Entry<Integer, V> {
        ...
        MapEntry(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap, int n) {
            this.this$0 = int2ReferenceLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Int2ReferenceLinkedOpenHashMap int2ReferenceLinkedOpenHashMap) {
            this.this$0 = int2ReferenceLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.key[this.index] == (Integer)entry.getKey() && this.this$0.value[this.index] == entry.getValue();
        }
