...
Hash {
    ...
    public Int2LongOpenCustomHashMap(int n, float f, IntHash.Strategy strategy) {
    ...
    public Int2LongOpenCustomHashMap(int n, IntHash.Strategy strategy) {
    ...
    public Int2LongOpenCustomHashMap(Map<? extends Integer, ? extends Long> map, float f, IntHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Int2LongOpenCustomHashMap(Map<? extends Integer, ? extends Long> map, IntHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Int2LongOpenCustomHashMap(Int2LongMap int2LongMap, float f, IntHash.Strategy strategy) {
        this(int2LongMap.size(), f, strategy);
        this.putAll(int2LongMap);
    }

    public Int2LongOpenCustomHashMap(Int2LongMap int2LongMap, IntHash.Strategy strategy) {
        this(int2LongMap, 0.75f, strategy);
    }

    public Int2LongOpenCustomHashMap(int[] nArray, long[] lArray, float f, IntHash.Strategy strategy) {
    ...
    public Int2LongOpenCustomHashMap(int[] nArray, long[] lArray, IntHash.Strategy strategy) {
        this(nArray, lArray, 0.75f, strategy);
    }
    ...
    public boolean remove(int n, long l) {
        ...
        if (this.strategy.equals(n, n3) && l == this.value[n2]) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if ((n3 = nArray[n2 = n2 + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(n, n3) || l != this.value[n2]);
        this.removeEntry(n2);
        return false;
    }
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection(this){
                final Int2LongOpenCustomHashMap this$0;
                {
                    this.this$0 = int2LongOpenCustomHashMap;
                }
    ...
    public Int2LongOpenCustomHashMap clone() {
        Int2LongOpenCustomHashMap int2LongOpenCustomHashMap;
        try {
            int2LongOpenCustomHashMap = (Int2LongOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2LongOpenCustomHashMap.keys = null;
        int2LongOpenCustomHashMap.values = null;
        int2LongOpenCustomHashMap.entries = null;
        int2LongOpenCustomHashMap.containsNullKey = this.containsNullKey;
        int2LongOpenCustomHashMap.key = (int[])this.key.clone();
        int2LongOpenCustomHashMap.value = (long[])this.value.clone();
        int2LongOpenCustomHashMap.strategy = this.strategy;
        return int2LongOpenCustomHashMap;
    }
    ...
    static long access$300(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap) {
        return int2LongOpenCustomHashMap.removeNullEntry();
    }

    static long access$400(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap, int n) {
        return int2LongOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements LongIterator {
        ...
        public ValueIterator(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap) {
            this.this$0 = int2LongOpenCustomHashMap;
            super(int2LongOpenCustomHashMap, null);
        }
    ...
    extends AbstractIntSet {
        ...
        private KeySet(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap) {
            this.this$0 = int2LongOpenCustomHashMap;
        }
        ...
        KeySet(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap, 1 var2_2) {
            this(int2LongOpenCustomHashMap);
        }
    }
    ...
    implements IntIterator {
        ...
        public KeyIterator(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap) {
            this.this$0 = int2LongOpenCustomHashMap;
            super(int2LongOpenCustomHashMap, null);
        }
    ...
    implements Int2LongMap.FastEntrySet {
        ...
        private MapEntrySet(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap) {
            this.this$0 = int2LongOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(n, 0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == l) {
                    Int2LongOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(n3, n)) {
                if (this.this$0.value[n2] == l) {
                    Int2LongOpenCustomHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((n3 = nArray[n2 = n2 + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(n3, n) || this.this$0.value[n2] != l);
            Int2LongOpenCustomHashMap.access$400(this.this$0, n2);
            return false;
        }
        ...
        MapEntrySet(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap, 1 var2_2) {
            this(int2LongOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2LongMap.Entry> {
        ...
        private FastEntryIterator(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap) {
            this.this$0 = int2LongOpenCustomHashMap;
            super(int2LongOpenCustomHashMap, null);
        ...
        FastEntryIterator(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap, 1 var2_2) {
            this(int2LongOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2LongMap.Entry> {
        ...
        private EntryIterator(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap) {
            this.this$0 = int2LongOpenCustomHashMap;
            super(int2LongOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap, 1 var2_2) {
            this(int2LongOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap) {
            this.this$0 = int2LongOpenCustomHashMap;
        ...
        MapIterator(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap, 1 var2_2) {
            this(int2LongOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Integer, Long> {
        ...
        MapEntry(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap, int n) {
            this.this$0 = int2LongOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Int2LongOpenCustomHashMap int2LongOpenCustomHashMap) {
            this.this$0 = int2LongOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Integer)entry.getKey()) && this.this$0.value[this.index] == (Long)entry.getValue();
        }
