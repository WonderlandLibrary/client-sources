...
Map<Integer, V> {
    ...
    default public V put(Integer n, V v) {
        return Int2ReferenceFunction.super.put(n, v);
    }

    @Override
    @Deprecated
    default public V get(Object object) {
        return Int2ReferenceFunction.super.get(object);
    }

    @Override
    @Deprecated
    default public V remove(Object object) {
        return Int2ReferenceFunction.super.remove(object);
    }
    ...
    default public boolean containsKey(Object object) {
        return Int2ReferenceFunction.super.containsKey(object);
    }
    ...
    default public boolean remove(int n, Object object) {
        Object v = this.get(n);
        if (v != object || v == this.defaultReturnValue() && !this.containsKey(n)) {
            return true;
        }
        this.remove(n);
        return false;
    ...
    default public boolean replace(int n, V v, V v2) {
        Object v3 = this.get(n);
        if (v3 != v || v3 == this.defaultReturnValue() && !this.containsKey(n)) {
            return true;
        }
        this.put(n, v2);
        return false;
    ...
    default public V computeIfAbsentPartial(int n, Int2ReferenceFunction<? extends V> int2ReferenceFunction) {
        Objects.requireNonNull(int2ReferenceFunction);
        Object v = this.get(n);
        V v2 = this.defaultReturnValue();
        if (v != v2 || this.containsKey(n)) {
            return v;
        }
        if (!int2ReferenceFunction.containsKey(n)) {
            return v2;
        }
        V v3 = int2ReferenceFunction.get(n);
        this.put(n, v3);
        return v3;
    }
