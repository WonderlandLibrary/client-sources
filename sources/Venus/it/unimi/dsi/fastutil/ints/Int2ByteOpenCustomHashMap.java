...
Hash {
    ...
    public Int2ByteOpenCustomHashMap(int n, float f, IntHash.Strategy strategy) {
    ...
    public Int2ByteOpenCustomHashMap(int n, IntHash.Strategy strategy) {
    ...
    public Int2ByteOpenCustomHashMap(Map<? extends Integer, ? extends Byte> map, float f, IntHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Int2ByteOpenCustomHashMap(Map<? extends Integer, ? extends Byte> map, IntHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Int2ByteOpenCustomHashMap(Int2ByteMap int2ByteMap, float f, IntHash.Strategy strategy) {
        this(int2ByteMap.size(), f, strategy);
        this.putAll(int2ByteMap);
    }

    public Int2ByteOpenCustomHashMap(Int2ByteMap int2ByteMap, IntHash.Strategy strategy) {
        this(int2ByteMap, 0.75f, strategy);
    }

    public Int2ByteOpenCustomHashMap(int[] nArray, byte[] byArray, float f, IntHash.Strategy strategy) {
    ...
    public Int2ByteOpenCustomHashMap(int[] nArray, byte[] byArray, IntHash.Strategy strategy) {
        this(nArray, byArray, 0.75f, strategy);
    }
    ...
    public boolean remove(int n, byte by) {
        ...
        if (this.strategy.equals(n, n3) && by == this.value[n2]) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if ((n3 = nArray[n2 = n2 + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(n, n3) || by != this.value[n2]);
        this.removeEntry(n2);
        return false;
    }
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection(this){
                final Int2ByteOpenCustomHashMap this$0;
                {
                    this.this$0 = int2ByteOpenCustomHashMap;
                }
    ...
    public Int2ByteOpenCustomHashMap clone() {
        Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap;
        try {
            int2ByteOpenCustomHashMap = (Int2ByteOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2ByteOpenCustomHashMap.keys = null;
        int2ByteOpenCustomHashMap.values = null;
        int2ByteOpenCustomHashMap.entries = null;
        int2ByteOpenCustomHashMap.containsNullKey = this.containsNullKey;
        int2ByteOpenCustomHashMap.key = (int[])this.key.clone();
        int2ByteOpenCustomHashMap.value = (byte[])this.value.clone();
        int2ByteOpenCustomHashMap.strategy = this.strategy;
        return int2ByteOpenCustomHashMap;
    }
    ...
    static byte access$300(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap) {
        return int2ByteOpenCustomHashMap.removeNullEntry();
    }

    static byte access$400(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap, int n) {
        return int2ByteOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ByteIterator {
        ...
        public ValueIterator(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap) {
            this.this$0 = int2ByteOpenCustomHashMap;
            super(int2ByteOpenCustomHashMap, null);
        }
    ...
    extends AbstractIntSet {
        ...
        private KeySet(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap) {
            this.this$0 = int2ByteOpenCustomHashMap;
        }
        ...
        KeySet(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap, 1 var2_2) {
            this(int2ByteOpenCustomHashMap);
        }
    }
    ...
    implements IntIterator {
        ...
        public KeyIterator(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap) {
            this.this$0 = int2ByteOpenCustomHashMap;
            super(int2ByteOpenCustomHashMap, null);
        }
    ...
    implements Int2ByteMap.FastEntrySet {
        ...
        private MapEntrySet(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap) {
            this.this$0 = int2ByteOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(n, 0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == by) {
                    Int2ByteOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(n3, n)) {
                if (this.this$0.value[n2] == by) {
                    Int2ByteOpenCustomHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((n3 = nArray[n2 = n2 + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(n3, n) || this.this$0.value[n2] != by);
            Int2ByteOpenCustomHashMap.access$400(this.this$0, n2);
            return false;
        }
        ...
        MapEntrySet(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap, 1 var2_2) {
            this(int2ByteOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2ByteMap.Entry> {
        ...
        private FastEntryIterator(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap) {
            this.this$0 = int2ByteOpenCustomHashMap;
            super(int2ByteOpenCustomHashMap, null);
        ...
        FastEntryIterator(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap, 1 var2_2) {
            this(int2ByteOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2ByteMap.Entry> {
        ...
        private EntryIterator(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap) {
            this.this$0 = int2ByteOpenCustomHashMap;
            super(int2ByteOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap, 1 var2_2) {
            this(int2ByteOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap) {
            this.this$0 = int2ByteOpenCustomHashMap;
        ...
        MapIterator(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap, 1 var2_2) {
            this(int2ByteOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Integer, Byte> {
        ...
        MapEntry(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap, int n) {
            this.this$0 = int2ByteOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Int2ByteOpenCustomHashMap int2ByteOpenCustomHashMap) {
            this.this$0 = int2ByteOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Integer)entry.getKey()) && this.this$0.value[this.index] == (Byte)entry.getValue();
        }
