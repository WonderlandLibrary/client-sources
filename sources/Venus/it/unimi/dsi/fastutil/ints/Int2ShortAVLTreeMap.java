...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Int2ShortAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Int2ShortAVLTreeMap(Comparator<? super Integer> comparator) {
        this();
    ...
    public Int2ShortAVLTreeMap(SortedMap<Integer, Short> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Integer, ? extends Short>)sortedMap);
    }

    public Int2ShortAVLTreeMap(Int2ShortMap int2ShortMap) {
        this();
        this.putAll(int2ShortMap);
    }

    public Int2ShortAVLTreeMap(Int2ShortSortedMap int2ShortSortedMap) {
        this(int2ShortSortedMap.comparator());
        this.putAll(int2ShortSortedMap);
    }

    public Int2ShortAVLTreeMap(int[] nArray, short[] sArray, Comparator<? super Integer> comparator) {
        this(comparator);
    ...
    public Int2ShortAVLTreeMap(int[] nArray, short[] sArray) {
    ...
    public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ShortMap.Entry>(this){
                ...
                final Int2ShortAVLTreeMap this$0;
                {
                    this.this$0 = int2ShortAVLTreeMap;
    ...
    public Int2ShortAVLTreeMap clone() {
        Int2ShortAVLTreeMap int2ShortAVLTreeMap;
        try {
            int2ShortAVLTreeMap = (Int2ShortAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2ShortAVLTreeMap.keys = null;
        int2ShortAVLTreeMap.values = null;
        int2ShortAVLTreeMap.entries = null;
        int2ShortAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            int2ShortAVLTreeMap.firstEntry = int2ShortAVLTreeMap.tree = entry2.left;
                            while (int2ShortAVLTreeMap.firstEntry.left != null) {
                                int2ShortAVLTreeMap.firstEntry = int2ShortAVLTreeMap.firstEntry.left;
                            }
                            int2ShortAVLTreeMap.lastEntry = int2ShortAVLTreeMap.tree;
                            while (int2ShortAVLTreeMap.lastEntry.right != null) {
                                int2ShortAVLTreeMap.lastEntry = int2ShortAVLTreeMap.lastEntry.right;
                            }
                            return int2ShortAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Int2ShortAVLTreeMap int2ShortAVLTreeMap, int n, boolean bl, int n2, boolean bl2) {
            this.this$0 = int2ShortAVLTreeMap;
            if (!bl && !bl2 && int2ShortAVLTreeMap.compare(n, n2) > 0) {
            ...
            this.to = n2;
            this.top = bl2;
            this.defRetValue = int2ShortAVLTreeMap.defRetValue;
        }
    ...
    implements ShortListIterator {
        ...
        private ValueIterator(Int2ShortAVLTreeMap int2ShortAVLTreeMap) {
            this.this$0 = int2ShortAVLTreeMap;
            super(int2ShortAVLTreeMap);
        }
        ...
        ValueIterator(Int2ShortAVLTreeMap int2ShortAVLTreeMap, 1 var2_2) {
            this(int2ShortAVLTreeMap);
        }
    }
    ...
    extends AbstractInt2ShortSortedMap.KeySet {
        ...
        private KeySet(Int2ShortAVLTreeMap int2ShortAVLTreeMap) {
            this.this$0 = int2ShortAVLTreeMap;
            super(int2ShortAVLTreeMap);
        }
        ...
        KeySet(Int2ShortAVLTreeMap int2ShortAVLTreeMap, 1 var2_2) {
            this(int2ShortAVLTreeMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2ShortAVLTreeMap int2ShortAVLTreeMap) {
            this.this$0 = int2ShortAVLTreeMap;
            super(int2ShortAVLTreeMap);
        }

        public KeyIterator(Int2ShortAVLTreeMap int2ShortAVLTreeMap, int n) {
            this.this$0 = int2ShortAVLTreeMap;
            super(int2ShortAVLTreeMap, n);
        }
    ...
    implements ObjectListIterator<Int2ShortMap.Entry> {
        ...
        EntryIterator(Int2ShortAVLTreeMap int2ShortAVLTreeMap) {
            this.this$0 = int2ShortAVLTreeMap;
            super(int2ShortAVLTreeMap);
        }

        EntryIterator(Int2ShortAVLTreeMap int2ShortAVLTreeMap, int n) {
            this.this$0 = int2ShortAVLTreeMap;
            super(int2ShortAVLTreeMap, n);
        }
        ...
        public void add(Object object) {
            this.add((Int2ShortMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Int2ShortMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Int2ShortAVLTreeMap int2ShortAVLTreeMap) {
            this.this$0 = int2ShortAVLTreeMap;
            this.index = 0;
            this.next = int2ShortAVLTreeMap.firstEntry;
        }

        TreeIterator(Int2ShortAVLTreeMap int2ShortAVLTreeMap, int n) {
            this.this$0 = int2ShortAVLTreeMap;
            this.index = 0;
            this.next = int2ShortAVLTreeMap.locateKey(n);
            if (this.next != null) {
                if (int2ShortAVLTreeMap.compare(this.next.key, n) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
