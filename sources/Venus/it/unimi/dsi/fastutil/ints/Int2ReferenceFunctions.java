...
public final class Int2ReferenceFunctions {
    ...
    public static <V> Int2ReferenceFunction<V> singleton(int n, V v) {
        return new Singleton<V>(n, v);
    }

    public static <V> Int2ReferenceFunction<V> singleton(Integer n, V v) {
        return new Singleton<V>(n, v);
    }

    public static <V> Int2ReferenceFunction<V> synchronize(Int2ReferenceFunction<V> int2ReferenceFunction) {
        return new SynchronizedFunction<V>(int2ReferenceFunction);
    }

    public static <V> Int2ReferenceFunction<V> synchronize(Int2ReferenceFunction<V> int2ReferenceFunction, Object object) {
        return new SynchronizedFunction<V>(int2ReferenceFunction, object);
    }

    public static <V> Int2ReferenceFunction<V> unmodifiable(Int2ReferenceFunction<V> int2ReferenceFunction) {
        return new UnmodifiableFunction<V>(int2ReferenceFunction);
    }

    public static <V> Int2ReferenceFunction<V> primitive(java.util.function.Function<? super Integer, ? extends V> function) {
        Objects.requireNonNull(function);
        if (function instanceof Int2ReferenceFunction) {
            return (Int2ReferenceFunction)function;
        }
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Int2ReferenceFunction<V> int2ReferenceFunction) {
            if (int2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = int2ReferenceFunction;
        }
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Int2ReferenceFunction<V> int2ReferenceFunction, Object object) {
            if (int2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = int2ReferenceFunction;
        ...
        protected SynchronizedFunction(Int2ReferenceFunction<V> int2ReferenceFunction) {
            if (int2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = int2ReferenceFunction;
