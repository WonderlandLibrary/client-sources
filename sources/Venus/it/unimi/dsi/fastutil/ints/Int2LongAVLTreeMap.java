...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Int2LongAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Int2LongAVLTreeMap(int[] nArray, long[] lArray, Comparator<? super Integer> comparator) {
        this(comparator);
    ...
    public Int2LongAVLTreeMap(int[] nArray, long[] lArray) {
    ...
    public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2LongMap.Entry>(this){
                ...
                final Int2LongAVLTreeMap this$0;
                {
                    this.this$0 = int2LongAVLTreeMap;
    ...
    public Int2LongAVLTreeMap clone() {
        Int2LongAVLTreeMap int2LongAVLTreeMap;
        try {
            int2LongAVLTreeMap = (Int2LongAVLTreeMap)super.clone();
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            int2LongAVLTreeMap.firstEntry = int2LongAVLTreeMap.tree = entry2.left;
    ...
    implements Serializable {
        ...
        public Submap(Int2LongAVLTreeMap int2LongAVLTreeMap, int n, boolean bl, int n2, boolean bl2) {
            this.this$0 = int2LongAVLTreeMap;
            if (!bl && !bl2 && int2LongAVLTreeMap.compare(n, n2) > 0) {
            ...
            this.to = n2;
            this.top = bl2;
            this.defRetValue = int2LongAVLTreeMap.defRetValue;
        }
    ...
    implements LongListIterator {
        ...
        private ValueIterator(Int2LongAVLTreeMap int2LongAVLTreeMap) {
            this.this$0 = int2LongAVLTreeMap;
            super(int2LongAVLTreeMap);
        }
        ...
        ValueIterator(Int2LongAVLTreeMap int2LongAVLTreeMap, 1 var2_2) {
            this(int2LongAVLTreeMap);
        }
    }
    ...
    extends AbstractInt2LongSortedMap.KeySet {
        ...
        private KeySet(Int2LongAVLTreeMap int2LongAVLTreeMap) {
            this.this$0 = int2LongAVLTreeMap;
            super(int2LongAVLTreeMap);
        }
        ...
        KeySet(Int2LongAVLTreeMap int2LongAVLTreeMap, 1 var2_2) {
            this(int2LongAVLTreeMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2LongAVLTreeMap int2LongAVLTreeMap) {
            this.this$0 = int2LongAVLTreeMap;
            super(int2LongAVLTreeMap);
        }

        public KeyIterator(Int2LongAVLTreeMap int2LongAVLTreeMap, int n) {
            this.this$0 = int2LongAVLTreeMap;
            super(int2LongAVLTreeMap, n);
        }
    ...
    implements ObjectListIterator<Int2LongMap.Entry> {
        ...
        EntryIterator(Int2LongAVLTreeMap int2LongAVLTreeMap) {
            this.this$0 = int2LongAVLTreeMap;
            super(int2LongAVLTreeMap);
        }

        EntryIterator(Int2LongAVLTreeMap int2LongAVLTreeMap, int n) {
            this.this$0 = int2LongAVLTreeMap;
            super(int2LongAVLTreeMap, n);
        }
        ...
        public void add(Object object) {
            this.add((Int2LongMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Int2LongMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Int2LongAVLTreeMap int2LongAVLTreeMap) {
            this.this$0 = int2LongAVLTreeMap;
            this.index = 0;
            this.next = int2LongAVLTreeMap.firstEntry;
        }

        TreeIterator(Int2LongAVLTreeMap int2LongAVLTreeMap, int n) {
            this.this$0 = int2LongAVLTreeMap;
            this.index = 0;
            this.next = int2LongAVLTreeMap.locateKey(n);
            if (this.next != null) {
                if (int2LongAVLTreeMap.compare(this.next.key, n) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
