...
Cloneable {
    ...
    public Int2ObjectRBTreeMap(Comparator<? super Integer> comparator) {
        this();
    ...
    public Int2ObjectRBTreeMap(SortedMap<Integer, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Integer, V>)sortedMap);
    }

    public Int2ObjectRBTreeMap(Int2ObjectMap<? extends V> int2ObjectMap) {
        this();
        this.putAll(int2ObjectMap);
    }

    public Int2ObjectRBTreeMap(Int2ObjectSortedMap<V> int2ObjectSortedMap) {
        this(int2ObjectSortedMap.comparator());
        this.putAll(int2ObjectSortedMap);
    }

    public Int2ObjectRBTreeMap(int[] nArray, V[] VArray, Comparator<? super Integer> comparator) {
        this(comparator);
    ...
    public Int2ObjectRBTreeMap(int[] nArray, V[] VArray) {
    ...
    public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ObjectMap.Entry<V>>(this){
                ...
                final Int2ObjectRBTreeMap this$0;
                {
                    this.this$0 = int2ObjectRBTreeMap;
    ...
    public Int2ObjectRBTreeMap<V> clone() {
        ...
        try {
            int2ObjectRBTreeMap = (Int2ObjectRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2ObjectRBTreeMap.keys = null;
        int2ObjectRBTreeMap.values = null;
        int2ObjectRBTreeMap.entries = null;
        int2ObjectRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            int2ObjectRBTreeMap.tree = entry2.left;
                            int2ObjectRBTreeMap.firstEntry = int2ObjectRBTreeMap.tree;
                            while (int2ObjectRBTreeMap.firstEntry.left != null) {
                                int2ObjectRBTreeMap.firstEntry = int2ObjectRBTreeMap.firstEntry.left;
                            }
                            int2ObjectRBTreeMap.lastEntry = int2ObjectRBTreeMap.tree;
                            while (int2ObjectRBTreeMap.lastEntry.right != null) {
                                int2ObjectRBTreeMap.lastEntry = int2ObjectRBTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Int2ObjectRBTreeMap int2ObjectRBTreeMap, int n, boolean bl, int n2, boolean bl2) {
            this.this$0 = int2ObjectRBTreeMap;
            if (!bl && !bl2 && int2ObjectRBTreeMap.compare(n, n2) > 0) {
            ...
            this.to = n2;
            this.top = bl2;
            this.defRetValue = int2ObjectRBTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Int2ObjectRBTreeMap int2ObjectRBTreeMap) {
            this.this$0 = int2ObjectRBTreeMap;
            super(int2ObjectRBTreeMap);
        }
        ...
        ValueIterator(Int2ObjectRBTreeMap int2ObjectRBTreeMap, 1 var2_2) {
            this(int2ObjectRBTreeMap);
        }
    }
    ...
    extends AbstractInt2ObjectSortedMap.KeySet {
        ...
        private KeySet(Int2ObjectRBTreeMap int2ObjectRBTreeMap) {
            this.this$0 = int2ObjectRBTreeMap;
            super(int2ObjectRBTreeMap);
        }
        ...
        KeySet(Int2ObjectRBTreeMap int2ObjectRBTreeMap, 1 var2_2) {
            this(int2ObjectRBTreeMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2ObjectRBTreeMap int2ObjectRBTreeMap) {
            this.this$0 = int2ObjectRBTreeMap;
            super(int2ObjectRBTreeMap);
        }

        public KeyIterator(Int2ObjectRBTreeMap int2ObjectRBTreeMap, int n) {
            this.this$0 = int2ObjectRBTreeMap;
            super(int2ObjectRBTreeMap, n);
        }
    ...
    implements ObjectListIterator<Int2ObjectMap.Entry<V>> {
        ...
        EntryIterator(Int2ObjectRBTreeMap int2ObjectRBTreeMap) {
            this.this$0 = int2ObjectRBTreeMap;
            super(int2ObjectRBTreeMap);
        }

        EntryIterator(Int2ObjectRBTreeMap int2ObjectRBTreeMap, int n) {
            this.this$0 = int2ObjectRBTreeMap;
            super(int2ObjectRBTreeMap, n);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Int2ObjectRBTreeMap int2ObjectRBTreeMap) {
            this.this$0 = int2ObjectRBTreeMap;
            this.index = 0;
            this.next = int2ObjectRBTreeMap.firstEntry;
        }

        TreeIterator(Int2ObjectRBTreeMap int2ObjectRBTreeMap, int n) {
            this.this$0 = int2ObjectRBTreeMap;
            this.index = 0;
            this.next = int2ObjectRBTreeMap.locateKey(n);
            if (this.next != null) {
                if (int2ObjectRBTreeMap.compare(this.next.key, n) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
