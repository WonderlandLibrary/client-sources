...
Cloneable {
    ...
    public Int2ByteRBTreeMap(Comparator<? super Integer> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Int2ByteRBTreeMap(Map<? extends Integer, ? extends Byte> map) {
        this();
        this.putAll(map);
    }

    public Int2ByteRBTreeMap(SortedMap<Integer, Byte> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Integer, ? extends Byte>)sortedMap);
    }

    public Int2ByteRBTreeMap(Int2ByteMap int2ByteMap) {
        this();
        this.putAll(int2ByteMap);
    }

    public Int2ByteRBTreeMap(Int2ByteSortedMap int2ByteSortedMap) {
        this(int2ByteSortedMap.comparator());
        this.putAll(int2ByteSortedMap);
    }

    public Int2ByteRBTreeMap(int[] nArray, byte[] byArray, Comparator<? super Integer> comparator) {
        this(comparator);
    ...
    public Int2ByteRBTreeMap(int[] nArray, byte[] byArray) {
    ...
    public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>(this){
                ...
                final Int2ByteRBTreeMap this$0;
                {
                    this.this$0 = int2ByteRBTreeMap;
    ...
    public Int2ByteRBTreeMap clone() {
        Int2ByteRBTreeMap int2ByteRBTreeMap;
        try {
            int2ByteRBTreeMap = (Int2ByteRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2ByteRBTreeMap.keys = null;
        int2ByteRBTreeMap.values = null;
        int2ByteRBTreeMap.entries = null;
        int2ByteRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            int2ByteRBTreeMap.firstEntry = int2ByteRBTreeMap.tree = entry2.left;
                            while (int2ByteRBTreeMap.firstEntry.left != null) {
                                int2ByteRBTreeMap.firstEntry = int2ByteRBTreeMap.firstEntry.left;
                            }
                            int2ByteRBTreeMap.lastEntry = int2ByteRBTreeMap.tree;
                            while (int2ByteRBTreeMap.lastEntry.right != null) {
                                int2ByteRBTreeMap.lastEntry = int2ByteRBTreeMap.lastEntry.right;
                            }
                            return int2ByteRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Int2ByteRBTreeMap int2ByteRBTreeMap, int n, boolean bl, int n2, boolean bl2) {
            this.this$0 = int2ByteRBTreeMap;
            if (!bl && !bl2 && int2ByteRBTreeMap.compare(n, n2) > 0) {
            ...
            this.to = n2;
            this.top = bl2;
            this.defRetValue = int2ByteRBTreeMap.defRetValue;
        }
    ...
    implements ByteListIterator {
        ...
        private ValueIterator(Int2ByteRBTreeMap int2ByteRBTreeMap) {
            this.this$0 = int2ByteRBTreeMap;
            super(int2ByteRBTreeMap);
        }
        ...
        ValueIterator(Int2ByteRBTreeMap int2ByteRBTreeMap, 1 var2_2) {
            this(int2ByteRBTreeMap);
        }
    }
    ...
    extends AbstractInt2ByteSortedMap.KeySet {
        ...
        private KeySet(Int2ByteRBTreeMap int2ByteRBTreeMap) {
            this.this$0 = int2ByteRBTreeMap;
            super(int2ByteRBTreeMap);
        }
        ...
        KeySet(Int2ByteRBTreeMap int2ByteRBTreeMap, 1 var2_2) {
            this(int2ByteRBTreeMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2ByteRBTreeMap int2ByteRBTreeMap) {
            this.this$0 = int2ByteRBTreeMap;
            super(int2ByteRBTreeMap);
        }

        public KeyIterator(Int2ByteRBTreeMap int2ByteRBTreeMap, int n) {
            this.this$0 = int2ByteRBTreeMap;
            super(int2ByteRBTreeMap, n);
        }
    ...
    implements ObjectListIterator<Int2ByteMap.Entry> {
        ...
        EntryIterator(Int2ByteRBTreeMap int2ByteRBTreeMap) {
            this.this$0 = int2ByteRBTreeMap;
            super(int2ByteRBTreeMap);
        }

        EntryIterator(Int2ByteRBTreeMap int2ByteRBTreeMap, int n) {
            this.this$0 = int2ByteRBTreeMap;
            super(int2ByteRBTreeMap, n);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Int2ByteRBTreeMap int2ByteRBTreeMap) {
            this.this$0 = int2ByteRBTreeMap;
            this.index = 0;
            this.next = int2ByteRBTreeMap.firstEntry;
        }

        TreeIterator(Int2ByteRBTreeMap int2ByteRBTreeMap, int n) {
            this.this$0 = int2ByteRBTreeMap;
            this.index = 0;
            this.next = int2ByteRBTreeMap.locateKey(n);
            if (this.next != null) {
                if (int2ByteRBTreeMap.compare(this.next.key, n) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
