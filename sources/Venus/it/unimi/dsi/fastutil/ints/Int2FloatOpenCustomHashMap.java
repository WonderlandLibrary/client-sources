...
Hash {
    ...
    public Int2FloatOpenCustomHashMap(int n, float f, IntHash.Strategy strategy) {
    ...
    public Int2FloatOpenCustomHashMap(int n, IntHash.Strategy strategy) {
    ...
    public Int2FloatOpenCustomHashMap(Map<? extends Integer, ? extends Float> map, float f, IntHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Int2FloatOpenCustomHashMap(Map<? extends Integer, ? extends Float> map, IntHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Int2FloatOpenCustomHashMap(Int2FloatMap int2FloatMap, float f, IntHash.Strategy strategy) {
        this(int2FloatMap.size(), f, strategy);
        this.putAll(int2FloatMap);
    }

    public Int2FloatOpenCustomHashMap(Int2FloatMap int2FloatMap, IntHash.Strategy strategy) {
        this(int2FloatMap, 0.75f, strategy);
    }

    public Int2FloatOpenCustomHashMap(int[] nArray, float[] fArray, float f, IntHash.Strategy strategy) {
    ...
    public Int2FloatOpenCustomHashMap(int[] nArray, float[] fArray, IntHash.Strategy strategy) {
        this(nArray, fArray, 0.75f, strategy);
    }
    ...
    public boolean remove(int n, float f) {
        ...
        if (this.strategy.equals(n, n3) && Float.floatToIntBits(f) == Float.floatToIntBits(this.value[n2])) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if ((n3 = nArray[n2 = n2 + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(n, n3) || Float.floatToIntBits(f) != Float.floatToIntBits(this.value[n2]));
        this.removeEntry(n2);
        return false;
    }
    ...
    public FloatCollection values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection(this){
                final Int2FloatOpenCustomHashMap this$0;
                {
                    this.this$0 = int2FloatOpenCustomHashMap;
                }
    ...
    public Int2FloatOpenCustomHashMap clone() {
        Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap;
        try {
            int2FloatOpenCustomHashMap = (Int2FloatOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2FloatOpenCustomHashMap.keys = null;
        int2FloatOpenCustomHashMap.values = null;
        int2FloatOpenCustomHashMap.entries = null;
        int2FloatOpenCustomHashMap.containsNullKey = this.containsNullKey;
        int2FloatOpenCustomHashMap.key = (int[])this.key.clone();
        int2FloatOpenCustomHashMap.value = (float[])this.value.clone();
        int2FloatOpenCustomHashMap.strategy = this.strategy;
        return int2FloatOpenCustomHashMap;
    }
    ...
    static float access$300(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap) {
        return int2FloatOpenCustomHashMap.removeNullEntry();
    }

    static float access$400(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap, int n) {
        return int2FloatOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements FloatIterator {
        ...
        public ValueIterator(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap) {
            this.this$0 = int2FloatOpenCustomHashMap;
            super(int2FloatOpenCustomHashMap, null);
        }
    ...
    extends AbstractIntSet {
        ...
        private KeySet(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap) {
            this.this$0 = int2FloatOpenCustomHashMap;
        }
        ...
        KeySet(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap, 1 var2_2) {
            this(int2FloatOpenCustomHashMap);
        }
    }
    ...
    implements IntIterator {
        ...
        public KeyIterator(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap) {
            this.this$0 = int2FloatOpenCustomHashMap;
            super(int2FloatOpenCustomHashMap, null);
        }
    ...
    implements Int2FloatMap.FastEntrySet {
        ...
        private MapEntrySet(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap) {
            this.this$0 = int2FloatOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(n, 0)) {
                if (this.this$0.containsNullKey && Float.floatToIntBits(this.this$0.value[this.this$0.n]) == Float.floatToIntBits(f)) {
                    Int2FloatOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(n3, n)) {
                if (Float.floatToIntBits(this.this$0.value[n2]) == Float.floatToIntBits(f)) {
                    Int2FloatOpenCustomHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((n3 = nArray[n2 = n2 + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(n3, n) || Float.floatToIntBits(this.this$0.value[n2]) != Float.floatToIntBits(f));
            Int2FloatOpenCustomHashMap.access$400(this.this$0, n2);
            return false;
        }
        ...
        public void forEach(Consumer<? super Int2FloatMap.Entry> consumer) {
            if (this.this$0.containsNullKey) {
                consumer.accept(new AbstractInt2FloatMap.BasicEntry(this.this$0.key[this.this$0.n], this.this$0.value[this.this$0.n]));
            }
            int n = this.this$0.n;
            while (n-- != 0) {
                if (this.this$0.key[n] == 0) continue;
                consumer.accept(new AbstractInt2FloatMap.BasicEntry(this.this$0.key[n], this.this$0.value[n]));
            }
        }
        ...
        MapEntrySet(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap, 1 var2_2) {
            this(int2FloatOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2FloatMap.Entry> {
        ...
        private FastEntryIterator(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap) {
            this.this$0 = int2FloatOpenCustomHashMap;
            super(int2FloatOpenCustomHashMap, null);
        ...
        FastEntryIterator(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap, 1 var2_2) {
            this(int2FloatOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2FloatMap.Entry> {
        ...
        private EntryIterator(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap) {
            this.this$0 = int2FloatOpenCustomHashMap;
            super(int2FloatOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap, 1 var2_2) {
            this(int2FloatOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap) {
            this.this$0 = int2FloatOpenCustomHashMap;
        ...
        MapIterator(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap, 1 var2_2) {
            this(int2FloatOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Integer, Float> {
        ...
        MapEntry(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap, int n) {
            this.this$0 = int2FloatOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Int2FloatOpenCustomHashMap int2FloatOpenCustomHashMap) {
            this.this$0 = int2FloatOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Integer)entry.getKey()) && Float.floatToIntBits(this.this$0.value[this.index]) == Float.floatToIntBits(((Float)entry.getValue()).floatValue());
        }
