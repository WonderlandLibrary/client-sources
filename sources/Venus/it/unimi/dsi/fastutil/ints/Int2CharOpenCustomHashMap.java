...
Hash {
    ...
    public Int2CharOpenCustomHashMap(int n, float f, IntHash.Strategy strategy) {
    ...
    public Int2CharOpenCustomHashMap(int n, IntHash.Strategy strategy) {
    ...
    public Int2CharOpenCustomHashMap(Map<? extends Integer, ? extends Character> map, float f, IntHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Int2CharOpenCustomHashMap(Map<? extends Integer, ? extends Character> map, IntHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Int2CharOpenCustomHashMap(Int2CharMap int2CharMap, float f, IntHash.Strategy strategy) {
        this(int2CharMap.size(), f, strategy);
        this.putAll(int2CharMap);
    }

    public Int2CharOpenCustomHashMap(Int2CharMap int2CharMap, IntHash.Strategy strategy) {
        this(int2CharMap, 0.75f, strategy);
    }

    public Int2CharOpenCustomHashMap(int[] nArray, char[] cArray, float f, IntHash.Strategy strategy) {
    ...
    public Int2CharOpenCustomHashMap(int[] nArray, char[] cArray, IntHash.Strategy strategy) {
        this(nArray, cArray, 0.75f, strategy);
    }
    ...
    public boolean remove(int n, char c) {
        ...
        if (this.strategy.equals(n, n3) && c == this.value[n2]) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if ((n3 = nArray[n2 = n2 + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(n, n3) || c != this.value[n2]);
        this.removeEntry(n2);
        return false;
    }
    ...
    public CharCollection values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection(this){
                final Int2CharOpenCustomHashMap this$0;
                {
                    this.this$0 = int2CharOpenCustomHashMap;
                }
    ...
    public Int2CharOpenCustomHashMap clone() {
        Int2CharOpenCustomHashMap int2CharOpenCustomHashMap;
        try {
            int2CharOpenCustomHashMap = (Int2CharOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2CharOpenCustomHashMap.keys = null;
        int2CharOpenCustomHashMap.values = null;
        int2CharOpenCustomHashMap.entries = null;
        int2CharOpenCustomHashMap.containsNullKey = this.containsNullKey;
        int2CharOpenCustomHashMap.key = (int[])this.key.clone();
        int2CharOpenCustomHashMap.value = (char[])this.value.clone();
        int2CharOpenCustomHashMap.strategy = this.strategy;
        return int2CharOpenCustomHashMap;
    }
    ...
    static char access$300(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap) {
        return int2CharOpenCustomHashMap.removeNullEntry();
    }

    static char access$400(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap, int n) {
        return int2CharOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements CharIterator {
        ...
        public ValueIterator(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap) {
            this.this$0 = int2CharOpenCustomHashMap;
            super(int2CharOpenCustomHashMap, null);
        }
    ...
    extends AbstractIntSet {
        ...
        private KeySet(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap) {
            this.this$0 = int2CharOpenCustomHashMap;
        }
        ...
        KeySet(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap, 1 var2_2) {
            this(int2CharOpenCustomHashMap);
        }
    }
    ...
    implements IntIterator {
        ...
        public KeyIterator(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap) {
            this.this$0 = int2CharOpenCustomHashMap;
            super(int2CharOpenCustomHashMap, null);
        }
    ...
    implements Int2CharMap.FastEntrySet {
        ...
        private MapEntrySet(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap) {
            this.this$0 = int2CharOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(n, 0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == c) {
                    Int2CharOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(n3, n)) {
                if (this.this$0.value[n2] == c) {
                    Int2CharOpenCustomHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((n3 = nArray[n2 = n2 + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(n3, n) || this.this$0.value[n2] != c);
            Int2CharOpenCustomHashMap.access$400(this.this$0, n2);
            return false;
        }
        ...
        MapEntrySet(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap, 1 var2_2) {
            this(int2CharOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2CharMap.Entry> {
        ...
        private FastEntryIterator(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap) {
            this.this$0 = int2CharOpenCustomHashMap;
            super(int2CharOpenCustomHashMap, null);
        ...
        FastEntryIterator(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap, 1 var2_2) {
            this(int2CharOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2CharMap.Entry> {
        ...
        private EntryIterator(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap) {
            this.this$0 = int2CharOpenCustomHashMap;
            super(int2CharOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap, 1 var2_2) {
            this(int2CharOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap) {
            this.this$0 = int2CharOpenCustomHashMap;
        ...
        MapIterator(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap, 1 var2_2) {
            this(int2CharOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Integer, Character> {
        ...
        MapEntry(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap, int n) {
            this.this$0 = int2CharOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Int2CharOpenCustomHashMap int2CharOpenCustomHashMap) {
            this.this$0 = int2CharOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Integer)entry.getKey()) && this.this$0.value[this.index] == ((Character)entry.getValue()).charValue();
        }
