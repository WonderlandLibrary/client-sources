...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Int2FloatAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Int2FloatAVLTreeMap(Comparator<? super Integer> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Int2FloatAVLTreeMap(Map<? extends Integer, ? extends Float> map) {
        this();
        this.putAll(map);
    }

    public Int2FloatAVLTreeMap(SortedMap<Integer, Float> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Integer, ? extends Float>)sortedMap);
    }

    public Int2FloatAVLTreeMap(Int2FloatMap int2FloatMap) {
        this();
        this.putAll(int2FloatMap);
    }

    public Int2FloatAVLTreeMap(Int2FloatSortedMap int2FloatSortedMap) {
        this(int2FloatSortedMap.comparator());
        this.putAll(int2FloatSortedMap);
    }

    public Int2FloatAVLTreeMap(int[] nArray, float[] fArray, Comparator<? super Integer> comparator) {
        this(comparator);
    ...
    public Int2FloatAVLTreeMap(int[] nArray, float[] fArray) {
    ...
    public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>(this){
                ...
                final Int2FloatAVLTreeMap this$0;
                {
                    this.this$0 = int2FloatAVLTreeMap;
    ...
    public Int2FloatAVLTreeMap clone() {
        Int2FloatAVLTreeMap int2FloatAVLTreeMap;
        try {
            int2FloatAVLTreeMap = (Int2FloatAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2FloatAVLTreeMap.keys = null;
        int2FloatAVLTreeMap.values = null;
        int2FloatAVLTreeMap.entries = null;
        int2FloatAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            int2FloatAVLTreeMap.firstEntry = int2FloatAVLTreeMap.tree = entry2.left;
                            while (int2FloatAVLTreeMap.firstEntry.left != null) {
                                int2FloatAVLTreeMap.firstEntry = int2FloatAVLTreeMap.firstEntry.left;
                            }
                            int2FloatAVLTreeMap.lastEntry = int2FloatAVLTreeMap.tree;
                            while (int2FloatAVLTreeMap.lastEntry.right != null) {
                                int2FloatAVLTreeMap.lastEntry = int2FloatAVLTreeMap.lastEntry.right;
                            }
                            return int2FloatAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Int2FloatAVLTreeMap int2FloatAVLTreeMap, int n, boolean bl, int n2, boolean bl2) {
            this.this$0 = int2FloatAVLTreeMap;
            if (!bl && !bl2 && int2FloatAVLTreeMap.compare(n, n2) > 0) {
            ...
            this.to = n2;
            this.top = bl2;
            this.defRetValue = int2FloatAVLTreeMap.defRetValue;
        }
    ...
    implements FloatListIterator {
        ...
        private ValueIterator(Int2FloatAVLTreeMap int2FloatAVLTreeMap) {
            this.this$0 = int2FloatAVLTreeMap;
            super(int2FloatAVLTreeMap);
        }
        ...
        ValueIterator(Int2FloatAVLTreeMap int2FloatAVLTreeMap, 1 var2_2) {
            this(int2FloatAVLTreeMap);
        }
    }
    ...
    extends AbstractInt2FloatSortedMap.KeySet {
        ...
        private KeySet(Int2FloatAVLTreeMap int2FloatAVLTreeMap) {
            this.this$0 = int2FloatAVLTreeMap;
            super(int2FloatAVLTreeMap);
        }
        ...
        KeySet(Int2FloatAVLTreeMap int2FloatAVLTreeMap, 1 var2_2) {
            this(int2FloatAVLTreeMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2FloatAVLTreeMap int2FloatAVLTreeMap) {
            this.this$0 = int2FloatAVLTreeMap;
            super(int2FloatAVLTreeMap);
        }

        public KeyIterator(Int2FloatAVLTreeMap int2FloatAVLTreeMap, int n) {
            this.this$0 = int2FloatAVLTreeMap;
            super(int2FloatAVLTreeMap, n);
        }
    ...
    implements ObjectListIterator<Int2FloatMap.Entry> {
        ...
        EntryIterator(Int2FloatAVLTreeMap int2FloatAVLTreeMap) {
            this.this$0 = int2FloatAVLTreeMap;
            super(int2FloatAVLTreeMap);
        }

        EntryIterator(Int2FloatAVLTreeMap int2FloatAVLTreeMap, int n) {
            this.this$0 = int2FloatAVLTreeMap;
            super(int2FloatAVLTreeMap, n);
        }
        ...
        public void add(Object object) {
            this.add((Int2FloatMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Int2FloatMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Int2FloatAVLTreeMap int2FloatAVLTreeMap) {
            this.this$0 = int2FloatAVLTreeMap;
            this.index = 0;
            this.next = int2FloatAVLTreeMap.firstEntry;
        }

        TreeIterator(Int2FloatAVLTreeMap int2FloatAVLTreeMap, int n) {
            this.this$0 = int2FloatAVLTreeMap;
            this.index = 0;
            this.next = int2FloatAVLTreeMap.locateKey(n);
            if (this.next != null) {
                if (int2FloatAVLTreeMap.compare(this.next.key, n) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
