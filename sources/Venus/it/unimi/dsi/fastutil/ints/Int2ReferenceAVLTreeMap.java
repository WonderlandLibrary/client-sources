...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Int2ReferenceAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Int2ReferenceAVLTreeMap(Comparator<? super Integer> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Int2ReferenceAVLTreeMap(Map<? extends Integer, ? extends V> map) {
        this();
        this.putAll((Map<Integer, ? extends V>)map);
    }

    public Int2ReferenceAVLTreeMap(SortedMap<Integer, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Integer, V>)sortedMap);
    }

    public Int2ReferenceAVLTreeMap(Int2ReferenceMap<? extends V> int2ReferenceMap) {
        this();
        this.putAll(int2ReferenceMap);
    }

    public Int2ReferenceAVLTreeMap(Int2ReferenceSortedMap<V> int2ReferenceSortedMap) {
        this(int2ReferenceSortedMap.comparator());
        this.putAll(int2ReferenceSortedMap);
    }

    public Int2ReferenceAVLTreeMap(int[] nArray, V[] VArray, Comparator<? super Integer> comparator) {
        this(comparator);
    ...
    public Int2ReferenceAVLTreeMap(int[] nArray, V[] VArray) {
    ...
    public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>(this){
                ...
                final Int2ReferenceAVLTreeMap this$0;
                {
                    this.this$0 = int2ReferenceAVLTreeMap;
    ...
    public Int2ReferenceAVLTreeMap<V> clone() {
        Int2ReferenceAVLTreeMap int2ReferenceAVLTreeMap;
        try {
            int2ReferenceAVLTreeMap = (Int2ReferenceAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2ReferenceAVLTreeMap.keys = null;
        int2ReferenceAVLTreeMap.values = null;
        int2ReferenceAVLTreeMap.entries = null;
        int2ReferenceAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            int2ReferenceAVLTreeMap.tree = entry2.left;
                            int2ReferenceAVLTreeMap.firstEntry = int2ReferenceAVLTreeMap.tree;
                            while (int2ReferenceAVLTreeMap.firstEntry.left != null) {
                                int2ReferenceAVLTreeMap.firstEntry = int2ReferenceAVLTreeMap.firstEntry.left;
                            }
                            int2ReferenceAVLTreeMap.lastEntry = int2ReferenceAVLTreeMap.tree;
                            while (int2ReferenceAVLTreeMap.lastEntry.right != null) {
                                int2ReferenceAVLTreeMap.lastEntry = int2ReferenceAVLTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Int2ReferenceAVLTreeMap int2ReferenceAVLTreeMap, int n, boolean bl, int n2, boolean bl2) {
            this.this$0 = int2ReferenceAVLTreeMap;
            if (!bl && !bl2 && int2ReferenceAVLTreeMap.compare(n, n2) > 0) {
            ...
            this.to = n2;
            this.top = bl2;
            this.defRetValue = int2ReferenceAVLTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Int2ReferenceAVLTreeMap int2ReferenceAVLTreeMap) {
            this.this$0 = int2ReferenceAVLTreeMap;
            super(int2ReferenceAVLTreeMap);
        }
        ...
        ValueIterator(Int2ReferenceAVLTreeMap int2ReferenceAVLTreeMap, 1 var2_2) {
            this(int2ReferenceAVLTreeMap);
        }
    }
    ...
    extends AbstractInt2ReferenceSortedMap.KeySet {
        ...
        private KeySet(Int2ReferenceAVLTreeMap int2ReferenceAVLTreeMap) {
            this.this$0 = int2ReferenceAVLTreeMap;
            super(int2ReferenceAVLTreeMap);
        }
        ...
        KeySet(Int2ReferenceAVLTreeMap int2ReferenceAVLTreeMap, 1 var2_2) {
            this(int2ReferenceAVLTreeMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2ReferenceAVLTreeMap int2ReferenceAVLTreeMap) {
            this.this$0 = int2ReferenceAVLTreeMap;
            super(int2ReferenceAVLTreeMap);
        }

        public KeyIterator(Int2ReferenceAVLTreeMap int2ReferenceAVLTreeMap, int n) {
            this.this$0 = int2ReferenceAVLTreeMap;
            super(int2ReferenceAVLTreeMap, n);
        }
    ...
    implements ObjectListIterator<Int2ReferenceMap.Entry<V>> {
        ...
        EntryIterator(Int2ReferenceAVLTreeMap int2ReferenceAVLTreeMap) {
            this.this$0 = int2ReferenceAVLTreeMap;
            super(int2ReferenceAVLTreeMap);
        }

        EntryIterator(Int2ReferenceAVLTreeMap int2ReferenceAVLTreeMap, int n) {
            this.this$0 = int2ReferenceAVLTreeMap;
            super(int2ReferenceAVLTreeMap, n);
        }
        ...
        public void add(Object object) {
            this.add((Int2ReferenceMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Int2ReferenceMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Int2ReferenceAVLTreeMap int2ReferenceAVLTreeMap) {
            this.this$0 = int2ReferenceAVLTreeMap;
            this.index = 0;
            this.next = int2ReferenceAVLTreeMap.firstEntry;
        }

        TreeIterator(Int2ReferenceAVLTreeMap int2ReferenceAVLTreeMap, int n) {
            this.this$0 = int2ReferenceAVLTreeMap;
            this.index = 0;
            this.next = int2ReferenceAVLTreeMap.locateKey(n);
            if (this.next != null) {
                if (int2ReferenceAVLTreeMap.compare(this.next.key, n) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
