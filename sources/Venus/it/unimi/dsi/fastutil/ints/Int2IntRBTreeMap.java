...
Cloneable {
    ...
    public Int2IntRBTreeMap(Comparator<? super Integer> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Int2IntRBTreeMap(Map<? extends Integer, ? extends Integer> map) {
        this();
        this.putAll(map);
    }

    public Int2IntRBTreeMap(SortedMap<Integer, Integer> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Integer, ? extends Integer>)sortedMap);
    }

    public Int2IntRBTreeMap(Int2IntMap int2IntMap) {
        this();
        this.putAll(int2IntMap);
    }

    public Int2IntRBTreeMap(Int2IntSortedMap int2IntSortedMap) {
        this(int2IntSortedMap.comparator());
        this.putAll(int2IntSortedMap);
    }

    public Int2IntRBTreeMap(int[] nArray, int[] nArray2, Comparator<? super Integer> comparator) {
        this(comparator);
    ...
    public Int2IntRBTreeMap(int[] nArray, int[] nArray2) {
    ...
    public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>(this){
                ...
                final Int2IntRBTreeMap this$0;
                {
                    this.this$0 = int2IntRBTreeMap;
    ...
    public Int2IntRBTreeMap clone() {
        Int2IntRBTreeMap int2IntRBTreeMap;
        try {
            int2IntRBTreeMap = (Int2IntRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2IntRBTreeMap.keys = null;
        int2IntRBTreeMap.values = null;
        int2IntRBTreeMap.entries = null;
        int2IntRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            int2IntRBTreeMap.firstEntry = int2IntRBTreeMap.tree = entry2.left;
                            while (int2IntRBTreeMap.firstEntry.left != null) {
                                int2IntRBTreeMap.firstEntry = int2IntRBTreeMap.firstEntry.left;
                            }
                            int2IntRBTreeMap.lastEntry = int2IntRBTreeMap.tree;
                            while (int2IntRBTreeMap.lastEntry.right != null) {
                                int2IntRBTreeMap.lastEntry = int2IntRBTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Int2IntRBTreeMap int2IntRBTreeMap, int n, boolean bl, int n2, boolean bl2) {
            this.this$0 = int2IntRBTreeMap;
            if (!bl && !bl2 && int2IntRBTreeMap.compare(n, n2) > 0) {
            ...
            this.to = n2;
            this.top = bl2;
            this.defRetValue = int2IntRBTreeMap.defRetValue;
        }
    ...
    implements IntListIterator {
        ...
        private ValueIterator(Int2IntRBTreeMap int2IntRBTreeMap) {
            this.this$0 = int2IntRBTreeMap;
            super(int2IntRBTreeMap);
        }
        ...
        ValueIterator(Int2IntRBTreeMap int2IntRBTreeMap, 1 var2_2) {
            this(int2IntRBTreeMap);
        }
    }
    ...
    extends AbstractInt2IntSortedMap.KeySet {
        ...
        private KeySet(Int2IntRBTreeMap int2IntRBTreeMap) {
            this.this$0 = int2IntRBTreeMap;
            super(int2IntRBTreeMap);
        }
        ...
        KeySet(Int2IntRBTreeMap int2IntRBTreeMap, 1 var2_2) {
            this(int2IntRBTreeMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2IntRBTreeMap int2IntRBTreeMap) {
            this.this$0 = int2IntRBTreeMap;
            super(int2IntRBTreeMap);
        }

        public KeyIterator(Int2IntRBTreeMap int2IntRBTreeMap, int n) {
            this.this$0 = int2IntRBTreeMap;
            super(int2IntRBTreeMap, n);
        }
    ...
    implements ObjectListIterator<Int2IntMap.Entry> {
        ...
        EntryIterator(Int2IntRBTreeMap int2IntRBTreeMap) {
            this.this$0 = int2IntRBTreeMap;
            super(int2IntRBTreeMap);
        }

        EntryIterator(Int2IntRBTreeMap int2IntRBTreeMap, int n) {
            this.this$0 = int2IntRBTreeMap;
            super(int2IntRBTreeMap, n);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Int2IntRBTreeMap int2IntRBTreeMap) {
            this.this$0 = int2IntRBTreeMap;
            this.index = 0;
            this.next = int2IntRBTreeMap.firstEntry;
        }

        TreeIterator(Int2IntRBTreeMap int2IntRBTreeMap, int n) {
            this.this$0 = int2IntRBTreeMap;
            this.index = 0;
            this.next = int2IntRBTreeMap.locateKey(n);
            if (this.next != null) {
                if (int2IntRBTreeMap.compare(this.next.key, n) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
