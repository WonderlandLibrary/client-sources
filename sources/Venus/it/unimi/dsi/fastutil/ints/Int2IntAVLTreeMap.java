...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Int2IntAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Int2IntAVLTreeMap(Comparator<? super Integer> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Int2IntAVLTreeMap(Map<? extends Integer, ? extends Integer> map) {
        this();
        this.putAll(map);
    }

    public Int2IntAVLTreeMap(SortedMap<Integer, Integer> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Integer, ? extends Integer>)sortedMap);
    }

    public Int2IntAVLTreeMap(Int2IntMap int2IntMap) {
        this();
        this.putAll(int2IntMap);
    }

    public Int2IntAVLTreeMap(Int2IntSortedMap int2IntSortedMap) {
        this(int2IntSortedMap.comparator());
        this.putAll(int2IntSortedMap);
    }

    public Int2IntAVLTreeMap(int[] nArray, int[] nArray2, Comparator<? super Integer> comparator) {
        this(comparator);
    ...
    public Int2IntAVLTreeMap(int[] nArray, int[] nArray2) {
    ...
    public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>(this){
                final Comparator<? super Int2IntMap.Entry> comparator;
                final Int2IntAVLTreeMap this$0;
                {
                    this.this$0 = int2IntAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator(Int2IntMap.Entry entry) {
                ...
                public ObjectSortedSet<Int2IntMap.Entry> subSet(Int2IntMap.Entry entry, Int2IntMap.Entry entry2) {
                    return this.this$0.subMap(entry.getIntKey(), entry2.getIntKey()).int2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Int2IntMap.Entry> headSet(Int2IntMap.Entry entry) {
                    return this.this$0.headMap(entry.getIntKey()).int2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Int2IntMap.Entry> tailSet(Int2IntMap.Entry entry) {
                    return this.this$0.tailMap(entry.getIntKey()).int2IntEntrySet();
                }
                ...
                private int lambda$$0(Int2IntMap.Entry entry, Int2IntMap.Entry entry2) {
    ...
    public Int2IntAVLTreeMap clone() {
        Int2IntAVLTreeMap int2IntAVLTreeMap;
        try {
            int2IntAVLTreeMap = (Int2IntAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2IntAVLTreeMap.keys = null;
        int2IntAVLTreeMap.values = null;
        int2IntAVLTreeMap.entries = null;
        int2IntAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            int2IntAVLTreeMap.firstEntry = int2IntAVLTreeMap.tree = entry2.left;
                            while (int2IntAVLTreeMap.firstEntry.left != null) {
                                int2IntAVLTreeMap.firstEntry = int2IntAVLTreeMap.firstEntry.left;
                            }
                            int2IntAVLTreeMap.lastEntry = int2IntAVLTreeMap.tree;
                            while (int2IntAVLTreeMap.lastEntry.right != null) {
                                int2IntAVLTreeMap.lastEntry = int2IntAVLTreeMap.lastEntry.right;
                            }
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        ...
        if (n == 2) {
            ...
            entry4.right(new Entry(objectInputStream.readInt(), objectInputStream.readInt()));
    ...
    implements Serializable {
        ...
        public Submap(Int2IntAVLTreeMap int2IntAVLTreeMap, int n, boolean bl, int n2, boolean bl2) {
            this.this$0 = int2IntAVLTreeMap;
            if (!bl && !bl2 && int2IntAVLTreeMap.compare(n, n2) > 0) {
            ...
            this.to = n2;
            this.top = bl2;
            this.defRetValue = int2IntAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Int2IntMap.Entry> comparator() {
                        return this.this$1.this$0.int2IntEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Int2IntMap.Entry> subSet(Int2IntMap.Entry entry, Int2IntMap.Entry entry2) {
                        return this.this$1.subMap(entry.getIntKey(), entry2.getIntKey()).int2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Int2IntMap.Entry> headSet(Int2IntMap.Entry entry) {
                        return this.this$1.headMap(entry.getIntKey()).int2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Int2IntMap.Entry> tailSet(Int2IntMap.Entry entry) {
                        return this.this$1.tailMap(entry.getIntKey()).int2IntEntrySet();
                    }
        ...
        public int put(int n, int n2) {
            ...
            int n3 = this.this$0.put(n, n2);
            return this.this$0.modified ? this.defRetValue : n3;
        }
        ...
        public int remove(int n) {
            ...
            int n2 = this.this$0.remove(n);
            return this.this$0.modified ? n2 : this.defRetValue;
        }
    ...
    implements IntListIterator {
        ...
        private ValueIterator(Int2IntAVLTreeMap int2IntAVLTreeMap) {
            this.this$0 = int2IntAVLTreeMap;
            super(int2IntAVLTreeMap);
        }
        ...
        ValueIterator(Int2IntAVLTreeMap int2IntAVLTreeMap, 1 var2_2) {
            this(int2IntAVLTreeMap);
        }
    }
    ...
    extends AbstractInt2IntSortedMap.KeySet {
        ...
        private KeySet(Int2IntAVLTreeMap int2IntAVLTreeMap) {
            this.this$0 = int2IntAVLTreeMap;
            super(int2IntAVLTreeMap);
        }
        ...
        KeySet(Int2IntAVLTreeMap int2IntAVLTreeMap, 1 var2_2) {
            this(int2IntAVLTreeMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2IntAVLTreeMap int2IntAVLTreeMap) {
            this.this$0 = int2IntAVLTreeMap;
            super(int2IntAVLTreeMap);
        }

        public KeyIterator(Int2IntAVLTreeMap int2IntAVLTreeMap, int n) {
            this.this$0 = int2IntAVLTreeMap;
            super(int2IntAVLTreeMap, n);
        }
    ...
    implements ObjectListIterator<Int2IntMap.Entry> {
        ...
        EntryIterator(Int2IntAVLTreeMap int2IntAVLTreeMap) {
            this.this$0 = int2IntAVLTreeMap;
            super(int2IntAVLTreeMap);
        }

        EntryIterator(Int2IntAVLTreeMap int2IntAVLTreeMap, int n) {
            this.this$0 = int2IntAVLTreeMap;
            super(int2IntAVLTreeMap, n);
        }
        ...
        public void add(Object object) {
            this.add((Int2IntMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Int2IntMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Int2IntAVLTreeMap int2IntAVLTreeMap) {
            this.this$0 = int2IntAVLTreeMap;
            this.index = 0;
            this.next = int2IntAVLTreeMap.firstEntry;
        }

        TreeIterator(Int2IntAVLTreeMap int2IntAVLTreeMap, int n) {
            this.this$0 = int2IntAVLTreeMap;
            this.index = 0;
            this.next = int2IntAVLTreeMap.locateKey(n);
            if (this.next != null) {
                if (int2IntAVLTreeMap.compare(this.next.key, n) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Integer)entry.getKey() && this.value == (Integer)entry.getValue();
        }
