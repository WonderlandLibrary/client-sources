...
Hash {
    ...
    public Int2ReferenceOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Int2ReferenceOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Int2ReferenceOpenHashMap(Map<? extends Integer, ? extends V> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Int2ReferenceOpenHashMap(Map<? extends Integer, ? extends V> map) {
        this(map, 0.75f);
    }

    public Int2ReferenceOpenHashMap(Int2ReferenceMap<V> int2ReferenceMap, float f) {
        this(int2ReferenceMap.size(), f);
        this.putAll(int2ReferenceMap);
    }

    public Int2ReferenceOpenHashMap(Int2ReferenceMap<V> int2ReferenceMap) {
        this(int2ReferenceMap, 0.75f);
    }

    public Int2ReferenceOpenHashMap(int[] nArray, V[] VArray, float f) {
    ...
    public Int2ReferenceOpenHashMap(int[] nArray, V[] VArray) {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Int2ReferenceOpenHashMap this$0;
                {
                    this.this$0 = int2ReferenceOpenHashMap;
                }
    ...
    public Int2ReferenceOpenHashMap<V> clone() {
        ...
        try {
            int2ReferenceOpenHashMap = (Int2ReferenceOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2ReferenceOpenHashMap.keys = null;
        int2ReferenceOpenHashMap.values = null;
        int2ReferenceOpenHashMap.entries = null;
        int2ReferenceOpenHashMap.containsNullKey = this.containsNullKey;
        int2ReferenceOpenHashMap.key = (int[])this.key.clone();
        int2ReferenceOpenHashMap.value = (Object[])this.value.clone();
    ...
    static Object access$300(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap) {
        return int2ReferenceOpenHashMap.removeNullEntry();
    }

    static Object access$400(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap, int n) {
        return int2ReferenceOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap) {
            this.this$0 = int2ReferenceOpenHashMap;
            super(int2ReferenceOpenHashMap, null);
        }
    ...
    extends AbstractIntSet {
        ...
        private KeySet(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap) {
            this.this$0 = int2ReferenceOpenHashMap;
        }
        ...
        KeySet(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap, 1 var2_2) {
            this(int2ReferenceOpenHashMap);
        }
    }
    ...
    implements IntIterator {
        ...
        public KeyIterator(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap) {
            this.this$0 = int2ReferenceOpenHashMap;
            super(int2ReferenceOpenHashMap, null);
        }
    ...
    implements Int2ReferenceMap.FastEntrySet<V> {
        ...
        private MapEntrySet(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap) {
            this.this$0 = int2ReferenceOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (n == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Int2ReferenceOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (n3 == n) {
                if (this.this$0.value[n2] == v) {
                    Int2ReferenceOpenHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap, 1 var2_2) {
            this(int2ReferenceOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2ReferenceMap.Entry<V>> {
        ...
        private FastEntryIterator(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap) {
            this.this$0 = int2ReferenceOpenHashMap;
            super(int2ReferenceOpenHashMap, null);
        ...
        FastEntryIterator(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap, 1 var2_2) {
            this(int2ReferenceOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2ReferenceMap.Entry<V>> {
        ...
        private EntryIterator(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap) {
            this.this$0 = int2ReferenceOpenHashMap;
            super(int2ReferenceOpenHashMap, null);
        }
        ...
        EntryIterator(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap, 1 var2_2) {
            this(int2ReferenceOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap) {
            this.this$0 = int2ReferenceOpenHashMap;
        ...
        MapIterator(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap, 1 var2_2) {
            this(int2ReferenceOpenHashMap);
        }
    }
    ...
    Map.Entry<Integer, V> {
        ...
        MapEntry(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap, int n) {
            this.this$0 = int2ReferenceOpenHashMap;
            this.index = n;
        }

        MapEntry(Int2ReferenceOpenHashMap int2ReferenceOpenHashMap) {
            this.this$0 = int2ReferenceOpenHashMap;
        }
