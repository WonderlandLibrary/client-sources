...
Hash {
    ...
    public Int2FloatLinkedOpenHashMap(Map<? extends Integer, ? extends Float> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Int2FloatLinkedOpenHashMap(Map<? extends Integer, ? extends Float> map) {
        this(map, 0.75f);
    }

    public Int2FloatLinkedOpenHashMap(Int2FloatMap int2FloatMap, float f) {
        this(int2FloatMap.size(), f);
        this.putAll(int2FloatMap);
    }

    public Int2FloatLinkedOpenHashMap(Int2FloatMap int2FloatMap) {
        this(int2FloatMap, 0.75f);
    }

    public Int2FloatLinkedOpenHashMap(int[] nArray, float[] fArray, float f) {
    ...
    public Int2FloatLinkedOpenHashMap(int[] nArray, float[] fArray) {
        this(nArray, fArray, 0.75f);
    }
    ...
    private void insert(int n, int n2, float f) {
        if (n == this.n) {
    ...
    public float addTo(int n, float f) {
        ...
        this.key[n2] = n;
        this.value[n2] = this.defRetValue + f;
        if (this.size == 0) {
    ...
    public float getAndMoveToFirst(int n) {
        if (n == 0) {
            if (this.containsNullKey) {
    ...
    public float getAndMoveToLast(int n) {
        if (n == 0) {
            if (this.containsNullKey) {
    ...
    public float putAndMoveToFirst(int n, float f) {
        int n2;
        if (n == 0) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public float putAndMoveToLast(int n, float f) {
        int n2;
        if (n == 0) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public boolean containsValue(float f) {
        ...
        int n = this.n;
        while (n-- != 0) {
            if (nArray[n] == 0 || Float.floatToIntBits(fArray[n]) != Float.floatToIntBits(f)) continue;
            return false;
        }
        return true;
    }
    ...
    public boolean remove(int n, float f) {
        ...
        if (n == n3 && Float.floatToIntBits(f) == Float.floatToIntBits(this.value[n2])) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if ((n3 = nArray[n2 = n2 + 1 & this.mask]) != 0) continue;
            return true;
        } while (n != n3 || Float.floatToIntBits(f) != Float.floatToIntBits(this.value[n2]));
        this.removeEntry(n2);
        return false;
    }
    ...
    public boolean replace(int n, float f, float f2) {
        int n2 = this.find(n);
        if (n2 < 0 || Float.floatToIntBits(f) != Float.floatToIntBits(this.value[n2])) {
            return true;
        }
        this.value[n2] = f2;
        return false;
    ...
    public float computeIfAbsent(int n, IntToDoubleFunction intToDoubleFunction) {
        ...
        float f = SafeMath.safeDoubleToFloat(intToDoubleFunction.applyAsDouble(n));
        this.insert(-n2 - 1, n, f);
        return f;
    }
    ...
    public float computeIfAbsentNullable(int n, IntFunction<? extends Float> intFunction) {
        ...
        Float f = intFunction.apply(n);
        if (f == null) {
            return this.defRetValue;
        }
        float f2 = f.floatValue();
        this.insert(-n2 - 1, n, f2);
        return f2;
    }
    ...
    public float computeIfPresent(int n, BiFunction<? super Integer, ? super Float, ? extends Float> biFunction) {
        ...
        Float f = biFunction.apply((Integer)n, Float.valueOf(this.value[n2]));
        if (f == null) {
            if (n == 0) {
                this.removeNullEntry();
            } else {
    ...
    public float compute(int n, BiFunction<? super Integer, ? super Float, ? extends Float> biFunction) {
        Objects.requireNonNull(biFunction);
        int n2 = this.find(n);
        Float f = biFunction.apply((Integer)n, n2 >= 0 ? Float.valueOf(this.value[n2]) : null);
        if (f == null) {
            if (n2 >= 0) {
                if (n == 0) {
                    this.removeNullEntry();
    ...
    public float merge(int n, float f, BiFunction<? super Float, ? super Float, ? extends Float> biFunction) {
        ...
        Float f2 = biFunction.apply(Float.valueOf(this.value[n2]), Float.valueOf(f));
        if (f2 == null) {
            if (n == 0) {
                this.removeNullEntry();
            } else {
    ...
    public FloatCollection values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection(this){
                final Int2FloatLinkedOpenHashMap this$0;
                {
                    this.this$0 = int2FloatLinkedOpenHashMap;
                }
    ...
    public Int2FloatLinkedOpenHashMap clone() {
        Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap;
        try {
            int2FloatLinkedOpenHashMap = (Int2FloatLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2FloatLinkedOpenHashMap.keys = null;
        int2FloatLinkedOpenHashMap.values = null;
        int2FloatLinkedOpenHashMap.entries = null;
        int2FloatLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        int2FloatLinkedOpenHashMap.key = (int[])this.key.clone();
        int2FloatLinkedOpenHashMap.value = (float[])this.value.clone();
        int2FloatLinkedOpenHashMap.link = (long[])this.link.clone();
        return int2FloatLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet int2FloatEntrySet() {
    ...
    static float access$100(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap) {
        return int2FloatLinkedOpenHashMap.removeNullEntry();
    }

    static float access$200(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap, int n) {
        return int2FloatLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements FloatListIterator {
        ...
        public ValueIterator(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap) {
            this.this$0 = int2FloatLinkedOpenHashMap;
            super(int2FloatLinkedOpenHashMap);
        }
    ...
    extends AbstractIntSortedSet {
        ...
        private KeySet(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap) {
            this.this$0 = int2FloatLinkedOpenHashMap;
        }
        ...
        KeySet(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap, 1 var2_2) {
            this(int2FloatLinkedOpenHashMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap, int n) {
            this.this$0 = int2FloatLinkedOpenHashMap;
            super(int2FloatLinkedOpenHashMap, n, null);
        }
        ...
        public KeyIterator(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap) {
            this.this$0 = int2FloatLinkedOpenHashMap;
            super(int2FloatLinkedOpenHashMap);
        }
    ...
    implements Int2FloatSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap) {
            this.this$0 = int2FloatLinkedOpenHashMap;
        }
        ...
        public boolean contains(Object object) {
            ...
            if (n == n3) {
                return Float.floatToIntBits(this.this$0.value[n2]) == Float.floatToIntBits(f);
            }
            do {
        ...
        public boolean remove(Object object) {
            ...
            if (n == 0) {
                if (this.this$0.containsNullKey && Float.floatToIntBits(this.this$0.value[this.this$0.n]) == Float.floatToIntBits(f)) {
                    Int2FloatLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (n3 == n) {
                if (Float.floatToIntBits(this.this$0.value[n2]) == Float.floatToIntBits(f)) {
                    Int2FloatLinkedOpenHashMap.access$200(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((n3 = nArray[n2 = n2 + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (n3 != n || Float.floatToIntBits(this.this$0.value[n2]) != Float.floatToIntBits(f));
            Int2FloatLinkedOpenHashMap.access$200(this.this$0, n2);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Int2FloatMap.Entry> iterator(Int2FloatMap.Entry entry) {
        ...
        public ObjectListIterator<Int2FloatMap.Entry> fastIterator(Int2FloatMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Int2FloatMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractInt2FloatMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }

        @Override
        public void fastForEach(Consumer<? super Int2FloatMap.Entry> consumer) {
            AbstractInt2FloatMap.BasicEntry basicEntry = new AbstractInt2FloatMap.BasicEntry();
            int n = this.this$0.size;
            int n2 = this.this$0.first;
            while (n-- != 0) {
                int n3 = n2;
        ...
        public ObjectBidirectionalIterator fastIterator(Int2FloatMap.Entry entry) {
        ...
        MapEntrySet(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap, 1 var2_2) {
            this(int2FloatLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Int2FloatMap.Entry> {
        ...
        public FastEntryIterator(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap) {
            this.this$0 = int2FloatLinkedOpenHashMap;
            super(int2FloatLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap, int n) {
            this.this$0 = int2FloatLinkedOpenHashMap;
            super(int2FloatLinkedOpenHashMap, n, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Int2FloatMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Int2FloatMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Int2FloatMap.Entry> {
        ...
        public EntryIterator(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap) {
            this.this$0 = int2FloatLinkedOpenHashMap;
            super(int2FloatLinkedOpenHashMap);
        }

        public EntryIterator(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap, int n) {
            this.this$0 = int2FloatLinkedOpenHashMap;
            super(int2FloatLinkedOpenHashMap, n, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap) {
            this.this$0 = int2FloatLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = int2FloatLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap, int n) {
            this.this$0 = int2FloatLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (n == 0) {
                if (int2FloatLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)int2FloatLinkedOpenHashMap.link[int2FloatLinkedOpenHashMap.n];
                    this.prev = int2FloatLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + n + " does not belong to this map.");
            }
            if (int2FloatLinkedOpenHashMap.key[int2FloatLinkedOpenHashMap.last] == n) {
                this.prev = int2FloatLinkedOpenHashMap.last;
                this.index = int2FloatLinkedOpenHashMap.size;
                return;
            }
            int n2 = HashCommon.mix(n) & int2FloatLinkedOpenHashMap.mask;
            while (int2FloatLinkedOpenHashMap.key[n2] != 0) {
                if (int2FloatLinkedOpenHashMap.key[n2] == n) {
                    this.next = (int)int2FloatLinkedOpenHashMap.link[n2];
                    this.prev = n2;
                    return;
                }
                n2 = n2 + 1 & int2FloatLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + n + " does not belong to this map.");
        }
        ...
        public void set(Int2FloatMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Int2FloatMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap, int n, 1 var3_3) {
            this(int2FloatLinkedOpenHashMap, n);
        }
    }
    ...
    Map.Entry<Integer, Float> {
        ...
        MapEntry(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap, int n) {
            this.this$0 = int2FloatLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Int2FloatLinkedOpenHashMap int2FloatLinkedOpenHashMap) {
            this.this$0 = int2FloatLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.key[this.index] == (Integer)entry.getKey() && Float.floatToIntBits(this.this$0.value[this.index]) == Float.floatToIntBits(((Float)entry.getValue()).floatValue());
        }
