...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Int2DoubleAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Int2DoubleAVLTreeMap(Comparator<? super Integer> comparator) {
        this();
    ...
    public Int2DoubleAVLTreeMap(SortedMap<Integer, Double> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Integer, ? extends Double>)sortedMap);
    }

    public Int2DoubleAVLTreeMap(Int2DoubleMap int2DoubleMap) {
        this();
        this.putAll(int2DoubleMap);
    }

    public Int2DoubleAVLTreeMap(Int2DoubleSortedMap int2DoubleSortedMap) {
        this(int2DoubleSortedMap.comparator());
        this.putAll(int2DoubleSortedMap);
    }

    public Int2DoubleAVLTreeMap(int[] nArray, double[] dArray, Comparator<? super Integer> comparator) {
        this(comparator);
    ...
    public Int2DoubleAVLTreeMap(int[] nArray, double[] dArray) {
        this(nArray, dArray, null);
    }
    ...
    public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>(this){
                final Comparator<? super Int2DoubleMap.Entry> comparator;
                final Int2DoubleAVLTreeMap this$0;
                {
                    this.this$0 = int2DoubleAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator(Int2DoubleMap.Entry entry) {
                ...
                public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry entry, Int2DoubleMap.Entry entry2) {
                    return this.this$0.subMap(entry.getIntKey(), entry2.getIntKey()).int2DoubleEntrySet();
                }

                @Override
                public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry entry) {
                    return this.this$0.headMap(entry.getIntKey()).int2DoubleEntrySet();
                }

                @Override
                public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry entry) {
                    return this.this$0.tailMap(entry.getIntKey()).int2DoubleEntrySet();
                }
                ...
                private int lambda$$0(Int2DoubleMap.Entry entry, Int2DoubleMap.Entry entry2) {
    ...
    public Int2DoubleAVLTreeMap clone() {
        Int2DoubleAVLTreeMap int2DoubleAVLTreeMap;
        try {
            int2DoubleAVLTreeMap = (Int2DoubleAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2DoubleAVLTreeMap.keys = null;
        int2DoubleAVLTreeMap.values = null;
        int2DoubleAVLTreeMap.entries = null;
        int2DoubleAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            int2DoubleAVLTreeMap.firstEntry = int2DoubleAVLTreeMap.tree = entry2.left;
                            while (int2DoubleAVLTreeMap.firstEntry.left != null) {
                                int2DoubleAVLTreeMap.firstEntry = int2DoubleAVLTreeMap.firstEntry.left;
                            }
                            int2DoubleAVLTreeMap.lastEntry = int2DoubleAVLTreeMap.tree;
                            while (int2DoubleAVLTreeMap.lastEntry.right != null) {
                                int2DoubleAVLTreeMap.lastEntry = int2DoubleAVLTreeMap.lastEntry.right;
                            }
                            return int2DoubleAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readInt(), objectInputStream.readDouble());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readInt(), objectInputStream.readDouble());
            entry4.right(new Entry(objectInputStream.readInt(), objectInputStream.readDouble()));
    ...
    implements Serializable {
        ...
        public Submap(Int2DoubleAVLTreeMap int2DoubleAVLTreeMap, int n, boolean bl, int n2, boolean bl2) {
            this.this$0 = int2DoubleAVLTreeMap;
            if (!bl && !bl2 && int2DoubleAVLTreeMap.compare(n, n2) > 0) {
            ...
            this.to = n2;
            this.top = bl2;
            this.defRetValue = int2DoubleAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Int2DoubleMap.Entry> comparator() {
                        return this.this$1.this$0.int2DoubleEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry entry, Int2DoubleMap.Entry entry2) {
                        return this.this$1.subMap(entry.getIntKey(), entry2.getIntKey()).int2DoubleEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry entry) {
                        return this.this$1.headMap(entry.getIntKey()).int2DoubleEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry entry) {
                        return this.this$1.tailMap(entry.getIntKey()).int2DoubleEntrySet();
                    }
    ...
    implements DoubleListIterator {
        ...
        private ValueIterator(Int2DoubleAVLTreeMap int2DoubleAVLTreeMap) {
            this.this$0 = int2DoubleAVLTreeMap;
            super(int2DoubleAVLTreeMap);
        }
        ...
        ValueIterator(Int2DoubleAVLTreeMap int2DoubleAVLTreeMap, 1 var2_2) {
            this(int2DoubleAVLTreeMap);
        }
    }
    ...
    extends AbstractInt2DoubleSortedMap.KeySet {
        ...
        private KeySet(Int2DoubleAVLTreeMap int2DoubleAVLTreeMap) {
            this.this$0 = int2DoubleAVLTreeMap;
            super(int2DoubleAVLTreeMap);
        }
        ...
        KeySet(Int2DoubleAVLTreeMap int2DoubleAVLTreeMap, 1 var2_2) {
            this(int2DoubleAVLTreeMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2DoubleAVLTreeMap int2DoubleAVLTreeMap) {
            this.this$0 = int2DoubleAVLTreeMap;
            super(int2DoubleAVLTreeMap);
        }

        public KeyIterator(Int2DoubleAVLTreeMap int2DoubleAVLTreeMap, int n) {
            this.this$0 = int2DoubleAVLTreeMap;
            super(int2DoubleAVLTreeMap, n);
        }
    ...
    implements ObjectListIterator<Int2DoubleMap.Entry> {
        ...
        EntryIterator(Int2DoubleAVLTreeMap int2DoubleAVLTreeMap) {
            this.this$0 = int2DoubleAVLTreeMap;
            super(int2DoubleAVLTreeMap);
        }

        EntryIterator(Int2DoubleAVLTreeMap int2DoubleAVLTreeMap, int n) {
            this.this$0 = int2DoubleAVLTreeMap;
            super(int2DoubleAVLTreeMap, n);
        }
        ...
        public void add(Object object) {
            this.add((Int2DoubleMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Int2DoubleMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Int2DoubleAVLTreeMap int2DoubleAVLTreeMap) {
            this.this$0 = int2DoubleAVLTreeMap;
            this.index = 0;
            this.next = int2DoubleAVLTreeMap.firstEntry;
        }

        TreeIterator(Int2DoubleAVLTreeMap int2DoubleAVLTreeMap, int n) {
            this.this$0 = int2DoubleAVLTreeMap;
            this.index = 0;
            this.next = int2DoubleAVLTreeMap.locateKey(n);
            if (this.next != null) {
                if (int2DoubleAVLTreeMap.compare(this.next.key, n) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Integer)entry.getKey() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits((Double)entry.getValue());
        }
