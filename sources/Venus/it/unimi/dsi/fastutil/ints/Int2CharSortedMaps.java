...
public final class Int2CharSortedMaps {
    ...
    public static Comparator<? super Map.Entry<Integer, ?>> entryComparator(IntComparator intComparator) {
        return (arg_0, arg_1) -> Int2CharSortedMaps.lambda$entryComparator$0(intComparator, arg_0, arg_1);
    }

    public static ObjectBidirectionalIterator<Int2CharMap.Entry> fastIterator(Int2CharSortedMap int2CharSortedMap) {
        ObjectSet objectSet = int2CharSortedMap.int2CharEntrySet();
        return objectSet instanceof Int2CharSortedMap.FastSortedEntrySet ? ((Int2CharSortedMap.FastSortedEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }

    public static ObjectBidirectionalIterable<Int2CharMap.Entry> fastIterable(Int2CharSortedMap int2CharSortedMap) {
        ObjectSet objectSet = int2CharSortedMap.int2CharEntrySet();
        return objectSet instanceof Int2CharSortedMap.FastSortedEntrySet ? ((Int2CharSortedMap.FastSortedEntrySet)objectSet)::fastIterator : objectSet;
    }

    public static Int2CharSortedMap singleton(Integer n, Character c) {
        return new Singleton(n, c.charValue());
    }

    public static Int2CharSortedMap singleton(Integer n, Character c, IntComparator intComparator) {
        return new Singleton(n, c.charValue(), intComparator);
    }

    public static Int2CharSortedMap singleton(int n, char c) {
        return new Singleton(n, c);
    }

    public static Int2CharSortedMap singleton(int n, char c, IntComparator intComparator) {
        return new Singleton(n, c, intComparator);
    }

    public static Int2CharSortedMap synchronize(Int2CharSortedMap int2CharSortedMap) {
        return new SynchronizedSortedMap(int2CharSortedMap);
    }

    public static Int2CharSortedMap synchronize(Int2CharSortedMap int2CharSortedMap, Object object) {
        return new SynchronizedSortedMap(int2CharSortedMap, object);
    }

    public static Int2CharSortedMap unmodifiable(Int2CharSortedMap int2CharSortedMap) {
        return new UnmodifiableSortedMap(int2CharSortedMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableSortedMap(Int2CharSortedMap int2CharSortedMap) {
            super(int2CharSortedMap);
            this.sortedMap = int2CharSortedMap;
        }
        ...
        @Override
        @Deprecated
        public Int2CharSortedMap subMap(Integer n, Integer n2) {
            return new UnmodifiableSortedMap(this.sortedMap.subMap(n, n2));
        }

        @Override
        @Deprecated
        public Int2CharSortedMap headMap(Integer n) {
            return new UnmodifiableSortedMap(this.sortedMap.headMap(n));
        }

        @Override
        @Deprecated
        public Int2CharSortedMap tailMap(Integer n) {
            return new UnmodifiableSortedMap(this.sortedMap.tailMap(n));
        }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Int2CharSortedMap int2CharSortedMap, Object object) {
            super(int2CharSortedMap, object);
            this.sortedMap = int2CharSortedMap;
        }

        protected SynchronizedSortedMap(Int2CharSortedMap int2CharSortedMap) {
            super(int2CharSortedMap);
            this.sortedMap = int2CharSortedMap;
        }
    ...
    Cloneable {
        ...
        protected Singleton(int n, char c, IntComparator intComparator) {
            super(n, c);
