...
Hash {
    ...
    public Int2LongLinkedOpenHashMap(Map<? extends Integer, ? extends Long> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Int2LongLinkedOpenHashMap(Map<? extends Integer, ? extends Long> map) {
        this(map, 0.75f);
    }

    public Int2LongLinkedOpenHashMap(Int2LongMap int2LongMap, float f) {
        this(int2LongMap.size(), f);
        this.putAll(int2LongMap);
    }

    public Int2LongLinkedOpenHashMap(Int2LongMap int2LongMap) {
        this(int2LongMap, 0.75f);
    }

    public Int2LongLinkedOpenHashMap(int[] nArray, long[] lArray, float f) {
    ...
    public Int2LongLinkedOpenHashMap(int[] nArray, long[] lArray) {
    ...
    public long getAndMoveToFirst(int n) {
        if (n == 0) {
            if (this.containsNullKey) {
    ...
    public long getAndMoveToLast(int n) {
        if (n == 0) {
            if (this.containsNullKey) {
    ...
    public long putAndMoveToFirst(int n, long l) {
        int n2;
        if (n == 0) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public long putAndMoveToLast(int n, long l) {
        int n2;
        if (n == 0) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection(this){
                final Int2LongLinkedOpenHashMap this$0;
                {
                    this.this$0 = int2LongLinkedOpenHashMap;
                }
    ...
    public Int2LongLinkedOpenHashMap clone() {
        Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap;
        try {
            int2LongLinkedOpenHashMap = (Int2LongLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2LongLinkedOpenHashMap.keys = null;
        int2LongLinkedOpenHashMap.values = null;
        int2LongLinkedOpenHashMap.entries = null;
        int2LongLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        int2LongLinkedOpenHashMap.key = (int[])this.key.clone();
        int2LongLinkedOpenHashMap.value = (long[])this.value.clone();
        int2LongLinkedOpenHashMap.link = (long[])this.link.clone();
        return int2LongLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet int2LongEntrySet() {
    ...
    static long access$100(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap) {
        return int2LongLinkedOpenHashMap.removeNullEntry();
    }

    static long access$200(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap, int n) {
        return int2LongLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements LongListIterator {
        ...
        public ValueIterator(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap) {
            this.this$0 = int2LongLinkedOpenHashMap;
            super(int2LongLinkedOpenHashMap);
        }
    ...
    extends AbstractIntSortedSet {
        ...
        private KeySet(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap) {
            this.this$0 = int2LongLinkedOpenHashMap;
        }
        ...
        KeySet(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap, 1 var2_2) {
            this(int2LongLinkedOpenHashMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap, int n) {
            this.this$0 = int2LongLinkedOpenHashMap;
            super(int2LongLinkedOpenHashMap, n, null);
        }
        ...
        public KeyIterator(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap) {
            this.this$0 = int2LongLinkedOpenHashMap;
            super(int2LongLinkedOpenHashMap);
        }
    ...
    implements Int2LongSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap) {
            this.this$0 = int2LongLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (n == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == l) {
                    Int2LongLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (n3 == n) {
                if (this.this$0.value[n2] == l) {
                    Int2LongLinkedOpenHashMap.access$200(this.this$0, n2);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Int2LongMap.Entry> iterator(Int2LongMap.Entry entry) {
        ...
        public ObjectListIterator<Int2LongMap.Entry> fastIterator(Int2LongMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Int2LongMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractInt2LongMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Int2LongMap.Entry entry) {
        ...
        MapEntrySet(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap, 1 var2_2) {
            this(int2LongLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Int2LongMap.Entry> {
        ...
        public FastEntryIterator(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap) {
            this.this$0 = int2LongLinkedOpenHashMap;
            super(int2LongLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap, int n) {
            this.this$0 = int2LongLinkedOpenHashMap;
            super(int2LongLinkedOpenHashMap, n, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Int2LongMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Int2LongMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Int2LongMap.Entry> {
        ...
        public EntryIterator(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap) {
            this.this$0 = int2LongLinkedOpenHashMap;
            super(int2LongLinkedOpenHashMap);
        }

        public EntryIterator(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap, int n) {
            this.this$0 = int2LongLinkedOpenHashMap;
            super(int2LongLinkedOpenHashMap, n, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap) {
            this.this$0 = int2LongLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = int2LongLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap, int n) {
            this.this$0 = int2LongLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (n == 0) {
                if (int2LongLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)int2LongLinkedOpenHashMap.link[int2LongLinkedOpenHashMap.n];
                    this.prev = int2LongLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + n + " does not belong to this map.");
            }
            if (int2LongLinkedOpenHashMap.key[int2LongLinkedOpenHashMap.last] == n) {
                this.prev = int2LongLinkedOpenHashMap.last;
                this.index = int2LongLinkedOpenHashMap.size;
                return;
            }
            int n2 = HashCommon.mix(n) & int2LongLinkedOpenHashMap.mask;
            while (int2LongLinkedOpenHashMap.key[n2] != 0) {
                if (int2LongLinkedOpenHashMap.key[n2] == n) {
                    this.next = (int)int2LongLinkedOpenHashMap.link[n2];
                    this.prev = n2;
                    return;
                }
                n2 = n2 + 1 & int2LongLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + n + " does not belong to this map.");
        }
        ...
        MapIterator(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap, int n, 1 var3_3) {
            this(int2LongLinkedOpenHashMap, n);
        }
    }
    ...
    Map.Entry<Integer, Long> {
        ...
        MapEntry(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap, int n) {
            this.this$0 = int2LongLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Int2LongLinkedOpenHashMap int2LongLinkedOpenHashMap) {
            this.this$0 = int2LongLinkedOpenHashMap;
        }
