...
Cloneable {
    ...
    public Int2BooleanRBTreeMap(Comparator<? super Integer> comparator) {
        this();
    ...
    public Int2BooleanRBTreeMap(SortedMap<Integer, Boolean> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Integer, ? extends Boolean>)sortedMap);
    }

    public Int2BooleanRBTreeMap(Int2BooleanMap int2BooleanMap) {
        this();
        this.putAll(int2BooleanMap);
    }

    public Int2BooleanRBTreeMap(Int2BooleanSortedMap int2BooleanSortedMap) {
        this(int2BooleanSortedMap.comparator());
        this.putAll(int2BooleanSortedMap);
    }

    public Int2BooleanRBTreeMap(int[] nArray, boolean[] blArray, Comparator<? super Integer> comparator) {
        this(comparator);
    ...
    public Int2BooleanRBTreeMap(int[] nArray, boolean[] blArray) {
    ...
    public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>(this){
                ...
                final Int2BooleanRBTreeMap this$0;
                {
                    this.this$0 = int2BooleanRBTreeMap;
    ...
    public Int2BooleanRBTreeMap clone() {
        Int2BooleanRBTreeMap int2BooleanRBTreeMap;
        try {
            int2BooleanRBTreeMap = (Int2BooleanRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        int2BooleanRBTreeMap.keys = null;
        int2BooleanRBTreeMap.values = null;
        int2BooleanRBTreeMap.entries = null;
        int2BooleanRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            int2BooleanRBTreeMap.firstEntry = int2BooleanRBTreeMap.tree = entry2.left;
                            while (int2BooleanRBTreeMap.firstEntry.left != null) {
                                int2BooleanRBTreeMap.firstEntry = int2BooleanRBTreeMap.firstEntry.left;
                            }
                            int2BooleanRBTreeMap.lastEntry = int2BooleanRBTreeMap.tree;
                            while (int2BooleanRBTreeMap.lastEntry.right != null) {
                                int2BooleanRBTreeMap.lastEntry = int2BooleanRBTreeMap.lastEntry.right;
                            }
                            return int2BooleanRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Int2BooleanRBTreeMap int2BooleanRBTreeMap, int n, boolean bl, int n2, boolean bl2) {
            this.this$0 = int2BooleanRBTreeMap;
            if (!bl && !bl2 && int2BooleanRBTreeMap.compare(n, n2) > 0) {
            ...
            this.to = n2;
            this.top = bl2;
            this.defRetValue = int2BooleanRBTreeMap.defRetValue;
        }
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Int2BooleanRBTreeMap int2BooleanRBTreeMap) {
            this.this$0 = int2BooleanRBTreeMap;
            super(int2BooleanRBTreeMap);
        }
        ...
        ValueIterator(Int2BooleanRBTreeMap int2BooleanRBTreeMap, 1 var2_2) {
            this(int2BooleanRBTreeMap);
        }
    }
    ...
    extends AbstractInt2BooleanSortedMap.KeySet {
        ...
        private KeySet(Int2BooleanRBTreeMap int2BooleanRBTreeMap) {
            this.this$0 = int2BooleanRBTreeMap;
            super(int2BooleanRBTreeMap);
        }
        ...
        KeySet(Int2BooleanRBTreeMap int2BooleanRBTreeMap, 1 var2_2) {
            this(int2BooleanRBTreeMap);
        }
    }
    ...
    implements IntListIterator {
        ...
        public KeyIterator(Int2BooleanRBTreeMap int2BooleanRBTreeMap) {
            this.this$0 = int2BooleanRBTreeMap;
            super(int2BooleanRBTreeMap);
        }

        public KeyIterator(Int2BooleanRBTreeMap int2BooleanRBTreeMap, int n) {
            this.this$0 = int2BooleanRBTreeMap;
            super(int2BooleanRBTreeMap, n);
        }
    ...
    implements ObjectListIterator<Int2BooleanMap.Entry> {
        ...
        EntryIterator(Int2BooleanRBTreeMap int2BooleanRBTreeMap) {
            this.this$0 = int2BooleanRBTreeMap;
            super(int2BooleanRBTreeMap);
        }

        EntryIterator(Int2BooleanRBTreeMap int2BooleanRBTreeMap, int n) {
            this.this$0 = int2BooleanRBTreeMap;
            super(int2BooleanRBTreeMap, n);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Int2BooleanRBTreeMap int2BooleanRBTreeMap) {
            this.this$0 = int2BooleanRBTreeMap;
            this.index = 0;
            this.next = int2BooleanRBTreeMap.firstEntry;
        }

        TreeIterator(Int2BooleanRBTreeMap int2BooleanRBTreeMap, int n) {
            this.this$0 = int2BooleanRBTreeMap;
            this.index = 0;
            this.next = int2BooleanRBTreeMap.locateKey(n);
            if (this.next != null) {
                if (int2BooleanRBTreeMap.compare(this.next.key, n) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
