...
Hash {
    ...
    static int access$300(Int2IntOpenHashMap int2IntOpenHashMap) {
        return int2IntOpenHashMap.removeNullEntry();
    }

    static int access$400(Int2IntOpenHashMap int2IntOpenHashMap, int n) {
        ...
        public boolean remove(Object object) {
            ...
            if (n == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n2) {
                    Int2IntOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (n4 == n) {
                if (this.this$0.value[n3] == n2) {
                    Int2IntOpenHashMap.access$400(this.this$0, n3);
                    return false;
                }
                return true;
            }
