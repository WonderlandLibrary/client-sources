...
Hash {
    ...
    public Int2DoubleOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Int2DoubleOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Int2DoubleOpenHashMap(Map<? extends Integer, ? extends Double> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }
    ...
    public Int2DoubleOpenHashMap(Int2DoubleMap int2DoubleMap, float f) {
    ...
    public Int2DoubleOpenHashMap(int[] nArray, double[] dArray, float f) {
    ...
    public Int2DoubleOpenHashMap(int[] nArray, double[] dArray) {
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(this){
                final Int2DoubleOpenHashMap this$0;
                {
                    this.this$0 = int2DoubleOpenHashMap;
                }
    ...
    public Int2DoubleOpenHashMap clone() {
        ...
        try {
            int2DoubleOpenHashMap = (Int2DoubleOpenHashMap)super.clone();
    ...
    static double access$300(Int2DoubleOpenHashMap int2DoubleOpenHashMap) {
        return int2DoubleOpenHashMap.removeNullEntry();
    }

    static double access$400(Int2DoubleOpenHashMap int2DoubleOpenHashMap, int n) {
        return int2DoubleOpenHashMap.removeEntry(n);
    }
    ...
    implements DoubleIterator {
        ...
        public ValueIterator(Int2DoubleOpenHashMap int2DoubleOpenHashMap) {
            this.this$0 = int2DoubleOpenHashMap;
            super(int2DoubleOpenHashMap, null);
        }
    ...
    extends AbstractIntSet {
        ...
        private KeySet(Int2DoubleOpenHashMap int2DoubleOpenHashMap) {
            this.this$0 = int2DoubleOpenHashMap;
        }
        ...
        KeySet(Int2DoubleOpenHashMap int2DoubleOpenHashMap, 1 var2_2) {
            this(int2DoubleOpenHashMap);
        }
    }
    ...
    implements IntIterator {
        ...
        public KeyIterator(Int2DoubleOpenHashMap int2DoubleOpenHashMap) {
            this.this$0 = int2DoubleOpenHashMap;
            super(int2DoubleOpenHashMap, null);
        }
    ...
    implements Int2DoubleMap.FastEntrySet {
        ...
        private MapEntrySet(Int2DoubleOpenHashMap int2DoubleOpenHashMap) {
            this.this$0 = int2DoubleOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (n == 0) {
                if (this.this$0.containsNullKey && Double.doubleToLongBits(this.this$0.value[this.this$0.n]) == Double.doubleToLongBits(d)) {
                    Int2DoubleOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (n3 == n) {
                if (Double.doubleToLongBits(this.this$0.value[n2]) == Double.doubleToLongBits(d)) {
                    Int2DoubleOpenHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Int2DoubleOpenHashMap int2DoubleOpenHashMap, 1 var2_2) {
            this(int2DoubleOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2DoubleMap.Entry> {
        ...
        private FastEntryIterator(Int2DoubleOpenHashMap int2DoubleOpenHashMap) {
            this.this$0 = int2DoubleOpenHashMap;
            super(int2DoubleOpenHashMap, null);
        ...
        FastEntryIterator(Int2DoubleOpenHashMap int2DoubleOpenHashMap, 1 var2_2) {
            this(int2DoubleOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Int2DoubleMap.Entry> {
        ...
        private EntryIterator(Int2DoubleOpenHashMap int2DoubleOpenHashMap) {
            this.this$0 = int2DoubleOpenHashMap;
            super(int2DoubleOpenHashMap, null);
        }
        ...
        EntryIterator(Int2DoubleOpenHashMap int2DoubleOpenHashMap, 1 var2_2) {
            this(int2DoubleOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Int2DoubleOpenHashMap int2DoubleOpenHashMap) {
            this.this$0 = int2DoubleOpenHashMap;
        ...
        MapIterator(Int2DoubleOpenHashMap int2DoubleOpenHashMap, 1 var2_2) {
            this(int2DoubleOpenHashMap);
        }
    }
    ...
    Map.Entry<Integer, Double> {
        ...
        MapEntry(Int2DoubleOpenHashMap int2DoubleOpenHashMap, int n) {
            this.this$0 = int2DoubleOpenHashMap;
            this.index = n;
        }

        MapEntry(Int2DoubleOpenHashMap int2DoubleOpenHashMap) {
            this.this$0 = int2DoubleOpenHashMap;
        }
