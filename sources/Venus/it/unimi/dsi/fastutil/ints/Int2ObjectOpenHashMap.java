...
Hash {
    ...
    static Object access$300(Int2ObjectOpenHashMap int2ObjectOpenHashMap) {
        return int2ObjectOpenHashMap.removeNullEntry();
    }

    static Object access$400(Int2ObjectOpenHashMap int2ObjectOpenHashMap, int n) {
        ...
        public boolean remove(Object object) {
            ...
            if (n == 0) {
                if (this.this$0.containsNullKey && Objects.equals(this.this$0.value[this.this$0.n], v)) {
                    Int2ObjectOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (n3 == n) {
                if (Objects.equals(this.this$0.value[n2], v)) {
                    Int2ObjectOpenHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
