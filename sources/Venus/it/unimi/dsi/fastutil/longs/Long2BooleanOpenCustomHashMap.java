...
Hash {
    ...
    public Long2BooleanOpenCustomHashMap(int n, float f, LongHash.Strategy strategy) {
    ...
    public Long2BooleanOpenCustomHashMap(int n, LongHash.Strategy strategy) {
    ...
    public Long2BooleanOpenCustomHashMap(Map<? extends Long, ? extends Boolean> map, float f, LongHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Long2BooleanOpenCustomHashMap(Map<? extends Long, ? extends Boolean> map, LongHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Long2BooleanOpenCustomHashMap(Long2BooleanMap long2BooleanMap, float f, LongHash.Strategy strategy) {
        this(long2BooleanMap.size(), f, strategy);
        this.putAll(long2BooleanMap);
    }

    public Long2BooleanOpenCustomHashMap(Long2BooleanMap long2BooleanMap, LongHash.Strategy strategy) {
        this(long2BooleanMap, 0.75f, strategy);
    }

    public Long2BooleanOpenCustomHashMap(long[] lArray, boolean[] blArray, float f, LongHash.Strategy strategy) {
    ...
    public Long2BooleanOpenCustomHashMap(long[] lArray, boolean[] blArray, LongHash.Strategy strategy) {
        this(lArray, blArray, 0.75f, strategy);
    }
    ...
    public boolean remove(long l, boolean bl) {
        ...
        if (this.strategy.equals(l, l2) && bl == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((l2 = lArray[n = n + 1 & this.mask]) != 0L) continue;
            return true;
        } while (!this.strategy.equals(l, l2) || bl != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public BooleanCollection values() {
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(this){
                final Long2BooleanOpenCustomHashMap this$0;
                {
                    this.this$0 = long2BooleanOpenCustomHashMap;
                }
    ...
    public Long2BooleanOpenCustomHashMap clone() {
        Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap;
        try {
            long2BooleanOpenCustomHashMap = (Long2BooleanOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2BooleanOpenCustomHashMap.keys = null;
        long2BooleanOpenCustomHashMap.values = null;
        long2BooleanOpenCustomHashMap.entries = null;
        long2BooleanOpenCustomHashMap.containsNullKey = this.containsNullKey;
        long2BooleanOpenCustomHashMap.key = (long[])this.key.clone();
        long2BooleanOpenCustomHashMap.value = (boolean[])this.value.clone();
        long2BooleanOpenCustomHashMap.strategy = this.strategy;
    ...
    static boolean access$300(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap) {
        return long2BooleanOpenCustomHashMap.removeNullEntry();
    }

    static boolean access$400(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap, int n) {
        return long2BooleanOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements BooleanIterator {
        ...
        public ValueIterator(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap) {
            this.this$0 = long2BooleanOpenCustomHashMap;
            super(long2BooleanOpenCustomHashMap, null);
        }
    ...
    extends AbstractLongSet {
        ...
        private KeySet(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap) {
            this.this$0 = long2BooleanOpenCustomHashMap;
        }
        ...
        KeySet(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap, 1 var2_2) {
            this(long2BooleanOpenCustomHashMap);
        }
    }
    ...
    implements LongIterator {
        ...
        public KeyIterator(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap) {
            this.this$0 = long2BooleanOpenCustomHashMap;
            super(long2BooleanOpenCustomHashMap, null);
        }
    ...
    implements Long2BooleanMap.FastEntrySet {
        ...
        private MapEntrySet(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap) {
            this.this$0 = long2BooleanOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(l, 0L)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == bl) {
                    Long2BooleanOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(l2, l)) {
                if (this.this$0.value[n] == bl) {
                    Long2BooleanOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((l2 = lArray[n = n + 1 & this.this$0.mask]) != 0L) continue;
                return true;
            } while (!this.this$0.strategy.equals(l2, l) || this.this$0.value[n] != bl);
            Long2BooleanOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap, 1 var2_2) {
            this(long2BooleanOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2BooleanMap.Entry> {
        ...
        private FastEntryIterator(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap) {
            this.this$0 = long2BooleanOpenCustomHashMap;
            super(long2BooleanOpenCustomHashMap, null);
        ...
        FastEntryIterator(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap, 1 var2_2) {
            this(long2BooleanOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2BooleanMap.Entry> {
        ...
        private EntryIterator(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap) {
            this.this$0 = long2BooleanOpenCustomHashMap;
            super(long2BooleanOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap, 1 var2_2) {
            this(long2BooleanOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap) {
            this.this$0 = long2BooleanOpenCustomHashMap;
        ...
        MapIterator(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap, 1 var2_2) {
            this(long2BooleanOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Long, Boolean> {
        ...
        MapEntry(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap, int n) {
            this.this$0 = long2BooleanOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Long2BooleanOpenCustomHashMap long2BooleanOpenCustomHashMap) {
            this.this$0 = long2BooleanOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Long)entry.getKey()) && this.this$0.value[this.index] == (Boolean)entry.getValue();
        }
