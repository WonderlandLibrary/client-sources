...
Hash {
    ...
    public Long2ShortOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Long2ShortOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Long2ShortOpenHashMap(Map<? extends Long, ? extends Short> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Long2ShortOpenHashMap(Map<? extends Long, ? extends Short> map) {
        this(map, 0.75f);
    }

    public Long2ShortOpenHashMap(Long2ShortMap long2ShortMap, float f) {
        this(long2ShortMap.size(), f);
        this.putAll(long2ShortMap);
    }

    public Long2ShortOpenHashMap(Long2ShortMap long2ShortMap) {
        this(long2ShortMap, 0.75f);
    }

    public Long2ShortOpenHashMap(long[] lArray, short[] sArray, float f) {
    ...
    public Long2ShortOpenHashMap(long[] lArray, short[] sArray) {
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection(this){
                final Long2ShortOpenHashMap this$0;
                {
                    this.this$0 = long2ShortOpenHashMap;
                }
    ...
    public Long2ShortOpenHashMap clone() {
        Long2ShortOpenHashMap long2ShortOpenHashMap;
        try {
            long2ShortOpenHashMap = (Long2ShortOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2ShortOpenHashMap.keys = null;
        long2ShortOpenHashMap.values = null;
        long2ShortOpenHashMap.entries = null;
        long2ShortOpenHashMap.containsNullKey = this.containsNullKey;
        long2ShortOpenHashMap.key = (long[])this.key.clone();
        long2ShortOpenHashMap.value = (short[])this.value.clone();
    ...
    static short access$300(Long2ShortOpenHashMap long2ShortOpenHashMap) {
        return long2ShortOpenHashMap.removeNullEntry();
    }

    static short access$400(Long2ShortOpenHashMap long2ShortOpenHashMap, int n) {
        return long2ShortOpenHashMap.removeEntry(n);
    }
    ...
    implements ShortIterator {
        ...
        public ValueIterator(Long2ShortOpenHashMap long2ShortOpenHashMap) {
            this.this$0 = long2ShortOpenHashMap;
            super(long2ShortOpenHashMap, null);
        }
    ...
    extends AbstractLongSet {
        ...
        private KeySet(Long2ShortOpenHashMap long2ShortOpenHashMap) {
            this.this$0 = long2ShortOpenHashMap;
        }
        ...
        KeySet(Long2ShortOpenHashMap long2ShortOpenHashMap, 1 var2_2) {
            this(long2ShortOpenHashMap);
        }
    }
    ...
    implements LongIterator {
        ...
        public KeyIterator(Long2ShortOpenHashMap long2ShortOpenHashMap) {
            this.this$0 = long2ShortOpenHashMap;
            super(long2ShortOpenHashMap, null);
        }
    ...
    implements Long2ShortMap.FastEntrySet {
        ...
        private MapEntrySet(Long2ShortOpenHashMap long2ShortOpenHashMap) {
            this.this$0 = long2ShortOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (l == 0L) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == s) {
                    Long2ShortOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (l2 == l) {
                if (this.this$0.value[n] == s) {
                    Long2ShortOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Long2ShortOpenHashMap long2ShortOpenHashMap, 1 var2_2) {
            this(long2ShortOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2ShortMap.Entry> {
        ...
        private FastEntryIterator(Long2ShortOpenHashMap long2ShortOpenHashMap) {
            this.this$0 = long2ShortOpenHashMap;
            super(long2ShortOpenHashMap, null);
        ...
        FastEntryIterator(Long2ShortOpenHashMap long2ShortOpenHashMap, 1 var2_2) {
            this(long2ShortOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2ShortMap.Entry> {
        ...
        private EntryIterator(Long2ShortOpenHashMap long2ShortOpenHashMap) {
            this.this$0 = long2ShortOpenHashMap;
            super(long2ShortOpenHashMap, null);
        }
        ...
        EntryIterator(Long2ShortOpenHashMap long2ShortOpenHashMap, 1 var2_2) {
            this(long2ShortOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Long2ShortOpenHashMap long2ShortOpenHashMap) {
            this.this$0 = long2ShortOpenHashMap;
        ...
        MapIterator(Long2ShortOpenHashMap long2ShortOpenHashMap, 1 var2_2) {
            this(long2ShortOpenHashMap);
        }
    }
    ...
    Map.Entry<Long, Short> {
        ...
        MapEntry(Long2ShortOpenHashMap long2ShortOpenHashMap, int n) {
            this.this$0 = long2ShortOpenHashMap;
            this.index = n;
        }

        MapEntry(Long2ShortOpenHashMap long2ShortOpenHashMap) {
            this.this$0 = long2ShortOpenHashMap;
        }
