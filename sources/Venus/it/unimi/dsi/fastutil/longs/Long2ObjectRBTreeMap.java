...
Cloneable {
    ...
    public Long2ObjectRBTreeMap(Comparator<? super Long> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Long2ObjectRBTreeMap(Map<? extends Long, ? extends V> map) {
        this();
        this.putAll((Map<Long, ? extends V>)map);
    }

    public Long2ObjectRBTreeMap(SortedMap<Long, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Long, V>)sortedMap);
    }

    public Long2ObjectRBTreeMap(Long2ObjectMap<? extends V> long2ObjectMap) {
        this();
        this.putAll(long2ObjectMap);
    }

    public Long2ObjectRBTreeMap(Long2ObjectSortedMap<V> long2ObjectSortedMap) {
        this(long2ObjectSortedMap.comparator());
        this.putAll(long2ObjectSortedMap);
    }

    public Long2ObjectRBTreeMap(long[] lArray, V[] VArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2ObjectRBTreeMap(long[] lArray, V[] VArray) {
    ...
    public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>(this){
                final Comparator<? super Long2ObjectMap.Entry<V>> comparator;
                final Long2ObjectRBTreeMap this$0;
                {
                    this.this$0 = long2ObjectRBTreeMap;
                ...
                public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> entry, Long2ObjectMap.Entry<V> entry2) {
                    return this.this$0.subMap(entry.getLongKey(), entry2.getLongKey()).long2ObjectEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> entry) {
                    return this.this$0.headMap(entry.getLongKey()).long2ObjectEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> entry) {
                    return this.this$0.tailMap(entry.getLongKey()).long2ObjectEntrySet();
                }
                ...
                private int lambda$$0(Long2ObjectMap.Entry entry, Long2ObjectMap.Entry entry2) {
    ...
    public Long2ObjectRBTreeMap<V> clone() {
        Long2ObjectRBTreeMap long2ObjectRBTreeMap;
        try {
            long2ObjectRBTreeMap = (Long2ObjectRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2ObjectRBTreeMap.keys = null;
        long2ObjectRBTreeMap.values = null;
        long2ObjectRBTreeMap.entries = null;
        long2ObjectRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2ObjectRBTreeMap.tree = entry2.left;
                            long2ObjectRBTreeMap.firstEntry = long2ObjectRBTreeMap.tree;
                            while (long2ObjectRBTreeMap.firstEntry.left != null) {
                                long2ObjectRBTreeMap.firstEntry = long2ObjectRBTreeMap.firstEntry.left;
                            }
                            long2ObjectRBTreeMap.lastEntry = long2ObjectRBTreeMap.tree;
                            while (long2ObjectRBTreeMap.lastEntry.right != null) {
                                long2ObjectRBTreeMap.lastEntry = long2ObjectRBTreeMap.lastEntry.right;
                            }
                            return long2ObjectRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Long2ObjectRBTreeMap long2ObjectRBTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2ObjectRBTreeMap;
            if (!bl && !bl2 && long2ObjectRBTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2ObjectRBTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>(this){
                    ...
                    @Override
                    public Comparator<? super Long2ObjectMap.Entry<V>> comparator() {
                        return this.this$1.this$0.long2ObjectEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> entry, Long2ObjectMap.Entry<V> entry2) {
                        return this.this$1.subMap(entry.getLongKey(), entry2.getLongKey()).long2ObjectEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> entry) {
                        return this.this$1.headMap(entry.getLongKey()).long2ObjectEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> entry) {
                        return this.this$1.tailMap(entry.getLongKey()).long2ObjectEntrySet();
                    }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Long2ObjectRBTreeMap long2ObjectRBTreeMap) {
            this.this$0 = long2ObjectRBTreeMap;
            super(long2ObjectRBTreeMap);
        }
        ...
        ValueIterator(Long2ObjectRBTreeMap long2ObjectRBTreeMap, 1 var2_2) {
            this(long2ObjectRBTreeMap);
        }
    }
    ...
    extends AbstractLong2ObjectSortedMap.KeySet {
        ...
        private KeySet(Long2ObjectRBTreeMap long2ObjectRBTreeMap) {
            this.this$0 = long2ObjectRBTreeMap;
            super(long2ObjectRBTreeMap);
        }
        ...
        KeySet(Long2ObjectRBTreeMap long2ObjectRBTreeMap, 1 var2_2) {
            this(long2ObjectRBTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2ObjectRBTreeMap long2ObjectRBTreeMap) {
            this.this$0 = long2ObjectRBTreeMap;
            super(long2ObjectRBTreeMap);
        }

        public KeyIterator(Long2ObjectRBTreeMap long2ObjectRBTreeMap, long l) {
            this.this$0 = long2ObjectRBTreeMap;
            super(long2ObjectRBTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2ObjectMap.Entry<V>> {
        ...
        EntryIterator(Long2ObjectRBTreeMap long2ObjectRBTreeMap) {
            this.this$0 = long2ObjectRBTreeMap;
            super(long2ObjectRBTreeMap);
        }

        EntryIterator(Long2ObjectRBTreeMap long2ObjectRBTreeMap, long l) {
            this.this$0 = long2ObjectRBTreeMap;
            super(long2ObjectRBTreeMap, l);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2ObjectRBTreeMap long2ObjectRBTreeMap) {
            this.this$0 = long2ObjectRBTreeMap;
            this.index = 0;
            this.next = long2ObjectRBTreeMap.firstEntry;
        }

        TreeIterator(Long2ObjectRBTreeMap long2ObjectRBTreeMap, long l) {
            this.this$0 = long2ObjectRBTreeMap;
            this.index = 0;
            this.next = long2ObjectRBTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2ObjectRBTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Long)entry.getKey() && Objects.equals(this.value, entry.getValue());
        }
