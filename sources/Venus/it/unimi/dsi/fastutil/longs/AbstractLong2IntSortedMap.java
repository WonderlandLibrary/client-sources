...
implements Long2IntSortedMap {
    ...
    implements IntIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Long2IntMap.Entry> objectBidirectionalIterator) {
    ...
    extends AbstractIntCollection {
        final AbstractLong2IntSortedMap this$0;

        protected ValuesCollection(AbstractLong2IntSortedMap abstractLong2IntSortedMap) {
            this.this$0 = abstractLong2IntSortedMap;
        }

        @Override
        public IntIterator iterator() {
            return new ValuesIterator(Long2IntSortedMaps.fastIterator(this.this$0));
        }
    ...
    implements LongBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Long2IntMap.Entry> objectBidirectionalIterator) {
            this.i = objectBidirectionalIterator;
        }
    ...
    extends AbstractLongSortedSet {
        ...
        protected KeySet(AbstractLong2IntSortedMap abstractLong2IntSortedMap) {
            this.this$0 = abstractLong2IntSortedMap;
        }
        ...
        public LongBidirectionalIterator iterator(long l) {
            return new KeySetIterator(this.this$0.long2IntEntrySet().iterator(new AbstractLong2IntMap.BasicEntry(l, 0)));
        }

        @Override
        public LongBidirectionalIterator iterator() {
            return new KeySetIterator(Long2IntSortedMaps.fastIterator(this.this$0));
        }
