...
Hash {
    ...
    public Long2ByteOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Long2ByteOpenHashMap(Map<? extends Long, ? extends Byte> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Long2ByteOpenHashMap(Map<? extends Long, ? extends Byte> map) {
        this(map, 0.75f);
    }

    public Long2ByteOpenHashMap(Long2ByteMap long2ByteMap, float f) {
        this(long2ByteMap.size(), f);
        this.putAll(long2ByteMap);
    }

    public Long2ByteOpenHashMap(Long2ByteMap long2ByteMap) {
        this(long2ByteMap, 0.75f);
    }

    public Long2ByteOpenHashMap(long[] lArray, byte[] byArray, float f) {
    ...
    public Long2ByteOpenHashMap(long[] lArray, byte[] byArray) {
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection(this){
                final Long2ByteOpenHashMap this$0;
                {
                    this.this$0 = long2ByteOpenHashMap;
                }
    ...
    public Long2ByteOpenHashMap clone() {
        Long2ByteOpenHashMap long2ByteOpenHashMap;
        try {
            long2ByteOpenHashMap = (Long2ByteOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2ByteOpenHashMap.keys = null;
        long2ByteOpenHashMap.values = null;
        long2ByteOpenHashMap.entries = null;
        long2ByteOpenHashMap.containsNullKey = this.containsNullKey;
        long2ByteOpenHashMap.key = (long[])this.key.clone();
        long2ByteOpenHashMap.value = (byte[])this.value.clone();
    ...
    static byte access$300(Long2ByteOpenHashMap long2ByteOpenHashMap) {
        return long2ByteOpenHashMap.removeNullEntry();
    }

    static byte access$400(Long2ByteOpenHashMap long2ByteOpenHashMap, int n) {
        return long2ByteOpenHashMap.removeEntry(n);
    }
    ...
    implements ByteIterator {
        ...
        public ValueIterator(Long2ByteOpenHashMap long2ByteOpenHashMap) {
            this.this$0 = long2ByteOpenHashMap;
            super(long2ByteOpenHashMap, null);
        }
    ...
    extends AbstractLongSet {
        ...
        private KeySet(Long2ByteOpenHashMap long2ByteOpenHashMap) {
            this.this$0 = long2ByteOpenHashMap;
        }
        ...
        KeySet(Long2ByteOpenHashMap long2ByteOpenHashMap, 1 var2_2) {
            this(long2ByteOpenHashMap);
        }
    }
    ...
    implements LongIterator {
        ...
        public KeyIterator(Long2ByteOpenHashMap long2ByteOpenHashMap) {
            this.this$0 = long2ByteOpenHashMap;
            super(long2ByteOpenHashMap, null);
        }
    ...
    implements Long2ByteMap.FastEntrySet {
        ...
        private MapEntrySet(Long2ByteOpenHashMap long2ByteOpenHashMap) {
            this.this$0 = long2ByteOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (l == 0L) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == by) {
                    Long2ByteOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (l2 == l) {
                if (this.this$0.value[n] == by) {
                    Long2ByteOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Long2ByteOpenHashMap long2ByteOpenHashMap, 1 var2_2) {
            this(long2ByteOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2ByteMap.Entry> {
        ...
        private FastEntryIterator(Long2ByteOpenHashMap long2ByteOpenHashMap) {
            this.this$0 = long2ByteOpenHashMap;
            super(long2ByteOpenHashMap, null);
        ...
        FastEntryIterator(Long2ByteOpenHashMap long2ByteOpenHashMap, 1 var2_2) {
            this(long2ByteOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2ByteMap.Entry> {
        ...
        private EntryIterator(Long2ByteOpenHashMap long2ByteOpenHashMap) {
            this.this$0 = long2ByteOpenHashMap;
            super(long2ByteOpenHashMap, null);
        }
        ...
        EntryIterator(Long2ByteOpenHashMap long2ByteOpenHashMap, 1 var2_2) {
            this(long2ByteOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Long2ByteOpenHashMap long2ByteOpenHashMap) {
            this.this$0 = long2ByteOpenHashMap;
        ...
        MapIterator(Long2ByteOpenHashMap long2ByteOpenHashMap, 1 var2_2) {
            this(long2ByteOpenHashMap);
        }
    }
    ...
    Map.Entry<Long, Byte> {
        ...
        MapEntry(Long2ByteOpenHashMap long2ByteOpenHashMap, int n) {
            this.this$0 = long2ByteOpenHashMap;
            this.index = n;
        }

        MapEntry(Long2ByteOpenHashMap long2ByteOpenHashMap) {
            this.this$0 = long2ByteOpenHashMap;
        }
