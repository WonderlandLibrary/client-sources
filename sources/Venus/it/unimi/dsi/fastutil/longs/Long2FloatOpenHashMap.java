...
Hash {
    ...
    public Long2FloatOpenHashMap(Map<? extends Long, ? extends Float> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }
    ...
    public Long2FloatOpenHashMap(Long2FloatMap long2FloatMap, float f) {
        this(long2FloatMap.size(), f);
        this.putAll(long2FloatMap);
    }

    public Long2FloatOpenHashMap(Long2FloatMap long2FloatMap) {
        this(long2FloatMap, 0.75f);
    }

    public Long2FloatOpenHashMap(long[] lArray, float[] fArray, float f) {
    ...
    public Long2FloatOpenHashMap(long[] lArray, float[] fArray) {
    ...
    public FloatCollection values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection(this){
                final Long2FloatOpenHashMap this$0;
                {
                    this.this$0 = long2FloatOpenHashMap;
                }
    ...
    public Long2FloatOpenHashMap clone() {
        Long2FloatOpenHashMap long2FloatOpenHashMap;
        try {
            long2FloatOpenHashMap = (Long2FloatOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2FloatOpenHashMap.keys = null;
        long2FloatOpenHashMap.values = null;
        long2FloatOpenHashMap.entries = null;
        long2FloatOpenHashMap.containsNullKey = this.containsNullKey;
        long2FloatOpenHashMap.key = (long[])this.key.clone();
        long2FloatOpenHashMap.value = (float[])this.value.clone();
    ...
    static float access$300(Long2FloatOpenHashMap long2FloatOpenHashMap) {
        return long2FloatOpenHashMap.removeNullEntry();
    }

    static float access$400(Long2FloatOpenHashMap long2FloatOpenHashMap, int n) {
        return long2FloatOpenHashMap.removeEntry(n);
    }
    ...
    implements FloatIterator {
        ...
        public ValueIterator(Long2FloatOpenHashMap long2FloatOpenHashMap) {
            this.this$0 = long2FloatOpenHashMap;
            super(long2FloatOpenHashMap, null);
        }
    ...
    extends AbstractLongSet {
        ...
        private KeySet(Long2FloatOpenHashMap long2FloatOpenHashMap) {
            this.this$0 = long2FloatOpenHashMap;
        }
        ...
        KeySet(Long2FloatOpenHashMap long2FloatOpenHashMap, 1 var2_2) {
            this(long2FloatOpenHashMap);
        }
    }
    ...
    implements LongIterator {
        ...
        public KeyIterator(Long2FloatOpenHashMap long2FloatOpenHashMap) {
            this.this$0 = long2FloatOpenHashMap;
            super(long2FloatOpenHashMap, null);
        }
    ...
    implements Long2FloatMap.FastEntrySet {
        ...
        private MapEntrySet(Long2FloatOpenHashMap long2FloatOpenHashMap) {
            this.this$0 = long2FloatOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (l == 0L) {
                if (this.this$0.containsNullKey && Float.floatToIntBits(this.this$0.value[this.this$0.n]) == Float.floatToIntBits(f)) {
                    Long2FloatOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (l2 == l) {
                if (Float.floatToIntBits(this.this$0.value[n]) == Float.floatToIntBits(f)) {
                    Long2FloatOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Long2FloatOpenHashMap long2FloatOpenHashMap, 1 var2_2) {
            this(long2FloatOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2FloatMap.Entry> {
        ...
        private FastEntryIterator(Long2FloatOpenHashMap long2FloatOpenHashMap) {
            this.this$0 = long2FloatOpenHashMap;
            super(long2FloatOpenHashMap, null);
        ...
        FastEntryIterator(Long2FloatOpenHashMap long2FloatOpenHashMap, 1 var2_2) {
            this(long2FloatOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2FloatMap.Entry> {
        ...
        private EntryIterator(Long2FloatOpenHashMap long2FloatOpenHashMap) {
            this.this$0 = long2FloatOpenHashMap;
            super(long2FloatOpenHashMap, null);
        }
        ...
        EntryIterator(Long2FloatOpenHashMap long2FloatOpenHashMap, 1 var2_2) {
            this(long2FloatOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Long2FloatOpenHashMap long2FloatOpenHashMap) {
            this.this$0 = long2FloatOpenHashMap;
        ...
        MapIterator(Long2FloatOpenHashMap long2FloatOpenHashMap, 1 var2_2) {
            this(long2FloatOpenHashMap);
        }
    }
    ...
    Map.Entry<Long, Float> {
        ...
        MapEntry(Long2FloatOpenHashMap long2FloatOpenHashMap, int n) {
            this.this$0 = long2FloatOpenHashMap;
            this.index = n;
        }

        MapEntry(Long2FloatOpenHashMap long2FloatOpenHashMap) {
            this.this$0 = long2FloatOpenHashMap;
        }
