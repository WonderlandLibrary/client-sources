...
implements Long2ObjectSortedMap<V> {
    ...
    implements ObjectIterator<V> {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> objectBidirectionalIterator) {
    ...
    extends AbstractObjectCollection<V> {
        final AbstractLong2ObjectSortedMap this$0;

        protected ValuesCollection(AbstractLong2ObjectSortedMap abstractLong2ObjectSortedMap) {
            this.this$0 = abstractLong2ObjectSortedMap;
        }

        @Override
        public ObjectIterator<V> iterator() {
            return new ValuesIterator(Long2ObjectSortedMaps.fastIterator(this.this$0));
        }
    ...
    implements LongBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> objectBidirectionalIterator) {
            this.i = objectBidirectionalIterator;
        }
    ...
    extends AbstractLongSortedSet {
        ...
        protected KeySet(AbstractLong2ObjectSortedMap abstractLong2ObjectSortedMap) {
            this.this$0 = abstractLong2ObjectSortedMap;
        }
        ...
        public LongBidirectionalIterator iterator(long l) {
            return new KeySetIterator(this.this$0.long2ObjectEntrySet().iterator(new AbstractLong2ObjectMap.BasicEntry<Object>(l, null)));
        }

        @Override
        public LongBidirectionalIterator iterator() {
            return new KeySetIterator(Long2ObjectSortedMaps.fastIterator(this.this$0));
        }
