...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Long2CharAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Long2CharAVLTreeMap(Comparator<? super Long> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Long2CharAVLTreeMap(Map<? extends Long, ? extends Character> map) {
        this();
        this.putAll(map);
    }

    public Long2CharAVLTreeMap(SortedMap<Long, Character> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Long, ? extends Character>)sortedMap);
    }

    public Long2CharAVLTreeMap(Long2CharMap long2CharMap) {
        this();
        this.putAll(long2CharMap);
    }

    public Long2CharAVLTreeMap(Long2CharSortedMap long2CharSortedMap) {
        this(long2CharSortedMap.comparator());
        this.putAll(long2CharSortedMap);
    }

    public Long2CharAVLTreeMap(long[] lArray, char[] cArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2CharAVLTreeMap(long[] lArray, char[] cArray) {
        this(lArray, cArray, null);
    }
    ...
    public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2CharMap.Entry>(this){
                final Comparator<? super Long2CharMap.Entry> comparator;
                final Long2CharAVLTreeMap this$0;
                {
                    this.this$0 = long2CharAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator(Long2CharMap.Entry entry) {
                ...
                public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry entry, Long2CharMap.Entry entry2) {
                    return this.this$0.subMap(entry.getLongKey(), entry2.getLongKey()).long2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry entry) {
                    return this.this$0.headMap(entry.getLongKey()).long2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry entry) {
                    return this.this$0.tailMap(entry.getLongKey()).long2CharEntrySet();
                }
                ...
                private int lambda$$0(Long2CharMap.Entry entry, Long2CharMap.Entry entry2) {
    ...
    public Long2CharAVLTreeMap clone() {
        Long2CharAVLTreeMap long2CharAVLTreeMap;
        try {
            long2CharAVLTreeMap = (Long2CharAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2CharAVLTreeMap.keys = null;
        long2CharAVLTreeMap.values = null;
        long2CharAVLTreeMap.entries = null;
        long2CharAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2CharAVLTreeMap.firstEntry = long2CharAVLTreeMap.tree = entry2.left;
                            while (long2CharAVLTreeMap.firstEntry.left != null) {
                                long2CharAVLTreeMap.firstEntry = long2CharAVLTreeMap.firstEntry.left;
                            }
                            long2CharAVLTreeMap.lastEntry = long2CharAVLTreeMap.tree;
                            while (long2CharAVLTreeMap.lastEntry.right != null) {
                                long2CharAVLTreeMap.lastEntry = long2CharAVLTreeMap.lastEntry.right;
                            }
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readLong(), objectInputStream.readChar());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readLong(), objectInputStream.readChar());
            entry4.right(new Entry(objectInputStream.readLong(), objectInputStream.readChar()));
    ...
    implements Serializable {
        ...
        public Submap(Long2CharAVLTreeMap long2CharAVLTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2CharAVLTreeMap;
            if (!bl && !bl2 && long2CharAVLTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2CharAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2CharMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Long2CharMap.Entry> comparator() {
                        return this.this$1.this$0.long2CharEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry entry, Long2CharMap.Entry entry2) {
                        return this.this$1.subMap(entry.getLongKey(), entry2.getLongKey()).long2CharEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry entry) {
                        return this.this$1.headMap(entry.getLongKey()).long2CharEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry entry) {
                        return this.this$1.tailMap(entry.getLongKey()).long2CharEntrySet();
                    }
    ...
    implements CharListIterator {
        ...
        private ValueIterator(Long2CharAVLTreeMap long2CharAVLTreeMap) {
            this.this$0 = long2CharAVLTreeMap;
            super(long2CharAVLTreeMap);
        }
        ...
        ValueIterator(Long2CharAVLTreeMap long2CharAVLTreeMap, 1 var2_2) {
            this(long2CharAVLTreeMap);
        }
    }
    ...
    extends AbstractLong2CharSortedMap.KeySet {
        ...
        private KeySet(Long2CharAVLTreeMap long2CharAVLTreeMap) {
            this.this$0 = long2CharAVLTreeMap;
            super(long2CharAVLTreeMap);
        }
        ...
        KeySet(Long2CharAVLTreeMap long2CharAVLTreeMap, 1 var2_2) {
            this(long2CharAVLTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2CharAVLTreeMap long2CharAVLTreeMap) {
            this.this$0 = long2CharAVLTreeMap;
            super(long2CharAVLTreeMap);
        }

        public KeyIterator(Long2CharAVLTreeMap long2CharAVLTreeMap, long l) {
            this.this$0 = long2CharAVLTreeMap;
            super(long2CharAVLTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2CharMap.Entry> {
        ...
        EntryIterator(Long2CharAVLTreeMap long2CharAVLTreeMap) {
            this.this$0 = long2CharAVLTreeMap;
            super(long2CharAVLTreeMap);
        }

        EntryIterator(Long2CharAVLTreeMap long2CharAVLTreeMap, long l) {
            this.this$0 = long2CharAVLTreeMap;
            super(long2CharAVLTreeMap, l);
        }
        ...
        public void add(Object object) {
            this.add((Long2CharMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Long2CharMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2CharAVLTreeMap long2CharAVLTreeMap) {
            this.this$0 = long2CharAVLTreeMap;
            this.index = 0;
            this.next = long2CharAVLTreeMap.firstEntry;
        }

        TreeIterator(Long2CharAVLTreeMap long2CharAVLTreeMap, long l) {
            this.this$0 = long2CharAVLTreeMap;
            this.index = 0;
            this.next = long2CharAVLTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2CharAVLTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Long)entry.getKey() && this.value == ((Character)entry.getValue()).charValue();
        }
