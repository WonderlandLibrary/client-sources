...
Cloneable {
    ...
    public Long2BooleanRBTreeMap(Comparator<? super Long> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Long2BooleanRBTreeMap(Map<? extends Long, ? extends Boolean> map) {
        this();
        this.putAll(map);
    }

    public Long2BooleanRBTreeMap(SortedMap<Long, Boolean> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Long, ? extends Boolean>)sortedMap);
    }

    public Long2BooleanRBTreeMap(Long2BooleanMap long2BooleanMap) {
        this();
        this.putAll(long2BooleanMap);
    }

    public Long2BooleanRBTreeMap(Long2BooleanSortedMap long2BooleanSortedMap) {
        this(long2BooleanSortedMap.comparator());
        this.putAll(long2BooleanSortedMap);
    }

    public Long2BooleanRBTreeMap(long[] lArray, boolean[] blArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2BooleanRBTreeMap(long[] lArray, boolean[] blArray) {
        this(lArray, blArray, null);
    }
    ...
    public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry>(this){
                final Comparator<? super Long2BooleanMap.Entry> comparator;
                final Long2BooleanRBTreeMap this$0;
                {
                    this.this$0 = long2BooleanRBTreeMap;
                ...
                public ObjectSortedSet<Long2BooleanMap.Entry> subSet(Long2BooleanMap.Entry entry, Long2BooleanMap.Entry entry2) {
                    return this.this$0.subMap(entry.getLongKey(), entry2.getLongKey()).long2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2BooleanMap.Entry> headSet(Long2BooleanMap.Entry entry) {
                    return this.this$0.headMap(entry.getLongKey()).long2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2BooleanMap.Entry> tailSet(Long2BooleanMap.Entry entry) {
                    return this.this$0.tailMap(entry.getLongKey()).long2BooleanEntrySet();
                }
                ...
                private int lambda$$0(Long2BooleanMap.Entry entry, Long2BooleanMap.Entry entry2) {
    ...
    public Long2BooleanRBTreeMap clone() {
        Long2BooleanRBTreeMap long2BooleanRBTreeMap;
        try {
            long2BooleanRBTreeMap = (Long2BooleanRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2BooleanRBTreeMap.keys = null;
        long2BooleanRBTreeMap.values = null;
        long2BooleanRBTreeMap.entries = null;
        long2BooleanRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2BooleanRBTreeMap.firstEntry = long2BooleanRBTreeMap.tree = entry2.left;
                            while (long2BooleanRBTreeMap.firstEntry.left != null) {
                                long2BooleanRBTreeMap.firstEntry = long2BooleanRBTreeMap.firstEntry.left;
                            }
                            long2BooleanRBTreeMap.lastEntry = long2BooleanRBTreeMap.tree;
                            while (long2BooleanRBTreeMap.lastEntry.right != null) {
                                long2BooleanRBTreeMap.lastEntry = long2BooleanRBTreeMap.lastEntry.right;
                            }
                            return long2BooleanRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Long2BooleanRBTreeMap long2BooleanRBTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2BooleanRBTreeMap;
            if (!bl && !bl2 && long2BooleanRBTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2BooleanRBTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Long2BooleanMap.Entry> comparator() {
                        return this.this$1.this$0.long2BooleanEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Long2BooleanMap.Entry> subSet(Long2BooleanMap.Entry entry, Long2BooleanMap.Entry entry2) {
                        return this.this$1.subMap(entry.getLongKey(), entry2.getLongKey()).long2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2BooleanMap.Entry> headSet(Long2BooleanMap.Entry entry) {
                        return this.this$1.headMap(entry.getLongKey()).long2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2BooleanMap.Entry> tailSet(Long2BooleanMap.Entry entry) {
                        return this.this$1.tailMap(entry.getLongKey()).long2BooleanEntrySet();
                    }
        ...
        public boolean put(long l, boolean bl) {
            ...
            boolean bl2 = this.this$0.put(l, bl);
        ...
        public boolean remove(long l) {
            ...
            boolean bl = this.this$0.remove(l);
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Long2BooleanRBTreeMap long2BooleanRBTreeMap) {
            this.this$0 = long2BooleanRBTreeMap;
            super(long2BooleanRBTreeMap);
        }
        ...
        ValueIterator(Long2BooleanRBTreeMap long2BooleanRBTreeMap, 1 var2_2) {
            this(long2BooleanRBTreeMap);
        }
    }
    ...
    extends AbstractLong2BooleanSortedMap.KeySet {
        ...
        private KeySet(Long2BooleanRBTreeMap long2BooleanRBTreeMap) {
            this.this$0 = long2BooleanRBTreeMap;
            super(long2BooleanRBTreeMap);
        }
        ...
        KeySet(Long2BooleanRBTreeMap long2BooleanRBTreeMap, 1 var2_2) {
            this(long2BooleanRBTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2BooleanRBTreeMap long2BooleanRBTreeMap) {
            this.this$0 = long2BooleanRBTreeMap;
            super(long2BooleanRBTreeMap);
        }

        public KeyIterator(Long2BooleanRBTreeMap long2BooleanRBTreeMap, long l) {
            this.this$0 = long2BooleanRBTreeMap;
            super(long2BooleanRBTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2BooleanMap.Entry> {
        ...
        EntryIterator(Long2BooleanRBTreeMap long2BooleanRBTreeMap) {
            this.this$0 = long2BooleanRBTreeMap;
            super(long2BooleanRBTreeMap);
        }

        EntryIterator(Long2BooleanRBTreeMap long2BooleanRBTreeMap, long l) {
            this.this$0 = long2BooleanRBTreeMap;
            super(long2BooleanRBTreeMap, l);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2BooleanRBTreeMap long2BooleanRBTreeMap) {
            this.this$0 = long2BooleanRBTreeMap;
            this.index = 0;
            this.next = long2BooleanRBTreeMap.firstEntry;
        }

        TreeIterator(Long2BooleanRBTreeMap long2BooleanRBTreeMap, long l) {
            this.this$0 = long2BooleanRBTreeMap;
            this.index = 0;
            this.next = long2BooleanRBTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2BooleanRBTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Long)entry.getKey() && this.value == (Boolean)entry.getValue();
        }
