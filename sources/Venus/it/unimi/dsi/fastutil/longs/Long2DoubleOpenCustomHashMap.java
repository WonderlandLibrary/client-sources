...
Hash {
    ...
    public Long2DoubleOpenCustomHashMap(int n, float f, LongHash.Strategy strategy) {
    ...
    public Long2DoubleOpenCustomHashMap(int n, LongHash.Strategy strategy) {
    ...
    public Long2DoubleOpenCustomHashMap(Map<? extends Long, ? extends Double> map, float f, LongHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Long2DoubleOpenCustomHashMap(Map<? extends Long, ? extends Double> map, LongHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Long2DoubleOpenCustomHashMap(Long2DoubleMap long2DoubleMap, float f, LongHash.Strategy strategy) {
        this(long2DoubleMap.size(), f, strategy);
        this.putAll(long2DoubleMap);
    }

    public Long2DoubleOpenCustomHashMap(Long2DoubleMap long2DoubleMap, LongHash.Strategy strategy) {
        this(long2DoubleMap, 0.75f, strategy);
    }

    public Long2DoubleOpenCustomHashMap(long[] lArray, double[] dArray, float f, LongHash.Strategy strategy) {
    ...
    public Long2DoubleOpenCustomHashMap(long[] lArray, double[] dArray, LongHash.Strategy strategy) {
        this(lArray, dArray, 0.75f, strategy);
    }
    ...
    public boolean remove(long l, double d) {
        ...
        if (this.strategy.equals(l, l2) && Double.doubleToLongBits(d) == Double.doubleToLongBits(this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((l2 = lArray[n = n + 1 & this.mask]) != 0L) continue;
            return true;
        } while (!this.strategy.equals(l, l2) || Double.doubleToLongBits(d) != Double.doubleToLongBits(this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(this){
                final Long2DoubleOpenCustomHashMap this$0;
                {
                    this.this$0 = long2DoubleOpenCustomHashMap;
                }
    ...
    public Long2DoubleOpenCustomHashMap clone() {
        Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap;
        try {
            long2DoubleOpenCustomHashMap = (Long2DoubleOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2DoubleOpenCustomHashMap.keys = null;
        long2DoubleOpenCustomHashMap.values = null;
        long2DoubleOpenCustomHashMap.entries = null;
        long2DoubleOpenCustomHashMap.containsNullKey = this.containsNullKey;
        long2DoubleOpenCustomHashMap.key = (long[])this.key.clone();
        long2DoubleOpenCustomHashMap.value = (double[])this.value.clone();
        long2DoubleOpenCustomHashMap.strategy = this.strategy;
        return long2DoubleOpenCustomHashMap;
    }
    ...
    static double access$300(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap) {
        return long2DoubleOpenCustomHashMap.removeNullEntry();
    }

    static double access$400(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap, int n) {
        return long2DoubleOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements DoubleIterator {
        ...
        public ValueIterator(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap) {
            this.this$0 = long2DoubleOpenCustomHashMap;
            super(long2DoubleOpenCustomHashMap, null);
        }
    ...
    extends AbstractLongSet {
        ...
        private KeySet(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap) {
            this.this$0 = long2DoubleOpenCustomHashMap;
        }
        ...
        KeySet(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap, 1 var2_2) {
            this(long2DoubleOpenCustomHashMap);
        }
    }
    ...
    implements LongIterator {
        ...
        public KeyIterator(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap) {
            this.this$0 = long2DoubleOpenCustomHashMap;
            super(long2DoubleOpenCustomHashMap, null);
        }
    ...
    implements Long2DoubleMap.FastEntrySet {
        ...
        private MapEntrySet(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap) {
            this.this$0 = long2DoubleOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(l, 0L)) {
                if (this.this$0.containsNullKey && Double.doubleToLongBits(this.this$0.value[this.this$0.n]) == Double.doubleToLongBits(d)) {
                    Long2DoubleOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(l2, l)) {
                if (Double.doubleToLongBits(this.this$0.value[n]) == Double.doubleToLongBits(d)) {
                    Long2DoubleOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((l2 = lArray[n = n + 1 & this.this$0.mask]) != 0L) continue;
                return true;
            } while (!this.this$0.strategy.equals(l2, l) || Double.doubleToLongBits(this.this$0.value[n]) != Double.doubleToLongBits(d));
            Long2DoubleOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap, 1 var2_2) {
            this(long2DoubleOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2DoubleMap.Entry> {
        ...
        private FastEntryIterator(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap) {
            this.this$0 = long2DoubleOpenCustomHashMap;
            super(long2DoubleOpenCustomHashMap, null);
        ...
        FastEntryIterator(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap, 1 var2_2) {
            this(long2DoubleOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2DoubleMap.Entry> {
        ...
        private EntryIterator(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap) {
            this.this$0 = long2DoubleOpenCustomHashMap;
            super(long2DoubleOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap, 1 var2_2) {
            this(long2DoubleOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap) {
            this.this$0 = long2DoubleOpenCustomHashMap;
        ...
        MapIterator(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap, 1 var2_2) {
            this(long2DoubleOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Long, Double> {
        ...
        MapEntry(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap, int n) {
            this.this$0 = long2DoubleOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Long2DoubleOpenCustomHashMap long2DoubleOpenCustomHashMap) {
            this.this$0 = long2DoubleOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Long)entry.getKey()) && Double.doubleToLongBits(this.this$0.value[this.index]) == Double.doubleToLongBits((Double)entry.getValue());
        }
