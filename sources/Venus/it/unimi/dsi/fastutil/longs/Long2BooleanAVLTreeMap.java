...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Long2BooleanAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Long2BooleanAVLTreeMap(long[] lArray, boolean[] blArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2BooleanAVLTreeMap(long[] lArray, boolean[] blArray) {
    ...
    public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry>(this){
                ...
                final Long2BooleanAVLTreeMap this$0;
                {
                    this.this$0 = long2BooleanAVLTreeMap;
    ...
    public Long2BooleanAVLTreeMap clone() {
        Long2BooleanAVLTreeMap long2BooleanAVLTreeMap;
        try {
            long2BooleanAVLTreeMap = (Long2BooleanAVLTreeMap)super.clone();
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2BooleanAVLTreeMap.firstEntry = long2BooleanAVLTreeMap.tree = entry2.left;
    ...
    implements Serializable {
        ...
        public Submap(Long2BooleanAVLTreeMap long2BooleanAVLTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2BooleanAVLTreeMap;
            if (!bl && !bl2 && long2BooleanAVLTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2BooleanAVLTreeMap.defRetValue;
        }
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Long2BooleanAVLTreeMap long2BooleanAVLTreeMap) {
            this.this$0 = long2BooleanAVLTreeMap;
            super(long2BooleanAVLTreeMap);
        }
        ...
        ValueIterator(Long2BooleanAVLTreeMap long2BooleanAVLTreeMap, 1 var2_2) {
            this(long2BooleanAVLTreeMap);
        }
    }
    ...
    extends AbstractLong2BooleanSortedMap.KeySet {
        ...
        private KeySet(Long2BooleanAVLTreeMap long2BooleanAVLTreeMap) {
            this.this$0 = long2BooleanAVLTreeMap;
            super(long2BooleanAVLTreeMap);
        }
        ...
        KeySet(Long2BooleanAVLTreeMap long2BooleanAVLTreeMap, 1 var2_2) {
            this(long2BooleanAVLTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2BooleanAVLTreeMap long2BooleanAVLTreeMap) {
            this.this$0 = long2BooleanAVLTreeMap;
            super(long2BooleanAVLTreeMap);
        }

        public KeyIterator(Long2BooleanAVLTreeMap long2BooleanAVLTreeMap, long l) {
            this.this$0 = long2BooleanAVLTreeMap;
            super(long2BooleanAVLTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2BooleanMap.Entry> {
        ...
        EntryIterator(Long2BooleanAVLTreeMap long2BooleanAVLTreeMap) {
            this.this$0 = long2BooleanAVLTreeMap;
            super(long2BooleanAVLTreeMap);
        }

        EntryIterator(Long2BooleanAVLTreeMap long2BooleanAVLTreeMap, long l) {
            this.this$0 = long2BooleanAVLTreeMap;
            super(long2BooleanAVLTreeMap, l);
        }
        ...
        public void add(Object object) {
            this.add((Long2BooleanMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Long2BooleanMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2BooleanAVLTreeMap long2BooleanAVLTreeMap) {
            this.this$0 = long2BooleanAVLTreeMap;
            this.index = 0;
            this.next = long2BooleanAVLTreeMap.firstEntry;
        }

        TreeIterator(Long2BooleanAVLTreeMap long2BooleanAVLTreeMap, long l) {
            this.this$0 = long2BooleanAVLTreeMap;
            this.index = 0;
            this.next = long2BooleanAVLTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2BooleanAVLTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
