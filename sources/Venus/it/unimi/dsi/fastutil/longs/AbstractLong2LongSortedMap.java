...
implements Long2LongSortedMap {
    ...
    implements LongIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Long2LongMap.Entry> objectBidirectionalIterator) {
    ...
    extends AbstractLongCollection {
        final AbstractLong2LongSortedMap this$0;

        protected ValuesCollection(AbstractLong2LongSortedMap abstractLong2LongSortedMap) {
            this.this$0 = abstractLong2LongSortedMap;
        }

        @Override
        public LongIterator iterator() {
            return new ValuesIterator(Long2LongSortedMaps.fastIterator(this.this$0));
        }
    ...
    implements LongBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Long2LongMap.Entry> objectBidirectionalIterator) {
            this.i = objectBidirectionalIterator;
        }
    ...
    extends AbstractLongSortedSet {
        ...
        protected KeySet(AbstractLong2LongSortedMap abstractLong2LongSortedMap) {
            this.this$0 = abstractLong2LongSortedMap;
        }
        ...
        public LongBidirectionalIterator iterator(long l) {
            return new KeySetIterator(this.this$0.long2LongEntrySet().iterator(new AbstractLong2LongMap.BasicEntry(l, 0L)));
        }

        @Override
        public LongBidirectionalIterator iterator() {
            return new KeySetIterator(Long2LongSortedMaps.fastIterator(this.this$0));
        }
