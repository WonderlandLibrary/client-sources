...
Cloneable {
    ...
    public Long2CharRBTreeMap(Comparator<? super Long> comparator) {
        this();
    ...
    public Long2CharRBTreeMap(SortedMap<Long, Character> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Long, ? extends Character>)sortedMap);
    }

    public Long2CharRBTreeMap(Long2CharMap long2CharMap) {
        this();
        this.putAll(long2CharMap);
    }

    public Long2CharRBTreeMap(Long2CharSortedMap long2CharSortedMap) {
        this(long2CharSortedMap.comparator());
        this.putAll(long2CharSortedMap);
    }

    public Long2CharRBTreeMap(long[] lArray, char[] cArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2CharRBTreeMap(long[] lArray, char[] cArray) {
    ...
    public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2CharMap.Entry>(this){
                ...
                final Long2CharRBTreeMap this$0;
                {
                    this.this$0 = long2CharRBTreeMap;
    ...
    public Long2CharRBTreeMap clone() {
        Long2CharRBTreeMap long2CharRBTreeMap;
        try {
            long2CharRBTreeMap = (Long2CharRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2CharRBTreeMap.keys = null;
        long2CharRBTreeMap.values = null;
        long2CharRBTreeMap.entries = null;
        long2CharRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2CharRBTreeMap.firstEntry = long2CharRBTreeMap.tree = entry2.left;
                            while (long2CharRBTreeMap.firstEntry.left != null) {
                                long2CharRBTreeMap.firstEntry = long2CharRBTreeMap.firstEntry.left;
                            }
                            long2CharRBTreeMap.lastEntry = long2CharRBTreeMap.tree;
                            while (long2CharRBTreeMap.lastEntry.right != null) {
                                long2CharRBTreeMap.lastEntry = long2CharRBTreeMap.lastEntry.right;
                            }
                            return long2CharRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Long2CharRBTreeMap long2CharRBTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2CharRBTreeMap;
            if (!bl && !bl2 && long2CharRBTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2CharRBTreeMap.defRetValue;
        }
    ...
    implements CharListIterator {
        ...
        private ValueIterator(Long2CharRBTreeMap long2CharRBTreeMap) {
            this.this$0 = long2CharRBTreeMap;
            super(long2CharRBTreeMap);
        }
        ...
        ValueIterator(Long2CharRBTreeMap long2CharRBTreeMap, 1 var2_2) {
            this(long2CharRBTreeMap);
        }
    }
    ...
    extends AbstractLong2CharSortedMap.KeySet {
        ...
        private KeySet(Long2CharRBTreeMap long2CharRBTreeMap) {
            this.this$0 = long2CharRBTreeMap;
            super(long2CharRBTreeMap);
        }
        ...
        KeySet(Long2CharRBTreeMap long2CharRBTreeMap, 1 var2_2) {
            this(long2CharRBTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2CharRBTreeMap long2CharRBTreeMap) {
            this.this$0 = long2CharRBTreeMap;
            super(long2CharRBTreeMap);
        }

        public KeyIterator(Long2CharRBTreeMap long2CharRBTreeMap, long l) {
            this.this$0 = long2CharRBTreeMap;
            super(long2CharRBTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2CharMap.Entry> {
        ...
        EntryIterator(Long2CharRBTreeMap long2CharRBTreeMap) {
            this.this$0 = long2CharRBTreeMap;
            super(long2CharRBTreeMap);
        }

        EntryIterator(Long2CharRBTreeMap long2CharRBTreeMap, long l) {
            this.this$0 = long2CharRBTreeMap;
            super(long2CharRBTreeMap, l);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2CharRBTreeMap long2CharRBTreeMap) {
            this.this$0 = long2CharRBTreeMap;
            this.index = 0;
            this.next = long2CharRBTreeMap.firstEntry;
        }

        TreeIterator(Long2CharRBTreeMap long2CharRBTreeMap, long l) {
            this.this$0 = long2CharRBTreeMap;
            this.index = 0;
            this.next = long2CharRBTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2CharRBTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
