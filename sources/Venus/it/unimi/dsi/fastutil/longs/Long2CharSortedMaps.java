...
public final class Long2CharSortedMaps {
    ...
    public static Comparator<? super Map.Entry<Long, ?>> entryComparator(LongComparator longComparator) {
        return (arg_0, arg_1) -> Long2CharSortedMaps.lambda$entryComparator$0(longComparator, arg_0, arg_1);
    }

    public static ObjectBidirectionalIterator<Long2CharMap.Entry> fastIterator(Long2CharSortedMap long2CharSortedMap) {
        ObjectSet objectSet = long2CharSortedMap.long2CharEntrySet();
        return objectSet instanceof Long2CharSortedMap.FastSortedEntrySet ? ((Long2CharSortedMap.FastSortedEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }

    public static ObjectBidirectionalIterable<Long2CharMap.Entry> fastIterable(Long2CharSortedMap long2CharSortedMap) {
        ObjectSet objectSet = long2CharSortedMap.long2CharEntrySet();
        return objectSet instanceof Long2CharSortedMap.FastSortedEntrySet ? ((Long2CharSortedMap.FastSortedEntrySet)objectSet)::fastIterator : objectSet;
    }

    public static Long2CharSortedMap singleton(Long l, Character c) {
        return new Singleton(l, c.charValue());
    }

    public static Long2CharSortedMap singleton(Long l, Character c, LongComparator longComparator) {
        return new Singleton(l, c.charValue(), longComparator);
    }

    public static Long2CharSortedMap singleton(long l, char c) {
        return new Singleton(l, c);
    }

    public static Long2CharSortedMap singleton(long l, char c, LongComparator longComparator) {
        return new Singleton(l, c, longComparator);
    }

    public static Long2CharSortedMap synchronize(Long2CharSortedMap long2CharSortedMap) {
        return new SynchronizedSortedMap(long2CharSortedMap);
    }

    public static Long2CharSortedMap synchronize(Long2CharSortedMap long2CharSortedMap, Object object) {
        return new SynchronizedSortedMap(long2CharSortedMap, object);
    }

    public static Long2CharSortedMap unmodifiable(Long2CharSortedMap long2CharSortedMap) {
        return new UnmodifiableSortedMap(long2CharSortedMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableSortedMap(Long2CharSortedMap long2CharSortedMap) {
            super(long2CharSortedMap);
            this.sortedMap = long2CharSortedMap;
        }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Long2CharSortedMap long2CharSortedMap, Object object) {
            super(long2CharSortedMap, object);
            this.sortedMap = long2CharSortedMap;
        }

        protected SynchronizedSortedMap(Long2CharSortedMap long2CharSortedMap) {
            super(long2CharSortedMap);
            this.sortedMap = long2CharSortedMap;
        }
    ...
    Cloneable {
        ...
        protected Singleton(long l, char c, LongComparator longComparator) {
            super(l, c);
