...
Hash {
    ...
    public Long2FloatOpenCustomHashMap(int n, float f, LongHash.Strategy strategy) {
    ...
    public Long2FloatOpenCustomHashMap(int n, LongHash.Strategy strategy) {
    ...
    public Long2FloatOpenCustomHashMap(Map<? extends Long, ? extends Float> map, float f, LongHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Long2FloatOpenCustomHashMap(Map<? extends Long, ? extends Float> map, LongHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Long2FloatOpenCustomHashMap(Long2FloatMap long2FloatMap, float f, LongHash.Strategy strategy) {
        this(long2FloatMap.size(), f, strategy);
        this.putAll(long2FloatMap);
    }

    public Long2FloatOpenCustomHashMap(Long2FloatMap long2FloatMap, LongHash.Strategy strategy) {
        this(long2FloatMap, 0.75f, strategy);
    }

    public Long2FloatOpenCustomHashMap(long[] lArray, float[] fArray, float f, LongHash.Strategy strategy) {
    ...
    public Long2FloatOpenCustomHashMap(long[] lArray, float[] fArray, LongHash.Strategy strategy) {
        this(lArray, fArray, 0.75f, strategy);
    }
    ...
    public boolean remove(long l, float f) {
        ...
        if (this.strategy.equals(l, l2) && Float.floatToIntBits(f) == Float.floatToIntBits(this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((l2 = lArray[n = n + 1 & this.mask]) != 0L) continue;
            return true;
        } while (!this.strategy.equals(l, l2) || Float.floatToIntBits(f) != Float.floatToIntBits(this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public FloatCollection values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection(this){
                final Long2FloatOpenCustomHashMap this$0;
                {
                    this.this$0 = long2FloatOpenCustomHashMap;
                }
    ...
    public Long2FloatOpenCustomHashMap clone() {
        Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap;
        try {
            long2FloatOpenCustomHashMap = (Long2FloatOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2FloatOpenCustomHashMap.keys = null;
        long2FloatOpenCustomHashMap.values = null;
        long2FloatOpenCustomHashMap.entries = null;
        long2FloatOpenCustomHashMap.containsNullKey = this.containsNullKey;
        long2FloatOpenCustomHashMap.key = (long[])this.key.clone();
        long2FloatOpenCustomHashMap.value = (float[])this.value.clone();
        long2FloatOpenCustomHashMap.strategy = this.strategy;
        return long2FloatOpenCustomHashMap;
    }
    ...
    static float access$300(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap) {
        return long2FloatOpenCustomHashMap.removeNullEntry();
    }

    static float access$400(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap, int n) {
        return long2FloatOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements FloatIterator {
        ...
        public ValueIterator(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap) {
            this.this$0 = long2FloatOpenCustomHashMap;
            super(long2FloatOpenCustomHashMap, null);
        }
    ...
    extends AbstractLongSet {
        ...
        private KeySet(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap) {
            this.this$0 = long2FloatOpenCustomHashMap;
        }
        ...
        KeySet(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap, 1 var2_2) {
            this(long2FloatOpenCustomHashMap);
        }
    }
    ...
    implements LongIterator {
        ...
        public KeyIterator(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap) {
            this.this$0 = long2FloatOpenCustomHashMap;
            super(long2FloatOpenCustomHashMap, null);
        }
    ...
    implements Long2FloatMap.FastEntrySet {
        ...
        private MapEntrySet(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap) {
            this.this$0 = long2FloatOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(l, 0L)) {
                if (this.this$0.containsNullKey && Float.floatToIntBits(this.this$0.value[this.this$0.n]) == Float.floatToIntBits(f)) {
                    Long2FloatOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(l2, l)) {
                if (Float.floatToIntBits(this.this$0.value[n]) == Float.floatToIntBits(f)) {
                    Long2FloatOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((l2 = lArray[n = n + 1 & this.this$0.mask]) != 0L) continue;
                return true;
            } while (!this.this$0.strategy.equals(l2, l) || Float.floatToIntBits(this.this$0.value[n]) != Float.floatToIntBits(f));
            Long2FloatOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        public void forEach(Consumer<? super Long2FloatMap.Entry> consumer) {
            if (this.this$0.containsNullKey) {
                consumer.accept(new AbstractLong2FloatMap.BasicEntry(this.this$0.key[this.this$0.n], this.this$0.value[this.this$0.n]));
            }
            int n = this.this$0.n;
            while (n-- != 0) {
                if (this.this$0.key[n] == 0L) continue;
                consumer.accept(new AbstractLong2FloatMap.BasicEntry(this.this$0.key[n], this.this$0.value[n]));
            }
        }
        ...
        MapEntrySet(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap, 1 var2_2) {
            this(long2FloatOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2FloatMap.Entry> {
        ...
        private FastEntryIterator(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap) {
            this.this$0 = long2FloatOpenCustomHashMap;
            super(long2FloatOpenCustomHashMap, null);
        ...
        FastEntryIterator(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap, 1 var2_2) {
            this(long2FloatOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2FloatMap.Entry> {
        ...
        private EntryIterator(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap) {
            this.this$0 = long2FloatOpenCustomHashMap;
            super(long2FloatOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap, 1 var2_2) {
            this(long2FloatOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap) {
            this.this$0 = long2FloatOpenCustomHashMap;
        ...
        MapIterator(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap, 1 var2_2) {
            this(long2FloatOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Long, Float> {
        ...
        MapEntry(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap, int n) {
            this.this$0 = long2FloatOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Long2FloatOpenCustomHashMap long2FloatOpenCustomHashMap) {
            this.this$0 = long2FloatOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Long)entry.getKey()) && Float.floatToIntBits(this.this$0.value[this.index]) == Float.floatToIntBits(((Float)entry.getValue()).floatValue());
        }
