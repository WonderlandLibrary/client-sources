...
public final class Long2ReferenceFunctions {
    ...
    public static <V> Long2ReferenceFunction<V> singleton(long l, V v) {
    ...
    public static <V> Long2ReferenceFunction<V> synchronize(Long2ReferenceFunction<V> long2ReferenceFunction) {
        return new SynchronizedFunction<V>(long2ReferenceFunction);
    }

    public static <V> Long2ReferenceFunction<V> synchronize(Long2ReferenceFunction<V> long2ReferenceFunction, Object object) {
        return new SynchronizedFunction<V>(long2ReferenceFunction, object);
    }

    public static <V> Long2ReferenceFunction<V> unmodifiable(Long2ReferenceFunction<V> long2ReferenceFunction) {
        return new UnmodifiableFunction<V>(long2ReferenceFunction);
    }

    public static <V> Long2ReferenceFunction<V> primitive(java.util.function.Function<? super Long, ? extends V> function) {
        Objects.requireNonNull(function);
        if (function instanceof Long2ReferenceFunction) {
            return (Long2ReferenceFunction)function;
        }
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Long2ReferenceFunction<V> long2ReferenceFunction) {
            if (long2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = long2ReferenceFunction;
        }
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Long2ReferenceFunction<V> long2ReferenceFunction, Object object) {
            if (long2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = long2ReferenceFunction;
        ...
        protected SynchronizedFunction(Long2ReferenceFunction<V> long2ReferenceFunction) {
            if (long2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = long2ReferenceFunction;
