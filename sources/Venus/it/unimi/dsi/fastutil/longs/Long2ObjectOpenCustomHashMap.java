...
Hash {
    ...
    public Long2ObjectOpenCustomHashMap(int n, float f, LongHash.Strategy strategy) {
    ...
    public Long2ObjectOpenCustomHashMap(int n, LongHash.Strategy strategy) {
    ...
    public Long2ObjectOpenCustomHashMap(Map<? extends Long, ? extends V> map, float f, LongHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Long2ObjectOpenCustomHashMap(Map<? extends Long, ? extends V> map, LongHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Long2ObjectOpenCustomHashMap(Long2ObjectMap<V> long2ObjectMap, float f, LongHash.Strategy strategy) {
        this(long2ObjectMap.size(), f, strategy);
        this.putAll(long2ObjectMap);
    }

    public Long2ObjectOpenCustomHashMap(Long2ObjectMap<V> long2ObjectMap, LongHash.Strategy strategy) {
        this(long2ObjectMap, 0.75f, strategy);
    }

    public Long2ObjectOpenCustomHashMap(long[] lArray, V[] VArray, float f, LongHash.Strategy strategy) {
    ...
    public Long2ObjectOpenCustomHashMap(long[] lArray, V[] VArray, LongHash.Strategy strategy) {
    ...
    public boolean remove(long l, Object object) {
        ...
        if (this.strategy.equals(l, l2) && Objects.equals(object, this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((l2 = lArray[n = n + 1 & this.mask]) != 0L) continue;
            return true;
        } while (!this.strategy.equals(l, l2) || !Objects.equals(object, this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public ObjectCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(this){
                final Long2ObjectOpenCustomHashMap this$0;
                {
    ...
    public Long2ObjectOpenCustomHashMap<V> clone() {
        Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap;
        try {
            long2ObjectOpenCustomHashMap = (Long2ObjectOpenCustomHashMap)super.clone();
        ...
        long2ObjectOpenCustomHashMap.value = (Object[])this.value.clone();
    ...
    static Object access$300(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap) {
        return long2ObjectOpenCustomHashMap.removeNullEntry();
    }

    static Object access$400(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap, int n) {
        return long2ObjectOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap) {
            this.this$0 = long2ObjectOpenCustomHashMap;
            super(long2ObjectOpenCustomHashMap, null);
        }
    ...
    extends AbstractLongSet {
        ...
        private KeySet(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap) {
            this.this$0 = long2ObjectOpenCustomHashMap;
        }
        ...
        KeySet(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap, 1 var2_2) {
            this(long2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements LongIterator {
        ...
        public KeyIterator(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap) {
            this.this$0 = long2ObjectOpenCustomHashMap;
            super(long2ObjectOpenCustomHashMap, null);
        }
    ...
    implements Long2ObjectMap.FastEntrySet<V> {
        ...
        private MapEntrySet(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap) {
            this.this$0 = long2ObjectOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(l, 0L)) {
                if (this.this$0.containsNullKey && Objects.equals(this.this$0.value[this.this$0.n], v)) {
                    Long2ObjectOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(l2, l)) {
                if (Objects.equals(this.this$0.value[n], v)) {
                    Long2ObjectOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((l2 = lArray[n = n + 1 & this.this$0.mask]) != 0L) continue;
                return true;
            } while (!this.this$0.strategy.equals(l2, l) || !Objects.equals(this.this$0.value[n], v));
            Long2ObjectOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap, 1 var2_2) {
            this(long2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2ObjectMap.Entry<V>> {
        ...
        private FastEntryIterator(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap) {
            this.this$0 = long2ObjectOpenCustomHashMap;
            super(long2ObjectOpenCustomHashMap, null);
        ...
        FastEntryIterator(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap, 1 var2_2) {
            this(long2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2ObjectMap.Entry<V>> {
        ...
        private EntryIterator(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap) {
            this.this$0 = long2ObjectOpenCustomHashMap;
            super(long2ObjectOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap, 1 var2_2) {
            this(long2ObjectOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap) {
            this.this$0 = long2ObjectOpenCustomHashMap;
        ...
        MapIterator(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap, 1 var2_2) {
            this(long2ObjectOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Long, V> {
        ...
        MapEntry(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap, int n) {
            this.this$0 = long2ObjectOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Long2ObjectOpenCustomHashMap long2ObjectOpenCustomHashMap) {
            this.this$0 = long2ObjectOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Long)entry.getKey()) && Objects.equals(this.this$0.value[this.index], entry.getValue());
        }
