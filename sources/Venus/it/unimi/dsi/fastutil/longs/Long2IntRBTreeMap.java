...
Cloneable {
    ...
    public Long2IntRBTreeMap(Comparator<? super Long> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Long2IntRBTreeMap(Map<? extends Long, ? extends Integer> map) {
        this();
        this.putAll(map);
    }

    public Long2IntRBTreeMap(SortedMap<Long, Integer> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Long, ? extends Integer>)sortedMap);
    }

    public Long2IntRBTreeMap(Long2IntMap long2IntMap) {
        this();
        this.putAll(long2IntMap);
    }

    public Long2IntRBTreeMap(Long2IntSortedMap long2IntSortedMap) {
        this(long2IntSortedMap.comparator());
        this.putAll(long2IntSortedMap);
    }

    public Long2IntRBTreeMap(long[] lArray, int[] nArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2IntRBTreeMap(long[] lArray, int[] nArray) {
    ...
    public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2IntMap.Entry>(this){
                ...
                final Long2IntRBTreeMap this$0;
                {
                    this.this$0 = long2IntRBTreeMap;
    ...
    public Long2IntRBTreeMap clone() {
        Long2IntRBTreeMap long2IntRBTreeMap;
        try {
            long2IntRBTreeMap = (Long2IntRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2IntRBTreeMap.keys = null;
        long2IntRBTreeMap.values = null;
        long2IntRBTreeMap.entries = null;
        long2IntRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2IntRBTreeMap.firstEntry = long2IntRBTreeMap.tree = entry2.left;
                            while (long2IntRBTreeMap.firstEntry.left != null) {
                                long2IntRBTreeMap.firstEntry = long2IntRBTreeMap.firstEntry.left;
                            }
                            long2IntRBTreeMap.lastEntry = long2IntRBTreeMap.tree;
                            while (long2IntRBTreeMap.lastEntry.right != null) {
                                long2IntRBTreeMap.lastEntry = long2IntRBTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Long2IntRBTreeMap long2IntRBTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2IntRBTreeMap;
            if (!bl && !bl2 && long2IntRBTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2IntRBTreeMap.defRetValue;
        }
    ...
    implements IntListIterator {
        ...
        private ValueIterator(Long2IntRBTreeMap long2IntRBTreeMap) {
            this.this$0 = long2IntRBTreeMap;
            super(long2IntRBTreeMap);
        }
        ...
        ValueIterator(Long2IntRBTreeMap long2IntRBTreeMap, 1 var2_2) {
            this(long2IntRBTreeMap);
        }
    }
    ...
    extends AbstractLong2IntSortedMap.KeySet {
        ...
        private KeySet(Long2IntRBTreeMap long2IntRBTreeMap) {
            this.this$0 = long2IntRBTreeMap;
            super(long2IntRBTreeMap);
        }
        ...
        KeySet(Long2IntRBTreeMap long2IntRBTreeMap, 1 var2_2) {
            this(long2IntRBTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2IntRBTreeMap long2IntRBTreeMap) {
            this.this$0 = long2IntRBTreeMap;
            super(long2IntRBTreeMap);
        }

        public KeyIterator(Long2IntRBTreeMap long2IntRBTreeMap, long l) {
            this.this$0 = long2IntRBTreeMap;
            super(long2IntRBTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2IntMap.Entry> {
        ...
        EntryIterator(Long2IntRBTreeMap long2IntRBTreeMap) {
            this.this$0 = long2IntRBTreeMap;
            super(long2IntRBTreeMap);
        }

        EntryIterator(Long2IntRBTreeMap long2IntRBTreeMap, long l) {
            this.this$0 = long2IntRBTreeMap;
            super(long2IntRBTreeMap, l);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2IntRBTreeMap long2IntRBTreeMap) {
            this.this$0 = long2IntRBTreeMap;
            this.index = 0;
            this.next = long2IntRBTreeMap.firstEntry;
        }

        TreeIterator(Long2IntRBTreeMap long2IntRBTreeMap, long l) {
            this.this$0 = long2IntRBTreeMap;
            this.index = 0;
            this.next = long2IntRBTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2IntRBTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
