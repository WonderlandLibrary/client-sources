...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Long2ByteAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Long2ByteAVLTreeMap(Comparator<? super Long> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Long2ByteAVLTreeMap(Map<? extends Long, ? extends Byte> map) {
        this();
        this.putAll(map);
    }

    public Long2ByteAVLTreeMap(SortedMap<Long, Byte> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Long, ? extends Byte>)sortedMap);
    }

    public Long2ByteAVLTreeMap(Long2ByteMap long2ByteMap) {
        this();
        this.putAll(long2ByteMap);
    }

    public Long2ByteAVLTreeMap(Long2ByteSortedMap long2ByteSortedMap) {
        this(long2ByteSortedMap.comparator());
        this.putAll(long2ByteSortedMap);
    }

    public Long2ByteAVLTreeMap(long[] lArray, byte[] byArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2ByteAVLTreeMap(long[] lArray, byte[] byArray) {
        this(lArray, byArray, null);
    }
    ...
    public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>(this){
                final Comparator<? super Long2ByteMap.Entry> comparator;
                final Long2ByteAVLTreeMap this$0;
                {
                    this.this$0 = long2ByteAVLTreeMap;
                ...
                public ObjectSortedSet<Long2ByteMap.Entry> subSet(Long2ByteMap.Entry entry, Long2ByteMap.Entry entry2) {
                    return this.this$0.subMap(entry.getLongKey(), entry2.getLongKey()).long2ByteEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2ByteMap.Entry> headSet(Long2ByteMap.Entry entry) {
                    return this.this$0.headMap(entry.getLongKey()).long2ByteEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2ByteMap.Entry> tailSet(Long2ByteMap.Entry entry) {
                    return this.this$0.tailMap(entry.getLongKey()).long2ByteEntrySet();
                }
                ...
                private int lambda$$0(Long2ByteMap.Entry entry, Long2ByteMap.Entry entry2) {
    ...
    public Long2ByteAVLTreeMap clone() {
        Long2ByteAVLTreeMap long2ByteAVLTreeMap;
        try {
            long2ByteAVLTreeMap = (Long2ByteAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2ByteAVLTreeMap.keys = null;
        long2ByteAVLTreeMap.values = null;
        long2ByteAVLTreeMap.entries = null;
        long2ByteAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2ByteAVLTreeMap.firstEntry = long2ByteAVLTreeMap.tree = entry2.left;
                            while (long2ByteAVLTreeMap.firstEntry.left != null) {
                                long2ByteAVLTreeMap.firstEntry = long2ByteAVLTreeMap.firstEntry.left;
                            }
                            long2ByteAVLTreeMap.lastEntry = long2ByteAVLTreeMap.tree;
                            while (long2ByteAVLTreeMap.lastEntry.right != null) {
                                long2ByteAVLTreeMap.lastEntry = long2ByteAVLTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Long2ByteAVLTreeMap long2ByteAVLTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2ByteAVLTreeMap;
            if (!bl && !bl2 && long2ByteAVLTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2ByteAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Long2ByteMap.Entry> comparator() {
                        return this.this$1.this$0.long2ByteEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Long2ByteMap.Entry> subSet(Long2ByteMap.Entry entry, Long2ByteMap.Entry entry2) {
                        return this.this$1.subMap(entry.getLongKey(), entry2.getLongKey()).long2ByteEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2ByteMap.Entry> headSet(Long2ByteMap.Entry entry) {
                        return this.this$1.headMap(entry.getLongKey()).long2ByteEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2ByteMap.Entry> tailSet(Long2ByteMap.Entry entry) {
                        return this.this$1.tailMap(entry.getLongKey()).long2ByteEntrySet();
                    }
    ...
    implements ByteListIterator {
        ...
        private ValueIterator(Long2ByteAVLTreeMap long2ByteAVLTreeMap) {
            this.this$0 = long2ByteAVLTreeMap;
            super(long2ByteAVLTreeMap);
        }
        ...
        ValueIterator(Long2ByteAVLTreeMap long2ByteAVLTreeMap, 1 var2_2) {
            this(long2ByteAVLTreeMap);
        }
    }
    ...
    extends AbstractLong2ByteSortedMap.KeySet {
        ...
        private KeySet(Long2ByteAVLTreeMap long2ByteAVLTreeMap) {
            this.this$0 = long2ByteAVLTreeMap;
            super(long2ByteAVLTreeMap);
        }
        ...
        KeySet(Long2ByteAVLTreeMap long2ByteAVLTreeMap, 1 var2_2) {
            this(long2ByteAVLTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2ByteAVLTreeMap long2ByteAVLTreeMap) {
            this.this$0 = long2ByteAVLTreeMap;
            super(long2ByteAVLTreeMap);
        }

        public KeyIterator(Long2ByteAVLTreeMap long2ByteAVLTreeMap, long l) {
            this.this$0 = long2ByteAVLTreeMap;
            super(long2ByteAVLTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2ByteMap.Entry> {
        ...
        EntryIterator(Long2ByteAVLTreeMap long2ByteAVLTreeMap) {
            this.this$0 = long2ByteAVLTreeMap;
            super(long2ByteAVLTreeMap);
        }

        EntryIterator(Long2ByteAVLTreeMap long2ByteAVLTreeMap, long l) {
            this.this$0 = long2ByteAVLTreeMap;
            super(long2ByteAVLTreeMap, l);
        }
        ...
        public void add(Object object) {
            this.add((Long2ByteMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Long2ByteMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2ByteAVLTreeMap long2ByteAVLTreeMap) {
            this.this$0 = long2ByteAVLTreeMap;
            this.index = 0;
            this.next = long2ByteAVLTreeMap.firstEntry;
        }

        TreeIterator(Long2ByteAVLTreeMap long2ByteAVLTreeMap, long l) {
            this.this$0 = long2ByteAVLTreeMap;
            this.index = 0;
            this.next = long2ByteAVLTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2ByteAVLTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Long)entry.getKey() && this.value == (Byte)entry.getValue();
        }
