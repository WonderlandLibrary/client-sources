...
Serializable {
    ...
    public boolean containsKey(long l) {
        Iterator iterator2 = this.long2LongEntrySet().iterator();
        while (iterator2.hasNext()) {
            if (((Long2LongMap.Entry)iterator2.next()).getLongKey() != l) continue;
            return false;
        }
        return true;
    }
    ...
    public LongSet keySet() {
        return new AbstractLongSet(this){
            final AbstractLong2LongMap this$0;
            {
                this.this$0 = abstractLong2LongMap;
            }
            ...
            public LongIterator iterator() {
                return new LongIterator(this){
                    ...
                    {
                        this.this$1 = var1_1;
                        this.i = Long2LongMaps.fastIterator(this.this$1.this$0);
                    }
    ...
    public void putAll(Map<? extends Long, ? extends Long> map) {
        if (map instanceof Long2LongMap) {
            ObjectIterator<Long2LongMap.Entry> objectIterator = Long2LongMaps.fastIterator((Long2LongMap)map);
            while (objectIterator.hasNext()) {
                Long2LongMap.Entry entry = (Long2LongMap.Entry)objectIterator.next();
                this.put(entry.getLongKey(), entry.getLongValue());
            }
        } else {
            int n = map.size();
            Iterator<Map.Entry<? extends Long, ? extends Long>> iterator2 = map.entrySet().iterator();
            while (n-- != 0) {
                Map.Entry<? extends Long, ? extends Long> entry = iterator2.next();
    ...
    public int hashCode() {
        int n = 0;
        int n2 = this.size();
        ObjectIterator<Long2LongMap.Entry> objectIterator = Long2LongMaps.fastIterator(this);
        while (n2-- != 0) {
            n += ((Long2LongMap.Entry)objectIterator.next()).hashCode();
        }
        return n;
    }
    ...
    public boolean equals(Object object) {
        ...
        return this.long2LongEntrySet().containsAll(map.entrySet());
    }
    ...
    extends AbstractObjectSet<Long2LongMap.Entry> {
        ...
        public BasicEntrySet(Long2LongMap long2LongMap) {
        ...
        public boolean contains(Object object) {
            ...
            if (object instanceof Long2LongMap.Entry) {
                Long2LongMap.Entry entry = (Long2LongMap.Entry)object;
                long l = entry.getLongKey();
                return this.map.containsKey(l) && this.map.get(l) == entry.getLongValue();
            }
            ...
            return this.map.containsKey(l) && this.map.get(l) == ((Long)v).longValue();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (object instanceof Long2LongMap.Entry) {
                Long2LongMap.Entry entry = (Long2LongMap.Entry)object;
                return this.map.remove(entry.getLongKey(), entry.getLongValue());
            }
            Map.Entry entry = (Map.Entry)object;
            Object k = entry.getKey();
            if (k == null || !(k instanceof Long)) {
    ...
    implements Long2LongMap.Entry {
        ...
        public boolean equals(Object object) {
            ...
            return this.key == (Long)k && this.value == (Long)v;
        }
