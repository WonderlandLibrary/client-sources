...
Cloneable {
    ...
    public Long2FloatRBTreeMap(long[] lArray, float[] fArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2FloatRBTreeMap(long[] lArray, float[] fArray) {
    ...
    public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>(this){
                ...
                final Long2FloatRBTreeMap this$0;
                {
                    this.this$0 = long2FloatRBTreeMap;
    ...
    public Long2FloatRBTreeMap clone() {
        Long2FloatRBTreeMap long2FloatRBTreeMap;
        try {
            long2FloatRBTreeMap = (Long2FloatRBTreeMap)super.clone();
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2FloatRBTreeMap.firstEntry = long2FloatRBTreeMap.tree = entry2.left;
    ...
    implements Serializable {
        ...
        public Submap(Long2FloatRBTreeMap long2FloatRBTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2FloatRBTreeMap;
            if (!bl && !bl2 && long2FloatRBTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2FloatRBTreeMap.defRetValue;
        }
    ...
    implements FloatListIterator {
        ...
        private ValueIterator(Long2FloatRBTreeMap long2FloatRBTreeMap) {
            this.this$0 = long2FloatRBTreeMap;
            super(long2FloatRBTreeMap);
        }
        ...
        ValueIterator(Long2FloatRBTreeMap long2FloatRBTreeMap, 1 var2_2) {
            this(long2FloatRBTreeMap);
        }
    }
    ...
    extends AbstractLong2FloatSortedMap.KeySet {
        ...
        private KeySet(Long2FloatRBTreeMap long2FloatRBTreeMap) {
            this.this$0 = long2FloatRBTreeMap;
            super(long2FloatRBTreeMap);
        }
        ...
        KeySet(Long2FloatRBTreeMap long2FloatRBTreeMap, 1 var2_2) {
            this(long2FloatRBTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2FloatRBTreeMap long2FloatRBTreeMap) {
            this.this$0 = long2FloatRBTreeMap;
            super(long2FloatRBTreeMap);
        }

        public KeyIterator(Long2FloatRBTreeMap long2FloatRBTreeMap, long l) {
            this.this$0 = long2FloatRBTreeMap;
            super(long2FloatRBTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2FloatMap.Entry> {
        ...
        EntryIterator(Long2FloatRBTreeMap long2FloatRBTreeMap) {
            this.this$0 = long2FloatRBTreeMap;
            super(long2FloatRBTreeMap);
        }

        EntryIterator(Long2FloatRBTreeMap long2FloatRBTreeMap, long l) {
            this.this$0 = long2FloatRBTreeMap;
            super(long2FloatRBTreeMap, l);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2FloatRBTreeMap long2FloatRBTreeMap) {
            this.this$0 = long2FloatRBTreeMap;
            this.index = 0;
            this.next = long2FloatRBTreeMap.firstEntry;
        }

        TreeIterator(Long2FloatRBTreeMap long2FloatRBTreeMap, long l) {
            this.this$0 = long2FloatRBTreeMap;
            this.index = 0;
            this.next = long2FloatRBTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2FloatRBTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
