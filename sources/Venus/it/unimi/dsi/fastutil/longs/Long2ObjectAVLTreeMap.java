...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Long2ObjectAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Long2ObjectAVLTreeMap(Long2ObjectMap<? extends V> long2ObjectMap) {
        this();
        this.putAll(long2ObjectMap);
    }

    public Long2ObjectAVLTreeMap(Long2ObjectSortedMap<V> long2ObjectSortedMap) {
        this(long2ObjectSortedMap.comparator());
        this.putAll(long2ObjectSortedMap);
    }

    public Long2ObjectAVLTreeMap(long[] lArray, V[] VArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2ObjectAVLTreeMap(long[] lArray, V[] VArray) {
    ...
    public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>(this){
                ...
                final Long2ObjectAVLTreeMap this$0;
                {
                    this.this$0 = long2ObjectAVLTreeMap;
    ...
    public Long2ObjectAVLTreeMap<V> clone() {
        ...
        try {
            long2ObjectAVLTreeMap = (Long2ObjectAVLTreeMap)super.clone();
        ...
        long2ObjectAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2ObjectAVLTreeMap.tree = entry2.left;
                            long2ObjectAVLTreeMap.firstEntry = long2ObjectAVLTreeMap.tree;
                            while (long2ObjectAVLTreeMap.firstEntry.left != null) {
                                long2ObjectAVLTreeMap.firstEntry = long2ObjectAVLTreeMap.firstEntry.left;
                            }
                            long2ObjectAVLTreeMap.lastEntry = long2ObjectAVLTreeMap.tree;
                            while (long2ObjectAVLTreeMap.lastEntry.right != null) {
                                long2ObjectAVLTreeMap.lastEntry = long2ObjectAVLTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Long2ObjectAVLTreeMap long2ObjectAVLTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2ObjectAVLTreeMap;
            if (!bl && !bl2 && long2ObjectAVLTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2ObjectAVLTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Long2ObjectAVLTreeMap long2ObjectAVLTreeMap) {
            this.this$0 = long2ObjectAVLTreeMap;
            super(long2ObjectAVLTreeMap);
        }
        ...
        ValueIterator(Long2ObjectAVLTreeMap long2ObjectAVLTreeMap, 1 var2_2) {
            this(long2ObjectAVLTreeMap);
        }
    }
    ...
    extends AbstractLong2ObjectSortedMap.KeySet {
        ...
        private KeySet(Long2ObjectAVLTreeMap long2ObjectAVLTreeMap) {
            this.this$0 = long2ObjectAVLTreeMap;
            super(long2ObjectAVLTreeMap);
        }
        ...
        KeySet(Long2ObjectAVLTreeMap long2ObjectAVLTreeMap, 1 var2_2) {
            this(long2ObjectAVLTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2ObjectAVLTreeMap long2ObjectAVLTreeMap) {
            this.this$0 = long2ObjectAVLTreeMap;
            super(long2ObjectAVLTreeMap);
        }

        public KeyIterator(Long2ObjectAVLTreeMap long2ObjectAVLTreeMap, long l) {
            this.this$0 = long2ObjectAVLTreeMap;
            super(long2ObjectAVLTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2ObjectMap.Entry<V>> {
        ...
        EntryIterator(Long2ObjectAVLTreeMap long2ObjectAVLTreeMap) {
            this.this$0 = long2ObjectAVLTreeMap;
            super(long2ObjectAVLTreeMap);
        }

        EntryIterator(Long2ObjectAVLTreeMap long2ObjectAVLTreeMap, long l) {
            this.this$0 = long2ObjectAVLTreeMap;
            super(long2ObjectAVLTreeMap, l);
        }
        ...
        public void add(Object object) {
            this.add((Long2ObjectMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Long2ObjectMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2ObjectAVLTreeMap long2ObjectAVLTreeMap) {
            this.this$0 = long2ObjectAVLTreeMap;
            this.index = 0;
            this.next = long2ObjectAVLTreeMap.firstEntry;
        }

        TreeIterator(Long2ObjectAVLTreeMap long2ObjectAVLTreeMap, long l) {
            this.this$0 = long2ObjectAVLTreeMap;
            this.index = 0;
            this.next = long2ObjectAVLTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2ObjectAVLTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
