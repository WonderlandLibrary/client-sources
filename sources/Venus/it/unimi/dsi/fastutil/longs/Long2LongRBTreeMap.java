...
Cloneable {
    ...
    public Long2LongRBTreeMap(Long2LongMap long2LongMap) {
        this();
        this.putAll(long2LongMap);
    }

    public Long2LongRBTreeMap(Long2LongSortedMap long2LongSortedMap) {
        this(long2LongSortedMap.comparator());
        this.putAll(long2LongSortedMap);
    }

    public Long2LongRBTreeMap(long[] lArray, long[] lArray2, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2LongRBTreeMap(long[] lArray, long[] lArray2) {
    ...
    public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2LongMap.Entry>(this){
                ...
                final Long2LongRBTreeMap this$0;
                {
                    this.this$0 = long2LongRBTreeMap;
    ...
    public Long2LongRBTreeMap clone() {
        Long2LongRBTreeMap long2LongRBTreeMap;
        try {
            long2LongRBTreeMap = (Long2LongRBTreeMap)super.clone();
        ...
        long2LongRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2LongRBTreeMap.firstEntry = long2LongRBTreeMap.tree = entry2.left;
                            while (long2LongRBTreeMap.firstEntry.left != null) {
                                long2LongRBTreeMap.firstEntry = long2LongRBTreeMap.firstEntry.left;
                            }
                            long2LongRBTreeMap.lastEntry = long2LongRBTreeMap.tree;
                            while (long2LongRBTreeMap.lastEntry.right != null) {
                                long2LongRBTreeMap.lastEntry = long2LongRBTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Long2LongRBTreeMap long2LongRBTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2LongRBTreeMap;
            if (!bl && !bl2 && long2LongRBTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2LongRBTreeMap.defRetValue;
        }
    ...
    implements LongListIterator {
        ...
        private ValueIterator(Long2LongRBTreeMap long2LongRBTreeMap) {
            this.this$0 = long2LongRBTreeMap;
            super(long2LongRBTreeMap);
        }
        ...
        ValueIterator(Long2LongRBTreeMap long2LongRBTreeMap, 1 var2_2) {
            this(long2LongRBTreeMap);
        }
    }
    ...
    extends AbstractLong2LongSortedMap.KeySet {
        ...
        private KeySet(Long2LongRBTreeMap long2LongRBTreeMap) {
            this.this$0 = long2LongRBTreeMap;
            super(long2LongRBTreeMap);
        }
        ...
        KeySet(Long2LongRBTreeMap long2LongRBTreeMap, 1 var2_2) {
            this(long2LongRBTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2LongRBTreeMap long2LongRBTreeMap) {
            this.this$0 = long2LongRBTreeMap;
            super(long2LongRBTreeMap);
        }

        public KeyIterator(Long2LongRBTreeMap long2LongRBTreeMap, long l) {
            this.this$0 = long2LongRBTreeMap;
            super(long2LongRBTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2LongMap.Entry> {
        ...
        EntryIterator(Long2LongRBTreeMap long2LongRBTreeMap) {
            this.this$0 = long2LongRBTreeMap;
            super(long2LongRBTreeMap);
        }

        EntryIterator(Long2LongRBTreeMap long2LongRBTreeMap, long l) {
            this.this$0 = long2LongRBTreeMap;
            super(long2LongRBTreeMap, l);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2LongRBTreeMap long2LongRBTreeMap) {
            this.this$0 = long2LongRBTreeMap;
            this.index = 0;
            this.next = long2LongRBTreeMap.firstEntry;
        }

        TreeIterator(Long2LongRBTreeMap long2LongRBTreeMap, long l) {
            this.this$0 = long2LongRBTreeMap;
            this.index = 0;
            this.next = long2LongRBTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2LongRBTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
