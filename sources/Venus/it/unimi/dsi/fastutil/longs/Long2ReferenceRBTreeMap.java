...
Cloneable {
    ...
    public Long2ReferenceRBTreeMap(Comparator<? super Long> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Long2ReferenceRBTreeMap(Map<? extends Long, ? extends V> map) {
        this();
        this.putAll((Map<Long, ? extends V>)map);
    }

    public Long2ReferenceRBTreeMap(SortedMap<Long, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Long, V>)sortedMap);
    }

    public Long2ReferenceRBTreeMap(Long2ReferenceMap<? extends V> long2ReferenceMap) {
        this();
        this.putAll(long2ReferenceMap);
    }

    public Long2ReferenceRBTreeMap(Long2ReferenceSortedMap<V> long2ReferenceSortedMap) {
        this(long2ReferenceSortedMap.comparator());
        this.putAll(long2ReferenceSortedMap);
    }

    public Long2ReferenceRBTreeMap(long[] lArray, V[] VArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2ReferenceRBTreeMap(long[] lArray, V[] VArray) {
    ...
    public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>(this){
                ...
                final Long2ReferenceRBTreeMap this$0;
                {
                    this.this$0 = long2ReferenceRBTreeMap;
    ...
    public Long2ReferenceRBTreeMap<V> clone() {
        Long2ReferenceRBTreeMap long2ReferenceRBTreeMap;
        try {
            long2ReferenceRBTreeMap = (Long2ReferenceRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2ReferenceRBTreeMap.keys = null;
        long2ReferenceRBTreeMap.values = null;
        long2ReferenceRBTreeMap.entries = null;
        long2ReferenceRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2ReferenceRBTreeMap.tree = entry2.left;
                            long2ReferenceRBTreeMap.firstEntry = long2ReferenceRBTreeMap.tree;
                            while (long2ReferenceRBTreeMap.firstEntry.left != null) {
                                long2ReferenceRBTreeMap.firstEntry = long2ReferenceRBTreeMap.firstEntry.left;
                            }
                            long2ReferenceRBTreeMap.lastEntry = long2ReferenceRBTreeMap.tree;
                            while (long2ReferenceRBTreeMap.lastEntry.right != null) {
                                long2ReferenceRBTreeMap.lastEntry = long2ReferenceRBTreeMap.lastEntry.right;
                            }
                            return long2ReferenceRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Long2ReferenceRBTreeMap long2ReferenceRBTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2ReferenceRBTreeMap;
            if (!bl && !bl2 && long2ReferenceRBTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2ReferenceRBTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Long2ReferenceRBTreeMap long2ReferenceRBTreeMap) {
            this.this$0 = long2ReferenceRBTreeMap;
            super(long2ReferenceRBTreeMap);
        }
        ...
        ValueIterator(Long2ReferenceRBTreeMap long2ReferenceRBTreeMap, 1 var2_2) {
            this(long2ReferenceRBTreeMap);
        }
    }
    ...
    extends AbstractLong2ReferenceSortedMap.KeySet {
        ...
        private KeySet(Long2ReferenceRBTreeMap long2ReferenceRBTreeMap) {
            this.this$0 = long2ReferenceRBTreeMap;
            super(long2ReferenceRBTreeMap);
        }
        ...
        KeySet(Long2ReferenceRBTreeMap long2ReferenceRBTreeMap, 1 var2_2) {
            this(long2ReferenceRBTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2ReferenceRBTreeMap long2ReferenceRBTreeMap) {
            this.this$0 = long2ReferenceRBTreeMap;
            super(long2ReferenceRBTreeMap);
        }

        public KeyIterator(Long2ReferenceRBTreeMap long2ReferenceRBTreeMap, long l) {
            this.this$0 = long2ReferenceRBTreeMap;
            super(long2ReferenceRBTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2ReferenceMap.Entry<V>> {
        ...
        EntryIterator(Long2ReferenceRBTreeMap long2ReferenceRBTreeMap) {
            this.this$0 = long2ReferenceRBTreeMap;
            super(long2ReferenceRBTreeMap);
        }

        EntryIterator(Long2ReferenceRBTreeMap long2ReferenceRBTreeMap, long l) {
            this.this$0 = long2ReferenceRBTreeMap;
            super(long2ReferenceRBTreeMap, l);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2ReferenceRBTreeMap long2ReferenceRBTreeMap) {
            this.this$0 = long2ReferenceRBTreeMap;
            this.index = 0;
            this.next = long2ReferenceRBTreeMap.firstEntry;
        }

        TreeIterator(Long2ReferenceRBTreeMap long2ReferenceRBTreeMap, long l) {
            this.this$0 = long2ReferenceRBTreeMap;
            this.index = 0;
            this.next = long2ReferenceRBTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2ReferenceRBTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
