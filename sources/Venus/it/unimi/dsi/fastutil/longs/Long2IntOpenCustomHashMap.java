...
Hash {
    ...
    public Long2IntOpenCustomHashMap(int n, float f, LongHash.Strategy strategy) {
    ...
    public Long2IntOpenCustomHashMap(int n, LongHash.Strategy strategy) {
    ...
    public Long2IntOpenCustomHashMap(Map<? extends Long, ? extends Integer> map, float f, LongHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Long2IntOpenCustomHashMap(Map<? extends Long, ? extends Integer> map, LongHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Long2IntOpenCustomHashMap(Long2IntMap long2IntMap, float f, LongHash.Strategy strategy) {
        this(long2IntMap.size(), f, strategy);
        this.putAll(long2IntMap);
    }

    public Long2IntOpenCustomHashMap(Long2IntMap long2IntMap, LongHash.Strategy strategy) {
        this(long2IntMap, 0.75f, strategy);
    }

    public Long2IntOpenCustomHashMap(long[] lArray, int[] nArray, float f, LongHash.Strategy strategy) {
    ...
    public Long2IntOpenCustomHashMap(long[] lArray, int[] nArray, LongHash.Strategy strategy) {
        this(lArray, nArray, 0.75f, strategy);
    }
    ...
    public int getOrDefault(long l, int n) {
        ...
        long[] lArray = this.key;
        int n2 = HashCommon.mix(this.strategy.hashCode(l)) & this.mask;
        long l2 = lArray[n2];
        if (l2 == 0L) {
            return n;
        }
    ...
    public boolean remove(long l, int n) {
        ...
        if (this.strategy.equals(l, l2) && n == this.value[n2]) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if ((l2 = lArray[n2 = n2 + 1 & this.mask]) != 0L) continue;
            return true;
        } while (!this.strategy.equals(l, l2) || n != this.value[n2]);
        this.removeEntry(n2);
        return false;
    }
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection(this){
                final Long2IntOpenCustomHashMap this$0;
                {
                    this.this$0 = long2IntOpenCustomHashMap;
                }
    ...
    public Long2IntOpenCustomHashMap clone() {
        Long2IntOpenCustomHashMap long2IntOpenCustomHashMap;
        try {
            long2IntOpenCustomHashMap = (Long2IntOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2IntOpenCustomHashMap.keys = null;
        long2IntOpenCustomHashMap.values = null;
        long2IntOpenCustomHashMap.entries = null;
        long2IntOpenCustomHashMap.containsNullKey = this.containsNullKey;
        long2IntOpenCustomHashMap.key = (long[])this.key.clone();
        long2IntOpenCustomHashMap.value = (int[])this.value.clone();
        long2IntOpenCustomHashMap.strategy = this.strategy;
        return long2IntOpenCustomHashMap;
    }
    ...
    static int access$300(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap) {
        return long2IntOpenCustomHashMap.removeNullEntry();
    }

    static int access$400(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap, int n) {
        return long2IntOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements IntIterator {
        ...
        public ValueIterator(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap) {
            this.this$0 = long2IntOpenCustomHashMap;
            super(long2IntOpenCustomHashMap, null);
        }
    ...
    extends AbstractLongSet {
        ...
        private KeySet(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap) {
            this.this$0 = long2IntOpenCustomHashMap;
        }
        ...
        KeySet(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap, 1 var2_2) {
            this(long2IntOpenCustomHashMap);
        }
    }
    ...
    implements LongIterator {
        ...
        public KeyIterator(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap) {
            this.this$0 = long2IntOpenCustomHashMap;
            super(long2IntOpenCustomHashMap, null);
        }
    ...
    implements Long2IntMap.FastEntrySet {
        ...
        private MapEntrySet(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap) {
            this.this$0 = long2IntOpenCustomHashMap;
        }
        ...
        public boolean contains(Object object) {
            ...
            int n2 = HashCommon.mix(this.this$0.strategy.hashCode(l)) & this.this$0.mask;
            long l2 = lArray[n2];
            if (l2 == 0L) {
                return true;
            }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(l, 0L)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n) {
                    Long2IntOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(l2, l)) {
                if (this.this$0.value[n2] == n) {
                    Long2IntOpenCustomHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((l2 = lArray[n2 = n2 + 1 & this.this$0.mask]) != 0L) continue;
                return true;
            } while (!this.this$0.strategy.equals(l2, l) || this.this$0.value[n2] != n);
            Long2IntOpenCustomHashMap.access$400(this.this$0, n2);
            return false;
        }
        ...
        MapEntrySet(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap, 1 var2_2) {
            this(long2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2IntMap.Entry> {
        ...
        private FastEntryIterator(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap) {
            this.this$0 = long2IntOpenCustomHashMap;
            super(long2IntOpenCustomHashMap, null);
        ...
        FastEntryIterator(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap, 1 var2_2) {
            this(long2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2IntMap.Entry> {
        ...
        private EntryIterator(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap) {
            this.this$0 = long2IntOpenCustomHashMap;
            super(long2IntOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap, 1 var2_2) {
            this(long2IntOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap) {
            this.this$0 = long2IntOpenCustomHashMap;
        ...
        MapIterator(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap, 1 var2_2) {
            this(long2IntOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Long, Integer> {
        ...
        MapEntry(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap, int n) {
            this.this$0 = long2IntOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Long2IntOpenCustomHashMap long2IntOpenCustomHashMap) {
            this.this$0 = long2IntOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Long)entry.getKey()) && this.this$0.value[this.index] == (Integer)entry.getValue();
        }
