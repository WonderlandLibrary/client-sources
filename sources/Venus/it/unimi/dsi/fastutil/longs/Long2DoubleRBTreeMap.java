...
Cloneable {
    ...
    public Long2DoubleRBTreeMap(Comparator<? super Long> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Long2DoubleRBTreeMap(Map<? extends Long, ? extends Double> map) {
        this();
        this.putAll(map);
    }

    public Long2DoubleRBTreeMap(SortedMap<Long, Double> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Long, ? extends Double>)sortedMap);
    }

    public Long2DoubleRBTreeMap(Long2DoubleMap long2DoubleMap) {
        this();
        this.putAll(long2DoubleMap);
    }

    public Long2DoubleRBTreeMap(Long2DoubleSortedMap long2DoubleSortedMap) {
        this(long2DoubleSortedMap.comparator());
        this.putAll(long2DoubleSortedMap);
    }

    public Long2DoubleRBTreeMap(long[] lArray, double[] dArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2DoubleRBTreeMap(long[] lArray, double[] dArray) {
    ...
    public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>(this){
                ...
                final Long2DoubleRBTreeMap this$0;
                {
                    this.this$0 = long2DoubleRBTreeMap;
    ...
    public Long2DoubleRBTreeMap clone() {
        Long2DoubleRBTreeMap long2DoubleRBTreeMap;
        try {
            long2DoubleRBTreeMap = (Long2DoubleRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2DoubleRBTreeMap.keys = null;
        long2DoubleRBTreeMap.values = null;
        long2DoubleRBTreeMap.entries = null;
        long2DoubleRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2DoubleRBTreeMap.firstEntry = long2DoubleRBTreeMap.tree = entry2.left;
                            while (long2DoubleRBTreeMap.firstEntry.left != null) {
                                long2DoubleRBTreeMap.firstEntry = long2DoubleRBTreeMap.firstEntry.left;
                            }
                            long2DoubleRBTreeMap.lastEntry = long2DoubleRBTreeMap.tree;
                            while (long2DoubleRBTreeMap.lastEntry.right != null) {
                                long2DoubleRBTreeMap.lastEntry = long2DoubleRBTreeMap.lastEntry.right;
                            }
                            return long2DoubleRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Long2DoubleRBTreeMap long2DoubleRBTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2DoubleRBTreeMap;
            if (!bl && !bl2 && long2DoubleRBTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2DoubleRBTreeMap.defRetValue;
        }
    ...
    implements DoubleListIterator {
        ...
        private ValueIterator(Long2DoubleRBTreeMap long2DoubleRBTreeMap) {
            this.this$0 = long2DoubleRBTreeMap;
            super(long2DoubleRBTreeMap);
        }
        ...
        ValueIterator(Long2DoubleRBTreeMap long2DoubleRBTreeMap, 1 var2_2) {
            this(long2DoubleRBTreeMap);
        }
    }
    ...
    extends AbstractLong2DoubleSortedMap.KeySet {
        ...
        private KeySet(Long2DoubleRBTreeMap long2DoubleRBTreeMap) {
            this.this$0 = long2DoubleRBTreeMap;
            super(long2DoubleRBTreeMap);
        }
        ...
        KeySet(Long2DoubleRBTreeMap long2DoubleRBTreeMap, 1 var2_2) {
            this(long2DoubleRBTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2DoubleRBTreeMap long2DoubleRBTreeMap) {
            this.this$0 = long2DoubleRBTreeMap;
            super(long2DoubleRBTreeMap);
        }

        public KeyIterator(Long2DoubleRBTreeMap long2DoubleRBTreeMap, long l) {
            this.this$0 = long2DoubleRBTreeMap;
            super(long2DoubleRBTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2DoubleMap.Entry> {
        ...
        EntryIterator(Long2DoubleRBTreeMap long2DoubleRBTreeMap) {
            this.this$0 = long2DoubleRBTreeMap;
            super(long2DoubleRBTreeMap);
        }

        EntryIterator(Long2DoubleRBTreeMap long2DoubleRBTreeMap, long l) {
            this.this$0 = long2DoubleRBTreeMap;
            super(long2DoubleRBTreeMap, l);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2DoubleRBTreeMap long2DoubleRBTreeMap) {
            this.this$0 = long2DoubleRBTreeMap;
            this.index = 0;
            this.next = long2DoubleRBTreeMap.firstEntry;
        }

        TreeIterator(Long2DoubleRBTreeMap long2DoubleRBTreeMap, long l) {
            this.this$0 = long2DoubleRBTreeMap;
            this.index = 0;
            this.next = long2DoubleRBTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2DoubleRBTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
