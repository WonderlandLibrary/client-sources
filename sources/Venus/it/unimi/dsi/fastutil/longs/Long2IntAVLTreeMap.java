...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Long2IntAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Long2IntAVLTreeMap(Comparator<? super Long> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Long2IntAVLTreeMap(Map<? extends Long, ? extends Integer> map) {
        this();
        this.putAll(map);
    }

    public Long2IntAVLTreeMap(SortedMap<Long, Integer> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Long, ? extends Integer>)sortedMap);
    }

    public Long2IntAVLTreeMap(Long2IntMap long2IntMap) {
        this();
        this.putAll(long2IntMap);
    }

    public Long2IntAVLTreeMap(Long2IntSortedMap long2IntSortedMap) {
        this(long2IntSortedMap.comparator());
        this.putAll(long2IntSortedMap);
    }

    public Long2IntAVLTreeMap(long[] lArray, int[] nArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2IntAVLTreeMap(long[] lArray, int[] nArray) {
        this(lArray, nArray, null);
    }
    ...
    public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2IntMap.Entry>(this){
                final Comparator<? super Long2IntMap.Entry> comparator;
                final Long2IntAVLTreeMap this$0;
                {
                    this.this$0 = long2IntAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator(Long2IntMap.Entry entry) {
                ...
                public ObjectSortedSet<Long2IntMap.Entry> subSet(Long2IntMap.Entry entry, Long2IntMap.Entry entry2) {
                    return this.this$0.subMap(entry.getLongKey(), entry2.getLongKey()).long2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2IntMap.Entry> headSet(Long2IntMap.Entry entry) {
                    return this.this$0.headMap(entry.getLongKey()).long2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2IntMap.Entry> tailSet(Long2IntMap.Entry entry) {
                    return this.this$0.tailMap(entry.getLongKey()).long2IntEntrySet();
                }
                ...
                private int lambda$$0(Long2IntMap.Entry entry, Long2IntMap.Entry entry2) {
    ...
    public Long2IntAVLTreeMap clone() {
        Long2IntAVLTreeMap long2IntAVLTreeMap;
        try {
            long2IntAVLTreeMap = (Long2IntAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2IntAVLTreeMap.keys = null;
        long2IntAVLTreeMap.values = null;
        long2IntAVLTreeMap.entries = null;
        long2IntAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2IntAVLTreeMap.firstEntry = long2IntAVLTreeMap.tree = entry2.left;
                            while (long2IntAVLTreeMap.firstEntry.left != null) {
                                long2IntAVLTreeMap.firstEntry = long2IntAVLTreeMap.firstEntry.left;
                            }
                            long2IntAVLTreeMap.lastEntry = long2IntAVLTreeMap.tree;
                            while (long2IntAVLTreeMap.lastEntry.right != null) {
                                long2IntAVLTreeMap.lastEntry = long2IntAVLTreeMap.lastEntry.right;
                            }
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        ...
        if (n == 2) {
            ...
            entry4.right(new Entry(objectInputStream.readLong(), objectInputStream.readInt()));
    ...
    implements Serializable {
        ...
        public Submap(Long2IntAVLTreeMap long2IntAVLTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2IntAVLTreeMap;
            if (!bl && !bl2 && long2IntAVLTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2IntAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2IntMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Long2IntMap.Entry> comparator() {
                        return this.this$1.this$0.long2IntEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Long2IntMap.Entry> subSet(Long2IntMap.Entry entry, Long2IntMap.Entry entry2) {
                        return this.this$1.subMap(entry.getLongKey(), entry2.getLongKey()).long2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2IntMap.Entry> headSet(Long2IntMap.Entry entry) {
                        return this.this$1.headMap(entry.getLongKey()).long2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2IntMap.Entry> tailSet(Long2IntMap.Entry entry) {
                        return this.this$1.tailMap(entry.getLongKey()).long2IntEntrySet();
                    }
    ...
    implements IntListIterator {
        ...
        private ValueIterator(Long2IntAVLTreeMap long2IntAVLTreeMap) {
            this.this$0 = long2IntAVLTreeMap;
            super(long2IntAVLTreeMap);
        }
        ...
        ValueIterator(Long2IntAVLTreeMap long2IntAVLTreeMap, 1 var2_2) {
            this(long2IntAVLTreeMap);
        }
    }
    ...
    extends AbstractLong2IntSortedMap.KeySet {
        ...
        private KeySet(Long2IntAVLTreeMap long2IntAVLTreeMap) {
            this.this$0 = long2IntAVLTreeMap;
            super(long2IntAVLTreeMap);
        }
        ...
        KeySet(Long2IntAVLTreeMap long2IntAVLTreeMap, 1 var2_2) {
            this(long2IntAVLTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2IntAVLTreeMap long2IntAVLTreeMap) {
            this.this$0 = long2IntAVLTreeMap;
            super(long2IntAVLTreeMap);
        }

        public KeyIterator(Long2IntAVLTreeMap long2IntAVLTreeMap, long l) {
            this.this$0 = long2IntAVLTreeMap;
            super(long2IntAVLTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2IntMap.Entry> {
        ...
        EntryIterator(Long2IntAVLTreeMap long2IntAVLTreeMap) {
            this.this$0 = long2IntAVLTreeMap;
            super(long2IntAVLTreeMap);
        }

        EntryIterator(Long2IntAVLTreeMap long2IntAVLTreeMap, long l) {
            this.this$0 = long2IntAVLTreeMap;
            super(long2IntAVLTreeMap, l);
        }
        ...
        public void add(Object object) {
            this.add((Long2IntMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Long2IntMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2IntAVLTreeMap long2IntAVLTreeMap) {
            this.this$0 = long2IntAVLTreeMap;
            this.index = 0;
            this.next = long2IntAVLTreeMap.firstEntry;
        }

        TreeIterator(Long2IntAVLTreeMap long2IntAVLTreeMap, long l) {
            this.this$0 = long2IntAVLTreeMap;
            this.index = 0;
            this.next = long2IntAVLTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2IntAVLTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Long)entry.getKey() && this.value == (Integer)entry.getValue();
        }
