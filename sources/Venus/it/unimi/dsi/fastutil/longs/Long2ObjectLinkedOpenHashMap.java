...
Hash {
    ...
    public Long2ObjectLinkedOpenHashMap(Map<? extends Long, ? extends V> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }
    ...
    public Long2ObjectLinkedOpenHashMap(Long2ObjectMap<V> long2ObjectMap, float f) {
        this(long2ObjectMap.size(), f);
        this.putAll(long2ObjectMap);
    }

    public Long2ObjectLinkedOpenHashMap(Long2ObjectMap<V> long2ObjectMap) {
        this(long2ObjectMap, 0.75f);
    }

    public Long2ObjectLinkedOpenHashMap(long[] lArray, V[] VArray, float f) {
    ...
    public Long2ObjectLinkedOpenHashMap(long[] lArray, V[] VArray) {
    ...
    public ObjectCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(this){
                final Long2ObjectLinkedOpenHashMap this$0;
                {
                    this.this$0 = long2ObjectLinkedOpenHashMap;
                }
    ...
    public Long2ObjectLinkedOpenHashMap<V> clone() {
        ...
        try {
            long2ObjectLinkedOpenHashMap = (Long2ObjectLinkedOpenHashMap)super.clone();
        ...
        long2ObjectLinkedOpenHashMap.value = (Object[])this.value.clone();
    ...
    @Override
    public ObjectSortedSet long2ObjectEntrySet() {
    ...
    static Object access$100(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap) {
        return long2ObjectLinkedOpenHashMap.removeNullEntry();
    }

    static Object access$200(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap, int n) {
        return long2ObjectLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectListIterator<V> {
        ...
        public ValueIterator(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap) {
            this.this$0 = long2ObjectLinkedOpenHashMap;
            super(long2ObjectLinkedOpenHashMap);
        }
    ...
    extends AbstractLongSortedSet {
        ...
        private KeySet(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap) {
            this.this$0 = long2ObjectLinkedOpenHashMap;
        }
        ...
        KeySet(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap, 1 var2_2) {
            this(long2ObjectLinkedOpenHashMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap, long l) {
            this.this$0 = long2ObjectLinkedOpenHashMap;
            super(long2ObjectLinkedOpenHashMap, l, null);
        }
        ...
        public KeyIterator(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap) {
            this.this$0 = long2ObjectLinkedOpenHashMap;
            super(long2ObjectLinkedOpenHashMap);
        }
    ...
    implements Long2ObjectSortedMap.FastSortedEntrySet<V> {
        ...
        private MapEntrySet(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap) {
            this.this$0 = long2ObjectLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> entry, Long2ObjectMap.Entry<V> entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (l == 0L) {
                if (this.this$0.containsNullKey && Objects.equals(this.this$0.value[this.this$0.n], v)) {
                    Long2ObjectLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (l2 == l) {
                if (Objects.equals(this.this$0.value[n], v)) {
                    Long2ObjectLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Long2ObjectMap.Entry<V>> fastIterator(Long2ObjectMap.Entry<V> entry) {
        ...
        public void forEach(Consumer<? super Long2ObjectMap.Entry<V>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractLong2ObjectMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Long2ObjectMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Long2ObjectMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Long2ObjectMap.Entry)object, (Long2ObjectMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Long2ObjectMap.Entry)object);
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Long2ObjectMap.Entry entry) {
        ...
        MapEntrySet(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap, 1 var2_2) {
            this(long2ObjectLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Long2ObjectMap.Entry<V>> {
        ...
        public FastEntryIterator(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap, long l) {
            this.this$0 = long2ObjectLinkedOpenHashMap;
            super(long2ObjectLinkedOpenHashMap, l, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Long2ObjectMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Long2ObjectMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Long2ObjectMap.Entry<V>> {
        ...
        public EntryIterator(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap) {
            this.this$0 = long2ObjectLinkedOpenHashMap;
            super(long2ObjectLinkedOpenHashMap);
        }

        public EntryIterator(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap, long l) {
            this.this$0 = long2ObjectLinkedOpenHashMap;
            super(long2ObjectLinkedOpenHashMap, l, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap) {
            this.this$0 = long2ObjectLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = long2ObjectLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap, long l) {
            this.this$0 = long2ObjectLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (l == 0L) {
                if (long2ObjectLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)long2ObjectLinkedOpenHashMap.link[long2ObjectLinkedOpenHashMap.n];
                    this.prev = long2ObjectLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + l + " does not belong to this map.");
            }
            if (long2ObjectLinkedOpenHashMap.key[long2ObjectLinkedOpenHashMap.last] == l) {
                this.prev = long2ObjectLinkedOpenHashMap.last;
                this.index = long2ObjectLinkedOpenHashMap.size;
                return;
            }
            int n = (int)HashCommon.mix(l) & long2ObjectLinkedOpenHashMap.mask;
            while (long2ObjectLinkedOpenHashMap.key[n] != 0L) {
                if (long2ObjectLinkedOpenHashMap.key[n] == l) {
                    this.next = (int)long2ObjectLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & long2ObjectLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + l + " does not belong to this map.");
        }
        ...
        MapIterator(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap, long l, 1 var4_3) {
            this(long2ObjectLinkedOpenHashMap, l);
        }
    }
    ...
    Map.Entry<Long, V> {
        ...
        MapEntry(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap, int n) {
            this.this$0 = long2ObjectLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Long2ObjectLinkedOpenHashMap long2ObjectLinkedOpenHashMap) {
            this.this$0 = long2ObjectLinkedOpenHashMap;
        }
