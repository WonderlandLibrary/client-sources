...
Hash {
    ...
    public Long2CharOpenCustomHashMap(int n, float f, LongHash.Strategy strategy) {
    ...
    public Long2CharOpenCustomHashMap(int n, LongHash.Strategy strategy) {
    ...
    public Long2CharOpenCustomHashMap(Map<? extends Long, ? extends Character> map, float f, LongHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Long2CharOpenCustomHashMap(Map<? extends Long, ? extends Character> map, LongHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Long2CharOpenCustomHashMap(Long2CharMap long2CharMap, float f, LongHash.Strategy strategy) {
        this(long2CharMap.size(), f, strategy);
        this.putAll(long2CharMap);
    }

    public Long2CharOpenCustomHashMap(Long2CharMap long2CharMap, LongHash.Strategy strategy) {
        this(long2CharMap, 0.75f, strategy);
    }

    public Long2CharOpenCustomHashMap(long[] lArray, char[] cArray, float f, LongHash.Strategy strategy) {
    ...
    public Long2CharOpenCustomHashMap(long[] lArray, char[] cArray, LongHash.Strategy strategy) {
        this(lArray, cArray, 0.75f, strategy);
    }
    ...
    public boolean remove(long l, char c) {
        ...
        if (this.strategy.equals(l, l2) && c == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((l2 = lArray[n = n + 1 & this.mask]) != 0L) continue;
            return true;
        } while (!this.strategy.equals(l, l2) || c != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public CharCollection values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection(this){
                final Long2CharOpenCustomHashMap this$0;
                {
                    this.this$0 = long2CharOpenCustomHashMap;
                }
    ...
    public Long2CharOpenCustomHashMap clone() {
        Long2CharOpenCustomHashMap long2CharOpenCustomHashMap;
        try {
            long2CharOpenCustomHashMap = (Long2CharOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2CharOpenCustomHashMap.keys = null;
        long2CharOpenCustomHashMap.values = null;
        long2CharOpenCustomHashMap.entries = null;
        long2CharOpenCustomHashMap.containsNullKey = this.containsNullKey;
        long2CharOpenCustomHashMap.key = (long[])this.key.clone();
        long2CharOpenCustomHashMap.value = (char[])this.value.clone();
        long2CharOpenCustomHashMap.strategy = this.strategy;
        return long2CharOpenCustomHashMap;
    }
    ...
    static char access$300(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap) {
        return long2CharOpenCustomHashMap.removeNullEntry();
    }

    static char access$400(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap, int n) {
        return long2CharOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements CharIterator {
        ...
        public ValueIterator(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap) {
            this.this$0 = long2CharOpenCustomHashMap;
            super(long2CharOpenCustomHashMap, null);
        }
    ...
    extends AbstractLongSet {
        ...
        private KeySet(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap) {
            this.this$0 = long2CharOpenCustomHashMap;
        }
        ...
        KeySet(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap, 1 var2_2) {
            this(long2CharOpenCustomHashMap);
        }
    }
    ...
    implements LongIterator {
        ...
        public KeyIterator(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap) {
            this.this$0 = long2CharOpenCustomHashMap;
            super(long2CharOpenCustomHashMap, null);
        }
    ...
    implements Long2CharMap.FastEntrySet {
        ...
        private MapEntrySet(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap) {
            this.this$0 = long2CharOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(l, 0L)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == c) {
                    Long2CharOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(l2, l)) {
                if (this.this$0.value[n] == c) {
                    Long2CharOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((l2 = lArray[n = n + 1 & this.this$0.mask]) != 0L) continue;
                return true;
            } while (!this.this$0.strategy.equals(l2, l) || this.this$0.value[n] != c);
            Long2CharOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        public void forEach(Consumer<? super Long2CharMap.Entry> consumer) {
            if (this.this$0.containsNullKey) {
                consumer.accept(new AbstractLong2CharMap.BasicEntry(this.this$0.key[this.this$0.n], this.this$0.value[this.this$0.n]));
            }
            int n = this.this$0.n;
            while (n-- != 0) {
                if (this.this$0.key[n] == 0L) continue;
                consumer.accept(new AbstractLong2CharMap.BasicEntry(this.this$0.key[n], this.this$0.value[n]));
            }
        }
        ...
        MapEntrySet(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap, 1 var2_2) {
            this(long2CharOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2CharMap.Entry> {
        ...
        private FastEntryIterator(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap) {
            this.this$0 = long2CharOpenCustomHashMap;
            super(long2CharOpenCustomHashMap, null);
        ...
        FastEntryIterator(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap, 1 var2_2) {
            this(long2CharOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2CharMap.Entry> {
        ...
        private EntryIterator(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap) {
            this.this$0 = long2CharOpenCustomHashMap;
            super(long2CharOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap, 1 var2_2) {
            this(long2CharOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap) {
            this.this$0 = long2CharOpenCustomHashMap;
        ...
        MapIterator(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap, 1 var2_2) {
            this(long2CharOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Long, Character> {
        ...
        MapEntry(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap, int n) {
            this.this$0 = long2CharOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Long2CharOpenCustomHashMap long2CharOpenCustomHashMap) {
            this.this$0 = long2CharOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Long)entry.getKey()) && this.this$0.value[this.index] == ((Character)entry.getValue()).charValue();
        }
