...
Map<Long, V> {
    ...
    default public V put(Long l, V v) {
        return Long2ObjectFunction.super.put(l, v);
    }

    @Override
    @Deprecated
    default public V get(Object object) {
        return Long2ObjectFunction.super.get(object);
    }

    @Override
    @Deprecated
    default public V remove(Object object) {
        return Long2ObjectFunction.super.remove(object);
    }
    ...
    default public boolean containsKey(Object object) {
        return Long2ObjectFunction.super.containsKey(object);
    }
    ...
    default public boolean remove(long l, Object object) {
        Object v = this.get(l);
        if (!Objects.equals(v, object) || v == this.defaultReturnValue() && !this.containsKey(l)) {
            return true;
        }
        this.remove(l);
        return false;
    ...
    default public boolean replace(long l, V v, V v2) {
        Object v3 = this.get(l);
        if (!Objects.equals(v3, v) || v3 == this.defaultReturnValue() && !this.containsKey(l)) {
            return true;
        }
        this.put(l, v2);
        return false;
    ...
    default public V computeIfAbsentPartial(long l, Long2ObjectFunction<? extends V> long2ObjectFunction) {
        ...
        if (!long2ObjectFunction.containsKey(l)) {
            return v2;
        }
        V v3 = long2ObjectFunction.get(l);
        this.put(l, v3);
        return v3;
    }
