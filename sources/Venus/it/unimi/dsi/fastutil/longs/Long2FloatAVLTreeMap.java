...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Long2FloatAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Long2FloatAVLTreeMap(Comparator<? super Long> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Long2FloatAVLTreeMap(Map<? extends Long, ? extends Float> map) {
        this();
        this.putAll(map);
    }

    public Long2FloatAVLTreeMap(SortedMap<Long, Float> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Long, ? extends Float>)sortedMap);
    }

    public Long2FloatAVLTreeMap(Long2FloatMap long2FloatMap) {
        this();
        this.putAll(long2FloatMap);
    }

    public Long2FloatAVLTreeMap(Long2FloatSortedMap long2FloatSortedMap) {
        this(long2FloatSortedMap.comparator());
        this.putAll(long2FloatSortedMap);
    }

    public Long2FloatAVLTreeMap(long[] lArray, float[] fArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2FloatAVLTreeMap(long[] lArray, float[] fArray) {
        this(lArray, fArray, null);
    }
    ...
    public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>(this){
                final Comparator<? super Long2FloatMap.Entry> comparator;
                final Long2FloatAVLTreeMap this$0;
                {
                    this.this$0 = long2FloatAVLTreeMap;
                ...
                public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry entry, Long2FloatMap.Entry entry2) {
                    return this.this$0.subMap(entry.getLongKey(), entry2.getLongKey()).long2FloatEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry entry) {
                    return this.this$0.headMap(entry.getLongKey()).long2FloatEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry entry) {
                    return this.this$0.tailMap(entry.getLongKey()).long2FloatEntrySet();
                }
                ...
                private int lambda$$0(Long2FloatMap.Entry entry, Long2FloatMap.Entry entry2) {
    ...
    public Long2FloatAVLTreeMap clone() {
        Long2FloatAVLTreeMap long2FloatAVLTreeMap;
        try {
            long2FloatAVLTreeMap = (Long2FloatAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2FloatAVLTreeMap.keys = null;
        long2FloatAVLTreeMap.values = null;
        long2FloatAVLTreeMap.entries = null;
        long2FloatAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2FloatAVLTreeMap.firstEntry = long2FloatAVLTreeMap.tree = entry2.left;
                            while (long2FloatAVLTreeMap.firstEntry.left != null) {
                                long2FloatAVLTreeMap.firstEntry = long2FloatAVLTreeMap.firstEntry.left;
                            }
                            long2FloatAVLTreeMap.lastEntry = long2FloatAVLTreeMap.tree;
                            while (long2FloatAVLTreeMap.lastEntry.right != null) {
                                long2FloatAVLTreeMap.lastEntry = long2FloatAVLTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Long2FloatAVLTreeMap long2FloatAVLTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2FloatAVLTreeMap;
            if (!bl && !bl2 && long2FloatAVLTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2FloatAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Long2FloatMap.Entry> comparator() {
                        return this.this$1.this$0.long2FloatEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry entry, Long2FloatMap.Entry entry2) {
                        return this.this$1.subMap(entry.getLongKey(), entry2.getLongKey()).long2FloatEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry entry) {
                        return this.this$1.headMap(entry.getLongKey()).long2FloatEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry entry) {
                        return this.this$1.tailMap(entry.getLongKey()).long2FloatEntrySet();
                    }
    ...
    implements FloatListIterator {
        ...
        private ValueIterator(Long2FloatAVLTreeMap long2FloatAVLTreeMap) {
            this.this$0 = long2FloatAVLTreeMap;
            super(long2FloatAVLTreeMap);
        }
        ...
        ValueIterator(Long2FloatAVLTreeMap long2FloatAVLTreeMap, 1 var2_2) {
            this(long2FloatAVLTreeMap);
        }
    }
    ...
    extends AbstractLong2FloatSortedMap.KeySet {
        ...
        private KeySet(Long2FloatAVLTreeMap long2FloatAVLTreeMap) {
            this.this$0 = long2FloatAVLTreeMap;
            super(long2FloatAVLTreeMap);
        }
        ...
        KeySet(Long2FloatAVLTreeMap long2FloatAVLTreeMap, 1 var2_2) {
            this(long2FloatAVLTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2FloatAVLTreeMap long2FloatAVLTreeMap) {
            this.this$0 = long2FloatAVLTreeMap;
            super(long2FloatAVLTreeMap);
        }

        public KeyIterator(Long2FloatAVLTreeMap long2FloatAVLTreeMap, long l) {
            this.this$0 = long2FloatAVLTreeMap;
            super(long2FloatAVLTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2FloatMap.Entry> {
        ...
        EntryIterator(Long2FloatAVLTreeMap long2FloatAVLTreeMap) {
            this.this$0 = long2FloatAVLTreeMap;
            super(long2FloatAVLTreeMap);
        }

        EntryIterator(Long2FloatAVLTreeMap long2FloatAVLTreeMap, long l) {
            this.this$0 = long2FloatAVLTreeMap;
            super(long2FloatAVLTreeMap, l);
        }
        ...
        public void add(Object object) {
            this.add((Long2FloatMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Long2FloatMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2FloatAVLTreeMap long2FloatAVLTreeMap) {
            this.this$0 = long2FloatAVLTreeMap;
            this.index = 0;
            this.next = long2FloatAVLTreeMap.firstEntry;
        }

        TreeIterator(Long2FloatAVLTreeMap long2FloatAVLTreeMap, long l) {
            this.this$0 = long2FloatAVLTreeMap;
            this.index = 0;
            this.next = long2FloatAVLTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2FloatAVLTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Long)entry.getKey() && Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)entry.getValue()).floatValue());
        }
