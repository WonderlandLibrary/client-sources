...
Hash {
    ...
    public Long2LongOpenCustomHashMap(int n, float f, LongHash.Strategy strategy) {
    ...
    public Long2LongOpenCustomHashMap(int n, LongHash.Strategy strategy) {
    ...
    public Long2LongOpenCustomHashMap(Map<? extends Long, ? extends Long> map, float f, LongHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Long2LongOpenCustomHashMap(Map<? extends Long, ? extends Long> map, LongHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Long2LongOpenCustomHashMap(Long2LongMap long2LongMap, float f, LongHash.Strategy strategy) {
        this(long2LongMap.size(), f, strategy);
        this.putAll(long2LongMap);
    }

    public Long2LongOpenCustomHashMap(Long2LongMap long2LongMap, LongHash.Strategy strategy) {
        this(long2LongMap, 0.75f, strategy);
    }

    public Long2LongOpenCustomHashMap(long[] lArray, long[] lArray2, float f, LongHash.Strategy strategy) {
    ...
    public Long2LongOpenCustomHashMap(long[] lArray, long[] lArray2, LongHash.Strategy strategy) {
        this(lArray, lArray2, 0.75f, strategy);
    }
    ...
    public long addTo(long l, long l2) {
        ...
        if (this.strategy.equals(l, 0L)) {
            ...
            long l3 = lArray[n];
            if (l3 != 0L) {
                if (this.strategy.equals(l3, l)) {
                    return this.addToValue(n, l2);
                }
                while ((l3 = lArray[n = n + 1 & this.mask]) != 0L) {
                    if (!this.strategy.equals(l3, l)) continue;
                    return this.addToValue(n, l2);
                }
            }
        }
    ...
    public long getOrDefault(long l, long l2) {
        ...
        if (this.strategy.equals(l, l3)) {
            return this.value[n];
        }
        do {
            if ((l3 = lArray[n = n + 1 & this.mask]) != 0L) continue;
            return l2;
        } while (!this.strategy.equals(l, l3));
        return this.value[n];
    }
    ...
    public boolean remove(long l, long l2) {
        ...
        if (this.strategy.equals(l, l3) && l2 == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((l3 = lArray[n = n + 1 & this.mask]) != 0L) continue;
            return true;
        } while (!this.strategy.equals(l, l3) || l2 != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection(this){
                final Long2LongOpenCustomHashMap this$0;
                {
                    this.this$0 = long2LongOpenCustomHashMap;
                }
    ...
    public Long2LongOpenCustomHashMap clone() {
        ...
        try {
            long2LongOpenCustomHashMap = (Long2LongOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2LongOpenCustomHashMap.keys = null;
        long2LongOpenCustomHashMap.values = null;
        long2LongOpenCustomHashMap.entries = null;
        long2LongOpenCustomHashMap.containsNullKey = this.containsNullKey;
        long2LongOpenCustomHashMap.key = (long[])this.key.clone();
        long2LongOpenCustomHashMap.value = (long[])this.value.clone();
        long2LongOpenCustomHashMap.strategy = this.strategy;
    ...
    static long access$300(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap) {
        return long2LongOpenCustomHashMap.removeNullEntry();
    }

    static long access$400(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap, int n) {
        return long2LongOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements LongIterator {
        ...
        public ValueIterator(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap) {
            this.this$0 = long2LongOpenCustomHashMap;
            super(long2LongOpenCustomHashMap, null);
        }
    ...
    extends AbstractLongSet {
        ...
        private KeySet(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap) {
            this.this$0 = long2LongOpenCustomHashMap;
        }
        ...
        KeySet(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap, 1 var2_2) {
            this(long2LongOpenCustomHashMap);
        }
    }
    ...
    implements LongIterator {
        ...
        public KeyIterator(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap) {
            this.this$0 = long2LongOpenCustomHashMap;
            super(long2LongOpenCustomHashMap, null);
        }
    ...
    implements Long2LongMap.FastEntrySet {
        ...
        private MapEntrySet(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap) {
            this.this$0 = long2LongOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(l, 0L)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == l2) {
                    Long2LongOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(l3, l)) {
                if (this.this$0.value[n] == l2) {
                    Long2LongOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((l3 = lArray[n = n + 1 & this.this$0.mask]) != 0L) continue;
                return true;
            } while (!this.this$0.strategy.equals(l3, l) || this.this$0.value[n] != l2);
            Long2LongOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap, 1 var2_2) {
            this(long2LongOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2LongMap.Entry> {
        ...
        private FastEntryIterator(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap) {
            this.this$0 = long2LongOpenCustomHashMap;
            super(long2LongOpenCustomHashMap, null);
        ...
        FastEntryIterator(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap, 1 var2_2) {
            this(long2LongOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2LongMap.Entry> {
        ...
        private EntryIterator(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap) {
            this.this$0 = long2LongOpenCustomHashMap;
            super(long2LongOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap, 1 var2_2) {
            this(long2LongOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap) {
            this.this$0 = long2LongOpenCustomHashMap;
        ...
        MapIterator(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap, 1 var2_2) {
            this(long2LongOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Long, Long> {
        ...
        MapEntry(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap, int n) {
            this.this$0 = long2LongOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Long2LongOpenCustomHashMap long2LongOpenCustomHashMap) {
            this.this$0 = long2LongOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Long)entry.getKey()) && this.this$0.value[this.index] == (Long)entry.getValue();
        }
