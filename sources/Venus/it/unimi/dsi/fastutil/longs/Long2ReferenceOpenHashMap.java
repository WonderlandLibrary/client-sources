...
Hash {
    ...
    public Long2ReferenceOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Long2ReferenceOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Long2ReferenceOpenHashMap(Map<? extends Long, ? extends V> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Long2ReferenceOpenHashMap(Map<? extends Long, ? extends V> map) {
        this(map, 0.75f);
    }

    public Long2ReferenceOpenHashMap(Long2ReferenceMap<V> long2ReferenceMap, float f) {
        this(long2ReferenceMap.size(), f);
        this.putAll(long2ReferenceMap);
    }

    public Long2ReferenceOpenHashMap(Long2ReferenceMap<V> long2ReferenceMap) {
        this(long2ReferenceMap, 0.75f);
    }

    public Long2ReferenceOpenHashMap(long[] lArray, V[] VArray, float f) {
    ...
    public Long2ReferenceOpenHashMap(long[] lArray, V[] VArray) {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Long2ReferenceOpenHashMap this$0;
                {
                    this.this$0 = long2ReferenceOpenHashMap;
                }
    ...
    public Long2ReferenceOpenHashMap<V> clone() {
        Long2ReferenceOpenHashMap long2ReferenceOpenHashMap;
        try {
            long2ReferenceOpenHashMap = (Long2ReferenceOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2ReferenceOpenHashMap.keys = null;
        long2ReferenceOpenHashMap.values = null;
        long2ReferenceOpenHashMap.entries = null;
        long2ReferenceOpenHashMap.containsNullKey = this.containsNullKey;
        long2ReferenceOpenHashMap.key = (long[])this.key.clone();
        long2ReferenceOpenHashMap.value = (Object[])this.value.clone();
    ...
    static Object access$300(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap) {
        return long2ReferenceOpenHashMap.removeNullEntry();
    }

    static Object access$400(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap, int n) {
        return long2ReferenceOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap) {
            this.this$0 = long2ReferenceOpenHashMap;
            super(long2ReferenceOpenHashMap, null);
        }
    ...
    extends AbstractLongSet {
        ...
        private KeySet(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap) {
            this.this$0 = long2ReferenceOpenHashMap;
        }
        ...
        KeySet(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap, 1 var2_2) {
            this(long2ReferenceOpenHashMap);
        }
    }
    ...
    implements LongIterator {
        ...
        public KeyIterator(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap) {
            this.this$0 = long2ReferenceOpenHashMap;
            super(long2ReferenceOpenHashMap, null);
        }
    ...
    implements Long2ReferenceMap.FastEntrySet<V> {
        ...
        private MapEntrySet(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap) {
            this.this$0 = long2ReferenceOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (l == 0L) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Long2ReferenceOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (l2 == l) {
                if (this.this$0.value[n] == v) {
                    Long2ReferenceOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap, 1 var2_2) {
            this(long2ReferenceOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2ReferenceMap.Entry<V>> {
        ...
        private FastEntryIterator(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap) {
            this.this$0 = long2ReferenceOpenHashMap;
            super(long2ReferenceOpenHashMap, null);
        ...
        FastEntryIterator(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap, 1 var2_2) {
            this(long2ReferenceOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Long2ReferenceMap.Entry<V>> {
        ...
        private EntryIterator(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap) {
            this.this$0 = long2ReferenceOpenHashMap;
            super(long2ReferenceOpenHashMap, null);
        }
        ...
        EntryIterator(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap, 1 var2_2) {
            this(long2ReferenceOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap) {
            this.this$0 = long2ReferenceOpenHashMap;
        ...
        MapIterator(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap, 1 var2_2) {
            this(long2ReferenceOpenHashMap);
        }
    }
    ...
    Map.Entry<Long, V> {
        ...
        MapEntry(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap, int n) {
            this.this$0 = long2ReferenceOpenHashMap;
            this.index = n;
        }

        MapEntry(Long2ReferenceOpenHashMap long2ReferenceOpenHashMap) {
            this.this$0 = long2ReferenceOpenHashMap;
        }
