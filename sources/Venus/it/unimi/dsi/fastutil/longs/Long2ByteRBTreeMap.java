...
Cloneable {
    ...
    public Long2ByteRBTreeMap(long[] lArray, byte[] byArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2ByteRBTreeMap(long[] lArray, byte[] byArray) {
    ...
    public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>(this){
                ...
                final Long2ByteRBTreeMap this$0;
                {
                    this.this$0 = long2ByteRBTreeMap;
    ...
    public Long2ByteRBTreeMap clone() {
        Long2ByteRBTreeMap long2ByteRBTreeMap;
        try {
            long2ByteRBTreeMap = (Long2ByteRBTreeMap)super.clone();
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2ByteRBTreeMap.firstEntry = long2ByteRBTreeMap.tree = entry2.left;
    ...
    implements Serializable {
        ...
        public Submap(Long2ByteRBTreeMap long2ByteRBTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2ByteRBTreeMap;
            if (!bl && !bl2 && long2ByteRBTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2ByteRBTreeMap.defRetValue;
        }
    ...
    implements ByteListIterator {
        ...
        private ValueIterator(Long2ByteRBTreeMap long2ByteRBTreeMap) {
            this.this$0 = long2ByteRBTreeMap;
            super(long2ByteRBTreeMap);
        }
        ...
        ValueIterator(Long2ByteRBTreeMap long2ByteRBTreeMap, 1 var2_2) {
            this(long2ByteRBTreeMap);
        }
    }
    ...
    extends AbstractLong2ByteSortedMap.KeySet {
        ...
        private KeySet(Long2ByteRBTreeMap long2ByteRBTreeMap) {
            this.this$0 = long2ByteRBTreeMap;
            super(long2ByteRBTreeMap);
        }
        ...
        KeySet(Long2ByteRBTreeMap long2ByteRBTreeMap, 1 var2_2) {
            this(long2ByteRBTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2ByteRBTreeMap long2ByteRBTreeMap) {
            this.this$0 = long2ByteRBTreeMap;
            super(long2ByteRBTreeMap);
        }

        public KeyIterator(Long2ByteRBTreeMap long2ByteRBTreeMap, long l) {
            this.this$0 = long2ByteRBTreeMap;
            super(long2ByteRBTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2ByteMap.Entry> {
        ...
        EntryIterator(Long2ByteRBTreeMap long2ByteRBTreeMap) {
            this.this$0 = long2ByteRBTreeMap;
            super(long2ByteRBTreeMap);
        }

        EntryIterator(Long2ByteRBTreeMap long2ByteRBTreeMap, long l) {
            this.this$0 = long2ByteRBTreeMap;
            super(long2ByteRBTreeMap, l);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2ByteRBTreeMap long2ByteRBTreeMap) {
            this.this$0 = long2ByteRBTreeMap;
            this.index = 0;
            this.next = long2ByteRBTreeMap.firstEntry;
        }

        TreeIterator(Long2ByteRBTreeMap long2ByteRBTreeMap, long l) {
            this.this$0 = long2ByteRBTreeMap;
            this.index = 0;
            this.next = long2ByteRBTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2ByteRBTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
