...
public final class Long2IntSortedMaps {
    ...
    public static Comparator<? super Map.Entry<Long, ?>> entryComparator(LongComparator longComparator) {
        return (arg_0, arg_1) -> Long2IntSortedMaps.lambda$entryComparator$0(longComparator, arg_0, arg_1);
    }

    public static ObjectBidirectionalIterator<Long2IntMap.Entry> fastIterator(Long2IntSortedMap long2IntSortedMap) {
        ObjectSet objectSet = long2IntSortedMap.long2IntEntrySet();
        return objectSet instanceof Long2IntSortedMap.FastSortedEntrySet ? ((Long2IntSortedMap.FastSortedEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }

    public static ObjectBidirectionalIterable<Long2IntMap.Entry> fastIterable(Long2IntSortedMap long2IntSortedMap) {
        ObjectSet objectSet = long2IntSortedMap.long2IntEntrySet();
        return objectSet instanceof Long2IntSortedMap.FastSortedEntrySet ? ((Long2IntSortedMap.FastSortedEntrySet)objectSet)::fastIterator : objectSet;
    }

    public static Long2IntSortedMap singleton(Long l, Integer n) {
        return new Singleton(l, n);
    }

    public static Long2IntSortedMap singleton(Long l, Integer n, LongComparator longComparator) {
        return new Singleton(l, n, longComparator);
    }

    public static Long2IntSortedMap singleton(long l, int n) {
        return new Singleton(l, n);
    }

    public static Long2IntSortedMap singleton(long l, int n, LongComparator longComparator) {
        return new Singleton(l, n, longComparator);
    }
    ...
    public static Long2IntSortedMap synchronize(Long2IntSortedMap long2IntSortedMap, Object object) {
        return new SynchronizedSortedMap(long2IntSortedMap, object);
    }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Long2IntSortedMap long2IntSortedMap, Object object) {
            super(long2IntSortedMap, object);
            this.sortedMap = long2IntSortedMap;
        }
    ...
    Cloneable {
        ...
        protected Singleton(long l, int n, LongComparator longComparator) {
            super(l, n);
