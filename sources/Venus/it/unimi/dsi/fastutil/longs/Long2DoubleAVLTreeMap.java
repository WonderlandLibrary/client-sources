...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Long2DoubleAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Long2DoubleAVLTreeMap(Comparator<? super Long> comparator) {
        this();
    ...
    public Long2DoubleAVLTreeMap(SortedMap<Long, Double> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Long, ? extends Double>)sortedMap);
    }

    public Long2DoubleAVLTreeMap(Long2DoubleMap long2DoubleMap) {
        this();
        this.putAll(long2DoubleMap);
    }

    public Long2DoubleAVLTreeMap(Long2DoubleSortedMap long2DoubleSortedMap) {
        this(long2DoubleSortedMap.comparator());
        this.putAll(long2DoubleSortedMap);
    }

    public Long2DoubleAVLTreeMap(long[] lArray, double[] dArray, Comparator<? super Long> comparator) {
        this(comparator);
    ...
    public Long2DoubleAVLTreeMap(long[] lArray, double[] dArray) {
        this(lArray, dArray, null);
    }
    ...
    public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>(this){
                final Comparator<? super Long2DoubleMap.Entry> comparator;
                final Long2DoubleAVLTreeMap this$0;
                {
                    this.this$0 = long2DoubleAVLTreeMap;
                ...
                public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry entry, Long2DoubleMap.Entry entry2) {
                    return this.this$0.subMap(entry.getLongKey(), entry2.getLongKey()).long2DoubleEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry entry) {
                    return this.this$0.headMap(entry.getLongKey()).long2DoubleEntrySet();
                }

                @Override
                public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry entry) {
                    return this.this$0.tailMap(entry.getLongKey()).long2DoubleEntrySet();
                }
                ...
                private int lambda$$0(Long2DoubleMap.Entry entry, Long2DoubleMap.Entry entry2) {
    ...
    public Long2DoubleAVLTreeMap clone() {
        Long2DoubleAVLTreeMap long2DoubleAVLTreeMap;
        try {
            long2DoubleAVLTreeMap = (Long2DoubleAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        long2DoubleAVLTreeMap.keys = null;
        long2DoubleAVLTreeMap.values = null;
        long2DoubleAVLTreeMap.entries = null;
        long2DoubleAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            long2DoubleAVLTreeMap.firstEntry = long2DoubleAVLTreeMap.tree = entry2.left;
                            while (long2DoubleAVLTreeMap.firstEntry.left != null) {
                                long2DoubleAVLTreeMap.firstEntry = long2DoubleAVLTreeMap.firstEntry.left;
                            }
                            long2DoubleAVLTreeMap.lastEntry = long2DoubleAVLTreeMap.tree;
                            while (long2DoubleAVLTreeMap.lastEntry.right != null) {
                                long2DoubleAVLTreeMap.lastEntry = long2DoubleAVLTreeMap.lastEntry.right;
                            }
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readLong(), objectInputStream.readDouble());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readLong(), objectInputStream.readDouble());
            entry4.right(new Entry(objectInputStream.readLong(), objectInputStream.readDouble()));
    ...
    implements Serializable {
        ...
        public Submap(Long2DoubleAVLTreeMap long2DoubleAVLTreeMap, long l, boolean bl, long l2, boolean bl2) {
            this.this$0 = long2DoubleAVLTreeMap;
            if (!bl && !bl2 && long2DoubleAVLTreeMap.compare(l, l2) > 0) {
            ...
            this.to = l2;
            this.top = bl2;
            this.defRetValue = long2DoubleAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Long2DoubleMap.Entry> comparator() {
                        return this.this$1.this$0.long2DoubleEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry entry, Long2DoubleMap.Entry entry2) {
                        return this.this$1.subMap(entry.getLongKey(), entry2.getLongKey()).long2DoubleEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry entry) {
                        return this.this$1.headMap(entry.getLongKey()).long2DoubleEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry entry) {
                        return this.this$1.tailMap(entry.getLongKey()).long2DoubleEntrySet();
                    }
    ...
    implements DoubleListIterator {
        ...
        private ValueIterator(Long2DoubleAVLTreeMap long2DoubleAVLTreeMap) {
            this.this$0 = long2DoubleAVLTreeMap;
            super(long2DoubleAVLTreeMap);
        }
        ...
        ValueIterator(Long2DoubleAVLTreeMap long2DoubleAVLTreeMap, 1 var2_2) {
            this(long2DoubleAVLTreeMap);
        }
    }
    ...
    extends AbstractLong2DoubleSortedMap.KeySet {
        ...
        private KeySet(Long2DoubleAVLTreeMap long2DoubleAVLTreeMap) {
            this.this$0 = long2DoubleAVLTreeMap;
            super(long2DoubleAVLTreeMap);
        }
        ...
        KeySet(Long2DoubleAVLTreeMap long2DoubleAVLTreeMap, 1 var2_2) {
            this(long2DoubleAVLTreeMap);
        }
    }
    ...
    implements LongListIterator {
        ...
        public KeyIterator(Long2DoubleAVLTreeMap long2DoubleAVLTreeMap) {
            this.this$0 = long2DoubleAVLTreeMap;
            super(long2DoubleAVLTreeMap);
        }

        public KeyIterator(Long2DoubleAVLTreeMap long2DoubleAVLTreeMap, long l) {
            this.this$0 = long2DoubleAVLTreeMap;
            super(long2DoubleAVLTreeMap, l);
        }
    ...
    implements ObjectListIterator<Long2DoubleMap.Entry> {
        ...
        EntryIterator(Long2DoubleAVLTreeMap long2DoubleAVLTreeMap) {
            this.this$0 = long2DoubleAVLTreeMap;
            super(long2DoubleAVLTreeMap);
        }

        EntryIterator(Long2DoubleAVLTreeMap long2DoubleAVLTreeMap, long l) {
            this.this$0 = long2DoubleAVLTreeMap;
            super(long2DoubleAVLTreeMap, l);
        }
        ...
        public void add(Object object) {
            this.add((Long2DoubleMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Long2DoubleMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Long2DoubleAVLTreeMap long2DoubleAVLTreeMap) {
            this.this$0 = long2DoubleAVLTreeMap;
            this.index = 0;
            this.next = long2DoubleAVLTreeMap.firstEntry;
        }

        TreeIterator(Long2DoubleAVLTreeMap long2DoubleAVLTreeMap, long l) {
            this.this$0 = long2DoubleAVLTreeMap;
            this.index = 0;
            this.next = long2DoubleAVLTreeMap.locateKey(l);
            if (this.next != null) {
                if (long2DoubleAVLTreeMap.compare(this.next.key, l) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Long)entry.getKey() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits((Double)entry.getValue());
        }
