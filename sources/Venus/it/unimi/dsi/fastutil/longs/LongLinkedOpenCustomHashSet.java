...
Hash {
    ...
    public LongLinkedOpenCustomHashSet(int n, float f, LongHash.Strategy strategy) {
    ...
    public LongLinkedOpenCustomHashSet(int n, LongHash.Strategy strategy) {
    ...
    public LongLinkedOpenCustomHashSet(Collection<? extends Long> collection, float f, LongHash.Strategy strategy) {
        this(collection.size(), f, strategy);
        this.addAll(collection);
    }

    public LongLinkedOpenCustomHashSet(Collection<? extends Long> collection, LongHash.Strategy strategy) {
        this(collection, 0.75f, strategy);
    }

    public LongLinkedOpenCustomHashSet(LongCollection longCollection, float f, LongHash.Strategy strategy) {
        this(longCollection.size(), f, strategy);
        this.addAll(longCollection);
    }

    public LongLinkedOpenCustomHashSet(LongCollection longCollection, LongHash.Strategy strategy) {
        this(longCollection, 0.75f, strategy);
    }

    public LongLinkedOpenCustomHashSet(LongIterator longIterator, float f, LongHash.Strategy strategy) {
        this(16, f, strategy);
    ...
    public LongLinkedOpenCustomHashSet(LongIterator longIterator, LongHash.Strategy strategy) {
        this(longIterator, 0.75f, strategy);
    }

    public LongLinkedOpenCustomHashSet(Iterator<?> iterator2, float f, LongHash.Strategy strategy) {
        this(LongIterators.asLongIterator(iterator2), f, strategy);
    }

    public LongLinkedOpenCustomHashSet(Iterator<?> iterator2, LongHash.Strategy strategy) {
        this(LongIterators.asLongIterator(iterator2), strategy);
    }

    public LongLinkedOpenCustomHashSet(long[] lArray, int n, int n2, float f, LongHash.Strategy strategy) {
    ...
    public LongLinkedOpenCustomHashSet(long[] lArray, int n, int n2, LongHash.Strategy strategy) {
        this(lArray, n, n2, 0.75f, strategy);
    }

    public LongLinkedOpenCustomHashSet(long[] lArray, float f, LongHash.Strategy strategy) {
        this(lArray, 0, lArray.length, f, strategy);
    }

    public LongLinkedOpenCustomHashSet(long[] lArray, LongHash.Strategy strategy) {
    ...
    public boolean addAndMoveToFirst(long l) {
        ...
        if (this.strategy.equals(l, 0L)) {
            ...
            n = HashCommon.mix(this.strategy.hashCode(l)) & this.mask;
            while (lArray[n] != 0L) {
                if (this.strategy.equals(l, lArray[n])) {
    ...
    protected void rehash(int n) {
        ...
        while (n6-- != 0) {
            int n7;
            if (this.strategy.equals(lArray[n3], 0L)) {
                n7 = n;
            } else {
                n7 = HashCommon.mix(this.strategy.hashCode(lArray[n3])) & n2;
                while (lArray2[n7] != 0L) {
                    n7 = n7 + 1 & n2;
                }
            }
    ...
    public LongLinkedOpenCustomHashSet clone() {
        LongLinkedOpenCustomHashSet longLinkedOpenCustomHashSet;
        try {
            longLinkedOpenCustomHashSet = (LongLinkedOpenCustomHashSet)super.clone();
        ...
        longLinkedOpenCustomHashSet.strategy = this.strategy;
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        while (n2-- != 0) {
            ...
            if (this.strategy.equals(l, 0L)) {
                ...
                n3 = HashCommon.mix(this.strategy.hashCode(l)) & this.mask;
                if (lArray[n3] != 0L) {
    ...
    implements LongListIterator {
        ...
        int curr;
        int index;
        final LongLinkedOpenCustomHashSet this$0;

        SetIterator(LongLinkedOpenCustomHashSet longLinkedOpenCustomHashSet) {
            this.this$0 = longLinkedOpenCustomHashSet;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = longLinkedOpenCustomHashSet.first;
            this.index = 0;
        }

        SetIterator(LongLinkedOpenCustomHashSet longLinkedOpenCustomHashSet, long l) {
            this.this$0 = longLinkedOpenCustomHashSet;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (longLinkedOpenCustomHashSet.strategy.equals(l, 0L)) {
                if (longLinkedOpenCustomHashSet.containsNull) {
                    this.next = (int)longLinkedOpenCustomHashSet.link[longLinkedOpenCustomHashSet.n];
                    this.prev = longLinkedOpenCustomHashSet.n;
                    return;
                }
                throw new NoSuchElementException("The key " + l + " does not belong to this set.");
            }
            if (longLinkedOpenCustomHashSet.strategy.equals(longLinkedOpenCustomHashSet.key[longLinkedOpenCustomHashSet.last], l)) {
                this.prev = longLinkedOpenCustomHashSet.last;
                this.index = longLinkedOpenCustomHashSet.size;
                return;
            }
            long[] lArray = longLinkedOpenCustomHashSet.key;
            int n = HashCommon.mix(longLinkedOpenCustomHashSet.strategy.hashCode(l)) & longLinkedOpenCustomHashSet.mask;
            while (lArray[n] != 0L) {
                if (longLinkedOpenCustomHashSet.strategy.equals(lArray[n], l)) {
                    this.next = (int)longLinkedOpenCustomHashSet.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & longLinkedOpenCustomHashSet.mask;
            }
            throw new NoSuchElementException("The key " + l + " does not belong to this set.");
        }
