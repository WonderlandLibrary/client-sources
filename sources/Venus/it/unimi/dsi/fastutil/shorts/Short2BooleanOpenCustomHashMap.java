...
Hash {
    ...
    public Short2BooleanOpenCustomHashMap(int n, float f, ShortHash.Strategy strategy) {
    ...
    public Short2BooleanOpenCustomHashMap(int n, ShortHash.Strategy strategy) {
    ...
    public Short2BooleanOpenCustomHashMap(Map<? extends Short, ? extends Boolean> map, float f, ShortHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Short2BooleanOpenCustomHashMap(Map<? extends Short, ? extends Boolean> map, ShortHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Short2BooleanOpenCustomHashMap(Short2BooleanMap short2BooleanMap, float f, ShortHash.Strategy strategy) {
        this(short2BooleanMap.size(), f, strategy);
        this.putAll(short2BooleanMap);
    }

    public Short2BooleanOpenCustomHashMap(Short2BooleanMap short2BooleanMap, ShortHash.Strategy strategy) {
        this(short2BooleanMap, 0.75f, strategy);
    }

    public Short2BooleanOpenCustomHashMap(short[] sArray, boolean[] blArray, float f, ShortHash.Strategy strategy) {
    ...
    public Short2BooleanOpenCustomHashMap(short[] sArray, boolean[] blArray, ShortHash.Strategy strategy) {
        this(sArray, blArray, 0.75f, strategy);
    }
    ...
    public boolean remove(short s, boolean bl) {
        ...
        if (this.strategy.equals(s, s2) && bl == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((s2 = sArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(s, s2) || bl != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public BooleanCollection values() {
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(this){
                final Short2BooleanOpenCustomHashMap this$0;
                {
                    this.this$0 = short2BooleanOpenCustomHashMap;
                }
    ...
    public Short2BooleanOpenCustomHashMap clone() {
        Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap;
        try {
            short2BooleanOpenCustomHashMap = (Short2BooleanOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2BooleanOpenCustomHashMap.keys = null;
        short2BooleanOpenCustomHashMap.values = null;
        short2BooleanOpenCustomHashMap.entries = null;
        short2BooleanOpenCustomHashMap.containsNullKey = this.containsNullKey;
        short2BooleanOpenCustomHashMap.key = (short[])this.key.clone();
        short2BooleanOpenCustomHashMap.value = (boolean[])this.value.clone();
        short2BooleanOpenCustomHashMap.strategy = this.strategy;
        return short2BooleanOpenCustomHashMap;
    }
    ...
    static boolean access$300(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap) {
        return short2BooleanOpenCustomHashMap.removeNullEntry();
    }

    static boolean access$400(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap, int n) {
        return short2BooleanOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements BooleanIterator {
        ...
        public ValueIterator(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap) {
            this.this$0 = short2BooleanOpenCustomHashMap;
            super(short2BooleanOpenCustomHashMap, null);
        }
    ...
    extends AbstractShortSet {
        ...
        private KeySet(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap) {
            this.this$0 = short2BooleanOpenCustomHashMap;
        }
        ...
        KeySet(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap, 1 var2_2) {
            this(short2BooleanOpenCustomHashMap);
        }
    }
    ...
    implements ShortIterator {
        ...
        public KeyIterator(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap) {
            this.this$0 = short2BooleanOpenCustomHashMap;
            super(short2BooleanOpenCustomHashMap, null);
        }
    ...
    implements Short2BooleanMap.FastEntrySet {
        ...
        private MapEntrySet(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap) {
            this.this$0 = short2BooleanOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(s, (short)0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == bl) {
                    Short2BooleanOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(s2, s)) {
                if (this.this$0.value[n] == bl) {
                    Short2BooleanOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((s2 = sArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(s2, s) || this.this$0.value[n] != bl);
            Short2BooleanOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap, 1 var2_2) {
            this(short2BooleanOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2BooleanMap.Entry> {
        ...
        private FastEntryIterator(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap) {
            this.this$0 = short2BooleanOpenCustomHashMap;
            super(short2BooleanOpenCustomHashMap, null);
        ...
        FastEntryIterator(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap, 1 var2_2) {
            this(short2BooleanOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2BooleanMap.Entry> {
        ...
        private EntryIterator(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap) {
            this.this$0 = short2BooleanOpenCustomHashMap;
            super(short2BooleanOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap, 1 var2_2) {
            this(short2BooleanOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap) {
            this.this$0 = short2BooleanOpenCustomHashMap;
        ...
        MapIterator(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap, 1 var2_2) {
            this(short2BooleanOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Short, Boolean> {
        ...
        MapEntry(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap, int n) {
            this.this$0 = short2BooleanOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Short2BooleanOpenCustomHashMap short2BooleanOpenCustomHashMap) {
            this.this$0 = short2BooleanOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Short)entry.getKey()) && this.this$0.value[this.index] == (Boolean)entry.getValue();
        }
