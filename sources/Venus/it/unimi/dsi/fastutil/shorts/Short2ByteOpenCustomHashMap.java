...
Hash {
    ...
    public Short2ByteOpenCustomHashMap(int n, float f, ShortHash.Strategy strategy) {
    ...
    public Short2ByteOpenCustomHashMap(int n, ShortHash.Strategy strategy) {
    ...
    public Short2ByteOpenCustomHashMap(Map<? extends Short, ? extends Byte> map, float f, ShortHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Short2ByteOpenCustomHashMap(Map<? extends Short, ? extends Byte> map, ShortHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Short2ByteOpenCustomHashMap(Short2ByteMap short2ByteMap, float f, ShortHash.Strategy strategy) {
        this(short2ByteMap.size(), f, strategy);
        this.putAll(short2ByteMap);
    }

    public Short2ByteOpenCustomHashMap(Short2ByteMap short2ByteMap, ShortHash.Strategy strategy) {
        this(short2ByteMap, 0.75f, strategy);
    }

    public Short2ByteOpenCustomHashMap(short[] sArray, byte[] byArray, float f, ShortHash.Strategy strategy) {
    ...
    public Short2ByteOpenCustomHashMap(short[] sArray, byte[] byArray, ShortHash.Strategy strategy) {
        this(sArray, byArray, 0.75f, strategy);
    }
    ...
    public boolean remove(short s, byte by) {
        ...
        if (this.strategy.equals(s, s2) && by == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((s2 = sArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(s, s2) || by != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection(this){
                final Short2ByteOpenCustomHashMap this$0;
                {
                    this.this$0 = short2ByteOpenCustomHashMap;
                }
    ...
    public Short2ByteOpenCustomHashMap clone() {
        Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap;
        try {
            short2ByteOpenCustomHashMap = (Short2ByteOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2ByteOpenCustomHashMap.keys = null;
        short2ByteOpenCustomHashMap.values = null;
        short2ByteOpenCustomHashMap.entries = null;
        short2ByteOpenCustomHashMap.containsNullKey = this.containsNullKey;
        short2ByteOpenCustomHashMap.key = (short[])this.key.clone();
        short2ByteOpenCustomHashMap.value = (byte[])this.value.clone();
        short2ByteOpenCustomHashMap.strategy = this.strategy;
        return short2ByteOpenCustomHashMap;
    }
    ...
    static byte access$300(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap) {
        return short2ByteOpenCustomHashMap.removeNullEntry();
    }

    static byte access$400(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap, int n) {
        return short2ByteOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ByteIterator {
        ...
        public ValueIterator(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap) {
            this.this$0 = short2ByteOpenCustomHashMap;
            super(short2ByteOpenCustomHashMap, null);
        }
    ...
    extends AbstractShortSet {
        ...
        private KeySet(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap) {
            this.this$0 = short2ByteOpenCustomHashMap;
        }
        ...
        KeySet(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap, 1 var2_2) {
            this(short2ByteOpenCustomHashMap);
        }
    }
    ...
    implements ShortIterator {
        ...
        public KeyIterator(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap) {
            this.this$0 = short2ByteOpenCustomHashMap;
            super(short2ByteOpenCustomHashMap, null);
        }
    ...
    implements Short2ByteMap.FastEntrySet {
        ...
        private MapEntrySet(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap) {
            this.this$0 = short2ByteOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(s, (short)0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == by) {
                    Short2ByteOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(s2, s)) {
                if (this.this$0.value[n] == by) {
                    Short2ByteOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((s2 = sArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(s2, s) || this.this$0.value[n] != by);
            Short2ByteOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap, 1 var2_2) {
            this(short2ByteOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2ByteMap.Entry> {
        ...
        private FastEntryIterator(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap) {
            this.this$0 = short2ByteOpenCustomHashMap;
            super(short2ByteOpenCustomHashMap, null);
        ...
        FastEntryIterator(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap, 1 var2_2) {
            this(short2ByteOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2ByteMap.Entry> {
        ...
        private EntryIterator(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap) {
            this.this$0 = short2ByteOpenCustomHashMap;
            super(short2ByteOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap, 1 var2_2) {
            this(short2ByteOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap) {
            this.this$0 = short2ByteOpenCustomHashMap;
        ...
        MapIterator(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap, 1 var2_2) {
            this(short2ByteOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Short, Byte> {
        ...
        MapEntry(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap, int n) {
            this.this$0 = short2ByteOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Short2ByteOpenCustomHashMap short2ByteOpenCustomHashMap) {
            this.this$0 = short2ByteOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Short)entry.getKey()) && this.this$0.value[this.index] == (Byte)entry.getValue();
        }
