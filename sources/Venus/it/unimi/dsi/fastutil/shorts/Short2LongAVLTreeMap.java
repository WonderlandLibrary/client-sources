...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Short2LongAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Short2LongAVLTreeMap(Comparator<? super Short> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Short2LongAVLTreeMap(Map<? extends Short, ? extends Long> map) {
        this();
        this.putAll(map);
    }

    public Short2LongAVLTreeMap(SortedMap<Short, Long> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Short, ? extends Long>)sortedMap);
    }

    public Short2LongAVLTreeMap(Short2LongMap short2LongMap) {
        this();
        this.putAll(short2LongMap);
    }

    public Short2LongAVLTreeMap(Short2LongSortedMap short2LongSortedMap) {
        this(short2LongSortedMap.comparator());
        this.putAll(short2LongSortedMap);
    }

    public Short2LongAVLTreeMap(short[] sArray, long[] lArray, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2LongAVLTreeMap(short[] sArray, long[] lArray) {
        this(sArray, lArray, null);
    }
    ...
    public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>(this){
                final Comparator<? super Short2LongMap.Entry> comparator;
                final Short2LongAVLTreeMap this$0;
                {
                    this.this$0 = short2LongAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator(Short2LongMap.Entry entry) {
                ...
                public ObjectSortedSet<Short2LongMap.Entry> subSet(Short2LongMap.Entry entry, Short2LongMap.Entry entry2) {
                    return this.this$0.subMap(entry.getShortKey(), entry2.getShortKey()).short2LongEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry entry) {
                    return this.this$0.headMap(entry.getShortKey()).short2LongEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry entry) {
                    return this.this$0.tailMap(entry.getShortKey()).short2LongEntrySet();
                }
                ...
                private int lambda$$0(Short2LongMap.Entry entry, Short2LongMap.Entry entry2) {
    ...
    public Short2LongAVLTreeMap clone() {
        Short2LongAVLTreeMap short2LongAVLTreeMap;
        try {
            short2LongAVLTreeMap = (Short2LongAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2LongAVLTreeMap.keys = null;
        short2LongAVLTreeMap.values = null;
        short2LongAVLTreeMap.entries = null;
        short2LongAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2LongAVLTreeMap.firstEntry = short2LongAVLTreeMap.tree = entry2.left;
                            while (short2LongAVLTreeMap.firstEntry.left != null) {
                                short2LongAVLTreeMap.firstEntry = short2LongAVLTreeMap.firstEntry.left;
                            }
                            short2LongAVLTreeMap.lastEntry = short2LongAVLTreeMap.tree;
                            while (short2LongAVLTreeMap.lastEntry.right != null) {
                                short2LongAVLTreeMap.lastEntry = short2LongAVLTreeMap.lastEntry.right;
                            }
                            return short2LongAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readShort(), objectInputStream.readLong());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readShort(), objectInputStream.readLong());
            entry4.right(new Entry(objectInputStream.readShort(), objectInputStream.readLong()));
    ...
    implements Serializable {
        ...
        public Submap(Short2LongAVLTreeMap short2LongAVLTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2LongAVLTreeMap;
            if (!bl && !bl2 && short2LongAVLTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2LongAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Short2LongMap.Entry> comparator() {
                        return this.this$1.this$0.short2LongEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Short2LongMap.Entry> subSet(Short2LongMap.Entry entry, Short2LongMap.Entry entry2) {
                        return this.this$1.subMap(entry.getShortKey(), entry2.getShortKey()).short2LongEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry entry) {
                        return this.this$1.headMap(entry.getShortKey()).short2LongEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry entry) {
                        return this.this$1.tailMap(entry.getShortKey()).short2LongEntrySet();
                    }
    ...
    implements LongListIterator {
        ...
        private ValueIterator(Short2LongAVLTreeMap short2LongAVLTreeMap) {
            this.this$0 = short2LongAVLTreeMap;
            super(short2LongAVLTreeMap);
        }
        ...
        ValueIterator(Short2LongAVLTreeMap short2LongAVLTreeMap, 1 var2_2) {
            this(short2LongAVLTreeMap);
        }
    }
    ...
    extends AbstractShort2LongSortedMap.KeySet {
        ...
        private KeySet(Short2LongAVLTreeMap short2LongAVLTreeMap) {
            this.this$0 = short2LongAVLTreeMap;
            super(short2LongAVLTreeMap);
        }
        ...
        KeySet(Short2LongAVLTreeMap short2LongAVLTreeMap, 1 var2_2) {
            this(short2LongAVLTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2LongAVLTreeMap short2LongAVLTreeMap) {
            this.this$0 = short2LongAVLTreeMap;
            super(short2LongAVLTreeMap);
        }

        public KeyIterator(Short2LongAVLTreeMap short2LongAVLTreeMap, short s) {
            this.this$0 = short2LongAVLTreeMap;
            super(short2LongAVLTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2LongMap.Entry> {
        ...
        EntryIterator(Short2LongAVLTreeMap short2LongAVLTreeMap) {
            this.this$0 = short2LongAVLTreeMap;
            super(short2LongAVLTreeMap);
        }

        EntryIterator(Short2LongAVLTreeMap short2LongAVLTreeMap, short s) {
            this.this$0 = short2LongAVLTreeMap;
            super(short2LongAVLTreeMap, s);
        }
        ...
        public void add(Object object) {
            this.add((Short2LongMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Short2LongMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2LongAVLTreeMap short2LongAVLTreeMap) {
            this.this$0 = short2LongAVLTreeMap;
            this.index = 0;
            this.next = short2LongAVLTreeMap.firstEntry;
        }

        TreeIterator(Short2LongAVLTreeMap short2LongAVLTreeMap, short s) {
            this.this$0 = short2LongAVLTreeMap;
            this.index = 0;
            this.next = short2LongAVLTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2LongAVLTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Short)entry.getKey() && this.value == (Long)entry.getValue();
        }
