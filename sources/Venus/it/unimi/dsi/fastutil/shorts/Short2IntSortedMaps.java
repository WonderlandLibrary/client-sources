...
public final class Short2IntSortedMaps {
    ...
    public static Comparator<? super Map.Entry<Short, ?>> entryComparator(ShortComparator shortComparator) {
        return (arg_0, arg_1) -> Short2IntSortedMaps.lambda$entryComparator$0(shortComparator, arg_0, arg_1);
    }

    public static ObjectBidirectionalIterator<Short2IntMap.Entry> fastIterator(Short2IntSortedMap short2IntSortedMap) {
        ObjectSet objectSet = short2IntSortedMap.short2IntEntrySet();
        return objectSet instanceof Short2IntSortedMap.FastSortedEntrySet ? ((Short2IntSortedMap.FastSortedEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }

    public static ObjectBidirectionalIterable<Short2IntMap.Entry> fastIterable(Short2IntSortedMap short2IntSortedMap) {
        ObjectSet objectSet = short2IntSortedMap.short2IntEntrySet();
        return objectSet instanceof Short2IntSortedMap.FastSortedEntrySet ? ((Short2IntSortedMap.FastSortedEntrySet)objectSet)::fastIterator : objectSet;
    }

    public static Short2IntSortedMap singleton(Short s, Integer n) {
        return new Singleton(s, n);
    }

    public static Short2IntSortedMap singleton(Short s, Integer n, ShortComparator shortComparator) {
        return new Singleton(s, n, shortComparator);
    }

    public static Short2IntSortedMap singleton(short s, int n) {
        return new Singleton(s, n);
    }

    public static Short2IntSortedMap singleton(short s, int n, ShortComparator shortComparator) {
        return new Singleton(s, n, shortComparator);
    }

    public static Short2IntSortedMap synchronize(Short2IntSortedMap short2IntSortedMap) {
        return new SynchronizedSortedMap(short2IntSortedMap);
    }

    public static Short2IntSortedMap synchronize(Short2IntSortedMap short2IntSortedMap, Object object) {
        return new SynchronizedSortedMap(short2IntSortedMap, object);
    }

    public static Short2IntSortedMap unmodifiable(Short2IntSortedMap short2IntSortedMap) {
        return new UnmodifiableSortedMap(short2IntSortedMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableSortedMap(Short2IntSortedMap short2IntSortedMap) {
            super(short2IntSortedMap);
            this.sortedMap = short2IntSortedMap;
        }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Short2IntSortedMap short2IntSortedMap, Object object) {
            super(short2IntSortedMap, object);
            this.sortedMap = short2IntSortedMap;
        }

        protected SynchronizedSortedMap(Short2IntSortedMap short2IntSortedMap) {
            super(short2IntSortedMap);
            this.sortedMap = short2IntSortedMap;
        }
    ...
    Cloneable {
        ...
        protected Singleton(short s, int n, ShortComparator shortComparator) {
            super(s, n);
