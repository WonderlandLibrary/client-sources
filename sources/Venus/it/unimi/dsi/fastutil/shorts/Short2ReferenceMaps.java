...
public final class Short2ReferenceMaps {
    ...
    public static <V> ObjectIterator<Short2ReferenceMap.Entry<V>> fastIterator(Short2ReferenceMap<V> short2ReferenceMap) {
        ObjectSet<Short2ReferenceMap.Entry<V>> objectSet = short2ReferenceMap.short2ReferenceEntrySet();
        return objectSet instanceof Short2ReferenceMap.FastEntrySet ? ((Short2ReferenceMap.FastEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }
    ...
    public static <V> void fastForEach(Short2ReferenceMap<V> short2ReferenceMap, Consumer<? super Short2ReferenceMap.Entry<V>> consumer) {
        ObjectSet<Short2ReferenceMap.Entry<V>> objectSet = short2ReferenceMap.short2ReferenceEntrySet();
        if (objectSet instanceof Short2ReferenceMap.FastEntrySet) {
            ((Short2ReferenceMap.FastEntrySet)objectSet).fastForEach(consumer);
        } else {
    ...
    public static <V> ObjectIterable<Short2ReferenceMap.Entry<V>> fastIterable(Short2ReferenceMap<V> short2ReferenceMap) {
        ObjectSet<Short2ReferenceMap.Entry<V>> objectSet = short2ReferenceMap.short2ReferenceEntrySet();
        return objectSet instanceof Short2ReferenceMap.FastEntrySet ? new ObjectIterable<Short2ReferenceMap.Entry<V>>(objectSet){
            ...
            public ObjectIterator<Short2ReferenceMap.Entry<V>> iterator() {
                return ((Short2ReferenceMap.FastEntrySet)this.val$entries).fastIterator();
            }

            @Override
            public void forEach(Consumer<? super Short2ReferenceMap.Entry<V>> consumer) {
                ((Short2ReferenceMap.FastEntrySet)this.val$entries).fastForEach(consumer);
            }
    ...
    public static <V> Short2ReferenceMap<V> synchronize(Short2ReferenceMap<V> short2ReferenceMap) {
        return new SynchronizedMap<V>(short2ReferenceMap);
    }

    public static <V> Short2ReferenceMap<V> synchronize(Short2ReferenceMap<V> short2ReferenceMap, Object object) {
        return new SynchronizedMap<V>(short2ReferenceMap, object);
    }

    public static <V> Short2ReferenceMap<V> unmodifiable(Short2ReferenceMap<V> short2ReferenceMap) {
        return new UnmodifiableMap<V>(short2ReferenceMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableMap(Short2ReferenceMap<V> short2ReferenceMap) {
        ...
        @Override
        public V computeIfAbsentPartial(short s, Short2ReferenceFunction<? extends V> short2ReferenceFunction) {
            throw new UnsupportedOperationException();
        }
    ...
    Serializable {
        ...
        protected SynchronizedMap(Short2ReferenceMap<V> short2ReferenceMap, Object object) {
            super(short2ReferenceMap, object);
            this.map = short2ReferenceMap;
        }

        protected SynchronizedMap(Short2ReferenceMap<V> short2ReferenceMap) {
            super(short2ReferenceMap);
            this.map = short2ReferenceMap;
        }
        ...
        public V computeIfAbsentPartial(short s, Short2ReferenceFunction<? extends V> short2ReferenceFunction) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.computeIfAbsentPartial(s, short2ReferenceFunction);
            }
        }
