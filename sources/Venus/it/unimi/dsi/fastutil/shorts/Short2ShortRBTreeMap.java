...
Cloneable {
    ...
    public Short2ShortRBTreeMap(Comparator<? super Short> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Short2ShortRBTreeMap(Map<? extends Short, ? extends Short> map) {
        this();
        this.putAll(map);
    }

    public Short2ShortRBTreeMap(SortedMap<Short, Short> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Short, ? extends Short>)sortedMap);
    }

    public Short2ShortRBTreeMap(Short2ShortMap short2ShortMap) {
        this();
        this.putAll(short2ShortMap);
    }

    public Short2ShortRBTreeMap(Short2ShortSortedMap short2ShortSortedMap) {
        this(short2ShortSortedMap.comparator());
        this.putAll(short2ShortSortedMap);
    }

    public Short2ShortRBTreeMap(short[] sArray, short[] sArray2, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2ShortRBTreeMap(short[] sArray, short[] sArray2) {
    ...
    public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ShortMap.Entry>(this){
                ...
                final Short2ShortRBTreeMap this$0;
                {
                    this.this$0 = short2ShortRBTreeMap;
    ...
    public Short2ShortRBTreeMap clone() {
        Short2ShortRBTreeMap short2ShortRBTreeMap;
        try {
            short2ShortRBTreeMap = (Short2ShortRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2ShortRBTreeMap.keys = null;
        short2ShortRBTreeMap.values = null;
        short2ShortRBTreeMap.entries = null;
        short2ShortRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2ShortRBTreeMap.firstEntry = short2ShortRBTreeMap.tree = entry2.left;
                            while (short2ShortRBTreeMap.firstEntry.left != null) {
                                short2ShortRBTreeMap.firstEntry = short2ShortRBTreeMap.firstEntry.left;
                            }
                            short2ShortRBTreeMap.lastEntry = short2ShortRBTreeMap.tree;
                            while (short2ShortRBTreeMap.lastEntry.right != null) {
                                short2ShortRBTreeMap.lastEntry = short2ShortRBTreeMap.lastEntry.right;
                            }
                            return short2ShortRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Short2ShortRBTreeMap short2ShortRBTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2ShortRBTreeMap;
            if (!bl && !bl2 && short2ShortRBTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2ShortRBTreeMap.defRetValue;
        }
    ...
    implements ShortListIterator {
        ...
        private ValueIterator(Short2ShortRBTreeMap short2ShortRBTreeMap) {
            this.this$0 = short2ShortRBTreeMap;
            super(short2ShortRBTreeMap);
        }
        ...
        ValueIterator(Short2ShortRBTreeMap short2ShortRBTreeMap, 1 var2_2) {
            this(short2ShortRBTreeMap);
        }
    }
    ...
    extends AbstractShort2ShortSortedMap.KeySet {
        ...
        private KeySet(Short2ShortRBTreeMap short2ShortRBTreeMap) {
            this.this$0 = short2ShortRBTreeMap;
            super(short2ShortRBTreeMap);
        }
        ...
        KeySet(Short2ShortRBTreeMap short2ShortRBTreeMap, 1 var2_2) {
            this(short2ShortRBTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2ShortRBTreeMap short2ShortRBTreeMap) {
            this.this$0 = short2ShortRBTreeMap;
            super(short2ShortRBTreeMap);
        }

        public KeyIterator(Short2ShortRBTreeMap short2ShortRBTreeMap, short s) {
            this.this$0 = short2ShortRBTreeMap;
            super(short2ShortRBTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2ShortMap.Entry> {
        ...
        EntryIterator(Short2ShortRBTreeMap short2ShortRBTreeMap) {
            this.this$0 = short2ShortRBTreeMap;
            super(short2ShortRBTreeMap);
        }

        EntryIterator(Short2ShortRBTreeMap short2ShortRBTreeMap, short s) {
            this.this$0 = short2ShortRBTreeMap;
            super(short2ShortRBTreeMap, s);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2ShortRBTreeMap short2ShortRBTreeMap) {
            this.this$0 = short2ShortRBTreeMap;
            this.index = 0;
            this.next = short2ShortRBTreeMap.firstEntry;
        }

        TreeIterator(Short2ShortRBTreeMap short2ShortRBTreeMap, short s) {
            this.this$0 = short2ShortRBTreeMap;
            this.index = 0;
            this.next = short2ShortRBTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2ShortRBTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
