...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Short2CharAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Short2CharAVLTreeMap(Comparator<? super Short> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Short2CharAVLTreeMap(Map<? extends Short, ? extends Character> map) {
        this();
        this.putAll(map);
    }

    public Short2CharAVLTreeMap(SortedMap<Short, Character> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Short, ? extends Character>)sortedMap);
    }

    public Short2CharAVLTreeMap(Short2CharMap short2CharMap) {
        this();
        this.putAll(short2CharMap);
    }

    public Short2CharAVLTreeMap(Short2CharSortedMap short2CharSortedMap) {
        this(short2CharSortedMap.comparator());
        this.putAll(short2CharSortedMap);
    }

    public Short2CharAVLTreeMap(short[] sArray, char[] cArray, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2CharAVLTreeMap(short[] sArray, char[] cArray) {
        this(sArray, cArray, null);
    }
    ...
    public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>(this){
                final Comparator<? super Short2CharMap.Entry> comparator;
                final Short2CharAVLTreeMap this$0;
                {
                    this.this$0 = short2CharAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator(Short2CharMap.Entry entry) {
                ...
                public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry entry, Short2CharMap.Entry entry2) {
                    return this.this$0.subMap(entry.getShortKey(), entry2.getShortKey()).short2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry entry) {
                    return this.this$0.headMap(entry.getShortKey()).short2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry entry) {
                    return this.this$0.tailMap(entry.getShortKey()).short2CharEntrySet();
                }
                ...
                private int lambda$$0(Short2CharMap.Entry entry, Short2CharMap.Entry entry2) {
    ...
    public Short2CharAVLTreeMap clone() {
        Short2CharAVLTreeMap short2CharAVLTreeMap;
        try {
            short2CharAVLTreeMap = (Short2CharAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2CharAVLTreeMap.keys = null;
        short2CharAVLTreeMap.values = null;
        short2CharAVLTreeMap.entries = null;
        short2CharAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2CharAVLTreeMap.firstEntry = short2CharAVLTreeMap.tree = entry2.left;
                            while (short2CharAVLTreeMap.firstEntry.left != null) {
                                short2CharAVLTreeMap.firstEntry = short2CharAVLTreeMap.firstEntry.left;
                            }
                            short2CharAVLTreeMap.lastEntry = short2CharAVLTreeMap.tree;
                            while (short2CharAVLTreeMap.lastEntry.right != null) {
                                short2CharAVLTreeMap.lastEntry = short2CharAVLTreeMap.lastEntry.right;
                            }
                            return short2CharAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readShort(), objectInputStream.readChar());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readShort(), objectInputStream.readChar());
            entry4.right(new Entry(objectInputStream.readShort(), objectInputStream.readChar()));
    ...
    implements Serializable {
        ...
        public Submap(Short2CharAVLTreeMap short2CharAVLTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2CharAVLTreeMap;
            if (!bl && !bl2 && short2CharAVLTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2CharAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Short2CharMap.Entry> comparator() {
                        return this.this$1.this$0.short2CharEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry entry, Short2CharMap.Entry entry2) {
                        return this.this$1.subMap(entry.getShortKey(), entry2.getShortKey()).short2CharEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry entry) {
                        return this.this$1.headMap(entry.getShortKey()).short2CharEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry entry) {
                        return this.this$1.tailMap(entry.getShortKey()).short2CharEntrySet();
                    }
    ...
    implements CharListIterator {
        ...
        private ValueIterator(Short2CharAVLTreeMap short2CharAVLTreeMap) {
            this.this$0 = short2CharAVLTreeMap;
            super(short2CharAVLTreeMap);
        }
        ...
        ValueIterator(Short2CharAVLTreeMap short2CharAVLTreeMap, 1 var2_2) {
            this(short2CharAVLTreeMap);
        }
    }
    ...
    extends AbstractShort2CharSortedMap.KeySet {
        ...
        private KeySet(Short2CharAVLTreeMap short2CharAVLTreeMap) {
            this.this$0 = short2CharAVLTreeMap;
            super(short2CharAVLTreeMap);
        }
        ...
        KeySet(Short2CharAVLTreeMap short2CharAVLTreeMap, 1 var2_2) {
            this(short2CharAVLTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2CharAVLTreeMap short2CharAVLTreeMap) {
            this.this$0 = short2CharAVLTreeMap;
            super(short2CharAVLTreeMap);
        }

        public KeyIterator(Short2CharAVLTreeMap short2CharAVLTreeMap, short s) {
            this.this$0 = short2CharAVLTreeMap;
            super(short2CharAVLTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2CharMap.Entry> {
        ...
        EntryIterator(Short2CharAVLTreeMap short2CharAVLTreeMap) {
            this.this$0 = short2CharAVLTreeMap;
            super(short2CharAVLTreeMap);
        }

        EntryIterator(Short2CharAVLTreeMap short2CharAVLTreeMap, short s) {
            this.this$0 = short2CharAVLTreeMap;
            super(short2CharAVLTreeMap, s);
        }
        ...
        public void add(Object object) {
            this.add((Short2CharMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Short2CharMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2CharAVLTreeMap short2CharAVLTreeMap) {
            this.this$0 = short2CharAVLTreeMap;
            this.index = 0;
            this.next = short2CharAVLTreeMap.firstEntry;
        }

        TreeIterator(Short2CharAVLTreeMap short2CharAVLTreeMap, short s) {
            this.this$0 = short2CharAVLTreeMap;
            this.index = 0;
            this.next = short2CharAVLTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2CharAVLTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Short)entry.getKey() && this.value == ((Character)entry.getValue()).charValue();
        }
