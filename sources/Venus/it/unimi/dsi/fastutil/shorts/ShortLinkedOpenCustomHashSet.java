...
Hash {
    ...
    public ShortLinkedOpenCustomHashSet(int n, float f, ShortHash.Strategy strategy) {
    ...
    public ShortLinkedOpenCustomHashSet(int n, ShortHash.Strategy strategy) {
    ...
    public ShortLinkedOpenCustomHashSet(Collection<? extends Short> collection, float f, ShortHash.Strategy strategy) {
        this(collection.size(), f, strategy);
        this.addAll(collection);
    }

    public ShortLinkedOpenCustomHashSet(Collection<? extends Short> collection, ShortHash.Strategy strategy) {
        this(collection, 0.75f, strategy);
    }

    public ShortLinkedOpenCustomHashSet(ShortCollection shortCollection, float f, ShortHash.Strategy strategy) {
        this(shortCollection.size(), f, strategy);
        this.addAll(shortCollection);
    }

    public ShortLinkedOpenCustomHashSet(ShortCollection shortCollection, ShortHash.Strategy strategy) {
        this(shortCollection, 0.75f, strategy);
    }

    public ShortLinkedOpenCustomHashSet(ShortIterator shortIterator, float f, ShortHash.Strategy strategy) {
        this(16, f, strategy);
    ...
    public ShortLinkedOpenCustomHashSet(ShortIterator shortIterator, ShortHash.Strategy strategy) {
        this(shortIterator, 0.75f, strategy);
    }

    public ShortLinkedOpenCustomHashSet(Iterator<?> iterator2, float f, ShortHash.Strategy strategy) {
        this(ShortIterators.asShortIterator(iterator2), f, strategy);
    }

    public ShortLinkedOpenCustomHashSet(Iterator<?> iterator2, ShortHash.Strategy strategy) {
        this(ShortIterators.asShortIterator(iterator2), strategy);
    }

    public ShortLinkedOpenCustomHashSet(short[] sArray, int n, int n2, float f, ShortHash.Strategy strategy) {
    ...
    public ShortLinkedOpenCustomHashSet(short[] sArray, int n, int n2, ShortHash.Strategy strategy) {
        this(sArray, n, n2, 0.75f, strategy);
    }

    public ShortLinkedOpenCustomHashSet(short[] sArray, float f, ShortHash.Strategy strategy) {
        this(sArray, 0, sArray.length, f, strategy);
    }

    public ShortLinkedOpenCustomHashSet(short[] sArray, ShortHash.Strategy strategy) {
    ...
    public boolean addAndMoveToFirst(short s) {
        ...
        if (this.strategy.equals(s, (short)0)) {
            ...
            n = HashCommon.mix(this.strategy.hashCode(s)) & this.mask;
            while (sArray[n] != 0) {
                if (this.strategy.equals(s, sArray[n])) {
    ...
    protected void rehash(int n) {
        ...
        while (n6-- != 0) {
            int n7;
            if (this.strategy.equals(sArray[n3], (short)0)) {
                n7 = n;
            } else {
                n7 = HashCommon.mix(this.strategy.hashCode(sArray[n3])) & n2;
                while (sArray2[n7] != 0) {
                    n7 = n7 + 1 & n2;
                }
            }
    ...
    public ShortLinkedOpenCustomHashSet clone() {
        ShortLinkedOpenCustomHashSet shortLinkedOpenCustomHashSet;
        try {
            shortLinkedOpenCustomHashSet = (ShortLinkedOpenCustomHashSet)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        shortLinkedOpenCustomHashSet.key = (short[])this.key.clone();
        shortLinkedOpenCustomHashSet.containsNull = this.containsNull;
        shortLinkedOpenCustomHashSet.link = (long[])this.link.clone();
        shortLinkedOpenCustomHashSet.strategy = this.strategy;
        return shortLinkedOpenCustomHashSet;
    }
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) throws IOException {
        ...
        int n = this.size;
        while (n-- != 0) {
            objectOutputStream.writeShort(shortListIterator.nextShort());
        }
    }
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        while (n2-- != 0) {
            ...
            if (this.strategy.equals(s, (short)0)) {
                ...
                n3 = HashCommon.mix(this.strategy.hashCode(s)) & this.mask;
                if (sArray[n3] != 0) {
                    while (sArray[n3 = n3 + 1 & this.mask] != 0) {
                    }
                }
            }
            sArray[n3] = s;
    ...
    implements ShortListIterator {
        ...
        int curr;
        int index;
        final ShortLinkedOpenCustomHashSet this$0;

        SetIterator(ShortLinkedOpenCustomHashSet shortLinkedOpenCustomHashSet) {
            this.this$0 = shortLinkedOpenCustomHashSet;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = shortLinkedOpenCustomHashSet.first;
            this.index = 0;
        }

        SetIterator(ShortLinkedOpenCustomHashSet shortLinkedOpenCustomHashSet, short s) {
            this.this$0 = shortLinkedOpenCustomHashSet;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (shortLinkedOpenCustomHashSet.strategy.equals(s, (short)0)) {
                if (shortLinkedOpenCustomHashSet.containsNull) {
                    this.next = (int)shortLinkedOpenCustomHashSet.link[shortLinkedOpenCustomHashSet.n];
                    this.prev = shortLinkedOpenCustomHashSet.n;
                    return;
                }
                throw new NoSuchElementException("The key " + s + " does not belong to this set.");
            }
            if (shortLinkedOpenCustomHashSet.strategy.equals(shortLinkedOpenCustomHashSet.key[shortLinkedOpenCustomHashSet.last], s)) {
                this.prev = shortLinkedOpenCustomHashSet.last;
                this.index = shortLinkedOpenCustomHashSet.size;
                return;
            }
            short[] sArray = shortLinkedOpenCustomHashSet.key;
            int n = HashCommon.mix(shortLinkedOpenCustomHashSet.strategy.hashCode(s)) & shortLinkedOpenCustomHashSet.mask;
            while (sArray[n] != 0) {
                if (shortLinkedOpenCustomHashSet.strategy.equals(sArray[n], s)) {
                    this.next = (int)shortLinkedOpenCustomHashSet.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & shortLinkedOpenCustomHashSet.mask;
            }
            throw new NoSuchElementException("The key " + s + " does not belong to this set.");
        }
