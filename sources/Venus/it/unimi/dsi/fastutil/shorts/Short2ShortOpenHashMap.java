...
Hash {
    ...
    public Short2ShortOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Short2ShortOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Short2ShortOpenHashMap(Map<? extends Short, ? extends Short> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Short2ShortOpenHashMap(Map<? extends Short, ? extends Short> map) {
        this(map, 0.75f);
    }

    public Short2ShortOpenHashMap(Short2ShortMap short2ShortMap, float f) {
        this(short2ShortMap.size(), f);
        this.putAll(short2ShortMap);
    }

    public Short2ShortOpenHashMap(Short2ShortMap short2ShortMap) {
        this(short2ShortMap, 0.75f);
    }

    public Short2ShortOpenHashMap(short[] sArray, short[] sArray2, float f) {
    ...
    public Short2ShortOpenHashMap(short[] sArray, short[] sArray2) {
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection(this){
                final Short2ShortOpenHashMap this$0;
                {
                    this.this$0 = short2ShortOpenHashMap;
                }
    ...
    public Short2ShortOpenHashMap clone() {
        ...
        try {
            short2ShortOpenHashMap = (Short2ShortOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2ShortOpenHashMap.keys = null;
        short2ShortOpenHashMap.values = null;
        short2ShortOpenHashMap.entries = null;
        short2ShortOpenHashMap.containsNullKey = this.containsNullKey;
        short2ShortOpenHashMap.key = (short[])this.key.clone();
        short2ShortOpenHashMap.value = (short[])this.value.clone();
    ...
    static short access$300(Short2ShortOpenHashMap short2ShortOpenHashMap) {
        return short2ShortOpenHashMap.removeNullEntry();
    }

    static short access$400(Short2ShortOpenHashMap short2ShortOpenHashMap, int n) {
        return short2ShortOpenHashMap.removeEntry(n);
    }
    ...
    implements ShortIterator {
        ...
        public ValueIterator(Short2ShortOpenHashMap short2ShortOpenHashMap) {
            this.this$0 = short2ShortOpenHashMap;
            super(short2ShortOpenHashMap, null);
        }
    ...
    extends AbstractShortSet {
        ...
        private KeySet(Short2ShortOpenHashMap short2ShortOpenHashMap) {
            this.this$0 = short2ShortOpenHashMap;
        }
        ...
        KeySet(Short2ShortOpenHashMap short2ShortOpenHashMap, 1 var2_2) {
            this(short2ShortOpenHashMap);
        }
    }
    ...
    implements ShortIterator {
        ...
        public KeyIterator(Short2ShortOpenHashMap short2ShortOpenHashMap) {
            this.this$0 = short2ShortOpenHashMap;
            super(short2ShortOpenHashMap, null);
        }
    ...
    implements Short2ShortMap.FastEntrySet {
        ...
        private MapEntrySet(Short2ShortOpenHashMap short2ShortOpenHashMap) {
            this.this$0 = short2ShortOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (s == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == s2) {
                    Short2ShortOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (s3 == s) {
                if (this.this$0.value[n] == s2) {
                    Short2ShortOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Short2ShortOpenHashMap short2ShortOpenHashMap, 1 var2_2) {
            this(short2ShortOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2ShortMap.Entry> {
        ...
        private FastEntryIterator(Short2ShortOpenHashMap short2ShortOpenHashMap) {
            this.this$0 = short2ShortOpenHashMap;
            super(short2ShortOpenHashMap, null);
        ...
        FastEntryIterator(Short2ShortOpenHashMap short2ShortOpenHashMap, 1 var2_2) {
            this(short2ShortOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2ShortMap.Entry> {
        ...
        private EntryIterator(Short2ShortOpenHashMap short2ShortOpenHashMap) {
            this.this$0 = short2ShortOpenHashMap;
            super(short2ShortOpenHashMap, null);
        }
        ...
        EntryIterator(Short2ShortOpenHashMap short2ShortOpenHashMap, 1 var2_2) {
            this(short2ShortOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Short2ShortOpenHashMap short2ShortOpenHashMap) {
            this.this$0 = short2ShortOpenHashMap;
        ...
        MapIterator(Short2ShortOpenHashMap short2ShortOpenHashMap, 1 var2_2) {
            this(short2ShortOpenHashMap);
        }
    }
    ...
    Map.Entry<Short, Short> {
        ...
        MapEntry(Short2ShortOpenHashMap short2ShortOpenHashMap, int n) {
            this.this$0 = short2ShortOpenHashMap;
            this.index = n;
        }

        MapEntry(Short2ShortOpenHashMap short2ShortOpenHashMap) {
            this.this$0 = short2ShortOpenHashMap;
        }
