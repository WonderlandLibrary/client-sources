...
Cloneable {
    ...
    public Short2LongRBTreeMap(Comparator<? super Short> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Short2LongRBTreeMap(Map<? extends Short, ? extends Long> map) {
        this();
        this.putAll(map);
    }

    public Short2LongRBTreeMap(SortedMap<Short, Long> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Short, ? extends Long>)sortedMap);
    }

    public Short2LongRBTreeMap(Short2LongMap short2LongMap) {
        this();
        this.putAll(short2LongMap);
    }

    public Short2LongRBTreeMap(Short2LongSortedMap short2LongSortedMap) {
        this(short2LongSortedMap.comparator());
        this.putAll(short2LongSortedMap);
    }

    public Short2LongRBTreeMap(short[] sArray, long[] lArray, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2LongRBTreeMap(short[] sArray, long[] lArray) {
    ...
    public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>(this){
                ...
                final Short2LongRBTreeMap this$0;
                {
                    this.this$0 = short2LongRBTreeMap;
    ...
    public Short2LongRBTreeMap clone() {
        Short2LongRBTreeMap short2LongRBTreeMap;
        try {
            short2LongRBTreeMap = (Short2LongRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2LongRBTreeMap.keys = null;
        short2LongRBTreeMap.values = null;
        short2LongRBTreeMap.entries = null;
        short2LongRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2LongRBTreeMap.firstEntry = short2LongRBTreeMap.tree = entry2.left;
                            while (short2LongRBTreeMap.firstEntry.left != null) {
                                short2LongRBTreeMap.firstEntry = short2LongRBTreeMap.firstEntry.left;
                            }
                            short2LongRBTreeMap.lastEntry = short2LongRBTreeMap.tree;
                            while (short2LongRBTreeMap.lastEntry.right != null) {
                                short2LongRBTreeMap.lastEntry = short2LongRBTreeMap.lastEntry.right;
                            }
                            return short2LongRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Short2LongRBTreeMap short2LongRBTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2LongRBTreeMap;
            if (!bl && !bl2 && short2LongRBTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2LongRBTreeMap.defRetValue;
        }
    ...
    implements LongListIterator {
        ...
        private ValueIterator(Short2LongRBTreeMap short2LongRBTreeMap) {
            this.this$0 = short2LongRBTreeMap;
            super(short2LongRBTreeMap);
        }
        ...
        ValueIterator(Short2LongRBTreeMap short2LongRBTreeMap, 1 var2_2) {
            this(short2LongRBTreeMap);
        }
    }
    ...
    extends AbstractShort2LongSortedMap.KeySet {
        ...
        private KeySet(Short2LongRBTreeMap short2LongRBTreeMap) {
            this.this$0 = short2LongRBTreeMap;
            super(short2LongRBTreeMap);
        }
        ...
        KeySet(Short2LongRBTreeMap short2LongRBTreeMap, 1 var2_2) {
            this(short2LongRBTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2LongRBTreeMap short2LongRBTreeMap) {
            this.this$0 = short2LongRBTreeMap;
            super(short2LongRBTreeMap);
        }

        public KeyIterator(Short2LongRBTreeMap short2LongRBTreeMap, short s) {
            this.this$0 = short2LongRBTreeMap;
            super(short2LongRBTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2LongMap.Entry> {
        ...
        EntryIterator(Short2LongRBTreeMap short2LongRBTreeMap) {
            this.this$0 = short2LongRBTreeMap;
            super(short2LongRBTreeMap);
        }

        EntryIterator(Short2LongRBTreeMap short2LongRBTreeMap, short s) {
            this.this$0 = short2LongRBTreeMap;
            super(short2LongRBTreeMap, s);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2LongRBTreeMap short2LongRBTreeMap) {
            this.this$0 = short2LongRBTreeMap;
            this.index = 0;
            this.next = short2LongRBTreeMap.firstEntry;
        }

        TreeIterator(Short2LongRBTreeMap short2LongRBTreeMap, short s) {
            this.this$0 = short2LongRBTreeMap;
            this.index = 0;
            this.next = short2LongRBTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2LongRBTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
