...
Hash {
    ...
    public Short2ByteLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Short2ByteLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Short2ByteLinkedOpenHashMap(Map<? extends Short, ? extends Byte> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Short2ByteLinkedOpenHashMap(Map<? extends Short, ? extends Byte> map) {
        this(map, 0.75f);
    }

    public Short2ByteLinkedOpenHashMap(Short2ByteMap short2ByteMap, float f) {
        this(short2ByteMap.size(), f);
        this.putAll(short2ByteMap);
    }

    public Short2ByteLinkedOpenHashMap(Short2ByteMap short2ByteMap) {
        this(short2ByteMap, 0.75f);
    }

    public Short2ByteLinkedOpenHashMap(short[] sArray, byte[] byArray, float f) {
    ...
    public Short2ByteLinkedOpenHashMap(short[] sArray, byte[] byArray) {
    ...
    public byte getAndMoveToFirst(short s) {
        if (s == 0) {
            if (this.containsNullKey) {
    ...
    public byte getAndMoveToLast(short s) {
        if (s == 0) {
            if (this.containsNullKey) {
    ...
    public byte putAndMoveToFirst(short s, byte by) {
        int n;
        if (s == 0) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public byte putAndMoveToLast(short s, byte by) {
        int n;
        if (s == 0) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection(this){
                final Short2ByteLinkedOpenHashMap this$0;
                {
                    this.this$0 = short2ByteLinkedOpenHashMap;
                }
    ...
    public Short2ByteLinkedOpenHashMap clone() {
        Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap;
        try {
            short2ByteLinkedOpenHashMap = (Short2ByteLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2ByteLinkedOpenHashMap.keys = null;
        short2ByteLinkedOpenHashMap.values = null;
        short2ByteLinkedOpenHashMap.entries = null;
        short2ByteLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        short2ByteLinkedOpenHashMap.key = (short[])this.key.clone();
        short2ByteLinkedOpenHashMap.value = (byte[])this.value.clone();
        short2ByteLinkedOpenHashMap.link = (long[])this.link.clone();
        return short2ByteLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet short2ByteEntrySet() {
    ...
    static byte access$100(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap) {
        return short2ByteLinkedOpenHashMap.removeNullEntry();
    }

    static byte access$200(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap, int n) {
        return short2ByteLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ByteListIterator {
        ...
        public ValueIterator(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap) {
            this.this$0 = short2ByteLinkedOpenHashMap;
            super(short2ByteLinkedOpenHashMap);
        }
    ...
    extends AbstractShortSortedSet {
        ...
        private KeySet(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap) {
            this.this$0 = short2ByteLinkedOpenHashMap;
        }
        ...
        KeySet(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap, 1 var2_2) {
            this(short2ByteLinkedOpenHashMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap, short s) {
            this.this$0 = short2ByteLinkedOpenHashMap;
            super(short2ByteLinkedOpenHashMap, s, null);
        }
        ...
        public KeyIterator(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap) {
            this.this$0 = short2ByteLinkedOpenHashMap;
            super(short2ByteLinkedOpenHashMap);
        }
    ...
    implements Short2ByteSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap) {
            this.this$0 = short2ByteLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry entry, Short2ByteMap.Entry entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (s == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == by) {
                    Short2ByteLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (s2 == s) {
                if (this.this$0.value[n] == by) {
                    Short2ByteLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Short2ByteMap.Entry> iterator(Short2ByteMap.Entry entry) {
        ...
        public ObjectListIterator<Short2ByteMap.Entry> fastIterator(Short2ByteMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Short2ByteMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractShort2ByteMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Short2ByteMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Short2ByteMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Short2ByteMap.Entry)object, (Short2ByteMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Short2ByteMap.Entry)object);
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Short2ByteMap.Entry entry) {
        ...
        MapEntrySet(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap, 1 var2_2) {
            this(short2ByteLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Short2ByteMap.Entry> {
        ...
        public FastEntryIterator(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap) {
            this.this$0 = short2ByteLinkedOpenHashMap;
            super(short2ByteLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap, short s) {
            this.this$0 = short2ByteLinkedOpenHashMap;
            super(short2ByteLinkedOpenHashMap, s, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Short2ByteMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Short2ByteMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Short2ByteMap.Entry> {
        ...
        public EntryIterator(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap) {
            this.this$0 = short2ByteLinkedOpenHashMap;
            super(short2ByteLinkedOpenHashMap);
        }

        public EntryIterator(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap, short s) {
            this.this$0 = short2ByteLinkedOpenHashMap;
            super(short2ByteLinkedOpenHashMap, s, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap) {
            this.this$0 = short2ByteLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = short2ByteLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap, short s) {
            this.this$0 = short2ByteLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (s == 0) {
                if (short2ByteLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)short2ByteLinkedOpenHashMap.link[short2ByteLinkedOpenHashMap.n];
                    this.prev = short2ByteLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + s + " does not belong to this map.");
            }
            if (short2ByteLinkedOpenHashMap.key[short2ByteLinkedOpenHashMap.last] == s) {
                this.prev = short2ByteLinkedOpenHashMap.last;
                this.index = short2ByteLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(s) & short2ByteLinkedOpenHashMap.mask;
            while (short2ByteLinkedOpenHashMap.key[n] != 0) {
                if (short2ByteLinkedOpenHashMap.key[n] == s) {
                    this.next = (int)short2ByteLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & short2ByteLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + s + " does not belong to this map.");
        }
        ...
        public void set(Short2ByteMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Short2ByteMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap, short s, 1 var3_3) {
            this(short2ByteLinkedOpenHashMap, s);
        }
    }
    ...
    Map.Entry<Short, Byte> {
        ...
        MapEntry(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap, int n) {
            this.this$0 = short2ByteLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Short2ByteLinkedOpenHashMap short2ByteLinkedOpenHashMap) {
            this.this$0 = short2ByteLinkedOpenHashMap;
        }
