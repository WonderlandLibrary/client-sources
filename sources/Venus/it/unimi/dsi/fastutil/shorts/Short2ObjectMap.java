...
Map<Short, V> {
    ...
    default public V put(Short s, V v) {
        return Short2ObjectFunction.super.put(s, v);
    }

    @Override
    @Deprecated
    default public V get(Object object) {
        return Short2ObjectFunction.super.get(object);
    }

    @Override
    @Deprecated
    default public V remove(Object object) {
        return Short2ObjectFunction.super.remove(object);
    }
    ...
    default public boolean containsKey(Object object) {
        return Short2ObjectFunction.super.containsKey(object);
    }
    ...
    default public boolean remove(short s, Object object) {
        Object v = this.get(s);
        if (!Objects.equals(v, object) || v == this.defaultReturnValue() && !this.containsKey(s)) {
            return true;
        }
        this.remove(s);
        return false;
    ...
    default public boolean replace(short s, V v, V v2) {
        Object v3 = this.get(s);
        if (!Objects.equals(v3, v) || v3 == this.defaultReturnValue() && !this.containsKey(s)) {
            return true;
        }
        this.put(s, v2);
        return false;
    ...
    default public V computeIfAbsentPartial(short s, Short2ObjectFunction<? extends V> short2ObjectFunction) {
        ...
        V v3 = short2ObjectFunction.get(s);
        this.put(s, v3);
        return v3;
    }
