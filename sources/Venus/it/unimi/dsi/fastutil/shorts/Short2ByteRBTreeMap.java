...
Cloneable {
    ...
    public Short2ByteRBTreeMap(Comparator<? super Short> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Short2ByteRBTreeMap(Map<? extends Short, ? extends Byte> map) {
        this();
        this.putAll(map);
    }

    public Short2ByteRBTreeMap(SortedMap<Short, Byte> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Short, ? extends Byte>)sortedMap);
    }

    public Short2ByteRBTreeMap(Short2ByteMap short2ByteMap) {
        this();
        this.putAll(short2ByteMap);
    }

    public Short2ByteRBTreeMap(Short2ByteSortedMap short2ByteSortedMap) {
        this(short2ByteSortedMap.comparator());
        this.putAll(short2ByteSortedMap);
    }

    public Short2ByteRBTreeMap(short[] sArray, byte[] byArray, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2ByteRBTreeMap(short[] sArray, byte[] byArray) {
    ...
    public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ByteMap.Entry>(this){
                ...
                final Short2ByteRBTreeMap this$0;
                {
                    this.this$0 = short2ByteRBTreeMap;
    ...
    public Short2ByteRBTreeMap clone() {
        Short2ByteRBTreeMap short2ByteRBTreeMap;
        try {
            short2ByteRBTreeMap = (Short2ByteRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2ByteRBTreeMap.keys = null;
        short2ByteRBTreeMap.values = null;
        short2ByteRBTreeMap.entries = null;
        short2ByteRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2ByteRBTreeMap.firstEntry = short2ByteRBTreeMap.tree = entry2.left;
                            while (short2ByteRBTreeMap.firstEntry.left != null) {
                                short2ByteRBTreeMap.firstEntry = short2ByteRBTreeMap.firstEntry.left;
                            }
                            short2ByteRBTreeMap.lastEntry = short2ByteRBTreeMap.tree;
                            while (short2ByteRBTreeMap.lastEntry.right != null) {
                                short2ByteRBTreeMap.lastEntry = short2ByteRBTreeMap.lastEntry.right;
                            }
                            return short2ByteRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Short2ByteRBTreeMap short2ByteRBTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2ByteRBTreeMap;
            if (!bl && !bl2 && short2ByteRBTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2ByteRBTreeMap.defRetValue;
        }
    ...
    implements ByteListIterator {
        ...
        private ValueIterator(Short2ByteRBTreeMap short2ByteRBTreeMap) {
            this.this$0 = short2ByteRBTreeMap;
            super(short2ByteRBTreeMap);
        }
        ...
        ValueIterator(Short2ByteRBTreeMap short2ByteRBTreeMap, 1 var2_2) {
            this(short2ByteRBTreeMap);
        }
    }
    ...
    extends AbstractShort2ByteSortedMap.KeySet {
        ...
        private KeySet(Short2ByteRBTreeMap short2ByteRBTreeMap) {
            this.this$0 = short2ByteRBTreeMap;
            super(short2ByteRBTreeMap);
        }
        ...
        KeySet(Short2ByteRBTreeMap short2ByteRBTreeMap, 1 var2_2) {
            this(short2ByteRBTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2ByteRBTreeMap short2ByteRBTreeMap) {
            this.this$0 = short2ByteRBTreeMap;
            super(short2ByteRBTreeMap);
        }

        public KeyIterator(Short2ByteRBTreeMap short2ByteRBTreeMap, short s) {
            this.this$0 = short2ByteRBTreeMap;
            super(short2ByteRBTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2ByteMap.Entry> {
        ...
        EntryIterator(Short2ByteRBTreeMap short2ByteRBTreeMap) {
            this.this$0 = short2ByteRBTreeMap;
            super(short2ByteRBTreeMap);
        }

        EntryIterator(Short2ByteRBTreeMap short2ByteRBTreeMap, short s) {
            this.this$0 = short2ByteRBTreeMap;
            super(short2ByteRBTreeMap, s);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2ByteRBTreeMap short2ByteRBTreeMap) {
            this.this$0 = short2ByteRBTreeMap;
            this.index = 0;
            this.next = short2ByteRBTreeMap.firstEntry;
        }

        TreeIterator(Short2ByteRBTreeMap short2ByteRBTreeMap, short s) {
            this.this$0 = short2ByteRBTreeMap;
            this.index = 0;
            this.next = short2ByteRBTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2ByteRBTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
