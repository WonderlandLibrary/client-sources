...
Cloneable {
    ...
    public Short2IntRBTreeMap(short[] sArray, int[] nArray, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2IntRBTreeMap(short[] sArray, int[] nArray) {
    ...
    public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2IntMap.Entry>(this){
                ...
                final Short2IntRBTreeMap this$0;
                {
                    this.this$0 = short2IntRBTreeMap;
    ...
    public Short2IntRBTreeMap clone() {
        Short2IntRBTreeMap short2IntRBTreeMap;
        try {
            short2IntRBTreeMap = (Short2IntRBTreeMap)super.clone();
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2IntRBTreeMap.firstEntry = short2IntRBTreeMap.tree = entry2.left;
    ...
    implements Serializable {
        ...
        public Submap(Short2IntRBTreeMap short2IntRBTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2IntRBTreeMap;
            if (!bl && !bl2 && short2IntRBTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2IntRBTreeMap.defRetValue;
        }
    ...
    implements IntListIterator {
        ...
        private ValueIterator(Short2IntRBTreeMap short2IntRBTreeMap) {
            this.this$0 = short2IntRBTreeMap;
            super(short2IntRBTreeMap);
        }
        ...
        ValueIterator(Short2IntRBTreeMap short2IntRBTreeMap, 1 var2_2) {
            this(short2IntRBTreeMap);
        }
    }
    ...
    extends AbstractShort2IntSortedMap.KeySet {
        ...
        private KeySet(Short2IntRBTreeMap short2IntRBTreeMap) {
            this.this$0 = short2IntRBTreeMap;
            super(short2IntRBTreeMap);
        }
        ...
        KeySet(Short2IntRBTreeMap short2IntRBTreeMap, 1 var2_2) {
            this(short2IntRBTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2IntRBTreeMap short2IntRBTreeMap) {
            this.this$0 = short2IntRBTreeMap;
            super(short2IntRBTreeMap);
        }

        public KeyIterator(Short2IntRBTreeMap short2IntRBTreeMap, short s) {
            this.this$0 = short2IntRBTreeMap;
            super(short2IntRBTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2IntMap.Entry> {
        ...
        EntryIterator(Short2IntRBTreeMap short2IntRBTreeMap) {
            this.this$0 = short2IntRBTreeMap;
            super(short2IntRBTreeMap);
        }

        EntryIterator(Short2IntRBTreeMap short2IntRBTreeMap, short s) {
            this.this$0 = short2IntRBTreeMap;
            super(short2IntRBTreeMap, s);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2IntRBTreeMap short2IntRBTreeMap) {
            this.this$0 = short2IntRBTreeMap;
            this.index = 0;
            this.next = short2IntRBTreeMap.firstEntry;
        }

        TreeIterator(Short2IntRBTreeMap short2IntRBTreeMap, short s) {
            this.this$0 = short2IntRBTreeMap;
            this.index = 0;
            this.next = short2IntRBTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2IntRBTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
