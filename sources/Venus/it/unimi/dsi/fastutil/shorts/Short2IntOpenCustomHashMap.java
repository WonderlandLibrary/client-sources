...
Hash {
    ...
    public Short2IntOpenCustomHashMap(int n, float f, ShortHash.Strategy strategy) {
    ...
    public Short2IntOpenCustomHashMap(int n, ShortHash.Strategy strategy) {
    ...
    public Short2IntOpenCustomHashMap(Map<? extends Short, ? extends Integer> map, float f, ShortHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Short2IntOpenCustomHashMap(Map<? extends Short, ? extends Integer> map, ShortHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Short2IntOpenCustomHashMap(Short2IntMap short2IntMap, float f, ShortHash.Strategy strategy) {
        this(short2IntMap.size(), f, strategy);
        this.putAll(short2IntMap);
    }

    public Short2IntOpenCustomHashMap(Short2IntMap short2IntMap, ShortHash.Strategy strategy) {
        this(short2IntMap, 0.75f, strategy);
    }

    public Short2IntOpenCustomHashMap(short[] sArray, int[] nArray, float f, ShortHash.Strategy strategy) {
    ...
    public Short2IntOpenCustomHashMap(short[] sArray, int[] nArray, ShortHash.Strategy strategy) {
        this(sArray, nArray, 0.75f, strategy);
    }
    ...
    public int getOrDefault(short s, int n) {
        ...
        short[] sArray = this.key;
        int n2 = HashCommon.mix(this.strategy.hashCode(s)) & this.mask;
        short s2 = sArray[n2];
        if (s2 == 0) {
            return n;
        }
    ...
    public boolean remove(short s, int n) {
        ...
        if (this.strategy.equals(s, s2) && n == this.value[n2]) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if ((s2 = sArray[n2 = n2 + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(s, s2) || n != this.value[n2]);
        this.removeEntry(n2);
        return false;
    }
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection(this){
                final Short2IntOpenCustomHashMap this$0;
                {
                    this.this$0 = short2IntOpenCustomHashMap;
                }
    ...
    public Short2IntOpenCustomHashMap clone() {
        Short2IntOpenCustomHashMap short2IntOpenCustomHashMap;
        try {
            short2IntOpenCustomHashMap = (Short2IntOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2IntOpenCustomHashMap.keys = null;
        short2IntOpenCustomHashMap.values = null;
        short2IntOpenCustomHashMap.entries = null;
        short2IntOpenCustomHashMap.containsNullKey = this.containsNullKey;
        short2IntOpenCustomHashMap.key = (short[])this.key.clone();
        short2IntOpenCustomHashMap.value = (int[])this.value.clone();
        short2IntOpenCustomHashMap.strategy = this.strategy;
        return short2IntOpenCustomHashMap;
    }
    ...
    static int access$300(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap) {
        return short2IntOpenCustomHashMap.removeNullEntry();
    }

    static int access$400(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap, int n) {
        return short2IntOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements IntIterator {
        ...
        public ValueIterator(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap) {
            this.this$0 = short2IntOpenCustomHashMap;
            super(short2IntOpenCustomHashMap, null);
        }
    ...
    extends AbstractShortSet {
        ...
        private KeySet(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap) {
            this.this$0 = short2IntOpenCustomHashMap;
        }
        ...
        KeySet(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap, 1 var2_2) {
            this(short2IntOpenCustomHashMap);
        }
    }
    ...
    implements ShortIterator {
        ...
        public KeyIterator(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap) {
            this.this$0 = short2IntOpenCustomHashMap;
            super(short2IntOpenCustomHashMap, null);
        }
    ...
    implements Short2IntMap.FastEntrySet {
        ...
        private MapEntrySet(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap) {
            this.this$0 = short2IntOpenCustomHashMap;
        }
        ...
        public boolean contains(Object object) {
            ...
            int n2 = HashCommon.mix(this.this$0.strategy.hashCode(s)) & this.this$0.mask;
            short s2 = sArray[n2];
            if (s2 == 0) {
                return true;
            }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(s, (short)0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n) {
                    Short2IntOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(s2, s)) {
                if (this.this$0.value[n2] == n) {
                    Short2IntOpenCustomHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((s2 = sArray[n2 = n2 + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(s2, s) || this.this$0.value[n2] != n);
            Short2IntOpenCustomHashMap.access$400(this.this$0, n2);
            return false;
        }
        ...
        MapEntrySet(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap, 1 var2_2) {
            this(short2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2IntMap.Entry> {
        ...
        private FastEntryIterator(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap) {
            this.this$0 = short2IntOpenCustomHashMap;
            super(short2IntOpenCustomHashMap, null);
        ...
        FastEntryIterator(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap, 1 var2_2) {
            this(short2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2IntMap.Entry> {
        ...
        private EntryIterator(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap) {
            this.this$0 = short2IntOpenCustomHashMap;
            super(short2IntOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap, 1 var2_2) {
            this(short2IntOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap) {
            this.this$0 = short2IntOpenCustomHashMap;
        ...
        MapIterator(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap, 1 var2_2) {
            this(short2IntOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Short, Integer> {
        ...
        MapEntry(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap, int n) {
            this.this$0 = short2IntOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Short2IntOpenCustomHashMap short2IntOpenCustomHashMap) {
            this.this$0 = short2IntOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Short)entry.getKey()) && this.this$0.value[this.index] == (Integer)entry.getValue();
        }
