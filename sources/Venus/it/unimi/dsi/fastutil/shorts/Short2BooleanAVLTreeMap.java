...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Short2BooleanAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Short2BooleanAVLTreeMap(Comparator<? super Short> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Short2BooleanAVLTreeMap(Map<? extends Short, ? extends Boolean> map) {
        this();
        this.putAll(map);
    }

    public Short2BooleanAVLTreeMap(SortedMap<Short, Boolean> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Short, ? extends Boolean>)sortedMap);
    }

    public Short2BooleanAVLTreeMap(Short2BooleanMap short2BooleanMap) {
        this();
        this.putAll(short2BooleanMap);
    }

    public Short2BooleanAVLTreeMap(Short2BooleanSortedMap short2BooleanSortedMap) {
        this(short2BooleanSortedMap.comparator());
        this.putAll(short2BooleanSortedMap);
    }

    public Short2BooleanAVLTreeMap(short[] sArray, boolean[] blArray, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2BooleanAVLTreeMap(short[] sArray, boolean[] blArray) {
        this(sArray, blArray, null);
    }
    ...
    public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry>(this){
                final Comparator<? super Short2BooleanMap.Entry> comparator;
                final Short2BooleanAVLTreeMap this$0;
                {
                    this.this$0 = short2BooleanAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator(Short2BooleanMap.Entry entry) {
                ...
                public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry entry, Short2BooleanMap.Entry entry2) {
                    return this.this$0.subMap(entry.getShortKey(), entry2.getShortKey()).short2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry entry) {
                    return this.this$0.headMap(entry.getShortKey()).short2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry entry) {
                    return this.this$0.tailMap(entry.getShortKey()).short2BooleanEntrySet();
                }
                ...
                private int lambda$$0(Short2BooleanMap.Entry entry, Short2BooleanMap.Entry entry2) {
    ...
    public Short2BooleanAVLTreeMap clone() {
        Short2BooleanAVLTreeMap short2BooleanAVLTreeMap;
        try {
            short2BooleanAVLTreeMap = (Short2BooleanAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2BooleanAVLTreeMap.keys = null;
        short2BooleanAVLTreeMap.values = null;
        short2BooleanAVLTreeMap.entries = null;
        short2BooleanAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2BooleanAVLTreeMap.firstEntry = short2BooleanAVLTreeMap.tree = entry2.left;
                            while (short2BooleanAVLTreeMap.firstEntry.left != null) {
                                short2BooleanAVLTreeMap.firstEntry = short2BooleanAVLTreeMap.firstEntry.left;
                            }
                            short2BooleanAVLTreeMap.lastEntry = short2BooleanAVLTreeMap.tree;
                            while (short2BooleanAVLTreeMap.lastEntry.right != null) {
                                short2BooleanAVLTreeMap.lastEntry = short2BooleanAVLTreeMap.lastEntry.right;
                            }
                            return short2BooleanAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readShort(), objectInputStream.readBoolean());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readShort(), objectInputStream.readBoolean());
            entry4.right(new Entry(objectInputStream.readShort(), objectInputStream.readBoolean()));
    ...
    implements Serializable {
        ...
        public Submap(Short2BooleanAVLTreeMap short2BooleanAVLTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2BooleanAVLTreeMap;
            if (!bl && !bl2 && short2BooleanAVLTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2BooleanAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Short2BooleanMap.Entry> comparator() {
                        return this.this$1.this$0.short2BooleanEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry entry, Short2BooleanMap.Entry entry2) {
                        return this.this$1.subMap(entry.getShortKey(), entry2.getShortKey()).short2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry entry) {
                        return this.this$1.headMap(entry.getShortKey()).short2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry entry) {
                        return this.this$1.tailMap(entry.getShortKey()).short2BooleanEntrySet();
                    }
        ...
        public boolean put(short s, boolean bl) {
            ...
            boolean bl2 = this.this$0.put(s, bl);
        ...
        public boolean remove(short s) {
            ...
            boolean bl = this.this$0.remove(s);
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Short2BooleanAVLTreeMap short2BooleanAVLTreeMap) {
            this.this$0 = short2BooleanAVLTreeMap;
            super(short2BooleanAVLTreeMap);
        }
        ...
        ValueIterator(Short2BooleanAVLTreeMap short2BooleanAVLTreeMap, 1 var2_2) {
            this(short2BooleanAVLTreeMap);
        }
    }
    ...
    extends AbstractShort2BooleanSortedMap.KeySet {
        ...
        private KeySet(Short2BooleanAVLTreeMap short2BooleanAVLTreeMap) {
            this.this$0 = short2BooleanAVLTreeMap;
            super(short2BooleanAVLTreeMap);
        }
        ...
        KeySet(Short2BooleanAVLTreeMap short2BooleanAVLTreeMap, 1 var2_2) {
            this(short2BooleanAVLTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2BooleanAVLTreeMap short2BooleanAVLTreeMap) {
            this.this$0 = short2BooleanAVLTreeMap;
            super(short2BooleanAVLTreeMap);
        }

        public KeyIterator(Short2BooleanAVLTreeMap short2BooleanAVLTreeMap, short s) {
            this.this$0 = short2BooleanAVLTreeMap;
            super(short2BooleanAVLTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2BooleanMap.Entry> {
        ...
        EntryIterator(Short2BooleanAVLTreeMap short2BooleanAVLTreeMap) {
            this.this$0 = short2BooleanAVLTreeMap;
            super(short2BooleanAVLTreeMap);
        }

        EntryIterator(Short2BooleanAVLTreeMap short2BooleanAVLTreeMap, short s) {
            this.this$0 = short2BooleanAVLTreeMap;
            super(short2BooleanAVLTreeMap, s);
        }
        ...
        public void add(Object object) {
            this.add((Short2BooleanMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Short2BooleanMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2BooleanAVLTreeMap short2BooleanAVLTreeMap) {
            this.this$0 = short2BooleanAVLTreeMap;
            this.index = 0;
            this.next = short2BooleanAVLTreeMap.firstEntry;
        }

        TreeIterator(Short2BooleanAVLTreeMap short2BooleanAVLTreeMap, short s) {
            this.this$0 = short2BooleanAVLTreeMap;
            this.index = 0;
            this.next = short2BooleanAVLTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2BooleanAVLTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Short)entry.getKey() && this.value == (Boolean)entry.getValue();
        }
