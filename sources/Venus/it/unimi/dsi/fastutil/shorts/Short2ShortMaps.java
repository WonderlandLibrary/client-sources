...
public final class Short2ShortMaps {
    ...
    public static ObjectIterator<Short2ShortMap.Entry> fastIterator(Short2ShortMap short2ShortMap) {
        ObjectSet<Short2ShortMap.Entry> objectSet = short2ShortMap.short2ShortEntrySet();
        return objectSet instanceof Short2ShortMap.FastEntrySet ? ((Short2ShortMap.FastEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }

    public static void fastForEach(Short2ShortMap short2ShortMap, Consumer<? super Short2ShortMap.Entry> consumer) {
        ObjectSet<Short2ShortMap.Entry> objectSet = short2ShortMap.short2ShortEntrySet();
        if (objectSet instanceof Short2ShortMap.FastEntrySet) {
            ((Short2ShortMap.FastEntrySet)objectSet).fastForEach(consumer);
        } else {
    ...
    public static ObjectIterable<Short2ShortMap.Entry> fastIterable(Short2ShortMap short2ShortMap) {
        ObjectSet<Short2ShortMap.Entry> objectSet = short2ShortMap.short2ShortEntrySet();
        return objectSet instanceof Short2ShortMap.FastEntrySet ? new ObjectIterable<Short2ShortMap.Entry>(objectSet){
            ...
            public ObjectIterator<Short2ShortMap.Entry> iterator() {
                return ((Short2ShortMap.FastEntrySet)this.val$entries).fastIterator();
            }

            @Override
            public void forEach(Consumer<? super Short2ShortMap.Entry> consumer) {
                ((Short2ShortMap.FastEntrySet)this.val$entries).fastForEach(consumer);
            }
    ...
    public static Short2ShortMap synchronize(Short2ShortMap short2ShortMap) {
        return new SynchronizedMap(short2ShortMap);
    }

    public static Short2ShortMap synchronize(Short2ShortMap short2ShortMap, Object object) {
        return new SynchronizedMap(short2ShortMap, object);
    }

    public static Short2ShortMap unmodifiable(Short2ShortMap short2ShortMap) {
        return new UnmodifiableMap(short2ShortMap);
    }
    ...
    Serializable {
        ...
        @Override
        public short computeIfAbsentPartial(short s, Short2ShortFunction short2ShortFunction) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        @Deprecated
        public Short computeIfAbsent(Short s, Function<? super Short, ? extends Short> function) {
            throw new UnsupportedOperationException();
        }
    ...
    Serializable {
        ...
        protected SynchronizedMap(Short2ShortMap short2ShortMap, Object object) {
            super(short2ShortMap, object);
            this.map = short2ShortMap;
        }
        ...
        public boolean replace(short s, short s2, short s3) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.replace(s, s2, s3);
            }
        }
        ...
        public short computeIfAbsentPartial(short s, Short2ShortFunction short2ShortFunction) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.computeIfAbsentPartial(s, short2ShortFunction);
            }
        }
        ...
        public short merge(short s, short s2, BiFunction<? super Short, ? super Short, ? extends Short> biFunction) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.merge(s, s2, biFunction);
            }
        }
