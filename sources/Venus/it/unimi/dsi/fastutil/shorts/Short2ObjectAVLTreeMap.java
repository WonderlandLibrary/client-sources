...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Short2ObjectAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Short2ObjectAVLTreeMap(Comparator<? super Short> comparator) {
        this();
    ...
    public Short2ObjectAVLTreeMap(SortedMap<Short, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Short, V>)sortedMap);
    }

    public Short2ObjectAVLTreeMap(Short2ObjectMap<? extends V> short2ObjectMap) {
        this();
        this.putAll(short2ObjectMap);
    }

    public Short2ObjectAVLTreeMap(Short2ObjectSortedMap<V> short2ObjectSortedMap) {
        this(short2ObjectSortedMap.comparator());
        this.putAll(short2ObjectSortedMap);
    }

    public Short2ObjectAVLTreeMap(short[] sArray, V[] VArray, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2ObjectAVLTreeMap(short[] sArray, V[] VArray) {
    ...
    public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>(this){
                ...
                final Short2ObjectAVLTreeMap this$0;
                {
                    this.this$0 = short2ObjectAVLTreeMap;
    ...
    public Short2ObjectAVLTreeMap<V> clone() {
        Short2ObjectAVLTreeMap short2ObjectAVLTreeMap;
        try {
            short2ObjectAVLTreeMap = (Short2ObjectAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2ObjectAVLTreeMap.keys = null;
        short2ObjectAVLTreeMap.values = null;
        short2ObjectAVLTreeMap.entries = null;
        short2ObjectAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2ObjectAVLTreeMap.tree = entry2.left;
                            short2ObjectAVLTreeMap.firstEntry = short2ObjectAVLTreeMap.tree;
                            while (short2ObjectAVLTreeMap.firstEntry.left != null) {
                                short2ObjectAVLTreeMap.firstEntry = short2ObjectAVLTreeMap.firstEntry.left;
                            }
                            short2ObjectAVLTreeMap.lastEntry = short2ObjectAVLTreeMap.tree;
                            while (short2ObjectAVLTreeMap.lastEntry.right != null) {
                                short2ObjectAVLTreeMap.lastEntry = short2ObjectAVLTreeMap.lastEntry.right;
                            }
                            return short2ObjectAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Short2ObjectAVLTreeMap short2ObjectAVLTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2ObjectAVLTreeMap;
            if (!bl && !bl2 && short2ObjectAVLTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2ObjectAVLTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Short2ObjectAVLTreeMap short2ObjectAVLTreeMap) {
            this.this$0 = short2ObjectAVLTreeMap;
            super(short2ObjectAVLTreeMap);
        }
        ...
        ValueIterator(Short2ObjectAVLTreeMap short2ObjectAVLTreeMap, 1 var2_2) {
            this(short2ObjectAVLTreeMap);
        }
    }
    ...
    extends AbstractShort2ObjectSortedMap.KeySet {
        ...
        private KeySet(Short2ObjectAVLTreeMap short2ObjectAVLTreeMap) {
            this.this$0 = short2ObjectAVLTreeMap;
            super(short2ObjectAVLTreeMap);
        }
        ...
        KeySet(Short2ObjectAVLTreeMap short2ObjectAVLTreeMap, 1 var2_2) {
            this(short2ObjectAVLTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2ObjectAVLTreeMap short2ObjectAVLTreeMap) {
            this.this$0 = short2ObjectAVLTreeMap;
            super(short2ObjectAVLTreeMap);
        }

        public KeyIterator(Short2ObjectAVLTreeMap short2ObjectAVLTreeMap, short s) {
            this.this$0 = short2ObjectAVLTreeMap;
            super(short2ObjectAVLTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2ObjectMap.Entry<V>> {
        ...
        EntryIterator(Short2ObjectAVLTreeMap short2ObjectAVLTreeMap) {
            this.this$0 = short2ObjectAVLTreeMap;
            super(short2ObjectAVLTreeMap);
        }

        EntryIterator(Short2ObjectAVLTreeMap short2ObjectAVLTreeMap, short s) {
            this.this$0 = short2ObjectAVLTreeMap;
            super(short2ObjectAVLTreeMap, s);
        }
        ...
        public void add(Object object) {
            this.add((Short2ObjectMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Short2ObjectMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2ObjectAVLTreeMap short2ObjectAVLTreeMap) {
            this.this$0 = short2ObjectAVLTreeMap;
            this.index = 0;
            this.next = short2ObjectAVLTreeMap.firstEntry;
        }

        TreeIterator(Short2ObjectAVLTreeMap short2ObjectAVLTreeMap, short s) {
            this.this$0 = short2ObjectAVLTreeMap;
            this.index = 0;
            this.next = short2ObjectAVLTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2ObjectAVLTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
