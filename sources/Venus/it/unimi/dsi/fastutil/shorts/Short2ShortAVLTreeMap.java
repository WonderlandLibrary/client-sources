...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Short2ShortAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Short2ShortAVLTreeMap(Comparator<? super Short> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Short2ShortAVLTreeMap(Map<? extends Short, ? extends Short> map) {
        this();
        this.putAll(map);
    }

    public Short2ShortAVLTreeMap(SortedMap<Short, Short> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Short, ? extends Short>)sortedMap);
    }

    public Short2ShortAVLTreeMap(Short2ShortMap short2ShortMap) {
        this();
        this.putAll(short2ShortMap);
    }

    public Short2ShortAVLTreeMap(Short2ShortSortedMap short2ShortSortedMap) {
        this(short2ShortSortedMap.comparator());
        this.putAll(short2ShortSortedMap);
    }

    public Short2ShortAVLTreeMap(short[] sArray, short[] sArray2, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2ShortAVLTreeMap(short[] sArray, short[] sArray2) {
        this(sArray, sArray2, null);
    }
    ...
    public short addTo(short s, short s2) {
        ...
        short s3 = entry.value;
        entry.value = (short)(entry.value + s2);
        return s3;
    }
    ...
    public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ShortMap.Entry>(this){
                final Comparator<? super Short2ShortMap.Entry> comparator;
                final Short2ShortAVLTreeMap this$0;
                {
                    this.this$0 = short2ShortAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator(Short2ShortMap.Entry entry) {
                ...
                public ObjectSortedSet<Short2ShortMap.Entry> subSet(Short2ShortMap.Entry entry, Short2ShortMap.Entry entry2) {
                    return this.this$0.subMap(entry.getShortKey(), entry2.getShortKey()).short2ShortEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2ShortMap.Entry> headSet(Short2ShortMap.Entry entry) {
                    return this.this$0.headMap(entry.getShortKey()).short2ShortEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2ShortMap.Entry> tailSet(Short2ShortMap.Entry entry) {
                    return this.this$0.tailMap(entry.getShortKey()).short2ShortEntrySet();
                }
                ...
                private int lambda$$0(Short2ShortMap.Entry entry, Short2ShortMap.Entry entry2) {
    ...
    public Short2ShortAVLTreeMap clone() {
        Short2ShortAVLTreeMap short2ShortAVLTreeMap;
        try {
            short2ShortAVLTreeMap = (Short2ShortAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2ShortAVLTreeMap.keys = null;
        short2ShortAVLTreeMap.values = null;
        short2ShortAVLTreeMap.entries = null;
        short2ShortAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2ShortAVLTreeMap.firstEntry = short2ShortAVLTreeMap.tree = entry2.left;
                            while (short2ShortAVLTreeMap.firstEntry.left != null) {
                                short2ShortAVLTreeMap.firstEntry = short2ShortAVLTreeMap.firstEntry.left;
                            }
                            short2ShortAVLTreeMap.lastEntry = short2ShortAVLTreeMap.tree;
                            while (short2ShortAVLTreeMap.lastEntry.right != null) {
                                short2ShortAVLTreeMap.lastEntry = short2ShortAVLTreeMap.lastEntry.right;
                            }
                            return short2ShortAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readShort(), objectInputStream.readShort());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readShort(), objectInputStream.readShort());
            entry4.right(new Entry(objectInputStream.readShort(), objectInputStream.readShort()));
    ...
    implements Serializable {
        ...
        public Submap(Short2ShortAVLTreeMap short2ShortAVLTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2ShortAVLTreeMap;
            if (!bl && !bl2 && short2ShortAVLTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2ShortAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2ShortMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Short2ShortMap.Entry> comparator() {
                        return this.this$1.this$0.short2ShortEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Short2ShortMap.Entry> subSet(Short2ShortMap.Entry entry, Short2ShortMap.Entry entry2) {
                        return this.this$1.subMap(entry.getShortKey(), entry2.getShortKey()).short2ShortEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Short2ShortMap.Entry> headSet(Short2ShortMap.Entry entry) {
                        return this.this$1.headMap(entry.getShortKey()).short2ShortEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Short2ShortMap.Entry> tailSet(Short2ShortMap.Entry entry) {
                        return this.this$1.tailMap(entry.getShortKey()).short2ShortEntrySet();
                    }
        ...
        public short put(short s, short s2) {
            ...
            short s3 = this.this$0.put(s, s2);
            return this.this$0.modified ? this.defRetValue : s3;
        }
        ...
        public short remove(short s) {
            ...
            short s2 = this.this$0.remove(s);
            return this.this$0.modified ? s2 : this.defRetValue;
        }
    ...
    implements ShortListIterator {
        ...
        private ValueIterator(Short2ShortAVLTreeMap short2ShortAVLTreeMap) {
            this.this$0 = short2ShortAVLTreeMap;
            super(short2ShortAVLTreeMap);
        }
        ...
        ValueIterator(Short2ShortAVLTreeMap short2ShortAVLTreeMap, 1 var2_2) {
            this(short2ShortAVLTreeMap);
        }
    }
    ...
    extends AbstractShort2ShortSortedMap.KeySet {
        ...
        private KeySet(Short2ShortAVLTreeMap short2ShortAVLTreeMap) {
            this.this$0 = short2ShortAVLTreeMap;
            super(short2ShortAVLTreeMap);
        }
        ...
        KeySet(Short2ShortAVLTreeMap short2ShortAVLTreeMap, 1 var2_2) {
            this(short2ShortAVLTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2ShortAVLTreeMap short2ShortAVLTreeMap) {
            this.this$0 = short2ShortAVLTreeMap;
            super(short2ShortAVLTreeMap);
        }

        public KeyIterator(Short2ShortAVLTreeMap short2ShortAVLTreeMap, short s) {
            this.this$0 = short2ShortAVLTreeMap;
            super(short2ShortAVLTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2ShortMap.Entry> {
        ...
        EntryIterator(Short2ShortAVLTreeMap short2ShortAVLTreeMap) {
            this.this$0 = short2ShortAVLTreeMap;
            super(short2ShortAVLTreeMap);
        }

        EntryIterator(Short2ShortAVLTreeMap short2ShortAVLTreeMap, short s) {
            this.this$0 = short2ShortAVLTreeMap;
            super(short2ShortAVLTreeMap, s);
        }
        ...
        public void add(Object object) {
            this.add((Short2ShortMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Short2ShortMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2ShortAVLTreeMap short2ShortAVLTreeMap) {
            this.this$0 = short2ShortAVLTreeMap;
            this.index = 0;
            this.next = short2ShortAVLTreeMap.firstEntry;
        }

        TreeIterator(Short2ShortAVLTreeMap short2ShortAVLTreeMap, short s) {
            this.this$0 = short2ShortAVLTreeMap;
            this.index = 0;
            this.next = short2ShortAVLTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2ShortAVLTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Short)entry.getKey() && this.value == (Short)entry.getValue();
        }
