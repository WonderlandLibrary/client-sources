...
public final class Short2CharFunctions {
    ...
    public static Short2CharFunction singleton(Short s, Character c) {
    ...
    public static Short2CharFunction synchronize(Short2CharFunction short2CharFunction, Object object) {
        return new SynchronizedFunction(short2CharFunction, object);
    }
    ...
    public static Short2CharFunction primitive(java.util.function.Function<? super Short, ? extends Character> function) {
        Objects.requireNonNull(function);
        if (function instanceof Short2CharFunction) {
            return (Short2CharFunction)function;
        }
        if (function instanceof IntUnaryOperator) {
            return arg_0 -> Short2CharFunctions.lambda$primitive$0(function, arg_0);
        }
        return new PrimitiveFunction(function);
    }

    private static char lambda$primitive$0(java.util.function.Function function, short s) {
        return SafeMath.safeIntToChar(((IntUnaryOperator)((Object)function)).applyAsInt(s));
    }
    ...
    implements Short2CharFunction {
        ...
        public char get(short s) {
            Character c = this.function.apply((Short)s);
            if (c == null) {
        ...
        @Override
        @Deprecated
        public Character put(Short s, Character c) {
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Short2CharFunction short2CharFunction) {
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Short2CharFunction short2CharFunction, Object object) {
            if (short2CharFunction == null) {
                throw new NullPointerException();
            }
            this.function = short2CharFunction;
        ...
        protected SynchronizedFunction(Short2CharFunction short2CharFunction) {
            if (short2CharFunction == null) {
                throw new NullPointerException();
            }
            this.function = short2CharFunction;
        ...
        @Override
        @Deprecated
        public Character apply(Short s) {
            Object object = this.sync;
            synchronized (object) {
                return (Character)this.function.apply(s);
            }
        }
