...
public final class Short2ByteFunctions {
    ...
    public static Short2ByteFunction singleton(short s, byte by) {
    ...
    public static Short2ByteFunction synchronize(Short2ByteFunction short2ByteFunction, Object object) {
        return new SynchronizedFunction(short2ByteFunction, object);
    }
    ...
    public static Short2ByteFunction primitive(java.util.function.Function<? super Short, ? extends Byte> function) {
        Objects.requireNonNull(function);
        if (function instanceof Short2ByteFunction) {
            return (Short2ByteFunction)function;
        }
        if (function instanceof IntUnaryOperator) {
            return arg_0 -> Short2ByteFunctions.lambda$primitive$0(function, arg_0);
        }
        return new PrimitiveFunction(function);
    }

    private static byte lambda$primitive$0(java.util.function.Function function, short s) {
        return SafeMath.safeIntToByte(((IntUnaryOperator)((Object)function)).applyAsInt(s));
    }
    ...
    implements Short2ByteFunction {
        ...
        public byte get(short s) {
            Byte by = this.function.apply((Short)s);
            if (by == null) {
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Short2ByteFunction short2ByteFunction) {
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Short2ByteFunction short2ByteFunction, Object object) {
            if (short2ByteFunction == null) {
                throw new NullPointerException();
            }
            this.function = short2ByteFunction;
        ...
        protected SynchronizedFunction(Short2ByteFunction short2ByteFunction) {
            if (short2ByteFunction == null) {
                throw new NullPointerException();
            }
            this.function = short2ByteFunction;
        ...
        public Byte apply(Short s) {
            Object object = this.sync;
            synchronized (object) {
                return (Byte)this.function.apply(s);
            }
        }
