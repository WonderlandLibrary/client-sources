...
implements Short2ObjectSortedMap<V> {
    ...
    implements ObjectIterator<V> {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> objectBidirectionalIterator) {
    ...
    extends AbstractObjectCollection<V> {
        final AbstractShort2ObjectSortedMap this$0;

        protected ValuesCollection(AbstractShort2ObjectSortedMap abstractShort2ObjectSortedMap) {
            this.this$0 = abstractShort2ObjectSortedMap;
        }

        @Override
        public ObjectIterator<V> iterator() {
            return new ValuesIterator(Short2ObjectSortedMaps.fastIterator(this.this$0));
        }
    ...
    implements ShortBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> objectBidirectionalIterator) {
            this.i = objectBidirectionalIterator;
        }
    ...
    extends AbstractShortSortedSet {
        ...
        protected KeySet(AbstractShort2ObjectSortedMap abstractShort2ObjectSortedMap) {
            this.this$0 = abstractShort2ObjectSortedMap;
        }
        ...
        public ShortBidirectionalIterator iterator(short s) {
            return new KeySetIterator(this.this$0.short2ObjectEntrySet().iterator(new AbstractShort2ObjectMap.BasicEntry<Object>(s, null)));
        }

        @Override
        public ShortBidirectionalIterator iterator() {
            return new KeySetIterator(Short2ObjectSortedMaps.fastIterator(this.this$0));
        }
