...
Cloneable {
    ...
    public Short2ReferenceRBTreeMap(Comparator<? super Short> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Short2ReferenceRBTreeMap(Map<? extends Short, ? extends V> map) {
        this();
        this.putAll((Map<Short, ? extends V>)map);
    }

    public Short2ReferenceRBTreeMap(SortedMap<Short, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Short, V>)sortedMap);
    }

    public Short2ReferenceRBTreeMap(Short2ReferenceMap<? extends V> short2ReferenceMap) {
        this();
        this.putAll(short2ReferenceMap);
    }

    public Short2ReferenceRBTreeMap(Short2ReferenceSortedMap<V> short2ReferenceSortedMap) {
        this(short2ReferenceSortedMap.comparator());
        this.putAll(short2ReferenceSortedMap);
    }

    public Short2ReferenceRBTreeMap(short[] sArray, V[] VArray, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2ReferenceRBTreeMap(short[] sArray, V[] VArray) {
    ...
    public ObjectSortedSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ReferenceMap.Entry<V>>(this){
                ...
                final Short2ReferenceRBTreeMap this$0;
                {
                    this.this$0 = short2ReferenceRBTreeMap;
    ...
    public Short2ReferenceRBTreeMap<V> clone() {
        Short2ReferenceRBTreeMap short2ReferenceRBTreeMap;
        try {
            short2ReferenceRBTreeMap = (Short2ReferenceRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2ReferenceRBTreeMap.keys = null;
        short2ReferenceRBTreeMap.values = null;
        short2ReferenceRBTreeMap.entries = null;
        short2ReferenceRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2ReferenceRBTreeMap.tree = entry2.left;
                            short2ReferenceRBTreeMap.firstEntry = short2ReferenceRBTreeMap.tree;
                            while (short2ReferenceRBTreeMap.firstEntry.left != null) {
                                short2ReferenceRBTreeMap.firstEntry = short2ReferenceRBTreeMap.firstEntry.left;
                            }
                            short2ReferenceRBTreeMap.lastEntry = short2ReferenceRBTreeMap.tree;
                            while (short2ReferenceRBTreeMap.lastEntry.right != null) {
                                short2ReferenceRBTreeMap.lastEntry = short2ReferenceRBTreeMap.lastEntry.right;
                            }
                            return short2ReferenceRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Short2ReferenceRBTreeMap short2ReferenceRBTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2ReferenceRBTreeMap;
            if (!bl && !bl2 && short2ReferenceRBTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2ReferenceRBTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Short2ReferenceRBTreeMap short2ReferenceRBTreeMap) {
            this.this$0 = short2ReferenceRBTreeMap;
            super(short2ReferenceRBTreeMap);
        }
        ...
        ValueIterator(Short2ReferenceRBTreeMap short2ReferenceRBTreeMap, 1 var2_2) {
            this(short2ReferenceRBTreeMap);
        }
    }
    ...
    extends AbstractShort2ReferenceSortedMap.KeySet {
        ...
        private KeySet(Short2ReferenceRBTreeMap short2ReferenceRBTreeMap) {
            this.this$0 = short2ReferenceRBTreeMap;
            super(short2ReferenceRBTreeMap);
        }
        ...
        KeySet(Short2ReferenceRBTreeMap short2ReferenceRBTreeMap, 1 var2_2) {
            this(short2ReferenceRBTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2ReferenceRBTreeMap short2ReferenceRBTreeMap) {
            this.this$0 = short2ReferenceRBTreeMap;
            super(short2ReferenceRBTreeMap);
        }

        public KeyIterator(Short2ReferenceRBTreeMap short2ReferenceRBTreeMap, short s) {
            this.this$0 = short2ReferenceRBTreeMap;
            super(short2ReferenceRBTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2ReferenceMap.Entry<V>> {
        ...
        EntryIterator(Short2ReferenceRBTreeMap short2ReferenceRBTreeMap) {
            this.this$0 = short2ReferenceRBTreeMap;
            super(short2ReferenceRBTreeMap);
        }

        EntryIterator(Short2ReferenceRBTreeMap short2ReferenceRBTreeMap, short s) {
            this.this$0 = short2ReferenceRBTreeMap;
            super(short2ReferenceRBTreeMap, s);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2ReferenceRBTreeMap short2ReferenceRBTreeMap) {
            this.this$0 = short2ReferenceRBTreeMap;
            this.index = 0;
            this.next = short2ReferenceRBTreeMap.firstEntry;
        }

        TreeIterator(Short2ReferenceRBTreeMap short2ReferenceRBTreeMap, short s) {
            this.this$0 = short2ReferenceRBTreeMap;
            this.index = 0;
            this.next = short2ReferenceRBTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2ReferenceRBTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
