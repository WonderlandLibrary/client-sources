...
Hash {
    ...
    public Short2BooleanLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Short2BooleanLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Short2BooleanLinkedOpenHashMap(Map<? extends Short, ? extends Boolean> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Short2BooleanLinkedOpenHashMap(Map<? extends Short, ? extends Boolean> map) {
        this(map, 0.75f);
    }

    public Short2BooleanLinkedOpenHashMap(Short2BooleanMap short2BooleanMap, float f) {
        this(short2BooleanMap.size(), f);
        this.putAll(short2BooleanMap);
    }

    public Short2BooleanLinkedOpenHashMap(Short2BooleanMap short2BooleanMap) {
        this(short2BooleanMap, 0.75f);
    }

    public Short2BooleanLinkedOpenHashMap(short[] sArray, boolean[] blArray, float f) {
    ...
    public Short2BooleanLinkedOpenHashMap(short[] sArray, boolean[] blArray) {
    ...
    public boolean putAndMoveToFirst(short s, boolean bl) {
        int n;
        if (s == 0) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public boolean putAndMoveToLast(short s, boolean bl) {
        int n;
        if (s == 0) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public BooleanCollection values() {
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(this){
                final Short2BooleanLinkedOpenHashMap this$0;
                {
                    this.this$0 = short2BooleanLinkedOpenHashMap;
                }
    ...
    public Short2BooleanLinkedOpenHashMap clone() {
        Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap;
        try {
            short2BooleanLinkedOpenHashMap = (Short2BooleanLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2BooleanLinkedOpenHashMap.keys = null;
        short2BooleanLinkedOpenHashMap.values = null;
        short2BooleanLinkedOpenHashMap.entries = null;
        short2BooleanLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        short2BooleanLinkedOpenHashMap.key = (short[])this.key.clone();
        short2BooleanLinkedOpenHashMap.value = (boolean[])this.value.clone();
        short2BooleanLinkedOpenHashMap.link = (long[])this.link.clone();
        return short2BooleanLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet short2BooleanEntrySet() {
    ...
    static boolean access$100(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap) {
        return short2BooleanLinkedOpenHashMap.removeNullEntry();
    }

    static boolean access$200(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap, int n) {
        return short2BooleanLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements BooleanListIterator {
        ...
        public ValueIterator(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap) {
            this.this$0 = short2BooleanLinkedOpenHashMap;
            super(short2BooleanLinkedOpenHashMap);
        }
    ...
    extends AbstractShortSortedSet {
        ...
        private KeySet(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap) {
            this.this$0 = short2BooleanLinkedOpenHashMap;
        }
        ...
        KeySet(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap, 1 var2_2) {
            this(short2BooleanLinkedOpenHashMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap, short s) {
            this.this$0 = short2BooleanLinkedOpenHashMap;
            super(short2BooleanLinkedOpenHashMap, s, null);
        }
        ...
        public KeyIterator(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap) {
            this.this$0 = short2BooleanLinkedOpenHashMap;
            super(short2BooleanLinkedOpenHashMap);
        }
    ...
    implements Short2BooleanSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap) {
            this.this$0 = short2BooleanLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry entry, Short2BooleanMap.Entry entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (s == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == bl) {
                    Short2BooleanLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (s2 == s) {
                if (this.this$0.value[n] == bl) {
                    Short2BooleanLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Short2BooleanMap.Entry> iterator(Short2BooleanMap.Entry entry) {
        ...
        public ObjectListIterator<Short2BooleanMap.Entry> fastIterator(Short2BooleanMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Short2BooleanMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractShort2BooleanMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Short2BooleanMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Short2BooleanMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Short2BooleanMap.Entry)object, (Short2BooleanMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Short2BooleanMap.Entry)object);
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Short2BooleanMap.Entry entry) {
        ...
        MapEntrySet(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap, 1 var2_2) {
            this(short2BooleanLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Short2BooleanMap.Entry> {
        ...
        public FastEntryIterator(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap) {
            this.this$0 = short2BooleanLinkedOpenHashMap;
            super(short2BooleanLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap, short s) {
            this.this$0 = short2BooleanLinkedOpenHashMap;
            super(short2BooleanLinkedOpenHashMap, s, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Short2BooleanMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Short2BooleanMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Short2BooleanMap.Entry> {
        ...
        public EntryIterator(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap) {
            this.this$0 = short2BooleanLinkedOpenHashMap;
            super(short2BooleanLinkedOpenHashMap);
        }

        public EntryIterator(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap, short s) {
            this.this$0 = short2BooleanLinkedOpenHashMap;
            super(short2BooleanLinkedOpenHashMap, s, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap) {
            this.this$0 = short2BooleanLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = short2BooleanLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap, short s) {
            this.this$0 = short2BooleanLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (s == 0) {
                if (short2BooleanLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)short2BooleanLinkedOpenHashMap.link[short2BooleanLinkedOpenHashMap.n];
                    this.prev = short2BooleanLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + s + " does not belong to this map.");
            }
            if (short2BooleanLinkedOpenHashMap.key[short2BooleanLinkedOpenHashMap.last] == s) {
                this.prev = short2BooleanLinkedOpenHashMap.last;
                this.index = short2BooleanLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(s) & short2BooleanLinkedOpenHashMap.mask;
            while (short2BooleanLinkedOpenHashMap.key[n] != 0) {
                if (short2BooleanLinkedOpenHashMap.key[n] == s) {
                    this.next = (int)short2BooleanLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & short2BooleanLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + s + " does not belong to this map.");
        }
        ...
        public void set(Short2BooleanMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Short2BooleanMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap, short s, 1 var3_3) {
            this(short2BooleanLinkedOpenHashMap, s);
        }
    }
    ...
    Map.Entry<Short, Boolean> {
        ...
        MapEntry(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap, int n) {
            this.this$0 = short2BooleanLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Short2BooleanLinkedOpenHashMap short2BooleanLinkedOpenHashMap) {
            this.this$0 = short2BooleanLinkedOpenHashMap;
        }
