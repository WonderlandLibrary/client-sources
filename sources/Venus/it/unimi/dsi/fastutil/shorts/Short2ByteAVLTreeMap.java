...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Short2ByteAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Short2ByteAVLTreeMap(Comparator<? super Short> comparator) {
        this();
    ...
    public Short2ByteAVLTreeMap(SortedMap<Short, Byte> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Short, ? extends Byte>)sortedMap);
    }

    public Short2ByteAVLTreeMap(Short2ByteMap short2ByteMap) {
        this();
        this.putAll(short2ByteMap);
    }

    public Short2ByteAVLTreeMap(Short2ByteSortedMap short2ByteSortedMap) {
        this(short2ByteSortedMap.comparator());
        this.putAll(short2ByteSortedMap);
    }

    public Short2ByteAVLTreeMap(short[] sArray, byte[] byArray, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2ByteAVLTreeMap(short[] sArray, byte[] byArray) {
        this(sArray, byArray, null);
    }
    ...
    public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ByteMap.Entry>(this){
                final Comparator<? super Short2ByteMap.Entry> comparator;
                final Short2ByteAVLTreeMap this$0;
                {
                    this.this$0 = short2ByteAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator(Short2ByteMap.Entry entry) {
                ...
                public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry entry, Short2ByteMap.Entry entry2) {
                    return this.this$0.subMap(entry.getShortKey(), entry2.getShortKey()).short2ByteEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry entry) {
                    return this.this$0.headMap(entry.getShortKey()).short2ByteEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry entry) {
                    return this.this$0.tailMap(entry.getShortKey()).short2ByteEntrySet();
                }
                ...
                private int lambda$$0(Short2ByteMap.Entry entry, Short2ByteMap.Entry entry2) {
    ...
    public Short2ByteAVLTreeMap clone() {
        Short2ByteAVLTreeMap short2ByteAVLTreeMap;
        try {
            short2ByteAVLTreeMap = (Short2ByteAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2ByteAVLTreeMap.keys = null;
        short2ByteAVLTreeMap.values = null;
        short2ByteAVLTreeMap.entries = null;
        short2ByteAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2ByteAVLTreeMap.firstEntry = short2ByteAVLTreeMap.tree = entry2.left;
                            while (short2ByteAVLTreeMap.firstEntry.left != null) {
                                short2ByteAVLTreeMap.firstEntry = short2ByteAVLTreeMap.firstEntry.left;
                            }
                            short2ByteAVLTreeMap.lastEntry = short2ByteAVLTreeMap.tree;
                            while (short2ByteAVLTreeMap.lastEntry.right != null) {
                                short2ByteAVLTreeMap.lastEntry = short2ByteAVLTreeMap.lastEntry.right;
                            }
                            return short2ByteAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readShort(), objectInputStream.readByte());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readShort(), objectInputStream.readByte());
            entry4.right(new Entry(objectInputStream.readShort(), objectInputStream.readByte()));
    ...
    implements Serializable {
        ...
        public Submap(Short2ByteAVLTreeMap short2ByteAVLTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2ByteAVLTreeMap;
            if (!bl && !bl2 && short2ByteAVLTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2ByteAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2ByteMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Short2ByteMap.Entry> comparator() {
                        return this.this$1.this$0.short2ByteEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry entry, Short2ByteMap.Entry entry2) {
                        return this.this$1.subMap(entry.getShortKey(), entry2.getShortKey()).short2ByteEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry entry) {
                        return this.this$1.headMap(entry.getShortKey()).short2ByteEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry entry) {
                        return this.this$1.tailMap(entry.getShortKey()).short2ByteEntrySet();
                    }
    ...
    implements ByteListIterator {
        ...
        private ValueIterator(Short2ByteAVLTreeMap short2ByteAVLTreeMap) {
            this.this$0 = short2ByteAVLTreeMap;
            super(short2ByteAVLTreeMap);
        }
        ...
        ValueIterator(Short2ByteAVLTreeMap short2ByteAVLTreeMap, 1 var2_2) {
            this(short2ByteAVLTreeMap);
        }
    }
    ...
    extends AbstractShort2ByteSortedMap.KeySet {
        ...
        private KeySet(Short2ByteAVLTreeMap short2ByteAVLTreeMap) {
            this.this$0 = short2ByteAVLTreeMap;
            super(short2ByteAVLTreeMap);
        }
        ...
        KeySet(Short2ByteAVLTreeMap short2ByteAVLTreeMap, 1 var2_2) {
            this(short2ByteAVLTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2ByteAVLTreeMap short2ByteAVLTreeMap) {
            this.this$0 = short2ByteAVLTreeMap;
            super(short2ByteAVLTreeMap);
        }

        public KeyIterator(Short2ByteAVLTreeMap short2ByteAVLTreeMap, short s) {
            this.this$0 = short2ByteAVLTreeMap;
            super(short2ByteAVLTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2ByteMap.Entry> {
        ...
        EntryIterator(Short2ByteAVLTreeMap short2ByteAVLTreeMap) {
            this.this$0 = short2ByteAVLTreeMap;
            super(short2ByteAVLTreeMap);
        }

        EntryIterator(Short2ByteAVLTreeMap short2ByteAVLTreeMap, short s) {
            this.this$0 = short2ByteAVLTreeMap;
            super(short2ByteAVLTreeMap, s);
        }
        ...
        public void add(Object object) {
            this.add((Short2ByteMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Short2ByteMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2ByteAVLTreeMap short2ByteAVLTreeMap) {
            this.this$0 = short2ByteAVLTreeMap;
            this.index = 0;
            this.next = short2ByteAVLTreeMap.firstEntry;
        }

        TreeIterator(Short2ByteAVLTreeMap short2ByteAVLTreeMap, short s) {
            this.this$0 = short2ByteAVLTreeMap;
            this.index = 0;
            this.next = short2ByteAVLTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2ByteAVLTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Short)entry.getKey() && this.value == (Byte)entry.getValue();
        }
