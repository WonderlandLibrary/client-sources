...
Hash {
    ...
    public Short2FloatOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Short2FloatOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Short2FloatOpenHashMap(short[] sArray, float[] fArray, float f) {
    ...
    public Short2FloatOpenHashMap(short[] sArray, float[] fArray) {
    ...
    public FloatCollection values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection(this){
                final Short2FloatOpenHashMap this$0;
                {
                    this.this$0 = short2FloatOpenHashMap;
                }
    ...
    public Short2FloatOpenHashMap clone() {
        Short2FloatOpenHashMap short2FloatOpenHashMap;
        try {
            short2FloatOpenHashMap = (Short2FloatOpenHashMap)super.clone();
    ...
    static float access$300(Short2FloatOpenHashMap short2FloatOpenHashMap) {
        return short2FloatOpenHashMap.removeNullEntry();
    }

    static float access$400(Short2FloatOpenHashMap short2FloatOpenHashMap, int n) {
        return short2FloatOpenHashMap.removeEntry(n);
    }
    ...
    implements FloatIterator {
        ...
        public ValueIterator(Short2FloatOpenHashMap short2FloatOpenHashMap) {
            this.this$0 = short2FloatOpenHashMap;
            super(short2FloatOpenHashMap, null);
        }
    ...
    extends AbstractShortSet {
        ...
        private KeySet(Short2FloatOpenHashMap short2FloatOpenHashMap) {
            this.this$0 = short2FloatOpenHashMap;
        }
        ...
        KeySet(Short2FloatOpenHashMap short2FloatOpenHashMap, 1 var2_2) {
            this(short2FloatOpenHashMap);
        }
    }
    ...
    implements ShortIterator {
        ...
        public KeyIterator(Short2FloatOpenHashMap short2FloatOpenHashMap) {
            this.this$0 = short2FloatOpenHashMap;
            super(short2FloatOpenHashMap, null);
        }
    ...
    implements Short2FloatMap.FastEntrySet {
        ...
        private MapEntrySet(Short2FloatOpenHashMap short2FloatOpenHashMap) {
            this.this$0 = short2FloatOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (s == 0) {
                if (this.this$0.containsNullKey && Float.floatToIntBits(this.this$0.value[this.this$0.n]) == Float.floatToIntBits(f)) {
                    Short2FloatOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (s2 == s) {
                if (Float.floatToIntBits(this.this$0.value[n]) == Float.floatToIntBits(f)) {
                    Short2FloatOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Short2FloatOpenHashMap short2FloatOpenHashMap, 1 var2_2) {
            this(short2FloatOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2FloatMap.Entry> {
        ...
        private FastEntryIterator(Short2FloatOpenHashMap short2FloatOpenHashMap) {
            this.this$0 = short2FloatOpenHashMap;
            super(short2FloatOpenHashMap, null);
        ...
        FastEntryIterator(Short2FloatOpenHashMap short2FloatOpenHashMap, 1 var2_2) {
            this(short2FloatOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2FloatMap.Entry> {
        ...
        private EntryIterator(Short2FloatOpenHashMap short2FloatOpenHashMap) {
            this.this$0 = short2FloatOpenHashMap;
            super(short2FloatOpenHashMap, null);
        }
        ...
        EntryIterator(Short2FloatOpenHashMap short2FloatOpenHashMap, 1 var2_2) {
            this(short2FloatOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Short2FloatOpenHashMap short2FloatOpenHashMap) {
            this.this$0 = short2FloatOpenHashMap;
        ...
        MapIterator(Short2FloatOpenHashMap short2FloatOpenHashMap, 1 var2_2) {
            this(short2FloatOpenHashMap);
        }
    }
    ...
    Map.Entry<Short, Float> {
        ...
        MapEntry(Short2FloatOpenHashMap short2FloatOpenHashMap, int n) {
            this.this$0 = short2FloatOpenHashMap;
            this.index = n;
        }

        MapEntry(Short2FloatOpenHashMap short2FloatOpenHashMap) {
            this.this$0 = short2FloatOpenHashMap;
        }
