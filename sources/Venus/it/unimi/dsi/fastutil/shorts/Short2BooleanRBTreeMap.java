...
Cloneable {
    ...
    public Short2BooleanRBTreeMap(Comparator<? super Short> comparator) {
        this();
    ...
    public Short2BooleanRBTreeMap(SortedMap<Short, Boolean> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Short, ? extends Boolean>)sortedMap);
    }

    public Short2BooleanRBTreeMap(Short2BooleanMap short2BooleanMap) {
        this();
        this.putAll(short2BooleanMap);
    }

    public Short2BooleanRBTreeMap(Short2BooleanSortedMap short2BooleanSortedMap) {
        this(short2BooleanSortedMap.comparator());
        this.putAll(short2BooleanSortedMap);
    }

    public Short2BooleanRBTreeMap(short[] sArray, boolean[] blArray, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2BooleanRBTreeMap(short[] sArray, boolean[] blArray) {
    ...
    public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry>(this){
                ...
                final Short2BooleanRBTreeMap this$0;
                {
                    this.this$0 = short2BooleanRBTreeMap;
    ...
    public Short2BooleanRBTreeMap clone() {
        Short2BooleanRBTreeMap short2BooleanRBTreeMap;
        try {
            short2BooleanRBTreeMap = (Short2BooleanRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2BooleanRBTreeMap.keys = null;
        short2BooleanRBTreeMap.values = null;
        short2BooleanRBTreeMap.entries = null;
        short2BooleanRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2BooleanRBTreeMap.firstEntry = short2BooleanRBTreeMap.tree = entry2.left;
                            while (short2BooleanRBTreeMap.firstEntry.left != null) {
                                short2BooleanRBTreeMap.firstEntry = short2BooleanRBTreeMap.firstEntry.left;
                            }
                            short2BooleanRBTreeMap.lastEntry = short2BooleanRBTreeMap.tree;
                            while (short2BooleanRBTreeMap.lastEntry.right != null) {
                                short2BooleanRBTreeMap.lastEntry = short2BooleanRBTreeMap.lastEntry.right;
                            }
                            return short2BooleanRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Short2BooleanRBTreeMap short2BooleanRBTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2BooleanRBTreeMap;
            if (!bl && !bl2 && short2BooleanRBTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2BooleanRBTreeMap.defRetValue;
        }
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Short2BooleanRBTreeMap short2BooleanRBTreeMap) {
            this.this$0 = short2BooleanRBTreeMap;
            super(short2BooleanRBTreeMap);
        }
        ...
        ValueIterator(Short2BooleanRBTreeMap short2BooleanRBTreeMap, 1 var2_2) {
            this(short2BooleanRBTreeMap);
        }
    }
    ...
    extends AbstractShort2BooleanSortedMap.KeySet {
        ...
        private KeySet(Short2BooleanRBTreeMap short2BooleanRBTreeMap) {
            this.this$0 = short2BooleanRBTreeMap;
            super(short2BooleanRBTreeMap);
        }
        ...
        KeySet(Short2BooleanRBTreeMap short2BooleanRBTreeMap, 1 var2_2) {
            this(short2BooleanRBTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2BooleanRBTreeMap short2BooleanRBTreeMap) {
            this.this$0 = short2BooleanRBTreeMap;
            super(short2BooleanRBTreeMap);
        }

        public KeyIterator(Short2BooleanRBTreeMap short2BooleanRBTreeMap, short s) {
            this.this$0 = short2BooleanRBTreeMap;
            super(short2BooleanRBTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2BooleanMap.Entry> {
        ...
        EntryIterator(Short2BooleanRBTreeMap short2BooleanRBTreeMap) {
            this.this$0 = short2BooleanRBTreeMap;
            super(short2BooleanRBTreeMap);
        }

        EntryIterator(Short2BooleanRBTreeMap short2BooleanRBTreeMap, short s) {
            this.this$0 = short2BooleanRBTreeMap;
            super(short2BooleanRBTreeMap, s);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2BooleanRBTreeMap short2BooleanRBTreeMap) {
            this.this$0 = short2BooleanRBTreeMap;
            this.index = 0;
            this.next = short2BooleanRBTreeMap.firstEntry;
        }

        TreeIterator(Short2BooleanRBTreeMap short2BooleanRBTreeMap, short s) {
            this.this$0 = short2BooleanRBTreeMap;
            this.index = 0;
            this.next = short2BooleanRBTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2BooleanRBTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
