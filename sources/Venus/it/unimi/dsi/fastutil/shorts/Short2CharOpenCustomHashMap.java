...
Hash {
    ...
    public Short2CharOpenCustomHashMap(int n, float f, ShortHash.Strategy strategy) {
    ...
    public Short2CharOpenCustomHashMap(int n, ShortHash.Strategy strategy) {
    ...
    public Short2CharOpenCustomHashMap(Map<? extends Short, ? extends Character> map, float f, ShortHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Short2CharOpenCustomHashMap(Map<? extends Short, ? extends Character> map, ShortHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Short2CharOpenCustomHashMap(Short2CharMap short2CharMap, float f, ShortHash.Strategy strategy) {
        this(short2CharMap.size(), f, strategy);
        this.putAll(short2CharMap);
    }

    public Short2CharOpenCustomHashMap(Short2CharMap short2CharMap, ShortHash.Strategy strategy) {
        this(short2CharMap, 0.75f, strategy);
    }

    public Short2CharOpenCustomHashMap(short[] sArray, char[] cArray, float f, ShortHash.Strategy strategy) {
    ...
    public Short2CharOpenCustomHashMap(short[] sArray, char[] cArray, ShortHash.Strategy strategy) {
        this(sArray, cArray, 0.75f, strategy);
    }
    ...
    public boolean remove(short s, char c) {
        ...
        if (this.strategy.equals(s, s2) && c == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((s2 = sArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(s, s2) || c != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public CharCollection values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection(this){
                final Short2CharOpenCustomHashMap this$0;
                {
                    this.this$0 = short2CharOpenCustomHashMap;
                }
    ...
    public Short2CharOpenCustomHashMap clone() {
        Short2CharOpenCustomHashMap short2CharOpenCustomHashMap;
        try {
            short2CharOpenCustomHashMap = (Short2CharOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2CharOpenCustomHashMap.keys = null;
        short2CharOpenCustomHashMap.values = null;
        short2CharOpenCustomHashMap.entries = null;
        short2CharOpenCustomHashMap.containsNullKey = this.containsNullKey;
        short2CharOpenCustomHashMap.key = (short[])this.key.clone();
        short2CharOpenCustomHashMap.value = (char[])this.value.clone();
        short2CharOpenCustomHashMap.strategy = this.strategy;
        return short2CharOpenCustomHashMap;
    }
    ...
    static char access$300(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap) {
        return short2CharOpenCustomHashMap.removeNullEntry();
    }

    static char access$400(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap, int n) {
        return short2CharOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements CharIterator {
        ...
        public ValueIterator(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap) {
            this.this$0 = short2CharOpenCustomHashMap;
            super(short2CharOpenCustomHashMap, null);
        }
    ...
    extends AbstractShortSet {
        ...
        private KeySet(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap) {
            this.this$0 = short2CharOpenCustomHashMap;
        }
        ...
        KeySet(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap, 1 var2_2) {
            this(short2CharOpenCustomHashMap);
        }
    }
    ...
    implements ShortIterator {
        ...
        public KeyIterator(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap) {
            this.this$0 = short2CharOpenCustomHashMap;
            super(short2CharOpenCustomHashMap, null);
        }
    ...
    implements Short2CharMap.FastEntrySet {
        ...
        private MapEntrySet(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap) {
            this.this$0 = short2CharOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(s, (short)0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == c) {
                    Short2CharOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(s2, s)) {
                if (this.this$0.value[n] == c) {
                    Short2CharOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((s2 = sArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(s2, s) || this.this$0.value[n] != c);
            Short2CharOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        public void forEach(Consumer<? super Short2CharMap.Entry> consumer) {
            if (this.this$0.containsNullKey) {
                consumer.accept(new AbstractShort2CharMap.BasicEntry(this.this$0.key[this.this$0.n], this.this$0.value[this.this$0.n]));
            }
            int n = this.this$0.n;
            while (n-- != 0) {
                if (this.this$0.key[n] == 0) continue;
                consumer.accept(new AbstractShort2CharMap.BasicEntry(this.this$0.key[n], this.this$0.value[n]));
            }
        }
        ...
        MapEntrySet(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap, 1 var2_2) {
            this(short2CharOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2CharMap.Entry> {
        ...
        private FastEntryIterator(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap) {
            this.this$0 = short2CharOpenCustomHashMap;
            super(short2CharOpenCustomHashMap, null);
        ...
        FastEntryIterator(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap, 1 var2_2) {
            this(short2CharOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2CharMap.Entry> {
        ...
        private EntryIterator(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap) {
            this.this$0 = short2CharOpenCustomHashMap;
            super(short2CharOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap, 1 var2_2) {
            this(short2CharOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap) {
            this.this$0 = short2CharOpenCustomHashMap;
        ...
        MapIterator(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap, 1 var2_2) {
            this(short2CharOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Short, Character> {
        ...
        MapEntry(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap, int n) {
            this.this$0 = short2CharOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Short2CharOpenCustomHashMap short2CharOpenCustomHashMap) {
            this.this$0 = short2CharOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Short)entry.getKey()) && this.this$0.value[this.index] == ((Character)entry.getValue()).charValue();
        }
