...
Hash {
    ...
    public Short2CharLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Short2CharLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Short2CharLinkedOpenHashMap(short[] sArray, char[] cArray, float f) {
        this(sArray.length, f);
        if (sArray.length != cArray.length) {
            throw new IllegalArgumentException("The key array and the value array have different lengths (" + sArray.length + " and " + cArray.length + ")");
        }
        for (int i = 0; i < sArray.length; ++i) {
            this.put(sArray[i], cArray[i]);
        }
    }

    public Short2CharLinkedOpenHashMap(short[] sArray, char[] cArray) {
        this(sArray, cArray, 0.75f);
    }
    ...
    private void insert(int n, short s, char c) {
        if (n == this.n) {
    ...
    public boolean containsValue(char c) {
        ...
        int n = this.n;
        while (n-- != 0) {
            if (sArray[n] == 0 || cArray[n] != c) continue;
            return false;
        }
        return true;
    }
    ...
    public char computeIfAbsent(short s, IntUnaryOperator intUnaryOperator) {
        ...
        char c = SafeMath.safeIntToChar(intUnaryOperator.applyAsInt(s));
        this.insert(-n - 1, s, c);
        return c;
    }
    ...
    public char computeIfAbsentNullable(short s, IntFunction<? extends Character> intFunction) {
        ...
        Character c = intFunction.apply(s);
        if (c == null) {
            return this.defRetValue;
        }
        char c2 = c.charValue();
        this.insert(-n - 1, s, c2);
        return c2;
    }
    ...
    public char computeIfPresent(short s, BiFunction<? super Short, ? super Character, ? extends Character> biFunction) {
        ...
        Character c = biFunction.apply((Short)s, Character.valueOf(this.value[n]));
        if (c == null) {
            if (s == 0) {
                this.removeNullEntry();
            } else {
    ...
    public char compute(short s, BiFunction<? super Short, ? super Character, ? extends Character> biFunction) {
        Objects.requireNonNull(biFunction);
        int n = this.find(s);
        Character c = biFunction.apply((Short)s, n >= 0 ? Character.valueOf(this.value[n]) : null);
        if (c == null) {
            if (n >= 0) {
                if (s == 0) {
                    this.removeNullEntry();
    ...
    public CharCollection values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection(this){
                final Short2CharLinkedOpenHashMap this$0;
                {
                    this.this$0 = short2CharLinkedOpenHashMap;
                }
    ...
    public Short2CharLinkedOpenHashMap clone() {
        Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap;
        try {
            short2CharLinkedOpenHashMap = (Short2CharLinkedOpenHashMap)super.clone();
    ...
    @Override
    public ObjectSortedSet short2CharEntrySet() {
    ...
    static char access$100(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap) {
        return short2CharLinkedOpenHashMap.removeNullEntry();
    }

    static char access$200(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap, int n) {
        return short2CharLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements CharListIterator {
        ...
        public ValueIterator(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap) {
            this.this$0 = short2CharLinkedOpenHashMap;
            super(short2CharLinkedOpenHashMap);
        }
    ...
    extends AbstractShortSortedSet {
        ...
        private KeySet(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap) {
            this.this$0 = short2CharLinkedOpenHashMap;
        }
        ...
        KeySet(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap, 1 var2_2) {
            this(short2CharLinkedOpenHashMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap, short s) {
            this.this$0 = short2CharLinkedOpenHashMap;
            super(short2CharLinkedOpenHashMap, s, null);
        }
        ...
        public KeyIterator(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap) {
            this.this$0 = short2CharLinkedOpenHashMap;
            super(short2CharLinkedOpenHashMap);
        }
    ...
    implements Short2CharSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap) {
            this.this$0 = short2CharLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (s == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == c) {
                    Short2CharLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (s2 == s) {
                if (this.this$0.value[n] == c) {
                    Short2CharLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((s2 = sArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (s2 != s || this.this$0.value[n] != c);
            Short2CharLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        public void forEach(Consumer<? super Short2CharMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractShort2CharMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Short2CharMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Short2CharMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Short2CharMap.Entry)object, (Short2CharMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Short2CharMap.Entry)object);
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Short2CharMap.Entry entry) {
        ...
        MapEntrySet(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap, 1 var2_2) {
            this(short2CharLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Short2CharMap.Entry> {
        ...
        public FastEntryIterator(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap) {
            this.this$0 = short2CharLinkedOpenHashMap;
            super(short2CharLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap, short s) {
            this.this$0 = short2CharLinkedOpenHashMap;
            super(short2CharLinkedOpenHashMap, s, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Short2CharMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Short2CharMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Short2CharMap.Entry> {
        ...
        public EntryIterator(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap) {
            this.this$0 = short2CharLinkedOpenHashMap;
            super(short2CharLinkedOpenHashMap);
        }

        public EntryIterator(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap, short s) {
            this.this$0 = short2CharLinkedOpenHashMap;
            super(short2CharLinkedOpenHashMap, s, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap) {
            this.this$0 = short2CharLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = short2CharLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap, short s) {
            this.this$0 = short2CharLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (s == 0) {
                if (short2CharLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)short2CharLinkedOpenHashMap.link[short2CharLinkedOpenHashMap.n];
                    this.prev = short2CharLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + s + " does not belong to this map.");
            }
            if (short2CharLinkedOpenHashMap.key[short2CharLinkedOpenHashMap.last] == s) {
                this.prev = short2CharLinkedOpenHashMap.last;
                this.index = short2CharLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(s) & short2CharLinkedOpenHashMap.mask;
            while (short2CharLinkedOpenHashMap.key[n] != 0) {
                if (short2CharLinkedOpenHashMap.key[n] == s) {
                    this.next = (int)short2CharLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & short2CharLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + s + " does not belong to this map.");
        }
        ...
        MapIterator(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap, short s, 1 var3_3) {
            this(short2CharLinkedOpenHashMap, s);
        }
    }
    ...
    Map.Entry<Short, Character> {
        ...
        MapEntry(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap, int n) {
            this.this$0 = short2CharLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Short2CharLinkedOpenHashMap short2CharLinkedOpenHashMap) {
            this.this$0 = short2CharLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.key[this.index] == (Short)entry.getKey() && this.this$0.value[this.index] == ((Character)entry.getValue()).charValue();
        }
