...
Hash {
    ...
    public Short2ReferenceLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Short2ReferenceLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Short2ReferenceLinkedOpenHashMap(Map<? extends Short, ? extends V> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Short2ReferenceLinkedOpenHashMap(Map<? extends Short, ? extends V> map) {
        this(map, 0.75f);
    }

    public Short2ReferenceLinkedOpenHashMap(Short2ReferenceMap<V> short2ReferenceMap, float f) {
        this(short2ReferenceMap.size(), f);
        this.putAll(short2ReferenceMap);
    }

    public Short2ReferenceLinkedOpenHashMap(Short2ReferenceMap<V> short2ReferenceMap) {
        this(short2ReferenceMap, 0.75f);
    }

    public Short2ReferenceLinkedOpenHashMap(short[] sArray, V[] VArray, float f) {
    ...
    public Short2ReferenceLinkedOpenHashMap(short[] sArray, V[] VArray) {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Short2ReferenceLinkedOpenHashMap this$0;
                {
                    this.this$0 = short2ReferenceLinkedOpenHashMap;
                }
    ...
    public Short2ReferenceLinkedOpenHashMap<V> clone() {
        Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap;
        try {
            short2ReferenceLinkedOpenHashMap = (Short2ReferenceLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2ReferenceLinkedOpenHashMap.keys = null;
        short2ReferenceLinkedOpenHashMap.values = null;
        short2ReferenceLinkedOpenHashMap.entries = null;
        short2ReferenceLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        short2ReferenceLinkedOpenHashMap.key = (short[])this.key.clone();
        short2ReferenceLinkedOpenHashMap.value = (Object[])this.value.clone();
        short2ReferenceLinkedOpenHashMap.link = (long[])this.link.clone();
        return short2ReferenceLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet short2ReferenceEntrySet() {
    ...
    static Object access$100(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap) {
        return short2ReferenceLinkedOpenHashMap.removeNullEntry();
    }

    static Object access$200(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap, int n) {
        return short2ReferenceLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectListIterator<V> {
        ...
        public ValueIterator(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap) {
            this.this$0 = short2ReferenceLinkedOpenHashMap;
            super(short2ReferenceLinkedOpenHashMap);
        }
    ...
    extends AbstractShortSortedSet {
        ...
        private KeySet(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap) {
            this.this$0 = short2ReferenceLinkedOpenHashMap;
        }
        ...
        KeySet(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap, 1 var2_2) {
            this(short2ReferenceLinkedOpenHashMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap, short s) {
            this.this$0 = short2ReferenceLinkedOpenHashMap;
            super(short2ReferenceLinkedOpenHashMap, s, null);
        }
        ...
        public KeyIterator(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap) {
            this.this$0 = short2ReferenceLinkedOpenHashMap;
            super(short2ReferenceLinkedOpenHashMap);
        }
    ...
    implements Short2ReferenceSortedMap.FastSortedEntrySet<V> {
        ...
        private MapEntrySet(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap) {
            this.this$0 = short2ReferenceLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (s == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Short2ReferenceLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (s2 == s) {
                if (this.this$0.value[n] == v) {
                    Short2ReferenceLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Short2ReferenceMap.Entry<V>> iterator(Short2ReferenceMap.Entry<V> entry) {
        ...
        @Override
        public ObjectListIterator<Short2ReferenceMap.Entry<V>> fastIterator(Short2ReferenceMap.Entry<V> entry) {
        ...
        public void forEach(Consumer<? super Short2ReferenceMap.Entry<V>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractShort2ReferenceMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Short2ReferenceMap.Entry entry) {
        ...
        MapEntrySet(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap, 1 var2_2) {
            this(short2ReferenceLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Short2ReferenceMap.Entry<V>> {
        ...
        public FastEntryIterator(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap) {
            this.this$0 = short2ReferenceLinkedOpenHashMap;
            super(short2ReferenceLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap, short s) {
            this.this$0 = short2ReferenceLinkedOpenHashMap;
            super(short2ReferenceLinkedOpenHashMap, s, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Short2ReferenceMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Short2ReferenceMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Short2ReferenceMap.Entry<V>> {
        ...
        public EntryIterator(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap) {
            this.this$0 = short2ReferenceLinkedOpenHashMap;
            super(short2ReferenceLinkedOpenHashMap);
        }

        public EntryIterator(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap, short s) {
            this.this$0 = short2ReferenceLinkedOpenHashMap;
            super(short2ReferenceLinkedOpenHashMap, s, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap) {
            this.this$0 = short2ReferenceLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = short2ReferenceLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap, short s) {
            this.this$0 = short2ReferenceLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (s == 0) {
                if (short2ReferenceLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)short2ReferenceLinkedOpenHashMap.link[short2ReferenceLinkedOpenHashMap.n];
                    this.prev = short2ReferenceLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + s + " does not belong to this map.");
            }
            if (short2ReferenceLinkedOpenHashMap.key[short2ReferenceLinkedOpenHashMap.last] == s) {
                this.prev = short2ReferenceLinkedOpenHashMap.last;
                this.index = short2ReferenceLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(s) & short2ReferenceLinkedOpenHashMap.mask;
            while (short2ReferenceLinkedOpenHashMap.key[n] != 0) {
                if (short2ReferenceLinkedOpenHashMap.key[n] == s) {
                    this.next = (int)short2ReferenceLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & short2ReferenceLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + s + " does not belong to this map.");
        }
        ...
        MapIterator(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap, short s, 1 var3_3) {
            this(short2ReferenceLinkedOpenHashMap, s);
        }
    }
    ...
    Map.Entry<Short, V> {
        ...
        MapEntry(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap, int n) {
            this.this$0 = short2ReferenceLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Short2ReferenceLinkedOpenHashMap short2ReferenceLinkedOpenHashMap) {
            this.this$0 = short2ReferenceLinkedOpenHashMap;
        }
