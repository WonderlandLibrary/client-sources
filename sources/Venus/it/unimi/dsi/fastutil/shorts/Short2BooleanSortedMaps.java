...
public final class Short2BooleanSortedMaps {
    ...
    public static Comparator<? super Map.Entry<Short, ?>> entryComparator(ShortComparator shortComparator) {
        return (arg_0, arg_1) -> Short2BooleanSortedMaps.lambda$entryComparator$0(shortComparator, arg_0, arg_1);
    }

    public static ObjectBidirectionalIterator<Short2BooleanMap.Entry> fastIterator(Short2BooleanSortedMap short2BooleanSortedMap) {
        ObjectSet objectSet = short2BooleanSortedMap.short2BooleanEntrySet();
        return objectSet instanceof Short2BooleanSortedMap.FastSortedEntrySet ? ((Short2BooleanSortedMap.FastSortedEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }

    public static ObjectBidirectionalIterable<Short2BooleanMap.Entry> fastIterable(Short2BooleanSortedMap short2BooleanSortedMap) {
        ObjectSet objectSet = short2BooleanSortedMap.short2BooleanEntrySet();
        return objectSet instanceof Short2BooleanSortedMap.FastSortedEntrySet ? ((Short2BooleanSortedMap.FastSortedEntrySet)objectSet)::fastIterator : objectSet;
    }

    public static Short2BooleanSortedMap singleton(Short s, Boolean bl) {
        return new Singleton(s, bl);
    }

    public static Short2BooleanSortedMap singleton(Short s, Boolean bl, ShortComparator shortComparator) {
        return new Singleton(s, bl, shortComparator);
    }
    ...
    public static Short2BooleanSortedMap synchronize(Short2BooleanSortedMap short2BooleanSortedMap) {
        return new SynchronizedSortedMap(short2BooleanSortedMap);
    }

    public static Short2BooleanSortedMap synchronize(Short2BooleanSortedMap short2BooleanSortedMap, Object object) {
        return new SynchronizedSortedMap(short2BooleanSortedMap, object);
    }

    public static Short2BooleanSortedMap unmodifiable(Short2BooleanSortedMap short2BooleanSortedMap) {
        return new UnmodifiableSortedMap(short2BooleanSortedMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableSortedMap(Short2BooleanSortedMap short2BooleanSortedMap) {
            super(short2BooleanSortedMap);
            this.sortedMap = short2BooleanSortedMap;
        }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Short2BooleanSortedMap short2BooleanSortedMap, Object object) {
            super(short2BooleanSortedMap, object);
            this.sortedMap = short2BooleanSortedMap;
        }

        protected SynchronizedSortedMap(Short2BooleanSortedMap short2BooleanSortedMap) {
            super(short2BooleanSortedMap);
            this.sortedMap = short2BooleanSortedMap;
        }
    ...
    Cloneable {
        ...
        protected Singleton(short s, boolean bl, ShortComparator shortComparator) {
            super(s, bl);
