...
Hash {
    ...
    public Short2DoubleOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Short2DoubleOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Short2DoubleOpenHashMap(short[] sArray, double[] dArray, float f) {
    ...
    public Short2DoubleOpenHashMap(short[] sArray, double[] dArray) {
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(this){
                final Short2DoubleOpenHashMap this$0;
                {
                    this.this$0 = short2DoubleOpenHashMap;
                }
    ...
    public Short2DoubleOpenHashMap clone() {
        Short2DoubleOpenHashMap short2DoubleOpenHashMap;
        try {
            short2DoubleOpenHashMap = (Short2DoubleOpenHashMap)super.clone();
    ...
    static double access$300(Short2DoubleOpenHashMap short2DoubleOpenHashMap) {
        return short2DoubleOpenHashMap.removeNullEntry();
    }

    static double access$400(Short2DoubleOpenHashMap short2DoubleOpenHashMap, int n) {
        return short2DoubleOpenHashMap.removeEntry(n);
    }
    ...
    implements DoubleIterator {
        ...
        public ValueIterator(Short2DoubleOpenHashMap short2DoubleOpenHashMap) {
            this.this$0 = short2DoubleOpenHashMap;
            super(short2DoubleOpenHashMap, null);
        }
    ...
    extends AbstractShortSet {
        ...
        private KeySet(Short2DoubleOpenHashMap short2DoubleOpenHashMap) {
            this.this$0 = short2DoubleOpenHashMap;
        }
        ...
        KeySet(Short2DoubleOpenHashMap short2DoubleOpenHashMap, 1 var2_2) {
            this(short2DoubleOpenHashMap);
        }
    }
    ...
    implements ShortIterator {
        ...
        public KeyIterator(Short2DoubleOpenHashMap short2DoubleOpenHashMap) {
            this.this$0 = short2DoubleOpenHashMap;
            super(short2DoubleOpenHashMap, null);
        }
    ...
    implements Short2DoubleMap.FastEntrySet {
        ...
        private MapEntrySet(Short2DoubleOpenHashMap short2DoubleOpenHashMap) {
            this.this$0 = short2DoubleOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (s == 0) {
                if (this.this$0.containsNullKey && Double.doubleToLongBits(this.this$0.value[this.this$0.n]) == Double.doubleToLongBits(d)) {
                    Short2DoubleOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (s2 == s) {
                if (Double.doubleToLongBits(this.this$0.value[n]) == Double.doubleToLongBits(d)) {
                    Short2DoubleOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Short2DoubleOpenHashMap short2DoubleOpenHashMap, 1 var2_2) {
            this(short2DoubleOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2DoubleMap.Entry> {
        ...
        private FastEntryIterator(Short2DoubleOpenHashMap short2DoubleOpenHashMap) {
            this.this$0 = short2DoubleOpenHashMap;
            super(short2DoubleOpenHashMap, null);
        ...
        FastEntryIterator(Short2DoubleOpenHashMap short2DoubleOpenHashMap, 1 var2_2) {
            this(short2DoubleOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2DoubleMap.Entry> {
        ...
        private EntryIterator(Short2DoubleOpenHashMap short2DoubleOpenHashMap) {
            this.this$0 = short2DoubleOpenHashMap;
            super(short2DoubleOpenHashMap, null);
        }
        ...
        EntryIterator(Short2DoubleOpenHashMap short2DoubleOpenHashMap, 1 var2_2) {
            this(short2DoubleOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Short2DoubleOpenHashMap short2DoubleOpenHashMap) {
            this.this$0 = short2DoubleOpenHashMap;
        ...
        MapIterator(Short2DoubleOpenHashMap short2DoubleOpenHashMap, 1 var2_2) {
            this(short2DoubleOpenHashMap);
        }
    }
    ...
    Map.Entry<Short, Double> {
        ...
        MapEntry(Short2DoubleOpenHashMap short2DoubleOpenHashMap, int n) {
            this.this$0 = short2DoubleOpenHashMap;
            this.index = n;
        }

        MapEntry(Short2DoubleOpenHashMap short2DoubleOpenHashMap) {
            this.this$0 = short2DoubleOpenHashMap;
        }
