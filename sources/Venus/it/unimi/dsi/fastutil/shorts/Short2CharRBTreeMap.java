...
Cloneable {
    ...
    public Short2CharRBTreeMap(Comparator<? super Short> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Short2CharRBTreeMap(Map<? extends Short, ? extends Character> map) {
        this();
        this.putAll(map);
    }

    public Short2CharRBTreeMap(SortedMap<Short, Character> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Short, ? extends Character>)sortedMap);
    }

    public Short2CharRBTreeMap(Short2CharMap short2CharMap) {
        this();
        this.putAll(short2CharMap);
    }

    public Short2CharRBTreeMap(Short2CharSortedMap short2CharSortedMap) {
        this(short2CharSortedMap.comparator());
        this.putAll(short2CharSortedMap);
    }

    public Short2CharRBTreeMap(short[] sArray, char[] cArray, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2CharRBTreeMap(short[] sArray, char[] cArray) {
    ...
    public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>(this){
                ...
                final Short2CharRBTreeMap this$0;
                {
                    this.this$0 = short2CharRBTreeMap;
    ...
    public Short2CharRBTreeMap clone() {
        Short2CharRBTreeMap short2CharRBTreeMap;
        try {
            short2CharRBTreeMap = (Short2CharRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2CharRBTreeMap.keys = null;
        short2CharRBTreeMap.values = null;
        short2CharRBTreeMap.entries = null;
        short2CharRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2CharRBTreeMap.firstEntry = short2CharRBTreeMap.tree = entry2.left;
                            while (short2CharRBTreeMap.firstEntry.left != null) {
                                short2CharRBTreeMap.firstEntry = short2CharRBTreeMap.firstEntry.left;
                            }
                            short2CharRBTreeMap.lastEntry = short2CharRBTreeMap.tree;
                            while (short2CharRBTreeMap.lastEntry.right != null) {
                                short2CharRBTreeMap.lastEntry = short2CharRBTreeMap.lastEntry.right;
                            }
                            return short2CharRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Short2CharRBTreeMap short2CharRBTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2CharRBTreeMap;
            if (!bl && !bl2 && short2CharRBTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2CharRBTreeMap.defRetValue;
        }
    ...
    implements CharListIterator {
        ...
        private ValueIterator(Short2CharRBTreeMap short2CharRBTreeMap) {
            this.this$0 = short2CharRBTreeMap;
            super(short2CharRBTreeMap);
        }
        ...
        ValueIterator(Short2CharRBTreeMap short2CharRBTreeMap, 1 var2_2) {
            this(short2CharRBTreeMap);
        }
    }
    ...
    extends AbstractShort2CharSortedMap.KeySet {
        ...
        private KeySet(Short2CharRBTreeMap short2CharRBTreeMap) {
            this.this$0 = short2CharRBTreeMap;
            super(short2CharRBTreeMap);
        }
        ...
        KeySet(Short2CharRBTreeMap short2CharRBTreeMap, 1 var2_2) {
            this(short2CharRBTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2CharRBTreeMap short2CharRBTreeMap) {
            this.this$0 = short2CharRBTreeMap;
            super(short2CharRBTreeMap);
        }

        public KeyIterator(Short2CharRBTreeMap short2CharRBTreeMap, short s) {
            this.this$0 = short2CharRBTreeMap;
            super(short2CharRBTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2CharMap.Entry> {
        ...
        EntryIterator(Short2CharRBTreeMap short2CharRBTreeMap) {
            this.this$0 = short2CharRBTreeMap;
            super(short2CharRBTreeMap);
        }

        EntryIterator(Short2CharRBTreeMap short2CharRBTreeMap, short s) {
            this.this$0 = short2CharRBTreeMap;
            super(short2CharRBTreeMap, s);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2CharRBTreeMap short2CharRBTreeMap) {
            this.this$0 = short2CharRBTreeMap;
            this.index = 0;
            this.next = short2CharRBTreeMap.firstEntry;
        }

        TreeIterator(Short2CharRBTreeMap short2CharRBTreeMap, short s) {
            this.this$0 = short2CharRBTreeMap;
            this.index = 0;
            this.next = short2CharRBTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2CharRBTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
