...
Hash {
    ...
    public Short2ReferenceOpenCustomHashMap(int n, float f, ShortHash.Strategy strategy) {
    ...
    public Short2ReferenceOpenCustomHashMap(int n, ShortHash.Strategy strategy) {
    ...
    public Short2ReferenceOpenCustomHashMap(Map<? extends Short, ? extends V> map, float f, ShortHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Short2ReferenceOpenCustomHashMap(Map<? extends Short, ? extends V> map, ShortHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Short2ReferenceOpenCustomHashMap(Short2ReferenceMap<V> short2ReferenceMap, float f, ShortHash.Strategy strategy) {
        this(short2ReferenceMap.size(), f, strategy);
        this.putAll(short2ReferenceMap);
    }

    public Short2ReferenceOpenCustomHashMap(Short2ReferenceMap<V> short2ReferenceMap, ShortHash.Strategy strategy) {
        this(short2ReferenceMap, 0.75f, strategy);
    }

    public Short2ReferenceOpenCustomHashMap(short[] sArray, V[] VArray, float f, ShortHash.Strategy strategy) {
    ...
    public Short2ReferenceOpenCustomHashMap(short[] sArray, V[] VArray, ShortHash.Strategy strategy) {
    ...
    public boolean remove(short s, Object object) {
        ...
        if (this.strategy.equals(s, s2) && object == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((s2 = sArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(s, s2) || object != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Short2ReferenceOpenCustomHashMap this$0;
                {
                    this.this$0 = short2ReferenceOpenCustomHashMap;
                }
    ...
    public Short2ReferenceOpenCustomHashMap<V> clone() {
        Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap;
        try {
            short2ReferenceOpenCustomHashMap = (Short2ReferenceOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2ReferenceOpenCustomHashMap.keys = null;
        short2ReferenceOpenCustomHashMap.values = null;
        short2ReferenceOpenCustomHashMap.entries = null;
        short2ReferenceOpenCustomHashMap.containsNullKey = this.containsNullKey;
        short2ReferenceOpenCustomHashMap.key = (short[])this.key.clone();
        short2ReferenceOpenCustomHashMap.value = (Object[])this.value.clone();
        short2ReferenceOpenCustomHashMap.strategy = this.strategy;
        return short2ReferenceOpenCustomHashMap;
    }
    ...
    static Object access$300(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap) {
        return short2ReferenceOpenCustomHashMap.removeNullEntry();
    }

    static Object access$400(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap, int n) {
        return short2ReferenceOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap) {
            this.this$0 = short2ReferenceOpenCustomHashMap;
            super(short2ReferenceOpenCustomHashMap, null);
        }
    ...
    extends AbstractShortSet {
        ...
        private KeySet(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap) {
            this.this$0 = short2ReferenceOpenCustomHashMap;
        }
        ...
        KeySet(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(short2ReferenceOpenCustomHashMap);
        }
    }
    ...
    implements ShortIterator {
        ...
        public KeyIterator(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap) {
            this.this$0 = short2ReferenceOpenCustomHashMap;
            super(short2ReferenceOpenCustomHashMap, null);
        }
    ...
    implements Short2ReferenceMap.FastEntrySet<V> {
        ...
        private MapEntrySet(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap) {
            this.this$0 = short2ReferenceOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(s, (short)0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Short2ReferenceOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(s2, s)) {
                if (this.this$0.value[n] == v) {
                    Short2ReferenceOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((s2 = sArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(s2, s) || this.this$0.value[n] != v);
            Short2ReferenceOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(short2ReferenceOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2ReferenceMap.Entry<V>> {
        ...
        private FastEntryIterator(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap) {
            this.this$0 = short2ReferenceOpenCustomHashMap;
            super(short2ReferenceOpenCustomHashMap, null);
        ...
        FastEntryIterator(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(short2ReferenceOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2ReferenceMap.Entry<V>> {
        ...
        private EntryIterator(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap) {
            this.this$0 = short2ReferenceOpenCustomHashMap;
            super(short2ReferenceOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(short2ReferenceOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap) {
            this.this$0 = short2ReferenceOpenCustomHashMap;
        ...
        MapIterator(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(short2ReferenceOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Short, V> {
        ...
        MapEntry(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap, int n) {
            this.this$0 = short2ReferenceOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Short2ReferenceOpenCustomHashMap short2ReferenceOpenCustomHashMap) {
            this.this$0 = short2ReferenceOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Short)entry.getKey()) && this.this$0.value[this.index] == entry.getValue();
        }
