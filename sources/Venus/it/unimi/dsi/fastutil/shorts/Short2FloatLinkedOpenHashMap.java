...
Hash {
    ...
    public Short2FloatLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Short2FloatLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Short2FloatLinkedOpenHashMap(Map<? extends Short, ? extends Float> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }
    ...
    public Short2FloatLinkedOpenHashMap(Short2FloatMap short2FloatMap, float f) {
        this(short2FloatMap.size(), f);
        this.putAll(short2FloatMap);
    }

    public Short2FloatLinkedOpenHashMap(Short2FloatMap short2FloatMap) {
        this(short2FloatMap, 0.75f);
    }

    public Short2FloatLinkedOpenHashMap(short[] sArray, float[] fArray, float f) {
    ...
    public Short2FloatLinkedOpenHashMap(short[] sArray, float[] fArray) {
        this(sArray, fArray, 0.75f);
    }
    ...
    public boolean remove(short s, float f) {
        ...
        if (s == s2 && Float.floatToIntBits(f) == Float.floatToIntBits(this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((s2 = sArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (s != s2 || Float.floatToIntBits(f) != Float.floatToIntBits(this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public FloatCollection values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection(this){
                final Short2FloatLinkedOpenHashMap this$0;
                {
                    this.this$0 = short2FloatLinkedOpenHashMap;
                }
    ...
    public Short2FloatLinkedOpenHashMap clone() {
        Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap;
        try {
            short2FloatLinkedOpenHashMap = (Short2FloatLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2FloatLinkedOpenHashMap.keys = null;
        short2FloatLinkedOpenHashMap.values = null;
        short2FloatLinkedOpenHashMap.entries = null;
        short2FloatLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        short2FloatLinkedOpenHashMap.key = (short[])this.key.clone();
        short2FloatLinkedOpenHashMap.value = (float[])this.value.clone();
        short2FloatLinkedOpenHashMap.link = (long[])this.link.clone();
        return short2FloatLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet short2FloatEntrySet() {
    ...
    static float access$100(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap) {
        return short2FloatLinkedOpenHashMap.removeNullEntry();
    }

    static float access$200(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap, int n) {
        return short2FloatLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements FloatListIterator {
        ...
        public ValueIterator(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap) {
            this.this$0 = short2FloatLinkedOpenHashMap;
            super(short2FloatLinkedOpenHashMap);
        }
    ...
    extends AbstractShortSortedSet {
        ...
        private KeySet(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap) {
            this.this$0 = short2FloatLinkedOpenHashMap;
        }
        ...
        KeySet(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap, 1 var2_2) {
            this(short2FloatLinkedOpenHashMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap, short s) {
            this.this$0 = short2FloatLinkedOpenHashMap;
            super(short2FloatLinkedOpenHashMap, s, null);
        }
        ...
        public KeyIterator(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap) {
            this.this$0 = short2FloatLinkedOpenHashMap;
            super(short2FloatLinkedOpenHashMap);
        }
    ...
    implements Short2FloatSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap) {
            this.this$0 = short2FloatLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (s == 0) {
                if (this.this$0.containsNullKey && Float.floatToIntBits(this.this$0.value[this.this$0.n]) == Float.floatToIntBits(f)) {
                    Short2FloatLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (s2 == s) {
                if (Float.floatToIntBits(this.this$0.value[n]) == Float.floatToIntBits(f)) {
                    Short2FloatLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((s2 = sArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (s2 != s || Float.floatToIntBits(this.this$0.value[n]) != Float.floatToIntBits(f));
            Short2FloatLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry entry) {
        ...
        public ObjectListIterator<Short2FloatMap.Entry> fastIterator(Short2FloatMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Short2FloatMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractShort2FloatMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Short2FloatMap.Entry entry) {
        ...
        MapEntrySet(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap, 1 var2_2) {
            this(short2FloatLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Short2FloatMap.Entry> {
        ...
        public FastEntryIterator(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap) {
            this.this$0 = short2FloatLinkedOpenHashMap;
            super(short2FloatLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap, short s) {
            this.this$0 = short2FloatLinkedOpenHashMap;
            super(short2FloatLinkedOpenHashMap, s, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Short2FloatMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Short2FloatMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Short2FloatMap.Entry> {
        ...
        public EntryIterator(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap) {
            this.this$0 = short2FloatLinkedOpenHashMap;
            super(short2FloatLinkedOpenHashMap);
        }

        public EntryIterator(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap, short s) {
            this.this$0 = short2FloatLinkedOpenHashMap;
            super(short2FloatLinkedOpenHashMap, s, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap) {
            this.this$0 = short2FloatLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = short2FloatLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap, short s) {
            this.this$0 = short2FloatLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (s == 0) {
                if (short2FloatLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)short2FloatLinkedOpenHashMap.link[short2FloatLinkedOpenHashMap.n];
                    this.prev = short2FloatLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + s + " does not belong to this map.");
            }
            if (short2FloatLinkedOpenHashMap.key[short2FloatLinkedOpenHashMap.last] == s) {
                this.prev = short2FloatLinkedOpenHashMap.last;
                this.index = short2FloatLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(s) & short2FloatLinkedOpenHashMap.mask;
            while (short2FloatLinkedOpenHashMap.key[n] != 0) {
                if (short2FloatLinkedOpenHashMap.key[n] == s) {
                    this.next = (int)short2FloatLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & short2FloatLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + s + " does not belong to this map.");
        }
        ...
        MapIterator(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap, short s, 1 var3_3) {
            this(short2FloatLinkedOpenHashMap, s);
        }
    }
    ...
    Map.Entry<Short, Float> {
        ...
        MapEntry(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap, int n) {
            this.this$0 = short2FloatLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Short2FloatLinkedOpenHashMap short2FloatLinkedOpenHashMap) {
            this.this$0 = short2FloatLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.key[this.index] == (Short)entry.getKey() && Float.floatToIntBits(this.this$0.value[this.index]) == Float.floatToIntBits(((Float)entry.getValue()).floatValue());
        }
