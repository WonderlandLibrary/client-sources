...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Short2FloatAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Short2FloatAVLTreeMap(Comparator<? super Short> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Short2FloatAVLTreeMap(Map<? extends Short, ? extends Float> map) {
        this();
        this.putAll(map);
    }

    public Short2FloatAVLTreeMap(SortedMap<Short, Float> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Short, ? extends Float>)sortedMap);
    }

    public Short2FloatAVLTreeMap(Short2FloatMap short2FloatMap) {
        this();
        this.putAll(short2FloatMap);
    }

    public Short2FloatAVLTreeMap(Short2FloatSortedMap short2FloatSortedMap) {
        this(short2FloatSortedMap.comparator());
        this.putAll(short2FloatSortedMap);
    }

    public Short2FloatAVLTreeMap(short[] sArray, float[] fArray, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2FloatAVLTreeMap(short[] sArray, float[] fArray) {
    ...
    public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>(this){
                ...
                final Short2FloatAVLTreeMap this$0;
                {
                    this.this$0 = short2FloatAVLTreeMap;
    ...
    public Short2FloatAVLTreeMap clone() {
        Short2FloatAVLTreeMap short2FloatAVLTreeMap;
        try {
            short2FloatAVLTreeMap = (Short2FloatAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2FloatAVLTreeMap.keys = null;
        short2FloatAVLTreeMap.values = null;
        short2FloatAVLTreeMap.entries = null;
        short2FloatAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2FloatAVLTreeMap.firstEntry = short2FloatAVLTreeMap.tree = entry2.left;
                            while (short2FloatAVLTreeMap.firstEntry.left != null) {
                                short2FloatAVLTreeMap.firstEntry = short2FloatAVLTreeMap.firstEntry.left;
                            }
                            short2FloatAVLTreeMap.lastEntry = short2FloatAVLTreeMap.tree;
                            while (short2FloatAVLTreeMap.lastEntry.right != null) {
                                short2FloatAVLTreeMap.lastEntry = short2FloatAVLTreeMap.lastEntry.right;
                            }
                            return short2FloatAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Short2FloatAVLTreeMap short2FloatAVLTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2FloatAVLTreeMap;
            if (!bl && !bl2 && short2FloatAVLTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2FloatAVLTreeMap.defRetValue;
        }
    ...
    implements FloatListIterator {
        ...
        private ValueIterator(Short2FloatAVLTreeMap short2FloatAVLTreeMap) {
            this.this$0 = short2FloatAVLTreeMap;
            super(short2FloatAVLTreeMap);
        }
        ...
        ValueIterator(Short2FloatAVLTreeMap short2FloatAVLTreeMap, 1 var2_2) {
            this(short2FloatAVLTreeMap);
        }
    }
    ...
    extends AbstractShort2FloatSortedMap.KeySet {
        ...
        private KeySet(Short2FloatAVLTreeMap short2FloatAVLTreeMap) {
            this.this$0 = short2FloatAVLTreeMap;
            super(short2FloatAVLTreeMap);
        }
        ...
        KeySet(Short2FloatAVLTreeMap short2FloatAVLTreeMap, 1 var2_2) {
            this(short2FloatAVLTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2FloatAVLTreeMap short2FloatAVLTreeMap) {
            this.this$0 = short2FloatAVLTreeMap;
            super(short2FloatAVLTreeMap);
        }

        public KeyIterator(Short2FloatAVLTreeMap short2FloatAVLTreeMap, short s) {
            this.this$0 = short2FloatAVLTreeMap;
            super(short2FloatAVLTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2FloatMap.Entry> {
        ...
        EntryIterator(Short2FloatAVLTreeMap short2FloatAVLTreeMap) {
            this.this$0 = short2FloatAVLTreeMap;
            super(short2FloatAVLTreeMap);
        }

        EntryIterator(Short2FloatAVLTreeMap short2FloatAVLTreeMap, short s) {
            this.this$0 = short2FloatAVLTreeMap;
            super(short2FloatAVLTreeMap, s);
        }
        ...
        public void add(Object object) {
            this.add((Short2FloatMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Short2FloatMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2FloatAVLTreeMap short2FloatAVLTreeMap) {
            this.this$0 = short2FloatAVLTreeMap;
            this.index = 0;
            this.next = short2FloatAVLTreeMap.firstEntry;
        }

        TreeIterator(Short2FloatAVLTreeMap short2FloatAVLTreeMap, short s) {
            this.this$0 = short2FloatAVLTreeMap;
            this.index = 0;
            this.next = short2FloatAVLTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2FloatAVLTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
