...
public final class Short2ReferenceFunctions {
    ...
    public static <V> Short2ReferenceFunction<V> singleton(short s, V v) {
    ...
    public static <V> Short2ReferenceFunction<V> synchronize(Short2ReferenceFunction<V> short2ReferenceFunction) {
        return new SynchronizedFunction<V>(short2ReferenceFunction);
    }

    public static <V> Short2ReferenceFunction<V> synchronize(Short2ReferenceFunction<V> short2ReferenceFunction, Object object) {
        return new SynchronizedFunction<V>(short2ReferenceFunction, object);
    }

    public static <V> Short2ReferenceFunction<V> unmodifiable(Short2ReferenceFunction<V> short2ReferenceFunction) {
        return new UnmodifiableFunction<V>(short2ReferenceFunction);
    }

    public static <V> Short2ReferenceFunction<V> primitive(java.util.function.Function<? super Short, ? extends V> function) {
        Objects.requireNonNull(function);
        if (function instanceof Short2ReferenceFunction) {
            return (Short2ReferenceFunction)function;
        }
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Short2ReferenceFunction<V> short2ReferenceFunction) {
            if (short2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = short2ReferenceFunction;
        }
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Short2ReferenceFunction<V> short2ReferenceFunction, Object object) {
            if (short2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = short2ReferenceFunction;
        ...
        protected SynchronizedFunction(Short2ReferenceFunction<V> short2ReferenceFunction) {
            if (short2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = short2ReferenceFunction;
