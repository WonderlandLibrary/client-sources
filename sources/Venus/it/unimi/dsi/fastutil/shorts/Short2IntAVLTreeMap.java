...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Short2IntAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Short2IntAVLTreeMap(Comparator<? super Short> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Short2IntAVLTreeMap(Map<? extends Short, ? extends Integer> map) {
        this();
        this.putAll(map);
    }

    public Short2IntAVLTreeMap(SortedMap<Short, Integer> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Short, ? extends Integer>)sortedMap);
    }

    public Short2IntAVLTreeMap(Short2IntMap short2IntMap) {
        this();
        this.putAll(short2IntMap);
    }

    public Short2IntAVLTreeMap(Short2IntSortedMap short2IntSortedMap) {
        this(short2IntSortedMap.comparator());
        this.putAll(short2IntSortedMap);
    }

    public Short2IntAVLTreeMap(short[] sArray, int[] nArray, Comparator<? super Short> comparator) {
        this(comparator);
    ...
    public Short2IntAVLTreeMap(short[] sArray, int[] nArray) {
        this(sArray, nArray, null);
    }
    ...
    public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2IntMap.Entry>(this){
                final Comparator<? super Short2IntMap.Entry> comparator;
                final Short2IntAVLTreeMap this$0;
                {
                    this.this$0 = short2IntAVLTreeMap;
                ...
                public ObjectSortedSet<Short2IntMap.Entry> subSet(Short2IntMap.Entry entry, Short2IntMap.Entry entry2) {
                    return this.this$0.subMap(entry.getShortKey(), entry2.getShortKey()).short2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2IntMap.Entry> headSet(Short2IntMap.Entry entry) {
                    return this.this$0.headMap(entry.getShortKey()).short2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Short2IntMap.Entry> tailSet(Short2IntMap.Entry entry) {
                    return this.this$0.tailMap(entry.getShortKey()).short2IntEntrySet();
                }
                ...
                private int lambda$$0(Short2IntMap.Entry entry, Short2IntMap.Entry entry2) {
    ...
    public Short2IntAVLTreeMap clone() {
        Short2IntAVLTreeMap short2IntAVLTreeMap;
        try {
            short2IntAVLTreeMap = (Short2IntAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2IntAVLTreeMap.keys = null;
        short2IntAVLTreeMap.values = null;
        short2IntAVLTreeMap.entries = null;
        short2IntAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            short2IntAVLTreeMap.firstEntry = short2IntAVLTreeMap.tree = entry2.left;
                            while (short2IntAVLTreeMap.firstEntry.left != null) {
                                short2IntAVLTreeMap.firstEntry = short2IntAVLTreeMap.firstEntry.left;
                            }
                            short2IntAVLTreeMap.lastEntry = short2IntAVLTreeMap.tree;
                            while (short2IntAVLTreeMap.lastEntry.right != null) {
                                short2IntAVLTreeMap.lastEntry = short2IntAVLTreeMap.lastEntry.right;
                            }
                            return short2IntAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Short2IntAVLTreeMap short2IntAVLTreeMap, short s, boolean bl, short s2, boolean bl2) {
            this.this$0 = short2IntAVLTreeMap;
            if (!bl && !bl2 && short2IntAVLTreeMap.compare(s, s2) > 0) {
            ...
            this.to = s2;
            this.top = bl2;
            this.defRetValue = short2IntAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2IntMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Short2IntMap.Entry> comparator() {
                        return this.this$1.this$0.short2IntEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Short2IntMap.Entry> subSet(Short2IntMap.Entry entry, Short2IntMap.Entry entry2) {
                        return this.this$1.subMap(entry.getShortKey(), entry2.getShortKey()).short2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Short2IntMap.Entry> headSet(Short2IntMap.Entry entry) {
                        return this.this$1.headMap(entry.getShortKey()).short2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Short2IntMap.Entry> tailSet(Short2IntMap.Entry entry) {
                        return this.this$1.tailMap(entry.getShortKey()).short2IntEntrySet();
                    }
    ...
    implements IntListIterator {
        ...
        private ValueIterator(Short2IntAVLTreeMap short2IntAVLTreeMap) {
            this.this$0 = short2IntAVLTreeMap;
            super(short2IntAVLTreeMap);
        }
        ...
        ValueIterator(Short2IntAVLTreeMap short2IntAVLTreeMap, 1 var2_2) {
            this(short2IntAVLTreeMap);
        }
    }
    ...
    extends AbstractShort2IntSortedMap.KeySet {
        ...
        private KeySet(Short2IntAVLTreeMap short2IntAVLTreeMap) {
            this.this$0 = short2IntAVLTreeMap;
            super(short2IntAVLTreeMap);
        }
        ...
        KeySet(Short2IntAVLTreeMap short2IntAVLTreeMap, 1 var2_2) {
            this(short2IntAVLTreeMap);
        }
    }
    ...
    implements ShortListIterator {
        ...
        public KeyIterator(Short2IntAVLTreeMap short2IntAVLTreeMap) {
            this.this$0 = short2IntAVLTreeMap;
            super(short2IntAVLTreeMap);
        }

        public KeyIterator(Short2IntAVLTreeMap short2IntAVLTreeMap, short s) {
            this.this$0 = short2IntAVLTreeMap;
            super(short2IntAVLTreeMap, s);
        }
    ...
    implements ObjectListIterator<Short2IntMap.Entry> {
        ...
        EntryIterator(Short2IntAVLTreeMap short2IntAVLTreeMap) {
            this.this$0 = short2IntAVLTreeMap;
            super(short2IntAVLTreeMap);
        }

        EntryIterator(Short2IntAVLTreeMap short2IntAVLTreeMap, short s) {
            this.this$0 = short2IntAVLTreeMap;
            super(short2IntAVLTreeMap, s);
        }
        ...
        public void add(Object object) {
            this.add((Short2IntMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Short2IntMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Short2IntAVLTreeMap short2IntAVLTreeMap) {
            this.this$0 = short2IntAVLTreeMap;
            this.index = 0;
            this.next = short2IntAVLTreeMap.firstEntry;
        }

        TreeIterator(Short2IntAVLTreeMap short2IntAVLTreeMap, short s) {
            this.this$0 = short2IntAVLTreeMap;
            this.index = 0;
            this.next = short2IntAVLTreeMap.locateKey(s);
            if (this.next != null) {
                if (short2IntAVLTreeMap.compare(this.next.key, s) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == (Short)entry.getKey() && this.value == (Integer)entry.getValue();
        }
