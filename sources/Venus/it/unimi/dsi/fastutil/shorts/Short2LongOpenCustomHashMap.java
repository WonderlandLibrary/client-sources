...
Hash {
    ...
    public Short2LongOpenCustomHashMap(int n, float f, ShortHash.Strategy strategy) {
    ...
    public Short2LongOpenCustomHashMap(int n, ShortHash.Strategy strategy) {
    ...
    public Short2LongOpenCustomHashMap(Map<? extends Short, ? extends Long> map, float f, ShortHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Short2LongOpenCustomHashMap(Map<? extends Short, ? extends Long> map, ShortHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Short2LongOpenCustomHashMap(Short2LongMap short2LongMap, float f, ShortHash.Strategy strategy) {
        this(short2LongMap.size(), f, strategy);
        this.putAll(short2LongMap);
    }

    public Short2LongOpenCustomHashMap(Short2LongMap short2LongMap, ShortHash.Strategy strategy) {
        this(short2LongMap, 0.75f, strategy);
    }

    public Short2LongOpenCustomHashMap(short[] sArray, long[] lArray, float f, ShortHash.Strategy strategy) {
    ...
    public Short2LongOpenCustomHashMap(short[] sArray, long[] lArray, ShortHash.Strategy strategy) {
        this(sArray, lArray, 0.75f, strategy);
    }
    ...
    public boolean remove(short s, long l) {
        ...
        if (this.strategy.equals(s, s2) && l == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((s2 = sArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(s, s2) || l != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection(this){
                final Short2LongOpenCustomHashMap this$0;
                {
                    this.this$0 = short2LongOpenCustomHashMap;
                }
    ...
    public Short2LongOpenCustomHashMap clone() {
        Short2LongOpenCustomHashMap short2LongOpenCustomHashMap;
        try {
            short2LongOpenCustomHashMap = (Short2LongOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        short2LongOpenCustomHashMap.keys = null;
        short2LongOpenCustomHashMap.values = null;
        short2LongOpenCustomHashMap.entries = null;
        short2LongOpenCustomHashMap.containsNullKey = this.containsNullKey;
        short2LongOpenCustomHashMap.key = (short[])this.key.clone();
        short2LongOpenCustomHashMap.value = (long[])this.value.clone();
        short2LongOpenCustomHashMap.strategy = this.strategy;
        return short2LongOpenCustomHashMap;
    }
    ...
    static long access$300(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap) {
        return short2LongOpenCustomHashMap.removeNullEntry();
    }

    static long access$400(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap, int n) {
        return short2LongOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements LongIterator {
        ...
        public ValueIterator(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap) {
            this.this$0 = short2LongOpenCustomHashMap;
            super(short2LongOpenCustomHashMap, null);
        }
    ...
    extends AbstractShortSet {
        ...
        private KeySet(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap) {
            this.this$0 = short2LongOpenCustomHashMap;
        }
        ...
        KeySet(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap, 1 var2_2) {
            this(short2LongOpenCustomHashMap);
        }
    }
    ...
    implements ShortIterator {
        ...
        public KeyIterator(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap) {
            this.this$0 = short2LongOpenCustomHashMap;
            super(short2LongOpenCustomHashMap, null);
        }
    ...
    implements Short2LongMap.FastEntrySet {
        ...
        private MapEntrySet(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap) {
            this.this$0 = short2LongOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(s, (short)0)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == l) {
                    Short2LongOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(s2, s)) {
                if (this.this$0.value[n] == l) {
                    Short2LongOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((s2 = sArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(s2, s) || this.this$0.value[n] != l);
            Short2LongOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap, 1 var2_2) {
            this(short2LongOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2LongMap.Entry> {
        ...
        private FastEntryIterator(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap) {
            this.this$0 = short2LongOpenCustomHashMap;
            super(short2LongOpenCustomHashMap, null);
        ...
        FastEntryIterator(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap, 1 var2_2) {
            this(short2LongOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Short2LongMap.Entry> {
        ...
        private EntryIterator(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap) {
            this.this$0 = short2LongOpenCustomHashMap;
            super(short2LongOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap, 1 var2_2) {
            this(short2LongOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap) {
            this.this$0 = short2LongOpenCustomHashMap;
        ...
        MapIterator(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap, 1 var2_2) {
            this(short2LongOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Short, Long> {
        ...
        MapEntry(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap, int n) {
            this.this$0 = short2LongOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Short2LongOpenCustomHashMap short2LongOpenCustomHashMap) {
            this.this$0 = short2LongOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], (Short)entry.getKey()) && this.this$0.value[this.index] == (Long)entry.getValue();
        }
