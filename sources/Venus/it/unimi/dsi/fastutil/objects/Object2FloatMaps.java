...
public final class Object2FloatMaps {
    ...
    public static <K> ObjectIterator<Object2FloatMap.Entry<K>> fastIterator(Object2FloatMap<K> object2FloatMap) {
        ObjectSet<Object2FloatMap.Entry<K>> objectSet = object2FloatMap.object2FloatEntrySet();
        return objectSet instanceof Object2FloatMap.FastEntrySet ? ((Object2FloatMap.FastEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }

    public static <K> void fastForEach(Object2FloatMap<K> object2FloatMap, Consumer<? super Object2FloatMap.Entry<K>> consumer) {
        ObjectSet<Object2FloatMap.Entry<K>> objectSet = object2FloatMap.object2FloatEntrySet();
        if (objectSet instanceof Object2FloatMap.FastEntrySet) {
            ((Object2FloatMap.FastEntrySet)objectSet).fastForEach(consumer);
        } else {
    ...
    public static <K> ObjectIterable<Object2FloatMap.Entry<K>> fastIterable(Object2FloatMap<K> object2FloatMap) {
        ObjectSet<Object2FloatMap.Entry<K>> objectSet = object2FloatMap.object2FloatEntrySet();
        return objectSet instanceof Object2FloatMap.FastEntrySet ? new ObjectIterable<Object2FloatMap.Entry<K>>(objectSet){
            ...
            public ObjectIterator<Object2FloatMap.Entry<K>> iterator() {
                return ((Object2FloatMap.FastEntrySet)this.val$entries).fastIterator();
            }

            @Override
            public void forEach(Consumer<? super Object2FloatMap.Entry<K>> consumer) {
                ((Object2FloatMap.FastEntrySet)this.val$entries).fastForEach(consumer);
            }
    ...
    public static <K> Object2FloatMap<K> synchronize(Object2FloatMap<K> object2FloatMap) {
        return new SynchronizedMap<K>(object2FloatMap);
    }

    public static <K> Object2FloatMap<K> synchronize(Object2FloatMap<K> object2FloatMap, Object object) {
        return new SynchronizedMap<K>(object2FloatMap, object);
    }

    public static <K> Object2FloatMap<K> unmodifiable(Object2FloatMap<K> object2FloatMap) {
        return new UnmodifiableMap<K>(object2FloatMap);
    }
    ...
    Serializable {
        ...
        protected SynchronizedMap(Object2FloatMap<K> object2FloatMap, Object object) {
            super(object2FloatMap, object);
            this.map = object2FloatMap;
        }
        ...
        public float computeFloatIfAbsentPartial(K k, Object2FloatFunction<? super K> object2FloatFunction) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.computeFloatIfAbsentPartial((K)k, object2FloatFunction);
            }
        }
