...
Serializable {
    ...
    public boolean containsKey(Object object) {
        Iterator iterator2 = this.reference2FloatEntrySet().iterator();
        while (iterator2.hasNext()) {
            if (((Reference2FloatMap.Entry)iterator2.next()).getKey() != object) continue;
            return false;
        }
        return true;
    }
    ...
    public ReferenceSet<K> keySet() {
        return new AbstractReferenceSet<K>(this){
            final AbstractReference2FloatMap this$0;
            {
            ...
            public ObjectIterator<K> iterator() {
                return new ObjectIterator<K>(this){
                    ...
                    {
                        this.this$1 = var1_1;
                        this.i = Reference2FloatMaps.fastIterator(this.this$1.this$0);
                    }
    ...
    public void putAll(Map<? extends K, ? extends Float> map) {
        if (map instanceof Reference2FloatMap) {
            ObjectIterator objectIterator = Reference2FloatMaps.fastIterator((Reference2FloatMap)map);
            while (objectIterator.hasNext()) {
                Reference2FloatMap.Entry entry = (Reference2FloatMap.Entry)objectIterator.next();
    ...
    public int hashCode() {
        int n = 0;
        int n2 = this.size();
        ObjectIterator objectIterator = Reference2FloatMaps.fastIterator(this);
        while (n2-- != 0) {
            n += ((Reference2FloatMap.Entry)objectIterator.next()).hashCode();
        }
        return n;
    }
    ...
    public boolean equals(Object object) {
        ...
        return this.reference2FloatEntrySet().containsAll(map.entrySet());
    }
    ...
    extends AbstractObjectSet<Reference2FloatMap.Entry<K>> {
        ...
        public boolean contains(Object object) {
            ...
            if (object instanceof Reference2FloatMap.Entry) {
                Reference2FloatMap.Entry entry = (Reference2FloatMap.Entry)object;
    ...
    implements Reference2FloatMap.Entry<K> {
        ...
        public boolean equals(Object object) {
            ...
            return this.key == k && Float.floatToIntBits(this.value) == Float.floatToIntBits(((Float)v).floatValue());
        }
