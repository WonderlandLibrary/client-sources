...
Serializable {
    ...
    public boolean containsKey(Object object) {
        Iterator iterator2 = this.reference2IntEntrySet().iterator();
        while (iterator2.hasNext()) {
            if (((Reference2IntMap.Entry)iterator2.next()).getKey() != object) continue;
            return false;
        }
        return true;
    }
    ...
    public ReferenceSet<K> keySet() {
        return new AbstractReferenceSet<K>(this){
            final AbstractReference2IntMap this$0;
            {
                this.this$0 = abstractReference2IntMap;
            }
            ...
            public ObjectIterator<K> iterator() {
                return new ObjectIterator<K>(this){
                    ...
                    {
                        this.this$1 = var1_1;
                        this.i = Reference2IntMaps.fastIterator(this.this$1.this$0);
                    }
    ...
    public void putAll(Map<? extends K, ? extends Integer> map) {
        if (map instanceof Reference2IntMap) {
            ObjectIterator objectIterator = Reference2IntMaps.fastIterator((Reference2IntMap)map);
            while (objectIterator.hasNext()) {
                Reference2IntMap.Entry entry = (Reference2IntMap.Entry)objectIterator.next();
    ...
    public int hashCode() {
        int n = 0;
        int n2 = this.size();
        ObjectIterator objectIterator = Reference2IntMaps.fastIterator(this);
        while (n2-- != 0) {
            n += ((Reference2IntMap.Entry)objectIterator.next()).hashCode();
        }
        return n;
    }
    ...
    public boolean equals(Object object) {
        ...
        return this.reference2IntEntrySet().containsAll(map.entrySet());
    }
    ...
    extends AbstractObjectSet<Reference2IntMap.Entry<K>> {
        ...
        public BasicEntrySet(Reference2IntMap<K> reference2IntMap) {
        ...
        public boolean contains(Object object) {
            ...
            if (object instanceof Reference2IntMap.Entry) {
                Reference2IntMap.Entry entry = (Reference2IntMap.Entry)object;
    ...
    implements Reference2IntMap.Entry<K> {
        ...
        public boolean equals(Object object) {
            ...
            if (object instanceof Reference2IntMap.Entry) {
                Reference2IntMap.Entry entry = (Reference2IntMap.Entry)object;
                return this.key == entry.getKey() && this.value == entry.getIntValue();
            }
            Map.Entry entry = (Map.Entry)object;
            Object k = entry.getKey();
            Object v = entry.getValue();
            ...
            return this.key == k && this.value == (Integer)v;
        }
