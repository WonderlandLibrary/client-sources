...
Hash {
    ...
    public Object2ByteOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Object2ByteOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Object2ByteOpenHashMap(Map<? extends K, ? extends Byte> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Object2ByteOpenHashMap(Map<? extends K, ? extends Byte> map) {
        this(map, 0.75f);
    }

    public Object2ByteOpenHashMap(Object2ByteMap<K> object2ByteMap, float f) {
        this(object2ByteMap.size(), f);
        this.putAll(object2ByteMap);
    }

    public Object2ByteOpenHashMap(Object2ByteMap<K> object2ByteMap) {
        this(object2ByteMap, 0.75f);
    }

    public Object2ByteOpenHashMap(K[] KArray, byte[] byArray, float f) {
    ...
    public Object2ByteOpenHashMap(K[] KArray, byte[] byArray) {
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection(this){
                final Object2ByteOpenHashMap this$0;
                {
                    this.this$0 = object2ByteOpenHashMap;
                }
    ...
    public Object2ByteOpenHashMap<K> clone() {
        Object2ByteOpenHashMap object2ByteOpenHashMap;
        try {
            object2ByteOpenHashMap = (Object2ByteOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2ByteOpenHashMap.keys = null;
        object2ByteOpenHashMap.values = null;
        object2ByteOpenHashMap.entries = null;
        object2ByteOpenHashMap.containsNullKey = this.containsNullKey;
        object2ByteOpenHashMap.key = (Object[])this.key.clone();
        object2ByteOpenHashMap.value = (byte[])this.value.clone();
    ...
    static byte access$300(Object2ByteOpenHashMap object2ByteOpenHashMap) {
        return object2ByteOpenHashMap.removeNullEntry();
    }

    static byte access$400(Object2ByteOpenHashMap object2ByteOpenHashMap, int n) {
        return object2ByteOpenHashMap.removeEntry(n);
    }
    ...
    implements ByteIterator {
        ...
        public ValueIterator(Object2ByteOpenHashMap object2ByteOpenHashMap) {
            this.this$0 = object2ByteOpenHashMap;
            super(object2ByteOpenHashMap, null);
        }
    ...
    extends AbstractObjectSet<K> {
        ...
        private KeySet(Object2ByteOpenHashMap object2ByteOpenHashMap) {
            this.this$0 = object2ByteOpenHashMap;
        }
        ...
        KeySet(Object2ByteOpenHashMap object2ByteOpenHashMap, 1 var2_2) {
            this(object2ByteOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<K> {
        ...
        public KeyIterator(Object2ByteOpenHashMap object2ByteOpenHashMap) {
            this.this$0 = object2ByteOpenHashMap;
            super(object2ByteOpenHashMap, null);
        }
    ...
    implements Object2ByteMap.FastEntrySet<K> {
        ...
        private MapEntrySet(Object2ByteOpenHashMap object2ByteOpenHashMap) {
            this.this$0 = object2ByteOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == by) {
                    Object2ByteOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2.equals(k)) {
                if (this.this$0.value[n] == by) {
                    Object2ByteOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Object2ByteOpenHashMap object2ByteOpenHashMap, 1 var2_2) {
            this(object2ByteOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Object2ByteMap.Entry<K>> {
        ...
        private FastEntryIterator(Object2ByteOpenHashMap object2ByteOpenHashMap) {
            this.this$0 = object2ByteOpenHashMap;
            super(object2ByteOpenHashMap, null);
        ...
        FastEntryIterator(Object2ByteOpenHashMap object2ByteOpenHashMap, 1 var2_2) {
            this(object2ByteOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Object2ByteMap.Entry<K>> {
        ...
        private EntryIterator(Object2ByteOpenHashMap object2ByteOpenHashMap) {
            this.this$0 = object2ByteOpenHashMap;
            super(object2ByteOpenHashMap, null);
        }
        ...
        EntryIterator(Object2ByteOpenHashMap object2ByteOpenHashMap, 1 var2_2) {
            this(object2ByteOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Object2ByteOpenHashMap object2ByteOpenHashMap) {
            this.this$0 = object2ByteOpenHashMap;
        ...
        MapIterator(Object2ByteOpenHashMap object2ByteOpenHashMap, 1 var2_2) {
            this(object2ByteOpenHashMap);
        }
    }
    ...
    Map.Entry<K, Byte> {
        ...
        MapEntry(Object2ByteOpenHashMap object2ByteOpenHashMap, int n) {
            this.this$0 = object2ByteOpenHashMap;
            this.index = n;
        }

        MapEntry(Object2ByteOpenHashMap object2ByteOpenHashMap) {
            this.this$0 = object2ByteOpenHashMap;
        }
