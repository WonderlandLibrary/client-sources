...
Map<K, Character> {
    ...
    default public Character put(K k, Character c) {
        return Reference2CharFunction.super.put(k, c);
    }

    @Override
    @Deprecated
    default public Character get(Object object) {
        return Reference2CharFunction.super.get(object);
    }

    @Override
    @Deprecated
    default public Character remove(Object object) {
        return Reference2CharFunction.super.remove(object);
    }
    ...
    default public char computeCharIfAbsentPartial(K k, Reference2CharFunction<? super K> reference2CharFunction) {
        ...
        char c3 = reference2CharFunction.getChar(k);
        this.put(k, c3);
        return c3;
    }
