...
Hash {
    ...
    public Object2DoubleLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Object2DoubleLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Object2DoubleLinkedOpenHashMap(Map<? extends K, ? extends Double> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Object2DoubleLinkedOpenHashMap(Map<? extends K, ? extends Double> map) {
        this(map, 0.75f);
    }

    public Object2DoubleLinkedOpenHashMap(Object2DoubleMap<K> object2DoubleMap, float f) {
        this(object2DoubleMap.size(), f);
        this.putAll(object2DoubleMap);
    }

    public Object2DoubleLinkedOpenHashMap(Object2DoubleMap<K> object2DoubleMap) {
        this(object2DoubleMap, 0.75f);
    }

    public Object2DoubleLinkedOpenHashMap(K[] KArray, double[] dArray, float f) {
    ...
    public Object2DoubleLinkedOpenHashMap(K[] KArray, double[] dArray) {
    ...
    public boolean remove(Object object, double d) {
        ...
        if (object.equals(k) && Double.doubleToLongBits(d) == Double.doubleToLongBits(this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((k = KArray[n = n + 1 & this.mask]) != null) continue;
            return true;
        } while (!object.equals(k) || Double.doubleToLongBits(d) != Double.doubleToLongBits(this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(this){
                final Object2DoubleLinkedOpenHashMap this$0;
                {
                    this.this$0 = object2DoubleLinkedOpenHashMap;
                }
    ...
    public Object2DoubleLinkedOpenHashMap<K> clone() {
        Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap;
        try {
            object2DoubleLinkedOpenHashMap = (Object2DoubleLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2DoubleLinkedOpenHashMap.keys = null;
        object2DoubleLinkedOpenHashMap.values = null;
        object2DoubleLinkedOpenHashMap.entries = null;
        object2DoubleLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        object2DoubleLinkedOpenHashMap.key = (Object[])this.key.clone();
        object2DoubleLinkedOpenHashMap.value = (double[])this.value.clone();
        object2DoubleLinkedOpenHashMap.link = (long[])this.link.clone();
    ...
    static double access$100(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap) {
        return object2DoubleLinkedOpenHashMap.removeNullEntry();
    }

    static double access$200(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap, int n) {
        return object2DoubleLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements DoubleListIterator {
        ...
        public ValueIterator(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap) {
            this.this$0 = object2DoubleLinkedOpenHashMap;
            super(object2DoubleLinkedOpenHashMap);
        }
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        private KeySet(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap) {
            this.this$0 = object2DoubleLinkedOpenHashMap;
        }
        ...
        KeySet(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap, 1 var2_2) {
            this(object2DoubleLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap, K k) {
            this.this$0 = object2DoubleLinkedOpenHashMap;
            super(object2DoubleLinkedOpenHashMap, k, null);
        }
        ...
        public KeyIterator(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap) {
            this.this$0 = object2DoubleLinkedOpenHashMap;
            super(object2DoubleLinkedOpenHashMap);
        }
    ...
    implements Object2DoubleSortedMap.FastSortedEntrySet<K> {
        ...
        private MapEntrySet(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap) {
            this.this$0 = object2DoubleLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && Double.doubleToLongBits(this.this$0.value[this.this$0.n]) == Double.doubleToLongBits(d)) {
                    Object2DoubleLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2.equals(k)) {
                if (Double.doubleToLongBits(this.this$0.value[n]) == Double.doubleToLongBits(d)) {
                    Object2DoubleLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((k2 = KArray[n = n + 1 & this.this$0.mask]) != null) continue;
                return true;
            } while (!k2.equals(k) || Double.doubleToLongBits(this.this$0.value[n]) != Double.doubleToLongBits(d));
            Object2DoubleLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap, 1 var2_2) {
            this(object2DoubleLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Object2DoubleMap.Entry<K>> {
        ...
        public FastEntryIterator(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap) {
            this.this$0 = object2DoubleLinkedOpenHashMap;
            super(object2DoubleLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap, K k) {
            this.this$0 = object2DoubleLinkedOpenHashMap;
            super(object2DoubleLinkedOpenHashMap, k, null);
            this.entry = new MapEntry(this.this$0);
        }
    ...
    implements ObjectListIterator<Object2DoubleMap.Entry<K>> {
        ...
        public EntryIterator(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap) {
            this.this$0 = object2DoubleLinkedOpenHashMap;
            super(object2DoubleLinkedOpenHashMap);
        }

        public EntryIterator(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap, K k) {
            this.this$0 = object2DoubleLinkedOpenHashMap;
            super(object2DoubleLinkedOpenHashMap, k, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap) {
            this.this$0 = object2DoubleLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = object2DoubleLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap, K k) {
            this.this$0 = object2DoubleLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (k == null) {
                if (object2DoubleLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)object2DoubleLinkedOpenHashMap.link[object2DoubleLinkedOpenHashMap.n];
                    this.prev = object2DoubleLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + k + " does not belong to this map.");
            }
            if (Objects.equals(object2DoubleLinkedOpenHashMap.key[object2DoubleLinkedOpenHashMap.last], k)) {
                this.prev = object2DoubleLinkedOpenHashMap.last;
                this.index = object2DoubleLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(k.hashCode()) & object2DoubleLinkedOpenHashMap.mask;
            while (object2DoubleLinkedOpenHashMap.key[n] != null) {
                if (object2DoubleLinkedOpenHashMap.key[n].equals(k)) {
                    this.next = (int)object2DoubleLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & object2DoubleLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this map.");
        }
        ...
        MapIterator(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap, Object object, 1 var3_3) {
            this(object2DoubleLinkedOpenHashMap, object);
        }
    }
    ...
    Map.Entry<K, Double> {
        ...
        MapEntry(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap, int n) {
            this.this$0 = object2DoubleLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Object2DoubleLinkedOpenHashMap object2DoubleLinkedOpenHashMap) {
            this.this$0 = object2DoubleLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Objects.equals(this.this$0.key[this.index], entry.getKey()) && Double.doubleToLongBits(this.this$0.value[this.index]) == Double.doubleToLongBits((Double)entry.getValue());
        }

        @Override
        public int hashCode() {
            return (this.this$0.key[this.index] == null ? 0 : this.this$0.key[this.index].hashCode()) ^ HashCommon.double2int(this.this$0.value[this.index]);
        }
