...
Hash {
    ...
    public Object2BooleanLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Object2BooleanLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Object2BooleanLinkedOpenHashMap(Map<? extends K, ? extends Boolean> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Object2BooleanLinkedOpenHashMap(Map<? extends K, ? extends Boolean> map) {
        this(map, 0.75f);
    }

    public Object2BooleanLinkedOpenHashMap(Object2BooleanMap<K> object2BooleanMap, float f) {
        this(object2BooleanMap.size(), f);
        this.putAll(object2BooleanMap);
    }

    public Object2BooleanLinkedOpenHashMap(Object2BooleanMap<K> object2BooleanMap) {
        this(object2BooleanMap, 0.75f);
    }

    public Object2BooleanLinkedOpenHashMap(K[] KArray, boolean[] blArray, float f) {
    ...
    public Object2BooleanLinkedOpenHashMap(K[] KArray, boolean[] blArray) {
    ...
    public boolean remove(Object object, boolean bl) {
        ...
        if (object.equals(k) && bl == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((k = KArray[n = n + 1 & this.mask]) != null) continue;
            return true;
        } while (!object.equals(k) || bl != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public BooleanCollection values() {
        if (this.values == null) {
            this.values = new AbstractBooleanCollection(this){
                final Object2BooleanLinkedOpenHashMap this$0;
                {
                    this.this$0 = object2BooleanLinkedOpenHashMap;
                }
    ...
    public Object2BooleanLinkedOpenHashMap<K> clone() {
        Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap;
        try {
            object2BooleanLinkedOpenHashMap = (Object2BooleanLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2BooleanLinkedOpenHashMap.keys = null;
        object2BooleanLinkedOpenHashMap.values = null;
        object2BooleanLinkedOpenHashMap.entries = null;
        object2BooleanLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        object2BooleanLinkedOpenHashMap.key = (Object[])this.key.clone();
        object2BooleanLinkedOpenHashMap.value = (boolean[])this.value.clone();
        object2BooleanLinkedOpenHashMap.link = (long[])this.link.clone();
        return object2BooleanLinkedOpenHashMap;
    }
    ...
    static boolean access$100(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap) {
        return object2BooleanLinkedOpenHashMap.removeNullEntry();
    }

    static boolean access$200(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap, int n) {
        return object2BooleanLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements BooleanListIterator {
        ...
        public ValueIterator(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap) {
            this.this$0 = object2BooleanLinkedOpenHashMap;
            super(object2BooleanLinkedOpenHashMap);
        }
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        private KeySet(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap) {
            this.this$0 = object2BooleanLinkedOpenHashMap;
        }
        ...
        KeySet(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap, 1 var2_2) {
            this(object2BooleanLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap, K k) {
            this.this$0 = object2BooleanLinkedOpenHashMap;
            super(object2BooleanLinkedOpenHashMap, k, null);
        }
        ...
        public KeyIterator(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap) {
            this.this$0 = object2BooleanLinkedOpenHashMap;
            super(object2BooleanLinkedOpenHashMap);
        }
    ...
    implements Object2BooleanSortedMap.FastSortedEntrySet<K> {
        ...
        private MapEntrySet(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap) {
            this.this$0 = object2BooleanLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == bl) {
                    Object2BooleanLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2.equals(k)) {
                if (this.this$0.value[n] == bl) {
                    Object2BooleanLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((k2 = KArray[n = n + 1 & this.this$0.mask]) != null) continue;
                return true;
            } while (!k2.equals(k) || this.this$0.value[n] != bl);
            Object2BooleanLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap, 1 var2_2) {
            this(object2BooleanLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Object2BooleanMap.Entry<K>> {
        ...
        public FastEntryIterator(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap) {
            this.this$0 = object2BooleanLinkedOpenHashMap;
            super(object2BooleanLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap, K k) {
            this.this$0 = object2BooleanLinkedOpenHashMap;
            super(object2BooleanLinkedOpenHashMap, k, null);
            this.entry = new MapEntry(this.this$0);
        }
    ...
    implements ObjectListIterator<Object2BooleanMap.Entry<K>> {
        ...
        public EntryIterator(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap) {
            this.this$0 = object2BooleanLinkedOpenHashMap;
            super(object2BooleanLinkedOpenHashMap);
        }

        public EntryIterator(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap, K k) {
            this.this$0 = object2BooleanLinkedOpenHashMap;
            super(object2BooleanLinkedOpenHashMap, k, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap) {
            this.this$0 = object2BooleanLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = object2BooleanLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap, K k) {
            this.this$0 = object2BooleanLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (k == null) {
                if (object2BooleanLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)object2BooleanLinkedOpenHashMap.link[object2BooleanLinkedOpenHashMap.n];
                    this.prev = object2BooleanLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + k + " does not belong to this map.");
            }
            if (Objects.equals(object2BooleanLinkedOpenHashMap.key[object2BooleanLinkedOpenHashMap.last], k)) {
                this.prev = object2BooleanLinkedOpenHashMap.last;
                this.index = object2BooleanLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(k.hashCode()) & object2BooleanLinkedOpenHashMap.mask;
            while (object2BooleanLinkedOpenHashMap.key[n] != null) {
                if (object2BooleanLinkedOpenHashMap.key[n].equals(k)) {
                    this.next = (int)object2BooleanLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & object2BooleanLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this map.");
        }
        ...
        MapIterator(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap, Object object, 1 var3_3) {
            this(object2BooleanLinkedOpenHashMap, object);
        }
    }
    ...
    Map.Entry<K, Boolean> {
        ...
        MapEntry(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap, int n) {
            this.this$0 = object2BooleanLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Object2BooleanLinkedOpenHashMap object2BooleanLinkedOpenHashMap) {
            this.this$0 = object2BooleanLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Objects.equals(this.this$0.key[this.index], entry.getKey()) && this.this$0.value[this.index] == (Boolean)entry.getValue();
        }

        @Override
        public int hashCode() {
            return (this.this$0.key[this.index] == null ? 0 : this.this$0.key[this.index].hashCode()) ^ (this.this$0.value[this.index] ? 1231 : 1237);
        }
