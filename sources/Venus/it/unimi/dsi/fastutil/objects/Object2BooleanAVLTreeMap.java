...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Object2BooleanAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Object2BooleanAVLTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2BooleanAVLTreeMap(Map<? extends K, ? extends Boolean> map) {
        this();
        this.putAll((Map<? extends K, Boolean>)map);
    }

    public Object2BooleanAVLTreeMap(SortedMap<K, Boolean> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<K, Boolean>)sortedMap);
    }

    public Object2BooleanAVLTreeMap(Object2BooleanMap<? extends K> object2BooleanMap) {
        this();
        this.putAll(object2BooleanMap);
    }

    public Object2BooleanAVLTreeMap(Object2BooleanSortedMap<K> object2BooleanSortedMap) {
        this(object2BooleanSortedMap.comparator());
        this.putAll(object2BooleanSortedMap);
    }

    public Object2BooleanAVLTreeMap(K[] KArray, boolean[] blArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2BooleanAVLTreeMap(K[] KArray, boolean[] blArray) {
        this(KArray, blArray, null);
    }
    ...
    public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>(this){
                final Comparator<? super Object2BooleanMap.Entry<K>> comparator;
                final Object2BooleanAVLTreeMap this$0;
                {
                    this.this$0 = object2BooleanAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> iterator(Object2BooleanMap.Entry<K> entry) {
                ...
                public boolean remove(Object object) {
                    ...
                    this.this$0.removeBoolean(entry2.key);
                    return false;
                }
                ...
                public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(Object2BooleanMap.Entry<K> entry, Object2BooleanMap.Entry<K> entry2) {
                    return this.this$0.subMap(entry.getKey(), entry2.getKey()).object2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2BooleanMap.Entry<K>> headSet(Object2BooleanMap.Entry<K> entry) {
                    return this.this$0.headMap(entry.getKey()).object2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2BooleanMap.Entry<K>> tailSet(Object2BooleanMap.Entry<K> entry) {
                    return this.this$0.tailMap(entry.getKey()).object2BooleanEntrySet();
                }
                ...
                private int lambda$$0(Object2BooleanMap.Entry entry, Object2BooleanMap.Entry entry2) {
    ...
    public Object2BooleanAVLTreeMap<K> clone() {
        Object2BooleanAVLTreeMap object2BooleanAVLTreeMap;
        try {
            object2BooleanAVLTreeMap = (Object2BooleanAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2BooleanAVLTreeMap.keys = null;
        object2BooleanAVLTreeMap.values = null;
        object2BooleanAVLTreeMap.entries = null;
        object2BooleanAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            object2BooleanAVLTreeMap.tree = entry2.left;
                            object2BooleanAVLTreeMap.firstEntry = object2BooleanAVLTreeMap.tree;
                            while (object2BooleanAVLTreeMap.firstEntry.left != null) {
                                object2BooleanAVLTreeMap.firstEntry = object2BooleanAVLTreeMap.firstEntry.left;
                            }
                            object2BooleanAVLTreeMap.lastEntry = object2BooleanAVLTreeMap.tree;
                            while (object2BooleanAVLTreeMap.lastEntry.right != null) {
                                object2BooleanAVLTreeMap.lastEntry = object2BooleanAVLTreeMap.lastEntry.right;
                            }
                            return object2BooleanAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry<K> readTree(ObjectInputStream objectInputStream, int n, Entry<K> entry, Entry<K> entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry<Object> entry3 = new Entry<Object>(objectInputStream.readObject(), objectInputStream.readBoolean());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry<Object> entry4 = new Entry<Object>(objectInputStream.readObject(), objectInputStream.readBoolean());
            entry4.right(new Entry<Object>(objectInputStream.readObject(), objectInputStream.readBoolean()));
    ...
    implements Serializable {
        ...
        public Submap(Object2BooleanAVLTreeMap object2BooleanAVLTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2BooleanAVLTreeMap;
            if (!bl && !bl2 && object2BooleanAVLTreeMap.compare(k, k2) > 0) {
            ...
            this.to = k2;
            this.top = bl2;
            this.defRetValue = object2BooleanAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>(this){
                    ...
                    @Override
                    public Comparator<? super Object2BooleanMap.Entry<K>> comparator() {
                        return this.this$1.this$0.object2BooleanEntrySet().comparator();
                    }
                    ...
                    public boolean remove(Object object) {
                        ...
                        if (entry2 != null && this.this$1.in(entry2.key)) {
                            this.this$1.removeBoolean(entry2.key);
                        }
                        return entry2 != null;
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(Object2BooleanMap.Entry<K> entry, Object2BooleanMap.Entry<K> entry2) {
                        return this.this$1.subMap(entry.getKey(), entry2.getKey()).object2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2BooleanMap.Entry<K>> headSet(Object2BooleanMap.Entry<K> entry) {
                        return this.this$1.headMap(entry.getKey()).object2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2BooleanMap.Entry<K>> tailSet(Object2BooleanMap.Entry<K> entry) {
                        return this.this$1.tailMap(entry.getKey()).object2BooleanEntrySet();
                    }
        ...
        public boolean put(K k, boolean bl) {
            ...
            boolean bl2 = this.this$0.put(k, bl);
        ...
        public boolean removeBoolean(Object object) {
            ...
            boolean bl = this.this$0.removeBoolean(object);
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Object2BooleanAVLTreeMap object2BooleanAVLTreeMap) {
            this.this$0 = object2BooleanAVLTreeMap;
            super(object2BooleanAVLTreeMap);
        }
        ...
        ValueIterator(Object2BooleanAVLTreeMap object2BooleanAVLTreeMap, 1 var2_2) {
            this(object2BooleanAVLTreeMap);
        }
    }
    ...
    extends AbstractObject2BooleanSortedMap.KeySet {
        ...
        private KeySet(Object2BooleanAVLTreeMap object2BooleanAVLTreeMap) {
            this.this$0 = object2BooleanAVLTreeMap;
            super(object2BooleanAVLTreeMap);
        }
        ...
        KeySet(Object2BooleanAVLTreeMap object2BooleanAVLTreeMap, 1 var2_2) {
            this(object2BooleanAVLTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2BooleanAVLTreeMap object2BooleanAVLTreeMap) {
            this.this$0 = object2BooleanAVLTreeMap;
            super(object2BooleanAVLTreeMap);
        }

        public KeyIterator(Object2BooleanAVLTreeMap object2BooleanAVLTreeMap, K k) {
            this.this$0 = object2BooleanAVLTreeMap;
            super(object2BooleanAVLTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2BooleanMap.Entry<K>> {
        ...
        EntryIterator(Object2BooleanAVLTreeMap object2BooleanAVLTreeMap) {
            this.this$0 = object2BooleanAVLTreeMap;
            super(object2BooleanAVLTreeMap);
        }

        EntryIterator(Object2BooleanAVLTreeMap object2BooleanAVLTreeMap, K k) {
            this.this$0 = object2BooleanAVLTreeMap;
            super(object2BooleanAVLTreeMap, k);
        }
        ...
        public void add(Object object) {
            this.add((Object2BooleanMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Object2BooleanMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2BooleanAVLTreeMap object2BooleanAVLTreeMap) {
            this.this$0 = object2BooleanAVLTreeMap;
            this.index = 0;
            this.next = object2BooleanAVLTreeMap.firstEntry;
        }

        TreeIterator(Object2BooleanAVLTreeMap object2BooleanAVLTreeMap, K k) {
            this.this$0 = object2BooleanAVLTreeMap;
            this.index = 0;
            this.next = object2BooleanAVLTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2BooleanAVLTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Objects.equals(this.key, entry.getKey()) && this.value == (Boolean)entry.getValue();
        }
