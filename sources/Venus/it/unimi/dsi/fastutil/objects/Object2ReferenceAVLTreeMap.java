...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Object2ReferenceAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Object2ReferenceAVLTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2ReferenceAVLTreeMap(Map<? extends K, ? extends V> map) {
        this();
        this.putAll(map);
    }

    public Object2ReferenceAVLTreeMap(SortedMap<K, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll(sortedMap);
    }

    public Object2ReferenceAVLTreeMap(Object2ReferenceMap<? extends K, ? extends V> object2ReferenceMap) {
        this();
        this.putAll(object2ReferenceMap);
    }

    public Object2ReferenceAVLTreeMap(Object2ReferenceSortedMap<K, V> object2ReferenceSortedMap) {
        this(object2ReferenceSortedMap.comparator());
        this.putAll(object2ReferenceSortedMap);
    }

    public Object2ReferenceAVLTreeMap(K[] KArray, V[] VArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2ReferenceAVLTreeMap(K[] KArray, V[] VArray) {
    ...
    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>(this){
                final Comparator<? super Object2ReferenceMap.Entry<K, V>> comparator;
                final Object2ReferenceAVLTreeMap this$0;
                {
                    this.this$0 = object2ReferenceAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator(Object2ReferenceMap.Entry<K, V> entry) {
                ...
                public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(Object2ReferenceMap.Entry<K, V> entry, Object2ReferenceMap.Entry<K, V> entry2) {
                    return this.this$0.subMap(entry.getKey(), entry2.getKey()).object2ReferenceEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(Object2ReferenceMap.Entry<K, V> entry) {
                    return this.this$0.headMap(entry.getKey()).object2ReferenceEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(Object2ReferenceMap.Entry<K, V> entry) {
                    return this.this$0.tailMap(entry.getKey()).object2ReferenceEntrySet();
                }
                ...
                private int lambda$$0(Object2ReferenceMap.Entry entry, Object2ReferenceMap.Entry entry2) {
    ...
    public Object2ReferenceAVLTreeMap<K, V> clone() {
        Object2ReferenceAVLTreeMap object2ReferenceAVLTreeMap;
        try {
            object2ReferenceAVLTreeMap = (Object2ReferenceAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2ReferenceAVLTreeMap.keys = null;
        object2ReferenceAVLTreeMap.values = null;
        object2ReferenceAVLTreeMap.entries = null;
        object2ReferenceAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            object2ReferenceAVLTreeMap.tree = entry2.left;
                            object2ReferenceAVLTreeMap.firstEntry = object2ReferenceAVLTreeMap.tree;
                            while (object2ReferenceAVLTreeMap.firstEntry.left != null) {
                                object2ReferenceAVLTreeMap.firstEntry = object2ReferenceAVLTreeMap.firstEntry.left;
                            }
                            object2ReferenceAVLTreeMap.lastEntry = object2ReferenceAVLTreeMap.tree;
                            while (object2ReferenceAVLTreeMap.lastEntry.right != null) {
                                object2ReferenceAVLTreeMap.lastEntry = object2ReferenceAVLTreeMap.lastEntry.right;
                            }
                            return object2ReferenceAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Object2ReferenceAVLTreeMap object2ReferenceAVLTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2ReferenceAVLTreeMap;
            if (!bl && !bl2 && object2ReferenceAVLTreeMap.compare(k, k2) > 0) {
            ...
            this.to = k2;
            this.top = bl2;
            this.defRetValue = object2ReferenceAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>(this){
                    ...
                    @Override
                    public Comparator<? super Object2ReferenceMap.Entry<K, V>> comparator() {
                        return this.this$1.this$0.object2ReferenceEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(Object2ReferenceMap.Entry<K, V> entry, Object2ReferenceMap.Entry<K, V> entry2) {
                        return this.this$1.subMap(entry.getKey(), entry2.getKey()).object2ReferenceEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(Object2ReferenceMap.Entry<K, V> entry) {
                        return this.this$1.headMap(entry.getKey()).object2ReferenceEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(Object2ReferenceMap.Entry<K, V> entry) {
                        return this.this$1.tailMap(entry.getKey()).object2ReferenceEntrySet();
                    }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Object2ReferenceAVLTreeMap object2ReferenceAVLTreeMap) {
            this.this$0 = object2ReferenceAVLTreeMap;
            super(object2ReferenceAVLTreeMap);
        }
        ...
        ValueIterator(Object2ReferenceAVLTreeMap object2ReferenceAVLTreeMap, 1 var2_2) {
            this(object2ReferenceAVLTreeMap);
        }
    }
    ...
    extends AbstractObject2ReferenceSortedMap.KeySet {
        ...
        private KeySet(Object2ReferenceAVLTreeMap object2ReferenceAVLTreeMap) {
            this.this$0 = object2ReferenceAVLTreeMap;
            super(object2ReferenceAVLTreeMap);
        }
        ...
        KeySet(Object2ReferenceAVLTreeMap object2ReferenceAVLTreeMap, 1 var2_2) {
            this(object2ReferenceAVLTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2ReferenceAVLTreeMap object2ReferenceAVLTreeMap) {
            this.this$0 = object2ReferenceAVLTreeMap;
            super(object2ReferenceAVLTreeMap);
        }

        public KeyIterator(Object2ReferenceAVLTreeMap object2ReferenceAVLTreeMap, K k) {
            this.this$0 = object2ReferenceAVLTreeMap;
            super(object2ReferenceAVLTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> {
        ...
        EntryIterator(Object2ReferenceAVLTreeMap object2ReferenceAVLTreeMap) {
            this.this$0 = object2ReferenceAVLTreeMap;
            super(object2ReferenceAVLTreeMap);
        }

        EntryIterator(Object2ReferenceAVLTreeMap object2ReferenceAVLTreeMap, K k) {
            this.this$0 = object2ReferenceAVLTreeMap;
            super(object2ReferenceAVLTreeMap, k);
        }
        ...
        public void add(Object object) {
            this.add((Object2ReferenceMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Object2ReferenceMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2ReferenceAVLTreeMap object2ReferenceAVLTreeMap) {
            this.this$0 = object2ReferenceAVLTreeMap;
            this.index = 0;
            this.next = object2ReferenceAVLTreeMap.firstEntry;
        }

        TreeIterator(Object2ReferenceAVLTreeMap object2ReferenceAVLTreeMap, K k) {
            this.this$0 = object2ReferenceAVLTreeMap;
            this.index = 0;
            this.next = object2ReferenceAVLTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2ReferenceAVLTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
