...
Hash {
    ...
    public Reference2ObjectOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Reference2ObjectOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Reference2ObjectOpenHashMap(Map<? extends K, ? extends V> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Reference2ObjectOpenHashMap(Map<? extends K, ? extends V> map) {
        this(map, 0.75f);
    }

    public Reference2ObjectOpenHashMap(Reference2ObjectMap<K, V> reference2ObjectMap, float f) {
        this(reference2ObjectMap.size(), f);
        this.putAll(reference2ObjectMap);
    }

    public Reference2ObjectOpenHashMap(Reference2ObjectMap<K, V> reference2ObjectMap) {
        this(reference2ObjectMap, 0.75f);
    }

    public Reference2ObjectOpenHashMap(K[] KArray, V[] VArray, float f) {
    ...
    public Reference2ObjectOpenHashMap(K[] KArray, V[] VArray) {
    ...
    public ObjectCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(this){
                final Reference2ObjectOpenHashMap this$0;
                {
                    this.this$0 = reference2ObjectOpenHashMap;
                }
    ...
    public Reference2ObjectOpenHashMap<K, V> clone() {
        Reference2ObjectOpenHashMap reference2ObjectOpenHashMap;
        try {
            reference2ObjectOpenHashMap = (Reference2ObjectOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2ObjectOpenHashMap.keys = null;
        reference2ObjectOpenHashMap.values = null;
        reference2ObjectOpenHashMap.entries = null;
        reference2ObjectOpenHashMap.containsNullKey = this.containsNullKey;
        reference2ObjectOpenHashMap.key = (Object[])this.key.clone();
        reference2ObjectOpenHashMap.value = (Object[])this.value.clone();
    ...
    static Object access$300(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap) {
        return reference2ObjectOpenHashMap.removeNullEntry();
    }

    static Object access$400(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap, int n) {
        return reference2ObjectOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap) {
            this.this$0 = reference2ObjectOpenHashMap;
            super(reference2ObjectOpenHashMap, null);
        }
    ...
    extends AbstractReferenceSet<K> {
        ...
        private KeySet(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap) {
            this.this$0 = reference2ObjectOpenHashMap;
        }
        ...
        KeySet(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap, 1 var2_2) {
            this(reference2ObjectOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<K> {
        ...
        public KeyIterator(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap) {
            this.this$0 = reference2ObjectOpenHashMap;
            super(reference2ObjectOpenHashMap, null);
        }
    ...
    implements Reference2ObjectMap.FastEntrySet<K, V> {
        ...
        private MapEntrySet(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap) {
            this.this$0 = reference2ObjectOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && Objects.equals(this.this$0.value[this.this$0.n], v)) {
                    Reference2ObjectOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2 == k) {
                if (Objects.equals(this.this$0.value[n], v)) {
                    Reference2ObjectOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap, 1 var2_2) {
            this(reference2ObjectOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2ObjectMap.Entry<K, V>> {
        ...
        private FastEntryIterator(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap) {
            this.this$0 = reference2ObjectOpenHashMap;
            super(reference2ObjectOpenHashMap, null);
        ...
        FastEntryIterator(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap, 1 var2_2) {
            this(reference2ObjectOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2ObjectMap.Entry<K, V>> {
        ...
        private EntryIterator(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap) {
            this.this$0 = reference2ObjectOpenHashMap;
            super(reference2ObjectOpenHashMap, null);
        }
        ...
        EntryIterator(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap, 1 var2_2) {
            this(reference2ObjectOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap) {
            this.this$0 = reference2ObjectOpenHashMap;
        ...
        MapIterator(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap, 1 var2_2) {
            this(reference2ObjectOpenHashMap);
        }
    }
    ...
    Map.Entry<K, V> {
        ...
        MapEntry(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap, int n) {
            this.this$0 = reference2ObjectOpenHashMap;
            this.index = n;
        }

        MapEntry(Reference2ObjectOpenHashMap reference2ObjectOpenHashMap) {
            this.this$0 = reference2ObjectOpenHashMap;
        }
