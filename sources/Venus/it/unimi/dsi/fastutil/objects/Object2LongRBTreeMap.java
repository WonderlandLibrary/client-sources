...
Cloneable {
    ...
    public Object2LongRBTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2LongRBTreeMap(Map<? extends K, ? extends Long> map) {
        this();
        this.putAll((Map<? extends K, Long>)map);
    }

    public Object2LongRBTreeMap(SortedMap<K, Long> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<K, Long>)sortedMap);
    }

    public Object2LongRBTreeMap(Object2LongMap<? extends K> object2LongMap) {
        this();
        this.putAll(object2LongMap);
    }

    public Object2LongRBTreeMap(Object2LongSortedMap<K> object2LongSortedMap) {
        this(object2LongSortedMap.comparator());
        this.putAll(object2LongSortedMap);
    }

    public Object2LongRBTreeMap(K[] KArray, long[] lArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2LongRBTreeMap(K[] KArray, long[] lArray) {
        this(KArray, lArray, null);
    }
    ...
    public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>(this){
                final Comparator<? super Object2LongMap.Entry<K>> comparator;
                final Object2LongRBTreeMap this$0;
                {
                    this.this$0 = object2LongRBTreeMap;
                ...
                public boolean remove(Object object) {
                    ...
                    this.this$0.removeLong(entry2.key);
                    return false;
                }
                ...
                public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> entry, Object2LongMap.Entry<K> entry2) {
                    return this.this$0.subMap(entry.getKey(), entry2.getKey()).object2LongEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> entry) {
                    return this.this$0.headMap(entry.getKey()).object2LongEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> entry) {
                    return this.this$0.tailMap(entry.getKey()).object2LongEntrySet();
                }
                ...
                private int lambda$$0(Object2LongMap.Entry entry, Object2LongMap.Entry entry2) {
    ...
    public Object2LongRBTreeMap<K> clone() {
        Object2LongRBTreeMap object2LongRBTreeMap;
        try {
            object2LongRBTreeMap = (Object2LongRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2LongRBTreeMap.keys = null;
        object2LongRBTreeMap.values = null;
        object2LongRBTreeMap.entries = null;
        object2LongRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            object2LongRBTreeMap.tree = entry2.left;
                            object2LongRBTreeMap.firstEntry = object2LongRBTreeMap.tree;
                            while (object2LongRBTreeMap.firstEntry.left != null) {
                                object2LongRBTreeMap.firstEntry = object2LongRBTreeMap.firstEntry.left;
                            }
                            object2LongRBTreeMap.lastEntry = object2LongRBTreeMap.tree;
                            while (object2LongRBTreeMap.lastEntry.right != null) {
                                object2LongRBTreeMap.lastEntry = object2LongRBTreeMap.lastEntry.right;
                            }
    ...
    private Entry<K> readTree(ObjectInputStream objectInputStream, int n, Entry<K> entry, Entry<K> entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry<Object> entry3 = new Entry<Object>(objectInputStream.readObject(), objectInputStream.readLong());
            entry3.pred(entry);
            entry3.succ(entry2);
            entry3.black(false);
            return entry3;
        ...
        if (n == 2) {
            Entry<Object> entry4 = new Entry<Object>(objectInputStream.readObject(), objectInputStream.readLong());
            entry4.black(false);
            entry4.right(new Entry<Object>(objectInputStream.readObject(), objectInputStream.readLong()));
    ...
    implements Serializable {
        ...
        public Submap(Object2LongRBTreeMap object2LongRBTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2LongRBTreeMap;
            if (!bl && !bl2 && object2LongRBTreeMap.compare(k, k2) > 0) {
            ...
            this.to = k2;
            this.top = bl2;
            this.defRetValue = object2LongRBTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>(this){
                    ...
                    @Override
                    public Comparator<? super Object2LongMap.Entry<K>> comparator() {
                        return this.this$1.this$0.object2LongEntrySet().comparator();
                    }
                    ...
                    public boolean remove(Object object) {
                        ...
                        if (entry2 != null && this.this$1.in(entry2.key)) {
                            this.this$1.removeLong(entry2.key);
                        }
                        return entry2 != null;
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> entry, Object2LongMap.Entry<K> entry2) {
                        return this.this$1.subMap(entry.getKey(), entry2.getKey()).object2LongEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> entry) {
                        return this.this$1.headMap(entry.getKey()).object2LongEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> entry) {
                        return this.this$1.tailMap(entry.getKey()).object2LongEntrySet();
                    }
        ...
        public long removeLong(Object object) {
            ...
            long l = this.this$0.removeLong(object);
    ...
    implements LongListIterator {
        ...
        private ValueIterator(Object2LongRBTreeMap object2LongRBTreeMap) {
            this.this$0 = object2LongRBTreeMap;
            super(object2LongRBTreeMap);
        }
        ...
        ValueIterator(Object2LongRBTreeMap object2LongRBTreeMap, 1 var2_2) {
            this(object2LongRBTreeMap);
        }
    }
    ...
    extends AbstractObject2LongSortedMap.KeySet {
        ...
        private KeySet(Object2LongRBTreeMap object2LongRBTreeMap) {
            this.this$0 = object2LongRBTreeMap;
            super(object2LongRBTreeMap);
        }
        ...
        KeySet(Object2LongRBTreeMap object2LongRBTreeMap, 1 var2_2) {
            this(object2LongRBTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2LongRBTreeMap object2LongRBTreeMap) {
            this.this$0 = object2LongRBTreeMap;
            super(object2LongRBTreeMap);
        }

        public KeyIterator(Object2LongRBTreeMap object2LongRBTreeMap, K k) {
            this.this$0 = object2LongRBTreeMap;
            super(object2LongRBTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2LongMap.Entry<K>> {
        ...
        EntryIterator(Object2LongRBTreeMap object2LongRBTreeMap) {
            this.this$0 = object2LongRBTreeMap;
            super(object2LongRBTreeMap);
        }

        EntryIterator(Object2LongRBTreeMap object2LongRBTreeMap, K k) {
            this.this$0 = object2LongRBTreeMap;
            super(object2LongRBTreeMap, k);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2LongRBTreeMap object2LongRBTreeMap) {
            this.this$0 = object2LongRBTreeMap;
            this.index = 0;
            this.next = object2LongRBTreeMap.firstEntry;
        }

        TreeIterator(Object2LongRBTreeMap object2LongRBTreeMap, K k) {
            this.this$0 = object2LongRBTreeMap;
            this.index = 0;
            this.next = object2LongRBTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2LongRBTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
        ...
        public void remove() {
            ...
            this.updatePrevious();
            this.updateNext();
            this.this$0.removeLong(this.curr.key);
            this.curr = null;
        }
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Objects.equals(this.key, entry.getKey()) && this.value == (Long)entry.getValue();
        }
