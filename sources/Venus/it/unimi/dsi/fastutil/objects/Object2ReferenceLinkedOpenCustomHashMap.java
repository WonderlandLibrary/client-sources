...
Hash {
    ...
    public Object2ReferenceLinkedOpenCustomHashMap(Map<? extends K, ? extends V> map, float f, Hash.Strategy<K> strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Object2ReferenceLinkedOpenCustomHashMap(Map<? extends K, ? extends V> map, Hash.Strategy<K> strategy) {
        this(map, 0.75f, strategy);
    }

    public Object2ReferenceLinkedOpenCustomHashMap(Object2ReferenceMap<K, V> object2ReferenceMap, float f, Hash.Strategy<K> strategy) {
        this(object2ReferenceMap.size(), f, strategy);
        this.putAll(object2ReferenceMap);
    }

    public Object2ReferenceLinkedOpenCustomHashMap(Object2ReferenceMap<K, V> object2ReferenceMap, Hash.Strategy<K> strategy) {
        this(object2ReferenceMap, 0.75f, strategy);
    }

    public Object2ReferenceLinkedOpenCustomHashMap(K[] KArray, V[] VArray, float f, Hash.Strategy<K> strategy) {
    ...
    public Object2ReferenceLinkedOpenCustomHashMap(K[] KArray, V[] VArray, Hash.Strategy<K> strategy) {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Object2ReferenceLinkedOpenCustomHashMap this$0;
                {
                    this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
                }
    ...
    public Object2ReferenceLinkedOpenCustomHashMap<K, V> clone() {
        Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap;
        try {
            object2ReferenceLinkedOpenCustomHashMap = (Object2ReferenceLinkedOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2ReferenceLinkedOpenCustomHashMap.keys = null;
        object2ReferenceLinkedOpenCustomHashMap.values = null;
        object2ReferenceLinkedOpenCustomHashMap.entries = null;
        object2ReferenceLinkedOpenCustomHashMap.containsNullKey = this.containsNullKey;
        object2ReferenceLinkedOpenCustomHashMap.key = (Object[])this.key.clone();
        object2ReferenceLinkedOpenCustomHashMap.value = (Object[])this.value.clone();
        object2ReferenceLinkedOpenCustomHashMap.link = (long[])this.link.clone();
        object2ReferenceLinkedOpenCustomHashMap.strategy = this.strategy;
        return object2ReferenceLinkedOpenCustomHashMap;
    }
    ...
    @Override
    public ObjectSortedSet object2ReferenceEntrySet() {
    ...
    static Object access$100(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap) {
        return object2ReferenceLinkedOpenCustomHashMap.removeNullEntry();
    }

    static Object access$200(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap, int n) {
        return object2ReferenceLinkedOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ObjectListIterator<V> {
        ...
        public ValueIterator(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap) {
            this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
            super(object2ReferenceLinkedOpenCustomHashMap);
        }
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        private KeySet(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap) {
            this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
        }
        ...
        KeySet(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap, 1 var2_2) {
            this(object2ReferenceLinkedOpenCustomHashMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap, K k) {
            this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
            super(object2ReferenceLinkedOpenCustomHashMap, k, null);
        }
        ...
        public KeyIterator(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap) {
            this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
            super(object2ReferenceLinkedOpenCustomHashMap);
        }
    ...
    implements Object2ReferenceSortedMap.FastSortedEntrySet<K, V> {
        ...
        private MapEntrySet(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap) {
            this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(Object2ReferenceMap.Entry<K, V> entry, Object2ReferenceMap.Entry<K, V> entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(Object2ReferenceMap.Entry<K, V> entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(Object2ReferenceMap.Entry<K, V> entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(k, null)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Object2ReferenceLinkedOpenCustomHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(k2, k)) {
                if (this.this$0.value[n] == v) {
                    Object2ReferenceLinkedOpenCustomHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Object2ReferenceMap.Entry<K, V>> iterator(Object2ReferenceMap.Entry<K, V> entry) {
        ...
        @Override
        public ObjectListIterator<Object2ReferenceMap.Entry<K, V>> fastIterator(Object2ReferenceMap.Entry<K, V> entry) {
        ...
        public void forEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractObject2ReferenceMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Object2ReferenceMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Object2ReferenceMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Object2ReferenceMap.Entry)object, (Object2ReferenceMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Object2ReferenceMap.Entry)object);
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Object2ReferenceMap.Entry entry) {
        ...
        MapEntrySet(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap, 1 var2_2) {
            this(object2ReferenceLinkedOpenCustomHashMap);
        }
    }
    ...
    implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> {
        ...
        public FastEntryIterator(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap) {
            this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
            super(object2ReferenceLinkedOpenCustomHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap, K k) {
            this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
            super(object2ReferenceLinkedOpenCustomHashMap, k, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Object2ReferenceMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Object2ReferenceMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> {
        ...
        public EntryIterator(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap) {
            this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
            super(object2ReferenceLinkedOpenCustomHashMap);
        }

        public EntryIterator(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap, K k) {
            this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
            super(object2ReferenceLinkedOpenCustomHashMap, k, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap) {
            this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = object2ReferenceLinkedOpenCustomHashMap.first;
            this.index = 0;
        }

        private MapIterator(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap, K k) {
            this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (object2ReferenceLinkedOpenCustomHashMap.strategy.equals(k, null)) {
                if (object2ReferenceLinkedOpenCustomHashMap.containsNullKey) {
                    this.next = (int)object2ReferenceLinkedOpenCustomHashMap.link[object2ReferenceLinkedOpenCustomHashMap.n];
                    this.prev = object2ReferenceLinkedOpenCustomHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + k + " does not belong to this map.");
            }
            if (object2ReferenceLinkedOpenCustomHashMap.strategy.equals(object2ReferenceLinkedOpenCustomHashMap.key[object2ReferenceLinkedOpenCustomHashMap.last], k)) {
                this.prev = object2ReferenceLinkedOpenCustomHashMap.last;
                this.index = object2ReferenceLinkedOpenCustomHashMap.size;
                return;
            }
            int n = HashCommon.mix(object2ReferenceLinkedOpenCustomHashMap.strategy.hashCode(k)) & object2ReferenceLinkedOpenCustomHashMap.mask;
            while (object2ReferenceLinkedOpenCustomHashMap.key[n] != null) {
                if (object2ReferenceLinkedOpenCustomHashMap.strategy.equals(object2ReferenceLinkedOpenCustomHashMap.key[n], k)) {
                    this.next = (int)object2ReferenceLinkedOpenCustomHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & object2ReferenceLinkedOpenCustomHashMap.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this map.");
        }
        ...
        public void set(Object2ReferenceMap.Entry<K, V> entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Object2ReferenceMap.Entry<K, V> entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap, Object object, 1 var3_3) {
            this(object2ReferenceLinkedOpenCustomHashMap, object);
        }
    }
    ...
    Map.Entry<K, V> {
        ...
        MapEntry(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap, int n) {
            this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Object2ReferenceLinkedOpenCustomHashMap object2ReferenceLinkedOpenCustomHashMap) {
            this.this$0 = object2ReferenceLinkedOpenCustomHashMap;
        }
