...
Hash {
    ...
    public Object2LongLinkedOpenHashMap(Object2LongMap<K> object2LongMap) {
        this(object2LongMap, 0.75f);
    }

    public Object2LongLinkedOpenHashMap(K[] KArray, long[] lArray, float f) {
    ...
    public Object2LongLinkedOpenHashMap(K[] KArray, long[] lArray) {
    ...
    public boolean remove(Object object, long l) {
        ...
        if (object.equals(k) && l == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((k = KArray[n = n + 1 & this.mask]) != null) continue;
            return true;
        } while (!object.equals(k) || l != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection(this){
                final Object2LongLinkedOpenHashMap this$0;
                {
                    this.this$0 = object2LongLinkedOpenHashMap;
                }
    ...
    public Object2LongLinkedOpenHashMap<K> clone() {
        Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap;
        try {
            object2LongLinkedOpenHashMap = (Object2LongLinkedOpenHashMap)super.clone();
        ...
        object2LongLinkedOpenHashMap.key = (Object[])this.key.clone();
    ...
    static long access$100(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap) {
        return object2LongLinkedOpenHashMap.removeNullEntry();
    }

    static long access$200(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap, int n) {
        return object2LongLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements LongListIterator {
        ...
        public ValueIterator(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap) {
            this.this$0 = object2LongLinkedOpenHashMap;
            super(object2LongLinkedOpenHashMap);
        }
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        private KeySet(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap) {
            this.this$0 = object2LongLinkedOpenHashMap;
        }
        ...
        KeySet(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap, 1 var2_2) {
            this(object2LongLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap, K k) {
            this.this$0 = object2LongLinkedOpenHashMap;
            super(object2LongLinkedOpenHashMap, k, null);
        }
        ...
        public KeyIterator(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap) {
            this.this$0 = object2LongLinkedOpenHashMap;
            super(object2LongLinkedOpenHashMap);
        }
    ...
    implements Object2LongSortedMap.FastSortedEntrySet<K> {
        ...
        private MapEntrySet(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap) {
            this.this$0 = object2LongLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == l) {
                    Object2LongLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2.equals(k)) {
                if (this.this$0.value[n] == l) {
                    Object2LongLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((k2 = KArray[n = n + 1 & this.this$0.mask]) != null) continue;
                return true;
            } while (!k2.equals(k) || this.this$0.value[n] != l);
            Object2LongLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap, 1 var2_2) {
            this(object2LongLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Object2LongMap.Entry<K>> {
        ...
        public FastEntryIterator(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap, K k) {
            this.this$0 = object2LongLinkedOpenHashMap;
            super(object2LongLinkedOpenHashMap, k, null);
            this.entry = new MapEntry(this.this$0);
        }
    ...
    implements ObjectListIterator<Object2LongMap.Entry<K>> {
        ...
        public EntryIterator(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap) {
            this.this$0 = object2LongLinkedOpenHashMap;
            super(object2LongLinkedOpenHashMap);
        }

        public EntryIterator(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap, K k) {
            this.this$0 = object2LongLinkedOpenHashMap;
            super(object2LongLinkedOpenHashMap, k, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap) {
            this.this$0 = object2LongLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = object2LongLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap, K k) {
            this.this$0 = object2LongLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (k == null) {
                if (object2LongLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)object2LongLinkedOpenHashMap.link[object2LongLinkedOpenHashMap.n];
                    this.prev = object2LongLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + k + " does not belong to this map.");
            }
            if (Objects.equals(object2LongLinkedOpenHashMap.key[object2LongLinkedOpenHashMap.last], k)) {
                this.prev = object2LongLinkedOpenHashMap.last;
                this.index = object2LongLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(k.hashCode()) & object2LongLinkedOpenHashMap.mask;
            while (object2LongLinkedOpenHashMap.key[n] != null) {
                if (object2LongLinkedOpenHashMap.key[n].equals(k)) {
                    this.next = (int)object2LongLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & object2LongLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this map.");
        }
        ...
        MapIterator(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap, Object object, 1 var3_3) {
            this(object2LongLinkedOpenHashMap, object);
        }
    }
    ...
    Map.Entry<K, Long> {
        ...
        MapEntry(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap, int n) {
            this.this$0 = object2LongLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Object2LongLinkedOpenHashMap object2LongLinkedOpenHashMap) {
            this.this$0 = object2LongLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Objects.equals(this.this$0.key[this.index], entry.getKey()) && this.this$0.value[this.index] == (Long)entry.getValue();
        }

        @Override
        public int hashCode() {
            return (this.this$0.key[this.index] == null ? 0 : this.this$0.key[this.index].hashCode()) ^ HashCommon.long2int(this.this$0.value[this.index]);
        }
