...
Hash {
    ...
    public ObjectOpenCustomHashSet(Iterator<? extends K> iterator2, float f, Hash.Strategy<K> strategy) {
        this(16, f, strategy);
    ...
    public ObjectOpenCustomHashSet(Iterator<? extends K> iterator2, Hash.Strategy<K> strategy) {
        this(iterator2, 0.75f, strategy);
    }

    public ObjectOpenCustomHashSet(K[] KArray, int n, int n2, float f, Hash.Strategy<K> strategy) {
    ...
    public ObjectOpenCustomHashSet(K[] KArray, int n, int n2, Hash.Strategy<K> strategy) {
        this(KArray, n, n2, 0.75f, strategy);
    }

    public ObjectOpenCustomHashSet(K[] KArray, float f, Hash.Strategy<K> strategy) {
        this(KArray, 0, KArray.length, f, strategy);
    }

    public ObjectOpenCustomHashSet(K[] KArray, Hash.Strategy<K> strategy) {
    ...
    implements ObjectIterator<K> {
        ...
        final ObjectOpenCustomHashSet this$0;

        private SetIterator(ObjectOpenCustomHashSet objectOpenCustomHashSet) {
            this.this$0 = objectOpenCustomHashSet;
        ...
        SetIterator(ObjectOpenCustomHashSet objectOpenCustomHashSet, 1 var2_2) {
