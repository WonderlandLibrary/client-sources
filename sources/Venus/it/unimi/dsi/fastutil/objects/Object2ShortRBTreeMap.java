...
Cloneable {
    ...
    public Object2ShortRBTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2ShortRBTreeMap(Map<? extends K, ? extends Short> map) {
        this();
        this.putAll((Map<? extends K, Short>)map);
    }

    public Object2ShortRBTreeMap(SortedMap<K, Short> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<K, Short>)sortedMap);
    }

    public Object2ShortRBTreeMap(Object2ShortMap<? extends K> object2ShortMap) {
        this();
        this.putAll(object2ShortMap);
    }

    public Object2ShortRBTreeMap(Object2ShortSortedMap<K> object2ShortSortedMap) {
        this(object2ShortSortedMap.comparator());
        this.putAll(object2ShortSortedMap);
    }

    public Object2ShortRBTreeMap(K[] KArray, short[] sArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2ShortRBTreeMap(K[] KArray, short[] sArray) {
    ...
    public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ShortMap.Entry<K>>(this){
                ...
                final Object2ShortRBTreeMap this$0;
                {
                    this.this$0 = object2ShortRBTreeMap;
    ...
    public Object2ShortRBTreeMap<K> clone() {
        Object2ShortRBTreeMap object2ShortRBTreeMap;
        try {
            object2ShortRBTreeMap = (Object2ShortRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2ShortRBTreeMap.keys = null;
        object2ShortRBTreeMap.values = null;
        object2ShortRBTreeMap.entries = null;
        object2ShortRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            object2ShortRBTreeMap.tree = entry2.left;
                            object2ShortRBTreeMap.firstEntry = object2ShortRBTreeMap.tree;
                            while (object2ShortRBTreeMap.firstEntry.left != null) {
                                object2ShortRBTreeMap.firstEntry = object2ShortRBTreeMap.firstEntry.left;
                            }
                            object2ShortRBTreeMap.lastEntry = object2ShortRBTreeMap.tree;
                            while (object2ShortRBTreeMap.lastEntry.right != null) {
                                object2ShortRBTreeMap.lastEntry = object2ShortRBTreeMap.lastEntry.right;
                            }
                            return object2ShortRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Object2ShortRBTreeMap object2ShortRBTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2ShortRBTreeMap;
            if (!bl && !bl2 && object2ShortRBTreeMap.compare(k, k2) > 0) {
            ...
            this.to = k2;
            this.top = bl2;
            this.defRetValue = object2ShortRBTreeMap.defRetValue;
        }
    ...
    implements ShortListIterator {
        ...
        private ValueIterator(Object2ShortRBTreeMap object2ShortRBTreeMap) {
            this.this$0 = object2ShortRBTreeMap;
            super(object2ShortRBTreeMap);
        }
        ...
        ValueIterator(Object2ShortRBTreeMap object2ShortRBTreeMap, 1 var2_2) {
            this(object2ShortRBTreeMap);
        }
    }
    ...
    extends AbstractObject2ShortSortedMap.KeySet {
        ...
        private KeySet(Object2ShortRBTreeMap object2ShortRBTreeMap) {
            this.this$0 = object2ShortRBTreeMap;
            super(object2ShortRBTreeMap);
        }
        ...
        KeySet(Object2ShortRBTreeMap object2ShortRBTreeMap, 1 var2_2) {
            this(object2ShortRBTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2ShortRBTreeMap object2ShortRBTreeMap) {
            this.this$0 = object2ShortRBTreeMap;
            super(object2ShortRBTreeMap);
        }

        public KeyIterator(Object2ShortRBTreeMap object2ShortRBTreeMap, K k) {
            this.this$0 = object2ShortRBTreeMap;
            super(object2ShortRBTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2ShortMap.Entry<K>> {
        ...
        EntryIterator(Object2ShortRBTreeMap object2ShortRBTreeMap) {
            this.this$0 = object2ShortRBTreeMap;
            super(object2ShortRBTreeMap);
        }

        EntryIterator(Object2ShortRBTreeMap object2ShortRBTreeMap, K k) {
            this.this$0 = object2ShortRBTreeMap;
            super(object2ShortRBTreeMap, k);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2ShortRBTreeMap object2ShortRBTreeMap) {
            this.this$0 = object2ShortRBTreeMap;
            this.index = 0;
            this.next = object2ShortRBTreeMap.firstEntry;
        }

        TreeIterator(Object2ShortRBTreeMap object2ShortRBTreeMap, K k) {
            this.this$0 = object2ShortRBTreeMap;
            this.index = 0;
            this.next = object2ShortRBTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2ShortRBTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
