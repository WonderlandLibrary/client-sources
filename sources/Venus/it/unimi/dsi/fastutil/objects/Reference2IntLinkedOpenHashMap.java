...
Hash {
    ...
    public Reference2IntLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Reference2IntLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Reference2IntLinkedOpenHashMap(Map<? extends K, ? extends Integer> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Reference2IntLinkedOpenHashMap(Map<? extends K, ? extends Integer> map) {
        this(map, 0.75f);
    }

    public Reference2IntLinkedOpenHashMap(Reference2IntMap<K> reference2IntMap, float f) {
        this(reference2IntMap.size(), f);
        this.putAll(reference2IntMap);
    }

    public Reference2IntLinkedOpenHashMap(Reference2IntMap<K> reference2IntMap) {
        this(reference2IntMap, 0.75f);
    }

    public Reference2IntLinkedOpenHashMap(K[] KArray, int[] nArray, float f) {
    ...
    public Reference2IntLinkedOpenHashMap(K[] KArray, int[] nArray) {
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection(this){
                final Reference2IntLinkedOpenHashMap this$0;
                {
                    this.this$0 = reference2IntLinkedOpenHashMap;
                }
    ...
    public Reference2IntLinkedOpenHashMap<K> clone() {
        Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap;
        try {
            reference2IntLinkedOpenHashMap = (Reference2IntLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2IntLinkedOpenHashMap.keys = null;
        reference2IntLinkedOpenHashMap.values = null;
        reference2IntLinkedOpenHashMap.entries = null;
        reference2IntLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        reference2IntLinkedOpenHashMap.key = (Object[])this.key.clone();
        reference2IntLinkedOpenHashMap.value = (int[])this.value.clone();
        reference2IntLinkedOpenHashMap.link = (long[])this.link.clone();
    ...
    @Override
    public ObjectSortedSet reference2IntEntrySet() {
    ...
    static int access$100(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap) {
        return reference2IntLinkedOpenHashMap.removeNullEntry();
    }

    static int access$200(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap, int n) {
        return reference2IntLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements IntListIterator {
        ...
        public ValueIterator(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap) {
            this.this$0 = reference2IntLinkedOpenHashMap;
            super(reference2IntLinkedOpenHashMap);
        }
    ...
    extends AbstractReferenceSortedSet<K> {
        ...
        private KeySet(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap) {
            this.this$0 = reference2IntLinkedOpenHashMap;
        }
        ...
        KeySet(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap, 1 var2_2) {
            this(reference2IntLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap, K k) {
            this.this$0 = reference2IntLinkedOpenHashMap;
            super(reference2IntLinkedOpenHashMap, k, null);
        }
        ...
        public KeyIterator(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap) {
            this.this$0 = reference2IntLinkedOpenHashMap;
            super(reference2IntLinkedOpenHashMap);
        }
    ...
    implements Reference2IntSortedMap.FastSortedEntrySet<K> {
        ...
        private MapEntrySet(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap) {
            this.this$0 = reference2IntLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Reference2IntMap.Entry<K>> subSet(Reference2IntMap.Entry<K> entry, Reference2IntMap.Entry<K> entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Reference2IntMap.Entry<K>> headSet(Reference2IntMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Reference2IntMap.Entry<K>> tailSet(Reference2IntMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n) {
                    Reference2IntLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2 == k) {
                if (this.this$0.value[n2] == n) {
                    Reference2IntLinkedOpenHashMap.access$200(this.this$0, n2);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Reference2IntMap.Entry<K>> iterator(Reference2IntMap.Entry<K> entry) {
        ...
        @Override
        public ObjectListIterator<Reference2IntMap.Entry<K>> fastIterator(Reference2IntMap.Entry<K> entry) {
        ...
        public void forEach(Consumer<? super Reference2IntMap.Entry<K>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractReference2IntMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Reference2IntMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Reference2IntMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Reference2IntMap.Entry)object, (Reference2IntMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Reference2IntMap.Entry)object);
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Reference2IntMap.Entry entry) {
        ...
        MapEntrySet(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap, 1 var2_2) {
            this(reference2IntLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Reference2IntMap.Entry<K>> {
        ...
        public FastEntryIterator(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap) {
            this.this$0 = reference2IntLinkedOpenHashMap;
            super(reference2IntLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap, K k) {
            this.this$0 = reference2IntLinkedOpenHashMap;
            super(reference2IntLinkedOpenHashMap, k, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Reference2IntMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Reference2IntMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Reference2IntMap.Entry<K>> {
        ...
        public EntryIterator(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap) {
            this.this$0 = reference2IntLinkedOpenHashMap;
            super(reference2IntLinkedOpenHashMap);
        }

        public EntryIterator(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap, K k) {
            this.this$0 = reference2IntLinkedOpenHashMap;
            super(reference2IntLinkedOpenHashMap, k, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap) {
            this.this$0 = reference2IntLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = reference2IntLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap, K k) {
            this.this$0 = reference2IntLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (k == null) {
                if (reference2IntLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)reference2IntLinkedOpenHashMap.link[reference2IntLinkedOpenHashMap.n];
                    this.prev = reference2IntLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + k + " does not belong to this map.");
            }
            if (reference2IntLinkedOpenHashMap.key[reference2IntLinkedOpenHashMap.last] == k) {
                this.prev = reference2IntLinkedOpenHashMap.last;
                this.index = reference2IntLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(System.identityHashCode(k)) & reference2IntLinkedOpenHashMap.mask;
            while (reference2IntLinkedOpenHashMap.key[n] != null) {
                if (reference2IntLinkedOpenHashMap.key[n] == k) {
                    this.next = (int)reference2IntLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & reference2IntLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this map.");
        }
        ...
        public void set(Reference2IntMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Reference2IntMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap, Object object, 1 var3_3) {
            this(reference2IntLinkedOpenHashMap, object);
        }
    }
    ...
    Map.Entry<K, Integer> {
        ...
        MapEntry(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap, int n) {
            this.this$0 = reference2IntLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Reference2IntLinkedOpenHashMap reference2IntLinkedOpenHashMap) {
            this.this$0 = reference2IntLinkedOpenHashMap;
        }
