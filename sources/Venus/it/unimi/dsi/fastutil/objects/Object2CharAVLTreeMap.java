...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Object2CharAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Object2CharAVLTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2CharAVLTreeMap(Map<? extends K, ? extends Character> map) {
        this();
        this.putAll((Map<? extends K, Character>)map);
    }

    public Object2CharAVLTreeMap(SortedMap<K, Character> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<K, Character>)sortedMap);
    }

    public Object2CharAVLTreeMap(Object2CharMap<? extends K> object2CharMap) {
        this();
        this.putAll(object2CharMap);
    }

    public Object2CharAVLTreeMap(Object2CharSortedMap<K> object2CharSortedMap) {
        this(object2CharSortedMap.comparator());
        this.putAll(object2CharSortedMap);
    }

    public Object2CharAVLTreeMap(K[] KArray, char[] cArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2CharAVLTreeMap(K[] KArray, char[] cArray) {
        this(KArray, cArray, null);
    }
    ...
    public ObjectSortedSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2CharMap.Entry<K>>(this){
                final Comparator<? super Object2CharMap.Entry<K>> comparator;
                final Object2CharAVLTreeMap this$0;
                {
                    this.this$0 = object2CharAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> iterator(Object2CharMap.Entry<K> entry) {
                ...
                public boolean remove(Object object) {
                    ...
                    this.this$0.removeChar(entry2.key);
                    return false;
                }
                ...
                public ObjectSortedSet<Object2CharMap.Entry<K>> subSet(Object2CharMap.Entry<K> entry, Object2CharMap.Entry<K> entry2) {
                    return this.this$0.subMap(entry.getKey(), entry2.getKey()).object2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2CharMap.Entry<K>> headSet(Object2CharMap.Entry<K> entry) {
                    return this.this$0.headMap(entry.getKey()).object2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2CharMap.Entry<K>> tailSet(Object2CharMap.Entry<K> entry) {
                    return this.this$0.tailMap(entry.getKey()).object2CharEntrySet();
                }
                ...
                private int lambda$$0(Object2CharMap.Entry entry, Object2CharMap.Entry entry2) {
    ...
    public Object2CharAVLTreeMap<K> clone() {
        Object2CharAVLTreeMap object2CharAVLTreeMap;
        try {
            object2CharAVLTreeMap = (Object2CharAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2CharAVLTreeMap.keys = null;
        object2CharAVLTreeMap.values = null;
        object2CharAVLTreeMap.entries = null;
        object2CharAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            object2CharAVLTreeMap.tree = entry2.left;
                            object2CharAVLTreeMap.firstEntry = object2CharAVLTreeMap.tree;
                            while (object2CharAVLTreeMap.firstEntry.left != null) {
                                object2CharAVLTreeMap.firstEntry = object2CharAVLTreeMap.firstEntry.left;
                            }
                            object2CharAVLTreeMap.lastEntry = object2CharAVLTreeMap.tree;
                            while (object2CharAVLTreeMap.lastEntry.right != null) {
                                object2CharAVLTreeMap.lastEntry = object2CharAVLTreeMap.lastEntry.right;
                            }
                            return object2CharAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry<K> readTree(ObjectInputStream objectInputStream, int n, Entry<K> entry, Entry<K> entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry<Object> entry3 = new Entry<Object>(objectInputStream.readObject(), objectInputStream.readChar());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry<Object> entry4 = new Entry<Object>(objectInputStream.readObject(), objectInputStream.readChar());
            entry4.right(new Entry<Object>(objectInputStream.readObject(), objectInputStream.readChar()));
    ...
    implements Serializable {
        ...
        public Submap(Object2CharAVLTreeMap object2CharAVLTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2CharAVLTreeMap;
            if (!bl && !bl2 && object2CharAVLTreeMap.compare(k, k2) > 0) {
            ...
            this.to = k2;
            this.top = bl2;
            this.defRetValue = object2CharAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2CharMap.Entry<K>>(this){
                    ...
                    @Override
                    public Comparator<? super Object2CharMap.Entry<K>> comparator() {
                        return this.this$1.this$0.object2CharEntrySet().comparator();
                    }
                    ...
                    public boolean remove(Object object) {
                        ...
                        if (entry2 != null && this.this$1.in(entry2.key)) {
                            this.this$1.removeChar(entry2.key);
                        }
                        return entry2 != null;
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Object2CharMap.Entry<K>> subSet(Object2CharMap.Entry<K> entry, Object2CharMap.Entry<K> entry2) {
                        return this.this$1.subMap(entry.getKey(), entry2.getKey()).object2CharEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2CharMap.Entry<K>> headSet(Object2CharMap.Entry<K> entry) {
                        return this.this$1.headMap(entry.getKey()).object2CharEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2CharMap.Entry<K>> tailSet(Object2CharMap.Entry<K> entry) {
                        return this.this$1.tailMap(entry.getKey()).object2CharEntrySet();
                    }
        ...
        public char removeChar(Object object) {
            ...
            char c = this.this$0.removeChar(object);
    ...
    implements CharListIterator {
        ...
        private ValueIterator(Object2CharAVLTreeMap object2CharAVLTreeMap) {
            this.this$0 = object2CharAVLTreeMap;
            super(object2CharAVLTreeMap);
        }
        ...
        ValueIterator(Object2CharAVLTreeMap object2CharAVLTreeMap, 1 var2_2) {
            this(object2CharAVLTreeMap);
        }
    }
    ...
    extends AbstractObject2CharSortedMap.KeySet {
        ...
        private KeySet(Object2CharAVLTreeMap object2CharAVLTreeMap) {
            this.this$0 = object2CharAVLTreeMap;
            super(object2CharAVLTreeMap);
        }
        ...
        KeySet(Object2CharAVLTreeMap object2CharAVLTreeMap, 1 var2_2) {
            this(object2CharAVLTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2CharAVLTreeMap object2CharAVLTreeMap) {
            this.this$0 = object2CharAVLTreeMap;
            super(object2CharAVLTreeMap);
        }

        public KeyIterator(Object2CharAVLTreeMap object2CharAVLTreeMap, K k) {
            this.this$0 = object2CharAVLTreeMap;
            super(object2CharAVLTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2CharMap.Entry<K>> {
        ...
        EntryIterator(Object2CharAVLTreeMap object2CharAVLTreeMap) {
            this.this$0 = object2CharAVLTreeMap;
            super(object2CharAVLTreeMap);
        }

        EntryIterator(Object2CharAVLTreeMap object2CharAVLTreeMap, K k) {
            this.this$0 = object2CharAVLTreeMap;
            super(object2CharAVLTreeMap, k);
        }
        ...
        public void add(Object object) {
            this.add((Object2CharMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Object2CharMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2CharAVLTreeMap object2CharAVLTreeMap) {
            this.this$0 = object2CharAVLTreeMap;
            this.index = 0;
            this.next = object2CharAVLTreeMap.firstEntry;
        }

        TreeIterator(Object2CharAVLTreeMap object2CharAVLTreeMap, K k) {
            this.this$0 = object2CharAVLTreeMap;
            this.index = 0;
            this.next = object2CharAVLTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2CharAVLTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
        ...
        public void remove() {
            ...
            this.updatePrevious();
            this.updateNext();
            this.this$0.removeChar(this.curr.key);
            this.curr = null;
        }
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Objects.equals(this.key, entry.getKey()) && this.value == ((Character)entry.getValue()).charValue();
        }
