...
Map<K, Float> {
    ...
    default public Float put(K k, Float f) {
        return Reference2FloatFunction.super.put(k, f);
    }

    @Override
    @Deprecated
    default public Float get(Object object) {
        return Reference2FloatFunction.super.get(object);
    }

    @Override
    @Deprecated
    default public Float remove(Object object) {
        return Reference2FloatFunction.super.remove(object);
    }
    ...
    default public float computeFloatIfAbsentPartial(K k, Reference2FloatFunction<? super K> reference2FloatFunction) {
        ...
        float f3 = reference2FloatFunction.getFloat(k);
        this.put(k, f3);
        return f3;
    }
