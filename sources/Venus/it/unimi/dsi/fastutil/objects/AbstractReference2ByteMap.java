...
Serializable {
    ...
    public boolean containsKey(Object object) {
        Iterator iterator2 = this.reference2ByteEntrySet().iterator();
        while (iterator2.hasNext()) {
            if (((Reference2ByteMap.Entry)iterator2.next()).getKey() != object) continue;
            return false;
        }
        return true;
    }
    ...
    public ReferenceSet<K> keySet() {
        return new AbstractReferenceSet<K>(this){
            final AbstractReference2ByteMap this$0;
            {
                this.this$0 = abstractReference2ByteMap;
            }
            ...
            public ObjectIterator<K> iterator() {
                return new ObjectIterator<K>(this){
                    ...
                    {
                        this.this$1 = var1_1;
                        this.i = Reference2ByteMaps.fastIterator(this.this$1.this$0);
                    }
    ...
    public void putAll(Map<? extends K, ? extends Byte> map) {
        if (map instanceof Reference2ByteMap) {
            ObjectIterator objectIterator = Reference2ByteMaps.fastIterator((Reference2ByteMap)map);
            while (objectIterator.hasNext()) {
                Reference2ByteMap.Entry entry = (Reference2ByteMap.Entry)objectIterator.next();
    ...
    public int hashCode() {
        int n = 0;
        int n2 = this.size();
        ObjectIterator objectIterator = Reference2ByteMaps.fastIterator(this);
        while (n2-- != 0) {
            n += ((Reference2ByteMap.Entry)objectIterator.next()).hashCode();
        }
        return n;
    }
    ...
    public boolean equals(Object object) {
        ...
        return this.reference2ByteEntrySet().containsAll(map.entrySet());
    }
    ...
    extends AbstractObjectSet<Reference2ByteMap.Entry<K>> {
        ...
        public BasicEntrySet(Reference2ByteMap<K> reference2ByteMap) {
        ...
        public boolean contains(Object object) {
            ...
            if (object instanceof Reference2ByteMap.Entry) {
                Reference2ByteMap.Entry entry = (Reference2ByteMap.Entry)object;
    ...
    implements Reference2ByteMap.Entry<K> {
        ...
        public boolean equals(Object object) {
            ...
            if (object instanceof Reference2ByteMap.Entry) {
                Reference2ByteMap.Entry entry = (Reference2ByteMap.Entry)object;
                return this.key == entry.getKey() && this.value == entry.getByteValue();
            }
            Map.Entry entry = (Map.Entry)object;
            Object k = entry.getKey();
            Object v = entry.getValue();
            ...
            return this.key == k && this.value == (Byte)v;
        }
