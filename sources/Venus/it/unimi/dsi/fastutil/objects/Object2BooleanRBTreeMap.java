...
Cloneable {
    ...
    public Object2BooleanRBTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2BooleanRBTreeMap(Map<? extends K, ? extends Boolean> map) {
        this();
        this.putAll((Map<? extends K, Boolean>)map);
    }

    public Object2BooleanRBTreeMap(SortedMap<K, Boolean> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<K, Boolean>)sortedMap);
    }

    public Object2BooleanRBTreeMap(Object2BooleanMap<? extends K> object2BooleanMap) {
        this();
        this.putAll(object2BooleanMap);
    }

    public Object2BooleanRBTreeMap(Object2BooleanSortedMap<K> object2BooleanSortedMap) {
        this(object2BooleanSortedMap.comparator());
        this.putAll(object2BooleanSortedMap);
    }

    public Object2BooleanRBTreeMap(K[] KArray, boolean[] blArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2BooleanRBTreeMap(K[] KArray, boolean[] blArray) {
    ...
    public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>(this){
                ...
                final Object2BooleanRBTreeMap this$0;
                {
    ...
    public Object2BooleanRBTreeMap<K> clone() {
        Object2BooleanRBTreeMap object2BooleanRBTreeMap;
        try {
            object2BooleanRBTreeMap = (Object2BooleanRBTreeMap)super.clone();
    ...
    implements Serializable {
        ...
        public Submap(Object2BooleanRBTreeMap object2BooleanRBTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2BooleanRBTreeMap;
            if (!bl && !bl2 && object2BooleanRBTreeMap.compare(k, k2) > 0) {
    ...
    implements BooleanListIterator {
        ...
        ValueIterator(Object2BooleanRBTreeMap object2BooleanRBTreeMap, 1 var2_2) {
    ...
    extends AbstractObject2BooleanSortedMap.KeySet {
        ...
        private KeySet(Object2BooleanRBTreeMap object2BooleanRBTreeMap) {
            this.this$0 = object2BooleanRBTreeMap;
            super(object2BooleanRBTreeMap);
        }
        ...
        KeySet(Object2BooleanRBTreeMap object2BooleanRBTreeMap, 1 var2_2) {
            this(object2BooleanRBTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2BooleanRBTreeMap object2BooleanRBTreeMap, K k) {
            this.this$0 = object2BooleanRBTreeMap;
            super(object2BooleanRBTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2BooleanMap.Entry<K>> {
        ...
        EntryIterator(Object2BooleanRBTreeMap object2BooleanRBTreeMap) {
            this.this$0 = object2BooleanRBTreeMap;
            super(object2BooleanRBTreeMap);
        }

        EntryIterator(Object2BooleanRBTreeMap object2BooleanRBTreeMap, K k) {
            this.this$0 = object2BooleanRBTreeMap;
            super(object2BooleanRBTreeMap, k);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2BooleanRBTreeMap object2BooleanRBTreeMap, K k) {
            this.this$0 = object2BooleanRBTreeMap;
            this.index = 0;
            this.next = object2BooleanRBTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2BooleanRBTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
