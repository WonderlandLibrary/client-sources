...
Hash {
    ...
    public Object2ReferenceLinkedOpenHashMap(Map<? extends K, ? extends V> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Object2ReferenceLinkedOpenHashMap(Map<? extends K, ? extends V> map) {
        this(map, 0.75f);
    }

    public Object2ReferenceLinkedOpenHashMap(Object2ReferenceMap<K, V> object2ReferenceMap, float f) {
        this(object2ReferenceMap.size(), f);
        this.putAll(object2ReferenceMap);
    }

    public Object2ReferenceLinkedOpenHashMap(Object2ReferenceMap<K, V> object2ReferenceMap) {
        this(object2ReferenceMap, 0.75f);
    }

    public Object2ReferenceLinkedOpenHashMap(K[] KArray, V[] VArray, float f) {
    ...
    public Object2ReferenceLinkedOpenHashMap(K[] KArray, V[] VArray) {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Object2ReferenceLinkedOpenHashMap this$0;
                {
                    this.this$0 = object2ReferenceLinkedOpenHashMap;
                }
    ...
    public Object2ReferenceLinkedOpenHashMap<K, V> clone() {
        Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap;
        try {
            object2ReferenceLinkedOpenHashMap = (Object2ReferenceLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2ReferenceLinkedOpenHashMap.keys = null;
        object2ReferenceLinkedOpenHashMap.values = null;
        object2ReferenceLinkedOpenHashMap.entries = null;
        object2ReferenceLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        object2ReferenceLinkedOpenHashMap.key = (Object[])this.key.clone();
        object2ReferenceLinkedOpenHashMap.value = (Object[])this.value.clone();
        object2ReferenceLinkedOpenHashMap.link = (long[])this.link.clone();
    ...
    static Object access$100(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap) {
        return object2ReferenceLinkedOpenHashMap.removeNullEntry();
    }

    static Object access$200(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap, int n) {
        return object2ReferenceLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectListIterator<V> {
        ...
        public ValueIterator(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap) {
            this.this$0 = object2ReferenceLinkedOpenHashMap;
            super(object2ReferenceLinkedOpenHashMap);
        }
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        private KeySet(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap) {
            this.this$0 = object2ReferenceLinkedOpenHashMap;
        }
        ...
        KeySet(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap, 1 var2_2) {
            this(object2ReferenceLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap, K k) {
            this.this$0 = object2ReferenceLinkedOpenHashMap;
            super(object2ReferenceLinkedOpenHashMap, k, null);
        }
        ...
        public KeyIterator(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap) {
            this.this$0 = object2ReferenceLinkedOpenHashMap;
            super(object2ReferenceLinkedOpenHashMap);
        }
    ...
    implements Object2ReferenceSortedMap.FastSortedEntrySet<K, V> {
        ...
        private MapEntrySet(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap) {
            this.this$0 = object2ReferenceLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Object2ReferenceLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2.equals(k)) {
                if (this.this$0.value[n] == v) {
                    Object2ReferenceLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((k2 = KArray[n = n + 1 & this.this$0.mask]) != null) continue;
                return true;
            } while (!k2.equals(k) || this.this$0.value[n] != v);
            Object2ReferenceLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap, 1 var2_2) {
            this(object2ReferenceLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> {
        ...
        public FastEntryIterator(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap) {
            this.this$0 = object2ReferenceLinkedOpenHashMap;
            super(object2ReferenceLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap, K k) {
            this.this$0 = object2ReferenceLinkedOpenHashMap;
            super(object2ReferenceLinkedOpenHashMap, k, null);
            this.entry = new MapEntry(this.this$0);
        }
    ...
    implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> {
        ...
        public EntryIterator(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap) {
            this.this$0 = object2ReferenceLinkedOpenHashMap;
            super(object2ReferenceLinkedOpenHashMap);
        }

        public EntryIterator(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap, K k) {
            this.this$0 = object2ReferenceLinkedOpenHashMap;
            super(object2ReferenceLinkedOpenHashMap, k, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap) {
            this.this$0 = object2ReferenceLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = object2ReferenceLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap, K k) {
            this.this$0 = object2ReferenceLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (k == null) {
                if (object2ReferenceLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)object2ReferenceLinkedOpenHashMap.link[object2ReferenceLinkedOpenHashMap.n];
                    this.prev = object2ReferenceLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + k + " does not belong to this map.");
            }
            if (Objects.equals(object2ReferenceLinkedOpenHashMap.key[object2ReferenceLinkedOpenHashMap.last], k)) {
                this.prev = object2ReferenceLinkedOpenHashMap.last;
                this.index = object2ReferenceLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(k.hashCode()) & object2ReferenceLinkedOpenHashMap.mask;
            while (object2ReferenceLinkedOpenHashMap.key[n] != null) {
                if (object2ReferenceLinkedOpenHashMap.key[n].equals(k)) {
                    this.next = (int)object2ReferenceLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & object2ReferenceLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this map.");
        }
        ...
        MapIterator(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap, Object object, 1 var3_3) {
            this(object2ReferenceLinkedOpenHashMap, object);
        }
    }
    ...
    Map.Entry<K, V> {
        ...
        MapEntry(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap, int n) {
            this.this$0 = object2ReferenceLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Object2ReferenceLinkedOpenHashMap object2ReferenceLinkedOpenHashMap) {
            this.this$0 = object2ReferenceLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Objects.equals(this.this$0.key[this.index], entry.getKey()) && this.this$0.value[this.index] == entry.getValue();
        }

        @Override
        public int hashCode() {
            return (this.this$0.key[this.index] == null ? 0 : this.this$0.key[this.index].hashCode()) ^ (this.this$0.value[this.index] == null ? 0 : System.identityHashCode(this.this$0.value[this.index]));
        }
