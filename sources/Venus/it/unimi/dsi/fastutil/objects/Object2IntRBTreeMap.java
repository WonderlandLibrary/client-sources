...
Cloneable {
    ...
    public Object2IntRBTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2IntRBTreeMap(Map<? extends K, ? extends Integer> map) {
        this();
        this.putAll((Map<? extends K, Integer>)map);
    }

    public Object2IntRBTreeMap(SortedMap<K, Integer> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<K, Integer>)sortedMap);
    }

    public Object2IntRBTreeMap(Object2IntMap<? extends K> object2IntMap) {
        this();
        this.putAll(object2IntMap);
    }

    public Object2IntRBTreeMap(Object2IntSortedMap<K> object2IntSortedMap) {
        this(object2IntSortedMap.comparator());
        this.putAll(object2IntSortedMap);
    }

    public Object2IntRBTreeMap(K[] KArray, int[] nArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2IntRBTreeMap(K[] KArray, int[] nArray) {
    ...
    public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>(this){
                ...
                final Object2IntRBTreeMap this$0;
                {
                    this.this$0 = object2IntRBTreeMap;
    ...
    public Object2IntRBTreeMap<K> clone() {
        Object2IntRBTreeMap object2IntRBTreeMap;
        try {
            object2IntRBTreeMap = (Object2IntRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2IntRBTreeMap.keys = null;
        object2IntRBTreeMap.values = null;
        object2IntRBTreeMap.entries = null;
        object2IntRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            object2IntRBTreeMap.tree = entry2.left;
                            object2IntRBTreeMap.firstEntry = object2IntRBTreeMap.tree;
                            while (object2IntRBTreeMap.firstEntry.left != null) {
                                object2IntRBTreeMap.firstEntry = object2IntRBTreeMap.firstEntry.left;
                            }
                            object2IntRBTreeMap.lastEntry = object2IntRBTreeMap.tree;
                            while (object2IntRBTreeMap.lastEntry.right != null) {
                                object2IntRBTreeMap.lastEntry = object2IntRBTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Object2IntRBTreeMap object2IntRBTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2IntRBTreeMap;
            if (!bl && !bl2 && object2IntRBTreeMap.compare(k, k2) > 0) {
            ...
            this.to = k2;
            this.top = bl2;
            this.defRetValue = object2IntRBTreeMap.defRetValue;
        }
    ...
    implements IntListIterator {
        ...
        private ValueIterator(Object2IntRBTreeMap object2IntRBTreeMap) {
            this.this$0 = object2IntRBTreeMap;
            super(object2IntRBTreeMap);
        }
        ...
        ValueIterator(Object2IntRBTreeMap object2IntRBTreeMap, 1 var2_2) {
            this(object2IntRBTreeMap);
        }
    }
    ...
    extends AbstractObject2IntSortedMap.KeySet {
        ...
        private KeySet(Object2IntRBTreeMap object2IntRBTreeMap) {
            this.this$0 = object2IntRBTreeMap;
            super(object2IntRBTreeMap);
        }
        ...
        KeySet(Object2IntRBTreeMap object2IntRBTreeMap, 1 var2_2) {
            this(object2IntRBTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2IntRBTreeMap object2IntRBTreeMap) {
            this.this$0 = object2IntRBTreeMap;
            super(object2IntRBTreeMap);
        }

        public KeyIterator(Object2IntRBTreeMap object2IntRBTreeMap, K k) {
            this.this$0 = object2IntRBTreeMap;
            super(object2IntRBTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2IntMap.Entry<K>> {
        ...
        EntryIterator(Object2IntRBTreeMap object2IntRBTreeMap) {
            this.this$0 = object2IntRBTreeMap;
            super(object2IntRBTreeMap);
        }

        EntryIterator(Object2IntRBTreeMap object2IntRBTreeMap, K k) {
            this.this$0 = object2IntRBTreeMap;
            super(object2IntRBTreeMap, k);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2IntRBTreeMap object2IntRBTreeMap) {
            this.this$0 = object2IntRBTreeMap;
            this.index = 0;
            this.next = object2IntRBTreeMap.firstEntry;
        }

        TreeIterator(Object2IntRBTreeMap object2IntRBTreeMap, K k) {
            this.this$0 = object2IntRBTreeMap;
            this.index = 0;
            this.next = object2IntRBTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2IntRBTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
