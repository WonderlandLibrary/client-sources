...
Map<K, Long> {
    ...
    default public Long put(K k, Long l) {
        return Object2LongFunction.super.put(k, l);
    }

    @Override
    @Deprecated
    default public Long get(Object object) {
        return Object2LongFunction.super.get(object);
    }

    @Override
    @Deprecated
    default public Long remove(Object object) {
        return Object2LongFunction.super.remove(object);
    }
    ...
    default public long computeLongIfAbsentPartial(K k, Object2LongFunction<? super K> object2LongFunction) {
        ...
        long l3 = object2LongFunction.getLong(k);
        this.put(k, l3);
        return l3;
    }
