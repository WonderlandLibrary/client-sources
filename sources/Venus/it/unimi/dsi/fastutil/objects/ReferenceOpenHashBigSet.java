...
Size64 {
    ...
    public ReferenceOpenHashBigSet(long l, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public ReferenceOpenHashBigSet(long l) {
        this(l, 0.75f);
    }
    ...
    public ReferenceOpenHashBigSet(Collection<? extends K> collection, float f) {
        this(collection.size(), f);
        this.addAll(collection);
    }

    public ReferenceOpenHashBigSet(Collection<? extends K> collection) {
        this(collection, 0.75f);
    }

    public ReferenceOpenHashBigSet(ReferenceCollection<? extends K> referenceCollection, float f) {
        this(referenceCollection.size(), f);
        this.addAll(referenceCollection);
    }

    public ReferenceOpenHashBigSet(ReferenceCollection<? extends K> referenceCollection) {
        this(referenceCollection, 0.75f);
    }

    public ReferenceOpenHashBigSet(Iterator<? extends K> iterator2, float f) {
        this(16L, f);
    ...
    public ReferenceOpenHashBigSet(Iterator<? extends K> iterator2) {
        this(iterator2, 0.75f);
    }

    public ReferenceOpenHashBigSet(K[] KArray, int n, int n2, float f) {
    ...
    public ReferenceOpenHashBigSet(K[] KArray, int n, int n2) {
        this(KArray, n, n2, 0.75f);
    }

    public ReferenceOpenHashBigSet(K[] KArray, float f) {
        this(KArray, 0, KArray.length, f);
    }

    public ReferenceOpenHashBigSet(K[] KArray) {
        this(KArray, 0.75f);
    }
    ...
    public boolean add(K k) {
        if (k == null) {
            ...
            int n;
            K[][] KArray = this.key;
            long l = HashCommon.mix((long)System.identityHashCode(k));
    ...
    protected final void shiftKeys(long l) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                long l3 = HashCommon.mix((long)System.identityHashCode(ObjectBigArrays.get(KArray, l))) & this.mask;
    ...
    public boolean remove(Object object) {
        ...
        K[][] KArray = this.key;
        long l = HashCommon.mix((long)System.identityHashCode(object));
        int n2 = (int)((l & this.mask) >>> 27);
    ...
    protected void rehash(long l) {
        ...
        while (l3-- != 0L) {
            ...
            K k = KArray[n3][n4];
            long l4 = HashCommon.mix((long)System.identityHashCode(k));
            int n6 = (int)((l4 & l2) >>> 27);
    ...
    public ReferenceOpenHashBigSet<K> clone() {
        ReferenceOpenHashBigSet referenceOpenHashBigSet;
        try {
            referenceOpenHashBigSet = (ReferenceOpenHashBigSet)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        referenceOpenHashBigSet.key = ObjectBigArrays.copy(this.key);
        referenceOpenHashBigSet.containsNull = this.containsNull;
    ...
    public int hashCode() {
        ...
        while (l-- != 0L) {
            ...
            if (this != KArray[n2][n3]) {
                n += System.identityHashCode(KArray[n2][n3]);
            }
            n2 += (n3 = n3 + 1 & this.segmentMask) == 0 ? 1 : 0;
        }
        return n;
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        while (l-- != 0L) {
            ...
            long l2 = HashCommon.mix((long)System.identityHashCode(object));
    ...
    implements ObjectIterator<K> {
        ...
        final ReferenceOpenHashBigSet this$0;

        private SetIterator(ReferenceOpenHashBigSet referenceOpenHashBigSet) {
            this.this$0 = referenceOpenHashBigSet;
        ...
        private final void shiftKeys(long l) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    long l3 = HashCommon.mix((long)System.identityHashCode(k)) & this.this$0.mask;
                    if (l2 <= l ? l2 >= l3 || l3 > l : l2 >= l3 && l3 > l) break;
        ...
        SetIterator(ReferenceOpenHashBigSet referenceOpenHashBigSet, 1 var2_2) {
            this(referenceOpenHashBigSet);
        }
    }
}
