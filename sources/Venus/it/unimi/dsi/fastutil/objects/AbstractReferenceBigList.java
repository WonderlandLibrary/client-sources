...
Stack<K> {
    ...
    public ObjectBigListIterator<K> listIterator(long l) {
        ...
        return new ObjectBigListIterator<K>(this, l){
            ...
            final AbstractReferenceBigList this$0;
            {
                this.this$0 = abstractReferenceBigList;
                this.val$index = l;
    ...
    public ReferenceBigList<K> subList(long l, long l2) {
        ...
        return new ReferenceSubList(this, l, l2);
    }
    ...
    public boolean equals(Object object) {
        ...
        while (l-- != 0L) {
            if (bigListIterator.next() == bigListIterator2.next()) continue;
            return true;
        }
        return false;
    }
    ...
    implements Serializable {
        ...
        protected long to;
        static final boolean $assertionsDisabled = !AbstractReferenceBigList.class.desiredAssertionStatus();

        public ReferenceSubList(ReferenceBigList<K> referenceBigList, long l, long l2) {
            this.l = referenceBigList;
            this.from = l;
            this.to = l2;
        }
        ...
        public ReferenceBigList<K> subList(long l, long l2) {
            ...
            return new ReferenceSubList<K>(this, l, l2);
        }
