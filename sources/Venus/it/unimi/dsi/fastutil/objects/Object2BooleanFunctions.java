...
public final class Object2BooleanFunctions {
    ...
    public static <K> Object2BooleanFunction<K> singleton(K k, boolean bl) {
    ...
    public static <K> Object2BooleanFunction<K> synchronize(Object2BooleanFunction<K> object2BooleanFunction) {
        return new SynchronizedFunction<K>(object2BooleanFunction);
    }

    public static <K> Object2BooleanFunction<K> synchronize(Object2BooleanFunction<K> object2BooleanFunction, Object object) {
        return new SynchronizedFunction<K>(object2BooleanFunction, object);
    }

    public static <K> Object2BooleanFunction<K> unmodifiable(Object2BooleanFunction<K> object2BooleanFunction) {
        return new UnmodifiableFunction<K>(object2BooleanFunction);
    }

    public static <K> Object2BooleanFunction<K> primitive(java.util.function.Function<? super K, ? extends Boolean> function) {
        Objects.requireNonNull(function);
        if (function instanceof Object2BooleanFunction) {
            return (Object2BooleanFunction)function;
        }
        if (function instanceof Predicate) {
            return arg_0 -> Object2BooleanFunctions.lambda$primitive$0(function, arg_0);
        }
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Object2BooleanFunction<K> object2BooleanFunction) {
            if (object2BooleanFunction == null) {
                throw new NullPointerException();
            }
            this.function = object2BooleanFunction;
        }
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Object2BooleanFunction<K> object2BooleanFunction, Object object) {
            if (object2BooleanFunction == null) {
                throw new NullPointerException();
            }
            this.function = object2BooleanFunction;
        ...
        protected SynchronizedFunction(Object2BooleanFunction<K> object2BooleanFunction) {
            if (object2BooleanFunction == null) {
                throw new NullPointerException();
            }
            this.function = object2BooleanFunction;
