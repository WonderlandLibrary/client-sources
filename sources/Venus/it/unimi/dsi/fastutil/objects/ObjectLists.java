...
public final class ObjectLists {
    ...
    public static <K> ObjectList<K> synchronize(ObjectList<K> objectList) {
        return objectList instanceof RandomAccess ? new SynchronizedRandomAccessList<K>(objectList) : new SynchronizedList<K>(objectList);
    }

    public static <K> ObjectList<K> synchronize(ObjectList<K> objectList, Object object) {
        return objectList instanceof RandomAccess ? new SynchronizedRandomAccessList<K>(objectList, object) : new SynchronizedList<K>(objectList, object);
    }

    public static <K> ObjectList<K> unmodifiable(ObjectList<K> objectList) {
        return objectList instanceof RandomAccess ? new UnmodifiableRandomAccessList<K>(objectList) : new UnmodifiableList<K>(objectList);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableRandomAccessList(ObjectList<K> objectList) {
            super(objectList);
        }
    ...
    Serializable {
        ...
        protected SynchronizedRandomAccessList(ObjectList<K> objectList, Object object) {
            super(objectList, object);
        }

        protected SynchronizedRandomAccessList(ObjectList<K> objectList) {
            super(objectList);
        }
    ...
    Serializable {
        ...
        protected SynchronizedList(ObjectList<K> objectList, Object object) {
            super(objectList, object);
            this.list = objectList;
        }
