...
Cloneable {
    ...
    public Object2ByteRBTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2ByteRBTreeMap(Map<? extends K, ? extends Byte> map) {
        this();
        this.putAll((Map<? extends K, Byte>)map);
    }

    public Object2ByteRBTreeMap(SortedMap<K, Byte> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<K, Byte>)sortedMap);
    }

    public Object2ByteRBTreeMap(Object2ByteMap<? extends K> object2ByteMap) {
        this();
        this.putAll(object2ByteMap);
    }

    public Object2ByteRBTreeMap(Object2ByteSortedMap<K> object2ByteSortedMap) {
        this(object2ByteSortedMap.comparator());
        this.putAll(object2ByteSortedMap);
    }

    public Object2ByteRBTreeMap(K[] KArray, byte[] byArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2ByteRBTreeMap(K[] KArray, byte[] byArray) {
    ...
    public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>(this){
                ...
                final Object2ByteRBTreeMap this$0;
                {
                    this.this$0 = object2ByteRBTreeMap;
    ...
    public Object2ByteRBTreeMap<K> clone() {
        Object2ByteRBTreeMap object2ByteRBTreeMap;
        try {
            object2ByteRBTreeMap = (Object2ByteRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2ByteRBTreeMap.keys = null;
        object2ByteRBTreeMap.values = null;
        object2ByteRBTreeMap.entries = null;
        object2ByteRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            object2ByteRBTreeMap.tree = entry2.left;
                            object2ByteRBTreeMap.firstEntry = object2ByteRBTreeMap.tree;
                            while (object2ByteRBTreeMap.firstEntry.left != null) {
                                object2ByteRBTreeMap.firstEntry = object2ByteRBTreeMap.firstEntry.left;
                            }
                            object2ByteRBTreeMap.lastEntry = object2ByteRBTreeMap.tree;
                            while (object2ByteRBTreeMap.lastEntry.right != null) {
                                object2ByteRBTreeMap.lastEntry = object2ByteRBTreeMap.lastEntry.right;
                            }
                            return object2ByteRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Object2ByteRBTreeMap object2ByteRBTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2ByteRBTreeMap;
            if (!bl && !bl2 && object2ByteRBTreeMap.compare(k, k2) > 0) {
            ...
            this.to = k2;
            this.top = bl2;
            this.defRetValue = object2ByteRBTreeMap.defRetValue;
        }
    ...
    implements ByteListIterator {
        ...
        private ValueIterator(Object2ByteRBTreeMap object2ByteRBTreeMap) {
            this.this$0 = object2ByteRBTreeMap;
            super(object2ByteRBTreeMap);
        }
        ...
        ValueIterator(Object2ByteRBTreeMap object2ByteRBTreeMap, 1 var2_2) {
            this(object2ByteRBTreeMap);
        }
    }
    ...
    extends AbstractObject2ByteSortedMap.KeySet {
        ...
        private KeySet(Object2ByteRBTreeMap object2ByteRBTreeMap) {
            this.this$0 = object2ByteRBTreeMap;
            super(object2ByteRBTreeMap);
        }
        ...
        KeySet(Object2ByteRBTreeMap object2ByteRBTreeMap, 1 var2_2) {
            this(object2ByteRBTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2ByteRBTreeMap object2ByteRBTreeMap) {
            this.this$0 = object2ByteRBTreeMap;
            super(object2ByteRBTreeMap);
        }

        public KeyIterator(Object2ByteRBTreeMap object2ByteRBTreeMap, K k) {
            this.this$0 = object2ByteRBTreeMap;
            super(object2ByteRBTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2ByteMap.Entry<K>> {
        ...
        EntryIterator(Object2ByteRBTreeMap object2ByteRBTreeMap) {
            this.this$0 = object2ByteRBTreeMap;
            super(object2ByteRBTreeMap);
        }

        EntryIterator(Object2ByteRBTreeMap object2ByteRBTreeMap, K k) {
            this.this$0 = object2ByteRBTreeMap;
            super(object2ByteRBTreeMap, k);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2ByteRBTreeMap object2ByteRBTreeMap) {
            this.this$0 = object2ByteRBTreeMap;
            this.index = 0;
            this.next = object2ByteRBTreeMap.firstEntry;
        }

        TreeIterator(Object2ByteRBTreeMap object2ByteRBTreeMap, K k) {
            this.this$0 = object2ByteRBTreeMap;
            this.index = 0;
            this.next = object2ByteRBTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2ByteRBTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
