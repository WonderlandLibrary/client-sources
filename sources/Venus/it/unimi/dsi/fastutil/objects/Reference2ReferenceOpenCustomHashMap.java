...
Hash {
    ...
    public Reference2ReferenceOpenCustomHashMap(int n, float f, Hash.Strategy<K> strategy) {
    ...
    public Reference2ReferenceOpenCustomHashMap(int n, Hash.Strategy<K> strategy) {
    ...
    public Reference2ReferenceOpenCustomHashMap(Map<? extends K, ? extends V> map, float f, Hash.Strategy<K> strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Reference2ReferenceOpenCustomHashMap(Map<? extends K, ? extends V> map, Hash.Strategy<K> strategy) {
        this(map, 0.75f, strategy);
    }

    public Reference2ReferenceOpenCustomHashMap(Reference2ReferenceMap<K, V> reference2ReferenceMap, float f, Hash.Strategy<K> strategy) {
        this(reference2ReferenceMap.size(), f, strategy);
        this.putAll(reference2ReferenceMap);
    }

    public Reference2ReferenceOpenCustomHashMap(Reference2ReferenceMap<K, V> reference2ReferenceMap, Hash.Strategy<K> strategy) {
        this(reference2ReferenceMap, 0.75f, strategy);
    }

    public Reference2ReferenceOpenCustomHashMap(K[] KArray, V[] VArray, float f, Hash.Strategy<K> strategy) {
    ...
    public Reference2ReferenceOpenCustomHashMap(K[] KArray, V[] VArray, Hash.Strategy<K> strategy) {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Reference2ReferenceOpenCustomHashMap this$0;
                {
                    this.this$0 = reference2ReferenceOpenCustomHashMap;
                }
    ...
    public Reference2ReferenceOpenCustomHashMap<K, V> clone() {
        Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap;
        try {
            reference2ReferenceOpenCustomHashMap = (Reference2ReferenceOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2ReferenceOpenCustomHashMap.keys = null;
        reference2ReferenceOpenCustomHashMap.values = null;
        reference2ReferenceOpenCustomHashMap.entries = null;
        reference2ReferenceOpenCustomHashMap.containsNullKey = this.containsNullKey;
        reference2ReferenceOpenCustomHashMap.key = (Object[])this.key.clone();
        reference2ReferenceOpenCustomHashMap.value = (Object[])this.value.clone();
        reference2ReferenceOpenCustomHashMap.strategy = this.strategy;
        return reference2ReferenceOpenCustomHashMap;
    }
    ...
    static Object access$300(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap) {
        return reference2ReferenceOpenCustomHashMap.removeNullEntry();
    }

    static Object access$400(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap, int n) {
        return reference2ReferenceOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap) {
            this.this$0 = reference2ReferenceOpenCustomHashMap;
            super(reference2ReferenceOpenCustomHashMap, null);
        }
    ...
    extends AbstractReferenceSet<K> {
        ...
        private KeySet(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap) {
            this.this$0 = reference2ReferenceOpenCustomHashMap;
        }
        ...
        KeySet(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(reference2ReferenceOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<K> {
        ...
        public KeyIterator(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap) {
            this.this$0 = reference2ReferenceOpenCustomHashMap;
            super(reference2ReferenceOpenCustomHashMap, null);
        }
    ...
    implements Reference2ReferenceMap.FastEntrySet<K, V> {
        ...
        private MapEntrySet(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap) {
            this.this$0 = reference2ReferenceOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(k, null)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Reference2ReferenceOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(k2, k)) {
                if (this.this$0.value[n] == v) {
                    Reference2ReferenceOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(reference2ReferenceOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2ReferenceMap.Entry<K, V>> {
        ...
        private FastEntryIterator(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap) {
            this.this$0 = reference2ReferenceOpenCustomHashMap;
            super(reference2ReferenceOpenCustomHashMap, null);
        ...
        FastEntryIterator(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(reference2ReferenceOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2ReferenceMap.Entry<K, V>> {
        ...
        private EntryIterator(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap) {
            this.this$0 = reference2ReferenceOpenCustomHashMap;
            super(reference2ReferenceOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(reference2ReferenceOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap) {
            this.this$0 = reference2ReferenceOpenCustomHashMap;
        ...
        MapIterator(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(reference2ReferenceOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<K, V> {
        ...
        MapEntry(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap, int n) {
            this.this$0 = reference2ReferenceOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Reference2ReferenceOpenCustomHashMap reference2ReferenceOpenCustomHashMap) {
            this.this$0 = reference2ReferenceOpenCustomHashMap;
        }
