...
Hash {
    ...
    public Reference2FloatOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Reference2FloatOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Reference2FloatOpenHashMap(Map<? extends K, ? extends Float> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Reference2FloatOpenHashMap(Map<? extends K, ? extends Float> map) {
        this(map, 0.75f);
    }

    public Reference2FloatOpenHashMap(Reference2FloatMap<K> reference2FloatMap, float f) {
        this(reference2FloatMap.size(), f);
        this.putAll(reference2FloatMap);
    }

    public Reference2FloatOpenHashMap(Reference2FloatMap<K> reference2FloatMap) {
        this(reference2FloatMap, 0.75f);
    }

    public Reference2FloatOpenHashMap(K[] KArray, float[] fArray, float f) {
    ...
    public Reference2FloatOpenHashMap(K[] KArray, float[] fArray) {
    ...
    public FloatCollection values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection(this){
                final Reference2FloatOpenHashMap this$0;
                {
                    this.this$0 = reference2FloatOpenHashMap;
                }
    ...
    public Reference2FloatOpenHashMap<K> clone() {
        Reference2FloatOpenHashMap reference2FloatOpenHashMap;
        try {
            reference2FloatOpenHashMap = (Reference2FloatOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2FloatOpenHashMap.keys = null;
        reference2FloatOpenHashMap.values = null;
        reference2FloatOpenHashMap.entries = null;
        reference2FloatOpenHashMap.containsNullKey = this.containsNullKey;
        reference2FloatOpenHashMap.key = (Object[])this.key.clone();
        reference2FloatOpenHashMap.value = (float[])this.value.clone();
    ...
    static float access$300(Reference2FloatOpenHashMap reference2FloatOpenHashMap) {
        return reference2FloatOpenHashMap.removeNullEntry();
    }

    static float access$400(Reference2FloatOpenHashMap reference2FloatOpenHashMap, int n) {
        return reference2FloatOpenHashMap.removeEntry(n);
    }
    ...
    implements FloatIterator {
        ...
        public ValueIterator(Reference2FloatOpenHashMap reference2FloatOpenHashMap) {
            this.this$0 = reference2FloatOpenHashMap;
            super(reference2FloatOpenHashMap, null);
        }
    ...
    extends AbstractReferenceSet<K> {
        ...
        private KeySet(Reference2FloatOpenHashMap reference2FloatOpenHashMap) {
            this.this$0 = reference2FloatOpenHashMap;
        }
        ...
        KeySet(Reference2FloatOpenHashMap reference2FloatOpenHashMap, 1 var2_2) {
            this(reference2FloatOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<K> {
        ...
        public KeyIterator(Reference2FloatOpenHashMap reference2FloatOpenHashMap) {
            this.this$0 = reference2FloatOpenHashMap;
            super(reference2FloatOpenHashMap, null);
        }
    ...
    implements Reference2FloatMap.FastEntrySet<K> {
        ...
        private MapEntrySet(Reference2FloatOpenHashMap reference2FloatOpenHashMap) {
            this.this$0 = reference2FloatOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && Float.floatToIntBits(this.this$0.value[this.this$0.n]) == Float.floatToIntBits(f)) {
                    Reference2FloatOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2 == k) {
                if (Float.floatToIntBits(this.this$0.value[n]) == Float.floatToIntBits(f)) {
                    Reference2FloatOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Reference2FloatOpenHashMap reference2FloatOpenHashMap, 1 var2_2) {
            this(reference2FloatOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2FloatMap.Entry<K>> {
        ...
        private FastEntryIterator(Reference2FloatOpenHashMap reference2FloatOpenHashMap) {
            this.this$0 = reference2FloatOpenHashMap;
            super(reference2FloatOpenHashMap, null);
        ...
        FastEntryIterator(Reference2FloatOpenHashMap reference2FloatOpenHashMap, 1 var2_2) {
            this(reference2FloatOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2FloatMap.Entry<K>> {
        ...
        private EntryIterator(Reference2FloatOpenHashMap reference2FloatOpenHashMap) {
            this.this$0 = reference2FloatOpenHashMap;
            super(reference2FloatOpenHashMap, null);
        }
        ...
        EntryIterator(Reference2FloatOpenHashMap reference2FloatOpenHashMap, 1 var2_2) {
            this(reference2FloatOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Reference2FloatOpenHashMap reference2FloatOpenHashMap) {
            this.this$0 = reference2FloatOpenHashMap;
        ...
        MapIterator(Reference2FloatOpenHashMap reference2FloatOpenHashMap, 1 var2_2) {
            this(reference2FloatOpenHashMap);
        }
    }
    ...
    Map.Entry<K, Float> {
        ...
        MapEntry(Reference2FloatOpenHashMap reference2FloatOpenHashMap, int n) {
            this.this$0 = reference2FloatOpenHashMap;
            this.index = n;
        }

        MapEntry(Reference2FloatOpenHashMap reference2FloatOpenHashMap) {
            this.this$0 = reference2FloatOpenHashMap;
        }
