...
public final class Object2DoubleSortedMaps {
    ...
    public static <K> Comparator<? super Map.Entry<K, ?>> entryComparator(Comparator<? super K> comparator) {
        return (arg_0, arg_1) -> Object2DoubleSortedMaps.lambda$entryComparator$0(comparator, arg_0, arg_1);
    }

    public static <K> ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> fastIterator(Object2DoubleSortedMap<K> object2DoubleSortedMap) {
        ObjectSet objectSet = object2DoubleSortedMap.object2DoubleEntrySet();
        return objectSet instanceof Object2DoubleSortedMap.FastSortedEntrySet ? ((Object2DoubleSortedMap.FastSortedEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }

    public static <K> ObjectBidirectionalIterable<Object2DoubleMap.Entry<K>> fastIterable(Object2DoubleSortedMap<K> object2DoubleSortedMap) {
        ObjectSet objectSet = object2DoubleSortedMap.object2DoubleEntrySet();
        return objectSet instanceof Object2DoubleSortedMap.FastSortedEntrySet ? ((Object2DoubleSortedMap.FastSortedEntrySet)objectSet)::fastIterator : objectSet;
    }
    ...
    public static <K> Object2DoubleSortedMap<K> singleton(K k, Double d) {
        return new Singleton<K>(k, d);
    }

    public static <K> Object2DoubleSortedMap<K> singleton(K k, Double d, Comparator<? super K> comparator) {
    ...
    public static <K> Object2DoubleSortedMap<K> synchronize(Object2DoubleSortedMap<K> object2DoubleSortedMap) {
        return new SynchronizedSortedMap<K>(object2DoubleSortedMap);
    }

    public static <K> Object2DoubleSortedMap<K> synchronize(Object2DoubleSortedMap<K> object2DoubleSortedMap, Object object) {
        return new SynchronizedSortedMap<K>(object2DoubleSortedMap, object);
    }

    public static <K> Object2DoubleSortedMap<K> unmodifiable(Object2DoubleSortedMap<K> object2DoubleSortedMap) {
        return new UnmodifiableSortedMap<K>(object2DoubleSortedMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableSortedMap(Object2DoubleSortedMap<K> object2DoubleSortedMap) {
            super(object2DoubleSortedMap);
            this.sortedMap = object2DoubleSortedMap;
        }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Object2DoubleSortedMap<K> object2DoubleSortedMap, Object object) {
            super(object2DoubleSortedMap, object);
            this.sortedMap = object2DoubleSortedMap;
        }

        protected SynchronizedSortedMap(Object2DoubleSortedMap<K> object2DoubleSortedMap) {
            super(object2DoubleSortedMap);
            this.sortedMap = object2DoubleSortedMap;
        }
