...
implements Object2ShortSortedMap<K> {
    ...
    implements ShortIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> objectBidirectionalIterator) {
    ...
    extends AbstractShortCollection {
        final AbstractObject2ShortSortedMap this$0;

        protected ValuesCollection(AbstractObject2ShortSortedMap abstractObject2ShortSortedMap) {
            this.this$0 = abstractObject2ShortSortedMap;
        }

        @Override
        public ShortIterator iterator() {
            return new ValuesIterator(Object2ShortSortedMaps.fastIterator(this.this$0));
        }
    ...
    implements ObjectBidirectionalIterator<K> {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> objectBidirectionalIterator) {
            this.i = objectBidirectionalIterator;
        }
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        protected KeySet(AbstractObject2ShortSortedMap abstractObject2ShortSortedMap) {
            this.this$0 = abstractObject2ShortSortedMap;
        }
        ...
        public ObjectBidirectionalIterator<K> iterator(K k) {
            return new KeySetIterator(this.this$0.object2ShortEntrySet().iterator(new AbstractObject2ShortMap.BasicEntry(k, 0)));
        }

        @Override
        public ObjectBidirectionalIterator<K> iterator() {
            return new KeySetIterator(Object2ShortSortedMaps.fastIterator(this.this$0));
        }
