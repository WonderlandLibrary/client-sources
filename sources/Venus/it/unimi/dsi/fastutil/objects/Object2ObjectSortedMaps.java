...
public final class Object2ObjectSortedMaps {
    ...
    public static <K, V> Object2ObjectSortedMap<K, V> synchronize(Object2ObjectSortedMap<K, V> object2ObjectSortedMap) {
        return new SynchronizedSortedMap<K, V>(object2ObjectSortedMap);
    }

    public static <K, V> Object2ObjectSortedMap<K, V> synchronize(Object2ObjectSortedMap<K, V> object2ObjectSortedMap, Object object) {
        return new SynchronizedSortedMap<K, V>(object2ObjectSortedMap, object);
    }

    public static <K, V> Object2ObjectSortedMap<K, V> unmodifiable(Object2ObjectSortedMap<K, V> object2ObjectSortedMap) {
        return new UnmodifiableSortedMap<K, V>(object2ObjectSortedMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableSortedMap(Object2ObjectSortedMap<K, V> object2ObjectSortedMap) {
            super(object2ObjectSortedMap);
            this.sortedMap = object2ObjectSortedMap;
        }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Object2ObjectSortedMap<K, V> object2ObjectSortedMap, Object object) {
            super(object2ObjectSortedMap, object);
            this.sortedMap = object2ObjectSortedMap;
        }

        protected SynchronizedSortedMap(Object2ObjectSortedMap<K, V> object2ObjectSortedMap) {
            super(object2ObjectSortedMap);
            this.sortedMap = object2ObjectSortedMap;
        }
