...
Hash {
    ...
    public Reference2ByteLinkedOpenHashMap(Map<? extends K, ? extends Byte> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Reference2ByteLinkedOpenHashMap(Map<? extends K, ? extends Byte> map) {
        this(map, 0.75f);
    }

    public Reference2ByteLinkedOpenHashMap(Reference2ByteMap<K> reference2ByteMap, float f) {
        this(reference2ByteMap.size(), f);
        this.putAll(reference2ByteMap);
    }

    public Reference2ByteLinkedOpenHashMap(Reference2ByteMap<K> reference2ByteMap) {
        this(reference2ByteMap, 0.75f);
    }

    public Reference2ByteLinkedOpenHashMap(K[] KArray, byte[] byArray, float f) {
    ...
    public Reference2ByteLinkedOpenHashMap(K[] KArray, byte[] byArray) {
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection(this){
                final Reference2ByteLinkedOpenHashMap this$0;
                {
                    this.this$0 = reference2ByteLinkedOpenHashMap;
                }
    ...
    public Reference2ByteLinkedOpenHashMap<K> clone() {
        Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap;
        try {
            reference2ByteLinkedOpenHashMap = (Reference2ByteLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2ByteLinkedOpenHashMap.keys = null;
        reference2ByteLinkedOpenHashMap.values = null;
        reference2ByteLinkedOpenHashMap.entries = null;
        reference2ByteLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        reference2ByteLinkedOpenHashMap.key = (Object[])this.key.clone();
        reference2ByteLinkedOpenHashMap.value = (byte[])this.value.clone();
        reference2ByteLinkedOpenHashMap.link = (long[])this.link.clone();
        return reference2ByteLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet reference2ByteEntrySet() {
    ...
    static byte access$100(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap) {
        return reference2ByteLinkedOpenHashMap.removeNullEntry();
    }

    static byte access$200(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap, int n) {
        return reference2ByteLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ByteListIterator {
        ...
        public ValueIterator(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap) {
            this.this$0 = reference2ByteLinkedOpenHashMap;
            super(reference2ByteLinkedOpenHashMap);
        }
    ...
    extends AbstractReferenceSortedSet<K> {
        ...
        private KeySet(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap) {
            this.this$0 = reference2ByteLinkedOpenHashMap;
        }
        ...
        KeySet(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap, 1 var2_2) {
            this(reference2ByteLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap, K k) {
            this.this$0 = reference2ByteLinkedOpenHashMap;
            super(reference2ByteLinkedOpenHashMap, k, null);
        }
        ...
        public KeyIterator(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap) {
            this.this$0 = reference2ByteLinkedOpenHashMap;
            super(reference2ByteLinkedOpenHashMap);
        }
    ...
    implements Reference2ByteSortedMap.FastSortedEntrySet<K> {
        ...
        private MapEntrySet(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap) {
            this.this$0 = reference2ByteLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Reference2ByteMap.Entry<K>> subSet(Reference2ByteMap.Entry<K> entry, Reference2ByteMap.Entry<K> entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Reference2ByteMap.Entry<K>> headSet(Reference2ByteMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Reference2ByteMap.Entry<K>> tailSet(Reference2ByteMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == by) {
                    Reference2ByteLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2 == k) {
                if (this.this$0.value[n] == by) {
                    Reference2ByteLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Reference2ByteMap.Entry<K>> iterator(Reference2ByteMap.Entry<K> entry) {
        ...
        @Override
        public ObjectListIterator<Reference2ByteMap.Entry<K>> fastIterator(Reference2ByteMap.Entry<K> entry) {
        ...
        public void forEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractReference2ByteMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Reference2ByteMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Reference2ByteMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Reference2ByteMap.Entry)object, (Reference2ByteMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Reference2ByteMap.Entry)object);
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Reference2ByteMap.Entry entry) {
        ...
        MapEntrySet(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap, 1 var2_2) {
            this(reference2ByteLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Reference2ByteMap.Entry<K>> {
        ...
        public FastEntryIterator(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap) {
            this.this$0 = reference2ByteLinkedOpenHashMap;
            super(reference2ByteLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap, K k) {
            this.this$0 = reference2ByteLinkedOpenHashMap;
            super(reference2ByteLinkedOpenHashMap, k, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Reference2ByteMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Reference2ByteMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Reference2ByteMap.Entry<K>> {
        ...
        public EntryIterator(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap) {
            this.this$0 = reference2ByteLinkedOpenHashMap;
            super(reference2ByteLinkedOpenHashMap);
        }

        public EntryIterator(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap, K k) {
            this.this$0 = reference2ByteLinkedOpenHashMap;
            super(reference2ByteLinkedOpenHashMap, k, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap) {
            this.this$0 = reference2ByteLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = reference2ByteLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap, K k) {
            this.this$0 = reference2ByteLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (k == null) {
                if (reference2ByteLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)reference2ByteLinkedOpenHashMap.link[reference2ByteLinkedOpenHashMap.n];
                    this.prev = reference2ByteLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + k + " does not belong to this map.");
            }
            if (reference2ByteLinkedOpenHashMap.key[reference2ByteLinkedOpenHashMap.last] == k) {
                this.prev = reference2ByteLinkedOpenHashMap.last;
                this.index = reference2ByteLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(System.identityHashCode(k)) & reference2ByteLinkedOpenHashMap.mask;
            while (reference2ByteLinkedOpenHashMap.key[n] != null) {
                if (reference2ByteLinkedOpenHashMap.key[n] == k) {
                    this.next = (int)reference2ByteLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & reference2ByteLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this map.");
        }
        ...
        public void set(Reference2ByteMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Reference2ByteMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap, Object object, 1 var3_3) {
            this(reference2ByteLinkedOpenHashMap, object);
        }
    }
    ...
    Map.Entry<K, Byte> {
        ...
        MapEntry(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap, int n) {
            this.this$0 = reference2ByteLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Reference2ByteLinkedOpenHashMap reference2ByteLinkedOpenHashMap) {
            this.this$0 = reference2ByteLinkedOpenHashMap;
        }
