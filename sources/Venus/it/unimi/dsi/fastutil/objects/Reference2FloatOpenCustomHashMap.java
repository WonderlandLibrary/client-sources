...
Hash {
    ...
    public Reference2FloatOpenCustomHashMap(int n, float f, Hash.Strategy<K> strategy) {
    ...
    public Reference2FloatOpenCustomHashMap(int n, Hash.Strategy<K> strategy) {
    ...
    public Reference2FloatOpenCustomHashMap(Map<? extends K, ? extends Float> map, float f, Hash.Strategy<K> strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Reference2FloatOpenCustomHashMap(Map<? extends K, ? extends Float> map, Hash.Strategy<K> strategy) {
        this(map, 0.75f, strategy);
    }

    public Reference2FloatOpenCustomHashMap(Reference2FloatMap<K> reference2FloatMap, float f, Hash.Strategy<K> strategy) {
        this(reference2FloatMap.size(), f, strategy);
        this.putAll(reference2FloatMap);
    }

    public Reference2FloatOpenCustomHashMap(Reference2FloatMap<K> reference2FloatMap, Hash.Strategy<K> strategy) {
        this(reference2FloatMap, 0.75f, strategy);
    }

    public Reference2FloatOpenCustomHashMap(K[] KArray, float[] fArray, float f, Hash.Strategy<K> strategy) {
    ...
    public Reference2FloatOpenCustomHashMap(K[] KArray, float[] fArray, Hash.Strategy<K> strategy) {
    ...
    public FloatCollection values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection(this){
                final Reference2FloatOpenCustomHashMap this$0;
                {
                    this.this$0 = reference2FloatOpenCustomHashMap;
                }
    ...
    public Reference2FloatOpenCustomHashMap<K> clone() {
        Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap;
        try {
            reference2FloatOpenCustomHashMap = (Reference2FloatOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2FloatOpenCustomHashMap.keys = null;
        reference2FloatOpenCustomHashMap.values = null;
        reference2FloatOpenCustomHashMap.entries = null;
        reference2FloatOpenCustomHashMap.containsNullKey = this.containsNullKey;
        reference2FloatOpenCustomHashMap.key = (Object[])this.key.clone();
        reference2FloatOpenCustomHashMap.value = (float[])this.value.clone();
        reference2FloatOpenCustomHashMap.strategy = this.strategy;
        return reference2FloatOpenCustomHashMap;
    }
    ...
    static float access$300(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap) {
        return reference2FloatOpenCustomHashMap.removeNullEntry();
    }

    static float access$400(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap, int n) {
        return reference2FloatOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements FloatIterator {
        ...
        public ValueIterator(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap) {
            this.this$0 = reference2FloatOpenCustomHashMap;
            super(reference2FloatOpenCustomHashMap, null);
        }
    ...
    extends AbstractReferenceSet<K> {
        ...
        private KeySet(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap) {
            this.this$0 = reference2FloatOpenCustomHashMap;
        }
        ...
        KeySet(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap, 1 var2_2) {
            this(reference2FloatOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<K> {
        ...
        public KeyIterator(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap) {
            this.this$0 = reference2FloatOpenCustomHashMap;
            super(reference2FloatOpenCustomHashMap, null);
        }
    ...
    implements Reference2FloatMap.FastEntrySet<K> {
        ...
        private MapEntrySet(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap) {
            this.this$0 = reference2FloatOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(k, null)) {
                if (this.this$0.containsNullKey && Float.floatToIntBits(this.this$0.value[this.this$0.n]) == Float.floatToIntBits(f)) {
                    Reference2FloatOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(k2, k)) {
                if (Float.floatToIntBits(this.this$0.value[n]) == Float.floatToIntBits(f)) {
                    Reference2FloatOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        public void forEach(Consumer<? super Reference2FloatMap.Entry<K>> consumer) {
            if (this.this$0.containsNullKey) {
                consumer.accept(new AbstractReference2FloatMap.BasicEntry(this.this$0.key[this.this$0.n], this.this$0.value[this.this$0.n]));
            }
            int n = this.this$0.n;
            while (n-- != 0) {
                if (this.this$0.key[n] == null) continue;
                consumer.accept(new AbstractReference2FloatMap.BasicEntry(this.this$0.key[n], this.this$0.value[n]));
            }
        }
        ...
        MapEntrySet(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap, 1 var2_2) {
            this(reference2FloatOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2FloatMap.Entry<K>> {
        ...
        private FastEntryIterator(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap) {
            this.this$0 = reference2FloatOpenCustomHashMap;
            super(reference2FloatOpenCustomHashMap, null);
        ...
        FastEntryIterator(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap, 1 var2_2) {
            this(reference2FloatOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2FloatMap.Entry<K>> {
        ...
        private EntryIterator(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap) {
            this.this$0 = reference2FloatOpenCustomHashMap;
            super(reference2FloatOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap, 1 var2_2) {
            this(reference2FloatOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap) {
            this.this$0 = reference2FloatOpenCustomHashMap;
        ...
        MapIterator(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap, 1 var2_2) {
            this(reference2FloatOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<K, Float> {
        ...
        MapEntry(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap, int n) {
            this.this$0 = reference2FloatOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Reference2FloatOpenCustomHashMap reference2FloatOpenCustomHashMap) {
            this.this$0 = reference2FloatOpenCustomHashMap;
        }
