...
Hash {
    ...
    public Reference2ByteOpenCustomHashMap(int n, float f, Hash.Strategy<K> strategy) {
    ...
    public Reference2ByteOpenCustomHashMap(int n, Hash.Strategy<K> strategy) {
    ...
    public Reference2ByteOpenCustomHashMap(Map<? extends K, ? extends Byte> map, float f, Hash.Strategy<K> strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Reference2ByteOpenCustomHashMap(Map<? extends K, ? extends Byte> map, Hash.Strategy<K> strategy) {
        this(map, 0.75f, strategy);
    }

    public Reference2ByteOpenCustomHashMap(Reference2ByteMap<K> reference2ByteMap, float f, Hash.Strategy<K> strategy) {
        this(reference2ByteMap.size(), f, strategy);
        this.putAll(reference2ByteMap);
    }

    public Reference2ByteOpenCustomHashMap(Reference2ByteMap<K> reference2ByteMap, Hash.Strategy<K> strategy) {
        this(reference2ByteMap, 0.75f, strategy);
    }

    public Reference2ByteOpenCustomHashMap(K[] KArray, byte[] byArray, float f, Hash.Strategy<K> strategy) {
    ...
    public Reference2ByteOpenCustomHashMap(K[] KArray, byte[] byArray, Hash.Strategy<K> strategy) {
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection(this){
                final Reference2ByteOpenCustomHashMap this$0;
                {
                    this.this$0 = reference2ByteOpenCustomHashMap;
                }
    ...
    public Reference2ByteOpenCustomHashMap<K> clone() {
        Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap;
        try {
            reference2ByteOpenCustomHashMap = (Reference2ByteOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2ByteOpenCustomHashMap.keys = null;
        reference2ByteOpenCustomHashMap.values = null;
        reference2ByteOpenCustomHashMap.entries = null;
        reference2ByteOpenCustomHashMap.containsNullKey = this.containsNullKey;
        reference2ByteOpenCustomHashMap.key = (Object[])this.key.clone();
        reference2ByteOpenCustomHashMap.value = (byte[])this.value.clone();
        reference2ByteOpenCustomHashMap.strategy = this.strategy;
        return reference2ByteOpenCustomHashMap;
    }
    ...
    static byte access$300(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap) {
        return reference2ByteOpenCustomHashMap.removeNullEntry();
    }

    static byte access$400(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap, int n) {
        return reference2ByteOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ByteIterator {
        ...
        public ValueIterator(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap) {
            this.this$0 = reference2ByteOpenCustomHashMap;
            super(reference2ByteOpenCustomHashMap, null);
        }
    ...
    extends AbstractReferenceSet<K> {
        ...
        private KeySet(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap) {
            this.this$0 = reference2ByteOpenCustomHashMap;
        }
        ...
        KeySet(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap, 1 var2_2) {
            this(reference2ByteOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<K> {
        ...
        public KeyIterator(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap) {
            this.this$0 = reference2ByteOpenCustomHashMap;
            super(reference2ByteOpenCustomHashMap, null);
        }
    ...
    implements Reference2ByteMap.FastEntrySet<K> {
        ...
        private MapEntrySet(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap) {
            this.this$0 = reference2ByteOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(k, null)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == by) {
                    Reference2ByteOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(k2, k)) {
                if (this.this$0.value[n] == by) {
                    Reference2ByteOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap, 1 var2_2) {
            this(reference2ByteOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2ByteMap.Entry<K>> {
        ...
        private FastEntryIterator(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap) {
            this.this$0 = reference2ByteOpenCustomHashMap;
            super(reference2ByteOpenCustomHashMap, null);
        ...
        FastEntryIterator(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap, 1 var2_2) {
            this(reference2ByteOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2ByteMap.Entry<K>> {
        ...
        private EntryIterator(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap) {
            this.this$0 = reference2ByteOpenCustomHashMap;
            super(reference2ByteOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap, 1 var2_2) {
            this(reference2ByteOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap) {
            this.this$0 = reference2ByteOpenCustomHashMap;
        ...
        MapIterator(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap, 1 var2_2) {
            this(reference2ByteOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<K, Byte> {
        ...
        MapEntry(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap, int n) {
            this.this$0 = reference2ByteOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Reference2ByteOpenCustomHashMap reference2ByteOpenCustomHashMap) {
            this.this$0 = reference2ByteOpenCustomHashMap;
        }
