...
Hash {
    ...
    public Reference2ObjectLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Reference2ObjectLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Reference2ObjectLinkedOpenHashMap(Map<? extends K, ? extends V> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Reference2ObjectLinkedOpenHashMap(Map<? extends K, ? extends V> map) {
        this(map, 0.75f);
    }

    public Reference2ObjectLinkedOpenHashMap(Reference2ObjectMap<K, V> reference2ObjectMap, float f) {
        this(reference2ObjectMap.size(), f);
        this.putAll(reference2ObjectMap);
    }

    public Reference2ObjectLinkedOpenHashMap(Reference2ObjectMap<K, V> reference2ObjectMap) {
        this(reference2ObjectMap, 0.75f);
    }

    public Reference2ObjectLinkedOpenHashMap(K[] KArray, V[] VArray, float f) {
    ...
    public Reference2ObjectLinkedOpenHashMap(K[] KArray, V[] VArray) {
    ...
    public ObjectCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(this){
                final Reference2ObjectLinkedOpenHashMap this$0;
                {
                    this.this$0 = reference2ObjectLinkedOpenHashMap;
                }
    ...
    public Reference2ObjectLinkedOpenHashMap<K, V> clone() {
        Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap;
        try {
            reference2ObjectLinkedOpenHashMap = (Reference2ObjectLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2ObjectLinkedOpenHashMap.keys = null;
        reference2ObjectLinkedOpenHashMap.values = null;
        reference2ObjectLinkedOpenHashMap.entries = null;
        reference2ObjectLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        reference2ObjectLinkedOpenHashMap.key = (Object[])this.key.clone();
        reference2ObjectLinkedOpenHashMap.value = (Object[])this.value.clone();
        reference2ObjectLinkedOpenHashMap.link = (long[])this.link.clone();
    ...
    static Object access$100(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap) {
        return reference2ObjectLinkedOpenHashMap.removeNullEntry();
    }

    static Object access$200(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap, int n) {
        return reference2ObjectLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectListIterator<V> {
        ...
        public ValueIterator(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap) {
            this.this$0 = reference2ObjectLinkedOpenHashMap;
            super(reference2ObjectLinkedOpenHashMap);
        }
    ...
    extends AbstractReferenceSortedSet<K> {
        ...
        private KeySet(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap) {
            this.this$0 = reference2ObjectLinkedOpenHashMap;
        }
        ...
        KeySet(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap, 1 var2_2) {
            this(reference2ObjectLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap, K k) {
            this.this$0 = reference2ObjectLinkedOpenHashMap;
            super(reference2ObjectLinkedOpenHashMap, k, null);
        }
        ...
        public KeyIterator(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap) {
            this.this$0 = reference2ObjectLinkedOpenHashMap;
            super(reference2ObjectLinkedOpenHashMap);
        }
    ...
    implements Reference2ObjectSortedMap.FastSortedEntrySet<K, V> {
        ...
        private MapEntrySet(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap) {
            this.this$0 = reference2ObjectLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> subSet(Reference2ObjectMap.Entry<K, V> entry, Reference2ObjectMap.Entry<K, V> entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> headSet(Reference2ObjectMap.Entry<K, V> entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> tailSet(Reference2ObjectMap.Entry<K, V> entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && Objects.equals(this.this$0.value[this.this$0.n], v)) {
                    Reference2ObjectLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2 == k) {
                if (Objects.equals(this.this$0.value[n], v)) {
                    Reference2ObjectLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((k2 = KArray[n = n + 1 & this.this$0.mask]) != null) continue;
                return true;
            } while (k2 != k || !Objects.equals(this.this$0.value[n], v));
            Reference2ObjectLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Reference2ObjectMap.Entry<K, V>> iterator(Reference2ObjectMap.Entry<K, V> entry) {
        ...
        @Override
        public ObjectListIterator<Reference2ObjectMap.Entry<K, V>> fastIterator(Reference2ObjectMap.Entry<K, V> entry) {
        ...
        public void forEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractReference2ObjectMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Reference2ObjectMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Reference2ObjectMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Reference2ObjectMap.Entry)object, (Reference2ObjectMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Reference2ObjectMap.Entry)object);
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Reference2ObjectMap.Entry entry) {
        ...
        MapEntrySet(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap, 1 var2_2) {
            this(reference2ObjectLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Reference2ObjectMap.Entry<K, V>> {
        ...
        public FastEntryIterator(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap) {
            this.this$0 = reference2ObjectLinkedOpenHashMap;
            super(reference2ObjectLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap, K k) {
            this.this$0 = reference2ObjectLinkedOpenHashMap;
            super(reference2ObjectLinkedOpenHashMap, k, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Reference2ObjectMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Reference2ObjectMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Reference2ObjectMap.Entry<K, V>> {
        ...
        public EntryIterator(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap) {
            this.this$0 = reference2ObjectLinkedOpenHashMap;
            super(reference2ObjectLinkedOpenHashMap);
        }

        public EntryIterator(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap, K k) {
            this.this$0 = reference2ObjectLinkedOpenHashMap;
            super(reference2ObjectLinkedOpenHashMap, k, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap) {
            this.this$0 = reference2ObjectLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = reference2ObjectLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap, K k) {
            this.this$0 = reference2ObjectLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (k == null) {
                if (reference2ObjectLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)reference2ObjectLinkedOpenHashMap.link[reference2ObjectLinkedOpenHashMap.n];
                    this.prev = reference2ObjectLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + k + " does not belong to this map.");
            }
            if (reference2ObjectLinkedOpenHashMap.key[reference2ObjectLinkedOpenHashMap.last] == k) {
                this.prev = reference2ObjectLinkedOpenHashMap.last;
                this.index = reference2ObjectLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(System.identityHashCode(k)) & reference2ObjectLinkedOpenHashMap.mask;
            while (reference2ObjectLinkedOpenHashMap.key[n] != null) {
                if (reference2ObjectLinkedOpenHashMap.key[n] == k) {
                    this.next = (int)reference2ObjectLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & reference2ObjectLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this map.");
        }
        ...
        public void set(Reference2ObjectMap.Entry<K, V> entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Reference2ObjectMap.Entry<K, V> entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap, Object object, 1 var3_3) {
            this(reference2ObjectLinkedOpenHashMap, object);
        }
    }
    ...
    Map.Entry<K, V> {
        ...
        MapEntry(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap, int n) {
            this.this$0 = reference2ObjectLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Reference2ObjectLinkedOpenHashMap reference2ObjectLinkedOpenHashMap) {
            this.this$0 = reference2ObjectLinkedOpenHashMap;
        }
        ...
        @Override
        public int hashCode() {
            return System.identityHashCode(this.this$0.key[this.index]) ^ (this.this$0.value[this.index] == null ? 0 : this.this$0.value[this.index].hashCode());
        }
