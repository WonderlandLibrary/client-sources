...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Object2FloatAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Object2FloatAVLTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2FloatAVLTreeMap(Map<? extends K, ? extends Float> map) {
        this();
        this.putAll((Map<? extends K, Float>)map);
    }

    public Object2FloatAVLTreeMap(SortedMap<K, Float> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<K, Float>)sortedMap);
    }

    public Object2FloatAVLTreeMap(Object2FloatMap<? extends K> object2FloatMap) {
        this();
        this.putAll(object2FloatMap);
    }

    public Object2FloatAVLTreeMap(Object2FloatSortedMap<K> object2FloatSortedMap) {
        this(object2FloatSortedMap.comparator());
        this.putAll(object2FloatSortedMap);
    }

    public Object2FloatAVLTreeMap(K[] KArray, float[] fArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2FloatAVLTreeMap(K[] KArray, float[] fArray) {
    ...
    public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>(this){
                ...
                final Object2FloatAVLTreeMap this$0;
                {
                    this.this$0 = object2FloatAVLTreeMap;
    ...
    public Object2FloatAVLTreeMap<K> clone() {
        Object2FloatAVLTreeMap object2FloatAVLTreeMap;
        try {
            object2FloatAVLTreeMap = (Object2FloatAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2FloatAVLTreeMap.keys = null;
        object2FloatAVLTreeMap.values = null;
        object2FloatAVLTreeMap.entries = null;
        object2FloatAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            object2FloatAVLTreeMap.tree = entry2.left;
                            object2FloatAVLTreeMap.firstEntry = object2FloatAVLTreeMap.tree;
                            while (object2FloatAVLTreeMap.firstEntry.left != null) {
                                object2FloatAVLTreeMap.firstEntry = object2FloatAVLTreeMap.firstEntry.left;
                            }
                            object2FloatAVLTreeMap.lastEntry = object2FloatAVLTreeMap.tree;
                            while (object2FloatAVLTreeMap.lastEntry.right != null) {
                                object2FloatAVLTreeMap.lastEntry = object2FloatAVLTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Object2FloatAVLTreeMap object2FloatAVLTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2FloatAVLTreeMap;
            if (!bl && !bl2 && object2FloatAVLTreeMap.compare(k, k2) > 0) {
            ...
            this.to = k2;
            this.top = bl2;
            this.defRetValue = object2FloatAVLTreeMap.defRetValue;
        }
    ...
    implements FloatListIterator {
        ...
        private ValueIterator(Object2FloatAVLTreeMap object2FloatAVLTreeMap) {
            this.this$0 = object2FloatAVLTreeMap;
            super(object2FloatAVLTreeMap);
        }
        ...
        ValueIterator(Object2FloatAVLTreeMap object2FloatAVLTreeMap, 1 var2_2) {
            this(object2FloatAVLTreeMap);
        }
    }
    ...
    extends AbstractObject2FloatSortedMap.KeySet {
        ...
        private KeySet(Object2FloatAVLTreeMap object2FloatAVLTreeMap) {
            this.this$0 = object2FloatAVLTreeMap;
            super(object2FloatAVLTreeMap);
        }
        ...
        KeySet(Object2FloatAVLTreeMap object2FloatAVLTreeMap, 1 var2_2) {
            this(object2FloatAVLTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2FloatAVLTreeMap object2FloatAVLTreeMap) {
            this.this$0 = object2FloatAVLTreeMap;
            super(object2FloatAVLTreeMap);
        }

        public KeyIterator(Object2FloatAVLTreeMap object2FloatAVLTreeMap, K k) {
            this.this$0 = object2FloatAVLTreeMap;
            super(object2FloatAVLTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2FloatMap.Entry<K>> {
        ...
        EntryIterator(Object2FloatAVLTreeMap object2FloatAVLTreeMap) {
            this.this$0 = object2FloatAVLTreeMap;
            super(object2FloatAVLTreeMap);
        }

        EntryIterator(Object2FloatAVLTreeMap object2FloatAVLTreeMap, K k) {
            this.this$0 = object2FloatAVLTreeMap;
            super(object2FloatAVLTreeMap, k);
        }
        ...
        public void add(Object object) {
            this.add((Object2FloatMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Object2FloatMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2FloatAVLTreeMap object2FloatAVLTreeMap) {
            this.this$0 = object2FloatAVLTreeMap;
            this.index = 0;
            this.next = object2FloatAVLTreeMap.firstEntry;
        }

        TreeIterator(Object2FloatAVLTreeMap object2FloatAVLTreeMap, K k) {
            this.this$0 = object2FloatAVLTreeMap;
            this.index = 0;
            this.next = object2FloatAVLTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2FloatAVLTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
