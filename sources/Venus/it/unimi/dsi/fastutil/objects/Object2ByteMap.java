...
Map<K, Byte> {
    ...
    default public Byte put(K k, Byte by) {
        return Object2ByteFunction.super.put(k, by);
    }

    @Override
    @Deprecated
    default public Byte get(Object object) {
        return Object2ByteFunction.super.get(object);
    }

    @Override
    @Deprecated
    default public Byte remove(Object object) {
        return Object2ByteFunction.super.remove(object);
    }
    ...
    default public byte computeByteIfAbsentPartial(K k, Object2ByteFunction<? super K> object2ByteFunction) {
        ...
        byte by3 = object2ByteFunction.getByte(k);
        this.put(k, by3);
        return by3;
    }
