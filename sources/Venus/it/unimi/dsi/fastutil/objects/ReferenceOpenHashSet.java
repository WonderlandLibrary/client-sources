...
Hash {
    ...
    public ReferenceOpenHashSet(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public ReferenceOpenHashSet(Collection<? extends K> collection, float f) {
        this(collection.size(), f);
        this.addAll(collection);
    }

    public ReferenceOpenHashSet(Collection<? extends K> collection) {
        this(collection, 0.75f);
    }

    public ReferenceOpenHashSet(ReferenceCollection<? extends K> referenceCollection, float f) {
        this(referenceCollection.size(), f);
        this.addAll(referenceCollection);
    }

    public ReferenceOpenHashSet(ReferenceCollection<? extends K> referenceCollection) {
        this(referenceCollection, 0.75f);
    }

    public ReferenceOpenHashSet(Iterator<? extends K> iterator2, float f) {
        this(16, f);
    ...
    public ReferenceOpenHashSet(Iterator<? extends K> iterator2) {
        this(iterator2, 0.75f);
    }

    public ReferenceOpenHashSet(K[] KArray, int n, int n2, float f) {
        this(n2 < 0 ? 0 : n2, f);
    ...
    public ReferenceOpenHashSet(K[] KArray, int n, int n2) {
        this(KArray, n, n2, 0.75f);
    }

    public ReferenceOpenHashSet(K[] KArray, float f) {
        this(KArray, 0, KArray.length, f);
    }

    public ReferenceOpenHashSet(K[] KArray) {
        this(KArray, 0.75f);
    }
    ...
    public ReferenceOpenHashSet<K> clone() {
        ...
        try {
            referenceOpenHashSet = (ReferenceOpenHashSet)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        referenceOpenHashSet.key = (Object[])this.key.clone();
        referenceOpenHashSet.containsNull = this.containsNull;
    ...
    implements ObjectIterator<K> {
        ...
        final ReferenceOpenHashSet this$0;

        private SetIterator(ReferenceOpenHashSet referenceOpenHashSet) {
            this.this$0 = referenceOpenHashSet;
        ...
        SetIterator(ReferenceOpenHashSet referenceOpenHashSet, 1 var2_2) {
            this(referenceOpenHashSet);
        }
    }
}
