...
Hash {
    ...
    public Reference2IntOpenCustomHashMap(int n, float f, Hash.Strategy<K> strategy) {
    ...
    public Reference2IntOpenCustomHashMap(int n, Hash.Strategy<K> strategy) {
    ...
    public Reference2IntOpenCustomHashMap(Map<? extends K, ? extends Integer> map, float f, Hash.Strategy<K> strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Reference2IntOpenCustomHashMap(Map<? extends K, ? extends Integer> map, Hash.Strategy<K> strategy) {
        this(map, 0.75f, strategy);
    }

    public Reference2IntOpenCustomHashMap(Reference2IntMap<K> reference2IntMap, float f, Hash.Strategy<K> strategy) {
        this(reference2IntMap.size(), f, strategy);
        this.putAll(reference2IntMap);
    }

    public Reference2IntOpenCustomHashMap(Reference2IntMap<K> reference2IntMap, Hash.Strategy<K> strategy) {
        this(reference2IntMap, 0.75f, strategy);
    }

    public Reference2IntOpenCustomHashMap(K[] KArray, int[] nArray, float f, Hash.Strategy<K> strategy) {
    ...
    public Reference2IntOpenCustomHashMap(K[] KArray, int[] nArray, Hash.Strategy<K> strategy) {
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection(this){
                final Reference2IntOpenCustomHashMap this$0;
                {
                    this.this$0 = reference2IntOpenCustomHashMap;
                }
    ...
    public Reference2IntOpenCustomHashMap<K> clone() {
        Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap;
        try {
            reference2IntOpenCustomHashMap = (Reference2IntOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2IntOpenCustomHashMap.keys = null;
        reference2IntOpenCustomHashMap.values = null;
        reference2IntOpenCustomHashMap.entries = null;
        reference2IntOpenCustomHashMap.containsNullKey = this.containsNullKey;
        reference2IntOpenCustomHashMap.key = (Object[])this.key.clone();
        reference2IntOpenCustomHashMap.value = (int[])this.value.clone();
        reference2IntOpenCustomHashMap.strategy = this.strategy;
        return reference2IntOpenCustomHashMap;
    }
    ...
    static int access$300(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap) {
        return reference2IntOpenCustomHashMap.removeNullEntry();
    }

    static int access$400(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap, int n) {
        return reference2IntOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements IntIterator {
        ...
        public ValueIterator(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap) {
            this.this$0 = reference2IntOpenCustomHashMap;
            super(reference2IntOpenCustomHashMap, null);
        }
    ...
    extends AbstractReferenceSet<K> {
        ...
        private KeySet(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap) {
            this.this$0 = reference2IntOpenCustomHashMap;
        }
        ...
        KeySet(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap, 1 var2_2) {
            this(reference2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<K> {
        ...
        public KeyIterator(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap) {
            this.this$0 = reference2IntOpenCustomHashMap;
            super(reference2IntOpenCustomHashMap, null);
        }
    ...
    implements Reference2IntMap.FastEntrySet<K> {
        ...
        private MapEntrySet(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap) {
            this.this$0 = reference2IntOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(k, null)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n) {
                    Reference2IntOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(k2, k)) {
                if (this.this$0.value[n2] == n) {
                    Reference2IntOpenCustomHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap, 1 var2_2) {
            this(reference2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2IntMap.Entry<K>> {
        ...
        private FastEntryIterator(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap) {
            this.this$0 = reference2IntOpenCustomHashMap;
            super(reference2IntOpenCustomHashMap, null);
        ...
        FastEntryIterator(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap, 1 var2_2) {
            this(reference2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2IntMap.Entry<K>> {
        ...
        private EntryIterator(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap) {
            this.this$0 = reference2IntOpenCustomHashMap;
            super(reference2IntOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap, 1 var2_2) {
            this(reference2IntOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap) {
            this.this$0 = reference2IntOpenCustomHashMap;
        ...
        MapIterator(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap, 1 var2_2) {
            this(reference2IntOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<K, Integer> {
        ...
        MapEntry(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap, int n) {
            this.this$0 = reference2IntOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Reference2IntOpenCustomHashMap reference2IntOpenCustomHashMap) {
            this.this$0 = reference2IntOpenCustomHashMap;
        }
