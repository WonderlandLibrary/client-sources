...
public final class Reference2FloatSortedMaps {
    ...
    public static <K> Comparator<? super Map.Entry<K, ?>> entryComparator(Comparator<? super K> comparator) {
        return (arg_0, arg_1) -> Reference2FloatSortedMaps.lambda$entryComparator$0(comparator, arg_0, arg_1);
    }

    public static <K> ObjectBidirectionalIterator<Reference2FloatMap.Entry<K>> fastIterator(Reference2FloatSortedMap<K> reference2FloatSortedMap) {
        ObjectSet objectSet = reference2FloatSortedMap.reference2FloatEntrySet();
        return objectSet instanceof Reference2FloatSortedMap.FastSortedEntrySet ? ((Reference2FloatSortedMap.FastSortedEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }

    public static <K> ObjectBidirectionalIterable<Reference2FloatMap.Entry<K>> fastIterable(Reference2FloatSortedMap<K> reference2FloatSortedMap) {
        ObjectSet objectSet = reference2FloatSortedMap.reference2FloatEntrySet();
        return objectSet instanceof Reference2FloatSortedMap.FastSortedEntrySet ? ((Reference2FloatSortedMap.FastSortedEntrySet)objectSet)::fastIterator : objectSet;
    }
    ...
    public static <K> Reference2FloatSortedMap<K> singleton(K k, Float f) {
        return new Singleton<K>(k, f.floatValue());
    }

    public static <K> Reference2FloatSortedMap<K> singleton(K k, Float f, Comparator<? super K> comparator) {
    ...
    public static <K> Reference2FloatSortedMap<K> synchronize(Reference2FloatSortedMap<K> reference2FloatSortedMap) {
        return new SynchronizedSortedMap<K>(reference2FloatSortedMap);
    }

    public static <K> Reference2FloatSortedMap<K> synchronize(Reference2FloatSortedMap<K> reference2FloatSortedMap, Object object) {
        return new SynchronizedSortedMap<K>(reference2FloatSortedMap, object);
    }

    public static <K> Reference2FloatSortedMap<K> unmodifiable(Reference2FloatSortedMap<K> reference2FloatSortedMap) {
        return new UnmodifiableSortedMap<K>(reference2FloatSortedMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableSortedMap(Reference2FloatSortedMap<K> reference2FloatSortedMap) {
            super(reference2FloatSortedMap);
            this.sortedMap = reference2FloatSortedMap;
        }
    ...
    Serializable {
        ...
        protected SynchronizedSortedMap(Reference2FloatSortedMap<K> reference2FloatSortedMap, Object object) {
            super(reference2FloatSortedMap, object);
            this.sortedMap = reference2FloatSortedMap;
        }

        protected SynchronizedSortedMap(Reference2FloatSortedMap<K> reference2FloatSortedMap) {
            super(reference2FloatSortedMap);
            this.sortedMap = reference2FloatSortedMap;
        }
