...
Hash {
    ...
    public Object2ShortOpenCustomHashMap(Map<? extends K, ? extends Short> map, float f, Hash.Strategy<K> strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Object2ShortOpenCustomHashMap(Map<? extends K, ? extends Short> map, Hash.Strategy<K> strategy) {
        this(map, 0.75f, strategy);
    }

    public Object2ShortOpenCustomHashMap(Object2ShortMap<K> object2ShortMap, float f, Hash.Strategy<K> strategy) {
        this(object2ShortMap.size(), f, strategy);
        this.putAll(object2ShortMap);
    }

    public Object2ShortOpenCustomHashMap(Object2ShortMap<K> object2ShortMap, Hash.Strategy<K> strategy) {
        this(object2ShortMap, 0.75f, strategy);
    }

    public Object2ShortOpenCustomHashMap(K[] KArray, short[] sArray, float f, Hash.Strategy<K> strategy) {
    ...
    public Object2ShortOpenCustomHashMap(K[] KArray, short[] sArray, Hash.Strategy<K> strategy) {
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection(this){
                final Object2ShortOpenCustomHashMap this$0;
                {
                    this.this$0 = object2ShortOpenCustomHashMap;
                }
    ...
    public Object2ShortOpenCustomHashMap<K> clone() {
        Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap;
        try {
            object2ShortOpenCustomHashMap = (Object2ShortOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2ShortOpenCustomHashMap.keys = null;
        object2ShortOpenCustomHashMap.values = null;
        object2ShortOpenCustomHashMap.entries = null;
        object2ShortOpenCustomHashMap.containsNullKey = this.containsNullKey;
        object2ShortOpenCustomHashMap.key = (Object[])this.key.clone();
        object2ShortOpenCustomHashMap.value = (short[])this.value.clone();
        object2ShortOpenCustomHashMap.strategy = this.strategy;
        return object2ShortOpenCustomHashMap;
    }
    ...
    static short access$300(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap) {
        return object2ShortOpenCustomHashMap.removeNullEntry();
    }

    static short access$400(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap, int n) {
        return object2ShortOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ShortIterator {
        ...
        public ValueIterator(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap) {
            this.this$0 = object2ShortOpenCustomHashMap;
            super(object2ShortOpenCustomHashMap, null);
        }
    ...
    extends AbstractObjectSet<K> {
        ...
        private KeySet(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap) {
            this.this$0 = object2ShortOpenCustomHashMap;
        }
        ...
        KeySet(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap, 1 var2_2) {
            this(object2ShortOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<K> {
        ...
        public KeyIterator(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap) {
            this.this$0 = object2ShortOpenCustomHashMap;
            super(object2ShortOpenCustomHashMap, null);
        }
    ...
    implements Object2ShortMap.FastEntrySet<K> {
        ...
        private MapEntrySet(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap) {
            this.this$0 = object2ShortOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(k, null)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == s) {
                    Object2ShortOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(k2, k)) {
                if (this.this$0.value[n] == s) {
                    Object2ShortOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap, 1 var2_2) {
            this(object2ShortOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Object2ShortMap.Entry<K>> {
        ...
        private FastEntryIterator(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap) {
            this.this$0 = object2ShortOpenCustomHashMap;
            super(object2ShortOpenCustomHashMap, null);
        ...
        FastEntryIterator(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap, 1 var2_2) {
            this(object2ShortOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Object2ShortMap.Entry<K>> {
        ...
        private EntryIterator(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap) {
            this.this$0 = object2ShortOpenCustomHashMap;
            super(object2ShortOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap, 1 var2_2) {
            this(object2ShortOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap) {
            this.this$0 = object2ShortOpenCustomHashMap;
        ...
        MapIterator(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap, 1 var2_2) {
            this(object2ShortOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<K, Short> {
        ...
        MapEntry(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap, int n) {
            this.this$0 = object2ShortOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Object2ShortOpenCustomHashMap object2ShortOpenCustomHashMap) {
            this.this$0 = object2ShortOpenCustomHashMap;
        }
