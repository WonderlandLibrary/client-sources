...
Hash {
    ...
    public Reference2ShortLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Reference2ShortLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Reference2ShortLinkedOpenHashMap(Map<? extends K, ? extends Short> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Reference2ShortLinkedOpenHashMap(Map<? extends K, ? extends Short> map) {
        this(map, 0.75f);
    }

    public Reference2ShortLinkedOpenHashMap(Reference2ShortMap<K> reference2ShortMap, float f) {
        this(reference2ShortMap.size(), f);
        this.putAll(reference2ShortMap);
    }

    public Reference2ShortLinkedOpenHashMap(Reference2ShortMap<K> reference2ShortMap) {
        this(reference2ShortMap, 0.75f);
    }

    public Reference2ShortLinkedOpenHashMap(K[] KArray, short[] sArray, float f) {
    ...
    public Reference2ShortLinkedOpenHashMap(K[] KArray, short[] sArray) {
    ...
    public short putAndMoveToFirst(K k, short s) {
        int n;
        if (k == null) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public short putAndMoveToLast(K k, short s) {
        int n;
        if (k == null) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection(this){
                final Reference2ShortLinkedOpenHashMap this$0;
                {
                    this.this$0 = reference2ShortLinkedOpenHashMap;
                }
    ...
    public Reference2ShortLinkedOpenHashMap<K> clone() {
        Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap;
        try {
            reference2ShortLinkedOpenHashMap = (Reference2ShortLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2ShortLinkedOpenHashMap.keys = null;
        reference2ShortLinkedOpenHashMap.values = null;
        reference2ShortLinkedOpenHashMap.entries = null;
        reference2ShortLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        reference2ShortLinkedOpenHashMap.key = (Object[])this.key.clone();
        reference2ShortLinkedOpenHashMap.value = (short[])this.value.clone();
        reference2ShortLinkedOpenHashMap.link = (long[])this.link.clone();
        return reference2ShortLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet reference2ShortEntrySet() {
    ...
    static short access$100(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap) {
        return reference2ShortLinkedOpenHashMap.removeNullEntry();
    }

    static short access$200(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap, int n) {
        return reference2ShortLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ShortListIterator {
        ...
        public ValueIterator(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap) {
            this.this$0 = reference2ShortLinkedOpenHashMap;
            super(reference2ShortLinkedOpenHashMap);
        }
    ...
    extends AbstractReferenceSortedSet<K> {
        ...
        private KeySet(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap) {
            this.this$0 = reference2ShortLinkedOpenHashMap;
        }
        ...
        KeySet(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap, 1 var2_2) {
            this(reference2ShortLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap, K k) {
            this.this$0 = reference2ShortLinkedOpenHashMap;
            super(reference2ShortLinkedOpenHashMap, k, null);
        }
        ...
        public KeyIterator(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap) {
            this.this$0 = reference2ShortLinkedOpenHashMap;
            super(reference2ShortLinkedOpenHashMap);
        }
    ...
    implements Reference2ShortSortedMap.FastSortedEntrySet<K> {
        ...
        private MapEntrySet(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap) {
            this.this$0 = reference2ShortLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Reference2ShortMap.Entry<K>> subSet(Reference2ShortMap.Entry<K> entry, Reference2ShortMap.Entry<K> entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Reference2ShortMap.Entry<K>> headSet(Reference2ShortMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Reference2ShortMap.Entry<K>> tailSet(Reference2ShortMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == s) {
                    Reference2ShortLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2 == k) {
                if (this.this$0.value[n] == s) {
                    Reference2ShortLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((k2 = KArray[n = n + 1 & this.this$0.mask]) != null) continue;
                return true;
            } while (k2 != k || this.this$0.value[n] != s);
            Reference2ShortLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Reference2ShortMap.Entry<K>> iterator(Reference2ShortMap.Entry<K> entry) {
        ...
        @Override
        public ObjectListIterator<Reference2ShortMap.Entry<K>> fastIterator(Reference2ShortMap.Entry<K> entry) {
        ...
        public void forEach(Consumer<? super Reference2ShortMap.Entry<K>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractReference2ShortMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Reference2ShortMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Reference2ShortMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Reference2ShortMap.Entry)object, (Reference2ShortMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Reference2ShortMap.Entry)object);
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Reference2ShortMap.Entry entry) {
        ...
        MapEntrySet(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap, 1 var2_2) {
            this(reference2ShortLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Reference2ShortMap.Entry<K>> {
        ...
        public FastEntryIterator(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap) {
            this.this$0 = reference2ShortLinkedOpenHashMap;
            super(reference2ShortLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap, K k) {
            this.this$0 = reference2ShortLinkedOpenHashMap;
            super(reference2ShortLinkedOpenHashMap, k, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Reference2ShortMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Reference2ShortMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Reference2ShortMap.Entry<K>> {
        ...
        public EntryIterator(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap) {
            this.this$0 = reference2ShortLinkedOpenHashMap;
            super(reference2ShortLinkedOpenHashMap);
        }

        public EntryIterator(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap, K k) {
            this.this$0 = reference2ShortLinkedOpenHashMap;
            super(reference2ShortLinkedOpenHashMap, k, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap) {
            this.this$0 = reference2ShortLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = reference2ShortLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap, K k) {
            this.this$0 = reference2ShortLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (k == null) {
                if (reference2ShortLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)reference2ShortLinkedOpenHashMap.link[reference2ShortLinkedOpenHashMap.n];
                    this.prev = reference2ShortLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + k + " does not belong to this map.");
            }
            if (reference2ShortLinkedOpenHashMap.key[reference2ShortLinkedOpenHashMap.last] == k) {
                this.prev = reference2ShortLinkedOpenHashMap.last;
                this.index = reference2ShortLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(System.identityHashCode(k)) & reference2ShortLinkedOpenHashMap.mask;
            while (reference2ShortLinkedOpenHashMap.key[n] != null) {
                if (reference2ShortLinkedOpenHashMap.key[n] == k) {
                    this.next = (int)reference2ShortLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & reference2ShortLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this map.");
        }
        ...
        public void set(Reference2ShortMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Reference2ShortMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap, Object object, 1 var3_3) {
            this(reference2ShortLinkedOpenHashMap, object);
        }
    }
    ...
    Map.Entry<K, Short> {
        ...
        MapEntry(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap, int n) {
            this.this$0 = reference2ShortLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Reference2ShortLinkedOpenHashMap reference2ShortLinkedOpenHashMap) {
            this.this$0 = reference2ShortLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.key[this.index] == entry.getKey() && this.this$0.value[this.index] == (Short)entry.getValue();
        }
