...
Hash {
    ...
    public Reference2CharOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Reference2CharOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Reference2CharOpenHashMap(Map<? extends K, ? extends Character> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Reference2CharOpenHashMap(Map<? extends K, ? extends Character> map) {
        this(map, 0.75f);
    }

    public Reference2CharOpenHashMap(Reference2CharMap<K> reference2CharMap, float f) {
        this(reference2CharMap.size(), f);
        this.putAll(reference2CharMap);
    }

    public Reference2CharOpenHashMap(Reference2CharMap<K> reference2CharMap) {
        this(reference2CharMap, 0.75f);
    }

    public Reference2CharOpenHashMap(K[] KArray, char[] cArray, float f) {
    ...
    public Reference2CharOpenHashMap(K[] KArray, char[] cArray) {
    ...
    public CharCollection values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection(this){
                final Reference2CharOpenHashMap this$0;
                {
                    this.this$0 = reference2CharOpenHashMap;
                }
    ...
    public Reference2CharOpenHashMap<K> clone() {
        Reference2CharOpenHashMap reference2CharOpenHashMap;
        try {
            reference2CharOpenHashMap = (Reference2CharOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2CharOpenHashMap.keys = null;
        reference2CharOpenHashMap.values = null;
        reference2CharOpenHashMap.entries = null;
        reference2CharOpenHashMap.containsNullKey = this.containsNullKey;
        reference2CharOpenHashMap.key = (Object[])this.key.clone();
        reference2CharOpenHashMap.value = (char[])this.value.clone();
        return reference2CharOpenHashMap;
    }
    ...
    static char access$300(Reference2CharOpenHashMap reference2CharOpenHashMap) {
        return reference2CharOpenHashMap.removeNullEntry();
    }

    static char access$400(Reference2CharOpenHashMap reference2CharOpenHashMap, int n) {
        return reference2CharOpenHashMap.removeEntry(n);
    }
    ...
    implements CharIterator {
        ...
        public ValueIterator(Reference2CharOpenHashMap reference2CharOpenHashMap) {
            this.this$0 = reference2CharOpenHashMap;
            super(reference2CharOpenHashMap, null);
        }
    ...
    extends AbstractReferenceSet<K> {
        ...
        private KeySet(Reference2CharOpenHashMap reference2CharOpenHashMap) {
            this.this$0 = reference2CharOpenHashMap;
        }
        ...
        KeySet(Reference2CharOpenHashMap reference2CharOpenHashMap, 1 var2_2) {
            this(reference2CharOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<K> {
        ...
        public KeyIterator(Reference2CharOpenHashMap reference2CharOpenHashMap) {
            this.this$0 = reference2CharOpenHashMap;
            super(reference2CharOpenHashMap, null);
        }
    ...
    implements Reference2CharMap.FastEntrySet<K> {
        ...
        private MapEntrySet(Reference2CharOpenHashMap reference2CharOpenHashMap) {
            this.this$0 = reference2CharOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == c) {
                    Reference2CharOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2 == k) {
                if (this.this$0.value[n] == c) {
                    Reference2CharOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Reference2CharOpenHashMap reference2CharOpenHashMap, 1 var2_2) {
            this(reference2CharOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2CharMap.Entry<K>> {
        ...
        private FastEntryIterator(Reference2CharOpenHashMap reference2CharOpenHashMap) {
            this.this$0 = reference2CharOpenHashMap;
            super(reference2CharOpenHashMap, null);
        ...
        FastEntryIterator(Reference2CharOpenHashMap reference2CharOpenHashMap, 1 var2_2) {
            this(reference2CharOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2CharMap.Entry<K>> {
        ...
        private EntryIterator(Reference2CharOpenHashMap reference2CharOpenHashMap) {
            this.this$0 = reference2CharOpenHashMap;
            super(reference2CharOpenHashMap, null);
        }
        ...
        EntryIterator(Reference2CharOpenHashMap reference2CharOpenHashMap, 1 var2_2) {
            this(reference2CharOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Reference2CharOpenHashMap reference2CharOpenHashMap) {
            this.this$0 = reference2CharOpenHashMap;
        ...
        MapIterator(Reference2CharOpenHashMap reference2CharOpenHashMap, 1 var2_2) {
            this(reference2CharOpenHashMap);
        }
    }
    ...
    Map.Entry<K, Character> {
        ...
        MapEntry(Reference2CharOpenHashMap reference2CharOpenHashMap, int n) {
            this.this$0 = reference2CharOpenHashMap;
            this.index = n;
        }

        MapEntry(Reference2CharOpenHashMap reference2CharOpenHashMap) {
            this.this$0 = reference2CharOpenHashMap;
        }
