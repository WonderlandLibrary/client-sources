...
Hash {
    ...
    public Object2DoubleOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Object2DoubleOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Object2DoubleOpenHashMap(Map<? extends K, ? extends Double> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Object2DoubleOpenHashMap(Map<? extends K, ? extends Double> map) {
        this(map, 0.75f);
    }

    public Object2DoubleOpenHashMap(Object2DoubleMap<K> object2DoubleMap, float f) {
        this(object2DoubleMap.size(), f);
        this.putAll(object2DoubleMap);
    }

    public Object2DoubleOpenHashMap(Object2DoubleMap<K> object2DoubleMap) {
        this(object2DoubleMap, 0.75f);
    }

    public Object2DoubleOpenHashMap(K[] KArray, double[] dArray, float f) {
    ...
    public Object2DoubleOpenHashMap(K[] KArray, double[] dArray) {
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(this){
                final Object2DoubleOpenHashMap this$0;
                {
                    this.this$0 = object2DoubleOpenHashMap;
                }
    ...
    public Object2DoubleOpenHashMap<K> clone() {
        Object2DoubleOpenHashMap object2DoubleOpenHashMap;
        try {
            object2DoubleOpenHashMap = (Object2DoubleOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2DoubleOpenHashMap.keys = null;
        object2DoubleOpenHashMap.values = null;
        object2DoubleOpenHashMap.entries = null;
        object2DoubleOpenHashMap.containsNullKey = this.containsNullKey;
        object2DoubleOpenHashMap.key = (Object[])this.key.clone();
        object2DoubleOpenHashMap.value = (double[])this.value.clone();
    ...
    static double access$300(Object2DoubleOpenHashMap object2DoubleOpenHashMap) {
        return object2DoubleOpenHashMap.removeNullEntry();
    }

    static double access$400(Object2DoubleOpenHashMap object2DoubleOpenHashMap, int n) {
        return object2DoubleOpenHashMap.removeEntry(n);
    }
    ...
    implements DoubleIterator {
        ...
        public ValueIterator(Object2DoubleOpenHashMap object2DoubleOpenHashMap) {
            this.this$0 = object2DoubleOpenHashMap;
            super(object2DoubleOpenHashMap, null);
        }
    ...
    extends AbstractObjectSet<K> {
        ...
        private KeySet(Object2DoubleOpenHashMap object2DoubleOpenHashMap) {
            this.this$0 = object2DoubleOpenHashMap;
        }
        ...
        KeySet(Object2DoubleOpenHashMap object2DoubleOpenHashMap, 1 var2_2) {
            this(object2DoubleOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<K> {
        ...
        public KeyIterator(Object2DoubleOpenHashMap object2DoubleOpenHashMap) {
            this.this$0 = object2DoubleOpenHashMap;
            super(object2DoubleOpenHashMap, null);
        }
    ...
    implements Object2DoubleMap.FastEntrySet<K> {
        ...
        private MapEntrySet(Object2DoubleOpenHashMap object2DoubleOpenHashMap) {
            this.this$0 = object2DoubleOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && Double.doubleToLongBits(this.this$0.value[this.this$0.n]) == Double.doubleToLongBits(d)) {
                    Object2DoubleOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2.equals(k)) {
                if (Double.doubleToLongBits(this.this$0.value[n]) == Double.doubleToLongBits(d)) {
                    Object2DoubleOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        public void forEach(Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
            if (this.this$0.containsNullKey) {
                consumer.accept(new AbstractObject2DoubleMap.BasicEntry(this.this$0.key[this.this$0.n], this.this$0.value[this.this$0.n]));
            }
            int n = this.this$0.n;
            while (n-- != 0) {
                if (this.this$0.key[n] == null) continue;
                consumer.accept(new AbstractObject2DoubleMap.BasicEntry(this.this$0.key[n], this.this$0.value[n]));
            }
        }
        ...
        MapEntrySet(Object2DoubleOpenHashMap object2DoubleOpenHashMap, 1 var2_2) {
            this(object2DoubleOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Object2DoubleMap.Entry<K>> {
        ...
        private FastEntryIterator(Object2DoubleOpenHashMap object2DoubleOpenHashMap) {
            this.this$0 = object2DoubleOpenHashMap;
            super(object2DoubleOpenHashMap, null);
        ...
        FastEntryIterator(Object2DoubleOpenHashMap object2DoubleOpenHashMap, 1 var2_2) {
            this(object2DoubleOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Object2DoubleMap.Entry<K>> {
        ...
        private EntryIterator(Object2DoubleOpenHashMap object2DoubleOpenHashMap) {
            this.this$0 = object2DoubleOpenHashMap;
            super(object2DoubleOpenHashMap, null);
        }
        ...
        EntryIterator(Object2DoubleOpenHashMap object2DoubleOpenHashMap, 1 var2_2) {
            this(object2DoubleOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Object2DoubleOpenHashMap object2DoubleOpenHashMap) {
            this.this$0 = object2DoubleOpenHashMap;
        ...
        MapIterator(Object2DoubleOpenHashMap object2DoubleOpenHashMap, 1 var2_2) {
            this(object2DoubleOpenHashMap);
        }
    }
    ...
    Map.Entry<K, Double> {
        ...
        MapEntry(Object2DoubleOpenHashMap object2DoubleOpenHashMap, int n) {
            this.this$0 = object2DoubleOpenHashMap;
            this.index = n;
        }

        MapEntry(Object2DoubleOpenHashMap object2DoubleOpenHashMap) {
            this.this$0 = object2DoubleOpenHashMap;
        }
