...
Hash {
    ...
    public Object2IntLinkedOpenCustomHashMap(int n, float f, Hash.Strategy<K> strategy) {
    ...
    public Object2IntLinkedOpenCustomHashMap(int n, Hash.Strategy<K> strategy) {
    ...
    public Object2IntLinkedOpenCustomHashMap(Map<? extends K, ? extends Integer> map, float f, Hash.Strategy<K> strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Object2IntLinkedOpenCustomHashMap(Map<? extends K, ? extends Integer> map, Hash.Strategy<K> strategy) {
        this(map, 0.75f, strategy);
    }

    public Object2IntLinkedOpenCustomHashMap(Object2IntMap<K> object2IntMap, float f, Hash.Strategy<K> strategy) {
        this(object2IntMap.size(), f, strategy);
        this.putAll(object2IntMap);
    }

    public Object2IntLinkedOpenCustomHashMap(Object2IntMap<K> object2IntMap, Hash.Strategy<K> strategy) {
        this(object2IntMap, 0.75f, strategy);
    }

    public Object2IntLinkedOpenCustomHashMap(K[] KArray, int[] nArray, float f, Hash.Strategy<K> strategy) {
    ...
    public Object2IntLinkedOpenCustomHashMap(K[] KArray, int[] nArray, Hash.Strategy<K> strategy) {
        this(KArray, nArray, 0.75f, strategy);
    }
    ...
    public int addTo(K k, int n) {
        ...
        if (this.strategy.equals(k, null)) {
            ...
            K[] KArray = this.key;
            n2 = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
            K k2 = KArray[n2];
            if (k2 != null) {
    ...
    public int getOrDefault(Object object, int n) {
        ...
        K[] KArray = this.key;
        int n2 = HashCommon.mix(this.strategy.hashCode(object)) & this.mask;
        K k = KArray[n2];
        if (k == null) {
            return n;
        }
    ...
    public boolean remove(Object object, int n) {
        ...
        if (this.strategy.equals(object, k) && n == this.value[n2]) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if ((k = KArray[n2 = n2 + 1 & this.mask]) != null) continue;
            return true;
        } while (!this.strategy.equals(object, k) || n != this.value[n2]);
        this.removeEntry(n2);
        return false;
    }
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection(this){
                final Object2IntLinkedOpenCustomHashMap this$0;
                {
                    this.this$0 = object2IntLinkedOpenCustomHashMap;
                }
    ...
    public Object2IntLinkedOpenCustomHashMap<K> clone() {
        ...
        try {
            object2IntLinkedOpenCustomHashMap = (Object2IntLinkedOpenCustomHashMap)super.clone();
        ...
        object2IntLinkedOpenCustomHashMap.key = (Object[])this.key.clone();
    ...
    static int access$100(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap) {
        return object2IntLinkedOpenCustomHashMap.removeNullEntry();
    }

    static int access$200(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap, int n) {
        return object2IntLinkedOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements IntListIterator {
        ...
        public ValueIterator(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap) {
            this.this$0 = object2IntLinkedOpenCustomHashMap;
            super(object2IntLinkedOpenCustomHashMap);
        }
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        private KeySet(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap) {
            this.this$0 = object2IntLinkedOpenCustomHashMap;
        }
        ...
        KeySet(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap, 1 var2_2) {
            this(object2IntLinkedOpenCustomHashMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap, K k) {
            this.this$0 = object2IntLinkedOpenCustomHashMap;
            super(object2IntLinkedOpenCustomHashMap, k, null);
        }
        ...
        public KeyIterator(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap) {
            this.this$0 = object2IntLinkedOpenCustomHashMap;
            super(object2IntLinkedOpenCustomHashMap);
        }
    ...
    implements Object2IntSortedMap.FastSortedEntrySet<K> {
        ...
        private MapEntrySet(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap) {
            this.this$0 = object2IntLinkedOpenCustomHashMap;
        }
        ...
        public boolean contains(Object object) {
            ...
            int n2 = HashCommon.mix(this.this$0.strategy.hashCode(k)) & this.this$0.mask;
            Object k2 = KArray[n2];
            if (k2 == null) {
                return true;
            }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(k, null)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n) {
                    Object2IntLinkedOpenCustomHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(k2, k)) {
                if (this.this$0.value[n2] == n) {
                    Object2IntLinkedOpenCustomHashMap.access$200(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((k2 = KArray[n2 = n2 + 1 & this.this$0.mask]) != null) continue;
                return true;
            } while (!this.this$0.strategy.equals(k2, k) || this.this$0.value[n2] != n);
            Object2IntLinkedOpenCustomHashMap.access$200(this.this$0, n2);
            return false;
        }
        ...
        MapEntrySet(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap, 1 var2_2) {
            this(object2IntLinkedOpenCustomHashMap);
        }
    }
    ...
    implements ObjectListIterator<Object2IntMap.Entry<K>> {
        ...
        public FastEntryIterator(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap) {
            this.this$0 = object2IntLinkedOpenCustomHashMap;
            super(object2IntLinkedOpenCustomHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap, K k) {
            this.this$0 = object2IntLinkedOpenCustomHashMap;
            super(object2IntLinkedOpenCustomHashMap, k, null);
            this.entry = new MapEntry(this.this$0);
        }
    ...
    implements ObjectListIterator<Object2IntMap.Entry<K>> {
        ...
        public EntryIterator(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap) {
            this.this$0 = object2IntLinkedOpenCustomHashMap;
            super(object2IntLinkedOpenCustomHashMap);
        }

        public EntryIterator(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap, K k) {
            this.this$0 = object2IntLinkedOpenCustomHashMap;
            super(object2IntLinkedOpenCustomHashMap, k, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap) {
            this.this$0 = object2IntLinkedOpenCustomHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = object2IntLinkedOpenCustomHashMap.first;
            this.index = 0;
        }

        private MapIterator(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap, K k) {
            this.this$0 = object2IntLinkedOpenCustomHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (object2IntLinkedOpenCustomHashMap.strategy.equals(k, null)) {
                if (object2IntLinkedOpenCustomHashMap.containsNullKey) {
                    this.next = (int)object2IntLinkedOpenCustomHashMap.link[object2IntLinkedOpenCustomHashMap.n];
                    this.prev = object2IntLinkedOpenCustomHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + k + " does not belong to this map.");
            }
            if (object2IntLinkedOpenCustomHashMap.strategy.equals(object2IntLinkedOpenCustomHashMap.key[object2IntLinkedOpenCustomHashMap.last], k)) {
                this.prev = object2IntLinkedOpenCustomHashMap.last;
                this.index = object2IntLinkedOpenCustomHashMap.size;
                return;
            }
            int n = HashCommon.mix(object2IntLinkedOpenCustomHashMap.strategy.hashCode(k)) & object2IntLinkedOpenCustomHashMap.mask;
            while (object2IntLinkedOpenCustomHashMap.key[n] != null) {
                if (object2IntLinkedOpenCustomHashMap.strategy.equals(object2IntLinkedOpenCustomHashMap.key[n], k)) {
                    this.next = (int)object2IntLinkedOpenCustomHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & object2IntLinkedOpenCustomHashMap.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this map.");
        }
        ...
        MapIterator(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap, Object object, 1 var3_3) {
            this(object2IntLinkedOpenCustomHashMap, object);
        }
    }
    ...
    Map.Entry<K, Integer> {
        ...
        MapEntry(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap, int n) {
            this.this$0 = object2IntLinkedOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Object2IntLinkedOpenCustomHashMap object2IntLinkedOpenCustomHashMap) {
            this.this$0 = object2IntLinkedOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], entry.getKey()) && this.this$0.value[this.index] == (Integer)entry.getValue();
        }
