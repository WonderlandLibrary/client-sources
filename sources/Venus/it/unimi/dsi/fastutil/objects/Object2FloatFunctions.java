...
public final class Object2FloatFunctions {
    ...
    public static <K> Object2FloatFunction<K> singleton(K k, float f) {
    ...
    public static <K> Object2FloatFunction<K> synchronize(Object2FloatFunction<K> object2FloatFunction) {
        return new SynchronizedFunction<K>(object2FloatFunction);
    }

    public static <K> Object2FloatFunction<K> synchronize(Object2FloatFunction<K> object2FloatFunction, Object object) {
        return new SynchronizedFunction<K>(object2FloatFunction, object);
    }

    public static <K> Object2FloatFunction<K> unmodifiable(Object2FloatFunction<K> object2FloatFunction) {
        return new UnmodifiableFunction<K>(object2FloatFunction);
    }

    public static <K> Object2FloatFunction<K> primitive(java.util.function.Function<? super K, ? extends Float> function) {
        Objects.requireNonNull(function);
        if (function instanceof Object2FloatFunction) {
            return (Object2FloatFunction)function;
        }
        if (function instanceof ToDoubleFunction) {
            return arg_0 -> Object2FloatFunctions.lambda$primitive$0(function, arg_0);
        }
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Object2FloatFunction<K> object2FloatFunction) {
            if (object2FloatFunction == null) {
                throw new NullPointerException();
            }
            this.function = object2FloatFunction;
        }
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Object2FloatFunction<K> object2FloatFunction, Object object) {
            if (object2FloatFunction == null) {
                throw new NullPointerException();
            }
            this.function = object2FloatFunction;
        ...
        protected SynchronizedFunction(Object2FloatFunction<K> object2FloatFunction) {
            if (object2FloatFunction == null) {
                throw new NullPointerException();
            }
            this.function = object2FloatFunction;
