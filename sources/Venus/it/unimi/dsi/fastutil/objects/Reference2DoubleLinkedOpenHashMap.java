...
Hash {
    ...
    public Reference2DoubleLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Reference2DoubleLinkedOpenHashMap(Map<? extends K, ? extends Double> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Reference2DoubleLinkedOpenHashMap(Map<? extends K, ? extends Double> map) {
        this(map, 0.75f);
    }

    public Reference2DoubleLinkedOpenHashMap(Reference2DoubleMap<K> reference2DoubleMap, float f) {
        this(reference2DoubleMap.size(), f);
        this.putAll(reference2DoubleMap);
    }

    public Reference2DoubleLinkedOpenHashMap(Reference2DoubleMap<K> reference2DoubleMap) {
        this(reference2DoubleMap, 0.75f);
    }

    public Reference2DoubleLinkedOpenHashMap(K[] KArray, double[] dArray, float f) {
    ...
    public Reference2DoubleLinkedOpenHashMap(K[] KArray, double[] dArray) {
    ...
    @Override
    public Reference2DoubleSortedMap<K> tailMap(K k) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Reference2DoubleSortedMap<K> headMap(K k) {
        throw new UnsupportedOperationException();
    }

    @Override
    public Reference2DoubleSortedMap<K> subMap(K k, K k2) {
        throw new UnsupportedOperationException();
    }
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(this){
                final Reference2DoubleLinkedOpenHashMap this$0;
                {
                    this.this$0 = reference2DoubleLinkedOpenHashMap;
                }
    ...
    public Reference2DoubleLinkedOpenHashMap<K> clone() {
        Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap;
        try {
            reference2DoubleLinkedOpenHashMap = (Reference2DoubleLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2DoubleLinkedOpenHashMap.keys = null;
        reference2DoubleLinkedOpenHashMap.values = null;
        reference2DoubleLinkedOpenHashMap.entries = null;
        reference2DoubleLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        reference2DoubleLinkedOpenHashMap.key = (Object[])this.key.clone();
        reference2DoubleLinkedOpenHashMap.value = (double[])this.value.clone();
        reference2DoubleLinkedOpenHashMap.link = (long[])this.link.clone();
        return reference2DoubleLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet reference2DoubleEntrySet() {
    ...
    static double access$100(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap) {
        return reference2DoubleLinkedOpenHashMap.removeNullEntry();
    }

    static double access$200(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap, int n) {
        return reference2DoubleLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements DoubleListIterator {
        ...
        public ValueIterator(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap) {
            this.this$0 = reference2DoubleLinkedOpenHashMap;
            super(reference2DoubleLinkedOpenHashMap);
        }
    ...
    extends AbstractReferenceSortedSet<K> {
        ...
        private KeySet(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap) {
            this.this$0 = reference2DoubleLinkedOpenHashMap;
        }
        ...
        KeySet(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap, 1 var2_2) {
            this(reference2DoubleLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap, K k) {
            this.this$0 = reference2DoubleLinkedOpenHashMap;
            super(reference2DoubleLinkedOpenHashMap, k, null);
        }
        ...
        public KeyIterator(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap) {
            this.this$0 = reference2DoubleLinkedOpenHashMap;
            super(reference2DoubleLinkedOpenHashMap);
        }
    ...
    implements Reference2DoubleSortedMap.FastSortedEntrySet<K> {
        ...
        private MapEntrySet(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap) {
            this.this$0 = reference2DoubleLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Reference2DoubleMap.Entry<K>> subSet(Reference2DoubleMap.Entry<K> entry, Reference2DoubleMap.Entry<K> entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Reference2DoubleMap.Entry<K>> headSet(Reference2DoubleMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Reference2DoubleMap.Entry<K>> tailSet(Reference2DoubleMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && Double.doubleToLongBits(this.this$0.value[this.this$0.n]) == Double.doubleToLongBits(d)) {
                    Reference2DoubleLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2 == k) {
                if (Double.doubleToLongBits(this.this$0.value[n]) == Double.doubleToLongBits(d)) {
                    Reference2DoubleLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Reference2DoubleMap.Entry<K>> iterator(Reference2DoubleMap.Entry<K> entry) {
        ...
        @Override
        public ObjectListIterator<Reference2DoubleMap.Entry<K>> fastIterator(Reference2DoubleMap.Entry<K> entry) {
        ...
        public void forEach(Consumer<? super Reference2DoubleMap.Entry<K>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractReference2DoubleMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Reference2DoubleMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Reference2DoubleMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Reference2DoubleMap.Entry)object, (Reference2DoubleMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Reference2DoubleMap.Entry)object);
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Reference2DoubleMap.Entry entry) {
        ...
        MapEntrySet(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap, 1 var2_2) {
            this(reference2DoubleLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Reference2DoubleMap.Entry<K>> {
        ...
        public FastEntryIterator(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap) {
            this.this$0 = reference2DoubleLinkedOpenHashMap;
            super(reference2DoubleLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap, K k) {
            this.this$0 = reference2DoubleLinkedOpenHashMap;
            super(reference2DoubleLinkedOpenHashMap, k, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Reference2DoubleMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Reference2DoubleMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Reference2DoubleMap.Entry<K>> {
        ...
        public EntryIterator(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap) {
            this.this$0 = reference2DoubleLinkedOpenHashMap;
            super(reference2DoubleLinkedOpenHashMap);
        }

        public EntryIterator(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap, K k) {
            this.this$0 = reference2DoubleLinkedOpenHashMap;
            super(reference2DoubleLinkedOpenHashMap, k, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap) {
            this.this$0 = reference2DoubleLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = reference2DoubleLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap, K k) {
            this.this$0 = reference2DoubleLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (k == null) {
                if (reference2DoubleLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)reference2DoubleLinkedOpenHashMap.link[reference2DoubleLinkedOpenHashMap.n];
                    this.prev = reference2DoubleLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + k + " does not belong to this map.");
            }
            if (reference2DoubleLinkedOpenHashMap.key[reference2DoubleLinkedOpenHashMap.last] == k) {
                this.prev = reference2DoubleLinkedOpenHashMap.last;
                this.index = reference2DoubleLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(System.identityHashCode(k)) & reference2DoubleLinkedOpenHashMap.mask;
            while (reference2DoubleLinkedOpenHashMap.key[n] != null) {
                if (reference2DoubleLinkedOpenHashMap.key[n] == k) {
                    this.next = (int)reference2DoubleLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & reference2DoubleLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this map.");
        }
        ...
        public void set(Reference2DoubleMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Reference2DoubleMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap, Object object, 1 var3_3) {
            this(reference2DoubleLinkedOpenHashMap, object);
        }
    }
    ...
    Map.Entry<K, Double> {
        ...
        MapEntry(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap, int n) {
            this.this$0 = reference2DoubleLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Reference2DoubleLinkedOpenHashMap reference2DoubleLinkedOpenHashMap) {
            this.this$0 = reference2DoubleLinkedOpenHashMap;
        }
