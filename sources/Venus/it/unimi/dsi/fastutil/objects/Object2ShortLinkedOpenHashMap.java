...
Hash {
    ...
    public Object2ShortLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Object2ShortLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Object2ShortLinkedOpenHashMap(Map<? extends K, ? extends Short> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Object2ShortLinkedOpenHashMap(Map<? extends K, ? extends Short> map) {
        this(map, 0.75f);
    }

    public Object2ShortLinkedOpenHashMap(Object2ShortMap<K> object2ShortMap, float f) {
        this(object2ShortMap.size(), f);
        this.putAll(object2ShortMap);
    }

    public Object2ShortLinkedOpenHashMap(Object2ShortMap<K> object2ShortMap) {
        this(object2ShortMap, 0.75f);
    }

    public Object2ShortLinkedOpenHashMap(K[] KArray, short[] sArray, float f) {
    ...
    public Object2ShortLinkedOpenHashMap(K[] KArray, short[] sArray) {
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection(this){
                final Object2ShortLinkedOpenHashMap this$0;
                {
                    this.this$0 = object2ShortLinkedOpenHashMap;
                }
    ...
    public Object2ShortLinkedOpenHashMap<K> clone() {
        Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap;
        try {
            object2ShortLinkedOpenHashMap = (Object2ShortLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2ShortLinkedOpenHashMap.keys = null;
        object2ShortLinkedOpenHashMap.values = null;
        object2ShortLinkedOpenHashMap.entries = null;
        object2ShortLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        object2ShortLinkedOpenHashMap.key = (Object[])this.key.clone();
        object2ShortLinkedOpenHashMap.value = (short[])this.value.clone();
        object2ShortLinkedOpenHashMap.link = (long[])this.link.clone();
        return object2ShortLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet object2ShortEntrySet() {
    ...
    static short access$100(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap) {
        return object2ShortLinkedOpenHashMap.removeNullEntry();
    }

    static short access$200(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap, int n) {
        return object2ShortLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ShortListIterator {
        ...
        public ValueIterator(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap) {
            this.this$0 = object2ShortLinkedOpenHashMap;
            super(object2ShortLinkedOpenHashMap);
        }
    ...
    extends AbstractObjectSortedSet<K> {
        ...
        private KeySet(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap) {
            this.this$0 = object2ShortLinkedOpenHashMap;
        }
        ...
        KeySet(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap, 1 var2_2) {
            this(object2ShortLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap, K k) {
            this.this$0 = object2ShortLinkedOpenHashMap;
            super(object2ShortLinkedOpenHashMap, k, null);
        }
        ...
        public KeyIterator(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap) {
            this.this$0 = object2ShortLinkedOpenHashMap;
            super(object2ShortLinkedOpenHashMap);
        }
    ...
    implements Object2ShortSortedMap.FastSortedEntrySet<K> {
        ...
        private MapEntrySet(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap) {
            this.this$0 = object2ShortLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == s) {
                    Object2ShortLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2.equals(k)) {
                if (this.this$0.value[n] == s) {
                    Object2ShortLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Object2ShortMap.Entry<K>> iterator(Object2ShortMap.Entry<K> entry) {
        ...
        @Override
        public ObjectListIterator<Object2ShortMap.Entry<K>> fastIterator(Object2ShortMap.Entry<K> entry) {
        ...
        public void forEach(Consumer<? super Object2ShortMap.Entry<K>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractObject2ShortMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Object2ShortMap.Entry entry) {
        ...
        MapEntrySet(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap, 1 var2_2) {
            this(object2ShortLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Object2ShortMap.Entry<K>> {
        ...
        public FastEntryIterator(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap) {
            this.this$0 = object2ShortLinkedOpenHashMap;
            super(object2ShortLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap, K k) {
            this.this$0 = object2ShortLinkedOpenHashMap;
            super(object2ShortLinkedOpenHashMap, k, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Object2ShortMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Object2ShortMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Object2ShortMap.Entry<K>> {
        ...
        public EntryIterator(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap) {
            this.this$0 = object2ShortLinkedOpenHashMap;
            super(object2ShortLinkedOpenHashMap);
        }

        public EntryIterator(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap, K k) {
            this.this$0 = object2ShortLinkedOpenHashMap;
            super(object2ShortLinkedOpenHashMap, k, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap) {
            this.this$0 = object2ShortLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = object2ShortLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap, K k) {
            this.this$0 = object2ShortLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (k == null) {
                if (object2ShortLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)object2ShortLinkedOpenHashMap.link[object2ShortLinkedOpenHashMap.n];
                    this.prev = object2ShortLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + k + " does not belong to this map.");
            }
            if (Objects.equals(object2ShortLinkedOpenHashMap.key[object2ShortLinkedOpenHashMap.last], k)) {
                this.prev = object2ShortLinkedOpenHashMap.last;
                this.index = object2ShortLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(k.hashCode()) & object2ShortLinkedOpenHashMap.mask;
            while (object2ShortLinkedOpenHashMap.key[n] != null) {
                if (object2ShortLinkedOpenHashMap.key[n].equals(k)) {
                    this.next = (int)object2ShortLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & object2ShortLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this map.");
        }
        ...
        MapIterator(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap, Object object, 1 var3_3) {
            this(object2ShortLinkedOpenHashMap, object);
        }
    }
    ...
    Map.Entry<K, Short> {
        ...
        MapEntry(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap, int n) {
            this.this$0 = object2ShortLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Object2ShortLinkedOpenHashMap object2ShortLinkedOpenHashMap) {
            this.this$0 = object2ShortLinkedOpenHashMap;
        }
