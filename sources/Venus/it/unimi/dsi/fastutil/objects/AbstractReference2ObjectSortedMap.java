...
implements Reference2ObjectSortedMap<K, V> {
    ...
    extends AbstractObjectCollection<V> {
        final AbstractReference2ObjectSortedMap this$0;

        protected ValuesCollection(AbstractReference2ObjectSortedMap abstractReference2ObjectSortedMap) {
            this.this$0 = abstractReference2ObjectSortedMap;
        }

        @Override
        public ObjectIterator<V> iterator() {
            return new ValuesIterator(Reference2ObjectSortedMaps.fastIterator(this.this$0));
        }
    ...
    extends AbstractReferenceSortedSet<K> {
        ...
        protected KeySet(AbstractReference2ObjectSortedMap abstractReference2ObjectSortedMap) {
            this.this$0 = abstractReference2ObjectSortedMap;
        }
        ...
        public ObjectBidirectionalIterator<K> iterator(K k) {
            return new KeySetIterator(this.this$0.reference2ObjectEntrySet().iterator(new AbstractReference2ObjectMap.BasicEntry(k, null)));
        }

        @Override
        public ObjectBidirectionalIterator<K> iterator() {
            return new KeySetIterator(Reference2ObjectSortedMaps.fastIterator(this.this$0));
        }
