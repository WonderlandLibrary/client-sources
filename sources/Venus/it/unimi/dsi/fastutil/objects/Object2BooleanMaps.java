...
public final class Object2BooleanMaps {
    ...
    public static <K> ObjectIterator<Object2BooleanMap.Entry<K>> fastIterator(Object2BooleanMap<K> object2BooleanMap) {
        ObjectSet<Object2BooleanMap.Entry<K>> objectSet = object2BooleanMap.object2BooleanEntrySet();
        return objectSet instanceof Object2BooleanMap.FastEntrySet ? ((Object2BooleanMap.FastEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }

    public static <K> void fastForEach(Object2BooleanMap<K> object2BooleanMap, Consumer<? super Object2BooleanMap.Entry<K>> consumer) {
        ObjectSet<Object2BooleanMap.Entry<K>> objectSet = object2BooleanMap.object2BooleanEntrySet();
        if (objectSet instanceof Object2BooleanMap.FastEntrySet) {
            ((Object2BooleanMap.FastEntrySet)objectSet).fastForEach(consumer);
        } else {
            objectSet.forEach(consumer);
        }
    }

    public static <K> ObjectIterable<Object2BooleanMap.Entry<K>> fastIterable(Object2BooleanMap<K> object2BooleanMap) {
        ObjectSet<Object2BooleanMap.Entry<K>> objectSet = object2BooleanMap.object2BooleanEntrySet();
        return objectSet instanceof Object2BooleanMap.FastEntrySet ? new ObjectIterable<Object2BooleanMap.Entry<K>>(objectSet){
            ...
            public ObjectIterator<Object2BooleanMap.Entry<K>> iterator() {
                return ((Object2BooleanMap.FastEntrySet)this.val$entries).fastIterator();
            }

            @Override
            public void forEach(Consumer<? super Object2BooleanMap.Entry<K>> consumer) {
                ((Object2BooleanMap.FastEntrySet)this.val$entries).fastForEach(consumer);
            }
    ...
    public static <K> Object2BooleanMap<K> singleton(K k, boolean bl) {
    ...
    public static <K> Object2BooleanMap<K> synchronize(Object2BooleanMap<K> object2BooleanMap) {
        return new SynchronizedMap<K>(object2BooleanMap);
    }

    public static <K> Object2BooleanMap<K> synchronize(Object2BooleanMap<K> object2BooleanMap, Object object) {
        return new SynchronizedMap<K>(object2BooleanMap, object);
    }

    public static <K> Object2BooleanMap<K> unmodifiable(Object2BooleanMap<K> object2BooleanMap) {
        return new UnmodifiableMap<K>(object2BooleanMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableMap(Object2BooleanMap<K> object2BooleanMap) {
            super(object2BooleanMap);
        ...
        @Override
        public boolean computeBooleanIfAbsentPartial(K k, Object2BooleanFunction<? super K> object2BooleanFunction) {
            throw new UnsupportedOperationException();
        }
    ...
    Serializable {
        ...
        protected SynchronizedMap(Object2BooleanMap<K> object2BooleanMap, Object object) {
            super(object2BooleanMap, object);
            this.map = object2BooleanMap;
        }

        protected SynchronizedMap(Object2BooleanMap<K> object2BooleanMap) {
            super(object2BooleanMap);
            this.map = object2BooleanMap;
        }
        ...
        public boolean computeBooleanIfAbsentPartial(K k, Object2BooleanFunction<? super K> object2BooleanFunction) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.computeBooleanIfAbsentPartial((K)k, object2BooleanFunction);
            }
        }
