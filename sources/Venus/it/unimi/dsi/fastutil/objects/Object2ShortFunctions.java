...
public final class Object2ShortFunctions {
    ...
    public static <K> Object2ShortFunction<K> synchronize(Object2ShortFunction<K> object2ShortFunction) {
        return new SynchronizedFunction<K>(object2ShortFunction);
    }

    public static <K> Object2ShortFunction<K> synchronize(Object2ShortFunction<K> object2ShortFunction, Object object) {
        return new SynchronizedFunction<K>(object2ShortFunction, object);
    }

    public static <K> Object2ShortFunction<K> unmodifiable(Object2ShortFunction<K> object2ShortFunction) {
        return new UnmodifiableFunction<K>(object2ShortFunction);
    }

    public static <K> Object2ShortFunction<K> primitive(java.util.function.Function<? super K, ? extends Short> function) {
        Objects.requireNonNull(function);
        if (function instanceof Object2ShortFunction) {
            return (Object2ShortFunction)function;
        }
        if (function instanceof ToIntFunction) {
            return arg_0 -> Object2ShortFunctions.lambda$primitive$0(function, arg_0);
        }
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Object2ShortFunction<K> object2ShortFunction) {
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Object2ShortFunction<K> object2ShortFunction, Object object) {
            if (object2ShortFunction == null) {
                throw new NullPointerException();
            }
            this.function = object2ShortFunction;
        ...
        protected SynchronizedFunction(Object2ShortFunction<K> object2ShortFunction) {
            if (object2ShortFunction == null) {
                throw new NullPointerException();
            }
            this.function = object2ShortFunction;
