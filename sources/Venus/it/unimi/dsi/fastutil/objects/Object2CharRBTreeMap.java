...
Cloneable {
    ...
    public Object2CharRBTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2CharRBTreeMap(Map<? extends K, ? extends Character> map) {
        this();
        this.putAll((Map<? extends K, Character>)map);
    }

    public Object2CharRBTreeMap(SortedMap<K, Character> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<K, Character>)sortedMap);
    }

    public Object2CharRBTreeMap(Object2CharMap<? extends K> object2CharMap) {
        this();
        this.putAll(object2CharMap);
    }

    public Object2CharRBTreeMap(Object2CharSortedMap<K> object2CharSortedMap) {
        this(object2CharSortedMap.comparator());
        this.putAll(object2CharSortedMap);
    }

    public Object2CharRBTreeMap(K[] KArray, char[] cArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2CharRBTreeMap(K[] KArray, char[] cArray) {
    ...
    public ObjectSortedSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2CharMap.Entry<K>>(this){
                ...
                final Object2CharRBTreeMap this$0;
                {
                    this.this$0 = object2CharRBTreeMap;
    ...
    public Object2CharRBTreeMap<K> clone() {
        Object2CharRBTreeMap object2CharRBTreeMap;
        try {
            object2CharRBTreeMap = (Object2CharRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2CharRBTreeMap.keys = null;
        object2CharRBTreeMap.values = null;
        object2CharRBTreeMap.entries = null;
        object2CharRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            object2CharRBTreeMap.tree = entry2.left;
                            object2CharRBTreeMap.firstEntry = object2CharRBTreeMap.tree;
                            while (object2CharRBTreeMap.firstEntry.left != null) {
                                object2CharRBTreeMap.firstEntry = object2CharRBTreeMap.firstEntry.left;
                            }
                            object2CharRBTreeMap.lastEntry = object2CharRBTreeMap.tree;
                            while (object2CharRBTreeMap.lastEntry.right != null) {
                                object2CharRBTreeMap.lastEntry = object2CharRBTreeMap.lastEntry.right;
                            }
                            return object2CharRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Object2CharRBTreeMap object2CharRBTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2CharRBTreeMap;
            if (!bl && !bl2 && object2CharRBTreeMap.compare(k, k2) > 0) {
            ...
            this.to = k2;
            this.top = bl2;
            this.defRetValue = object2CharRBTreeMap.defRetValue;
        }
    ...
    implements CharListIterator {
        ...
        private ValueIterator(Object2CharRBTreeMap object2CharRBTreeMap) {
            this.this$0 = object2CharRBTreeMap;
            super(object2CharRBTreeMap);
        }
        ...
        ValueIterator(Object2CharRBTreeMap object2CharRBTreeMap, 1 var2_2) {
            this(object2CharRBTreeMap);
        }
    }
    ...
    extends AbstractObject2CharSortedMap.KeySet {
        ...
        private KeySet(Object2CharRBTreeMap object2CharRBTreeMap) {
            this.this$0 = object2CharRBTreeMap;
            super(object2CharRBTreeMap);
        }
        ...
        KeySet(Object2CharRBTreeMap object2CharRBTreeMap, 1 var2_2) {
            this(object2CharRBTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2CharRBTreeMap object2CharRBTreeMap) {
            this.this$0 = object2CharRBTreeMap;
            super(object2CharRBTreeMap);
        }

        public KeyIterator(Object2CharRBTreeMap object2CharRBTreeMap, K k) {
            this.this$0 = object2CharRBTreeMap;
            super(object2CharRBTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2CharMap.Entry<K>> {
        ...
        EntryIterator(Object2CharRBTreeMap object2CharRBTreeMap) {
            this.this$0 = object2CharRBTreeMap;
            super(object2CharRBTreeMap);
        }

        EntryIterator(Object2CharRBTreeMap object2CharRBTreeMap, K k) {
            this.this$0 = object2CharRBTreeMap;
            super(object2CharRBTreeMap, k);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2CharRBTreeMap object2CharRBTreeMap) {
            this.this$0 = object2CharRBTreeMap;
            this.index = 0;
            this.next = object2CharRBTreeMap.firstEntry;
        }

        TreeIterator(Object2CharRBTreeMap object2CharRBTreeMap, K k) {
            this.this$0 = object2CharRBTreeMap;
            this.index = 0;
            this.next = object2CharRBTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2CharRBTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
