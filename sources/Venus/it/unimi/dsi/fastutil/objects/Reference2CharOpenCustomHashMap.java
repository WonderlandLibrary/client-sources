...
Hash {
    ...
    public Reference2CharOpenCustomHashMap(int n, float f, Hash.Strategy<K> strategy) {
    ...
    public Reference2CharOpenCustomHashMap(int n, Hash.Strategy<K> strategy) {
    ...
    public Reference2CharOpenCustomHashMap(Map<? extends K, ? extends Character> map, float f, Hash.Strategy<K> strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Reference2CharOpenCustomHashMap(Map<? extends K, ? extends Character> map, Hash.Strategy<K> strategy) {
        this(map, 0.75f, strategy);
    }

    public Reference2CharOpenCustomHashMap(Reference2CharMap<K> reference2CharMap, float f, Hash.Strategy<K> strategy) {
        this(reference2CharMap.size(), f, strategy);
        this.putAll(reference2CharMap);
    }

    public Reference2CharOpenCustomHashMap(Reference2CharMap<K> reference2CharMap, Hash.Strategy<K> strategy) {
        this(reference2CharMap, 0.75f, strategy);
    }

    public Reference2CharOpenCustomHashMap(K[] KArray, char[] cArray, float f, Hash.Strategy<K> strategy) {
    ...
    public Reference2CharOpenCustomHashMap(K[] KArray, char[] cArray, Hash.Strategy<K> strategy) {
    ...
    public CharCollection values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection(this){
                final Reference2CharOpenCustomHashMap this$0;
                {
                    this.this$0 = reference2CharOpenCustomHashMap;
                }
    ...
    public Reference2CharOpenCustomHashMap<K> clone() {
        Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap;
        try {
            reference2CharOpenCustomHashMap = (Reference2CharOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2CharOpenCustomHashMap.keys = null;
        reference2CharOpenCustomHashMap.values = null;
        reference2CharOpenCustomHashMap.entries = null;
        reference2CharOpenCustomHashMap.containsNullKey = this.containsNullKey;
        reference2CharOpenCustomHashMap.key = (Object[])this.key.clone();
        reference2CharOpenCustomHashMap.value = (char[])this.value.clone();
        reference2CharOpenCustomHashMap.strategy = this.strategy;
        return reference2CharOpenCustomHashMap;
    }
    ...
    static char access$300(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap) {
        return reference2CharOpenCustomHashMap.removeNullEntry();
    }

    static char access$400(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap, int n) {
        return reference2CharOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements CharIterator {
        ...
        public ValueIterator(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap) {
            this.this$0 = reference2CharOpenCustomHashMap;
            super(reference2CharOpenCustomHashMap, null);
        }
    ...
    extends AbstractReferenceSet<K> {
        ...
        private KeySet(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap) {
            this.this$0 = reference2CharOpenCustomHashMap;
        }
        ...
        KeySet(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap, 1 var2_2) {
            this(reference2CharOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<K> {
        ...
        public KeyIterator(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap) {
            this.this$0 = reference2CharOpenCustomHashMap;
            super(reference2CharOpenCustomHashMap, null);
        }
    ...
    implements Reference2CharMap.FastEntrySet<K> {
        ...
        private MapEntrySet(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap) {
            this.this$0 = reference2CharOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(k, null)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == c) {
                    Reference2CharOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(k2, k)) {
                if (this.this$0.value[n] == c) {
                    Reference2CharOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        public void forEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
            if (this.this$0.containsNullKey) {
                consumer.accept(new AbstractReference2CharMap.BasicEntry(this.this$0.key[this.this$0.n], this.this$0.value[this.this$0.n]));
            }
            int n = this.this$0.n;
            while (n-- != 0) {
                if (this.this$0.key[n] == null) continue;
                consumer.accept(new AbstractReference2CharMap.BasicEntry(this.this$0.key[n], this.this$0.value[n]));
            }
        }
        ...
        MapEntrySet(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap, 1 var2_2) {
            this(reference2CharOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2CharMap.Entry<K>> {
        ...
        private FastEntryIterator(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap) {
            this.this$0 = reference2CharOpenCustomHashMap;
            super(reference2CharOpenCustomHashMap, null);
        ...
        FastEntryIterator(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap, 1 var2_2) {
            this(reference2CharOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2CharMap.Entry<K>> {
        ...
        private EntryIterator(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap) {
            this.this$0 = reference2CharOpenCustomHashMap;
            super(reference2CharOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap, 1 var2_2) {
            this(reference2CharOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap) {
            this.this$0 = reference2CharOpenCustomHashMap;
        ...
        MapIterator(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap, 1 var2_2) {
            this(reference2CharOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<K, Character> {
        ...
        MapEntry(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap, int n) {
            this.this$0 = reference2CharOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Reference2CharOpenCustomHashMap reference2CharOpenCustomHashMap) {
            this.this$0 = reference2CharOpenCustomHashMap;
        }
