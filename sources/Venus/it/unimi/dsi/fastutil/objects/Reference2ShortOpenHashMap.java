...
Hash {
    ...
    public Reference2ShortOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Reference2ShortOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Reference2ShortOpenHashMap(Map<? extends K, ? extends Short> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Reference2ShortOpenHashMap(Map<? extends K, ? extends Short> map) {
        this(map, 0.75f);
    }

    public Reference2ShortOpenHashMap(Reference2ShortMap<K> reference2ShortMap, float f) {
        this(reference2ShortMap.size(), f);
        this.putAll(reference2ShortMap);
    }

    public Reference2ShortOpenHashMap(Reference2ShortMap<K> reference2ShortMap) {
        this(reference2ShortMap, 0.75f);
    }

    public Reference2ShortOpenHashMap(K[] KArray, short[] sArray, float f) {
    ...
    public Reference2ShortOpenHashMap(K[] KArray, short[] sArray) {
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection(this){
                final Reference2ShortOpenHashMap this$0;
                {
                    this.this$0 = reference2ShortOpenHashMap;
                }
    ...
    public Reference2ShortOpenHashMap<K> clone() {
        Reference2ShortOpenHashMap reference2ShortOpenHashMap;
        try {
            reference2ShortOpenHashMap = (Reference2ShortOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2ShortOpenHashMap.keys = null;
        reference2ShortOpenHashMap.values = null;
        reference2ShortOpenHashMap.entries = null;
        reference2ShortOpenHashMap.containsNullKey = this.containsNullKey;
        reference2ShortOpenHashMap.key = (Object[])this.key.clone();
        reference2ShortOpenHashMap.value = (short[])this.value.clone();
    ...
    static short access$300(Reference2ShortOpenHashMap reference2ShortOpenHashMap) {
        return reference2ShortOpenHashMap.removeNullEntry();
    }

    static short access$400(Reference2ShortOpenHashMap reference2ShortOpenHashMap, int n) {
        return reference2ShortOpenHashMap.removeEntry(n);
    }
    ...
    implements ShortIterator {
        ...
        public ValueIterator(Reference2ShortOpenHashMap reference2ShortOpenHashMap) {
            this.this$0 = reference2ShortOpenHashMap;
            super(reference2ShortOpenHashMap, null);
        }
    ...
    extends AbstractReferenceSet<K> {
        ...
        private KeySet(Reference2ShortOpenHashMap reference2ShortOpenHashMap) {
            this.this$0 = reference2ShortOpenHashMap;
        }
        ...
        KeySet(Reference2ShortOpenHashMap reference2ShortOpenHashMap, 1 var2_2) {
            this(reference2ShortOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<K> {
        ...
        public KeyIterator(Reference2ShortOpenHashMap reference2ShortOpenHashMap) {
            this.this$0 = reference2ShortOpenHashMap;
            super(reference2ShortOpenHashMap, null);
        }
    ...
    implements Reference2ShortMap.FastEntrySet<K> {
        ...
        private MapEntrySet(Reference2ShortOpenHashMap reference2ShortOpenHashMap) {
            this.this$0 = reference2ShortOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == s) {
                    Reference2ShortOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2 == k) {
                if (this.this$0.value[n] == s) {
                    Reference2ShortOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Reference2ShortOpenHashMap reference2ShortOpenHashMap, 1 var2_2) {
            this(reference2ShortOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2ShortMap.Entry<K>> {
        ...
        private FastEntryIterator(Reference2ShortOpenHashMap reference2ShortOpenHashMap) {
            this.this$0 = reference2ShortOpenHashMap;
            super(reference2ShortOpenHashMap, null);
        ...
        FastEntryIterator(Reference2ShortOpenHashMap reference2ShortOpenHashMap, 1 var2_2) {
            this(reference2ShortOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Reference2ShortMap.Entry<K>> {
        ...
        private EntryIterator(Reference2ShortOpenHashMap reference2ShortOpenHashMap) {
            this.this$0 = reference2ShortOpenHashMap;
            super(reference2ShortOpenHashMap, null);
        }
        ...
        EntryIterator(Reference2ShortOpenHashMap reference2ShortOpenHashMap, 1 var2_2) {
            this(reference2ShortOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Reference2ShortOpenHashMap reference2ShortOpenHashMap) {
            this.this$0 = reference2ShortOpenHashMap;
        ...
        MapIterator(Reference2ShortOpenHashMap reference2ShortOpenHashMap, 1 var2_2) {
            this(reference2ShortOpenHashMap);
        }
    }
    ...
    Map.Entry<K, Short> {
        ...
        MapEntry(Reference2ShortOpenHashMap reference2ShortOpenHashMap, int n) {
            this.this$0 = reference2ShortOpenHashMap;
            this.index = n;
        }

        MapEntry(Reference2ShortOpenHashMap reference2ShortOpenHashMap) {
            this.this$0 = reference2ShortOpenHashMap;
        }
