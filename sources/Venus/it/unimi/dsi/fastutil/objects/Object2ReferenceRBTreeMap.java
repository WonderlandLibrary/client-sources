...
Cloneable {
    ...
    public Object2ReferenceRBTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2ReferenceRBTreeMap(Map<? extends K, ? extends V> map) {
        this();
        this.putAll(map);
    }

    public Object2ReferenceRBTreeMap(SortedMap<K, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll(sortedMap);
    }

    public Object2ReferenceRBTreeMap(Object2ReferenceMap<? extends K, ? extends V> object2ReferenceMap) {
        this();
        this.putAll(object2ReferenceMap);
    }

    public Object2ReferenceRBTreeMap(Object2ReferenceSortedMap<K, V> object2ReferenceSortedMap) {
        this(object2ReferenceSortedMap.comparator());
        this.putAll(object2ReferenceSortedMap);
    }

    public Object2ReferenceRBTreeMap(K[] KArray, V[] VArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2ReferenceRBTreeMap(K[] KArray, V[] VArray) {
    ...
    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>(this){
                ...
                final Object2ReferenceRBTreeMap this$0;
                {
                    this.this$0 = object2ReferenceRBTreeMap;
    ...
    public Object2ReferenceRBTreeMap<K, V> clone() {
        Object2ReferenceRBTreeMap object2ReferenceRBTreeMap;
        try {
            object2ReferenceRBTreeMap = (Object2ReferenceRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2ReferenceRBTreeMap.keys = null;
        object2ReferenceRBTreeMap.values = null;
        object2ReferenceRBTreeMap.entries = null;
        object2ReferenceRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            object2ReferenceRBTreeMap.tree = entry2.left;
                            object2ReferenceRBTreeMap.firstEntry = object2ReferenceRBTreeMap.tree;
                            while (object2ReferenceRBTreeMap.firstEntry.left != null) {
                                object2ReferenceRBTreeMap.firstEntry = object2ReferenceRBTreeMap.firstEntry.left;
                            }
                            object2ReferenceRBTreeMap.lastEntry = object2ReferenceRBTreeMap.tree;
                            while (object2ReferenceRBTreeMap.lastEntry.right != null) {
                                object2ReferenceRBTreeMap.lastEntry = object2ReferenceRBTreeMap.lastEntry.right;
                            }
                            return object2ReferenceRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Object2ReferenceRBTreeMap object2ReferenceRBTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2ReferenceRBTreeMap;
            if (!bl && !bl2 && object2ReferenceRBTreeMap.compare(k, k2) > 0) {
            ...
            this.to = k2;
            this.top = bl2;
            this.defRetValue = object2ReferenceRBTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Object2ReferenceRBTreeMap object2ReferenceRBTreeMap) {
            this.this$0 = object2ReferenceRBTreeMap;
            super(object2ReferenceRBTreeMap);
        }
        ...
        ValueIterator(Object2ReferenceRBTreeMap object2ReferenceRBTreeMap, 1 var2_2) {
            this(object2ReferenceRBTreeMap);
        }
    }
    ...
    extends AbstractObject2ReferenceSortedMap.KeySet {
        ...
        private KeySet(Object2ReferenceRBTreeMap object2ReferenceRBTreeMap) {
            this.this$0 = object2ReferenceRBTreeMap;
            super(object2ReferenceRBTreeMap);
        }
        ...
        KeySet(Object2ReferenceRBTreeMap object2ReferenceRBTreeMap, 1 var2_2) {
            this(object2ReferenceRBTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2ReferenceRBTreeMap object2ReferenceRBTreeMap) {
            this.this$0 = object2ReferenceRBTreeMap;
            super(object2ReferenceRBTreeMap);
        }

        public KeyIterator(Object2ReferenceRBTreeMap object2ReferenceRBTreeMap, K k) {
            this.this$0 = object2ReferenceRBTreeMap;
            super(object2ReferenceRBTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> {
        ...
        EntryIterator(Object2ReferenceRBTreeMap object2ReferenceRBTreeMap) {
            this.this$0 = object2ReferenceRBTreeMap;
            super(object2ReferenceRBTreeMap);
        }

        EntryIterator(Object2ReferenceRBTreeMap object2ReferenceRBTreeMap, K k) {
            this.this$0 = object2ReferenceRBTreeMap;
            super(object2ReferenceRBTreeMap, k);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2ReferenceRBTreeMap object2ReferenceRBTreeMap) {
            this.this$0 = object2ReferenceRBTreeMap;
            this.index = 0;
            this.next = object2ReferenceRBTreeMap.firstEntry;
        }

        TreeIterator(Object2ReferenceRBTreeMap object2ReferenceRBTreeMap, K k) {
            this.this$0 = object2ReferenceRBTreeMap;
            this.index = 0;
            this.next = object2ReferenceRBTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2ReferenceRBTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
