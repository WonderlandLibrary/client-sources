...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Object2DoubleAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Object2DoubleAVLTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2DoubleAVLTreeMap(Map<? extends K, ? extends Double> map) {
        this();
        this.putAll((Map<? extends K, Double>)map);
    }

    public Object2DoubleAVLTreeMap(SortedMap<K, Double> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<K, Double>)sortedMap);
    }

    public Object2DoubleAVLTreeMap(Object2DoubleMap<? extends K> object2DoubleMap) {
        this();
        this.putAll(object2DoubleMap);
    }

    public Object2DoubleAVLTreeMap(Object2DoubleSortedMap<K> object2DoubleSortedMap) {
        this(object2DoubleSortedMap.comparator());
        this.putAll(object2DoubleSortedMap);
    }

    public Object2DoubleAVLTreeMap(K[] KArray, double[] dArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2DoubleAVLTreeMap(K[] KArray, double[] dArray) {
    ...
    public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>(this){
                ...
                final Object2DoubleAVLTreeMap this$0;
                {
                    this.this$0 = object2DoubleAVLTreeMap;
    ...
    public Object2DoubleAVLTreeMap<K> clone() {
        Object2DoubleAVLTreeMap object2DoubleAVLTreeMap;
        try {
            object2DoubleAVLTreeMap = (Object2DoubleAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2DoubleAVLTreeMap.keys = null;
        object2DoubleAVLTreeMap.values = null;
        object2DoubleAVLTreeMap.entries = null;
        object2DoubleAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            object2DoubleAVLTreeMap.tree = entry2.left;
                            object2DoubleAVLTreeMap.firstEntry = object2DoubleAVLTreeMap.tree;
                            while (object2DoubleAVLTreeMap.firstEntry.left != null) {
                                object2DoubleAVLTreeMap.firstEntry = object2DoubleAVLTreeMap.firstEntry.left;
                            }
                            object2DoubleAVLTreeMap.lastEntry = object2DoubleAVLTreeMap.tree;
                            while (object2DoubleAVLTreeMap.lastEntry.right != null) {
                                object2DoubleAVLTreeMap.lastEntry = object2DoubleAVLTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Object2DoubleAVLTreeMap object2DoubleAVLTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2DoubleAVLTreeMap;
            if (!bl && !bl2 && object2DoubleAVLTreeMap.compare(k, k2) > 0) {
            ...
            this.to = k2;
            this.top = bl2;
            this.defRetValue = object2DoubleAVLTreeMap.defRetValue;
        }
    ...
    implements DoubleListIterator {
        ...
        private ValueIterator(Object2DoubleAVLTreeMap object2DoubleAVLTreeMap) {
            this.this$0 = object2DoubleAVLTreeMap;
            super(object2DoubleAVLTreeMap);
        }
        ...
        ValueIterator(Object2DoubleAVLTreeMap object2DoubleAVLTreeMap, 1 var2_2) {
            this(object2DoubleAVLTreeMap);
        }
    }
    ...
    extends AbstractObject2DoubleSortedMap.KeySet {
        ...
        private KeySet(Object2DoubleAVLTreeMap object2DoubleAVLTreeMap) {
            this.this$0 = object2DoubleAVLTreeMap;
            super(object2DoubleAVLTreeMap);
        }
        ...
        KeySet(Object2DoubleAVLTreeMap object2DoubleAVLTreeMap, 1 var2_2) {
            this(object2DoubleAVLTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2DoubleAVLTreeMap object2DoubleAVLTreeMap) {
            this.this$0 = object2DoubleAVLTreeMap;
            super(object2DoubleAVLTreeMap);
        }

        public KeyIterator(Object2DoubleAVLTreeMap object2DoubleAVLTreeMap, K k) {
            this.this$0 = object2DoubleAVLTreeMap;
            super(object2DoubleAVLTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2DoubleMap.Entry<K>> {
        ...
        EntryIterator(Object2DoubleAVLTreeMap object2DoubleAVLTreeMap) {
            this.this$0 = object2DoubleAVLTreeMap;
            super(object2DoubleAVLTreeMap);
        }

        EntryIterator(Object2DoubleAVLTreeMap object2DoubleAVLTreeMap, K k) {
            this.this$0 = object2DoubleAVLTreeMap;
            super(object2DoubleAVLTreeMap, k);
        }
        ...
        public void add(Object object) {
            this.add((Object2DoubleMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Object2DoubleMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2DoubleAVLTreeMap object2DoubleAVLTreeMap) {
            this.this$0 = object2DoubleAVLTreeMap;
            this.index = 0;
            this.next = object2DoubleAVLTreeMap.firstEntry;
        }

        TreeIterator(Object2DoubleAVLTreeMap object2DoubleAVLTreeMap, K k) {
            this.this$0 = object2DoubleAVLTreeMap;
            this.index = 0;
            this.next = object2DoubleAVLTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2DoubleAVLTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
