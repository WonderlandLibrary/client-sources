...
Map<K, Boolean> {
    ...
    default public Boolean put(K k, Boolean bl) {
        return Object2BooleanFunction.super.put(k, bl);
    }

    @Override
    @Deprecated
    default public Boolean get(Object object) {
        return Object2BooleanFunction.super.get(object);
    }

    @Override
    @Deprecated
    default public Boolean remove(Object object) {
        return Object2BooleanFunction.super.remove(object);
    }
    ...
    default public boolean computeBooleanIfAbsentPartial(K k, Object2BooleanFunction<? super K> object2BooleanFunction) {
        ...
        if (!object2BooleanFunction.containsKey(k)) {
            return bl2;
        }
        boolean bl3 = object2BooleanFunction.getBoolean(k);
        this.put(k, bl3);
        return bl3;
    }
