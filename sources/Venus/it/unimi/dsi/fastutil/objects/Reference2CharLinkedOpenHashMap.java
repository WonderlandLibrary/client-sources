...
Hash {
    ...
    public Reference2CharLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Reference2CharLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Reference2CharLinkedOpenHashMap(Map<? extends K, ? extends Character> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Reference2CharLinkedOpenHashMap(Map<? extends K, ? extends Character> map) {
        this(map, 0.75f);
    }

    public Reference2CharLinkedOpenHashMap(Reference2CharMap<K> reference2CharMap, float f) {
        this(reference2CharMap.size(), f);
        this.putAll(reference2CharMap);
    }

    public Reference2CharLinkedOpenHashMap(Reference2CharMap<K> reference2CharMap) {
        this(reference2CharMap, 0.75f);
    }

    public Reference2CharLinkedOpenHashMap(K[] KArray, char[] cArray, float f) {
    ...
    public Reference2CharLinkedOpenHashMap(K[] KArray, char[] cArray) {
    ...
    public CharCollection values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection(this){
                final Reference2CharLinkedOpenHashMap this$0;
                {
                    this.this$0 = reference2CharLinkedOpenHashMap;
                }
    ...
    public Reference2CharLinkedOpenHashMap<K> clone() {
        Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap;
        try {
            reference2CharLinkedOpenHashMap = (Reference2CharLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        reference2CharLinkedOpenHashMap.keys = null;
        reference2CharLinkedOpenHashMap.values = null;
        reference2CharLinkedOpenHashMap.entries = null;
        reference2CharLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        reference2CharLinkedOpenHashMap.key = (Object[])this.key.clone();
        reference2CharLinkedOpenHashMap.value = (char[])this.value.clone();
        reference2CharLinkedOpenHashMap.link = (long[])this.link.clone();
        return reference2CharLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet reference2CharEntrySet() {
    ...
    static char access$100(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap) {
        return reference2CharLinkedOpenHashMap.removeNullEntry();
    }

    static char access$200(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap, int n) {
        return reference2CharLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements CharListIterator {
        ...
        public ValueIterator(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap) {
            this.this$0 = reference2CharLinkedOpenHashMap;
            super(reference2CharLinkedOpenHashMap);
        }
    ...
    extends AbstractReferenceSortedSet<K> {
        ...
        private KeySet(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap) {
            this.this$0 = reference2CharLinkedOpenHashMap;
        }
        ...
        KeySet(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap, 1 var2_2) {
            this(reference2CharLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap, K k) {
            this.this$0 = reference2CharLinkedOpenHashMap;
            super(reference2CharLinkedOpenHashMap, k, null);
        }
        ...
        public KeyIterator(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap) {
            this.this$0 = reference2CharLinkedOpenHashMap;
            super(reference2CharLinkedOpenHashMap);
        }
    ...
    implements Reference2CharSortedMap.FastSortedEntrySet<K> {
        ...
        private MapEntrySet(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap) {
            this.this$0 = reference2CharLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Reference2CharMap.Entry<K>> subSet(Reference2CharMap.Entry<K> entry, Reference2CharMap.Entry<K> entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Reference2CharMap.Entry<K>> headSet(Reference2CharMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Reference2CharMap.Entry<K>> tailSet(Reference2CharMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (k == null) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == c) {
                    Reference2CharLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (k2 == k) {
                if (this.this$0.value[n] == c) {
                    Reference2CharLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((k2 = KArray[n = n + 1 & this.this$0.mask]) != null) continue;
                return true;
            } while (k2 != k || this.this$0.value[n] != c);
            Reference2CharLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Reference2CharMap.Entry<K>> iterator(Reference2CharMap.Entry<K> entry) {
        ...
        @Override
        public ObjectListIterator<Reference2CharMap.Entry<K>> fastIterator(Reference2CharMap.Entry<K> entry) {
        ...
        public void forEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractReference2CharMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }

        @Override
        public void fastForEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
            AbstractReference2CharMap.BasicEntry basicEntry = new AbstractReference2CharMap.BasicEntry();
            int n = this.this$0.size;
            int n2 = this.this$0.first;
            while (n-- != 0) {
                int n3 = n2;
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Reference2CharMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Reference2CharMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Reference2CharMap.Entry)object, (Reference2CharMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Reference2CharMap.Entry)object);
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Reference2CharMap.Entry entry) {
        ...
        MapEntrySet(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap, 1 var2_2) {
            this(reference2CharLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Reference2CharMap.Entry<K>> {
        ...
        public FastEntryIterator(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap) {
            this.this$0 = reference2CharLinkedOpenHashMap;
            super(reference2CharLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap, K k) {
            this.this$0 = reference2CharLinkedOpenHashMap;
            super(reference2CharLinkedOpenHashMap, k, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Reference2CharMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Reference2CharMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Reference2CharMap.Entry<K>> {
        ...
        public EntryIterator(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap) {
            this.this$0 = reference2CharLinkedOpenHashMap;
            super(reference2CharLinkedOpenHashMap);
        }

        public EntryIterator(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap, K k) {
            this.this$0 = reference2CharLinkedOpenHashMap;
            super(reference2CharLinkedOpenHashMap, k, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap) {
            this.this$0 = reference2CharLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = reference2CharLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap, K k) {
            this.this$0 = reference2CharLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (k == null) {
                if (reference2CharLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)reference2CharLinkedOpenHashMap.link[reference2CharLinkedOpenHashMap.n];
                    this.prev = reference2CharLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + k + " does not belong to this map.");
            }
            if (reference2CharLinkedOpenHashMap.key[reference2CharLinkedOpenHashMap.last] == k) {
                this.prev = reference2CharLinkedOpenHashMap.last;
                this.index = reference2CharLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(System.identityHashCode(k)) & reference2CharLinkedOpenHashMap.mask;
            while (reference2CharLinkedOpenHashMap.key[n] != null) {
                if (reference2CharLinkedOpenHashMap.key[n] == k) {
                    this.next = (int)reference2CharLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & reference2CharLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + k + " does not belong to this map.");
        }
        ...
        public void set(Reference2CharMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Reference2CharMap.Entry<K> entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap, Object object, 1 var3_3) {
            this(reference2CharLinkedOpenHashMap, object);
        }
    }
    ...
    Map.Entry<K, Character> {
        ...
        MapEntry(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap, int n) {
            this.this$0 = reference2CharLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Reference2CharLinkedOpenHashMap reference2CharLinkedOpenHashMap) {
            this.this$0 = reference2CharLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.key[this.index] == entry.getKey() && this.this$0.value[this.index] == ((Character)entry.getValue()).charValue();
        }
