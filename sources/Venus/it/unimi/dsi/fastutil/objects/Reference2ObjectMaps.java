...
public final class Reference2ObjectMaps {
    ...
    public static <K, V> ObjectIterator<Reference2ObjectMap.Entry<K, V>> fastIterator(Reference2ObjectMap<K, V> reference2ObjectMap) {
        ObjectSet<Reference2ObjectMap.Entry<K, V>> objectSet = reference2ObjectMap.reference2ObjectEntrySet();
        return objectSet instanceof Reference2ObjectMap.FastEntrySet ? ((Reference2ObjectMap.FastEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }
    ...
    public static <K, V> void fastForEach(Reference2ObjectMap<K, V> reference2ObjectMap, Consumer<? super Reference2ObjectMap.Entry<K, V>> consumer) {
        ...
        if (objectSet instanceof Reference2ObjectMap.FastEntrySet) {
            ((Reference2ObjectMap.FastEntrySet)objectSet).fastForEach(consumer);
        } else {
    ...
    public static <K, V> ObjectIterable<Reference2ObjectMap.Entry<K, V>> fastIterable(Reference2ObjectMap<K, V> reference2ObjectMap) {
        ObjectSet<Reference2ObjectMap.Entry<K, V>> objectSet = reference2ObjectMap.reference2ObjectEntrySet();
        return objectSet instanceof Reference2ObjectMap.FastEntrySet ? new ObjectIterable<Reference2ObjectMap.Entry<K, V>>(objectSet){
            ...
            public ObjectIterator<Reference2ObjectMap.Entry<K, V>> iterator() {
                return ((Reference2ObjectMap.FastEntrySet)this.val$entries).fastIterator();
            }

            @Override
            public void forEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> consumer) {
                ((Reference2ObjectMap.FastEntrySet)this.val$entries).fastForEach(consumer);
            }
    ...
    public static <K, V> Reference2ObjectMap<K, V> synchronize(Reference2ObjectMap<K, V> reference2ObjectMap) {
        return new SynchronizedMap<K, V>(reference2ObjectMap);
    }

    public static <K, V> Reference2ObjectMap<K, V> synchronize(Reference2ObjectMap<K, V> reference2ObjectMap, Object object) {
        return new SynchronizedMap<K, V>(reference2ObjectMap, object);
    }

    public static <K, V> Reference2ObjectMap<K, V> unmodifiable(Reference2ObjectMap<K, V> reference2ObjectMap) {
        return new UnmodifiableMap<K, V>(reference2ObjectMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableMap(Reference2ObjectMap<K, V> reference2ObjectMap) {
    ...
    Serializable {
        ...
        protected SynchronizedMap(Reference2ObjectMap<K, V> reference2ObjectMap, Object object) {
            super(reference2ObjectMap, object);
            this.map = reference2ObjectMap;
        }

        protected SynchronizedMap(Reference2ObjectMap<K, V> reference2ObjectMap) {
            super(reference2ObjectMap);
            this.map = reference2ObjectMap;
        }
