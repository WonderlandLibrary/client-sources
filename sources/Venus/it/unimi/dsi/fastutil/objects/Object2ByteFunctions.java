...
public final class Object2ByteFunctions {
    ...
    public static <K> Object2ByteFunction<K> singleton(K k, byte by) {
    ...
    public static <K> Object2ByteFunction<K> synchronize(Object2ByteFunction<K> object2ByteFunction) {
        return new SynchronizedFunction<K>(object2ByteFunction);
    }

    public static <K> Object2ByteFunction<K> synchronize(Object2ByteFunction<K> object2ByteFunction, Object object) {
        return new SynchronizedFunction<K>(object2ByteFunction, object);
    }

    public static <K> Object2ByteFunction<K> unmodifiable(Object2ByteFunction<K> object2ByteFunction) {
        return new UnmodifiableFunction<K>(object2ByteFunction);
    }

    public static <K> Object2ByteFunction<K> primitive(java.util.function.Function<? super K, ? extends Byte> function) {
        Objects.requireNonNull(function);
        if (function instanceof Object2ByteFunction) {
            return (Object2ByteFunction)function;
        }
        if (function instanceof ToIntFunction) {
            return arg_0 -> Object2ByteFunctions.lambda$primitive$0(function, arg_0);
        }
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Object2ByteFunction<K> object2ByteFunction) {
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Object2ByteFunction<K> object2ByteFunction, Object object) {
            if (object2ByteFunction == null) {
                throw new NullPointerException();
            }
            this.function = object2ByteFunction;
        ...
        protected SynchronizedFunction(Object2ByteFunction<K> object2ByteFunction) {
            if (object2ByteFunction == null) {
                throw new NullPointerException();
            }
            this.function = object2ByteFunction;
