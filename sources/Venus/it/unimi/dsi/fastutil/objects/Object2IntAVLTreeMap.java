...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Object2IntAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Object2IntAVLTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2IntAVLTreeMap(Map<? extends K, ? extends Integer> map) {
        this();
        this.putAll((Map<? extends K, Integer>)map);
    }

    public Object2IntAVLTreeMap(SortedMap<K, Integer> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<K, Integer>)sortedMap);
    }

    public Object2IntAVLTreeMap(Object2IntMap<? extends K> object2IntMap) {
        this();
        this.putAll(object2IntMap);
    }

    public Object2IntAVLTreeMap(Object2IntSortedMap<K> object2IntSortedMap) {
        this(object2IntSortedMap.comparator());
        this.putAll(object2IntSortedMap);
    }

    public Object2IntAVLTreeMap(K[] KArray, int[] nArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2IntAVLTreeMap(K[] KArray, int[] nArray) {
        this(KArray, nArray, null);
    }
    ...
    public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>(this){
                final Comparator<? super Object2IntMap.Entry<K>> comparator;
                final Object2IntAVLTreeMap this$0;
                {
                    this.this$0 = object2IntAVLTreeMap;
                ...
                public boolean remove(Object object) {
                    ...
                    this.this$0.removeInt(entry2.key);
                    return false;
                }
                ...
                public ObjectSortedSet<Object2IntMap.Entry<K>> subSet(Object2IntMap.Entry<K> entry, Object2IntMap.Entry<K> entry2) {
                    return this.this$0.subMap(entry.getKey(), entry2.getKey()).object2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2IntMap.Entry<K>> headSet(Object2IntMap.Entry<K> entry) {
                    return this.this$0.headMap(entry.getKey()).object2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2IntMap.Entry<K>> tailSet(Object2IntMap.Entry<K> entry) {
                    return this.this$0.tailMap(entry.getKey()).object2IntEntrySet();
                }
                ...
                private int lambda$$0(Object2IntMap.Entry entry, Object2IntMap.Entry entry2) {
    ...
    public Object2IntAVLTreeMap<K> clone() {
        Object2IntAVLTreeMap object2IntAVLTreeMap;
        try {
            object2IntAVLTreeMap = (Object2IntAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2IntAVLTreeMap.keys = null;
        object2IntAVLTreeMap.values = null;
        object2IntAVLTreeMap.entries = null;
        object2IntAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            object2IntAVLTreeMap.tree = entry2.left;
                            object2IntAVLTreeMap.firstEntry = object2IntAVLTreeMap.tree;
                            while (object2IntAVLTreeMap.firstEntry.left != null) {
                                object2IntAVLTreeMap.firstEntry = object2IntAVLTreeMap.firstEntry.left;
                            }
                            object2IntAVLTreeMap.lastEntry = object2IntAVLTreeMap.tree;
                            while (object2IntAVLTreeMap.lastEntry.right != null) {
                                object2IntAVLTreeMap.lastEntry = object2IntAVLTreeMap.lastEntry.right;
                            }
    ...
    private Entry<K> readTree(ObjectInputStream objectInputStream, int n, Entry<K> entry, Entry<K> entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry<Object> entry3 = new Entry<Object>(objectInputStream.readObject(), objectInputStream.readInt());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry<Object> entry4 = new Entry<Object>(objectInputStream.readObject(), objectInputStream.readInt());
            entry4.right(new Entry<Object>(objectInputStream.readObject(), objectInputStream.readInt()));
    ...
    implements Serializable {
        ...
        public Submap(Object2IntAVLTreeMap object2IntAVLTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2IntAVLTreeMap;
            if (!bl && !bl2 && object2IntAVLTreeMap.compare(k, k2) > 0) {
            ...
            this.to = k2;
            this.top = bl2;
            this.defRetValue = object2IntAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>(this){
                    ...
                    @Override
                    public Comparator<? super Object2IntMap.Entry<K>> comparator() {
                        return this.this$1.this$0.object2IntEntrySet().comparator();
                    }
                    ...
                    public boolean remove(Object object) {
                        ...
                        if (entry2 != null && this.this$1.in(entry2.key)) {
                            this.this$1.removeInt(entry2.key);
                        }
                        return entry2 != null;
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Object2IntMap.Entry<K>> subSet(Object2IntMap.Entry<K> entry, Object2IntMap.Entry<K> entry2) {
                        return this.this$1.subMap(entry.getKey(), entry2.getKey()).object2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2IntMap.Entry<K>> headSet(Object2IntMap.Entry<K> entry) {
                        return this.this$1.headMap(entry.getKey()).object2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2IntMap.Entry<K>> tailSet(Object2IntMap.Entry<K> entry) {
                        return this.this$1.tailMap(entry.getKey()).object2IntEntrySet();
                    }
        ...
        public int removeInt(Object object) {
            ...
            int n = this.this$0.removeInt(object);
    ...
    implements IntListIterator {
        ...
        private ValueIterator(Object2IntAVLTreeMap object2IntAVLTreeMap) {
            this.this$0 = object2IntAVLTreeMap;
            super(object2IntAVLTreeMap);
        }
        ...
        ValueIterator(Object2IntAVLTreeMap object2IntAVLTreeMap, 1 var2_2) {
            this(object2IntAVLTreeMap);
        }
    }
    ...
    extends AbstractObject2IntSortedMap.KeySet {
        ...
        private KeySet(Object2IntAVLTreeMap object2IntAVLTreeMap) {
            this.this$0 = object2IntAVLTreeMap;
            super(object2IntAVLTreeMap);
        }
        ...
        KeySet(Object2IntAVLTreeMap object2IntAVLTreeMap, 1 var2_2) {
            this(object2IntAVLTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2IntAVLTreeMap object2IntAVLTreeMap) {
            this.this$0 = object2IntAVLTreeMap;
            super(object2IntAVLTreeMap);
        }

        public KeyIterator(Object2IntAVLTreeMap object2IntAVLTreeMap, K k) {
            this.this$0 = object2IntAVLTreeMap;
            super(object2IntAVLTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2IntMap.Entry<K>> {
        ...
        EntryIterator(Object2IntAVLTreeMap object2IntAVLTreeMap) {
            this.this$0 = object2IntAVLTreeMap;
            super(object2IntAVLTreeMap);
        }

        EntryIterator(Object2IntAVLTreeMap object2IntAVLTreeMap, K k) {
            this.this$0 = object2IntAVLTreeMap;
            super(object2IntAVLTreeMap, k);
        }
        ...
        public void add(Object object) {
            this.add((Object2IntMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Object2IntMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2IntAVLTreeMap object2IntAVLTreeMap) {
            this.this$0 = object2IntAVLTreeMap;
            this.index = 0;
            this.next = object2IntAVLTreeMap.firstEntry;
        }

        TreeIterator(Object2IntAVLTreeMap object2IntAVLTreeMap, K k) {
            this.this$0 = object2IntAVLTreeMap;
            this.index = 0;
            this.next = object2IntAVLTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2IntAVLTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
        ...
        public void remove() {
            ...
            this.updatePrevious();
            this.updateNext();
            this.this$0.removeInt(this.curr.key);
            this.curr = null;
        }
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Objects.equals(this.key, entry.getKey()) && this.value == (Integer)entry.getValue();
        }
