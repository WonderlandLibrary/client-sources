...
public final class Reference2ReferenceFunctions {
    ...
    public static <K, V> Reference2ReferenceFunction<K, V> synchronize(Reference2ReferenceFunction<K, V> reference2ReferenceFunction) {
        return new SynchronizedFunction<K, V>(reference2ReferenceFunction);
    }

    public static <K, V> Reference2ReferenceFunction<K, V> synchronize(Reference2ReferenceFunction<K, V> reference2ReferenceFunction, Object object) {
        return new SynchronizedFunction<K, V>(reference2ReferenceFunction, object);
    }
    ...
    public static <K, V> Reference2ReferenceFunction<K, V> unmodifiable(Reference2ReferenceFunction<K, V> reference2ReferenceFunction) {
        return new UnmodifiableFunction<K, V>(reference2ReferenceFunction);
    }
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Reference2ReferenceFunction<K, V> reference2ReferenceFunction) {
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Reference2ReferenceFunction<K, V> reference2ReferenceFunction, Object object) {
            if (reference2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = reference2ReferenceFunction;
        ...
        protected SynchronizedFunction(Reference2ReferenceFunction<K, V> reference2ReferenceFunction) {
            if (reference2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = reference2ReferenceFunction;
