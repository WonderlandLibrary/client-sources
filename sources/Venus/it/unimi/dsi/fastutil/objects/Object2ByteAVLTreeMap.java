...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Object2ByteAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Object2ByteAVLTreeMap(Comparator<? super K> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Object2ByteAVLTreeMap(Map<? extends K, ? extends Byte> map) {
        this();
        this.putAll((Map<? extends K, Byte>)map);
    }

    public Object2ByteAVLTreeMap(SortedMap<K, Byte> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<K, Byte>)sortedMap);
    }

    public Object2ByteAVLTreeMap(Object2ByteMap<? extends K> object2ByteMap) {
        this();
        this.putAll(object2ByteMap);
    }

    public Object2ByteAVLTreeMap(Object2ByteSortedMap<K> object2ByteSortedMap) {
        this(object2ByteSortedMap.comparator());
        this.putAll(object2ByteSortedMap);
    }

    public Object2ByteAVLTreeMap(K[] KArray, byte[] byArray, Comparator<? super K> comparator) {
        this(comparator);
    ...
    public Object2ByteAVLTreeMap(K[] KArray, byte[] byArray) {
        this(KArray, byArray, null);
    }
    ...
    public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>(this){
                final Comparator<? super Object2ByteMap.Entry<K>> comparator;
                final Object2ByteAVLTreeMap this$0;
                {
                    this.this$0 = object2ByteAVLTreeMap;
                ...
                public boolean remove(Object object) {
                    ...
                    this.this$0.removeByte(entry2.key);
                    return false;
                }
                ...
                public ObjectSortedSet<Object2ByteMap.Entry<K>> subSet(Object2ByteMap.Entry<K> entry, Object2ByteMap.Entry<K> entry2) {
                    return this.this$0.subMap(entry.getKey(), entry2.getKey()).object2ByteEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2ByteMap.Entry<K>> headSet(Object2ByteMap.Entry<K> entry) {
                    return this.this$0.headMap(entry.getKey()).object2ByteEntrySet();
                }

                @Override
                public ObjectSortedSet<Object2ByteMap.Entry<K>> tailSet(Object2ByteMap.Entry<K> entry) {
                    return this.this$0.tailMap(entry.getKey()).object2ByteEntrySet();
                }
                ...
                private int lambda$$0(Object2ByteMap.Entry entry, Object2ByteMap.Entry entry2) {
    ...
    public Object2ByteAVLTreeMap<K> clone() {
        Object2ByteAVLTreeMap object2ByteAVLTreeMap;
        try {
            object2ByteAVLTreeMap = (Object2ByteAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        object2ByteAVLTreeMap.keys = null;
        object2ByteAVLTreeMap.values = null;
        object2ByteAVLTreeMap.entries = null;
        object2ByteAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            object2ByteAVLTreeMap.tree = entry2.left;
                            object2ByteAVLTreeMap.firstEntry = object2ByteAVLTreeMap.tree;
                            while (object2ByteAVLTreeMap.firstEntry.left != null) {
                                object2ByteAVLTreeMap.firstEntry = object2ByteAVLTreeMap.firstEntry.left;
                            }
                            object2ByteAVLTreeMap.lastEntry = object2ByteAVLTreeMap.tree;
                            while (object2ByteAVLTreeMap.lastEntry.right != null) {
                                object2ByteAVLTreeMap.lastEntry = object2ByteAVLTreeMap.lastEntry.right;
                            }
                            return object2ByteAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry<K> readTree(ObjectInputStream objectInputStream, int n, Entry<K> entry, Entry<K> entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry<Object> entry3 = new Entry<Object>(objectInputStream.readObject(), objectInputStream.readByte());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry<Object> entry4 = new Entry<Object>(objectInputStream.readObject(), objectInputStream.readByte());
            entry4.right(new Entry<Object>(objectInputStream.readObject(), objectInputStream.readByte()));
    ...
    implements Serializable {
        ...
        public Submap(Object2ByteAVLTreeMap object2ByteAVLTreeMap, K k, boolean bl, K k2, boolean bl2) {
            this.this$0 = object2ByteAVLTreeMap;
            if (!bl && !bl2 && object2ByteAVLTreeMap.compare(k, k2) > 0) {
            ...
            this.to = k2;
            this.top = bl2;
            this.defRetValue = object2ByteAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>(this){
                    ...
                    @Override
                    public Comparator<? super Object2ByteMap.Entry<K>> comparator() {
                        return this.this$1.this$0.object2ByteEntrySet().comparator();
                    }
                    ...
                    public boolean remove(Object object) {
                        ...
                        if (entry2 != null && this.this$1.in(entry2.key)) {
                            this.this$1.removeByte(entry2.key);
                        }
                        return entry2 != null;
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Object2ByteMap.Entry<K>> subSet(Object2ByteMap.Entry<K> entry, Object2ByteMap.Entry<K> entry2) {
                        return this.this$1.subMap(entry.getKey(), entry2.getKey()).object2ByteEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2ByteMap.Entry<K>> headSet(Object2ByteMap.Entry<K> entry) {
                        return this.this$1.headMap(entry.getKey()).object2ByteEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Object2ByteMap.Entry<K>> tailSet(Object2ByteMap.Entry<K> entry) {
                        return this.this$1.tailMap(entry.getKey()).object2ByteEntrySet();
                    }
        ...
        public byte removeByte(Object object) {
            ...
            byte by = this.this$0.removeByte(object);
    ...
    implements ByteListIterator {
        ...
        private ValueIterator(Object2ByteAVLTreeMap object2ByteAVLTreeMap) {
            this.this$0 = object2ByteAVLTreeMap;
            super(object2ByteAVLTreeMap);
        }
        ...
        ValueIterator(Object2ByteAVLTreeMap object2ByteAVLTreeMap, 1 var2_2) {
            this(object2ByteAVLTreeMap);
        }
    }
    ...
    extends AbstractObject2ByteSortedMap.KeySet {
        ...
        private KeySet(Object2ByteAVLTreeMap object2ByteAVLTreeMap) {
            this.this$0 = object2ByteAVLTreeMap;
            super(object2ByteAVLTreeMap);
        }
        ...
        KeySet(Object2ByteAVLTreeMap object2ByteAVLTreeMap, 1 var2_2) {
            this(object2ByteAVLTreeMap);
        }
    }
    ...
    implements ObjectListIterator<K> {
        ...
        public KeyIterator(Object2ByteAVLTreeMap object2ByteAVLTreeMap) {
            this.this$0 = object2ByteAVLTreeMap;
            super(object2ByteAVLTreeMap);
        }

        public KeyIterator(Object2ByteAVLTreeMap object2ByteAVLTreeMap, K k) {
            this.this$0 = object2ByteAVLTreeMap;
            super(object2ByteAVLTreeMap, k);
        }
    ...
    implements ObjectListIterator<Object2ByteMap.Entry<K>> {
        ...
        EntryIterator(Object2ByteAVLTreeMap object2ByteAVLTreeMap) {
            this.this$0 = object2ByteAVLTreeMap;
            super(object2ByteAVLTreeMap);
        }

        EntryIterator(Object2ByteAVLTreeMap object2ByteAVLTreeMap, K k) {
            this.this$0 = object2ByteAVLTreeMap;
            super(object2ByteAVLTreeMap, k);
        }
        ...
        public void add(Object object) {
            this.add((Object2ByteMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Object2ByteMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Object2ByteAVLTreeMap object2ByteAVLTreeMap) {
            this.this$0 = object2ByteAVLTreeMap;
            this.index = 0;
            this.next = object2ByteAVLTreeMap.firstEntry;
        }

        TreeIterator(Object2ByteAVLTreeMap object2ByteAVLTreeMap, K k) {
            this.this$0 = object2ByteAVLTreeMap;
            this.index = 0;
            this.next = object2ByteAVLTreeMap.locateKey(k);
            if (this.next != null) {
                if (object2ByteAVLTreeMap.compare(this.next.key, k) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
        ...
        public void remove() {
            ...
            this.updatePrevious();
            this.updateNext();
            this.this$0.removeByte(this.curr.key);
            this.curr = null;
        }
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Objects.equals(this.key, entry.getKey()) && this.value == (Byte)entry.getValue();
        }
