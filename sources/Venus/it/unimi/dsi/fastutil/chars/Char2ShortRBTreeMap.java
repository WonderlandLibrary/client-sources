...
Cloneable {
    ...
    public Char2ShortRBTreeMap(Comparator<? super Character> comparator) {
        this();
    ...
    public Char2ShortRBTreeMap(SortedMap<Character, Short> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Character, ? extends Short>)sortedMap);
    }

    public Char2ShortRBTreeMap(Char2ShortMap char2ShortMap) {
        this();
        this.putAll(char2ShortMap);
    }

    public Char2ShortRBTreeMap(Char2ShortSortedMap char2ShortSortedMap) {
        this(char2ShortSortedMap.comparator());
        this.putAll(char2ShortSortedMap);
    }

    public Char2ShortRBTreeMap(char[] cArray, short[] sArray, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2ShortRBTreeMap(char[] cArray, short[] sArray) {
    ...
    public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>(this){
                ...
                final Char2ShortRBTreeMap this$0;
                {
                    this.this$0 = char2ShortRBTreeMap;
    ...
    public Char2ShortRBTreeMap clone() {
        Char2ShortRBTreeMap char2ShortRBTreeMap;
        try {
            char2ShortRBTreeMap = (Char2ShortRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2ShortRBTreeMap.keys = null;
        char2ShortRBTreeMap.values = null;
        char2ShortRBTreeMap.entries = null;
        char2ShortRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2ShortRBTreeMap.firstEntry = char2ShortRBTreeMap.tree = entry2.left;
                            while (char2ShortRBTreeMap.firstEntry.left != null) {
                                char2ShortRBTreeMap.firstEntry = char2ShortRBTreeMap.firstEntry.left;
                            }
                            char2ShortRBTreeMap.lastEntry = char2ShortRBTreeMap.tree;
                            while (char2ShortRBTreeMap.lastEntry.right != null) {
                                char2ShortRBTreeMap.lastEntry = char2ShortRBTreeMap.lastEntry.right;
                            }
                            return char2ShortRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Char2ShortRBTreeMap char2ShortRBTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2ShortRBTreeMap;
            if (!bl && !bl2 && char2ShortRBTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2ShortRBTreeMap.defRetValue;
        }
    ...
    implements ShortListIterator {
        ...
        private ValueIterator(Char2ShortRBTreeMap char2ShortRBTreeMap) {
            this.this$0 = char2ShortRBTreeMap;
            super(char2ShortRBTreeMap);
        }
        ...
        ValueIterator(Char2ShortRBTreeMap char2ShortRBTreeMap, 1 var2_2) {
            this(char2ShortRBTreeMap);
        }
    }
    ...
    extends AbstractChar2ShortSortedMap.KeySet {
        ...
        private KeySet(Char2ShortRBTreeMap char2ShortRBTreeMap) {
            this.this$0 = char2ShortRBTreeMap;
            super(char2ShortRBTreeMap);
        }
        ...
        KeySet(Char2ShortRBTreeMap char2ShortRBTreeMap, 1 var2_2) {
            this(char2ShortRBTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2ShortRBTreeMap char2ShortRBTreeMap) {
            this.this$0 = char2ShortRBTreeMap;
            super(char2ShortRBTreeMap);
        }

        public KeyIterator(Char2ShortRBTreeMap char2ShortRBTreeMap, char c) {
            this.this$0 = char2ShortRBTreeMap;
            super(char2ShortRBTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2ShortMap.Entry> {
        ...
        EntryIterator(Char2ShortRBTreeMap char2ShortRBTreeMap) {
            this.this$0 = char2ShortRBTreeMap;
            super(char2ShortRBTreeMap);
        }

        EntryIterator(Char2ShortRBTreeMap char2ShortRBTreeMap, char c) {
            this.this$0 = char2ShortRBTreeMap;
            super(char2ShortRBTreeMap, c);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2ShortRBTreeMap char2ShortRBTreeMap) {
            this.this$0 = char2ShortRBTreeMap;
            this.index = 0;
            this.next = char2ShortRBTreeMap.firstEntry;
        }

        TreeIterator(Char2ShortRBTreeMap char2ShortRBTreeMap, char c) {
            this.this$0 = char2ShortRBTreeMap;
            this.index = 0;
            this.next = char2ShortRBTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2ShortRBTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
