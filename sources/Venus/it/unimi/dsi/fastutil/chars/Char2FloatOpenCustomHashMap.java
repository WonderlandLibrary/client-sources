...
Hash {
    ...
    public Char2FloatOpenCustomHashMap(int n, float f, CharHash.Strategy strategy) {
    ...
    public Char2FloatOpenCustomHashMap(int n, CharHash.Strategy strategy) {
    ...
    public Char2FloatOpenCustomHashMap(Map<? extends Character, ? extends Float> map, float f, CharHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Char2FloatOpenCustomHashMap(Map<? extends Character, ? extends Float> map, CharHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Char2FloatOpenCustomHashMap(Char2FloatMap char2FloatMap, float f, CharHash.Strategy strategy) {
        this(char2FloatMap.size(), f, strategy);
        this.putAll(char2FloatMap);
    }

    public Char2FloatOpenCustomHashMap(Char2FloatMap char2FloatMap, CharHash.Strategy strategy) {
        this(char2FloatMap, 0.75f, strategy);
    }

    public Char2FloatOpenCustomHashMap(char[] cArray, float[] fArray, float f, CharHash.Strategy strategy) {
    ...
    public Char2FloatOpenCustomHashMap(char[] cArray, float[] fArray, CharHash.Strategy strategy) {
        this(cArray, fArray, 0.75f, strategy);
    }
    ...
    public boolean remove(char c, float f) {
        ...
        if (this.strategy.equals(c, c2) && Float.floatToIntBits(f) == Float.floatToIntBits(this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((c2 = cArray[n = n + 1 & this.mask]) != '\u0000') continue;
            return true;
        } while (!this.strategy.equals(c, c2) || Float.floatToIntBits(f) != Float.floatToIntBits(this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public FloatCollection values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection(this){
                final Char2FloatOpenCustomHashMap this$0;
                {
                    this.this$0 = char2FloatOpenCustomHashMap;
                }
    ...
    public Char2FloatOpenCustomHashMap clone() {
        Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap;
        try {
            char2FloatOpenCustomHashMap = (Char2FloatOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2FloatOpenCustomHashMap.keys = null;
        char2FloatOpenCustomHashMap.values = null;
        char2FloatOpenCustomHashMap.entries = null;
        char2FloatOpenCustomHashMap.containsNullKey = this.containsNullKey;
        char2FloatOpenCustomHashMap.key = (char[])this.key.clone();
        char2FloatOpenCustomHashMap.value = (float[])this.value.clone();
        char2FloatOpenCustomHashMap.strategy = this.strategy;
        return char2FloatOpenCustomHashMap;
    }
    ...
    static float access$300(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap) {
        return char2FloatOpenCustomHashMap.removeNullEntry();
    }

    static float access$400(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap, int n) {
        return char2FloatOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements FloatIterator {
        ...
        public ValueIterator(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap) {
            this.this$0 = char2FloatOpenCustomHashMap;
            super(char2FloatOpenCustomHashMap, null);
        }
    ...
    extends AbstractCharSet {
        ...
        private KeySet(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap) {
            this.this$0 = char2FloatOpenCustomHashMap;
        }
        ...
        KeySet(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap, 1 var2_2) {
            this(char2FloatOpenCustomHashMap);
        }
    }
    ...
    implements CharIterator {
        ...
        public KeyIterator(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap) {
            this.this$0 = char2FloatOpenCustomHashMap;
            super(char2FloatOpenCustomHashMap, null);
        }
    ...
    implements Char2FloatMap.FastEntrySet {
        ...
        private MapEntrySet(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap) {
            this.this$0 = char2FloatOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(c, '\u0000')) {
                if (this.this$0.containsNullKey && Float.floatToIntBits(this.this$0.value[this.this$0.n]) == Float.floatToIntBits(f)) {
                    Char2FloatOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(c2, c)) {
                if (Float.floatToIntBits(this.this$0.value[n]) == Float.floatToIntBits(f)) {
                    Char2FloatOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((c2 = cArray[n = n + 1 & this.this$0.mask]) != '\u0000') continue;
                return true;
            } while (!this.this$0.strategy.equals(c2, c) || Float.floatToIntBits(this.this$0.value[n]) != Float.floatToIntBits(f));
            Char2FloatOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap, 1 var2_2) {
            this(char2FloatOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2FloatMap.Entry> {
        ...
        private FastEntryIterator(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap) {
            this.this$0 = char2FloatOpenCustomHashMap;
            super(char2FloatOpenCustomHashMap, null);
        ...
        FastEntryIterator(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap, 1 var2_2) {
            this(char2FloatOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2FloatMap.Entry> {
        ...
        private EntryIterator(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap) {
            this.this$0 = char2FloatOpenCustomHashMap;
            super(char2FloatOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap, 1 var2_2) {
            this(char2FloatOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap) {
            this.this$0 = char2FloatOpenCustomHashMap;
        ...
        MapIterator(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap, 1 var2_2) {
            this(char2FloatOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Character, Float> {
        ...
        MapEntry(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap, int n) {
            this.this$0 = char2FloatOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Char2FloatOpenCustomHashMap char2FloatOpenCustomHashMap) {
            this.this$0 = char2FloatOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], ((Character)entry.getKey()).charValue()) && Float.floatToIntBits(this.this$0.value[this.index]) == Float.floatToIntBits(((Float)entry.getValue()).floatValue());
        }
