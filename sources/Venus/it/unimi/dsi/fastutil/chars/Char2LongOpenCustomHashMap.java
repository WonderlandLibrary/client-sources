...
Hash {
    ...
    public Char2LongOpenCustomHashMap(int n, float f, CharHash.Strategy strategy) {
    ...
    public Char2LongOpenCustomHashMap(int n, CharHash.Strategy strategy) {
    ...
    public Char2LongOpenCustomHashMap(char[] cArray, long[] lArray, float f, CharHash.Strategy strategy) {
    ...
    public Char2LongOpenCustomHashMap(char[] cArray, long[] lArray, CharHash.Strategy strategy) {
        this(cArray, lArray, 0.75f, strategy);
    }
    ...
    public boolean remove(char c, long l) {
        ...
        if (this.strategy.equals(c, c2) && l == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((c2 = cArray[n = n + 1 & this.mask]) != '\u0000') continue;
            return true;
        } while (!this.strategy.equals(c, c2) || l != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection(this){
                final Char2LongOpenCustomHashMap this$0;
                {
                    this.this$0 = char2LongOpenCustomHashMap;
                }
    ...
    public Char2LongOpenCustomHashMap clone() {
        Char2LongOpenCustomHashMap char2LongOpenCustomHashMap;
        try {
            char2LongOpenCustomHashMap = (Char2LongOpenCustomHashMap)super.clone();
    ...
    static long access$300(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap) {
        return char2LongOpenCustomHashMap.removeNullEntry();
    }

    static long access$400(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap, int n) {
        return char2LongOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements LongIterator {
        ...
        public ValueIterator(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap) {
            this.this$0 = char2LongOpenCustomHashMap;
            super(char2LongOpenCustomHashMap, null);
        }
    ...
    extends AbstractCharSet {
        ...
        private KeySet(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap) {
            this.this$0 = char2LongOpenCustomHashMap;
        }
        ...
        KeySet(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap, 1 var2_2) {
            this(char2LongOpenCustomHashMap);
        }
    }
    ...
    implements CharIterator {
        ...
        public KeyIterator(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap) {
            this.this$0 = char2LongOpenCustomHashMap;
            super(char2LongOpenCustomHashMap, null);
        }
    ...
    implements Char2LongMap.FastEntrySet {
        ...
        private MapEntrySet(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap) {
            this.this$0 = char2LongOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(c, '\u0000')) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == l) {
                    Char2LongOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(c2, c)) {
                if (this.this$0.value[n] == l) {
                    Char2LongOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((c2 = cArray[n = n + 1 & this.this$0.mask]) != '\u0000') continue;
                return true;
            } while (!this.this$0.strategy.equals(c2, c) || this.this$0.value[n] != l);
            Char2LongOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        public void forEach(Consumer<? super Char2LongMap.Entry> consumer) {
            if (this.this$0.containsNullKey) {
                consumer.accept(new AbstractChar2LongMap.BasicEntry(this.this$0.key[this.this$0.n], this.this$0.value[this.this$0.n]));
            }
            int n = this.this$0.n;
            while (n-- != 0) {
                if (this.this$0.key[n] == '\u0000') continue;
                consumer.accept(new AbstractChar2LongMap.BasicEntry(this.this$0.key[n], this.this$0.value[n]));
            }
        }
        ...
        MapEntrySet(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap, 1 var2_2) {
            this(char2LongOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2LongMap.Entry> {
        ...
        private FastEntryIterator(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap) {
            this.this$0 = char2LongOpenCustomHashMap;
            super(char2LongOpenCustomHashMap, null);
        ...
        FastEntryIterator(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap, 1 var2_2) {
            this(char2LongOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2LongMap.Entry> {
        ...
        private EntryIterator(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap) {
            this.this$0 = char2LongOpenCustomHashMap;
            super(char2LongOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap, 1 var2_2) {
            this(char2LongOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap) {
            this.this$0 = char2LongOpenCustomHashMap;
        ...
        MapIterator(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap, 1 var2_2) {
            this(char2LongOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Character, Long> {
        ...
        MapEntry(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap, int n) {
            this.this$0 = char2LongOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Char2LongOpenCustomHashMap char2LongOpenCustomHashMap) {
            this.this$0 = char2LongOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], ((Character)entry.getKey()).charValue()) && this.this$0.value[this.index] == (Long)entry.getValue();
        }
