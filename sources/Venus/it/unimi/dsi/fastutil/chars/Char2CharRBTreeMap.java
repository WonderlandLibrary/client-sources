...
Cloneable {
    ...
    public Char2CharRBTreeMap(Comparator<? super Character> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Char2CharRBTreeMap(Map<? extends Character, ? extends Character> map) {
        this();
        this.putAll(map);
    }

    public Char2CharRBTreeMap(SortedMap<Character, Character> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Character, ? extends Character>)sortedMap);
    }

    public Char2CharRBTreeMap(Char2CharMap char2CharMap) {
        this();
        this.putAll(char2CharMap);
    }

    public Char2CharRBTreeMap(Char2CharSortedMap char2CharSortedMap) {
        this(char2CharSortedMap.comparator());
        this.putAll(char2CharSortedMap);
    }

    public Char2CharRBTreeMap(char[] cArray, char[] cArray2, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2CharRBTreeMap(char[] cArray, char[] cArray2) {
    ...
    public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2CharMap.Entry>(this){
                ...
                final Char2CharRBTreeMap this$0;
                {
                    this.this$0 = char2CharRBTreeMap;
    ...
    public Char2CharRBTreeMap clone() {
        Char2CharRBTreeMap char2CharRBTreeMap;
        try {
            char2CharRBTreeMap = (Char2CharRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2CharRBTreeMap.keys = null;
        char2CharRBTreeMap.values = null;
        char2CharRBTreeMap.entries = null;
        char2CharRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2CharRBTreeMap.firstEntry = char2CharRBTreeMap.tree = entry2.left;
                            while (char2CharRBTreeMap.firstEntry.left != null) {
                                char2CharRBTreeMap.firstEntry = char2CharRBTreeMap.firstEntry.left;
                            }
                            char2CharRBTreeMap.lastEntry = char2CharRBTreeMap.tree;
                            while (char2CharRBTreeMap.lastEntry.right != null) {
                                char2CharRBTreeMap.lastEntry = char2CharRBTreeMap.lastEntry.right;
                            }
                            return char2CharRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Char2CharRBTreeMap char2CharRBTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2CharRBTreeMap;
            if (!bl && !bl2 && char2CharRBTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2CharRBTreeMap.defRetValue;
        }
    ...
    implements CharListIterator {
        ...
        private ValueIterator(Char2CharRBTreeMap char2CharRBTreeMap) {
            this.this$0 = char2CharRBTreeMap;
            super(char2CharRBTreeMap);
        }
        ...
        ValueIterator(Char2CharRBTreeMap char2CharRBTreeMap, 1 var2_2) {
            this(char2CharRBTreeMap);
        }
    }
    ...
    extends AbstractChar2CharSortedMap.KeySet {
        ...
        private KeySet(Char2CharRBTreeMap char2CharRBTreeMap) {
            this.this$0 = char2CharRBTreeMap;
            super(char2CharRBTreeMap);
        }
        ...
        KeySet(Char2CharRBTreeMap char2CharRBTreeMap, 1 var2_2) {
            this(char2CharRBTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2CharRBTreeMap char2CharRBTreeMap) {
            this.this$0 = char2CharRBTreeMap;
            super(char2CharRBTreeMap);
        }

        public KeyIterator(Char2CharRBTreeMap char2CharRBTreeMap, char c) {
            this.this$0 = char2CharRBTreeMap;
            super(char2CharRBTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2CharMap.Entry> {
        ...
        EntryIterator(Char2CharRBTreeMap char2CharRBTreeMap) {
            this.this$0 = char2CharRBTreeMap;
            super(char2CharRBTreeMap);
        }

        EntryIterator(Char2CharRBTreeMap char2CharRBTreeMap, char c) {
            this.this$0 = char2CharRBTreeMap;
            super(char2CharRBTreeMap, c);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2CharRBTreeMap char2CharRBTreeMap) {
            this.this$0 = char2CharRBTreeMap;
            this.index = 0;
            this.next = char2CharRBTreeMap.firstEntry;
        }

        TreeIterator(Char2CharRBTreeMap char2CharRBTreeMap, char c) {
            this.this$0 = char2CharRBTreeMap;
            this.index = 0;
            this.next = char2CharRBTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2CharRBTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
