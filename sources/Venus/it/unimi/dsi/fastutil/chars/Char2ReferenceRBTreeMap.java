...
Cloneable {
    ...
    public Char2ReferenceRBTreeMap(Comparator<? super Character> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Char2ReferenceRBTreeMap(Map<? extends Character, ? extends V> map) {
        this();
        this.putAll((Map<Character, ? extends V>)map);
    }

    public Char2ReferenceRBTreeMap(SortedMap<Character, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Character, V>)sortedMap);
    }

    public Char2ReferenceRBTreeMap(Char2ReferenceMap<? extends V> char2ReferenceMap) {
        this();
        this.putAll(char2ReferenceMap);
    }

    public Char2ReferenceRBTreeMap(Char2ReferenceSortedMap<V> char2ReferenceSortedMap) {
        this(char2ReferenceSortedMap.comparator());
        this.putAll(char2ReferenceSortedMap);
    }

    public Char2ReferenceRBTreeMap(char[] cArray, V[] VArray, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2ReferenceRBTreeMap(char[] cArray, V[] VArray) {
    ...
    public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ReferenceMap.Entry<V>>(this){
                ...
                final Char2ReferenceRBTreeMap this$0;
                {
                    this.this$0 = char2ReferenceRBTreeMap;
    ...
    public Char2ReferenceRBTreeMap<V> clone() {
        Char2ReferenceRBTreeMap char2ReferenceRBTreeMap;
        try {
            char2ReferenceRBTreeMap = (Char2ReferenceRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2ReferenceRBTreeMap.keys = null;
        char2ReferenceRBTreeMap.values = null;
        char2ReferenceRBTreeMap.entries = null;
        char2ReferenceRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2ReferenceRBTreeMap.tree = entry2.left;
                            char2ReferenceRBTreeMap.firstEntry = char2ReferenceRBTreeMap.tree;
                            while (char2ReferenceRBTreeMap.firstEntry.left != null) {
                                char2ReferenceRBTreeMap.firstEntry = char2ReferenceRBTreeMap.firstEntry.left;
                            }
                            char2ReferenceRBTreeMap.lastEntry = char2ReferenceRBTreeMap.tree;
                            while (char2ReferenceRBTreeMap.lastEntry.right != null) {
                                char2ReferenceRBTreeMap.lastEntry = char2ReferenceRBTreeMap.lastEntry.right;
                            }
                            return char2ReferenceRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Char2ReferenceRBTreeMap char2ReferenceRBTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2ReferenceRBTreeMap;
            if (!bl && !bl2 && char2ReferenceRBTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2ReferenceRBTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Char2ReferenceRBTreeMap char2ReferenceRBTreeMap) {
            this.this$0 = char2ReferenceRBTreeMap;
            super(char2ReferenceRBTreeMap);
        }
        ...
        ValueIterator(Char2ReferenceRBTreeMap char2ReferenceRBTreeMap, 1 var2_2) {
            this(char2ReferenceRBTreeMap);
        }
    }
    ...
    extends AbstractChar2ReferenceSortedMap.KeySet {
        ...
        private KeySet(Char2ReferenceRBTreeMap char2ReferenceRBTreeMap) {
            this.this$0 = char2ReferenceRBTreeMap;
            super(char2ReferenceRBTreeMap);
        }
        ...
        KeySet(Char2ReferenceRBTreeMap char2ReferenceRBTreeMap, 1 var2_2) {
            this(char2ReferenceRBTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2ReferenceRBTreeMap char2ReferenceRBTreeMap) {
            this.this$0 = char2ReferenceRBTreeMap;
            super(char2ReferenceRBTreeMap);
        }

        public KeyIterator(Char2ReferenceRBTreeMap char2ReferenceRBTreeMap, char c) {
            this.this$0 = char2ReferenceRBTreeMap;
            super(char2ReferenceRBTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2ReferenceMap.Entry<V>> {
        ...
        EntryIterator(Char2ReferenceRBTreeMap char2ReferenceRBTreeMap) {
            this.this$0 = char2ReferenceRBTreeMap;
            super(char2ReferenceRBTreeMap);
        }

        EntryIterator(Char2ReferenceRBTreeMap char2ReferenceRBTreeMap, char c) {
            this.this$0 = char2ReferenceRBTreeMap;
            super(char2ReferenceRBTreeMap, c);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2ReferenceRBTreeMap char2ReferenceRBTreeMap) {
            this.this$0 = char2ReferenceRBTreeMap;
            this.index = 0;
            this.next = char2ReferenceRBTreeMap.firstEntry;
        }

        TreeIterator(Char2ReferenceRBTreeMap char2ReferenceRBTreeMap, char c) {
            this.this$0 = char2ReferenceRBTreeMap;
            this.index = 0;
            this.next = char2ReferenceRBTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2ReferenceRBTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
