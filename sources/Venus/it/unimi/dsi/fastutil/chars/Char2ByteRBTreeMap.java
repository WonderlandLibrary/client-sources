...
Cloneable {
    ...
    public Char2ByteRBTreeMap(Comparator<? super Character> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Char2ByteRBTreeMap(Map<? extends Character, ? extends Byte> map) {
        this();
        this.putAll(map);
    }

    public Char2ByteRBTreeMap(SortedMap<Character, Byte> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Character, ? extends Byte>)sortedMap);
    }

    public Char2ByteRBTreeMap(Char2ByteMap char2ByteMap) {
        this();
        this.putAll(char2ByteMap);
    }

    public Char2ByteRBTreeMap(Char2ByteSortedMap char2ByteSortedMap) {
        this(char2ByteSortedMap.comparator());
        this.putAll(char2ByteSortedMap);
    }

    public Char2ByteRBTreeMap(char[] cArray, byte[] byArray, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2ByteRBTreeMap(char[] cArray, byte[] byArray) {
    ...
    public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ByteMap.Entry>(this){
                ...
                final Char2ByteRBTreeMap this$0;
                {
                    this.this$0 = char2ByteRBTreeMap;
    ...
    public Char2ByteRBTreeMap clone() {
        Char2ByteRBTreeMap char2ByteRBTreeMap;
        try {
            char2ByteRBTreeMap = (Char2ByteRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2ByteRBTreeMap.keys = null;
        char2ByteRBTreeMap.values = null;
        char2ByteRBTreeMap.entries = null;
        char2ByteRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2ByteRBTreeMap.firstEntry = char2ByteRBTreeMap.tree = entry2.left;
                            while (char2ByteRBTreeMap.firstEntry.left != null) {
                                char2ByteRBTreeMap.firstEntry = char2ByteRBTreeMap.firstEntry.left;
                            }
                            char2ByteRBTreeMap.lastEntry = char2ByteRBTreeMap.tree;
                            while (char2ByteRBTreeMap.lastEntry.right != null) {
                                char2ByteRBTreeMap.lastEntry = char2ByteRBTreeMap.lastEntry.right;
                            }
                            return char2ByteRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Char2ByteRBTreeMap char2ByteRBTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2ByteRBTreeMap;
            if (!bl && !bl2 && char2ByteRBTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2ByteRBTreeMap.defRetValue;
        }
    ...
    implements ByteListIterator {
        ...
        private ValueIterator(Char2ByteRBTreeMap char2ByteRBTreeMap) {
            this.this$0 = char2ByteRBTreeMap;
            super(char2ByteRBTreeMap);
        }
        ...
        ValueIterator(Char2ByteRBTreeMap char2ByteRBTreeMap, 1 var2_2) {
            this(char2ByteRBTreeMap);
        }
    }
    ...
    extends AbstractChar2ByteSortedMap.KeySet {
        ...
        private KeySet(Char2ByteRBTreeMap char2ByteRBTreeMap) {
            this.this$0 = char2ByteRBTreeMap;
            super(char2ByteRBTreeMap);
        }
        ...
        KeySet(Char2ByteRBTreeMap char2ByteRBTreeMap, 1 var2_2) {
            this(char2ByteRBTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2ByteRBTreeMap char2ByteRBTreeMap) {
            this.this$0 = char2ByteRBTreeMap;
            super(char2ByteRBTreeMap);
        }

        public KeyIterator(Char2ByteRBTreeMap char2ByteRBTreeMap, char c) {
            this.this$0 = char2ByteRBTreeMap;
            super(char2ByteRBTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2ByteMap.Entry> {
        ...
        EntryIterator(Char2ByteRBTreeMap char2ByteRBTreeMap) {
            this.this$0 = char2ByteRBTreeMap;
            super(char2ByteRBTreeMap);
        }

        EntryIterator(Char2ByteRBTreeMap char2ByteRBTreeMap, char c) {
            this.this$0 = char2ByteRBTreeMap;
            super(char2ByteRBTreeMap, c);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2ByteRBTreeMap char2ByteRBTreeMap) {
            this.this$0 = char2ByteRBTreeMap;
            this.index = 0;
            this.next = char2ByteRBTreeMap.firstEntry;
        }

        TreeIterator(Char2ByteRBTreeMap char2ByteRBTreeMap, char c) {
            this.this$0 = char2ByteRBTreeMap;
            this.index = 0;
            this.next = char2ByteRBTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2ByteRBTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
