...
Map<Character, V> {
    ...
    default public V put(Character c, V v) {
        return Char2ReferenceFunction.super.put(c, v);
    }

    @Override
    @Deprecated
    default public V get(Object object) {
        return Char2ReferenceFunction.super.get(object);
    }

    @Override
    @Deprecated
    default public V remove(Object object) {
        return Char2ReferenceFunction.super.remove(object);
    }
    ...
    default public boolean containsKey(Object object) {
        return Char2ReferenceFunction.super.containsKey(object);
    }
    ...
    default public boolean remove(char c, Object object) {
        Object v = this.get(c);
        if (v != object || v == this.defaultReturnValue() && !this.containsKey(c)) {
            return true;
        }
        this.remove(c);
        return false;
    ...
    default public boolean replace(char c, V v, V v2) {
        Object v3 = this.get(c);
        if (v3 != v || v3 == this.defaultReturnValue() && !this.containsKey(c)) {
            return true;
        }
        this.put(c, v2);
        return false;
    ...
    default public V computeIfAbsentPartial(char c, Char2ReferenceFunction<? extends V> char2ReferenceFunction) {
        ...
        V v3 = char2ReferenceFunction.get(c);
        this.put(c, v3);
        return v3;
    }
