...
Hash {
    ...
    public CharLinkedOpenCustomHashSet(int n, float f, CharHash.Strategy strategy) {
    ...
    public CharLinkedOpenCustomHashSet(int n, CharHash.Strategy strategy) {
    ...
    public CharLinkedOpenCustomHashSet(Collection<? extends Character> collection, float f, CharHash.Strategy strategy) {
        this(collection.size(), f, strategy);
        this.addAll(collection);
    }

    public CharLinkedOpenCustomHashSet(Collection<? extends Character> collection, CharHash.Strategy strategy) {
        this(collection, 0.75f, strategy);
    }

    public CharLinkedOpenCustomHashSet(CharCollection charCollection, float f, CharHash.Strategy strategy) {
        this(charCollection.size(), f, strategy);
        this.addAll(charCollection);
    }

    public CharLinkedOpenCustomHashSet(CharCollection charCollection, CharHash.Strategy strategy) {
        this(charCollection, 0.75f, strategy);
    }

    public CharLinkedOpenCustomHashSet(CharIterator charIterator, float f, CharHash.Strategy strategy) {
        this(16, f, strategy);
    ...
    public CharLinkedOpenCustomHashSet(CharIterator charIterator, CharHash.Strategy strategy) {
        this(charIterator, 0.75f, strategy);
    }

    public CharLinkedOpenCustomHashSet(Iterator<?> iterator2, float f, CharHash.Strategy strategy) {
        this(CharIterators.asCharIterator(iterator2), f, strategy);
    }

    public CharLinkedOpenCustomHashSet(Iterator<?> iterator2, CharHash.Strategy strategy) {
        this(CharIterators.asCharIterator(iterator2), strategy);
    }

    public CharLinkedOpenCustomHashSet(char[] cArray, int n, int n2, float f, CharHash.Strategy strategy) {
    ...
    public CharLinkedOpenCustomHashSet(char[] cArray, int n, int n2, CharHash.Strategy strategy) {
        this(cArray, n, n2, 0.75f, strategy);
    }

    public CharLinkedOpenCustomHashSet(char[] cArray, float f, CharHash.Strategy strategy) {
        this(cArray, 0, cArray.length, f, strategy);
    }

    public CharLinkedOpenCustomHashSet(char[] cArray, CharHash.Strategy strategy) {
        this(cArray, 0.75f, strategy);
    }
    ...
    public boolean addAndMoveToFirst(char c) {
        ...
        if (this.strategy.equals(c, '\u0000')) {
            ...
            n = HashCommon.mix(this.strategy.hashCode(c)) & this.mask;
            while (cArray[n] != '\u0000') {
                if (this.strategy.equals(c, cArray[n])) {
    ...
    protected void rehash(int n) {
        ...
        while (n6-- != 0) {
            int n7;
            if (this.strategy.equals(cArray[n3], '\u0000')) {
                n7 = n;
            } else {
                n7 = HashCommon.mix(this.strategy.hashCode(cArray[n3])) & n2;
                while (cArray2[n7] != '\u0000') {
                    n7 = n7 + 1 & n2;
                }
            }
    ...
    public CharLinkedOpenCustomHashSet clone() {
        CharLinkedOpenCustomHashSet charLinkedOpenCustomHashSet;
        try {
            charLinkedOpenCustomHashSet = (CharLinkedOpenCustomHashSet)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        charLinkedOpenCustomHashSet.key = (char[])this.key.clone();
        charLinkedOpenCustomHashSet.containsNull = this.containsNull;
        charLinkedOpenCustomHashSet.link = (long[])this.link.clone();
        charLinkedOpenCustomHashSet.strategy = this.strategy;
        return charLinkedOpenCustomHashSet;
    }
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        while (n2-- != 0) {
            ...
            if (this.strategy.equals(c, '\u0000')) {
                ...
                n3 = HashCommon.mix(this.strategy.hashCode(c)) & this.mask;
                if (cArray[n3] != '\u0000') {
    ...
    implements CharListIterator {
        ...
        int curr;
        int index;
        final CharLinkedOpenCustomHashSet this$0;

        SetIterator(CharLinkedOpenCustomHashSet charLinkedOpenCustomHashSet) {
            this.this$0 = charLinkedOpenCustomHashSet;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = charLinkedOpenCustomHashSet.first;
            this.index = 0;
        }

        SetIterator(CharLinkedOpenCustomHashSet charLinkedOpenCustomHashSet, char c) {
            this.this$0 = charLinkedOpenCustomHashSet;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (charLinkedOpenCustomHashSet.strategy.equals(c, '\u0000')) {
                if (charLinkedOpenCustomHashSet.containsNull) {
                    this.next = (int)charLinkedOpenCustomHashSet.link[charLinkedOpenCustomHashSet.n];
                    this.prev = charLinkedOpenCustomHashSet.n;
                    return;
                }
                throw new NoSuchElementException("The key " + c + " does not belong to this set.");
            }
            if (charLinkedOpenCustomHashSet.strategy.equals(charLinkedOpenCustomHashSet.key[charLinkedOpenCustomHashSet.last], c)) {
                this.prev = charLinkedOpenCustomHashSet.last;
                this.index = charLinkedOpenCustomHashSet.size;
                return;
            }
            char[] cArray = charLinkedOpenCustomHashSet.key;
            int n = HashCommon.mix(charLinkedOpenCustomHashSet.strategy.hashCode(c)) & charLinkedOpenCustomHashSet.mask;
            while (cArray[n] != '\u0000') {
                if (charLinkedOpenCustomHashSet.strategy.equals(cArray[n], c)) {
                    this.next = (int)charLinkedOpenCustomHashSet.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & charLinkedOpenCustomHashSet.mask;
            }
            throw new NoSuchElementException("The key " + c + " does not belong to this set.");
        }
