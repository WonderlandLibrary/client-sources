...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Char2DoubleAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Char2DoubleAVLTreeMap(Comparator<? super Character> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Char2DoubleAVLTreeMap(Map<? extends Character, ? extends Double> map) {
        this();
        this.putAll(map);
    }

    public Char2DoubleAVLTreeMap(SortedMap<Character, Double> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Character, ? extends Double>)sortedMap);
    }

    public Char2DoubleAVLTreeMap(Char2DoubleMap char2DoubleMap) {
        this();
        this.putAll(char2DoubleMap);
    }

    public Char2DoubleAVLTreeMap(Char2DoubleSortedMap char2DoubleSortedMap) {
        this(char2DoubleSortedMap.comparator());
        this.putAll(char2DoubleSortedMap);
    }

    public Char2DoubleAVLTreeMap(char[] cArray, double[] dArray, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2DoubleAVLTreeMap(char[] cArray, double[] dArray) {
        this(cArray, dArray, null);
    }
    ...
    public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2DoubleMap.Entry>(this){
                final Comparator<? super Char2DoubleMap.Entry> comparator;
                final Char2DoubleAVLTreeMap this$0;
                {
                    this.this$0 = char2DoubleAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator(Char2DoubleMap.Entry entry) {
                ...
                @Override
                public ObjectSortedSet<Char2DoubleMap.Entry> subSet(Char2DoubleMap.Entry entry, Char2DoubleMap.Entry entry2) {
                    return this.this$0.subMap(entry.getCharKey(), entry2.getCharKey()).char2DoubleEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2DoubleMap.Entry> headSet(Char2DoubleMap.Entry entry) {
                    return this.this$0.headMap(entry.getCharKey()).char2DoubleEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2DoubleMap.Entry> tailSet(Char2DoubleMap.Entry entry) {
                    return this.this$0.tailMap(entry.getCharKey()).char2DoubleEntrySet();
                }

                @Override
                public ObjectSortedSet tailSet(Object object) {
                    return this.tailSet((Char2DoubleMap.Entry)object);
                }

                @Override
                public ObjectSortedSet headSet(Object object) {
                    return this.headSet((Char2DoubleMap.Entry)object);
                }

                @Override
                public ObjectSortedSet subSet(Object object, Object object2) {
                    return this.subSet((Char2DoubleMap.Entry)object, (Char2DoubleMap.Entry)object2);
                }

                @Override
                public ObjectBidirectionalIterator iterator(Object object) {
                    return this.iterator((Char2DoubleMap.Entry)object);
                }
                ...
                private int lambda$$0(Char2DoubleMap.Entry entry, Char2DoubleMap.Entry entry2) {
    ...
    public Char2DoubleAVLTreeMap clone() {
        Char2DoubleAVLTreeMap char2DoubleAVLTreeMap;
        try {
            char2DoubleAVLTreeMap = (Char2DoubleAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2DoubleAVLTreeMap.keys = null;
        char2DoubleAVLTreeMap.values = null;
        char2DoubleAVLTreeMap.entries = null;
        char2DoubleAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2DoubleAVLTreeMap.firstEntry = char2DoubleAVLTreeMap.tree = entry2.left;
                            while (char2DoubleAVLTreeMap.firstEntry.left != null) {
                                char2DoubleAVLTreeMap.firstEntry = char2DoubleAVLTreeMap.firstEntry.left;
                            }
                            char2DoubleAVLTreeMap.lastEntry = char2DoubleAVLTreeMap.tree;
                            while (char2DoubleAVLTreeMap.lastEntry.right != null) {
                                char2DoubleAVLTreeMap.lastEntry = char2DoubleAVLTreeMap.lastEntry.right;
                            }
                            return char2DoubleAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readChar(), objectInputStream.readDouble());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readChar(), objectInputStream.readDouble());
            entry4.right(new Entry(objectInputStream.readChar(), objectInputStream.readDouble()));
    ...
    implements Serializable {
        ...
        public Submap(Char2DoubleAVLTreeMap char2DoubleAVLTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2DoubleAVLTreeMap;
            if (!bl && !bl2 && char2DoubleAVLTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2DoubleAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2DoubleMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Char2DoubleMap.Entry> comparator() {
                        return this.this$1.this$0.char2DoubleEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Char2DoubleMap.Entry> subSet(Char2DoubleMap.Entry entry, Char2DoubleMap.Entry entry2) {
                        return this.this$1.subMap(entry.getCharKey(), entry2.getCharKey()).char2DoubleEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Char2DoubleMap.Entry> headSet(Char2DoubleMap.Entry entry) {
                        return this.this$1.headMap(entry.getCharKey()).char2DoubleEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Char2DoubleMap.Entry> tailSet(Char2DoubleMap.Entry entry) {
                        return this.this$1.tailMap(entry.getCharKey()).char2DoubleEntrySet();
                    }
    ...
    implements DoubleListIterator {
        ...
        private ValueIterator(Char2DoubleAVLTreeMap char2DoubleAVLTreeMap) {
            this.this$0 = char2DoubleAVLTreeMap;
            super(char2DoubleAVLTreeMap);
        }
        ...
        ValueIterator(Char2DoubleAVLTreeMap char2DoubleAVLTreeMap, 1 var2_2) {
            this(char2DoubleAVLTreeMap);
        }
    }
    ...
    extends AbstractChar2DoubleSortedMap.KeySet {
        ...
        private KeySet(Char2DoubleAVLTreeMap char2DoubleAVLTreeMap) {
            this.this$0 = char2DoubleAVLTreeMap;
            super(char2DoubleAVLTreeMap);
        }
        ...
        KeySet(Char2DoubleAVLTreeMap char2DoubleAVLTreeMap, 1 var2_2) {
            this(char2DoubleAVLTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2DoubleAVLTreeMap char2DoubleAVLTreeMap) {
            this.this$0 = char2DoubleAVLTreeMap;
            super(char2DoubleAVLTreeMap);
        }

        public KeyIterator(Char2DoubleAVLTreeMap char2DoubleAVLTreeMap, char c) {
            this.this$0 = char2DoubleAVLTreeMap;
            super(char2DoubleAVLTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2DoubleMap.Entry> {
        ...
        EntryIterator(Char2DoubleAVLTreeMap char2DoubleAVLTreeMap) {
            this.this$0 = char2DoubleAVLTreeMap;
            super(char2DoubleAVLTreeMap);
        }

        EntryIterator(Char2DoubleAVLTreeMap char2DoubleAVLTreeMap, char c) {
            this.this$0 = char2DoubleAVLTreeMap;
            super(char2DoubleAVLTreeMap, c);
        }
        ...
        @Override
        public void set(Char2DoubleMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void add(Char2DoubleMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void add(Object object) {
            this.add((Char2DoubleMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Char2DoubleMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2DoubleAVLTreeMap char2DoubleAVLTreeMap) {
            this.this$0 = char2DoubleAVLTreeMap;
            this.index = 0;
            this.next = char2DoubleAVLTreeMap.firstEntry;
        }

        TreeIterator(Char2DoubleAVLTreeMap char2DoubleAVLTreeMap, char c) {
            this.this$0 = char2DoubleAVLTreeMap;
            this.index = 0;
            this.next = char2DoubleAVLTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2DoubleAVLTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == ((Character)entry.getKey()).charValue() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits((Double)entry.getValue());
        }
