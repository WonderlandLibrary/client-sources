...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Char2ShortAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Char2ShortAVLTreeMap(Comparator<? super Character> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Char2ShortAVLTreeMap(Map<? extends Character, ? extends Short> map) {
        this();
        this.putAll(map);
    }

    public Char2ShortAVLTreeMap(SortedMap<Character, Short> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Character, ? extends Short>)sortedMap);
    }

    public Char2ShortAVLTreeMap(Char2ShortMap char2ShortMap) {
        this();
        this.putAll(char2ShortMap);
    }

    public Char2ShortAVLTreeMap(Char2ShortSortedMap char2ShortSortedMap) {
        this(char2ShortSortedMap.comparator());
        this.putAll(char2ShortSortedMap);
    }

    public Char2ShortAVLTreeMap(char[] cArray, short[] sArray, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2ShortAVLTreeMap(char[] cArray, short[] sArray) {
        this(cArray, sArray, null);
    }
    ...
    public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>(this){
                final Comparator<? super Char2ShortMap.Entry> comparator;
                final Char2ShortAVLTreeMap this$0;
                {
                    this.this$0 = char2ShortAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator(Char2ShortMap.Entry entry) {
                ...
                @Override
                public ObjectSortedSet<Char2ShortMap.Entry> subSet(Char2ShortMap.Entry entry, Char2ShortMap.Entry entry2) {
                    return this.this$0.subMap(entry.getCharKey(), entry2.getCharKey()).char2ShortEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry entry) {
                    return this.this$0.headMap(entry.getCharKey()).char2ShortEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry entry) {
                    return this.this$0.tailMap(entry.getCharKey()).char2ShortEntrySet();
                }

                @Override
                public ObjectSortedSet tailSet(Object object) {
                    return this.tailSet((Char2ShortMap.Entry)object);
                }

                @Override
                public ObjectSortedSet headSet(Object object) {
                    return this.headSet((Char2ShortMap.Entry)object);
                }

                @Override
                public ObjectSortedSet subSet(Object object, Object object2) {
                    return this.subSet((Char2ShortMap.Entry)object, (Char2ShortMap.Entry)object2);
                }

                @Override
                public ObjectBidirectionalIterator iterator(Object object) {
                    return this.iterator((Char2ShortMap.Entry)object);
                }
                ...
                private int lambda$$0(Char2ShortMap.Entry entry, Char2ShortMap.Entry entry2) {
    ...
    public Char2ShortAVLTreeMap clone() {
        Char2ShortAVLTreeMap char2ShortAVLTreeMap;
        try {
            char2ShortAVLTreeMap = (Char2ShortAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2ShortAVLTreeMap.keys = null;
        char2ShortAVLTreeMap.values = null;
        char2ShortAVLTreeMap.entries = null;
        char2ShortAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2ShortAVLTreeMap.firstEntry = char2ShortAVLTreeMap.tree = entry2.left;
                            while (char2ShortAVLTreeMap.firstEntry.left != null) {
                                char2ShortAVLTreeMap.firstEntry = char2ShortAVLTreeMap.firstEntry.left;
                            }
                            char2ShortAVLTreeMap.lastEntry = char2ShortAVLTreeMap.tree;
                            while (char2ShortAVLTreeMap.lastEntry.right != null) {
                                char2ShortAVLTreeMap.lastEntry = char2ShortAVLTreeMap.lastEntry.right;
                            }
                            return char2ShortAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readChar(), objectInputStream.readShort());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readChar(), objectInputStream.readShort());
            entry4.right(new Entry(objectInputStream.readChar(), objectInputStream.readShort()));
    ...
    implements Serializable {
        ...
        public Submap(Char2ShortAVLTreeMap char2ShortAVLTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2ShortAVLTreeMap;
            if (!bl && !bl2 && char2ShortAVLTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2ShortAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Char2ShortMap.Entry> comparator() {
                        return this.this$1.this$0.char2ShortEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Char2ShortMap.Entry> subSet(Char2ShortMap.Entry entry, Char2ShortMap.Entry entry2) {
                        return this.this$1.subMap(entry.getCharKey(), entry2.getCharKey()).char2ShortEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry entry) {
                        return this.this$1.headMap(entry.getCharKey()).char2ShortEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry entry) {
                        return this.this$1.tailMap(entry.getCharKey()).char2ShortEntrySet();
                    }
    ...
    implements ShortListIterator {
        ...
        private ValueIterator(Char2ShortAVLTreeMap char2ShortAVLTreeMap) {
            this.this$0 = char2ShortAVLTreeMap;
            super(char2ShortAVLTreeMap);
        }
        ...
        ValueIterator(Char2ShortAVLTreeMap char2ShortAVLTreeMap, 1 var2_2) {
            this(char2ShortAVLTreeMap);
        }
    }
    ...
    extends AbstractChar2ShortSortedMap.KeySet {
        ...
        private KeySet(Char2ShortAVLTreeMap char2ShortAVLTreeMap) {
            this.this$0 = char2ShortAVLTreeMap;
            super(char2ShortAVLTreeMap);
        }
        ...
        KeySet(Char2ShortAVLTreeMap char2ShortAVLTreeMap, 1 var2_2) {
            this(char2ShortAVLTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2ShortAVLTreeMap char2ShortAVLTreeMap) {
            this.this$0 = char2ShortAVLTreeMap;
            super(char2ShortAVLTreeMap);
        }

        public KeyIterator(Char2ShortAVLTreeMap char2ShortAVLTreeMap, char c) {
            this.this$0 = char2ShortAVLTreeMap;
            super(char2ShortAVLTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2ShortMap.Entry> {
        ...
        EntryIterator(Char2ShortAVLTreeMap char2ShortAVLTreeMap) {
            this.this$0 = char2ShortAVLTreeMap;
            super(char2ShortAVLTreeMap);
        }

        EntryIterator(Char2ShortAVLTreeMap char2ShortAVLTreeMap, char c) {
            this.this$0 = char2ShortAVLTreeMap;
            super(char2ShortAVLTreeMap, c);
        }
        ...
        @Override
        public void set(Char2ShortMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void add(Char2ShortMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public void add(Object object) {
            this.add((Char2ShortMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Char2ShortMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2ShortAVLTreeMap char2ShortAVLTreeMap) {
            this.this$0 = char2ShortAVLTreeMap;
            this.index = 0;
            this.next = char2ShortAVLTreeMap.firstEntry;
        }

        TreeIterator(Char2ShortAVLTreeMap char2ShortAVLTreeMap, char c) {
            this.this$0 = char2ShortAVLTreeMap;
            this.index = 0;
            this.next = char2ShortAVLTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2ShortAVLTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == ((Character)entry.getKey()).charValue() && this.value == (Short)entry.getValue();
        }
