...
Cloneable {
    ...
    public Char2DoubleRBTreeMap(Comparator<? super Character> comparator) {
        this();
    ...
    public Char2DoubleRBTreeMap(SortedMap<Character, Double> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Character, ? extends Double>)sortedMap);
    }

    public Char2DoubleRBTreeMap(Char2DoubleMap char2DoubleMap) {
        this();
        this.putAll(char2DoubleMap);
    }

    public Char2DoubleRBTreeMap(Char2DoubleSortedMap char2DoubleSortedMap) {
        this(char2DoubleSortedMap.comparator());
        this.putAll(char2DoubleSortedMap);
    }

    public Char2DoubleRBTreeMap(char[] cArray, double[] dArray, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2DoubleRBTreeMap(char[] cArray, double[] dArray) {
    ...
    public ObjectSortedSet<Char2DoubleMap.Entry> char2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2DoubleMap.Entry>(this){
                ...
                final Char2DoubleRBTreeMap this$0;
                {
                    this.this$0 = char2DoubleRBTreeMap;
    ...
    public Char2DoubleRBTreeMap clone() {
        Char2DoubleRBTreeMap char2DoubleRBTreeMap;
        try {
            char2DoubleRBTreeMap = (Char2DoubleRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2DoubleRBTreeMap.keys = null;
        char2DoubleRBTreeMap.values = null;
        char2DoubleRBTreeMap.entries = null;
        char2DoubleRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2DoubleRBTreeMap.firstEntry = char2DoubleRBTreeMap.tree = entry2.left;
                            while (char2DoubleRBTreeMap.firstEntry.left != null) {
                                char2DoubleRBTreeMap.firstEntry = char2DoubleRBTreeMap.firstEntry.left;
                            }
                            char2DoubleRBTreeMap.lastEntry = char2DoubleRBTreeMap.tree;
                            while (char2DoubleRBTreeMap.lastEntry.right != null) {
                                char2DoubleRBTreeMap.lastEntry = char2DoubleRBTreeMap.lastEntry.right;
                            }
                            return char2DoubleRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Char2DoubleRBTreeMap char2DoubleRBTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2DoubleRBTreeMap;
            if (!bl && !bl2 && char2DoubleRBTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2DoubleRBTreeMap.defRetValue;
        }
    ...
    implements DoubleListIterator {
        ...
        private ValueIterator(Char2DoubleRBTreeMap char2DoubleRBTreeMap) {
            this.this$0 = char2DoubleRBTreeMap;
            super(char2DoubleRBTreeMap);
        }
        ...
        ValueIterator(Char2DoubleRBTreeMap char2DoubleRBTreeMap, 1 var2_2) {
            this(char2DoubleRBTreeMap);
        }
    }
    ...
    extends AbstractChar2DoubleSortedMap.KeySet {
        ...
        private KeySet(Char2DoubleRBTreeMap char2DoubleRBTreeMap) {
            this.this$0 = char2DoubleRBTreeMap;
            super(char2DoubleRBTreeMap);
        }
        ...
        KeySet(Char2DoubleRBTreeMap char2DoubleRBTreeMap, 1 var2_2) {
            this(char2DoubleRBTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2DoubleRBTreeMap char2DoubleRBTreeMap) {
            this.this$0 = char2DoubleRBTreeMap;
            super(char2DoubleRBTreeMap);
        }

        public KeyIterator(Char2DoubleRBTreeMap char2DoubleRBTreeMap, char c) {
            this.this$0 = char2DoubleRBTreeMap;
            super(char2DoubleRBTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2DoubleMap.Entry> {
        ...
        EntryIterator(Char2DoubleRBTreeMap char2DoubleRBTreeMap) {
            this.this$0 = char2DoubleRBTreeMap;
            super(char2DoubleRBTreeMap);
        }

        EntryIterator(Char2DoubleRBTreeMap char2DoubleRBTreeMap, char c) {
            this.this$0 = char2DoubleRBTreeMap;
            super(char2DoubleRBTreeMap, c);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2DoubleRBTreeMap char2DoubleRBTreeMap) {
            this.this$0 = char2DoubleRBTreeMap;
            this.index = 0;
            this.next = char2DoubleRBTreeMap.firstEntry;
        }

        TreeIterator(Char2DoubleRBTreeMap char2DoubleRBTreeMap, char c) {
            this.this$0 = char2DoubleRBTreeMap;
            this.index = 0;
            this.next = char2DoubleRBTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2DoubleRBTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
