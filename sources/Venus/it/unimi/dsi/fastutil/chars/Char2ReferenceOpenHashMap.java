...
Hash {
    ...
    public Char2ReferenceOpenHashMap(Map<? extends Character, ? extends V> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Char2ReferenceOpenHashMap(Map<? extends Character, ? extends V> map) {
        this(map, 0.75f);
    }

    public Char2ReferenceOpenHashMap(Char2ReferenceMap<V> char2ReferenceMap, float f) {
        this(char2ReferenceMap.size(), f);
        this.putAll(char2ReferenceMap);
    }

    public Char2ReferenceOpenHashMap(Char2ReferenceMap<V> char2ReferenceMap) {
        this(char2ReferenceMap, 0.75f);
    }

    public Char2ReferenceOpenHashMap(char[] cArray, V[] VArray, float f) {
    ...
    public Char2ReferenceOpenHashMap(char[] cArray, V[] VArray) {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Char2ReferenceOpenHashMap this$0;
                {
                    this.this$0 = char2ReferenceOpenHashMap;
                }
    ...
    public Char2ReferenceOpenHashMap<V> clone() {
        ...
        try {
            char2ReferenceOpenHashMap = (Char2ReferenceOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2ReferenceOpenHashMap.keys = null;
        char2ReferenceOpenHashMap.values = null;
        char2ReferenceOpenHashMap.entries = null;
        char2ReferenceOpenHashMap.containsNullKey = this.containsNullKey;
        char2ReferenceOpenHashMap.key = (char[])this.key.clone();
        char2ReferenceOpenHashMap.value = (Object[])this.value.clone();
    ...
    static Object access$300(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap) {
        return char2ReferenceOpenHashMap.removeNullEntry();
    }

    static Object access$400(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap, int n) {
        return char2ReferenceOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap) {
            this.this$0 = char2ReferenceOpenHashMap;
            super(char2ReferenceOpenHashMap, null);
        }
    ...
    extends AbstractCharSet {
        ...
        private KeySet(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap) {
            this.this$0 = char2ReferenceOpenHashMap;
        }
        ...
        KeySet(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap, 1 var2_2) {
            this(char2ReferenceOpenHashMap);
        }
    }
    ...
    implements CharIterator {
        ...
        public KeyIterator(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap) {
            this.this$0 = char2ReferenceOpenHashMap;
            super(char2ReferenceOpenHashMap, null);
        }
    ...
    implements Char2ReferenceMap.FastEntrySet<V> {
        ...
        private MapEntrySet(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap) {
            this.this$0 = char2ReferenceOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (c == '\u0000') {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Char2ReferenceOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (c2 == c) {
                if (this.this$0.value[n] == v) {
                    Char2ReferenceOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap, 1 var2_2) {
            this(char2ReferenceOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2ReferenceMap.Entry<V>> {
        ...
        private FastEntryIterator(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap) {
            this.this$0 = char2ReferenceOpenHashMap;
            super(char2ReferenceOpenHashMap, null);
        ...
        FastEntryIterator(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap, 1 var2_2) {
            this(char2ReferenceOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2ReferenceMap.Entry<V>> {
        ...
        private EntryIterator(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap) {
            this.this$0 = char2ReferenceOpenHashMap;
            super(char2ReferenceOpenHashMap, null);
        }
        ...
        EntryIterator(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap, 1 var2_2) {
            this(char2ReferenceOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap) {
            this.this$0 = char2ReferenceOpenHashMap;
        ...
        MapIterator(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap, 1 var2_2) {
            this(char2ReferenceOpenHashMap);
        }
    }
    ...
    Map.Entry<Character, V> {
        ...
        MapEntry(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap, int n) {
            this.this$0 = char2ReferenceOpenHashMap;
            this.index = n;
        }

        MapEntry(Char2ReferenceOpenHashMap char2ReferenceOpenHashMap) {
            this.this$0 = char2ReferenceOpenHashMap;
        }
