...
Cloneable {
    ...
    public Char2LongRBTreeMap(Comparator<? super Character> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Char2LongRBTreeMap(Map<? extends Character, ? extends Long> map) {
        this();
        this.putAll(map);
    }

    public Char2LongRBTreeMap(SortedMap<Character, Long> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Character, ? extends Long>)sortedMap);
    }

    public Char2LongRBTreeMap(Char2LongMap char2LongMap) {
        this();
        this.putAll(char2LongMap);
    }

    public Char2LongRBTreeMap(Char2LongSortedMap char2LongSortedMap) {
        this(char2LongSortedMap.comparator());
        this.putAll(char2LongSortedMap);
    }

    public Char2LongRBTreeMap(char[] cArray, long[] lArray, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2LongRBTreeMap(char[] cArray, long[] lArray) {
        this(cArray, lArray, null);
    }
    ...
    public ObjectSortedSet<Char2LongMap.Entry> char2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2LongMap.Entry>(this){
                final Comparator<? super Char2LongMap.Entry> comparator;
                final Char2LongRBTreeMap this$0;
                {
                    this.this$0 = char2LongRBTreeMap;
                ...
                public ObjectSortedSet<Char2LongMap.Entry> subSet(Char2LongMap.Entry entry, Char2LongMap.Entry entry2) {
                    return this.this$0.subMap(entry.getCharKey(), entry2.getCharKey()).char2LongEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2LongMap.Entry> headSet(Char2LongMap.Entry entry) {
                    return this.this$0.headMap(entry.getCharKey()).char2LongEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2LongMap.Entry> tailSet(Char2LongMap.Entry entry) {
                    return this.this$0.tailMap(entry.getCharKey()).char2LongEntrySet();
                }
                ...
                private int lambda$$0(Char2LongMap.Entry entry, Char2LongMap.Entry entry2) {
    ...
    public Char2LongRBTreeMap clone() {
        Char2LongRBTreeMap char2LongRBTreeMap;
        try {
            char2LongRBTreeMap = (Char2LongRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2LongRBTreeMap.keys = null;
        char2LongRBTreeMap.values = null;
        char2LongRBTreeMap.entries = null;
        char2LongRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2LongRBTreeMap.firstEntry = char2LongRBTreeMap.tree = entry2.left;
                            while (char2LongRBTreeMap.firstEntry.left != null) {
                                char2LongRBTreeMap.firstEntry = char2LongRBTreeMap.firstEntry.left;
                            }
                            char2LongRBTreeMap.lastEntry = char2LongRBTreeMap.tree;
                            while (char2LongRBTreeMap.lastEntry.right != null) {
                                char2LongRBTreeMap.lastEntry = char2LongRBTreeMap.lastEntry.right;
                            }
                            return char2LongRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Char2LongRBTreeMap char2LongRBTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2LongRBTreeMap;
            if (!bl && !bl2 && char2LongRBTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2LongRBTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Char2LongMap.Entry> char2LongEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2LongMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Char2LongMap.Entry> comparator() {
                        return this.this$1.this$0.char2LongEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Char2LongMap.Entry> subSet(Char2LongMap.Entry entry, Char2LongMap.Entry entry2) {
                        return this.this$1.subMap(entry.getCharKey(), entry2.getCharKey()).char2LongEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Char2LongMap.Entry> headSet(Char2LongMap.Entry entry) {
                        return this.this$1.headMap(entry.getCharKey()).char2LongEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Char2LongMap.Entry> tailSet(Char2LongMap.Entry entry) {
                        return this.this$1.tailMap(entry.getCharKey()).char2LongEntrySet();
                    }
    ...
    implements LongListIterator {
        ...
        private ValueIterator(Char2LongRBTreeMap char2LongRBTreeMap) {
            this.this$0 = char2LongRBTreeMap;
            super(char2LongRBTreeMap);
        }
        ...
        ValueIterator(Char2LongRBTreeMap char2LongRBTreeMap, 1 var2_2) {
            this(char2LongRBTreeMap);
        }
    }
    ...
    extends AbstractChar2LongSortedMap.KeySet {
        ...
        private KeySet(Char2LongRBTreeMap char2LongRBTreeMap) {
            this.this$0 = char2LongRBTreeMap;
            super(char2LongRBTreeMap);
        }
        ...
        KeySet(Char2LongRBTreeMap char2LongRBTreeMap, 1 var2_2) {
            this(char2LongRBTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2LongRBTreeMap char2LongRBTreeMap) {
            this.this$0 = char2LongRBTreeMap;
            super(char2LongRBTreeMap);
        }

        public KeyIterator(Char2LongRBTreeMap char2LongRBTreeMap, char c) {
            this.this$0 = char2LongRBTreeMap;
            super(char2LongRBTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2LongMap.Entry> {
        ...
        EntryIterator(Char2LongRBTreeMap char2LongRBTreeMap) {
            this.this$0 = char2LongRBTreeMap;
            super(char2LongRBTreeMap);
        }

        EntryIterator(Char2LongRBTreeMap char2LongRBTreeMap, char c) {
            this.this$0 = char2LongRBTreeMap;
            super(char2LongRBTreeMap, c);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2LongRBTreeMap char2LongRBTreeMap) {
            this.this$0 = char2LongRBTreeMap;
            this.index = 0;
            this.next = char2LongRBTreeMap.firstEntry;
        }

        TreeIterator(Char2LongRBTreeMap char2LongRBTreeMap, char c) {
            this.this$0 = char2LongRBTreeMap;
            this.index = 0;
            this.next = char2LongRBTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2LongRBTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == ((Character)entry.getKey()).charValue() && this.value == (Long)entry.getValue();
        }
