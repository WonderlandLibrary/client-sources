...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Char2FloatAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Char2FloatAVLTreeMap(Comparator<? super Character> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Char2FloatAVLTreeMap(Map<? extends Character, ? extends Float> map) {
        this();
        this.putAll(map);
    }

    public Char2FloatAVLTreeMap(SortedMap<Character, Float> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Character, ? extends Float>)sortedMap);
    }

    public Char2FloatAVLTreeMap(Char2FloatMap char2FloatMap) {
        this();
        this.putAll(char2FloatMap);
    }

    public Char2FloatAVLTreeMap(Char2FloatSortedMap char2FloatSortedMap) {
        this(char2FloatSortedMap.comparator());
        this.putAll(char2FloatSortedMap);
    }

    public Char2FloatAVLTreeMap(char[] cArray, float[] fArray, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2FloatAVLTreeMap(char[] cArray, float[] fArray) {
    ...
    public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>(this){
                ...
                final Char2FloatAVLTreeMap this$0;
                {
                    this.this$0 = char2FloatAVLTreeMap;
    ...
    public Char2FloatAVLTreeMap clone() {
        Char2FloatAVLTreeMap char2FloatAVLTreeMap;
        try {
            char2FloatAVLTreeMap = (Char2FloatAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2FloatAVLTreeMap.keys = null;
        char2FloatAVLTreeMap.values = null;
        char2FloatAVLTreeMap.entries = null;
        char2FloatAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2FloatAVLTreeMap.firstEntry = char2FloatAVLTreeMap.tree = entry2.left;
                            while (char2FloatAVLTreeMap.firstEntry.left != null) {
                                char2FloatAVLTreeMap.firstEntry = char2FloatAVLTreeMap.firstEntry.left;
                            }
                            char2FloatAVLTreeMap.lastEntry = char2FloatAVLTreeMap.tree;
                            while (char2FloatAVLTreeMap.lastEntry.right != null) {
                                char2FloatAVLTreeMap.lastEntry = char2FloatAVLTreeMap.lastEntry.right;
                            }
                            return char2FloatAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Char2FloatAVLTreeMap char2FloatAVLTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2FloatAVLTreeMap;
            if (!bl && !bl2 && char2FloatAVLTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2FloatAVLTreeMap.defRetValue;
        }
    ...
    implements FloatListIterator {
        ...
        private ValueIterator(Char2FloatAVLTreeMap char2FloatAVLTreeMap) {
            this.this$0 = char2FloatAVLTreeMap;
            super(char2FloatAVLTreeMap);
        }
        ...
        ValueIterator(Char2FloatAVLTreeMap char2FloatAVLTreeMap, 1 var2_2) {
            this(char2FloatAVLTreeMap);
        }
    }
    ...
    extends AbstractChar2FloatSortedMap.KeySet {
        ...
        private KeySet(Char2FloatAVLTreeMap char2FloatAVLTreeMap) {
            this.this$0 = char2FloatAVLTreeMap;
            super(char2FloatAVLTreeMap);
        }
        ...
        KeySet(Char2FloatAVLTreeMap char2FloatAVLTreeMap, 1 var2_2) {
            this(char2FloatAVLTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2FloatAVLTreeMap char2FloatAVLTreeMap) {
            this.this$0 = char2FloatAVLTreeMap;
            super(char2FloatAVLTreeMap);
        }

        public KeyIterator(Char2FloatAVLTreeMap char2FloatAVLTreeMap, char c) {
            this.this$0 = char2FloatAVLTreeMap;
            super(char2FloatAVLTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2FloatMap.Entry> {
        ...
        EntryIterator(Char2FloatAVLTreeMap char2FloatAVLTreeMap) {
            this.this$0 = char2FloatAVLTreeMap;
            super(char2FloatAVLTreeMap);
        }

        EntryIterator(Char2FloatAVLTreeMap char2FloatAVLTreeMap, char c) {
            this.this$0 = char2FloatAVLTreeMap;
            super(char2FloatAVLTreeMap, c);
        }
        ...
        public void add(Object object) {
            this.add((Char2FloatMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Char2FloatMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2FloatAVLTreeMap char2FloatAVLTreeMap) {
            this.this$0 = char2FloatAVLTreeMap;
            this.index = 0;
            this.next = char2FloatAVLTreeMap.firstEntry;
        }

        TreeIterator(Char2FloatAVLTreeMap char2FloatAVLTreeMap, char c) {
            this.this$0 = char2FloatAVLTreeMap;
            this.index = 0;
            this.next = char2FloatAVLTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2FloatAVLTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
