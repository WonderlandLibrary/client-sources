...
Hash {
    ...
    public Char2ReferenceOpenCustomHashMap(int n, float f, CharHash.Strategy strategy) {
    ...
    public Char2ReferenceOpenCustomHashMap(int n, CharHash.Strategy strategy) {
    ...
    public Char2ReferenceOpenCustomHashMap(Map<? extends Character, ? extends V> map, float f, CharHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Char2ReferenceOpenCustomHashMap(Map<? extends Character, ? extends V> map, CharHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Char2ReferenceOpenCustomHashMap(Char2ReferenceMap<V> char2ReferenceMap, float f, CharHash.Strategy strategy) {
        this(char2ReferenceMap.size(), f, strategy);
        this.putAll(char2ReferenceMap);
    }

    public Char2ReferenceOpenCustomHashMap(Char2ReferenceMap<V> char2ReferenceMap, CharHash.Strategy strategy) {
        this(char2ReferenceMap, 0.75f, strategy);
    }

    public Char2ReferenceOpenCustomHashMap(char[] cArray, V[] VArray, float f, CharHash.Strategy strategy) {
    ...
    public Char2ReferenceOpenCustomHashMap(char[] cArray, V[] VArray, CharHash.Strategy strategy) {
    ...
    public boolean remove(char c, Object object) {
        ...
        if (this.strategy.equals(c, c2) && object == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((c2 = cArray[n = n + 1 & this.mask]) != '\u0000') continue;
            return true;
        } while (!this.strategy.equals(c, c2) || object != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Char2ReferenceOpenCustomHashMap this$0;
                {
                    this.this$0 = char2ReferenceOpenCustomHashMap;
                }
    ...
    public Char2ReferenceOpenCustomHashMap<V> clone() {
        Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap;
        try {
            char2ReferenceOpenCustomHashMap = (Char2ReferenceOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2ReferenceOpenCustomHashMap.keys = null;
        char2ReferenceOpenCustomHashMap.values = null;
        char2ReferenceOpenCustomHashMap.entries = null;
        char2ReferenceOpenCustomHashMap.containsNullKey = this.containsNullKey;
        char2ReferenceOpenCustomHashMap.key = (char[])this.key.clone();
        char2ReferenceOpenCustomHashMap.value = (Object[])this.value.clone();
        char2ReferenceOpenCustomHashMap.strategy = this.strategy;
        return char2ReferenceOpenCustomHashMap;
    }
    ...
    static Object access$300(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap) {
        return char2ReferenceOpenCustomHashMap.removeNullEntry();
    }

    static Object access$400(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap, int n) {
        return char2ReferenceOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap) {
            this.this$0 = char2ReferenceOpenCustomHashMap;
            super(char2ReferenceOpenCustomHashMap, null);
        }
    ...
    extends AbstractCharSet {
        ...
        private KeySet(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap) {
            this.this$0 = char2ReferenceOpenCustomHashMap;
        }
        ...
        KeySet(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(char2ReferenceOpenCustomHashMap);
        }
    }
    ...
    implements CharIterator {
        ...
        public KeyIterator(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap) {
            this.this$0 = char2ReferenceOpenCustomHashMap;
            super(char2ReferenceOpenCustomHashMap, null);
        }
    ...
    implements Char2ReferenceMap.FastEntrySet<V> {
        ...
        private MapEntrySet(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap) {
            this.this$0 = char2ReferenceOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(c, '\u0000')) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Char2ReferenceOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(c2, c)) {
                if (this.this$0.value[n] == v) {
                    Char2ReferenceOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((c2 = cArray[n = n + 1 & this.this$0.mask]) != '\u0000') continue;
                return true;
            } while (!this.this$0.strategy.equals(c2, c) || this.this$0.value[n] != v);
            Char2ReferenceOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        public void forEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
            if (this.this$0.containsNullKey) {
                consumer.accept(new AbstractChar2ReferenceMap.BasicEntry(this.this$0.key[this.this$0.n], this.this$0.value[this.this$0.n]));
            }
            int n = this.this$0.n;
            while (n-- != 0) {
                if (this.this$0.key[n] == '\u0000') continue;
                consumer.accept(new AbstractChar2ReferenceMap.BasicEntry(this.this$0.key[n], this.this$0.value[n]));
            }
        }
        ...
        MapEntrySet(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(char2ReferenceOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2ReferenceMap.Entry<V>> {
        ...
        private FastEntryIterator(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap) {
            this.this$0 = char2ReferenceOpenCustomHashMap;
            super(char2ReferenceOpenCustomHashMap, null);
        ...
        FastEntryIterator(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(char2ReferenceOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2ReferenceMap.Entry<V>> {
        ...
        private EntryIterator(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap) {
            this.this$0 = char2ReferenceOpenCustomHashMap;
            super(char2ReferenceOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(char2ReferenceOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap) {
            this.this$0 = char2ReferenceOpenCustomHashMap;
        ...
        MapIterator(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap, 1 var2_2) {
            this(char2ReferenceOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Character, V> {
        ...
        MapEntry(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap, int n) {
            this.this$0 = char2ReferenceOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Char2ReferenceOpenCustomHashMap char2ReferenceOpenCustomHashMap) {
            this.this$0 = char2ReferenceOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], ((Character)entry.getKey()).charValue()) && this.this$0.value[this.index] == entry.getValue();
        }
