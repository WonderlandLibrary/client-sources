...
Hash {
    ...
    public Char2ReferenceLinkedOpenHashMap(Map<? extends Character, ? extends V> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Char2ReferenceLinkedOpenHashMap(Map<? extends Character, ? extends V> map) {
        this(map, 0.75f);
    }

    public Char2ReferenceLinkedOpenHashMap(Char2ReferenceMap<V> char2ReferenceMap, float f) {
        this(char2ReferenceMap.size(), f);
        this.putAll(char2ReferenceMap);
    }

    public Char2ReferenceLinkedOpenHashMap(Char2ReferenceMap<V> char2ReferenceMap) {
        this(char2ReferenceMap, 0.75f);
    }

    public Char2ReferenceLinkedOpenHashMap(char[] cArray, V[] VArray, float f) {
    ...
    public Char2ReferenceLinkedOpenHashMap(char[] cArray, V[] VArray) {
    ...
    public boolean containsValue(Object object) {
        ...
        int n = this.n;
        while (n-- != 0) {
            if (cArray[n] == '\u0000' || VArray[n] != object) continue;
            return false;
        }
        return true;
    }
    ...
    public boolean remove(char c, Object object) {
        ...
        do {
            if ((c2 = cArray[n = n + 1 & this.mask]) != '\u0000') continue;
            return true;
        } while (c != c2 || object != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Char2ReferenceLinkedOpenHashMap this$0;
                {
                    this.this$0 = char2ReferenceLinkedOpenHashMap;
                }
    ...
    public Char2ReferenceLinkedOpenHashMap<V> clone() {
        Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap;
        try {
            char2ReferenceLinkedOpenHashMap = (Char2ReferenceLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2ReferenceLinkedOpenHashMap.keys = null;
        char2ReferenceLinkedOpenHashMap.values = null;
        char2ReferenceLinkedOpenHashMap.entries = null;
        char2ReferenceLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        char2ReferenceLinkedOpenHashMap.key = (char[])this.key.clone();
        char2ReferenceLinkedOpenHashMap.value = (Object[])this.value.clone();
        char2ReferenceLinkedOpenHashMap.link = (long[])this.link.clone();
        return char2ReferenceLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet char2ReferenceEntrySet() {
    ...
    static Object access$100(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap) {
        return char2ReferenceLinkedOpenHashMap.removeNullEntry();
    }

    static Object access$200(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap, int n) {
        return char2ReferenceLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectListIterator<V> {
        ...
        public ValueIterator(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap) {
            this.this$0 = char2ReferenceLinkedOpenHashMap;
            super(char2ReferenceLinkedOpenHashMap);
        }
    ...
    extends AbstractCharSortedSet {
        ...
        private KeySet(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap) {
            this.this$0 = char2ReferenceLinkedOpenHashMap;
        }
        ...
        KeySet(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap, 1 var2_2) {
            this(char2ReferenceLinkedOpenHashMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap, char c) {
            this.this$0 = char2ReferenceLinkedOpenHashMap;
            super(char2ReferenceLinkedOpenHashMap, c, null);
        }
        ...
        public KeyIterator(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap) {
            this.this$0 = char2ReferenceLinkedOpenHashMap;
            super(char2ReferenceLinkedOpenHashMap);
        }
    ...
    implements Char2ReferenceSortedMap.FastSortedEntrySet<V> {
        ...
        private MapEntrySet(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap) {
            this.this$0 = char2ReferenceLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Char2ReferenceMap.Entry<V>> subSet(Char2ReferenceMap.Entry<V> entry, Char2ReferenceMap.Entry<V> entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Char2ReferenceMap.Entry<V>> headSet(Char2ReferenceMap.Entry<V> entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Char2ReferenceMap.Entry<V>> tailSet(Char2ReferenceMap.Entry<V> entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (c == '\u0000') {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Char2ReferenceLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (c2 == c) {
                if (this.this$0.value[n] == v) {
                    Char2ReferenceLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((c2 = cArray[n = n + 1 & this.this$0.mask]) != '\u0000') continue;
                return true;
            } while (c2 != c || this.this$0.value[n] != v);
            Char2ReferenceLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Char2ReferenceMap.Entry<V>> iterator(Char2ReferenceMap.Entry<V> entry) {
        ...
        @Override
        public ObjectListIterator<Char2ReferenceMap.Entry<V>> fastIterator(Char2ReferenceMap.Entry<V> entry) {
        ...
        public void forEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractChar2ReferenceMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }

        @Override
        public void fastForEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
            AbstractChar2ReferenceMap.BasicEntry basicEntry = new AbstractChar2ReferenceMap.BasicEntry();
            int n = this.this$0.size;
            int n2 = this.this$0.first;
            while (n-- != 0) {
                int n3 = n2;
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Char2ReferenceMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Char2ReferenceMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Char2ReferenceMap.Entry)object, (Char2ReferenceMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Char2ReferenceMap.Entry)object);
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Char2ReferenceMap.Entry entry) {
        ...
        MapEntrySet(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap, 1 var2_2) {
            this(char2ReferenceLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Char2ReferenceMap.Entry<V>> {
        ...
        public FastEntryIterator(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap) {
            this.this$0 = char2ReferenceLinkedOpenHashMap;
            super(char2ReferenceLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap, char c) {
            this.this$0 = char2ReferenceLinkedOpenHashMap;
            super(char2ReferenceLinkedOpenHashMap, c, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Char2ReferenceMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Char2ReferenceMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Char2ReferenceMap.Entry<V>> {
        ...
        public EntryIterator(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap) {
            this.this$0 = char2ReferenceLinkedOpenHashMap;
            super(char2ReferenceLinkedOpenHashMap);
        }

        public EntryIterator(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap, char c) {
            this.this$0 = char2ReferenceLinkedOpenHashMap;
            super(char2ReferenceLinkedOpenHashMap, c, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap) {
            this.this$0 = char2ReferenceLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = char2ReferenceLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap, char c) {
            this.this$0 = char2ReferenceLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (c == '\u0000') {
                if (char2ReferenceLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)char2ReferenceLinkedOpenHashMap.link[char2ReferenceLinkedOpenHashMap.n];
                    this.prev = char2ReferenceLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + c + " does not belong to this map.");
            }
            if (char2ReferenceLinkedOpenHashMap.key[char2ReferenceLinkedOpenHashMap.last] == c) {
                this.prev = char2ReferenceLinkedOpenHashMap.last;
                this.index = char2ReferenceLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(c) & char2ReferenceLinkedOpenHashMap.mask;
            while (char2ReferenceLinkedOpenHashMap.key[n] != '\u0000') {
                if (char2ReferenceLinkedOpenHashMap.key[n] == c) {
                    this.next = (int)char2ReferenceLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & char2ReferenceLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + c + " does not belong to this map.");
        }
        ...
        public void set(Char2ReferenceMap.Entry<V> entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Char2ReferenceMap.Entry<V> entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap, char c, 1 var3_3) {
            this(char2ReferenceLinkedOpenHashMap, c);
        }
    }
    ...
    Map.Entry<Character, V> {
        ...
        MapEntry(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap, int n) {
            this.this$0 = char2ReferenceLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Char2ReferenceLinkedOpenHashMap char2ReferenceLinkedOpenHashMap) {
            this.this$0 = char2ReferenceLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.key[this.index] == ((Character)entry.getKey()).charValue() && this.this$0.value[this.index] == entry.getValue();
        }
