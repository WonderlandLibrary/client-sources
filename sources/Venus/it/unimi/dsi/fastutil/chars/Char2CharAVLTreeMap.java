...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Char2CharAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Char2CharAVLTreeMap(Comparator<? super Character> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Char2CharAVLTreeMap(Map<? extends Character, ? extends Character> map) {
        this();
        this.putAll(map);
    }

    public Char2CharAVLTreeMap(SortedMap<Character, Character> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Character, ? extends Character>)sortedMap);
    }

    public Char2CharAVLTreeMap(Char2CharMap char2CharMap) {
        this();
        this.putAll(char2CharMap);
    }

    public Char2CharAVLTreeMap(Char2CharSortedMap char2CharSortedMap) {
        this(char2CharSortedMap.comparator());
        this.putAll(char2CharSortedMap);
    }

    public Char2CharAVLTreeMap(char[] cArray, char[] cArray2, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2CharAVLTreeMap(char[] cArray, char[] cArray2) {
        this(cArray, cArray2, null);
    }
    ...
    public char addTo(char c, char c2) {
        ...
        char c3 = entry.value;
        entry.value = (char)(entry.value + c2);
        return c3;
    }
    ...
    public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2CharMap.Entry>(this){
                final Comparator<? super Char2CharMap.Entry> comparator;
                final Char2CharAVLTreeMap this$0;
                {
                    this.this$0 = char2CharAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator(Char2CharMap.Entry entry) {
                ...
                public ObjectSortedSet<Char2CharMap.Entry> subSet(Char2CharMap.Entry entry, Char2CharMap.Entry entry2) {
                    return this.this$0.subMap(entry.getCharKey(), entry2.getCharKey()).char2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2CharMap.Entry> headSet(Char2CharMap.Entry entry) {
                    return this.this$0.headMap(entry.getCharKey()).char2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2CharMap.Entry> tailSet(Char2CharMap.Entry entry) {
                    return this.this$0.tailMap(entry.getCharKey()).char2CharEntrySet();
                }
                ...
                private int lambda$$0(Char2CharMap.Entry entry, Char2CharMap.Entry entry2) {
    ...
    public Char2CharAVLTreeMap clone() {
        Char2CharAVLTreeMap char2CharAVLTreeMap;
        try {
            char2CharAVLTreeMap = (Char2CharAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2CharAVLTreeMap.keys = null;
        char2CharAVLTreeMap.values = null;
        char2CharAVLTreeMap.entries = null;
        char2CharAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2CharAVLTreeMap.firstEntry = char2CharAVLTreeMap.tree = entry2.left;
                            while (char2CharAVLTreeMap.firstEntry.left != null) {
                                char2CharAVLTreeMap.firstEntry = char2CharAVLTreeMap.firstEntry.left;
                            }
                            char2CharAVLTreeMap.lastEntry = char2CharAVLTreeMap.tree;
                            while (char2CharAVLTreeMap.lastEntry.right != null) {
                                char2CharAVLTreeMap.lastEntry = char2CharAVLTreeMap.lastEntry.right;
                            }
                            return char2CharAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readChar(), objectInputStream.readChar());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readChar(), objectInputStream.readChar());
            entry4.right(new Entry(objectInputStream.readChar(), objectInputStream.readChar()));
    ...
    implements Serializable {
        ...
        public Submap(Char2CharAVLTreeMap char2CharAVLTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2CharAVLTreeMap;
            if (!bl && !bl2 && char2CharAVLTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2CharAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2CharMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Char2CharMap.Entry> comparator() {
                        return this.this$1.this$0.char2CharEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Char2CharMap.Entry> subSet(Char2CharMap.Entry entry, Char2CharMap.Entry entry2) {
                        return this.this$1.subMap(entry.getCharKey(), entry2.getCharKey()).char2CharEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Char2CharMap.Entry> headSet(Char2CharMap.Entry entry) {
                        return this.this$1.headMap(entry.getCharKey()).char2CharEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Char2CharMap.Entry> tailSet(Char2CharMap.Entry entry) {
                        return this.this$1.tailMap(entry.getCharKey()).char2CharEntrySet();
                    }
        ...
        public char put(char c, char c2) {
            ...
            char c3 = this.this$0.put(c, c2);
            return this.this$0.modified ? this.defRetValue : c3;
        }
        ...
        public char remove(char c) {
            ...
            char c2 = this.this$0.remove(c);
            return this.this$0.modified ? c2 : this.defRetValue;
        }
    ...
    implements CharListIterator {
        ...
        private ValueIterator(Char2CharAVLTreeMap char2CharAVLTreeMap) {
            this.this$0 = char2CharAVLTreeMap;
            super(char2CharAVLTreeMap);
        }
        ...
        ValueIterator(Char2CharAVLTreeMap char2CharAVLTreeMap, 1 var2_2) {
            this(char2CharAVLTreeMap);
        }
    }
    ...
    extends AbstractChar2CharSortedMap.KeySet {
        ...
        private KeySet(Char2CharAVLTreeMap char2CharAVLTreeMap) {
            this.this$0 = char2CharAVLTreeMap;
            super(char2CharAVLTreeMap);
        }
        ...
        KeySet(Char2CharAVLTreeMap char2CharAVLTreeMap, 1 var2_2) {
            this(char2CharAVLTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2CharAVLTreeMap char2CharAVLTreeMap) {
            this.this$0 = char2CharAVLTreeMap;
            super(char2CharAVLTreeMap);
        }

        public KeyIterator(Char2CharAVLTreeMap char2CharAVLTreeMap, char c) {
            this.this$0 = char2CharAVLTreeMap;
            super(char2CharAVLTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2CharMap.Entry> {
        ...
        EntryIterator(Char2CharAVLTreeMap char2CharAVLTreeMap) {
            this.this$0 = char2CharAVLTreeMap;
            super(char2CharAVLTreeMap);
        }

        EntryIterator(Char2CharAVLTreeMap char2CharAVLTreeMap, char c) {
            this.this$0 = char2CharAVLTreeMap;
            super(char2CharAVLTreeMap, c);
        }
        ...
        public void add(Object object) {
            this.add((Char2CharMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Char2CharMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2CharAVLTreeMap char2CharAVLTreeMap) {
            this.this$0 = char2CharAVLTreeMap;
            this.index = 0;
            this.next = char2CharAVLTreeMap.firstEntry;
        }

        TreeIterator(Char2CharAVLTreeMap char2CharAVLTreeMap, char c) {
            this.this$0 = char2CharAVLTreeMap;
            this.index = 0;
            this.next = char2CharAVLTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2CharAVLTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == ((Character)entry.getKey()).charValue() && this.value == ((Character)entry.getValue()).charValue();
        }
