...
public final class Char2ReferenceFunctions {
    ...
    public static <V> Char2ReferenceFunction<V> singleton(Character c, V v) {
    ...
    public static <V> Char2ReferenceFunction<V> synchronize(Char2ReferenceFunction<V> char2ReferenceFunction) {
        return new SynchronizedFunction<V>(char2ReferenceFunction);
    }

    public static <V> Char2ReferenceFunction<V> synchronize(Char2ReferenceFunction<V> char2ReferenceFunction, Object object) {
        return new SynchronizedFunction<V>(char2ReferenceFunction, object);
    }

    public static <V> Char2ReferenceFunction<V> unmodifiable(Char2ReferenceFunction<V> char2ReferenceFunction) {
        return new UnmodifiableFunction<V>(char2ReferenceFunction);
    }
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Char2ReferenceFunction<V> char2ReferenceFunction) {
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Char2ReferenceFunction<V> char2ReferenceFunction, Object object) {
            if (char2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = char2ReferenceFunction;
        ...
        protected SynchronizedFunction(Char2ReferenceFunction<V> char2ReferenceFunction) {
            if (char2ReferenceFunction == null) {
                throw new NullPointerException();
            }
            this.function = char2ReferenceFunction;
