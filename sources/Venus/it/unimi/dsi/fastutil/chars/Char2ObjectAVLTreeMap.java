...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Char2ObjectAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Char2ObjectAVLTreeMap(Comparator<? super Character> comparator) {
        this();
    ...
    public Char2ObjectAVLTreeMap(SortedMap<Character, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Character, V>)sortedMap);
    }

    public Char2ObjectAVLTreeMap(Char2ObjectMap<? extends V> char2ObjectMap) {
        this();
        this.putAll(char2ObjectMap);
    }

    public Char2ObjectAVLTreeMap(Char2ObjectSortedMap<V> char2ObjectSortedMap) {
        this(char2ObjectSortedMap.comparator());
        this.putAll(char2ObjectSortedMap);
    }

    public Char2ObjectAVLTreeMap(char[] cArray, V[] VArray, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2ObjectAVLTreeMap(char[] cArray, V[] VArray) {
    ...
    public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>(this){
                ...
                final Char2ObjectAVLTreeMap this$0;
                {
                    this.this$0 = char2ObjectAVLTreeMap;
    ...
    public Char2ObjectAVLTreeMap<V> clone() {
        Char2ObjectAVLTreeMap char2ObjectAVLTreeMap;
        try {
            char2ObjectAVLTreeMap = (Char2ObjectAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2ObjectAVLTreeMap.keys = null;
        char2ObjectAVLTreeMap.values = null;
        char2ObjectAVLTreeMap.entries = null;
        char2ObjectAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2ObjectAVLTreeMap.tree = entry2.left;
                            char2ObjectAVLTreeMap.firstEntry = char2ObjectAVLTreeMap.tree;
                            while (char2ObjectAVLTreeMap.firstEntry.left != null) {
                                char2ObjectAVLTreeMap.firstEntry = char2ObjectAVLTreeMap.firstEntry.left;
                            }
                            char2ObjectAVLTreeMap.lastEntry = char2ObjectAVLTreeMap.tree;
                            while (char2ObjectAVLTreeMap.lastEntry.right != null) {
                                char2ObjectAVLTreeMap.lastEntry = char2ObjectAVLTreeMap.lastEntry.right;
                            }
    ...
    implements Serializable {
        ...
        public Submap(Char2ObjectAVLTreeMap char2ObjectAVLTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2ObjectAVLTreeMap;
            if (!bl && !bl2 && char2ObjectAVLTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2ObjectAVLTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Char2ObjectAVLTreeMap char2ObjectAVLTreeMap) {
            this.this$0 = char2ObjectAVLTreeMap;
            super(char2ObjectAVLTreeMap);
        }
        ...
        ValueIterator(Char2ObjectAVLTreeMap char2ObjectAVLTreeMap, 1 var2_2) {
            this(char2ObjectAVLTreeMap);
        }
    }
    ...
    extends AbstractChar2ObjectSortedMap.KeySet {
        ...
        private KeySet(Char2ObjectAVLTreeMap char2ObjectAVLTreeMap) {
            this.this$0 = char2ObjectAVLTreeMap;
            super(char2ObjectAVLTreeMap);
        }
        ...
        KeySet(Char2ObjectAVLTreeMap char2ObjectAVLTreeMap, 1 var2_2) {
            this(char2ObjectAVLTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2ObjectAVLTreeMap char2ObjectAVLTreeMap) {
            this.this$0 = char2ObjectAVLTreeMap;
            super(char2ObjectAVLTreeMap);
        }

        public KeyIterator(Char2ObjectAVLTreeMap char2ObjectAVLTreeMap, char c) {
            this.this$0 = char2ObjectAVLTreeMap;
            super(char2ObjectAVLTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2ObjectMap.Entry<V>> {
        ...
        EntryIterator(Char2ObjectAVLTreeMap char2ObjectAVLTreeMap) {
            this.this$0 = char2ObjectAVLTreeMap;
            super(char2ObjectAVLTreeMap);
        }

        EntryIterator(Char2ObjectAVLTreeMap char2ObjectAVLTreeMap, char c) {
            this.this$0 = char2ObjectAVLTreeMap;
            super(char2ObjectAVLTreeMap, c);
        }
        ...
        public void add(Object object) {
            this.add((Char2ObjectMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Char2ObjectMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2ObjectAVLTreeMap char2ObjectAVLTreeMap) {
            this.this$0 = char2ObjectAVLTreeMap;
            this.index = 0;
            this.next = char2ObjectAVLTreeMap.firstEntry;
        }

        TreeIterator(Char2ObjectAVLTreeMap char2ObjectAVLTreeMap, char c) {
            this.this$0 = char2ObjectAVLTreeMap;
            this.index = 0;
            this.next = char2ObjectAVLTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2ObjectAVLTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
