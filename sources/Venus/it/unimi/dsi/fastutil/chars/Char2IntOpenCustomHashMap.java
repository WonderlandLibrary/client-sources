...
Hash {
    ...
    public Char2IntOpenCustomHashMap(int n, float f, CharHash.Strategy strategy) {
    ...
    public Char2IntOpenCustomHashMap(int n, CharHash.Strategy strategy) {
    ...
    public Char2IntOpenCustomHashMap(Map<? extends Character, ? extends Integer> map, float f, CharHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Char2IntOpenCustomHashMap(Map<? extends Character, ? extends Integer> map, CharHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Char2IntOpenCustomHashMap(Char2IntMap char2IntMap, float f, CharHash.Strategy strategy) {
        this(char2IntMap.size(), f, strategy);
        this.putAll(char2IntMap);
    }

    public Char2IntOpenCustomHashMap(Char2IntMap char2IntMap, CharHash.Strategy strategy) {
        this(char2IntMap, 0.75f, strategy);
    }

    public Char2IntOpenCustomHashMap(char[] cArray, int[] nArray, float f, CharHash.Strategy strategy) {
    ...
    public Char2IntOpenCustomHashMap(char[] cArray, int[] nArray, CharHash.Strategy strategy) {
        this(cArray, nArray, 0.75f, strategy);
    }
    ...
    public int getOrDefault(char c, int n) {
        ...
        char[] cArray = this.key;
        int n2 = HashCommon.mix(this.strategy.hashCode(c)) & this.mask;
        char c2 = cArray[n2];
        if (c2 == '\u0000') {
            return n;
        }
    ...
    public boolean remove(char c, int n) {
        ...
        if (this.strategy.equals(c, c2) && n == this.value[n2]) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if ((c2 = cArray[n2 = n2 + 1 & this.mask]) != '\u0000') continue;
            return true;
        } while (!this.strategy.equals(c, c2) || n != this.value[n2]);
        this.removeEntry(n2);
        return false;
    }
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection(this){
                final Char2IntOpenCustomHashMap this$0;
                {
                    this.this$0 = char2IntOpenCustomHashMap;
                }
    ...
    public Char2IntOpenCustomHashMap clone() {
        Char2IntOpenCustomHashMap char2IntOpenCustomHashMap;
        try {
            char2IntOpenCustomHashMap = (Char2IntOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2IntOpenCustomHashMap.keys = null;
        char2IntOpenCustomHashMap.values = null;
        char2IntOpenCustomHashMap.entries = null;
        char2IntOpenCustomHashMap.containsNullKey = this.containsNullKey;
        char2IntOpenCustomHashMap.key = (char[])this.key.clone();
        char2IntOpenCustomHashMap.value = (int[])this.value.clone();
        char2IntOpenCustomHashMap.strategy = this.strategy;
        return char2IntOpenCustomHashMap;
    }
    ...
    static int access$300(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap) {
        return char2IntOpenCustomHashMap.removeNullEntry();
    }

    static int access$400(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap, int n) {
        return char2IntOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements IntIterator {
        ...
        public ValueIterator(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap) {
            this.this$0 = char2IntOpenCustomHashMap;
            super(char2IntOpenCustomHashMap, null);
        }
    ...
    extends AbstractCharSet {
        ...
        private KeySet(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap) {
            this.this$0 = char2IntOpenCustomHashMap;
        }
        ...
        KeySet(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap, 1 var2_2) {
            this(char2IntOpenCustomHashMap);
        }
    }
    ...
    implements CharIterator {
        ...
        public KeyIterator(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap) {
            this.this$0 = char2IntOpenCustomHashMap;
            super(char2IntOpenCustomHashMap, null);
        }
    ...
    implements Char2IntMap.FastEntrySet {
        ...
        private MapEntrySet(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap) {
            this.this$0 = char2IntOpenCustomHashMap;
        }
        ...
        public boolean contains(Object object) {
            ...
            int n2 = HashCommon.mix(this.this$0.strategy.hashCode(c)) & this.this$0.mask;
            char c2 = cArray[n2];
            if (c2 == '\u0000') {
                return true;
            }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(c, '\u0000')) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n) {
                    Char2IntOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(c2, c)) {
                if (this.this$0.value[n2] == n) {
                    Char2IntOpenCustomHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if ((c2 = cArray[n2 = n2 + 1 & this.this$0.mask]) != '\u0000') continue;
                return true;
            } while (!this.this$0.strategy.equals(c2, c) || this.this$0.value[n2] != n);
            Char2IntOpenCustomHashMap.access$400(this.this$0, n2);
            return false;
        }
        ...
        MapEntrySet(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap, 1 var2_2) {
            this(char2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2IntMap.Entry> {
        ...
        private FastEntryIterator(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap) {
            this.this$0 = char2IntOpenCustomHashMap;
            super(char2IntOpenCustomHashMap, null);
        ...
        FastEntryIterator(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap, 1 var2_2) {
            this(char2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2IntMap.Entry> {
        ...
        private EntryIterator(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap) {
            this.this$0 = char2IntOpenCustomHashMap;
            super(char2IntOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap, 1 var2_2) {
            this(char2IntOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap) {
            this.this$0 = char2IntOpenCustomHashMap;
        ...
        MapIterator(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap, 1 var2_2) {
            this(char2IntOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Character, Integer> {
        ...
        MapEntry(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap, int n) {
            this.this$0 = char2IntOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Char2IntOpenCustomHashMap char2IntOpenCustomHashMap) {
            this.this$0 = char2IntOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], ((Character)entry.getKey()).charValue()) && this.this$0.value[this.index] == (Integer)entry.getValue();
        }
