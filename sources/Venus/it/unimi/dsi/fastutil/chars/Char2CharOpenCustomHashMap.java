...
Hash {
    ...
    public Char2CharOpenCustomHashMap(int n, float f, CharHash.Strategy strategy) {
    ...
    public Char2CharOpenCustomHashMap(int n, CharHash.Strategy strategy) {
    ...
    public Char2CharOpenCustomHashMap(Map<? extends Character, ? extends Character> map, float f, CharHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Char2CharOpenCustomHashMap(Map<? extends Character, ? extends Character> map, CharHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Char2CharOpenCustomHashMap(Char2CharMap char2CharMap, float f, CharHash.Strategy strategy) {
        this(char2CharMap.size(), f, strategy);
        this.putAll(char2CharMap);
    }

    public Char2CharOpenCustomHashMap(Char2CharMap char2CharMap, CharHash.Strategy strategy) {
        this(char2CharMap, 0.75f, strategy);
    }

    public Char2CharOpenCustomHashMap(char[] cArray, char[] cArray2, float f, CharHash.Strategy strategy) {
    ...
    public Char2CharOpenCustomHashMap(char[] cArray, char[] cArray2, CharHash.Strategy strategy) {
        this(cArray, cArray2, 0.75f, strategy);
    }
    ...
    public char getOrDefault(char c, char c2) {
        ...
        do {
            ...
            return c2;
        } while (!this.strategy.equals(c, c3));
        return this.value[n];
    }
    ...
    public boolean remove(char c, char c2) {
        ...
        if (this.strategy.equals(c, c3) && c2 == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((c3 = cArray[n = n + 1 & this.mask]) != '\u0000') continue;
            return true;
        } while (!this.strategy.equals(c, c3) || c2 != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public CharCollection values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection(this){
                final Char2CharOpenCustomHashMap this$0;
                {
                    this.this$0 = char2CharOpenCustomHashMap;
                }
    ...
    public Char2CharOpenCustomHashMap clone() {
        Char2CharOpenCustomHashMap char2CharOpenCustomHashMap;
        try {
            char2CharOpenCustomHashMap = (Char2CharOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2CharOpenCustomHashMap.keys = null;
        char2CharOpenCustomHashMap.values = null;
        char2CharOpenCustomHashMap.entries = null;
        char2CharOpenCustomHashMap.containsNullKey = this.containsNullKey;
        char2CharOpenCustomHashMap.key = (char[])this.key.clone();
        char2CharOpenCustomHashMap.value = (char[])this.value.clone();
        char2CharOpenCustomHashMap.strategy = this.strategy;
        return char2CharOpenCustomHashMap;
    }
    ...
    static char access$300(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap) {
        return char2CharOpenCustomHashMap.removeNullEntry();
    }

    static char access$400(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap, int n) {
        return char2CharOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements CharIterator {
        ...
        public ValueIterator(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap) {
            this.this$0 = char2CharOpenCustomHashMap;
            super(char2CharOpenCustomHashMap, null);
        }
    ...
    extends AbstractCharSet {
        ...
        private KeySet(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap) {
            this.this$0 = char2CharOpenCustomHashMap;
        }
        ...
        KeySet(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap, 1 var2_2) {
            this(char2CharOpenCustomHashMap);
        }
    }
    ...
    implements CharIterator {
        ...
        public KeyIterator(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap) {
            this.this$0 = char2CharOpenCustomHashMap;
            super(char2CharOpenCustomHashMap, null);
        }
    ...
    implements Char2CharMap.FastEntrySet {
        ...
        private MapEntrySet(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap) {
            this.this$0 = char2CharOpenCustomHashMap;
        }
        ...
        public boolean contains(Object object) {
            ...
            if (this.this$0.strategy.equals(c, c3)) {
                return this.this$0.value[n] == c2;
            }
            do {
                if ((c3 = cArray[n = n + 1 & this.this$0.mask]) != '\u0000') continue;
                return true;
            } while (!this.this$0.strategy.equals(c, c3));
            return this.this$0.value[n] == c2;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(c, '\u0000')) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == c2) {
                    Char2CharOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(c3, c)) {
                if (this.this$0.value[n] == c2) {
                    Char2CharOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((c3 = cArray[n = n + 1 & this.this$0.mask]) != '\u0000') continue;
                return true;
            } while (!this.this$0.strategy.equals(c3, c) || this.this$0.value[n] != c2);
            Char2CharOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap, 1 var2_2) {
            this(char2CharOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2CharMap.Entry> {
        ...
        private FastEntryIterator(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap) {
            this.this$0 = char2CharOpenCustomHashMap;
            super(char2CharOpenCustomHashMap, null);
        ...
        FastEntryIterator(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap, 1 var2_2) {
            this(char2CharOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2CharMap.Entry> {
        ...
        private EntryIterator(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap) {
            this.this$0 = char2CharOpenCustomHashMap;
            super(char2CharOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap, 1 var2_2) {
            this(char2CharOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap) {
            this.this$0 = char2CharOpenCustomHashMap;
        ...
        MapIterator(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap, 1 var2_2) {
            this(char2CharOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Character, Character> {
        ...
        MapEntry(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap, int n) {
            this.this$0 = char2CharOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Char2CharOpenCustomHashMap char2CharOpenCustomHashMap) {
            this.this$0 = char2CharOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], ((Character)entry.getKey()).charValue()) && this.this$0.value[this.index] == ((Character)entry.getValue()).charValue();
        }
