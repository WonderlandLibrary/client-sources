...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Char2BooleanAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Char2BooleanAVLTreeMap(Comparator<? super Character> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Char2BooleanAVLTreeMap(Map<? extends Character, ? extends Boolean> map) {
        this();
        this.putAll(map);
    }

    public Char2BooleanAVLTreeMap(SortedMap<Character, Boolean> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Character, ? extends Boolean>)sortedMap);
    }

    public Char2BooleanAVLTreeMap(Char2BooleanMap char2BooleanMap) {
        this();
        this.putAll(char2BooleanMap);
    }

    public Char2BooleanAVLTreeMap(Char2BooleanSortedMap char2BooleanSortedMap) {
        this(char2BooleanSortedMap.comparator());
        this.putAll(char2BooleanSortedMap);
    }

    public Char2BooleanAVLTreeMap(char[] cArray, boolean[] blArray, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2BooleanAVLTreeMap(char[] cArray, boolean[] blArray) {
        this(cArray, blArray, null);
    }
    ...
    public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2BooleanMap.Entry>(this){
                final Comparator<? super Char2BooleanMap.Entry> comparator;
                final Char2BooleanAVLTreeMap this$0;
                {
                    this.this$0 = char2BooleanAVLTreeMap;
                ...
                public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry entry, Char2BooleanMap.Entry entry2) {
                    return this.this$0.subMap(entry.getCharKey(), entry2.getCharKey()).char2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry entry) {
                    return this.this$0.headMap(entry.getCharKey()).char2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry entry) {
                    return this.this$0.tailMap(entry.getCharKey()).char2BooleanEntrySet();
                }
                ...
                private int lambda$$0(Char2BooleanMap.Entry entry, Char2BooleanMap.Entry entry2) {
    ...
    public Char2BooleanAVLTreeMap clone() {
        Char2BooleanAVLTreeMap char2BooleanAVLTreeMap;
        try {
            char2BooleanAVLTreeMap = (Char2BooleanAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2BooleanAVLTreeMap.keys = null;
        char2BooleanAVLTreeMap.values = null;
        char2BooleanAVLTreeMap.entries = null;
        char2BooleanAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2BooleanAVLTreeMap.firstEntry = char2BooleanAVLTreeMap.tree = entry2.left;
                            while (char2BooleanAVLTreeMap.firstEntry.left != null) {
                                char2BooleanAVLTreeMap.firstEntry = char2BooleanAVLTreeMap.firstEntry.left;
                            }
                            char2BooleanAVLTreeMap.lastEntry = char2BooleanAVLTreeMap.tree;
                            while (char2BooleanAVLTreeMap.lastEntry.right != null) {
                                char2BooleanAVLTreeMap.lastEntry = char2BooleanAVLTreeMap.lastEntry.right;
                            }
                            return char2BooleanAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readChar(), objectInputStream.readBoolean());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readChar(), objectInputStream.readBoolean());
            entry4.right(new Entry(objectInputStream.readChar(), objectInputStream.readBoolean()));
    ...
    implements Serializable {
        ...
        public Submap(Char2BooleanAVLTreeMap char2BooleanAVLTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2BooleanAVLTreeMap;
            if (!bl && !bl2 && char2BooleanAVLTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2BooleanAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2BooleanMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Char2BooleanMap.Entry> comparator() {
                        return this.this$1.this$0.char2BooleanEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry entry, Char2BooleanMap.Entry entry2) {
                        return this.this$1.subMap(entry.getCharKey(), entry2.getCharKey()).char2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry entry) {
                        return this.this$1.headMap(entry.getCharKey()).char2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry entry) {
                        return this.this$1.tailMap(entry.getCharKey()).char2BooleanEntrySet();
                    }
        ...
        public boolean put(char c, boolean bl) {
            ...
            boolean bl2 = this.this$0.put(c, bl);
        ...
        public boolean remove(char c) {
            ...
            boolean bl = this.this$0.remove(c);
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Char2BooleanAVLTreeMap char2BooleanAVLTreeMap) {
            this.this$0 = char2BooleanAVLTreeMap;
            super(char2BooleanAVLTreeMap);
        }
        ...
        ValueIterator(Char2BooleanAVLTreeMap char2BooleanAVLTreeMap, 1 var2_2) {
            this(char2BooleanAVLTreeMap);
        }
    }
    ...
    extends AbstractChar2BooleanSortedMap.KeySet {
        ...
        private KeySet(Char2BooleanAVLTreeMap char2BooleanAVLTreeMap) {
            this.this$0 = char2BooleanAVLTreeMap;
            super(char2BooleanAVLTreeMap);
        }
        ...
        KeySet(Char2BooleanAVLTreeMap char2BooleanAVLTreeMap, 1 var2_2) {
            this(char2BooleanAVLTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2BooleanAVLTreeMap char2BooleanAVLTreeMap) {
            this.this$0 = char2BooleanAVLTreeMap;
            super(char2BooleanAVLTreeMap);
        }

        public KeyIterator(Char2BooleanAVLTreeMap char2BooleanAVLTreeMap, char c) {
            this.this$0 = char2BooleanAVLTreeMap;
            super(char2BooleanAVLTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2BooleanMap.Entry> {
        ...
        EntryIterator(Char2BooleanAVLTreeMap char2BooleanAVLTreeMap) {
            this.this$0 = char2BooleanAVLTreeMap;
            super(char2BooleanAVLTreeMap);
        }

        EntryIterator(Char2BooleanAVLTreeMap char2BooleanAVLTreeMap, char c) {
            this.this$0 = char2BooleanAVLTreeMap;
            super(char2BooleanAVLTreeMap, c);
        }
        ...
        public void add(Object object) {
            this.add((Char2BooleanMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Char2BooleanMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2BooleanAVLTreeMap char2BooleanAVLTreeMap) {
            this.this$0 = char2BooleanAVLTreeMap;
            this.index = 0;
            this.next = char2BooleanAVLTreeMap.firstEntry;
        }

        TreeIterator(Char2BooleanAVLTreeMap char2BooleanAVLTreeMap, char c) {
            this.this$0 = char2BooleanAVLTreeMap;
            this.index = 0;
            this.next = char2BooleanAVLTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2BooleanAVLTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == ((Character)entry.getKey()).charValue() && this.value == (Boolean)entry.getValue();
        }
