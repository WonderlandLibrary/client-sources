...
Cloneable {
    ...
    public Char2IntRBTreeMap(Comparator<? super Character> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Char2IntRBTreeMap(Map<? extends Character, ? extends Integer> map) {
        this();
        this.putAll(map);
    }

    public Char2IntRBTreeMap(SortedMap<Character, Integer> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Character, ? extends Integer>)sortedMap);
    }

    public Char2IntRBTreeMap(Char2IntMap char2IntMap) {
        this();
        this.putAll(char2IntMap);
    }

    public Char2IntRBTreeMap(Char2IntSortedMap char2IntSortedMap) {
        this(char2IntSortedMap.comparator());
        this.putAll(char2IntSortedMap);
    }

    public Char2IntRBTreeMap(char[] cArray, int[] nArray, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2IntRBTreeMap(char[] cArray, int[] nArray) {
    ...
    public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2IntMap.Entry>(this){
                ...
                final Char2IntRBTreeMap this$0;
                {
                    this.this$0 = char2IntRBTreeMap;
    ...
    public Char2IntRBTreeMap clone() {
        Char2IntRBTreeMap char2IntRBTreeMap;
        try {
            char2IntRBTreeMap = (Char2IntRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2IntRBTreeMap.keys = null;
        char2IntRBTreeMap.values = null;
        char2IntRBTreeMap.entries = null;
        char2IntRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2IntRBTreeMap.firstEntry = char2IntRBTreeMap.tree = entry2.left;
                            while (char2IntRBTreeMap.firstEntry.left != null) {
                                char2IntRBTreeMap.firstEntry = char2IntRBTreeMap.firstEntry.left;
                            }
                            char2IntRBTreeMap.lastEntry = char2IntRBTreeMap.tree;
                            while (char2IntRBTreeMap.lastEntry.right != null) {
                                char2IntRBTreeMap.lastEntry = char2IntRBTreeMap.lastEntry.right;
                            }
                            return char2IntRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Char2IntRBTreeMap char2IntRBTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2IntRBTreeMap;
            if (!bl && !bl2 && char2IntRBTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2IntRBTreeMap.defRetValue;
        }
    ...
    implements IntListIterator {
        ...
        private ValueIterator(Char2IntRBTreeMap char2IntRBTreeMap) {
            this.this$0 = char2IntRBTreeMap;
            super(char2IntRBTreeMap);
        }
        ...
        ValueIterator(Char2IntRBTreeMap char2IntRBTreeMap, 1 var2_2) {
            this(char2IntRBTreeMap);
        }
    }
    ...
    extends AbstractChar2IntSortedMap.KeySet {
        ...
        private KeySet(Char2IntRBTreeMap char2IntRBTreeMap) {
            this.this$0 = char2IntRBTreeMap;
            super(char2IntRBTreeMap);
        }
        ...
        KeySet(Char2IntRBTreeMap char2IntRBTreeMap, 1 var2_2) {
            this(char2IntRBTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2IntRBTreeMap char2IntRBTreeMap) {
            this.this$0 = char2IntRBTreeMap;
            super(char2IntRBTreeMap);
        }

        public KeyIterator(Char2IntRBTreeMap char2IntRBTreeMap, char c) {
            this.this$0 = char2IntRBTreeMap;
            super(char2IntRBTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2IntMap.Entry> {
        ...
        EntryIterator(Char2IntRBTreeMap char2IntRBTreeMap) {
            this.this$0 = char2IntRBTreeMap;
            super(char2IntRBTreeMap);
        }

        EntryIterator(Char2IntRBTreeMap char2IntRBTreeMap, char c) {
            this.this$0 = char2IntRBTreeMap;
            super(char2IntRBTreeMap, c);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2IntRBTreeMap char2IntRBTreeMap) {
            this.this$0 = char2IntRBTreeMap;
            this.index = 0;
            this.next = char2IntRBTreeMap.firstEntry;
        }

        TreeIterator(Char2IntRBTreeMap char2IntRBTreeMap, char c) {
            this.this$0 = char2IntRBTreeMap;
            this.index = 0;
            this.next = char2IntRBTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2IntRBTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
