...
Cloneable {
    ...
    public Char2BooleanRBTreeMap(Comparator<? super Character> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Char2BooleanRBTreeMap(Map<? extends Character, ? extends Boolean> map) {
        this();
        this.putAll(map);
    }

    public Char2BooleanRBTreeMap(SortedMap<Character, Boolean> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Character, ? extends Boolean>)sortedMap);
    }

    public Char2BooleanRBTreeMap(Char2BooleanMap char2BooleanMap) {
        this();
        this.putAll(char2BooleanMap);
    }

    public Char2BooleanRBTreeMap(Char2BooleanSortedMap char2BooleanSortedMap) {
        this(char2BooleanSortedMap.comparator());
        this.putAll(char2BooleanSortedMap);
    }

    public Char2BooleanRBTreeMap(char[] cArray, boolean[] blArray, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2BooleanRBTreeMap(char[] cArray, boolean[] blArray) {
    ...
    public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2BooleanMap.Entry>(this){
                ...
                final Char2BooleanRBTreeMap this$0;
                {
                    this.this$0 = char2BooleanRBTreeMap;
    ...
    public Char2BooleanRBTreeMap clone() {
        Char2BooleanRBTreeMap char2BooleanRBTreeMap;
        try {
            char2BooleanRBTreeMap = (Char2BooleanRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2BooleanRBTreeMap.keys = null;
        char2BooleanRBTreeMap.values = null;
        char2BooleanRBTreeMap.entries = null;
        char2BooleanRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2BooleanRBTreeMap.firstEntry = char2BooleanRBTreeMap.tree = entry2.left;
                            while (char2BooleanRBTreeMap.firstEntry.left != null) {
                                char2BooleanRBTreeMap.firstEntry = char2BooleanRBTreeMap.firstEntry.left;
                            }
                            char2BooleanRBTreeMap.lastEntry = char2BooleanRBTreeMap.tree;
                            while (char2BooleanRBTreeMap.lastEntry.right != null) {
                                char2BooleanRBTreeMap.lastEntry = char2BooleanRBTreeMap.lastEntry.right;
                            }
                            return char2BooleanRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Char2BooleanRBTreeMap char2BooleanRBTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2BooleanRBTreeMap;
            if (!bl && !bl2 && char2BooleanRBTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2BooleanRBTreeMap.defRetValue;
        }
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Char2BooleanRBTreeMap char2BooleanRBTreeMap) {
            this.this$0 = char2BooleanRBTreeMap;
            super(char2BooleanRBTreeMap);
        }
        ...
        ValueIterator(Char2BooleanRBTreeMap char2BooleanRBTreeMap, 1 var2_2) {
            this(char2BooleanRBTreeMap);
        }
    }
    ...
    extends AbstractChar2BooleanSortedMap.KeySet {
        ...
        private KeySet(Char2BooleanRBTreeMap char2BooleanRBTreeMap) {
            this.this$0 = char2BooleanRBTreeMap;
            super(char2BooleanRBTreeMap);
        }
        ...
        KeySet(Char2BooleanRBTreeMap char2BooleanRBTreeMap, 1 var2_2) {
            this(char2BooleanRBTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2BooleanRBTreeMap char2BooleanRBTreeMap) {
            this.this$0 = char2BooleanRBTreeMap;
            super(char2BooleanRBTreeMap);
        }

        public KeyIterator(Char2BooleanRBTreeMap char2BooleanRBTreeMap, char c) {
            this.this$0 = char2BooleanRBTreeMap;
            super(char2BooleanRBTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2BooleanMap.Entry> {
        ...
        EntryIterator(Char2BooleanRBTreeMap char2BooleanRBTreeMap) {
            this.this$0 = char2BooleanRBTreeMap;
            super(char2BooleanRBTreeMap);
        }

        EntryIterator(Char2BooleanRBTreeMap char2BooleanRBTreeMap, char c) {
            this.this$0 = char2BooleanRBTreeMap;
            super(char2BooleanRBTreeMap, c);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2BooleanRBTreeMap char2BooleanRBTreeMap) {
            this.this$0 = char2BooleanRBTreeMap;
            this.index = 0;
            this.next = char2BooleanRBTreeMap.firstEntry;
        }

        TreeIterator(Char2BooleanRBTreeMap char2BooleanRBTreeMap, char c) {
            this.this$0 = char2BooleanRBTreeMap;
            this.index = 0;
            this.next = char2BooleanRBTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2BooleanRBTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
