...
Hash {
    ...
    public Char2DoubleOpenCustomHashMap(int n, float f, CharHash.Strategy strategy) {
    ...
    public Char2DoubleOpenCustomHashMap(int n, CharHash.Strategy strategy) {
    ...
    public Char2DoubleOpenCustomHashMap(Map<? extends Character, ? extends Double> map, float f, CharHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Char2DoubleOpenCustomHashMap(Map<? extends Character, ? extends Double> map, CharHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Char2DoubleOpenCustomHashMap(Char2DoubleMap char2DoubleMap, float f, CharHash.Strategy strategy) {
        this(char2DoubleMap.size(), f, strategy);
        this.putAll(char2DoubleMap);
    }

    public Char2DoubleOpenCustomHashMap(Char2DoubleMap char2DoubleMap, CharHash.Strategy strategy) {
        this(char2DoubleMap, 0.75f, strategy);
    }

    public Char2DoubleOpenCustomHashMap(char[] cArray, double[] dArray, float f, CharHash.Strategy strategy) {
    ...
    public Char2DoubleOpenCustomHashMap(char[] cArray, double[] dArray, CharHash.Strategy strategy) {
        this(cArray, dArray, 0.75f, strategy);
    }
    ...
    public boolean remove(char c, double d) {
        ...
        if (this.strategy.equals(c, c2) && Double.doubleToLongBits(d) == Double.doubleToLongBits(this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if ((c2 = cArray[n = n + 1 & this.mask]) != '\u0000') continue;
            return true;
        } while (!this.strategy.equals(c, c2) || Double.doubleToLongBits(d) != Double.doubleToLongBits(this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(this){
                final Char2DoubleOpenCustomHashMap this$0;
                {
                    this.this$0 = char2DoubleOpenCustomHashMap;
                }
    ...
    public Char2DoubleOpenCustomHashMap clone() {
        Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap;
        try {
            char2DoubleOpenCustomHashMap = (Char2DoubleOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2DoubleOpenCustomHashMap.keys = null;
        char2DoubleOpenCustomHashMap.values = null;
        char2DoubleOpenCustomHashMap.entries = null;
        char2DoubleOpenCustomHashMap.containsNullKey = this.containsNullKey;
        char2DoubleOpenCustomHashMap.key = (char[])this.key.clone();
        char2DoubleOpenCustomHashMap.value = (double[])this.value.clone();
        char2DoubleOpenCustomHashMap.strategy = this.strategy;
        return char2DoubleOpenCustomHashMap;
    }
    ...
    static double access$300(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap) {
        return char2DoubleOpenCustomHashMap.removeNullEntry();
    }

    static double access$400(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap, int n) {
        return char2DoubleOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements DoubleIterator {
        ...
        public ValueIterator(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap) {
            this.this$0 = char2DoubleOpenCustomHashMap;
            super(char2DoubleOpenCustomHashMap, null);
        }
    ...
    extends AbstractCharSet {
        ...
        private KeySet(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap) {
            this.this$0 = char2DoubleOpenCustomHashMap;
        }
        ...
        KeySet(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap, 1 var2_2) {
            this(char2DoubleOpenCustomHashMap);
        }
    }
    ...
    implements CharIterator {
        ...
        public KeyIterator(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap) {
            this.this$0 = char2DoubleOpenCustomHashMap;
            super(char2DoubleOpenCustomHashMap, null);
        }
    ...
    implements Char2DoubleMap.FastEntrySet {
        ...
        private MapEntrySet(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap) {
            this.this$0 = char2DoubleOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(c, '\u0000')) {
                if (this.this$0.containsNullKey && Double.doubleToLongBits(this.this$0.value[this.this$0.n]) == Double.doubleToLongBits(d)) {
                    Char2DoubleOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(c2, c)) {
                if (Double.doubleToLongBits(this.this$0.value[n]) == Double.doubleToLongBits(d)) {
                    Char2DoubleOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if ((c2 = cArray[n = n + 1 & this.this$0.mask]) != '\u0000') continue;
                return true;
            } while (!this.this$0.strategy.equals(c2, c) || Double.doubleToLongBits(this.this$0.value[n]) != Double.doubleToLongBits(d));
            Char2DoubleOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap, 1 var2_2) {
            this(char2DoubleOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2DoubleMap.Entry> {
        ...
        private FastEntryIterator(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap) {
            this.this$0 = char2DoubleOpenCustomHashMap;
            super(char2DoubleOpenCustomHashMap, null);
        ...
        FastEntryIterator(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap, 1 var2_2) {
            this(char2DoubleOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Char2DoubleMap.Entry> {
        ...
        private EntryIterator(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap) {
            this.this$0 = char2DoubleOpenCustomHashMap;
            super(char2DoubleOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap, 1 var2_2) {
            this(char2DoubleOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap) {
            this.this$0 = char2DoubleOpenCustomHashMap;
        ...
        MapIterator(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap, 1 var2_2) {
            this(char2DoubleOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Character, Double> {
        ...
        MapEntry(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap, int n) {
            this.this$0 = char2DoubleOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Char2DoubleOpenCustomHashMap char2DoubleOpenCustomHashMap) {
            this.this$0 = char2DoubleOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], ((Character)entry.getKey()).charValue()) && Double.doubleToLongBits(this.this$0.value[this.index]) == Double.doubleToLongBits((Double)entry.getValue());
        }
