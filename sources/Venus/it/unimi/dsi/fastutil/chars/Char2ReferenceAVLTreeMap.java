...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Char2ReferenceAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Char2ReferenceAVLTreeMap(Comparator<? super Character> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Char2ReferenceAVLTreeMap(Map<? extends Character, ? extends V> map) {
        this();
        this.putAll((Map<Character, ? extends V>)map);
    }

    public Char2ReferenceAVLTreeMap(SortedMap<Character, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Character, V>)sortedMap);
    }

    public Char2ReferenceAVLTreeMap(Char2ReferenceMap<? extends V> char2ReferenceMap) {
        this();
        this.putAll(char2ReferenceMap);
    }

    public Char2ReferenceAVLTreeMap(Char2ReferenceSortedMap<V> char2ReferenceSortedMap) {
        this(char2ReferenceSortedMap.comparator());
        this.putAll(char2ReferenceSortedMap);
    }

    public Char2ReferenceAVLTreeMap(char[] cArray, V[] VArray, Comparator<? super Character> comparator) {
        this(comparator);
    ...
    public Char2ReferenceAVLTreeMap(char[] cArray, V[] VArray) {
    ...
    public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ReferenceMap.Entry<V>>(this){
                final Comparator<? super Char2ReferenceMap.Entry<V>> comparator;
                final Char2ReferenceAVLTreeMap this$0;
                {
                    this.this$0 = char2ReferenceAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> iterator(Char2ReferenceMap.Entry<V> entry) {
                ...
                public ObjectSortedSet<Char2ReferenceMap.Entry<V>> subSet(Char2ReferenceMap.Entry<V> entry, Char2ReferenceMap.Entry<V> entry2) {
                    return this.this$0.subMap(entry.getCharKey(), entry2.getCharKey()).char2ReferenceEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2ReferenceMap.Entry<V>> headSet(Char2ReferenceMap.Entry<V> entry) {
                    return this.this$0.headMap(entry.getCharKey()).char2ReferenceEntrySet();
                }

                @Override
                public ObjectSortedSet<Char2ReferenceMap.Entry<V>> tailSet(Char2ReferenceMap.Entry<V> entry) {
                    return this.this$0.tailMap(entry.getCharKey()).char2ReferenceEntrySet();
                }
                ...
                private int lambda$$0(Char2ReferenceMap.Entry entry, Char2ReferenceMap.Entry entry2) {
    ...
    public Char2ReferenceAVLTreeMap<V> clone() {
        Char2ReferenceAVLTreeMap char2ReferenceAVLTreeMap;
        try {
            char2ReferenceAVLTreeMap = (Char2ReferenceAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        char2ReferenceAVLTreeMap.keys = null;
        char2ReferenceAVLTreeMap.values = null;
        char2ReferenceAVLTreeMap.entries = null;
        char2ReferenceAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            char2ReferenceAVLTreeMap.tree = entry2.left;
                            char2ReferenceAVLTreeMap.firstEntry = char2ReferenceAVLTreeMap.tree;
                            while (char2ReferenceAVLTreeMap.firstEntry.left != null) {
                                char2ReferenceAVLTreeMap.firstEntry = char2ReferenceAVLTreeMap.firstEntry.left;
                            }
                            char2ReferenceAVLTreeMap.lastEntry = char2ReferenceAVLTreeMap.tree;
                            while (char2ReferenceAVLTreeMap.lastEntry.right != null) {
                                char2ReferenceAVLTreeMap.lastEntry = char2ReferenceAVLTreeMap.lastEntry.right;
                            }
                            return char2ReferenceAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Char2ReferenceAVLTreeMap char2ReferenceAVLTreeMap, char c, boolean bl, char c2, boolean bl2) {
            this.this$0 = char2ReferenceAVLTreeMap;
            if (!bl && !bl2 && char2ReferenceAVLTreeMap.compare(c, c2) > 0) {
            ...
            this.to = c2;
            this.top = bl2;
            this.defRetValue = char2ReferenceAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2ReferenceMap.Entry<V>>(this){
                    ...
                    @Override
                    public Comparator<? super Char2ReferenceMap.Entry<V>> comparator() {
                        return this.this$1.this$0.char2ReferenceEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Char2ReferenceMap.Entry<V>> subSet(Char2ReferenceMap.Entry<V> entry, Char2ReferenceMap.Entry<V> entry2) {
                        return this.this$1.subMap(entry.getCharKey(), entry2.getCharKey()).char2ReferenceEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Char2ReferenceMap.Entry<V>> headSet(Char2ReferenceMap.Entry<V> entry) {
                        return this.this$1.headMap(entry.getCharKey()).char2ReferenceEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Char2ReferenceMap.Entry<V>> tailSet(Char2ReferenceMap.Entry<V> entry) {
                        return this.this$1.tailMap(entry.getCharKey()).char2ReferenceEntrySet();
                    }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Char2ReferenceAVLTreeMap char2ReferenceAVLTreeMap) {
            this.this$0 = char2ReferenceAVLTreeMap;
            super(char2ReferenceAVLTreeMap);
        }
        ...
        ValueIterator(Char2ReferenceAVLTreeMap char2ReferenceAVLTreeMap, 1 var2_2) {
            this(char2ReferenceAVLTreeMap);
        }
    }
    ...
    extends AbstractChar2ReferenceSortedMap.KeySet {
        ...
        private KeySet(Char2ReferenceAVLTreeMap char2ReferenceAVLTreeMap) {
            this.this$0 = char2ReferenceAVLTreeMap;
            super(char2ReferenceAVLTreeMap);
        }
        ...
        KeySet(Char2ReferenceAVLTreeMap char2ReferenceAVLTreeMap, 1 var2_2) {
            this(char2ReferenceAVLTreeMap);
        }
    }
    ...
    implements CharListIterator {
        ...
        public KeyIterator(Char2ReferenceAVLTreeMap char2ReferenceAVLTreeMap) {
            this.this$0 = char2ReferenceAVLTreeMap;
            super(char2ReferenceAVLTreeMap);
        }

        public KeyIterator(Char2ReferenceAVLTreeMap char2ReferenceAVLTreeMap, char c) {
            this.this$0 = char2ReferenceAVLTreeMap;
            super(char2ReferenceAVLTreeMap, c);
        }
    ...
    implements ObjectListIterator<Char2ReferenceMap.Entry<V>> {
        ...
        EntryIterator(Char2ReferenceAVLTreeMap char2ReferenceAVLTreeMap) {
            this.this$0 = char2ReferenceAVLTreeMap;
            super(char2ReferenceAVLTreeMap);
        }

        EntryIterator(Char2ReferenceAVLTreeMap char2ReferenceAVLTreeMap, char c) {
            this.this$0 = char2ReferenceAVLTreeMap;
            super(char2ReferenceAVLTreeMap, c);
        }
        ...
        public void add(Object object) {
            this.add((Char2ReferenceMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Char2ReferenceMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Char2ReferenceAVLTreeMap char2ReferenceAVLTreeMap) {
            this.this$0 = char2ReferenceAVLTreeMap;
            this.index = 0;
            this.next = char2ReferenceAVLTreeMap.firstEntry;
        }

        TreeIterator(Char2ReferenceAVLTreeMap char2ReferenceAVLTreeMap, char c) {
            this.this$0 = char2ReferenceAVLTreeMap;
            this.index = 0;
            this.next = char2ReferenceAVLTreeMap.locateKey(c);
            if (this.next != null) {
                if (char2ReferenceAVLTreeMap.compare(this.next.key, c) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.key == ((Character)entry.getKey()).charValue() && this.value == entry.getValue();
        }
