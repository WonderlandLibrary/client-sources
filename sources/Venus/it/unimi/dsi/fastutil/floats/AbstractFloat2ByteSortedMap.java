...
implements Float2ByteSortedMap {
    ...
    implements ByteIterator {
        ...
        public ValuesIterator(ObjectBidirectionalIterator<Float2ByteMap.Entry> objectBidirectionalIterator) {
    ...
    extends AbstractByteCollection {
        final AbstractFloat2ByteSortedMap this$0;

        protected ValuesCollection(AbstractFloat2ByteSortedMap abstractFloat2ByteSortedMap) {
            this.this$0 = abstractFloat2ByteSortedMap;
        }

        @Override
        public ByteIterator iterator() {
            return new ValuesIterator(Float2ByteSortedMaps.fastIterator(this.this$0));
        }
    ...
    implements FloatBidirectionalIterator {
        ...
        public KeySetIterator(ObjectBidirectionalIterator<Float2ByteMap.Entry> objectBidirectionalIterator) {
            this.i = objectBidirectionalIterator;
        }
    ...
    extends AbstractFloatSortedSet {
        ...
        protected KeySet(AbstractFloat2ByteSortedMap abstractFloat2ByteSortedMap) {
            this.this$0 = abstractFloat2ByteSortedMap;
        }
        ...
        public FloatBidirectionalIterator iterator(float f) {
            return new KeySetIterator(this.this$0.float2ByteEntrySet().iterator(new AbstractFloat2ByteMap.BasicEntry(f, 0)));
        }

        @Override
        public FloatBidirectionalIterator iterator() {
            return new KeySetIterator(Float2ByteSortedMaps.fastIterator(this.this$0));
        }
