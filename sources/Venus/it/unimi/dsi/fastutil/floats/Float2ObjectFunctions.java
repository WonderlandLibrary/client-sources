...
public final class Float2ObjectFunctions {
    ...
    public static <V> Float2ObjectFunction<V> singleton(float f, V v) {
    ...
    public static <V> Float2ObjectFunction<V> synchronize(Float2ObjectFunction<V> float2ObjectFunction) {
        return new SynchronizedFunction<V>(float2ObjectFunction);
    }

    public static <V> Float2ObjectFunction<V> synchronize(Float2ObjectFunction<V> float2ObjectFunction, Object object) {
        return new SynchronizedFunction<V>(float2ObjectFunction, object);
    }

    public static <V> Float2ObjectFunction<V> unmodifiable(Float2ObjectFunction<V> float2ObjectFunction) {
        return new UnmodifiableFunction<V>(float2ObjectFunction);
    }

    public static <V> Float2ObjectFunction<V> primitive(java.util.function.Function<? super Float, ? extends V> function) {
        Objects.requireNonNull(function);
        if (function instanceof Float2ObjectFunction) {
            return (Float2ObjectFunction)function;
        }
    ...
    implements Serializable {
        ...
        protected UnmodifiableFunction(Float2ObjectFunction<V> float2ObjectFunction) {
            if (float2ObjectFunction == null) {
                throw new NullPointerException();
            }
            this.function = float2ObjectFunction;
        }
    ...
    Serializable {
        ...
        protected SynchronizedFunction(Float2ObjectFunction<V> float2ObjectFunction, Object object) {
            if (float2ObjectFunction == null) {
                throw new NullPointerException();
            }
            this.function = float2ObjectFunction;
        ...
        protected SynchronizedFunction(Float2ObjectFunction<V> float2ObjectFunction) {
            if (float2ObjectFunction == null) {
                throw new NullPointerException();
            }
            this.function = float2ObjectFunction;
