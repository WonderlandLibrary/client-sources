...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Float2BooleanAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Float2BooleanAVLTreeMap(float[] fArray, boolean[] blArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2BooleanAVLTreeMap(float[] fArray, boolean[] blArray) {
    ...
    public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2BooleanMap.Entry>(this){
                ...
                final Float2BooleanAVLTreeMap this$0;
                {
                    this.this$0 = float2BooleanAVLTreeMap;
    ...
    public Float2BooleanAVLTreeMap clone() {
        Float2BooleanAVLTreeMap float2BooleanAVLTreeMap;
        try {
            float2BooleanAVLTreeMap = (Float2BooleanAVLTreeMap)super.clone();
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2BooleanAVLTreeMap.firstEntry = float2BooleanAVLTreeMap.tree = entry2.left;
    ...
    implements Serializable {
        ...
        public Submap(Float2BooleanAVLTreeMap float2BooleanAVLTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2BooleanAVLTreeMap;
            if (!bl && !bl2 && float2BooleanAVLTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2BooleanAVLTreeMap.defRetValue;
        }
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Float2BooleanAVLTreeMap float2BooleanAVLTreeMap) {
            this.this$0 = float2BooleanAVLTreeMap;
            super(float2BooleanAVLTreeMap);
        }
        ...
        ValueIterator(Float2BooleanAVLTreeMap float2BooleanAVLTreeMap, 1 var2_2) {
            this(float2BooleanAVLTreeMap);
        }
    }
    ...
    extends AbstractFloat2BooleanSortedMap.KeySet {
        ...
        private KeySet(Float2BooleanAVLTreeMap float2BooleanAVLTreeMap) {
            this.this$0 = float2BooleanAVLTreeMap;
            super(float2BooleanAVLTreeMap);
        }
        ...
        KeySet(Float2BooleanAVLTreeMap float2BooleanAVLTreeMap, 1 var2_2) {
            this(float2BooleanAVLTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2BooleanAVLTreeMap float2BooleanAVLTreeMap) {
            this.this$0 = float2BooleanAVLTreeMap;
            super(float2BooleanAVLTreeMap);
        }

        public KeyIterator(Float2BooleanAVLTreeMap float2BooleanAVLTreeMap, float f) {
            this.this$0 = float2BooleanAVLTreeMap;
            super(float2BooleanAVLTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2BooleanMap.Entry> {
        ...
        EntryIterator(Float2BooleanAVLTreeMap float2BooleanAVLTreeMap) {
            this.this$0 = float2BooleanAVLTreeMap;
            super(float2BooleanAVLTreeMap);
        }

        EntryIterator(Float2BooleanAVLTreeMap float2BooleanAVLTreeMap, float f) {
            this.this$0 = float2BooleanAVLTreeMap;
            super(float2BooleanAVLTreeMap, f);
        }
        ...
        public void add(Object object) {
            this.add((Float2BooleanMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Float2BooleanMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2BooleanAVLTreeMap float2BooleanAVLTreeMap) {
            this.this$0 = float2BooleanAVLTreeMap;
            this.index = 0;
            this.next = float2BooleanAVLTreeMap.firstEntry;
        }

        TreeIterator(Float2BooleanAVLTreeMap float2BooleanAVLTreeMap, float f) {
            this.this$0 = float2BooleanAVLTreeMap;
            this.index = 0;
            this.next = float2BooleanAVLTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2BooleanAVLTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
