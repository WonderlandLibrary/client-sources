...
Hash {
    ...
    public Float2LongOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Float2LongOpenHashMap(Map<? extends Float, ? extends Long> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }
    ...
    public Float2LongOpenHashMap(Float2LongMap float2LongMap, float f) {
        this(float2LongMap.size(), f);
        this.putAll(float2LongMap);
    }

    public Float2LongOpenHashMap(Float2LongMap float2LongMap) {
        this(float2LongMap, 0.75f);
    }

    public Float2LongOpenHashMap(float[] fArray, long[] lArray, float f) {
    ...
    public Float2LongOpenHashMap(float[] fArray, long[] lArray) {
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection(this){
                final Float2LongOpenHashMap this$0;
                {
                    this.this$0 = float2LongOpenHashMap;
                }
    ...
    public Float2LongOpenHashMap clone() {
        Float2LongOpenHashMap float2LongOpenHashMap;
        try {
            float2LongOpenHashMap = (Float2LongOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2LongOpenHashMap.keys = null;
        float2LongOpenHashMap.values = null;
        float2LongOpenHashMap.entries = null;
        float2LongOpenHashMap.containsNullKey = this.containsNullKey;
        float2LongOpenHashMap.key = (float[])this.key.clone();
        float2LongOpenHashMap.value = (long[])this.value.clone();
    ...
    static long access$300(Float2LongOpenHashMap float2LongOpenHashMap) {
        return float2LongOpenHashMap.removeNullEntry();
    }

    static long access$400(Float2LongOpenHashMap float2LongOpenHashMap, int n) {
        return float2LongOpenHashMap.removeEntry(n);
    }
    ...
    implements LongIterator {
        ...
        public ValueIterator(Float2LongOpenHashMap float2LongOpenHashMap) {
            this.this$0 = float2LongOpenHashMap;
            super(float2LongOpenHashMap, null);
        }
    ...
    extends AbstractFloatSet {
        ...
        private KeySet(Float2LongOpenHashMap float2LongOpenHashMap) {
            this.this$0 = float2LongOpenHashMap;
        }
        ...
        KeySet(Float2LongOpenHashMap float2LongOpenHashMap, 1 var2_2) {
            this(float2LongOpenHashMap);
        }
    }
    ...
    implements FloatIterator {
        ...
        public KeyIterator(Float2LongOpenHashMap float2LongOpenHashMap) {
            this.this$0 = float2LongOpenHashMap;
            super(float2LongOpenHashMap, null);
        }
    ...
    implements Float2LongMap.FastEntrySet {
        ...
        private MapEntrySet(Float2LongOpenHashMap float2LongOpenHashMap) {
            this.this$0 = float2LongOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (Float.floatToIntBits(f) == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == l) {
                    Float2LongOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (Float.floatToIntBits(f2) == Float.floatToIntBits(f)) {
                if (this.this$0.value[n] == l) {
                    Float2LongOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Float2LongOpenHashMap float2LongOpenHashMap, 1 var2_2) {
            this(float2LongOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2LongMap.Entry> {
        ...
        private FastEntryIterator(Float2LongOpenHashMap float2LongOpenHashMap) {
            this.this$0 = float2LongOpenHashMap;
            super(float2LongOpenHashMap, null);
        ...
        FastEntryIterator(Float2LongOpenHashMap float2LongOpenHashMap, 1 var2_2) {
            this(float2LongOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2LongMap.Entry> {
        ...
        private EntryIterator(Float2LongOpenHashMap float2LongOpenHashMap) {
            this.this$0 = float2LongOpenHashMap;
            super(float2LongOpenHashMap, null);
        }
        ...
        EntryIterator(Float2LongOpenHashMap float2LongOpenHashMap, 1 var2_2) {
            this(float2LongOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Float2LongOpenHashMap float2LongOpenHashMap) {
            this.this$0 = float2LongOpenHashMap;
        ...
        MapIterator(Float2LongOpenHashMap float2LongOpenHashMap, 1 var2_2) {
            this(float2LongOpenHashMap);
        }
    }
    ...
    Map.Entry<Float, Long> {
        ...
        MapEntry(Float2LongOpenHashMap float2LongOpenHashMap, int n) {
            this.this$0 = float2LongOpenHashMap;
            this.index = n;
        }

        MapEntry(Float2LongOpenHashMap float2LongOpenHashMap) {
            this.this$0 = float2LongOpenHashMap;
        }
