...
Cloneable {
    ...
    public Float2BooleanRBTreeMap(Comparator<? super Float> comparator) {
        this();
    ...
    public Float2BooleanRBTreeMap(SortedMap<Float, Boolean> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Float, ? extends Boolean>)sortedMap);
    }

    public Float2BooleanRBTreeMap(Float2BooleanMap float2BooleanMap) {
        this();
        this.putAll(float2BooleanMap);
    }

    public Float2BooleanRBTreeMap(Float2BooleanSortedMap float2BooleanSortedMap) {
        this(float2BooleanSortedMap.comparator());
        this.putAll(float2BooleanSortedMap);
    }

    public Float2BooleanRBTreeMap(float[] fArray, boolean[] blArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2BooleanRBTreeMap(float[] fArray, boolean[] blArray) {
        this(fArray, blArray, null);
    }
    ...
    public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2BooleanMap.Entry>(this){
                final Comparator<? super Float2BooleanMap.Entry> comparator;
                final Float2BooleanRBTreeMap this$0;
                {
                    this.this$0 = float2BooleanRBTreeMap;
                ...
                public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry entry, Float2BooleanMap.Entry entry2) {
                    return this.this$0.subMap(entry.getFloatKey(), entry2.getFloatKey()).float2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Float2BooleanMap.Entry> headSet(Float2BooleanMap.Entry entry) {
                    return this.this$0.headMap(entry.getFloatKey()).float2BooleanEntrySet();
                }

                @Override
                public ObjectSortedSet<Float2BooleanMap.Entry> tailSet(Float2BooleanMap.Entry entry) {
                    return this.this$0.tailMap(entry.getFloatKey()).float2BooleanEntrySet();
                }
                ...
                private int lambda$$0(Float2BooleanMap.Entry entry, Float2BooleanMap.Entry entry2) {
    ...
    public Float2BooleanRBTreeMap clone() {
        Float2BooleanRBTreeMap float2BooleanRBTreeMap;
        try {
            float2BooleanRBTreeMap = (Float2BooleanRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2BooleanRBTreeMap.keys = null;
        float2BooleanRBTreeMap.values = null;
        float2BooleanRBTreeMap.entries = null;
        float2BooleanRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2BooleanRBTreeMap.firstEntry = float2BooleanRBTreeMap.tree = entry2.left;
                            while (float2BooleanRBTreeMap.firstEntry.left != null) {
                                float2BooleanRBTreeMap.firstEntry = float2BooleanRBTreeMap.firstEntry.left;
                            }
                            float2BooleanRBTreeMap.lastEntry = float2BooleanRBTreeMap.tree;
                            while (float2BooleanRBTreeMap.lastEntry.right != null) {
                                float2BooleanRBTreeMap.lastEntry = float2BooleanRBTreeMap.lastEntry.right;
                            }
                            return float2BooleanRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Float2BooleanRBTreeMap float2BooleanRBTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2BooleanRBTreeMap;
            if (!bl && !bl2 && float2BooleanRBTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2BooleanRBTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2BooleanMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Float2BooleanMap.Entry> comparator() {
                        return this.this$1.this$0.float2BooleanEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry entry, Float2BooleanMap.Entry entry2) {
                        return this.this$1.subMap(entry.getFloatKey(), entry2.getFloatKey()).float2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Float2BooleanMap.Entry> headSet(Float2BooleanMap.Entry entry) {
                        return this.this$1.headMap(entry.getFloatKey()).float2BooleanEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Float2BooleanMap.Entry> tailSet(Float2BooleanMap.Entry entry) {
                        return this.this$1.tailMap(entry.getFloatKey()).float2BooleanEntrySet();
                    }
        ...
        public boolean put(float f, boolean bl) {
            ...
            boolean bl2 = this.this$0.put(f, bl);
        ...
        public boolean remove(float f) {
            ...
            boolean bl = this.this$0.remove(f);
    ...
    implements BooleanListIterator {
        ...
        private ValueIterator(Float2BooleanRBTreeMap float2BooleanRBTreeMap) {
            this.this$0 = float2BooleanRBTreeMap;
            super(float2BooleanRBTreeMap);
        }
        ...
        ValueIterator(Float2BooleanRBTreeMap float2BooleanRBTreeMap, 1 var2_2) {
            this(float2BooleanRBTreeMap);
        }
    }
    ...
    extends AbstractFloat2BooleanSortedMap.KeySet {
        ...
        private KeySet(Float2BooleanRBTreeMap float2BooleanRBTreeMap) {
            this.this$0 = float2BooleanRBTreeMap;
            super(float2BooleanRBTreeMap);
        }
        ...
        KeySet(Float2BooleanRBTreeMap float2BooleanRBTreeMap, 1 var2_2) {
            this(float2BooleanRBTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2BooleanRBTreeMap float2BooleanRBTreeMap) {
            this.this$0 = float2BooleanRBTreeMap;
            super(float2BooleanRBTreeMap);
        }

        public KeyIterator(Float2BooleanRBTreeMap float2BooleanRBTreeMap, float f) {
            this.this$0 = float2BooleanRBTreeMap;
            super(float2BooleanRBTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2BooleanMap.Entry> {
        ...
        EntryIterator(Float2BooleanRBTreeMap float2BooleanRBTreeMap) {
            this.this$0 = float2BooleanRBTreeMap;
            super(float2BooleanRBTreeMap);
        }

        EntryIterator(Float2BooleanRBTreeMap float2BooleanRBTreeMap, float f) {
            this.this$0 = float2BooleanRBTreeMap;
            super(float2BooleanRBTreeMap, f);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2BooleanRBTreeMap float2BooleanRBTreeMap) {
            this.this$0 = float2BooleanRBTreeMap;
            this.index = 0;
            this.next = float2BooleanRBTreeMap.firstEntry;
        }

        TreeIterator(Float2BooleanRBTreeMap float2BooleanRBTreeMap, float f) {
            this.this$0 = float2BooleanRBTreeMap;
            this.index = 0;
            this.next = float2BooleanRBTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2BooleanRBTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)entry.getKey()).floatValue()) && this.value == (Boolean)entry.getValue();
        }
