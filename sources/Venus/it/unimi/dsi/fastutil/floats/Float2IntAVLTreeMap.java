...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Float2IntAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Float2IntAVLTreeMap(Comparator<? super Float> comparator) {
        this();
    ...
    public Float2IntAVLTreeMap(SortedMap<Float, Integer> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Float, ? extends Integer>)sortedMap);
    }

    public Float2IntAVLTreeMap(Float2IntMap float2IntMap) {
        this();
        this.putAll(float2IntMap);
    }

    public Float2IntAVLTreeMap(Float2IntSortedMap float2IntSortedMap) {
        this(float2IntSortedMap.comparator());
        this.putAll(float2IntSortedMap);
    }

    public Float2IntAVLTreeMap(float[] fArray, int[] nArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2IntAVLTreeMap(float[] fArray, int[] nArray) {
        this(fArray, nArray, null);
    }
    ...
    public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>(this){
                final Comparator<? super Float2IntMap.Entry> comparator;
                final Float2IntAVLTreeMap this$0;
                {
                    this.this$0 = float2IntAVLTreeMap;
                ...
                public ObjectSortedSet<Float2IntMap.Entry> subSet(Float2IntMap.Entry entry, Float2IntMap.Entry entry2) {
                    return this.this$0.subMap(entry.getFloatKey(), entry2.getFloatKey()).float2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Float2IntMap.Entry> headSet(Float2IntMap.Entry entry) {
                    return this.this$0.headMap(entry.getFloatKey()).float2IntEntrySet();
                }

                @Override
                public ObjectSortedSet<Float2IntMap.Entry> tailSet(Float2IntMap.Entry entry) {
                    return this.this$0.tailMap(entry.getFloatKey()).float2IntEntrySet();
                }
                ...
                private int lambda$$0(Float2IntMap.Entry entry, Float2IntMap.Entry entry2) {
    ...
    public Float2IntAVLTreeMap clone() {
        Float2IntAVLTreeMap float2IntAVLTreeMap;
        try {
            float2IntAVLTreeMap = (Float2IntAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2IntAVLTreeMap.keys = null;
        float2IntAVLTreeMap.values = null;
        float2IntAVLTreeMap.entries = null;
        float2IntAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2IntAVLTreeMap.firstEntry = float2IntAVLTreeMap.tree = entry2.left;
                            while (float2IntAVLTreeMap.firstEntry.left != null) {
                                float2IntAVLTreeMap.firstEntry = float2IntAVLTreeMap.firstEntry.left;
                            }
                            float2IntAVLTreeMap.lastEntry = float2IntAVLTreeMap.tree;
                            while (float2IntAVLTreeMap.lastEntry.right != null) {
                                float2IntAVLTreeMap.lastEntry = float2IntAVLTreeMap.lastEntry.right;
                            }
                            return float2IntAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readFloat(), objectInputStream.readInt());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readFloat(), objectInputStream.readInt());
            entry4.right(new Entry(objectInputStream.readFloat(), objectInputStream.readInt()));
    ...
    implements Serializable {
        ...
        public Submap(Float2IntAVLTreeMap float2IntAVLTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2IntAVLTreeMap;
            if (!bl && !bl2 && float2IntAVLTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2IntAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Float2IntMap.Entry> comparator() {
                        return this.this$1.this$0.float2IntEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Float2IntMap.Entry> subSet(Float2IntMap.Entry entry, Float2IntMap.Entry entry2) {
                        return this.this$1.subMap(entry.getFloatKey(), entry2.getFloatKey()).float2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Float2IntMap.Entry> headSet(Float2IntMap.Entry entry) {
                        return this.this$1.headMap(entry.getFloatKey()).float2IntEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Float2IntMap.Entry> tailSet(Float2IntMap.Entry entry) {
                        return this.this$1.tailMap(entry.getFloatKey()).float2IntEntrySet();
                    }
    ...
    implements IntListIterator {
        ...
        private ValueIterator(Float2IntAVLTreeMap float2IntAVLTreeMap) {
            this.this$0 = float2IntAVLTreeMap;
            super(float2IntAVLTreeMap);
        }
        ...
        ValueIterator(Float2IntAVLTreeMap float2IntAVLTreeMap, 1 var2_2) {
            this(float2IntAVLTreeMap);
        }
    }
    ...
    extends AbstractFloat2IntSortedMap.KeySet {
        ...
        private KeySet(Float2IntAVLTreeMap float2IntAVLTreeMap) {
            this.this$0 = float2IntAVLTreeMap;
            super(float2IntAVLTreeMap);
        }
        ...
        KeySet(Float2IntAVLTreeMap float2IntAVLTreeMap, 1 var2_2) {
            this(float2IntAVLTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2IntAVLTreeMap float2IntAVLTreeMap) {
            this.this$0 = float2IntAVLTreeMap;
            super(float2IntAVLTreeMap);
        }

        public KeyIterator(Float2IntAVLTreeMap float2IntAVLTreeMap, float f) {
            this.this$0 = float2IntAVLTreeMap;
            super(float2IntAVLTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2IntMap.Entry> {
        ...
        EntryIterator(Float2IntAVLTreeMap float2IntAVLTreeMap) {
            this.this$0 = float2IntAVLTreeMap;
            super(float2IntAVLTreeMap);
        }

        EntryIterator(Float2IntAVLTreeMap float2IntAVLTreeMap, float f) {
            this.this$0 = float2IntAVLTreeMap;
            super(float2IntAVLTreeMap, f);
        }
        ...
        public void add(Object object) {
            this.add((Float2IntMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Float2IntMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2IntAVLTreeMap float2IntAVLTreeMap) {
            this.this$0 = float2IntAVLTreeMap;
            this.index = 0;
            this.next = float2IntAVLTreeMap.firstEntry;
        }

        TreeIterator(Float2IntAVLTreeMap float2IntAVLTreeMap, float f) {
            this.this$0 = float2IntAVLTreeMap;
            this.index = 0;
            this.next = float2IntAVLTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2IntAVLTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)entry.getKey()).floatValue()) && this.value == (Integer)entry.getValue();
        }
