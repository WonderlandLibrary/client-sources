...
Cloneable {
    ...
    public Float2DoubleRBTreeMap(Comparator<? super Float> comparator) {
        this();
    ...
    public Float2DoubleRBTreeMap(SortedMap<Float, Double> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Float, ? extends Double>)sortedMap);
    }

    public Float2DoubleRBTreeMap(Float2DoubleMap float2DoubleMap) {
        this();
        this.putAll(float2DoubleMap);
    }

    public Float2DoubleRBTreeMap(Float2DoubleSortedMap float2DoubleSortedMap) {
        this(float2DoubleSortedMap.comparator());
        this.putAll(float2DoubleSortedMap);
    }

    public Float2DoubleRBTreeMap(float[] fArray, double[] dArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2DoubleRBTreeMap(float[] fArray, double[] dArray) {
    ...
    public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>(this){
                ...
                final Float2DoubleRBTreeMap this$0;
                {
                    this.this$0 = float2DoubleRBTreeMap;
    ...
    public Float2DoubleRBTreeMap clone() {
        Float2DoubleRBTreeMap float2DoubleRBTreeMap;
        try {
            float2DoubleRBTreeMap = (Float2DoubleRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2DoubleRBTreeMap.keys = null;
        float2DoubleRBTreeMap.values = null;
        float2DoubleRBTreeMap.entries = null;
        float2DoubleRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2DoubleRBTreeMap.firstEntry = float2DoubleRBTreeMap.tree = entry2.left;
                            while (float2DoubleRBTreeMap.firstEntry.left != null) {
                                float2DoubleRBTreeMap.firstEntry = float2DoubleRBTreeMap.firstEntry.left;
                            }
                            float2DoubleRBTreeMap.lastEntry = float2DoubleRBTreeMap.tree;
                            while (float2DoubleRBTreeMap.lastEntry.right != null) {
                                float2DoubleRBTreeMap.lastEntry = float2DoubleRBTreeMap.lastEntry.right;
                            }
                            return float2DoubleRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Float2DoubleRBTreeMap float2DoubleRBTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2DoubleRBTreeMap;
            if (!bl && !bl2 && float2DoubleRBTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2DoubleRBTreeMap.defRetValue;
        }
    ...
    implements DoubleListIterator {
        ...
        private ValueIterator(Float2DoubleRBTreeMap float2DoubleRBTreeMap) {
            this.this$0 = float2DoubleRBTreeMap;
            super(float2DoubleRBTreeMap);
        }
        ...
        ValueIterator(Float2DoubleRBTreeMap float2DoubleRBTreeMap, 1 var2_2) {
            this(float2DoubleRBTreeMap);
        }
    }
    ...
    extends AbstractFloat2DoubleSortedMap.KeySet {
        ...
        private KeySet(Float2DoubleRBTreeMap float2DoubleRBTreeMap) {
            this.this$0 = float2DoubleRBTreeMap;
            super(float2DoubleRBTreeMap);
        }
        ...
        KeySet(Float2DoubleRBTreeMap float2DoubleRBTreeMap, 1 var2_2) {
            this(float2DoubleRBTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2DoubleRBTreeMap float2DoubleRBTreeMap) {
            this.this$0 = float2DoubleRBTreeMap;
            super(float2DoubleRBTreeMap);
        }

        public KeyIterator(Float2DoubleRBTreeMap float2DoubleRBTreeMap, float f) {
            this.this$0 = float2DoubleRBTreeMap;
            super(float2DoubleRBTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2DoubleMap.Entry> {
        ...
        EntryIterator(Float2DoubleRBTreeMap float2DoubleRBTreeMap) {
            this.this$0 = float2DoubleRBTreeMap;
            super(float2DoubleRBTreeMap);
        }

        EntryIterator(Float2DoubleRBTreeMap float2DoubleRBTreeMap, float f) {
            this.this$0 = float2DoubleRBTreeMap;
            super(float2DoubleRBTreeMap, f);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2DoubleRBTreeMap float2DoubleRBTreeMap) {
            this.this$0 = float2DoubleRBTreeMap;
            this.index = 0;
            this.next = float2DoubleRBTreeMap.firstEntry;
        }

        TreeIterator(Float2DoubleRBTreeMap float2DoubleRBTreeMap, float f) {
            this.this$0 = float2DoubleRBTreeMap;
            this.index = 0;
            this.next = float2DoubleRBTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2DoubleRBTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
