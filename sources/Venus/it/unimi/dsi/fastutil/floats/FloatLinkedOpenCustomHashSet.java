...
Hash {
    ...
    public FloatLinkedOpenCustomHashSet(int n, float f, FloatHash.Strategy strategy) {
    ...
    public FloatLinkedOpenCustomHashSet(int n, FloatHash.Strategy strategy) {
    ...
    public FloatLinkedOpenCustomHashSet(Collection<? extends Float> collection, float f, FloatHash.Strategy strategy) {
        this(collection.size(), f, strategy);
        this.addAll(collection);
    }

    public FloatLinkedOpenCustomHashSet(Collection<? extends Float> collection, FloatHash.Strategy strategy) {
        this(collection, 0.75f, strategy);
    }

    public FloatLinkedOpenCustomHashSet(FloatCollection floatCollection, float f, FloatHash.Strategy strategy) {
        this(floatCollection.size(), f, strategy);
        this.addAll(floatCollection);
    }

    public FloatLinkedOpenCustomHashSet(FloatCollection floatCollection, FloatHash.Strategy strategy) {
        this(floatCollection, 0.75f, strategy);
    }

    public FloatLinkedOpenCustomHashSet(FloatIterator floatIterator, float f, FloatHash.Strategy strategy) {
        this(16, f, strategy);
    ...
    public FloatLinkedOpenCustomHashSet(FloatIterator floatIterator, FloatHash.Strategy strategy) {
        this(floatIterator, 0.75f, strategy);
    }

    public FloatLinkedOpenCustomHashSet(Iterator<?> iterator2, float f, FloatHash.Strategy strategy) {
        this(FloatIterators.asFloatIterator(iterator2), f, strategy);
    }

    public FloatLinkedOpenCustomHashSet(Iterator<?> iterator2, FloatHash.Strategy strategy) {
        this(FloatIterators.asFloatIterator(iterator2), strategy);
    }

    public FloatLinkedOpenCustomHashSet(float[] fArray, int n, int n2, float f, FloatHash.Strategy strategy) {
    ...
    public FloatLinkedOpenCustomHashSet(float[] fArray, int n, int n2, FloatHash.Strategy strategy) {
        this(fArray, n, n2, 0.75f, strategy);
    }

    public FloatLinkedOpenCustomHashSet(float[] fArray, float f, FloatHash.Strategy strategy) {
        this(fArray, 0, fArray.length, f, strategy);
    }

    public FloatLinkedOpenCustomHashSet(float[] fArray, FloatHash.Strategy strategy) {
    ...
    public boolean addAndMoveToFirst(float f) {
        ...
        if (this.strategy.equals(f, 0.0f)) {
            ...
            while (Float.floatToIntBits(fArray[n]) != 0) {
                if (this.strategy.equals(f, fArray[n])) {
    ...
    protected void rehash(int n) {
        ...
        while (n6-- != 0) {
            int n7;
            if (this.strategy.equals(fArray[n3], 0.0f)) {
                n7 = n;
            } else {
                n7 = HashCommon.mix(this.strategy.hashCode(fArray[n3])) & n2;
    ...
    public FloatLinkedOpenCustomHashSet clone() {
        FloatLinkedOpenCustomHashSet floatLinkedOpenCustomHashSet;
        try {
            floatLinkedOpenCustomHashSet = (FloatLinkedOpenCustomHashSet)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        floatLinkedOpenCustomHashSet.key = (float[])this.key.clone();
        floatLinkedOpenCustomHashSet.containsNull = this.containsNull;
        floatLinkedOpenCustomHashSet.link = (long[])this.link.clone();
        floatLinkedOpenCustomHashSet.strategy = this.strategy;
        return floatLinkedOpenCustomHashSet;
    }
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        while (n2-- != 0) {
            ...
            if (this.strategy.equals(f, 0.0f)) {
                ...
                n3 = HashCommon.mix(this.strategy.hashCode(f)) & this.mask;
    ...
    implements FloatListIterator {
        ...
        int curr;
        int index;
        final FloatLinkedOpenCustomHashSet this$0;

        SetIterator(FloatLinkedOpenCustomHashSet floatLinkedOpenCustomHashSet) {
            this.this$0 = floatLinkedOpenCustomHashSet;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = floatLinkedOpenCustomHashSet.first;
            this.index = 0;
        }

        SetIterator(FloatLinkedOpenCustomHashSet floatLinkedOpenCustomHashSet, float f) {
            this.this$0 = floatLinkedOpenCustomHashSet;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (floatLinkedOpenCustomHashSet.strategy.equals(f, 0.0f)) {
                if (floatLinkedOpenCustomHashSet.containsNull) {
                    this.next = (int)floatLinkedOpenCustomHashSet.link[floatLinkedOpenCustomHashSet.n];
                    this.prev = floatLinkedOpenCustomHashSet.n;
                    return;
                }
                throw new NoSuchElementException("The key " + f + " does not belong to this set.");
            }
            if (floatLinkedOpenCustomHashSet.strategy.equals(floatLinkedOpenCustomHashSet.key[floatLinkedOpenCustomHashSet.last], f)) {
                this.prev = floatLinkedOpenCustomHashSet.last;
                this.index = floatLinkedOpenCustomHashSet.size;
                return;
            }
            float[] fArray = floatLinkedOpenCustomHashSet.key;
            int n = HashCommon.mix(floatLinkedOpenCustomHashSet.strategy.hashCode(f)) & floatLinkedOpenCustomHashSet.mask;
            while (Float.floatToIntBits(fArray[n]) != 0) {
                if (floatLinkedOpenCustomHashSet.strategy.equals(fArray[n], f)) {
                    this.next = (int)floatLinkedOpenCustomHashSet.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & floatLinkedOpenCustomHashSet.mask;
            }
            throw new NoSuchElementException("The key " + f + " does not belong to this set.");
        }
