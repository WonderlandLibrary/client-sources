...
Hash {
    ...
    public Float2IntOpenCustomHashMap(int n, float f, FloatHash.Strategy strategy) {
    ...
    public Float2IntOpenCustomHashMap(int n, FloatHash.Strategy strategy) {
    ...
    public Float2IntOpenCustomHashMap(Map<? extends Float, ? extends Integer> map, float f, FloatHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Float2IntOpenCustomHashMap(Map<? extends Float, ? extends Integer> map, FloatHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Float2IntOpenCustomHashMap(Float2IntMap float2IntMap, float f, FloatHash.Strategy strategy) {
        this(float2IntMap.size(), f, strategy);
        this.putAll(float2IntMap);
    }

    public Float2IntOpenCustomHashMap(Float2IntMap float2IntMap, FloatHash.Strategy strategy) {
        this(float2IntMap, 0.75f, strategy);
    }

    public Float2IntOpenCustomHashMap(float[] fArray, int[] nArray, float f, FloatHash.Strategy strategy) {
    ...
    public Float2IntOpenCustomHashMap(float[] fArray, int[] nArray, FloatHash.Strategy strategy) {
        this(fArray, nArray, 0.75f, strategy);
    }
    ...
    public int getOrDefault(float f, int n) {
        ...
        float[] fArray = this.key;
        int n2 = HashCommon.mix(this.strategy.hashCode(f)) & this.mask;
        float f2 = fArray[n2];
        if (Float.floatToIntBits(f2) == 0) {
            return n;
        }
    ...
    public boolean remove(float f, int n) {
        ...
        if (this.strategy.equals(f, f2) && n == this.value[n2]) {
            this.removeEntry(n2);
            return false;
        }
        do {
            if (Float.floatToIntBits(f2 = fArray[n2 = n2 + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(f, f2) || n != this.value[n2]);
        this.removeEntry(n2);
        return false;
    }
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection(this){
                final Float2IntOpenCustomHashMap this$0;
                {
                    this.this$0 = float2IntOpenCustomHashMap;
                }
    ...
    public Float2IntOpenCustomHashMap clone() {
        Float2IntOpenCustomHashMap float2IntOpenCustomHashMap;
        try {
            float2IntOpenCustomHashMap = (Float2IntOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2IntOpenCustomHashMap.keys = null;
        float2IntOpenCustomHashMap.values = null;
        float2IntOpenCustomHashMap.entries = null;
        float2IntOpenCustomHashMap.containsNullKey = this.containsNullKey;
        float2IntOpenCustomHashMap.key = (float[])this.key.clone();
        float2IntOpenCustomHashMap.value = (int[])this.value.clone();
        float2IntOpenCustomHashMap.strategy = this.strategy;
        return float2IntOpenCustomHashMap;
    }
    ...
    static int access$300(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap) {
        return float2IntOpenCustomHashMap.removeNullEntry();
    }

    static int access$400(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap, int n) {
        return float2IntOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements IntIterator {
        ...
        public ValueIterator(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap) {
            this.this$0 = float2IntOpenCustomHashMap;
            super(float2IntOpenCustomHashMap, null);
        }
    ...
    extends AbstractFloatSet {
        ...
        private KeySet(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap) {
            this.this$0 = float2IntOpenCustomHashMap;
        }
        ...
        KeySet(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap, 1 var2_2) {
            this(float2IntOpenCustomHashMap);
        }
    }
    ...
    implements FloatIterator {
        ...
        public KeyIterator(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap) {
            this.this$0 = float2IntOpenCustomHashMap;
            super(float2IntOpenCustomHashMap, null);
        }
    ...
    implements Float2IntMap.FastEntrySet {
        ...
        private MapEntrySet(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap) {
            this.this$0 = float2IntOpenCustomHashMap;
        }
        ...
        public boolean contains(Object object) {
            ...
            int n2 = HashCommon.mix(this.this$0.strategy.hashCode(f)) & this.this$0.mask;
            float f2 = fArray[n2];
            if (Float.floatToIntBits(f2) == 0) {
                return true;
            }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(f, 0.0f)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n) {
                    Float2IntOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(f2, f)) {
                if (this.this$0.value[n2] == n) {
                    Float2IntOpenCustomHashMap.access$400(this.this$0, n2);
                    return false;
                }
                return true;
            }
            do {
                if (Float.floatToIntBits(f2 = fArray[n2 = n2 + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(f2, f) || this.this$0.value[n2] != n);
            Float2IntOpenCustomHashMap.access$400(this.this$0, n2);
            return false;
        }
        ...
        MapEntrySet(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap, 1 var2_2) {
            this(float2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2IntMap.Entry> {
        ...
        private FastEntryIterator(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap) {
            this.this$0 = float2IntOpenCustomHashMap;
            super(float2IntOpenCustomHashMap, null);
        ...
        FastEntryIterator(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap, 1 var2_2) {
            this(float2IntOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2IntMap.Entry> {
        ...
        private EntryIterator(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap) {
            this.this$0 = float2IntOpenCustomHashMap;
            super(float2IntOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap, 1 var2_2) {
            this(float2IntOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap) {
            this.this$0 = float2IntOpenCustomHashMap;
        ...
        MapIterator(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap, 1 var2_2) {
            this(float2IntOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Float, Integer> {
        ...
        MapEntry(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap, int n) {
            this.this$0 = float2IntOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Float2IntOpenCustomHashMap float2IntOpenCustomHashMap) {
            this.this$0 = float2IntOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], ((Float)entry.getKey()).floatValue()) && this.this$0.value[this.index] == (Integer)entry.getValue();
        }
