...
Hash {
    ...
    public Float2DoubleLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Float2DoubleLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Float2DoubleLinkedOpenHashMap(Map<? extends Float, ? extends Double> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Float2DoubleLinkedOpenHashMap(Map<? extends Float, ? extends Double> map) {
        this(map, 0.75f);
    }

    public Float2DoubleLinkedOpenHashMap(Float2DoubleMap float2DoubleMap, float f) {
        this(float2DoubleMap.size(), f);
        this.putAll(float2DoubleMap);
    }

    public Float2DoubleLinkedOpenHashMap(Float2DoubleMap float2DoubleMap) {
        this(float2DoubleMap, 0.75f);
    }

    public Float2DoubleLinkedOpenHashMap(float[] fArray, double[] dArray, float f) {
    ...
    public Float2DoubleLinkedOpenHashMap(float[] fArray, double[] dArray) {
    ...
    public double getAndMoveToFirst(float f) {
        if (Float.floatToIntBits(f) == 0) {
            if (this.containsNullKey) {
    ...
    public double getAndMoveToLast(float f) {
        if (Float.floatToIntBits(f) == 0) {
            if (this.containsNullKey) {
    ...
    public double putAndMoveToFirst(float f, double d) {
        int n;
        if (Float.floatToIntBits(f) == 0) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public double putAndMoveToLast(float f, double d) {
        int n;
        if (Float.floatToIntBits(f) == 0) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection(this){
                final Float2DoubleLinkedOpenHashMap this$0;
                {
                    this.this$0 = float2DoubleLinkedOpenHashMap;
                }
    ...
    public Float2DoubleLinkedOpenHashMap clone() {
        Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap;
        try {
            float2DoubleLinkedOpenHashMap = (Float2DoubleLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2DoubleLinkedOpenHashMap.keys = null;
        float2DoubleLinkedOpenHashMap.values = null;
        float2DoubleLinkedOpenHashMap.entries = null;
        float2DoubleLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        float2DoubleLinkedOpenHashMap.key = (float[])this.key.clone();
        float2DoubleLinkedOpenHashMap.value = (double[])this.value.clone();
        float2DoubleLinkedOpenHashMap.link = (long[])this.link.clone();
        return float2DoubleLinkedOpenHashMap;
    }
    ...
    static double access$100(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap) {
        return float2DoubleLinkedOpenHashMap.removeNullEntry();
    }

    static double access$200(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap, int n) {
        return float2DoubleLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements DoubleListIterator {
        ...
        public ValueIterator(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap) {
            this.this$0 = float2DoubleLinkedOpenHashMap;
            super(float2DoubleLinkedOpenHashMap);
        }
    ...
    extends AbstractFloatSortedSet {
        ...
        private KeySet(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap) {
            this.this$0 = float2DoubleLinkedOpenHashMap;
        }
        ...
        KeySet(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap, 1 var2_2) {
            this(float2DoubleLinkedOpenHashMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap, float f) {
            this.this$0 = float2DoubleLinkedOpenHashMap;
            super(float2DoubleLinkedOpenHashMap, f, null);
        }
        ...
        public KeyIterator(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap) {
            this.this$0 = float2DoubleLinkedOpenHashMap;
            super(float2DoubleLinkedOpenHashMap);
        }
    ...
    implements Float2DoubleSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap) {
            this.this$0 = float2DoubleLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Float2DoubleMap.Entry> subSet(Float2DoubleMap.Entry entry, Float2DoubleMap.Entry entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Float2DoubleMap.Entry> headSet(Float2DoubleMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Float2DoubleMap.Entry> tailSet(Float2DoubleMap.Entry entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (Float.floatToIntBits(f) == 0) {
                if (this.this$0.containsNullKey && Double.doubleToLongBits(this.this$0.value[this.this$0.n]) == Double.doubleToLongBits(d)) {
                    Float2DoubleLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (Float.floatToIntBits(f2) == Float.floatToIntBits(f)) {
                if (Double.doubleToLongBits(this.this$0.value[n]) == Double.doubleToLongBits(d)) {
                    Float2DoubleLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Float2DoubleMap.Entry> iterator(Float2DoubleMap.Entry entry) {
        ...
        public ObjectListIterator<Float2DoubleMap.Entry> fastIterator(Float2DoubleMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Float2DoubleMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractFloat2DoubleMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Float2DoubleMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Float2DoubleMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Float2DoubleMap.Entry)object, (Float2DoubleMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Float2DoubleMap.Entry)object);
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Float2DoubleMap.Entry entry) {
        ...
        MapEntrySet(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap, 1 var2_2) {
            this(float2DoubleLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Float2DoubleMap.Entry> {
        ...
        public FastEntryIterator(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap) {
            this.this$0 = float2DoubleLinkedOpenHashMap;
            super(float2DoubleLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap, float f) {
            this.this$0 = float2DoubleLinkedOpenHashMap;
            super(float2DoubleLinkedOpenHashMap, f, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Float2DoubleMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Float2DoubleMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Float2DoubleMap.Entry> {
        ...
        public EntryIterator(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap) {
            this.this$0 = float2DoubleLinkedOpenHashMap;
            super(float2DoubleLinkedOpenHashMap);
        }

        public EntryIterator(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap, float f) {
            this.this$0 = float2DoubleLinkedOpenHashMap;
            super(float2DoubleLinkedOpenHashMap, f, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap) {
            this.this$0 = float2DoubleLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = float2DoubleLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap, float f) {
            this.this$0 = float2DoubleLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (Float.floatToIntBits(f) == 0) {
                if (float2DoubleLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)float2DoubleLinkedOpenHashMap.link[float2DoubleLinkedOpenHashMap.n];
                    this.prev = float2DoubleLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + f + " does not belong to this map.");
            }
            if (Float.floatToIntBits(float2DoubleLinkedOpenHashMap.key[float2DoubleLinkedOpenHashMap.last]) == Float.floatToIntBits(f)) {
                this.prev = float2DoubleLinkedOpenHashMap.last;
                this.index = float2DoubleLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(HashCommon.float2int(f)) & float2DoubleLinkedOpenHashMap.mask;
            while (Float.floatToIntBits(float2DoubleLinkedOpenHashMap.key[n]) != 0) {
                if (Float.floatToIntBits(float2DoubleLinkedOpenHashMap.key[n]) == Float.floatToIntBits(f)) {
                    this.next = (int)float2DoubleLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & float2DoubleLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + f + " does not belong to this map.");
        }
        ...
        public void set(Float2DoubleMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Float2DoubleMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap, float f, 1 var3_3) {
            this(float2DoubleLinkedOpenHashMap, f);
        }
    }
    ...
    Map.Entry<Float, Double> {
        ...
        MapEntry(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap, int n) {
            this.this$0 = float2DoubleLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Float2DoubleLinkedOpenHashMap float2DoubleLinkedOpenHashMap) {
            this.this$0 = float2DoubleLinkedOpenHashMap;
        }
