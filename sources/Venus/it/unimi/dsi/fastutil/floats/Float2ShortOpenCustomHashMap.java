...
Hash {
    ...
    public Float2ShortOpenCustomHashMap(int n, float f, FloatHash.Strategy strategy) {
    ...
    public Float2ShortOpenCustomHashMap(int n, FloatHash.Strategy strategy) {
    ...
    public Float2ShortOpenCustomHashMap(Map<? extends Float, ? extends Short> map, float f, FloatHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Float2ShortOpenCustomHashMap(Map<? extends Float, ? extends Short> map, FloatHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Float2ShortOpenCustomHashMap(Float2ShortMap float2ShortMap, float f, FloatHash.Strategy strategy) {
        this(float2ShortMap.size(), f, strategy);
        this.putAll(float2ShortMap);
    }

    public Float2ShortOpenCustomHashMap(Float2ShortMap float2ShortMap, FloatHash.Strategy strategy) {
        this(float2ShortMap, 0.75f, strategy);
    }

    public Float2ShortOpenCustomHashMap(float[] fArray, short[] sArray, float f, FloatHash.Strategy strategy) {
    ...
    public Float2ShortOpenCustomHashMap(float[] fArray, short[] sArray, FloatHash.Strategy strategy) {
        this(fArray, sArray, 0.75f, strategy);
    }
    ...
    public boolean remove(float f, short s) {
        ...
        if (this.strategy.equals(f, f2) && s == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if (Float.floatToIntBits(f2 = fArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(f, f2) || s != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection(this){
                final Float2ShortOpenCustomHashMap this$0;
                {
                    this.this$0 = float2ShortOpenCustomHashMap;
                }
    ...
    public Float2ShortOpenCustomHashMap clone() {
        Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap;
        try {
            float2ShortOpenCustomHashMap = (Float2ShortOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2ShortOpenCustomHashMap.keys = null;
        float2ShortOpenCustomHashMap.values = null;
        float2ShortOpenCustomHashMap.entries = null;
        float2ShortOpenCustomHashMap.containsNullKey = this.containsNullKey;
        float2ShortOpenCustomHashMap.key = (float[])this.key.clone();
        float2ShortOpenCustomHashMap.value = (short[])this.value.clone();
        float2ShortOpenCustomHashMap.strategy = this.strategy;
        return float2ShortOpenCustomHashMap;
    }
    ...
    static short access$300(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap) {
        return float2ShortOpenCustomHashMap.removeNullEntry();
    }

    static short access$400(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap, int n) {
        return float2ShortOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ShortIterator {
        ...
        public ValueIterator(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap) {
            this.this$0 = float2ShortOpenCustomHashMap;
            super(float2ShortOpenCustomHashMap, null);
        }
    ...
    extends AbstractFloatSet {
        ...
        private KeySet(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap) {
            this.this$0 = float2ShortOpenCustomHashMap;
        }
        ...
        KeySet(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap, 1 var2_2) {
            this(float2ShortOpenCustomHashMap);
        }
    }
    ...
    implements FloatIterator {
        ...
        public KeyIterator(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap) {
            this.this$0 = float2ShortOpenCustomHashMap;
            super(float2ShortOpenCustomHashMap, null);
        }
    ...
    implements Float2ShortMap.FastEntrySet {
        ...
        private MapEntrySet(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap) {
            this.this$0 = float2ShortOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(f, 0.0f)) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == s) {
                    Float2ShortOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(f2, f)) {
                if (this.this$0.value[n] == s) {
                    Float2ShortOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if (Float.floatToIntBits(f2 = fArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(f2, f) || this.this$0.value[n] != s);
            Float2ShortOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap, 1 var2_2) {
            this(float2ShortOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2ShortMap.Entry> {
        ...
        private FastEntryIterator(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap) {
            this.this$0 = float2ShortOpenCustomHashMap;
            super(float2ShortOpenCustomHashMap, null);
        ...
        FastEntryIterator(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap, 1 var2_2) {
            this(float2ShortOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2ShortMap.Entry> {
        ...
        private EntryIterator(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap) {
            this.this$0 = float2ShortOpenCustomHashMap;
            super(float2ShortOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap, 1 var2_2) {
            this(float2ShortOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap) {
            this.this$0 = float2ShortOpenCustomHashMap;
        ...
        MapIterator(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap, 1 var2_2) {
            this(float2ShortOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Float, Short> {
        ...
        MapEntry(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap, int n) {
            this.this$0 = float2ShortOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Float2ShortOpenCustomHashMap float2ShortOpenCustomHashMap) {
            this.this$0 = float2ShortOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], ((Float)entry.getKey()).floatValue()) && this.this$0.value[this.index] == (Short)entry.getValue();
        }
