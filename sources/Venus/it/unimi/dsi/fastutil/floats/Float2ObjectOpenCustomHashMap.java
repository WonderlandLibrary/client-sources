...
Hash {
    ...
    public Float2ObjectOpenCustomHashMap(int n, float f, FloatHash.Strategy strategy) {
    ...
    public Float2ObjectOpenCustomHashMap(int n, FloatHash.Strategy strategy) {
    ...
    public Float2ObjectOpenCustomHashMap(Map<? extends Float, ? extends V> map, float f, FloatHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Float2ObjectOpenCustomHashMap(Map<? extends Float, ? extends V> map, FloatHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Float2ObjectOpenCustomHashMap(Float2ObjectMap<V> float2ObjectMap, float f, FloatHash.Strategy strategy) {
        this(float2ObjectMap.size(), f, strategy);
        this.putAll(float2ObjectMap);
    }

    public Float2ObjectOpenCustomHashMap(Float2ObjectMap<V> float2ObjectMap, FloatHash.Strategy strategy) {
        this(float2ObjectMap, 0.75f, strategy);
    }

    public Float2ObjectOpenCustomHashMap(float[] fArray, V[] VArray, float f, FloatHash.Strategy strategy) {
    ...
    public Float2ObjectOpenCustomHashMap(float[] fArray, V[] VArray, FloatHash.Strategy strategy) {
    ...
    public boolean remove(float f, Object object) {
        ...
        if (this.strategy.equals(f, f2) && Objects.equals(object, this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if (Float.floatToIntBits(f2 = fArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(f, f2) || !Objects.equals(object, this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public ObjectCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(this){
                final Float2ObjectOpenCustomHashMap this$0;
                {
    ...
    public Float2ObjectOpenCustomHashMap<V> clone() {
        Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap;
        try {
            float2ObjectOpenCustomHashMap = (Float2ObjectOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2ObjectOpenCustomHashMap.keys = null;
        float2ObjectOpenCustomHashMap.values = null;
        float2ObjectOpenCustomHashMap.entries = null;
        float2ObjectOpenCustomHashMap.containsNullKey = this.containsNullKey;
        float2ObjectOpenCustomHashMap.key = (float[])this.key.clone();
        float2ObjectOpenCustomHashMap.value = (Object[])this.value.clone();
        float2ObjectOpenCustomHashMap.strategy = this.strategy;
        return float2ObjectOpenCustomHashMap;
    }
    ...
    static Object access$300(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap) {
        return float2ObjectOpenCustomHashMap.removeNullEntry();
    }

    static Object access$400(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap, int n) {
        return float2ObjectOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap) {
            this.this$0 = float2ObjectOpenCustomHashMap;
            super(float2ObjectOpenCustomHashMap, null);
        }
    ...
    extends AbstractFloatSet {
        ...
        private KeySet(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap) {
            this.this$0 = float2ObjectOpenCustomHashMap;
        }
        ...
        KeySet(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap, 1 var2_2) {
            this(float2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements FloatIterator {
        ...
        public KeyIterator(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap) {
            this.this$0 = float2ObjectOpenCustomHashMap;
            super(float2ObjectOpenCustomHashMap, null);
        }
    ...
    implements Float2ObjectMap.FastEntrySet<V> {
        ...
        private MapEntrySet(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap) {
            this.this$0 = float2ObjectOpenCustomHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(f, 0.0f)) {
                if (this.this$0.containsNullKey && Objects.equals(this.this$0.value[this.this$0.n], v)) {
                    Float2ObjectOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(f2, f)) {
                if (Objects.equals(this.this$0.value[n], v)) {
                    Float2ObjectOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if (Float.floatToIntBits(f2 = fArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(f2, f) || !Objects.equals(this.this$0.value[n], v));
            Float2ObjectOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap, 1 var2_2) {
            this(float2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2ObjectMap.Entry<V>> {
        ...
        private FastEntryIterator(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap) {
            this.this$0 = float2ObjectOpenCustomHashMap;
            super(float2ObjectOpenCustomHashMap, null);
        ...
        FastEntryIterator(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap, 1 var2_2) {
            this(float2ObjectOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2ObjectMap.Entry<V>> {
        ...
        private EntryIterator(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap) {
            this.this$0 = float2ObjectOpenCustomHashMap;
            super(float2ObjectOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap, 1 var2_2) {
            this(float2ObjectOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap) {
            this.this$0 = float2ObjectOpenCustomHashMap;
        ...
        MapIterator(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap, 1 var2_2) {
            this(float2ObjectOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Float, V> {
        ...
        MapEntry(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap, int n) {
            this.this$0 = float2ObjectOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Float2ObjectOpenCustomHashMap float2ObjectOpenCustomHashMap) {
            this.this$0 = float2ObjectOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], ((Float)entry.getKey()).floatValue()) && Objects.equals(this.this$0.value[this.index], entry.getValue());
        }
