...
Cloneable {
    ...
    public Float2ReferenceRBTreeMap(Comparator<? super Float> comparator) {
        this();
        this.storedComparator = comparator;
    }

    public Float2ReferenceRBTreeMap(Map<? extends Float, ? extends V> map) {
        this();
        this.putAll((Map<Float, ? extends V>)map);
    }

    public Float2ReferenceRBTreeMap(SortedMap<Float, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Float, V>)sortedMap);
    }

    public Float2ReferenceRBTreeMap(Float2ReferenceMap<? extends V> float2ReferenceMap) {
        this();
        this.putAll(float2ReferenceMap);
    }

    public Float2ReferenceRBTreeMap(Float2ReferenceSortedMap<V> float2ReferenceSortedMap) {
        this(float2ReferenceSortedMap.comparator());
        this.putAll(float2ReferenceSortedMap);
    }

    public Float2ReferenceRBTreeMap(float[] fArray, V[] VArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2ReferenceRBTreeMap(float[] fArray, V[] VArray) {
    ...
    public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>(this){
                ...
                final Float2ReferenceRBTreeMap this$0;
                {
                    this.this$0 = float2ReferenceRBTreeMap;
    ...
    public Float2ReferenceRBTreeMap<V> clone() {
        Float2ReferenceRBTreeMap float2ReferenceRBTreeMap;
        try {
            float2ReferenceRBTreeMap = (Float2ReferenceRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2ReferenceRBTreeMap.keys = null;
        float2ReferenceRBTreeMap.values = null;
        float2ReferenceRBTreeMap.entries = null;
        float2ReferenceRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2ReferenceRBTreeMap.tree = entry2.left;
                            float2ReferenceRBTreeMap.firstEntry = float2ReferenceRBTreeMap.tree;
                            while (float2ReferenceRBTreeMap.firstEntry.left != null) {
                                float2ReferenceRBTreeMap.firstEntry = float2ReferenceRBTreeMap.firstEntry.left;
                            }
                            float2ReferenceRBTreeMap.lastEntry = float2ReferenceRBTreeMap.tree;
                            while (float2ReferenceRBTreeMap.lastEntry.right != null) {
                                float2ReferenceRBTreeMap.lastEntry = float2ReferenceRBTreeMap.lastEntry.right;
                            }
                            return float2ReferenceRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Float2ReferenceRBTreeMap float2ReferenceRBTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2ReferenceRBTreeMap;
            if (!bl && !bl2 && float2ReferenceRBTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2ReferenceRBTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Float2ReferenceRBTreeMap float2ReferenceRBTreeMap) {
            this.this$0 = float2ReferenceRBTreeMap;
            super(float2ReferenceRBTreeMap);
        }
        ...
        ValueIterator(Float2ReferenceRBTreeMap float2ReferenceRBTreeMap, 1 var2_2) {
            this(float2ReferenceRBTreeMap);
        }
    }
    ...
    extends AbstractFloat2ReferenceSortedMap.KeySet {
        ...
        private KeySet(Float2ReferenceRBTreeMap float2ReferenceRBTreeMap) {
            this.this$0 = float2ReferenceRBTreeMap;
            super(float2ReferenceRBTreeMap);
        }
        ...
        KeySet(Float2ReferenceRBTreeMap float2ReferenceRBTreeMap, 1 var2_2) {
            this(float2ReferenceRBTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2ReferenceRBTreeMap float2ReferenceRBTreeMap) {
            this.this$0 = float2ReferenceRBTreeMap;
            super(float2ReferenceRBTreeMap);
        }

        public KeyIterator(Float2ReferenceRBTreeMap float2ReferenceRBTreeMap, float f) {
            this.this$0 = float2ReferenceRBTreeMap;
            super(float2ReferenceRBTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2ReferenceMap.Entry<V>> {
        ...
        EntryIterator(Float2ReferenceRBTreeMap float2ReferenceRBTreeMap) {
            this.this$0 = float2ReferenceRBTreeMap;
            super(float2ReferenceRBTreeMap);
        }

        EntryIterator(Float2ReferenceRBTreeMap float2ReferenceRBTreeMap, float f) {
            this.this$0 = float2ReferenceRBTreeMap;
            super(float2ReferenceRBTreeMap, f);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2ReferenceRBTreeMap float2ReferenceRBTreeMap) {
            this.this$0 = float2ReferenceRBTreeMap;
            this.index = 0;
            this.next = float2ReferenceRBTreeMap.firstEntry;
        }

        TreeIterator(Float2ReferenceRBTreeMap float2ReferenceRBTreeMap, float f) {
            this.this$0 = float2ReferenceRBTreeMap;
            this.index = 0;
            this.next = float2ReferenceRBTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2ReferenceRBTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
