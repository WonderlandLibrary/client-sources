...
Hash {
    ...
    public Float2IntLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Float2IntLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Float2IntLinkedOpenHashMap(Map<? extends Float, ? extends Integer> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Float2IntLinkedOpenHashMap(Map<? extends Float, ? extends Integer> map) {
        this(map, 0.75f);
    }

    public Float2IntLinkedOpenHashMap(Float2IntMap float2IntMap, float f) {
        this(float2IntMap.size(), f);
        this.putAll(float2IntMap);
    }

    public Float2IntLinkedOpenHashMap(Float2IntMap float2IntMap) {
        this(float2IntMap, 0.75f);
    }

    public Float2IntLinkedOpenHashMap(float[] fArray, int[] nArray, float f) {
    ...
    public Float2IntLinkedOpenHashMap(float[] fArray, int[] nArray) {
    ...
    public int putAndMoveToFirst(float f, int n) {
        int n2;
        if (Float.floatToIntBits(f) == 0) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public int putAndMoveToLast(float f, int n) {
        int n2;
        if (Float.floatToIntBits(f) == 0) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection(this){
                final Float2IntLinkedOpenHashMap this$0;
                {
                    this.this$0 = float2IntLinkedOpenHashMap;
                }
    ...
    public Float2IntLinkedOpenHashMap clone() {
        Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap;
        try {
            float2IntLinkedOpenHashMap = (Float2IntLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2IntLinkedOpenHashMap.keys = null;
        float2IntLinkedOpenHashMap.values = null;
        float2IntLinkedOpenHashMap.entries = null;
        float2IntLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        float2IntLinkedOpenHashMap.key = (float[])this.key.clone();
        float2IntLinkedOpenHashMap.value = (int[])this.value.clone();
        float2IntLinkedOpenHashMap.link = (long[])this.link.clone();
        return float2IntLinkedOpenHashMap;
    }
    ...
    static int access$100(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap) {
        return float2IntLinkedOpenHashMap.removeNullEntry();
    }

    static int access$200(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap, int n) {
        return float2IntLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements IntListIterator {
        ...
        public ValueIterator(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap) {
            this.this$0 = float2IntLinkedOpenHashMap;
            super(float2IntLinkedOpenHashMap);
        }
    ...
    extends AbstractFloatSortedSet {
        ...
        private KeySet(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap) {
            this.this$0 = float2IntLinkedOpenHashMap;
        }
        ...
        KeySet(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap, 1 var2_2) {
            this(float2IntLinkedOpenHashMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap, float f) {
            this.this$0 = float2IntLinkedOpenHashMap;
            super(float2IntLinkedOpenHashMap, f, null);
        }
        ...
        public KeyIterator(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap) {
            this.this$0 = float2IntLinkedOpenHashMap;
            super(float2IntLinkedOpenHashMap);
        }
    ...
    implements Float2IntSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap) {
            this.this$0 = float2IntLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Float2IntMap.Entry> subSet(Float2IntMap.Entry entry, Float2IntMap.Entry entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Float2IntMap.Entry> headSet(Float2IntMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Float2IntMap.Entry> tailSet(Float2IntMap.Entry entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (Float.floatToIntBits(f) == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == n) {
                    Float2IntLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (Float.floatToIntBits(f2) == Float.floatToIntBits(f)) {
                if (this.this$0.value[n2] == n) {
                    Float2IntLinkedOpenHashMap.access$200(this.this$0, n2);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Float2IntMap.Entry> iterator(Float2IntMap.Entry entry) {
        ...
        public ObjectListIterator<Float2IntMap.Entry> fastIterator(Float2IntMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Float2IntMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractFloat2IntMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Float2IntMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Float2IntMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Float2IntMap.Entry)object, (Float2IntMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Float2IntMap.Entry)object);
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Float2IntMap.Entry entry) {
        ...
        MapEntrySet(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap, 1 var2_2) {
            this(float2IntLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Float2IntMap.Entry> {
        ...
        public FastEntryIterator(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap) {
            this.this$0 = float2IntLinkedOpenHashMap;
            super(float2IntLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap, float f) {
            this.this$0 = float2IntLinkedOpenHashMap;
            super(float2IntLinkedOpenHashMap, f, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Float2IntMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Float2IntMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Float2IntMap.Entry> {
        ...
        public EntryIterator(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap) {
            this.this$0 = float2IntLinkedOpenHashMap;
            super(float2IntLinkedOpenHashMap);
        }

        public EntryIterator(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap, float f) {
            this.this$0 = float2IntLinkedOpenHashMap;
            super(float2IntLinkedOpenHashMap, f, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap) {
            this.this$0 = float2IntLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = float2IntLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap, float f) {
            this.this$0 = float2IntLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (Float.floatToIntBits(f) == 0) {
                if (float2IntLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)float2IntLinkedOpenHashMap.link[float2IntLinkedOpenHashMap.n];
                    this.prev = float2IntLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + f + " does not belong to this map.");
            }
            if (Float.floatToIntBits(float2IntLinkedOpenHashMap.key[float2IntLinkedOpenHashMap.last]) == Float.floatToIntBits(f)) {
                this.prev = float2IntLinkedOpenHashMap.last;
                this.index = float2IntLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(HashCommon.float2int(f)) & float2IntLinkedOpenHashMap.mask;
            while (Float.floatToIntBits(float2IntLinkedOpenHashMap.key[n]) != 0) {
                if (Float.floatToIntBits(float2IntLinkedOpenHashMap.key[n]) == Float.floatToIntBits(f)) {
                    this.next = (int)float2IntLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & float2IntLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + f + " does not belong to this map.");
        }
        ...
        MapIterator(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap, float f, 1 var3_3) {
            this(float2IntLinkedOpenHashMap, f);
        }
    }
    ...
    Map.Entry<Float, Integer> {
        ...
        MapEntry(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap, int n) {
            this.this$0 = float2IntLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Float2IntLinkedOpenHashMap float2IntLinkedOpenHashMap) {
            this.this$0 = float2IntLinkedOpenHashMap;
        }
