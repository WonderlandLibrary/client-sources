...
Cloneable {
    ...
    public Float2CharRBTreeMap(Comparator<? super Float> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Float2CharRBTreeMap(Map<? extends Float, ? extends Character> map) {
        this();
        this.putAll(map);
    }

    public Float2CharRBTreeMap(SortedMap<Float, Character> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Float, ? extends Character>)sortedMap);
    }

    public Float2CharRBTreeMap(Float2CharMap float2CharMap) {
        this();
        this.putAll(float2CharMap);
    }

    public Float2CharRBTreeMap(Float2CharSortedMap float2CharSortedMap) {
        this(float2CharSortedMap.comparator());
        this.putAll(float2CharSortedMap);
    }

    public Float2CharRBTreeMap(float[] fArray, char[] cArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2CharRBTreeMap(float[] fArray, char[] cArray) {
    ...
    public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2CharMap.Entry>(this){
                ...
                final Float2CharRBTreeMap this$0;
                {
                    this.this$0 = float2CharRBTreeMap;
    ...
    public Float2CharRBTreeMap clone() {
        Float2CharRBTreeMap float2CharRBTreeMap;
        try {
            float2CharRBTreeMap = (Float2CharRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2CharRBTreeMap.keys = null;
        float2CharRBTreeMap.values = null;
        float2CharRBTreeMap.entries = null;
        float2CharRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2CharRBTreeMap.firstEntry = float2CharRBTreeMap.tree = entry2.left;
                            while (float2CharRBTreeMap.firstEntry.left != null) {
                                float2CharRBTreeMap.firstEntry = float2CharRBTreeMap.firstEntry.left;
                            }
                            float2CharRBTreeMap.lastEntry = float2CharRBTreeMap.tree;
                            while (float2CharRBTreeMap.lastEntry.right != null) {
                                float2CharRBTreeMap.lastEntry = float2CharRBTreeMap.lastEntry.right;
                            }
                            return float2CharRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Float2CharRBTreeMap float2CharRBTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2CharRBTreeMap;
            if (!bl && !bl2 && float2CharRBTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2CharRBTreeMap.defRetValue;
        }
    ...
    implements CharListIterator {
        ...
        private ValueIterator(Float2CharRBTreeMap float2CharRBTreeMap) {
            this.this$0 = float2CharRBTreeMap;
            super(float2CharRBTreeMap);
        }
        ...
        ValueIterator(Float2CharRBTreeMap float2CharRBTreeMap, 1 var2_2) {
            this(float2CharRBTreeMap);
        }
    }
    ...
    extends AbstractFloat2CharSortedMap.KeySet {
        ...
        private KeySet(Float2CharRBTreeMap float2CharRBTreeMap) {
            this.this$0 = float2CharRBTreeMap;
            super(float2CharRBTreeMap);
        }
        ...
        KeySet(Float2CharRBTreeMap float2CharRBTreeMap, 1 var2_2) {
            this(float2CharRBTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2CharRBTreeMap float2CharRBTreeMap) {
            this.this$0 = float2CharRBTreeMap;
            super(float2CharRBTreeMap);
        }

        public KeyIterator(Float2CharRBTreeMap float2CharRBTreeMap, float f) {
            this.this$0 = float2CharRBTreeMap;
            super(float2CharRBTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2CharMap.Entry> {
        ...
        EntryIterator(Float2CharRBTreeMap float2CharRBTreeMap) {
            this.this$0 = float2CharRBTreeMap;
            super(float2CharRBTreeMap);
        }

        EntryIterator(Float2CharRBTreeMap float2CharRBTreeMap, float f) {
            this.this$0 = float2CharRBTreeMap;
            super(float2CharRBTreeMap, f);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2CharRBTreeMap float2CharRBTreeMap) {
            this.this$0 = float2CharRBTreeMap;
            this.index = 0;
            this.next = float2CharRBTreeMap.firstEntry;
        }

        TreeIterator(Float2CharRBTreeMap float2CharRBTreeMap, float f) {
            this.this$0 = float2CharRBTreeMap;
            this.index = 0;
            this.next = float2CharRBTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2CharRBTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
