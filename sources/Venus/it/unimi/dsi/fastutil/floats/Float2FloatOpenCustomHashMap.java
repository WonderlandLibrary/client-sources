...
Hash {
    ...
    public Float2FloatOpenCustomHashMap(int n, float f, FloatHash.Strategy strategy) {
    ...
    public Float2FloatOpenCustomHashMap(int n, FloatHash.Strategy strategy) {
    ...
    public Float2FloatOpenCustomHashMap(Map<? extends Float, ? extends Float> map, float f, FloatHash.Strategy strategy) {
        this(map.size(), f, strategy);
        this.putAll(map);
    }

    public Float2FloatOpenCustomHashMap(Map<? extends Float, ? extends Float> map, FloatHash.Strategy strategy) {
        this(map, 0.75f, strategy);
    }

    public Float2FloatOpenCustomHashMap(Float2FloatMap float2FloatMap, float f, FloatHash.Strategy strategy) {
        this(float2FloatMap.size(), f, strategy);
        this.putAll(float2FloatMap);
    }

    public Float2FloatOpenCustomHashMap(Float2FloatMap float2FloatMap, FloatHash.Strategy strategy) {
        this(float2FloatMap, 0.75f, strategy);
    }

    public Float2FloatOpenCustomHashMap(float[] fArray, float[] fArray2, float f, FloatHash.Strategy strategy) {
    ...
    public Float2FloatOpenCustomHashMap(float[] fArray, float[] fArray2, FloatHash.Strategy strategy) {
        this(fArray, fArray2, 0.75f, strategy);
    }
        ...
        if (this.strategy.equals(f, 0.0f)) {
            ...
            if (Float.floatToIntBits(f3) != 0) {
                ...
                while (Float.floatToIntBits(f3 = fArray[n = n + 1 & this.mask]) != 0) {
                    if (!this.strategy.equals(f3, f)) continue;
                    return this.addToValue(n, f2);
                }
            }
        }
    ...
    public float getOrDefault(float f, float f2) {
        ...
        do {
            ...
            return f2;
        } while (!this.strategy.equals(f, f3));
        return this.value[n];
    }
    ...
    public boolean remove(float f, float f2) {
        ...
        if (this.strategy.equals(f, f3) && Float.floatToIntBits(f2) == Float.floatToIntBits(this.value[n])) {
            this.removeEntry(n);
            return false;
        }
        do {
            if (Float.floatToIntBits(f3 = fArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (!this.strategy.equals(f, f3) || Float.floatToIntBits(f2) != Float.floatToIntBits(this.value[n]));
        this.removeEntry(n);
        return false;
    }
    ...
    public FloatCollection values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection(this){
                final Float2FloatOpenCustomHashMap this$0;
                {
                    this.this$0 = float2FloatOpenCustomHashMap;
                }
    ...
    public Float2FloatOpenCustomHashMap clone() {
        Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap;
        try {
            float2FloatOpenCustomHashMap = (Float2FloatOpenCustomHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2FloatOpenCustomHashMap.keys = null;
        float2FloatOpenCustomHashMap.values = null;
        float2FloatOpenCustomHashMap.entries = null;
        float2FloatOpenCustomHashMap.containsNullKey = this.containsNullKey;
        float2FloatOpenCustomHashMap.key = (float[])this.key.clone();
        float2FloatOpenCustomHashMap.value = (float[])this.value.clone();
        float2FloatOpenCustomHashMap.strategy = this.strategy;
        return float2FloatOpenCustomHashMap;
    }
    ...
    static float access$300(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap) {
        return float2FloatOpenCustomHashMap.removeNullEntry();
    }

    static float access$400(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap, int n) {
        return float2FloatOpenCustomHashMap.removeEntry(n);
    }
    ...
    implements FloatIterator {
        ...
        public ValueIterator(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap) {
            this.this$0 = float2FloatOpenCustomHashMap;
            super(float2FloatOpenCustomHashMap, null);
        }
    ...
    extends AbstractFloatSet {
        ...
        private KeySet(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap) {
            this.this$0 = float2FloatOpenCustomHashMap;
        }
        ...
        KeySet(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap, 1 var2_2) {
            this(float2FloatOpenCustomHashMap);
        }
    }
    ...
    implements FloatIterator {
        ...
        public KeyIterator(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap) {
            this.this$0 = float2FloatOpenCustomHashMap;
            super(float2FloatOpenCustomHashMap, null);
        }
    ...
    implements Float2FloatMap.FastEntrySet {
        ...
        private MapEntrySet(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap) {
            this.this$0 = float2FloatOpenCustomHashMap;
        }
        ...
        public boolean contains(Object object) {
            ...
            if (this.this$0.strategy.equals(f, f3)) {
            ...
            do {
                ...
                return true;
            } while (!this.this$0.strategy.equals(f, f3));
            return Float.floatToIntBits(this.this$0.value[n]) == Float.floatToIntBits(f2);
        }
        ...
        public boolean remove(Object object) {
            ...
            if (this.this$0.strategy.equals(f, 0.0f)) {
                if (this.this$0.containsNullKey && Float.floatToIntBits(this.this$0.value[this.this$0.n]) == Float.floatToIntBits(f2)) {
                    Float2FloatOpenCustomHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (this.this$0.strategy.equals(f3, f)) {
                if (Float.floatToIntBits(this.this$0.value[n]) == Float.floatToIntBits(f2)) {
                    Float2FloatOpenCustomHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if (Float.floatToIntBits(f3 = fArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (!this.this$0.strategy.equals(f3, f) || Float.floatToIntBits(this.this$0.value[n]) != Float.floatToIntBits(f2));
            Float2FloatOpenCustomHashMap.access$400(this.this$0, n);
            return false;
        }
        ...
        MapEntrySet(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap, 1 var2_2) {
            this(float2FloatOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2FloatMap.Entry> {
        ...
        private FastEntryIterator(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap) {
            this.this$0 = float2FloatOpenCustomHashMap;
            super(float2FloatOpenCustomHashMap, null);
        ...
        FastEntryIterator(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap, 1 var2_2) {
            this(float2FloatOpenCustomHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2FloatMap.Entry> {
        ...
        private EntryIterator(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap) {
            this.this$0 = float2FloatOpenCustomHashMap;
            super(float2FloatOpenCustomHashMap, null);
        }
        ...
        EntryIterator(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap, 1 var2_2) {
            this(float2FloatOpenCustomHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap) {
            this.this$0 = float2FloatOpenCustomHashMap;
        ...
        MapIterator(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap, 1 var2_2) {
            this(float2FloatOpenCustomHashMap);
        }
    }
    ...
    Map.Entry<Float, Float> {
        ...
        MapEntry(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap, int n) {
            this.this$0 = float2FloatOpenCustomHashMap;
            this.index = n;
        }

        MapEntry(Float2FloatOpenCustomHashMap float2FloatOpenCustomHashMap) {
            this.this$0 = float2FloatOpenCustomHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return this.this$0.strategy.equals(this.this$0.key[this.index], ((Float)entry.getKey()).floatValue()) && Float.floatToIntBits(this.this$0.value[this.index]) == Float.floatToIntBits(((Float)entry.getValue()).floatValue());
        }
