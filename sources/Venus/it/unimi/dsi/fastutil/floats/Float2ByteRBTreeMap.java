...
Cloneable {
    ...
    public Float2ByteRBTreeMap(Comparator<? super Float> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Float2ByteRBTreeMap(Map<? extends Float, ? extends Byte> map) {
        this();
        this.putAll(map);
    }

    public Float2ByteRBTreeMap(SortedMap<Float, Byte> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Float, ? extends Byte>)sortedMap);
    }

    public Float2ByteRBTreeMap(Float2ByteMap float2ByteMap) {
        this();
        this.putAll(float2ByteMap);
    }

    public Float2ByteRBTreeMap(Float2ByteSortedMap float2ByteSortedMap) {
        this(float2ByteSortedMap.comparator());
        this.putAll(float2ByteSortedMap);
    }

    public Float2ByteRBTreeMap(float[] fArray, byte[] byArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2ByteRBTreeMap(float[] fArray, byte[] byArray) {
    ...
    public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ByteMap.Entry>(this){
                ...
                final Float2ByteRBTreeMap this$0;
                {
                    this.this$0 = float2ByteRBTreeMap;
    ...
    public Float2ByteRBTreeMap clone() {
        Float2ByteRBTreeMap float2ByteRBTreeMap;
        try {
            float2ByteRBTreeMap = (Float2ByteRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2ByteRBTreeMap.keys = null;
        float2ByteRBTreeMap.values = null;
        float2ByteRBTreeMap.entries = null;
        float2ByteRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2ByteRBTreeMap.firstEntry = float2ByteRBTreeMap.tree = entry2.left;
                            while (float2ByteRBTreeMap.firstEntry.left != null) {
                                float2ByteRBTreeMap.firstEntry = float2ByteRBTreeMap.firstEntry.left;
                            }
                            float2ByteRBTreeMap.lastEntry = float2ByteRBTreeMap.tree;
                            while (float2ByteRBTreeMap.lastEntry.right != null) {
                                float2ByteRBTreeMap.lastEntry = float2ByteRBTreeMap.lastEntry.right;
                            }
                            return float2ByteRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Float2ByteRBTreeMap float2ByteRBTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2ByteRBTreeMap;
            if (!bl && !bl2 && float2ByteRBTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2ByteRBTreeMap.defRetValue;
        }
    ...
    implements ByteListIterator {
        ...
        private ValueIterator(Float2ByteRBTreeMap float2ByteRBTreeMap) {
            this.this$0 = float2ByteRBTreeMap;
            super(float2ByteRBTreeMap);
        }
        ...
        ValueIterator(Float2ByteRBTreeMap float2ByteRBTreeMap, 1 var2_2) {
            this(float2ByteRBTreeMap);
        }
    }
    ...
    extends AbstractFloat2ByteSortedMap.KeySet {
        ...
        private KeySet(Float2ByteRBTreeMap float2ByteRBTreeMap) {
            this.this$0 = float2ByteRBTreeMap;
            super(float2ByteRBTreeMap);
        }
        ...
        KeySet(Float2ByteRBTreeMap float2ByteRBTreeMap, 1 var2_2) {
            this(float2ByteRBTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2ByteRBTreeMap float2ByteRBTreeMap) {
            this.this$0 = float2ByteRBTreeMap;
            super(float2ByteRBTreeMap);
        }

        public KeyIterator(Float2ByteRBTreeMap float2ByteRBTreeMap, float f) {
            this.this$0 = float2ByteRBTreeMap;
            super(float2ByteRBTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2ByteMap.Entry> {
        ...
        EntryIterator(Float2ByteRBTreeMap float2ByteRBTreeMap) {
            this.this$0 = float2ByteRBTreeMap;
            super(float2ByteRBTreeMap);
        }

        EntryIterator(Float2ByteRBTreeMap float2ByteRBTreeMap, float f) {
            this.this$0 = float2ByteRBTreeMap;
            super(float2ByteRBTreeMap, f);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2ByteRBTreeMap float2ByteRBTreeMap) {
            this.this$0 = float2ByteRBTreeMap;
            this.index = 0;
            this.next = float2ByteRBTreeMap.firstEntry;
        }

        TreeIterator(Float2ByteRBTreeMap float2ByteRBTreeMap, float f) {
            this.this$0 = float2ByteRBTreeMap;
            this.index = 0;
            this.next = float2ByteRBTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2ByteRBTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
