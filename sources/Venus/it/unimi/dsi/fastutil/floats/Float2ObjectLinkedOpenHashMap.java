...
Hash {
    ...
    public Float2ObjectLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Float2ObjectLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Float2ObjectLinkedOpenHashMap(float[] fArray, V[] VArray, float f) {
    ...
    public Float2ObjectLinkedOpenHashMap(float[] fArray, V[] VArray) {
    ...
    public ObjectCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>(this){
                final Float2ObjectLinkedOpenHashMap this$0;
                {
    ...
    public Float2ObjectLinkedOpenHashMap<V> clone() {
        Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap;
        try {
            float2ObjectLinkedOpenHashMap = (Float2ObjectLinkedOpenHashMap)super.clone();
        ...
        float2ObjectLinkedOpenHashMap.value = (Object[])this.value.clone();
    ...
    @Override
    public ObjectSortedSet float2ObjectEntrySet() {
    ...
    static Object access$100(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap) {
        return float2ObjectLinkedOpenHashMap.removeNullEntry();
    }

    static Object access$200(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap, int n) {
        return float2ObjectLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectListIterator<V> {
        ...
        public ValueIterator(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap) {
            this.this$0 = float2ObjectLinkedOpenHashMap;
    ...
    extends AbstractFloatSortedSet {
        ...
        private KeySet(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap) {
            this.this$0 = float2ObjectLinkedOpenHashMap;
        }
        ...
        KeySet(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap, 1 var2_2) {
            this(float2ObjectLinkedOpenHashMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap, float f) {
            this.this$0 = float2ObjectLinkedOpenHashMap;
            super(float2ObjectLinkedOpenHashMap, f, null);
        }
        ...
        public KeyIterator(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap) {
            this.this$0 = float2ObjectLinkedOpenHashMap;
            super(float2ObjectLinkedOpenHashMap);
        }
    ...
    implements Float2ObjectSortedMap.FastSortedEntrySet<V> {
        ...
        private MapEntrySet(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap) {
            this.this$0 = float2ObjectLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (Float.floatToIntBits(f) == 0) {
                if (this.this$0.containsNullKey && Objects.equals(this.this$0.value[this.this$0.n], v)) {
                    Float2ObjectLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (Float.floatToIntBits(f2) == Float.floatToIntBits(f)) {
                if (Objects.equals(this.this$0.value[n], v)) {
                    Float2ObjectLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        @Override
        public ObjectListIterator<Float2ObjectMap.Entry<V>> iterator(Float2ObjectMap.Entry<V> entry) {
        ...
        @Override
        public ObjectListIterator<Float2ObjectMap.Entry<V>> fastIterator(Float2ObjectMap.Entry<V> entry) {
        ...
        public void forEach(Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractFloat2ObjectMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Float2ObjectMap.Entry entry) {
        ...
        MapEntrySet(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap, 1 var2_2) {
            this(float2ObjectLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Float2ObjectMap.Entry<V>> {
        ...
        public FastEntryIterator(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap) {
            this.this$0 = float2ObjectLinkedOpenHashMap;
            super(float2ObjectLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap, float f) {
            this.this$0 = float2ObjectLinkedOpenHashMap;
            super(float2ObjectLinkedOpenHashMap, f, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Float2ObjectMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Float2ObjectMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Float2ObjectMap.Entry<V>> {
        ...
        public EntryIterator(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap) {
            this.this$0 = float2ObjectLinkedOpenHashMap;
            super(float2ObjectLinkedOpenHashMap);
        }

        public EntryIterator(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap, float f) {
            this.this$0 = float2ObjectLinkedOpenHashMap;
            super(float2ObjectLinkedOpenHashMap, f, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap) {
            this.this$0 = float2ObjectLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
        ...
        private MapIterator(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap, float f) {
            this.this$0 = float2ObjectLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            ...
            int n = HashCommon.mix(HashCommon.float2int(f)) & float2ObjectLinkedOpenHashMap.mask;
            while (Float.floatToIntBits(float2ObjectLinkedOpenHashMap.key[n]) != 0) {
                if (Float.floatToIntBits(float2ObjectLinkedOpenHashMap.key[n]) == Float.floatToIntBits(f)) {
                    this.next = (int)float2ObjectLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & float2ObjectLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + f + " does not belong to this map.");
        }
        ...
        MapIterator(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap, float f, 1 var3_3) {
            this(float2ObjectLinkedOpenHashMap, f);
        }
    }
    ...
    Map.Entry<Float, V> {
        ...
        MapEntry(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap, int n) {
            this.this$0 = float2ObjectLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Float2ObjectLinkedOpenHashMap float2ObjectLinkedOpenHashMap) {
            this.this$0 = float2ObjectLinkedOpenHashMap;
        }
