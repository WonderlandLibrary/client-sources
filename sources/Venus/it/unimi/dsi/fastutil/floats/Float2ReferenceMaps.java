...
public final class Float2ReferenceMaps {
    ...
    public static <V> ObjectIterator<Float2ReferenceMap.Entry<V>> fastIterator(Float2ReferenceMap<V> float2ReferenceMap) {
        ObjectSet<Float2ReferenceMap.Entry<V>> objectSet = float2ReferenceMap.float2ReferenceEntrySet();
        return objectSet instanceof Float2ReferenceMap.FastEntrySet ? ((Float2ReferenceMap.FastEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }
    ...
    public static <V> void fastForEach(Float2ReferenceMap<V> float2ReferenceMap, Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
        ObjectSet<Float2ReferenceMap.Entry<V>> objectSet = float2ReferenceMap.float2ReferenceEntrySet();
        if (objectSet instanceof Float2ReferenceMap.FastEntrySet) {
            ((Float2ReferenceMap.FastEntrySet)objectSet).fastForEach(consumer);
        } else {
    ...
    public static <V> ObjectIterable<Float2ReferenceMap.Entry<V>> fastIterable(Float2ReferenceMap<V> float2ReferenceMap) {
        ObjectSet<Float2ReferenceMap.Entry<V>> objectSet = float2ReferenceMap.float2ReferenceEntrySet();
        return objectSet instanceof Float2ReferenceMap.FastEntrySet ? new ObjectIterable<Float2ReferenceMap.Entry<V>>(objectSet){
            ...
            public ObjectIterator<Float2ReferenceMap.Entry<V>> iterator() {
                return ((Float2ReferenceMap.FastEntrySet)this.val$entries).fastIterator();
            }

            @Override
            public void forEach(Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
                ((Float2ReferenceMap.FastEntrySet)this.val$entries).fastForEach(consumer);
            }
    ...
    public static <V> Float2ReferenceMap<V> synchronize(Float2ReferenceMap<V> float2ReferenceMap) {
        return new SynchronizedMap<V>(float2ReferenceMap);
    }

    public static <V> Float2ReferenceMap<V> synchronize(Float2ReferenceMap<V> float2ReferenceMap, Object object) {
        return new SynchronizedMap<V>(float2ReferenceMap, object);
    }

    public static <V> Float2ReferenceMap<V> unmodifiable(Float2ReferenceMap<V> float2ReferenceMap) {
        return new UnmodifiableMap<V>(float2ReferenceMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableMap(Float2ReferenceMap<V> float2ReferenceMap) {
    ...
    Serializable {
        ...
        protected SynchronizedMap(Float2ReferenceMap<V> float2ReferenceMap, Object object) {
            super(float2ReferenceMap, object);
            this.map = float2ReferenceMap;
        }

        protected SynchronizedMap(Float2ReferenceMap<V> float2ReferenceMap) {
            super(float2ReferenceMap);
            this.map = float2ReferenceMap;
        }
        ...
        public V computeIfAbsentPartial(float f, Float2ReferenceFunction<? extends V> float2ReferenceFunction) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.computeIfAbsentPartial(f, float2ReferenceFunction);
            }
        }
