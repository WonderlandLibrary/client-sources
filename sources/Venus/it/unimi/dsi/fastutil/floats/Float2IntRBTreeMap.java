...
Cloneable {
    ...
    public Float2IntRBTreeMap(Comparator<? super Float> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Float2IntRBTreeMap(Map<? extends Float, ? extends Integer> map) {
        this();
        this.putAll(map);
    }

    public Float2IntRBTreeMap(SortedMap<Float, Integer> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Float, ? extends Integer>)sortedMap);
    }

    public Float2IntRBTreeMap(Float2IntMap float2IntMap) {
        this();
        this.putAll(float2IntMap);
    }

    public Float2IntRBTreeMap(Float2IntSortedMap float2IntSortedMap) {
        this(float2IntSortedMap.comparator());
        this.putAll(float2IntSortedMap);
    }

    public Float2IntRBTreeMap(float[] fArray, int[] nArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2IntRBTreeMap(float[] fArray, int[] nArray) {
    ...
    public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>(this){
                ...
                final Float2IntRBTreeMap this$0;
                {
                    this.this$0 = float2IntRBTreeMap;
    ...
    public Float2IntRBTreeMap clone() {
        Float2IntRBTreeMap float2IntRBTreeMap;
        try {
            float2IntRBTreeMap = (Float2IntRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2IntRBTreeMap.keys = null;
        float2IntRBTreeMap.values = null;
        float2IntRBTreeMap.entries = null;
        float2IntRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2IntRBTreeMap.firstEntry = float2IntRBTreeMap.tree = entry2.left;
                            while (float2IntRBTreeMap.firstEntry.left != null) {
                                float2IntRBTreeMap.firstEntry = float2IntRBTreeMap.firstEntry.left;
                            }
                            float2IntRBTreeMap.lastEntry = float2IntRBTreeMap.tree;
                            while (float2IntRBTreeMap.lastEntry.right != null) {
                                float2IntRBTreeMap.lastEntry = float2IntRBTreeMap.lastEntry.right;
                            }
                            return float2IntRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Float2IntRBTreeMap float2IntRBTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2IntRBTreeMap;
            if (!bl && !bl2 && float2IntRBTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2IntRBTreeMap.defRetValue;
        }
    ...
    implements IntListIterator {
        ...
        private ValueIterator(Float2IntRBTreeMap float2IntRBTreeMap) {
            this.this$0 = float2IntRBTreeMap;
            super(float2IntRBTreeMap);
        }
        ...
        ValueIterator(Float2IntRBTreeMap float2IntRBTreeMap, 1 var2_2) {
            this(float2IntRBTreeMap);
        }
    }
    ...
    extends AbstractFloat2IntSortedMap.KeySet {
        ...
        private KeySet(Float2IntRBTreeMap float2IntRBTreeMap) {
            this.this$0 = float2IntRBTreeMap;
            super(float2IntRBTreeMap);
        }
        ...
        KeySet(Float2IntRBTreeMap float2IntRBTreeMap, 1 var2_2) {
            this(float2IntRBTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2IntRBTreeMap float2IntRBTreeMap) {
            this.this$0 = float2IntRBTreeMap;
            super(float2IntRBTreeMap);
        }

        public KeyIterator(Float2IntRBTreeMap float2IntRBTreeMap, float f) {
            this.this$0 = float2IntRBTreeMap;
            super(float2IntRBTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2IntMap.Entry> {
        ...
        EntryIterator(Float2IntRBTreeMap float2IntRBTreeMap) {
            this.this$0 = float2IntRBTreeMap;
            super(float2IntRBTreeMap);
        }

        EntryIterator(Float2IntRBTreeMap float2IntRBTreeMap, float f) {
            this.this$0 = float2IntRBTreeMap;
            super(float2IntRBTreeMap, f);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2IntRBTreeMap float2IntRBTreeMap) {
            this.this$0 = float2IntRBTreeMap;
            this.index = 0;
            this.next = float2IntRBTreeMap.firstEntry;
        }

        TreeIterator(Float2IntRBTreeMap float2IntRBTreeMap, float f) {
            this.this$0 = float2IntRBTreeMap;
            this.index = 0;
            this.next = float2IntRBTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2IntRBTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
