...
Cloneable {
    ...
    public Float2ShortRBTreeMap(Comparator<? super Float> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Float2ShortRBTreeMap(Map<? extends Float, ? extends Short> map) {
        this();
        this.putAll(map);
    }

    public Float2ShortRBTreeMap(SortedMap<Float, Short> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Float, ? extends Short>)sortedMap);
    }

    public Float2ShortRBTreeMap(Float2ShortMap float2ShortMap) {
        this();
        this.putAll(float2ShortMap);
    }

    public Float2ShortRBTreeMap(Float2ShortSortedMap float2ShortSortedMap) {
        this(float2ShortSortedMap.comparator());
        this.putAll(float2ShortSortedMap);
    }

    public Float2ShortRBTreeMap(float[] fArray, short[] sArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2ShortRBTreeMap(float[] fArray, short[] sArray) {
    ...
    public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ShortMap.Entry>(this){
                ...
                final Float2ShortRBTreeMap this$0;
                {
                    this.this$0 = float2ShortRBTreeMap;
    ...
    public Float2ShortRBTreeMap clone() {
        Float2ShortRBTreeMap float2ShortRBTreeMap;
        try {
            float2ShortRBTreeMap = (Float2ShortRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2ShortRBTreeMap.keys = null;
        float2ShortRBTreeMap.values = null;
        float2ShortRBTreeMap.entries = null;
        float2ShortRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2ShortRBTreeMap.firstEntry = float2ShortRBTreeMap.tree = entry2.left;
                            while (float2ShortRBTreeMap.firstEntry.left != null) {
                                float2ShortRBTreeMap.firstEntry = float2ShortRBTreeMap.firstEntry.left;
                            }
                            float2ShortRBTreeMap.lastEntry = float2ShortRBTreeMap.tree;
                            while (float2ShortRBTreeMap.lastEntry.right != null) {
                                float2ShortRBTreeMap.lastEntry = float2ShortRBTreeMap.lastEntry.right;
                            }
                            return float2ShortRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Float2ShortRBTreeMap float2ShortRBTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2ShortRBTreeMap;
            if (!bl && !bl2 && float2ShortRBTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2ShortRBTreeMap.defRetValue;
        }
    ...
    implements ShortListIterator {
        ...
        private ValueIterator(Float2ShortRBTreeMap float2ShortRBTreeMap) {
            this.this$0 = float2ShortRBTreeMap;
            super(float2ShortRBTreeMap);
        }
        ...
        ValueIterator(Float2ShortRBTreeMap float2ShortRBTreeMap, 1 var2_2) {
            this(float2ShortRBTreeMap);
        }
    }
    ...
    extends AbstractFloat2ShortSortedMap.KeySet {
        ...
        private KeySet(Float2ShortRBTreeMap float2ShortRBTreeMap) {
            this.this$0 = float2ShortRBTreeMap;
            super(float2ShortRBTreeMap);
        }
        ...
        KeySet(Float2ShortRBTreeMap float2ShortRBTreeMap, 1 var2_2) {
            this(float2ShortRBTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2ShortRBTreeMap float2ShortRBTreeMap) {
            this.this$0 = float2ShortRBTreeMap;
            super(float2ShortRBTreeMap);
        }

        public KeyIterator(Float2ShortRBTreeMap float2ShortRBTreeMap, float f) {
            this.this$0 = float2ShortRBTreeMap;
            super(float2ShortRBTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2ShortMap.Entry> {
        ...
        EntryIterator(Float2ShortRBTreeMap float2ShortRBTreeMap) {
            this.this$0 = float2ShortRBTreeMap;
            super(float2ShortRBTreeMap);
        }

        EntryIterator(Float2ShortRBTreeMap float2ShortRBTreeMap, float f) {
            this.this$0 = float2ShortRBTreeMap;
            super(float2ShortRBTreeMap, f);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2ShortRBTreeMap float2ShortRBTreeMap) {
            this.this$0 = float2ShortRBTreeMap;
            this.index = 0;
            this.next = float2ShortRBTreeMap.firstEntry;
        }

        TreeIterator(Float2ShortRBTreeMap float2ShortRBTreeMap, float f) {
            this.this$0 = float2ShortRBTreeMap;
            this.index = 0;
            this.next = float2ShortRBTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2ShortRBTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
