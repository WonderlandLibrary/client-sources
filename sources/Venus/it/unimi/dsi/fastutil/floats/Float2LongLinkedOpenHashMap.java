...
Hash {
    ...
    public Float2LongLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Float2LongLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Float2LongLinkedOpenHashMap(Map<? extends Float, ? extends Long> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Float2LongLinkedOpenHashMap(Map<? extends Float, ? extends Long> map) {
        this(map, 0.75f);
    }

    public Float2LongLinkedOpenHashMap(Float2LongMap float2LongMap, float f) {
        this(float2LongMap.size(), f);
        this.putAll(float2LongMap);
    }

    public Float2LongLinkedOpenHashMap(Float2LongMap float2LongMap) {
        this(float2LongMap, 0.75f);
    }

    public Float2LongLinkedOpenHashMap(float[] fArray, long[] lArray, float f) {
    ...
    public Float2LongLinkedOpenHashMap(float[] fArray, long[] lArray) {
        this(fArray, lArray, 0.75f);
    }
    ...
    public long putAndMoveToFirst(float f, long l) {
        int n;
        if (Float.floatToIntBits(f) == 0) {
            if (this.containsNullKey) {
                this.moveIndexToFirst(this.n);
    ...
    public long putAndMoveToLast(float f, long l) {
        int n;
        if (Float.floatToIntBits(f) == 0) {
            if (this.containsNullKey) {
                this.moveIndexToLast(this.n);
    ...
    public boolean remove(float f, long l) {
        ...
        if (Float.floatToIntBits(f) == Float.floatToIntBits(f2) && l == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if (Float.floatToIntBits(f2 = fArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (Float.floatToIntBits(f) != Float.floatToIntBits(f2) || l != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection(this){
                final Float2LongLinkedOpenHashMap this$0;
                {
                    this.this$0 = float2LongLinkedOpenHashMap;
                }
    ...
    public Float2LongLinkedOpenHashMap clone() {
        Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap;
        try {
            float2LongLinkedOpenHashMap = (Float2LongLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2LongLinkedOpenHashMap.keys = null;
        float2LongLinkedOpenHashMap.values = null;
        float2LongLinkedOpenHashMap.entries = null;
        float2LongLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        float2LongLinkedOpenHashMap.key = (float[])this.key.clone();
        float2LongLinkedOpenHashMap.value = (long[])this.value.clone();
        float2LongLinkedOpenHashMap.link = (long[])this.link.clone();
        return float2LongLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet float2LongEntrySet() {
    ...
    static long access$100(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap) {
        return float2LongLinkedOpenHashMap.removeNullEntry();
    }

    static long access$200(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap, int n) {
        return float2LongLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements LongListIterator {
        ...
        public ValueIterator(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap) {
            this.this$0 = float2LongLinkedOpenHashMap;
            super(float2LongLinkedOpenHashMap);
        }
    ...
    extends AbstractFloatSortedSet {
        ...
        private KeySet(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap) {
            this.this$0 = float2LongLinkedOpenHashMap;
        }
        ...
        KeySet(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap, 1 var2_2) {
            this(float2LongLinkedOpenHashMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap, float f) {
            this.this$0 = float2LongLinkedOpenHashMap;
            super(float2LongLinkedOpenHashMap, f, null);
        }
        ...
        public KeyIterator(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap) {
            this.this$0 = float2LongLinkedOpenHashMap;
            super(float2LongLinkedOpenHashMap);
        }
    ...
    implements Float2LongSortedMap.FastSortedEntrySet {
        ...
        private MapEntrySet(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap) {
            this.this$0 = float2LongLinkedOpenHashMap;
        }
        ...
        @Override
        public ObjectSortedSet<Float2LongMap.Entry> subSet(Float2LongMap.Entry entry, Float2LongMap.Entry entry2) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Float2LongMap.Entry> headSet(Float2LongMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        @Override
        public ObjectSortedSet<Float2LongMap.Entry> tailSet(Float2LongMap.Entry entry) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(Object object) {
            ...
            if (Float.floatToIntBits(f) == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == l) {
                    Float2LongLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (Float.floatToIntBits(f2) == Float.floatToIntBits(f)) {
                if (this.this$0.value[n] == l) {
                    Float2LongLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if (Float.floatToIntBits(f2 = fArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (Float.floatToIntBits(f2) != Float.floatToIntBits(f) || this.this$0.value[n] != l);
            Float2LongLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Float2LongMap.Entry> iterator(Float2LongMap.Entry entry) {
        ...
        public ObjectListIterator<Float2LongMap.Entry> fastIterator(Float2LongMap.Entry entry) {
        ...
        public void forEach(Consumer<? super Float2LongMap.Entry> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractFloat2LongMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        public ObjectSortedSet tailSet(Object object) {
            return this.tailSet((Float2LongMap.Entry)object);
        }

        @Override
        public ObjectSortedSet headSet(Object object) {
            return this.headSet((Float2LongMap.Entry)object);
        }

        @Override
        public ObjectSortedSet subSet(Object object, Object object2) {
            return this.subSet((Float2LongMap.Entry)object, (Float2LongMap.Entry)object2);
        }

        @Override
        public ObjectBidirectionalIterator iterator(Object object) {
            return this.iterator((Float2LongMap.Entry)object);
        }
        ...
        public ObjectBidirectionalIterator fastIterator(Float2LongMap.Entry entry) {
        ...
        MapEntrySet(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap, 1 var2_2) {
            this(float2LongLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Float2LongMap.Entry> {
        ...
        public FastEntryIterator(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap) {
            this.this$0 = float2LongLinkedOpenHashMap;
            super(float2LongLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap, float f) {
            this.this$0 = float2LongLinkedOpenHashMap;
            super(float2LongLinkedOpenHashMap, f, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Float2LongMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Float2LongMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Float2LongMap.Entry> {
        ...
        public EntryIterator(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap) {
            this.this$0 = float2LongLinkedOpenHashMap;
            super(float2LongLinkedOpenHashMap);
        }

        public EntryIterator(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap, float f) {
            this.this$0 = float2LongLinkedOpenHashMap;
            super(float2LongLinkedOpenHashMap, f, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap) {
            this.this$0 = float2LongLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = float2LongLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap, float f) {
            this.this$0 = float2LongLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (Float.floatToIntBits(f) == 0) {
                if (float2LongLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)float2LongLinkedOpenHashMap.link[float2LongLinkedOpenHashMap.n];
                    this.prev = float2LongLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + f + " does not belong to this map.");
            }
            if (Float.floatToIntBits(float2LongLinkedOpenHashMap.key[float2LongLinkedOpenHashMap.last]) == Float.floatToIntBits(f)) {
                this.prev = float2LongLinkedOpenHashMap.last;
                this.index = float2LongLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(HashCommon.float2int(f)) & float2LongLinkedOpenHashMap.mask;
            while (Float.floatToIntBits(float2LongLinkedOpenHashMap.key[n]) != 0) {
                if (Float.floatToIntBits(float2LongLinkedOpenHashMap.key[n]) == Float.floatToIntBits(f)) {
                    this.next = (int)float2LongLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & float2LongLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + f + " does not belong to this map.");
        }
        ...
        public void set(Float2LongMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        public void add(Float2LongMap.Entry entry) {
            throw new UnsupportedOperationException();
        }

        MapIterator(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap, float f, 1 var3_3) {
            this(float2LongLinkedOpenHashMap, f);
        }
    }
    ...
    Map.Entry<Float, Long> {
        ...
        MapEntry(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap, int n) {
            this.this$0 = float2LongLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Float2LongLinkedOpenHashMap float2LongLinkedOpenHashMap) {
            this.this$0 = float2LongLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Float.floatToIntBits(this.this$0.key[this.index]) == Float.floatToIntBits(((Float)entry.getKey()).floatValue()) && this.this$0.value[this.index] == (Long)entry.getValue();
        }

        @Override
        public int hashCode() {
            return HashCommon.float2int(this.this$0.key[this.index]) ^ HashCommon.long2int(this.this$0.value[this.index]);
        }
