...
Map<Float, V> {
    ...
    default public V put(Float f, V v) {
        return Float2ObjectFunction.super.put(f, v);
    }

    @Override
    @Deprecated
    default public V get(Object object) {
        return Float2ObjectFunction.super.get(object);
    }

    @Override
    @Deprecated
    default public V remove(Object object) {
        return Float2ObjectFunction.super.remove(object);
    }
    ...
    default public boolean containsKey(Object object) {
        return Float2ObjectFunction.super.containsKey(object);
    }
    ...
    default public boolean remove(float f, Object object) {
        Object v = this.get(f);
        if (!Objects.equals(v, object) || v == this.defaultReturnValue() && !this.containsKey(f)) {
            return true;
        }
        this.remove(f);
        return false;
    ...
    default public boolean replace(float f, V v, V v2) {
        Object v3 = this.get(f);
        if (!Objects.equals(v3, v) || v3 == this.defaultReturnValue() && !this.containsKey(f)) {
            return true;
        }
        this.put(f, v2);
        return false;
    ...
    default public V computeIfAbsentPartial(float f, Float2ObjectFunction<? extends V> float2ObjectFunction) {
        ...
        if (!float2ObjectFunction.containsKey(f)) {
            return v2;
        }
        V v3 = float2ObjectFunction.get(f);
        this.put(f, v3);
        return v3;
    }
