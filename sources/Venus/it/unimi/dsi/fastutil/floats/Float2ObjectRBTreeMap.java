...
Cloneable {
    ...
    public Float2ObjectRBTreeMap(Comparator<? super Float> comparator) {
        this();
    ...
    public Float2ObjectRBTreeMap(SortedMap<Float, V> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<Float, V>)sortedMap);
    }

    public Float2ObjectRBTreeMap(Float2ObjectMap<? extends V> float2ObjectMap) {
        this();
        this.putAll(float2ObjectMap);
    }

    public Float2ObjectRBTreeMap(Float2ObjectSortedMap<V> float2ObjectSortedMap) {
        this(float2ObjectSortedMap.comparator());
        this.putAll(float2ObjectSortedMap);
    }

    public Float2ObjectRBTreeMap(float[] fArray, V[] VArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2ObjectRBTreeMap(float[] fArray, V[] VArray) {
    ...
    public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ObjectMap.Entry<V>>(this){
                ...
                final Float2ObjectRBTreeMap this$0;
                {
                    this.this$0 = float2ObjectRBTreeMap;
    ...
    public Float2ObjectRBTreeMap<V> clone() {
        Float2ObjectRBTreeMap float2ObjectRBTreeMap;
        try {
            float2ObjectRBTreeMap = (Float2ObjectRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2ObjectRBTreeMap.keys = null;
        float2ObjectRBTreeMap.values = null;
        float2ObjectRBTreeMap.entries = null;
        float2ObjectRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2ObjectRBTreeMap.tree = entry2.left;
                            float2ObjectRBTreeMap.firstEntry = float2ObjectRBTreeMap.tree;
                            while (float2ObjectRBTreeMap.firstEntry.left != null) {
                                float2ObjectRBTreeMap.firstEntry = float2ObjectRBTreeMap.firstEntry.left;
                            }
                            float2ObjectRBTreeMap.lastEntry = float2ObjectRBTreeMap.tree;
                            while (float2ObjectRBTreeMap.lastEntry.right != null) {
                                float2ObjectRBTreeMap.lastEntry = float2ObjectRBTreeMap.lastEntry.right;
                            }
                            return float2ObjectRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Float2ObjectRBTreeMap float2ObjectRBTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2ObjectRBTreeMap;
            if (!bl && !bl2 && float2ObjectRBTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2ObjectRBTreeMap.defRetValue;
        }
    ...
    implements ObjectListIterator<V> {
        ...
        private ValueIterator(Float2ObjectRBTreeMap float2ObjectRBTreeMap) {
            this.this$0 = float2ObjectRBTreeMap;
            super(float2ObjectRBTreeMap);
        }
        ...
        ValueIterator(Float2ObjectRBTreeMap float2ObjectRBTreeMap, 1 var2_2) {
            this(float2ObjectRBTreeMap);
        }
    }
    ...
    extends AbstractFloat2ObjectSortedMap.KeySet {
        ...
        private KeySet(Float2ObjectRBTreeMap float2ObjectRBTreeMap) {
            this.this$0 = float2ObjectRBTreeMap;
            super(float2ObjectRBTreeMap);
        }
        ...
        KeySet(Float2ObjectRBTreeMap float2ObjectRBTreeMap, 1 var2_2) {
            this(float2ObjectRBTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2ObjectRBTreeMap float2ObjectRBTreeMap) {
            this.this$0 = float2ObjectRBTreeMap;
            super(float2ObjectRBTreeMap);
        }

        public KeyIterator(Float2ObjectRBTreeMap float2ObjectRBTreeMap, float f) {
            this.this$0 = float2ObjectRBTreeMap;
            super(float2ObjectRBTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2ObjectMap.Entry<V>> {
        ...
        EntryIterator(Float2ObjectRBTreeMap float2ObjectRBTreeMap) {
            this.this$0 = float2ObjectRBTreeMap;
            super(float2ObjectRBTreeMap);
        }

        EntryIterator(Float2ObjectRBTreeMap float2ObjectRBTreeMap, float f) {
            this.this$0 = float2ObjectRBTreeMap;
            super(float2ObjectRBTreeMap, f);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2ObjectRBTreeMap float2ObjectRBTreeMap) {
            this.this$0 = float2ObjectRBTreeMap;
            this.index = 0;
            this.next = float2ObjectRBTreeMap.firstEntry;
        }

        TreeIterator(Float2ObjectRBTreeMap float2ObjectRBTreeMap, float f) {
            this.this$0 = float2ObjectRBTreeMap;
            this.index = 0;
            this.next = float2ObjectRBTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2ObjectRBTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
