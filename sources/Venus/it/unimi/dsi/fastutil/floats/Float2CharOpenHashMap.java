...
Hash {
    ...
    public Float2CharOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Float2CharOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Float2CharOpenHashMap(Map<? extends Float, ? extends Character> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Float2CharOpenHashMap(Map<? extends Float, ? extends Character> map) {
        this(map, 0.75f);
    }

    public Float2CharOpenHashMap(Float2CharMap float2CharMap, float f) {
        this(float2CharMap.size(), f);
        this.putAll(float2CharMap);
    }

    public Float2CharOpenHashMap(Float2CharMap float2CharMap) {
        this(float2CharMap, 0.75f);
    }

    public Float2CharOpenHashMap(float[] fArray, char[] cArray, float f) {
    ...
    public Float2CharOpenHashMap(float[] fArray, char[] cArray) {
    ...
    public CharCollection values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection(this){
                final Float2CharOpenHashMap this$0;
                {
                    this.this$0 = float2CharOpenHashMap;
                }
    ...
    public Float2CharOpenHashMap clone() {
        Float2CharOpenHashMap float2CharOpenHashMap;
        try {
            float2CharOpenHashMap = (Float2CharOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2CharOpenHashMap.keys = null;
        float2CharOpenHashMap.values = null;
        float2CharOpenHashMap.entries = null;
        float2CharOpenHashMap.containsNullKey = this.containsNullKey;
        float2CharOpenHashMap.key = (float[])this.key.clone();
        float2CharOpenHashMap.value = (char[])this.value.clone();
        return float2CharOpenHashMap;
    }
    ...
    static char access$300(Float2CharOpenHashMap float2CharOpenHashMap) {
        return float2CharOpenHashMap.removeNullEntry();
    }

    static char access$400(Float2CharOpenHashMap float2CharOpenHashMap, int n) {
        return float2CharOpenHashMap.removeEntry(n);
    }
    ...
    implements CharIterator {
        ...
        public ValueIterator(Float2CharOpenHashMap float2CharOpenHashMap) {
            this.this$0 = float2CharOpenHashMap;
            super(float2CharOpenHashMap, null);
        }
    ...
    extends AbstractFloatSet {
        ...
        private KeySet(Float2CharOpenHashMap float2CharOpenHashMap) {
            this.this$0 = float2CharOpenHashMap;
        }
        ...
        KeySet(Float2CharOpenHashMap float2CharOpenHashMap, 1 var2_2) {
            this(float2CharOpenHashMap);
        }
    }
    ...
    implements FloatIterator {
        ...
        public KeyIterator(Float2CharOpenHashMap float2CharOpenHashMap) {
            this.this$0 = float2CharOpenHashMap;
            super(float2CharOpenHashMap, null);
        }
    ...
    implements Float2CharMap.FastEntrySet {
        ...
        private MapEntrySet(Float2CharOpenHashMap float2CharOpenHashMap) {
            this.this$0 = float2CharOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (Float.floatToIntBits(f) == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == c) {
                    Float2CharOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (Float.floatToIntBits(f2) == Float.floatToIntBits(f)) {
                if (this.this$0.value[n] == c) {
                    Float2CharOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Float2CharOpenHashMap float2CharOpenHashMap, 1 var2_2) {
            this(float2CharOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2CharMap.Entry> {
        ...
        private FastEntryIterator(Float2CharOpenHashMap float2CharOpenHashMap) {
            this.this$0 = float2CharOpenHashMap;
            super(float2CharOpenHashMap, null);
        ...
        FastEntryIterator(Float2CharOpenHashMap float2CharOpenHashMap, 1 var2_2) {
            this(float2CharOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2CharMap.Entry> {
        ...
        private EntryIterator(Float2CharOpenHashMap float2CharOpenHashMap) {
            this.this$0 = float2CharOpenHashMap;
            super(float2CharOpenHashMap, null);
        }
        ...
        EntryIterator(Float2CharOpenHashMap float2CharOpenHashMap, 1 var2_2) {
            this(float2CharOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Float2CharOpenHashMap float2CharOpenHashMap) {
            this.this$0 = float2CharOpenHashMap;
        ...
        MapIterator(Float2CharOpenHashMap float2CharOpenHashMap, 1 var2_2) {
            this(float2CharOpenHashMap);
        }
    }
    ...
    Map.Entry<Float, Character> {
        ...
        MapEntry(Float2CharOpenHashMap float2CharOpenHashMap, int n) {
            this.this$0 = float2CharOpenHashMap;
            this.index = n;
        }

        MapEntry(Float2CharOpenHashMap float2CharOpenHashMap) {
            this.this$0 = float2CharOpenHashMap;
        }
