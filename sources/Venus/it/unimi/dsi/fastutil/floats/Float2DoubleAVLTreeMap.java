...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Float2DoubleAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Float2DoubleAVLTreeMap(Comparator<? super Float> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Float2DoubleAVLTreeMap(Map<? extends Float, ? extends Double> map) {
        this();
        this.putAll(map);
    }

    public Float2DoubleAVLTreeMap(SortedMap<Float, Double> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Float, ? extends Double>)sortedMap);
    }

    public Float2DoubleAVLTreeMap(Float2DoubleMap float2DoubleMap) {
        this();
        this.putAll(float2DoubleMap);
    }

    public Float2DoubleAVLTreeMap(Float2DoubleSortedMap float2DoubleSortedMap) {
        this(float2DoubleSortedMap.comparator());
        this.putAll(float2DoubleSortedMap);
    }

    public Float2DoubleAVLTreeMap(float[] fArray, double[] dArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2DoubleAVLTreeMap(float[] fArray, double[] dArray) {
        this(fArray, dArray, null);
    }
    ...
    public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>(this){
                final Comparator<? super Float2DoubleMap.Entry> comparator;
                final Float2DoubleAVLTreeMap this$0;
                {
                    this.this$0 = float2DoubleAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Float2DoubleMap.Entry> iterator(Float2DoubleMap.Entry entry) {
                ...
                public ObjectSortedSet<Float2DoubleMap.Entry> subSet(Float2DoubleMap.Entry entry, Float2DoubleMap.Entry entry2) {
                    return this.this$0.subMap(entry.getFloatKey(), entry2.getFloatKey()).float2DoubleEntrySet();
                }

                @Override
                public ObjectSortedSet<Float2DoubleMap.Entry> headSet(Float2DoubleMap.Entry entry) {
                    return this.this$0.headMap(entry.getFloatKey()).float2DoubleEntrySet();
                }

                @Override
                public ObjectSortedSet<Float2DoubleMap.Entry> tailSet(Float2DoubleMap.Entry entry) {
                    return this.this$0.tailMap(entry.getFloatKey()).float2DoubleEntrySet();
                }
                ...
                private int lambda$$0(Float2DoubleMap.Entry entry, Float2DoubleMap.Entry entry2) {
    ...
    public Float2DoubleAVLTreeMap clone() {
        Float2DoubleAVLTreeMap float2DoubleAVLTreeMap;
        try {
            float2DoubleAVLTreeMap = (Float2DoubleAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2DoubleAVLTreeMap.keys = null;
        float2DoubleAVLTreeMap.values = null;
        float2DoubleAVLTreeMap.entries = null;
        float2DoubleAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2DoubleAVLTreeMap.firstEntry = float2DoubleAVLTreeMap.tree = entry2.left;
                            while (float2DoubleAVLTreeMap.firstEntry.left != null) {
                                float2DoubleAVLTreeMap.firstEntry = float2DoubleAVLTreeMap.firstEntry.left;
                            }
                            float2DoubleAVLTreeMap.lastEntry = float2DoubleAVLTreeMap.tree;
                            while (float2DoubleAVLTreeMap.lastEntry.right != null) {
                                float2DoubleAVLTreeMap.lastEntry = float2DoubleAVLTreeMap.lastEntry.right;
                            }
                            return float2DoubleAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readFloat(), objectInputStream.readDouble());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readFloat(), objectInputStream.readDouble());
            entry4.right(new Entry(objectInputStream.readFloat(), objectInputStream.readDouble()));
    ...
    implements Serializable {
        ...
        public Submap(Float2DoubleAVLTreeMap float2DoubleAVLTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2DoubleAVLTreeMap;
            if (!bl && !bl2 && float2DoubleAVLTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2DoubleAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Float2DoubleMap.Entry> comparator() {
                        return this.this$1.this$0.float2DoubleEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Float2DoubleMap.Entry> subSet(Float2DoubleMap.Entry entry, Float2DoubleMap.Entry entry2) {
                        return this.this$1.subMap(entry.getFloatKey(), entry2.getFloatKey()).float2DoubleEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Float2DoubleMap.Entry> headSet(Float2DoubleMap.Entry entry) {
                        return this.this$1.headMap(entry.getFloatKey()).float2DoubleEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Float2DoubleMap.Entry> tailSet(Float2DoubleMap.Entry entry) {
                        return this.this$1.tailMap(entry.getFloatKey()).float2DoubleEntrySet();
                    }
    ...
    implements DoubleListIterator {
        ...
        private ValueIterator(Float2DoubleAVLTreeMap float2DoubleAVLTreeMap) {
            this.this$0 = float2DoubleAVLTreeMap;
            super(float2DoubleAVLTreeMap);
        }
        ...
        ValueIterator(Float2DoubleAVLTreeMap float2DoubleAVLTreeMap, 1 var2_2) {
            this(float2DoubleAVLTreeMap);
        }
    }
    ...
    extends AbstractFloat2DoubleSortedMap.KeySet {
        ...
        private KeySet(Float2DoubleAVLTreeMap float2DoubleAVLTreeMap) {
            this.this$0 = float2DoubleAVLTreeMap;
            super(float2DoubleAVLTreeMap);
        }
        ...
        KeySet(Float2DoubleAVLTreeMap float2DoubleAVLTreeMap, 1 var2_2) {
            this(float2DoubleAVLTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2DoubleAVLTreeMap float2DoubleAVLTreeMap) {
            this.this$0 = float2DoubleAVLTreeMap;
            super(float2DoubleAVLTreeMap);
        }

        public KeyIterator(Float2DoubleAVLTreeMap float2DoubleAVLTreeMap, float f) {
            this.this$0 = float2DoubleAVLTreeMap;
            super(float2DoubleAVLTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2DoubleMap.Entry> {
        ...
        EntryIterator(Float2DoubleAVLTreeMap float2DoubleAVLTreeMap) {
            this.this$0 = float2DoubleAVLTreeMap;
            super(float2DoubleAVLTreeMap);
        }

        EntryIterator(Float2DoubleAVLTreeMap float2DoubleAVLTreeMap, float f) {
            this.this$0 = float2DoubleAVLTreeMap;
            super(float2DoubleAVLTreeMap, f);
        }
        ...
        public void add(Object object) {
            this.add((Float2DoubleMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Float2DoubleMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2DoubleAVLTreeMap float2DoubleAVLTreeMap) {
            this.this$0 = float2DoubleAVLTreeMap;
            this.index = 0;
            this.next = float2DoubleAVLTreeMap.firstEntry;
        }

        TreeIterator(Float2DoubleAVLTreeMap float2DoubleAVLTreeMap, float f) {
            this.this$0 = float2DoubleAVLTreeMap;
            this.index = 0;
            this.next = float2DoubleAVLTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2DoubleAVLTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)entry.getKey()).floatValue()) && Double.doubleToLongBits(this.value) == Double.doubleToLongBits((Double)entry.getValue());
        }
