...
public final class Float2ObjectMaps {
    ...
    public static <V> ObjectIterator<Float2ObjectMap.Entry<V>> fastIterator(Float2ObjectMap<V> float2ObjectMap) {
        ObjectSet<Float2ObjectMap.Entry<V>> objectSet = float2ObjectMap.float2ObjectEntrySet();
        return objectSet instanceof Float2ObjectMap.FastEntrySet ? ((Float2ObjectMap.FastEntrySet)objectSet).fastIterator() : objectSet.iterator();
    }

    public static <V> void fastForEach(Float2ObjectMap<V> float2ObjectMap, Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
        ObjectSet<Float2ObjectMap.Entry<V>> objectSet = float2ObjectMap.float2ObjectEntrySet();
        if (objectSet instanceof Float2ObjectMap.FastEntrySet) {
            ((Float2ObjectMap.FastEntrySet)objectSet).fastForEach(consumer);
        } else {
            objectSet.forEach(consumer);
        }
    }

    public static <V> ObjectIterable<Float2ObjectMap.Entry<V>> fastIterable(Float2ObjectMap<V> float2ObjectMap) {
        ObjectSet<Float2ObjectMap.Entry<V>> objectSet = float2ObjectMap.float2ObjectEntrySet();
        return objectSet instanceof Float2ObjectMap.FastEntrySet ? new ObjectIterable<Float2ObjectMap.Entry<V>>(objectSet){
            ...
            public ObjectIterator<Float2ObjectMap.Entry<V>> iterator() {
                return ((Float2ObjectMap.FastEntrySet)this.val$entries).fastIterator();
            }

            @Override
            public void forEach(Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
                ((Float2ObjectMap.FastEntrySet)this.val$entries).fastForEach(consumer);
            }
    ...
    public static <V> Float2ObjectMap<V> singleton(float f, V v) {
    ...
    public static <V> Float2ObjectMap<V> synchronize(Float2ObjectMap<V> float2ObjectMap) {
        return new SynchronizedMap<V>(float2ObjectMap);
    }

    public static <V> Float2ObjectMap<V> synchronize(Float2ObjectMap<V> float2ObjectMap, Object object) {
        return new SynchronizedMap<V>(float2ObjectMap, object);
    }

    public static <V> Float2ObjectMap<V> unmodifiable(Float2ObjectMap<V> float2ObjectMap) {
        return new UnmodifiableMap<V>(float2ObjectMap);
    }
    ...
    Serializable {
        ...
        protected UnmodifiableMap(Float2ObjectMap<V> float2ObjectMap) {
            super(float2ObjectMap);
        ...
        public V getOrDefault(float f, V v) {
            return this.map.getOrDefault(f, v);
        }
        ...
        @Override
        public V computeIfAbsentPartial(float f, Float2ObjectFunction<? extends V> float2ObjectFunction) {
            throw new UnsupportedOperationException();
        }
    ...
    Serializable {
        ...
        protected SynchronizedMap(Float2ObjectMap<V> float2ObjectMap, Object object) {
            super(float2ObjectMap, object);
            this.map = float2ObjectMap;
        }

        protected SynchronizedMap(Float2ObjectMap<V> float2ObjectMap) {
            super(float2ObjectMap);
            this.map = float2ObjectMap;
        }
        ...
        public V putIfAbsent(float f, V v) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.putIfAbsent(f, v);
            }
        }
        ...
        public boolean remove(float f, Object object) {
            Object object2 = this.sync;
            synchronized (object2) {
                return this.map.remove(f, object);
            }
        }
        ...
        public boolean replace(float f, V v, V v2) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.replace(f, v, v2);
            }
        }
        ...
        public V computeIfAbsent(float f, DoubleFunction<? extends V> doubleFunction) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.computeIfAbsent(f, doubleFunction);
            }
        }
        ...
        public V computeIfAbsentPartial(float f, Float2ObjectFunction<? extends V> float2ObjectFunction) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.computeIfAbsentPartial(f, float2ObjectFunction);
            }
        }
        ...
        public V computeIfPresent(float f, BiFunction<? super Float, ? super V, ? extends V> biFunction) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.computeIfPresent(f, (BiFunction<Float, ? extends V, ? extends V>)biFunction);
            }
        }
        ...
        public V compute(float f, BiFunction<? super Float, ? super V, ? extends V> biFunction) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.compute(f, (BiFunction<Float, ? extends V, ? extends V>)biFunction);
            }
        }
        ...
        public V merge(float f, V v, BiFunction<? super V, ? super V, ? extends V> biFunction) {
            Object object = this.sync;
            synchronized (object) {
                return this.map.merge(f, (V)v, (BiFunction<? extends V, ? extends V, ? extends V>)biFunction);
            }
        }
