...
Hash {
    ...
    public Float2ReferenceOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Float2ReferenceOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Float2ReferenceOpenHashMap(Map<? extends Float, ? extends V> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Float2ReferenceOpenHashMap(Map<? extends Float, ? extends V> map) {
        this(map, 0.75f);
    }

    public Float2ReferenceOpenHashMap(Float2ReferenceMap<V> float2ReferenceMap, float f) {
        this(float2ReferenceMap.size(), f);
        this.putAll(float2ReferenceMap);
    }

    public Float2ReferenceOpenHashMap(Float2ReferenceMap<V> float2ReferenceMap) {
        this(float2ReferenceMap, 0.75f);
    }

    public Float2ReferenceOpenHashMap(float[] fArray, V[] VArray, float f) {
    ...
    public Float2ReferenceOpenHashMap(float[] fArray, V[] VArray) {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Float2ReferenceOpenHashMap this$0;
                {
                    this.this$0 = float2ReferenceOpenHashMap;
                }
    ...
    public Float2ReferenceOpenHashMap<V> clone() {
        Float2ReferenceOpenHashMap float2ReferenceOpenHashMap;
        try {
            float2ReferenceOpenHashMap = (Float2ReferenceOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2ReferenceOpenHashMap.keys = null;
        float2ReferenceOpenHashMap.values = null;
        float2ReferenceOpenHashMap.entries = null;
        float2ReferenceOpenHashMap.containsNullKey = this.containsNullKey;
        float2ReferenceOpenHashMap.key = (float[])this.key.clone();
        float2ReferenceOpenHashMap.value = (Object[])this.value.clone();
        return float2ReferenceOpenHashMap;
    }
    ...
    static Object access$300(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap) {
        return float2ReferenceOpenHashMap.removeNullEntry();
    }

    static Object access$400(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap, int n) {
        return float2ReferenceOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectIterator<V> {
        ...
        public ValueIterator(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap) {
            this.this$0 = float2ReferenceOpenHashMap;
            super(float2ReferenceOpenHashMap, null);
        }
    ...
    extends AbstractFloatSet {
        ...
        private KeySet(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap) {
            this.this$0 = float2ReferenceOpenHashMap;
        }
        ...
        KeySet(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap, 1 var2_2) {
            this(float2ReferenceOpenHashMap);
        }
    }
    ...
    implements FloatIterator {
        ...
        public KeyIterator(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap) {
            this.this$0 = float2ReferenceOpenHashMap;
            super(float2ReferenceOpenHashMap, null);
        }
    ...
    implements Float2ReferenceMap.FastEntrySet<V> {
        ...
        private MapEntrySet(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap) {
            this.this$0 = float2ReferenceOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (Float.floatToIntBits(f) == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Float2ReferenceOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (Float.floatToIntBits(f2) == Float.floatToIntBits(f)) {
                if (this.this$0.value[n] == v) {
                    Float2ReferenceOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap, 1 var2_2) {
            this(float2ReferenceOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2ReferenceMap.Entry<V>> {
        ...
        private FastEntryIterator(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap) {
            this.this$0 = float2ReferenceOpenHashMap;
            super(float2ReferenceOpenHashMap, null);
        ...
        FastEntryIterator(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap, 1 var2_2) {
            this(float2ReferenceOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2ReferenceMap.Entry<V>> {
        ...
        private EntryIterator(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap) {
            this.this$0 = float2ReferenceOpenHashMap;
            super(float2ReferenceOpenHashMap, null);
        }
        ...
        EntryIterator(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap, 1 var2_2) {
            this(float2ReferenceOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap) {
            this.this$0 = float2ReferenceOpenHashMap;
        ...
        MapIterator(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap, 1 var2_2) {
            this(float2ReferenceOpenHashMap);
        }
    }
    ...
    Map.Entry<Float, V> {
        ...
        MapEntry(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap, int n) {
            this.this$0 = float2ReferenceOpenHashMap;
            this.index = n;
        }

        MapEntry(Float2ReferenceOpenHashMap float2ReferenceOpenHashMap) {
            this.this$0 = float2ReferenceOpenHashMap;
        }
