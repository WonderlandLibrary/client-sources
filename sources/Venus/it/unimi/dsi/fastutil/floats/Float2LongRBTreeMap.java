...
Cloneable {
    ...
    public Float2LongRBTreeMap(Comparator<? super Float> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Float2LongRBTreeMap(Map<? extends Float, ? extends Long> map) {
        this();
        this.putAll(map);
    }

    public Float2LongRBTreeMap(SortedMap<Float, Long> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Float, ? extends Long>)sortedMap);
    }

    public Float2LongRBTreeMap(Float2LongMap float2LongMap) {
        this();
        this.putAll(float2LongMap);
    }

    public Float2LongRBTreeMap(Float2LongSortedMap float2LongSortedMap) {
        this(float2LongSortedMap.comparator());
        this.putAll(float2LongSortedMap);
    }

    public Float2LongRBTreeMap(float[] fArray, long[] lArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2LongRBTreeMap(float[] fArray, long[] lArray) {
    ...
    public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2LongMap.Entry>(this){
                ...
                final Float2LongRBTreeMap this$0;
                {
                    this.this$0 = float2LongRBTreeMap;
    ...
    public Float2LongRBTreeMap clone() {
        Float2LongRBTreeMap float2LongRBTreeMap;
        try {
            float2LongRBTreeMap = (Float2LongRBTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2LongRBTreeMap.keys = null;
        float2LongRBTreeMap.values = null;
        float2LongRBTreeMap.entries = null;
        float2LongRBTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2LongRBTreeMap.firstEntry = float2LongRBTreeMap.tree = entry2.left;
                            while (float2LongRBTreeMap.firstEntry.left != null) {
                                float2LongRBTreeMap.firstEntry = float2LongRBTreeMap.firstEntry.left;
                            }
                            float2LongRBTreeMap.lastEntry = float2LongRBTreeMap.tree;
                            while (float2LongRBTreeMap.lastEntry.right != null) {
                                float2LongRBTreeMap.lastEntry = float2LongRBTreeMap.lastEntry.right;
                            }
                            return float2LongRBTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    implements Serializable {
        ...
        public Submap(Float2LongRBTreeMap float2LongRBTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2LongRBTreeMap;
            if (!bl && !bl2 && float2LongRBTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2LongRBTreeMap.defRetValue;
        }
    ...
    implements LongListIterator {
        ...
        private ValueIterator(Float2LongRBTreeMap float2LongRBTreeMap) {
            this.this$0 = float2LongRBTreeMap;
            super(float2LongRBTreeMap);
        }
        ...
        ValueIterator(Float2LongRBTreeMap float2LongRBTreeMap, 1 var2_2) {
            this(float2LongRBTreeMap);
        }
    }
    ...
    extends AbstractFloat2LongSortedMap.KeySet {
        ...
        private KeySet(Float2LongRBTreeMap float2LongRBTreeMap) {
            this.this$0 = float2LongRBTreeMap;
            super(float2LongRBTreeMap);
        }
        ...
        KeySet(Float2LongRBTreeMap float2LongRBTreeMap, 1 var2_2) {
            this(float2LongRBTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2LongRBTreeMap float2LongRBTreeMap) {
            this.this$0 = float2LongRBTreeMap;
            super(float2LongRBTreeMap);
        }

        public KeyIterator(Float2LongRBTreeMap float2LongRBTreeMap, float f) {
            this.this$0 = float2LongRBTreeMap;
            super(float2LongRBTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2LongMap.Entry> {
        ...
        EntryIterator(Float2LongRBTreeMap float2LongRBTreeMap) {
            this.this$0 = float2LongRBTreeMap;
            super(float2LongRBTreeMap);
        }

        EntryIterator(Float2LongRBTreeMap float2LongRBTreeMap, float f) {
            this.this$0 = float2LongRBTreeMap;
            super(float2LongRBTreeMap, f);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2LongRBTreeMap float2LongRBTreeMap) {
            this.this$0 = float2LongRBTreeMap;
            this.index = 0;
            this.next = float2LongRBTreeMap.firstEntry;
        }

        TreeIterator(Float2LongRBTreeMap float2LongRBTreeMap, float f) {
            this.this$0 = float2LongRBTreeMap;
            this.index = 0;
            this.next = float2LongRBTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2LongRBTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
