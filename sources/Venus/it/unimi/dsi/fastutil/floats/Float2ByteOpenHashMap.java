...
Hash {
    ...
    public Float2ByteOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Float2ByteOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Float2ByteOpenHashMap(Map<? extends Float, ? extends Byte> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Float2ByteOpenHashMap(Map<? extends Float, ? extends Byte> map) {
        this(map, 0.75f);
    }

    public Float2ByteOpenHashMap(Float2ByteMap float2ByteMap, float f) {
        this(float2ByteMap.size(), f);
        this.putAll(float2ByteMap);
    }

    public Float2ByteOpenHashMap(Float2ByteMap float2ByteMap) {
        this(float2ByteMap, 0.75f);
    }

    public Float2ByteOpenHashMap(float[] fArray, byte[] byArray, float f) {
    ...
    public Float2ByteOpenHashMap(float[] fArray, byte[] byArray) {
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection(this){
                final Float2ByteOpenHashMap this$0;
                {
                    this.this$0 = float2ByteOpenHashMap;
                }
    ...
    public Float2ByteOpenHashMap clone() {
        Float2ByteOpenHashMap float2ByteOpenHashMap;
        try {
            float2ByteOpenHashMap = (Float2ByteOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2ByteOpenHashMap.keys = null;
        float2ByteOpenHashMap.values = null;
        float2ByteOpenHashMap.entries = null;
        float2ByteOpenHashMap.containsNullKey = this.containsNullKey;
        float2ByteOpenHashMap.key = (float[])this.key.clone();
        float2ByteOpenHashMap.value = (byte[])this.value.clone();
        return float2ByteOpenHashMap;
    }
    ...
    static byte access$300(Float2ByteOpenHashMap float2ByteOpenHashMap) {
        return float2ByteOpenHashMap.removeNullEntry();
    }

    static byte access$400(Float2ByteOpenHashMap float2ByteOpenHashMap, int n) {
        return float2ByteOpenHashMap.removeEntry(n);
    }
    ...
    implements ByteIterator {
        ...
        public ValueIterator(Float2ByteOpenHashMap float2ByteOpenHashMap) {
            this.this$0 = float2ByteOpenHashMap;
            super(float2ByteOpenHashMap, null);
        }
    ...
    extends AbstractFloatSet {
        ...
        private KeySet(Float2ByteOpenHashMap float2ByteOpenHashMap) {
            this.this$0 = float2ByteOpenHashMap;
        }
        ...
        KeySet(Float2ByteOpenHashMap float2ByteOpenHashMap, 1 var2_2) {
            this(float2ByteOpenHashMap);
        }
    }
    ...
    implements FloatIterator {
        ...
        public KeyIterator(Float2ByteOpenHashMap float2ByteOpenHashMap) {
            this.this$0 = float2ByteOpenHashMap;
            super(float2ByteOpenHashMap, null);
        }
    ...
    implements Float2ByteMap.FastEntrySet {
        ...
        private MapEntrySet(Float2ByteOpenHashMap float2ByteOpenHashMap) {
            this.this$0 = float2ByteOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (Float.floatToIntBits(f) == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == by) {
                    Float2ByteOpenHashMap.access$300(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (Float.floatToIntBits(f2) == Float.floatToIntBits(f)) {
                if (this.this$0.value[n] == by) {
                    Float2ByteOpenHashMap.access$400(this.this$0, n);
                    return false;
                }
                return true;
            }
        ...
        MapEntrySet(Float2ByteOpenHashMap float2ByteOpenHashMap, 1 var2_2) {
            this(float2ByteOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2ByteMap.Entry> {
        ...
        private FastEntryIterator(Float2ByteOpenHashMap float2ByteOpenHashMap) {
            this.this$0 = float2ByteOpenHashMap;
            super(float2ByteOpenHashMap, null);
        ...
        FastEntryIterator(Float2ByteOpenHashMap float2ByteOpenHashMap, 1 var2_2) {
            this(float2ByteOpenHashMap);
        }
    }
    ...
    implements ObjectIterator<Float2ByteMap.Entry> {
        ...
        private EntryIterator(Float2ByteOpenHashMap float2ByteOpenHashMap) {
            this.this$0 = float2ByteOpenHashMap;
            super(float2ByteOpenHashMap, null);
        }
        ...
        EntryIterator(Float2ByteOpenHashMap float2ByteOpenHashMap, 1 var2_2) {
            this(float2ByteOpenHashMap);
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(Float2ByteOpenHashMap float2ByteOpenHashMap) {
            this.this$0 = float2ByteOpenHashMap;
        ...
        MapIterator(Float2ByteOpenHashMap float2ByteOpenHashMap, 1 var2_2) {
            this(float2ByteOpenHashMap);
        }
    }
    ...
    Map.Entry<Float, Byte> {
        ...
        MapEntry(Float2ByteOpenHashMap float2ByteOpenHashMap, int n) {
            this.this$0 = float2ByteOpenHashMap;
            this.index = n;
        }

        MapEntry(Float2ByteOpenHashMap float2ByteOpenHashMap) {
            this.this$0 = float2ByteOpenHashMap;
        }
