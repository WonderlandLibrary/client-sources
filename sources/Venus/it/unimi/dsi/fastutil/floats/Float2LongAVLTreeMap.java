...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Float2LongAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Float2LongAVLTreeMap(Comparator<? super Float> comparator) {
        this();
    ...
    public Float2LongAVLTreeMap(SortedMap<Float, Long> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Float, ? extends Long>)sortedMap);
    }
    ...
    public Float2LongAVLTreeMap(Float2LongSortedMap float2LongSortedMap) {
        this(float2LongSortedMap.comparator());
        this.putAll(float2LongSortedMap);
    }

    public Float2LongAVLTreeMap(float[] fArray, long[] lArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2LongAVLTreeMap(float[] fArray, long[] lArray) {
        this(fArray, lArray, null);
    }
    ...
    public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2LongMap.Entry>(this){
                final Comparator<? super Float2LongMap.Entry> comparator;
                final Float2LongAVLTreeMap this$0;
                {
                    this.this$0 = float2LongAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator(Float2LongMap.Entry entry) {
                ...
                public ObjectSortedSet<Float2LongMap.Entry> subSet(Float2LongMap.Entry entry, Float2LongMap.Entry entry2) {
                    return this.this$0.subMap(entry.getFloatKey(), entry2.getFloatKey()).float2LongEntrySet();
                }

                @Override
                public ObjectSortedSet<Float2LongMap.Entry> headSet(Float2LongMap.Entry entry) {
                    return this.this$0.headMap(entry.getFloatKey()).float2LongEntrySet();
                }

                @Override
                public ObjectSortedSet<Float2LongMap.Entry> tailSet(Float2LongMap.Entry entry) {
                    return this.this$0.tailMap(entry.getFloatKey()).float2LongEntrySet();
                }
                ...
                private int lambda$$0(Float2LongMap.Entry entry, Float2LongMap.Entry entry2) {
    ...
    public Float2LongAVLTreeMap clone() {
        Float2LongAVLTreeMap float2LongAVLTreeMap;
        try {
            float2LongAVLTreeMap = (Float2LongAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2LongAVLTreeMap.keys = null;
        float2LongAVLTreeMap.values = null;
        float2LongAVLTreeMap.entries = null;
        float2LongAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2LongAVLTreeMap.firstEntry = float2LongAVLTreeMap.tree = entry2.left;
                            while (float2LongAVLTreeMap.firstEntry.left != null) {
                                float2LongAVLTreeMap.firstEntry = float2LongAVLTreeMap.firstEntry.left;
                            }
                            float2LongAVLTreeMap.lastEntry = float2LongAVLTreeMap.tree;
                            while (float2LongAVLTreeMap.lastEntry.right != null) {
                                float2LongAVLTreeMap.lastEntry = float2LongAVLTreeMap.lastEntry.right;
                            }
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readFloat(), objectInputStream.readLong());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readFloat(), objectInputStream.readLong());
            entry4.right(new Entry(objectInputStream.readFloat(), objectInputStream.readLong()));
    ...
    implements Serializable {
        ...
        public Submap(Float2LongAVLTreeMap float2LongAVLTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2LongAVLTreeMap;
            if (!bl && !bl2 && float2LongAVLTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2LongAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2LongMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Float2LongMap.Entry> comparator() {
                        return this.this$1.this$0.float2LongEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Float2LongMap.Entry> subSet(Float2LongMap.Entry entry, Float2LongMap.Entry entry2) {
                        return this.this$1.subMap(entry.getFloatKey(), entry2.getFloatKey()).float2LongEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Float2LongMap.Entry> headSet(Float2LongMap.Entry entry) {
                        return this.this$1.headMap(entry.getFloatKey()).float2LongEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Float2LongMap.Entry> tailSet(Float2LongMap.Entry entry) {
                        return this.this$1.tailMap(entry.getFloatKey()).float2LongEntrySet();
                    }
    ...
    implements LongListIterator {
        ...
        private ValueIterator(Float2LongAVLTreeMap float2LongAVLTreeMap) {
            this.this$0 = float2LongAVLTreeMap;
            super(float2LongAVLTreeMap);
        }
        ...
        ValueIterator(Float2LongAVLTreeMap float2LongAVLTreeMap, 1 var2_2) {
            this(float2LongAVLTreeMap);
        }
    }
    ...
    extends AbstractFloat2LongSortedMap.KeySet {
        ...
        private KeySet(Float2LongAVLTreeMap float2LongAVLTreeMap) {
            this.this$0 = float2LongAVLTreeMap;
            super(float2LongAVLTreeMap);
        }
        ...
        KeySet(Float2LongAVLTreeMap float2LongAVLTreeMap, 1 var2_2) {
            this(float2LongAVLTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2LongAVLTreeMap float2LongAVLTreeMap) {
            this.this$0 = float2LongAVLTreeMap;
            super(float2LongAVLTreeMap);
        }

        public KeyIterator(Float2LongAVLTreeMap float2LongAVLTreeMap, float f) {
            this.this$0 = float2LongAVLTreeMap;
            super(float2LongAVLTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2LongMap.Entry> {
        ...
        EntryIterator(Float2LongAVLTreeMap float2LongAVLTreeMap) {
            this.this$0 = float2LongAVLTreeMap;
            super(float2LongAVLTreeMap);
        }

        EntryIterator(Float2LongAVLTreeMap float2LongAVLTreeMap, float f) {
            this.this$0 = float2LongAVLTreeMap;
            super(float2LongAVLTreeMap, f);
        }
        ...
        public void add(Object object) {
            this.add((Float2LongMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Float2LongMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2LongAVLTreeMap float2LongAVLTreeMap) {
            this.this$0 = float2LongAVLTreeMap;
            this.index = 0;
            this.next = float2LongAVLTreeMap.firstEntry;
        }

        TreeIterator(Float2LongAVLTreeMap float2LongAVLTreeMap, float f) {
            this.this$0 = float2LongAVLTreeMap;
            this.index = 0;
            this.next = float2LongAVLTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2LongAVLTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)entry.getKey()).floatValue()) && this.value == (Long)entry.getValue();
        }
