...
Hash {
    ...
    public Float2ReferenceLinkedOpenHashMap(int n, float f) {
        if (f <= 0.0f || f > 1.0f) {
    ...
    public Float2ReferenceLinkedOpenHashMap(int n) {
        this(n, 0.75f);
    }
    ...
    public Float2ReferenceLinkedOpenHashMap(Map<? extends Float, ? extends V> map, float f) {
        this(map.size(), f);
        this.putAll(map);
    }

    public Float2ReferenceLinkedOpenHashMap(Map<? extends Float, ? extends V> map) {
        this(map, 0.75f);
    }

    public Float2ReferenceLinkedOpenHashMap(Float2ReferenceMap<V> float2ReferenceMap, float f) {
        this(float2ReferenceMap.size(), f);
        this.putAll(float2ReferenceMap);
    }

    public Float2ReferenceLinkedOpenHashMap(Float2ReferenceMap<V> float2ReferenceMap) {
        this(float2ReferenceMap, 0.75f);
    }

    public Float2ReferenceLinkedOpenHashMap(float[] fArray, V[] VArray, float f) {
    ...
    public Float2ReferenceLinkedOpenHashMap(float[] fArray, V[] VArray) {
    ...
    public boolean remove(float f, Object object) {
        ...
        if (Float.floatToIntBits(f) == Float.floatToIntBits(f2) && object == this.value[n]) {
            this.removeEntry(n);
            return false;
        }
        do {
            if (Float.floatToIntBits(f2 = fArray[n = n + 1 & this.mask]) != 0) continue;
            return true;
        } while (Float.floatToIntBits(f) != Float.floatToIntBits(f2) || object != this.value[n]);
        this.removeEntry(n);
        return false;
    }
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>(this){
                final Float2ReferenceLinkedOpenHashMap this$0;
                {
                    this.this$0 = float2ReferenceLinkedOpenHashMap;
                }
    ...
    public Float2ReferenceLinkedOpenHashMap<V> clone() {
        Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap;
        try {
            float2ReferenceLinkedOpenHashMap = (Float2ReferenceLinkedOpenHashMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2ReferenceLinkedOpenHashMap.keys = null;
        float2ReferenceLinkedOpenHashMap.values = null;
        float2ReferenceLinkedOpenHashMap.entries = null;
        float2ReferenceLinkedOpenHashMap.containsNullKey = this.containsNullKey;
        float2ReferenceLinkedOpenHashMap.key = (float[])this.key.clone();
        float2ReferenceLinkedOpenHashMap.value = (Object[])this.value.clone();
        float2ReferenceLinkedOpenHashMap.link = (long[])this.link.clone();
        return float2ReferenceLinkedOpenHashMap;
    }
    ...
    @Override
    public ObjectSortedSet float2ReferenceEntrySet() {
    ...
    static Object access$100(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap) {
        return float2ReferenceLinkedOpenHashMap.removeNullEntry();
    }

    static Object access$200(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap, int n) {
        return float2ReferenceLinkedOpenHashMap.removeEntry(n);
    }
    ...
    implements ObjectListIterator<V> {
        ...
        public ValueIterator(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap) {
            this.this$0 = float2ReferenceLinkedOpenHashMap;
            super(float2ReferenceLinkedOpenHashMap);
        }
    ...
    extends AbstractFloatSortedSet {
        ...
        private KeySet(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap) {
            this.this$0 = float2ReferenceLinkedOpenHashMap;
        }
        ...
        KeySet(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap, 1 var2_2) {
            this(float2ReferenceLinkedOpenHashMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap, float f) {
            this.this$0 = float2ReferenceLinkedOpenHashMap;
            super(float2ReferenceLinkedOpenHashMap, f, null);
        }
        ...
        public KeyIterator(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap) {
            this.this$0 = float2ReferenceLinkedOpenHashMap;
            super(float2ReferenceLinkedOpenHashMap);
        }
    ...
    implements Float2ReferenceSortedMap.FastSortedEntrySet<V> {
        ...
        private MapEntrySet(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap) {
            this.this$0 = float2ReferenceLinkedOpenHashMap;
        }
        ...
        public boolean remove(Object object) {
            ...
            if (Float.floatToIntBits(f) == 0) {
                if (this.this$0.containsNullKey && this.this$0.value[this.this$0.n] == v) {
                    Float2ReferenceLinkedOpenHashMap.access$100(this.this$0);
                    return false;
                }
                return true;
            }
            ...
            if (Float.floatToIntBits(f2) == Float.floatToIntBits(f)) {
                if (this.this$0.value[n] == v) {
                    Float2ReferenceLinkedOpenHashMap.access$200(this.this$0, n);
                    return false;
                }
                return true;
            }
            do {
                if (Float.floatToIntBits(f2 = fArray[n = n + 1 & this.this$0.mask]) != 0) continue;
                return true;
            } while (Float.floatToIntBits(f2) != Float.floatToIntBits(f) || this.this$0.value[n] != v);
            Float2ReferenceLinkedOpenHashMap.access$200(this.this$0, n);
            return false;
        }
        ...
        @Override
        public ObjectListIterator<Float2ReferenceMap.Entry<V>> iterator(Float2ReferenceMap.Entry<V> entry) {
        ...
        @Override
        public ObjectListIterator<Float2ReferenceMap.Entry<V>> fastIterator(Float2ReferenceMap.Entry<V> entry) {
        ...
        public void forEach(Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
            ...
            while (n-- != 0) {
                ...
                consumer.accept(new AbstractFloat2ReferenceMap.BasicEntry(this.this$0.key[n3], this.this$0.value[n3]));
            }
        }
        ...
        @Override
        public ObjectBidirectionalIterator fastIterator(Float2ReferenceMap.Entry entry) {
        ...
        MapEntrySet(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap, 1 var2_2) {
            this(float2ReferenceLinkedOpenHashMap);
        }
    }
    ...
    implements ObjectListIterator<Float2ReferenceMap.Entry<V>> {
        ...
        public FastEntryIterator(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap) {
            this.this$0 = float2ReferenceLinkedOpenHashMap;
            super(float2ReferenceLinkedOpenHashMap);
            this.entry = new MapEntry(this.this$0);
        }

        public FastEntryIterator(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap, float f) {
            this.this$0 = float2ReferenceLinkedOpenHashMap;
            super(float2ReferenceLinkedOpenHashMap, f, null);
            this.entry = new MapEntry(this.this$0);
        }
        ...
        public void add(Object object) {
            super.add((Float2ReferenceMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            super.set((Float2ReferenceMap.Entry)object);
        }
    ...
    implements ObjectListIterator<Float2ReferenceMap.Entry<V>> {
        ...
        public EntryIterator(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap) {
            this.this$0 = float2ReferenceLinkedOpenHashMap;
            super(float2ReferenceLinkedOpenHashMap);
        }

        public EntryIterator(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap, float f) {
            this.this$0 = float2ReferenceLinkedOpenHashMap;
            super(float2ReferenceLinkedOpenHashMap, f, null);
        }
    ...
    private class MapIterator {
        ...
        protected MapIterator(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap) {
            this.this$0 = float2ReferenceLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            this.next = float2ReferenceLinkedOpenHashMap.first;
            this.index = 0;
        }

        private MapIterator(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap, float f) {
            this.this$0 = float2ReferenceLinkedOpenHashMap;
            this.prev = -1;
            this.next = -1;
            this.curr = -1;
            this.index = -1;
            if (Float.floatToIntBits(f) == 0) {
                if (float2ReferenceLinkedOpenHashMap.containsNullKey) {
                    this.next = (int)float2ReferenceLinkedOpenHashMap.link[float2ReferenceLinkedOpenHashMap.n];
                    this.prev = float2ReferenceLinkedOpenHashMap.n;
                    return;
                }
                throw new NoSuchElementException("The key " + f + " does not belong to this map.");
            }
            if (Float.floatToIntBits(float2ReferenceLinkedOpenHashMap.key[float2ReferenceLinkedOpenHashMap.last]) == Float.floatToIntBits(f)) {
                this.prev = float2ReferenceLinkedOpenHashMap.last;
                this.index = float2ReferenceLinkedOpenHashMap.size;
                return;
            }
            int n = HashCommon.mix(HashCommon.float2int(f)) & float2ReferenceLinkedOpenHashMap.mask;
            while (Float.floatToIntBits(float2ReferenceLinkedOpenHashMap.key[n]) != 0) {
                if (Float.floatToIntBits(float2ReferenceLinkedOpenHashMap.key[n]) == Float.floatToIntBits(f)) {
                    this.next = (int)float2ReferenceLinkedOpenHashMap.link[n];
                    this.prev = n;
                    return;
                }
                n = n + 1 & float2ReferenceLinkedOpenHashMap.mask;
            }
            throw new NoSuchElementException("The key " + f + " does not belong to this map.");
        }
        ...
        MapIterator(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap, float f, 1 var3_3) {
            this(float2ReferenceLinkedOpenHashMap, f);
        }
    }
    ...
    Map.Entry<Float, V> {
        ...
        MapEntry(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap, int n) {
            this.this$0 = float2ReferenceLinkedOpenHashMap;
            this.index = n;
        }

        MapEntry(Float2ReferenceLinkedOpenHashMap float2ReferenceLinkedOpenHashMap) {
            this.this$0 = float2ReferenceLinkedOpenHashMap;
        }
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Float.floatToIntBits(this.this$0.key[this.index]) == Float.floatToIntBits(((Float)entry.getKey()).floatValue()) && this.this$0.value[this.index] == entry.getValue();
        }

        @Override
        public int hashCode() {
            return HashCommon.float2int(this.this$0.key[this.index]) ^ (this.this$0.value[this.index] == null ? 0 : System.identityHashCode(this.this$0.value[this.index]));
        }
