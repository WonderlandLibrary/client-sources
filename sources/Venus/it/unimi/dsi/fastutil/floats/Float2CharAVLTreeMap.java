...
Cloneable {
    ...
    static final boolean $assertionsDisabled = !Float2CharAVLTreeMap.class.desiredAssertionStatus();
    ...
    public Float2CharAVLTreeMap(Comparator<? super Float> comparator) {
        this();
        this.storedComparator = comparator;
        this.setActualComparator();
    }

    public Float2CharAVLTreeMap(Map<? extends Float, ? extends Character> map) {
        this();
        this.putAll(map);
    }

    public Float2CharAVLTreeMap(SortedMap<Float, Character> sortedMap) {
        this(sortedMap.comparator());
        this.putAll((Map<? extends Float, ? extends Character>)sortedMap);
    }

    public Float2CharAVLTreeMap(Float2CharMap float2CharMap) {
        this();
        this.putAll(float2CharMap);
    }

    public Float2CharAVLTreeMap(Float2CharSortedMap float2CharSortedMap) {
        this(float2CharSortedMap.comparator());
        this.putAll(float2CharSortedMap);
    }

    public Float2CharAVLTreeMap(float[] fArray, char[] cArray, Comparator<? super Float> comparator) {
        this(comparator);
    ...
    public Float2CharAVLTreeMap(float[] fArray, char[] cArray) {
        this(fArray, cArray, null);
    }
    ...
    public char addTo(float f, char c) {
    ...
    public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2CharMap.Entry>(this){
                final Comparator<? super Float2CharMap.Entry> comparator;
                final Float2CharAVLTreeMap this$0;
                {
                    this.this$0 = float2CharAVLTreeMap;
                ...
                @Override
                public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator(Float2CharMap.Entry entry) {
                ...
                public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry entry, Float2CharMap.Entry entry2) {
                    return this.this$0.subMap(entry.getFloatKey(), entry2.getFloatKey()).float2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry entry) {
                    return this.this$0.headMap(entry.getFloatKey()).float2CharEntrySet();
                }

                @Override
                public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry entry) {
                    return this.this$0.tailMap(entry.getFloatKey()).float2CharEntrySet();
                }
                ...
                private int lambda$$0(Float2CharMap.Entry entry, Float2CharMap.Entry entry2) {
    ...
    public Float2CharAVLTreeMap clone() {
        Float2CharAVLTreeMap float2CharAVLTreeMap;
        try {
            float2CharAVLTreeMap = (Float2CharAVLTreeMap)super.clone();
        } catch (CloneNotSupportedException cloneNotSupportedException) {
            throw new InternalError();
        }
        float2CharAVLTreeMap.keys = null;
        float2CharAVLTreeMap.values = null;
        float2CharAVLTreeMap.entries = null;
        float2CharAVLTreeMap.allocatePaths();
        if (this.count != 0) {
            ...
            while (true) {
                ...
                if (!entry3.pred()) {
                    ...
                    while (entry3.succ()) {
                        ...
                        if (entry3 == null) {
                            entry4.right = null;
                            float2CharAVLTreeMap.firstEntry = float2CharAVLTreeMap.tree = entry2.left;
                            while (float2CharAVLTreeMap.firstEntry.left != null) {
                                float2CharAVLTreeMap.firstEntry = float2CharAVLTreeMap.firstEntry.left;
                            }
                            float2CharAVLTreeMap.lastEntry = float2CharAVLTreeMap.tree;
                            while (float2CharAVLTreeMap.lastEntry.right != null) {
                                float2CharAVLTreeMap.lastEntry = float2CharAVLTreeMap.lastEntry.right;
                            }
                            return float2CharAVLTreeMap;
                        }
                        entry4 = entry4.right;
                    }
                    entry3 = entry3.right;
    ...
    private Entry readTree(ObjectInputStream objectInputStream, int n, Entry entry, Entry entry2) throws IOException, ClassNotFoundException {
        if (n == 1) {
            Entry entry3 = new Entry(objectInputStream.readFloat(), objectInputStream.readChar());
            entry3.pred(entry);
            entry3.succ(entry2);
            return entry3;
        }
        if (n == 2) {
            Entry entry4 = new Entry(objectInputStream.readFloat(), objectInputStream.readChar());
            entry4.right(new Entry(objectInputStream.readFloat(), objectInputStream.readChar()));
    ...
    implements Serializable {
        ...
        public Submap(Float2CharAVLTreeMap float2CharAVLTreeMap, float f, boolean bl, float f2, boolean bl2) {
            this.this$0 = float2CharAVLTreeMap;
            if (!bl && !bl2 && float2CharAVLTreeMap.compare(f, f2) > 0) {
            ...
            this.to = f2;
            this.top = bl2;
            this.defRetValue = float2CharAVLTreeMap.defRetValue;
        }
        ...
        public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2CharMap.Entry>(this){
                    ...
                    @Override
                    public Comparator<? super Float2CharMap.Entry> comparator() {
                        return this.this$1.this$0.float2CharEntrySet().comparator();
                    }
                    ...
                    @Override
                    public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry entry, Float2CharMap.Entry entry2) {
                        return this.this$1.subMap(entry.getFloatKey(), entry2.getFloatKey()).float2CharEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry entry) {
                        return this.this$1.headMap(entry.getFloatKey()).float2CharEntrySet();
                    }

                    @Override
                    public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry entry) {
                        return this.this$1.tailMap(entry.getFloatKey()).float2CharEntrySet();
                    }
    ...
    implements CharListIterator {
        ...
        private ValueIterator(Float2CharAVLTreeMap float2CharAVLTreeMap) {
            this.this$0 = float2CharAVLTreeMap;
            super(float2CharAVLTreeMap);
        }
        ...
        ValueIterator(Float2CharAVLTreeMap float2CharAVLTreeMap, 1 var2_2) {
            this(float2CharAVLTreeMap);
        }
    }
    ...
    extends AbstractFloat2CharSortedMap.KeySet {
        ...
        private KeySet(Float2CharAVLTreeMap float2CharAVLTreeMap) {
            this.this$0 = float2CharAVLTreeMap;
            super(float2CharAVLTreeMap);
        }
        ...
        KeySet(Float2CharAVLTreeMap float2CharAVLTreeMap, 1 var2_2) {
            this(float2CharAVLTreeMap);
        }
    }
    ...
    implements FloatListIterator {
        ...
        public KeyIterator(Float2CharAVLTreeMap float2CharAVLTreeMap) {
            this.this$0 = float2CharAVLTreeMap;
            super(float2CharAVLTreeMap);
        }

        public KeyIterator(Float2CharAVLTreeMap float2CharAVLTreeMap, float f) {
            this.this$0 = float2CharAVLTreeMap;
            super(float2CharAVLTreeMap, f);
        }
    ...
    implements ObjectListIterator<Float2CharMap.Entry> {
        ...
        EntryIterator(Float2CharAVLTreeMap float2CharAVLTreeMap) {
            this.this$0 = float2CharAVLTreeMap;
            super(float2CharAVLTreeMap);
        }

        EntryIterator(Float2CharAVLTreeMap float2CharAVLTreeMap, float f) {
            this.this$0 = float2CharAVLTreeMap;
            super(float2CharAVLTreeMap, f);
        }
        ...
        public void add(Object object) {
            this.add((Float2CharMap.Entry)object);
        }

        @Override
        public void set(Object object) {
            this.set((Float2CharMap.Entry)object);
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(Float2CharAVLTreeMap float2CharAVLTreeMap) {
            this.this$0 = float2CharAVLTreeMap;
            this.index = 0;
            this.next = float2CharAVLTreeMap.firstEntry;
        }

        TreeIterator(Float2CharAVLTreeMap float2CharAVLTreeMap, float f) {
            this.this$0 = float2CharAVLTreeMap;
            this.index = 0;
            this.next = float2CharAVLTreeMap.locateKey(f);
            if (this.next != null) {
                if (float2CharAVLTreeMap.compare(this.next.key, f) <= 0) {
                    this.prev = this.next;
                    this.next = this.next.next();
                } else {
                    this.prev = this.next.prev();
    ...
    implements Cloneable {
        ...
        public boolean equals(Object object) {
            ...
            Map.Entry entry = (Map.Entry)object;
            return Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)entry.getKey()).floatValue()) && this.value == ((Character)entry.getValue()).charValue();
        }
