...
class SetsKt__SetsJVMKt {
    ...
    @NotNull
    public static final <T> TreeSet<T> sortedSetOf(@NotNull T ... TArray) {
        Intrinsics.checkNotNullParameter(TArray, "elements");
        return (TreeSet)ArraysKt.toCollection(TArray, (Collection)new TreeSet());
    }

    @NotNull
    public static final <T> TreeSet<T> sortedSetOf(@NotNull Comparator<? super T> comparator, @NotNull T ... TArray) {
