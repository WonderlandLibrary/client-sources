...
extends MapsKt__MapsJVMKt {
    ...
    @NotNull
    public static final <K, V> Map<K, V> mapOf(@NotNull Pair<? extends K, ? extends V> ... pairArray) {
        Intrinsics.checkNotNullParameter(pairArray, "pairs");
        return pairArray.length > 0 ? MapsKt.toMap(pairArray, (Map)new LinkedHashMap(MapsKt.mapCapacity(pairArray.length))) : MapsKt.emptyMap();
    }
    ...
    @NotNull
    public static final <K, V> Map<K, V> mutableMapOf(@NotNull Pair<? extends K, ? extends V> ... pairArray) {
        LinkedHashMap linkedHashMap;
        Intrinsics.checkNotNullParameter(pairArray, "pairs");
        LinkedHashMap linkedHashMap2 = linkedHashMap = new LinkedHashMap(MapsKt.mapCapacity(pairArray.length));
        boolean bl = false;
        MapsKt.putAll((Map)linkedHashMap2, pairArray);
    ...
    @NotNull
    public static final <K, V> HashMap<K, V> hashMapOf(@NotNull Pair<? extends K, ? extends V> ... pairArray) {
        HashMap hashMap;
        Intrinsics.checkNotNullParameter(pairArray, "pairs");
        HashMap hashMap2 = hashMap = new HashMap(MapsKt.mapCapacity(pairArray.length));
        boolean bl = false;
        MapsKt.putAll((Map)hashMap2, pairArray);
        return hashMap;
    }
    ...
    @NotNull
    public static final <K, V> LinkedHashMap<K, V> linkedMapOf(@NotNull Pair<? extends K, ? extends V> ... pairArray) {
        Intrinsics.checkNotNullParameter(pairArray, "pairs");
    ...
    @WasExperimental(markerClass={ExperimentalStdlibApi.class})
    @InlineOnly
    private static final <K, V> Map<K, V> buildMap(int n, @BuilderInference Function1<? super Map<K, V>, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "builderAction");
    ...
    private static final <M extends Map<?, ?> & R, R> R ifEmpty(M m, Function0<? extends R> function0) {
        ...
        return (R)(m.isEmpty() ? function0.invoke() : m);
    }
    ...
    public static final <K, V, R, M extends Map<? super K, ? super R>> M mapValuesTo(@NotNull Map<? extends K, ? extends V> map, @NotNull M m, @NotNull Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> function1) {
        ...
        for (Object t : iterable) {
            ...
            M m2 = m;
            boolean bl3 = false;
            m2.put(entry.getKey(), function1.invoke((Map.Entry<K, V>)t));
        }
        return m;
    }
    ...
    public static final <K, V, R, M extends Map<? super R, ? super V>> M mapKeysTo(@NotNull Map<? extends K, ? extends V> map, @NotNull M m, @NotNull Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> function1) {
        ...
        for (Object t : iterable) {
            Map.Entry entry = (Map.Entry)t;
            R r = function1.invoke((Map.Entry<K, V>)t);
            M m2 = m;
            boolean bl3 = false;
    ...
    public static final <K, V> void putAll(@NotNull Map<? super K, ? super V> map, @NotNull Pair<? extends K, ? extends V>[] pairArray) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(pairArray, "pairs");
    ...
    public static final <K, V, R> Map<K, R> mapValues(@NotNull Map<? extends K, ? extends V> map, @NotNull Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> function1) {
        ...
        for (Object t : iterable) {
            ...
            Map map4 = map3;
            boolean bl4 = false;
            map4.put(entry.getKey(), function1.invoke((Map.Entry<K, V>)t));
        }
        return map3;
    }
    ...
    public static final <K, V, M extends Map<? super K, ? super V>> M toMap(@NotNull Iterable<? extends Pair<? extends K, ? extends V>> iterable, @NotNull M m) {
        ...
        M m3 = m2 = m;
        boolean bl = false;
        MapsKt.putAll(m3, iterable);
        return m2;
    }

    @NotNull
    public static final <K, V> Map<K, V> toMap(@NotNull Pair<? extends K, ? extends V>[] pairArray) {
        Map<Object, Object> map;
        Intrinsics.checkNotNullParameter(pairArray, "<this>");
        switch (pairArray.length) {
            case 0: {
                map = MapsKt.emptyMap();
                break;
            }
            case 1: {
                map = MapsKt.mapOf(pairArray[0]);
                break;
            }
            default: {
                map = MapsKt.toMap(pairArray, (Map)new LinkedHashMap(MapsKt.mapCapacity(pairArray.length)));
            }
        }
        return map;
    }
    ...
    @NotNull
    public static final <K, V, M extends Map<? super K, ? super V>> M toMap(@NotNull Pair<? extends K, ? extends V>[] pairArray, @NotNull M m) {
        M m2;
        Intrinsics.checkNotNullParameter(pairArray, "<this>");
        Intrinsics.checkNotNullParameter(m, "destination");
        M m3 = m2 = m;
        boolean bl = false;
        MapsKt.putAll(m3, pairArray);
        return m2;
    }
    ...
    public static final <K, V> Map<K, V> plus(@NotNull Map<? extends K, ? extends V> map, @NotNull Pair<? extends K, ? extends V> pair) {
        ...
        if (map.isEmpty()) {
            ...
            LinkedHashMap<K, V> linkedHashMap2 = linkedHashMap = new LinkedHashMap<K, V>(map);
            boolean bl = false;
    ...
    public static final <K, V> Map<K, V> plus(@NotNull Map<? extends K, ? extends V> map, @NotNull Iterable<? extends Pair<? extends K, ? extends V>> iterable) {
        ...
        if (map.isEmpty()) {
            ...
            LinkedHashMap<? extends K, ? extends V> linkedHashMap2 = linkedHashMap = new LinkedHashMap<K, V>(map);
            boolean bl = false;
    ...
    @NotNull
    public static final <K, V> Map<K, V> plus(@NotNull Map<? extends K, ? extends V> map, @NotNull Pair<? extends K, ? extends V>[] pairArray) {
        Map map2;
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(pairArray, "pairs");
        if (map.isEmpty()) {
            map2 = MapsKt.toMap(pairArray);
        } else {
            LinkedHashMap<? extends K, ? extends V> linkedHashMap;
            LinkedHashMap<? extends K, ? extends V> linkedHashMap2 = linkedHashMap = new LinkedHashMap<K, V>(map);
            boolean bl = false;
    ...
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> map, K k) {
        Map<K, V> map2;
        Intrinsics.checkNotNullParameter(map, "<this>");
        Map<K, V> map3 = map2 = MapsKt.toMutableMap(map);
        boolean bl = false;
        map3.remove(k);
    ...
    @SinceKotlin(version="1.1")
    @NotNull
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> map, @NotNull K[] KArray) {
        Map<K, V> map2;
        Intrinsics.checkNotNullParameter(map, "<this>");
