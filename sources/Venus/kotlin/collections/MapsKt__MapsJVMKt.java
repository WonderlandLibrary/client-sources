...
extends MapsKt__MapWithDefaultKt {
    ...
    public static final <K, V> V getOrPut(@NotNull ConcurrentMap<K, V> concurrentMap, K k, @NotNull Function0<? extends V> function0) {
        ...
        if (v == null) {
            V v2;
            V v3 = v2 = function0.invoke();
            boolean bl2 = false;
            v = concurrentMap.putIfAbsent(k, v3);
            if (v == null) {
                v = v3;
            }
        }
    ...
    public static final <K, V> SortedMap<K, V> toSortedMap(@NotNull Map<? extends K, ? extends V> map, @NotNull Comparator<? super K> comparator) {
        ...
        TreeMap<? extends K, ? extends V> treeMap2 = treeMap = new TreeMap<K, V>(comparator);
        boolean bl = false;
        treeMap2.putAll(map);
        return treeMap;
    }
    ...
    @NotNull
    public static final <K extends Comparable<? super K>, V> SortedMap<K, V> sortedMapOf(@NotNull Pair<? extends K, ? extends V> ... pairArray) {
        TreeMap treeMap;
        Intrinsics.checkNotNullParameter(pairArray, "pairs");
        TreeMap treeMap2 = treeMap = new TreeMap();
        boolean bl = false;
        MapsKt.putAll((Map)treeMap2, pairArray);
        return treeMap;
    }

    @SinceKotlin(version="1.4")
    @NotNull
    public static final <K, V> SortedMap<K, V> sortedMapOf(@NotNull Comparator<? super K> comparator, @NotNull Pair<? extends K, ? extends V> ... pairArray) {
        TreeMap treeMap;
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        Intrinsics.checkNotNullParameter(pairArray, "pairs");
        TreeMap treeMap2 = treeMap = new TreeMap(comparator);
        boolean bl = false;
        MapsKt.putAll((Map)treeMap2, pairArray);
        return treeMap;
    }
    ...
    public static final <K, V> Map<K, V> toSingletonMap(@NotNull Map<? extends K, ? extends V> map) {
        Map.Entry<K, V> entry;
        Intrinsics.checkNotNullParameter(map, "<this>");
        Map.Entry<K, V> entry2 = entry = map.entrySet().iterator().next();
        boolean bl = false;
