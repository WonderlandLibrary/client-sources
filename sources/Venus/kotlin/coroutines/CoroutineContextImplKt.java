...
public final class CoroutineContextImplKt {
    ...
    public static final <E extends CoroutineContext.Element> E getPolymorphicElement(@NotNull CoroutineContext.Element element, @NotNull CoroutineContext.Key<E> key) {
        ...
        if (key instanceof AbstractCoroutineContextKey) {
            Object e;
            return ((AbstractCoroutineContextKey)key).isSubKey$kotlin_stdlib(element.getKey()) ? ((e = ((AbstractCoroutineContextKey)key).tryCast$kotlin_stdlib(element)) instanceof CoroutineContext.Element ? e : null) : null;
        }
