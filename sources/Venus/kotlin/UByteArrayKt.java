...
public final class UByteArrayKt {
    ...
    private static final byte[] UByteArray(int n, Function1<? super Integer, UByte> function1) {
        ...
        while (n2 < n) {
            int n3 = n2++;
            byArray[n3] = function1.invoke((Integer)n3).unbox-impl();
        }
    ...
    @ExperimentalUnsignedTypes
    @InlineOnly
    private static final byte[] ubyteArrayOf-GBYM_sE(byte ... byArray) {
        Intrinsics.checkNotNullParameter(byArray, "elements");
        return byArray;
    }
}
