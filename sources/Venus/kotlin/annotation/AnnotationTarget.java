...
extends Enum<AnnotationTarget> {
    ...
    private static final AnnotationTarget[] $VALUES = AnnotationTarget.$values();
    ...
    private static final AnnotationTarget[] $values() {
        AnnotationTarget[] annotationTargetArray = new AnnotationTarget[]{CLASS, ANNOTATION_CLASS, TYPE_PARAMETER, PROPERTY, FIELD, LOCAL_VARIABLE, VALUE_PARAMETER, CONSTRUCTOR, FUNCTION, PROPERTY_GETTER, PROPERTY_SETTER, TYPE, EXPRESSION, FILE, TYPEALIAS};
