...
extends Enum<CharDirectionality> {
    ...
    private static final CharDirectionality[] $values() {
        CharDirectionality[] charDirectionalityArray = new CharDirectionality[]{UNDEFINED, LEFT_TO_RIGHT, RIGHT_TO_LEFT, RIGHT_TO_LEFT_ARABIC, EUROPEAN_NUMBER, EUROPEAN_NUMBER_SEPARATOR, EUROPEAN_NUMBER_TERMINATOR, ARABIC_NUMBER, COMMON_NUMBER_SEPARATOR, NONSPACING_MARK, BOUNDARY_NEUTRAL, PARAGRAPH_SEPARATOR, SEGMENT_SEPARATOR, WHITESPACE, OTHER_NEUTRALS, LEFT_TO_RIGHT_EMBEDDING, LEFT_TO_RIGHT_OVERRIDE, RIGHT_TO_LEFT_EMBEDDING, RIGHT_TO_LEFT_OVERRIDE, POP_DIRECTIONAL_FORMAT};
    ...
    public static final class Companion {
        ...
        private final Map<Integer, CharDirectionality> getDirectionalityMap() {
            Lazy lazy = CharDirectionality.access$getDirectionalityMap$delegate$cp();
            return (Map)lazy.getValue();
        }

        @NotNull
        public final CharDirectionality valueOf(int n) {
            CharDirectionality charDirectionality = this.getDirectionalityMap().get(n);
            if (charDirectionality == null) {
                throw new IllegalArgumentException("Directionality #" + n + " is not defined.");
            }
