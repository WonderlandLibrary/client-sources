...
KMappedMarker {
    ...
    @NotNull
    public static java.util.Iterator<ULong> iterator-impl(long[] lArray) {
    ...
    public static boolean containsAll-impl(long[] lArray, @NotNull Collection<ULong> collection) {
        boolean bl;
        block3: {
            ...
            if (((Collection)iterable).isEmpty()) {
                ...
                while (iterator2.hasNext()) {
                    ...
                    boolean bl3 = false;
                    if (t2 instanceof ULong && ArraysKt.contains(lArray, ((ULong)t2).unbox-impl())) continue;
                    bl = false;
                    break block3;
                }
                bl = true;
    ...
    public static boolean equals-impl(long[] lArray, Object object) {
        if (!(object instanceof ULongArray)) {
            return true;
        }
        return !Intrinsics.areEqual(lArray, ((ULongArray)object).unbox-impl());
    }
    ...
    @PublishedApi
    private ULongArray(long[] lArray) {
        this.storage = lArray;
    }

    @PublishedApi
    @NotNull
    public static long[] constructor-impl(@NotNull long[] lArray) {
        Intrinsics.checkNotNullParameter(lArray, "storage");
        return lArray;
    }

    public static final ULongArray box-impl(long[] lArray) {
    ...
    KMappedMarker {
        ...
        public Iterator(@NotNull long[] lArray) {
