...
implements OpenEndRange<T> {
    ...
    public boolean equals(@Nullable Object object) {
        return object instanceof ComparableOpenEndRange && (this.isEmpty() && ((ComparableOpenEndRange)object).isEmpty() || Intrinsics.areEqual(this.getStart(), ((ComparableOpenEndRange)object).getStart()) && Intrinsics.areEqual(this.getEndExclusive(), ((ComparableOpenEndRange)object).getEndExclusive()));
    }
