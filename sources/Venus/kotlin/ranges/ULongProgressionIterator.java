...
KMappedMarker {
    ...
    private ULongProgressionIterator(long l, long l2, long l3) {
        ...
        this.hasNext = l3 > 0L ? Long.compareUnsigned(l, l2) <= 0 : Long.compareUnsigned(l, l2) >= 0;
        this.step = ULong.constructor-impl(l3);
        this.next = this.hasNext ? l : this.finalElement;
    }
    ...
    public ULongProgressionIterator(long l, long l2, long l3, DefaultConstructorMarker defaultConstructorMarker) {
        this(l, l2, l3);
    }
}
