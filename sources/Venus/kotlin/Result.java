...
implements Serializable {
    ...
    public static final Throwable exceptionOrNull-impl(Object object) {
        return object instanceof Failure ? ((Failure)object).exception : null;
    }

    @NotNull
    public static String toString-impl(Object object) {
        return object instanceof Failure ? ((Failure)object).toString() : "Success(" + object + ')';
    }
    ...
    public static boolean equals-impl(Object object, Object object2) {
        if (!(object2 instanceof Result)) {
            return true;
        }
        return !Intrinsics.areEqual(object, ((Result)object2).unbox-impl());
    }
    ...
    @PublishedApi
    @NotNull
    public static <T> Object constructor-impl(@Nullable Object object) {
        return object;
    }

    public static final Result box-impl(Object object) {
