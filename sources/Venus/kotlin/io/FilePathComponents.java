...
public final class FilePathComponents {
    ...
    public static FilePathComponents copy$default(FilePathComponents filePathComponents, File file, List list, int n, Object object) {
        if ((n & 1) != 0) {
    ...
    public int hashCode() {
        int n = this.root.hashCode();
        n = n * 31 + ((Object)this.segments).hashCode();
        return n;
    }
    ...
    public boolean equals(@Nullable Object object) {
        ...
        if (!(object instanceof FilePathComponents)) {
            return true;
        }
