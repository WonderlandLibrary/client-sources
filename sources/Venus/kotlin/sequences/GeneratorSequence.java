...
implements Sequence<T> {
    ...
    public static final Function0 access$getGetInitialValue$p(GeneratorSequence generatorSequence) {
        return generatorSequence.getInitialValue;
    }

    public static final Function1 access$getGetNextValue$p(GeneratorSequence generatorSequence) {
