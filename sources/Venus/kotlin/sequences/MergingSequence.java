...
implements Sequence<V> {
    ...
    public static final Sequence access$getSequence1$p(MergingSequence mergingSequence) {
        return mergingSequence.sequence1;
    }

    public static final Sequence access$getSequence2$p(MergingSequence mergingSequence) {
        return mergingSequence.sequence2;
    }

    public static final Function2 access$getTransform$p(MergingSequence mergingSequence) {
