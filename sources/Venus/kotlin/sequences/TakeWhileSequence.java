...
implements Sequence<T> {
    ...
    public static final Sequence access$getSequence$p(TakeWhileSequence takeWhileSequence) {
        return takeWhileSequence.sequence;
    }

    public static final Function1 access$getPredicate$p(TakeWhileSequence takeWhileSequence) {
