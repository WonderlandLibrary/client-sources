...
DropTakeSequence<T> {
    ...
    public SubSequence(@NotNull Sequence<? extends T> sequence, int n, int n2) {
        boolean bl;
        ...
        boolean bl4 = bl = this.endIndex >= 0;
        if (!bl) {
            boolean bl5 = false;
            String string = "endIndex should be non-negative, but is " + this.endIndex;
            throw new IllegalArgumentException(string.toString());
        }
        boolean bl6 = bl = this.endIndex >= this.startIndex;
        if (!bl) {
            boolean bl7 = false;
    ...
    public static final Sequence access$getSequence$p(SubSequence subSequence) {
        return subSequence.sequence;
    }

    public static final int access$getStartIndex$p(SubSequence subSequence) {
        return subSequence.startIndex;
    }

    public static final int access$getEndIndex$p(SubSequence subSequence) {
