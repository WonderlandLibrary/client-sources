...
import mpp.venusfr.utils.animations.impl.EaseInOutQuad;
    ...
    private class Notification {
        ...
        public float draw(MatrixStack matrixStack) {
            ...
            if (this.imageType == ImageType.FIRST_PHOTO) {
                var3_3 = new ResourceLocation("venusfr/images/hud/notify.png");
                DisplayUtils.drawImage(var3_3, this.x - 424.0f + 50.0f, this.y - 26.5f, 16.0f, 16.0f, ColorUtils.rgb(255, 0, 0));
            } else {
                var3_3 = new ResourceLocation("venusfr/images/hud/notify2.png");
                DisplayUtils.drawImage(var3_3, this.x - 424.0f + 50.0f, this.y - 26.5f, 16.0f, 16.0f, ColorUtils.rgb(0, 255, 0));
            }
