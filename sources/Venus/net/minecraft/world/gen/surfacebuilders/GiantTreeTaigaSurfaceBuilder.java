...
extends SurfaceBuilder<SurfaceBuilderConfig> {
    public GiantTreeTaigaSurfaceBuilder(Codec<SurfaceBuilderConfig> codec) {
        super(codec);
    }
    ...
    public void buildSurface(Random random2, IChunk iChunk, Biome biome, int n, int n2, int n3, double d, BlockState blockState, BlockState blockState2, int n4, long l, SurfaceBuilderConfig surfaceBuilderConfig) {
        if (d > 1.75) {
            SurfaceBuilder.DEFAULT.buildSurface(random2, iChunk, biome, n, n2, n3, d, blockState, blockState2, n4, l, SurfaceBuilder.CORASE_DIRT_DIRT_GRAVEL_CONFIG);
        } else if (d > -0.95) {
            SurfaceBuilder.DEFAULT.buildSurface(random2, iChunk, biome, n, n2, n3, d, blockState, blockState2, n4, l, SurfaceBuilder.PODZOL_DIRT_GRAVEL_CONFIG);
        } else {
