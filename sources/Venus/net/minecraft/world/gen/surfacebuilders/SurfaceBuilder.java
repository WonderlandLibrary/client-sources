...
public abstract class SurfaceBuilder<C extends ISurfaceBuilderConfig> {
    ...
    private static <C extends ISurfaceBuilderConfig, F extends SurfaceBuilder<C>> F register(String string, F f) {
        return (F)Registry.register(Registry.SURFACE_BUILDER, string, f);
    }

    public SurfaceBuilder(Codec<C> codec) {
        this.field_237188_a_ = ((MapCodec)codec.fieldOf("config")).xmap(this::func_242929_a, ConfiguredSurfaceBuilder::getConfig).codec();
    }
    ...
    public ConfiguredSurfaceBuilder<C> func_242929_a(C c) {
        return new ConfiguredSurfaceBuilder<C>(this, c);
    }
