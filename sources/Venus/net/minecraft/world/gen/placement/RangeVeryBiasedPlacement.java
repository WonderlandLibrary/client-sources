...
extends SimplePlacement<TopSolidRangeConfig> {
    ...
    public Stream<BlockPos> getPositions(Random random2, TopSolidRangeConfig topSolidRangeConfig, BlockPos blockPos) {
        ...
        int n3 = random2.nextInt(random2.nextInt(random2.nextInt(topSolidRangeConfig.field_242815_e - topSolidRangeConfig.field_242814_d) + topSolidRangeConfig.field_242813_c) + topSolidRangeConfig.field_242813_c);
