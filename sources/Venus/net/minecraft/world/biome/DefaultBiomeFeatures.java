...
public class DefaultBiomeFeatures {
    ...
    public static void withOceanMobs(MobSpawnInfo.Builder builder, int n, int n2, int n3) {
        builder.withSpawner(EntityClassification.WATER_CREATURE, new MobSpawnInfo.Spawners(EntityType.SQUID, n, 1, n2));
        builder.withSpawner(EntityClassification.WATER_AMBIENT, new MobSpawnInfo.Spawners(EntityType.COD, n3, 3, 6));
    ...
    public static void withWarmOceanMobs(MobSpawnInfo.Builder builder, int n, int n2) {
        builder.withSpawner(EntityClassification.WATER_CREATURE, new MobSpawnInfo.Spawners(EntityType.SQUID, n, n2, 4));
    ...
    public static void withHostileMobs(MobSpawnInfo.Builder builder, int n, int n2, int n3) {
        builder.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.SPIDER, 100, 4, 4));
        builder.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ZOMBIE, n, 4, 4));
        builder.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ZOMBIE_VILLAGER, n2, 1, 1));
        builder.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.SKELETON, n3, 4, 4));
