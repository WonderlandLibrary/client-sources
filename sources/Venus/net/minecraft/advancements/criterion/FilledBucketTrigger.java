...
extends AbstractCriterionTrigger<Instance> {
    ...
    public void trigger(ServerPlayerEntity serverPlayerEntity, ItemStack itemStack) {
        this.triggerListeners(serverPlayerEntity, arg_0 -> FilledBucketTrigger.lambda$trigger$0(itemStack, arg_0));
    }
    ...
    extends CriterionInstance {
        ...
        public static Instance forItem(ItemPredicate itemPredicate) {
            return new Instance(EntityPredicate.AndPredicate.ANY_AND, itemPredicate);
        }
