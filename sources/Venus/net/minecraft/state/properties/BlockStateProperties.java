...
public class BlockStateProperties {
    ...
    public static final DirectionProperty FACING_EXCEPT_UP = DirectionProperty.create("facing", BlockStateProperties::lambda$static$0);
    ...
    public static final EnumProperty<RailShape> RAIL_SHAPE_STRAIGHT = EnumProperty.create("shape", RailShape.class, BlockStateProperties::lambda$static$1);
    ...
    private static boolean lambda$static$1(RailShape railShape) {
    ...
    private static boolean lambda$static$0(Direction direction) {
