...
public class ItemModelProvider {
    ...
    private void func_240077_a_(Item item, String string, ModelsUtil modelsUtil) {
        modelsUtil.func_240234_a_(ModelsResourceUtil.func_240220_a_(item, string), ModelTextures.func_240376_j_(ModelTextures.func_240344_a_(item, string)), this.field_240073_a_);
    }
    ...
    public void func_240074_a_() {
        ...
        for (n = 1; n < 64; ++n) {
            this.func_240077_a_(Items.CLOCK, String.format("_%02d", n), StockModelShapes.GENERATED);
        }
        ...
        for (n = 0; n < 32; ++n) {
            if (n == 16) continue;
            this.func_240077_a_(Items.COMPASS, String.format("_%02d", n), StockModelShapes.GENERATED);
        }
