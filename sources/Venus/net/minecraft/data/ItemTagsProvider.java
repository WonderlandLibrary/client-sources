...
extends TagsProvider<Item> {
    private final Function<ITag.INamedTag<Block>, ITag.Builder> blockTagResolver = blockTagsProvider::createBuilderIfAbsent;
    ...
    protected void copy(ITag.INamedTag<Block> iNamedTag, ITag.INamedTag<Item> iNamedTag2) {
        ITag.Builder builder = this.createBuilderIfAbsent(iNamedTag2);
        ITag.Builder builder2 = this.blockTagResolver.apply(iNamedTag);
        builder2.getProxyStream().forEach(builder::addProxyTag);
    }
