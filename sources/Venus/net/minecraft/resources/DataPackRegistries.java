...
implements AutoCloseable {
    ...
    public DataPackRegistries(Commands.EnvironmentType environmentType, int n) {
        this.commands = new Commands(environmentType);
        this.functionReloader = new FunctionReloader(n, this.commands.getDispatcher());
    ...
    public static CompletableFuture<DataPackRegistries> func_240961_a_(List<IResourcePack> list, Commands.EnvironmentType environmentType, int n, Executor executor, Executor executor2) {
        DataPackRegistries dataPackRegistries = new DataPackRegistries(environmentType, n);
        CompletableFuture<Unit> completableFuture = dataPackRegistries.resourceManager.reloadResourcesAndThen(executor, executor2, list, field_240951_a_);
        return ((CompletableFuture)completableFuture.whenComplete((arg_0, arg_1) -> DataPackRegistries.lambda$func_240961_a_$0(dataPackRegistries, arg_0, arg_1))).thenApply(arg_0 -> DataPackRegistries.lambda$func_240961_a_$1(dataPackRegistries, arg_0));
    }
    ...
    private static DataPackRegistries lambda$func_240961_a_$1(DataPackRegistries dataPackRegistries, Unit unit) {
        return dataPackRegistries;
    }

    private static void lambda$func_240961_a_$0(DataPackRegistries dataPackRegistries, Unit unit, Throwable throwable) {
        if (throwable != null) {
