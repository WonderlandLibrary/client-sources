...
extends LongRunningTask {
    ...
    public ResetWorldRealmsAction(@Nullable String string, @Nullable WorldTemplate worldTemplate, int n, boolean bl, long l, @Nullable ITextComponent iTextComponent, Runnable runnable) {
        this.field_238132_c_ = string;
        this.field_238133_d_ = worldTemplate;
        this.field_238134_e_ = n;
        this.field_238135_f_ = bl;
        this.field_238136_g_ = l;
