...
extends DataFix {
    private static final Map<String, String> OLD_TO_NEW_ID_MAP = DataFixUtils.make(Maps.newHashMap(), EntityId::lambda$static$0);

    public EntityId(Schema schema, boolean bl) {
        super(schema, bl);
    }
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq(this.convertUnchecked("item stack entity name hook converter", type, type2), this.fixTypeEverywhere("EntityIdFix", taggedChoiceType, taggedChoiceType2, EntityId::lambda$makeRule$3));
    }

    private static Function lambda$makeRule$3(DynamicOps dynamicOps) {
        return EntityId::lambda$makeRule$2;
    }

    private static Pair lambda$makeRule$2(Pair pair) {
        return pair.mapFirst(EntityId::lambda$makeRule$1);
    }
