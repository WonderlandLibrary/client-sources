...
public class RecipeRenamer1502
extends RecipeRenamer {
    ...
    public RecipeRenamer1502(Schema schema, boolean bl) {
        super(schema, bl, "Recipes fix", RecipeRenamer1502::lambda$new$0);
    }

    private static String lambda$new$0(String string) {
        return field_209673_a.getOrDefault(string, string);
    }
}
