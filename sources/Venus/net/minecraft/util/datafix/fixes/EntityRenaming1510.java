...
extends TypedEntityRenameHelper {
    ...
    public EntityRenaming1510(Schema schema, boolean bl) {
        super("EntityTheRenameningBlock", schema, bl);
    }

    @Override
    protected String rename(String object) {
        if (((String)object).startsWith("minecraft:bred_")) {
            object = "minecraft:" + ((String)object).substring(15);
        }
        return ENTITY_RENAME_MAP.getOrDefault(object, (String)object);
    }
}
