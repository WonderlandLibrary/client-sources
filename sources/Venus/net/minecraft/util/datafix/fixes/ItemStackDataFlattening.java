...
extends DataFix {
    private static final Map<String, String> field_199176_a = DataFixUtils.make(Maps.newHashMap(), ItemStackDataFlattening::lambda$static$0);
    private static final Set<String> field_199177_b = field_199176_a.keySet().stream().map(ItemStackDataFlattening::lambda$static$1).collect(Collectors.toSet());
    ...
    public ItemStackDataFlattening(Schema schema, boolean bl) {
        super(schema, bl);
    }
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", type, arg_0 -> ItemStackDataFlattening.lambda$makeRule$2(opticFinder, opticFinder2, arg_0));
    }

    @Nullable
    public static String updateItem(@Nullable String string, int n) {
        if (field_199177_b.contains(string)) {
            String string2 = field_199176_a.get(string + "." + n);
            return string2 == null ? field_199176_a.get(string + ".0") : string2;
        }
        return null;
    }
    ...
    private static Typed lambda$makeRule$2(OpticFinder opticFinder, OpticFinder opticFinder2, Typed typed) {
        ...
        String string = ItemStackDataFlattening.updateItem((String)((Pair)optional.get()).getSecond(), n);
        if (string != null) {
