...
extends TestRuntimeException {
    ...
    public String getMessage() {
        String string = this.field_229455_a_.getX() + "," + this.field_229455_a_.getY() + "," + this.field_229455_a_.getZ() + " (relative: " + this.field_229456_b_.getX() + "," + this.field_229456_b_.getY() + "," + this.field_229456_b_.getZ() + ")";
        return super.getMessage() + " at " + string + " (t=" + this.field_229457_c_ + ")";
    }
