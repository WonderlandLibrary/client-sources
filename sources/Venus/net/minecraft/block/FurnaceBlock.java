...
extends AbstractFurnaceBlock {
    protected FurnaceBlock(AbstractBlock.Properties properties) {
        super(properties);
    }
    ...
    public void animateTick(BlockState blockState, World world, BlockPos blockPos, Random random2) {
        if (blockState.get(LIT).booleanValue()) {
            ...
            if (random2.nextDouble() < 0.1) {
                world.playSound(d, d2, d3, SoundEvents.BLOCK_FURNACE_FIRE_CRACKLE, SoundCategory.BLOCKS, 1.0f, 1.0f, true);
            }
            ...
            double d7 = random2.nextDouble() * 6.0 / 16.0;
            ...
            world.addParticle(ParticleTypes.FLAME, d + d6, d2 + d7, d3 + d8, 0.0, 0.0, 0.0);
        }
    }
}
