...
extends SpriteTexturedParticle {
    private HeartParticle(ClientWorld clientWorld, double d, double d2, double d3) {
    ...
    implements IParticleFactory<BasicParticleType> {
        ...
        public Particle makeParticle(BasicParticleType basicParticleType, ClientWorld clientWorld, double d, double d2, double d3, double d4, double d5, double d6) {
            HeartParticle heartParticle = new HeartParticle(clientWorld, d, d2, d3);
    ...
    implements IParticleFactory<BasicParticleType> {
        ...
        public AngryVillagerFactory(IAnimatedSprite iAnimatedSprite) {
            this.spriteSet = iAnimatedSprite;
        }

        @Override
        public Particle makeParticle(BasicParticleType basicParticleType, ClientWorld clientWorld, double d, double d2, double d3, double d4, double d5, double d6) {
            HeartParticle heartParticle = new HeartParticle(clientWorld, d, d2 + 0.5, d3);
            heartParticle.selectSpriteRandomly(this.spriteSet);
