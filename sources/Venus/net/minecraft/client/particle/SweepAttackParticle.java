...
extends SpriteTexturedParticle {
    ...
    private SweepAttackParticle(ClientWorld clientWorld, double d, double d2, double d3, double d4, IAnimatedSprite iAnimatedSprite) {
        ...
        this.particleBlue = f;
        this.particleScale = 1.0f - (float)d4 * 0.5f;
    ...
    implements IParticleFactory<BasicParticleType> {
        ...
        public Particle makeParticle(BasicParticleType basicParticleType, ClientWorld clientWorld, double d, double d2, double d3, double d4, double d5, double d6) {
            return new SweepAttackParticle(clientWorld, d, d2, d3, d4, this.spriteSet);
        }
