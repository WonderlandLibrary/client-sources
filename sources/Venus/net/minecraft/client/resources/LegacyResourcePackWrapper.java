...
implements IResourcePack {
    ...
    public static final Map<ResourceLocation, ResourceLocation> NEW_TO_LEGACY_MAP = Util.make(LegacyResourcePackWrapper::lambda$static$1);

    private static ResourceLocation getMetaFileLocation(ResourceLocation resourceLocation) {
        return new ResourceLocation(resourceLocation.getNamespace(), resourceLocation.getPath() + ".mcmeta");
    }

    public LegacyResourcePackWrapper(IResourcePack iResourcePack, Map<ResourceLocation, ResourceLocation> map) {
        this.locationMap = iResourcePack;
        this.field_211855_c = map;
    }

    private ResourceLocation toLegacyLocation(ResourceLocation resourceLocation) {
        return this.field_211855_c.getOrDefault(resourceLocation, resourceLocation);
    }

    @Override
    public InputStream getRootResourceStream(String string) throws IOException {
        return this.locationMap.getRootResourceStream(string);
    }
    ...
    public InputStream getResourceStream(ResourcePackType resourcePackType, ResourceLocation resourceLocation) throws IOException {
        return this.locationMap.getResourceStream(resourcePackType, this.toLegacyLocation(resourceLocation));
    }
    ...
    public boolean resourceExists(ResourcePackType resourcePackType, ResourceLocation resourceLocation) {
        return this.locationMap.resourceExists(resourcePackType, this.toLegacyLocation(resourceLocation));
    }

    @Override
    public Set<String> getResourceNamespaces(ResourcePackType resourcePackType) {
        return this.locationMap.getResourceNamespaces(resourcePackType);
    }

    @Override
    @Nullable
    public <T> T getMetadata(IMetadataSectionSerializer<T> iMetadataSectionSerializer) throws IOException {
        return this.locationMap.getMetadata(iMetadataSectionSerializer);
    }
    ...
    private static ImmutableMap lambda$static$1() {
        ImmutableMap.Builder builder = ImmutableMap.builder();
        BiConsumer<String, String> biConsumer = (arg_0, arg_1) -> LegacyResourcePackWrapper.lambda$static$0(builder, arg_0, arg_1);
    ...
    private static void lambda$static$0(ImmutableMap.Builder builder, String string, String string2) {
        ...
        builder.put(LegacyResourcePackWrapper.getMetaFileLocation(resourceLocation), LegacyResourcePackWrapper.getMetaFileLocation(resourceLocation2));
    }
}
