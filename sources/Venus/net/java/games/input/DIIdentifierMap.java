...
final class DIIdentifierMap {
    ...
    public static final Component.Identifier.Key getKeyIdentifier(int n) {
        switch (n) {
            case 1: {
    ...
    public static final Component.Identifier.Button getButtonIdentifier(int n) {
        switch (n) {
            case 0: {
    ...
    public static final Component.Identifier.Button mapMouseButtonIdentifier(Component.Identifier.Button button) {
        if (button == Component.Identifier.Button._0) {
            return Component.Identifier.Button.LEFT;
        }
        if (button == Component.Identifier.Button._1) {
            return Component.Identifier.Button.RIGHT;
        }
        if (button == Component.Identifier.Button._2) {
