...
implements Usage {
    ...
    public static final ButtonUsage map(int n) {
        Integer n2 = new Integer(n);
        ButtonUsage buttonUsage = (ButtonUsage)map.get(n2);
        if (buttonUsage != null) {
            return buttonUsage;
        }
        ButtonUsage buttonUsage2 = new ButtonUsage(n);
        map.put(n2, buttonUsage2);
        return buttonUsage2;
    }

    private ButtonUsage(int n) {
        this.button_id = n;
    }
