...
final class AWTKeyMap {
    ...
    public static final Component.Identifier.Key mapKeyCode(int n) {
        switch (n) {
            case 48: {
    ...
    public static final Component.Identifier.Key map(KeyEvent keyEvent) {
