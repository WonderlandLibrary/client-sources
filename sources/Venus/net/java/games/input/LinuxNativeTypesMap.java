...
class LinuxNativeTypesMap {
    ...
    private static Logger log = Logger.getLogger((class$net$java$games$input$LinuxNativeTypesMap == null ? (class$net$java$games$input$LinuxNativeTypesMap = LinuxNativeTypesMap.class$("net.java.games.input.LinuxNativeTypesMap")) : class$net$java$games$input$LinuxNativeTypesMap).getName());
    ...
    public static final Controller.Type guessButtonTrait(int n) {
        switch (n) {
            case 288: 
            case 289: 
            case 290: 
    ...
    public static Controller.PortType getPortType(int n) {
        switch (n) {
            case 20: {
    ...
    public static Component.Identifier getRelAxisID(int n) {
        Component.Identifier identifier = null;
        try {
            identifier = LinuxNativeTypesMap.INSTANCE.relAxesIDs[n];
        } catch (ArrayIndexOutOfBoundsException arrayIndexOutOfBoundsException) {
            log.warning("INSTANCE.relAxesIDis only " + LinuxNativeTypesMap.INSTANCE.relAxesIDs.length + " long, so " + n + " not contained");
        }
        if (identifier == null) {
            identifier = Component.Identifier.Axis.SLIDER_VELOCITY;
        }
        return identifier;
    }

    public static Component.Identifier getAbsAxisID(int n) {
        Component.Identifier identifier = null;
        try {
            identifier = LinuxNativeTypesMap.INSTANCE.absAxesIDs[n];
        } catch (ArrayIndexOutOfBoundsException arrayIndexOutOfBoundsException) {
            log.warning("INSTANCE.absAxesIDs is only " + LinuxNativeTypesMap.INSTANCE.absAxesIDs.length + " long, so " + n + " not contained");
        }
        if (identifier == null) {
            identifier = Component.Identifier.Axis.SLIDER;
        }
        return identifier;
    }

    public static Component.Identifier getButtonID(int n) {
        Component.Identifier identifier = null;
        try {
            identifier = LinuxNativeTypesMap.INSTANCE.buttonIDs[n];
        } catch (ArrayIndexOutOfBoundsException arrayIndexOutOfBoundsException) {
            log.warning("INSTANCE.buttonIDs is only " + LinuxNativeTypesMap.INSTANCE.buttonIDs.length + " long, so " + n + " not contained");
        }
        if (identifier == null) {
            identifier = Component.Identifier.Key.UNKNOWN;
        }
        return identifier;
    }
