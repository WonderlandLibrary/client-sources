...
extends ShaderUniformBase {
    ...
    public ShaderUniform4f(String string) {
        super(string);
        this.resetValue();
    }
    ...
    public void setValue(float f, float f2, float f3, float f4) {
        ...
        if (fArray[0] != f || fArray[1] != f2 || fArray[2] != f3 || fArray[3] != f4) {
            ...
            if (n2 >= 0) {
                ...
                ARBShaderObjects.glUniform4fARB(n2, f, f2, f3, f4);
                this.checkGLError();
            }
        }
    }
    ...
    protected void onProgramSet(int n) {
        ...
        if (this.programValues[n] == null) {
            this.programValues[n] = new float[]{-3.4028235E38f, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f};
        }
    }
