...
public class CustomPanoramaProperties {
    ...
    public CustomPanoramaProperties(String string, Properties properties) {
        ...
        for (int i = 0; i < this.panoramaLocations.length; ++i) {
            this.panoramaLocations[i] = new ResourceLocation(string + "/panorama_" + i + ".png");
        }
        ...
        this.overlay1Bottom = ConnectedParser.parseColor4(properties.getProperty("overlay1.bottom"), 0xFFFFFF);
