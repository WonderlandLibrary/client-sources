...
public class PlayerControllerMP
{
    ...
    {
    	if (Meanings.CriticalsJ)
        {
            this.mc.thePlayer.motionY =  0.03999999910593033D;//0.10000000149011612D;
            this.mc.thePlayer.fallDistance = 0.1F;
            this.mc.thePlayer.onGround = false;
        }
    	
    	if(Meanings.Criticals){
    		 mc.thePlayer.connection.sendPacket(new CPacketPlayer.Position(mc.thePlayer.posX, mc.thePlayer.posY + 0.1625, mc.thePlayer.posZ, false));
             ...
             mc.thePlayer.connection.sendPacket(new CPacketPlayer.Position(mc.thePlayer.posX, mc.thePlayer.posY + 4.0E-6, mc.thePlayer.posZ, false));
             mc.thePlayer.connection.sendPacket(new CPacketPlayer.Position(mc.thePlayer.posX, mc.thePlayer.posY, mc.thePlayer.posZ, false));
             mc.thePlayer.connection.sendPacket(new CPacketPlayer.Position(mc.thePlayer.posX, mc.thePlayer.posY + 1.0E-6, mc.thePlayer.posZ, false));
             mc.thePlayer.connection.sendPacket(new CPacketPlayer.Position(mc.thePlayer.posX, mc.thePlayer.posY, mc.thePlayer.posZ, false));
