...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    if (Meanings.Regen)
	{
	    if (this.onGround)
	    {
	        Meanings.Regen3 = true;
	    }
	    else
	    {
	        Meanings.Regen3 = false;
	    }
	}
	else
	{
	...
	if (Meanings.Regen3 && this.shouldHeal())
	{
	...
	if (Meanings.Regen2 && this.shouldHeal2())
	{
    ...
    public void sendChatMessage(String message)
    {
        ...
        if (message.startsWith(".rccount"))
        {
            try
            {
                ex = message.split(" ");
                var58 = Float.parseFloat(ex[1]);
                mc.rightClickCount = var58;
                mc.thePlayer.addChatMessage(new TextComponentTranslation("\u00a74Кликов за одно нажатие установлено на \u00a7e" + var58, new Object[0]));
            }
            catch (Exception var53)
            {
                mc.thePlayer.addChatMessage(new TextComponentTranslation("\u00a74.rccount <count> -Установить количество кликов за одно нажатие.", new Object[0]));
            }
        }
        if (message.startsWith(".lccount"))
        {
            try
            {
                ex = message.split(" ");
                var59 = Float.parseFloat(ex[1]);
                mc.leftClickCount = var59;
                mc.thePlayer.addChatMessage(new TextComponentTranslation("\u00a74Кликов за одно нажатие установлено на \u00a7e" + var59, new Object[0]));
            }
            catch (Exception var53)
            {
                mc.thePlayer.addChatMessage(new TextComponentTranslation("\u00a74.lccount <count> -Установить количество кликов за одно нажатие.", new Object[0]));
            }
        }
        if (message.startsWith(".tp") || message.startsWith(".TP"))
        {
            ...
            {
                ex = message.split(" ");
                mc.inputNumber1 = Integer.parseInt(ex[1]);
                mc.inputNumber2 = Integer.parseInt(ex[2]);
                mc.var65 = Integer.parseInt(ex[3]);
                mc.thePlayer.addChatMessage(new TextComponentTranslation("\u00a7aTeleport: XYZ = " + mc.inputNumber1 + " / " + mc.inputNumber2 + " / " + mc.var65, new Object[0]));
            }
            catch (Exception var10)
            {
                mc.thePlayer.addChatMessage(new TextComponentTranslation("\u00a74Use .tp x y z. (x, y, z) - coordinates", new Object[0]));
            }
        }
        
    	//Yukon
    	if(Edictum.onSendChatMessage(message)){
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isHandActive() && !this.isRiding() && !Meanings.NoSlowDown)
        {
