...
import me.gishreload.yukon.gui.GuiIngameHook;
...
{
	public float rightClickCount = 0F;
	public float leftClickCount = 0F;
	public static float hitrange = 5F;
	public static double hs2 = 1D;
	public static double hs1 = 19D;
	public static float flightspeed = 0.1F;
	public double glidedamage = 0.5;
    ...
    /** Instance of IntegratedServer. */ IntegratedServer theIntegratedServer;
    ...
    private void startGame() throws LWJGLException, IOException
    {
      ...
      //Yukon
        ...
        else
       {
        ...
        Object localObject;
        localObject = new Account("Key");
        
        if (Meanings.AccountGui)
        {
    		((Account)localObject).setVisible(true);
    		((Account)localObject).setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    		((Account)localObject).setSize(300, 150);
    		((Account)localObject).setResizable(false);
    		((Account)localObject).setLocationRelativeTo(null);
        }
    ...
    private void runTickKeyboard() throws IOException
    {
        while (Keyboard.next())
        {
            ...
            if (flag)
            {
              ...
              //Yukon
                Edictum.onKeyPressed(i);
                Edictum.tabManager.keyPressed(i);
                
                if (Keyboard.getEventKey() == 62){
                	
                	Meanings.Gui = !Meanings.Gui;
                }
                
                if (Keyboard.getEventKey() == 62){
                	
                	Meanings.rammstein = false;
                }
