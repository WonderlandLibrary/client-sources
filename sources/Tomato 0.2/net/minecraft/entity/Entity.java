...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            boolean canStep = !Cheese.moduleManager.getModState("Phase");
            if (canStep)
            {
              StepEvent event = new StepEvent(this.stepHeight);
            ...
            if (this.stepHeight > 0.0F && var54 && (var13 != x || var17 != z))
            {
                ...
                if (var56 * var56 + var27 * var27 >= x * x + z * z)
                {
                    ...
                    final StepConfirmEvent eventConfirm = new StepConfirmEvent();
            ...
            Cheese.getInstance();
            this.onGround = Cheese.moduleManager.getModState("SkyWalker") && this == Minecraft.getMinecraft().thePlayer || this.isCollidedVertically && var15 < 0.0D;
