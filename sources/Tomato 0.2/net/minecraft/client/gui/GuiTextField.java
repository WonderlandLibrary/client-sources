   ...
   public void drawTextBox() {
      if(this.getVisible()) {
         ...
         if(var4.length() > 0) {
            ...
            var9 = this.fontRendererInstance.func_175063_a(var13, (float)var7, (float)var8, var1);
         }

         boolean var131 = this.cursorPosition < this.text.length() || this.text.length() >= this.getMaxStringLength();
         int var11 = var9;
         if(!var5) {
