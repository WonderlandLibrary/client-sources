...
public class GuiIngame extends Gui {
   ...
   protected void func_180479_a(ScaledResolution p_180479_1_, float p_180479_2_) {
      if(this.mc.func_175606_aa() instanceof EntityPlayer) {
         ...
         GlStateManager.disableBlend();
         if(!this.mc.gameSettings.showDebugInfo && Objects.nonNull(Wrapper.mc.thePlayer) && Objects.nonNull(Wrapper.mc.theWorld)) {
            GlStateManager.pushMatrix();
      ...
      if(this.mc.func_175606_aa() instanceof EntityPlayer) {
         ...
         if(var371 == null) {
            ...
            for(var23 = 0; var23 < 10; ++var23) {
               ...
               this.drawTexturedModalRect(var27, var38, 16 + var391 * 9, 27, 9, 9);
               if(var6) {
                  if(var23 * 2 + 1 < var9) {
            ...
            EntityLivingBase var35 = (EntityLivingBase)var371;
            var38 = (int)Math.ceil((double)var35.getHealth());
