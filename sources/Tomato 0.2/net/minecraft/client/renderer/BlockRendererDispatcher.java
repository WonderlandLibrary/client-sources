...
public class BlockRendererDispatcher implements IResourceManagerReloadListener
{
    ...
    {
        EventBlockRender blockRender = new EventBlockRender(p_175018_2_.getX(), p_175018_2_.getY(), p_175018_2_.getZ(), p_175018_1_.getBlock());
        EventManager.call(blockRender);
        try
        {
