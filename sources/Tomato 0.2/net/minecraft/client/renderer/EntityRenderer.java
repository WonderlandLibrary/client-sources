...
import cow.milkgod.cheese.events.EventTracers;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
            ...
            else
            {
                ...
                for (int var20 = 0; var20 < 8; ++var20)
                {
                    ...
                    if (var24 != null)
                    {
                        ...
                        Cheese.getInstance();
                        if (!Cheese.moduleManager.getModState("FreeView")) {
                          var28 = var25;
                        }
                    }
                }
    ...
    private void func_175067_i(float p_175067_1_)
    {
        if (this.mc.gameSettings.showDebugInfo && !this.mc.gameSettings.hideGUI && !this.mc.thePlayer.func_175140_cp() && !this.mc.gameSettings.field_178879_v)
        {
            ...
            EventTracers tracers = new EventTracers(p_175067_1_);
            EventManager.call(tracers);
            GlStateManager.popMatrix();
    ...
    private void func_175068_a(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        R3DUtils.setup3DLightlessModel();
        Event3D evnt = new Event3D(partialTicks);
        EventManager.call(evnt);
        R3DUtils.shutdown3DLightlessModel();
        R3DUtils.setup3DLightlessModel();
        ...
        if (!renderFirstPersonHand && field_175074_C)
        {
            GlStateManager.clear(256);
