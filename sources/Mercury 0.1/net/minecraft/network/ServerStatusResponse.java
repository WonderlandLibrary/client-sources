    ...
    JsonSerializer {
        ...
        public ServerStatusResponse deserialize1(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) {
            ...
            if (var4.has("description")) {
                var5.setServerDescription((IChatComponent)p_deserialize_3_.deserialize(var4.get("description"), (Type)((Object)IChatComponent.class)));
            }
            if (var4.has("players")) {
                var5.setPlayerCountData((PlayerCountData)p_deserialize_3_.deserialize(var4.get("players"), (Type)((Object)PlayerCountData.class)));
            }
            if (var4.has("version")) {
                var5.setProtocolVersionInfo((MinecraftProtocolVersionIdentifier)p_deserialize_3_.deserialize(var4.get("version"), (Type)((Object)MinecraftProtocolVersionIdentifier.class)));
            }
            if (var4.has("favicon")) {
