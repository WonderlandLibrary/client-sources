...
public enum EnumConnectionState {
    ...
    private final Map directionMaps = Maps.newEnumMap(EnumPacketDirection.class);
    ...
    static {
        ...
        for (EnumConnectionState var3 : EnumConnectionState.values()) {
    ...
    protected EnumConnectionState registerPacket(EnumPacketDirection direction, Class packetClass) {
        HashBiMap var3 = (HashBiMap)this.directionMaps.get((Object)direction);
        if (var3 == null) {
            var3 = HashBiMap.create();
            this.directionMaps.put(direction, var3);
        }
        if (((BiMap)var3).containsValue(packetClass)) {
            String var4 = (Object)((Object)direction) + " packet " + packetClass + " is already known to ID " + ((BiMap)var3).inverse().get(packetClass);
    ...
    public Packet getPacket(EnumPacketDirection direction, int packetId) throws InstantiationException, IllegalAccessException {
        Class var3 = (Class)((BiMap)this.directionMaps.get((Object)direction)).get(packetId);
    ...
    /* synthetic */ EnumConnectionState(String string, int n2, String string2, int n3, int n4, Object object, EnumConnectionState enumConnectionState) {
        this(string2, n3, n4, object);
    }
