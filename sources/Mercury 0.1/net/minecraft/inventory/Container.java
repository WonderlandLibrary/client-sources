...
public abstract class Container {
    ...
    public void detectAndSendChanges() {
        for (int var1 = 0; var1 < this.inventorySlots.size(); ++var1) {
            ...
            if (ItemStack.areItemStacksEqual(var3, var2)) continue;
    ...
    public Slot getSlotFromInventory(IInventory p_75147_1_, int p_75147_2_) {
        for (int var3 = 0; var3 < this.inventorySlots.size(); ++var3) {
            ...
            if (!var4.isHere(p_75147_1_, p_75147_2_)) continue;
            return var4;
        }
        return null;
    }
    ...
    public ItemStack slotClick(int slotId, int clickedButton, int mode, EntityPlayer playerIn) {
        ...
        if (mode == 5) {
            ...
            if ((var7 != 1 || this.dragEvent != 2) && var7 != this.dragEvent) {
                ...
                if (Container.func_180610_a(this.dragMode, playerIn)) {
                    this.dragEvent = 1;
                ...
                if (var8 != null && Container.canAddItemToSlot(var8, var6.getItemStack(), true) && var8.isItemValid(var6.getItemStack()) && var6.getItemStack().stackSize > this.dragSlots.size() && this.canDragIntoSlot(var8)) {
                ...
                if (!this.dragSlots.isEmpty()) {
                    ...
                    for (Slot var11 : this.dragSlots) {
                        if (var11 == null || !Container.canAddItemToSlot(var11, var6.getItemStack(), true) || !var11.isItemValid(var6.getItemStack()) || var6.getItemStack().stackSize < this.dragSlots.size() || !this.canDragIntoSlot(var11)) continue;
                        ItemStack var12 = var17.copy();
                        int var13 = var11.getHasStack() ? var11.getStack().stackSize : 0;
                        Container.computeStackSize(this.dragSlots, this.dragMode, var12, var13);
            ...
            if (slotId == -999) {
                ...
                if (var16 != null && var16.canTakeStack(playerIn) && (var17 = this.transferStackInSlot(playerIn, slotId)) != null) {
                ...
                if (var16 != null) {
                    ...
                    if (var17 == null) {
                        if (var20 != null && var16.isItemValid(var20)) {
                            int var21;
                            int n2 = var21 = clickedButton == 0 ? var20.stackSize : 1;
                        ...
                        int var21;
                        if (var20 == null) {
                            int var212 = clickedButton == 0 ? var17.stackSize : (var17.stackSize + 1) / 2;
                            ItemStack var23 = var16.decrStackSize(var212);
                            ...
                            if (var17.getItem() == var20.getItem() && var17.getMetadata() == var20.getMetadata() && ItemStack.areItemStackTagsEqual(var17, var20)) {
                                int var213;
                                int n3 = var213 = clickedButton == 0 ? var20.stackSize : 1;
                                if (var213 > var16.func_178170_b(var20) - var17.stackSize) {
                                    var213 = var16.func_178170_b(var20) - var17.stackSize;
                                }
                                if (var213 > var20.getMaxStackSize() - var17.stackSize) {
                                    var213 = var20.getMaxStackSize() - var17.stackSize;
                                }
                                var20.splitStack(var213);
                                if (var20.stackSize == 0) {
                                    var6.setItemStack(null);
                                }
                                var17.stackSize += var213;
                            } else if (var20.stackSize <= var16.func_178170_b(var20)) {
                                var16.putStack(var20);
                                var6.setItemStack(var17);
                            }
                        } else if (var17.getItem() == var20.getItem() && var20.getMaxStackSize() > 1 && (!var17.getHasSubtypes() || var17.getMetadata() == var20.getMetadata()) && ItemStack.areItemStackTagsEqual(var17, var20) && (var21 = var17.stackSize) > 0 && var21 + var20.stackSize <= var20.getMaxStackSize()) {
            ...
            if (!(var17 == null || var16 != null && var16.getHasStack() && var16.canTakeStack(playerIn))) {
                ...
                for (int var22 = 0; var22 < 2; ++var22) {
                    for (int var24 = var9; var24 >= 0 && var24 < this.inventorySlots.size() && var17.stackSize < var17.getMaxStackSize(); var24 += var21) {
                        ...
                        if (!var25.getHasStack() || !Container.canAddItemToSlot(var25, var17, true) || !var25.canTakeStack(playerIn) || !this.func_94530_a(var17, var25) || var22 == 0 && var25.getStack().stackSize == var25.getStack().getMaxStackSize()) continue;
    ...
    protected boolean mergeItemStack(ItemStack stack, int startIndex, int endIndex, boolean useEndIndex) {
        ...
        if (stack.stackSize > 0) {
            var6 = useEndIndex ? endIndex - 1 : startIndex;
    ...
    public static boolean canAddItemToSlot(Slot slotIn, ItemStack stack, boolean stackSizeMatters) {
        boolean var3;
        boolean bl2 = var3 = slotIn == null || !slotIn.getHasStack();
    ...
    public static int calcRedstoneFromInventory(TileEntity te2) {
    ...
    public static int calcRedstoneFromInventory(IInventory inv) {
        ...
        return MathHelper.floor_float((var2 /= (float)inv.getSizeInventory()) * 14.0f) + (var1 > 0 ? 1 : 0);
    }
}
