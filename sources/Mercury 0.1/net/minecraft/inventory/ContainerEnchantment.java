...
extends Container {
                ...
                if (!this.worldPointer.isRemote) {
                    ...
                    for (var4 = -1; var4 <= 1; ++var4) {
                        for (int var5 = -1; var5 <= 1; ++var5) {
                            if (var4 == 0 && var5 == 0 || !this.worldPointer.isAirBlock(this.field_178150_j.add(var5, 0, var4)) || !this.worldPointer.isAirBlock(this.field_178150_j.add(var5, 1, var4))) continue;
                            ...
                            if (this.worldPointer.getBlockState(this.field_178150_j.add(var5, 1, var4 * 2)).getBlock() != Blocks.bookshelf) continue;
                            ++var3;
                        }
                    }
                    ...
                    for (var4 = 0; var4 < 3; ++var4) {
                        ...
                        if (this.enchantLevels[var4] >= var4 + 1) continue;
                        this.enchantLevels[var4] = 0;
                    }
                    for (var4 = 0; var4 < 3; ++var4) {
                        List var7;
                        if (this.enchantLevels[var4] <= 0 || (var7 = this.func_178148_a(var2, var4, this.enchantLevels[var4])) == null || var7.isEmpty()) continue;
    ...
    public boolean enchantItem(EntityPlayer playerIn, int id2) {
        ...
        if (this.enchantLevels[id2] > 0 && var3 != null && (playerIn.experienceLevel >= var5 && playerIn.experienceLevel >= this.enchantLevels[id2] || playerIn.capabilities.isCreativeMode)) {
            if (!this.worldPointer.isRemote) {
                boolean var7;
                List var6 = this.func_178148_a(var3, id2, this.enchantLevels[id2]);
                boolean bl2 = var7 = var3.getItem() == Items.book;
                if (var6 != null) {
    ...
    public boolean canInteractWith(EntityPlayer playerIn) {
        return this.worldPointer.getBlockState(this.field_178150_j).getBlock() != Blocks.enchanting_table ? false : playerIn.getDistanceSq((double)this.field_178150_j.getX() + 0.5, (double)this.field_178150_j.getY() + 0.5, (double)this.field_178150_j.getZ() + 0.5) <= 64.0;
    }
