...
extends Container {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (var4 != null && var4.getHasStack()) {
            ...
            } else if (index != 1 && index != 0 ? (FurnaceRecipes.instance().getSmeltingResult(var5) != null ? !this.mergeItemStack(var5, 0, 1, false) : (TileEntityFurnace.isItemFuel(var5) ? !this.mergeItemStack(var5, 1, 2, false) : (index >= 3 && index < 30 ? !this.mergeItemStack(var5, 30, 39, false) : index >= 30 && index < 39 && !this.mergeItemStack(var5, 3, 30, false)))) : !this.mergeItemStack(var5, 3, 39, false)) {
                return null;
            }
            if (var5.stackSize == 0) {
                var4.putStack(null);
