...
extends PathNavigate {
    ...
    protected void pathFollow() {
        ...
        for (int var4 = java.lang.Math.min((int)(this.currentPath.getCurrentPathIndex() + var3), (int)(this.currentPath.getCurrentPathLength() - 1)); var4 > this.currentPath.getCurrentPathIndex(); --var4) {
            Vec3 var5 = this.currentPath.getVectorFromIndex(this.theEntity, var4);
            if (!(var5.squareDistanceTo(var1) <= 36.0) || !this.isDirectPathBetweenPoints(var1, var5, 0, 0, 0)) continue;
    ...
    protected boolean isDirectPathBetweenPoints(Vec3 p_75493_1_, Vec3 p_75493_2_, int p_75493_3_, int p_75493_4_, int p_75493_5_) {
        MovingObjectPosition var6 = this.worldObj.rayTraceBlocks(p_75493_1_, new Vec3(p_75493_2_.xCoord, p_75493_2_.yCoord + (double)this.theEntity.height * 0.5, p_75493_2_.zCoord), false, true, false);
