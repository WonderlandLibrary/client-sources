...
public class PathFinder {
    ...
    public PathEntity func_180782_a(IBlockAccess p_180782_1_, Entity p_180782_2_, BlockPos p_180782_3_, float p_180782_4_) {
        return this.func_176189_a(p_180782_1_, p_180782_2_, (float)p_180782_3_.getX() + 0.5f, (float)p_180782_3_.getY() + 0.5f, (float)p_180782_3_.getZ() + 0.5f, p_180782_4_);
    }
    ...
    private PathEntity func_176187_a(Entity p_176187_1_, PathPoint p_176187_2_, PathPoint p_176187_3_, float p_176187_4_) {
        ...
        p_176187_2_.distanceToTarget = p_176187_2_.distanceToNext = p_176187_2_.distanceToSquared(p_176187_3_);
        this.path.clearPath();
        ...
        while (!this.path.isPathEmpty()) {
            ...
            for (int var8 = 0; var8 < var7; ++var8) {
                ...
                if (!(var10 < p_176187_4_ * 2.0f) || var9.isAssigned() && !(var10 < var9.totalPathDistance)) continue;
                var9.previous = var6;
