...
extends Item {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        ItemDoor.func_179235_a(worldIn, pos, EnumFacing.fromAngle(playerIn.rotationYaw), this.field_179236_a);
        --stack.stackSize;
        return true;
    }
    ...
    public static void func_179235_a(World worldIn, BlockPos p_179235_1_, EnumFacing p_179235_2_, Block p_179235_3_) {
        ...
        IBlockState var12 = p_179235_3_.getDefaultState().withProperty(BlockDoor.FACING_PROP, (Comparable)((Object)p_179235_2_)).withProperty(BlockDoor.HINGEPOSITION_PROP, (Comparable)((Object)(var10 ? BlockDoor.EnumHingePosition.RIGHT : BlockDoor.EnumHingePosition.LEFT)));
        worldIn.setBlockState(p_179235_1_, var12.withProperty(BlockDoor.HALF_PROP, (Comparable)((Object)BlockDoor.EnumDoorHalf.LOWER)), 2);
        worldIn.setBlockState(var11, var12.withProperty(BlockDoor.HALF_PROP, (Comparable)((Object)BlockDoor.EnumDoorHalf.UPPER)), 2);
