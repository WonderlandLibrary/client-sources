...
implements IRecipe {
    ...
    public boolean matches(InventoryCrafting p_77569_1_, World worldIn) {
        ...
        for (int var4 = 0; var4 < p_77569_1_.getSizeInventory(); ++var4) {
            ...
            var3.add(var5);
            if (var3.size() <= 1) continue;
            ItemStack var6 = (ItemStack)var3.get(0);
            if (var5.getItem() == var6.getItem() && var6.stackSize == 1 && var5.stackSize == 1 && var6.getItem().isDamageable()) continue;
            return false;
        }
        return var3.size() == 2;
    }
    ...
    public ItemStack getCraftingResult(InventoryCrafting p_77572_1_) {
        ...
        for (int var3 = 0; var3 < p_77572_1_.getSizeInventory(); ++var3) {
            ...
            var2.add(var4);
            if (var2.size() <= 1) continue;
            ItemStack var5 = (ItemStack)var2.get(0);
            if (var4.getItem() == var5.getItem() && var5.stackSize == 1 && var4.stackSize == 1 && var5.getItem().isDamageable()) continue;
            return null;
        }
        if (var2.size() == 2) {
