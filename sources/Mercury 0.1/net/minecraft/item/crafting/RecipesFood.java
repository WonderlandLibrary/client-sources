...
public class RecipesFood {
    ...
    public void addRecipes(CraftingManager p_77608_1_) {
        ...
        p_77608_1_.addRecipe(new ItemStack(Items.cookie, 8), "#X#", Character.valueOf('X'), new ItemStack(Items.dye, 1, EnumDyeColor.BROWN.getDyeColorDamage()), Character.valueOf('#'), Items.wheat);
