    ...
    public void updateMapData(World worldIn, Entity p_77872_2_, MapData p_77872_3_) {
        if (worldIn.provider.getDimensionId() == p_77872_3_.dimension && p_77872_2_ instanceof EntityPlayer) {
            ...
            for (int var12 = var7 - var9 + 1; var12 < var7 + var9; ++var12) {
                if ((var12 & 15) != (var10.field_82569_d & 15) && !var11) continue;
                var11 = false;
                double var13 = 0.0;
                for (int var15 = var8 - var9 - 1; var15 < var8 + var9; ++var15) {
                    ...
                    if (worldIn.provider.getHasNoSky()) {
                        ...
                        if (((var28 = var28 * var28 * 31287121 + var28 * 11) >> 20 & 1) == 0) {
                            var21.add(Blocks.dirt.getMapColor(Blocks.dirt.getDefaultState().withProperty(BlockDirt.VARIANT, (Comparable)((Object)BlockDirt.DirtType.DIRT))), 10);
                        } else {
                            var21.add(Blocks.stone.getMapColor(Blocks.stone.getDefaultState().withProperty(BlockStone.VARIANT_PROP, (Comparable)((Object)BlockStone.EnumType.STONE))), 100);
                        }
                        var26 = 100.0;
                    } else {
                    ...
                    if ((var36 = Iterables.getFirst(Multisets.copyHighestCountFirst(var21), MapColor.airColor)) == MapColor.waterColor) {
