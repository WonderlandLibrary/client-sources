...
implements IChunkProvider {
        ...
        for (int var2 = 0; var2 < 16; ++var2) {
            for (int var3 = 0; var3 < 16; ++var3) {
                ...
                for (int var8 = 127; var8 >= 0; --var8) {
                    ...
                    if (var9.getBlock() != Blocks.stone) continue;
                    if (var5 == -1) {
                        if (var4 <= 0) {
    ...
    private double[] initializeNoiseField(double[] p_73187_1_, int p_73187_2_, int p_73187_3_, int p_73187_4_, int p_73187_5_, int p_73187_6_, int p_73187_7_) {
        ...
        this.noiseData1 = this.noiseGen3.generateNoiseOctaves(this.noiseData1, p_73187_2_, p_73187_3_, p_73187_4_, p_73187_5_, p_73187_6_, p_73187_7_, (var8 *= 2.0) / 80.0, var10 / 160.0, var8 / 80.0);
