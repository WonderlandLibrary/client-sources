...
public class StructureOceanMonumentPieces {
    ...
    extends Piece {
        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
            ...
            ArrayList<MonumentRoomFitHelper> var6 = Lists.newArrayList();
        ...
        private List func_175836_a(Random p_175836_1_) {
                ...
                for (var4 = 0; var4 < 5; ++var4) {
                    for (int var17 = 0; var17 < 3; ++var17) {
                        ...
                        for (EnumFacing var10 : EnumFacing.values()) {
                            ...
                            if (var11 < 0 || var11 >= 5 || var13 < 0 || var13 >= 5 || var12 < 0 || var12 >= 3 || var2[var14 = MonumentBuilding.func_175820_a(var11, var12, var13)] == null) continue;
                            if (var13 != var4) {
            ...
            ArrayList<RoomDefinition> var19 = Lists.newArrayList();
            RoomDefinition[] var20 = var2;
            int var8 = var2.length;
            for (int var9 = 0; var9 < var8; ++var9) {
                RoomDefinition var24 = var20[var9];
                if (var24 == null) continue;
                var24.func_175958_a();
                var19.add(var24);
            }
            var15.func_175958_a();
            ...
            for (RoomDefinition var23 : var19) {
                int var25 = 0;
                for (var11 = 0; var25 < 2 && var11 < 5; ++var11) {
        ...
        private void func_175842_f(World worldIn, Random p_175842_2_, StructureBoundingBox p_175842_3_) {
            ...
            if (this.func_175818_a(p_175842_3_, 8, 44, 49, 54)) {
                ...
                for (var4 = 12; var4 <= 45; var4 += 3) {
                    ...
                    if (var4 != 12 && var4 != 18 && var4 != 24 && var4 != 33 && var4 != 39 && var4 != 45) continue;
            ...
            for (int var10 = p_175819_4_; var10 <= p_175819_7_; ++var10) {
                for (int var11 = p_175819_3_; var11 <= p_175819_6_; ++var11) {
                    for (int var12 = p_175819_5_; var12 <= p_175819_8_; ++var12) {
                        if (this.func_175807_a(worldIn, var11, var10, var12, p_175819_2_) != field_175822_f) continue;
    ...
    static class RoomDefinition {
        ...
        public boolean func_175959_a(int p_175959_1_) {
            ...
            for (int var2 = 0; var2 < 6; ++var2) {
                if (this.field_175965_b[var2] == null || !this.field_175966_c[var2] || this.field_175965_b[var2].field_175962_f == p_175959_1_ || !this.field_175965_b[var2].func_175959_a(p_175959_1_)) continue;
                return true;
            }
            return false;
        }
        ...
        public int func_175960_c() {
            int var1 = 0;
            for (int var2 = 0; var2 < 6; ++var2) {
                if (!this.field_175966_c[var2]) continue;
                ++var1;
            }
            return var1;
        }
    ...
    extends Piece {
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            boolean bl2 = var4 = this.field_175833_o != 0 && p_74875_2_.nextBoolean() && !this.field_175830_k.field_175966_c[EnumFacing.DOWN.getIndex()] && !this.field_175830_k.field_175966_c[EnumFacing.UP.getIndex()] && this.field_175830_k.func_175960_c() > 1;
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
            ...
            for (int var4 = 1; var4 <= 6; ++var4) {
                for (int var5 = 1; var5 <= 6; ++var5) {
                    if (p_74875_2_.nextInt(3) == 0) continue;
