            ...
            for (int var5 = 0; var5 <= 1 + p_175926_3_; ++var5) {
                ...
                for (int var7 = -var6; var7 <= var6 && var4; ++var7) {
                    for (int var8 = -var6; var8 <= var6 && var4; ++var8) {
                        if (p_175926_2_.getY() + var5 >= 0 && p_175926_2_.getY() + var5 < 256 && this.func_150523_a(worldIn.getBlockState(p_175926_2_.add(var7, var5, var8)).getBlock())) continue;
                        var4 = false;
                    }
                }
            }
    ...
    protected void func_175925_a(World worldIn, BlockPos p_175925_2_, int p_175925_3_) {
        ...
        for (int var5 = -p_175925_3_; var5 <= p_175925_3_ + 1; ++var5) {
            for (int var6 = -p_175925_3_; var6 <= p_175925_3_ + 1; ++var6) {
                ...
                int var7 = var5 - 1;
                int var8 = var6 - 1;
                if (var5 * var5 + var6 * var6 > var4 && var7 * var7 + var8 * var8 > var4 && var5 * var5 + var8 * var8 > var4 && var7 * var7 + var6 * var6 > var4 || (var10 = worldIn.getBlockState(var9 = p_175925_2_.add(var5, 0, var6)).getBlock().getMaterial()) != Material.air && var10 != Material.leaves) continue;
    ...
    protected void func_175928_b(World worldIn, BlockPos p_175928_2_, int p_175928_3_) {
        ...
        for (int var5 = -p_175928_3_; var5 <= p_175928_3_; ++var5) {
            for (int var6 = -p_175928_3_; var6 <= p_175928_3_; ++var6) {
                Material var8;
                BlockPos var7;
                if (var5 * var5 + var6 * var6 > var4 || (var8 = worldIn.getBlockState(var7 = p_175928_2_.add(var5, 0, var6)).getBlock().getMaterial()) != Material.air && var8 != Material.leaves) continue;
