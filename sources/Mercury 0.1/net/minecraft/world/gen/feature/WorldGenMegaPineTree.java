...
extends WorldGenHugeTrees {
    ...
    public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_) {
        ...
        for (int var5 = 0; var5 < var4; ++var5) {
            ...
            if ((var6 = worldIn.getBlockState(p_180709_3_.add(1, var5, 1)).getBlock()).getMaterial() == Material.air || var6.getMaterial() == Material.leaves) {
                this.func_175905_a(worldIn, p_180709_3_.add(1, var5, 1), Blocks.log, this.woodMetadata);
            }
            if ((var6 = worldIn.getBlockState(p_180709_3_.add(0, var5, 1)).getBlock()).getMaterial() != Material.air && var6.getMaterial() != Material.leaves) continue;
    ...
    private void func_175933_b(World worldIn, BlockPos p_175933_2_) {
        for (int var3 = -2; var3 <= 2; ++var3) {
            for (int var4 = -2; var4 <= 2; ++var4) {
                if (Math.abs(var3) == 2 && Math.abs(var4) == 2) continue;
    ...
    private void func_175934_c(World worldIn, BlockPos p_175934_2_) {
        for (int var3 = 2; var3 >= -3; --var3) {
            ...
            if (var5.getMaterial() != Material.air && var3 < 0) break;
        }
    }
}
