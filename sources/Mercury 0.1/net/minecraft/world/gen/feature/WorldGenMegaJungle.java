...
extends WorldGenHugeTrees {
    ...
    public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_) {
        ...
        for (int var5 = p_180709_3_.getY() + var4 - 2 - p_180709_2_.nextInt((int)4); var5 > p_180709_3_.getY() + var4 / 2; var5 -= 2 + p_180709_2_.nextInt((int)4)) {
            int var9;
        ...
        for (int var13 = 0; var13 < var4; ++var13) {
            ...
            if (!this.func_175931_a(worldIn.getBlockState(var17 = var14.offsetSouth()).getBlock().getMaterial())) continue;
