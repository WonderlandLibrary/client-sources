    ...
    public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_) {
        ...
        for (var6 = 0; var6 < var4; ++var6) {
            ...
            for (int var9 = -var8; var9 <= var8; ++var9) {
                ...
                for (int var11 = -var8; var11 <= var8; ++var11) {
                    ...
                    if ((var9 != 0 || var11 != 0) && !(var10 * var10 + var12 * var12 <= var7 * var7) || (var9 == -var8 || var9 == var8 || var11 == -var8 || var11 == var8) && !(p_180709_2_.nextFloat() <= 0.75f)) continue;
                    ...
                    if (var6 == 0 || var8 <= 1 || (var13 = worldIn.getBlockState(p_180709_3_.add(var9, -var6, var11)).getBlock()).getMaterial() != Material.air && var13 != Blocks.dirt && var13 != Blocks.snow && var13 != Blocks.ice) continue;
                    this.func_175906_a(worldIn, p_180709_3_.add(var9, -var6, var11), Blocks.packed_ice);
                }
            }
        }
        ...
        for (int var14 = -var6; var14 <= var6; ++var14) {
            for (var8 = -var6; var8 <= var6; ++var8) {
                ...
                while (var15.getY() > 50 && ((var17 = worldIn.getBlockState(var15).getBlock()).getMaterial() == Material.air || var17 == Blocks.dirt || var17 == Blocks.snow || var17 == Blocks.ice || var17 == Blocks.packed_ice)) {
