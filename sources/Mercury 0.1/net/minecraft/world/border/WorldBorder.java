...
public class WorldBorder {
    ...
    public boolean contains(AxisAlignedBB bb2) {
        return bb2.maxX > this.minX() && bb2.minX < this.maxX() && bb2.maxZ > this.minZ() && bb2.minZ < this.maxZ();
    }
    ...
    public double getClosestDistance(double x2, double z2) {
        double var5 = z2 - this.minZ();
        double var7 = this.maxZ() - z2;
        double var9 = x2 - this.minX();
        double var11 = this.maxX() - x2;
    ...
    public void setCenter(double x2, double z2) {
        ...
        for (IBorderListener var6 : this.getListeners()) {
            var6.onCenterChanged(this, x2, z2);
        }
    }
