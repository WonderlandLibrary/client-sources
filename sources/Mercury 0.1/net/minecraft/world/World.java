...
implements IBlockAccess {
    ...
    public int getChunksLowestHorizon(int x2, int z2) {
        if (x2 >= -30000000 && z2 >= -30000000 && x2 < 30000000 && z2 < 30000000) {
            ...
            Chunk var3 = this.getChunkFromChunkCoords(x2 >> 4, z2 >> 4);
    ...
    public void playSoundEffect(double x2, double y2, double z2, String soundName, float volume, float pitch) {
        for (int var10 = 0; var10 < this.worldAccesses.size(); ++var10) {
            ((IWorldAccess)this.worldAccesses.get(var10)).playSound(soundName, x2, y2, z2, volume, pitch);
        }
    }
    ...
    public List func_147461_a(AxisAlignedBB p_147461_1_) {
        ArrayList<E> var2 = Lists.newArrayList();
    ...
    public void updateEntities() {
        ...
        Iterator<E> var10 = this.tickableTileEntities.iterator();
        while (var10.hasNext()) {
            BlockPos var13;
    ...
    public boolean func_175670_e(BlockPos p_175670_1_, boolean p_175670_2_) {
        ...
        if (p_175670_1_.getY() >= 0 && p_175670_1_.getY() < 256 && this.getLightFor(EnumSkyBlock.BLOCK, p_175670_1_) < 10 && ((var6 = (var5 = this.getBlockState(p_175670_1_)).getBlock()) == Blocks.water || var6 == Blocks.flowing_water) && (Integer)var5.getValue(BlockLiquid.LEVEL) == 0) {
            ...
            boolean bl2 = var7 = this.func_175696_F(p_175670_1_.offsetWest()) && this.func_175696_F(p_175670_1_.offsetEast()) && this.func_175696_F(p_175670_1_.offsetNorth()) && this.func_175696_F(p_175670_1_.offsetSouth());
            if (!var7) {
                return true;
            }
        }
    ...
    public boolean checkLightFor(EnumSkyBlock p_180500_1_, BlockPos p_180500_2_) {
        ...
        while (var3 < var4) {
            ...
            boolean bl2 = var31 = var4 < this.lightUpdateBlockList.length - 6;
    ...
    public List func_175674_a(Entity p_175674_1_, AxisAlignedBB p_175674_2_, Predicate p_175674_3_) {
        ArrayList<E> var4 = Lists.newArrayList();
    ...
    public List func_175644_a(Class p_175644_1_, Predicate p_175644_2_) {
        ...
        for (Entity var5 : this.loadedEntityList) {
            if (!p_175644_1_.isAssignableFrom(var5.getClass()) || !p_175644_2_.apply(var5)) continue;
            var3.add(var5);
        }
        return var3;
    }
    ...
    public List func_175661_b(Class p_175661_1_, Predicate p_175661_2_) {
        ...
        for (Entity var5 : this.playerEntities) {
            if (!p_175661_1_.isAssignableFrom(var5.getClass()) || !p_175661_2_.apply(var5)) continue;
            var3.add(var5);
        }
        return var3;
    }
    ...
    public List func_175647_a(Class p_175647_1_, AxisAlignedBB p_175647_2_, Predicate p_175647_3_) {
        ...
        ArrayList<E> var8 = Lists.newArrayList();
        for (int var9 = var4; var9 <= var5; ++var9) {
            for (int var10 = var6; var10 <= var7; ++var10) {
                if (!this.isChunkLoaded(var9, var10, true)) continue;
    ...
    public Entity findNearestEntityWithinAABB(Class p_72857_1_, AxisAlignedBB p_72857_2_, Entity p_72857_3_) {
        ...
        for (int var8 = 0; var8 < var4.size(); ++var8) {
            ...
            if (var9 == p_72857_3_ || !IEntitySelector.field_180132_d.apply(var9) || !((var10 = p_72857_3_.getDistanceSqToEntity(var9)) <= var6)) continue;
            var5 = var9;
            var6 = var10;
        }
        return var5;
    ...
    public EntityPlayer getClosestPlayer(double x2, double y2, double z2, double distance) {
        ...
        for (int var12 = 0; var12 < this.playerEntities.size(); ++var12) {
            ...
            if (!IEntitySelector.field_180132_d.apply(var13)) continue;
            double var14 = var13.getDistanceSq(x2, y2, z2);
    ...
    public boolean func_175636_b(double p_175636_1_, double p_175636_3_, double p_175636_5_, double p_175636_7_) {
        for (int var9 = 0; var9 < this.playerEntities.size(); ++var9) {
            ...
            if (!IEntitySelector.field_180132_d.apply(var10)) continue;
    ...
    public boolean chunkExists(int x2, int z2) {
        ...
        int var4 = x2 * 16 + 8 - var3.getX();
        int var5 = z2 * 16 + 8 - var3.getZ();
        int var6 = 128;
