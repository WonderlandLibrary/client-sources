...
extends NodeProcessor {
    ...
    public PathPoint func_176161_a(Entity p_176161_1_) {
        ...
        if (this.field_176184_i && p_176161_1_.isInWater()) {
            ...
            Block var3 = this.field_176169_a.getBlockState(new BlockPos(MathHelper.floor_double(p_176161_1_.posX), var2, MathHelper.floor_double(p_176161_1_.posZ))).getBlock();
            while (var3 == Blocks.flowing_water || var3 == Blocks.water) {
                var3 = this.field_176169_a.getBlockState(new BlockPos(MathHelper.floor_double(p_176161_1_.posX), ++var2, MathHelper.floor_double(p_176161_1_.posZ))).getBlock();
            }
    ...
    private int func_176177_a(Entity p_176177_1_, int p_176177_2_, int p_176177_3_, int p_176177_4_) {
        return WalkNodeProcessor.func_176170_a(this.field_176169_a, p_176177_1_, p_176177_2_, p_176177_3_, p_176177_4_, this.field_176168_c, this.field_176165_d, this.field_176166_e, this.field_176183_h, this.field_176181_g, this.field_176180_f);
    }
        ...
        for (int var13 = p_176170_2_; var13 < p_176170_2_ + p_176170_5_; ++var13) {
            for (int var14 = p_176170_3_; var14 < p_176170_3_ + p_176170_6_; ++var14) {
                for (int var15 = p_176170_4_; var15 < p_176170_4_ + p_176170_7_; ++var15) {
                    ...
                    if (var17.getMaterial() == Material.air) continue;
                    ...
                    if (p_176170_1_.worldObj.getBlockState(var16).getBlock() instanceof BlockRailBase) {
                        if (p_176170_1_.worldObj.getBlockState(var12).getBlock() instanceof BlockRailBase || p_176170_1_.worldObj.getBlockState(var12.offsetDown()).getBlock() instanceof BlockRailBase) continue;
                        return -3;
                    }
                    if (var17.isPassable(p_176170_0_, var16) || p_176170_9_ && var17 instanceof BlockDoor && var17.getMaterial() == Material.wood) continue;
                    ...
                    if (p_176170_1_.func_180799_ab()) continue;
                    return -2;
                }
            }
        }
