...
extends BiomeGenBase {
    ...
    public int func_180627_b(BlockPos p_180627_1_) {
        double var2 = field_180281_af.func_151601_a((double)p_180627_1_.getX() * 0.0225, (double)p_180627_1_.getZ() * 0.0225);
    ...
    public void genTerrainBlocks(World worldIn, Random p_180622_2_, ChunkPrimer p_180622_3_, int p_180622_4_, int p_180622_5_, double p_180622_6_) {
        double var8 = field_180281_af.func_151601_a((double)p_180622_4_ * 0.25, (double)p_180622_5_ * 0.25);
        if (var8 > 0.0) {
            int var10 = p_180622_4_ & 15;
            int var11 = p_180622_5_ & 15;
            for (int var12 = 255; var12 >= 0; --var12) {
                if (p_180622_3_.getBlockState(var11, var12, var10).getBlock().getMaterial() == Material.air) continue;
                if (var12 != 62 || p_180622_3_.getBlockState(var11, var12, var10).getBlock() == Blocks.water) break;
