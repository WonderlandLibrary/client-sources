...
public class WorldChunkManager {
    ...
    public BlockPos findBiomePosition(int x2, int z2, int range, List biomes, Random random) {
        IntCache.resetIntCache();
        int var6 = x2 - range >> 2;
        int var7 = z2 - range >> 2;
        int var8 = x2 + range >> 2;
        ...
        for (int var15 = 0; var15 < var10 * var11; ++var15) {
            ...
            if (!biomes.contains(var18) || var13 != null && random.nextInt(var14 + 1) != 0) continue;
