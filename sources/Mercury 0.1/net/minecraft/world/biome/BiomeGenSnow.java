...
extends BiomeGenBase {
    ...
    protected BiomeGenBase createMutatedBiome(int p_180277_1_) {
        BiomeGenBase var2 = new BiomeGenSnow(p_180277_1_, true).func_150557_a(13828095, true).setBiomeName(String.valueOf(this.biomeName) + " Spikes").setEnableSnow().setTemperatureRainfall(0.0f, 0.5f).setHeight(new BiomeGenBase.Height(this.minHeight + 0.1f, this.maxHeight + 0.1f));
