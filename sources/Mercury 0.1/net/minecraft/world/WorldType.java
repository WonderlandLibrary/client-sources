...
public class WorldType {
    ...
    private WorldType(int id2, String name) {
        this(id2, name, 0);
    }

    private WorldType(int id2, String name, int version) {
        this.worldType = name;
        this.generatorVersion = version;
        this.canBeCreated = true;
        this.worldTypeId = id2;
    ...
    public static WorldType parseWorldType(String type) {
        for (int var1 = 0; var1 < worldTypes.length; ++var1) {
            if (worldTypes[var1] == null || !WorldType.worldTypes[var1].worldType.equalsIgnoreCase(type)) continue;
