...
public class Chunk {
    ...
    private final ClassInheratanceMultiMap[] entityLists = new ClassInheratanceMultiMap[16];
    ...
    public int getHeight(int x2, int z2) {
    ...
    private void checkSkylightNeighborHeight(int x2, int p_76599_2_, int z2) {
        int var4 = this.worldObj.getHorizon(new BlockPos(x2, 0, p_76599_2_)).getY();
        if (var4 > z2) {
            this.updateSkylightNeighborHeight(x2, p_76599_2_, z2, var4 + 1);
        } else if (var4 < z2) {
            this.updateSkylightNeighborHeight(x2, p_76599_2_, var4, z2 + 1);
        }
    }
    ...
    private void updateSkylightNeighborHeight(int x2, int z2, int startY, int endY) {
        if (endY > startY && this.worldObj.isAreaLoaded(new BlockPos(x2, 0, z2), 16)) {
            for (int var5 = startY; var5 < endY; ++var5) {
                this.worldObj.checkLightFor(EnumSkyBlock.SKY, new BlockPos(x2, var5, z2));
            }
            this.isModified = true;
        }
    }
    ...
    private void relightBlock(int x2, int y2, int z2) {
        int var4;
        int var5 = var4 = this.heightMap[z2 << 4 | x2] & 255;
        if (y2 > var4) {
            var5 = y2;
        }
        while (var5 > 0 && this.getBlockLightOpacity(x2, var5 - 1, z2) == 0) {
            --var5;
        }
        if (var5 != var4) {
            int var13;
            int var8;
            this.worldObj.markBlocksDirtyVertical(x2 + this.xPosition * 16, z2 + this.zPosition * 16, var5, var4);
            this.heightMap[z2 << 4 | x2] = var5;
            int var6 = this.xPosition * 16 + x2;
            int var7 = this.zPosition * 16 + z2;
            if (!this.worldObj.provider.getHasNoSky()) {
                ...
                if (var5 < var4) {
                    for (var8 = var5; var8 < var4; ++var8) {
                        ...
                        var9.setExtSkylightValue(x2, var8 & 15, z2, 15);
                        this.worldObj.notifyLightSet(new BlockPos((this.xPosition << 4) + x2, var8, (this.zPosition << 4) + z2));
                    }
                } else {
                    for (var8 = var4; var8 < var5; ++var8) {
                        var9 = this.storageArrays[var8 >> 4];
                        if (var9 == null) continue;
                        var9.setExtSkylightValue(x2, var8 & 15, z2, 0);
                        this.worldObj.notifyLightSet(new BlockPos((this.xPosition << 4) + x2, var8, (this.zPosition << 4) + z2));
                    }
                }
                var8 = 15;
                while (var5 > 0 && var8 > 0) {
                    ...
                    if ((var13 = this.getBlockLightOpacity(x2, --var5, z2)) == 0) {
                        var13 = 1;
                    }
                    if ((var8 -= var13) < 0) {
                        var8 = 0;
                    ...
                    var10.setExtSkylightValue(x2, var5 & 15, z2, var8);
                }
            }
            var8 = this.heightMap[z2 << 4 | x2];
            var13 = var4;
            int var14 = var8;
            if (var8 < var4) {
                var13 = var8;
    ...
    private Block getBlock0(int x2, int y2, int z2) {
        ...
        if (y2 >= 0 && y2 >> 4 < this.storageArrays.length && (var5 = this.storageArrays[y2 >> 4]) != null) {
            try {
                var4 = var5.getBlockByExtId(x2, y2 & 15, z2);
            }
    ...
    public Block getBlock(final int x2, final int y2, final int z2) {
        try {
            return this.getBlock0(x2 & 15, y2, z2 & 15);
        }
    ...
    public IBlockState setBlockState(BlockPos p_177436_1_, IBlockState p_177436_2_) {
        ...
        if (var4 >= this.precipitationHeightMap[var6 = (var5 = p_177436_1_.getZ() & 15) << 4 | var3] - 1) {
    ...
    public boolean canSeeSky(BlockPos pos) {
        ...
        int var3 = pos.getY();
        return var3 >= this.heightMap[(var4 = pos.getZ() & 15) << 4 | var2];
    }
    ...
    public void func_177414_a(Entity p_177414_1_, AxisAlignedBB p_177414_2_, List p_177414_3_, Predicate p_177414_4_) {
        ...
        for (int var7 = var5; var7 <= var6; ++var7) {
            for (Entity var9 : this.entityLists[var7]) {
                if (var9 == p_177414_1_ || !var9.getEntityBoundingBox().intersectsWith(p_177414_2_) || p_177414_4_ != null && !p_177414_4_.apply(var9)) continue;
    ...
    public void func_177430_a(Class p_177430_1_, AxisAlignedBB p_177430_2_, List p_177430_3_, Predicate p_177430_4_) {
        ...
        for (int var7 = var5; var7 <= var6; ++var7) {
            for (Entity var9 : this.entityLists[var7].func_180215_b(p_177430_1_)) {
                if (!var9.getEntityBoundingBox().intersectsWith(p_177430_2_) || p_177430_4_ != null && !p_177430_4_.apply(var9)) continue;
    ...
    public void enqueueRelightChecks() {
        ...
        for (int var2 = 0; var2 < 8; ++var2) {
            ...
            for (int var6 = 0; var6 < 16; ++var6) {
                ...
                boolean bl2 = var8 = var6 == 0 || var6 == 15 || var4 == 0 || var4 == 15 || var5 == 0 || var5 == 15;
