...
IThreadedFileIO {
    ...
    public Chunk loadChunk(World worldIn, int x2, int z2) throws IOException {
        ...
        ChunkCoordIntPair var5 = new ChunkCoordIntPair(x2, z2);
        ...
        if (var4 == null) {
            DataInputStream var10 = RegionFileCache.getChunkInputStream(this.chunkSaveLocation, x2, z2);
            if (var10 == null) {
                return null;
            }
            var4 = CompressedStreamTools.read(var10);
        }
        return this.checkedReadChunkFromNBT(worldIn, x2, z2, var4);
    }
