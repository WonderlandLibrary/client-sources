...
extends SaveFormatOld {
    ...
    public List getSaveList() throws AnvilConverterException {
        if (this.savesDirectory != null && this.savesDirectory.exists() && this.savesDirectory.isDirectory()) {
            File[] var2;
            ArrayList<SaveFormatComparator> var1 = Lists.newArrayList();
    ...
    private void convertChunks(File p_75811_1_, File p_75811_2_, WorldChunkManager p_75811_3_, int p_75811_4_, int p_75811_5_, IProgressUpdate p_75811_6_) {
        try {
            ...
            RegionFile var9 = new RegionFile(new File(p_75811_1_, String.valueOf(var7.substring(0, var7.length() - ".mcr".length())) + ".mca"));
