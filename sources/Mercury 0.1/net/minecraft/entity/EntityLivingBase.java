...
extends Entity {
    ...
    private static final Map activePotionsMap = Maps.newHashMap();
    ...
    public void onEntityUpdate() {
        ...
        boolean bl2 = var7 = var1 && ((EntityPlayer)this).capabilities.disableDamage;
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound) {
        ...
        if (!activePotionsMap.isEmpty()) {
            ...
            for (PotionEffect var8 : activePotionsMap.values()) {
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        if (tagCompund.hasKey("ActiveEffects", 9)) {
            ...
            for (int var3 = 0; var3 < var2.tagCount(); ++var3) {
                ...
                if (var5 == null) continue;
                activePotionsMap.put(var5.getPotionID(), var5);
            }
        }
    ...
    protected void updatePotionEffects() {
        ...
        boolean bl2 = var12 = this.dataWatcher.getWatchableObjectByte(8) > 0;
        if (var11 > 0) {
            boolean var4 = false;
            if (!this.isInvisible()) {
                var4 = this.rand.nextBoolean();
            } else {
                boolean bl3 = var4 = this.rand.nextInt(15) == 0;
            }
            if (var12) {
    ...
    protected void func_175135_B() {
        if (activePotionsMap.isEmpty()) {
            ...
            this.dataWatcher.updateObject(8, (byte)(PotionHelper.func_82817_b(activePotionsMap.values()) ? 1 : 0));
    ...
    public boolean isPotionActive(int p_82165_1_) {
        return activePotionsMap.containsKey(p_82165_1_);
    }

    public boolean isPotionActive(Potion p_70644_1_) {
        return activePotionsMap.containsKey(p_70644_1_.id);
    }

    public static PotionEffect getActivePotionEffect(Potion p_70660_1_) {
        return (PotionEffect)activePotionsMap.get(p_70660_1_.id);
    }

    public void addPotionEffect(PotionEffect p_70690_1_) {
        if (this.isPotionApplicable(p_70690_1_)) {
            if (activePotionsMap.containsKey(p_70690_1_.getPotionID())) {
                ((PotionEffect)activePotionsMap.get(p_70690_1_.getPotionID())).combine(p_70690_1_);
                this.onChangedPotionEffect((PotionEffect)activePotionsMap.get(p_70690_1_.getPotionID()), true);
            } else {
                activePotionsMap.put(p_70690_1_.getPotionID(), p_70690_1_);
    ...
    public void removePotionEffectClient(int p_70618_1_) {
        activePotionsMap.remove(p_70618_1_);
    }

    public void removePotionEffect(int p_82170_1_) {
        PotionEffect var2 = (PotionEffect)activePotionsMap.remove(p_82170_1_);
        if (var2 != null) {
    ...
    public void fall(float distance, float damageMultiplier) {
        ...
        PotionEffect var3 = EntityLivingBase.getActivePotionEffect(Potion.jump);
    ...
    protected float applyPotionDamageCalculations(DamageSource p_70672_1_, float p_70672_2_) {
        ...
        if (this.isPotionActive(Potion.resistance) && p_70672_1_ != DamageSource.outOfWorld) {
            var3 = (EntityLivingBase.getActivePotionEffect(Potion.resistance).getAmplifier() + 1) * 5;
            var4 = 25 - var3;
    ...
    private int getArmSwingAnimationEnd() {
        return this.isPotionActive(Potion.digSpeed) ? 6 - (1 + EntityLivingBase.getActivePotionEffect(Potion.digSpeed).getAmplifier()) * 1 : (this.isPotionActive(Potion.digSlowdown) ? 6 + (1 + EntityLivingBase.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2 : 6);
    }
    ...
    protected void jump() {
        ...
        if (this.isPotionActive(Potion.jump)) {
            this.motionY += (double)((float)(EntityLivingBase.getActivePotionEffect(Potion.jump).getAmplifier() + 1) * 0.1f);
        }
        if (this.isSprinting()) {
        ...
        if (this.isServerWorld()) {
            ...
            if (!(!this.isInWater() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)) {
                ...
                if (this.isOnLadder()) {
                    ...
                    boolean bl2 = var7 = this.isSneaking() && this instanceof EntityPlayer;
    ...
    protected float func_110146_f(float p_110146_1_, float p_110146_2_) {
        ...
        boolean bl2 = var5 = var4 < -90.0f || var4 >= 90.0f;
        if (var4 < -75.0f) {
            var4 = -75.0f;
        }
        if (var4 >= 75.0f) {
