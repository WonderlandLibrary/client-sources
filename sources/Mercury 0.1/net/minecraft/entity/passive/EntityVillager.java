...
IMerchant {
    ...
    public boolean interact(EntityPlayer p_70085_1_) {
        ...
        boolean bl2 = var3 = var2 != null && var2.getItem() == Items.spawn_egg;
    ...
    public boolean func_175557_cr() {
        boolean var1;
        boolean bl2 = var1 = this.getProfession() == 0;
    ...
    private boolean func_175559_s(int p_175559_1_) {
        ...
        for (int var3 = 0; var3 < this.field_175560_bz.getSizeInventory(); ++var3) {
            ...
            if (!var2 || var4.getItem() != Items.wheat || var4.stackSize < 9 * p_175559_1_) continue;
            return true;
        }
        return false;
    }
    ...
    public boolean func_175556_cs() {
        for (int var1 = 0; var1 < this.field_175560_bz.getSizeInventory(); ++var1) {
            ...
            if (var2 == null || var2.getItem() != Items.wheat_seeds && var2.getItem() != Items.potato && var2.getItem() != Items.carrot) continue;
            return true;
        }
        return false;
    }
