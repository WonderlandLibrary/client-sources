    ...
    protected void updateAITasks() {
        if (this.getInvulTime() > 0) {
            ...
            block0 : for (var1 = 1; var1 < 3; ++var1) {
                ...
                List var13 = this.worldObj.func_175647_a(EntityLivingBase.class, this.getEntityBoundingBox().expand(20.0, 8.0, 20.0), Predicates.and(attackEntitySelector, IEntitySelector.field_180132_d));
