...
IMob {
    ...
    public EntityDragonPart[] dragonPartArray = new EntityDragonPart[]{this.dragonPartHead, this.dragonPartBody, this.dragonPartTail1, this.dragonPartTail2, this.dragonPartTail3, this.dragonPartWing1, this.dragonPartWing2};
        ...
        if (this.getHealth() <= 0.0f) {
            ...
            if (this.worldObj.isRemote) {
                ...
                if (this.target != null) {
                    ...
                    var16 = 0.4000000059604645 + var14 / 80.0 - 1.0;
                    if (var16 > 10.0) {
                        var16 = 10.0;
                    }
                ...
                this.rotationYaw = MathHelper.wrapAngleTo180_float(this.rotationYaw);
                double var11 = 180.0 - Math.atan2(var28, var6) * 180.0 / 3.141592653589793;
                ...
                var16 = -MathHelper.cos(this.rotationYaw * 3.1415927f / 180.0f);
                ...
                this.randomYawVelocity = (float)((double)this.randomYawVelocity + var13 * (0.699999988079071 / var21 / (double)var20));
            ...
            for (int var32 = 0; var32 < 3; ++var32) {
                ...
                float var37 = this.rotationYaw * 3.1415927f / 180.0f + this.simplifyAngle(var36[0] - var31[0]) * 3.1415927f / 180.0f * 1.0f;
