    ...
    public void updatePlayerList(List p_73122_1_) {
        ...
        if (this.updateCounter % this.updateFrequency == 0 || this.trackedEntity.isAirBorne || this.trackedEntity.getDataWatcher().hasObjectChanged()) {
            ...
            if (this.trackedEntity.ridingEntity == null) {
                ...
                boolean bl2 = var12 = Math.abs(var27 - this.encodedRotationYaw) >= 4 || Math.abs(var28 - this.encodedRotationPitch) >= 4;
                ...
                boolean bl3 = var26 = Math.abs(var23 - this.encodedRotationYaw) >= 4 || Math.abs(var24 - this.encodedRotationPitch) >= 4;
                if (var26) {
