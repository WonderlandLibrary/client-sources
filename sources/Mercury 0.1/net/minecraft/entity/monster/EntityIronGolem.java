...
extends EntityGolem {
    ...
    public void onLivingUpdate() {
        ...
        if (this.motionX * this.motionX + this.motionZ * this.motionZ > 2.500000277905201E-7 && this.rand.nextInt(5) == 0 && (var5 = (var4 = this.worldObj.getBlockState(new BlockPos(var1 = MathHelper.floor_double(this.posX), var2 = MathHelper.floor_double(this.posY - 0.20000000298023224), var3 = MathHelper.floor_double(this.posZ)))).getBlock()).getMaterial() != Material.air) {
