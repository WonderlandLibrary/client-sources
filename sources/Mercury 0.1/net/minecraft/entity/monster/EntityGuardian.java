        ...
        if (this.func_175461_cl()) {
            ...
            if ((this.ticksExisted + this.getEntityId()) % 1200 == 0) {
                ...
                for (EntityPlayerMP var8 : var6) {
                    if (var8.isPotionActive(var5) && EntityPlayerMP.getActivePotionEffect(var5).getAmplifier() >= 2 && EntityPlayerMP.getActivePotionEffect(var5).getDuration() >= 1200) continue;
