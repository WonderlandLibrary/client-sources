...
extends EntityAIBase {
    ...
    public static boolean func_179445_a(EntityLiving p_179445_0_, EntityLivingBase p_179445_1_, boolean p_179445_2_, boolean p_179445_3_) {
        ...
        if (p_179445_0_ instanceof IEntityOwnable && StringUtils.isNotEmpty(((IEntityOwnable)((Object)p_179445_0_)).func_152113_b())) {
    ...
    protected boolean isSuitableTarget(EntityLivingBase p_75296_1_, boolean p_75296_2_) {
        ...
        if (this.nearbyOnly) {
            ...
            if (this.targetSearchStatus == 0) {
                int n2 = this.targetSearchStatus = this.canEasilyReach(p_75296_1_) ? 1 : 2;
            }
    ...
    private boolean canEasilyReach(EntityLivingBase p_75295_1_) {
        ...
        return (double)(var4 * var4 + (var5 = var3.zCoord - MathHelper.floor_double(p_75295_1_.posZ)) * var5) <= 2.25;
    }
}
