...
extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        List var1 = this.theEntity.worldObj.func_175674_a(this.theEntity, this.theEntity.getEntityBoundingBox().expand(this.field_179508_f, 3.0, this.field_179508_f), Predicates.and(IEntitySelector.field_180132_d, this.field_179509_a, this.field_179510_i));
        if (var1.isEmpty()) {
            return false;
        }
