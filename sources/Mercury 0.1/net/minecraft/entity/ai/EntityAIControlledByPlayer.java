...
extends EntityAIBase {
    ...
    public void updateTask() {
        ...
        if (var4 != var17 || var6 != var18) {
            ...
            boolean bl2 = var23 = !this.isStairOrSlab(var22) && (var22.getMaterial() != Material.air || !this.isStairOrSlab(this.thisEntity.worldObj.getBlockState(new BlockPos(var4, var5 - 1, var6)).getBlock()));
