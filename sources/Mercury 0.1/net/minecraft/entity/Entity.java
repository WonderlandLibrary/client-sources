...
implements ICommandSender {
    ...
    public void setPosition(double x2, double y2, double z2) {
        ...
        this.func_174826_a(new AxisAlignedBB(x2 - (double)var7, y2, z2 - (double)var7, x2 + (double)var7, y2 + (double)var8, z2 + (double)var7));
    }
    ...
    public boolean isOffsetPositionInLiquid(double x2, double y2, double z2) {
        AxisAlignedBB var7 = this.getEntityBoundingBox().offset(x2, y2, z2);
    ...
    public void moveEntity(double x2, double y2, double z2) {
        if (this.noClip) {
            this.func_174826_a(this.getEntityBoundingBox().offset(x2, y2, z2));
            this.func_174829_m();
        } else {
            Block var28;
            ...
            List var53 = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().addCoord(x2, y2, z2));
            AxisAlignedBB var21 = this.getEntityBoundingBox();
            for (AxisAlignedBB var23 : var53) {
                y2 = var23.calculateYOffset(this.getEntityBoundingBox(), y2);
            }
            this.func_174826_a(this.getEntityBoundingBox().offset(0.0, y2, 0.0));
            boolean var54 = this.onGround || var15 != y2 && var15 < 0.0;
            for (AxisAlignedBB var24 : var53) {
                x2 = var24.calculateXOffset(this.getEntityBoundingBox(), x2);
            }
            this.func_174826_a(this.getEntityBoundingBox().offset(x2, 0.0, 0.0));
            for (AxisAlignedBB var24 : var53) {
                z2 = var24.calculateZOffset(this.getEntityBoundingBox(), z2);
            }
            this.func_174826_a(this.getEntityBoundingBox().offset(0.0, 0.0, z2));
            if (this.stepHeight > 0.0f && var54 && (var13 != x2 || var17 != z2)) {
                double var56 = x2;
                double var25 = y2;
                double var27 = z2;
                ...
                y2 = this.stepHeight;
                List var30 = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().addCoord(var13, y2, var17));
                ...
                for (AxisAlignedBB var51 : var30) {
                    y2 = var51.calculateYOffset(this.getEntityBoundingBox(), y2);
                }
                this.func_174826_a(this.getEntityBoundingBox().offset(0.0, y2, 0.0));
                if (var56 * var56 + var27 * var27 >= x2 * x2 + z2 * z2) {
                    x2 = var56;
                    y2 = var25;
                    z2 = var27;
            ...
            this.func_174829_m();
            this.isCollidedHorizontally = var13 != x2 || var17 != z2;
            this.isCollidedVertically = var15 != y2;
            this.onGround = this.isCollidedVertically && var15 < 0.0;
            this.isCollided = this.isCollidedHorizontally || this.isCollidedVertically;
            int var57 = MathHelper.floor_double(this.posX);
            int var58 = MathHelper.floor_double(this.posY - 0.20000000298023224);
            ...
            this.func_180433_a(y2, this.onGround, var60, var26);
            if (var13 != x2) {
                this.motionX = 0.0;
            }
            if (var17 != z2) {
    ...
    public double getDistanceSq(double x2, double y2, double z2) {
        double var7 = this.posX - x2;
        double var9 = this.posY - y2;
        double var11 = this.posZ - z2;
    ...
    public boolean isBurning() {
        boolean var1;
        boolean bl2 = var1 = this.worldObj != null && this.worldObj.isRemote;
    ...
    protected boolean pushOutOfBlocks(double x2, double y2, double z2) {
        BlockPos var7 = new BlockPos(x2, y2, z2);
        double var8 = x2 - (double)var7.getX();
        double var10 = y2 - (double)var7.getY();
        double var12 = z2 - (double)var7.getZ();
