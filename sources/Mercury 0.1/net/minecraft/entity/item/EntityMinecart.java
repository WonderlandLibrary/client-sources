...
implements IWorldNameable {
    ...
    public double getMountedYOffset() {
        return (double)this.height * 0.5 - 0.20000000298023224;
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if (!this.worldObj.isRemote && !this.isDead) {
            ...
            boolean bl2 = var3 = source.getEntity() instanceof EntityPlayer && ((EntityPlayer)source.getEntity()).capabilities.isCreativeMode;
    ...
    public void onUpdate() {
        ...
        if (this.worldObj.isRemote) {
            ...
            if (var6 * var6 + var8 * var8 > 0.001) {
                this.rotationYaw = (float)(Math.atan2(var8, var6) * 180.0 / 3.141592653589793);
                if (this.isInReverse) {
            ...
            this.setRotation(this.rotationYaw, this.rotationPitch);
            for (Entity var13 : this.worldObj.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox().expand(0.20000000298023224, 0.0, 0.20000000298023224))) {
    ...
    protected void func_180460_a(BlockPos p_180460_1_, IBlockState p_180460_2_) {
        ...
        if (this.riddenByEntity instanceof EntityLivingBase && (var21 = (double)((EntityLivingBase)this.riddenByEntity).moveForward) > 0.0) {
            var23 = -Math.sin(this.riddenByEntity.rotationYaw * 3.1415927f / 180.0f);
            var25 = Math.cos(this.riddenByEntity.rotationYaw * 3.1415927f / 180.0f);
    ...
    public void applyEntityCollision(Entity entityIn) {
        if (!(this.worldObj.isRemote || entityIn.noClip || this.noClip || entityIn == this.riddenByEntity)) {
            ...
            if ((var6 = (var2 = entityIn.posX - this.posX) * var2 + (var4 = entityIn.posZ - this.posZ) * var4) >= 9.999999747378752E-5) {
                ...
                if (entityIn instanceof EntityMinecart) {
                    ...
                    double var16 = Math.abs(var14.dotProduct(var15 = new Vec3(MathHelper.cos(this.rotationYaw * 3.1415927f / 180.0f), 0.0, MathHelper.sin(this.rotationYaw * 3.1415927f / 180.0f)).normalize()));
