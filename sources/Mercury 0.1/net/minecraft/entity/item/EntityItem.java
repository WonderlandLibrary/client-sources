...
extends Entity {
    ...
    public EntityItem(World worldIn, double x2, double y2, double z2) {
        super(worldIn);
    ...
    public EntityItem(World worldIn, double x2, double y2, double z2, ItemStack stack) {
        this(worldIn, x2, y2, z2);
    ...
    public void onUpdate() {
        if (this.getEntityItem() == null) {
            ...
            boolean bl2 = var1 = (int)this.prevPosX != (int)this.posX || (int)this.prevPosY != (int)this.posY || (int)this.prevPosZ != (int)this.posZ;
