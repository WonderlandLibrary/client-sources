...
extends EntityLivingBase {
    ...
    protected void dropEquipment(boolean p_82160_1_, int p_82160_2_) {
        for (int var3 = 0; var3 < this.getInventory().length; ++var3) {
            ...
            boolean bl2 = var5 = this.equipmentDropChances[var3] > 1.0f;
    ...
    protected void func_180481_a(DifficultyInstance p_180481_1_) {
        if (this.rand.nextFloat() < 0.15f * p_180481_1_.func_180170_c()) {
            ...
            float f2 = var3 = this.worldObj.getDifficulty() == EnumDifficulty.HARD ? 0.1f : 0.25f;
    ...
    private boolean canSkipUpdate() {
        ...
        double dx2 = Math.max(Math.abs(this.posX - player.posX) - 16.0, 0.0);
        double distSq = dx2 * dx2 + (dz2 = Math.max(Math.abs(this.posZ - player.posZ) - 16.0, 0.0)) * dz2;
