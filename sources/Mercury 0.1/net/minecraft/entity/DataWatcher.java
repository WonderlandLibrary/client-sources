...
public class DataWatcher {
    ...
    public void addObject(int id2, Object object) {
        ...
        WatchableObject var4 = new WatchableObject(var3, id2, object);
        this.lock.writeLock().lock();
        this.watchedObjects.put(id2, var4);
        this.lock.writeLock().unlock();
        this.isBlank = false;
    }

    public void addObjectByDataType(int id2, int type) {
        WatchableObject var3 = new WatchableObject(type, id2, null);
        this.lock.writeLock().lock();
        this.watchedObjects.put(id2, var3);
        this.lock.writeLock().unlock();
        this.isBlank = false;
    }
    ...
    private WatchableObject getWatchedObject(int id2) {
        ...
        try {
            var2 = (WatchableObject)this.watchedObjects.get(id2);
        }
            ...
            var5.addCrashSection("Data ID", id2);
    ...
    public void updateObject(int id2, Object newData) {
        WatchableObject var3 = this.getWatchedObject(id2);
        if (ObjectUtils.notEqual(newData, var3.getObject())) {
            var3.setObject(newData);
            this.owner.func_145781_i(id2);
    ...
    public void setObjectWatched(int id2) {
        WatchableObject.access$0(this.getWatchedObject(id2), true);
        this.objectChanged = true;
    }
    ...
    public static class WatchableObject {
        ...
        static /* synthetic */ void access$0(WatchableObject watchableObject, boolean bl2) {
            watchableObject.watched = bl2;
        }
    }
