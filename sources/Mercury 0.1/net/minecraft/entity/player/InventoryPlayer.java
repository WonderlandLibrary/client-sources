...
implements IInventory {
    ...
    private int getInventorySlotContainItem(Item itemIn) {
        for (int var2 = 0; var2 < this.mainInventory.length; ++var2) {
            if (this.mainInventory[var2] == null || this.mainInventory[var2].getItem() != itemIn) continue;
            return var2;
        }
        return -1;
    }
    ...
    private int getInventorySlotContainItemAndDamage(Item p_146024_1_, int p_146024_2_) {
        for (int var3 = 0; var3 < this.mainInventory.length; ++var3) {
            if (this.mainInventory[var3] == null || this.mainInventory[var3].getItem() != p_146024_1_ || this.mainInventory[var3].getMetadata() != p_146024_2_) continue;
            return var3;
        }
        return -1;
    }
    ...
    public int getFirstEmptyStack() {
        for (int var1 = 0; var1 < this.mainInventory.length; ++var1) {
            if (this.mainInventory[var1] != null) continue;
            return var1;
        }
        return -1;
    }
    ...
    public void setCurrentItem(Item p_146030_1_, int p_146030_2_, boolean p_146030_3_, boolean p_146030_4_) {
        ...
        int n2 = var6 = p_146030_3_ ? this.getInventorySlotContainItemAndDamage(p_146030_1_, p_146030_2_) : this.getInventorySlotContainItem(p_146030_1_);
        if (var6 >= 0 && var6 < 9) {
    ...
    public int func_174925_a(Item p_174925_1_, int p_174925_2_, int p_174925_3_, NBTTagCompound p_174925_4_) {
        ...
        for (var6 = 0; var6 < this.mainInventory.length; ++var6) {
            ...
            if (var7 == null || p_174925_1_ != null && var7.getItem() != p_174925_1_ || p_174925_2_ > -1 && var7.getMetadata() != p_174925_2_ || p_174925_4_ != null && !CommandTestForBlock.func_175775_a(p_174925_4_, var7.getTagCompound(), true)) continue;
            var8 = p_174925_3_ <= 0 ? var7.stackSize : Math.min(p_174925_3_ - var5, var7.stackSize);
            var5 += var8;
            if (p_174925_3_ == 0) continue;
            this.mainInventory[var6].stackSize -= var8;
            if (this.mainInventory[var6].stackSize == 0) {
                this.mainInventory[var6] = null;
            }
            if (p_174925_3_ <= 0 || var5 < p_174925_3_) continue;
            return var5;
        }
        for (var6 = 0; var6 < this.armorInventory.length; ++var6) {
            var7 = this.armorInventory[var6];
            if (var7 == null || p_174925_1_ != null && var7.getItem() != p_174925_1_ || p_174925_2_ > -1 && var7.getMetadata() != p_174925_2_ || p_174925_4_ != null && !CommandTestForBlock.func_175775_a(p_174925_4_, var7.getTagCompound(), false)) continue;
            var8 = p_174925_3_ <= 0 ? var7.stackSize : Math.min(p_174925_3_ - var5, var7.stackSize);
            var5 += var8;
            if (p_174925_3_ == 0) continue;
    ...
    public boolean addItemStackToInventory(final ItemStack p_70441_1_) {
        if (p_70441_1_ != null && p_70441_1_.stackSize != 0 && p_70441_1_.getItem() != null) {
            ...
            block10 : {
                block8 : {
                    block9 : {
                        if (!p_70441_1_.isItemDamaged()) break block8;
                        var2 = this.getFirstEmptyStack();
                        if (var2 < 0) break block9;
                ...
                try {
                    ...
                    if (p_70441_1_.stackSize != var2 || !this.player.capabilities.isCreativeMode) break block10;
                    p_70441_1_.stackSize = 0;
                    return true;
                }
    ...
    public NBTTagList writeToNBT(NBTTagList p_70442_1_) {
        ...
        for (var2 = 0; var2 < this.mainInventory.length; ++var2) {
            if (this.mainInventory[var2] == null) continue;
        ...
        for (var2 = 0; var2 < this.armorInventory.length; ++var2) {
            if (this.armorInventory[var2] == null) continue;
            var3 = new NBTTagCompound();
    ...
    public void readFromNBT(NBTTagList p_70443_1_) {
        ...
        for (int var2 = 0; var2 < p_70443_1_.tagCount(); ++var2) {
            ...
            if (var4 < 100 || var4 >= this.armorInventory.length + 100) continue;
    ...
    public int getTotalArmorValue() {
        ...
        for (int var2 = 0; var2 < this.armorInventory.length; ++var2) {
            if (this.armorInventory[var2] == null || !(this.armorInventory[var2].getItem() instanceof ItemArmor)) continue;
    ...
    public void damageArmor(float p_70449_1_) {
        ...
        for (int var2 = 0; var2 < this.armorInventory.length; ++var2) {
            ...
            if (this.armorInventory[var2].stackSize != 0) continue;
    ...
    public void dropAllItems() {
        ...
        for (var1 = 0; var1 < this.armorInventory.length; ++var1) {
            if (this.armorInventory[var1] == null) continue;
    ...
    public boolean hasItemStack(ItemStack p_70431_1_) {
        int var2;
        for (var2 = 0; var2 < this.armorInventory.length; ++var2) {
            if (this.armorInventory[var2] == null || !this.armorInventory[var2].isItemEqual(p_70431_1_)) continue;
            return true;
        }
        for (var2 = 0; var2 < this.mainInventory.length; ++var2) {
            if (this.mainInventory[var2] == null || !this.mainInventory[var2].isItemEqual(p_70431_1_)) continue;
            return true;
        }
        return false;
    }
