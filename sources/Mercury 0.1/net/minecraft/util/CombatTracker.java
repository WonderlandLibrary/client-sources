...
public class CombatTracker {
        ...
        if (var1 != null && var2.getDamageSrc() == DamageSource.fall) {
            ...
            if (var1.getDamageSrc() != DamageSource.fall && var1.getDamageSrc() != DamageSource.outOfWorld) {
                if (!(var6 == null || var4 != null && var6.equals(var4))) {
                    ...
                    var3 = var8 != null && var8.hasDisplayName() ? new ChatComponentTranslation("death.fell.assist.item", this.fighter.getDisplayName(), var6, var8.getChatComponent()) : new ChatComponentTranslation("death.fell.assist", this.fighter.getDisplayName(), var6);
                } else if (var4 != null) {
                    ItemStack var7;
                    ItemStack itemStack = var7 = var5 instanceof EntityLivingBase ? ((EntityLivingBase)var5).getHeldItem() : null;
                    var3 = var7 != null && var7.hasDisplayName() ? new ChatComponentTranslation("death.fell.finish.item", this.fighter.getDisplayName(), var4, var7.getChatComponent()) : new ChatComponentTranslation("death.fell.finish", this.fighter.getDisplayName(), var4);
                } else {
                    var3 = new ChatComponentTranslation("death.fell.killer", this.fighter.getDisplayName());
                }
            } else {
                var3 = new ChatComponentTranslation("death.fell.accident." + this.func_94548_b(var1), this.fighter.getDisplayName());
            }
        } else {
    ...
    private CombatEntry func_94544_f() {
        ...
        for (int var5 = 0; var5 < this.combatEntries.size(); ++var5) {
            ...
            if (var6.func_94562_g() == null || var2 != null && !(var6.func_94563_c() > (float)var3)) continue;
            var2 = var6;
        }
    ...
    public void func_94549_h() {
        int var1;
        int n2 = var1 = this.field_94552_d ? 300 : 100;
