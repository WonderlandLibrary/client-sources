...
extends Iterable {
    ...
    JsonSerializer {
        ...
        public IChatComponent deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) {
            ...
            ((IChatComponent)var5).setChatStyle((ChatStyle)p_deserialize_3_.deserialize(p_deserialize_1_, (Type)((Object)ChatStyle.class)));
            return var5;
        }
        ...
        private void serializeChatStyle(ChatStyle style, JsonObject object, JsonSerializationContext ctx) {
            ...
            if (var4.isJsonObject()) {
                ...
                for (Map.Entry<String, JsonElement> var7 : var5.entrySet()) {
                    object.add(var7.getKey(), var7.getValue());
                }
            }
        }
