...
extends AbstractSet {
    ...
    public void func_180213_a(Class p_180213_1_) {
        for (Object var3 : this.field_180218_a.get(this.func_180212_a(p_180213_1_, false))) {
    ...
    protected Class func_180212_a(Class p_180212_1_, boolean p_180212_2_) {
        Class<?> var4;
        Iterator<Class<?>> var3 = ClassUtils.hierarchy(p_180212_1_, ClassUtils.Interfaces.INCLUDE).iterator();
        do {
            if (var3.hasNext()) continue;
            throw new IllegalArgumentException("Don't know how to search for " + p_180212_1_);
        } while (!this.field_180216_b.contains(var4 = var3.next()));
