...
public class DamageSource {
    ...
    public IChatComponent getDeathMessage(EntityLivingBase p_151519_1_) {
        ...
        return var2 != null && StatCollector.canTranslate(var4) ? new ChatComponentTranslation(var4, p_151519_1_.getDisplayName(), var2.getDisplayName()) : new ChatComponentTranslation(var3, p_151519_1_.getDisplayName());
    }
