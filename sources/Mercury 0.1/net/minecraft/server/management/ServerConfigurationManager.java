...
public abstract class ServerConfigurationManager {
    ...
    protected void func_96456_a(ServerScoreboard scoreboardIn, EntityPlayerMP playerIn) {
        HashSet<ScoreObjective> var3 = Sets.newHashSet();
    ...
    public void sendToAllNearExcept(EntityPlayer p_148543_1_, double x2, double y2, double z2, double radius, int dimension, Packet p_148543_11_) {
        for (int var12 = 0; var12 < this.playerEntityList.size(); ++var12) {
            ...
            if (var13 == p_148543_1_ || var13.dimension != dimension || !((var14 = x2 - var13.posX) * var14 + (var16 = y2 - var13.posY) * var16 + (var18 = z2 - var13.posZ) * var18 < radius * radius)) continue;
    ...
    public List getPlayersMatchingAddress(String address) {
        ArrayList<EntityPlayerMP> var2 = Lists.newArrayList();
