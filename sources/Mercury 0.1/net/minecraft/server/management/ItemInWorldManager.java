    ...
    public void updateBlockRemoving() {
        ...
        if (this.receivedFinishDiggingPacket) {
            ...
            if (var5.getMaterial() == Material.air) {
                ...
                float var3 = var5.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.worldObj, this.field_180241_i) * (float)(var6 + 1);
                int var4 = (int)(var3 * 10.0f);
                if (var4 != this.durabilityRemainingOnBlock) {
    ...
    public boolean func_180236_a(EntityPlayer p_180236_1_, World worldIn, ItemStack p_180236_3_, BlockPos p_180236_4_, EnumFacing p_180236_5_, float p_180236_6_, float p_180236_7_, float p_180236_8_) {
        ...
        if (this.gameType == WorldSettings.GameType.SPECTATOR) {
            ...
            if (var13 instanceof ILockableContainer) {
                ...
                ILockableContainer var15 = (ILockableContainer)((Object)var13);
                ...
                p_180236_1_.displayGUIChest((IInventory)((Object)var13));
                return true;
            }
            return false;
        }
        if ((!p_180236_1_.isSneaking() || p_180236_1_.getHeldItem() == null) && (var9 = worldIn.getBlockState(p_180236_4_)).getBlock().onBlockActivated(worldIn, p_180236_4_, var9, p_180236_1_, p_180236_5_, p_180236_6_, p_180236_7_, p_180236_8_)) {
            return true;
        }
        if (p_180236_3_ == null) {
            return false;
