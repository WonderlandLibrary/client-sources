...
public abstract class TileEntity {
    ...
    private static void addMapping(Class cl2, String id2) {
    ...
    public double getDistanceSq(double p_145835_1_, double p_145835_3_, double p_145835_5_) {
        double var7 = (double)this.pos.getX() + 0.5 - p_145835_1_;
        double var9 = (double)this.pos.getY() + 0.5 - p_145835_3_;
        double var11 = (double)this.pos.getZ() + 0.5 - p_145835_5_;
