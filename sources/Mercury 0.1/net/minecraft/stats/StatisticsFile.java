...
extends StatFileWriter {
    ...
    public void func_150883_b() {
        try {
            FileUtils.writeStringToFile(this.field_150887_d, StatisticsFile.func_150880_a(this.field_150875_a));
        }
        catch (IOException var2) {
    ...
    public Map func_150881_a(String p_150881_1_) {
        ...
        HashMap<StatBase, TupleIntJsonSerializable> var4 = Maps.newHashMap();
        for (Map.Entry<String, JsonElement> var6 : var3.entrySet()) {
            StatBase var7 = StatList.getOneShotStat(var6.getKey());
            if (var7 != null) {
                ...
                if (var6.getValue().isJsonPrimitive() && var6.getValue().getAsJsonPrimitive().isNumber()) {
                    ...
                    JsonObject var9 = var6.getValue().getAsJsonObject();
    ...
    public static String func_150880_a(Map p_150880_0_) {
        ...
        for (Map.Entry var3 : p_150880_0_.entrySet()) {
            if (((TupleIntJsonSerializable)var3.getValue()).getJsonSerializableValue() != null) {
                ...
                var4.addProperty("value", ((TupleIntJsonSerializable)var3.getValue()).getIntegerValue());
                try {
    ...
    public void func_150876_a(EntityPlayerMP p_150876_1_) {
        ...
        HashMap<StatBase, Integer> var3 = Maps.newHashMap();
    ...
    public void func_150884_b(EntityPlayerMP p_150884_1_) {
        HashMap<Achievement, Integer> var2 = Maps.newHashMap();
