...
public class StatBase {
    ...
    public static IStatType timeStatType = new IStatType(){
        ...
        @Override
        public String format(int p_75843_1_) {
            double var2 = (double)p_75843_1_ / 20.0;
    ...
    public static IStatType distanceStatType = new IStatType(){
        ...
        @Override
        public String format(int p_75843_1_) {
            double var2 = (double)p_75843_1_ / 100.0;
            double var4 = var2 / 1000.0;
            return var4 > 0.5 ? String.valueOf(decimalFormat.format(var4)) + " km" : (var2 > 0.5 ? String.valueOf(decimalFormat.format(var2)) + " m" : String.valueOf(p_75843_1_) + " cm");
        }
    };
