...
public class CompressedStreamTools {
    ...
    public static NBTTagCompound readCompressed(InputStream p_74796_0_) throws IOException {
        NBTTagCompound var2;
        try (DataInputStream var1 = new DataInputStream(new BufferedInputStream(new GZIPInputStream(p_74796_0_)));){
    ...
    public static void safeWrite(NBTTagCompound p_74793_0_, File p_74793_1_) throws IOException {
        File var2 = new File(String.valueOf(p_74793_1_.getAbsolutePath()) + "_tmp");
        if (var2.exists()) {
            var2.delete();
        }
    ...
    public static NBTTagCompound read(File p_74797_0_) throws IOException {
        ...
        try (DataInputStream var1 = new DataInputStream(new FileInputStream(p_74797_0_));){
            var2 = CompressedStreamTools.func_152456_a(var1, NBTSizeTracker.INFINITE);
        }
        return var2;
    }
