...
extends NBTBase {
    ...
    private CrashReport createCrashReport(final String key, final int expectedType, ClassCastException ex2) {
        CrashReport var4 = CrashReport.makeCrashReport(ex2, "Reading NBT data");
    ...
    static NBTBase readNBT(byte id2, String key, DataInput input, int depth, NBTSizeTracker sizeTracker) {
        NBTBase var5 = NBTBase.createNewByType(id2);
        try {
            ...
            var8.addCrashSection("Tag type", id2);
