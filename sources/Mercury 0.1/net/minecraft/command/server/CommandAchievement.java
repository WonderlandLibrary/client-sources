        ...
        if (var5 || var6) {
            if (var3 == null) {
                if (var5) {
                    ...
                    for (Achievement var12 : Lists.reverse(AchievementList.achievementList)) {
                ...
                if (var3 instanceof Achievement) {
                    ...
                    if (var5) {
                        ...
                        ArrayList<Achievement> var8 = Lists.newArrayList();
                        ...
                        for (Achievement var10 : Lists.reverse(var8)) {
                        ...
                        ArrayList<Achievement> var8 = Lists.newArrayList(Iterators.filter(AchievementList.achievementList.iterator(), new Predicate(){
