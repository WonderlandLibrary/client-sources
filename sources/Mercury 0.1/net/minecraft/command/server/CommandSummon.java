...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args.length >= 4) {
            var6 = CommandSummon.func_175761_b(var6, args[1], true);
            var8 = CommandSummon.func_175761_b(var8, args[2], false);
            var10 = CommandSummon.func_175761_b(var10, args[3], true);
            var4 = new BlockPos(var6, var8, var10);
        }
        if (!(var12 = sender.getEntityWorld()).isBlockLoaded(var4)) {
        ...
        if ("LightningBolt".equals(var3)) {
            ...
            boolean var14 = false;
            if (args.length >= 5) {
                IChatComponent var15 = CommandSummon.getChatComponentFromNthArg(sender, args, 4);
                try {
            ...
            if (!var14 && var21 instanceof EntityLiving) {
                ((EntityLiving)var21).func_180482_a(var12.getDifficultyForLocation(new BlockPos(var21)), null);
            }
            var12.spawnEntityInWorld(var21);
            Entity var16 = var21;
            NBTTagCompound var17 = var13;
            while (var16 != null && var17.hasKey("Riding", 10)) {
                ...
                var16 = var18;
                var17 = var17.getCompoundTag("Riding");
            }
            CommandSummon.notifyOperators(sender, (ICommand)this, "commands.summon.success", new Object[0]);
        }
    }
    ...
    public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos) {
        return args.length == 1 ? CommandSummon.func_175762_a(args, EntityList.func_180124_b()) : (args.length > 1 && args.length <= 4 ? CommandSummon.func_175771_a(args, 1, pos) : null);
    }
}
