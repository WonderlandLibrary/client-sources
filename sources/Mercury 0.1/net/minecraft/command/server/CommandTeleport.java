...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        if (args.length != 2 && args.length != 4 && args.length != 6) {
            var4 = CommandTeleport.getCommandSenderAsPlayer(sender);
        } else {
            var4 = CommandTeleport.func_175768_b(sender, args[0]);
            var3 = 1;
        }
        if (args.length != 1 && args.length != 2) {
            ...
            if (var4.worldObj != null) {
                int var14 = var3 + 1;
                CommandBase.CoordinateArg var6 = CommandTeleport.func_175770_a(var4.posX, args[var3], true);
                CommandBase.CoordinateArg var7 = CommandTeleport.func_175767_a(var4.posY, args[var14++], 0, 0, false);
                CommandBase.CoordinateArg var8 = CommandTeleport.func_175770_a(var4.posZ, args[var14++], true);
                CommandBase.CoordinateArg var9 = CommandTeleport.func_175770_a(var4.rotationYaw, args.length > var14 ? args[var14++] : "~", false);
                CommandBase.CoordinateArg var10 = CommandTeleport.func_175770_a(var4.rotationPitch, args.length > var14 ? args[var14] : "~", false);
                if (var4 instanceof EntityPlayerMP) {
                    EnumSet<S08PacketPlayerPosLook.EnumFlags> var11 = EnumSet.noneOf(S08PacketPlayerPosLook.EnumFlags.class);
                ...
                CommandTeleport.notifyOperators(sender, (ICommand)this, "commands.tp.success.coordinates", var4.getName(), var6.func_179628_a(), var7.func_179628_a(), var8.func_179628_a());
            }
        } else {
            Entity var5 = CommandTeleport.func_175768_b(sender, args[args.length - 1]);
            ...
            CommandTeleport.notifyOperators(sender, (ICommand)this, "commands.tp.success", var4.getName(), var5.getName());
        }
    }
