...
implements ICommand {
    ...
    public static List func_175763_c(ICommandSender p_175763_0_, String p_175763_1_) throws EntityNotFoundException {
        return PlayerSelector.hasArguments(p_175763_1_) ? PlayerSelector.func_179656_b(p_175763_0_, p_175763_1_, Entity.class) : Lists.newArrayList(CommandBase.func_175768_b(p_175763_0_, p_175763_1_));
    }
    ...
    public static Item getItemByText(ICommandSender sender, String id2) throws NumberInvalidException {
        ResourceLocation var2 = new ResourceLocation(id2);
    ...
    public static Block getBlockByText(ICommandSender sender, String id2) throws NumberInvalidException {
        ResourceLocation var2 = new ResourceLocation(id2);
    ...
    public static List func_175762_a(String[] p_175762_0_, Collection p_175762_1_) {
        ...
        if (!p_175762_1_.isEmpty()) {
            for (String var5 : Iterables.transform(p_175762_1_, Functions.toStringFunction())) {
                if (!CommandBase.doesStringStartWith(var2, var5)) continue;
                var3.add(var5);
            }
            if (var3.isEmpty()) {
                for (String var6 : p_175762_1_) {
                    if (!(var6 instanceof ResourceLocation) || !CommandBase.doesStringStartWith(var2, ((ResourceLocation)((Object)var6)).getResourcePath())) continue;
