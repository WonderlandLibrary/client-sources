...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        ArrayList<EntityPlayerMP> var14 = Lists.newArrayList();
    ...
    private int func_110667_a(List p_110667_1_) {
        HashSet<Team> var2 = Sets.newHashSet();
    ...
    private int func_110668_a(Position p_110668_1_, double p_110668_2_, World worldIn, Random p_110668_5_, double p_110668_6_, double p_110668_8_, double p_110668_10_, double p_110668_12_, Position[] p_110668_14_, boolean p_110668_15_) throws CommandException {
        ...
        for (var17 = 0; var17 < 10000 && var16; ++var17) {
            ...
            for (int var20 = 0; var20 < p_110668_14_.length; ++var20) {
                ...
                if (!var21.func_111093_a(p_110668_6_, p_110668_8_, p_110668_10_, p_110668_12_)) continue;
                var16 = true;
            }
            if (var16) continue;
            ...
            for (var22 = 0; var22 < var29; ++var22) {
                var23 = var28[var22];
                if (var23.func_111098_b(worldIn)) continue;
    ...
    private double func_110671_a(List p_110671_1_, World worldIn, Position[] p_110671_3_, boolean p_110671_4_) {
        double var5 = 0.0;
        int var7 = 0;
        HashMap<Team, Position> var8 = Maps.newHashMap();
        for (int var9 = 0; var9 < p_110671_1_.size(); ++var9) {
            ...
            for (int var14 = 0; var14 < p_110671_3_.length; ++var14) {
                if (var11 == p_110671_3_[var14]) continue;
