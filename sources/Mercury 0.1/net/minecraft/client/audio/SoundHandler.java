...
IUpdatePlayerListBox {
    ...
    private static final Gson field_147699_c = new GsonBuilder().registerTypeAdapter((Type)((Object)SoundList.class), new SoundListSerializer()).create();
    ...
    private void loadSoundResource(ResourceLocation p_147693_1_, SoundList p_147693_2_) {
        ...
        boolean var4;
        boolean bl2 = var4 = !this.sndRegistry.containsKey(p_147693_1_);
            ...
            switch (SwitchType.field_148765_a[var6.getSoundEntryType().ordinal()]) {
                case 1: {
                    ...
                    try {
                        ...
                        logger.warn("File {} does not exist, cannot add it to event {}", var11, p_147693_1_);
    ...
    public SoundEventAccessorComposite getRandomSoundFromCategories(SoundCategory ... p_147686_1_) {
        ...
        for (ResourceLocation var4 : this.sndRegistry.getKeys()) {
            ...
            if (!ArrayUtils.contains((Object[])p_147686_1_, (Object)var5.getSoundCategory())) continue;
            var2.add(var5);
        }
        if (var2.isEmpty()) {
            return null;
