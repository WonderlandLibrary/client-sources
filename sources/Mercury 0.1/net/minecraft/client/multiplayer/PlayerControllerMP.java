...
public class PlayerControllerMP {
    ...
    public static void func_178891_a(Minecraft mcIn, PlayerControllerMP p_178891_1_, BlockPos p_178891_2_, EnumFacing p_178891_3_) {
        if (!mcIn.theWorld.func_175719_a(Minecraft.thePlayer, p_178891_2_, p_178891_3_)) {
    ...
    public boolean func_178888_a(BlockPos p_178888_1_, EnumFacing p_178888_2_) {
        ...
        if (!this.currentGameType.isCreative() && (var7 = Minecraft.thePlayer.getCurrentEquippedItem()) != null) {
    ...
    public boolean func_180511_b(BlockPos p_180511_1_, EnumFacing p_180511_2_) {
        ...
        if (this.currentGameType.isCreative()) {
            ...
            this.netClientHandler.addToSendQueue(new C07PacketPlayerDigging(C07PacketPlayerDigging.Action.START_DESTROY_BLOCK, p_180511_1_, p_180511_2_));
            var3 = this.mc.theWorld.getBlockState(p_180511_1_).getBlock();
            boolean bl2 = var5 = var3.getMaterial() != Material.air;
            if (var5 && this.curBlockDamageMP == 0.0f) {
                var3.onBlockClicked(this.mc.theWorld, p_180511_1_, Minecraft.thePlayer);
            }
            if (var5 && var3.getPlayerRelativeBlockHardness(Minecraft.thePlayer, Minecraft.thePlayer.worldObj, p_180511_1_) >= 1.0f) {
                ...
                this.mc.theWorld.sendBlockBreakProgress(Minecraft.thePlayer.getEntityId(), this.field_178895_c, (int)(this.curBlockDamageMP * 10.0f) - 1);
            }
        }
        return true;
    }
    ...
    public void resetBlockRemoving() {
        if (this.isHittingBlock) {
            ...
            this.curBlockDamageMP = 0.0f;
            this.mc.theWorld.sendBlockBreakProgress(Minecraft.thePlayer.getEntityId(), this.field_178895_c, -1);
        }
    }
    ...
    public boolean func_180512_c(BlockPos p_180512_1_, EnumFacing p_180512_2_) {
        ...
        if (this.func_178893_a(p_180512_1_)) {
            ...
            this.curBlockDamageMP += var3.getPlayerRelativeBlockHardness(Minecraft.thePlayer, Minecraft.thePlayer.worldObj, p_180512_1_);
    ...
    private boolean func_178893_a(BlockPos p_178893_1_) {
        ...
        boolean bl2 = var3 = this.currentItemHittingBlock == null && var2 == null;
        if (this.currentItemHittingBlock != null && var2 != null) {
            boolean bl3 = var3 = var2.getItem() == this.currentItemHittingBlock.getItem() && ItemStack.areItemStackTagsEqual(var2, this.currentItemHittingBlock) && (var2.isItemStackDamageable() || var2.getMetadata() == this.currentItemHittingBlock.getMetadata());
        }
