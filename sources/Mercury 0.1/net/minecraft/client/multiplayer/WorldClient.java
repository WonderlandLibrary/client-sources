...
extends World {
    ...
    public void playSound(double x2, double y2, double z2, String soundName, float volume, float pitch, boolean distanceDelay) {
        double var11 = this.mc.func_175606_aa().getDistanceSq(x2, y2, z2);
        PositionedSoundRecord var13 = new PositionedSoundRecord(new ResourceLocation(soundName), volume, pitch, (float)x2, (float)y2, (float)z2);
    ...
    public void makeFireworks(double x2, double y2, double z2, double motionX, double motionY, double motionZ, NBTTagCompound compund) {
        this.mc.effectRenderer.addEffect(new EntityFireworkStarterFX(this, x2, y2, z2, motionX, motionY, motionZ, this.mc.effectRenderer, compund));
    }
