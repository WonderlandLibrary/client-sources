...
public class EffectRenderer {
    ...
    public void addEffect(EntityFX p_78873_1_) {
        if (p_78873_1_ != null && (!(p_78873_1_ instanceof EntityFireworkSparkFX) || Config.isFireworkParticles())) {
            ...
            int n2 = var3 = p_78873_1_.func_174838_j() != 1.0f ? 0 : 1;
    ...
    public void updateEffects() {
        ...
        ArrayList<EntityParticleEmitter> var41 = Lists.newArrayList();
    ...
    private void func_178925_a(List p_178925_1_) {
        ArrayList<EntityFX> var2 = Lists.newArrayList();
    ...
    private boolean reuseBarrierParticle(EntityFX entityfx, List<EntityFX> list) {
        EntityFX efx;
        Iterator<EntityFX> it2 = list.iterator();
        do {
            if (it2.hasNext()) continue;
            return false;
        } while (!((efx = it2.next()) instanceof Barrier) || entityfx.posX != efx.posX || entityfx.posY != efx.posY || entityfx.posZ != efx.posZ);
        efx.particleAge = 0;
        return true;
    }
