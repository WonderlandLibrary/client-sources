...
extends ModelBase {
    ...
    public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
        ...
        boolean bl2 = var16 = var8.riddenByEntity != null;
        if (var12) {
    ...
    public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_) {
        ...
        this.backLeftHoof.rotateAngleX = this.backLeftShin.rotateAngleX = -0.08726646f * var12 + (-var19 * 0.5f * p_78086_3_ - Math.max(0.0f, var19 * 0.5f * p_78086_3_)) * var13;
        this.backRightLeg.rotateAngleX = var24 + var19 * 0.5f * p_78086_3_ * var13;
        this.backRightHoof.rotateAngleX = this.backRightShin.rotateAngleX = -0.08726646f * var12 + (var19 * 0.5f * p_78086_3_ - Math.max(0.0f, -var19 * 0.5f * p_78086_3_)) * var13;
        this.frontLeftLeg.rotateAngleX = var26;
        this.frontLeftHoof.rotateAngleX = this.frontLeftShin.rotateAngleX = (this.frontLeftLeg.rotateAngleX + 3.1415927f * Math.max(0.0f, 0.2f + var25 * 0.2f)) * var12 + (var20 + Math.max(0.0f, var19 * 0.5f * p_78086_3_)) * var13;
        this.frontRightLeg.rotateAngleX = var27;
        this.frontRightHoof.rotateAngleX = this.frontRightShin.rotateAngleX = (this.frontRightLeg.rotateAngleX + 3.1415927f * Math.max(0.0f, 0.2f - var25 * 0.2f)) * var12 + (-var20 + Math.max(0.0f, -var19 * 0.5f * p_78086_3_)) * var13;
        ...
        if ((var21 = -1.3089f + p_78086_3_ * 1.5f) > 0.0f) {
            var21 = 0.0f;
        }
        if (var15) {
