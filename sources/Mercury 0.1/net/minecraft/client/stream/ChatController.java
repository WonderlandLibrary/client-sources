...
public class ChatController {
    ...
    public void func_152997_n() {
        ErrorCode var1;
        if (this.field_153011_i != ChatState.Uninitialized && ErrorCode.failed(var1 = this.field_153008_f.flushEvents())) {
            String var2 = ErrorCode.getString(var1);
    ...
    protected void func_153001_r() {
        ErrorCode var1;
        if (this.field_175995_l != EnumEmoticonMode.None && this.field_175996_m == null && ErrorCode.failed(var1 = this.field_153008_f.downloadEmoticonData())) {
            String var2 = ErrorCode.getString(var1);
    ...
    implements IChatChannelListener {
        ...
        public boolean func_176038_a(boolean p_176038_1_) {
            ...
            var2 = p_176038_1_ ? ChatController.this.field_153008_f.connectAnonymous(this.field_176048_a, this) : ChatController.this.field_153008_f.connect(this.field_176048_a, ChatController.this.field_153004_b, ChatController.this.field_153012_j.data, this);
            if (ErrorCode.failed(var2)) {
                String var3 = ErrorCode.getString(var2);
        ...
        protected void func_176041_h() {
            ErrorCode var1;
            if (ChatController.this.field_175995_l != EnumEmoticonMode.None && this.field_176043_g == null && ErrorCode.failed(var1 = ChatController.this.field_153008_f.downloadBadgeData(this.field_176048_a))) {
                String var2 = ErrorCode.getString(var1);
    ...
    public static enum ChatState {
        ...
        private ChatState(String stateName, int id2) {
        }
    }
