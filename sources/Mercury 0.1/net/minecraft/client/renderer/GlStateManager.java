...
public class GlStateManager {
    ...
    public static void func_179105_a(TexGen p_179105_0_, int p_179105_1_, FloatBuffer p_179105_2_) {
        GL11.glTexGen(GlStateManager.texGenCoord((TexGen)p_179105_0_).field_179065_b, p_179105_1_, p_179105_2_);
    }
    ...
    public static void checkBoundTexture() {
        if (Config.isMinecraftThread()) {
            ...
            int act2 = GlStateManager.getActiveTextureUnit();
            int tex = GlStateManager.getBoundTexture();
            if (tex > 0 && (glAct != act2 || glTex != tex)) {
                Config.dbg("checkTexture: act: " + act2 + ", glAct: " + glAct + ", tex: " + tex + ", glTex: " + glTex);
            }
        }
    }
