...
extends TextureAtlasSprite {
    ...
    public void updateAnimation() {
        ...
        if (var1.theWorld != null && Minecraft.thePlayer != null) {
            this.updateCompass(var1.theWorld, Minecraft.thePlayer.posX, Minecraft.thePlayer.posZ, Minecraft.thePlayer.rotationYaw, false, false);
        } else {
    ...
    public void updateCompass(World worldIn, double p_94241_2_, double p_94241_4_, double p_94241_6_, boolean p_94241_8_, boolean p_94241_9_) {
        if (!this.framesTextureData.isEmpty()) {
            ...
            if (p_94241_9_) {
                ...
                double var181;
                for (var181 = var10 - this.currentAngle; var181 < -3.141592653589793; var181 += 6.283185307179586) {
                }
