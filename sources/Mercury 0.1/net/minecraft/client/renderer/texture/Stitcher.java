...
public class Stitcher {
    ...
    public List getStichSlots() {
        ArrayList<Slot> var1 = Lists.newArrayList();
        for (Slot var7 : this.stitchSlots) {
            var7.getAllStitchSlots(var1);
        }
        ArrayList<TextureAtlasSprite> var71 = Lists.newArrayList();
        for (Slot var4 : var1) {
    ...
    private boolean expandAndAllocateSlot(Holder p_94311_1_) {
        ...
        boolean bl2 = var3 = this.currentWidth == 0 && this.currentHeight == 0;
        if (this.forcePowerOf2) {
            boolean var12;
            boolean var10;
            ...
            boolean bl3 = var10 = var8 <= this.maxHeight;
            if (!var9 && !var10) {
                return false;
            }
            boolean var11 = var5 != var14;
            boolean bl4 = var12 = var15 != var8;
            var4 = var11 ^ var12 ? !var11 : var9 && var5 <= var15;
        } else {
            boolean var141;
            boolean var151 = this.currentWidth + var2 <= this.maxWidth;
            boolean bl5 = var141 = this.currentHeight + var2 <= this.maxHeight;
            if (!var151 && !var141) {
                return false;
            }
