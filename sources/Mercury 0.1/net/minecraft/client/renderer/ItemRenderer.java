            ...
            if (this.itemToRender.getItem() instanceof ItemMap) {
                ...
                switch (SwitchEnumAction.field_178094_a[var7.ordinal()]) {
                    ...
                    case 4: {
                        ...
                        this.func_178096_b(0.0f, var4 / 33.0f);
                        this.func_178103_d();
                        break;
                    }
                    case 5: {
    ...
    public void renderOverlays(float p_78447_1_) {
        ...
        if (Minecraft.thePlayer.isEntityInsideOpaqueBlock()) {
            ...
            if (var2.getBlock().getRenderType() != -1) {
                ...
                if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderBlockOverlay, Minecraft.thePlayer, Float.valueOf(p_78447_1_), var13, var2, blockPos)) {
        ...
        if (!Minecraft.thePlayer.func_175149_v()) {
            if (Minecraft.thePlayer.isInsideOfMaterial(Material.water)) {
                if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderWaterOverlay, Minecraft.thePlayer, Float.valueOf(p_78447_1_))) {
                    this.renderWaterOverlayTexture(p_78447_1_);
                }
            }
            if (Minecraft.thePlayer.isBurning()) {
                if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, Minecraft.thePlayer, Float.valueOf(p_78447_1_))) {
