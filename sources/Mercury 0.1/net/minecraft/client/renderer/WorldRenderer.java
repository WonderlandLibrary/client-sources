...
public class WorldRenderer {
    ...
    public void addVertex(double p_178984_1_, double p_178984_3_, double p_178984_5_) {
        ...
        block6 : for (int i2 = 0; i2 < listSize; ++i2) {
            VertexFormatElement var9 = (VertexFormatElement)var7.get(i2);
    ...
    public void drawMultiTexture() {
        if (this.quadSprites != null) {
            ...
            for (int i2 = 0; i2 < countQuads; ++i2) {
                int iconIndex;
                TextureAtlasSprite icon = this.quadSprites[i2];
    ...
    private int drawForIcon(TextureAtlasSprite sprite, int startQuadPos) {
        ...
        for (int i2 = startQuadPos; i2 < countQuads; ++i2) {
            TextureAtlasSprite ts2 = this.quadSprites[i2];
            if (ts2 == sprite) {
