...
public class RenderChunk {
    ...
    public void func_178576_a(BlockPos p_178576_1_) {
        ...
        this.func_178567_n();
        for (int i2 = 0; i2 < this.positionOffsets16.length; ++i2) {
            this.positionOffsets16[i2] = null;
        }
    }
    ...
    public void func_178581_b(float p_178581_1_, float p_178581_2_, float p_178581_3_, ChunkCompileTaskGenerator p_178581_4_) {
        ...
        block20 : {
            block19 : {
                ...
                try {
                    ...
                    if (this.field_178588_d == null) break block19;
        ...
        if (!var9.extendedLevelsInChunkCache()) {
            ...
            while (var11.hasNext()) {
                ...
                for (int i2 = 0; i2 < var28.length; ++i2) {
                    EnumWorldBlockLayer var24 = var28[i2];
                    if (forgeBlockCanRenderInLayerExists) {
                    ...
                    if (var22.getRenderType() == -1) continue;
                    ...
                    if (!Minecraft.getMinecraft().getBlockRendererDispatcher().func_175018_a(var21, var20, var9, var17)) continue;
                    var5.func_178486_a(var24);
                }
            }
            for (EnumWorldBlockLayer var29 : ENUM_WORLD_BLOCK_LAYERS) {
                if (!var5.func_178492_d(var29)) continue;
                if (Config.isShaders()) {
    ...
    public void func_178566_a() {
        ...
        for (int var1 = 0; var1 < EnumWorldBlockLayer.values().length; ++var1) {
            if (this.field_178594_l[var1] == null) continue;
    ...
    protected RegionRenderCache createRegionRenderCache(World world, BlockPos from, BlockPos to2, int subtract) {
        return new RegionRenderCache(world, from, to2, subtract);
    }
