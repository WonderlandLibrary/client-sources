...
extends Render {
    ...
    public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
        block20 : {
            block19 : {
                if (!Reflector.RenderLivingEvent_Pre_Constructor.exists()) break block19;
                if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, p_76986_1_, this, p_76986_2_, p_76986_4_, p_76986_6_)) break block20;
            }
            ...
            try {
                ...
                if (p_76986_1_ instanceof EntityPlayerSP) {
                    var19 = this.interpolateRotation(((EntityPlayerSP)p_76986_1_).oldYaw, ((EntityPlayerSP)p_76986_1_).oldYaw, p_76986_9_);
                    var11 = this.interpolateRotation(((EntityPlayerSP)p_76986_1_).oldYaw, ((EntityPlayerSP)p_76986_1_).oldYaw, p_76986_9_);
                }
    ...
    protected boolean func_177092_a(EntityLivingBase p_177092_1_, float p_177092_2_, boolean p_177092_3_) {
        ...
        boolean bl2 = var7 = p_177092_1_.hurtTime > 0 || p_177092_1_.deathTime > 0;
        if (!var6 && !var7) {
            return false;
        }
        if (!var6 && !p_177092_3_) {
    ...
    public void passSpecialRender(EntityLivingBase p_77033_1_, double p_77033_2_, double p_77033_4_, double p_77033_6_) {
        block10 : {
            ...
            if (this.canRenderName(p_77033_1_)) {
                ...
                float f2 = var10 = p_77033_1_.isSneaking() ? NAME_TAG_RANGE_SNEAK : NAME_TAG_RANGE;
