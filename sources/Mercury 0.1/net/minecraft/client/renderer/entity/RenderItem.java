...
implements IResourceManagerReloadListener {
    ...
    public RenderItem(TextureManager p_i46165_1_, ModelManager p_i46165_2_) {
        ...
        this.itemModelMesher = Reflector.ItemModelMesherForge_Constructor.exists() ? (ItemModelMesher)Reflector.newInstance(Reflector.ItemModelMesherForge_Constructor, p_i46165_2_) : new ItemModelMesher(p_i46165_2_);
        this.registerItems();
    }
    ...
    private void func_175045_a(IBakedModel p_175045_1_, int p_175045_2_, ItemStack p_175045_3_) {
        ...
        boolean bl2 = multiTexture = Config.isMultiTexture() && renderTextureMap;
        if (multiTexture) {
    ...
    private void func_175033_a(WorldRenderer p_175033_1_, BakedQuad p_175033_2_, int p_175033_3_) {
        ...
        if (Reflector.IColoredBakedQuad.exists() && Reflector.IColoredBakedQuad.isInstance(p_175033_2_)) {
            RenderItem.forgeHooksClient_putQuadColor(p_175033_1_, p_175033_2_, p_175033_3_);
        } else {
    ...
    protected void func_175034_a(ItemTransformVec3f p_175034_1_) {
        RenderItem.applyVanillaTransform(p_175034_1_);
    }
    ...
    public void func_180453_a(FontRenderer p_180453_1_, ItemStack p_180453_2_, int p_180453_3_, int p_180453_4_, String p_180453_5_) {
        if (p_180453_2_ != null) {
            if (p_180453_2_.stackSize != 1 || p_180453_5_ != null) {
                String itemDamaged;
                String string = itemDamaged = p_180453_5_ == null ? String.valueOf(p_180453_2_.stackSize) : p_180453_5_;
                if (p_180453_5_ == null && p_180453_2_.stackSize < 1) {
                    itemDamaged = (Object)((Object)EnumChatFormatting.RED) + String.valueOf(p_180453_2_.stackSize);
                }
                GlStateManager.disableLighting();
            ...
            if (Reflector.ForgeItem_showDurabilityBar.exists()) {
                itemDamaged1 = Reflector.callBoolean(p_180453_2_.getItem(), Reflector.ForgeItem_showDurabilityBar, p_180453_2_);
            }
            if (itemDamaged1) {
                ...
                if (Reflector.ForgeItem_getDurabilityForDisplay.exists()) {
                    double var8 = Reflector.callDouble(p_180453_2_.getItem(), Reflector.ForgeItem_getDurabilityForDisplay, p_180453_2_);
                    var12 = (int)Math.round(13.0 - var8 * 13.0);
                    var7 = (int)Math.round(255.0 - var8 * 255.0);
                }
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
    ...
    public static void forgeHooksClient_putQuadColor(WorldRenderer renderer, BakedQuad quad, int color) {
        float cr2 = color & 255;
        float cg = color >>> 8 & 255;
        float cb2 = color >>> 16 & 255;
        float ca2 = color >>> 24 & 255;
        int[] vd2 = quad.func_178209_a();
        int step = vd2.length / 4;
        for (int i2 = 0; i2 < 4; ++i2) {
            int vc2 = vd2[3 + step * i2];
            float vcr = vc2 & 255;
            float vcg = vc2 >>> 8 & 255;
            float vcb = vc2 >>> 16 & 255;
            float vca = vc2 >>> 24 & 255;
            int ncr = Math.min(255, (int)(cr2 * vcr / 255.0f));
            int ncg = Math.min(255, (int)(cg * vcg / 255.0f));
            int ncb = Math.min(255, (int)(cb2 * vcb / 255.0f));
            int nca = Math.min(255, (int)(ca2 * vca / 255.0f));
            renderer.func_178972_a(renderer.getGLCallListForPass(4 - i2), ncr, ncg, ncb, nca);
        }
    }
