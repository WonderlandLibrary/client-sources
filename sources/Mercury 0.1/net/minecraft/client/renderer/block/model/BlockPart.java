...
public class BlockPart {
    ...
    private void func_178235_a() {
        for (Map.Entry var2 : this.field_178240_c.entrySet()) {
    ...
    implements JsonDeserializer {
        ...
        private Map func_178253_b(JsonDeserializationContext p_178253_1_, JsonObject p_178253_2_) {
            EnumMap<EnumFacing, BlockPartFace> var3 = Maps.newEnumMap(EnumFacing.class);
            JsonObject var4 = JsonUtils.getJsonObject(p_178253_2_, "faces");
            for (Map.Entry<String, JsonElement> var6 : var4.entrySet()) {
                EnumFacing var7 = this.func_178248_a(var6.getKey());
                var3.put(var7, (BlockPartFace)p_178253_1_.deserialize(var6.getValue(), (Type)((Object)BlockPartFace.class)));
            }
            return var3;
        }
        ...
        private Vector3f func_178251_a(JsonObject p_178251_1_, String p_178251_2_) {
            ...
            for (int var5 = 0; var5 < var4.length; ++var5) {
                var4[var5] = JsonUtils.getJsonElementFloatValue(var3.get(var5), String.valueOf(p_178251_2_) + "[" + var5 + "]");
            }
