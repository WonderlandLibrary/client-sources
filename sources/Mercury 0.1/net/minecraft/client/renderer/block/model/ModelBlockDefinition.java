...
public class ModelBlockDefinition {
    static final Gson field_178333_a = new GsonBuilder().registerTypeAdapter((Type)((Object)ModelBlockDefinition.class), new Deserializer()).registerTypeAdapter((Type)((Object)Variant.class), new Variant.Deserializer()).create();
    ...
    implements JsonDeserializer {
        ...
        protected List func_178334_a(JsonDeserializationContext p_178334_1_, JsonObject p_178334_2_) {
            ...
            ArrayList<Variants> var4 = Lists.newArrayList();
        ...
        protected Variants func_178335_a(JsonDeserializationContext p_178335_1_, Map.Entry p_178335_2_) {
            ...
            ArrayList<Variant> var4 = Lists.newArrayList();
            JsonElement var5 = (JsonElement)p_178335_2_.getValue();
            if (var5.isJsonArray()) {
                for (JsonElement var7 : var5.getAsJsonArray()) {
                    var4.add((Variant)p_178335_1_.deserialize(var7, (Type)((Object)Variant.class)));
                }
            } else {
                var4.add((Variant)p_178335_1_.deserialize(var5, (Type)((Object)Variant.class)));
            }
