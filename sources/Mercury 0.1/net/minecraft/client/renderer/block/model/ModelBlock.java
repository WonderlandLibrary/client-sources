...
public class ModelBlock {
    ...
    public static void func_178312_b(Map p_178312_0_) {
        for (ModelBlock var2 : p_178312_0_.values()) {
            try {
                ModelBlock var3 = var2.parent;
                ModelBlock var4 = var3.parent;
                while (var3 != var4) {
                    var3 = var3.parent;
                    var4 = var4.parent.parent;
                }
    ...
    implements JsonDeserializer {
        ...
        public ModelBlock func_178327_a(JsonElement p_178327_1_, Type p_178327_2_, JsonDeserializationContext p_178327_3_) {
            ...
            if (var4.has("display")) {
                ...
                var11 = (ItemCameraTransforms)p_178327_3_.deserialize(var12, (Type)((Object)ItemCameraTransforms.class));
            }
        ...
        protected List getModelElements(JsonDeserializationContext p_178325_1_, JsonObject p_178325_2_) {
            ArrayList<BlockPart> var3 = Lists.newArrayList();
            if (p_178325_2_.has("elements")) {
                for (JsonElement var5 : JsonUtils.getJsonObjectJsonArrayField(p_178325_2_, "elements")) {
                    var3.add((BlockPart)p_178325_1_.deserialize(var5, (Type)((Object)BlockPart.class)));
                }
            }
            return var3;
        }
