...
public class ItemCameraTransforms {
    ...
    implements JsonDeserializer {
        ...
        public ItemCameraTransforms func_178352_a(JsonElement p_178352_1_, Type p_178352_2_, JsonDeserializationContext p_178352_3_) {
            ...
            if (var4.has("thirdperson")) {
                var5 = (ItemTransformVec3f)p_178352_3_.deserialize(var4.get("thirdperson"), (Type)((Object)ItemTransformVec3f.class));
            }
            if (var4.has("firstperson")) {
                var6 = (ItemTransformVec3f)p_178352_3_.deserialize(var4.get("firstperson"), (Type)((Object)ItemTransformVec3f.class));
            }
            if (var4.has("head")) {
                var7 = (ItemTransformVec3f)p_178352_3_.deserialize(var4.get("head"), (Type)((Object)ItemTransformVec3f.class));
            }
            if (var4.has("gui")) {
                var8 = (ItemTransformVec3f)p_178352_3_.deserialize(var4.get("gui"), (Type)((Object)ItemTransformVec3f.class));
            }
    ...
    public static enum TransformType {
        ...
        static {
            $VALUES = new TransformType[]{NONE, THIRD_PERSON, FIRST_PERSON, HEAD, GUI};
        }
