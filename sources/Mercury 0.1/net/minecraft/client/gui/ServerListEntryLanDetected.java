...
implements GuiListExtended.IGuiListEntry {
    ...
    public void drawEntry(int slotIndex, int x2, int y2, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
        this.field_148293_a.fontRendererObj.drawString(I18n.format("lanServer.title", new Object[0]), x2 + 32 + 3, y2 + 1, 16777215);
        this.field_148293_a.fontRendererObj.drawString(this.field_148291_b.getServerMotd(), x2 + 32 + 3, y2 + 12, 8421504);
        if (this.field_148293_a.gameSettings.hideServerAddress) {
            this.field_148293_a.fontRendererObj.drawString(I18n.format("selectServer.hiddenAddress", new Object[0]), x2 + 32 + 3, y2 + 12 + 11, 3158064);
        } else {
            this.field_148293_a.fontRendererObj.drawString(this.field_148291_b.getServerIpPort(), x2 + 32 + 3, y2 + 12 + 11, 3158064);
        }
    }
