...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiFlatPresets.drawString(this.fontRendererObj, this.field_146439_i, 50, 30, 10526880);
        GuiFlatPresets.drawString(this.fontRendererObj, this.field_146436_r, 50, 70, 10526880);
    ...
    static /* synthetic */ ListSlot access$2(GuiFlatPresets guiFlatPresets) {
    ...
    extends GuiSlot {
        ...
        private void func_148171_c(int p_148171_1_, int p_148171_2_, int p_148171_3_, int p_148171_4_) {
            ...
            var10.addVertexWithUV(p_148171_1_ + 0, p_148171_2_ + 18, zLevel, (float)(p_148171_3_ + 0) * 0.0078125f, (float)(p_148171_4_ + 18) * 0.0078125f);
            var10.addVertexWithUV(p_148171_1_ + 18, p_148171_2_ + 18, zLevel, (float)(p_148171_3_ + 18) * 0.0078125f, (float)(p_148171_4_ + 18) * 0.0078125f);
            var10.addVertexWithUV(p_148171_1_ + 18, p_148171_2_ + 0, zLevel, (float)(p_148171_3_ + 18) * 0.0078125f, (float)(p_148171_4_ + 0) * 0.0078125f);
            var10.addVertexWithUV(p_148171_1_ + 0, p_148171_2_ + 0, zLevel, (float)(p_148171_3_ + 0) * 0.0078125f, (float)(p_148171_4_ + 0) * 0.0078125f);
            var9.draw();
        }
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
            ...
            GuiFlatPresets.this.field_146433_u.setText(((LayerItem)GuiFlatPresets.access$0().get((int)GuiFlatPresets.access$2((GuiFlatPresets)GuiFlatPresets.this).field_148175_k)).field_148233_c);
        }
