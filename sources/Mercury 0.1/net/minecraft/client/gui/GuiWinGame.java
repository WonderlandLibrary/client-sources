...
extends GuiScreen {
    ...
    private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
        ...
        var5.addVertexWithUV(0.0, this.height, zLevel, 0.0, var7 * var9);
        var5.addVertexWithUV(var6, this.height, zLevel, (float)var6 * var9, var7 * var9);
        var5.addVertexWithUV(var6, 0.0, zLevel, (float)var6 * var9, var8 * var9);
        var5.addVertexWithUV(0.0, 0.0, zLevel, 0.0, var8 * var9);
        var4.draw();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        var5.addVertexWithUV(0.0, var14, zLevel, 0.0, 1.0);
        var5.addVertexWithUV(var11, var14, zLevel, 1.0, 1.0);
        var5.addVertexWithUV(var11, 0.0, zLevel, 1.0, 0.0);
        var5.addVertexWithUV(0.0, 0.0, zLevel, 0.0, 0.0);
        var4.draw();
