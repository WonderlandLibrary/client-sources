...
public class GuiUtilRenderComponents {
    ...
    public static List func_178908_a(IChatComponent p_178908_0_, int p_178908_1_, FontRenderer p_178908_2_, boolean p_178908_3_, boolean p_178908_4_) {
        ...
        ArrayList<ChatComponentText> var7 = Lists.newArrayList();
        ArrayList<ChatComponentText> var8 = Lists.newArrayList(p_178908_0_);
        for (int var9 = 0; var9 < var8.size(); ++var9) {
            ...
            var14 = (var21 = GuiUtilRenderComponents.func_178909_a(String.valueOf(var10.getChatStyle().getFormattingCode()) + var11, p_178908_4_)).endsWith("\n") ? var21.substring(0, var21.length() - 1) : var21;
            ...
            if (var5 + var22 > p_178908_1_) {
                ...
                String string = var18 = var17.length() < var21.length() ? var21.substring(var17.length()) : null;
