...
extends GuiScreen {
    ...
    private void func_146319_h() {
        this.field_146343_z.displayString = String.valueOf(I18n.format("selectWorld.gameMode", new Object[0])) + ": " + I18n.format("selectWorld.gameMode." + this.field_146342_r, new Object[0]);
    ...
    public static String func_146317_a(ISaveFormat p_146317_0_, String p_146317_1_) {
        ...
        for (String var5 : field_146327_L) {
            if (!p_146317_1_.equalsIgnoreCase(var5)) continue;
