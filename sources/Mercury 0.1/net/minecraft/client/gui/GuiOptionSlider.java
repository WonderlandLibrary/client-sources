...
extends GuiButton {
    ...
    protected void mouseDragged(Minecraft mc2, int mouseX, int mouseY) {
        if (this.visible) {
            if (this.dragging) {
                ...
                mc2.gameSettings.setOptionFloatValue(this.options, var4);
                this.sliderValue = this.options.normalizeValue(var4);
                this.displayString = mc2.gameSettings.getKeyBinding(this.options);
            }
    ...
    public boolean mousePressed(Minecraft mc2, int mouseX, int mouseY) {
        if (super.mousePressed(mc2, mouseX, mouseY)) {
            this.sliderValue = (float)(mouseX - (this.xPosition + 4)) / (float)(this.width - 8);
            this.sliderValue = MathHelper.clamp_float(this.sliderValue, 0.0f, 1.0f);
            mc2.gameSettings.setOptionFloatValue(this.options, this.options.denormalizeValue(this.sliderValue));
            this.displayString = mc2.gameSettings.getKeyBinding(this.options);
            this.dragging = true;
            return true;
        }
