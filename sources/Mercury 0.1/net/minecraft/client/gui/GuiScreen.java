...
implements GuiYesNoCallback {
    ...
    private static final Set field_175284_f = Sets.newHashSet("http", "https");
    private static final Splitter field_175285_g = Splitter.on('\n');
    protected Minecraft mc;
    protected RenderItem itemRender;
    public int width;
    public int height;
    public static boolean hudlilnibbastopyourjob = false;
    ...
    protected void renderToolTip(ItemStack itemIn, int x2, int y2) {
        ...
        this.drawHoveringText(var4, x2, y2);
    }
    ...
    protected void drawHoveringText(List textLines, int x2, int y2) {
        if (!textLines.isEmpty()) {
            ...
            for (int var12 = 0; var12 < textLines.size(); ++var12) {
                ...
                this.fontRendererObj.func_175063_a(var13, var14, var15, -1);
                if (var12 == 0) {
                    var15 += 2;
                }
                var15 += 10;
            ...
            block21 : {
                ...
                if (var4.getAction() == HoverEvent.Action.SHOW_ITEM) {
                    ...
                    if (this.mc.gameSettings.advancedItemTooltips) {
                        try {
                            ...
                            if (var12 instanceof NBTTagCompound) {
                                ArrayList<String> var14 = Lists.newArrayList();
                    ...
                    if (var13 != null) {
                        ...
                        ArrayList<String> var9 = Lists.newArrayList(var15.getFormattedText(), var16.getFormattedText());
                        if (var8 != null) {
    ...
    public void drawWorldBackground(int tint) {
        if (this.mc.theWorld != null) {
            ...
            this.drawBackgroundOriginal(tint);
        }
    }
    ...
    public void drawBackground(int tint) {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("textures/client.jpg"));
        Gui.drawScaledCustomSizeModalRect(0, 0, 0.0f, 0.0f, this.width, this.height, this.width, this.height, this.width, this.height);
    }

    public void drawBackgroundOriginal(int tint) {
        GlStateManager.disableLighting();
        GlStateManager.disableFog();
