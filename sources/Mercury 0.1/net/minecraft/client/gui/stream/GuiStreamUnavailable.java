...
extends GuiScreen {
    ...
    public static void func_152321_a(GuiScreen p_152321_0_) {
        ...
        if (!OpenGlHelper.framebufferSupported) {
            ArrayList<ChatComponentTranslation> var3 = Lists.newArrayList();
            ...
            List<ChatComponentTranslation> var4 = Arrays.asList(new ChatComponentTranslation("stream.unavailable.initialization_failure.extra", ErrorCode.getString(var2.func_152912_E())));
