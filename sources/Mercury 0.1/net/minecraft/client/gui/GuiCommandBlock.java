...
extends GuiScreen {
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        ...
        boolean bl2 = this.doneBtn.enabled = this.commandTextField.getText().trim().length() > 0;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiCommandBlock.drawString(this.fontRendererObj, I18n.format("advMode.command", new Object[0]), this.width / 2 - 150, 37, 10526880);
        ...
        GuiCommandBlock.drawString(this.fontRendererObj, I18n.format("advMode.randomPlayer", new Object[0]), this.width / 2 - 150, var4 + var7++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        GuiCommandBlock.drawString(this.fontRendererObj, I18n.format("advMode.allPlayers", new Object[0]), this.width / 2 - 150, var4 + var7++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        GuiCommandBlock.drawString(this.fontRendererObj, I18n.format("advMode.allEntities", new Object[0]), this.width / 2 - 150, var4 + var7++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        GuiCommandBlock.drawString(this.fontRendererObj, "", this.width / 2 - 150, var4 + var7++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        if (this.field_146486_g.getText().length() > 0) {
            int var6 = var4 + var7 * this.fontRendererObj.FONT_HEIGHT + 16;
            GuiCommandBlock.drawString(this.fontRendererObj, I18n.format("advMode.previousOutput", new Object[0]), this.width / 2 - 150, var6, 10526880);
