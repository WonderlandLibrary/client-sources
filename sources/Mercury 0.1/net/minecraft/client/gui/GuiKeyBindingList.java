...
extends GuiListExtended {
    ...
    public GuiKeyBindingList(GuiControls p_i45031_1_, Minecraft mcIn) {
        ...
        this.mc = mcIn;
        Object[] var3 = ArrayUtils.clone(mcIn.gameSettings.keyBindings);
    ...
    implements GuiListExtended.IGuiListEntry {
        ...
        public void drawEntry(int slotIndex, int x2, int y2, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
            ...
            GuiKeyBindingList.access$0((GuiKeyBindingList)GuiKeyBindingList.this).fontRendererObj.drawString(this.field_148283_c, x2 + 90 - GuiKeyBindingList.this.maxListLabelWidth, y2 + slotHeight / 2 - GuiKeyBindingList.access$0((GuiKeyBindingList)GuiKeyBindingList.this).fontRendererObj.FONT_HEIGHT / 2, 16777215);
