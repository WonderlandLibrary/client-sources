...
extends GuiContainer {
    ...
    public void updateScreen() {
        super.updateScreen();
        MerchantRecipeList var1 = this.field_147037_w.getRecipes(Minecraft.thePlayer);
        if (var1 != null) {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (button == this.field_147043_x) {
            ++this.field_147041_z;
            MerchantRecipeList var3 = this.field_147037_w.getRecipes(Minecraft.thePlayer);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        MerchantRecipeList var6 = this.field_147037_w.getRecipes(Minecraft.thePlayer);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        MerchantRecipeList var4 = this.field_147037_w.getRecipes(Minecraft.thePlayer);
    ...
    extends GuiButton {
        ...
        public void drawButton(Minecraft mc2, int mouseX, int mouseY) {
            if (this.visible) {
                mc2.getTextureManager().bindTexture(field_147038_v);
                GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
