...
extends GuiScreen {
    ...
    @Override
    public void renderToolTip(ItemStack itemIn, int x2, int y2) {
    ...
    @Override
    public void drawHoveringText(List textLines, int x2, int y2) {
    ...
    public void func_154319_c(String p_154319_1_, int p_154319_2_, int p_154319_3_, int p_154319_4_) {
        this.fontRendererObj.func_175063_a(p_154319_1_, p_154319_2_, p_154319_3_, p_154319_4_);
    }
    ...
    public List func_154320_j() {
        ArrayList<RealmsButton> var1 = Lists.newArrayListWithExpectedSize(this.buttonList.size());
