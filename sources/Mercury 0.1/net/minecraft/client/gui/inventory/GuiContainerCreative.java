...
extends InventoryEffectRenderer {
    ...
    protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType) {
        ...
        if (slotIn == null && selectedTabIndex != CreativeTabs.tabInventory.getTabIndex() && clickType != 5) {
            ...
            for (int var10 = 0; var10 < Minecraft.thePlayer.inventoryContainer.getInventory().size(); ++var10) {
            ...
            if (slotIn == this.field_147064_C) {
                ...
                Minecraft.thePlayer.inventoryContainer.slotClick(slotIn == null ? slotId : CreativeSlot.access$0((CreativeSlot)((CreativeSlot)slotIn)).slotNumber, clickedButton, clickType, Minecraft.thePlayer);
    ...
    private void updateCreativeSearch() {
        ...
        while (var2.hasNext()) {
            ...
            boolean var12 = false;
            for (String var7 : var11.getTooltip(Minecraft.thePlayer, this.mc.gameSettings.advancedItemTooltips)) {
    ...
    protected void renderToolTip(ItemStack itemIn, int x2, int y2) {
        if (selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex()) {
            ...
            super.renderToolTip(itemIn, x2, y2);
        }
    }
    ...
    protected void func_147051_a(CreativeTabs p_147051_1_) {
        ...
        this.itemRender.func_180450_b(var10, var7 += 6, var8 += 8 + n2);
