...
extends GuiScreen {
    ...
    private void drawItemStack(ItemStack stack, int x2, int y2, String altText) {
        ...
        this.itemRender.func_180450_b(stack, x2, y2);
        this.itemRender.func_180453_a(this.fontRendererObj, stack, x2, y2 - (this.draggedStack == null ? 0 : 8), altText);
        zLevel = 0.0f;
    ...
    private Slot getSlotAtPosition(int x2, int y2) {
        for (int var3 = 0; var3 < this.inventorySlots.inventorySlots.size(); ++var3) {
            ...
            if (!this.isMouseOverSlot(var4, x2, y2)) continue;
            return var4;
        }
        return null;
    }
        ...
        if (this.doubleClick && var4 != null && state == 0 && this.inventorySlots.func_94530_a(null, var4)) {
            if (GuiContainer.isShiftKeyDown()) {
                if (var4 != null && var4.inventory != null && this.shiftClickedSlot != null) {
                    for (Slot var10 : this.inventorySlots.inventorySlots) {
                        if (var10 == null || !var10.canTakeStack(Minecraft.thePlayer) || !var10.getHasStack() || var10.inventory != var4.inventory || !Container.canAddItemToSlot(var10, this.shiftClickedSlot, true)) continue;
            ...
            if (this.clickedSlot != null && this.mc.gameSettings.touchscreen) {
                ...
                if (state == this.mc.gameSettings.keyBindPickBlock.getKeyCode() + 100) {
                    ...
                    boolean var9;
                    boolean bl2 = var9 = var8 != -999 && (Keyboard.isKeyDown(42) || Keyboard.isKeyDown(54));
                    if (var9) {
