...
extends GuiListExtended {
    ...
    implements GuiListExtended.IGuiListEntry {
        ...
        public void drawEntry(int slotIndex, int x2, int y2, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
            this.func_178017_a(this.field_178029_b, y2, mouseX, mouseY, false);
            this.func_178017_a(this.field_178030_c, y2, mouseX, mouseY, false);
        }
        ...
        public void mouseReleased(int slotIndex, int x2, int y2, int mouseEvent, int relativeX, int relativeY) {
            this.func_178016_b(this.field_178029_b, x2, y2, mouseEvent);
            this.func_178016_b(this.field_178030_c, x2, y2, mouseEvent);
        }
