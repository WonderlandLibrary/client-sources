...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        ArrayList<ResourcePackRepository.Entry> var2 = Lists.newArrayList(var1.getRepositoryEntriesAll());
        ...
        for (ResourcePackRepository.Entry var4 : Lists.reverse(var1.getRepositoryEntries())) {
        ...
        if (button.enabled) {
            if (button.id == 2) {
                ...
                if (this.field_175289_s) {
                    ArrayList<ResourcePackRepository.Entry> var10 = Lists.newArrayList();
