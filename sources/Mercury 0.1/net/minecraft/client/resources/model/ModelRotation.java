...
ITransformation
{
    ...
    private ModelRotation(String p_i46087_1_, int p_i46087_2_, int p_i46087_3_, int p_i46087_4_) {
        ...
        var5.setIdentity();
        var5.setRotation(new AxisAngle4d(1.0, 0.0, 0.0, (float)(-p_i46087_3_) * 0.017453292f));
        this.field_177543_t = MathHelper.abs_int(p_i46087_3_ / 90);
        Matrix4d var6 = new Matrix4d();
        var6.setIdentity();
        var6.setRotation(new AxisAngle4d(0.0, 1.0, 0.0, (float)(-p_i46087_4_) * 0.017453292f));
