...
public class ModelBakery {
    ...
    private void func_177577_b() {
        ...
        this.variants.put(MODEL_MISSING, new ModelBlockDefinition.Variants(MODEL_MISSING.func_177518_c(), Lists.newArrayList(new ModelBlockDefinition.Variant(new ResourceLocation(MODEL_MISSING.getResourcePath()), ModelRotation.X0_Y0, false, 1))));
    ...
    private ModelBlockDefinition getModelBlockDefinition(ResourceLocation p_177586_1_) {
        ...
        if (var3 == null) {
            ArrayList<ModelBlockDefinition> var4 = Lists.newArrayList();
            try {
    ...
    private void func_177574_i() {
        ...
        ArrayDeque<ResourceLocation> var1 = Queues.newArrayDeque();
        HashSet<ResourceLocation> var2 = Sets.newHashSet();
        ...
        while (!var1.isEmpty()) {
            ...
            try {
                ...
                LOGGER.warn("In parent chain: " + field_177601_e.join(this.func_177573_e(var7)) + "; unable to load model: '" + var7 + "'", (Throwable)var6);
            }
            var2.add(var7);
        }
    }
    ...
    private List func_177573_e(ResourceLocation p_177573_1_) {
        ArrayList<ResourceLocation> var2 = Lists.newArrayList(p_177573_1_);
    ...
    private Set func_177571_k() {
        HashSet<ResourceLocation> var1 = Sets.newHashSet();
