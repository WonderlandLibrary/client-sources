...
public class Locale {
    ...
    private void loadLocaleData(InputStream p_135021_1_) throws IOException {
        for (String var3 : IOUtils.readLines(p_135021_1_, Charsets.UTF_8)) {
            String[] var4;
            if (var3.isEmpty() || var3.charAt(0) == '#' || (var4 = Iterables.toArray(splitter.split(var3), String.class)) == null || var4.length != 2) continue;
            String var5 = var4[0];
