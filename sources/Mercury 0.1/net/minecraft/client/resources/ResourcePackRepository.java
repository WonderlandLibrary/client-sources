...
public class ResourcePackRepository {
    ...
    private static final FileFilter resourcePackFilter = new FileFilter(){
        ...
        public boolean accept(File p_accept_1_) {
            ...
            boolean bl2 = var3 = p_accept_1_.isDirectory() && new File(p_accept_1_, "pack.mcmeta").isFile();
            return var2 || var3;
        }
    };
    ...
    public void updateRepositoryEntriesAll() {
        ArrayList<Entry> var1 = Lists.newArrayList();
        for (File var3 : this.getResourcePackFiles()) {
            ...
            var1.add((Entry)this.repositoryEntriesAll.get(var5));
        }
        ...
        try {
            ...
            if (var4.exists() && p_180601_2_.length() == 40) {
                ...
                block12 : {
                    ...
                    var5 = Hashing.sha1().hashBytes(Files.toByteArray(var4)).toString();
