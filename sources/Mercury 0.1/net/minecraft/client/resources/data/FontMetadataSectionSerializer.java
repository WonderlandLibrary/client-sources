    ...
    public FontMetadataSection deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) {
        ...
        if (var4.has("characters")) {
            ...
            if (var11.has("default")) {
                ...
                Validate.inclusiveBetween(0.0, 3.4028234663852886E38, var8, "Invalid default width");
                var9 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var12, "spacing", var9);
                Validate.inclusiveBetween(0.0, 3.4028234663852886E38, var9, "Invalid default spacing");
                var10 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var12, "left", var9);
                Validate.inclusiveBetween(0.0, 3.4028234663852886E38, var10, "Invalid default left");
            }
            for (int var18 = 0; var18 < 256; ++var18) {
                ...
                if (var13 != null) {
                    ...
                    Validate.inclusiveBetween(0.0, 3.4028234663852886E38, var14, "Invalid width");
                    var15 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var17, "spacing", var9);
                    Validate.inclusiveBetween(0.0, 3.4028234663852886E38, var15, "Invalid spacing");
                    var16 = JsonUtils.getJsonObjectFloatFieldValueOrDefault(var17, "left", var10);
                    Validate.inclusiveBetween(0.0, 3.4028234663852886E38, var16, "Invalid left");
                }
                var5[var18] = var14;
                var6[var18] = var15;
                var7[var18] = var16;
