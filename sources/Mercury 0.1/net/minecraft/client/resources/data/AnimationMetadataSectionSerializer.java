...
implements JsonSerializer {
    ...
    public AnimationMetadataSection deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) {
        int var8;
        ArrayList<AnimationFrame> var4 = Lists.newArrayList();
        ...
        if (var6 != 1) {
            Validate.inclusiveBetween(1L, Integer.MAX_VALUE, var6, "Invalid default frame time");
        }
        if (var5.has("frames")) {
            try {
        ...
        if (var12 != -1) {
            Validate.inclusiveBetween(1L, Integer.MAX_VALUE, var12, "Invalid width");
        }
        if (var8 != -1) {
            Validate.inclusiveBetween(1L, Integer.MAX_VALUE, var8, "Invalid height");
        }
    ...
    private AnimationFrame parseAnimationFrame(int p_110492_1_, JsonElement p_110492_2_) {
        ...
        if (p_110492_2_.isJsonObject()) {
            ...
            if (var3.has("time")) {
                Validate.inclusiveBetween(1L, Integer.MAX_VALUE, var4, "Invalid frame time");
            }
            int var5 = JsonUtils.getJsonObjectIntegerFieldValue(var3, "index");
            Validate.inclusiveBetween(0L, Integer.MAX_VALUE, var5, "Invalid frame index");
