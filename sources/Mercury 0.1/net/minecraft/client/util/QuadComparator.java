...
implements Comparator {
    ...
    public int compare(Integer p_compare_1_, Integer p_compare_2_) {
        ...
        float var6 = this.field_147627_d.get(p_compare_1_ + this.field_178079_e + 0) - this.field_147630_a;
        ...
        float var9 = this.field_147627_d.get(p_compare_1_ + this.field_178079_e * 2 + 0) - this.field_147630_a;
        ...
        float var12 = this.field_147627_d.get(p_compare_1_ + this.field_178079_e * 3 + 0) - this.field_147630_a;
        ...
        float var18 = this.field_147627_d.get(p_compare_2_ + this.field_178079_e + 0) - this.field_147630_a;
        ...
        float var21 = this.field_147627_d.get(p_compare_2_ + this.field_178079_e * 2 + 0) - this.field_147630_a;
        ...
        float var24 = this.field_147627_d.get(p_compare_2_ + this.field_178079_e * 3 + 0) - this.field_147630_a;
