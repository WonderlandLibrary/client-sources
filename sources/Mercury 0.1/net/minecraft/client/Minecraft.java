...
import us.amerikan.events.EventTick;
...
IPlayerUsage {
    ...
    public Minecraft(GameConfiguration p_i45547_1_) {
        ...
        session = p_i45547_1_.field_178745_a.field_178752_a;
        ...
        if (p_i45547_1_.field_178742_e.field_178754_a != null) {
            ...
            EventManager.register(new amerikan());
        }
    ...
    private void func_175609_am() throws LWJGLException {
        ...
        Display.setTitle("Loading Mercury...");
        try {
    ...
    public void rightClickMouse() {
        ...
        if (this.objectMouseOver == null) {
            ...
            switch (this.objectMouseOver.typeOfHit) {
                ...
                case BLOCK: {
                    ...
                    int n2 = var4 = var2 != null ? var2.stackSize : 0;
                    if (this.playerController.func_178890_a(thePlayer, this.theWorld, var2, var3, this.objectMouseOver.field_178784_b, this.objectMouseOver.hitVec)) {
                        var1 = false;
                        thePlayer.swingItem();
                    }
                    if (var2 == null) {
        ...
        if (var1 && (var5 = Minecraft.thePlayer.inventory.getCurrentItem()) != null && this.playerController.sendUseItem(thePlayer, this.theWorld, var5)) {
    ...
    public void runTick() throws IOException {
        block95 : {
            block96 : {
                ...
                if (this.currentScreen != null && !this.currentScreen.allowUserInput) break block95;
                ...
                while (Keyboard.next()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        for (Module m : amerikan.modulemanager.getModules()) {
                ...
                if (!Minecraft.thePlayer.isUsingItem()) ** GOTO lbl192
...
lbl193: // 2 sources:
    ...
    public void dispatchKeypresses() {
        int var1;
        int n2 = var1 = Keyboard.getEventKey() == 0 ? Keyboard.getEventCharacter() : Keyboard.getEventKey();
    ...
    public static Map func_175596_ai() {
        HashMap<String, String> var0 = Maps.newHashMap();
