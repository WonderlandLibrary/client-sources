...
public class Scoreboard {
    ...
    public ScoreObjective addScoreObjective(String p_96535_1_, IScoreObjectiveCriteria p_96535_2_) {
        ...
        ArrayList var4 = (ArrayList)this.scoreObjectiveCriterias.get(p_96535_2_);
        if (var4 == null) {
    ...
    public Score getValueFromObjective(String p_96529_1_, ScoreObjective p_96529_2_) {
        Score var4;
        HashMap var3 = (HashMap)this.field_96544_c.get(p_96529_1_);
        if (var3 == null) {
            var3 = Maps.newHashMap();
            this.field_96544_c.put(p_96529_1_, var3);
        }
        if ((var4 = (Score)((Map)var3).get(p_96529_2_)) == null) {
    ...
    public void func_178822_d(String p_178822_1_, ScoreObjective p_178822_2_) {
        if (p_178822_2_ == null) {
            Map var3 = (Map)this.field_96544_c.remove(p_178822_1_);
            if (var3 != null) {
                this.func_96516_a(p_178822_1_);
            }
        } else {
            Map var3 = (Map)this.field_96544_c.get(p_178822_1_);
            if (var3 != null) {
    ...
    public Map func_96510_d(String p_96510_1_) {
        HashMap var2 = (HashMap)this.field_96544_c.get(p_96510_1_);
        if (var2 == null) {
    ...
    public void func_96519_k(ScoreObjective p_96519_1_) {
        ...
        for (int var2 = 0; var2 < 19; ++var2) {
            if (this.getObjectiveInDisplaySlot(var2) != p_96519_1_) continue;
    ...
    public void removeTeam(ScorePlayerTeam p_96511_1_) {
        ...
        for (String var3 : p_96511_1_.getMembershipCollection()) {
    ...
    public static String getObjectiveDisplaySlot(int p_96517_0_) {
        ...
        if (p_96517_0_ >= 3 && p_96517_0_ <= 18 && (var1 = EnumChatFormatting.func_175744_a(p_96517_0_ - 3)) != null && var1 != EnumChatFormatting.RESET) {
    ...
    public static int getObjectiveDisplaySlotNumber(String p_96537_0_) {
        ...
        if (p_96537_0_.startsWith("sidebar.team.") && (var2 = EnumChatFormatting.getValueByName(var1 = p_96537_0_.substring("sidebar.team.".length()))) != null && var2.func_175746_b() >= 0) {
