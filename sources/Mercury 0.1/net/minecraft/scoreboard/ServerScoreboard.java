...
extends Scoreboard {
    ...
    public List func_96550_d(ScoreObjective p_96550_1_) {
        ArrayList<Packet> var2 = Lists.newArrayList();
        var2.add(new S3BPacketScoreboardObjective(p_96550_1_, 0));
        for (int var3 = 0; var3 < 19; ++var3) {
            if (this.getObjectiveInDisplaySlot(var3) != p_96550_1_) continue;
            var2.add(new S3DPacketDisplayScoreboard(var3, p_96550_1_));
        }
        for (Score var4 : this.getSortedScores(p_96550_1_)) {
    ...
    public List func_96548_f(ScoreObjective p_96548_1_) {
        ...
        for (int var3 = 0; var3 < 19; ++var3) {
            if (this.getObjectiveInDisplaySlot(var3) != p_96548_1_) continue;
    ...
    public int func_96552_h(ScoreObjective p_96552_1_) {
        int var2 = 0;
        for (int var3 = 0; var3 < 19; ++var3) {
            if (this.getObjectiveInDisplaySlot(var3) != p_96552_1_) continue;
            ++var2;
        }
        return var2;
    }
