...
implements IGrowable {
    ...
    public void func_176476_e(World worldIn, BlockPos p_176476_2_, IBlockState p_176476_3_, Random p_176476_4_) {
        ...
        switch (SwitchEnumType.field_177065_a[((BlockPlanks.EnumType)((Object)p_176476_3_.getValue(TYPE_PROP))).ordinal()]) {
            case 1: {
                block7 : for (var6 = 0; var6 >= -1; --var6) {
                    for (var7 = 0; var7 >= -1; --var7) {
                        if (!this.func_176477_a(worldIn, p_176476_2_.add(var6, 0, var7), BlockPlanks.EnumType.SPRUCE) || !this.func_176477_a(worldIn, p_176476_2_.add(var6 + 1, 0, var7), BlockPlanks.EnumType.SPRUCE) || !this.func_176477_a(worldIn, p_176476_2_.add(var6, 0, var7 + 1), BlockPlanks.EnumType.SPRUCE) || !this.func_176477_a(worldIn, p_176476_2_.add(var6 + 1, 0, var7 + 1), BlockPlanks.EnumType.SPRUCE)) continue;
            ...
            case 3: {
                block9 : for (var6 = 0; var6 >= -1; --var6) {
                    for (var7 = 0; var7 >= -1; --var7) {
                        if (!this.func_176477_a(worldIn, p_176476_2_.add(var6, 0, var7), BlockPlanks.EnumType.JUNGLE) || !this.func_176477_a(worldIn, p_176476_2_.add(var6 + 1, 0, var7), BlockPlanks.EnumType.JUNGLE) || !this.func_176477_a(worldIn, p_176476_2_.add(var6, 0, var7 + 1), BlockPlanks.EnumType.JUNGLE) || !this.func_176477_a(worldIn, p_176476_2_.add(var6 + 1, 0, var7 + 1), BlockPlanks.EnumType.JUNGLE)) continue;
            ...
            case 5: {
                block11 : for (var6 = 0; var6 >= -1; --var6) {
                    for (var7 = 0; var7 >= -1; --var7) {
                        if (!this.func_176477_a(worldIn, p_176476_2_.add(var6, 0, var7), BlockPlanks.EnumType.DARK_OAK) || !this.func_176477_a(worldIn, p_176476_2_.add(var6 + 1, 0, var7), BlockPlanks.EnumType.DARK_OAK) || !this.func_176477_a(worldIn, p_176476_2_.add(var6, 0, var7 + 1), BlockPlanks.EnumType.DARK_OAK) || !this.func_176477_a(worldIn, p_176476_2_.add(var6 + 1, 0, var7 + 1), BlockPlanks.EnumType.DARK_OAK)) continue;
