        ...
        for (int var5 = 0; var5 < this.field_177686_d; ++var5) {
            for (int var6 = 0; var6 < this.field_177688_c; ++var6) {
                for (int var7 = 0; var7 < this.field_177687_b; ++var7) {
                    if (this.field_177689_a[var7][var6][var5].apply(p_177682_4_.getUnchecked(BlockPattern.func_177683_a(p_177682_1_, p_177682_2_, p_177682_3_, var5, var6, var7)))) continue;
                    return null;
                }
            }
        }
