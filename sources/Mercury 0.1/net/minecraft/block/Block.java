...
public class Block {
    ...
    public static Block getBlockById(int id2) {
        return (Block)blockRegistry.getObjectById(id2);
    }

    public static IBlockState getStateById(int id2) {
        int var1 = id2 & 4095;
        int var2 = id2 >> 12 & 15;
    ...
    public void harvestBlock(World worldIn, EntityPlayer playerIn, BlockPos pos, IBlockState state, TileEntity te2) {
    ...
    public static void registerBlocks() {
        ...
        for (Block var14 : blockRegistry) {
            ...
            boolean bl2 = var20 = var14.lightOpacity == 0;
    ...
    private static void registerBlock(int id2, ResourceLocation textualID, Block block_) {
        blockRegistry.register(id2, textualID, block_);
    }

    private static void registerBlock(int id2, String textualID, Block block_) {
        Block.registerBlock(id2, new ResourceLocation(textualID), block_);
    }
