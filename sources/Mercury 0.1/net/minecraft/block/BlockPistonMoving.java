...
extends BlockContainer {
    ...
    public BlockPistonMoving() {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(field_176426_a, (Comparable)((Object)EnumFacing.NORTH)).withProperty(field_176425_b, (Comparable)((Object)BlockPistonExtension.EnumPistonType.DEFAULT)));
    ...
    public void onBlockDestroyedByPlayer(World worldIn, BlockPos pos, IBlockState state) {
        BlockPos var4 = pos.offset(((EnumFacing)((Object)state.getValue(field_176426_a))).getOpposite());
    ...
    public void dropBlockAsItemWithChance(World worldIn, BlockPos pos, IBlockState state, float chance, int fortune) {
        TileEntityPiston var6;
        if (!worldIn.isRemote && (var6 = this.func_176422_e(worldIn, pos)) != null) {
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState().withProperty(field_176426_a, (Comparable)((Object)BlockPistonExtension.func_176322_b(meta))).withProperty(field_176425_b, (Comparable)((Object)((meta & 8) > 0 ? BlockPistonExtension.EnumPistonType.STICKY : BlockPistonExtension.EnumPistonType.DEFAULT)));
    }

    @Override
    public int getMetaFromState(IBlockState state) {
        int var2 = 0;
        int var3 = var2 | ((EnumFacing)((Object)state.getValue(field_176426_a))).getIndex();
