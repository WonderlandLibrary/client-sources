...
extends Thread {
    ...
    public void run() {
        while (!Thread.interrupted()) {
            ...
            try {
                ...
                InputStream e2 = this.httpPipelineConnection.getInputStream();
                HttpResponse resp = this.readResponse(e2);
    ...
    private HttpResponse readResponse(InputStream in2) throws IOException {
        ...
        do {
            String body;
            String enc;
            if ((body = this.readLine(in2)).length() <= 0) {
                byte[] body1 = null;
