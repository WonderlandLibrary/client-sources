...
public class Lagometer {
    ...
    private static long getMemoryUsed() {
        ...
        return r2.totalMemory() - r2.freeMemory();
    }
    ...
    public static void updateLagometer() {
        ...
        if (Lagometer.gameSettings.showDebugInfo && Lagometer.gameSettings.ofLagometer) {
            ...
            if (prevFrameTimeNano == -1L) {
                ...
                boolean gc2 = Lagometer.updateMemoryAllocation();
    ...
    public static void showLagometer(ScaledResolution scaledResolution) {
        if (gameSettings != null && Lagometer.gameSettings.ofLagometer) {
            ...
            for (y60 = 0; y60 < timesFrame.length; ++y60) {
                ...
                float f2 = lumMem - (float)Lagometer.renderTime(y60, timesTick[y60], 0, y30, y30, lumMem, tessellator);
            }
    ...
    private static long renderTime(int frameNum, long time, int r2, int g2, int b2, float baseHeight, WorldRenderer tessellator) {
        ...
        tessellator.func_178961_b(r2, g2, b2, 255);
