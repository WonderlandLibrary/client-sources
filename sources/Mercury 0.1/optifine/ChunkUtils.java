...
public class ChunkUtils {
    ...
    private static Field findFieldHasEntities(Chunk chunk) {
        try {
            ArrayList<Field> e2 = new ArrayList<Field>();
            ...
            for (int var18 = 0; var18 < e2.size(); ++var18) {
                Field field1 = (Field)e2.get(var18);
