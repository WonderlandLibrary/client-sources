...
public class Reflector {
    ...
    public static void callVoid(ReflectorMethod refMethod, Object ... params) {
        try {
            Method e2 = refMethod.getTargetMethod();
            if (e2 == null) {
                return;
            }
            e2.invoke(null, params);
        }
    ...
    public static boolean callBoolean(ReflectorMethod refMethod, Object ... params) {
        ...
        Boolean retVal = (Boolean)e2.invoke(null, params);
        return retVal;
    }
    ...
    public static int callInt(ReflectorMethod refMethod, Object ... params) {
        ...
        Integer retVal = (Integer)e2.invoke(null, params);
        return retVal;
    }
    ...
    public static float callFloat(ReflectorMethod refMethod, Object ... params) {
        ...
        Float retVal = (Float)e2.invoke(null, params);
    ...
    public static double callDouble(ReflectorMethod refMethod, Object ... params) {
        ...
        Double retVal = (Double)e2.invoke(null, params);
        return retVal;
    }
    ...
    public static String callString(ReflectorMethod refMethod, Object ... params) {
        ...
        String retVal = (String)e2.invoke(null, params);
        return retVal;
    }
    ...
    public static Object call(ReflectorMethod refMethod, Object ... params) {
        ...
        Object retVal = e2.invoke(null, params);
        return retVal;
    }
    ...
    public static boolean callBoolean(Object obj, ReflectorMethod refMethod, Object ... params) {
        ...
        Boolean retVal = (Boolean)e2.invoke(obj, params);
        return retVal;
    }
    ...
    public static int callInt(Object obj, ReflectorMethod refMethod, Object ... params) {
        ...
        Integer retVal = (Integer)e2.invoke(obj, params);
        return retVal;
    }
    ...
    public static float callFloat(Object obj, ReflectorMethod refMethod, Object ... params) {
        ...
        Float retVal = (Float)e2.invoke(obj, params);
        return retVal.floatValue();
    }
    ...
    public static double callDouble(Object obj, ReflectorMethod refMethod, Object ... params) {
        ...
        Double retVal = (Double)e2.invoke(obj, params);
        return retVal;
    }
    ...
    public static String callString(Object obj, ReflectorMethod refMethod, Object ... params) {
        ...
        String retVal = (String)e2.invoke(obj, params);
        return retVal;
    }
    ...
    public static Object call(Object obj, ReflectorMethod refMethod, Object ... params) {
        ...
        Object retVal = e2.invoke(obj, params);
        return retVal;
    }
    ...
    public static void setFieldValue(Object obj, ReflectorField refField, Object value) {
        try {
            Field e2 = refField.getTargetField();
            if (e2 == null) {
                return;
            }
            e2.set(obj, value);
    ...
    public static Object newInstance(ReflectorConstructor constr, Object ... params) {
        ...
        try {
            Object e2 = c2.newInstance(params);
            return e2;
        }
        catch (Throwable var4) {
    ...
    public static Method[] getMethods(Class cls, String methodName) {
        ...
        Method[] ms2 = cls.getDeclaredMethods();
        for (int methods = 0; methods < ms2.length; ++methods) {
            Method m2 = ms2[methods];
            if (!m2.getName().equals(methodName)) continue;
            listMethods.add(m2);
        }
        Method[] var6 = listMethods.toArray(new Method[listMethods.size()]);
        return var6;
    }
    ...
    public static boolean matchesTypes(Class[] pTypes, Class[] cTypes) {
        ...
        for (int i2 = 0; i2 < cTypes.length; ++i2) {
            Class pType = pTypes[i2];
            Class cType = cTypes[i2];
    ...
    private static void handleException(Throwable e2, Object obj, ReflectorMethod refMethod, Object[] params) {
    ...
    private static void handleException(Throwable e2, ReflectorConstructor refConstr, Object[] params) {
        if (e2 instanceof InvocationTargetException) {
            e2.printStackTrace();
        } else {
            if (e2 instanceof IllegalArgumentException) {
    ...
    public static Field getField(Class cls, Class fieldType) {
        try {
            Field[] e2 = cls.getDeclaredFields();
    ...
    public static Field[] getFields(Class cls, Class fieldType) {
        ...
        try {
            Field[] e2 = cls.getDeclaredFields();
            for (int fields = 0; fields < e2.length; ++fields) {
                Field field = e2[fields];
                if (field.getType() != fieldType) continue;
                field.setAccessible(true);
                list.add(field);
            }
            Field[] var7 = list.toArray(new Field[list.size()]);
            return var7;
        }
