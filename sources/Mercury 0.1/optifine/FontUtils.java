...
public class FontUtils {
    public static Properties readFontProperties(ResourceLocation locationFontTexture) {
        ...
        try {
            ResourceLocation e2 = new ResourceLocation(locationFontTexture.getResourceDomain(), fileName);
            InputStream in2 = Config.getResourceStream(Config.getResourceManager(), e2);
            if (in2 == null) {
                return props;
            }
