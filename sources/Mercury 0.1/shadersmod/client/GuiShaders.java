...
extends GuiScreen {
        ...
        if (button.enabled) {
            if (button instanceof GuiButtonEnumShaderOption) {
                ...
                switch (button.id) {
                    ...
                    case 202: {
                        new java.io.File(Shaders.shadersdir, "current.cfg");
                        try {
                            Shaders.storeConfig();
                        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (infoWidth < this.width - 5) {
            ...
            GuiShaders.drawString(this.fontRendererObj, info, 5, this.height - 40, 8421504);
        }
    ...
    public static String toStringOnOff(boolean value) {
        String on2 = Lang.getOn();
        String off = Lang.getOff();
        return value ? on2 : off;
    }
