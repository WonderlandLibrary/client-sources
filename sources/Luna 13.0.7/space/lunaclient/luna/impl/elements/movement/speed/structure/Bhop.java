...
@ElementInfo(name="Bhop", category=Category.MOVEMENT)
public class Bhop
{
  ...
  public void onMove(EventMove e)
  {
    ...
    if ((stage == 2) && (Minecraft.thePlayer.isCollidedVertically) && ((Minecraft.thePlayer.moveForward != 0.0F) || (Minecraft.thePlayer.moveStrafing != 0.0F)))
    {
      ...
      double[] speedVal = { Element.mc.getCurrentServerData().serverIP.contains("cubecraft") ? 1.31D : Minecraft.thePlayer.ticksExisted % 5 == 0 ? 1.2D : 1.45D };
