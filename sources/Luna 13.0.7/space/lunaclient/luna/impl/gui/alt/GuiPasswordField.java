  ...
  extends Gui
{
  ...
  private int field_146217_k = 172;
  ...
  GuiPasswordField(FontRenderer p_i1032_1_, int p_i1032_2_, int p_i1032_3_, int p_i1032_4_, int p_i1032_5_)
  {
  ...
  public void drawTextBox()
  {
    if (func_146176_q())
    {
      ...
      boolean var13 = (this.field_146224_r < this.field_146216_j.length()) || (this.field_146216_j.length() >= func_146208_g());
      int var11 = var9;
      if (!var5)
      {
  ...
  private void func_146175_b(int p_146175_1_)
  {
  ...
  private void func_146177_a(int p_146177_1_)
  {
    if (this.field_146216_j.length() != 0) {
      if (this.field_146223_s != this.field_146224_r) {
        func_146191_b("");
  ...
  private void func_146182_d(int p_146182_1_)
  {
    func_146190_e(this.field_146223_s + p_146182_1_);
  }
  
  private int func_146183_a(int p_146183_1_, int p_146183_2_)
  {
    return func_146197_a(p_146183_1_, func_146198_h());
  }
  ...
  private int func_146187_c(int p_146187_1_)
  {
  ...
  private void func_146190_e(int p_146190_1_)
  {
  ...
  private void func_146191_b(String p_146191_1_)
  {
    String var2 = "";
    ...
    for (int var7 = 0; var7 < var6; var7++) {
      ...
      else
      {
        ...
        if (var4 == -1) {
          ...
          while ((var4 < var8) && (this.field_146216_j.charAt(var4) == ' ')) {
            var4++;
          }
        }
      }
  ...
  void textBoxTyped(char p_146201_1_, int p_146201_2_)
  {
