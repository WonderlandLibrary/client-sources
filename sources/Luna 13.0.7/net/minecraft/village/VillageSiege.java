...
public class VillageSiege
{
    ...
    while (var2.hasNext())
    {
      ...
      if (!var3.func_175149_v())
      {
        ...
        if ((this.theVillage != null) && (this.theVillage.getNumVillageDoors() >= 10) && (this.theVillage.getTicksSinceLastDoorAdding() >= 20) && (this.theVillage.getNumVillagers() >= 20))
        {
          ...
          Vec3 var11 = func_179867_a(new BlockPos(this.field_75532_g, this.field_75538_h, this.field_75539_i));
          if (var11 != null)
          {
  ...
  {
    Vec3 var1 = func_179867_a(new BlockPos(this.field_75532_g, this.field_75538_h, this.field_75539_i));
    if (var1 == null) {
      return false;
    }
    try
