  ...
  extends Block
{
  ...
  {
    func_176286_e(worldIn, pos, state.withProperty(field_176293_a, Boolean.valueOf(true)));
  }
  ...
  {
    EnumFacing[] var4 = { EnumFacing.SOUTH, EnumFacing.WEST };
    ...
    while (var6 < var5)
    {
      ...
      while (var8 < 42)
      {
        ...
        if (var10.getBlock() == Blocks.tripwire_hook)
        {
          ...
          Blocks.tripwire_hook.func_176260_a(worldIn, var9, var10, false, true, var8, p_176286_3_); break;
        }
  ...
  private void func_176288_d(World worldIn, BlockPos p_176288_2_)
  {
    ...
    boolean var5 = false;
    List var6 = worldIn.getEntitiesWithinAABBExcludingEntity((Entity)null, new AxisAlignedBB(p_176288_2_.getX() + this.minX, p_176288_2_.getY() + this.minY, p_176288_2_.getZ() + this.minZ, p_176288_2_.getX() + this.maxX, p_176288_2_.getY() + this.maxY, p_176288_2_.getZ() + this.maxZ));
    if (!var6.isEmpty())
    {
  ...
  {
    return getDefaultState().withProperty(field_176293_a, Boolean.valueOf((meta & 0x1) > 0)).withProperty(field_176290_b, Boolean.valueOf((meta & 0x2) > 0)).withProperty(field_176294_M, Boolean.valueOf((meta & 0x4) > 0)).withProperty(field_176295_N, Boolean.valueOf((meta & 0x8) > 0));
  }
