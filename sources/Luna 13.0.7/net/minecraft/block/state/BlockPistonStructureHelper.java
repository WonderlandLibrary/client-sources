...
public class BlockPistonStructureHelper
{
  ...
  public boolean func_177253_a()
  {
    ...
    if (!func_177251_a(this.field_177260_c)) {
      return false;
    }
    for (int var2 = 0; var2 < this.field_177258_e.size(); var2++)
    {
      BlockPos var3 = (BlockPos)this.field_177258_e.get(var2);
      if ((this.field_177261_a.getBlockState(var3).getBlock() == Blocks.slime_block) && (!func_177250_b(var3))) {
        return false;
      }
    }
    return true;
    ...
    for (;;)
    {
      ...
      if (var7 > -1)
      {
        ...
        for (int var8 = 0; var8 <= var7 + var10; var8++)
        {
          ...
          if ((this.field_177261_a.getBlockState(var9).getBlock() == Blocks.slime_block) && (!func_177250_b(var9))) {
            return false;
          }
        }
        return true;
  ...
  private boolean func_177250_b(BlockPos p_177250_1_)
  {
    ...
    for (int var4 = 0; var4 < var3; var4++)
    {
      ...
      if ((var5.getAxis() != this.field_177257_d.getAxis()) && (!func_177251_a(p_177250_1_.offset(var5)))) {
        return false;
      }
    }
    return true;
