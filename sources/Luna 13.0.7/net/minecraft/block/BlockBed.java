  ...
  extends BlockDirectional
{
  ...
  public BlockBed()
  {
    ...
    setDefaultState(this.blockState.getBaseState().withProperty(PART_PROP, EnumPartType.FOOT).withProperty(OCCUPIED_PROP, Boolean.valueOf(false)));
    setBedBounds();
  }
  ...
  {
    if ((playerIn.capabilities.isCreativeMode) && (state.getValue(PART_PROP) == EnumPartType.HEAD))
    {
