  ...
  extends BlockBreakable
{
  ...
  public BlockPortal()
  {
    ...
    setDefaultState(this.blockState.getBaseState().withProperty(field_176550_a, EnumFacing.Axis.X));
  ...
  public static class Size
  {
    ...
    public Size(World worldIn, BlockPos p_i45694_2_, EnumFacing.Axis p_i45694_3_)
    {
      ...
      int var5 = func_180120_a(p_i45694_2_, this.field_150863_d) - 1;
      if (var5 >= 0)
      {
    ...
    protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
    {
      for (int var3 = 0; var3 < 22; var3++)
      {
        ...
        if ((!func_150857_a(this.field_150867_a.getBlockState(var4).getBlock())) || (this.field_150867_a.getBlockState(var4.offsetDown()).getBlock() != Blocks.obsidian)) {
          break;
        }
      }
    ...
    {
      for (this.field_150862_g = 0; this.field_150862_g < 21; this.field_150862_g += 1) {
