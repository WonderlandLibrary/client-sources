  ...
  extends BlockLiquid
{
  ...
  private int func_176374_a(World worldIn, BlockPos p_176374_2_, int p_176374_3_, EnumFacing p_176374_4_)
  {
    ...
    while (var6.hasNext())
    {
      ...
      if (var7 != p_176374_4_)
      {
        ...
        if ((!func_176372_g(worldIn, var8, var9)) && ((var9.getBlock().getMaterial() != this.blockMaterial) || (((Integer)var9.getValue(LEVEL)).intValue() > 0)))
        {
  ...
  private Set func_176376_e(World worldIn, BlockPos p_176376_2_)
  {
    ...
    while (var5.hasNext())
    {
      ...
      if ((!func_176372_g(worldIn, var7, var8)) && ((var8.getBlock().getMaterial() != this.blockMaterial) || (((Integer)var8.getValue(LEVEL)).intValue() > 0)))
      {
        int var9;
        int var9;
  ...
  private boolean func_176372_g(World worldIn, BlockPos p_176372_2_, IBlockState p_176372_3_)
  {
    ...
    return var4.blockMaterial == Material.portal;
  }
  ...
  private boolean func_176373_h(World worldIn, BlockPos p_176373_2_, IBlockState p_176373_3_)
  {
    ...
    return (var4 != this.blockMaterial) && (var4 != Material.lava) && (!func_176372_g(worldIn, p_176373_2_, p_176373_3_));
  }
