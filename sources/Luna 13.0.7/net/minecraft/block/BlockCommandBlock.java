  ...
  extends BlockContainer
{
  ...
  {
    super(Material.iron);
    setDefaultState(this.blockState.getBaseState().withProperty(TRIGGERED_PROP, Boolean.valueOf(false)));
  }
  ...
  {
    return getDefaultState().withProperty(TRIGGERED_PROP, Boolean.valueOf((meta & 0x1) > 0));
  }
  ...
  {
    return getDefaultState().withProperty(TRIGGERED_PROP, Boolean.valueOf(false));
  }
}
