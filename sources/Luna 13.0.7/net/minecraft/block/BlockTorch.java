  ...
  extends Block
{
  ...
  protected BlockTorch()
  {
    ...
    setDefaultState(this.blockState.getBaseState().withProperty(FACING_PROP, EnumFacing.UP));
  ...
  {
    if ((p_176593_3_.getBlock() == this) && (func_176595_b(worldIn, p_176593_2_, (EnumFacing)p_176593_3_.getValue(FACING_PROP)))) {
      return true;
    }
  ...
  public int getMetaFromState(IBlockState state)
  {
    ...
    int var3;
    int var3;
    switch (SwitchEnumFacing.field_176609_a[((EnumFacing)state.getValue(FACING_PROP)).ordinal()])
    {
    case 1: 
      var3 = var2 | 0x1;
      break;
