  ...
  extends BlockBasePressurePlate
{
  ...
  {
    super(p_i45436_2_);
    setDefaultState(this.blockState.getBaseState().withProperty(POWER, Integer.valueOf(0)));
    this.field_150068_a = p_i45436_3_;
  }
  
  protected int computeRedstoneStrength(World worldIn, BlockPos pos)
  {
    int var3 = Math.min(worldIn.getEntitiesWithinAABB(Entity.class, getSensitiveAABB(pos)).size(), this.field_150068_a);
    if (var3 > 0)
    {
      float var4 = Math.min(this.field_150068_a, var3) / this.field_150068_a;
