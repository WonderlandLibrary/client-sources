  ...
  extends Block
{
  ...
  {
    super(Material.tnt);
    setDefaultState(this.blockState.getBaseState().withProperty(field_176246_a, Boolean.valueOf(false)));
  ...
  public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
  {
    if ((!worldIn.isRemote) && ((entityIn instanceof EntityArrow)))
    {
      ...
      if (var5.isBurning())
      {
        func_180692_a(worldIn, pos, worldIn.getBlockState(pos).withProperty(field_176246_a, Boolean.valueOf(true)), (var5.shootingEntity instanceof EntityLivingBase) ? (EntityLivingBase)var5.shootingEntity : null);
        worldIn.setBlockToAir(pos);
      }
    }
  }
