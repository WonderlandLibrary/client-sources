  ...
  extends Block
{
  ...
  {
    super(p_i45402_1_);
    setDefaultState(this.blockState.getBaseState().withProperty(FACING_PROP, EnumFacing.NORTH).withProperty(OPEN_PROP, Boolean.valueOf(false)).withProperty(HINGEPOSITION_PROP, EnumHingePosition.LEFT).withProperty(POWERED_PROP, Boolean.valueOf(false)).withProperty(HALF_PROP, EnumDoorHalf.LOWER));
  }
  ...
  public static enum EnumHingePosition
    implements IStringSerializable
  {
