  ...
  implements IGrowable
{
  ...
  {
    setDefaultState(this.blockState.getBaseState().withProperty(AGE_PROP, Integer.valueOf(0)).withProperty(FACING_PROP, EnumFacing.UP));
  ...
  {
    this.maxY = ((((Integer)access.getBlockState(pos).getValue(AGE_PROP)).intValue() * 2 + 2) / 16.0F);
    float var3 = 0.125F;
    setBlockBounds(0.5F - var3, 0.0F, 0.5F - var3, 0.5F + var3, (float)this.maxY, 0.5F + var3);
  }
  ...
  {
    return this.cropBlock == Blocks.melon_block ? Items.melon_seeds : this.cropBlock == Blocks.pumpkin ? Items.pumpkin_seeds : null;
  }
