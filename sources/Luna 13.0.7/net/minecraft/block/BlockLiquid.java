  ...
  extends Block
{
  ...
  public boolean isBlockSolid(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
  {
    ...
    return var4 == Material.ice ? false : side == EnumFacing.UP ? true : var4 == this.blockMaterial ? false : super.isBlockSolid(worldIn, pos, side);
  }
  
  public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
  {
    return side == EnumFacing.UP ? true : worldIn.getBlockState(pos).getBlock().getMaterial() == this.blockMaterial ? false : super.shouldSideBeRendered(worldIn, pos, side);
  }
  ...
  {
    return this.blockMaterial == Material.lava ? 30 : worldIn.provider.getHasNoSky() ? 10 : this.blockMaterial == Material.water ? 5 : 0;
  }
