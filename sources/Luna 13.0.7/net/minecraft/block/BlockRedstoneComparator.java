  ...
  implements ITileEntityProvider
{
  ...
  {
    super(p_i45399_1_);
    setDefaultState(this.blockState.getBaseState().withProperty(AGE, EnumFacing.NORTH).withProperty(field_176464_a, Boolean.valueOf(false)).withProperty(field_176463_b, Mode.COMPARE));
