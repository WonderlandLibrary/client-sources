  ...
  extends BlockLog
{
  ...
  public BlockOldLog()
  {
    setDefaultState(this.blockState.getBaseState().withProperty(VARIANT_PROP, BlockPlanks.EnumType.OAK).withProperty(AXIS_PROP, BlockLog.EnumAxis.Y));
  }
  ...
  {
    IBlockState var2 = getDefaultState().withProperty(VARIANT_PROP, BlockPlanks.EnumType.func_176837_a((meta & 0x3) % 4));
    switch (meta & 0xC)
    {
    case 0: 
  ...
  public int getMetaFromState(IBlockState state)
  {
    ...
    switch (SwitchEnumAxis.field_180203_a[((BlockLog.EnumAxis)state.getValue(AXIS_PROP)).ordinal()])
    {
    case 1: 
      var3 |= 0x4;
      break;
