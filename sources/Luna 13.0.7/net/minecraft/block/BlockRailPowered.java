  ...
  extends BlockRailBase
{
  ...
  {
    super(true);
    setDefaultState(this.blockState.getBaseState().withProperty(field_176568_b, BlockRailBase.EnumRailDirection.NORTH_SOUTH).withProperty(field_176569_M, Boolean.valueOf(false)));
  }
  ...
  protected boolean func_176566_a(World worldIn, BlockPos p_176566_2_, IBlockState p_176566_3_, boolean p_176566_4_, int p_176566_5_)
  {
    ...
    return func_176567_a(worldIn, new BlockPos(var6, var7, var8), p_176566_4_, p_176566_5_, var10);
  }
  ...
  protected boolean func_176567_a(World worldIn, BlockPos p_176567_2_, boolean p_176567_3_, int p_176567_4_, BlockRailBase.EnumRailDirection p_176567_5_)
  {
    ...
    return (p_176567_5_ != BlockRailBase.EnumRailDirection.EAST_WEST) || ((var7 != BlockRailBase.EnumRailDirection.NORTH_SOUTH) && (var7 != BlockRailBase.EnumRailDirection.ASCENDING_NORTH) && (var7 != BlockRailBase.EnumRailDirection.ASCENDING_SOUTH));
  }
  ...
  {
    return getDefaultState().withProperty(field_176568_b, BlockRailBase.EnumRailDirection.func_177016_a(meta & 0x7)).withProperty(field_176569_M, Boolean.valueOf((meta & 0x8) > 0));
  }
