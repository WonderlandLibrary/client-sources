  ...
  extends Block
{
  ...
  protected BlockCactus()
  {
    ...
    setDefaultState(this.blockState.getBaseState().withProperty(AGE_PROP, Integer.valueOf(0)));
  ...
  public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
  {
    ...
    {
      for (int var6 = 1; worldIn.getBlockState(pos.offsetDown(var6)).getBlock() == this; var6++) {}
      if (var6 < 3)
      {
