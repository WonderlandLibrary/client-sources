...
public class PathEntity
{
  ...
  {
    double var3 = this.points[p_75881_2_].xCoord + (int)(p_75881_1_.width + 1.0F) * 0.5D;
    double var5 = this.points[p_75881_2_].yCoord;
    double var7 = this.points[p_75881_2_].zCoord + (int)(p_75881_1_.width + 1.0F) * 0.5D;
    return new Vec3(var3, var5, var7);
  }
  
  public Vec3 getPosition(Entity p_75878_1_)
  {
    return getVectorFromIndex(p_75878_1_, this.currentPathIndex);
  }
