  ...
  extends PathNavigate
{
  ...
  {
    return (this.theEntity.onGround) || ((func_179684_h()) && (isInLiquid())) || ((this.theEntity.isRiding()) && ((this.theEntity instanceof EntityZombie)) && ((this.theEntity.ridingEntity instanceof EntityChicken)));
  }
  
  protected Vec3 getEntityPosition()
  {
    return new Vec3(this.theEntity.posX, func_179687_p(), this.theEntity.posZ);
  }
  
  private int func_179687_p()
  {
    if ((this.theEntity.isInWater()) && (func_179684_h()))
    {
