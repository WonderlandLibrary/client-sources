...
public class EntityTrackerEntry
{
  ...
  public void updatePlayerList(List p_73122_1_)
  {
    ...
    if (((this.trackedEntity instanceof EntityItemFrame)) && (this.updateCounter % 10 == 0))
    {
      ...
      if ((var3 != null) && ((var3.getItem() instanceof ItemMap)))
      {
        ...
        while (var5.hasNext())
        {
          ...
          Packet<INetHandler> var8 = Items.filled_map.createMapDataPacket(var3, this.trackedEntity.worldObj, var7);
          if (var8 != null) {
    ...
    if ((this.updateCounter % this.updateFrequency == 0) || (this.trackedEntity.isAirBorne) || (this.trackedEntity.getDataWatcher().hasObjectChanged()))
    {
      ...
      {
        this.ticksSinceLastForcedTeleport += 1;
        int var23 = MathHelper.floor_double(this.trackedEntity.posX * 32.0D);
        int var24 = MathHelper.floor_double(this.trackedEntity.posY * 32.0D);
      ...
      else
      {
        ...
        if (var26)
        {
          func_151259_a(new S14PacketEntity.S16PacketEntityLook(this.trackedEntity.getEntityId(), (byte)var23, (byte)var24, this.trackedEntity.onGround));
      ...
      int var23 = MathHelper.floor_float(this.trackedEntity.getRotationYawHead() * 256.0F / 360.0F);
      if (Math.abs(var23 - this.lastHeadMotion) >= 4)
      {
        func_151259_a(new S19PacketEntityHeadLook(this.trackedEntity, (byte)var23));
  ...
  private void sendMetadataToAllAssociatedPlayers()
  {
    ...
    if (var1.hasObjectChanged()) {
      func_151261_b(new S1CPacketEntityMetadata(this.trackedEntity.getEntityId(), var1, false));
    }
    if ((this.trackedEntity instanceof EntityLivingBase))
    {
      ...
      if (!var3.isEmpty()) {
        func_151261_b(new S20PacketEntityProperties(this.trackedEntity.getEntityId(), var3));
      }
      var3.clear();
    }
  }
  
  public void func_151259_a(Packet<INetHandler> p_151259_1_)
  {
  ...
  public void func_151261_b(Packet<INetHandler> p_151261_1_)
  {
  ...
  public void updatePlayerEntity(EntityPlayerMP p_73117_1_)
  {
    if (p_73117_1_ != this.trackedEntity) {
      ...
      {
        if ((!this.trackingPlayers.contains(p_73117_1_)) && ((isPlayerWatchingThisChunk(p_73117_1_)) || (this.trackedEntity.forceSpawn)))
        {
          this.trackingPlayers.add(p_73117_1_);
          Packet<INetHandler> var2 = func_151260_c();
  ...
  public boolean func_180233_c(EntityPlayerMP p_180233_1_)
  {
    ...
    return (var2 >= -this.trackingDistanceThreshold) && (var2 <= this.trackingDistanceThreshold) && (var4 >= -this.trackingDistanceThreshold) && (var4 <= this.trackingDistanceThreshold) && (this.trackedEntity.func_174827_a(p_180233_1_));
  }
  ...
  private Packet<INetHandler> func_151260_c()
  {
