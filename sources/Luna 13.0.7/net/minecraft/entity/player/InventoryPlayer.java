  ...
  implements IInventory
{
  ...
  public void setCurrentItem(Item p_146030_1_, int p_146030_2_, boolean p_146030_3_, boolean p_146030_4_)
  {
    ...
    else if ((p_146030_4_) && (p_146030_1_ != null))
    {
      ...
      if ((var5 == null) || (!var5.isItemEnchantable()) || (getInventorySlotContainItemAndDamage(var5.getItem(), var5.getItemDamage()) != this.currentItem))
      {
  ...
  public int func_174925_a(Item p_174925_1_, int p_174925_2_, int p_174925_3_, NBTTagCompound p_174925_4_)
  {
    ...
    for (int var6 = 0; var6 < this.mainInventory.length; var6++)
    {
      ...
      {
        int var8 = p_174925_3_ <= 0 ? var7.stackSize : Math.min(p_174925_3_ - var5, var7.stackSize);
        var5 += var8;
        if (p_174925_3_ != 0)
        {
    ...
    {
      ItemStack var7 = this.armorInventory[var6];
  ...
  private int storePartialItemStack(ItemStack p_70452_1_)
  {
    ...
    if (var5 > getInventoryStackLimit() - this.mainInventory[var4].stackSize) {
      var5 = getInventoryStackLimit() - this.mainInventory[var4].stackSize;
    }
    if (var5 == 0) {
      return var3;
    }
  ...
  public boolean func_146025_b(Block p_146025_1_)
  {
    ...
    ItemStack var2 = getStackInSlot(this.currentItem);
