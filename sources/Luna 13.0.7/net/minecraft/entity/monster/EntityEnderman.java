  ...
  extends EntityMob
{
  ...
  private boolean shouldAttackPlayer(EntityPlayer p_70821_1_)
  {
    ...
    Vec3 var4 = new Vec3(this.posX - p_70821_1_.posX, getEntityBoundingBox().minY + this.height / 2.0F - (p_70821_1_.posY + p_70821_1_.getEyeHeight()), this.posZ - p_70821_1_.posZ);
  ...
  {
    Vec3 var2 = new Vec3(this.posX - p_70816_1_.posX, getEntityBoundingBox().minY + this.height / 2.0F - p_70816_1_.posY + p_70816_1_.getEyeHeight(), this.posZ - p_70816_1_.posZ);
    var2 = var2.normalize();
    double var3 = 16.0D;
  ...
  protected boolean teleportTo(double p_70825_1_, double p_70825_3_, double p_70825_5_)
  {
    ...
    for (int var29 = 0; var29 < var28; var29++)
    {
      ...
      double var22 = var7 + (this.posX - var7) * var30 + (this.rand.nextDouble() - 0.5D) * this.width * 2.0D;
      double var24 = var9 + (this.posY - var9) * var30 + this.rand.nextDouble() * this.height;
      double var26 = var11 + (this.posZ - var11) * var30 + (this.rand.nextDouble() - 0.5D) * this.width * 2.0D;
      this.worldObj.spawnParticle(EnumParticleTypes.PORTAL, var22, var24, var26, var19, var20, var21, new int[0]);
    }
  ...
  {
    this.dataWatcher.updateObject(16, Short.valueOf((short)(Block.getStateId(p_175490_1_) & 0xFFFF)));
  }
    ...
    extends EntityAIBase
  {
    ...
    public boolean shouldExecute()
    {
      return this.field_179475_a.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing");
    }
    ...
    public void updateTask()
    {
      ...
      if (func_179474_a(var2, var6, this.field_179475_a.func_175489_ck().getBlock(), var7, var8))
      {
    ...
    extends EntityAIBase
  {
    ...
    public boolean shouldExecute()
    {
      return this.field_179473_a.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing");
    }
