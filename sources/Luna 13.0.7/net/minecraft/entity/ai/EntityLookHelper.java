...
public class EntityLookHelper
{
  ...
  public void onUpdateLook()
  {
    ...
    if (this.isLooking)
    {
      ...
      this.entity.rotationPitch = updateRotation(this.entity.rotationPitch, var10, this.deltaLookPitch);
      this.entity.rotationYawHead = updateRotation(this.entity.rotationYawHead, var9, this.deltaLookYaw);
    }
    else
    {
