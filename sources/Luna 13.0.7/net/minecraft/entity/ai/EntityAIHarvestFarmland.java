  ...
  extends EntityAIMoveToBlock
{
  ...
  {
    super.updateTask();
    this.field_179504_c.getLookHelper().setLookPosition(this.field_179494_b.getX() + 0.5D, this.field_179494_b.getY() + 1, this.field_179494_b.getZ() + 0.5D, 10.0F, this.field_179504_c.getVerticalFaceSpeed());
    if (func_179487_f())
    {
      ...
      else if ((this.field_179501_f == 1) && (var4 == Blocks.air))
      {
        ...
        for (int var6 = 0; var6 < var5.getSizeInventory(); var6++)
        {
          ...
          if (var8)
          {
            ...
            var5.setInventorySlotContents(var6, (ItemStack)null); break;
          }
        }
      }
      this.field_179501_f = -1;
