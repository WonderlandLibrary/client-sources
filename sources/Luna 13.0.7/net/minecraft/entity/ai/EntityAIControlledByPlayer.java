  ...
  extends EntityAIBase
{
  ...
  public void updateTask()
  {
    ...
    if ((var4 != var17) || (var6 != var18))
    {
      ...
      boolean var23 = (!isStairOrSlab(var22)) && ((var22.getMaterial() != Material.air) || (!isStairOrSlab(this.thisEntity.worldObj.getBlockState(new BlockPos(var4, var5 - 1, var6)).getBlock())));
