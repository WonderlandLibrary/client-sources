  ...
  extends Entity
{
  ...
  public void onUpdate()
  {
    ...
    float var13 = 0.98F;
    if (this.onGround) {
      var13 = this.worldObj.getBlockState(new BlockPos(MathHelper.floor_double(this.posX), MathHelper.floor_double(getEntityBoundingBox().minY) - 1, MathHelper.floor_double(this.posZ))).getBlock().slipperiness * 0.98F;
    }
    this.motionX *= var13;
  ...
  {
    return this.worldObj.handleMaterialAcceleration(getEntityBoundingBox(), Material.water, this);
  }
  ...
  {
    return this.xpValue >= 3 ? 1 : this.xpValue >= 7 ? 2 : this.xpValue >= 17 ? 3 : this.xpValue >= 37 ? 4 : this.xpValue >= 73 ? 5 : this.xpValue >= 149 ? 6 : this.xpValue >= 307 ? 7 : this.xpValue >= 617 ? 8 : this.xpValue >= 1237 ? 9 : this.xpValue >= 2477 ? 10 : 0;
  }
