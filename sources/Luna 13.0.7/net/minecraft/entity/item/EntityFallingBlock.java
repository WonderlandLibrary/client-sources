  ...
  extends Entity
{
      ...
      if (!this.worldObj.isRemote)
      {
        ...
        if (this.onGround)
        {
          ...
          if (this.worldObj.getBlockState(var2).getBlock() != Blocks.piston_extension)
          {
            ...
            {
              entityDropItem(new ItemStack(var1, 1, var1.damageDropped(this.field_175132_d)), 0.0F);
            }
          }
        }
  ...
  public void fall(float distance, float damageMultiplier)
  {
    ...
    if (this.hurtEntities)
    {
      ...
      if (var4 > 0)
      {
        ArrayList var5 = Lists.newArrayList(this.worldObj.getEntitiesWithinAABBExcludingEntity(this, getEntityBoundingBox()));
