...
import space.lunaclient.luna.impl.elements.movement.WebMove;
import space.lunaclient.luna.impl.elements.movement.flight.Flight;
  ...
  implements ICommandSender
{
  ...
  public void moveEntity(double x, double y, double z)
  {
    ...
    else
    {
      ...
      {
        this.isInWeb = false;
        x *= (Luna.INSTANCE.ELEMENT_MANAGER.getElement(WebMove.class).isToggled() ? WebMove.speed.getValDouble() : 0.25D);
        y *= 0.05000000074505806D;
        z *= (Luna.INSTANCE.ELEMENT_MANAGER.getElement(WebMove.class).isToggled() ? WebMove.speed.getValDouble() : 0.25D);
        this.motionX = 0.0D;
        this.motionY = 0.0D;
        this.motionZ = 0.0D;
      }
      ...
      boolean var19 = ((this.onGround) && (isSneaking()) && ((this instanceof EntityPlayer))) || ((Luna.INSTANCE.ELEMENT_MANAGER.getElement(Scaffold.class).isToggled()) && (!Minecraft.thePlayer.isJumping) && ((BlockUtils.getBlockUnderPlayer(Minecraft.thePlayer, 1.0D) instanceof BlockAir)));
      if (var19)
      {
        for (double var20 = 0.05D; (x != 0.0D) && (this.worldObj.getCollidingBoundingBoxes(this, getEntityBoundingBox().offset(x, -1.0D, 0.0D)).isEmpty()); var13 = x) {
          if ((x < var20) && (x >= -var20)) {
            x = 0.0D;
          } else if (x > 0.0D) {
            x -= var20;
        ...
        for (; (z != 0.0D) && (this.worldObj.getCollidingBoundingBoxes(this, getEntityBoundingBox().offset(0.0D, -1.0D, z)).isEmpty()); var17 = z) {
          if ((z < var20) && (z >= -var20)) {
            z = 0.0D;
          } else if (z > 0.0D) {
            z -= var20;
        ...
        for (; (x != 0.0D) && (z != 0.0D) && (this.worldObj.getCollidingBoundingBoxes(this, getEntityBoundingBox().offset(x, -1.0D, z)).isEmpty()); var17 = z)
        {
          if ((x < var20) && (x >= -var20)) {
            x = 0.0D;
          } else if (x > 0.0D) {
      ...
      this.onGround = (((Luna.INSTANCE.ELEMENT_MANAGER.getElement(Flight.class).isToggled() & Flight.mode.getValString().equalsIgnoreCase("Hypixel"))) || ((Luna.INSTANCE.ELEMENT_MANAGER.getElement(Flight.class).isToggled() & Flight.mode.getValString().equalsIgnoreCase("SkyGiants"))) || ((this.isCollidedVertically) && (var15 < 0.0D)));
      ...
      func_180433_a(y, this.onGround, var60, var26);
      if (var13 != x) {
        this.motionX = 0.0D;
      }
      if (var17 != z) {
      ...
      if ((canTriggerWalking()) && (!var19) && (this.ridingEntity == null))
      {
        ...
        if ((this.distanceWalkedOnStepModified > this.nextStepDistance) && (var60.getMaterial() != Material.air))
        {
          ...
          if (isInWater())
          {
            ...
            playSound(getSwimSound(), var34, 1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.4F);
          }
  ...
  {
    BlockPos var1 = new BlockPos(getEntityBoundingBox().minX + 0.001D, getEntityBoundingBox().minY + 0.001D, getEntityBoundingBox().minZ + 0.001D);
    BlockPos var2 = new BlockPos(getEntityBoundingBox().maxX - 0.001D, getEntityBoundingBox().maxY - 0.001D, getEntityBoundingBox().maxZ - 0.001D);
  ...
  protected void resetHeight()
  {
    ...
    playSound(getSplashSound(), var1, 1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.4F);
  ...
  protected void func_174808_Z()
  {
    ...
    if (var6.getRenderType() != -1) {
      this.worldObj.spawnParticle(EnumParticleTypes.BLOCK_CRACK, this.posX + (this.rand.nextFloat() - 0.5D) * this.width, getEntityBoundingBox().minY + 0.1D, this.posZ + (this.rand.nextFloat() - 0.5D) * this.width, -this.motionX * 4.0D, 1.5D, -this.motionZ * 4.0D, new int[] { Block.getStateId(var5) });
    }
  }
  ...
  {
    double var2 = this.posY + getEyeHeight();
  ...
  {
    if (p_70676_1_ == 1.0F) {
      return func_174806_f(this.rotationPitch, this.rotationYaw);
    }
  ...
  public Vec3 func_174824_e(float p_174824_1_)
  {
    ...
    double var2 = this.prevPosX + (this.posX - this.prevPosX) * p_174824_1_;
    double var4 = this.prevPosY + (this.posY - this.prevPosY) * p_174824_1_ + getEyeHeight();
    double var6 = this.prevPosZ + (this.posZ - this.prevPosZ) * p_174824_1_;
  ...
  public void writeToNBT(NBTTagCompound tagCompund)
  {
    try
    {
      tagCompund.setTag("Pos", newDoubleNBTList(new double[] { this.posX, this.posY, this.posZ }));
      tagCompund.setTag("Motion", newDoubleNBTList(new double[] { this.motionX, this.motionY, this.motionZ }));
      tagCompund.setTag("Rotation", newFloatNBTList(new float[] { this.rotationYaw, this.rotationPitch }));
  ...
  public boolean isEntityInsideOpaqueBlock()
  {
    ...
    for (int var1 = 0; var1 < 8; var1++)
    {
      ...
      if (this.worldObj.getBlockState(new BlockPos(var2, var4 + getEyeHeight(), var6)).getBlock().isVisuallyOpaque()) {
        return true;
      }
    }
    return false;
  ...
  public void func_180426_a(double p_180426_1_, double p_180426_3_, double p_180426_5_, float p_180426_7_, float p_180426_8_, int p_180426_9_, boolean p_180426_10_)
  {
    ...
    List var11 = this.worldObj.getCollidingBoundingBoxes(this, getEntityBoundingBox().contract(0.03125D, 0.0D, 0.03125D));
    if (!var11.isEmpty())
    {
      double var12 = 0.0D;
  ...
  public boolean isBurning()
  {
    ...
    return (!this.isImmuneToFire) && ((this.fire > 0) || ((var1) && (getFlag(0))));
  }
  ...
  protected void setFlag(int flag, boolean set)
  {
    ...
    if (set) {
      ...
      this.dataWatcher.updateObject(0, Byte.valueOf((byte)(var3 & (1 << flag ^ 0xFFFFFFFF))));
    }
  }
  ...
  protected boolean pushOutOfBlocks(double x, double y, double z)
  {
    ...
    List var14 = this.worldObj.func_147461_a(getEntityBoundingBox());
  ...
  {
    setLocationAndAngles(p_70634_1_, p_70634_3_, p_70634_5_, this.rotationYaw, this.rotationPitch);
  }
