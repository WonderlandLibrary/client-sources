  ...
  extends EntityAnimal
{
  ...
  public void updateAITasks()
  {
    ...
    if (this.onGround)
    {
      ...
      if ((func_175531_cl() == 99) && (this.field_175538_bq == 0))
      {
      ...
      RabbitJumpHelper var4 = (RabbitJumpHelper)this.jumpHelper;
  ...
  {
    this.rotationYaw = ((float)(Math.atan2(p_175533_3_ - this.posZ, p_175533_1_ - this.posX) * 180.0D / 3.141592653589793D) - 90.0F);
  }
  ...
  public EntityRabbit func_175526_b(EntityAgeable p_175526_1_)
  {
    ...
    if ((p_175526_1_ instanceof EntityRabbit)) {
      var2.func_175529_r(this.rand.nextBoolean() ? func_175531_cl() : ((EntityRabbit)p_175526_1_).func_175531_cl());
    }
    return var2;
  }
