  ...
  implements INpc, IMerchant
{
  ...
  protected void updateAITasks()
  {
    if (--this.randomTickDivider <= 0)
    {
      ...
      else
      {
        ...
        func_175449_a(var2, (int)(this.villageObj.getVillageRadius() * 1.0F));
  ...
  {
    if ((!this.field_175565_bs) && (p_175550_1_) && (func_175553_cp()))
    {
      boolean var2 = false;
      for (int var3 = 0; var3 < this.field_175560_bz.getSizeInventory(); var3++)
      {
  ...
  private void func_180489_a(EnumParticleTypes p_180489_1_)
  {
    for (int var2 = 0; var2 < 5; var2++)
    {
      ...
      this.worldObj.spawnParticle(p_180489_1_, this.posX + this.rand.nextFloat() * this.width * 2.0F - this.width, this.posY + 1.0D + this.rand.nextFloat() * this.height, this.posZ + this.rand.nextFloat() * this.width * 2.0F - this.width, var3, var5, var7, new int[0]);
    }
  }
