  ...
  extends EntityAnimal
{
  ...
  {
    return this.sheepTimer < 4 ? (this.sheepTimer - p_70894_1_) / 4.0F : (this.sheepTimer >= 4) && (this.sheepTimer <= 36) ? 1.0F : this.sheepTimer <= 0 ? 0.0F : -(this.sheepTimer - 40 - p_70894_1_) / 4.0F;
  }
  ...
  public void func_175512_b(EnumDyeColor p_175512_1_)
  {
    ...
    this.dataWatcher.updateObject(16, Byte.valueOf((byte)(var2 & 0xF0 | p_175512_1_.func_176765_a() & 0xF)));
  }
  ...
  public void setSheared(boolean p_70893_1_)
  {
    byte var2 = this.dataWatcher.getWatchableObjectByte(16);
    if (p_70893_1_) {
      this.dataWatcher.updateObject(16, Byte.valueOf((byte)(var2 | 0x10)));
    } else {
      this.dataWatcher.updateObject(16, Byte.valueOf((byte)(var2 & 0xFFFFFFEF)));
    }
  }
  ...
  public IEntityLivingData func_180482_a(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_)
  {
    ...
    func_175512_b(func_175510_a(this.worldObj.rand));
    return p_180482_2_;
  }
