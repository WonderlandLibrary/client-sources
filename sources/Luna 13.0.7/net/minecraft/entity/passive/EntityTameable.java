  ...
  implements IEntityOwnable
{
  ...
  public void setTamed(boolean p_70903_1_)
  {
    ...
    if (p_70903_1_) {
      this.dataWatcher.updateObject(16, Byte.valueOf((byte)(var2 | 0x4)));
    } else {
      this.dataWatcher.updateObject(16, Byte.valueOf((byte)(var2 & 0xFFFFFFFB)));
    }
    func_175544_ck();
  }
  ...
  {
    if ((!this.worldObj.isRemote) && (this.worldObj.getGameRules().getGameRuleBooleanValue("showDeathMessages")) && (hasCustomName()) && ((func_180492_cm() instanceof EntityPlayerMP))) {
