...
public class RecipesBanners
{
  ...
  void func_179534_a(CraftingManager p_179534_1_)
  {
    ...
    for (int var4 = 0; var4 < var3; var4++)
    {
      ...
      p_179534_1_.addRecipe(new ItemStack(Items.banner, 1, var5.getDyeColorDamage()), new Object[] { "###", "###", " | ", Character.valueOf('#'), new ItemStack(Blocks.wool, 1, var5.func_176765_a()), Character.valueOf('|'), Items.stick });
    }
