  ...
  public void addRecipes(CraftingManager p_77586_1_)
  {
    for (int var2 = 0; var2 < this.recipeItems[0].length; var2++)
    {
      ...
      for (int var4 = 0; var4 < this.recipeItems.length - 1; var4++)
      {
        ...
        p_77586_1_.addRecipe(new ItemStack(var5), new Object[] { this.recipePatterns[var4], Character.valueOf('#'), Items.stick, Character.valueOf('X'), var3 });
      }
    }
    p_77586_1_.addRecipe(new ItemStack(Items.shears), new Object[] { " #", "# ", Character.valueOf('#'), Items.iron_ingot });
  }
}
