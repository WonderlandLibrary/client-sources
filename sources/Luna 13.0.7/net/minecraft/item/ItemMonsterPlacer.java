  ...
  extends Item
{
  ...
  {
    String var2 = ("" + StatCollector.translateToLocal(new StringBuilder().append(getUnlocalizedName()).append(".name").toString())).trim();
    String var3 = EntityList.getStringFromID(stack.getMetadata());
    if (var3 != null) {
      var2 = var2 + " " + StatCollector.translateToLocal(new StringBuilder().append("entity.").append(var3).append(".name").toString());
    }
    return var2;
  }
  ...
  public int getColorFromItemStack(ItemStack stack, int renderPass)
  {
    ...
    return var3 != null ? var3.secondaryColor : renderPass == 0 ? var3.primaryColor : 16777215;
  }
