...
public class CrashReportCategory
{
  ...
  public boolean firstTwoElementsOfStackTraceMatch(StackTraceElement s1, StackTraceElement s2)
  {
    if ((this.stackTrace.length != 0) && (s1 != null))
    {
      ...
      {
        if ((s2 != null ? 1 : 0) != (this.stackTrace.length > 1 ? 1 : 0)) {
          return false;
        }
  ...
  public static void addBlockInfo(CrashReportCategory category, BlockPos pos, final Block blockIn, int blockData)
  {
    ...
    category.addCrashSectionCallable("Block type", new Callable()
    {
      ...
      public String call()
      {
        try
        {
          return String.format("ID #%d (%s // %s)", new Object[] { Integer.valueOf(this.val$var4), blockIn.getUnlocalizedName(), blockIn.getClass().getCanonicalName() });
        }
    ...
    category.addCrashSectionCallable("Block data value", new Callable()
    {
      ...
      public String call()
      {
        ...
        String var1 = String.format("%4s", new Object[] { Integer.toBinaryString(this.val$blockData) }).replace(" ", "0");
        return String.format("%1$d / 0x%1$X / 0b%2$s", new Object[] { Integer.valueOf(this.val$blockData), var1 });
      }
    });
