...
public class ItemInWorldManager
{
  ...
  public void updateBlockRemoving()
  {
    ...
    if (this.receivedFinishDiggingPacket)
    {
      ...
      {
        float var3 = var2.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.worldObj, this.field_180241_i) * (var1 + 1);
    ...
    else if (this.isDestroyingBlock)
    {
      ...
      else
      {
        ...
        float var3 = var5.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.worldObj, this.field_180241_i) * (var6 + 1);
        int var4 = (int)(var3 * 10.0F);
        if (var4 != this.durabilityRemainingOnBlock)
        {
  ...
  public void func_180785_a(BlockPos p_180785_1_)
  {
    if (p_180785_1_.equals(this.field_180240_f))
    {
      ...
      if (var3.getMaterial() != Material.air)
      {
        float var4 = var3.getPlayerRelativeBlockHardness(this.thisPlayerMP, this.thisPlayerMP.worldObj, p_180785_1_) * (var2 + 1);
        if (var4 >= 0.7F)
        {
          this.isDestroyingBlock = false;
