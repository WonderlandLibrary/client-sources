...
public class StructureOceanMonumentPieces
{
    ...
    extends StructureOceanMonumentPieces.Piece
  {
    ...
    {
      if (this.field_175830_k.field_175967_a / 25 > 0) {
        func_175821_a(worldIn, p_74875_3_, 0, 0, this.field_175830_k.field_175966_c[EnumFacing.DOWN.getIndex()]);
      }
      ...
      for (int var6 = 1; var6 <= 5; var6 += 4)
      {
        ...
        var8 = 7;
        if (var5.field_175966_c[EnumFacing.EAST.getIndex()] != 0)
        {
          func_175804_a(worldIn, p_74875_3_, var8, var6, 2, var8, var6 + 2, 2, field_175826_b, field_175826_b, false);
          func_175804_a(worldIn, p_74875_3_, var8, var6, 5, var8, var6 + 2, 5, field_175826_b, field_175826_b, false);
          func_175804_a(worldIn, p_74875_3_, var8, var6 + 2, 3, var8, var6 + 2, 4, field_175826_b, field_175826_b, false);
    ...
    extends StructureOceanMonumentPieces.Piece
  {
    ...
    public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
      ...
      if (var4.field_175966_c[EnumFacing.WEST.getIndex()] != 0) {
      ...
      if (var7.field_175966_c[EnumFacing.WEST.getIndex()] != 0)
      {
        func_175804_a(worldIn, p_74875_3_, 0, 5, 3, 0, 6, 4, field_175822_f, field_175822_f, false);
      ...
      if (var6.field_175966_c[EnumFacing.EAST.getIndex()] != 0)
      {
    ...
    extends StructureOceanMonumentPieces.Piece
  {
    ...
    public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
      ...
      if (this.field_175830_k.field_175966_c[EnumFacing.NORTH.getIndex()] != 0) {
        func_175804_a(worldIn, p_74875_3_, 3, 1, 7, 4, 2, 7, field_175822_f, field_175822_f, false);
      }
      if (this.field_175830_k.field_175966_c[EnumFacing.WEST.getIndex()] != 0) {
        func_175804_a(worldIn, p_74875_3_, 0, 1, 3, 1, 2, 4, field_175822_f, field_175822_f, false);
      }
      if (this.field_175830_k.field_175966_c[EnumFacing.EAST.getIndex()] != 0) {
    ...
    implements StructureOceanMonumentPieces.MonumentRoomFitHelper
  {
    ...
    public boolean func_175969_a(StructureOceanMonumentPieces.RoomDefinition p_175969_1_)
    {
      return (p_175969_1_.field_175966_c[EnumFacing.WEST.getIndex()] == 0) && (p_175969_1_.field_175966_c[EnumFacing.EAST.getIndex()] == 0) && (p_175969_1_.field_175966_c[EnumFacing.NORTH.getIndex()] == 0) && (p_175969_1_.field_175966_c[EnumFacing.SOUTH.getIndex()] == 0) && (p_175969_1_.field_175966_c[EnumFacing.UP.getIndex()] == 0);
    }
    ...
    private List func_175836_a(Random p_175836_1_)
    {
      ...
      for (; var22.hasNext(); goto 789)
      {
        ...
        while ((var25 < 2) && (var11 < 5))
        {
          ...
          if (var23.field_175966_c[var12] != 0)
          {
  ...
  static class RoomDefinition
  {
    ...
    public void func_175958_a()
    {
      for (int var1 = 0; var1 < 6; var1++) {
        this.field_175966_c[var1] = (this.field_175965_b[var1] != null ? 1 : false);
      }
    }
    ...
    public boolean func_175959_a(int p_175959_1_)
    {
      ...
      for (int var2 = 0; var2 < 6; var2++) {
        if ((this.field_175965_b[var2] != null) && (this.field_175966_c[var2] != 0) && (this.field_175965_b[var2].field_175962_f != p_175959_1_) && (this.field_175965_b[var2].func_175959_a(p_175959_1_))) {
          return true;
        }
      }
      return false;
    ...
    extends StructureOceanMonumentPieces.Piece
  {
    ...
    public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
      ...
      boolean var4 = (this.field_175833_o != 0) && (p_74875_2_.nextBoolean()) && (this.field_175830_k.field_175966_c[EnumFacing.DOWN.getIndex()] == 0) && (this.field_175830_k.field_175966_c[EnumFacing.UP.getIndex()] == 0) && (this.field_175830_k.func_175960_c() > 1);
      if (this.field_175833_o == 0)
      {
        ...
        if (this.field_175830_k.field_175966_c[EnumFacing.SOUTH.getIndex()] != 0)
        {
    ...
    implements StructureOceanMonumentPieces.MonumentRoomFitHelper
  {
    ...
    public boolean func_175969_a(StructureOceanMonumentPieces.RoomDefinition p_175969_1_)
    {
      return (p_175969_1_.field_175966_c[EnumFacing.EAST.getIndex()] != 0) && (!p_175969_1_.field_175965_b[EnumFacing.EAST.getIndex()].field_175963_d);
    }
    ...
    implements StructureOceanMonumentPieces.MonumentRoomFitHelper
  {
    ...
    public boolean func_175969_a(StructureOceanMonumentPieces.RoomDefinition p_175969_1_)
    {
      if ((p_175969_1_.field_175966_c[EnumFacing.EAST.getIndex()] != 0) && (!p_175969_1_.field_175965_b[EnumFacing.EAST.getIndex()].field_175963_d) && (p_175969_1_.field_175966_c[EnumFacing.UP.getIndex()] != 0) && (!p_175969_1_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d))
      {
        StructureOceanMonumentPieces.RoomDefinition var2 = p_175969_1_.field_175965_b[EnumFacing.EAST.getIndex()];
        return (var2.field_175966_c[EnumFacing.UP.getIndex()] != 0) && (!var2.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d);
      }
      return false;
    }
    ...
    implements StructureOceanMonumentPieces.MonumentRoomFitHelper
  {
    ...
    public boolean func_175969_a(StructureOceanMonumentPieces.RoomDefinition p_175969_1_)
    {
      return (p_175969_1_.field_175966_c[EnumFacing.UP.getIndex()] != 0) && (!p_175969_1_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d);
    }
    ...
    implements StructureOceanMonumentPieces.MonumentRoomFitHelper
  {
    ...
    public boolean func_175969_a(StructureOceanMonumentPieces.RoomDefinition p_175969_1_)
    {
      if ((p_175969_1_.field_175966_c[EnumFacing.NORTH.getIndex()] != 0) && (!p_175969_1_.field_175965_b[EnumFacing.NORTH.getIndex()].field_175963_d) && (p_175969_1_.field_175966_c[EnumFacing.UP.getIndex()] != 0) && (!p_175969_1_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d))
      {
    ...
    implements StructureOceanMonumentPieces.MonumentRoomFitHelper
  {
    ...
    public boolean func_175969_a(StructureOceanMonumentPieces.RoomDefinition p_175969_1_)
    {
      return (p_175969_1_.field_175966_c[EnumFacing.NORTH.getIndex()] != 0) && (!p_175969_1_.field_175965_b[EnumFacing.NORTH.getIndex()].field_175963_d);
    }
    
    public StructureOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, StructureOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
    {
      StructureOceanMonumentPieces.RoomDefinition var4 = p_175968_2_;
      if ((p_175968_2_.field_175966_c[EnumFacing.NORTH.getIndex()] == 0) || (p_175968_2_.field_175965_b[EnumFacing.NORTH.getIndex()].field_175963_d)) {
