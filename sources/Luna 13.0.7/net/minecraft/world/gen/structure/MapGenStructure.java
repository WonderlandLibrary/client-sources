  ...
  private void func_143027_a(World worldIn)
  {
    if (this.field_143029_e == null)
    {
      if (Reflector.ForgeWorld_getPerWorldStorage.exists())
      {
        ...
        this.field_143029_e = ((MapGenStructureData)var2.loadData(MapGenStructureData.class, getStructureName()));
      }
      else
      {
        this.field_143029_e = ((MapGenStructureData)worldIn.loadItemData(MapGenStructureData.class, getStructureName()));
      }
      if (this.field_143029_e == null)
      {
        this.field_143029_e = new MapGenStructureData(getStructureName());
        if (Reflector.ForgeWorld_getPerWorldStorage.exists())
        {
          MapStorage var2 = (MapStorage)Reflector.call(worldIn, Reflector.ForgeWorld_getPerWorldStorage, new Object[0]);
          var2.setData(getStructureName(), this.field_143029_e);
        }
        else
        {
          worldIn.setItemData(getStructureName(), this.field_143029_e);
        }
      }
      else
      {
