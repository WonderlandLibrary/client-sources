  ...
  extends MapGenStructure
{
  ...
  protected boolean canSpawnStructureAtCoords(int p_75047_1_, int p_75047_2_)
  {
    if (!this.ranBiomeCheck)
    {
      ...
      {
        double var8 = (1.25D * var6 + var3.nextDouble()) * this.field_82671_h * var6;
        ...
        var4 += 6.283185307179586D * var6 / this.field_82672_i;
  ...
  {
    for (Start var3 = new Start(this.worldObj, this.rand, p_75049_1_, p_75049_2_); (var3.getComponents().isEmpty()) || (((StructureStrongholdPieces.Stairs2)var3.getComponents().get(0)).strongholdPortalRoom == null); var3 = new Start(this.worldObj, this.rand, p_75049_1_, p_75049_2_)) {}
    return var3;
  }
