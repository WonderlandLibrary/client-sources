      ...
      for (int var8 = 0; var8 < areaWidth; var8++)
      {
        ...
        } else if (var9 == 1)
        {
          if (var10 > 0)
          {
            ...
            var6[(var8 + var7 * areaWidth)] = this.field_151623_c[nextInt(this.field_151623_c.length)].biomeID;
          }
        }
        else if (var9 == 2)
        {
          if (var10 > 0) {
            ...
            var6[(var8 + var7 * areaWidth)] = this.field_151621_d[nextInt(this.field_151621_d.length)].biomeID;
          }
        }
        else if (var9 == 3)
        {
          if (var10 > 0) {
            ...
            var6[(var8 + var7 * areaWidth)] = this.field_151622_e[nextInt(this.field_151622_e.length)].biomeID;
          }
        }
        else if (var9 == 4) {
          var6[(var8 + var7 * areaWidth)] = this.field_151620_f[nextInt(this.field_151620_f.length)].biomeID;
        } else {
