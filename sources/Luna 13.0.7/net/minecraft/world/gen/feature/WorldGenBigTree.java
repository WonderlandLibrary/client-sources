  ...
  extends WorldGenAbstractTree
{
  ...
  void generateLeafNodeList()
  {
    ...
    for (; var3 >= 0; var3--)
    {
      ...
      if (var4 >= 0.0F) {
        ...
        {
          double var6 = this.field_175945_e * var4 * (this.field_175949_k.nextFloat() + 0.328D);
          double var8 = this.field_175949_k.nextFloat() * 2.0F * 3.141592653589793D;
          double var10 = var6 * Math.sin(var8) + 0.5D;
          double var12 = var6 * Math.cos(var8) + 0.5D;
          BlockPos var14 = this.field_175947_m.add(var10, var3 - 1, var12);
          ...
          if (func_175936_a(var14, var15) == -1)
          {
            ...
            double var18 = var14.getY() - Math.sqrt(var16 * var16 + var17 * var17) * this.field_175944_d;
      ...
      for (int var6 = -var4; var6 <= var4; var6++) {
        if (Math.pow(Math.abs(var5) + 0.5D, 2.0D) + Math.pow(Math.abs(var6) + 0.5D, 2.0D) <= p_180712_2_ * p_180712_2_)
        {
          ...
          if ((var8 == Material.air) || (var8 == Material.leaves)) {
            func_175905_a(this.field_175946_l, var7, p_180712_3_, 0);
          }
        }
      }
    }
  ...
  {
    return (p_76495_1_ >= 0) && (p_76495_1_ < this.leafDistanceLimit) ? 2.0F : (p_76495_1_ != 0) && (p_76495_1_ != this.leafDistanceLimit - 1) ? 3.0F : -1.0F;
  }
  ...
  void func_175937_a(BlockPos p_175937_1_, BlockPos p_175937_2_, Block p_175937_3_)
  {
    ...
    for (int var9 = 0; var9 <= var5; var9++)
    {
      ...
      func_175903_a(this.field_175946_l, var10, p_175937_3_.getDefaultState().withProperty(BlockLog.AXIS_PROP, var11));
    }
  }
  ...
  void func_175939_d()
  {
    ...
    while (var1.hasNext())
    {
      ...
      if (leafNodeNeedsBase(var3 - this.field_175947_m.getY())) {
  ...
  int func_175936_a(BlockPos p_175936_1_, BlockPos p_175936_2_)
  {
    ...
    for (int var8 = 0; var8 <= var4; var8++)
    {
      ...
      if (!func_150523_a(this.field_175946_l.getBlockState(var9).getBlock())) {
        return var8;
      }
    }
    return -1;
  ...
  private boolean validTreeLocation()
  {
    ...
    int var2 = func_175936_a(this.field_175947_m, this.field_175947_m.offsetUp(this.heightLimit - 1));
    if (var2 == -1) {
      return true;
    }
    if (var2 < 6) {
