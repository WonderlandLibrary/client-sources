    ...
    if ((p_180709_3_.getY() >= 1) && (p_180709_3_.getY() + var4 + 1 <= 256))
    {
      ...
      if (((var20 == Blocks.grass) || (var20 == Blocks.dirt)) && (p_180709_3_.getY() < 256 - var4 - 1))
      {
        ...
        for (int var13 = 0; var13 < var4; var13++)
        {
          ...
          {
            func_175905_a(worldIn, var15, Blocks.log2, BlockPlanks.EnumType.ACACIA.func_176839_a() - 4);
            var12 = var14;
          }
        }
        ...
        if (var23 != var21)
        {
          ...
          for (int var25 = var14; (var25 < var4) && (var24 > 0); var24--)
          {
            if (var25 >= 1)
            {
              ...
              {
                func_175905_a(worldIn, var18, Blocks.log2, BlockPlanks.EnumType.ACACIA.func_176839_a() - 4);
                var12 = var17;
              }
            }
            var25++;
