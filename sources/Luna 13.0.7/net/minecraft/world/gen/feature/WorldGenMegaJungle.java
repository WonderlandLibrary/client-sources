  ...
  public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_)
  {
    ...
    for (int var5 = p_180709_3_.getY() + var4 - 2 - p_180709_2_.nextInt(4); var5 > p_180709_3_.getY() + var4 / 2; var5 -= 2 + p_180709_2_.nextInt(4))
    {
      ...
      for (int var9 = 0; var9 < 5; var9++)
      {
        ...
        func_175905_a(worldIn, new BlockPos(var7, var5 - 3 + var9 / 2, var8), Blocks.log, this.woodMetadata);
      }
    ...
    for (int var13 = 0; var13 < var4; var13++)
    {
      ...
      {
        func_175905_a(worldIn, var14, Blocks.log, this.woodMetadata);
        if (var13 > 0)
        {
      ...
      if (var13 < var4 - 1)
      {
        ...
        {
          func_175905_a(worldIn, var15, Blocks.log, this.woodMetadata);
          if (var13 > 0)
          {
        ...
        {
          func_175905_a(worldIn, var16, Blocks.log, this.woodMetadata);
          if (var13 > 0)
          {
        ...
        {
          func_175905_a(worldIn, var17, Blocks.log, this.woodMetadata);
          if (var13 > 0)
          {
