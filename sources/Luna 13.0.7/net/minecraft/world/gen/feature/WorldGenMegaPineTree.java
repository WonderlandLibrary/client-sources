  ...
  extends WorldGenHugeTrees
{
  ...
  public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_)
  {
    ...
    for (int var5 = 0; var5 < var4; var5++)
    {
      ...
      if ((var6.getMaterial() == Material.air) || (var6.getMaterial() == Material.leaves)) {
        func_175905_a(worldIn, p_180709_3_.offsetUp(var5), Blocks.log, this.woodMetadata);
      }
      if (var5 < var4 - 1)
      {
        var6 = worldIn.getBlockState(p_180709_3_.add(1, var5, 0)).getBlock();
        if ((var6.getMaterial() == Material.air) || (var6.getMaterial() == Material.leaves)) {
          func_175905_a(worldIn, p_180709_3_.add(1, var5, 0), Blocks.log, this.woodMetadata);
        }
        var6 = worldIn.getBlockState(p_180709_3_.add(1, var5, 1)).getBlock();
        if ((var6.getMaterial() == Material.air) || (var6.getMaterial() == Material.leaves)) {
          func_175905_a(worldIn, p_180709_3_.add(1, var5, 1), Blocks.log, this.woodMetadata);
        }
        var6 = worldIn.getBlockState(p_180709_3_.add(0, var5, 1)).getBlock();
        if ((var6.getMaterial() == Material.air) || (var6.getMaterial() == Material.leaves)) {
          func_175905_a(worldIn, p_180709_3_.add(0, var5, 1), Blocks.log, this.woodMetadata);
        }
      }
    }
    return true;
  ...
  private void func_150541_c(World worldIn, int p_150541_2_, int p_150541_3_, int p_150541_4_, int p_150541_5_, Random p_150541_6_)
  {
    ...
    for (int var9 = p_150541_4_ - var7; var9 <= p_150541_4_; var9++)
    {
      ...
      int var11 = p_150541_5_ + MathHelper.floor_float(var10 / var7 * 3.5F);
      func_175925_a(worldIn, new BlockPos(p_150541_2_, var9, p_150541_3_), var11 + ((var10 > 0) && (var11 == var8) && ((var9 & 0x1) == 0) ? 1 : 0));
      var8 = var11;
    }
  }
