  ...
  extends BiomeGenBase
{
  ...
  public void genTerrainBlocks(World worldIn, Random p_180622_2_, ChunkPrimer p_180622_3_, int p_180622_4_, int p_180622_5_, double p_180622_6_)
  {
    ...
    if (this.field_150626_aH)
    {
      ...
      double var12 = Math.min(Math.abs(p_180622_6_), this.field_150623_aE.func_151601_a(var10 * 0.25D, var11 * 0.25D));
      if (var12 > 0.0D)
      {
        double var14 = 0.001953125D;
        double var16 = Math.abs(this.field_150624_aF.func_151601_a(var10 * var14, var11 * var14));
  ...
  {
    int var4 = (int)Math.round(this.field_150625_aG.func_151601_a(p_180629_1_ * 1.0D / 512.0D, p_180629_1_ * 1.0D / 512.0D) * 2.0D);
