...
public class Teleporter
{
  ...
  public boolean func_180620_b(Entity p_180620_1_, float p_180620_2_)
  {
    ...
    if (var4 >= 0.0D)
    {
      if (var8)
      {
        this.destinationCoordinateCache.add(var10, new PortalPosition((BlockPos)var9, this.worldServerInstance.getTotalWorldTime()));
  ...
  public boolean makePortal(Entity p_85188_1_)
  {
    ...
    {
      double var14 = var13 + 0.5D - p_85188_1_.posX;
      for (int var16 = var7 - var2; var16 <= var7 + var2; var16++)
      {
        double var17 = var16 + 0.5D - p_85188_1_.posZ;
        label466:
        for (int var19 = this.worldServerInstance.getActualHeight() - 1; var19 >= 0; var19--) {
          if (this.worldServerInstance.isAirBlock(new BlockPos(var13, var19, var16)))
          {
            ...
            for (int var20 = var12; var20 < var12 + 4; var20++)
            {
              ...
              double var32 = var19 + 0.5D - p_85188_1_.posY;
