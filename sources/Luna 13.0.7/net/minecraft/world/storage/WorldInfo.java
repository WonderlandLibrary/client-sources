...
public class WorldInfo
{
  ...
  public NBTTagCompound getNBTTagCompound()
  {
    ...
    updateTagCompound(var1, this.playerTag);
    return var1;
  }
  ...
  public void addToCrashReport(CrashReportCategory category)
  {
    ...
    category.addCrashSectionCallable("Level time", new Callable()
    {
      ...
      public String call()
      {
        return String.format("%d game time, %d day time", new Object[] { Long.valueOf(WorldInfo.this.totalTime), Long.valueOf(WorldInfo.worldTime) });
      }
    });
