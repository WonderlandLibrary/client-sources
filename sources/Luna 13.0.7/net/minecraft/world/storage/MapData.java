  ...
  extends WorldSavedData
{
  ...
  public void updateVisiblePlayers(EntityPlayer p_76191_1_, ItemStack p_76191_2_)
  {
    ...
    for (int var6 = 0; var6 < this.playersArrayList.size(); var6++)
    {
      ...
      if ((!var4.entityplayerObj.isDead) && ((var4.entityplayerObj.inventory.hasItemStack(p_76191_2_)) || (p_76191_2_.isOnItemFrame())))
      {
        if ((!p_76191_2_.isOnItemFrame()) && (var4.entityplayerObj.dimension == this.dimension)) {
          func_82567_a(0, var4.entityplayerObj.worldObj, var4.entityplayerObj.getName(), var4.entityplayerObj.posX, var4.entityplayerObj.posZ, var4.entityplayerObj.rotationYaw);
        }
      }
      else
      {
    ...
    if (p_76191_2_.isOnItemFrame())
    {
      ...
      func_82567_a(1, p_76191_1_.worldObj, "frame-" + var7.getEntityId(), var9.getX(), var9.getZ(), var7.field_174860_b.getHorizontalIndex() * 90);
    }
    if ((p_76191_2_.hasTagCompound()) && (p_76191_2_.getTagCompound().hasKey("Decorations", 9)))
    {
      ...
      for (int var10 = 0; var10 < var8.tagCount(); var10++)
      {
        ...
        if (!this.playersVisibleOnMap.containsKey(var5.getString("id"))) {
          func_82567_a(var5.getByte("type"), p_76191_1_.worldObj, var5.getString("id"), var5.getDouble("x"), var5.getDouble("z"), var5.getDouble("rot"));
        }
      }
    }
  }
  ...
  public Packet<INetHandler> func_176052_a(ItemStack p_176052_1_, World worldIn, EntityPlayer p_176052_3_)
  {
  ...
  public class MapInfo
  {
    ...
    public Packet<INetHandler> func_176101_a(ItemStack p_176101_1_)
    {
