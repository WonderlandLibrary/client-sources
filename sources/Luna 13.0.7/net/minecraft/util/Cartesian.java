...
public class Cartesian
{
    ...
    implements Iterable
  {
    ...
    {
      return this.iterables.length <= 0 ? Collections.singletonList((Object[])Cartesian.createArray(this.clazz, 0)).iterator() : new ProductIterator(this.clazz, this.iterables, null);
    }
      ...
      extends UnmodifiableIterator
    {
      ...
      public boolean hasNext()
      {
        ...
        if (this.index >= this.iterators.length) {
          for (this.index = (this.iterators.length - 1); this.index >= 0; this.index -= 1)
          {
