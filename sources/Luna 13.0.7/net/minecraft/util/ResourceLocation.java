...
public class ResourceLocation
{
  ...
  public ResourceLocation(int p_i45928_1_, String... p_i45928_2_)
  {
    this.resourceDomain = (StringUtils.isEmpty(p_i45928_2_[0]) ? "minecraft" : p_i45928_2_[0].toLowerCase());
