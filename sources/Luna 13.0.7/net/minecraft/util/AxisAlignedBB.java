...
public class AxisAlignedBB
{
  ...
  public double calculateXOffset(AxisAlignedBB other, double p_72316_2_)
  {
    if ((other.maxY > this.minY) && (other.minY < this.maxY) && (other.maxZ > this.minZ) && (other.minZ < this.maxZ))
    {
      ...
      {
        double var4 = this.minX - other.maxX;
        if (var4 < p_72316_2_) {
          p_72316_2_ = var4;
        }
      }
      ...
      {
        double var4 = this.maxX - other.minX;
        if (var4 > p_72316_2_) {
          p_72316_2_ = var4;
        }
      }
  ...
  public double calculateYOffset(AxisAlignedBB other, double p_72323_2_)
  {
    if ((other.maxX > this.minX) && (other.minX < this.maxX) && (other.maxZ > this.minZ) && (other.minZ < this.maxZ))
    {
      ...
      {
        double var4 = this.minY - other.maxY;
        if (var4 < p_72323_2_) {
          p_72323_2_ = var4;
        }
      }
      ...
      {
        double var4 = this.maxY - other.minY;
        if (var4 > p_72323_2_) {
          p_72323_2_ = var4;
        }
      }
  ...
  public double calculateZOffset(AxisAlignedBB other, double p_72322_2_)
  {
    if ((other.maxX > this.minX) && (other.minX < this.maxX) && (other.maxY > this.minY) && (other.minY < this.maxY))
    {
      ...
      {
        double var4 = this.minZ - other.maxZ;
        if (var4 < p_72322_2_) {
          p_72322_2_ = var4;
        }
      }
      ...
      {
        double var4 = this.maxZ - other.minZ;
        if (var4 > p_72322_2_) {
          p_72322_2_ = var4;
        }
      }
