  ...
  extends AbstractSet
{
  ...
  {
    Iterator var2 = this.field_180218_a.get(func_180212_a(p_180213_1_, false)).iterator();
    while (var2.hasNext())
    {
  ...
  {
    Iterator var3 = ClassUtils.hierarchy(p_180212_1_, ClassUtils.Interfaces.INCLUDE).iterator();
    Class var4;
    do
    {
      if (!var3.hasNext()) {
