  ...
  extends Container
{
  ...
  public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
  {
    ...
    if ((var4 != null) && (var4.getHasStack()))
    {
      ...
      {
        if (!mergeItemStack(var5, this.field_111243_a.getSizeInventory(), this.inventorySlots.size(), true)) {
          return null;
        }
      }
      ...
      else if ((this.field_111243_a.getSizeInventory() <= 2) || (!mergeItemStack(var5, 2, this.field_111243_a.getSizeInventory(), false))) {
        return null;
      }
      if (var5.stackSize == 0) {
