  ...
  extends Container
{
  ...
  public ContainerRepair(InventoryPlayer p_i45807_1_, final World worldIn, final BlockPos p_i45807_3_, EntityPlayer p_i45807_4_)
  {
    ...
    addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47)
    {
      ...
      {
        return ((p_82869_1_.capabilities.isCreativeMode) || (p_82869_1_.experienceLevel >= ContainerRepair.this.maximumCost)) && (ContainerRepair.this.maximumCost > 0) && (getHasStack());
      }
    ...
    else
    {
      ...
      if (var13 != null)
      {
        ...
        if ((var12.isItemStackDamageable()) && (var12.getItem().getIsRepairable(var8, var13)))
        {
          ...
          for (int var17 = 0; (var16 > 0) && (var17 < var13.stackSize); var17++)
          {
  ...
  {
    return this.theWorld.getBlockState(this.field_178156_j).getBlock() == Blocks.anvil;
  }
