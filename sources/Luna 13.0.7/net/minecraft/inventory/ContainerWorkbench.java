  ...
  extends Container
{
  ...
  public ContainerWorkbench(InventoryPlayer p_i45800_1_, World worldIn, BlockPos p_i45800_3_)
  {
    ...
    addSlotToContainer(new SlotCrafting(p_i45800_1_.player, this.craftMatrix, this.craftResult, 0, 124, 35));
    for (int var4 = 0; var4 < 3; var4++) {
      for (int var5 = 0; var5 < 3; var5++) {
        addSlotToContainer(new Slot(this.craftMatrix, var5 + var4 * 3, 30 + var5 * 18, 17 + var4 * 18));
      }
    }
  ...
  {
    return this.worldObj.getBlockState(this.field_178145_h).getBlock() == Blocks.crafting_table;
  }
