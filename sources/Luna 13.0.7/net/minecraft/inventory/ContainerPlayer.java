  ...
  extends Container
{
  ...
  public ContainerPlayer(InventoryPlayer p_i1819_1_, boolean p_i1819_2_, EntityPlayer p_i1819_3_)
  {
    ...
    addSlotToContainer(new SlotCrafting(p_i1819_1_.player, this.craftMatrix, this.craftResult, 0, 144, 36));
    for (int var4 = 0; var4 < 2; var4++) {
      for (int var5 = 0; var5 < 2; var5++) {
        addSlotToContainer(new Slot(this.craftMatrix, var5 + var4 * 2, 88 + var5 * 18, 26 + var4 * 18));
      }
    }
