  ...
  extends Container
{
  ...
  public ContainerBrewingStand(InventoryPlayer p_i45802_1_, IInventory p_i45802_2_)
  {
    ...
    addSlotToContainer(new Potion(p_i45802_1_.player, p_i45802_2_, 0, 56, 46));
    addSlotToContainer(new Potion(p_i45802_1_.player, p_i45802_2_, 1, 79, 53));
    addSlotToContainer(new Potion(p_i45802_1_.player, p_i45802_2_, 2, 102, 46));
    this.theSlot = addSlotToContainer(new Ingredient(p_i45802_2_, 3, 79, 17));
    ...
    extends Slot
  {
    ...
    {
      super(p_i1803_3_, p_i1803_4_, p_i1803_5_);
    }
    ...
    extends Slot
  {
    ...
    {
      super(p_i1804_3_, p_i1804_4_, p_i1804_5_);
