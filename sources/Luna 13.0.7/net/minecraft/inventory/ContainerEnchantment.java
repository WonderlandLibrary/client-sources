  ...
  extends Container
{
      ...
      if ((var2 != null) && (var2.isItemEnchantable()))
      {
        if (!this.worldPointer.isRemote)
        {
          ...
          for (var4 = 0; var4 < 3; var4++) {
            ...
            {
              List var7 = func_178148_a(var2, var4, this.enchantLevels[var4]);
  ...
  public boolean enchantItem(EntityPlayer playerIn, int id)
  {
    ...
    if ((this.enchantLevels[id] > 0) && (var3 != null) && (((playerIn.experienceLevel >= var5) && (playerIn.experienceLevel >= this.enchantLevels[id])) || (playerIn.capabilities.isCreativeMode)))
    {
      if (!this.worldPointer.isRemote)
      {
        List var6 = func_178148_a(var3, id, this.enchantLevels[id]);
  ...
  {
    return this.worldPointer.getBlockState(this.field_178150_j).getBlock() == Blocks.enchanting_table;
  }
