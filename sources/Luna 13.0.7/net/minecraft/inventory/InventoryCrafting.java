  ...
  implements IInventory
{
  ...
  {
    return slotIn >= getSizeInventory() ? null : this.stackList[slotIn];
  }
  
  public ItemStack getStackInRowAndColumn(int p_70463_1_, int p_70463_2_)
  {
    return (p_70463_1_ >= 0) && (p_70463_1_ < this.inventoryWidth) && (p_70463_2_ >= 0) && (p_70463_2_ <= this.field_174924_c) ? getStackInSlot(p_70463_1_ + p_70463_2_ * this.inventoryWidth) : null;
  }
