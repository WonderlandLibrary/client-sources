  ...
  implements IUpdatePlayerListBox
{
  ...
  {
    return this.extending ? (func_145860_a(p_174929_1_) - 1.0F) * this.field_174931_f.getFrontOffsetX() : (1.0F - func_145860_a(p_174929_1_)) * this.field_174931_f.getFrontOffsetX();
  }
  
  public float func_174928_c(float p_174928_1_)
  {
    return this.extending ? (func_145860_a(p_174928_1_) - 1.0F) * this.field_174931_f.getFrontOffsetY() : (1.0F - func_145860_a(p_174928_1_)) * this.field_174931_f.getFrontOffsetY();
  }
  
  public float func_174926_d(float p_174926_1_)
  {
    return this.extending ? (func_145860_a(p_174926_1_) - 1.0F) * this.field_174931_f.getFrontOffsetZ() : (1.0F - func_145860_a(p_174926_1_)) * this.field_174931_f.getFrontOffsetZ();
  }
