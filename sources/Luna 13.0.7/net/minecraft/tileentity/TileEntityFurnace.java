  ...
  implements IUpdatePlayerListBox, ISidedInventory
{
  ...
  public void setInventorySlotContents(int index, ItemStack stack)
  {
    ...
    if ((index == 0) && (!var3))
    {
      this.field_174905_l = func_174904_a(stack);
  ...
  public void update()
  {
    ...
    if (!this.worldObj.isRemote)
    {
      ...
      {
        if ((!isBurning()) && (this.field_174906_k > 0)) {
      ...
      else
      {
        ...
        if ((isBurning()) && (canSmelt()))
        {
          this.field_174906_k += 1;
          if (this.field_174906_k == this.field_174905_l)
          {
            this.field_174906_k = 0;
            this.field_174905_l = func_174904_a(this.furnaceItemStacks[0]);
            smeltItem();
            var2 = true;
          }
        }
      ...
      {
        var2 = true;
        BlockFurnace.func_176446_a(isBurning(), this.worldObj, this.pos);
      }
    }
    if (var2) {
      markDirty();
