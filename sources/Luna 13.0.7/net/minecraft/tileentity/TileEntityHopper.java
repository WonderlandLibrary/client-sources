  ...
  implements IHopper, IUpdatePlayerListBox
{
  ...
  private IInventory func_145895_l()
  {
    ...
    return func_145893_b(getWorld(), this.pos.getX() + var1.getFrontOffsetX(), this.pos.getY() + var1.getFrontOffsetY(), this.pos.getZ() + var1.getFrontOffsetZ());
  }
  ...
  {
    return stack1.stackSize > stack1.getMaxStackSize() ? false : stack1.getMetadata() != stack2.getMetadata() ? false : stack1.getItem() != stack2.getItem() ? false : ItemStack.areItemStackTagsEqual(stack1, stack2);
  }
