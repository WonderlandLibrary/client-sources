...
public class PlayerControllerMP
{
  ...
  public boolean processRightClickBlock(EntityPlayerSP p_178890_1_, WorldClient p_178890_2_, ItemStack p_178890_3_, BlockPos p_178890_4_, EnumFacing p_178890_5_, Vec3d p_178890_6_)
  {
    syncCurrentPlayItem();
    float var7 = (float)(p_178890_6_.xCoord - p_178890_4_.getX());
    float var8 = (float)(p_178890_6_.yCoord - p_178890_4_.getY());
    ...
    if (this.currentGameType != WorldSettings.GameType.SPECTATOR)
    {
      ...
      if (((!p_178890_1_.isSneaking()) || (p_178890_1_.getHeldItem() == null)) && 
        (var11.getBlock().onBlockActivated(p_178890_2_, p_178890_4_, var11, p_178890_1_, p_178890_5_, var7, var8, var9))) {
        var10 = true;
      }
      if ((!var10) && (p_178890_3_ != null) && ((p_178890_3_.getItem() instanceof ItemBlock)))
      {
    ...
    this.netClientHandler.addToSendQueue(new C08PacketPlayerBlockPlacement(p_178890_4_, p_178890_5_.getIndex(), p_178890_1_.inventory
      .getCurrentItem(), var7, var8, var9));
    if ((!var10) && (this.currentGameType != WorldSettings.GameType.SPECTATOR))
    {
      if (p_178890_3_ == null) {
        return false;
