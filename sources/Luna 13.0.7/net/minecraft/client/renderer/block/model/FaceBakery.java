...
import net.minecraft.client.renderer.EnumFaceing.VertexInformation;
...
public class FaceBakery
{
  ...
  {
    int[] var10 = makeQuadVertexData(face, sprite, facing, func_178403_a(posFrom, posTo), modelRotationIn, partRotation, uvLocked, shade);
  ...
  private float[] func_178403_a(Vector3f pos1, Vector3f pos2)
  {
    ...
    var3[net.minecraft.client.renderer.EnumFaceing.Constants.field_179176_f] = (pos1.x / 16.0F);
    var3[net.minecraft.client.renderer.EnumFaceing.Constants.field_179178_e] = (pos1.y / 16.0F);
    var3[net.minecraft.client.renderer.EnumFaceing.Constants.field_179177_d] = (pos1.z / 16.0F);
    var3[net.minecraft.client.renderer.EnumFaceing.Constants.field_179180_c] = (pos2.x / 16.0F);
    var3[net.minecraft.client.renderer.EnumFaceing.Constants.field_179179_b] = (pos2.y / 16.0F);
    var3[net.minecraft.client.renderer.EnumFaceing.Constants.field_179181_a] = (pos2.z / 16.0F);
    return var3;
  }
  ...
  private void func_178407_a(Vector3d p_178407_1_, BlockPartRotation p_178407_2_)
  {
    if (p_178407_2_ != null)
    {
      ...
      {
      case 1: 
        var3.mul(func_178416_a(new AxisAngle4d(1.0D, 0.0D, 0.0D, p_178407_2_.field_178343_c * 0.017453292519943295D)));
        var4.set(0.0D, 1.0D, 1.0D);
        break;
      case 2: 
        var3.mul(func_178416_a(new AxisAngle4d(0.0D, 1.0D, 0.0D, p_178407_2_.field_178343_c * 0.017453292519943295D)));
        var4.set(1.0D, 0.0D, 1.0D);
        break;
      case 3: 
        var3.mul(func_178416_a(new AxisAngle4d(0.0D, 0.0D, 1.0D, p_178407_2_.field_178343_c * 0.017453292519943295D)));
  ...
  public int rotateVertex(Vector3d position, EnumFacing facing, int vertexIndex, ITransformation modelRotationIn, boolean uvLocked)
  {
    ...
    if (Reflector.ForgeHooksClient_transform.exists()) {
      ...
      func_178406_a(position, new Vector3d(0.5D, 0.5D, 0.5D), new Matrix4d(modelRotationIn.getMatrix()), new Vector3d(1.0D, 1.0D, 1.0D));
    }
  ...
  private void func_178408_a(int[] p_178408_1_, EnumFacing p_178408_2_)
  {
    ...
    for (int var6 = 0; var6 < 4; var6++)
    {
      ...
      float var9 = var4[var20.field_179184_a];
