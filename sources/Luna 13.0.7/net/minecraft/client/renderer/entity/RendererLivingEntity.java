...
import space.lunaclient.luna.impl.events.EventRenderNameTag;
  ...
  extends Render
{
  ...
  public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
  {
    ...
    {
      if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] { p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_) })) {}
    }
    else
    {
      ...
      if (Reflector.RenderLivingEvent_Post_Constructor.exists()) {
        if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Post_Constructor, new Object[] { p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_) })) {}
      }
    }
  }
  ...
  protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
  {
    ...
    boolean var9 = (!var8) && (!p_77036_1_.isInvisibleToPlayer(Minecraft.thePlayer));
    if ((var8) || (var9))
    {
  ...
  {
    Luna.INSTANCE.EVENT_MANAGER.register(new EventRenderNameTag(p_77033_1_));
    if (Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists())
    {
      if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, new Object[] { p_77033_1_, this, Double.valueOf(p_77033_2_), Double.valueOf(p_77033_4_), Double.valueOf(p_77033_6_) })) {}
    }
    else
    {
      ...
      if (Reflector.RenderLivingEvent_Specials_Post_Constructor.exists()) {
        if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Post_Constructor, new Object[] { p_77033_1_, this, Double.valueOf(p_77033_2_), Double.valueOf(p_77033_4_), Double.valueOf(p_77033_6_) })) {}
      }
    }
  }
