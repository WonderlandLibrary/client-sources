  ...
  extends RenderLiving
{
  ...
  public boolean func_177113_a(EntityGuardian p_177113_1_, ICamera p_177113_2_, double p_177113_3_, double p_177113_5_, double p_177113_7_)
  {
    ...
    if (p_177113_1_.func_175474_cn())
    {
      ...
      if (var9 != null)
      {
        Vec3 var10 = func_177110_a(var9, var9.height * 0.5D, 1.0F);
        Vec3 var11 = func_177110_a(p_177113_1_, p_177113_1_.getEyeHeight(), 1.0F);
        
        return p_177113_2_.isBoundingBoxInFrustum(AxisAlignedBB.fromBounds(var11.xCoord, var11.yCoord, var11.zCoord, var10.xCoord, var10.yCoord, var10.zCoord));
      }
    }
    return false;
  }
  ...
  {
    double var5 = p_177110_1_.lastTickPosX + (p_177110_1_.posX - p_177110_1_.lastTickPosX) * p_177110_4_;
    double var7 = p_177110_2_ + p_177110_1_.lastTickPosY + (p_177110_1_.posY - p_177110_1_.lastTickPosY) * p_177110_4_;
    double var9 = p_177110_1_.lastTickPosZ + (p_177110_1_.posZ - p_177110_1_.lastTickPosZ) * p_177110_4_;
  ...
  public void func_177109_a(EntityGuardian p_177109_1_, double p_177109_2_, double p_177109_4_, double p_177109_6_, float p_177109_8_, float p_177109_9_)
  {
    ...
    if (var10 != null)
    {
      ...
      Vec3 var18 = func_177110_a(var10, var10.height * 0.5D, p_177109_9_);
