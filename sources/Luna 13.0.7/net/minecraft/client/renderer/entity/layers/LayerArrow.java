  ...
  public void doRenderLayer(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_, float p_177141_5_, float p_177141_6_, float p_177141_7_, float p_177141_8_)
  {
    ...
    if (var9 > 0)
    {
      ...
      for (int var12 = 0; var12 < var9; var12++)
      {
        ...
        var10.prevRotationYaw = (var10.rotationYaw = (float)(Math.atan2(var15, var17) * 180.0D / 3.141592653589793D));
        var10.prevRotationPitch = (var10.rotationPitch = (float)(Math.atan2(var16, var21) * 180.0D / 3.141592653589793D));
        double var22 = 0.0D;
        double var24 = 0.0D;
        double var26 = 0.0D;
