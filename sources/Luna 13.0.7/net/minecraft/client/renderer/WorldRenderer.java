...
public class WorldRenderer
{
  ...
  public State getVertexState(float p_178971_1_, float p_178971_2_, float p_178971_3_)
  {
    ...
    PriorityQueue var5 = new PriorityQueue(this.rawBufferIndex, new QuadComparator(this.rawFloatBuffer, (float)(p_178971_1_ + this.xOffset), (float)(p_178971_2_ + this.yOffset), (float)(p_178971_3_ + this.zOffset), this.vertexFormat.func_177338_f() / 4));
  ...
  public void func_178978_a(float p_178978_1_, float p_178978_2_, float p_178978_3_, int p_178978_4_)
  {
    ...
    {
      int var7 = (int)((this.field_179007_h >> 24 & 0xFF) * p_178978_1_);
      int var8 = (int)((this.field_179007_h >> 16 & 0xFF) * p_178978_2_);
      int var9 = (int)((this.field_179007_h >> 8 & 0xFF) * p_178978_3_);
      var6 &= 0xFF;
