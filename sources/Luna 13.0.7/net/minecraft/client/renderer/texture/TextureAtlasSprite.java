...
public class TextureAtlasSprite
{
  ...
  public void initSprite(int p_110971_1_, int p_110971_2_, int p_110971_3_, int p_110971_4_, boolean p_110971_5_)
  {
    ...
    this.minV = (p_110971_4_ / p_110971_2_ + var7);
    this.maxV = ((p_110971_4_ + this.height) / p_110971_2_ - var7);
  ...
  {
    double var1 = 1.0D - this.tickCounter / this.animationMetadata.getFrameTimeSingle(this.frameCounter);
    int var3 = this.animationMetadata.getFrameIndex(this.frameCounter);
      ...
      for (int var8 = 0; var8 < var6.length; var8++)
      {
        ...
        if ((var8 < var7.length) && (var7[var8].length == var6[var8].length)) {
          for (int var9 = 0; var9 < var6[var8].length; var9++)
          {
            ...
            this.field_176605_b[var8][var9] = (var10 & 0xFF000000 | var12 << 16 | var13 << 8 | var14);
          }
        }
      }
  ...
  public void func_180598_a(BufferedImage[] p_180598_1_, AnimationMetadataSection p_180598_2_)
  {
    ...
    for (int var11 = 0; var11 < this.framesTextureData.size(); var11++)
    {
  ...
  {
    u -= this.baseU;
    float ku = this.sheetWidth / this.width;
    u *= ku;
    return u;
  }
  ...
  {
    v -= this.baseV;
    float kv = this.sheetHeight / this.height;
    v *= kv;
    return v;
  }
}
