...
public class Stitcher
{
  ...
  {
    Holder[] var1 = (Holder[])this.setStitchHolders.toArray(new Holder[this.setStitchHolders.size()]);
    Arrays.sort(var1);
    Holder[] var2 = var1;
  ...
  private boolean expandAndAllocateSlot(Holder p_94311_1_)
  {
    ...
    if (var4)
    {
      ...
      Slot var152 = new Slot(this.currentWidth, 0, p_94311_1_.getWidth(), this.currentHeight);
