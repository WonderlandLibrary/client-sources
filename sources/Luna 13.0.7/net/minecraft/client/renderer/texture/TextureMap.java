  ...
  implements ITickableTextureObject
{
  ...
  public void loadTexture(IResourceManager p_110551_1_)
  {
    ...
    if (this.field_174946_m != null) {
      func_174943_a(p_110551_1_, this.field_174946_m);
    }
  }
  ...
  public void func_174943_a(IResourceManager p_174943_1_, IIconCreator p_174943_2_)
  {
    ...
    {
      this.mipmapLevels = detectMaxMipmapLevel(this.mapRegisteredSprites, p_174943_1_);
  ...
  public void loadTextureAtlas(IResourceManager p_110571_1_)
  {
    ...
    if (Config.isShaders()) {
      ShadersTex.allocateTextureMap(getGlTextureId(), this.mipmapLevels, var31.getCurrentWidth(), var31.getCurrentHeight(), var31, this);
    } else {
      TextureUtil.func_180600_a(getGlTextureId(), this.mipmapLevels, var31.getCurrentWidth(), var31.getCurrentHeight());
    }
    ...
    if (Config.equals(System.getProperty("saveTextureMap"), "true"))
    {
      ...
      TextureUtil.func_177055_a(this.basePath.replaceAll("/", "_"), getGlTextureId(), this.mipmapLevels, var31.getCurrentWidth(), var31.getCurrentHeight());
    }
  }
  ...
  {
    return (ts != TextureUtils.iconWaterStill) && (ts != TextureUtils.iconWaterFlow) ? Config.isAnimatedLava() : (ts != TextureUtils.iconLavaStill) && (ts != TextureUtils.iconLavaFlow) ? Config.isAnimatedFire() : (ts != TextureUtils.iconFireLayer0) && (ts != TextureUtils.iconFireLayer1) ? false : (ts == TextureUtils.iconClock) || (ts == TextureUtils.iconCompass) || (Config.isAnimatedTerrain()) ? true : ts == TextureUtils.iconPortal ? Config.isAnimatedPortal() : Config.isAnimatedWater();
  }
