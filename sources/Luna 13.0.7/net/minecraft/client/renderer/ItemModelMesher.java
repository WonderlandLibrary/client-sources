...
public class ItemModelMesher
{
  ...
  {
    return (IBakedModel)this.simpleShapesCache.get(Integer.valueOf(getIndex(p_178088_1_, p_178088_2_)));
  }
  ...
  {
    this.simpleShapes.put(Integer.valueOf(getIndex(p_178086_1_, p_178086_2_)), p_178086_3_);
    this.simpleShapesCache.put(Integer.valueOf(getIndex(p_178086_1_, p_178086_2_)), this.modelManager.getModel(p_178086_3_));
  }
