    ...
    if ((!this.isHidden) && (this.showModel))
    {
      ...
      if ((this.rotateAngleX == 0.0F) && (this.rotateAngleY == 0.0F) && (this.rotateAngleZ == 0.0F)) {
        if ((this.rotationPointX == 0.0F) && (this.rotationPointY == 0.0F) && (this.rotationPointZ == 0.0F))
        {
          ...
          {
            ((ModelRenderer)this.childModels.get(var2)).render(p_78785_1_);var2++; continue;
            ...
            GlStateManager.translate(-this.rotationPointX * p_78785_1_, -this.rotationPointY * p_78785_1_, -this.rotationPointZ * p_78785_1_); break;
