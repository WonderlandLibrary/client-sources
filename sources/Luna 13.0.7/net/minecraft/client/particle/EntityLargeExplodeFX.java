  ...
  extends EntityFX
{
  ...
  {
    int var9 = (int)((this.field_70581_a + p_180434_3_) * 15.0F / this.field_70584_aq);
    if (var9 <= 15)
    {
      ...
      float var15 = (float)(this.prevPosX + (this.posX - this.prevPosX) * p_180434_3_ - interpPosX);
      float var16 = (float)(this.prevPosY + (this.posY - this.prevPosY) * p_180434_3_ - interpPosY);
      float var17 = (float)(this.prevPosZ + (this.posZ - this.prevPosZ) * p_180434_3_ - interpPosZ);
