...
public class EffectRenderer
{
  ...
  public void addEffect(EntityFX p_78873_1_)
  {
    if (p_78873_1_ != null) {
      if ((!(p_78873_1_ instanceof EntityFireworkSparkFX)) || (Config.isFireworkParticles()))
      {
        ...
        if ((!(p_78873_1_ instanceof Barrier)) || (!reuseBarrierParticle(p_78873_1_, this.fxLayers[var2][var3]))) {
  ...
  private void func_178922_a(int p_178922_1_)
  {
    for (int var2 = 0; var2 < 2; var2++) {
      func_178925_a(this.fxLayers[p_178922_1_][var2]);
    }
  }
  ...
  public void func_180533_a(BlockPos p_180533_1_, IBlockState p_180533_2_)
  {
    ...
    if ((Reflector.ForgeBlock_addDestroyEffects.exists()) && (Reflector.ForgeBlock_isAir.exists()))
    {
      ...
      if (!Reflector.callBoolean(var3, Reflector.ForgeBlock_isAir, new Object[] { this.worldObj, p_180533_1_ })) {}
      notAir = !Reflector.callBoolean(var3, Reflector.ForgeBlock_addDestroyEffects, new Object[] { this.worldObj, p_180533_1_, this });
    }
    else
    {
      ...
      for (int var4 = 0; var4 < var14; var4++) {
        for (int var5 = 0; var5 < var14; var5++) {
          for (int var6 = 0; var6 < var14; var6++)
          {
            ...
            addEffect(new EntityDiggingFX(this.worldObj, var7, var9, var11, var7 - p_180533_1_.getX() - 0.5D, var9 - p_180533_1_.getY() - 0.5D, var11 - p_180533_1_.getZ() - 0.5D, p_180533_2_).func_174846_a(p_180533_1_));
          }
        }
      }
    }
  ...
  public void func_180532_a(BlockPos p_180532_1_, EnumFacing p_180532_2_)
  {
    ...
    if (var4.getRenderType() != -1)
    {
      ...
      addEffect(new EntityDiggingFX(this.worldObj, var9, var11, var13, 0.0D, 0.0D, 0.0D, var3).func_174846_a(p_180532_1_).multiplyVelocity(0.2F).multipleParticleScaleBy(0.6F));
    }
  }
