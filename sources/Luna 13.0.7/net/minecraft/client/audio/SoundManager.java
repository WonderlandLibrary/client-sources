...
public class SoundManager
{
      ...
      try
      {
        new Thread(new Runnable()
        {
          ...
          public void run()
          {
            ...
            }); SoundManager tmp23_20 = SoundManager.this;tmp23_20.getClass();SoundManager.this.sndSystem = new SoundManager.SoundSystemStarterThread(tmp23_20, null);
    ...
    if (this.loaded) {
      ...
      else
      {
        ...
        while (var3.hasNext())
        {
          ...
          float var6 = getNormalizedVolume(var5, (SoundPoolEntry)this.playingSoundPoolEntries.get(var5), p_148601_1_);
          if (var6 <= 0.0F) {
            stopSound(var5);
          } else {
  ...
  public void updateAllSounds()
  {
    ...
    while (var1.hasNext())
    {
      ...
      else
      {
        ...
        this.sndSystem.setVolume(var3, getNormalizedVolume(var2, (SoundPoolEntry)this.playingSoundPoolEntries.get(var2), this.sndHandler.getSound(var2.getSoundLocation()).getSoundCategory()));
        this.sndSystem.setPitch(var3, getNormalizedPitch(var2, (SoundPoolEntry)this.playingSoundPoolEntries.get(var2)));
  ...
  public boolean isSoundPlaying(ISound p_148597_1_)
  {
    ...
    return (var2 != null) && ((this.sndSystem.playing(var2)) || ((this.playingSoundsStopTime.containsKey(var2)) && (((Integer)this.playingSoundsStopTime.get(var2)).intValue() <= this.playTime)));
  }
      ...
      protected URLConnection openConnection(URL p_openConnection_1_)
      {
        new URLConnection(p_openConnection_1_)
        {
          ...
          public InputStream getInputStream()
            throws IOException
          {
            return Minecraft.getMinecraft().getResourceManager().getResource(SoundManager.2.this.val$p_148612_0_).getInputStream();
          }
        };
      }
    };
  ...
  public void setListener(EntityPlayer p_148615_1_, float p_148615_2_)
  {
    if ((this.loaded) && (p_148615_1_ != null))
    {
      ...
      double var5 = p_148615_1_.prevPosX + (p_148615_1_.posX - p_148615_1_.prevPosX) * p_148615_2_;
      double var7 = p_148615_1_.prevPosY + (p_148615_1_.posY - p_148615_1_.prevPosY) * p_148615_2_ + p_148615_1_.getEyeHeight();
      double var9 = p_148615_1_.prevPosZ + (p_148615_1_.posZ - p_148615_1_.prevPosZ) * p_148615_2_;
