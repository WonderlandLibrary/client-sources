  ...
  private void func_73722_d(String p_73722_1_)
  {
    ...
    else
    {
      ...
      if (OpenGlHelper.isFramebufferEnabled())
      {
        ...
        GlStateManager.ortho(0.0D, this.field_146587_f.getScaledWidth() * var2, this.field_146587_f.getScaledHeight() * var2, 0.0D, 100.0D, 300.0D);
      }
      else
      {
  ...
  public void setLoadingProgress(int progress)
  {
    ...
    else
    {
      ...
      if (var2 - this.field_73723_d >= 100L)
      {
        ...
        Minecraft.fontRendererObj.func_175063_a(this.currentlyDisplayedText, (var6 - Minecraft.fontRendererObj.getStringWidth(this.currentlyDisplayedText)) / 2, var7 / 2 - 4 - 16, 16777215);
        Minecraft.fontRendererObj.func_175063_a(this.field_73727_a, (var6 - Minecraft.fontRendererObj.getStringWidth(this.field_73727_a)) / 2, var7 / 2 - 4 + 8, 16777215);
