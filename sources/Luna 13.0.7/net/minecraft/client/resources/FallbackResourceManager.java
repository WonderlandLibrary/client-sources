  ...
  implements IResourceManager
{
    ...
    throws IOException
  {
    ...
    for (int var4 = this.resourcePacks.size() - 1; var4 >= 0; var4--)
    {
      ...
      if (var5.resourceExists(p_110536_1_))
      {
        ...
        return new SimpleResource(var5.getPackName(), p_110536_1_, func_177245_a(p_110536_1_, var5), var6, this.frmMetadataSerializer);
      }
    }
    throw new FileNotFoundException(p_110536_1_.toString());
  }
  
  protected InputStream func_177245_a(ResourceLocation p_177245_1_, IResourcePack p_177245_2_)
    throws IOException
  {
    InputStream var3 = p_177245_2_.getInputStream(p_177245_1_);
    return field_177246_b.isDebugEnabled() ? new ImputStreamLeakedResourceLogger(var3, p_177245_1_, p_177245_2_.getPackName()) : var3;
  }
    ...
    throws IOException
  {
    ...
    while (var4.hasNext())
    {
      ...
      {
        InputStream var6 = var5.resourceExists(var3) ? func_177245_a(var3, var5) : null;
        var2.add(new SimpleResource(var5.getPackName(), p_135056_1_, func_177245_a(p_135056_1_, var5), var6, this.frmMetadataSerializer));
      }
    }
    if (var2.isEmpty()) {
