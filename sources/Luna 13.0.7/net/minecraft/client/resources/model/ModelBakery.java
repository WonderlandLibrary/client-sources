...
public class ModelBakery
{
  ...
  {
    loadVariants(this.blockModelShapes.getBlockStateMapper().func_178446_a().values());
    ...
    throws IOException
  {
    ...
    {
      IResource var9 = this.resourceManager.getResource(getModelLocation(p_177594_1_));
  ...
  private List getVariantNames(Item p_177596_1_)
  {
    ...
    if (var2 == null) {
      var2 = Collections.singletonList(Item.itemRegistry.getNameForObject(p_177596_1_).toString());
    }
    return var2;
  }
    ...
    while (var1.hasNext())
    {
      ...
      if ((var11 != null) && (var11.isResolved()))
      {
        if (isCustomRenderer(var11)) {
          ...
          this.bakedRegistry.putObject(var10, bakeModel(var11, ModelRotation.X0_Y0, false));
        }
      }
      else {
    ...
    while (var6.hasNext())
    {
      ...
      while (var8.hasNext())
      {
        ...
        if (var10.field_178244_b == null) {
          ...
          var5.func_177650_a(p_177578_2_.func_177523_a(var10.field_178244_b), func_177589_a(var7, var10, var11, var9, p_177578_2_, p_177578_3_));
        }
      }
    }
