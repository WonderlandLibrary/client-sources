  ...
  extends Gui
{
  ...
  {
    if ((this.theAchievement != null) && (this.notificationTime != 0L) && (Minecraft.thePlayer != null))
    {
      ...
      if (this.permanentNotification)
      {
        Minecraft.fontRendererObj.drawSplitString(this.achievementDescription, var5 + 30, var6 + 7, 120, -1);
      }
      else
      {
        Minecraft.fontRendererObj.drawString(this.achievementTitle, var5 + 30, var6 + 7, 65280);
        Minecraft.fontRendererObj.drawString(this.achievementDescription, var5 + 30, var6 + 18, -1);
      }
