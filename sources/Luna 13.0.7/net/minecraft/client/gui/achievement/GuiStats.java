  ...
  implements IProgressMeter
{
  ...
  public void createButtons()
  {
    ...
    GuiButton var1;
    this.buttonList.add(var1 = new GuiButton(2, width / 2 - 80, height - 52, 80, 20, I18n.format("stat.blocksButton", new Object[0])));
    GuiButton var2;
    this.buttonList.add(var2 = new GuiButton(3, width / 2, height - 52, 80, 20, I18n.format("stat.itemsButton", new Object[0])));
    GuiButton var3;
    this.buttonList.add(var3 = new GuiButton(4, width / 2 + 80, height - 52, 80, 20, I18n.format("stat.mobsButton", new Object[0])));
    ...
    extends GuiSlot
  {
    ...
    {
      super(GuiScreen.width, GuiScreen.height, 32, GuiScreen.height - 64, 20);
    ...
    protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_)
    {
      if (p_148213_1_ != null)
      {
        ...
        String var7 = ("" + I18n.format(new StringBuilder().append(var6).append(".name").toString(), new Object[0])).trim();
        if (var7.length() > 0)
        {
      ...
      this.statSorter = new Comparator()
      {
        ...
        public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_)
        {
          ...
          if ((var5 != null) || (var6 != null))
          {
            ...
            if (var7 != var8) {
              return (var7 - var8) * GuiStats.StatsBlock.this.field_148215_p;
            }
          }
          return var3 - var4;
        }
    ...
    extends GuiSlot
  {
    ...
    {
      super(GuiScreen.width, GuiScreen.height, 32, GuiScreen.height - 64, 10);
      setShowSelectionBox(false);
    }
    ...
    public StatsItem(Minecraft mcIn)
    {
      ...
      this.statSorter = new Comparator()
      {
        ...
        public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_)
        {
          ...
          StatBase var5 = null;
          StatBase var6 = null;
          if (GuiStats.StatsItem.this.field_148217_o == 0)
          {
            var5 = StatList.objectBreakStats[var3];
            var6 = StatList.objectBreakStats[var4];
          }
          else if (GuiStats.StatsItem.this.field_148217_o == 1)
          {
            var5 = StatList.objectCraftStats[var3];
            var6 = StatList.objectCraftStats[var4];
          }
          else if (GuiStats.StatsItem.this.field_148217_o == 2)
          {
            var5 = StatList.objectUseStats[var3];
            var6 = StatList.objectUseStats[var4];
          }
          if ((var5 != null) || (var6 != null))
          {
            ...
            int var8 = GuiStats.this.field_146546_t.writeStat(var6);
            if (var7 != var8) {
              return (var7 - var8) * GuiStats.StatsItem.this.field_148215_p;
            }
          }
          return var3 - var4;
        }
    ...
    extends GuiSlot
  {
    ...
    {
      super(GuiScreen.width, GuiScreen.height, 32, GuiScreen.height - 64, GuiStats.this.fontRendererObj.FONT_HEIGHT * 4);
      setShowSelectionBox(false);
