  ...
  extends GuiScreen
{
  ...
  public void initGui()
  {
    this.buttonList.add(this.field_146455_i = new GuiOptionButton(100, width / 2 - 155, height - 38, GameSettings.Options.FORCE_UNICODE_FONT, this.game_settings_3.getKeyBinding(GameSettings.Options.FORCE_UNICODE_FONT)));
    this.buttonList.add(this.field_146452_r = new GuiOptionButton(6, width / 2 - 155 + 160, height - 38, I18n.format("gui.done", new Object[0])));
    ...
    if (button.enabled) {
      ...
      case 100: 
        if ((button instanceof GuiOptionButton))
        {
          ...
          setWorldAndResolution(this.mc, var3, var4);
        }
        break;
      default: 
  ...
  class List
    extends GuiSlot
  {
    private final List field_148176_l = Lists.newArrayList();
    private final Map field_148177_m = Maps.newHashMap();
    private static final String __OBFID = "CL_00000699";
    
    public List(Minecraft mcIn)
    {
      super(GuiScreen.width, GuiScreen.height, 32, GuiScreen.height - 65 + 4, 18);
