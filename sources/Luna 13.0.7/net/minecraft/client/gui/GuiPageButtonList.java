  ...
  extends GuiListExtended
{
  ...
  {
    GuiListEntry[][] var1 = this.field_178078_x;
  ...
  public void func_178071_h()
  {
    if (this.field_178077_y > 0)
    {
      ...
      func_178055_t();
      func_178060_e(var1, this.field_178077_y);
  ...
  {
    GuiListEntry[] var3 = this.field_178078_x[p_178060_1_];
    int var4 = var3.length;
    for (int var5 = 0; var5 < var4; var5++)
    {
      GuiListEntry var6 = var3[var5];
      if (var6 != null) {
        func_178066_a((Gui)this.field_178073_v.lookup(var6.func_178935_b()), false);
      }
    }
    ...
    for (var5 = 0; var5 < var4; var5++)
    {
      GuiListEntry var6 = var3[var5];
      if (var6 != null) {
        func_178066_a((Gui)this.field_178073_v.lookup(var6.func_178935_b()), true);
      }
    }
  }
  ...
  {
    GuiTextField var4 = new GuiTextField(p_178068_3_.func_178935_b(), Minecraft.fontRendererObj, p_178068_1_, p_178068_2_, 150, 20);
  ...
  private GuiLabel func_178063_a(int p_178063_1_, int p_178063_2_, GuiLabelEntry p_178063_3_, boolean p_178063_4_)
  {
    ...
    GuiLabel var5;
    if (p_178063_4_) {
      var5 = new GuiLabel(Minecraft.fontRendererObj, p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, this.width - p_178063_1_ * 2, 20, -1);
    } else {
      var5 = new GuiLabel(Minecraft.fontRendererObj, p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, 150, 20, -1);
    }
  ...
  public void func_178062_a(char p_178062_1_, int p_178062_2_)
  {
    if ((this.field_178075_A instanceof GuiTextField))
    {
      ...
      else
      {
        ...
        int var6 = this.field_178072_w.indexOf(this.field_178075_A);
        int var7 = var6;
        String[] var8 = var5;
    ...
    implements GuiListExtended.IGuiListEntry
  {
    ...
    {
      func_178017_a(this.field_178029_b, y, mouseX, mouseY, false);
      func_178017_a(this.field_178030_c, y, mouseX, mouseY, false);
    }
    ...
    {
      func_178017_a(this.field_178029_b, p_178011_3_, 0, 0, true);
      func_178017_a(this.field_178030_c, p_178011_3_, 0, 0, true);
    }
    
    public boolean mousePressed(int p_148278_1_, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_)
    {
      boolean var7 = func_178026_a(this.field_178029_b, p_148278_2_, p_148278_3_, p_148278_4_);
      boolean var8 = func_178026_a(this.field_178030_c, p_148278_2_, p_148278_3_, p_148278_4_);
      return (var7) || (var8);
    }
    ...
    {
      func_178016_b(this.field_178029_b, x, y, mouseEvent);
      func_178016_b(this.field_178030_c, x, y, mouseEvent);
    }
