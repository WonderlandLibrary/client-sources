...
import space.lunaclient.luna.util.glsl.ShaderUtils;
  ...
  extends Gui
{
  ...
  public static int animatedWidth = 0;
  ...
  public GuiIngame(Minecraft mcIn)
  {
    ...
    int i = new ScaledResolution(this.mc, this.mc.displayWidth, this.mc.displayHeight).getScaledWidth() / 2;
    animatedWidth = i - 80 + 20;
  ...
  public void func_175180_a(float p_175180_1_)
  {
    ...
    int should = new ScaledResolution(this.mc, this.mc.displayWidth, this.mc.displayHeight).getScaledWidth() / 2 - 80 + Minecraft.thePlayer.inventory.currentItem * 20;
    
    int distance = Math.abs(should - animatedWidth) / 12;
    int step;
    int n = step = distance >= 3 ? distance : 3;
    if (animatedWidth < should) {
      animatedWidth = should - animatedWidth >= step ? (animatedWidth = animatedWidth + step) : should;
    } else if (animatedWidth > should) {
      animatedWidth = animatedWidth - should >= step ? (animatedWidth = animatedWidth - step) : should;
    }
    ...
    {
      float var7 = Minecraft.thePlayer.prevTimeInPortal + (Minecraft.thePlayer.timeInPortal - Minecraft.thePlayer.prevTimeInPortal) * p_175180_1_;
      if (var7 > 0.0F) {
    ...
    if (Minecraft.thePlayer.getSleepTimer() > 0)
    {
      ...
      int var11 = Minecraft.thePlayer.getSleepTimer();
    ...
    if (this.recordPlayingUpFor > 0)
    {
      ...
      float var7 = this.recordPlayingUpFor - p_175180_1_;
      ...
      if (var8 > 8)
      {
        ...
        func_175179_f().drawString(this.recordPlaying, -func_175179_f().getStringWidth(this.recordPlaying) / 2, -4, var9 + (var8 << 24 & 0xFF000000));
        GlStateManager.disableBlend();
    ...
    if (this.field_175195_w > 0)
    {
      ...
      float var7 = this.field_175195_w - p_175180_1_;
      int var8 = 255;
      ...
      if (var8 > 8)
      {
        ...
        func_175179_f().func_175065_a(this.field_175201_x, -func_175179_f().getStringWidth(this.field_175201_x) / 2, -10.0F, 0xFFFFFF | var9, true);
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        GlStateManager.scale(2.0F, 2.0F, 2.0F);
        func_175179_f().func_175065_a(this.field_175200_y, -func_175179_f().getStringWidth(this.field_175200_y) / 2, 5.0F, 0xFFFFFF | var9, true);
        GlStateManager.popMatrix();
        GlStateManager.disableBlend();
        GlStateManager.popMatrix();
      }
    ...
    ScorePlayerTeam var15 = var121.getPlayersTeam(Minecraft.thePlayer.getName());
    if (var15 != null)
    {
    ...
    if ((this.mc.gameSettings.keyBindPlayerList.getIsKeyPressed()) && ((!this.mc.isIntegratedServerRunning()) || (Minecraft.thePlayer.sendQueue.func_175106_d().size() > 1) || (var161 != null)))
    {
    ...
    if (!Luna.INSTANCE.isLoading) {
      NotificationUtil.INSTANCE.drawNotifications();
    } else if (Luna.INSTANCE.isLoading) {
      NotificationUtil.notifications.clear();
    }
    GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    GlStateManager.pushMatrix();
    new EventRender2D(var2.getScaledWidth(), var2.getScaledHeight()).call();
    GlStateManager.popMatrix();
  }
  ...
  protected void func_180479_a(ScaledResolution p_180479_1_, float p_180479_2_)
  {
    if ((this.mc.func_175606_aa() instanceof EntityPlayer))
    {
      ...
      this.zLevel = -90.0F;
      if (HUD.hotBar.getValBoolean())
      {
        drawRect(0.0D, PlayerUtils.getScaledRes().getScaledHeight() - 22, 
          PlayerUtils.getScaledRes().getScaledWidth(), PlayerUtils.getScaledRes().getScaledHeight(), 1962934272);
        
        drawRect(0.0D, PlayerUtils.getScaledRes().getScaledHeight() - 22, 
          PlayerUtils.getScaledRes().getScaledWidth(), PlayerUtils.getScaledRes().getScaledHeight(), 1962934272);
        
        drawRect(0.0D, PlayerUtils.getScaledRes().getScaledHeight() - 22, 
          PlayerUtils.getScaledRes().getScaledWidth(), PlayerUtils.getScaledRes().getScaledHeight(), 1912602624);
        
        drawRect(0.0D, PlayerUtils.getScaledRes().getScaledHeight() - 22, 
          PlayerUtils.getScaledRes().getScaledWidth(), PlayerUtils.getScaledRes().getScaledHeight() - 21, 
          ColorUtils.getMainColor());
        drawRect(PlayerUtils.getScaledRes().getScaledWidth() - 3, PlayerUtils.getScaledRes().getScaledHeight() - 21, 
          PlayerUtils.getScaledRes().getScaledWidth(), PlayerUtils.getScaledRes().getScaledHeight(), 
          ColorUtils.getMainColor());
      }
      else
      {
        drawTexturedModalRect(var4 - 91, p_180479_1_.getScaledHeight() - 22, 0, 0, 182, 22);
        drawTexturedModalRect(var4 - 91 - 1 + var3.inventory.currentItem * 20, p_180479_1_.getScaledHeight() - 22 - 1, 0, 22, 24, 22);
      }
      this.zLevel = var5;
  ...
  public void func_175176_b(ScaledResolution p_175176_1_, int p_175176_2_)
  {
    ...
    {
      short var9 = 182;
      int var10 = (int)(Minecraft.thePlayer.experience * (var9 + 1));
    ...
    if (Minecraft.thePlayer.experienceLevel > 0)
    {
      ...
      String var101 = "" + Minecraft.thePlayer.experienceLevel;
  ...
  public void func_175182_a(ScaledResolution p_175182_1_)
  {
    ...
    if ((this.remainingHighlightTicks > 0) && (this.highlightingItemStack != null))
    {
      ...
      if (var5 > 0)
      {
        ...
        GlStateManager.enableBlend();
        GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
        func_175179_f().func_175063_a(var2, var3, var4, 16777215 + (var5 << 24));
        GlStateManager.disableBlend();
        GlStateManager.popMatrix();
      }
    }
  ...
  public void func_175185_b(ScaledResolution p_175185_1_)
  {
    ...
    if (Minecraft.theWorld.getTotalWorldTime() >= 120500L) {
      ...
      var2 = I18n.format("demo.remainingTime", new Object[] { StringUtils.ticksToElapsedTime((int)(120500L - Minecraft.theWorld.getTotalWorldTime())) });
    }
    int var3 = func_175179_f().getStringWidth(var2);
    func_175179_f().func_175063_a(var2, p_175185_1_.getScaledWidth() - var3 - 10, 5.0F, 16777215);
    this.mc.mcProfiler.endSection();
  }
  ...
  protected boolean func_175183_b()
  {
    ...
    if (Minecraft.playerController.enableEverythingIsScrewedUpMode())
    {
      ...
      if ((this.mc.objectMouseOver != null) && (this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK))
      {
        ...
        return Minecraft.theWorld.getTileEntity(var1) instanceof IInventory;
      }
      return false;
    }
    return true;
  ...
  private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
  {
    ...
    int var221 = var21.size() * func_175179_f().FONT_HEIGHT;
    ...
    while (var12.hasNext())
    {
      ...
      int var18 = var231 - var11 * func_175179_f().FONT_HEIGHT;
      ...
      if (var11 == var21.size())
      {
        ...
        func_175179_f().drawString(var20, var25 + var6 / 2 - func_175179_f().getStringWidth(var20) / 2, var18 - func_175179_f().FONT_HEIGHT, 553648127);
      }
    }
  }
  ...
  private void func_180477_d(ScaledResolution p_180477_1_)
  {
    if ((this.mc.func_175606_aa() instanceof EntityPlayer))
    {
      ...
      if ((var371 instanceof EntityLivingBase))
      {
      ...
      {
        int var23 = Minecraft.thePlayer.getAir();
  ...
  private void renderBossHealth()
  {
    if ((BossStatus.bossName != null) && (BossStatus.statusBarTime > 0))
    {
      ...
      func_175179_f().func_175063_a(var8, var3 / 2 - func_175179_f().getStringWidth(var8) / 2, var7 - 10, bossTextColor);
      GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
      this.mc.getTextureManager().bindTexture(icons);
    }
  }
  ...
  private void func_175184_a(int p_175184_1_, int p_175184_2_, int p_175184_3_, float p_175184_4_, EntityPlayer p_175184_5_)
  {
    ...
    if (var6 != null)
    {
      float var7 = var6.animationsToGo - p_175184_4_;
      if (var7 > 0.0F)
      {
        GlStateManager.pushMatrix();
      ...
      this.itemRenderer.func_175030_a(Minecraft.fontRendererObj, var6, p_175184_2_, p_175184_3_);
    }
  }
