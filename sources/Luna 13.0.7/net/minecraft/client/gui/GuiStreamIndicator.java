...
public class GuiStreamIndicator
{
  ...
  public void render(int p_152437_1_, int p_152437_2_)
  {
    if (this.mc.getTwitchStream().func_152934_n())
    {
      ...
      {
        String var4 = "" + var3;
        int var5 = Minecraft.fontRendererObj.getStringWidth(var4);
        boolean var6 = true;
        int var7 = p_152437_1_ - var5 - 1;
        int var8 = p_152437_2_ + 20 - 1;
        int var10 = p_152437_2_ + 20 + Minecraft.fontRendererObj.FONT_HEIGHT - 1;
        ...
        Minecraft.fontRendererObj.drawString(var4, p_152437_1_ - var5, p_152437_2_ + 20, 16777215);
      }
