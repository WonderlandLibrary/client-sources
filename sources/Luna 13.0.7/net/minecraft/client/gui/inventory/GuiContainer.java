  ...
  extends GuiScreen
{
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    {
      byte var17 = 8;
      int var11 = this.draggedStack == null ? 8 : 16;
      String var12 = null;
    ...
    if (this.returningStack != null)
    {
      ...
      int var11 = this.returningStackDestSlot.xDisplayPosition - this.touchUpX;
      ...
      drawItemStack(this.returningStack, var13, var14, null);
    }
  ...
  protected void mouseReleased(int mouseX, int mouseY, int state)
  {
    ...
    if ((this.doubleClick) && (var4 != null) && (state == 0) && (this.inventorySlots.func_94530_a(null, var4)))
    {
      if (isShiftKeyDown())
      {
        ...
        {
          Iterator var11 = this.inventorySlots.inventorySlots.iterator();
          while (var11.hasNext())
          {
            Slot var10 = (Slot)var11.next();
            if ((var10 != null) && (var10.canTakeStack(Minecraft.thePlayer)) && (var10.getHasStack()) && (var10.inventory == var4.inventory) && (Container.canAddItemToSlot(var10, this.shiftClickedSlot, true))) {
    ...
    else
    {
      ...
      {
        handleMouseClick(null, 64537, Container.func_94534_d(0, this.dragSplittingLimit), 5);
        Iterator var11 = this.dragSplittingSlots.iterator();
        while (var11.hasNext())
        {
          Slot var10 = (Slot)var11.next();
          handleMouseClick(var10, var10.slotNumber, Container.func_94534_d(1, this.dragSplittingLimit), 5);
        }
        handleMouseClick(null, 64537, Container.func_94534_d(2, this.dragSplittingLimit), 5);
      }
  ...
  protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType)
  {
    ...
    Minecraft.playerController.windowClick(this.inventorySlots.windowId, slotId, clickedButton, clickType, Minecraft.thePlayer);
  }
  ...
  protected boolean checkHotbarKeys(int keyCode)
  {
    if ((Minecraft.thePlayer.inventory.getItemStack() == null) && (this.theSlot != null)) {
      for (int var2 = 0; var2 < 9; var2++) {
        ...
        {
          handleMouseClick(this.theSlot, this.theSlot.slotNumber, var2, 2);
          return true;
        }
      }
    }
