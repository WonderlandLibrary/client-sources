  ...
  public void updateScreen()
  {
    ...
    if ((this.buttonsNotDrawn) && (var1 >= 0))
    {
      ...
      for (int var4 = 0; var4 <= 2; var4++)
      {
        ...
        {
          int var8 = net.minecraft.tileentity.TileEntityBeacon.effectsList[var4][var7].id;
          PowerButton var9 = new PowerButton(var4 << 8 | var8, this.guiLeft + 76 + var7 * 24 - var6 / 2, this.guiTop + 22 + var4 * 25, var8, var4);
      ...
      {
        int var8 = net.minecraft.tileentity.TileEntityBeacon.effectsList[var10][var7].id;
        PowerButton var9 = new PowerButton(var10 << 8 | var8, this.guiLeft + 167 + var7 * 24 - var6 / 2, this.guiTop + 47, var8, var10);
        this.buttonList.add(var9);
        if (var10 >= var1) {
          var9.enabled = false;
        } else if (var8 == var3) {
