  ...
  extends GuiScreen
{
  ...
  public void initGui()
  {
    ...
    this.buttonList.add(this.field_146343_z = new GuiButton(2, width / 2 - 75, 115, 150, 20, I18n.format("selectWorld.gameMode", new Object[0])));
    this.buttonList.add(this.field_146324_A = new GuiButton(3, width / 2 - 75, 187, 150, 20, I18n.format("selectWorld.moreWorldOptions", new Object[0])));
    this.buttonList.add(this.field_146325_B = new GuiButton(4, width / 2 - 155, 100, 150, 20, I18n.format("selectWorld.mapFeatures", new Object[0])));
    this.field_146325_B.visible = false;
    this.buttonList.add(this.field_146326_C = new GuiButton(7, width / 2 + 5, 151, 150, 20, I18n.format("selectWorld.bonusItems", new Object[0])));
    this.field_146326_C.visible = false;
    this.buttonList.add(this.field_146320_D = new GuiButton(5, width / 2 + 5, 100, 150, 20, I18n.format("selectWorld.mapType", new Object[0])));
    this.field_146320_D.visible = false;
    this.buttonList.add(this.field_146321_E = new GuiButton(6, width / 2 - 155, 151, 150, 20, I18n.format("selectWorld.allowCommands", new Object[0])));
    this.field_146321_E.visible = false;
    this.buttonList.add(this.field_146322_F = new GuiButton(8, width / 2 + 5, 120, 150, 20, I18n.format("selectWorld.customizeType", new Object[0])));
  ...
  {
    this.field_146343_z.displayString = (I18n.format("selectWorld.gameMode", new Object[0]) + ": " + I18n.format(new StringBuilder().append("selectWorld.gameMode.").append(this.field_146342_r).toString(), new Object[0]));
  ...
  private boolean func_175299_g()
  {
    ...
    return (var1 != null) && (var1.getCanBeCreated()) && ((var1 != WorldType.DEBUG_WORLD) || (isShiftKeyDown()));
  }
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    else
    {
      ...
      drawString(this.fontRendererObj, I18n.format("selectWorld.resultFolder", new Object[0]) + " " + this.field_146336_i, width / 2 - 100, 85, -6250336);
      this.field_146333_g.drawTextBox();
      drawString(this.fontRendererObj, this.field_146323_G, width / 2 - 100, 137, -6250336);
      drawString(this.fontRendererObj, this.field_146328_H, width / 2 - 100, 149, -6250336);
    }
