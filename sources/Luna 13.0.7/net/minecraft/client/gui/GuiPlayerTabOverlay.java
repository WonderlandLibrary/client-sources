...
public class GuiPlayerTabOverlay
  extends Gui
{
  public static final Ordering field_175252_a = Ordering.from(new PlayerComparator(null));
  ...
  public void func_175249_a(int p_175249_1_, Scoreboard p_175249_2_, ScoreObjective p_175249_3_)
  {
    ...
    while (var8.hasNext())
    {
      ...
      int var10 = Minecraft.fontRendererObj.getStringWidth(func_175243_a(var9));
      var6 = Math.max(var6, var10);
      if ((p_175249_3_ != null) && (p_175249_3_.func_178766_e() != IScoreObjectiveCriteria.EnumRenderType.HEARTS))
      {
        var10 = Minecraft.fontRendererObj.getStringWidth(" " + p_175249_2_.getValueFromObjective(var9.func_178845_a().getName(), p_175249_3_).getScorePoints());
    ...
    boolean var11 = (this.field_175250_f.isIntegratedServerRunning()) || (Minecraft.getNetHandler().getNetworkManager().func_179292_f());
    int var12;
    int var12;
    if (p_175249_3_ != null)
    {
    ...
    if (this.header != null)
    {
      var17 = Minecraft.fontRendererObj.listFormattedStringToWidth(this.header.getFormattedText(), p_175249_1_ - 50);
      String var20;
      for (Iterator var19 = var17.iterator(); var19.hasNext(); var16 = Math.max(var16, Minecraft.fontRendererObj.getStringWidth(var20))) {
        var20 = (String)var19.next();
      }
    }
    if (this.footer != null)
    {
      var18 = Minecraft.fontRendererObj.listFormattedStringToWidth(this.footer.getFormattedText(), p_175249_1_ - 50);
      String var20;
      for (Iterator var19 = var18.iterator(); var19.hasNext(); var16 = Math.max(var16, Minecraft.fontRendererObj.getStringWidth(var20))) {
        var20 = (String)var19.next();
      }
    }
    if (var17 != null)
    {
      drawRect(p_175249_1_ / 2 - var16 / 2 - 1, var15 - 1, p_175249_1_ / 2 + var16 / 2 + 1, var15 + var17.size() * Minecraft.fontRendererObj.FONT_HEIGHT, Integer.MIN_VALUE);
      for (Iterator var19 = var17.iterator(); var19.hasNext(); var15 += Minecraft.fontRendererObj.FONT_HEIGHT)
      {
        String var20 = (String)var19.next();
        int var21 = Minecraft.fontRendererObj.getStringWidth(var20);
        Minecraft.fontRendererObj.func_175063_a(var20, p_175249_1_ / 2 - var21 / 2, var15, -1);
      }
      var15++;
    }
    ...
    for (int var30 = 0; var30 < var28; var30++)
    {
      ...
      if (var30 < var5.size())
      {
        ...
        if (var11)
        {
          ...
          EntityPlayer var26 = Minecraft.theWorld.getPlayerEntityByUUID(var24.func_178845_a().getId());
        ...
        if (var24.getGameType() == WorldSettings.GameType.SPECTATOR)
        {
          ...
          Minecraft.fontRendererObj.func_175063_a(var25, var22, var23, -1862270977);
        }
        else
        {
          Minecraft.fontRendererObj.func_175063_a(var25, var22, var23, -1);
        }
    ...
    {
      var15 += var29 * 9 + 1;
      drawRect(p_175249_1_ / 2 - var16 / 2 - 1, var15 - 1, p_175249_1_ / 2 + var16 / 2 + 1, var15 + var18.size() * Minecraft.fontRendererObj.FONT_HEIGHT, Integer.MIN_VALUE);
      for (Iterator var19 = var18.iterator(); var19.hasNext(); var15 += Minecraft.fontRendererObj.FONT_HEIGHT)
      {
        String var20 = (String)var19.next();
        int var21 = Minecraft.fontRendererObj.getStringWidth(var20);
        Minecraft.fontRendererObj.func_175063_a(var20, p_175249_1_ / 2 - var21 / 2, var15, -1);
  ...
  protected void func_175245_a(int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo p_175245_4_)
  {
    ...
    {
      byte var7;
      if (p_175245_4_.getResponseTime() < 150)
      {
        var7 = 0;
      }
      else
      {
        byte var7;
        if (p_175245_4_.getResponseTime() < 300)
        {
          var7 = 1;
        }
        else
        {
          byte var7;
          if (p_175245_4_.getResponseTime() < 600)
          {
            var7 = 2;
          }
          else
          {
            byte var7;
            if (p_175245_4_.getResponseTime() < 1000) {
              var7 = 3;
            } else {
              var7 = 4;
            }
  ...
  private void func_175247_a(ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_, int p_175247_5_, NetworkPlayerInfo p_175247_6_)
  {
    ...
    if (p_175247_1_.func_178766_e() == IScoreObjectiveCriteria.EnumRenderType.HEARTS)
    {
      ...
      boolean var10 = (p_175247_6_.func_178858_o() > this.field_175251_g.getUpdateCounter()) && ((p_175247_6_.func_178858_o() - this.field_175251_g.getUpdateCounter()) / 3L % 2L == 1L);
      if (var8 > 0)
      {
        ...
        else
        {
          ...
          if (p_175247_5_ - Minecraft.fontRendererObj.getStringWidth(var14 + "hp") >= p_175247_4_) {
            var14 = var14 + "hp";
          }
          Minecraft.fontRendererObj.func_175063_a(var14, (p_175247_5_ + p_175247_4_) / 2 - Minecraft.fontRendererObj.getStringWidth(var14) / 2, p_175247_2_, var13);
        }
      }
    }
    else
    {
      ...
      Minecraft.fontRendererObj.func_175063_a(var15, p_175247_5_ - Minecraft.fontRendererObj.getStringWidth(var15), p_175247_2_, 16777215);
    }
  }
