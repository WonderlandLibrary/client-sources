  ...
  extends GuiScreen
{
    ...
    throws IOException
  {
    if (button.enabled)
    {
      ...
      if (this.guiGameSettings.guiScale != guiScale)
      {
        ...
        setWorldAndResolution(this.mc, var4, var5);
      }
      if (button.id == 201)
      {
        this.mc.gameSettings.saveOptions();
  ...
  public void drawScreen(int x, int y, float z)
  {
    ...
    drawString(this.fontRendererObj, ver, 2, height - 10, 8421504);
    String verMc = "Minecraft 1.8";
    int lenMc = this.fontRendererObj.getStringWidth(verMc);
    drawString(this.fontRendererObj, verMc, width - lenMc - 2, height - 10, 8421504);
