  ...
  extends GuiScreen
{
  ...
  GuiScreenServerList(GuiScreen p_i1031_1_, ServerData p_i1031_2_)
  {
  ...
  public void initGui()
  {
    ...
    ((GuiButton)this.buttonList.get(0)).enabled = ((this.field_146302_g.getText().length() > 0 ? 1 : 0) & (this.field_146302_g.getText().split(":").length > 0 ? 1 : 0));
  }
    ...
    throws IOException
  {
    if (this.field_146302_g.textboxKeyTyped(typedChar, keyCode)) {
      ((GuiButton)this.buttonList.get(0)).enabled = ((this.field_146302_g.getText().length() > 0 ? 1 : 0) & (this.field_146302_g.getText().split(":").length > 0 ? 1 : 0));
    } else if (((keyCode == 28 ? 1 : 0) | (keyCode == 156 ? 1 : 0)) != 0) {
