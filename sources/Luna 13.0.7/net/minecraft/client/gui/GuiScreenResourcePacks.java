  ...
  extends GuiScreen
{
  ...
  public void initGui()
  {
    ...
    this.field_146970_i = new GuiResourcePackAvailable(this.mc, 200, height, this.field_146966_g);
    this.field_146970_i.setSlotXBoundsFromLeft(width / 2 - 4 - 200);
    this.field_146970_i.registerScrollButtons(7, 8);
    this.field_146967_r = new GuiResourcePackSelected(this.mc, 200, height, this.field_146969_h);
    this.field_146967_r.setSlotXBoundsFromLeft(width / 2 + 4);
  ...
  {
    return hasResourcePackEntry(p_146962_1_) ? this.field_146969_h : this.field_146966_g;
  }
