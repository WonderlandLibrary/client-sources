  ...
  extends GuiListExtended
{
    ...
    implements GuiListExtended.IGuiListEntry
  {
    ...
    {
      Minecraft.fontRendererObj.drawString(this.labelText, GuiScreen.width / 2 - this.labelWidth / 2, y + slotHeight - Minecraft.fontRendererObj.FONT_HEIGHT - 1, 16777215);
    }
    ...
    implements GuiListExtended.IGuiListEntry
  {
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
      ...
      Minecraft.fontRendererObj.drawString(this.field_148283_c, x + 90 - GuiKeyBindingList.this.maxListLabelWidth, y + slotHeight / 2 - Minecraft.fontRendererObj.FONT_HEIGHT / 2, 16777215);
