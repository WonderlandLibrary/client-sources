  ...
  extends GuiScreen
{
    ...
    extends GuiSlot
  {
    ...
    {
      super(GuiScreen.width, GuiScreen.height, 32, GuiScreen.height - 35, (int)(Minecraft.fontRendererObj.FONT_HEIGHT * 3.5D));
    ...
    protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_)
    {
      ...
      GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, var9, getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(var9), p_180791_3_ + 5, 8421504);
      if (var10 != null) {
        GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, var10, getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(var10), p_180791_3_ + 5 + 3 + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT, 8421504);
      }
    }
