  ...
  extends GuiScreen
{
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    int var4 = Math.max((int)(height * 0.85D / 2.0D - this.field_152323_r.size() * this.fontRendererObj.FONT_HEIGHT / 2.0F), 50);
    drawCenteredString(this.fontRendererObj, this.field_152324_f.getFormattedText(), width / 2, var4 - this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
    for (Iterator var5 = this.field_152323_r.iterator(); var5.hasNext(); var4 += this.fontRendererObj.FONT_HEIGHT)
    {
      String var6 = (String)var5.next();
      drawCenteredString(this.fontRendererObj, var6, width / 2, var4, 10526880);
    }
  ...
  public static void func_152321_a(GuiScreen p_152321_0_)
  {
    ...
    else
    {
      ...
      case 2: 
        ...
        break;
      default: 
        var1.displayGuiScreen(new GuiStreamUnavailable(p_152321_0_, Reason.UNSUPPORTED_OS_OTHER)); break;
        ...
        else if (!var2.func_152913_F())
        {
          ...
          case 2: 
          default: 
            var1.displayGuiScreen(new GuiStreamUnavailable(p_152321_0_, Reason.FAILED_TWITCH_AUTH_ERROR));break;
          }
        }
