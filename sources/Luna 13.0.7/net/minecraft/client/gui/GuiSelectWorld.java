  ...
  implements GuiYesNoCallback
{
  ...
  public void initGui()
  {
    ...
    this.field_146635_w[net.minecraft.world.WorldSettings.GameType.SURVIVAL.getID()] = I18n.format("gameMode.survival", new Object[0]);
    this.field_146635_w[net.minecraft.world.WorldSettings.GameType.CREATIVE.getID()] = I18n.format("gameMode.creative", new Object[0]);
    this.field_146635_w[net.minecraft.world.WorldSettings.GameType.ADVENTURE.getID()] = I18n.format("gameMode.adventure", new Object[0]);
    this.field_146635_w[net.minecraft.world.WorldSettings.GameType.SPECTATOR.getID()] = I18n.format("gameMode.spectator", new Object[0]);
  ...
  {
    this.buttonList.add(this.field_146641_z = new GuiButton(1, width / 2 - 154, height - 52, 150, 20, I18n.format("selectWorld.select", new Object[0])));
    this.buttonList.add(new GuiButton(3, width / 2 + 4, height - 52, 150, 20, I18n.format("selectWorld.create", new Object[0])));
    this.buttonList.add(this.field_146630_A = new GuiButton(6, width / 2 - 154, height - 28, 72, 20, I18n.format("selectWorld.rename", new Object[0])));
    this.buttonList.add(this.field_146642_y = new GuiButton(2, width / 2 - 76, height - 28, 72, 20, I18n.format("selectWorld.delete", new Object[0])));
    this.buttonList.add(this.field_146631_B = new GuiButton(7, width / 2 + 4, height - 28, 72, 20, I18n.format("selectWorld.recreate", new Object[0])));
    ...
    throws IOException
  {
    if (button.enabled) {
      if (button.id == 2)
      {
        String var2 = func_146614_d(this.field_146640_r);
        if (var2 != null)
        {
      ...
      else if (button.id == 7)
      {
        ...
        ISaveHandler var6 = this.mc.getSaveLoader().getSaveLoader(func_146621_a(this.field_146640_r), false);
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    drawCenteredString(this.fontRendererObj, this.field_146628_f, width / 2, 20, 16777215);
    ...
    extends GuiSlot
  {
    ...
    {
      super(GuiScreen.width, GuiScreen.height, 32, GuiScreen.height - 64, 36);
    }
    ...
    protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY)
    {
      ...
      boolean var5 = (GuiSelectWorld.this.field_146640_r >= 0) && (GuiSelectWorld.this.field_146640_r < getSize());
