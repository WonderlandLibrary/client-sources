  ...
  extends GuiScreen
{
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    {
      String var6 = I18n.format("book.pageIndicator", new Object[] { Integer.valueOf(this.currPage + 1), Integer.valueOf(this.bookTotalPages) });
      String var7 = "";
      if ((this.bookPages != null) && (this.currPage >= 0) && (this.currPage < this.bookPages.tagCount())) {
  ...
  public IChatComponent func_175385_b(int p_175385_1_, int p_175385_2_)
  {
    ...
    int var3 = p_175385_1_ - (width - this.bookImageWidth) / 2 - 36;
      ...
      if ((var3 <= 116) && (var4 < Minecraft.fontRendererObj.FONT_HEIGHT * var5 + var5))
      {
        ...
        if ((var6 >= 0) && (var6 < this.field_175386_A.size()))
        {
          ...
          while (var9.hasNext())
          {
            ...
            {
              var8 += Minecraft.fontRendererObj.getStringWidth(((ChatComponentText)var10).getChatComponentText_TextValue());
              if (var8 > var3) {
                return var10;
              }
            }
