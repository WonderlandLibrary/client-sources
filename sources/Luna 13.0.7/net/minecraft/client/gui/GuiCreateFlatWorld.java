  ...
  extends GuiScreen
{
  ...
  public void initGui()
  {
    ...
    this.field_146389_t.visible = (this.field_146388_u.visible = 0);
    ...
    throws IOException
  {
    ...
    {
      this.createWorldGui.field_146334_a = func_146384_e();
      this.mc.displayGuiScreen(this.createWorldGui);
    }
    else if (button.id == 5)
    {
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    drawCenteredString(this.fontRendererObj, this.field_146393_h, width / 2, 8, 16777215);
    int var4 = width / 2 - 92 - 16;
    drawString(this.fontRendererObj, this.field_146394_i, var4, 32, 16777215);
    drawString(this.fontRendererObj, this.field_146391_r, var4 + 2 + 213 - this.fontRendererObj.getStringWidth(this.field_146391_r), 32, 16777215);
    ...
    extends GuiSlot
  {
    ...
    public Details()
    {
      super(GuiScreen.width, GuiScreen.height, 43, GuiScreen.height - 60, 24);
    }
    ...
    protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_)
    {
      ...
      {
        String var13;
        if (p_180791_1_ == GuiCreateFlatWorld.this.theFlatGeneratorInfo.getFlatLayers().size() - 1) {
