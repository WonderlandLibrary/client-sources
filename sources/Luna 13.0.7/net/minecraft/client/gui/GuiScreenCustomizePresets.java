  ...
  extends GuiScreen
{
    ...
    extends GuiSlot
  {
    ...
    public ListPreset()
    {
      super(GuiScreen.width, GuiScreen.height, 80, GuiScreen.height - 32, 38);
    }
    ...
    private void func_178051_a(int p_178051_1_, int p_178051_2_, ResourceLocation p_178051_3_)
    {
      ...
      Gui.drawHorizontalLine(var4 - 1, var4 + 32, p_178051_2_ - 1, -2039584);
      Gui.drawHorizontalLine(var4 - 1, var4 + 32, p_178051_2_ + 32, -6250336);
