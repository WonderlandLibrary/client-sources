  ...
  public void drawLabel(Minecraft mc, int mouseX, int mouseY)
  {
    if (this.visible)
    {
      ...
      for (int var6 = 0; var6 < this.field_146173_k.size(); var6++) {
        if (this.centered) {
          drawCenteredString(this.fontRenderer, (String)this.field_146173_k.get(var6), this.field_146162_g + this.field_146167_a / 2, var5 + var6 * 10, this.field_146168_n);
        } else {
          drawString(this.fontRenderer, (String)this.field_146173_k.get(var6), this.field_146162_g, var5 + var6 * 10, this.field_146168_n);
        }
      }
    }
  }
