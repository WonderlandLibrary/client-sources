  ...
  implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester.IngestTestListener, IStream
{
  ...
  public void func_152922_k()
  {
    if ((this.broadcastController.isBroadcasting()) && (!this.broadcastController.isBroadcastPaused()))
    {
      ...
      long var3 = 1000000000 / this.field_152958_j;
      ...
      if (var7)
      {
        ...
        GlStateManager.ortho(0.0D, this.field_152956_h.framebufferWidth, this.field_152956_h.framebufferHeight, 0.0D, 1000.0D, 3000.0D);
        ...
        float var12 = var9.framebufferWidth / var9.framebufferTextureWidth;
        float var13 = var9.framebufferHeight / var9.framebufferTextureHeight;
  ...
  public void func_152915_s()
  {
    if (func_152934_n())
    {
      ...
      this.broadcastController.func_152829_a(func_152929_G() ? 0.0F : this.field_152953_e.gameSettings.streamMicVolume);
    }
  }
  ...
  public void func_152930_t()
  {
    ...
    VideoParams var2 = this.broadcastController.func_152834_a(func_152946_b(var1.streamKbps), func_152948_a(var1.streamFps), func_152947_c(var1.streamBytesPerPixel), this.field_152953_e.displayWidth / this.field_152953_e.displayHeight);
  ...
  {
    return func_152934_n() ? this.broadcastController.func_152816_j().viewers : 0;
  }
  ...
  public void func_180605_a(String p_180605_1_, ChatRawMessage[] p_180605_2_)
  {
    ...
    for (int var5 = 0; var5 < var4; var5++)
    {
      ...
      if (func_176028_a(var6.modes, var6.subscriptions, this.field_152953_e.gameSettings.streamChatUserFilter))
      {
        ...
        Iterator var10 = GuiTwitchUserMode.func_152328_a(var6.modes, var6.subscriptions, null).iterator();
        while (var10.hasNext())
        {
