...
public class IngestServerTester
{
  ...
  {
    if ((!func_153032_e()) && (this.field_153047_e != IngestTestState.Uninitalized)) {
  ...
  {
    if ((!func_153032_e()) && (!this.field_153060_r))
    {
  ...
  {
    if ((!this.field_153061_s) && (!this.field_153060_r) && (func_153037_m() < this.field_153048_f))
    {
      if ((!this.field_176008_y) && (!this.field_176007_z))
      {
        ...
        if (this.field_153051_i == RTMPState.SendVideo)
        {
          ...
          {
            p_153029_1_.bitrateKbps = ((float)(this.field_153050_h * 8L) / (float)func_153037_m());
            this.field_153064_v = this.field_153050_h;
          }
        }
        return true;
