  ...
  extends CommandBase
{
  ...
  {
    if (args.length < 9) {
      throw new WrongUsageException("orders.compare.usage", new Object[0]);
    }
    ...
    if (var8 > 524288) {
      throw new CommandException("orders.compare.tooManyBlocks", new Object[] { Integer.valueOf(var8), Integer.valueOf(524288) });
    }
    if ((var6.minY >= 0) && (var6.maxY < 256) && (var7.minY >= 0) && (var7.maxY < 256))
    {
      ...
      if ((var9.isAreaLoaded(var6)) && (var9.isAreaLoaded(var7)))
      {
          ...
          for (int var13 = var6.minY; var13 <= var6.maxY; var13++) {
            for (int var14 = var6.minX; var14 <= var6.maxX; var14++)
            {
              ...
              if ((!var10) || (var18.getBlock() != Blocks.air))
              {
                ...
                var8++;
                if (var17) {
                  throw new CommandException("orders.compare.failed", new Object[0]);
                }
              }
            }
          }
        ...
        notifyOperators(sender, this, "orders.compare.success", new Object[] { Integer.valueOf(var8) });
      }
      else
      {
        throw new CommandException("orders.compare.outOfWorld", new Object[0]);
      }
    }
    else
    {
  ...
  {
    return args.length == 10 ? getListOfStringsMatchingLastWord(args, new String[] { "masked", "all" }) : (args.length > 6) && (args.length <= 9) ? func_175771_a(args, 6, pos) : (args.length > 3) && (args.length <= 6) ? func_175771_a(args, 3, pos) : (args.length > 0) && (args.length <= 3) ? func_175771_a(args, 0, pos) : null;
  }
}
