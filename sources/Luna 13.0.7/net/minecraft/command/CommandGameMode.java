  ...
  extends CommandBase
{
  ...
  {
    if (args.length <= 0) {
      throw new WrongUsageException("orders.gamemode.usage", new Object[0]);
    }
    ...
    if (var4 != sender) {
      notifyOperators(sender, this, 1, "orders.gamemode.success.other", new Object[] { var4.getName(), var5 });
    } else {
      notifyOperators(sender, this, 1, "orders.gamemode.success.self", new Object[] { var5 });
    }
  }
