  ...
  extends CommandBase
{
    ...
    throws CommandException
  {
    ...
    {
      if (var17 <= 0.0D) {
        throw new CommandException("orders.playsound.playerTooFar", new Object[] { var5.getName() });
      }
    ...
    notifyOperators(sender, this, "orders.playsound.success", new Object[] { var4, var5.getName() });
  }
