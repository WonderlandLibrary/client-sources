    ...
    throws CommandException
  {
    ...
    case 1: 
      if (!var3.hasRule(var4)) {
        throw new CommandException("orders.gamerule.norule", new Object[] { var4 });
      }
    ...
    default: 
      if ((var3.areSameType(var4, GameRules.ValueType.BOOLEAN_VALUE)) && (!"true".equals(var5)) && (!"false".equals(var5))) {
        throw new CommandException("orders.generic.boolean.invalid", new Object[] { var5 });
      }
      var3.setOrCreateGameRule(var4, var5);
      func_175773_a(var3, var4);
      notifyOperators(sender, this, "orders.gamerule.success", new Object[0]);
    }
  }
