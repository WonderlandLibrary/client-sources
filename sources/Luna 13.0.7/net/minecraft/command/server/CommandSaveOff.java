  ...
  extends CommandBase
{
    ...
    throws CommandException
  {
    ...
    if (var4) {
      notifyOperators(sender, this, "orders.save.disabled", new Object[0]);
    } else {
      throw new CommandException("orders.save-off.alreadyOff", new Object[0]);
    }
  }
}
