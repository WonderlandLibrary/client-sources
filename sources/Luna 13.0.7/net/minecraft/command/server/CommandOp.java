  ...
  extends CommandBase
{
    ...
    throws CommandException
  {
    if ((args.length == 1) && (args[0].length() > 0))
    {
      ...
      if (var4 == null) {
        throw new CommandException("orders.op.failed", new Object[] { args[0] });
      }
      var3.getConfigurationManager().addOp(var4);
      notifyOperators(sender, this, "orders.op.success", new Object[] { args[0] });
    }
    else
    {
      throw new WrongUsageException("orders.op.usage", new Object[0]);
    }
  }
