  ...
  extends CommandBase
{
  ...
  {
    if (args.length < 1) {
      throw new WrongUsageException("orders.tp.usage", new Object[0]);
    }
    byte var3 = 0;
    Object var4;
    Object var4;
    ...
    if ((args.length != 1) && (args.length != 2))
    {
      ...
      if (((Entity)var4).worldObj != null)
      {
        ...
        CommandBase.CoordinateArg var9 = func_175770_a(((Entity)var4).rotationYaw, args.length > var14 ? args[(var14++)] : "~", false);
        CommandBase.CoordinateArg var10 = func_175770_a(((Entity)var4).rotationPitch, args.length > var14 ? args[var14] : "~", false);
        ...
        notifyOperators(sender, this, "orders.tp.success.coordinates", new Object[] { ((Entity)var4).getName(), Double.valueOf(var6.func_179628_a()), Double.valueOf(var7.func_179628_a()), Double.valueOf(var8.func_179628_a()) });
      }
    }
    else
    {
      ...
      if (var5.worldObj != ((Entity)var4).worldObj) {
        throw new CommandException("orders.tp.notSameDimension", new Object[0]);
      }
      ((Entity)var4).mountEntity(null);
      if ((var4 instanceof EntityPlayerMP)) {
      ...
      notifyOperators(sender, this, "orders.tp.success", new Object[] { ((Entity)var4).getName(), var5.getName() });
    }
  }
