    ...
    throws CommandException
  {
    if ((args.length == 1) && (args[0].length() > 1))
    {
      ...
      if (var3.matches())
      {
        ...
        notifyOperators(sender, this, "orders.unbanip.success", new Object[] { args[0] });
      }
      else
      {
        throw new SyntaxErrorException("orders.unbanip.invalid", new Object[0]);
      }
    }
    else
    {
      throw new WrongUsageException("orders.unbanip.usage", new Object[0]);
    }
  }
