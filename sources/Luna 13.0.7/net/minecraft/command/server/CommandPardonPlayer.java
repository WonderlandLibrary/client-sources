  ...
  extends CommandBase
{
    ...
    throws CommandException
  {
    if ((args.length == 1) && (args[0].length() > 0))
    {
      ...
      if (var4 == null) {
        throw new CommandException("orders.unban.failed", new Object[] { args[0] });
      }
      var3.getConfigurationManager().getBannedPlayers().removeEntry(var4);
      notifyOperators(sender, this, "orders.unban.success", new Object[] { args[0] });
    }
    else
    {
      throw new WrongUsageException("orders.unban.usage", new Object[0]);
    }
  }
