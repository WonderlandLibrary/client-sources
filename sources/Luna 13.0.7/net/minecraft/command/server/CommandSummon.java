  ...
  extends CommandBase
{
  ...
  {
    if (args.length < 1) {
      throw new WrongUsageException("orders.summon.usage", new Object[0]);
    }
    String var3 = args[0];
    ...
    if (!var12.isBlockLoaded(var4)) {
      throw new CommandException("orders.summon.outOfWorld", new Object[0]);
    }
    if ("LightningBolt".equals(var3))
    {
      var12.addWeatherEffect(new EntityLightningBolt(var12, var6, var8, var10));
      notifyOperators(sender, this, "orders.summon.success", new Object[0]);
    }
    else
    {
      ...
      if (args.length >= 5)
      {
        ...
        {
          throw new CommandException("orders.summon.tagError", new Object[] { var20.getMessage() });
        }
      }
      ...
      {
        Entity var21;
        throw new CommandException("orders.summon.failed", new Object[0]);
      }
      Entity var21;
      if (var21 == null) {
        throw new CommandException("orders.summon.failed", new Object[0]);
  ...
  {
    return (args.length > 1) && (args.length <= 4) ? func_175771_a(args, 1, pos) : args.length == 1 ? func_175762_a(args, EntityList.func_180124_b()) : null;
  }
}
