  ...
  extends CommandBase
{
    ...
    throws CommandException
  {
    if ((args.length >= 1) && (args[0].length() > 1))
    {
      ...
      else
      {
        ...
        if (var5 == null) {
          throw new PlayerNotFoundException("orders.banip.invalid", new Object[0]);
        }
    ...
    {
      throw new WrongUsageException("orders.banip.usage", new Object[0]);
    }
  }
  ...
  protected void func_147210_a(ICommandSender p_147210_1_, String p_147210_2_, String p_147210_3_)
  {
    ...
    if (var5.isEmpty()) {
      notifyOperators(p_147210_1_, this, "orders.banip.success", new Object[] { p_147210_2_ });
    } else {
      notifyOperators(p_147210_1_, this, "orders.banip.success.players", new Object[] { p_147210_2_, joinNiceString(var6) });
    }
  }
}
