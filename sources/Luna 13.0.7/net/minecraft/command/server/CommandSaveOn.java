  ...
  extends CommandBase
{
    ...
    throws CommandException
  {
    ...
    if (var4) {
      notifyOperators(sender, this, "orders.save.enabled", new Object[0]);
    } else {
      throw new CommandException("orders.save-on.alreadyOn", new Object[0]);
    }
  }
}
