  ...
  extends CommandBase
{
  ...
  {
    return "orders.testforblock.usage";
  }
  ...
  {
    if (args.length < 4) {
      throw new WrongUsageException("orders.testforblock.usage", new Object[0]);
    }
    ...
    if (var4 == null) {
      throw new NumberInvalidException("orders.setblock.notFound", new Object[] { args[3] });
    }
    int var5 = -1;
    if (args.length >= 5) {
    ...
    if (!var6.isBlockLoaded(var3)) {
      throw new CommandException("orders.testforblock.outOfWorld", new Object[0]);
    }
    ...
    if ((args.length >= 6) && (var4.hasTileEntity()))
    {
      ...
      {
        throw new CommandException("orders.setblock.tagError", new Object[] { var13.getMessage() });
      }
    }
    IBlockState var14 = var6.getBlockState(var3);
    Block var10 = var14.getBlock();
    if (var10 != var4) {
      throw new CommandException("orders.testforblock.failed.tile", new Object[] { Integer.valueOf(var3.getX()), Integer.valueOf(var3.getY()), Integer.valueOf(var3.getZ()), var10.getLocalizedName(), var4.getLocalizedName() });
    }
    if (var5 > -1)
    {
      int var11 = var14.getBlock().getMetaFromState(var14);
      if (var11 != var5) {
        throw new CommandException("orders.testforblock.failed.data", new Object[] { Integer.valueOf(var3.getX()), Integer.valueOf(var3.getY()), Integer.valueOf(var3.getZ()), Integer.valueOf(var11), Integer.valueOf(var5) });
      }
    }
    if (var8)
    {
      ...
      if (var15 == null) {
        throw new CommandException("orders.testforblock.failed.tileEntity", new Object[] { Integer.valueOf(var3.getX()), Integer.valueOf(var3.getY()), Integer.valueOf(var3.getZ()) });
      }
      NBTTagCompound var12 = new NBTTagCompound();
      var15.writeToNBT(var12);
      if (!func_175775_a(var7, var12, true)) {
        throw new CommandException("orders.testforblock.failed.nbt", new Object[] { Integer.valueOf(var3.getX()), Integer.valueOf(var3.getY()), Integer.valueOf(var3.getZ()) });
      }
    }
    sender.func_174794_a(CommandResultStats.Type.AFFECTED_BLOCKS, 1);
    notifyOperators(sender, this, "orders.testforblock.success", new Object[] { Integer.valueOf(var3.getX()), Integer.valueOf(var3.getY()), Integer.valueOf(var3.getZ()) });
  }
  ...
  {
    return args.length == 4 ? func_175762_a(args, Block.blockRegistry.getKeys()) : (args.length > 0) && (args.length <= 3) ? func_175771_a(args, 0, pos) : null;
  }
}
