  ...
  extends CommandBase
{
  ...
  {
    return "orders.achievement.usage";
  }
  ...
  {
    if (args.length < 2) {
      throw new WrongUsageException("orders.achievement.usage", new Object[0]);
    }
    final StatBase var3 = StatList.getOneShotStat(args[1]);
    if ((var3 == null) && (!args[1].equals("*"))) {
      throw new CommandException("orders.achievement.unknownAchievement", new Object[] { args[1] });
    }
    ...
    if ((var5) || (var6)) {
      if (var3 == null)
      {
        if (var5)
        {
          ...
          notifyOperators(sender, this, "orders.achievement.give.success.all", new Object[] { var4.getName() });
        }
        else if (var6)
        {
          ...
          notifyOperators(sender, this, "orders.achievement.take.success.all", new Object[] { var4.getName() });
        }
      }
      else
      {
        if ((var3 instanceof Achievement))
        {
          ...
          if (var5)
          {
            if (var4.getStatFile().hasAchievementUnlocked(var7)) {
              throw new CommandException("orders.achievement.alreadyHave", new Object[] { var4.getName(), var3.func_150955_j() });
            }
            for (ArrayList var8 = Lists.newArrayList(); (var7.parentAchievement != null) && (!var4.getStatFile().hasAchievementUnlocked(var7.parentAchievement)); var7 = var7.parentAchievement) {
          ...
          {
            if (!var4.getStatFile().hasAchievementUnlocked(var7)) {
              throw new CommandException("orders.achievement.dontHave", new Object[] { var4.getName(), var3.func_150955_j() });
            }
            ArrayList var8 = Lists.newArrayList(Iterators.filter(AchievementList.achievementList.iterator(), new Predicate()
            {
            ...
            for (; (var7.parentAchievement != null) && (var4.getStatFile().hasAchievementUnlocked(var7.parentAchievement)); var7 = var7.parentAchievement) {
        ...
        if (var5)
        {
          ...
          notifyOperators(sender, this, "orders.achievement.give.success.one", new Object[] { var4.getName(), var3.func_150955_j() });
        }
        else if (var6)
        {
          var4.func_175145_a(var3);
          notifyOperators(sender, this, "orders.achievement.take.success.one", new Object[] { var3.func_150955_j(), var4.getName() });
        }
      }
    }
  }
