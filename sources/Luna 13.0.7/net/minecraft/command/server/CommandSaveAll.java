  ...
  extends CommandBase
{
    ...
    throws CommandException
  {
    ...
    sender.addChatMessage(new ChatComponentTranslation("orders.save.start", new Object[0]));
    ...
    try
    {
      ...
      {
        sender.addChatMessage(new ChatComponentTranslation("orders.save.flushStart", new Object[0]));
        ...
        sender.addChatMessage(new ChatComponentTranslation("orders.save.flushEnd", new Object[0]));
      }
    }
    catch (MinecraftException var7)
    {
      notifyOperators(sender, this, "orders.save.failed", new Object[] { var7.getMessage() });
      return;
    }
    notifyOperators(sender, this, "orders.save.success", new Object[0]);
  }
}
