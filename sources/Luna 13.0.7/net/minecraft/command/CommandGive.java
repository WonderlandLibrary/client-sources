  ...
  extends CommandBase
{
  ...
  {
    if (args.length < 2) {
      throw new WrongUsageException("orders.give.usage", new Object[0]);
    }
    ...
    if (args.length >= 5)
    {
      ...
      {
        throw new CommandException("orders.give.tagError", new Object[] { var10.getMessage() });
      }
    }
    ...
    notifyOperators(sender, this, "orders.give.success", new Object[] { var7.getChatComponent(), Integer.valueOf(var5), var3.getName() });
  }
