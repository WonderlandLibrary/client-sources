  ...
  implements ICommandManager
{
  ...
  public int executeCommand(ICommandSender sender, String command)
  {
    ...
    if (var5 == null)
    {
      ChatComponentTranslation var8 = new ChatComponentTranslation("orders.generic.notFound", new Object[0]);
    ...
    {
      ChatComponentTranslation var8 = new ChatComponentTranslation("orders.generic.permission", new Object[0]);
      var8.getChatStyle().setColor(EnumChatFormatting.RED);
      sender.addChatMessage(var8);
    }
  ...
  protected boolean func_175786_a(ICommandSender p_175786_1_, String[] p_175786_2_, ICommand p_175786_3_, String p_175786_4_)
  {
    ...
    {
      ChatComponentTranslation var6 = new ChatComponentTranslation("orders.generic.usage", new Object[] { new ChatComponentTranslation(var7.getMessage(), var7.getErrorOjbects()) });
    ...
    {
      ChatComponentTranslation var6 = new ChatComponentTranslation("orders.generic.exception", new Object[0]);
      var6.getChatStyle().setColor(EnumChatFormatting.RED);
      p_175786_1_.addChatMessage(var6);
