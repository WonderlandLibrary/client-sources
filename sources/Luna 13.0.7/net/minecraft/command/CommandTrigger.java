  ...
  extends CommandBase
{
  ...
  {
    if (args.length < 3) {
      throw new WrongUsageException("orders.trigger.usage", new Object[0]);
    }
    EntityPlayerMP var3;
    EntityPlayerMP var3;
    ...
    else
    {
      ...
      if (!(var4 instanceof EntityPlayerMP)) {
        throw new CommandException("orders.trigger.invalidPlayer", new Object[0]);
      }
    ...
    if ((var5 != null) && (var5.getCriteria() == IScoreObjectiveCriteria.field_178791_c))
    {
      ...
      if (!var8.func_178819_b(var3.getName(), var5)) {
        throw new CommandException("orders.trigger.invalidObjective", new Object[] { args[0] });
      }
      Score var7 = var8.getValueFromObjective(var3.getName(), var5);
      if (var7.func_178816_g()) {
        throw new CommandException("orders.trigger.disabled", new Object[] { args[0] });
      }
      ...
      else
      {
        if (!"add".equals(args[1])) {
          throw new CommandException("orders.trigger.invalidMode", new Object[] { args[1] });
        }
        var7.increseScore(var6);
      }
      var7.func_178815_a(true);
      if (var3.theItemInWorldManager.isCreative()) {
        notifyOperators(sender, this, "orders.trigger.success", new Object[] { args[0], args[1], args[2] });
      }
    }
    else
    {
