  ...
  extends CommandBase
{
    ...
    throws CommandException
  {
    if ((args.length >= 1) && (args.length <= 2))
    {
      ...
      WorldServer var4 = net.minecraft.server.MinecraftServer.getServer().worldServers[0];
      ...
      if ("clear".equalsIgnoreCase(args[0]))
      {
        ...
        notifyOperators(sender, this, "orders.weather.clear", new Object[0]);
      }
      else if ("rain".equalsIgnoreCase(args[0]))
      {
        ...
        var5.setThundering(false);
        notifyOperators(sender, this, "orders.weather.rain", new Object[0]);
      }
      else
      {
        if (!"thunder".equalsIgnoreCase(args[0])) {
          throw new WrongUsageException("orders.weather.usage", new Object[0]);
        }
        var5.func_176142_i(0);
        var5.setRainTime(var3);
        var5.setThunderTime(var3);
        ...
        notifyOperators(sender, this, "orders.weather.thunder", new Object[0]);
      }
    }
    else
    {
