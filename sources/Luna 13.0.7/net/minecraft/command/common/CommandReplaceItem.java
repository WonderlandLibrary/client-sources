  ...
  extends CommandBase
{
  ...
  {
    return "orders.replaceitem.usage";
  }
  ...
  {
    if (args.length < 1) {
      throw new WrongUsageException("orders.replaceitem.usage", new Object[0]);
    }
    boolean var3;
    boolean var3;
    ...
    {
      if (args.length < 6) {
        throw new WrongUsageException("orders.replaceitem.block.usage", new Object[0]);
      }
      var4 = 4;
    }
    else
    {
      if (args.length < 4) {
        throw new WrongUsageException("orders.replaceitem.entity.usage", new Object[0]);
      }
      var4 = 2;
    }
    int var16 = var4 + 1;
    int var5 = func_175783_e(args[var4]);
    Item var6;
    try
    {
    ...
    if (args.length > var16)
    {
      ...
      {
        throw new CommandException("orders.replaceitem.tagError", new Object[] { var14.getMessage() });
      }
    }
    ...
    if (var3)
    {
      ...
      if ((var12 == null) || (!(var12 instanceof IInventory))) {
        throw new CommandException("orders.replaceitem.noContainer", new Object[] { Integer.valueOf(var17.getX()), Integer.valueOf(var17.getY()), Integer.valueOf(var17.getZ()) });
      }
    ...
    else
    {
      ...
      if (!var18.func_174820_d(var5, var9)) {
        throw new CommandException("orders.replaceitem.failed", new Object[] { Integer.valueOf(var5), Integer.valueOf(var7), var9 == null ? "Air" : var9.getChatComponent() });
      }
      if ((var18 instanceof EntityPlayer)) {
        ((EntityPlayer)var18).inventoryContainer.detectAndSendChanges();
      }
    ...
    notifyOperators(sender, this, "orders.replaceitem.success", new Object[] { Integer.valueOf(var5), Integer.valueOf(var7), var9 == null ? "Air" : var9.getChatComponent() });
  }
  
  private int func_175783_e(String p_175783_1_)
    throws CommandException
  {
    if (!field_175785_a.containsKey(p_175783_1_)) {
      throw new CommandException("orders.generic.parameter.invalid", new Object[] { p_175783_1_ });
    }
  ...
  {
    return ((args.length != 3) || (!args[0].equals("entity"))) && ((args.length != 5) || (!args[0].equals("block"))) ? func_175762_a(args, Item.itemRegistry.getKeys()) : ((args.length != 4) || (!args[0].equals("entity"))) && ((args.length != 6) || (!args[0].equals("block"))) ? null : (args.length == 2) && (args[0].equals("entity")) ? getListOfStringsMatchingLastWord(args, func_175784_d()) : args.length == 1 ? getListOfStringsMatchingLastWord(args, new String[] { "entity", "block" }) : func_175762_a(args, field_175785_a.keySet());
  }
