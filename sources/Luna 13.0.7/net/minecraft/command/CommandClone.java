  ...
  extends CommandBase
{
  ...
  {
    if (args.length < 9) {
      throw new WrongUsageException("orders.clone.usage", new Object[0]);
    }
    ...
    if (var8 > 32768) {
      throw new CommandException("orders.clone.tooManyBlocks", new Object[] { Integer.valueOf(var8), Integer.valueOf(32768) });
    }
    boolean var9 = false;
    Block var10 = null;
    int var11 = -1;
    if (((args.length < 11) || ((!args[10].equals("force")) && (!args[10].equals("move")))) && (var6.intersectsWith(var7))) {
      throw new CommandException("orders.clone.noOverlap", new Object[0]);
    }
    ...
    if ((var6.minY >= 0) && (var6.maxY < 256) && (var7.minY >= 0) && (var7.maxY < 256))
    {
      ...
      if ((var12.isAreaLoaded(var6)) && (var12.isAreaLoaded(var7)))
      {
        ...
        {
          BlockPos var29;
          for (Iterator var27 = var17.iterator(); var27.hasNext(); var12.setBlockState(var29, Blocks.barrier.getDefaultState(), 2))
          {
        ...
        for (Iterator var32 = var30.iterator(); var32.hasNext(); var12.setBlockState(var34.field_179537_a, Blocks.barrier.getDefaultState(), 2))
        {
          var34 = (StaticCloneData)var32.next();
          TileEntity var36 = var12.getTileEntity(var34.field_179537_a);
        ...
        if (var8 <= 0) {
          throw new CommandException("orders.clone.failed", new Object[0]);
        }
        sender.func_174794_a(CommandResultStats.Type.AFFECTED_BLOCKS, var8);
        notifyOperators(sender, this, "orders.clone.success", new Object[] { Integer.valueOf(var8) });
      }
      else
      {
        throw new CommandException("orders.clone.outOfWorld", new Object[0]);
      }
    }
    else
    {
