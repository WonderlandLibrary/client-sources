  ...
  extends CommandBase
{
  ...
  {
    if (args.length < 8) {
      throw new WrongUsageException("orders.particle.usage", new Object[0]);
    }
    boolean var3 = false;
    ...
    if (!var3) {
      throw new CommandException("orders.particle.notFound", new Object[] { args[0] });
    }
    String var30 = args[0];
    ...
    if ((var23 instanceof WorldServer))
    {
      ...
      notifyOperators(sender, this, "orders.particle.success", new Object[] { var30, Integer.valueOf(Math.max(var21, 1)) });
    }
  }
  
  public List addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos)
  {
    return args.length == 9 ? getListOfStringsMatchingLastWord(args, new String[] { "normal", "force" }) : (args.length > 1) && (args.length <= 4) ? func_175771_a(args, 1, pos) : args.length == 1 ? getListOfStringsMatchingLastWord(args, EnumParticleTypes.func_179349_a()) : null;
  }
}
