  ...
  extends CommandBase
{
  ...
  {
    if (args.length < 1) {
      throw new WrongUsageException("orders.debug.usage", new Object[0]);
    }
    if (args[0].equals("start"))
    {
      ...
      notifyOperators(sender, this, "orders.debug.start", new Object[0]);
    ...
    else if (args[0].equals("stop"))
    {
      ...
      if (!MinecraftServer.getServer().theProfiler.profilingEnabled) {
        throw new CommandException("orders.debug.notStarted", new Object[0]);
      }
      ...
      notifyOperators(sender, this, "orders.debug.stop", new Object[] { Float.valueOf((float)var6 / 1000.0F), Integer.valueOf(var8) });
    }
