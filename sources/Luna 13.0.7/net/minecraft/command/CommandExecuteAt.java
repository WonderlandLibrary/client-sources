    ...
    throws CommandException
  {
    ...
    if (("detect".equals(args[4])) && (args.length > 10))
    {
      ...
      if ((var22.getBlock() != var19) || ((var20 >= 0) && (var22.getBlock().getMetaFromState(var22) != var20))) {
        throw new CommandException("orders.execute.failed", new Object[] { "detect", var3.getName() });
      }
      var11 = 10;
    }
    ...
    ICommandSender var14 = new ICommandSender()
    {
      ...
      {
        return new Vec3(var4, var8, this.val$var8);
      }
    ...
    try
    {
      ...
      if (var16 < 1) {
        throw new CommandException("orders.execute.allInvocationsFailed", new Object[] { var24 });
      }
    }
    catch (Throwable var23)
    {
      throw new CommandException("orders.execute.failed", new Object[] { var24, var3.getName() });
    }
  }
