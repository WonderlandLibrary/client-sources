  ...
  extends CommandBase
{
  ...
  {
    return "orders.spreadplayers.usage";
  }
  ...
  {
    if (args.length < 6) {
      throw new WrongUsageException("orders.spreadplayers.usage", new Object[0]);
    }
    byte var3 = 0;
    ...
    sender.addChatMessage(new ChatComponentTranslation("orders.spreadplayers.spreading." + (var13 ? "teams" : "players"), new Object[] { Integer.valueOf(var14.size()), Double.valueOf(var11), Double.valueOf(var5), Double.valueOf(var7), Double.valueOf(var9) }));
    func_110669_a(sender, var14, new Position(var5, var7), var9, var11, ((Entity)var14.get(0)).worldObj, var13);
  }
    ...
    throws CommandException
  {
    ...
    notifyOperators(p_110669_1_, this, "orders.spreadplayers.success." + (p_110669_9_ ? "teams" : "players"), new Object[] { Integer.valueOf(var19.length), Double.valueOf(p_110669_3_.field_111101_a), Double.valueOf(p_110669_3_.field_111100_b) });
    if (var19.length > 1) {
      p_110669_1_.addChatMessage(new ChatComponentTranslation("orders.spreadplayers.info." + (p_110669_9_ ? "teams" : "players"), new Object[] { String.format("%.2f", new Object[] { Double.valueOf(var21) }), Integer.valueOf(var20) }));
    }
  }
  ...
  private int func_110668_a(Position p_110668_1_, double p_110668_2_, World worldIn, Random p_110668_5_, double p_110668_6_, double p_110668_8_, double p_110668_10_, double p_110668_12_, Position[] p_110668_14_, boolean p_110668_15_)
    throws CommandException
  {
    boolean var16 = true;
    ...
    if (var17 >= 10000) {
      throw new CommandException("orders.spreadplayers.failure." + (p_110668_15_ ? "teams" : "players"), new Object[] { Integer.valueOf(p_110668_14_.length), Double.valueOf(p_110668_1_.field_111101_a), Double.valueOf(p_110668_1_.field_111100_b), String.format("%.2f", new Object[] { Double.valueOf(var18) }) });
    }
    return var17;
  }
