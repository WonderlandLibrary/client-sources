...
public class CompressedStreamTools
{
  ...
  public static NBTTagCompound readCompressed(InputStream p_74796_0_)
    throws IOException
  {
    DataInputStream var1 = new DataInputStream(new BufferedInputStream(new GZIPInputStream(p_74796_0_)));Throwable localThrowable3 = null;
    try
    {
  ...
  public static void writeCompressed(NBTTagCompound p_74799_0_, OutputStream p_74799_1_)
    throws IOException
  {
    DataOutputStream var2 = new DataOutputStream(new BufferedOutputStream(new GZIPOutputStream(p_74799_1_)));Throwable localThrowable3 = null;
    try
    {
  ...
  public static void write(NBTTagCompound p_74795_0_, File p_74795_1_)
    throws IOException
  {
    DataOutputStream var2 = new DataOutputStream(new FileOutputStream(p_74795_1_));Throwable localThrowable3 = null;
    try
    {
    ...
    throws IOException
  {
    ...
    DataInputStream var1 = new DataInputStream(new FileInputStream(p_74797_0_));Throwable localThrowable3 = null;
    try
    {
      var2 = func_152456_a(var1, NBTSizeTracker.INFINITE);
    }
  ...
  private static void writeTag(NBTBase p_150663_0_, DataOutput p_150663_1_)
    throws IOException
  {
