...
public class ConnectedTextures
{
  ...
  private static TextureAtlasSprite getConnectedTextureCtm(ConnectedProperties cp, IBlockAccess blockAccess, IBlockState blockState, BlockPos blockPos, int vertAxis, int side, TextureAtlasSprite icon, int metadata, RenderEnv renderEnv)
  {
    ...
    {
    case 0: 
      borders[0] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetEast().offsetNorth(), side, icon, metadata) ? 1 : false);
      borders[1] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetWest().offsetNorth(), side, icon, metadata) ? 1 : false);
      borders[2] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetEast().offsetSouth(), side, icon, metadata) ? 1 : false);
      borders[3] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetWest().offsetSouth(), side, icon, metadata) ? 1 : false);
      break;
    case 1: 
      borders[0] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetEast().offsetSouth(), side, icon, metadata) ? 1 : false);
      borders[1] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetWest().offsetSouth(), side, icon, metadata) ? 1 : false);
      borders[2] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetEast().offsetNorth(), side, icon, metadata) ? 1 : false);
      borders[3] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetWest().offsetNorth(), side, icon, metadata) ? 1 : false);
      break;
    case 2: 
      borders[0] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetWest().offsetDown(), side, icon, metadata) ? 1 : false);
      borders[1] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetEast().offsetDown(), side, icon, metadata) ? 1 : false);
      borders[2] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetWest().offsetUp(), side, icon, metadata) ? 1 : false);
      borders[3] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetEast().offsetUp(), side, icon, metadata) ? 1 : false);
      break;
    case 3: 
      borders[0] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetEast().offsetDown(), side, icon, metadata) ? 1 : false);
      borders[1] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetWest().offsetDown(), side, icon, metadata) ? 1 : false);
      borders[2] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetEast().offsetUp(), side, icon, metadata) ? 1 : false);
      borders[3] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetWest().offsetUp(), side, icon, metadata) ? 1 : false);
      break;
    case 4: 
      borders[0] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetDown().offsetSouth(), side, icon, metadata) ? 1 : false);
      borders[1] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetDown().offsetNorth(), side, icon, metadata) ? 1 : false);
      borders[2] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetUp().offsetSouth(), side, icon, metadata) ? 1 : false);
      borders[3] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetUp().offsetNorth(), side, icon, metadata) ? 1 : false);
      break;
    case 5: 
      borders[0] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetDown().offsetNorth(), side, icon, metadata) ? 1 : false);
      borders[1] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetDown().offsetSouth(), side, icon, metadata) ? 1 : false);
      borders[2] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetUp().offsetNorth(), side, icon, metadata) ? 1 : false);
      borders[3] = (!isNeighbour(cp, blockAccess, blockState, blockPos.offsetUp().offsetSouth(), side, icon, metadata) ? 1 : false);
    }
