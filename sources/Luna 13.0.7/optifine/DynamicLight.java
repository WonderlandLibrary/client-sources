  ...
  public void update(RenderGlobal renderGlobal)
  {
    ...
    if ((Math.abs(dx) > delta) || (Math.abs(dy) > delta) || (Math.abs(dz) > delta) || (this.lastLightLevel != lightLevel))
    {
      ...
      if (lightLevel > 0)
      {
        ...
        updateChunkLight(chunkView, this.setLitChunkPos, setNewPos1);
        updateChunkLight(chunkX, this.setLitChunkPos, setNewPos1);
        updateChunkLight(chunkZ, this.setLitChunkPos, setNewPos1);
        updateChunkLight(chunkXZ, this.setLitChunkPos, setNewPos1);
        updateChunkLight(chunkY, this.setLitChunkPos, setNewPos1);
        updateChunkLight(chunkYX, this.setLitChunkPos, setNewPos1);
        updateChunkLight(chunkYZ, this.setLitChunkPos, setNewPos1);
        updateChunkLight(chunkYXZ, this.setLitChunkPos, setNewPos1);
      }
