...
public class StrUtils
{
  ...
  static boolean equalsMask(String str, String mask, char wildChar, char wildCharSingle)
  {
  ...
  private static boolean equalsMask(String str, String mask, char wildChar)
  {
    if ((mask != null) && (str != null))
    {
      if (mask.indexOf(wildChar) < 0) {
  ...
  private static String fillLeft(String s, int len, char fillChar)
  {
    if (s == null) {
      s = "";
    }
