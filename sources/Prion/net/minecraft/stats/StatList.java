...
public class StatList
{
  ...
  public static final StatBase[] mineBlockStatArray = new StatBase['က'];
  

  public static final StatBase[] objectCraftStats = new StatBase['紀'];
  

  public static final StatBase[] objectUseStats = new StatBase['紀'];
  

  public static final StatBase[] objectBreakStats = new StatBase['紀'];
  private static final String __OBFID = "CL_00001480";
  
  public StatList() {}
  
  public static void func_151178_a() { func_151181_c();
    initStats();
    func_151179_e();
    initCraftableStats();
  ...
  {
    HashSet var0 = com.google.common.collect.Sets.newHashSet();
    ...
    while (var0.hasNext())
    {
      ...
      if (var1 != null)
      {
        ...
        if (var3 != null)
        {
          ...
          if (!(var1 instanceof net.minecraft.item.ItemBlock))
          {
  ...
  {
    String var1 = EntityList.getStringFromID(spawnedID);
