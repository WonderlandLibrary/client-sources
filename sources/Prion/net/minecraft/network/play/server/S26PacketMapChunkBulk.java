...
public class S26PacketMapChunkBulk implements net.minecraft.network.Packet
{
  ...
  public S26PacketMapChunkBulk(List p_i45197_1_)
  {
    ...
    field_149267_h = (!get0getWorldprovider.getHasNoSky());
    
    for (int var3 = 0; var3 < var2; var3++)
    {
      Chunk var4 = (Chunk)p_i45197_1_.get(var3);
      S21PacketChunkData.Extracted var5 = S21PacketChunkData.func_179756_a(var4, true, field_149267_h, 65535);
      field_149266_a[var3] = xPosition;
      field_149264_b[var3] = zPosition;
    ...
    throws IOException
  {
    ...
    for (int var3 = 0; var3 < var2; var3++)
    {
      ...
      field_179755_c[var3].field_150280_b = (data.readShort() & 0xFFFF);
      field_179755_c[var3].field_150282_a = new byte[S21PacketChunkData.func_180737_a(Integer.bitCount(field_179755_c[var3].field_150280_b), field_149267_h, true)];
    }
    ...
    throws IOException
  {
    ...
    for (int var2 = 0; var2 < field_149266_a.length; var2++)
    {
      ...
      data.writeShort((short)(field_179755_c[var2].field_150280_b & 0xFFFF));
    }
