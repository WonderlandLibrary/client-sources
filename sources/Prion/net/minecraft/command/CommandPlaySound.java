...
public class CommandPlaySound extends CommandBase
{
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    ...
    if (var21 > var19)
    {
      ...
      double var23 = var7 - posX;
      double var25 = var9 - posY;
      double var27 = var11 - posZ;
      double var29 = Math.sqrt(var23 * var23 + var25 * var25 + var27 * var27);
      
      if (var29 > 0.0D)
      {
        var7 = posX + var23 / var29 * 2.0D;
        var9 = posY + var25 / var29 * 2.0D;
        var11 = posZ + var27 / var29 * 2.0D;
      }
      
      var13 = var17;
    }
    
    playerNetServerHandler.sendPacket(new net.minecraft.network.play.server.S29PacketSoundEffect(var4, var7, var9, var11, (float)var13, (float)var15));
  ...
  {
    return (args.length > 2) && (args.length <= 5) ? func_175771_a(args, 2, pos) : args.length == 2 ? getListOfStringsMatchingLastWord(args, MinecraftServer.getServer().getAllUsernames()) : null;
  }
