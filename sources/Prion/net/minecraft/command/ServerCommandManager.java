...
public class ServerCommandManager extends CommandHandler implements IAdminCommand
{
  ...
  public ServerCommandManager()
  {
    ...
    registerCommand(new net.minecraft.command.common.CommandReplaceItem());
    ...
    registerCommand(new net.minecraft.command.server.CommandEmote());
    ...
    registerCommand(new net.minecraft.command.server.CommandSetDefaultSpawnpoint());
    ...
    registerCommand(new net.minecraft.command.server.CommandMessageRaw());
    ...
    if (MinecraftServer.getServer().isDedicatedServer())
    {
      ...
      registerCommand(new net.minecraft.command.server.CommandWhitelist());
  ...
  public void notifyOperators(ICommandSender sender, ICommand command, int p_152372_3_, String msgFormat, Object... msgParams)
  {
    ...
    if (var6)
    {
      Iterator var9 = getConfigurationManagerplayerEntityList.iterator();
    ...
    if ((sender != var7) && (worldServers[0].getGameRules().getGameRuleBooleanValue("logAdminCommands")))
    {
      var7.addChatMessage(var8);
    }
    
    boolean var11 = worldServers[0].getGameRules().getGameRuleBooleanValue("sendCommandFeedback");
