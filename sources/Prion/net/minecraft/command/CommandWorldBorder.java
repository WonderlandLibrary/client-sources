...
public class CommandWorldBorder extends CommandBase
{
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    ...
    else if (args[0].equals("get"))
    {
      ...
      sender.addChatMessage(new net.minecraft.util.ChatComponentTranslation("commands.worldborder.get.success", new Object[] { String.format("%.0f", new Object[] { Double.valueOf(var4) }) }));
    }
  }
  ...
  {
    return getServerworldServers[0].getWorldBorder();
  }
