...
import me.hexxed.mercury.gui.GuiIngameHook;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
  ...
  public static final boolean isRunningOnMac = net.minecraft.util.Util.getOSType() == Util.EnumOS.OSX;
    ...
    throws LWJGLException
  {
    ...
    Mercury.getInstance().initClient();
  ...
  {
    Util.EnumOS var1 = net.minecraft.util.Util.getOSType();
  ...
  private void updateDisplayMode() throws LWJGLException
  {
    ...
    if ((!var1.contains(var2)) && (net.minecraft.util.Util.getOSType() == Util.EnumOS.OSX))
    {
  ...
  private List<Packet> packetCache2 = new ArrayList();
  
  private TimeHelper display = new TimeHelper();
  
  private void runGameLoop() throws IOException
  {
    curtime = Long.valueOf(System.currentTimeMillis());
    if ((lasttime.longValue() == -1L) || (curtime.longValue() - lasttime.longValue() > 50L)) {
      lasttime = curtime;
    ...
    me.hexxed.mercury.util.Util.updatePacketQueue();
