...
public class TileEntityEndPortalRenderer extends TileEntitySpecialRenderer
{
  ...
  FloatBuffer field_147528_b = net.minecraft.client.renderer.GLAllocation.createDirectFloatBuffer(16);
  private static final String __OBFID = "CL_00002467";
  
  public TileEntityEndPortalRenderer() {}
  
  public void func_180544_a(TileEntityEndPortal p_180544_1_, double p_180544_2_, double p_180544_4_, double p_180544_6_, float p_180544_8_, int p_180544_9_) { float var10 = (float)rendererDispatcher.field_147560_j;
    float var11 = (float)rendererDispatcher.field_147561_k;
    float var12 = (float)rendererDispatcher.field_147558_l;
    ...
    for (int var14 = 0; var14 < 16; var14++)
    {
      ...
      float var19 = var18 + (float)func_178804_ayCoord;
      float var20 = var18 + var15 + (float)func_178804_ayCoord;
      ...
      GlStateManager.translate(0.0F, (float)(net.minecraft.client.Minecraft.getSystemTime() % 700000L) / 700000.0F, 0.0F);
      ...
      var19 = var18 + (float)func_178804_ayCoord;
      GlStateManager.translate((float)func_178804_axCoord * var15 / var19, (float)func_178804_azCoord * var15 / var19, -var11);
  ...
  {
    func_180544_a((TileEntityEndPortal)p_180535_1_, p_180535_2_, p_180535_4_, p_180535_6_, p_180535_8_, p_180535_9_);
  }
}
