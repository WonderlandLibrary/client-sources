...
public class RenderPainting extends Render
{
  ...
  public void doRender(EntityPainting p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
  {
    ...
    EntityPainting.EnumArt var10 = art;
    float var11 = 0.0625F;
    GlStateManager.scale(var11, var11, var11);
    func_77010_a(p_76986_1_, sizeX, sizeY, offsetX, offsetY);
  ...
  private void func_77008_a(EntityPainting p_77008_1_, float p_77008_2_, float p_77008_3_)
  {
    ...
    int var5 = MathHelper.floor_double(posY + p_77008_3_ / 16.0F);
    int var6 = MathHelper.floor_double(posZ);
    EnumFacing var7 = field_174860_b;
    
    if (var7 == EnumFacing.NORTH)
    {
      var4 = MathHelper.floor_double(posX + p_77008_2_ / 16.0F);
    }
    
    if (var7 == EnumFacing.WEST)
    {
      var6 = MathHelper.floor_double(posZ - p_77008_2_ / 16.0F);
    }
    ...
    int var8 = renderManager.worldObj.getCombinedLight(new net.minecraft.util.BlockPos(var4, var5, var6), 0);
    int var9 = var8 % 65536;
  ...
  {
    doRender((EntityPainting)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
  }
}
