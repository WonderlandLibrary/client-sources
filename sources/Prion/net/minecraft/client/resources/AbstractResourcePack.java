...
public abstract class AbstractResourcePack implements IResourcePack
{
  ...
  {
    resourceLog.warn("ResourcePack: ignored non-lowercase namespace: %s in %s", new Object[] { p_110594_1_, resourcePackFile });
  }
  ...
  static IMetadataSection readMetadata(IMetadataSerializer p_110596_0_, InputStream p_110596_1_, String p_110596_2_)
  {
    ...
    try
    {
      var4 = new BufferedReader(new InputStreamReader(p_110596_1_, com.google.common.base.Charsets.UTF_8));
