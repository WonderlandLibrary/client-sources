...
public class GuiIngame extends Gui
{
  ...
  public void func_175180_a(float p_175180_1_)
  {
    ...
    {
      float var6 = mc.thePlayer.prevTimeInPortal + (mc.thePlayer.timeInPortal - mc.thePlayer.prevTimeInPortal) * p_175180_1_;
    ...
    Scoreboard var12 = mc.theWorld.getScoreboard();
    ScoreObjective var13 = null;
    ScorePlayerTeam var15 = var12.getPlayersTeam(mc.thePlayer.getName());
    ...
    if ((mc.gameSettings.keyBindPlayerList.getIsKeyPressed()) && ((!mc.isIntegratedServerRunning()) || (mc.thePlayer.sendQueue.func_175106_d().size() > 1) || (var16 != null)))
    {
  ...
  public void func_175176_b(ScaledResolution p_175176_1_, int p_175176_2_)
  {
    ...
    {
      short var4 = 182;
      int var5 = (int)(mc.thePlayer.experience * (var4 + 1));
    ...
    if (mc.thePlayer.experienceLevel > 0)
    {
      ...
      int var9 = 8453920;
      String var10 = mc.thePlayer.experienceLevel;
