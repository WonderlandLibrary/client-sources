...
public class GuiGameOver extends GuiScreen implements GuiYesNoCallback
{
  ...
  public void initGui()
  {
    ...
    else
    {
      ...
      buttonList.add(new GuiButton(2, width / 2 - 100, height / 4 + 96, "Revive"));
      buttonList.add(new GuiButton(1, width / 2 - 100, height / 4 + 120, I18n.format("deathScreen.titleScreen", new Object[0])));
    ...
    throws java.io.IOException
  {
    ...
    case 1: 
      ...
      break;
    case 2: 
      me.hexxed.mercury.modulebase.ModuleManager.getModByName("Ghost").setState(true);
    }
