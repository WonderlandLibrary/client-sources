...
public class GuiSpectator extends Gui implements net.minecraft.client.gui.spectator.ISpectatorMenuReciepient
{
  ...
  {
    long var1 = field_175270_h - Minecraft.getSystemTime() + 5000L;
    return net.minecraft.util.MathHelper.clamp_float((float)var1 / 2000.0F, 0.0F, 1.0F);
  }
  ...
  public void func_175264_a(ScaledResolution p_175264_1_, float p_175264_2_)
  {
    if (field_175271_i != null)
    {
      ...
      else
      {
        ...
        float var5 = zLevel;
        zLevel = -90.0F;
        float var6 = p_175264_1_.getScaledHeight() - 22.0F * var3;
        SpectatorDetails var7 = field_175271_i.func_178646_f();
  ...
  protected void func_175258_a(ScaledResolution p_175258_1_, float p_175258_2_, int p_175258_3_, float p_175258_4_, SpectatorDetails p_175258_5_)
  {
    ...
    {
      func_175266_a(var6, p_175258_1_.getScaledWidth() / 2 - 90 + var6 * 20 + 2, p_175258_4_ + 3.0F, p_175258_2_, p_175258_5_.func_178680_a(var6));
    }
  ...
  private void func_175266_a(int p_175266_1_, int p_175266_2_, float p_175266_3_, float p_175266_4_, ISpectatorMenuObject p_175266_5_)
  {
    ...
    if (p_175266_5_ != SpectatorMenu.field_178657_a)
    {
      ...
      String var8 = String.valueOf(GameSettings.getKeyDisplayString(field_175268_g.gameSettings.keyBindsHotbar[p_175266_1_].getKeyCode()));
      
      if ((var6 > 3) && (p_175266_5_.func_178662_A_()))
      {
        field_175268_g.fontRendererObj.func_175063_a(var8, p_175266_2_ + 19 - 2 - field_175268_g.fontRendererObj.getStringWidth(var8), p_175266_3_ + 6.0F + 3.0F, 16777215 + (var6 << 24));
      }
    }
  }
  ...
  {
    int var2 = (int)(func_175265_c() * 255.0F);
    
    if ((var2 > 3) && (field_175271_i != null))
    {
      ISpectatorMenuObject var3 = field_175271_i.func_178645_b();
      String var4 = var3 != SpectatorMenu.field_178657_a ? var3.func_178664_z_().getFormattedText() : field_175271_i.func_178650_c().func_178670_b().getFormattedText();
      
      if (var4 != null)
      {
        int var5 = (p_175263_1_.getScaledWidth() - field_175268_g.fontRendererObj.getStringWidth(var4)) / 2;
        int var6 = p_175263_1_.getScaledHeight() - 35;
        GlStateManager.pushMatrix();
        GlStateManager.enableBlend();
        GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
        field_175268_g.fontRendererObj.func_175063_a(var4, var5, var6, 16777215 + (var2 << 24));
        GlStateManager.disableBlend();
        GlStateManager.popMatrix();
      }
    }
  ...
  {
    for (int var2 = field_175271_i.func_178648_e() + p_175259_1_; (var2 >= 0) && (var2 <= 8) && ((field_175271_i.func_178643_a(var2) == SpectatorMenu.field_178657_a) || (!field_175271_i.func_178643_a(var2).func_178662_A_())); var2 += p_175259_1_) {}
  ...
  public void func_175261_b()
  {
    ...
    if (func_175262_a())
    {
      int var1 = field_175271_i.func_178648_e();
