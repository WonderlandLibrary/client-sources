...
public class GuiChat extends GuiScreen
{
  ...
  public void initGui()
  {
    ...
    inputField = new GuiTextField(0, mc.fontRendererObj, 4, height - 12, width - 4, 12);
  ...
  private void sendAutocompleteRequest(String p_146405_1_, String p_146405_2_)
  {
    if (p_146405_1_.length() >= 1)
    {
      ...
      mc.thePlayer.sendQueue.addToSendQueue(new C14PacketTabComplete(p_146405_1_, var3));
