...
public class WorldGenSwamp extends WorldGenAbstractTree
{
  ...
  {
    for (int var4 = p_180709_2_.nextInt(4) + 5; worldIn.getBlockState(p_180709_3_.offsetDown()).getBlock().getMaterial() == Material.water; p_180709_3_ = p_180709_3_.offsetDown()) {}
    ...
    if ((p_180709_3_.getY() >= 1) && (p_180709_3_.getY() + var4 + 1 <= 256))
    {
      ...
      if (((var17 == Blocks.grass) || (var17 == Blocks.dirt)) && (p_180709_3_.getY() < 256 - var4 - 1))
      {
        ...
        for (int var18 = p_180709_3_.getY() - 3 + var4; var18 <= p_180709_3_.getY() + var4; var18++)
        {
          int var8 = var18 - (p_180709_3_.getY() + var4);
          int var9 = 2 - var8 / 2;
          
          for (int var20 = p_180709_3_.getX() - var9; var20 <= p_180709_3_.getX() + var9; var20++)
          {
            int var11 = var20 - p_180709_3_.getX();
            ...
            for (int var12 = p_180709_3_.getZ() - var9; var12 <= p_180709_3_.getZ() + var9; var12++)
            {
              ...
              {
                BlockPos var14 = new BlockPos(var20, var18, var12);
                
                if (!worldIn.getBlockState(var14).getBlock().isFullBlock())
                {
                  func_175906_a(worldIn, var14, Blocks.leaves);
                }
              }
            }
          }
        ...
        for (var18 = 0; var18 < var4; var18++)
        {
          ...
          {
            func_175906_a(worldIn, p_180709_3_.offsetUp(var18), Blocks.log);
          }
        }
        ...
        for (var18 = p_180709_3_.getY() - 3 + var4; var18 <= p_180709_3_.getY() + var4; var18++)
        {
          ...
          for (int var20 = p_180709_3_.getX() - var9; var20 <= p_180709_3_.getX() + var9; var20++)
          {
            for (int var11 = p_180709_3_.getZ() - var9; var11 <= p_180709_3_.getZ() + var9; var11++)
            {
              ...
              if (worldIn.getBlockState(var21).getBlock().getMaterial() == Material.leaves)
              {
                ...
                BlockPos var14 = var21.offsetEast();
                ...
                {
                  func_175922_a(worldIn, var22, net.minecraft.block.BlockVine.field_176275_S);
                }
                
                if ((p_180709_2_.nextInt(4) == 0) && (worldIn.getBlockState(var14).getBlock().getMaterial() == Material.air))
                {
                  func_175922_a(worldIn, var14, net.minecraft.block.BlockVine.field_176271_T);
                }
                
                if ((p_180709_2_.nextInt(4) == 0) && (worldIn.getBlockState(var15).getBlock().getMaterial() == Material.air))
                {
                  func_175922_a(worldIn, var15, net.minecraft.block.BlockVine.field_176272_Q);
                }
                
                if ((p_180709_2_.nextInt(4) == 0) && (worldIn.getBlockState(var16).getBlock().getMaterial() == Material.air))
                {
                  func_175922_a(worldIn, var16, net.minecraft.block.BlockVine.field_176276_R);
                }
              }
            }
          }
  ...
  {
    func_175905_a(worldIn, p_175922_2_, Blocks.vine, p_175922_3_);
    int var4 = 4;
