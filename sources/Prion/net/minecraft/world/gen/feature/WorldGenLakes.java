  ...
  public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_)
  {
    ...
    for (var6 = 0; var6 < 16; var6++)
    {
      for (int var30 = 0; var30 < 16; var30++)
      {
        ...
        {
          boolean var32 = (var4[((var6 * 16 + var30) * 8 + var8)] == 0) && (((var6 < 15) && (var4[(((var6 + 1) * 16 + var30) * 8 + var8)] != 0)) || ((var6 > 0) && (var4[(((var6 - 1) * 16 + var30) * 8 + var8)] != 0)) || ((var30 < 15) && (var4[((var6 * 16 + var30 + 1) * 8 + var8)] != 0)) || ((var30 > 0) && (var4[((var6 * 16 + (var30 - 1)) * 8 + var8)] != 0)) || ((var8 < 7) && (var4[((var6 * 16 + var30) * 8 + var8 + 1)] != 0)) || ((var8 > 0) && (var4[((var6 * 16 + var30) * 8 + (var8 - 1))] != 0)));
          ...
          if (var32)
          {
            ...
            if ((var8 < 4) && (!var10.isSolid()) && (worldIn.getBlockState(p_180709_3_.add(var6, var8, var30)).getBlock() != field_150556_a))
            {
              return false;
            }
          }
    ...
    for (var6 = 0; var6 < 16; var6++)
    {
      for (int var30 = 0; var30 < 16; var30++)
      {
        for (int var8 = 0; var8 < 8; var8++)
        {
          if (var4[((var6 * 16 + var30) * 8 + var8)] != 0)
          {
            worldIn.setBlockState(p_180709_3_.add(var6, var8, var30), var8 >= 4 ? Blocks.air.getDefaultState() : field_150556_a.getDefaultState(), 2);
          }
        }
      }
    }
      ...
      for (int var30 = 0; var30 < 16; var30++)
      {
        for (int var8 = 4; var8 < 8; var8++)
        {
          if (var4[((var6 * 16 + var30) * 8 + var8)] != 0)
          {
            ...
            if ((worldIn.getBlockState(var33).getBlock() == Blocks.dirt) && (worldIn.getLightFor(net.minecraft.world.EnumSkyBlock.SKY, p_180709_3_.add(var6, var8, var30)) > 0))
            {
              BiomeGenBase var34 = worldIn.getBiomeGenForCoords(var33);
              
              if (topBlock.getBlock() == Blocks.mycelium)
              {
