...
public class WorldGenGlowStone1 extends WorldGenerator
{
  ...
  public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_)
  {
    ...
    for (int var4 = 0; var4 < 1500; var4++)
    {
      ...
      if (worldIn.getBlockState(var5).getBlock().getMaterial() == net.minecraft.block.material.Material.air)
      {
        int var6 = 0;
        net.minecraft.util.EnumFacing[] var7 = net.minecraft.util.EnumFacing.values();
        int var8 = var7.length;
        
        for (int var9 = 0; var9 < var8; var9++)
        {
          net.minecraft.util.EnumFacing var10 = var7[var9];
