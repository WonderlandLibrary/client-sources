  ...
  public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_)
  {
    ...
    if ((p_180709_3_.getY() >= 1) && (p_180709_3_.getY() + var4 + 1 <= 256))
    {
      ...
      if (((var18 == Blocks.grass) || (var18 == Blocks.dirt)) && (p_180709_3_.getY() < 256 - var4 - 1))
      {
        ...
        net.minecraft.util.EnumFacing var19 = net.minecraft.util.EnumFacing.Plane.HORIZONTAL.random(p_180709_2_);
        int var8 = var4 - p_180709_2_.nextInt(4);
        ...
        for (int var13 = 0; var13 < var4; var13++)
        {
          ...
          {
            func_175905_a(worldIn, var15, Blocks.log2, BlockPlanks.EnumType.DARK_OAK.func_176839_a() - 4);
            func_175905_a(worldIn, var15.offsetEast(), Blocks.log2, BlockPlanks.EnumType.DARK_OAK.func_176839_a() - 4);
            func_175905_a(worldIn, var15.offsetSouth(), Blocks.log2, BlockPlanks.EnumType.DARK_OAK.func_176839_a() - 4);
            func_175905_a(worldIn, var15.offsetEast().offsetSouth(), Blocks.log2, BlockPlanks.EnumType.DARK_OAK.func_176839_a() - 4);
            var12 = var14;
          }
        }
        ...
        for (var13 = -1; var13 <= 2; var13++)
        {
          for (int var14 = -1; var14 <= 2; var14++)
          {
            if (((var13 < 0) || (var13 > 1) || (var14 < 0) || (var14 > 1)) && (p_180709_2_.nextInt(3) <= 0))
            {
              ...
              {
                func_175905_a(worldIn, new BlockPos(p_180709_3_.getX() + var13, var12 - var23 - 1, p_180709_3_.getZ() + var14), Blocks.log2, BlockPlanks.EnumType.DARK_OAK.func_176839_a() - 4);
              }
              ...
              for (var23 = -2; var23 <= 2; var23++)
              {
                for (int var17 = -2; var17 <= 2; var17++)
                {
                  ...
                  {
                    func_150526_a(worldIn, var10 + var13 + var23, var12 - 1, var11 + var14 + var17);
                  }
                }
              }
            }
