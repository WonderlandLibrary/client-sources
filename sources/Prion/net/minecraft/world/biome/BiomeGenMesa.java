...
public class BiomeGenMesa extends BiomeGenBase
{
  ...
  public void genTerrainBlocks(World worldIn, Random p_180622_2_, ChunkPrimer p_180622_3_, int p_180622_4_, int p_180622_5_, double p_180622_6_)
  {
    ...
    {
      Random var8 = new Random(field_150622_aD);
    ...
    if (field_150626_aH)
    {
      int var10 = (p_180622_4_ & 0xFFFFFFF0) + (p_180622_5_ & 0xF);
      int var11 = (p_180622_5_ & 0xFFFFFFF0) + (p_180622_4_ & 0xF);
      double var12 = Math.min(Math.abs(p_180622_6_), field_150623_aE.func_151601_a(var10 * 0.25D, var11 * 0.25D));
      
      if (var12 > 0.0D)
      {
        double var14 = 0.001953125D;
        double var16 = Math.abs(field_150624_aF.func_151601_a(var10 * var14, var11 * var14));
      ...
      else
      {
        ...
        else if (var20.getBlock() == Blocks.stone)
        {
          ...
          if (var17 == -1)
          {
            ...
            if (var19 >= 62)
            {
              if ((field_150620_aI) && (var19 > 86 + var15 * 2))
              {
                if (var25)
                {
                  p_180622_3_.setBlockState(var11, var19, var10, Blocks.dirt.getDefaultState().withProperty(net.minecraft.block.BlockDirt.VARIANT, net.minecraft.block.BlockDirt.DirtType.COARSE_DIRT));
                }
                else
                {
              ...
              else if (var19 > 66 + var15) { IBlockState var21;
                IBlockState var21;
          ...
          else if (var17 > 0)
          {
            ...
            {
              IBlockState var21 = func_180629_a(p_180622_4_, var19, p_180622_5_);
              p_180622_3_.setBlockState(var11, var19, var10, var21);
            }
          }
        }
  ...
  private void func_150619_a(long p_150619_1_)
  {
    ...
    java.util.Arrays.fill(field_150621_aC, Blocks.hardened_clay.getDefaultState());
    ...
    for (int var4 = 0; var4 < 64; var4++)
    {
      ...
      if (var4 < 64)
      {
        field_150621_aC[var4] = Blocks.stained_hardened_clay.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.ORANGE);
      }
    }
    ...
    for (int var5 = 0; var5 < var4; var5++)
    {
      ...
      {
        field_150621_aC[(var7 + var8)] = Blocks.stained_hardened_clay.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.YELLOW);
      }
    }
    ...
    for (int var6 = 0; var6 < var5; var6++)
    {
      ...
      {
        field_150621_aC[(var8 + var9)] = Blocks.stained_hardened_clay.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.BROWN);
      }
    }
    ...
    for (int var7 = 0; var7 < var6; var7++)
    {
      ...
      {
        field_150621_aC[(var9 + var10)] = Blocks.stained_hardened_clay.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.RED);
      }
    }
    ...
    for (int var9 = 0; var9 < var7; var9++)
    {
      ...
      {
        field_150621_aC[(var8 + var11)] = Blocks.stained_hardened_clay.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.WHITE);
        
        if ((var8 + var11 > 1) && (var3.nextBoolean()))
        {
          field_150621_aC[(var8 + var11 - 1)] = Blocks.stained_hardened_clay.getDefaultState().withProperty(BlockColored.COLOR, EnumDyeColor.SILVER);
        }
  ...
  {
    int var4 = (int)Math.round(field_150625_aG.func_151601_a(p_180629_1_ * 1.0D / 512.0D, p_180629_1_ * 1.0D / 512.0D) * 2.0D);
    return field_150621_aC[((p_180629_2_ + var4 + 64) % 64)];
  }
  
  protected BiomeGenBase createMutatedBiome(int p_180277_1_)
  {
    boolean var2 = biomeID == mesabiomeID;
    BiomeGenMesa var3 = new BiomeGenMesa(p_180277_1_, var2, field_150620_aI);
