...
{
  private static final net.minecraft.dispenser.IBehaviorDispenseItem dispenserMinecartBehavior = new BehaviorDefaultDispenseItem()
  {
    ...
    public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
      ...
      {
        if ((var12.getBlock().getMaterial() != net.minecraft.block.material.Material.air) || (!BlockRailBase.func_176563_d(var4.getBlockState(var11.offsetDown()))))
        {
      ...
      EntityMinecart var18 = EntityMinecart.func_180458_a(var4, var5, var7 + var14, var9, getItemminecartType);
