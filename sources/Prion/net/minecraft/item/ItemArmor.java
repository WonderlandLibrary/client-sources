...
public class ItemArmor extends Item
{
  ...
  private static final IBehaviorDispenseItem dispenserBehavior = new BehaviorDefaultDispenseItem()
  {
    ...
    protected ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
      ...
      List var8 = source.getWorld().func_175647_a(EntityLivingBase.class, var7, Predicates.and(net.minecraft.command.IEntitySelector.field_180132_d, new IEntitySelector.ArmoredMob(stack)));
  ...
  {
    return !p_82816_1_.getTagCompound().hasKey("display", 10) ? false : !p_82816_1_.hasTagCompound() ? false : material != ArmorMaterial.LEATHER ? false : p_82816_1_.getTagCompound().getCompoundTag("display").hasKey("color", 3);
  }
