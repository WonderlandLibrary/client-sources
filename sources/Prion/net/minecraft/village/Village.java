...
public class Village
{
  ...
  public void tick(int p_75560_1_)
  {
    ...
    if ((numIronGolems < var2) && (villageDoorInfoList.size() > 20) && (worldObj.rand.nextInt(7000) == 0))
    {
      ...
      if (var3 != null)
      {
        ...
        var4.setPosition(xCoord, yCoord, zCoord);
  ...
  public void addOrRenewAgressor(EntityLivingBase p_75575_1_)
  {
    ...
    do
    {
      if (!var2.hasNext())
      {
        villageAgressors.add(new VillageAgressor(p_75575_1_, tickCounter));
        return;
      }
      
      var3 = (VillageAgressor)var2.next();
    }
    while (agressor != p_75575_1_);
    
    agressionTime = tickCounter;
  }
  ...
  public EntityLivingBase findNearestVillageAggressor(EntityLivingBase p_75571_1_)
  {
    ...
    for (int var5 = 0; var5 < villageAgressors.size(); var5++)
    {
      ...
      double var7 = agressor.getDistanceSqToEntity(p_75571_1_);
    ...
    return var4 != null ? agressor : null;
  }
  ...
  private void removeDeadAndOldAgressors()
  {
    ...
    while (var1.hasNext())
    {
      ...
      if ((!agressor.isEntityAlive()) || (Math.abs(tickCounter - agressionTime) > 300))
      {
        var1.remove();
      }
    }
