...
public class RandomMobs
{
  ...
  public static void entityLoaded(Entity entity) { if ((entity instanceof EntityLiving))
    {
  ...
  public static ResourceLocation getTextureLocation(ResourceLocation loc)
  {
    ...
    try
    {
      ...
      working = false; } ResourceLocation var6; working = false;
