...
public class BlockPortal extends BlockBreakable
{
  ...
  public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
  {
    ...
    if ((provider.isSurfaceWorld()) && (worldIn.getGameRules().getGameRuleBooleanValue("doMobSpawning")) && (rand.nextInt(2000) < worldIn.getDifficulty().getDifficultyId()))
    {
      int var5 = pos.getY();
      

      for (BlockPos var6 = pos; (!World.doesBlockHaveSolidTopSurface(worldIn, var6)) && (var6.getY() > 0); var6 = var6.offsetDown()) {}
      ...
      {
        Entity var7 = net.minecraft.item.ItemMonsterPlacer.spawnCreature(worldIn, 57, var6.getX() + 0.5D, var6.getY() + 1.1D, var6.getZ() + 0.5D);
  ...
  {
    return p_176549_0_ == EnumFacing.Axis.Z ? 2 : p_176549_0_ == EnumFacing.Axis.X ? 1 : 0;
  }
  ...
  public boolean func_176548_d(World worldIn, BlockPos p_176548_2_)
  {
    ...
    if ((var3.func_150860_b()) && (field_150864_e == 0))
    {
      var3.func_150859_c();
      return true;
    }
    ...
    if ((var4.func_150860_b()) && (field_150864_e == 0))
    {
      var4.func_150859_c();
      return true;
    }
  ...
  public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
  {
    ...
    {
      Size var6 = new Size(worldIn, pos, EnumFacing.Axis.X);
      
      if ((!var6.func_150860_b()) || (field_150864_e < field_150868_h * field_150862_g))
      {
    ...
    {
      Size var6 = new Size(worldIn, pos, EnumFacing.Axis.Z);
  ...
  public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side)
  {
    ...
    return (var10) && (side == EnumFacing.WEST);
  }
  ...
  {
    if ((ridingEntity == null) && (riddenByEntity == null))
    {
  ...
  {
    return getDefaultState().withProperty(field_176550_a, (meta & 0x3) == 2 ? EnumFacing.Axis.Z : EnumFacing.Axis.X);
  }
  ...
  {
    return new BlockState(this, new net.minecraft.block.properties.IProperty[] { field_176550_a });
  }
  ...
  public static class Size
  {
    ...
    {
      for (field_150862_g = 0; field_150862_g < 21; field_150862_g += 1)
      {
    ...
    {
      return (blockMaterial == Material.air) || (p_150857_1_ == Blocks.fire) || (p_150857_1_ == Blocks.portal);
    }
