...
public class BlockReed extends Block
{
  ...
  protected BlockReed()
  {
    ...
    setDefaultState(blockState.getBaseState().withProperty(field_176355_a, Integer.valueOf(0)));
    float var1 = 0.375F;
  ...
  {
    return new BlockState(this, new net.minecraft.block.properties.IProperty[] { field_176355_a });
  }
}
