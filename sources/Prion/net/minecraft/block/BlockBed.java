...
public class BlockBed extends BlockDirectional
{
  ...
  public BlockBed()
  {
    ...
    setDefaultState(blockState.getBaseState().withProperty(PART_PROP, EnumPartType.FOOT).withProperty(OCCUPIED_PROP, Boolean.valueOf(false)));
    setBedBounds();
  }
  ...
  public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
  {
    ...
    if ((provider.canRespawnHere()) && (worldIn.getBiomeGenForCoords(pos) != net.minecraft.world.biome.BiomeGenBase.hell))
    {
  ...
  private EntityPlayer func_176470_e(World worldIn, BlockPos p_176470_2_)
  {
    ...
    while ((!var4.isPlayerSleeping()) || (!playerLocation.equals(p_176470_2_)));
  ...
  {
    if ((capabilities.isCreativeMode) && (state.getValue(PART_PROP) == EnumPartType.HEAD))
    {
  ...
  public IBlockState getStateFromMeta(int meta)
  {
    ...
    return (meta & 0x8) > 0 ? getDefaultState().withProperty(PART_PROP, EnumPartType.HEAD).withProperty(AGE, var2).withProperty(OCCUPIED_PROP, Boolean.valueOf((meta & 0x4) > 0)) : getDefaultState().withProperty(PART_PROP, EnumPartType.FOOT).withProperty(AGE, var2);
  }
  ...
  {
    return new BlockState(this, new net.minecraft.block.properties.IProperty[] { AGE, PART_PROP, OCCUPIED_PROP });
  }
