...
public class BlockChest extends BlockContainer
{
  ...
  {
    EnumFacing var6 = EnumFacing.getHorizontal(MathHelper.floor_double(rotationYaw * 4.0F / 360.0F + 0.5D) & 0x3).getOpposite();
  ...
  public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
  {
    ...
    {
      net.minecraft.inventory.InventoryHelper.dropInventoryItems(worldIn, pos, (IInventory)var4);
