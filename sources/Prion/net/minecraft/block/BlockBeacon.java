...
public class BlockBeacon extends BlockContainer
{
  ...
  public static void func_176450_d(World worldIn, final BlockPos p_176450_1_)
  {
    HttpUtil.field_180193_a.submit(new Runnable()
    {
      ...
      public void run() {
        Chunk var1 = getChunkFromBlockCoords(p_176450_1_);
        ...
        for (int var2 = p_176450_1_.getY() - 1; var2 >= 0; var2--)
        {
          ...
          IBlockState var4 = getBlockState(var3);
          
          if (var4.getBlock() == Blocks.beacon)
          {
            ((WorldServer)BlockBeacon.this).addScheduledTask(new Runnable()
            {
              private static final String __OBFID = "CL_00002135";
              
              public void run() {
                TileEntity var1 = val$worldIn.getTileEntity(var3);
                
                if ((var1 instanceof TileEntityBeacon))
                {
                  ((TileEntityBeacon)var1).func_174908_m();
                  val$worldIn.addBlockEvent(var3, Blocks.beacon, 1, 0);
                }
              }
            });
          }
