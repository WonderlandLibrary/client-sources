...
{
  public static final PropertyDirection FACING_PROP = PropertyDirection.create("facing", net.minecraft.util.EnumFacing.Plane.HORIZONTAL);
  ...
  public static class BlockBannerStanding extends BlockBanner
  {
    ...
    {
      setDefaultState(blockState.getBaseState().withProperty(ROTATION_PROP, Integer.valueOf(0)));
    }
