...
public class BlockFire extends Block
{
  ...
  public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
  {
    ...
    {
      boolean var7 = (var4 + var5 + var6 & 0x1) == 1;
      boolean var8 = (var4 / 2 + var5 / 2 + var6 / 2 & 0x1) == 1;
      int var9 = 0;
      ...
      return state.withProperty(field_176545_N, Boolean.valueOf(func_176535_e(worldIn, pos.offsetNorth()))).withProperty(field_176546_O, Boolean.valueOf(func_176535_e(worldIn, pos.offsetEast()))).withProperty(field_176541_P, Boolean.valueOf(func_176535_e(worldIn, pos.offsetSouth()))).withProperty(field_176539_Q, Boolean.valueOf(func_176535_e(worldIn, pos.offsetWest()))).withProperty(field_176542_R, Integer.valueOf(var9)).withProperty(field_176540_b, Boolean.valueOf(var8)).withProperty(field_176544_M, Boolean.valueOf(var7));
    }
  ...
  public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
  {
    if (worldIn.getGameRules().getGameRuleBooleanValue("doFireTick"))
    {
      ...
      if (((provider instanceof net.minecraft.world.WorldProviderEnd)) && (var5 == Blocks.bedrock))
      {
        var6 = true;
      }
  ...
  private void func_176536_a(World worldIn, BlockPos p_176536_2_, int p_176536_3_, Random p_176536_4_, int p_176536_5_)
  {
    ...
    if (p_176536_4_.nextInt(p_176536_3_) < var6)
    {
      ...
      if ((p_176536_4_.nextInt(p_176536_5_ + 10) < 5) && (!worldIn.func_175727_C(p_176536_2_)))
      {
        ...
        worldIn.setBlockState(p_176536_2_, getDefaultState().withProperty(field_176543_a, Integer.valueOf(var8)), 3);
      }
      else
      {
  ...
  {
    if ((provider.getDimensionId() > 0) || (!Blocks.portal.func_176548_d(worldIn, pos)))
    {
      if ((!World.doesBlockHaveSolidTopSurface(worldIn, pos.offsetDown())) && (!func_176533_e(worldIn, pos)))
      {
        worldIn.setBlockToAir(pos);
  ...
  public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
  {
    ...
    if ((!World.doesBlockHaveSolidTopSurface(worldIn, pos.offsetDown())) && (!Blocks.fire.func_176535_e(worldIn, pos.offsetDown())))
    {
      if (Blocks.fire.func_176535_e(worldIn, pos.offsetWest()))
      {
        ...
        {
          double var6 = pos.getX() + rand.nextDouble() * 0.10000000149011612D;
          double var8 = pos.getY() + rand.nextDouble();
          double var10 = pos.getZ() + rand.nextDouble();
      ...
      if (Blocks.fire.func_176535_e(worldIn, pos.offsetEast()))
      {
        for (int var5 = 0; var5 < 2; var5++)
        {
          double var6 = pos.getX() + 1 - rand.nextDouble() * 0.10000000149011612D;
          double var8 = pos.getY() + rand.nextDouble();
          double var10 = pos.getZ() + rand.nextDouble();
          worldIn.spawnParticle(EnumParticleTypes.SMOKE_LARGE, var6, var8, var10, 0.0D, 0.0D, 0.0D, new int[0]);
        }
      ...
      if (Blocks.fire.func_176535_e(worldIn, pos.offsetNorth()))
      {
        for (int var5 = 0; var5 < 2; var5++)
        {
          double var6 = pos.getX() + rand.nextDouble();
          double var8 = pos.getY() + rand.nextDouble();
          double var10 = pos.getZ() + rand.nextDouble() * 0.10000000149011612D;
          worldIn.spawnParticle(EnumParticleTypes.SMOKE_LARGE, var6, var8, var10, 0.0D, 0.0D, 0.0D, new int[0]);
        }
      }
      ...
      if (Blocks.fire.func_176535_e(worldIn, pos.offsetSouth()))
      {
        for (int var5 = 0; var5 < 2; var5++)
        {
          double var6 = pos.getX() + rand.nextDouble();
          double var8 = pos.getY() + rand.nextDouble();
          double var10 = pos.getZ() + 1 - rand.nextDouble() * 0.10000000149011612D;
          worldIn.spawnParticle(EnumParticleTypes.SMOKE_LARGE, var6, var8, var10, 0.0D, 0.0D, 0.0D, new int[0]);
        }
      }
      ...
      if (Blocks.fire.func_176535_e(worldIn, pos.offsetUp()))
      {
        ...
        {
          double var6 = pos.getX() + rand.nextDouble();
          double var8 = pos.getY() + 1 - rand.nextDouble() * 0.10000000149011612D;
          double var10 = pos.getZ() + rand.nextDouble();
          worldIn.spawnParticle(EnumParticleTypes.SMOKE_LARGE, var6, var8, var10, 0.0D, 0.0D, 0.0D, new int[0]);
        }
      }
    ...
    else
    {
      ...
      {
        double var6 = pos.getX() + rand.nextDouble();
        double var8 = pos.getY() + rand.nextDouble() * 0.5D + 0.5D;
        double var10 = pos.getZ() + rand.nextDouble();
        worldIn.spawnParticle(EnumParticleTypes.SMOKE_LARGE, var6, var8, var10, 0.0D, 0.0D, 0.0D, new int[0]);
      }
    }
  ...
  {
    return getDefaultState().withProperty(field_176543_a, Integer.valueOf(meta));
  }
