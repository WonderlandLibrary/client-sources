...
public class BlockSkull extends BlockContainer
{
  ...
  protected BlockSkull()
  {
    ...
    setDefaultState(blockState.getBaseState().withProperty(field_176418_a, EnumFacing.NORTH).withProperty(field_176417_b, Boolean.valueOf(false)));
  ...
  {
    switch (SwitchEnumFacing.field_177063_a[((EnumFacing)access.getBlockState(pos).getValue(field_176418_a)).ordinal()])
    {
    case 1: 
    default: 
      setBlockBounds(0.25F, 0.0F, 0.25F, 0.75F, 0.5F, 0.75F);
  ...
  {
    return getDefaultState().withProperty(field_176418_a, placer.func_174811_aO()).withProperty(field_176417_b, Boolean.valueOf(false));
  }
  ...
  {
    return func_176414_j().func_177681_a(worldIn, p_176415_2_) != null;
  }
  
  public void func_180679_a(World worldIn, BlockPos p_180679_2_, TileEntitySkull p_180679_3_)
  {
    if ((p_180679_3_.getSkullType() == 1) && (p_180679_2_.getY() >= 2) && (worldIn.getDifficulty() != net.minecraft.world.EnumDifficulty.PEACEFUL) && (!isRemote))
    {
      ...
      if (var5 != null)
      {
        ...
        renderYawOffset = (var5.func_177669_b().getAxis() == EnumFacing.Axis.X ? 0.0F : 90.0F);
        var14.func_82206_m();
        ...
        while (var9.hasNext())
        {
          ...
          var10.triggerAchievement(net.minecraft.stats.AchievementList.spawnWither);
        }
        
        worldIn.spawnEntityInWorld(var14);
        

        for (int var16 = 0; var16 < 120; var16++)
        {
          worldIn.spawnParticle(EnumParticleTypes.SNOWBALL, var12.getX() + rand.nextDouble(), var12.getY() - 2 + rand.nextDouble() * 3.9D, var12.getZ() + rand.nextDouble(), 0.0D, 0.0D, 0.0D, new int[0]);
        }
  ...
  {
    return getDefaultState().withProperty(field_176418_a, EnumFacing.getFront(meta & 0x7)).withProperty(field_176417_b, Boolean.valueOf((meta & 0x8) > 0));
  }
  ...
  protected BlockPattern func_176416_l()
  {
    ...
    {
      field_176421_O = FactoryBlockPattern.start().aisle(new String[] { "^^^", "###", "~#~" }).where('#', BlockWorldState.hasState(BlockStateHelper.forBlock(Blocks.soul_sand))).where('^', field_176419_M).where('~', BlockWorldState.hasState(BlockStateHelper.forBlock(Blocks.air))).build();
    }
