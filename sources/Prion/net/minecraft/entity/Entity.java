...
public abstract class Entity implements net.minecraft.command.ICommandSender
{
  ...
  {
    int var2 = seconds * 20;
    var2 = net.minecraft.enchantment.EnchantmentProtection.getFireTimeForEntity(this, var2);
  ...
  public void moveEntity(double x, double y, double z)
  {
    ...
    else
    {
      ...
      {
        if ((this instanceof EntityPlayerSP)) {
          if ((ModuleManager.getModByName("NoSlow").isEnabled()) && (getMinecraftthePlayer.motionY < -0.1D)) {
            isInWeb = false;
            x *= 0.8D;
            y *= 0.9D;
            z *= 0.8D;
      ...
      if ((var19) || ((getValuessafewalk) && (onGround)))
      {
      ...
      if ((stepHeight > 0.0F) && (var54) && ((var13 != x) || (var17 != z)))
      {
        ...
        if ((this instanceof EntityPlayerSP)) {
          func_174826_a(getEntityBoundingBox().offset(0.0D, ((!ModuleManager.getModByName("Ladders").isEnabled()) || (!getMinecraftthePlayer.isOnLadder())) && (ModuleManager.getModByName("Step").isEnabled()) && (ModuleManager.getModByName("NoCheat").isEnabled()) && ((!ModuleManager.getModByName("Fly").isEnabled()) || (getValuesflymode != Values.FlyMode.NCP)) ? y + 0.1D : y, 0.0D));
        } else {
          func_174826_a(getEntityBoundingBox().offset(0.0D, y, 0.0D));
        }
  ...
  {
    if ((ModuleManager.getModByName("Freecam").isEnabled()) || (ModuleManager.getModByClassName("Vclip").isEnabled()) || (ModuleManager.getModByName("Phase").isEnabled())) {
      return false;
    }
  ...
  public String getName()
  {
    ...
    return net.minecraft.util.StatCollector.translateToLocal("entity." + var1 + ".name");
  }
  ...
  protected HoverEvent func_174823_aP()
  {
    ...
    return new HoverEvent(net.minecraft.event.HoverEvent.Action.SHOW_ENTITY, new ChatComponentText(var1.toString()));
  }
