...
public abstract class EntityLivingBase extends Entity
{
  ...
  public void renderBrokenItemStack(ItemStack p_70669_1_)
  {
    ...
    for (int var2 = 0; var2 < 5; var2++)
    {
      ...
      worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, xCoord, yCoord, zCoord, xCoord, yCoord + 0.05D, zCoord, new int[] { Item.getIdFromItem(p_70669_1_.getItem()) });
    }
  }
  ...
  {
    if (ModuleManager.getModByName("Phase").isEnabled()) return false;
  ...
  {
    if ((ModuleManager.getModByName("HighJump").isEnabled()) && (!ModuleManager.isAntiCheatOn())) {
      return 0.42F * getValuesjumpheight;
    }
    return 0.42F;
  }
  ...
  protected void jump()
  {
    if (((ModuleManager.getModByName("HighJump").isEnabled()) && (ModuleManager.isAntiCheatOn())) || ((ModuleManager.getModByClassName("Cclimb").isEnabled()) && (me.hexxed.mercury.util.Util.isInsideBlock()) && (getValuesfastcclimb))) {
      return;
    }
