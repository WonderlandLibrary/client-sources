...
public class RandomPositionGenerator
{
  ...
  {
    staticVector = p_75464_3_.subtract(posX, posY, posZ);
  ...
  {
    staticVector = new Vec3(posX, posY, posZ).subtract(p_75461_3_);
  ...
  private static Vec3 findRandomTargetBlock(EntityCreature p_75462_0_, int p_75462_1_, int p_75462_2_, Vec3 p_75462_3_)
  {
    ...
    {
      double var11 = p_75462_0_.func_180486_cf().distanceSq(MathHelper.floor_double(posX), MathHelper.floor_double(posY), MathHelper.floor_double(posZ)) + 4.0D;
    ...
    for (int var17 = 0; var17 < 10; var17++)
    {
      ...
      if ((p_75462_3_ == null) || (var12 * xCoord + var14 * zCoord >= 0.0D))
      {
        ...
        var18 += MathHelper.floor_double(posY);
        var14 += MathHelper.floor_double(posZ);
