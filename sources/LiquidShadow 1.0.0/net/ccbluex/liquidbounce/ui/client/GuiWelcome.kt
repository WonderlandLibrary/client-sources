...
class GuiWelcome : GuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        font.drawCenteredString("Here is some information you might find useful if you are a Low IQ user.", width / 2F, height / 8F + 70 + font.fontHeight, 0xffffff, true)
        ...
        font.drawCenteredString("Right-click modules with a '+' or a '>' next to them to edit their settings.", width / 2F, height / 8F + 80 + font.fontHeight * 5, 0xffffff, true)
        ...
        font.drawCenteredString("BiliBili: https://space.bilibili.com/534709171", width / 2F, height / 8F + 80 + font.fontHeight * 13, 0xffffff, true)
