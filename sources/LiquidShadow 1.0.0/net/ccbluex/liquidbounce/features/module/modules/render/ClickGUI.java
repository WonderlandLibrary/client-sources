...
public class ClickGUI extends Module {
    ...
    public static final IntegerValue colorRedValue = new IntegerValue("R", 65, 0, 255);
    public static final IntegerValue colorGreenValue = new IntegerValue("G", 215, 0, 255);
