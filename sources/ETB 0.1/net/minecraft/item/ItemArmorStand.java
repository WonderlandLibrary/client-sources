...
public class ItemArmorStand extends Item
{
  ...
  public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
  {
    ...
    List var19 = worldIn.getEntitiesWithinAABBExcludingEntity(null, net.minecraft.util.AxisAlignedBB.fromBounds(var13, var15, var17, var13 + 1.0D, var15 + 2.0D, var17 + 1.0D));
    ...
    if (!isRemote)
    {
      ...
      float var21 = MathHelper.floor_float((MathHelper.wrapAngleTo180_float(rotationYaw - 180.0F) + 22.5F) / 45.0F) * 45.0F;
      var20.setLocationAndAngles(var13 + 0.5D, var15, var17 + 0.5D, var21, 0.0F);
      func_179221_a(var20, rand);
