...
public class ItemFireworkCharge extends Item
{
  ...
  public int getColorFromItemStack(ItemStack stack, int renderPass)
  {
    ...
    net.minecraft.nbt.NBTBase var3 = func_150903_a(stack, "Colors");
  ...
  public static net.minecraft.nbt.NBTBase func_150903_a(ItemStack p_150903_0_, String p_150903_1_)
  {
  ...
  public void addInformation(ItemStack stack, net.minecraft.entity.player.EntityPlayer playerIn, List tooltip, boolean advanced)
  {
    ...
    if (var3.length > 0)
    {
      ...
      for (int var8 = 0; var8 < var7; var8++)
      {
        ...
        for (int var11 = 0; var11 < ItemDye.dyeColors.length; var11++)
        {
          ...
          {
            var10 = true;
            var5 = var5 + StatCollector.translateToLocal(new StringBuilder("item.fireworksCharge.").append(EnumDyeColor.func_176766_a(var11).func_176762_d()).toString());
            break;
          }
        }
    ...
    if (var13.length > 0)
    {
      ...
      for (int var9 = 0; var9 < var8; var9++)
      {
        ...
        for (int var12 = 0; var12 < 16; var12++)
        {
          ...
          {
            var19 = true;
            var15 = var15 + StatCollector.translateToLocal(new StringBuilder("item.fireworksCharge.").append(EnumDyeColor.func_176766_a(var12).func_176762_d()).toString());
            break;
          }
        }
