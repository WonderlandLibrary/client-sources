...
public class RecipesBanners
{
  ...
  void func_179534_a(CraftingManager p_179534_1_)
  {
    ...
    for (int var4 = 0; var4 < var3; var4++)
    {
      ...
      p_179534_1_.addRecipe(new ItemStack(Items.banner, 1, var5.getDyeColorDamage()), new Object[] { "###", "###", " | ", Character.valueOf('#'), new ItemStack(net.minecraft.init.Blocks.wool, 1, var5.func_176765_a()), Character.valueOf('|'), Items.stick });
    }
  ...
  static class RecipeAddPattern implements IRecipe
  {
    ...
    public boolean matches(InventoryCrafting p_77569_1_, net.minecraft.world.World worldIn)
    {
      boolean var3 = false;
      ...
      return func_179533_c(p_77569_1_) != null;
    }
    ...
    public ItemStack getCraftingResult(InventoryCrafting p_77572_1_)
    {
      ...
      TileEntityBanner.EnumBannerPattern var8 = func_179533_c(p_77572_1_);
      ...
      if (var8 != null)
      {
        ...
        {
          ItemStack var6 = p_77572_1_.getStackInSlot(var5);
        ...
        ItemStack var6 = null;
        net.minecraft.nbt.NBTTagList var11;
        net.minecraft.nbt.NBTTagList var11;
        ...
        {
          var11 = new net.minecraft.nbt.NBTTagList();
        ...
        if (var5.func_177270_d())
        {
          ...
          else
          {
            ...
            for (int var8 = 0; (var8 < p_179533_1_.getSizeInventory()) && (var6); var8++)
            {
              ...
              else if (var5.func_177267_c()[var9].charAt(var10) != ' ')
              {
                var6 = false;
                break;
              }
