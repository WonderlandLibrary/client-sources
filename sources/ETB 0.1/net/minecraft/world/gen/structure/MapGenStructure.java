...
public abstract class MapGenStructure extends MapGenBase
{
  ...
  protected final void func_180701_a(World worldIn, final int p_180701_2_, final int p_180701_3_, int p_180701_4_, int p_180701_5_, ChunkPrimer p_180701_6_) {
    ...
    if (!structureLongMap.containsItem(ChunkCoordIntPair.chunkXZ2Int(p_180701_2_, p_180701_3_)))
    {
      ...
      catch (Throwable var101)
      {
        ...
        throw new net.minecraft.util.ReportedException(var8);
      }
    }
  }
  ...
  private void func_143027_a(World worldIn)
  {
    if (field_143029_e == null)
    {
      ...
      {
        MapStorage var2 = (MapStorage)Reflector.call(worldIn, Reflector.ForgeWorld_getPerWorldStorage, new Object[0]);
      ...
      {
        NBTTagCompound var21 = field_143029_e.func_143041_a();
