...
public class ChunkProviderDebug implements IChunkProvider
{
  ...
  public Chunk provideChunk(int p_73154_1_, int p_73154_2_)
  {
    ...
    for (int var4 = 0; var4 < 16; var4++)
    {
      for (int var5 = 0; var5 < 16; var5++)
      {
        ...
        int var7 = p_73154_2_ * 16 + var5;
        var3.setBlockState(var4, 60, var5, net.minecraft.init.Blocks.barrier.getDefaultState());
    ...
    Chunk var9 = new Chunk(field_177463_c, var3, p_73154_1_, p_73154_2_);
    var9.generateSkylightMap();
    BiomeGenBase[] var10 = field_177463_c.getWorldChunkManager().loadBlockGeneratorData(null, p_73154_1_ * 16, p_73154_2_ * 16, 16, 16);
    byte[] var11 = var9.getBiomeArray();
    
    for (int var7 = 0; var7 < var11.length; var7++)
    {
      var11[var7] = ((byte)biomeID);
    }
  ...
  {
    BiomeGenBase var3 = field_177463_c.getBiomeGenForCoords(p_177458_2_);
