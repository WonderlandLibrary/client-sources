...
public class WorldGenBigMushroom extends WorldGenerator
{
  ...
  public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_)
  {
    ...
    if ((p_180709_3_.getY() >= 1) && (p_180709_3_.getY() + var5 + 1 < 256))
    {
      ...
      for (int var9 = var16; var9 <= p_180709_3_.getY() + var5; var9++)
      {
        int var10 = 1;
        ...
        for (int var18 = p_180709_3_.getX() - var10; var18 <= p_180709_3_.getX() + var10; var18++)
        {
          for (int var12 = p_180709_3_.getZ() - var10; var12 <= p_180709_3_.getZ() + var10; var12++)
          {
            ...
            if ((var13 != 0) || (p_180709_3_.getY() >= p_180709_3_.getY() + var5 - 1))
            {
              ...
              {
                func_175905_a(worldIn, var14, Block.getBlockById(Block.getIdFromBlock(Blocks.brown_mushroom_block) + var4), var13);
              }
            }
          }
        }
      ...
      for (var9 = 0; var9 < var5; var9++)
      {
        ...
        {
          func_175905_a(worldIn, p_180709_3_.offsetUp(var9), Block.getBlockById(Block.getIdFromBlock(Blocks.brown_mushroom_block) + var4), 10);
        }
      }
