...
public class AnvilSaveConverter extends SaveFormatOld
{
  ...
  public List getSaveList() throws AnvilConverterException
  {
    if ((savesDirectory != null) && (savesDirectory.exists()) && (savesDirectory.isDirectory()))
    {
      ...
      File[] var2 = savesDirectory.listFiles();
      File[] var3 = var2;
      ...
      for (int var5 = 0; var5 < var4; var5++)
      {
        ...
        if (var6.isDirectory())
        {
          ...
          WorldInfo var8 = getWorldInfo(var7);
          
          if ((var8 != null) && ((var8.getSaveVersion() == 19132) || (var8.getSaveVersion() == 19133)))
          {
            boolean var9 = var8.getSaveVersion() != getSaveVersion();
  ...
  {
    WorldInfo var2 = getWorldInfo(p_154334_1_);
  ...
  public boolean convertMapFormat(String p_75805_1_, IProgressUpdate p_75805_2_)
  {
    ...
    convertFile(new File(var7, "region"), var4, new WorldChunkManagerHell(BiomeGenBase.hell, 0.0F), var3.size(), var9, p_75805_2_);
    convertFile(new File(var8, "region"), var5, new WorldChunkManagerHell(BiomeGenBase.sky, 0.0F), var3.size() + var4.size(), var9, p_75805_2_);
