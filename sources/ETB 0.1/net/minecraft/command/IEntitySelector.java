...
public final class IEntitySelector
{
  ...
  public static final Predicate field_152785_b = new Predicate()
  {
    ...
    public boolean func_180130_a(Entity p_180130_1_) {
      return (p_180130_1_.isEntityAlive()) && (riddenByEntity == null) && (ridingEntity == null);
    }
  ...
  public static class ArmoredMob implements Predicate {
    ...
    public boolean func_180100_a(Entity p_180100_1_)
    {
      ...
      return (var2 instanceof EntityArmorStand) ? true : (var2 instanceof EntityLiving) ? ((EntityLiving)var2).canPickUpLoot() : var2.getEquipmentInSlot(EntityLiving.getArmorPosition(field_96567_c)) != null ? false : var2 instanceof EntityPlayer;
    }
