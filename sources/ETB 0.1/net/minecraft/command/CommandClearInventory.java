...
public class CommandClearInventory extends CommandBase
{
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    ...
    net.minecraft.nbt.NBTTagCompound var7 = null;
    ...
    int var8 = inventory.func_174925_a(var4, var5, var6, var7);
    ...
    if (var6 == 0)
    {
      sender.addChatMessage(new net.minecraft.util.ChatComponentTranslation("commands.clear.testing", new Object[] { var3.getName(), Integer.valueOf(var8) }));
    }
    else
    {
