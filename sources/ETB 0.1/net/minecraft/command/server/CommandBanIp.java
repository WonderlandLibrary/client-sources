...
public class CommandBanIp extends CommandBase
{
  ...
  public String getCommandName() { return "ban-ip"; }
  ...
  public void processCommand(ICommandSender sender, String[] args) throws CommandException
  {
    ...
    {
      throw new net.minecraft.command.WrongUsageException("commands.banip.usage", new Object[0]);
    }
  }
  ...
  protected void func_147210_a(ICommandSender p_147210_1_, String p_147210_2_, String p_147210_3_)
  {
    ...
    for (Iterator var8 = var5.iterator(); var8.hasNext(); var6[(var7++)] = var9.getName())
    {
      ...
      playerNetServerHandler.kickPlayerFromServer("You have been IP banned.");
    }
