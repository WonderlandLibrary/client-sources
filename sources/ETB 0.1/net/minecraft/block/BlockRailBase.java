...
public abstract class BlockRailBase extends Block
{
  ...
  public void setBlockBoundsBasedOnState(IBlockAccess access, BlockPos pos)
  {
    ...
    EnumRailDirection var4 = var3.getBlock() == this ? (EnumRailDirection)var3.getValue(func_176560_l()) : null;
  ...
  public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
  {
    if (!isRemote)
    {
      EnumRailDirection var5 = (EnumRailDirection)state.getValue(func_176560_l());
      boolean var6 = false;
  ...
  {
    return isRemote ? p_176564_3_ : new Rail(worldIn, p_176564_2_, p_176564_3_).func_180364_a(worldIn.isBlockPowered(p_176564_2_), p_176564_4_).func_180362_b();
  }
  ...
  public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
  {
    ...
    if (((EnumRailDirection)state.getValue(func_176560_l())).func_177018_c())
    {
  ...
  public static enum EnumRailDirection implements IStringSerializable
  {
    ...
    static
    {
      ...
      EnumRailDirection[] var0 = values();
      int var1 = var0.length;
      
      for (int var2 = 0; var2 < var1; var2++)
      {
        EnumRailDirection var3 = var0[var2];
  ...
  public class Rail
  {
    ...
    private void func_150651_b()
    {
      ...
      {
        Rail var2 = func_180697_b((BlockPos)field_150657_g.get(var1));
        
        if ((var2 != null) && (var2.func_150653_a(this)))
        {
          field_150657_g.set(var1, field_180367_c);
        }
        else
        {
    ...
    private Rail func_180697_b(BlockPos p_180697_1_)
    {
      ...
      {
        BlockRailBase tmp24_21 = BlockRailBase.this;tmp24_21.getClass();return new Rail(tmp24_21, field_150660_b, p_180697_1_, var3);
      }
      ...
      if (BlockRailBase.func_176563_d(var3))
      {
        BlockRailBase tmp68_65 = BlockRailBase.this;tmp68_65.getClass();return new Rail(tmp68_65, field_150660_b, var2, var3);
      }
      

      var2 = p_180697_1_.offsetDown();
      var3 = field_150660_b.getBlockState(var2); BlockRailBase 
        tmp112_109 = BlockRailBase.this;tmp112_109.getClass();return BlockRailBase.func_176563_d(var3) ? new Rail(tmp112_109, field_150660_b, var2, var3) : null;
    }
    ...
    {
      return func_180363_c(field_180367_c);
    }
    ...
    {
      field_150657_g.add(field_180367_c);
    ...
    {
      Rail var2 = func_180697_b(p_180361_1_);
    ...
    public Rail func_180364_a(boolean p_180364_1_, boolean p_180364_2_)
    {
      ...
      if ((p_180364_2_) || (field_150660_b.getBlockState(field_180367_c) != field_180366_e))
      {
        ...
        {
          Rail var13 = func_180697_b((BlockPos)field_150657_g.get(var12));
