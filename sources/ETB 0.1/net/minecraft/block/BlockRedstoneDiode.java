...
public abstract class BlockRedstoneDiode extends BlockDirectional
{
  ...
  {
    return state.getValue(AGE) == side ? func_176408_a(worldIn, pos, state) : !func_176406_l(state) ? 0 : 0;
  }
  ...
  protected int func_176401_c(IBlockAccess p_176401_1_, BlockPos p_176401_2_, EnumFacing p_176401_3_)
  {
    ...
    return func_149908_a(var5) ? p_176401_1_.getStrongPower(p_176401_2_, p_176401_3_) : var5 == Blocks.redstone_wire ? ((Integer)var4.getValue(BlockRedstoneWire.POWER)).intValue() : 0;
  }
  ...
  public boolean func_176402_i(World worldIn, BlockPos p_176402_2_, IBlockState p_176402_3_)
  {
    ...
    return worldIn.getBlockState(var5).getValue(AGE) != var4;
  }
