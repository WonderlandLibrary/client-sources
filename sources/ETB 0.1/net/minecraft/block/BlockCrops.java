  ...
  extends BlockBush implements IGrowable
{
  ...
  {
    int var4 = ((Integer)p_176487_3_.getValue(AGE)).intValue() + MathHelper.getRandomIntegerInRange(rand, 2, 5);
  ...
  {
    return ((Integer)state.getValue(AGE)).intValue() == 7 ? getCrop() : getSeed();
  }
