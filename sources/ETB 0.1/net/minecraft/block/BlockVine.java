...
public class BlockVine extends Block
{
  ...
  {
    super(Material.vine);
    setDefaultState(blockState.getBaseState().withProperty(field_176277_a, Boolean.valueOf(false)).withProperty(field_176273_b, Boolean.valueOf(false)).withProperty(field_176278_M, Boolean.valueOf(false)).withProperty(field_176279_N, Boolean.valueOf(false)).withProperty(field_176280_O, Boolean.valueOf(false)));
  ...
  {
    return (p_150093_1_.isFullCube()) && (blockMaterial.blocksMovement());
  }
  ...
  {
    if ((!isRemote) && (!func_176269_e(worldIn, pos, state)))
    {
  ...
  public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
  {
    if (!isRemote)
    {
      if (rand.nextInt(4) == 0)
      {
        ...
        else if ((var17.getAxis().isHorizontal()) && (!((Boolean)state.getValue(func_176267_a(var17))).booleanValue()))
        {
          if (!var7)
          {
            ...
            if (blockMaterial == Material.air)
            {
              ...
              {
                worldIn.setBlockState(var18, getDefaultState().withProperty(func_176267_a(var23), Boolean.valueOf(true)), 2);
              }
              else if ((var26) && (func_150093_a(worldIn.getBlockState(var16).getBlock())))
              {
                worldIn.setBlockState(var18, getDefaultState().withProperty(func_176267_a(var24), Boolean.valueOf(true)), 2);
              }
              else if ((var25) && (worldIn.isAirBlock(var27)) && (func_150093_a(worldIn.getBlockState(pos.offset(var23)).getBlock())))
              {
                worldIn.setBlockState(var27, getDefaultState().withProperty(func_176267_a(var17.getOpposite()), Boolean.valueOf(true)), 2);
              }
              else if ((var26) && (worldIn.isAirBlock(var16)) && (func_150093_a(worldIn.getBlockState(pos.offset(var24)).getBlock())))
              {
                worldIn.setBlockState(var16, getDefaultState().withProperty(func_176267_a(var17.getOpposite()), Boolean.valueOf(true)), 2);
              }
            ...
            else if ((blockMaterial.isOpaque()) && (var21.isFullCube()))
            {
        ...
        else if (pos.getY() > 1)
        {
          ...
          if (blockMaterial == Material.air)
          {
            ...
            Iterator var13 = EnumFacing.Plane.HORIZONTAL.iterator();
            
            while (var13.hasNext())
            {
              EnumFacing var14 = (EnumFacing)var13.next();
  ...
  {
    IBlockState var9 = getDefaultState().withProperty(field_176277_a, Boolean.valueOf(false)).withProperty(field_176273_b, Boolean.valueOf(false)).withProperty(field_176278_M, Boolean.valueOf(false)).withProperty(field_176279_N, Boolean.valueOf(false)).withProperty(field_176280_O, Boolean.valueOf(false));
  ...
  {
    if ((!isRemote) && (playerIn.getCurrentEquippedItem() != null) && (playerIn.getCurrentEquippedItem().getItem() == Items.shears))
    {
      playerIn.triggerAchievement(net.minecraft.stats.StatList.mineBlockStatArray[Block.getIdFromBlock(this)]);
      spawnAsEntity(worldIn, pos, new ItemStack(net.minecraft.init.Blocks.vine, 1, 0));
    }
    else
    {
  ...
  {
    return getDefaultState().withProperty(field_176273_b, Boolean.valueOf((meta & field_176276_R) > 0)).withProperty(field_176278_M, Boolean.valueOf((meta & field_176275_S) > 0)).withProperty(field_176279_N, Boolean.valueOf((meta & field_176272_Q) > 0)).withProperty(field_176280_O, Boolean.valueOf((meta & field_176271_T) > 0));
  }
