...
public class BlockPistonExtension extends Block
{
  ...
  {
    super(net.minecraft.block.material.Material.piston);
    setDefaultState(blockState.getBaseState().withProperty(field_176326_a, EnumFacing.NORTH).withProperty(field_176325_b, EnumPistonType.DEFAULT).withProperty(field_176327_M, Boolean.valueOf(false)));
