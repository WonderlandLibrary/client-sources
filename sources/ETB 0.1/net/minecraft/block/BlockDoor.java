...
public class BlockDoor extends Block
{
  ...
  {
    super(p_i45402_1_);
    setDefaultState(blockState.getBaseState().withProperty(FACING_PROP, EnumFacing.NORTH).withProperty(OPEN_PROP, Boolean.valueOf(false)).withProperty(HINGEPOSITION_PROP, EnumHingePosition.LEFT).withProperty(POWERED_PROP, Boolean.valueOf(false)).withProperty(HALF_PROP, EnumDoorHalf.LOWER));
  }
  ...
  {
    return state.getValue(HALF_PROP) == EnumDoorHalf.UPPER ? null : func_176509_j();
  }
  ...
  {
    return this == Blocks.dark_oak_door ? Items.dark_oak_door : this == Blocks.acacia_door ? Items.acacia_door : this == Blocks.jungle_door ? Items.jungle_door : this == Blocks.birch_door ? Items.birch_door : this == Blocks.spruce_door ? Items.spruce_door : this == Blocks.iron_door ? Items.iron_door : Items.oak_door;
  }
  ...
  public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn)
  {
    ...
    if ((capabilities.isCreativeMode) && (state.getValue(HALF_PROP) == EnumDoorHalf.UPPER) && (worldIn.getBlockState(var5).getBlock() == this))
    {
  ...
  {
    return (meta & 0x8) > 0 ? getDefaultState().withProperty(HALF_PROP, EnumDoorHalf.UPPER).withProperty(HINGEPOSITION_PROP, (meta & 0x1) > 0 ? EnumHingePosition.RIGHT : EnumHingePosition.LEFT).withProperty(POWERED_PROP, Boolean.valueOf((meta & 0x2) > 0)) : getDefaultState().withProperty(HALF_PROP, EnumDoorHalf.LOWER).withProperty(FACING_PROP, EnumFacing.getHorizontal(meta & 0x3).rotateYCCW()).withProperty(OPEN_PROP, Boolean.valueOf((meta & 0x4) > 0));
  }
  ...
  {
    return new BlockState(this, new net.minecraft.block.properties.IProperty[] { HALF_PROP, FACING_PROP, OPEN_PROP, HINGEPOSITION_PROP, POWERED_PROP });
  }
