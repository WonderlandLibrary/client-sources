...
public class BlockOldLeaf extends BlockLeaves
{
  ...
  public BlockOldLeaf()
  {
    setDefaultState(blockState.getBaseState().withProperty(VARIANT_PROP, BlockPlanks.EnumType.OAK).withProperty(field_176236_b, Boolean.valueOf(true)).withProperty(field_176237_a, Boolean.valueOf(true)));
  }
  ...
  public int getRenderColor(IBlockState state)
  {
    ...
    return var2 == BlockPlanks.EnumType.BIRCH ? ColorizerFoliage.getFoliageColorBirch() : var2 == BlockPlanks.EnumType.SPRUCE ? ColorizerFoliage.getFoliageColorPine() : super.getRenderColor(state);
  }
  ...
  {
    if ((p_176234_3_.getValue(VARIANT_PROP) == BlockPlanks.EnumType.OAK) && (rand.nextInt(p_176234_4_) == 0))
    {
  ...
  {
    return getDefaultState().withProperty(VARIANT_PROP, func_176233_b(meta)).withProperty(field_176237_a, Boolean.valueOf((meta & 0x4) == 0)).withProperty(field_176236_b, Boolean.valueOf((meta & 0x8) > 0));
  }
