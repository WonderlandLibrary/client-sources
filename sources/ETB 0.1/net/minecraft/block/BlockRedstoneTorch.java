...
public class BlockRedstoneTorch extends BlockTorch
{
  ...
  private boolean func_176598_a(World worldIn, BlockPos p_176598_2_, boolean p_176598_3_)
  {
    ...
    for (int var6 = 0; var6 < var4.size(); var6++)
    {
      ...
      if (field_180111_a.equals(p_176598_2_))
      {
        var5++;
  ...
  public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
  {
    ...
    while ((var6 != null) && (!var6.isEmpty()) && (worldIn.getTotalWorldTime() - get0field_150844_d > 60L))
    {
      var6.remove(0);
    }
    ...
    if (field_150113_a)
    {
      if (var5)
      {
        ...
        {
          worldIn.playSoundEffect(pos.getX() + 0.5F, pos.getY() + 0.5F, pos.getZ() + 0.5F, "random.fizz", 0.5F, 2.6F + (rand.nextFloat() - rand.nextFloat()) * 0.8F);
