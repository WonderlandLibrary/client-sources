...
public class MerchantRecipeList extends ArrayList
{
  ...
  public MerchantRecipe canRecipeBeUsed(ItemStack p_77203_1_, ItemStack p_77203_2_, int p_77203_3_)
  {
    if ((p_77203_3_ > 0) && (p_77203_3_ < size()))
    {
      ...
      return (ItemStack.areItemsEqual(p_77203_1_, var6.getItemToBuy())) && (((p_77203_2_ == null) && (!var6.hasSecondItemToBuy())) || ((var6.hasSecondItemToBuy()) && (ItemStack.areItemsEqual(p_77203_2_, var6.getSecondItemToBuy())) && (stackSize >= getItemToBuystackSize) && ((!var6.hasSecondItemToBuy()) || (stackSize >= getSecondItemToBuystackSize)))) ? var6 : null;
    }
    ...
    for (int var4 = 0; var4 < size(); var4++)
    {
      ...
      if ((ItemStack.areItemsEqual(p_77203_1_, var5.getItemToBuy())) && (stackSize >= getItemToBuystackSize) && (((!var5.hasSecondItemToBuy()) && (p_77203_2_ == null)) || ((var5.hasSecondItemToBuy()) && (ItemStack.areItemsEqual(p_77203_2_, var5.getSecondItemToBuy())) && (stackSize >= getSecondItemToBuystackSize))))
      {
        return var5;
      }
    }
  ...
  {
    p_151391_1_.writeByte((byte)(size() & 0xFF));
  ...
  public static MerchantRecipeList func_151390_b(PacketBuffer p_151390_0_) throws IOException
  {
    ...
    int var2 = p_151390_0_.readByte() & 0xFF;
