...
public class ServerStatusResponse
{
  ...
  public static class MinecraftProtocolVersionIdentifier
  {
    ...
    public static class Serializer implements com.google.gson.JsonDeserializer, JsonSerializer {
      ...
      {
        return serialize((ServerStatusResponse.MinecraftProtocolVersionIdentifier)p_serialize_1_, p_serialize_2_, p_serialize_3_);
      }
  ...
  public static class PlayerCountData
  {
    ...
    public static class Serializer implements com.google.gson.JsonDeserializer, JsonSerializer {
        ...
        if (JsonUtils.jsonObjectFieldTypeIsArray(var4, "sample"))
        {
          ...
          if (var6.size() > 0)
          {
            ...
            for (int var8 = 0; var8 < var7.length; var8++)
            {
              ...
              var7[var8] = new GameProfile(java.util.UUID.fromString(var10), JsonUtils.getJsonObjectStringFieldValue(var9, "name"));
            }
      ...
      public JsonElement serialize(ServerStatusResponse.PlayerCountData p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_)
      {
        ...
        if ((p_serialize_1_.getPlayers() != null) && (p_serialize_1_.getPlayers().length > 0))
        {
          ...
          for (int var6 = 0; var6 < p_serialize_1_.getPlayers().length; var6++)
          {
            ...
            java.util.UUID var8 = p_serialize_1_.getPlayers()[var6].getId();
      ...
      public JsonElement serialize(Object p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_)
      {
        return serialize((ServerStatusResponse.PlayerCountData)p_serialize_1_, p_serialize_2_, p_serialize_3_);
      }
  ...
  public static class Serializer implements com.google.gson.JsonDeserializer, JsonSerializer {
    ...
    public JsonElement serialize(Object p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_)
    {
      return serialize((ServerStatusResponse)p_serialize_1_, p_serialize_2_, p_serialize_3_);
    }
