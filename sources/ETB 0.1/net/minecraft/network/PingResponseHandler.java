...
public class PingResponseHandler extends ChannelInboundHandlerAdapter
{
  ...
  public void channelRead(ChannelHandlerContext p_channelRead_1_, Object p_channelRead_2_)
  {
    ...
    try
    {
      ...
      case 0: 
        ...
        String var8 = String.format("%s§%d§%d", new Object[] { var6.getMOTD(), Integer.valueOf(var6.getCurrentPlayerCount()), Integer.valueOf(var6.getMaxPlayers()) });
      ...
      case 1: 
        ...
        String var8 = String.format("§1\000%d\000%s\000%s\000%d\000%d", new Object[] { Integer.valueOf(127), var6.getMinecraftVersion(), var6.getMOTD(), Integer.valueOf(var6.getCurrentPlayerCount()), Integer.valueOf(var6.getMaxPlayers()) });
        writeAndFlush(p_channelRead_1_, getStringBuffer(var8));
        break;
      ...
      default: 
        ...
        var23 &= "MC|PingHost".equals(new String(var3.readBytes(var3.readShort() * 2).array(), com.google.common.base.Charsets.UTF_16BE));
        ...
        String var10 = String.format("§1\000%d\000%s\000%s\000%d\000%d", new Object[] { Integer.valueOf(127), var6.getMinecraftVersion(), var6.getMOTD(), Integer.valueOf(var6.getCurrentPlayerCount()), Integer.valueOf(var6.getMaxPlayers()) });
  ...
  {
    ByteBuf var2 = io.netty.buffer.Unpooled.buffer();
    var2.writeByte(255);
