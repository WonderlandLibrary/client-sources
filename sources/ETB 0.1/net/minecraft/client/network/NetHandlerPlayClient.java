...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
  ...
  public void handleJoinGame(S01PacketJoinGame packetIn)
  {
    ...
    netManager.sendPacket(new net.minecraft.network.play.client.C17PacketCustomPayload("MC|Brand", new PacketBuffer(Unpooled.buffer()).writeString(ClientBrandRetriever.getClientModName())));
  }
  ...
  {
    EventPacket event = (EventPacket)EventBus.getDefault().call(new EventPacket(p_147297_1_, (byte)0));
    
    if (event.isCancelled()) {
      return;
    }
    
    netManager.sendPacket(event.getPacket());
    
    EventBus.getDefault().call(new EventPacket(event.getPacket(), (byte)1));
  }
  ...
  public void handleSpawnMob(S0FPacketSpawnMob packetIn)
  {
    ...
    EntityLivingBase var10 = (EntityLivingBase)net.minecraft.entity.EntityList.createEntityByID(packetIn.func_149025_e(), gameController.theWorld);
