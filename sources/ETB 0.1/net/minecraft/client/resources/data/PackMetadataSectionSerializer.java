...
public class PackMetadataSectionSerializer extends BaseMetadataSectionSerializer implements com.google.gson.JsonSerializer
{
  ...
  public PackMetadataSection deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_)
  {
    ...
    int var6 = net.minecraft.util.JsonUtils.getJsonObjectIntegerFieldValue(var4, "pack_format");
  ...
  {
    return serialize((PackMetadataSection)p_serialize_1_, p_serialize_2_, p_serialize_3_);
  }
}
