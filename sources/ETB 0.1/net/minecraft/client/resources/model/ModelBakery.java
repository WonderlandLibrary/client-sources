...
public class ModelBakery
{
  ...
  private void func_177577_b()
  {
    ...
    variants.put(MODEL_MISSING, new ModelBlockDefinition.Variants(MODEL_MISSING.func_177518_c(), Lists.newArrayList(new ModelBlockDefinition.Variant[] { new ModelBlockDefinition.Variant(new ResourceLocation(MODEL_MISSING.getResourcePath()), ModelRotation.X0_Y0, false, 1) })));
    ResourceLocation var1 = new ResourceLocation("item_frame");
    ModelBlockDefinition var2 = getModelBlockDefinition(var1);
  ...
  private void loadVariants(Collection p_177591_1_)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ModelBlockDefinition var4 = getModelBlockDefinition(var3);
  ...
  {
    ResourceLocation var2 = getBlockStateLocation(p_177586_1_);
    ...
    if (var3 == null)
    {
      ...
      try
      {
        Iterator var5 = resourceManager.getAllResources(var2).iterator();
        ...
        while (var5.hasNext())
        {
          ...
          {
            org.apache.commons.io.IOUtils.closeQuietly(var7);
          }
        }
      }
  ...
  private void func_177595_c()
  {
        ...
        var3.hasNext())
    {
      ...
      var3 = ((ModelBlockDefinition.Variants)variants.get(var2)).getVariants().iterator();
      ...
      if (models.get(var5) == null)
      {
        try
        {
          ModelBlock var6 = loadModel(var5);
    ...
    throws IOException
  {
    ...
    if (var3.startsWith("builtin/"))
    {
      ...
      if (var5 == null)
      {
        throw new java.io.FileNotFoundException(p_177594_1_.toString());
      }
    ...
    {
      IResource var9 = resourceManager.getResource(getModelLocation(p_177594_1_));
    ...
    try
    {
      ...
      field_178317_b = p_177594_1_.toString();
      var11 = var10;
    }
    finally {
      ModelBlock var11;
  ...
  private void loadItemModels()
  {
        ...
        var4.hasNext())
    {
      ...
      List var3 = getVariantNames(var2);
      var4 = var3.iterator();
      
      continue;
      
      String var5 = (String)var4.next();
      ResourceLocation var6 = getItemLocation(var5);
      ...
      if (models.get(var6) == null)
      {
        try
        {
          ModelBlock var7 = loadModel(var6);
  ...
  {
    variantNames.put(Item.getItemFromBlock(Blocks.stone), Lists.newArrayList(new String[] { "stone", "granite", "granite_smooth", "diorite", "diorite_smooth", "andesite", "andesite_smooth" }));
    variantNames.put(Item.getItemFromBlock(Blocks.dirt), Lists.newArrayList(new String[] { "dirt", "coarse_dirt", "podzol" }));
    variantNames.put(Item.getItemFromBlock(Blocks.planks), Lists.newArrayList(new String[] { "oak_planks", "spruce_planks", "birch_planks", "jungle_planks", "acacia_planks", "dark_oak_planks" }));
    variantNames.put(Item.getItemFromBlock(Blocks.sapling), Lists.newArrayList(new String[] { "oak_sapling", "spruce_sapling", "birch_sapling", "jungle_sapling", "acacia_sapling", "dark_oak_sapling" }));
    variantNames.put(Item.getItemFromBlock(Blocks.sand), Lists.newArrayList(new String[] { "sand", "red_sand" }));
    variantNames.put(Item.getItemFromBlock(Blocks.log), Lists.newArrayList(new String[] { "oak_log", "spruce_log", "birch_log", "jungle_log" }));
    variantNames.put(Item.getItemFromBlock(Blocks.leaves), Lists.newArrayList(new String[] { "oak_leaves", "spruce_leaves", "birch_leaves", "jungle_leaves" }));
    variantNames.put(Item.getItemFromBlock(Blocks.sponge), Lists.newArrayList(new String[] { "sponge", "sponge_wet" }));
    variantNames.put(Item.getItemFromBlock(Blocks.sandstone), Lists.newArrayList(new String[] { "sandstone", "chiseled_sandstone", "smooth_sandstone" }));
    variantNames.put(Item.getItemFromBlock(Blocks.red_sandstone), Lists.newArrayList(new String[] { "red_sandstone", "chiseled_red_sandstone", "smooth_red_sandstone" }));
    variantNames.put(Item.getItemFromBlock(Blocks.tallgrass), Lists.newArrayList(new String[] { "dead_bush", "tall_grass", "fern" }));
    variantNames.put(Item.getItemFromBlock(Blocks.deadbush), Lists.newArrayList(new String[] { "dead_bush" }));
    variantNames.put(Item.getItemFromBlock(Blocks.wool), Lists.newArrayList(new String[] { "black_wool", "red_wool", "green_wool", "brown_wool", "blue_wool", "purple_wool", "cyan_wool", "silver_wool", "gray_wool", "pink_wool", "lime_wool", "yellow_wool", "light_blue_wool", "magenta_wool", "orange_wool", "white_wool" }));
    variantNames.put(Item.getItemFromBlock(Blocks.yellow_flower), Lists.newArrayList(new String[] { "dandelion" }));
    variantNames.put(Item.getItemFromBlock(Blocks.red_flower), Lists.newArrayList(new String[] { "poppy", "blue_orchid", "allium", "houstonia", "red_tulip", "orange_tulip", "white_tulip", "pink_tulip", "oxeye_daisy" }));
    variantNames.put(Item.getItemFromBlock(Blocks.stone_slab), Lists.newArrayList(new String[] { "stone_slab", "sandstone_slab", "cobblestone_slab", "brick_slab", "stone_brick_slab", "nether_brick_slab", "quartz_slab" }));
    variantNames.put(Item.getItemFromBlock(Blocks.stone_slab2), Lists.newArrayList(new String[] { "red_sandstone_slab" }));
    ...
    variantNames.put(Item.getItemFromBlock(Blocks.monster_egg), Lists.newArrayList(new String[] { "stone_monster_egg", "cobblestone_monster_egg", "stone_brick_monster_egg", "mossy_brick_monster_egg", "cracked_brick_monster_egg", "chiseled_brick_monster_egg" }));
    variantNames.put(Item.getItemFromBlock(Blocks.stonebrick), Lists.newArrayList(new String[] { "stonebrick", "mossy_stonebrick", "cracked_stonebrick", "chiseled_stonebrick" }));
    variantNames.put(Item.getItemFromBlock(Blocks.wooden_slab), Lists.newArrayList(new String[] { "oak_slab", "spruce_slab", "birch_slab", "jungle_slab", "acacia_slab", "dark_oak_slab" }));
    variantNames.put(Item.getItemFromBlock(Blocks.cobblestone_wall), Lists.newArrayList(new String[] { "cobblestone_wall", "mossy_cobblestone_wall" }));
    variantNames.put(Item.getItemFromBlock(Blocks.anvil), Lists.newArrayList(new String[] { "anvil_intact", "anvil_slightly_damaged", "anvil_very_damaged" }));
    variantNames.put(Item.getItemFromBlock(Blocks.quartz_block), Lists.newArrayList(new String[] { "quartz_block", "chiseled_quartz_block", "quartz_column" }));
    ...
    variantNames.put(Item.getItemFromBlock(Blocks.stained_glass_pane), Lists.newArrayList(new String[] { "black_stained_glass_pane", "red_stained_glass_pane", "green_stained_glass_pane", "brown_stained_glass_pane", "blue_stained_glass_pane", "purple_stained_glass_pane", "cyan_stained_glass_pane", "silver_stained_glass_pane", "gray_stained_glass_pane", "pink_stained_glass_pane", "lime_stained_glass_pane", "yellow_stained_glass_pane", "light_blue_stained_glass_pane", "magenta_stained_glass_pane", "orange_stained_glass_pane", "white_stained_glass_pane" }));
    variantNames.put(Item.getItemFromBlock(Blocks.leaves2), Lists.newArrayList(new String[] { "acacia_leaves", "dark_oak_leaves" }));
    variantNames.put(Item.getItemFromBlock(Blocks.log2), Lists.newArrayList(new String[] { "acacia_log", "dark_oak_log" }));
    variantNames.put(Item.getItemFromBlock(Blocks.prismarine), Lists.newArrayList(new String[] { "prismarine", "prismarine_bricks", "dark_prismarine" }));
    variantNames.put(Item.getItemFromBlock(Blocks.carpet), Lists.newArrayList(new String[] { "black_carpet", "red_carpet", "green_carpet", "brown_carpet", "blue_carpet", "purple_carpet", "cyan_carpet", "silver_carpet", "gray_carpet", "pink_carpet", "lime_carpet", "yellow_carpet", "light_blue_carpet", "magenta_carpet", "orange_carpet", "white_carpet" }));
    variantNames.put(Item.getItemFromBlock(Blocks.double_plant), Lists.newArrayList(new String[] { "sunflower", "syringa", "double_grass", "double_fern", "double_rose", "paeonia" }));
    variantNames.put(Items.bow, Lists.newArrayList(new String[] { "bow", "bow_pulling_0", "bow_pulling_1", "bow_pulling_2" }));
    ...
    variantNames.put(Items.dye, Lists.newArrayList(new String[] { "dye_black", "dye_red", "dye_green", "dye_brown", "dye_blue", "dye_purple", "dye_cyan", "dye_silver", "dye_gray", "dye_pink", "dye_lime", "dye_yellow", "dye_light_blue", "dye_magenta", "dye_orange", "dye_white" }));
    variantNames.put(Items.potionitem, Lists.newArrayList(new String[] { "bottle_drinkable", "bottle_splash" }));
    variantNames.put(Items.skull, Lists.newArrayList(new String[] { "skull_skeleton", "skull_wither", "skull_zombie", "skull_char", "skull_creeper" }));
    variantNames.put(Item.getItemFromBlock(Blocks.oak_fence_gate), Lists.newArrayList(new String[] { "oak_fence_gate" }));
  ...
  private void bakeBlockModels()
  {
    ...
    while (var1.hasNext())
    {
      ...
      int var4 = 0;
      Iterator var5 = ((ModelBlockDefinition.Variants)variants.get(var2)).getVariants().iterator();
      
      while (var5.hasNext())
      {
        ModelBlockDefinition.Variant var6 = (ModelBlockDefinition.Variant)var5.next();
        ModelBlock var7 = (ModelBlock)models.get(var6.getModelLocation());
    ...
    while (var1.hasNext())
    {
      Map.Entry var8 = (Map.Entry)var1.next();
      ...
      ModelBlock var11 = (ModelBlock)models.get(var9);
      
      if ((var11 != null) && (var11.isResolved()))
      {
        if (isCustomRenderer(var11))
        {
          bakedRegistry.putObject(var10, new BuiltInModel(new net.minecraft.client.renderer.block.model.ItemCameraTransforms(var11.getThirdPersonTransform(), var11.getFirstPersonTransform(), var11.getHeadTransform(), var11.getInGuiTransform())));
        }
        else
        {
  ...
  private Set func_177575_g()
  {
    ...
    ArrayList var2 = Lists.newArrayList(variants.keySet());
        ...
        var6.hasNext())
    {
      ...
      ModelBlockDefinition.Variants var5 = (ModelBlockDefinition.Variants)variants.get(var4);
      var6 = var5.getVariants().iterator();
      
      continue;
      
      ModelBlockDefinition.Variant var7 = (ModelBlockDefinition.Variant)var6.next();
      ModelBlock var8 = (ModelBlock)models.get(var7.getModelLocation());
  ...
  {
    TextureAtlasSprite var4 = (TextureAtlasSprite)field_177599_g.get(new ResourceLocation(p_177578_1_.resolveTextureName("particle")));
        ...
        var8.hasNext())
    {
      ...
      TextureAtlasSprite var11 = (TextureAtlasSprite)field_177599_g.get(new ResourceLocation(p_177578_1_.resolveTextureName(field_178242_d)));
      ...
      {
        var5.func_177650_a(p_177578_2_.func_177523_a(field_178244_b), func_177589_a(var7, var10, var11, var9, p_177578_2_, p_177578_3_));
      }
    }
  ...
  {
    return field_177607_l.func_178414_a(field_178241_a, field_178239_b, p_177589_2_, p_177589_3_, p_177589_4_, p_177589_5_, field_178237_d, p_177589_6_, field_178238_e);
  }
  ...
  {
    ArrayDeque var1 = com.google.common.collect.Queues.newArrayDeque();
    HashSet var2 = Sets.newHashSet();
    Iterator var3 = models.keySet().iterator();
    ...
    while (var3.hasNext())
    {
      ...
      var2.add(var4);
      ResourceLocation var5 = ((ModelBlock)models.get(var4)).getParentLocation();
    ...
    while (!var1.isEmpty())
    {
      ...
      try
      {
        ...
        ModelBlock var8 = loadModel(var7);
        models.put(var7, var8);
        ResourceLocation var5 = var8.getParentLocation();
      ...
      {
        LOGGER.warn("In parent chain: " + field_177601_e.join(func_177573_e(var7)) + "; unable to load model: '" + var7 + "'", var6);
      }
  ...
  {
    Iterator var2 = models.entrySet().iterator();
  ...
  private Set func_177585_a(ModelBlock p_177585_1_)
  {
        ...
        var5.hasNext())
    {
      ...
      var5 = field_178240_c.values().iterator();
      
      continue;
      
      BlockPartFace var6 = (BlockPartFace)var5.next();
      ResourceLocation var7 = new ResourceLocation(p_177585_1_.resolveTextureName(field_178242_d));
      var2.add(var7);
    }
  ...
  {
    HashSet var1 = Sets.newHashSet();
    Iterator var2 = itemLocations.values().iterator();
    
    while (var2.hasNext())
    {
      ResourceLocation var3 = (ResourceLocation)var2.next();
      ModelBlock var4 = (ModelBlock)models.get(var3);
      ...
      if (var4 != null)
      {
        ...
        if (func_177581_b(var4)) {
          ...
          for (Iterator var5 = ItemModelGenerator.LAYERS.iterator(); var5.hasNext(); var1.add(var11))
          {
        ...
        {
          Iterator var5 = var4.getElements().iterator();
          Iterator var7;
          for (; var5.hasNext(); 
              ...
              var7.hasNext())
          {
            ...
            var7 = field_178240_c.values().iterator();
            
            continue;
            
            BlockPartFace var8 = (BlockPartFace)var7.next();
            ResourceLocation var9 = new ResourceLocation(var4.resolveTextureName(field_178242_d));
            var1.add(var9);
          }
        }
      }
  ...
  private void bakeItemModels()
  {
    ...
    while (var1.hasNext())
    {
      ...
      ModelBlock var3 = (ModelBlock)models.get(var2);
      
      if (func_177581_b(var3))
      {
        ModelBlock var4 = func_177582_d(var3);
        
        if (var4 != null)
        {
          field_178317_b = var2.toString();
        }
  ...
  static
  {
    ...
    MODEL_GENERATEDfield_178317_b = "generation marker";
    MODEL_COMPASSfield_178317_b = "compass generation marker";
    MODEL_CLOCKfield_178317_b = "class generation marker";
    MODEL_ENTITYfield_178317_b = "block entity marker";
  }
}
