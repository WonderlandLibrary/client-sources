...
public class GuiPlayerTabOverlay extends Gui
{
  ...
  private void func_175247_a(ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_, int p_175247_5_, NetworkPlayerInfo p_175247_6_)
  {
    ...
    if (p_175247_1_.func_178766_e() == IScoreObjectiveCriteria.EnumRenderType.HEARTS)
    {
      ...
      if (var8 > 0)
      {
        ...
        else
        {
          ...
          field_175250_f.fontRendererObj.drawStringWithShadow(var14, (p_175247_5_ + p_175247_4_) / 2 - field_175250_f.fontRendererObj.getStringWidth(var14) / 2, p_175247_2_, var13);
        }
      }
    }
    else
    {
      ...
      field_175250_f.fontRendererObj.drawStringWithShadow(var15, p_175247_5_ - field_175250_f.fontRendererObj.getStringWidth(var15), p_175247_2_, 16777215);
    }
  }
