...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
  ...
  public void initGui()
  {
    ...
    var1.setTime(new java.util.Date());
    ...
    buttonList.add(new GuiButton(0, width / 2 - 100, var3 + 72 + 12, 98, 20, I18n.format("menu.options", new Object[0])));
  ...
  private void drawPanorama(int p_73970_1_, int p_73970_2_, float p_73970_3_)
  {
    ...
    org.lwjgl.util.glu.Project.gluPerspective(120.0F, 1.0F, 0.05F, 10.0F);
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    GlStateManager.popMatrix();
    String var10 = instancename + " " + instanceversion;
