...
public class ChunkRenderDispatcher
{
  ...
  {
    return String.format("pC: %03d, pU: %1d, aB: %1d", new Object[] { Integer.valueOf(field_178519_d.size()), Integer.valueOf(field_178524_h.size()), Integer.valueOf(field_178520_e.size()) });
  }
  ...
  public boolean func_178516_a(long p_178516_1_)
  {
    ...
    {
      boolean var4 = false;
      Queue var5 = field_178524_h;
      Queue var81 = field_178524_h;
  ...
  public boolean func_178507_a(RenderChunk p_178507_1_)
  {
    ...
    try
    {
      ...
      boolean var3 = field_178519_d.offer(var2);
  ...
  public boolean func_178509_c(RenderChunk p_178509_1_)
  {
    ...
    try
    {
      ...
      boolean var4;
      p_178509_1_.func_178579_c().unlock(); } boolean var4; p_178509_1_.func_178579_c().unlock();
    

    return var4;
  }
  
  public com.google.common.util.concurrent.ListenableFuture func_178503_a(final EnumWorldBlockLayer p_178503_1_, final WorldRenderer p_178503_2_, final RenderChunk p_178503_3_, final CompiledChunk p_178503_4_)
  {
    if (Minecraft.getMinecraft().isCallingFromMinecraftThread())
    {
      ...
      {
        func_178510_a(p_178503_2_, ((ListedRenderChunk)p_178503_3_).func_178600_a(p_178503_1_, p_178503_4_), p_178503_3_);
      }
    ...
    ListenableFutureTask var5 = ListenableFutureTask.create(new Runnable()
    {
      ...
      public void run() {
        func_178503_a(p_178503_1_, p_178503_2_, p_178503_3_, p_178503_4_);
      }
    }, null);
    Queue var6 = field_178524_h;
    Queue var7 = field_178524_h;
  ...
  public void func_178513_e()
  {
    ...
    {
      ChunkCompileTaskGenerator task = (ChunkCompileTaskGenerator)field_178519_d.poll();
