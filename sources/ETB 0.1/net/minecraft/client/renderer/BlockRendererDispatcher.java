...
public class BlockRendererDispatcher implements IResourceManagerReloadListener
{
  ...
  public void func_175020_a(IBlockState p_175020_1_, BlockPos p_175020_2_, TextureAtlasSprite p_175020_3_, IBlockAccess p_175020_4_)
  {
    ...
    if (var6 == 3)
    {
      ...
      IBakedModel var7 = field_175028_a.func_178125_b(p_175020_1_);
      ...
      if (Reflector.ISmartBlockModel.isInstance(var7))
      {
        ...
        for (int i$ = 0; i$ < len$; i$++)
        {
          ...
          if (Reflector.callBoolean(var5, Reflector.ForgeBlock_canRenderInLayer, new Object[] { layer }))
          {
            ...
            blockModelRenderer.func_178259_a(p_175020_4_, damageModel, p_175020_1_, p_175020_2_, Tessellator.getInstance().getWorldRenderer());
          }
        }
      ...
      blockModelRenderer.func_178259_a(p_175020_4_, var8, p_175020_1_, p_175020_2_, Tessellator.getInstance().getWorldRenderer());
    }
  }
  ...
  public boolean func_175018_a(IBlockState p_175018_1_, BlockPos p_175018_2_, IBlockAccess p_175018_3_, WorldRenderer p_175018_4_)
  {
    try
    {
      ...
      case 1: 
        ...
        boolean var61 = fluidRenderer.func_178270_a(p_175018_3_, p_175018_1_, p_175018_2_, p_175018_4_);
      ...
      case 3: 
        IBakedModel var71 = getModelFromBlockState(p_175018_1_, p_175018_3_, p_175018_2_);
        ...
        boolean flag3 = blockModelRenderer.func_178259_a(p_175018_3_, var71, p_175018_1_, p_175018_2_, p_175018_4_);
  ...
  public void func_175016_a(IBlockState p_175016_1_, float p_175016_2_)
  {
    ...
    if (var3 != -1)
    {
      ...
      case 3: 
        IBakedModel var4 = func_175017_a(p_175016_1_, null);
