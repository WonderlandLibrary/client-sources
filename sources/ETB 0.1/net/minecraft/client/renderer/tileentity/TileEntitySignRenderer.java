  ...
  extends TileEntitySpecialRenderer
{
  ...
  public void func_180541_a(TileEntitySign p_180541_1_, double p_180541_2_, double p_180541_4_, double p_180541_6_, float p_180541_8_, int p_180541_9_) { Block var10 = p_180541_1_.getBlockType();
    ...
    if (var10 == Blocks.standing_sign)
    {
      ...
      float var20 = p_180541_1_.getBlockMetadata() * 360 / 16.0F;
    ...
    FontRenderer var201 = getFontRenderer();
    float var13 = 0.015625F * var11;
    ...
    if (p_180541_9_ < 0)
    {
      for (int var15 = 0; var15 < signText.length; var15++)
      {
        if (signText[var15] != null)
        {
          IChatComponent var16 = signText[var15];
          ...
          if (var15 == lineBeingEdited)
          {
            var18 = "> " + var18 + " <";
            var201.drawString(var18, -var201.getStringWidth(var18) / 2, var15 * 10 - signText.length * 5, var14);
          }
          else
          {
            var201.drawString(var18, -var201.getStringWidth(var18) / 2, var15 * 10 - signText.length * 5, var14);
