...
public class WorldRenderer
{
  ...
  private void growBuffer(int p_178983_1_)
  {
    ...
    if (quadSprites != null)
    {
      TextureAtlasSprite[] sprites = quadSprites;
  ...
  public State getVertexState(float p_178971_1_, float p_178971_2_, float p_178971_3_)
  {
    ...
    PriorityQueue var5 = new PriorityQueue(rawBufferIndex, new QuadComparator(rawFloatBuffer, (float)(p_178971_1_ + xOffset), (float)(p_178971_2_ + yOffset), (float)(p_178971_3_ + zOffset), vertexFormat.func_177338_f() / 4));
    int var6 = vertexFormat.func_177338_f();
    TextureAtlasSprite[] quadSpritesSorted = null;
    int quadStep = vertexFormat.func_177338_f() / 4 * 4;
    ...
    return new State(var4, rawBufferIndex, vertexCount, new VertexFormat(vertexFormat), quadSpritesSorted);
  }
  ...
  public void setVertexState(State p_178993_1_)
  {
    ...
    if (stateQuadSprites != null)
    {
      ...
      System.arraycopy(stateQuadSprites, 0, quadSprites, 0, stateQuadSprites.length);
    }
    else
    {
      if (quadSprites != null)
  ...
  public void drawMultiTexture()
  {
    if (quadSprites != null)
    {
      ...
      {
        TextureAtlasSprite icon = quadSprites[i];
  ...
  private int drawForIcon(TextureAtlasSprite sprite, int startQuadPos)
  {
    ...
    {
      TextureAtlasSprite ts = quadSprites[i];
  ...
  {
    int quadSize = rawIntBuffer.capacity() * 4 / (vertexFormat.func_177338_f() * 4);
    return quadSize;
  }
