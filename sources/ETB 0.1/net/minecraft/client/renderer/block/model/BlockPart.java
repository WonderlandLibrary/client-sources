...
public class BlockPart
{
  ...
  {
    Iterator var1 = field_178240_c.entrySet().iterator();
    
    while (var1.hasNext())
    {
      Map.Entry var2 = (Map.Entry)var1.next();
      float[] var3 = func_178236_a((EnumFacing)var2.getKey());
      getValuefield_178243_e.func_178349_a(var3);
    }
  }
  ...
  private float[] func_178236_a(EnumFacing p_178236_1_) {
    ...
    case 3: 
    case 4: 
      var2 = new float[] { field_178241_a.x, 16.0F - field_178239_b.y, field_178239_b.x, 16.0F - field_178241_a.y };
      break;
    case 5: 
    case 6: 
      var2 = new float[] { field_178241_a.z, 16.0F - field_178239_b.y, field_178239_b.z, 16.0F - field_178241_a.y };
      break;
    default: 
  ...
  static class Deserializer implements com.google.gson.JsonDeserializer {
    ...
    public BlockPart func_178254_a(JsonElement p_178254_1_, Type p_178254_2_, JsonDeserializationContext p_178254_3_) {
      ...
      Vector3f var5 = func_178249_e(var4);
      Vector3f var6 = func_178247_d(var4);
      BlockPartRotation var7 = func_178256_a(var4);
      Map var8 = func_178250_a(p_178254_3_, var4);
    ...
    private BlockPartRotation func_178256_a(JsonObject p_178256_1_)
    {
      ...
      if (p_178256_1_.has("rotation"))
      {
        ...
        Vector3f var4 = func_178251_a(var3, "origin");
        var4.scale(0.0625F);
        EnumFacing.Axis var5 = func_178252_c(var3);
        float var6 = func_178255_b(var3);
    ...
    {
      Map var3 = func_178253_b(p_178250_1_, p_178250_2_);
    ...
    {
      EnumMap var3 = com.google.common.collect.Maps.newEnumMap(EnumFacing.class);
      ...
      while (var5.hasNext())
      {
        ...
        EnumFacing var7 = func_178248_a((String)var6.getKey());
    ...
    {
      Vector3f var2 = func_178251_a(p_178247_1_, "to");
    ...
    {
      Vector3f var2 = func_178251_a(p_178249_1_, "from");
