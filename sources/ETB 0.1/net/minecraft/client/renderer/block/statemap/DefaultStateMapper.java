...
public class DefaultStateMapper extends StateMapperBase
{
  ...
  {
    return new ModelResourceLocation((net.minecraft.util.ResourceLocation)net.minecraft.block.Block.blockRegistry.getNameForObject(p_178132_1_.getBlock()), func_178131_a(p_178132_1_.getProperties()));
  }
}
