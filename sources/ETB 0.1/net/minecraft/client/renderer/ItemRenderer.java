...
public class ItemRenderer
{
  ...
  {
    mc = mcIn;
    field_178111_g = mcIn.getRenderManager();
  ...
  public void renderItem(EntityLivingBase p_178099_1_, ItemStack p_178099_2_, ItemCameraTransforms.TransformType p_178099_3_)
  {
    if (p_178099_2_ != null)
    {
      ...
      if (itemRenderer.func_175050_a(p_178099_2_))
      {
      ...
      itemRenderer.func_175049_a(p_178099_2_, p_178099_1_, p_178099_3_);
  ...
  {
    int var2 = mc.theWorld.getCombinedLight(new BlockPos(posX, posY + p_178109_1_.getEyeHeight(), posZ), 0);
    
    if (Config.isDynamicLights())
    {
      var2 = optifine.DynamicLights.getCombinedLight(mc.func_175606_aa(), var2);
    }
  ...
  {
    float var3 = prevRenderArmPitch + (renderArmPitch - prevRenderArmPitch) * p_178110_2_;
    float var4 = prevRenderArmYaw + (renderArmYaw - prevRenderArmYaw) * p_178110_2_;
    GlStateManager.rotate((rotationPitch - var3) * 0.1F, 1.0F, 0.0F, 0.0F);
    GlStateManager.rotate((rotationYaw - var4) * 0.1F, 0.0F, 1.0F, 0.0F);
  }
  ...
  private void func_180534_a(RenderPlayer p_180534_1_)
  {
    ...
    p_180534_1_.func_177138_b(mc.thePlayer);
    GlStateManager.popMatrix();
  }
  ...
  private void func_178106_b(RenderPlayer p_178106_1_)
  {
    ...
    p_178106_1_.func_177139_c(mc.thePlayer);
    GlStateManager.popMatrix();
  }
  ...
  private void func_178102_b(AbstractClientPlayer p_178102_1_)
  {
    ...
    Render var2 = field_178111_g.getEntityRenderObject(mc.thePlayer);
  ...
  private void func_178097_a(AbstractClientPlayer p_178097_1_, float p_178097_2_, float p_178097_3_, float p_178097_4_)
  {
    ...
    var11.draw();
    MapData var13 = Items.filled_map.getMapData(itemToRender, mc.theWorld);
    
    if (var13 != null)
    {
      mc.entityRenderer.getMapItemRenderer().func_148250_a(var13, false);
    }
  }
  ...
  private void func_178095_a(AbstractClientPlayer p_178095_1_, float p_178095_2_, float p_178095_3_)
  {
    ...
    mc.getTextureManager().bindTexture(p_178095_1_.getLocationSkin());
    ...
    Render var9 = field_178111_g.getEntityRenderObject(mc.thePlayer);
    RenderPlayer var10 = (RenderPlayer)var9;
    var10.func_177138_b(mc.thePlayer);
  }
  ...
  private void func_178104_a(AbstractClientPlayer p_178104_1_, float p_178104_2_)
  {
    ...
    float var4 = var3 / itemToRender.getMaxItemUseDuration();
  ...
  private void func_178098_a(float p_178098_1_, AbstractClientPlayer p_178098_2_)
  {
    ...
    float var3 = itemToRender.getMaxItemUseDuration() - (p_178098_2_.getItemInUseCount() - p_178098_1_ + 1.0F);
  ...
  {
    float var2 = 1.0F - (prevEquippedProgress + (equippedProgress - prevEquippedProgress) * p_78440_1_);
    EntityPlayerSP var3 = mc.thePlayer;
    float var4 = var3.getSwingProgress(p_78440_1_);
    float var5 = prevRotationPitch + (rotationPitch - prevRotationPitch) * p_78440_1_;
    float var6 = prevRotationYaw + (rotationYaw - prevRotationYaw) * p_78440_1_;
    ...
    if (itemToRender != null)
    {
      ...
      {
        EnumAction var7 = itemToRender.getItemUseAction();
  ...
  public void renderOverlays(float p_78447_1_)
  {
    ...
    if (mc.thePlayer.isEntityInsideOpaqueBlock())
    {
      ...
      IBlockState var2 = mc.theWorld.getBlockState(blockPos);
      EntityPlayerSP var3 = mc.thePlayer;
      
      for (int overlayType = 0; overlayType < 8; overlayType++)
      {
        double var5 = posX + ((overlayType >> 0) % 2 - 0.5F) * width * 0.8F;
        double var7 = posY + ((overlayType >> 1) % 2 - 0.5F) * 0.1F;
        double var9 = posZ + ((overlayType >> 2) % 2 - 0.5F) * width * 0.8F;
        blockPos = new BlockPos(var5, var7 + var3.getEyeHeight(), var9);
        IBlockState var12 = mc.theWorld.getBlockState(blockPos);
      ...
      if (var2.getBlock().getRenderType() != -1)
      {
        ...
        if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderBlockOverlay, new Object[] { mc.thePlayer, Float.valueOf(p_78447_1_), var13, var2, blockPos }))
        {
    ...
    if (!mc.thePlayer.func_175149_v())
    {
      if (mc.thePlayer.isInsideOfMaterial(Material.water)) { if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderWaterOverlay, new Object[] { mc.thePlayer, Float.valueOf(p_78447_1_) }))
        {
          renderWaterOverlayTexture(p_78447_1_);
        }
      }
      if (mc.thePlayer.isBurning()) { if (!Reflector.callBoolean(Reflector.ForgeEventFactory_renderFireOverlay, new Object[] { mc.thePlayer, Float.valueOf(p_78447_1_) }))
        {
  ...
  private void renderWaterOverlayTexture(float p_78448_1_)
  {
    ...
    float var4 = mc.thePlayer.getBrightness(p_78448_1_);
    ...
    float var9 = 1.0F;
    float var10 = -0.5F;
    float var11 = -mc.thePlayer.rotationYaw / 64.0F;
    float var12 = mc.thePlayer.rotationPitch / 64.0F;
  ...
  private void renderFireInFirstPerson(float p_78442_1_)
  {
    ...
    {
      GlStateManager.pushMatrix();
      TextureAtlasSprite var6 = mc.getTextureMapBlocks().getAtlasSprite("minecraft:blocks/fire_layer_1");
      mc.getTextureManager().bindTexture(TextureMap.locationBlocksTexture);
  ...
  public void updateEquippedItem()
  {
    ...
    if ((itemToRender != null) && (var2 != null))
    {
      if (!itemToRender.getIsItemStackEqual(var2))
      {
        ...
        {
          boolean var4 = Reflector.callBoolean(itemToRender.getItem(), Reflector.ForgeItem_shouldCauseReequipAnimation, new Object[] { itemToRender, var2, Boolean.valueOf(equippedItemSlot != inventory.currentItem ? 1 : false) });
          
          if (!var4)
          {
            itemToRender = var2;
            equippedItemSlot = inventory.currentItem;
            return;
          }
        }
    ...
    else if ((itemToRender == null) && (var2 == null))
    {
      var3 = false;
    }
    else
    ...
    float var6 = MathHelper.clamp_float(var5 - equippedProgress, -var41, var41);
