...
public abstract class RendererLivingEntity extends Render
{
  ...
  protected List field_177097_h = com.google.common.collect.Lists.newArrayList();
  ...
  {
    for (float var4 = p_77034_2_ - p_77034_1_; var4 < -180.0F; var4 += 360.0F) {}
  ...
  {
    if (Reflector.RenderLivingEvent_Pre_Constructor.exists()) { if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] { p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_) })) {}
    } else {
      ...
      {
        mainModel.isRiding = ((p_76986_1_.isRiding()) && (ridingEntity != null) && (Reflector.callBoolean(ridingEntity, Reflector.ForgeEntity_shouldRiderSit, new Object[0])));
      }
      ...
      try
      {
        float var19 = interpolateRotation(prevRenderYawOffset, renderYawOffset, p_76986_9_);
        float var11 = interpolateRotation(prevRotationYawHead, rotationYawHead, p_76986_9_);
        float var12 = var11 - var19;
        

        if ((mainModel.isRiding) && ((ridingEntity instanceof EntityLivingBase)))
        {
          EntityLivingBase var20 = (EntityLivingBase)ridingEntity;
          var19 = interpolateRotation(prevRenderYawOffset, renderYawOffset, p_76986_9_);
          var12 = var11 - var19;
        ...
        float var201 = prevRotationPitch + (rotationPitch - prevRotationPitch) * p_76986_9_;
        ...
        float var16 = prevLimbSwingAmount + (limbSwingAmount - prevLimbSwingAmount) * p_76986_9_;
        float var17 = limbSwing - limbSwingAmount * (1.0F - p_76986_9_);
      ...
      if (Reflector.RenderLivingEvent_Post_Constructor.exists()) { if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Post_Constructor, new Object[] { p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_) })) {}
      }
    }
  }
  ...
  protected boolean func_177088_c(EntityLivingBase p_177088_1_)
  {
    ...
    float var61 = (var2 >> 16 & 0xFF) / 255.0F;
    float var71 = (var2 >> 8 & 0xFF) / 255.0F;
  ...
  protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
  {
    ...
    boolean var9 = (!var8) && (!p_77036_1_.isInvisibleToPlayer(getMinecraftthePlayer));
  ...
  protected boolean func_177092_a(EntityLivingBase p_177092_1_, float p_177092_2_, boolean p_177092_3_)
  {
    ...
    int var5 = getColorMultiplier(p_177092_1_, var4, p_177092_2_);
    boolean var6 = (var5 >> 24 & 0xFF) > 0;
    boolean var7 = (hurtTime > 0) || (deathTime > 0);
  ...
  protected void rotateCorpse(EntityLivingBase p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_)
  {
    ...
    if (deathTime > 0)
    {
      float var6 = (deathTime + p_77043_4_ - 1.0F) / 20.0F * 1.6F;
    ...
    else
    {
      ...
      if ((var61 != null) && ((var61.equals("Dinnerbone")) || (var61.equals("Grumm"))) && ((!(p_77043_1_ instanceof EntityPlayer)) || (((EntityPlayer)p_77043_1_).func_175148_a(net.minecraft.entity.player.EnumPlayerModelParts.CAPE))))
      {
  ...
  {
    return ticksExisted + p_77044_2_;
  }
  ...
  {
    Iterator var9 = field_177097_h.iterator();
    
    while (var9.hasNext())
    {
      LayerRenderer var10 = (LayerRenderer)var9.next();
      boolean var11 = func_177092_a(p_177093_1_, p_177093_4_, var10.shouldCombineTextures());
  ...
  {
    if (Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists()) { if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, new Object[] { p_77033_1_, this, Double.valueOf(p_77033_2_), Double.valueOf(p_77033_4_), Double.valueOf(p_77033_6_) })) {}
    } else {
      if (canRenderName(p_77033_1_))
      {
        double var8 = p_77033_1_.getDistanceSqToEntity(renderManager.livingPlayer);
        ...
        if (var8 < var10 * var10)
        {
          ...
          if (p_77033_1_.isSneaking())
          {
            ...
            GlStateManager.pushMatrix();
            GlStateManager.translate((float)p_77033_2_, (float)p_77033_4_ + height + 0.5F - (p_77033_1_.isChild() ? height / 2.0F : 0.0F), (float)p_77033_6_);
          ...
          {
            func_177069_a(p_77033_1_, p_77033_2_, p_77033_4_ - (p_77033_1_.isChild() ? height / 2.0F : 0.0D), p_77033_6_, var11, 0.02666667F, var8);
          }
        }
      }
      
      if (Reflector.RenderLivingEvent_Specials_Post_Constructor.exists()) { if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Post_Constructor, new Object[] { p_77033_1_, this, Double.valueOf(p_77033_2_), Double.valueOf(p_77033_4_), Double.valueOf(p_77033_6_) })) {}
      }
    }
  }
  ...
  {
    EntityPlayerSP var2 = getMinecraftthePlayer;
    ...
    return (Minecraft.isGuiEnabled()) && (targetEntity != renderManager.livingPlayer) && (!targetEntity.isInvisibleToPlayer(var2)) && (riddenByEntity == null);
  }
  ...
  {
    doRender((EntityLivingBase)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
  }
  ...
  static final class SwitchEnumVisible { static final int[] field_178679_a = new int[Team.EnumVisible.values().length];
