...
public class SoundHandler implements IResourceManagerReloadListener, IUpdatePlayerListBox
{
  ...
  {
    boolean var4 = !sndRegistry.containsKey(p_147693_1_);
      ...
      case 2: 
        var10 = new ISoundEventAccessor()
        {
          ...
          public int getWeight() {
            SoundEventAccessorComposite var1 = (SoundEventAccessorComposite)sndRegistry.getObject(field_148726_a);
  ...
  public SoundEventAccessorComposite getRandomSoundFromCategories(SoundCategory... p_147686_1_)
  {
    ...
    Iterator var3 = sndRegistry.getKeys().iterator();
    
    while (var3.hasNext())
    {
      ResourceLocation var4 = (ResourceLocation)var3.next();
      SoundEventAccessorComposite var5 = (SoundEventAccessorComposite)sndRegistry.getObject(var4);
      
      if (org.apache.commons.lang3.ArrayUtils.contains(p_147686_1_, var5.getSoundCategory()))
      {
        var2.add(var5);
      }
    }
