...
public class PlayerControllerMP
{
  ...
  private void syncCurrentPlayItem()
  {
    ...
    if (var1 != currentPlayerItem)
    {
      ...
      netClientHandler.addToSendQueue(new net.minecraft.network.play.client.C09PacketHeldItemChange(currentPlayerItem));
    }
  }
  ...
  {
    return (mc.thePlayer.isRiding()) && ((mc.thePlayer.ridingEntity instanceof net.minecraft.entity.passive.EntityHorse));
  }
