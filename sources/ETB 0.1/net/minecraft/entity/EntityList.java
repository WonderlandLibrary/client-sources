...
public class EntityList
{
  ...
  private static void addMapping(Class p_75618_0_, String p_75618_1_, int p_75618_2_)
  {
    ...
    if (idToClassMapping.containsKey(Integer.valueOf(p_75618_2_)))
    {
  ...
  public static List func_180124_b()
  {
    ...
    while (var2.hasNext())
    {
      ...
      if ((var4.getModifiers() & 0x400) != 1024)
      {
        var1.add(var3);
      }
    }
  ...
  static
  {
    ...
    addMapping(net.minecraft.entity.monster.EntityMagmaCube.class, "LavaSlime", 62, 3407872, 16579584);
  ...
  public static class EntityEggInfo { public final int spawnedID;
    ...
    public EntityEggInfo(int p_i1583_1_, int p_i1583_2_, int p_i1583_3_) { spawnedID = p_i1583_1_;
