...
public class EntityLeashKnot extends EntityHanging
{
  ...
  public boolean interactFirst(EntityPlayer playerIn)
  {
    ...
    if ((var2 != null) && (var2.getItem() == net.minecraft.init.Items.lead) && (!worldObj.isRemote))
    {
      double var4 = 7.0D;
      List var6 = worldObj.getEntitiesWithinAABB(EntityLiving.class, new AxisAlignedBB(posX - var4, posY - var4, posZ - var4, posX + var4, posY + var4, posZ + var4));
  ...
  {
    return worldObj.getBlockState(field_174861_a).getBlock() instanceof net.minecraft.block.BlockFence;
  }
