  ...
  extends Iterable
{
    ...
    implements JsonDeserializer, JsonSerializer
  {
    ...
    public IChatComponent deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_)
    {
      ...
      if (var4.has("text"))
      {
        ...
        else if (var4.has("score"))
        {
          ...
          Object var5 = new ChatComponentScore(JsonUtils.getJsonObjectStringFieldValue(var13, "name"), JsonUtils.getJsonObjectStringFieldValue(var13, "objective"));
    ...
    public JsonElement serialize(IChatComponent p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_)
    {
      ...
      if (!p_serialize_1_.getSiblings().isEmpty())
      {
        ...
        while (var6.hasNext())
        {
          ...
          var5.add(serialize(var7, var7.getClass(), p_serialize_3_));
        }
      ...
      else if ((p_serialize_1_ instanceof ChatComponentTranslation))
      {
        ...
        if ((var11.getFormatArgs() != null) && (var11.getFormatArgs().length > 0))
        {
          ...
          for (int var9 = 0; var9 < var8; var9++)
          {
            ...
            {
              var14.add(serialize((IChatComponent)var10, var10.getClass(), p_serialize_3_));
            }
            else
            {
    ...
    {
      return serialize((IChatComponent)p_serialize_1_, p_serialize_2_, p_serialize_3_);
    }
