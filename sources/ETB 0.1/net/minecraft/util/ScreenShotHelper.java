...
public class ScreenShotHelper
{
  ...
  public static IChatComponent saveScreenshot(File p_148259_0_, String p_148259_1_, int p_148259_2_, int p_148259_3_, Framebuffer p_148259_4_)
  {
    try
    {
      ...
      {
        p_148259_2_ = framebufferTextureWidth;
        p_148259_3_ = framebufferTextureHeight;
      }
      ...
      if (OpenGlHelper.isFramebufferEnabled())
      {
        var7 = new BufferedImage(framebufferWidth, framebufferHeight, 1);
        int var8 = framebufferTextureHeight - framebufferHeight;
        
        for (int var9 = var8; var9 < framebufferTextureHeight; var9++)
        {
          for (int var10 = 0; var10 < framebufferWidth; var10++)
          {
            var7.setRGB(var10, var9 - var8, pixelValues[(var9 * framebufferTextureWidth + var10)]);
          }
        }
      }
      else
  ...
  private static File getTimestampedPNGFileForDirectory(File p_74290_0_)
  {
    ...
    for (;;)
    {
      File var1 = new File(p_74290_0_, var2 + (var3 == 1 ? "" : new StringBuilder("_").append(var3).toString()) + ".png");
