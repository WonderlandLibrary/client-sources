  ...
  implements Plugin
{
  ...
  private static File[] listFilesPrivileged(File dir, final FilenameFilter filter) { (File[])AccessController.doPrivileged(new PrivilegedAction() { private final File val$dir;
      
      public Object run() { File[] files = val$dir.listFiles(filter);
