...
final class OSXHIDDevice
{
  ...
  {
    return (String)properties.get("Product");
  }
  ...
  public final UsagePair getUsagePair() {
    int usage_page_id = getIntFromProperties(properties, "PrimaryUsagePage");
    int usage_id = getIntFromProperties(properties, "PrimaryUsage");
  ...
  private final Map getDeviceProperties() throws IOException { return nGetDeviceProperties(device_address); }
  ...
  public final synchronized void getElementValue(long element_cookie, OSXEvent event) throws IOException { checkReleased();
  ...
  public final synchronized OSXHIDQueue createQueue(int queue_depth) throws IOException { checkReleased();
  ...
  private final void open() throws IOException { nOpen(device_interface_address); }
  

  private static final native void nOpen(long paramLong) throws IOException;
  
  private final void close() throws IOException { nClose(device_interface_address); }
