...
public class WaveData
{
  ...
  public static WaveData create(AudioInputStream ais)
  {
    ...
    if (audioformat.getChannels() == 1) {
      ...
      else if (!$assertionsDisabled) throw new AssertionError("Illegal sample size");
    }
    ...
    else if (!$assertionsDisabled) { throw new AssertionError("Only mono or stereo is supported");
    }
