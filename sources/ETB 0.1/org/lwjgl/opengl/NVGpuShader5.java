...
public final class NVGpuShader5
{
  ...
  public static void glUniform1i64NV(int location, long x)
  {
    ...
    long function_pointer = glUniform1i64NV;
  ...
  public static void glUniform2i64NV(int location, long x, long y) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform2i64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniform3i64NV(int location, long x, long y, long z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform3i64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniform4i64NV(int location, long x, long y, long z, long w) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform4i64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniform1NV(int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform1i64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniform2NV(int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform2i64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glUniform3NV(int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform3i64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glUniform4NV(int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform4i64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glUniform1ui64NV(int location, long x) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform1ui64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniform2ui64NV(int location, long x, long y) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform2ui64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniform3ui64NV(int location, long x, long y, long z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform3ui64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniform4ui64NV(int location, long x, long y, long z, long w) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform4ui64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniform1uNV(int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform1ui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glUniform2uNV(int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform2ui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glUniform3uNV(int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform3ui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glUniform4uNV(int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniform4ui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glGetUniformNV(int program, int location, LongBuffer params) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetUniformi64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetUniformuNV(int program, int location, LongBuffer params) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetUniformui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 1);
  ...
  public static void glProgramUniform1i64NV(int program, int location, long x) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform1i64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glProgramUniform2i64NV(int program, int location, long x, long y) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform2i64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glProgramUniform3i64NV(int program, int location, long x, long y, long z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform3i64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glProgramUniform4i64NV(int program, int location, long x, long y, long z, long w) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform4i64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glProgramUniform1NV(int program, int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform1i64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glProgramUniform2NV(int program, int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform2i64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glProgramUniform3NV(int program, int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform3i64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glProgramUniform4NV(int program, int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform4i64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glProgramUniform1ui64NV(int program, int location, long x) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform1ui64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glProgramUniform2ui64NV(int program, int location, long x, long y) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform2ui64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glProgramUniform3ui64NV(int program, int location, long x, long y, long z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform3ui64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glProgramUniform4ui64NV(int program, int location, long x, long y, long z, long w) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform4ui64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glProgramUniform1uNV(int program, int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform1ui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glProgramUniform2uNV(int program, int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform2ui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glProgramUniform3uNV(int program, int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform3ui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
  ...
  public static void glProgramUniform4uNV(int program, int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniform4ui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
