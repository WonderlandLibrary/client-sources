...
public final class ATIVertexStreams
{
  ...
  public static void glVertexStream2fATI(int stream, float x, float y)
  {
    ...
    long function_pointer = glVertexStream2fATI;
  ...
  public static void glVertexStream2dATI(int stream, double x, double y) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexStream2dATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexStream2iATI(int stream, int x, int y) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexStream2iATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexStream2sATI(int stream, short x, short y) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexStream2sATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexStream3fATI(int stream, float x, float y, float z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexStream3fATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexStream3dATI(int stream, double x, double y, double z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexStream3dATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexStream3iATI(int stream, int x, int y, int z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexStream3iATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexStream3sATI(int stream, short x, short y, short z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexStream3sATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexStream4fATI(int stream, float x, float y, float z, float w) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexStream4fATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexStream4dATI(int stream, double x, double y, double z, double w) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexStream4dATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexStream4iATI(int stream, int x, int y, int z, int w) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexStream4iATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexStream4sATI(int stream, short x, short y, short z, short w) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexStream4sATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glNormalStream3bATI(int stream, byte x, byte y, byte z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glNormalStream3bATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glNormalStream3fATI(int stream, float x, float y, float z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glNormalStream3fATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glNormalStream3dATI(int stream, double x, double y, double z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glNormalStream3dATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glNormalStream3iATI(int stream, int x, int y, int z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glNormalStream3iATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glNormalStream3sATI(int stream, short x, short y, short z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glNormalStream3sATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glClientActiveVertexStreamATI(int stream) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glClientActiveVertexStreamATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexBlendEnvfATI(int pname, float param) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexBlendEnvfATI;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexBlendEnviATI(int pname, int param) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexBlendEnviATI;
    BufferChecks.checkFunctionAddress(function_pointer);
