...
public final class EXTVertexWeighting
{
  ...
  public static void glVertexWeightfEXT(float weight)
  {
    ...
    long function_pointer = glVertexWeightfEXT;
  ...
  public static void glVertexWeightPointerEXT(int size, int stride, FloatBuffer pPointer) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexWeightPointerEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    GLChecks.ensureArrayVBOdisabled(caps);
    BufferChecks.checkDirect(pPointer);
    if (LWJGLUtil.CHECKS) getReferencesEXT_vertex_weighting_glVertexWeightPointerEXT_pPointer = pPointer;
    nglVertexWeightPointerEXT(size, 5126, stride, org.lwjgl.MemoryUtil.getAddress(pPointer), function_pointer); }
  
  static native void nglVertexWeightPointerEXT(int paramInt1, int paramInt2, int paramInt3, long paramLong1, long paramLong2);
  
  public static void glVertexWeightPointerEXT(int size, int type, int stride, long pPointer_buffer_offset) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexWeightPointerEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
