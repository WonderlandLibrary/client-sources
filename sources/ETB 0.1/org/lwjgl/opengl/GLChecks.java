...
class GLChecks
{
  ...
  {
    if ((LWJGLUtil.CHECKS) && (getReferencesarrayBuffer != 0)) {
  ...
  static void ensureIndirectBOdisabled(ContextCapabilities caps) {
    if ((LWJGLUtil.CHECKS) && (getReferencesindirectBuffer != 0)) {
  ...
  static void ensurePackPBOdisabled(ContextCapabilities caps) {
    if ((LWJGLUtil.CHECKS) && (getReferencespixelPackBuffer != 0)) {
  ...
  static void ensureUnpackPBOdisabled(ContextCapabilities caps) {
    if ((LWJGLUtil.CHECKS) && (getReferencespixelUnpackBuffer != 0)) {
