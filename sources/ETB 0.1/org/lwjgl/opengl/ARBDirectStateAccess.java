...
public final class ARBDirectStateAccess
{
  ...
  public static void glNamedBufferStorage(int buffer, DoubleBuffer data, int flags) { GL45.glNamedBufferStorage(buffer, data, flags); }
  
  public static void glNamedBufferStorage(int buffer, FloatBuffer data, int flags) {
    GL45.glNamedBufferStorage(buffer, data, flags);
  }
  
  public static void glNamedBufferStorage(int buffer, IntBuffer data, int flags) { GL45.glNamedBufferStorage(buffer, data, flags); }
  ...
  public static void glNamedBufferData(int buffer, ByteBuffer data, int usage) { GL45.glNamedBufferData(buffer, data, usage); }
  
  public static void glNamedBufferData(int buffer, DoubleBuffer data, int usage) {
    GL45.glNamedBufferData(buffer, data, usage);
  }
  
  public static void glNamedBufferData(int buffer, FloatBuffer data, int usage) { GL45.glNamedBufferData(buffer, data, usage); }
  
  public static void glNamedBufferData(int buffer, IntBuffer data, int usage) {
    GL45.glNamedBufferData(buffer, data, usage);
  }
  
  public static void glNamedBufferData(int buffer, ShortBuffer data, int usage) { GL45.glNamedBufferData(buffer, data, usage); }
  ...
  public static void glNamedBufferSubData(int buffer, long offset, DoubleBuffer data) { GL45.glNamedBufferSubData(buffer, offset, data); }
  
  public static void glNamedBufferSubData(int buffer, long offset, FloatBuffer data) {
    GL45.glNamedBufferSubData(buffer, offset, data);
  }
  
  public static void glNamedBufferSubData(int buffer, long offset, IntBuffer data) { GL45.glNamedBufferSubData(buffer, offset, data); }
  ...
  public static void glGetNamedBufferSubData(int buffer, long offset, DoubleBuffer data) { GL45.glGetNamedBufferSubData(buffer, offset, data); }
  
  public static void glGetNamedBufferSubData(int buffer, long offset, FloatBuffer data) {
    GL45.glGetNamedBufferSubData(buffer, offset, data);
  }
  
  public static void glGetNamedBufferSubData(int buffer, long offset, IntBuffer data) { GL45.glGetNamedBufferSubData(buffer, offset, data); }
  ...
  public static void glTextureSubImage1D(int texture, int level, int xoffset, int width, int format, int type, DoubleBuffer pixels) { GL45.glTextureSubImage1D(texture, level, xoffset, width, format, type, pixels); }
  ...
  public static void glTextureSubImage1D(int texture, int level, int xoffset, int width, int format, int type, IntBuffer pixels) { GL45.glTextureSubImage1D(texture, level, xoffset, width, format, type, pixels); }
  ...
  public static void glTextureSubImage2D(int texture, int level, int xoffset, int yoffset, int width, int height, int format, int type, DoubleBuffer pixels) { GL45.glTextureSubImage2D(texture, level, xoffset, yoffset, width, height, format, type, pixels); }
  ...
  public static void glTextureSubImage2D(int texture, int level, int xoffset, int yoffset, int width, int height, int format, int type, IntBuffer pixels) { GL45.glTextureSubImage2D(texture, level, xoffset, yoffset, width, height, format, type, pixels); }
  ...
  public static void glTextureSubImage2D(int texture, int level, int xoffset, int yoffset, int width, int height, int format, int type, long pixels_buffer_offset) { GL45.glTextureSubImage2D(texture, level, xoffset, yoffset, width, height, format, type, pixels_buffer_offset); }
  ...
  public static void glTextureSubImage3D(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type, DoubleBuffer pixels) { GL45.glTextureSubImage3D(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels); }
  ...
  public static void glTextureSubImage3D(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type, IntBuffer pixels) { GL45.glTextureSubImage3D(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels); }
  ...
  public static void glCompressedTextureSubImage2D(int texture, int level, int xoffset, int yoffset, int width, int height, int format, int data_imageSize, long data_buffer_offset) { GL45.glCompressedTextureSubImage2D(texture, level, xoffset, yoffset, width, height, format, data_imageSize, data_buffer_offset); }
  ...
  public static void glGetTextureImage(int texture, int level, int format, int type, DoubleBuffer pixels) { GL45.glGetTextureImage(texture, level, format, type, pixels); }
  
  public static void glGetTextureImage(int texture, int level, int format, int type, FloatBuffer pixels) {
    GL45.glGetTextureImage(texture, level, format, type, pixels);
  }
  
  public static void glGetTextureImage(int texture, int level, int format, int type, IntBuffer pixels) { GL45.glGetTextureImage(texture, level, format, type, pixels); }
  ...
  public static void glGetCompressedTextureImage(int texture, int level, IntBuffer pixels) { GL45.glGetCompressedTextureImage(texture, level, pixels); }
