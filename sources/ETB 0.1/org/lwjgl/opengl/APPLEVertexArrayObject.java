...
public final class APPLEVertexArrayObject
{
  ...
  public static void glBindVertexArrayAPPLE(int array)
  {
    ...
    long function_pointer = glBindVertexArrayAPPLE;
  ...
  public static void glDeleteVertexArraysAPPLE(IntBuffer arrays) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glDeleteVertexArraysAPPLE;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGenVertexArraysAPPLE(IntBuffer arrays) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGenVertexArraysAPPLE;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(arrays);
  ...
  public static boolean glIsVertexArrayAPPLE(int array) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glIsVertexArrayAPPLE;
    BufferChecks.checkFunctionAddress(function_pointer);
