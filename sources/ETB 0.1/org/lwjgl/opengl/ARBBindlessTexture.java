...
public final class ARBBindlessTexture
{
  ...
  public static long glGetTextureHandleARB(int texture)
  {
    ...
    long function_pointer = glGetTextureHandleARB;
  ...
  public static long glGetTextureSamplerHandleARB(int texture, int sampler) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetTextureSamplerHandleARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMakeTextureHandleResidentARB(long handle) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMakeTextureHandleResidentARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMakeTextureHandleNonResidentARB(long handle) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMakeTextureHandleNonResidentARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static long glGetImageHandleARB(int texture, int level, boolean layered, int layer, int format) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetImageHandleARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMakeImageHandleResidentARB(long handle, int access) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMakeImageHandleResidentARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMakeImageHandleNonResidentARB(long handle) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMakeImageHandleNonResidentARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniformHandleui64ARB(int location, long value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniformHandleui64ARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniformHandleuARB(int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniformHandleui64vARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glProgramUniformHandleui64ARB(int program, int location, long value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniformHandleui64ARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glProgramUniformHandleuARB(int program, int location, LongBuffer values) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniformHandleui64vARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static boolean glIsTextureHandleResidentARB(long handle) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glIsTextureHandleResidentARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static boolean glIsImageHandleResidentARB(long handle) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glIsImageHandleResidentARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexAttribL1ui64ARB(int index, long x) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexAttribL1ui64ARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexAttribL1uARB(int index, LongBuffer v) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexAttribL1ui64vARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetVertexAttribLuARB(int index, int pname, LongBuffer params) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetVertexAttribLui64vARB;
    BufferChecks.checkFunctionAddress(function_pointer);
