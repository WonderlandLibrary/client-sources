...
public final class EXTTextureInteger
{
  ...
  public static void glClearColorIiEXT(int r, int g, int b, int a)
  {
    ...
    long function_pointer = glClearColorIiEXT;
  ...
  public static void glClearColorIuiEXT(int r, int g, int b, int a) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glClearColorIuiEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glTexParameterIEXT(int target, int pname, IntBuffer params) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glTexParameterIivEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glTexParameterIuEXT(int target, int pname, IntBuffer params) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glTexParameterIuivEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 4);
  ...
  public static void glGetTexParameterIEXT(int target, int pname, IntBuffer params) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetTexParameterIivEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 4);
  ...
  public static void glGetTexParameterIuEXT(int target, int pname, IntBuffer params) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetTexParameterIuivEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 4);
