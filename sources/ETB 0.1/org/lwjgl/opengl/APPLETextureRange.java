...
public final class APPLETextureRange
{
  ...
  public static void glTextureRangeAPPLE(int target, ByteBuffer pointer)
  {
    ...
    long function_pointer = glTextureRangeAPPLE;
  ...
  public static Buffer glGetTexParameterPointervAPPLE(int target, int pname, long result_size) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetTexParameterPointervAPPLE;
    BufferChecks.checkFunctionAddress(function_pointer);
