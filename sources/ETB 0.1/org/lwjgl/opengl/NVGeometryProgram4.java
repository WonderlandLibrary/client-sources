...
public final class NVGeometryProgram4
{
  ...
  public static void glProgramVertexLimitNV(int target, int limit)
  {
    ...
    long function_pointer = glProgramVertexLimitNV;
  ...
  public static void glFramebufferTextureEXT(int target, int attachment, int texture, int level) { EXTGeometryShader4.glFramebufferTextureEXT(target, attachment, texture, level); }
