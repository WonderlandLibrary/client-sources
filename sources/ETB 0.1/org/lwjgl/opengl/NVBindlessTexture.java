...
public final class NVBindlessTexture
{
  ...
  public static long glGetTextureHandleNV(int texture)
  {
    ...
    long function_pointer = glGetTextureHandleNV;
  ...
  public static long glGetTextureSamplerHandleNV(int texture, int sampler) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetTextureSamplerHandleNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMakeTextureHandleResidentNV(long handle) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMakeTextureHandleResidentNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMakeTextureHandleNonResidentNV(long handle) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMakeTextureHandleNonResidentNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static long glGetImageHandleNV(int texture, int level, boolean layered, int layer, int format) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetImageHandleNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMakeImageHandleResidentNV(long handle, int access) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMakeImageHandleResidentNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMakeImageHandleNonResidentNV(long handle) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMakeImageHandleNonResidentNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniformHandleui64NV(int location, long value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniformHandleui64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniformHandleuNV(int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniformHandleui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glProgramUniformHandleui64NV(int program, int location, long value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniformHandleui64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glProgramUniformHandleuNV(int program, int location, LongBuffer values) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniformHandleui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static boolean glIsTextureHandleResidentNV(long handle) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glIsTextureHandleResidentNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static boolean glIsImageHandleResidentNV(long handle) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glIsImageHandleResidentNV;
    BufferChecks.checkFunctionAddress(function_pointer);
