...
public class NVProgram
{
  ...
  public static void glLoadProgramNV(int target, int programID, ByteBuffer string)
  {
    ...
    long function_pointer = glLoadProgramNV;
  ...
  public static void glBindProgramNV(int target, int programID) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glBindProgramNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glDeleteProgramsNV(IntBuffer programs) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glDeleteProgramsNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGenProgramsNV(IntBuffer programs) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGenProgramsNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(programs);
  ...
  public static void glGetProgramNV(int programID, int parameterName, IntBuffer params) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetProgramivNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetProgramStringNV(int programID, int parameterName, ByteBuffer paramString) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetProgramStringNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static boolean glIsProgramNV(int programID) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glIsProgramNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static boolean glAreProgramsResidentNV(IntBuffer programIDs, ByteBuffer programResidences) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glAreProgramsResidentNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glRequestResidentProgramsNV(IntBuffer programIDs) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glRequestResidentProgramsNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(programIDs);
