...
public final class EXTGeometryShader4
{
  ...
  public static void glProgramParameteriEXT(int program, int pname, int value)
  {
    ...
    long function_pointer = glProgramParameteriEXT;
  ...
  public static void glFramebufferTextureEXT(int target, int attachment, int texture, int level) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glFramebufferTextureEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glFramebufferTextureLayerEXT(int target, int attachment, int texture, int level, int layer) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glFramebufferTextureLayerEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glFramebufferTextureFaceEXT(int target, int attachment, int texture, int level, int face) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glFramebufferTextureFaceEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
