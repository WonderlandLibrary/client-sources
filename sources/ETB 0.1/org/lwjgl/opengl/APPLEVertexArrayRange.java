...
public final class APPLEVertexArrayRange
{
  ...
  public static void glVertexArrayRangeAPPLE(ByteBuffer pointer)
  {
    ...
    long function_pointer = glVertexArrayRangeAPPLE;
  ...
  public static void glFlushVertexArrayRangeAPPLE(ByteBuffer pointer) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glFlushVertexArrayRangeAPPLE;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(pointer);
  ...
  public static void glVertexArrayParameteriAPPLE(int pname, int param) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexArrayParameteriAPPLE;
    BufferChecks.checkFunctionAddress(function_pointer);
