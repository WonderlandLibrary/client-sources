...
public final class ARBSparseTexture
{
  ...
  public static void glTexPageCommitmentARB(int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, boolean commit)
  {
    ...
    long function_pointer = glTexPageCommitmentARB;
  ...
  public static void glTexturePageCommitmentEXT(int texture, int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, boolean commit) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glTexturePageCommitmentEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
