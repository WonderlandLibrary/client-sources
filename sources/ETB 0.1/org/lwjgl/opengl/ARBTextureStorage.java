...
public final class ARBTextureStorage
{
  ...
  public static void glTextureStorage1DEXT(int texture, int target, int levels, int internalformat, int width) {
    ...
    long function_pointer = glTextureStorage1DEXT;
  ...
  public static void glTextureStorage2DEXT(int texture, int target, int levels, int internalformat, int width, int height) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glTextureStorage2DEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glTextureStorage3DEXT(int texture, int target, int levels, int internalformat, int width, int height, int depth) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glTextureStorage3DEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
