...
public final class NVVideoCapture
{
  ...
  public static void glBeginVideoCaptureNV(int video_capture_slot)
  {
    ...
    long function_pointer = glBeginVideoCaptureNV;
  ...
  public static void glBindVideoCaptureStreamBufferNV(int video_capture_slot, int stream, int frame_region, long offset) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glBindVideoCaptureStreamBufferNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glBindVideoCaptureStreamTextureNV(int video_capture_slot, int stream, int frame_region, int target, int texture) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glBindVideoCaptureStreamTextureNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glEndVideoCaptureNV(int video_capture_slot) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glEndVideoCaptureNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetVideoCaptureNV(int video_capture_slot, int pname, IntBuffer params) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetVideoCaptureivNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetVideoCaptureStreamNV(int video_capture_slot, int stream, int pname, IntBuffer params) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetVideoCaptureStreamivNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 1);
  ...
  public static void glGetVideoCaptureStreamNV(int video_capture_slot, int stream, int pname, FloatBuffer params) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetVideoCaptureStreamfvNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 1);
  ...
  public static void glGetVideoCaptureStreamNV(int video_capture_slot, int stream, int pname, DoubleBuffer params) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetVideoCaptureStreamdvNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 1);
  ...
  public static int glVideoCaptureNV(int video_capture_slot, IntBuffer sequence_num, LongBuffer capture_time) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVideoCaptureNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVideoCaptureStreamParameterNV(int video_capture_slot, int stream, int pname, IntBuffer params) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVideoCaptureStreamParameterivNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVideoCaptureStreamParameterNV(int video_capture_slot, int stream, int pname, FloatBuffer params) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVideoCaptureStreamParameterfvNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 16);
  ...
  public static void glVideoCaptureStreamParameterNV(int video_capture_slot, int stream, int pname, DoubleBuffer params) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVideoCaptureStreamParameterdvNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 16);
