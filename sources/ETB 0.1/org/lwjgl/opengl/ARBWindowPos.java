...
public final class ARBWindowPos
{
  ...
  public static void glWindowPos2fARB(float x, float y)
  {
    ...
    long function_pointer = glWindowPos2fARB;
  ...
  public static void glWindowPos2dARB(double x, double y) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glWindowPos2dARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glWindowPos2iARB(int x, int y) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glWindowPos2iARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glWindowPos2sARB(short x, short y) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glWindowPos2sARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glWindowPos3fARB(float x, float y, float z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glWindowPos3fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glWindowPos3dARB(double x, double y, double z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glWindowPos3dARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glWindowPos3iARB(int x, int y, int z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glWindowPos3iARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glWindowPos3sARB(short x, short y, short z) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glWindowPos3sARB;
    BufferChecks.checkFunctionAddress(function_pointer);
