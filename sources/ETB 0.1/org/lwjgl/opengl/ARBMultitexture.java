...
public final class ARBMultitexture
{
  ...
  public static void glClientActiveTextureARB(int texture)
  {
    ...
    long function_pointer = glClientActiveTextureARB;
  ...
  public static void glActiveTextureARB(int texture) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glActiveTextureARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord1fARB(int target, float s) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord1fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord1dARB(int target, double s) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord1dARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord1iARB(int target, int s) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord1iARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord1sARB(int target, short s) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord1sARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord2fARB(int target, float s, float t) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord2fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord2dARB(int target, double s, double t) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord2dARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord2iARB(int target, int s, int t) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord2iARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord2sARB(int target, short s, short t) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord2sARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord3fARB(int target, float s, float t, float r) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord3fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord3dARB(int target, double s, double t, double r) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord3dARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord3iARB(int target, int s, int t, int r) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord3iARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord3sARB(int target, short s, short t, short r) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord3sARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord4fARB(int target, float s, float t, float r, float q) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord4fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord4dARB(int target, double s, double t, double r, double q) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord4dARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord4iARB(int target, int s, int t, int r, int q) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord4iARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMultiTexCoord4sARB(int target, short s, short t, short r, short q) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMultiTexCoord4sARB;
    BufferChecks.checkFunctionAddress(function_pointer);
