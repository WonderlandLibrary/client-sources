...
public final class NVVertexBufferUnifiedMemory
{
  ...
  public static void glBufferAddressRangeNV(int pname, int index, long address, long length)
  {
    ...
    long function_pointer = glBufferAddressRangeNV;
  ...
  public static void glVertexFormatNV(int size, int type, int stride) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexFormatNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glNormalFormatNV(int type, int stride) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glNormalFormatNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glColorFormatNV(int size, int type, int stride) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glColorFormatNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glIndexFormatNV(int type, int stride) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glIndexFormatNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glTexCoordFormatNV(int size, int type, int stride) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glTexCoordFormatNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glEdgeFlagFormatNV(int stride) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glEdgeFlagFormatNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glSecondaryColorFormatNV(int size, int type, int stride) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glSecondaryColorFormatNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glFogCoordFormatNV(int type, int stride) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glFogCoordFormatNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexAttribFormatNV(int index, int size, int type, boolean normalized, int stride) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexAttribFormatNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glVertexAttribIFormatNV(int index, int size, int type, int stride) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glVertexAttribIFormatNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetIntegeruNV(int value, int index, LongBuffer result) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetIntegerui64i_vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
