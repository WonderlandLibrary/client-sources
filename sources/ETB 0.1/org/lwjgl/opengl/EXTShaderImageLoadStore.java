...
public final class EXTShaderImageLoadStore
{
  ...
  public static void glBindImageTextureEXT(int index, int texture, int level, boolean layered, int layer, int access, int format)
  {
    ...
    long function_pointer = glBindImageTextureEXT;
  ...
  public static void glMemoryBarrierEXT(int barriers) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMemoryBarrierEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
