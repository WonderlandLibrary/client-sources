...
public final class EXTBindableUniform
{
  ...
  public static void glUniformBufferEXT(int program, int location, int buffer)
  {
    ...
    long function_pointer = glUniformBufferEXT;
  ...
  public static int glGetUniformBufferSizeEXT(int program, int location) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetUniformBufferSizeEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static long glGetUniformOffsetEXT(int program, int location) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetUniformOffsetEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
