...
public final class NVOcclusionQuery
{
  ...
  public static void glGenOcclusionQueriesNV(IntBuffer piIDs)
  {
    ...
    long function_pointer = glGenOcclusionQueriesNV;
  ...
  public static void glDeleteOcclusionQueriesNV(IntBuffer piIDs) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glDeleteOcclusionQueriesNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(piIDs);
  ...
  public static boolean glIsOcclusionQueryNV(int id) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glIsOcclusionQueryNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glBeginOcclusionQueryNV(int id) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glBeginOcclusionQueryNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glEndOcclusionQueryNV() { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glEndOcclusionQueryNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetOcclusionQueryuNV(int id, int pname, IntBuffer params) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetOcclusionQueryuivNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetOcclusionQueryNV(int id, int pname, IntBuffer params) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetOcclusionQueryivNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 1);
