...
public final class AMDDebugOutput
{
  ...
  public static void glDebugMessageEnableAMD(int category, int severity, IntBuffer ids, boolean enabled)
  {
    ...
    long function_pointer = glDebugMessageEnableAMD;
  ...
  public static void glDebugMessageInsertAMD(int category, int severity, int id, ByteBuffer buf) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glDebugMessageInsertAMD;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glDebugMessageCallbackAMD;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static int glGetDebugMessageLogAMD(int count, IntBuffer categories, IntBuffer severities, IntBuffer ids, IntBuffer lengths, ByteBuffer messageLog) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetDebugMessageLogAMD;
    BufferChecks.checkFunctionAddress(function_pointer);
    if (categories != null)
