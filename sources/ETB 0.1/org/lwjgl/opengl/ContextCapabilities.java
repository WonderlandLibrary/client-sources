...
public class ContextCapabilities
{
  ...
  {
    return ((this.glBufferStorage = GLContext.getFunctionAddress("glBufferStorage")) != 0L ? 1 : 0) & ((!supported_extensions.contains("GL_EXT_direct_state_access")) || ((this.glNamedBufferStorageEXT = GLContext.getFunctionAddress("glNamedBufferStorageEXT")) != 0L) ? 1 : 0);
  }
  ...
  {
    return ((this.glTexPageCommitmentARB = GLContext.getFunctionAddress("glTexPageCommitmentARB")) != 0L ? 1 : 0) & ((!supported_extensions.contains("GL_EXT_direct_state_access")) || ((this.glTexturePageCommitmentEXT = GLContext.getFunctionAddress("glTexturePageCommitmentEXT")) != 0L) ? 1 : 0);
  }
  ...
  {
    return ((this.glTexBufferRange = GLContext.getFunctionAddress("glTexBufferRange")) != 0L ? 1 : 0) & ((!supported_extensions.contains("GL_EXT_direct_state_access")) || ((this.glTextureBufferRangeEXT = GLContext.getFunctionAddress("glTextureBufferRangeEXT")) != 0L) ? 1 : 0);
  }
  ...
  ContextCapabilities(boolean forwardCompatible) throws LWJGLException
  {
    ...
    GL_AMD_blend_minmax_factor = supported_extensions.contains("GL_AMD_blend_minmax_factor");
    GL_AMD_conservative_depth = supported_extensions.contains("GL_AMD_conservative_depth");
    GL_AMD_debug_output = ((supported_extensions.contains("GL_AMD_debug_output")) || (supported_extensions.contains("GL_AMDX_debug_output")));
    
    GL_AMD_depth_clamp_separate = supported_extensions.contains("GL_AMD_depth_clamp_separate");
    GL_AMD_draw_buffers_blend = supported_extensions.contains("GL_AMD_draw_buffers_blend");
    GL_AMD_interleaved_elements = supported_extensions.contains("GL_AMD_interleaved_elements");
    GL_AMD_multi_draw_indirect = supported_extensions.contains("GL_AMD_multi_draw_indirect");
    GL_AMD_name_gen_delete = supported_extensions.contains("GL_AMD_name_gen_delete");
    GL_AMD_performance_monitor = supported_extensions.contains("GL_AMD_performance_monitor");
    GL_AMD_pinned_memory = supported_extensions.contains("GL_AMD_pinned_memory");
    GL_AMD_query_buffer_object = supported_extensions.contains("GL_AMD_query_buffer_object");
    GL_AMD_sample_positions = supported_extensions.contains("GL_AMD_sample_positions");
    GL_AMD_seamless_cubemap_per_texture = supported_extensions.contains("GL_AMD_seamless_cubemap_per_texture");
    GL_AMD_shader_atomic_counter_ops = supported_extensions.contains("GL_AMD_shader_atomic_counter_ops");
    GL_AMD_shader_stencil_export = supported_extensions.contains("GL_AMD_shader_stencil_export");
    GL_AMD_shader_trinary_minmax = supported_extensions.contains("GL_AMD_shader_trinary_minmax");
    GL_AMD_sparse_texture = supported_extensions.contains("GL_AMD_sparse_texture");
    GL_AMD_stencil_operation_extended = supported_extensions.contains("GL_AMD_stencil_operation_extended");
    GL_AMD_texture_texture4 = supported_extensions.contains("GL_AMD_texture_texture4");
    GL_AMD_transform_feedback3_lines_triangles = supported_extensions.contains("GL_AMD_transform_feedback3_lines_triangles");
    GL_AMD_vertex_shader_layer = supported_extensions.contains("GL_AMD_vertex_shader_layer");
    GL_AMD_vertex_shader_tessellator = supported_extensions.contains("GL_AMD_vertex_shader_tessellator");
    GL_AMD_vertex_shader_viewport_index = supported_extensions.contains("GL_AMD_vertex_shader_viewport_index");
    GL_APPLE_aux_depth_stencil = supported_extensions.contains("GL_APPLE_aux_depth_stencil");
    GL_APPLE_client_storage = supported_extensions.contains("GL_APPLE_client_storage");
    GL_APPLE_element_array = supported_extensions.contains("GL_APPLE_element_array");
    GL_APPLE_fence = supported_extensions.contains("GL_APPLE_fence");
    GL_APPLE_float_pixels = supported_extensions.contains("GL_APPLE_float_pixels");
    GL_APPLE_flush_buffer_range = supported_extensions.contains("GL_APPLE_flush_buffer_range");
    GL_APPLE_object_purgeable = supported_extensions.contains("GL_APPLE_object_purgeable");
    GL_APPLE_packed_pixels = supported_extensions.contains("GL_APPLE_packed_pixels");
    GL_APPLE_rgb_422 = supported_extensions.contains("GL_APPLE_rgb_422");
    GL_APPLE_row_bytes = supported_extensions.contains("GL_APPLE_row_bytes");
    GL_APPLE_texture_range = supported_extensions.contains("GL_APPLE_texture_range");
    GL_APPLE_vertex_array_object = supported_extensions.contains("GL_APPLE_vertex_array_object");
    GL_APPLE_vertex_array_range = supported_extensions.contains("GL_APPLE_vertex_array_range");
    GL_APPLE_vertex_program_evaluators = supported_extensions.contains("GL_APPLE_vertex_program_evaluators");
    GL_APPLE_ycbcr_422 = supported_extensions.contains("GL_APPLE_ycbcr_422");
    GL_ARB_ES2_compatibility = supported_extensions.contains("GL_ARB_ES2_compatibility");
    GL_ARB_ES3_1_compatibility = supported_extensions.contains("GL_ARB_ES3_1_compatibility");
    GL_ARB_ES3_compatibility = supported_extensions.contains("GL_ARB_ES3_compatibility");
    GL_ARB_arrays_of_arrays = supported_extensions.contains("GL_ARB_arrays_of_arrays");
    GL_ARB_base_instance = supported_extensions.contains("GL_ARB_base_instance");
    GL_ARB_bindless_texture = supported_extensions.contains("GL_ARB_bindless_texture");
    GL_ARB_blend_func_extended = supported_extensions.contains("GL_ARB_blend_func_extended");
    GL_ARB_buffer_storage = supported_extensions.contains("GL_ARB_buffer_storage");
    GL_ARB_cl_event = supported_extensions.contains("GL_ARB_cl_event");
    GL_ARB_clear_buffer_object = supported_extensions.contains("GL_ARB_clear_buffer_object");
    GL_ARB_clear_texture = supported_extensions.contains("GL_ARB_clear_texture");
    GL_ARB_clip_control = supported_extensions.contains("GL_ARB_clip_control");
    GL_ARB_color_buffer_float = supported_extensions.contains("GL_ARB_color_buffer_float");
    GL_ARB_compatibility = supported_extensions.contains("GL_ARB_compatibility");
    GL_ARB_compressed_texture_pixel_storage = supported_extensions.contains("GL_ARB_compressed_texture_pixel_storage");
    GL_ARB_compute_shader = supported_extensions.contains("GL_ARB_compute_shader");
    GL_ARB_compute_variable_group_size = supported_extensions.contains("GL_ARB_compute_variable_group_size");
    GL_ARB_conditional_render_inverted = supported_extensions.contains("GL_ARB_conditional_render_inverted");
    GL_ARB_conservative_depth = supported_extensions.contains("GL_ARB_conservative_depth");
    GL_ARB_copy_buffer = supported_extensions.contains("GL_ARB_copy_buffer");
    GL_ARB_copy_image = supported_extensions.contains("GL_ARB_copy_image");
    GL_ARB_cull_distance = supported_extensions.contains("GL_ARB_cull_distance");
    GL_ARB_debug_output = supported_extensions.contains("GL_ARB_debug_output");
    GL_ARB_depth_buffer_float = supported_extensions.contains("GL_ARB_depth_buffer_float");
    GL_ARB_depth_clamp = supported_extensions.contains("GL_ARB_depth_clamp");
    GL_ARB_depth_texture = supported_extensions.contains("GL_ARB_depth_texture");
    GL_ARB_derivative_control = supported_extensions.contains("GL_ARB_derivative_control");
    GL_ARB_direct_state_access = supported_extensions.contains("GL_ARB_direct_state_access");
    GL_ARB_draw_buffers = supported_extensions.contains("GL_ARB_draw_buffers");
    GL_ARB_draw_buffers_blend = supported_extensions.contains("GL_ARB_draw_buffers_blend");
    GL_ARB_draw_elements_base_vertex = supported_extensions.contains("GL_ARB_draw_elements_base_vertex");
    GL_ARB_draw_indirect = supported_extensions.contains("GL_ARB_draw_indirect");
    GL_ARB_draw_instanced = supported_extensions.contains("GL_ARB_draw_instanced");
    GL_ARB_enhanced_layouts = supported_extensions.contains("GL_ARB_enhanced_layouts");
    GL_ARB_explicit_attrib_location = supported_extensions.contains("GL_ARB_explicit_attrib_location");
    GL_ARB_explicit_uniform_location = supported_extensions.contains("GL_ARB_explicit_uniform_location");
    GL_ARB_fragment_coord_conventions = supported_extensions.contains("GL_ARB_fragment_coord_conventions");
    GL_ARB_fragment_layer_viewport = supported_extensions.contains("GL_ARB_fragment_layer_viewport");
    GL_ARB_fragment_program = ((supported_extensions.contains("GL_ARB_fragment_program")) && (supported_extensions.contains("GL_ARB_program")));
    
    GL_ARB_fragment_program_shadow = supported_extensions.contains("GL_ARB_fragment_program_shadow");
    GL_ARB_fragment_shader = supported_extensions.contains("GL_ARB_fragment_shader");
    GL_ARB_framebuffer_no_attachments = supported_extensions.contains("GL_ARB_framebuffer_no_attachments");
    GL_ARB_framebuffer_object = supported_extensions.contains("GL_ARB_framebuffer_object");
    GL_ARB_framebuffer_sRGB = supported_extensions.contains("GL_ARB_framebuffer_sRGB");
    GL_ARB_geometry_shader4 = supported_extensions.contains("GL_ARB_geometry_shader4");
    GL_ARB_get_program_binary = supported_extensions.contains("GL_ARB_get_program_binary");
    GL_ARB_get_texture_sub_image = supported_extensions.contains("GL_ARB_get_texture_sub_image");
    GL_ARB_gpu_shader5 = supported_extensions.contains("GL_ARB_gpu_shader5");
    GL_ARB_gpu_shader_fp64 = supported_extensions.contains("GL_ARB_gpu_shader_fp64");
    GL_ARB_half_float_pixel = supported_extensions.contains("GL_ARB_half_float_pixel");
    GL_ARB_half_float_vertex = supported_extensions.contains("GL_ARB_half_float_vertex");
    GL_ARB_imaging = supported_extensions.contains("GL_ARB_imaging");
    GL_ARB_indirect_parameters = supported_extensions.contains("GL_ARB_indirect_parameters");
    GL_ARB_instanced_arrays = supported_extensions.contains("GL_ARB_instanced_arrays");
    GL_ARB_internalformat_query = supported_extensions.contains("GL_ARB_internalformat_query");
    GL_ARB_internalformat_query2 = supported_extensions.contains("GL_ARB_internalformat_query2");
    GL_ARB_invalidate_subdata = supported_extensions.contains("GL_ARB_invalidate_subdata");
    GL_ARB_map_buffer_alignment = supported_extensions.contains("GL_ARB_map_buffer_alignment");
    GL_ARB_map_buffer_range = supported_extensions.contains("GL_ARB_map_buffer_range");
    GL_ARB_matrix_palette = supported_extensions.contains("GL_ARB_matrix_palette");
    GL_ARB_multi_bind = supported_extensions.contains("GL_ARB_multi_bind");
    GL_ARB_multi_draw_indirect = supported_extensions.contains("GL_ARB_multi_draw_indirect");
    GL_ARB_multisample = supported_extensions.contains("GL_ARB_multisample");
    GL_ARB_multitexture = supported_extensions.contains("GL_ARB_multitexture");
    GL_ARB_occlusion_query = supported_extensions.contains("GL_ARB_occlusion_query");
    GL_ARB_occlusion_query2 = supported_extensions.contains("GL_ARB_occlusion_query2");
    GL_ARB_pipeline_statistics_query = supported_extensions.contains("GL_ARB_pipeline_statistics_query");
    GL_ARB_pixel_buffer_object = ((supported_extensions.contains("GL_ARB_pixel_buffer_object")) && (supported_extensions.contains("GL_ARB_buffer_object")));
    
    GL_ARB_point_parameters = supported_extensions.contains("GL_ARB_point_parameters");
    GL_ARB_point_sprite = supported_extensions.contains("GL_ARB_point_sprite");
    GL_ARB_program_interface_query = supported_extensions.contains("GL_ARB_program_interface_query");
    GL_ARB_provoking_vertex = supported_extensions.contains("GL_ARB_provoking_vertex");
    GL_ARB_query_buffer_object = supported_extensions.contains("GL_ARB_query_buffer_object");
    GL_ARB_robust_buffer_access_behavior = supported_extensions.contains("GL_ARB_robust_buffer_access_behavior");
    GL_ARB_robustness = supported_extensions.contains("GL_ARB_robustness");
    GL_ARB_robustness_isolation = supported_extensions.contains("GL_ARB_robustness_isolation");
    GL_ARB_sample_shading = supported_extensions.contains("GL_ARB_sample_shading");
    GL_ARB_sampler_objects = supported_extensions.contains("GL_ARB_sampler_objects");
    GL_ARB_seamless_cube_map = supported_extensions.contains("GL_ARB_seamless_cube_map");
    GL_ARB_seamless_cubemap_per_texture = supported_extensions.contains("GL_ARB_seamless_cubemap_per_texture");
    GL_ARB_separate_shader_objects = supported_extensions.contains("GL_ARB_separate_shader_objects");
    GL_ARB_shader_atomic_counters = supported_extensions.contains("GL_ARB_shader_atomic_counters");
    GL_ARB_shader_bit_encoding = supported_extensions.contains("GL_ARB_shader_bit_encoding");
    GL_ARB_shader_draw_parameters = supported_extensions.contains("GL_ARB_shader_draw_parameters");
    GL_ARB_shader_group_vote = supported_extensions.contains("GL_ARB_shader_group_vote");
    GL_ARB_shader_image_load_store = supported_extensions.contains("GL_ARB_shader_image_load_store");
    GL_ARB_shader_image_size = supported_extensions.contains("GL_ARB_shader_image_size");
    GL_ARB_shader_objects = supported_extensions.contains("GL_ARB_shader_objects");
    GL_ARB_shader_precision = supported_extensions.contains("GL_ARB_shader_precision");
    GL_ARB_shader_stencil_export = supported_extensions.contains("GL_ARB_shader_stencil_export");
    GL_ARB_shader_storage_buffer_object = supported_extensions.contains("GL_ARB_shader_storage_buffer_object");
    GL_ARB_shader_subroutine = supported_extensions.contains("GL_ARB_shader_subroutine");
    GL_ARB_shader_texture_image_samples = supported_extensions.contains("GL_ARB_shader_texture_image_samples");
    GL_ARB_shader_texture_lod = supported_extensions.contains("GL_ARB_shader_texture_lod");
    GL_ARB_shading_language_100 = supported_extensions.contains("GL_ARB_shading_language_100");
    GL_ARB_shading_language_420pack = supported_extensions.contains("GL_ARB_shading_language_420pack");
    GL_ARB_shading_language_include = supported_extensions.contains("GL_ARB_shading_language_include");
    GL_ARB_shading_language_packing = supported_extensions.contains("GL_ARB_shading_language_packing");
    GL_ARB_shadow = supported_extensions.contains("GL_ARB_shadow");
    GL_ARB_shadow_ambient = supported_extensions.contains("GL_ARB_shadow_ambient");
    GL_ARB_sparse_buffer = supported_extensions.contains("GL_ARB_sparse_buffer");
    GL_ARB_sparse_texture = supported_extensions.contains("GL_ARB_sparse_texture");
    GL_ARB_stencil_texturing = supported_extensions.contains("GL_ARB_stencil_texturing");
    GL_ARB_sync = supported_extensions.contains("GL_ARB_sync");
    GL_ARB_tessellation_shader = supported_extensions.contains("GL_ARB_tessellation_shader");
    GL_ARB_texture_barrier = supported_extensions.contains("GL_ARB_texture_barrier");
    GL_ARB_texture_border_clamp = supported_extensions.contains("GL_ARB_texture_border_clamp");
    GL_ARB_texture_buffer_object = supported_extensions.contains("GL_ARB_texture_buffer_object");
    GL_ARB_texture_buffer_object_rgb32 = ((supported_extensions.contains("GL_ARB_texture_buffer_object_rgb32")) || (supported_extensions.contains("GL_EXT_texture_buffer_object_rgb32")));
    
    GL_ARB_texture_buffer_range = supported_extensions.contains("GL_ARB_texture_buffer_range");
    GL_ARB_texture_compression = supported_extensions.contains("GL_ARB_texture_compression");
    GL_ARB_texture_compression_bptc = ((supported_extensions.contains("GL_ARB_texture_compression_bptc")) || (supported_extensions.contains("GL_EXT_texture_compression_bptc")));
    
    GL_ARB_texture_compression_rgtc = supported_extensions.contains("GL_ARB_texture_compression_rgtc");
    GL_ARB_texture_cube_map = supported_extensions.contains("GL_ARB_texture_cube_map");
    GL_ARB_texture_cube_map_array = supported_extensions.contains("GL_ARB_texture_cube_map_array");
    GL_ARB_texture_env_add = supported_extensions.contains("GL_ARB_texture_env_add");
    GL_ARB_texture_env_combine = supported_extensions.contains("GL_ARB_texture_env_combine");
    GL_ARB_texture_env_crossbar = supported_extensions.contains("GL_ARB_texture_env_crossbar");
    GL_ARB_texture_env_dot3 = supported_extensions.contains("GL_ARB_texture_env_dot3");
    GL_ARB_texture_float = supported_extensions.contains("GL_ARB_texture_float");
    GL_ARB_texture_gather = supported_extensions.contains("GL_ARB_texture_gather");
    GL_ARB_texture_mirror_clamp_to_edge = supported_extensions.contains("GL_ARB_texture_mirror_clamp_to_edge");
    GL_ARB_texture_mirrored_repeat = supported_extensions.contains("GL_ARB_texture_mirrored_repeat");
    GL_ARB_texture_multisample = supported_extensions.contains("GL_ARB_texture_multisample");
    GL_ARB_texture_non_power_of_two = supported_extensions.contains("GL_ARB_texture_non_power_of_two");
    GL_ARB_texture_query_levels = supported_extensions.contains("GL_ARB_texture_query_levels");
    GL_ARB_texture_query_lod = supported_extensions.contains("GL_ARB_texture_query_lod");
    GL_ARB_texture_rectangle = supported_extensions.contains("GL_ARB_texture_rectangle");
    GL_ARB_texture_rg = supported_extensions.contains("GL_ARB_texture_rg");
    GL_ARB_texture_rgb10_a2ui = supported_extensions.contains("GL_ARB_texture_rgb10_a2ui");
    GL_ARB_texture_stencil8 = supported_extensions.contains("GL_ARB_texture_stencil8");
    GL_ARB_texture_storage = ((supported_extensions.contains("GL_ARB_texture_storage")) || (supported_extensions.contains("GL_EXT_texture_storage")));
    
    GL_ARB_texture_storage_multisample = supported_extensions.contains("GL_ARB_texture_storage_multisample");
    GL_ARB_texture_swizzle = supported_extensions.contains("GL_ARB_texture_swizzle");
    GL_ARB_texture_view = supported_extensions.contains("GL_ARB_texture_view");
    GL_ARB_timer_query = supported_extensions.contains("GL_ARB_timer_query");
    GL_ARB_transform_feedback2 = supported_extensions.contains("GL_ARB_transform_feedback2");
    GL_ARB_transform_feedback3 = supported_extensions.contains("GL_ARB_transform_feedback3");
    GL_ARB_transform_feedback_instanced = supported_extensions.contains("GL_ARB_transform_feedback_instanced");
    GL_ARB_transform_feedback_overflow_query = supported_extensions.contains("GL_ARB_transform_feedback_overflow_query");
    GL_ARB_transpose_matrix = supported_extensions.contains("GL_ARB_transpose_matrix");
    GL_ARB_uniform_buffer_object = supported_extensions.contains("GL_ARB_uniform_buffer_object");
    GL_ARB_vertex_array_bgra = supported_extensions.contains("GL_ARB_vertex_array_bgra");
    GL_ARB_vertex_array_object = supported_extensions.contains("GL_ARB_vertex_array_object");
    GL_ARB_vertex_attrib_64bit = supported_extensions.contains("GL_ARB_vertex_attrib_64bit");
    GL_ARB_vertex_attrib_binding = supported_extensions.contains("GL_ARB_vertex_attrib_binding");
    GL_ARB_vertex_blend = supported_extensions.contains("GL_ARB_vertex_blend");
    GL_ARB_vertex_buffer_object = ((supported_extensions.contains("GL_ARB_vertex_buffer_object")) && (supported_extensions.contains("GL_ARB_buffer_object")));
    
    GL_ARB_vertex_program = ((supported_extensions.contains("GL_ARB_vertex_program")) && (supported_extensions.contains("GL_ARB_program")));
    
    GL_ARB_vertex_shader = supported_extensions.contains("GL_ARB_vertex_shader");
    GL_ARB_vertex_type_10f_11f_11f_rev = supported_extensions.contains("GL_ARB_vertex_type_10f_11f_11f_rev");
    GL_ARB_vertex_type_2_10_10_10_rev = supported_extensions.contains("GL_ARB_vertex_type_2_10_10_10_rev");
    GL_ARB_viewport_array = supported_extensions.contains("GL_ARB_viewport_array");
    GL_ARB_window_pos = supported_extensions.contains("GL_ARB_window_pos");
    GL_ATI_draw_buffers = supported_extensions.contains("GL_ATI_draw_buffers");
    GL_ATI_element_array = supported_extensions.contains("GL_ATI_element_array");
    GL_ATI_envmap_bumpmap = supported_extensions.contains("GL_ATI_envmap_bumpmap");
    GL_ATI_fragment_shader = supported_extensions.contains("GL_ATI_fragment_shader");
    GL_ATI_map_object_buffer = supported_extensions.contains("GL_ATI_map_object_buffer");
    GL_ATI_meminfo = supported_extensions.contains("GL_ATI_meminfo");
    GL_ATI_pn_triangles = supported_extensions.contains("GL_ATI_pn_triangles");
    GL_ATI_separate_stencil = supported_extensions.contains("GL_ATI_separate_stencil");
    GL_ATI_shader_texture_lod = supported_extensions.contains("GL_ATI_shader_texture_lod");
    ...
    GL_ATI_texture_env_combine3 = supported_extensions.contains("GL_ATI_texture_env_combine3");
    GL_ATI_texture_float = supported_extensions.contains("GL_ATI_texture_float");
    GL_ATI_texture_mirror_once = supported_extensions.contains("GL_ATI_texture_mirror_once");
    GL_ATI_vertex_array_object = supported_extensions.contains("GL_ATI_vertex_array_object");
    GL_ATI_vertex_attrib_array_object = supported_extensions.contains("GL_ATI_vertex_attrib_array_object");
    GL_ATI_vertex_streams = supported_extensions.contains("GL_ATI_vertex_streams");
    GL_EXT_Cg_shader = supported_extensions.contains("GL_EXT_Cg_shader");
    GL_EXT_abgr = supported_extensions.contains("GL_EXT_abgr");
    GL_EXT_bgra = supported_extensions.contains("GL_EXT_bgra");
    GL_EXT_bindable_uniform = supported_extensions.contains("GL_EXT_bindable_uniform");
    GL_EXT_blend_color = supported_extensions.contains("GL_EXT_blend_color");
    GL_EXT_blend_equation_separate = supported_extensions.contains("GL_EXT_blend_equation_separate");
    GL_EXT_blend_func_separate = supported_extensions.contains("GL_EXT_blend_func_separate");
    GL_EXT_blend_minmax = supported_extensions.contains("GL_EXT_blend_minmax");
    GL_EXT_blend_subtract = supported_extensions.contains("GL_EXT_blend_subtract");
    GL_EXT_compiled_vertex_array = supported_extensions.contains("GL_EXT_compiled_vertex_array");
    GL_EXT_depth_bounds_test = supported_extensions.contains("GL_EXT_depth_bounds_test");
    GL_EXT_direct_state_access = supported_extensions.contains("GL_EXT_direct_state_access");
    GL_EXT_draw_buffers2 = supported_extensions.contains("GL_EXT_draw_buffers2");
    GL_EXT_draw_instanced = supported_extensions.contains("GL_EXT_draw_instanced");
    GL_EXT_draw_range_elements = supported_extensions.contains("GL_EXT_draw_range_elements");
    GL_EXT_fog_coord = supported_extensions.contains("GL_EXT_fog_coord");
    GL_EXT_framebuffer_blit = supported_extensions.contains("GL_EXT_framebuffer_blit");
    GL_EXT_framebuffer_multisample = supported_extensions.contains("GL_EXT_framebuffer_multisample");
    GL_EXT_framebuffer_multisample_blit_scaled = supported_extensions.contains("GL_EXT_framebuffer_multisample_blit_scaled");
    GL_EXT_framebuffer_object = supported_extensions.contains("GL_EXT_framebuffer_object");
    GL_EXT_framebuffer_sRGB = supported_extensions.contains("GL_EXT_framebuffer_sRGB");
    GL_EXT_geometry_shader4 = supported_extensions.contains("GL_EXT_geometry_shader4");
    GL_EXT_gpu_program_parameters = supported_extensions.contains("GL_EXT_gpu_program_parameters");
    GL_EXT_gpu_shader4 = supported_extensions.contains("GL_EXT_gpu_shader4");
    GL_EXT_multi_draw_arrays = supported_extensions.contains("GL_EXT_multi_draw_arrays");
    GL_EXT_packed_depth_stencil = supported_extensions.contains("GL_EXT_packed_depth_stencil");
    GL_EXT_packed_float = supported_extensions.contains("GL_EXT_packed_float");
    GL_EXT_packed_pixels = supported_extensions.contains("GL_EXT_packed_pixels");
    GL_EXT_paletted_texture = supported_extensions.contains("GL_EXT_paletted_texture");
    GL_EXT_pixel_buffer_object = ((supported_extensions.contains("GL_EXT_pixel_buffer_object")) && (supported_extensions.contains("GL_ARB_buffer_object")));
    
    GL_EXT_point_parameters = supported_extensions.contains("GL_EXT_point_parameters");
    GL_EXT_provoking_vertex = supported_extensions.contains("GL_EXT_provoking_vertex");
    GL_EXT_rescale_normal = supported_extensions.contains("GL_EXT_rescale_normal");
    GL_EXT_secondary_color = supported_extensions.contains("GL_EXT_secondary_color");
    GL_EXT_separate_shader_objects = supported_extensions.contains("GL_EXT_separate_shader_objects");
    GL_EXT_separate_specular_color = supported_extensions.contains("GL_EXT_separate_specular_color");
    GL_EXT_shader_image_load_store = supported_extensions.contains("GL_EXT_shader_image_load_store");
    GL_EXT_shadow_funcs = supported_extensions.contains("GL_EXT_shadow_funcs");
    GL_EXT_shared_texture_palette = supported_extensions.contains("GL_EXT_shared_texture_palette");
    GL_EXT_stencil_clear_tag = supported_extensions.contains("GL_EXT_stencil_clear_tag");
    GL_EXT_stencil_two_side = supported_extensions.contains("GL_EXT_stencil_two_side");
    GL_EXT_stencil_wrap = supported_extensions.contains("GL_EXT_stencil_wrap");
    GL_EXT_texture_3d = supported_extensions.contains("GL_EXT_texture_3d");
    GL_EXT_texture_array = supported_extensions.contains("GL_EXT_texture_array");
    GL_EXT_texture_buffer_object = supported_extensions.contains("GL_EXT_texture_buffer_object");
    GL_EXT_texture_compression_latc = supported_extensions.contains("GL_EXT_texture_compression_latc");
    GL_EXT_texture_compression_rgtc = supported_extensions.contains("GL_EXT_texture_compression_rgtc");
    GL_EXT_texture_compression_s3tc = supported_extensions.contains("GL_EXT_texture_compression_s3tc");
    GL_EXT_texture_env_combine = supported_extensions.contains("GL_EXT_texture_env_combine");
    GL_EXT_texture_env_dot3 = supported_extensions.contains("GL_EXT_texture_env_dot3");
    GL_EXT_texture_filter_anisotropic = supported_extensions.contains("GL_EXT_texture_filter_anisotropic");
    GL_EXT_texture_integer = supported_extensions.contains("GL_EXT_texture_integer");
    GL_EXT_texture_lod_bias = supported_extensions.contains("GL_EXT_texture_lod_bias");
    GL_EXT_texture_mirror_clamp = supported_extensions.contains("GL_EXT_texture_mirror_clamp");
    GL_EXT_texture_rectangle = supported_extensions.contains("GL_EXT_texture_rectangle");
    GL_EXT_texture_sRGB = supported_extensions.contains("GL_EXT_texture_sRGB");
    GL_EXT_texture_sRGB_decode = supported_extensions.contains("GL_EXT_texture_sRGB_decode");
    GL_EXT_texture_shared_exponent = supported_extensions.contains("GL_EXT_texture_shared_exponent");
    GL_EXT_texture_snorm = supported_extensions.contains("GL_EXT_texture_snorm");
    GL_EXT_texture_swizzle = supported_extensions.contains("GL_EXT_texture_swizzle");
    GL_EXT_timer_query = supported_extensions.contains("GL_EXT_timer_query");
    GL_EXT_transform_feedback = supported_extensions.contains("GL_EXT_transform_feedback");
    GL_EXT_vertex_array_bgra = supported_extensions.contains("GL_EXT_vertex_array_bgra");
    GL_EXT_vertex_attrib_64bit = supported_extensions.contains("GL_EXT_vertex_attrib_64bit");
    GL_EXT_vertex_shader = supported_extensions.contains("GL_EXT_vertex_shader");
    GL_EXT_vertex_weighting = supported_extensions.contains("GL_EXT_vertex_weighting");
    OpenGL11 = supported_extensions.contains("OpenGL11");
    OpenGL12 = supported_extensions.contains("OpenGL12");
    OpenGL13 = supported_extensions.contains("OpenGL13");
    OpenGL14 = supported_extensions.contains("OpenGL14");
    OpenGL15 = supported_extensions.contains("OpenGL15");
    OpenGL20 = supported_extensions.contains("OpenGL20");
    OpenGL21 = supported_extensions.contains("OpenGL21");
    OpenGL30 = supported_extensions.contains("OpenGL30");
    OpenGL31 = supported_extensions.contains("OpenGL31");
    OpenGL32 = supported_extensions.contains("OpenGL32");
    OpenGL33 = supported_extensions.contains("OpenGL33");
    OpenGL40 = supported_extensions.contains("OpenGL40");
    OpenGL41 = supported_extensions.contains("OpenGL41");
    OpenGL42 = supported_extensions.contains("OpenGL42");
    OpenGL43 = supported_extensions.contains("OpenGL43");
    OpenGL44 = supported_extensions.contains("OpenGL44");
    OpenGL45 = supported_extensions.contains("OpenGL45");
    GL_GREMEDY_frame_terminator = supported_extensions.contains("GL_GREMEDY_frame_terminator");
    GL_GREMEDY_string_marker = supported_extensions.contains("GL_GREMEDY_string_marker");
    GL_HP_occlusion_test = supported_extensions.contains("GL_HP_occlusion_test");
    GL_IBM_rasterpos_clip = supported_extensions.contains("GL_IBM_rasterpos_clip");
    GL_INTEL_map_texture = supported_extensions.contains("GL_INTEL_map_texture");
    GL_KHR_context_flush_control = supported_extensions.contains("GL_KHR_context_flush_control");
    GL_KHR_debug = supported_extensions.contains("GL_KHR_debug");
    GL_KHR_robust_buffer_access_behavior = supported_extensions.contains("GL_KHR_robust_buffer_access_behavior");
    GL_KHR_robustness = supported_extensions.contains("GL_KHR_robustness");
    GL_KHR_texture_compression_astc_ldr = supported_extensions.contains("GL_KHR_texture_compression_astc_ldr");
    GL_NVX_gpu_memory_info = supported_extensions.contains("GL_NVX_gpu_memory_info");
    GL_NV_bindless_multi_draw_indirect = supported_extensions.contains("GL_NV_bindless_multi_draw_indirect");
    GL_NV_bindless_texture = supported_extensions.contains("GL_NV_bindless_texture");
    GL_NV_blend_equation_advanced = supported_extensions.contains("GL_NV_blend_equation_advanced");
    GL_NV_blend_square = supported_extensions.contains("GL_NV_blend_square");
    GL_NV_compute_program5 = supported_extensions.contains("GL_NV_compute_program5");
    GL_NV_conditional_render = supported_extensions.contains("GL_NV_conditional_render");
    GL_NV_copy_depth_to_color = supported_extensions.contains("GL_NV_copy_depth_to_color");
    GL_NV_copy_image = supported_extensions.contains("GL_NV_copy_image");
    GL_NV_deep_texture3D = supported_extensions.contains("GL_NV_deep_texture3D");
    GL_NV_depth_buffer_float = supported_extensions.contains("GL_NV_depth_buffer_float");
    GL_NV_depth_clamp = supported_extensions.contains("GL_NV_depth_clamp");
    GL_NV_draw_texture = supported_extensions.contains("GL_NV_draw_texture");
    GL_NV_evaluators = supported_extensions.contains("GL_NV_evaluators");
    GL_NV_explicit_multisample = supported_extensions.contains("GL_NV_explicit_multisample");
    GL_NV_fence = supported_extensions.contains("GL_NV_fence");
    GL_NV_float_buffer = supported_extensions.contains("GL_NV_float_buffer");
    GL_NV_fog_distance = supported_extensions.contains("GL_NV_fog_distance");
    GL_NV_fragment_program = ((supported_extensions.contains("GL_NV_fragment_program")) && (supported_extensions.contains("GL_NV_program")));
    
    GL_NV_fragment_program2 = supported_extensions.contains("GL_NV_fragment_program2");
    GL_NV_fragment_program4 = supported_extensions.contains("GL_NV_fragment_program4");
    GL_NV_fragment_program_option = supported_extensions.contains("GL_NV_fragment_program_option");
    GL_NV_framebuffer_multisample_coverage = supported_extensions.contains("GL_NV_framebuffer_multisample_coverage");
    GL_NV_geometry_program4 = supported_extensions.contains("GL_NV_geometry_program4");
    GL_NV_geometry_shader4 = supported_extensions.contains("GL_NV_geometry_shader4");
    GL_NV_gpu_program4 = supported_extensions.contains("GL_NV_gpu_program4");
    GL_NV_gpu_program5 = supported_extensions.contains("GL_NV_gpu_program5");
    GL_NV_gpu_program5_mem_extended = supported_extensions.contains("GL_NV_gpu_program5_mem_extended");
    GL_NV_gpu_shader5 = supported_extensions.contains("GL_NV_gpu_shader5");
    GL_NV_half_float = supported_extensions.contains("GL_NV_half_float");
    GL_NV_light_max_exponent = supported_extensions.contains("GL_NV_light_max_exponent");
    GL_NV_multisample_coverage = supported_extensions.contains("GL_NV_multisample_coverage");
    GL_NV_multisample_filter_hint = supported_extensions.contains("GL_NV_multisample_filter_hint");
    GL_NV_occlusion_query = supported_extensions.contains("GL_NV_occlusion_query");
    GL_NV_packed_depth_stencil = supported_extensions.contains("GL_NV_packed_depth_stencil");
    GL_NV_parameter_buffer_object = supported_extensions.contains("GL_NV_parameter_buffer_object");
    GL_NV_parameter_buffer_object2 = supported_extensions.contains("GL_NV_parameter_buffer_object2");
    GL_NV_path_rendering = supported_extensions.contains("GL_NV_path_rendering");
    GL_NV_pixel_data_range = supported_extensions.contains("GL_NV_pixel_data_range");
    GL_NV_point_sprite = supported_extensions.contains("GL_NV_point_sprite");
    GL_NV_present_video = supported_extensions.contains("GL_NV_present_video");
    GL_NV_primitive_restart = supported_extensions.contains("GL_NV_primitive_restart");
    GL_NV_register_combiners = supported_extensions.contains("GL_NV_register_combiners");
    GL_NV_register_combiners2 = supported_extensions.contains("GL_NV_register_combiners2");
    GL_NV_shader_atomic_counters = supported_extensions.contains("GL_NV_shader_atomic_counters");
    GL_NV_shader_atomic_float = supported_extensions.contains("GL_NV_shader_atomic_float");
    GL_NV_shader_buffer_load = supported_extensions.contains("GL_NV_shader_buffer_load");
    GL_NV_shader_buffer_store = supported_extensions.contains("GL_NV_shader_buffer_store");
    GL_NV_shader_storage_buffer_object = supported_extensions.contains("GL_NV_shader_storage_buffer_object");
    GL_NV_tessellation_program5 = supported_extensions.contains("GL_NV_tessellation_program5");
    GL_NV_texgen_reflection = supported_extensions.contains("GL_NV_texgen_reflection");
    GL_NV_texture_barrier = supported_extensions.contains("GL_NV_texture_barrier");
    GL_NV_texture_compression_vtc = supported_extensions.contains("GL_NV_texture_compression_vtc");
    GL_NV_texture_env_combine4 = supported_extensions.contains("GL_NV_texture_env_combine4");
    GL_NV_texture_expand_normal = supported_extensions.contains("GL_NV_texture_expand_normal");
    GL_NV_texture_multisample = supported_extensions.contains("GL_NV_texture_multisample");
    GL_NV_texture_rectangle = supported_extensions.contains("GL_NV_texture_rectangle");
    GL_NV_texture_shader = supported_extensions.contains("GL_NV_texture_shader");
    GL_NV_texture_shader2 = supported_extensions.contains("GL_NV_texture_shader2");
    GL_NV_texture_shader3 = supported_extensions.contains("GL_NV_texture_shader3");
    GL_NV_transform_feedback = supported_extensions.contains("GL_NV_transform_feedback");
    GL_NV_transform_feedback2 = supported_extensions.contains("GL_NV_transform_feedback2");
    GL_NV_vertex_array_range = supported_extensions.contains("GL_NV_vertex_array_range");
    GL_NV_vertex_array_range2 = supported_extensions.contains("GL_NV_vertex_array_range2");
    GL_NV_vertex_attrib_integer_64bit = supported_extensions.contains("GL_NV_vertex_attrib_integer_64bit");
    GL_NV_vertex_buffer_unified_memory = supported_extensions.contains("GL_NV_vertex_buffer_unified_memory");
    GL_NV_vertex_program = ((supported_extensions.contains("GL_NV_vertex_program")) && (supported_extensions.contains("GL_NV_program")));
    
    GL_NV_vertex_program1_1 = supported_extensions.contains("GL_NV_vertex_program1_1");
    GL_NV_vertex_program2 = supported_extensions.contains("GL_NV_vertex_program2");
    GL_NV_vertex_program2_option = supported_extensions.contains("GL_NV_vertex_program2_option");
    GL_NV_vertex_program3 = supported_extensions.contains("GL_NV_vertex_program3");
    GL_NV_vertex_program4 = supported_extensions.contains("GL_NV_vertex_program4");
    GL_NV_video_capture = supported_extensions.contains("GL_NV_video_capture");
    GL_SGIS_generate_mipmap = supported_extensions.contains("GL_SGIS_generate_mipmap");
    GL_SGIS_texture_lod = supported_extensions.contains("GL_SGIS_texture_lod");
    GL_SUN_slice_accum = supported_extensions.contains("GL_SUN_slice_accum");
    tracker.init();
  }
}
