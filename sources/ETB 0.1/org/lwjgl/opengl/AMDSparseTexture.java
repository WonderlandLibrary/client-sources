...
public final class AMDSparseTexture
{
  ...
  public static void glTexStorageSparseAMD(int target, int internalFormat, int width, int height, int depth, int layers, int flags)
  {
    ...
    long function_pointer = glTexStorageSparseAMD;
  ...
  public static void glTextureStorageSparseAMD(int texture, int target, int internalFormat, int width, int height, int depth, int layers, int flags) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glTextureStorageSparseAMD;
    BufferChecks.checkFunctionAddress(function_pointer);
