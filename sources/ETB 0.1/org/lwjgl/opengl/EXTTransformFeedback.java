...
public final class EXTTransformFeedback
{
  ...
  public static void glBindBufferRangeEXT(int target, int index, int buffer, long offset, long size)
  {
    ...
    long function_pointer = glBindBufferRangeEXT;
  ...
  public static void glBindBufferOffsetEXT(int target, int index, int buffer, long offset) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glBindBufferOffsetEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glBindBufferBaseEXT(int target, int index, int buffer) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glBindBufferBaseEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glBeginTransformFeedbackEXT(int primitiveMode) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glBeginTransformFeedbackEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glEndTransformFeedbackEXT() { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glEndTransformFeedbackEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glTransformFeedbackVaryingsEXT(int program, int count, ByteBuffer varyings, int bufferMode) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glTransformFeedbackVaryingsEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetTransformFeedbackVaryingEXT(int program, int index, IntBuffer length, IntBuffer size, IntBuffer type, ByteBuffer name) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetTransformFeedbackVaryingEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    if (length != null)
