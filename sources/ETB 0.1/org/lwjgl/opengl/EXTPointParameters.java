...
public final class EXTPointParameters
{
  ...
  public static void glPointParameterfEXT(int pname, float param)
  {
    ...
    long function_pointer = glPointParameterfEXT;
  ...
  public static void glPointParameterEXT(int pname, FloatBuffer pfParams) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glPointParameterfvEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
