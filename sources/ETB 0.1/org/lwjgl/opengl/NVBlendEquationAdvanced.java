...
public final class NVBlendEquationAdvanced
{
  ...
  public static void glBlendParameteriNV(int pname, int value)
  {
    ...
    long function_pointer = glBlendParameteriNV;
  ...
  public static void glBlendBarrierNV() { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glBlendBarrierNV;
    BufferChecks.checkFunctionAddress(function_pointer);
