...
public final class NVExplicitMultisample
{
  ...
  public static void glGetMultisampleNV(int pname, int index, FloatBuffer val) {
    ...
    long function_pointer = glGetMultisamplefvNV;
  ...
  public static void glSampleMaskIndexedNV(int index, int mask) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glSampleMaskIndexedNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glTexRenderbufferNV(int target, int renderbuffer) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glTexRenderbufferNV;
    BufferChecks.checkFunctionAddress(function_pointer);
