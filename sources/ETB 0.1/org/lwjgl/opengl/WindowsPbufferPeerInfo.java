  ...
  extends WindowsPeerInfo
{
  ...
  public boolean isBufferLost() { return nIsBufferLost(getHandle()); }
  ...
  public void bindTexImageToPbuffer(int buffer) { nBindTexImageToPbuffer(getHandle(), buffer); }
  ...
  public void destroy() { nDestroy(getHandle()); }
