...
public final class APPLEObjectPurgeable
{
  ...
  public static int glObjectPurgeableAPPLE(int objectType, int name, int option)
  {
    ...
    long function_pointer = glObjectPurgeableAPPLE;
  ...
  public static int glObjectUnpurgeableAPPLE(int objectType, int name, int option) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glObjectUnpurgeableAPPLE;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetObjectParameterAPPLE(int objectType, int name, int pname, IntBuffer params) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetObjectParameterivAPPLE;
    BufferChecks.checkFunctionAddress(function_pointer);
