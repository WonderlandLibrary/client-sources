...
public final class INTELMapTexture
{
  ...
  public static ByteBuffer glMapTexture2DINTEL(int texture, int level, long length, int access, IntBuffer stride, IntBuffer layout, ByteBuffer old_buffer)
  {
    ...
    long function_pointer = glMapTexture2DINTEL;
  ...
  public static void glUnmapTexture2DINTEL(int texture, int level) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUnmapTexture2DINTEL;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glSyncTextureINTEL(int texture) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glSyncTextureINTEL;
    BufferChecks.checkFunctionAddress(function_pointer);
