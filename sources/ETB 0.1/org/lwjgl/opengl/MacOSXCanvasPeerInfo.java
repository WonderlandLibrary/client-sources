  ...
  extends MacOSXPeerInfo
{
  ...
  protected void initHandle(Canvas component) throws LWJGLException {
    ...
    int top = insets != null ? top : 0;
    int left = insets != null ? left : 0;
  ...
  private void addComponentListener(final Canvas component)
  {
    ...
    ComponentListener comp = new ComponentListener()
    {
      ...
      {
        MacOSXCanvasPeerInfo.reSetLayerBounds(component, getHandle());
      }
  ...
  private static native ByteBuffer nInitHandle(ByteBuffer paramByteBuffer1, ByteBuffer paramByteBuffer2, ByteBuffer paramByteBuffer3, boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2)
  ...
  private static void reSetLayerBounds(Canvas component, ByteBuffer peer_info_handle)
  {
    ...
    int x = (int)rtLoc.getX();int y = (int)rtLoc.getY();
    
    Insets insets = getInsets(component);
    x -= (insets != null ? left : 0);
    y -= (insets != null ? top : 0);
