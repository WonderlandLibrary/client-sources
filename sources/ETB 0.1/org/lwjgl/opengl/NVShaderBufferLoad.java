...
public final class NVShaderBufferLoad
{
  ...
  public static void glMakeBufferResidentNV(int target, int access)
  {
    ...
    long function_pointer = glMakeBufferResidentNV;
  ...
  public static void glMakeBufferNonResidentNV(int target) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMakeBufferNonResidentNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static boolean glIsBufferResidentNV(int target) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glIsBufferResidentNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMakeNamedBufferResidentNV(int buffer, int access) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMakeNamedBufferResidentNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glMakeNamedBufferNonResidentNV(int buffer) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glMakeNamedBufferNonResidentNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static boolean glIsNamedBufferResidentNV(int buffer) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glIsNamedBufferResidentNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetBufferParameteruNV(int target, int pname, LongBuffer params) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetBufferParameterui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetNamedBufferParameteruNV(int buffer, int pname, LongBuffer params) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetNamedBufferParameterui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 1);
  ...
  public static void glGetIntegeruNV(int value, LongBuffer result) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glGetIntegerui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniformui64NV(int location, long value) {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniformui64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glUniformuNV(int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glUniformui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetUniformuNV(int program, int location, LongBuffer params) { NVGpuShader5.glGetUniformuNV(program, location, params); }
  
  public static void glProgramUniformui64NV(int program, int location, long value)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniformui64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glProgramUniformuNV(int program, int location, LongBuffer value) { ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = glProgramUniformui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(value);
