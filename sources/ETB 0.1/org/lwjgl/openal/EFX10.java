...
public final class EFX10
{
  ...
  public static void alDeleteAuxiliaryEffectSlots(IntBuffer auxiliaryeffectslots) { BufferChecks.checkDirect(auxiliaryeffectslots);
  ...
  public static void alDeleteAuxiliaryEffectSlots(int auxiliaryeffectslot) { nalDeleteAuxiliaryEffectSlots2(1, auxiliaryeffectslot); }
  ...
  public static void alAuxiliaryEffectSloti(int auxiliaryeffectslot, int param, int value) { nalAuxiliaryEffectSloti(auxiliaryeffectslot, param, value); }
  ...
  public static void alAuxiliaryEffectSlotf(int auxiliaryeffectslot, int param, float value) { nalAuxiliaryEffectSlotf(auxiliaryeffectslot, param, value); }
  ...
  public static int alGetAuxiliaryEffectSloti(int auxiliaryeffectslot, int param) { int __result = nalGetAuxiliaryEffectSloti(auxiliaryeffectslot, param);
    return __result;
  }
  
  static native int nalGetAuxiliaryEffectSloti(int paramInt1, int paramInt2);
  
  public static void alGetAuxiliaryEffectSlot(int auxiliaryeffectslot, int param, IntBuffer intdata) { BufferChecks.checkBuffer(intdata, 1);
  ...
  public static float alGetAuxiliaryEffectSlotf(int auxiliaryeffectslot, int param) { float __result = nalGetAuxiliaryEffectSlotf(auxiliaryeffectslot, param);
    return __result;
  }
  
  static native float nalGetAuxiliaryEffectSlotf(int paramInt1, int paramInt2);
  
  public static void alGetAuxiliaryEffectSlot(int auxiliaryeffectslot, int param, FloatBuffer floatdata) { BufferChecks.checkBuffer(floatdata, 1);
  ...
  public static void alGenEffects(IntBuffer effects) { BufferChecks.checkDirect(effects);
  ...
  public static void alDeleteEffects(IntBuffer effects) { BufferChecks.checkDirect(effects);
  ...
  public static void alDeleteEffects(int effect) { nalDeleteEffects2(1, effect); }
  ...
  public static void alEffecti(int effect, int param, int value) { nalEffecti(effect, param, value); }
  ...
  public static void alEffectf(int effect, int param, float value) { nalEffectf(effect, param, value); }
  ...
  public static int alGetEffecti(int effect, int param) { int __result = nalGetEffecti(effect, param);
    return __result;
  }
  
  static native int nalGetEffecti(int paramInt1, int paramInt2);
  
  public static void alGetEffect(int effect, int param, IntBuffer intdata) { BufferChecks.checkBuffer(intdata, 1);
  ...
  public static float alGetEffectf(int effect, int param) { float __result = nalGetEffectf(effect, param);
    return __result;
  }
  
  static native float nalGetEffectf(int paramInt1, int paramInt2);
  
  public static void alGetEffect(int effect, int param, FloatBuffer floatdata) { BufferChecks.checkBuffer(floatdata, 1);
  ...
  public static void alGenFilters(IntBuffer filters) { BufferChecks.checkDirect(filters);
  ...
  public static void alDeleteFilters(IntBuffer filters) { BufferChecks.checkDirect(filters);
  ...
  public static void alDeleteFilters(int filter) { nalDeleteFilters2(1, filter); }
  ...
  public static void alFilteri(int filter, int param, int value) { nalFilteri(filter, param, value); }
  ...
  public static void alFilterf(int filter, int param, float value) { nalFilterf(filter, param, value); }
  ...
  public static int alGetFilteri(int filter, int param) { int __result = nalGetFilteri(filter, param);
    return __result;
  }
  
  static native int nalGetFilteri(int paramInt1, int paramInt2);
  
  public static void alGetFilter(int filter, int param, IntBuffer intdata) { BufferChecks.checkBuffer(intdata, 1);
  ...
  public static float alGetFilterf(int filter, int param) { float __result = nalGetFilterf(filter, param);
    return __result;
  }
  
  static native float nalGetFilterf(int paramInt1, int paramInt2);
  
  public static void alGetFilter(int filter, int param, FloatBuffer floatdata) { BufferChecks.checkBuffer(floatdata, 1);
