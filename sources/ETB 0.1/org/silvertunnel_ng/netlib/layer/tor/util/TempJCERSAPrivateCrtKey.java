  ...
  implements RSAPrivateCrtKey
{
  ...
  TempJCERSAPrivateCrtKey(RSAPrivateCrtKeyParameters key)
  {
    super(key);
  ...
  TempJCERSAPrivateCrtKey(RSAPrivateCrtKeySpec spec)
  {
  ...
  TempJCERSAPrivateCrtKey(RSAPrivateCrtKey key)
  {
  ...
  TempJCERSAPrivateCrtKey(PrivateKeyInfo info)
    throws IOException
  {
  ...
  TempJCERSAPrivateCrtKey(RSAPrivateKey key)
  {
    modulus = key.getModulus();
    publicExponent = key.getPublicExponent();
    privateExponent = key.getPrivateExponent();
