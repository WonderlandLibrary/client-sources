...
public abstract class Nat160
{
  ...
  public static int mul33DWordAdd(int x, long y, int[] z, int zOff)
  {
    ...
    z[(zOff + 3)] = ((int)c);
    c >>>= 32;
    return c == 0L ? 0 : Nat.incAt(5, z, zOff, 4);
  }
  ...
  public static int mul33WordAdd(int x, int y, int[] z, int zOff)
  {
    ...
    z[(zOff + 2)] = ((int)c);
    c >>>= 32;
    return c == 0L ? 0 : Nat.incAt(5, z, zOff, 3);
  }
  ...
  public static int mulWordsAdd(int x, int y, int[] z, int zOff)
  {
    ...
    z[(zOff + 1)] = ((int)c);
    c >>>= 32;
    return c == 0L ? 0 : Nat.incAt(5, z, zOff, 2);
  }
  ...
  public static BigInteger toBigInteger(int[] x)
  {
    ...
    for (int i = 0; i < 5; i++)
    {
      ...
      if (x_i != 0)
      {
        org.spongycastle.util.Pack.intToBigEndian(x_i, bs, 4 - i << 2);
      }
    }
