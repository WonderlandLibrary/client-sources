...
public abstract class Nat256
{
  ...
  public static int add(int[] x, int[] y, int[] z)
  {
    ...
    z[6] = ((int)c);
    c >>>= 32;
    c += (x[7] & 0xFFFFFFFF) + (y[7] & 0xFFFFFFFF);
    z[7] = ((int)c);
    c >>>= 32;
    return (int)c;
  }
  ...
  public static int add(int[] x, int xOff, int[] y, int yOff, int[] z, int zOff)
  {
    ...
    z[(zOff + 6)] = ((int)c);
    c >>>= 32;
    c += (x[(xOff + 7)] & 0xFFFFFFFF) + (y[(yOff + 7)] & 0xFFFFFFFF);
    z[(zOff + 7)] = ((int)c);
    c >>>= 32;
    return (int)c;
  }
  ...
  public static int addBothTo(int[] x, int[] y, int[] z)
  {
    ...
    z[6] = ((int)c);
    c >>>= 32;
    c += (x[7] & 0xFFFFFFFF) + (y[7] & 0xFFFFFFFF) + (z[7] & 0xFFFFFFFF);
    z[7] = ((int)c);
    c >>>= 32;
    return (int)c;
  }
  ...
  public static int addBothTo(int[] x, int xOff, int[] y, int yOff, int[] z, int zOff)
  {
    ...
    z[(zOff + 6)] = ((int)c);
    c >>>= 32;
    c += (x[(xOff + 7)] & 0xFFFFFFFF) + (y[(yOff + 7)] & 0xFFFFFFFF) + (z[(zOff + 7)] & 0xFFFFFFFF);
    z[(zOff + 7)] = ((int)c);
    c >>>= 32;
    return (int)c;
  }
  ...
  public static int addTo(int[] x, int[] z)
  {
    ...
    z[6] = ((int)c);
    c >>>= 32;
    c += (x[7] & 0xFFFFFFFF) + (z[7] & 0xFFFFFFFF);
    z[7] = ((int)c);
    c >>>= 32;
    return (int)c;
  }
  ...
  public static int addTo(int[] x, int xOff, int[] z, int zOff, int cIn)
  {
    ...
    z[(zOff + 6)] = ((int)c);
    c >>>= 32;
    c += (x[(xOff + 7)] & 0xFFFFFFFF) + (z[(zOff + 7)] & 0xFFFFFFFF);
    z[(zOff + 7)] = ((int)c);
    c >>>= 32;
    return (int)c;
  }
  ...
  public static int addToEachOther(int[] u, int uOff, int[] v, int vOff)
  {
    ...
    v[(vOff + 6)] = ((int)c);
    c >>>= 32;
    c += (u[(uOff + 7)] & 0xFFFFFFFF) + (v[(vOff + 7)] & 0xFFFFFFFF);
    u[(uOff + 7)] = ((int)c);
    v[(vOff + 7)] = ((int)c);
    c >>>= 32;
    return (int)c;
  ...
  public static void mul(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff)
  {
    ...
    for (int i = 1; i < 8; i++)
    {
      ...
      zz[(zzOff + 6)] = ((int)c);
      c >>>= 32;
      c += x_i * y_7 + (zz[(zzOff + 7)] & 0xFFFFFFFF);
      zz[(zzOff + 7)] = ((int)c);
      c >>>= 32;
      zz[(zzOff + 8)] = ((int)c);
    }
  ...
  public static long mul33Add(int w, int[] x, int xOff, int[] y, int yOff, int[] z, int zOff)
  {
    ...
    z[(zOff + 6)] = ((int)c);
    c >>>= 32;
    long x7 = x[(xOff + 7)] & 0xFFFFFFFF;
    c += wVal * x7 + x6 + (y[(yOff + 7)] & 0xFFFFFFFF);
    z[(zOff + 7)] = ((int)c);
    c >>>= 32;
    c += x7;
    return c;
  ...
  public static int mulByWordAddTo(int x, int[] y, int[] z)
  {
    ...
    z[6] = ((int)c);
    c >>>= 32;
    c += xVal * (z[7] & 0xFFFFFFFF) + (y[7] & 0xFFFFFFFF);
    z[7] = ((int)c);
    c >>>= 32;
    return (int)c;
  }
  ...
  public static int mulWordAddTo(int x, int[] y, int yOff, int[] z, int zOff)
  {
    ...
    z[(zOff + 6)] = ((int)c);
    c >>>= 32;
    c += xVal * (y[(yOff + 7)] & 0xFFFFFFFF) + (z[(zOff + 7)] & 0xFFFFFFFF);
    z[(zOff + 7)] = ((int)c);
    c >>>= 32;
    return (int)c;
  }
  ...
  public static void square(int[] x, int[] zz)
  {
    ...
    long x_7 = x[7] & 0xFFFFFFFF;
    long zz_13 = (zz[13] & 0xFFFFFFFF) + (zz_12 >>> 32);zz_12 &= 0xFFFFFFFF;
    long zz_14 = (zz[14] & 0xFFFFFFFF) + (zz_13 >>> 32);zz_13 &= 0xFFFFFFFF;
  ...
  public static void square(int[] x, int xOff, int[] zz, int zzOff)
  {
    ...
    long x_7 = x[(xOff + 7)] & 0xFFFFFFFF;
    long zz_13 = (zz[(zzOff + 13)] & 0xFFFFFFFF) + (zz_12 >>> 32);zz_12 &= 0xFFFFFFFF;
    long zz_14 = (zz[(zzOff + 14)] & 0xFFFFFFFF) + (zz_13 >>> 32);zz_13 &= 0xFFFFFFFF;
  ...
  public static int subBothFrom(int[] x, int[] y, int[] z)
  {
    ...
    z[6] = ((int)c);
    c >>= 32;
    c += (z[7] & 0xFFFFFFFF) - (x[7] & 0xFFFFFFFF) - (y[7] & 0xFFFFFFFF);
    z[7] = ((int)c);
    c >>= 32;
    return (int)c;
  }
  ...
  public static int subFrom(int[] x, int[] z)
  {
    ...
    z[6] = ((int)c);
    c >>= 32;
    c += (z[7] & 0xFFFFFFFF) - (x[7] & 0xFFFFFFFF);
    z[7] = ((int)c);
    c >>= 32;
    return (int)c;
  }
  ...
  public static int subFrom(int[] x, int xOff, int[] z, int zOff)
  {
    ...
    z[(zOff + 6)] = ((int)c);
    c >>= 32;
    c += (z[(zOff + 7)] & 0xFFFFFFFF) - (x[(xOff + 7)] & 0xFFFFFFFF);
    z[(zOff + 7)] = ((int)c);
    c >>= 32;
    return (int)c;
  }
  ...
  public static BigInteger toBigInteger(int[] x)
  {
    ...
    for (int i = 0; i < 8; i++)
    {
      ...
      if (x_i != 0)
      {
        org.spongycastle.util.Pack.intToBigEndian(x_i, bs, 7 - i << 2);
      }
    }
  ...
  public static BigInteger toBigInteger64(long[] x)
  {
    ...
    for (int i = 0; i < 4; i++)
    {
      ...
      if (x_i != 0L)
      {
        org.spongycastle.util.Pack.longToBigEndian(x_i, bs, 3 - i << 3);
      }
    }
    return new BigInteger(1, bs);
  }
