...
public class SecT283Field
{
  ...
  public static void reduce(long[] xx, long[] z)
  {
    ...
    long x5 = xx[5];long x6 = xx[6];long x7 = xx[7];long x8 = xx[8];
  ...
  public static void sqrt(long[] x, long[] z)
  {
    ...
    odd[1] = (u0 >>> 32 | u1 & 0xFFFFFFFF00000000);
    
    u0 = Interleave.unshuffle(x[4]);
    long e2 = u0 & 0xFFFFFFFF;
    odd[2] = (u0 >>> 32);
  ...
  {
    return (int)(x[0] ^ x[4] >>> 15) & 0x1;
  }
  
  protected static void implCompactExt(long[] zz)
  {
    long z0 = zz[0];long z1 = zz[1];long z2 = zz[2];long z3 = zz[3];long z4 = zz[4];
    long z5 = zz[5];long z6 = zz[6];long z7 = zz[7];long z8 = zz[8];long z9 = zz[9];
    zz[0] = (z0 ^ z1 << 57);
    zz[1] = (z1 >>> 7 ^ z2 << 50);
    zz[2] = (z2 >>> 14 ^ z3 << 43);
    zz[3] = (z3 >>> 21 ^ z4 << 36);
  ...
  {
    long x0 = x[0];long x1 = x[1];long x2 = x[2];long x3 = x[3];long x4 = x[4];
    z[0] = (x0 & 0x1FFFFFFFFFFFFFF);
    z[1] = ((x0 >>> 57 ^ x1 << 7) & 0x1FFFFFFFFFFFFFF);
    z[2] = ((x1 >>> 50 ^ x2 << 14) & 0x1FFFFFFFFFFFFFF);
    z[3] = ((x2 >>> 43 ^ x3 << 21) & 0x1FFFFFFFFFFFFFF);
    z[4] = (x3 >>> 36 ^ x4 << 28);
  }
  ...
  {
    long[] a = new long[5];long[] b = new long[5];
    implExpand(x, a);
    implExpand(y, b);
    ...
    long u0 = a[0] ^ a[1];long v0 = b[0] ^ b[1];
    long u1 = a[0] ^ a[2];long v1 = b[0] ^ b[2];
    long u2 = a[2] ^ a[4];long v2 = b[2] ^ b[4];
    long u3 = a[3] ^ a[4];long v3 = b[3] ^ b[4];
    
    implMulw(u1 ^ a[3], v1 ^ b[3], p, 18);
    implMulw(u2 ^ a[1], v2 ^ b[1], p, 20);
    
    long A4 = u0 ^ u3;long B4 = v0 ^ v3;
    long A5 = A4 ^ a[2];long B5 = B4 ^ b[2];
