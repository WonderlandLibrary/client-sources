  ...
  extends ECPoint.AbstractFp
{
  ...
  public ECPoint add(ECPoint b)
  {
    ...
    SecP384R1FieldElement X1 = (SecP384R1FieldElement)x;SecP384R1FieldElement Y1 = (SecP384R1FieldElement)y;
    SecP384R1FieldElement X2 = (SecP384R1FieldElement)b.getXCoord();SecP384R1FieldElement Y2 = (SecP384R1FieldElement)b.getYCoord();
    ...
    {
      S2 = t3;
      SecP384R1Field.square(x, S2);
      
      U2 = tt2;
      SecP384R1Field.multiply(S2, x, U2);
      
      SecP384R1Field.multiply(S2, x, S2);
      SecP384R1Field.multiply(S2, x, S2);
    }
    ...
    {
      S1 = t4;
      SecP384R1Field.square(x, S1);
      
      U1 = tt1;
      SecP384R1Field.multiply(S1, x, U1);
      
      SecP384R1Field.multiply(S1, x, S1);
      SecP384R1Field.multiply(S1, x, S1);
    }
    ...
    SecP384R1Field.square(R, x);
    SecP384R1Field.subtract(x, G, x);
    
    SecP384R1FieldElement Y3 = new SecP384R1FieldElement(G);
    SecP384R1Field.subtract(V, x, x);
    Nat384.mul(x, R, tt2);
    SecP384R1Field.addExt(tt1, tt2, tt1);
    SecP384R1Field.reduce(tt1, x);
    
    SecP384R1FieldElement Z3 = new SecP384R1FieldElement(H);
    if (!Z1IsOne)
    {
      SecP384R1Field.multiply(x, x, x);
    }
    if (!Z2IsOne)
    {
      SecP384R1Field.multiply(x, x, x);
    ...
    return new SecP384R1Point(curve, X3, Y3, zs, withCompression);
  }
  ...
  public ECPoint twice()
  {
    ...
    SecP384R1FieldElement Y1 = (SecP384R1FieldElement)y;
    if (Y1.isZero())
    {
      return curve.getInfinity();
    }
    
    SecP384R1FieldElement X1 = (SecP384R1FieldElement)x;SecP384R1FieldElement Z1 = (SecP384R1FieldElement)zs[0];
    ...
    SecP384R1Field.square(x, Y1Squared);
    ...
    {
      Z1Squared = t2;
      SecP384R1Field.square(x, Z1Squared);
    }
    
    SecP384R1Field.subtract(x, Z1Squared, t1);
    
    int[] M = t2;
    SecP384R1Field.add(x, Z1Squared, M);
    SecP384R1Field.multiply(M, t1, M);
    int c = Nat.addBothTo(12, M, M, M);
    SecP384R1Field.reduce32(c, M);
    
    int[] S = Y1Squared;
    SecP384R1Field.multiply(Y1Squared, x, S);
    ...
    SecP384R1Field.square(M, x);
    SecP384R1Field.subtract(x, S, x);
    SecP384R1Field.subtract(x, S, x);
    
    SecP384R1FieldElement Y3 = new SecP384R1FieldElement(S);
    SecP384R1Field.subtract(S, x, x);
    SecP384R1Field.multiply(x, M, x);
    SecP384R1Field.subtract(x, t1, x);
    
    SecP384R1FieldElement Z3 = new SecP384R1FieldElement(M);
    SecP384R1Field.twice(x, x);
    if (!Z1IsOne)
    {
      SecP384R1Field.multiply(x, x, x);
    }
    
    return new SecP384R1Point(curve, X3, Y3, new ECFieldElement[] { Z3 }, withCompression);
  }
  ...
  public ECPoint negate()
  {
    ...
    return new SecP384R1Point(curve, x, y.negate(), zs, withCompression);
  }
}
