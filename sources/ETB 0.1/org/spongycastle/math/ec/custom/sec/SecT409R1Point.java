...
public class SecT409R1Point extends ECPoint.AbstractF2m
{
  ...
  public ECPoint add(ECPoint b)
  {
    ...
    ECFieldElement Z3; if (X2.isZero())
    {
      ...
      if (X3.isZero())
      {
        return new SecT409R1Point(curve, X3, curve.getB().sqrt(), withCompression);
      }
    ...
    return new SecT409R1Point(curve, X3, L3, new ECFieldElement[] { Z3 }, withCompression);
  }
  ...
  public ECPoint negate()
  {
    ...
    return new SecT409R1Point(curve, X, L.add(Z), new ECFieldElement[] { Z }, withCompression);
  }
}
