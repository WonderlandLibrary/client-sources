  ...
  extends ECPoint.AbstractFp
{
  ...
  public ECPoint add(ECPoint b)
  {
    ...
    return new SecP160R2Point(curve, X3, Y3, zs, withCompression);
  }
  ...
  public ECPoint twice()
  {
    ...
    {
      Z1Squared = t2;
      SecP160R2Field.square(x, Z1Squared);
    }
    
    SecP160R2Field.subtract(x, Z1Squared, t1);
    
    int[] M = t2;
    SecP160R2Field.add(x, Z1Squared, M);
    ...
    return new SecP160R2Point(curve, X3, Y3, new ECFieldElement[] { Z3 }, withCompression);
  }
  ...
  public ECPoint negate()
  {
    ...
    return new SecP160R2Point(curve, x, y.negate(), zs, withCompression);
  }
}
