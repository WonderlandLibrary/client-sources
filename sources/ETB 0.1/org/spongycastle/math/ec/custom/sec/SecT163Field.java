...
public class SecT163Field
{
  ...
  {
    long x0 = xx[0];long x1 = xx[1];long x2 = xx[2];long x3 = xx[3];long x4 = xx[4];long x5 = xx[5];
  ...
  {
    long z2 = z[(zOff + 2)];long t = z2 >>> 35;
    z[zOff] ^= t ^ t << 3 ^ t << 6 ^ t << 7;
    z[(zOff + 2)] = (z2 & 0x7FFFFFFFF);
  }
  ...
  protected static void implMultiply(long[] x, long[] y, long[] zz)
  {
    ...
    f2 = f1 >>> 46 ^ f2 << 18;
    f1 = (f0 >>> 55 ^ f1 << 9) & 0x7FFFFFFFFFFFFF;
    f0 &= 0x7FFFFFFFFFFFFF;
    
    long g0 = y[0];long g1 = y[1];long g2 = y[2];
    g2 = g1 >>> 46 ^ g2 << 18;
    g1 = (g0 >>> 55 ^ g1 << 9) & 0x7FFFFFFFFFFFFF;
    g0 &= 0x7FFFFFFFFFFFFF;
    ...
    w1 ^= w0 >>> 55;w0 &= 0x7FFFFFFFFFFFFF;
    w2 ^= w1 >>> 55;w1 &= 0x7FFFFFFFFFFFFF;
  ...
  protected static void implSquare(long[] x, long[] zz)
  {
    ...
    zz[5] = (Interleave.expand8to16((int)(x2 >>> 32)) & 0xFFFFFFFF);
  }
}
