  ...
  extends X509CRL
{
  ...
  protected X509CRLObject(JcaJceHelper bcHelper, CertificateList c)
    throws CRLException
  {
  ...
  private Set loadCRLEntries()
  {
    ...
    while (certs.hasMoreElements())
    {
      ...
      if ((isIndirect) && (entry.hasExtensions()))
      {
        ...
        {
          previousCertificateIssuer = X500Name.getInstance(org.spongycastle.asn1.x509.GeneralNames.getInstance(currentCaName.getParsedValue()).getNames()[0].getName());
        }
      }
    }
    ...
    if (certs.hasMoreElements())
    {
      ...
      while (certs.hasMoreElements())
      {
        ...
        if ((isIndirect) && (entry.hasExtensions()))
        {
          ...
          if (currentCaName != null)
          {
            caName = X500Name.getInstance(org.spongycastle.asn1.x509.GeneralNames.getInstance(currentCaName.getParsedValue()).getNames()[0].getName());
          }
        }
  ...
  public boolean equals(Object other)
  {
    ...
    if ((other instanceof X509CRLObject))
    {
      ...
      if (isHashCodeSet)
      {
        boolean otherIsHashCodeSet = isHashCodeSet;
        if (otherIsHashCodeSet)
        {
          if (hashCodeValue != hashCodeValue)
          {
            return false;
          }
        }
