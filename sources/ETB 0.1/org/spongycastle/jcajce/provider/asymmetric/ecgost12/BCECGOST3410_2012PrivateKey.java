  ...
  implements java.security.interfaces.ECPrivateKey, org.spongycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
  ...
  public BCECGOST3410_2012PrivateKey(org.spongycastle.jce.spec.ECPrivateKeySpec spec)
  {
    d = spec.getD();
  ...
  public BCECGOST3410_2012PrivateKey(String algorithm, ECPrivateKeyParameters params, BCECGOST3410_2012PublicKey pubKey, java.security.spec.ECParameterSpec spec)
  {
  ...
  public BCECGOST3410_2012PrivateKey(String algorithm, ECPrivateKeyParameters params, BCECGOST3410_2012PublicKey pubKey, org.spongycastle.jce.spec.ECParameterSpec spec)
  {
    ECDomainParameters dp = params.getParameters();
  ...
  public byte[] getEncoded()
  {
    ...
    if (gostParams != null)
    {
      ...
      extractBytes(encKey, size, 0, getS());
