  ...
  implements Polynomial
{
  ...
  public int hashCode()
  {
    int prime = 31;
    int result = 1;
    result = 31 * result + (f1 == null ? 0 : f1.hashCode());
    result = 31 * result + (f2 == null ? 0 : f2.hashCode());
    result = 31 * result + (f3 == null ? 0 : f3.hashCode());
    return result;
  }
