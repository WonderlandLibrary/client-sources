...
class XMSSNodeUtil
{
  ...
  static XMSSNode randomizeHash(WOTSPlus wotsPlus, XMSSNode left, XMSSNode right, XMSSAddress address)
  {
    ...
    else if ((address instanceof HashTreeAddress))
    {
      ...
      address = (HashTreeAddress)((HashTreeAddress.Builder)((HashTreeAddress.Builder)((HashTreeAddress.Builder)new HashTreeAddress.Builder().withLayerAddress(tmpAddress.getLayerAddress())).withTreeAddress(tmpAddress.getTreeAddress())).withTreeHeight(tmpAddress.getTreeHeight()).withTreeIndex(tmpAddress.getTreeIndex()).withKeyAndMask(0)).build();
    }
    ...
    if ((address instanceof LTreeAddress))
    {
      ...
      address = (LTreeAddress)((LTreeAddress.Builder)((LTreeAddress.Builder)((LTreeAddress.Builder)new LTreeAddress.Builder().withLayerAddress(tmpAddress.getLayerAddress())).withTreeAddress(tmpAddress.getTreeAddress())).withLTreeAddress(tmpAddress.getLTreeAddress()).withTreeHeight(tmpAddress.getTreeHeight()).withTreeIndex(tmpAddress.getTreeIndex()).withKeyAndMask(1)).build();
    }
    else if ((address instanceof HashTreeAddress))
    {
      HashTreeAddress tmpAddress = (HashTreeAddress)address;
      ...
      address = (HashTreeAddress)((HashTreeAddress.Builder)((HashTreeAddress.Builder)((HashTreeAddress.Builder)new HashTreeAddress.Builder().withLayerAddress(tmpAddress.getLayerAddress())).withTreeAddress(tmpAddress.getTreeAddress())).withTreeHeight(tmpAddress.getTreeHeight()).withTreeIndex(tmpAddress.getTreeIndex()).withKeyAndMask(1)).build();
    }
    ...
    if ((address instanceof LTreeAddress))
    {
      ...
      address = (LTreeAddress)((LTreeAddress.Builder)((LTreeAddress.Builder)((LTreeAddress.Builder)new LTreeAddress.Builder().withLayerAddress(tmpAddress.getLayerAddress())).withTreeAddress(tmpAddress.getTreeAddress())).withLTreeAddress(tmpAddress.getLTreeAddress()).withTreeHeight(tmpAddress.getTreeHeight()).withTreeIndex(tmpAddress.getTreeIndex()).withKeyAndMask(2)).build();
    }
    else if ((address instanceof HashTreeAddress))
    {
      HashTreeAddress tmpAddress = (HashTreeAddress)address;
      ...
      address = (HashTreeAddress)((HashTreeAddress.Builder)((HashTreeAddress.Builder)((HashTreeAddress.Builder)new HashTreeAddress.Builder().withLayerAddress(tmpAddress.getLayerAddress())).withTreeAddress(tmpAddress.getTreeAddress())).withTreeHeight(tmpAddress.getTreeHeight()).withTreeIndex(tmpAddress.getTreeIndex()).withKeyAndMask(2)).build();
    }
