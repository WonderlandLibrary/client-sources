...
public class DSTU4145NamedCurves
{
  ...
  static
  {
    ...
    h_s[0] = BigInteger.valueOf(2L);
    h_s[1] = BigInteger.valueOf(2L);
    h_s[2] = BigInteger.valueOf(4L);
    h_s[3] = BigInteger.valueOf(2L);
    h_s[4] = BigInteger.valueOf(2L);
    h_s[5] = BigInteger.valueOf(2L);
    h_s[6] = BigInteger.valueOf(4L);
    h_s[7] = BigInteger.valueOf(2L);
    h_s[8] = BigInteger.valueOf(2L);
    h_s[9] = BigInteger.valueOf(2L);
