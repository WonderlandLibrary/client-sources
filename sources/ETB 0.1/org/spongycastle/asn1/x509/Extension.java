  ...
  extends ASN1Object
{
  ...
  private Extension(ASN1Sequence seq)
  {
    ...
    {
      extnId = ASN1ObjectIdentifier.getInstance(seq.getObjectAt(0));
      critical = ASN1Boolean.getInstance(seq.getObjectAt(1)).isTrue();
      value = ASN1OctetString.getInstance(seq.getObjectAt(2));
    }
    else
    {
  ...
  public int hashCode()
  {
    ...
    return getExtnValue().hashCode() ^ getExtnId().hashCode() ^ 0xFFFFFFFF;
  }
  ...
  public boolean equals(Object o)
  {
    ...
    return (other.getExtnId().equals(getExtnId())) && 
      (other.getExtnValue().equals(getExtnValue())) && 
