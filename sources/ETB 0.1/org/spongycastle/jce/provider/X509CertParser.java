  ...
  extends X509StreamParserSpi
{
  ...
  private java.security.cert.Certificate readDERCertificate(InputStream in) throws IOException, CertificateParsingException
  {
    ...
    throws StreamParsingException
  {
    ...
    while ((cert = (java.security.cert.Certificate)engineRead()) != null)
    {
      certs.add(cert);
    }
