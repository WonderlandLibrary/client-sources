  ...
  extends Salsa20Engine
{
  ...
  protected void retreatCounter(long diff)
  {
    ...
    if (hi != 0)
    {
      if ((engineState[13] & 0xFFFFFFFF) >= (hi & 0xFFFFFFFF))
      {
        engineState[13] -= hi;
      }
      else
  ...
  {
    return engineState[13] << 32 | engineState[12] & 0xFFFFFFFF;
  }
  
  protected void resetCounter()
  {
    int tmp13_12 = 0;engineState[13] = tmp13_12;engineState[12] = tmp13_12;
  }
