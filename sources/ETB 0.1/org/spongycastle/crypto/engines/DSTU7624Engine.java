  ...
  implements BlockCipher
{
    ...
    throws IllegalArgumentException
  {
    ...
    wordsInBlock = (blockBitLength / 64);
    internalState = new long[wordsInBlock];
    
    internalStateBytes = new byte[internalState.length * 64 / 8];
    tempInternalStateBytes = new byte[internalState.length * 64 / 8];
  }
    ...
    throws IllegalArgumentException
  {
    if ((params instanceof KeyParameter))
    {
      ...
      int blockBitLength = wordsInBlock * 64;
      ...
      if (keyBytes.length != wordsInKey * 64 / 8)
      {
  ...
  public void reset()
  {
    ...
    Arrays.fill(internalStateBytes, (byte)0);
    Arrays.fill(tempInternalStateBytes, (byte)0);
  }
  ...
  private void SubBytes()
  {
    ...
    {
      internalState[i] = (sboxesForEncryption[0][((int)(internalState[i] & 0xFF))] & 0xFF | sboxesForEncryption[1][((int)((internalState[i] & 0xFF00) >>> 8))] << 8 & 0xFF00 | sboxesForEncryption[2][((int)((internalState[i] & 0xFF0000) >>> 16))] << 16 & 0xFF0000 | sboxesForEncryption[3][((int)((internalState[i] & 0xFF000000) >>> 24))] << 24 & 0xFF000000 | sboxesForEncryption[0][((int)((internalState[i] & 0xFF00000000) >>> 32))] << 32 & 0xFF00000000 | sboxesForEncryption[1][((int)((internalState[i] & 0xFF0000000000) >>> 40))] << 40 & 0xFF0000000000 | sboxesForEncryption[2][((int)((internalState[i] & 0xFF000000000000) >>> 48))] << 48 & 0xFF000000000000 | sboxesForEncryption[3][((int)((internalState[i] & 0xFF00000000000000) >>> 56))] << 56 & 0xFF00000000000000);
    }
  }
  ...
  private void InvSubBytes()
  {
    for (int i = 0; i < wordsInBlock; i++)
    {
      internalState[i] = (sboxesForDecryption[0][((int)(internalState[i] & 0xFF))] & 0xFF | sboxesForDecryption[1][((int)((internalState[i] & 0xFF00) >>> 8))] << 8 & 0xFF00 | sboxesForDecryption[2][((int)((internalState[i] & 0xFF0000) >>> 16))] << 16 & 0xFF0000 | sboxesForDecryption[3][((int)((internalState[i] & 0xFF000000) >>> 24))] << 24 & 0xFF000000 | sboxesForDecryption[0][((int)((internalState[i] & 0xFF00000000) >>> 32))] << 32 & 0xFF00000000 | sboxesForDecryption[1][((int)((internalState[i] & 0xFF0000000000) >>> 40))] << 40 & 0xFF0000000000 | sboxesForDecryption[2][((int)((internalState[i] & 0xFF000000000000) >>> 48))] << 48 & 0xFF000000000000 | sboxesForDecryption[3][((int)((internalState[i] & 0xFF00000000000000) >>> 56))] << 56 & 0xFF00000000000000);
    }
  }
  ...
  private void ShiftRows()
  {
    ...
    for (int row = 0; row < 8; row++)
    {
      ...
      {
        tempInternalStateBytes[(row + (col + shift) % wordsInBlock * 64 / 8)] = internalStateBytes[(row + col * 64 / 8)];
      }
    }
  ...
  private void InvShiftRows()
  {
    ...
    for (int row = 0; row < 8; row++)
    {
      ...
      for (int col = 0; col < wordsInBlock; col++)
      {
        tempInternalStateBytes[(row + col * 64 / 8)] = internalStateBytes[(row + (col + shift) % wordsInBlock * 64 / 8)];
      }
    }
  ...
  private void MixColumns(byte[][] matrix)
  {
    ...
    for (int col = 0; col < wordsInBlock; col++)
    {
      ...
      for (int row = 7; row >= 0; row--)
      {
        ...
        for (int b = 7; b >= 0; b--)
        {
          product = (byte)(product ^ MultiplyGF(internalStateBytes[(b + col * 64 / 8)], matrix[row][b]));
        }
        
        result |= product << row * 64 / 8 & shift;
        shift >>>= 8;
      }
  ...
  private byte[][] mdsMatrix = { { 1, 1, 5, 1, 8, 6, 7, 4 }, { 4, 1, 1, 5, 1, 8, 6, 7 }, { 7, 4, 1, 1, 5, 1, 8, 6 }, { 6, 7, 4, 1, 1, 5, 1, 8 }, { 8, 6, 7, 4, 1, 1, 5, 1 }, { 1, 8, 6, 7, 4, 1, 1, 5 }, { 5, 1, 8, 6, 7, 4, 1, 1 }, { 1, 5, 1, 8, 6, 7, 4, 1 } };
  ...
  private byte[][] mdsInvMatrix = { { -83, -107, 118, -88, 47, 73, -41, -54 }, { -54, -83, -107, 118, -88, 47, 73, -41 }, { -41, -54, -83, -107, 118, -88, 47, 73 }, { 73, -41, -54, -83, -107, 118, -88, 47 }, { 47, 73, -41, -54, -83, -107, 118, -88 }, { -88, 47, 73, -41, -54, -83, -107, 118 }, { 118, -88, 47, 73, -41, -54, -83, -107 }, { -107, 118, -88, 47, 73, -41, -54, -83 } };
