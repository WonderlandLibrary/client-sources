...
public class ECGOST3410_2012Signer implements org.spongycastle.crypto.DSA
{
  ECKeyParameters key;
  SecureRandom random;
  ...
  public boolean verifySignature(byte[] message, BigInteger r, BigInteger s)
  {
    ...
    ECPoint point = org.spongycastle.math.ec.ECAlgorithms.sumOfTwoMultiplies(G, z1, Q, z2).normalize();
