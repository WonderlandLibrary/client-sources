...
public class SM2KeyExchange
{
  ...
  public void init(CipherParameters privParam)
  {
    ...
    {
      SM2KeyExchangePrivateParameters baseParam = (SM2KeyExchangePrivateParameters)((ParametersWithID)privParam).getParameters();
  ...
  public byte[] calculateKey(int kLen, CipherParameters pubParam)
  {
    ...
    {
      SM2KeyExchangePublicParameters otherPub = (SM2KeyExchangePublicParameters)((ParametersWithID)pubParam).getParameters();
  ...
  {
    return x.and(BigInteger.valueOf(1L).shiftLeft(w).subtract(BigInteger.valueOf(1L))).setBit(w);
  }
