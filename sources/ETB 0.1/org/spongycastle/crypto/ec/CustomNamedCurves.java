...
public class CustomNamedCurves
{
  ...
  static X9ECParametersHolder curve25519 = new X9ECParametersHolder()
  {
    protected X9ECParameters createParameters()
    {
      ...
      X9ECPoint G = new X9ECPoint(curve, Hex.decode("042AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAD245A20AE19A1B8A086B4E01EDD2C7748D14C923D4D7E6D7C61B229E9C5A27ECED3D9"));
  ...
  static X9ECParametersHolder secp160k1 = new X9ECParametersHolder()
  {
    protected X9ECParameters createParameters()
    {
      ...
      ECCurve curve = CustomNamedCurves.configureCurveGLV(new SecP160K1Curve(), glv);
  ...
  static X9ECParametersHolder sm2p256v1 = new X9ECParametersHolder()
  {
    ...
    {
      byte[] S = null;
      ECCurve curve = CustomNamedCurves.configureCurve(new SM2P256V1Curve());
