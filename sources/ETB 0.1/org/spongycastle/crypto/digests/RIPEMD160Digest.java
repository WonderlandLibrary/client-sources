  ...
  extends GeneralDigest
{
  ...
  protected void processBlock()
  {
    ...
    int aa = RL(aa + f5(bb, cc, dd) + X[5] + 1352829926, 8) + ee;int cc = RL(cc, 10);
    int ee = RL(ee + f5(aa, bb, cc) + X[14] + 1352829926, 9) + dd;int bb = RL(bb, 10);
    int dd = RL(dd + f5(ee, aa, bb) + X[7] + 1352829926, 9) + cc;aa = RL(aa, 10);
