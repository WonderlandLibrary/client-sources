    ...
    throws CertificateParsingException
  {
    try
    {
      if (certificate.getVersion() != 3)
      {
        ...
        return 
          (ASN1Sequence)new AuthorityKeyIdentifier(info, new GeneralNames(genName), certificate.getSerialNumber()).toASN1Primitive();
      }
      ...
      if (ext != null)
      {
        ...
        return 
          (ASN1Sequence)new AuthorityKeyIdentifier(str.getOctets(), new GeneralNames(genName), certificate.getSerialNumber()).toASN1Primitive();
      }
