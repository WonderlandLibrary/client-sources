...
public class ModelUtils
{
  ...
  public static IBakedModel duplicateModel(IBakedModel model)
  {
    ...
    EnumFacing[] faces = EnumFacing.VALUES;
    java.util.ArrayList faceQuads2 = new java.util.ArrayList();
    ...
    net.minecraft.client.resources.model.SimpleBakedModel var8 = new net.minecraft.client.resources.model.SimpleBakedModel(generalQuads2, faceQuads2, model.isGui3d(), model.isAmbientOcclusionEnabled(), model.getTexture(), model.getItemCameraTransforms());
    return var8;
  }
