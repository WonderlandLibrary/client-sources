  ...
  public static void updateWaterOpacity(GameSettings settings, World world)
  {
    ...
    if (world != null)
    {
      ...
      if (var25 != null)
      {
        ...
        if (rve != null)
        {
          int cViewX = (int)posX / 16;
          int cViewZ = (int)posZ / 16;
          ...
          for (int threadName = cXMin; threadName < cXMax; threadName++)
          {
            for (int cz = cZMin; cz < cZMax; cz++)
            {
              ...
              {
                net.minecraft.world.chunk.Chunk c = var25.provideChunk(threadName, cz);
                
                if ((c != null) && (!(c instanceof net.minecraft.world.chunk.EmptyChunk)))
                {
                  int x0 = threadName << 4;
                  int z0 = cz << 4;
                  int x1 = x0 + 16;
                  ...
                  for (int x = x0; x < x1; x++)
                  {
                    ...
                    while (z < z1)
                    {
                      ...
                      while (y < posH.getY())
                      {
                        ...
                        if (bs.getBlock().getMaterial() != net.minecraft.block.material.Material.water)
                        {
                          y++;
                        }
                        else
