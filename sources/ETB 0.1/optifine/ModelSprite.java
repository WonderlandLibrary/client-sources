...
public class ModelSprite
{
  ...
  public ModelSprite(ModelRenderer modelRenderer, int textureOffsetX, int textureOffsetY, float posX, float posY, float posZ, int sizeX, int sizeY, int sizeZ, float sizeAdd)
  {
    ...
    minU = (textureOffsetX / textureWidth);
    minV = (textureOffsetY / textureHeight);
    maxU = ((textureOffsetX + sizeX) / textureWidth);
    maxV = ((textureOffsetY + sizeY) / textureHeight);
  }
  ...
  public void render(Tessellator tessellator, float scale)
  {
    ...
    renderItemIn2D(tessellator, rMinU, rMinV, rMaxU, rMaxV, sizeX, sizeY, scale * sizeZ, modelRenderer.textureWidth, modelRenderer.textureHeight);
    GlStateManager.translate(-posX * scale, -posY * scale, -posZ * scale);
  }
