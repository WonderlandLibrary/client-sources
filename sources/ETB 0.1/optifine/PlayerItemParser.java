...
public class PlayerItemParser
{
  ...
  public PlayerItemParser() {}
  
  public static PlayerItemModel parseItemModel(JsonObject obj) { String type = Json.getString(obj, "type");
  ...
  private static ModelRenderer parseModelRenderer(JsonObject elem, ModelBase modelBase)
  {
    ...
    rotateAngleX = rotateAngles[0];
    rotateAngleY = rotateAngles[1];
    rotateAngleZ = rotateAngles[2];
    ...
    if (boxes != null)
    {
      ...
      {
        JsonObject submodel = boxes.get(sprites).getAsJsonObject();
