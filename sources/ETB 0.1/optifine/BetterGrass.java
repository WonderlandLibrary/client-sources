...
public class BetterGrass
{
  ...
  public static void update() { modelCubeGrass = BlockModelUtils.makeModelCube("minecraft:blocks/grass_top", 0);
  ...
  public static List getFaceQuads(IBlockAccess blockAccess, Block block, BlockPos blockPos, EnumFacing facing, List quads)
  {
    if ((facing != EnumFacing.UP) && (facing != EnumFacing.DOWN))
    {
      ...
      {
        return Config.isBetterGrassFancy() ? quads : getBlockAt(blockPos.offsetDown(), facing, blockAccess) == Blocks.mycelium ? modelCubeMycelium.func_177551_a(facing) : modelCubeMycelium.func_177551_a(facing);
      }
