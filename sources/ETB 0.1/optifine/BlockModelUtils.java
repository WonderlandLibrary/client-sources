...
public class BlockModelUtils
{
  ...
  public static IBakedModel makeModelCube(TextureAtlasSprite sprite, int tintIndex)
  {
    ...
    SimpleBakedModel var8 = new SimpleBakedModel(generalQuads, faceQuads, true, true, sprite, net.minecraft.client.renderer.block.model.ItemCameraTransforms.field_178357_a);
    return var8;
  }
  ...
  private static BakedQuad makeBakedQuad(EnumFacing facing, TextureAtlasSprite sprite, int tintIndex)
  {
    ...
    BakedQuad quad = faceBakery.func_178414_a(posFrom, posTo, face, sprite, facing, modelRotation, (net.minecraft.client.renderer.block.model.BlockPartRotation)partRotation, uvLocked, shade);
    return quad;
  }
}
