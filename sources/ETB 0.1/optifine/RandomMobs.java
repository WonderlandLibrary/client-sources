...
public class RandomMobs
{
  ...
  public static void entityLoaded(Entity entity, World world) { if ((entity instanceof EntityLiving))
    {
      if (world != null)
      {
        EntityLiving el = (EntityLiving)entity;
        spawnPosition = el.getPosition();
        spawnBiome = world.getBiomeGenForCoords(spawnPosition);
  ...
  public static ResourceLocation getTextureLocation(ResourceLocation loc)
  {
    ...
    try
    {
      ...
      Entity entity = renderGlobalrenderedEntity;
      ...
      if (props != null)
      {
        ResourceLocation var5 = props.getTextureLocation(loc, entityLiving);
        return var5;
      }
      ...
      working = false; } ResourceLocation var5; working = false;
