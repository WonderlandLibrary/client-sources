...
public class SmartLeaves
{
  ...
  public static IBakedModel getLeavesModel(IBakedModel model) { if (!Config.isTreesSmart())
    {
      return model;
    }
    ...
    return generalQuads == generalQuadsCullSpruce ? modelLeavesDoubleSpruce : generalQuads == generalQuadsCullOak ? modelLeavesDoubleOak : generalQuads == generalQuadsCullJungle ? modelLeavesDoubleJungle : generalQuads == generalQuadsCullDarkOak ? modelLeavesDoubleDarkOak : generalQuads == generalQuadsCullBirch ? modelLeavesDoubleBirch : generalQuads == generalQuadsCullAcacia ? modelLeavesDoubleAcacia : model;
  }
