...
public class Json
{
  ...
  public static float[] parseFloatArray(JsonElement jsonElement, int len, float[] def)
  {
    ...
    com.google.gson.JsonArray arr = jsonElement.getAsJsonArray();
    
    if (arr.size() != len)
    {
      throw new com.google.gson.JsonParseException("Wrong array length: " + arr.size() + ", should be: " + len + ", array: " + arr);
    }
