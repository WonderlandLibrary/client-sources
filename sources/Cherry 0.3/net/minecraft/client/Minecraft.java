...
import net.minecraft.client.network.badlion.Events.EventRightClick;
import net.minecraft.client.network.badlion.Events.EventTick;
import net.minecraft.client.network.badlion.Mod.Mod;
import net.minecraft.client.network.badlion.UI.UIRenderer;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void rightClickMouse()
    {
        ...
        final EventRightClick event = new EventRightClick();
    ...
    {
        final EventTick event = new EventTick();
        EventManager.call(event);
