...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    {//TODO: here
        ...
        this.func_180452_a(p_175042_2_, p_175042_3_, var4.isAmbientOcclusionEnabled());
        this.func_175034_a(var4.getItemCameraTransforms().field_178354_e);
        this.supermeme(p_175042_1_, var4);
        GlStateManager.disableAlpha();
        GlStateManager.disableRescaleNormal();
        GlStateManager.disableLighting();
        GlStateManager.popMatrix();
    ...
    public void renderItem(final ItemStack stack, final IBakedModel model, final boolean effect) {
        if (effect) {
            ...
            if (model.isBuiltInRenderer()) {
                ...
                GlStateManager.translate(-0.5f, -0.5f, -0.5f);
                this.func_175045_a(model, -1, stack);
            }
            GlStateManager.popMatrix();
        }
    }
