...
package net.minecraft.client.network.badlion.ttf;
...
public class NahrFont
{
    ...
    private void createFont(final Object font, final float size) {
        try {
            if (font instanceof Font) {
                ...
                this.theFont = new Font("Arial", 0, Math.round(size));
            }
        ...
        while ((var2 = par0Str.indexOf(167, var2 + 1)) != -1) {
            if (var2 < var3 - 1) {
                ...
                if (this.isFormatColor(var4)) {
                    ...
                    var1 = String.valueOf(String.valueOf(String.valueOf(var1))) + "§" + var4;
                }
            }
        }
        return var1;
    ...
    public String wrapFormattedStringToWidth(final String s, final float width) {
        ...
        final String split2 = String.valueOf(String.valueOf(String.valueOf(this.getFormatFromString(split)))) + s.substring(wrapWidth + ((s.charAt(wrapWidth) == ' ' || s.charAt(wrapWidth) == '\n') ? 1 : 0));
        try {
            return String.valueOf(String.valueOf(String.valueOf(split))) + "\n" + this.wrapFormattedStringToWidth(split2, width);
        }
        catch (Exception e) {
    ...
    {
        EMBOSS_BOTTOM("EMBOSS_BOTTOM", 0, "EMBOSS_BOTTOM", 0, "EMBOSS_BOTTOM", 0), 
        EMBOSS_TOP("EMBOSS_TOP", 1, "EMBOSS_TOP", 1, "EMBOSS_TOP", 1), 
        NORMAL("NORMAL", 2, "NORMAL", 2, "NORMAL", 2), 
        OUTLINE_THIN("OUTLINE_THIN", 3, "OUTLINE_THIN", 3, "OUTLINE_THIN", 3), 
        SHADOW_THICK("SHADOW_THICK", 4, "SHADOW_THICK", 4, "SHADOW_THICK", 4), 
        SHADOW_THIN("SHADOW_THIN", 5, "SHADOW_THIN", 5, "SHADOW_THIN", 5);
        
        private FontType(final String s3, final int n3, final String s2, final int n2, final String s, final int n) {
        }
    }
}
