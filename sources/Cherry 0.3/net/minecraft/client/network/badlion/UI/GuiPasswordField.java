...
public class GuiPasswordField extends Gui
{
    ...
    public GuiPasswordField(final int p_i45542_1_, final FontRenderer p_i45542_2_, final int p_i45542_3_, final int p_i45542_4_, final int p_i45542_5_, final int p_i45542_6_) {
        this.text = "";
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (var4.length() > 0) {
                ...
                var9 = Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(var10.replaceAll(this.textVisible ? "" : "(?s).", "*"), var7, var8, var1);
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                var9 = Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(var4.substring(var2).replaceAll(this.textVisible ? "" : "(?s).", "*"), var9, var8, var1);
            }
            if (var6) {
                if (var11) {
                    ...
                    Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("_", var12, var8, var1);
                }
            }
            if (var3 != var2) {
                final int var13 = var7 + Minecraft.getMinecraft().fontRendererObj.getStringWidth(var4.substring(0, var3).replaceAll(this.textVisible ? "" : "(?s).", "*"));
                this.drawCursorVertical(var12, var8 - 1, var13 - 1, var8 + 1 + Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT);
            }
        }
    }
