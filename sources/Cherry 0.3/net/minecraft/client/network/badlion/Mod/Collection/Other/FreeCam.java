...
import net.minecraft.client.network.badlion.Utils.BlockUtils;
...
public class FreeCam extends Mod
{
    ...
    public void onUpdate(final EventUpdate event) {
        ...
        final double x = MovementInput.moveForward * 0.3 * mx2 + MovementInput.moveStrafe * 0.3 * mz2;
        final double z = MovementInput.moveForward * 0.3 * mz2 - MovementInput.moveStrafe * 0.3 * mx2;
