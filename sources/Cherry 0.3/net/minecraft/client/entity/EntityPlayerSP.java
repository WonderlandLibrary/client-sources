...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                this.func_175161_p();
                final EventUpdate eventPost = new EventUpdate();
    ...
    {
        final EventUpdate eventPre = new EventUpdate(this.posY, this.rotationYaw, this.rotationPitch, this.onGround);
    ...
    {
        final EventChatSend event = new EventChatSend(p_71165_1_);
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding() && !Badlion.getWinter().theMods.getMod(NoSlowDown.class).isEnabled()){
    ...
    public static boolean isOnLiquid() {
        ...
        final int y = (int)Minecraft.getMinecraft().thePlayer.boundingBox.offset(0.0, -0.01, 0.0).minY;
