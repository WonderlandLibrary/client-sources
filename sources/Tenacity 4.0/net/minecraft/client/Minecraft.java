...
import dev.event.impl.game.WorldEvent;
import dev.event.impl.player.BlockEvent;
import dev.event.impl.player.ClickEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        FontUtil.iconFont40 = new MinecraftFontRenderer(FontUtil.getFont(locationMap, "tenacity.ttf", 40), true, true);
        FontUtil.tenacityFont20 = new MinecraftFontRenderer(FontUtil.getFont(locationMap, "tenacity.ttf", 20), true, true);
        FontUtil.iconFont35 = new MinecraftFontRenderer(FontUtil.getFont(locationMap, "tenacity.ttf", 35), true, true);
        FontUtil.tenacityBoldFont20 = new MinecraftFontRenderer(FontUtil.getFont(locationMap, "tenacitybold.ttf", 20), true, true);
        FontUtil.iconFont26 = new MinecraftFontRenderer(FontUtil.getFont(locationMap, "tenacity.ttf", 26), true, true);
        FontUtil.tenacityFont40 = new MinecraftFontRenderer(FontUtil.getFont(locationMap, "tenacity.ttf", 40), true, true);
        FontUtil.iconFont20 = new MinecraftFontRenderer(FontUtil.getFont(locationMap, "tenacity.ttf", 20), true, true);
        FontUtil.iconFont16 = new MinecraftFontRenderer(FontUtil.getFont(locationMap, "tenacity.ttf", 20), true, true);
