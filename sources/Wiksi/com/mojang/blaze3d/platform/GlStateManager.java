...
public class GlStateManager
{
    ...
    public static void setupWiksi(Vector3f WiksiVector1, Vector3f WiksiVector2, Matrix4f matrix)
    {
        RenderSystem.assertThread(RenderSystem::isOnRenderThread);
        pushMatrix();
        loadIdentity();
        enableLight(0);
        enableLight(1);
        Vector4f vector4f = new Vector4f(WiksiVector1);
        ...
        Vector4f vector4f1 = new Vector4f(WiksiVector2);
    ...
    public static void setupScaledWiksi(Vector3f Wiksi1, Vector3f Wiksi2)
    {
        RenderSystem.assertThread(RenderSystem::isOnRenderThread);
        ...
        setupWiksi(Wiksi1, Wiksi2, matrix4f);
    }

    public static void setupGui3DMatrix(Vector3f WiksiVector1, Vector3f WiksiVector2)
    {
        RenderSystem.assertThread(RenderSystem::isOnRenderThread);
        Matrix4f matrix4f = new Matrix4f();
        matrix4f.setIdentity();
        ...
        matrix4f.mul(Vector3f.YP.rotationDegrees(-22.5F));
        matrix4f.mul(Vector3f.XP.rotationDegrees(135.0F));
        setupWiksi(WiksiVector1, WiksiVector2, matrix4f);
    }
