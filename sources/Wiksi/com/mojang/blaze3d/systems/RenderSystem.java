...
public class RenderSystem
{
    ...
    public static void pushWiksiAttributes()
    {
        ...
        GlStateManager.pushWiksiAttributes();
    }
    ...
    public static void setupLevelDiffuseWiksi(Vector3f p_setupLevelDiffuseWiksi_0_, Vector3f p_setupLevelDiffuseWiksi_1_, Matrix4f p_setupLevelDiffuseWiksi_2_)
    {
        assertThread(RenderSystem::isOnGameThread);
        GlStateManager.setupWiksi(p_setupLevelDiffuseWiksi_0_, p_setupLevelDiffuseWiksi_1_, p_setupLevelDiffuseWiksi_2_);
    }

    public static void setupGuiFlatDiffuseWiksi(Vector3f p_setupGuiFlatDiffuseWiksi_0_, Vector3f p_setupGuiFlatDiffuseWiksi_1_)
    {
        assertThread(RenderSystem::isOnGameThread);
        GlStateManager.setupScaledWiksi(p_setupGuiFlatDiffuseWiksi_0_, p_setupGuiFlatDiffuseWiksi_1_);
    }

    public static void setupGui3DDiffuseWiksi(Vector3f p_setupGui3DDiffuseWiksi_0_, Vector3f p_setupGui3DDiffuseWiksi_1_)
    {
        assertThread(RenderSystem::isOnGameThread);
        GlStateManager.setupGui3DMatrix(p_setupGui3DDiffuseWiksi_0_, p_setupGui3DDiffuseWiksi_1_);
    }
