...
import src.Wiksi.events.EventSpawnEntity;
...
public class AutoTotem extends Function {
    ...
    private final BooleanSetting noBallSwitch = new BooleanSetting("Если шар", false);
    private final BooleanSetting saveEnchanted = new BooleanSetting("Если зачар", true);
