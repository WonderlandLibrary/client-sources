...
public class Trails extends Function {
    ...
    public ModeSetting mod = new ModeSetting("Мод", "Обычный", "Обычный", "Линия", "Точки");
    ...
    public Trails() {
        this.addSettings(hider, pointsTime, mod, tolshina);
    }

    @Subscribe
    public void onRender(WorldEvent event) {
        float pointsi = pointsTime.get();
        ...
        while (true) {
            ...
            do {
                    ...
                    do {
                        if (!bb.hasNext()) {
                            ...
                            while (aa.hasNext()) {
                                ...
                                if (mod.is("Обычный")) {
                                    GL11.glBegin(8);
                                } else if (mod.is("Линия")) {
                                    GL11.glBegin(3);

                                } else if (mod.is("Точки")) {
                                    GL11.glEnable(2832);
                                    GL11.glHint(3153, 4354);

                                    float tolshinaa = tolshina.get();
                ...
                } while ((Boolean) hider.get() && entity == mc.player && mc.gameSettings.getPointOfView() == PointOfView.FIRST_PERSON);
            ...
            } while (lastPoint != null && !(lastPoint.distanceTo(player) > 1.0E-8));
