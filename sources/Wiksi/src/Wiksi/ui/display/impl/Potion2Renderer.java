...
public class Potion2Renderer implements ElementRenderer
{
    ...
    final ResourceLocation potion = new ResourceLocation("Wiksi/images/hud/potion1.png");
    ...
    public void render(final EventDisplay eventDisplay) {
        ...
        final ITextComponent name = GradientUtil.gradient("Potion");


        DisplayUtils.drawRoundedRect(posX, posY + 1.0f, this.animation, 18.0f, 4.0f, ColorUtils.rgba(21, 21, 21, 215));
        Fonts.sfui.drawText(ms, "Potion", posX + 20, posY + padding + 1.5f,ColorUtils.rgb(255,255,255), 6.5f);
        ...
        posY += 3.0f;
        for (EffectInstance ef : Potion2Renderer.mc.player.getActivePotionEffects()) {
            ...
            DisplayUtils.drawRectVerticalW(posX + 66.0f, posY + 2.0f, width - 1, 8.0f, 3, ColorUtils.rgba(255, 255, 255, (int) (255 * 0.75f)));
    ...
    public Potion2Renderer(final Dragging dragging) {
