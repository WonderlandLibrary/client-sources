package src.Wiksi.ui.ab.render.impl.item;

import com.mojang.blaze3d.matrix.MatrixStack;
import src.Wiksi.Wiksi;
import src.Wiksi.ui.ab.model.IItem;
import src.Wiksi.ui.ab.model.ItemImpl;
import src.Wiksi.ui.ab.render.impl.AddedItemComponent;
import src.Wiksi.ui.ab.render.impl.AllItemComponent;
import src.Wiksi.ui.ab.render.impl.Component;
import src.Wiksi.utils.client.IMinecraft;
import src.Wiksi.utils.components.ButtonComponent;
import src.Wiksi.utils.components.FieldComponent;
import src.Wiksi.utils.components.SliderComponent;
...
public class EditComponent extends Component implements IMinecraft {
    ...
    private final ButtonComponent add = new ButtonComponent(0, 0, 0, 0, "Добавить", () -> {
        if (!price.get().isEmpty()) {
            ...
            Wiksi.getInstance().getItemStorage().addItem(stack.getItem(), Integer.parseInt(price.get()), Integer.parseInt(count.fieldComponent.get()), Integer.parseInt(damage.fieldComponent.get()), enchantmentWidget.get());
