...
public class BakedQuadRetextured extends BakedQuad
{
    ...
    {
        super(remapVertexData(quad.getVertexData(), quad.getSprite(), spriteIn), quad.getTintIndex(), FaceBakery.getFacingFromVertexData(quad.getVertexData()), spriteIn, quad.applyDiffuseWiksi());
    }
