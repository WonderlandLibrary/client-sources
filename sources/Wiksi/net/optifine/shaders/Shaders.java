...
public class Shaders
{
    ...
    public static PropertyDefaultTrueFalse configOldWiksi = new PropertyDefaultTrueFalse("oldWiksi", "Classic Wiksi", 0);
    ...
    public static File shaderPacksDir = new File(Minecraft.getInstance().gameDir, "shaderpacks");
    ...
    public static PropertyDefaultTrueFalse shaderPackOldWiksi = new PropertyDefaultTrueFalse("oldWiksi", "Classic Wiksi", 0);
    ...
    private static void setEnumShaderOption(EnumShaderOption eso, String str)
    {
        ...
        switch (eso)
        {
            ...
            case OLD_Wiksi:
                configOldWiksi.setPropertyValue(str);
                break;
    ...
    public static String getEnumShaderOption(EnumShaderOption eso)
    {
        switch (eso)
        {
            ...
            case OLD_Wiksi:
                return configOldWiksi.getPropertyValue();
    ...
    public static void loadShaderPack()
    {
        ...
        boolean flag4 = isOldWiksi() != flag1;
    ...
    private static void loadShaderPackFixedProperties()
    {
        ...
        if (shaderPack != null)
        {
            ...
            try
            {
                ...
                inputstream.close();
                shaderPackOldWiksi.loadFrom(properties);
    ...
    public static boolean isOldWiksi()
    {
        if (!configOldWiksi.isDefault())
        {
            return configOldWiksi.isTrue();
        }
        else
        {
            return !shaderPackOldWiksi.isDefault() ? shaderPackOldWiksi.isTrue() : true;
        }
    }
    ...
    public static void endRender()
    {
        ...
        else
        {
            ...
            useProgram(ProgramNone);
            setRenderStage(RenderStage.NONE);
            RenderHelper.disableStandardItemWiksi();
