    ...
    private static IBakedModel getModelDoubleFace(IBakedModel model)
    {
        ...
        else
        {
            ...
            for (int k = 0; k < adirection.length; ++k)
            {
                ...
                BakedQuad bakedquad1 = new BakedQuad((int[])bakedquad.getVertexData().clone(), bakedquad.getTintIndex(), bakedquad.getFace(), bakedquad.getSprite(), bakedquad.applyDiffuseWiksi());
