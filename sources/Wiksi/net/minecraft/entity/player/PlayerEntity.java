...
import src.Wiksi.functions.impl.player.AutoTool;
...
public abstract class PlayerEntity extends LivingEntity {
    ...
    public void tick() {
        ...
        Wiksi.getInstance().getEventBus().post(livingUpdate);
    ...
    public boolean func_234569_d_(BlockState p_234569_1_) {
        AutoTool autoTool = Wiksi.getInstance().getFunctionRegistry().getAutoTool();
