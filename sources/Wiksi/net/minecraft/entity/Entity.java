...
import src.Wiksi.events.EventStartRiding;
import src.Wiksi.events.MovingEvent;
import src.Wiksi.events.PostMoveEvent;
import src.Wiksi.functions.api.FunctionRegistry;
import src.Wiksi.functions.impl.combat.Hitbox;
import src.Wiksi.functions.impl.render.Trails;
import src.Wiksi.scripts.lua.classes.EntityClass;
...
public abstract class Entity implements INameable, ICommandSource {
    ...
    public List<Trails.Point> points = new ArrayList<>();
    ...
    public void move(MoverType typeIn, Vector3d pos) {
        ...
        if (this.noClip) {
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Wiksi.getInstance().getEventBus().post(move);
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Wiksi.getInstance().getEventBus().post(post);
            }
    ...
    public boolean startRiding(Entity entityIn, boolean force) {
        Wiksi.getInstance().getEventBus().post(new EventStartRiding(entityIn));
...
//        FunctionRegistry functionRegistry = Wiksi.getInstance().getFunctionRegistry();
//        SeeInvisibles seeInvisibles = functionRegistry.getSeeInvisibles();
//        boolean alpha = seeInvisibles.isState();
//
//        if (alpha && !(this instanceof ArmorStandEntity))
//            return false;
