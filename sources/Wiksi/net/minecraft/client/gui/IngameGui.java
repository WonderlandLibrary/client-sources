...
import src.Wiksi.events.EventCancelOverlay;
...
import src.Wiksi.functions.impl.render.Crosshair;
import src.Wiksi.functions.impl.render.HUD;
import src.Wiksi.functions.impl.render.Hotbar;
...
public class IngameGui extends AbstractGui {
    ...
    private ItemStack highWiksiItemStack = ItemStack.EMPTY;
    ...
    public void renderIngameGui(MatrixStack matrixStack, float partialTicks) {
        ...
        if (eventDisplay.getType() == EventDisplay.Type.PRE) {
            Wiksi.getInstance().getEventBus().post(eventDisplay);
        }
        ...
        if (!this.mc.gameSettings.hideGUI) {
            ...
            Wiksi.getInstance().getEventBus().post(eventCancelOverlay);
    ...
    protected void renderHotbar(float partialTicks, MatrixStack matrixStack) {
        ...
        if (playerentity != null) {
            ...
            int k = -(-((3673 | 16656 | 11763) ^ 28493));
            int l = -(-((-32 | 50 | 4) ^ -83));
            int firstColor = ColorUtils.getColor(0);
            int secondColor = ColorUtils.getColor(-(-((58 | -9 | 52) ^ -91)));
            FunctionRegistry functionRegistry = Wiksi.getInstance().getFunctionRegistry();
            Hotbar hotbar = functionRegistry.getHotbar();
            boolean customHotbar = hotbar.isState();
            int blitStandartY = this.scaledHeight - -(-((-97 | -108 | 110) ^ -23));
            int blitItemY = blitStandartY + 3;
            this.setBlitOffset(-(-((8 | -104 | 58) ^ 28)));
            Runnable var10000;
            var ref = new Object() {
                int i2;
            };
            ...
            if (customHotbar) {
                ref.i2 = i - -(-((-20 | -39 | -44) ^ -90));
                lambdaContext.k2 = -(-((4237 | 525 | 3815) ^ 7769));
                lambdaContext.l1 = -(-((71 | 33 | -114) ^ -7));
                var10000 = () -> {
                    DisplayUtils.drawRoundedRect((float) ref.i2, (float)blitStandartY, (float) lambdaContext.k2, (float)(lambdaContext.l1 - 2), 4.0F, java.awt.Color.WHITE.getRGB());
                };
                DisplayUtils.drawRoundedRect((float) ref.i2, (float)blitStandartY, (float) lambdaContext.k2, (float)(lambdaContext.l1 - 2), 2.5F, (new java.awt.Color(0, 0, 0, -(-((20 | 26 | 113) ^ 27)))).getRGB());
                ref.i2 = i - -(-((-94 | -91 | 76) ^ -76)) - 1 + playerentity.inventory.currentItem * -(-((4 | -116 | -2) ^ -22));
                j2 = blitStandartY - 1;
                lambdaContext.k2 = -(-((36 | 76 | -109) ^ -25));
                lambdaContext.l1 = -(-((-97 | 108 | -46) ^ -23));
                DisplayUtils.drawRoundedRect((float)(ref.i2 + 2), (float)(j2 + 2), (float)(lambdaContext.k2 - 4), (float)(lambdaContext.l1 - 4), 1.0F, ColorUtils.getColor(0));
                DisplayUtils.drawRoundedRect((float)(ref.i2 + 2), (float)(j2 + 2), (float)(lambdaContext.k2 - 4), (float)(lambdaContext.l1 - 4), 1.0F, (new java.awt.Color(0, 0, 0, -(-((121 | 114 | 118) ^ 27)))).getRGB());
                if (-(-((64 | -128 | -114) ^ 75)) != -(-((81 | 78 | 60) ^ 60))) {
                }
            } else {
                this.blit(matrixStack, i - -(-((127 | 7 | 51) ^ 36)), blitStandartY, 0, 0, -(-((29979 | 27162 | 21568) ^ 32749)), -(-((-46 | 45 | -30) ^ -23)));
                this.blit(matrixStack, i - -(-((-91 | -43 | 114) ^ -84)) - 1 + playerentity.inventory.currentItem * -(-((-122 | 102 | -95) ^ -13)), blitStandartY - 1, 0, -(-((50 | 5 | -7) ^ -23)), -(-((112 | -98 | -77) ^ -25)), -(-((51 | 121 | -103) ^ -19)));
            }

            if (!itemstack.isEmpty()) {
                if (handside == HandSide.LEFT) {
                    if (!customHotbar) {
                        this.blit(matrixStack, i - -(-((-49 | 24 | -10) ^ -92)) - -(-((-106 | 61 | 91) ^ -30)), blitStandartY - 1, -(-((-9 | 123 | 80) ^ -25)), -(-((-127 | -27 | -55) ^ -5)), -(-((-73 | 120 | -56) ^ -30)), -(-((-120 | 75 | 79) ^ -41)));
                        if (-(-((-123 | 35 | -109) ^ -4)) != -(-((-35 | 117 | -42) ^ -75))) {
                        }
                    } else {
                        ref.i2 = i - -(-((-79 | -81 | -93) ^ -28)) - -(-((52 | -51 | 19) ^ -29));
                        lambdaContext.k2 = -(-((43 | 102 | -40) ^ -21));
                        lambdaContext.l1 = -(-((105 | -40 | 62) ^ -22));
                        var10000 = () -> {
                            DisplayUtils.drawRoundedRect((float)ref.i2, (float)blitStandartY, (float)lambdaContext.k2, (float)(lambdaContext.l1 - 1), 3.0F, java.awt.Color.WHITE.getRGB());

                        };
                        DisplayUtils.drawRoundedRect((float) ref.i2, (float)blitStandartY, (float) lambdaContext.k2, (float)(lambdaContext.l1 - 1), 3.0F, ColorUtils.getColor(-(-((120 | -83 | 121) ^ -89))));
                        DisplayUtils.drawRoundedRect((float) ref.i2, (float)blitStandartY, (float) lambdaContext.k2, (float)(lambdaContext.l1 - 1), 2.5F, ColorUtils.rgba(0, 0, 0, -(-((116 | 46 | 35) ^ 27))));
                        this.blit(matrixStack, i - -(-((-55 | 99 | -69) ^ -96)) - -(-((99 | -26 | -76) ^ -22)), blitStandartY - 1, -(-((124 | 127 | 16) ^ 103)), -(-((69 | -16 | -79) ^ -29)), -(-((-58 | 43 | 73) ^ -14)), -(-((109 | -69 | -44) ^ -25)));
                        if (-(-((-36 | 90 | -68) ^ 69)) != -(-((50 | -105 | 56) ^ 69))) {
                        }
                    }
                } else {
                    this.blit(matrixStack, i + -(-((111 | 1 | 57) ^ 36)), blitStandartY - 1, -(-((-118 | -38 | -48) ^ -17)), -(-((57 | 33 | -45) ^ -19)), -(-((-101 | 37 | -92) ^ -94)), -(-((54 | -96 | -104) ^ -90)));
                }
            }
            ...
            RenderSystem.enableBlend();
            RenderSystem.defaultBlendFunc();
            GL11.glEnable(-(-((11431 | 11684 | 29624) ^ 29902)));
            CustomItems.setRenderOffHand(false);
            ref.i2 = 0;

            while(ref.i2 < -(-((-8 | -91 | 122) ^ -10))) {
                j2 = i - -(-((-87 | 94 | -74) ^ -91)) + ref.i2 * -(-((-109 | 56 | -59) ^ -21)) + 2;
                lambdaContext.k2 = blitItemY - 1;
                this.renderHotbarItem(j2, lambdaContext.k2, partialTicks, playerentity, (ItemStack)playerentity.inventory.mainInventory.get(ref.i2));
                ++ref.i2;
                if (-(-((-20 | -73 | 42) ^ 87)) != -(-((-110 | 107 | 8) ^ 65))) {
                }
            }
            ...
            if (!itemstack.isEmpty()) {
                ...
                ref.i2 = blitItemY - 1;
                if (handside == HandSide.LEFT) {
                    this.renderHotbarItem(i - -(-((61 | 127 | -51) ^ -92)) - -(-((-128 | 8 | 26) ^ -128)), ref.i2, partialTicks, playerentity, itemstack);
                    if (-(-((42 | 38 | -16) ^ -72)) != -(-((87 | 13 | 48) ^ 17))) {
                    }
                } else {
                    this.renderHotbarItem(i + -(-((119 | -114 | 26) ^ -92)) + -(-((-49 | -80 | 37) ^ -11)), ref.i2, partialTicks, playerentity, itemstack);
                }
            ...
            if (this.mc.gameSettings.attackIndicator == AttackIndicatorStatus.HOTBAR) {
                ...
                if (f < 1.0F) {
                    j2 = blitStandartY - 2;
                    lambdaContext.k2 = i + -(-((93 | -64 | 17) ^ -122)) + -(-((-13 | 107 | 122) ^ -3));
                    if (handside == HandSide.RIGHT) {
                        lambdaContext.k2 = i - -(-((123 | -99 | 89) ^ -92)) - -(-((-105 | 91 | -67) ^ -23));
                    }

                    this.mc.getTextureManager().bindTexture(AbstractGui.GUI_ICONS_LOCATION);
                    lambdaContext.l1 = (int)(f * 19.0F);
                    RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
                    this.blit(matrixStack, lambdaContext.k2, j2, 0, -(-((-32 | 43 | 92) ^ -95)), -(-((-70 | -59 | 65) ^ -19)), -(-((-104 | 23 | 127) ^ -19)));
                    this.blit(matrixStack, lambdaContext.k2, j2 + -(-((-67 | 22 | -40) ^ -19)) - lambdaContext.l1, -(-((-44 | 6 | 43) ^ -19)), -(-((-127 | 112 | 106) ^ -117)) - lambdaContext.l1, -(-((78 | 3 | -48) ^ -51)), lambdaContext.l1);
                }
            }
    ...
    public void func_238453_b_(MatrixStack p_238453_1_) {
        ...
        if (this.remainingHighlightTicks > 0 && !this.highWiksiItemStack.isEmpty()) {
            IFormattableTextComponent iformattabletextcomponent = (new StringTextComponent(""))
                    .append(this.highWiksiItemStack.getDisplayName())
                    .mergeStyle(this.highWiksiItemStack.getRarity().color);

            if (this.highWiksiItemStack.hasDisplayName()) {
            ...
            if (Reflector.IForgeItemStack_getHighlightTip.exists()) {
                itextcomponent = (ITextComponent) Reflector.call(this.highWiksiItemStack,
            ...
            if (l > 0) {
                ...
                if (Reflector.IForgeItem_getFontRenderer.exists()) {
                    fontrenderer = (FontRenderer) Reflector.call(this.highWiksiItemStack.getItem(),
                            Reflector.IForgeItem_getFontRenderer, this.highWiksiItemStack);
                }
    ...
    public void tick() {
        ...
        if (this.mc.player != null) {
            ...
            if (Reflector.IForgeItemStack_getHighlightTip.exists()) {
                ...
                ITextComponent itextcomponent1 = (ITextComponent) Reflector.call(this.highWiksiItemStack,
                        Reflector.IForgeItemStack_getHighlightTip, this.highWiksiItemStack.getDisplayName());
                flag = Config.equals(itextcomponent, itextcomponent1);
            }

            if (itemstack.isEmpty()) {
                this.remainingHighlightTicks = 0;
            } else if (!this.highWiksiItemStack.isEmpty()
                    && itemstack.getItem() == this.highWiksiItemStack.getItem()
                    && itemstack.getDisplayName().equals(this.highWiksiItemStack.getDisplayName()) && flag) {
            ...
            this.highWiksiItemStack = itemstack;
        }
    }
