...
public class FlatPresetsScreen extends Screen
{
    ...
    class SlotList extends ExtendedList<SlotList.PresetEntry>
    {
        public SlotList()
        {
        ...
        public class PresetEntry extends net.minecraft.client.gui.widget.list.AbstractList.AbstractListEntry<PresetEntry>
        {
            public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_)
            {
                LayerItem flatpresetsscreen$layeritem = FlatPresetsScreen.FLAT_WORLD_PRESETS.get(p_230432_2_);
            ...
            private void func_214399_a()
            {
                ...
                LayerItem flatpresetsscreen$layeritem = FlatPresetsScreen.FLAT_WORLD_PRESETS.get(SlotList.this.getEventListeners().indexOf(this));
