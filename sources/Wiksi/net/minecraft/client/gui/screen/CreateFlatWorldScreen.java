...
public class CreateFlatWorldScreen extends Screen
{
    ...
    class DetailsList extends ExtendedList<DetailsList.LayerEntry>
    {
        public DetailsList()
        {
        ...
        public void func_214345_a()
        {
            ...
            List<LayerEntry> list = this.getEventListeners();
        ...
        class LayerEntry extends net.minecraft.client.gui.widget.list.AbstractList.AbstractListEntry<LayerEntry>
        {
            private LayerEntry()
            {
            }
