...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = Wiksi.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.unhooked)
            addButton(Wiksi.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        Wiksi.getInstance().getViaMCP().viaScreen.tick();
