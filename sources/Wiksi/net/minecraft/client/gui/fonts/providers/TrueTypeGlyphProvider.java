            ...
            try (MemoryStack memorystack = MemoryStack.stackPush())
            {
                ...
                if (i != 0)
                {
                    ...
                    if (k != 0 && j != 0)
                    {
                        ...
                        return new GlpyhInfo(intbuffer.get(0), intbuffer2.get(0), -intbuffer1.get(0), -intbuffer3.get(0), (float)intbuffer5.get(0) * this.scale, (float)intbuffer4.get(0) * this.scale, i);
                    }
