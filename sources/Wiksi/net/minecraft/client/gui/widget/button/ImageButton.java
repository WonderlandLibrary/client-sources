...
public class ImageButton extends Button
{
    ...
    public ImageButton(int xIn, int yIn, int widthIn, int heightIn, int xTexStartIn, int yTexStartIn, int yDiffTextIn, ResourceLocation resourceLocationIn, int p_i51135_9_, int p_i51135_10_, IPressable onPressIn)
    {
    ...
    public ImageButton(int x, int y, int width, int height, int xTexStart, int yTexStart, int yDiffText, ResourceLocation resourceLocation, int textureWidth, int textureHeight, IPressable onPress, ITextComponent title)
    {
    ...
    public ImageButton(int p_i242137_1_, int p_i242137_2_, int p_i242137_3_, int p_i242137_4_, int p_i242137_5_, int p_i242137_6_, int p_i242137_7_, ResourceLocation p_i242137_8_, int p_i242137_9_, int p_i242137_10_, IPressable p_i242137_11_, ITooltip p_i242137_12_, ITextComponent p_i242137_13_)
    {
