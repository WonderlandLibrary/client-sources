...
import src.Wiksi.utils.render.RectUtil;
...
public abstract class Widget extends AbstractGui implements IRenderable, IGuiEventListener {
    ...
    public int x;
    public int y;
    int backgroundColor1 = ColorUtils.rgba(21, 21, 50, 255);
    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (isBetter) {
            ...
            int color1 = ColorUtils.multDark(HUD.getColor(0, 1), darkness);
            int color2 = ColorUtils.multDark(HUD.getColor(90, 1), darkness);
            int color3 = ColorUtils.multDark(HUD.getColor(180, 1), darkness);
            int color4 = ColorUtils.multDark(HUD.getColor(270, 1), darkness);
