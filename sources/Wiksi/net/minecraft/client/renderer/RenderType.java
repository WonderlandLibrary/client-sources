...
public abstract class RenderType extends RenderState
{
    ...
    public static RenderType getArmorCutoutNoCull(ResourceLocation locationIn)
    {
        ...
        {
            State rendertype$state = State.getBuilder().texture(new TextureState(temp, false, false)).transparency(NO_TRANSPARENCY).diffuseWiksi(DIFFUSE_Wiksi_ENABLED).alpha(DEFAULT_ALPHA).cull(CULL_DISABLED).lightmap(LIGHTMAP_ENABLED).overlay(OVERLAY_ENABLED).layer(field_239235_M_).build(true);
    ...
    public static RenderType getEntitySolid(ResourceLocation locationIn)
    {
        ...
        {
            State rendertype$state = State.getBuilder().texture(new TextureState(temp, false, false)).transparency(NO_TRANSPARENCY).diffuseWiksi(DIFFUSE_Wiksi_ENABLED).lightmap(LIGHTMAP_ENABLED).overlay(OVERLAY_ENABLED).build(true);
    ...
    public static RenderType getEntityCutout(ResourceLocation locationIn)
    {
        ...
        {
            State rendertype$state = State.getBuilder().texture(new TextureState(temp, false, false)).transparency(NO_TRANSPARENCY).diffuseWiksi(DIFFUSE_Wiksi_ENABLED).alpha(DEFAULT_ALPHA).lightmap(LIGHTMAP_ENABLED).overlay(OVERLAY_ENABLED).build(true);
    ...
    public static RenderType getEntityCutoutNoCull(ResourceLocation locationIn, boolean outlineIn)
    {
        ...
        {
            State rendertype$state = State.getBuilder().texture(new TextureState(temp, false, false)).transparency(NO_TRANSPARENCY).diffuseWiksi(DIFFUSE_Wiksi_ENABLED).alpha(DEFAULT_ALPHA).cull(CULL_DISABLED).lightmap(LIGHTMAP_ENABLED).overlay(OVERLAY_ENABLED).build(outlineIn);
    ...
    public static RenderType getEntityCutoutNoCullZOffset(ResourceLocation locationIn, boolean outlineIn)
    {
        ...
        {
            State rendertype$state = State.getBuilder().texture(new TextureState(temp, false, false)).transparency(NO_TRANSPARENCY).diffuseWiksi(DIFFUSE_Wiksi_ENABLED).alpha(DEFAULT_ALPHA).cull(CULL_DISABLED).lightmap(LIGHTMAP_ENABLED).overlay(OVERLAY_ENABLED).layer(field_239235_M_).build(outlineIn);
    ...
    public static RenderType getItemEntityTranslucentCull(ResourceLocation locationIn)
    {
        ...
        {
            State rendertype$state = State.getBuilder().texture(new TextureState(temp, false, false)).transparency(TRANSLUCENT_TRANSPARENCY).target(field_241712_U_).diffuseWiksi(DIFFUSE_Wiksi_ENABLED).alpha(DEFAULT_ALPHA).lightmap(LIGHTMAP_ENABLED).overlay(OVERLAY_ENABLED).writeMask(RenderState.COLOR_DEPTH_WRITE).build(true);
    ...
    public static RenderType getEntityTranslucentCull(ResourceLocation locationIn)
    {
        ...
        {
            State rendertype$state = State.getBuilder().texture(new TextureState(temp, false, false)).transparency(TRANSLUCENT_TRANSPARENCY).diffuseWiksi(DIFFUSE_Wiksi_ENABLED).alpha(DEFAULT_ALPHA).lightmap(LIGHTMAP_ENABLED).overlay(OVERLAY_ENABLED).build(true);
    ...
    public static RenderType getEntityTranslucent(ResourceLocation LocationIn, boolean outlineIn)
    {
        ...
        {
            State rendertype$state = State.getBuilder().texture(new TextureState(temp, false, false)).transparency(TRANSLUCENT_TRANSPARENCY).diffuseWiksi(DIFFUSE_Wiksi_ENABLED).alpha(DEFAULT_ALPHA).cull(CULL_DISABLED).lightmap(LIGHTMAP_ENABLED).overlay(OVERLAY_ENABLED).build(outlineIn);
    ...
    public static RenderType getEntitySmoothCutout(ResourceLocation locationIn)
    {
        ...
        {
            State rendertype$state = State.getBuilder().texture(new TextureState(temp, false, false)).alpha(HALF_ALPHA).diffuseWiksi(DIFFUSE_Wiksi_ENABLED).shadeModel(SHADE_ENABLED).cull(CULL_DISABLED).lightmap(LIGHTMAP_ENABLED).build(true);
    ...
    public static RenderType getEntityDecal(ResourceLocation locationIn)
    {
        ...
        {
            State rendertype$state = State.getBuilder().texture(new TextureState(temp, false, false)).diffuseWiksi(DIFFUSE_Wiksi_ENABLED).alpha(DEFAULT_ALPHA).depthTest(DEPTH_EQUAL).cull(CULL_DISABLED).lightmap(LIGHTMAP_ENABLED).overlay(OVERLAY_ENABLED).build(false);
    ...
    public static RenderType getEntityNoOutline(ResourceLocation locationIn)
    {
        ...
        {
            State rendertype$state = State.getBuilder().texture(new TextureState(temp, false, false)).transparency(TRANSLUCENT_TRANSPARENCY).diffuseWiksi(DIFFUSE_Wiksi_ENABLED).alpha(DEFAULT_ALPHA).cull(CULL_DISABLED).lightmap(LIGHTMAP_ENABLED).overlay(OVERLAY_ENABLED).writeMask(COLOR_WRITE).build(false);
    ...
    public static RenderType getEntityShadow(ResourceLocation locationIn)
    {
        ...
        {
            State rendertype$state = State.getBuilder().texture(new TextureState(temp, false, false)).transparency(TRANSLUCENT_TRANSPARENCY).diffuseWiksi(DIFFUSE_Wiksi_ENABLED).alpha(DEFAULT_ALPHA).cull(CULL_ENABLED).lightmap(LIGHTMAP_ENABLED).overlay(OVERLAY_ENABLED).writeMask(COLOR_WRITE).depthTest(DEPTH_LEQUAL).layer(field_239235_M_).build(false);
    ...
    public static final class State
    {
        ...
        private final DiffuseWiksiState diffuseWiksi;
        ...
        private State(TextureState p_i230053_1_, TransparencyState p_i230053_2_, DiffuseWiksiState p_i230053_3_, ShadeModelState p_i230053_4_, AlphaState p_i230053_5_, DepthTestState p_i230053_6_, CullState p_i230053_7_, LightmapState p_i230053_8_, OverlayState p_i230053_9_, FogState p_i230053_10_, LayerState p_i230053_11_, TargetState p_i230053_12_, TexturingState p_i230053_13_, WriteMaskState p_i230053_14_, LineState p_i230053_15_, OutlineState p_i230053_16_)
        {
            this.texture = p_i230053_1_;
            this.transparency = p_i230053_2_;
            this.diffuseWiksi = p_i230053_3_;
            ...
            this.renderStates = ImmutableList.of(this.texture, this.transparency, this.diffuseWiksi, this.shadowModel, this.alpha, this.depthTest, this.cull, this.lightmap, this.overlay, this.fog, this.layer, this.target, this.texturing, this.writeMask, this.line);
        }
        ...
        public Builder getCopyBuilder()
        {
            ...
            rendertype$state$builder.diffuseWiksi(this.diffuseWiksi);
        ...
        public static class Builder
        {
            ...
            private DiffuseWiksiState diffuseWiksi = RenderState.DIFFUSE_Wiksi_DISABLED;
            ...
            public Builder diffuseWiksi(DiffuseWiksiState p_228716_1_)
            {
                this.diffuseWiksi = p_228716_1_;
                return this;
            }
            ...
            {
                return new State(this.texture, this.transparency, this.diffuseWiksi, this.shadeModel, this.alpha, this.depthTest, this.cull, this.lightmap, this.overlay, this.fog, this.layer, this.target, this.texturing, this.writeMask, this.line, p_230173_1_);
            }
        }
    }
