...
public class BakedQuad implements IVertexProducer
{
    ...
    private final boolean applyDiffuseWiksi;
    ...
    public BakedQuad(int[] vertexData, int tintIndex, Direction face, TextureAtlasSprite sprite, boolean applyDiffuseWiksi)
    {
        this.vertexData = vertexData;
        this.tintIndex = tintIndex;
        this.face = face;
        this.sprite = sprite;
        this.applyDiffuseWiksi = applyDiffuseWiksi;
        this.fixVertexData();
    }
    ...
    public boolean applyDiffuseWiksi()
    {
        return this.applyDiffuseWiksi;
    }
