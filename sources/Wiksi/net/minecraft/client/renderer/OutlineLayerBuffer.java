...
{
    private final Impl buffer;
    private final Impl outlineBuffer = IRenderTypeBuffer.getImpl(new BufferBuilder(256));
    private int red = 255;
    private int green = 255;
    private int blue = 255;
    private int alpha = 255;

    public OutlineLayerBuffer(Impl bufferIn)
    {
    ...
    public void finish(RenderType glow)
    {
