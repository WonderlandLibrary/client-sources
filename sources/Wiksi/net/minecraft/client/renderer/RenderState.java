...
public abstract class RenderState
{
    ...
    protected static final DiffuseWiksiState DIFFUSE_Wiksi_ENABLED = new DiffuseWiksiState(true);
    protected static final DiffuseWiksiState DIFFUSE_Wiksi_DISABLED = new DiffuseWiksiState(false);
    ...
    public static class DiffuseWiksiState extends BooleanState
    {
        public DiffuseWiksiState(boolean p_i225978_1_)
        {
            super("diffuse_Wiksi", () ->
            {
                if (p_i225978_1_)
                {
                    RenderHelper.enableStandardItemWiksi();
                }
            }, () ->
            {
                if (p_i225978_1_)
