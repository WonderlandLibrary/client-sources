...
import src.Wiksi.events.EventChangeWorld;
import src.Wiksi.events.TickEvent;
...
import src.Wiksi.functions.impl.player.ItemCooldown;
...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
    ...
    public void setDefaultMinecraftTitle() {
        ...
        if (selfDestruct.unhooked) {
            ...
            this.mainWindow.setWindowTitle("WIKSI SRC | BY KNOWQE FURIOUS CLIENT");
        }
    }
    ...
    private void tick(boolean isDebug, @Nullable LongTickDetector detector) {
        Wiksi.getInstance().getEventBus().post(tickEvent);
    ...
    public void runTick() {
        ...
        if (this.world != null) {
            Wiksi.getInstance().getEventBus().post(player.tick);
    ...
    public void loadWorld(ClientWorld worldClientIn) {
        ...
        Wiksi.getInstance().getEventBus().post(new EventChangeWorld());
    }
    ...
    public void displayGuiScreen(AltWidget altWidget) {
    }
