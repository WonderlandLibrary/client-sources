...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
    ...
    public void tick() {
        if (this.world.isBlockLoaded(new BlockPos(this.getPosX(), 0.0D, this.getPosZ()))) {
            if (!Wiksi.getInstance().playerOnServer) {
                Wiksi.getInstance().playerOnServer = true;
            }

            Wiksi.getInstance().getEventBus().post(eventUpdate);
            super.tick();
    ...
    private void onUpdateWalkingPlayer() {
        ...
        Wiksi.getInstance().getEventBus().post(ea);
        ...
        if (this.isCurrentViewEntity()) {
            ...
            Wiksi.getInstance().getEventBus().post(eventMotion);
        ...
        Wiksi.getInstance().getEventBus().post(new EventPostMotion());
    ...
    public void sendChatMessage(String message) {
        ...
        CommandDispatcher commandDispatcher = Wiksi.getInstance().getCommandDispatcher();
    ...
    public void closeScreen() {
        ...
        Wiksi.getInstance().getEventBus().post(event);
        if (!event.isCancel()) {
    ...
    public void setSprinting(boolean sprinting) {
        Wiksi.getInstance().getEventBus().post(sprintEvent);
    ...
    public void livingTick() {
        ...
        if (this.isHandActive() && !this.isPassenger()) {
            Wiksi.getInstance().getEventBus().post(noSlowEvent);
    ...
    public boolean canVectorBeSeenFixed(Vector3d position) {
         return true;
    }
