...
public class DoubleNBT extends NumberNBT
{
    ...
    {
        ITextComponent itextcomponent = (new StringTextComponent("d")).mergeStyle(SYNTAX_HIGHWiksi_NUMBER_TYPE);
        return (new StringTextComponent(String.valueOf(this.data))).append(itextcomponent).mergeStyle(SYNTAX_HIGHWiksi_NUMBER);
    }
