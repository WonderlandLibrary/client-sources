...
public class ShortNBT extends NumberNBT
{
    ...
    {
        ITextComponent itextcomponent = (new StringTextComponent("s")).mergeStyle(SYNTAX_HIGHWiksi_NUMBER_TYPE);
        return (new StringTextComponent(String.valueOf((int)this.data))).append(itextcomponent).mergeStyle(SYNTAX_HIGHWiksi_NUMBER);
    }
