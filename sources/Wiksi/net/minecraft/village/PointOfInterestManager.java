...
public class PointOfInterestManager extends RegionSectionCache<PointOfInterestData>
{
    ...
    {
        return this.func_219146_b(typePredicate, pos, distance, Status.HAS_SPACE).filter((p_219129_1_) ->
        {
    ...
    private boolean isVillageCenter(long p_219154_1_)
    {
        ...
        {
            return data.getRecords(PointOfInterestType.MATCH_ANY, Status.IS_OCCUPIED).count() > 0L;
        }).orElse(false);
    }
