...
default T getRandomElement(Random random)
    ...
    public static class Builder
    {
        ...
        public Builder deserialize(JsonObject json, String identifier)
        {
            ...
            List<ITagEntry> list = Lists.newArrayList();
            ...
            {
                this.proxyTags.add(new Proxy(tagEntry, identifier));
            });
            return this;
        }
        ...
        private static ITagEntry deserializeTagEntry(JsonElement json)
        {
            ...
            if (s.startsWith("#"))
            {
                ...
                return (ITagEntry)(flag ? new TagEntry(resourcelocation1) : new OptionalTagEntry(resourcelocation1));
            }
            else
            {
                ResourceLocation resourcelocation = new ResourceLocation(s);
                return (ITagEntry)(flag ? new ItemEntry(resourcelocation) : new OptionalItemEntry(resourcelocation));
            }
        }
