...
public class ServerLoginNetHandler implements IServerLoginNetHandler
{
    ...
    public void tick()
    {
        ...
        else if (this.currentLoginState == State.DELAY_ACCEPT)
        {
    ...
    {
        Validate.validState(this.currentLoginState == State.HELLO, "Unexpected hello packet");
    ...
    {
        Validate.validState(this.currentLoginState == State.KEY, "Unexpected key packet");
