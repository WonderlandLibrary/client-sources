...
public class Heightmap
{
    ...
    {
        WORLD_SURFACE_WG("WORLD_SURFACE_WG", Usage.WORLDGEN, Heightmap.IS_NOT_AIR),
        WORLD_SURFACE("WORLD_SURFACE", Usage.CLIENT, Heightmap.IS_NOT_AIR),
        OCEAN_FLOOR_WG("OCEAN_FLOOR_WG", Usage.WORLDGEN, Heightmap.BLOCKS_MOVEMENT),
        OCEAN_FLOOR("OCEAN_FLOOR", Usage.LIVE_WORLD, Heightmap.BLOCKS_MOVEMENT),
        MOTION_BLOCKING("MOTION_BLOCKING", Usage.CLIENT, (p_222680_0_) -> {
            return p_222680_0_.getMaterial().blocksMovement() || !p_222680_0_.getFluidState().isEmpty();
        }),
        MOTION_BLOCKING_NO_LEAVES("MOTION_BLOCKING_NO_LEAVES", Usage.LIVE_WORLD, (p_222682_0_) -> {
        ...
        public static final Codec<Type> field_236078_g_ = IStringSerializable.createEnumCodec(Type::values, Type::getTypeFromId);
        private final String id;
        private final Usage usage;
        private final Predicate<BlockState> heightLimitPredicate;
        private static final Map<String, Type> BY_ID = Util.make(Maps.newHashMap(), (p_222679_0_) -> {
            for (Type heightmap$type : values())
            {
