...
public class FortressPieces
{
    ...
    public static class Corridor extends Piece
    {
        ...
        public static Corridor createPiece(List<StructurePiece> p_175879_0_, Random p_175879_1_, int p_175879_2_, int p_175879_3_, int p_175879_4_, Direction p_175879_5_, int p_175879_6_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175879_0_, mutableboundingbox) == null ? new Corridor(p_175879_6_, p_175879_1_, mutableboundingbox, p_175879_5_) : null;
        }
    ...
    public static class Corridor2 extends Piece
    {
        ...
        public static Corridor2 createPiece(List<StructurePiece> p_175876_0_, Random p_175876_1_, int p_175876_2_, int p_175876_3_, int p_175876_4_, Direction p_175876_5_, int p_175876_6_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175876_0_, mutableboundingbox) == null ? new Corridor2(p_175876_6_, p_175876_1_, mutableboundingbox, p_175876_5_) : null;
        }
    ...
    public static class Corridor3 extends Piece
    {
        ...
        public static Corridor3 createPiece(List<StructurePiece> p_175883_0_, int p_175883_1_, int p_175883_2_, int p_175883_3_, Direction p_175883_4_, int p_175883_5_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175883_0_, mutableboundingbox) == null ? new Corridor3(p_175883_5_, mutableboundingbox, p_175883_4_) : null;
        }
    ...
    public static class Corridor4 extends Piece
    {
        ...
        public static Corridor4 func_214814_a(List<StructurePiece> p_214814_0_, int p_214814_1_, int p_214814_2_, int p_214814_3_, Direction p_214814_4_, int p_214814_5_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_214814_0_, mutableboundingbox) == null ? new Corridor4(p_214814_5_, mutableboundingbox, p_214814_4_) : null;
        }
    ...
    public static class Corridor5 extends Piece
    {
        ...
        public static Corridor5 createPiece(List<StructurePiece> p_175877_0_, int p_175877_1_, int p_175877_2_, int p_175877_3_, Direction p_175877_4_, int p_175877_5_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175877_0_, mutableboundingbox) == null ? new Corridor5(p_175877_5_, mutableboundingbox, p_175877_4_) : null;
        }
    ...
    public static class Crossing extends Piece
    {
        ...
        public static Crossing createPiece(List<StructurePiece> p_175873_0_, int p_175873_1_, int p_175873_2_, int p_175873_3_, Direction p_175873_4_, int p_175873_5_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175873_0_, mutableboundingbox) == null ? new Crossing(p_175873_5_, mutableboundingbox, p_175873_4_) : null;
        }
    ...
    public static class Crossing2 extends Piece
    {
        ...
        public static Crossing2 createPiece(List<StructurePiece> p_175878_0_, int p_175878_1_, int p_175878_2_, int p_175878_3_, Direction p_175878_4_, int p_175878_5_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175878_0_, mutableboundingbox) == null ? new Crossing2(p_175878_5_, mutableboundingbox, p_175878_4_) : null;
        }
    ...
    public static class Crossing3 extends Piece
    {
        ...
        public static Crossing3 createPiece(List<StructurePiece> p_175885_0_, int p_175885_1_, int p_175885_2_, int p_175885_3_, Direction p_175885_4_, int p_175885_5_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175885_0_, mutableboundingbox) == null ? new Crossing3(p_175885_5_, mutableboundingbox, p_175885_4_) : null;
        }
    ...
    public static class End extends Piece
    {
        ...
        public static End createPiece(List<StructurePiece> p_175884_0_, Random p_175884_1_, int p_175884_2_, int p_175884_3_, int p_175884_4_, Direction p_175884_5_, int p_175884_6_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175884_0_, mutableboundingbox) == null ? new End(p_175884_6_, p_175884_1_, mutableboundingbox, p_175884_5_) : null;
        }
    ...
    public static class Entrance extends Piece
    {
        ...
        public static Entrance createPiece(List<StructurePiece> p_175881_0_, Random p_175881_1_, int p_175881_2_, int p_175881_3_, int p_175881_4_, Direction p_175881_5_, int p_175881_6_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175881_0_, mutableboundingbox) == null ? new Entrance(p_175881_6_, p_175881_1_, mutableboundingbox, p_175881_5_) : null;
        }
    ...
    public static class NetherStalkRoom extends Piece
    {
        ...
        public static NetherStalkRoom createPiece(List<StructurePiece> p_175875_0_, int p_175875_1_, int p_175875_2_, int p_175875_3_, Direction p_175875_4_, int p_175875_5_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175875_0_, mutableboundingbox) == null ? new NetherStalkRoom(p_175875_5_, mutableboundingbox, p_175875_4_) : null;
        }
    ...
    public static class Stairs extends Piece
    {
        ...
        public static Stairs createPiece(List<StructurePiece> p_175872_0_, int p_175872_1_, int p_175872_2_, int p_175872_3_, int p_175872_4_, Direction p_175872_5_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175872_0_, mutableboundingbox) == null ? new Stairs(p_175872_4_, mutableboundingbox, p_175872_5_) : null;
        }
    ...
    public static class Start extends Crossing3
    {
        ...
        public Start(Random p_i2059_1_, int p_i2059_2_, int p_i2059_3_)
        {
            ...
            for (PieceWeight fortresspieces$pieceweight : FortressPieces.PRIMARY_COMPONENTS)
            {
            ...
            for (PieceWeight fortresspieces$pieceweight1 : FortressPieces.SECONDARY_COMPONENTS)
            {
    ...
    public static class Straight extends Piece
    {
        ...
        public static Straight createPiece(List<StructurePiece> p_175882_0_, Random p_175882_1_, int p_175882_2_, int p_175882_3_, int p_175882_4_, Direction p_175882_5_, int p_175882_6_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175882_0_, mutableboundingbox) == null ? new Straight(p_175882_6_, p_175882_1_, mutableboundingbox, p_175882_5_) : null;
        }
    ...
    public static class Throne extends Piece
    {
        ...
        public static Throne createPiece(List<StructurePiece> p_175874_0_, int p_175874_1_, int p_175874_2_, int p_175874_3_, int p_175874_4_, Direction p_175874_5_)
        {
            ...
            return isAboveGround(mutableboundingbox) && StructurePiece.findIntersecting(p_175874_0_, mutableboundingbox) == null ? new Throne(p_175874_4_, mutableboundingbox, p_175874_5_) : null;
        }
