...
public class OceanRuinStructure extends Structure<OceanRuinConfig>
{
    ...
    public IStartFactory<OceanRuinConfig> getStartFactory()
    {
        return Start::new;
    }
    ...
    public static enum Type implements IStringSerializable
    {
        ...
        private static final Map<String, Type> BY_NAME = Arrays.stream(values()).collect(Collectors.toMap(Type::getName, (p_215134_0_) -> {
            return p_215134_0_;
        }));
