...
import src.Wiksi.events.EventCalculateCooldown;
import src.Wiksi.events.EventCooldown;
...
public class CooldownTracker {
    ...
    public float getCooldown(Item itemIn, float partialTicks) {
        ...
        Wiksi.getInstance().getEventBus().post(cooldown);
        ...
        if (!this.cooldowns.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                if ((entry.getValue()).expireTicks <= this.ticks) {
                    ...
                    Wiksi.getInstance().getEventBus().post(eventCooldown);
                    iterator.remove();
