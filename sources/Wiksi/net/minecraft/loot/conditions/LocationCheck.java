...
public class LocationCheck implements ILootCondition
{
    ...
    public static IBuilder builder(LocationPredicate.Builder p_215975_0_)
    {
        return () ->
        {
    ...
    public static IBuilder func_241547_a_(LocationPredicate.Builder p_241547_0_, BlockPos p_241547_1_)
    {
        return () ->
        {
