...
extends TabGui {
    ...
    private static final int INSIDE_COLOR = -16777215;
    ...
    public boolean onRender(Render2DEvent event) {
        if (super.onRender(event)) {
            ...
            RenderUtils.rectangle(2.0, 14.0, 2 + baseCategoryWidth, 14 + baseCategoryHeight, -16777215);
            ...
            if (section == Section.MODS) {
                RenderUtils.rectangle(baseCategoryWidth + 4, categoryPosition - 1, baseCategoryWidth + 2 + baseModWidth, categoryPosition + LucidTabGui.getModsInCategory(Module.Category.values()[categoryTab]).size() * 14 + 1, -16777215);
