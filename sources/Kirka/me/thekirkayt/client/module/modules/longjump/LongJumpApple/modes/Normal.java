 ...
 */
package me.thekirkayt.client.module.modules.longjump.LongJumpApple.modes;

import java.util.List;
import me.thekirkayt.client.module.Module;
import me.thekirkayt.client.module.modules.longjump.LongJumpApple;
import me.thekirkayt.client.module.modules.longjump.LongJumpApple.LongJumpAppleMode;
...
extends LongJumpAppleMode {
    ...
    public /* synthetic */ boolean onMove(MoveEvent event) {
        if (super.onMove(event)) {
            boolean setY = false;
            if (ClientUtils.player().moveForward != 0.0f || ClientUtils.player().moveStrafing != 0.0f) {
                if (LongJumpApple.stage == 0) {
                    this.moveSpeed = 1.0 + SpeedNCP.getBaseMoveSpeed() - 0.05;
                } else if (LongJumpApple.stage == 1) {
                    ClientUtils.player().motionY = 0.42;
                    event.setY(0.42);
                    this.moveSpeed *= 2.13;
                } else if (LongJumpApple.stage == 2) {
