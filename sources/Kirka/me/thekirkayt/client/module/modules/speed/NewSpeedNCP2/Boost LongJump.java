    ...
    public boolean onMove(MoveEvent moveEvent) {
        if (super.onMove(moveEvent)) {
            ...
            if (this.stage == 1 && (ClientUtils.player().moveForward != 0.0f || ClientUtils.player().moveStrafing != 0.0f)) {
                this.stage = 2;
                this.moveSpeed = ClientUtils.player().isPotionActive(Potion.moveSpeed) ? 3.5 * NewSpeedNCP2.getBaseMoveSpeed() : NewSpeedNCP2.boost * NewSpeedNCP2.getBaseMoveSpeed();
                ...
                this.stage = 4;
                double d = 0.66 * (this.lastDist - NewSpeedNCP2.getBaseMoveSpeed());
            ...
            ClientUtils.setMoveSpeed(moveEvent, this.stage != 0 ? (this.moveSpeed = Math.max(this.moveSpeed, NewSpeedNCP2.getBaseMoveSpeed())) : 0.15);
        }
        return true;
    }
