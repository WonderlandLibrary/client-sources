...
public enum ModelRotation {
    ...
    private ModelRotation(String p_i46087_1_, int p_i46087_2_, int p_i46087_3_, int p_i46087_4_) {
        ...
        var5.setIdentity();
        var5.setRotation(new AxisAngle4d(1.0, 0.0, 0.0, (double)((float)(-p_i46087_3_) * 0.017453292f)));
    ...
    public static ModelRotation func_177524_a(int p_177524_0_, int p_177524_1_) {
        return (ModelRotation)((Object)field_177546_q.get(ModelRotation.func_177521_b(MathHelper.func_180184_b(p_177524_0_, 360), MathHelper.func_180184_b(p_177524_1_, 360))));
    }
}
