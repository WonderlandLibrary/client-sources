...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        for (EnumPlayerModelParts var5 : EnumPlayerModelParts.values()) {
            this.buttonList.add(new ButtonPart(var5.func_179328_b(), width / 2 - 155 + var1 % 2 * 160, height / 6 + 24 * (var1 >> 1), 150, 20, var5, null));
            ++var1;
        }
        if (var1 % 2 == 1) {
            ++var1;
        }
        this.buttonList.add(new GuiButton(200, width / 2 - 100, height / 6 + 24 * (var1 >> 1), I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_175360_f, width / 2, 20, 16777215);
