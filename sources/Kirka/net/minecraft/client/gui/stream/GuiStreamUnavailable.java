...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int var4 = Math.max((int)((double)height * 0.85 / 2.0 - (double)((float)(this.field_152323_r.size() * this.fontRendererObj.FONT_HEIGHT) / 2.0f)), 50);
        ...
        for (String var6 : this.field_152323_r) {
            this.drawCenteredString(this.fontRendererObj, var6, width / 2, var4, 10526880);
