...
extends GuiScreen {
    ...
    extends GuiSlot {
        ...
        public ServerList(Minecraft mcIn) {
            super(mcIn, width, height, 32, height - 35, (int)((double)mcIn.fontRendererObj.FONT_HEIGHT * 3.5));
        ...
        protected void drawSlot(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
            ...
            GuiIngestServers.drawString(GuiIngestServers.this.fontRendererObj, var7.serverName, p_180791_2_ + 2, p_180791_3_ + 5, 16777215);
            GuiIngestServers.drawString(GuiIngestServers.this.fontRendererObj, var8, p_180791_2_ + 2, p_180791_3_ + GuiIngestServers.access$0((GuiIngestServers)GuiIngestServers.this).FONT_HEIGHT + 5 + 3, 3158064);
            GuiIngestServers.drawString(GuiIngestServers.this.fontRendererObj, var9, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(var9), p_180791_3_ + 5, 8421504);
            if (var10 != null) {
                GuiIngestServers.drawString(GuiIngestServers.this.fontRendererObj, var10, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(var10), p_180791_3_ + 5 + 3 + GuiIngestServers.access$0((GuiIngestServers)GuiIngestServers.this).FONT_HEIGHT, 8421504);
            }
        }
