...
implements IProgressMeter {
    ...
    public void createButtons() {
        ...
        GuiButton var1 = new GuiButton(2, width / 2 - 80, height - 52, 80, 20, I18n.format("stat.blocksButton", new Object[0]));
        this.buttonList.add(var1);
        GuiButton var2 = new GuiButton(3, width / 2, height - 52, 80, 20, I18n.format("stat.itemsButton", new Object[0]));
        this.buttonList.add(var2);
        GuiButton var3 = new GuiButton(4, width / 2 + 80, height - 52, 80, 20, I18n.format("stat.mobsButton", new Object[0]));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            this.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), width / 2, height / 2, 16777215);
    ...
    extends GuiSlot {
        ...
        public StatsMobsList(Minecraft mcIn) {
            super(mcIn, width, height, 32, height - 64, GuiStats.access$2((GuiStats)GuiStats.this).FONT_HEIGHT * 4);
