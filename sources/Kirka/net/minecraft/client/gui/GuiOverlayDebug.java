...
extends Gui {
    ...
    protected void func_175239_b(ScaledResolution p_175239_1_) {
        ...
        for (int var3 = 0; var3 < var2.size(); ++var3) {
            ...
            int var7 = ScaledResolution.getScaledWidth() - 2 - var6;
    ...
    protected List call() {
        ...
        if (this.func_175236_d()) {
            return Lists.newArrayList((Object[])new String[]{"Minecraft 1.8 (" + this.mc.func_175600_c() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, Minecraft.renderGlobal.getDebugInfoRenders(), Minecraft.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + Minecraft.theWorld.getDebugLoadedEntities(), Minecraft.theWorld.getProviderName(), "", String.format("Chunk-relative: %d %d %d", var1.getX() & 15, var1.getY() & 15, var1.getZ() & 15)});
        }
        ...
        ArrayList var5 = Lists.newArrayList((Object[])new String[]{"Minecraft 1.8 (" + this.mc.func_175600_c() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, Minecraft.renderGlobal.getDebugInfoRenders(), Minecraft.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + Minecraft.theWorld.getDebugLoadedEntities(), Minecraft.theWorld.getProviderName(), "", String.format("XYZ: %.3f / %.5f / %.3f", this.mc.func_175606_aa().posX, this.mc.func_175606_aa().getEntityBoundingBox().minY, this.mc.func_175606_aa().posZ), String.format("Block: %d %d %d", var1.getX(), var1.getY(), var1.getZ()), String.format("Chunk: %d %d %d in %d %d %d", var1.getX() & 15, var1.getY() & 15, var1.getZ() & 15, var1.getX() >> 4, var1.getY() >> 4, var1.getZ() >> 4), String.format("Facing: %s (%s) (%.1f / %.1f)", var3, var4, Float.valueOf(MathHelper.wrapAngleTo180_float(var2.rotationYaw)), Float.valueOf(MathHelper.wrapAngleTo180_float(var2.rotationPitch)))});
        if (Minecraft.theWorld != null && Minecraft.theWorld.isBlockLoaded(var1)) {
            ...
            if (this.mc.isIntegratedServerRunning() && this.mc.getIntegratedServer() != null && (var8 = this.mc.getIntegratedServer().getConfigurationManager().func_177451_a(Minecraft.thePlayer.getUniqueID())) != null) {
