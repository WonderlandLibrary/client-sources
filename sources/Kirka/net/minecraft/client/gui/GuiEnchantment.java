...
extends GuiContainer {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        for (int var6 = 0; var6 < 3; ++var6) {
            ...
            if (var7 < 0 || var8 < 0 || var7 >= 108 || var8 >= 19 || !this.field_147075_G.enchantItem(Minecraft.thePlayer, var6)) continue;
            Minecraft.playerController.sendEnchantPacket(this.field_147075_G.windowId, var6);
        }
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        GlStateManager.viewport((ScaledResolution.getScaledWidth() - 320) / 2 * var6.getScaleFactor(), (ScaledResolution.getScaledHeight() - 240) / 2 * var6.getScaleFactor(), 320 * var6.getScaleFactor(), 240 * var6.getScaleFactor());
