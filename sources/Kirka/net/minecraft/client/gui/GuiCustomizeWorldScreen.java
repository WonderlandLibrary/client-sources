...
GuiPageButtonList.GuiResponder {
    ...
    private void func_175325_f() {
        ...
        this.field_175349_r = new GuiPageButtonList(this.mc, width, height, 32, height - 32, 25, this, var1, var2, var3, var4);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.field_175339_B != 0) {
            GuiCustomizeWorldScreen.drawRect(0, 0, width, height, Integer.MIN_VALUE);
            ...
            var7.addVertexWithUV(width / 2 - 90, 185.0, 0.0, 0.0, 2.65625);
            var7.addVertexWithUV(width / 2 + 90, 185.0, 0.0, 5.625, 2.65625);
            var7.addVertexWithUV(width / 2 + 90, 100.0, 0.0, 5.625, 0.0);
            var7.addVertexWithUV(width / 2 - 90, 100.0, 0.0, 0.0, 0.0);
            var6.draw();
            this.drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirmTitle", new Object[0]), width / 2, 105, 16777215);
            this.drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirm1", new Object[0]), width / 2, 125, 16777215);
            this.drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirm2", new Object[0]), width / 2, 135, 16777215);
