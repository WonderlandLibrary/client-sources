...
implements GuiYesNoCallback {
    ...
    public void drawBackground(int tint) {
        ...
        var3.addVertexWithUV(0.0, height, 0.0, 0.0, (float)height / var4 + (float)tint);
        var3.addVertexWithUV(width, height, 0.0, (float)width / var4, (float)height / var4 + (float)tint);
        var3.addVertexWithUV(width, 0.0, 0.0, (float)width / var4, tint);
