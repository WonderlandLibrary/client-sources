...
public class RenderChunk {
    ...
    public void func_178581_b(float p_178581_1_, float p_178581_2_, float p_178581_3_, ChunkCompileTaskGenerator p_178581_4_) {
        ...
        if (!var9.extendedLevelsInChunkCache()) {
            ++field_178592_a;
            for (BlockPosM var20 : BlockPosM.getAllInBoxMutable(var7, var8)) {
                TileEntity var23;
                ...
                if (var22.hasTileEntity() && (var23 = var9.getTileEntity(new BlockPos(var20))) != null && TileEntityRendererDispatcher.instance.hasSpecialRenderer(var23)) {
                    var5.func_178490_a(var23);
                }
                EnumWorldBlockLayer var231 = var22.getBlockLayer();
            ...
            for (EnumWorldBlockLayer var231 : EnumWorldBlockLayer.values()) {
                if (!var5.func_178492_d(var231)) continue;
    ...
    public ChunkCompileTaskGenerator func_178582_e() {
        ...
        try {
            if (this.field_178599_i == null || this.field_178599_i.func_178546_a() != ChunkCompileTaskGenerator.Status.PENDING) {
                ...
                ChunkCompileTaskGenerator chunkCompileTaskGenerator = var2 = (var12 = this.field_178599_i);
