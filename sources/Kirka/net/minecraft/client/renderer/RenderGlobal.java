...
IResourceManagerReloadListener {
    ...
    public RenderGlobal(Minecraft mcIn) {
        this.mc = mcIn;
        this.field_175010_j = Minecraft.getRenderManager();
    ...
    protected boolean func_174985_d() {
        return this.field_175015_z != null && this.field_174991_A != null && Minecraft.thePlayer != null && Minecraft.thePlayer.func_175149_v() && this.mc.gameSettings.field_178883_an.getIsKeyPressed();
    }
    ...
    public void func_180446_a(Entity p_180446_1_, ICamera p_180446_2_, float partialTicks) {
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            for (var18 = 0; var18 < this.theWorld.weatherEffects.size(); ++var18) {
                ...
                if (!var19.isInRangeToRender3d(var4, var6, var8)) continue;
            ...
            if (this.func_174985_d()) {
                ...
                for (var18 = 0; var18 < var17.size(); ++var18) {
                    ...
                    boolean bl = var26 = var19.isInRangeToRender3d(var4, var6, var8) && (var19.ignoreFrustumCheck || p_180446_2_.isBoundingBoxInFrustum(var19.getEntityBoundingBox()) || var19.riddenByEntity == Minecraft.thePlayer) && var19 instanceof EntityPlayer;
                    if (var19 == this.mc.func_175606_aa() && this.mc.gameSettings.thirdPersonView == 0 && !var25 || !var26) continue;
                    this.field_175010_j.renderEntitySimple(var19, partialTicks);
                }
            ...
            Iterator<Object> var321 = this.glRenderLists.iterator();
            ...
            while (var321.hasNext()) {
                ...
                while (((Iterator)var27).hasNext()) {
                    ...
                    boolean bl = var34 = this.field_175010_j.func_178635_a(var30, p_180446_2_, var4, var6, var8) || var30.riddenByEntity == Minecraft.thePlayer;
                    if (var34) {
                        boolean teClass;
                        boolean bl2 = teClass = this.mc.func_175606_aa() instanceof EntityLivingBase ? ((EntityLivingBase)this.mc.func_175606_aa()).isPlayerSleeping() : false;
                        if (var30 == this.mc.func_175606_aa() && this.mc.gameSettings.thirdPersonView == 0 && !teClass || var30.posY >= 0.0 && var30.posY < 256.0 && !this.theWorld.isBlockLoaded(new BlockPos(var30))) continue;
                        ++this.countEntitiesRendered;
                    ...
                    if (var34 || !(var30 instanceof EntityWitherSkull)) continue;
                    Minecraft.getRenderManager().func_178630_b(var30, partialTicks);
                }
            }
            ...
            RenderHelper.enableStandardItemLighting();
            for (ContainerLocalRenderInformation var33 : this.glRenderLists) {
            ...
            this.func_180443_s();
            for (DestroyBlockProgress var37 : this.damagedBlocks.values()) {
                ...
                if (var35 == null || !(var41 instanceof BlockChest) && !(var41 instanceof BlockEnderChest) && !(var41 instanceof BlockSign) && !(var41 instanceof BlockSkull)) continue;
        ...
        if (!var22 && this.displayListEntitiesDirty) {
            ...
            if (var20 == null) {
                ...
                for (int var45 = -this.renderDistanceChunks; var45 <= this.renderDistanceChunks; ++var45) {
                    for (int var46 = -this.renderDistanceChunks; var46 <= this.renderDistanceChunks; ++var46) {
                        ...
                        if (var30 == null || !camera.isBoundingBoxInFrustum(var30.field_178591_c)) continue;
            ...
            while (!var36.isEmpty()) {
                ...
                for (EnumFacing var32 : EnumFacing.VALUES) {
                    ...
                    if (var37 && var39.field_178035_c.contains(var32.getOpposite()) || var37 && var391 != null && !var41.func_178571_g().func_178495_a(var391.getOpposite(), var32) || var33 == null || !var33.func_178577_a(frameCount) || !camera.isBoundingBoxInFrustum(var33.field_178591_c)) continue;
    ...
    public int func_174977_a(EnumWorldBlockLayer blockLayerIn, double partialTicks, int pass, Entity entityIn) {
        ...
        for (int var11 = var161; var11 != var9; var11 += var171) {
            ...
            if (var181.func_178571_g().func_178491_b(blockLayerIn)) continue;
            ++var151;
    ...
    public void func_174976_a(float partialTicks, int pass) {
        Object var4;
        WorldProvider var3;
        if (Reflector.ForgeWorldProvider_getSkyRenderer.exists() && (var4 = Reflector.call(var3 = Minecraft.theWorld.provider, Reflector.ForgeWorldProvider_getSkyRenderer, new Object[0])) != null) {
        ...
        if (Minecraft.theWorld.provider.getDimensionId() == 1) {
            ...
            var221 = CustomColorizer.getSkyColor(var221, Minecraft.theWorld, this.mc.func_175606_aa().posX, this.mc.func_175606_aa().posY + 1.0, this.mc.func_175606_aa().posZ);
            ...
            if (var261 != null && Config.isSunMoonEnabled()) {
                ...
                for (var31 = 0; var31 <= 16; ++var31) {
                    var22 = (float)var31 * 3.1415927f * 2.0f / 16.0f;
            ...
            double var29 = Minecraft.thePlayer.func_174824_e((float)partialTicks).yCoord - this.theWorld.getHorizon();
            if (var29 < 0.0) {
                GlStateManager.pushMatrix();
    ...
    public void func_180447_b(float p_180447_1_, int p_180447_2_) {
        if (!Config.isCloudsOff()) {
            ...
            Object var3;
            if (Reflector.ForgeWorldProvider_getCloudRenderer.exists() && (var3 = Reflector.call(partialTicks = Minecraft.theWorld.provider, Reflector.ForgeWorldProvider_getCloudRenderer, new Object[0])) != null) {
            ...
            if (Minecraft.theWorld.provider.isSurfaceWorld()) {
                if (Config.isCloudsFancy()) {
                    ...
                    if (this.isFancyGlListClouds || this.cloudTickCounter >= this.cloudTickCounterGlList + 20) {
                        ...
                        var12 = 4.8828125E-4f;
                        exactPlayerZ1 = (float)this.cloudTickCounter + p_180447_1_;
                        dc = this.mc.func_175606_aa().prevPosX + (this.mc.func_175606_aa().posX - this.mc.func_175606_aa().prevPosX) * (double)p_180447_1_ + exactPlayerZ1 * 0.029999999329447746;
                        ...
                        int var20 = MathHelper.floor_double(cdx / 2048.0);
                        float var21 = this.theWorld.provider.getCloudHeight() - var31 + 0.33f;
                        var21 += this.mc.gameSettings.ofCloudsHeight * 128.0f;
                        float var22 = (float)((dc -= (double)(cdz * 2048)) * 4.8828125E-4);
                        float var23 = (float)((cdx -= (double)(var20 * 2048)) * 4.8828125E-4);
    ...
    private void func_180445_c(float p_180445_1_, int p_180445_2_) {
        ...
        double var10 = (this.mc.func_175606_aa().prevPosX + (this.mc.func_175606_aa().posX - this.mc.func_175606_aa().prevPosX) * (double)p_180445_1_ + var8 * 0.029999999329447746) / 12.0;
        double var12 = (this.mc.func_175606_aa().prevPosZ + (this.mc.func_175606_aa().posZ - this.mc.func_175606_aa().prevPosZ) * (double)p_180445_1_) / 12.0 + 0.33000001311302185;
        ...
        for (int var29 = 0; var29 < 2; ++var29) {
                    ...
                    for (int exactPlayerX = -3; exactPlayerX <= 4; ++exactPlayerX) {
                        ...
                        if (entityliving > -1) {
                            ...
                            for (var36 = 0; var36 < 8; ++var36) {
                                var5.addVertexWithUV(var34 + (float)var36 + 0.0f, var14 + 0.0f, exactPlayerZ + 8.0f, (var32 + (float)var36 + 0.5f) * 0.00390625f + var22, (exactPlayerY + 8.0f) * 0.00390625f + var23);
                                var5.addVertexWithUV(var34 + (float)var36 + 0.0f, var14 + 4.0f, exactPlayerZ + 8.0f, (var32 + (float)var36 + 0.5f) * 0.00390625f + var22, (exactPlayerY + 8.0f) * 0.00390625f + var23);
                                var5.addVertexWithUV(var34 + (float)var36 + 0.0f, var14 + 4.0f, exactPlayerZ + 0.0f, (var32 + (float)var36 + 0.5f) * 0.00390625f + var22, (exactPlayerY + 0.0f) * 0.00390625f + var23);
                                var5.addVertexWithUV(var34 + (float)var36 + 0.0f, var14 + 0.0f, exactPlayerZ + 0.0f, (var32 + (float)var36 + 0.5f) * 0.00390625f + var22, (exactPlayerY + 0.0f) * 0.00390625f + var23);
                            }
                        }
                        if (entityliving <= 1) {
                            var5.func_178980_d(1.0f, 0.0f, 0.0f);
                            for (var36 = 0; var36 < 8; ++var36) {
                                var5.addVertexWithUV(var34 + (float)var36 + 1.0f - 9.765625E-4f, var14 + 0.0f, exactPlayerZ + 8.0f, (var32 + (float)var36 + 0.5f) * 0.00390625f + var22, (exactPlayerY + 8.0f) * 0.00390625f + var23);
                                var5.addVertexWithUV(var34 + (float)var36 + 1.0f - 9.765625E-4f, var14 + 4.0f, exactPlayerZ + 8.0f, (var32 + (float)var36 + 0.5f) * 0.00390625f + var22, (exactPlayerY + 8.0f) * 0.00390625f + var23);
                                var5.addVertexWithUV(var34 + (float)var36 + 1.0f - 9.765625E-4f, var14 + 4.0f, exactPlayerZ + 0.0f, (var32 + (float)var36 + 0.5f) * 0.00390625f + var22, (exactPlayerY + 0.0f) * 0.00390625f + var23);
                                var5.addVertexWithUV(var34 + (float)var36 + 1.0f - 9.765625E-4f, var14 + 0.0f, exactPlayerZ + 0.0f, (var32 + (float)var36 + 0.5f) * 0.00390625f + var22, (exactPlayerY + 0.0f) * 0.00390625f + var23);
                            }
                        }
                        ...
                        if (exactPlayerX > -1) {
                            ...
                            for (var36 = 0; var36 < 8; ++var36) {
                                var5.addVertexWithUV(var34 + 0.0f, var14 + 4.0f, exactPlayerZ + (float)var36 + 0.0f, (var32 + 0.0f) * 0.00390625f + var22, (exactPlayerY + (float)var36 + 0.5f) * 0.00390625f + var23);
                                var5.addVertexWithUV(var34 + 8.0f, var14 + 4.0f, exactPlayerZ + (float)var36 + 0.0f, (var32 + 8.0f) * 0.00390625f + var22, (exactPlayerY + (float)var36 + 0.5f) * 0.00390625f + var23);
                                var5.addVertexWithUV(var34 + 8.0f, var14 + 0.0f, exactPlayerZ + (float)var36 + 0.0f, (var32 + 8.0f) * 0.00390625f + var22, (exactPlayerY + (float)var36 + 0.5f) * 0.00390625f + var23);
                                var5.addVertexWithUV(var34 + 0.0f, var14 + 0.0f, exactPlayerZ + (float)var36 + 0.0f, (var32 + 0.0f) * 0.00390625f + var22, (exactPlayerY + (float)var36 + 0.5f) * 0.00390625f + var23);
                            }
                        }
                        if (exactPlayerX <= 1) {
                            var5.func_178980_d(0.0f, 0.0f, 1.0f);
                            for (var36 = 0; var36 < 8; ++var36) {
                                var5.addVertexWithUV(var34 + 0.0f, var14 + 4.0f, exactPlayerZ + (float)var36 + 1.0f - 9.765625E-4f, (var32 + 0.0f) * 0.00390625f + var22, (exactPlayerY + (float)var36 + 0.5f) * 0.00390625f + var23);
                                var5.addVertexWithUV(var34 + 8.0f, var14 + 4.0f, exactPlayerZ + (float)var36 + 1.0f - 9.765625E-4f, (var32 + 8.0f) * 0.00390625f + var22, (exactPlayerY + (float)var36 + 0.5f) * 0.00390625f + var23);
                                var5.addVertexWithUV(var34 + 8.0f, var14 + 0.0f, exactPlayerZ + (float)var36 + 1.0f - 9.765625E-4f, (var32 + 8.0f) * 0.00390625f + var22, (exactPlayerY + (float)var36 + 0.5f) * 0.00390625f + var23);
                                var5.addVertexWithUV(var34 + 0.0f, var14 + 0.0f, exactPlayerZ + (float)var36 + 1.0f - 9.765625E-4f, (var32 + 0.0f) * 0.00390625f + var22, (exactPlayerY + (float)var36 + 0.5f) * 0.00390625f + var23);
                            }
                        }
                        var4.draw();
                    }
            ...
            double dc = (float)(this.cloudTickCounter - this.cloudTickCounterGlList) + partialTicks;
            float cdx = (float)(var44 - this.cloudPlayerX + dc * 0.03);
    ...
    public void func_174981_a(Tessellator p_174981_1_, WorldRenderer p_174981_2_, Entity p_174981_3_, float p_174981_4_) {
        ...
        if (!this.damagedBlocks.isEmpty()) {
            ...
            while (var11.hasNext()) {
                ...
                if (var20 instanceof BlockChest || var20 instanceof BlockEnderChest || var20 instanceof BlockSign || var20 instanceof BlockSkull) continue;
    ...
    public void drawSelectionBox(EntityPlayer p_72731_1_, MovingObjectPosition p_72731_2_, int p_72731_3_, float p_72731_4_) {
        if (p_72731_3_ == 0 && p_72731_2_.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (var7.getMaterial() != Material.air && this.theWorld.getWorldBorder().contains(var6)) {
                ...
                RenderGlobal.drawOutlinedBoundingBox(var7.getSelectedBoundingBox(this.theWorld, var6).expand(0.0020000000949949026, 0.0020000000949949026, 0.0020000000949949026).offset(-var8, -var10, -var12), -1);
            }
            GlStateManager.depthMask(true);
            GlStateManager.bindTexture();
            GlStateManager.disableBlend();
        ...
        switch (p_180439_2_) {
            ...
            case 2002: {
                ...
                for (int var18 = 0; var18 < 100; ++var18) {
                    ...
                    double var21 = var5.nextDouble() * 3.141592653589793 * 2.0;
