...
import me.thekirkayt.client.module.modules.render.Blocking;
import me.thekirkayt.client.module.modules.render.SwordTransitions;
...
public class ItemRenderer {
    ...
    public ItemRenderer(Minecraft mcIn) {
        this.mc = mcIn;
        this.field_178111_g = Minecraft.getRenderManager();
    ...
    public void renderItemInFirstPerson(float p_78440_1_) {
        ...
        if (this.itemToRender != null) {
            ...
            if (this.itemToRender.getItem() != null && this.itemToRender.getItem() instanceof ItemSword && new Blocking().getInstance().isEnabled()) {
                ...
                if (var3.getItemInUseCount() > 0) {
                    ...
                    GL11.glTranslatef((float)-0.05f, (float)(Minecraft.thePlayer.isSneaking() ? -0.2f : 0.0f), (float)0.1f);
                }
                ...
                switch (SwitchEnumAction.field_178094_a[var7.ordinal()]) {
                    ...
                    case 4: {
                        this.func_178096_b(var2 + 0.0f, var4);
                        this.func_178103_d();
                        if (var7 != EnumAction.BLOCK) break;
                        SwordTransitions mod = (SwordTransitions)new SwordTransitions().getInstance();
                        GL11.glTranslated((double)(-0.25 + (mod.isEnabled() ? mod.getX() : 0.0)), (double)(0.2 + (mod.isEnabled() ? mod.getY() : 0.0)), (double)(mod.isEnabled() ? mod.getZ() : 0.0));
                        GL11.glTranslatef((float)-0.05f, (float)(Minecraft.thePlayer.isSneaking() ? -0.2f : 0.0f), (float)0.1f);
                        break;
                    }
                    case 5: {
