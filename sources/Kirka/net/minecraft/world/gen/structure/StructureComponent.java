    ...
    protected boolean isLiquidInStructureBoundingBox(World worldIn, StructureBoundingBox p_74860_2_) {
        ...
        for (var9 = var3; var9 <= var6; ++var9) {
            for (var10 = var5; var10 <= var8; ++var10) {
                ...
                if (!worldIn.getBlockState(new BlockPos(var9, var7, var10)).getBlock().getMaterial().isLiquid()) continue;
                return true;
            }
        }
        for (var9 = var3; var9 <= var6; ++var9) {
            for (var10 = var4; var10 <= var7; ++var10) {
                ...
                if (!worldIn.getBlockState(new BlockPos(var9, var10, var8)).getBlock().getMaterial().isLiquid()) continue;
                return true;
            }
        }
        for (var9 = var5; var9 <= var8; ++var9) {
            for (var10 = var4; var10 <= var7; ++var10) {
                ...
                if (!worldIn.getBlockState(new BlockPos(var6, var10, var9)).getBlock().getMaterial().isLiquid()) continue;
                return true;
            }
        }
        return false;
        ...
        for (int var12 = p_175804_4_; var12 <= p_175804_7_; ++var12) {
            for (int var13 = p_175804_3_; var13 <= p_175804_6_; ++var13) {
                for (int var14 = p_175804_5_; var14 <= p_175804_8_; ++var14) {
                    if (p_175804_11_ && this.func_175807_a(worldIn, var13, var12, var14, p_175804_2_).getBlock().getMaterial() == Material.air) continue;
        ...
        for (int var12 = p_74882_4_; var12 <= p_74882_7_; ++var12) {
            for (int var13 = p_74882_3_; var13 <= p_74882_6_; ++var13) {
                for (int var14 = p_74882_5_; var14 <= p_74882_8_; ++var14) {
                    if (p_74882_9_ && this.func_175807_a(worldIn, var13, var12, var14, p_74882_2_).getBlock().getMaterial() == Material.air) continue;
        ...
        for (int var14 = p_175805_6_; var14 <= p_175805_9_; ++var14) {
            for (int var15 = p_175805_5_; var15 <= p_175805_8_; ++var15) {
                for (int var16 = p_175805_7_; var16 <= p_175805_10_; ++var16) {
                    if (!(p_175805_3_.nextFloat() <= p_175805_4_) || p_175805_13_ && this.func_175807_a(worldIn, var15, var14, var16, p_175805_2_).getBlock().getMaterial() == Material.air) continue;
        ...
        for (int var16 = p_180777_4_; var16 <= p_180777_7_; ++var16) {
            ...
            for (int var18 = p_180777_3_; var18 <= p_180777_6_; ++var18) {
                ...
                for (int var20 = p_180777_5_; var20 <= p_180777_8_; ++var20) {
                    ...
                    if (p_180777_10_ && this.func_175807_a(worldIn, var18, var16, var20, p_180777_2_).getBlock().getMaterial() == Material.air || !((var22 = var19 * var19 + var17 * var17 + var21 * var21) <= 1.05f)) continue;
