...
implements IBlockAccess {
    ...
    public void updateEntityWithOptionalForce(Entity p_72866_1_, boolean p_72866_2_) {
        ...
        int var2 = MathHelper.floor_double(p_72866_1_.posZ);
        var3 = 32;
        if (!p_72866_2_ || this.isAreaLoaded(var3 - var3, 0, var2 - var3, var3 + var3, 0, var2 + var3, true)) {
            ...
            int var4 = MathHelper.floor_double(p_72866_1_.posX / 16.0);
            int var5 = MathHelper.floor_double(p_72866_1_.posY / 16.0);
            int var6 = MathHelper.floor_double(p_72866_1_.posZ / 16.0);
            if (!p_72866_1_.addedToChunk || p_72866_1_.chunkCoordX != var4 || p_72866_1_.chunkCoordY != var5 || p_72866_1_.chunkCoordZ != var6) {
                ...
                if (this.isChunkLoaded(var4, var6, true)) {
                    p_72866_1_.addedToChunk = true;
                    this.getChunkFromChunkCoords(var4, var6).addEntity(p_72866_1_);
                } else {
