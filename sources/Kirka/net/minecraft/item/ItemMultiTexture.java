...
extends ItemBlock {
    ...
    public ItemMultiTexture(Block p_i45346_1_, Block p_i45346_2_, String[] p_i45346_3_) {
        this(p_i45346_1_, p_i45346_2_, new Function(){
            ...
            public String apply(ItemStack p_179541_1_) {
                ...
                if (var2 < 0 || var2 >= val$p_i45346_3_.length) {
                    var2 = 0;
                }
                return val$p_i45346_3_[var2];
            }
    ...
    public String getUnlocalizedName(ItemStack stack) {
        return String.valueOf(super.getUnlocalizedName()) + "." + (String)this.nameFunction.apply((Object)stack);
    }
