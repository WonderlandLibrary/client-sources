...
import me.thekirkayt.client.module.modules.world.X-Ray;
...
public class Block {
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
        if (X-Ray.isXray) {
            return X-Ray.filterBlocks(this);
        }
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List list, Entity collidingEntity) {
        ...
        BlockBB eventb = new BlockBB(pos.getX(), pos.getY(), pos.getZ(), state.getBlock(), var7);
        BoundingBoxEvent event = new BoundingBoxEvent(this, pos, var7);
        Minecraft.getMinecraft();
        if (collidingEntity == Minecraft.thePlayer) {
            event.call();
            eventb.call();
        }
        var7 = event.getBoundingBox();
        var7 = eventb.getBoundingBox();
