...
implements Serializable {
    ...
    protected void findCenter() {
        ...
        for (int i = 0; i < length; i += 2) {
            float[] arrf = this.center;
            arrf[0] = arrf[0] + this.points[i];
            float[] arrf2 = this.center;
            arrf2[1] = arrf2[1] + this.points[i + 1];
        }
        float[] arrf = this.center;
        arrf[0] = arrf[0] / (float)(length / 2);
        float[] arrf3 = this.center;
        arrf3[1] = arrf3[1] / (float)(length / 2);
    }
