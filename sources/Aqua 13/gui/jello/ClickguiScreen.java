...
public class ClickguiScreen extends GuiScreen {
   ...
   public void initGui() {
      ...
      for(Category category : Category.values()) {
         ...
         CategoryPaneOwn categoryPane = new CategoryPaneOwn(x, y, 98, 20, category, this);
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      if (Aqua.moduleManager.getModuleByName("Blur").isToggled() && !Aqua.moduleManager.getModuleByName("GuiElements").isToggled()) {
         Blur.drawBlurred(() -> Gui.drawRect2(0.0, 0.0, (double)this.mc.displayWidth, (double)this.mc.displayHeight, -1), false);
      }
