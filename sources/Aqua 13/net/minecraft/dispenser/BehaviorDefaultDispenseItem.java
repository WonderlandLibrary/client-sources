...
public class BehaviorDefaultDispenseItem implements IBehaviorDispenseItem {
   ...
   public static void doDispense(World worldIn, ItemStack stack, int speed, EnumFacing facing, IPosition position) {
      ...
      entityitem.motionX += worldIn.rand.nextGaussian() * 0.0075F * (double)speed;
      entityitem.motionY += worldIn.rand.nextGaussian() * 0.0075F * (double)speed;
      entityitem.motionZ += worldIn.rand.nextGaussian() * 0.0075F * (double)speed;
