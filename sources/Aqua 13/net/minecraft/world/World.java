...
public abstract class World implements IBlockAccess {
   ...
   public void updateEntities() {
      ...
      for(int i1 = 0; i1 < this.loadedEntityList.size(); ++i1) {
         ...
         if (!entity2.isDead || Minecraft.getMinecraft().thePlayer.isDead && entity2 instanceof EntityPlayerSP) {
            try {
   ...
   public void updateEntity(Entity ent) {
      this.updateEntityWithOptionalForce(ent, ent != Minecraft.getMinecraft().thePlayer || !Minecraft.getMinecraft().thePlayer.isDead);
   }
