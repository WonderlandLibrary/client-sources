...
public class MapGenCavesHell extends MapGenBase {
   protected void func_180705_a(
      long p_180705_1_, int p_180705_3_, int p_180705_4_, ChunkPrimer p_180705_5_, double p_180705_6_, double p_180705_8_, double p_180705_10_
   ) {
      this.func_180704_a(
         p_180705_1_,
         p_180705_3_,
   ...
   protected void func_180704_a(
      ...
      for(boolean flag = random.nextInt(6) == 0; p_180704_15_ < p_180704_16_; ++p_180704_15_) {
         ...
         if (flag1 || random.nextInt(4) != 0) {
            ...
            if (p_180704_6_ >= d0 - 16.0 - d2 * 2.0
               && p_180704_10_ >= d1 - 16.0 - d2 * 2.0
               && p_180704_6_ <= d0 + 16.0 + d2 * 2.0
               && p_180704_10_ <= d1 + 16.0 + d2 * 2.0) {
