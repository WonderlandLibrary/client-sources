...
public class ChunkProviderGenerate implements IChunkProvider {
   ...
   public void replaceBlocksForBiome(int x, int z, ChunkPrimer primer, BiomeGenBase[] biomeGens) {
      double d0 = 0.03125;
      this.stoneNoise = this.field_147430_m.func_151599_a(this.stoneNoise, (double)(x * 16), (double)(z * 16), 16, 16, d0 * 2.0, d0 * 2.0, 1.0);
   ...
   private void func_147423_a(int x, int y, int z) {
      this.depthNoiseArray = this.noiseGen6
         .generateNoiseOctaves(
            this.depthNoiseArray,
            x,
            z,
            5,
            5,
      ...
      this.mainNoiseArray = this.field_147429_l
         .generateNoiseOctaves(
            this.mainNoiseArray,
            x,
            y,
      ...
      for(int k = 0; k < 5; ++k) {
         for(int l = 0; l < 5; ++l) {
            ...
            for(int l1 = 0; l1 < 33; ++l1) {
               ...
               double d4 = (this.mainNoiseArray[i] / 10.0 + 1.0) / 2.0;
