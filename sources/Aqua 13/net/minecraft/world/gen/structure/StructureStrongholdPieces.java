...
public class StructureStrongholdPieces {
   ...
   private static StructureComponent func_175953_c(
   ...
   public static class Library extends StructureStrongholdPieces.Stronghold {
      ...
      public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
         if (this.isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn)) {
            ...
            this.func_175805_a(
               worldIn, structureBoundingBoxIn, randomIn, 0.07F, 2, 1, 1, 11, 4, 13, Blocks.web.getDefaultState(), Blocks.web.getDefaultState(), false
            );
            int j = 1;
            int k = 12;
   ...
   abstract static class Stronghold extends StructureComponent {
      ...
      protected StructureComponent getNextComponentNormal(
         StructureStrongholdPieces.Stairs2 p_74986_1_, List<StructureComponent> p_74986_2_, Random p_74986_3_, int p_74986_4_, int p_74986_5_
      ) {
         if (this.coordBaseMode != null) {
            switch(this.coordBaseMode) {
               case SOUTH:
                  return StructureStrongholdPieces.func_175953_c(
                     ...
                     this.boundingBox.minY + p_74986_5_,
