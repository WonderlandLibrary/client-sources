...
public class ChunkProviderEnd implements IChunkProvider {
   ...
   private double[] initializeNoiseField(double[] p_73187_1_, int p_73187_2_, int p_73187_3_, int p_73187_4_, int p_73187_5_, int p_73187_6_, int p_73187_7_) {
      ...
      d0 *= 2.0;
      this.noiseData1 = this.noiseGen3
         .generateNoiseOctaves(this.noiseData1, p_73187_2_, p_73187_3_, p_73187_4_, p_73187_5_, p_73187_6_, p_73187_7_, d0 / 80.0, d1 / 160.0, d0 / 80.0);
      this.noiseData2 = this.noiseGen1
         .generateNoiseOctaves(this.noiseData2, p_73187_2_, p_73187_3_, p_73187_4_, p_73187_5_, p_73187_6_, p_73187_7_, d0, d1, d0);
      this.noiseData3 = this.noiseGen2
         .generateNoiseOctaves(this.noiseData3, p_73187_2_, p_73187_3_, p_73187_4_, p_73187_5_, p_73187_6_, p_73187_7_, d0, d1, d0);
      int i = 0;
      ...
      for(int j = 0; j < p_73187_5_; ++j) {
         for(int k = 0; k < p_73187_7_; ++k) {
            ...
            for(int l = 0; l < p_73187_6_; ++l) {
               ...
               int var34 = 8;
               if (l < var34) {
                  double d7 = (double)((float)(var34 - l) / ((float)var34 - 1.0F));
