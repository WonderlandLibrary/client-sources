...
public class GenLayerShore extends GenLayer {
      ...
      for(int i = 0; i < areaHeight; ++i) {
         for(int j = 0; j < areaWidth; ++j) {
            ...
            if (k == BiomeGenBase.mushroomIsland.biomeID) {
               ...
               if (j2 != BiomeGenBase.ocean.biomeID
                  && i3 != BiomeGenBase.ocean.biomeID
                  && l3 != BiomeGenBase.ocean.biomeID
                  && k4 != BiomeGenBase.ocean.biomeID) {
            ...
            } else if (biomegenbase != null && biomegenbase.isSnowyBiome()) {
               ...
               if (isBiomeOceanic(l) || isBiomeOceanic(i1) || isBiomeOceanic(j1) || isBiomeOceanic(k1)) {
                  aint1[j + i * areaWidth] = k;
               } else if (this.func_151633_d(l) && this.func_151633_d(i1) && this.func_151633_d(j1) && this.func_151633_d(k1)) {
                  aint1[j + i * areaWidth] = k;
               } else {
                  aint1[j + i * areaWidth] = BiomeGenBase.desert.biomeID;
               }
            } else if (k != BiomeGenBase.ocean.biomeID
               && k != BiomeGenBase.deepOcean.biomeID
   ...
   private boolean func_151631_c(int p_151631_1_) {
      return BiomeGenBase.getBiome(p_151631_1_) != null && BiomeGenBase.getBiome(p_151631_1_).getBiomeClass() == BiomeGenJungle.class
         ? true
         : p_151631_1_ == BiomeGenBase.jungleEdge.biomeID
