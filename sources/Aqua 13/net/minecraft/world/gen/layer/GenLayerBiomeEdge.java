...
public class GenLayerBiomeEdge extends GenLayer {
   ...
   public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight) {
      ...
      for(int i = 0; i < areaHeight; ++i) {
         for(int j = 0; j < areaWidth; ++j) {
            ...
            if (!this.replaceBiomeEdgeIfNecessary(aint, aint1, j, i, areaWidth, k, BiomeGenBase.extremeHills.biomeID, BiomeGenBase.extremeHillsEdge.biomeID)
               && !this.replaceBiomeEdge(aint, aint1, j, i, areaWidth, k, BiomeGenBase.mesaPlateau_F.biomeID, BiomeGenBase.mesa.biomeID)
               && !this.replaceBiomeEdge(aint, aint1, j, i, areaWidth, k, BiomeGenBase.mesaPlateau.biomeID, BiomeGenBase.mesa.biomeID)
               && !this.replaceBiomeEdge(aint, aint1, j, i, areaWidth, k, BiomeGenBase.megaTaiga.biomeID, BiomeGenBase.taiga.biomeID)) {
               if (k == BiomeGenBase.desert.biomeID) {
                  ...
                  if (l1 != BiomeGenBase.icePlains.biomeID
                     && i2 != BiomeGenBase.icePlains.biomeID
                     && j2 != BiomeGenBase.icePlains.biomeID
                     && k2 != BiomeGenBase.icePlains.biomeID) {
                  ...
                  if (l == BiomeGenBase.desert.biomeID
                     || i1 == BiomeGenBase.desert.biomeID
                     || j1 == BiomeGenBase.desert.biomeID
                     || k1 == BiomeGenBase.desert.biomeID
                     || l == BiomeGenBase.coldTaiga.biomeID
                     || i1 == BiomeGenBase.coldTaiga.biomeID
                     || j1 == BiomeGenBase.coldTaiga.biomeID
                     || k1 == BiomeGenBase.coldTaiga.biomeID
                     || l == BiomeGenBase.icePlains.biomeID
                     || i1 == BiomeGenBase.icePlains.biomeID
                     || j1 == BiomeGenBase.icePlains.biomeID
                     || k1 == BiomeGenBase.icePlains.biomeID) {
                     aint1[j + i * areaWidth] = BiomeGenBase.plains.biomeID;
                  } else if (l != BiomeGenBase.jungle.biomeID
                     && k1 != BiomeGenBase.jungle.biomeID
                     && i1 != BiomeGenBase.jungle.biomeID
                     && j1 != BiomeGenBase.jungle.biomeID) {
                     aint1[j + i * areaWidth] = k;
                  } else {
   ...
   private boolean replaceBiomeEdgeIfNecessary(
      int[] p_151636_1_, int[] p_151636_2_, int p_151636_3_, int p_151636_4_, int p_151636_5_, int p_151636_6_, int p_151636_7_, int p_151636_8_
   ) {
      if (!biomesEqualOrMesaPlateau(p_151636_6_, p_151636_7_)) {
         ...
         if (this.canBiomesBeNeighbors(i, p_151636_7_)
            && this.canBiomesBeNeighbors(j, p_151636_7_)
            && this.canBiomesBeNeighbors(k, p_151636_7_)
            && this.canBiomesBeNeighbors(l, p_151636_7_)) {
   ...
   private boolean replaceBiomeEdge(
      int[] p_151635_1_, int[] p_151635_2_, int p_151635_3_, int p_151635_4_, int p_151635_5_, int p_151635_6_, int p_151635_7_, int p_151635_8_
   ) {
      if (p_151635_6_ != p_151635_7_) {
         ...
         if (biomesEqualOrMesaPlateau(i, p_151635_7_)
            && biomesEqualOrMesaPlateau(j, p_151635_7_)
            && biomesEqualOrMesaPlateau(k, p_151635_7_)
            && biomesEqualOrMesaPlateau(l, p_151635_7_)) {
