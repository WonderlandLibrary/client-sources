   ...
   public void onUpdateNavigation() {
      ...
      if (!this.noPath()) {
         ...
         if (!this.noPath()) {
            ...
            if (vec32 != null) {
               AxisAlignedBB axisalignedbb1 = new AxisAlignedBB(vec32.xCoord, vec32.yCoord, vec32.zCoord, vec32.xCoord, vec32.yCoord, vec32.zCoord)
                  .expand(0.5, 0.5, 0.5);
