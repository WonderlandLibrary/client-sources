...
public class EntitySheep extends EntityAnimal {
      ...
      return this.sheepTimer <= 0
         ...
         : (
            this.sheepTimer >= 4 && this.sheepTimer <= 36
               ? 1.0F
               : (this.sheepTimer < 4 ? ((float)this.sheepTimer - p_70894_1_) / 4.0F : -((float)(this.sheepTimer - 40) - p_70894_1_) / 4.0F)
         );
   }
   ...
   public float getHeadRotationAngleX(float p_70890_1_) {
      if (this.sheepTimer > 4 && this.sheepTimer <= 36) {
         ...
         return ((float) (Math.PI / 5)) + 0.2199115F * MathHelper.sin(f * 28.7F);
      } else {
   ...
   public static EnumDyeColor getRandomSheepColor(Random random) {
      ...
      return i < 5
         ...
         : (
            i < 10
               ? EnumDyeColor.GRAY
               : (i < 15 ? EnumDyeColor.SILVER : (i < 18 ? EnumDyeColor.BROWN : (random.nextInt(500) == 0 ? EnumDyeColor.PINK : EnumDyeColor.WHITE)))
         );
   }
