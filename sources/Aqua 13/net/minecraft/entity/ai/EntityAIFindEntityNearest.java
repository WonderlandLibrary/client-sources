...
public class EntityAIFindEntityNearest extends EntityAIBase {
      ...
      this.field_179443_c = new Predicate<EntityLivingBase>() {
         public boolean apply(EntityLivingBase p_apply_1_) {
            ...
            return p_apply_1_.isInvisible()
               ? false
               : (
                  (double)p_apply_1_.getDistanceToEntity(EntityAIFindEntityNearest.this.mob) > d0
                     ? false
                     : EntityAITarget.isSuitableTarget(EntityAIFindEntityNearest.this.mob, p_apply_1_, false, true)
               );
         }
      };
   ...
   public boolean shouldExecute() {
      ...
      List<EntityLivingBase> list = this.mob
         .worldObj
         .getEntitiesWithinAABB(this.field_179439_f, this.mob.getEntityBoundingBox().expand(d0, 4.0, d0), this.field_179443_c);
   ...
   public boolean continueExecuting() {
      ...
      if (entitylivingbase == null) {
         ...
         double d0 = this.getFollowRange();
         return this.mob.getDistanceSqToEntity(entitylivingbase) > d0 * d0
            ? false
