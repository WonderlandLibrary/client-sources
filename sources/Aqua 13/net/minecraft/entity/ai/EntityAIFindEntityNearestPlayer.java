...
public class EntityAIFindEntityNearestPlayer extends EntityAIBase {
      ...
      this.predicate = new Predicate<Entity>() {
         public boolean apply(Entity p_apply_1_) {
            if (!(p_apply_1_ instanceof EntityPlayer)) {
               ...
               return (double)p_apply_1_.getDistanceToEntity(EntityAIFindEntityNearestPlayer.this.entityLiving) > d0
                  ? false
                  : EntityAITarget.isSuitableTarget(EntityAIFindEntityNearestPlayer.this.entityLiving, (EntityLivingBase)p_apply_1_, false, true);
            }
         }
      };
   ...
   public boolean shouldExecute() {
      ...
      List<EntityPlayer> list = this.entityLiving
         .worldObj
         .getEntitiesWithinAABB(EntityPlayer.class, this.entityLiving.getEntityBoundingBox().expand(d0, 4.0, d0), this.predicate);
   ...
   public boolean continueExecuting() {
      ...
      if (entitylivingbase == null) {
         ...
         if (team != null && team1 == team) {
            ...
            double d0 = this.maxTargetRange();
            return this.entityLiving.getDistanceSqToEntity(entitylivingbase) > d0 * d0
               ? false
