...
public class EntityBlaze extends EntityMob {
   ...
   public void onLivingUpdate() {
      ...
      if (this.worldObj.isRemote) {
         if (this.rand.nextInt(24) == 0 && !this.isSilent()) {
            this.worldObj
               .playSound(
                  this.posX + 0.5, this.posY + 0.5, this.posZ + 0.5, "fire.fire", 1.0F + this.rand.nextFloat(), this.rand.nextFloat() * 0.7F + 0.3F, false
               );
         }
   ...
   protected void updateAITasks() {
      ...
      if (entitylivingbase != null
         && entitylivingbase.posY + (double)entitylivingbase.getEyeHeight() > this.posY + (double)this.getEyeHeight() + (double)this.heightOffset) {
         this.motionY += (0.3F - this.motionY) * 0.3F;
   ...
   static class AIFireballAttack extends EntityAIBase {
      ...
      public void updateTask() {
         ...
         if (d0 < 4.0) {
            ...
            double d2 = entitylivingbase.getEntityBoundingBox().minY
            ...
            if (this.field_179468_c <= 0) {
               ...
               if (this.field_179467_b > 1) {
                  ...
                  this.blaze
                     .worldObj
                     .playAuxSFXAtEntity((EntityPlayer)null, 1009, new BlockPos((int)this.blaze.posX, (int)this.blaze.posY, (int)this.blaze.posZ), 0);

                  for(int i = 0; i < 1; ++i) {
                     EntitySmallFireball entitysmallfireball = new EntitySmallFireball(
                        this.blaze.worldObj,
                        this.blaze,
                        d1 + this.blaze.getRNG().nextGaussian() * (double)f,
                        d2,
