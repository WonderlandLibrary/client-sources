...
public class EntityZombie extends EntityMob {
   protected static final IAttribute reinforcementChance = new RangedAttribute((IAttribute)null, "zombie.spawnReinforcements", 0.0, 0.0, 1.0)
            ...
            for(int l = 0; l < 50; ++l) {
               ...
               if (World.doesBlockHaveSolidTopSurface(this.worldObj, new BlockPos(i1, j1 - 1, k1))
                  ...
                  if (!this.worldObj.isAnyPlayerWithinRangeAt((double)i1, (double)j1, (double)k1, 7.0)
                     ...
                     entityzombie.getEntityAttribute(reinforcementChance)
