...
public abstract class EntityLivingBase extends Entity {
   ...
   public int realPosY;
   public int realPosZ;
   public int realServerPosX;
   public int realServerPosY;
   public int realServerPosZ;
   public Vec3 realPos;
   public Vec3 realLastPos;
   public AxisAlignedBB realBoundingBox = null;
   ...
   private int getArmSwingAnimationEnd() {
      HeldItem.hitSpeed = (float)Aqua.setmgr.getSetting("HeldItemSpeed").getCurrentNumber();
      return this.isPotionActive(Potion.digSpeed)
         ? 6 - (1 + this.getActivePotionEffect(Potion.digSpeed).getAmplifier())
         : (int)(
            this.isPotionActive(Potion.digSlowdown) ? (float)(6 + (1 + this.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2) : HeldItem.hitSpeed
         );
   }
   ...
   protected void jump() {
      ...
      if (this.isSprinting()) {
         if (Aqua.setmgr.getSetting("KillauraJumpFix").isState() && Killaura.target != null) {
            float f = EventPreMotion.getYaw() * (float) (Math.PI / 180.0);
