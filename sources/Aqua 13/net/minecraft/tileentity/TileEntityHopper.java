...
public class TileEntityHopper extends TileEntityLockable implements IHopper, ITickable {
   ...
   public static boolean captureDroppedItems(IHopper p_145891_0_) {
      ...
      if (iinventory != null) {
         ...
         for(EntityItem entityitem : func_181556_a(p_145891_0_.getWorld(), p_145891_0_.getXPos(), p_145891_0_.getYPos() + 1.0, p_145891_0_.getZPos())) {
   ...
   private IInventory getInventoryForHopperTransfer() {
      ...
      return getInventoryAtPosition(
         this.getWorld(),
         (double)(this.pos.getX() + enumfacing.getFrontOffsetX()),
   ...
   public static List<EntityItem> func_181556_a(World p_181556_0_, double p_181556_1_, double p_181556_3_, double p_181556_5_) {
      return p_181556_0_.getEntitiesWithinAABB(
         EntityItem.class,
         new AxisAlignedBB(p_181556_1_ - 0.5, p_181556_3_ - 0.5, p_181556_5_ - 0.5, p_181556_1_ + 0.5, p_181556_3_ + 0.5, p_181556_5_ + 0.5),
   ...
   public static IInventory getInventoryAtPosition(World worldIn, double x, double y, double z) {
      ...
      if (iinventory == null) {
         List<Entity> list = worldIn.getEntitiesInAABBexcluding(
            (Entity)null, new AxisAlignedBB(x - 0.5, y - 0.5, z - 0.5, x + 0.5, y + 0.5, z + 0.5), EntitySelectors.selectInventories
         );
         if (list.size() > 0) {
