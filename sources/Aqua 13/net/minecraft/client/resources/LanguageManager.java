   ...
   public void parseLanguageMetadata(List<IResourcePack> resourcesPacks) {
      ...
      for(IResourcePack iresourcepack : resourcesPacks) {
         try {
            ...
            logger.warn("Unable to parse metadata section of resourcepack: " + iresourcepack.getPackName(), (Throwable)var7);
         } catch (IOException var8) {
            logger.warn("Unable to parse metadata section of resourcepack: " + iresourcepack.getPackName(), (Throwable)var8);
         }
      }
   }
