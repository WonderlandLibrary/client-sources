...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
   ...
   public void drawBackground(int tint) {
      ...
      worldrenderer.pos(0.0, (double)height, 0.0).tex(0.0, (double)((float)height / 32.0F + (float)tint)).color(64, 64, 64, 255).endVertex();
      worldrenderer.pos((double)width, (double)height, 0.0)
         .tex((double)((float)width / 32.0F), (double)((float)height / 32.0F + (float)tint))
         .color(64, 64, 64, 255)
         .endVertex();
      worldrenderer.pos((double)width, 0.0, 0.0).tex((double)((float)width / 32.0F), (double)tint).color(64, 64, 64, 255).endVertex();
      worldrenderer.pos(0.0, 0.0, 0.0).tex(0.0, (double)tint).color(64, 64, 64, 255).endVertex();
      tessellator.draw();
   }
