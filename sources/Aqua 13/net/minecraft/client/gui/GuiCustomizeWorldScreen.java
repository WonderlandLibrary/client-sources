...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
   ...
   public void initGui() {
      ...
      this.buttonList
         .add(this.field_175346_u = new GuiButton(304, width / 2 - 187, height - 27, 90, 20, I18n.format("createWorld.customize.custom.defaults")));
      this.buttonList
         .add(this.field_175347_t = new GuiButton(301, width / 2 - 92, height - 27, 90, 20, I18n.format("createWorld.customize.custom.randomize")));
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.field_175339_B != 0) {
         ...
         worldrenderer.pos((double)(width / 2 - 90), 185.0, 0.0).tex(0.0, 2.65625).color(64, 64, 64, 64).endVertex();
         worldrenderer.pos((double)(width / 2 + 90), 185.0, 0.0).tex(5.625, 2.65625).color(64, 64, 64, 64).endVertex();
         worldrenderer.pos((double)(width / 2 + 90), 100.0, 0.0).tex(5.625, 0.0).color(64, 64, 64, 64).endVertex();
         worldrenderer.pos((double)(width / 2 - 90), 100.0, 0.0).tex(0.0, 0.0).color(64, 64, 64, 64).endVertex();
         tessellator.draw();
