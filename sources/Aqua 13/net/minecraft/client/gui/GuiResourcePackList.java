...
public abstract class GuiResourcePackList extends GuiListExtended {
   ...
   public GuiResourcePackList(Minecraft mcIn, int p_i45055_2_, int p_i45055_3_, List<ResourcePackListEntry> p_i45055_4_) {
      ...
      this.setHasListHeader(true, (int)((float)FontRenderer.FONT_HEIGHT * 1.5F));
   }
   ...
   protected void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_) {
      ...
      this.mc
         .fontRendererObj
         .drawString(s, p_148129_1_ + this.width / 2 - this.mc.fontRendererObj.getStringWidth(s) / 2, Math.min(this.top + 3, p_148129_2_), 16777215);
   }
