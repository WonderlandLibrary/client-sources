      ...
      if (this.buttonsNotDrawn && i >= 0) {
         ...
         for(int l = 0; l <= 2; ++l) {
            ...
            for(int k1 = 0; k1 < i1; ++k1) {
               ...
               GuiBeacon.PowerButton guibeacon$powerbutton = new GuiBeacon.PowerButton(
                  l << 8 | l1, this.guiLeft + 76 + k1 * 24 - j1 / 2, this.guiTop + 22 + l * 25, l1, l
               );
         ...
         for(int l2 = 0; l2 < j2 - 1; ++l2) {
            ...
            GuiBeacon.PowerButton guibeacon$powerbutton2 = new GuiBeacon.PowerButton(
               i2 << 8 | i3, this.guiLeft + 167 + l2 * 24 - k2 / 2, this.guiTop + 47, i3, i2
            );
         ...
         if (j > 0) {
            GuiBeacon.PowerButton guibeacon$powerbutton1 = new GuiBeacon.PowerButton(
               i2 << 8 | j, this.guiLeft + 167 + (j2 - 1) * 24 - k2 / 2, this.guiTop + 47, j, i2
            );
