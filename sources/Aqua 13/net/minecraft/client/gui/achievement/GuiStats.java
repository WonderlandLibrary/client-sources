...
public class GuiStats extends GuiScreen implements IProgressMeter {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      if (this.doesGuiPauseGame) {
         ...
         this.drawCenteredString(
            ...
            width / 2,
            height / 2 + FontRenderer.FONT_HEIGHT * 2,
            16777215
         );
      } else {
   ...
   class StatsGeneral extends GuiSlot {
      ...
      protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
         ...
         GuiStats.this.drawString(
            GuiStats.this.fontRendererObj,
            statbase.getStatName().getUnformattedText(),
            p_180791_2_ + 2,
            p_180791_3_ + 1,
   ...
   class StatsMobsList extends GuiSlot {
      ...
      public StatsMobsList(Minecraft mcIn) {
         int var10002 = GuiStats.width;
         int var10003 = GuiStats.height;
         int var10005 = GuiStats.height - 64;
         GuiStats.this.fontRendererObj;
         super(mcIn, var10002, var10003, 32, var10005, FontRenderer.FONT_HEIGHT * 4);
      ...
      @Override
      protected int getContentHeight() {
         int var10000 = this.getSize();
         GuiStats.this.fontRendererObj;
         return var10000 * FontRenderer.FONT_HEIGHT * 4;
      }
      ...
      protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
         ...
         FontRenderer var10001 = GuiStats.this.fontRendererObj;
         int var10003 = p_180791_2_ + 2;
         int var10004 = p_180791_3_ + 1;
         GuiStats.this.fontRendererObj;
         var10000.drawString(var10001, s1, var10003, var10004 + FontRenderer.FONT_HEIGHT, i == 0 ? 6316128 : 9474192);
         var10000 = GuiStats.this;
         var10001 = GuiStats.this.fontRendererObj;
         var10003 = p_180791_2_ + 2;
         var10004 = p_180791_3_ + 1;
         GuiStats.this.fontRendererObj;
         var10000.drawString(var10001, s2, var10003, var10004 + FontRenderer.FONT_HEIGHT * 2, j == 0 ? 6316128 : 9474192);
      }
   }
}
