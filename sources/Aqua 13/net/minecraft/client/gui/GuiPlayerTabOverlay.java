...
public class GuiPlayerTabOverlay extends Gui {
   ...
   public static String getIrcPrefix(String name, GameProfile pr) {
      try {
         ...
         if (ircPlayer != null) {
            String client = ThemeScreen.themeHero ? "Hero" : "Aqua";
   ...
   public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn) {
      ...
      for(NetworkPlayerInfo networkplayerinfo : list) {
         String prefix = getIrcPrefix(this.getPlayerName(networkplayerinfo), networkplayerinfo.getGameProfile());
      ...
      if (list1 != null) {
         ...
         Shadow.drawGlow(
            () -> drawRect(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + finalList.size() * FontRenderer.FONT_HEIGHT, Integer.MIN_VALUE), false
         );
         drawRect(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + list1.size() * FontRenderer.FONT_HEIGHT, Integer.MIN_VALUE);

         for(String s3 : list1) {
            int i2 = this.mc.fontRendererObj.getStringWidth(s3);
            Shadow.drawGlow(() -> this.mc.fontRendererObj.drawStringWithShadow(s3, (float)(width / 2 - i2 / 2), (float)k1, -1), false);
      ...
      int finalL = l1;
      Shadow.drawGlow(() -> drawRect(width / 2 - finalL / 2 - 1, k1 - 1, width / 2 + finalL / 2 + 1, k1 + i4 * 9, Integer.MIN_VALUE), false);
      ...
      if (list2 != null) {
         k1 = k1 + i4 * 9 + 1;
         drawRect(width / 2 - l1 / 2 - 1, k1 - 1, width / 2 + l1 / 2 + 1, k1 + list2.size() * FontRenderer.FONT_HEIGHT, Integer.MIN_VALUE);
