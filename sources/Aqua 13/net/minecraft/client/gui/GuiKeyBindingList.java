...
public class GuiKeyBindingList extends GuiListExtended {
   ...
   public GuiKeyBindingList(GuiControls controls, Minecraft mcIn) {
      ...
      this.mc = mcIn;
      KeyBinding[] akeybinding = ArrayUtils.clone((KeyBinding[])mcIn.gameSettings.keyBindings);
   ...
   public class CategoryEntry implements GuiListExtended.IGuiListEntry {
      ...
      public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
         int var10002 = GuiScreen.width / 2 - this.labelWidth / 2;
         GuiKeyBindingList.this.mc.fontRendererObj.drawString(this.labelText, var10002, y + slotHeight - FontRenderer.FONT_HEIGHT - 1, 16777215);
      }
   ...
   public class KeyEntry implements GuiListExtended.IGuiListEntry {
      ...
      public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
         ...
         GuiKeyBindingList.this.mc
            .fontRendererObj
            .drawString(this.keyDesc, x + 90 - GuiKeyBindingList.this.maxListLabelWidth, y + slotHeight / 2 - FontRenderer.FONT_HEIGHT / 2, 16777215);
