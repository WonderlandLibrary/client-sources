...
public class RenderChunk {
   ...
   public ChunkCompileTaskGenerator makeCompileTaskTransparency() {
      ...
      ChunkCompileTaskGenerator var3;
      try {
         ...
         var3 = chunkcompiletaskgenerator2;
      } finally {
         this.lockCompileTask.unlock();
      }
   ...
   protected RegionRenderCache createRegionRenderCache(
      World p_createRegionRenderCache_1_, BlockPos p_createRegionRenderCache_2_, BlockPos p_createRegionRenderCache_3_, int p_createRegionRenderCache_4_
   ) {
