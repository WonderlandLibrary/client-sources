...
public class EntityRenderer implements IResourceManagerReloadListener {
      ...
      if (entity != null && this.mc.theWorld != null) {
         ...
         List<Entity> list = this.mc
            ...
            .getEntitiesInAABBexcluding(
               entity,
               entity.getEntityBoundingBox().addCoord(vec31.xCoord * d0, vec31.yCoord * d0, vec31.zCoord * d0).expand(1.0, 1.0, 1.0),
               ...
               if (biomegenbase.canRain() || biomegenbase.getEnableSnow()) {
                  ...
                  if (k2 != l2) {
                     ...
                     if (world.getWorldChunkManager().getTemperatureAtHeight(f1, j2) >= 0.15F) {
                        ...
                        int k3 = j3 >> 16 & 65535;
                        int l3 = j3 & 65535;
                        worldrenderer.pos((double)l1 - d3 + 0.5, (double)k2, (double)k1 - d4 + 0.5)
                        ...
                        worldrenderer.pos((double)l1 + d3 + 0.5, (double)k2, (double)k1 + d4 + 0.5)
                           ...
                           .lightmap(k3, l3)
                           .endVertex();
                        worldrenderer.pos((double)l1 + d3 + 0.5, (double)l2, (double)k1 + d4 + 0.5)
   ...
   private void updateFogColor(float partialTicks) {
      ...
      if (this.mc.gameSettings.renderDistanceChunks >= 4) {
         double d0 = -1.0;
         Vec3 vec32 = MathHelper.sin(world.getCelestialAngleRadians(partialTicks)) > 0.0F ? new Vec3(-1.0, 0.0, 0.0) : new Vec3(1.0, 0.0, 0.0);
