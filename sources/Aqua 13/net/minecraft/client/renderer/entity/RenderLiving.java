   ...
   protected void renderLeash(T entityLivingIn, double x, double y, double z, float entityYaw, float partialTicks) {
      if (!Config.isShaders() || !Shaders.isShadowPass) {
         ...
         if (entity != null) {
            ...
            double d0 = this.interpolateValue((double)entity.prevRotationYaw, (double)entity.rotationYaw, (double)(partialTicks * 0.5F))
               * (float) (Math.PI / 180.0);
            double d1 = this.interpolateValue((double)entity.prevRotationPitch, (double)entity.rotationPitch, (double)(partialTicks * 0.5F))
               * (float) (Math.PI / 180.0);
            ...
            double d7 = this.interpolateValue(
                  entity.prevPosY + (double)entity.getEyeHeight() * 0.7, entity.posY + (double)entity.getEyeHeight() * 0.7, (double)partialTicks
               )
               - d4 * 0.5
               - 0.25;
            double d8 = this.interpolateValue(entity.prevPosZ, entity.posZ, (double)partialTicks) - d3 * 0.7 + d2 * 0.5 * d5;
            double d9 = this.interpolateValue((double)entityLivingIn.prevRenderYawOffset, (double)entityLivingIn.renderYawOffset, (double)partialTicks)
                  * (float) (Math.PI / 180.0)
               + (Math.PI / 2);
            ...
            for(int j = 0; j <= 24; ++j) {
               ...
               worldrenderer.pos(
                     x + d13 * (double)f3 + 0.0, y + d14 * (double)(f3 * f3 + f3) * 0.5 + (double)((24.0F - (float)j) / 18.0F + 0.125F), z + d15 * (double)f3
                  )
                  .color(f, f1, f2, 1.0F)
                  .endVertex();
               worldrenderer.pos(
                     x + d13 * (double)f3 + 0.025,
                     y + d14 * (double)(f3 * f3 + f3) * 0.5 + (double)((24.0F - (float)j) / 18.0F + 0.125F) + 0.025,
                     z + d15 * (double)f3
                  )
                  .color(f, f1, f2, 1.0F)
                  .endVertex();
            ...
            for(int k = 0; k <= 24; ++k) {
               ...
               worldrenderer.pos(
                     x + d13 * (double)f7 + 0.0,
                     y + d14 * (double)(f7 * f7 + f7) * 0.5 + (double)((24.0F - (float)k) / 18.0F + 0.125F) + 0.025,
                     z + d15 * (double)f7
                  )
                  .color(f4, f5, f6, 1.0F)
                  .endVertex();
               worldrenderer.pos(
                     x + d13 * (double)f7 + 0.025,
                     y + d14 * (double)(f7 * f7 + f7) * 0.5 + (double)((24.0F - (float)k) / 18.0F + 0.125F),
                     z + d15 * (double)f7 + 0.025
                  )
                  .color(f4, f5, f6, 1.0F)
                  .endVertex();
            }
