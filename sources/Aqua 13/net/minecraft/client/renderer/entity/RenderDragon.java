...
public class RenderDragon extends RenderLiving<EntityDragon> {
   ...
   protected void renderModel(
      EntityDragon entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor
   ) {
   ...
   protected void drawRechargeRay(EntityDragon dragon, double p_180574_2_, double p_180574_4_, double p_180574_6_, float p_180574_8_) {
      ...
      for(int j = 0; j <= 8; ++j) {
         ...
         worldrenderer.pos((double)(f9 * 0.2F), (double)(f10 * 0.2F), 0.0).tex((double)f11, (double)f8).color(0, 0, 0, 255).endVertex();
