...
public class RenderItem implements IResourceManagerReloadListener {
   ...
   private void renderEffect(IBakedModel model) {
      if ((!Config.isCustomItems() || CustomItems.isUseGlint()) && (!Config.isShaders() || !Shaders.isShadowPass)) {
         ...
         this.renderModel(model, Aqua.moduleManager.getModuleByName("Glint").isToggled() ? Aqua.setmgr.getSetting("GlintColor").getColor() : -8372020);
         GlStateManager.popMatrix();
         GlStateManager.pushMatrix();
         GlStateManager.scale(8.0F, 8.0F, 8.0F);
   ...
   public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text) {
      if (stack != null) {
         if (stack.stackSize != 1 || text != null) {
            ...
            GlStateManager.disableBlend();
            Aqua.INSTANCE.comfortaa4.drawStringWithShadow(s, (float)(xPosition + 22 - 2 - fr.getStringWidth(s)), (float)(yPosition + 6 + 3), 16777215);
