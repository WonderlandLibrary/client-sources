   ...
   public void doRenderLayer(
      ...
      if (i > 0) {
         ...
         for(int j = 0; j < i; ++j) {
            ...
            entity.prevRotationYaw = entity.rotationYaw = (float)(Math.atan2((double)f, (double)f2) * 180.0 / Math.PI);
            entity.prevRotationPitch = entity.rotationPitch = (float)(Math.atan2((double)f1, (double)f6) * 180.0 / Math.PI);
            double d0 = 0.0;
            double d1 = 0.0;
            double d2 = 0.0;
