...
public class EntityPlayerSP extends AbstractClientPlayer {
      ...
      if (this.isCurrentViewEntity()) {
         ...
         if (this.ridingEntity == null) {
               ...
               this.sendQueue
                  .addToSendQueue(
                     new C03PacketPlayer.C06PacketPlayerPosLook(
                        this.posX, this.getEntityBoundingBox().minY, this.posZ, EventPreMotion.getYaw(), EventPreMotion.getPitch(), this.onGround
                     )
                  );
            } else if (flag2) {
               this.sendQueue
                  .addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.onGround));
            } else if (flag3) {
            ...
            this.sendQueue
               .addToSendQueue(
                  new C03PacketPlayer.C06PacketPlayerPosLook(
                     this.motionX, -999.0, this.motionZ, EventPreMotion.getYaw(), EventPreMotion.getPitch(), this.onGround
                  )
               );
            flag2 = false;
         }
   ...
   public void sendChatMessage(String message) {
      if (!Aqua.commandSystem.execute(message) && !message.startsWith(".")) {
