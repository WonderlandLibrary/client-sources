...
public class EntityFootStepFX extends EntityFX {
   ...
   public void renderParticle(
      ...
      worldRendererIn.pos((double)(f3 - 0.125F), (double)f4, (double)(f5 + 0.125F)).tex(0.0, 1.0).color(f6, f6, f6, f1).endVertex();
      worldRendererIn.pos((double)(f3 + 0.125F), (double)f4, (double)(f5 + 0.125F)).tex(1.0, 1.0).color(f6, f6, f6, f1).endVertex();
      worldRendererIn.pos((double)(f3 + 0.125F), (double)f4, (double)(f5 - 0.125F)).tex(1.0, 0.0).color(f6, f6, f6, f1).endVertex();
      worldRendererIn.pos((double)(f3 - 0.125F), (double)f4, (double)(f5 - 0.125F)).tex(0.0, 0.0).color(f6, f6, f6, f1).endVertex();
