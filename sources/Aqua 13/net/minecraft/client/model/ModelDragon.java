...
public class ModelDragon extends ModelBase {
   ...
   public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
      ...
      this.jaw.rotateAngleX = (float)(Math.sin((double)(f * (float) Math.PI * 2.0F)) + 1.0) * 0.2F;
      float f1 = (float)(Math.sin((double)(f * (float) Math.PI * 2.0F - 1.0F)) + 1.0);
      ...
      for(int i = 0; i < 5; ++i) {
         ...
         f2 = (float)((double)f2 + Math.sin((double)this.spine.rotateAngleX) * 10.0);
         f3 = (float)((double)f3 - Math.cos((double)this.spine.rotateAngleY) * Math.cos((double)this.spine.rotateAngleX) * 10.0);
         f4 = (float)((double)f4 - Math.sin((double)this.spine.rotateAngleY) * Math.cos((double)this.spine.rotateAngleX) * 10.0);
      ...
      for(int j = 0; j < 2; ++j) {
         ...
         this.wing.rotateAngleZ = (float)(Math.sin((double)f11) + 0.125) * 0.8F;
      ...
      for(int k = 0; k < 12; ++k) {
         ...
         f10 = (float)((double)f10 + Math.sin((double)((float)k * 0.45F + f8)) * 0.05F);
