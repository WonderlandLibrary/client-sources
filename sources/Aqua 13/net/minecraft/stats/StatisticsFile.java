   ...
   public void readStatFile() {
      if (this.statsFile.isFile()) {
         try {
            ...
            logger.error("Couldn't read statistics file " + this.statsFile, (Throwable)var2);
         } catch (JsonParseException var3) {
            logger.error("Couldn't parse statistics file " + this.statsFile, (Throwable)var3);
         }
      }
   }
   ...
   public void unlockAchievement(EntityPlayer playerIn, StatBase statIn, int p_150873_3_) {
      ...
      if (statIn.isAchievement() && i == 0 && p_150873_3_ > 0) {
         ...
         if (this.mcServer.isAnnouncingPlayerAchievements()) {
            this.mcServer
               ...
               .sendChatMsg(new ChatComponentTranslation("chat.type.achievement", playerIn.getDisplayName(), statIn.createChatComponent()));
         }
      }
      ...
      if (statIn.isAchievement() && i > 0 && p_150873_3_ == 0) {
         ...
         if (this.mcServer.isAnnouncingPlayerAchievements()) {
            this.mcServer
               .getConfigurationManager()
               .sendChatMsg(new ChatComponentTranslation("chat.type.achievement.taken", playerIn.getDisplayName(), statIn.createChatComponent()));
         }
      }
   }
      ...
      for(Entry<StatBase, TupleIntJsonSerializable> entry : p_150880_0_.entrySet()) {
         if (entry.getValue().getJsonSerializableValue() != null) {
            ...
            try {
               ...
               logger.warn("Couldn't save statistic " + entry.getKey().getStatName() + ": error serializing progress", var6);
            }
