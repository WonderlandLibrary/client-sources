...
public class AchievementList {
   ...
   public static Achievement openInventory = new Achievement("achievement.openInventory", "openInventory", 0, 0, Items.book, (Achievement)null)
      .initIndependentStat()
      .registerStat();
   ...
   public static Achievement buildWorkBench = new Achievement("achievement.buildWorkBench", "buildWorkBench", 4, -1, Blocks.crafting_table, mineWood)
      .registerStat();
   public static Achievement buildPickaxe = new Achievement("achievement.buildPickaxe", "buildPickaxe", 4, 2, Items.wooden_pickaxe, buildWorkBench)
      .registerStat();
   ...
   public static Achievement buildBetterPickaxe = new Achievement(
   ...
   public static Achievement snipeSkeleton = new Achievement("achievement.snipeSkeleton", "snipeSkeleton", 7, 0, Items.bow, killEnemy)
      .setSpecial()
      .registerStat();
   ...
   public static Achievement enchantments = new Achievement("achievement.enchantments", "enchantments", -4, 4, Blocks.enchanting_table, diamonds)
      .registerStat();
   public static Achievement overkill = new Achievement("achievement.overkill", "overkill", -4, 1, Items.diamond_sword, enchantments)
      .setSpecial()
      .registerStat();
   ...
   public static Achievement spawnWither = new Achievement("achievement.spawnWither", "spawnWither", 7, 12, new ItemStack(Items.skull, 1, 1), theEnd2)
      .registerStat();
   ...
   public static Achievement exploreAllBiomes = new Achievement("achievement.exploreAllBiomes", "exploreAllBiomes", 4, 8, Items.diamond_boots, theEnd)
