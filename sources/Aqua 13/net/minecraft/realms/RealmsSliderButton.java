...
public class RealmsSliderButton extends RealmsButton {
   ...
   public RealmsSliderButton(
      int p_i1057_1_, int p_i1057_2_, int p_i1057_3_, int p_i1057_4_, int p_i1057_5_, int p_i1057_6_, float p_i1057_7_, float p_i1057_8_
   ) {
   ...
   public void renderBg(int p_renderBg_1_, int p_renderBg_2_) {
      if (this.getProxy().visible) {
         ...
         this.blit(
            this.getProxy().xPosition + (int)(this.value * (float)(this.getProxy().getButtonWidth() - 8)) + 4, this.getProxy().yPosition, 196, 66, 4, 20
         );
      }
   }
