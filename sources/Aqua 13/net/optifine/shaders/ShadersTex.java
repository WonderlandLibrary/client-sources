...
public class ShadersTex {
   ...
   public static void uploadTexSubForLoadAtlas(
      TextureMap textureMap, String iconName, int[][] data, int width, int height, int xoffset, int yoffset, boolean linear, boolean clamp
   ) {
   ...
   public static int[][] readImageAndMipmaps(TextureMap updatingTextureMap, String name, int width, int height, int numLevels, boolean border, int defColor) {
      ...
      GlStateManager.bindTexture(multitexid.spec);
      return genMipmapsSimple(aint.length - 1, width, aint);
   }
