         ...
         if (module.getCategory() == this.category) {
            ...
            if (module.isToggled()) {
               if (module.isOpen()) {
                  ...
                  RenderUtil.drawRoundedRect2Alpha((double)(this.x + 4), (double)(this.y + add + 1), (double)(this.width - 7), 13.0, 3.0, alphaColor);
               }
               ...
               if (Aqua.setmgr.getSetting("GUIDarkMode").isState()) {
                  RenderUtil.drawRoundedRect2Alpha(
                     (double)(this.x + 4), (double)(this.y + add + 1), (double)(this.width - 7), 13.0, 3.0, new Color(76, 76, 76, 220)
                  );
               } else {
                  RenderUtil.drawRoundedRect2Alpha(
                     (double)(this.x + 4), (double)(this.y + add + 1), (double)(this.width - 7), 13.0, 3.0, new Color(255, 255, 255, 190)
                  );
               }
