...
public class ClickguiScreenHero extends GuiScreen {
   ...
   private final List<CategoryPaneHero> categoryPanes = new ArrayList<>();
   private final GuiScreen parentScreen;
   public CategoryPaneHero current = null;
   private final Animate animate = new Animate();

   public ClickguiScreenHero(GuiScreen parentScreen) {
   ...
   public void initGui() {
      ...
      this.translate = new Translate((float)this.mc.displayWidth / 2.0F, (float)this.mc.displayHeight / 2.0F - 250.0F);
      int x = 10;
      ...
      for(Category category : Category.values()) {
         CategoryPaneHero categoryPane = new CategoryPaneHero(x, 10, 105, 20, category, this);
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      this.translate.interpolate((float)width, (float)height, 6.0);
      ...
      for(CategoryPaneHero categoryPane : this.categoryPanes) {
