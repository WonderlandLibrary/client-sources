...
public class Glow {
   ...
   public static ShaderProgram blurProgram = new ShaderProgram("vertex.vert", "alphaBlurESP.glsl");
   ...
   public static void setupBlurUniforms() {
      ...
      float sigma1 = (float)Aqua.setmgr.getSetting("ShaderMultiplierSigma").getCurrentNumber();
      float strength = (float)Aqua.setmgr.getSetting("ShaderMultiplierMultiplier").getCurrentNumber();
      GL20.glUniform1f(blurProgram.uniform("sigmaESP"), sigma1);
