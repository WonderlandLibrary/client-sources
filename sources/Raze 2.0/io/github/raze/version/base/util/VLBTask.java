...
public class VLBTask implements PlatformTask<Task> {
    ...
    public VLBTask(Task object) { this.object = object; }

    @Override
    public Task getObject() { return object; }

    @Override
    public void cancel() { object.cancel(); }

    public TaskStatus getStatus() { return this.getObject().status(); }
}