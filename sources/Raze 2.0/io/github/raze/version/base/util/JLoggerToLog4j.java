 ...
 */
package io.github.raze.version.base.util;
...
public class JLoggerToLog4j extends Logger {
    ...
    public void log(LogRecord record) { this.log(record.getLevel(), record.getMessage()); }
    ...
    public void log(Level level, String msg, Object[] params) { log(level, MessageFormat.format(msg, params)); }
