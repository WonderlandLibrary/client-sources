 ...
 */
package io.github.raze.version.base.platform;
...
import io.github.raze.version.base.ViaLoadingBase;
import io.github.raze.version.base.platform.viaversion.VLBViaAPIWrapper;
import io.github.raze.version.base.platform.viaversion.VLBViaConfig;
import io.github.raze.version.base.util.VLBTask;
...
public class ViaVersionPlatformImpl implements ViaPlatform<UUID> {
    ...
    @Override
    public VLBTask runSync(Runnable runnable) { return this.runAsync(runnable); }
    ...
    @Override
    public VLBTask runRepeatingSync(Runnable runnable, long ticks) { return this.runRepeatingAsync(runnable, ticks); }
    ...
    @Override
    public ViaAPI<UUID> getApi() { return api; }

    @Override
    public File getDataFolder() { return ViaLoadingBase.getInstance().getRunDirectory(); }

    @Override
    public String getPluginVersion() { return VersionInfo.VERSION; }

    @Override
    public String getPlatformName() { return "ViaLoadingBase by FlorianMichael"; }

    @Override
    public String getPlatformVersion() { return ViaLoadingBase.VERSION; }

    @Override
    public boolean isPluginEnabled() { return true; }

    @Override
    public ConfigurationProvider getConfigurationProvider() { return config; }
    ...
    @Override
    public boolean hasPlugin(String s) { return false; }
