 ...
 */
package io.github.raze.version.base.platform.viaversion;
...
import io.github.raze.version.base.netty.VLBPipeline;
...
public class VLBViaInjector implements ViaInjector {
    ...
    @Override
    public String getDecoderName() { return VLBPipeline.VIA_DECODER_HANDLER_NAME; }

    @Override
    public String getEncoderName() { return VLBPipeline.VIA_ENCODER_HANDLER_NAME; }
    ...
    @Override
    public int getServerProtocolVersion() { return this.getServerProtocolVersions().firstInt(); }

    @Override
    public JsonObject getDump() { return new JsonObject(); }
}
