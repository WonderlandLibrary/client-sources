 ...
 */
package io.github.raze.version.base.netty;

import com.viaversion.viaversion.api.connection.UserConnection;
import io.github.raze.version.base.netty.event.CompressionReorderEvent;
import io.github.raze.version.base.netty.handler.VLBViaDecodeHandler;
import io.github.raze.version.base.netty.handler.VLBViaEncodeHandler;
...
public abstract class VLBPipeline extends ChannelInboundHandlerAdapter {
    ...
    public VLBPipeline(final UserConnection user) { this.user = user; }
    ...
    public VLBViaDecodeHandler createVLBViaDecodeHandler() { return new VLBViaDecodeHandler(this.user); }

    public VLBViaEncodeHandler createVLBViaEncodeHandler() { return new VLBViaEncodeHandler(this.user); }
    ...
    public UserConnection getUser() { return user; }
}
