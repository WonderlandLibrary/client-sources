 ...
 */
package io.github.raze.version;

import io.github.raze.version.base.ViaLoadingBase;
import io.github.raze.version.gui.AsyncVersionSlider;
...
public class ViaMCP {
    ...
    public static void create() { INSTANCE = new ViaMCP(); }
    ...
    public void initAsyncSlider() { this.initAsyncSlider(5, 5, 110, 20); }
    ...
    public AsyncVersionSlider getAsyncVersionSlider() { return asyncVersionSlider; }
}
