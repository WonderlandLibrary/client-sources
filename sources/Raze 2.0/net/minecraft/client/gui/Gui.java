...
public class Gui
{
    ...
    public static void drawScaledCustomSizeModalRect(float x, float y, float u, float v, double uWidth, double vHeight, double width, double height, float tileWidth, float tileHeight)
    {
