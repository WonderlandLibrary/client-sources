...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void createButtons()
    {
        ...
        dnsInput = new GuiTextField(eventButton, mc.fontRenderer, width - 132 - 5, 5, 110, 20);
        this.buttonList.add(new GuiButton(12, width - 20 - 5, 5, 20, 20, "OK"));
    ...
    protected void type(char typedChar, int keyCode) throws IOException
    {
        ...
        dnsInput.textboxKeyTyped(typedChar, keyCode);
        if (typedChar == '\t' && (dnsInput.isFocused()))
            dnsInput.setFocused(!dnsInput.isFocused());
        if (typedChar == '\r')
    ...
    protected void release(int mouseX, int mouseY, int state)
    {
        ...
        dnsInput.mouseClicked(mouseX, mouseY, state);
