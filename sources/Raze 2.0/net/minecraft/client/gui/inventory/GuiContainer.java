...
import io.github.raze.modules.collection.player.ChestStealer;
...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void initialize()
    {
        super.initialize();
        buttonList.clear();
        buttonList.add(new GuiButton(10, 0, 20, 120,20 ,"Disable Aura"));
        buttonList.add(new GuiButton(11, 0, 0, 120,20 , "Disable ChestStealer"));
    ...
    {
        if(button.id == 10) {
            if(Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Aura.class).isEnabled()) {
                Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Aura.class).setEnabled(false);
            }
        }

        if(button.id == 11) {
            if(Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(ChestStealer.class).isEnabled()) {
                Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(ChestStealer.class).setEnabled(false);
            }
        }
    }
}
