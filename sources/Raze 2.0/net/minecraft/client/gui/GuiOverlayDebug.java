...
public class GuiOverlayDebug extends Gui
{
    ...
    protected List<String> call()
    {
        ...
        else
        {
            ...
            if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPosition() != null)
            {
                BlockPosition blockpos1 = this.mc.objectMouseOver.getBlockPosition();
