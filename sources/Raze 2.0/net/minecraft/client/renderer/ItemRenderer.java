...
public class ItemRenderer
{
    ...
    {
        float scale = Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Animations.class).scale.get().floatValue();
        float xPos = Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Animations.class).xPos.get().floatValue();
        float yPos = Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Animations.class).yPos.get().floatValue();
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand())
        {
            ...
            if (this.itemToRender != null)
            {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case DRINK:
                            if(Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Animations.class).isEnabled()
                                    && Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Animations.class).mode.compare("1.7")){
                        ...
                        case BLOCK:
                            ...
                            if(!Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Animations.class).isEnabled()){
                                ...
                                switch(Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Animations.class).mode.get()){
                                    case "Sigma": {
                ...
                {
                    if(Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Animations.class).isEnabled()
                        && Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Animations.class).swing.compare("Smooth")){
