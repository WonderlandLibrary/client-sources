...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            {
                this.pointedEntity = null;
                this.mc.objectMouseOver = new MovingObjectPosition(MovingObjectPosition.MovingObjectType.MISS, vec33, (EnumFacing)null, new BlockPosition(vec33));
            }
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                try
                {
                    ...
                    {
                        this.mc.currentScreen.render(k1, l1, partialTicks);
                    }
                }
    ...
    private boolean isDrawBlockOutline()
    {
        ...
        else
        {
            ...
            if (flag && !((EntityPlayer)entity).capabilities.allowEdit)
            {
                ...
                {
                    BlockPosition blockpos = this.mc.objectMouseOver.getBlockPosition();
                    IBlockState iblockstate = this.mc.theWorld.getBlockState(blockpos);
                    Block block = iblockstate.getBlock();
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof UIMainMenu)
        {
            this.updateMainMenu((UIMainMenu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(UIMainMenu p_updateUIMainMenu_1_)
    {
        try
        {
            String s = null;
            ...
            Reflector.setFieldValue(p_updateUIMainMenu_1_, Reflector.GuiMainMenu_splashText, s);
        }
