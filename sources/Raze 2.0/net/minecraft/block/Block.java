...
import io.github.raze.modules.collection.visual.XRay;
...
public class Block
{
    ...
    public float getBlockHardness(World worldIn, BlockPosition pos)
    {
    ...
    public float getPlayerRelativeBlockHardness(EntityPlayer playerIn, World worldIn, BlockPosition pos)
    {
