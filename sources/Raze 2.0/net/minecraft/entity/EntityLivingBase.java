...
public abstract class EntityLivingBase extends Entity
{
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound)
    {
        ...
        if(Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(NoSlow.class).isEnabled()) {
            return;
        }
    ...
    {
        return this.isPotionActive(Potion.digSpeed) ? 6 - (1 + this.getActivePotionEffect(Potion.digSpeed).getAmplifier()) : (int) ((this.isPotionActive(Potion.digSlowdown) ? 6 + (1 + this.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2 : 6) * (Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Animations.class).isEnabled() ? Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Animations.class).slowdown.get().doubleValue() : 1));
    }
