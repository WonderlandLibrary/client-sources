...
import io.github.raze.modules.collection.movement.SafeWalk;
import io.github.raze.modules.collection.movement.Scaffold;
import io.github.raze.modules.collection.visual.AntiBlind;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void onEntityUpdate()
    {
        ...
        else if (this.fire > 0 && !Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(AntiBlind.class).isEnabled())
        {
    ...
    {
        if (!this.isImmuneToFire && !Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(AntiBlind.class).isEnabled())
        {
    ...
    {
        if(!Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(AntiBlind.class).isEnabled()) {
            int i = seconds * 20;
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = (this.onGround && this.isSneaking() && this instanceof EntityPlayer) || ((Raze.INSTANCE.managerRegistry.moduleRegistry
                    .getByClass(SafeWalk.class).isEnabled() || (Scaffold.shouldDoSafeWalk
                    && Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(Scaffold.class).isEnabled()))
                    && Minecraft.getMinecraft().thePlayer != null && Minecraft.getMinecraft().thePlayer.onGround);
            ...
            && !Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(AntiBlind.class).isEnabled())
            {
    ...
    {
        return Raze.INSTANCE.managerRegistry.moduleRegistry.getByClass(AntiBlind.class).isEnabled() || this.inWater
                || this.worldObj.isRainingAt(new BlockPosition(this.posX, this.posY, this.posZ))
                || this.worldObj.isRainingAt(new BlockPosition(this.posX, this.posY + (double)this.height, this.posZ));
    }
