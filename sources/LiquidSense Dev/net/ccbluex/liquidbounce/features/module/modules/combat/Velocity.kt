...
class Velocity : Module() {
    ...
    private val modeValue = ListValue("Mode", arrayOf("Simple", "AAC", "AACPush", "AACZero",
            "Reverse","SmoothReverse","AAC4.4.0", "Jump", "Glitch"), "Simple")
    ...
    private var velocityTimer2 = MSTimer()
    ...
    fun onPacket(event: PacketEvent) {
        ...
        if (packet is S12PacketEntityVelocity) {
            ...
            when (modeValue.get().toLowerCase()) {
                ...
                "aac","reverse", "aaczero","smoothreverse"-> velocityInput = true
        ...
        if (packet is S06PacketUpdateHealth) {
