...
public class LiquidSenseStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) { //上面和下面的面
        RenderUtils.drawBorderedRect((float) panel.getX(), (float) panel.getY() - 3, (float) panel.getX() + panel.getWidth(), (float) panel.getY() + 17, 3, new Color(20, 20, 20,200).getRGB(), new Color(20, 20, 20).getRGB());
        if(panel.getFade() > 0) {
                ...
                if(moduleElement.isShowSettings()) {
                    ...
                    for(final Value value : moduleValues) {
                        if(value instanceof BoolValue) {
                            ...
                            RenderUtils.drawRect(moduleElement.getX() + moduleElement.getWidth() + 4, yPos + 2, moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth(), yPos + 24, new Color(35, 35, 35).getRGB());
                            ...
                            final float sliderValue = moduleElement.getX() + moduleElement.getWidth() + 8 + (moduleElement.getSettingsWidth() - 12) * ((floatValue.get() - floatValue.getMinimum()) / (floatValue.getMaximum() - floatValue.getMinimum()));
                            RenderUtils.drawRect(moduleElement.getX() + moduleElement.getWidth() + 8, yPos + 18, sliderValue, yPos + 19, Color.WHITE.getRGB());
                            ...
                            RenderUtils.drawRect(moduleElement.getX() + moduleElement.getWidth() + 4, yPos + 2, moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth(), yPos + 24, new Color(35, 35, 35).getRGB());
                            RenderUtils.drawRect(moduleElement.getX() + moduleElement.getWidth() + 8, yPos + 18, moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() - 4, yPos + 19, Integer.MAX_VALUE);
                            final float sliderValue = moduleElement.getX() + moduleElement.getWidth() + 8 + (moduleElement.getSettingsWidth() - 12) * ((float)(integerValue.get() - integerValue.getMinimum()) / (integerValue.getMaximum() - integerValue.getMinimum()));
                            RenderUtils.drawRect(moduleElement.getX() + moduleElement.getWidth() + 8, yPos + 18, sliderValue, yPos + 19, Color.WHITE.getRGB());
