...
public class Fly extends Module {
   ...
   private final GliFly gliFly = Fly.this.new GliFly();
   ...
   class GliFly {
      ...
      public void update() {
         ...
         if ((int) a.getInput() == 2) {
            mc.thePlayer.motionZ *= Fly.b.getInput();
            mc.thePlayer.motionX *= Math.cos(Math.toRadians(mc.thePlayer.rotationYawHead));
            mc.thePlayer.motionY *= Math.sin(Math.toRadians(mc.thePlayer.rotationYawHead));
         }
      }
   }
