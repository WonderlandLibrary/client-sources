...
public class PlayerESP extends Module {
   ...
   public static TickSetting outline; // New setting for the outline
   private int rgb_c = 0;
   ...
   public PlayerESP() {
      ...
      this.registerSetting(outline = new TickSetting("Outline", false)); // Register the new outline setting
   ...
   private void r(Entity en, int rgb) {
      Color outlineColor = new Color(0, 0, 255); // Blue color for the outline

      if (t1.isToggled()) {
         Utils.HUD.drawBoxAroundEntity(en, 1, i.getInput(), j.getInput(), rgb, h.isToggled());
         if (outline.isToggled()) {
            Utils.HUD.drawOutlineAroundEntity(en, 1, i.getInput(), j.getInput(), outlineColor.getRGB(), h.isToggled());
         }
      }
      ...
      if (t2.isToggled()) {
         ...
         if (outline.isToggled()) {
            Utils.HUD.drawOutlineAroundEntity(en, 2, i.getInput(), j.getInput(), outlineColor.getRGB(), h.isToggled());
         }
      }
      ...
      if (t3.isToggled()) {
         ...
         if (outline.isToggled()) {
            Utils.HUD.drawOutlineAroundEntity(en, 3, i.getInput(), j.getInput(), outlineColor.getRGB(), h.isToggled());
         }
      }
      ...
      if (t4.isToggled()) {
         ...
         if (outline.isToggled()) {
            Utils.HUD.drawOutlineAroundEntity(en, 4, i.getInput(), j.getInput(), outlineColor.getRGB(), h.isToggled());
         }
      }
      ...
      if (t5.isToggled()) {
         ...
         if (outline.isToggled()) {
            Utils.HUD.drawOutlineAroundEntity(en, 5, i.getInput(), j.getInput(), outlineColor.getRGB(), h.isToggled());
         }
      }
      ...
      if (t6.isToggled()) {
         ...
         if (outline.isToggled()) {
            Utils.HUD.drawOutlineAroundEntity(en, 6, i.getInput(), j.getInput(), outlineColor.getRGB(), h.isToggled());
         }
      }
   }
}
