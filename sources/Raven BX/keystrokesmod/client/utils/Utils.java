...
public class Utils {
   ...
   public static class Player {
      ...
      public static EnumFacing getFacing() {
         // Get the player's rotation yaw and calculate the facing direction
   ...
   public static class HUD {
      ...
      public static void drawBoxAroundEntity(Entity en, int type, double input, double input1, boolean rgb, boolean toggled) {
      }

      public static void drawOutlineAroundEntity(Entity entity, int type, double expand, double xShift, int outlineColor, boolean redOnDamage) {
         GlStateManager.pushMatrix();
         GlStateManager.translate(xShift, 0, 0);
         GlStateManager.scale(1.0 + expand, 1.0 + expand, 1.0 + expand);
         ...
         GL11.glLineWidth(2.0f); // Set the line width

         Color color = new Color(outlineColor);
         ...
         // Render the entity's model or a simple shape to represent the outline
         // For demonstration purposes, I'm rendering a simple rectangle
         // Replace this with the actual rendering logic you need
