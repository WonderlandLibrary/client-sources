...
public class FontUtil {
    ...
    public static void bootstrap() {
        new Thread(() -> {
            ...
            normal_ = getFont(locationMap, "couture-bld.otf", 19, Font.PLAIN);
            two_ = getFont(locationMap, "couture-bld.otf", 30, Font.PLAIN);
            small_ = getFont(locationMap, "LEMONMILK-BoldItalic.otf", 14, Font.BOLD);
            completed++;
        }).start();
        new Thread(() -> {
            Map<String, Font> locationMap = new HashMap<>();
