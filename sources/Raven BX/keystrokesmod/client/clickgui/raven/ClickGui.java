...
public class ClickGui extends GuiScreen {
   ...
   public void drawScreen(int x, int y, float p) {
      ...
      // Horizontal Text
      this.drawCenteredString(this.fontRendererObj, "RAVEN", halfScreenWidth - w_c, quarterScreenHeight + 15, Utils.Client.rainbowDraw(2L, 1500L));
      this.drawCenteredString(this.fontRendererObj, "BX", halfScreenWidth + 1 + w_c, quarterScreenHeight + 30, Utils.Client.rainbowDraw(2L, 0L));
      ...
      if (latestVersion.isNewerThan(clientVersion)) {
         int margin = 2;
         int rows = 1;
         for (String up : Raven.updateText) {
            mc.fontRendererObj.drawString(up, halfScreenWidth - this.fontRendererObj.getStringWidth(up) / 2,
         ...
         mc.fontRendererObj.drawString("Raven B+ v" + clientVersion + " | Config: " + Raven.configManager.getConfig().getName(),
