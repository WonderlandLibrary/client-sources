...
public class SliderComponent implements Component {
   ...
   public void draw() {
      ...
      net.minecraft.client.gui.Gui.drawRect(this.p.category.getX() + 4, this.p.category.getY() + this.o + 11, this.p.category.getX() + 4 + this.p.category.getWidth() - 8, this.p.category.getY() + this.o + 13, -12302777);
      ...
      net.minecraft.client.gui.Gui.drawRect(l, this.p.category.getY() + this.o + 11, r, this.p.category.getY() + this.o + 13, new Color(46,117,226).getRGB());
      GL11.glPushMatrix();
   ...
   public boolean u(int x, int y) {
      return x > this.x && x < this.x + this.p.category.getWidth() / 2 + 1 && y > this.y && y < this.y + 13;
   }

   public boolean i(int x, int y) {
      return x > this.x + this.p.category.getWidth() / 2 && x < this.x + this.p.category.getWidth() && y > this.y && y < this.y + 13;
   }
}
