...
public class RangeSliderComponent implements Component {
    ...
    public void draw() {
        ...
        // Drawing the main colored bar
        net.minecraft.client.gui.Gui.drawRect(startToDrawFrom, this.module.category.getY() + this.moduleStartY + textSize, finishDrawingAt, this.module.category.getY() + this.moduleStartY + textSize + boxHeight, new Color(46,117,226).getRGB());
    ...
    public void update(int mousePosX, int mousePosY) {
        ...
        this.barWidth = (double) (this.module.category.getWidth() - boxMargin * 2) // The bar width of the slider
