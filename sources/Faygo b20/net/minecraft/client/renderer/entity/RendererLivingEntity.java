...
import me.valk.event.events.screen.EventRenderEntity;
import me.valk.event.events.screen.EventRenderNametag;
...
public abstract class RendererLivingEntity extends Render
{
	 ...
	 * handing it off to a worker function which does the actual work. In all probabilty, the class MotionBlur is generic
	 * (MotionBlur<T extends Entity) and this method has signature public void doRender(T entity, double d, double d1,
	 * double d2, float f, float f1). But JAD is pre 1.5 so doesn't do that.
	 */
	public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
	{
		 if (EventSystem.call(new EventRenderEntity(p_76986_1_, EventType.PRE)).isCancelled()) {
	            return;
	        }
		 if(p_76986_1_ instanceof EntityPlayer) {
	        EventPreRenderEntity pre = new EventPreRenderEntity(p_76986_1_);
	        EventSystem.call(pre);
		 }
		...
		if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_)}))
		{
			...
			{
				Shaders.setEntityHurtFlash(p_76986_1_.hurtTime <= 0 && p_76986_1_.deathTime <= 0 ? 0 : 102, this.getColorMultiplier(p_76986_1_, p_76986_1_.getBrightness(p_76986_9_), p_76986_9_));
			}
	...
	protected boolean func_177088_c(EntityLivingBase p_177088_1_)
	{
		...
		if (p_177088_1_ instanceof EntityPlayer)
		{
			...
			if (var6 != null)
			{
				String var7 = Minecraft.getMinecraft().fontRendererObj.getFormatFromString(var6.getColorPrefix());
	 ...
	 */
	 ...
	 {
		 if(EventSystem.call(new EventRenderNametag(p_77033_1_)).isCancelled()) return;
