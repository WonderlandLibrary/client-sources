        ...
        while (var6.hasNext() && !this.skipFirst)
        {
            ...
            else
            {
                try
                {
                    ...
                    BufferedImage[] var31_1 = new BufferedImage[1 + this.mipmapLevels];
                    var31_1[0] = TextureUtil.func_177053_a(var30.getInputStream());

                    if (this.mipmapLevels > 0 && var31_1 != null)
                    {
                        sheetHeight = var31_1[0].getWidth();
                        var31_1[0] = TextureUtils.scaleToPowerOfTwo(var31_1[0], minSpriteSize);
                        int listSprites = var31_1[0].getWidth();
                    ...
                    if (sheetHeight1 != null)
                    {
                        ...
                        {
                            int tas = var31_1[0].getWidth();
                            it = var31_1[0].getHeight();
                        ...
                        while (tas1.hasNext())
                        {
                            ...
                            if (it > 0 && it < var31_1.length - 1 && var31_1[it] == null)
                            {
                                ResourceLocation ss = this.completeResourceLocation(var27, it);

                                try
                                {
                                    var31_1[it] = TextureUtil.func_177053_a(ShadersTex.loadResource(p_110571_1_, ss).getInputStream());
                                }
                    ...
                    var26.func_180598_a(var31_1, listSprites2);
                }
