...
import me.valk.event.events.entity.EventEntityVelocity;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleEntityVelocity(S12PacketEntityVelocity packetIn)
    {
		...
		EventEntityVelocity event = (EventEntityVelocity) EventSystem
				.call(new EventEntityVelocity(var2, (double) packetIn
						.func_149411_d() / 8000.0D, (double) packetIn
						.func_149410_e() / 8000.0D, (double) packetIn
						.func_149409_f() / 8000.0D));

		if(event.isCancelled())
			return;

		if(var2 != null){
			var2.setVelocity(event.getMotionX(), event.getMotionY(),
					event.getMotionZ());
		}
    }
    ...
    {
    	EventPacket event = (EventPacket) EventSystem.call(new EventPacket(EventPacketType.SEND, p_147297_1_));
