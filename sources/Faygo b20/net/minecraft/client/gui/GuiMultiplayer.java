...
import me.valk.agway.gui.altmanager.GuiAltManager;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
	...
	public void createButtons() {
		...
		this.buttonList.add(new GuiButton(0, this.width / 2 + 4 + 76, this.height - 28, 75, 20,I18n.format("gui.back", new Object[0])));
		this.buttonList.add(new GuiButton(99, 8, 10, 70, 20,I18n.format("Alt Manager", new Object[0])));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		if (button.enabled) {
			GuiListExtended.IGuiListEntry var2 = this.serverListSelector.func_148193_k() < 0 ? null
			...
			if (button.id == 2 && var2 instanceof ServerListEntryNormal) {
				...
				//TODO: ASS THIS TOO YOU FUCKING NIGGER
				GuiAddAlt.loadAlts();
			}
		}
	}
	...
	public void confirmClicked(boolean result, int id) {
		GuiListExtended.IGuiListEntry var3 = this.serverListSelector.func_148193_k() < 0 ? null
				: this.serverListSelector.getListEntry(this.serverListSelector.func_148193_k());
	...
	public void connectToSelected() {
		GuiListExtended.IGuiListEntry var1 = this.serverListSelector.func_148193_k() < 0 ? null
				: this.serverListSelector.getListEntry(this.serverListSelector.func_148193_k());
