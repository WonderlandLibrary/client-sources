...
public class GuiPlayerTabOverlay extends Gui {
	...
	public void func_175249_a(int p_175249_1_, Scoreboard p_175249_2_, ScoreObjective p_175249_3_) {
		...
		while (var8.hasNext()) {
			...
			if (p_175249_3_ != null && p_175249_3_.func_178766_e() != IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
				var10 = this.field_175250_f.fontRendererObj.getStringWidth(" " + p_175249_2_
		...
		boolean var11 = this.field_175250_f.isIntegratedServerRunning()
				|| this.field_175250_f.getNetHandler().getNetworkManager().func_179292_f();
		int var12;
		...
		if (this.header != null) {
			var17 = this.field_175250_f.fontRendererObj.listFormattedStringToWidth(this.header.getFormattedText(),
					p_175249_1_ - 50);

			for (var19 = var17.iterator(); var19
					.hasNext(); var16 = Math.max(var16, this.field_175250_f.fontRendererObj.getStringWidth(var20))) {
				var20 = (String) var19.next();
			}
		}

		if (this.footer != null) {
			var18 = this.field_175250_f.fontRendererObj.listFormattedStringToWidth(this.footer.getFormattedText(),
					p_175249_1_ - 50);
		...
		if (var17 != null) {
			drawRect(p_175249_1_ / 2 - var16 / 2 - 1, var15 - 1, p_175249_1_ / 2 + var16 / 2 + 1,
					var15 + var17.size() * this.field_175250_f.fontRendererObj.FONT_HEIGHT, Integer.MIN_VALUE);
			...
			for (var19 = var17.iterator(); var19.hasNext(); var15 += this.field_175250_f.fontRendererObj.FONT_HEIGHT) {
				...
				this.field_175250_f.fontRendererObj.func_175063_a(var20, (float) (p_175249_1_ / 2 - var21 / 2),
						(float) var15, -1);
			}
		...
		for (int var30 = 0; var30 < var28; ++var30) {
			...
			if (var30 < var5.size()) {
				...
				if (var11) {
					...
					EntityPlayer var26 = this.field_175250_f.theWorld
							.getPlayerEntityByUUID(var24.func_178845_a().getId());
		...
		if (var18 != null) {
			var15 += var29 * 9 + 1;
			drawRect(p_175249_1_ / 2 - var16 / 2 - 1, var15 - 1, p_175249_1_ / 2 + var16 / 2 + 1,
					var15 + var18.size() * this.field_175250_f.fontRendererObj.FONT_HEIGHT, Integer.MIN_VALUE);
	...
	private void func_175247_a(ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_,
		...
		if (p_175247_1_.func_178766_e() == IScoreObjectiveCriteria.EnumRenderType.HEARTS) {
			...
			if (Minecraft.getSystemTime() - p_175247_6_.func_178847_n() > 1000L
					|| this.field_175253_j != p_175247_6_.func_178855_p()) {
			...
			int var9 = Math.max(MathHelper.ceiling_float_int((float) (var7 / 2)),
					Math.max(MathHelper.ceiling_float_int((float) (p_175247_6_.func_178860_m() / 2)), 10));
			boolean var10 = p_175247_6_.func_178858_o() > (long) this.field_175251_g.getUpdateCounter()
					&& (p_175247_6_.func_178858_o() - (long) this.field_175251_g.getUpdateCounter()) / 3L % 2L == 1L;
			...
			if (var8 > 0) {
				...
				if (var11 > 3.0F) {
					...
					for (var12 = var8; var12 < var9; ++var12) {
						this.func_175174_a((float) p_175247_4_ + (float) var12 * var11, (float) p_175247_2_,
								var10 ? 25 : 16, 0, 9, 9);
					}
					...
					for (var12 = 0; var12 < var8; ++var12) {
						...
						if (var10) {
							if (var12 * 2 + 1 < p_175247_6_.func_178860_m()) {
								this.func_175174_a((float) p_175247_4_ + (float) var12 * var11, (float) p_175247_2_, 70,
										0, 9, 9);
							}

							if (var12 * 2 + 1 == p_175247_6_.func_178860_m()) {
								this.func_175174_a((float) p_175247_4_ + (float) var12 * var11, (float) p_175247_2_, 79,
										0, 9, 9);
							}
						}
						...
						if (var12 * 2 + 1 < var7) {
							this.func_175174_a((float) p_175247_4_ + (float) var12 * var11, (float) p_175247_2_,
									var12 >= 10 ? 160 : 52, 0, 9, 9);
						}

						if (var12 * 2 + 1 == var7) {
							this.func_175174_a((float) p_175247_4_ + (float) var12 * var11, (float) p_175247_2_,
									var12 >= 10 ? 169 : 61, 0, 9, 9);
						}
					}
				} else {
					...
					this.field_175250_f.fontRendererObj.func_175063_a(var14,
							(float) ((p_175247_5_ + p_175247_4_) / 2
									- this.field_175250_f.fontRendererObj.getStringWidth(var14) / 2),
							(float) p_175247_2_, var13);
				}
			}
		} else {
			String var15 = EnumChatFormatting.YELLOW + "" + var7;
			this.field_175250_f.fontRendererObj.func_175063_a(var15,
					(float) (p_175247_5_ - this.field_175250_f.fontRendererObj.getStringWidth(var15)),
