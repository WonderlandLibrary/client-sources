...
import me.valk.utils.render.NormalFontRenderer;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
	...
	public NormalFontRenderer fontRendererObj;
	...
	private void startGame() throws LWJGLException {
		...
		this.fontRendererObj = new NormalFontRenderer(this.gameSettings,
			...
			while (Keyboard.next()) {
				...
				if (Keyboard.getEventKeyState()) {
					...
					if (this.currentScreen != null) {
						...
						EventSystem.call(new EventKeyPress(var1));
