package com.masterof13fps.utils.render.slick.opengl.renderer;
...
public class ImmediateModeOGLRenderer implements SGL {
	...
	/*
	 * (non-Javadoc)
	 * @see de.crazymemecoke.utils.render.slick.opengl.renderer.SGL#glGenTextures(java.nio.IntBuffer)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.crazymemecoke.utils.render.slick.opengl.renderer.SGL#glGetError()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.crazymemecoke.utils.render.slick.opengl.renderer.SGL#glTexImage2D(int, int, int, int, int, int, int, int, java.nio.ByteBuffer)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.crazymemecoke.utils.render.slick.opengl.renderer.SGL#canTextureMirrorClamp()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.crazymemecoke.utils.render.slick.opengl.renderer.SGL#canSecondaryColor()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.crazymemecoke.utils.render.slick.opengl.renderer.SGL#glSecondaryColor3ubEXT(byte, byte, byte)
	 */
