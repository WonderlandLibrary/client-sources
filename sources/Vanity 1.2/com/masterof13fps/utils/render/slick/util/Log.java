package com.masterof13fps.utils.render.slick.util;
...
public final class Log {
	...
	/** true if activated by the system property "de.crazymemecoke.utils.render.slick.forceVerboseLog" */
	 ...
	 * value must be "true"
	 */
	private static final String forceVerboseProperty = "de.crazymemecoke.utils.render.slick.forceVerboseLog";
	 ...
	 * "de.crazymemecoke.utils.render.slick.forceVerboseLog"
	 * 
	...
	/**
	 * Check if the system property de.crazymemecoke.utils.render.slick.verboseLog is set to true.
	 ...
	 * Only be called when system property "de.crazymemecoke.utils.render.slick.forceVerboseLog" is set to true.
