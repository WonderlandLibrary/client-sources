...
import com.masterof13fps.features.ui.Interface;
import com.masterof13fps.features.ui.guiscreens.GuiMainMenu;
import com.masterof13fps.features.ui.tabgui.TabGUI;
import com.masterof13fps.manager.eventmanager.impl.EventKeyPress;
...
public class Minecraft implements IThreadListener, IPlayerUsage, Wrapper {
    ...
    private static LanguageManager mcLanguageManager;
    ...
    public void runTick() throws IOException {
        ...
        eventManager.onEvent(eventTick);
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        eventManager.onEvent(eventKeyPress);
