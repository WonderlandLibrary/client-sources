...
public class ChunkRenderWorker implements Runnable
{
    ...
    public void run()
    {
        while (true)
        {
            ...
            catch (Throwable throwable)
            {
                ...
                Minecraft.mc().crashed(Minecraft.mc().addGraphicsAndWorldToCrashReport(crashreport));
                return;
            }
        }
    }
    ...
    protected void processTask(final ChunkCompileTaskGenerator generator) throws InterruptedException
    {
        ...
        Entity lvt_2_1_ = Minecraft.mc().getRenderViewEntity();
        ...
        else
        {
            ...
            Futures.addCallback(listenablefuture, new FutureCallback<List<Object>>()
            {
                ...
                public void onFailure(Throwable p_onFailure_1_)
                {
                    ...
                    {
                        Minecraft.mc().crashed(CrashReport.makeCrashReport(p_onFailure_1_, "Rendering chunk"));
                    }
                }
            });
        }
