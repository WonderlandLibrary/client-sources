...
import net.optifine.shadersmod.client.ShadowUtils;
...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener, Wrapper {
    ...
    protected boolean isRenderEntityOutlines() {
        EventOutline eventOutline = new EventOutline(!Config.isFastRender() && !Config.isShaders() && !Config.isAntialiasing() && this.entityOutlineFramebuffer != null && this.entityOutlineShader != null && this.mc.thePlayer != null && this.mc.thePlayer.isSpectator() && this.mc.gameSettings.keyBindSpectatorOutlines.isKeyDown());
        eventManager.onEvent(eventOutline);
    ...
    protected Vector3f getViewVector(Entity entityIn, double partialTicks) {
        ...
        if (Minecraft.mc().gameSettings.thirdPersonView == 2) {
            f += 180.0F;
        }
    ...
    public void drawSelectionBox(EntityPlayer player, MovingObjectPosition movingObjectPositionIn, int p_72731_3_, float partialTicks) {
        if (p_72731_3_ == 0 && movingObjectPositionIn.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (block.getMaterial() != Material.air && this.theWorld.getWorldBorder().contains(blockpos)) {
                ...
                drawOutlinedBoundingBox(block.getSelectedBoundingBox(this.theWorld, blockpos).expand(0.0020000000949949026D, 0.0020000000949949026D, 0.0020000000949949026D).offset(-d0, -d1, -d2));
            }
    ...
    public static void drawOutlinedBoundingBox(AxisAlignedBB p_181561_0_) {
        Tessellator tessellator = Tessellator.getInstance();
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
