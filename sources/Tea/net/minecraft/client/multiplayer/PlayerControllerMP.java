...
public class PlayerControllerMP
{
    ...
    {
    	if(ModuleUtils.getMod(Reach.class).isToggled()) {
    		return this.currentGameType.isCreative() ? Reach.reach : Reach.reach;
    	}
	...
	public ItemStack windowClick(int windowId, int slotId, int mouseButtonClicked, int p_78753_4_,
			EntityPlayer playerIn, boolean packet) {
		short var6 = playerIn.openContainer.getNextTransactionID(playerIn.inventory);
		...
		if (packet) {
			this.netClientHandler.addToSendQueue(
					new C0EPacketClickWindow(windowId, slotId, mouseButtonClicked, p_78753_4_, var7, var6));
		}
		return var7;
	}
