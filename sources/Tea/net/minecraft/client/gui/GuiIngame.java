...
public class GuiIngame extends Gui
{
    ...
    public void func_175180_a(float p_175180_1_)
    {
        ...
        if (FileUtils.clip.isRunning() && mc.isGuiEnabled())
	    {
        	FileUtils.setVolume(-1000.0F);
	    }
        ...
        if (this.mc.isDemo())
        {
        	...
        	//drawString(Minecraft.getMinecraft().fontRendererObj, "Still 1233switched XD".replace("1", "k").replace("2", "i").replace("33", "ll"), 1, 1, 0xFF000000);
        	//drawRect(1000000, 1000000, 1000000, 1000000, -1);
