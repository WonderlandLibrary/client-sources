            ...
            else if (var3.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.SwitchEnumAction.field_178094_a[var7.ordinal()])
                {
                    ...
                    case 4:
                    	...
                    	func_178103_d();
                        float f5 = MathHelper.sin(MathHelper.sqrt_float(var4) * 3.1415927F);
                        GlStateManager.translate(-0.5F, 0.4F, 0.0F);
                        GlStateManager.rotate(-f5 * 50.0F, -10.0F, 5.0F, 9.0F);
                        GlStateManager.rotate(-f5 * 70.0F, 1.0F, -0.4F, -0.0F);
                        break;
