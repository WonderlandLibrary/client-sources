...
public class GlStateManager
{
    ...
    public static void setAndBindTexture(int index){
		if(index != field_179174_p[field_179162_o].field_179059_b){
			field_179174_p[field_179162_o].field_179059_b = index;
			GL11.glBindTexture(3553, index);
		}
	}
