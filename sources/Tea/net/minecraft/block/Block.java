...
public class Block
{
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List list, Entity collidingEntity)
    {
        ...
        EventEntityCollision event = (EventEntityCollision) EventManager.call(new EventEntityCollision(collidingEntity, new Location(pos.getX(), pos.getY(), pos.getZ()), var7, this));
        
        var7 = event.getBoundingBox();
        
        if(event.isCancelled()) return;
        
        EventBBSet e = new EventBBSet(this, pos, var7);
