package io.github.liticane.clients.util.render.shaders.impl;


import io.github.liticane.clients.util.render.shaders.FrameBufferUtil;
import io.github.liticane.clients.util.render.shaders.OpenGlUtil;
import io.github.liticane.clients.util.render.shaders.ShaderUtil;
...
public class KawaseBlur {
    ...
    private static void initFramebuffers(float iterations) {
        ...
        framebufferList.add(framebuffer = FrameBufferUtil.createFrameBuffer(null));
    ...
    public static void renderBlur(int stencilFrameBufferTexture, int iterations, int offset) {
        ...
        FrameBufferUtil.bindTexture(stencilFrameBufferTexture);
        GL13.glActiveTexture(GL13.GL_TEXTURE0);
        FrameBufferUtil.bindTexture(framebufferList.get(1).framebufferTexture);
        ShaderUtil.drawQuads();
        kawaseUp.unload();


        mc.getFramebuffer().bindFramebuffer(true);
        FrameBufferUtil.bindTexture(framebufferList.get(0).framebufferTexture);
        FrameBufferUtil.setAlphaLimit(0);
    ...
    private static void renderFBO(Framebuffer framebuffer, int framebufferTexture, ShaderUtil shader, float offset) {
        ...
        shader.init();
        FrameBufferUtil.bindTexture(framebufferTexture);
