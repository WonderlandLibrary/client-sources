...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn)
    {
        ...
        this.gameController.controller = new PlayerControllerMP(this.gameController, this);
        ...
        this.gameController.display(new GuiDownloadTerrain(this));
        ...
        this.gameController.controller.setGameType(packetIn.getGameType());
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn)
    {
        ...
        if (!this.doneLoadingTerrain)
        {
            ...
            this.gameController.display((GuiScreen)null);
        }
    }
    ...
    public void onDisconnect(IChatComponent reason)
    {
        ...
        if (this.guiScreenServer != null)
        {
            ...
            {
                this.gameController.display((new DisconnectedRealmsScreen(((GuiScreenRealmsProxy)this.guiScreenServer).func_154321_a(), "disconnect.lost", reason)).getProxy());
            }
            else
            {
                this.gameController.display(new GuiDisconnected(this.guiScreenServer, "disconnect.lost", reason));
            }
        }
        else
        {
            this.gameController.display(new GuiDisconnected(new GuiMultiplayer(new GuiMainMenu()), "disconnect.lost", reason));
        }
    }

    public void send(Packet p_147297_1_)
    {
        PacketEvent packetEvent = new PacketEvent(p_147297_1_, PacketEvent.Type.SENT);
        Client.INSTANCE.getEventManager().handle(packetEvent);
    ...
    public void sendSilent(Packet p_147297_1_)
    {
        this.netManager.sendPacket(p_147297_1_);
    }
    ...
    public void handleConfirmTransaction(S32PacketConfirmTransaction packetIn)
    {
        ...
        {
            this.send(new C0FPacketConfirmTransaction(packetIn.getWindowId(), packetIn.getActionNumber(), true));
        }
    }
    ...
    public void handleChangeGameState(S2BPacketChangeGameState packetIn)
    {
        ...
        {
            this.gameController.controller.setGameType(WorldSettings.GameType.getByID(j));
        }
        else if (i == 4)
        {
            this.gameController.display(new GuiWinGame());
        }
        else if (i == 5)
        {
            GameSettings gamesettings = this.gameController.settings;
            ...
            if (f == 0.0F)
            {
                this.gameController.display(new GuiScreenDemo());
            }
            else if (f == 101.0F)
            {
    ...
    {
        this.send(new C00PacketKeepAlive(packetIn.func_149134_c()));
    }
        ...
        else
        {
            ...
            else
            {
                this.gameController.addScheduledTask(new Runnable()
                {
                    public void run()
                    {
                        NetHandlerPlayClient.this.gameController.display(new GuiYesNo(new GuiYesNoCallback()
                        {
                            public void confirmClicked(boolean result, int id)
                            {
                                ...
                                NetHandlerPlayClient.this.gameController.display((GuiScreen)null);
                            }
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn)
    {
        ...
        else if ("MC|BOpen".equals(packetIn.getChannelName()))
        {
            ...
            {
                this.gameController.display(new GuiScreenBook(this.gameController.player, itemstack, false));
            }
        }
    }
