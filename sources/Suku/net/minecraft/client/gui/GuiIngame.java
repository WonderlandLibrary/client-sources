...
import io.github.liticane.clients.feature.module.impl.visual.Effects;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (this.mc.settings.thirdPersonView == 0 && itemstack != null && itemstack.getItem() == Item.getItemFromBlock(Blocks.pumpkin))
        {
        ...
        Effects postProcessing = (Effects) Client.INSTANCE.getModuleManager().get(Effects.class);
        postProcessing.blurScreen();

        if (this.mc.controller.isSpectator())
        {
        ...
        if (this.mc.controller.shouldDrawHUD())
        {
        ...
        else if (this.mc.controller.gameIsSurvivalOrAdventure())
        {
            this.renderExpBar(scaledresolution, k1);
        }

        if (this.mc.settings.heldItemTooltips && !this.mc.controller.isSpectator())
        {
        ...
        {
            if(Client.INSTANCE.getModuleManager().get(io.github.liticane.clients.feature.module.impl.visual.Scoreboard.class).isToggled()) {
        ...
        if (this.mc.settings.keyBindPlayerList.isKeyDown() && (!this.mc.isIntegratedServerRunning() || this.mc.player.connection.getPlayerInfoMap().size() > 1 || scoreobjective1 != null))
        {
        ...
        Client.INSTANCE.getEventManager().handle(new Render2DEvent());
    ...
    protected boolean showCrosshair()
    {
        ...
        else if (this.mc.controller.isSpectator())
        {
