...
public class TeleportToTeam implements ISpectatorMenuView, ISpectatorMenuObject
{
    ...
    class TeamSelectionObject implements ISpectatorMenuObject
    {
        ...
        public TeamSelectionObject(ScorePlayerTeam p_i45492_2_)
        {
            ...
            {
                NetworkPlayerInfo networkplayerinfo = Minecraft.getInstance().getNetHandler().getPlayerInfo(s);
        ...
        public void func_178663_a(float p_178663_1_, int alpha)
        {
            ...
            if (s.length() >= 2)
            {
                i = Minecraft.getInstance().fontRendererObj.getColorCode(s.charAt(1));
            }
