    ...
    public EntityItem dropItem(ItemStack droppedItem, boolean dropAround, boolean traceItem)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                entityitem.motionZ = (double)(MathHelper.cos(this.moveForward / 180.0F * (float)Math.PI) * MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI) * f2);
                ...
                if (f > 0.0F || f1 > 0.0F)
                {
                    ...
                    if (flag2)
                    {
                        if (i > 0)
                        {
                            ...
                            Client.INSTANCE.getEventManager().handle(keepSprintEvent);
