...
extends GuiScreenOF {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(201, width / 2 - j1 - 20, height / 6 + 168 + 11, j1, k1, I18n.format("controls.reset", new Object[0])));
        this.buttonList.add(new GuiButton(200, width / 2 + 20, height / 6 + 168 + 11, j1, k1, I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(int x, int y, float f) {
        ...
        if (this.screenText != null) {
            this.drawCenteredString(this.fontRendererObj, this.screenText, width / 2, 15, 0xFFFFFF);
        } else {
