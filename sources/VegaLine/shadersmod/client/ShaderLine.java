...
public class ShaderLine {
    ...
    public ShaderLine(int type2, String name, String value, String line) {
        this.type = type2;
        this.name = name;
        this.value = value;
        this.line = line;
    ...
    public boolean isComment(String name) {
        return this.isComment() && name.equals(this.name);
    }

    public boolean isComment(String name, String value) {
        return this.isComment(name) && value.equals(this.value);
    }
