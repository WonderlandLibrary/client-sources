    ...
    public static void useProgram(int program) {
        ...
        if (activeProgram != program) {
            ...
            if (programsID[program] == 0) {
                ...
                ItemStack itemstack = Minecraft.player != null ? Minecraft.player.getHeldItemMainhand() : null;
                ...
                ItemStack itemstack1 = Minecraft.player != null ? Minecraft.player.getHeldItemOffhand() : null;
        ...
        if (entity != null) {
            ...
            if (Minecraft.player != null) {
                ...
                if (Minecraft.player.isPotionActive(MobEffects.NIGHT_VISION)) {
                    nightVision = Config.getMinecraft().entityRenderer.getNightVisionBrightness(Minecraft.player, partialTicks);
                }
                blindness = 0.0f;
                if (Minecraft.player.isPotionActive(MobEffects.BLINDNESS)) {
                    int i = Minecraft.player.getActivePotionEffect(MobEffects.BLINDNESS).getDuration();
