...
implements Reconfigurable {
    ...
    public CompositeConfiguration(List<? extends AbstractConfiguration> configurations) {
        ...
        try {
            this.mergeStrategy = (MergeStrategy)LoaderUtil.newInstanceOf(mergeStrategyClassName);
    ...
    public void setup() {
        ...
        ConfiguratonFileWatcher fileWatcher = new ConfiguratonFileWatcher(this, this.listeners);
        ...
        for (AbstractConfiguration abstractConfiguration : this.configurations) {
            ...
            if (sourceURI != null) {
                ...
                if (currentConfig == null) {
                    ...
                    currentConfig = abstractConfiguration;
                }
            } else {
                currentConfig = abstractConfiguration;
            }
