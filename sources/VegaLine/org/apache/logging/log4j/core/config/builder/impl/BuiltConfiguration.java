...
extends AbstractConfiguration {
    ...
    public void setMonitorInterval(int intervalSeconds) {
        ...
        if (this instanceof Reconfigurable && intervalSeconds > 0 && (configSource = this.getConfigurationSource()) != null) {
            File configFile = configSource.getFile();
            if (intervalSeconds > 0) {
                this.getWatchManager().setIntervalSeconds(intervalSeconds);
                if (configFile != null) {
                    ConfiguratonFileWatcher watcher = new ConfiguratonFileWatcher((Reconfigurable)((Object)this), this.listeners);
