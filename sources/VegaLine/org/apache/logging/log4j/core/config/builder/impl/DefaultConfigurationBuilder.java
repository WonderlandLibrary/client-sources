...
implements ConfigurationBuilder<T> {
    ...
    @Override
    public AppenderComponentBuilder newAppender(String name, String type2) {
        return new DefaultAppenderComponentBuilder(this, name, type2);
    }
    ...
    @Override
    public <B extends ComponentBuilder<B>> ComponentBuilder<B> newComponent(String type2) {
        return new DefaultComponentBuilder(this, type2);
    }

    @Override
    public <B extends ComponentBuilder<B>> ComponentBuilder<B> newComponent(String name, String type2) {
        return new DefaultComponentBuilder(this, name, type2);
    }

    @Override
    public <B extends ComponentBuilder<B>> ComponentBuilder<B> newComponent(String name, String type2, String value) {
        return new DefaultComponentBuilder(this, name, type2, value);
    }
    ...
    @Override
    public FilterComponentBuilder newFilter(String type2, Filter.Result onMatch, Filter.Result onMisMatch) {
        return new DefaultFilterComponentBuilder(this, type2, onMatch.name(), onMisMatch.name());
    }

    @Override
    public FilterComponentBuilder newFilter(String type2, String onMatch, String onMisMatch) {
        return new DefaultFilterComponentBuilder(this, type2, onMatch, onMisMatch);
    }

    @Override
    public LayoutComponentBuilder newLayout(String type2) {
        return new DefaultLayoutComponentBuilder(this, type2);
    }
