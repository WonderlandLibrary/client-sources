...
implements RewritePolicy {
    ...
    public LogEvent rewrite(LogEvent source) {
        HashMap<String, String> props = new HashMap<String, String>(source.getContextData().toMap());
        ...
        Log4jLogEvent result = new Log4jLogEvent.Builder(source).setContextMap(props).build();
        return result;
    }
