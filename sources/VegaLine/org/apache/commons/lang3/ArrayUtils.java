...
public class ArrayUtils {
    ...
    public static <T> T[] nullToEmpty(T[] array, Class<T[]> type2) {
        if (type2 == null) {
            throw new IllegalArgumentException("The type must not be null");
        }
        if (array == null) {
            return type2.cast(Array.newInstance(type2.getComponentType(), 0));
        }
        return array;
    }
    ...
    public static <T> T[] subarray(T[] array, int startIndexInclusive, int endIndexExclusive) {
        ...
        if (newSize <= 0) {
            Object[] emptyArray = (Object[])Array.newInstance(type2, 0);
            return emptyArray;
        }
        Object[] subarray = (Object[])Array.newInstance(type2, newSize);
    ...
    public static <T> T[] add(T[] array, T element) {
        Class<?> type2;
        if (array != null) {
            type2 = array.getClass().getComponentType();
        } else if (element != null) {
            type2 = element.getClass();
        } else {
            throw new IllegalArgumentException("Arguments cannot both be null");
        }
        Object[] newArray = (Object[])ArrayUtils.copyArrayGrow1(array, type2);
