...
public class Validate {
    ...
    public static void isInstanceOf(Class<?> type2, Object obj) {
        if (!type2.isInstance(obj)) {
            throw new IllegalArgumentException(String.format(DEFAULT_IS_INSTANCE_OF_EX_MESSAGE, type2.getName(), obj == null ? "null" : obj.getClass().getName()));
        }
    }

    public static void isInstanceOf(Class<?> type2, Object obj, String message, Object ... values) {
        if (!type2.isInstance(obj)) {
            throw new IllegalArgumentException(String.format(message, values));
        }
    }
    ...
    public static void isAssignableFrom(Class<?> superType, Class<?> type2) {
        if (!superType.isAssignableFrom(type2)) {
            throw new IllegalArgumentException(String.format(DEFAULT_IS_ASSIGNABLE_EX_MESSAGE, type2 == null ? "null" : type2.getName(), superType.getName()));
        }
    }

    public static void isAssignableFrom(Class<?> superType, Class<?> type2, String message, Object ... values) {
        if (!superType.isAssignableFrom(type2)) {
            throw new IllegalArgumentException(String.format(message, values));
        }
    }
