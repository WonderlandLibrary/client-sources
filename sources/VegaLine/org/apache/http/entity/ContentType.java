...
implements Serializable {
    ...
    public static ContentType create(String mimeType, Charset charset) {
        String type2 = Args.notBlank(mimeType, "MIME type").toLowerCase(Locale.US);
        Args.check(ContentType.valid(type2), "MIME type may not contain reserved characters");
        return new ContentType(type2, charset);
    }
