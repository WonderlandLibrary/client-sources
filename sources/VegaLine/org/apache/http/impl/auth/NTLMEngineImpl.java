...
implements NTLMEngine {
    ...
    static class NTLMMessage {
        ...
        NTLMMessage(String messageBody, int expectedType) throws NTLMEngineException {
            ...
            int type2 = this.readULong(SIGNATURE.length);
            if (type2 != expectedType) {
                throw new NTLMEngineException("NTLM type " + Integer.toString(expectedType) + " message expected - instead got type " + Integer.toString(type2));
            }
