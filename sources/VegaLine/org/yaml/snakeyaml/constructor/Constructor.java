...
extends SafeConstructor {
            ...
            if (!possibleConstructors.isEmpty()) {
                ...
                if (possibleConstructors.size() == 1) {
                    ...
                    for (Node node2 : snode.getValue()) {
                        Class<?> type2 = c.getParameterTypes()[index];
                        node2.setType(type2);
    ...
    extends AbstractConstruct {
        ...
        public Object construct(Node nnode) {
            ...
            Object instance = Constructor.this.newInstance(type2, node, false);
            if (instance != BaseConstructor.NOT_INSTANTIATED_OBJECT) {
                return instance;
            }
            if (type2.isPrimitive() || type2 == String.class || Number.class.isAssignableFrom(type2) || type2 == Boolean.class || Date.class.isAssignableFrom(type2) || type2 == Character.class || type2 == BigInteger.class || type2 == BigDecimal.class || Enum.class.isAssignableFrom(type2) || Tag.BINARY.equals(node.getTag()) || Calendar.class.isAssignableFrom(type2) || type2 == UUID.class) {
    ...
    implements Construct {
        ...
        protected Property getProperty(Class<? extends Object> type2, String name) {
            return Constructor.this.getPropertyUtils().getProperty(type2, name);
        }
    }
}
