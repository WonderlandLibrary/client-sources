...
extends Property {
    ...
    public PropertySubstitute(String name, Class<?> type2, String readMethod, String writeMethod, Class<?> ... params) {
        super(name, type2);
    ...
    public PropertySubstitute(String name, Class<?> type2, Class<?> ... params) {
        this(name, type2, (String)null, (String)null, params);
    }
    ...
    private Method discoverMethod(Class<?> type2, String name, Class<?> ... params) {
