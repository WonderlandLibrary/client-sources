...
public final class ARBDrawInstanced {
    ...
    public static void glDrawElementsInstancedARB(int mode, int indices_count, int type2, long indices_buffer_offset, int primcount) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDrawElementsInstancedARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureElementVBOenabled(caps);
        ARBDrawInstanced.nglDrawElementsInstancedARBBO(mode, indices_count, type2, indices_buffer_offset, primcount, function_pointer);
    }
