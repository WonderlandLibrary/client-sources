...
public final class NVPresentVideo {
    ...
    public static void glPresentFrameKeyedNV(int video_slot, long minPresentTime, int beginPresentTimeId, int presentDurationId, int type2, int target0, int fill0, int key0, int target1, int fill1, int key1) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glPresentFrameKeyedNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPresentVideo.nglPresentFrameKeyedNV(video_slot, minPresentTime, beginPresentTimeId, presentDurationId, type2, target0, fill0, key0, target1, fill1, key1, function_pointer);
    }
    ...
    public static void glPresentFrameDualFillNV(int video_slot, long minPresentTime, int beginPresentTimeId, int presentDurationId, int type2, int target0, int fill0, int target1, int fill1, int target2, int fill2, int target3, int fill3) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glPresentFrameDualFillNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVPresentVideo.nglPresentFrameDualFillNV(video_slot, minPresentTime, beginPresentTimeId, presentDurationId, type2, target0, fill0, target1, fill1, target2, fill2, target3, fill3, function_pointer);
    }
