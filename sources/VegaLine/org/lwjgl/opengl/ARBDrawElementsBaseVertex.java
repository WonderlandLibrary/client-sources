...
public final class ARBDrawElementsBaseVertex {
    ...
    public static void glDrawElementsBaseVertex(int mode, int indices_count, int type2, long indices_buffer_offset, int basevertex) {
        GL32.glDrawElementsBaseVertex(mode, indices_count, type2, indices_buffer_offset, basevertex);
    }
    ...
    public static void glDrawRangeElementsBaseVertex(int mode, int start, int end, int indices_count, int type2, long indices_buffer_offset, int basevertex) {
        GL32.glDrawRangeElementsBaseVertex(mode, start, end, indices_count, type2, indices_buffer_offset, basevertex);
    }
    ...
    public static void glDrawElementsInstancedBaseVertex(int mode, int indices_count, int type2, long indices_buffer_offset, int primcount, int basevertex) {
        GL32.glDrawElementsInstancedBaseVertex(mode, indices_count, type2, indices_buffer_offset, primcount, basevertex);
    }
}
