...
public final class ARBBaseInstance {
    ...
    public static void glDrawElementsInstancedBaseInstance(int mode, int indices_count, int type2, long indices_buffer_offset, int primcount, int baseinstance) {
        GL42.glDrawElementsInstancedBaseInstance(mode, indices_count, type2, indices_buffer_offset, primcount, baseinstance);
    }
    ...
    public static void glDrawElementsInstancedBaseVertexBaseInstance(int mode, int indices_count, int type2, long indices_buffer_offset, int primcount, int basevertex, int baseinstance) {
        GL42.glDrawElementsInstancedBaseVertexBaseInstance(mode, indices_count, type2, indices_buffer_offset, primcount, basevertex, baseinstance);
    }
}
