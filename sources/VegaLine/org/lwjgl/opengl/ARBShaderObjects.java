...
public final class ARBShaderObjects {
    ...
    public static void glGetActiveUniformARB(int programObj, int index, IntBuffer length, IntBuffer size, IntBuffer type2, ByteBuffer name) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        BufferChecks.checkDirect(name);
        ARBShaderObjects.nglGetActiveUniformARB(programObj, index, name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type2), MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static int glGetActiveUniformTypeARB(int programObj, int index) {
        ...
        ARBShaderObjects.nglGetActiveUniformARB(programObj, index, 0, 0L, MemoryUtil.getAddress(type2, 1), MemoryUtil.getAddress(type2), APIUtil.getBufferByte0(caps), function_pointer);
        return type2.get(0);
    }
