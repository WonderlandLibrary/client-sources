...
public final class ARBIndirectParameters {
    ...
    public static void glMultiDrawElementsIndirectCountARB(int mode, int type2, ByteBuffer indirect, long drawcount, int maxdrawcount, int stride) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        ARBIndirectParameters.nglMultiDrawElementsIndirectCountARB(mode, type2, MemoryUtil.getAddress(indirect), drawcount, maxdrawcount, stride, function_pointer);
    }
    ...
    public static void glMultiDrawElementsIndirectCountARB(int mode, int type2, long indirect_buffer_offset, long drawcount, int maxdrawcount, int stride) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMultiDrawElementsIndirectCountARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureIndirectBOenabled(caps);
        ARBIndirectParameters.nglMultiDrawElementsIndirectCountARBBO(mode, type2, indirect_buffer_offset, drawcount, maxdrawcount, stride, function_pointer);
    }
    ...
    public static void glMultiDrawElementsIndirectCountARB(int mode, int type2, IntBuffer indirect, long drawcount, int maxdrawcount, int stride) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMultiDrawElementsIndirectCountARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureIndirectBOdisabled(caps);
