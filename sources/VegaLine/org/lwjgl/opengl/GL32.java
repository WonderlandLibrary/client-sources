...
public final class GL32 {
    ...
    public static void glDrawElementsBaseVertex(int mode, int indices_count, int type2, long indices_buffer_offset, int basevertex) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDrawElementsBaseVertex;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureElementVBOenabled(caps);
        GL32.nglDrawElementsBaseVertexBO(mode, indices_count, type2, indices_buffer_offset, basevertex, function_pointer);
    }
    ...
    public static void glDrawRangeElementsBaseVertex(int mode, int start, int end, int indices_count, int type2, long indices_buffer_offset, int basevertex) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDrawRangeElementsBaseVertex;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureElementVBOenabled(caps);
        GL32.nglDrawRangeElementsBaseVertexBO(mode, start, end, indices_count, type2, indices_buffer_offset, basevertex, function_pointer);
    }
    ...
    public static void glDrawElementsInstancedBaseVertex(int mode, int indices_count, int type2, long indices_buffer_offset, int primcount, int basevertex) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDrawElementsInstancedBaseVertex;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureElementVBOenabled(caps);
        GL32.nglDrawElementsInstancedBaseVertexBO(mode, indices_count, type2, indices_buffer_offset, primcount, basevertex, function_pointer);
    }
