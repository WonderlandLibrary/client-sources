...
public final class GL40 {
    ...
    public static void glDrawElementsIndirect(int mode, int type2, ByteBuffer indirect) {
        ...
        GL40.nglDrawElementsIndirect(mode, type2, MemoryUtil.getAddress(indirect), function_pointer);
    }
    ...
    public static void glDrawElementsIndirect(int mode, int type2, long indirect_buffer_offset) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureIndirectBOenabled(caps);
        GL40.nglDrawElementsIndirectBO(mode, type2, indirect_buffer_offset, function_pointer);
    }
