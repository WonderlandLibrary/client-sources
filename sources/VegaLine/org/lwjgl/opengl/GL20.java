...
public final class GL20 {
    ...
    public static int glCreateShader(int type2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        int __result = GL20.nglCreateShader(type2, function_pointer);
        return __result;
    }
    ...
    public static void glGetActiveUniform(int program, int index, IntBuffer length, IntBuffer size, IntBuffer type2, ByteBuffer name) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        BufferChecks.checkBuffer(type2, 1);
        BufferChecks.checkDirect(name);
        GL20.nglGetActiveUniform(program, index, name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type2), MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static int glGetActiveUniformType(int program, int index) {
        ...
        long function_pointer = caps.glGetActiveUniform;
        BufferChecks.checkFunctionAddress(function_pointer);
        IntBuffer type2 = APIUtil.getBufferInt(caps);
        GL20.nglGetActiveUniform(program, index, 0, 0L, MemoryUtil.getAddress(type2, 1), MemoryUtil.getAddress(type2), APIUtil.getBufferByte0(caps), function_pointer);
        return type2.get(0);
    }
    ...
    public static void glVertexAttribPointer(int index, int size, int type2, boolean normalized, int stride, long buffer_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribPointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOenabled(caps);
        GL20.nglVertexAttribPointerBO(index, size, type2, normalized, stride, buffer_buffer_offset, function_pointer);
    }

    static native void nglVertexAttribPointerBO(int var0, int var1, int var2, boolean var3, int var4, long var5, long var7);

    public static void glVertexAttribPointer(int index, int size, int type2, boolean normalized, int stride, ByteBuffer buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribPointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
        ...
        GL20.nglVertexAttribPointer(index, size, type2, normalized, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }
    ...
    public static void glGetActiveAttrib(int program, int index, IntBuffer length, IntBuffer size, IntBuffer type2, ByteBuffer name) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        BufferChecks.checkBuffer(type2, 1);
        BufferChecks.checkDirect(name);
        GL20.nglGetActiveAttrib(program, index, name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type2), MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static int glGetActiveAttribType(int program, int index) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        IntBuffer type2 = APIUtil.getBufferInt(caps);
        GL20.nglGetActiveAttrib(program, index, 0, 0L, MemoryUtil.getAddress(type2, 1), MemoryUtil.getAddress(type2), APIUtil.getBufferByte0(caps), function_pointer);
        return type2.get(0);
    }
