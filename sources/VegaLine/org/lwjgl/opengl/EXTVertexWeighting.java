...
public final class EXTVertexWeighting {
    ...
    public static void glVertexWeightPointerEXT(int size, int type2, int stride, long pPointer_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexWeightPointerEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOenabled(caps);
        EXTVertexWeighting.nglVertexWeightPointerEXTBO(size, type2, stride, pPointer_buffer_offset, function_pointer);
    }
