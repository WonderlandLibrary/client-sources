...
public final class ATIVertexArrayObject {
    ...
    public static void glArrayObjectATI(int array, int size, int type2, int stride, int buffer, int offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glArrayObjectATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexArrayObject.nglArrayObjectATI(array, size, type2, stride, buffer, offset, function_pointer);
    }
    ...
    public static void glVariantArrayObjectATI(int id, int type2, int stride, int buffer, int offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVariantArrayObjectATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexArrayObject.nglVariantArrayObjectATI(id, type2, stride, buffer, offset, function_pointer);
    }
