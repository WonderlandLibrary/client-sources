...
public final class EXTFogCoord {
    ...
    public static void glFogCoordPointerEXT(int type2, int stride, long data_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glFogCoordPointerEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOenabled(caps);
        EXTFogCoord.nglFogCoordPointerEXTBO(type2, stride, data_buffer_offset, function_pointer);
    }
