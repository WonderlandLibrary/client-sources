...
public final class GL42 {
    ...
    public static void glDrawElementsInstancedBaseInstance(int mode, int indices_count, int type2, long indices_buffer_offset, int primcount, int baseinstance) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDrawElementsInstancedBaseInstance;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureElementVBOenabled(caps);
        GL42.nglDrawElementsInstancedBaseInstanceBO(mode, indices_count, type2, indices_buffer_offset, primcount, baseinstance, function_pointer);
    }
    ...
    public static void glDrawElementsInstancedBaseVertexBaseInstance(int mode, int indices_count, int type2, long indices_buffer_offset, int primcount, int basevertex, int baseinstance) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDrawElementsInstancedBaseVertexBaseInstance;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureElementVBOenabled(caps);
        GL42.nglDrawElementsInstancedBaseVertexBaseInstanceBO(mode, indices_count, type2, indices_buffer_offset, primcount, basevertex, baseinstance, function_pointer);
    }
