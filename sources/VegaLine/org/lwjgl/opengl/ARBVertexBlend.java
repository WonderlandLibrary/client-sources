...
public final class ARBVertexBlend {
    ...
    public static void glWeightPointerARB(int size, int type2, int stride, long pPointer_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glWeightPointerARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOenabled(caps);
        ARBVertexBlend.nglWeightPointerARBBO(size, type2, stride, pPointer_buffer_offset, function_pointer);
    }
