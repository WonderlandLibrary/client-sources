...
public final class GL30 {
    ...
    public static void glVertexAttribIPointer(int index, int size, int type2, int stride, ByteBuffer buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        GL30.nglVertexAttribIPointer(index, size, type2, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }

    public static void glVertexAttribIPointer(int index, int size, int type2, int stride, IntBuffer buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribIPointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
    ...
    public static void glVertexAttribIPointer(int index, int size, int type2, int stride, ShortBuffer buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribIPointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
    ...
    public static void glVertexAttribIPointer(int index, int size, int type2, int stride, long buffer_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribIPointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOenabled(caps);
        GL30.nglVertexAttribIPointerBO(index, size, type2, stride, buffer_buffer_offset, function_pointer);
    }
    ...
    public static void glGetTransformFeedbackVarying(int program, int index, IntBuffer length, IntBuffer size, IntBuffer type2, ByteBuffer name) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        BufferChecks.checkDirect(name);
        GL30.nglGetTransformFeedbackVarying(program, index, name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type2), MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static String glGetTransformFeedbackVarying(int program, int index, int bufSize, IntBuffer size, IntBuffer type2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetTransformFeedbackVarying;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(size, 1);
        ...
        GL30.nglGetTransformFeedbackVarying(program, index, bufSize, MemoryUtil.getAddress0(name_length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type2), MemoryUtil.getAddress(name), function_pointer);
