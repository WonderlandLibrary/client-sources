...
public final class ARBMatrixPalette {
    ...
    public static void glMatrixIndexPointerARB(int size, int type2, int stride, long pPointer_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMatrixIndexPointerARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOenabled(caps);
        ARBMatrixPalette.nglMatrixIndexPointerARBBO(size, type2, stride, pPointer_buffer_offset, function_pointer);
    }
