...
public final class EXTDrawRangeElements {
    ...
    public static void glDrawRangeElementsEXT(int mode, int start, int end, int pIndices_count, int type2, long pIndices_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDrawRangeElementsEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureElementVBOenabled(caps);
        EXTDrawRangeElements.nglDrawRangeElementsEXTBO(mode, start, end, pIndices_count, type2, pIndices_buffer_offset, function_pointer);
    }
