...
public final class GL43 {
    ...
    public static void glClearBufferData(int target, int internalformat, int format, int type2, ByteBuffer data) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glClearBufferData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data, 1);
        GL43.nglClearBufferData(target, internalformat, format, type2, MemoryUtil.getAddress(data), function_pointer);
    }

    static native void nglClearBufferData(int var0, int var1, int var2, int var3, long var4, long var6);

    public static void glClearBufferSubData(int target, int internalformat, long offset, long size, int format, int type2, ByteBuffer data) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glClearBufferSubData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data, 1);
        GL43.nglClearBufferSubData(target, internalformat, offset, size, format, type2, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glDebugMessageControl(int source, int type2, int severity, IntBuffer ids, boolean enabled) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        GL43.nglDebugMessageControl(source, type2, severity, ids == null ? 0 : ids.remaining(), MemoryUtil.getAddressSafe(ids), enabled, function_pointer);
    }

    static native void nglDebugMessageControl(int var0, int var1, int var2, int var3, long var4, boolean var6, long var7);

    public static void glDebugMessageInsert(int source, int type2, int id, int severity, ByteBuffer buf) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDebugMessageInsert;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(buf);
        GL43.nglDebugMessageInsert(source, type2, id, severity, buf.remaining(), MemoryUtil.getAddress(buf), function_pointer);
    }

    static native void nglDebugMessageInsert(int var0, int var1, int var2, int var3, int var4, long var5, long var7);

    public static void glDebugMessageInsert(int source, int type2, int id, int severity, CharSequence buf) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDebugMessageInsert;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglDebugMessageInsert(source, type2, id, severity, buf.length(), APIUtil.getBuffer(caps, buf), function_pointer);
    }
    ...
    public static void glMultiDrawElementsIndirect(int mode, int type2, ByteBuffer indirect, int primcount, int stride) {
        ...
        GL43.nglMultiDrawElementsIndirect(mode, type2, MemoryUtil.getAddress(indirect), primcount, stride, function_pointer);
    }
    ...
    public static void glMultiDrawElementsIndirect(int mode, int type2, long indirect_buffer_offset, int primcount, int stride) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureIndirectBOenabled(caps);
        GL43.nglMultiDrawElementsIndirectBO(mode, type2, indirect_buffer_offset, primcount, stride, function_pointer);
    }
    ...
    public static void glVertexAttribFormat(int attribindex, int size, int type2, boolean normalized, int relativeoffset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribFormat;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglVertexAttribFormat(attribindex, size, type2, normalized, relativeoffset, function_pointer);
    }

    static native void nglVertexAttribFormat(int var0, int var1, int var2, boolean var3, int var4, long var5);

    public static void glVertexAttribIFormat(int attribindex, int size, int type2, int relativeoffset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribIFormat;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglVertexAttribIFormat(attribindex, size, type2, relativeoffset, function_pointer);
    }

    static native void nglVertexAttribIFormat(int var0, int var1, int var2, int var3, long var4);

    public static void glVertexAttribLFormat(int attribindex, int size, int type2, int relativeoffset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribLFormat;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL43.nglVertexAttribLFormat(attribindex, size, type2, relativeoffset, function_pointer);
    }
