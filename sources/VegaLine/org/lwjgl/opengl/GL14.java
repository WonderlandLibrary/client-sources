...
public final class GL14 {
    ...
    public static void glFogCoordPointer(int type2, int stride, long data_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glFogCoordPointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOenabled(caps);
        GL14.nglFogCoordPointerBO(type2, stride, data_buffer_offset, function_pointer);
    }
    ...
    public static void glSecondaryColorPointer(int size, int type2, int stride, long data_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glSecondaryColorPointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOenabled(caps);
        GL14.nglSecondaryColorPointerBO(size, type2, stride, data_buffer_offset, function_pointer);
    }
