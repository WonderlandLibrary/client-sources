...
public final class NVTransformFeedback {
    ...
    public static void glGetActiveVaryingNV(int program, int index, IntBuffer length, IntBuffer size, IntBuffer type2, ByteBuffer name) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        BufferChecks.checkDirect(name);
        NVTransformFeedback.nglGetActiveVaryingNV(program, index, name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type2), MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static int glGetActiveVaryingTypeNV(int program, int index) {
        ...
        NVTransformFeedback.nglGetActiveVaryingNV(program, index, 0, 0L, MemoryUtil.getAddress(type2, 1), MemoryUtil.getAddress(type2), APIUtil.getBufferByte0(caps), function_pointer);
        return type2.get(0);
    }
