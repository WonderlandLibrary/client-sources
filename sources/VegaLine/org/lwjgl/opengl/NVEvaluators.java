...
public final class NVEvaluators {
    ...
    public static void glGetMapControlPointsNV(int target, int index, int type2, int ustride, int vstride, boolean packed, FloatBuffer pPoints) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetMapControlPointsNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pPoints);
        NVEvaluators.nglGetMapControlPointsNV(target, index, type2, ustride, vstride, packed, MemoryUtil.getAddress(pPoints), function_pointer);
    }
    ...
    public static void glMapControlPointsNV(int target, int index, int type2, int ustride, int vstride, int uorder, int vorder, boolean packed, FloatBuffer pPoints) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glMapControlPointsNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(pPoints);
        NVEvaluators.nglMapControlPointsNV(target, index, type2, ustride, vstride, uorder, vorder, packed, MemoryUtil.getAddress(pPoints), function_pointer);
    }
