...
public final class ATIVertexAttribArrayObject {
    ...
    public static void glVertexAttribArrayObjectATI(int index, int size, int type2, boolean normalized, int stride, int buffer, int offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribArrayObjectATI;
        BufferChecks.checkFunctionAddress(function_pointer);
        ATIVertexAttribArrayObject.nglVertexAttribArrayObjectATI(index, size, type2, normalized, stride, buffer, offset, function_pointer);
    }
