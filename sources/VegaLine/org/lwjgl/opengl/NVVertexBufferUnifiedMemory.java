...
public final class NVVertexBufferUnifiedMemory {
    ...
    public static void glVertexFormatNV(int size, int type2, int stride) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexFormatNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexBufferUnifiedMemory.nglVertexFormatNV(size, type2, stride, function_pointer);
    }

    static native void nglVertexFormatNV(int var0, int var1, int var2, long var3);

    public static void glNormalFormatNV(int type2, int stride) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glNormalFormatNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexBufferUnifiedMemory.nglNormalFormatNV(type2, stride, function_pointer);
    }

    static native void nglNormalFormatNV(int var0, int var1, long var2);

    public static void glColorFormatNV(int size, int type2, int stride) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glColorFormatNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexBufferUnifiedMemory.nglColorFormatNV(size, type2, stride, function_pointer);
    }

    static native void nglColorFormatNV(int var0, int var1, int var2, long var3);

    public static void glIndexFormatNV(int type2, int stride) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glIndexFormatNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexBufferUnifiedMemory.nglIndexFormatNV(type2, stride, function_pointer);
    }

    static native void nglIndexFormatNV(int var0, int var1, long var2);

    public static void glTexCoordFormatNV(int size, int type2, int stride) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glTexCoordFormatNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexBufferUnifiedMemory.nglTexCoordFormatNV(size, type2, stride, function_pointer);
    }
    ...
    public static void glSecondaryColorFormatNV(int size, int type2, int stride) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glSecondaryColorFormatNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexBufferUnifiedMemory.nglSecondaryColorFormatNV(size, type2, stride, function_pointer);
    }

    static native void nglSecondaryColorFormatNV(int var0, int var1, int var2, long var3);

    public static void glFogCoordFormatNV(int type2, int stride) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glFogCoordFormatNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexBufferUnifiedMemory.nglFogCoordFormatNV(type2, stride, function_pointer);
    }

    static native void nglFogCoordFormatNV(int var0, int var1, long var2);

    public static void glVertexAttribFormatNV(int index, int size, int type2, boolean normalized, int stride) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribFormatNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexBufferUnifiedMemory.nglVertexAttribFormatNV(index, size, type2, normalized, stride, function_pointer);
    }

    static native void nglVertexAttribFormatNV(int var0, int var1, int var2, boolean var3, int var4, long var5);

    public static void glVertexAttribIFormatNV(int index, int size, int type2, int stride) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribIFormatNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        NVVertexBufferUnifiedMemory.nglVertexAttribIFormatNV(index, size, type2, stride, function_pointer);
    }
