...
public final class ARBDebugOutput {
    ...
    public static void glDebugMessageControlARB(int source, int type2, int severity, IntBuffer ids, boolean enabled) {
        ...
        ARBDebugOutput.nglDebugMessageControlARB(source, type2, severity, ids == null ? 0 : ids.remaining(), MemoryUtil.getAddressSafe(ids), enabled, function_pointer);
    }

    static native void nglDebugMessageControlARB(int var0, int var1, int var2, int var3, long var4, boolean var6, long var7);

    public static void glDebugMessageInsertARB(int source, int type2, int id, int severity, ByteBuffer buf) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDebugMessageInsertARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(buf);
        ARBDebugOutput.nglDebugMessageInsertARB(source, type2, id, severity, buf.remaining(), MemoryUtil.getAddress(buf), function_pointer);
    }

    static native void nglDebugMessageInsertARB(int var0, int var1, int var2, int var3, int var4, long var5, long var7);

    public static void glDebugMessageInsertARB(int source, int type2, int id, int severity, CharSequence buf) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDebugMessageInsertARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBDebugOutput.nglDebugMessageInsertARB(source, type2, id, severity, buf.length(), APIUtil.getBuffer(caps, buf), function_pointer);
    }
