...
public final class GL33 {
    ...
    public static void glVertexP2ui(int type2, int value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglVertexP2ui(type2, value, function_pointer);
    }
    ...
    public static void glVertexP3ui(int type2, int value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglVertexP3ui(type2, value, function_pointer);
    }
    ...
    public static void glVertexP4ui(int type2, int value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglVertexP4ui(type2, value, function_pointer);
    }
    ...
    public static void glVertexP2u(int type2, IntBuffer value) {
        ...
        GL33.nglVertexP2uiv(type2, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glVertexP3u(int type2, IntBuffer value) {
        ...
        GL33.nglVertexP3uiv(type2, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glVertexP4u(int type2, IntBuffer value) {
        ...
        GL33.nglVertexP4uiv(type2, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glTexCoordP1ui(int type2, int coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglTexCoordP1ui(type2, coords, function_pointer);
    }
    ...
    public static void glTexCoordP2ui(int type2, int coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglTexCoordP2ui(type2, coords, function_pointer);
    }
    ...
    public static void glTexCoordP3ui(int type2, int coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglTexCoordP3ui(type2, coords, function_pointer);
    }
    ...
    public static void glTexCoordP4ui(int type2, int coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglTexCoordP4ui(type2, coords, function_pointer);
    }
    ...
    public static void glTexCoordP1u(int type2, IntBuffer coords) {
        ...
        GL33.nglTexCoordP1uiv(type2, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glTexCoordP2u(int type2, IntBuffer coords) {
        ...
        GL33.nglTexCoordP2uiv(type2, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glTexCoordP3u(int type2, IntBuffer coords) {
        ...
        GL33.nglTexCoordP3uiv(type2, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glTexCoordP4u(int type2, IntBuffer coords) {
        ...
        GL33.nglTexCoordP4uiv(type2, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glMultiTexCoordP1ui(int texture, int type2, int coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglMultiTexCoordP1ui(texture, type2, coords, function_pointer);
    }
    ...
    public static void glMultiTexCoordP2ui(int texture, int type2, int coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglMultiTexCoordP2ui(texture, type2, coords, function_pointer);
    }
    ...
    public static void glMultiTexCoordP3ui(int texture, int type2, int coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglMultiTexCoordP3ui(texture, type2, coords, function_pointer);
    }
    ...
    public static void glMultiTexCoordP4ui(int texture, int type2, int coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglMultiTexCoordP4ui(texture, type2, coords, function_pointer);
    }
    ...
    public static void glMultiTexCoordP1u(int texture, int type2, IntBuffer coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(coords, 1);
        GL33.nglMultiTexCoordP1uiv(texture, type2, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glMultiTexCoordP2u(int texture, int type2, IntBuffer coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(coords, 2);
        GL33.nglMultiTexCoordP2uiv(texture, type2, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glMultiTexCoordP3u(int texture, int type2, IntBuffer coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(coords, 3);
        GL33.nglMultiTexCoordP3uiv(texture, type2, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glMultiTexCoordP4u(int texture, int type2, IntBuffer coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(coords, 4);
        GL33.nglMultiTexCoordP4uiv(texture, type2, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glNormalP3ui(int type2, int coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglNormalP3ui(type2, coords, function_pointer);
    }
    ...
    public static void glNormalP3u(int type2, IntBuffer coords) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(coords, 3);
        GL33.nglNormalP3uiv(type2, MemoryUtil.getAddress(coords), function_pointer);
    }
    ...
    public static void glColorP3ui(int type2, int color) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglColorP3ui(type2, color, function_pointer);
    }
    ...
    public static void glColorP4ui(int type2, int color) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglColorP4ui(type2, color, function_pointer);
    }
    ...
    public static void glColorP3u(int type2, IntBuffer color) {
        ...
        GL33.nglColorP3uiv(type2, MemoryUtil.getAddress(color), function_pointer);
    }
    ...
    public static void glColorP4u(int type2, IntBuffer color) {
        ...
        GL33.nglColorP4uiv(type2, MemoryUtil.getAddress(color), function_pointer);
    }
    ...
    public static void glSecondaryColorP3ui(int type2, int color) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglSecondaryColorP3ui(type2, color, function_pointer);
    }
    ...
    public static void glSecondaryColorP3u(int type2, IntBuffer color) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(color, 3);
        GL33.nglSecondaryColorP3uiv(type2, MemoryUtil.getAddress(color), function_pointer);
    }
    ...
    public static void glVertexAttribP1ui(int index, int type2, boolean normalized, int value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglVertexAttribP1ui(index, type2, normalized, value, function_pointer);
    }
    ...
    public static void glVertexAttribP2ui(int index, int type2, boolean normalized, int value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglVertexAttribP2ui(index, type2, normalized, value, function_pointer);
    }
    ...
    public static void glVertexAttribP3ui(int index, int type2, boolean normalized, int value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglVertexAttribP3ui(index, type2, normalized, value, function_pointer);
    }
    ...
    public static void glVertexAttribP4ui(int index, int type2, boolean normalized, int value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL33.nglVertexAttribP4ui(index, type2, normalized, value, function_pointer);
    }
    ...
    public static void glVertexAttribP1u(int index, int type2, boolean normalized, IntBuffer value) {
        ...
        GL33.nglVertexAttribP1uiv(index, type2, normalized, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glVertexAttribP2u(int index, int type2, boolean normalized, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 2);
        GL33.nglVertexAttribP2uiv(index, type2, normalized, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glVertexAttribP3u(int index, int type2, boolean normalized, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 3);
        GL33.nglVertexAttribP3uiv(index, type2, normalized, MemoryUtil.getAddress(value), function_pointer);
    }
    ...
    public static void glVertexAttribP4u(int index, int type2, boolean normalized, IntBuffer value) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(value, 4);
        GL33.nglVertexAttribP4uiv(index, type2, normalized, MemoryUtil.getAddress(value), function_pointer);
    }
