...
public final class EXTSecondaryColor {
    ...
    public static void glSecondaryColorPointerEXT(int size, int type2, int stride, long pPointer_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glSecondaryColorPointerEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOenabled(caps);
        EXTSecondaryColor.nglSecondaryColorPointerEXTBO(size, type2, stride, pPointer_buffer_offset, function_pointer);
    }
