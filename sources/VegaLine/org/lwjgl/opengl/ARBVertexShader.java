...
public final class ARBVertexShader {
    ...
    public static void glVertexAttribPointerARB(int index, int size, int type2, boolean normalized, int stride, long buffer_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribPointerARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOenabled(caps);
        ARBVertexShader.nglVertexAttribPointerARBBO(index, size, type2, normalized, stride, buffer_buffer_offset, function_pointer);
    }

    static native void nglVertexAttribPointerARBBO(int var0, int var1, int var2, boolean var3, int var4, long var5, long var7);

    public static void glVertexAttribPointerARB(int index, int size, int type2, boolean normalized, int stride, ByteBuffer buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribPointerARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
        ...
        ARBVertexShader.nglVertexAttribPointerARB(index, size, type2, normalized, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }
    ...
    public static void glGetActiveAttribARB(int programObj, int index, IntBuffer length, IntBuffer size, IntBuffer type2, ByteBuffer name) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        BufferChecks.checkDirect(name);
        ARBVertexShader.nglGetActiveAttribARB(programObj, index, name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(size), MemoryUtil.getAddress(type2), MemoryUtil.getAddress(name), function_pointer);
    }
    ...
    public static int glGetActiveAttribTypeARB(int programObj, int index) {
        ...
        ARBVertexShader.nglGetActiveAttribARB(programObj, index, 0, 0L, MemoryUtil.getAddress(type2, 1), MemoryUtil.getAddress(type2), APIUtil.getBufferByte0(caps), function_pointer);
        return type2.get(0);
    }
