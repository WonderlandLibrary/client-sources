...
public final class EXTDrawInstanced {
    ...
    public static void glDrawElementsInstancedEXT(int mode, int indices_count, int type2, long indices_buffer_offset, int primcount) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDrawElementsInstancedEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureElementVBOenabled(caps);
        EXTDrawInstanced.nglDrawElementsInstancedEXTBO(mode, indices_count, type2, indices_buffer_offset, primcount, function_pointer);
    }
