...
public final class GL45 {
    ...
    public static void glClearNamedBufferData(int buffer, int internalformat, int format, int type2, ByteBuffer data) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glClearNamedBufferData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data, 1);
        GL45.nglClearNamedBufferData(buffer, internalformat, format, type2, MemoryUtil.getAddress(data), function_pointer);
    }

    static native void nglClearNamedBufferData(int var0, int var1, int var2, int var3, long var4, long var6);

    public static void glClearNamedBufferSubData(int buffer, int internalformat, long offset, long size, int format, int type2, ByteBuffer data) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glClearNamedBufferSubData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data, 1);
        GL45.nglClearNamedBufferSubData(buffer, internalformat, offset, size, format, type2, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glTextureSubImage1D(int texture, int level, int xoffset, int width, int format, int type2, ByteBuffer pixels) {
        ...
        GL45.nglTextureSubImage1D(texture, level, xoffset, width, format, type2, MemoryUtil.getAddress(pixels), function_pointer);
    }
    ...
    public static void glTextureSubImage1D(int texture, int level, int xoffset, int width, int format, int type2, long pixels_buffer_offset) {
        ...
        GL45.nglTextureSubImage1DBO(texture, level, xoffset, width, format, type2, pixels_buffer_offset, function_pointer);
    }
    ...
    public static void glTextureSubImage2D(int texture, int level, int xoffset, int yoffset, int width, int height, int format, int type2, ByteBuffer pixels) {
        ...
        GL45.nglTextureSubImage2D(texture, level, xoffset, yoffset, width, height, format, type2, MemoryUtil.getAddress(pixels), function_pointer);
    }
    ...
    public static void glTextureSubImage2D(int texture, int level, int xoffset, int yoffset, int width, int height, int format, int type2, long pixels_buffer_offset) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureUnpackPBOenabled(caps);
        GL45.nglTextureSubImage2DBO(texture, level, xoffset, yoffset, width, height, format, type2, pixels_buffer_offset, function_pointer);
    }
    ...
    public static void glTextureSubImage3D(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type2, ByteBuffer pixels) {
        ...
        GL45.nglTextureSubImage3D(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type2, MemoryUtil.getAddress(pixels), function_pointer);
    }
    ...
    public static void glTextureSubImage3D(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type2, long pixels_buffer_offset) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureUnpackPBOenabled(caps);
        GL45.nglTextureSubImage3DBO(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type2, pixels_buffer_offset, function_pointer);
    }
    ...
    public static void glGetTextureImage(int texture, int level, int format, int type2, ByteBuffer pixels) {
        ...
        GL45.nglGetTextureImage(texture, level, format, type2, pixels.remaining(), MemoryUtil.getAddress(pixels), function_pointer);
    }
    ...
    public static void glGetTextureImage(int texture, int level, int format, int type2, DoubleBuffer pixels) {
        ...
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(pixels);
        GL45.nglGetTextureImage(texture, level, format, type2, pixels.remaining() << 3, MemoryUtil.getAddress(pixels), function_pointer);
    }
    ...
    public static void glGetTextureImage(int texture, int level, int format, int type2, FloatBuffer pixels) {
        ...
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(pixels);
        GL45.nglGetTextureImage(texture, level, format, type2, pixels.remaining() << 2, MemoryUtil.getAddress(pixels), function_pointer);
    }
    ...
    public static void glGetTextureImage(int texture, int level, int format, int type2, ShortBuffer pixels) {
        ...
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(pixels);
        GL45.nglGetTextureImage(texture, level, format, type2, pixels.remaining() << 1, MemoryUtil.getAddress(pixels), function_pointer);
    }
    ...
    public static void glGetTextureImage(int texture, int level, int format, int type2, int pixels_bufSize, long pixels_buffer_offset) {
        ...
        GL45.nglGetTextureImageBO(texture, level, format, type2, pixels_bufSize, pixels_buffer_offset, function_pointer);
    }
    ...
    public static void glVertexArrayAttribFormat(int vaobj, int attribindex, int size, int type2, boolean normalized, int relativeoffset) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL45.nglVertexArrayAttribFormat(vaobj, attribindex, size, type2, normalized, relativeoffset, function_pointer);
    }
    ...
    public static void glVertexArrayAttribIFormat(int vaobj, int attribindex, int size, int type2, int relativeoffset) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL45.nglVertexArrayAttribIFormat(vaobj, attribindex, size, type2, relativeoffset, function_pointer);
    }
    ...
    public static void glVertexArrayAttribLFormat(int vaobj, int attribindex, int size, int type2, int relativeoffset) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GL45.nglVertexArrayAttribLFormat(vaobj, attribindex, size, type2, relativeoffset, function_pointer);
    }
    ...
    public static void glGetTextureSubImage(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type2, ByteBuffer pixels) {
        ...
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(pixels);
        GL45.nglGetTextureSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type2, pixels.remaining(), MemoryUtil.getAddress(pixels), function_pointer);
    }
    ...
    public static void glGetTextureSubImage(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type2, DoubleBuffer pixels) {
        ...
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(pixels);
        GL45.nglGetTextureSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type2, pixels.remaining() << 3, MemoryUtil.getAddress(pixels), function_pointer);
    }
    ...
    public static void glGetTextureSubImage(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type2, FloatBuffer pixels) {
        ...
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(pixels);
        GL45.nglGetTextureSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type2, pixels.remaining() << 2, MemoryUtil.getAddress(pixels), function_pointer);
    }
    ...
    public static void glGetTextureSubImage(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type2, ShortBuffer pixels) {
        ...
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(pixels);
        GL45.nglGetTextureSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type2, pixels.remaining() << 1, MemoryUtil.getAddress(pixels), function_pointer);
    }
    ...
    public static void glGetTextureSubImage(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type2, int pixels_bufSize, long pixels_buffer_offset) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOenabled(caps);
        GL45.nglGetTextureSubImageBO(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type2, pixels_bufSize, pixels_buffer_offset, function_pointer);
    }
    ...
    public static void glReadnPixels(int x, int y, int width, int height, int format, int type2, ByteBuffer pixels) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glReadnPixels;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(pixels);
        GL45.nglReadnPixels(x, y, width, height, format, type2, pixels.remaining(), MemoryUtil.getAddress(pixels), function_pointer);
    }

    public static void glReadnPixels(int x, int y, int width, int height, int format, int type2, DoubleBuffer pixels) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glReadnPixels;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(pixels);
        GL45.nglReadnPixels(x, y, width, height, format, type2, pixels.remaining() << 3, MemoryUtil.getAddress(pixels), function_pointer);
    }

    public static void glReadnPixels(int x, int y, int width, int height, int format, int type2, FloatBuffer pixels) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glReadnPixels;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(pixels);
        GL45.nglReadnPixels(x, y, width, height, format, type2, pixels.remaining() << 2, MemoryUtil.getAddress(pixels), function_pointer);
    }

    public static void glReadnPixels(int x, int y, int width, int height, int format, int type2, IntBuffer pixels) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glReadnPixels;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
    ...
    public static void glReadnPixels(int x, int y, int width, int height, int format, int type2, ShortBuffer pixels) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glReadnPixels;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(pixels);
        GL45.nglReadnPixels(x, y, width, height, format, type2, pixels.remaining() << 1, MemoryUtil.getAddress(pixels), function_pointer);
    }

    static native void nglReadnPixels(int var0, int var1, int var2, int var3, int var4, int var5, int var6, long var7, long var9);

    public static void glReadnPixels(int x, int y, int width, int height, int format, int type2, int pixels_bufSize, long pixels_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glReadnPixels;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOenabled(caps);
        GL45.nglReadnPixelsBO(x, y, width, height, format, type2, pixels_bufSize, pixels_buffer_offset, function_pointer);
    }
