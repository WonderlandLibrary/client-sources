...
public final class GL31 {
    ...
    public static void glDrawElementsInstanced(int mode, int indices_count, int type2, long indices_buffer_offset, int primcount) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDrawElementsInstanced;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureElementVBOenabled(caps);
        GL31.nglDrawElementsInstancedBO(mode, indices_count, type2, indices_buffer_offset, primcount, function_pointer);
    }
