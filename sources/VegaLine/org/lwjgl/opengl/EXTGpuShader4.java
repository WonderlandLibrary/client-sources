...
public final class EXTGpuShader4 {
    ...
    public static void glVertexAttribIPointerEXT(int index, int size, int type2, int stride, ByteBuffer buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        EXTGpuShader4.nglVertexAttribIPointerEXT(index, size, type2, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }

    public static void glVertexAttribIPointerEXT(int index, int size, int type2, int stride, IntBuffer buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribIPointerEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
    ...
    public static void glVertexAttribIPointerEXT(int index, int size, int type2, int stride, ShortBuffer buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribIPointerEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
    ...
    public static void glVertexAttribIPointerEXT(int index, int size, int type2, int stride, long buffer_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribIPointerEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOenabled(caps);
        EXTGpuShader4.nglVertexAttribIPointerEXTBO(index, size, type2, stride, buffer_buffer_offset, function_pointer);
    }
