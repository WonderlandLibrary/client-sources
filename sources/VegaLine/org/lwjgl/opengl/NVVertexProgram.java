...
extends NVProgram {
    ...
    public static void glVertexAttribPointerNV(int index, int size, int type2, int stride, DoubleBuffer buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        NVVertexProgram.nglVertexAttribPointerNV(index, size, type2, stride, MemoryUtil.getAddress(buffer), function_pointer);
    }

    public static void glVertexAttribPointerNV(int index, int size, int type2, int stride, FloatBuffer buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribPointerNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
    ...
    public static void glVertexAttribPointerNV(int index, int size, int type2, int stride, ByteBuffer buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribPointerNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
    ...
    public static void glVertexAttribPointerNV(int index, int size, int type2, int stride, IntBuffer buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribPointerNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
    ...
    public static void glVertexAttribPointerNV(int index, int size, int type2, int stride, ShortBuffer buffer) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribPointerNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
    ...
    public static void glVertexAttribPointerNV(int index, int size, int type2, int stride, long buffer_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexAttribPointerNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOenabled(caps);
        NVVertexProgram.nglVertexAttribPointerNVBO(index, size, type2, stride, buffer_buffer_offset, function_pointer);
    }
