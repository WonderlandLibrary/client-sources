...
public final class ARBVertexAttrib64bit {
    ...
    public static void glVertexArrayVertexAttribLOffsetEXT(int vaobj, int buffer, int index, int size, int type2, int stride, long offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glVertexArrayVertexAttribLOffsetEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        ARBVertexAttrib64bit.nglVertexArrayVertexAttribLOffsetEXT(vaobj, buffer, index, size, type2, stride, offset, function_pointer);
    }
