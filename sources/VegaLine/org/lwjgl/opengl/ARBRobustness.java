...
public final class ARBRobustness {
    ...
    public static void glReadnPixelsARB(int x, int y, int width, int height, int format, int type2, ByteBuffer data) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glReadnPixelsARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(data);
        ARBRobustness.nglReadnPixelsARB(x, y, width, height, format, type2, data.remaining(), MemoryUtil.getAddress(data), function_pointer);
    }

    public static void glReadnPixelsARB(int x, int y, int width, int height, int format, int type2, DoubleBuffer data) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glReadnPixelsARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(data);
        ARBRobustness.nglReadnPixelsARB(x, y, width, height, format, type2, data.remaining() << 3, MemoryUtil.getAddress(data), function_pointer);
    }

    public static void glReadnPixelsARB(int x, int y, int width, int height, int format, int type2, FloatBuffer data) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glReadnPixelsARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(data);
        ARBRobustness.nglReadnPixelsARB(x, y, width, height, format, type2, data.remaining() << 2, MemoryUtil.getAddress(data), function_pointer);
    }

    public static void glReadnPixelsARB(int x, int y, int width, int height, int format, int type2, IntBuffer data) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glReadnPixelsARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
    ...
    public static void glReadnPixelsARB(int x, int y, int width, int height, int format, int type2, ShortBuffer data) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glReadnPixelsARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(data);
        ARBRobustness.nglReadnPixelsARB(x, y, width, height, format, type2, data.remaining() << 1, MemoryUtil.getAddress(data), function_pointer);
    }
    ...
    public static void glGetnHistogramARB(int target, boolean reset, int format, int type2, ByteBuffer values) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetnHistogramARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(values);
        ARBRobustness.nglGetnHistogramARB(target, reset, format, type2, values.remaining(), MemoryUtil.getAddress(values), function_pointer);
    }

    public static void glGetnHistogramARB(int target, boolean reset, int format, int type2, DoubleBuffer values) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetnHistogramARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(values);
        ARBRobustness.nglGetnHistogramARB(target, reset, format, type2, values.remaining() << 3, MemoryUtil.getAddress(values), function_pointer);
    }

    public static void glGetnHistogramARB(int target, boolean reset, int format, int type2, FloatBuffer values) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetnHistogramARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(values);
        ARBRobustness.nglGetnHistogramARB(target, reset, format, type2, values.remaining() << 2, MemoryUtil.getAddress(values), function_pointer);
    }

    public static void glGetnHistogramARB(int target, boolean reset, int format, int type2, IntBuffer values) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetnHistogramARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
    ...
    public static void glGetnHistogramARB(int target, boolean reset, int format, int type2, ShortBuffer values) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetnHistogramARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(values);
        ARBRobustness.nglGetnHistogramARB(target, reset, format, type2, values.remaining() << 1, MemoryUtil.getAddress(values), function_pointer);
    }
    ...
    public static void glGetnMinmaxARB(int target, boolean reset, int format, int type2, ByteBuffer values) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetnMinmaxARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(values);
        ARBRobustness.nglGetnMinmaxARB(target, reset, format, type2, values.remaining(), MemoryUtil.getAddress(values), function_pointer);
    }

    public static void glGetnMinmaxARB(int target, boolean reset, int format, int type2, DoubleBuffer values) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetnMinmaxARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(values);
        ARBRobustness.nglGetnMinmaxARB(target, reset, format, type2, values.remaining() << 3, MemoryUtil.getAddress(values), function_pointer);
    }

    public static void glGetnMinmaxARB(int target, boolean reset, int format, int type2, FloatBuffer values) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetnMinmaxARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(values);
        ARBRobustness.nglGetnMinmaxARB(target, reset, format, type2, values.remaining() << 2, MemoryUtil.getAddress(values), function_pointer);
    }

    public static void glGetnMinmaxARB(int target, boolean reset, int format, int type2, IntBuffer values) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetnMinmaxARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
    ...
    public static void glGetnMinmaxARB(int target, boolean reset, int format, int type2, ShortBuffer values) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetnMinmaxARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkDirect(values);
        ARBRobustness.nglGetnMinmaxARB(target, reset, format, type2, values.remaining() << 1, MemoryUtil.getAddress(values), function_pointer);
    }
