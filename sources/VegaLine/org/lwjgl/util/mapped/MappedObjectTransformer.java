...
public class MappedObjectTransformer {
    ...
    static String jvmClassName(Class<?> type2) {
        return type2.getName().replace('.', '/');
    }
    ...
    private static class FieldInfo {
        ...
        FieldInfo(long offset, long length, long lengthPadded, Type type2, boolean isVolatile, boolean isPointer) {
            this.offset = offset;
            this.length = length;
