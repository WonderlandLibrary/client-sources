...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ByteComparator ? (ByteComparator)this.storedComparator : new ByteComparator(){
            ...
            public int compare(byte k1, byte k2) {
                return Byte2ByteRBTreeMap.this.storedComparator.compare((Byte)k1, (Byte)k2);
            }

            @Override
            public int compare(Byte ok1, Byte ok2) {
                return Byte2ByteRBTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Byte put(Byte ok, Byte ov) {
        byte oldValue = this.put((byte)ok, (byte)ov);
    ...
    public Byte remove(Object ok) {
        byte oldValue = this.remove((Byte)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ByteMap.Entry>(){
                final Comparator<? super Byte2ByteMap.Entry> comparator = new Comparator<Byte2ByteMap.Entry>(){
                    ...
                    @Override
                    public int compare(Byte2ByteMap.Entry x, Byte2ByteMap.Entry y) {
                        return Byte2ByteRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public Byte put(Byte ok, Byte ov) {
            byte oldValue = this.put((byte)ok, (byte)ov);
            return Byte2ByteRBTreeMap.this.modified ? null : Byte.valueOf(oldValue);
        }
        ...
        public Byte remove(Object ok) {
            byte oldValue = this.remove((Byte)ok);
            return Byte2ByteRBTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
        }
