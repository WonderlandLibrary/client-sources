...
Hash {
    ...
    implements FloatIterator {
        ...
        @Deprecated
        public Float next() {
            return Float.valueOf(Byte2FloatOpenCustomHashMap.this.value[this.nextEntry()]);
        }
    }
    ...
    implements Byte2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
                return Byte2FloatOpenCustomHashMap.this.containsNullKey && Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n] == v;
            }
            ...
            if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Byte2FloatOpenCustomHashMap.this.value[pos] == v;
            }
            do {
        ...
        public boolean rem(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
                if (Byte2FloatOpenCustomHashMap.this.containsNullKey && Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n] == v) {
            ...
            if (Byte2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Byte2FloatOpenCustomHashMap.this.value[pos] == v) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2FloatOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Byte2FloatOpenCustomHashMap.this.value[pos] != v);
            Byte2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Byte, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Byte2FloatOpenCustomHashMap.this.strategy.equals(Byte2FloatOpenCustomHashMap.this.key[this.index], (Byte)e.getKey()) && Byte2FloatOpenCustomHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue();
        }
