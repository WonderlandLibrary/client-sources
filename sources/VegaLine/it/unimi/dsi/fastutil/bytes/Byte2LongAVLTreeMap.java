...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ByteComparator ? (ByteComparator)this.storedComparator : new ByteComparator(){
            ...
            public int compare(byte k1, byte k2) {
                return Byte2LongAVLTreeMap.this.storedComparator.compare((Byte)k1, (Byte)k2);
            }

            @Override
            public int compare(Byte ok1, Byte ok2) {
                return Byte2LongAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Long put(Byte ok, Long ov) {
        long oldValue = this.put((byte)ok, (long)ov);
    ...
    public Long remove(Object ok) {
        long oldValue = this.remove((Byte)ok);
            ...
            this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>(){
                final Comparator<? super Byte2LongMap.Entry> comparator = new Comparator<Byte2LongMap.Entry>(){
                    ...
                    public int compare(Byte2LongMap.Entry x, Byte2LongMap.Entry y) {
                        return Byte2LongAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Byte2LongMap.Entry> comparator() {
                        return Byte2LongAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Long put(Byte ok, Long ov) {
            long oldValue = this.put((byte)ok, (long)ov);
            return Byte2LongAVLTreeMap.this.modified ? null : Long.valueOf(oldValue);
        }
        ...
        public Long remove(Object ok) {
            long oldValue = this.remove((Byte)ok);
            return Byte2LongAVLTreeMap.this.modified ? Long.valueOf(oldValue) : null;
        }
