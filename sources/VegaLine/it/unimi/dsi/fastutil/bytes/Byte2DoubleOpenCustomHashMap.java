...
Hash {
    ...
    implements Byte2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
                return Byte2DoubleOpenCustomHashMap.this.containsNullKey && Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n] == v;
            }
            ...
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Byte2DoubleOpenCustomHashMap.this.value[pos] == v;
            }
            do {
        ...
        public boolean rem(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
                if (Byte2DoubleOpenCustomHashMap.this.containsNullKey && Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n] == v) {
            ...
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Byte2DoubleOpenCustomHashMap.this.value[pos] == v) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Byte2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Byte2DoubleOpenCustomHashMap.this.value[pos] != v);
            Byte2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Byte, Double> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Byte2DoubleOpenCustomHashMap.this.strategy.equals(Byte2DoubleOpenCustomHashMap.this.key[this.index], (Byte)e.getKey()) && Byte2DoubleOpenCustomHashMap.this.value[this.index] == (Double)e.getValue();
        }
