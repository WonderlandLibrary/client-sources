...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ByteComparator ? (ByteComparator)this.storedComparator : new ByteComparator(){
            ...
            public int compare(byte k1, byte k2) {
                return Byte2ReferenceAVLTreeMap.this.storedComparator.compare((Byte)k1, (Byte)k2);
            }

            @Override
            public int compare(Byte ok1, Byte ok2) {
                return Byte2ReferenceAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public V put(Byte ok, V ov) {
        V oldValue = this.put((byte)ok, ov);
    ...
    public V remove(Object ok) {
        V oldValue = this.remove((Byte)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>(){
                final Comparator<? super Byte2ReferenceMap.Entry<V>> comparator = new Comparator<Byte2ReferenceMap.Entry<V>>(){
                    ...
                    @Override
                    public int compare(Byte2ReferenceMap.Entry<V> x, Byte2ReferenceMap.Entry<V> y) {
                        return Byte2ReferenceAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>(){
                    ...
                    @Override
                    public Comparator<? super Byte2ReferenceMap.Entry<V>> comparator() {
                        return Byte2ReferenceAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        @Deprecated
        public V put(Byte ok, V ov) {
            Object oldValue = this.put((byte)ok, (V)ov);
            return Byte2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
        }
        ...
        @Deprecated
        public V remove(Object ok) {
            Object oldValue = this.remove((Byte)ok);
            return Byte2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
        }
