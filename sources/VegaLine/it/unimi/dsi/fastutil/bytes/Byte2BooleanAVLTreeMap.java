...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ByteComparator ? (ByteComparator)this.storedComparator : new ByteComparator(){
            ...
            public int compare(byte k1, byte k2) {
                return Byte2BooleanAVLTreeMap.this.storedComparator.compare((Byte)k1, (Byte)k2);
            }
    ...
    public Boolean put(Byte ok, Boolean ov) {
        boolean oldValue = this.put((byte)ok, (boolean)ov);
    ...
    public Boolean remove(Object ok) {
        boolean oldValue = this.remove((Byte)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2BooleanMap.Entry>(){
                final Comparator<? super Byte2BooleanMap.Entry> comparator = new Comparator<Byte2BooleanMap.Entry>(){
                    ...
                    @Override
                    public int compare(Byte2BooleanMap.Entry x, Byte2BooleanMap.Entry y) {
                        return Byte2BooleanAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                    }
                };
