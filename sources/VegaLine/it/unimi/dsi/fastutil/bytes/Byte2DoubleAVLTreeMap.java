...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ByteComparator ? (ByteComparator)this.storedComparator : new ByteComparator(){
            ...
            public int compare(byte k1, byte k2) {
                return Byte2DoubleAVLTreeMap.this.storedComparator.compare((Byte)k1, (Byte)k2);
            }

            @Override
            public int compare(Byte ok1, Byte ok2) {
                return Byte2DoubleAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Double put(Byte ok, Double ov) {
        double oldValue = this.put((byte)ok, (double)ov);
    ...
    public Double remove(Object ok) {
        double oldValue = this.remove((Byte)ok);
            ...
            this.entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>(){
                final Comparator<? super Byte2DoubleMap.Entry> comparator = new Comparator<Byte2DoubleMap.Entry>(){
                    ...
                    public int compare(Byte2DoubleMap.Entry x, Byte2DoubleMap.Entry y) {
                        return Byte2DoubleAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Byte2DoubleMap.Entry> comparator() {
                        return Byte2DoubleAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Double put(Byte ok, Double ov) {
            double oldValue = this.put((byte)ok, (double)ov);
            return Byte2DoubleAVLTreeMap.this.modified ? null : Double.valueOf(oldValue);
        }
        ...
        public Double remove(Object ok) {
            double oldValue = this.remove((Byte)ok);
            return Byte2DoubleAVLTreeMap.this.modified ? Double.valueOf(oldValue) : null;
        }
