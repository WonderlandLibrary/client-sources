...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ByteComparator ? (ByteComparator)this.storedComparator : new ByteComparator(){
            ...
            public int compare(byte k1, byte k2) {
                return Byte2ShortRBTreeMap.this.storedComparator.compare((Byte)k1, (Byte)k2);
            }

            @Override
            public int compare(Byte ok1, Byte ok2) {
                return Byte2ShortRBTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Short put(Byte ok, Short ov) {
        short oldValue = this.put((byte)ok, (short)ov);
    ...
    public Short remove(Object ok) {
        short oldValue = this.remove((Byte)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ShortMap.Entry>(){
                final Comparator<? super Byte2ShortMap.Entry> comparator = new Comparator<Byte2ShortMap.Entry>(){
                    ...
                    @Override
                    public int compare(Byte2ShortMap.Entry x, Byte2ShortMap.Entry y) {
                        return Byte2ShortRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public Short put(Byte ok, Short ov) {
            short oldValue = this.put((byte)ok, (short)ov);
            return Byte2ShortRBTreeMap.this.modified ? null : Short.valueOf(oldValue);
        }
        ...
        public Short remove(Object ok) {
            short oldValue = this.remove((Byte)ok);
            return Byte2ShortRBTreeMap.this.modified ? Short.valueOf(oldValue) : null;
        }
