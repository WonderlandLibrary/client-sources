...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ByteComparator ? (ByteComparator)this.storedComparator : new ByteComparator(){
            ...
            public int compare(byte k1, byte k2) {
                return Byte2CharAVLTreeMap.this.storedComparator.compare((Byte)k1, (Byte)k2);
            }

            @Override
            public int compare(Byte ok1, Byte ok2) {
                return Byte2CharAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Character put(Byte ok, Character ov) {
        char oldValue = this.put((byte)ok, ov.charValue());
    ...
    public Character remove(Object ok) {
        char oldValue = this.remove((Byte)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2CharMap.Entry>(){
                final Comparator<? super Byte2CharMap.Entry> comparator = new Comparator<Byte2CharMap.Entry>(){
                    ...
                    @Override
                    public int compare(Byte2CharMap.Entry x, Byte2CharMap.Entry y) {
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2CharMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Byte2CharMap.Entry> comparator() {
                        return Byte2CharAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Character put(Byte ok, Character ov) {
            char oldValue = this.put((byte)ok, ov.charValue());
            return Byte2CharAVLTreeMap.this.modified ? null : Character.valueOf(oldValue);
        }
        ...
        public Character remove(Object ok) {
            char oldValue = this.remove((Byte)ok);
            return Byte2CharAVLTreeMap.this.modified ? Character.valueOf(oldValue) : null;
        }
