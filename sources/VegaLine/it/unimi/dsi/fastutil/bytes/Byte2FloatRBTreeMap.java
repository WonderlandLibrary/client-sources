...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ByteComparator ? (ByteComparator)this.storedComparator : new ByteComparator(){
            ...
            public int compare(byte k1, byte k2) {
                return Byte2FloatRBTreeMap.this.storedComparator.compare((Byte)k1, (Byte)k2);
            }
    ...
    public Float put(Byte ok, Float ov) {
        float oldValue = this.put((byte)ok, ov.floatValue());
    ...
    public Float remove(Object ok) {
        float oldValue = this.remove((Byte)ok);
            ...
            this.entries = new AbstractObjectSortedSet<Byte2FloatMap.Entry>(){
                final Comparator<? super Byte2FloatMap.Entry> comparator = new Comparator<Byte2FloatMap.Entry>(){
                    ...
                    public int compare(Byte2FloatMap.Entry x, Byte2FloatMap.Entry y) {
                        return Byte2FloatRBTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                    }
                };
