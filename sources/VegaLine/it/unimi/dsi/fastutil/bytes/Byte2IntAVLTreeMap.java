...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ByteComparator ? (ByteComparator)this.storedComparator : new ByteComparator(){
            ...
            public int compare(byte k1, byte k2) {
                return Byte2IntAVLTreeMap.this.storedComparator.compare((Byte)k1, (Byte)k2);
            }

            @Override
            public int compare(Byte ok1, Byte ok2) {
                return Byte2IntAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Integer put(Byte ok, Integer ov) {
        int oldValue = this.put((byte)ok, (int)ov);
    ...
    public Integer remove(Object ok) {
        int oldValue = this.remove((Byte)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>(){
                final Comparator<? super Byte2IntMap.Entry> comparator = new Comparator<Byte2IntMap.Entry>(){
                    ...
                    @Override
                    public int compare(Byte2IntMap.Entry x, Byte2IntMap.Entry y) {
                        return Byte2IntAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Byte2IntMap.Entry> comparator() {
                        return Byte2IntAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Integer put(Byte ok, Integer ov) {
            int oldValue = this.put((byte)ok, (int)ov);
            return Byte2IntAVLTreeMap.this.modified ? null : Integer.valueOf(oldValue);
        }
        ...
        public Integer remove(Object ok) {
            int oldValue = this.remove((Byte)ok);
            return Byte2IntAVLTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
        }
