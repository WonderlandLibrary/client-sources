    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof IntComparator ? (IntComparator)this.storedComparator : new IntComparator(){
            ...
            public int compare(int k1, int k2) {
                return Int2FloatRBTreeMap.this.storedComparator.compare((Integer)k1, (Integer)k2);
            }
            ...
            this.entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>(){
                final Comparator<? super Int2FloatMap.Entry> comparator = new Comparator<Int2FloatMap.Entry>(){
                    ...
                    public int compare(Int2FloatMap.Entry x, Int2FloatMap.Entry y) {
                        return Int2FloatRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                    }
                };
