...
Hash {
    ...
    implements Int2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Int2DoubleOpenHashMap.this.containsNullKey && Int2DoubleOpenHashMap.this.value[Int2DoubleOpenHashMap.this.n] == v;
            }
            ...
            if (k == curr) {
                return Int2DoubleOpenHashMap.this.value[pos] == v;
            }
            do {
        ...
        public boolean rem(Object o) {
            ...
            double v = (Double)e.getValue();
            if (k == 0) {
                if (Int2DoubleOpenHashMap.this.containsNullKey && Int2DoubleOpenHashMap.this.value[Int2DoubleOpenHashMap.this.n] == v) {
            ...
            if (curr == k) {
                if (Int2DoubleOpenHashMap.this.value[pos] == v) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2DoubleOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Int2DoubleOpenHashMap.this.value[pos] != v);
            Int2DoubleOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Integer, Double> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2DoubleOpenHashMap.this.key[this.index] == (Integer)e.getKey() && Int2DoubleOpenHashMap.this.value[this.index] == (Double)e.getValue();
        }
