...
Hash {
    ...
    implements FloatIterator {
        ...
        @Deprecated
        public Float next() {
            return Float.valueOf(Int2FloatOpenCustomHashMap.this.value[this.nextEntry()]);
        }
    }
    ...
    implements Int2FloatMap.FastEntrySet {
        ...
        public boolean rem(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2FloatOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Int2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Int2FloatOpenCustomHashMap.this.value[pos] != v);
            Int2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Integer, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2FloatOpenCustomHashMap.this.strategy.equals(Int2FloatOpenCustomHashMap.this.key[this.index], (Integer)e.getKey()) && Int2FloatOpenCustomHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue();
        }
