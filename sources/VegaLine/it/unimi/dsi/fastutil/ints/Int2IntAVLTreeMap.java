...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof IntComparator ? (IntComparator)this.storedComparator : new IntComparator(){
            ...
            public int compare(int k1, int k2) {
                return Int2IntAVLTreeMap.this.storedComparator.compare((Integer)k1, (Integer)k2);
            }

            @Override
            public int compare(Integer ok1, Integer ok2) {
                return Int2IntAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Integer put(Integer ok, Integer ov) {
        int oldValue = this.put((int)ok, (int)ov);
    ...
    public Integer remove(Object ok) {
        int oldValue = this.remove((Integer)ok);
            ...
            this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>(){
                final Comparator<? super Int2IntMap.Entry> comparator = new Comparator<Int2IntMap.Entry>(){
                    ...
                    public int compare(Int2IntMap.Entry x, Int2IntMap.Entry y) {
                        return Int2IntAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Int2IntMap.Entry> comparator() {
                        return Int2IntAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Integer put(Integer ok, Integer ov) {
            int oldValue = this.put((int)ok, (int)ov);
            return Int2IntAVLTreeMap.this.modified ? null : Integer.valueOf(oldValue);
        }
        ...
        public Integer remove(Object ok) {
            int oldValue = this.remove((Integer)ok);
            return Int2IntAVLTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
        }
