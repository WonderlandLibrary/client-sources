...
IntSortedSet {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof IntComparator ? (IntComparator)this.storedComparator : new IntComparator(){
            ...
            public int compare(int k1, int k2) {
                return IntAVLTreeSet.this.storedComparator.compare((Integer)k1, (Integer)k2);
            }

            @Override
            public int compare(Integer ok1, Integer ok2) {
                return IntAVLTreeSet.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    IntSortedSet {
        ...
        public boolean rem(int k) {
            ...
            return IntAVLTreeSet.this.rem(k);
        }
    ...
    extends AbstractIntListIterator {
        ...
        public void remove() {
            ...
            this.updatePrevious();
            this.updateNext();
            IntAVLTreeSet.this.rem(this.curr.key);
            this.curr = null;
        }
    }
