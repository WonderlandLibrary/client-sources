...
Hash {
    ...
    private int insert(int k, double v) {
        int pos;
    ...
    implements Int2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Int2DoubleOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Int2DoubleOpenCustomHashMap.this.containsNullKey && Int2DoubleOpenCustomHashMap.this.value[Int2DoubleOpenCustomHashMap.this.n] == v;
            }
            ...
            if (Int2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Int2DoubleOpenCustomHashMap.this.value[pos] == v;
            }
            do {
        ...
        public boolean rem(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Int2DoubleOpenCustomHashMap.this.strategy.equals(k, 0)) {
                if (Int2DoubleOpenCustomHashMap.this.containsNullKey && Int2DoubleOpenCustomHashMap.this.value[Int2DoubleOpenCustomHashMap.this.n] == v) {
            ...
            if (Int2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Int2DoubleOpenCustomHashMap.this.value[pos] == v) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2DoubleOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Int2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Int2DoubleOpenCustomHashMap.this.value[pos] != v);
            Int2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Integer, Double> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Int2DoubleOpenCustomHashMap.this.strategy.equals(Int2DoubleOpenCustomHashMap.this.key[this.index], (Integer)e.getKey()) && Int2DoubleOpenCustomHashMap.this.value[this.index] == (Double)e.getValue();
        }
