...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof IntComparator ? (IntComparator)this.storedComparator : new IntComparator(){
            ...
            public int compare(int k1, int k2) {
                return Int2LongAVLTreeMap.this.storedComparator.compare((Integer)k1, (Integer)k2);
            }

            @Override
            public int compare(Integer ok1, Integer ok2) {
                return Int2LongAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Long put(Integer ok, Long ov) {
        long oldValue = this.put((int)ok, (long)ov);
    ...
    public Long remove(Object ok) {
        long oldValue = this.remove((Integer)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2LongMap.Entry>(){
                final Comparator<? super Int2LongMap.Entry> comparator = new Comparator<Int2LongMap.Entry>(){
                    ...
                    @Override
                    public int compare(Int2LongMap.Entry x, Int2LongMap.Entry y) {
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2LongMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Int2LongMap.Entry> comparator() {
                        return Int2LongAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Long put(Integer ok, Long ov) {
            long oldValue = this.put((int)ok, (long)ov);
            return Int2LongAVLTreeMap.this.modified ? null : Long.valueOf(oldValue);
        }
        ...
        public Long remove(Object ok) {
            long oldValue = this.remove((Integer)ok);
            return Int2LongAVLTreeMap.this.modified ? Long.valueOf(oldValue) : null;
        }
