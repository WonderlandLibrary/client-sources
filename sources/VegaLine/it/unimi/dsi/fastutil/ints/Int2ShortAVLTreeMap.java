...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof IntComparator ? (IntComparator)this.storedComparator : new IntComparator(){
            ...
            public int compare(int k1, int k2) {
                return Int2ShortAVLTreeMap.this.storedComparator.compare((Integer)k1, (Integer)k2);
            }
    ...
    public Short put(Integer ok, Short ov) {
        short oldValue = this.put((int)ok, (short)ov);
    ...
    public Short remove(Object ok) {
        short oldValue = this.remove((Integer)ok);
