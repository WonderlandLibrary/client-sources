...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof IntComparator ? (IntComparator)this.storedComparator : new IntComparator(){
            ...
            public int compare(int k1, int k2) {
                return Int2ReferenceAVLTreeMap.this.storedComparator.compare((Integer)k1, (Integer)k2);
            }

            @Override
            public int compare(Integer ok1, Integer ok2) {
                return Int2ReferenceAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public V remove(Object ok) {
        V oldValue = this.remove((Integer)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>(){
                final Comparator<? super Int2ReferenceMap.Entry<V>> comparator = new Comparator<Int2ReferenceMap.Entry<V>>(){
                    ...
                    @Override
                    public int compare(Int2ReferenceMap.Entry<V> x, Int2ReferenceMap.Entry<V> y) {
                        return Int2ReferenceAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>(){
                    ...
                    @Override
                    public Comparator<? super Int2ReferenceMap.Entry<V>> comparator() {
                        return Int2ReferenceAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        @Deprecated
        public V put(Integer ok, V ov) {
            Object oldValue = this.put((int)ok, (V)ov);
            return Int2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
        }
        ...
        @Deprecated
        public V remove(Object ok) {
            Object oldValue = this.remove((Integer)ok);
            return Int2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
        }
