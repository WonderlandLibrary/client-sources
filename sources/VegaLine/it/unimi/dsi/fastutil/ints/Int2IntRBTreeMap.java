...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof IntComparator ? (IntComparator)this.storedComparator : new IntComparator(){
            ...
            public int compare(int k1, int k2) {
                return Int2IntRBTreeMap.this.storedComparator.compare((Integer)k1, (Integer)k2);
            }

            @Override
            public int compare(Integer ok1, Integer ok2) {
                return Int2IntRBTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    implements Serializable {
        ...
        public Integer put(Integer ok, Integer ov) {
            int oldValue = this.put((int)ok, (int)ov);
            return Int2IntRBTreeMap.this.modified ? null : Integer.valueOf(oldValue);
        }
        ...
        public Integer remove(Object ok) {
            int oldValue = this.remove((Integer)ok);
            return Int2IntRBTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
        }
