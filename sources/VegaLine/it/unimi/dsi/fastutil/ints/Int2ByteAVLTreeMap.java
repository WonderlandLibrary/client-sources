...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof IntComparator ? (IntComparator)this.storedComparator : new IntComparator(){
            ...
            public int compare(int k1, int k2) {
                return Int2ByteAVLTreeMap.this.storedComparator.compare((Integer)k1, (Integer)k2);
            }

            @Override
            public int compare(Integer ok1, Integer ok2) {
                return Int2ByteAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Byte put(Integer ok, Byte ov) {
        byte oldValue = this.put((int)ok, (byte)ov);
    ...
    public Byte remove(Object ok) {
        byte oldValue = this.remove((Integer)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>(){
                final Comparator<? super Int2ByteMap.Entry> comparator = new Comparator<Int2ByteMap.Entry>(){
                    ...
                    @Override
                    public int compare(Int2ByteMap.Entry x, Int2ByteMap.Entry y) {
                        return Int2ByteAVLTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Int2ByteMap.Entry> comparator() {
                        return Int2ByteAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Byte put(Integer ok, Byte ov) {
            byte oldValue = this.put((int)ok, (byte)ov);
            return Int2ByteAVLTreeMap.this.modified ? null : Byte.valueOf(oldValue);
        }
        ...
        public Byte remove(Object ok) {
            byte oldValue = this.remove((Integer)ok);
            return Int2ByteAVLTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
        }
