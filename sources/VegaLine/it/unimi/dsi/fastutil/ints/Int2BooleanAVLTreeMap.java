...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof IntComparator ? (IntComparator)this.storedComparator : new IntComparator(){
            ...
            public int compare(int k1, int k2) {
                return Int2BooleanAVLTreeMap.this.storedComparator.compare((Integer)k1, (Integer)k2);
            }
    ...
    public Boolean put(Integer ok, Boolean ov) {
        boolean oldValue = this.put((int)ok, (boolean)ov);
    ...
    public Boolean remove(Object ok) {
        boolean oldValue = this.remove((Integer)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>(){
                final Comparator<? super Int2BooleanMap.Entry> comparator = new Comparator<Int2BooleanMap.Entry>(){
                    ...
                    @Override
                    public int compare(Int2BooleanMap.Entry x, Int2BooleanMap.Entry y) {
