...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof IntComparator ? (IntComparator)this.storedComparator : new IntComparator(){
            ...
            public int compare(int k1, int k2) {
                return Int2DoubleAVLTreeMap.this.storedComparator.compare((Integer)k1, (Integer)k2);
            }

            @Override
            public int compare(Integer ok1, Integer ok2) {
                return Int2DoubleAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Double put(Integer ok, Double ov) {
        double oldValue = this.put((int)ok, (double)ov);
    ...
    public Double remove(Object ok) {
        double oldValue = this.remove((Integer)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>(){
                final Comparator<? super Int2DoubleMap.Entry> comparator = new Comparator<Int2DoubleMap.Entry>(){
                    ...
                    @Override
                    public int compare(Int2DoubleMap.Entry x, Int2DoubleMap.Entry y) {
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Int2DoubleMap.Entry> comparator() {
                        return Int2DoubleAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Double put(Integer ok, Double ov) {
            double oldValue = this.put((int)ok, (double)ov);
            return Int2DoubleAVLTreeMap.this.modified ? null : Double.valueOf(oldValue);
        }
        ...
        public Double remove(Object ok) {
            double oldValue = this.remove((Integer)ok);
            return Int2DoubleAVLTreeMap.this.modified ? Double.valueOf(oldValue) : null;
        }
