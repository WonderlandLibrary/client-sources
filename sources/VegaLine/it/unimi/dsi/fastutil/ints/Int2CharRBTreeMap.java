...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof IntComparator ? (IntComparator)this.storedComparator : new IntComparator(){
            ...
            public int compare(int k1, int k2) {
                return Int2CharRBTreeMap.this.storedComparator.compare((Integer)k1, (Integer)k2);
            }

            @Override
            public int compare(Integer ok1, Integer ok2) {
                return Int2CharRBTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Character put(Integer ok, Character ov) {
        char oldValue = this.put((int)ok, ov.charValue());
    ...
    public Character remove(Object ok) {
        char oldValue = this.remove((Integer)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2CharMap.Entry>(){
                final Comparator<? super Int2CharMap.Entry> comparator = new Comparator<Int2CharMap.Entry>(){
                    ...
                    @Override
                    public int compare(Int2CharMap.Entry x, Int2CharMap.Entry y) {
                        return Int2CharRBTreeMap.this.actualComparator.compare(x.getIntKey(), y.getIntKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public Character put(Integer ok, Character ov) {
            char oldValue = this.put((int)ok, ov.charValue());
            return Int2CharRBTreeMap.this.modified ? null : Character.valueOf(oldValue);
        }
        ...
        public Character remove(Object ok) {
            char oldValue = this.remove((Integer)ok);
            return Int2CharRBTreeMap.this.modified ? Character.valueOf(oldValue) : null;
        }
