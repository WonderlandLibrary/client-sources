...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof IntComparator ? (IntComparator)this.storedComparator : new IntComparator(){
            ...
            public int compare(int k1, int k2) {
                return Int2FloatAVLTreeMap.this.storedComparator.compare((Integer)k1, (Integer)k2);
            }
    ...
    public Float put(Integer ok, Float ov) {
        float oldValue = this.put((int)ok, ov.floatValue());
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>(){
                final Comparator<? super Int2FloatMap.Entry> comparator = new Comparator<Int2FloatMap.Entry>(){
                    ...
                    @Override
                    public int compare(Int2FloatMap.Entry x, Int2FloatMap.Entry y) {
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Int2FloatMap.Entry> comparator() {
                        return Int2FloatAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Float put(Integer ok, Float ov) {
            float oldValue = this.put((int)ok, ov.floatValue());
            return Int2FloatAVLTreeMap.this.modified ? null : Float.valueOf(oldValue);
        }
        ...
        public Float remove(Object ok) {
            float oldValue = this.remove((Integer)ok);
            return Int2FloatAVLTreeMap.this.modified ? Float.valueOf(oldValue) : null;
        }
