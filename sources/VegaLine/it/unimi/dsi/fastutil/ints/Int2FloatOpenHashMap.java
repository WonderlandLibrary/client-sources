...
Hash {
    ...
    implements FloatIterator {
        ...
        @Deprecated
        public Float next() {
            return Float.valueOf(Int2FloatOpenHashMap.this.value[this.nextEntry()]);
        }
    }
    ...
    implements Int2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Int2FloatOpenHashMap.this.containsNullKey && Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n] == v;
            }
            ...
            if (k == curr) {
                return Int2FloatOpenHashMap.this.value[pos] == v;
            }
            do {
        ...
        public boolean rem(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (k == 0) {
                if (Int2FloatOpenHashMap.this.containsNullKey && Int2FloatOpenHashMap.this.value[Int2FloatOpenHashMap.this.n] == v) {
            ...
            if (curr == k) {
                if (Int2FloatOpenHashMap.this.value[pos] == v) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Int2FloatOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (curr != k || Int2FloatOpenHashMap.this.value[pos] != v);
            Int2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
