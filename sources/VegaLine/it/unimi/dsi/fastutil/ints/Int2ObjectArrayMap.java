    ...
    implements Int2ObjectMap.FastEntrySet<V> {
        ...
        public ObjectIterator<Int2ObjectMap.Entry<V>> fastIterator() {
            return new AbstractObjectIterator<Int2ObjectMap.Entry<V>>(){
                int next = 0;
                int curr = -1;
                final AbstractInt2ObjectMap.BasicEntry<V> entry = new AbstractInt2ObjectMap.BasicEntry<Object>(0, null);
        ...
        public boolean remove(Object o) {
            ...
            if (oldPos == -1 || !(v != null ? v.equals(Int2ObjectArrayMap.this.value[oldPos]) : Int2ObjectArrayMap.this.value[oldPos] == null)) {
                return false;
            }
