...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof CharComparator ? (CharComparator)this.storedComparator : new CharComparator(){
            ...
            public int compare(char k1, char k2) {
                return Char2BooleanAVLTreeMap.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
            }

            @Override
            public int compare(Character ok1, Character ok2) {
                return Char2BooleanAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Boolean put(Character ok, Boolean ov) {
        boolean oldValue = this.put(ok.charValue(), (boolean)ov);
    ...
    public Boolean remove(Object ok) {
        boolean oldValue = this.remove(((Character)ok).charValue());
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2BooleanMap.Entry>(){
                final Comparator<? super Char2BooleanMap.Entry> comparator = new Comparator<Char2BooleanMap.Entry>(){
                    ...
                    @Override
                    public int compare(Char2BooleanMap.Entry x, Char2BooleanMap.Entry y) {
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2BooleanMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Char2BooleanMap.Entry> comparator() {
                        return Char2BooleanAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Boolean put(Character ok, Boolean ov) {
            boolean oldValue = this.put(ok.charValue(), (boolean)ov);
            return Char2BooleanAVLTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
        }
        ...
        public Boolean remove(Object ok) {
            boolean oldValue = this.remove(((Character)ok).charValue());
            return Char2BooleanAVLTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
        }
