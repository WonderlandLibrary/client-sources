...
Hash {
    ...
    implements CharIterator {
        ...
        public Character next() {
            return Character.valueOf(Char2CharOpenCustomHashMap.this.value[this.nextEntry()]);
        }
    }
    ...
    implements CharIterator {
        ...
        @Override
        public Character next() {
            return Character.valueOf(Char2CharOpenCustomHashMap.this.key[this.nextEntry()]);
        }
    }
