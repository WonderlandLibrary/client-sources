...
Hash {
    ...
    implements CharIterator {
        ...
        public Character next() {
            return Character.valueOf(Char2ObjectOpenHashMap.this.key[this.nextEntry()]);
        }
    }
    ...
    implements Char2ObjectMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            Object v = e.getValue();
            if (k == '\u0000') {
                return Char2ObjectOpenHashMap.this.containsNullKey && (Char2ObjectOpenHashMap.this.value[Char2ObjectOpenHashMap.this.n] == null ? v == null : Char2ObjectOpenHashMap.this.value[Char2ObjectOpenHashMap.this.n].equals(v));
            }
        ...
        public boolean rem(Object o) {
            ...
            Object v = e.getValue();
            if (k == '\u0000') {
                if (Char2ObjectOpenHashMap.this.containsNullKey && (Char2ObjectOpenHashMap.this.value[Char2ObjectOpenHashMap.this.n] == null ? v == null : Char2ObjectOpenHashMap.this.value[Char2ObjectOpenHashMap.this.n].equals(v))) {
            ...
            if (curr == k) {
                if (Char2ObjectOpenHashMap.this.value[pos] == null ? v == null : Char2ObjectOpenHashMap.this.value[pos].equals(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2ObjectOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k || !(Char2ObjectOpenHashMap.this.value[pos] == null ? v == null : Char2ObjectOpenHashMap.this.value[pos].equals(v)));
            Char2ObjectOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Character, V> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2ObjectOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && (Char2ObjectOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Char2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()));
        }
