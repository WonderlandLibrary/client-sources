...
Hash {
    ...
    public boolean containsValue(Object v) {
        ...
        int i = this.n;
        while (i-- != 0) {
            if (key[i] == '\u0000' || !(value[i] == null ? v == null : value[i].equals(v))) continue;
            return true;
        }
        return false;
    }
    ...
    implements CharIterator {
        ...
        public Character next() {
            return Character.valueOf(Char2ObjectOpenCustomHashMap.this.key[this.nextEntry()]);
        }
    }
    ...
    implements Char2ObjectMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            if (Char2ObjectOpenCustomHashMap.this.strategy.equals(k, '\u0000')) {
                return Char2ObjectOpenCustomHashMap.this.containsNullKey && (Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n] == null ? v == null : Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n].equals(v));
            }
            ...
            if (Char2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Char2ObjectOpenCustomHashMap.this.value[pos] == null ? v == null : Char2ObjectOpenCustomHashMap.this.value[pos].equals(v);
            }
            do {
        ...
        public boolean rem(Object o) {
            ...
            Object v = e.getValue();
            if (Char2ObjectOpenCustomHashMap.this.strategy.equals(k, '\u0000')) {
                if (Char2ObjectOpenCustomHashMap.this.containsNullKey && (Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n] == null ? v == null : Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n].equals(v))) {
            ...
            if (Char2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Char2ObjectOpenCustomHashMap.this.value[pos] == null ? v == null : Char2ObjectOpenCustomHashMap.this.value[pos].equals(v)) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2ObjectOpenCustomHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (!Char2ObjectOpenCustomHashMap.this.strategy.equals(curr, k) || !(Char2ObjectOpenCustomHashMap.this.value[pos] == null ? v == null : Char2ObjectOpenCustomHashMap.this.value[pos].equals(v)));
            Char2ObjectOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Character, V> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2ObjectOpenCustomHashMap.this.strategy.equals(Char2ObjectOpenCustomHashMap.this.key[this.index], ((Character)e.getKey()).charValue()) && (Char2ObjectOpenCustomHashMap.this.value[this.index] == null ? e.getValue() == null : Char2ObjectOpenCustomHashMap.this.value[this.index].equals(e.getValue()));
        }
