...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof CharComparator ? (CharComparator)this.storedComparator : new CharComparator(){
            ...
            public int compare(char k1, char k2) {
                return Char2ReferenceAVLTreeMap.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
            }
    ...
    public V put(Character ok, V ov) {
        V oldValue = this.put(ok.charValue(), ov);
    ...
    public V remove(Object ok) {
        V oldValue = this.remove(((Character)ok).charValue());
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ReferenceMap.Entry<V>>(){
                final Comparator<? super Char2ReferenceMap.Entry<V>> comparator = new Comparator<Char2ReferenceMap.Entry<V>>(){
                    ...
                    @Override
                    public int compare(Char2ReferenceMap.Entry<V> x, Char2ReferenceMap.Entry<V> y) {
    ...
    implements Serializable {
        ...
        @Deprecated
        public V put(Character ok, V ov) {
            Object oldValue = this.put(ok.charValue(), (V)ov);
            return Char2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
        }
        ...
        @Deprecated
        public V remove(Object ok) {
            Object oldValue = this.remove(((Character)ok).charValue());
            return Char2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
        }
