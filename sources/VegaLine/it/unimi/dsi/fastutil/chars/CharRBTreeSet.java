...
CharSortedSet {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof CharComparator ? (CharComparator)this.storedComparator : new CharComparator(){
            ...
            public int compare(char k1, char k2) {
                return CharRBTreeSet.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
            }
    ...
    CharSortedSet {
        ...
        public boolean rem(char k) {
            ...
            return CharRBTreeSet.this.rem(k);
        }
    ...
    extends AbstractCharListIterator {
        ...
        public void remove() {
            ...
            this.updatePrevious();
            this.updateNext();
            CharRBTreeSet.this.rem(this.curr.key);
            this.curr = null;
        }
    }
