...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof CharComparator ? (CharComparator)this.storedComparator : new CharComparator(){
            ...
            public int compare(char k1, char k2) {
                return Char2LongAVLTreeMap.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
            }
    ...
    public Long put(Character ok, Long ov) {
        long oldValue = this.put(ok.charValue(), (long)ov);
    ...
    public Long remove(Object ok) {
        long oldValue = this.remove(((Character)ok).charValue());
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2LongMap.Entry>(){
                final Comparator<? super Char2LongMap.Entry> comparator = new Comparator<Char2LongMap.Entry>(){
                    ...
                    @Override
                    public int compare(Char2LongMap.Entry x, Char2LongMap.Entry y) {
