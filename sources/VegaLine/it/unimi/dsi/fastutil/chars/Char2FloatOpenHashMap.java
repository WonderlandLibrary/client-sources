...
Hash {
    ...
    implements FloatIterator {
        ...
        @Deprecated
        public Float next() {
            return Float.valueOf(Char2FloatOpenHashMap.this.value[this.nextEntry()]);
        }
    }
    ...
    implements CharIterator {
        ...
        public Character next() {
            return Character.valueOf(Char2FloatOpenHashMap.this.key[this.nextEntry()]);
        }
    }
    ...
    implements Char2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == '\u0000') {
                return Char2FloatOpenHashMap.this.containsNullKey && Char2FloatOpenHashMap.this.value[Char2FloatOpenHashMap.this.n] == v;
            }
            ...
            if (k == curr) {
                return Char2FloatOpenHashMap.this.value[pos] == v;
            }
            do {
        ...
        public boolean rem(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (k == '\u0000') {
                if (Char2FloatOpenHashMap.this.containsNullKey && Char2FloatOpenHashMap.this.value[Char2FloatOpenHashMap.this.n] == v) {
            ...
            if (curr == k) {
                if (Char2FloatOpenHashMap.this.value[pos] == v) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2FloatOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k || Char2FloatOpenHashMap.this.value[pos] != v);
            Char2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Character, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2FloatOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2FloatOpenHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue();
        }
