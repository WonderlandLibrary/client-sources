    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof CharComparator ? (CharComparator)this.storedComparator : new CharComparator(){
            ...
            public int compare(char k1, char k2) {
                return Char2IntRBTreeMap.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
            }
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2IntMap.Entry>(){
                final Comparator<? super Char2IntMap.Entry> comparator = new Comparator<Char2IntMap.Entry>(){
                    ...
                    @Override
                    public int compare(Char2IntMap.Entry x, Char2IntMap.Entry y) {
