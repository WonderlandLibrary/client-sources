...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof CharComparator ? (CharComparator)this.storedComparator : new CharComparator(){
            ...
            public int compare(char k1, char k2) {
                return Char2ByteAVLTreeMap.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
            }
    ...
    public Byte put(Character ok, Byte ov) {
        byte oldValue = this.put(ok.charValue(), (byte)ov);
    ...
    public Byte remove(Object ok) {
        byte oldValue = this.remove(((Character)ok).charValue());
            ...
            this.entries = new AbstractObjectSortedSet<Char2ByteMap.Entry>(){
                final Comparator<? super Char2ByteMap.Entry> comparator = new Comparator<Char2ByteMap.Entry>(){
                    ...
                    public int compare(Char2ByteMap.Entry x, Char2ByteMap.Entry y) {
                        return Char2ByteAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
                    }
                };
