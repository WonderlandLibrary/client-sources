...
Hash {
    ...
    implements CharIterator {
        ...
        public Character next() {
            return Character.valueOf(Char2DoubleOpenHashMap.this.key[this.nextEntry()]);
        }
    }
    ...
    implements Char2DoubleMap.FastEntrySet {
        ...
        public boolean rem(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Char2DoubleOpenHashMap.this.mask]) != '\u0000') continue;
                return false;
            } while (curr != k || Char2DoubleOpenHashMap.this.value[pos] != v);
            Char2DoubleOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Character, Double> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Char2DoubleOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue() && Char2DoubleOpenHashMap.this.value[this.index] == (Double)e.getValue();
        }
