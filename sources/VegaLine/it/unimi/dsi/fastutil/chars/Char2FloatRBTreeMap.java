...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof CharComparator ? (CharComparator)this.storedComparator : new CharComparator(){
            ...
            public int compare(char k1, char k2) {
                return Char2FloatRBTreeMap.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
            }

            @Override
            public int compare(Character ok1, Character ok2) {
                return Char2FloatRBTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Float put(Character ok, Float ov) {
        float oldValue = this.put(ok.charValue(), ov.floatValue());
    ...
    public Float remove(Object ok) {
        float oldValue = this.remove(((Character)ok).charValue());
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>(){
                final Comparator<? super Char2FloatMap.Entry> comparator = new Comparator<Char2FloatMap.Entry>(){
                    ...
                    @Override
                    public int compare(Char2FloatMap.Entry x, Char2FloatMap.Entry y) {
    ...
    implements Serializable {
        ...
        public Float put(Character ok, Float ov) {
            float oldValue = this.put(ok.charValue(), ov.floatValue());
            return Char2FloatRBTreeMap.this.modified ? null : Float.valueOf(oldValue);
        }
        ...
        public Float remove(Object ok) {
            float oldValue = this.remove(((Character)ok).charValue());
            return Char2FloatRBTreeMap.this.modified ? Float.valueOf(oldValue) : null;
        }
