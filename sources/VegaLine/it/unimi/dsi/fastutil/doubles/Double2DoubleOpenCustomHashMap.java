...
Hash {
    ...
    implements Double2DoubleMap.FastEntrySet {
        ...
        public boolean rem(Object o) {
            ...
            do {
                if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2DoubleOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
            } while (!Double2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Double2DoubleOpenCustomHashMap.this.value[pos] != v);
            Double2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Double, Double> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double2DoubleOpenCustomHashMap.this.strategy.equals(Double2DoubleOpenCustomHashMap.this.key[this.index], (Double)e.getKey()) && Double2DoubleOpenCustomHashMap.this.value[this.index] == (Double)e.getValue();
        }
