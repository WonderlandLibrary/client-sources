...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof DoubleComparator ? (DoubleComparator)this.storedComparator : new DoubleComparator(){
            ...
            public int compare(double k1, double k2) {
                return Double2IntAVLTreeMap.this.storedComparator.compare((Double)k1, (Double)k2);
            }

            @Override
            public int compare(Double ok1, Double ok2) {
                return Double2IntAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2IntMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Double2IntMap.Entry> comparator() {
                        return Double2IntAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Integer put(Double ok, Integer ov) {
            int oldValue = this.put((double)ok, (int)ov);
            return Double2IntAVLTreeMap.this.modified ? null : Integer.valueOf(oldValue);
        }
        ...
        public Integer remove(Object ok) {
            int oldValue = this.remove((Double)ok);
            return Double2IntAVLTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
        }
