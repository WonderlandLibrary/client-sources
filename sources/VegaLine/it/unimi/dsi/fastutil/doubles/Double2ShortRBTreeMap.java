...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof DoubleComparator ? (DoubleComparator)this.storedComparator : new DoubleComparator(){
            ...
            public int compare(double k1, double k2) {
                return Double2ShortRBTreeMap.this.storedComparator.compare((Double)k1, (Double)k2);
            }

            @Override
            public int compare(Double ok1, Double ok2) {
                return Double2ShortRBTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Short put(Double ok, Short ov) {
        short oldValue = this.put((double)ok, (short)ov);
    ...
    public Short remove(Object ok) {
        short oldValue = this.remove((Double)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>(){
                final Comparator<? super Double2ShortMap.Entry> comparator = new Comparator<Double2ShortMap.Entry>(){
                    ...
                    @Override
                    public int compare(Double2ShortMap.Entry x, Double2ShortMap.Entry y) {
    ...
    implements Serializable {
        ...
        public Short put(Double ok, Short ov) {
            short oldValue = this.put((double)ok, (short)ov);
            return Double2ShortRBTreeMap.this.modified ? null : Short.valueOf(oldValue);
        }
        ...
        public Short remove(Object ok) {
            short oldValue = this.remove((Double)ok);
            return Double2ShortRBTreeMap.this.modified ? Short.valueOf(oldValue) : null;
        }
