...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof DoubleComparator ? (DoubleComparator)this.storedComparator : new DoubleComparator(){
            ...
            public int compare(double k1, double k2) {
                return Double2IntRBTreeMap.this.storedComparator.compare((Double)k1, (Double)k2);
            }

            @Override
            public int compare(Double ok1, Double ok2) {
                return Double2IntRBTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Integer put(Double ok, Integer ov) {
        int oldValue = this.put((double)ok, (int)ov);
    ...
    public Integer remove(Object ok) {
        int oldValue = this.remove((Double)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2IntMap.Entry>(){
                final Comparator<? super Double2IntMap.Entry> comparator = new Comparator<Double2IntMap.Entry>(){
                    ...
                    @Override
                    public int compare(Double2IntMap.Entry x, Double2IntMap.Entry y) {
                        return Double2IntRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public Integer put(Double ok, Integer ov) {
            int oldValue = this.put((double)ok, (int)ov);
            return Double2IntRBTreeMap.this.modified ? null : Integer.valueOf(oldValue);
        }
        ...
        public Integer remove(Object ok) {
            int oldValue = this.remove((Double)ok);
            return Double2IntRBTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
        }
