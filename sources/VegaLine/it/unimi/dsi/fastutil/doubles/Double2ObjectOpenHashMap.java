...
Hash {
    ...
    implements Double2ObjectMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            Object v = e.getValue();
            if (Double.doubleToLongBits(k) == 0L) {
                return Double2ObjectOpenHashMap.this.containsNullKey && (Double2ObjectOpenHashMap.this.value[Double2ObjectOpenHashMap.this.n] == null ? v == null : Double2ObjectOpenHashMap.this.value[Double2ObjectOpenHashMap.this.n].equals(v));
            }
        ...
        public boolean rem(Object o) {
            ...
            Object v = e.getValue();
            if (Double.doubleToLongBits(k) == 0L) {
                if (Double2ObjectOpenHashMap.this.containsNullKey && (Double2ObjectOpenHashMap.this.value[Double2ObjectOpenHashMap.this.n] == null ? v == null : Double2ObjectOpenHashMap.this.value[Double2ObjectOpenHashMap.this.n].equals(v))) {
            ...
            if (Double.doubleToLongBits(curr) == Double.doubleToLongBits(k)) {
                if (Double2ObjectOpenHashMap.this.value[pos] == null ? v == null : Double2ObjectOpenHashMap.this.value[pos].equals(v)) {
            ...
            do {
                if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2ObjectOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToLongBits(curr) != Double.doubleToLongBits(k) || !(Double2ObjectOpenHashMap.this.value[pos] == null ? v == null : Double2ObjectOpenHashMap.this.value[pos].equals(v)));
            Double2ObjectOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Double, V> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToLongBits(Double2ObjectOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((Double)e.getKey()) && (Double2ObjectOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Double2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()));
        }
