...
Hash {
    ...
    implements FloatIterator {
        ...
        @Deprecated
        public Float next() {
            return Float.valueOf(Double2FloatOpenHashMap.this.value[this.nextEntry()]);
        }
    }
    ...
    implements Double2FloatMap.FastEntrySet {
        ...
        public boolean rem(Object o) {
            ...
            do {
                if (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2FloatOpenHashMap.this.mask]) != 0L) continue;
                return false;
            } while (Double.doubleToLongBits(curr) != Double.doubleToLongBits(k) || Double2FloatOpenHashMap.this.value[pos] != v);
            Double2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Double, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Double.doubleToLongBits(Double2FloatOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((Double)e.getKey()) && Double2FloatOpenHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue();
        }
