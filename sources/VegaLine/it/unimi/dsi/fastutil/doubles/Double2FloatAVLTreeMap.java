...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof DoubleComparator ? (DoubleComparator)this.storedComparator : new DoubleComparator(){
            ...
            public int compare(double k1, double k2) {
                return Double2FloatAVLTreeMap.this.storedComparator.compare((Double)k1, (Double)k2);
            }
    ...
    public Float put(Double ok, Float ov) {
        float oldValue = this.put((double)ok, ov.floatValue());
    ...
    public Float remove(Object ok) {
        float oldValue = this.remove((Double)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2FloatMap.Entry>(){
                final Comparator<? super Double2FloatMap.Entry> comparator = new Comparator<Double2FloatMap.Entry>(){
                    ...
                    @Override
                    public int compare(Double2FloatMap.Entry x, Double2FloatMap.Entry y) {
