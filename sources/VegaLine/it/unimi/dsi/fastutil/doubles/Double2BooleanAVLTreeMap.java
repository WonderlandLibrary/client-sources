...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof DoubleComparator ? (DoubleComparator)this.storedComparator : new DoubleComparator(){
            ...
            public int compare(double k1, double k2) {
                return Double2BooleanAVLTreeMap.this.storedComparator.compare((Double)k1, (Double)k2);
            }

            @Override
            public int compare(Double ok1, Double ok2) {
                return Double2BooleanAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Boolean put(Double ok, Boolean ov) {
        boolean oldValue = this.put((double)ok, (boolean)ov);
    ...
    public Boolean remove(Object ok) {
        boolean oldValue = this.remove((Double)ok);
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2BooleanMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Double2BooleanMap.Entry> comparator() {
                        return Double2BooleanAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Boolean put(Double ok, Boolean ov) {
            boolean oldValue = this.put((double)ok, (boolean)ov);
            return Double2BooleanAVLTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
        }
        ...
        public Boolean remove(Object ok) {
            boolean oldValue = this.remove((Double)ok);
            return Double2BooleanAVLTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
        }
