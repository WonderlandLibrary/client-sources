...
DoubleSortedSet {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof DoubleComparator ? (DoubleComparator)this.storedComparator : new DoubleComparator(){
            ...
            public int compare(double k1, double k2) {
                return DoubleAVLTreeSet.this.storedComparator.compare((Double)k1, (Double)k2);
            }

            @Override
            public int compare(Double ok1, Double ok2) {
                return DoubleAVLTreeSet.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    DoubleSortedSet {
        ...
        public boolean rem(double k) {
            ...
            return DoubleAVLTreeSet.this.rem(k);
        }
    ...
    extends AbstractDoubleListIterator {
        ...
        public void remove() {
            ...
            this.updatePrevious();
            this.updateNext();
            DoubleAVLTreeSet.this.rem(this.curr.key);
            this.curr = null;
        }
    }
