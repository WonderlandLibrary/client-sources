...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof DoubleComparator ? (DoubleComparator)this.storedComparator : new DoubleComparator(){
            ...
            public int compare(double k1, double k2) {
                return Double2DoubleRBTreeMap.this.storedComparator.compare((Double)k1, (Double)k2);
            }
    ...
    public Double put(Double ok, Double ov) {
        double oldValue = this.put((double)ok, (double)ov);
    ...
    public Double remove(Object ok) {
        double oldValue = this.remove((Double)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2DoubleMap.Entry>(){
                final Comparator<? super Double2DoubleMap.Entry> comparator = new Comparator<Double2DoubleMap.Entry>(){
                    ...
                    @Override
                    public int compare(Double2DoubleMap.Entry x, Double2DoubleMap.Entry y) {
                        return Double2DoubleRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                    }
                };
