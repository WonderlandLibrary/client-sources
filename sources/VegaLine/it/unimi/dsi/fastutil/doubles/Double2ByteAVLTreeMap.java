...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof DoubleComparator ? (DoubleComparator)this.storedComparator : new DoubleComparator(){
            ...
            public int compare(double k1, double k2) {
                return Double2ByteAVLTreeMap.this.storedComparator.compare((Double)k1, (Double)k2);
            }

            @Override
            public int compare(Double ok1, Double ok2) {
                return Double2ByteAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Byte put(Double ok, Byte ov) {
        byte oldValue = this.put((double)ok, (byte)ov);
    ...
    public Byte remove(Object ok) {
        byte oldValue = this.remove((Double)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>(){
                final Comparator<? super Double2ByteMap.Entry> comparator = new Comparator<Double2ByteMap.Entry>(){
                    ...
                    @Override
                    public int compare(Double2ByteMap.Entry x, Double2ByteMap.Entry y) {
                        return Double2ByteAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Double2ByteMap.Entry> comparator() {
                        return Double2ByteAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Byte put(Double ok, Byte ov) {
            byte oldValue = this.put((double)ok, (byte)ov);
            return Double2ByteAVLTreeMap.this.modified ? null : Byte.valueOf(oldValue);
        }
        ...
        public Byte remove(Object ok) {
            byte oldValue = this.remove((Double)ok);
            return Double2ByteAVLTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
        }
