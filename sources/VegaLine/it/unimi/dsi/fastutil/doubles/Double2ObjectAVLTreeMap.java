...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof DoubleComparator ? (DoubleComparator)this.storedComparator : new DoubleComparator(){
            ...
            public int compare(double k1, double k2) {
                return Double2ObjectAVLTreeMap.this.storedComparator.compare((Double)k1, (Double)k2);
            }

            @Override
            public int compare(Double ok1, Double ok2) {
                return Double2ObjectAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public V put(Double ok, V ov) {
        V oldValue = this.put((double)ok, ov);
    ...
    public V remove(Object ok) {
        V oldValue = this.remove((Double)ok);
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2ObjectMap.Entry<V>>(){
                    ...
                    @Override
                    public Comparator<? super Double2ObjectMap.Entry<V>> comparator() {
                        return Double2ObjectAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        @Deprecated
        public V put(Double ok, V ov) {
            Object oldValue = this.put((double)ok, (V)ov);
            return Double2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
        }
        ...
        @Deprecated
        public V remove(Object ok) {
            Object oldValue = this.remove((Double)ok);
            return Double2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
        }
