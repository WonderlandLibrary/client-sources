...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ShortComparator ? (ShortComparator)this.storedComparator : new ShortComparator(){

            @Override
            public int compare(short k1, short k2) {
                return Short2FloatAVLTreeMap.this.storedComparator.compare((Short)k1, (Short)k2);
            }

            @Override
            public int compare(Short ok1, Short ok2) {
                return Short2FloatAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Float put(Short ok, Float ov) {
        float oldValue = this.put((short)ok, ov.floatValue());
    ...
    public Float remove(Object ok) {
        float oldValue = this.remove((Short)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>(){
                final Comparator<? super Short2FloatMap.Entry> comparator = new Comparator<Short2FloatMap.Entry>(){
                    ...
                    @Override
                    public int compare(Short2FloatMap.Entry x, Short2FloatMap.Entry y) {
                        return Short2FloatAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Short2FloatMap.Entry> comparator() {
                        return Short2FloatAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Float put(Short ok, Float ov) {
            float oldValue = this.put((short)ok, ov.floatValue());
            return Short2FloatAVLTreeMap.this.modified ? null : Float.valueOf(oldValue);
        }
        ...
        public Float remove(Object ok) {
            float oldValue = this.remove((Short)ok);
            return Short2FloatAVLTreeMap.this.modified ? Float.valueOf(oldValue) : null;
        }
