...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ShortComparator ? (ShortComparator)this.storedComparator : new ShortComparator(){
            ...
            public int compare(short k1, short k2) {
                return Short2ShortAVLTreeMap.this.storedComparator.compare((Short)k1, (Short)k2);
            }

            @Override
            public int compare(Short ok1, Short ok2) {
                return Short2ShortAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Short put(Short ok, Short ov) {
        short oldValue = this.put((short)ok, (short)ov);
    ...
    public Short remove(Object ok) {
        short oldValue = this.remove((Short)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ShortMap.Entry>(){
                final Comparator<? super Short2ShortMap.Entry> comparator = new Comparator<Short2ShortMap.Entry>(){
                    ...
                    @Override
                    public int compare(Short2ShortMap.Entry x, Short2ShortMap.Entry y) {
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2ShortMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Short2ShortMap.Entry> comparator() {
                        return Short2ShortAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Short put(Short ok, Short ov) {
            short oldValue = this.put((short)ok, (short)ov);
            return Short2ShortAVLTreeMap.this.modified ? null : Short.valueOf(oldValue);
        }
        ...
        public Short remove(Object ok) {
            short oldValue = this.remove((Short)ok);
            return Short2ShortAVLTreeMap.this.modified ? Short.valueOf(oldValue) : null;
        }
