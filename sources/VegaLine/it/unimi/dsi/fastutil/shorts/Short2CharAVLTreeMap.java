...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ShortComparator ? (ShortComparator)this.storedComparator : new ShortComparator(){
            ...
            public int compare(short k1, short k2) {
                return Short2CharAVLTreeMap.this.storedComparator.compare((Short)k1, (Short)k2);
            }

            @Override
            public int compare(Short ok1, Short ok2) {
                return Short2CharAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Short2CharMap.Entry> comparator() {
                        return Short2CharAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Character put(Short ok, Character ov) {
            char oldValue = this.put((short)ok, ov.charValue());
            return Short2CharAVLTreeMap.this.modified ? null : Character.valueOf(oldValue);
        }
        ...
        public Character remove(Object ok) {
            char oldValue = this.remove((Short)ok);
            return Short2CharAVLTreeMap.this.modified ? Character.valueOf(oldValue) : null;
        }
