...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ShortComparator ? (ShortComparator)this.storedComparator : new ShortComparator(){
            ...
            public int compare(short k1, short k2) {
                return Short2CharRBTreeMap.this.storedComparator.compare((Short)k1, (Short)k2);
            }

            @Override
            public int compare(Short ok1, Short ok2) {
                return Short2CharRBTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Character put(Short ok, Character ov) {
        char oldValue = this.put((short)ok, ov.charValue());
    ...
    public Character remove(Object ok) {
        char oldValue = this.remove((Short)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>(){
                final Comparator<? super Short2CharMap.Entry> comparator = new Comparator<Short2CharMap.Entry>(){
                    ...
                    @Override
                    public int compare(Short2CharMap.Entry x, Short2CharMap.Entry y) {
                        return Short2CharRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public Character put(Short ok, Character ov) {
            char oldValue = this.put((short)ok, ov.charValue());
            return Short2CharRBTreeMap.this.modified ? null : Character.valueOf(oldValue);
        }
        ...
        public Character remove(Object ok) {
            char oldValue = this.remove((Short)ok);
            return Short2CharRBTreeMap.this.modified ? Character.valueOf(oldValue) : null;
        }
