    ...
    implements Short2FloatMap.FastEntrySet {
        ...
        public ObjectIterator<Short2FloatMap.Entry> fastIterator() {
            return new AbstractObjectIterator<Short2FloatMap.Entry>(){
                int next = 0;
                int curr = -1;
                final AbstractShort2FloatMap.BasicEntry entry = new AbstractShort2FloatMap.BasicEntry(0, 0.0f);
        ...
        public boolean contains(Object o) {
            ...
            return Short2FloatArrayMap.this.containsKey(k) && Short2FloatArrayMap.this.get(k) == ((Float)e.getValue()).floatValue();
        }
