...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ShortComparator ? (ShortComparator)this.storedComparator : new ShortComparator(){
            ...
            public int compare(short k1, short k2) {
                return Short2ByteAVLTreeMap.this.storedComparator.compare((Short)k1, (Short)k2);
            }

            @Override
            public int compare(Short ok1, Short ok2) {
                return Short2ByteAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Byte put(Short ok, Byte ov) {
        byte oldValue = this.put((short)ok, (byte)ov);
    ...
    public Byte remove(Object ok) {
        byte oldValue = this.remove((Short)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ByteMap.Entry>(){
                final Comparator<? super Short2ByteMap.Entry> comparator = new Comparator<Short2ByteMap.Entry>(){
                    ...
                    @Override
                    public int compare(Short2ByteMap.Entry x, Short2ByteMap.Entry y) {
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2ByteMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Short2ByteMap.Entry> comparator() {
                        return Short2ByteAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Byte put(Short ok, Byte ov) {
            byte oldValue = this.put((short)ok, (byte)ov);
            return Short2ByteAVLTreeMap.this.modified ? null : Byte.valueOf(oldValue);
        }
        ...
        public Byte remove(Object ok) {
            byte oldValue = this.remove((Short)ok);
            return Short2ByteAVLTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
        }
