...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ShortComparator ? (ShortComparator)this.storedComparator : new ShortComparator(){
            ...
            public int compare(short k1, short k2) {
                return Short2ObjectAVLTreeMap.this.storedComparator.compare((Short)k1, (Short)k2);
            }

            @Override
            public int compare(Short ok1, Short ok2) {
                return Short2ObjectAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public V put(Short ok, V ov) {
        V oldValue = this.put((short)ok, ov);
    ...
    public V remove(Object ok) {
        V oldValue = this.remove((Short)ok);
    ...
    public boolean containsValue(Object v) {
        ...
        while (j-- != 0) {
            Object ev = i.next();
            if (!(ev == null ? v == null : ev.equals(v))) continue;
            return true;
        }
        return false;
    }
            ...
            this.entries = new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>(){
                final Comparator<? super Short2ObjectMap.Entry<V>> comparator = new Comparator<Short2ObjectMap.Entry<V>>(){
                    ...
                    public int compare(Short2ObjectMap.Entry<V> x, Short2ObjectMap.Entry<V> y) {
                        return Short2ObjectAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>(){
                    ...
                    @Override
                    public Comparator<? super Short2ObjectMap.Entry<V>> comparator() {
                        return Short2ObjectAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        @Deprecated
        public V put(Short ok, V ov) {
            Object oldValue = this.put((short)ok, (V)ov);
            return Short2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
        }
        ...
        @Deprecated
        public V remove(Object ok) {
            Object oldValue = this.remove((Short)ok);
            return Short2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
        }
