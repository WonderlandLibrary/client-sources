...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ShortComparator ? (ShortComparator)this.storedComparator : new ShortComparator(){
            ...
            public int compare(short k1, short k2) {
                return Short2DoubleAVLTreeMap.this.storedComparator.compare((Short)k1, (Short)k2);
            }

            @Override
            public int compare(Short ok1, Short ok2) {
                return Short2DoubleAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Double put(Short ok, Double ov) {
        double oldValue = this.put((short)ok, (double)ov);
    ...
    public Double remove(Object ok) {
        double oldValue = this.remove((Short)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2DoubleMap.Entry>(){
                final Comparator<? super Short2DoubleMap.Entry> comparator = new Comparator<Short2DoubleMap.Entry>(){
                    ...
                    @Override
                    public int compare(Short2DoubleMap.Entry x, Short2DoubleMap.Entry y) {
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2DoubleMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Short2DoubleMap.Entry> comparator() {
                        return Short2DoubleAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Double put(Short ok, Double ov) {
            double oldValue = this.put((short)ok, (double)ov);
            return Short2DoubleAVLTreeMap.this.modified ? null : Double.valueOf(oldValue);
        }
        ...
        public Double remove(Object ok) {
            double oldValue = this.remove((Short)ok);
            return Short2DoubleAVLTreeMap.this.modified ? Double.valueOf(oldValue) : null;
        }
