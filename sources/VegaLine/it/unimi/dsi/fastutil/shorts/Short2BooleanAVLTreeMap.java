...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ShortComparator ? (ShortComparator)this.storedComparator : new ShortComparator(){
            ...
            public int compare(short k1, short k2) {
                return Short2BooleanAVLTreeMap.this.storedComparator.compare((Short)k1, (Short)k2);
            }

            @Override
            public int compare(Short ok1, Short ok2) {
                return Short2BooleanAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Boolean put(Short ok, Boolean ov) {
        boolean oldValue = this.put((short)ok, (boolean)ov);
    ...
    public Boolean remove(Object ok) {
        boolean oldValue = this.remove((Short)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry>(){
                final Comparator<? super Short2BooleanMap.Entry> comparator = new Comparator<Short2BooleanMap.Entry>(){
                    ...
                    @Override
                    public int compare(Short2BooleanMap.Entry x, Short2BooleanMap.Entry y) {
                        return Short2BooleanAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Short2BooleanMap.Entry> comparator() {
                        return Short2BooleanAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Boolean put(Short ok, Boolean ov) {
            boolean oldValue = this.put((short)ok, (boolean)ov);
            return Short2BooleanAVLTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
        }
        ...
        public Boolean remove(Object ok) {
            boolean oldValue = this.remove((Short)ok);
            return Short2BooleanAVLTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
        }
