    ...
    implements Short2DoubleMap.FastEntrySet {
        ...
        public ObjectIterator<Short2DoubleMap.Entry> fastIterator() {
            return new AbstractObjectIterator<Short2DoubleMap.Entry>(){
                int next = 0;
                int curr = -1;
                final AbstractShort2DoubleMap.BasicEntry entry = new AbstractShort2DoubleMap.BasicEntry(0, 0.0);
        ...
        public boolean contains(Object o) {
            ...
            return Short2DoubleArrayMap.this.containsKey(k) && Short2DoubleArrayMap.this.get(k) == ((Double)e.getValue()).doubleValue();
        }
