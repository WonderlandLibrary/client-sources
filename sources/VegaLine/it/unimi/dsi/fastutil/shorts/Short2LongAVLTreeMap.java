...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ShortComparator ? (ShortComparator)this.storedComparator : new ShortComparator(){
            ...
            public int compare(short k1, short k2) {
                return Short2LongAVLTreeMap.this.storedComparator.compare((Short)k1, (Short)k2);
            }

            @Override
            public int compare(Short ok1, Short ok2) {
                return Short2LongAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Long put(Short ok, Long ov) {
        long oldValue = this.put((short)ok, (long)ov);
    ...
    public Long remove(Object ok) {
        long oldValue = this.remove((Short)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>(){
                final Comparator<? super Short2LongMap.Entry> comparator = new Comparator<Short2LongMap.Entry>(){
                    ...
                    @Override
                    public int compare(Short2LongMap.Entry x, Short2LongMap.Entry y) {
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Short2LongMap.Entry> comparator() {
                        return Short2LongAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Long put(Short ok, Long ov) {
            long oldValue = this.put((short)ok, (long)ov);
            return Short2LongAVLTreeMap.this.modified ? null : Long.valueOf(oldValue);
        }
        ...
        public Long remove(Object ok) {
            long oldValue = this.remove((Short)ok);
            return Short2LongAVLTreeMap.this.modified ? Long.valueOf(oldValue) : null;
        }
