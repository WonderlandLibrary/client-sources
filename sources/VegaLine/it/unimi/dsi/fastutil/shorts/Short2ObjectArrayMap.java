    ...
    implements Short2ObjectMap.FastEntrySet<V> {
        ...
        public ObjectIterator<Short2ObjectMap.Entry<V>> fastIterator() {
            return new AbstractObjectIterator<Short2ObjectMap.Entry<V>>(){
                int next = 0;
                int curr = -1;
                final AbstractShort2ObjectMap.BasicEntry<V> entry = new AbstractShort2ObjectMap.BasicEntry<Object>(0, null);
        ...
        public boolean remove(Object o) {
            ...
            if (oldPos == -1 || !(v != null ? v.equals(Short2ObjectArrayMap.this.value[oldPos]) : Short2ObjectArrayMap.this.value[oldPos] == null)) {
                return false;
            }
