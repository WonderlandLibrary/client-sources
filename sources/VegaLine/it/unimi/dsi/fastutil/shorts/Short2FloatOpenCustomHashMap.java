...
Hash {
    ...
    implements FloatIterator {
        ...
        @Deprecated
        public Float next() {
            return Float.valueOf(Short2FloatOpenCustomHashMap.this.value[this.nextEntry()]);
        }
    }
    ...
    implements Short2FloatMap.FastEntrySet {
        ...
        public boolean rem(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Short2FloatOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Short2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Short2FloatOpenCustomHashMap.this.value[pos] != v);
            Short2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Short, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Short2FloatOpenCustomHashMap.this.strategy.equals(Short2FloatOpenCustomHashMap.this.key[this.index], (Short)e.getKey()) && Short2FloatOpenCustomHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue();
        }
