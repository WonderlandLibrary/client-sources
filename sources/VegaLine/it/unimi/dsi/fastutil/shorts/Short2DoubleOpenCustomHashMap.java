...
Hash {
    ...
    implements Short2DoubleMap.FastEntrySet {
        ...
        public boolean rem(Object o) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Short2DoubleOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Short2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Short2DoubleOpenCustomHashMap.this.value[pos] != v);
            Short2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Short, Double> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Short2DoubleOpenCustomHashMap.this.strategy.equals(Short2DoubleOpenCustomHashMap.this.key[this.index], (Short)e.getKey()) && Short2DoubleOpenCustomHashMap.this.value[this.index] == (Double)e.getValue();
        }
