...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof ShortComparator ? (ShortComparator)this.storedComparator : new ShortComparator(){
            ...
            public int compare(short k1, short k2) {
                return Short2IntRBTreeMap.this.storedComparator.compare((Short)k1, (Short)k2);
            }
    ...
    public Integer put(Short ok, Integer ov) {
        int oldValue = this.put((short)ok, (int)ov);
    ...
    public Integer remove(Object ok) {
        int oldValue = this.remove((Short)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2IntMap.Entry>(){
                final Comparator<? super Short2IntMap.Entry> comparator = new Comparator<Short2IntMap.Entry>(){
                    ...
                    @Override
                    public int compare(Short2IntMap.Entry x, Short2IntMap.Entry y) {
                        return Short2IntRBTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
                    }
                };
