...
Hash {
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.last == Object2ShortOpenHashMap.this.n) {
                ...
                Object2ShortOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, (Object)null));
                this.last = -1;
                return;
            }
    ...
    Map.Entry<K, Short> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return (Object2ShortOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2ShortOpenHashMap.this.key[this.index].equals(e.getKey())) && Object2ShortOpenHashMap.this.value[this.index] == (Short)e.getValue();
        }
