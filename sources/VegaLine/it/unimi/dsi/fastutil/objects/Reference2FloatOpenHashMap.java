...
Hash {
    ...
    implements FloatIterator {
        ...
        @Deprecated
        public Float next() {
            return Float.valueOf(Reference2FloatOpenHashMap.this.value[this.nextEntry()]);
        }
    }
    ...
    implements Reference2FloatMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            if (k == null) {
                return Reference2FloatOpenHashMap.this.containsNullKey && Reference2FloatOpenHashMap.this.value[Reference2FloatOpenHashMap.this.n] == v;
            }
            ...
            if (k == curr) {
                return Reference2FloatOpenHashMap.this.value[pos] == v;
            }
            do {
        ...
        public boolean rem(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (k == null) {
                if (Reference2FloatOpenHashMap.this.containsNullKey && Reference2FloatOpenHashMap.this.value[Reference2FloatOpenHashMap.this.n] == v) {
            ...
            if (curr == k) {
                if (Reference2FloatOpenHashMap.this.value[pos] == v) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2FloatOpenHashMap.this.mask]) != null) continue;
                return false;
            } while (curr != k || Reference2FloatOpenHashMap.this.value[pos] != v);
            Reference2FloatOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.last == Reference2FloatOpenHashMap.this.n) {
                ...
                Reference2FloatOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, (Object)null));
                this.last = -1;
                return;
            }
    ...
    Map.Entry<K, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Reference2FloatOpenHashMap.this.key[this.index] == e.getKey() && Reference2FloatOpenHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue();
        }
