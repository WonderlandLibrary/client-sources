    ...
    implements Object2ObjectMap.FastEntrySet<K, V> {
        ...
        public ObjectIterator<Object2ObjectMap.Entry<K, V>> fastIterator() {
            return new AbstractObjectIterator<Object2ObjectMap.Entry<K, V>>(){
                int next = 0;
                int curr = -1;
                final AbstractObject2ObjectMap.BasicEntry<K, V> entry = new AbstractObject2ObjectMap.BasicEntry<Object, Object>(null, null);
        ...
        public boolean remove(Object o) {
            ...
            if (oldPos == -1 || !(v != null ? v.equals(Object2ObjectArrayMap.this.value[oldPos]) : Object2ObjectArrayMap.this.value[oldPos] == null)) {
                return false;
            }
