...
Cloneable {
    ...
    public Integer put(K ok, Integer ov) {
        int oldValue = this.put(ok, (int)ov);
    ...
    public Integer remove(Object ok) {
        int oldValue = this.removeInt(ok);
    ...
    implements Serializable {
        ...
        public Integer get(Object ok) {
            Entry<Object> e;
            Object kk = ok;
            return this.in(kk) && (e = Object2IntRBTreeMap.this.findKey(kk)) != null ? e.getValue() : null;
        }
        ...
        @Deprecated
        public Integer put(K ok, Integer ov) {
            int oldValue = this.put((K)ok, (int)ov);
            return Object2IntRBTreeMap.this.modified ? null : Integer.valueOf(oldValue);
        }
        ...
        public Integer remove(Object ok) {
            int oldValue = this.removeInt(ok);
            return Object2IntRBTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
        }
