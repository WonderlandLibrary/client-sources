...
Serializable {
    ...
    public long indexOf(Object k) {
        for (long i = 0L; i < this.size; ++i) {
            if (!(k == null ? ObjectBigArrays.get(this.a, i) == null : k.equals(ObjectBigArrays.get(this.a, i)))) continue;
            return i;
        }
        return -1L;
    }
    ...
    public void removeElements(int from, int to) {
        ...
        ObjectBigArrays.copy(this.a, to, this.a, from, this.size - (long)to);
        this.size -= (long)(to - from);
        ObjectBigArrays.fill(this.a, this.size, this.size + (long)to - (long)from, null);
    }
    ...
    public void addElements(int index, K[][] a, long offset, long length) {
        ...
        ObjectBigArrays.copy(this.a, index, this.a, (long)index + length, this.size - (long)index);
