...
Cloneable {
    ...
    public Float put(K ok, Float ov) {
        float oldValue = this.put(ok, ov.floatValue());
    ...
    public Float remove(Object ok) {
        float oldValue = this.removeFloat(ok);
    ...
    public Float get(Object ok) {
        Entry<Object> e = this.findKey(ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>(){
                final Comparator<? super Object2FloatMap.Entry<K>> comparator = new Comparator<Object2FloatMap.Entry<K>>(){
                    ...
                    @Override
                    public int compare(Object2FloatMap.Entry<K> x, Object2FloatMap.Entry<K> y) {
                        return Object2FloatRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                    }
                };
    ...
    private static <K> int checkTree(Entry<K> e, int d, int D) {
        return 0;
    }
    ...
    implements Serializable {
        ...
        public Float get(Object ok) {
            Entry<Object> e;
            Object kk = ok;
            return this.in(kk) && (e = Object2FloatRBTreeMap.this.findKey(kk)) != null ? e.getValue() : null;
        }
        ...
        @Deprecated
        public Float put(K ok, Float ov) {
            float oldValue = this.put((K)ok, ov.floatValue());
            return Object2FloatRBTreeMap.this.modified ? null : Float.valueOf(oldValue);
        }
        ...
        public Float remove(Object ok) {
            float oldValue = this.removeFloat(ok);
            return Object2FloatRBTreeMap.this.modified ? Float.valueOf(oldValue) : null;
        }
    ...
    Object2FloatMap.Entry<K> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && this.value == ((Float)e.getValue()).floatValue();
        }
