...
Cloneable {
    ...
    public Boolean put(K ok, Boolean ov) {
        boolean oldValue = this.put(ok, (boolean)ov);
    ...
    public Boolean remove(Object ok) {
        boolean oldValue = this.removeBoolean(ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>(){
                final Comparator<? super Object2BooleanMap.Entry<K>> comparator = new Comparator<Object2BooleanMap.Entry<K>>(){
                    ...
                    @Override
                    public int compare(Object2BooleanMap.Entry<K> x, Object2BooleanMap.Entry<K> y) {
    ...
    implements Serializable {
        ...
        @Deprecated
        public Boolean put(K ok, Boolean ov) {
            boolean oldValue = this.put((K)ok, (boolean)ov);
