...
Hash {
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.last == Object2BooleanOpenHashMap.this.n) {
                ...
                Object2BooleanOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, (Object)null));
                this.last = -1;
                return;
            }
    ...
    Map.Entry<K, Boolean> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return (Object2BooleanOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2BooleanOpenHashMap.this.key[this.index].equals(e.getKey())) && Object2BooleanOpenHashMap.this.value[this.index] == (Boolean)e.getValue();
        }
