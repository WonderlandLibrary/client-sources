    ...
    implements Object2FloatMap.FastEntrySet<K> {
        ...
        public ObjectIterator<Object2FloatMap.Entry<K>> fastIterator() {
            return new AbstractObjectIterator<Object2FloatMap.Entry<K>>(){
                int next = 0;
                int curr = -1;
                final AbstractObject2FloatMap.BasicEntry<K> entry = new AbstractObject2FloatMap.BasicEntry<Object>(null, 0.0f);
        ...
        public boolean contains(Object o) {
            ...
            Object k = e.getKey();
            return Object2FloatArrayMap.this.containsKey(k) && Object2FloatArrayMap.this.getFloat(k) == ((Float)e.getValue()).floatValue();
        }
