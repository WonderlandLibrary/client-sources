...
Cloneable {
    ...
    public Long put(K ok, Long ov) {
        long oldValue = this.put(ok, (long)ov);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>(){
                final Comparator<? super Object2LongMap.Entry<K>> comparator = new Comparator<Object2LongMap.Entry<K>>(){
                    ...
                    @Override
                    public int compare(Object2LongMap.Entry<K> x, Object2LongMap.Entry<K> y) {
    ...
    implements Serializable {
        ...
        public Long get(Object ok) {
            Entry<Object> e;
            Object kk = ok;
            return this.in(kk) && (e = Object2LongRBTreeMap.this.findKey(kk)) != null ? e.getValue() : null;
        }
        ...
        @Deprecated
        public Long put(K ok, Long ov) {
            long oldValue = this.put((K)ok, (long)ov);
            return Object2LongRBTreeMap.this.modified ? null : Long.valueOf(oldValue);
        }
        ...
        public Long remove(Object ok) {
            long oldValue = this.removeLong(ok);
            return Object2LongRBTreeMap.this.modified ? Long.valueOf(oldValue) : null;
        }
