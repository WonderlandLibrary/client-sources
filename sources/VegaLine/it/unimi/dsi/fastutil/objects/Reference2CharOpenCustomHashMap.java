...
Hash {
    ...
    implements CharIterator {
        ...
        public Character next() {
            return Character.valueOf(Reference2CharOpenCustomHashMap.this.value[this.nextEntry()]);
        }
    }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.last == Reference2CharOpenCustomHashMap.this.n) {
                ...
                Reference2CharOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 1, (Object)null));
                this.last = -1;
                return;
            }
