    ...
    Cloneable {
        ...
        Map.Entry<K, Long> {
            ...
            public boolean equals(Object o) {
                ...
                return (Singleton.this.key == null ? e.getKey() == null : Singleton.this.key.equals(e.getKey())) && Singleton.this.value == (Long)e.getValue();
            }

            @Override
            public int hashCode() {
                return (Singleton.this.key == null ? 0 : Singleton.this.key.hashCode()) ^ HashCommon.long2int(Singleton.this.value);
            }
