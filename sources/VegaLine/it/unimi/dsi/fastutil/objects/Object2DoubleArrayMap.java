    ...
    implements Object2DoubleMap.FastEntrySet<K> {
        ...
        public ObjectIterator<Object2DoubleMap.Entry<K>> fastIterator() {
            return new AbstractObjectIterator<Object2DoubleMap.Entry<K>>(){
                int next = 0;
                int curr = -1;
                final AbstractObject2DoubleMap.BasicEntry<K> entry = new AbstractObject2DoubleMap.BasicEntry<Object>(null, 0.0);
        ...
        public boolean contains(Object o) {
            ...
            Object k = e.getKey();
            return Object2DoubleArrayMap.this.containsKey(k) && Object2DoubleArrayMap.this.getDouble(k) == ((Double)e.getValue()).doubleValue();
        }
