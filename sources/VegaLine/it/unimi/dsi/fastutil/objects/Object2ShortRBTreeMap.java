...
Cloneable {
    ...
    public Short put(K ok, Short ov) {
        short oldValue = this.put(ok, (short)ov);
    ...
    public Short remove(Object ok) {
        short oldValue = this.removeShort(ok);
            ...
            this.entries = new AbstractObjectSortedSet<Object2ShortMap.Entry<K>>(){
                final Comparator<? super Object2ShortMap.Entry<K>> comparator = new Comparator<Object2ShortMap.Entry<K>>(){
                    ...
                    public int compare(Object2ShortMap.Entry<K> x, Object2ShortMap.Entry<K> y) {
                        return Object2ShortRBTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public Short get(Object ok) {
            Entry<Object> e;
            Object kk = ok;
            return this.in(kk) && (e = Object2ShortRBTreeMap.this.findKey(kk)) != null ? e.getValue() : null;
        }
        ...
        @Deprecated
        public Short put(K ok, Short ov) {
            short oldValue = this.put((K)ok, (short)ov);
            return Object2ShortRBTreeMap.this.modified ? null : Short.valueOf(oldValue);
        }
        ...
        public Short remove(Object ok) {
            short oldValue = this.removeShort(ok);
            return Object2ShortRBTreeMap.this.modified ? Short.valueOf(oldValue) : null;
        }
