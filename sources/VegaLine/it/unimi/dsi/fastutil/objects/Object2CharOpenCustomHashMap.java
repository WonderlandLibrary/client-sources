...
Hash {
    ...
    implements CharIterator {
        ...
        public Character next() {
            return Character.valueOf(Object2CharOpenCustomHashMap.this.value[this.nextEntry()]);
        }
    }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.last == Object2CharOpenCustomHashMap.this.n) {
                ...
                Object2CharOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 1, (Object)null));
                this.last = -1;
                return;
            }
