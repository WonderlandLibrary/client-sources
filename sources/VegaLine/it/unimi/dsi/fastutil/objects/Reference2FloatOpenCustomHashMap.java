...
Hash {
    ...
    implements FloatIterator {
        ...
        @Deprecated
        public Float next() {
            return Float.valueOf(Reference2FloatOpenCustomHashMap.this.value[this.nextEntry()]);
        }
    }
    ...
    extends AbstractReferenceSet<K> {
        ...
        public boolean rem(Object k) {
            ...
            Reference2FloatOpenCustomHashMap.this.remove(k);
    ...
    implements Reference2FloatMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
                return Reference2FloatOpenCustomHashMap.this.containsNullKey && Reference2FloatOpenCustomHashMap.this.value[Reference2FloatOpenCustomHashMap.this.n] == v;
            }
            ...
            if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Reference2FloatOpenCustomHashMap.this.value[pos] == v;
            }
            do {
        ...
        public boolean rem(Object o) {
            ...
            float v = ((Float)e.getValue()).floatValue();
            if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
                if (Reference2FloatOpenCustomHashMap.this.containsNullKey && Reference2FloatOpenCustomHashMap.this.value[Reference2FloatOpenCustomHashMap.this.n] == v) {
            ...
            if (Reference2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Reference2FloatOpenCustomHashMap.this.value[pos] == v) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Reference2FloatOpenCustomHashMap.this.mask]) != null) continue;
                return false;
            } while (!Reference2FloatOpenCustomHashMap.this.strategy.equals(curr, k) || Reference2FloatOpenCustomHashMap.this.value[pos] != v);
            Reference2FloatOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.last == Reference2FloatOpenCustomHashMap.this.n) {
                ...
                Reference2FloatOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 1, (Object)null));
                this.last = -1;
                return;
            }
    ...
    Map.Entry<K, Float> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Reference2FloatOpenCustomHashMap.this.strategy.equals(Reference2FloatOpenCustomHashMap.this.key[this.index], e.getKey()) && Reference2FloatOpenCustomHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue();
        }
