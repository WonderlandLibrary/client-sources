...
Hash {
    ...
    implements CharIterator {
        ...
        public Character next() {
            return Character.valueOf(Object2CharOpenHashMap.this.value[this.nextEntry()]);
        }
    }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.last == Object2CharOpenHashMap.this.n) {
                ...
                Object2CharOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, (Object)null));
                this.last = -1;
                return;
            }
    ...
    Map.Entry<K, Character> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return (Object2CharOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2CharOpenHashMap.this.key[this.index].equals(e.getKey())) && Object2CharOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue();
        }
