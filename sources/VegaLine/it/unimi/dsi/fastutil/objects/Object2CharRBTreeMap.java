...
Cloneable {
    ...
    public Character put(K ok, Character ov) {
        char oldValue = this.put(ok, ov.charValue());
    ...
    public Character remove(Object ok) {
        char oldValue = this.removeChar(ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2CharMap.Entry<K>>(){
                final Comparator<? super Object2CharMap.Entry<K>> comparator = new Comparator<Object2CharMap.Entry<K>>(){
                    ...
                    @Override
                    public int compare(Object2CharMap.Entry<K> x, Object2CharMap.Entry<K> y) {
    ...
    implements Serializable {
        ...
        public Character get(Object ok) {
            Entry<Object> e;
            Object kk = ok;
            return this.in(kk) && (e = Object2CharRBTreeMap.this.findKey(kk)) != null ? e.getValue() : null;
        }
        ...
        @Deprecated
        public Character put(K ok, Character ov) {
            char oldValue = this.put((K)ok, ov.charValue());
