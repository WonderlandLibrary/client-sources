...
Hash {
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            if (this.last == Object2ByteOpenHashMap.this.n) {
                ...
                Object2ByteOpenHashMap.this.remove(this.wrapped.set(-this.pos - 1, (Object)null));
                this.last = -1;
                return;
            }
    ...
    Map.Entry<K, Byte> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return (Object2ByteOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2ByteOpenHashMap.this.key[this.index].equals(e.getKey())) && Object2ByteOpenHashMap.this.value[this.index] == (Byte)e.getValue();
        }
