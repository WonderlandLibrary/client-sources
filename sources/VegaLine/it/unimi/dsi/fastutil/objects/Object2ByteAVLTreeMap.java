...
Cloneable {
    ...
    public Byte put(K ok, Byte ov) {
        byte oldValue = this.put(ok, (byte)ov);
    ...
    public Byte remove(Object ok) {
        byte oldValue = this.removeByte(ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>(){
                final Comparator<? super Object2ByteMap.Entry<K>> comparator = new Comparator<Object2ByteMap.Entry<K>>(){
                    ...
                    @Override
                    public int compare(Object2ByteMap.Entry<K> x, Object2ByteMap.Entry<K> y) {
                        return Object2ByteAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2ByteMap.Entry<K>>(){
                    ...
                    @Override
                    public Comparator<? super Object2ByteMap.Entry<K>> comparator() {
                        return Object2ByteAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Byte get(Object ok) {
            Entry<Object> e;
            Object kk = ok;
            return this.in(kk) && (e = Object2ByteAVLTreeMap.this.findKey(kk)) != null ? e.getValue() : null;
        }
        ...
        @Deprecated
        public Byte put(K ok, Byte ov) {
            byte oldValue = this.put((K)ok, (byte)ov);
            return Object2ByteAVLTreeMap.this.modified ? null : Byte.valueOf(oldValue);
        }
        ...
        public Byte remove(Object ok) {
            byte oldValue = this.removeByte(ok);
            return Object2ByteAVLTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
        }
