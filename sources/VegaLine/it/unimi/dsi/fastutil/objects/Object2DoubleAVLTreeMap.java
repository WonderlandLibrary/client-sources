...
Cloneable {
    ...
    public Double put(K ok, Double ov) {
        double oldValue = this.put(ok, (double)ov);
    ...
    public Double remove(Object ok) {
        double oldValue = this.removeDouble(ok);
            ...
            this.entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>(){
                final Comparator<? super Object2DoubleMap.Entry<K>> comparator = new Comparator<Object2DoubleMap.Entry<K>>(){
                    ...
                    public int compare(Object2DoubleMap.Entry<K> x, Object2DoubleMap.Entry<K> y) {
                        return Object2DoubleAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>(){
                    ...
                    @Override
                    public Comparator<? super Object2DoubleMap.Entry<K>> comparator() {
                        return Object2DoubleAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Double get(Object ok) {
            Entry<Object> e;
            Object kk = ok;
            return this.in(kk) && (e = Object2DoubleAVLTreeMap.this.findKey(kk)) != null ? e.getValue() : null;
        }
        ...
        @Deprecated
        public Double put(K ok, Double ov) {
            double oldValue = this.put((K)ok, (double)ov);
            return Object2DoubleAVLTreeMap.this.modified ? null : Double.valueOf(oldValue);
        }
        ...
        public Double remove(Object ok) {
            double oldValue = this.removeDouble(ok);
            return Object2DoubleAVLTreeMap.this.modified ? Double.valueOf(oldValue) : null;
        }
