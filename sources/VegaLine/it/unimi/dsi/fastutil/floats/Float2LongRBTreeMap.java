...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof FloatComparator ? (FloatComparator)this.storedComparator : new FloatComparator(){
            ...
            public int compare(float k1, float k2) {
                return Float2LongRBTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
            }

            @Override
            public int compare(Float ok1, Float ok2) {
                return Float2LongRBTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Long put(Float ok, Long ov) {
        long oldValue = this.put(ok.floatValue(), (long)ov);
    ...
    public Long remove(Object ok) {
        long oldValue = this.remove(((Float)ok).floatValue());
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2LongMap.Entry>(){
                final Comparator<? super Float2LongMap.Entry> comparator = new Comparator<Float2LongMap.Entry>(){
                    ...
                    @Override
                    public int compare(Float2LongMap.Entry x, Float2LongMap.Entry y) {
    ...
    implements Serializable {
        ...
        public Long put(Float ok, Long ov) {
            long oldValue = this.put(ok.floatValue(), (long)ov);
            return Float2LongRBTreeMap.this.modified ? null : Long.valueOf(oldValue);
        }
        ...
        public Long remove(Object ok) {
            long oldValue = this.remove(((Float)ok).floatValue());
            return Float2LongRBTreeMap.this.modified ? Long.valueOf(oldValue) : null;
        }
