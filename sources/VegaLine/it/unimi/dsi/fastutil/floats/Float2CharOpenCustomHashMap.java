...
Hash {
    ...
    implements CharIterator {
        ...
        public Character next() {
            return Character.valueOf(Float2CharOpenCustomHashMap.this.value[this.nextEntry()]);
        }
    }
    ...
    implements FloatIterator {
        ...
        @Override
        public Float next() {
            return Float.valueOf(Float2CharOpenCustomHashMap.this.key[this.nextEntry()]);
        }
    }
