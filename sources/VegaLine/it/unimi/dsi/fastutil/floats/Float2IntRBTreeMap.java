    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof FloatComparator ? (FloatComparator)this.storedComparator : new FloatComparator(){
            ...
            public int compare(float k1, float k2) {
                return Float2IntRBTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
            }
            ...
            this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>(){
                final Comparator<? super Float2IntMap.Entry> comparator = new Comparator<Float2IntMap.Entry>(){
                    ...
                    public int compare(Float2IntMap.Entry x, Float2IntMap.Entry y) {
                        return Float2IntRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                    }
                };
