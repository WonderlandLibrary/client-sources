...
Hash {
    ...
    implements Float2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Float.floatToIntBits(k) == 0) {
                return Float2DoubleOpenHashMap.this.containsNullKey && Float2DoubleOpenHashMap.this.value[Float2DoubleOpenHashMap.this.n] == v;
            }
            ...
            if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) {
                return Float2DoubleOpenHashMap.this.value[pos] == v;
            }
            do {
        ...
        public boolean rem(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Float.floatToIntBits(k) == 0) {
                if (Float2DoubleOpenHashMap.this.containsNullKey && Float2DoubleOpenHashMap.this.value[Float2DoubleOpenHashMap.this.n] == v) {
            ...
            if (Float.floatToIntBits(curr) == Float.floatToIntBits(k)) {
                if (Float2DoubleOpenHashMap.this.value[pos] == v) {
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2DoubleOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToIntBits(curr) != Float.floatToIntBits(k) || Float2DoubleOpenHashMap.this.value[pos] != v);
            Float2DoubleOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Float, Double> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToIntBits(Float2DoubleOpenHashMap.this.key[this.index]) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && Float2DoubleOpenHashMap.this.value[this.index] == (Double)e.getValue();
        }
