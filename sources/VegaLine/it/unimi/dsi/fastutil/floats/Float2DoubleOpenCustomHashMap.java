...
Hash {
    ...
    private int insert(float k, double v) {
        int pos;
    ...
    implements FloatIterator {
        ...
        @Override
        public Float next() {
            return Float.valueOf(Float2DoubleOpenCustomHashMap.this.key[this.nextEntry()]);
        }
    }
    ...
    implements Float2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                return Float2DoubleOpenCustomHashMap.this.containsNullKey && Float2DoubleOpenCustomHashMap.this.value[Float2DoubleOpenCustomHashMap.this.n] == v;
            }
            ...
            if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Float2DoubleOpenCustomHashMap.this.value[pos] == v;
            }
            do {
        ...
        public boolean rem(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                if (Float2DoubleOpenCustomHashMap.this.containsNullKey && Float2DoubleOpenCustomHashMap.this.value[Float2DoubleOpenCustomHashMap.this.n] == v) {
            ...
            if (Float2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Float2DoubleOpenCustomHashMap.this.value[pos] == v) {
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2DoubleOpenCustomHashMap.this.mask]) != 0) continue;
                return false;
            } while (!Float2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Float2DoubleOpenCustomHashMap.this.value[pos] != v);
            Float2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Float, Double> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float2DoubleOpenCustomHashMap.this.strategy.equals(Float2DoubleOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue()) && Float2DoubleOpenCustomHashMap.this.value[this.index] == (Double)e.getValue();
        }
