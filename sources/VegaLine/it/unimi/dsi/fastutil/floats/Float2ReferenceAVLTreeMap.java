...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof FloatComparator ? (FloatComparator)this.storedComparator : new FloatComparator(){
            ...
            public int compare(float k1, float k2) {
                return Float2ReferenceAVLTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
            }
    ...
    public V put(Float ok, V ov) {
        V oldValue = this.put(ok.floatValue(), ov);
    ...
    public V remove(Object ok) {
        V oldValue = this.remove(((Float)ok).floatValue());
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>(){
                final Comparator<? super Float2ReferenceMap.Entry<V>> comparator = new Comparator<Float2ReferenceMap.Entry<V>>(){
                    ...
                    @Override
                    public int compare(Float2ReferenceMap.Entry<V> x, Float2ReferenceMap.Entry<V> y) {
                        return Float2ReferenceAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                    }
                };
    ...
    private static <V> int checkTree(Entry<V> e) {
        return 0;
    }
    ...
    implements Serializable {
        ...
        @Deprecated
        public V put(Float ok, V ov) {
            Object oldValue = this.put(ok.floatValue(), (V)ov);
            return Float2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
        }
        ...
        @Deprecated
        public V remove(Object ok) {
            Object oldValue = this.remove(((Float)ok).floatValue());
            return Float2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
        }
