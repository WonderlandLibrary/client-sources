...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof FloatComparator ? (FloatComparator)this.storedComparator : new FloatComparator(){
            ...
            public int compare(float k1, float k2) {
                return Float2CharAVLTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
            }
    ...
    public Character put(Float ok, Character ov) {
        char oldValue = this.put(ok.floatValue(), ov.charValue());
    ...
    public Character remove(Object ok) {
        char oldValue = this.remove(((Float)ok).floatValue());
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2CharMap.Entry>(){
                final Comparator<? super Float2CharMap.Entry> comparator = new Comparator<Float2CharMap.Entry>(){
                    ...
                    @Override
                    public int compare(Float2CharMap.Entry x, Float2CharMap.Entry y) {
