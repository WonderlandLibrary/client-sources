...
FloatSortedSet {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof FloatComparator ? (FloatComparator)this.storedComparator : new FloatComparator(){
            ...
            public int compare(float k1, float k2) {
                return FloatAVLTreeSet.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
            }
    ...
    FloatSortedSet {
        ...
        public boolean rem(float k) {
            ...
            return FloatAVLTreeSet.this.rem(k);
        }
    ...
    extends AbstractFloatListIterator {
        ...
        public void remove() {
            ...
            this.updatePrevious();
            this.updateNext();
            FloatAVLTreeSet.this.rem(this.curr.key);
            this.curr = null;
        }
    }
