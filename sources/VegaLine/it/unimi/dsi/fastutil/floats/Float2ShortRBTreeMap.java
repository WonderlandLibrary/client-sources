    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof FloatComparator ? (FloatComparator)this.storedComparator : new FloatComparator(){
            ...
            public int compare(float k1, float k2) {
                return Float2ShortRBTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
            }
            ...
            this.entries = new AbstractObjectSortedSet<Float2ShortMap.Entry>(){
                final Comparator<? super Float2ShortMap.Entry> comparator = new Comparator<Float2ShortMap.Entry>(){
                    ...
                    public int compare(Float2ShortMap.Entry x, Float2ShortMap.Entry y) {
                        return Float2ShortRBTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                    }
                };
