...
Hash {
    ...
    implements FloatIterator {
        ...
        @Override
        public Float next() {
            return Float.valueOf(Float2ObjectOpenHashMap.this.key[this.nextEntry()]);
        }
    }
    ...
    implements Float2ObjectMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            Object v = e.getValue();
            if (Float.floatToIntBits(k) == 0) {
                return Float2ObjectOpenHashMap.this.containsNullKey && (Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n] == null ? v == null : Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n].equals(v));
            }
            ...
            if (Float.floatToIntBits(k) == Float.floatToIntBits(curr)) {
                return Float2ObjectOpenHashMap.this.value[pos] == null ? v == null : Float2ObjectOpenHashMap.this.value[pos].equals(v);
            }
            do {
        ...
        public boolean rem(Object o) {
            ...
            Object v = e.getValue();
            if (Float.floatToIntBits(k) == 0) {
                if (Float2ObjectOpenHashMap.this.containsNullKey && (Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n] == null ? v == null : Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n].equals(v))) {
            ...
            if (Float.floatToIntBits(curr) == Float.floatToIntBits(k)) {
                if (Float2ObjectOpenHashMap.this.value[pos] == null ? v == null : Float2ObjectOpenHashMap.this.value[pos].equals(v)) {
            ...
            do {
                if (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2ObjectOpenHashMap.this.mask]) != 0) continue;
                return false;
            } while (Float.floatToIntBits(curr) != Float.floatToIntBits(k) || !(Float2ObjectOpenHashMap.this.value[pos] == null ? v == null : Float2ObjectOpenHashMap.this.value[pos].equals(v)));
            Float2ObjectOpenHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Float, V> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Float.floatToIntBits(Float2ObjectOpenHashMap.this.key[this.index]) == Float.floatToIntBits(((Float)e.getKey()).floatValue()) && (Float2ObjectOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Float2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()));
        }
