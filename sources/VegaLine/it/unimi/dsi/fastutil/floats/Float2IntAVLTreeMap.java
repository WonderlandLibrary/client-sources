...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof FloatComparator ? (FloatComparator)this.storedComparator : new FloatComparator(){
            ...
            public int compare(float k1, float k2) {
                return Float2IntAVLTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
            }

            @Override
            public int compare(Float ok1, Float ok2) {
                return Float2IntAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Integer put(Float ok, Integer ov) {
        int oldValue = this.put(ok.floatValue(), (int)ov);
    ...
    public Integer remove(Object ok) {
        int oldValue = this.remove(((Float)ok).floatValue());
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>(){
                final Comparator<? super Float2IntMap.Entry> comparator = new Comparator<Float2IntMap.Entry>(){
                    ...
                    @Override
                    public int compare(Float2IntMap.Entry x, Float2IntMap.Entry y) {
                        return Float2IntAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Float2IntMap.Entry> comparator() {
                        return Float2IntAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Integer put(Float ok, Integer ov) {
            int oldValue = this.put(ok.floatValue(), (int)ov);
            return Float2IntAVLTreeMap.this.modified ? null : Integer.valueOf(oldValue);
        }
        ...
        public Integer remove(Object ok) {
            int oldValue = this.remove(((Float)ok).floatValue());
            return Float2IntAVLTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
        }
