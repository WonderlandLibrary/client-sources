...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof FloatComparator ? (FloatComparator)this.storedComparator : new FloatComparator(){

            @Override
            public int compare(float k1, float k2) {
                return Float2FloatAVLTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
            }

            @Override
            public int compare(Float ok1, Float ok2) {
                return Float2FloatAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Float put(Float ok, Float ov) {
        float oldValue = this.put(ok.floatValue(), ov.floatValue());
    ...
    public Float remove(Object ok) {
        float oldValue = this.remove(((Float)ok).floatValue());
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>(){
                final Comparator<? super Float2FloatMap.Entry> comparator = new Comparator<Float2FloatMap.Entry>(){
                    ...
                    @Override
                    public int compare(Float2FloatMap.Entry x, Float2FloatMap.Entry y) {
                        return Float2FloatAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Float2FloatMap.Entry> comparator() {
                        return Float2FloatAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Float put(Float ok, Float ov) {
            float oldValue = this.put(ok.floatValue(), ov.floatValue());
            return Float2FloatAVLTreeMap.this.modified ? null : Float.valueOf(oldValue);
        }
        ...
        public Float remove(Object ok) {
            float oldValue = this.remove(((Float)ok).floatValue());
            return Float2FloatAVLTreeMap.this.modified ? Float.valueOf(oldValue) : null;
        }
        ...
        implements FloatListIterator {
            ...
            @Override
            public Float next() {
                return Float.valueOf(this.nextEntry().value);
            }

            @Override
            public Float previous() {
                return Float.valueOf(this.previousEntry().value);
            }
        ...
        implements FloatListIterator {
            ...
            @Override
            public Float next() {
                return Float.valueOf(this.nextEntry().key);
            }

            @Override
            public Float previous() {
                return Float.valueOf(this.previousEntry().key);
            }
