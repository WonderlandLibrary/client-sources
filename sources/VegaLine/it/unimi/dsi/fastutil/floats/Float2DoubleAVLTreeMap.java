...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof FloatComparator ? (FloatComparator)this.storedComparator : new FloatComparator(){
            ...
            public int compare(float k1, float k2) {
                return Float2DoubleAVLTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
            }

            @Override
            public int compare(Float ok1, Float ok2) {
                return Float2DoubleAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Double put(Float ok, Double ov) {
        double oldValue = this.put(ok.floatValue(), (double)ov);
    ...
    public Double remove(Object ok) {
        double oldValue = this.remove(((Float)ok).floatValue());
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Float2DoubleMap.Entry> float2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Float2DoubleMap.Entry> comparator() {
                        return Float2DoubleAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Double put(Float ok, Double ov) {
            double oldValue = this.put(ok.floatValue(), (double)ov);
            return Float2DoubleAVLTreeMap.this.modified ? null : Double.valueOf(oldValue);
        }
        ...
        public Double remove(Object ok) {
            double oldValue = this.remove(((Float)ok).floatValue());
            return Float2DoubleAVLTreeMap.this.modified ? Double.valueOf(oldValue) : null;
        }
