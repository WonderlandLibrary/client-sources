...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof FloatComparator ? (FloatComparator)this.storedComparator : new FloatComparator(){
            ...
            public int compare(float k1, float k2) {
                return Float2BooleanRBTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
            }

            @Override
            public int compare(Float ok1, Float ok2) {
                return Float2BooleanRBTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Boolean put(Float ok, Boolean ov) {
        boolean oldValue = this.put(ok.floatValue(), (boolean)ov);
    ...
    public Boolean remove(Object ok) {
        boolean oldValue = this.remove(((Float)ok).floatValue());
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2BooleanMap.Entry>(){
                final Comparator<? super Float2BooleanMap.Entry> comparator = new Comparator<Float2BooleanMap.Entry>(){
                    ...
                    @Override
                    public int compare(Float2BooleanMap.Entry x, Float2BooleanMap.Entry y) {
    ...
    implements Serializable {
        ...
        public Boolean put(Float ok, Boolean ov) {
            boolean oldValue = this.put(ok.floatValue(), (boolean)ov);
            return Float2BooleanRBTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
        }
        ...
        public Boolean remove(Object ok) {
            boolean oldValue = this.remove(((Float)ok).floatValue());
            return Float2BooleanRBTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
        }
