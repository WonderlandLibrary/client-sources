...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof FloatComparator ? (FloatComparator)this.storedComparator : new FloatComparator(){
            ...
            public int compare(float k1, float k2) {
                return Float2FloatRBTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
            }

            @Override
            public int compare(Float ok1, Float ok2) {
                return Float2FloatRBTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    implements Serializable {
        ...
        public Float put(Float ok, Float ov) {
            float oldValue = this.put(ok.floatValue(), ov.floatValue());
            return Float2FloatRBTreeMap.this.modified ? null : Float.valueOf(oldValue);
        }
        ...
        public Float remove(Object ok) {
            float oldValue = this.remove(((Float)ok).floatValue());
            return Float2FloatRBTreeMap.this.modified ? Float.valueOf(oldValue) : null;
        }
