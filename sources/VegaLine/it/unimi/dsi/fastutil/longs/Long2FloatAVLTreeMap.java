...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof LongComparator ? (LongComparator)this.storedComparator : new LongComparator(){
            ...
            public int compare(long k1, long k2) {
                return Long2FloatAVLTreeMap.this.storedComparator.compare((Long)k1, (Long)k2);
            }
    ...
    public Float put(Long ok, Float ov) {
        float oldValue = this.put((long)ok, ov.floatValue());
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>(){
                final Comparator<? super Long2FloatMap.Entry> comparator = new Comparator<Long2FloatMap.Entry>(){
                    ...
                    @Override
                    public int compare(Long2FloatMap.Entry x, Long2FloatMap.Entry y) {
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Long2FloatMap.Entry> comparator() {
                        return Long2FloatAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Float put(Long ok, Float ov) {
            float oldValue = this.put((long)ok, ov.floatValue());
            return Long2FloatAVLTreeMap.this.modified ? null : Float.valueOf(oldValue);
        }
        ...
        public Float remove(Object ok) {
            float oldValue = this.remove((Long)ok);
            return Long2FloatAVLTreeMap.this.modified ? Float.valueOf(oldValue) : null;
        }
