...
LongSortedSet {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof LongComparator ? (LongComparator)this.storedComparator : new LongComparator(){
            ...
            public int compare(long k1, long k2) {
                return LongAVLTreeSet.this.storedComparator.compare((Long)k1, (Long)k2);
            }

            @Override
            public int compare(Long ok1, Long ok2) {
                return LongAVLTreeSet.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    LongSortedSet {
        ...
        public boolean rem(long k) {
            ...
            return LongAVLTreeSet.this.rem(k);
        }
    ...
    extends AbstractLongListIterator {
        ...
        public void remove() {
            ...
            this.updatePrevious();
            this.updateNext();
            LongAVLTreeSet.this.rem(this.curr.key);
            this.curr = null;
        }
    }
