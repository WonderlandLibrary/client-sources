...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof LongComparator ? (LongComparator)this.storedComparator : new LongComparator(){
            ...
            public int compare(long k1, long k2) {
                return Long2CharRBTreeMap.this.storedComparator.compare((Long)k1, (Long)k2);
            }

            @Override
            public int compare(Long ok1, Long ok2) {
                return Long2CharRBTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Character put(Long ok, Character ov) {
        char oldValue = this.put((long)ok, ov.charValue());
    ...
    public Character remove(Object ok) {
        char oldValue = this.remove((Long)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2CharMap.Entry>(){
                final Comparator<? super Long2CharMap.Entry> comparator = new Comparator<Long2CharMap.Entry>(){
                    ...
                    @Override
                    public int compare(Long2CharMap.Entry x, Long2CharMap.Entry y) {
                        return Long2CharRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public Character put(Long ok, Character ov) {
            char oldValue = this.put((long)ok, ov.charValue());
            return Long2CharRBTreeMap.this.modified ? null : Character.valueOf(oldValue);
        }
        ...
        public Character remove(Object ok) {
            char oldValue = this.remove((Long)ok);
            return Long2CharRBTreeMap.this.modified ? Character.valueOf(oldValue) : null;
        }
