...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof LongComparator ? (LongComparator)this.storedComparator : new LongComparator(){
            ...
            public int compare(long k1, long k2) {
                return Long2BooleanAVLTreeMap.this.storedComparator.compare((Long)k1, (Long)k2);
            }

            @Override
            public int compare(Long ok1, Long ok2) {
                return Long2BooleanAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Boolean put(Long ok, Boolean ov) {
        boolean oldValue = this.put((long)ok, (boolean)ov);
    ...
    public Boolean remove(Object ok) {
        boolean oldValue = this.remove((Long)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry>(){
                final Comparator<? super Long2BooleanMap.Entry> comparator = new Comparator<Long2BooleanMap.Entry>(){
                    ...
                    @Override
                    public int compare(Long2BooleanMap.Entry x, Long2BooleanMap.Entry y) {
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Long2BooleanMap.Entry> comparator() {
                        return Long2BooleanAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Boolean put(Long ok, Boolean ov) {
            boolean oldValue = this.put((long)ok, (boolean)ov);
            return Long2BooleanAVLTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
        }
        ...
        public Boolean remove(Object ok) {
            boolean oldValue = this.remove((Long)ok);
            return Long2BooleanAVLTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
        }
