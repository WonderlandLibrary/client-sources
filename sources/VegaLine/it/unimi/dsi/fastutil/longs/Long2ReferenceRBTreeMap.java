    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof LongComparator ? (LongComparator)this.storedComparator : new LongComparator(){
            ...
            public int compare(long k1, long k2) {
                return Long2ReferenceRBTreeMap.this.storedComparator.compare((Long)k1, (Long)k2);
            }
            ...
            this.entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>(){
                final Comparator<? super Long2ReferenceMap.Entry<V>> comparator = new Comparator<Long2ReferenceMap.Entry<V>>(){
                    ...
                    public int compare(Long2ReferenceMap.Entry<V> x, Long2ReferenceMap.Entry<V> y) {
                        return Long2ReferenceRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                    }
                };
