...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof LongComparator ? (LongComparator)this.storedComparator : new LongComparator(){
            ...
            public int compare(long k1, long k2) {
                return Long2ShortRBTreeMap.this.storedComparator.compare((Long)k1, (Long)k2);
            }
    ...
    public Short put(Long ok, Short ov) {
        short oldValue = this.put((long)ok, (short)ov);
    ...
    public Short remove(Object ok) {
        short oldValue = this.remove((Long)ok);
            ...
            this.entries = new AbstractObjectSortedSet<Long2ShortMap.Entry>(){
                final Comparator<? super Long2ShortMap.Entry> comparator = new Comparator<Long2ShortMap.Entry>(){
                    ...
                    public int compare(Long2ShortMap.Entry x, Long2ShortMap.Entry y) {
                        return Long2ShortRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                    }
                };
