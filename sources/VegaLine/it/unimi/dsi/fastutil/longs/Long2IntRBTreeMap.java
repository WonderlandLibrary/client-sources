...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof LongComparator ? (LongComparator)this.storedComparator : new LongComparator(){
            ...
            public int compare(long k1, long k2) {
                return Long2IntRBTreeMap.this.storedComparator.compare((Long)k1, (Long)k2);
            }
    ...
    implements Serializable {
        ...
        public Integer put(Long ok, Integer ov) {
            int oldValue = this.put((long)ok, (int)ov);
            return Long2IntRBTreeMap.this.modified ? null : Integer.valueOf(oldValue);
        }
        ...
        public Integer remove(Object ok) {
            int oldValue = this.remove((Long)ok);
            return Long2IntRBTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
        }
