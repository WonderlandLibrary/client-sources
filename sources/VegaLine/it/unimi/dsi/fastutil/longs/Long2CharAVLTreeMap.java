...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof LongComparator ? (LongComparator)this.storedComparator : new LongComparator(){
            ...
            public int compare(long k1, long k2) {
                return Long2CharAVLTreeMap.this.storedComparator.compare((Long)k1, (Long)k2);
            }

            @Override
            public int compare(Long ok1, Long ok2) {
                return Long2CharAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2CharMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Long2CharMap.Entry> comparator() {
                        return Long2CharAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Character put(Long ok, Character ov) {
            char oldValue = this.put((long)ok, ov.charValue());
            return Long2CharAVLTreeMap.this.modified ? null : Character.valueOf(oldValue);
        }
        ...
        public Character remove(Object ok) {
            char oldValue = this.remove((Long)ok);
            return Long2CharAVLTreeMap.this.modified ? Character.valueOf(oldValue) : null;
        }
