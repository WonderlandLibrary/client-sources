...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof LongComparator ? (LongComparator)this.storedComparator : new LongComparator(){
            ...
            public int compare(long k1, long k2) {
                return Long2ObjectAVLTreeMap.this.storedComparator.compare((Long)k1, (Long)k2);
            }

            @Override
            public int compare(Long ok1, Long ok2) {
                return Long2ObjectAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public V put(Long ok, V ov) {
        V oldValue = this.put((long)ok, ov);
    ...
    public V remove(Object ok) {
        V oldValue = this.remove((Long)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>(){
                final Comparator<? super Long2ObjectMap.Entry<V>> comparator = new Comparator<Long2ObjectMap.Entry<V>>(){
                    ...
                    @Override
                    public int compare(Long2ObjectMap.Entry<V> x, Long2ObjectMap.Entry<V> y) {
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>(){
                    ...
                    @Override
                    public Comparator<? super Long2ObjectMap.Entry<V>> comparator() {
                        return Long2ObjectAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        @Deprecated
        public V put(Long ok, V ov) {
            Object oldValue = this.put((long)ok, (V)ov);
            return Long2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
        }
