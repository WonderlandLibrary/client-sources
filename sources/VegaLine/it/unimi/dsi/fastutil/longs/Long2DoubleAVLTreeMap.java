...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof LongComparator ? (LongComparator)this.storedComparator : new LongComparator(){
            ...
            public int compare(long k1, long k2) {
                return Long2DoubleAVLTreeMap.this.storedComparator.compare((Long)k1, (Long)k2);
            }

            @Override
            public int compare(Long ok1, Long ok2) {
                return Long2DoubleAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Double put(Long ok, Double ov) {
        double oldValue = this.put((long)ok, (double)ov);
    ...
    public Double remove(Object ok) {
        double oldValue = this.remove((Long)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>(){
                final Comparator<? super Long2DoubleMap.Entry> comparator = new Comparator<Long2DoubleMap.Entry>(){
                    ...
                    @Override
                    public int compare(Long2DoubleMap.Entry x, Long2DoubleMap.Entry y) {
                        return Long2DoubleAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Long2DoubleMap.Entry> comparator() {
                        return Long2DoubleAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Double put(Long ok, Double ov) {
            double oldValue = this.put((long)ok, (double)ov);
            return Long2DoubleAVLTreeMap.this.modified ? null : Double.valueOf(oldValue);
        }
        ...
        public Double remove(Object ok) {
            double oldValue = this.remove((Long)ok);
            return Long2DoubleAVLTreeMap.this.modified ? Double.valueOf(oldValue) : null;
        }
