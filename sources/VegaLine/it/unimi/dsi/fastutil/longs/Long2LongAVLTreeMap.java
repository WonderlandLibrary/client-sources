...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof LongComparator ? (LongComparator)this.storedComparator : new LongComparator(){
            ...
            public int compare(long k1, long k2) {
                return Long2LongAVLTreeMap.this.storedComparator.compare((Long)k1, (Long)k2);
            }

            @Override
            public int compare(Long ok1, Long ok2) {
                return Long2LongAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Long put(Long ok, Long ov) {
        long oldValue = this.put((long)ok, (long)ov);
    ...
    public Long remove(Object ok) {
        long oldValue = this.remove((Long)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2LongMap.Entry>(){
                final Comparator<? super Long2LongMap.Entry> comparator = new Comparator<Long2LongMap.Entry>(){
                    ...
                    @Override
                    public int compare(Long2LongMap.Entry x, Long2LongMap.Entry y) {
                        return Long2LongAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2LongMap.Entry>(){
                    ...
                    @Override
                    public Comparator<? super Long2LongMap.Entry> comparator() {
                        return Long2LongAVLTreeMap.this.entrySet().comparator();
                    }
        ...
        public Long put(Long ok, Long ov) {
            long oldValue = this.put((long)ok, (long)ov);
            return Long2LongAVLTreeMap.this.modified ? null : Long.valueOf(oldValue);
        }
        ...
        public Long remove(Object ok) {
            long oldValue = this.remove((Long)ok);
            return Long2LongAVLTreeMap.this.modified ? Long.valueOf(oldValue) : null;
        }
