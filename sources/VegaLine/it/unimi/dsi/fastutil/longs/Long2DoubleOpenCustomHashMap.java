...
Hash {
    ...
    implements Long2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Long2DoubleOpenCustomHashMap.this.strategy.equals(k, 0L)) {
                return Long2DoubleOpenCustomHashMap.this.containsNullKey && Long2DoubleOpenCustomHashMap.this.value[Long2DoubleOpenCustomHashMap.this.n] == v;
            }
            ...
            if (Long2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                return Long2DoubleOpenCustomHashMap.this.value[pos] == v;
            }
            do {
        ...
        public boolean rem(Object o) {
            ...
            double v = (Double)e.getValue();
            if (Long2DoubleOpenCustomHashMap.this.strategy.equals(k, 0L)) {
                if (Long2DoubleOpenCustomHashMap.this.containsNullKey && Long2DoubleOpenCustomHashMap.this.value[Long2DoubleOpenCustomHashMap.this.n] == v) {
            ...
            if (Long2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                if (Long2DoubleOpenCustomHashMap.this.value[pos] == v) {
            ...
            do {
                if ((curr = key[pos = pos + 1 & Long2DoubleOpenCustomHashMap.this.mask]) != 0L) continue;
                return false;
            } while (!Long2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) || Long2DoubleOpenCustomHashMap.this.value[pos] != v);
            Long2DoubleOpenCustomHashMap.this.removeEntry(pos);
            return true;
        }
    ...
    Map.Entry<Long, Double> {
        ...
        public boolean equals(Object o) {
            ...
            Map.Entry e = (Map.Entry)o;
            return Long2DoubleOpenCustomHashMap.this.strategy.equals(Long2DoubleOpenCustomHashMap.this.key[this.index], (Long)e.getKey()) && Long2DoubleOpenCustomHashMap.this.value[this.index] == (Double)e.getValue();
        }
