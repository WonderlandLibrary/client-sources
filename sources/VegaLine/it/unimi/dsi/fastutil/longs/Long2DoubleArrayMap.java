    ...
    implements Long2DoubleMap.FastEntrySet {
        ...
        public ObjectIterator<Long2DoubleMap.Entry> fastIterator() {
            return new AbstractObjectIterator<Long2DoubleMap.Entry>(){
                int next = 0;
                int curr = -1;
                final AbstractLong2DoubleMap.BasicEntry entry = new AbstractLong2DoubleMap.BasicEntry(0L, 0.0);
        ...
        public boolean contains(Object o) {
            ...
            return Long2DoubleArrayMap.this.containsKey(k) && Long2DoubleArrayMap.this.get(k) == ((Double)e.getValue()).doubleValue();
        }
