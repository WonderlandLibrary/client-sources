    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof LongComparator ? (LongComparator)this.storedComparator : new LongComparator(){
            ...
            public int compare(long k1, long k2) {
                return Long2ReferenceAVLTreeMap.this.storedComparator.compare((Long)k1, (Long)k2);
            }

            @Override
            public int compare(Long ok1, Long ok2) {
                return Long2ReferenceAVLTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
        ...
        public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>(){
                    ...
                    @Override
                    public Comparator<? super Long2ReferenceMap.Entry<V>> comparator() {
                        return Long2ReferenceAVLTreeMap.this.entrySet().comparator();
                    }
