...
Cloneable {
    ...
    private void setActualComparator() {
        this.actualComparator = this.storedComparator == null || this.storedComparator instanceof LongComparator ? (LongComparator)this.storedComparator : new LongComparator(){
            ...
            public int compare(long k1, long k2) {
                return Long2ByteRBTreeMap.this.storedComparator.compare((Long)k1, (Long)k2);
            }

            @Override
            public int compare(Long ok1, Long ok2) {
                return Long2ByteRBTreeMap.this.storedComparator.compare(ok1, ok2);
            }
        };
    }
    ...
    public Byte put(Long ok, Byte ov) {
        byte oldValue = this.put((long)ok, (byte)ov);
    ...
    public Byte remove(Object ok) {
        byte oldValue = this.remove((Long)ok);
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>(){
                final Comparator<? super Long2ByteMap.Entry> comparator = new Comparator<Long2ByteMap.Entry>(){
                    ...
                    @Override
                    public int compare(Long2ByteMap.Entry x, Long2ByteMap.Entry y) {
                        return Long2ByteRBTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
                    }
                };
    ...
    implements Serializable {
        ...
        public Byte put(Long ok, Byte ov) {
            byte oldValue = this.put((long)ok, (byte)ov);
            return Long2ByteRBTreeMap.this.modified ? null : Byte.valueOf(oldValue);
        }
        ...
        public Byte remove(Object ok) {
            byte oldValue = this.remove((Long)ok);
            return Long2ByteRBTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
        }
