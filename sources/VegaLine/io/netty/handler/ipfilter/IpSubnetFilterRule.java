...
implements IpFilterRule {
    ...
    implements IpFilterRule {
        ...
        @Override
        public boolean matches(InetSocketAddress remoteAddress) {
            BigInteger ipAddress = Ip6SubnetFilterRule.ipToInt((Inet6Address)remoteAddress.getAddress());
    ...
    implements IpFilterRule {
        ...
        @Override
        public boolean matches(InetSocketAddress remoteAddress) {
            int ipAddress = Ip4SubnetFilterRule.ipToInt((Inet4Address)remoteAddress.getAddress());
