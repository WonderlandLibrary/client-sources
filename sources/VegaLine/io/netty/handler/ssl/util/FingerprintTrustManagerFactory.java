...
extends SimpleTrustManagerFactory {
    ...
    private final TrustManager tm = new X509TrustManager(){
        ...
        private void checkTrusted(String type2, X509Certificate[] chain) throws CertificateException {
            ...
            if (!found) {
                throw new CertificateException(type2 + " certificate with unknown fingerprint: " + cert.getSubjectDN());
            }
        }
