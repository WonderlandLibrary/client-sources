...
implements Http2Connection {
    ...
    implements Http2Stream {
        ...
        @Override
        public boolean isResetSent() {
            return (this.sentState & 1) != 0;
        }

        @Override
        public Http2Stream resetSent() {
            this.sentState = (byte)(this.sentState | 1);
            return this;
        }

        @Override
        public Http2Stream headersSent() {
            this.sentState = (byte)(this.sentState | 2);
            return this;
        }

        @Override
        public boolean isHeadersSent() {
            return (this.sentState & 2) != 0;
        }

        @Override
        public Http2Stream pushPromiseSent() {
            this.sentState = (byte)(this.sentState | 4);
            return this;
        }

        @Override
        public boolean isPushPromiseSent() {
            return (this.sentState & 4) != 0;
        }
