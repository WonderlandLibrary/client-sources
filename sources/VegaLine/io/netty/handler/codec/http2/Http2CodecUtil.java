...
public final class Http2CodecUtil {
    ...
    public static void writeFrameHeader(ByteBuf out, int payloadLength, byte type2, Http2Flags flags, int streamId) {
        out.ensureWritable(9 + payloadLength);
        Http2CodecUtil.writeFrameHeaderInternal(out, payloadLength, type2, flags, streamId);
    }
    ...
    static void writeFrameHeaderInternal(ByteBuf out, int payloadLength, byte type2, Http2Flags flags, int streamId) {
