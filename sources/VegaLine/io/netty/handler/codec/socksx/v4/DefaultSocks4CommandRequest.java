...
implements Socks4CommandRequest {
    ...
    public DefaultSocks4CommandRequest(Socks4CommandType type2, String dstAddr, int dstPort) {
        this(type2, dstAddr, dstPort, "");
    }

    public DefaultSocks4CommandRequest(Socks4CommandType type2, String dstAddr, int dstPort, String userId) {
        if (type2 == null) {
