...
extends ByteToMessageDecoder {
    ...
    private void fail(ChannelHandlerContext ctx, String errMsg, Throwable t) {
        this.finished = true;
        ctx.close();
        HAProxyProtocolException ppex = errMsg != null && t != null ? new HAProxyProtocolException(errMsg, t) : (errMsg != null ? new HAProxyProtocolException(errMsg) : (t != null ? new HAProxyProtocolException(t) : new HAProxyProtocolException()));
        throw ppex;
    }
