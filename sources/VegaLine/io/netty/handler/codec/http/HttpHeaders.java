...
implements Iterable<Map.Entry<String, String>> {
    ...
    public boolean contains(String name, String value, boolean ignoreCase) {
        ...
        for (String v : values) {
            if (!(ignoreCase ? v.equalsIgnoreCase(value) : v.equals(value))) continue;
            return true;
        }
        return false;
    }
    ...
    public boolean containsValue(CharSequence name, CharSequence value, boolean ignoreCase) {
        ...
        for (String v : values) {
            if (!HttpHeaders.contains(v, value, ignoreCase)) continue;
            return true;
        }
        return false;
    }
    ...
    private static boolean contains(String value, CharSequence expected, boolean ignoreCase) {
        ...
        if (ignoreCase) {
            for (String s : parts) {
                if (!AsciiString.contentEqualsIgnoreCase(expected, s.trim())) continue;
                return true;
            }
        } else {
            for (String s : parts) {
                if (!AsciiString.contentEquals(expected, s.trim())) continue;
                return true;
            }
        }
        return false;
