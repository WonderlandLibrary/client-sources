...
extends MessageToMessageEncoder<MqttMessage> {
    ...
    private static ByteBuf encodeConnectMessage(ByteBufAllocator byteBufAllocator, MqttConnectMessage message) {
        ...
        byte[] byArray = willMessageBytes = willMessage != null ? MqttEncoder.encodeStringUtf8(willMessage) : EmptyArrays.EMPTY_BYTES;
        ...
        byte[] byArray3 = passwordBytes = (password = payload.password()) != null ? MqttEncoder.encodeStringUtf8(password) : EmptyArrays.EMPTY_BYTES;
