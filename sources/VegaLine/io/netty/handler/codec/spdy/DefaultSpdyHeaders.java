...
implements SpdyHeaders {
    private static final DefaultHeaders.NameValidator<CharSequence> SpydNameValidator = new DefaultHeaders.NameValidator<CharSequence>(){
    ...
    public DefaultSpdyHeaders(boolean validate) {
        super(AsciiString.CASE_INSENSITIVE_HASHER, validate ? HeaderValueConverterAndValidator.INSTANCE : CharSequenceValueConverter.INSTANCE, validate ? SpydNameValidator : DefaultHeaders.NameValidator.NOT_NULL);
    }
