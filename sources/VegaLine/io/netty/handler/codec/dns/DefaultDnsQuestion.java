...
implements DnsQuestion {
    public DefaultDnsQuestion(String name, DnsRecordType type2) {
        super(name, type2, 0L);
    }

    public DefaultDnsQuestion(String name, DnsRecordType type2, int dnsClass) {
        super(name, type2, dnsClass, 0L);
    }
