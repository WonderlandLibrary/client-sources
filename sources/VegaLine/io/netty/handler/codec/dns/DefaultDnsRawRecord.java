...
implements DnsRawRecord {
    ...
    public DefaultDnsRawRecord(String name, DnsRecordType type2, long timeToLive, ByteBuf content) {
        this(name, type2, 1, timeToLive, content);
    }

    public DefaultDnsRawRecord(String name, DnsRecordType type2, int dnsClass, long timeToLive, ByteBuf content) {
        super(name, type2, dnsClass, timeToLive);
