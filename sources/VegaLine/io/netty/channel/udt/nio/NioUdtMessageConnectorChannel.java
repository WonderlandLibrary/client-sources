...
implements UdtChannel {
    ...
    public NioUdtMessageConnectorChannel(TypeUDT type2) {
        this(NioUdtProvider.newConnectorChannelUDT(type2));
    }
    ...
    protected void doBind(SocketAddress localAddress) throws Exception {
        SocketUtils.bind((SocketChannel)this.javaChannel(), localAddress);
    }
