    ...
    private Selector openSelector() {
        ...
        if (!(maybeSelectorImplClass instanceof Class) || !((Class)maybeSelectorImplClass).isAssignableFrom(this.unwrappedSelector.getClass())) {
            if (maybeSelectorImplClass instanceof Throwable) {
                ...
                logger.trace("failed to instrument a special java.util.Set into: {}", (Object)this.unwrappedSelector, (Object)t);
            }
            return this.unwrappedSelector;
        }
        ...
        if (maybeException instanceof Exception) {
            ...
            logger.trace("failed to instrument a special java.util.Set into: {}", (Object)this.unwrappedSelector, (Object)e);
            return this.unwrappedSelector;
        }
