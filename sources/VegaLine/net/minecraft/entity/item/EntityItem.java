...
extends Entity {
    ...
    public double fix = MathUtils.getRandomInRange(-0.0025, 0.0025);
    ...
    public void onUpdate() {
        if (this.getEntityItem().func_190926_b()) {
            ...
            float slipperiness = this.onGround ? this.world.getBlockState((BlockPos)new BlockPos((int)MathHelper.floor((double)this.posX), (int)(MathHelper.floor((double)this.getEntityBoundingBox().minY) - 1), (int)MathHelper.floor((double)this.posZ))).getBlock().slipperiness * 0.98f : 0.98f;
