...
extends EntityLivingBase {
    ...
    protected void updateEquipmentIfNeeded(EntityItem itemEntity) {
        ...
        if (flag && this.canEquipItem(itemstack)) {
            if (!itemstack1.func_190926_b() && (double)(this.rand.nextFloat() - 0.1f) < (switch (entityequipmentslot.getSlotType()) {
                case EntityEquipmentSlot.Type.HAND -> this.inventoryHandsDropChances[entityequipmentslot.getIndex()];
                case EntityEquipmentSlot.Type.ARMOR -> this.inventoryArmorDropChances[entityequipmentslot.getIndex()];
                default -> 0.0;
            })) {
