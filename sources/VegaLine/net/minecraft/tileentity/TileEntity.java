...
public abstract class TileEntity {
    ...
    public double getDistanceToTileEntity(TileEntity tileEntityIn) {
        int f = this.getPos().getX() - tileEntityIn.getPos().getX();
        int f1 = this.getPos().getY() - tileEntityIn.getPos().getY();
        int f2 = this.getPos().getZ() - tileEntityIn.getPos().getZ();
