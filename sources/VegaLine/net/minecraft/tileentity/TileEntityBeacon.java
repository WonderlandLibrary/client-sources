...
ISidedInventory {
    ...
    public static final Set<Potion> VALID_EFFECTS = Sets.newHashSet();
    public final List<BeamSegment> beamSegments = Lists.newArrayList();
    ...
    public ItemStack payment = ItemStack.field_190927_a;
