...
extends MinecraftServer {
    ...
    @Override
    public void loadAllWorlds(String saveName, String worldNameIn, long seed, WorldType type2, String generatorOptions) {
    ...
    @Override
    public String shareToLAN(GameType type2, boolean allowCheats) {
        try {
            int i = -1;
            try {
            ...
            this.getPlayerList().setGameType(type2);
            ...
            Futures.getUnchecked(this.addScheduledTask(new Runnable(){
                ...
                public void run() {
                    for (EntityPlayerMP entityplayermp : Lists.newArrayList(IntegratedServer.this.getPlayerList().getPlayerList())) {
                        Minecraft cfr_ignored_0 = IntegratedServer.this.mc;
                        if (entityplayermp.getUniqueID().equals(Minecraft.player.getUniqueID())) continue;
