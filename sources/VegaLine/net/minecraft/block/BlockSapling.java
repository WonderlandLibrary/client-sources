...
implements IGrowable {
    ...
    private boolean isTwoByTwoOfType(World worldIn, BlockPos pos, int p_181624_3_, int p_181624_4_, BlockPlanks.EnumType type2) {
        return this.isTypeAt(worldIn, pos.add(p_181624_3_, 0, p_181624_4_), type2) && this.isTypeAt(worldIn, pos.add(p_181624_3_ + 1, 0, p_181624_4_), type2) && this.isTypeAt(worldIn, pos.add(p_181624_3_, 0, p_181624_4_ + 1), type2) && this.isTypeAt(worldIn, pos.add(p_181624_3_ + 1, 0, p_181624_4_ + 1), type2);
    }

    public boolean isTypeAt(World worldIn, BlockPos pos, BlockPlanks.EnumType type2) {
        IBlockState iblockstate = worldIn.getBlockState(pos);
        return iblockstate.getBlock() == this && iblockstate.getValue(TYPE) == type2;
    }
