...
public class Block {
    ...
    public static final AxisAlignedBB MATRIX_AIR_AABB = new AxisAlignedBB(0.0, 0.0, 0.0, 1.0, 0.99999, 1.0);
    @Nullable
    ...
    public static float blockModelAlphaMul() {
        return CaveFinder.findEnabled ? 0.3f : 1.0f;
    }
    ...
    public EnumBlockRenderType getRenderType(IBlockState state) {
        return Xray.enabled ? (Xray.gold && state.getBlock() == Blocks.GOLD_ORE || Xray.iron && state.getBlock() == Blocks.IRON_ORE || Xray.lapis && state.getBlock() == Blocks.LAPIS_ORE || Xray.diamond && state.getBlock() == Blocks.DIAMOND_ORE || Xray.redstone && state.getBlock() == Blocks.REDSTONE_ORE || Xray.emerald && state.getBlock() == Blocks.EMERALD_ORE || Xray.quartz && state.getBlock() == Blocks.QUARTZ_ORE || Xray.coal && state.getBlock() == Blocks.COAL_ORE ? EnumBlockRenderType.MODEL : EnumBlockRenderType.INVISIBLE) : EnumBlockRenderType.MODEL;
    }
    ...
    public boolean canCollideCheck(IBlockState state, boolean hitIfLiquid) {
        boolean ignoreInteract = NoInteract.get.actived && (!NoInteract.get.currentBooleanValue("OnlyWithAura") || HitAura.TARGET != null);
        Block block = state.getBlock();
        if (ignoreInteract && (Block.getIdFromBlock(block) == 96 || Block.getIdFromBlock(block) == 167 || Block.getIdFromBlock(block) == 54 || Block.getIdFromBlock(block) == 130 || Block.getIdFromBlock(block) == 146 || Block.getIdFromBlock(block) == 58 || Block.getIdFromBlock(block) == 64 || Block.getIdFromBlock(block) == 71 || Block.getIdFromBlock(block) == 193 || Block.getIdFromBlock(block) == 194 || Block.getIdFromBlock(block) == 195 || Block.getIdFromBlock(block) == 196 || Block.getIdFromBlock(block) == 197 || Block.getIdFromBlock(block) == 324 || Block.getIdFromBlock(block) == 330 || Block.getIdFromBlock(block) == 427 || Block.getIdFromBlock(block) == 428 || Block.getIdFromBlock(block) == 429 || Block.getIdFromBlock(block) == 430 || Block.getIdFromBlock(block) == 431 || Block.getIdFromBlock(block) == 154 || Block.getIdFromBlock(block) == 61 || Block.getIdFromBlock(block) == 23 || Block.getIdFromBlock(block) == 158 || Block.getIdFromBlock(block) == 145 || Block.getIdFromBlock(block) == 69 || Block.getIdFromBlock(block) == 107 || Block.getIdFromBlock(block) == 187 || Block.getIdFromBlock(block) == 186 || Block.getIdFromBlock(block) == 185 || Block.getIdFromBlock(block) == 184 || Block.getIdFromBlock(block) == 183 || Block.getIdFromBlock(block) == 107 || Block.getIdFromBlock(block) == 116 || Block.getIdFromBlock(block) == 84 || Block.getIdFromBlock(block) == 356 || Block.getIdFromBlock(block) == 404 || Block.getIdFromBlock(block) == 151 || Block.getIdFromBlock(block) == 25 || Block.getIdFromBlock(block) == 219 || Block.getIdFromBlock(block) == 220 || Block.getIdFromBlock(block) == 221 || Block.getIdFromBlock(block) == 222 || Block.getIdFromBlock(block) == 223 || Block.getIdFromBlock(block) == 224 || Block.getIdFromBlock(block) == 225 || Block.getIdFromBlock(block) == 226 || Block.getIdFromBlock(block) == 227 || Block.getIdFromBlock(block) == 228 || Block.getIdFromBlock(block) == 229 || Block.getIdFromBlock(block) == 230 || Block.getIdFromBlock(block) == 231 || Block.getIdFromBlock(block) == 232 || Block.getIdFromBlock(block) == 233 || Block.getIdFromBlock(block) == 234 || Block.getIdFromBlock(block) == 389 || Block.getIdFromBlock(block) == 379 || Block.getIdFromBlock(block) == 380 || Block.getIdFromBlock(block) == 138 || Block.getIdFromBlock(block) == 321 || Block.getIdFromBlock(block) == 323 || Block.getIdFromBlock(block) == 77 || Block.getIdFromBlock(block) == 143 || Block.getIdFromBlock(block) == 404 || Block.getIdFromBlock(block) == 379 || Block.getIdFromBlock(block) == 323)) {
            return false;
        }
    ...
    public void dropBlockAsItemWithChance(World worldIn, BlockPos pos, IBlockState state, float chance, int fortune) {
        if (!worldIn.isRemote) {
            ...
            for (int j = 0; j < i; ++j) {
                Item item;
                if (!(worldIn.rand.nextFloat() <= chance) || (item = this.getItemDropped(state, worldIn.rand, fortune)) == Items.air) continue;
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        EventPostPlace postPlaceEvent = new EventPostPlace(pos, stack);
        postPlaceEvent.call();
    }
