...
extends Block {
    ...
    public AxisAlignedBB getCollisionBoundingBox(IBlockState blockState, IBlockAccess worldIn, BlockPos pos) {
        ...
        if (mc.world != null && Minecraft.player != null && JesusSpeed.get.actived) {
            if (JesusSpeed.get.JesusMode.currentMode.equalsIgnoreCase("NcpNew") && !Minecraft.player.isInWater() && !Minecraft.player.isInLava()) {
            ...
            if (JesusSpeed.get.JesusMode.currentMode.equalsIgnoreCase("MatrixSolid3") && !JesusSpeed.canUp && !Minecraft.player.isCollidedHorizontally) {
                return new AxisAlignedBB(0.0, 0.0, 0.0, 1.0, JesusSpeed.distOfFall > 2.0 && Minecraft.player.isCollidedHorizontally ? 0.8 : 0.964000003039835, 1.0);
            }
            ...
            if (JesusSpeed.get.JesusMode.currentMode.equalsIgnoreCase("Matrix7.0.2") && Minecraft.player != null && !Minecraft.player.isInWater() && Minecraft.player.motionY < 0.0) {
