...
extends Vec3i {
    ...
    public double getDistanceToBlockPos(BlockPos pos2) {
        int dX = this.getX() - pos2.getX();
        int dY = this.getY() - pos2.getY();
        int dZ = this.getZ() - pos2.getZ();
        return Math.sqrt(dX * dX + dY * dY + dZ * dZ);
    }

    public double getDistanceToBlockPosXZ(BlockPos pos2) {
        int dX = this.getX() - pos2.getX();
        int dZ = this.getZ() - pos2.getZ();
