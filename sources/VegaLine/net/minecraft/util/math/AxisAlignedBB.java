...
public class AxisAlignedBB {
    ...
    public AxisAlignedBB addExpandXZ(double expand) {
        return new AxisAlignedBB(this.minX - expand, this.minY, this.minZ - expand, this.maxX + expand, this.maxY, this.maxZ + expand);
    }

    public AxisAlignedBB(BlockPos pos, float expandByY1) {
        this(pos.getX(), pos.getY(), pos.getZ(), pos.getX() + 1, (float)pos.getY() + expandByY1, pos.getZ() + 1);
    }
    ...
    public AxisAlignedBB offsetMinDown(double expand) {
        return new AxisAlignedBB(this.minX, this.minY - expand, this.minZ, this.maxX, this.maxY, this.maxZ);
    }

    public AxisAlignedBB maxYToMinY() {
        return new AxisAlignedBB(this.minX, this.minY, this.minZ, this.maxX, this.minY, this.maxZ);
    }

    public AxisAlignedBB maxYToMinY(double expandUPMax) {
        return new AxisAlignedBB(this.minX, this.minY, this.minZ, this.maxX, this.minY + expandUPMax, this.maxZ);
    }
