...
extends Particle {
    ...
    public void onUpdate() {
        ...
        this.setParticleTextureIndex((int)((float)this.textureIdx + ((float)(this.numAgingFrames - 1) - this.particleAge * (float)this.numAgingFrames / (float)this.particleMaxAge)));
