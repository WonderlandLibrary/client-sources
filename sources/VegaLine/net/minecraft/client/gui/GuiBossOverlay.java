...
extends Gui {
    ...
    public final Map<UUID, BossInfoClient> mapBossInfos = Maps.newLinkedHashMap();
    public static Map<UUID, BossInfoClient> mapBossInfos2 = Maps.newLinkedHashMap();
    ...
    public void renderBossHealth() {
        if (!(this.mapBossInfos.isEmpty() || NoRender.get.actived && NoRender.get.BossStatusBar.bValue)) {
