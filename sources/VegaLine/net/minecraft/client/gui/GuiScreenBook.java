...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        if (this.bookIsUnsigned) {
            this.buttonSign = this.addButton(new GuiButton(3, width / 2 - 100, 196, 98, 20, I18n.format("book.signButton", new Object[0])));
            this.buttonDone = this.addButton(new GuiButton(0, width / 2 + 2, 196, 98, 20, I18n.format("gui.done", new Object[0])));
            this.buttonFinalize = this.addButton(new GuiButton(5, width / 2 - 100, 196, 98, 20, I18n.format("book.finalizeButton", new Object[0])));
            this.buttonCancel = this.addButton(new GuiButton(4, width / 2 + 2, 196, 98, 20, I18n.format("gui.cancel", new Object[0])));
        } else {
            this.buttonDone = this.addButton(new GuiButton(0, width / 2 - 100, 196, 200, 20, I18n.format("gui.done", new Object[0])));
        }
        int i = (width - 192) / 2;
        int j = 2;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            ...
            if (this.bookIsUnsigned) {
                s = this.updateCount / 6 % 2 == 0 ? (String)s + TextFormatting.BLACK + "_" : (String)s + TextFormatting.GRAY + "_";
            }
            String s1 = I18n.format("book.editTitle", new Object[0]);
            int k = this.fontRendererObj.getStringWidth(s1);
            this.fontRendererObj.drawString(s1, i + 36 + (116 - k) / 2, 34.0, 0);
            int l = this.fontRendererObj.getStringWidth((String)s);
            this.fontRendererObj.drawString((String)s, i + 36 + (116 - l) / 2, 50.0, 0);
            String s2 = I18n.format("book.byAuthor", this.editingPlayer.getName());
            int i1 = this.fontRendererObj.getStringWidth(s2);
            this.fontRendererObj.drawString(TextFormatting.DARK_GRAY + s2, i + 36 + (116 - i1) / 2, 60.0, 0);
            ...
            if (this.bookIsUnsigned) {
                s5 = this.fontRendererObj.getBidiFlag() ? (String)s5 + "_" : (this.updateCount / 6 % 2 == 0 ? (String)s5 + TextFormatting.BLACK + "_" : (String)s5 + TextFormatting.GRAY + "_");
            } else if (this.cachedPage != this.currPage) {
                if (ItemWrittenBook.validBookTagContents(this.bookObj.getTagCompound())) {
                    try {
                        ITextComponent itextcomponent = ITextComponent.Serializer.jsonToComponent((String)s5);
            ...
            this.fontRendererObj.drawString(s4, i - j1 + 192 - 44, 18.0, 0);
            if (this.cachedComponents == null) {
                this.fontRendererObj.drawSplitString((String)s5, i + 36, 34, 116, 0);
            } else {
