...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiOptionButton(199, width / 2 - 155 + i % 2 * 160, height / 6 + 24 * (i >> 1), GameSettings.Options.MAIN_HAND, this.mc.gameSettings.getKeyBinding(GameSettings.Options.MAIN_HAND)));
        if (++i % 2 == 1) {
            ++i;
        }
