...
implements IProgressMeter {
    ...
    public void func_193029_f() {
        ...
        GuiButton guibutton = this.addButton(new GuiButton(2, width / 2 - 80, height - 52, 80, 20, I18n.format("stat.blocksButton", new Object[0])));
        GuiButton guibutton1 = this.addButton(new GuiButton(3, width / 2, height - 52, 80, 20, I18n.format("stat.itemsButton", new Object[0])));
        GuiButton guibutton2 = this.addButton(new GuiButton(4, width / 2 + 80, height - 52, 80, 20, I18n.format("stat.mobsButton", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            this.drawCenteredString(this.fontRendererObj, LOADING_STRINGS[(int)(Minecraft.getSystemTime() / 150L % (long)LOADING_STRINGS.length)], width / 2, height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 0xFFFFFF);
        } else {
    ...
    extends GuiSlot {
        public StatsGeneral(Minecraft p_i47553_2_) {
            super(p_i47553_2_, width, height, 32, height - 64, 10);
    ...
    extends GuiSlot {
        ...
        public StatsMobsList(Minecraft p_i47551_2_) {
            super(p_i47551_2_, width, height, 32, height - 64, ((GuiStats)GuiStats.this).fontRendererObj.FONT_HEIGHT * 4);
    ...
    extends GuiSlot {
        ...
        protected Stats(Minecraft p_i47550_2_) {
            super(p_i47550_2_, width, height, 32, height - 64, 20);
        ...
        protected void renderMouseHoverToolTip(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_) {
            ...
            String s;
            String s1;
            if (p_148213_1_ != null && !(s1 = I18n.format((s = (itemstack = new ItemStack(item = p_148213_1_.getItem())).getUnlocalizedName()) + ".name", new Object[0]).trim()).isEmpty()) {
