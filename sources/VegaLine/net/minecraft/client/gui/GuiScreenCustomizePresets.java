...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.select = this.addButton(new GuiButton(0, width / 2 - 102, height - 27, 100, 20, I18n.format("createWorld.customize.presets.select", new Object[0])));
    ...
    extends GuiSlot {
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
            ...
            GuiScreenCustomizePresets.this.export.setText(GuiScreenCustomizePresets.PRESETS.get((int)GuiScreenCustomizePresets.this.list.selected).settings.toString());
        }
        ...
        protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
            Info guiscreencustomizepresets$info = PRESETS.get(p_192637_1_);
