...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.serverResourcePacks = this.addButton(new GuiButton(2, width / 2 - 100, height / 4 + 72, I18n.format("addServer.resourcePack", new Object[0]) + ": " + this.serverData.getResourceMode().getMotd().getFormattedText()));
