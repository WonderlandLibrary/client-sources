...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.btnSelect = this.addButton(new GuiButton(0, width / 2 - 155, height - 28, 150, 20, I18n.format("createWorld.customize.presets.select", new Object[0])));
    ...
    extends GuiSlot {
        ...
        protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
            ...
            GuiFlatPresets.this.export.setText(GuiFlatPresets.FLAT_WORLD_PRESETS.get((int)GuiFlatPresets.this.list.selected).generatorInfo);
        }
        ...
        protected void func_192637_a(int p_192637_1_, int p_192637_2_, int p_192637_3_, int p_192637_4_, int p_192637_5_, int p_192637_6_, float p_192637_7_) {
            LayerItem guiflatpresets$layeritem = FLAT_WORLD_PRESETS.get(p_192637_1_);
