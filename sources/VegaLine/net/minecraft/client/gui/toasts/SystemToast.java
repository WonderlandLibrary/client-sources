...
implements IToast {
    ...
    public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_) {
        ...
        if (this.field_193661_e == null) {
            p_193653_1_.func_192989_b().fontRendererObj.drawString(this.field_193660_d, 18.0f, 12.0, -256);
        } else {
            p_193653_1_.func_192989_b().fontRendererObj.drawString(this.field_193660_d, 18.0f, 7.0, -256);
            p_193653_1_.func_192989_b().fontRendererObj.drawString(this.field_193661_e, 18.0f, 18.0, -1);
        }
