...
implements IToast {
    ...
    public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_) {
        ...
        if (displayinfo != null) {
            ...
            if (list.size() == 1) {
                p_193653_1_.func_192989_b().fontRendererObj.drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a(), new Object[0]), 30.0f, 7.0, i | 0xFF000000);
                p_193653_1_.func_192989_b().fontRendererObj.drawString(displayinfo.func_192297_a().getFormattedText(), 30.0f, 18.0, -1);
            } else {
                int j = 1500;
                float f = 300.0f;
                if (p_193653_2_ < 1500L) {
                    int k = MathHelper.floor(MathHelper.clamp((float)(1500L - p_193653_2_) / 300.0f, 0.0f, 1.0f) * 255.0f) << 24 | 0x4000000;
                    p_193653_1_.func_192989_b().fontRendererObj.drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a(), new Object[0]), 30.0f, 11.0, i | k);
                } else {
                    ...
                    for (String s : list) {
                        p_193653_1_.func_192989_b().fontRendererObj.drawString(s, 30.0f, l, 0xFFFFFF | i1);
