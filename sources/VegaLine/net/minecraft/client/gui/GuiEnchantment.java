...
extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.fontRendererObj.drawString(this.nameable.getDisplayName().getUnformattedText(), 12.0f, 5.0, 0x404040);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        for (int k = 0; k < 3; ++k) {
            ...
            if (l < 0 || i1 < 0 || l >= 108 || i1 >= 19) continue;
            if (!this.container.enchantItem(Minecraft.player, k)) continue;
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        i = (GuiEnchantment.width - this.xSize) / 2;
        j = (GuiEnchantment.height - this.ySize) / 2;
        ...
        f2 = this.oOpen + (this.open - this.oOpen) * partialTicks;
        ...
        f3 = this.oFlip + (this.flip - this.oFlip) * partialTicks + 0.25f;
        f4 = this.oFlip + (this.flip - this.oFlip) * partialTicks + 0.75f;
        ...
        GuiEnchantment.MODEL_BOOK.render(null, 0.0f, f3, f4, f2, 0.0f, 0.0625f);
        ...
        k = this.container.getLapisAmount();
        for (l = 0; l < 3; ++l) {
            block10: {
                i1 = i + 60;
                j1 = i1 + 20;
                this.zLevel = 0.0f;
                this.mc.getTextureManager().bindTexture(GuiEnchantment.ENCHANTMENT_TABLE_GUI_TEXTURE);
                k1 = this.container.enchantLevels[l];
                GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
                if (k1 == 0) {
                ...
                i2 = 6839882;
                if (k < l + 1) break block10;
                if (Minecraft.player.experienceLevel >= k1) ** GOTO lbl-1000
            }
