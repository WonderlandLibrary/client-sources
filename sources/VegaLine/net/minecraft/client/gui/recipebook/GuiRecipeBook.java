...
implements IRecipeUpdateListener {
    ...
    private void func_193003_g(boolean p_193003_1_) {
        ...
        if (!s.isEmpty()) {
            ObjectLinkedOpenHashSet<RecipeList> objectset = new ObjectLinkedOpenHashSet<RecipeList>(this.field_191888_F.func_193987_a(SearchTreeManager.field_194012_b).func_194038_a(s.toLowerCase(Locale.ROOT)));
    ...
    public void func_193957_d() {
        if (this.func_191878_b() && this.field_193966_v != Minecraft.player.inventory.func_194015_p()) {
            this.func_193942_g();
            this.field_193966_v = Minecraft.player.inventory.func_194015_p();
        }
    }
    ...
    public boolean func_191862_a(int p_191862_1_, int p_191862_2_, int p_191862_3_) {
        if (this.func_191878_b() && !Minecraft.player.isSpectator()) {
            if (this.field_193022_s.func_194196_a(p_191862_1_, p_191862_2_, p_191862_3_, (this.field_191904_o - 147) / 2 - this.field_191903_n, (this.field_191905_p - 166) / 2, 147, 166)) {
                ...
                if (irecipe != null && recipelist != null) {
                    ...
                    this.field_191915_z.func_192682_a();
                    this.field_191888_F.playerController.func_194338_a(Minecraft.player.openContainer.windowId, irecipe, GuiScreen.isShiftKeyDown(), Minecraft.player);
