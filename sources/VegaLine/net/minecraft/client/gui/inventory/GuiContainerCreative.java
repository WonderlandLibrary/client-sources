...
extends InventoryEffectRenderer {
    ...
    @Override
    public void handleMouseClick(@Nullable Slot slotIn, int slotId, int mouseButton, ClickType type2) {
        this.clearSearch = true;
        boolean flag = type2 == ClickType.QUICK_MOVE;
        ClickType clickType = type2 = slotId == -999 && type2 == ClickType.PICKUP ? ClickType.THROW : type2;
        if (slotIn == null && selectedTabIndex != CreativeTabs.INVENTORY.getTabIndex() && type2 != ClickType.QUICK_CRAFT) {
            ...
            if (slotIn == this.destroyItemSlot && flag) {
                ...
                if (slotIn == this.destroyItemSlot) {
                ...
                } else if (type2 == ClickType.THROW && slotIn != null && slotIn.getHasStack()) {
                ...
                } else if (type2 == ClickType.THROW && !Minecraft.player.inventory.getItemStack().func_190926_b()) {
                    ...
                    Minecraft.player.inventoryContainer.slotClick(slotIn == null ? slotId : ((CreativeSlot)slotIn).slot.slotNumber, mouseButton, type2, Minecraft.player);
                    Minecraft.player.inventoryContainer.detectAndSendChanges();
                }
            } else if (type2 != ClickType.QUICK_CRAFT && slotIn.inventory == basicInventory) {
                ...
                this.inventorySlots.slotClick(slotIn == null ? slotId : slotIn.slotNumber, mouseButton, type2, Minecraft.player);
                if (Container.getDragEvent(mouseButton) == 2) {
                    ...
                    } else if (type2 == ClickType.THROW && !itemstack3.func_190926_b()) {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (creativetabs.drawInForegroundOfTab()) {
            ...
            this.fontRendererObj.drawString(I18n.format(creativetabs.getTranslatedTabLabel(), new Object[0]), 8.0f, 6.0, 0x404040);
        }
    }
    ...
    protected void renderToolTip(ItemStack stack, int x, int y) {
        if (selectedTabIndex == CreativeTabs.SEARCH.getTabIndex()) {
            ...
            List<String> list = stack.getTooltip(Minecraft.player, this.mc.gameSettings.advancedItemTooltips ? ITooltipFlag.TooltipFlags.ADVANCED : ITooltipFlag.TooltipFlags.NORMAL);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (creativetabs == CreativeTabs.INVENTORY) {
            GuiInventory.drawEntityOnScreen(this.guiLeft + 88, this.guiTop + 45, 20.0f, this.guiLeft + 88 - mouseX, this.guiTop + 45 - 30 - mouseY, Minecraft.player);
        }
    }
