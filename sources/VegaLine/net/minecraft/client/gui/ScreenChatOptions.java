...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(200, width / 2 - 100, height / 6 + 144, I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.chatTitle, width / 2, 20, 0xFFFFFF);
