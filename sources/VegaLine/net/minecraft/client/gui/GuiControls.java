...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(200, width / 2 - 155 + 160, height - 29, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonReset = this.addButton(new GuiButton(201, width / 2 - 155, height - 29, 150, 20, I18n.format("controls.resetAll", new Object[0])));
