...
public class GameSettings {
    ...
    public GameSettings(Minecraft mcIn, File optionsFileIn) {
        ...
        this.keyBindings = ArrayUtils.addAll(new KeyBinding[]{this.keyBindAttack, this.keyBindUseItem, this.keyBindForward, keyBindLeft, this.keyBindBack, keyBindRight, this.keyBindJump, this.keyBindSneak, this.keyBindSprint, this.keyBindDrop, this.keyBindInventory, this.keyBindChat, this.keyBindPlayerList, this.keyBindPickBlock, this.keyBindCommand, this.keyBindScreenshot, this.keyBindTogglePerspective, this.keyBindSmoothCamera, this.keyBindFullscreen, this.keyBindSpectatorOutlines, this.keyBindSwapHands, this.field_193629_ap, this.field_193630_aq, this.field_194146_ao}, this.keyBindsHotbar);
    ...
    private String getKeyBindingOF(Options p_getKeyBindingOF_1_) {
        ...
        Object object = s = s == null ? p_getKeyBindingOF_1_.getEnumString() : s;
        ...
        if (p_getKeyBindingOF_1_ == Options.AUTOSAVE_TICKS) {
            if (this.ofAutoSaveTicks <= 40) {
                return (String)s + Lang.get("of.options.save.default");
            }
            if (this.ofAutoSaveTicks <= 400) {
                return (String)s + Lang.get("of.options.save.20s");
            }
            return this.ofAutoSaveTicks <= 4000 ? (String)s + Lang.get("of.options.save.3min") : (String)s + Lang.get("of.options.save.30min");
        }
        ...
        if (p_getKeyBindingOF_1_ == Options.TIME) {
            ...
            return this.ofTime == 2 ? (String)s + Lang.get("of.options.time.nightOnly") : (String)s + Lang.getDefault();
        }
        ...
        if (p_getKeyBindingOF_1_ == Options.RANDOM_MOBS) {
            return this.ofRandomMobs ? (String)s + Lang.getOn() : (String)s + Lang.getOff();
        }
        ...
        if (p_getKeyBindingOF_1_ == Options.TRANSLUCENT_BLOCKS) {
            ...
            return this.ofTranslucentBlocks == 2 ? (String)s + Lang.getFancy() : (String)s + Lang.getDefault();
        }
        ...
        if (p_getKeyBindingOF_1_ == Options.FRAMERATE_LIMIT) {
            ...
            return f == p_getKeyBindingOF_1_.valueMax ? (String)s + I18n.format("options.framerateLimit.max", new Object[0]) : (String)s + (int)f + " fps";
        }
        return null;
    }
    ...
    private void setForgeKeybindProperties() {
        if (Reflector.KeyConflictContext_IN_GAME.exists() && Reflector.ForgeKeyBinding_setKeyConflictContext.exists()) {
            ...
            Reflector.call(keyBindLeft, Reflector.ForgeKeyBinding_setKeyConflictContext, object);
            Reflector.call(this.keyBindBack, Reflector.ForgeKeyBinding_setKeyConflictContext, object);
            Reflector.call(keyBindRight, Reflector.ForgeKeyBinding_setKeyConflictContext, object);
