...
implements IResourceManagerReloadListener {
    ...
    final boolean cancelGlint() {
        return NoRender.get.actived && NoRender.get.EnchGlintEffect.bValue;
    }
    ...
    public void renderItem(ItemStack stack, IBakedModel model) {
        if (!stack.func_190926_b()) {
            ...
            if (model.isBuiltInRenderer()) {
                ...
                if (!(!stack.hasEffect() || Config.isCustomItems() && CustomItems.renderCustomEffect(this, stack, model) || this.cancelGlint())) {
    ...
    public void renderItemAndEffectIntoGUIChar(ItemStack stack, int xPosition, int yPosition) {
        this.renderItemAndEffectIntoGUIChar(Minecraft.player, stack, xPosition, yPosition);
    }
    ...
    public void renderItemAndEffectIntoGUIChar(@Nullable EntityLivingBase p_184391_1_, final ItemStack p_184391_2_, int p_184391_3_, int p_184391_4_) {
        if (!p_184391_2_.func_190926_b()) {
            this.zLevel += 50.0f;
            try {
                this.func_191962_a(p_184391_2_, p_184391_3_, p_184391_4_, this.getItemModelWithOverrides(p_184391_2_, null, p_184391_1_));
    ...
    public void renderItemOverlays(CFontRenderer frs, ItemStack stack, int xPosition, int yPosition) {
        this.renderItemOverlayIntoGUI(frs, stack, xPosition, yPosition, null);
    }
    ...
    public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, @Nullable String text) {
        if (!stack.func_190926_b()) {
            ...
            float f = f3 = (entityplayersp = Minecraft.player) == null ? 0.0f : entityplayersp.getCooldownTracker().getCooldown(stack.getItem(), Minecraft.getMinecraft().getRenderPartialTicks());
            if (f3 > 0.0f) {
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                GlStateManager.disableTexture2D();
    ...
    public void renderItemOverlayIntoGUI20(CFontRenderer fr, ItemStack stack, int xPosition, int yPosition, @Nullable String text) {
        if (!stack.func_190926_b()) {
            EntityPlayerSP entityplayersp;
            float f3;
            if (ReflectorForge.isItemDamaged(stack)) {
            ...
            if (stack.func_190916_E() != 1 || text != null) {
                ...
                GlStateManager.disableDepth();
                GlStateManager.disableBlend();
                fr.drawStringWithOutline(s, xPosition + 19 - 2 - fr.getStringWidth(s), yPosition + 8, 0xFFFFFF);
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
                GlStateManager.enableBlend();
            }
    ...
    public void renderItemOverlayIntoGUIWithTextColor(CFontRenderer fr, ItemStack stack, int xPosition, int yPosition, @Nullable String text, int color) {
        if (!stack.func_190926_b()) {
            EntityPlayerSP entityplayersp;
            float f3;
            if (stack.func_190916_E() != 1 || text != null) {
                ...
                GlStateManager.disableBlend();
                if (fr != null) {
                    fr.drawStringWithShadow(s, xPosition + 19 - 2 - fr.getStringWidth(s), yPosition + 6 + 3, color);
                }
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
                GlStateManager.enableBlend();
