...
public class ItemCameraTransforms {
    ...
    public void applyTransform(TransformType type2) {
        ItemCameraTransforms.applyTransformSide(this.getTransform(type2), false);
    }
    ...
    public ItemTransformVec3f getTransform(TransformType type2) {
        switch (type2) {
    ...
    public boolean hasCustomTransform(TransformType type2) {
        return this.getTransform(type2) != ItemTransformVec3f.DEFAULT;
    }
