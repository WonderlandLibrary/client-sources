...
public class TileEntityRendererDispatcher {
    ...
    private final Tessellator batchBuffer = new Tessellator(0x200000);
    ...
    public void func_192854_a(TileEntity p_192854_1_, double p_192854_2_, double p_192854_4_, double p_192854_6_, float p_192854_8_, int p_192854_9_, float p_192854_10_) {
        ...
        if (tileentityspecialrenderer != null) {
            ...
            if (WallHack.get != null && WallHack.get.actived) {
                WallHack.get.preRenderTileEntity(p_192854_1_, render);
                render.run();
                WallHack.get.postRenderTileEntity(p_192854_1_, render);
            } else {
                render.run();
            }
        }
