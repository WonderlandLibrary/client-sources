...
public class RenderChunk {
    ...
    public void setPosition(int p_189562_1_, int p_189562_2_, int p_189562_3_) {
        ...
        EventRenderChunk zalupa = new EventRenderChunk(this, new BlockPos(p_189562_1_, p_189562_2_, p_189562_3_));
        zalupa.call();
    }
            ...
            if (!chunkcacheof.isEmpty()) {
                ...
                for (Object blockposm0 : BlockPosM.getAllInBoxMutable(blockpos, blockpos1)) {
                    ...
                    for (int j = 0; j < ablockrenderlayer.length; ++j) {
                        ...
                        if (flag && !(flag2 = Reflector.callBoolean(block, Reflector.ForgeBlock_canRenderInLayer, new Object[]{iblockstate, blockrenderlayer}))) continue;
                        if (flag1) {
