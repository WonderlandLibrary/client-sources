...
extends World {
    ...
    public Entity getEntityByID(int id) {
        return id == Minecraft.player.getEntityId() ? Minecraft.player : super.getEntityByID(id);
    }
    ...
    public void sendQuittingDisconnectingPacket(String result) {
        this.connection.getNetworkManager().closeChannel(new TextComponentString(result));
    }
    ...
    protected void playMoodSoundAndCheckLight(int p_147467_1_, int p_147467_2_, Chunk chunkIn) {
        ...
        if (this.ambienceTicks == 0) {
            ...
            double d0 = Minecraft.player.getDistanceSq((double)(j += p_147467_1_) + 0.5, (double)l + 0.5, (double)(k += p_147467_2_) + 0.5);
            if (d0 < 4.0) {
                return;
            }
            if (d0 > 255.0) {
    ...
    private boolean isPlayerActing() {
        ...
        if (playerControllerMP instanceof PlayerControllerOF) {
            PlayerControllerOF playercontrollerof = (PlayerControllerOF)playerControllerMP;
