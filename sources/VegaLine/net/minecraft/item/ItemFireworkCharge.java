        ...
        if (aint.length > 0) {
            ...
            for (int i : aint) {
                ...
                for (int j = 0; j < ItemDye.DYE_COLORS.length; ++j) {
                    ...
                    flag1 = true;
                    s = (String)s + I18n.translateToLocal("item.fireworksCharge." + EnumDyeColor.byDyeDamage(j).getUnlocalizedName());
                    break;
                }
                if (flag1) continue;
                s = (String)s + I18n.translateToLocal("item.fireworksCharge.customColor");
            }
