...
extends ItemFood {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving) {
        ...
        if (entityLiving instanceof EntityPlayerSP && PlayerHelper.get.actived && PlayerHelper.get.ChorusUseCooldown.bValue && !PlayerHelper.checkChorus && PlayerHelper.canCooldown()) {
            PlayerHelper.trackChorus();
        }
        if (!worldIn.isRemote) {
