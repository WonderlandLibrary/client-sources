...
public final class ItemStack {
    ...
    public ItemStack onItemUseFinish(World worldIn, EntityLivingBase entityLiving) {
        OffHand.timerDelay.lastMS = OffHand.timerDelay.getCurrentMS() - 100L;
    ...
    boolean unlimit() {
        return !Panic.stop && this.mc().playerController != null && this.mc().playerController.getCurrentGameType() == GameType.CREATIVE && ProContainer.get.actived && ProContainer.get.StackUnlimit.bValue;
    }

    public int getMaxStackSize() {
        return !this.unlimit() ? this.getItem().getItemStackLimit() : 64;
    }
    ...
    public static boolean areItemStacksEqual(ItemStack stackA, ItemStack stackB) {
        ...
        return !stackA.func_190926_b() && !stackB.func_190926_b() && stackA.isItemStackEqual(stackB);
    }
    ...
    public float getItemAttackDamage(ItemStack item) {
    ...
    public static boolean areItemsEqual(ItemStack stackA, ItemStack stackB) {
        ...
        return !stackA.func_190926_b() && !stackB.func_190926_b() && stackA.isItemEqual(stackB);
    }
    ...
    public static boolean areItemsEqualIgnoreDurability(ItemStack stackA, ItemStack stackB) {
        ...
        return !stackA.func_190926_b() && !stackB.func_190926_b() && stackA.isItemEqualIgnoreDurability(stackB);
    }
    ...
    public List<String> getTooltip(@Nullable EntityPlayer playerIn, ITooltipFlag advanced) {
        ...
        s = (String)s + TextFormatting.RESET;
        ...
        for (EntityEquipmentSlot entityequipmentslot : EntityEquipmentSlot.values()) {
            ...
            for (Map.Entry<String, AttributeModifier> entry : multimap.entries()) {
                ...
                if (!(d0 < 0.0)) continue;
                list.add(TextFormatting.RED + " " + I18n.translateToLocalFormatted("attribute.modifier.take." + attributemodifier.getOperation(), DECIMALFORMAT.format(d1 *= -1.0), I18n.translateToLocal("attribute.name." + entry.getKey())));
            }
        }
    ...
    public String getCount() {
        return this.stackSize == 1 ? "" : "" + (this.field_190928_g ? 0 : this.stackSize);
    }
