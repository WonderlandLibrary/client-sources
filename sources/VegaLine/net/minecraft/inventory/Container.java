...
public abstract class Container {
    ...
    public final Set<Slot> dragSlots = Sets.newHashSet();
    public List<IContainerListener> listeners = Lists.newArrayList();
    public final Set<EntityPlayer> playerList = Sets.newHashSet();
    ...
    public Slot getSlot(int slotId) {
        return this.inventorySlots.get(slotId) != null ? this.inventorySlots.get(slotId) : null;
    }
    ...
    public ItemStack slotClick(int slotId, int dragType, ClickType clickTypeIn, EntityPlayer player) {
        ...
        if (clickTypeIn == ClickType.QUICK_CRAFT) {
            ...
            if (slotId == -999) {
                ...
                if (slotId < 0 || slotId > this.inventorySlots.size() - 1 || this.inventorySlots.get(slotId) == null) {
                    return ItemStack.field_190927_a;
                }
    ...
    public void func_193327_a(EntityPlayer p_193327_1_, World p_193327_2_, IInventory p_193327_3_) {
    ...
    public void func_192389_a(World p_192389_1_, EntityPlayer p_192389_2_, InventoryCrafting p_192389_3_, InventoryCraftResult p_192389_4_) {
