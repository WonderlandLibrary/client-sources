...
public class EntitySelector {
    ...
    private static List<Predicate<Entity>> getTypePredicates(Map<String, String> params, String type2) {
        String s = EntitySelector.getArgument(params, field_190849_w);
        if (s == null || !type2.equals("e") && !type2.equals("r") && !type2.equals("s")) {
            return !type2.equals("e") && !type2.equals("s") ? Collections.singletonList(new Predicate<Entity>(){
    ...
    private static List<Predicate<Entity>> getGamemodePredicates(Map<String, String> params) {
        ...
        list.add(new Predicate<Entity>(){
            ...
            public boolean apply(@Nullable Entity p_apply_1_) {
                ...
                return flag ? gametype1 != type2 : gametype1 == type2;
            }
        });
        return list;
    }
    ...
    private static <T extends Entity> List<T> filterResults(Map<String, String> params, Class<? extends T> entityClass, List<Predicate<Entity>> inputList, String type2, World worldIn, BlockPos position) {
        ArrayList<Entity> list = Lists.newArrayList();
        String s = EntitySelector.getArgument(params, field_190849_w);
        s = s != null && s.startsWith("!") ? s.substring(1) : s;
        boolean flag = !type2.equals("e");
        boolean flag1 = type2.equals("r") && s != null;
        ...
        if (!(params.containsKey(field_190838_l) || params.containsKey(field_190839_m) || params.containsKey(field_190840_n))) {
            ...
            } else if (!(type2.equals("p") || type2.equals("r") && !flag1)) {
    ...
    private static <T extends Entity> List<T> getEntitiesFromPredicates(List<T> matchingEntities, Map<String, String> params, ICommandSender sender, Class<? extends T> targetClass, String type2, final Vec3d pos) {
        Entity entity;
        int i = EntitySelector.getInt(params, field_190845_s, !type2.equals("a") && !type2.equals("e") ? 1 : 0);
        if (!(type2.equals("p") || type2.equals("a") || type2.equals("e"))) {
            if (type2.equals("r")) {
        ...
        if ((entity = sender.getCommandSenderEntity()) != null && targetClass.isAssignableFrom(entity.getClass()) && i == 1 && matchingEntities.contains(entity) && !"r".equals(type2)) {
