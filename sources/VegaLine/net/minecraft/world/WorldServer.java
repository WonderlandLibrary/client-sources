...
implements IThreadListener {
    ...
    public void spawnParticle(EntityPlayerMP player, EnumParticleTypes particle2, boolean longDistance, double x, double y, double z, int count, double xOffset, double yOffset, double zOffset, double speed, int ... arguments) {
        SPacketParticles packet = new SPacketParticles(particle2, longDistance, (float)x, (float)y, (float)z, (float)xOffset, (float)yOffset, (float)zOffset, (float)speed, count, arguments);
