...
public class StructureVillagePieces {
    ...
    extends Village {
        ...
        public House1(Start start, int type2, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing) {
            super(start, type2);
    ...
    extends Village {
        ...
        public Field1(Start start, int type2, Random rand, StructureBoundingBox p_i45570_4_, EnumFacing facing) {
            super(start, type2);
            this.setCoordBaseMode(facing);
    ...
    extends Village {
        ...
        public Hall(Start start, int type2, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing) {
            super(start, type2);
            this.setCoordBaseMode(facing);
    ...
    extends Village {
        ...
        public WoodHut(Start start, int type2, Random rand, StructureBoundingBox structurebb, EnumFacing facing) {
            super(start, type2);
            this.setCoordBaseMode(facing);
    ...
    extends Village {
        ...
        public Church(Start start, int type2, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing) {
            super(start, type2);
            this.setCoordBaseMode(facing);
    ...
    extends Village {
        ...
        public House2(Start start, int type2, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing) {
            super(start, type2);
            this.setCoordBaseMode(facing);
    ...
    extends Village {
        ...
        public House3(Start start, int type2, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing) {
            super(start, type2);
            this.setCoordBaseMode(facing);
    ...
    extends Village {
        ...
        public Well(Start start, int type2, Random rand, int x, int z) {
            super(start, type2);
    ...
    extends StructureComponent {
        ...
        protected Village(Start start, int type2) {
            super(type2);
            if (start != null) {
    ...
    extends Village {
        ...
        protected Road(Start start, int type2) {
            super(start, type2);
        }
    }
}
