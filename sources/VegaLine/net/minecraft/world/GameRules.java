...
public class GameRules {
    ...
    public void addGameRule(String key, String value, ValueType type2) {
        this.theGameRules.put(key, new Value(value, type2));
    }
    ...
    static class Value {
        ...
        public Value(String value, ValueType type2) {
            this.type = type2;
            this.setValue(value);
        }
