...
implements Plugin {
    ...
    private final AbstractController createControllerFromDevice(IDirectInputDevice device, Controller.Type type2) {
        Component[] components = this.createComponents(device, false);
        DIAbstractController controller = new DIAbstractController(device, components, new Controller[0], device.getRumblers(), type2);
        return controller;
    }
