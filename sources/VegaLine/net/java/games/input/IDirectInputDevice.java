...
final class IDirectInputDevice {
    ...
    private final void addObject(byte[] guid, int guid_type, int identifier, int type2, int instance, int flags, String name) throws IOException {
        Component.Identifier id = this.getIdentifier(guid_type, type2, instance);
        int format_offset = this.current_format_offset++;
        DIDeviceObject obj = new DIDeviceObject(this, id, guid, guid_type, identifier, type2, instance, flags, name, format_offset);
    ...
    private final Component.Identifier getIdentifier(int guid_type, int type2, int instance) {
        switch (guid_type) {
            case 1: {
