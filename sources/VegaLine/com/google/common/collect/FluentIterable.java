...
implements Iterable<E> {
    ...
    @GwtIncompatible
    public final <T> FluentIterable<T> filter(Class<T> type2) {
        return FluentIterable.from(Iterables.filter(this.getDelegate(), type2));
    }
    ...
    @GwtIncompatible
    public final E[] toArray(Class<E> type2) {
        return Iterables.toArray(this.getDelegate(), type2);
    }
