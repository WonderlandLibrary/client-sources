...
final class Types {
    ...
    static String toString(Type type2) {
        return type2 instanceof Class ? ((Class)type2).getName() : type2.toString();
    }

    @Nullable
    static Type getComponentType(Type type2) {
    ...
    static enum JavaVersion {
        JAVA6{
            ...
            @Override
            Type usedInGenericType(Type type2) {
                Class cls;
                Preconditions.checkNotNull(type2);
                if (type2 instanceof Class && (cls = (Class)type2).isArray()) {
        ...
        JAVA7{
            ...
            @Override
            Type usedInGenericType(Type type2) {
                return Preconditions.checkNotNull(type2);
            }
        }
        ,
        JAVA8{
            ...
            @Override
            Type usedInGenericType(Type type2) {
                return JAVA7.usedInGenericType(type2);
            }

            @Override
            String typeName(Type type2) {
                try {
                    Method getTypeName = Type.class.getMethod("getTypeName", new Class[0]);
                    return (String)getTypeName.invoke(type2, new Object[0]);
        ...
        final ImmutableList<Type> usedInGenericType(Type[] types) {
            ...
            for (Type type2 : types) {
                builder.add(this.usedInGenericType(type2));
            }
