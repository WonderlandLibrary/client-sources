...
public final class MediaType {
    ...
    private static MediaType createConstant(String type2, String subtype) {
        return MediaType.addKnownType(new MediaType(type2, subtype, ImmutableListMultimap.of()));
    }

    private static MediaType createConstantUtf8(String type2, String subtype) {
        return MediaType.addKnownType(new MediaType(type2, subtype, UTF_8_CONSTANT_PARAMETERS));
    }
    ...
    private MediaType(String type2, String subtype, ImmutableListMultimap<String, String> parameters) {
        this.type = type2;
    ...
    public static MediaType create(String type2, String subtype) {
        return MediaType.create(type2, subtype, ImmutableListMultimap.of());
    }
    ...
    private static MediaType create(String type2, String subtype, Multimap<String, String> parameters) {
        Preconditions.checkNotNull(type2);
        Preconditions.checkNotNull(subtype);
        Preconditions.checkNotNull(parameters);
        String normalizedType = MediaType.normalizeToken(type2);
    ...
    public static MediaType parse(String input) {
        ...
        try {
            ...
            return MediaType.create(type2, subtype, parameters.build());
