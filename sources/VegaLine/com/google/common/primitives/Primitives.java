...
public final class Primitives {
    ...
    public static boolean isWrapperType(Class<?> type2) {
        return WRAPPER_TO_PRIMITIVE_TYPE.containsKey(Preconditions.checkNotNull(type2));
    }
    ...
    public static <T> Class<T> unwrap(Class<T> type2) {
        Preconditions.checkNotNull(type2);
        Class<?> unwrapped = WRAPPER_TO_PRIMITIVE_TYPE.get(type2);
