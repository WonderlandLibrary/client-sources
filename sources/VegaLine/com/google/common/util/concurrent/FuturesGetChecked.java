...
final class FuturesGetChecked {
    ...
    @VisibleForTesting
    static boolean isCheckedException(Class<? extends Exception> type2) {
        return !RuntimeException.class.isAssignableFrom(type2);
    }
            ...
            static {
                isValidClass = new ClassValue<Boolean>(){
                    ...
                    protected Boolean computeValue(Class<?> type2) {
                        FuturesGetChecked.checkExceptionClassValidity(type2.asSubclass(Exception.class));
                        return true;
                    }
                };
            }
