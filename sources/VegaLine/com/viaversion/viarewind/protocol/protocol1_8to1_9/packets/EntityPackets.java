...
public class EntityPackets {
    public static void register(Protocol<ClientboundPackets1_9, ClientboundPackets1_8, ServerboundPackets1_9, ServerboundPackets1_8> protocol) {
        protocol.registerClientbound(ClientboundPackets1_9.ENTITY_STATUS, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.ENTITY_POSITION, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.ENTITY_POSITION_AND_ROTATION, (ClientboundPackets1_8)((Object)new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    boolean onGround = packetWrapper.passthrough(Type.BOOLEAN);
                    Entity1_10Types.EntityType type2 = packetWrapper.user().get(EntityTracker.class).getClientEntityTypes().get(entityId);
                    if (type2 == Entity1_10Types.EntityType.BOAT) {
                        yaw = (byte)(yaw - 64);
        ...
        protocol.registerClientbound(ClientboundPackets1_9.ENTITY_ROTATION, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.DESTROY_ENTITIES, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.REMOVE_ENTITY_EFFECT, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.ENTITY_HEAD_LOOK, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.ENTITY_METADATA, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.ATTACH_ENTITY, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.ENTITY_EQUIPMENT, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.ENTITY_TELEPORT, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.ENTITY_PROPERTIES, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.ENTITY_EFFECT, (ClientboundPackets1_8)((Object)new PacketHandlers(){
