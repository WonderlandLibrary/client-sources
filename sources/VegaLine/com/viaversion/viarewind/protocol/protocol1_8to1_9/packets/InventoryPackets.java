...
public class InventoryPackets {
    public static void register(Protocol<ClientboundPackets1_9, ClientboundPackets1_8, ServerboundPackets1_9, ServerboundPackets1_8> protocol) {
        protocol.registerClientbound(ClientboundPackets1_9.CLOSE_WINDOW, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.OPEN_WINDOW, (ClientboundPackets1_8)((Object)new PacketHandlers(){
            ...
            public void register() {
                ...
                this.map(Type.UNSIGNED_BYTE);
                this.handler(packetWrapper -> {
                    String type2 = packetWrapper.get(Type.STRING, 0);
                    if (type2.equals("EntityHorse")) {
        ...
        protocol.registerClientbound(ClientboundPackets1_9.WINDOW_ITEMS, (ClientboundPackets1_8)((Object)new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (windowId == 0 && items.length == 46) {
                        ...
                        String type2 = packetWrapper.user().get(Windows.class).get(windowId);
                        if (type2 != null && type2.equalsIgnoreCase("minecraft:brewing_stand")) {
        ...
        protocol.registerClientbound(ClientboundPackets1_9.SET_SLOT, (ClientboundPackets1_8)((Object)new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (type2.equalsIgnoreCase("minecraft:brewing_stand")) {
                        if (slot > 4) {
                            slot = (short)(slot - 1);
        ...
        protocol.registerServerbound(ServerboundPackets1_8.CLICK_WINDOW, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    String type2 = windows.get(windowId);
                    if (type2 == null) {
                        return;
                    }
                    if (type2.equalsIgnoreCase("minecraft:brewing_stand") && (slot = packetWrapper.get(Type.SHORT, 0).shortValue()) > 3) {
                        slot = (short)(slot + 1);
                        packetWrapper.set(Type.SHORT, 0, slot);
                    }
                });
