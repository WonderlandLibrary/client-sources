...
public class SpawnPackets {
    public static void register(Protocol<ClientboundPackets1_9, ClientboundPackets1_8, ServerboundPackets1_9, ServerboundPackets1_8> protocol) {
        protocol.registerClientbound(ClientboundPackets1_9.SPAWN_ENTITY, (ClientboundPackets1_8)((Object)new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (type2.is((EntityType)Entity1_10Types.EntityType.BOAT)) {
                        byte yaw = packetWrapper.get(Type.BYTE, 1);
                        yaw = (byte)(yaw - 64);
                        packetWrapper.set(Type.BYTE, 1, yaw);
                        packetWrapper.set(Type.INT, 1, y += 10);
                    } else if (type2.is((EntityType)Entity1_10Types.EntityType.SHULKER_BULLET)) {
                        packetWrapper.cancel();
                    ...
                    if (type2.isOrHasParent(Entity1_10Types.EntityType.ARROW) && data != 0) {
                        packetWrapper.set(Type.INT, 3, --data);
                    }
                    if (type2.is((EntityType)Entity1_10Types.EntityType.FALLING_BLOCK) && (replace = ReplacementRegistry1_8to1_9.getReplacement(blockId = data & 0xFFF, blockData = data >> 12 & 0xF)) != null) {
        ...
        protocol.registerClientbound(ClientboundPackets1_9.SPAWN_EXPERIENCE_ORB, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.SPAWN_GLOBAL_ENTITY, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.SPAWN_MOB, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.SPAWN_PAINTING, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.SPAWN_PLAYER, (ClientboundPackets1_8)((Object)new PacketHandlers(){
