...
public class PlayerPackets {
    public static void register(final Protocol<ClientboundPackets1_9, ClientboundPackets1_8, ServerboundPackets1_9, ServerboundPackets1_8> protocol) {
        ...
        protocol.registerClientbound(ClientboundPackets1_9.PLUGIN_MESSAGE, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.GAME_EVENT, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.JOIN_GAME, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.PLAYER_POSITION, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerClientbound(ClientboundPackets1_9.RESPAWN, (ClientboundPackets1_8)((Object)new PacketHandlers(){
        ...
        protocol.registerServerbound(ServerboundPackets1_8.INTERACT_ENTITY, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.map(Type.VAR_INT);
                this.handler(packetWrapper -> {
                    int type2 = packetWrapper.get(Type.VAR_INT, 1);
                    if (type2 == 2) {
