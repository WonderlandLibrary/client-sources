...
public class MetaIndex1_8to1_9 {
    ...
    private static Optional<MetaIndex> getIndex(Entity1_10Types.EntityType type2, int index) {
    ...
    public static MetaIndex searchIndex(Entity1_10Types.EntityType type2, int index) {
