...
public enum MetaIndex1_8To1_7_6_10 {
    ...
    private MetaIndex1_8To1_7_6_10(Entity1_10Types.EntityType type2, int index, MetaType1_7_6_10 oldType, MetaType1_8 newType) {
        this.clazz = type2;
        this.index = index;
        this.newIndex = index;
    ...
    private MetaIndex1_8To1_7_6_10(Entity1_10Types.EntityType type2, int index, MetaType1_7_6_10 oldType, int newIndex, MetaType1_8 newType) {
        this.clazz = type2;
        this.index = index;
        this.oldType = oldType;
    ...
    private static Optional<MetaIndex1_8To1_7_6_10> getIndex(Entity1_10Types.EntityType type2, int index) {
        Pair<Entity1_10Types.EntityType, Integer> pair = new Pair<Entity1_10Types.EntityType, Integer>(type2, index);
    ...
    public static MetaIndex1_8To1_7_6_10 searchIndex(Entity1_10Types.EntityType type2, int index) {
        Entity1_10Types.EntityType currentType = type2;
        do {
