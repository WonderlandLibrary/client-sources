        ...
        protocol.registerClientbound(ClientboundPackets1_8.SPAWN_PARTICLE, new PacketHandlers(){
            ...
            public void register() {
                this.handler(packetWrapper -> {
                    ...
                    Particle particle2 = Particle.find(particleId);
                    if (particle2 == null) {
                        particle2 = Particle.CRIT;
                    }
                    packetWrapper.write(Type.STRING, particle2.name);
                ...
                this.handler(packetWrapper -> {
                    ...
                    if (particle2 == Particle.ICON_CRACK || particle2 == Particle.BLOCK_CRACK || particle2 == Particle.BLOCK_DUST) {
                        ...
                        int n = data = particle2 == Particle.ICON_CRACK ? packetWrapper.read(Type.VAR_INT) : 0;
            ...
            public void register() {
                this.handler(packetWrapper -> {
                    ...
                    if (action == 0) {
                        ...
                        worldBorder.init(packetWrapper.read(Type.DOUBLE), packetWrapper.read(Type.DOUBLE), packetWrapper.read(Type.DOUBLE), packetWrapper.read(Type.DOUBLE), packetWrapper.read(Type.VAR_LONG), packetWrapper.read(Type.VAR_INT), packetWrapper.read(Type.VAR_INT), packetWrapper.read(Type.VAR_INT));
                    } else if (action == 4) {
