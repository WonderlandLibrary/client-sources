        ...
        ((Protocol1_13To1_13_1)this.protocol).registerClientbound(ClientboundPackets1_13.SPAWN_ENTITY, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    Entity1_13Types.EntityType entType = Entity1_13Types.getTypeFromId(type2, true);
                    if (entType == null) {
                        ViaBackwards.getPlatform().getLogger().warning("Could not find 1.13 entity type " + type2);
                        return;
                    }
