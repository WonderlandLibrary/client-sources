...
extends BackwardsProtocol<ClientboundPackets1_17, ClientboundPackets1_16_2, ServerboundPackets1_17, ServerboundPackets1_16_2> {
    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(ClientboundPackets1_17.TAGS, (PacketWrapper wrapper) -> {
            ...
            for (RegistryType type2 : TAG_REGISTRY_TYPES) {
                List tagList = (List)tags.get(type2.resourceLocation());
                if (tagList == null) {
                    wrapper.write(Type.VAR_INT, 0);
                    continue;
                }
                IdRewriteFunction rewriter = tagRewriter.getRewriter(type2);
    ...
    public void mergePacket(ClientboundPackets1_17 newPacketType, ClientboundPackets1_16_2 oldPacketType, int type2) {
        this.registerClientbound(newPacketType, oldPacketType, (PacketWrapper wrapper) -> wrapper.write(Type.VAR_INT, type2));
    }
