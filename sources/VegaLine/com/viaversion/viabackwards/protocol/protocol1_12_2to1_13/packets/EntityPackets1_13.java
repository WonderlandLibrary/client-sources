...
extends LegacyEntityRewriter<ClientboundPackets1_13, Protocol1_12_2To1_13> {
        ...
        ((Protocol1_12_2To1_13)this.protocol).registerClientbound(ClientboundPackets1_13.SPAWN_ENTITY, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    Entity1_13Types.ObjectType type2 = optionalType.get();
                    if (type2 == Entity1_13Types.ObjectType.FALLING_BLOCK) {
                    ...
                    } else if (type2 == Entity1_13Types.ObjectType.ITEM_FRAME) {
                    ...
                    } else if (type2 == Entity1_13Types.ObjectType.TRIDENT) {
        ...
        ((Protocol1_12_2To1_13)this.protocol).registerClientbound(ClientboundPackets1_13.SPAWN_MOB, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    Entity1_13Types.EntityType entityType = Entity1_13Types.getTypeFromId(type2, false);
                    EntityPackets1_13.this.tracker(wrapper.user()).addEntity(wrapper.get(Type.VAR_INT, 0), entityType);
                    int oldId = EntityTypeMapping.getOldId(type2);
                    if (oldId == -1) {
                        if (!EntityPackets1_13.this.hasData(entityType)) {
                            ViaBackwards.getPlatform().getLogger().warning("Could not find 1.12 entity type for 1.13 entity type " + type2 + "/" + entityType);
                        }
                    } else {
    ...
    protected void registerRewrites() {
        ...
        this.filter().type(Entity1_13Types.EntityType.AREA_EFFECT_CLOUD).index(9).handler((event, meta) -> {
            ...
            ParticleMapping.ParticleData data = ParticleMapping.getMapping(particle2.getId());
            int firstArg = 0;
            int secondArg = 0;
            int[] particleArgs = data.rewriteMeta((Protocol1_12_2To1_13)this.protocol, particle2.getArguments());
