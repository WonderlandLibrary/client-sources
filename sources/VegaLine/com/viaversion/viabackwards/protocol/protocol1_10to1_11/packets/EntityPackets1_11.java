...
extends LegacyEntityRewriter<ClientboundPackets1_9_3, Protocol1_10To1_11> {
    ...
    protected void registerPackets() {
        ((Protocol1_10To1_11)this.protocol).registerClientbound(ClientboundPackets1_9_3.EFFECT, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    int type2 = wrapper.get(Type.INT, 0);
                    if (type2 == 2002 || type2 == 2007) {
                        int mappedData;
                        if (type2 == 2007) {
        ...
        ((Protocol1_10To1_11)this.protocol).registerClientbound(ClientboundPackets1_9_3.SPAWN_ENTITY, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    Optional<Entity1_12Types.ObjectType> type2 = Entity1_12Types.ObjectType.findById(wrapper.get(Type.BYTE, 0).byteValue());
                    if (type2.isPresent() && type2.get() == Entity1_12Types.ObjectType.FALLING_BLOCK) {
        ...
        ((Protocol1_10To1_11)this.protocol).registerClientbound(ClientboundPackets1_9_3.SPAWN_MOB, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    EntityType type2 = EntityPackets1_11.this.tracker(wrapper.user()).entityType(entityId);
                    ...
                    EntityData entityData = EntityPackets1_11.this.entityDataForType(type2);
                    if (entityData != null) {
    ...
    private Metadata getSkeletonTypeMeta(int type2) {
        return new Metadata(12, MetaType1_9.VarInt, type2);
    }

    private Metadata getZombieTypeMeta(int type2) {
        return new Metadata(13, MetaType1_9.VarInt, type2);
    }

    private void handleZombieType(WrappedMetadata storage, int type2) {
        Metadata meta = storage.get(13);
        if (meta == null) {
            storage.add(this.getZombieTypeMeta(type2));
        }
    }

    private Metadata getHorseMetaType(int type2) {
        return new Metadata(14, MetaType1_9.VarInt, type2);
    }
