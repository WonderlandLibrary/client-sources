...
public final class GsonBuilder {
    ...
    public GsonBuilder registerTypeAdapter(Type type2, Object typeAdapter) {
        ...
        if (typeAdapter instanceof InstanceCreator) {
            this.instanceCreators.put(type2, (InstanceCreator)typeAdapter);
        }
        ...
        if (typeAdapter instanceof TypeAdapter) {
            TypeAdapterFactory factory = TypeAdapters.newFactory(TypeToken.get(type2), (TypeAdapter)typeAdapter);
