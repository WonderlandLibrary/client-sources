...
Iterable<BinaryTag> {
    ...
    @NotNull
    public static <T extends BinaryTag> Builder<T> builder(@NotNull BinaryTagType<T> type2) {
        if (type2 == BinaryTagTypes.END) {
            throw new IllegalArgumentException("Cannot create a list of " + BinaryTagTypes.END);
        }
        return new ListTagBuilder(type2);
    }

    @NotNull
    public static ListBinaryTag listBinaryTag(@NotNull BinaryTagType<? extends BinaryTag> type2, @NotNull List<BinaryTag> tags) {
        if (tags.isEmpty()) {
        ...
        return new ListBinaryTagImpl(type2, tags);
    }

    @Deprecated
    @ApiStatus.ScheduledForRemoval(inVersion="5.0.0")
    @NotNull
    public static ListBinaryTag of(@NotNull BinaryTagType<? extends BinaryTag> type2, @NotNull List<BinaryTag> tags) {
        return ListBinaryTag.listBinaryTag(type2, tags);
    }
