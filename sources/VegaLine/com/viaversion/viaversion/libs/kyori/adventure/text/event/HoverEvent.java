...
StyleBuilderApplicable {
    ...
    @NotNull
    public static HoverEvent<ShowEntity> showEntity(@NotNull Key type2, @NotNull UUID id) {
        return HoverEvent.showEntity(type2, id, null);
    }

    @NotNull
    public static HoverEvent<ShowEntity> showEntity(@NotNull Keyed type2, @NotNull UUID id) {
        return HoverEvent.showEntity(type2, id, null);
    }

    @NotNull
    public static HoverEvent<ShowEntity> showEntity(@NotNull Key type2, @NotNull UUID id, @Nullable Component name) {
        return HoverEvent.showEntity(ShowEntity.of(type2, id, name));
    }

    @NotNull
    public static HoverEvent<ShowEntity> showEntity(@NotNull Keyed type2, @NotNull UUID id, @Nullable Component name) {
        return HoverEvent.showEntity(ShowEntity.of(type2, id, name));
    }
    ...
    public static final class Action<V> {
        ...
        Action(String name, Class<V> type2, boolean readable, Renderer<V> renderer) {
            this.name = name;
            this.type = type2;
    ...
    implements Examinable {
        ...
        @NotNull
        public static ShowEntity showEntity(@NotNull Key type2, @NotNull UUID id) {
            return ShowEntity.showEntity(type2, id, null);
        }

        @Deprecated
        @ApiStatus.ScheduledForRemoval(inVersion="5.0.0")
        @NotNull
        public static ShowEntity of(@NotNull Key type2, @NotNull UUID id) {
            return ShowEntity.of(type2, id, null);
        }

        @NotNull
        public static ShowEntity showEntity(@NotNull Keyed type2, @NotNull UUID id) {
            return ShowEntity.showEntity(type2, id, null);
        }
        ...
        @ApiStatus.ScheduledForRemoval(inVersion="5.0.0")
        @NotNull
        public static ShowEntity of(@NotNull Keyed type2, @NotNull UUID id) {
            return ShowEntity.of(type2, id, null);
        }

        @NotNull
        public static ShowEntity showEntity(@NotNull Key type2, @NotNull UUID id, @Nullable Component name) {
            return new ShowEntity(Objects.requireNonNull(type2, "type"), Objects.requireNonNull(id, "id"), name);
        }

        @Deprecated
        @ApiStatus.ScheduledForRemoval(inVersion="5.0.0")
        @NotNull
        public static ShowEntity of(@NotNull Key type2, @NotNull UUID id, @Nullable Component name) {
            return new ShowEntity(Objects.requireNonNull(type2, "type"), Objects.requireNonNull(id, "id"), name);
        }

        @NotNull
        public static ShowEntity showEntity(@NotNull Keyed type2, @NotNull UUID id, @Nullable Component name) {
            return new ShowEntity(Objects.requireNonNull(type2, "type").key(), Objects.requireNonNull(id, "id"), name);
        }

        @Deprecated
        @ApiStatus.ScheduledForRemoval(inVersion="5.0.0")
        @NotNull
        public static ShowEntity of(@NotNull Keyed type2, @NotNull UUID id, @Nullable Component name) {
            return new ShowEntity(Objects.requireNonNull(type2, "type").key(), Objects.requireNonNull(id, "id"), name);
        }

        private ShowEntity(@NotNull Key type2, @NotNull UUID id, @Nullable Component name) {
            this.type = type2;
            this.id = id;
            this.name = name;
        }
        ...
        @NotNull
        public ShowEntity type(@NotNull Key type2) {
            if (Objects.requireNonNull(type2, "type").equals(this.type)) {
                return this;
            }
            return new ShowEntity(type2, this.id, this.name);
        }

        @NotNull
        public ShowEntity type(@NotNull Keyed type2) {
            return this.type(Objects.requireNonNull(type2, "type").key());
        }
