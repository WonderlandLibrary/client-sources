...
extends Pointered {
    ...
    default public void sendMessage(@NotNull ComponentLike message, @NotNull MessageType type2) {
        this.sendMessage(message.asComponent(), type2);
    }

    @Deprecated
    @ForwardingAudienceOverrideNotRequired
    @ApiStatus.ScheduledForRemoval(inVersion="5.0.0")
    default public void sendMessage(@NotNull Component message, @NotNull MessageType type2) {
        this.sendMessage(Identity.nil(), message, type2);
    }
    ...
    @ForwardingAudienceOverrideNotRequired
    @ApiStatus.ScheduledForRemoval(inVersion="5.0.0")
    default public void sendMessage(@NotNull Identified source, @NotNull ComponentLike message, @NotNull MessageType type2) {
        this.sendMessage(source, message.asComponent(), type2);
    }

    @Deprecated
    @ForwardingAudienceOverrideNotRequired
    @ApiStatus.ScheduledForRemoval(inVersion="5.0.0")
    default public void sendMessage(@NotNull Identity source, @NotNull ComponentLike message, @NotNull MessageType type2) {
        this.sendMessage(source, message.asComponent(), type2);
    }

    @Deprecated
    @ApiStatus.ScheduledForRemoval(inVersion="5.0.0")
    default public void sendMessage(@NotNull Identified source, @NotNull Component message, @NotNull MessageType type2) {
        this.sendMessage(source.identity(), message, type2);
    }
