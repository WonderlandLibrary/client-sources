...
public class RecipeRewriter<C extends ClientboundPacketType> {
    ...
    public void handleRecipeType(PacketWrapper wrapper, String type2) throws Exception {
        RecipeConsumer handler = this.recipeHandlers.get(type2);
        if (handler != null) {
    ...
    public void register(C packetType) {
        this.protocol.registerClientbound(packetType, wrapper -> {
            ...
            for (int i = 0; i < size; ++i) {
                ...
                this.handleRecipeType(wrapper, Key.stripMinecraftNamespace(type2));
            }
        });
    }
