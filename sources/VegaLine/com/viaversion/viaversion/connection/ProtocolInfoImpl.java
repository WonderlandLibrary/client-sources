...
implements ProtocolInfo {
    ...
    public void setClientState(State clientState) {
        if (Via.getManager().debugHandler().enabled()) {
            Via.getPlatform().getLogger().info("Client state changed from " + (Object)((Object)this.clientState) + " to " + (Object)((Object)clientState) + " for " + this.connection.getProtocolInfo().getUuid());
        }
    ...
    public void setServerState(State serverState) {
        if (Via.getManager().debugHandler().enabled()) {
            Via.getPlatform().getLogger().info("Server state changed from " + (Object)((Object)this.serverState) + " to " + (Object)((Object)serverState) + " for " + this.connection.getProtocolInfo().getUuid());
        }
