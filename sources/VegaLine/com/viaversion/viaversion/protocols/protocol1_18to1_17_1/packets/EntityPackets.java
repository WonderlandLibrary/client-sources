    ...
    protected void registerRewrites() {
        this.filter().handler((event, meta) -> {
            ...
            if (meta.metaType() == Types1_18.META_TYPES.particleType) {
                ...
                if (particle2.getId() == 2) {
                    particle2.setId(3);
                    particle2.getArguments().add(new Particle.ParticleData(Type.VAR_INT, 7754));
                } else if (particle2.getId() == 3) {
                    particle2.getArguments().add(new Particle.ParticleData(Type.VAR_INT, 7786));
                } else {
