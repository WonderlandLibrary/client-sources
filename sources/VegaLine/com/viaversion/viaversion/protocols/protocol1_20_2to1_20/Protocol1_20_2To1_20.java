...
extends AbstractProtocol<ClientboundPackets1_19_4, ClientboundPackets1_20_2, ServerboundPackets1_19_4, ServerboundPackets1_20_2> {
    ...
    protected void registerPackets() {
        ...
        this.registerClientbound(ClientboundPackets1_19_4.PLUGIN_MESSAGE, (PacketWrapper wrapper) -> {
        ...
        this.registerServerbound(ServerboundPackets1_20_2.PLUGIN_MESSAGE, (PacketWrapper wrapper) -> {
            String channel = wrapper.passthrough(Type.STRING);
            if (channel.equals("minecraft:brand")) {
                wrapper.passthrough(Type.STRING);
                wrapper.read(Type.REMAINING_BYTES);
    ...
    public static void sendConfigurationPackets(UserConnection connection, CompoundTag dimensionRegistry, @Nullable LastResourcePack lastResourcePack) throws Exception {
        ...
        PacketWrapper enableFeaturesPacket = PacketWrapper.create(ClientboundConfigurationPackets1_20_2.UPDATE_ENABLED_FEATURES, connection);
