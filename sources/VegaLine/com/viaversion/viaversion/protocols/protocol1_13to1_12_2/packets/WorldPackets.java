...
public class WorldPackets {
    ...
    public static void register(Protocol1_13To1_12_2 protocol) {
        ...
        protocol.registerClientbound(ClientboundPackets1_12_1.CHUNK_DATA, wrapper -> {
            ...
            Chunk chunk = wrapper.read(type2);
            ...
            while (iterator.hasNext()) {
                ...
                if (newId != -1) {
                    ...
                    Position position = new Position(x, (short)(y = ((NumberTag)tag.get("y")).asInt()), z = ((NumberTag)tag.get("z")).asInt());
        ...
        protocol.registerClientbound(ClientboundPackets1_12_1.SPAWN_PARTICLE, new PacketHandlers(){
            ...
            public void register() {
                ...
                this.handler(wrapper -> {
                    ...
                    Particle particle2 = ParticleRewriter.rewriteParticle(particleId, data);
                    if (particle2 == null || particle2.getId() == -1) {
                        wrapper.cancel();
                        return;
                    }
                    if (particle2.getId() == 11) {
                        ...
                        if (count == 0) {
                            ...
                            List<Particle.ParticleData> arguments = particle2.getArguments();
                            for (int i = 0; i < 3; ++i) {
                    ...
                    wrapper.set(Type.INT, 0, particle2.getId());
                    for (Particle.ParticleData particleData : particle2.getArguments()) {
