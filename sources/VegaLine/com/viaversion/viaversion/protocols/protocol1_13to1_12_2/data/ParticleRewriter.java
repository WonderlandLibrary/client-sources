...
public class ParticleRewriter {
    ...
    private static ParticleDataHandler reddustHandler() {
        return new ParticleDataHandler(){
            ...
            @Override
            public Particle handler(Particle particle2, Integer[] data) {
                particle2.getArguments().add(new Particle.ParticleData(Type.FLOAT, Float.valueOf(ParticleRewriter.randomBool() ? 1.0f : 0.0f)));
                particle2.getArguments().add(new Particle.ParticleData(Type.FLOAT, Float.valueOf(0.0f)));
                particle2.getArguments().add(new Particle.ParticleData(Type.FLOAT, Float.valueOf(ParticleRewriter.randomBool() ? 1.0f : 0.0f)));
                particle2.getArguments().add(new Particle.ParticleData(Type.FLOAT, Float.valueOf(1.0f)));
                return particle2;
            }
        };
    }
    ...
    private static ParticleDataHandler iconcrackHandler() {
        return new ParticleDataHandler(){
            ...
            public Particle handler(Particle particle2, Integer[] data) {
                ...
                particle2.getArguments().add(new Particle.ParticleData(Type.FLAT_ITEM, item));
                return particle2;
            }
        };
    }
    ...
    private static ParticleDataHandler blockHandler() {
        return new ParticleDataHandler(){
            ...
            public Particle handler(Particle particle2, Integer[] data) {
                ...
                particle2.getArguments().add(new Particle.ParticleData(Type.VAR_INT, newId));
                return particle2;
            }
        };
    }
    ...
    private static class NewParticle {
        ...
        public Particle handle(Particle particle2, Integer[] data) {
            if (this.handler != null) {
                return this.handler.handler(particle2, data);
            }
            return particle2;
        }
