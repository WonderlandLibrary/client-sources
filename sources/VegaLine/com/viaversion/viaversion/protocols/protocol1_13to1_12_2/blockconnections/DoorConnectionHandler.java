...
extends ConnectionHandler {
    ...
    static ConnectionData.ConnectorInitAction init() {
        ...
        return blockData -> {
            int type2 = baseDoors.indexOf(blockData.getMinecraftKey());
            if (type2 == -1) {
                return;
            }
            int id = blockData.getSavedBlockStateId();
            DoorData doorData = new DoorData(blockData.getValue("half").equals("lower"), blockData.getValue("hinge").equals("right"), blockData.getValue("powered").equals("true"), blockData.getValue("open").equals("true"), BlockFace.valueOf(blockData.getValue("facing").toUpperCase(Locale.ROOT)), type2);
    ...
    private static final class DoorData {
        ...
        private DoorData(boolean lower, boolean rightHinge, boolean powered, boolean open, BlockFace facing, int type2) {
            this.lower = lower;
