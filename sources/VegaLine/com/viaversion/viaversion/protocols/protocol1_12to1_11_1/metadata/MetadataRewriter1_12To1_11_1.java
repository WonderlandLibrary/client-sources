...
extends EntityRewriter<ClientboundPackets1_9_3, Protocol1_12To1_11_1> {
    ...
    protected void handleMetadata(int entityId, EntityType type2, Metadata metadata, List<Metadata> metadatas, UserConnection connection) {
        ...
        if (type2 == Entity1_12Types.EntityType.EVOCATION_ILLAGER && metadata.id() == 12) {
            metadata.setId(13);
        }
    }
    ...
    public EntityType typeFromId(int type2) {
        return Entity1_12Types.getTypeFromId(type2, false);
    }

    @Override
    public EntityType objectTypeFromId(int type2) {
        return Entity1_12Types.getTypeFromId(type2, true);
    }
}
