            ...
            block3: {
                ...
                block4: {
                    ...
                    block6: {
                        ...
                        if (!(obj.get("hoverEvent") instanceof JsonObject) || !(hoverEvent = (JsonObject)obj.get("hoverEvent")).has("action") || !hoverEvent.has("value") || !(type2 = hoverEvent.get("action").getAsString()).equals("show_item") && !type2.equals("show_entity")) break block5;
