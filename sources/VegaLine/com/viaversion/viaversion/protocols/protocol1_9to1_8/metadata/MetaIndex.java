...
public enum MetaIndex {
    ...
    private MetaIndex(Entity1_10Types.EntityType type2, @Nullable int index, MetaType1_8 oldType, MetaType1_9 newType) {
        this.clazz = type2;
        this.index = index;
        this.newIndex = index;
    ...
    private MetaIndex(Entity1_10Types.EntityType type2, int index, @Nullable MetaType1_8 oldType, int newIndex, MetaType1_9 newType) {
        this.clazz = type2;
        this.index = index;
        this.oldType = oldType;
    ...
    private static Optional<MetaIndex> getIndex(EntityType type2, int index) {
        Pair<EntityType, Integer> pair = new Pair<EntityType, Integer>(type2, index);
        return Optional.ofNullable(metadataRewrites.get(pair));
    }

    public static MetaIndex searchIndex(EntityType type2, int index) {
        EntityType currentType = type2;
        do {
