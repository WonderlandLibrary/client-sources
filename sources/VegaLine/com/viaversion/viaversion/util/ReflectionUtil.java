...
public class ReflectionUtil {
    ...
    public static <T> T getStatic(Class<?> clazz, String f, Class<T> type2) throws NoSuchFieldException, IllegalAccessException {
        Field field = clazz.getDeclaredField(f);
        field.setAccessible(true);
        return type2.cast(field.get(null));
    }
    ...
    public static <T> T getSuper(Object o, String f, Class<T> type2) throws NoSuchFieldException, IllegalAccessException {
        Field field = o.getClass().getSuperclass().getDeclaredField(f);
        field.setAccessible(true);
        return type2.cast(field.get(o));
    }

    public static <T> T get(Object instance, Class<?> clazz, String f, Class<T> type2) throws NoSuchFieldException, IllegalAccessException {
        Field field = clazz.getDeclaredField(f);
        field.setAccessible(true);
        return type2.cast(field.get(instance));
    }

    public static <T> T get(Object o, String f, Class<T> type2) throws NoSuchFieldException, IllegalAccessException {
        Field field = o.getClass().getDeclaredField(f);
        field.setAccessible(true);
        return type2.cast(field.get(o));
    }

    public static <T> T getPublic(Object o, String f, Class<T> type2) throws NoSuchFieldException, IllegalAccessException {
    ...
    public static final class ClassReflection {
        ...
        public <T> T getFieldValue(String fieldName, Object instance, Class<T> type2) throws IllegalAccessException {
            return type2.cast(this.getField(fieldName).get(instance));
        }

        public <T> T invokeMethod(Class<T> type2, String methodName, Object instance, Object ... args) throws InvocationTargetException, IllegalAccessException {
            return type2.cast(this.getMethod(methodName).invoke(instance, args));
        }
