...
public class Entity1_13Types {
    public static EntityType getTypeFromId(int typeID, boolean isObject) {
        Optional<EntityType> type2 = isObject ? ObjectType.getPCEntity(typeID) : EntityType.findById(typeID);
        if (!type2.isPresent()) {
    ...
    public static enum ObjectType implements com.viaversion.viaversion.api.minecraft.entities.ObjectType
    {
        ...
        private ObjectType(int id, EntityType type2) {
            this.id = id;
            this.type = type2;
        }
        ...
        public static Optional<ObjectType> fromEntityType(EntityType type2) {
            for (ObjectType ent : ObjectType.values()) {
                if (ent.type != type2) continue;
        ...
        static {
            ...
            for (ObjectType type2 : ObjectType.values()) {
                TYPES.put(type2.id, type2);
            }
        }
    }
