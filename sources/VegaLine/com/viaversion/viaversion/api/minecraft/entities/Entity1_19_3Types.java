...
public enum Entity1_19_3Types implements EntityType
{
    ...
    private Entity1_19_3Types(EntityType parent) {
        this.parent = parent;
        this.identifier = "minecraft:" + this.name().toLowerCase(Locale.ROOT);
    }

    private Entity1_19_3Types(EntityType parent, String identifier) {
        this.parent = parent;
    ...
    public static void initialize(Protocol<?, ?, ?, ?> protocol) {
        EntityTypeUtil.initialize((EntityType[])Entity1_19_3Types.values(), (EntityType[])TYPES, protocol, (type2, id) -> {
            type2.id = id;
        });
    }
