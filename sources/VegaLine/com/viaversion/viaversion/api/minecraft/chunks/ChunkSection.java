...
public interface ChunkSection {
    ...
    @Deprecated
    default public void setBlockWithData(int x, int y, int z, int type2, int data) {
        this.setFlatBlock(ChunkSection.index(x, y, z), type2 << 4 | data & 0xF);
    }

    @Deprecated
    default public void setBlockWithData(int idx, int type2, int data) {
        this.setFlatBlock(idx, type2 << 4 | data & 0xF);
    }
