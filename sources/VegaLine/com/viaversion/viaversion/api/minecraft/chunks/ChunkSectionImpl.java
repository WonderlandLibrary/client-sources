...
implements ChunkSection {
    ...
    @Override
    public DataPalette palette(PaletteType type2) {
        return this.palettes.get((Object)type2);
    }

    @Override
    public void addPalette(PaletteType type2, DataPalette palette) {
        this.palettes.put(type2, palette);
    }

    @Override
    public void removePalette(PaletteType type2) {
        this.palettes.remove((Object)type2);
    }
}
