...
UCharacterEnums.ECharacterDirection {
    ...
    public static int getIntPropertyValue(int ch, int type2) {
        return UCharacterProperty.INSTANCE.getIntPropertyValue(ch, type2);
    }
    ...
    public static int getIntPropertyMinValue(int type2) {
        return 0;
    }

    public static int getIntPropertyMaxValue(int type2) {
        return UCharacterProperty.INSTANCE.getIntPropertyMaxValue(type2);
    }
