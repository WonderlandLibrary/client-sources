...
public class CalendarData {
    ...
    public CalendarData(ULocale loc, String type2) {
        this((ICUResourceBundle)UResourceBundle.getBundleInstance("com/ibm/icu/impl/data/icudt51b", loc), type2);
    }

    public CalendarData(ICUResourceBundle b, String type2) {
        this.fBundle = b;
        if (type2 == null || type2.equals("") || type2.equals("gregorian")) {
            this.fMainType = "gregorian";
            this.fFallbackType = null;
        } else {
            this.fMainType = type2;
