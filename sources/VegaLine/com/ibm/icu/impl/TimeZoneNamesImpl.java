...
extends TimeZoneNames {
    ...
    @Override
    public String getMetaZoneDisplayName(String mzID, TimeZoneNames.NameType type2) {
        if (mzID == null || mzID.length() == 0) {
            return null;
        }
        return this.loadMetaZoneNames(mzID).getName(type2);
    }

    @Override
    public String getTimeZoneDisplayName(String tzID, TimeZoneNames.NameType type2) {
        if (tzID == null || tzID.length() == 0) {
            return null;
        }
        return this.loadTimeZoneNames(tzID).getName(type2);
    }
    ...
    extends ZNames {
        ...
        public String getName(TimeZoneNames.NameType type2) {
            if (type2 == TimeZoneNames.NameType.EXEMPLAR_LOCATION) {
                return this._locationName;
            }
            return super.getName(type2);
        }
