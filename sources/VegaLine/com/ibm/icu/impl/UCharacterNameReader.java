...
implements ICUBinary.Authenticate {
    ...
    private UCharacterName.AlgorithmName readAlg() throws IOException {
        ...
        if (!result.setInfo(rangestart, rangeend = this.m_dataInputStream_.readInt(), type2 = this.m_dataInputStream_.readByte(), (byte)(variant = this.m_dataInputStream_.readByte()))) {
            return null;
        }
