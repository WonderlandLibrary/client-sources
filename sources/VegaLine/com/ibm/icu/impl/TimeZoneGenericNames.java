...
Freezable<TimeZoneGenericNames> {
    ...
    public String getDisplayName(TimeZone tz, GenericNameType type2, long date) {
        String name = null;
        ...
        switch (type2) {
            ...
            case LONG: 
            case SHORT: {
                name = this.formatGenericNonLocationName(tz, type2, date);
    ...
    private String formatGenericNonLocationName(TimeZone tz, GenericNameType type2, long date) {
        assert (type2 == GenericNameType.LONG || type2 == GenericNameType.SHORT);
        String tzID = ZoneMeta.getCanonicalCLDRID(tz);
        if (tzID == null) {
            return null;
        }
        TimeZoneNames.NameType nameType = type2 == GenericNameType.LONG ? TimeZoneNames.NameType.LONG_GENERIC : TimeZoneNames.NameType.SHORT_GENERIC;
    ...
    public static enum GenericNameType {
        ...
        public boolean isFallbackTypeOf(GenericNameType type2) {
            String typeStr = type2.toString();
