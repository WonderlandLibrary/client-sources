...
Serializable {
    ...
    public String getGMTOffsetPattern(GMTOffsetPatternType type2) {
        return this._gmtOffsetPatterns[type2.ordinal()];
    }

    public TimeZoneFormat setGMTOffsetPattern(GMTOffsetPatternType type2, String pattern) {
        if (this.isFrozen()) {
            throw new UnsupportedOperationException("Attempt to modify frozen object");
        }
        if (pattern == null) {
        ...
        Object[] parsedItems = TimeZoneFormat.parseOffsetPattern(pattern, type2.required());
        this._gmtOffsetPatterns[type2.ordinal()] = pattern;
        this._gmtOffsetPatternItems[type2.ordinal()] = parsedItems;
    ...
    private static class GMTOffsetField {
        ...
        GMTOffsetField(char type2, int width) {
            this._type = type2;
            this._width = width;
        }
        ...
        static boolean isValid(char type2, int width) {
