...
extends DateFormat {
    ...
    public DisplayContext getContext(DisplayContext.Type type2) {
        return type2 == DisplayContext.Type.CAPITALIZATION && this.capitalizationSetting != null ? this.capitalizationSetting : DisplayContext.CAPITALIZATION_NONE;
    }
    ...
    private static class PatternItem {
        ...
        PatternItem(char type2, int length) {
            this.type = type2;
            this.length = length;
            this.isNumeric = SimpleDateFormat.isNumeric(type2, length);
        }
    }
