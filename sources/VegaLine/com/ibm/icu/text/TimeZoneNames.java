...
implements Serializable {
    ...
    public final String getDisplayName(String tzID, NameType type2, long date) {
        String name = this.getTimeZoneDisplayName(tzID, type2);
        if (name == null) {
            String mzID = this.getMetaZoneID(tzID, date);
            name = this.getMetaZoneDisplayName(mzID, type2);
        }
        return name;
    }
    ...
    extends TimeZoneNames {
        ...
        @Override
        public String getMetaZoneDisplayName(String mzID, NameType type2) {
            return null;
        }

        @Override
        public String getTimeZoneDisplayName(String tzID, NameType type2) {
            return null;
        }
