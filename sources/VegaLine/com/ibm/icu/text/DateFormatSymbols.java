...
Cloneable {
    ...
    protected void initializeData(ULocale desiredLocale, String type2) {
        String key = desiredLocale.getBaseName() + "+" + type2;
        DateFormatSymbols dfs = DFSCACHE.get(key);
        if (dfs == null) {
            CalendarData calData = new CalendarData(desiredLocale, type2);
