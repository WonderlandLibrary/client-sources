...
public class ConnectedProperties {
    ...
    private String[] parseTileNames(String p_parseTileNames_1_) {
        ...
        for (int i1 = 0; i1 < astring2.length; ++i1) {
            ...
            if (!(((String)(s1 = TextureUtils.fixResourcePath((String)s1, this.basePath))).startsWith(this.basePath) || ((String)s1).startsWith("textures/") || ((String)s1).startsWith("mcpatcher/"))) {
                s1 = this.basePath + "/" + (String)s1;
            }
            if (((String)s1).endsWith(".png")) {
                s1 = ((String)s1).substring(0, ((String)s1).length() - 4);
            }
            if (((String)s1).startsWith(s2 = "textures/blocks/")) {
                s1 = ((String)s1).substring(s2.length());
            }
    ...
    private static TextureAtlasSprite[] registerIcons(String[] p_registerIcons_0_, TextureMap p_registerIcons_1_) {
        ...
        for (int i = 0; i < p_registerIcons_0_.length; ++i) {
            ...
            if (!((String)s2).contains("/")) {
                s2 = "textures/blocks/" + (String)s2;
            }
            if (!(flag = Config.hasResource(resourcelocation1 = new ResourceLocation(s1, s3 = (String)s2 + ".png")))) {
