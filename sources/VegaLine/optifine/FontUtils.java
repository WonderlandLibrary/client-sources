...
public class FontUtils {
    ...
    public static ResourceLocation getHdFontLocation(ResourceLocation p_getHdFontLocation_0_) {
        ...
        Object s = p_getHdFontLocation_0_.getResourcePath();
        String s1 = "textures/";
        String s2 = "mcpatcher/";
        ...
        s = s2 + (String)s;
        ResourceLocation resourcelocation = new ResourceLocation(p_getHdFontLocation_0_.getResourceDomain(), (String)s);
