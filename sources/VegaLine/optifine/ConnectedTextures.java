...
public class ConnectedTextures {
    ...
    private static String[] getDefaultCtmPaths() {
        ...
        if (Config.isFromDefaultResourcePack(new ResourceLocation("textures/blocks/glass.png"))) {
            list.add((CallSite)((Object)(s + "glass.properties")));
            list.add((CallSite)((Object)(s + "glasspane.properties")));
        }
        if (Config.isFromDefaultResourcePack(new ResourceLocation("textures/blocks/bookshelf.png"))) {
            list.add((CallSite)((Object)(s + "bookshelf.properties")));
        }
        if (Config.isFromDefaultResourcePack(new ResourceLocation("textures/blocks/sandstone_normal.png"))) {
            list.add((CallSite)((Object)(s + "sandstone.properties")));
        }
        ...
        for (int i = 0; i < astring.length; ++i) {
            ...
            list.add((CallSite)((Object)(s + i + "_glass_" + s1 + "/glass_" + s1 + ".properties")));
            list.add((CallSite)((Object)(s + i + "_glass_" + s1 + "/glass_pane_" + s1 + ".properties")));
        }
