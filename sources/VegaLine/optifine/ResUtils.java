...
public class ResUtils {
    ...
    private static String[] collectFilesFolder(File p_collectFilesFolder_0_, String p_collectFilesFolder_1_, String[] p_collectFilesFolder_2_, String[] p_collectFilesFolder_3_) {
        ...
        for (int i = 0; i < afile.length; ++i) {
            File file1 = afile[i];
            if (file1.isFile()) {
                Object s3 = p_collectFilesFolder_1_ + file1.getName();
                if (!((String)s3).startsWith(s) || !StrUtils.startsWith((String)(s3 = ((String)s3).substring(s.length())), p_collectFilesFolder_2_) || !StrUtils.endsWith((String)s3, p_collectFilesFolder_3_)) continue;
