...
public class CustomItemProperties {
    ...
    private static String fixTextureName(String p_fixTextureName_0_, String p_fixTextureName_1_) {
        if (!(((String)(p_fixTextureName_0_ = TextureUtils.fixResourcePath((String)p_fixTextureName_0_, p_fixTextureName_1_))).startsWith(p_fixTextureName_1_) || ((String)p_fixTextureName_0_).startsWith("textures/") || ((String)p_fixTextureName_0_).startsWith("mcpatcher/"))) {
            p_fixTextureName_0_ = p_fixTextureName_1_ + "/" + (String)p_fixTextureName_0_;
        }
        if (((String)p_fixTextureName_0_).endsWith(".png")) {
            p_fixTextureName_0_ = ((String)p_fixTextureName_0_).substring(0, ((String)p_fixTextureName_0_).length() - 4);
        }
        if (((String)p_fixTextureName_0_).startsWith("/")) {
            p_fixTextureName_0_ = ((String)p_fixTextureName_0_).substring(1);
        }
    ...
    private static String fixModelName(String p_fixModelName_0_, String p_fixModelName_1_) {
        String s;
        boolean flag;
        boolean bl = flag = ((String)(p_fixModelName_0_ = TextureUtils.fixResourcePath((String)p_fixModelName_0_, p_fixModelName_1_))).startsWith("block/") || ((String)p_fixModelName_0_).startsWith("item/");
        if (!(((String)p_fixModelName_0_).startsWith(p_fixModelName_1_) || flag || ((String)p_fixModelName_0_).startsWith("mcpatcher/"))) {
            p_fixModelName_0_ = p_fixModelName_1_ + "/" + (String)p_fixModelName_0_;
        }
        if (((String)p_fixModelName_0_).endsWith(s = ".json")) {
            p_fixModelName_0_ = ((String)p_fixModelName_0_).substring(0, ((String)p_fixModelName_0_).length() - s.length());
        }
        if (((String)p_fixModelName_0_).startsWith("/")) {
            p_fixModelName_0_ = ((String)p_fixModelName_0_).substring(1);
        }
    ...
    private ResourceLocation getTextureLocation(String p_getTextureLocation_1_) {
        ...
        Object s1 = resourcelocation.getResourcePath();
        if (!((String)s1).contains("/")) {
            s1 = "textures/items/" + (String)s1;
        }
        if (!(flag = Config.hasResource(resourcelocation1 = new ResourceLocation(s, s2 = (String)s1 + ".png")))) {
