...
public class InventoryUtil {
    ...
    public static boolean isBestArmors(ItemStack stack, int type2) {
        ...
        for (int i = 5; i < 45; ++i) {
            ...
            if (!(InventoryUtil.getProtection(is) > prot) || !is.getUnlocalizedName().contains(armorType)) continue;
            return false;
        }
        return true;
    }
    ...
    public static int getUseablePotion() {
        for (int o = 9; o < 36; ++o) {
            ItemStack item;
            if (!Minecraft.player.inventoryContainer.getSlot(o).getHasStack() || !InventoryUtil.isPotion(item = Minecraft.player.inventoryContainer.getSlot(o).getStack())) continue;
            return o;
        }
        return -1;
    }
    ...
    public static void usePotion() {
        ...
        if (item == null || InventoryUtil.mc.playerController.processRightClick(Minecraft.player, InventoryUtil.mc.world, hand) == EnumActionResult.SUCCESS) {
            // empty if block
        }
    }
    ...
    public static boolean doesHotbarHaveBlock() {
        for (int i = 0; i < 9; ++i) {
            if (Minecraft.player.inventory.getStackInSlot(i) == null || !(Minecraft.player.inventory.getStackInSlot(i).getItem() instanceof ItemBlock)) continue;
            return true;
        }
        return false;
    }
    ...
    public static int getSwordSlot() {
        ...
        for (int i = 9; i < 45; ++i) {
            ItemStack item;
            if (!Minecraft.player.inventoryContainer.getSlot(i).getHasStack() || (item = Minecraft.player.inventoryContainer.getSlot(i).getStack()) == null || !(item.getItem() instanceof ItemSword)) continue;
    ...
    public static boolean doesNextSlotHavePot() {
        for (int i = 0; i < 9; ++i) {
            if (Minecraft.player.inventory.getStackInSlot(i) == null || !(Minecraft.player.inventory.getStackInSlot(i).getItem() instanceof ItemPotion)) continue;
            return true;
        }
        return false;
    }
    ...
    public static boolean doesNextSlotHaveSoup() {
        for (int i = 0; i < 9; ++i) {
            if (Minecraft.player.inventory.getStackInSlot(i) == null || !(Minecraft.player.inventory.getStackInSlot(i).getItem() instanceof ItemSoup)) continue;
            return true;
        }
        return false;
    }
    ...
    public static int getSlotWithPot() {
        for (int i = 0; i < 9; ++i) {
            if (Minecraft.player.inventory.getStackInSlot(i) == null || Minecraft.player.inventory.getStackInSlot(i).getItem() != Items.SPLASH_POTION) continue;
            return i;
        }
        return 0;
    }
    ...
    public static int getItemSlotInHotbar(ItemStack item) {
        ...
        for (int i = 0; i < 9; ++i) {
            ItemStack is = Minecraft.player.inventory.getStackInSlot(i);
            if (is.getItem() != item.getItem()) continue;
            slot = i;
            break;
        }
        return slot;
    ...
    public static boolean isBestArmor(ItemStack stack, int type2) {
        ...
        for (int i = 5; i < 45; ++i) {
            ItemStack is;
            if (!Minecraft.player.inventoryContainer.getSlot(i).getHasStack() || !(InventoryUtil.getProtection(is = Minecraft.player.inventoryContainer.getSlot(i).getStack()) > prot) || !is.getUnlocalizedName().contains(strType)) continue;
            return false;
        }
        return true;
    }
