...
extends Gui {
    ...
    public void writeText(String par1Str) {
        ...
        this.text = ((String)var2).replaceAll(" ", "");
    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtils.smoothAngleRect(this.xPos - 1, this.yPos + 4, this.xPos + this.width + 1, this.yPos + this.height - 4, ColorUtils.getColor(255, 40, 80));
                RenderUtils.smoothAngleRect(this.xPos, this.yPos + 5, this.xPos + this.width, this.yPos + this.height - 5, -16777216);
            }
            ...
            if (var6) {
                if (var10) {
                    Gui.drawRect(var11, (double)(var8 - 1), (double)(var11 + 1), (double)(var8 + 1 + this.fontRenderer.FONT_HEIGHT), -3092272);
                } else {
