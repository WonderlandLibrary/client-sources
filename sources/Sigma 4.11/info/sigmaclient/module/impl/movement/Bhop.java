...
public class Bhop extends Module {
    ...
    public Bhop(ModuleData data) {
        super(data);
        settings.put(MODE, new Setting<>(MODE, new Options("Speed Mode", "Hypixel", new String[]{"Bhop", "Hypixel", "OnGround", "OldHop", "Mineplex",
                "AAC", "Janitor", "Cubecraft", "MineplexHop", "AACWall"}), "Speed bypass method."));
    ...
    public void onEnable() {
        ...
        spoofSlot =  player ? 1 : mc.thePlayer.inventory.currentItem;
        lessSlow = false;
