...
public class GuiModdedMainMenu extends ClientMainMenu {
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiChangelogButton(8, width - 60, 4, "Changelog"));
        buttonList.add(new GuiChangelogButton(100, width - 60, height + 4, "Back"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (page == 1) {
            for (ChangelogComponent changeL : changeLs) {
                changeL.updateWheel(mouseX, mouseY, height);
            }
        }
    ...
    void drawLigmaScreen(int mouseX, int mouseY) {
        ...
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        float nigga = slide > height ? height : slide;
        ...
        for (ChangelogComponent changeL : changeLs) {
            changeL.draw(s, ScaledResolution.getScaledHeight());
        }
        TTFFontRenderer tFont = Client.fm.getFont("SFL 8");
        tFont.drawStringWithShadow("Owned/Developed by Skids, cracked and exported by Vladymyr.", 1, 3, -1);
        GlStateManager.translate(0, slide, 0);
    }
    ...
    void initChangeLogs() {
        ...
        ChangelogComponent cl4_0 = new ChangelogComponent(c4_0, "4.0 Changelog", 10, height + 30, tFont2);
        ChangelogComponent cl4_1 = new ChangelogComponent(c4_1, "4.1 Changelog", cl4_0.getX() + (int) cl4_0.getWidth() + 10, height + 30, tFont2);
        ChangelogComponent cl4_11 = new ChangelogComponent(c4_11, "4.11 Changelog", cl4_1.getX() + (int) cl4_1.getWidth() + 10, height + 30, tFont2);
        changeLs.add(cl4_0);
        changeLs.add(cl4_1);
        changeLs.add(cl4_11);
