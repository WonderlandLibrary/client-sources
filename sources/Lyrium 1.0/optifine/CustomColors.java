...
public class CustomColors
{
    ...
    public static int getColorMultiplier(final BakedQuad p_getColorMultiplier_0_, final Block p_getColorMultiplier_1_, final IBlockAccess p_getColorMultiplier_2_, BlockPos p_getColorMultiplier_3_, final RenderEnv p_getColorMultiplier_4_) {
        ...
        IColorizer customcolorsicolorizer;
        if (p_getColorMultiplier_1_ != Blocks.grass && p_getColorMultiplier_1_ != Blocks.tallgrass && p_getColorMultiplier_1_ != Blocks.double_plant) {
            if (p_getColorMultiplier_1_ == Blocks.double_plant) {
                customcolorsicolorizer = CustomColors.COLORIZER_GRASS;
                if (i >= 8) {
                    p_getColorMultiplier_3_ = p_getColorMultiplier_3_.down();
                }
            }
                ...
                switch (i & 0x3) {
                    case 0: {
                        customcolorsicolorizer = CustomColors.COLORIZER_FOLIAGE;
                        break;
                    }
                    case 1: {
                        customcolorsicolorizer = CustomColors.COLORIZER_FOLIAGE_PINE;
                        break;
                    }
                    case 2: {
                        customcolorsicolorizer = CustomColors.COLORIZER_FOLIAGE_BIRCH;
                        break;
                    }
                    default: {
                        customcolorsicolorizer = CustomColors.COLORIZER_FOLIAGE;
        ...
        return (Config.isSmoothBiomes() && !customcolorsicolorizer.isColorConstant()) ? getSmoothColorMultiplier(p_getColorMultiplier_2_, p_getColorMultiplier_3_, customcolorsicolorizer, p_getColorMultiplier_4_.getColorizerBlockPosM()) : customcolorsicolorizer.getColor(p_getColorMultiplier_2_, p_getColorMultiplier_3_);
    }
    ...
    public static int getFluidColor(final IBlockAccess p_getFluidColor_0_, final IBlockState p_getFluidColor_1_, final BlockPos p_getFluidColor_2_, final RenderEnv p_getFluidColor_3_) {
        ...
        IColorizer customcolorsicolorizer = getBlockColormap(p_getFluidColor_1_);
        if (customcolorsicolorizer == null && block.getMaterial() == Material.water) {
            customcolorsicolorizer = CustomColors.COLORIZER_WATER;
        }
        return (customcolorsicolorizer == null) ? block.colorMultiplier(p_getFluidColor_0_, p_getFluidColor_2_) : ((Config.isSmoothBiomes() && !customcolorsicolorizer.isColorConstant()) ? getSmoothColorMultiplier(p_getFluidColor_0_, p_getFluidColor_2_, customcolorsicolorizer, p_getFluidColor_3_.getColorizerBlockPosM()) : customcolorsicolorizer.getColor(p_getFluidColor_0_, p_getFluidColor_2_));
    }
