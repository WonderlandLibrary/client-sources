...
public class Config
{
    ...
    public static IResourcePack[] getResourcePacks() {
        ...
        for (final Object resourcepackrepositoryentry : list) {
            list2.add(((ResourcePackRepository.Entry)resourcepackrepositoryentry).getResourcePack());
        }
    ...
    public static IResourcePack getDefiningResourcePack(final ResourceLocation p_getDefiningResourcePack_0_) {
        ...
        if (list != null) {
            for (int i = list.size() - 1; i >= 0; --i) {
                final ResourcePackRepository.Entry resourcepackrepositoryentry = list.get(i);
                final IResourcePack iresourcepack2 = resourcepackrepositoryentry.getResourcePack();
