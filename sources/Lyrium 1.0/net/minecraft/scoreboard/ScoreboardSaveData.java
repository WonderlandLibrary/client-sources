    ...
    protected void readTeams(final NBTTagList p_96498_1_) {
        for (int i = 0; i < p_96498_1_.tagCount(); ++i) {
            ...
            if (nbttagcompound.hasKey("NameTagVisibility", 8)) {
                final Team.EnumVisible teamenumvisible = Team.EnumVisible.func_178824_a(nbttagcompound.getString("NameTagVisibility"));
                if (teamenumvisible != null) {
                    scoreplayerteam.setNameTagVisibility(teamenumvisible);
                }
            }
            if (nbttagcompound.hasKey("DeathMessageVisibility", 8)) {
                final Team.EnumVisible teamenumvisible2 = Team.EnumVisible.func_178824_a(nbttagcompound.getString("DeathMessageVisibility"));
                if (teamenumvisible2 != null) {
                    scoreplayerteam.setDeathMessageVisibility(teamenumvisible2);
                }
            }
