...
public interface IScoreObjectiveCriteria
{
    ...
    public enum EnumRenderType
    {
        ...
        public static EnumRenderType func_178795_a(final String p_178795_0_) {
            final EnumRenderType iscoreobjectivecriteriaenumrendertype = EnumRenderType.field_178801_c.get(p_178795_0_);
            return (iscoreobjectivecriteriaenumrendertype == null) ? EnumRenderType.INTEGER : iscoreobjectivecriteriaenumrendertype;
        }
        
        static {
            field_178801_c = Maps.newHashMap();
            for (final EnumRenderType iscoreobjectivecriteriaenumrendertype : values()) {
                EnumRenderType.field_178801_c.put(iscoreobjectivecriteriaenumrendertype.func_178796_a(), iscoreobjectivecriteriaenumrendertype);
            }
        }
    }
}
