                        ...
                        for (final ChunkCoordIntPair chunkcoordintpair2 : this.eligibleChunksForSpawning) {
                            ...
                            if (!block.isNormalCube()) {
                                ...
                                for (int k4 = 0; k4 < 3; ++k4) {
                                    ...
                                    int j5 = i4;
                                    final int k5 = 6;
                                    BiomeGenBase.SpawnListEntry biomegenbasespawnlistentry = null;
                                    ...
                                    for (int l4 = 0; l4 < 4; ++l4) {
                                        ...
                                        if (!p_77192_1_.isAnyPlayerWithinRangeAt(f, i5, f2, 24.0) && blockpos2.distanceSq(f, i5, f2) >= 576.0) {
                                            if (biomegenbasespawnlistentry == null) {
                                                biomegenbasespawnlistentry = p_77192_1_.getSpawnListEntryForTypeAt(enumcreaturetype, blockpos4);
                                                if (biomegenbasespawnlistentry == null) {
                                                    break;
                                                }
                                            }
                                            if (p_77192_1_.canCreatureTypeSpawnHere(enumcreaturetype, biomegenbasespawnlistentry, blockpos4) && canCreatureTypeSpawnAtLocation(EntitySpawnPlacementRegistry.getPlacementForEntity(biomegenbasespawnlistentry.entityClass), p_77192_1_, blockpos4)) {
                                                EntityLiving entityliving;
                                                try {
                                                    entityliving = (EntityLiving)biomegenbasespawnlistentry.entityClass.getConstructor(World.class).newInstance(p_77192_1_);
                                                }
    ...
    public static void performWorldGenSpawning(final World worldIn, final BiomeGenBase p_77191_1_, final int p_77191_2_, final int p_77191_3_, final int p_77191_4_, final int p_77191_5_, final Random p_77191_6_) {
        ...
        if (!list.isEmpty()) {
            while (p_77191_6_.nextFloat() < p_77191_1_.getSpawningChance()) {
                final BiomeGenBase.SpawnListEntry biomegenbasespawnlistentry = WeightedRandom.getRandomItem(worldIn.rand, list);
                final int i = biomegenbasespawnlistentry.minGroupCount + p_77191_6_.nextInt(1 + biomegenbasespawnlistentry.maxGroupCount - biomegenbasespawnlistentry.minGroupCount);
                IEntityLivingData ientitylivingdata = null;
                ...
                for (int j2 = 0; j2 < i; ++j2) {
                    ...
                    for (int k2 = 0; !flag && k2 < 4; ++k2) {
                        ...
                        if (canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType.ON_GROUND, worldIn, blockpos)) {
                            EntityLiving entityliving;
                            try {
                                entityliving = (EntityLiving)biomegenbasespawnlistentry.entityClass.getConstructor(World.class).newInstance(worldIn);
                            }
                            catch (Exception exception) {
                                exception.printStackTrace();
                                continue;
