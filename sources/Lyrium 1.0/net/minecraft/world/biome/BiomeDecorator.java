    ...
    protected void genDecorations(final BiomeGenBase biomeGenBaseIn) {
        ...
        for (int l3 = 0; l3 < this.flowersPerChunk; ++l3) {
            ...
            if (j5 > 0) {
                ...
                final BlockFlower.EnumFlowerType blockflowerenumflowertype = biomeGenBaseIn.pickRandomFlower(this.randomGenerator, blockpos2);
                final BlockFlower blockflower = blockflowerenumflowertype.getBlockType().getBlock();
                if (blockflower.getMaterial() != Material.air) {
                    this.yellowFlowerGen.setGeneratedBlock(blockflower, blockflowerenumflowertype);
