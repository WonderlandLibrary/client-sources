...
public class BiomeGenForest extends BiomeGenBase
{
    ...
    public BlockFlower.EnumFlowerType pickRandomFlower(final Random rand, final BlockPos pos) {
        if (this.field_150632_aF == 1) {
            ...
            final BlockFlower.EnumFlowerType blockflowerenumflowertype = BlockFlower.EnumFlowerType.values()[(int)(d0 * BlockFlower.EnumFlowerType.values().length)];
            return (blockflowerenumflowertype == BlockFlower.EnumFlowerType.BLUE_ORCHID) ? BlockFlower.EnumFlowerType.POPPY : blockflowerenumflowertype;
        }
