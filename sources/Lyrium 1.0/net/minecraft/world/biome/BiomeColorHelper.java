...
public class BiomeColorHelper
{
    ...
    private static int func_180285_a(final IBlockAccess p_180285_0_, final BlockPos p_180285_1_, final ColorResolver p_180285_2_) {
        ...
        int j = 0;
        int k = 0;
        for (final BlockPos.MutableBlockPos blockposmutableblockpos : BlockPos.getAllInBoxMutable(p_180285_1_.add(-1, 0, -1), p_180285_1_.add(1, 0, 1))) {
            final int l = p_180285_2_.getColorAtPos(p_180285_0_.getBiomeGenForCoords(blockposmutableblockpos), blockposmutableblockpos);
            i += (l & 0xFF0000) >> 16;
            j += (l & 0xFF00) >> 8;
            k += (l & 0xFF);
        }
