                                            ...
                                            if (this.func_175793_a(iblockstate2, iblockstate3)) {
                                                if (j4 - 1 < 10) {
                                                    ...
                                                    if (flag5 && p_180702_5_.getBlockState(j3, j4 - 1, i4).getBlock() == Blocks.dirt) {
                                                        blockposmutableblockpos.func_181079_c(j3 + p_180702_3_ * 16, 0, i4 + p_180702_4_ * 16);
                                                        p_180702_5_.setBlockState(j3, j4 - 1, i4, this.worldObj.getBiomeGenForCoords(blockposmutableblockpos).topBlock.getBlock().getDefaultState());
                                                    }
                                                }
                                            }
                                        }
