                                            ...
                                            if (iblockstate2.getBlock() == Blocks.stone || iblockstate2.getBlock() == Blocks.dirt || iblockstate2.getBlock() == Blocks.grass) {
                                                if (j4 - 1 < 10) {
                                                    ...
                                                    if (flag3 && p_180707_5_.getBlockState(j3, j4 - 1, i4).getBlock() == Blocks.dirt) {
                                                        blockposmutableblockpos.func_181079_c(j3 + p_180707_3_ * 16, 0, i4 + p_180707_4_ * 16);
                                                        p_180707_5_.setBlockState(j3, j4 - 1, i4, this.worldObj.getBiomeGenForCoords(blockposmutableblockpos).topBlock);
                                                    }
                                                }
                                            }
                                        }
