...
public class StructureVillagePieces
{
    ...
    public static List<PieceWeight> getStructureVillageWeightedPieceList(final Random random, final int p_75084_1_) {
    ...
    private static int func_75079_a(final List<PieceWeight> p_75079_0_) {
        boolean flag = false;
        int i = 0;
        for (final PieceWeight structurevillagepiecespieceweight : p_75079_0_) {
            if (structurevillagepiecespieceweight.villagePiecesLimit > 0 && structurevillagepiecespieceweight.villagePiecesSpawned < structurevillagepiecespieceweight.villagePiecesLimit) {
                flag = true;
            }
            i += structurevillagepiecespieceweight.villagePieceWeight;
        }
        return flag ? i : -1;
    }
    ...
    private static Village func_176065_a(final Start start, final PieceWeight weight, final List<StructureComponent> p_176065_2_, final Random rand, final int p_176065_4_, final int p_176065_5_, final int p_176065_6_, final EnumFacing facing, final int p_176065_8_) {
        ...
        Village structurevillagepiecesvillage = null;
        if (oclass == House4Garden.class) {
            structurevillagepiecesvillage = House4Garden.func_175858_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        else if (oclass == Church.class) {
            structurevillagepiecesvillage = Church.func_175854_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        else if (oclass == House1.class) {
            structurevillagepiecesvillage = House1.func_175850_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        else if (oclass == WoodHut.class) {
            structurevillagepiecesvillage = WoodHut.func_175853_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        else if (oclass == Hall.class) {
            structurevillagepiecesvillage = Hall.func_175857_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        else if (oclass == Field1.class) {
            structurevillagepiecesvillage = Field1.func_175851_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        else if (oclass == Field2.class) {
            structurevillagepiecesvillage = Field2.func_175852_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        else if (oclass == House2.class) {
            structurevillagepiecesvillage = House2.func_175855_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        else if (oclass == House3.class) {
            structurevillagepiecesvillage = House3.func_175849_a(start, p_176065_2_, rand, p_176065_4_, p_176065_5_, p_176065_6_, facing, p_176065_8_);
        }
        return structurevillagepiecesvillage;
    }
    ...
    private static Village func_176067_c(final Start start, final List<StructureComponent> p_176067_1_, final Random rand, final int p_176067_3_, final int p_176067_4_, final int p_176067_5_, final EnumFacing facing, final int p_176067_7_) {
        ...
        while (j < 5) {
            ...
            for (final PieceWeight structurevillagepiecespieceweight : start.structureVillageWeightedPieceList) {
                k -= structurevillagepiecespieceweight.villagePieceWeight;
                if (k < 0) {
                    if (!structurevillagepiecespieceweight.canSpawnMoreVillagePiecesOfType(p_176067_7_)) {
                        break;
                    }
                    if (structurevillagepiecespieceweight == start.structVillagePieceWeight && start.structureVillageWeightedPieceList.size() > 1) {
                        break;
                    }
                    final Village structurevillagepiecesvillage = func_176065_a(start, structurevillagepiecespieceweight, p_176067_1_, rand, p_176067_3_, p_176067_4_, p_176067_5_, facing, p_176067_7_);
                    if (structurevillagepiecesvillage != null) {
                        final PieceWeight pieceWeight = structurevillagepiecespieceweight;
                        ++pieceWeight.villagePiecesSpawned;
                        start.structVillagePieceWeight = structurevillagepiecespieceweight;
                        if (!structurevillagepiecespieceweight.canSpawnMoreVillagePieces()) {
                            start.structureVillageWeightedPieceList.remove(structurevillagepiecespieceweight);
                        }
                        return structurevillagepiecesvillage;
                    }
                    continue;
        ...
        protected int getAverageGroundLevel(final World worldIn, final StructureBoundingBox p_74889_2_) {
            ...
            for (int k = this.boundingBox.minZ; k <= this.boundingBox.maxZ; ++k) {
                for (int l = this.boundingBox.minX; l <= this.boundingBox.maxX; ++l) {
                    blockposmutableblockpos.func_181079_c(l, 64, k);
                    if (p_74889_2_.isVecInside(blockposmutableblockpos)) {
                        i += Math.max(worldIn.getTopSolidOrLiquidBlock(blockposmutableblockpos).getY(), worldIn.provider.getAverageGroundLevel());
                        ++j;
                    }
                }
            }
