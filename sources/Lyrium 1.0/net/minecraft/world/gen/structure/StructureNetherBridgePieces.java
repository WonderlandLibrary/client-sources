...
public class StructureNetherBridgePieces
{
    ...
    private static Piece func_175887_b(final PieceWeight p_175887_0_, final List<StructureComponent> p_175887_1_, final Random p_175887_2_, final int p_175887_3_, final int p_175887_4_, final int p_175887_5_, final EnumFacing p_175887_6_, final int p_175887_7_) {
        ...
        Piece structurenetherbridgepiecespiece = null;
        if (oclass == Straight.class) {
            structurenetherbridgepiecespiece = Straight.func_175882_a(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == Crossing3.class) {
            structurenetherbridgepiecespiece = Crossing3.func_175885_a(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == Crossing.class) {
            structurenetherbridgepiecespiece = Crossing.func_175873_a(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == Stairs.class) {
            structurenetherbridgepiecespiece = Stairs.func_175872_a(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_7_, p_175887_6_);
        }
        else if (oclass == Throne.class) {
            structurenetherbridgepiecespiece = Throne.func_175874_a(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_7_, p_175887_6_);
        }
        else if (oclass == Entrance.class) {
            structurenetherbridgepiecespiece = Entrance.func_175881_a(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == Corridor5.class) {
            structurenetherbridgepiecespiece = Corridor5.func_175877_a(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == Corridor2.class) {
            structurenetherbridgepiecespiece = Corridor2.func_175876_a(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == Corridor.class) {
            structurenetherbridgepiecespiece = Corridor.func_175879_a(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == Corridor3.class) {
            structurenetherbridgepiecespiece = Corridor3.func_175883_a(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == Corridor4.class) {
            structurenetherbridgepiecespiece = Corridor4.func_175880_a(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == Crossing2.class) {
            structurenetherbridgepiecespiece = Crossing2.func_175878_a(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        else if (oclass == NetherStalkRoom.class) {
            structurenetherbridgepiecespiece = NetherStalkRoom.func_175875_a(p_175887_1_, p_175887_2_, p_175887_3_, p_175887_4_, p_175887_5_, p_175887_6_, p_175887_7_);
        }
        return structurenetherbridgepiecespiece;
    }
    ...
    abstract static class Piece extends StructureComponent
    {
        ...
        private int getTotalWeight(final List<PieceWeight> p_74960_1_) {
            boolean flag = false;
            int i = 0;
            for (final PieceWeight structurenetherbridgepiecespieceweight : p_74960_1_) {
                if (structurenetherbridgepiecespieceweight.field_78824_d > 0 && structurenetherbridgepiecespieceweight.field_78827_c < structurenetherbridgepiecespieceweight.field_78824_d) {
                    flag = true;
                }
                i += structurenetherbridgepiecespieceweight.field_78826_b;
            }
            return flag ? i : -1;
        }
        ...
        private Piece func_175871_a(final Start p_175871_1_, final List<PieceWeight> p_175871_2_, final List<StructureComponent> p_175871_3_, final Random p_175871_4_, final int p_175871_5_, final int p_175871_6_, final int p_175871_7_, final EnumFacing p_175871_8_, final int p_175871_9_) {
            ...
            while (j < 5 && flag) {
                ...
                for (final PieceWeight structurenetherbridgepiecespieceweight : p_175871_2_) {
                    k -= structurenetherbridgepiecespieceweight.field_78826_b;
                    if (k < 0) {
                        if (!structurenetherbridgepiecespieceweight.func_78822_a(p_175871_9_)) {
                            break;
                        }
                        if (structurenetherbridgepiecespieceweight == p_175871_1_.theNetherBridgePieceWeight && !structurenetherbridgepiecespieceweight.field_78825_e) {
                            break;
                        }
                        final Piece structurenetherbridgepiecespiece = func_175887_b(structurenetherbridgepiecespieceweight, p_175871_3_, p_175871_4_, p_175871_5_, p_175871_6_, p_175871_7_, p_175871_8_, p_175871_9_);
                        if (structurenetherbridgepiecespiece != null) {
                            final PieceWeight pieceWeight = structurenetherbridgepiecespieceweight;
                            ++pieceWeight.field_78827_c;
                            p_175871_1_.theNetherBridgePieceWeight = structurenetherbridgepiecespieceweight;
                            if (!structurenetherbridgepiecespieceweight.func_78823_a()) {
                                p_175871_2_.remove(structurenetherbridgepiecespieceweight);
                            }
                            return structurenetherbridgepiecespiece;
                        }
                        continue;
    ...
    public static class Start extends Crossing3
    {
        ...
        public Start(final Random p_i2059_1_, final int p_i2059_2_, final int p_i2059_3_) {
            ...
            for (final PieceWeight structurenetherbridgepiecespieceweight : StructureNetherBridgePieces.primaryComponents) {
                structurenetherbridgepiecespieceweight.field_78827_c = 0;
                this.primaryWeights.add(structurenetherbridgepiecespieceweight);
            }
            this.secondaryWeights = (List<PieceWeight>)Lists.newArrayList();
            for (final PieceWeight structurenetherbridgepiecespieceweight2 : StructureNetherBridgePieces.secondaryComponents) {
                structurenetherbridgepiecespieceweight2.field_78827_c = 0;
                this.secondaryWeights.add(structurenetherbridgepiecespieceweight2);
            }
        }
