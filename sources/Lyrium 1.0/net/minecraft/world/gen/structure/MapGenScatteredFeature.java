        ...
        public Start(final World worldIn, final Random p_i2060_2_, final int p_i2060_3_, final int p_i2060_4_) {
            ...
            if (biomegenbase != BiomeGenBase.jungle && biomegenbase != BiomeGenBase.jungleHills) {
                if (biomegenbase == BiomeGenBase.swampland) {
                    final ComponentScatteredFeaturePieces.SwampHut componentscatteredfeaturepiecesswamphut = new ComponentScatteredFeaturePieces.SwampHut(p_i2060_2_, p_i2060_3_ * 16, p_i2060_4_ * 16);
                    this.components.add(componentscatteredfeaturepiecesswamphut);
                }
                else if (biomegenbase == BiomeGenBase.desert || biomegenbase == BiomeGenBase.desertHills) {
                    final ComponentScatteredFeaturePieces.DesertPyramid componentscatteredfeaturepiecesdesertpyramid = new ComponentScatteredFeaturePieces.DesertPyramid(p_i2060_2_, p_i2060_3_ * 16, p_i2060_4_ * 16);
                    this.components.add(componentscatteredfeaturepiecesdesertpyramid);
                }
            }
            else {
                final ComponentScatteredFeaturePieces.JunglePyramid componentscatteredfeaturepiecesjunglepyramid = new ComponentScatteredFeaturePieces.JunglePyramid(p_i2060_2_, p_i2060_3_ * 16, p_i2060_4_ * 16);
                this.components.add(componentscatteredfeaturepiecesjunglepyramid);
            }
