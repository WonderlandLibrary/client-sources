...
public class MapGenNetherBridge extends MapGenStructure
{
    ...
    public static class Start extends StructureStart
    {
        ...
        public Start(final World worldIn, final Random p_i2040_2_, final int p_i2040_3_, final int p_i2040_4_) {
            ...
            final StructureNetherBridgePieces.Start structurenetherbridgepiecesstart = new StructureNetherBridgePieces.Start(p_i2040_2_, (p_i2040_3_ << 4) + 2, (p_i2040_4_ << 4) + 2);
            this.components.add(structurenetherbridgepiecesstart);
            structurenetherbridgepiecesstart.buildComponent(structurenetherbridgepiecesstart, this.components, p_i2040_2_);
            final List<StructureComponent> list = structurenetherbridgepiecesstart.field_74967_d;
            while (!list.isEmpty()) {
                final int i = p_i2040_2_.nextInt(list.size());
                final StructureComponent structurecomponent = list.remove(i);
                structurecomponent.buildComponent(structurenetherbridgepiecesstart, this.components, p_i2040_2_);
            }
