...
public class StructureStrongholdPieces
{
    ...
    public static void prepareStructurePieces() {
        ...
        for (final PieceWeight structurestrongholdpiecespieceweight : StructureStrongholdPieces.pieceWeightArray) {
            structurestrongholdpiecespieceweight.instancesSpawned = 0;
            StructureStrongholdPieces.structurePieceList.add(structurestrongholdpiecespieceweight);
        }
    ...
    private static boolean canAddStructurePieces() {
        ...
        for (final PieceWeight structurestrongholdpiecespieceweight : StructureStrongholdPieces.structurePieceList) {
            if (structurestrongholdpiecespieceweight.instancesLimit > 0 && structurestrongholdpiecespieceweight.instancesSpawned < structurestrongholdpiecespieceweight.instancesLimit) {
                flag = true;
            }
            StructureStrongholdPieces.totalWeight += structurestrongholdpiecespieceweight.pieceWeight;
        }
        return flag;
    }
    ...
    private static Stronghold func_175954_a(final Class<? extends Stronghold> p_175954_0_, final List<StructureComponent> p_175954_1_, final Random p_175954_2_, final int p_175954_3_, final int p_175954_4_, final int p_175954_5_, final EnumFacing p_175954_6_, final int p_175954_7_) {
        Stronghold structurestrongholdpiecesstronghold = null;
        if (p_175954_0_ == Straight.class) {
            structurestrongholdpiecesstronghold = Straight.func_175862_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (p_175954_0_ == Prison.class) {
            structurestrongholdpiecesstronghold = Prison.func_175860_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (p_175954_0_ == LeftTurn.class) {
            structurestrongholdpiecesstronghold = LeftTurn.func_175867_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (p_175954_0_ == RightTurn.class) {
            structurestrongholdpiecesstronghold = LeftTurn.func_175867_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (p_175954_0_ == RoomCrossing.class) {
            structurestrongholdpiecesstronghold = RoomCrossing.func_175859_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (p_175954_0_ == StairsStraight.class) {
            structurestrongholdpiecesstronghold = StairsStraight.func_175861_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (p_175954_0_ == Stairs.class) {
            structurestrongholdpiecesstronghold = Stairs.func_175863_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (p_175954_0_ == Crossing.class) {
            structurestrongholdpiecesstronghold = Crossing.func_175866_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (p_175954_0_ == ChestCorridor.class) {
            structurestrongholdpiecesstronghold = ChestCorridor.func_175868_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (p_175954_0_ == Library.class) {
            structurestrongholdpiecesstronghold = Library.func_175864_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        else if (p_175954_0_ == PortalRoom.class) {
            structurestrongholdpiecesstronghold = PortalRoom.func_175865_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
        }
        return structurestrongholdpiecesstronghold;
    }
    ...
    private static Stronghold func_175955_b(final Stairs2 p_175955_0_, final List<StructureComponent> p_175955_1_, final Random p_175955_2_, final int p_175955_3_, final int p_175955_4_, final int p_175955_5_, final EnumFacing p_175955_6_, final int p_175955_7_) {
        ...
        if (StructureStrongholdPieces.strongComponentType != null) {
            final Stronghold structurestrongholdpiecesstronghold = func_175954_a(StructureStrongholdPieces.strongComponentType, p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_, p_175955_7_);
            StructureStrongholdPieces.strongComponentType = null;
            if (structurestrongholdpiecesstronghold != null) {
                return structurestrongholdpiecesstronghold;
            }
        }
        int j = 0;
        while (j < 5) {
            ...
            for (final PieceWeight structurestrongholdpiecespieceweight : StructureStrongholdPieces.structurePieceList) {
                i -= structurestrongholdpiecespieceweight.pieceWeight;
                if (i < 0) {
                    if (!structurestrongholdpiecespieceweight.canSpawnMoreStructuresOfType(p_175955_7_)) {
                        break;
                    }
                    if (structurestrongholdpiecespieceweight == p_175955_0_.strongholdPieceWeight) {
                        break;
                    }
                    final Stronghold structurestrongholdpiecesstronghold2 = func_175954_a(structurestrongholdpiecespieceweight.pieceClass, p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_, p_175955_7_);
                    if (structurestrongholdpiecesstronghold2 != null) {
                        final PieceWeight pieceWeight = structurestrongholdpiecespieceweight;
                        ++pieceWeight.instancesSpawned;
                        p_175955_0_.strongholdPieceWeight = structurestrongholdpiecespieceweight;
                        if (!structurestrongholdpiecespieceweight.canSpawnMoreStructures()) {
                            StructureStrongholdPieces.structurePieceList.remove(structurestrongholdpiecespieceweight);
                        }
                        return structurestrongholdpiecesstronghold2;
                    }
                    continue;
                }
            }
    ...
    public static class Library extends Stronghold
    {
        ...
        static {
            strongholdLibraryChestContents = Lists.newArrayList(new WeightedRandomChestContent(Items.book, 0, 1, 3, 20), new WeightedRandomChestContent(Items.paper, 0, 2, 7, 20), new WeightedRandomChestContent(Items.map, 0, 1, 1, 1), new WeightedRandomChestContent(Items.compass, 0, 1, 1, 1));
        }
    }
