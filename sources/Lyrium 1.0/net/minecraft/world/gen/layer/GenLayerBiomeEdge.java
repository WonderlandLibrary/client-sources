...
public class GenLayerBiomeEdge extends GenLayer
{
    ...
    private boolean canBiomesBeNeighbors(final int p_151634_1_, final int p_151634_2_) {
        ...
        if (biomegenbase != null && biomegenbase2 != null) {
            final BiomeGenBase.TempCategory biomegenbasetempcategory = biomegenbase.getTempCategory();
            final BiomeGenBase.TempCategory biomegenbasetempcategory2 = biomegenbase2.getTempCategory();
            return biomegenbasetempcategory == biomegenbasetempcategory2 || biomegenbasetempcategory == BiomeGenBase.TempCategory.MEDIUM || biomegenbasetempcategory2 == BiomeGenBase.TempCategory.MEDIUM;
        }
        return false;
    }
}
