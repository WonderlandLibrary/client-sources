...
public abstract class World implements IBlockAccess
{
    ...
    public List<AxisAlignedBB> getCollidingBoundingBoxes(final Entity entityIn, final AxisAlignedBB bb) {
        ...
        for (int k2 = i; k2 < j; ++k2) {
            for (int l2 = i2; l2 < j2; ++l2) {
                if (this.isBlockLoaded(blockposmutableblockpos.func_181079_c(k2, 64, l2))) {
                    for (int i3 = k - 1; i3 < l; ++i3) {
                        blockposmutableblockpos.func_181079_c(k2, i3, l2);
                        if (flag && flag2) {
                        ...
                        if (worldborder.contains(blockposmutableblockpos) || !flag2) {
                            iblockstate2 = this.getBlockState(blockposmutableblockpos);
                        }
                        iblockstate2.getBlock().addCollisionBoxesToList(this, blockposmutableblockpos, iblockstate2, bb, list, entityIn);
                    }
                }
            }
        }
                ...
                if (this.isBlockLoaded(blockposmutableblockpos.func_181079_c(k2, 64, l2))) {
                    for (int i3 = k - 1; i3 < l; ++i3) {
                        ...
                        if (k2 >= -30000000 && k2 < 30000000 && l2 >= -30000000 && l2 < 30000000) {
                            iblockstate = this.getBlockState(blockposmutableblockpos);
                        }
                        else {
                            iblockstate = Blocks.bedrock.getDefaultState();
                        }
                        iblockstate.getBlock().addCollisionBoxesToList(this, blockposmutableblockpos, iblockstate, bb, list, null);
                    }
                }
            }
        }
        ...
        for (int k2 = i; k2 <= j; ++k2) {
            for (int l2 = k; l2 <= l; ++l2) {
                for (int i3 = i2; i3 <= j2; ++i3) {
                    final Block block = this.getBlockState(blockposmutableblockpos.func_181079_c(k2, l2, i3)).getBlock();
                    if (block.getMaterial() != Material.air) {
                        return true;
                    }
                }
    ...
    public boolean handleMaterialAcceleration(final AxisAlignedBB bb, final Material materialIn, final Entity entityIn) {
        ...
        for (int k2 = i; k2 < j; ++k2) {
            for (int l2 = k; l2 < l; ++l2) {
                for (int i3 = i2; i3 < j2; ++i3) {
                    blockposmutableblockpos.func_181079_c(k2, l2, i3);
                    final IBlockState iblockstate = this.getBlockState(blockposmutableblockpos);
                    final Block block = iblockstate.getBlock();
                    if (block.getMaterial() == materialIn) {
                        final double d0 = l2 + 1 - BlockLiquid.getLiquidHeightPercent(iblockstate.getValue((IProperty<Integer>)BlockLiquid.LEVEL));
                        if (l >= d0) {
                            flag = true;
                            vec3 = block.modifyAcceleration(this, blockposmutableblockpos, entityIn, vec3);
                        }
                    }
                }
            }
    ...
    public boolean isMaterialInBB(final AxisAlignedBB bb, final Material materialIn) {
        ...
        for (int k2 = i; k2 < j; ++k2) {
            for (int l2 = k; l2 < l; ++l2) {
                for (int i3 = i2; i3 < j2; ++i3) {
                    if (this.getBlockState(blockposmutableblockpos.func_181079_c(k2, l2, i3)).getBlock().getMaterial() == materialIn) {
                        return true;
                    }
                }
            }
    ...
    public boolean isAABBInMaterial(final AxisAlignedBB bb, final Material materialIn) {
        ...
        for (int k2 = i; k2 < j; ++k2) {
            for (int l2 = k; l2 < l; ++l2) {
                for (int i3 = i2; i3 < j2; ++i3) {
                    final IBlockState iblockstate = this.getBlockState(blockposmutableblockpos.func_181079_c(k2, l2, i3));
                    final Block block = iblockstate.getBlock();
                    if (block.getMaterial() == materialIn) {
            ...
            while (i < j) {
                ...
                if (i4 == l3) {
                    ...
                    for (final EnumFacing enumfacing : EnumFacing.values()) {
                        ...
                        blockposmutableblockpos.func_181079_c(i5, j5, k5);
                        final int l5 = Math.max(1, this.getBlockState(blockposmutableblockpos).getBlock().getLightOpacity());
                        i4 = this.getLightFor(lightType, blockposmutableblockpos);
