...
public class ChunkLoader
{
    public static AnvilConverterData load(final NBTTagCompound nbt) {
        ...
        final AnvilConverterData chunkloaderanvilconverterdata = new AnvilConverterData(i, j);
        chunkloaderanvilconverterdata.blocks = nbt.getByteArray("Blocks");
        chunkloaderanvilconverterdata.data = new NibbleArrayReader(nbt.getByteArray("Data"), 7);
        chunkloaderanvilconverterdata.skyLight = new NibbleArrayReader(nbt.getByteArray("SkyLight"), 7);
        chunkloaderanvilconverterdata.blockLight = new NibbleArrayReader(nbt.getByteArray("BlockLight"), 7);
        chunkloaderanvilconverterdata.heightmap = nbt.getByteArray("HeightMap");
        chunkloaderanvilconverterdata.terrainPopulated = nbt.getBoolean("TerrainPopulated");
        chunkloaderanvilconverterdata.entities = nbt.getTagList("Entities", 10);
        chunkloaderanvilconverterdata.tileEntities = nbt.getTagList("TileEntities", 10);
        chunkloaderanvilconverterdata.tileTicks = nbt.getTagList("TileTicks", 10);
        try {
            chunkloaderanvilconverterdata.lastUpdated = nbt.getLong("LastUpdate");
        }
        catch (ClassCastException var5) {
            chunkloaderanvilconverterdata.lastUpdated = nbt.getInteger("LastUpdate");
        }
        return chunkloaderanvilconverterdata;
    }
    ...
    public static void convertToAnvilFormat(final AnvilConverterData p_76690_0_, final NBTTagCompound p_76690_1_, final WorldChunkManager p_76690_2_) {
        ...
        for (int l3 = 0; l3 < 16; ++l3) {
            for (int i4 = 0; i4 < 16; ++i4) {
                blockposmutableblockpos.func_181079_c(p_76690_0_.x << 4 | l3, 0, p_76690_0_.z << 4 | i4);
                abyte2[i4 << 4 | l3] = (byte)(p_76690_2_.getBiomeGenerator(blockposmutableblockpos, BiomeGenBase.field_180279_ad).biomeID & 0xFF);
            }
        }
        p_76690_1_.setByteArray("Biomes", abyte2);
