                ...
                for (int j = 0; j < 32; ++j) {
                    if (regionfile.isChunkSaved(i, j) && !regionfile2.isChunkSaved(i, j)) {
                        ...
                        if (datainputstream == null) {
                            ...
                            final ChunkLoader.AnvilConverterData chunkloaderanvilconverterdata = ChunkLoader.load(nbttagcompound2);
                            ...
                            ChunkLoader.convertToAnvilFormat(chunkloaderanvilconverterdata, nbttagcompound4, p_75811_3_);
