...
public final class WorldSettings
{
    ...
    public enum GameType
    {
        ...
        public static GameType getByID(final int idIn) {
            for (final GameType worldsettingsgametype : values()) {
                if (worldsettingsgametype.id == idIn) {
                    return worldsettingsgametype;
                }
            }
        ...
        public static GameType getByName(final String p_77142_0_) {
            for (final GameType worldsettingsgametype : values()) {
                if (worldsettingsgametype.name.equals(p_77142_0_)) {
                    return worldsettingsgametype;
                }
            }
            return GameType.SURVIVAL;
