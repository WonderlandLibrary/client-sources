...
public abstract class ServerConfigurationManager
{
    ...
    public EntityPlayerMP createPlayerForUser(final GameProfile profile) {
        ...
        final ItemInWorldManager iteminworldmanager = new ItemInWorldManager(this.mcServer.worldServerForDimension(0));
    ...
    public EntityPlayerMP recreatePlayerEntity(final EntityPlayerMP playerIn, final int dimension, final boolean conqueredEnd) {
        ...
        final ItemInWorldManager iteminworldmanager = new ItemInWorldManager(this.mcServer.worldServerForDimension(playerIn.dimension));
