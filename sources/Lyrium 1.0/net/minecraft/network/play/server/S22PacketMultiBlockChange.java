...
public class S22PacketMultiBlockChange implements Packet<INetHandlerPlayClient>
{
    ...
    public void writePacketData(final PacketBuffer buf) throws IOException {
        ...
        for (final BlockUpdateData s22packetmultiblockchangeblockupdatedata : this.changedBlocks) {
            buf.writeShort(s22packetmultiblockchangeblockupdatedata.func_180089_b());
            buf.writeVarIntToBuffer(Block.BLOCK_STATE_IDS.get(s22packetmultiblockchangeblockupdatedata.getBlockState()));
        }
    }
