...
public class S45PacketTitle implements Packet<INetHandlerPlayClient>
{
    ...
    public enum Type
    {
        ...
        public static Type byName(final String name) {
            for (final Type s45packettitletype : values()) {
                if (s45packettitletype.name().equalsIgnoreCase(name)) {
                    return s45packettitletype;
                }
            }
            return Type.TITLE;
        }
        ...
        public static String[] getNames() {
            ...
            int i = 0;
            for (final Type s45packettitletype : values()) {
                astring[i++] = s45packettitletype.name().toLowerCase();
            }
            return astring;
        }
    }
