...
public class S20PacketEntityProperties implements Packet<INetHandlerPlayClient>
{
    ...
    public void writePacketData(final PacketBuffer buf) throws IOException {
        ...
        for (final Snapshot s20packetentitypropertiessnapshot : this.field_149444_b) {
            buf.writeString(s20packetentitypropertiessnapshot.func_151409_a());
            buf.writeDouble(s20packetentitypropertiessnapshot.func_151410_b());
            buf.writeVarIntToBuffer(s20packetentitypropertiessnapshot.func_151408_c().size());
            for (final AttributeModifier attributemodifier : s20packetentitypropertiessnapshot.func_151408_c()) {
