...
public class S08PacketPlayerPosLook implements Packet<INetHandlerPlayClient>
{
    ...
    public enum EnumFlags
    {
        ...
        public static Set<EnumFlags> func_180053_a(final int p_180053_0_) {
            ...
            for (final EnumFlags s08packetplayerposlookenumflags : values()) {
                if (s08packetplayerposlookenumflags.func_180054_b(p_180053_0_)) {
                    set.add(s08packetplayerposlookenumflags);
                }
            }
            return set;
        }
        ...
        public static int func_180056_a(final Set<EnumFlags> p_180056_0_) {
            int i = 0;
            for (final EnumFlags s08packetplayerposlookenumflags : p_180056_0_) {
                i |= s08packetplayerposlookenumflags.func_180055_a();
            }
            return i;
        }
    }
