...
public class C0CPacketInput implements Packet<INetHandlerPlayServer>
{
    ...
    public C0CPacketInput(final C0CPacketInput c0c) {
        this.strafeSpeed = c0c.getStrafeSpeed();
        this.forwardSpeed = c0c.getForwardSpeed();
        this.jumping = c0c.isJumping();
        this.sneaking = c0c.isSneaking();
    }
    ...
    public void setStrafeSpeed(final float strafeSpeed) {
        this.strafeSpeed = strafeSpeed;
    }
