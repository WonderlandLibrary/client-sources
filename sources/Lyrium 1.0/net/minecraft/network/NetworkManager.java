...
public class NetworkManager extends SimpleChannelInboundHandler<Packet>
{
    ...
    protected void channelRead0(final ChannelHandlerContext p_channelRead0_1_, final Packet p_channelRead0_2_) {
        final PacketEvent packetEvent = new PacketEvent(p_channelRead0_2_, PacketEvent.State.RECEIVE);
        ...
        if (this.channel != null && this.channel.isOpen()) {
            ...
            try {
                while (!this.outboundPacketsQueue.isEmpty()) {
                    final InboundHandlerTuplePacketListener networkmanagerinboundhandlertuplepacketlistener = this.outboundPacketsQueue.poll();
                    this.dispatchPacket(networkmanagerinboundhandlertuplepacketlistener.packet, networkmanagerinboundhandlertuplepacketlistener.futureListeners);
                }
            }
            finally {
