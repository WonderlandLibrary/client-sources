...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable
{
    ...
    public void processPlayer(final C03PacketPlayer packetIn) {
        ...
        if (this.func_183006_b(packetIn)) {
            ...
            if (!this.playerEntity.playerConqueredTheEnd) {
                ...
                double d4 = 0.0;
                final double d5 = packetIn.getX() - this.lastPosX;
                final double d6 = packetIn.getY() - this.lastPosY;
                final double d7 = packetIn.getZ() - this.lastPosZ;
    ...
    public void sendPacket(final Packet packetIn) {
        if (packetIn instanceof S02PacketChat) {
            ...
            final EntityPlayer.EnumChatVisibility entityplayerenumchatvisibility = this.playerEntity.getChatVisibility();
            if (entityplayerenumchatvisibility == EntityPlayer.EnumChatVisibility.HIDDEN) {
                return;
            }
            if (entityplayerenumchatvisibility == EntityPlayer.EnumChatVisibility.SYSTEM && !s02packetchat.isChat()) {
                return;
            }
        }
        try {
    ...
    public void processClientStatus(final C16PacketClientStatus packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue((Packet<NetHandlerPlayServer>)packetIn, this, this.playerEntity.getServerForPlayer());
        this.playerEntity.markPlayerActive();
        final C16PacketClientStatus.EnumState c16packetclientstatusenumstate = packetIn.getStatus();
        switch (c16packetclientstatusenumstate) {
